...
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type x@@11) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@14) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Heap@2) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (FrameFragment arg0@@43)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@43))
))) (= (type xs) (SeqType RefType))) (forall ((arg0@@44 T@U) (arg1@@20 Int) ) (! (= (type (invRecv9 arg0@@44 arg1@@20)) RefType)
 :qid |funType:invRecv9|
 :pattern ( (invRecv9 arg0@@44 arg1@@20))
))))
...
(let ((anon9_Else_correct  (=> (HasDirectPerm Mask@1 null (p5 x@@11 i@@18)) (=> (and (= Heap@2 Heap@@14) (= (ControlFlow 0 4) 2)) anon6_correct))))
(let ((anon9_Then_correct  (=> (not (HasDirectPerm Mask@1 null (p5 x@@11 i@@18))) (=> (and (and (= Heap@0 (MapType0Store Heap@@14 null (|p5#sm| x@@11 i@@18) ZeroPMask)) (= Heap@1 (MapType0Store Heap@0 null (p5 x@@11 i@@18) freshVersion@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 3) 2))) anon6_correct))))
(let ((anon4_correct  (=> (= Mask@0 (MapType1Store QPMask@0 x@@11 f_7 (real_2_U (- (U_2_real (MapType1Select QPMask@0 x@@11 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (= (U_2_int (MapType0Select Heap@@14 x@@11 f_7)) i@@18)) (=> (= (U_2_int (MapType0Select Heap@@14 x@@11 f_7)) i@@18) (=> (= Mask@1 (MapType1Store Mask@0 null (p5 x@@11 i@@18) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (p5 x@@11 i@@18))) FullPerm)))) (=> (and (and (state Heap@@14 Mask@1) (state Heap@@14 Mask@1)) (and (|p5#trigger| Heap@@14 (p5 x@@11 i@@18)) (= (MapType0Select Heap@@14 null (p5 x@@11 i@@18)) (FrameFragment (MapType0Select Heap@@14 x@@11 f_7))))) (and (=> (= (ControlFlow 0 5) 3) anon9_Then_correct) (=> (= (ControlFlow 0 5) 4) anon9_Else_correct)))))))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 5)) anon4_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 x@@11 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 x@@11 f_7))) (=> (= (ControlFlow 0 7) 5) anon4_correct))))))
...
)) (=> (and (forall ((r_2_1 T@U) (i_1_1 Int) ) (!  (=> (= (type r_2_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv9 r_2_1 i_1_1)) (< NoPerm FullPerm)) (qpRange9 r_2_1 i_1_1)) (and (= (invRecv9 r_2_1 i_1_1) r_2_1) (= i@@18 i_1_1))))
...
))) (and (state Heap@@14 QPMask@0) (state Heap@@14 QPMask@0))) (and (=> (= (ControlFlow 0 10) 7) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct)))))))))
