...
(set-info :boogie-vc-id |e1#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (not (= this@@111 null))) (=> (not (= this@@111 null)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm ZeroMask this@@111 x@@8)) (=> (HasDirectPerm ZeroMask this@@111 x@@8) (=> (= (ControlFlow 0 3) (- 0 2)) (= (U_2_int (MapType0Select Heap@@121 this@@111 x@@8)) 0))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@121 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@121 this@@111 $allocated)) (= AssumeFunctionsAbove 13)) (and (=> (= (ControlFlow 0 6) 1) anon3_Then_correct) (=> (= (ControlFlow 0 6) 3) anon3_Else_correct))))))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (and (not (= this@@111 null)) (= (ControlFlow 0 4) (- 0 3))) (HasDirectPerm ZeroMask this@@111 x@@8))))
(let ((anon3_Then_correct  (=> (and (not (= this@@111 null)) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm ZeroMask this@@111 x@@8))))
(let ((anon0_correct  (=> (state Heap@@121 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@121 this@@111 $allocated)) (= AssumeFunctionsAbove 21)) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon6_Then_correct  (=> (and (not (= this@@111 null)) (= (ControlFlow 0 3) (- 0 2))) (HasDirectPerm Mask@0 this@@111 x@@8))))
(let ((anon5_Else_correct  (=> (not (= this@@111 null)) (=> (and (and (= Mask@0 (MapType1Store ZeroMask this@@111 x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@111 x@@8)) FullPerm)))) (state Heap@@121 Mask@0)) (and (state Heap@@121 Mask@0) (= (ControlFlow 0 4) 3))) anon6_Then_correct))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@121 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@121 this@@111 $allocated)) (= AssumeFunctionsAbove 16)) (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 4) anon5_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 6) 5) anon0_correct)))
PreconditionGeneratedEntry_correct))))))
))
(check-sat)
