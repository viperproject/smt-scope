...
(declare-fun y@@6 () T@U)
(assert  (and (and (and (and (and (and (and (= (type xs) (MapType2Type RefType boolType)) (= (type x_3) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type x_6) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type x_8) RefType)) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv4 arg0@@43)) RefType)
...
(let ((anon26_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs x_8))) (= (ControlFlow 0 17) 13)) anon16_correct)))
(let ((anon26_Then_correct  (=> (U_2_bool (MapType2Select xs x_8)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm QPMask@0 x_8 f_7)) (=> (HasDirectPerm QPMask@0 x_8 f_7) (=> (= (ControlFlow 0 15) 13) anon16_correct))))))
(let ((anon25_Then_correct  (=> (HasDirectPerm QPMask@0 x_8 f_7) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm QPMask@0 x_8 f_7)) (=> (HasDirectPerm QPMask@0 x_8 f_7) (and (=> (= (ControlFlow 0 18) 15) anon26_Then_correct) (=> (= (ControlFlow 0 18) 17) anon26_Else_correct)))))))
(let ((anon25_Else_correct  (=> (and (not (HasDirectPerm QPMask@0 x_8 f_7)) (= (ControlFlow 0 14) 13)) anon16_correct)))
(let ((anon24_Else_correct  (=> (= (ControlFlow 0 12) (- 0 11)) (forall ((x_8_1 T@U) ) (!  (=> (and (and (= (type x_8_1) RefType) (HasDirectPerm QPMask@0 x_8_1 f_7)) (U_2_bool (MapType2Select xs x_8_1))) (not (= (U_2_int (MapType0Select Heap@@9 x_8_1 f_7)) 0)))
 :qid |stdinbpl.740:15|
 :skolemid |111|
 :pattern ( (MapType1Select QPMask@0 x_8_1 f_7))
 :pattern ( (MapType0Select Heap@@9 x_8_1 f_7))
)))))
(let ((anon22_Else_correct  (=> (forall ((x_6_1 T@U) ) (!  (=> (and (= (type x_6_1) RefType) (U_2_bool (MapType2Select xs x_6_1))) (not (= (U_2_int (MapType0Select Heap@@9 x_6_1 f_7)) 0)))
 :qid |stdinbpl.716:20|
 :skolemid |110|
 :pattern ( (MapType0Select Heap@@9 x_6_1 f_7))
)) (=> (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)) (and (and (=> (= (ControlFlow 0 20) 12) anon24_Else_correct) (=> (= (ControlFlow 0 20) 18) anon25_Then_correct)) (=> (= (ControlFlow 0 20) 14) anon25_Else_correct))))))
(let ((anon11_correct true))
(let ((anon23_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs x_6))) (= (ControlFlow 0 10) 7)) anon11_correct)))
(let ((anon23_Then_correct  (=> (U_2_bool (MapType2Select xs x_6)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm QPMask@0 x_6 f_7)) (=> (HasDirectPerm QPMask@0 x_6 f_7) (=> (= (ControlFlow 0 8) 7) anon11_correct))))))
(let ((anon20_Else_correct  (=> (and (forall ((x_4_1 T@U) ) (!  (=> (and (= (type x_4_1) RefType) (U_2_bool (MapType2Select xs x_4_1))) (<= FullPerm (U_2_real (MapType1Select QPMask@0 x_4_1 f_7))))
 :qid |stdinbpl.700:20|
 :skolemid |109|
 :pattern ( (MapType0Select Heap@@9 x_4_1 f_7))
)) (state Heap@@9 QPMask@0)) (and (and (=> (= (ControlFlow 0 21) 20) anon22_Else_correct) (=> (= (ControlFlow 0 21) 8) anon23_Then_correct)) (=> (= (ControlFlow 0 21) 10) anon23_Else_correct)))))
(let ((anon7_correct true))
(let ((anon21_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs x_3))) (= (ControlFlow 0 6) 3)) anon7_correct)))
(let ((anon21_Then_correct  (=> (U_2_bool (MapType2Select xs x_3)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 x_3 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 x_3 f_7))) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
(let ((anon19_Then_correct true))
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 22) (- 0 23)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select xs x_1))) (U_2_bool (MapType2Select xs x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.650:15|
 :skolemid |103|
 :no-pattern (type x_1)
...
)) (=> (and (and (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs x_1@@1)) (< NoPerm FullPerm)) (and (qpRange4 x_1@@1) (= (invRecv4 x_1@@1) x_1@@1))))
 :qid |stdinbpl.656:22|
 :skolemid |104|
 :pattern ( (MapType0Select Heap@@9 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
 :pattern ( (MapType0Select Heap@@9 x_1@@1 f_7))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv4 o_3))) (< NoPerm FullPerm)) (qpRange4 o_3)) (= (invRecv4 o_3) o_3)))
 :qid |stdinbpl.660:22|
 :skolemid |105|
 ...
 :pattern ( (MapType0Select Heap@@9 x_1@@2 f_7))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs (invRecv4 o_3@@0))) (< NoPerm FullPerm)) (qpRange4 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select xs (invRecv4 o_3@@0))) (< NoPerm FullPerm)) (qpRange4 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.672:22|
 :skolemid |107|
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (and (and (=> (= (ControlFlow 0 22) 2) anon19_Then_correct) (=> (= (ControlFlow 0 22) 21) anon20_Else_correct)) (=> (= (ControlFlow 0 22) 4) anon21_Then_correct)) (=> (= (ControlFlow 0 22) 6) anon21_Else_correct)))))))
(let ((anon18_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 y@@6 $allocated))) (and (=> (= (ControlFlow 0 24) 1) anon18_Then_correct) (=> (= (ControlFlow 0 24) 22) anon18_Else_correct)))))
