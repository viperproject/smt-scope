...
(assert  (and (and (and (= (type Heap@@17) (MapType0Type RefType)) (= (type diz) RefType)) (= (type freshObj@0) RefType)) (= (type Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id Ref__Ref)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (U_2_bool (MapType0Select Heap@@17 diz $allocated)) (=> (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@17 freshObj@0 $allocated)))) (=> (and (and (= Heap@0 (MapType0Store Heap@@17 freshObj@0 $allocated (bool_2_U true))) (state Heap@0 ZeroMask)) (and (state Heap@0 ZeroMask) (= (ControlFlow 0 3) (- 0 4)))) (not (= freshObj@0 null)))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (>= current_thread_id 0) (state Heap@@17 ZeroMask)) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct))))))
