...
(let ((anon10_Then_correct  (=> (state Heap@@12 ZeroMask) (and (=> (= (ControlFlow 0 7) 5) anon11_Then_correct) (=> (= (ControlFlow 0 7) 6) anon11_Else_correct)))))
(let ((anon12_Else_correct true))
(let ((anon12_Then_correct true))
(let ((anon9_Else_correct  (=> (fun01 Heap@@12 (not (= x@@8 i))) (=> (and (state Heap@@12 ZeroMask) (state Heap@@12 ZeroMask)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (fun01 Heap@@12 (not (= x@@8 i)))) (=> (fun01 Heap@@12 (not (= x@@8 i))) (and (and (=> (= (ControlFlow 0 8) 7) anon10_Then_correct) (=> (= (ControlFlow 0 8) 3) anon12_Then_correct)) (=> (= (ControlFlow 0 8) 4) anon12_Else_correct))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@12 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (state Heap@@12 ZeroMask)) (and (=> (= (ControlFlow 0 10) 1) anon9_Then_correct) (=> (= (ControlFlow 0 10) 8) anon9_Else_correct))))))
