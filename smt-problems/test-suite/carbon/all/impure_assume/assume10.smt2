...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type x1@@7) RefType)) (= (type x2) RefType)) (= (type x3) RefType)) (= (type x4) RefType)) (= (type x5) RefType)) (= (type x6) RefType)) (= (type x7) RefType)) (= (type x8) RefType)) (= (type x9) RefType)) (= (type x10) RefType)) (= (type x11) RefType)) (= (type x12) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id m)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct true))
(let ((anon3_Then_correct  (=> (and (< NoPerm p_11) (= (ControlFlow 0 2) (- 0 1))) false)))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 x1@@7 $allocated)) (U_2_bool (MapType0Select Heap@@9 x2 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@9 x3 $allocated)) (U_2_bool (MapType0Select Heap@@9 x4 $allocated))) (and (U_2_bool (MapType0Select Heap@@9 x5 $allocated)) (U_2_bool (MapType0Select Heap@@9 x6 $allocated)))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@9 x7 $allocated)) (U_2_bool (MapType0Select Heap@@9 x8 $allocated))) (and (U_2_bool (MapType0Select Heap@@9 x9 $allocated)) (U_2_bool (MapType0Select Heap@@9 x10 $allocated)))) (and (and (U_2_bool (MapType0Select Heap@@9 x11 $allocated)) (U_2_bool (MapType0Select Heap@@9 x12 $allocated))) (and (<= NoPerm p_11) (state Heap@@9 ZeroMask)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (>= p_11 NoPerm)) (=> (>= p_11 NoPerm) (=> (and (=> (> p_11 NoPerm) (not (= x1@@7 null))) (= Mask@0 (MapType1Store ZeroMask x1@@7 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x1@@7 f_7)) p_11))))) (=> (and (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (<= p_11 (U_2_real (MapType1Select Mask@0 x2 f_7))))) (=> (and (and (and (and (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (<= (__iar__assume_helper_1 (= x2 x3) p_11 p_11) (U_2_real (MapType1Select Mask@0 x3 f_7))) (state Heap@@9 Mask@0))) (and (and (state Heap@@9 Mask@0) (<= (__iar__assume_helper_2 (= x2 x4) (= x3 x4) p_11 p_11 p_11) (U_2_real (MapType1Select Mask@0 x4 f_7)))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)))) (and (and (and (<= (__iar__assume_helper_3 (= x2 x5) (= x3 x5) (= x4 x5) p_11 p_11 p_11 p_11) (U_2_real (MapType1Select Mask@0 x5 f_7))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (<= (__iar__assume_helper_4 (= x2 x6) (= x3 x6) (= x4 x6) (= x5 x6) p_11 p_11 p_11 p_11 p_11) (U_2_real (MapType1Select Mask@0 x6 f_7))))) (and (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (<= (__iar__assume_helper_5 (= x2 x7) (= x3 x7) (= x4 x7) (= x5 x7) (= x6 x7) p_11 p_11 p_11 p_11 p_11 p_11) (U_2_real (MapType1Select Mask@0 x7 f_7))) (state Heap@@9 Mask@0))))) (and (and (and (and (state Heap@@9 Mask@0) (<= (__iar__assume_helper_6 (= x2 x8) (= x3 x8) (= x4 x8) (= x5 x8) (= x6 x8) (= x7 x8) p_11 p_11 p_11 p_11 p_11 p_11 p_11) (U_2_real (MapType1Select Mask@0 x8 f_7)))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (and (<= (__iar__assume_helper_7 (= x2 x9) (= x3 x9) (= x4 x9) (= x5 x9) (= x6 x9) (= x7 x9) (= x8 x9) p_11 p_11 p_11 p_11 p_11 p_11 p_11 p_11) (U_2_real (MapType1Select Mask@0 x9 f_7))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (<= (__iar__assume_helper_8 (= x2 x10) (= x3 x10) (= x4 x10) (= x5 x10) (= x6 x10) (= x7 x10) (= x8 x10) (= x9 x10) p_11 p_11 p_11 p_11 p_11 p_11 p_11 p_11 p_11) (U_2_real (MapType1Select Mask@0 x10 f_7)))))) (and (and (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (<= (__iar__assume_helper_9 (= x2 x11) (= x3 x11) (= x4 x11) (= x5 x11) (= x6 x11) (= x7 x11) (= x8 x11) (= x9 x11) (= x10 x11) p_11 p_11 p_11 p_11 p_11 p_11 p_11 p_11 p_11 p_11) (U_2_real (MapType1Select Mask@0 x11 f_7))) (state Heap@@9 Mask@0))) (and (and (state Heap@@9 Mask@0) (<= (__iar__assume_helper_10 (= x2 x12) (= x3 x12) (= x4 x12) (= x5 x12) (= x6 x12) (= x7 x12) (= x8 x12) (= x9 x12) (= x10 x12) (= x11 x12) p_11 p_11 p_11 p_11 p_11 p_11 p_11 p_11 p_11 p_11 p_11) (U_2_real (MapType1Select Mask@0 x12 f_7)))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)))))) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))))))))))
