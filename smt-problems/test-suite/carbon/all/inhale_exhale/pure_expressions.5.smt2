...
(let ((anon3_Else_correct  (=> (and (not (= 1 1)) (= (ControlFlow 0 4) 1)) anon2_correct)))
(let ((anon3_Then_correct  (=> (= 1 1) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= 1 1)) (=> (= 1 1) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (= 1 1)) (=> (= 1 1) (and (=> (= (ControlFlow 0 5) (- 0 6)) (= 1 1)) (=> (= 1 1) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))))))
