...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon9_Else_correct  (=> (= r_1@2 (fourAnd Heap@@13 true false false true)) (=> (and (state Heap@@13 ZeroMask) (= (ControlFlow 0 5) (- 0 4))) (not r_1@2)))))
(let ((anon9_Then_correct true))
(let ((anon8_Else_correct  (=> (and (= r_1@1 (fourAnd Heap@@13 true true false true)) (state Heap@@13 ZeroMask)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (not r_1@1)) (=> (not r_1@1) (=> (state Heap@@13 ZeroMask) (and (=> (= (ControlFlow 0 6) 3) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct))))))))
