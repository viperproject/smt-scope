(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 19:52:13
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/issues/silicon/0171.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
; [eval] (forall k: Int, fresh__1: Int :: { (k in [x..fresh__1)) } (k in [x..x + 1)) ==> (y in [0..length(a))))
(declare-const k@5@00 Int)
(declare-const fresh__1@6@00 Int)
(push) ; 2
...
; [eval] (k in [x..fresh__1))
; [eval] [x..fresh__1)
(pop) ; 2
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((k@5@00 Int) (fresh__1@6@00 Int)) (!
  (or
    (not (Seq_contains (Seq_range x@1@00 (+ x@1@00 1)) k@5@00))
    (Seq_contains (Seq_range x@1@00 (+ x@1@00 1)) k@5@00))
  :pattern ((Seq_contains (Seq_range x@1@00 fresh__1@6@00) k@5@00))
  :pattern ((Seq_contains_trigger (Seq_range x@1@00 fresh__1@6@00) k@5@00))
  :qid |prog./silicon/silver/src/test/resources/all/issues/silicon/0171.vpr@11@11@11@65-aux|)))
(assert (forall ((k@5@00 Int) (fresh__1@6@00 Int)) (!
  (or
    (not (Seq_contains (Seq_range x@1@00 (+ x@1@00 1)) k@5@00))
    (Seq_contains (Seq_range x@1@00 (+ x@1@00 1)) k@5@00))
...
(assert (forall ((k@5@00 Int) (fresh__1@6@00 Int)) (!
  ...
  :pattern ((Seq_contains (Seq_range x@1@00 fresh__1@6@00) k@5@00))
  :pattern ((Seq_contains_trigger (Seq_range x@1@00 fresh__1@6@00) k@5@00))
  :qid |prog./silicon/silver/src/test/resources/all/issues/silicon/0171.vpr@11@11@11@65|)))
(pop) ; 1
...
(assert (forall ((s@$ $Snap) (a@0@00 IArray) (x@1@00 Int) (y@2@00 Int)) (!
  (let ((result@3@00 (f_lcp%limited s@$ a@0@00 x@1@00 y@2@00))) (=>
    ...
    (forall ((k Int) (fresh__1 Int)) (!
      (=>
        (Seq_contains (Seq_range x@1@00 (+ x@1@00 1)) k)
        (Seq_contains (Seq_range 0 (length<Int> a@0@00)) y@2@00))
      :pattern ((Seq_contains (Seq_range x@1@00 fresh__1) k))
      :pattern ((Seq_contains_trigger (Seq_range x@1@00 fresh__1) k))
      :pattern ((Seq_contains_trigger (Seq_range x@1@00 fresh__1) k))
      ))))
  :pattern ((f_lcp%limited s@$ a@0@00 x@1@00 y@2@00))
  :qid |quant-u-2|)))
