...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type QPMask@1) (MapType2Type RefType realType)) (= (type x_6) RefType)) (= (type t_1) RefType)) (= (type Mask@2) (MapType2Type RefType realType))) (= (type Mask@1) (MapType2Type RefType realType))) (= (type Heap@1) (MapType1Type RefType))) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@47 T@U) ) (! (= (type (invRecv9 arg0@@47)) RefType)
 :qid |funType:invRecv9|
 :pattern ( (invRecv9 arg0@@47))
))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv10 arg0@@48)) RefType)
 :qid |funType:invRecv10|
 :pattern ( (invRecv10 arg0@@48))
))) (= (type Heap@0) (MapType1Type RefType))) (= (type Heap@@10) (MapType1Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@0) (MapType2Type RefType realType))) (forall ((arg0@@49 T@U) (arg1@@25 T@U) ) (! (= (type (CombineFrames arg0@@49 arg1@@25)) FrameTypeType)
...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType2Select QPMask@1 x_6 left)))) (=> (<= FullPerm (U_2_real (MapType2Select QPMask@1 x_6 left))) (=> (= (ControlFlow 0 2) 1) anon6_correct))))))
(let ((anon4_correct  (=> (not (= t_1 null)) (=> (and (= Mask@2 (MapType2Store Mask@1 t_1 all (real_2_U (+ (U_2_real (MapType2Select Mask@1 t_1 all)) FullPerm)))) (state Heap@1 Mask@2)) (and (=> (= (ControlFlow 0 5) (- 0 11)) (forall ((q T@U) (q_3 T@U) ) (!  (=> (and (= (type q) RefType) (= (type q_3) RefType)) (=> (and (and (and (and (not (= q q_3)) (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) q))) (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) q_3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= q q_3))))
 :qid |stdinbpl.1217:15|
 :skolemid |150|
 :no-pattern (type q)
 :no-pattern (type q_3)
 :no-pattern (U_2_int q)
 :no-pattern (U_2_bool q)
 :no-pattern (U_2_int q_3)
 :no-pattern (U_2_bool q_3)
))) (=> (forall ((q@@0 T@U) (q_3@@0 T@U) ) (!  (=> (and (= (type q@@0) RefType) (= (type q_3@@0) RefType)) (=> (and (and (and (and (not (= q@@0 q_3@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) q@@0))) (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) q_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= q@@0 q_3@@0))))
 :qid |stdinbpl.1217:15|
 :skolemid |150|
 :no-pattern (type q@@0)
 :no-pattern (type q_3@@0)
 :no-pattern (U_2_int q@@0)
 :no-pattern (U_2_bool q@@0)
 :no-pattern (U_2_int q_3@@0)
 :no-pattern (U_2_bool q_3@@0)
)) (=> (and (forall ((q@@1 T@U) ) (!  (=> (= (type q@@1) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) q@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange9 q@@1) (= (invRecv9 q@@1) q@@1))))
 :qid |stdinbpl.1223:22|
 :skolemid |151|
 :pattern ( (MapType1Select Heap@1 q@@1 left))
 :pattern ( (MapType2Select QPMask@0 q@@1 left))
 :pattern ( (MapType0Select (MapType1Select Heap@1 t_1 all) q@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) (invRecv9 o_3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange9 o_3)) (= (invRecv9 o_3) o_3)))
 :qid |stdinbpl.1227:22|
 :skolemid |152|
 :pattern ( (invRecv9 o_3))
))) (and (=> (= (ControlFlow 0 5) (- 0 10)) (forall ((q@@2 T@U) ) (!  (=> (and (= (type q@@2) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) q@@2))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1233:15|
 :skolemid |153|
 :pattern ( (MapType1Select Heap@1 q@@2 left))
 :pattern ( (MapType2Select QPMask@0 q@@2 left))
 :pattern ( (MapType0Select (MapType1Select Heap@1 t_1 all) q@@2))
))) (=> (forall ((q@@3 T@U) ) (!  (=> (and (= (type q@@3) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) q@@3))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1233:15|
 :skolemid |153|
 :pattern ( (MapType1Select Heap@1 q@@3 left))
 :pattern ( (MapType2Select QPMask@0 q@@3 left))
 :pattern ( (MapType0Select (MapType1Select Heap@1 t_1 all) q@@3))
)) (=> (and (and (forall ((q@@4 T@U) ) (!  (=> (= (type q@@4) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) q@@4)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= q@@4 null))))
 :qid |stdinbpl.1239:22|
 :skolemid |154|
 :pattern ( (MapType1Select Heap@1 q@@4 left))
 :pattern ( (MapType2Select QPMask@0 q@@4 left))
 :pattern ( (MapType0Select (MapType1Select Heap@1 t_1 all) q@@4))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) (invRecv9 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange9 o_3@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv9 o_3@@0) o_3@@0)) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 left)) (+ (U_2_real (MapType2Select Mask@2 o_3@@0 left)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) (invRecv9 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange9 o_3@@0))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 left)) (U_2_real (MapType2Select Mask@2 o_3@@0 left))))))
...
)) (state Heap@1 QPMask@0))) (and (=> (= (ControlFlow 0 5) (- 0 9)) (forall ((x$0 T@U) (x$0_1 T@U) ) (!  (=> (and (= (type x$0) RefType) (= (type x$0_1) RefType)) (=> (and (and (and (and (not (= x$0 x$0_1)) (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) x$0)) (= (MapType1Select Heap@1 x$0 left) null))) (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) x$0_1)) (= (MapType1Select Heap@1 x$0_1 left) null))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= x$0 x$0_1))))
...
))) (=> (forall ((x$0@@0 T@U) (x$0_1@@0 T@U) ) (!  (=> (and (= (type x$0@@0) RefType) (= (type x$0_1@@0) RefType)) (=> (and (and (and (and (not (= x$0@@0 x$0_1@@0)) (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) x$0@@0)) (= (MapType1Select Heap@1 x$0@@0 left) null))) (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) x$0_1@@0)) (= (MapType1Select Heap@1 x$0_1@@0 left) null))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= x$0@@0 x$0_1@@0))))
 :qid |stdinbpl.1257:15|
 :skolemid |157|
...
)) (=> (and (forall ((x$0@@1 T@U) ) (!  (=> (= (type x$0@@1) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) x$0@@1)) (= (MapType1Select Heap@1 x$0@@1 left) null)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange10 x$0@@1) (= (invRecv10 x$0@@1) x$0@@1))))
 :qid |stdinbpl.1263:22|
 :skolemid |158|
 :pattern ( (MapType1Select Heap@1 x$0@@1 left))
 :pattern ( (MapType2Select QPMask@1 x$0@@1 left))
 :pattern ( (MapType0Select (MapType1Select Heap@1 t_1 all) x$0@@1))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) (invRecv10 o_3@@2))) (= (MapType1Select Heap@1 (invRecv10 o_3@@2) left) null)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange10 o_3@@2)) (= (invRecv10 o_3@@2) o_3@@2)))
 :qid |stdinbpl.1267:22|
 :skolemid |159|
 :pattern ( (invRecv10 o_3@@2))
))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (forall ((x$0@@2 T@U) ) (!  (=> (= (type x$0@@2) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) x$0@@2)) (= (MapType1Select Heap@1 x$0@@2 left) null)) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.1273:15|
 :skolemid |160|
 :pattern ( (MapType1Select Heap@1 x$0@@2 left))
 :pattern ( (MapType2Select QPMask@1 x$0@@2 left))
 :pattern ( (MapType0Select (MapType1Select Heap@1 t_1 all) x$0@@2))
))) (=> (forall ((x$0@@3 T@U) ) (!  (=> (= (type x$0@@3) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) x$0@@3)) (= (MapType1Select Heap@1 x$0@@3 left) null)) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.1273:15|
 :skolemid |160|
 :pattern ( (MapType1Select Heap@1 x$0@@3 left))
 :pattern ( (MapType2Select QPMask@1 x$0@@3 left))
 :pattern ( (MapType0Select (MapType1Select Heap@1 t_1 all) x$0@@3))
)) (=> (and (forall ((x$0@@4 T@U) ) (!  (=> (= (type x$0@@4) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) x$0@@4)) (= (MapType1Select Heap@1 x$0@@4 left) null)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= x$0@@4 null))))
 :qid |stdinbpl.1279:22|
 :skolemid |161|
 :pattern ( (MapType1Select Heap@1 x$0@@4 left))
 :pattern ( (MapType2Select QPMask@1 x$0@@4 left))
 :pattern ( (MapType0Select (MapType1Select Heap@1 t_1 all) x$0@@4))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) (invRecv10 o_3@@3))) (= (MapType1Select Heap@1 (invRecv10 o_3@@3) left) null)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange10 o_3@@3)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv10 o_3@@3) o_3@@3)) (= (U_2_real (MapType2Select QPMask@1 o_3@@3 left)) (+ (U_2_real (MapType2Select QPMask@0 o_3@@3 left)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) (invRecv10 o_3@@3))) (= (MapType1Select Heap@1 (invRecv10 o_3@@3) left) null)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange10 o_3@@3))) (= (U_2_real (MapType2Select QPMask@1 o_3@@3 left)) (U_2_real (MapType2Select QPMask@0 o_3@@3 left))))))
...
)) (state Heap@1 QPMask@1)) (and (state Heap@1 QPMask@1) (state Heap@1 QPMask@1))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (HasDirectPerm QPMask@1 t_1 all)) (=> (HasDirectPerm QPMask@1 t_1 all) (=> (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) x_6)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm QPMask@1 x_6 left)) (=> (HasDirectPerm QPMask@1 x_6 left) (=> (= (MapType1Select Heap@1 x_6 left) null) (=> (and (state Heap@1 QPMask@1) (state Heap@1 QPMask@1)) (and (=> (= (ControlFlow 0 5) 2) anon9_Then_correct) (=> (= (ControlFlow 0 5) 4) anon9_Else_correct))))))))))))))))))))))))))
(let ((anon8_Else_correct  (=> (HasDirectPerm Mask@1 null (inv t_1)) (=> (and (= Heap@1 Heap@@10) (= (ControlFlow 0 13) 5)) anon4_correct))))
(let ((anon8_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (inv t_1))) (= Heap@0 (MapType1Store Heap@@10 null (inv t_1) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 12) 5))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (MapType2Store Mask@0 null (inv t_1) (real_2_U (- (U_2_real (MapType2Select Mask@0 null (inv t_1))) FullPerm)))) (and (=> (= (ControlFlow 0 14) 12) anon8_Then_correct) (=> (= (ControlFlow 0 14) 13) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 17) 14)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= FullPerm (U_2_real (MapType2Select Mask@0 null (inv t_1))))) (=> (<= FullPerm (U_2_real (MapType2Select Mask@0 null (inv t_1)))) (=> (= (ControlFlow 0 15) 14) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (and (U_2_bool (MapType1Select Heap@@10 x_6 $allocated)) (U_2_bool (MapType1Select Heap@@10 t_1 $allocated))) (and (= Mask@0 (MapType2Store ZeroMask null (inv t_1) (real_2_U (+ (U_2_real (MapType2Select ZeroMask null (inv t_1))) FullPerm)))) (state Heap@@10 Mask@0))) (and (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (|inv#trigger| Heap@@10 (inv t_1)) (= (MapType1Select Heap@@10 null (inv t_1)) (CombineFrames (FrameFragment (MapType1Select Heap@@10 t_1 all)) (CombineFrames (FrameFragment (int_2_U (|inv#condqp1| Heap@@10 t_1))) (FrameFragment (int_2_U (|inv#condqp2| Heap@@10 t_1))))))))) (and (=> (= (ControlFlow 0 18) 15) anon7_Then_correct) (=> (= (ControlFlow 0 18) 17) anon7_Else_correct))))))
