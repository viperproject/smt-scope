...
(declare-fun r_7 () T@U)
(declare-fun ref () T@U)
(assert  (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type r_7) RefType)) (= (type Heap@@12) (MapType0Type RefType))) (= (type r_8) RefType)) (= (type ref) RefType)))
(set-info :boogie-vc-id permOnlyOnePredicate2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm Mask@0 null (P1 r_8))) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm Mask@0 null (P1 r_8)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm Mask@0 null (P1 r_8))) (=> (HasDirectPerm Mask@0 null (P1 r_8)) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((r_3 T@U) ) (!  (=> (and (= (type r_3) RefType) (HasDirectPerm Mask@0 null (P1 r_3))) false)
 :qid |stdinbpl.580:15|
 :skolemid |46|
 :pattern ( (MapType1Select Mask@0 null (P1 r_3)))
 :pattern ( (MapType0Select Heap@@12 null (P1 r_3)))
)))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((r_1_1 T@U) ) (!  (=> (and (= (type r_1_1) RefType) (HasDirectPerm Mask@0 null (P2 r_1_1))) false)
 :qid |stdinbpl.561:15|
 :skolemid |45|
 :pattern ( (MapType1Select Mask@0 null (P2 r_1_1)))
 :pattern ( (MapType0Select Heap@@12 null (P2 r_1_1)))
))) (=> (forall ((r_1_1@@0 T@U) ) (!  (=> (and (= (type r_1_1@@0) RefType) (HasDirectPerm Mask@0 null (P2 r_1_1@@0))) false)
 :qid |stdinbpl.561:15|
 :skolemid |45|
 :pattern ( (MapType1Select Mask@0 null (P2 r_1_1@@0)))
 :pattern ( (MapType0Select Heap@@12 null (P2 r_1_1@@0)))
...
(let ((anon10_Else_correct  (=> (and (not (HasDirectPerm Mask@0 null (P2 r_7))) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (HasDirectPerm Mask@0 null (P2 r_7)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 null (P2 r_7))) (=> (HasDirectPerm Mask@0 null (P2 r_7)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
