...
(assert  (and (and (and (and (and (= (type r@@11) RefType) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))))
...
(let ((anon3_Then_correct  (=> (> i@@5 0) (=> (and (not (= r@@11 null)) (= Mask@0 (MapType1Store ZeroMask r@@11 val (real_2_U (+ (U_2_real (MapType1Select ZeroMask r@@11 val)) FullPerm))))) (=> (and (and (state Heap@@10 Mask@0) (not (= r@@11 null))) (and (= Mask@1 (MapType1Store Mask@0 r@@11 next (real_2_U (+ (U_2_real (MapType1Select Mask@0 r@@11 next)) FullPerm)))) (state Heap@@10 Mask@1))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 r@@11 next)) (=> (HasDirectPerm Mask@1 r@@11 next) (=> (and (and (= Mask@2 (MapType1Store Mask@1 null (list (MapType0Select Heap@@10 r@@11 next) (- i@@5 1)) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (list (MapType0Select Heap@@10 r@@11 next) (- i@@5 1)))) FullPerm)))) (state Heap@@10 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 2) 1))) anon2_correct))))))))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 r@@11 $allocated))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))
