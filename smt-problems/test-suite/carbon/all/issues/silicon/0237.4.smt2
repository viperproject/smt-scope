...
(assert  (and (and (= (type arr) RefType) (= (type Heap@@9) (MapType0Type RefType))) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon6_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((p_1 Int) (p_1_1 Int) ) (!  (=> (and (and (not (= p_1 p_1_1)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_1) (loc arr p_1_1))))
 :qid |stdinbpl.597:15|
 :skolemid |56|
))) (=> (forall ((p_1@@0 Int) (p_1_1@@0 Int) ) (!  (=> (and (and (not (= p_1@@0 p_1_1@@0)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_1@@0) (loc arr p_1_1@@0))))
 :qid |stdinbpl.597:15|
 :skolemid |56|
)) (=> (forall ((p_1@@1 Int) ) (!  (=> (< NoPerm NoPerm) (and (qpRange6 (loc arr p_1@@1)) (= (invRecv6 (loc arr p_1@@1)) p_1@@1)))
 :qid |stdinbpl.603:22|
 :skolemid |57|
 :pattern ( (loc arr p_1@@1))
 :pattern ( (loc arr p_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (< NoPerm NoPerm) (qpRange6 o_3)) (= (loc arr (invRecv6 o_3)) o_3)))
 :qid |stdinbpl.607:22|
 :skolemid |58|
 :pattern ( (invRecv6 o_3))
)) (= (ControlFlow 0 7) (- 0 6))) (forall ((p_1@@2 Int) ) (! (>= NoPerm NoPerm)
 :qid |stdinbpl.613:15|
 :skolemid |59|
...
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((p_2 Int) ) (!  (=> (dummyFunction (MapType0Select Heap@@9 (loc arr p_2) val)) (>= NoPerm NoPerm))
 :qid |stdinbpl.644:17|
 :skolemid |62|
 :pattern ( (loc arr p_2))
 :pattern ( (loc arr p_2))
))) (=> (forall ((p_2@@0 Int) ) (!  (=> (dummyFunction (MapType0Select Heap@@9 (loc arr p_2@@0) val)) (>= NoPerm NoPerm))
 :qid |stdinbpl.644:17|
 :skolemid |62|
 :pattern ( (loc arr p_2@@0))
 :pattern ( (loc arr p_2@@0))
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((p_2@@1 Int) (p_2_1 Int) ) (!  (=> (and (and (not (= p_2@@1 p_2_1)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_2@@1) (loc arr p_2_1))))
 :qid |stdinbpl.651:17|
 :skolemid |63|
 :pattern ( (neverTriggered7 p_2@@1) (neverTriggered7 p_2_1))
))) (=> (forall ((p_2@@2 Int) (p_2_1@@0 Int) ) (!  (=> (and (and (not (= p_2@@2 p_2_1@@0)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_2@@2) (loc arr p_2_1@@0))))
 :qid |stdinbpl.651:17|
 :skolemid |63|
 :pattern ( (neverTriggered7 p_2@@2) (neverTriggered7 p_2_1@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((p_2@@3 Int) ) (! (>= (U_2_real (MapType1Select ZeroMask (loc arr p_2@@3) val)) NoPerm)
 :qid |stdinbpl.658:17|
 :skolemid |64|
 :pattern ( (loc arr p_2@@3))
 :pattern ( (loc arr p_2@@3))
)))))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 arr $allocated))) (and (=> (= (ControlFlow 0 10) 9) anon5_Then_correct) (=> (= (ControlFlow 0 10) 2) anon5_Else_correct)))))
