...
(assert  (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type y@@2) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type x@@11) RefType)))
(set-info :boogie-vc-id foo1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 y@@2 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 y@@2 f_7)) perm_temp_quasihavoc_@0)))) (=> (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= perm_temp_quasihavoc_@0 NoPerm)) (=> (>= perm_temp_quasihavoc_@0 NoPerm) (=> (=> (> perm_temp_quasihavoc_@0 NoPerm) (not (= y@@2 null))) (=> (and (and (= Mask@2 (MapType1Store Mask@1 y@@2 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@1 y@@2 f_7)) perm_temp_quasihavoc_@0)))) (state ExhaleHeap@0 Mask@2)) (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@2 x@@11 f_7)) (=> (HasDirectPerm Mask@2 x@@11 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (MapType0Select ExhaleHeap@0 x@@11 f_7)) 3))))))))))))
(let ((anon3_Else_correct  (=> (and (= perm_temp_quasihavoc_@0 NoPerm) (= (ControlFlow 0 7) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= perm_temp_quasihavoc_@0 NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= perm_temp_quasihavoc_@0 (U_2_real (MapType1Select Mask@0 y@@2 f_7)))) (=> (<= perm_temp_quasihavoc_@0 (U_2_real (MapType1Select Mask@0 y@@2 f_7))) (=> (= (ControlFlow 0 5) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@11 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@9 y@@2 $allocated)) (not (= x@@11 null))) (and (= Mask@0 (MapType1Store ZeroMask x@@11 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@11 f_7)) FullPerm)))) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (HasDirectPerm Mask@0 x@@11 f_7)) (=> (HasDirectPerm Mask@0 x@@11 f_7) (=> (and (= (U_2_int (MapType0Select Heap@@9 x@@11 f_7)) 3) (state Heap@@9 Mask@0)) (=> (and (and (not (= x@@11 y@@2)) (state Heap@@9 Mask@0)) (and (= perm_temp_quasihavoc_@0 (U_2_real (MapType1Select Mask@0 y@@2 f_7))) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (>= perm_temp_quasihavoc_@0 NoPerm)) (=> (>= perm_temp_quasihavoc_@0 NoPerm) (and (=> (= (ControlFlow 0 8) 5) anon3_Then_correct) (=> (= (ControlFlow 0 8) 7) anon3_Else_correct))))))))))))
