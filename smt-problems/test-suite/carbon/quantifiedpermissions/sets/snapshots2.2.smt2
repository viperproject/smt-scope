...
(assert  (and (and (and (and (and (and (and (and (and (= (type xs@@4) (MapType1Type RefType boolType)) (= (type ys) (MapType1Type RefType boolType))) (= (type z_3) RefType)) (= (type Heap@@13) (MapType0Type RefType))) (= (type QPMask@1) (MapType2Type RefType realType))) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv22 arg0@@45)) RefType)
 :qid |funType:invRecv22|
 :pattern ( (invRecv22 arg0@@45))
))) (= (type x@@24) RefType)) (= (type y@@6) RefType)) (forall ((arg0@@46 T@U) ) (! (= (type (invRecv21 arg0@@46)) RefType)
 :qid |funType:invRecv21|
 :pattern ( (invRecv21 arg0@@46))
))))
(set-info :boogie-vc-id test04)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon15_Else_correct  (=> (= v_2@0 (fun Heap@@13 xs@@4 x@@24 n@@4)) (=> (and (state Heap@@13 QPMask@0) (= (ControlFlow 0 13) (- 0 12))) (= FullPerm (U_2_real (MapType2Select QPMask@0 y@@6 f_7)))))))
(let ((anon15_Then_correct  (and (=> (= (ControlFlow 0 8) (- 0 11)) (forall ((z_5 T@U) (z_5_1 T@U) ) (!  (=> (and (= (type z_5) RefType) (= (type z_5_1) RefType)) (=> (and (and (and (and (not (= z_5 z_5_1)) (U_2_bool (MapType1Select xs@@4 z_5))) (U_2_bool (MapType1Select xs@@4 z_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_5 z_5_1))))
 :qid |stdinbpl.2058:21|
 :skolemid |214|
 :pattern ( (neverTriggered22 z_5) (neverTriggered22 z_5_1))
))) (=> (forall ((z_5@@0 T@U) (z_5_1@@0 T@U) ) (!  (=> (and (= (type z_5@@0) RefType) (= (type z_5_1@@0) RefType)) (=> (and (and (and (and (not (= z_5@@0 z_5_1@@0)) (U_2_bool (MapType1Select xs@@4 z_5@@0))) (U_2_bool (MapType1Select xs@@4 z_5_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_5@@0 z_5_1@@0))))
 :qid |stdinbpl.2058:21|
 :skolemid |214|
 :pattern ( (neverTriggered22 z_5@@0) (neverTriggered22 z_5_1@@0))
)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (forall ((z_5@@1 T@U) ) (!  (=> (and (= (type z_5@@1) RefType) (U_2_bool (MapType1Select xs@@4 z_5@@1))) (>= (U_2_real (MapType2Select QPMask@0 z_5@@1 f_7)) FullPerm))
 :qid |stdinbpl.2065:21|
 :skolemid |215|
 :pattern ( (MapType0Select Heap@@13 z_5@@1 f_7))
 :pattern ( (MapType2Select QPMask@1 z_5@@1 f_7))
 :pattern ( (MapType1Select xs@@4 z_5@@1))
))) (=> (forall ((z_5@@2 T@U) ) (!  (=> (and (= (type z_5@@2) RefType) (U_2_bool (MapType1Select xs@@4 z_5@@2))) (>= (U_2_real (MapType2Select QPMask@0 z_5@@2 f_7)) FullPerm))
 :qid |stdinbpl.2065:21|
 :skolemid |215|
 :pattern ( (MapType0Select Heap@@13 z_5@@2 f_7))
 :pattern ( (MapType2Select QPMask@1 z_5@@2 f_7))
 :pattern ( (MapType1Select xs@@4 z_5@@2))
)) (=> (and (and (forall ((z_5@@3 T@U) ) (!  (=> (= (type z_5@@3) RefType) (=> (and (U_2_bool (MapType1Select xs@@4 z_5@@3)) (< NoPerm FullPerm)) (and (qpRange22 z_5@@3) (= (invRecv22 z_5@@3) z_5@@3))))
 :qid |stdinbpl.2071:26|
 :skolemid |216|
 :pattern ( (MapType0Select Heap@@13 z_5@@3 f_7))
 :pattern ( (MapType2Select QPMask@1 z_5@@3 f_7))
 :pattern ( (MapType1Select xs@@4 z_5@@3))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType1Select xs@@4 (invRecv22 o_3))) (and (< NoPerm FullPerm) (qpRange22 o_3))) (= (invRecv22 o_3) o_3)))
 :qid |stdinbpl.2075:26|
 :skolemid |217|
 :pattern ( (invRecv22 o_3))
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType1Select xs@@4 (invRecv22 o_3@@0))) (and (< NoPerm FullPerm) (qpRange22 o_3@@0))) (and (= (invRecv22 o_3@@0) o_3@@0) (= (U_2_real (MapType2Select QPMask@1 o_3@@0 f_7)) (- (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType1Select xs@@4 (invRecv22 o_3@@0))) (and (< NoPerm FullPerm) (qpRange22 o_3@@0)))) (= (U_2_real (MapType2Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7))))))
 :qid |stdinbpl.2081:26|
 :skolemid |218|
 :pattern ( (MapType2Select QPMask@1 o_3@@0 f_7))
)) (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 f_7))) (= (U_2_real (MapType2Select QPMask@0 o_3@@1 f_5)) (U_2_real (MapType2Select QPMask@1 o_3@@1 f_5))))))
 :qid |stdinbpl.2087:33|
 :skolemid |219|
...
(let ((anon13_Else_correct  (=> (and (forall ((z_4_1_1 T@U) ) (!  (=> (and (= (type z_4_1_1) RefType) (U_2_bool (MapType1Select (|Set#Union| xs@@4 ys) z_4_1_1))) (not (= z_4_1_1 null)))
 :qid |stdinbpl.2038:20|
 :skolemid |213|
 :pattern ( (MapType1Select (|Set#Union| xs@@4 ys) z_4_1_1))
 :pattern ( (MapType1Select xs@@4 z_4_1_1))
)) (state Heap@@13 QPMask@0)) (and (=> (= (ControlFlow 0 14) 8) anon15_Then_correct) (=> (= (ControlFlow 0 14) 13) anon15_Else_correct)))))
(let ((anon7_correct true))
(let ((anon14_Else_correct  (=> (and (not (U_2_bool (MapType1Select (|Set#Union| xs@@4 ys) z_3))) (= (ControlFlow 0 6) 3)) anon7_correct)))
(let ((anon14_Then_correct  (=> (U_2_bool (MapType1Select (|Set#Union| xs@@4 ys) z_3)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= z_3 null))) (=> (not (= z_3 null)) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (U_2_bool (MapType1Select (|Set#Union| xs@@4 ys) z_1))) (U_2_bool (MapType1Select (|Set#Union| xs@@4 ys) z_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1))))
...
))) (=> (forall ((z_1@@0 T@U) (z_1_1@@0 T@U) ) (!  (=> (and (= (type z_1@@0) RefType) (= (type z_1_1@@0) RefType)) (=> (and (and (and (and (not (= z_1@@0 z_1_1@@0)) (U_2_bool (MapType1Select (|Set#Union| xs@@4 ys) z_1@@0))) (U_2_bool (MapType1Select (|Set#Union| xs@@4 ys) z_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1@@0 z_1_1@@0))))
 :qid |stdinbpl.1969:15|
 :skolemid |207|
...
)) (=> (and (forall ((z_1@@1 T@U) ) (!  (=> (= (type z_1@@1) RefType) (=> (and (U_2_bool (MapType1Select (|Set#Union| xs@@4 ys) z_1@@1)) (< NoPerm FullPerm)) (and (qpRange21 z_1@@1) (= (invRecv21 z_1@@1) z_1@@1))))
 :qid |stdinbpl.1975:22|
 :skolemid |208|
 :pattern ( (MapType0Select Heap@@13 z_1@@1 f_7))
 :pattern ( (MapType2Select QPMask@0 z_1@@1 f_7))
 :pattern ( (MapType1Select (|Set#Union| xs@@4 ys) z_1@@1))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType1Select (|Set#Union| xs@@4 ys) (invRecv21 o_3@@2))) (< NoPerm FullPerm)) (qpRange21 o_3@@2)) (= (invRecv21 o_3@@2) o_3@@2)))
 :qid |stdinbpl.1979:22|
 :skolemid |209|
 :pattern ( (invRecv21 o_3@@2))
))) (=> (and (and (and (and (forall ((z_1@@2 T@U) ) (!  (=> (and (= (type z_1@@2) RefType) (U_2_bool (MapType1Select (|Set#Union| xs@@4 ys) z_1@@2))) (not (= z_1@@2 null)))
 :qid |stdinbpl.1985:22|
 :skolemid |210|
 :pattern ( (MapType0Select Heap@@13 z_1@@2 f_7))
 :pattern ( (MapType2Select QPMask@0 z_1@@2 f_7))
 :pattern ( (MapType1Select (|Set#Union| xs@@4 ys) z_1@@2))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType1Select (|Set#Union| xs@@4 ys) (invRecv21 o_3@@3))) (< NoPerm FullPerm)) (qpRange21 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv21 o_3@@3) o_3@@3)) (= (U_2_real (MapType2Select QPMask@0 o_3@@3 f_7)) (+ (U_2_real (MapType2Select ZeroMask o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType1Select (|Set#Union| xs@@4 ys) (invRecv21 o_3@@3))) (< NoPerm FullPerm)) (qpRange21 o_3@@3))) (= (U_2_real (MapType2Select QPMask@0 o_3@@3 f_7)) (U_2_real (MapType2Select ZeroMask o_3@@3 f_7))))))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 f_7))) (= (U_2_real (MapType2Select ZeroMask o_3@@4 f_5@@0)) (U_2_real (MapType2Select QPMask@0 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.1995:29|
 :skolemid |212|
 :pattern ( (MapType2Select ZeroMask o_3@@4 f_5@@0))
 :pattern ( (MapType2Select QPMask@0 o_3@@4 f_5@@0))
)) (state Heap@@13 QPMask@0))) (and (and (state Heap@@13 QPMask@0) (U_2_bool (MapType1Select xs@@4 x@@24))) (and (U_2_bool (MapType1Select ys y@@6)) (state Heap@@13 QPMask@0)))) (and (and (and (not (U_2_bool (MapType1Select ys x@@24))) (not (U_2_bool (MapType1Select xs@@4 y@@6)))) (and (state Heap@@13 QPMask@0) (not (= x@@24 null)))) (and (and (not (= y@@6 null)) (state Heap@@13 QPMask@0)) (and (>= n@@4 0) (state Heap@@13 QPMask@0))))) (and (and (and (=> (= (ControlFlow 0 15) 2) anon12_Then_correct) (=> (= (ControlFlow 0 15) 14) anon13_Else_correct)) (=> (= (ControlFlow 0 15) 4) anon14_Then_correct)) (=> (= (ControlFlow 0 15) 6) anon14_Else_correct))))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@13 x@@24 $allocated)) (U_2_bool (MapType0Select Heap@@13 y@@6 $allocated)))) (and (=> (= (ControlFlow 0 17) 1) anon11_Then_correct) (=> (= (ControlFlow 0 17) 15) anon11_Else_correct)))))
