(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:24:44
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quantifiedpredicates/basic/injectivity.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(pop) ; 3
(declare-const $t@7@01 $PSF<pred1>)
...
(assert (not (forall ((x1@6@01 $Ref) (x2@6@01 $Ref)) (!
  (=>
    (and (Seq_contains xs@2@01 x1@6@01) (Seq_contains xs@2@01 x2@6@01))
    (= x1@6@01 x2@6@01))
...
(declare-const sm@15@01 $PSF<pred2>)
; Definitional axioms for singleton-SM's value
(assert (=
  ($PSF.lookup_pred2 (as sm@15@01  $PSF<pred2>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap y@13@01)
...
(push) ; 3
; [eval] (x in xs)
(assert (Seq_contains xs@12@01 x@16@01))
(pop) ; 3
(declare-const $t@17@01 $PSF<pred2>)
(declare-fun inv@18@01 ($Ref Int) $Ref)
(declare-fun img@19@01 ($Ref Int) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((x1@16@01 $Ref) (x2@16@01 $Ref)) (!
  (=>
    (and (Seq_contains xs@12@01 x1@16@01) (Seq_contains xs@12@01 x2@16@01))
    (= x1@16@01 x2@16@01))
...
(push) ; 3
; [eval] (x in xs)
(assert (Seq_contains xs@22@01 x@24@01))
(pop) ; 3
...
(assert (not (forall ((x1@24@01 $Ref) (x2@24@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@22@01 x1@24@01)
      (Seq_contains xs@22@01 x2@24@01)
      (= x1@24@01 x2@24@01))
    (= x1@24@01 x2@24@01))
...
(assert (forall ((x@24@01 $Ref)) (!
  (=>
    (Seq_contains xs@22@01 x@24@01)
    (and (= (inv@25@01 x@24@01 1) x@24@01) (img@26@01 x@24@01 1)))
  :pattern ((Seq_contains xs@22@01 x@24@01))
  :pattern ((Seq_contains_trigger xs@22@01 x@24@01))
  :pattern ((inv@25@01 x@24@01 1))
  :pattern ((img@26@01 x@24@01 1))
  :qid |pred2-invOfFct|)))
(assert (forall ((a $Ref) (i Int)) (!
  (=>
    (and (img@26@01 a i) (Seq_contains xs@22@01 (inv@25@01 a i)))
    (and (= (inv@25@01 a i) a) (= 1 i)))
  :pattern ((inv@25@01 a i))
  :qid |pred2-fctOfInv|)))
...
(assert (not (forall ((a $Ref) (i Int)) (!
  (=>
    (and
      (Seq_contains xs@22@01 (inv@25@01 a i))
      (img@26@01 a i)
      (and (= a (inv@25@01 a i)) (= i 1)))
    false)
...
(push) ; 3
; [eval] (x in xs)
(assert (Seq_contains xs@22@01 x@27@01))
(pop) ; 3
...
(assert (not (forall ((x1@27@01 $Ref) (x2@27@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@22@01 x1@27@01)
      (Seq_contains xs@22@01 x2@27@01)
      (= x1@27@01 x2@27@01))
    (= x1@27@01 x2@27@01))
...
(assert (forall ((x@27@01 $Ref)) (!
  (=>
    (Seq_contains xs@22@01 x@27@01)
    (and (= (inv@28@01 x@27@01 1) x@27@01) (img@29@01 x@27@01 1)))
  :pattern ((Seq_contains xs@22@01 x@27@01))
  :pattern ((Seq_contains_trigger xs@22@01 x@27@01))
  :pattern ((inv@28@01 x@27@01 1))
  :pattern ((img@29@01 x@27@01 1))
  :qid |pred2-invOfFct|)))
(assert (forall ((a $Ref) (i Int)) (!
  (=>
    (and (img@29@01 a i) (Seq_contains xs@22@01 (inv@28@01 a i)))
    (and (= (inv@28@01 a i) a) (= 1 i)))
  :pattern ((inv@28@01 a i))
  :qid |pred2-fctOfInv|)))
; Precomputing data for removing quantified permissions
; Done precomputing, updating quantified chunks
; State saturation: before repetition
...
(assert (not (forall ((a $Ref) (i Int)) (!
  (=>
    (and
      (Seq_contains xs@22@01 (inv@28@01 a i))
      (img@29@01 a i)
      (and (= a (inv@28@01 a i)) (= i 1)))
    false)
