...
(assert  (and (and (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type r_1) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type ExhaleHeap@1) (MapType0Type RefType))))
...
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@2 r_1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 r_1 f_7))) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 r_1 $allocated)) (> wildcard@0 NoPerm)) (=> (and (and (not (= r_1 null)) (= Mask@0 (MapType1Store ZeroMask r_1 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1 f_7)) wildcard@0))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 5) (- 0 9)) (> (U_2_real (MapType1Select Mask@0 r_1 f_7)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@0 r_1 f_7)) NoPerm) (=> (and (> wildcard@1 NoPerm) (< wildcard@1 (U_2_real (MapType1Select Mask@0 r_1 f_7)))) (=> (and (and (= Mask@1 (MapType1Store Mask@0 r_1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 r_1 f_7)) wildcard@1)))) (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@1)) (and (state ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (> (U_2_real (MapType1Select Mask@1 r_1 f_7)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@1 r_1 f_7)) NoPerm) (=> (and (> wildcard@2 NoPerm) (< wildcard@2 (U_2_real (MapType1Select Mask@1 r_1 f_7)))) (=> (and (and (= Mask@2 (MapType1Store Mask@1 r_1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 r_1 f_7)) wildcard@2)))) (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@1 Mask@2)) (and (state ExhaleHeap@1 Mask@2) (state ExhaleHeap@1 Mask@2))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (<= NoPerm FullPerm)) (=> (<= NoPerm FullPerm) (and (=> (= (ControlFlow 0 5) (- 0 6)) (>= FullPerm NoPerm)) (=> (>= FullPerm NoPerm) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))))))))))))))))
