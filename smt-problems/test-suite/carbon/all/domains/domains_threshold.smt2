...
(assert  (and (and (and (forall ((arg0@@25 T@T) ) (! (= (Ctor (D1DomainTypeType arg0@@25)) 11)
...
))) (forall ((arg0@@27 T@U) ) (! (let ((T (D1DomainTypeTypeInv0 (type arg0@@27))))
(= (type (f6 arg0@@27)) (D1DomainTypeType (D1DomainTypeType T))))
 :qid |funType:f6|
 :pattern ( (f6 arg0@@27))
))) (forall ((arg0@@28 T@U) ) (! (let ((T@@0 (type arg0@@28)))
(= (type (f1 arg0@@28)) (D1DomainTypeType T@@0)))
 :qid |funType:f1|
 :pattern ( (f1 arg0@@28))
))))
(assert (forall ((x@@8 T@U) ) (! (= (f6 (f1 x@@8)) (f1 (f1 x@@8)))
 :qid |stdinbpl.201:19|
 :skolemid |22|
 :pattern ( (f6 (f1 x@@8)))
 :pattern ( (f1 (f1 x@@8)))
...
(assert  (and (forall ((arg0@@30 T@U) ) (! (let ((T@@1 (D1DomainTypeTypeInv0 (D1DomainTypeTypeInv0 (type arg0@@30)))))
(= (type (f4 arg0@@30)) T@@1))
 :qid |funType:f4|
 :pattern ( (f4 arg0@@30))
)) (forall ((arg0@@31 T@U) ) (! (let ((T@@2 (D1DomainTypeTypeInv0 (type arg0@@31))))
(= (type (f3 arg0@@31)) T@@2))
 :qid |funType:f3|
 :pattern ( (f3 arg0@@31))
))))
(assert (forall ((z@@0 T@U) ) (! (let ((T@@3 (D1DomainTypeTypeInv0 (D1DomainTypeTypeInv0 (type z@@0)))))
 (=> (= (type z@@0) (D1DomainTypeType (D1DomainTypeType T@@3))) (= (f4 z@@0) (f3 (f3 z@@0)))))
 :qid |stdinbpl.213:19|
 :skolemid |24|
 :pattern ( (f4 z@@0))
 :pattern ( (f3 (f3 z@@0)))
...
(assert (forall ((arg0@@32 T@U) ) (! (let ((T@@4 (D1DomainTypeTypeInv0 (type arg0@@32))))
(= (type (f2 arg0@@32)) (D1DomainTypeType T@@4)))
 :qid |funType:f2|
 :pattern ( (f2 arg0@@32))
)))
(assert (forall ((y@@1 T@U) ) (! (let ((T@@5 (D1DomainTypeTypeInv0 (type y@@1))))
 (=> (= (type y@@1) (D1DomainTypeType T@@5)) (= y@@1 (f2 y@@1))))
 :qid |stdinbpl.207:19|
 :skolemid |23|
 :pattern ( (f2 y@@1))
)))
