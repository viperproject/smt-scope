...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon8_correct  (=> (and (= Mask@3 (MapType1Store Mask@2 x@@14 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@2 x@@14 f_7)) FullPerm)))) (= (ControlFlow 0 4) (- 0 3))) (= (U_2_int (MapType0Select Heap@2 x@@14 f_7)) 0))))
(let ((anon12_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 4)) anon8_correct)))
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@2 x@@14 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 x@@14 f_7))) (=> (= (ControlFlow 0 5) 4) anon8_correct))))))
(let ((anon6_correct  (=> (not (= x@@14 null)) (=> (and (and (= Mask@2 (MapType1Store Mask@1 x@@14 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@1 x@@14 f_7)) FullPerm)))) (state Heap@1 Mask@2)) (and (state Heap@1 Mask@2) (state Heap@1 Mask@2))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (= FullPerm (U_2_real (MapType1Select Mask@2 x@@14 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@2 x@@14 f_7))) (=> (and (= Heap@2 (MapType0Store Heap@1 x@@14 f_7 (int_2_U 0))) (state Heap@2 Mask@2)) (and (=> (= (ControlFlow 0 8) 5) anon12_Then_correct) (=> (= (ControlFlow 0 8) 7) anon12_Else_correct)))))))))
(let ((anon11_Else_correct  (=> (HasDirectPerm Mask@1 null (Cell x@@14)) (=> (and (= Heap@1 Heap@@10) (= (ControlFlow 0 11) 8)) anon6_correct))))
(let ((anon11_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (Cell x@@14))) (= Heap@0 (MapType0Store Heap@@10 null (Cell x@@14) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 10) 8))) anon6_correct)))
(let ((anon4_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (Cell x@@14) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (Cell x@@14))) FullPerm)))) (and (=> (= (ControlFlow 0 12) 10) anon11_Then_correct) (=> (= (ControlFlow 0 12) 11) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 15) 12)) anon4_correct)))
(let ((anon10_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Cell x@@14))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Cell x@@14)))) (=> (= (ControlFlow 0 13) 12) anon4_correct))))))
(let ((anon9_Else_correct  (=> (and (|Cell#trigger| Heap@@10 (Cell x@@14)) (= (MapType0Select Heap@@10 null (Cell x@@14)) (FrameFragment (MapType0Select Heap@@10 x@@14 f_7)))) (and (=> (= (ControlFlow 0 16) 13) anon10_Then_correct) (=> (= (ControlFlow 0 16) 15) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (not (= x@@14 null)) (= PostMask@0 (MapType1Store ZeroMask x@@14 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@14 f_7)) FullPerm))))) (and (state PostHeap@0 PostMask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm PostMask@0 x@@14 f_7)))))
