...
(assert  (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type c3) RefType)) (= (type r_3) RefType)) (= (type c1) RefType)) (= (type c2) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test03)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (not (HasDirectPerm Mask@1 r_3 val)) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (HasDirectPerm Mask@1 r_3 val) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@1 r_3 val)) (=> (HasDirectPerm Mask@1 r_3 val) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
(let ((anon5_Else_correct  (=> (and (and (forall ((r_1_1 T@U) ) (!  (=> (and (and (= (type r_1_1) RefType) (HasDirectPerm Mask@1 r_1_1 val)) (= r_1_1 c3)) false)
 :qid |stdinbpl.362:20|
 :skolemid |24|
 :pattern ( (MapType1Select Mask@1 r_1_1 val))
 :pattern ( (MapType0Select Heap@@9 r_1_1 val))
)) (state Heap@@9 Mask@1)) (and (state Heap@@9 Mask@1) (= (ControlFlow 0 2) (- 0 1)))) false)))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 c1 $allocated)) (U_2_bool (MapType0Select Heap@@9 c2 $allocated))) (and (U_2_bool (MapType0Select Heap@@9 c3 $allocated)) (not (= c1 null)))) (=> (and (and (and (= Mask@0 (MapType1Store ZeroMask c1 val (real_2_U (+ (U_2_real (MapType1Select ZeroMask c1 val)) FullPerm)))) (state Heap@@9 Mask@0)) (and (not (= c2 null)) (= Mask@1 (MapType1Store Mask@0 c2 val (real_2_U (+ (U_2_real (MapType1Select Mask@0 c2 val)) FullPerm)))))) (and (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1)) (and (or (= c3 c1) (= c3 c2)) (state Heap@@9 Mask@1)))) (and (and (=> (= (ControlFlow 0 7) 2) anon5_Else_correct) (=> (= (ControlFlow 0 7) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))))
