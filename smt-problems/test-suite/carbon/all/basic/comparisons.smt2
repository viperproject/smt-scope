...
(declare-fun s3 () T@U)
(declare-fun s4 () T@U)
(assert  (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type s2) (SeqType (SeqType intType)))) (= (type s1@@6) (SeqType intType))) (= (type s3) (SeqType (SeqType (SeqType intType))))) (= (type s4) (MapType2Type (SeqType (SeqType (SeqType intType))) boolType))))
(set-info :boogie-vc-id chain1In)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (|Seq#Contains| s2 s1@@6) (|Seq#Contains| s3 s2)) (and (U_2_bool (MapType2Select s4 s3)) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Seq#Contains| s2 s1@@6)) (=> (|Seq#Contains| s2 s1@@6) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (U_2_bool (MapType2Select s4 s3))) (=> (U_2_bool (MapType2Select s4 s3)) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Seq#Contains| s3 s2)) (=> (|Seq#Contains| s3 s2) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (|Seq#Contains| s1@@6 (int_2_U 3)))))))))))))))
