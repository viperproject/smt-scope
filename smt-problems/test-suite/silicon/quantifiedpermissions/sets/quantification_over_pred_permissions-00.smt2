(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:20:32
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quantifiedpermissions/sets/quantification_over_pred_permissions.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
; Final check if taken enough permissions
; Done removing quantified permissions
(declare-const sm@23@01 $PSF<inv>)
(declare-const s@24@01 $Snap)
; Definitional axioms for snapshot map domain
(assert (forall ((s@24@01 $Snap)) (!
  (and
    (=>
      (Set_in s@24@01 ($PSF.domain_inv (as sm@23@01  $PSF<inv>)))
      (and
        (Set_in (inv@19@01 ($SortWrappers.$SnapTo$Ref s@24@01)) S@1@01)
        (img@20@01 ($SortWrappers.$SnapTo$Ref s@24@01))))
    (=>
      (and
        (Set_in (inv@19@01 ($SortWrappers.$SnapTo$Ref s@24@01)) S@1@01)
        (img@20@01 ($SortWrappers.$SnapTo$Ref s@24@01)))
      (Set_in s@24@01 ($PSF.domain_inv (as sm@23@01  $PSF<inv>)))))
  :pattern ((Set_in s@24@01 ($PSF.domain_inv (as sm@23@01  $PSF<inv>))))
  :qid |qp.psmDomDef3|)))
  ...
  (=>
    (and
      (and
        (Set_in (inv@19@01 ($SortWrappers.$SnapTo$Ref s@24@01)) S@1@01)
        (img@20@01 ($SortWrappers.$SnapTo$Ref s@24@01)))
      (= ($SortWrappers.$SnapTo$Ref s@24@01) b@10@01))
    (and
      (not (= s@24@01 $Snap.unit))
      (=
        ($PSF.lookup_inv (as sm@23@01  $PSF<inv>) s@24@01)
        ($PSF.lookup_inv (as sm@17@01  $PSF<inv>) s@24@01))))
  :pattern (($PSF.lookup_inv (as sm@23@01  $PSF<inv>) s@24@01))
  :pattern (($PSF.lookup_inv (as sm@17@01  $PSF<inv>) s@24@01))
  :qid |qp.psmValDef1|)))
(assert (forall ((s@24@01 $Snap)) (!
  (=>
    (and
      ...
      (ite
        (and
          (img@5@01 ($SortWrappers.$SnapTo$Ref s@24@01))
          (Set_in (inv@4@01 ($SortWrappers.$SnapTo$Ref s@24@01)) S@1@01))
        (<
          $Perm.No
          (- $Perm.Write (pTaken@13@01 ($SortWrappers.$SnapTo$Ref s@24@01))))
        false))
    (and
      (not (= s@24@01 $Snap.unit))
      (=
        ($PSF.lookup_inv (as sm@23@01  $PSF<inv>) s@24@01)
        ($PSF.lookup_inv $t@3@01 s@24@01))))
  :pattern (($PSF.lookup_inv (as sm@23@01  $PSF<inv>) s@24@01))
  :pattern (($PSF.lookup_inv $t@3@01 s@24@01))
  :qid |qp.psmValDef2|)))
(pop) ; 2
(pop) ; 1
