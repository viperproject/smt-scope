...
(assert  (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type x@@11) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test02_client)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 x@@11 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 x@@11 f_7)) p_1)))) (=> (and (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1)) (and (state ExhaleHeap@0 Mask@1) (= (ControlFlow 0 2) (- 0 1)))) false))))
(let ((anon3_Else_correct  (=> (and (= p_1 NoPerm) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= p_1 NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= p_1 (U_2_real (MapType1Select Mask@0 x@@11 f_7)))) (=> (<= p_1 (U_2_real (MapType1Select Mask@0 x@@11 f_7))) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@11 $allocated))) (and (= p_1 NoPerm) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 6) (- 0 9)) (>= p_1 NoPerm)) (=> (>= p_1 NoPerm) (=> (and (and (=> (> p_1 NoPerm) (not (= x@@11 null))) (= Mask@0 (MapType1Store ZeroMask x@@11 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@11 f_7)) p_1))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (<= NoPerm p_1)) (=> (<= NoPerm p_1) (and (=> (= (ControlFlow 0 6) (- 0 7)) (>= p_1 NoPerm)) (=> (>= p_1 NoPerm) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))))))))
