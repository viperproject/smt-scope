...
(let ((anon22_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon11_correct)))
(let ((anon22_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@3 null (lseg (MapType0Select Heap@@14 this@@9 sibling) last@@3))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@3 null (lseg (MapType0Select Heap@@14 this@@9 sibling) last@@3)))) (=> (= (ControlFlow 0 9) 8) anon11_correct))))))
(let ((anon21_Then_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (not (= (MapType0Select Heap@@14 this@@9 sibling) null))) (=> (not (= (MapType0Select Heap@@14 this@@9 sibling) null)) (and (=> (= (ControlFlow 0 12) 9) anon22_Then_correct) (=> (= (ControlFlow 0 12) 11) anon22_Else_correct))))))
(let ((anon16_correct true))
(let ((anon15_correct  (=> (and (state Heap@2 Mask@0) (= (ControlFlow 0 3) 1)) anon16_correct)))
(let ((anon23_Else_correct  (=> (= this@@9 last@@3) (=> (and (= Heap@2 Heap@@14) (= (ControlFlow 0 5) 3)) anon15_correct))))
(let ((anon23_Then_correct  (=> (and (not (= this@@9 last@@3)) (= Heap@0 (MapType0Store Heap@@14 null (|lseg#sm| this@@9 last@@3) (MapType1Store (MapType0Select Heap@@14 null (|lseg#sm| this@@9 last@@3)) this@@9 sibling (bool_2_U true))))) (=> (and (and (forall ((o_3 T@U) (f_7 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_7))))
(let ((A@@12 (FieldTypeInv0 (type f_7))))
 (=> (and (and (= (type o_3) RefType) (= (type f_7) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@0 null (|lseg#sm| this@@9 last@@3)) o_3 f_7)) (U_2_bool (MapType1Select (MapType0Select Heap@0 null (|lseg#sm| (MapType0Select Heap@0 this@@9 sibling) last@@3)) o_3 f_7)))) (U_2_bool (MapType1Select newPMask@0 o_3 f_7)))))
 :qid |stdinbpl.674:35|
 :skolemid |62|
 :pattern ( (MapType1Select newPMask@0 o_3 f_7))
)) (= Heap@1 (MapType0Store Heap@0 null (|lseg#sm| this@@9 last@@3) newPMask@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 4) 3))) anon15_correct))))
(let ((anon21_Else_correct  (=> (|degrees#trigger| (MapType0Select Heap@@14 null (lseg (MapType0Select Heap@@14 this@@9 sibling) last@@3)) (MapType0Select Heap@@14 this@@9 sibling) last@@3) (and (=> (= (ControlFlow 0 7) 4) anon23_Then_correct) (=> (= (ControlFlow 0 7) 5) anon23_Else_correct)))))
(let ((anon20_Else_correct  (=> (not (= (MapType0Select Heap@@14 this@@9 sibling) null)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm UnfoldingMask@3 this@@9 sibling)) (=> (HasDirectPerm UnfoldingMask@3 this@@9 sibling) (and (=> (= (ControlFlow 0 14) 12) anon21_Then_correct) (=> (= (ControlFlow 0 14) 7) anon21_Else_correct)))))))
(let ((anon20_Then_correct  (=> (= (MapType0Select Heap@@14 this@@9 sibling) null) (and (=> (= (ControlFlow 0 6) 4) anon23_Then_correct) (=> (= (ControlFlow 0 6) 5) anon23_Else_correct)))))
(let ((anon6_correct  (=> (state Heap@@14 UnfoldingMask@3) (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm UnfoldingMask@3 this@@9 sibling)) (=> (HasDirectPerm UnfoldingMask@3 this@@9 sibling) (and (=> (= (ControlFlow 0 16) 6) anon20_Then_correct) (=> (= (ControlFlow 0 16) 14) anon20_Else_correct)))))))
(let ((anon19_Else_correct  (=> (= this@@9 last@@3) (=> (and (= UnfoldingMask@3 UnfoldingMask@0) (= (ControlFlow 0 19) 16)) anon6_correct))))
(let ((anon19_Then_correct  (=> (and (not (= this@@9 last@@3)) (not (= this@@9 null))) (=> (and (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this@@9 sibling (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this@@9 sibling)) FullPerm)))) (state Heap@@14 UnfoldingMask@1)) (and (not (= (MapType0Select Heap@@14 this@@9 sibling) null)) (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 null (lseg (MapType0Select Heap@@14 this@@9 sibling) last@@3) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 null (lseg (MapType0Select Heap@@14 this@@9 sibling) last@@3))) FullPerm)))))) (and (and (InsidePredicate (lseg this@@9 last@@3) (MapType0Select Heap@@14 null (lseg this@@9 last@@3)) (lseg (MapType0Select Heap@@14 this@@9 sibling) last@@3) (MapType0Select Heap@@14 null (lseg (MapType0Select Heap@@14 this@@9 sibling) last@@3))) (state Heap@@14 UnfoldingMask@2)) (and (= UnfoldingMask@3 UnfoldingMask@2) (= (ControlFlow 0 18) 16)))) anon6_correct))))
(let ((anon4_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (lseg this@@9 last@@3) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (lseg this@@9 last@@3))) FullPerm)))) (and (=> (= (ControlFlow 0 20) 18) anon19_Then_correct) (=> (= (ControlFlow 0 20) 19) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 23) 20)) anon4_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (lseg this@@9 last@@3))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (lseg this@@9 last@@3)))) (=> (= (ControlFlow 0 21) 20) anon4_correct))))))
(let ((anon17_Else_correct  (=> (not (= this@@9 last@@3)) (=> (and (|lseg#trigger| Heap@@14 (lseg this@@9 last@@3)) (= (MapType0Select Heap@@14 null (lseg this@@9 last@@3)) (FrameFragment (ite (not (= this@@9 last@@3)) (CombineFrames (FrameFragment (MapType0Select Heap@@14 this@@9 sibling)) (MapType0Select Heap@@14 null (lseg (MapType0Select Heap@@14 this@@9 sibling) last@@3))) EmptyFrame)))) (and (=> (= (ControlFlow 0 24) 21) anon18_Then_correct) (=> (= (ControlFlow 0 24) 23) anon18_Else_correct))))))
(let ((anon17_Then_correct  (=> (and (= this@@9 last@@3) (= (ControlFlow 0 2) 1)) anon16_correct)))
(let ((anon0_correct  (=> (and (and (and (state Heap@@14 ZeroMask) (U_2_bool (MapType0Select Heap@@14 this@@9 $allocated))) (and (U_2_bool (MapType0Select Heap@@14 last@@3 $allocated)) (= AssumeFunctionsAbove 0))) (and (and (not (= this@@9 null)) (= Mask@0 (MapType1Store ZeroMask null (lseg this@@9 last@@3) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (lseg this@@9 last@@3))) FullPerm))))) (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0)))) (and (=> (= (ControlFlow 0 25) 2) anon17_Then_correct) (=> (= (ControlFlow 0 25) 24) anon17_Else_correct)))))
