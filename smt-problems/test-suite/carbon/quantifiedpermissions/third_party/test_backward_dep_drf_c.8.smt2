...
(let ((anon37_Else_correct  (=> (and (not (and (>= k_9 0) (and (< k_9 (|Seq#Length| ar@@27)) (and (>= j_4 0) (and (< j_4 (|Seq#Length| ar@@27)) (not (= k_9 j_4))))))) (= (ControlFlow 0 32) 29)) anon21_correct)))
(let ((anon37_Then_correct  (=> (and (>= k_9 0) (and (< k_9 (|Seq#Length| ar@@27)) (and (>= j_4 0) (and (< j_4 (|Seq#Length| ar@@27)) (not (= k_9 j_4)))))) (and (=> (= (ControlFlow 0 30) (- 0 31)) (not (= (|Seq#Index| ar@@27 k_9) (|Seq#Index| ar@@27 j_4)))) (=> (not (= (|Seq#Index| ar@@27 k_9) (|Seq#Index| ar@@27 j_4))) (=> (= (ControlFlow 0 30) 29) anon21_correct))))))
(let ((anon36_Else_correct  (=> (and (forall ((k_10_1 Int) (j_5_1 Int) ) (!  (=> (and (>= k_10_1 0) (and (< k_10_1 (|Seq#Length| ar@@27)) (and (>= j_5_1 0) (and (< j_5_1 (|Seq#Length| ar@@27)) (not (= k_10_1 j_5_1)))))) (not (= (|Seq#Index| ar@@27 k_10_1) (|Seq#Index| ar@@27 j_5_1))))
 :qid |stdinbpl.1209:26|
 :skolemid |98|
...
(let ((anon25_Else_correct  (=> (and (forall ((k_6 Int) (j_3 Int) ) (!  (=> (and (>= k_6 0) (and (< k_6 (|Seq#Length| ar@@27)) (and (>= j_3 0) (and (< j_3 (|Seq#Length| ar@@27)) (not (= k_6 j_3)))))) (not (= (|Seq#Index| ar@@27 k_6) (|Seq#Index| ar@@27 j_3))))
 :qid |stdinbpl.1102:20|
 :skolemid |91|
...
(let ((anon26_Else_correct  (=> (and (not (and (>= k_3 0) (and (< k_3 (|Seq#Length| ar@@27)) (and (>= j_2 0) (and (< j_2 (|Seq#Length| ar@@27)) (not (= k_3 j_2))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon26_Then_correct  (=> (and (>= k_3 0) (and (< k_3 (|Seq#Length| ar@@27)) (and (>= j_2 0) (and (< j_2 (|Seq#Length| ar@@27)) (not (= k_3 j_2)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= k_3 0)) (=> (>= k_3 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< k_3 (|Seq#Length| ar@@27))) (=> (< k_3 (|Seq#Length| ar@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_2 0)) (=> (>= j_2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_2 (|Seq#Length| ar@@27))) (=> (< j_2 (|Seq#Length| ar@@27)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
