...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 6)) (not (= 1 0))) (=> (not (= 1 0)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= 1 0))) (=> (not (= 1 0)) (=> (= (ControlFlow 0 4) (- 0 3)) (not (= (div 1 1) 2)))))))))
(let ((anon3_Then_correct  (=> (and (state Heap@@75 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (not (= 1 0)))))
(let ((anon0_correct  (=> (and (state Heap@@75 ZeroMask) (= AssumeFunctionsAbove 11)) (and (=> (= (ControlFlow 0 7) 2) anon3_Then_correct) (=> (= (ControlFlow 0 7) 4) anon3_Else_correct)))))
