...
(assert  (and (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type this@@5) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |P#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (not (U_2_bool (MapType0Select Heap@@10 this@@5 b_2))) (=> (and (= Mask@2 Mask@0) (= (ControlFlow 0 3) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (and (U_2_bool (MapType0Select Heap@@10 this@@5 b_2)) (not (= this@@5 null))) (=> (and (and (= Mask@1 (MapType1Store Mask@0 this@@5 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 this@@5 f_7)) FullPerm)))) (state Heap@@10 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 2) 1))) anon2_correct))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@10 this@@5 $allocated)) (not (= this@@5 null))) (and (= Mask@0 (MapType1Store ZeroMask this@@5 b_2 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@5 b_2)) FullPerm)))) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@0 this@@5 b_2)) (=> (HasDirectPerm Mask@0 this@@5 b_2) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))))
