(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:07:26
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/sequences/nil.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
; [exec]
; var bs1: Seq[Bool]
(declare-const bs1@0@01 Seq<Bool>)
; [exec]
; var bs2: Seq[Bool]
(declare-const bs2@1@01 Seq<Bool>)
; [exec]
; bs1 := Seq[Bool]()
; [eval] Seq[Bool]()
; [exec]
...
; [eval] |bs1|
(push) ; 3
(assert (not (= (Seq_length (as Seq_empty  Seq<Bool>)) 0)))
(check-sat)
; unsat
(pop) ; 3
; 0,00s
