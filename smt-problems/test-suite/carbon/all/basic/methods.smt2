...
(assert  (and (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type r_1) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id t7)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 r_1 $allocated))) (=> (and (and (not (= r_1 null)) (= Mask@0 (MapType1Store ZeroMask r_1 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1 f_7)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= FullPerm (U_2_real (MapType1Select Mask@0 r_1 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 r_1 f_7))) (=> (and (= Heap@0 (MapType0Store Heap@@9 r_1 f_7 (int_2_U 2))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (> (U_2_real (MapType1Select Mask@0 r_1 f_7)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@0 r_1 f_7)) NoPerm) (=> (> wildcard@0 NoPerm) (=> (and (and (< wildcard@0 (U_2_real (MapType1Select Mask@0 r_1 f_7))) (= Mask@1 (MapType1Store Mask@0 r_1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 r_1 f_7)) wildcard@0))))) (and (IdenticalOnKnownLocations Heap@0 ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 r_1 f_7)) (=> (HasDirectPerm Mask@1 r_1 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (MapType0Select ExhaleHeap@0 r_1 f_7)) 2)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (> wildcard NoPerm) true) (= (ControlFlow 0 6) 2)) anon0_correct)))
