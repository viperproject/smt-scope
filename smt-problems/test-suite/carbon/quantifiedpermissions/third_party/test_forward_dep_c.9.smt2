...
(assert  (and (and (and (= (type Heap@@33) (MapType0Type RefType)) (= (type diz) RefType)) (= (type a_2) (SeqType RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id Ref__send_body_183)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@33 diz $allocated)) (not (= diz null))) (and (state Heap@@33 ZeroMask) (>= current_thread_id 0))) (and (and (state Heap@@33 ZeroMask) (<= 0 i@@34)) (and (< i@@34 (|Seq#Length| a_2)) (state Heap@@33 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (>= i@@34 0)) (=> (>= i@@34 0) (and (=> (= (ControlFlow 0 2) (- 0 6)) (< i@@34 (|Seq#Length| a_2))) (=> (< i@@34 (|Seq#Length| a_2)) (=> (= perm@0 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= (|Seq#Index| a_2 i@@34) null))) (= Mask@0 (MapType1Store ZeroMask (|Seq#Index| a_2 i@@34) Ref__Integer_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask (|Seq#Index| a_2 i@@34) Ref__Integer_value)) perm@0))))) (and (state Heap@@33 Mask@0) (state Heap@@33 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i@@34 0)) (=> (>= i@@34 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i@@34 (|Seq#Length| a_2))) (=> (< i@@34 (|Seq#Length| a_2)) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@0 (|Seq#Index| a_2 i@@34) Ref__Integer_value))))))))))))))))))
