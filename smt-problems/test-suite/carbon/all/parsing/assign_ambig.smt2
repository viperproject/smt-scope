...
(assert  (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type b_2) (SeqType RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id bar)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (> (|Seq#Length| b_2) 0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (< 0 (|Seq#Length| b_2))) (=> (< 0 (|Seq#Length| b_2)) (=> (not (= (|Seq#Index| b_2 0) null)) (=> (and (= Mask@0 (MapType1Store ZeroMask (|Seq#Index| b_2 0) f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask (|Seq#Index| b_2 0) f_7)) FullPerm)))) (state Heap@@9 Mask@0)) (=> (and (and (state Heap@@9 Mask@0) a_2) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< 0 (|Seq#Length| (|Seq#Take| b_2 1)))) (=> (< 0 (|Seq#Length| (|Seq#Take| b_2 1))) (=> (= (ControlFlow 0 2) (- 0 1)) (= FullPerm (U_2_real (MapType1Select Mask@0 (|Seq#Index| (|Seq#Take| b_2 1) 0) f_7))))))))))))))
