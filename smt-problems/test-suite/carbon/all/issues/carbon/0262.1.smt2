...
(declare-fun exists_path (T@U T@U) Bool)
(declare-fun y@@1 () T@U)
(declare-fun __learn_trigger__ (Bool) Bool)
(declare-fun foo (T@U T@U) Bool)
(declare-fun Heap@@9 () T@U)
(declare-fun from () T@U)
(assert  (and (and (= (type y@@1) RefType) (= (type Heap@@9) (MapType0Type RefType))) (= (type from) RefType)))
(set-info :boogie-vc-id append)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon6_correct true))
(let ((anon9_Else_correct  (=> (and (not (exists_path y@@1 y@@1)) (= (ControlFlow 0 4) 1)) anon6_correct)))
(let ((anon9_Then_correct  (=> (exists_path y@@1 y@@1) (and (=> (= (ControlFlow 0 2) (- 0 3)) (__learn_trigger__ (foo y@@1 y@@1))) (=> (__learn_trigger__ (foo y@@1 y@@1)) (=> (= (ControlFlow 0 2) 1) anon6_correct))))))
(let ((anon4_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 5) 2) anon9_Then_correct) (=> (= (ControlFlow 0 5) 4) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (not (exists_path y@@1 y@@1)) (= (ControlFlow 0 8) 5)) anon4_correct)))
(let ((anon8_Then_correct  (=> (exists_path y@@1 y@@1) (and (=> (= (ControlFlow 0 6) (- 0 7)) (__learn_trigger__ (foo from y@@1))) (=> (__learn_trigger__ (foo from y@@1)) (=> (= (ControlFlow 0 6) 5) anon4_correct))))))
(let ((anon2_correct  (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 9) 6) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (= from null) (= (ControlFlow 0 11) 9)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= from null)) (=> (and (forall ((x@@8 T@U) (y$0 T@U) ) (!  (=> (and (= (type x@@8) RefType) (= (type y$0) RefType)) (__learn_trigger__ (foo from y$0)))
 :qid |stdinbpl.302:24|
 :skolemid |24|
 :pattern ( (exists_path x@@8 y$0))
)) (= (ControlFlow 0 10) 9)) anon2_correct))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 from $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@9 y@@1 $allocated)) (not (= from null))) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 12) 10) anon7_Then_correct) (=> (= (ControlFlow 0 12) 11) anon7_Else_correct))))))
