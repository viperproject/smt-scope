...
(assert  (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type r_1) RefType)) (= (type Heap@@9) (MapType0Type RefType))))
...
(let ((anon3_Then_correct  (=> (not (= NoPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= NoPerm (U_2_real (MapType1Select Mask@0 r_1 f_7)))) (=> (<= NoPerm (U_2_real (MapType1Select Mask@0 r_1 f_7))) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 r_1 $allocated))) (and (<= NoPerm p_1) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (>= p_1 NoPerm)) (=> (>= p_1 NoPerm) (=> (and (and (=> (> p_1 NoPerm) (not (= r_1 null))) (= Mask@0 (MapType1Store ZeroMask r_1 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1 f_7)) p_1))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (<= NoPerm NoPerm)) (=> (<= NoPerm NoPerm) (and (=> (= (ControlFlow 0 5) (- 0 6)) (>= NoPerm NoPerm)) (=> (>= NoPerm NoPerm) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))))))))
