...
(set-info :boogie-vc-id |isGreaterOne#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon2_Else_correct true))
(let ((anon2_Then_correct  (=> (and (> i@@16 60) (= (ControlFlow 0 2) (- 0 1))) Result@0)))
(let ((anon0_correct  (=> (state Heap@@72 ZeroMask) (=> (and (and (= AssumeFunctionsAbove 12) (> i@@16 (- 0 60))) (and (state Heap@@72 ZeroMask) (= Result@0 (> i@@16 1)))) (and (=> (= (ControlFlow 0 4) 2) anon2_Then_correct) (=> (= (ControlFlow 0 4) 3) anon2_Else_correct))))))
...
(set-info :boogie-vc-id mNestedFunc)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
