...
(set-info :boogie-vc-id tripleLen1Bad_termination_proof)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_correct true))
(let ((anon4_Else_correct  (=> (not (= (Triple3_tag (get_Triple2_x (get_Triple1_x t_2@@30))) 0)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing t_2@@30 t_2@@30)) (=> (decreasing t_2@@30 t_2@@30) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded t_2@@30)) (=> (bounded t_2@@30) (=> (and (state Heap@@53 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
