...
(declare-fun owner () T@U)
(declare-fun Heap@@11 () T@U)
(declare-fun user () T@U)
(declare-fun current_thread_id () Int)
(declare-fun Mask@0 () T@U)
(declare-fun wildcard () Real)
(assert  (and (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type sys__result) RefType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type PostMask@1) (MapType1Type RefType realType))) (= (type owner) RefType)) (= (type Heap@@11) (MapType0Type RefType))) (= (type user) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id Lock__Lock)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon3_Else_correct true))
(let ((anon3_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (not (= sys__result null)) (state PostHeap@0 ZeroMask)) (and (> wildcard@0 NoPerm) (not (= sys__result null)))) (=> (and (and (and (= PostMask@0 (MapType1Store ZeroMask sys__result Lock__owner (real_2_U (+ (U_2_real (MapType1Select ZeroMask sys__result Lock__owner)) wildcard@0)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (> wildcard@1 NoPerm))) (and (and (not (= sys__result null)) (= PostMask@1 (MapType1Store PostMask@0 sys__result Lock__user (real_2_U (+ (U_2_real (MapType1Select PostMask@0 sys__result Lock__user)) wildcard@1))))) (and (state PostHeap@0 PostMask@1) (state PostHeap@0 PostMask@1)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm PostMask@1 sys__result Lock__owner)) (=> (HasDirectPerm PostMask@1 sys__result Lock__owner) (=> (= (MapType0Select PostHeap@0 sys__result Lock__owner) owner) (=> (and (state PostHeap@0 PostMask@1) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm PostMask@1 sys__result Lock__user))))))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 owner $allocated))) (and (U_2_bool (MapType0Select Heap@@11 user $allocated)) (>= current_thread_id 0))) (and (and (state Heap@@11 ZeroMask) (= Mask@0 (MapType1Store ZeroMask null (Client__inv user FullPerm) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Client__inv user FullPerm))) FullPerm))))) (and (state Heap@@11 Mask@0) (state Heap@@11 Mask@0)))) (and (=> (= (ControlFlow 0 17) 2) anon3_Then_correct) (=> (= (ControlFlow 0 17) 5) anon3_Else_correct)))))
