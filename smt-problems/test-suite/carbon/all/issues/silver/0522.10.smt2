...
(assert  (and (= (type Heap@@14) (MapType0Type RefType)) (= (type x@@34) RefType)))
(set-info :boogie-vc-id test1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@14 x@@34 $allocated))) (and (= perm@0 (/ (to_real (- 0 1)) (to_real 2))) (= (ControlFlow 0 2) (- 0 1)))) (>= perm@0 NoPerm)))))
...
(declare-fun y@@6 () T@U)
(declare-fun AssumeFunctionsAbove () Int)
(assert  (and (and (and (and (and (and (= (type xs@0) (MapType2Type RefType boolType)) (= (type x_3) RefType)) (= (type Heap@@14) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv9 arg0@@48)) RefType)
 :qid |funType:invRecv9|
 :pattern ( (invRecv9 arg0@@48))
))) (= (type xs) (MapType2Type RefType boolType))) (= (type y@@6) RefType)))
(set-info :boogie-vc-id test23b)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((x_6 T@U) (x_6_1 T@U) ) (!  (=> (and (= (type x_6) RefType) (= (type x_6_1) RefType)) (=> (and (and (and (and (not (= x_6 x_6_1)) (U_2_bool (MapType2Select xs@0 x_6))) (U_2_bool (MapType2Select xs@0 x_6_1))) (< NoPerm (permfun x_6))) (< NoPerm (permfun x_6_1))) (not (= x_6 x_6_1))))
...
))) (=> (forall ((x_6@@0 T@U) (x_6_1@@0 T@U) ) (!  (=> (and (= (type x_6@@0) RefType) (= (type x_6_1@@0) RefType)) (=> (and (and (and (and (not (= x_6@@0 x_6_1@@0)) (U_2_bool (MapType2Select xs@0 x_6@@0))) (U_2_bool (MapType2Select xs@0 x_6_1@@0))) (< NoPerm (permfun x_6@@0))) (< NoPerm (permfun x_6_1@@0))) (not (= x_6@@0 x_6_1@@0))))
 :qid |stdinbpl.1531:15|
 :skolemid |158|
...
)) (=> (forall ((x_6@@1 T@U) ) (!  (=> (= (type x_6@@1) RefType) (=> (and (U_2_bool (MapType2Select xs@0 x_6@@1)) (< NoPerm (permfun x_6@@1))) (and (qpRange9 x_6@@1) (= (invRecv9 x_6@@1) x_6@@1))))
 :qid |stdinbpl.1537:22|
 :skolemid |159|
 :pattern ( (MapType0Select Heap@@14 x_6@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_6@@1 f_7))
 :pattern ( (MapType2Select xs@0 x_6@@1))
 :pattern ( (permfun x_6@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select xs@0 (invRecv9 o_3))) (< NoPerm (permfun (invRecv9 o_3)))) (qpRange9 o_3)) (= (invRecv9 o_3) o_3)))
 :qid |stdinbpl.1541:22|
 :skolemid |160|
 :pattern ( (invRecv9 o_3))
)) (= (ControlFlow 0 9) (- 0 8))) (forall ((x_6@@2 T@U) ) (!  (=> (and (= (type x_6@@2) RefType) (U_2_bool (MapType2Select xs@0 x_6@@2))) (>= (permfun x_6@@2) NoPerm))
 :qid |stdinbpl.1547:15|
 :skolemid |161|
 :pattern ( (MapType0Select Heap@@14 x_6@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 x_6@@2 f_7))
 :pattern ( (MapType2Select xs@0 x_6@@2))
 :pattern ( (permfun x_6@@2))
))))))))
(let ((anon15_Then_correct true))
(let ((anon13_Else_correct  (=> (and (forall ((x_4_1 T@U) ) (!  (=> (and (= (type x_4_1) RefType) (U_2_bool (MapType2Select xs@0 x_4_1))) (<= NoPerm (permfun x_4_1)))
 :qid |stdinbpl.1514:20|
 :skolemid |157|
 :pattern ( (MapType2Select xs@0 x_4_1))
 :pattern ( (permfun x_4_1))
)) (state Heap@@14 ZeroMask)) (and (=> (= (ControlFlow 0 11) 7) anon15_Then_correct) (=> (= (ControlFlow 0 11) 9) anon15_Else_correct)))))
(let ((anon7_correct true))
(let ((anon14_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs@0 x_3))) (= (ControlFlow 0 6) 3)) anon7_correct)))
(let ((anon14_Then_correct  (=> (U_2_bool (MapType2Select xs@0 x_3)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= NoPerm (permfun x_3))) (=> (<= NoPerm (permfun x_3)) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (=> (forall ((x_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (U_2_bool (MapType2Select xs x_1))) (<= NoPerm (permfun x_1)))
 :qid |stdinbpl.1485:20|
 :skolemid |156|
 :pattern ( (MapType2Select xs x_1))
 :pattern ( (permfun x_1))
)) (=> (and (and (state Heap@@14 ZeroMask) (state Heap@@14 ZeroMask)) (and (= xs@0 (|Set#Union| xs (|Set#Singleton| y@@6))) (state Heap@@14 ZeroMask))) (and (and (and (=> (= (ControlFlow 0 12) 2) anon12_Then_correct) (=> (= (ControlFlow 0 12) 11) anon13_Else_correct)) (=> (= (ControlFlow 0 12) 4) anon14_Then_correct)) (=> (= (ControlFlow 0 12) 6) anon14_Else_correct))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@14 y@@6 $allocated)) (U_2_bool (MapType2Select xs y@@6))) (and (state Heap@@14 ZeroMask) (state Heap@@14 ZeroMask))) (and (=> (= (ControlFlow 0 13) 1) anon11_Then_correct) (=> (= (ControlFlow 0 13) 12) anon11_Else_correct))))))
