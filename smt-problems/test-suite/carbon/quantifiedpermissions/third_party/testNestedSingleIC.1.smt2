...
(let ((anon41_Else_correct  (=> (and (not (and (<= 0 j_12) (< j_12 (* M N)))) (= (ControlFlow 0 27) 22)) anon20_correct)))
(let ((anon41_Then_correct  (=> (and (<= 0 j_12) (< j_12 (* M N))) (and (=> (= (ControlFlow 0 23) (- 0 26)) (>= j_12 0)) (=> (>= j_12 0) (and (=> (= (ControlFlow 0 23) (- 0 25)) (< j_12 (|Seq#Length| ar@@27))) (=> (< j_12 (|Seq#Length| ar@@27)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (HasDirectPerm QPMask@1 (|Seq#Index| ar@@27 j_12) Ref__Integer_value)) (=> (HasDirectPerm QPMask@1 (|Seq#Index| ar@@27 j_12) Ref__Integer_value) (=> (= (ControlFlow 0 23) 22) anon20_correct))))))))))
(let ((anon40_Else_correct true))
(let ((anon38_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 29)) (forall ((j_5 Int) (j_5_2 Int) ) (!  (=> (and (and (and (and (not (= j_5 j_5_2)) (and (<= 0 j_5) (< j_5 (* M N)))) (and (<= 0 j_5_2) (< j_5_2 (* M N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ar@@27 j_5) (|Seq#Index| ar@@27 j_5_2))))
 :qid |stdinbpl.1976:15|
 :skolemid |167|
 ...
 :qid |stdinbpl.1976:15|
 :skolemid |167|
)) (=> (forall ((j_5@@1 Int) ) (!  (=> (and (and (<= 0 j_5@@1) (< j_5@@1 (* M N))) (< NoPerm FullPerm)) (and (qpRange10 (|Seq#Index| ar@@27 j_5@@1)) (= (invRecv10 (|Seq#Index| ar@@27 j_5@@1)) j_5@@1)))
 :qid |stdinbpl.1982:22|
 :skolemid |168|
 :pattern ( (|Seq#Index| ar@@27 j_5@@1))
 :pattern ( (|Seq#Index| ar@@27 j_5@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv10 o_3)) (< (invRecv10 o_3) (* M N))) (< NoPerm FullPerm)) (qpRange10 o_3)) (= (|Seq#Index| ar@@27 (invRecv10 o_3)) o_3)))
 ...
 :pattern ( (|Seq#Index| ar@@27 j_5@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv10 o_3@@0)) (< (invRecv10 o_3@@0) (* M N))) (< NoPerm FullPerm)) (qpRange10 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| ar@@27 (invRecv10 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 Ref__Integer_value)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 Ref__Integer_value)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv10 o_3@@0)) (< (invRecv10 o_3@@0) (* M N))) (< NoPerm FullPerm)) (qpRange10 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 Ref__Integer_value)) (U_2_real (MapType1Select ZeroMask o_3@@0 Ref__Integer_value))))))
...
(let ((anon39_Else_correct  (=> (and (not (and (<= 0 j_11) (< j_11 (* M N)))) (= (ControlFlow 0 20) 16)) anon16_correct)))
(let ((anon39_Then_correct  (=> (and (<= 0 j_11) (< j_11 (* M N))) (and (=> (= (ControlFlow 0 17) (- 0 19)) (>= j_11 0)) (=> (>= j_11 0) (and (=> (= (ControlFlow 0 17) (- 0 18)) (< j_11 (|Seq#Length| ar@@27))) (=> (< j_11 (|Seq#Length| ar@@27)) (=> (= (ControlFlow 0 17) 16) anon16_correct))))))))
(let ((anon37_Else_correct  (=> (and (forall ((i_3 Int) ) (!  (=> (and (<= 0 i_3) (and (< i_3 M) (< 0 N))) (= (* M N) (|Seq#Length| ar@@27)))
 :qid |stdinbpl.1958:20|
 :skolemid |166|
...
(let ((anon34_Else_correct  (and (=> (= (ControlFlow 0 32) (- 0 33)) (forall ((j_3 Int) (j_3_1 Int) ) (!  (=> (and (and (and (and (not (= j_3 j_3_1)) (and (<= 0 j_3) (< j_3 (* M N)))) (and (<= 0 j_3_1) (< j_3_1 (* M N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ar@@27 j_3) (|Seq#Index| ar@@27 j_3_1))))
 :qid |stdinbpl.1909:15|
 :skolemid |160|
))) (=> (forall ((j_3@@0 Int) (j_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_3@@0 j_3_1@@0)) (and (<= 0 j_3@@0) (< j_3@@0 (* M N)))) (and (<= 0 j_3_1@@0) (< j_3_1@@0 (* M N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ar@@27 j_3@@0) (|Seq#Index| ar@@27 j_3_1@@0))))
 :qid |stdinbpl.1909:15|
 :skolemid |160|
)) (=> (forall ((j_3@@1 Int) ) (!  (=> (and (and (<= 0 j_3@@1) (< j_3@@1 (* M N))) (< NoPerm FullPerm)) (and (qpRange9 (|Seq#Index| ar@@27 j_3@@1)) (= (invRecv9 (|Seq#Index| ar@@27 j_3@@1)) j_3@@1)))
 :qid |stdinbpl.1915:22|
 :skolemid |161|
 :pattern ( (|Seq#Index| ar@@27 j_3@@1))
 :pattern ( (|Seq#Index| ar@@27 j_3@@1))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (<= 0 (invRecv9 o_3@@2)) (< (invRecv9 o_3@@2) (* M N))) (< NoPerm FullPerm)) (qpRange9 o_3@@2)) (= (|Seq#Index| ar@@27 (invRecv9 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.1919:22|
 :skolemid |162|
 :pattern ( (invRecv9 o_3@@2))
)) (forall ((j_3@@2 Int) ) (!  (=> (and (<= 0 j_3@@2) (< j_3@@2 (* M N))) (not (= (|Seq#Index| ar@@27 j_3@@2) null)))
 :qid |stdinbpl.1925:22|
 :skolemid |163|
 :pattern ( (|Seq#Index| ar@@27 j_3@@2))
 :pattern ( (|Seq#Index| ar@@27 j_3@@2))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (and (<= 0 (invRecv9 o_3@@3)) (< (invRecv9 o_3@@3) (* M N))) (< NoPerm FullPerm)) (qpRange9 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| ar@@27 (invRecv9 o_3@@3)) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 Ref__Integer_value)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 Ref__Integer_value)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv9 o_3@@3)) (< (invRecv9 o_3@@3) (* M N))) (< NoPerm FullPerm)) (qpRange9 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 Ref__Integer_value)) (U_2_real (MapType1Select ZeroMask o_3@@3 Ref__Integer_value))))))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 ...
 :qid |stdinbpl.1935:29|
 :skolemid |165|
 :pattern ( (MapType1Select ZeroMask o_3@@4 f_5@@0))
 :pattern ( (MapType1Select QPMask@0 o_3@@4 f_5@@0))
))) (and (state Heap@@33 QPMask@0) (state Heap@@33 QPMask@0))) (and (=> (= (ControlFlow 0 32) 31) anon36_Then_correct) (=> (= (ControlFlow 0 32) 14) anon36_Else_correct)))))))))
(let ((anon9_correct true))
(let ((anon35_Else_correct  (=> (and (not (and (<= 0 j_10) (< j_10 (* M N)))) (= (ControlFlow 0 13) 9)) anon9_correct)))
(let ((anon35_Then_correct  (=> (and (<= 0 j_10) (< j_10 (* M N))) (and (=> (= (ControlFlow 0 10) (- 0 12)) (>= j_10 0)) (=> (>= j_10 0) (and (=> (= (ControlFlow 0 10) (- 0 11)) (< j_10 (|Seq#Length| ar@@27))) (=> (< j_10 (|Seq#Length| ar@@27)) (=> (= (ControlFlow 0 10) 9) anon9_correct))))))))
(let ((anon32_Else_correct  (=> (and (forall ((j_1_1 Int) (k_1_1 Int) ) (!  (=> (and (<= 0 j_1_1) (and (< j_1_1 (* M N)) (and (<= 0 k_1_1) (and (< k_1_1 (* M N)) (not (= j_1_1 k_1_1)))))) (not (= (|Seq#Index| ar@@27 j_1_1) (|Seq#Index| ar@@27 k_1_1))))
 :qid |stdinbpl.1891:20|
 :skolemid |159|
 :pattern ( (|Seq#Index| ar@@27 j_1_1) (|Seq#Index| ar@@27 k_1_1))
)) (state Heap@@33 ZeroMask)) (and (and (=> (= (ControlFlow 0 34) 32) anon34_Else_correct) (=> (= (ControlFlow 0 34) 10) anon35_Then_correct)) (=> (= (ControlFlow 0 34) 13) anon35_Else_correct)))))
(let ((anon5_correct true))
(let ((anon33_Else_correct  (=> (and (not (and (<= 0 j_9) (and (< j_9 (* M N)) (and (<= 0 k_15) (and (< k_15 (* M N)) (not (= j_9 k_15))))))) (= (ControlFlow 0 8) 2)) anon5_correct)))
(let ((anon33_Then_correct  (=> (and (<= 0 j_9) (and (< j_9 (* M N)) (and (<= 0 k_15) (and (< k_15 (* M N)) (not (= j_9 k_15)))))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (>= j_9 0)) (=> (>= j_9 0) (and (=> (= (ControlFlow 0 3) (- 0 6)) (< j_9 (|Seq#Length| ar@@27))) (=> (< j_9 (|Seq#Length| ar@@27)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (>= k_15 0)) (=> (>= k_15 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< k_15 (|Seq#Length| ar@@27))) (=> (< k_15 (|Seq#Length| ar@@27)) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))))))))
(let ((anon31_Else_correct  (=> (and (and (forall ((i_1 Int) ) (!  (=> (and (<= 0 i_1) (and (< i_1 M) (< 0 N))) (= (* M N) (|Seq#Length| ar@@27)))
 :qid |stdinbpl.1869:20|
 :skolemid |158|
)) (state Heap@@33 ZeroMask)) (and (<= (* M N) (|Seq#Length| ar@@27)) (state Heap@@33 ZeroMask))) (and (and (=> (= (ControlFlow 0 35) 34) anon32_Else_correct) (=> (= (ControlFlow 0 35) 3) anon33_Then_correct)) (=> (= (ControlFlow 0 35) 8) anon33_Else_correct)))))
(let ((anon31_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@33 diz $allocated))) (=> (and (and (not (= diz null)) (state Heap@@33 ZeroMask)) (and (>= current_thread_id 0) (state Heap@@33 ZeroMask))) (and (=> (= (ControlFlow 0 36) 1) anon31_Then_correct) (=> (= (ControlFlow 0 36) 35) anon31_Else_correct)))))))
