...
(declare-fun l@@44 () T@U)
(declare-fun Heap@@58 () T@U)
(assert  (and (= (type l@@44) (DListDomainTypeType intType ValDomainTypeType)) (= (type Heap@@58) (MapType0Type RefType))))
(set-info :boogie-vc-id |dlenBad#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_correct  (=> (and (= Result@0 (ite (= (DList_tag l@@44) 1) 0 (+ 1 (dlenBad Heap@@58 l@@44)))) (= (ControlFlow 0 3) (- 0 2))) (>= Result@0 0))))
(let ((anon7_Else_correct  (=> (and (|dlenBad#trigger| EmptyFrame l@@44) (= (ControlFlow 0 5) 3)) anon5_correct)))
(let ((anon6_Then_correct  (=> (and (= (DList_tag l@@44) 1) (= (ControlFlow 0 4) 3)) anon5_correct)))
(let ((anon7_Then_correct true))
(let ((anon6_Else_correct  (=> (not (= (DList_tag l@@44) 1)) (and (=> (= (ControlFlow 0 6) 1) anon7_Then_correct) (=> (= (ControlFlow 0 6) 5) anon7_Else_correct)))))
(let ((anon0_correct  (=> (and (state Heap@@58 ZeroMask) (= AssumeFunctionsAbove 1)) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))
...
(declare-fun Heap@@58 () T@U)
(declare-fun l@@44 () T@U)
(assert  (and (= (type l@@44) IntListDomainTypeType) (= (type Heap@@58) (MapType0Type RefType))))
(set-info :boogie-vc-id ilen2_termination_proof)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_correct true))
(let ((anon5_correct  (=> (and (state Heap@@58 ZeroMask) (= (ControlFlow 0 3) 1)) anon6_correct)))
(let ((anon8_Else_correct  (=> (not (= (IntList_tag (get_IntList_itail l@@44)) 1)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (decreasing (get_IntList_itail (get_IntList_itail l@@44)) l@@44)) (=> (decreasing (get_IntList_itail (get_IntList_itail l@@44)) l@@44) (and (=> (= (ControlFlow 0 5) (- 0 6)) (bounded l@@44)) (=> (bounded l@@44) (=> (and (state Heap@@58 ZeroMask) (= (ControlFlow 0 5) 3)) anon5_correct))))))))
(let ((anon8_Then_correct  (=> (and (= (IntList_tag (get_IntList_itail l@@44)) 1) (= (ControlFlow 0 4) 3)) anon5_correct)))
(let ((anon7_Else_correct  (=> (not (= (IntList_tag l@@44) 1)) (and (=> (= (ControlFlow 0 8) 4) anon8_Then_correct) (=> (= (ControlFlow 0 8) 5) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (and (= (IntList_tag l@@44) 1) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (and (state Heap@@58 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 9) 2) anon7_Then_correct) (=> (= (ControlFlow 0 9) 8) anon7_Else_correct)))))
