...
(declare-fun |loc'| (T@U T@U Int) T@U)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |loc#triggerStateless| (T@U Int) T@U)
...
(declare-fun |loc#frame| (T@U T@U Int) T@U)
...
(assert  (and (and (= (Ctor PredicateType_PType) 11) (= (Ctor FrameTypeType) 12)) (forall ((arg0@@23 T@U) (arg1@@9 Int) ) (! (= (type (P arg0@@23 arg1@@9)) (FieldType PredicateType_PType FrameTypeType))
 :qid |funType:P|
 :pattern ( (P arg0@@23 arg1@@9))
))))
(assert (forall ((s T@U) (i Int) ) (!  (=> (= (type s) RefType) (IsPredicateField (P s i)))
 :qid |stdinbpl.256:15|
 :skolemid |26|
 :pattern ( (P s i))
)))
(assert  (and (forall ((arg0@@24 T@U) (arg1@@10 T@U) (arg2@@3 Int) ) (! (= (type (|loc'| arg0@@24 arg1@@10 arg2@@3)) RefType)
 :qid |funType:loc'|
 :pattern ( (|loc'| arg0@@24 arg1@@10 arg2@@3))
)) (forall ((arg0@@25 T@U) (arg1@@11 Int) ) (! (= (type (|loc#triggerStateless| arg0@@25 arg1@@11)) RefType)
 :qid |funType:loc#triggerStateless|
 :pattern ( (|loc#triggerStateless| arg0@@25 arg1@@11))
))))
(assert (forall ((Heap@@0 T@U) (a_2 T@U) (i@@0 Int) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type a_2) RefType)) (dummyFunction (|loc#triggerStateless| a_2 i@@0)))
 :qid |stdinbpl.215:15|
 :skolemid |23|
 :pattern ( (|loc'| Heap@@0 a_2 i@@0))
)))
(assert (forall ((Heap@@1 T@U) (s@@0 T@U) (i@@1 Int) ) (!  (=> (and (= (type Heap@@1) (MapType0Type RefType)) (= (type s@@0) RefType)) (|P#everUsed| (P s@@0 i@@1)))
 :qid |stdinbpl.275:15|
 :skolemid |30|
 :pattern ( (|P#trigger| Heap@@1 (P s@@0 i@@1)))
)))
...
(assert  (and (forall ((arg0@@28 T@U) (arg1@@12 T@U) (arg2@@4 Int) ) (! (= (type (|loc#frame| arg0@@28 arg1@@12 arg2@@4)) RefType)
 :qid |funType:loc#frame|
 :pattern ( (|loc#frame| arg0@@28 arg1@@12 arg2@@4))
)) (= (type EmptyFrame) FrameTypeType)))
(assert (forall ((Heap@@4 T@U) (Mask@@2 T@U) (a_2@@0 T@U) (i@@2 Int) ) (!  (=> (and (and (and (= (type Heap@@4) (MapType0Type RefType)) (= (type Mask@@2) (MapType1Type RefType realType))) (= (type a_2@@0) RefType)) (state Heap@@4 Mask@@2)) (= (|loc'| Heap@@4 a_2@@0 i@@2) (|loc#frame| EmptyFrame a_2@@0 i@@2)))
 :qid |stdinbpl.222:15|
 :skolemid |24|
 :pattern ( (state Heap@@4 Mask@@2) (|loc'| Heap@@4 a_2@@0 i@@2))
)))
...
(assert (forall ((s@@1 T@U) (i@@3 Int) (s2 T@U) (i2 Int) ) (!  (=> (and (and (= (type s@@1) RefType) (= (type s2) RefType)) (= (P s@@1 i@@3) (P s2 i2))) (and (= s@@1 s2) (= i@@3 i2)))
 :qid |stdinbpl.266:15|
 :skolemid |28|
 :pattern ( (P s@@1 i@@3) (P s2 i2))
)))
(assert (forall ((arg0@@29 T@U) (arg1@@13 Int) ) (! (= (type (|P#sm| arg0@@29 arg1@@13)) (FieldType PredicateType_PType (MapType1Type RefType boolType)))
 :qid |funType:P#sm|
 :pattern ( (|P#sm| arg0@@29 arg1@@13))
)))
(assert (forall ((s@@2 T@U) (i@@4 Int) (s2@@0 T@U) (i2@@0 Int) ) (!  (=> (and (and (= (type s@@2) RefType) (= (type s2@@0) RefType)) (= (|P#sm| s@@2 i@@4) (|P#sm| s2@@0 i2@@0))) (and (= s@@2 s2@@0) (= i@@4 i2@@0)))
 :qid |stdinbpl.270:15|
 :skolemid |29|
 :pattern ( (|P#sm| s@@2 i@@4) (|P#sm| s2@@0 i2@@0))
)))
...
(assert (forall ((arg0@@30 Real) (arg1@@14 T@U) ) (! (= (type (ConditionalFrame arg0@@30 arg1@@14)) FrameTypeType)
...
(assert (forall ((arg0@@31 T@U) (arg1@@15 T@U) (arg2@@5 Int) ) (! (= (type (loc arg0@@31 arg1@@15 arg2@@5)) RefType)
 :qid |funType:loc|
 :pattern ( (loc arg0@@31 arg1@@15 arg2@@5))
)))
(assert (forall ((Heap@@8 T@U) (a_2@@1 T@U) (i@@5 Int) ) (!  (=> (and (= (type Heap@@8) (MapType0Type RefType)) (= (type a_2@@1) RefType)) (and (= (loc Heap@@8 a_2@@1 i@@5) (|loc'| Heap@@8 a_2@@1 i@@5)) (dummyFunction (|loc#triggerStateless| a_2@@1 i@@5))))
 :qid |stdinbpl.211:15|
 :skolemid |22|
 :pattern ( (loc Heap@@8 a_2@@1 i@@5))
)))
...
(assert (forall ((s@@3 T@U) (i@@6 Int) ) (!  (=> (= (type s@@3) RefType) (= (getPredWandId (P s@@3 i@@6)) 0))
 :qid |stdinbpl.260:15|
 :skolemid |27|
 :pattern ( (P s@@3 i@@6))
)))
...
(assert (forall ((s@@4 T@U) (i@@7 Int) ) (!  (=> (= (type s@@4) RefType) (= (PredicateMaskField (P s@@4 i@@7)) (|P#sm| s@@4 i@@7)))
 :qid |stdinbpl.252:15|
 :skolemid |25|
 :pattern ( (PredicateMaskField (P s@@4 i@@7)))
)))
...
(assert  (and (= (type Heap@@13) (MapType0Type RefType)) (= (type s@@5) RefType)))
...
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (not (= i_1 i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc Heap@@13 s@@5 i_1) (loc Heap@@13 s@@5 i_1_1))))
 :qid |stdinbpl.388:15|
 :skolemid |37|
)))))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@13 s@@5 $allocated)) (state Heap@@13 ZeroMask))) (and (and (=> (= (ControlFlow 0 5) 2) anon5_Else_correct) (=> (= (ControlFlow 0 5) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
