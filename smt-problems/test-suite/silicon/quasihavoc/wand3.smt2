(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:27:41
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quasihavoc/wand3.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
; [eval] x.f == 3
; [exec]
; quasihavoc acc(x.f, 1 / 2) --* acc(x.f, write)
(declare-const mwsf@7@01 $MWSF)
; [exec]
; assert x.f == 3
; [eval] x.f == 3
; [exec]
; apply acc(x.f, 1 / 2) --* acc(x.f, write)
; [state consolidation]
