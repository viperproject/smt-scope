...
(declare-fun |countFalseX#trigger| (T@U T@U Int) Bool)
...
(let ((anon10_Else_correct  (=> (and (|countFalseX#trigger| (FrameFragment (int_2_U (|countFalseX#condqp1| Heap@@17 a_3@@11 (+ from@@9 1)))) a_3@@11 (+ from@@9 1)) (= (ControlFlow 0 9) 7)) anon7_correct)))
(let ((anon9_Then_correct  (=> (and (= from@@9 (length a_3@@11)) (= (ControlFlow 0 8) 7)) anon7_correct)))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (<= 0 (+ from@@9 1))) (=> (<= 0 (+ from@@9 1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (<= (+ from@@9 1) (length a_3@@11))) (=> (<= (+ from@@9 1) (length a_3@@11)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((z_5 Int) (z_5_1 Int) ) (!  (=> (and (and (and (and (not (= z_5 z_5_1)) (and (<= (+ from@@9 1) z_5) (< z_5 (length a_3@@11)))) (and (<= (+ from@@9 1) z_5_1) (< z_5_1 (length a_3@@11)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@11 z_5) (loc a_3@@11 z_5_1))))
 :qid |stdinbpl.393:23|
 :skolemid |35|
 :pattern ( (neverTriggered2 z_5) (neverTriggered2 z_5_1))
))) (=> (forall ((z_5@@0 Int) (z_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= z_5@@0 z_5_1@@0)) (and (<= (+ from@@9 1) z_5@@0) (< z_5@@0 (length a_3@@11)))) (and (<= (+ from@@9 1) z_5_1@@0) (< z_5_1@@0 (length a_3@@11)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@11 z_5@@0) (loc a_3@@11 z_5_1@@0))))
 :qid |stdinbpl.393:23|
 :skolemid |35|
 :pattern ( (neverTriggered2 z_5@@0) (neverTriggered2 z_5_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((z_5@@1 Int) ) (!  (=> (and (<= (+ from@@9 1) z_5@@1) (< z_5@@1 (length a_3@@11))) (>= (U_2_real (MapType1Select QPMask@0 (loc a_3@@11 z_5@@1) val)) FullPerm))
 :qid |stdinbpl.400:23|
 :skolemid |36|
 :pattern ( (loc a_3@@11 z_5@@1))
 :pattern ( (loc a_3@@11 z_5@@1))
)))))))))))
(let ((anon9_Else_correct  (=> (not (= from@@9 (length a_3@@11))) (and (=> (= (ControlFlow 0 10) 3) anon10_Then_correct) (=> (= (ControlFlow 0 10) 9) anon10_Else_correct)))))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((z_4 Int) (z_4_1 Int) ) (!  (=> (and (and (and (and (not (= z_4 z_4_1)) (and (<= from@@9 z_4) (< z_4 (length a_3@@11)))) (and (<= from@@9 z_4_1) (< z_4_1 (length a_3@@11)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@11 z_4) (loc a_3@@11 z_4_1))))
 :qid |stdinbpl.339:15|
 :skolemid |29|
))) (=> (forall ((z_4@@0 Int) (z_4_1@@0 Int) ) (!  (=> (and (and (and (and (not (= z_4@@0 z_4_1@@0)) (and (<= from@@9 z_4@@0) (< z_4@@0 (length a_3@@11)))) (and (<= from@@9 z_4_1@@0) (< z_4_1@@0 (length a_3@@11)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@11 z_4@@0) (loc a_3@@11 z_4_1@@0))))
 :qid |stdinbpl.339:15|
 :skolemid |29|
)) (=> (forall ((z_4@@1 Int) ) (!  (=> (and (and (<= from@@9 z_4@@1) (< z_4@@1 (length a_3@@11))) (< NoPerm FullPerm)) (and (qpRange1 (loc a_3@@11 z_4@@1)) (= (invRecv1 (loc a_3@@11 z_4@@1)) z_4@@1)))
 :qid |stdinbpl.345:22|
 :skolemid |30|
 :pattern ( (loc a_3@@11 z_4@@1))
 :pattern ( (loc a_3@@11 z_4@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= from@@9 (invRecv1 o_3)) (< (invRecv1 o_3) (length a_3@@11))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (loc a_3@@11 (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.349:22|
 :skolemid |31|
 :pattern ( (invRecv1 o_3))
)) (forall ((z_4@@2 Int) ) (!  (=> (and (<= from@@9 z_4@@2) (< z_4@@2 (length a_3@@11))) (not (= (loc a_3@@11 z_4@@2) null)))
 :qid |stdinbpl.355:22|
 :skolemid |32|
 :pattern ( (loc a_3@@11 z_4@@2))
 :pattern ( (loc a_3@@11 z_4@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= from@@9 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (length a_3@@11))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@11 (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (and (and (<= from@@9 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (length a_3@@11))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.361:22|
 :skolemid |33|
...
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (=> (= (ControlFlow 0 11) 8) anon9_Then_correct) (=> (= (ControlFlow 0 11) 10) anon9_Else_correct)))))))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and (= AssumeFunctionsAbove 1) (<= 0 from@@9)) (and (<= from@@9 (length a_3@@11)) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 13) 1) anon8_Then_correct) (=> (= (ControlFlow 0 13) 11) anon8_Else_correct))))))
