...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon6_correct  (=> (and (state Heap@1 Mask@4) (state Heap@1 Mask@4)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@4 this@@11 next)) (=> (HasDirectPerm Mask@4 this@@11 next) (=> (= (ControlFlow 0 2) (- 0 1)) (not (= this@@11 (MapType0Select Heap@1 this@@11 next)))))))))
(let ((anon9_Else_correct  (=> (= (MapType0Select Heap@1 this@@11 next) null) (=> (and (= Mask@4 Mask@2) (= (ControlFlow 0 5) 2)) anon6_correct))))
(let ((anon9_Then_correct  (=> (and (not (= (MapType0Select Heap@1 this@@11 next) null)) (= Mask@3 (MapType1Store Mask@2 null (valid2 (MapType0Select Heap@1 this@@11 next)) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (valid2 (MapType0Select Heap@1 this@@11 next)))) FullPerm))))) (=> (and (and (InsidePredicate (valid2 this@@11) (MapType0Select Heap@1 null (valid2 this@@11)) (valid2 (MapType0Select Heap@1 this@@11 next)) (MapType0Select Heap@1 null (valid2 (MapType0Select Heap@1 this@@11 next)))) (state Heap@1 Mask@3)) (and (= Mask@4 Mask@3) (= (ControlFlow 0 4) 2))) anon6_correct))))
(let ((anon4_correct  (=> (not (= this@@11 null)) (=> (and (= Mask@2 (MapType1Store Mask@1 this@@11 next (real_2_U (+ (U_2_real (MapType1Select Mask@1 this@@11 next)) FullPerm)))) (state Heap@1 Mask@2)) (and (=> (= (ControlFlow 0 6) 4) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct))))))
(let ((anon8_Else_correct  (=> (HasDirectPerm Mask@1 null (valid2 this@@11)) (=> (and (= Heap@1 Heap@@11) (= (ControlFlow 0 8) 6)) anon4_correct))))
(let ((anon8_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (valid2 this@@11))) (= Heap@0 (MapType0Store Heap@@11 null (valid2 this@@11) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 7) 6))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (valid2 this@@11) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid2 this@@11))) FullPerm)))) (and (=> (= (ControlFlow 0 9) 7) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid2 this@@11))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid2 this@@11)))) (=> (= (ControlFlow 0 10) 9) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@11 this@@11 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (valid2 this@@11) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid2 this@@11))) FullPerm))))) (=> (and (and (state Heap@@11 Mask@0) (state Heap@@11 Mask@0)) (and (|valid2#trigger| Heap@@11 (valid2 this@@11)) (= (MapType0Select Heap@@11 null (valid2 this@@11)) (CombineFrames (FrameFragment (MapType0Select Heap@@11 this@@11 next)) (FrameFragment (ite (not (= (MapType0Select Heap@@11 this@@11 next) null)) (MapType0Select Heap@@11 null (valid2 (MapType0Select Heap@@11 this@@11 next))) EmptyFrame)))))) (and (=> (= (ControlFlow 0 13) 10) anon7_Then_correct) (=> (= (ControlFlow 0 13) 12) anon7_Else_correct)))))))
