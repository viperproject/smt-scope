...
(assert  (and (and (and (= (type UnfoldingMask@0) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type x@@34) RefType)) (= (type Heap@@14) (MapType0Type RefType))))
(set-info :boogie-vc-id test5)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (Q x@@34 p_1@@5) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (Q x@@34 p_1@@5))) FullPerm)))) (= (ControlFlow 0 2) (- 0 1))) (>= p_1@@5 NoPerm))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Q x@@34 p_1@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Q x@@34 p_1@@5)))) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@14 x@@34 $allocated))) (and (= Mask@0 (MapType1Store ZeroMask null (Q x@@34 p_1@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Q x@@34 p_1@@5))) FullPerm)))) (state Heap@@14 Mask@0))) (and (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0)) (and (|Q#trigger| Heap@@14 (Q x@@34 p_1@@5)) (= (MapType0Select Heap@@14 null (Q x@@34 p_1@@5)) (ConditionalFrame p_1@@5 (FrameFragment (MapType0Select Heap@@14 x@@34 f_7))))))) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))
