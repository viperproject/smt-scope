...
(declare-fun r_2 () T@U)
(assert  (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type r_2) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type r_3) RefType)) (= (type this) RefType)))
(set-info :boogie-vc-id test02a)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon9_correct true))
(let ((anon15_Else_correct  (=> (and (not (HasDirectPerm Mask@1 null (P r_3))) (= (ControlFlow 0 10) 7)) anon9_correct)))
(let ((anon15_Then_correct  (=> (HasDirectPerm Mask@1 null (P r_3)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm Mask@0 null (P r_3))) (=> (HasDirectPerm Mask@0 null (P r_3)) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
(let ((anon14_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((r_3_1 T@U) ) (!  (=> (and (= (type r_3_1) RefType) (HasDirectPerm Mask@1 null (P r_3_1))) false)
 :qid |stdinbpl.333:15|
 :skolemid |29|
 :pattern ( (MapType1Select Mask@1 null (P r_3_1)))
 :pattern ( (MapType0Select Heap@@10 null (P r_3_1)))
)))))
(let ((anon6_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (P this) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P this))) FullPerm)))) (and (and (=> (= (ControlFlow 0 11) 6) anon14_Else_correct) (=> (= (ControlFlow 0 11) 8) anon15_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon15_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 14) 11)) anon6_correct)))
(let ((anon13_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P this))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P this)))) (=> (= (ControlFlow 0 12) 11) anon6_correct))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((r_1_1 T@U) ) (!  (=> (and (= (type r_1_1) RefType) (HasDirectPerm Mask@0 null (P r_1_1))) false)
 :qid |stdinbpl.313:15|
 :skolemid |28|
 :pattern ( (MapType1Select Mask@0 null (P r_1_1)))
 :pattern ( (MapType0Select Heap@@10 null (P r_1_1)))
))) (=> (forall ((r_1_1@@0 T@U) ) (!  (=> (and (= (type r_1_1@@0) RefType) (HasDirectPerm Mask@0 null (P r_1_1@@0))) false)
 :qid |stdinbpl.313:15|
 :skolemid |28|
 :pattern ( (MapType1Select Mask@0 null (P r_1_1@@0)))
 :pattern ( (MapType0Select Heap@@10 null (P r_1_1@@0)))
)) (and (=> (= (ControlFlow 0 15) 12) anon13_Then_correct) (=> (= (ControlFlow 0 15) 14) anon13_Else_correct))))))
(let ((anon3_correct true))
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm Mask@0 null (P r_2))) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm Mask@0 null (P r_2)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 null (P r_2))) (=> (HasDirectPerm Mask@0 null (P r_2)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@10 this $allocated)) (= Mask@0 (MapType1Store ZeroMask null (P this) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P this))) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (and (=> (= (ControlFlow 0 17) 15) anon11_Else_correct) (=> (= (ControlFlow 0 17) 2) anon12_Then_correct)) (=> (= (ControlFlow 0 17) 4) anon12_Else_correct))))))
