...
(assert  (and (and (and (and (and (= (type refs@@4) (MapType0Type RefType boolType)) (= (type p_3) RefType)) (= (type s_2) RefType)) (= (type QPMask@0) (MapType2Type RefType realType))) (= (type Heap@@13) (MapType1Type RefType))) (forall ((arg0@@55 T@U) ) (! (= (type (invRecv1 arg0@@55)) RefType)
...
(let ((anon11_Else_correct  (=> (and (not (U_2_bool (MapType0Select refs@@4 s_2))) (= (ControlFlow 0 7) 3)) anon6_correct)))
(let ((anon11_Then_correct  (=> (U_2_bool (MapType0Select refs@@4 s_2)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm QPMask@0 p_3 next)) (=> (HasDirectPerm QPMask@0 p_3 next) (=> (= (ControlFlow 0 5) 3) anon6_correct))))))
(let ((anon10_Then_correct  (=> (U_2_bool (MapType0Select refs@@4 p_3)) (and (=> (= (ControlFlow 0 8) 5) anon11_Then_correct) (=> (= (ControlFlow 0 8) 7) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (not (U_2_bool (MapType0Select refs@@4 p_3))) (= (ControlFlow 0 4) 3)) anon6_correct)))
(let ((anon9_Else_correct true))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((n_3 T@U) (n_3_1 T@U) ) (!  (=> (and (= (type n_3) RefType) (= (type n_3_1) RefType)) (=> (and (and (and (and (not (= n_3 n_3_1)) (U_2_bool (MapType0Select refs@@4 n_3))) (U_2_bool (MapType0Select refs@@4 n_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3 n_3_1))))
 :qid |stdinbpl.898:15|
 :skolemid |115|
 :no-pattern (type n_3)
...
))) (=> (forall ((n_3@@0 T@U) (n_3_1@@0 T@U) ) (!  (=> (and (= (type n_3@@0) RefType) (= (type n_3_1@@0) RefType)) (=> (and (and (and (and (not (= n_3@@0 n_3_1@@0)) (U_2_bool (MapType0Select refs@@4 n_3@@0))) (U_2_bool (MapType0Select refs@@4 n_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3@@0 n_3_1@@0))))
 :qid |stdinbpl.898:15|
 :skolemid |115|
...
)) (=> (forall ((n_3@@1 T@U) ) (!  (=> (= (type n_3@@1) RefType) (=> (and (U_2_bool (MapType0Select refs@@4 n_3@@1)) (< NoPerm FullPerm)) (and (qpRange1 n_3@@1) (= (invRecv1 n_3@@1) n_3@@1))))
 :qid |stdinbpl.904:22|
 :skolemid |116|
 :pattern ( (MapType1Select Heap@@13 n_3@@1 next))
 :pattern ( (MapType2Select QPMask@0 n_3@@1 next))
 :pattern ( (MapType1Select Heap@@13 n_3@@1 next))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType0Select refs@@4 (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.908:22|
 :skolemid |117|
 :pattern ( (invRecv1 o_3))
)) (forall ((n_3@@2 T@U) ) (!  (=> (and (= (type n_3@@2) RefType) (U_2_bool (MapType0Select refs@@4 n_3@@2))) (not (= n_3@@2 null)))
 :qid |stdinbpl.914:22|
 :skolemid |118|
 :pattern ( (MapType1Select Heap@@13 n_3@@2 next))
 :pattern ( (MapType2Select QPMask@0 n_3@@2 next))
 :pattern ( (MapType1Select Heap@@13 n_3@@2 next))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType0Select refs@@4 (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@0) o_3@@0)) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 next)) (+ (U_2_real (MapType2Select ZeroMask o_3@@0 next)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select refs@@4 (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 next)) (U_2_real (MapType2Select ZeroMask o_3@@0 next))))))
 :qid |stdinbpl.920:22|
 :skolemid |119|
 :pattern ( (MapType2Select QPMask@0 o_3@@0 next))
)) (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 next))) (= (U_2_real (MapType2Select ZeroMask o_3@@1 f_5)) (U_2_real (MapType2Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.924:29|
 :skolemid |120|
...
(let ((anon0_correct  (=> (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 11) 1) anon8_Then_correct) (=> (= (ControlFlow 0 11) 9) anon8_Else_correct)))))
