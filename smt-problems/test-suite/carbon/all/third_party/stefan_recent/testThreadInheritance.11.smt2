...
(declare-fun wildcard () Real)
(assert  (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type sys__result) RefType)) (forall ((arg0@@68 T@U) ) (! (= (type (type_of arg0@@68)) TYPEDomainTypeType)
 :qid |funType:type_of|
