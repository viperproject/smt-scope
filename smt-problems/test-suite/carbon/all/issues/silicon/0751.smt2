...
(declare-fun |round'| (T@U Real) Real)
...
(declare-fun |round#trigger| (T@U Real) Bool)
(declare-fun EmptyFrame () T@U)
(declare-fun ConditionalFrame (Real T@U) T@U)
(declare-fun NoPerm () Real)
(declare-fun FullPerm () Real)
(declare-fun |round#frame| (T@U Real) Real)
...
(assert (forall ((Heap@@2 T@U) (x@@8 Real) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (real_2_U (|round#triggerStateless| x@@8))))
 :qid |stdinbpl.196:15|
 :skolemid |23|
 :pattern ( (|round'| Heap@@2 x@@8))
)))
(assert (forall ((Heap@@3 T@U) (Mask@@2 T@U) (x@@9 Real) ) (!  (=> (and (and (= (type Heap@@3) (MapType0Type RefType)) (= (type Mask@@2) (MapType1Type RefType realType))) (and (state Heap@@3 Mask@@2) (< AssumeFunctionsAbove 0))) (= (round Heap@@3 x@@9) (/ (to_real (to_int x@@9)) (to_real 2))))
 :qid |stdinbpl.202:15|
 :skolemid |24|
 :pattern ( (state Heap@@3 Mask@@2) (round Heap@@3 x@@9))
)))
...
(assert (forall ((Heap@@5 T@U) (x@@10 Real) ) (!  (=> (= (type Heap@@5) (MapType0Type RefType)) (and (= (round Heap@@5 x@@10) (|round'| Heap@@5 x@@10)) (dummyFunction (real_2_U (|round#triggerStateless| x@@10)))))
 :qid |stdinbpl.192:15|
 :skolemid |22|
 :pattern ( (round Heap@@5 x@@10))
)))
...
(assert (forall ((Heap@@8 T@U) (Mask@@6 T@U) (x@@11 Real) ) (!  (=> (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (and (state Heap@@8 Mask@@6) (or (< AssumeFunctionsAbove 0) (|round#trigger| EmptyFrame x@@11)))) (= (|round'| Heap@@8 x@@11) (/ (to_real (to_int x@@11)) (to_real 1))))
 :qid |stdinbpl.219:15|
 :skolemid |27|
 :pattern ( (state Heap@@8 Mask@@6) (|round'| Heap@@8 x@@11))
)))
...
(assert (forall ((Heap@@9 T@U) (Mask@@8 T@U) (x@@12 Real) ) (!  (=> (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@8) (MapType1Type RefType realType))) (and (state Heap@@9 Mask@@8) (or (< AssumeFunctionsAbove 0) (|round#trigger| EmptyFrame x@@12)))) (= x@@12 (/ (to_real 3) (to_real 1)))) (= (|round'| Heap@@9 x@@12) (/ (to_real 3) (to_real 2))))
 :qid |stdinbpl.215:15|
 :skolemid |26|
 :pattern ( (state Heap@@9 Mask@@8) (|round'| Heap@@9 x@@12))
)))
(assert (forall ((Heap@@10 T@U) (ExhaleHeap@@4 T@U) (Mask@@9 T@U) (pm_f@@1 T@U) ) (! (let ((C@@1 (FieldTypeInv0 (type pm_f@@1))))
 (=> (and (and (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type ExhaleHeap@@4) (MapType0Type RefType))) (= (type Mask@@9) (MapType1Type RefType realType))) (= (type pm_f@@1) (FieldType C@@1 FrameTypeType))) (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@4 Mask@@9)) (and (HasDirectPerm Mask@@9 null pm_f@@1) (IsPredicateField pm_f@@1))) (forall ((o2 T@U) (f_2@@0 T@U) ) (! (let ((B@@5 (FieldTypeInv1 (type f_2@@0))))
(let ((A@@6 (FieldTypeInv0 (type f_2@@0))))
 ...
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@4 Mask@@9) (IsPredicateField pm_f@@1))
)))
(assert (forall ((Heap@@11 T@U) (ExhaleHeap@@5 T@U) (Mask@@10 T@U) (pm_f@@2 T@U) ) (! (let ((C@@2 (FieldTypeInv0 (type pm_f@@2))))
 (=> (and (and (and (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type ExhaleHeap@@5) (MapType0Type RefType))) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type pm_f@@2) (FieldType C@@2 FrameTypeType))) (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@5 Mask@@10)) (and (HasDirectPerm Mask@@10 null pm_f@@2) (IsWandField pm_f@@2))) (forall ((o2@@0 T@U) (f_2@@1 T@U) ) (! (let ((B@@6 (FieldTypeInv1 (type f_2@@1))))
(let ((A@@7 (FieldTypeInv0 (type f_2@@1))))
 ...
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@5 Mask@@10) (IsWandField pm_f@@2))
)))
...
(assert (forall ((Heap@@12 T@U) (Mask@@12 T@U) (x@@13 Real) ) (!  (=> (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (state Heap@@12 Mask@@12)) (= (|round'| Heap@@12 x@@13) (|round#frame| EmptyFrame x@@13)))
 :qid |stdinbpl.209:15|
 :skolemid |25|
 :pattern ( (state Heap@@12 Mask@@12) (|round'| Heap@@12 x@@13))
)))
...
(declare-fun x@@14 () Real)
(declare-fun Heap@@15 () T@U)
(assert (= (type Heap@@15) (MapType0Type RefType)))
(set-info :boogie-vc-id |round#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= Result@0 (/ (to_real (to_int x@@14)) (to_real 1))))))
(let ((anon3_Else_correct  (=> (and (not (= x@@14 (/ (to_real 3) (to_real 1)))) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (= x@@14 (/ (to_real 3) (to_real 1))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= Result@0 (/ (to_real 3) (to_real 2)))) (=> (= Result@0 (/ (to_real 3) (to_real 2))) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (= AssumeFunctionsAbove 0) (= Result@0 (/ (to_real (to_int x@@14)) (to_real 2)))) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))
