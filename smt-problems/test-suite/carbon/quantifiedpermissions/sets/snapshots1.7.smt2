...
(assert  (and (and (and (and (and (and (and (and (and (and (= (type xs@@15) (MapType2Type RefType boolType)) (= (type Heap@1) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv10 arg0@@48)) RefType)
 :qid |funType:invRecv10|
 :pattern ( (invRecv10 arg0@@48))
))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Heap@@18) (MapType0Type RefType))) (forall ((arg0@@49 T@U) ) (! (= (type (invRecv9 arg0@@49)) RefType)
 :qid |funType:invRecv9|
 :pattern ( (invRecv9 arg0@@49))
))) (= (type x@@35) RefType)) (= (type y@@6) RefType)) (= (type Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test5)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon6_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((z_3 T@U) (z_3_1 T@U) ) (!  (=> (and (= (type z_3) RefType) (= (type z_3_1) RefType)) (=> (and (and (and (and (not (= z_3 z_3_1)) (U_2_bool (MapType2Select xs@@15 z_3))) (U_2_bool (MapType2Select xs@@15 z_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_3 z_3_1))))
...
)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((z_3@@1 T@U) ) (!  (=> (and (= (type z_3@@1) RefType) (U_2_bool (MapType2Select xs@@15 z_3@@1))) (>= (U_2_real (MapType1Select QPMask@0 z_3@@1 f_7)) FullPerm))
 :qid |stdinbpl.1262:17|
 :skolemid |155|
 :pattern ( (MapType0Select Heap@1 z_3@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 z_3@@1 f_7))
 :pattern ( (MapType2Select xs@@15 z_3@@1))
))) (=> (forall ((z_3@@2 T@U) ) (!  (=> (and (= (type z_3@@2) RefType) (U_2_bool (MapType2Select xs@@15 z_3@@2))) (>= (U_2_real (MapType1Select QPMask@0 z_3@@2 f_7)) FullPerm))
 :qid |stdinbpl.1262:17|
 :skolemid |155|
 :pattern ( (MapType0Select Heap@1 z_3@@2 f_7))
 :pattern ( (MapType1Select QPMask@1 z_3@@2 f_7))
 :pattern ( (MapType2Select xs@@15 z_3@@2))
)) (=> (forall ((z_3@@3 T@U) ) (!  (=> (= (type z_3@@3) RefType) (=> (and (U_2_bool (MapType2Select xs@@15 z_3@@3)) (< NoPerm FullPerm)) (and (qpRange10 z_3@@3) (= (invRecv10 z_3@@3) z_3@@3))))
 :qid |stdinbpl.1268:22|
 :skolemid |156|
 :pattern ( (MapType0Select Heap@1 z_3@@3 f_7))
 :pattern ( (MapType1Select QPMask@1 z_3@@3 f_7))
 :pattern ( (MapType2Select xs@@15 z_3@@3))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType2Select xs@@15 (invRecv10 o_3))) (and (< NoPerm FullPerm) (qpRange10 o_3))) (= (invRecv10 o_3) o_3)))
 :qid |stdinbpl.1272:22|
 :skolemid |157|
 :pattern ( (invRecv10 o_3))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType2Select xs@@15 (invRecv10 o_3@@0))) (and (< NoPerm FullPerm) (qpRange10 o_3@@0))) (and (= (invRecv10 o_3@@0) o_3@@0) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (- (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select xs@@15 (invRecv10 o_3@@0))) (and (< NoPerm FullPerm) (qpRange10 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7))))))
...
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 13)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (U_2_bool (MapType2Select xs@@15 z_1))) (U_2_bool (MapType2Select xs@@15 z_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1))))
 :qid |stdinbpl.1167:15|
 :skolemid |148|
 :no-pattern (type z_1)
...
)) (=> (forall ((z_1@@1 T@U) ) (!  (=> (= (type z_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs@@15 z_1@@1)) (< NoPerm FullPerm)) (and (qpRange9 z_1@@1) (= (invRecv9 z_1@@1) z_1@@1))))
...
)) (=> (and (and (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType2Select xs@@15 (invRecv9 o_3@@2))) (< NoPerm FullPerm)) (qpRange9 o_3@@2)) (= (invRecv9 o_3@@2) o_3@@2)))
...
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs@@15 (invRecv9 o_3@@3))) (< NoPerm FullPerm)) (qpRange9 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv9 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select xs@@15 (invRecv9 o_3@@3))) (< NoPerm FullPerm)) (qpRange9 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@3 f_7))))))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 ...
 :qid |stdinbpl.1193:29|
 :skolemid |153|
 :pattern ( (MapType1Select ZeroMask o_3@@4 f_5@@0))
 :pattern ( (MapType1Select QPMask@0 o_3@@4 f_5@@0))
)))) (and (and (state Heap@@18 QPMask@0) (state Heap@@18 QPMask@0)) (and (not (= x@@35 y@@6)) (state Heap@@18 QPMask@0)))) (and (=> (= (ControlFlow 0 7) (- 0 12)) (HasDirectPerm QPMask@0 y@@6 f_7)) (=> (HasDirectPerm QPMask@0 y@@6 f_7) (=> (and (= yf@0 (U_2_int (MapType0Select Heap@@18 y@@6 f_7))) (state Heap@@18 QPMask@0)) (and (=> (= (ControlFlow 0 7) (- 0 11)) (= FullPerm (U_2_real (MapType1Select QPMask@0 x@@35 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 x@@35 f_7))) (=> (and (= Heap@0 (MapType0Store Heap@@18 x@@35 f_7 (int_2_U 1))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 7) (- 0 10)) (HasDirectPerm QPMask@0 y@@6 f_7)) (=> (HasDirectPerm QPMask@0 y@@6 f_7) (and (=> (= (ControlFlow 0 7) (- 0 9)) (= (U_2_int (MapType0Select Heap@0 y@@6 f_7)) yf@0)) (=> (= (U_2_int (MapType0Select Heap@0 y@@6 f_7)) yf@0) (=> (state Heap@0 QPMask@0) (and (=> (= (ControlFlow 0 7) (- 0 8)) (= FullPerm (U_2_real (MapType1Select QPMask@0 y@@6 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 y@@6 f_7))) (=> (and (= Heap@1 (MapType0Store Heap@0 y@@6 f_7 (int_2_U (+ yf@0 1)))) (state Heap@1 QPMask@0)) (and (=> (= (ControlFlow 0 7) 2) anon6_Then_correct) (=> (= (ControlFlow 0 7) 4) anon6_Else_correct))))))))))))))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@18 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@18 x@@35 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@18 y@@6 $allocated)) (U_2_bool (MapType2Select xs@@15 x@@35))) (and (U_2_bool (MapType2Select xs@@15 y@@6)) (state Heap@@18 ZeroMask))) (and (=> (= (ControlFlow 0 14) 1) anon5_Then_correct) (=> (= (ControlFlow 0 14) 7) anon5_Else_correct)))))))
