...
(assert  (and (and (and (and (and (and (and (= (type Mask@0) (MapType2Type RefType realType)) (= (type this@@7) RefType)) (= (type Heap@@10) (MapType1Type RefType))) (= (type QPMask@1) (MapType2Type RefType realType))) (forall ((arg0@@47 T@U) ) (! (= (type (invRecv2 arg0@@47)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@47))
))) (= (type x@@19) RefType)) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv1 arg0@@48)) RefType)
...
(let ((anon9_Else_correct  (=> (and (not (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) x@@19))) (= (ControlFlow 0 9) 6)) anon5_correct)))
(let ((anon9_Then_correct  (=> (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) x@@19)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm QPMask@0 x@@19 left)) (=> (HasDirectPerm QPMask@0 x@@19 left) (=> (= (ControlFlow 0 7) 6) anon5_correct))))))
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm QPMask@0 this@@7 all)) (=> (HasDirectPerm QPMask@0 this@@7 all) (and (=> (= (ControlFlow 0 10) 7) anon9_Then_correct) (=> (= (ControlFlow 0 10) 9) anon9_Else_correct))))))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((x_2 T@U) (x_2_1 T@U) ) (!  (=> (and (= (type x_2) RefType) (= (type x_2_1) RefType)) (=> (and (and (and (and (not (= x_2 x_2_1)) (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) x_2)) (= (MapType1Select Heap@@10 x_2 left) null))) (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) x_2_1)) (= (MapType1Select Heap@@10 x_2_1 left) null))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= x_2 x_2_1))))
 :qid |stdinbpl.559:15|
 :skolemid |97|
 :no-pattern (type x_2)
...
))) (=> (forall ((x_2@@0 T@U) (x_2_1@@0 T@U) ) (!  (=> (and (= (type x_2@@0) RefType) (= (type x_2_1@@0) RefType)) (=> (and (and (and (and (not (= x_2@@0 x_2_1@@0)) (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) x_2@@0)) (= (MapType1Select Heap@@10 x_2@@0 left) null))) (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) x_2_1@@0)) (= (MapType1Select Heap@@10 x_2_1@@0 left) null))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= x_2@@0 x_2_1@@0))))
 :qid |stdinbpl.559:15|
 :skolemid |97|
...
)) (=> (forall ((x_2@@1 T@U) ) (!  (=> (= (type x_2@@1) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) x_2@@1)) (= (MapType1Select Heap@@10 x_2@@1 left) null)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange2 x_2@@1) (= (invRecv2 x_2@@1) x_2@@1))))
 :qid |stdinbpl.565:22|
 :skolemid |98|
 :pattern ( (MapType1Select Heap@@10 x_2@@1 left))
 :pattern ( (MapType2Select QPMask@1 x_2@@1 left))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 this@@7 all) x_2@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) (invRecv2 o_3))) (= (MapType1Select Heap@@10 (invRecv2 o_3) left) null)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.569:22|
 :skolemid |99|
 :pattern ( (invRecv2 o_3))
)) (= (ControlFlow 0 4) (- 0 3))) (forall ((x_2@@2 T@U) ) (!  (=> (= (type x_2@@2) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) x_2@@2)) (= (MapType1Select Heap@@10 x_2@@2 left) null)) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.575:15|
 :skolemid |100|
 :pattern ( (MapType1Select Heap@@10 x_2@@2 left))
 :pattern ( (MapType2Select QPMask@1 x_2@@2 left))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 this@@7 all) x_2@@2))
))))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 14)) (forall ((q_2 T@U) (q_2_1 T@U) ) (!  (=> (and (= (type q_2) RefType) (= (type q_2_1) RefType)) (=> (and (and (and (and (not (= q_2 q_2_1)) (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) q_2))) (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) q_2_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= q_2 q_2_1))))
 :qid |stdinbpl.508:15|
 :skolemid |90|
 :no-pattern (type q_2)
 :no-pattern (type q_2_1)
 :no-pattern (U_2_int q_2)
 :no-pattern (U_2_bool q_2)
 :no-pattern (U_2_int q_2_1)
 :no-pattern (U_2_bool q_2_1)
))) (=> (forall ((q_2@@0 T@U) (q_2_1@@0 T@U) ) (!  (=> (and (= (type q_2@@0) RefType) (= (type q_2_1@@0) RefType)) (=> (and (and (and (and (not (= q_2@@0 q_2_1@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) q_2@@0))) (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) q_2_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= q_2@@0 q_2_1@@0))))
 :qid |stdinbpl.508:15|
 :skolemid |90|
 :no-pattern (type q_2@@0)
 :no-pattern (type q_2_1@@0)
 :no-pattern (U_2_int q_2@@0)
 :no-pattern (U_2_bool q_2@@0)
 :no-pattern (U_2_int q_2_1@@0)
 :no-pattern (U_2_bool q_2_1@@0)
)) (=> (and (forall ((q_2@@1 T@U) ) (!  (=> (= (type q_2@@1) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) q_2@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange1 q_2@@1) (= (invRecv1 q_2@@1) q_2@@1))))
 :qid |stdinbpl.514:22|
 :skolemid |91|
 :pattern ( (MapType1Select Heap@@10 q_2@@1 left))
 :pattern ( (MapType2Select QPMask@0 q_2@@1 left))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 this@@7 all) q_2@@1))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) (invRecv1 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_3@@0)) (= (invRecv1 o_3@@0) o_3@@0)))
 :qid |stdinbpl.518:22|
 :skolemid |92|
 :pattern ( (invRecv1 o_3@@0))
))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((q_2@@2 T@U) ) (!  (=> (and (= (type q_2@@2) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) q_2@@2))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.524:15|
 :skolemid |93|
 :pattern ( (MapType1Select Heap@@10 q_2@@2 left))
 :pattern ( (MapType2Select QPMask@0 q_2@@2 left))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 this@@7 all) q_2@@2))
))) (=> (forall ((q_2@@3 T@U) ) (!  (=> (and (= (type q_2@@3) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) q_2@@3))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.524:15|
 :skolemid |93|
 :pattern ( (MapType1Select Heap@@10 q_2@@3 left))
 :pattern ( (MapType2Select QPMask@0 q_2@@3 left))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 this@@7 all) q_2@@3))
)) (=> (and (and (forall ((q_2@@4 T@U) ) (!  (=> (= (type q_2@@4) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) q_2@@4)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= q_2@@4 null))))
 :qid |stdinbpl.530:22|
 :skolemid |94|
 :pattern ( (MapType1Select Heap@@10 q_2@@4 left))
 :pattern ( (MapType2Select QPMask@0 q_2@@4 left))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 this@@7 all) q_2@@4))
)) (forall ((o_3@@1 T@U) ) (!  (=> (= (type o_3@@1) RefType) (and (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) (invRecv1 o_3@@1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_3@@1)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv1 o_3@@1) o_3@@1)) (= (U_2_real (MapType2Select QPMask@0 o_3@@1 left)) (+ (U_2_real (MapType2Select Mask@0 o_3@@1 left)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) (invRecv1 o_3@@1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_3@@1))) (= (U_2_real (MapType2Select QPMask@0 o_3@@1 left)) (U_2_real (MapType2Select Mask@0 o_3@@1 left))))))
 :qid |stdinbpl.536:22|
 :skolemid |95|
 :pattern ( (MapType2Select QPMask@0 o_3@@1 left))
))) (and (forall ((o_3@@2 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@2) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 left))) (= (U_2_real (MapType2Select Mask@0 o_3@@2 f_5)) (U_2_real (MapType2Select QPMask@0 o_3@@2 f_5))))))
 :qid |stdinbpl.540:29|
 :skolemid |96|
 :pattern ( (MapType2Select Mask@0 o_3@@2 f_5))
 :pattern ( (MapType2Select QPMask@0 o_3@@2 f_5))
)) (state Heap@@10 QPMask@0))) (and (=> (= (ControlFlow 0 12) 10) anon8_Then_correct) (=> (= (ControlFlow 0 12) 4) anon8_Else_correct))))))))))
(let ((anon7_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@0 this@@7 all))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (U_2_bool (MapType1Select Heap@@10 this@@7 $allocated)) (not (= this@@7 null))) (and (= Mask@0 (MapType2Store ZeroMask this@@7 all (real_2_U (+ (U_2_real (MapType2Select ZeroMask this@@7 all)) FullPerm)))) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 15) 2) anon7_Then_correct) (=> (= (ControlFlow 0 15) 12) anon7_Else_correct))))))
