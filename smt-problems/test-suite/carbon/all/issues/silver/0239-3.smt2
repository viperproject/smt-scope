...
(declare-fun i@@6 () Int)
(declare-fun leftArray () T@U)
(declare-fun rightArray () T@U)
...
(declare-fun i$0 () Int)
(declare-fun j@@5 () Int)
(declare-fun tree () T@U)
(assert  (and (and (and (and (and (= (type array) (SeqType RefType)) (= (type leftArray) (SeqType RefType))) (= (type rightArray) (SeqType RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type tree) RefType)))
(set-info :boogie-vc-id foo)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 31) (let ((anon15_correct true))
(let ((anon24_Else_correct  (=> (and (not (and (<= 0 (- (- i@@6 (|Seq#Length| leftArray)) 1)) (< (- (- i@@6 (|Seq#Length| leftArray)) 1) (|Seq#Length| rightArray)))) (= (ControlFlow 0 25) 21)) anon15_correct)))
(let ((anon24_Then_correct  (=> (and (<= 0 (- (- i@@6 (|Seq#Length| leftArray)) 1)) (< (- (- i@@6 (|Seq#Length| leftArray)) 1) (|Seq#Length| rightArray))) (and (=> (= (ControlFlow 0 22) (- 0 24)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 22) (- 0 23)) (< i@@6 (|Seq#Length| array))) (=> (< i@@6 (|Seq#Length| array)) (=> (= (ControlFlow 0 22) 21) anon15_correct))))))))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 (- (- i_1 (|Seq#Length| leftArray)) 1)) (< (- (- i_1 (|Seq#Length| leftArray)) 1) (|Seq#Length| rightArray)))) (and (<= 0 (- (- i_1_1 (|Seq#Length| leftArray)) 1)) (< (- (- i_1_1 (|Seq#Length| leftArray)) 1) (|Seq#Length| rightArray)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| array i_1) (|Seq#Index| array i_1_1))))
 :qid |stdinbpl.704:17|
 :skolemid |66|
 :pattern ( (neverTriggered2 i_1) (neverTriggered2 i_1_1))
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= 0 (- (- i_1@@0 (|Seq#Length| leftArray)) 1)) (< (- (- i_1@@0 (|Seq#Length| leftArray)) 1) (|Seq#Length| rightArray)))) (and (<= 0 (- (- i_1_1@@0 (|Seq#Length| leftArray)) 1)) (< (- (- i_1_1@@0 (|Seq#Length| leftArray)) 1) (|Seq#Length| rightArray)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| array i_1@@0) (|Seq#Index| array i_1_1@@0))))
 :qid |stdinbpl.704:17|
 :skolemid |66|
 :pattern ( (neverTriggered2 i_1@@0) (neverTriggered2 i_1_1@@0))
)) (=> (= (ControlFlow 0 19) (- 0 18)) (forall ((i_1@@1 Int) ) (!  (=> (and (<= 0 (- (- i_1@@1 (|Seq#Length| leftArray)) 1)) (< (- (- i_1@@1 (|Seq#Length| leftArray)) 1) (|Seq#Length| rightArray))) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| array i_1@@1) value)) FullPerm))
 :qid |stdinbpl.711:17|
 :skolemid |67|
 :pattern ( (|Seq#Index| array i_1@@1))
 :pattern ( (|Seq#Index| array i_1@@1))
)))))))
(let ((anon21_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((i$1_3 Int) (i$1_3_1 Int) ) (!  (=> (and (and (and (and (not (= i$1_3 i$1_3_1)) (and (<= 0 i$1_3) (< i$1_3 (|Seq#Length| array)))) (and (<= 0 i$1_3_1) (< i$1_3_1 (|Seq#Length| array)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| array i$1_3) (|Seq#Index| array i$1_3_1))))
 :qid |stdinbpl.638:15|
 :skolemid |60|
))) (=> (forall ((i$1_3@@0 Int) (i$1_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i$1_3@@0 i$1_3_1@@0)) (and (<= 0 i$1_3@@0) (< i$1_3@@0 (|Seq#Length| array)))) (and (<= 0 i$1_3_1@@0) (< i$1_3_1@@0 (|Seq#Length| array)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| array i$1_3@@0) (|Seq#Index| array i$1_3_1@@0))))
 :qid |stdinbpl.638:15|
 :skolemid |60|
)) (=> (forall ((i$1_3@@1 Int) ) (!  (=> (and (and (<= 0 i$1_3@@1) (< i$1_3@@1 (|Seq#Length| array))) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index| array i$1_3@@1)) (= (invRecv1 (|Seq#Index| array i$1_3@@1)) i$1_3@@1)))
 :qid |stdinbpl.644:22|
 :skolemid |61|
 :pattern ( (|Seq#Index| array i$1_3@@1))
 :pattern ( (|Seq#Index| array i$1_3@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv1 o_3)) (< (invRecv1 o_3) (|Seq#Length| array))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (|Seq#Index| array (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.648:22|
 :skolemid |62|
 :pattern ( (invRecv1 o_3))
)) (forall ((i$1_3@@2 Int) ) (!  (=> (and (<= 0 i$1_3@@2) (< i$1_3@@2 (|Seq#Length| array))) (not (= (|Seq#Index| array i$1_3@@2) null)))
 :qid |stdinbpl.654:22|
 :skolemid |63|
 :pattern ( (|Seq#Index| array i$1_3@@2))
 :pattern ( (|Seq#Index| array i$1_3@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (|Seq#Length| array))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| array (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 value)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 value)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (|Seq#Length| array))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 value)) (U_2_real (MapType1Select ZeroMask o_3@@0 value))))))
 :qid |stdinbpl.660:22|
 :skolemid |64|
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 value))) (= (U_2_real (MapType1Select ZeroMask o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.664:29|
 :skolemid |65|
 :pattern ( (MapType1Select ZeroMask o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 26) 19) anon23_Else_correct) (=> (= (ControlFlow 0 26) 22) anon24_Then_correct)) (=> (= (ControlFlow 0 26) 25) anon24_Else_correct)))))))))
(let ((anon11_correct true))
(let ((anon22_Else_correct  (=> (and (not (and (<= 0 i$1_2) (< i$1_2 (|Seq#Length| array)))) (= (ControlFlow 0 17) 13)) anon11_correct)))
(let ((anon22_Then_correct  (=> (and (<= 0 i$1_2) (< i$1_2 (|Seq#Length| array))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= i$1_2 0)) (=> (>= i$1_2 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< i$1_2 (|Seq#Length| array))) (=> (< i$1_2 (|Seq#Length| array)) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))
(let ((anon19_Else_correct  (=> (forall ((i$1_1 Int) ) (!  (=> (and (<= 0 i$1_1) (< i$1_1 (|Seq#Length| array))) (not (= (|Seq#Index| array i$1_1) null)))
 :qid |stdinbpl.621:20|
 :skolemid |59|
 :pattern ( (|Seq#Index| array i$1_1))
...
(let ((anon20_Else_correct  (=> (and (not (and (<= 0 i$1) (< i$1 (|Seq#Length| array)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon20_Then_correct  (=> (and (<= 0 i$1) (< i$1 (|Seq#Length| array))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i$1 0)) (=> (>= i$1 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i$1 (|Seq#Length| array))) (=> (< i$1 (|Seq#Length| array)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon17_Else_correct  (=> (forall ((i$0_1 Int) (j_1 Int) ) (!  (=> (and (and (<= 0 i$0_1) (< i$0_1 (|Seq#Length| array))) (and (and (<= 0 j_1) (< j_1 (|Seq#Length| array))) (not (= i$0_1 j_1)))) (not (= (|Seq#Index| array i$0_1) (|Seq#Index| array j_1))))
 :qid |stdinbpl.606:20|
 :skolemid |58|
 :pattern ( (|Seq#Index| array i$0_1) (|Seq#Index| array j_1))
...
(let ((anon18_Else_correct  (=> (and (not (and (and (<= 0 i$0) (< i$0 (|Seq#Length| array))) (and (and (<= 0 j@@5) (< j@@5 (|Seq#Length| array))) (not (= i$0 j@@5))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon18_Then_correct  (=> (and (and (<= 0 i$0) (< i$0 (|Seq#Length| array))) (and (and (<= 0 j@@5) (< j@@5 (|Seq#Length| array))) (not (= i$0 j@@5)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i$0 0)) (=> (>= i$0 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i$0 (|Seq#Length| array))) (=> (< i$0 (|Seq#Length| array)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j@@5 (|Seq#Length| array))) (=> (< j@@5 (|Seq#Length| array)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 tree $allocated))) (and (and (=> (= (ControlFlow 0 30) 29) anon17_Else_correct) (=> (= (ControlFlow 0 30) 2) anon18_Then_correct)) (=> (= (ControlFlow 0 30) 7) anon18_Else_correct)))))
