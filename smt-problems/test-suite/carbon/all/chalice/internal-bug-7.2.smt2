...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (Ctor RefType) 8)) (= (type n) (FieldType NormalFieldType RefType))))
(assert (distinct $allocated n)
)
...
(= (type (MapType1Store arg0@@22 arg1@@8 arg2@@2 arg3@@0)) (MapType1Type aVar0@@0 aVar1@@0))))
 ...
 :weight 0
)))) (= (type null) RefType)) (= (Ctor PredicateType_PType) 11)) (= (Ctor FrameTypeType) 12)) (forall ((arg0@@23 T@U) ) (! (= (type (P arg0@@23)) (FieldType PredicateType_PType FrameTypeType))
 :qid |funType:P|
 :pattern ( (P arg0@@23))
))))
(assert (forall ((Heap T@U) (Mask T@U) (this T@U) ) (!  (=> (and (and (and (= (type Heap) (MapType0Type RefType)) (= (type Mask) (MapType1Type RefType realType))) (= (type this) RefType)) (and (state Heap Mask) (or (< AssumeFunctionsAbove 0) (|length#trigger| (MapType0Select Heap null (P this)) this)))) (>= (|length'| Heap this) 1))
 :qid |stdinbpl.216:15|
 :skolemid |26|
...
(assert (forall ((this@@0 T@U) ) (!  (=> (= (type this@@0) RefType) (IsPredicateField (P this@@0)))
 :qid |stdinbpl.340:15|
 :skolemid |29|
 :pattern ( (P this@@0))
)))
...
(assert (forall ((Heap@@4 T@U) (this@@2 T@U) ) (!  (=> (and (= (type Heap@@4) (MapType0Type RefType)) (= (type this@@2) RefType)) (|P#everUsed| (P this@@2)))
 :qid |stdinbpl.359:15|
 :skolemid |33|
 :pattern ( (|P#trigger| Heap@@4 (P this@@2)))
)))
...
(assert (forall ((this@@4 T@U) (this2 T@U) ) (!  (=> (and (and (= (type this@@4) RefType) (= (type this2) RefType)) (= (P this@@4) (P this2))) (= this@@4 this2))
 :qid |stdinbpl.350:15|
 :skolemid |31|
...
(assert (forall ((this@@5 T@U) (this2@@0 T@U) ) (!  (=> (and (and (= (type this@@5) RefType) (= (type this2@@0) RefType)) (= (|P#sm| this@@5) (|P#sm| this2@@0))) (= this@@5 this2@@0))
 :qid |stdinbpl.354:15|
 :skolemid |32|
...
(assert (forall ((Heap@@9 T@U) (Mask@@6 T@U) (this@@6 T@U) ) (!  (=> (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (= (type this@@6) RefType)) (and (state Heap@@9 Mask@@6) (< AssumeFunctionsAbove 0))) (= (length Heap@@9 this@@6) (+ 1 (ite (= (MapType0Select Heap@@9 this@@6 n) null) 0 (|length'| Heap@@9 (MapType0Select Heap@@9 this@@6 n))))))
 :qid |stdinbpl.203:15|
 :skolemid |24|
 :pattern ( (state Heap@@9 Mask@@6) (length Heap@@9 this@@6))
 :pattern ( (state Heap@@9 Mask@@6) (|length#triggerStateless| this@@6) (|P#trigger| Heap@@9 (P this@@6)))
)))
...
(assert (forall ((this@@7 T@U) ) (!  (=> (= (type this@@7) RefType) (= (getPredWandId (P this@@7)) 0))
 :qid |stdinbpl.344:15|
 :skolemid |30|
 :pattern ( (P this@@7))
)))
...
(assert (forall ((Heap@@12 T@U) (Mask@@11 T@U) (this@@8 T@U) ) (!  (=> (and (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (= (type this@@8) RefType)) (state Heap@@12 Mask@@11)) (= (|length'| Heap@@12 this@@8) (|length#frame| (MapType0Select Heap@@12 null (P this@@8)) this@@8)))
 :qid |stdinbpl.210:15|
 :skolemid |25|
 :pattern ( (state Heap@@12 Mask@@11) (|length'| Heap@@12 this@@8))
 :pattern ( (state Heap@@12 Mask@@11) (|length#triggerStateless| this@@8) (|P#trigger| Heap@@12 (P this@@8)))
)))
...
(assert (forall ((this@@9 T@U) ) (!  (=> (= (type this@@9) RefType) (= (PredicateMaskField (P this@@9)) (|P#sm| this@@9)))
 :qid |stdinbpl.336:15|
 :skolemid |28|
 :pattern ( (PredicateMaskField (P this@@9)))
)))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon13_correct  (=> (state Heap@2 Mask@0) (=> (and (= Result@0 (+ 1 (ite (= (MapType0Select Heap@2 this@@10 n) null) 0 (length Heap@2 (MapType0Select Heap@2 this@@10 n))))) (= (ControlFlow 0 6) (- 0 5))) (>= Result@0 1)))))
(let ((anon19_Else_correct  (=> (= (MapType0Select Heap@0 this@@10 n) null) (=> (and (= Heap@2 Heap@0) (= (ControlFlow 0 8) 6)) anon13_correct))))
(let ((anon19_Then_correct  (=> (not (= (MapType0Select Heap@0 this@@10 n) null)) (=> (and (and (forall ((o_3 T@U) (f_7 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_7))))
(let ((A@@12 (FieldTypeInv0 (type f_7))))
 (=> (and (and (= (type o_3) RefType) (= (type f_7) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@0 null (|P#sm| this@@10)) o_3 f_7)) (U_2_bool (MapType1Select (MapType0Select Heap@0 null (|P#sm| (MapType0Select Heap@0 this@@10 n))) o_3 f_7)))) (U_2_bool (MapType1Select newPMask@0 o_3 f_7)))))
 :qid |stdinbpl.311:33|
 :skolemid |27|
 :pattern ( (MapType1Select newPMask@0 o_3 f_7))
)) (= Heap@1 (MapType0Store Heap@0 null (|P#sm| this@@10) newPMask@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 7) 6))) anon13_correct))))
(let ((anon11_correct  (=> (= Heap@0 (MapType0Store Heap@@15 null (|P#sm| this@@10) (MapType1Store (MapType0Select Heap@@15 null (|P#sm| this@@10)) this@@10 n (bool_2_U true)))) (and (=> (= (ControlFlow 0 9) 7) anon19_Then_correct) (=> (= (ControlFlow 0 9) 8) anon19_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (|length#trigger| (MapType0Select Heap@@15 null (P (MapType0Select Heap@@15 this@@10 n))) (MapType0Select Heap@@15 this@@10 n)) (= (ControlFlow 0 11) 9)) anon11_correct)))
(let ((anon16_Then_correct  (=> (and (= (MapType0Select Heap@@15 this@@10 n) null) (= (ControlFlow 0 10) 9)) anon11_correct)))
(let ((anon9_correct true))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon9_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@3 null (P (MapType0Select Heap@@15 this@@10 n)))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@3 null (P (MapType0Select Heap@@15 this@@10 n))))) (=> (= (ControlFlow 0 2) 1) anon9_correct))))))
(let ((anon16_Else_correct  (=> (not (= (MapType0Select Heap@@15 this@@10 n) null)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm UnfoldingMask@3 this@@10 n)) (=> (HasDirectPerm UnfoldingMask@3 this@@10 n) (and (and (=> (= (ControlFlow 0 12) 11) anon17_Else_correct) (=> (= (ControlFlow 0 12) 2) anon18_Then_correct)) (=> (= (ControlFlow 0 12) 4) anon18_Else_correct)))))))
(let ((anon4_correct  (=> (state Heap@@15 UnfoldingMask@3) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm UnfoldingMask@3 this@@10 n)) (=> (HasDirectPerm UnfoldingMask@3 this@@10 n) (and (=> (= (ControlFlow 0 14) 10) anon16_Then_correct) (=> (= (ControlFlow 0 14) 12) anon16_Else_correct)))))))
(let ((anon15_Else_correct  (=> (= (MapType0Select Heap@@15 this@@10 n) null) (=> (and (= UnfoldingMask@3 UnfoldingMask@1) (= (ControlFlow 0 17) 14)) anon4_correct))))
(let ((anon15_Then_correct  (=> (and (not (= (MapType0Select Heap@@15 this@@10 n) null)) (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 null (P (MapType0Select Heap@@15 this@@10 n)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 null (P (MapType0Select Heap@@15 this@@10 n)))) FullPerm))))) (=> (and (and (InsidePredicate (P this@@10) (MapType0Select Heap@@15 null (P this@@10)) (P (MapType0Select Heap@@15 this@@10 n)) (MapType0Select Heap@@15 null (P (MapType0Select Heap@@15 this@@10 n)))) (state Heap@@15 UnfoldingMask@2)) (and (= UnfoldingMask@3 UnfoldingMask@2) (= (ControlFlow 0 16) 14))) anon4_correct))))
(let ((anon2_correct  (=> (and (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (P this@@10) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P this@@10))) FullPerm)))) (not (= this@@10 null))) (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this@@10 n (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this@@10 n)) FullPerm)))) (state Heap@@15 UnfoldingMask@1))) (and (=> (= (ControlFlow 0 18) 16) anon15_Then_correct) (=> (= (ControlFlow 0 18) 17) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 21) 18)) anon2_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P this@@10))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P this@@10)))) (=> (= (ControlFlow 0 19) 18) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@15 ZeroMask) (U_2_bool (MapType0Select Heap@@15 this@@10 $allocated))) (and (= AssumeFunctionsAbove 0) (= Mask@0 (MapType1Store ZeroMask null (P this@@10) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P this@@10))) FullPerm)))))) (and (and (state Heap@@15 Mask@0) (state Heap@@15 Mask@0)) (and (|P#trigger| Heap@@15 (P this@@10)) (= (MapType0Select Heap@@15 null (P this@@10)) (CombineFrames (FrameFragment (MapType0Select Heap@@15 this@@10 n)) (FrameFragment (ite (not (= (MapType0Select Heap@@15 this@@10 n) null)) (MapType0Select Heap@@15 null (P (MapType0Select Heap@@15 this@@10 n))) EmptyFrame))))))) (and (=> (= (ControlFlow 0 22) 19) anon14_Then_correct) (=> (= (ControlFlow 0 22) 21) anon14_Else_correct)))))
