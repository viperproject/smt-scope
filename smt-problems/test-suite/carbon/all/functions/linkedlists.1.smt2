...
(declare-fun |ascending#trigger| (T@U T@U) Bool)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 32) (let ((anon13_correct  (=> (and (= UnfoldingMask@5 (MapType1Store UnfoldingMask@4 null (list (MapType0Select Heap@@47 xs@@42 next)) (real_2_U (- (U_2_real (MapType1Select UnfoldingMask@4 null (list (MapType0Select Heap@@47 xs@@42 next)))) FullPerm)))) (= (ControlFlow 0 14) (- 0 13))) (not (= (MapType0Select Heap@@47 xs@@42 next) null)))))
(let ((anon25_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 17) 14)) anon13_correct)))
(let ((anon25_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (list (MapType0Select Heap@@47 xs@@42 next)))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (list (MapType0Select Heap@@47 xs@@42 next))))) (=> (= (ControlFlow 0 15) 14) anon13_correct))))))
(let ((anon8_correct  (=> (and (= UnfoldingMask@6 (MapType1Store UnfoldingMask@4 null (list (MapType0Select Heap@@47 xs@@42 next)) (real_2_U (- (U_2_real (MapType1Select UnfoldingMask@4 null (list (MapType0Select Heap@@47 xs@@42 next)))) FullPerm)))) (= (ControlFlow 0 8) (- 0 7))) (not (= (MapType0Select Heap@@47 xs@@42 next) null)))))
(let ((anon22_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon8_correct)))
(let ((anon22_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (list (MapType0Select Heap@@47 xs@@42 next)))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (list (MapType0Select Heap@@47 xs@@42 next))))) (=> (= (ControlFlow 0 9) 8) anon8_correct))))))
(let ((anon17_correct true))
(let ((anon26_Else_correct  (=> (= (MapType0Select Heap@1 xs@@42 next) null) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 3) 1)) anon17_correct))))
(let ((anon26_Then_correct  (=> (not (= (MapType0Select Heap@1 xs@@42 next) null)) (=> (and (and (forall ((o_11 T@U) (f_15 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_15))))
(let ((A@@12 (FieldTypeInv0 (type f_15))))
 (=> (and (and (= (type o_11) RefType) (= (type f_15) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|list#sm| xs@@42)) o_11 f_15)) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|list#sm| (MapType0Select Heap@1 xs@@42 next))) o_11 f_15)))) (U_2_bool (MapType1Select newPMask@0 o_11 f_15)))))
 :qid |stdinbpl.1825:33|
 :skolemid |103|
 :pattern ( (MapType1Select newPMask@0 o_11 f_15))
)) (= Heap@2 (MapType0Store Heap@1 null (|list#sm| xs@@42) newPMask@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 2) 1))) anon17_correct))))
(let ((anon15_correct  (=> (and (= Heap@0 (MapType0Store Heap@@47 null (|list#sm| xs@@42) (MapType1Store (MapType0Select Heap@@47 null (|list#sm| xs@@42)) xs@@42 next (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|list#sm| xs@@42) (MapType1Store (MapType0Select Heap@0 null (|list#sm| xs@@42)) xs@@42 val (bool_2_U true))))) (and (=> (= (ControlFlow 0 4) 2) anon26_Then_correct) (=> (= (ControlFlow 0 4) 3) anon26_Else_correct)))))
(let ((anon24_Else_correct  (=> (and (|ascending#trigger| (MapType0Select Heap@@47 null (list (MapType0Select Heap@@47 xs@@42 next))) (MapType0Select Heap@@47 xs@@42 next)) (= (ControlFlow 0 12) 4)) anon15_correct)))
(let ((anon23_Then_correct  (=> (<= (U_2_int (MapType0Select Heap@@47 xs@@42 val)) (head Heap@@47 (MapType0Select Heap@@47 xs@@42 next))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm UnfoldingMask@4 xs@@42 next)) (=> (HasDirectPerm UnfoldingMask@4 xs@@42 next) (and (and (=> (= (ControlFlow 0 18) 12) anon24_Else_correct) (=> (= (ControlFlow 0 18) 15) anon25_Then_correct)) (=> (= (ControlFlow 0 18) 17) anon25_Else_correct)))))))
(let ((anon23_Else_correct  (=> (and (< (head Heap@@47 (MapType0Select Heap@@47 xs@@42 next)) (U_2_int (MapType0Select Heap@@47 xs@@42 val))) (= (ControlFlow 0 6) 4)) anon15_correct)))
(let ((anon20_Then_correct  (=> (not (= (MapType0Select Heap@@47 xs@@42 next) null)) (and (=> (= (ControlFlow 0 20) (- 0 22)) (HasDirectPerm UnfoldingMask@4 xs@@42 val)) (=> (HasDirectPerm UnfoldingMask@4 xs@@42 val) (and (=> (= (ControlFlow 0 20) (- 0 21)) (HasDirectPerm UnfoldingMask@4 xs@@42 next)) (=> (HasDirectPerm UnfoldingMask@4 xs@@42 next) (and (and (and (=> (= (ControlFlow 0 20) 18) anon23_Then_correct) (=> (= (ControlFlow 0 20) 6) anon23_Else_correct)) (=> (= (ControlFlow 0 20) 9) anon22_Then_correct)) (=> (= (ControlFlow 0 20) 11) anon22_Else_correct)))))))))
(let ((anon20_Else_correct  (=> (and (= (MapType0Select Heap@@47 xs@@42 next) null) (= (ControlFlow 0 5) 4)) anon15_correct)))
(let ((anon4_correct  (=> (state Heap@@47 UnfoldingMask@4) (and (=> (= (ControlFlow 0 23) (- 0 24)) (HasDirectPerm UnfoldingMask@4 xs@@42 next)) (=> (HasDirectPerm UnfoldingMask@4 xs@@42 next) (and (=> (= (ControlFlow 0 23) 20) anon20_Then_correct) (=> (= (ControlFlow 0 23) 5) anon20_Else_correct)))))))
(let ((anon19_Else_correct  (=> (= (MapType0Select Heap@@47 xs@@42 next) null) (=> (and (= UnfoldingMask@4 UnfoldingMask@2) (= (ControlFlow 0 26) 23)) anon4_correct))))
(let ((anon19_Then_correct  (=> (not (= (MapType0Select Heap@@47 xs@@42 next) null)) (=> (and (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 null (list (MapType0Select Heap@@47 xs@@42 next)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 null (list (MapType0Select Heap@@47 xs@@42 next)))) FullPerm)))) (InsidePredicate (list xs@@42) (MapType0Select Heap@@47 null (list xs@@42)) (list (MapType0Select Heap@@47 xs@@42 next)) (MapType0Select Heap@@47 null (list (MapType0Select Heap@@47 xs@@42 next))))) (=> (and (and (state Heap@@47 UnfoldingMask@3) (not (= (MapType0Select Heap@@47 xs@@42 next) null))) (and (= UnfoldingMask@4 UnfoldingMask@3) (= (ControlFlow 0 25) 23))) anon4_correct)))))
(let ((anon2_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (list xs@@42) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (list xs@@42))) FullPerm)))) (=> (and (not (= xs@@42 null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 xs@@42 next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 xs@@42 next)) FullPerm))))) (=> (and (and (state Heap@@47 UnfoldingMask@1) (not (= xs@@42 null))) (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 xs@@42 val (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 xs@@42 val)) FullPerm)))) (state Heap@@47 UnfoldingMask@2))) (and (=> (= (ControlFlow 0 27) 25) anon19_Then_correct) (=> (= (ControlFlow 0 27) 26) anon19_Else_correct)))))))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 30) 27)) anon2_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 28) (- 0 29)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@42))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@42)))) (=> (= (ControlFlow 0 28) 27) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@47 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@47 xs@@42 $allocated)) (= AssumeFunctionsAbove 3)) (and (= Mask@0 (MapType1Store ZeroMask null (list xs@@42) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (list xs@@42))) FullPerm)))) (state Heap@@47 Mask@0))) (and (and (not (= xs@@42 null)) (state Heap@@47 Mask@0)) (and (|list#trigger| Heap@@47 (list xs@@42)) (= (MapType0Select Heap@@47 null (list xs@@42)) (CombineFrames (FrameFragment (MapType0Select Heap@@47 xs@@42 next)) (CombineFrames (FrameFragment (MapType0Select Heap@@47 xs@@42 val)) (FrameFragment (ite (not (= (MapType0Select Heap@@47 xs@@42 next) null)) (MapType0Select Heap@@47 null (list (MapType0Select Heap@@47 xs@@42 next))) EmptyFrame)))))))) (and (=> (= (ControlFlow 0 31) 28) anon18_Then_correct) (=> (= (ControlFlow 0 31) 30) anon18_Else_correct))))))
