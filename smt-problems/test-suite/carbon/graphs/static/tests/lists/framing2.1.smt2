...
(declare-fun roots@@4 () T@U)
(declare-fun n$1_5 () T@U)
(declare-fun qpRange2 (T@U) Bool)
(declare-fun invRecv2 (T@U) T@U)
(assert  (and (and (and (and (and (and (and (= (type g@@10) (MapType2Type RefType boolType)) (= (type n$1_5) RefType)) (= (type Heap@@27) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type n_11) RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type roots@@4) (MapType2Type RefType boolType))) (forall ((arg0@@58 T@U) ) (! (= (type (invRecv2 arg0@@58)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@58))
))))
(set-info :boogie-vc-id |is_global_sroot#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon20_Then_correct  (and (=> (= (ControlFlow 0 13) (- 0 15)) (forall ((n$0_5 T@U) ) (!  (=> (= (type n$0_5) RefType) (=> (and (U_2_bool (MapType2Select g@@10 n$0_5)) (dummyFunction (MapType0Select Heap@@27 n$0_5 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.1013:25|
 :skolemid |132|
 :pattern ( (MapType0Select Heap@@27 n$0_5 next))
 :pattern ( (MapType1Select QPMask@1 n$0_5 next))
 :pattern ( (MapType0Select Heap@@27 n$0_5 next))
))) (=> (forall ((n$0_5@@0 T@U) ) (!  (=> (= (type n$0_5@@0) RefType) (=> (and (U_2_bool (MapType2Select g@@10 n$0_5@@0)) (dummyFunction (MapType0Select Heap@@27 n$0_5@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.1013:25|
 :skolemid |132|
 :pattern ( (MapType0Select Heap@@27 n$0_5@@0 next))
 :pattern ( (MapType1Select QPMask@1 n$0_5@@0 next))
 :pattern ( (MapType0Select Heap@@27 n$0_5@@0 next))
)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((n$0_5@@1 T@U) (n$0_5_1 T@U) ) (!  (=> (and (= (type n$0_5@@1) RefType) (= (type n$0_5_1) RefType)) (=> (and (and (and (and (not (= n$0_5@@1 n$0_5_1)) (U_2_bool (MapType2Select g@@10 n$0_5@@1))) (U_2_bool (MapType2Select g@@10 n$0_5_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_5@@1 n$0_5_1))))
 :qid |stdinbpl.1020:25|
 :skolemid |133|
 :pattern ( (neverTriggered3 n$0_5@@1) (neverTriggered3 n$0_5_1))
))) (=> (forall ((n$0_5@@2 T@U) (n$0_5_1@@0 T@U) ) (!  (=> (and (= (type n$0_5@@2) RefType) (= (type n$0_5_1@@0) RefType)) (=> (and (and (and (and (not (= n$0_5@@2 n$0_5_1@@0)) (U_2_bool (MapType2Select g@@10 n$0_5@@2))) (U_2_bool (MapType2Select g@@10 n$0_5_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_5@@2 n$0_5_1@@0))))
 :qid |stdinbpl.1020:25|
 :skolemid |133|
 :pattern ( (neverTriggered3 n$0_5@@2) (neverTriggered3 n$0_5_1@@0))
)) (=> (= (ControlFlow 0 13) (- 0 12)) (forall ((n$0_5@@3 T@U) ) (!  (=> (and (= (type n$0_5@@3) RefType) (U_2_bool (MapType2Select g@@10 n$0_5@@3))) (>= (U_2_real (MapType1Select QPMask@0 n$0_5@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.1027:25|
 :skolemid |134|
 :pattern ( (MapType0Select Heap@@27 n$0_5@@3 next))
 :pattern ( (MapType1Select QPMask@1 n$0_5@@3 next))
 :pattern ( (MapType0Select Heap@@27 n$0_5@@3 next))
)))))))))
(let ((anon12_correct true))
(let ((anon19_Then_correct  (=> (U_2_bool (MapType2Select g@@10 n_11)) (and (=> (= (ControlFlow 0 16) 13) anon20_Then_correct) (=> (= (ControlFlow 0 16) 10) anon12_correct)))))
(let ((anon19_Else_correct  (=> (and (not (U_2_bool (MapType2Select g@@10 n_11))) (= (ControlFlow 0 11) 10)) anon12_correct)))
(let ((anon18_Else_correct true))
(let ((anon15_Else_correct  (=> (and (and (forall ((n$1_3 T@U) ) (!  (=> (= (type n$1_3) RefType) (=> (and (U_2_bool (MapType2Select g@@10 n$1_3)) (not (= (MapType0Select Heap@@27 n$1_3 next) null))) (U_2_bool (MapType2Select g@@10 (MapType0Select Heap@@27 n$1_3 next)))))
 :qid |stdinbpl.992:20|
 :skolemid |131|
 :pattern ( (MapType2Select g@@10 (MapType0Select Heap@@27 n$1_3 next)))
 :pattern ( (MapType2Select g@@10 n$1_3) (MapType0Select Heap@@27 n$1_3 next))
)) (state Heap@@27 QPMask@0)) (and (|Set#Subset| roots@@4 g@@10) (state Heap@@27 QPMask@0))) (and (and (=> (= (ControlFlow 0 17) 9) anon18_Else_correct) (=> (= (ControlFlow 0 17) 16) anon19_Then_correct)) (=> (= (ControlFlow 0 17) 11) anon19_Else_correct)))))
(let ((anon7_correct true))
(let ((anon17_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g@@10 n$1_5)) (not (= (MapType0Select Heap@@27 n$1_5 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon17_Then_correct  (=> (and (U_2_bool (MapType2Select g@@10 n$1_5)) (not (= (MapType0Select Heap@@27 n$1_5 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 n$1_5 next)) (=> (HasDirectPerm QPMask@0 n$1_5 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon16_Else_correct  (=> (not (U_2_bool (MapType2Select g@@10 n$1_5))) (and (=> (= (ControlFlow 0 8) 3) anon17_Then_correct) (=> (= (ControlFlow 0 8) 5) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (U_2_bool (MapType2Select g@@10 n$1_5)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm QPMask@0 n$1_5 next)) (=> (HasDirectPerm QPMask@0 n$1_5 next) (and (=> (= (ControlFlow 0 6) 3) anon17_Then_correct) (=> (= (ControlFlow 0 6) 5) anon17_Else_correct)))))))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((n$0_4 T@U) (n$0_4_1 T@U) ) (!  (=> (and (= (type n$0_4) RefType) (= (type n$0_4_1) RefType)) (=> (and (and (and (and (not (= n$0_4 n$0_4_1)) (U_2_bool (MapType2Select g@@10 n$0_4))) (U_2_bool (MapType2Select g@@10 n$0_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_4 n$0_4_1))))
 :qid |stdinbpl.947:15|
 :skolemid |125|
 :no-pattern (type n$0_4)
 :no-pattern (type n$0_4_1)
 :no-pattern (U_2_int n$0_4)
 :no-pattern (U_2_bool n$0_4)
 :no-pattern (U_2_int n$0_4_1)
 :no-pattern (U_2_bool n$0_4_1)
))) (=> (forall ((n$0_4@@0 T@U) (n$0_4_1@@0 T@U) ) (!  (=> (and (= (type n$0_4@@0) RefType) (= (type n$0_4_1@@0) RefType)) (=> (and (and (and (and (not (= n$0_4@@0 n$0_4_1@@0)) (U_2_bool (MapType2Select g@@10 n$0_4@@0))) (U_2_bool (MapType2Select g@@10 n$0_4_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_4@@0 n$0_4_1@@0))))
 :qid |stdinbpl.947:15|
 :skolemid |125|
 :no-pattern (type n$0_4@@0)
 :no-pattern (type n$0_4_1@@0)
 :no-pattern (U_2_int n$0_4@@0)
 :no-pattern (U_2_bool n$0_4@@0)
 :no-pattern (U_2_int n$0_4_1@@0)
 :no-pattern (U_2_bool n$0_4_1@@0)
)) (=> (and (forall ((n$0_4@@1 T@U) ) (!  (=> (= (type n$0_4@@1) RefType) (=> (and (U_2_bool (MapType2Select g@@10 n$0_4@@1)) (< NoPerm FullPerm)) (and (qpRange2 n$0_4@@1) (= (invRecv2 n$0_4@@1) n$0_4@@1))))
 :qid |stdinbpl.953:22|
 :skolemid |126|
 :pattern ( (MapType0Select Heap@@27 n$0_4@@1 next))
 :pattern ( (MapType1Select QPMask@0 n$0_4@@1 next))
 :pattern ( (MapType0Select Heap@@27 n$0_4@@1 next))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select g@@10 (invRecv2 o_3))) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.957:22|
 :skolemid |127|
 :pattern ( (invRecv2 o_3))
))) (=> (and (and (forall ((n$0_4@@2 T@U) ) (!  (=> (and (= (type n$0_4@@2) RefType) (U_2_bool (MapType2Select g@@10 n$0_4@@2))) (not (= n$0_4@@2 null)))
 :qid |stdinbpl.963:22|
 :skolemid |128|
 :pattern ( (MapType0Select Heap@@27 n$0_4@@2 next))
 :pattern ( (MapType1Select QPMask@0 n$0_4@@2 next))
 :pattern ( (MapType0Select Heap@@27 n$0_4@@2 next))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select g@@10 (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 next)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select g@@10 (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (U_2_real (MapType1Select ZeroMask o_3@@0 next))))))
 :qid |stdinbpl.969:22|
 :skolemid |129|
...
)) (state Heap@@27 QPMask@0))) (and (and (=> (= (ControlFlow 0 18) 17) anon15_Else_correct) (=> (= (ControlFlow 0 18) 6) anon16_Then_correct)) (=> (= (ControlFlow 0 18) 8) anon16_Else_correct))))))))
(let ((anon14_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@27 ZeroMask) (=> (and (= AssumeFunctionsAbove 1) (not (U_2_bool (MapType2Select g@@10 null)))) (and (=> (= (ControlFlow 0 20) 1) anon14_Then_correct) (=> (= (ControlFlow 0 20) 18) anon14_Else_correct))))))
