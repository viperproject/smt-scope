...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 31) (let ((anon20_Else_correct  (=> (= __flatten_2@0 (Ref__multidim_index_2 Heap@@17 M step 0 0)) (=> (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0)) (and (=> (= (ControlFlow 0 24) (- 0 26)) (>= __flatten_2@0 0)) (=> (>= __flatten_2@0 0) (and (=> (= (ControlFlow 0 24) (- 0 25)) (< __flatten_2@0 (|Seq#Length| matrix))) (=> (< __flatten_2@0 (|Seq#Length| matrix)) (=> (and (and (= __flatten_3@0 (|Seq#Index| matrix __flatten_2@0)) (state Heap@@17 QPMask@0)) (and (state Heap@@17 QPMask@0) (= (ControlFlow 0 24) (- 0 23)))) (= FullPerm (U_2_real (MapType1Select QPMask@0 __flatten_3@0 Ref__Integer_value))))))))))))
(let ((anon20_Then_correct  (and (=> (= (ControlFlow 0 19) (- 0 22)) (< 0 M)) (=> (< 0 M) (and (=> (= (ControlFlow 0 19) (- 0 21)) (<= 0 M)) (=> (<= 0 M) (and (=> (= (ControlFlow 0 19) (- 0 20)) (< 0 step)) (=> (< 0 step) (=> (= (ControlFlow 0 19) (- 0 18)) (<= 0 step))))))))))
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) (forall ((j1_1 Int) (j1_1_1 Int) ) (!  (=> (and (and (and (and (not (= j1_1 j1_1_1)) (and (<= 0 j1_1) (and (< j1_1 (* M step)) (< (mod j1_1 step) N)))) (and (<= 0 j1_1_1) (and (< j1_1_1 (* M step)) (< (mod j1_1_1 step) N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| matrix j1_1) (|Seq#Index| matrix j1_1_1))))
 :qid |stdinbpl.739:15|
 :skolemid |67|
...
)) (state Heap@@17 QPMask@0)) (and (state Heap@@17 QPMask@0) (U_2_bool (MapType0Select Heap@@17 __flatten_3 $allocated))))) (and (=> (= (ControlFlow 0 27) 19) anon20_Then_correct) (=> (= (ControlFlow 0 27) 24) anon20_Else_correct)))))))
...
)) (state Heap@@17 ZeroMask)) (and (and (=> (= (ControlFlow 0 29) 27) anon16_Else_correct) (=> (= (ControlFlow 0 29) 17) anon17_Then_correct)) (=> (= (ControlFlow 0 29) 13) anon17_Else_correct)))))
...
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@17 diz $allocated))) (=> (and (and (not (= diz null)) (state Heap@@17 ZeroMask)) (and (>= current_thread_id 0) (state Heap@@17 ZeroMask))) (=> (and (and (and (> M 0) (> N 0)) (and (> step N) (state Heap@@17 ZeroMask))) (and (and (<= N step) (state Heap@@17 ZeroMask)) (and (<= (* M step) (|Seq#Length| matrix)) (state Heap@@17 ZeroMask)))) (and (and (=> (= (ControlFlow 0 30) 29) anon14_Else_correct) (=> (= (ControlFlow 0 30) 2) anon15_Then_correct)) (=> (= (ControlFlow 0 30) 7) anon15_Else_correct))))))))
