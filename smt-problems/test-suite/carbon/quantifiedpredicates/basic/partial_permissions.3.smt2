...
(assert  (and (and (and (= (type xs) (SeqType RefType)) (= (type Heap@@10) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type r_1@@5) RefType)))
(set-info :boogie-vc-id t6)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_Else_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 4) (- 0 7)) (forall ((x_3 T@U) ) (!  (=> (and (= (type x_3) RefType) (|Seq#Contains| xs x_3)) (> (U_2_real (MapType1Select ZeroMask x_3 f_7)) NoPerm))
 :qid |stdinbpl.2202:15|
 :skolemid |238|
 :no-pattern (type x_3)
 :no-pattern (U_2_int x_3)
 :no-pattern (U_2_bool x_3)
))) (=> (forall ((x_3@@0 T@U) ) (!  (=> (and (= (type x_3@@0) RefType) (|Seq#Contains| xs x_3@@0)) (> (U_2_real (MapType1Select ZeroMask x_3@@0 f_7)) NoPerm))
 :qid |stdinbpl.2202:15|
 :skolemid |238|
 :no-pattern (type x_3@@0)
 :no-pattern (U_2_int x_3@@0)
 :no-pattern (U_2_bool x_3@@0)
)) (=> (forall ((x_3@@1 T@U) ) (!  (=> (and (= (type x_3@@1) RefType) (|Seq#Contains| xs x_3@@1)) (< wildcard@0 (U_2_real (MapType1Select ZeroMask x_3@@1 f_7))))
 :qid |stdinbpl.2206:20|
 :skolemid |239|
 :no-pattern (type x_3@@1)
 :no-pattern (U_2_int x_3@@1)
 :no-pattern (U_2_bool x_3@@1)
)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((x_3@@2 T@U) ) (!  (=> (= (type x_3@@2) RefType) (=> (and (|Seq#Contains| xs x_3@@2) (dummyFunction (MapType0Select Heap@@10 x_3@@2 f_7))) (>= wildcard@0 NoPerm)))
 :qid |stdinbpl.2213:17|
 :skolemid |240|
 :pattern ( (MapType0Select Heap@@10 x_3@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 x_3@@2 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs x_3@@2))
 :pattern ( (|Seq#Contains| xs x_3@@2))
))) (=> (forall ((x_3@@3 T@U) ) (!  (=> (= (type x_3@@3) RefType) (=> (and (|Seq#Contains| xs x_3@@3) (dummyFunction (MapType0Select Heap@@10 x_3@@3 f_7))) (>= wildcard@0 NoPerm)))
 :qid |stdinbpl.2213:17|
 :skolemid |240|
 :pattern ( (MapType0Select Heap@@10 x_3@@3 f_7))
 :pattern ( (MapType1Select QPMask@0 x_3@@3 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs x_3@@3))
 :pattern ( (|Seq#Contains| xs x_3@@3))
)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((x_3@@4 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3@@4) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3@@4 x_3_1)) (|Seq#Contains| xs x_3@@4)) (|Seq#Contains| xs x_3_1)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_3@@4 x_3_1))))
 :qid |stdinbpl.2220:17|
 :skolemid |241|
 :pattern ( (neverTriggered23 x_3@@4) (neverTriggered23 x_3_1))
))) (=> (forall ((x_3@@5 T@U) (x_3_1@@0 T@U) ) (!  (=> (and (= (type x_3@@5) RefType) (= (type x_3_1@@0) RefType)) (=> (and (and (and (and (not (= x_3@@5 x_3_1@@0)) (|Seq#Contains| xs x_3@@5)) (|Seq#Contains| xs x_3_1@@0)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_3@@5 x_3_1@@0))))
 :qid |stdinbpl.2220:17|
 :skolemid |241|
 :pattern ( (neverTriggered23 x_3@@5) (neverTriggered23 x_3_1@@0))
)) (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((x_3@@6 T@U) ) (!  (=> (and (= (type x_3@@6) RefType) (|Seq#Contains| xs x_3@@6)) (> (U_2_real (MapType1Select ZeroMask x_3@@6 f_7)) NoPerm))
 :qid |stdinbpl.2227:17|
 :skolemid |242|
 :pattern ( (MapType0Select Heap@@10 x_3@@6 f_7))
 :pattern ( (MapType1Select QPMask@0 x_3@@6 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs x_3@@6))
 :pattern ( (|Seq#Contains| xs x_3@@6))
)))))))))))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (forall ((x_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (|Seq#Contains| xs x_1)) (not (= x_1 null)))
 :qid |stdinbpl.2183:20|
 :skolemid |237|
 :pattern ( (|Seq#ContainsTrigger| xs x_1))
 :pattern ( (|Seq#Contains| xs x_1))
)) (=> (and (state Heap@@10 ZeroMask) (state Heap@@10 ZeroMask)) (and (=> (= (ControlFlow 0 8) 2) anon6_Then_correct) (=> (= (ControlFlow 0 8) 4) anon6_Else_correct))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 r_1@@5 $allocated))) (and (|Seq#Contains| xs r_1@@5) (state Heap@@10 ZeroMask))) (and (=> (= (ControlFlow 0 9) 1) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct)))))
