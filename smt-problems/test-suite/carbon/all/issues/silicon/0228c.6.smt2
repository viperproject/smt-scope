...
(assert  (and (and (and (and (and (and (and (and (and (and (= (type Mask@3) (MapType1Type RefType realType)) (= (type x@@18) RefType)) (= (type Heap@1) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@17) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@0) (MapType1Type RefType realType))) (forall ((arg0@@28 T@U) (arg1@@10 T@U) ) (! (= (type (CombineFrames arg0@@28 arg1@@10)) FrameTypeType)
...
(let ((anon28_Then_correct  (=> (and (<= 0 i_3) (< i_3 10)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (fun Heap@1 (U_2_int (MapType0Select Heap@1 x@@18 f_7)) i_3)) (=> (fun Heap@1 (U_2_int (MapType0Select Heap@1 x@@18 f_7)) i_3) (=> (= (ControlFlow 0 13) 12) anon17_correct))))))
(let ((anon26_Then_correct true))
(let ((anon13_correct true))
(let ((anon25_Then_correct  (=> (and (<= 0 i_9) (< i_9 10)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm Mask@3 x@@18 f_7)) (=> (HasDirectPerm Mask@3 x@@18 f_7) (and (=> (= (ControlFlow 0 10) 9) anon26_Then_correct) (=> (= (ControlFlow 0 10) 7) anon13_correct)))))))
(let ((anon25_Else_correct  (=> (and (not (and (<= 0 i_9) (< i_9 10))) (= (ControlFlow 0 8) 7)) anon13_correct)))
(let ((anon27_Else_correct true))
(let ((anon21_Else_correct  (=> (forall ((i_1_1 Int) ) (!  (=> (and (<= 0 i_1_1) (< i_1_1 10)) (fun Heap@1 (U_2_int (MapType0Select Heap@1 x@@18 f_7)) i_1_1))
 :qid |stdinbpl.890:20|
 :skolemid |41|
 :pattern ( (|fun#frame| EmptyFrame (U_2_int (MapType0Select Heap@1 x@@18 f_7)) i_1_1))
...
(let ((anon22_Then_correct  (=> (and (<= 0 i_8) (< i_8 10)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@3 x@@18 f_7)) (=> (HasDirectPerm Mask@3 x@@18 f_7) (and (=> (= (ControlFlow 0 4) 3) anon23_Then_correct) (=> (= (ControlFlow 0 4) 1) anon8_correct)))))))
(let ((anon22_Else_correct  (=> (and (not (and (<= 0 i_8) (< i_8 10))) (= (ControlFlow 0 2) 1)) anon8_correct)))
(let ((anon4_correct  (=> (= perm@0 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 17) (- 0 19)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= x@@18 null))) (= Mask@2 (MapType1Store Mask@1 x@@18 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@1 x@@18 f_7)) perm@0))))) (and (state Heap@1 Mask@2) (= perm@1 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (=> (> perm@1 NoPerm) (not (= x@@18 null))) (= Mask@3 (MapType1Store Mask@2 x@@18 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@2 x@@18 f_7)) perm@1))))) (=> (and (and (state Heap@1 Mask@3) (state Heap@1 Mask@3)) (and (state Heap@1 Mask@3) (state Heap@1 Mask@3))) (and (and (=> (= (ControlFlow 0 17) 16) anon21_Else_correct) (=> (= (ControlFlow 0 17) 4) anon22_Then_correct)) (=> (= (ControlFlow 0 17) 2) anon22_Else_correct))))))))))))
(let ((anon20_Else_correct  (=> (HasDirectPerm Mask@1 null (pred x@@18)) (=> (and (= Heap@1 Heap@@17) (= (ControlFlow 0 21) 17)) anon4_correct))))
(let ((anon20_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (pred x@@18))) (= Heap@0 (MapType0Store Heap@@17 null (pred x@@18) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 20) 17))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (pred x@@18) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (pred x@@18))) FullPerm)))) (and (=> (= (ControlFlow 0 22) 20) anon20_Then_correct) (=> (= (ControlFlow 0 22) 21) anon20_Else_correct)))))
(let ((anon19_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 25) 22)) anon2_correct)))
(let ((anon19_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pred x@@18))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pred x@@18)))) (=> (= (ControlFlow 0 23) 22) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@17 x@@18 $allocated))) (and (= Mask@0 (MapType1Store ZeroMask null (pred x@@18) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (pred x@@18))) FullPerm)))) (state Heap@@17 Mask@0))) (and (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)) (and (|pred#trigger| Heap@@17 (pred x@@18)) (= (MapType0Select Heap@@17 null (pred x@@18)) (CombineFrames (FrameFragment (MapType0Select Heap@@17 x@@18 f_7)) (FrameFragment (MapType0Select Heap@@17 x@@18 f_7))))))) (and (=> (= (ControlFlow 0 26) 23) anon19_Then_correct) (=> (= (ControlFlow 0 26) 25) anon19_Else_correct))))))
