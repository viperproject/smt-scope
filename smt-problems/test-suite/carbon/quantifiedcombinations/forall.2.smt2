...
(assert  (and (and (and (and (and (and (and (and (and (and (= (type xs) (SeqType RefType)) (= (type Heap@@10) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@37 T@U) ) (! (= (type (invRecv29 arg0@@37)) RefType)
 :qid |funType:invRecv29|
 :pattern ( (invRecv29 arg0@@37))
))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (forall ((arg0@@38 T@U) ) (! (= (type (invRecv27 arg0@@38)) RefType)
 :qid |funType:invRecv27|
 :pattern ( (invRecv27 arg0@@38))
))) (= (type QPMask@4) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@39 T@U) ) (! (= (type (invRecv26 arg0@@39)) RefType)
 :qid |funType:invRecv26|
 :pattern ( (invRecv26 arg0@@39))
))) (forall ((arg0@@40 T@U) ) (! (= (type (invRecv25 arg0@@40)) RefType)
 :qid |funType:invRecv25|
 :pattern ( (invRecv25 arg0@@40))
))))
(set-info :boogie-vc-id m6)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon15_Else_correct  (=> (= (ControlFlow 0 11) (- 0 10)) (forall ((x_13 T@U) (x_13_2 T@U) ) (!  (=> (and (= (type x_13) RefType) (= (type x_13_2) RefType)) (=> (and (and (and (and (not (= x_13 x_13_2)) (|Seq#Contains| xs x_13)) (|Seq#Contains| xs x_13_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_13 x_13_2))))
 :qid |stdinbpl.2139:17|
 :skolemid |229|
 :pattern ( (neverTriggered28 x_13) (neverTriggered28 x_13_2))
)))))
(let ((anon15_Then_correct true))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((x_9 T@U) (x_9_2 T@U) ) (!  (=> (and (= (type x_9) RefType) (= (type x_9_2) RefType)) (=> (and (and (and (and (not (= x_9 x_9_2)) (|Seq#Contains| xs x_9)) (|Seq#Contains| xs x_9_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_9 x_9_2))))
 :qid |stdinbpl.2098:17|
 :skolemid |223|
 :pattern ( (neverTriggered27 x_9) (neverTriggered27 x_9_2))
))) (=> (forall ((x_9@@0 T@U) (x_9_2@@0 T@U) ) (!  (=> (and (= (type x_9@@0) RefType) (= (type x_9_2@@0) RefType)) (=> (and (and (and (and (not (= x_9@@0 x_9_2@@0)) (|Seq#Contains| xs x_9@@0)) (|Seq#Contains| xs x_9_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_9@@0 x_9_2@@0))))
 :qid |stdinbpl.2098:17|
 :skolemid |223|
 :pattern ( (neverTriggered27 x_9@@0) (neverTriggered27 x_9_2@@0))
)) (=> (and (forall ((x_9@@1 T@U) ) (!  (=> (= (type x_9@@1) RefType) (=> (and (|Seq#Contains| xs x_9@@1) (< NoPerm FullPerm)) (and (= (invRecv27 x_9@@1) x_9@@1) (qpRange27 x_9@@1))))
 :qid |stdinbpl.2104:22|
 :skolemid |224|
 :pattern ( (MapType0Select PostHeap@0 null (pred x_9@@1)))
 :pattern ( (MapType1Select ZeroMask null (pred x_9@@1)))
 :pattern ( (|Seq#ContainsTrigger| xs x_9@@1))
 :pattern ( (|Seq#Contains| xs x_9@@1))
)) (forall ((x_10_1 T@U) ) (!  (=> (= (type x_10_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv27 x_10_1)) (< NoPerm FullPerm)) (qpRange27 x_10_1)) (= (invRecv27 x_10_1) x_10_1)))
 :qid |stdinbpl.2108:22|
 :skolemid |225|
 :pattern ( (invRecv27 x_10_1))
))) (=> (and (and (forall ((x_10_1@@0 T@U) ) (!  (=> (= (type x_10_1@@0) RefType) (=> (and (and (|Seq#Contains| xs (invRecv27 x_10_1@@0)) (< NoPerm FullPerm)) (qpRange27 x_10_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv27 x_10_1@@0) x_10_1@@0)) (= (U_2_real (MapType1Select QPMask@4 null (pred x_10_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (pred x_10_1@@0))) FullPerm)))))
 :qid |stdinbpl.2114:22|
 :skolemid |226|
 :pattern ( (MapType1Select QPMask@4 null (pred x_10_1@@0)))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.2120:29|
 :skolemid |227|
 :pattern ( (MapType1Select ZeroMask o_3 f_5))
 :pattern ( (MapType1Select QPMask@4 o_3 f_5))
))) (and (forall ((x_10_1@@1 T@U) ) (!  (=> (and (= (type x_10_1@@1) RefType) (not (and (and (|Seq#Contains| xs (invRecv27 x_10_1@@1)) (< NoPerm FullPerm)) (qpRange27 x_10_1@@1)))) (= (U_2_real (MapType1Select QPMask@4 null (pred x_10_1@@1))) (U_2_real (MapType1Select ZeroMask null (pred x_10_1@@1)))))
 :qid |stdinbpl.2124:22|
 :skolemid |228|
 :pattern ( (MapType1Select QPMask@4 null (pred x_10_1@@1)))
...
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 7)) (forall ((x_16 T@U) (x_16_2 T@U) ) (!  (=> (and (= (type x_16) RefType) (= (type x_16_2) RefType)) (=> (and (and (and (and (not (= x_16 x_16_2)) (|Seq#Contains| xs x_16)) (|Seq#Contains| xs x_16_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_16 x_16_2))))
 :qid |stdinbpl.2186:17|
 :skolemid |235|
 :pattern ( (neverTriggered29 x_16) (neverTriggered29 x_16_2))
))) (=> (forall ((x_16@@0 T@U) (x_16_2@@0 T@U) ) (!  (=> (and (= (type x_16@@0) RefType) (= (type x_16_2@@0) RefType)) (=> (and (and (and (and (not (= x_16@@0 x_16_2@@0)) (|Seq#Contains| xs x_16@@0)) (|Seq#Contains| xs x_16_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_16@@0 x_16_2@@0))))
 :qid |stdinbpl.2186:17|
 :skolemid |235|
 :pattern ( (neverTriggered29 x_16@@0) (neverTriggered29 x_16_2@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((x_16@@1 T@U) ) (!  (=> (and (= (type x_16@@1) RefType) (|Seq#Contains| xs x_16@@1)) (>= (U_2_real (MapType1Select QPMask@1 null (pred x_16@@1))) FullPerm))
 :qid |stdinbpl.2193:17|
 :skolemid |236|
 :pattern ( (MapType0Select Heap@@10 null (pred x_16@@1)))
 :pattern ( (MapType1Select QPMask@1 null (pred x_16@@1)))
 :pattern ( (|Seq#ContainsTrigger| xs x_16@@1))
 :pattern ( (|Seq#Contains| xs x_16@@1))
))) (=> (forall ((x_16@@2 T@U) ) (!  (=> (and (= (type x_16@@2) RefType) (|Seq#Contains| xs x_16@@2)) (>= (U_2_real (MapType1Select QPMask@1 null (pred x_16@@2))) FullPerm))
 :qid |stdinbpl.2193:17|
 :skolemid |236|
 :pattern ( (MapType0Select Heap@@10 null (pred x_16@@2)))
 :pattern ( (MapType1Select QPMask@1 null (pred x_16@@2)))
 :pattern ( (|Seq#ContainsTrigger| xs x_16@@2))
 :pattern ( (|Seq#Contains| xs x_16@@2))
)) (=> (forall ((x_16@@3 T@U) ) (!  (=> (= (type x_16@@3) RefType) (=> (and (|Seq#Contains| xs x_16@@3) (< NoPerm FullPerm)) (and (= (invRecv29 x_16@@3) x_16@@3) (qpRange29 x_16@@3))))
 :qid |stdinbpl.2199:22|
 :skolemid |237|
 :pattern ( (MapType0Select Heap@@10 null (pred x_16@@3)))
 :pattern ( (MapType1Select QPMask@1 null (pred x_16@@3)))
 :pattern ( (|Seq#ContainsTrigger| xs x_16@@3))
 :pattern ( (|Seq#Contains| xs x_16@@3))
)) (=> (and (and (forall ((x_17_1 T@U) ) (!  (=> (= (type x_17_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv29 x_17_1)) (< NoPerm FullPerm)) (qpRange29 x_17_1)) (= (invRecv29 x_17_1) x_17_1)))
 :qid |stdinbpl.2203:22|
 :skolemid |238|
 :pattern ( (invRecv29 x_17_1))
)) (forall ((x_17_1@@0 T@U) ) (!  (=> (= (type x_17_1@@0) RefType) (=> (and (and (|Seq#Contains| xs (invRecv29 x_17_1@@0)) (< NoPerm FullPerm)) (qpRange29 x_17_1@@0)) (and (= (invRecv29 x_17_1@@0) x_17_1@@0) (= (U_2_real (MapType1Select QPMask@2 null (pred x_17_1@@0))) (- (U_2_real (MapType1Select QPMask@1 null (pred x_17_1@@0))) FullPerm)))))
 :qid |stdinbpl.2209:22|
 :skolemid |239|
 :pattern ( (MapType1Select QPMask@2 null (pred x_17_1@@0)))
))) (and (forall ((x_17_1@@1 T@U) ) (!  (=> (and (= (type x_17_1@@1) RefType) (not (and (and (|Seq#Contains| xs (invRecv29 x_17_1@@1)) (< NoPerm FullPerm)) (qpRange29 x_17_1@@1)))) (= (U_2_real (MapType1Select QPMask@2 null (pred x_17_1@@1))) (U_2_real (MapType1Select QPMask@1 null (pred x_17_1@@1)))))
 :qid |stdinbpl.2213:22|
 :skolemid |240|
 :pattern ( (MapType1Select QPMask@2 null (pred x_17_1@@1)))
...
)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((x_18 T@U) (x_18_1 T@U) ) (!  (=> (and (= (type x_18) RefType) (= (type x_18_1) RefType)) (=> (and (and (and (and (not (= x_18 x_18_1)) (|Seq#Contains| xs x_18)) (|Seq#Contains| xs x_18_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_18 x_18_1))))
 :qid |stdinbpl.2231:17|
 :skolemid |242|
 :pattern ( (neverTriggered30 x_18) (neverTriggered30 x_18_1))
))) (=> (forall ((x_18@@0 T@U) (x_18_1@@0 T@U) ) (!  (=> (and (= (type x_18@@0) RefType) (= (type x_18_1@@0) RefType)) (=> (and (and (and (and (not (= x_18@@0 x_18_1@@0)) (|Seq#Contains| xs x_18@@0)) (|Seq#Contains| xs x_18_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_18@@0 x_18_1@@0))))
 :qid |stdinbpl.2231:17|
 :skolemid |242|
 :pattern ( (neverTriggered30 x_18@@0) (neverTriggered30 x_18_1@@0))
)) (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((x_18@@1 T@U) ) (!  (=> (and (= (type x_18@@1) RefType) (|Seq#Contains| xs x_18@@1)) (>= (U_2_real (MapType1Select QPMask@2 null (pred x_18@@1))) FullPerm))
 :qid |stdinbpl.2238:17|
 :skolemid |243|
 :pattern ( (MapType0Select Heap@@10 null (pred x_18@@1)))
 :pattern ( (MapType1Select QPMask@2 null (pred x_18@@1)))
 :pattern ( (|Seq#ContainsTrigger| xs x_18@@1))
 :pattern ( (|Seq#Contains| xs x_18@@1))
)))))))))))))
...
)) (=> (forall ((x_5@@1 T@U) ) (!  (=> (= (type x_5@@1) RefType) (=> (and (|Seq#Contains| xs x_5@@1) (< NoPerm FullPerm)) (and (= (invRecv26 x_5@@1) x_5@@1) (qpRange26 x_5@@1))))
 :qid |stdinbpl.2051:22|
 :skolemid |218|
 :pattern ( (MapType0Select Heap@@10 null (pred x_5@@1)))
 :pattern ( (MapType1Select QPMask@0 null (pred x_5@@1)))
 :pattern ( (|Seq#ContainsTrigger| xs x_5@@1))
 :pattern ( (|Seq#Contains| xs x_5@@1))
)) (=> (and (forall ((x_6_1 T@U) ) (!  (=> (= (type x_6_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv26 x_6_1)) (< NoPerm FullPerm)) (qpRange26 x_6_1)) (= (invRecv26 x_6_1) x_6_1)))
 :qid |stdinbpl.2055:22|
 :skolemid |219|
 :pattern ( (invRecv26 x_6_1))
)) (forall ((x_6_1@@0 T@U) ) (!  (=> (= (type x_6_1@@0) RefType) (=> (and (and (|Seq#Contains| xs (invRecv26 x_6_1@@0)) (< NoPerm FullPerm)) (qpRange26 x_6_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv26 x_6_1@@0) x_6_1@@0)) (= (U_2_real (MapType1Select QPMask@1 null (pred x_6_1@@0))) (+ (U_2_real (MapType1Select QPMask@0 null (pred x_6_1@@0))) FullPerm)))))
 :qid |stdinbpl.2061:22|
 :skolemid |220|
 :pattern ( (MapType1Select QPMask@1 null (pred x_6_1@@0)))
))) (=> (and (and (forall ((o_3@@1 T@U) (f_5@@1 T@U) ) (! (let ((B@@13 (FieldTypeInv1 (type f_5@@1))))
(let ((A@@14 (FieldTypeInv0 (type f_5@@1))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5@@1) (FieldType A@@14 B@@13))) (or (or (not (= o_3@@1 null)) (not (IsPredicateField f_5@@1))) (not (= (getPredWandId f_5@@1) 0)))) (= (U_2_real (MapType1Select QPMask@0 o_3@@1 f_5@@1)) (U_2_real (MapType1Select QPMask@1 o_3@@1 f_5@@1))))))
 :qid |stdinbpl.2067:29|
 :skolemid |221|
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5@@1))
 :pattern ( (MapType1Select QPMask@1 o_3@@1 f_5@@1))
)) (forall ((x_6_1@@1 T@U) ) (!  (=> (and (= (type x_6_1@@1) RefType) (not (and (and (|Seq#Contains| xs (invRecv26 x_6_1@@1)) (< NoPerm FullPerm)) (qpRange26 x_6_1@@1)))) (= (U_2_real (MapType1Select QPMask@1 null (pred x_6_1@@1))) (U_2_real (MapType1Select QPMask@0 null (pred x_6_1@@1)))))
 :qid |stdinbpl.2071:22|
 :skolemid |222|
 :pattern ( (MapType1Select QPMask@1 null (pred x_6_1@@1)))
...
)) (=> (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| xs x_1@@1) (< NoPerm FullPerm)) (and (= (invRecv25 x_1@@1) x_1@@1) (qpRange25 x_1@@1))))
...
)) (forall ((x_2_1 T@U) ) (!  (=> (= (type x_2_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv25 x_2_1)) (< NoPerm FullPerm)) (qpRange25 x_2_1)) (= (invRecv25 x_2_1) x_2_1)))
 :qid |stdinbpl.2014:22|
 :skolemid |213|
 :pattern ( (invRecv25 x_2_1))
))) (=> (and (and (forall ((x_2_1@@0 T@U) ) (!  (=> (= (type x_2_1@@0) RefType) (=> (and (and (|Seq#Contains| xs (invRecv25 x_2_1@@0)) (< NoPerm FullPerm)) (qpRange25 x_2_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv25 x_2_1@@0) x_2_1@@0)) (= (U_2_real (MapType1Select QPMask@0 null (pred x_2_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (pred x_2_1@@0))) FullPerm)))))
...
(let ((A@@15 (FieldTypeInv0 (type f_5@@2))))
 ...
 :qid |stdinbpl.2026:29|
 :skolemid |215|
 :pattern ( (MapType1Select ZeroMask o_3@@2 f_5@@2))
 :pattern ( (MapType1Select QPMask@0 o_3@@2 f_5@@2))
))) (and (forall ((x_2_1@@1 T@U) ) (!  (=> (and (= (type x_2_1@@1) RefType) (not (and (and (|Seq#Contains| xs (invRecv25 x_2_1@@1)) (< NoPerm FullPerm)) (qpRange25 x_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (pred x_2_1@@1))) (U_2_real (MapType1Select ZeroMask null (pred x_2_1@@1)))))
