...
(assert  (and (and (and (and (and (and (= (type xs@@8) (MapType2Type RefType boolType)) (= (type ys@@8) (MapType2Type RefType boolType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv4 arg0@@48)) RefType)
 :qid |funType:invRecv4|
 :pattern ( (invRecv4 arg0@@48))
))) (= (type x1_2) RefType)) (= (type x2_2) RefType)))
(set-info :boogie-vc-id test05)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (and (U_2_bool (MapType2Select xs@@8 x_1)) (not (U_2_bool (MapType2Select ys@@8 x_1))))) (and (U_2_bool (MapType2Select xs@@8 x_1_1)) (not (U_2_bool (MapType2Select ys@@8 x_1_1))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.802:15|
 :skolemid |110|
 :no-pattern (type x_1)
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (and (U_2_bool (MapType2Select xs@@8 x_1@@0)) (not (U_2_bool (MapType2Select ys@@8 x_1@@0))))) (and (U_2_bool (MapType2Select xs@@8 x_1_1@@0)) (not (U_2_bool (MapType2Select ys@@8 x_1_1@@0))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.802:15|
 :skolemid |110|
...
)) (=> (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (and (U_2_bool (MapType2Select xs@@8 x_1@@1)) (not (U_2_bool (MapType2Select ys@@8 x_1@@1)))) (< NoPerm FullPerm)) (and (qpRange4 x_1@@1) (= (invRecv4 x_1@@1) x_1@@1))))
 :qid |stdinbpl.808:22|
 :skolemid |111|
 :pattern ( (MapType0Select Heap@@10 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
 :pattern ( (MapType2Select xs@@8 x_1@@1))
 :pattern ( (MapType2Select ys@@8 x_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (U_2_bool (MapType2Select xs@@8 (invRecv4 o_3))) (not (U_2_bool (MapType2Select ys@@8 (invRecv4 o_3))))) (< NoPerm FullPerm)) (qpRange4 o_3)) (= (invRecv4 o_3) o_3)))
 :qid |stdinbpl.812:22|
 :skolemid |112|
 :pattern ( (invRecv4 o_3))
))) (=> (and (and (forall ((x_1@@2 T@U) ) (!  (=> (= (type x_1@@2) RefType) (=> (and (U_2_bool (MapType2Select xs@@8 x_1@@2)) (not (U_2_bool (MapType2Select ys@@8 x_1@@2)))) (not (= x_1@@2 null))))
 :qid |stdinbpl.818:22|
 :skolemid |113|
 :pattern ( (MapType0Select Heap@@10 x_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@2 f_7))
 :pattern ( (MapType2Select xs@@8 x_1@@2))
 :pattern ( (MapType2Select ys@@8 x_1@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (U_2_bool (MapType2Select xs@@8 (invRecv4 o_3@@0))) (not (U_2_bool (MapType2Select ys@@8 (invRecv4 o_3@@0))))) (< NoPerm FullPerm)) (qpRange4 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (and (U_2_bool (MapType2Select xs@@8 (invRecv4 o_3@@0))) (not (U_2_bool (MapType2Select ys@@8 (invRecv4 o_3@@0))))) (< NoPerm FullPerm)) (qpRange4 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.824:22|
 :skolemid |114|
...
)) (state Heap@@10 QPMask@0))) (=> (and (and (and (and (state Heap@@10 QPMask@0) (U_2_bool (MapType2Select xs@@8 x1_2))) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0))) (and (and (U_2_bool (MapType2Select xs@@8 x2_2)) (state Heap@@10 QPMask@0)) (and (state Heap@@10 QPMask@0) (not (U_2_bool (MapType2Select ys@@8 x1_2)))))) (and (and (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0)) (and (not (= x1_2 null)) (state Heap@@10 QPMask@0))) (and (and (state Heap@@10 QPMask@0) (not (= x2_2 null))) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 x1_2 f_7)) (=> (HasDirectPerm QPMask@0 x1_2 f_7) (=> (= a_2@0 (U_2_int (MapType0Select Heap@@10 x1_2 f_7))) (=> (and (state Heap@@10 QPMask@0) (= (ControlFlow 0 3) (- 0 2))) (HasDirectPerm QPMask@0 x2_2 f_7))))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 x1_2 $allocated)) (U_2_bool (MapType0Select Heap@@10 x2_2 $allocated))) (and (=> (= (ControlFlow 0 6) 1) anon3_Then_correct) (=> (= (ControlFlow 0 6) 3) anon3_Else_correct))))))
