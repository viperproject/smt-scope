...
(declare-fun bar (T@U) T@U)
(declare-fun PredicateType_barType () T@T)
(declare-fun |get'| (T@U T@U) Int)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |get#triggerStateless| (T@U) Int)
(declare-fun |bar#trigger| (T@U T@U) Bool)
(declare-fun |bar#everUsed| (T@U) Bool)
...
(declare-fun |get#condqp1| (T@U T@U) Int)
(declare-fun |sk_get#condqp1| (Int Int) T@U)
...
(assert  (and (= (Ctor PredicateType_barType) 13) (forall ((arg0@@30 T@U) ) (! (= (type (bar arg0@@30)) (FieldType PredicateType_barType FrameTypeType))
 :qid |funType:bar|
 :pattern ( (bar arg0@@30))
))))
(assert (forall ((x@@8 T@U) ) (!  (=> (= (type x@@8) RefType) (IsPredicateField (bar x@@8)))
 :qid |stdinbpl.555:15|
 :skolemid |94|
 :pattern ( (bar x@@8))
)))
...
(assert (forall ((Heap@@3 T@U) (x@@10 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type x@@10) RefType)) (|bar#everUsed| (bar x@@10)))
 :qid |stdinbpl.574:15|
 :skolemid |98|
 :pattern ( (|bar#trigger| Heap@@3 (bar x@@10)))
)))
...
(assert  (and (and (and (and (and (and (and (forall ((arg0@@31 T@T) (arg1@@12 T@T) ) (! (= (Ctor (MapType2Type arg0@@31 arg1@@12)) 14)
...
(= (type (MapType2Store arg0@@35 arg1@@16 arg2@@3)) (MapType2Type aVar0@@1 aVar1@@3))))
 ...
 :weight 0
)))) (forall ((arg0@@36 T@U) (arg1@@17 T@U) ) (! (let ((T@@4 (MapType2TypeInv0 (type arg0@@36))))
(= (type (|Set#Union| arg0@@36 arg1@@17)) (MapType2Type T@@4 boolType)))
...
(assert (forall ((arg0@@37 T@U) (arg1@@18 T@U) ) (! (let ((T@@6 (MapType2TypeInv0 (type arg0@@37))))
(= (type (|Set#Intersection| arg0@@37 arg1@@18)) (MapType2Type T@@6 boolType)))
...
(assert (forall ((x@@12 T@U) (x2 T@U) ) (!  (=> (and (and (= (type x@@12) RefType) (= (type x2) RefType)) (= (bar x@@12) (bar x2))) (= x@@12 x2))
 :qid |stdinbpl.565:15|
 :skolemid |96|
 :pattern ( (bar x@@12) (bar x2))
)))
(assert (forall ((arg0@@39 T@U) ) (! (= (type (|bar#sm| arg0@@39)) (FieldType PredicateType_barType (MapType1Type RefType boolType)))
 :qid |funType:bar#sm|
 :pattern ( (|bar#sm| arg0@@39))
)))
(assert (forall ((x@@13 T@U) (x2@@0 T@U) ) (!  (=> (and (and (= (type x@@13) RefType) (= (type x2@@0) RefType)) (= (|bar#sm| x@@13) (|bar#sm| x2@@0))) (= x@@13 x2@@0))
 :qid |stdinbpl.569:15|
 :skolemid |97|
 :pattern ( (|bar#sm| x@@13) (|bar#sm| x2@@0))
)))
...
(assert (forall ((arg0@@40 T@U) (arg1@@19 T@U) ) (! (let ((T@@13 (type arg1@@19)))
(= (type (|MultiSet#UnionOne| arg0@@40 arg1@@19)) (MultiSetType T@@13)))
 :qid |funType:MultiSet#UnionOne|
 :pattern ( (|MultiSet#UnionOne| arg0@@40 arg1@@19))
)))
...
(assert (forall ((p T@U) (v_1 T@U) (w_3 T@U) ) (! (let ((A@@2 (FieldTypeInv0 (type p))))
 (=> (and (and (= (type p) (FieldType A@@2 FrameTypeType)) (= (type v_1) FrameTypeType)) (= (type w_3) FrameTypeType)) (not (InsidePredicate p v_1 p w_3))))
 :qid |stdinbpl.203:19|
 :skolemid |21|
 :pattern ( (InsidePredicate p v_1 p w_3))
)))
...
(assert (forall ((arg0@@43 T@U) (arg1@@21 T@U) ) (! (let ((T@@20 (MapType2TypeInv0 (type arg0@@43))))
(= (type (|Set#Difference| arg0@@43 arg1@@21)) (MapType2Type T@@20 boolType)))
 :qid |funType:Set#Difference|
 :pattern ( (|Set#Difference| arg0@@43 arg1@@21))
)))
...
(assert (forall ((arg0@@44 T@U) (arg1@@22 T@U) ) (! (let ((T@@24 (type arg1@@22)))
(= (type (|Set#UnionOne| arg0@@44 arg1@@22)) (MapType2Type T@@24 boolType)))
 :qid |funType:Set#UnionOne|
 :pattern ( (|Set#UnionOne| arg0@@44 arg1@@22))
)))
(assert (forall ((a@@16 T@U) (x@@15 T@U) (y@@2 T@U) ) (! (let ((T@@25 (type x@@15)))
 (=> (and (and (= (type a@@16) (MapType2Type T@@25 boolType)) (= (type y@@2) T@@25)) (U_2_bool (MapType2Select a@@16 y@@2))) (U_2_bool (MapType2Select (|Set#UnionOne| a@@16 x@@15) y@@2))))
 :qid |stdinbpl.234:18|
 :skolemid |31|
 :pattern ( (|Set#UnionOne| a@@16 x@@15) (MapType2Select a@@16 y@@2))
)))
...
(assert (forall ((x@@21 T@U) ) (!  (=> (= (type x@@21) RefType) (= (getPredWandId (bar x@@21)) 0))
 :qid |stdinbpl.559:15|
 :skolemid |95|
 :pattern ( (bar x@@21))
)))
...
(assert (forall ((arg0@@45 Int) (arg1@@23 Int) ) (! (= (type (|sk_get#condqp1| arg0@@45 arg1@@23)) RefType)
 :qid |funType:sk_get#condqp1|
 :pattern ( (|sk_get#condqp1| arg0@@45 arg1@@23))
)))
(assert (forall ((Heap2Heap T@U) (Heap1Heap T@U) (x@@22 T@U) ) (!  (=> (and (and (and (= (type Heap2Heap) (MapType0Type RefType)) (= (type Heap1Heap) (MapType0Type RefType))) (= (type x@@22) RefType)) (and (=  (and (U_2_bool (MapType2Select (|Set#Singleton| x@@22) (|sk_get#condqp1| (|get#condqp1| Heap2Heap x@@22) (|get#condqp1| Heap1Heap x@@22)))) (< NoPerm FullPerm))  (and (U_2_bool (MapType2Select (|Set#Singleton| x@@22) (|sk_get#condqp1| (|get#condqp1| Heap2Heap x@@22) (|get#condqp1| Heap1Heap x@@22)))) (< NoPerm FullPerm))) (=> (and (U_2_bool (MapType2Select (|Set#Singleton| x@@22) (|sk_get#condqp1| (|get#condqp1| Heap2Heap x@@22) (|get#condqp1| Heap1Heap x@@22)))) (< NoPerm FullPerm)) (= (MapType0Select Heap2Heap null (bar (|sk_get#condqp1| (|get#condqp1| Heap2Heap x@@22) (|get#condqp1| Heap1Heap x@@22)))) (MapType0Select Heap1Heap null (bar (|sk_get#condqp1| (|get#condqp1| Heap2Heap x@@22) (|get#condqp1| Heap1Heap x@@22)))))))) (= (|get#condqp1| Heap2Heap x@@22) (|get#condqp1| Heap1Heap x@@22)))
 :qid |stdinbpl.441:15|
 :skolemid |86|
 :pattern ( (|get#condqp1| Heap2Heap x@@22) (|get#condqp1| Heap1Heap x@@22) (succHeapTrans Heap2Heap Heap1Heap))
)))
(assert (forall ((s@@1 T@U) ) (! (let ((T@@42 (MultiSetTypeInv0 (type s@@1))))
 (=> (= (type s@@1) (MultiSetType T@@42)) (and (= (= (|MultiSet#Card| s@@1) 0) (= s@@1 (|MultiSet#Empty| T@@42))) (=> (not (= (|MultiSet#Card| s@@1) 0)) (exists ((x@@23 T@U) ) (!  (and (= (type x@@23) T@@42) (< 0 (|MultiSet#Select| s@@1 x@@23)))
 :qid |stdinbpl.332:38|
 :skolemid |59|
...
(assert (forall ((x@@24 T@U) ) (!  (=> (= (type x@@24) RefType) (= (PredicateMaskField (bar x@@24)) (|bar#sm| x@@24)))
 :qid |stdinbpl.551:15|
 :skolemid |93|
 :pattern ( (PredicateMaskField (bar x@@24)))
)))
...
(assert (forall ((s@@2 T@U) ) (! (let ((T@@48 (MapType2TypeInv0 (type s@@2))))
 (=> (= (type s@@2) (MapType2Type T@@48 boolType)) (and (= (= (|Set#Card| s@@2) 0) (= s@@2 (|Set#Empty| T@@48))) (=> (not (= (|Set#Card| s@@2) 0)) (exists ((x@@25 T@U) ) (!  (and (= (type x@@25) T@@48) (U_2_bool (MapType2Select s@@2 x@@25)))
 :qid |stdinbpl.222:33|
 :skolemid |24|
...
(assert (forall ((arg0@@46 T@U) ) (! (= (type (FrameFragment arg0@@46)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@46))
)))
(assert (forall ((Heap@@11 T@U) (Mask@@9 T@U) (x@@26 T@U) ) (!  (=> (and (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (= (type x@@26) RefType)) (state Heap@@11 Mask@@9)) (= (|get'| Heap@@11 x@@26) (|get#frame| (FrameFragment (int_2_U (|get#condqp1| Heap@@11 x@@26))) x@@26)))
 :qid |stdinbpl.431:15|
 :skolemid |85|
 :pattern ( (state Heap@@11 Mask@@9) (|get'| Heap@@11 x@@26))
)))
...
(assert (forall ((Heap@@13 T@U) (Mask@@10 T@U) (x@@27 T@U) ) (!  (=> (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type x@@27) RefType)) (and (state Heap@@13 Mask@@10) (< AssumeFunctionsAbove 0))) (= (get Heap@@13 x@@27) (U_2_int (MapType0Select Heap@@13 x@@27 val))))
 :qid |stdinbpl.424:15|
 :skolemid |84|
 :pattern ( (state Heap@@13 Mask@@10) (get Heap@@13 x@@27))
)))
(assert (forall ((a@@32 T@U) (x@@28 T@U) ) (! (let ((T@@50 (type x@@28)))
 (=> (and (= (type a@@32) (MapType2Type T@@50 boolType)) (not (U_2_bool (MapType2Select a@@32 x@@28)))) (= (|Set#Card| (|Set#UnionOne| a@@32 x@@28)) (+ (|Set#Card| a@@32) 1))))
 :qid |stdinbpl.238:18|
 :skolemid |33|
 :pattern ( (|Set#Card| (|Set#UnionOne| a@@32 x@@28)))
)))
...
(assert (forall ((p@@1 T@U) (v_1@@0 T@U) (q T@U) (w_3@@0 T@U) (r@@5 T@U) (u T@U) ) (! (let ((C@@3 (FieldTypeInv0 (type r@@5))))
(let ((B@@10 (FieldTypeInv0 (type q))))
(let ((A@@11 (FieldTypeInv0 (type p@@1))))
 (=> (and (and (and (and (and (and (= (type p@@1) (FieldType A@@11 FrameTypeType)) (= (type v_1@@0) FrameTypeType)) (= (type q) (FieldType B@@10 FrameTypeType))) (= (type w_3@@0) FrameTypeType)) (= (type r@@5) (FieldType C@@3 FrameTypeType))) (= (type u) FrameTypeType)) (and (InsidePredicate p@@1 v_1@@0 q w_3@@0) (InsidePredicate q w_3@@0 r@@5 u))) (InsidePredicate p@@1 v_1@@0 r@@5 u)))))
 :qid |stdinbpl.198:25|
 :skolemid |20|
 :pattern ( (InsidePredicate p@@1 v_1@@0 q w_3@@0) (InsidePredicate q w_3@@0 r@@5 u))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((a@@35 T@U) (x@@29 T@U) (o@@14 T@U) ) (! (let ((T@@52 (type x@@29)))
 (=> (and (= (type a@@35) (MultiSetType T@@52)) (= (type o@@14) T@@52)) (= (|MultiSet#Select| (|MultiSet#UnionOne| a@@35 x@@29) o@@14) (ite (= x@@29 o@@14) (+ (|MultiSet#Select| a@@35 o@@14) 1) (|MultiSet#Select| a@@35 o@@14)))))
 :qid |stdinbpl.342:18|
 :skolemid |64|
 :pattern ( (|MultiSet#Select| (|MultiSet#UnionOne| a@@35 x@@29) o@@14))
 :pattern ( (|MultiSet#UnionOne| a@@35 x@@29) (|MultiSet#Select| a@@35 o@@14))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type x@@30) RefType) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type ExhaleHeap@2) (MapType0Type RefType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type ExhaleHeap@4) (MapType0Type RefType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type z@@0) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@14) (MapType0Type RefType))) (forall ((arg0@@47 T@U) ) (! (= (type (invRecv3 arg0@@47)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 32) (let ((anon21_Else_correct  (=> (= (ControlFlow 0 12) (- 0 11)) (= (get ExhaleHeap@4 x@@30) 4))))
(let ((anon21_Then_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((w_2 T@U) (w_2_1 T@U) ) (!  (=> (and (= (type w_2) RefType) (= (type w_2_1) RefType)) (=> (and (and (and (and (not (= w_2 w_2_1)) (U_2_bool (MapType2Select (|Set#Singleton| x@@30) w_2))) (U_2_bool (MapType2Select (|Set#Singleton| x@@30) w_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= w_2 w_2_1))))
 :qid |stdinbpl.1036:21|
 :skolemid |126|
 :pattern ( (neverTriggered6 w_2) (neverTriggered6 w_2_1))
))) (=> (forall ((w_2@@0 T@U) (w_2_1@@0 T@U) ) (!  (=> (and (= (type w_2@@0) RefType) (= (type w_2_1@@0) RefType)) (=> (and (and (and (and (not (= w_2@@0 w_2_1@@0)) (U_2_bool (MapType2Select (|Set#Singleton| x@@30) w_2@@0))) (U_2_bool (MapType2Select (|Set#Singleton| x@@30) w_2_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= w_2@@0 w_2_1@@0))))
 :qid |stdinbpl.1036:21|
 :skolemid |126|
 :pattern ( (neverTriggered6 w_2@@0) (neverTriggered6 w_2_1@@0))
)) (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((w_2@@1 T@U) ) (!  (=> (and (= (type w_2@@1) RefType) (U_2_bool (MapType2Select (|Set#Singleton| x@@30) w_2@@1))) (>= (U_2_real (MapType1Select Mask@5 null (bar w_2@@1))) FullPerm))
 :qid |stdinbpl.1043:21|
 :skolemid |127|
 :pattern ( (MapType0Select ExhaleHeap@4 null (bar w_2@@1)))
 :pattern ( (MapType1Select Mask@5 null (bar w_2@@1)))
 :pattern ( (MapType2Select (|Set#Singleton| x@@30) w_2@@1))
)))))))
(let ((anon12_correct  (=> (and (and (and (= Mask@4 (MapType1Store Mask@3 null (bar x@@30) (real_2_U (- (U_2_real (MapType1Select Mask@3 null (bar x@@30))) FullPerm)))) (IdenticalOnKnownLocations ExhaleHeap@2 ExhaleHeap@4 Mask@4)) (and (= Mask@5 (MapType1Store Mask@4 null (bar x@@30) (real_2_U (+ (U_2_real (MapType1Select Mask@4 null (bar x@@30))) FullPerm)))) (state ExhaleHeap@4 Mask@5))) (and (and (state ExhaleHeap@4 Mask@5) (= (get ExhaleHeap@4 x@@30) 3)) (and (state ExhaleHeap@4 Mask@5) (state ExhaleHeap@4 Mask@5)))) (and (=> (= (ControlFlow 0 13) 9) anon21_Then_correct) (=> (= (ControlFlow 0 13) 12) anon21_Else_correct)))))
(let ((anon20_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 13)) anon12_correct)))
(let ((anon20_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (U_2_real (MapType1Select Mask@3 null (bar x@@30))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 null (bar x@@30)))) (=> (= (ControlFlow 0 14) 13) anon12_correct))))))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (= (get ExhaleHeap@2 x@@30) 4)) (=> (= (get ExhaleHeap@2 x@@30) 4) (=> (state ExhaleHeap@2 Mask@3) (and (=> (= (ControlFlow 0 17) 14) anon20_Then_correct) (=> (= (ControlFlow 0 17) 16) anon20_Else_correct)))))))
(let ((anon19_Then_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((w_1 T@U) (w_1_1 T@U) ) (!  (=> (and (= (type w_1) RefType) (= (type w_1_1) RefType)) (=> (and (and (and (and (not (= w_1 w_1_1)) (U_2_bool (MapType2Select (|Set#Singleton| x@@30) w_1))) (U_2_bool (MapType2Select (|Set#Singleton| x@@30) w_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= w_1 w_1_1))))
 :qid |stdinbpl.944:21|
 :skolemid |119|
 :pattern ( (neverTriggered5 w_1) (neverTriggered5 w_1_1))
))) (=> (forall ((w_1@@0 T@U) (w_1_1@@0 T@U) ) (!  (=> (and (= (type w_1@@0) RefType) (= (type w_1_1@@0) RefType)) (=> (and (and (and (and (not (= w_1@@0 w_1_1@@0)) (U_2_bool (MapType2Select (|Set#Singleton| x@@30) w_1@@0))) (U_2_bool (MapType2Select (|Set#Singleton| x@@30) w_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= w_1@@0 w_1_1@@0))))
 :qid |stdinbpl.944:21|
 :skolemid |119|
 :pattern ( (neverTriggered5 w_1@@0) (neverTriggered5 w_1_1@@0))
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((w_1@@1 T@U) ) (!  (=> (and (= (type w_1@@1) RefType) (U_2_bool (MapType2Select (|Set#Singleton| x@@30) w_1@@1))) (>= (U_2_real (MapType1Select Mask@3 null (bar w_1@@1))) FullPerm))
 :qid |stdinbpl.951:21|
 :skolemid |120|
 :pattern ( (MapType0Select ExhaleHeap@2 null (bar w_1@@1)))
 :pattern ( (MapType1Select Mask@3 null (bar w_1@@1)))
 :pattern ( (MapType2Select (|Set#Singleton| x@@30) w_1@@1))
)))))))
(let ((anon8_correct  (=> (and (and (and (= Mask@2 (MapType1Store Mask@1 null (bar z@@0) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (bar z@@0))) FullPerm)))) (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@2 Mask@2)) (and (= Mask@3 (MapType1Store Mask@2 null (bar z@@0) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (bar z@@0))) FullPerm)))) (state ExhaleHeap@2 Mask@3))) (and (and (state ExhaleHeap@2 Mask@3) (= (get ExhaleHeap@2 z@@0) 3)) (and (state ExhaleHeap@2 Mask@3) (state ExhaleHeap@2 Mask@3)))) (and (=> (= (ControlFlow 0 19) 6) anon19_Then_correct) (=> (= (ControlFlow 0 19) 17) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 22) 19)) anon8_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (bar z@@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (bar z@@0)))) (=> (= (ControlFlow 0 20) 19) anon8_correct))))))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 23) (- 0 24)) (= (get ExhaleHeap@0 x@@30) 4)) (=> (= (get ExhaleHeap@0 x@@30) 4) (=> (state ExhaleHeap@0 Mask@1) (and (=> (= (ControlFlow 0 23) 20) anon18_Then_correct) (=> (= (ControlFlow 0 23) 22) anon18_Else_correct)))))))
(let ((anon17_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((w T@U) (w_5 T@U) ) (!  (=> (and (= (type w) RefType) (= (type w_5) RefType)) (=> (and (and (and (and (not (= w w_5)) (U_2_bool (MapType2Select (|Set#Singleton| x@@30) w))) (U_2_bool (MapType2Select (|Set#Singleton| x@@30) w_5))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= w w_5))))
 :qid |stdinbpl.852:21|
 :skolemid |112|
 :pattern ( (neverTriggered4 w) (neverTriggered4 w_5))
))) (=> (forall ((w@@0 T@U) (w_5@@0 T@U) ) (!  (=> (and (= (type w@@0) RefType) (= (type w_5@@0) RefType)) (=> (and (and (and (and (not (= w@@0 w_5@@0)) (U_2_bool (MapType2Select (|Set#Singleton| x@@30) w@@0))) (U_2_bool (MapType2Select (|Set#Singleton| x@@30) w_5@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= w@@0 w_5@@0))))
 :qid |stdinbpl.852:21|
 :skolemid |112|
 :pattern ( (neverTriggered4 w@@0) (neverTriggered4 w_5@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((w@@1 T@U) ) (!  (=> (and (= (type w@@1) RefType) (U_2_bool (MapType2Select (|Set#Singleton| x@@30) w@@1))) (>= (U_2_real (MapType1Select Mask@1 null (bar w@@1))) FullPerm))
 :qid |stdinbpl.859:21|
 :skolemid |113|
 :pattern ( (MapType0Select ExhaleHeap@0 null (bar w@@1)))
 :pattern ( (MapType1Select Mask@1 null (bar w@@1)))
 :pattern ( (MapType2Select (|Set#Singleton| x@@30) w@@1))
)))))))
(let ((anon4_correct  (=> (and (and (and (= Mask@0 (MapType1Store QPMask@0 null (bar x@@30) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (bar x@@30))) FullPerm)))) (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@0 Mask@0)) (and (= Mask@1 (MapType1Store Mask@0 null (bar x@@30) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (bar x@@30))) FullPerm)))) (state ExhaleHeap@0 Mask@1))) (and (and (state ExhaleHeap@0 Mask@1) (= (get ExhaleHeap@0 x@@30) 4)) (and (state ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1)))) (and (=> (= (ControlFlow 0 25) 3) anon17_Then_correct) (=> (= (ControlFlow 0 25) 23) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 28) 25)) anon4_correct)))
(let ((anon16_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (bar x@@30))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (bar x@@30)))) (=> (= (ControlFlow 0 26) 25) anon4_correct))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 29) (- 0 30)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| z@@0) x@@30) r_1))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| z@@0) x@@30) r_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1 r_1_1))))
 :qid |stdinbpl.767:17|
 :skolemid |106|
 :pattern ( (neverTriggered3 r_1) (neverTriggered3 r_1_1))
))) (=> (forall ((r_1@@0 T@U) (r_1_1@@0 T@U) ) (!  (=> (and (= (type r_1@@0) RefType) (= (type r_1_1@@0) RefType)) (=> (and (and (and (and (not (= r_1@@0 r_1_1@@0)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| z@@0) x@@30) r_1@@0))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| z@@0) x@@30) r_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1@@0 r_1_1@@0))))
 :qid |stdinbpl.767:17|
 :skolemid |106|
 :pattern ( (neverTriggered3 r_1@@0) (neverTriggered3 r_1_1@@0))
)) (=> (forall ((r_1@@1 T@U) ) (!  (=> (= (type r_1@@1) RefType) (=> (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| z@@0) x@@30) r_1@@1)) (< NoPerm FullPerm)) (and (= (invRecv3 r_1@@1) r_1@@1) (qpRange3 r_1@@1))))
 :qid |stdinbpl.773:22|
 :skolemid |107|
 :pattern ( (MapType0Select Heap@@14 null (bar r_1@@1)))
 :pattern ( (MapType1Select ZeroMask null (bar r_1@@1)))
 :pattern ( (MapType2Select (|Set#UnionOne| (|Set#Singleton| z@@0) x@@30) r_1@@1))
)) (=> (and (and (and (forall ((x_1_1 T@U) ) (!  (=> (= (type x_1_1) RefType) (=> (and (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| z@@0) x@@30) (invRecv3 x_1_1))) (< NoPerm FullPerm)) (qpRange3 x_1_1)) (= (invRecv3 x_1_1) x_1_1)))
 :qid |stdinbpl.777:22|
 :skolemid |108|
 :pattern ( (invRecv3 x_1_1))
)) (forall ((x_1_1@@0 T@U) ) (!  (=> (= (type x_1_1@@0) RefType) (=> (and (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| z@@0) x@@30) (invRecv3 x_1_1@@0))) (< NoPerm FullPerm)) (qpRange3 x_1_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv3 x_1_1@@0) x_1_1@@0)) (= (U_2_real (MapType1Select QPMask@0 null (bar x_1_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (bar x_1_1@@0))) FullPerm)))))
 :qid |stdinbpl.783:22|
 :skolemid |109|
 :pattern ( (MapType1Select QPMask@0 null (bar x_1_1@@0)))
...
)) (forall ((x_1_1@@1 T@U) ) (!  (=> (and (= (type x_1_1@@1) RefType) (not (and (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| z@@0) x@@30) (invRecv3 x_1_1@@1))) (< NoPerm FullPerm)) (qpRange3 x_1_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (bar x_1_1@@1))) (U_2_real (MapType1Select ZeroMask null (bar x_1_1@@1)))))
 :qid |stdinbpl.793:22|
 :skolemid |111|
 :pattern ( (MapType1Select QPMask@0 null (bar x_1_1@@1)))
)))) (and (and (state Heap@@14 QPMask@0) (state Heap@@14 QPMask@0)) (and (not (= x@@30 z@@0)) (state Heap@@14 QPMask@0)))) (and (=> (= (ControlFlow 0 29) 26) anon16_Then_correct) (=> (= (ControlFlow 0 29) 28) anon16_Else_correct))))))))
(let ((anon15_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@14 x@@30 $allocated)) (U_2_bool (MapType0Select Heap@@14 z@@0 $allocated)))) (and (=> (= (ControlFlow 0 31) 1) anon15_Then_correct) (=> (= (ControlFlow 0 31) 29) anon15_Else_correct)))))
