...
(declare-fun res2@0 () Int)
(declare-fun res1@0 () Int)
(assert (= (type Heap@@9) (MapType0Type RefType)))
(set-info :boogie-vc-id main)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= 2 0)) (=> (>= 2 0) (=> (and (and (= res2@0 2) (= res1@0 (+ res2@0 5))) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= res2@0 2)) (=> (= res2@0 2) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= res1@0 (+ res2@0 5)))))))))))
