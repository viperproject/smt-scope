...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@5) (MapType1Type RefType realType)) (= (type Mask@4) (MapType1Type RefType realType))) (= (type freshObj@0) RefType)) (= (type Heap@8) (MapType0Type RefType))) (= (type Heap@6) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@7) (MapType0Type RefType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@3) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@35 T@U) (arg1@@14 T@U) ) (! (= (type (CombineFrames arg0@@35 arg1@@14)) FrameTypeType)
...
))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type a_3@@1) ArrayDomainTypeType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@@19) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type this@@15) RefType)) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id create)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 35) (let ((anon4_correct true))
(let ((anon19_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 32) 29)) anon4_correct)))
(let ((anon19_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 30) (- 0 31)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (AList this@@15))))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (AList this@@15)))) (=> (= (ControlFlow 0 30) 29) anon4_correct))))))
(let ((anon18_Else_correct true))
(let ((anon17_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (= PostMask@0 (MapType1Store ZeroMask null (AList this@@15) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (AList this@@15))) FullPerm)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (and (=> (= (ControlFlow 0 33) 28) anon18_Else_correct) (=> (= (ControlFlow 0 33) 30) anon19_Then_correct)) (=> (= (ControlFlow 0 33) 32) anon19_Else_correct))))))
(let ((anon16_correct  (=> (and (= Mask@5 (MapType1Store Mask@4 null (AList freshObj@0) (real_2_U (- (U_2_real (MapType1Select Mask@4 null (AList freshObj@0))) FullPerm)))) (= (ControlFlow 0 3) (- 0 2))) (= (length Heap@8 freshObj@0) 0))))
(let ((anon24_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon16_correct)))
(let ((anon24_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@4 null (AList freshObj@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 null (AList freshObj@0)))) (=> (= (ControlFlow 0 4) 3) anon16_correct))))))
(let ((anon14_correct  (=> (= Heap@6 (MapType0Store Heap@5 null (|AList#sm| freshObj@0) (MapType1Store (MapType0Select Heap@5 null (|AList#sm| freshObj@0)) freshObj@0 elems (bool_2_U true)))) (=> (and (= Heap@7 (MapType0Store Heap@6 null (|AList#sm| freshObj@0) (MapType1Store (MapType0Select Heap@6 null (|AList#sm| freshObj@0)) freshObj@0 size (bool_2_U true)))) (forall ((o_6 T@U) (f_9 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_9))))
(let ((A@@12 (FieldTypeInv0 (type f_9))))
 (=> (and (and (= (type o_6) RefType) (= (type f_9) (FieldType A@@12 B@@11))) (U_2_bool (MapType1Select (MapType0Select Heap@7 null (|AList#sm| freshObj@0)) o_6 f_9))) (U_2_bool (MapType1Select newPMask@0 o_6 f_9)))))
 :qid |stdinbpl.973:27|
 :skolemid |74|
 :pattern ( (MapType1Select newPMask@0 o_6 f_9))
))) (=> (and (and (forall ((i_3 Int) ) (!  (=> (and (<= 0 i_3) (< i_3 (len (MapType0Select Heap@7 freshObj@0 elems)))) (U_2_bool (MapType1Select newPMask@0 (loc (MapType0Select Heap@7 freshObj@0 elems) i_3) val)))
 :qid |stdinbpl.977:20|
 :skolemid |75|
)) (= Heap@8 (MapType0Store Heap@7 null (|AList#sm| freshObj@0) newPMask@0))) (and (state Heap@8 Mask@4) (state Heap@8 Mask@4))) (and (=> (= (ControlFlow 0 7) 4) anon24_Then_correct) (=> (= (ControlFlow 0 7) 6) anon24_Else_correct)))))))
(let ((anon23_Else_correct  (=> (HasDirectPerm Mask@4 null (AList freshObj@0)) (=> (and (= Heap@5 Heap@2) (= (ControlFlow 0 9) 7)) anon14_correct))))
(let ((anon23_Then_correct  (=> (not (HasDirectPerm Mask@4 null (AList freshObj@0))) (=> (and (and (= Heap@3 (MapType0Store Heap@2 null (|AList#sm| freshObj@0) ZeroPMask)) (= Heap@4 (MapType0Store Heap@3 null (AList freshObj@0) freshVersion@0))) (and (= Heap@5 Heap@4) (= (ControlFlow 0 8) 7))) anon14_correct))))
(let ((anon12_correct  (=> (= Mask@3 (MapType1Store Mask@2 freshObj@0 size (real_2_U (- (U_2_real (MapType1Select Mask@2 freshObj@0 size)) FullPerm)))) (and (=> (= (ControlFlow 0 10) (- 0 15)) (<= 0 (U_2_int (MapType0Select Heap@2 freshObj@0 size)))) (=> (<= 0 (U_2_int (MapType0Select Heap@2 freshObj@0 size))) (and (=> (= (ControlFlow 0 10) (- 0 14)) (<= (U_2_int (MapType0Select Heap@2 freshObj@0 size)) (len (MapType0Select Heap@2 freshObj@0 elems)))) (=> (<= (U_2_int (MapType0Select Heap@2 freshObj@0 size)) (len (MapType0Select Heap@2 freshObj@0 elems))) (and (=> (= (ControlFlow 0 10) (- 0 13)) (< 0 (len (MapType0Select Heap@2 freshObj@0 elems)))) (=> (< 0 (len (MapType0Select Heap@2 freshObj@0 elems))) (and (=> (= (ControlFlow 0 10) (- 0 12)) (forall ((i_2 Int) (i_2_1 Int) ) (!  (=> (and (and (and (and (not (= i_2 i_2_1)) (and (<= 0 i_2) (< i_2 (len (MapType0Select Heap@2 freshObj@0 elems))))) (and (<= 0 i_2_1) (< i_2_1 (len (MapType0Select Heap@2 freshObj@0 elems))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc (MapType0Select Heap@2 freshObj@0 elems) i_2) (loc (MapType0Select Heap@2 freshObj@0 elems) i_2_1))))
 :qid |stdinbpl.924:17|
 :skolemid |68|
 :pattern ( (neverTriggered5 i_2) (neverTriggered5 i_2_1))
))) (=> (forall ((i_2@@0 Int) (i_2_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_2@@0 i_2_1@@0)) (and (<= 0 i_2@@0) (< i_2@@0 (len (MapType0Select Heap@2 freshObj@0 elems))))) (and (<= 0 i_2_1@@0) (< i_2_1@@0 (len (MapType0Select Heap@2 freshObj@0 elems))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc (MapType0Select Heap@2 freshObj@0 elems) i_2@@0) (loc (MapType0Select Heap@2 freshObj@0 elems) i_2_1@@0))))
 :qid |stdinbpl.924:17|
 :skolemid |68|
 :pattern ( (neverTriggered5 i_2@@0) (neverTriggered5 i_2_1@@0))
)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((i_2@@1 Int) ) (!  (=> (and (<= 0 i_2@@1) (< i_2@@1 (len (MapType0Select Heap@2 freshObj@0 elems)))) (>= (U_2_real (MapType1Select Mask@3 (loc (MapType0Select Heap@2 freshObj@0 elems) i_2@@1) val)) FullPerm))
 :qid |stdinbpl.931:17|
 :skolemid |69|
 :pattern ( (loc (MapType0Select Heap@2 freshObj@0 elems) i_2@@1))
 :pattern ( (loc (MapType0Select Heap@2 freshObj@0 elems) i_2@@1))
))) (=> (forall ((i_2@@2 Int) ) (!  (=> (and (<= 0 i_2@@2) (< i_2@@2 (len (MapType0Select Heap@2 freshObj@0 elems)))) (>= (U_2_real (MapType1Select Mask@3 (loc (MapType0Select Heap@2 freshObj@0 elems) i_2@@2) val)) FullPerm))
 :qid |stdinbpl.931:17|
 :skolemid |69|
 :pattern ( (loc (MapType0Select Heap@2 freshObj@0 elems) i_2@@2))
 :pattern ( (loc (MapType0Select Heap@2 freshObj@0 elems) i_2@@2))
)) (=> (forall ((i_2@@3 Int) ) (!  (=> (and (and (<= 0 i_2@@3) (< i_2@@3 (len (MapType0Select Heap@2 freshObj@0 elems)))) (< NoPerm FullPerm)) (and (qpRange5 (loc (MapType0Select Heap@2 freshObj@0 elems) i_2@@3)) (= (invRecv5 (loc (MapType0Select Heap@2 freshObj@0 elems) i_2@@3)) i_2@@3)))
 :qid |stdinbpl.937:22|
 :skolemid |70|
 :pattern ( (loc (MapType0Select Heap@2 freshObj@0 elems) i_2@@3))
 :pattern ( (loc (MapType0Select Heap@2 freshObj@0 elems) i_2@@3))
)) (=> (and (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (<= 0 (invRecv5 o_3)) (< (invRecv5 o_3) (len (MapType0Select Heap@2 freshObj@0 elems)))) (and (< NoPerm FullPerm) (qpRange5 o_3))) (= (loc (MapType0Select Heap@2 freshObj@0 elems) (invRecv5 o_3)) o_3)))
 :qid |stdinbpl.941:22|
 :skolemid |71|
 :pattern ( (invRecv5 o_3))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (<= 0 (invRecv5 o_3@@0)) (< (invRecv5 o_3@@0) (len (MapType0Select Heap@2 freshObj@0 elems)))) (and (< NoPerm FullPerm) (qpRange5 o_3@@0))) (and (= (loc (MapType0Select Heap@2 freshObj@0 elems) (invRecv5 o_3@@0)) o_3@@0) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 val)) (- (U_2_real (MapType1Select Mask@3 o_3@@0 val)) FullPerm)))) (=> (not (and (and (<= 0 (invRecv5 o_3@@0)) (< (invRecv5 o_3@@0) (len (MapType0Select Heap@2 freshObj@0 elems)))) (and (< NoPerm FullPerm) (qpRange5 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 val)) (U_2_real (MapType1Select Mask@3 o_3@@0 val))))))
 :qid |stdinbpl.947:22|
 :skolemid |72|
...
(let ((A@@13 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@13 B@@12))) (not (= f_5 val))) (= (U_2_real (MapType1Select Mask@3 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@1 o_3@@1 f_5))))))
 :qid |stdinbpl.953:29|
 :skolemid |73|
 :pattern ( (MapType1Select QPMask@1 o_3@@1 f_5))
)) (= Mask@4 (MapType1Store QPMask@1 null (AList freshObj@0) (real_2_U (+ (U_2_real (MapType1Select QPMask@1 null (AList freshObj@0))) FullPerm)))))) (and (and (state Heap@2 Mask@4) (state Heap@2 Mask@4)) (and (|AList#trigger| Heap@2 (AList freshObj@0)) (= (MapType0Select Heap@2 null (AList freshObj@0)) (CombineFrames (FrameFragment (MapType0Select Heap@2 freshObj@0 elems)) (CombineFrames (FrameFragment (MapType0Select Heap@2 freshObj@0 size)) (FrameFragment (int_2_U (|AList#condqp1| Heap@2 freshObj@0))))))))) (and (=> (= (ControlFlow 0 10) 8) anon23_Then_correct) (=> (= (ControlFlow 0 10) 9) anon23_Else_correct)))))))))))))))))
(let ((anon22_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 18) 10)) anon12_correct)))
(let ((anon22_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 size)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 size))) (=> (= (ControlFlow 0 16) 10) anon12_correct))))))
(let ((anon10_correct  (=> (= Mask@2 (MapType1Store QPMask@0 freshObj@0 elems (real_2_U (- (U_2_real (MapType1Select QPMask@0 freshObj@0 elems)) FullPerm)))) (and (=> (= (ControlFlow 0 19) 16) anon22_Then_correct) (=> (= (ControlFlow 0 19) 18) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 22) 19)) anon10_correct)))
(let ((anon21_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 freshObj@0 elems)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 freshObj@0 elems))) (=> (= (ControlFlow 0 20) 19) anon10_correct))))))
(let ((anon20_Else_correct  (and (=> (= (ControlFlow 0 23) (- 0 26)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (len a_3@@1)))) (and (<= 0 i_1_1) (< i_1_1 (len a_3@@1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_1) (loc a_3@@1 i_1_1))))
 :qid |stdinbpl.849:15|
 :skolemid |62|
 ...
 :qid |stdinbpl.849:15|
 :skolemid |62|
)) (=> (and (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 (len a_3@@1))) (< NoPerm FullPerm)) (and (qpRange4 (loc a_3@@1 i_1@@1)) (= (invRecv4 (loc a_3@@1 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.855:22|
 :skolemid |63|
 :pattern ( (loc a_3@@1 i_1@@1))
 :pattern ( (loc a_3@@1 i_1@@1))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (<= 0 (invRecv4 o_3@@2)) (< (invRecv4 o_3@@2) (len a_3@@1))) (< NoPerm FullPerm)) (qpRange4 o_3@@2)) (= (loc a_3@@1 (invRecv4 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.859:22|
 :skolemid |64|
 :pattern ( (invRecv4 o_3@@2))
))) (and (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (< i_1@@2 (len a_3@@1))) (not (= (loc a_3@@1 i_1@@2) null)))
 :qid |stdinbpl.865:22|
 :skolemid |65|
 :pattern ( (loc a_3@@1 i_1@@2))
 :pattern ( (loc a_3@@1 i_1@@2))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (and (<= 0 (invRecv4 o_3@@3)) (< (invRecv4 o_3@@3) (len a_3@@1))) (< NoPerm FullPerm)) (qpRange4 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@1 (invRecv4 o_3@@3)) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 val)) (+ (U_2_real (MapType1Select Mask@1 o_3@@3 val)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv4 o_3@@3)) (< (invRecv4 o_3@@3) (len a_3@@1))) (< NoPerm FullPerm)) (qpRange4 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 val)) (U_2_real (MapType1Select Mask@1 o_3@@3 val))))))
 :qid |stdinbpl.871:22|
 :skolemid |66|
...
(let ((A@@14 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@14 B@@13))) (not (= f_5@@0 val))) (= (U_2_real (MapType1Select Mask@1 o_3@@4 f_5@@0)) (U_2_real (MapType1Select QPMask@0 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.875:29|
 :skolemid |67|
 :pattern ( (MapType1Select Mask@1 o_3@@4 f_5@@0))
 :pattern ( (MapType1Select QPMask@0 o_3@@4 f_5@@0))
)) (state Heap@0 QPMask@0)) (and (state Heap@0 QPMask@0) (state Heap@0 QPMask@0)))) (and (=> (= (ControlFlow 0 23) (- 0 25)) (= FullPerm (U_2_real (MapType1Select QPMask@0 freshObj@0 size)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 freshObj@0 size))) (=> (and (= Heap@1 (MapType0Store Heap@0 freshObj@0 size (int_2_U 0))) (state Heap@1 QPMask@0)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (= FullPerm (U_2_real (MapType1Select QPMask@0 freshObj@0 elems)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 freshObj@0 elems))) (=> (and (= Heap@2 (MapType0Store Heap@1 freshObj@0 elems a_3@@1)) (state Heap@2 QPMask@0)) (and (=> (= (ControlFlow 0 23) 20) anon21_Then_correct) (=> (= (ControlFlow 0 23) 22) anon21_Else_correct)))))))))))))
(let ((anon20_Then_correct true))
(let ((anon17_Else_correct  (=> (and (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@19 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@19 freshObj@0 $allocated (bool_2_U true)))) (and (= Mask@0 (MapType1Store ZeroMask freshObj@0 elems (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 elems)) FullPerm)))) (= Mask@1 (MapType1Store Mask@0 freshObj@0 size (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@0 size)) FullPerm)))))) (and (and (state Heap@0 Mask@1) (= (len a_3@@1) 10)) (and (state Heap@0 Mask@1) (state Heap@0 Mask@1)))) (and (=> (= (ControlFlow 0 27) 1) anon20_Then_correct) (=> (= (ControlFlow 0 27) 23) anon20_Else_correct)))))
(let ((anon0_correct  (=> (and (state Heap@@19 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 34) 33) anon17_Then_correct) (=> (= (ControlFlow 0 34) 27) anon17_Else_correct)))))
