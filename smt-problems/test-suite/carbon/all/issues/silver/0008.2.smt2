...
(declare-fun |sq#frame| (T@U Int) Int)
...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (Ctor RefType) 8)) (= (type f_7) (FieldType NormalFieldType RefType))) (= (type g) (FieldType NormalFieldType intType))) (= (type integer) (FieldType NormalFieldType intType))) (= (type Node_n) (FieldType NormalFieldType RefType))))
(assert (distinct $allocated f_7 g integer Node_n)
)
...
(assert (forall ((Heap@@2 T@U) (i Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (int_2_U (|sq#triggerStateless| i))))
 :qid |stdinbpl.569:15|
 :skolemid |59|
 :pattern ( (|sq'| Heap@@2 i))
)))
(assert  (and (forall ((arg0@@30 T@U) (arg1@@11 T@U) ) (! (= (type (|id'| arg0@@30 arg1@@11)) RefType)
 :qid |funType:id'|
 :pattern ( (|id'| arg0@@30 arg1@@11))
)) (forall ((arg0@@31 T@U) ) (! (= (type (|id#triggerStateless| arg0@@31)) RefType)
 :qid |funType:id#triggerStateless|
 :pattern ( (|id#triggerStateless| arg0@@31))
))))
(assert (forall ((Heap@@3 T@U) (x@@9 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type x@@9) RefType)) (dummyFunction (|id#triggerStateless| x@@9)))
 :qid |stdinbpl.618:15|
 :skolemid |63|
 :pattern ( (|id'| Heap@@3 x@@9))
)))
(assert (forall ((Heap@@4 T@U) (x@@10 T@U) ) (!  (=> (and (= (type Heap@@4) (MapType0Type RefType)) (= (type x@@10) RefType)) (|P#everUsed| (P x@@10)))
 :qid |stdinbpl.687:15|
 :skolemid |71|
 :pattern ( (|P#trigger| Heap@@4 (P x@@10)))
)))
...
(assert (forall ((Heap@@6 T@U) (i@@1 Int) ) (!  (=> (= (type Heap@@6) (MapType0Type RefType)) (and (= (sq Heap@@6 i@@1) (|sq'| Heap@@6 i@@1)) (dummyFunction (int_2_U (|sq#triggerStateless| i@@1)))))
 :qid |stdinbpl.565:15|
 :skolemid |58|
 :pattern ( (sq Heap@@6 i@@1))
)))
(assert (forall ((arg0@@35 T@U) (arg1@@15 T@U) ) (! (= (type (id arg0@@35 arg1@@15)) RefType)
 :qid |funType:id|
 :pattern ( (id arg0@@35 arg1@@15))
)))
...
(assert (forall ((arg0@@37 T@U) ) (! (= (type (|P#sm| arg0@@37)) (FieldType PredicateType_PType (MapType1Type RefType boolType)))
 :qid |funType:P#sm|
 :pattern ( (|P#sm| arg0@@37))
)))
...
(assert  (not (IsPredicateField integer)))
(assert  (not (IsWandField integer)))
...
(assert (forall ((Heap@@10 T@U) (Mask@@6 T@U) (i@@4 Int) ) (!  (=> (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (and (state Heap@@10 Mask@@6) (< AssumeFunctionsAbove 0))) (= (sq Heap@@10 i@@4) (* i@@4 i@@4)))
 :qid |stdinbpl.575:15|
 :skolemid |60|
 :pattern ( (state Heap@@10 Mask@@6) (sq Heap@@10 i@@4))
)))
...
(assert (forall ((Heap@@13 T@U) (Mask@@10 T@U) (i@@6 Int) ) (!  (=> (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (state Heap@@13 Mask@@10)) (= (|sq'| Heap@@13 i@@6) (|sq#frame| EmptyFrame i@@6)))
 :qid |stdinbpl.582:15|
 :skolemid |61|
 :pattern ( (state Heap@@13 Mask@@10) (|sq'| Heap@@13 i@@6))
)))
(assert (forall ((arg0@@40 T@U) (arg1@@18 T@U) ) (! (= (type (|id#frame| arg0@@40 arg1@@18)) RefType)
 :qid |funType:id#frame|
 :pattern ( (|id#frame| arg0@@40 arg1@@18))
)))
(assert (forall ((Heap@@14 T@U) (Mask@@11 T@U) (x@@17 T@U) ) (!  (=> (and (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (= (type x@@17) RefType)) (state Heap@@14 Mask@@11)) (= (|id'| Heap@@14 x@@17) (|id#frame| EmptyFrame x@@17)))
 :qid |stdinbpl.631:15|
 :skolemid |65|
 :pattern ( (state Heap@@14 Mask@@11) (|id'| Heap@@14 x@@17))
)))
...
(assert (forall ((s@@14 T@U) (x@@19 T@U) (i@@9 Int) ) (! (let ((T@@30 (type x@@19)))
 (=> (= (type s@@14) (SeqType T@@30)) (=> (and (and (<= 0 i@@9) (< i@@9 (|Seq#Length| s@@14))) (= (|Seq#Index| s@@14 i@@9) x@@19)) (|Seq#Contains| s@@14 x@@19))))
 :qid |stdinbpl.396:18|
 :skolemid |48|
 :pattern ( (|Seq#Contains| s@@14 x@@19) (|Seq#Index| s@@14 i@@9))
)))
...
(assert (forall ((Heap@@17 T@U) (Mask@@12 T@U) (x@@20 T@U) ) (!  (=> (and (and (and (= (type Heap@@17) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (= (type x@@20) RefType)) (and (state Heap@@17 Mask@@12) (< AssumeFunctionsAbove 1))) (= (id Heap@@17 x@@20) x@@20))
 :qid |stdinbpl.624:15|
 :skolemid |64|
 :pattern ( (state Heap@@17 Mask@@12) (id Heap@@17 x@@20))
)))
...
(assert  (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type x@@21) RefType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@18) (MapType0Type RefType))))
(set-info :boogie-vc-id foo)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon4_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 x@@21 integer (real_2_U (- (U_2_real (MapType1Select Mask@0 x@@21 integer)) FullPerm)))) (= (ControlFlow 0 4) (- 0 3))) (< n@0 (U_2_int (MapType0Select Heap@0 x@@21 integer))))))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 4)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@21 integer)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@21 integer))) (=> (= (ControlFlow 0 5) 4) anon4_correct))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 10)) (HasDirectPerm Mask@0 x@@21 integer)) (=> (HasDirectPerm Mask@0 x@@21 integer) (=> (and (= n@0 (U_2_int (MapType0Select Heap@@18 x@@21 integer))) (state Heap@@18 Mask@0)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (= FullPerm (U_2_real (MapType1Select Mask@0 x@@21 integer)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 x@@21 integer))) (=> (and (= Heap@0 (MapType0Store Heap@@18 x@@21 integer (int_2_U (+ n@0 1)))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 8) 5) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct))))))))))
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (not (= x@@21 null)) (= PostMask@0 (MapType1Store ZeroMask x@@21 integer (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@21 integer)) FullPerm))))) (and (state PostHeap@0 PostMask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm PostMask@0 x@@21 integer)))))
(let ((anon0_correct  (=> (state Heap@@18 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@18 x@@21 $allocated))) (=> (and (and (not (= x@@21 null)) (= Mask@0 (MapType1Store ZeroMask x@@21 integer (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@21 integer)) FullPerm))))) (and (state Heap@@18 Mask@0) (state Heap@@18 Mask@0))) (and (=> (= (ControlFlow 0 11) 2) anon5_Then_correct) (=> (= (ControlFlow 0 11) 8) anon5_Else_correct)))))))
