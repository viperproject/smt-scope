...
(assert  (and (and (= (type Heap@@17) (MapType0Type RefType)) (= (type a_3@@7) ArrayDomainTypeType)) (= (type Result@0) RefType)))
(set-info :boogie-vc-id |aloc#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (= AssumeFunctionsAbove 0) (<= 0 i_1@@18)) (=> (and (and (state Heap@@17 ZeroMask) (< i_1@@18 (alen a_3@@7))) (and (state Heap@@17 ZeroMask) (= Result@0 (array_loc a_3@@7 i_1@@18)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (loc_inv_1 Result@0) a_3@@7)) (=> (= (loc_inv_1 Result@0) a_3@@7) (=> (= (ControlFlow 0 2) (- 0 1)) (= (loc_inv_2 Result@0) i_1@@18)))))))))
