...
(assert  (and (and (and (and (and (and (= (type t1) RefType) (= (type t2) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))))
...
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 t1 $allocated)) (U_2_bool (MapType0Select Heap@@9 t2 $allocated))) (and (> wildcard@0 NoPerm) (not (= t1 null)))) (=> (and (and (and (= Mask@0 (MapType1Store ZeroMask t1 next (real_2_U (+ (U_2_real (MapType1Select ZeroMask t1 next)) wildcard@0)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (> wildcard@1 NoPerm))) (and (and (not (= t2 null)) (= Mask@1 (MapType1Store Mask@0 t2 next (real_2_U (+ (U_2_real (MapType1Select Mask@0 t2 next)) wildcard@1))))) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1)))) (and (=> (= (ControlFlow 0 4) (- 0 8)) (HasDirectPerm Mask@1 t1 next)) (=> (HasDirectPerm Mask@1 t1 next) (=> (and (not (= (MapType0Select Heap@@9 t1 next) null)) (state Heap@@9 Mask@1)) (and (=> (= (ControlFlow 0 4) (- 0 7)) (HasDirectPerm Mask@1 t2 next)) (=> (HasDirectPerm Mask@1 t2 next) (=> (and (not (= (MapType0Select Heap@@9 t2 next) null)) (state Heap@@9 Mask@1)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (HasDirectPerm Mask@1 t1 next)) (=> (HasDirectPerm Mask@1 t1 next) (=> (> wildcard@2 NoPerm) (=> (and (and (not (= (MapType0Select Heap@@9 t1 next) null)) (= Mask@2 (MapType1Store Mask@1 (MapType0Select Heap@@9 t1 next) next (real_2_U (+ (U_2_real (MapType1Select Mask@1 (MapType0Select Heap@@9 t1 next) next)) wildcard@2))))) (and (state Heap@@9 Mask@2) (state Heap@@9 Mask@2))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@2 t2 next)) (=> (HasDirectPerm Mask@2 t2 next) (=> (> wildcard@3 NoPerm) (=> (and (and (not (= (MapType0Select Heap@@9 t2 next) null)) (= Mask@3 (MapType1Store Mask@2 (MapType0Select Heap@@9 t2 next) next (real_2_U (+ (U_2_real (MapType1Select Mask@2 (MapType0Select Heap@@9 t2 next) next)) wildcard@3))))) (and (state Heap@@9 Mask@3) (state Heap@@9 Mask@3))) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))))))))))))))))))
