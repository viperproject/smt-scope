...
(assert  (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type a_2) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))))
(set-info :boogie-vc-id m)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 7)) (> (U_2_real (MapType1Select Mask@0 a_2 f_7)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@0 a_2 f_7)) NoPerm) (=> (and (> wildcard@2 NoPerm) (< wildcard@2 (U_2_real (MapType1Select Mask@0 a_2 f_7)))) (=> (and (and (and (= Mask@1 (MapType1Store Mask@0 a_2 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 a_2 f_7)) wildcard@2)))) (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@1)) (and (> wildcard@3 NoPerm) (not (= a_2 null)))) (and (and (= Mask@2 (MapType1Store Mask@1 a_2 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@1 a_2 f_7)) wildcard@3)))) (state ExhaleHeap@0 Mask@2)) (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (HasDirectPerm Mask@2 a_2 f_7)) (=> (HasDirectPerm Mask@2 a_2 f_7) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm Mask@0 a_2 f_7)) (=> (HasDirectPerm Mask@0 a_2 f_7) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= (U_2_int (MapType0Select ExhaleHeap@0 a_2 f_7)) (U_2_int (MapType0Select Heap@@9 a_2 f_7)))) (=> (= (U_2_int (MapType0Select ExhaleHeap@0 a_2 f_7)) (U_2_int (MapType0Select Heap@@9 a_2 f_7))) (=> (and (state ExhaleHeap@0 Mask@2) (= (ControlFlow 0 3) (- 0 2))) (> (U_2_real (MapType1Select Mask@2 a_2 f_7)) NoPerm))))))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 a_2 $allocated)) (> wildcard@0 NoPerm)) (=> (and (and (not (= a_2 null)) (= Mask@0 (MapType1Store ZeroMask a_2 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask a_2 f_7)) wildcard@0))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 8) 1) anon3_Then_correct) (=> (= (ControlFlow 0 8) 3) anon3_Else_correct)))))))
