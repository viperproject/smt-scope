...
(declare-fun |fun01#trigger| (T@U Int) Bool)
(declare-fun x_1@@3 () Int)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon7_Then_correct true))
(let ((anon5_correct true))
(let ((anon7_Else_correct  (=> (and (|fun01#trigger| EmptyFrame (+ x_1@@3 1)) (= (ControlFlow 0 5) 1)) anon5_correct)))
(let ((anon6_Then_correct  (=> (<= x_1@@3 0) (and (=> (= (ControlFlow 0 6) 4) anon7_Then_correct) (=> (= (ControlFlow 0 6) 5) anon7_Else_correct)))))
(let ((anon6_Else_correct  (=> (< 0 x_1@@3) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (= x_1@@3 0))) (=> (not (= x_1@@3 0)) (=> (= (ControlFlow 0 2) 1) anon5_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 7) 6) anon6_Then_correct) (=> (= (ControlFlow 0 7) 2) anon6_Else_correct)))))
