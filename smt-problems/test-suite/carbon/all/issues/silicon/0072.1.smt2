...
(assert  (and (and (= (type s@@17) (SeqType intType)) (= (type PostHeap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id test04)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon4_correct true))
(let ((anon13_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i_4))) (= (ControlFlow 0 11) 7)) anon4_correct)))
(let ((anon13_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i_4)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 8) (- 0 9)) (< i_4 (|Seq#Length| s@@17))) (=> (< i_4 (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 8) 7) anon4_correct))))))))
...
(let ((anon15_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i_2_1))) (= (ControlFlow 0 5) 2)) anon9_correct)))
(let ((anon15_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i_2_1)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (> (U_2_int (|Seq#Index| s@@17 i_2_1)) 0)) (=> (> (U_2_int (|Seq#Index| s@@17 i_2_1)) 0) (=> (= (ControlFlow 0 3) 2) anon9_correct))))))
(let ((anon14_Else_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (> (|Seq#Length| s@@17) 2)) (and (=> (= (ControlFlow 0 13) (- 0 15)) (< 0 (|Seq#Length| s@@17))) (=> (< 0 (|Seq#Length| s@@17)) (=> (> (U_2_int (|Seq#Index| s@@17 0)) 0) (and (=> (= (ControlFlow 0 13) (- 0 14)) (< 1 (|Seq#Length| s@@17))) (=> (< 1 (|Seq#Length| s@@17)) (=> (and (> (U_2_int (|Seq#Index| s@@17 1)) 0) (state Heap@@9 ZeroMask)) (and (and (and (=> (= (ControlFlow 0 13) 12) anon11_Then_correct) (=> (= (ControlFlow 0 13) 1) anon14_Else_correct)) (=> (= (ControlFlow 0 13) 3) anon15_Then_correct)) (=> (= (ControlFlow 0 13) 5) anon15_Else_correct)))))))))))
