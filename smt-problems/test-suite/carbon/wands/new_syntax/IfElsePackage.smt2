...
(assert  (and (and (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type x@@14) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |Cell#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (not (U_2_bool (MapType0Select Heap@@10 x@@14 b_2))) (=> (and (= Mask@3 Mask@1) (= (ControlFlow 0 4) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (U_2_bool (MapType0Select Heap@@10 x@@14 b_2)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 x@@14 f_7)) (=> (HasDirectPerm Mask@1 x@@14 f_7) (=> (and (and (= Mask@2 (MapType1Store Mask@1 null (Cell (MapType0Select Heap@@10 x@@14 f_7)) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (Cell (MapType0Select Heap@@10 x@@14 f_7)))) FullPerm)))) (state Heap@@10 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 2) 1))) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x@@14 $allocated))) (and (not (= x@@14 null)) (= Mask@0 (MapType1Store ZeroMask x@@14 b_2 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@14 b_2)) FullPerm)))))) (and (and (state Heap@@10 Mask@0) (not (= x@@14 null))) (and (= Mask@1 (MapType1Store Mask@0 x@@14 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@14 f_7)) FullPerm)))) (state Heap@@10 Mask@1)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@1 x@@14 b_2)) (=> (HasDirectPerm Mask@1 x@@14 b_2) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))))
