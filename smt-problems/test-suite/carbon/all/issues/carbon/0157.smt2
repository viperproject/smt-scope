...
(declare-fun create_edge (T@T T@U T@U) T@U)
(declare-fun edge_pred (T@U) T@U)
(declare-fun edge_succ (T@U) T@U)
(declare-fun EdgeDomainTypeType (T@T) T@T)
(declare-fun EdgeDomainTypeTypeInv0 (T@T) T@T)
...
(assert  (and (and (and (and (forall ((arg0@@26 T@T) ) (! (= (Ctor (EdgeDomainTypeType arg0@@26)) 12)
 :qid |ctor:EdgeDomainTypeType|
)) (forall ((arg0@@27 T@T) ) (! (= (EdgeDomainTypeTypeInv0 (EdgeDomainTypeType arg0@@27)) arg0@@27)
 :qid |typeInv:EdgeDomainTypeTypeInv0|
 :pattern ( (EdgeDomainTypeType arg0@@27))
))) (forall ((T T@T) (arg0@@28 T@U) (arg1@@10 T@U) ) (! (= (type (create_edge T arg0@@28 arg1@@10)) (EdgeDomainTypeType T))
 :qid |funType:create_edge|
 :pattern ( (create_edge T arg0@@28 arg1@@10))
))) (forall ((arg0@@29 T@U) ) (! (= (type (edge_pred arg0@@29)) RefType)
 :qid |funType:edge_pred|
 :pattern ( (edge_pred arg0@@29))
))) (forall ((arg0@@30 T@U) ) (! (= (type (edge_succ arg0@@30)) RefType)
 :qid |funType:edge_succ|
 :pattern ( (edge_succ arg0@@30))
))))
(assert (forall ((x0_1 T@U) (y0_1 T@U) (T@@0 T@T) ) (!  (=> (and (= (type x0_1) RefType) (= (type y0_1) RefType)) (and (= (edge_pred (create_edge T@@0 x0_1 y0_1)) x0_1) (= (edge_succ (create_edge T@@0 x0_1 y0_1)) y0_1)))
 :qid |stdinbpl.222:19|
 :skolemid |22|
 :pattern ( (create_edge T@@0 x0_1 y0_1))
)))
...
(assert  (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (forall ((arg0@@31 T@T) ) (! (= (Ctor (ListDomainTypeType arg0@@31)) 13)
 :qid |ctor:ListDomainTypeType|
))) (forall ((arg0@@32 T@T) ) (! (= (ListDomainTypeTypeInv0 (ListDomainTypeType arg0@@32)) arg0@@32)
 :qid |typeInv:ListDomainTypeTypeInv0|
 :pattern ( (ListDomainTypeType arg0@@32))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (Nil intType) (Nil intType))) (=> (= (Nil intType) (Nil intType)) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (Nil intType) (Nil intType))))))))
