...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (forall ((arg0@@14 T@T) (arg1@@2 T@T) ) (! (= (Ctor (MapType arg0@@14 arg1@@2)) 8)
 :qid |ctor:MapType|
...
))) (= (Ctor RefType) 9)) (= (type values) (FieldType NormalFieldType (MapType intType RefType)))) (= (type value) (FieldType NormalFieldType intType))))
(assert (distinct $allocated values value)
)
(assert  (and (and (and (and (and (and (and (and (and (forall ((arg0@@17 T@T) (arg1@@5 T@T) ) (! (= (Ctor (MapType0Type arg0@@17 arg1@@5)) 10)
...
(assert  (not (IsPredicateField values)))
(assert  (not (IsWandField values)))
...
(assert  (and (and (and (and (and (= (type Heap@@9) (MapType1Type RefType)) (= (type x@@21) RefType)) (= (type freshObj@0) RefType)) (= (type Heap@0) (MapType1Type RefType))) (= (type Mask@0) (MapType2Type RefType realType))) (= (type Heap@1) (MapType1Type RefType))))
(set-info :boogie-vc-id main)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType1Select Heap@@9 x@@21 $allocated))) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType1Select Heap@@9 freshObj@0 $allocated)))) (= Heap@0 (MapType1Store Heap@@9 freshObj@0 $allocated (bool_2_U true)))) (and (= Mask@0 (MapType2Store ZeroMask freshObj@0 values (real_2_U (+ (U_2_real (MapType2Select ZeroMask freshObj@0 values)) FullPerm)))) (state Heap@0 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (= FullPerm (U_2_real (MapType2Select Mask@0 freshObj@0 values)))) (=> (= FullPerm (U_2_real (MapType2Select Mask@0 freshObj@0 values))) (=> (and (= Heap@1 (MapType1Store Heap@0 freshObj@0 values (|Map#Empty| intType RefType))) (state Heap@1 Mask@0)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (HasDirectPerm Mask@0 freshObj@0 values)) (=> (HasDirectPerm Mask@0 freshObj@0 values) (and (=> (= (ControlFlow 0 2) (- 0 5)) (U_2_bool (MapType0Select (|Map#Domain| (MapType1Select Heap@1 freshObj@0 values)) (int_2_U 1)))) (=> (U_2_bool (MapType0Select (|Map#Domain| (MapType1Select Heap@1 freshObj@0 values)) (int_2_U 1))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@0 (MapType0Select (|Map#Elements| (MapType1Select Heap@1 freshObj@0 values)) (int_2_U 1)) value)) (=> (HasDirectPerm Mask@0 (MapType0Select (|Map#Elements| (MapType1Select Heap@1 freshObj@0 values)) (int_2_U 1)) value) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> (U_2_int (MapType1Select Heap@1 (MapType0Select (|Map#Elements| (MapType1Select Heap@1 freshObj@0 values)) (int_2_U 1)) value)) 0)) (=> (> (U_2_int (MapType1Select Heap@1 (MapType0Select (|Map#Elements| (MapType1Select Heap@1 freshObj@0 values)) (int_2_U 1)) value)) 0) (=> (and (state Heap@1 Mask@0) (= (ControlFlow 0 2) (- 0 1))) false))))))))))))))))
