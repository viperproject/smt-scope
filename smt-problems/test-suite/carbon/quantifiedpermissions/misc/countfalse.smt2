...
(set-info :boogie-vc-id lemmaFront)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon8_correct  (=> (= (ControlFlow 0 15) (- 0 14)) (= (countFalse Heap@@17 a_3@@11 from@@9 to@@4) (ite (= from@@9 to@@4) 0 (+ (ite (U_2_bool (MapType0Select Heap@@17 (loc a_3@@11 from@@9) val)) 0 1) (countFalse Heap@@17 a_3@@11 (+ from@@9 1) to@@4)))))))
(let ((anon11_Then_correct  (=> (and (= from@@9 to@@4) (= (ControlFlow 0 16) 15)) anon8_correct)))
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 9) (- 0 13)) (<= 0 (+ from@@9 1))) (=> (<= 0 (+ from@@9 1)) (and (=> (= (ControlFlow 0 9) (- 0 12)) (<= (+ from@@9 1) to@@4)) (=> (<= (+ from@@9 1) to@@4) (and (=> (= (ControlFlow 0 9) (- 0 11)) (<= to@@4 (length a_3@@11))) (=> (<= to@@4 (length a_3@@11)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((z_3 Int) (z_3_1 Int) ) (!  (=> (and (and (and (and (not (= z_3 z_3_1)) (and (<= (+ from@@9 1) z_3) (< z_3 to@@4))) (and (<= (+ from@@9 1) z_3_1) (< z_3_1 to@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@11 z_3) (loc a_3@@11 z_3_1))))
 :qid |stdinbpl.1185:23|
 :skolemid |106|
 :pattern ( (neverTriggered13 z_3) (neverTriggered13 z_3_1))
))) (=> (forall ((z_3@@0 Int) (z_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= z_3@@0 z_3_1@@0)) (and (<= (+ from@@9 1) z_3@@0) (< z_3@@0 to@@4))) (and (<= (+ from@@9 1) z_3_1@@0) (< z_3_1@@0 to@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@11 z_3@@0) (loc a_3@@11 z_3_1@@0))))
 :qid |stdinbpl.1185:23|
 :skolemid |106|
 :pattern ( (neverTriggered13 z_3@@0) (neverTriggered13 z_3_1@@0))
)) (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((z_3@@1 Int) ) (!  (=> (and (<= (+ from@@9 1) z_3@@1) (< z_3@@1 to@@4)) (>= (U_2_real (MapType1Select QPMask@0 (loc a_3@@11 z_3@@1) val)) FullPerm))
 :qid |stdinbpl.1192:23|
 :skolemid |107|
 :pattern ( (loc a_3@@11 z_3@@1))
 :pattern ( (loc a_3@@11 z_3@@1))
)))))))))))))
(let ((anon11_Else_correct  (=> (not (= from@@9 to@@4)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm QPMask@0 (loc a_3@@11 from@@9) val)) (=> (HasDirectPerm QPMask@0 (loc a_3@@11 from@@9) val) (and (=> (= (ControlFlow 0 17) 9) anon12_Then_correct) (=> (= (ControlFlow 0 17) 15) anon8_correct)))))))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 7)) (<= 0 from@@9)) (=> (<= 0 from@@9) (and (=> (= (ControlFlow 0 3) (- 0 6)) (<= from@@9 to@@4)) (=> (<= from@@9 to@@4) (and (=> (= (ControlFlow 0 3) (- 0 5)) (<= to@@4 (length a_3@@11))) (=> (<= to@@4 (length a_3@@11)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((z_2 Int) (z_2_1 Int) ) (!  (=> (and (and (and (and (not (= z_2 z_2_1)) (and (<= from@@9 z_2) (< z_2 to@@4))) (and (<= from@@9 z_2_1) (< z_2_1 to@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@11 z_2) (loc a_3@@11 z_2_1))))
 :qid |stdinbpl.1123:21|
 :skolemid |100|
 :pattern ( (neverTriggered12 z_2) (neverTriggered12 z_2_1))
))) (=> (forall ((z_2@@0 Int) (z_2_1@@0 Int) ) (!  (=> (and (and (and (and (not (= z_2@@0 z_2_1@@0)) (and (<= from@@9 z_2@@0) (< z_2@@0 to@@4))) (and (<= from@@9 z_2_1@@0) (< z_2_1@@0 to@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@11 z_2@@0) (loc a_3@@11 z_2_1@@0))))
 :qid |stdinbpl.1123:21|
 :skolemid |100|
 :pattern ( (neverTriggered12 z_2@@0) (neverTriggered12 z_2_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((z_2@@1 Int) ) (!  (=> (and (<= from@@9 z_2@@1) (< z_2@@1 to@@4)) (>= (U_2_real (MapType1Select QPMask@0 (loc a_3@@11 z_2@@1) val)) FullPerm))
 :qid |stdinbpl.1130:21|
 :skolemid |101|
 :pattern ( (loc a_3@@11 z_2@@1))
 :pattern ( (loc a_3@@11 z_2@@1))
)))))))))))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((z_1 Int) (z_1_1 Int) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (and (<= from@@9 z_1) (< z_1 to@@4))) (and (<= from@@9 z_1_1) (< z_1_1 to@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@11 z_1) (loc a_3@@11 z_1_1))))
 :qid |stdinbpl.1058:15|
 :skolemid |94|
))) (=> (forall ((z_1@@0 Int) (z_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= z_1@@0 z_1_1@@0)) (and (<= from@@9 z_1@@0) (< z_1@@0 to@@4))) (and (<= from@@9 z_1_1@@0) (< z_1_1@@0 to@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@11 z_1@@0) (loc a_3@@11 z_1_1@@0))))
 :qid |stdinbpl.1058:15|
 :skolemid |94|
)) (=> (forall ((z_1@@1 Int) ) (!  (=> (and (and (<= from@@9 z_1@@1) (< z_1@@1 to@@4)) (< NoPerm FullPerm)) (and (qpRange11 (loc a_3@@11 z_1@@1)) (= (invRecv11 (loc a_3@@11 z_1@@1)) z_1@@1)))
 :qid |stdinbpl.1064:22|
 :skolemid |95|
 :pattern ( (loc a_3@@11 z_1@@1))
 :pattern ( (loc a_3@@11 z_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= from@@9 (invRecv11 o_3)) (< (invRecv11 o_3) to@@4)) (< NoPerm FullPerm)) (qpRange11 o_3)) (= (loc a_3@@11 (invRecv11 o_3)) o_3)))
 :qid |stdinbpl.1068:22|
 :skolemid |96|
 :pattern ( (invRecv11 o_3))
)) (forall ((z_1@@2 Int) ) (!  (=> (and (<= from@@9 z_1@@2) (< z_1@@2 to@@4)) (not (= (loc a_3@@11 z_1@@2) null)))
 :qid |stdinbpl.1074:22|
 :skolemid |97|
 :pattern ( (loc a_3@@11 z_1@@2))
 :pattern ( (loc a_3@@11 z_1@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= from@@9 (invRecv11 o_3@@0)) (< (invRecv11 o_3@@0) to@@4)) (< NoPerm FullPerm)) (qpRange11 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@11 (invRecv11 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (and (and (<= from@@9 (invRecv11 o_3@@0)) (< (invRecv11 o_3@@0) to@@4)) (< NoPerm FullPerm)) (qpRange11 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.1084:29|
 :skolemid |99|
 :pattern ( (MapType1Select ZeroMask o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (and (=> (= (ControlFlow 0 19) 3) anon10_Then_correct) (=> (= (ControlFlow 0 19) 16) anon11_Then_correct)) (=> (= (ControlFlow 0 19) 17) anon11_Else_correct)))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (<= 0 from@@9) (<= from@@9 to@@4)) (and (<= to@@4 (length a_3@@11)) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 21) 1) anon9_Then_correct) (=> (= (ControlFlow 0 21) 19) anon9_Else_correct))))))
