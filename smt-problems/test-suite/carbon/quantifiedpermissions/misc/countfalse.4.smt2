...
(declare-fun |countFalse#trigger| (T@U T@U Int Int) Bool)
...
(let ((anon10_Else_correct  (=> (and (|countFalse#trigger| (FrameFragment (int_2_U (|countFalse#condqp2| Heap@@17 a_3@@11 (+ from@@9 1) to@@4))) a_3@@11 (+ from@@9 1) to@@4) (= (ControlFlow 0 10) 8)) anon7_correct)))
(let ((anon9_Then_correct  (=> (and (= from@@9 to@@4) (= (ControlFlow 0 9) 8)) anon7_correct)))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 7)) (<= 0 (+ from@@9 1))) (=> (<= 0 (+ from@@9 1)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (<= (+ from@@9 1) to@@4)) (=> (<= (+ from@@9 1) to@@4) (and (=> (= (ControlFlow 0 3) (- 0 5)) (<= to@@4 (length a_3@@11))) (=> (<= to@@4 (length a_3@@11)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((z_5 Int) (z_5_1 Int) ) (!  (=> (and (and (and (and (not (= z_5 z_5_1)) (and (<= (+ from@@9 1) z_5) (< z_5 to@@4))) (and (<= (+ from@@9 1) z_5_1) (< z_5_1 to@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@11 z_5) (loc a_3@@11 z_5_1))))
 :qid |stdinbpl.572:23|
 :skolemid |52|
 :pattern ( (neverTriggered4 z_5) (neverTriggered4 z_5_1))
))) (=> (forall ((z_5@@0 Int) (z_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= z_5@@0 z_5_1@@0)) (and (<= (+ from@@9 1) z_5@@0) (< z_5@@0 to@@4))) (and (<= (+ from@@9 1) z_5_1@@0) (< z_5_1@@0 to@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@11 z_5@@0) (loc a_3@@11 z_5_1@@0))))
 :qid |stdinbpl.572:23|
 :skolemid |52|
 :pattern ( (neverTriggered4 z_5@@0) (neverTriggered4 z_5_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((z_5@@1 Int) ) (!  (=> (and (<= (+ from@@9 1) z_5@@1) (< z_5@@1 to@@4)) (>= (U_2_real (MapType1Select QPMask@0 (loc a_3@@11 z_5@@1) val)) FullPerm))
 :qid |stdinbpl.579:23|
 :skolemid |53|
 :pattern ( (loc a_3@@11 z_5@@1))
 :pattern ( (loc a_3@@11 z_5@@1))
)))))))))))))
(let ((anon9_Else_correct  (=> (not (= from@@9 to@@4)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm QPMask@0 (loc a_3@@11 from@@9) val)) (=> (HasDirectPerm QPMask@0 (loc a_3@@11 from@@9) val) (and (=> (= (ControlFlow 0 11) 3) anon10_Then_correct) (=> (= (ControlFlow 0 11) 10) anon10_Else_correct)))))))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((z_4 Int) (z_4_1 Int) ) (!  (=> (and (and (and (and (not (= z_4 z_4_1)) (and (<= from@@9 z_4) (< z_4 to@@4))) (and (<= from@@9 z_4_1) (< z_4_1 to@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@11 z_4) (loc a_3@@11 z_4_1))))
 :qid |stdinbpl.514:15|
 :skolemid |46|
))) (=> (forall ((z_4@@0 Int) (z_4_1@@0 Int) ) (!  (=> (and (and (and (and (not (= z_4@@0 z_4_1@@0)) (and (<= from@@9 z_4@@0) (< z_4@@0 to@@4))) (and (<= from@@9 z_4_1@@0) (< z_4_1@@0 to@@4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@11 z_4@@0) (loc a_3@@11 z_4_1@@0))))
 :qid |stdinbpl.514:15|
 :skolemid |46|
)) (=> (forall ((z_4@@1 Int) ) (!  (=> (and (and (<= from@@9 z_4@@1) (< z_4@@1 to@@4)) (< NoPerm FullPerm)) (and (qpRange3 (loc a_3@@11 z_4@@1)) (= (invRecv3 (loc a_3@@11 z_4@@1)) z_4@@1)))
 :qid |stdinbpl.520:22|
 :skolemid |47|
 :pattern ( (loc a_3@@11 z_4@@1))
 :pattern ( (loc a_3@@11 z_4@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= from@@9 (invRecv3 o_3)) (< (invRecv3 o_3) to@@4)) (< NoPerm FullPerm)) (qpRange3 o_3)) (= (loc a_3@@11 (invRecv3 o_3)) o_3)))
 :qid |stdinbpl.524:22|
 :skolemid |48|
 :pattern ( (invRecv3 o_3))
)) (forall ((z_4@@2 Int) ) (!  (=> (and (<= from@@9 z_4@@2) (< z_4@@2 to@@4)) (not (= (loc a_3@@11 z_4@@2) null)))
 :qid |stdinbpl.530:22|
 :skolemid |49|
 :pattern ( (loc a_3@@11 z_4@@2))
 :pattern ( (loc a_3@@11 z_4@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= from@@9 (invRecv3 o_3@@0)) (< (invRecv3 o_3@@0) to@@4)) (< NoPerm FullPerm)) (qpRange3 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@11 (invRecv3 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (and (and (<= from@@9 (invRecv3 o_3@@0)) (< (invRecv3 o_3@@0) to@@4)) (< NoPerm FullPerm)) (qpRange3 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.536:22|
 :skolemid |50|
...
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (=> (= (ControlFlow 0 13) 9) anon9_Then_correct) (=> (= (ControlFlow 0 13) 11) anon9_Else_correct)))))))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) (= AssumeFunctionsAbove 0)) (=> (and (and (<= 0 from@@9) (<= from@@9 to@@4)) (and (<= to@@4 (length a_3@@11)) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 15) 1) anon8_Then_correct) (=> (= (ControlFlow 0 15) 13) anon8_Else_correct))))))
