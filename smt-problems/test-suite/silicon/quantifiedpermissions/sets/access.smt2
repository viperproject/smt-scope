(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:20:01
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quantifiedpermissions/sets/access.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (forall ((y@10@01 $Ref)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/sets/access.vpr@10@12@10@55-aux|)))
(assert (forall ((y@10@01 $Ref)) (!
  (=>
    (Set_in y@10@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01)))
    (>=
      ...
      0))
  :pattern ((Set_in y@10@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@6@01))))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/sets/access.vpr@10@12@10@55|)))
...
(assert (forall ((y@21@01 $Ref)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/sets/access.vpr@19@12@19@55-aux|)))
(assert (forall ((y@21@01 $Ref)) (!
  (=>
    (Set_in y@21@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@17@01)))
    (>=
      ...
      0))
  :pattern ((Set_in y@21@01 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first $t@17@01))))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/sets/access.vpr@19@12@19@55|)))
