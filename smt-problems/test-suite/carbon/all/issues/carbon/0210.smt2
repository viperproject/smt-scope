...
(assert  (and (and (and (and (= (type g@@3) (MapType2Type RefType boolType)) (= (type n$0) RefType)) (= (type Heap@@12) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@49 T@U) ) (! (= (type (invRecv1 arg0@@49)) RefType)
...
(let ((anon12_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g@@3 n$0)) (not (= (MapType0Select Heap@@12 n$0 next) null)))) (= (ControlFlow 0 6) 3)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (U_2_bool (MapType2Select g@@3 n$0)) (not (= (MapType0Select Heap@@12 n$0 next) null))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm QPMask@0 n$0 next)) (=> (HasDirectPerm QPMask@0 n$0 next) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
(let ((anon11_Else_correct  (=> (not (U_2_bool (MapType2Select g@@3 n$0))) (and (=> (= (ControlFlow 0 9) 4) anon12_Then_correct) (=> (= (ControlFlow 0 9) 6) anon12_Else_correct)))))
(let ((anon11_Then_correct  (=> (U_2_bool (MapType2Select g@@3 n$0)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm QPMask@0 n$0 next)) (=> (HasDirectPerm QPMask@0 n$0 next) (and (=> (= (ControlFlow 0 7) 4) anon12_Then_correct) (=> (= (ControlFlow 0 7) 6) anon12_Else_correct)))))))
(let ((anon10_Else_correct true))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((n_3 T@U) (n_3_1 T@U) ) (!  (=> (and (= (type n_3) RefType) (= (type n_3_1) RefType)) (=> (and (and (and (and (not (= n_3 n_3_1)) (U_2_bool (MapType2Select g@@3 n_3))) (U_2_bool (MapType2Select g@@3 n_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3 n_3_1))))
 :qid |stdinbpl.528:15|
 :skolemid |86|
 :no-pattern (type n_3)
...
)) (=> (and (forall ((n_3@@1 T@U) ) (!  (=> (= (type n_3@@1) RefType) (=> (and (U_2_bool (MapType2Select g@@3 n_3@@1)) (< NoPerm FullPerm)) (and (qpRange1 n_3@@1) (= (invRecv1 n_3@@1) n_3@@1))))
 :qid |stdinbpl.534:22|
 :skolemid |87|
 :pattern ( (MapType0Select Heap@@12 n_3@@1 next))
 :pattern ( (MapType1Select QPMask@0 n_3@@1 next))
 :pattern ( (MapType0Select Heap@@12 n_3@@1 next))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select g@@3 (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.538:22|
 :skolemid |88|
 :pattern ( (invRecv1 o_3))
))) (=> (and (and (forall ((n_3@@2 T@U) ) (!  (=> (and (= (type n_3@@2) RefType) (U_2_bool (MapType2Select g@@3 n_3@@2))) (not (= n_3@@2 null)))
 :qid |stdinbpl.544:22|
 :skolemid |89|
 :pattern ( (MapType0Select Heap@@12 n_3@@2 next))
 :pattern ( (MapType1Select QPMask@0 n_3@@2 next))
 :pattern ( (MapType0Select Heap@@12 n_3@@2 next))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select g@@3 (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 next)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select g@@3 (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (U_2_real (MapType1Select ZeroMask o_3@@0 next))))))
 :qid |stdinbpl.550:22|
 :skolemid |90|
...
)) (state Heap@@12 QPMask@0))) (and (and (=> (= (ControlFlow 0 10) 2) anon10_Else_correct) (=> (= (ControlFlow 0 10) 7) anon11_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon11_Else_correct))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@12 ZeroMask) (=> (and (= AssumeFunctionsAbove 0) (not (U_2_bool (MapType2Select g@@3 null)))) (and (=> (= (ControlFlow 0 12) 1) anon9_Then_correct) (=> (= (ControlFlow 0 12) 10) anon9_Else_correct))))))
