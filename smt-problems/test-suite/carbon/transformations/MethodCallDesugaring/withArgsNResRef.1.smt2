...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= 2 0)) (=> (>= 2 0) (=> (state Heap@@9 ZeroMask) (=> (and (= res2 2) (state Heap@@9 ZeroMask)) (=> (and (and (state Heap@@9 ZeroMask) (= res1 (+ res2 5))) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= res2 2)) (=> (= res2 2) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= res1 (+ res2 5)))))))))))))
