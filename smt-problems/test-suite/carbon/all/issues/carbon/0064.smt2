...
(assert  (and (and (= (type Heap@@15) (MapType0Type RefType)) (= (type this@@10) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |Nodesize#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) (U_2_bool (MapType0Select Heap@@15 this@@10 $allocated))) (=> (and (and (and (= AssumeFunctionsAbove 0) (not (= this@@10 null))) (and (state Heap@@15 ZeroMask) (> wildcard@0 NoPerm))) (and (and (= Mask@0 (MapType1Store ZeroMask null (Nodevalid this@@10) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Nodevalid this@@10))) wildcard@0)))) (state Heap@@15 Mask@0)) (and (state Heap@@15 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (> 1 0)))))
