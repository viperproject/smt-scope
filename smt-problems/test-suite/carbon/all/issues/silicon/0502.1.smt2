...
(assert  (and (and (and (and (and (and (= (type QPMask@0) (MapType1Type RefType realType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type r1) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type r2) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id foo6)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (= (U_2_real (MapType1Select QPMask@0 o_3 f_7)) (U_2_real (MapType1Select Mask@1 o_3 f_7))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@0) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 f_7))) (= (U_2_real (MapType1Select Mask@1 o_3@@0 f_5)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_5))))))
 :qid |stdinbpl.1007:29|
 :skolemid |115|
 :pattern ( (MapType1Select Mask@1 o_3@@0 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@0 f_5))
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= FullPerm (U_2_real (MapType1Select QPMask@0 r1 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 r1 f_7))) (=> (= Heap@0 (MapType0Store Heap@@9 r1 f_7 (int_2_U 3))) (=> (and (state Heap@0 QPMask@0) (= (ControlFlow 0 3) (- 0 2))) (not (= r1 r2)))))))))
