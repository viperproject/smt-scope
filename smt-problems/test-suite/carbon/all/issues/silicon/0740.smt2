...
(let ((anon26_Then_correct  (=> (and (not (= curr@0 null)) (not (= curr@0 null))) (=> (and (and (= Mask@4 (MapType1Store ZeroMask curr@0 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask curr@0 f_7)) FullPerm)))) (state ExhaleHeap@0 Mask@4)) (and (= Mask@5 Mask@4) (= (ControlFlow 0 20) 19))) anon11_correct))))
...
(let ((anon30_Then_correct  (=> (and (not (= curr@0 null)) (not (= curr@0 null))) (=> (and (and (= Mask@2 (MapType1Store Mask@1 curr@0 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@1 curr@0 f_7)) FullPerm)))) (state ExhaleHeap@0 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 6) 5))) anon20_correct))))
...
(let ((anon24_Then_correct  (=> (and (not (= curr@0 null)) (not (= curr@0 null))) (=> (and (and (= Mask@8 (MapType1Store Mask@1 curr@0 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@1 curr@0 f_7)) FullPerm)))) (state ExhaleHeap@0 Mask@8)) (and (= Mask@9 Mask@8) (= (ControlFlow 0 2) 1))) anon7_correct))))
(let ((anon4_correct  (=> (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@1) (U_2_bool (MapType0Select ExhaleHeap@0 curr@0 $allocated))) (and (and (and (=> (= (ControlFlow 0 23) 22) anon25_Then_correct) (=> (= (ControlFlow 0 23) 8) anon25_Else_correct)) (=> (= (ControlFlow 0 23) 2) anon24_Then_correct)) (=> (= (ControlFlow 0 23) 3) anon24_Else_correct)))))
(let ((anon3_correct  (=> (= Mask@0 (MapType1Store ZeroMask null f_7 (real_2_U (- (U_2_real (MapType1Select ZeroMask null f_7)) FullPerm)))) (=> (and (= Mask@1 Mask@0) (= (ControlFlow 0 25) 23)) anon4_correct))))
(let ((anon22_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 28) 25)) anon3_correct)))
(let ((anon22_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (<= FullPerm (U_2_real (MapType1Select ZeroMask null f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select ZeroMask null f_7))) (=> (= (ControlFlow 0 26) 25) anon3_correct))))))
...
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 curr $allocated)) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 30) 29) anon21_Then_correct) (=> (= (ControlFlow 0 30) 24) anon21_Else_correct))))))
