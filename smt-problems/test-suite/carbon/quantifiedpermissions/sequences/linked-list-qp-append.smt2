...
(assert (not
 ...
 :qid |stdinbpl.687:17|
 :skolemid |63|
)) (=> (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 (|Seq#Length| (MapType0Select Heap@@18 this@@15 nodes)))) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index| (MapType0Select Heap@@18 this@@15 nodes) i_1@@1)) (= (invRecv1 (|Seq#Index| (MapType0Select Heap@@18 this@@15 nodes) i_1@@1)) i_1@@1)))
 :qid |stdinbpl.693:24|
 :skolemid |64|
 :pattern ( (|Seq#Index| (MapType0Select Heap@@18 this@@15 nodes) i_1@@1))
 :pattern ( (|Seq#Index| (MapType0Select Heap@@18 this@@15 nodes) i_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv1 o_3)) (< (invRecv1 o_3) (|Seq#Length| (MapType0Select Heap@@18 this@@15 nodes)))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (|Seq#Index| (MapType0Select Heap@@18 this@@15 nodes) (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.697:24|
 :skolemid |65|
 ...
 :pattern ( (|Seq#Index| (MapType0Select Heap@@18 this@@15 nodes) i_1@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (|Seq#Length| (MapType0Select Heap@@18 this@@15 nodes)))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| (MapType0Select Heap@@18 this@@15 nodes) (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select UnfoldingMask@1 o_3@@0 val)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (|Seq#Length| (MapType0Select Heap@@18 this@@15 nodes)))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select UnfoldingMask@1 o_3@@0 val))))))
 :qid |stdinbpl.709:24|
 :skolemid |67|
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.721:17|
 :skolemid |69|
)) (=> (forall ((i_2@@1 Int) ) (!  (=> (and (and (<= 0 i_2@@1) (< i_2@@1 (|Seq#Length| (MapType0Select Heap@@18 this@@15 nodes)))) (< NoPerm FullPerm)) (and (qpRange2 (|Seq#Index| (MapType0Select Heap@@18 this@@15 nodes) i_2@@1)) (= (invRecv2 (|Seq#Index| (MapType0Select Heap@@18 this@@15 nodes) i_2@@1)) i_2@@1)))
 :qid |stdinbpl.727:24|
 :skolemid |70|
 :pattern ( (|Seq#Index| (MapType0Select Heap@@18 this@@15 nodes) i_2@@1))
 :pattern ( (|Seq#Index| (MapType0Select Heap@@18 this@@15 nodes) i_2@@1))
)) (=> (and (and (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (<= 0 (invRecv2 o_3@@2)) (< (invRecv2 o_3@@2) (|Seq#Length| (MapType0Select Heap@@18 this@@15 nodes)))) (< NoPerm FullPerm)) (qpRange2 o_3@@2)) (= (|Seq#Index| (MapType0Select Heap@@18 this@@15 nodes) (invRecv2 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.731:24|
 :skolemid |71|
 :pattern ( (invRecv2 o_3@@2))
)) (forall ((i_2@@2 Int) ) (!  (=> (and (<= 0 i_2@@2) (< i_2@@2 (|Seq#Length| (MapType0Select Heap@@18 this@@15 nodes)))) (not (= (|Seq#Index| (MapType0Select Heap@@18 this@@15 nodes) i_2@@2) null)))
 :qid |stdinbpl.737:24|
 :skolemid |72|
 :pattern ( (|Seq#Index| (MapType0Select Heap@@18 this@@15 nodes) i_2@@2))
 :pattern ( (|Seq#Index| (MapType0Select Heap@@18 this@@15 nodes) i_2@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (and (<= 0 (invRecv2 o_3@@3)) (< (invRecv2 o_3@@3) (|Seq#Length| (MapType0Select Heap@@18 this@@15 nodes)))) (< NoPerm FullPerm)) (qpRange2 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| (MapType0Select Heap@@18 this@@15 nodes) (invRecv2 o_3@@3)) o_3@@3)) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 next)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@3 next)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv2 o_3@@3)) (< (invRecv2 o_3@@3) (|Seq#Length| (MapType0Select Heap@@18 this@@15 nodes)))) (< NoPerm FullPerm)) (qpRange2 o_3@@3))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 next)) (U_2_real (MapType1Select QPMask@0 o_3@@3 next))))))
 :qid |stdinbpl.743:24|
 :skolemid |73|
...
)))) (and (and (state Heap@@18 QPMask@1) (forall ((i_3 Int) ) (!  (=> (and (<= 0 i_3) (< i_3 (|Seq#Length| (MapType0Select Heap@@18 this@@15 nodes)))) (and (|Seq#Contains| (MapType0Select Heap@@18 this@@15 nodes) (|Seq#Index| (MapType0Select Heap@@18 this@@15 nodes) i_3)) (ite (< i_3 (- (|Seq#Length| (MapType0Select Heap@@18 this@@15 nodes)) 1)) (= (MapType0Select Heap@@18 (|Seq#Index| (MapType0Select Heap@@18 this@@15 nodes) i_3) next) (|Seq#Index| (MapType0Select Heap@@18 this@@15 nodes) (+ i_3 1))) (= (MapType0Select Heap@@18 (|Seq#Index| (MapType0Select Heap@@18 this@@15 nodes) i_3) next) null))))
 :qid |stdinbpl.753:22|
 :skolemid |75|
 :pattern ( (MapType0Select Heap@@18 (|Seq#Index| (MapType0Select Heap@@18 this@@15 nodes) i_3) next))
))) (and (state Heap@@18 QPMask@1) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm QPMask@1 this@@15 nodes)))))))))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (List this@@15))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (List this@@15)))) (=> (= (ControlFlow 0 5) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@18 ZeroMask) (U_2_bool (MapType0Select Heap@@18 this@@15 $allocated))) (and (= AssumeFunctionsAbove 1) (= Mask@0 (MapType1Store ZeroMask null (List this@@15) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (List this@@15))) FullPerm)))))) (and (and (state Heap@@18 Mask@0) (state Heap@@18 Mask@0)) (and (|List#trigger| Heap@@18 (List this@@15)) (= (MapType0Select Heap@@18 null (List this@@15)) (CombineFrames (FrameFragment (MapType0Select Heap@@18 this@@15 nodes)) (CombineFrames (FrameFragment (int_2_U (|List#condqp1| Heap@@18 this@@15))) (FrameFragment (int_2_U (|List#condqp2| Heap@@18 this@@15))))))))) (and (=> (= (ControlFlow 0 8) 5) anon3_Then_correct) (=> (= (ControlFlow 0 8) 7) anon3_Else_correct)))))
