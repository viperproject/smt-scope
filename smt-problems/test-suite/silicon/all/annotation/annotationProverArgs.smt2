(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 19:40:36
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/annotation/annotationProverArgs.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
; [eval] i * i2
(push) ; 3
(assert (not (>= (* i@2@01 i2@3@01) 0)))
(check-sat)
; unsat
(pop) ; 3
; 0,00s
; (get-info :all-statistics)
(assert (>= (* i@2@01 i2@3@01) 0))
(pop) ; 2
(pop) ; 1
; ---------- m2 ----------
(get-option :smt.arith.nl)
; true
...
; [eval] i * i2
(push) ; 3
(assert (not (>= (* i@12@01 i2@13@01) 0)))
(check-sat)
; unsat
(pop) ; 3
; 0,00s
; (get-info :all-statistics)
(assert (>= (* i@12@01 i2@13@01) 0))
(pop) ; 2
(pop) ; 1
(get-option :smt.arith.nl)
; true
