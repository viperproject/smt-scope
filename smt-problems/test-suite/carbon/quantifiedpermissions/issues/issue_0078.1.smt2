...
(assert  (and (and (and (and (and (and (and (and (= (type Mask@1) (MapType2Type RefType realType)) (= (type this@@7) RefType)) (= (type Heap@@10) (MapType1Type RefType))) (= (type QPMask@1) (MapType2Type RefType realType))) (= (type QPMask@0) (MapType2Type RefType realType))) (= (type x_5) RefType)) (= (type Mask@2) (MapType2Type RefType realType))) (forall ((arg0@@47 T@U) ) (! (= (type (invRecv5 arg0@@47)) RefType)
 :qid |funType:invRecv5|
 :pattern ( (invRecv5 arg0@@47))
))) (= (type Mask@0) (MapType2Type RefType realType))))
(set-info :boogie-vc-id Dmm2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_5))) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_5)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm Mask@1 x_5 p_1)) (=> (HasDirectPerm Mask@1 x_5 p_1) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
(let ((anon11_Then_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm Mask@1 this@@7 s)) (=> (HasDirectPerm Mask@1 this@@7 s) (and (=> (= (ControlFlow 0 11) 8) anon12_Then_correct) (=> (= (ControlFlow 0 11) 10) anon12_Else_correct))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((x_3 T@U) ) (!  (=> (= (type x_3) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_3)) (= (MapType1Select Heap@@10 x_3 p_1) null)) (dummyFunction (MapType1Select Heap@@10 x_3 p_1))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.912:17|
 :skolemid |125|
 :pattern ( (MapType1Select Heap@@10 x_3 p_1))
 :pattern ( (MapType2Select QPMask@1 x_3 p_1))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_3))
))) (=> (forall ((x_3@@0 T@U) ) (!  (=> (= (type x_3@@0) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_3@@0)) (= (MapType1Select Heap@@10 x_3@@0 p_1) null)) (dummyFunction (MapType1Select Heap@@10 x_3@@0 p_1))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.912:17|
 :skolemid |125|
 :pattern ( (MapType1Select Heap@@10 x_3@@0 p_1))
 :pattern ( (MapType2Select QPMask@1 x_3@@0 p_1))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_3@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((x_3@@1 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3@@1) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3@@1 x_3_1)) (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_3@@1)) (= (MapType1Select Heap@@10 x_3@@1 p_1) null))) (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_3_1)) (= (MapType1Select Heap@@10 x_3_1 p_1) null))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= x_3@@1 x_3_1))))
 :qid |stdinbpl.919:17|
 :skolemid |126|
 :pattern ( (neverTriggered6 x_3@@1) (neverTriggered6 x_3_1))
))) (=> (forall ((x_3@@2 T@U) (x_3_1@@0 T@U) ) (!  (=> (and (= (type x_3@@2) RefType) (= (type x_3_1@@0) RefType)) (=> (and (and (and (and (not (= x_3@@2 x_3_1@@0)) (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_3@@2)) (= (MapType1Select Heap@@10 x_3@@2 p_1) null))) (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_3_1@@0)) (= (MapType1Select Heap@@10 x_3_1@@0 p_1) null))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= x_3@@2 x_3_1@@0))))
 :qid |stdinbpl.919:17|
 :skolemid |126|
 :pattern ( (neverTriggered6 x_3@@2) (neverTriggered6 x_3_1@@0))
)) (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((x_3@@3 T@U) ) (!  (=> (= (type x_3@@3) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_3@@3)) (= (MapType1Select Heap@@10 x_3@@3 p_1) null)) (>= (U_2_real (MapType2Select QPMask@0 x_3@@3 p_1)) (/ (to_real 1) (to_real 2)))))
 :qid |stdinbpl.926:17|
 :skolemid |127|
 :pattern ( (MapType1Select Heap@@10 x_3@@3 p_1))
 :pattern ( (MapType2Select QPMask@1 x_3@@3 p_1))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_3@@3))
)))))))))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 16)) (forall ((x_1 T@U) ) (!  (=> (= (type x_1) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_1)) (dummyFunction (MapType1Select Heap@@10 x_1 p_1))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.856:17|
 :skolemid |118|
 :pattern ( (MapType1Select Heap@@10 x_1 p_1))
 :pattern ( (MapType2Select QPMask@0 x_1 p_1))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_1))
))) (=> (forall ((x_1@@0 T@U) ) (!  (=> (= (type x_1@@0) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_1@@0)) (dummyFunction (MapType1Select Heap@@10 x_1@@0 p_1))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.856:17|
 :skolemid |118|
 :pattern ( (MapType1Select Heap@@10 x_1@@0 p_1))
 :pattern ( (MapType2Select QPMask@0 x_1@@0 p_1))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_1@@0))
)) (and (=> (= (ControlFlow 0 13) (- 0 15)) (forall ((x_1@@1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1@@1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1@@1 x_1_1)) (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_1@@1))) (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_1_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= x_1@@1 x_1_1))))
 :qid |stdinbpl.863:17|
 :skolemid |119|
 :pattern ( (neverTriggered5 x_1@@1) (neverTriggered5 x_1_1))
))) (=> (forall ((x_1@@2 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@2 x_1_1@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_1@@2))) (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_1_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= x_1@@2 x_1_1@@0))))
 :qid |stdinbpl.863:17|
 :skolemid |119|
 :pattern ( (neverTriggered5 x_1@@2) (neverTriggered5 x_1_1@@0))
)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((x_1@@3 T@U) ) (!  (=> (and (= (type x_1@@3) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_1@@3))) (>= (U_2_real (MapType2Select Mask@2 x_1@@3 p_1)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.870:17|
 :skolemid |120|
 :pattern ( (MapType1Select Heap@@10 x_1@@3 p_1))
 :pattern ( (MapType2Select QPMask@0 x_1@@3 p_1))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_1@@3))
))) (=> (forall ((x_1@@4 T@U) ) (!  (=> (and (= (type x_1@@4) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_1@@4))) (>= (U_2_real (MapType2Select Mask@2 x_1@@4 p_1)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.870:17|
 :skolemid |120|
 :pattern ( (MapType1Select Heap@@10 x_1@@4 p_1))
 :pattern ( (MapType2Select QPMask@0 x_1@@4 p_1))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_1@@4))
)) (=> (and (and (forall ((x_1@@5 T@U) ) (!  (=> (= (type x_1@@5) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_1@@5)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange5 x_1@@5) (= (invRecv5 x_1@@5) x_1@@5))))
 :qid |stdinbpl.876:22|
 :skolemid |121|
 :pattern ( (MapType1Select Heap@@10 x_1@@5 p_1))
 :pattern ( (MapType2Select QPMask@0 x_1@@5 p_1))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_1@@5))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) (invRecv5 o_3))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange5 o_3))) (= (invRecv5 o_3) o_3)))
 :qid |stdinbpl.880:22|
 :skolemid |122|
 :pattern ( (invRecv5 o_3))
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) (invRecv5 o_3@@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange5 o_3@@0))) (and (= (invRecv5 o_3@@0) o_3@@0) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 p_1)) (- (U_2_real (MapType2Select Mask@2 o_3@@0 p_1)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) (invRecv5 o_3@@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange5 o_3@@0)))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 p_1)) (U_2_real (MapType2Select Mask@2 o_3@@0 p_1))))))
 :qid |stdinbpl.886:22|
 :skolemid |123|
 :pattern ( (MapType2Select QPMask@0 o_3@@0 p_1))
)) (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 p_1))) (= (U_2_real (MapType2Select Mask@2 o_3@@1 f_5)) (U_2_real (MapType2Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.892:29|
 :skolemid |124|
...
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@1 this@@7 s))))
(let ((anon2_correct  (=> (= Mask@2 (MapType2Store Mask@1 this@@7 s (real_2_U (- (U_2_real (MapType2Select Mask@1 this@@7 s)) FullPerm)))) (and (=> (= (ControlFlow 0 17) 2) anon10_Then_correct) (=> (= (ControlFlow 0 17) 13) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 20) 17)) anon2_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (<= FullPerm (U_2_real (MapType2Select Mask@1 this@@7 s)))) (=> (<= FullPerm (U_2_real (MapType2Select Mask@1 this@@7 s))) (=> (= (ControlFlow 0 18) 17) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (and (U_2_bool (MapType1Select Heap@@10 this@@7 $allocated)) (not (= this@@7 null))) (and (= Mask@0 (MapType2Store ZeroMask this@@7 p_1 (real_2_U (+ (U_2_real (MapType2Select ZeroMask this@@7 p_1)) FullPerm)))) (state Heap@@10 Mask@0))) (and (and (not (= this@@7 null)) (= Mask@1 (MapType2Store Mask@0 this@@7 s (real_2_U (+ (U_2_real (MapType2Select Mask@0 this@@7 s)) FullPerm))))) (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1)))) (and (=> (= (ControlFlow 0 21) (- 0 23)) (HasDirectPerm Mask@1 this@@7 s)) (=> (HasDirectPerm Mask@1 this@@7 s) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) this@@7)) (state Heap@@10 Mask@1)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (HasDirectPerm Mask@1 this@@7 p_1)) (=> (HasDirectPerm Mask@1 this@@7 p_1) (=> (and (= (MapType1Select Heap@@10 this@@7 p_1) null) (state Heap@@10 Mask@1)) (and (=> (= (ControlFlow 0 21) 18) anon9_Then_correct) (=> (= (ControlFlow 0 21) 20) anon9_Else_correct))))))))))))
