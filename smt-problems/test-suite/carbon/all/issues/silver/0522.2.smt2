...
(set-info :boogie-vc-id |funky#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@14 x@@34 $allocated)) (= AssumeFunctionsAbove 0)) (and (= perm@0 (/ (to_real (- 0 1)) (to_real 2))) (= (ControlFlow 0 2) (- 0 1)))) (>= perm@0 NoPerm)))))
...
(declare-fun AssumeFunctionsAbove () Int)
(declare-fun x@@34 () T@U)
(assert  (and (and (= (type QPMask@0) (MapType1Type RefType realType)) (= (type Heap@@14) (MapType0Type RefType))) (= (type x@@34) RefType)))
(set-info :boogie-vc-id test40)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (= (U_2_real (MapType1Select QPMask@0 o_3 f_7)) (U_2_real (MapType1Select ZeroMask o_3 f_7))))
 :qid |stdinbpl.1717:22|
 :skolemid |171|
 :pattern ( (MapType1Select QPMask@0 o_3 f_7))
)) (=> (and (forall ((o_3@@0 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@0) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 f_7))) (= (U_2_real (MapType1Select ZeroMask o_3@@0 f_5)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_5))))))
 :qid |stdinbpl.1721:29|
 :skolemid |172|
 :pattern ( (MapType1Select ZeroMask o_3@@0 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@0 f_5))
)) (state Heap@@14 QPMask@0)) (=> (and (and (state Heap@@14 QPMask@0) (state Heap@@14 QPMask@0)) (and (= perm@0 (/ (to_real (- 0 1)) (to_real 2))) (= (ControlFlow 0 3) (- 0 2)))) (>= perm@0 NoPerm))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@14 x@@34 $allocated))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
