...
(assert  (and (= (type list@0) (ListDomainTypeType intType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id discriminators_3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon22_Else_correct  (=> (and (not (= (List_tag (get_List_tail list@0)) 1)) (= (ControlFlow 0 16) (- 0 15))) false)))
(let ((anon23_Else_correct  (=> (and (not (= (List_tag (get_List_tail list@0)) 1)) (= (ControlFlow 0 12) (- 0 11))) false)))
(let ((anon17_correct true))
(let ((anon22_Then_correct  (=> (and (= (List_tag (get_List_tail list@0)) 1) (= (ControlFlow 0 14) 7)) anon17_correct)))
(let ((anon21_Then_correct  (=> (= (List_tag (get_List_tail list@0)) 0) (and (=> (= (ControlFlow 0 17) 14) anon22_Then_correct) (=> (= (ControlFlow 0 17) 16) anon22_Else_correct)))))
(let ((anon23_Then_correct  (=> (and (= (List_tag (get_List_tail list@0)) 1) (= (ControlFlow 0 10) 7)) anon17_correct)))
(let ((anon21_Else_correct  (=> (not (= (List_tag (get_List_tail list@0)) 0)) (and (=> (= (ControlFlow 0 13) 10) anon23_Then_correct) (=> (= (ControlFlow 0 13) 12) anon23_Else_correct)))))
(let ((anon20_Then_correct  (=> (= (List_tag (get_List_tail list@0)) 1) (and (=> (= (ControlFlow 0 18) 17) anon21_Then_correct) (=> (= (ControlFlow 0 18) 13) anon21_Else_correct)))))
(let ((anon24_Then_correct  (=> (and (= (List_tag (get_List_tail list@0)) 1) (= (ControlFlow 0 8) 7)) anon17_correct)))
(let ((anon24_Else_correct  (=> (and (not (= (List_tag (get_List_tail list@0)) 1)) (= (ControlFlow 0 6) (- 0 5))) false)))
(let ((anon20_Else_correct  (=> (not (= (List_tag (get_List_tail list@0)) 1)) (and (=> (= (ControlFlow 0 9) 8) anon24_Then_correct) (=> (= (ControlFlow 0 9) 6) anon24_Else_correct)))))
(let ((anon19_Then_correct  (=> (and (= (List_tag (get_List_tail list@0)) 1) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 19) 18) anon20_Then_correct) (=> (= (ControlFlow 0 19) 9) anon20_Else_correct)))))
(let ((anon19_Else_correct  (=> (and (not (= (List_tag (get_List_tail list@0)) 1)) (= (ControlFlow 0 4) (- 0 3))) false)))
(let ((anon18_Then_correct  (=> (and (= (List_tag (get_List_tail list@0)) 1) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 20) 19) anon19_Then_correct) (=> (= (ControlFlow 0 20) 4) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (and (not (= (List_tag (get_List_tail list@0)) 1)) (= (ControlFlow 0 2) (- 0 1))) false)))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= list@0 (Cons (int_2_U 1) (Nil intType))) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 21) 20) anon18_Then_correct) (=> (= (ControlFlow 0 21) 2) anon18_Else_correct))))))
