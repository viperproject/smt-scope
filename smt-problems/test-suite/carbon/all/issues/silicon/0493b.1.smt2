...
(assert  (and (and (= (type vas@@11) (MapType2Type RefType boolType)) (= (type vis@@3) (MapType2Type intType boolType))) (= (type Heap@@20) (MapType0Type RefType))))
(set-info :boogie-vc-id |foo_twos#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((a_3 T@U) (i_3 Int) (a_3_1 T@U) (i_3_1 Int) ) (!  (=> (and (= (type a_3) RefType) (= (type a_3_1) RefType)) (=> (and (and (and (and (and (not (= a_3 a_3_1)) (not (= i_3 i_3_1))) (and (U_2_bool (MapType2Select vas@@11 a_3)) (U_2_bool (MapType2Select vis@@3 (int_2_U i_3))))) (and (U_2_bool (MapType2Select vas@@11 a_3_1)) (U_2_bool (MapType2Select vis@@3 (int_2_U i_3_1))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_3 a_3_1)) (not (= i_3 i_3_1)))))
 :qid |stdinbpl.742:17|
 :skolemid |106|
 :pattern ( (neverTriggered4 a_3 i_3) (neverTriggered4 a_3_1 i_3_1))
)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@20 ZeroMask) (= AssumeFunctionsAbove 1)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
