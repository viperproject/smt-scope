...
(declare-fun |Nodes#frame| (T@U) Int)
...
(assert (forall ((Heap@@5 T@U) ) (!  (=> (= (type Heap@@5) (MapType0Type RefType)) (and (= (Nodes Heap@@5) (|Nodes'| Heap@@5)) (dummyFunction (int_2_U |Nodes#triggerStateless|))))
 :qid |stdinbpl.547:15|
 :skolemid |58|
 :pattern ( (Nodes Heap@@5))
)))
...
(assert (forall ((Heap@@8 T@U) ) (!  (=> (= (type Heap@@8) (MapType0Type RefType)) (dummyFunction (int_2_U |Nodes#triggerStateless|)))
 :qid |stdinbpl.551:15|
 :skolemid |59|
 :pattern ( (|Nodes'| Heap@@8))
)))
...
(assert (forall ((Heap@@10 T@U) (Mask@@9 T@U) ) (!  (=> (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (state Heap@@10 Mask@@9)) (= (|Nodes'| Heap@@10) (|Nodes#frame| EmptyFrame)))
 :qid |stdinbpl.564:15|
 :skolemid |61|
 :pattern ( (state Heap@@10 Mask@@9) (|Nodes'| Heap@@10))
)))
...
(assert (forall ((Heap@@12 T@U) (Mask@@10 T@U) ) (!  (=> (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (and (state Heap@@12 Mask@@10) (< AssumeFunctionsAbove 0))) (= (Nodes Heap@@12) 5))
 :qid |stdinbpl.557:15|
 :skolemid |60|
 :pattern ( (state Heap@@12 Mask@@10) (Nodes Heap@@12))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
