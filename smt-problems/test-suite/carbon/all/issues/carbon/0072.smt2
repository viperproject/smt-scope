...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type frac) (FieldType NormalFieldType realType))) (= (Ctor RefType) 8)) (= (type data) (FieldType NormalFieldType RefType))))
(assert (distinct $allocated frac data)
)
...
(assert  (not (IsPredicateField frac)))
(assert  (not (IsWandField frac)))
...
(assert  (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type this) RefType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id run)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon5_Else_correct true))
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm ZeroMask this frac)) (=> (HasDirectPerm ZeroMask this frac) (=> (and (= perm@0 (U_2_real (MapType0Select PostHeap@0 this frac))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@0 NoPerm)))))))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 this $allocated))) (and (not (= this null)) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 6) 2) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct)))))
