...
(declare-fun xs () T@U)
(declare-fun invRecv3 (T@U Real) T@U)
(declare-fun qpRange3 (T@U Real) Bool)
(declare-fun FrameFragment (T@U) T@U)
(assert  (and (and (and (and (and (and (and (and (and (and (= (type y@@2) RefType) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@11) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type xs) (SeqType RefType))) (forall ((arg0@@39 T@U) (arg1@@18 Real) ) (! (= (type (invRecv3 arg0@@39 arg1@@18)) RefType)
 :qid |funType:invRecv3|
 :pattern ( (invRecv3 arg0@@39 arg1@@18))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon6_correct  (=> (<= NoPerm p_1@@5) (and (=> (= (ControlFlow 0 3) (- 0 4)) (>= p_1@@5 NoPerm)) (=> (>= p_1@@5 NoPerm) (=> (and (=> (> p_1@@5 NoPerm) (not (= y@@2 null))) (= Mask@1 (MapType1Store Mask@0 y@@2 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@2 f_7)) p_1@@5))))) (=> (and (and (state Heap@1 Mask@1) (state Heap@1 Mask@1)) (and (state Heap@1 Mask@1) (= (ControlFlow 0 3) (- 0 2)))) (not (= y@@2 null)))))))))
(let ((anon9_Else_correct  (=> (HasDirectPerm Mask@0 null (pred2 y@@2 p_1@@5)) (=> (and (= Heap@1 Heap@@11) (= (ControlFlow 0 6) 3)) anon6_correct))))
(let ((anon9_Then_correct  (=> (and (and (not (HasDirectPerm Mask@0 null (pred2 y@@2 p_1@@5))) (= Heap@0 (MapType0Store Heap@@11 null (pred2 y@@2 p_1@@5) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 5) 3))) anon6_correct)))
(let ((anon4_correct  (=> (= Mask@0 (MapType1Store QPMask@0 null (pred2 y@@2 p_1@@5) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (pred2 y@@2 p_1@@5))) FullPerm)))) (and (=> (= (ControlFlow 0 7) 5) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 7)) anon4_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (pred2 y@@2 p_1@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (pred2 y@@2 p_1@@5)))) (=> (= (ControlFlow 0 8) 7) anon4_correct))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| xs x_1)) (|Seq#Contains| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= x_1 x_1_1)) (not (= p_1@@5 p_1@@5)))))
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| xs x_1@@1) (< NoPerm FullPerm)) (and (= (invRecv3 x_1@@1 p_1@@5) x_1@@1) (qpRange3 x_1@@1 p_1@@5))))
...
)) (=> (and (and (and (forall ((a_1@@11 T@U) (p_1_1 Real) ) (!  (=> (= (type a_1@@11) RefType) (=> (and (and (|Seq#Contains| xs (invRecv3 a_1@@11 p_1_1)) (< NoPerm FullPerm)) (qpRange3 a_1@@11 p_1_1)) (and (= (invRecv3 a_1@@11 p_1_1) a_1@@11) (= p_1@@5 p_1_1))))
 :qid |stdinbpl.1226:22|
 :skolemid |85|
 :pattern ( (invRecv3 a_1@@11 p_1_1))
)) (forall ((a_1@@12 T@U) (p_1_1@@0 Real) ) (!  (=> (= (type a_1@@12) RefType) (=> (and (and (|Seq#Contains| xs (invRecv3 a_1@@12 p_1_1@@0)) (< NoPerm FullPerm)) (qpRange3 a_1@@12 p_1_1@@0)) (and (=> (< NoPerm FullPerm) (and (= (invRecv3 a_1@@12 p_1_1@@0) a_1@@12) (= p_1@@5 p_1_1@@0))) (= (U_2_real (MapType1Select QPMask@0 null (pred2 a_1@@12 p_1_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (pred2 a_1@@12 p_1_1@@0))) FullPerm)))))
...
)) (forall ((a_1@@13 T@U) (p_1_1@@1 Real) ) (!  (=> (and (= (type a_1@@13) RefType) (not (and (and (|Seq#Contains| xs (invRecv3 a_1@@13 p_1_1@@1)) (< NoPerm FullPerm)) (qpRange3 a_1@@13 p_1_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (pred2 a_1@@13 p_1_1@@1))) (U_2_real (MapType1Select ZeroMask null (pred2 a_1@@13 p_1_1@@1)))))
 :qid |stdinbpl.1242:22|
 :skolemid |88|
 :pattern ( (MapType1Select QPMask@0 null (pred2 a_1@@13 p_1_1@@1)))
)))) (and (and (state Heap@@11 QPMask@0) (state Heap@@11 QPMask@0)) (and (|pred2#trigger| Heap@@11 (pred2 y@@2 p_1@@5)) (= (MapType0Select Heap@@11 null (pred2 y@@2 p_1@@5)) (ConditionalFrame p_1@@5 (FrameFragment (MapType0Select Heap@@11 y@@2 f_7))))))) (and (=> (= (ControlFlow 0 11) 8) anon8_Then_correct) (=> (= (ControlFlow 0 11) 10) anon8_Else_correct))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 y@@2 $allocated))) (=> (and (and (|Seq#Contains| xs y@@2) (state Heap@@11 ZeroMask)) (and (<= NoPerm p_1@@5) (state Heap@@11 ZeroMask))) (and (=> (= (ControlFlow 0 13) 1) anon7_Then_correct) (=> (= (ControlFlow 0 13) 11) anon7_Else_correct))))))
