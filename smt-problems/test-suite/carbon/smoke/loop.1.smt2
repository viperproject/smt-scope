...
(declare-fun |foo'| (T@U) Bool)
(declare-fun |foo#frame| (T@U) Bool)
...
(assert (forall ((Heap@@4 T@U) (Mask@@4 T@U) ) (!  (=> (and (and (= (type Heap@@4) (MapType0Type RefType)) (= (type Mask@@4) (MapType1Type RefType realType))) (and (state Heap@@4 Mask@@4) (< AssumeFunctionsAbove 0))) (not (foo Heap@@4)))
 :qid |stdinbpl.195:15|
 :skolemid |24|
 :pattern ( (state Heap@@4 Mask@@4) (foo Heap@@4))
)))
...
(assert (forall ((Heap@@6 T@U) (Mask@@7 T@U) ) (!  (=> (and (and (= (type Heap@@6) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (state Heap@@6 Mask@@7)) (= (|foo'| Heap@@6) (|foo#frame| EmptyFrame)))
 :qid |stdinbpl.202:15|
 :skolemid |25|
 :pattern ( (state Heap@@6 Mask@@7) (|foo'| Heap@@6))
)))
...
(assert (forall ((Heap@@9 T@U) ) (!  (=> (= (type Heap@@9) (MapType0Type RefType)) (dummyFunction (bool_2_U |foo#triggerStateless|)))
 :qid |stdinbpl.189:15|
 :skolemid |23|
 :pattern ( (|foo'| Heap@@9))
)))
...
(assert (forall ((Heap@@12 T@U) ) (!  (=> (= (type Heap@@12) (MapType0Type RefType)) (and (= (foo Heap@@12) (|foo'| Heap@@12)) (dummyFunction (bool_2_U |foo#triggerStateless|))))
 :qid |stdinbpl.185:15|
 :skolemid |22|
 :pattern ( (foo Heap@@12))
)))
