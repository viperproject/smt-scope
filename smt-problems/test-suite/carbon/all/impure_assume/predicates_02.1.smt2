...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon8_correct  (=> (and (and (and (state Heap@@10 Mask@2) b_2) (and (state Heap@@10 Mask@2) (state Heap@@10 Mask@2))) (and (and (or (not (= x@@14 y@@1)) (not (= i@@5 j))) (state Heap@@10 Mask@2)) (and (state Heap@@10 Mask@2) (= (ControlFlow 0 2) (- 0 1))))) false)))
