...
(declare-fun tail1_1 () T@U)
(declare-fun head2_1 () Int)
(declare-fun tail2_1 () T@U)
(declare-fun Heap@@9 () T@U)
(declare-fun xs_1_1 () T@U)
(declare-fun head_1_1 () Int)
(declare-fun tail_1_1 () T@U)
(assert  (and (and (and (and (= (type xs_1_1) listDomainTypeType) (= (type tail_1_1) listDomainTypeType)) (= (type tail1_1) listDomainTypeType)) (= (type tail2_1) listDomainTypeType)) (= (type Heap@@9) (MapType0Type RefType))))
...
(let ((anon12_Else_correct  (=> (and (forall ((head_2_1 Int) (tail_2_1 T@U) (xs_2_1 T@U) ) (!  (=> (and (and (= (type tail_2_1) listDomainTypeType) (= (type xs_2_1) listDomainTypeType)) (is_Cons xs_2_1)) (=  (and (= head_2_1 (head_Cons xs_2_1)) (= tail_2_1 (tail_Cons xs_2_1))) (= (Cons head_2_1 tail_2_1) xs_2_1)))
 :qid |stdinbpl.328:20|
 :skolemid |28|
...
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 10) 6) anon14_Then_correct) (=> (= (ControlFlow 0 10) 8) anon15_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon15_Else_correct)))))
(let ((anon5_correct true))
(let ((anon13_Else_correct  (=> (and (not (is_Cons xs_1_1)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon13_Then_correct  (=> (is_Cons xs_1_1) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=  (and (= head_1_1 (head_Cons xs_1_1)) (= tail_1_1 (tail_Cons xs_1_1))) (= (Cons head_1_1 tail_1_1) xs_1_1))) (=> (=  (and (= head_1_1 (head_Cons xs_1_1)) (= tail_1_1 (tail_Cons xs_1_1))) (= (Cons head_1_1 tail_1_1) xs_1_1)) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (and (and (=> (= (ControlFlow 0 11) 1) anon11_Then_correct) (=> (= (ControlFlow 0 11) 10) anon12_Else_correct)) (=> (= (ControlFlow 0 11) 3) anon13_Then_correct)) (=> (= (ControlFlow 0 11) 5) anon13_Else_correct)))))
