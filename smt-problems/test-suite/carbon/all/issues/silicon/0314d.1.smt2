...
(declare-fun i@@6 () Int)
(declare-fun j@@5 () Int)
(assert  (and (and (and (and (and (= (type xs) (SeqType RefType)) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 44) (let ((anon19_correct true))
(let ((anon30_Else_correct  (=> (and (not (and (<= 0 i_8) (< i_8 (|Seq#Length| xs)))) (= (ControlFlow 0 31) 27)) anon19_correct)))
(let ((anon30_Then_correct  (=> (and (<= 0 i_8) (< i_8 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 28) (- 0 30)) (>= i_8 0)) (=> (>= i_8 0) (and (=> (= (ControlFlow 0 28) (- 0 29)) (< i_8 (|Seq#Length| xs))) (=> (< i_8 (|Seq#Length| xs)) (=> (= (ControlFlow 0 28) 27) anon19_correct))))))))
(let ((anon29_Else_correct  (and (=> (= (ControlFlow 0 24) (- 0 26)) (forall ((i_9 Int) ) (!  (=> (and (and (<= 0 i_9) (< i_9 (|Seq#Length| xs))) (dummyFunction (MapType0Select ExhaleHeap@0 (|Seq#Index| xs i_9) f_7))) (>= p_1 NoPerm))
 :qid |stdinbpl.855:17|
 :skolemid |80|
 :pattern ( (|Seq#Index| xs i_9))
 :pattern ( (MapType0Select ExhaleHeap@0 (|Seq#Index| xs i_9) f_7))
))) (=> (forall ((i_9@@0 Int) ) (!  (=> (and (and (<= 0 i_9@@0) (< i_9@@0 (|Seq#Length| xs))) (dummyFunction (MapType0Select ExhaleHeap@0 (|Seq#Index| xs i_9@@0) f_7))) (>= p_1 NoPerm))
 :qid |stdinbpl.855:17|
 :skolemid |80|
 :pattern ( (|Seq#Index| xs i_9@@0))
 :pattern ( (MapType0Select ExhaleHeap@0 (|Seq#Index| xs i_9@@0) f_7))
)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (forall ((i_9@@1 Int) (i_9_1 Int) ) (!  (=> (and (and (and (and (not (= i_9@@1 i_9_1)) (and (<= 0 i_9@@1) (< i_9@@1 (|Seq#Length| xs)))) (and (<= 0 i_9_1) (< i_9_1 (|Seq#Length| xs)))) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index| xs i_9@@1) (|Seq#Index| xs i_9_1))))
 :qid |stdinbpl.862:17|
 :skolemid |81|
 :pattern ( (neverTriggered4 i_9@@1) (neverTriggered4 i_9_1))
))) (=> (forall ((i_9@@2 Int) (i_9_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_9@@2 i_9_1@@0)) (and (<= 0 i_9@@2) (< i_9@@2 (|Seq#Length| xs)))) (and (<= 0 i_9_1@@0) (< i_9_1@@0 (|Seq#Length| xs)))) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index| xs i_9@@2) (|Seq#Index| xs i_9_1@@0))))
 :qid |stdinbpl.862:17|
 :skolemid |81|
 :pattern ( (neverTriggered4 i_9@@2) (neverTriggered4 i_9_1@@0))
)) (=> (= (ControlFlow 0 24) (- 0 23)) (forall ((i_9@@3 Int) ) (!  (=> (and (<= 0 i_9@@3) (< i_9@@3 (|Seq#Length| xs))) (>= (U_2_real (MapType1Select QPMask@2 (|Seq#Index| xs i_9@@3) f_7)) p_1))
 :qid |stdinbpl.869:17|
 :skolemid |82|
 :pattern ( (|Seq#Index| xs i_9@@3))
 :pattern ( (MapType0Select ExhaleHeap@0 (|Seq#Index| xs i_9@@3) f_7))
)))))))))
(let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 32) (- 0 34)) (forall ((i_7 Int) (i_7_1 Int) ) (!  (=> (and (and (and (and (not (= i_7 i_7_1)) (and (<= k i_7) (< i_7 (|Seq#Length| xs)))) (and (<= k i_7_1) (< i_7_1 (|Seq#Length| xs)))) (< NoPerm (/ p_1 (to_real 2)))) (< NoPerm (/ p_1 (to_real 2)))) (not (= (|Seq#Index| xs i_7) (|Seq#Index| xs i_7_1))))
 :qid |stdinbpl.794:15|
 :skolemid |73|
))) (=> (forall ((i_7@@0 Int) (i_7_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_7@@0 i_7_1@@0)) (and (<= k i_7@@0) (< i_7@@0 (|Seq#Length| xs)))) (and (<= k i_7_1@@0) (< i_7_1@@0 (|Seq#Length| xs)))) (< NoPerm (/ p_1 (to_real 2)))) (< NoPerm (/ p_1 (to_real 2)))) (not (= (|Seq#Index| xs i_7@@0) (|Seq#Index| xs i_7_1@@0))))
 :qid |stdinbpl.794:15|
 :skolemid |73|
)) (=> (and (forall ((i_7@@1 Int) ) (!  (=> (and (and (<= k i_7@@1) (< i_7@@1 (|Seq#Length| xs))) (< NoPerm (/ p_1 (to_real 2)))) (and (qpRange3 (|Seq#Index| xs i_7@@1)) (= (invRecv3 (|Seq#Index| xs i_7@@1)) i_7@@1)))
 :qid |stdinbpl.800:22|
 :skolemid |74|
 :pattern ( (|Seq#Index| xs i_7@@1))
 :pattern ( (MapType0Select ExhaleHeap@0 (|Seq#Index| xs i_7@@1) f_7))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= k (invRecv3 o_3)) (< (invRecv3 o_3) (|Seq#Length| xs))) (< NoPerm (/ p_1 (to_real 2)))) (qpRange3 o_3)) (= (|Seq#Index| xs (invRecv3 o_3)) o_3)))
 :qid |stdinbpl.804:22|
 :skolemid |75|
 :pattern ( (invRecv3 o_3))
))) (and (=> (= (ControlFlow 0 32) (- 0 33)) (forall ((i_7@@2 Int) ) (!  (=> (and (<= k i_7@@2) (< i_7@@2 (|Seq#Length| xs))) (>= (/ p_1 (to_real 2)) NoPerm))
 :qid |stdinbpl.810:15|
 :skolemid |76|
 :pattern ( (|Seq#Index| xs i_7@@2))
 :pattern ( (MapType0Select ExhaleHeap@0 (|Seq#Index| xs i_7@@2) f_7))
))) (=> (forall ((i_7@@3 Int) ) (!  (=> (and (<= k i_7@@3) (< i_7@@3 (|Seq#Length| xs))) (>= (/ p_1 (to_real 2)) NoPerm))
 :qid |stdinbpl.810:15|
 :skolemid |76|
 :pattern ( (|Seq#Index| xs i_7@@3))
 :pattern ( (MapType0Select ExhaleHeap@0 (|Seq#Index| xs i_7@@3) f_7))
)) (=> (and (forall ((i_7@@4 Int) ) (!  (=> (and (and (<= k i_7@@4) (< i_7@@4 (|Seq#Length| xs))) (> (/ p_1 (to_real 2)) NoPerm)) (not (= (|Seq#Index| xs i_7@@4) null)))
 :qid |stdinbpl.816:22|
 :skolemid |77|
 :pattern ( (|Seq#Index| xs i_7@@4))
 :pattern ( (MapType0Select ExhaleHeap@0 (|Seq#Index| xs i_7@@4) f_7))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= k (invRecv3 o_3@@0)) (< (invRecv3 o_3@@0) (|Seq#Length| xs))) (< NoPerm (/ p_1 (to_real 2)))) (qpRange3 o_3@@0)) (and (=> (< NoPerm (/ p_1 (to_real 2))) (= (|Seq#Index| xs (invRecv3 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (+ (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (/ p_1 (to_real 2)))))) (=> (not (and (and (and (<= k (invRecv3 o_3@@0)) (< (invRecv3 o_3@@0) (|Seq#Length| xs))) (< NoPerm (/ p_1 (to_real 2)))) (qpRange3 o_3@@0))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7))))))
 :qid |stdinbpl.822:22|
 :skolemid |78|
...
(let ((anon28_Else_correct  (=> (and (not (and (<= k i_6) (< i_6 (|Seq#Length| xs)))) (= (ControlFlow 0 22) 18)) anon15_correct)))
(let ((anon28_Then_correct  (=> (and (<= k i_6) (< i_6 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 19) (- 0 21)) (>= i_6 0)) (=> (>= i_6 0) (and (=> (= (ControlFlow 0 19) (- 0 20)) (< i_6 (|Seq#Length| xs))) (=> (< i_6 (|Seq#Length| xs)) (=> (= (ControlFlow 0 19) 18) anon15_correct))))))))
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 35) (- 0 38)) (forall ((i_5 Int) ) (!  (=> (and (and (<= k i_5) (< i_5 (|Seq#Length| xs))) (dummyFunction (MapType0Select Heap@@9 (|Seq#Index| xs i_5) f_7))) (>= (/ p_1 (to_real 2)) NoPerm))
 :qid |stdinbpl.731:17|
 :skolemid |66|
 :pattern ( (|Seq#Index| xs i_5))
 :pattern ( (MapType0Select Heap@@9 (|Seq#Index| xs i_5) f_7))
))) (=> (forall ((i_5@@0 Int) ) (!  (=> (and (and (<= k i_5@@0) (< i_5@@0 (|Seq#Length| xs))) (dummyFunction (MapType0Select Heap@@9 (|Seq#Index| xs i_5@@0) f_7))) (>= (/ p_1 (to_real 2)) NoPerm))
 :qid |stdinbpl.731:17|
 :skolemid |66|
 :pattern ( (|Seq#Index| xs i_5@@0))
 :pattern ( (MapType0Select Heap@@9 (|Seq#Index| xs i_5@@0) f_7))
)) (and (=> (= (ControlFlow 0 35) (- 0 37)) (forall ((i_5@@1 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5@@1 i_5_1)) (and (<= k i_5@@1) (< i_5@@1 (|Seq#Length| xs)))) (and (<= k i_5_1) (< i_5_1 (|Seq#Length| xs)))) (< NoPerm (/ p_1 (to_real 2)))) (< NoPerm (/ p_1 (to_real 2)))) (not (= (|Seq#Index| xs i_5@@1) (|Seq#Index| xs i_5_1))))
 :qid |stdinbpl.738:17|
 :skolemid |67|
 :pattern ( (neverTriggered2 i_5@@1) (neverTriggered2 i_5_1))
))) (=> (forall ((i_5@@2 Int) (i_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_5@@2 i_5_1@@0)) (and (<= k i_5@@2) (< i_5@@2 (|Seq#Length| xs)))) (and (<= k i_5_1@@0) (< i_5_1@@0 (|Seq#Length| xs)))) (< NoPerm (/ p_1 (to_real 2)))) (< NoPerm (/ p_1 (to_real 2)))) (not (= (|Seq#Index| xs i_5@@2) (|Seq#Index| xs i_5_1@@0))))
 :qid |stdinbpl.738:17|
 :skolemid |67|
 :pattern ( (neverTriggered2 i_5@@2) (neverTriggered2 i_5_1@@0))
)) (and (=> (= (ControlFlow 0 35) (- 0 36)) (forall ((i_5@@3 Int) ) (!  (=> (and (<= k i_5@@3) (< i_5@@3 (|Seq#Length| xs))) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs i_5@@3) f_7)) (/ p_1 (to_real 2))))
 :qid |stdinbpl.745:17|
 :skolemid |68|
 :pattern ( (|Seq#Index| xs i_5@@3))
 :pattern ( (MapType0Select Heap@@9 (|Seq#Index| xs i_5@@3) f_7))
))) (=> (forall ((i_5@@4 Int) ) (!  (=> (and (<= k i_5@@4) (< i_5@@4 (|Seq#Length| xs))) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs i_5@@4) f_7)) (/ p_1 (to_real 2))))
 :qid |stdinbpl.745:17|
 :skolemid |68|
 :pattern ( (|Seq#Index| xs i_5@@4))
 :pattern ( (MapType0Select Heap@@9 (|Seq#Index| xs i_5@@4) f_7))
)) (=> (and (forall ((i_5@@5 Int) ) (!  (=> (and (and (<= k i_5@@5) (< i_5@@5 (|Seq#Length| xs))) (< NoPerm (/ p_1 (to_real 2)))) (and (qpRange2 (|Seq#Index| xs i_5@@5)) (= (invRecv2 (|Seq#Index| xs i_5@@5)) i_5@@5)))
 :qid |stdinbpl.751:22|
 :skolemid |69|
 :pattern ( (|Seq#Index| xs i_5@@5))
 :pattern ( (MapType0Select Heap@@9 (|Seq#Index| xs i_5@@5) f_7))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (<= k (invRecv2 o_3@@2)) (< (invRecv2 o_3@@2) (|Seq#Length| xs))) (and (< NoPerm (/ p_1 (to_real 2))) (qpRange2 o_3@@2))) (= (|Seq#Index| xs (invRecv2 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.755:22|
 :skolemid |70|
 :pattern ( (invRecv2 o_3@@2))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (<= k (invRecv2 o_3@@3)) (< (invRecv2 o_3@@3) (|Seq#Length| xs))) (and (< NoPerm (/ p_1 (to_real 2))) (qpRange2 o_3@@3))) (and (= (|Seq#Index| xs (invRecv2 o_3@@3)) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (- (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (/ p_1 (to_real 2)))))) (=> (not (and (and (<= k (invRecv2 o_3@@3)) (< (invRecv2 o_3@@3) (|Seq#Length| xs))) (and (< NoPerm (/ p_1 (to_real 2))) (qpRange2 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7))))))
 :qid |stdinbpl.761:22|
 :skolemid |71|
...
))) (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 QPMask@1) (state ExhaleHeap@0 QPMask@1))) (and (and (=> (= (ControlFlow 0 35) 32) anon27_Else_correct) (=> (= (ControlFlow 0 35) 19) anon28_Then_correct)) (=> (= (ControlFlow 0 35) 22) anon28_Else_correct))))))))))))
(let ((anon11_correct true))
(let ((anon26_Else_correct  (=> (and (not (and (<= k i_4) (< i_4 (|Seq#Length| xs)))) (= (ControlFlow 0 17) 13)) anon11_correct)))
(let ((anon26_Then_correct  (=> (and (<= k i_4) (< i_4 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< i_4 (|Seq#Length| xs))) (=> (< i_4 (|Seq#Length| xs)) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 39) (- 0 41)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 (|Seq#Length| xs)))) (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length| xs)))) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index| xs i_3) (|Seq#Index| xs i_3_1))))
 :qid |stdinbpl.660:15|
 :skolemid |59|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (and (<= 0 i_3@@0) (< i_3@@0 (|Seq#Length| xs)))) (and (<= 0 i_3_1@@0) (< i_3_1@@0 (|Seq#Length| xs)))) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index| xs i_3@@0) (|Seq#Index| xs i_3_1@@0))))
 :qid |stdinbpl.660:15|
 :skolemid |59|
)) (=> (and (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 (|Seq#Length| xs))) (< NoPerm p_1)) (and (qpRange1 (|Seq#Index| xs i_3@@1)) (= (invRecv1 (|Seq#Index| xs i_3@@1)) i_3@@1)))
 :qid |stdinbpl.666:22|
 :skolemid |60|
 :pattern ( (|Seq#Index| xs i_3@@1))
 :pattern ( (MapType0Select Heap@@9 (|Seq#Index| xs i_3@@1) f_7))
)) (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (and (<= 0 (invRecv1 o_3@@5)) (< (invRecv1 o_3@@5) (|Seq#Length| xs))) (< NoPerm p_1)) (qpRange1 o_3@@5)) (= (|Seq#Index| xs (invRecv1 o_3@@5)) o_3@@5)))
 :qid |stdinbpl.670:22|
 :skolemid |61|
 :pattern ( (invRecv1 o_3@@5))
))) (and (=> (= (ControlFlow 0 39) (- 0 40)) (forall ((i_3@@2 Int) ) (!  (=> (and (<= 0 i_3@@2) (< i_3@@2 (|Seq#Length| xs))) (>= p_1 NoPerm))
 :qid |stdinbpl.676:15|
 :skolemid |62|
 :pattern ( (|Seq#Index| xs i_3@@2))
 :pattern ( (MapType0Select Heap@@9 (|Seq#Index| xs i_3@@2) f_7))
))) (=> (forall ((i_3@@3 Int) ) (!  (=> (and (<= 0 i_3@@3) (< i_3@@3 (|Seq#Length| xs))) (>= p_1 NoPerm))
 :qid |stdinbpl.676:15|
 :skolemid |62|
 :pattern ( (|Seq#Index| xs i_3@@3))
 :pattern ( (MapType0Select Heap@@9 (|Seq#Index| xs i_3@@3) f_7))
)) (=> (and (and (forall ((i_3@@4 Int) ) (!  (=> (and (and (<= 0 i_3@@4) (< i_3@@4 (|Seq#Length| xs))) (> p_1 NoPerm)) (not (= (|Seq#Index| xs i_3@@4) null)))
 :qid |stdinbpl.682:22|
 :skolemid |63|
 :pattern ( (|Seq#Index| xs i_3@@4))
 :pattern ( (MapType0Select Heap@@9 (|Seq#Index| xs i_3@@4) f_7))
)) (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (and (<= 0 (invRecv1 o_3@@6)) (< (invRecv1 o_3@@6) (|Seq#Length| xs))) (< NoPerm p_1)) (qpRange1 o_3@@6)) (and (=> (< NoPerm p_1) (= (|Seq#Index| xs (invRecv1 o_3@@6)) o_3@@6)) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@6 f_7)) p_1)))) (=> (not (and (and (and (<= 0 (invRecv1 o_3@@6)) (< (invRecv1 o_3@@6) (|Seq#Length| xs))) (< NoPerm p_1)) (qpRange1 o_3@@6))) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@6 f_7))))))
 :qid |stdinbpl.688:22|
 :skolemid |64|
...
)) (state Heap@@9 QPMask@0))) (=> (and (and (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)) (and (<= 0 k) (state Heap@@9 QPMask@0))) (and (and (state Heap@@9 QPMask@0) (< k (|Seq#Length| xs))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (and (=> (= (ControlFlow 0 39) 35) anon25_Else_correct) (=> (= (ControlFlow 0 39) 14) anon26_Then_correct)) (=> (= (ControlFlow 0 39) 17) anon26_Else_correct)))))))))))
(let ((anon7_correct true))
(let ((anon24_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 (|Seq#Length| xs)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon24_Then_correct  (=> (and (<= 0 i_2) (< i_2 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_2 (|Seq#Length| xs))) (=> (< i_2 (|Seq#Length| xs)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon21_Else_correct  (=> (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (>= i_1 0) (and (< i_1 (|Seq#Length| xs)) (and (>= j_1 0) (and (< j_1 (|Seq#Length| xs)) (not (= i_1 j_1)))))) (not (= (|Seq#Index| xs i_1) (|Seq#Index| xs j_1))))
 :qid |stdinbpl.637:20|
 :skolemid |58|
 :pattern ( (|Seq#Index| xs i_1) (|Seq#Index| xs j_1))
)) (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 42) 39) anon23_Else_correct) (=> (= (ControlFlow 0 42) 9) anon24_Then_correct)) (=> (= (ControlFlow 0 42) 12) anon24_Else_correct))))))
(let ((anon3_correct true))
(let ((anon22_Else_correct  (=> (and (not (and (>= i@@6 0) (and (< i@@6 (|Seq#Length| xs)) (and (>= j@@5 0) (and (< j@@5 (|Seq#Length| xs)) (not (= i@@6 j@@5))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon22_Then_correct  (=> (and (>= i@@6 0) (and (< i@@6 (|Seq#Length| xs)) (and (>= j@@5 0) (and (< j@@5 (|Seq#Length| xs)) (not (= i@@6 j@@5)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i@@6 (|Seq#Length| xs))) (=> (< i@@6 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j@@5 (|Seq#Length| xs))) (=> (< j@@5 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (< NoPerm p_1) (< p_1 FullPerm)) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 43) 42) anon21_Else_correct) (=> (= (ControlFlow 0 43) 2) anon22_Then_correct)) (=> (= (ControlFlow 0 43) 7) anon22_Else_correct))))))
