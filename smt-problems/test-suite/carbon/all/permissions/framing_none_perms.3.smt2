...
(assert  (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type x@@14) RefType)) (= (type y@@7) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@15) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 25) (let ((anon15_correct true))
(let ((anon24_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 18) 15)) anon15_correct)))
(let ((anon24_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= FullPerm (U_2_real (MapType1Select Mask@1 y@@7 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 y@@7 f_7))) (=> (= (ControlFlow 0 16) 15) anon15_correct))))))
(let ((anon23_Else_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (= vy@0 (fun01 Heap@0 x@@14 y@@7 false)))))
(let ((anon21_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (= vx@0 (fun01 Heap@0 x@@14 y@@7 true))) (=> (= vx@0 (fun01 Heap@0 x@@14 y@@7 true)) (=> (state Heap@0 Mask@1) (and (and (=> (= (ControlFlow 0 19) 14) anon23_Else_correct) (=> (= (ControlFlow 0 19) 16) anon24_Then_correct)) (=> (= (ControlFlow 0 19) 18) anon24_Else_correct)))))))
(let ((anon11_correct true))
(let ((anon22_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon11_correct)))
(let ((anon22_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@14 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@14 f_7))) (=> (= (ControlFlow 0 10) 9) anon11_correct))))))
(let ((anon19_Else_correct  (=> (and (= vy@0 (fun01 Heap@@15 x@@14 y@@7 false)) (state Heap@@15 Mask@1)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (= FullPerm (U_2_real (MapType1Select Mask@1 y@@7 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 y@@7 f_7))) (=> (and (= Heap@0 (MapType0Store Heap@@15 y@@7 f_7 (int_2_U 0))) (state Heap@0 Mask@1)) (and (and (=> (= (ControlFlow 0 21) 19) anon21_Else_correct) (=> (= (ControlFlow 0 21) 10) anon22_Then_correct)) (=> (= (ControlFlow 0 21) 12) anon22_Else_correct))))))))
(let ((anon7_correct true))
(let ((anon20_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon7_correct)))
(let ((anon20_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@1 y@@7 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 y@@7 f_7))) (=> (= (ControlFlow 0 6) 5) anon7_correct))))))
(let ((anon17_Else_correct  (=> (and (= vx@0 (fun01 Heap@@15 x@@14 y@@7 true)) (state Heap@@15 Mask@1)) (and (and (=> (= (ControlFlow 0 23) 21) anon19_Else_correct) (=> (= (ControlFlow 0 23) 6) anon20_Then_correct)) (=> (= (ControlFlow 0 23) 8) anon20_Else_correct)))))
(let ((anon3_correct true))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@14 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@14 f_7))) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@15 x@@14 $allocated))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@15 y@@7 $allocated)) (not (= x@@14 null))) (and (= Mask@0 (MapType1Store ZeroMask x@@14 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@14 f_7)) FullPerm)))) (state Heap@@15 Mask@0))) (and (and (not (= y@@7 null)) (= Mask@1 (MapType1Store Mask@0 y@@7 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@7 f_7)) FullPerm))))) (and (state Heap@@15 Mask@1) (state Heap@@15 Mask@1)))) (and (and (=> (= (ControlFlow 0 24) 23) anon17_Else_correct) (=> (= (ControlFlow 0 24) 2) anon18_Then_correct)) (=> (= (ControlFlow 0 24) 4) anon18_Else_correct)))))))
