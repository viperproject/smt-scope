...
(assert  (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type x@@31) RefType)) (= (type Mask@0) (MapType2Type RefType realType))))
(set-info :boogie-vc-id |P#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 x@@31 $allocated))) (=> (and (and (not (= x@@31 null)) (= Mask@0 (MapType2Store ZeroMask x@@31 f_7 (real_2_U (+ (U_2_real (MapType2Select ZeroMask x@@31 f_7)) FullPerm))))) (and (state Heap@@11 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@0 x@@31 f_7)))))
