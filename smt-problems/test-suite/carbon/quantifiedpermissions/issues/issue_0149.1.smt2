...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (= (type x2) RefType) (= (type x1@@7) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (forall ((arg0@@52 T@U) ) (! (= (type (invRecv3 arg0@@52)) RefType)
 :qid |funType:invRecv3|
 :pattern ( (invRecv3 arg0@@52))
))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type x@@22) RefType)) (= (type QPMask@2) (MapType1Type RefType realType))) (forall ((arg0@@53 T@U) ) (! (= (type (invRecv1 arg0@@53)) RefType)
...
(let ((anon12_Else_correct  (=> (and (not (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x@@22))) (= (ControlFlow 0 13) 10)) anon6_correct)))
(let ((anon12_Then_correct  (=> (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x@@22)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm QPMask@2 x@@22 g)) (=> (HasDirectPerm QPMask@2 x@@22 g) (=> (= (ControlFlow 0 11) 10) anon6_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_3))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (MapType0Select PostHeap@0 x_3 g) (MapType0Select PostHeap@0 x_3_1 g)))))
 :qid |stdinbpl.910:15|
 :skolemid |124|
 :no-pattern (type x_3)
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 x_1@@1) (= (invRecv1 x_1@@1) x_1@@1))))
 :qid |stdinbpl.864:22|
 :skolemid |119|
...
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.868:22|
 :skolemid |120|
...
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 g)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 g)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 g)) (U_2_real (MapType1Select ZeroMask o_3@@0 g))))))
 :qid |stdinbpl.880:22|
 :skolemid |122|
...
))) (and (state PostHeap@0 QPMask@2) (state PostHeap@0 QPMask@2))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (HasDirectPerm QPMask@2 x1@@7 g)) (=> (HasDirectPerm QPMask@2 x1@@7 g) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm QPMask@2 x2 g)) (=> (HasDirectPerm QPMask@2 x2 g) (=> (and (not (= (MapType0Select PostHeap@0 x1@@7 g) (MapType0Select PostHeap@0 x2 g))) (state PostHeap@0 QPMask@2)) (and (and (=> (= (ControlFlow 0 14) 9) anon11_Else_correct) (=> (= (ControlFlow 0 14) 11) anon12_Then_correct)) (=> (= (ControlFlow 0 14) 13) anon12_Else_correct))))))))))))))
(let ((anon10_Then_correct true))
(let ((anon9_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 18) 7) anon10_Then_correct) (=> (= (ControlFlow 0 18) 14) anon10_Else_correct)))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 6)) (forall ((x_4 T@U) (x_4_1 T@U) ) (!  (=> (and (= (type x_4) RefType) (= (type x_4_1) RefType)) (=> (and (and (and (and (not (= x_4 x_4_1)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_4))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4 x_4_1))))
 :qid |stdinbpl.957:17|
 :skolemid |130|
 :pattern ( (neverTriggered3 x_4) (neverTriggered3 x_4_1))
))) (=> (forall ((x_4@@0 T@U) (x_4_1@@0 T@U) ) (!  (=> (and (= (type x_4@@0) RefType) (= (type x_4_1@@0) RefType)) (=> (and (and (and (and (not (= x_4@@0 x_4_1@@0)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_4@@0))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_4_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4@@0 x_4_1@@0))))
 :qid |stdinbpl.957:17|
 :skolemid |130|
 :pattern ( (neverTriggered3 x_4@@0) (neverTriggered3 x_4_1@@0))
)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall ((x_4@@1 T@U) ) (!  (=> (and (= (type x_4@@1) RefType) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_4@@1))) (>= (U_2_real (MapType1Select Mask@3 x_4@@1 g)) FullPerm))
 :qid |stdinbpl.964:17|
 :skolemid |131|
 :pattern ( (MapType0Select Heap@@9 x_4@@1 g))
 :pattern ( (MapType1Select QPMask@0 x_4@@1 g))
 :pattern ( (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_4@@1))
))) (=> (forall ((x_4@@2 T@U) ) (!  (=> (and (= (type x_4@@2) RefType) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_4@@2))) (>= (U_2_real (MapType1Select Mask@3 x_4@@2 g)) FullPerm))
 :qid |stdinbpl.964:17|
 :skolemid |131|
 :pattern ( (MapType0Select Heap@@9 x_4@@2 g))
 :pattern ( (MapType1Select QPMask@0 x_4@@2 g))
 :pattern ( (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_4@@2))
)) (=> (and (and (forall ((x_4@@3 T@U) ) (!  (=> (= (type x_4@@3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_4@@3)) (< NoPerm FullPerm)) (and (qpRange3 x_4@@3) (= (invRecv3 x_4@@3) x_4@@3))))
 :qid |stdinbpl.970:22|
 :skolemid |132|
...
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) (invRecv3 o_3@@2))) (and (< NoPerm FullPerm) (qpRange3 o_3@@2))) (= (invRecv3 o_3@@2) o_3@@2)))
 :qid |stdinbpl.974:22|
 :skolemid |133|
 :pattern ( (invRecv3 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) (invRecv3 o_3@@3))) (and (< NoPerm FullPerm) (qpRange3 o_3@@3))) (and (= (invRecv3 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 g)) (- (U_2_real (MapType1Select Mask@3 o_3@@3 g)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) (invRecv3 o_3@@3))) (and (< NoPerm FullPerm) (qpRange3 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 g)) (U_2_real (MapType1Select Mask@3 o_3@@3 g))))))
 :qid |stdinbpl.980:22|
 :skolemid |134|
...
)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (not (= (MapType0Select Heap@@9 x1@@7 g) (MapType0Select Heap@@9 x2 g)))) (=> (not (= (MapType0Select Heap@@9 x1@@7 g) (MapType0Select Heap@@9 x2 g))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((x_5 T@U) (x_5_1 T@U) ) (!  (=> (and (= (type x_5) RefType) (= (type x_5_1) RefType)) (=> (and (and (and (and (not (= x_5 x_5_1)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_5))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (MapType0Select Heap@@9 x_5 g) (MapType0Select Heap@@9 x_5_1 g)))))
 :qid |stdinbpl.1000:17|
 :skolemid |136|
 :pattern ( (neverTriggered4 x_5) (neverTriggered4 x_5_1))
))) (=> (forall ((x_5@@0 T@U) (x_5_1@@0 T@U) ) (!  (=> (and (= (type x_5@@0) RefType) (= (type x_5_1@@0) RefType)) (=> (and (and (and (and (not (= x_5@@0 x_5_1@@0)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_5@@0))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_5_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (MapType0Select Heap@@9 x_5@@0 g) (MapType0Select Heap@@9 x_5_1@@0 g)))))
 :qid |stdinbpl.1000:17|
 :skolemid |136|
 :pattern ( (neverTriggered4 x_5@@0) (neverTriggered4 x_5_1@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((x_5@@1 T@U) ) (!  (=> (and (= (type x_5@@1) RefType) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_5@@1))) (>= (U_2_real (MapType1Select QPMask@0 (MapType0Select Heap@@9 x_5@@1 g) f_7)) FullPerm))
 :qid |stdinbpl.1007:17|
 :skolemid |137|
 :pattern ( (MapType0Select Heap@@9 x_5@@1 g))
 :pattern ( (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_5@@1))
))))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x1@@7 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@9 x2 $allocated)) (not (= x1@@7 null))) (and (= Mask@0 (MapType1Store ZeroMask x1@@7 g (real_2_U (+ (U_2_real (MapType1Select ZeroMask x1@@7 g)) FullPerm)))) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 19) (- 0 21)) (HasDirectPerm Mask@0 x1@@7 g)) (=> (HasDirectPerm Mask@0 x1@@7 g) (=> (not (= (MapType0Select Heap@@9 x1@@7 g) null)) (=> (and (= Mask@1 (MapType1Store Mask@0 (MapType0Select Heap@@9 x1@@7 g) f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 (MapType0Select Heap@@9 x1@@7 g) f_7)) FullPerm)))) (state Heap@@9 Mask@1)) (=> (and (and (state Heap@@9 Mask@1) (not (= x2 null))) (and (= Mask@2 (MapType1Store Mask@1 x2 g (real_2_U (+ (U_2_real (MapType1Select Mask@1 x2 g)) FullPerm)))) (state Heap@@9 Mask@2))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (HasDirectPerm Mask@2 x2 g)) (=> (HasDirectPerm Mask@2 x2 g) (=> (and (and (not (= (MapType0Select Heap@@9 x2 g) null)) (= Mask@3 (MapType1Store Mask@2 (MapType0Select Heap@@9 x2 g) f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@2 (MapType0Select Heap@@9 x2 g) f_7)) FullPerm))))) (and (state Heap@@9 Mask@3) (state Heap@@9 Mask@3))) (and (=> (= (ControlFlow 0 19) 18) anon9_Then_correct) (=> (= (ControlFlow 0 19) 2) anon9_Else_correct))))))))))))))
