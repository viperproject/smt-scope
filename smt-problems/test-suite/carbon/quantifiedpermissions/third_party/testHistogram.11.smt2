...
(set-info :boogie-vc-id Ref__loop_body_76)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon4_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 (|Seq#Index| hist k@@3) Ref__Integer_value (real_2_U (- (U_2_real (MapType1Select Mask@0 (|Seq#Index| hist k@@3) Ref__Integer_value)) FullPerm)))) (= (ControlFlow 0 8) (- 0 7))) (= (U_2_int (MapType0Select Heap@0 (|Seq#Index| hist k@@3) Ref__Integer_value)) 0))))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@0 (|Seq#Index| hist k@@3) Ref__Integer_value)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 (|Seq#Index| hist k@@3) Ref__Integer_value))) (=> (= (ControlFlow 0 9) 8) anon4_correct))))))
(let ((anon5_Else_correct  (=> (U_2_bool (MapType0Select Heap@@41 __flatten_4 $allocated)) (and (=> (= (ControlFlow 0 12) (- 0 17)) (>= k@@3 0)) (=> (>= k@@3 0) (and (=> (= (ControlFlow 0 12) (- 0 16)) (< k@@3 (|Seq#Length| hist))) (=> (< k@@3 (|Seq#Length| hist)) (=> (= __flatten_4@0 (|Seq#Index| hist k@@3)) (=> (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0)) (and (=> (= (ControlFlow 0 12) (- 0 15)) (= FullPerm (U_2_real (MapType1Select Mask@0 __flatten_4@0 Ref__Integer_value)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 __flatten_4@0 Ref__Integer_value))) (=> (and (= Heap@0 (MapType0Store Heap@@41 __flatten_4@0 Ref__Integer_value (int_2_U 0))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (<= 0 k@@3)) (=> (<= 0 k@@3) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< k@@3 P)) (=> (< k@@3 P) (and (=> (= (ControlFlow 0 12) 9) anon6_Then_correct) (=> (= (ControlFlow 0 12) 11) anon6_Else_correct))))))))))))))))))
(let ((anon5_Then_correct  (=> (and (and (state PostHeap@0 ZeroMask) (<= 0 k@@3)) (and (< k@@3 P) (state PostHeap@0 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= k@@3 0)) (=> (>= k@@3 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< k@@3 (|Seq#Length| hist))) (=> (< k@@3 (|Seq#Length| hist)) (=> (and (and (not (= (|Seq#Index| hist k@@3) null)) (= PostMask@0 (MapType1Store ZeroMask (|Seq#Index| hist k@@3) Ref__Integer_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask (|Seq#Index| hist k@@3) Ref__Integer_value)) FullPerm))))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k@@3 0)) (=> (>= k@@3 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k@@3 (|Seq#Length| hist))) (=> (< k@@3 (|Seq#Length| hist)) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm PostMask@0 (|Seq#Index| hist k@@3) Ref__Integer_value))))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@41 diz $allocated)) (not (= diz null)))) (=> (and (and (and (state Heap@@41 ZeroMask) (>= current_thread_id 0)) (and (state Heap@@41 ZeroMask) (<= 0 k@@3))) (and (and (< k@@3 P) (state Heap@@41 ZeroMask)) (and (<= P (|Seq#Length| hist)) (state Heap@@41 ZeroMask)))) (and (=> (= (ControlFlow 0 18) (- 0 20)) (>= k@@3 0)) (=> (>= k@@3 0) (and (=> (= (ControlFlow 0 18) (- 0 19)) (< k@@3 (|Seq#Length| hist))) (=> (< k@@3 (|Seq#Length| hist)) (=> (and (and (not (= (|Seq#Index| hist k@@3) null)) (= Mask@0 (MapType1Store ZeroMask (|Seq#Index| hist k@@3) Ref__Integer_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask (|Seq#Index| hist k@@3) Ref__Integer_value)) FullPerm))))) (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0))) (and (=> (= (ControlFlow 0 18) 2) anon5_Then_correct) (=> (= (ControlFlow 0 18) 12) anon5_Else_correct)))))))))))
