...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (= y@0 (+ x@@23 x@@23))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (+ x@@23 x@@23) (* 2 x@@23))) (=> (= (+ x@@23 x@@23) (* 2 x@@23)) (=> (= y_2@0 (+ x@@23 x@@23)) (=> (and (and (state Heap@@19 ZeroMask) (= y_3@0 (+ x@@23 x@@23))) (and (= y_4@0 (+ x@@23 x@@23)) (= (ControlFlow 0 2) (- 0 1)))) (= (* 2 x@@23) (+ x@@23 x@@23))))))))))
