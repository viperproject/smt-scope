...
(assert  (and (and (and (and (and (and (and (and (= (type xs) (SeqType RefType)) (= (type ix) RefType)) (= (type jx) RefType)) (= (type x_2) RefType)) (= (type Heap@@13) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type x_5) RefType)) (forall ((arg0@@41 T@U) ) (! (= (type (invRecv1 arg0@@41)) RefType)
...
(let ((anon29_Then_correct  (=> (|Seq#Contains| xs x_5) (and (=> (= (ControlFlow 0 18) 17) anon30_Then_correct) (=> (= (ControlFlow 0 18) 15) anon17_correct)))))
(let ((anon29_Else_correct  (=> (and (not (|Seq#Contains| xs x_5)) (= (ControlFlow 0 16) 15)) anon17_correct)))
(let ((anon28_Else_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (|Seq#Contains| xs x_3)) (|Seq#Contains| xs x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (e PostHeap@0 x_3) (e PostHeap@0 x_3_1)))))
 :qid |stdinbpl.797:15|
 :skolemid |74|
 :no-pattern (type x_3)
...
(let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((x_4 T@U) (x_4_1 T@U) ) (!  (=> (and (= (type x_4) RefType) (= (type x_4_1) RefType)) (=> (and (and (and (and (not (= x_4 x_4_1)) (|Seq#Contains| xs x_4)) (|Seq#Contains| xs x_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (e Heap@@13 x_4) (e Heap@@13 x_4_1)))))
 :qid |stdinbpl.844:17|
 :skolemid |80|
 :pattern ( (neverTriggered3 x_4) (neverTriggered3 x_4_1))
))) (=> (forall ((x_4@@0 T@U) (x_4_1@@0 T@U) ) (!  (=> (and (= (type x_4@@0) RefType) (= (type x_4_1@@0) RefType)) (=> (and (and (and (and (not (= x_4@@0 x_4_1@@0)) (|Seq#Contains| xs x_4@@0)) (|Seq#Contains| xs x_4_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (e Heap@@13 x_4@@0) (e Heap@@13 x_4_1@@0)))))
 :qid |stdinbpl.844:17|
 :skolemid |80|
 :pattern ( (neverTriggered3 x_4@@0) (neverTriggered3 x_4_1@@0))
)) (=> (= (ControlFlow 0 11) (- 0 10)) (forall ((x_4@@1 T@U) ) (!  (=> (and (= (type x_4@@1) RefType) (|Seq#Contains| xs x_4@@1)) (>= (U_2_real (MapType1Select QPMask@0 (e Heap@@13 x_4@@1) f_7)) FullPerm))
 :qid |stdinbpl.851:17|
 :skolemid |81|
...
(let ((anon24_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| xs x_1)) (|Seq#Contains| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (e Heap@@13 x_1) (e Heap@@13 x_1_1)))))
 :qid |stdinbpl.739:15|
 :skolemid |68|
 :no-pattern (type x_1)
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (|Seq#Contains| xs x_1@@0)) (|Seq#Contains| xs x_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (e Heap@@13 x_1@@0) (e Heap@@13 x_1_1@@0)))))
 :qid |stdinbpl.739:15|
 :skolemid |68|
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| xs x_1@@1) (< NoPerm FullPerm)) (and (qpRange1 (e Heap@@13 x_1@@1)) (= (invRecv1 (e Heap@@13 x_1@@1)) x_1@@1))))
 :qid |stdinbpl.745:22|
 :skolemid |69|
 ...
 :pattern ( (|e#frame| EmptyFrame x_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| xs (invRecv1 o_3)) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (e Heap@@13 (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.749:22|
 :skolemid |70|
 :pattern ( (invRecv1 o_3))
)) (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (|Seq#Contains| xs x_1@@2)) (not (= (e Heap@@13 x_1@@2) null)))
 :qid |stdinbpl.755:22|
 :skolemid |71|
 ...
 :pattern ( (|e#frame| EmptyFrame x_1@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| xs (invRecv1 o_3@@0)) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (e Heap@@13 (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| xs (invRecv1 o_3@@0)) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.761:22|
 :skolemid |72|
...
(let ((anon25_Then_correct  (=> (|Seq#Contains| xs x_2) (and (=> (= (ControlFlow 0 9) 8) anon26_Then_correct) (=> (= (ControlFlow 0 9) 6) anon11_correct)))))
(let ((anon25_Else_correct  (=> (and (not (|Seq#Contains| xs x_2)) (= (ControlFlow 0 7) 6)) anon11_correct)))
...
(let ((anon21_Then_correct  (=> (and (|Seq#Contains| xs ix) (and (|Seq#Contains| xs jx) (not (= ix jx)))) (and (and (=> (= (ControlFlow 0 5) 3) anon22_Then_correct) (=> (= (ControlFlow 0 5) 4) anon23_Then_correct)) (=> (= (ControlFlow 0 5) 1) anon6_correct)))))
(let ((anon21_Else_correct  (=> (and (not (and (|Seq#Contains| xs ix) (and (|Seq#Contains| xs jx) (not (= ix jx))))) (= (ControlFlow 0 2) 1)) anon6_correct)))
