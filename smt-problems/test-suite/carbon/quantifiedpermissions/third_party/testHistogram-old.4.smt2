...
(assert (not
 ...
 :qid |stdinbpl.1149:23|
 :skolemid |97|
 :pattern ( (|Seq#Index| ar@@27 k_5@@6))
 :pattern ( (|Seq#Index| ar@@27 k_5@@6))
)))))))))))))))))))))))))))
(let ((anon16_correct true))
(let ((anon25_Else_correct  (=> (and (|sum_square#trigger| (FrameFragment (int_2_U (|sum_square#condqp2| Heap@@33 (+ i@@34 1) lo@@14 hi@@27 step@@9 vmin@@9 vmax@@9 ar@@27))) (+ i@@34 1) lo@@14 hi@@27 step@@9 vmin@@9 vmax@@9 ar@@27) (= (ControlFlow 0 28) 14)) anon16_correct)))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.1076:29|
 :skolemid |92|
 :pattern ( (MapType1Select ZeroMask o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
))) (and (state Heap@@33 QPMask@0) (state Heap@@33 QPMask@0))) (and (=> (= (ControlFlow 0 39) 37) anon22_Then_correct) (=> (= (ControlFlow 0 39) 15) anon22_Else_correct)))))))))
...
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (= AssumeFunctionsAbove 4) (<= 0 lo@@14)) (=> (and (and (and (<= lo@@14 hi@@27) (<= hi@@27 step@@9)) (and (> step@@9 0) (state Heap@@33 ZeroMask))) (and (and (<= 0 vmin@@9) (<= vmin@@9 i@@34)) (and (<= i@@34 vmax@@9) (state Heap@@33 ZeroMask)))) (and (and (=> (= (ControlFlow 0 41) 39) anon17_Else_correct) (=> (= (ControlFlow 0 41) 13) anon18_Then_correct)) (=> (= (ControlFlow 0 41) 6) anon18_Else_correct)))))))
