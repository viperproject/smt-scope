...
(assert  (and (and (= (Ctor FrameTypeType) 13) (= (type EmptyFrame) FrameTypeType)) (forall ((arg0@@26 Int) (arg1@@10 Int) ) (! (= (type (|Seq#Range| arg0@@26 arg1@@10)) (SeqType intType))
 :qid |funType:Seq#Range|
 :pattern ( (|Seq#Range| arg0@@26 arg1@@10))
))))
(assert (forall ((Heap@@1 T@U) (Mask@@0 T@U) (a_3@@0 T@U) (x@@9 Int) (y@@2 Int) ) (!  (=> (and (and (and (= (type Heap@@1) (MapType0Type RefType)) (= (type Mask@@0) (MapType1Type RefType realType))) (= (type a_3@@0) IArrayDomainTypeType)) (and (state Heap@@1 Mask@@0) (or (< AssumeFunctionsAbove 0) (|f_lcp#trigger| EmptyFrame a_3@@0 x@@9 y@@2)))) (forall ((k T@U) (fresh__1 Int) ) (!  (=> (and (= (type k) intType) (|Seq#Contains| (|Seq#Range| x@@9 (+ x@@9 1)) k)) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@0)) (int_2_U y@@2)))
 :qid |stdinbpl.584:103|
 :skolemid |61|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| x@@9 fresh__1) k))
 :pattern ( (|Seq#Contains| (|Seq#Range| x@@9 fresh__1) k))
)))
 :qid |stdinbpl.582:15|
 :skolemid |62|
 :pattern ( (state Heap@@1 Mask@@0) (|f_lcp'| Heap@@1 a_3@@0 x@@9 y@@2))
)))
...
(assert (forall ((Heap@@7 T@U) (Mask@@6 T@U) (a_3@@1 T@U) (x@@12 Int) (y@@4 Int) ) (!  (=> (and (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (= (type a_3@@1) IArrayDomainTypeType)) (state Heap@@7 Mask@@6)) (= (|f_lcp'| Heap@@7 a_3@@1 x@@12 y@@4) (|f_lcp#frame| EmptyFrame a_3@@1 x@@12 y@@4)))
 :qid |stdinbpl.576:15|
 :skolemid |60|
 :pattern ( (state Heap@@7 Mask@@6) (|f_lcp'| Heap@@7 a_3@@1 x@@12 y@@4))
)))
...
(assert (forall ((Heap@@8 T@U) (a_3@@2 T@U) (x@@13 Int) (y@@5 Int) ) (!  (=> (and (= (type Heap@@8) (MapType0Type RefType)) (= (type a_3@@2) IArrayDomainTypeType)) (and (= (f_lcp Heap@@8 a_3@@2 x@@13 y@@5) (|f_lcp'| Heap@@8 a_3@@2 x@@13 y@@5)) (dummyFunction (int_2_U (|f_lcp#triggerStateless| a_3@@2 x@@13 y@@5)))))
 :qid |stdinbpl.565:15|
 :skolemid |58|
 :pattern ( (f_lcp Heap@@8 a_3@@2 x@@13 y@@5))
)))
