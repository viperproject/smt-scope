...
(let ((anon27_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@12 (|Seq#Index| cr i_26) Integer_value)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@12 (|Seq#Index| cr i_26) Integer_value))) (=> (= (ControlFlow 0 10) 9) anon18_correct))))))
(let ((anon16_correct  (=> (= Mask@12 (MapType1Store Mask@11 (|Seq#Index| br i_26) Integer_value (real_2_U (- (U_2_real (MapType1Select Mask@11 (|Seq#Index| br i_26) Integer_value)) perm@7)))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (= (|Seq#Length| cr) len)) (=> (= (|Seq#Length| cr) len) (and (=> (= (ControlFlow 0 13) 10) anon27_Then_correct) (=> (= (ControlFlow 0 13) 12) anon27_Else_correct)))))))
(let ((anon26_Else_correct  (=> (and (= perm@7 NoPerm) (= (ControlFlow 0 17) 13)) anon16_correct)))
(let ((anon26_Then_correct  (=> (not (= perm@7 NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= perm@7 (U_2_real (MapType1Select Mask@11 (|Seq#Index| br i_26) Integer_value)))) (=> (<= perm@7 (U_2_real (MapType1Select Mask@11 (|Seq#Index| br i_26) Integer_value))) (=> (= (ControlFlow 0 15) 13) anon16_correct))))))
(let ((anon14_correct  (=> (= Mask@11 (MapType1Store Mask@10 (|Seq#Index| ar i_26) Integer_value (real_2_U (- (U_2_real (MapType1Select Mask@10 (|Seq#Index| ar i_26) Integer_value)) FullPerm)))) (and (=> (= (ControlFlow 0 18) (- 0 20)) (= (|Seq#Length| br) len)) (=> (= (|Seq#Length| br) len) (=> (= perm@7 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (>= perm@7 NoPerm)) (=> (>= perm@7 NoPerm) (and (=> (= (ControlFlow 0 18) 15) anon26_Then_correct) (=> (= (ControlFlow 0 18) 17) anon26_Else_correct))))))))))
(let ((anon25_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 23) 18)) anon14_correct)))
(let ((anon25_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (<= FullPerm (U_2_real (MapType1Select Mask@10 (|Seq#Index| ar i_26) Integer_value)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@10 (|Seq#Index| ar i_26) Integer_value))) (=> (= (ControlFlow 0 21) 18) anon14_correct))))))
(let ((anon12_correct  (=> (state Heap@2 Mask@10) (and (=> (= (ControlFlow 0 24) (- 0 27)) (<= 0 i_26)) (=> (<= 0 i_26) (and (=> (= (ControlFlow 0 24) (- 0 26)) (< i_26 len)) (=> (< i_26 len) (and (=> (= (ControlFlow 0 24) (- 0 25)) (= (|Seq#Length| ar) len)) (=> (= (|Seq#Length| ar) len) (and (=> (= (ControlFlow 0 24) 21) anon25_Then_correct) (=> (= (ControlFlow 0 24) 23) anon25_Else_correct)))))))))))
(let ((anon11_correct  (=> (= Mask@9 (MapType1Store Mask@8 (|Seq#Index| ar (+ i_26 1)) Integer_value (real_2_U (- (U_2_real (MapType1Select Mask@8 (|Seq#Index| ar (+ i_26 1)) Integer_value)) perm@6)))) (=> (and (IdenticalOnKnownLocations Heap@1 ExhaleHeap@0 Mask@9) (state ExhaleHeap@0 Mask@9)) (=> (and (and (state ExhaleHeap@0 Mask@9) (= Heap@2 ExhaleHeap@0)) (and (= Mask@10 Mask@9) (= (ControlFlow 0 29) 24))) anon12_correct)))))
(let ((anon24_Else_correct  (=> (and (= perm@6 NoPerm) (= (ControlFlow 0 32) 29)) anon11_correct)))
(let ((anon24_Then_correct  (=> (not (= perm@6 NoPerm)) (and (=> (= (ControlFlow 0 30) (- 0 31)) (<= perm@6 (U_2_real (MapType1Select Mask@8 (|Seq#Index| ar (+ i_26 1)) Integer_value)))) (=> (<= perm@6 (U_2_real (MapType1Select Mask@8 (|Seq#Index| ar (+ i_26 1)) Integer_value))) (=> (= (ControlFlow 0 30) 29) anon11_correct))))))
(let ((anon23_Then_correct  (=> (< i_26 (- len 1)) (and (=> (= (ControlFlow 0 33) (- 0 42)) (>= i_26 0)) (=> (>= i_26 0) (and (=> (= (ControlFlow 0 33) (- 0 41)) (< i_26 (|Seq#Length| cr))) (=> (< i_26 (|Seq#Length| cr)) (and (=> (= (ControlFlow 0 33) (- 0 40)) (>= (+ i_26 1) 0)) (=> (>= (+ i_26 1) 0) (and (=> (= (ControlFlow 0 33) (- 0 39)) (< (+ i_26 1) (|Seq#Length| ar))) (=> (< (+ i_26 1) (|Seq#Length| ar)) (and (=> (= (ControlFlow 0 33) (- 0 38)) (HasDirectPerm Mask@8 (|Seq#Index| ar (+ i_26 1)) Integer_value)) (=> (HasDirectPerm Mask@8 (|Seq#Index| ar (+ i_26 1)) Integer_value) (and (=> (= (ControlFlow 0 33) (- 0 37)) (= FullPerm (U_2_real (MapType1Select Mask@8 (|Seq#Index| cr i_26) Integer_value)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@8 (|Seq#Index| cr i_26) Integer_value))) (=> (and (= Heap@1 (MapType0Store Heap@0 (|Seq#Index| cr i_26) Integer_value (int_2_U (+ (U_2_int (MapType0Select Heap@0 (|Seq#Index| ar (+ i_26 1)) Integer_value)) 2)))) (state Heap@1 Mask@8)) (and (=> (= (ControlFlow 0 33) (- 0 36)) (<= (- 0 1) i_26)) (=> (<= (- 0 1) i_26) (and (=> (= (ControlFlow 0 33) (- 0 35)) (< (+ i_26 1) (|Seq#Length| ar))) (=> (< (+ i_26 1) (|Seq#Length| ar)) (=> (= perm@6 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 33) (- 0 34)) (>= perm@6 NoPerm)) (=> (>= perm@6 NoPerm) (and (=> (= (ControlFlow 0 33) 30) anon24_Then_correct) (=> (= (ControlFlow 0 33) 32) anon24_Else_correct)))))))))))))))))))))))))
(let ((anon23_Else_correct  (=> (and (and (<= (- len 1) i_26) (= Heap@2 Heap@0)) (and (= Mask@10 Mask@8) (= (ControlFlow 0 28) 24))) anon12_correct)))
(let ((anon8_correct  (=> (state Heap@@9 Mask@8) (and (=> (= (ControlFlow 0 43) (- 0 49)) (>= i_26 0)) (=> (>= i_26 0) (and (=> (= (ControlFlow 0 43) (- 0 48)) (< i_26 (|Seq#Length| ar))) (=> (< i_26 (|Seq#Length| ar)) (and (=> (= (ControlFlow 0 43) (- 0 47)) (>= i_26 0)) (=> (>= i_26 0) (and (=> (= (ControlFlow 0 43) (- 0 46)) (< i_26 (|Seq#Length| br))) (=> (< i_26 (|Seq#Length| br)) (and (=> (= (ControlFlow 0 43) (- 0 45)) (HasDirectPerm Mask@8 (|Seq#Index| br i_26) Integer_value)) (=> (HasDirectPerm Mask@8 (|Seq#Index| br i_26) Integer_value) (and (=> (= (ControlFlow 0 43) (- 0 44)) (= FullPerm (U_2_real (MapType1Select Mask@8 (|Seq#Index| ar i_26) Integer_value)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@8 (|Seq#Index| ar i_26) Integer_value))) (=> (and (= Heap@0 (MapType0Store Heap@@9 (|Seq#Index| ar i_26) Integer_value (int_2_U (+ (U_2_int (MapType0Select Heap@@9 (|Seq#Index| br i_26) Integer_value)) 1)))) (state Heap@0 Mask@8)) (and (=> (= (ControlFlow 0 43) 33) anon23_Then_correct) (=> (= (ControlFlow 0 43) 28) anon23_Else_correct))))))))))))))))))
(let ((anon22_Else_correct  (=> (>= 0 i_26) (=> (and (= Mask@8 Mask@6) (= (ControlFlow 0 54) 43)) anon8_correct))))
(let ((anon22_Then_correct  (=> (> i_26 0) (and (=> (= (ControlFlow 0 50) (- 0 53)) (<= 0 i_26)) (=> (<= 0 i_26) (and (=> (= (ControlFlow 0 50) (- 0 52)) (< i_26 (|Seq#Length| ar))) (=> (< i_26 (|Seq#Length| ar)) (=> (= perm@5 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 50) (- 0 51)) (>= perm@5 NoPerm)) (=> (>= perm@5 NoPerm) (=> (=> (> perm@5 NoPerm) (not (= (|Seq#Index| ar i_26) null))) (=> (and (= Mask@7 (MapType1Store Mask@6 (|Seq#Index| ar i_26) Integer_value (real_2_U (+ (U_2_real (MapType1Select Mask@6 (|Seq#Index| ar i_26) Integer_value)) perm@5)))) (state Heap@@9 Mask@7)) (=> (and (and (state Heap@@9 Mask@7) (state Heap@@9 Mask@7)) (and (= Mask@8 Mask@7) (= (ControlFlow 0 50) 43))) anon8_correct)))))))))))))
(let ((anon21_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (<= 0 i_26)) (=> (and (and (< i_26 len) (state PostHeap@0 ZeroMask)) (and (= (|Seq#Length| ar) len) (state PostHeap@0 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (>= i_26 0)) (=> (>= i_26 0) (and (=> (= (ControlFlow 0 2) (- 0 7)) (< i_26 (|Seq#Length| ar))) (=> (< i_26 (|Seq#Length| ar)) (=> (and (not (= (|Seq#Index| ar i_26) null)) (= PostMask@0 (MapType1Store ZeroMask (|Seq#Index| ar i_26) Integer_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask (|Seq#Index| ar i_26) Integer_value)) FullPerm))))) (=> (and (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)) (and (= (|Seq#Length| br) len) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_26 0)) (=> (>= i_26 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_26 (|Seq#Length| br))) (=> (< i_26 (|Seq#Length| br)) (=> (= perm@4 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= perm@4 NoPerm)) (=> (>= perm@4 NoPerm) (=> (and (=> (> perm@4 NoPerm) (not (= (|Seq#Index| br i_26) null))) (= PostMask@1 (MapType1Store PostMask@0 (|Seq#Index| br i_26) Integer_value (real_2_U (+ (U_2_real (MapType1Select PostMask@0 (|Seq#Index| br i_26) Integer_value)) perm@4))))) (=> (and (and (state PostHeap@0 PostMask@1) (state PostHeap@0 PostMask@1)) (and (= (|Seq#Length| cr) len) (state PostHeap@0 PostMask@1))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= i_26 0)) (=> (>= i_26 0) (=> (= (ControlFlow 0 2) (- 0 1)) (< i_26 (|Seq#Length| cr))))))))))))))))))))))))
(let ((anon4_correct  (=> (state Heap@@9 Mask@4) (=> (and (= (|Seq#Length| br) len) (state Heap@@9 Mask@4)) (and (=> (= (ControlFlow 0 55) (- 0 60)) (>= i_26 0)) (=> (>= i_26 0) (and (=> (= (ControlFlow 0 55) (- 0 59)) (< i_26 (|Seq#Length| br))) (=> (< i_26 (|Seq#Length| br)) (=> (= perm@3 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 55) (- 0 58)) (>= perm@3 NoPerm)) (=> (>= perm@3 NoPerm) (=> (and (=> (> perm@3 NoPerm) (not (= (|Seq#Index| br i_26) null))) (= Mask@5 (MapType1Store Mask@4 (|Seq#Index| br i_26) Integer_value (real_2_U (+ (U_2_real (MapType1Select Mask@4 (|Seq#Index| br i_26) Integer_value)) perm@3))))) (=> (and (and (state Heap@@9 Mask@5) (state Heap@@9 Mask@5)) (and (= (|Seq#Length| cr) len) (state Heap@@9 Mask@5))) (and (=> (= (ControlFlow 0 55) (- 0 57)) (>= i_26 0)) (=> (>= i_26 0) (and (=> (= (ControlFlow 0 55) (- 0 56)) (< i_26 (|Seq#Length| cr))) (=> (< i_26 (|Seq#Length| cr)) (=> (and (and (not (= (|Seq#Index| cr i_26) null)) (= Mask@6 (MapType1Store Mask@5 (|Seq#Index| cr i_26) Integer_value (real_2_U (+ (U_2_real (MapType1Select Mask@5 (|Seq#Index| cr i_26) Integer_value)) FullPerm))))) (and (state Heap@@9 Mask@6) (state Heap@@9 Mask@6))) (and (and (=> (= (ControlFlow 0 55) 2) anon21_Then_correct) (=> (= (ControlFlow 0 55) 50) anon22_Then_correct)) (=> (= (ControlFlow 0 55) 54) anon22_Else_correct))))))))))))))))))))
(let ((anon20_Else_correct  (=> (<= (- (|Seq#Length| ar) 1) i_26) (=> (and (= Mask@4 Mask@2) (= (ControlFlow 0 65) 55)) anon4_correct))))
(let ((anon20_Then_correct  (=> (< i_26 (- (|Seq#Length| ar) 1)) (and (=> (= (ControlFlow 0 61) (- 0 64)) (>= (+ i_26 1) 0)) (=> (>= (+ i_26 1) 0) (and (=> (= (ControlFlow 0 61) (- 0 63)) (< (+ i_26 1) (|Seq#Length| ar))) (=> (< (+ i_26 1) (|Seq#Length| ar)) (=> (= perm@2 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 61) (- 0 62)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (=> (> perm@2 NoPerm) (not (= (|Seq#Index| ar (+ i_26 1)) null))) (=> (and (and (= Mask@3 (MapType1Store Mask@2 (|Seq#Index| ar (+ i_26 1)) Integer_value (real_2_U (+ (U_2_real (MapType1Select Mask@2 (|Seq#Index| ar (+ i_26 1)) Integer_value)) perm@2)))) (state Heap@@9 Mask@3)) (and (= Mask@4 Mask@3) (= (ControlFlow 0 61) 55))) anon4_correct))))))))))))
(let ((anon2_correct  (=> (state Heap@@9 Mask@2) (and (=> (= (ControlFlow 0 66) 61) anon20_Then_correct) (=> (= (ControlFlow 0 66) 65) anon20_Else_correct)))))
(let ((anon19_Else_correct  (=> (not (= i_26 0)) (=> (and (= Mask@2 Mask@0) (= (ControlFlow 0 71) 66)) anon2_correct))))
(let ((anon19_Then_correct  (=> (= i_26 0) (and (=> (= (ControlFlow 0 67) (- 0 70)) (>= i_26 0)) (=> (>= i_26 0) (and (=> (= (ControlFlow 0 67) (- 0 69)) (< i_26 (|Seq#Length| ar))) (=> (< i_26 (|Seq#Length| ar)) (=> (= perm@1 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 67) (- 0 68)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (=> (> perm@1 NoPerm) (not (= (|Seq#Index| ar i_26) null))) (=> (and (and (= Mask@1 (MapType1Store Mask@0 (|Seq#Index| ar i_26) Integer_value (real_2_U (+ (U_2_real (MapType1Select Mask@0 (|Seq#Index| ar i_26) Integer_value)) perm@1)))) (state Heap@@9 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 67) 66))) anon2_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 this $allocated)) (<= 0 i_26)) (=> (and (and (< i_26 len) (state Heap@@9 ZeroMask)) (and (= (|Seq#Length| ar) len) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 72) (- 0 75)) (>= i_26 0)) (=> (>= i_26 0) (and (=> (= (ControlFlow 0 72) (- 0 74)) (< i_26 (|Seq#Length| ar))) (=> (< i_26 (|Seq#Length| ar)) (=> (= perm@0 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 72) (- 0 73)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= (|Seq#Index| ar i_26) null))) (= Mask@0 (MapType1Store ZeroMask (|Seq#Index| ar i_26) Integer_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask (|Seq#Index| ar i_26) Integer_value)) perm@0))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 72) 67) anon19_Then_correct) (=> (= (ControlFlow 0 72) 71) anon19_Else_correct)))))))))))))))
