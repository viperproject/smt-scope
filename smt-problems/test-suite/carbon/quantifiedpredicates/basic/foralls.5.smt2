...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 1 (+ (|Seq#Length| xs) 1)) (int_2_U i_4))) (= (ControlFlow 0 14) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 1 (+ (|Seq#Length| xs) 1)) (int_2_U i_4)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= (- i_4 1) 0)) (=> (>= (- i_4 1) 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< (- i_4 1) (|Seq#Length| xs))) (=> (< (- i_4 1) (|Seq#Length| xs)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 1 (+ (|Seq#Length| xs) 1)) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 1 (+ (|Seq#Length| xs) 1)) (int_2_U i_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs (- i_1 1)) (|Seq#Index| xs (- i_1_1 1)))))
...
(let ((anon10_Else_correct  (=> (and (not (and (>= ix_4 0) (and (< ix_4 (|Seq#Length| xs)) (and (>= jx_4 0) (and (< jx_4 (|Seq#Length| xs)) (not (= ix_4 jx_4))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (>= ix_4 0) (and (< ix_4 (|Seq#Length| xs)) (and (>= jx_4 0) (and (< jx_4 (|Seq#Length| xs)) (not (= ix_4 jx_4)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= ix_4 0)) (=> (>= ix_4 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< ix_4 (|Seq#Length| xs))) (=> (< ix_4 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= jx_4 0)) (=> (>= jx_4 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< jx_4 (|Seq#Length| xs))) (=> (< jx_4 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (and (and (=> (= (ControlFlow 0 16) 15) anon9_Else_correct) (=> (= (ControlFlow 0 16) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 16) 7) anon10_Else_correct)))))
