...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x@@14 $allocated))) (=> (and (and (not (= x@@14 null)) (= Mask@0 (MapType1Store ZeroMask x@@14 p_2 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@14 p_2)) FullPerm))))) (and (state Heap@@10 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@0 x@@14 p_2)))))
