(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:08:32
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/third_party/stefan_recent/testThreadInheritanceReal.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(declare-const args@264@01 Seq<$Ref>)
(declare-const sys__thrown@265@01 $Ref)
(declare-const current_thread_id@266@01 Int)
(declare-const args@267@01 Seq<$Ref>)
...
; [eval] current_thread_id >= 0
(assert (>= current_thread_id@266@01 0))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
; [exec]
; var w: Ref
(declare-const w@270@01 $Ref)
; [exec]
; var __flatten_5: Ref
(declare-const __flatten_5@271@01 $Ref)
; [exec]
; sys__thrown, __flatten_5 := Worker__Worker(current_thread_id, 7)
; [eval] current_thread_id >= 0
(declare-const sys__thrown@272@01 $Ref)
(declare-const sys__result@273@01 $Ref)
...
; [eval] sys__result != null
(assert (not (= sys__result@273@01 $Ref.null)))
(assert (=
...
; [eval] type_of(sys__result)
; [eval] class_Worker()
(assert (= (type_of<TYPE> sys__result@273@01) (as class_Worker<TYPE>  TYPE)))
(assert (=
  ($Snap.second ($Snap.second $t@274@01))
  ($Snap.combine
...
(assert (<= $Perm.No $k@275@01))
(assert (<= $k@275@01 $Perm.Write))
(assert (=> (< $Perm.No $k@275@01) (not (= sys__result@273@01 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@274@01))))
  ($Snap.combine
...
; (get-info :all-statistics)
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@274@01)))))
  7))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
...
; [eval] diz != null
; [eval] current_thread_id >= 0
(declare-const sys__thrown@280@01 $Ref)
...
; [eval] p >= none
(assert (=
  ($Snap.second $t@281@01)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@281@01))
    ($Snap.second ($Snap.second $t@281@01)))))
(assert (=
  ($Snap.second ($Snap.second $t@281@01))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@281@01)))
    ($Snap.second ($Snap.second ($Snap.second $t@281@01))))))
...
(assert (and
  ...
  (=>
    ...
    (=
      $t@283@01
      ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second $t@281@01))))))))
(assert (<= $Perm.No (+ $k@275@01 $k@282@01)))
(assert (<= (+ $k@275@01 $k@282@01) $Perm.Write))
(assert (=> (< $Perm.No (+ $k@275@01 $k@282@01)) (not (= sys__result@273@01 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@281@01)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@281@01))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@281@01)))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@281@01))))
  $Snap.unit))
; [eval] p != none
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@281@01))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@281@01)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@281@01))))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@281@01)))))
  $Snap.unit))
; [eval] diz.Worker__output == diz.Worker__input + 1
...
(push) ; 3
(set-option :timeout 10)
(assert (not (< $Perm.No (+ $k@275@01 $k@282@01))))
(check-sat)
; unsat
(pop) ; 3
; 0,00s
; (get-info :all-statistics)
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@281@01))))))
  (+ $t@283@01 1)))
; State saturation: after unfold
(set-option :timeout 40)
(check-sat)
; unknown
(assert (Worker__postJoin_at_Worker%trigger $t@281@01 sys__result@273@01 $Perm.Write))
; [exec]
...
(pop) ; 1
; ---------- Main__Main ----------
(declare-const current_thread_id@284@01 Int)
(declare-const sys__thrown@285@01 $Ref)
(declare-const sys__result@286@01 $Ref)
(declare-const current_thread_id@287@01 Int)
(declare-const sys__thrown@288@01 $Ref)
(declare-const sys__result@289@01 $Ref)
(push) ; 1
(declare-const $t@290@01 $Snap)
(assert (= $t@290@01 $Snap.unit))
; [eval] current_thread_id >= 0
(assert (>= current_thread_id@287@01 0))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
; [eval] sys__result != null
(assert (not (= sys__result@289@01 $Ref.null)))
(assert (= ($Snap.second $t@291@01) $Snap.unit))
; [eval] type_of(sys__result) == class_Main()
; [eval] type_of(sys__result)
; [eval] class_Main()
(assert (= (type_of<TYPE> sys__result@289@01) (as class_Main<TYPE>  TYPE)))
(pop) ; 2
(push) ; 2
; [exec]
; var diz: Ref
(declare-const diz@292@01 $Ref)
; [exec]
; diz := new()
(declare-const diz@293@01 $Ref)
(assert (not (= diz@293@01 $Ref.null)))
(assert (not (= diz@293@01 diz@292@01)))
(assert (not (= diz@293@01 sys__result@289@01)))
(assert (not (= diz@293@01 sys__thrown@288@01)))
; [exec]
...
; [eval] type_of(diz)
; [eval] class_Main()
(assert (= (type_of<TYPE> diz@293@01) (as class_Main<TYPE>  TYPE)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
