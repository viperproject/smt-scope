...
(declare-fun test05 () T@U)
(declare-fun PredicateType_test05Type () T@T)
...
(declare-fun |test05#trigger| (T@U T@U) Bool)
(declare-fun |test05#everUsed| (T@U) Bool)
(declare-fun |test05#sm| () T@U)
...
(assert (forall ((i_1 Int) ) (! (foo i_1 i_1)
 :qid |stdinbpl.186:15|
 :skolemid |22|
 :pattern ( (foo i_1 i_1))
)))
...
(assert  (and (= (Ctor PredicateType_test05Type) 11) (= (type test05) (FieldType PredicateType_test05Type FrameTypeType))))
(assert (IsPredicateField test05))
(assert (= (getPredWandId test05) 0))
(assert (forall ((i_1@@0 Int) ) (! (forall ((i$0 Int) ) (! (boo i_1@@0 i$0)
 :qid |stdinbpl.204:11|
 :skolemid |23|
 :pattern ( (boo i_1@@0 i$0))
))
 :qid |stdinbpl.202:15|
 :skolemid |24|
)))
...
(assert (forall ((i_1_1 Int) ) (! (forall ((i$2 Int) ) (! (boo i_1_1 i$2)
 :qid |stdinbpl.213:11|
 :skolemid |26|
 :pattern ( (boo i_1_1 i$2))
))
 :qid |stdinbpl.211:14|
 :skolemid |27|
)))
...
(assert (forall ((Heap@@7 T@U) ) (!  (=> (= (type Heap@@7) (MapType0Type RefType)) (|test05#everUsed| test05))
 :qid |stdinbpl.232:15|
 :skolemid |28|
 :pattern ( (|test05#trigger| Heap@@7 test05))
)))
...
(assert (= (type |test05#sm|) (FieldType PredicateType_test05Type (MapType1Type RefType boolType))))
(assert (= (PredicateMaskField test05) |test05#sm|))
...
(declare-fun j_1 () Int)
(assert (= (type Heap@@10) (MapType0Type RefType)))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon12_Else_correct true))
(let ((anon12_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (foo i_1@@1 i$0_1))))
(let ((anon11_Then_correct true))
(let ((anon10_Else_correct  (=> (and (forall ((j_2_1 Int) ) (! (foo j_2_1 j_2_1)
 :qid |stdinbpl.379:20|
 :skolemid |34|
 :pattern ( (foo j_2_1 j_2_1))
)) (state Heap@@10 ZeroMask)) (and (and (=> (= (ControlFlow 0 8) 4) anon11_Then_correct) (=> (= (ControlFlow 0 8) 6) anon12_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon12_Else_correct)))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (foo j_1 j_1))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (and (=> (= (ControlFlow 0 9) (- 0 10)) (foo i_1@@1 i_1@@1)) (=> (foo i_1@@1 i_1@@1) (=> (state Heap@@10 ZeroMask) (and (and (=> (= (ControlFlow 0 9) 1) anon9_Then_correct) (=> (= (ControlFlow 0 9) 3) anon10_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon10_Else_correct))))))))
