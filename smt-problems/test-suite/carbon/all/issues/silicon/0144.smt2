...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= x@@8 0))) (=> (not (= x@@8 0)) (=> (= r_1@0 (div 1 x@@8)) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 4) (- 0 3))) (= r_1@0 (div 1 x@@8))))))))
(let ((anon3_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (not (= x@@8 0)))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 4) anon3_Else_correct)))))
