...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (= (type x2) RefType) (= (type x1@@7) RefType)) (= (type r_4) RefType)) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type UnfoldingMask@3) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (forall ((arg0@@45 T@U) ) (! (= (type (FrameFragment arg0@@45)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@45))
))) (= (type r_1) RefType)) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id m3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon11_correct true))
(let ((anon10_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@1 null (p2 r_1) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (p2 r_1))) FullPerm)))) (not (= r_1 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 r_1 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 r_1 f_7)) FullPerm)))) (state Heap@@10 UnfoldingMask@1)) (and (= (U_2_int (MapType0Select Heap@@10 r_1 f_7)) 5) (state Heap@@10 UnfoldingMask@1))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (= (U_2_int (MapType0Select Heap@@10 r_1 f_7)) 5)) (=> (= (U_2_int (MapType0Select Heap@@10 r_1 f_7)) 5) (=> (= (ControlFlow 0 12) 10) anon11_correct)))))))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 12)) anon10_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (p2 r_1))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (p2 r_1)))) (=> (= (ControlFlow 0 14) 12) anon10_correct))))))
(let ((anon17_Then_correct  (=> (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) r_1)) (=> (and (|p2#trigger| Heap@@10 (p2 r_1)) (= (MapType0Select Heap@@10 null (p2 r_1)) (FrameFragment (MapType0Select Heap@@10 r_1 f_7)))) (and (=> (= (ControlFlow 0 17) 14) anon18_Then_correct) (=> (= (ControlFlow 0 17) 16) anon18_Else_correct))))))
(let ((anon17_Else_correct  (=> (and (not (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) r_1))) (= (ControlFlow 0 11) 10)) anon11_correct)))
(let ((anon5_correct true))
(let ((anon4_correct  (=> (and (= UnfoldingMask@2 (MapType1Store Mask@1 null (p2 r_4) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (p2 r_4))) FullPerm)))) (not (= r_4 null))) (=> (and (and (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 r_4 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 r_4 f_7)) FullPerm)))) (state Heap@@10 UnfoldingMask@3)) (and (= (U_2_int (MapType0Select Heap@@10 r_4 f_7)) 5) (state Heap@@10 UnfoldingMask@3))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm UnfoldingMask@3 r_4 f_7)) (=> (HasDirectPerm UnfoldingMask@3 r_4 f_7) (=> (= Heap@0 (MapType0Store Heap@@10 null (|p2#sm| r_4) (MapType1Store (MapType0Select Heap@@10 null (|p2#sm| r_4)) r_4 f_7 (bool_2_U true)))) (=> (and (state Heap@0 Mask@1) (= (ControlFlow 0 4) 2)) anon5_correct))))))))
(let ((anon15_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 4)) anon4_correct)))
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (p2 r_4))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (p2 r_4)))) (=> (= (ControlFlow 0 6) 4) anon4_correct))))))
(let ((anon14_Then_correct  (=> (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) r_4)) (=> (and (|p2#trigger| Heap@@10 (p2 r_4)) (= (MapType0Select Heap@@10 null (p2 r_4)) (FrameFragment (MapType0Select Heap@@10 r_4 f_7)))) (and (=> (= (ControlFlow 0 9) 6) anon15_Then_correct) (=> (= (ControlFlow 0 9) 8) anon15_Else_correct))))))
(let ((anon14_Else_correct  (=> (and (not (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) r_4))) (= (ControlFlow 0 3) 2)) anon5_correct)))
(let ((anon16_Else_correct true))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@10 x1@@7 $allocated)) (U_2_bool (MapType0Select Heap@@10 x2 $allocated))) (and (= Mask@0 (MapType1Store ZeroMask null (p2 x1@@7) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (p2 x1@@7))) FullPerm)))) (state Heap@@10 Mask@0))) (and (and (state Heap@@10 Mask@0) (= Mask@1 (MapType1Store Mask@0 null (p2 x2) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (p2 x2))) FullPerm))))) (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1)))) (and (and (and (and (=> (= (ControlFlow 0 18) 1) anon16_Else_correct) (=> (= (ControlFlow 0 18) 17) anon17_Then_correct)) (=> (= (ControlFlow 0 18) 11) anon17_Else_correct)) (=> (= (ControlFlow 0 18) 9) anon14_Then_correct)) (=> (= (ControlFlow 0 18) 3) anon14_Else_correct))))))
