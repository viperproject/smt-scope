...
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (issubtype (typeof Result) vint))))
(let ((anon5_Else_correct  (=> (= (bool___unbox__ Heap@@51 Result) prim@@10) (=> (and (state Heap@@51 ZeroMask) (state Heap@@51 ZeroMask)) (and (=> (= (ControlFlow 0 6) 4) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct))))))
(let ((anon5_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (issubtype (typeof Result) vbool))))
(let ((anon0_correct  (=> (state Heap@@51 ZeroMask) (=> (and (and (= AssumeFunctionsAbove 0) (= (typeof Result) vbool)) (and (state Heap@@51 ZeroMask) (state Heap@@51 ZeroMask))) (and (=> (= (ControlFlow 0 7) 2) anon5_Then_correct) (=> (= (ControlFlow 0 7) 6) anon5_Else_correct))))))
