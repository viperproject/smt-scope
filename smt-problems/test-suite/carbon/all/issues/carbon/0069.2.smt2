...
(assert  (and (and (= (type Heap@@19) (MapType0Type RefType)) (= (type this@@9) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |postFunction2#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (and (state Heap@@19 ZeroMask) (U_2_bool (MapType0Select Heap@@19 this@@9 $allocated))) (and (= AssumeFunctionsAbove 1) (not (= this@@9 null)))) (and (and (not (= this@@9 null)) (= Mask@0 (MapType1Store ZeroMask this@@9 x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@9 x@@8)) FullPerm))))) (and (state Heap@@19 Mask@0) (state Heap@@19 Mask@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 this@@9 x@@8)) (=> (HasDirectPerm Mask@0 this@@9 x@@8) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (MapType0Select Heap@@19 this@@9 x@@8)) 0)))))))
