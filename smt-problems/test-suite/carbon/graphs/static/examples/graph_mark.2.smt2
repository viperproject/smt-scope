...
(declare-fun refs@@5 () T@U)
(declare-fun qpRange2 (T@U) Bool)
(declare-fun invRecv2 (T@U) T@U)
(declare-fun QPMask@0 () T@U)
(declare-fun qpRange1 (T@U) Bool)
(declare-fun invRecv1 (T@U) T@U)
(assert  (and (and (and (and (and (and (and (= (type refs@@5) (MapType2Type RefType boolType)) (= (type p_3) RefType)) (= (type s_2) RefType)) (= (type Heap@@17) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@59 T@U) ) (! (= (type (invRecv2 arg0@@59)) RefType)
...
(let ((anon16_Else_correct  (=> (and (= (MapType0Select Heap@@17 p_3 car) s_2) (= (ControlFlow 0 9) 4)) anon9_correct)))
(let ((anon16_Then_correct  (=> (not (= (MapType0Select Heap@@17 p_3 car) s_2)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm QPMask@1 p_3 cdr)) (=> (HasDirectPerm QPMask@1 p_3 cdr) (=> (= (ControlFlow 0 7) 4) anon9_correct))))))
(let ((anon15_Then_correct  (=> (U_2_bool (MapType2Select refs@@5 s_2)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm QPMask@1 p_3 car)) (=> (HasDirectPerm QPMask@1 p_3 car) (and (=> (= (ControlFlow 0 10) 7) anon16_Then_correct) (=> (= (ControlFlow 0 10) 9) anon16_Else_correct)))))))
(let ((anon15_Else_correct  (=> (and (not (U_2_bool (MapType2Select refs@@5 s_2))) (= (ControlFlow 0 6) 4)) anon9_correct)))
(let ((anon14_Then_correct  (=> (U_2_bool (MapType2Select refs@@5 p_3)) (and (=> (= (ControlFlow 0 12) 10) anon15_Then_correct) (=> (= (ControlFlow 0 12) 6) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (not (U_2_bool (MapType2Select refs@@5 p_3))) (= (ControlFlow 0 5) 4)) anon9_correct)))
(let ((anon13_Else_correct true))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((n$0_3 T@U) (n$0_3_1 T@U) ) (!  (=> (and (= (type n$0_3) RefType) (= (type n$0_3_1) RefType)) (=> (and (and (and (and (not (= n$0_3 n$0_3_1)) (U_2_bool (MapType2Select refs@@5 n$0_3))) (U_2_bool (MapType2Select refs@@5 n$0_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_3 n$0_3_1))))
 :qid |stdinbpl.756:15|
 :skolemid |107|
 :no-pattern (type n$0_3)
 :no-pattern (type n$0_3_1)
 :no-pattern (U_2_int n$0_3)
 :no-pattern (U_2_bool n$0_3)
 :no-pattern (U_2_int n$0_3_1)
 :no-pattern (U_2_bool n$0_3_1)
))) (=> (forall ((n$0_3@@0 T@U) (n$0_3_1@@0 T@U) ) (!  (=> (and (= (type n$0_3@@0) RefType) (= (type n$0_3_1@@0) RefType)) (=> (and (and (and (and (not (= n$0_3@@0 n$0_3_1@@0)) (U_2_bool (MapType2Select refs@@5 n$0_3@@0))) (U_2_bool (MapType2Select refs@@5 n$0_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_3@@0 n$0_3_1@@0))))
 :qid |stdinbpl.756:15|
 :skolemid |107|
 :no-pattern (type n$0_3@@0)
 :no-pattern (type n$0_3_1@@0)
 :no-pattern (U_2_int n$0_3@@0)
 :no-pattern (U_2_bool n$0_3@@0)
 :no-pattern (U_2_int n$0_3_1@@0)
 :no-pattern (U_2_bool n$0_3_1@@0)
)) (=> (forall ((n$0_3@@1 T@U) ) (!  (=> (= (type n$0_3@@1) RefType) (=> (and (U_2_bool (MapType2Select refs@@5 n$0_3@@1)) (< NoPerm FullPerm)) (and (qpRange2 n$0_3@@1) (= (invRecv2 n$0_3@@1) n$0_3@@1))))
 :qid |stdinbpl.762:22|
 :skolemid |108|
 :pattern ( (MapType0Select Heap@@17 n$0_3@@1 cdr))
 :pattern ( (MapType1Select QPMask@1 n$0_3@@1 cdr))
 :pattern ( (MapType0Select Heap@@17 n$0_3@@1 cdr))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select refs@@5 (invRecv2 o_3))) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.766:22|
 :skolemid |109|
 :pattern ( (invRecv2 o_3))
)) (forall ((n$0_3@@2 T@U) ) (!  (=> (and (= (type n$0_3@@2) RefType) (U_2_bool (MapType2Select refs@@5 n$0_3@@2))) (not (= n$0_3@@2 null)))
 :qid |stdinbpl.772:22|
 :skolemid |110|
 :pattern ( (MapType0Select Heap@@17 n$0_3@@2 cdr))
 :pattern ( (MapType1Select QPMask@1 n$0_3@@2 cdr))
 :pattern ( (MapType0Select Heap@@17 n$0_3@@2 cdr))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select refs@@5 (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 cdr)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@0 cdr)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select refs@@5 (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 cdr)) (U_2_real (MapType1Select QPMask@0 o_3@@0 cdr))))))
 :qid |stdinbpl.778:22|
 :skolemid |111|
 :pattern ( (MapType1Select QPMask@1 o_3@@0 cdr))
)) (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 cdr))) (= (U_2_real (MapType1Select QPMask@0 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@1 o_3@@1 f_5))))))
 :qid |stdinbpl.782:29|
 :skolemid |112|
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@1 o_3@@1 f_5))
))) (and (state Heap@@17 QPMask@1) (state Heap@@17 QPMask@1))) (and (and (=> (= (ControlFlow 0 13) 3) anon13_Else_correct) (=> (= (ControlFlow 0 13) 12) anon14_Then_correct)) (=> (= (ControlFlow 0 13) 5) anon14_Else_correct)))))))))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((n_3 T@U) (n_3_1 T@U) ) (!  (=> (and (= (type n_3) RefType) (= (type n_3_1) RefType)) (=> (and (and (and (and (not (= n_3 n_3_1)) (U_2_bool (MapType2Select refs@@5 n_3))) (U_2_bool (MapType2Select refs@@5 n_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3 n_3_1))))
 :qid |stdinbpl.717:15|
 :skolemid |101|
 :no-pattern (type n_3)
...
))) (=> (forall ((n_3@@0 T@U) (n_3_1@@0 T@U) ) (!  (=> (and (= (type n_3@@0) RefType) (= (type n_3_1@@0) RefType)) (=> (and (and (and (and (not (= n_3@@0 n_3_1@@0)) (U_2_bool (MapType2Select refs@@5 n_3@@0))) (U_2_bool (MapType2Select refs@@5 n_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3@@0 n_3_1@@0))))
 :qid |stdinbpl.717:15|
 :skolemid |101|
...
)) (=> (and (forall ((n_3@@1 T@U) ) (!  (=> (= (type n_3@@1) RefType) (=> (and (U_2_bool (MapType2Select refs@@5 n_3@@1)) (< NoPerm FullPerm)) (and (qpRange1 n_3@@1) (= (invRecv1 n_3@@1) n_3@@1))))
 :qid |stdinbpl.723:22|
 :skolemid |102|
 :pattern ( (MapType0Select Heap@@17 n_3@@1 car))
 :pattern ( (MapType1Select QPMask@0 n_3@@1 car))
 :pattern ( (MapType0Select Heap@@17 n_3@@1 car))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType2Select refs@@5 (invRecv1 o_3@@2))) (< NoPerm FullPerm)) (qpRange1 o_3@@2)) (= (invRecv1 o_3@@2) o_3@@2)))
 :qid |stdinbpl.727:22|
 :skolemid |103|
 :pattern ( (invRecv1 o_3@@2))
))) (=> (and (and (forall ((n_3@@2 T@U) ) (!  (=> (and (= (type n_3@@2) RefType) (U_2_bool (MapType2Select refs@@5 n_3@@2))) (not (= n_3@@2 null)))
 :qid |stdinbpl.733:22|
 :skolemid |104|
 :pattern ( (MapType0Select Heap@@17 n_3@@2 car))
 :pattern ( (MapType1Select QPMask@0 n_3@@2 car))
 :pattern ( (MapType0Select Heap@@17 n_3@@2 car))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType2Select refs@@5 (invRecv1 o_3@@3))) (< NoPerm FullPerm)) (qpRange1 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 car)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 car)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select refs@@5 (invRecv1 o_3@@3))) (< NoPerm FullPerm)) (qpRange1 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 car)) (U_2_real (MapType1Select ZeroMask o_3@@3 car))))))
 :qid |stdinbpl.739:22|
 :skolemid |105|
 :pattern ( (MapType1Select QPMask@0 o_3@@3 car))
))) (and (forall ((o_3@@4 T@U) (f_5@@0 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_5@@0))))
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 car))) (= (U_2_real (MapType1Select ZeroMask o_3@@4 f_5@@0)) (U_2_real (MapType1Select QPMask@0 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.743:29|
 :skolemid |106|
 :pattern ( (MapType1Select ZeroMask o_3@@4 f_5@@0))
 :pattern ( (MapType1Select QPMask@0 o_3@@4 f_5@@0))
)) (state Heap@@17 QPMask@0))) (and (=> (= (ControlFlow 0 15) 2) anon12_Then_correct) (=> (= (ControlFlow 0 15) 13) anon12_Else_correct))))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) (= AssumeFunctionsAbove 1)) (and (=> (= (ControlFlow 0 17) 1) anon11_Then_correct) (=> (= (ControlFlow 0 17) 15) anon11_Else_correct)))))
