...
(let ((anon4_Else_correct  (=> (not (= i@@3 0)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing h@@3 h@@3)) (=> (decreasing h@@3 h@@3) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded h@@3)) (=> (bounded h@@3) (=> (and (state Heap@@13 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (and (= i@@3 0) (= (ControlFlow 0 2) 1)) anon3_correct)))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (>= i@@3 0) (state Heap@@13 ZeroMask))) (and (=> (= (ControlFlow 0 6) 2) anon4_Then_correct) (=> (= (ControlFlow 0 6) 3) anon4_Else_correct)))))
