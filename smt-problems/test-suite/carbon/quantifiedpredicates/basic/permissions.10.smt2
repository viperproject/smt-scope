...
(assert  (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type x@@11) RefType)) (= (type Heap@@11) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test02_client)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (pred2 x@@11 p_1@@5) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (pred2 x@@11 p_1@@5))) FullPerm)))) (=> (and (and (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1)) (and (state ExhaleHeap@0 Mask@1) (= (ControlFlow 0 2) (- 0 1)))) false))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pred2 x@@11 p_1@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pred2 x@@11 p_1@@5)))) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@11 x@@11 $allocated)) (= p_1@@5 NoPerm)) (=> (and (and (state Heap@@11 ZeroMask) (= Mask@0 (MapType1Store ZeroMask null (pred2 x@@11 p_1@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (pred2 x@@11 p_1@@5))) FullPerm))))) (and (state Heap@@11 Mask@0) (state Heap@@11 Mask@0))) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))))
