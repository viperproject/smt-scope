...
(declare-fun |trigger_issue'| (T@U Int Int) Bool)
(declare-fun MapType0Type (T@T) T@T)
(declare-fun RefType () T@T)
(declare-fun MapType1Type (T@T T@T) T@T)
(declare-fun |trigger_issue#frame| (T@U Int Int) Bool)
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((arg0@@14 T@T) ) (! (= (Ctor (MapType0Type arg0@@14)) 7)
...
(assert (forall ((Heap T@U) (Mask T@U) (lo Int) (hi Int) ) (!  (=> (and (and (= (type Heap) (MapType0Type RefType)) (= (type Mask) (MapType1Type RefType realType))) (state Heap Mask)) (= (|trigger_issue'| Heap lo hi) (|trigger_issue#frame| EmptyFrame lo hi)))
 :qid |stdinbpl.567:15|
 :skolemid |62|
...
(assert (forall ((Heap@@1 T@U) (lo@@0 Int) (hi@@0 Int) ) (!  (=> (= (type Heap@@1) (MapType0Type RefType)) (dummyFunction (bool_2_U (|trigger_issue#triggerStateless| lo@@0 hi@@0))))
 :qid |stdinbpl.551:15|
 :skolemid |59|
...
(assert (forall ((Heap@@11 T@U) (Mask@@10 T@U) (lo@@1 Int) (hi@@1 Int) ) (!  (=> (and (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (and (state Heap@@11 Mask@@10) (< AssumeFunctionsAbove 0))) (forall ((k Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| lo@@1 hi@@1) (int_2_U k)) (< k (+ k 1)))
 :qid |stdinbpl.559:61|
 :skolemid |60|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| lo@@1 hi@@1) (int_2_U k)))
 :pattern ( (|Seq#Contains| (|Seq#Range| lo@@1 hi@@1) (int_2_U k)))
))) (trigger_issue Heap@@11 lo@@1 hi@@1))
 :qid |stdinbpl.557:15|
 :skolemid |61|
 :pattern ( (state Heap@@11 Mask@@10) (trigger_issue Heap@@11 lo@@1 hi@@1))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@12 T@U) (lo@@2 Int) (hi@@2 Int) ) (!  (=> (= (type Heap@@12) (MapType0Type RefType)) (and (= (trigger_issue Heap@@12 lo@@2 hi@@2) (|trigger_issue'| Heap@@12 lo@@2 hi@@2)) (dummyFunction (bool_2_U (|trigger_issue#triggerStateless| lo@@2 hi@@2)))))
 :qid |stdinbpl.547:15|
 :skolemid |58|
 :pattern ( (trigger_issue Heap@@12 lo@@2 hi@@2))
)))
(push 1)
...
(let ((anon9_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (* x@@11 y@@2)) (int_2_U k@@0))) (= (ControlFlow 0 7) 4)) anon4_correct)))
(let ((anon9_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (* x@@11 y@@2)) (int_2_U k@@0)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< k@@0 (+ k@@0 1))) (=> (< k@@0 (+ k@@0 1)) (=> (= (ControlFlow 0 5) 4) anon4_correct))))))
(let ((anon8_Else_correct true))
(let ((anon7_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (trigger_issue Heap@@13 0 (* x@@11 y@@2)))))
(let ((anon0_correct  (=> (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (and (and (=> (= (ControlFlow 0 8) 2) anon7_Else_correct) (=> (= (ControlFlow 0 8) 3) anon8_Else_correct)) (=> (= (ControlFlow 0 8) 5) anon9_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct)))))
