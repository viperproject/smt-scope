...
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 f_7))) (=> (= (ControlFlow 0 2) 1) anon10_correct))))))
(let ((anon8_correct  (=> (= Mask@1 (MapType1Store Mask@0 r_1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 r_1 f_7)) FullPerm)))) (=> (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (= (U_2_real (MapType1Select Mask@1 r_1 f_7)) NoPerm)) (=> (= (U_2_real (MapType1Select Mask@1 r_1 f_7)) NoPerm) (=> (state ExhaleHeap@0 Mask@1) (and (=> (= (ControlFlow 0 5) 2) anon15_Then_correct) (=> (= (ControlFlow 0 5) 4) anon15_Else_correct)))))))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 5)) anon8_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select Mask@0 r_1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 r_1 f_7))) (=> (= (ControlFlow 0 7) 5) anon8_correct))))))
(let ((anon6_correct  (=> (and (= AssertMask@2 (MapType1Store Mask@0 r_1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 r_1 f_7)) FullPerm)))) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 10) 7) anon14_Then_correct) (=> (= (ControlFlow 0 10) 9) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 10)) anon6_correct)))
(let ((anon13_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType1Select Mask@0 r_1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 r_1 f_7))) (=> (= (ControlFlow 0 11) 10) anon6_correct))))))
(let ((anon4_correct  (=> (and (= AssertMask@1 (MapType1Store Mask@0 r_1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 r_1 f_7)) FullPerm)))) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 14) 11) anon13_Then_correct) (=> (= (ControlFlow 0 14) 13) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 17) 14)) anon4_correct)))
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= FullPerm (U_2_real (MapType1Select Mask@0 r_1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 r_1 f_7))) (=> (= (ControlFlow 0 15) 14) anon4_correct))))))
(let ((anon2_correct  (=> (and (= AssertMask@0 (MapType1Store Mask@0 r_1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 r_1 f_7)) FullPerm)))) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 18) 15) anon12_Then_correct) (=> (= (ControlFlow 0 18) 17) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 21) 18)) anon2_correct)))
(let ((anon11_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (<= FullPerm (U_2_real (MapType1Select Mask@0 r_1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 r_1 f_7))) (=> (= (ControlFlow 0 19) 18) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 r_1 $allocated))) (=> (and (and (not (= r_1 null)) (= Mask@0 (MapType1Store ZeroMask r_1 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1 f_7)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 22) 19) anon11_Then_correct) (=> (= (ControlFlow 0 22) 21) anon11_Else_correct))))))
