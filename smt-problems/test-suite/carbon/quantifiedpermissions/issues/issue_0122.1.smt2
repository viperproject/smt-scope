...
(assert  (and (and (and (and (= (type xs@@4) (MapType2Type RefType boolType)) (= (type Heap@@13) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv1 arg0@@45)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_4 T@U) (x_4_1 T@U) ) (!  (=> (and (= (type x_4) RefType) (= (type x_4_1) RefType)) (=> (and (and (and (and (not (= x_4 x_4_1)) (U_2_bool (MapType2Select xs@@4 x_4))) (U_2_bool (MapType2Select xs@@4 x_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4 x_4_1))))
 :qid |stdinbpl.463:15|
 :skolemid |87|
 :no-pattern (type x_4)
...
))) (=> (forall ((x_4@@0 T@U) (x_4_1@@0 T@U) ) (!  (=> (and (= (type x_4@@0) RefType) (= (type x_4_1@@0) RefType)) (=> (and (and (and (and (not (= x_4@@0 x_4_1@@0)) (U_2_bool (MapType2Select xs@@4 x_4@@0))) (U_2_bool (MapType2Select xs@@4 x_4_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4@@0 x_4_1@@0))))
 :qid |stdinbpl.463:15|
 :skolemid |87|
...
)) (=> (and (forall ((x_4@@1 T@U) ) (!  (=> (= (type x_4@@1) RefType) (=> (and (U_2_bool (MapType2Select xs@@4 x_4@@1)) (< NoPerm FullPerm)) (and (qpRange1 x_4@@1) (= (invRecv1 x_4@@1) x_4@@1))))
 :qid |stdinbpl.469:22|
 :skolemid |88|
 :pattern ( (MapType0Select Heap@@13 x_4@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_4@@1 f_7))
 :pattern ( (MapType2Select xs@@4 x_4@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select xs@@4 (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.473:22|
 :skolemid |89|
 :pattern ( (invRecv1 o_3))
))) (=> (and (and (and (forall ((x_4@@2 T@U) ) (!  (=> (and (= (type x_4@@2) RefType) (U_2_bool (MapType2Select xs@@4 x_4@@2))) (not (= x_4@@2 null)))
 :qid |stdinbpl.479:22|
 :skolemid |90|
 :pattern ( (MapType0Select Heap@@13 x_4@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 x_4@@2 f_7))
 :pattern ( (MapType2Select xs@@4 x_4@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs@@4 (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select xs@@4 (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.485:22|
 :skolemid |91|
...
)) (state Heap@@13 QPMask@0))) (and (and (state Heap@@13 QPMask@0) (U_2_bool (MapType2Select xs@@4 y@@11))) (and (state Heap@@13 QPMask@0) (= (ControlFlow 0 3) (- 0 2))))) (HasDirectPerm QPMask@0 y@@11 f_7)))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@13 y@@11 $allocated)) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct))))))
