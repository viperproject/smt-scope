(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:06:56
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/permissions/negative_amounts.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (= k@11@01 (* (to_real (- 0 1)) k@8@01)))
; [exec]
; assert none < k
; [eval] none < k
(set-option :timeout 0)
