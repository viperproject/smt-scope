(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:31:50
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/transformations/Macros/Hygienic/forall.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (not (forall ((i@2@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/transformations/Macros/Hygienic/forall.vpr@10@12@10@23|))))
(check-sat)
; unsat
(pop) ; 3
; 0,00s
...
(assert (not (forall ((i$0@3@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/transformations/Macros/Hygienic/forall.vpr@11@12@11@23|))))
(check-sat)
; unsat
(pop) ; 3
; 0,00s
