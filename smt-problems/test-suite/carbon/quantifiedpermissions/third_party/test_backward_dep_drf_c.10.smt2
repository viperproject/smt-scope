...
(assert  (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type a_2) (SeqType RefType))) (= (type Heap@@33) (MapType0Type RefType))) (= (type diz) RefType)))
(set-info :boogie-vc-id Ref__recv_body_115)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_Else_correct true))
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i@@34 0)) (=> (>= i@@34 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i@@34 (|Seq#Length| a_2))) (=> (< i@@34 (|Seq#Length| a_2)) (=> (and (= perm@0 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@0 NoPerm)))))))))
