...
(assert  (and (and (and (and (and (= (type UnfoldingMask@0) (MapType1Type RefType realType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type x@@30) RefType)) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Heap@@14) (MapType0Type RefType))) (forall ((arg0@@47 T@U) ) (! (= (type (invRecv1 arg0@@47)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon4_correct  (=> (and (= UnfoldingMask@0 (MapType1Store QPMask@0 null (bar x@@30) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (bar x@@30))) FullPerm)))) (not (= x@@30 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x@@30 val (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@30 val)) FullPerm)))) (state Heap@@14 UnfoldingMask@1)) (and (state Heap@@14 UnfoldingMask@1) (= (ControlFlow 0 3) (- 0 2)))) (HasDirectPerm UnfoldingMask@1 x@@30 val)))))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (bar x@@30))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (bar x@@30)))) (=> (= (ControlFlow 0 4) 3) anon4_correct))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((w_4 T@U) (w_4_1 T@U) ) (!  (=> (and (= (type w_4) RefType) (= (type w_4_1) RefType)) (=> (and (and (and (and (not (= w_4 w_4_1)) (U_2_bool (MapType2Select (|Set#Singleton| x@@30) w_4))) (U_2_bool (MapType2Select (|Set#Singleton| x@@30) w_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= w_4 w_4_1))))
 :qid |stdinbpl.479:17|
 :skolemid |87|
 :pattern ( (neverTriggered1 w_4) (neverTriggered1 w_4_1))
))) (=> (forall ((w_4@@0 T@U) (w_4_1@@0 T@U) ) (!  (=> (and (= (type w_4@@0) RefType) (= (type w_4_1@@0) RefType)) (=> (and (and (and (and (not (= w_4@@0 w_4_1@@0)) (U_2_bool (MapType2Select (|Set#Singleton| x@@30) w_4@@0))) (U_2_bool (MapType2Select (|Set#Singleton| x@@30) w_4_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= w_4@@0 w_4_1@@0))))
 :qid |stdinbpl.479:17|
 :skolemid |87|
 :pattern ( (neverTriggered1 w_4@@0) (neverTriggered1 w_4_1@@0))
)) (=> (forall ((w_4@@1 T@U) ) (!  (=> (= (type w_4@@1) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Singleton| x@@30) w_4@@1)) (< NoPerm FullPerm)) (and (= (invRecv1 w_4@@1) w_4@@1) (qpRange1 w_4@@1))))
 :qid |stdinbpl.485:22|
 :skolemid |88|
 :pattern ( (MapType0Select Heap@@14 null (bar w_4@@1)))
 :pattern ( (MapType1Select ZeroMask null (bar w_4@@1)))
 :pattern ( (MapType2Select (|Set#Singleton| x@@30) w_4@@1))
)) (=> (and (and (and (forall ((x_2_1 T@U) ) (!  (=> (= (type x_2_1) RefType) (=> (and (and (U_2_bool (MapType2Select (|Set#Singleton| x@@30) (invRecv1 x_2_1))) (< NoPerm FullPerm)) (qpRange1 x_2_1)) (= (invRecv1 x_2_1) x_2_1)))
 :qid |stdinbpl.489:22|
 :skolemid |89|
 :pattern ( (invRecv1 x_2_1))
)) (forall ((x_2_1@@0 T@U) ) (!  (=> (= (type x_2_1@@0) RefType) (=> (and (and (U_2_bool (MapType2Select (|Set#Singleton| x@@30) (invRecv1 x_2_1@@0))) (< NoPerm FullPerm)) (qpRange1 x_2_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 x_2_1@@0) x_2_1@@0)) (= (U_2_real (MapType1Select QPMask@0 null (bar x_2_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (bar x_2_1@@0))) FullPerm)))))
 :qid |stdinbpl.495:22|
 :skolemid |90|
 :pattern ( (MapType1Select QPMask@0 null (bar x_2_1@@0)))
...
)) (forall ((x_2_1@@1 T@U) ) (!  (=> (and (= (type x_2_1@@1) RefType) (not (and (and (U_2_bool (MapType2Select (|Set#Singleton| x@@30) (invRecv1 x_2_1@@1))) (< NoPerm FullPerm)) (qpRange1 x_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (bar x_2_1@@1))) (U_2_real (MapType1Select ZeroMask null (bar x_2_1@@1)))))
 :qid |stdinbpl.505:22|
 :skolemid |92|
 :pattern ( (MapType1Select QPMask@0 null (bar x_2_1@@1)))
)))) (and (and (state Heap@@14 QPMask@0) (state Heap@@14 QPMask@0)) (and (|bar#trigger| Heap@@14 (bar x@@30)) (= (MapType0Select Heap@@14 null (bar x@@30)) (FrameFragment (MapType0Select Heap@@14 x@@30 val)))))) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@14 x@@30 $allocated)) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 9) 1) anon5_Then_correct) (=> (= (ControlFlow 0 9) 7) anon5_Else_correct))))))
