...
(assert  (and (= (type s@@5) RefType) (= (type Heap@@13) (MapType0Type RefType))))
(set-info :boogie-vc-id foo)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (not (= i_1 i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= s@@5 s@@5)) (not (= i_1 i_1_1))))
 :qid |stdinbpl.310:17|
 :skolemid |31|
 :pattern ( (neverTriggered1 i_1) (neverTriggered1 i_1_1))
)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@13 s@@5 $allocated)) (state Heap@@13 ZeroMask))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
