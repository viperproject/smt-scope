...
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@8) (MapType1Type RefType realType)) (= (type this) RefType)) (= (type Mask@10) (MapType1Type RefType realType))) (= (type Mask@9) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@7) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test03a)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 31) (let ((anon19_correct true))
(let ((anon18_correct  (=> (= Mask@9 (MapType1Store Mask@8 null (P this) (real_2_U (- (U_2_real (MapType1Select Mask@8 null (P this))) FullPerm)))) (=> (and (= Mask@10 Mask@9) (= (ControlFlow 0 5) 3)) anon19_correct))))
(let ((anon30_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon18_correct)))
(let ((anon30_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@8 null (P this))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@8 null (P this)))) (=> (= (ControlFlow 0 6) 5) anon18_correct))))))
(let ((anon29_Then_correct  (=> (<= FullPerm (U_2_real (MapType1Select Mask@8 null (P this)))) (and (=> (= (ControlFlow 0 9) 6) anon30_Then_correct) (=> (= (ControlFlow 0 9) 8) anon30_Else_correct)))))
(let ((anon29_Else_correct  (=> (< (U_2_real (MapType1Select Mask@8 null (P this))) FullPerm) (=> (and (= Mask@10 Mask@8) (= (ControlFlow 0 4) 3)) anon19_correct))))
(let ((anon14_correct  (=> (and (= Mask@7 (MapType1Store Mask@5 null (P this) (real_2_U (- (U_2_real (MapType1Select Mask@5 null (P this))) FullPerm)))) (= Mask@8 Mask@7)) (and (=> (= (ControlFlow 0 11) 9) anon29_Then_correct) (=> (= (ControlFlow 0 11) 4) anon29_Else_correct)))))
(let ((anon28_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 14) 11)) anon14_correct)))
(let ((anon28_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (U_2_real (MapType1Select Mask@5 null (P this))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@5 null (P this)))) (=> (= (ControlFlow 0 12) 11) anon14_correct))))))
(let ((anon27_Then_correct  (=> (< NoPerm (U_2_real (MapType1Select Mask@5 null (P this)))) (and (=> (= (ControlFlow 0 15) 12) anon28_Then_correct) (=> (= (ControlFlow 0 15) 14) anon28_Else_correct)))))
(let ((anon27_Else_correct  (=> (and (<= (U_2_real (MapType1Select Mask@5 null (P this))) NoPerm) (= Mask@8 Mask@5)) (and (=> (= (ControlFlow 0 10) 9) anon29_Then_correct) (=> (= (ControlFlow 0 10) 4) anon29_Else_correct)))))
(let ((anon26_Then_correct  (=> (state ExhaleHeap@0 ZeroMask) (=> (and (and (= Mask@5 (MapType1Store ZeroMask null (P this) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P this))) FullPerm)))) (state ExhaleHeap@0 Mask@5)) (and (state ExhaleHeap@0 Mask@5) (state ExhaleHeap@0 Mask@5))) (and (=> (= (ControlFlow 0 16) 15) anon27_Then_correct) (=> (= (ControlFlow 0 16) 10) anon27_Else_correct))))))
(let ((anon26_Else_correct true))
(let ((anon25_Then_correct true))
(let ((anon8_correct  (=> (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@0 Mask@3) (and (and (=> (= (ControlFlow 0 17) 1) anon25_Then_correct) (=> (= (ControlFlow 0 17) 16) anon26_Then_correct)) (=> (= (ControlFlow 0 17) 2) anon26_Else_correct)))))
(let ((anon7_correct  (=> (= Mask@2 (MapType1Store Mask@1 null (P this) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (P this))) FullPerm)))) (=> (and (= Mask@3 Mask@2) (= (ControlFlow 0 19) 17)) anon8_correct))))
(let ((anon24_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 22) 19)) anon7_correct)))
(let ((anon24_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (P this))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (P this)))) (=> (= (ControlFlow 0 20) 19) anon7_correct))))))
(let ((anon23_Then_correct  (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (P this)))) (and (=> (= (ControlFlow 0 23) 20) anon24_Then_correct) (=> (= (ControlFlow 0 23) 22) anon24_Else_correct)))))
(let ((anon23_Else_correct  (=> (< (U_2_real (MapType1Select Mask@1 null (P this))) FullPerm) (=> (and (= Mask@3 Mask@1) (= (ControlFlow 0 18) 17)) anon8_correct))))
(let ((anon3_correct  (=> (and (= Mask@0 (MapType1Store ZeroMask null (P this) (real_2_U (- (U_2_real (MapType1Select ZeroMask null (P this))) FullPerm)))) (= Mask@1 Mask@0)) (and (=> (= (ControlFlow 0 25) 23) anon23_Then_correct) (=> (= (ControlFlow 0 25) 18) anon23_Else_correct)))))
(let ((anon22_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 28) 25)) anon3_correct)))
(let ((anon22_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (<= FullPerm (U_2_real (MapType1Select ZeroMask null (P this))))) (=> (<= FullPerm (U_2_real (MapType1Select ZeroMask null (P this)))) (=> (= (ControlFlow 0 26) 25) anon3_correct))))))
(let ((anon21_Then_correct  (=> (< NoPerm (U_2_real (MapType1Select ZeroMask null (P this)))) (and (=> (= (ControlFlow 0 29) 26) anon22_Then_correct) (=> (= (ControlFlow 0 29) 28) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (and (<= (U_2_real (MapType1Select ZeroMask null (P this))) NoPerm) (= Mask@1 ZeroMask)) (and (=> (= (ControlFlow 0 24) 23) anon23_Then_correct) (=> (= (ControlFlow 0 24) 18) anon23_Else_correct)))))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 this $allocated))) (and (=> (= (ControlFlow 0 30) 29) anon21_Then_correct) (=> (= (ControlFlow 0 30) 24) anon21_Else_correct)))))
