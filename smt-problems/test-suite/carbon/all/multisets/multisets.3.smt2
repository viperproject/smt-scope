...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (= (|MultiSet#Card| B@@11) n) (state Heap@@9 ZeroMask)) (and (= B1@0 (|MultiSet#Intersection| B@@11 (|MultiSet#UnionOne| (|MultiSet#Singleton| (int_2_U y@@6)) (int_2_U x@@19)))) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (> (|MultiSet#Select| B1@0 (int_2_U x@@19)) 0) (> (|MultiSet#Select| B@@11 (int_2_U x@@19)) 0))) (=> (= (> (|MultiSet#Select| B1@0 (int_2_U x@@19)) 0) (> (|MultiSet#Select| B@@11 (int_2_U x@@19)) 0)) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (<= (|MultiSet#Card| B1@0) 2))))))))
