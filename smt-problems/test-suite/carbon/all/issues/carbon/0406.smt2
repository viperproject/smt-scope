...
(assert  (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type x_2) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id m3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon6_Else_correct true))
(let ((anon6_Then_correct  (=> (and (not (= (U_2_real (MapType1Select Mask@1 x_2 f_7)) NoPerm)) (= (ControlFlow 0 2) (- 0 4))) false)))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 x_2 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 x_2 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 6) 2) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select Mask@0 x_2 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 x_2 f_7))) (=> (= (ControlFlow 0 7) 6) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 x_2 $allocated)) (not (= x_2 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask x_2 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x_2 f_7)) FullPerm)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 10) 7) anon5_Then_correct) (=> (= (ControlFlow 0 10) 9) anon5_Else_correct)))))))
