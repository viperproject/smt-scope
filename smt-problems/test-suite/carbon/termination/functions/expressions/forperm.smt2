...
(declare-fun |nonTerminating'| (T@U Int) Bool)
...
(declare-fun |nonTerminating#frame| (T@U Int) Bool)
...
(assert (forall ((Heap@@4 T@U) (v_2 Int) ) (!  (=> (= (type Heap@@4) (MapType0Type RefType)) (dummyFunction (bool_2_U (|nonTerminating#triggerStateless| v_2))))
 :qid |stdinbpl.387:15|
 :skolemid |33|
 :pattern ( (|nonTerminating'| Heap@@4 v_2))
)))
...
(assert (forall ((Heap@@6 T@U) (Mask@@3 T@U) (x@@10 T@U) ) (!  (=> (and (and (and (= (type Heap@@6) (MapType0Type RefType)) (= (type Mask@@3) (MapType1Type RefType realType))) (= (type x@@10) RefType)) (and (state Heap@@6 Mask@@3) (< AssumeFunctionsAbove 0))) (test2 Heap@@6 x@@10))
 :qid |stdinbpl.311:15|
 :skolemid |29|
 :pattern ( (state Heap@@6 Mask@@3) (test2 Heap@@6 x@@10))
)))
(assert (forall ((Heap@@7 T@U) (Mask@@4 T@U) (x@@11 T@U) ) (!  (=> (and (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type Mask@@4) (MapType1Type RefType realType))) (= (type x@@11) RefType)) (and (state Heap@@7 Mask@@4) (< AssumeFunctionsAbove 1))) (test Heap@@7 x@@11))
 :qid |stdinbpl.218:15|
 :skolemid |24|
 :pattern ( (state Heap@@7 Mask@@4) (test Heap@@7 x@@11))
)))
...
(assert (forall ((Heap@@10 T@U) (Mask@@8 T@U) (x@@12 T@U) ) (!  (=> (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@8) (MapType1Type RefType realType))) (= (type x@@12) RefType)) (state Heap@@10 Mask@@8)) (= (|test2'| Heap@@10 x@@12) (|test2#frame| EmptyFrame x@@12)))
 :qid |stdinbpl.318:15|
 :skolemid |30|
 :pattern ( (state Heap@@10 Mask@@8) (|test2'| Heap@@10 x@@12))
)))
(assert (forall ((Heap@@11 T@U) (Mask@@9 T@U) (v_2@@0 Int) ) (!  (=> (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (state Heap@@11 Mask@@9)) (= (|nonTerminating'| Heap@@11 v_2@@0) (|nonTerminating#frame| EmptyFrame v_2@@0)))
 :qid |stdinbpl.394:15|
 :skolemid |34|
 :pattern ( (state Heap@@11 Mask@@9) (|nonTerminating'| Heap@@11 v_2@@0))
)))
(assert (forall ((arg0@@26 T@U) ) (! (= (type (FrameFragment arg0@@26)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@26))
)))
(assert (forall ((Heap@@12 T@U) (Mask@@10 T@U) (x@@13 T@U) ) (!  (=> (and (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type x@@13) RefType)) (state Heap@@12 Mask@@10)) (= (|test'| Heap@@12 x@@13) (|test#frame| (FrameFragment (MapType0Select Heap@@12 x@@13 f_7)) x@@13)))
 :qid |stdinbpl.225:15|
 :skolemid |25|
 :pattern ( (state Heap@@12 Mask@@10) (|test'| Heap@@12 x@@13))
)))
(assert (forall ((Heap@@13 T@U) (x@@14 T@U) ) (!  (=> (and (= (type Heap@@13) (MapType0Type RefType)) (= (type x@@14) RefType)) (and (= (test Heap@@13 x@@14) (|test'| Heap@@13 x@@14)) (dummyFunction (bool_2_U (|test#triggerStateless| x@@14)))))
 :qid |stdinbpl.208:15|
 :skolemid |22|
 :pattern ( (test Heap@@13 x@@14))
)))
(assert (forall ((Heap@@14 T@U) (x@@15 T@U) ) (!  (=> (and (= (type Heap@@14) (MapType0Type RefType)) (= (type x@@15) RefType)) (and (= (test2 Heap@@14 x@@15) (|test2'| Heap@@14 x@@15)) (dummyFunction (bool_2_U (|test2#triggerStateless| x@@15)))))
 :qid |stdinbpl.301:15|
 :skolemid |27|
 :pattern ( (test2 Heap@@14 x@@15))
)))
(assert (forall ((Heap@@15 T@U) (v_2@@1 Int) ) (!  (=> (= (type Heap@@15) (MapType0Type RefType)) (and (= (nonTerminating Heap@@15 v_2@@1) (|nonTerminating'| Heap@@15 v_2@@1)) (dummyFunction (bool_2_U (|nonTerminating#triggerStateless| v_2@@1)))))
 :qid |stdinbpl.383:15|
 :skolemid |32|
 :pattern ( (nonTerminating Heap@@15 v_2@@1))
)))
...
(assert  (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type x21) RefType)) (= (type Heap@@20) (MapType0Type RefType))) (= (type x@@16) RefType)))
(set-info :boogie-vc-id test_pres_termination_proof)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon10_Then_correct  (=> (and (> (U_2_real (MapType1Select Mask@1 x21 f_7)) NoPerm) (= (ControlFlow 0 5) (- 0 4))) false)))
(let ((anon7_correct true))
(let ((anon10_Else_correct  (=> (>= NoPerm (U_2_real (MapType1Select Mask@1 x21 f_7))) (=> (and (state Heap@@20 Mask@1) (= (ControlFlow 0 6) 2)) anon7_correct))))
(let ((anon9_Then_correct  (=> (and $condInEx (U_2_bool (MapType0Select Heap@@20 x21 $allocated))) (and (=> (= (ControlFlow 0 7) 5) anon10_Then_correct) (=> (= (ControlFlow 0 7) 6) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (not $condInEx) (= (ControlFlow 0 3) 2)) anon7_correct)))
(let ((anon8_Else_correct  (=> (not b_2) (=> (and (not (= x@@16 null)) (= Mask@1 (MapType1Store ZeroMask x@@16 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@16 f_7)) FullPerm))))) (=> (and (and (state Heap@@20 Mask@1) (state Heap@@20 Mask@1)) (and (state Heap@@20 Mask@1) (state Heap@@20 Mask@1))) (and (=> (= (ControlFlow 0 8) 7) anon9_Then_correct) (=> (= (ControlFlow 0 8) 3) anon9_Else_correct)))))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@20 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@20 x@@16 $allocated))) (and (=> (= (ControlFlow 0 9) 1) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct))))))
