...
(declare-fun y@@6 () T@U)
(assert  (and (and (and (and (= (type xs) (MapType2Type RefType boolType)) (= (type Heap@@10) (MapType0Type RefType))) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv3 arg0@@45)) RefType)
 :qid |funType:invRecv3|
 :pattern ( (invRecv3 arg0@@45))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type y@@6) RefType)))
(set-info :boogie-vc-id m3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select xs x_1))) (U_2_bool (MapType2Select xs x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.730:17|
 :skolemid |100|
...
)) (=> (and (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs x_1@@1)) (< NoPerm FullPerm)) (and (= (invRecv3 x_1@@1) x_1@@1) (qpRange3 x_1@@1))))
 :qid |stdinbpl.736:22|
 :skolemid |101|
 :pattern ( (MapType0Select Heap@@10 null (p_1 x_1@@1)))
 :pattern ( (MapType1Select ZeroMask null (p_1 x_1@@1)))
 :pattern ( (MapType0Select Heap@@10 null (p_1 x_1@@1)))
)) (forall ((x_2_1 T@U) ) (!  (=> (= (type x_2_1) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv3 x_2_1))) (< NoPerm FullPerm)) (qpRange3 x_2_1)) (= (invRecv3 x_2_1) x_2_1)))
 :qid |stdinbpl.740:22|
 :skolemid |102|
 :pattern ( (invRecv3 x_2_1))
))) (and (forall ((x_2_1@@0 T@U) ) (!  (=> (= (type x_2_1@@0) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv3 x_2_1@@0))) (< NoPerm FullPerm)) (qpRange3 x_2_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv3 x_2_1@@0) x_2_1@@0)) (= (U_2_real (MapType1Select QPMask@0 null (p_1 x_2_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (p_1 x_2_1@@0))) FullPerm)))))
 :qid |stdinbpl.746:22|
 :skolemid |103|
...
)))) (=> (and (and (and (forall ((x_2_1@@1 T@U) ) (!  (=> (and (= (type x_2_1@@1) RefType) (not (and (and (U_2_bool (MapType2Select xs (invRecv3 x_2_1@@1))) (< NoPerm FullPerm)) (qpRange3 x_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (p_1 x_2_1@@1))) (U_2_real (MapType1Select ZeroMask null (p_1 x_2_1@@1)))))
 :qid |stdinbpl.756:22|
 :skolemid |105|
 :pattern ( (MapType1Select QPMask@0 null (p_1 x_2_1@@1)))
)) (state Heap@@10 QPMask@0)) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0))) (and (and (U_2_bool (MapType2Select xs y@@6)) (state Heap@@10 QPMask@0)) (and (state Heap@@10 QPMask@0) (= (ControlFlow 0 3) (- 0 2))))) (= (U_2_real (MapType1Select QPMask@0 null (p_1 y@@6))) FullPerm)))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 y@@6 $allocated))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct)))))
