...
(assert  (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type this) RefType)) (forall ((arg0@@28 T@U) ) (! (= (type (FrameFragment arg0@@28)) FrameTypeType)
...
(let ((anon6_Else_correct  (=> (and (HasDirectPerm Mask@1 null (valid false)) (= (ControlFlow 0 4) 2)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (HasDirectPerm Mask@1 null (valid false))) (=> (and (= Heap@0 (MapType0Store Heap@@10 null (valid false) newVersion@0)) (= (ControlFlow 0 3) 2)) anon4_correct))))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (valid false) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid false))) FullPerm)))) (and (=> (= (ControlFlow 0 5) 3) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid false))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid false)))) (=> (= (ControlFlow 0 6) 5) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 this $allocated)) (= Mask@0 (MapType1Store ZeroMask null (valid false) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid false))) FullPerm))))) (=> (and (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (|valid#trigger| Heap@@10 (valid false)) (= (MapType0Select Heap@@10 null (valid false)) (FrameFragment EmptyFrame)))) (and (=> (= (ControlFlow 0 9) 6) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct)))))))
