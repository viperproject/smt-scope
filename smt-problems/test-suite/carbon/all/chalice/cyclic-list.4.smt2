...
(assert  (and (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type freshObj@0) RefType)) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@@19) (MapType0Type RefType))) (= (type this@@14) RefType)) (= (type x@@8) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
...
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (valid (MapType0Select Heap@1 freshObj@0 next)))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (valid (MapType0Select Heap@1 freshObj@0 next))))) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (= (length Heap@1 freshObj@0) (+ (length Heap@1 (MapType0Select Heap@1 freshObj@0 next)) 1)))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm Mask@1 freshObj@0 next)) (=> (HasDirectPerm Mask@1 freshObj@0 next) (and (and (=> (= (ControlFlow 0 11) 6) anon11_Else_correct) (=> (= (ControlFlow 0 11) 8) anon12_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon12_Else_correct))))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (valid freshObj@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (valid freshObj@0)))) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@19 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@19 this@@14 $allocated)) (U_2_bool (MapType0Select Heap@@19 x@@8 $allocated))) (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@19 freshObj@0 $allocated))))) (and (and (= Heap@0 (MapType0Store Heap@@19 freshObj@0 $allocated (bool_2_U true))) (= Mask@0 (MapType1Store ZeroMask freshObj@0 value (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 value)) FullPerm))))) (and (= Mask@1 (MapType1Store Mask@0 freshObj@0 next (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@0 next)) FullPerm)))) (state Heap@0 Mask@1)))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 next)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 next))) (=> (and (= Heap@1 (MapType0Store Heap@0 freshObj@0 next freshObj@0)) (state Heap@1 Mask@1)) (and (and (=> (= (ControlFlow 0 13) 11) anon9_Else_correct) (=> (= (ControlFlow 0 13) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 13) 4) anon10_Else_correct)))))))))
