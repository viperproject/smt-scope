...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type AssertMask@4) (MapType1Type RefType realType)) (= (type x@@36) RefType)) (= (type Mask@7) (MapType1Type RefType realType))) (= (type Heap@4) (MapType0Type RefType))) (= (type AssertMask@2) (MapType1Type RefType realType))) (= (type AssertMask@3) (MapType1Type RefType realType))) (= (type AssertMask@1) (MapType1Type RefType realType))) (= (type AssertMask@0) (MapType1Type RefType realType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@17) (MapType0Type RefType))) (= (type Used_13Mask@3) (MapType1Type RefType realType))) (= (type Result_10Heap) (MapType0Type RefType))) (= (type Result_10Mask) (MapType1Type RefType realType))) (= (type Ops_13Mask) (MapType1Type RefType realType))) (= (type Ops_13Heap@0) (MapType0Type RefType))) (= (type Used_13Heap@0) (MapType0Type RefType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Used_13Mask@1) (MapType1Type RefType realType))) (= (type Used_13Mask@2) (MapType1Type RefType realType))) (= (type TempMask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Used_13Mask@0) (MapType1Type RefType realType))) (= (type TempMask@0) (MapType1Type RefType realType))) (= (type Ops_13Mask@0) (MapType1Type RefType realType))) (= (type Used_13Mask@7) (MapType1Type RefType realType))) (= (type Result_9Heap) (MapType0Type RefType))) (= (type Result_9Mask) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Heap@3) (MapType0Type RefType))) (= (type Used_13Mask@5) (MapType1Type RefType realType))) (= (type Used_13Mask@6) (MapType1Type RefType realType))) (= (type TempMask@3) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type newPMask@1) (MapType1Type RefType boolType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Used_13Mask@4) (MapType1Type RefType realType))) (= (type TempMask@2) (MapType1Type RefType realType))) (= (type Ops_13Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Used_12Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test03)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 73) (let ((anon49_correct true))
(let ((anon73_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon49_correct)))
(let ((anon73_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select AssertMask@4 null (T x@@36))))) (=> (<= FullPerm (U_2_real (MapType1Select AssertMask@4 null (T x@@36)))) (=> (= (ControlFlow 0 2) 1) anon49_correct))))))
(let ((anon47_correct  (=> (= AssertMask@4 (MapType1Store Mask@7 null (E x@@36) (real_2_U (- (U_2_real (MapType1Select Mask@7 null (E x@@36))) FullPerm)))) (and (=> (= (ControlFlow 0 5) 2) anon73_Then_correct) (=> (= (ControlFlow 0 5) 4) anon73_Else_correct)))))
(let ((anon72_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon47_correct)))
(let ((anon72_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@7 null (E x@@36))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@7 null (E x@@36)))) (=> (= (ControlFlow 0 6) 5) anon47_correct))))))
(let ((anon45_correct  (=> (state Heap@4 Mask@7) (and (=> (= (ControlFlow 0 9) 6) anon72_Then_correct) (=> (= (ControlFlow 0 9) 8) anon72_Else_correct)))))
(let ((anon41_correct  (=> (and (= AssertMask@3 (MapType1Store Mask@7 null (E x@@36) (real_2_U (- (U_2_real (MapType1Select Mask@7 null (E x@@36))) FullPerm)))) (= (ControlFlow 0 15) 9)) anon45_correct)))
(let ((anon70_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 18) 15)) anon41_correct)))
(let ((anon70_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= FullPerm (U_2_real (MapType1Select Mask@7 null (E x@@36))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@7 null (E x@@36)))) (=> (= (ControlFlow 0 16) 15) anon41_correct))))))
(let ((anon69_Then_correct  (=> (= i@@3 0) (and (=> (= (ControlFlow 0 19) 16) anon70_Then_correct) (=> (= (ControlFlow 0 19) 18) anon70_Else_correct)))))
(let ((anon44_correct  (=> (and (= AssertMask@2 (MapType1Store Mask@7 null (T x@@36) (real_2_U (- (U_2_real (MapType1Select Mask@7 null (T x@@36))) FullPerm)))) (= (ControlFlow 0 10) 9)) anon45_correct)))
(let ((anon71_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 10)) anon44_correct)))
(let ((anon71_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType1Select Mask@7 null (T x@@36))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@7 null (T x@@36)))) (=> (= (ControlFlow 0 11) 10) anon44_correct))))))
(let ((anon69_Else_correct  (=> (not (= i@@3 0)) (and (=> (= (ControlFlow 0 14) 11) anon71_Then_correct) (=> (= (ControlFlow 0 14) 13) anon71_Else_correct)))))
(let ((anon38_correct  (=> (state Heap@4 Mask@7) (and (=> (= (ControlFlow 0 20) 19) anon69_Then_correct) (=> (= (ControlFlow 0 20) 14) anon69_Else_correct)))))
(let ((anon37_correct  (=> (and (= AssertMask@1 (MapType1Store Mask@7 null (E x@@36) (real_2_U (- (U_2_real (MapType1Select Mask@7 null (E x@@36))) FullPerm)))) (= (ControlFlow 0 22) 20)) anon38_correct)))
(let ((anon68_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 25) 22)) anon37_correct)))
(let ((anon68_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (<= FullPerm (U_2_real (MapType1Select Mask@7 null (E x@@36))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@7 null (E x@@36)))) (=> (= (ControlFlow 0 23) 22) anon37_correct))))))
(let ((anon67_Then_correct  (=> (= i@@3 0) (and (=> (= (ControlFlow 0 26) 23) anon68_Then_correct) (=> (= (ControlFlow 0 26) 25) anon68_Else_correct)))))
(let ((anon67_Else_correct  (=> (and (not (= i@@3 0)) (= (ControlFlow 0 21) 20)) anon38_correct)))
(let ((anon34_correct  (=> (state Heap@4 Mask@7) (and (=> (= (ControlFlow 0 27) 26) anon67_Then_correct) (=> (= (ControlFlow 0 27) 21) anon67_Else_correct)))))
(let ((anon33_correct  (=> (and (= AssertMask@0 (MapType1Store Mask@7 null (T x@@36) (real_2_U (- (U_2_real (MapType1Select Mask@7 null (T x@@36))) FullPerm)))) (= (ControlFlow 0 29) 27)) anon34_correct)))
(let ((anon66_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 32) 29)) anon33_correct)))
(let ((anon66_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 30) (- 0 31)) (<= FullPerm (U_2_real (MapType1Select Mask@7 null (T x@@36))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@7 null (T x@@36)))) (=> (= (ControlFlow 0 30) 29) anon33_correct))))))
(let ((anon65_Then_correct  (=> (not (= i@@3 0)) (and (=> (= (ControlFlow 0 33) 30) anon66_Then_correct) (=> (= (ControlFlow 0 33) 32) anon66_Else_correct)))))
(let ((anon65_Else_correct  (=> (and (= i@@3 0) (= (ControlFlow 0 28) 27)) anon34_correct)))
(let ((anon30_correct  (=> (and (and (= Mask@7 (MapType1Store Mask@6 null (wand_5 true (= i@@3 0) x@@36 FullPerm x@@36 FullPerm) (real_2_U (+ (U_2_real (MapType1Select Mask@6 null (wand_5 true (= i@@3 0) x@@36 FullPerm x@@36 FullPerm))) FullPerm)))) (state Heap@4 Mask@7)) (and (state Heap@4 Mask@7) (state Heap@4 Mask@7))) (and (=> (= (ControlFlow 0 34) 33) anon65_Then_correct) (=> (= (ControlFlow 0 34) 28) anon65_Else_correct)))))
(let ((anon16_correct  (and (=> (= (ControlFlow 0 52) (- 0 53)) (=> (and (and b_28@2 b_28@2) b_29@12) (and (= neededTransfer@7 0.0) (= (U_2_real (MapType1Select Used_13Mask@7 null (T x@@36))) initNeededTransfer@0)))) (=> (=> (and (and b_28@2 b_28@2) b_29@12) (and (= neededTransfer@7 0.0) (= (U_2_real (MapType1Select Used_13Mask@7 null (T x@@36))) initNeededTransfer@0))) (=> (= b_30@0  (and b_28@2 b_29@12)) (=> (and (and (and (= b_30@1  (and b_30@0 (state Result_9Heap Result_9Mask))) (= b_30@2  (and b_30@1 (sumMask Result_9Mask Ops_13Mask Used_13Mask@7)))) (and (= b_30@3  (and (and b_30@2 (IdenticalOnKnownLocations Ops_13Heap@0 Result_9Heap Ops_13Mask)) (IdenticalOnKnownLocations Used_13Heap@0 Result_9Heap Used_13Mask@7))) (= b_30@4  (and b_30@3 (state Result_9Heap Result_9Mask))))) (and (and (= b_28@4  (and b_28@2 b_30@4)) (= Mask@6 Mask@5)) (and (= Heap@4 Heap@3) (= (ControlFlow 0 52) 34)))) anon30_correct))))))
(let ((anon58_Else_correct  (=> (>= 0.0 takeTransfer@3) (=> (and (= Mask@5 Mask@1) (= neededTransfer@7 neededTransfer@5)) (=> (and (and (= b_29@12 b_29@9) (= Used_13Mask@7 Used_13Mask@5)) (and (= Heap@3 Heap@@17) (= (ControlFlow 0 56) 52))) anon16_correct)))))
(let ((anon58_Then_correct  (=> (> takeTransfer@3 0.0) (=> (and (= neededTransfer@6 (- neededTransfer@5 takeTransfer@3)) (= Used_13Mask@6 (MapType1Store Used_13Mask@5 null (T x@@36) (real_2_U (+ (U_2_real (MapType1Select Used_13Mask@5 null (T x@@36))) takeTransfer@3))))) (=> (and (and (= b_29@10  (and b_29@9 (state Used_13Heap@0 Used_13Mask@6))) (= TempMask@3 (MapType1Store ZeroMask null (T x@@36) (real_2_U FullPerm)))) (and (= b_29@11  (and b_29@10 (IdenticalOnKnownLocations Heap@@17 Used_13Heap@0 TempMask@3))) (= Mask@4 (MapType1Store Mask@1 null (T x@@36) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (T x@@36))) takeTransfer@3)))))) (=> (and (and (and (forall ((o_11 T@U) (f_16 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_16))))
(let ((A@@12 (FieldTypeInv0 (type f_16))))
 (=> (and (and (= (type o_11) RefType) (= (type f_16) (FieldType A@@12 B@@12))) (or (U_2_bool (MapType1Select (MapType0Select Heap@@17 null (|wand_5#sm| true (= i@@3 0) x@@36 FullPerm x@@36 FullPerm)) o_11 f_16)) (U_2_bool (MapType1Select (MapType0Select Heap@@17 null (|T#sm| x@@36)) o_11 f_16)))) (U_2_bool (MapType1Select newPMask@1 o_11 f_16)))))
 :qid |stdinbpl.2235:39|
 :skolemid |107|
 :pattern ( (MapType1Select newPMask@1 o_11 f_16))
)) (= Heap@2 (MapType0Store Heap@@17 null (|wand_5#sm| true (= i@@3 0) x@@36 FullPerm x@@36 FullPerm) newPMask@1))) (and (= Mask@5 Mask@4) (= neededTransfer@7 neededTransfer@6))) (and (and (= b_29@12 b_29@11) (= Used_13Mask@7 Used_13Mask@6)) (and (= Heap@3 Heap@2) (= (ControlFlow 0 55) 52)))) anon16_correct))))))
(let ((anon57_Else_correct  (=> (and (< maskTransfer@3 neededTransfer@5) (= takeTransfer@3 maskTransfer@3)) (and (=> (= (ControlFlow 0 58) 55) anon58_Then_correct) (=> (= (ControlFlow 0 58) 56) anon58_Else_correct)))))
(let ((anon57_Then_correct  (=> (and (<= neededTransfer@5 maskTransfer@3) (= takeTransfer@3 neededTransfer@5)) (and (=> (= (ControlFlow 0 57) 55) anon58_Then_correct) (=> (= (ControlFlow 0 57) 56) anon58_Else_correct)))))
(let ((anon56_Then_correct  (=> (and (and (and (and (and b_28@2 b_28@2) b_29@9) true) (> neededTransfer@5 0.0)) (= maskTransfer@3 (U_2_real (MapType1Select Mask@1 null (T x@@36))))) (and (=> (= (ControlFlow 0 59) 57) anon57_Then_correct) (=> (= (ControlFlow 0 59) 58) anon57_Else_correct)))))
(let ((anon56_Else_correct  (=> (not (and (and (and (and b_28@2 b_28@2) b_29@9) true) (> neededTransfer@5 0.0))) (=> (and (= Mask@5 Mask@1) (= neededTransfer@7 neededTransfer@5)) (=> (and (and (= b_29@12 b_29@9) (= Used_13Mask@7 Used_13Mask@5)) (and (= Heap@3 Heap@@17) (= (ControlFlow 0 54) 52))) anon16_correct)))))
(let ((anon55_Else_correct  (=> (and (and (>= 0.0 takeTransfer@2) (= Used_13Mask@5 ZeroMask)) (and (= b_29@9 b_29@0) (= neededTransfer@5 FullPerm))) (and (=> (= (ControlFlow 0 62) 59) anon56_Then_correct) (=> (= (ControlFlow 0 62) 54) anon56_Else_correct)))))
(let ((anon55_Then_correct  (=> (and (> takeTransfer@2 0.0) (= neededTransfer@4 (- FullPerm takeTransfer@2))) (=> (and (and (and (= Used_13Mask@4 (MapType1Store ZeroMask null (T x@@36) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (T x@@36))) takeTransfer@2)))) (= b_29@7  (and b_29@0 (state Used_13Heap@0 Used_13Mask@4)))) (and (= TempMask@2 (MapType1Store ZeroMask null (T x@@36) (real_2_U FullPerm))) (= b_29@8  (and b_29@7 (IdenticalOnKnownLocations Ops_13Heap@0 Used_13Heap@0 TempMask@2))))) (and (and (= Ops_13Mask@1 (MapType1Store ZeroMask null (T x@@36) (real_2_U (- (U_2_real (MapType1Select ZeroMask null (T x@@36))) takeTransfer@2)))) (= Used_13Mask@5 Used_13Mask@4)) (and (= b_29@9 b_29@8) (= neededTransfer@5 neededTransfer@4)))) (and (=> (= (ControlFlow 0 61) 59) anon56_Then_correct) (=> (= (ControlFlow 0 61) 54) anon56_Else_correct))))))
(let ((anon54_Else_correct  (=> (and (< maskTransfer@2 FullPerm) (= takeTransfer@2 maskTransfer@2)) (and (=> (= (ControlFlow 0 64) 61) anon55_Then_correct) (=> (= (ControlFlow 0 64) 62) anon55_Else_correct)))))
(let ((anon54_Then_correct  (=> (and (<= FullPerm maskTransfer@2) (= takeTransfer@2 FullPerm)) (and (=> (= (ControlFlow 0 63) 61) anon55_Then_correct) (=> (= (ControlFlow 0 63) 62) anon55_Else_correct)))))
(let ((anon53_Then_correct  (=> (and (and (and (and (and b_28@2 b_28@2) b_29@0) true) (> FullPerm 0.0)) (= maskTransfer@2 (U_2_real (MapType1Select ZeroMask null (T x@@36))))) (and (=> (= (ControlFlow 0 65) 63) anon54_Then_correct) (=> (= (ControlFlow 0 65) 64) anon54_Else_correct)))))
(let ((anon53_Else_correct  (=> (and (and (not (and (and (and (and b_28@2 b_28@2) b_29@0) true) (> FullPerm 0.0))) (= Used_13Mask@5 ZeroMask)) (and (= b_29@9 b_29@0) (= neededTransfer@5 FullPerm))) (and (=> (= (ControlFlow 0 60) 59) anon56_Then_correct) (=> (= (ControlFlow 0 60) 54) anon56_Else_correct)))))
(let ((anon52_Then_correct  (=> (and (= i@@3 0) (= initNeededTransfer@0 (+ (U_2_real (MapType1Select ZeroMask null (T x@@36))) FullPerm))) (and (=> (= (ControlFlow 0 66) (- 0 67)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 66) 65) anon53_Then_correct) (=> (= (ControlFlow 0 66) 60) anon53_Else_correct)))))))
(let ((anon29_correct  (and (=> (= (ControlFlow 0 36) (- 0 37)) (=> (and (and b_28@2 b_28@2) b_29@6) (and (= neededTransfer@3 0.0) (= (U_2_real (MapType1Select Used_13Mask@3 null (E x@@36))) initNeededTransfer@1)))) (=> (=> (and (and b_28@2 b_28@2) b_29@6) (and (= neededTransfer@3 0.0) (= (U_2_real (MapType1Select Used_13Mask@3 null (E x@@36))) initNeededTransfer@1))) (=> (= b_31@0  (and b_28@2 b_29@6)) (=> (and (and (and (= b_31@1  (and b_31@0 (state Result_10Heap Result_10Mask))) (= b_31@2  (and b_31@1 (sumMask Result_10Mask Ops_13Mask Used_13Mask@3)))) (and (= b_31@3  (and (and b_31@2 (IdenticalOnKnownLocations Ops_13Heap@0 Result_10Heap Ops_13Mask)) (IdenticalOnKnownLocations Used_13Heap@0 Result_10Heap Used_13Mask@3))) (= b_31@4  (and b_31@3 (state Result_10Heap Result_10Mask))))) (and (and (= b_28@3  (and b_28@2 b_31@4)) (= Mask@6 Mask@3)) (and (= Heap@4 Heap@1) (= (ControlFlow 0 36) 34)))) anon30_correct))))))
(let ((anon64_Else_correct  (=> (>= 0.0 takeTransfer@1) (=> (and (= Mask@3 Mask@1) (= neededTransfer@3 neededTransfer@1)) (=> (and (and (= b_29@6 b_29@3) (= Used_13Mask@3 Used_13Mask@1)) (and (= Heap@1 Heap@@17) (= (ControlFlow 0 40) 36))) anon29_correct)))))
(let ((anon64_Then_correct  (=> (> takeTransfer@1 0.0) (=> (and (= neededTransfer@2 (- neededTransfer@1 takeTransfer@1)) (= Used_13Mask@2 (MapType1Store Used_13Mask@1 null (E x@@36) (real_2_U (+ (U_2_real (MapType1Select Used_13Mask@1 null (E x@@36))) takeTransfer@1))))) (=> (and (and (= b_29@4  (and b_29@3 (state Used_13Heap@0 Used_13Mask@2))) (= TempMask@1 (MapType1Store ZeroMask null (E x@@36) (real_2_U FullPerm)))) (and (= b_29@5  (and b_29@4 (IdenticalOnKnownLocations Heap@@17 Used_13Heap@0 TempMask@1))) (= Mask@2 (MapType1Store Mask@1 null (E x@@36) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (E x@@36))) takeTransfer@1)))))) (=> (and (and (and (forall ((o_12 T@U) (f_17 T@U) ) (! (let ((B@@13 (FieldTypeInv1 (type f_17))))
(let ((A@@13 (FieldTypeInv0 (type f_17))))
 (=> (and (and (= (type o_12) RefType) (= (type f_17) (FieldType A@@13 B@@13))) (or (U_2_bool (MapType1Select (MapType0Select Heap@@17 null (|wand_5#sm| true (= i@@3 0) x@@36 FullPerm x@@36 FullPerm)) o_12 f_17)) (U_2_bool (MapType1Select (MapType0Select Heap@@17 null (|E#sm| x@@36)) o_12 f_17)))) (U_2_bool (MapType1Select newPMask@0 o_12 f_17)))))
 :qid |stdinbpl.2301:39|
 :skolemid |108|
 :pattern ( (MapType1Select newPMask@0 o_12 f_17))
)) (= Heap@0 (MapType0Store Heap@@17 null (|wand_5#sm| true (= i@@3 0) x@@36 FullPerm x@@36 FullPerm) newPMask@0))) (and (= Mask@3 Mask@2) (= neededTransfer@3 neededTransfer@2))) (and (and (= b_29@6 b_29@5) (= Used_13Mask@3 Used_13Mask@2)) (and (= Heap@1 Heap@0) (= (ControlFlow 0 39) 36)))) anon29_correct))))))
(let ((anon63_Else_correct  (=> (and (< maskTransfer@1 neededTransfer@1) (= takeTransfer@1 maskTransfer@1)) (and (=> (= (ControlFlow 0 42) 39) anon64_Then_correct) (=> (= (ControlFlow 0 42) 40) anon64_Else_correct)))))
(let ((anon63_Then_correct  (=> (and (<= neededTransfer@1 maskTransfer@1) (= takeTransfer@1 neededTransfer@1)) (and (=> (= (ControlFlow 0 41) 39) anon64_Then_correct) (=> (= (ControlFlow 0 41) 40) anon64_Else_correct)))))
(let ((anon62_Then_correct  (=> (and (and (and (and (and b_28@2 b_28@2) b_29@3) true) (> neededTransfer@1 0.0)) (= maskTransfer@1 (U_2_real (MapType1Select Mask@1 null (E x@@36))))) (and (=> (= (ControlFlow 0 43) 41) anon63_Then_correct) (=> (= (ControlFlow 0 43) 42) anon63_Else_correct)))))
(let ((anon62_Else_correct  (=> (not (and (and (and (and b_28@2 b_28@2) b_29@3) true) (> neededTransfer@1 0.0))) (=> (and (= Mask@3 Mask@1) (= neededTransfer@3 neededTransfer@1)) (=> (and (and (= b_29@6 b_29@3) (= Used_13Mask@3 Used_13Mask@1)) (and (= Heap@1 Heap@@17) (= (ControlFlow 0 38) 36))) anon29_correct)))))
(let ((anon61_Else_correct  (=> (and (and (>= 0.0 takeTransfer@0) (= Used_13Mask@1 ZeroMask)) (and (= b_29@3 b_29@0) (= neededTransfer@1 FullPerm))) (and (=> (= (ControlFlow 0 46) 43) anon62_Then_correct) (=> (= (ControlFlow 0 46) 38) anon62_Else_correct)))))
(let ((anon61_Then_correct  (=> (and (> takeTransfer@0 0.0) (= neededTransfer@0 (- FullPerm takeTransfer@0))) (=> (and (and (and (= Used_13Mask@0 (MapType1Store ZeroMask null (E x@@36) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (E x@@36))) takeTransfer@0)))) (= b_29@1  (and b_29@0 (state Used_13Heap@0 Used_13Mask@0)))) (and (= TempMask@0 (MapType1Store ZeroMask null (E x@@36) (real_2_U FullPerm))) (= b_29@2  (and b_29@1 (IdenticalOnKnownLocations Ops_13Heap@0 Used_13Heap@0 TempMask@0))))) (and (and (= Ops_13Mask@0 (MapType1Store ZeroMask null (E x@@36) (real_2_U (- (U_2_real (MapType1Select ZeroMask null (E x@@36))) takeTransfer@0)))) (= Used_13Mask@1 Used_13Mask@0)) (and (= b_29@3 b_29@2) (= neededTransfer@1 neededTransfer@0)))) (and (=> (= (ControlFlow 0 45) 43) anon62_Then_correct) (=> (= (ControlFlow 0 45) 38) anon62_Else_correct))))))
(let ((anon60_Else_correct  (=> (and (< maskTransfer@0 FullPerm) (= takeTransfer@0 maskTransfer@0)) (and (=> (= (ControlFlow 0 48) 45) anon61_Then_correct) (=> (= (ControlFlow 0 48) 46) anon61_Else_correct)))))
(let ((anon60_Then_correct  (=> (and (<= FullPerm maskTransfer@0) (= takeTransfer@0 FullPerm)) (and (=> (= (ControlFlow 0 47) 45) anon61_Then_correct) (=> (= (ControlFlow 0 47) 46) anon61_Else_correct)))))
(let ((anon59_Then_correct  (=> (and (and (and (and (and b_28@2 b_28@2) b_29@0) true) (> FullPerm 0.0)) (= maskTransfer@0 (U_2_real (MapType1Select ZeroMask null (E x@@36))))) (and (=> (= (ControlFlow 0 49) 47) anon60_Then_correct) (=> (= (ControlFlow 0 49) 48) anon60_Else_correct)))))
(let ((anon59_Else_correct  (=> (and (and (not (and (and (and (and b_28@2 b_28@2) b_29@0) true) (> FullPerm 0.0))) (= Used_13Mask@1 ZeroMask)) (and (= b_29@3 b_29@0) (= neededTransfer@1 FullPerm))) (and (=> (= (ControlFlow 0 44) 43) anon62_Then_correct) (=> (= (ControlFlow 0 44) 38) anon62_Else_correct)))))
(let ((anon52_Else_correct  (=> (and (not (= i@@3 0)) (= initNeededTransfer@1 (+ (U_2_real (MapType1Select ZeroMask null (E x@@36))) FullPerm))) (and (=> (= (ControlFlow 0 50) (- 0 51)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 50) 49) anon59_Then_correct) (=> (= (ControlFlow 0 50) 44) anon59_Else_correct)))))))
(let ((anon51_Then_correct  (=> (and b_28@2 b_28@2) (and (=> (= (ControlFlow 0 68) 66) anon52_Then_correct) (=> (= (ControlFlow 0 68) 50) anon52_Else_correct)))))
(let ((anon51_Else_correct  (=> (and (and (not (and b_28@2 b_28@2)) (= Mask@6 Mask@1)) (and (= Heap@4 Heap@@17) (= (ControlFlow 0 35) 34))) anon30_correct)))
(let ((anon2_correct  (=> (= b_28@1  (and b_28@0 (state Ops_13Heap@0 ZeroMask))) (=> (and (= b_28@2  (and b_28@1 (state Ops_13Heap@0 ZeroMask))) (= b_29@0  (and b_29 (state Used_13Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 69) 68) anon51_Then_correct) (=> (= (ControlFlow 0 69) 35) anon51_Else_correct))))))
(let ((anon50_Else_correct  (=> (and (not b_28@0) (= (ControlFlow 0 71) 69)) anon2_correct)))
(let ((anon50_Then_correct  (=> (and b_28@0 (= (ControlFlow 0 70) 69)) anon2_correct)))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@17 x@@36 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (T x@@36) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (T x@@36))) FullPerm))))) (and (state Heap@@17 Mask@0) (= Mask@1 (MapType1Store Mask@0 null (E x@@36) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (E x@@36))) FullPerm)))))) (and (and (state Heap@@17 Mask@1) (state Heap@@17 Mask@1)) (and (= b_28@0  (and b_28 (state Ops_13Heap@0 ZeroMask))) (= b_27@0  (and b_27 (state Used_12Heap@0 ZeroMask)))))) (and (=> (= (ControlFlow 0 72) 70) anon50_Then_correct) (=> (= (ControlFlow 0 72) 71) anon50_Else_correct))))))
