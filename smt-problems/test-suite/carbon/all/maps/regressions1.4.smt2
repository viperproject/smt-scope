...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (forall ((i_1 T@U) ) (!  (=> (= (type i_1) intType) (=  (and (<= 0 (U_2_int i_1)) (< (U_2_int i_1) 4)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) i_1))))
 :qid |stdinbpl.539:20|
 :skolemid |103|
 :pattern ( (MapType0Select (|Map#Domain| m@@23) i_1))
)) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 3) (- 0 2))) (or (|Set#Equal| (|Map#Domain| m@@23) (|Set#UnionOne| (|Set#UnionOne| (|Set#Singleton| (int_2_U 2)) (int_2_U 1)) (int_2_U 0))) (not (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 3)))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
