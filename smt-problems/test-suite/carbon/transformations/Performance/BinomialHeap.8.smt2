...
(set-info :boogie-vc-id |treeKey#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon6_correct  (=> (and (state Heap@@61 UnfoldingMask@5) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm UnfoldingMask@5 this@@66 key))))
