...
(let ((anon3_correct  (=> (state Heap@@10 ZeroMask) (and (=> (= (ControlFlow 0 3) (- 0 4)) (not (= a_2 b_2))) (=> (not (= a_2 b_2)) (=> (and (state Heap@@10 ZeroMask) (= (ControlFlow 0 3) 1)) anon4_correct))))))
(let ((anon6_Else_correct  (=> (and (= b_2 null) (= (ControlFlow 0 7) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (not (= b_2 null)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (not (= a_2 b_2))) (=> (not (= a_2 b_2)) (=> (and (state Heap@@10 ZeroMask) (= (ControlFlow 0 5) 3)) anon3_correct))))))
...
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 a_2 $allocated)) (U_2_bool (MapType0Select Heap@@10 b_2 $allocated))) (and (=> (= (ControlFlow 0 9) 8) anon5_Then_correct) (=> (= (ControlFlow 0 9) 2) anon5_Else_correct))))))
