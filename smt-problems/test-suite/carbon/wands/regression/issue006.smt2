...
(assert  (and (and (and (and (and (= (type Ops_17Heap@0) (MapType0Type RefType)) (= (type Used_17Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@13) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Used_16Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test08a)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon2_correct  (=> (= b_27@3  (and b_27@2 (state Ops_17Heap@0 ZeroMask))) (=> (and (= b_27@4  (and b_27@3 (state Ops_17Heap@0 ZeroMask))) (= b_28@0  (and b_28 (state Used_17Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (and (and b_27@4 b_27@4) b_28@0) (atMost x_1@@0 y_1@@0))) (=> (=> (and (and b_27@4 b_27@4) b_28@0) (atMost x_1@@0 y_1@@0)) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (wand (< x_1@@0 y_1@@0) (atMost x_1@@0 y_1@@0)) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (wand (< x_1@@0 y_1@@0) (atMost x_1@@0 y_1@@0)))) FullPerm)))) (state Heap@@13 Mask@0)) (and (state Heap@@13 Mask@0) (state Heap@@13 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (wand (< x_1@@0 y_1@@0) (atMost x_1@@0 y_1@@0)))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (wand (< x_1@@0 y_1@@0) (atMost x_1@@0 y_1@@0))))) (=> (= Mask@1 (MapType1Store Mask@0 null (wand (< x_1@@0 y_1@@0) (atMost x_1@@0 y_1@@0)) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (wand (< x_1@@0 y_1@@0) (atMost x_1@@0 y_1@@0)))) FullPerm)))) (=> (and (state Heap@@13 Mask@1) (= (ControlFlow 0 2) (- 0 1))) (< x_1@@0 y_1@@0))))))))))))
(let ((anon3_Else_correct  (=> (not b_27@0) (=> (and (= b_27@2 b_27@0) (= (ControlFlow 0 6) 2)) anon2_correct))))
(let ((anon3_Then_correct  (=> (and (and b_27@0 (= b_27@1  (and b_27@0 (< x_1@@0 y_1@@0)))) (and (= b_27@2 b_27@1) (= (ControlFlow 0 5) 2))) anon2_correct)))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (= b_27@0  (and b_27 (state Ops_17Heap@0 ZeroMask))) (= b_26@0  (and b_26 (state Used_16Heap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 7) 5) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct)))))
