...
(declare-fun |funky'| (T@U T@U) Bool)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |funky#triggerStateless| (T@U) Bool)
...
(declare-fun |funky#frame| (T@U T@U) Bool)
...
(assert  (and (and (= (Ctor PredicateType_QType) 12) (= (Ctor FrameTypeType) 13)) (forall ((arg0@@28 T@U) (arg1@@12 Real) ) (! (= (type (Q arg0@@28 arg1@@12)) (FieldType PredicateType_QType FrameTypeType))
 :qid |funType:Q|
 :pattern ( (Q arg0@@28 arg1@@12))
))))
(assert (forall ((x@@8 T@U) (p_1 Real) ) (!  (=> (= (type x@@8) RefType) (IsPredicateField (Q x@@8 p_1)))
 :qid |stdinbpl.548:15|
 :skolemid |92|
 :pattern ( (Q x@@8 p_1))
)))
(assert (forall ((Heap@@0 T@U) (x@@9 T@U) (p_1@@0 Real) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type x@@9) RefType)) (|Q#everUsed| (Q x@@9 p_1@@0)))
 :qid |stdinbpl.567:15|
 :skolemid |96|
 :pattern ( (|Q#trigger| Heap@@0 (Q x@@9 p_1@@0)))
)))
...
(assert  (and (= (Ctor PredicateType_PType) 14) (forall ((arg0@@31 T@U) ) (! (= (type (P arg0@@31)) (FieldType PredicateType_PType FrameTypeType))
 :qid |funType:P|
 :pattern ( (P arg0@@31))
))))
(assert (forall ((x@@10 T@U) ) (!  (=> (= (type x@@10) RefType) (IsPredicateField (P x@@10)))
 :qid |stdinbpl.494:15|
 :skolemid |86|
 :pattern ( (P x@@10))
)))
(assert (forall ((Heap@@3 T@U) (x@@11 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type x@@11) RefType)) (dummyFunction (bool_2_U (|funky#triggerStateless| x@@11))))
 :qid |stdinbpl.443:15|
 :skolemid |83|
 :pattern ( (|funky'| Heap@@3 x@@11))
)))
(assert (forall ((Heap@@4 T@U) (x@@12 T@U) ) (!  (=> (and (= (type Heap@@4) (MapType0Type RefType)) (= (type x@@12) RefType)) (|P#everUsed| (P x@@12)))
 :qid |stdinbpl.513:15|
 :skolemid |90|
 :pattern ( (|P#trigger| Heap@@4 (P x@@12)))
)))
...
(assert  (and (and (and (and (and (and (and (forall ((arg0@@32 T@T) (arg1@@13 T@T) ) (! (= (Ctor (MapType2Type arg0@@32 arg1@@13)) 15)
...
))) (forall ((arg0@@35 T@U) (arg1@@16 T@U) ) (! (let ((aVar1@@2 (MapType2TypeInv1 (type arg0@@35))))
(= (type (MapType2Select arg0@@35 arg1@@16)) aVar1@@2))
 :qid |funType:MapType2Select|
 :pattern ( (MapType2Select arg0@@35 arg1@@16))
))) (forall ((arg0@@36 T@U) (arg1@@17 T@U) (arg2@@3 T@U) ) (! (let ((aVar1@@3 (type arg2@@3)))
(let ((aVar0@@1 (type arg1@@17)))
(= (type (MapType2Store arg0@@36 arg1@@17 arg2@@3)) (MapType2Type aVar0@@1 aVar1@@3))))
 :qid |funType:MapType2Store|
 :pattern ( (MapType2Store arg0@@36 arg1@@17 arg2@@3))
 ...
 :weight 0
)))) (forall ((arg0@@37 T@U) (arg1@@18 T@U) ) (! (let ((T@@4 (MapType2TypeInv0 (type arg0@@37))))
...
(assert (forall ((x@@13 T@U) (p_1@@1 Real) (x2 T@U) (p2 Real) ) (!  (=> (and (and (= (type x@@13) RefType) (= (type x2) RefType)) (= (Q x@@13 p_1@@1) (Q x2 p2))) (and (= x@@13 x2) (= p_1@@1 p2)))
 :qid |stdinbpl.558:15|
 :skolemid |94|
 :pattern ( (Q x@@13 p_1@@1) (Q x2 p2))
)))
(assert (forall ((arg0@@40 T@U) (arg1@@20 Real) ) (! (= (type (|Q#sm| arg0@@40 arg1@@20)) (FieldType PredicateType_QType (MapType1Type RefType boolType)))
 :qid |funType:Q#sm|
 :pattern ( (|Q#sm| arg0@@40 arg1@@20))
)))
(assert (forall ((x@@14 T@U) (p_1@@2 Real) (x2@@0 T@U) (p2@@0 Real) ) (!  (=> (and (and (= (type x@@14) RefType) (= (type x2@@0) RefType)) (= (|Q#sm| x@@14 p_1@@2) (|Q#sm| x2@@0 p2@@0))) (and (= x@@14 x2@@0) (= p_1@@2 p2@@0)))
 :qid |stdinbpl.562:15|
 :skolemid |95|
 :pattern ( (|Q#sm| x@@14 p_1@@2) (|Q#sm| x2@@0 p2@@0))
)))
(assert (forall ((x@@15 T@U) (x2@@1 T@U) ) (!  (=> (and (and (= (type x@@15) RefType) (= (type x2@@1) RefType)) (= (P x@@15) (P x2@@1))) (= x@@15 x2@@1))
 :qid |stdinbpl.504:15|
 :skolemid |88|
 :pattern ( (P x@@15) (P x2@@1))
)))
...
(assert (forall ((x@@16 T@U) (x2@@2 T@U) ) (!  (=> (and (and (= (type x@@16) RefType) (= (type x2@@2) RefType)) (= (|P#sm| x@@16) (|P#sm| x2@@2))) (= x@@16 x2@@2))
 :qid |stdinbpl.508:15|
 :skolemid |89|
 :pattern ( (|P#sm| x@@16) (|P#sm| x2@@2))
)))
...
(assert (forall ((Heap@@8 T@U) (Mask@@5 T@U) (x@@18 T@U) ) (!  (=> (and (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@5) (MapType1Type RefType realType))) (= (type x@@18) RefType)) (state Heap@@8 Mask@@5)) (= (|funky'| Heap@@8 x@@18) (|funky#frame| (ConditionalFrame (/ (to_real (- 0 1)) (to_real 2)) (FrameFragment (MapType0Select Heap@@8 x@@18 f_7))) x@@18)))
 :qid |stdinbpl.450:15|
 :skolemid |84|
 :pattern ( (state Heap@@8 Mask@@5) (|funky'| Heap@@8 x@@18))
)))
...
(assert (forall ((arg0@@46 T@U) (arg1@@23 T@U) ) (! (let ((T@@20 (MapType2TypeInv0 (type arg0@@46))))
(= (type (|Set#Difference| arg0@@46 arg1@@23)) (MapType2Type T@@20 boolType)))
...
(= (type (|Set#UnionOne| arg0@@47 arg1@@24)) (MapType2Type T@@24 boolType)))
 :qid |funType:Set#UnionOne|
 :pattern ( (|Set#UnionOne| arg0@@47 arg1@@24))
)))
(assert (forall ((a@@16 T@U) (x@@19 T@U) (y@@2 T@U) ) (! (let ((T@@25 (type x@@19)))
 (=> (and (and (= (type a@@16) (MapType2Type T@@25 boolType)) (= (type y@@2) T@@25)) (U_2_bool (MapType2Select a@@16 y@@2))) (U_2_bool (MapType2Select (|Set#UnionOne| a@@16 x@@19) y@@2))))
 :qid |stdinbpl.249:18|
 :skolemid |31|
 :pattern ( (|Set#UnionOne| a@@16 x@@19) (MapType2Select a@@16 y@@2))
)))
...
(assert (forall ((ms T@U) (x@@20 T@U) ) (! (let ((T@@28 (type x@@20)))
 (=> (= (type ms) (MultiSetType T@@28)) (>= (|MultiSet#Select| ms x@@20) 0)))
 :qid |stdinbpl.336:18|
 :skolemid |56|
 :pattern ( (|MultiSet#Select| ms x@@20))
)))
(assert (forall ((a@@19 T@U) (x@@21 T@U) (o@@5 T@U) ) (! (let ((T@@29 (type x@@21)))
 (=> (and (= (type a@@19) (MapType2Type T@@29 boolType)) (= (type o@@5) T@@29)) (= (U_2_bool (MapType2Select (|Set#UnionOne| a@@19 x@@21) o@@5))  (or (= o@@5 x@@21) (U_2_bool (MapType2Select a@@19 o@@5))))))
 :qid |stdinbpl.245:18|
 :skolemid |29|
 :pattern ( (MapType2Select (|Set#UnionOne| a@@19 x@@21) o@@5))
)))
...
(assert (forall ((Heap@@9 T@U) (x@@22 T@U) ) (!  (=> (and (= (type Heap@@9) (MapType0Type RefType)) (= (type x@@22) RefType)) (and (= (funky Heap@@9 x@@22) (|funky'| Heap@@9 x@@22)) (dummyFunction (bool_2_U (|funky#triggerStateless| x@@22)))))
 :qid |stdinbpl.439:15|
 :skolemid |82|
 :pattern ( (funky Heap@@9 x@@22))
)))
...
(assert (forall ((x@@23 T@U) (p_1@@3 Real) ) (!  (=> (= (type x@@23) RefType) (= (getPredWandId (Q x@@23 p_1@@3)) 1))
 :qid |stdinbpl.552:15|
 :skolemid |93|
 :pattern ( (Q x@@23 p_1@@3))
)))
(assert (forall ((a@@22 T@U) (x@@24 T@U) ) (! (let ((T@@36 (type x@@24)))
 (=> (= (type a@@22) (MapType2Type T@@36 boolType)) (U_2_bool (MapType2Select (|Set#UnionOne| a@@22 x@@24) x@@24))))
 :qid |stdinbpl.247:18|
 :skolemid |30|
 :pattern ( (|Set#UnionOne| a@@22 x@@24))
)))
...
(assert (forall ((a@@23 T@U) (x@@25 T@U) ) (! (let ((T@@37 (type x@@25)))
 (=> (and (= (type a@@23) (MapType2Type T@@37 boolType)) (U_2_bool (MapType2Select a@@23 x@@25))) (= (|Set#Card| (|Set#UnionOne| a@@23 x@@25)) (|Set#Card| a@@23))))
 :qid |stdinbpl.251:18|
 :skolemid |32|
 :pattern ( (|Set#Card| (|Set#UnionOne| a@@23 x@@25)))
)))
(assert (forall ((a@@24 T@U) (x@@26 T@U) ) (! (let ((T@@38 (type x@@26)))
 (=> (= (type a@@24) (MultiSetType T@@38)) (and (> (|MultiSet#Select| (|MultiSet#UnionOne| a@@24 x@@26) x@@26) 0) (> (|MultiSet#Card| (|MultiSet#UnionOne| a@@24 x@@26)) 0))))
 :qid |stdinbpl.363:18|
 :skolemid |66|
 :pattern ( (|MultiSet#UnionOne| a@@24 x@@26))
)))
(assert (forall ((x@@27 T@U) ) (!  (=> (= (type x@@27) RefType) (= (getPredWandId (P x@@27)) 0))
 :qid |stdinbpl.498:15|
 :skolemid |87|
 :pattern ( (P x@@27))
)))
...
(assert (forall ((x@@29 T@U) (p_1@@4 Real) ) (!  (=> (= (type x@@29) RefType) (= (PredicateMaskField (Q x@@29 p_1@@4)) (|Q#sm| x@@29 p_1@@4)))
 :qid |stdinbpl.544:15|
 :skolemid |91|
 :pattern ( (PredicateMaskField (Q x@@29 p_1@@4)))
)))
...
(assert (forall ((x@@30 T@U) ) (!  (=> (= (type x@@30) RefType) (= (PredicateMaskField (P x@@30)) (|P#sm| x@@30)))
 :qid |stdinbpl.490:15|
 :skolemid |85|
 :pattern ( (PredicateMaskField (P x@@30)))
)))
...
(assert (forall ((s@@2 T@U) ) (! (let ((T@@48 (MapType2TypeInv0 (type s@@2))))
 (=> (= (type s@@2) (MapType2Type T@@48 boolType)) (and (= (= (|Set#Card| s@@2) 0) (= s@@2 (|Set#Empty| T@@48))) (=> (not (= (|Set#Card| s@@2) 0)) (exists ((x@@31 T@U) ) (!  (and (= (type x@@31) T@@48) (U_2_bool (MapType2Select s@@2 x@@31)))
 :qid |stdinbpl.237:33|
 :skolemid |24|
 :no-pattern (type x@@31)
 :no-pattern (U_2_int x@@31)
 :no-pattern (U_2_bool x@@31)
))))))
 :qid |stdinbpl.235:18|
 :skolemid |25|
...
(assert (forall ((a@@32 T@U) (x@@32 T@U) ) (! (let ((T@@50 (type x@@32)))
 (=> (and (= (type a@@32) (MapType2Type T@@50 boolType)) (not (U_2_bool (MapType2Select a@@32 x@@32)))) (= (|Set#Card| (|Set#UnionOne| a@@32 x@@32)) (+ (|Set#Card| a@@32) 1))))
 :qid |stdinbpl.253:18|
 :skolemid |33|
 :pattern ( (|Set#Card| (|Set#UnionOne| a@@32 x@@32)))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((a@@35 T@U) (x@@33 T@U) (o@@14 T@U) ) (! (let ((T@@52 (type x@@33)))
 (=> (and (= (type a@@35) (MultiSetType T@@52)) (= (type o@@14) T@@52)) (= (|MultiSet#Select| (|MultiSet#UnionOne| a@@35 x@@33) o@@14) (ite (= x@@33 o@@14) (+ (|MultiSet#Select| a@@35 o@@14) 1) (|MultiSet#Select| a@@35 o@@14)))))
 :qid |stdinbpl.357:18|
 :skolemid |64|
 :pattern ( (|MultiSet#Select| (|MultiSet#UnionOne| a@@35 x@@33) o@@14))
 :pattern ( (|MultiSet#UnionOne| a@@35 x@@33) (|MultiSet#Select| a@@35 o@@14))
)))
...
(assert  (and (and (and (and (and (and (and (and (= (type ExhaleHeap@0) (MapType0Type RefType)) (= (type xs) (MapType2Type RefType boolType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv4 arg0@@48)) RefType)
 :qid |funType:invRecv4|
 :pattern ( (invRecv4 arg0@@48))
))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@49 T@U) ) (! (= (type (invRecv5 arg0@@49)) RefType)
 :qid |funType:invRecv5|
 :pattern ( (invRecv5 arg0@@49))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@50 T@U) ) (! (= (type (invRecv3 arg0@@50)) RefType)
 :qid |funType:invRecv3|
 :pattern ( (invRecv3 arg0@@50))
))) (= (type Heap@@14) (MapType0Type RefType))) (forall ((arg0@@51 T@U) ) (! (= (type (invRecv2 arg0@@51)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (U_2_bool (MapType2Select xs x_3))) (U_2_bool (MapType2Select xs x_3_1))) (< NoPerm p_1@@5)) (< NoPerm p_1@@5)) (not (= x_3 x_3_1))))
 :qid |stdinbpl.1065:21|
 :skolemid |112|
 :pattern ( (neverTriggered3 x_3) (neverTriggered3 x_3_1))
))) (=> (forall ((x_3@@0 T@U) (x_3_1@@0 T@U) ) (!  (=> (and (= (type x_3@@0) RefType) (= (type x_3_1@@0) RefType)) (=> (and (and (and (and (not (= x_3@@0 x_3_1@@0)) (U_2_bool (MapType2Select xs x_3@@0))) (U_2_bool (MapType2Select xs x_3_1@@0))) (< NoPerm p_1@@5)) (< NoPerm p_1@@5)) (not (= x_3@@0 x_3_1@@0))))
 :qid |stdinbpl.1065:21|
 :skolemid |112|
 :pattern ( (neverTriggered3 x_3@@0) (neverTriggered3 x_3_1@@0))
)) (=> (forall ((x_3@@1 T@U) ) (!  (=> (= (type x_3@@1) RefType) (=> (and (U_2_bool (MapType2Select xs x_3@@1)) (< NoPerm p_1@@5)) (and (= (invRecv3 x_3@@1) x_3@@1) (qpRange3 x_3@@1))))
 :qid |stdinbpl.1071:26|
 :skolemid |113|
 :pattern ( (MapType0Select ExhaleHeap@0 null (P x_3@@1)))
 :pattern ( (MapType1Select QPMask@0 null (P x_3@@1)))
 :pattern ( (MapType2Select xs x_3@@1))
)) (=> (and (forall ((x_4_1 T@U) ) (!  (=> (= (type x_4_1) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv3 x_4_1))) (< NoPerm p_1@@5)) (qpRange3 x_4_1)) (= (invRecv3 x_4_1) x_4_1)))
 :qid |stdinbpl.1075:26|
 :skolemid |114|
 :pattern ( (invRecv3 x_4_1))
)) (= (ControlFlow 0 12) (- 0 11))) (forall ((x_3@@2 T@U) ) (!  (=> (and (= (type x_3@@2) RefType) (U_2_bool (MapType2Select xs x_3@@2))) (>= p_1@@5 NoPerm))
 :qid |stdinbpl.1081:19|
 :skolemid |115|
 :pattern ( (MapType0Select ExhaleHeap@0 null (P x_3@@2)))
 :pattern ( (MapType1Select QPMask@0 null (P x_3@@2)))
 :pattern ( (MapType2Select xs x_3@@2))
))))))))
(let ((anon8_Then_correct true))
(let ((anon9_Else_correct true))
(let ((anon9_Then_correct  (=> (state ExhaleHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 6)) (forall ((x_6 T@U) (x_6_1 T@U) ) (!  (=> (and (= (type x_6) RefType) (= (type x_6_1) RefType)) (=> (and (and (and (and (not (= x_6 x_6_1)) (U_2_bool (MapType2Select xs x_6))) (U_2_bool (MapType2Select xs x_6_1))) (< NoPerm p_1@@5)) (< NoPerm p_1@@5)) (not (= x_6 x_6_1))))
 :qid |stdinbpl.1119:21|
 :skolemid |119|
 :pattern ( (neverTriggered4 x_6) (neverTriggered4 x_6_1))
))) (=> (forall ((x_6@@0 T@U) (x_6_1@@0 T@U) ) (!  (=> (and (= (type x_6@@0) RefType) (= (type x_6_1@@0) RefType)) (=> (and (and (and (and (not (= x_6@@0 x_6_1@@0)) (U_2_bool (MapType2Select xs x_6@@0))) (U_2_bool (MapType2Select xs x_6_1@@0))) (< NoPerm p_1@@5)) (< NoPerm p_1@@5)) (not (= x_6@@0 x_6_1@@0))))
 :qid |stdinbpl.1119:21|
 :skolemid |119|
 :pattern ( (neverTriggered4 x_6@@0) (neverTriggered4 x_6_1@@0))
)) (=> (and (forall ((x_6@@1 T@U) ) (!  (=> (= (type x_6@@1) RefType) (=> (and (U_2_bool (MapType2Select xs x_6@@1)) (< NoPerm p_1@@5)) (and (= (invRecv4 x_6@@1) x_6@@1) (qpRange4 x_6@@1))))
 :qid |stdinbpl.1125:26|
 :skolemid |120|
 :pattern ( (MapType0Select ExhaleHeap@0 null (P x_6@@1)))
 :pattern ( (MapType1Select ZeroMask null (P x_6@@1)))
 :pattern ( (MapType2Select xs x_6@@1))
)) (forall ((x_7_1 T@U) ) (!  (=> (= (type x_7_1) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv4 x_7_1))) (< NoPerm p_1@@5)) (qpRange4 x_7_1)) (= (invRecv4 x_7_1) x_7_1)))
 :qid |stdinbpl.1129:26|
 :skolemid |121|
 :pattern ( (invRecv4 x_7_1))
))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall ((x_6@@2 T@U) ) (!  (=> (and (= (type x_6@@2) RefType) (U_2_bool (MapType2Select xs x_6@@2))) (>= p_1@@5 NoPerm))
 :qid |stdinbpl.1135:19|
 :skolemid |122|
 :pattern ( (MapType0Select ExhaleHeap@0 null (P x_6@@2)))
 :pattern ( (MapType1Select ZeroMask null (P x_6@@2)))
 :pattern ( (MapType2Select xs x_6@@2))
))) (=> (forall ((x_6@@3 T@U) ) (!  (=> (and (= (type x_6@@3) RefType) (U_2_bool (MapType2Select xs x_6@@3))) (>= p_1@@5 NoPerm))
 :qid |stdinbpl.1135:19|
 :skolemid |122|
 :pattern ( (MapType0Select ExhaleHeap@0 null (P x_6@@3)))
 :pattern ( (MapType1Select ZeroMask null (P x_6@@3)))
 :pattern ( (MapType2Select xs x_6@@3))
)) (=> (and (forall ((x_7_1@@0 T@U) ) (!  (=> (= (type x_7_1@@0) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv4 x_7_1@@0))) (< NoPerm p_1@@5)) (qpRange4 x_7_1@@0)) (and (=> (< NoPerm p_1@@5) (= (invRecv4 x_7_1@@0) x_7_1@@0)) (= (U_2_real (MapType1Select QPMask@1 null (P x_7_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (P x_7_1@@0))) p_1@@5)))))
 :qid |stdinbpl.1141:26|
 :skolemid |123|
 :pattern ( (MapType1Select QPMask@1 null (P x_7_1@@0)))
)) (forall ((o_3 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (or (or (not (= o_3 null)) (not (IsPredicateField f_5))) (not (= (getPredWandId f_5) 0)))) (= (U_2_real (MapType1Select ZeroMask o_3 f_5)) (U_2_real (MapType1Select QPMask@1 o_3 f_5))))))
 :qid |stdinbpl.1147:33|
 :skolemid |124|
 :pattern ( (MapType1Select ZeroMask o_3 f_5))
 :pattern ( (MapType1Select QPMask@1 o_3 f_5))
))) (=> (and (and (forall ((x_7_1@@1 T@U) ) (!  (=> (and (= (type x_7_1@@1) RefType) (not (and (and (U_2_bool (MapType2Select xs (invRecv4 x_7_1@@1))) (< NoPerm p_1@@5)) (qpRange4 x_7_1@@1)))) (= (U_2_real (MapType1Select QPMask@1 null (P x_7_1@@1))) (U_2_real (MapType1Select ZeroMask null (P x_7_1@@1)))))
 :qid |stdinbpl.1151:26|
 :skolemid |125|
 :pattern ( (MapType1Select QPMask@1 null (P x_7_1@@1)))
)) (state ExhaleHeap@0 QPMask@1)) (and (state ExhaleHeap@0 QPMask@1) (state ExhaleHeap@0 QPMask@1))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((x_10_1 T@U) ) (!  (=> (= (type x_10_1) RefType) (=> (and (U_2_bool (MapType2Select xs (invRecv5 x_10_1))) (qpRange5 x_10_1)) (>= p_1@@5 NoPerm)))
 :qid |stdinbpl.1167:21|
 :skolemid |126|
 :pattern ( (invRecv5 x_10_1))
))) (=> (forall ((x_10_1@@0 T@U) ) (!  (=> (= (type x_10_1@@0) RefType) (=> (and (U_2_bool (MapType2Select xs (invRecv5 x_10_1@@0))) (qpRange5 x_10_1@@0)) (>= p_1@@5 NoPerm)))
 :qid |stdinbpl.1167:21|
 :skolemid |126|
 :pattern ( (invRecv5 x_10_1@@0))
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((x_9 T@U) (x_9_1 T@U) ) (!  (=> (and (= (type x_9) RefType) (= (type x_9_1) RefType)) (=> (and (and (and (and (not (= x_9 x_9_1)) (U_2_bool (MapType2Select xs x_9))) (U_2_bool (MapType2Select xs x_9_1))) (< NoPerm p_1@@5)) (< NoPerm p_1@@5)) (not (= x_9 x_9_1))))
 :qid |stdinbpl.1174:21|
 :skolemid |127|
 :pattern ( (neverTriggered5 x_9) (neverTriggered5 x_9_1))
))) (=> (forall ((x_9@@0 T@U) (x_9_1@@0 T@U) ) (!  (=> (and (= (type x_9@@0) RefType) (= (type x_9_1@@0) RefType)) (=> (and (and (and (and (not (= x_9@@0 x_9_1@@0)) (U_2_bool (MapType2Select xs x_9@@0))) (U_2_bool (MapType2Select xs x_9_1@@0))) (< NoPerm p_1@@5)) (< NoPerm p_1@@5)) (not (= x_9@@0 x_9_1@@0))))
 :qid |stdinbpl.1174:21|
 :skolemid |127|
 :pattern ( (neverTriggered5 x_9@@0) (neverTriggered5 x_9_1@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((x_9@@1 T@U) ) (!  (=> (and (= (type x_9@@1) RefType) (U_2_bool (MapType2Select xs x_9@@1))) (>= (U_2_real (MapType1Select QPMask@1 null (P x_9@@1))) p_1@@5))
 :qid |stdinbpl.1181:21|
 :skolemid |128|
 :pattern ( (MapType0Select ExhaleHeap@0 null (P x_9@@1)))
 :pattern ( (MapType1Select QPMask@1 null (P x_9@@1)))
 :pattern ( (MapType2Select xs x_9@@1))
)))))))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 14) (- 0 17)) (forall ((x_1_1 T@U) ) (!  (=> (= (type x_1_1) RefType) (=> (and (U_2_bool (MapType2Select xs (invRecv2 x_1_1))) (qpRange2 x_1_1)) (>= p_1@@5 NoPerm)))
 :qid |stdinbpl.1004:21|
 :skolemid |104|
 :pattern ( (invRecv2 x_1_1))
))) (=> (forall ((x_1_1@@0 T@U) ) (!  (=> (= (type x_1_1@@0) RefType) (=> (and (U_2_bool (MapType2Select xs (invRecv2 x_1_1@@0))) (qpRange2 x_1_1@@0)) (>= p_1@@5 NoPerm)))
 :qid |stdinbpl.1004:21|
 :skolemid |104|
 :pattern ( (invRecv2 x_1_1@@0))
)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (forall ((x@@34 T@U) (x_4 T@U) ) (!  (=> (and (= (type x@@34) RefType) (= (type x_4) RefType)) (=> (and (and (and (and (not (= x@@34 x_4)) (U_2_bool (MapType2Select xs x@@34))) (U_2_bool (MapType2Select xs x_4))) (< NoPerm p_1@@5)) (< NoPerm p_1@@5)) (not (= x@@34 x_4))))
 :qid |stdinbpl.1011:21|
 :skolemid |105|
 :pattern ( (neverTriggered2 x@@34) (neverTriggered2 x_4))
))) (=> (forall ((x@@35 T@U) (x_4@@0 T@U) ) (!  (=> (and (= (type x@@35) RefType) (= (type x_4@@0) RefType)) (=> (and (and (and (and (not (= x@@35 x_4@@0)) (U_2_bool (MapType2Select xs x@@35))) (U_2_bool (MapType2Select xs x_4@@0))) (< NoPerm p_1@@5)) (< NoPerm p_1@@5)) (not (= x@@35 x_4@@0))))
 :qid |stdinbpl.1011:21|
 :skolemid |105|
 :pattern ( (neverTriggered2 x@@35) (neverTriggered2 x_4@@0))
)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((x@@36 T@U) ) (!  (=> (and (= (type x@@36) RefType) (U_2_bool (MapType2Select xs x@@36))) (>= (U_2_real (MapType1Select ZeroMask null (P x@@36))) p_1@@5))
 :qid |stdinbpl.1018:21|
 :skolemid |106|
 :pattern ( (MapType0Select Heap@@14 null (P x@@36)))
 :pattern ( (MapType1Select ZeroMask null (P x@@36)))
 :pattern ( (MapType2Select xs x@@36))
))) (=> (forall ((x@@37 T@U) ) (!  (=> (and (= (type x@@37) RefType) (U_2_bool (MapType2Select xs x@@37))) (>= (U_2_real (MapType1Select ZeroMask null (P x@@37))) p_1@@5))
 :qid |stdinbpl.1018:21|
 :skolemid |106|
 :pattern ( (MapType0Select Heap@@14 null (P x@@37)))
 :pattern ( (MapType1Select ZeroMask null (P x@@37)))
 :pattern ( (MapType2Select xs x@@37))
)) (=> (and (forall ((x@@38 T@U) ) (!  (=> (= (type x@@38) RefType) (=> (and (U_2_bool (MapType2Select xs x@@38)) (< NoPerm p_1@@5)) (and (= (invRecv2 x@@38) x@@38) (qpRange2 x@@38))))
 :qid |stdinbpl.1024:26|
 :skolemid |107|
 :pattern ( (MapType0Select Heap@@14 null (P x@@38)))
 :pattern ( (MapType1Select ZeroMask null (P x@@38)))
 :pattern ( (MapType2Select xs x@@38))
)) (forall ((x_1_1@@1 T@U) ) (!  (=> (= (type x_1_1@@1) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv2 x_1_1@@1))) (< NoPerm p_1@@5)) (qpRange2 x_1_1@@1)) (= (invRecv2 x_1_1@@1) x_1_1@@1)))
 :qid |stdinbpl.1028:26|
 :skolemid |108|
 :pattern ( (invRecv2 x_1_1@@1))
))) (=> (and (and (forall ((x_1_1@@2 T@U) ) (!  (=> (= (type x_1_1@@2) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv2 x_1_1@@2))) (< NoPerm p_1@@5)) (qpRange2 x_1_1@@2)) (and (= (invRecv2 x_1_1@@2) x_1_1@@2) (= (U_2_real (MapType1Select QPMask@0 null (P x_1_1@@2))) (- (U_2_real (MapType1Select ZeroMask null (P x_1_1@@2))) p_1@@5)))))
 :qid |stdinbpl.1034:26|
 :skolemid |109|
 :pattern ( (MapType1Select QPMask@0 null (P x_1_1@@2)))
)) (forall ((x_1_1@@3 T@U) ) (!  (=> (and (= (type x_1_1@@3) RefType) (not (and (and (U_2_bool (MapType2Select xs (invRecv2 x_1_1@@3))) (< NoPerm p_1@@5)) (qpRange2 x_1_1@@3)))) (= (U_2_real (MapType1Select QPMask@0 null (P x_1_1@@3))) (U_2_real (MapType1Select ZeroMask null (P x_1_1@@3)))))
 :qid |stdinbpl.1038:26|
 :skolemid |110|
 :pattern ( (MapType1Select QPMask@0 null (P x_1_1@@3)))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 ...
 :qid |stdinbpl.1044:33|
 :skolemid |111|
 :pattern ( (MapType1Select ZeroMask o_3@@0 f_5@@0))
 :pattern ( (MapType1Select QPMask@0 o_3@@0 f_5@@0))
)) (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@0 QPMask@0))) (and (and (and (=> (= (ControlFlow 0 14) 2) anon9_Then_correct) (=> (= (ControlFlow 0 14) 8) anon9_Else_correct)) (=> (= (ControlFlow 0 14) 10) anon8_Then_correct)) (=> (= (ControlFlow 0 14) 12) anon8_Else_correct)))))))))))))
