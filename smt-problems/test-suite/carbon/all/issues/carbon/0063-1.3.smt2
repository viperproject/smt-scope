...
(assert  (and (and (and (= (type UnfoldingMask@0) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type this@@11) RefType)) (= (type Heap@@11) (MapType0Type RefType))))
(set-info :boogie-vc-id test1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon2_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (P this@@11) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P this@@11))) FullPerm)))) (=> (and (state Heap@@11 UnfoldingMask@0) (state Heap@@11 Mask@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 this@@11 x@@8)) (=> (HasDirectPerm Mask@0 this@@11 x@@8) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (MapType0Select Heap@@11 this@@11 x@@8)) 0))))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P this@@11))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P this@@11)))) (=> (= (ControlFlow 0 4) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@11 this@@11 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (P this@@11) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P this@@11))) FullPerm))))) (and (state Heap@@11 Mask@0) (not (= this@@11 null)))) (and (and (state Heap@@11 Mask@0) (state Heap@@11 Mask@0)) (and (|P#trigger| Heap@@11 (P this@@11)) (= (MapType0Select Heap@@11 null (P this@@11)) EmptyFrame)))) (and (=> (= (ControlFlow 0 7) 4) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct))))))
