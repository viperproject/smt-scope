(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 19:46:27
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/issues/carbon/0053.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(declare-fun TestP$%trigger ($Snap $Ref) Bool)
...
; [eval] (unfolding acc(TestP$(this), write) in this.Testx$ == old(this.Testx$))
(push) ; 3
(assert (TestP$%trigger ($Snap.first $t@5@01) this@2@01))
; [eval] this.Testx$ == old(this.Testx$)
; [eval] old(this.Testx$)
(check-sat)
; unknown
; [state consolidation]
