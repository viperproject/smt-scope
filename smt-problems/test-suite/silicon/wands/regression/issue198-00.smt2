(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:36:08
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/wands/regression/issue198.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(check-sat)
; unknown
; Create MagicWandSnapFunction for wand true --* acc(P(), 1 / 1)
(declare-const mwsf@1@01 $MWSF)
...
(check-sat)
; unknown
; Create MagicWandSnapFunction for wand true --* acc(P(), 1 / 1) && acc(P(), 1 / 1)
...
(check-sat)
; unknown
; Create MagicWandSnapFunction for wand true --* acc(P(), 2 / 1)
...
(check-sat)
; unknown
; Create MagicWandSnapFunction for wand true --* acc(P(), 1 / 1) && acc(Q(), 1 / 1)
