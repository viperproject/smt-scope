...
(let ((anon6_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2_2))) (= (ControlFlow 0 7) 2)) anon3_correct)))
(let ((anon6_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2_2)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (>= i2_2 0)) (=> (>= i2_2 0) (and (=> (= (ControlFlow 0 3) (- 0 5)) (< i2_2 (|Seq#Length| s@@17))) (=> (< i2_2 (|Seq#Length| s@@17)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm Mask@1 (|Seq#Index| s@@17 i2_2) f_7)) (=> (HasDirectPerm Mask@1 (|Seq#Index| s@@17 i2_2) f_7) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (> (|Seq#Length| s@@17) 2)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (< 0 (|Seq#Length| s@@17))) (=> (< 0 (|Seq#Length| s@@17)) (=> (not (= (|Seq#Index| s@@17 0) null)) (=> (and (= Mask@0 (MapType1Store ZeroMask (|Seq#Index| s@@17 0) f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask (|Seq#Index| s@@17 0) f_7)) FullPerm)))) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (< 1 (|Seq#Length| s@@17))) (=> (< 1 (|Seq#Length| s@@17)) (=> (and (and (not (= (|Seq#Index| s@@17 1) null)) (= Mask@1 (MapType1Store Mask@0 (|Seq#Index| s@@17 1) f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 (|Seq#Index| s@@17 1) f_7)) FullPerm))))) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1))) (and (and (=> (= (ControlFlow 0 8) 1) anon5_Else_correct) (=> (= (ControlFlow 0 8) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct))))))))))))
