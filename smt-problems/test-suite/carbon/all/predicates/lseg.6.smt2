...
(assert  (and (and (and (and (and (and (= (type Heap@@19) (MapType0Type RefType)) (= (type this@@14) RefType)) (= (type end@@14) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |lseg#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (= (MapType0Select Heap@@19 this@@14 next) end@@14) (=> (and (= Mask@3 Mask@1) (= (ControlFlow 0 5) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (not (= (MapType0Select Heap@@19 this@@14 next) end@@14)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@1 this@@14 next)) (=> (HasDirectPerm Mask@1 this@@14 next) (=> (not (= (MapType0Select Heap@@19 this@@14 next) null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 this@@14 next)) (=> (HasDirectPerm Mask@1 this@@14 next) (=> (and (and (= Mask@2 (MapType1Store Mask@1 null (lseg (MapType0Select Heap@@19 this@@14 next) end@@14) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (lseg (MapType0Select Heap@@19 this@@14 next) end@@14))) FullPerm)))) (state Heap@@19 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 2) 1))) anon2_correct)))))))))
(let ((anon0_correct  (=> (and (state Heap@@19 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@19 this@@14 $allocated)) (U_2_bool (MapType0Select Heap@@19 end@@14 $allocated))) (and (not (= this@@14 null)) (= Mask@0 (MapType1Store ZeroMask this@@14 value (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@14 value)) FullPerm)))))) (and (and (state Heap@@19 Mask@0) (not (= this@@14 null))) (and (= Mask@1 (MapType1Store Mask@0 this@@14 next (real_2_U (+ (U_2_real (MapType1Select Mask@0 this@@14 next)) FullPerm)))) (state Heap@@19 Mask@1)))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm Mask@1 this@@14 next)) (=> (HasDirectPerm Mask@1 this@@14 next) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))))
