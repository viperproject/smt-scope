...
(assert  (and (and (and (and (and (and (= (type UnfoldingMask@0) (MapType2Type RefType realType)) (= (type Mask@1) (MapType2Type RefType realType))) (= (type Heap@@18) (MapType1Type RefType))) (= (type this@@3) RefType)) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv1 arg0@@48)) RefType)
 :qid |funType:invRecv1|
 :pattern ( (invRecv1 arg0@@48))
))) (= (type Mask@0) (MapType2Type RefType realType))))
(set-info :boogie-vc-id |getField#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon2_correct  (=> (= UnfoldingMask@0 (MapType2Store Mask@1 null (inv (MapType1Select Heap@@18 this@@3 col)) (real_2_U (- (U_2_real (MapType2Select Mask@1 null (inv (MapType1Select Heap@@18 this@@3 col)))) FullPerm)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((x@@19 T@U) (x_1 T@U) ) (!  (=> (and (= (type x@@19) RefType) (= (type x_1) RefType)) (=> (and (and (and (and (not (= x@@19 x_1)) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@3 col) x@@19))) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@3 col) x_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@19 x_1))))
 :qid |stdinbpl.506:17|
 :skolemid |86|
...
))) (=> (forall ((x@@20 T@U) (x_1@@0 T@U) ) (!  (=> (and (= (type x@@20) RefType) (= (type x_1@@0) RefType)) (=> (and (and (and (and (not (= x@@20 x_1@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@3 col) x@@20))) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@3 col) x_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@20 x_1@@0))))
 :qid |stdinbpl.506:17|
 :skolemid |86|
...
)) (=> (forall ((x@@21 T@U) ) (!  (=> (= (type x@@21) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@3 col) x@@21)) (< NoPerm FullPerm)) (and (qpRange1 x@@21) (= (invRecv1 x@@21) x@@21))))
 :qid |stdinbpl.512:24|
 :skolemid |87|
 :pattern ( (MapType1Select Heap@@18 x@@21 fld))
 :pattern ( (MapType2Select QPMask@0 x@@21 fld))
 :pattern ( (MapType0Select (MapType1Select Heap@@18 this@@3 col) x@@21))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@3 col) (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.516:24|
 :skolemid |88|
 :pattern ( (invRecv1 o_3))
)) (forall ((x@@22 T@U) ) (!  (=> (and (= (type x@@22) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@3 col) x@@22))) (not (= x@@22 null)))
 :qid |stdinbpl.522:24|
 :skolemid |89|
 :pattern ( (MapType1Select Heap@@18 x@@22 fld))
 :pattern ( (MapType2Select QPMask@0 x@@22 fld))
 :pattern ( (MapType0Select (MapType1Select Heap@@18 this@@3 col) x@@22))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@3 col) (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@0) o_3@@0)) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 fld)) (+ (U_2_real (MapType2Select UnfoldingMask@0 o_3@@0 fld)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@3 col) (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 fld)) (U_2_real (MapType2Select UnfoldingMask@0 o_3@@0 fld))))))
 :qid |stdinbpl.528:24|
 :skolemid |90|
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 fld))) (= (U_2_real (MapType2Select UnfoldingMask@0 o_3@@1 f_5)) (U_2_real (MapType2Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.532:31|
 :skolemid |91|
 :pattern ( (MapType2Select UnfoldingMask@0 o_3@@1 f_5))
 :pattern ( (MapType2Select QPMask@0 o_3@@1 f_5))
))) (and (state Heap@@18 QPMask@0) (state Heap@@18 QPMask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm QPMask@0 this@@3 col)) (=> (HasDirectPerm QPMask@0 this@@3 col) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm QPMask@0 this@@3 fld))))))))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType2Select Mask@1 null (inv (MapType1Select Heap@@18 this@@3 col)))))) (=> (<= FullPerm (U_2_real (MapType2Select Mask@1 null (inv (MapType1Select Heap@@18 this@@3 col))))) (=> (= (ControlFlow 0 5) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@18 ZeroMask) (U_2_bool (MapType1Select Heap@@18 this@@3 $allocated))) (=> (and (and (= AssumeFunctionsAbove 0) (not (= this@@3 null))) (and (= Mask@0 (MapType2Store ZeroMask this@@3 col (real_2_U (+ (U_2_real (MapType2Select ZeroMask this@@3 col)) FullPerm)))) (state Heap@@18 Mask@0))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (HasDirectPerm Mask@0 this@@3 col)) (=> (HasDirectPerm Mask@0 this@@3 col) (=> (and (= Mask@1 (MapType2Store Mask@0 null (inv (MapType1Select Heap@@18 this@@3 col)) (real_2_U (+ (U_2_real (MapType2Select Mask@0 null (inv (MapType1Select Heap@@18 this@@3 col)))) FullPerm)))) (state Heap@@18 Mask@1)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm Mask@1 this@@3 col)) (=> (HasDirectPerm Mask@1 this@@3 col) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@3 col) this@@3)) (state Heap@@18 Mask@1)) (and (|inv#trigger| Heap@@18 (inv (MapType1Select Heap@@18 this@@3 col))) (= (MapType1Select Heap@@18 null (inv (MapType1Select Heap@@18 this@@3 col))) (FrameFragment (int_2_U (|inv#condqp1| Heap@@18 (MapType1Select Heap@@18 this@@3 col))))))) (and (=> (= (ControlFlow 0 8) 5) anon3_Then_correct) (=> (= (ControlFlow 0 8) 7) anon3_Else_correct))))))))))))
