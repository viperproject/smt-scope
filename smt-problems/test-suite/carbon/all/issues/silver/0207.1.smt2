...
(declare-fun value (T@U) Int)
(declare-fun isParent (T@U T@U) Bool)
(declare-fun left (T@U) T@U)
(declare-fun BSTDomainTypeType () T@T)
(declare-fun nullNode () T@U)
...
(assert  (and (and (= (Ctor BSTDomainTypeType) 6) (forall ((arg0@@11 T@U) ) (! (= (type (left arg0@@11)) BSTDomainTypeType)
 :qid |funType:left|
 :pattern ( (left arg0@@11))
))) (= (type nullNode) BSTDomainTypeType)))
(assert (forall ((t_2 T@U) (c_1 T@U) ) (!  (=> (and (and (= (type t_2) BSTDomainTypeType) (= (type c_1) BSTDomainTypeType)) (and (not (= t_2 nullNode)) (and (not (= c_1 nullNode)) (isParent (left t_2) c_1)))) (< (value c_1) (value t_2)))
 :qid |stdinbpl.217:15|
 :skolemid |23|
 :pattern ( (value t_2) (value c_1))
 :pattern ( (isParent (left t_2) c_1))
)))
(assert (forall ((arg0@@12 T@U) ) (! (= (type (right arg0@@12)) BSTDomainTypeType)
 :qid |funType:right|
 :pattern ( (right arg0@@12))
)))
(assert (forall ((t_2@@0 T@U) (c_1@@0 T@U) ) (!  (=> (and (and (= (type t_2@@0) BSTDomainTypeType) (= (type c_1@@0) BSTDomainTypeType)) (and (not (= t_2@@0 nullNode)) (and (not (= c_1@@0 nullNode)) (isParent (right t_2@@0) c_1@@0)))) (> (value c_1@@0) (value t_2@@0)))
 :qid |stdinbpl.223:15|
 :skolemid |24|
 :pattern ( (value t_2@@0) (value c_1@@0))
)))
(assert (forall ((t_2@@1 T@U) ) (!  (=> (= (type t_2@@1) BSTDomainTypeType) (isParent t_2@@1 t_2@@1))
 :qid |stdinbpl.229:15|
 :skolemid |25|
 :pattern ( (isParent t_2@@1 t_2@@1))
)))
(assert  (and (and (and (and (and (and (and (and (and (forall ((arg0@@13 T@T) ) (! (= (Ctor (MapType0Type arg0@@13)) 7)
 :qid |ctor:MapType0Type|
)) (forall ((arg0@@14 T@T) ) (! (= (MapType0TypeInv0 (MapType0Type arg0@@14)) arg0@@14)
 :qid |typeInv:MapType0TypeInv0|
 :pattern ( (MapType0Type arg0@@14))
))) (forall ((arg0@@15 T@T) (arg1 T@T) ) (! (= (Ctor (FieldType arg0@@15 arg1)) 8)
 :qid |ctor:FieldType|
))) (forall ((arg0@@16 T@T) (arg1@@0 T@T) ) (! (= (FieldTypeInv0 (FieldType arg0@@16 arg1@@0)) arg0@@16)
 :qid |typeInv:FieldTypeInv0|
 :pattern ( (FieldType arg0@@16 arg1@@0))
))) (forall ((arg0@@17 T@T) (arg1@@1 T@T) ) (! (= (FieldTypeInv1 (FieldType arg0@@17 arg1@@1)) arg1@@1)
...
(assert  (and (and (and (and (and (and (forall ((arg0@@20 T@T) (arg1@@4 T@T) ) (! (= (Ctor (MapType1Type arg0@@20 arg1@@4)) 10)
...
(assert (forall ((p_2 T@U) (c_1@@1 T@U) ) (!  (=> (and (and (= (type p_2) BSTDomainTypeType) (= (type c_1@@1) BSTDomainTypeType)) (isParent p_2 c_1@@1)) (and (isParent p_2 (left c_1@@1)) (isParent p_2 (right c_1@@1))))
 :qid |stdinbpl.241:15|
 :skolemid |27|
 :pattern ( (isParent p_2 (left c_1@@1)))
 :pattern ( (isParent p_2 (right c_1@@1)))
)))
...
(assert (forall ((p_2@@0 T@U) (c_1@@2 T@U) ) (!  (=> (and (and (= (type p_2@@0) BSTDomainTypeType) (= (type c_1@@2) BSTDomainTypeType)) (and (not (= p_2@@0 nullNode)) (and (isParent p_2@@0 c_1@@2) (> (value p_2@@0) (value c_1@@2))))) (and (not (= (left p_2@@0) nullNode)) (isParent (left p_2@@0) c_1@@2)))
 :qid |stdinbpl.247:15|
 :skolemid |28|
 :pattern ( (isParent (left p_2@@0) c_1@@2))
)))
...
(assert (forall ((t_2@@2 T@U) ) (!  (=> (= (type t_2@@2) BSTDomainTypeType) (and (isParent t_2@@2 (left t_2@@2)) (isParent t_2@@2 (right t_2@@2))))
 :qid |stdinbpl.235:15|
 :skolemid |26|
 :pattern ( (isParent t_2@@2 (left t_2@@2)))
 :pattern ( (isParent t_2@@2 (right t_2@@2)))
)))
...
(assert (forall ((t_2@@3 T@U) ) (!  (=> (and (= (type t_2@@3) BSTDomainTypeType) (not (= (left t_2@@3) nullNode))) (> (value t_2@@3) (value (left t_2@@3))))
 :qid |stdinbpl.211:15|
 :skolemid |22|
 :pattern ( (value t_2@@3) (value (left t_2@@3)))
)))
...
(assert  (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type t_2@@4) BSTDomainTypeType)) (= (type Heap@@9) (MapType0Type RefType))))
...
(let ((anon35_Else_correct  (=> (and (forall ((t1_1 T@U) ) (!  (=> (= (type t1_1) BSTDomainTypeType) (or (= t1_1 t_2@@4) (not (isParent t1_1 t_2@@4))))
 :qid |stdinbpl.314:20|
 :skolemid |29|
 :pattern ( (isParent t1_1 t_2@@4))
)) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 9) 8) anon36_Then_correct) (=> (= (ControlFlow 0 9) 3) anon36_Else_correct)))))
(let ((anon35_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (not (= t_2@@4 nullNode)) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 10) 1) anon35_Then_correct) (=> (= (ControlFlow 0 10) 9) anon35_Else_correct))))))
