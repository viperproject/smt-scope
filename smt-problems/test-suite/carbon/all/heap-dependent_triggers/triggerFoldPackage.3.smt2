...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@3) (MapType0Type RefType)) (= (type Heap@2) (MapType0Type RefType))) (= (type y@@7) RefType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type z@@0) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (forall ((arg0@@57 T@U) ) (! (= (type (FrameFragment arg0@@57)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@57))
))) (= (type ys) (MapType2Type RefType boolType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type xs) (MapType2Type RefType boolType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@58 T@U) ) (! (= (type (invRecv4 arg0@@58)) RefType)
 :qid |funType:invRecv4|
 :pattern ( (invRecv4 arg0@@58))
))) (forall ((arg0@@59 T@U) ) (! (= (type (invRecv3 arg0@@59)) RefType)
 :qid |funType:invRecv3|
 :pattern ( (invRecv3 arg0@@59))
))))
(set-info :boogie-vc-id m2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon10_correct  (=> (and (and (= Heap@3 (MapType0Store Heap@2 null (|p1#sm| y@@7) (MapType1Store (MapType0Select Heap@2 null (|p1#sm| y@@7)) y@@7 f_7 (bool_2_U true)))) (state Heap@3 Mask@2)) (and (state Heap@3 Mask@2) (= (ControlFlow 0 5) (- 0 4)))) (not (= y@@7 z@@0)))))
(let ((anon15_Else_correct  (=> (HasDirectPerm Mask@2 null (p1 y@@7)) (=> (and (= Heap@2 Heap@@10) (= (ControlFlow 0 7) 5)) anon10_correct))))
(let ((anon15_Then_correct  (=> (not (HasDirectPerm Mask@2 null (p1 y@@7))) (=> (and (and (= Heap@0 (MapType0Store Heap@@10 null (|p1#sm| y@@7) ZeroPMask)) (= Heap@1 (MapType0Store Heap@0 null (p1 y@@7) freshVersion@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 6) 5))) anon10_correct))))
(let ((anon8_correct  (=> (= Mask@1 (MapType1Store Mask@0 y@@7 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 y@@7 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (= (U_2_int (MapType0Select Heap@@10 y@@7 f_7)) 0)) (=> (= (U_2_int (MapType0Select Heap@@10 y@@7 f_7)) 0) (=> (= Mask@2 (MapType1Store Mask@1 null (p1 y@@7) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (p1 y@@7))) FullPerm)))) (=> (and (and (state Heap@@10 Mask@2) (state Heap@@10 Mask@2)) (and (|p1#trigger| Heap@@10 (p1 y@@7)) (= (MapType0Select Heap@@10 null (p1 y@@7)) (FrameFragment (MapType0Select Heap@@10 y@@7 f_7))))) (and (=> (= (ControlFlow 0 8) 6) anon15_Then_correct) (=> (= (ControlFlow 0 8) 7) anon15_Else_correct)))))))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 8)) anon8_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@0 y@@7 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 y@@7 f_7))) (=> (= (ControlFlow 0 10) 8) anon8_correct))))))
(let ((anon13_Else_correct  (=> (and (forall ((x_7 T@U) ) (!  (=> (and (= (type x_7) RefType) (U_2_bool (MapType2Select ys x_7))) (not (= x_7 z@@0)))
 :qid |stdinbpl.1290:20|
 :skolemid |156|
 :pattern ( (MapType0Select Heap@@10 null (p1 x_7)))
)) (state Heap@@10 QPMask@1)) (=> (and (and (state Heap@@10 QPMask@1) (not (U_2_bool (MapType2Select xs y@@7)))) (and (state Heap@@10 QPMask@1) (state Heap@@10 QPMask@1))) (=> (and (and (and (not (= y@@7 null)) (= Mask@0 (MapType1Store QPMask@1 y@@7 f_7 (real_2_U (+ (U_2_real (MapType1Select QPMask@1 y@@7 f_7)) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (and (state Heap@@10 Mask@0) (U_2_bool (MapType2Select ys y@@7))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm Mask@0 y@@7 f_7)) (=> (HasDirectPerm Mask@0 y@@7 f_7) (=> (= (U_2_int (MapType0Select Heap@@10 y@@7 f_7)) 0) (=> (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (=> (= (ControlFlow 0 13) 10) anon14_Then_correct) (=> (= (ControlFlow 0 13) 12) anon14_Else_correct)))))))))))
(let ((anon13_Then_correct true))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (U_2_bool (MapType2Select xs x_3))) (U_2_bool (MapType2Select xs x_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1))))
 :qid |stdinbpl.1249:17|
 :skolemid |150|
 :pattern ( (neverTriggered4 x_3) (neverTriggered4 x_3_1))
))) (=> (forall ((x_3@@0 T@U) (x_3_1@@0 T@U) ) (!  (=> (and (= (type x_3@@0) RefType) (= (type x_3_1@@0) RefType)) (=> (and (and (and (and (not (= x_3@@0 x_3_1@@0)) (U_2_bool (MapType2Select xs x_3@@0))) (U_2_bool (MapType2Select xs x_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3@@0 x_3_1@@0))))
 :qid |stdinbpl.1249:17|
 :skolemid |150|
 :pattern ( (neverTriggered4 x_3@@0) (neverTriggered4 x_3_1@@0))
)) (=> (and (and (and (forall ((x_3@@1 T@U) ) (!  (=> (= (type x_3@@1) RefType) (=> (and (U_2_bool (MapType2Select xs x_3@@1)) (< NoPerm FullPerm)) (and (= (invRecv4 x_3@@1) x_3@@1) (qpRange4 x_3@@1))))
 :qid |stdinbpl.1255:22|
 :skolemid |151|
 :pattern ( (MapType0Select Heap@@10 null (p1 x_3@@1)))
 :pattern ( (MapType1Select QPMask@0 null (p1 x_3@@1)))
 :pattern ( (MapType0Select Heap@@10 null (p1 x_3@@1)))
)) (forall ((x_4_1 T@U) ) (!  (=> (= (type x_4_1) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv4 x_4_1))) (< NoPerm FullPerm)) (qpRange4 x_4_1)) (= (invRecv4 x_4_1) x_4_1)))
 :qid |stdinbpl.1259:22|
 :skolemid |152|
 :pattern ( (invRecv4 x_4_1))
))) (and (forall ((x_4_1@@0 T@U) ) (!  (=> (= (type x_4_1@@0) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv4 x_4_1@@0))) (< NoPerm FullPerm)) (qpRange4 x_4_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 x_4_1@@0) x_4_1@@0)) (= (U_2_real (MapType1Select QPMask@1 null (p1 x_4_1@@0))) (+ (U_2_real (MapType1Select QPMask@0 null (p1 x_4_1@@0))) FullPerm)))))
 :qid |stdinbpl.1265:22|
 :skolemid |153|
 :pattern ( (MapType1Select QPMask@1 null (p1 x_4_1@@0)))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.1271:29|
 :skolemid |154|
 :pattern ( (MapType1Select QPMask@0 o_3 f_5))
 :pattern ( (MapType1Select QPMask@1 o_3 f_5))
)))) (and (and (forall ((x_4_1@@1 T@U) ) (!  (=> (and (= (type x_4_1@@1) RefType) (not (and (and (U_2_bool (MapType2Select xs (invRecv4 x_4_1@@1))) (< NoPerm FullPerm)) (qpRange4 x_4_1@@1)))) (= (U_2_real (MapType1Select QPMask@1 null (p1 x_4_1@@1))) (U_2_real (MapType1Select QPMask@0 null (p1 x_4_1@@1)))))
 :qid |stdinbpl.1275:22|
 :skolemid |155|
 :pattern ( (MapType1Select QPMask@1 null (p1 x_4_1@@1)))
)) (state Heap@@10 QPMask@1)) (and (state Heap@@10 QPMask@1) (state Heap@@10 QPMask@1)))) (and (=> (= (ControlFlow 0 15) 3) anon13_Then_correct) (=> (= (ControlFlow 0 15) 13) anon13_Else_correct)))))))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (= x_1 z@@0)) (= x_1_1 z@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (= x_1@@0 z@@0)) (= x_1_1@@0 z@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.1204:15|
 :skolemid |144|
...
)) (=> (and (and (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (= x_1@@1 z@@0) (< NoPerm FullPerm)) (and (qpRange3 x_1@@1) (= (invRecv3 x_1@@1) x_1@@1))))
 :qid |stdinbpl.1210:22|
 :skolemid |145|
 :pattern ( (MapType0Select Heap@@10 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (=> (and (and (= (invRecv3 o_3@@0) z@@0) (< NoPerm FullPerm)) (qpRange3 o_3@@0)) (= (invRecv3 o_3@@0) o_3@@0)))
 :qid |stdinbpl.1214:22|
 :skolemid |146|
 :pattern ( (invRecv3 o_3@@0))
))) (and (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (= x_1@@2 z@@0)) (not (= x_1@@2 null)))
 :qid |stdinbpl.1220:22|
 :skolemid |147|
 :pattern ( (MapType0Select Heap@@10 x_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@2 f_7))
)) (forall ((o_3@@1 T@U) ) (!  (=> (= (type o_3@@1) RefType) (and (=> (and (and (= (invRecv3 o_3@@1) z@@0) (< NoPerm FullPerm)) (qpRange3 o_3@@1)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_3@@1) o_3@@1)) (= (U_2_real (MapType1Select QPMask@0 o_3@@1 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@1 f_7)) FullPerm)))) (=> (not (and (and (= (invRecv3 o_3@@1) z@@0) (< NoPerm FullPerm)) (qpRange3 o_3@@1))) (= (U_2_real (MapType1Select QPMask@0 o_3@@1 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@1 f_7))))))
...
)) (state Heap@@10 QPMask@0)) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0)))) (and (=> (= (ControlFlow 0 17) 2) anon12_Then_correct) (=> (= (ControlFlow 0 17) 15) anon12_Else_correct)))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 z@@0 $allocated)) (U_2_bool (MapType0Select Heap@@10 y@@7 $allocated))) (and (=> (= (ControlFlow 0 19) 1) anon11_Then_correct) (=> (= (ControlFlow 0 19) 17) anon11_Else_correct))))))
