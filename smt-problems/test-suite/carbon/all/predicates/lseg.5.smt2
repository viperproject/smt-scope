...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 45) (let ((anon8_correct  (=> (and (= PostMask@1 (MapType1Store PostMask@0 null (lseg this@@14 null) (real_2_U (- (U_2_real (MapType1Select PostMask@0 null (lseg this@@14 null))) FullPerm)))) (= (ControlFlow 0 38) (- 0 37))) (< 0 (length PostHeap@0 this@@14 null)))))
(let ((anon29_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 41) 38)) anon8_correct)))
(let ((anon29_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 39) (- 0 40)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (lseg this@@14 null))))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (lseg this@@14 null)))) (=> (= (ControlFlow 0 39) 38) anon8_correct))))))
(let ((anon28_Else_correct true))
(let ((anon26_Else_correct  (=> (= (length PostHeap@0 this@@14 null) 1) (=> (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)) (and (and (=> (= (ControlFlow 0 42) 36) anon28_Else_correct) (=> (= (ControlFlow 0 42) 39) anon29_Then_correct)) (=> (= (ControlFlow 0 42) 41) anon29_Else_correct))))))
(let ((anon4_correct true))
(let ((anon27_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 35) 32)) anon4_correct)))
(let ((anon27_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 33) (- 0 34)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (lseg this@@14 null))))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (lseg this@@14 null)))) (=> (= (ControlFlow 0 33) 32) anon4_correct))))))
(let ((anon25_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (= PostMask@0 (MapType1Store ZeroMask null (lseg this@@14 null) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (lseg this@@14 null))) FullPerm)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (and (=> (= (ControlFlow 0 43) 42) anon26_Else_correct) (=> (= (ControlFlow 0 43) 33) anon27_Then_correct)) (=> (= (ControlFlow 0 43) 35) anon27_Else_correct))))))
(let ((anon24_correct  (=> (= Mask@7 (MapType1Store Mask@6 null (lseg this@@14 null) (real_2_U (- (U_2_real (MapType1Select Mask@6 null (lseg this@@14 null))) FullPerm)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (length Heap@8 this@@14 null) 1)) (=> (= (length Heap@8 this@@14 null) 1) (=> (= (ControlFlow 0 2) (- 0 1)) (= (get Heap@8 this@@14 0 null) val@@7)))))))
(let ((anon36_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 2)) anon24_correct)))
(let ((anon36_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@6 null (lseg this@@14 null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@6 null (lseg this@@14 null)))) (=> (= (ControlFlow 0 4) 2) anon24_correct))))))
(let ((anon22_correct  (=> (and (state Heap@8 Mask@6) (state Heap@8 Mask@6)) (and (=> (= (ControlFlow 0 7) 4) anon36_Then_correct) (=> (= (ControlFlow 0 7) 6) anon36_Else_correct)))))
(let ((anon35_Else_correct  (=> (= (MapType0Select Heap@6 this@@14 next) null) (=> (and (= Heap@8 Heap@6) (= (ControlFlow 0 9) 7)) anon22_correct))))
(let ((anon35_Then_correct  (=> (not (= (MapType0Select Heap@6 this@@14 next) null)) (=> (and (and (forall ((o_5 T@U) (f_9 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_9))))
(let ((A@@12 (FieldTypeInv0 (type f_9))))
 (=> (and (and (= (type o_5) RefType) (= (type f_9) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@6 null (|lseg#sm| this@@14 null)) o_5 f_9)) (U_2_bool (MapType1Select (MapType0Select Heap@6 null (|lseg#sm| (MapType0Select Heap@6 this@@14 next) null)) o_5 f_9)))) (U_2_bool (MapType1Select newPMask@0 o_5 f_9)))))
 :qid |stdinbpl.739:29|
 :skolemid |39|
 :pattern ( (MapType1Select newPMask@0 o_5 f_9))
)) (= Heap@7 (MapType0Store Heap@6 null (|lseg#sm| this@@14 null) newPMask@0))) (and (= Heap@8 Heap@7) (= (ControlFlow 0 8) 7))) anon22_correct))))
(let ((anon20_correct  (=> (and (= Heap@5 (MapType0Store Heap@4 null (|lseg#sm| this@@14 null) (MapType1Store (MapType0Select Heap@4 null (|lseg#sm| this@@14 null)) this@@14 value (bool_2_U true)))) (= Heap@6 (MapType0Store Heap@5 null (|lseg#sm| this@@14 null) (MapType1Store (MapType0Select Heap@5 null (|lseg#sm| this@@14 null)) this@@14 next (bool_2_U true))))) (and (=> (= (ControlFlow 0 10) 8) anon35_Then_correct) (=> (= (ControlFlow 0 10) 9) anon35_Else_correct)))))
(let ((anon34_Else_correct  (=> (HasDirectPerm Mask@6 null (lseg this@@14 null)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 12) 10)) anon20_correct))))
(let ((anon34_Then_correct  (=> (not (HasDirectPerm Mask@6 null (lseg this@@14 null))) (=> (and (and (= Heap@2 (MapType0Store Heap@1 null (|lseg#sm| this@@14 null) ZeroPMask)) (= Heap@3 (MapType0Store Heap@2 null (lseg this@@14 null) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 11) 10))) anon20_correct))))
(let ((anon18_correct  (=> (= Mask@6 (MapType1Store Mask@5 null (lseg this@@14 null) (real_2_U (+ (U_2_real (MapType1Select Mask@5 null (lseg this@@14 null))) FullPerm)))) (=> (and (and (state Heap@1 Mask@6) (state Heap@1 Mask@6)) (and (|lseg#trigger| Heap@1 (lseg this@@14 null)) (= (MapType0Select Heap@1 null (lseg this@@14 null)) (CombineFrames (FrameFragment (MapType0Select Heap@1 this@@14 value)) (CombineFrames (FrameFragment (MapType0Select Heap@1 this@@14 next)) (FrameFragment (ite (not (= (MapType0Select Heap@1 this@@14 next) null)) (MapType0Select Heap@1 null (lseg (MapType0Select Heap@1 this@@14 next) null)) EmptyFrame))))))) (and (=> (= (ControlFlow 0 13) 11) anon34_Then_correct) (=> (= (ControlFlow 0 13) 12) anon34_Else_correct))))))
(let ((anon17_correct  (=> (and (and (= Mask@4 (MapType1Store Mask@3 null (lseg (MapType0Select Heap@1 this@@14 next) null) (real_2_U (- (U_2_real (MapType1Select Mask@3 null (lseg (MapType0Select Heap@1 this@@14 next) null))) FullPerm)))) (InsidePredicate (lseg this@@14 null) (MapType0Select Heap@1 null (lseg this@@14 null)) (lseg (MapType0Select Heap@1 this@@14 next) null) (MapType0Select Heap@1 null (lseg (MapType0Select Heap@1 this@@14 next) null)))) (and (= Mask@5 Mask@4) (= (ControlFlow 0 15) 13))) anon18_correct)))
(let ((anon33_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 18) 15)) anon17_correct)))
(let ((anon33_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= FullPerm (U_2_real (MapType1Select Mask@3 null (lseg (MapType0Select Heap@1 this@@14 next) null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 null (lseg (MapType0Select Heap@1 this@@14 next) null)))) (=> (= (ControlFlow 0 16) 15) anon17_correct))))))
(let ((anon32_Then_correct  (=> (not (= (MapType0Select Heap@1 this@@14 next) null)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (not (= (MapType0Select Heap@1 this@@14 next) null))) (=> (not (= (MapType0Select Heap@1 this@@14 next) null)) (and (=> (= (ControlFlow 0 19) 16) anon33_Then_correct) (=> (= (ControlFlow 0 19) 18) anon33_Else_correct)))))))
(let ((anon32_Else_correct  (=> (= (MapType0Select Heap@1 this@@14 next) null) (=> (and (= Mask@5 Mask@3) (= (ControlFlow 0 14) 13)) anon18_correct))))
(let ((anon14_correct  (=> (= Mask@3 (MapType1Store Mask@2 this@@14 next (real_2_U (- (U_2_real (MapType1Select Mask@2 this@@14 next)) FullPerm)))) (and (=> (= (ControlFlow 0 21) 19) anon32_Then_correct) (=> (= (ControlFlow 0 21) 14) anon32_Else_correct)))))
(let ((anon31_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 24) 21)) anon14_correct)))
(let ((anon31_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (<= FullPerm (U_2_real (MapType1Select Mask@2 this@@14 next)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 this@@14 next))) (=> (= (ControlFlow 0 22) 21) anon14_correct))))))
(let ((anon12_correct  (=> (= Mask@2 (MapType1Store Mask@1 this@@14 value (real_2_U (- (U_2_real (MapType1Select Mask@1 this@@14 value)) FullPerm)))) (and (=> (= (ControlFlow 0 25) 22) anon31_Then_correct) (=> (= (ControlFlow 0 25) 24) anon31_Else_correct)))))
(let ((anon30_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 28) 25)) anon12_correct)))
(let ((anon30_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (<= FullPerm (U_2_real (MapType1Select Mask@1 this@@14 value)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 this@@14 value))) (=> (= (ControlFlow 0 26) 25) anon12_correct))))))
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 29) (- 0 31)) (= FullPerm (U_2_real (MapType1Select Mask@1 this@@14 next)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 this@@14 next))) (=> (and (= Heap@0 (MapType0Store Heap@@19 this@@14 next null)) (state Heap@0 Mask@1)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (= FullPerm (U_2_real (MapType1Select Mask@1 this@@14 value)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 this@@14 value))) (=> (and (= Heap@1 (MapType0Store Heap@0 this@@14 value (int_2_U val@@7))) (state Heap@1 Mask@1)) (and (=> (= (ControlFlow 0 29) 26) anon30_Then_correct) (=> (= (ControlFlow 0 29) 28) anon30_Else_correct))))))))))
(let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@19 this@@14 $allocated))) (=> (and (and (and (not (= this@@14 null)) (= Mask@0 (MapType1Store ZeroMask this@@14 next (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@14 next)) FullPerm))))) (and (state Heap@@19 Mask@0) (state Heap@@19 Mask@0))) (and (and (not (= this@@14 null)) (= Mask@1 (MapType1Store Mask@0 this@@14 value (real_2_U (+ (U_2_real (MapType1Select Mask@0 this@@14 value)) FullPerm))))) (and (state Heap@@19 Mask@1) (state Heap@@19 Mask@1)))) (and (=> (= (ControlFlow 0 44) 43) anon25_Then_correct) (=> (= (ControlFlow 0 44) 29) anon25_Else_correct)))))))
