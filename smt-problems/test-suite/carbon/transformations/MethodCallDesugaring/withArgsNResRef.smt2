...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= r1@0 (+ x@@8 y@@1)) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= x@@8 x@@8)) (=> (= x@@8 x@@8) (=> (= (ControlFlow 0 3) (- 0 2)) (= r1@0 (+ x@@8 y@@1)))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (>= x@@8 0)) (and (>= y@@1 0) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct)))))
