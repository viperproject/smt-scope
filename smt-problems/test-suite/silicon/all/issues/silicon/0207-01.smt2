(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 19:52:33
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/issues/silicon/0207.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (forall ((r@10@00 $Ref)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/all/issues/silicon/0207.vpr@15@7@15@91-aux|)))
(assert (forall ((r@10@00 $Ref)) (!
  (=>
    (and
      (Set_in r@10@00 ($SortWrappers.$SnapToSet<$Ref> ($Snap.first s@$)))
  ...
  :pattern (($FVF.loc_next ($FVF.lookup_next (sm@9@00 s@$ this@0@00) r@10@00) r@10@00))
  :qid |prog./silicon/silver/src/test/resources/all/issues/silicon/0207.vpr@15@7@15@91|)))
; [eval] |this.nodes|
(pop) ; 2
; Joined path conditions
(assert (forall ((r $Ref)) (!
