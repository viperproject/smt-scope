...
(declare-fun wset@@7 () T@U)
(declare-fun Heap@@10 () T@U)
(declare-fun QPMask@0 () T@U)
(declare-fun qpRange1 (T@U) Bool)
(declare-fun invRecv1 (T@U) T@U)
(declare-fun ref@@7 () T@U)
(assert  (and (and (and (and (= (type wset@@7) (MapType2Type RefType boolType)) (= (type Heap@@10) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@47 T@U) ) (! (= (type (invRecv1 arg0@@47)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((r_5 T@U) (r_5_1 T@U) ) (!  (=> (and (= (type r_5) RefType) (= (type r_5_1) RefType)) (=> (and (and (and (and (not (= r_5 r_5_1)) (U_2_bool (MapType2Select wset@@7 r_5))) (U_2_bool (MapType2Select wset@@7 r_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= r_5 r_5_1)) (not (= wset@@7 wset@@7)))))
 :qid |stdinbpl.520:17|
 :skolemid |96|
 :pattern ( (neverTriggered2 r_5) (neverTriggered2 r_5_1))
)))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((r_3 T@U) (r_3_1 T@U) ) (!  (=> (and (= (type r_3) RefType) (= (type r_3_1) RefType)) (=> (and (and (and (and (not (= r_3 r_3_1)) (U_2_bool (MapType2Select wset@@7 r_3))) (U_2_bool (MapType2Select wset@@7 r_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_3 r_3_1))))
 :qid |stdinbpl.479:15|
 :skolemid |90|
 :no-pattern (type r_3)
...
))) (=> (forall ((r_3@@0 T@U) (r_3_1@@0 T@U) ) (!  (=> (and (= (type r_3@@0) RefType) (= (type r_3_1@@0) RefType)) (=> (and (and (and (and (not (= r_3@@0 r_3_1@@0)) (U_2_bool (MapType2Select wset@@7 r_3@@0))) (U_2_bool (MapType2Select wset@@7 r_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_3@@0 r_3_1@@0))))
 :qid |stdinbpl.479:15|
 :skolemid |90|
...
)) (=> (and (forall ((r_3@@1 T@U) ) (!  (=> (= (type r_3@@1) RefType) (=> (and (U_2_bool (MapType2Select wset@@7 r_3@@1)) (< NoPerm FullPerm)) (and (qpRange1 r_3@@1) (= (invRecv1 r_3@@1) r_3@@1))))
 :qid |stdinbpl.485:22|
 :skolemid |91|
 :pattern ( (MapType0Select Heap@@10 r_3@@1 data))
 :pattern ( (MapType1Select QPMask@0 r_3@@1 data))
 :pattern ( (MapType2Select wset@@7 r_3@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select wset@@7 (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.489:22|
 :skolemid |92|
 :pattern ( (invRecv1 o_3))
))) (=> (and (and (forall ((r_3@@2 T@U) ) (!  (=> (and (= (type r_3@@2) RefType) (U_2_bool (MapType2Select wset@@7 r_3@@2))) (not (= r_3@@2 null)))
 :qid |stdinbpl.495:22|
 :skolemid |93|
 :pattern ( (MapType0Select Heap@@10 r_3@@2 data))
 :pattern ( (MapType1Select QPMask@0 r_3@@2 data))
 :pattern ( (MapType2Select wset@@7 r_3@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select wset@@7 (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 data)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 data)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select wset@@7 (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 data)) (U_2_real (MapType1Select ZeroMask o_3@@0 data))))))
 :qid |stdinbpl.501:22|
 :skolemid |94|
...
)) (state Heap@@10 QPMask@0))) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 ref@@7 $allocated))) (and (=> (= (ControlFlow 0 7) 1) anon5_Then_correct) (=> (= (ControlFlow 0 7) 5) anon5_Else_correct)))))
