...
(assert  (and (and (and (and (and (and (= (type UnfoldingMask@0) (MapType2Type RefType realType)) (= (type Mask@0) (MapType2Type RefType realType))) (= (type xs@@3) (MapType0Type RefType boolType))) (= (type Heap@@18) (MapType1Type RefType))) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv2 arg0@@48)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon2_correct  (=> (= UnfoldingMask@0 (MapType2Store Mask@0 null (inv xs@@3) (real_2_U (- (U_2_real (MapType2Select Mask@0 null (inv xs@@3))) FullPerm)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((x@@19 T@U) (x_1 T@U) ) (!  (=> (and (= (type x@@19) RefType) (= (type x_1) RefType)) (=> (and (and (and (and (not (= x@@19 x_1)) (U_2_bool (MapType0Select xs@@3 x@@19))) (U_2_bool (MapType0Select xs@@3 x_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@19 x_1))))
 :qid |stdinbpl.639:17|
 :skolemid |98|
...
)) (=> (and (and (and (forall ((x@@21 T@U) ) (!  (=> (= (type x@@21) RefType) (=> (and (U_2_bool (MapType0Select xs@@3 x@@21)) (< NoPerm FullPerm)) (and (qpRange2 x@@21) (= (invRecv2 x@@21) x@@21))))
 :qid |stdinbpl.645:24|
 :skolemid |99|
 :pattern ( (MapType1Select Heap@@18 x@@21 fld))
 :pattern ( (MapType2Select QPMask@0 x@@21 fld))
 :pattern ( (MapType0Select xs@@3 x@@21))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType0Select xs@@3 (invRecv2 o_3))) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.649:24|
 :skolemid |100|
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType0Select xs@@3 (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@0) o_3@@0)) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 fld)) (+ (U_2_real (MapType2Select UnfoldingMask@0 o_3@@0 fld)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select xs@@3 (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 fld)) (U_2_real (MapType2Select UnfoldingMask@0 o_3@@0 fld))))))
 :qid |stdinbpl.661:24|
 :skolemid |102|
...
)) (state Heap@@18 QPMask@0)) (and (state Heap@@18 QPMask@0) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm QPMask@0 y@@10 fld)))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType2Select Mask@0 null (inv xs@@3))))) (=> (<= FullPerm (U_2_real (MapType2Select Mask@0 null (inv xs@@3)))) (=> (= (ControlFlow 0 4) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@18 ZeroMask) (=> (and (and (and (U_2_bool (MapType1Select Heap@@18 y@@10 $allocated)) (= AssumeFunctionsAbove 1)) (and (= Mask@0 (MapType2Store ZeroMask null (inv xs@@3) (real_2_U (+ (U_2_real (MapType2Select ZeroMask null (inv xs@@3))) FullPerm)))) (state Heap@@18 Mask@0))) (and (and (U_2_bool (MapType0Select xs@@3 y@@10)) (state Heap@@18 Mask@0)) (and (|inv#trigger| Heap@@18 (inv xs@@3)) (= (MapType1Select Heap@@18 null (inv xs@@3)) (FrameFragment (int_2_U (|inv#condqp1| Heap@@18 xs@@3))))))) (and (=> (= (ControlFlow 0 7) 4) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct))))))
