...
(declare-fun Mask@0 () T@U)
(declare-fun current_thread_id () Int)
(assert  (and (and (and (and (and (and (and (and (= (type PostMask@1) (MapType1Type RefType realType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type diz@@169) RefType)) (= (type PostHeap@0) (MapType0Type RefType))) (= (type PostMask@2) (MapType1Type RefType realType))) (= (type Heap@@44) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id SubjectLock__lock)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon6_correct true))
(let ((anon16_Else_correct  (=> (not (= count@@5 0)) (=> (and (= PostMask@2 PostMask@0) (= (ControlFlow 0 4) 2)) anon6_correct))))
(let ((anon16_Then_correct  (=> (= count@@5 0) (=> (and (and (= PostMask@1 (MapType1Store PostMask@0 null (SubjectLock__inv diz@@169) (real_2_U (+ (U_2_real (MapType1Select PostMask@0 null (SubjectLock__inv diz@@169))) FullPerm)))) (state PostHeap@0 PostMask@1)) (and (= PostMask@2 PostMask@1) (= (ControlFlow 0 3) 2))) anon6_correct))))
(let ((anon15_Then_correct  (=> (and (and (state PostHeap@0 ZeroMask) (= PostMask@0 (MapType1Store ZeroMask null (SubjectLock__locked diz@@169 p_1@@98 (+ count@@5 1)) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (SubjectLock__locked diz@@169 p_1@@98 (+ count@@5 1)))) FullPerm))))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 5) 3) anon16_Then_correct) (=> (= (ControlFlow 0 5) 4) anon16_Else_correct)))))
(let ((anon15_Else_correct true))
(let ((anon3_correct  (=> (state Heap@@44 Mask@2) (and (=> (= (ControlFlow 0 6) 5) anon15_Then_correct) (=> (= (ControlFlow 0 6) 1) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (>= 0 count@@5) (and (=> (= (ControlFlow 0 8) (- 0 9)) (>= p_1@@98 NoPerm)) (=> (>= p_1@@98 NoPerm) (=> (and (and (= Mask@1 (MapType1Store ZeroMask null (SubjectLock__valid diz@@169) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (SubjectLock__valid diz@@169))) p_1@@98)))) (state Heap@@44 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 8) 6))) anon3_correct))))))
(let ((anon14_Then_correct  (=> (> count@@5 0) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (SubjectLock__locked diz@@169 p_1@@98 count@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (SubjectLock__locked diz@@169 p_1@@98 count@@5))) FullPerm)))) (state Heap@@44 Mask@0)) (and (= Mask@2 Mask@0) (= (ControlFlow 0 7) 6))) anon3_correct))))
(let ((anon0_correct  (=> (state Heap@@44 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@44 diz@@169 $allocated))) (=> (and (and (and (not (= diz@@169 null)) (state Heap@@44 ZeroMask)) (and (>= current_thread_id 0) (state Heap@@44 ZeroMask))) (and (and (>= count@@5 0) (state Heap@@44 ZeroMask)) (and (<= NoPerm p_1@@98) (state Heap@@44 ZeroMask)))) (and (=> (= (ControlFlow 0 10) 7) anon14_Then_correct) (=> (= (ControlFlow 0 10) 8) anon14_Else_correct)))))))
