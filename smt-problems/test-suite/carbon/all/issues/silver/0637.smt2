...
(assert  (and (= (type Heap@@9) (MapType0Type RefType)) (= (type x@@11) RefType)))
(set-info :boogie-vc-id test2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@11 $allocated))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm ZeroMask x@@11 f_7)) (=> (HasDirectPerm ZeroMask x@@11 f_7) (=> (= j_3@0 (U_2_int (MapType0Select Heap@@9 x@@11 f_7))) (=> (and (= perm@0 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@0 NoPerm))))))))
