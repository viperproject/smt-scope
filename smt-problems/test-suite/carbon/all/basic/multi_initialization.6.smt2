...
(assert  (and (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type x@@14) RefType)) (= (type Heap@@10) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type _target0@0) RefType)) (= (type _receiver0) RefType)) (= (type _target0) RefType)))
(set-info :boogie-vc-id test4)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 x@@14 n (real_2_U (- (U_2_real (MapType1Select Mask@0 x@@14 n)) FullPerm)))) (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@0 Mask@1)) (=> (and (and (state ExhaleHeap@0 Mask@1) (U_2_bool (MapType0Select ExhaleHeap@0 _target0@0 $allocated))) (and (state ExhaleHeap@0 Mask@1) (= (ControlFlow 0 2) (- 0 1)))) (= FullPerm (U_2_real (MapType1Select Mask@1 x@@14 n)))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@14 n)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@14 n))) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@10 x@@14 $allocated)) (not (= x@@14 null))) (and (= Mask@0 (MapType1Store ZeroMask x@@14 n (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@14 n)) FullPerm)))) (state Heap@@10 Mask@0))) (and (and (state Heap@@10 Mask@0) (U_2_bool (MapType0Select Heap@@10 _receiver0 $allocated))) (and (U_2_bool (MapType0Select Heap@@10 _target0 $allocated)) (state Heap@@10 Mask@0)))) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))
