...
(declare-fun |val'| (T@U T@U) T@U)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |val#triggerStateless| (T@U) T@U)
...
(declare-fun |val#frame| (T@U T@U) T@U)
...
(assert  (and (= (Ctor PredicateType_CellType) 13) (forall ((arg0@@29 T@U) ) (! (= (type (Cell arg0@@29)) (FieldType PredicateType_CellType FrameTypeType))
 :qid |funType:Cell|
...
(assert  (and (forall ((arg0@@30 T@U) (arg1@@11 T@U) ) (! (= (type (|val'| arg0@@30 arg1@@11)) (SeqType intType))
 :qid |funType:val'|
 :pattern ( (|val'| arg0@@30 arg1@@11))
)) (forall ((arg0@@31 T@U) ) (! (= (type (|val#triggerStateless| arg0@@31)) (SeqType intType))
 :qid |funType:val#triggerStateless|
 :pattern ( (|val#triggerStateless| arg0@@31))
))))
(assert (forall ((Heap@@2 T@U) (x@@9 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type x@@9) RefType)) (dummyFunction (|val#triggerStateless| x@@9)))
 :qid |stdinbpl.559:15|
 :skolemid |59|
 :pattern ( (|val'| Heap@@2 x@@9))
)))
...
(assert (forall ((arg0@@35 T@U) (arg1@@15 T@U) ) (! (= (type (val@@7 arg0@@35 arg1@@15)) (SeqType intType))
 :qid |funType:val|
 :pattern ( (val@@7 arg0@@35 arg1@@15))
)))
(assert (forall ((Heap@@5 T@U) (x@@12 T@U) ) (!  (=> (and (= (type Heap@@5) (MapType0Type RefType)) (= (type x@@12) RefType)) (and (= (val@@7 Heap@@5 x@@12) (|val'| Heap@@5 x@@12)) (dummyFunction (|val#triggerStateless| x@@12))))
 :qid |stdinbpl.555:15|
 :skolemid |58|
 :pattern ( (val@@7 Heap@@5 x@@12))
)))
...
(assert (forall ((x@@14 T@U) (x2 T@U) ) (!  (=> (and (and (= (type x@@14) RefType) (= (type x2) RefType)) (= (Cell x@@14) (Cell x2))) (= x@@14 x2))
 :qid |stdinbpl.664:15|
 :skolemid |65|
 :pattern ( (Cell x@@14) (Cell x2))
)))
(assert (forall ((arg0@@37 T@U) ) (! (= (type (|Cell#sm| arg0@@37)) (FieldType PredicateType_CellType (MapType1Type RefType boolType)))
 :qid |funType:Cell#sm|
 :pattern ( (|Cell#sm| arg0@@37))
)))
(assert (forall ((x@@15 T@U) (x2@@0 T@U) ) (!  (=> (and (and (= (type x@@15) RefType) (= (type x2@@0) RefType)) (= (|Cell#sm| x@@15) (|Cell#sm| x2@@0))) (= x@@15 x2@@0))
 :qid |stdinbpl.668:15|
 :skolemid |66|
 :pattern ( (|Cell#sm| x@@15) (|Cell#sm| x2@@0))
)))
...
(assert (forall ((x@@16 T@U) ) (!  (=> (= (type x@@16) RefType) (= (getPredWandId (Cell x@@16)) 0))
 :qid |stdinbpl.658:15|
 :skolemid |64|
 :pattern ( (Cell x@@16))
)))
...
(assert (forall ((arg0@@40 T@U) (arg1@@18 T@U) ) (! (= (type (|val#frame| arg0@@40 arg1@@18)) (SeqType intType))
 :qid |funType:val#frame|
 :pattern ( (|val#frame| arg0@@40 arg1@@18))
)))
(assert (forall ((Heap@@10 T@U) (Mask@@9 T@U) (x@@17 T@U) ) (!  (=> (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (= (type x@@17) RefType)) (state Heap@@10 Mask@@9)) (= (|val'| Heap@@10 x@@17) (|val#frame| (MapType0Select Heap@@10 null (Cell x@@17)) x@@17)))
 :qid |stdinbpl.572:15|
 :skolemid |61|
 :pattern ( (state Heap@@10 Mask@@9) (|val'| Heap@@10 x@@17))
)))
...
(assert (forall ((Heap@@12 T@U) (Mask@@10 T@U) (x@@18 T@U) ) (!  (=> (and (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type x@@18) RefType)) (and (state Heap@@12 Mask@@10) (< AssumeFunctionsAbove 0))) (= (val@@7 Heap@@12 x@@18) (ite (= x@@18 null) (|Seq#Empty| intType) (|Seq#Singleton| (MapType0Select Heap@@12 x@@18 v_2)))))
 :qid |stdinbpl.565:15|
 :skolemid |60|
 :pattern ( (state Heap@@12 Mask@@10) (val@@7 Heap@@12 x@@18))
 :pattern ( (state Heap@@12 Mask@@10) (|val#triggerStateless| x@@18) (|Cell#trigger| Heap@@12 (Cell x@@18)))
)))
...
(assert (forall ((x@@19 T@U) ) (!  (=> (= (type x@@19) RefType) (= (PredicateMaskField (Cell x@@19)) (|Cell#sm| x@@19)))
 :qid |stdinbpl.650:15|
 :skolemid |62|
 :pattern ( (PredicateMaskField (Cell x@@19)))
)))
...
(assert (forall ((s@@14 T@U) (x@@20 T@U) (i@@5 Int) ) (! (let ((T@@30 (type x@@20)))
 (=> (= (type s@@14) (SeqType T@@30)) (=> (and (and (<= 0 i@@5) (< i@@5 (|Seq#Length| s@@14))) (= (|Seq#Index| s@@14 i@@5) x@@20)) (|Seq#Contains| s@@14 x@@20))))
 :qid |stdinbpl.395:18|
 :skolemid |48|
...
(assert  (and (and (and (and (and (and (and (and (= (type x@@21) RefType) (= (type Heap@1) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@14) (MapType0Type RefType))) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (forall ((arg0@@41 T@U) ) (! (= (type (FrameFragment arg0@@41)) FrameTypeType)
...
(let ((anon8_correct  (=> (and (state Heap@1 Mask@0) (= (ControlFlow 0 3) 1)) anon9_correct)))
(let ((anon13_Else_correct  (=> (= x@@21 null) (=> (and (= Heap@1 Heap@@14) (= (ControlFlow 0 5) 3)) anon8_correct))))
(let ((anon13_Then_correct  (=> (and (and (not (= x@@21 null)) (= Heap@0 (MapType0Store Heap@@14 null (|Cell#sm| x@@21) (MapType1Store (MapType0Select Heap@@14 null (|Cell#sm| x@@21)) x@@21 v_2 (bool_2_U true))))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 4) 3))) anon8_correct)))
(let ((anon6_correct  (=> (state Heap@@14 UnfoldingMask@2) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm UnfoldingMask@2 x@@21 v_2)) (=> (HasDirectPerm UnfoldingMask@2 x@@21 v_2) (and (=> (= (ControlFlow 0 6) 4) anon13_Then_correct) (=> (= (ControlFlow 0 6) 5) anon13_Else_correct)))))))
(let ((anon12_Else_correct  (=> (= x@@21 null) (=> (and (= UnfoldingMask@2 UnfoldingMask@0) (= (ControlFlow 0 9) 6)) anon6_correct))))
(let ((anon12_Then_correct  (=> (and (not (= x@@21 null)) (not (= x@@21 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x@@21 v_2 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@21 v_2)) FullPerm)))) (state Heap@@14 UnfoldingMask@1)) (and (= UnfoldingMask@2 UnfoldingMask@1) (= (ControlFlow 0 8) 6))) anon6_correct))))
(let ((anon4_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (Cell x@@21) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (Cell x@@21))) FullPerm)))) (and (=> (= (ControlFlow 0 10) 8) anon12_Then_correct) (=> (= (ControlFlow 0 10) 9) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 10)) anon4_correct)))
(let ((anon11_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Cell x@@21))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Cell x@@21)))) (=> (= (ControlFlow 0 11) 10) anon4_correct))))))
(let ((anon10_Else_correct  (=> (not (= x@@21 null)) (=> (and (|Cell#trigger| Heap@@14 (Cell x@@21)) (= (MapType0Select Heap@@14 null (Cell x@@21)) (FrameFragment (ite (not (= x@@21 null)) (FrameFragment (MapType0Select Heap@@14 x@@21 v_2)) EmptyFrame)))) (and (=> (= (ControlFlow 0 14) 11) anon11_Then_correct) (=> (= (ControlFlow 0 14) 13) anon11_Else_correct))))))
(let ((anon10_Then_correct  (=> (and (= x@@21 null) (= (ControlFlow 0 2) 1)) anon9_correct)))
(let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (U_2_bool (MapType0Select Heap@@14 x@@21 $allocated))) (=> (and (and (= AssumeFunctionsAbove 0) (= Mask@0 (MapType1Store ZeroMask null (Cell x@@21) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Cell x@@21))) FullPerm))))) (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0))) (and (=> (= (ControlFlow 0 15) 2) anon10_Then_correct) (=> (= (ControlFlow 0 15) 14) anon10_Else_correct))))))
