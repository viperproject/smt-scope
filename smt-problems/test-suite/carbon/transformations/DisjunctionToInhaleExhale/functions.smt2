...
(assert (forall ((Heap@@8 T@U) (Mask@@5 T@U) (vari1@@3 Bool) ) (!  (=> (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@5) (MapType1Type RefType realType))) (and (state Heap@@8 Mask@@5) (< AssumeFunctionsAbove 0))) (NonDet1 Heap@@8 vari1@@3))
 :qid |stdinbpl.197:15|
 :skolemid |24|
 :pattern ( (state Heap@@8 Mask@@5) (NonDet1 Heap@@8 vari1@@3))
)))
(assert (forall ((Heap@@9 T@U) (Mask@@6 T@U) (b_2@@0 Bool) ) (!  (=> (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (and (state Heap@@9 Mask@@6) (< AssumeFunctionsAbove 1))) (func Heap@@9 b_2@@0))
 :qid |stdinbpl.295:15|
 :skolemid |32|
 :pattern ( (state Heap@@9 Mask@@6) (func Heap@@9 b_2@@0))
)))
