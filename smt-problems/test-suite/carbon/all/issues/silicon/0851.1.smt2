...
(assert  (and (and (forall ((arg0@@25 T@U) (arg1@@9 T@U) ) (! (= (type (CombineFrames arg0@@25 arg1@@9)) FrameTypeType)
...
))) (forall ((arg0@@27 Real) (arg1@@10 T@U) ) (! (= (type (ConditionalFrame arg0@@27 arg1@@10)) FrameTypeType)
 :qid |funType:ConditionalFrame|
 :pattern ( (ConditionalFrame arg0@@27 arg1@@10))
))))
(assert (forall ((Heap@@3 T@U) (Mask@@2 T@U) (x@@9 T@U) (b1@@0 Bool) (b2@@0 Bool) ) (!  (=> (and (and (and (= (type Heap@@3) (MapType0Type RefType)) (= (type Mask@@2) (MapType1Type RefType realType))) (= (type x@@9) RefType)) (state Heap@@3 Mask@@2)) (= (|fun01'| Heap@@3 x@@9 b1@@0 b2@@0) (|fun01#frame| (CombineFrames (FrameFragment (MapType0Select Heap@@3 x@@9 v_2)) (CombineFrames (ConditionalFrame (ite b1@@0 (/ (to_real 1) (to_real 3)) NoPerm) (FrameFragment (MapType0Select Heap@@3 x@@9 v_2))) (ConditionalFrame (ite b2@@0 (/ (to_real 1) (to_real 3)) NoPerm) (FrameFragment (MapType0Select Heap@@3 x@@9 v_2))))) x@@9 b1@@0 b2@@0)))
 :qid |stdinbpl.216:15|
 :skolemid |25|
 :pattern ( (state Heap@@3 Mask@@2) (|fun01'| Heap@@3 x@@9 b1@@0 b2@@0))
)))
(assert (forall ((Heap@@4 T@U) (Mask@@3 T@U) (x@@10 T@U) (b1@@1 Bool) (b2@@1 Bool) ) (!  (=> (and (and (and (= (type Heap@@4) (MapType0Type RefType)) (= (type Mask@@3) (MapType1Type RefType realType))) (= (type x@@10) RefType)) (and (state Heap@@4 Mask@@3) (< AssumeFunctionsAbove 0))) (= (fun01 Heap@@4 x@@10 b1@@1 b2@@1) (U_2_int (MapType0Select Heap@@4 x@@10 v_2))))
 :qid |stdinbpl.209:15|
 :skolemid |24|
 :pattern ( (state Heap@@4 Mask@@3) (fun01 Heap@@4 x@@10 b1@@1 b2@@1))
)))
...
(assert (forall ((Heap@@8 T@U) (x@@11 T@U) (b1@@2 Bool) (b2@@2 Bool) ) (!  (=> (and (= (type Heap@@8) (MapType0Type RefType)) (= (type x@@11) RefType)) (and (= (fun01 Heap@@8 x@@11 b1@@2 b2@@2) (|fun01'| Heap@@8 x@@11 b1@@2 b2@@2)) (dummyFunction (int_2_U (|fun01#triggerStateless| x@@11 b1@@2 b2@@2)))))
 :qid |stdinbpl.199:15|
 :skolemid |22|
 :pattern ( (fun01 Heap@@8 x@@11 b1@@2 b2@@2))
)))
...
(assert  (and (and (and (and (and (= (type Heap@0) (MapType0Type RefType)) (= (type x@@12) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@1) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@0) (MapType1Type RefType realType))) (= (type Heap@@13) (MapType0Type RefType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (= perm@2 NoPerm) (= (ControlFlow 0 7) 4)) anon7_correct)))
(let ((anon12_Then_correct  (=> (not (= perm@2 NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= perm@2 (U_2_real (MapType1Select ExhaleWellDef0Mask@1 x@@12 v_2)))) (=> (<= perm@2 (U_2_real (MapType1Select ExhaleWellDef0Mask@1 x@@12 v_2))) (=> (= (ControlFlow 0 5) 4) anon7_correct))))))
(let ((anon5_correct  (=> (and (= ExhaleWellDef0Mask@1 (MapType1Store ExhaleWellDef0Mask@0 x@@12 v_2 (real_2_U (- (U_2_real (MapType1Select ExhaleWellDef0Mask@0 x@@12 v_2)) perm@1)))) (= perm@2 (ite b1@@3 (/ (to_real 1) (to_real 3)) NoPerm))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (and (=> (= (ControlFlow 0 8) 5) anon12_Then_correct) (=> (= (ControlFlow 0 8) 7) anon12_Else_correct)))))))
(let ((anon11_Else_correct  (=> (and (= perm@1 NoPerm) (= (ControlFlow 0 12) 8)) anon5_correct)))
(let ((anon11_Then_correct  (=> (not (= perm@1 NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= perm@1 (U_2_real (MapType1Select ExhaleWellDef0Mask@0 x@@12 v_2)))) (=> (<= perm@1 (U_2_real (MapType1Select ExhaleWellDef0Mask@0 x@@12 v_2))) (=> (= (ControlFlow 0 10) 8) anon5_correct))))))
(let ((anon3_correct  (=> (and (= ExhaleWellDef0Mask@0 (MapType1Store Mask@0 x@@12 v_2 (real_2_U (- (U_2_real (MapType1Select Mask@0 x@@12 v_2)) perm@0)))) (= perm@1 (ite b2@@3 (/ (to_real 1) (to_real 3)) NoPerm))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (and (=> (= (ControlFlow 0 13) 10) anon11_Then_correct) (=> (= (ControlFlow 0 13) 12) anon11_Else_correct)))))))
(let ((anon10_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 17) 13)) anon3_correct)))
(let ((anon10_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= perm@0 (U_2_real (MapType1Select Mask@0 x@@12 v_2)))) (=> (<= perm@0 (U_2_real (MapType1Select Mask@0 x@@12 v_2))) (=> (= (ControlFlow 0 15) 13) anon3_correct))))))
(let ((anon9_Then_correct  (=> (= perm@0 (/ (to_real 1) (to_real 3))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 18) 15) anon10_Then_correct) (=> (= (ControlFlow 0 18) 17) anon10_Else_correct)))))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (fun01 Heap@0 x@@12 b2@@3 b1@@3) 4)) (=> (= (fun01 Heap@0 x@@12 b2@@3 b1@@3) 4) (=> (and (state Heap@0 Mask@0) (= (ControlFlow 0 2) (- 0 1))) false)))))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@13 x@@12 $allocated))) (=> (and (and (not (= x@@12 null)) (= Mask@0 (MapType1Store ZeroMask x@@12 v_2 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@12 v_2)) FullPerm))))) (and (state Heap@@13 Mask@0) (state Heap@@13 Mask@0))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (= FullPerm (U_2_real (MapType1Select Mask@0 x@@12 v_2)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 x@@12 v_2))) (=> (and (= Heap@0 (MapType0Store Heap@@13 x@@12 v_2 (int_2_U 4))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 20) 18) anon9_Then_correct) (=> (= (ControlFlow 0 20) 2) anon9_Else_correct))))))))))
