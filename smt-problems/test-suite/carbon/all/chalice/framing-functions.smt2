...
(let ((anon3_Then_correct  (=> (not (= (MapType0Select Heap@@14 this@@9 next) null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 this@@9 next)) (=> (HasDirectPerm Mask@1 this@@9 next) (=> (and (and (= Mask@2 (MapType1Store Mask@1 null (valid (MapType0Select Heap@@14 this@@9 next)) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (valid (MapType0Select Heap@@14 this@@9 next)))) FullPerm)))) (state Heap@@14 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 2) 1))) anon2_correct))))))
