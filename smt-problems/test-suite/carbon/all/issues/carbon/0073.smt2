...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type data) (FieldType NormalFieldType intType))) (= (type rds) (FieldType NormalFieldType intType))))
(assert (distinct $allocated data rds)
)
...
(assert  (not (IsPredicateField rds)))
(assert  (not (IsWandField rds)))
...
(assert  (and (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type this) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon2_correct  (=> (= Mask@2 (MapType1Store Mask@1 this data (real_2_U (- (U_2_real (MapType1Select Mask@1 this data)) FullPerm)))) (=> (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm Mask@2 this rds)) (=> (HasDirectPerm Mask@2 this rds) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= (U_2_int (MapType0Select ExhaleHeap@0 this rds)) 0)) (=> (>= (U_2_int (MapType0Select ExhaleHeap@0 this rds)) 0) (=> (state ExhaleHeap@0 Mask@2) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@2 this rds)) (=> (HasDirectPerm Mask@2 this rds) (=> (= (ControlFlow 0 2) (- 0 1)) (< NoPerm (* (to_real (U_2_int (MapType0Select ExhaleHeap@0 this rds))) I))))))))))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@1 this data)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 this data))) (=> (= (ControlFlow 0 6) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 this $allocated)) (not (= this null))) (and (= Mask@0 (MapType1Store ZeroMask this rds (real_2_U (+ (U_2_real (MapType1Select ZeroMask this rds)) FullPerm)))) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 9) (- 0 13)) (HasDirectPerm Mask@0 this rds)) (=> (HasDirectPerm Mask@0 this rds) (=> (and (and (>= (U_2_int (MapType0Select Heap@@9 this rds)) 0) (not (= this null))) (and (= Mask@1 (MapType1Store Mask@0 this data (real_2_U (+ (U_2_real (MapType1Select Mask@0 this data)) FullPerm)))) (state Heap@@9 Mask@1))) (and (=> (= (ControlFlow 0 9) (- 0 12)) (HasDirectPerm Mask@1 this rds)) (=> (HasDirectPerm Mask@1 this rds) (=> (< NoPerm (* (to_real (U_2_int (MapType0Select Heap@@9 this rds))) I)) (=> (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (HasDirectPerm Mask@1 this rds)) (=> (HasDirectPerm Mask@1 this rds) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< NoPerm (* (to_real (U_2_int (MapType0Select Heap@@9 this rds))) I))) (=> (< NoPerm (* (to_real (U_2_int (MapType0Select Heap@@9 this rds))) I)) (=> (state Heap@@9 Mask@1) (and (=> (= (ControlFlow 0 9) 6) anon3_Then_correct) (=> (= (ControlFlow 0 9) 8) anon3_Else_correct))))))))))))))))))
