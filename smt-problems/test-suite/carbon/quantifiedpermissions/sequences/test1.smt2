...
(declare-fun i1 () Int)
(declare-fun i2 () Int)
(assert  (and (and (= (type nodes) (SeqType RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id Bug)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 30) (let ((anon11_correct true))
(let ((anon18_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| nodes) 1)) (int_2_U i_2))) (= (ControlFlow 0 25) 18)) anon11_correct)))
(let ((anon18_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| nodes) 1)) (int_2_U i_2)) (and (=> (= (ControlFlow 0 19) (- 0 24)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 19) (- 0 23)) (< i_2 (|Seq#Length| nodes))) (=> (< i_2 (|Seq#Length| nodes)) (and (=> (= (ControlFlow 0 19) (- 0 22)) (HasDirectPerm QPMask@0 (|Seq#Index| nodes i_2) next)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| nodes i_2) next) (and (=> (= (ControlFlow 0 19) (- 0 21)) (>= (+ i_2 1) 0)) (=> (>= (+ i_2 1) 0) (and (=> (= (ControlFlow 0 19) (- 0 20)) (< (+ i_2 1) (|Seq#Length| nodes))) (=> (< (+ i_2 1) (|Seq#Length| nodes)) (=> (= (ControlFlow 0 19) 18) anon11_correct))))))))))))))
(let ((anon17_Else_correct  (=> (and (forall ((i_3 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| nodes) 1)) (int_2_U i_3)) (= (MapType0Select Heap@@9 (|Seq#Index| nodes i_3) next) (|Seq#Index| nodes (+ i_3 1))))
 :qid |stdinbpl.668:20|
 :skolemid |65|
 :pattern ( (|Seq#Index| nodes i_3))
)) (state Heap@@9 QPMask@0)) (and (=> (= (ControlFlow 0 14) (- 0 17)) (< 0 (|Seq#Length| nodes))) (=> (< 0 (|Seq#Length| nodes)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (HasDirectPerm QPMask@0 (|Seq#Index| nodes 0) next)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| nodes 0) next) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< 1 (|Seq#Length| nodes))) (=> (< 1 (|Seq#Length| nodes)) (=> (= (ControlFlow 0 14) (- 0 13)) (= (MapType0Select Heap@@9 (|Seq#Index| nodes 0) next) (|Seq#Index| nodes 1))))))))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| nodes i_1) (|Seq#Index| nodes i_1_1))))
 :qid |stdinbpl.618:15|
 :skolemid |59|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i_1@@0))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| nodes i_1@@0) (|Seq#Index| nodes i_1_1@@0))))
 :qid |stdinbpl.618:15|
 :skolemid |59|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index| nodes i_1@@1)) (= (invRecv1 (|Seq#Index| nodes i_1@@1)) i_1@@1)))
 :qid |stdinbpl.624:22|
 :skolemid |60|
 :pattern ( (|Seq#Index| nodes i_1@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i_1@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i_1@@1)))
 :pattern ( (|Seq#Index| nodes i_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (|Seq#Index| nodes (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.628:22|
 :skolemid |61|
 :pattern ( (invRecv1 o_3))
)) (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i_1@@2)) (not (= (|Seq#Index| nodes i_1@@2) null)))
 :qid |stdinbpl.634:22|
 :skolemid |62|
 :pattern ( (|Seq#Index| nodes i_1@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i_1@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i_1@@2)))
 :pattern ( (|Seq#Index| nodes i_1@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| nodes (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 next)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (U_2_real (MapType1Select ZeroMask o_3@@0 next))))))
 :qid |stdinbpl.640:22|
 :skolemid |63|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 26) 14) anon17_Else_correct) (=> (= (ControlFlow 0 26) 19) anon18_Then_correct)) (=> (= (ControlFlow 0 26) 25) anon18_Else_correct)))))))))
(let ((anon7_correct true))
(let ((anon16_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i@@6))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon16_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i@@6)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i@@6 (|Seq#Length| nodes))) (=> (< i@@6 (|Seq#Length| nodes)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon13_Else_correct  (=> (and (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i1_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i2_1)) (not (= i1_1 i2_1)))) (not (= (|Seq#Index| nodes i1_1) (|Seq#Index| nodes i2_1))))
 :qid |stdinbpl.600:20|
 :skolemid |58|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i1_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i2_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i1_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i2_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i1_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i2_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i1_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i2_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i1_1)) (|Seq#Index| nodes i2_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i1_1)) (|Seq#Index| nodes i2_1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i2_1)) (|Seq#Index| nodes i1_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i2_1)) (|Seq#Index| nodes i1_1))
 :pattern ( (|Seq#Index| nodes i1_1) (|Seq#Index| nodes i2_1))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 28) 26) anon15_Else_correct) (=> (= (ControlFlow 0 28) 9) anon16_Then_correct)) (=> (= (ControlFlow 0 28) 12) anon16_Else_correct)))))
(let ((anon3_correct true))
(let ((anon14_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i2)) (not (= i1 i2))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon14_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| nodes)) (int_2_U i2)) (not (= i1 i2)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1 0)) (=> (>= i1 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1 (|Seq#Length| nodes))) (=> (< i1 (|Seq#Length| nodes)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2 0)) (=> (>= i2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2 (|Seq#Length| nodes))) (=> (< i2 (|Seq#Length| nodes)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (< 1 (|Seq#Length| nodes))) (and (not (|Seq#Contains| nodes null)) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 29) 28) anon13_Else_correct) (=> (= (ControlFlow 0 29) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 29) 7) anon14_Else_correct)))))
