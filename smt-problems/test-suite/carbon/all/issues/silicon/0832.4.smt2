...
(declare-fun i_3 () Int)
(declare-fun a_1@@20 () T@U)
(declare-fun Heap@@17 () T@U)
(declare-fun n@@12 () Int)
(assert  (and (= (type a_1@@20) ArrayDomainTypeType) (= (type Heap@@17) (MapType0Type RefType))))
(set-info :boogie-vc-id |arr#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= 0 i_3)) (=> (<= 0 i_3) (=> (= (ControlFlow 0 6) (- 0 5)) (< i_3 (alen a_1@@20)))))))
(let ((anon4_correct true))
(let ((anon7_Then_correct  (=> (and (<= 0 i_3) (< i_3 (alen a_1@@20))) (and (=> (= (ControlFlow 0 8) 6) anon8_Then_correct) (=> (= (ControlFlow 0 8) 3) anon4_correct)))))
(let ((anon7_Else_correct  (=> (and (not (and (<= 0 i_3) (< i_3 (alen a_1@@20)))) (= (ControlFlow 0 4) 3)) anon4_correct)))
(let ((anon6_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((i_2 Int) (i_2_1 Int) ) (!  (=> (and (and (and (and (not (= i_2 i_2_1)) (and (<= 0 i_2) (< i_2 (alen a_1@@20)))) (and (<= 0 i_2_1) (< i_2_1 (alen a_1@@20)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (aloc Heap@@17 a_1@@20 i_2) (aloc Heap@@17 a_1@@20 i_2_1))))
 :qid |stdinbpl.467:15|
 :skolemid |43|
)))))
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (= (alen a_1@@20) n@@12) (state Heap@@17 ZeroMask))) (and (and (=> (= (ControlFlow 0 9) 2) anon6_Else_correct) (=> (= (ControlFlow 0 9) 8) anon7_Then_correct)) (=> (= (ControlFlow 0 9) 4) anon7_Else_correct)))))
