...
(declare-fun requireser () T@U)
(declare-fun ensureser () T@U)
(declare-fun invarianter () T@U)
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type requireser) RefType)) (= (type ensureser) RefType)) (= (type invarianter) RefType)) (= (type freshObj@0) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type freshObj@1) RefType)) (= (type Heap@1) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type freshObj@2) RefType)) (= (type Heap@2) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@3) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))))
(set-info :boogie-vc-id specifications)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 requireser $allocated))) (and (U_2_bool (MapType0Select Heap@@9 ensureser $allocated)) (U_2_bool (MapType0Select Heap@@9 invarianter $allocated)))) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@9 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@9 freshObj@0 $allocated (bool_2_U true)))) (and (= Mask@0 (MapType1Store ZeroMask freshObj@0 foo (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 foo)) FullPerm)))) (state Heap@0 Mask@0))) (=> (and (and (and (and (not (= freshObj@1 null)) (not (U_2_bool (MapType0Select Heap@0 freshObj@1 $allocated)))) (= Heap@1 (MapType0Store Heap@0 freshObj@1 $allocated (bool_2_U true)))) (and (= Mask@1 (MapType1Store Mask@0 freshObj@1 foo (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@1 foo)) FullPerm)))) (state Heap@1 Mask@1))) (and (and (and (not (= freshObj@2 null)) (not (U_2_bool (MapType0Select Heap@1 freshObj@2 $allocated)))) (= Heap@2 (MapType0Store Heap@1 freshObj@2 $allocated (bool_2_U true)))) (and (= Mask@2 (MapType1Store Mask@1 freshObj@2 foo (real_2_U (+ (U_2_real (MapType1Select Mask@1 freshObj@2 foo)) FullPerm)))) (state Heap@2 Mask@2)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 foo)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 foo))) (=> (and (= Heap@3 (MapType0Store Heap@2 freshObj@0 foo (int_2_U 1))) (state Heap@3 Mask@2)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@1 foo)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@1 foo))) (=> (= Heap@4 (MapType0Store Heap@3 freshObj@1 foo (int_2_U 1))) (=> (and (state Heap@4 Mask@2) (= (ControlFlow 0 2) (- 0 1))) (= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@2 foo)))))))))))))))
