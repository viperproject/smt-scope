...
(declare-fun x_3 () T@U)
(declare-fun from_1 () T@U)
(declare-fun U_3 () T@U)
(declare-fun V_2 () T@U)
(declare-fun to_1 () T@U)
(declare-fun y_3 () T@U)
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type g) (MapType2Type RefType boolType)) (= (type n$0_8) RefType)) (= (type Heap@@24) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type n$2_3) RefType)) (= (type PostHeap@0) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type n_21) RefType)) (= (type from_1) RefType)) (= (type QPMask@9) (MapType1Type RefType realType))) (= (type n_23) RefType)) (= (type to_1) RefType)) (= (type QPMask@8) (MapType1Type RefType realType))) (= (type n_25) RefType)) (= (type QPMask@7) (MapType1Type RefType realType))) (= (type n_28) RefType)) (= (type QPMask@5) (MapType1Type RefType realType))) (= (type QPMask@6) (MapType1Type RefType realType))) (= (type QPMask@10) (MapType1Type RefType realType))) (= (type x_4) RefType)) (= (type y_4) RefType)) (= (type u_17) RefType)) (= (type v_17) RefType)) (= (type QPMask@12) (MapType1Type RefType realType))) (= (type QPMask@11) (MapType1Type RefType realType))) (= (type u_16) RefType)) (= (type v_16) RefType)) (= (type x_3) RefType)) (= (type y_3) RefType)) (= (type QPMask@13) (MapType1Type RefType realType))) (= (type QPMask@14) (MapType1Type RefType realType))) (= (type QPMask@23) (MapType1Type RefType realType))) (= (type QPMask@21) (MapType1Type RefType realType))) (= (type QPMask@22) (MapType1Type RefType realType))) (= (type QPMask@20) (MapType1Type RefType realType))) (= (type QPMask@18) (MapType1Type RefType realType))) (= (type U_2) RefType)) (= (type V) RefType)) (= (type QPMask@19) (MapType1Type RefType realType))) (= (type QPMask@17) (MapType1Type RefType realType))) (= (type QPMask@15) (MapType1Type RefType realType))) (= (type U_3) RefType)) (= (type V_2) RefType)) (= (type QPMask@16) (MapType1Type RefType realType))) (= (type QPMask@24) (MapType1Type RefType realType))) (= (type QPMask@25) (MapType1Type RefType realType))) (= (type QPMask@3) (MapType1Type RefType realType))) (= (type QPMask@4) (MapType1Type RefType realType))) (forall ((arg0@@58 T@U) ) (! (= (type (invRecv25 arg0@@58)) RefType)
 :qid |funType:invRecv25|
 :pattern ( (invRecv25 arg0@@58))
))) (= (type PostMask@0) (MapType1Type RefType realType))) (forall ((arg0@@59 T@U) ) (! (= (type (invRecv23 arg0@@59)) RefType)
 :qid |funType:invRecv23|
 :pattern ( (invRecv23 arg0@@59))
))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id link_01PG_next)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 210) (let ((anon178_Then_correct  (and (=> (= (ControlFlow 0 192) (- 0 194)) (forall ((n_4 T@U) ) (!  (=> (= (type n_4) RefType) (=> (and (U_2_bool (MapType2Select g n_4)) (dummyFunction (MapType0Select Heap@@24 n_4 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.2966:23|
 :skolemid |335|
 :pattern ( (MapType0Select Heap@@24 n_4 next))
 :pattern ( (MapType1Select QPMask@4 n_4 next))
 :pattern ( (MapType0Select Heap@@24 n_4 next))
))) (=> (forall ((n_4@@0 T@U) ) (!  (=> (= (type n_4@@0) RefType) (=> (and (U_2_bool (MapType2Select g n_4@@0)) (dummyFunction (MapType0Select Heap@@24 n_4@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.2966:23|
 :skolemid |335|
 :pattern ( (MapType0Select Heap@@24 n_4@@0 next))
 :pattern ( (MapType1Select QPMask@4 n_4@@0 next))
 :pattern ( (MapType0Select Heap@@24 n_4@@0 next))
)) (and (=> (= (ControlFlow 0 192) (- 0 193)) (forall ((n_4@@1 T@U) (n_4_1 T@U) ) (!  (=> (and (= (type n_4@@1) RefType) (= (type n_4_1) RefType)) (=> (and (and (and (and (not (= n_4@@1 n_4_1)) (U_2_bool (MapType2Select g n_4@@1))) (U_2_bool (MapType2Select g n_4_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_4@@1 n_4_1))))
 :qid |stdinbpl.2973:23|
 :skolemid |336|
...
)) (=> (= (ControlFlow 0 192) (- 0 191)) (forall ((n_4@@3 T@U) ) (!  (=> (and (= (type n_4@@3) RefType) (U_2_bool (MapType2Select g n_4@@3))) (>= (U_2_real (MapType1Select QPMask@0 n_4@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.2980:23|
 :skolemid |337|
 :pattern ( (MapType0Select Heap@@24 n_4@@3 next))
 :pattern ( (MapType1Select QPMask@4 n_4@@3 next))
 :pattern ( (MapType0Select Heap@@24 n_4@@3 next))
)))))))))
(let ((anon177_Then_correct  (and (=> (= (ControlFlow 0 188) (- 0 190)) (forall ((n_3 T@U) ) (!  (=> (= (type n_3) RefType) (=> (and (U_2_bool (MapType2Select g n_3)) (dummyFunction (MapType0Select PostHeap@0 n_3 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.2910:23|
 :skolemid |328|
 :pattern ( (MapType0Select PostHeap@0 n_3 next))
 :pattern ( (MapType1Select QPMask@3 n_3 next))
 :pattern ( (MapType0Select PostHeap@0 n_3 next))
))) (=> (forall ((n_3@@0 T@U) ) (!  (=> (= (type n_3@@0) RefType) (=> (and (U_2_bool (MapType2Select g n_3@@0)) (dummyFunction (MapType0Select PostHeap@0 n_3@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.2910:23|
 :skolemid |328|
 :pattern ( (MapType0Select PostHeap@0 n_3@@0 next))
 :pattern ( (MapType1Select QPMask@3 n_3@@0 next))
 :pattern ( (MapType0Select PostHeap@0 n_3@@0 next))
)) (and (=> (= (ControlFlow 0 188) (- 0 189)) (forall ((n_3@@1 T@U) (n_3_1 T@U) ) (!  (=> (and (= (type n_3@@1) RefType) (= (type n_3_1) RefType)) (=> (and (and (and (and (not (= n_3@@1 n_3_1)) (U_2_bool (MapType2Select g n_3@@1))) (U_2_bool (MapType2Select g n_3_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_3@@1 n_3_1))))
 :qid |stdinbpl.2917:23|
 :skolemid |329|
...
)) (=> (= (ControlFlow 0 188) (- 0 187)) (forall ((n_3@@3 T@U) ) (!  (=> (and (= (type n_3@@3) RefType) (U_2_bool (MapType2Select g n_3@@3))) (>= (U_2_real (MapType1Select QPMask@2 n_3@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.2924:23|
 :skolemid |330|
 :pattern ( (MapType0Select PostHeap@0 n_3@@3 next))
 :pattern ( (MapType1Select QPMask@3 n_3@@3 next))
 :pattern ( (MapType0Select PostHeap@0 n_3@@3 next))
)))))))))
(let ((anon182_Else_correct true))
(let ((anon182_Then_correct  (and (=> (= (ControlFlow 0 180) (- 0 182)) (forall ((n_6 T@U) ) (!  (=> (= (type n_6) RefType) (=> (and (U_2_bool (MapType2Select g n_6)) (dummyFunction (MapType0Select Heap@@24 n_6 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3083:25|
 :skolemid |349|
 :pattern ( (MapType0Select Heap@@24 n_6 next))
 :pattern ( (MapType1Select QPMask@25 n_6 next))
 :pattern ( (MapType0Select Heap@@24 n_6 next))
))) (=> (forall ((n_6@@0 T@U) ) (!  (=> (= (type n_6@@0) RefType) (=> (and (U_2_bool (MapType2Select g n_6@@0)) (dummyFunction (MapType0Select Heap@@24 n_6@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3083:25|
 :skolemid |349|
 :pattern ( (MapType0Select Heap@@24 n_6@@0 next))
 :pattern ( (MapType1Select QPMask@25 n_6@@0 next))
 :pattern ( (MapType0Select Heap@@24 n_6@@0 next))
)) (and (=> (= (ControlFlow 0 180) (- 0 181)) (forall ((n_6@@1 T@U) (n_6_1 T@U) ) (!  (=> (and (= (type n_6@@1) RefType) (= (type n_6_1) RefType)) (=> (and (and (and (and (not (= n_6@@1 n_6_1)) (U_2_bool (MapType2Select g n_6@@1))) (U_2_bool (MapType2Select g n_6_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_6@@1 n_6_1))))
 :qid |stdinbpl.3090:25|
 :skolemid |350|
...
)) (=> (= (ControlFlow 0 180) (- 0 179)) (forall ((n_6@@3 T@U) ) (!  (=> (and (= (type n_6@@3) RefType) (U_2_bool (MapType2Select g n_6@@3))) (>= (U_2_real (MapType1Select QPMask@0 n_6@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.3097:25|
 :skolemid |351|
 :pattern ( (MapType0Select Heap@@24 n_6@@3 next))
 :pattern ( (MapType1Select QPMask@25 n_6@@3 next))
 :pattern ( (MapType0Select Heap@@24 n_6@@3 next))
)))))))))
(let ((anon181_Then_correct  (and (=> (= (ControlFlow 0 176) (- 0 178)) (forall ((n_5 T@U) ) (!  (=> (= (type n_5) RefType) (=> (and (U_2_bool (MapType2Select g n_5)) (dummyFunction (MapType0Select PostHeap@0 n_5 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3027:25|
 :skolemid |342|
 :pattern ( (MapType0Select PostHeap@0 n_5 next))
 :pattern ( (MapType1Select QPMask@24 n_5 next))
 :pattern ( (MapType0Select PostHeap@0 n_5 next))
))) (=> (forall ((n_5@@0 T@U) ) (!  (=> (= (type n_5@@0) RefType) (=> (and (U_2_bool (MapType2Select g n_5@@0)) (dummyFunction (MapType0Select PostHeap@0 n_5@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3027:25|
 :skolemid |342|
 :pattern ( (MapType0Select PostHeap@0 n_5@@0 next))
 :pattern ( (MapType1Select QPMask@24 n_5@@0 next))
 :pattern ( (MapType0Select PostHeap@0 n_5@@0 next))
)) (and (=> (= (ControlFlow 0 176) (- 0 177)) (forall ((n_5@@1 T@U) (n_5_1 T@U) ) (!  (=> (and (= (type n_5@@1) RefType) (= (type n_5_1) RefType)) (=> (and (and (and (and (not (= n_5@@1 n_5_1)) (U_2_bool (MapType2Select g n_5@@1))) (U_2_bool (MapType2Select g n_5_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_5@@1 n_5_1))))
 :qid |stdinbpl.3034:25|
 :skolemid |343|
...
)) (=> (= (ControlFlow 0 176) (- 0 175)) (forall ((n_5@@3 T@U) ) (!  (=> (and (= (type n_5@@3) RefType) (U_2_bool (MapType2Select g n_5@@3))) (>= (U_2_real (MapType1Select QPMask@2 n_5@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.3041:25|
 :skolemid |344|
 :pattern ( (MapType0Select PostHeap@0 n_5@@3 next))
 :pattern ( (MapType1Select QPMask@24 n_5@@3 next))
 :pattern ( (MapType0Select PostHeap@0 n_5@@3 next))
)))))))))
(let ((anon213_Then_correct  (and (=> (= (ControlFlow 0 159) (- 0 161)) (forall ((n_16 T@U) ) (!  (=> (= (type n_16) RefType) (=> (and (U_2_bool (MapType2Select g n_16)) (dummyFunction (MapType0Select Heap@@24 n_16 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3680:45|
 :skolemid |427|
 :pattern ( (MapType0Select Heap@@24 n_16 next))
 :pattern ( (MapType1Select QPMask@16 n_16 next))
 :pattern ( (MapType0Select Heap@@24 n_16 next))
))) (=> (forall ((n_16@@0 T@U) ) (!  (=> (= (type n_16@@0) RefType) (=> (and (U_2_bool (MapType2Select g n_16@@0)) (dummyFunction (MapType0Select Heap@@24 n_16@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3680:45|
 :skolemid |427|
 :pattern ( (MapType0Select Heap@@24 n_16@@0 next))
 :pattern ( (MapType1Select QPMask@16 n_16@@0 next))
 :pattern ( (MapType0Select Heap@@24 n_16@@0 next))
)) (and (=> (= (ControlFlow 0 159) (- 0 160)) (forall ((n_16@@1 T@U) (n_16_1 T@U) ) (!  (=> (and (= (type n_16@@1) RefType) (= (type n_16_1) RefType)) (=> (and (and (and (and (not (= n_16@@1 n_16_1)) (U_2_bool (MapType2Select g n_16@@1))) (U_2_bool (MapType2Select g n_16_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_16@@1 n_16_1))))
 :qid |stdinbpl.3687:45|
 :skolemid |428|
...
)) (=> (= (ControlFlow 0 159) (- 0 158)) (forall ((n_16@@3 T@U) ) (!  (=> (and (= (type n_16@@3) RefType) (U_2_bool (MapType2Select g n_16@@3))) (>= (U_2_real (MapType1Select QPMask@0 n_16@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.3694:45|
 :skolemid |429|
 :pattern ( (MapType0Select Heap@@24 n_16@@3 next))
 :pattern ( (MapType1Select QPMask@16 n_16@@3 next))
 :pattern ( (MapType0Select Heap@@24 n_16@@3 next))
)))))))))
(let ((anon211_Then_correct  (and (=> (= (ControlFlow 0 154) (- 0 156)) (forall ((n_15 T@U) ) (!  (=> (= (type n_15) RefType) (=> (and (U_2_bool (MapType2Select g n_15)) (dummyFunction (MapType0Select Heap@@24 n_15 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3626:43|
 :skolemid |420|
 :pattern ( (MapType0Select Heap@@24 n_15 next))
 :pattern ( (MapType1Select QPMask@15 n_15 next))
 :pattern ( (MapType0Select Heap@@24 n_15 next))
))) (=> (forall ((n_15@@0 T@U) ) (!  (=> (= (type n_15@@0) RefType) (=> (and (U_2_bool (MapType2Select g n_15@@0)) (dummyFunction (MapType0Select Heap@@24 n_15@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3626:43|
 :skolemid |420|
 :pattern ( (MapType0Select Heap@@24 n_15@@0 next))
 :pattern ( (MapType1Select QPMask@15 n_15@@0 next))
 :pattern ( (MapType0Select Heap@@24 n_15@@0 next))
)) (and (=> (= (ControlFlow 0 154) (- 0 155)) (forall ((n_15@@1 T@U) (n_15_1 T@U) ) (!  (=> (and (= (type n_15@@1) RefType) (= (type n_15_1) RefType)) (=> (and (and (and (and (not (= n_15@@1 n_15_1)) (U_2_bool (MapType2Select g n_15@@1))) (U_2_bool (MapType2Select g n_15_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_15@@1 n_15_1))))
 :qid |stdinbpl.3633:43|
 :skolemid |421|
...
)) (=> (= (ControlFlow 0 154) (- 0 153)) (forall ((n_15@@3 T@U) ) (!  (=> (and (= (type n_15@@3) RefType) (U_2_bool (MapType2Select g n_15@@3))) (>= (U_2_real (MapType1Select QPMask@0 n_15@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.3640:43|
 :skolemid |422|
 :pattern ( (MapType0Select Heap@@24 n_15@@3 next))
 :pattern ( (MapType1Select QPMask@15 n_15@@3 next))
 :pattern ( (MapType0Select Heap@@24 n_15@@3 next))
)))))))))
(let ((anon79_correct true))
(let ((anon212_Then_correct  (=> (or (and (DEP ($$ Heap@@24 g) x_3 from_1 U_3 V_2) (not (= x_3 from_1))) (and (= x_3 U_3) (and (= U_3 from_1) (= V_2 to_1)))) (and (=> (= (ControlFlow 0 162) 159) anon213_Then_correct) (=> (= (ControlFlow 0 162) 151) anon79_correct)))))
(let ((anon212_Else_correct  (=> (and (not (or (and (DEP ($$ Heap@@24 g) x_3 from_1 U_3 V_2) (not (= x_3 from_1))) (and (= x_3 U_3) (and (= U_3 from_1) (= V_2 to_1))))) (= (ControlFlow 0 157) 151)) anon79_correct)))
(let ((anon210_Then_correct  (=> (forall ((u__7 T@U) (v__7 T@U) ) (!  (=> (and (= (type u__7) RefType) (= (type v__7) RefType)) (not (DEP ($$ Heap@@24 g) x_3 y_3 u__7 v__7)))
 :qid |stdinbpl.3614:39|
 :skolemid |419|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_3 y_3 u__7 v__7))
...
(let ((anon210_Else_correct  (=> (and (not (forall ((u__7@@0 T@U) (v__7@@0 T@U) ) (!  (=> (and (= (type u__7@@0) RefType) (= (type v__7@@0) RefType)) (not (DEP ($$ Heap@@24 g) x_3 y_3 u__7@@0 v__7@@0)))
 :qid |stdinbpl.3614:39|
 :skolemid |419|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_3 y_3 u__7@@0 v__7@@0))
))) (= (ControlFlow 0 152) 151)) anon79_correct)))
(let ((anon209_Else_correct true))
(let ((anon209_Then_correct  (and (=> (= (ControlFlow 0 147) (- 0 149)) (forall ((n_14 T@U) ) (!  (=> (= (type n_14) RefType) (=> (and (U_2_bool (MapType2Select g n_14)) (dummyFunction (MapType0Select Heap@@24 n_14 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3567:43|
 :skolemid |412|
 :pattern ( (MapType0Select Heap@@24 n_14 next))
 :pattern ( (MapType1Select QPMask@17 n_14 next))
 :pattern ( (MapType0Select Heap@@24 n_14 next))
))) (=> (forall ((n_14@@0 T@U) ) (!  (=> (= (type n_14@@0) RefType) (=> (and (U_2_bool (MapType2Select g n_14@@0)) (dummyFunction (MapType0Select Heap@@24 n_14@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3567:43|
 :skolemid |412|
 :pattern ( (MapType0Select Heap@@24 n_14@@0 next))
 :pattern ( (MapType1Select QPMask@17 n_14@@0 next))
 :pattern ( (MapType0Select Heap@@24 n_14@@0 next))
)) (and (=> (= (ControlFlow 0 147) (- 0 148)) (forall ((n_14@@1 T@U) (n_14_1 T@U) ) (!  (=> (and (= (type n_14@@1) RefType) (= (type n_14_1) RefType)) (=> (and (and (and (and (not (= n_14@@1 n_14_1)) (U_2_bool (MapType2Select g n_14@@1))) (U_2_bool (MapType2Select g n_14_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_14@@1 n_14_1))))
 :qid |stdinbpl.3574:43|
 :skolemid |413|
...
)) (=> (= (ControlFlow 0 147) (- 0 146)) (forall ((n_14@@3 T@U) ) (!  (=> (and (= (type n_14@@3) RefType) (U_2_bool (MapType2Select g n_14@@3))) (>= (U_2_real (MapType1Select QPMask@0 n_14@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.3581:43|
 :skolemid |414|
 :pattern ( (MapType0Select Heap@@24 n_14@@3 next))
 :pattern ( (MapType1Select QPMask@17 n_14@@3 next))
 :pattern ( (MapType0Select Heap@@24 n_14@@3 next))
)))))))))
(let ((anon203_Then_correct  (and (=> (= (ControlFlow 0 139) (- 0 141)) (forall ((n_13 T@U) ) (!  (=> (= (type n_13) RefType) (=> (and (U_2_bool (MapType2Select g n_13)) (dummyFunction (MapType0Select Heap@@24 n_13 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3499:39|
 :skolemid |403|
 :pattern ( (MapType0Select Heap@@24 n_13 next))
 :pattern ( (MapType1Select QPMask@19 n_13 next))
 :pattern ( (MapType0Select Heap@@24 n_13 next))
))) (=> (forall ((n_13@@0 T@U) ) (!  (=> (= (type n_13@@0) RefType) (=> (and (U_2_bool (MapType2Select g n_13@@0)) (dummyFunction (MapType0Select Heap@@24 n_13@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3499:39|
 :skolemid |403|
 :pattern ( (MapType0Select Heap@@24 n_13@@0 next))
 :pattern ( (MapType1Select QPMask@19 n_13@@0 next))
 :pattern ( (MapType0Select Heap@@24 n_13@@0 next))
)) (and (=> (= (ControlFlow 0 139) (- 0 140)) (forall ((n_13@@1 T@U) (n_13_1 T@U) ) (!  (=> (and (= (type n_13@@1) RefType) (= (type n_13_1) RefType)) (=> (and (and (and (and (not (= n_13@@1 n_13_1)) (U_2_bool (MapType2Select g n_13@@1))) (U_2_bool (MapType2Select g n_13_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_13@@1 n_13_1))))
 :qid |stdinbpl.3506:39|
 :skolemid |404|
...
)) (=> (= (ControlFlow 0 139) (- 0 138)) (forall ((n_13@@3 T@U) ) (!  (=> (and (= (type n_13@@3) RefType) (U_2_bool (MapType2Select g n_13@@3))) (>= (U_2_real (MapType1Select QPMask@0 n_13@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.3513:39|
 :skolemid |405|
 :pattern ( (MapType0Select Heap@@24 n_13@@3 next))
 :pattern ( (MapType1Select QPMask@19 n_13@@3 next))
 :pattern ( (MapType0Select Heap@@24 n_13@@3 next))
)))))))))
(let ((anon201_Then_correct  (and (=> (= (ControlFlow 0 134) (- 0 136)) (forall ((n_12 T@U) ) (!  (=> (= (type n_12) RefType) (=> (and (U_2_bool (MapType2Select g n_12)) (dummyFunction (MapType0Select Heap@@24 n_12 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3445:37|
 :skolemid |396|
 :pattern ( (MapType0Select Heap@@24 n_12 next))
 :pattern ( (MapType1Select QPMask@18 n_12 next))
 :pattern ( (MapType0Select Heap@@24 n_12 next))
))) (=> (forall ((n_12@@0 T@U) ) (!  (=> (= (type n_12@@0) RefType) (=> (and (U_2_bool (MapType2Select g n_12@@0)) (dummyFunction (MapType0Select Heap@@24 n_12@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3445:37|
 :skolemid |396|
 :pattern ( (MapType0Select Heap@@24 n_12@@0 next))
 :pattern ( (MapType1Select QPMask@18 n_12@@0 next))
 :pattern ( (MapType0Select Heap@@24 n_12@@0 next))
)) (and (=> (= (ControlFlow 0 134) (- 0 135)) (forall ((n_12@@1 T@U) (n_12_1 T@U) ) (!  (=> (and (= (type n_12@@1) RefType) (= (type n_12_1) RefType)) (=> (and (and (and (and (not (= n_12@@1 n_12_1)) (U_2_bool (MapType2Select g n_12@@1))) (U_2_bool (MapType2Select g n_12_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_12@@1 n_12_1))))
 :qid |stdinbpl.3452:37|
 :skolemid |397|
...
)) (=> (= (ControlFlow 0 134) (- 0 133)) (forall ((n_12@@3 T@U) ) (!  (=> (and (= (type n_12@@3) RefType) (U_2_bool (MapType2Select g n_12@@3))) (>= (U_2_real (MapType1Select QPMask@0 n_12@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.3459:37|
 :skolemid |398|
 :pattern ( (MapType0Select Heap@@24 n_12@@3 next))
 :pattern ( (MapType1Select QPMask@18 n_12@@3 next))
 :pattern ( (MapType0Select Heap@@24 n_12@@3 next))
)))))))))
(let ((anon64_correct true))
(let ((anon202_Then_correct  (=> (or (and (DEP ($$ Heap@@24 g) x_3 from_1 U_2 V) (not (= x_3 from_1))) (and (= x_3 U_2) (and (= U_2 from_1) (= V to_1)))) (and (=> (= (ControlFlow 0 142) 139) anon203_Then_correct) (=> (= (ControlFlow 0 142) 131) anon64_correct)))))
(let ((anon202_Else_correct  (=> (and (not (or (and (DEP ($$ Heap@@24 g) x_3 from_1 U_2 V) (not (= x_3 from_1))) (and (= x_3 U_2) (and (= U_2 from_1) (= V to_1))))) (= (ControlFlow 0 137) 131)) anon64_correct)))
(let ((anon200_Then_correct  (=> (forall ((u__4 T@U) (v__4 T@U) ) (!  (=> (and (= (type u__4) RefType) (= (type v__4) RefType)) (not (DEP ($$ Heap@@24 g) x_3 y_3 u__4 v__4)))
 :qid |stdinbpl.3433:33|
 :skolemid |395|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_3 y_3 u__4 v__4))
...
(let ((anon200_Else_correct  (=> (and (not (forall ((u__4@@0 T@U) (v__4@@0 T@U) ) (!  (=> (and (= (type u__4@@0) RefType) (= (type v__4@@0) RefType)) (not (DEP ($$ Heap@@24 g) x_3 y_3 u__4@@0 v__4@@0)))
 :qid |stdinbpl.3433:33|
 :skolemid |395|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_3 y_3 u__4@@0 v__4@@0))
))) (= (ControlFlow 0 132) 131)) anon64_correct)))
(let ((anon199_Else_correct true))
(let ((anon199_Then_correct  (and (=> (= (ControlFlow 0 127) (- 0 129)) (forall ((n_11 T@U) ) (!  (=> (= (type n_11) RefType) (=> (and (U_2_bool (MapType2Select g n_11)) (dummyFunction (MapType0Select Heap@@24 n_11 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3386:37|
 :skolemid |388|
 :pattern ( (MapType0Select Heap@@24 n_11 next))
 :pattern ( (MapType1Select QPMask@20 n_11 next))
 :pattern ( (MapType0Select Heap@@24 n_11 next))
))) (=> (forall ((n_11@@0 T@U) ) (!  (=> (= (type n_11@@0) RefType) (=> (and (U_2_bool (MapType2Select g n_11@@0)) (dummyFunction (MapType0Select Heap@@24 n_11@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3386:37|
 :skolemid |388|
 :pattern ( (MapType0Select Heap@@24 n_11@@0 next))
 :pattern ( (MapType1Select QPMask@20 n_11@@0 next))
 :pattern ( (MapType0Select Heap@@24 n_11@@0 next))
)) (and (=> (= (ControlFlow 0 127) (- 0 128)) (forall ((n_11@@1 T@U) (n_11_1 T@U) ) (!  (=> (and (= (type n_11@@1) RefType) (= (type n_11_1) RefType)) (=> (and (and (and (and (not (= n_11@@1 n_11_1)) (U_2_bool (MapType2Select g n_11@@1))) (U_2_bool (MapType2Select g n_11_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_11@@1 n_11_1))))
 :qid |stdinbpl.3393:37|
 :skolemid |389|
...
)) (=> (= (ControlFlow 0 127) (- 0 126)) (forall ((n_11@@3 T@U) ) (!  (=> (and (= (type n_11@@3) RefType) (U_2_bool (MapType2Select g n_11@@3))) (>= (U_2_real (MapType1Select QPMask@0 n_11@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.3400:37|
 :skolemid |390|
 :pattern ( (MapType0Select Heap@@24 n_11@@3 next))
 :pattern ( (MapType1Select QPMask@20 n_11@@3 next))
 :pattern ( (MapType0Select Heap@@24 n_11@@3 next))
)))))))))
(let ((anon195_Then_correct  (and (=> (= (ControlFlow 0 120) (- 0 122)) (forall ((n_10 T@U) ) (!  (=> (= (type n_10) RefType) (=> (and (U_2_bool (MapType2Select g n_10)) (dummyFunction (MapType0Select Heap@@24 n_10 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3320:37|
 :skolemid |379|
 :pattern ( (MapType0Select Heap@@24 n_10 next))
 :pattern ( (MapType1Select QPMask@22 n_10 next))
 :pattern ( (MapType0Select Heap@@24 n_10 next))
))) (=> (forall ((n_10@@0 T@U) ) (!  (=> (= (type n_10@@0) RefType) (=> (and (U_2_bool (MapType2Select g n_10@@0)) (dummyFunction (MapType0Select Heap@@24 n_10@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3320:37|
 :skolemid |379|
 :pattern ( (MapType0Select Heap@@24 n_10@@0 next))
 :pattern ( (MapType1Select QPMask@22 n_10@@0 next))
 :pattern ( (MapType0Select Heap@@24 n_10@@0 next))
)) (and (=> (= (ControlFlow 0 120) (- 0 121)) (forall ((n_10@@1 T@U) (n_10_1 T@U) ) (!  (=> (and (= (type n_10@@1) RefType) (= (type n_10_1) RefType)) (=> (and (and (and (and (not (= n_10@@1 n_10_1)) (U_2_bool (MapType2Select g n_10@@1))) (U_2_bool (MapType2Select g n_10_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_10@@1 n_10_1))))
 :qid |stdinbpl.3327:37|
 :skolemid |380|
 :pattern ( (neverTriggered33 n_10@@1) (neverTriggered33 n_10_1))
 ...
 :qid |stdinbpl.3327:37|
 :skolemid |380|
 :pattern ( (neverTriggered33 n_10@@2) (neverTriggered33 n_10_1@@0))
)) (=> (= (ControlFlow 0 120) (- 0 119)) (forall ((n_10@@3 T@U) ) (!  (=> (and (= (type n_10@@3) RefType) (U_2_bool (MapType2Select g n_10@@3))) (>= (U_2_real (MapType1Select QPMask@0 n_10@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.3334:37|
 :skolemid |381|
 :pattern ( (MapType0Select Heap@@24 n_10@@3 next))
 :pattern ( (MapType1Select QPMask@22 n_10@@3 next))
 :pattern ( (MapType0Select Heap@@24 n_10@@3 next))
)))))))))
(let ((anon193_Then_correct  (and (=> (= (ControlFlow 0 115) (- 0 117)) (forall ((n_9 T@U) ) (!  (=> (= (type n_9) RefType) (=> (and (U_2_bool (MapType2Select g n_9)) (dummyFunction (MapType0Select Heap@@24 n_9 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3266:35|
 :skolemid |372|
 :pattern ( (MapType0Select Heap@@24 n_9 next))
 :pattern ( (MapType1Select QPMask@21 n_9 next))
 :pattern ( (MapType0Select Heap@@24 n_9 next))
))) (=> (forall ((n_9@@0 T@U) ) (!  (=> (= (type n_9@@0) RefType) (=> (and (U_2_bool (MapType2Select g n_9@@0)) (dummyFunction (MapType0Select Heap@@24 n_9@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3266:35|
 :skolemid |372|
 :pattern ( (MapType0Select Heap@@24 n_9@@0 next))
 :pattern ( (MapType1Select QPMask@21 n_9@@0 next))
 :pattern ( (MapType0Select Heap@@24 n_9@@0 next))
)) (and (=> (= (ControlFlow 0 115) (- 0 116)) (forall ((n_9@@1 T@U) (n_9_1 T@U) ) (!  (=> (and (= (type n_9@@1) RefType) (= (type n_9_1) RefType)) (=> (and (and (and (and (not (= n_9@@1 n_9_1)) (U_2_bool (MapType2Select g n_9@@1))) (U_2_bool (MapType2Select g n_9_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_9@@1 n_9_1))))
 :qid |stdinbpl.3273:35|
 :skolemid |373|
...
)) (=> (= (ControlFlow 0 115) (- 0 114)) (forall ((n_9@@3 T@U) ) (!  (=> (and (= (type n_9@@3) RefType) (U_2_bool (MapType2Select g n_9@@3))) (>= (U_2_real (MapType1Select QPMask@0 n_9@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.3280:35|
 :skolemid |374|
 :pattern ( (MapType0Select Heap@@24 n_9@@3 next))
 :pattern ( (MapType1Select QPMask@21 n_9@@3 next))
 :pattern ( (MapType0Select Heap@@24 n_9@@3 next))
)))))))))
(let ((anon51_correct true))
(let ((anon194_Then_correct  (=> (or (and (DEP ($$ Heap@@24 g) x_3 from_1 u_16 v_16) (not (= x_3 from_1))) (and (= x_3 u_16) (and (= u_16 from_1) (= v_16 to_1)))) (and (=> (= (ControlFlow 0 123) 120) anon195_Then_correct) (=> (= (ControlFlow 0 123) 112) anon51_correct)))))
(let ((anon194_Else_correct  (=> (and (not (or (and (DEP ($$ Heap@@24 g) x_3 from_1 u_16 v_16) (not (= x_3 from_1))) (and (= x_3 u_16) (and (= u_16 from_1) (= v_16 to_1))))) (= (ControlFlow 0 118) 112)) anon51_correct)))
(let ((anon192_Then_correct  (=> (forall ((u__1 T@U) (v__1 T@U) ) (!  (=> (and (= (type u__1) RefType) (= (type v__1) RefType)) (not (DEP ($$ Heap@@24 g) x_3 y_3 u__1 v__1)))
 :qid |stdinbpl.3254:31|
 :skolemid |371|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_3 y_3 u__1 v__1))
...
(let ((anon192_Else_correct  (=> (and (not (forall ((u__1@@0 T@U) (v__1@@0 T@U) ) (!  (=> (and (= (type u__1@@0) RefType) (= (type v__1@@0) RefType)) (not (DEP ($$ Heap@@24 g) x_3 y_3 u__1@@0 v__1@@0)))
 :qid |stdinbpl.3254:31|
 :skolemid |371|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_3 y_3 u__1@@0 v__1@@0))
))) (= (ControlFlow 0 113) 112)) anon51_correct)))
(let ((anon191_Else_correct true))
(let ((anon191_Then_correct  (and (=> (= (ControlFlow 0 108) (- 0 110)) (forall ((n_8 T@U) ) (!  (=> (= (type n_8) RefType) (=> (and (U_2_bool (MapType2Select g n_8)) (dummyFunction (MapType0Select Heap@@24 n_8 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3207:35|
 :skolemid |364|
 :pattern ( (MapType0Select Heap@@24 n_8 next))
 :pattern ( (MapType1Select QPMask@23 n_8 next))
 :pattern ( (MapType0Select Heap@@24 n_8 next))
))) (=> (forall ((n_8@@0 T@U) ) (!  (=> (= (type n_8@@0) RefType) (=> (and (U_2_bool (MapType2Select g n_8@@0)) (dummyFunction (MapType0Select Heap@@24 n_8@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3207:35|
 :skolemid |364|
 :pattern ( (MapType0Select Heap@@24 n_8@@0 next))
 :pattern ( (MapType1Select QPMask@23 n_8@@0 next))
 :pattern ( (MapType0Select Heap@@24 n_8@@0 next))
)) (and (=> (= (ControlFlow 0 108) (- 0 109)) (forall ((n_8@@1 T@U) (n_8_1 T@U) ) (!  (=> (and (= (type n_8@@1) RefType) (= (type n_8_1) RefType)) (=> (and (and (and (and (not (= n_8@@1 n_8_1)) (U_2_bool (MapType2Select g n_8@@1))) (U_2_bool (MapType2Select g n_8_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_8@@1 n_8_1))))
 :qid |stdinbpl.3214:35|
 :skolemid |365|
...
)) (=> (= (ControlFlow 0 108) (- 0 107)) (forall ((n_8@@3 T@U) ) (!  (=> (and (= (type n_8@@3) RefType) (U_2_bool (MapType2Select g n_8@@3))) (>= (U_2_real (MapType1Select QPMask@0 n_8@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.3221:35|
 :skolemid |366|
 :pattern ( (MapType0Select Heap@@24 n_8@@3 next))
 :pattern ( (MapType1Select QPMask@23 n_8@@3 next))
 :pattern ( (MapType0Select Heap@@24 n_8@@3 next))
)))))))))
(let ((anon215_Then_correct  (and (=> (= (ControlFlow 0 100) (- 0 102)) (forall ((n_17 T@U) ) (!  (=> (= (type n_17) RefType) (=> (and (U_2_bool (MapType2Select g n_17)) (dummyFunction (MapType0Select PostHeap@0 n_17 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3762:29|
 :skolemid |440|
 :pattern ( (MapType0Select PostHeap@0 n_17 next))
 :pattern ( (MapType1Select QPMask@14 n_17 next))
 :pattern ( (MapType0Select PostHeap@0 n_17 next))
))) (=> (forall ((n_17@@0 T@U) ) (!  (=> (= (type n_17@@0) RefType) (=> (and (U_2_bool (MapType2Select g n_17@@0)) (dummyFunction (MapType0Select PostHeap@0 n_17@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3762:29|
 :skolemid |440|
 :pattern ( (MapType0Select PostHeap@0 n_17@@0 next))
 :pattern ( (MapType1Select QPMask@14 n_17@@0 next))
 :pattern ( (MapType0Select PostHeap@0 n_17@@0 next))
)) (and (=> (= (ControlFlow 0 100) (- 0 101)) (forall ((n_17@@1 T@U) (n_17_1 T@U) ) (!  (=> (and (= (type n_17@@1) RefType) (= (type n_17_1) RefType)) (=> (and (and (and (and (not (= n_17@@1 n_17_1)) (U_2_bool (MapType2Select g n_17@@1))) (U_2_bool (MapType2Select g n_17_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_17@@1 n_17_1))))
...
)) (=> (= (ControlFlow 0 100) (- 0 99)) (forall ((n_17@@3 T@U) ) (!  (=> (and (= (type n_17@@3) RefType) (U_2_bool (MapType2Select g n_17@@3))) (>= (U_2_real (MapType1Select QPMask@2 n_17@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.3776:29|
 :skolemid |442|
 :pattern ( (MapType0Select PostHeap@0 n_17@@3 next))
 :pattern ( (MapType1Select QPMask@14 n_17@@3 next))
 :pattern ( (MapType0Select PostHeap@0 n_17@@3 next))
)))))))))
(let ((anon186_Then_correct  (and (=> (= (ControlFlow 0 95) (- 0 97)) (forall ((n_7 T@U) ) (!  (=> (= (type n_7) RefType) (=> (and (U_2_bool (MapType2Select g n_7)) (dummyFunction (MapType0Select Heap@@24 n_7 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3150:27|
 :skolemid |357|
 :pattern ( (MapType0Select Heap@@24 n_7 next))
 :pattern ( (MapType1Select QPMask@13 n_7 next))
 :pattern ( (MapType0Select Heap@@24 n_7 next))
))) (=> (forall ((n_7@@0 T@U) ) (!  (=> (= (type n_7@@0) RefType) (=> (and (U_2_bool (MapType2Select g n_7@@0)) (dummyFunction (MapType0Select Heap@@24 n_7@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3150:27|
 :skolemid |357|
 :pattern ( (MapType0Select Heap@@24 n_7@@0 next))
 :pattern ( (MapType1Select QPMask@13 n_7@@0 next))
 :pattern ( (MapType0Select Heap@@24 n_7@@0 next))
)) (and (=> (= (ControlFlow 0 95) (- 0 96)) (forall ((n_7@@1 T@U) (n_7_1 T@U) ) (!  (=> (and (= (type n_7@@1) RefType) (= (type n_7_1) RefType)) (=> (and (and (and (and (not (= n_7@@1 n_7_1)) (U_2_bool (MapType2Select g n_7@@1))) (U_2_bool (MapType2Select g n_7_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_7@@1 n_7_1))))
 :qid |stdinbpl.3157:27|
 :skolemid |358|
...
)) (=> (= (ControlFlow 0 95) (- 0 94)) (forall ((n_7@@3 T@U) ) (!  (=> (and (= (type n_7@@3) RefType) (U_2_bool (MapType2Select g n_7@@3))) (>= (U_2_real (MapType1Select QPMask@0 n_7@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.3164:27|
 :skolemid |359|
 :pattern ( (MapType0Select Heap@@24 n_7@@3 next))
 :pattern ( (MapType1Select QPMask@13 n_7@@3 next))
 :pattern ( (MapType0Select Heap@@24 n_7@@3 next))
)))))))))
(let ((anon83_correct true))
(let ((anon214_Then_correct  (=> (or (DEP ($$ Heap@@24 g) x_3 y_3 u_16 v_16) (or (and (= x_3 from_1) (and (= u_16 from_1) (and (= y_3 to_1) (= v_16 to_1)))) (or (exists ((w_3 T@U) (z_3 T@U) ) (!  (and (and (= (type w_3) RefType) (= (type z_3) RefType)) (and (forall ((u__8 T@U) (v__8 T@U) ) (!  (=> (and (= (type u__8) RefType) (= (type v__8) RefType)) (not (DEP ($$ Heap@@24 g) x_3 y_3 u__8 v__8)))
 :qid |stdinbpl.3737:23|
 :skolemid |434|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_3 y_3 u__8 v__8))
)) (and (or (and (DEP ($$ Heap@@24 g) x_3 from_1 u_16 v_16) (not (= x_3 from_1))) (and (= x_3 u_16) (and (= u_16 from_1) (= v_16 to_1)))) (or (and (DEP ($$ Heap@@24 g) to_1 y_3 w_3 z_3) (not (= to_1 y_3))) (and (= from_1 w_3) (and (= to_1 z_3) (= z_3 y_3)))))))
 :qid |stdinbpl.3735:152|
 :skolemid |435|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) to_1 y_3 w_3 z_3))
)) (or (exists ((U_3_1 T@U) (V_3 T@U) ) (!  (and (and (= (type U_3_1) RefType) (= (type V_3) RefType)) (and (forall ((u__9 T@U) (v__9 T@U) ) (!  (=> (and (= (type u__9) RefType) (= (type v__9) RefType)) (not (DEP ($$ Heap@@24 g) x_3 y_3 u__9 v__9)))
 :qid |stdinbpl.3743:23|
 :skolemid |436|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_3 y_3 u__9 v__9))
)) (and (or (and (DEP ($$ Heap@@24 g) x_3 from_1 U_3_1 V_3) (not (= x_3 from_1))) (and (= x_3 U_3_1) (and (= U_3_1 from_1) (= V_3 to_1)))) (or (and (DEP ($$ Heap@@24 g) to_1 y_3 u_16 v_16) (not (= to_1 y_3))) (and (= from_1 u_16) (and (= to_1 v_16) (= v_16 y_3)))))))
 :qid |stdinbpl.3741:27|
 :skolemid |437|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_3 from_1 U_3_1 V_3))
)) (and (= u_16 from_1) (and (= v_16 to_1) (exists ((U_4 T@U) (V_4 T@U) (w_4 T@U) (z_4 T@U) ) (!  (and (and (and (and (= (type U_4) RefType) (= (type V_4) RefType)) (= (type w_4) RefType)) (= (type z_4) RefType)) (and (forall ((u__10 T@U) (v__10 T@U) ) (!  (=> (and (= (type u__10) RefType) (= (type v__10) RefType)) (not (DEP ($$ Heap@@24 g) x_3 y_3 u__10 v__10)))
 :qid |stdinbpl.3749:23|
 :skolemid |438|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_3 y_3 u__10 v__10))
)) (and (or (and (DEP ($$ Heap@@24 g) x_3 from_1 U_4 V_4) (not (= x_3 from_1))) (and (= x_3 U_4) (and (= U_4 from_1) (= V_4 to_1)))) (or (and (DEP ($$ Heap@@24 g) to_1 y_3 w_4 z_4) (not (= to_1 y_3))) (and (= from_1 w_4) (and (= to_1 z_4) (= z_4 y_3)))))))
 :qid |stdinbpl.3747:62|
 :skolemid |439|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_3 from_1 U_4 V_4) (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) to_1 y_3 w_4 z_4))
)))))))) (and (=> (= (ControlFlow 0 103) 100) anon215_Then_correct) (=> (= (ControlFlow 0 103) 92) anon83_correct)))))
(let ((anon214_Else_correct  (=> (and (not (or (DEP ($$ Heap@@24 g) x_3 y_3 u_16 v_16) (or (and (= x_3 from_1) (and (= u_16 from_1) (and (= y_3 to_1) (= v_16 to_1)))) (or (exists ((w_3@@0 T@U) (z_3@@0 T@U) ) (!  (and (and (= (type w_3@@0) RefType) (= (type z_3@@0) RefType)) (and (forall ((u__8@@0 T@U) (v__8@@0 T@U) ) (!  (=> (and (= (type u__8@@0) RefType) (= (type v__8@@0) RefType)) (not (DEP ($$ Heap@@24 g) x_3 y_3 u__8@@0 v__8@@0)))
 :qid |stdinbpl.3737:23|
 :skolemid |434|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_3 y_3 u__8@@0 v__8@@0))
)) (and (or (and (DEP ($$ Heap@@24 g) x_3 from_1 u_16 v_16) (not (= x_3 from_1))) (and (= x_3 u_16) (and (= u_16 from_1) (= v_16 to_1)))) (or (and (DEP ($$ Heap@@24 g) to_1 y_3 w_3@@0 z_3@@0) (not (= to_1 y_3))) (and (= from_1 w_3@@0) (and (= to_1 z_3@@0) (= z_3@@0 y_3)))))))
 :qid |stdinbpl.3735:152|
 :skolemid |435|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) to_1 y_3 w_3@@0 z_3@@0))
)) (or (exists ((U_3_1@@0 T@U) (V_3@@0 T@U) ) (!  (and (and (= (type U_3_1@@0) RefType) (= (type V_3@@0) RefType)) (and (forall ((u__9@@0 T@U) (v__9@@0 T@U) ) (!  (=> (and (= (type u__9@@0) RefType) (= (type v__9@@0) RefType)) (not (DEP ($$ Heap@@24 g) x_3 y_3 u__9@@0 v__9@@0)))
 :qid |stdinbpl.3743:23|
 :skolemid |436|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_3 y_3 u__9@@0 v__9@@0))
)) (and (or (and (DEP ($$ Heap@@24 g) x_3 from_1 U_3_1@@0 V_3@@0) (not (= x_3 from_1))) (and (= x_3 U_3_1@@0) (and (= U_3_1@@0 from_1) (= V_3@@0 to_1)))) (or (and (DEP ($$ Heap@@24 g) to_1 y_3 u_16 v_16) (not (= to_1 y_3))) (and (= from_1 u_16) (and (= to_1 v_16) (= v_16 y_3)))))))
 :qid |stdinbpl.3741:27|
 :skolemid |437|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_3 from_1 U_3_1@@0 V_3@@0))
)) (and (= u_16 from_1) (and (= v_16 to_1) (exists ((U_4@@0 T@U) (V_4@@0 T@U) (w_4@@0 T@U) (z_4@@0 T@U) ) (!  (and (and (and (and (= (type U_4@@0) RefType) (= (type V_4@@0) RefType)) (= (type w_4@@0) RefType)) (= (type z_4@@0) RefType)) (and (forall ((u__10@@0 T@U) (v__10@@0 T@U) ) (!  (=> (and (= (type u__10@@0) RefType) (= (type v__10@@0) RefType)) (not (DEP ($$ Heap@@24 g) x_3 y_3 u__10@@0 v__10@@0)))
 :qid |stdinbpl.3749:23|
 :skolemid |438|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_3 y_3 u__10@@0 v__10@@0))
)) (and (or (and (DEP ($$ Heap@@24 g) x_3 from_1 U_4@@0 V_4@@0) (not (= x_3 from_1))) (and (= x_3 U_4@@0) (and (= U_4@@0 from_1) (= V_4@@0 to_1)))) (or (and (DEP ($$ Heap@@24 g) to_1 y_3 w_4@@0 z_4@@0) (not (= to_1 y_3))) (and (= from_1 w_4@@0) (and (= to_1 z_4@@0) (= z_4@@0 y_3)))))))
 :qid |stdinbpl.3747:62|
 :skolemid |439|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_3 from_1 U_4@@0 V_4@@0) (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) to_1 y_3 w_4@@0 z_4@@0))
))))))))) (= (ControlFlow 0 98) 92)) anon83_correct)))
(let ((anon206_Then_correct  (=> (= v_16 to_1) (and (and (and (and (and (=> (= (ControlFlow 0 164) 103) anon214_Then_correct) (=> (= (ControlFlow 0 164) 98) anon214_Else_correct)) (=> (= (ControlFlow 0 164) 163) anon210_Then_correct)) (=> (= (ControlFlow 0 164) 152) anon210_Else_correct)) (=> (= (ControlFlow 0 164) 147) anon209_Then_correct)) (=> (= (ControlFlow 0 164) 150) anon209_Else_correct)))))
(let ((anon206_Else_correct  (=> (not (= v_16 to_1)) (and (=> (= (ControlFlow 0 145) 103) anon214_Then_correct) (=> (= (ControlFlow 0 145) 98) anon214_Else_correct)))))
(let ((anon205_Then_correct  (=> (= u_16 from_1) (and (=> (= (ControlFlow 0 165) 164) anon206_Then_correct) (=> (= (ControlFlow 0 165) 145) anon206_Else_correct)))))
(let ((anon205_Else_correct  (=> (not (= u_16 from_1)) (and (=> (= (ControlFlow 0 144) 103) anon214_Then_correct) (=> (= (ControlFlow 0 144) 98) anon214_Else_correct)))))
(let ((anon204_Then_correct  (=> (not (exists ((U_1_1 T@U) (V_1 T@U) ) (!  (and (and (= (type U_1_1) RefType) (= (type V_1) RefType)) (and (forall ((u__5 T@U) (v__5 T@U) ) (!  (=> (and (= (type u__5) RefType) (= (type v__5) RefType)) (not (DEP ($$ Heap@@24 g) x_3 y_3 u__5 v__5)))
 :qid |stdinbpl.3550:29|
 :skolemid |410|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_3 y_3 u__5 v__5))
)) (and (or (and (DEP ($$ Heap@@24 g) x_3 from_1 U_1_1 V_1) (not (= x_3 from_1))) (and (= x_3 U_1_1) (and (= U_1_1 from_1) (= V_1 to_1)))) (or (and (DEP ($$ Heap@@24 g) to_1 y_3 u_16 v_16) (not (= to_1 y_3))) (and (= from_1 u_16) (and (= to_1 v_16) (= v_16 y_3)))))))
 :qid |stdinbpl.3548:32|
 :skolemid |411|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_3 from_1 U_1_1 V_1))
))) (and (=> (= (ControlFlow 0 166) 165) anon205_Then_correct) (=> (= (ControlFlow 0 166) 144) anon205_Else_correct)))))
(let ((anon204_Else_correct  (=> (exists ((U_1_1@@0 T@U) (V_1@@0 T@U) ) (!  (and (and (= (type U_1_1@@0) RefType) (= (type V_1@@0) RefType)) (and (forall ((u__5@@0 T@U) (v__5@@0 T@U) ) (!  (=> (and (= (type u__5@@0) RefType) (= (type v__5@@0) RefType)) (not (DEP ($$ Heap@@24 g) x_3 y_3 u__5@@0 v__5@@0)))
 :qid |stdinbpl.3550:29|
 :skolemid |410|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_3 y_3 u__5@@0 v__5@@0))
)) (and (or (and (DEP ($$ Heap@@24 g) x_3 from_1 U_1_1@@0 V_1@@0) (not (= x_3 from_1))) (and (= x_3 U_1_1@@0) (and (= U_1_1@@0 from_1) (= V_1@@0 to_1)))) (or (and (DEP ($$ Heap@@24 g) to_1 y_3 u_16 v_16) (not (= to_1 y_3))) (and (= from_1 u_16) (and (= to_1 v_16) (= v_16 y_3)))))))
 :qid |stdinbpl.3548:32|
 :skolemid |411|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_3 from_1 U_1_1@@0 V_1@@0))
)) (and (=> (= (ControlFlow 0 125) 103) anon214_Then_correct) (=> (= (ControlFlow 0 125) 98) anon214_Else_correct)))))
(let ((anon196_Then_correct  (=> (not (exists ((w_1_1 T@U) (z_1 T@U) ) (!  (and (and (= (type w_1_1) RefType) (= (type z_1) RefType)) (and (forall ((u__2 T@U) (v__2 T@U) ) (!  (=> (and (= (type u__2) RefType) (= (type v__2) RefType)) (not (DEP ($$ Heap@@24 g) x_3 y_3 u__2 v__2)))
 :qid |stdinbpl.3371:27|
 :skolemid |386|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_3 y_3 u__2 v__2))
)) (and (or (and (DEP ($$ Heap@@24 g) x_3 from_1 u_16 v_16) (not (= x_3 from_1))) (and (= x_3 u_16) (and (= u_16 from_1) (= v_16 to_1)))) (or (and (DEP ($$ Heap@@24 g) to_1 y_3 w_1_1 z_1) (not (= to_1 y_3))) (and (= from_1 w_1_1) (and (= to_1 z_1) (= z_1 y_3)))))))
 :qid |stdinbpl.3369:30|
 :skolemid |387|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) to_1 y_3 w_1_1 z_1))
...
(let ((anon196_Else_correct  (=> (exists ((w_1_1@@0 T@U) (z_1@@0 T@U) ) (!  (and (and (= (type w_1_1@@0) RefType) (= (type z_1@@0) RefType)) (and (forall ((u__2@@0 T@U) (v__2@@0 T@U) ) (!  (=> (and (= (type u__2@@0) RefType) (= (type v__2@@0) RefType)) (not (DEP ($$ Heap@@24 g) x_3 y_3 u__2@@0 v__2@@0)))
 :qid |stdinbpl.3371:27|
 :skolemid |386|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_3 y_3 u__2@@0 v__2@@0))
)) (and (or (and (DEP ($$ Heap@@24 g) x_3 from_1 u_16 v_16) (not (= x_3 from_1))) (and (= x_3 u_16) (and (= u_16 from_1) (= v_16 to_1)))) (or (and (DEP ($$ Heap@@24 g) to_1 y_3 w_1_1@@0 z_1@@0) (not (= to_1 y_3))) (and (= from_1 w_1_1@@0) (and (= to_1 z_1@@0) (= z_1@@0 y_3)))))))
 :qid |stdinbpl.3369:30|
 :skolemid |387|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) to_1 y_3 w_1_1@@0 z_1@@0))
)) (and (=> (= (ControlFlow 0 106) 103) anon214_Then_correct) (=> (= (ControlFlow 0 106) 98) anon214_Else_correct)))))
(let ((anon188_Then_correct  (=> (not (and (= x_3 from_1) (and (= u_16 from_1) (and (= y_3 to_1) (= v_16 to_1))))) (and (and (and (and (and (=> (= (ControlFlow 0 168) 167) anon196_Then_correct) (=> (= (ControlFlow 0 168) 106) anon196_Else_correct)) (=> (= (ControlFlow 0 168) 124) anon192_Then_correct)) (=> (= (ControlFlow 0 168) 113) anon192_Else_correct)) (=> (= (ControlFlow 0 168) 108) anon191_Then_correct)) (=> (= (ControlFlow 0 168) 111) anon191_Else_correct)))))
(let ((anon188_Else_correct  (=> (and (= x_3 from_1) (and (= u_16 from_1) (and (= y_3 to_1) (= v_16 to_1)))) (and (=> (= (ControlFlow 0 105) 103) anon214_Then_correct) (=> (= (ControlFlow 0 105) 98) anon214_Else_correct)))))
(let ((anon187_Then_correct  (=> (not (DEP ($$ Heap@@24 g) x_3 y_3 u_16 v_16)) (and (=> (= (ControlFlow 0 169) 168) anon188_Then_correct) (=> (= (ControlFlow 0 169) 105) anon188_Else_correct)))))
(let ((anon187_Else_correct  (=> (DEP ($$ Heap@@24 g) x_3 y_3 u_16 v_16) (and (=> (= (ControlFlow 0 104) 103) anon214_Then_correct) (=> (= (ControlFlow 0 104) 98) anon214_Else_correct)))))
(let ((anon185_Then_correct  (=> (and (not (= from_1 to_1)) (and (not (= u_16 v_16)) (not (= x_3 y_3)))) (and (and (=> (= (ControlFlow 0 170) 95) anon186_Then_correct) (=> (= (ControlFlow 0 170) 169) anon187_Then_correct)) (=> (= (ControlFlow 0 170) 104) anon187_Else_correct)))))
(let ((anon185_Else_correct  (=> (and (not (and (not (= from_1 to_1)) (and (not (= u_16 v_16)) (not (= x_3 y_3))))) (= (ControlFlow 0 93) 92)) anon83_correct)))
(let ((anon220_Then_correct  (and (=> (= (ControlFlow 0 84) (- 0 86)) (forall ((n_19 T@U) ) (!  (=> (= (type n_19) RefType) (=> (and (U_2_bool (MapType2Select g n_19)) (dummyFunction (MapType0Select PostHeap@0 n_19 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3908:27|
 :skolemid |461|
 :pattern ( (MapType0Select PostHeap@0 n_19 next))
 :pattern ( (MapType1Select QPMask@11 n_19 next))
 :pattern ( (MapType0Select PostHeap@0 n_19 next))
))) (=> (forall ((n_19@@0 T@U) ) (!  (=> (= (type n_19@@0) RefType) (=> (and (U_2_bool (MapType2Select g n_19@@0)) (dummyFunction (MapType0Select PostHeap@0 n_19@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3908:27|
 :skolemid |461|
 :pattern ( (MapType0Select PostHeap@0 n_19@@0 next))
 :pattern ( (MapType1Select QPMask@11 n_19@@0 next))
 :pattern ( (MapType0Select PostHeap@0 n_19@@0 next))
)) (and (=> (= (ControlFlow 0 84) (- 0 85)) (forall ((n_19@@1 T@U) (n_19_1 T@U) ) (!  (=> (and (= (type n_19@@1) RefType) (= (type n_19_1) RefType)) (=> (and (and (and (and (not (= n_19@@1 n_19_1)) (U_2_bool (MapType2Select g n_19@@1))) (U_2_bool (MapType2Select g n_19_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_19@@1 n_19_1))))
 :qid |stdinbpl.3915:27|
 :skolemid |462|
...
)) (=> (= (ControlFlow 0 84) (- 0 83)) (forall ((n_19@@3 T@U) ) (!  (=> (and (= (type n_19@@3) RefType) (U_2_bool (MapType2Select g n_19@@3))) (>= (U_2_real (MapType1Select QPMask@2 n_19@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.3922:27|
 :skolemid |463|
 :pattern ( (MapType0Select PostHeap@0 n_19@@3 next))
 :pattern ( (MapType1Select QPMask@11 n_19@@3 next))
 :pattern ( (MapType0Select PostHeap@0 n_19@@3 next))
)))))))))
(let ((anon222_Then_correct  (and (=> (= (ControlFlow 0 78) (- 0 80)) (forall ((n_20 T@U) ) (!  (=> (= (type n_20) RefType) (=> (and (U_2_bool (MapType2Select g n_20)) (dummyFunction (MapType0Select Heap@@24 n_20 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3966:27|
 :skolemid |468|
 :pattern ( (MapType0Select Heap@@24 n_20 next))
 :pattern ( (MapType1Select QPMask@12 n_20 next))
 :pattern ( (MapType0Select Heap@@24 n_20 next))
))) (=> (forall ((n_20@@0 T@U) ) (!  (=> (= (type n_20@@0) RefType) (=> (and (U_2_bool (MapType2Select g n_20@@0)) (dummyFunction (MapType0Select Heap@@24 n_20@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3966:27|
 :skolemid |468|
 :pattern ( (MapType0Select Heap@@24 n_20@@0 next))
 :pattern ( (MapType1Select QPMask@12 n_20@@0 next))
 :pattern ( (MapType0Select Heap@@24 n_20@@0 next))
)) (and (=> (= (ControlFlow 0 78) (- 0 79)) (forall ((n_20@@1 T@U) (n_20_1 T@U) ) (!  (=> (and (= (type n_20@@1) RefType) (= (type n_20_1) RefType)) (=> (and (and (and (and (not (= n_20@@1 n_20_1)) (U_2_bool (MapType2Select g n_20@@1))) (U_2_bool (MapType2Select g n_20_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_20@@1 n_20_1))))
 :qid |stdinbpl.3973:27|
 :skolemid |469|
 :pattern ( (neverTriggered43 n_20@@1) (neverTriggered43 n_20_1))
))) (=> (forall ((n_20@@2 T@U) (n_20_1@@0 T@U) ) (!  (=> (and (= (type n_20@@2) RefType) (= (type n_20_1@@0) RefType)) (=> (and (and (and (and (not (= n_20@@2 n_20_1@@0)) (U_2_bool (MapType2Select g n_20@@2))) (U_2_bool (MapType2Select g n_20_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_20@@2 n_20_1@@0))))
 :qid |stdinbpl.3973:27|
 :skolemid |469|
 :pattern ( (neverTriggered43 n_20@@2) (neverTriggered43 n_20_1@@0))
)) (=> (= (ControlFlow 0 78) (- 0 77)) (forall ((n_20@@3 T@U) ) (!  (=> (and (= (type n_20@@3) RefType) (U_2_bool (MapType2Select g n_20@@3))) (>= (U_2_real (MapType1Select QPMask@0 n_20@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.3980:27|
 :skolemid |470|
 :pattern ( (MapType0Select Heap@@24 n_20@@3 next))
 :pattern ( (MapType1Select QPMask@12 n_20@@3 next))
 :pattern ( (MapType0Select Heap@@24 n_20@@3 next))
)))))))))
(let ((anon95_correct true))
(let ((anon221_Then_correct  (=> (and (DEP ($$ PostHeap@0 g) x_4 y_4 u_17 v_17) (not (DEP ($$ PostHeap@0 g) x_4 y_4 from_1 to_1))) (and (=> (= (ControlFlow 0 81) 78) anon222_Then_correct) (=> (= (ControlFlow 0 81) 75) anon95_correct)))))
(let ((anon221_Else_correct  (=> (and (not (and (DEP ($$ PostHeap@0 g) x_4 y_4 u_17 v_17) (not (DEP ($$ PostHeap@0 g) x_4 y_4 from_1 to_1)))) (= (ControlFlow 0 76) 75)) anon95_correct)))
(let ((anon219_Then_correct  (=> (DEP ($$ PostHeap@0 g) x_4 y_4 u_17 v_17) (and (and (=> (= (ControlFlow 0 87) 84) anon220_Then_correct) (=> (= (ControlFlow 0 87) 81) anon221_Then_correct)) (=> (= (ControlFlow 0 87) 76) anon221_Else_correct)))))
(let ((anon219_Else_correct  (=> (not (DEP ($$ PostHeap@0 g) x_4 y_4 u_17 v_17)) (and (=> (= (ControlFlow 0 82) 81) anon221_Then_correct) (=> (= (ControlFlow 0 82) 76) anon221_Else_correct)))))
(let ((anon218_Then_correct  (and (=> (= (ControlFlow 0 72) (- 0 74)) (forall ((n_18 T@U) ) (!  (=> (= (type n_18) RefType) (=> (and (U_2_bool (MapType2Select g n_18)) (dummyFunction (MapType0Select PostHeap@0 n_18 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3851:25|
 :skolemid |454|
 :pattern ( (MapType0Select PostHeap@0 n_18 next))
 :pattern ( (MapType1Select QPMask@10 n_18 next))
 :pattern ( (MapType0Select PostHeap@0 n_18 next))
))) (=> (forall ((n_18@@0 T@U) ) (!  (=> (= (type n_18@@0) RefType) (=> (and (U_2_bool (MapType2Select g n_18@@0)) (dummyFunction (MapType0Select PostHeap@0 n_18@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.3851:25|
 :skolemid |454|
 :pattern ( (MapType0Select PostHeap@0 n_18@@0 next))
 :pattern ( (MapType1Select QPMask@10 n_18@@0 next))
 :pattern ( (MapType0Select PostHeap@0 n_18@@0 next))
)) (and (=> (= (ControlFlow 0 72) (- 0 73)) (forall ((n_18@@1 T@U) (n_18_1 T@U) ) (!  (=> (and (= (type n_18@@1) RefType) (= (type n_18_1) RefType)) (=> (and (and (and (and (not (= n_18@@1 n_18_1)) (U_2_bool (MapType2Select g n_18@@1))) (U_2_bool (MapType2Select g n_18_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_18@@1 n_18_1))))
 :qid |stdinbpl.3858:25|
 :skolemid |455|
...
)) (=> (= (ControlFlow 0 72) (- 0 71)) (forall ((n_18@@3 T@U) ) (!  (=> (and (= (type n_18@@3) RefType) (U_2_bool (MapType2Select g n_18@@3))) (>= (U_2_real (MapType1Select QPMask@2 n_18@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.3865:25|
 :skolemid |456|
 :pattern ( (MapType0Select PostHeap@0 n_18@@3 next))
 :pattern ( (MapType1Select QPMask@10 n_18@@3 next))
 :pattern ( (MapType0Select PostHeap@0 n_18@@3 next))
)))))))))
(let ((anon236_Then_correct  (and (=> (= (ControlFlow 0 60) (- 0 62)) (forall ((n$0_6 T@U) ) (!  (=> (= (type n$0_6) RefType) (=> (and (U_2_bool (MapType2Select g n$0_6)) (dummyFunction (MapType0Select Heap@@24 n$0_6 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.4303:27|
 :skolemid |507|
 :pattern ( (MapType0Select Heap@@24 n$0_6 next))
 :pattern ( (MapType1Select QPMask@6 n$0_6 next))
 :pattern ( (MapType0Select Heap@@24 n$0_6 next))
))) (=> (forall ((n$0_6@@0 T@U) ) (!  (=> (= (type n$0_6@@0) RefType) (=> (and (U_2_bool (MapType2Select g n$0_6@@0)) (dummyFunction (MapType0Select Heap@@24 n$0_6@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.4303:27|
 :skolemid |507|
 :pattern ( (MapType0Select Heap@@24 n$0_6@@0 next))
 :pattern ( (MapType1Select QPMask@6 n$0_6@@0 next))
 :pattern ( (MapType0Select Heap@@24 n$0_6@@0 next))
)) (and (=> (= (ControlFlow 0 60) (- 0 61)) (forall ((n$0_6@@1 T@U) (n$0_6_1 T@U) ) (!  (=> (and (= (type n$0_6@@1) RefType) (= (type n$0_6_1) RefType)) (=> (and (and (and (and (not (= n$0_6@@1 n$0_6_1)) (U_2_bool (MapType2Select g n$0_6@@1))) (U_2_bool (MapType2Select g n$0_6_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_6@@1 n$0_6_1))))
 :qid |stdinbpl.4310:27|
 :skolemid |508|
...
)) (=> (= (ControlFlow 0 60) (- 0 59)) (forall ((n$0_6@@3 T@U) ) (!  (=> (and (= (type n$0_6@@3) RefType) (U_2_bool (MapType2Select g n$0_6@@3))) (>= (U_2_real (MapType1Select QPMask@0 n$0_6@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.4317:27|
 :skolemid |509|
 :pattern ( (MapType0Select Heap@@24 n$0_6@@3 next))
 :pattern ( (MapType1Select QPMask@6 n$0_6@@3 next))
 :pattern ( (MapType0Select Heap@@24 n$0_6@@3 next))
)))))))))
(let ((anon234_Then_correct  (and (=> (= (ControlFlow 0 55) (- 0 57)) (forall ((n$0_5 T@U) ) (!  (=> (= (type n$0_5) RefType) (=> (and (U_2_bool (MapType2Select g n$0_5)) (dummyFunction (MapType0Select PostHeap@0 n$0_5 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.4246:25|
 :skolemid |500|
 :pattern ( (MapType0Select PostHeap@0 n$0_5 next))
 :pattern ( (MapType1Select QPMask@5 n$0_5 next))
 :pattern ( (MapType0Select PostHeap@0 n$0_5 next))
 ...
 :pattern ( (MapType1Select QPMask@5 n$0_5@@0 next))
 :pattern ( (MapType0Select PostHeap@0 n$0_5@@0 next))
)) (and (=> (= (ControlFlow 0 55) (- 0 56)) (forall ((n$0_5@@1 T@U) (n$0_5_1 T@U) ) (!  (=> (and (= (type n$0_5@@1) RefType) (= (type n$0_5_1) RefType)) (=> (and (and (and (and (not (= n$0_5@@1 n$0_5_1)) (U_2_bool (MapType2Select g n$0_5@@1))) (U_2_bool (MapType2Select g n$0_5_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_5@@1 n$0_5_1))))
 :qid |stdinbpl.4253:25|
 :skolemid |501|
...
)) (=> (= (ControlFlow 0 55) (- 0 54)) (forall ((n$0_5@@3 T@U) ) (!  (=> (and (= (type n$0_5@@3) RefType) (U_2_bool (MapType2Select g n$0_5@@3))) (>= (U_2_real (MapType1Select QPMask@2 n$0_5@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.4260:25|
 :skolemid |502|
 :pattern ( (MapType0Select PostHeap@0 n$0_5@@3 next))
 :pattern ( (MapType1Select QPMask@5 n$0_5@@3 next))
 :pattern ( (MapType0Select PostHeap@0 n$0_5@@3 next))
)))))))))
(let ((anon122_correct true))
(let ((anon235_Then_correct  (=> (__learn_trigger__ (exists_path ($$ PostHeap@0 g) to_1 n_28)) (and (=> (= (ControlFlow 0 63) 60) anon236_Then_correct) (=> (= (ControlFlow 0 63) 52) anon122_correct)))))
(let ((anon235_Else_correct  (=> (and (not (__learn_trigger__ (exists_path ($$ PostHeap@0 g) to_1 n_28))) (= (ControlFlow 0 58) 52)) anon122_correct)))
(let ((anon233_Then_correct  (=> (U_2_bool (MapType2Select g n_28)) (and (and (=> (= (ControlFlow 0 64) 55) anon234_Then_correct) (=> (= (ControlFlow 0 64) 63) anon235_Then_correct)) (=> (= (ControlFlow 0 64) 58) anon235_Else_correct)))))
(let ((anon233_Else_correct  (=> (and (not (U_2_bool (MapType2Select g n_28))) (= (ControlFlow 0 53) 52)) anon122_correct)))
(let ((anon232_Else_correct true))
(let ((anon229_Else_correct  (=> (forall ((n_26 T@U) ) (!  (=> (= (type n_26) RefType) (=> (and (U_2_bool (MapType2Select g n_26)) (not (= n_26 from_1))) (__learn_trigger__ (DEP ($$ PostHeap@0 g) n_26 from_1 n_26 (MapType0Select PostHeap@0 n_26 next)))))
 :qid |stdinbpl.4228:20|
 :skolemid |499|
 :pattern ( (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| PostHeap@0 g))) g) n_26 to_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| PostHeap@0 g))) g) n_26 from_1))
...
(let ((anon231_Then_correct  (and (=> (= (ControlFlow 0 45) (- 0 47)) (forall ((n$0_4 T@U) ) (!  (=> (= (type n$0_4) RefType) (=> (and (U_2_bool (MapType2Select g n$0_4)) (dummyFunction (MapType0Select PostHeap@0 n$0_4 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.4175:25|
 :skolemid |492|
 :pattern ( (MapType0Select PostHeap@0 n$0_4 next))
 :pattern ( (MapType1Select QPMask@7 n$0_4 next))
 :pattern ( (MapType0Select PostHeap@0 n$0_4 next))
 ...
 :pattern ( (MapType1Select QPMask@7 n$0_4@@0 next))
 :pattern ( (MapType0Select PostHeap@0 n$0_4@@0 next))
)) (and (=> (= (ControlFlow 0 45) (- 0 46)) (forall ((n$0_4@@1 T@U) (n$0_4_1 T@U) ) (!  (=> (and (= (type n$0_4@@1) RefType) (= (type n$0_4_1) RefType)) (=> (and (and (and (and (not (= n$0_4@@1 n$0_4_1)) (U_2_bool (MapType2Select g n$0_4@@1))) (U_2_bool (MapType2Select g n$0_4_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_4@@1 n$0_4_1))))
 :qid |stdinbpl.4182:25|
 :skolemid |493|
...
)) (=> (= (ControlFlow 0 45) (- 0 44)) (forall ((n$0_4@@3 T@U) ) (!  (=> (and (= (type n$0_4@@3) RefType) (U_2_bool (MapType2Select g n$0_4@@3))) (>= (U_2_real (MapType1Select QPMask@2 n$0_4@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.4189:25|
 :skolemid |494|
 :pattern ( (MapType0Select PostHeap@0 n$0_4@@3 next))
 :pattern ( (MapType1Select QPMask@7 n$0_4@@3 next))
 :pattern ( (MapType0Select PostHeap@0 n$0_4@@3 next))
)))))))))
(let ((anon114_correct true))
(let ((anon231_Else_correct  (and (=> (= (ControlFlow 0 48) (- 0 49)) (HasDirectPerm QPMask@2 n_25 next)) (=> (HasDirectPerm QPMask@2 n_25 next) (=> (= (ControlFlow 0 48) 42) anon114_correct)))))
(let ((anon230_Then_correct  (=> (and (U_2_bool (MapType2Select g n_25)) (not (= n_25 from_1))) (and (=> (= (ControlFlow 0 50) 45) anon231_Then_correct) (=> (= (ControlFlow 0 50) 48) anon231_Else_correct)))))
(let ((anon230_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g n_25)) (not (= n_25 from_1)))) (= (ControlFlow 0 43) 42)) anon114_correct)))
(let ((anon226_Else_correct  (=> (forall ((n_24 T@U) ) (!  (=> (= (type n_24) RefType) (=> (and (U_2_bool (MapType2Select g n_24)) (not (= n_24 to_1))) (__learn_trigger__ (DEP ($$ PostHeap@0 g) to_1 n_24 to_1 (MapType0Select PostHeap@0 to_1 next)))))
 :qid |stdinbpl.4157:20|
 :skolemid |491|
 :pattern ( (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| PostHeap@0 g))) g) to_1 n_24))
 :pattern ( (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| PostHeap@0 g))) g) from_1 n_24))
...
(let ((anon228_Then_correct  (and (=> (= (ControlFlow 0 36) (- 0 38)) (forall ((n$0_3 T@U) ) (!  (=> (= (type n$0_3) RefType) (=> (and (U_2_bool (MapType2Select g n$0_3)) (dummyFunction (MapType0Select PostHeap@0 n$0_3 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.4104:25|
 :skolemid |484|
 :pattern ( (MapType0Select PostHeap@0 n$0_3 next))
 :pattern ( (MapType1Select QPMask@8 n$0_3 next))
 :pattern ( (MapType0Select PostHeap@0 n$0_3 next))
))) (=> (forall ((n$0_3@@0 T@U) ) (!  (=> (= (type n$0_3@@0) RefType) (=> (and (U_2_bool (MapType2Select g n$0_3@@0)) (dummyFunction (MapType0Select PostHeap@0 n$0_3@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.4104:25|
 :skolemid |484|
 :pattern ( (MapType0Select PostHeap@0 n$0_3@@0 next))
 :pattern ( (MapType1Select QPMask@8 n$0_3@@0 next))
 :pattern ( (MapType0Select PostHeap@0 n$0_3@@0 next))
)) (and (=> (= (ControlFlow 0 36) (- 0 37)) (forall ((n$0_3@@1 T@U) (n$0_3_1 T@U) ) (!  (=> (and (= (type n$0_3@@1) RefType) (= (type n$0_3_1) RefType)) (=> (and (and (and (and (not (= n$0_3@@1 n$0_3_1)) (U_2_bool (MapType2Select g n$0_3@@1))) (U_2_bool (MapType2Select g n$0_3_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_3@@1 n$0_3_1))))
 :qid |stdinbpl.4111:25|
 :skolemid |485|
...
)) (=> (= (ControlFlow 0 36) (- 0 35)) (forall ((n$0_3@@3 T@U) ) (!  (=> (and (= (type n$0_3@@3) RefType) (U_2_bool (MapType2Select g n$0_3@@3))) (>= (U_2_real (MapType1Select QPMask@2 n$0_3@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.4118:25|
 :skolemid |486|
 :pattern ( (MapType0Select PostHeap@0 n$0_3@@3 next))
 :pattern ( (MapType1Select QPMask@8 n$0_3@@3 next))
 :pattern ( (MapType0Select PostHeap@0 n$0_3@@3 next))
)))))))))
(let ((anon108_correct true))
(let ((anon228_Else_correct  (and (=> (= (ControlFlow 0 39) (- 0 40)) (HasDirectPerm QPMask@2 to_1 next)) (=> (HasDirectPerm QPMask@2 to_1 next) (=> (= (ControlFlow 0 39) 33) anon108_correct)))))
(let ((anon227_Then_correct  (=> (and (U_2_bool (MapType2Select g n_23)) (not (= n_23 to_1))) (and (=> (= (ControlFlow 0 41) 36) anon228_Then_correct) (=> (= (ControlFlow 0 41) 39) anon228_Else_correct)))))
(let ((anon227_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g n_23)) (not (= n_23 to_1)))) (= (ControlFlow 0 34) 33)) anon108_correct)))
(let ((anon223_Else_correct  (=> (forall ((n_22 T@U) ) (!  (=> (= (type n_22) RefType) (=> (and (U_2_bool (MapType2Select g n_22)) (not (= n_22 from_1))) (__learn_trigger__ (DEP ($$ PostHeap@0 g) from_1 n_22 from_1 (MapType0Select PostHeap@0 from_1 next)))))
 :qid |stdinbpl.4086:20|
 :skolemid |483|
 :pattern ( (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| PostHeap@0 g))) g) to_1 n_22))
 :pattern ( (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| PostHeap@0 g))) g) from_1 n_22))
...
(let ((anon225_Then_correct  (and (=> (= (ControlFlow 0 27) (- 0 29)) (forall ((n$0_2 T@U) ) (!  (=> (= (type n$0_2) RefType) (=> (and (U_2_bool (MapType2Select g n$0_2)) (dummyFunction (MapType0Select PostHeap@0 n$0_2 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.4033:25|
 :skolemid |476|
 :pattern ( (MapType0Select PostHeap@0 n$0_2 next))
 :pattern ( (MapType1Select QPMask@9 n$0_2 next))
 :pattern ( (MapType0Select PostHeap@0 n$0_2 next))
))) (=> (forall ((n$0_2@@0 T@U) ) (!  (=> (= (type n$0_2@@0) RefType) (=> (and (U_2_bool (MapType2Select g n$0_2@@0)) (dummyFunction (MapType0Select PostHeap@0 n$0_2@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.4033:25|
 :skolemid |476|
 :pattern ( (MapType0Select PostHeap@0 n$0_2@@0 next))
 :pattern ( (MapType1Select QPMask@9 n$0_2@@0 next))
 :pattern ( (MapType0Select PostHeap@0 n$0_2@@0 next))
)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (forall ((n$0_2@@1 T@U) (n$0_2_1 T@U) ) (!  (=> (and (= (type n$0_2@@1) RefType) (= (type n$0_2_1) RefType)) (=> (and (and (and (and (not (= n$0_2@@1 n$0_2_1)) (U_2_bool (MapType2Select g n$0_2@@1))) (U_2_bool (MapType2Select g n$0_2_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$0_2@@1 n$0_2_1))))
 :qid |stdinbpl.4040:25|
 :skolemid |477|
...
)) (=> (= (ControlFlow 0 27) (- 0 26)) (forall ((n$0_2@@3 T@U) ) (!  (=> (and (= (type n$0_2@@3) RefType) (U_2_bool (MapType2Select g n$0_2@@3))) (>= (U_2_real (MapType1Select QPMask@2 n$0_2@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.4047:25|
 :skolemid |478|
 :pattern ( (MapType0Select PostHeap@0 n$0_2@@3 next))
 :pattern ( (MapType1Select QPMask@9 n$0_2@@3 next))
 :pattern ( (MapType0Select PostHeap@0 n$0_2@@3 next))
)))))))))
(let ((anon102_correct true))
(let ((anon225_Else_correct  (and (=> (= (ControlFlow 0 30) (- 0 31)) (HasDirectPerm QPMask@2 from_1 next)) (=> (HasDirectPerm QPMask@2 from_1 next) (=> (= (ControlFlow 0 30) 24) anon102_correct)))))
(let ((anon224_Then_correct  (=> (and (U_2_bool (MapType2Select g n_21)) (not (= n_21 from_1))) (and (=> (= (ControlFlow 0 32) 27) anon225_Then_correct) (=> (= (ControlFlow 0 32) 30) anon225_Else_correct)))))
(let ((anon224_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g n_21)) (not (= n_21 from_1)))) (= (ControlFlow 0 25) 24)) anon102_correct)))
...
(let ((anon217_Else_correct  (=> (and (forall ((x_3_2 T@U) (y_3_2 T@U) (u_3@@0 T@U) (v_3_1@@0 T@U) ) (!  (=> (and (and (and (and (= (type x_3_2) RefType) (= (type y_3_2) RefType)) (= (type u_3@@0) RefType)) (= (type v_3_1@@0) RefType)) (and (DEP ($$ PostHeap@0 g) x_3_2 y_3_2 u_3@@0 v_3_1@@0) (not (DEP ($$ PostHeap@0 g) x_3_2 y_3_2 from_1 to_1)))) (DEP ($$ Heap@@24 g) x_3_2 y_3_2 u_3@@0 v_3_1@@0))
 :qid |stdinbpl.4014:22|
 :skolemid |475|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| PostHeap@0 g))) g) x_3_2 y_3_2 u_3@@0 v_3_1@@0))
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_3_2 y_3_2 u_3@@0 v_3_1@@0))
...
(let ((anon184_Else_correct  (=> (and (forall ((x_1_1 T@U) (y_1_1 T@U) (u_1_1@@1 T@U) (v_1_1@@1 T@U) ) (!  (=> (and (and (and (and (and (= (type x_1_1) RefType) (= (type y_1_1) RefType)) (= (type u_1_1@@1) RefType)) (= (type v_1_1@@1) RefType)) (and (not (= from_1 to_1)) (and (not (= u_1_1@@1 v_1_1@@1)) (not (= x_1_1 y_1_1))))) (or (DEP ($$ Heap@@24 g) x_1_1 y_1_1 u_1_1@@1 v_1_1@@1) (or (and (= x_1_1 from_1) (and (= u_1_1@@1 from_1) (and (= y_1_1 to_1) (= v_1_1@@1 to_1)))) (or (exists ((w_5 T@U) (z_5 T@U) ) (!  (and (and (= (type w_5) RefType) (= (type z_5) RefType)) (and (forall ((u__11 T@U) (v__11 T@U) ) (!  (=> (and (= (type u__11) RefType) (= (type v__11) RefType)) (not (DEP ($$ Heap@@24 g) x_1_1 y_1_1 u__11 v__11)))
 :qid |stdinbpl.3818:19|
 :skolemid |447|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_1_1 y_1_1 u__11 v__11))
)) (and (or (and (DEP ($$ Heap@@24 g) x_1_1 from_1 u_1_1@@1 v_1_1@@1) (not (= x_1_1 from_1))) (and (= x_1_1 u_1_1@@1) (and (= u_1_1@@1 from_1) (= v_1_1@@1 to_1)))) (or (and (DEP ($$ Heap@@24 g) to_1 y_1_1 w_5 z_5) (not (= to_1 y_1_1))) (and (= from_1 w_5) (and (= to_1 z_5) (= z_5 y_1_1)))))))
 :qid |stdinbpl.3816:213|
 :skolemid |448|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) to_1 y_1_1 w_5 z_5))
)) (or (exists ((U_5 T@U) (V_5 T@U) ) (!  (and (and (= (type U_5) RefType) (= (type V_5) RefType)) (and (forall ((u__12 T@U) (v__12 T@U) ) (!  (=> (and (= (type u__12) RefType) (= (type v__12) RefType)) (not (DEP ($$ Heap@@24 g) x_1_1 y_1_1 u__12 v__12)))
 :qid |stdinbpl.3824:19|
 :skolemid |449|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_1_1 y_1_1 u__12 v__12))
)) (and (or (and (DEP ($$ Heap@@24 g) x_1_1 from_1 U_5 V_5) (not (= x_1_1 from_1))) (and (= x_1_1 U_5) (and (= U_5 from_1) (= V_5 to_1)))) (or (and (DEP ($$ Heap@@24 g) to_1 y_1_1 u_1_1@@1 v_1_1@@1) (not (= to_1 y_1_1))) (and (= from_1 u_1_1@@1) (and (= to_1 v_1_1@@1) (= v_1_1@@1 y_1_1)))))))
 :qid |stdinbpl.3822:23|
 :skolemid |450|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_1_1 from_1 U_5 V_5))
)) (and (= u_1_1@@1 from_1) (and (= v_1_1@@1 to_1) (exists ((U_6 T@U) (V_6 T@U) (w_6 T@U) (z_6 T@U) ) (!  (and (and (and (and (= (type U_6) RefType) (= (type V_6) RefType)) (= (type w_6) RefType)) (= (type z_6) RefType)) (and (forall ((u__13 T@U) (v__13 T@U) ) (!  (=> (and (= (type u__13) RefType) (= (type v__13) RefType)) (not (DEP ($$ Heap@@24 g) x_1_1 y_1_1 u__13 v__13)))
 :qid |stdinbpl.3830:19|
 :skolemid |451|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_1_1 y_1_1 u__13 v__13))
)) (and (or (and (DEP ($$ Heap@@24 g) x_1_1 from_1 U_6 V_6) (not (= x_1_1 from_1))) (and (= x_1_1 U_6) (and (= U_6 from_1) (= V_6 to_1)))) (or (and (DEP ($$ Heap@@24 g) to_1 y_1_1 w_6 z_6) (not (= to_1 y_1_1))) (and (= from_1 w_6) (and (= to_1 z_6) (= z_6 y_1_1)))))))
 :qid |stdinbpl.3828:60|
 :skolemid |452|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_1_1 from_1 U_6 V_6) (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) to_1 y_1_1 w_6 z_6))
))))))))) (DEP ($$ PostHeap@0 g) x_1_1 y_1_1 u_1_1@@1 v_1_1@@1))
 :qid |stdinbpl.3814:22|
 :skolemid |453|
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| PostHeap@0 g))) g) x_1_1 y_1_1 u_1_1@@1 v_1_1@@1))
 :pattern ( (DEP (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@24 g))) g) x_1_1 y_1_1 u_1_1@@1 v_1_1@@1))
...
(let ((anon180_Else_correct  (=> (and (forall ((v1_1_1 T@U) (v2_1_1 T@U) ) (!  (=> (and (= (type v1_1_1) RefType) (= (type v2_1_1) RefType)) (= (edge ($$ PostHeap@0 g) v1_1_1 v2_1_1)  (or (edge ($$ Heap@@24 g) v1_1_1 v2_1_1) (and (= v1_1_1 from_1) (= v2_1_1 to_1)))))
 :qid |stdinbpl.3130:22|
 :skolemid |356|
 :pattern ( (edge (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| PostHeap@0 g))) g) v1_1_1 v2_1_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| PostHeap@0 g))) g) v1_1_1 v2_1_1))
...
(let ((anon178_Else_correct  (=> (and (|Set#Equal| ($$ PostHeap@0 g) ($$ Heap@@24 g)) (= (ControlFlow 0 195) 185)) anon25_correct)))
...
(let ((anon173_Else_correct  (=> (and (forall ((n$2_1 T@U) ) (!  (=> (= (type n$2_1) RefType) (=> (and (U_2_bool (MapType2Select g n$2_1)) (not (= (MapType0Select PostHeap@0 n$2_1 next) null))) (U_2_bool (MapType2Select g (MapType0Select PostHeap@0 n$2_1 next)))))
...
)) (state PostHeap@0 QPMask@2)) (and (=> (= (ControlFlow 0 197) (- 0 198)) (HasDirectPerm QPMask@2 from_1 next)) (=> (HasDirectPerm QPMask@2 from_1 next) (=> (and (= (MapType0Select PostHeap@0 from_1 next) to_1) (state PostHeap@0 QPMask@2)) (and (=> (= (ControlFlow 0 197) 196) anon176_Then_correct) (=> (= (ControlFlow 0 197) 186) anon176_Else_correct))))))))
(let ((anon18_correct true))
(let ((anon175_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g n$2_3)) (not (= (MapType0Select PostHeap@0 n$2_3 next) null)))) (= (ControlFlow 0 20) 17)) anon18_correct)))
(let ((anon175_Then_correct  (=> (and (U_2_bool (MapType2Select g n$2_3)) (not (= (MapType0Select PostHeap@0 n$2_3 next) null))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm QPMask@2 n$2_3 next)) (=> (HasDirectPerm QPMask@2 n$2_3 next) (=> (= (ControlFlow 0 18) 17) anon18_correct))))))
(let ((anon174_Else_correct  (=> (not (U_2_bool (MapType2Select g n$2_3))) (and (=> (= (ControlFlow 0 23) 18) anon175_Then_correct) (=> (= (ControlFlow 0 23) 20) anon175_Else_correct)))))
(let ((anon174_Then_correct  (=> (U_2_bool (MapType2Select g n$2_3)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (HasDirectPerm QPMask@2 n$2_3 next)) (=> (HasDirectPerm QPMask@2 n$2_3 next) (and (=> (= (ControlFlow 0 21) 18) anon175_Then_correct) (=> (= (ControlFlow 0 21) 20) anon175_Else_correct)))))))
(let ((anon172_Else_correct  (and (=> (= (ControlFlow 0 199) (- 0 201)) (forall ((n$1_1 T@U) (n$1_1_1 T@U) ) (!  (=> (and (= (type n$1_1) RefType) (= (type n$1_1_1) RefType)) (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (and (U_2_bool (MapType2Select g n$1_1)) (not (= n$1_1 from_1)))) (and (U_2_bool (MapType2Select g n$1_1_1)) (not (= n$1_1_1 from_1)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$1_1 n$1_1_1))))
 :qid |stdinbpl.2836:15|
 :skolemid |320|
...
))) (=> (forall ((n$1_1@@0 T@U) (n$1_1_1@@0 T@U) ) (!  (=> (and (= (type n$1_1@@0) RefType) (= (type n$1_1_1@@0) RefType)) (=> (and (and (and (and (not (= n$1_1@@0 n$1_1_1@@0)) (and (U_2_bool (MapType2Select g n$1_1@@0)) (not (= n$1_1@@0 from_1)))) (and (U_2_bool (MapType2Select g n$1_1_1@@0)) (not (= n$1_1_1@@0 from_1)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n$1_1@@0 n$1_1_1@@0))))
 :qid |stdinbpl.2836:15|
 :skolemid |320|
...
)) (=> (and (forall ((n$1_1@@1 T@U) ) (!  (=> (= (type n$1_1@@1) RefType) (=> (and (and (U_2_bool (MapType2Select g n$1_1@@1)) (not (= n$1_1@@1 from_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange25 n$1_1@@1) (= (invRecv25 n$1_1@@1) n$1_1@@1))))
 :qid |stdinbpl.2842:22|
 :skolemid |321|
 :pattern ( (MapType0Select PostHeap@0 n$1_1@@1 next))
 :pattern ( (MapType1Select QPMask@2 n$1_1@@1 next))
 :pattern ( (MapType0Select PostHeap@0 n$1_1@@1 next))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (U_2_bool (MapType2Select g (invRecv25 o_3))) (not (= (invRecv25 o_3) from_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange25 o_3)) (= (invRecv25 o_3) o_3)))
 :qid |stdinbpl.2846:22|
 :skolemid |322|
 :pattern ( (invRecv25 o_3))
))) (and (=> (= (ControlFlow 0 199) (- 0 200)) (forall ((n$1_1@@2 T@U) ) (!  (=> (= (type n$1_1@@2) RefType) (=> (and (U_2_bool (MapType2Select g n$1_1@@2)) (not (= n$1_1@@2 from_1))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.2852:15|
 :skolemid |323|
 :pattern ( (MapType0Select PostHeap@0 n$1_1@@2 next))
 :pattern ( (MapType1Select QPMask@2 n$1_1@@2 next))
 :pattern ( (MapType0Select PostHeap@0 n$1_1@@2 next))
))) (=> (forall ((n$1_1@@3 T@U) ) (!  (=> (= (type n$1_1@@3) RefType) (=> (and (U_2_bool (MapType2Select g n$1_1@@3)) (not (= n$1_1@@3 from_1))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.2852:15|
 :skolemid |323|
 :pattern ( (MapType0Select PostHeap@0 n$1_1@@3 next))
 :pattern ( (MapType1Select QPMask@2 n$1_1@@3 next))
 :pattern ( (MapType0Select PostHeap@0 n$1_1@@3 next))
)) (=> (and (and (forall ((n$1_1@@4 T@U) ) (!  (=> (= (type n$1_1@@4) RefType) (=> (and (and (U_2_bool (MapType2Select g n$1_1@@4)) (not (= n$1_1@@4 from_1))) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= n$1_1@@4 null))))
 :qid |stdinbpl.2858:22|
 :skolemid |324|
 :pattern ( (MapType0Select PostHeap@0 n$1_1@@4 next))
 :pattern ( (MapType1Select QPMask@2 n$1_1@@4 next))
 :pattern ( (MapType0Select PostHeap@0 n$1_1@@4 next))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (U_2_bool (MapType2Select g (invRecv25 o_3@@0))) (not (= (invRecv25 o_3@@0) from_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange25 o_3@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv25 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 next)) (+ (U_2_real (MapType1Select PostMask@0 o_3@@0 next)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (U_2_bool (MapType2Select g (invRecv25 o_3@@0))) (not (= (invRecv25 o_3@@0) from_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange25 o_3@@0))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 next)) (U_2_real (MapType1Select PostMask@0 o_3@@0 next))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 next))) (= (U_2_real (MapType1Select PostMask@0 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@2 o_3@@1 f_5))))))
 :qid |stdinbpl.2868:29|
 :skolemid |326|
...
(let ((anon171_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (not (U_2_bool (MapType2Select g null)))) (=> (and (and (U_2_bool (MapType2Select g from_1)) (not (= from_1 null))) (and (= PostMask@0 (MapType1Store ZeroMask from_1 next (real_2_U (+ (U_2_real (MapType1Select ZeroMask from_1 next)) FullPerm)))) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 202) 16) anon172_Then_correct) (=> (= (ControlFlow 0 202) 199) anon172_Else_correct))))))
(let ((anon171_Else_correct true))
(let ((anon170_Else_correct  (=> (and (not (exists_path ($$ Heap@@24 g) from_1 to_1)) (state Heap@@24 QPMask@0)) (and (=> (= (ControlFlow 0 203) 202) anon171_Then_correct) (=> (= (ControlFlow 0 203) 14) anon171_Else_correct)))))
(let ((anon170_Then_correct  (and (=> (= (ControlFlow 0 10) (- 0 12)) (forall ((n_2 T@U) ) (!  (=> (= (type n_2) RefType) (=> (and (U_2_bool (MapType2Select g n_2)) (dummyFunction (MapType0Select Heap@@24 n_2 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.2762:21|
 :skolemid |313|
 :pattern ( (MapType0Select Heap@@24 n_2 next))
 :pattern ( (MapType1Select QPMask@1 n_2 next))
 :pattern ( (MapType0Select Heap@@24 n_2 next))
))) (=> (forall ((n_2@@0 T@U) ) (!  (=> (= (type n_2@@0) RefType) (=> (and (U_2_bool (MapType2Select g n_2@@0)) (dummyFunction (MapType0Select Heap@@24 n_2@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.2762:21|
 :skolemid |313|
 :pattern ( (MapType0Select Heap@@24 n_2@@0 next))
 ...
 :skolemid |315|
 :pattern ( (MapType0Select Heap@@24 n_2@@3 next))
 :pattern ( (MapType1Select QPMask@1 n_2@@3 next))
 :pattern ( (MapType0Select Heap@@24 n_2@@3 next))
)))))))))
(let ((anon167_Else_correct  (=> (and (forall ((n$0_1 T@U) ) (!  (=> (= (type n$0_1) RefType) (=> (and (U_2_bool (MapType2Select g n$0_1)) (not (= (MapType0Select Heap@@24 n$0_1 next) null))) (U_2_bool (MapType2Select g (MapType0Select Heap@@24 n$0_1 next)))))
 :qid |stdinbpl.2740:20|
 :skolemid |312|
...
)) (state Heap@@24 QPMask@0)) (and (=> (= (ControlFlow 0 204) (- 0 205)) (HasDirectPerm QPMask@0 from_1 next)) (=> (HasDirectPerm QPMask@0 from_1 next) (=> (= (MapType0Select Heap@@24 from_1 next) null) (=> (and (state Heap@@24 QPMask@0) (state Heap@@24 QPMask@0)) (and (=> (= (ControlFlow 0 204) 10) anon170_Then_correct) (=> (= (ControlFlow 0 204) 203) anon170_Else_correct)))))))))
(let ((anon7_correct true))
(let ((anon169_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g n$0_8)) (not (= (MapType0Select Heap@@24 n$0_8 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon169_Then_correct  (=> (and (U_2_bool (MapType2Select g n$0_8)) (not (= (MapType0Select Heap@@24 n$0_8 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 n$0_8 next)) (=> (HasDirectPerm QPMask@0 n$0_8 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon168_Else_correct  (=> (not (U_2_bool (MapType2Select g n$0_8))) (and (=> (= (ControlFlow 0 8) 3) anon169_Then_correct) (=> (= (ControlFlow 0 8) 5) anon169_Else_correct)))))
(let ((anon168_Then_correct  (=> (U_2_bool (MapType2Select g n$0_8)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm QPMask@0 n$0_8 next)) (=> (HasDirectPerm QPMask@0 n$0_8 next) (and (=> (= (ControlFlow 0 6) 3) anon169_Then_correct) (=> (= (ControlFlow 0 6) 5) anon169_Else_correct)))))))
(let ((anon166_Else_correct  (and (=> (= (ControlFlow 0 206) (- 0 208)) (forall ((n_1 T@U) (n_1_1 T@U) ) (!  (=> (and (= (type n_1) RefType) (= (type n_1_1) RefType)) (=> (and (and (and (and (not (= n_1 n_1_1)) (and (U_2_bool (MapType2Select g n_1)) (not (= n_1 from_1)))) (and (U_2_bool (MapType2Select g n_1_1)) (not (= n_1_1 from_1)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_1 n_1_1))))
 :qid |stdinbpl.2689:15|
 :skolemid |305|
 :no-pattern (type n_1)
...
))) (=> (forall ((n_1@@0 T@U) (n_1_1@@0 T@U) ) (!  (=> (and (= (type n_1@@0) RefType) (= (type n_1_1@@0) RefType)) (=> (and (and (and (and (not (= n_1@@0 n_1_1@@0)) (and (U_2_bool (MapType2Select g n_1@@0)) (not (= n_1@@0 from_1)))) (and (U_2_bool (MapType2Select g n_1_1@@0)) (not (= n_1_1@@0 from_1)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_1@@0 n_1_1@@0))))
 :qid |stdinbpl.2689:15|
 :skolemid |305|
...
)) (=> (and (forall ((n_1@@1 T@U) ) (!  (=> (= (type n_1@@1) RefType) (=> (and (and (U_2_bool (MapType2Select g n_1@@1)) (not (= n_1@@1 from_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange23 n_1@@1) (= (invRecv23 n_1@@1) n_1@@1))))
 :qid |stdinbpl.2695:22|
 :skolemid |306|
 :pattern ( (MapType0Select Heap@@24 n_1@@1 next))
 :pattern ( (MapType1Select QPMask@0 n_1@@1 next))
 :pattern ( (MapType0Select Heap@@24 n_1@@1 next))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (U_2_bool (MapType2Select g (invRecv23 o_3@@2))) (not (= (invRecv23 o_3@@2) from_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange23 o_3@@2)) (= (invRecv23 o_3@@2) o_3@@2)))
 :qid |stdinbpl.2699:22|
 :skolemid |307|
 :pattern ( (invRecv23 o_3@@2))
))) (and (=> (= (ControlFlow 0 206) (- 0 207)) (forall ((n_1@@2 T@U) ) (!  (=> (= (type n_1@@2) RefType) (=> (and (U_2_bool (MapType2Select g n_1@@2)) (not (= n_1@@2 from_1))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.2705:15|
 :skolemid |308|
 :pattern ( (MapType0Select Heap@@24 n_1@@2 next))
 :pattern ( (MapType1Select QPMask@0 n_1@@2 next))
 :pattern ( (MapType0Select Heap@@24 n_1@@2 next))
))) (=> (forall ((n_1@@3 T@U) ) (!  (=> (= (type n_1@@3) RefType) (=> (and (U_2_bool (MapType2Select g n_1@@3)) (not (= n_1@@3 from_1))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.2705:15|
 :skolemid |308|
 :pattern ( (MapType0Select Heap@@24 n_1@@3 next))
 :pattern ( (MapType1Select QPMask@0 n_1@@3 next))
 :pattern ( (MapType0Select Heap@@24 n_1@@3 next))
)) (=> (and (and (forall ((n_1@@4 T@U) ) (!  (=> (= (type n_1@@4) RefType) (=> (and (and (U_2_bool (MapType2Select g n_1@@4)) (not (= n_1@@4 from_1))) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= n_1@@4 null))))
 :qid |stdinbpl.2711:22|
 :skolemid |309|
 :pattern ( (MapType0Select Heap@@24 n_1@@4 next))
 :pattern ( (MapType1Select QPMask@0 n_1@@4 next))
 :pattern ( (MapType0Select Heap@@24 n_1@@4 next))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (and (U_2_bool (MapType2Select g (invRecv23 o_3@@3))) (not (= (invRecv23 o_3@@3) from_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange23 o_3@@3)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv23 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 next)) (+ (U_2_real (MapType1Select Mask@0 o_3@@3 next)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (U_2_bool (MapType2Select g (invRecv23 o_3@@3))) (not (= (invRecv23 o_3@@3) from_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange23 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 next)) (U_2_real (MapType1Select Mask@0 o_3@@3 next))))))
 :qid |stdinbpl.2717:22|
 :skolemid |310|
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 next))) (= (U_2_real (MapType1Select Mask@0 o_3@@4 f_5@@0)) (U_2_real (MapType1Select QPMask@0 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.2721:29|
 :skolemid |311|
 :pattern ( (MapType1Select Mask@0 o_3@@4 f_5@@0))
 :pattern ( (MapType1Select QPMask@0 o_3@@4 f_5@@0))
)) (state Heap@@24 QPMask@0))) (and (and (=> (= (ControlFlow 0 206) 204) anon167_Else_correct) (=> (= (ControlFlow 0 206) 6) anon168_Then_correct)) (=> (= (ControlFlow 0 206) 8) anon168_Else_correct))))))))))
(let ((anon166_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@24 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@24 from_1 $allocated))) (and (U_2_bool (MapType0Select Heap@@24 to_1 $allocated)) (U_2_bool (MapType2Select g from_1)))) (=> (and (and (and (state Heap@@24 ZeroMask) (not (= to_1 null))) (and (state Heap@@24 ZeroMask) (not (U_2_bool (MapType2Select g null))))) (and (and (U_2_bool (MapType2Select g from_1)) (not (= from_1 null))) (and (= Mask@0 (MapType1Store ZeroMask from_1 next (real_2_U (+ (U_2_real (MapType1Select ZeroMask from_1 next)) FullPerm)))) (state Heap@@24 Mask@0)))) (and (=> (= (ControlFlow 0 209) 1) anon166_Then_correct) (=> (= (ControlFlow 0 209) 206) anon166_Else_correct)))))))
