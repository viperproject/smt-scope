...
(assert  (and (and (and (and (and (and (and (= (type QPMask@0) (MapType1Type RefType realType)) (= (type a_3@@1) IArrayDomainTypeType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type Heap@@13) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type pw@0) (SeqType intType))) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id client)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 34) (let ((anon15_Else_correct  (=> (= (ControlFlow 0 28) (- 0 27)) (forall ((i_5 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5 i_5_1)) (and (<= 0 i_5) (< i_5 (len a_3@@1)))) (and (<= 0 i_5_1) (< i_5_1 (len a_3@@1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_5) (loc a_3@@1 i_5_1))))
...
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 25)) (< 10 (len a_3@@1))) (=> (< 10 (len a_3@@1)) (and (=> (= (ControlFlow 0 7) (- 0 24)) (forall ((i_7 Int) (i_7_1 Int) ) (!  (=> (and (and (and (and (not (= i_7 i_7_1)) (and (<= 0 i_7) (<= i_7 10))) (and (<= 0 i_7_1) (<= i_7_1 10))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_7) (loc a_3@@1 i_7_1))))
 :qid |stdinbpl.3092:19|
 :skolemid |243|
 :pattern ( (neverTriggered21 i_7) (neverTriggered21 i_7_1))
))) (=> (forall ((i_7@@0 Int) (i_7_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_7@@0 i_7_1@@0)) (and (<= 0 i_7@@0) (<= i_7@@0 10))) (and (<= 0 i_7_1@@0) (<= i_7_1@@0 10))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_7@@0) (loc a_3@@1 i_7_1@@0))))
 :qid |stdinbpl.3092:19|
 :skolemid |243|
 :pattern ( (neverTriggered21 i_7@@0) (neverTriggered21 i_7_1@@0))
)) (and (=> (= (ControlFlow 0 7) (- 0 23)) (forall ((i_7@@1 Int) ) (!  (=> (and (<= 0 i_7@@1) (<= i_7@@1 10)) (>= (U_2_real (MapType1Select QPMask@0 (loc a_3@@1 i_7@@1) val)) FullPerm))
 :qid |stdinbpl.3099:19|
 :skolemid |244|
 :pattern ( (loc a_3@@1 i_7@@1))
 :pattern ( (loc a_3@@1 i_7@@1))
))) (=> (forall ((i_7@@2 Int) ) (!  (=> (and (<= 0 i_7@@2) (<= i_7@@2 10)) (>= (U_2_real (MapType1Select QPMask@0 (loc a_3@@1 i_7@@2) val)) FullPerm))
 :qid |stdinbpl.3099:19|
 :skolemid |244|
 :pattern ( (loc a_3@@1 i_7@@2))
 :pattern ( (loc a_3@@1 i_7@@2))
)) (=> (forall ((i_7@@3 Int) ) (!  (=> (and (and (<= 0 i_7@@3) (<= i_7@@3 10)) (< NoPerm FullPerm)) (and (qpRange21 (loc a_3@@1 i_7@@3)) (= (invRecv21 (loc a_3@@1 i_7@@3)) i_7@@3)))
 :qid |stdinbpl.3105:24|
 :skolemid |245|
 :pattern ( (loc a_3@@1 i_7@@3))
 :pattern ( (loc a_3@@1 i_7@@3))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (<= 0 (invRecv21 o_3)) (<= (invRecv21 o_3) 10)) (and (< NoPerm FullPerm) (qpRange21 o_3))) (= (loc a_3@@1 (invRecv21 o_3)) o_3)))
 :qid |stdinbpl.3109:24|
 :skolemid |246|
 :pattern ( (invRecv21 o_3))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (<= 0 (invRecv21 o_3@@0)) (<= (invRecv21 o_3@@0) 10)) (and (< NoPerm FullPerm) (qpRange21 o_3@@0))) (and (= (loc a_3@@1 (invRecv21 o_3@@0)) o_3@@0) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 val)) (- (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) FullPerm)))) (=> (not (and (and (<= 0 (invRecv21 o_3@@0)) (<= (invRecv21 o_3@@0) 10)) (and (< NoPerm FullPerm) (qpRange21 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 val)) (U_2_real (MapType1Select QPMask@0 o_3@@0 val))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.3121:31|
 :skolemid |248|
 :pattern ( (MapType1Select QPMask@1 o_3@@1 f_5))
)) (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@0 QPMask@1)) (and (<= 0 storeIndex@0) (<= storeIndex@0 10))) (and (=> (= (ControlFlow 0 7) (- 0 22)) (forall ((i_8 Int) (i_8_1 Int) ) (!  (=> (and (and (and (and (not (= i_8 i_8_1)) (and (<= 0 i_8) (<= i_8 10))) (and (<= 0 i_8_1) (<= i_8_1 10))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_8) (loc a_3@@1 i_8_1))))
 :qid |stdinbpl.3139:17|
 :skolemid |249|
))) (=> (forall ((i_8@@0 Int) (i_8_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_8@@0 i_8_1@@0)) (and (<= 0 i_8@@0) (<= i_8@@0 10))) (and (<= 0 i_8_1@@0) (<= i_8_1@@0 10))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_8@@0) (loc a_3@@1 i_8_1@@0))))
 :qid |stdinbpl.3139:17|
 :skolemid |249|
)) (=> (forall ((i_8@@1 Int) ) (!  (=> (and (and (<= 0 i_8@@1) (<= i_8@@1 10)) (< NoPerm FullPerm)) (and (qpRange22 (loc a_3@@1 i_8@@1)) (= (invRecv22 (loc a_3@@1 i_8@@1)) i_8@@1)))
 :qid |stdinbpl.3145:24|
 :skolemid |250|
 :pattern ( (loc a_3@@1 i_8@@1))
 :pattern ( (loc a_3@@1 i_8@@1))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (<= 0 (invRecv22 o_3@@2)) (<= (invRecv22 o_3@@2) 10)) (< NoPerm FullPerm)) (qpRange22 o_3@@2)) (= (loc a_3@@1 (invRecv22 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.3149:24|
 :skolemid |251|
 :pattern ( (invRecv22 o_3@@2))
)) (forall ((i_8@@2 Int) ) (!  (=> (and (<= 0 i_8@@2) (<= i_8@@2 10)) (not (= (loc a_3@@1 i_8@@2) null)))
 :qid |stdinbpl.3155:24|
 :skolemid |252|
 :pattern ( (loc a_3@@1 i_8@@2))
 :pattern ( (loc a_3@@1 i_8@@2))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (and (<= 0 (invRecv22 o_3@@3)) (<= (invRecv22 o_3@@3) 10)) (< NoPerm FullPerm)) (qpRange22 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@1 (invRecv22 o_3@@3)) o_3@@3)) (= (U_2_real (MapType1Select QPMask@2 o_3@@3 val)) (+ (U_2_real (MapType1Select QPMask@1 o_3@@3 val)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv22 o_3@@3)) (<= (invRecv22 o_3@@3) 10)) (< NoPerm FullPerm)) (qpRange22 o_3@@3))) (= (U_2_real (MapType1Select QPMask@2 o_3@@3 val)) (U_2_real (MapType1Select QPMask@1 o_3@@3 val))))))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 val))) (= (U_2_real (MapType1Select QPMask@1 o_3@@4 f_5@@0)) (U_2_real (MapType1Select QPMask@2 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.3165:31|
 :skolemid |254|
 :pattern ( (MapType1Select QPMask@1 o_3@@4 f_5@@0))
 :pattern ( (MapType1Select QPMask@2 o_3@@4 f_5@@0))
))) (and (state ExhaleHeap@0 QPMask@2) (= storeIndex@0 3))) (=> (and (and (and (forall ((i_9_1 Int) ) (!  (=> (and (<= 0 i_9_1) (< i_9_1 storeIndex@0)) (<= (U_2_int (MapType0Select ExhaleHeap@0 (loc a_3@@1 i_9_1) val)) (U_2_int (MapType0Select ExhaleHeap@0 (loc a_3@@1 storeIndex@0) val))))
 :qid |stdinbpl.3172:22|
 :skolemid |255|
 :pattern ( (loc a_3@@1 i_9_1))
)) (forall ((i_10_1 Int) ) (!  (=> (and (< storeIndex@0 i_10_1) (<= i_10_1 10)) (<= (U_2_int (MapType0Select ExhaleHeap@0 (loc a_3@@1 storeIndex@0) val)) (U_2_int (MapType0Select ExhaleHeap@0 (loc a_3@@1 i_10_1) val))))
 :qid |stdinbpl.3176:22|
 :skolemid |256|
 :pattern ( (loc a_3@@1 i_10_1))
))) (and (= (|Seq#Length| pw@0) 11) (forall ((i_11_1 Int) ) (!  (=> (and (<= 0 i_11_1) (< i_11_1 (|Seq#Length| pw@0))) (and (<= 0 (U_2_int (|Seq#Index| pw@0 i_11_1))) (<= (U_2_int (|Seq#Index| pw@0 i_11_1)) 10)))
 :qid |stdinbpl.3181:22|
 :skolemid |257|
 :pattern ( (|Seq#Index| pw@0 i_11_1))
)))) (and (and (forall ((i_12_1 Int) (j@@5 Int) ) (!  (=> (and (<= 0 i_12_1) (and (< i_12_1 j@@5) (< j@@5 (|Seq#Length| pw@0)))) (not (= (U_2_int (|Seq#Index| pw@0 i_12_1)) (U_2_int (|Seq#Index| pw@0 j@@5)))))
 :qid |stdinbpl.3185:22|
 :skolemid |258|
 :pattern ( (|Seq#Index| pw@0 i_12_1) (|Seq#Index| pw@0 j@@5))
)) (forall ((i_13 Int) ) (!  (=> (and (<= 0 i_13) (< i_13 (|Seq#Length| pw@0))) (= (U_2_int (MapType0Select ExhaleHeap@0 (loc a_3@@1 (+ 0 i_13)) val)) (U_2_int (MapType0Select Heap@@13 (loc a_3@@1 (U_2_int (|Seq#Index| pw@0 i_13))) val))))
 :qid |stdinbpl.3189:22|
 :skolemid |259|
 :pattern ( (|Seq#Index| pw@0 i_13))
))) (and (state ExhaleHeap@0 QPMask@2) (state ExhaleHeap@0 QPMask@2)))) (and (=> (= (ControlFlow 0 7) (- 0 21)) (= storeIndex@0 3)) (=> (= storeIndex@0 3) (=> (state ExhaleHeap@0 QPMask@2) (and (=> (= (ControlFlow 0 7) (- 0 20)) (HasDirectPerm QPMask@2 (loc a_3@@1 storeIndex@0) val)) (=> (HasDirectPerm QPMask@2 (loc a_3@@1 storeIndex@0) val) (and (=> (= (ControlFlow 0 7) (- 0 19)) (>= storeIndex@0 0)) (=> (>= storeIndex@0 0) (and (=> (= (ControlFlow 0 7) (- 0 18)) (< storeIndex@0 (|Seq#Length| pw@0))) (=> (< storeIndex@0 (|Seq#Length| pw@0)) (and (=> (= (ControlFlow 0 7) (- 0 17)) (HasDirectPerm QPMask@0 (loc a_3@@1 (U_2_int (|Seq#Index| pw@0 storeIndex@0))) val)) (=> (HasDirectPerm QPMask@0 (loc a_3@@1 (U_2_int (|Seq#Index| pw@0 storeIndex@0))) val) (and (=> (= (ControlFlow 0 7) (- 0 16)) (= (U_2_int (MapType0Select ExhaleHeap@0 (loc a_3@@1 storeIndex@0) val)) (U_2_int (MapType0Select Heap@@13 (loc a_3@@1 (U_2_int (|Seq#Index| pw@0 storeIndex@0))) val)))) (=> (= (U_2_int (MapType0Select ExhaleHeap@0 (loc a_3@@1 storeIndex@0) val)) (U_2_int (MapType0Select Heap@@13 (loc a_3@@1 (U_2_int (|Seq#Index| pw@0 storeIndex@0))) val))) (=> (state ExhaleHeap@0 QPMask@2) (and (=> (= (ControlFlow 0 7) (- 0 15)) (HasDirectPerm QPMask@0 (loc a_3@@1 0) val)) (=> (HasDirectPerm QPMask@0 (loc a_3@@1 0) val) (and (=> (= (ControlFlow 0 7) (- 0 14)) (= (U_2_int (MapType0Select Heap@@13 (loc a_3@@1 0) val)) 0)) (=> (= (U_2_int (MapType0Select Heap@@13 (loc a_3@@1 0) val)) 0) (=> (state ExhaleHeap@0 QPMask@2) (and (=> (= (ControlFlow 0 7) (- 0 13)) (HasDirectPerm QPMask@0 (loc a_3@@1 3) val)) (=> (HasDirectPerm QPMask@0 (loc a_3@@1 3) val) (and (=> (= (ControlFlow 0 7) (- 0 12)) (= (U_2_int (MapType0Select Heap@@13 (loc a_3@@1 3) val)) 3)) (=> (= (U_2_int (MapType0Select Heap@@13 (loc a_3@@1 3) val)) 3) (=> (state ExhaleHeap@0 QPMask@2) (and (=> (= (ControlFlow 0 7) (- 0 11)) (HasDirectPerm QPMask@0 (loc a_3@@1 2) val)) (=> (HasDirectPerm QPMask@0 (loc a_3@@1 2) val) (and (=> (= (ControlFlow 0 7) (- 0 10)) (HasDirectPerm QPMask@0 (loc a_3@@1 3) val)) (=> (HasDirectPerm QPMask@0 (loc a_3@@1 3) val) (and (=> (= (ControlFlow 0 7) (- 0 9)) (not (= (U_2_int (MapType0Select Heap@@13 (loc a_3@@1 2) val)) (U_2_int (MapType0Select Heap@@13 (loc a_3@@1 3) val))))) (=> (not (= (U_2_int (MapType0Select Heap@@13 (loc a_3@@1 2) val)) (U_2_int (MapType0Select Heap@@13 (loc a_3@@1 3) val)))) (=> (state ExhaleHeap@0 QPMask@2) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((i_6 Int) (i_6_1 Int) ) (!  (=> (and (and (and (and (not (= i_6 i_6_1)) (and (<= 0 i_6) (< i_6 (len a_3@@1)))) (and (<= 0 i_6_1) (< i_6_1 (len a_3@@1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_6) (loc a_3@@1 i_6_1))))
 :qid |stdinbpl.3265:17|
 :skolemid |260|
 :pattern ( (neverTriggered20 i_6) (neverTriggered20 i_6_1))
 ...
 :qid |stdinbpl.3265:17|
 :skolemid |260|
 :pattern ( (neverTriggered20 i_6@@0) (neverTriggered20 i_6_1@@0))
)) (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((i_6@@1 Int) ) (!  (=> (and (<= 0 i_6@@1) (< i_6@@1 (len a_3@@1))) (>= (U_2_real (MapType1Select QPMask@2 (loc a_3@@1 i_6@@1) val)) FullPerm))
 :qid |stdinbpl.3272:17|
 :skolemid |261|
 :pattern ( (loc a_3@@1 i_6@@1))
 :pattern ( (loc a_3@@1 i_6@@1))
)))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((anon12_Else_correct  (=> (and (forall ((i_3 Int) ) (!  (=> (and (<= 0 i_3) (<= i_3 10)) (= (U_2_int (MapType0Select Heap@@13 (loc a_3@@1 i_3) val)) i_3))
 :qid |stdinbpl.3016:20|
 :skolemid |236|
 :pattern ( (loc a_3@@1 i_3))
)) (state Heap@@13 QPMask@0)) (and (=> (= (ControlFlow 0 30) 29) anon14_Then_correct) (=> (= (ControlFlow 0 30) 7) anon14_Else_correct)))))
(let ((anon5_correct true))
(let ((anon13_Else_correct  (=> (and (not (and (<= 0 i_55) (<= i_55 10))) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon13_Then_correct  (=> (and (<= 0 i_55) (<= i_55 10)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 (loc a_3@@1 i_55) val)) (=> (HasDirectPerm QPMask@0 (loc a_3@@1 i_55) val) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 32)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (len a_3@@1)))) (and (<= 0 i_1_1) (< i_1_1 (len a_3@@1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_1) (loc a_3@@1 i_1_1))))
 :qid |stdinbpl.2974:15|
 :skolemid |230|
 ...
 :qid |stdinbpl.2974:15|
 :skolemid |230|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 (len a_3@@1))) (< NoPerm FullPerm)) (and (qpRange18 (loc a_3@@1 i_1@@1)) (= (invRecv18 (loc a_3@@1 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.2980:22|
 :skolemid |231|
 :pattern ( (loc a_3@@1 i_1@@1))
 :pattern ( (loc a_3@@1 i_1@@1))
)) (=> (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (and (<= 0 (invRecv18 o_3@@5)) (< (invRecv18 o_3@@5) (len a_3@@1))) (< NoPerm FullPerm)) (qpRange18 o_3@@5)) (= (loc a_3@@1 (invRecv18 o_3@@5)) o_3@@5)))
 ...
 :pattern ( (loc a_3@@1 i_1@@2))
))) (=> (and (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (and (<= 0 (invRecv18 o_3@@6)) (< (invRecv18 o_3@@6) (len a_3@@1))) (< NoPerm FullPerm)) (qpRange18 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@1 (invRecv18 o_3@@6)) o_3@@6)) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@6 val)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv18 o_3@@6)) (< (invRecv18 o_3@@6) (len a_3@@1))) (< NoPerm FullPerm)) (qpRange18 o_3@@6))) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 val)) (U_2_real (MapType1Select ZeroMask o_3@@6 val))))))
...
(let ((A@@14 (FieldTypeInv0 (type f_5@@1))))
 ...
 :qid |stdinbpl.3000:29|
 :skolemid |235|
 :pattern ( (MapType1Select ZeroMask o_3@@7 f_5@@1))
 :pattern ( (MapType1Select QPMask@0 o_3@@7 f_5@@1))
))) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0))) (and (and (=> (= (ControlFlow 0 31) 30) anon12_Else_correct) (=> (= (ControlFlow 0 31) 3) anon13_Then_correct)) (=> (= (ControlFlow 0 31) 5) anon13_Else_correct)))))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (< 10 (len a_3@@1)) (state Heap@@13 ZeroMask))) (and (=> (= (ControlFlow 0 33) 1) anon11_Then_correct) (=> (= (ControlFlow 0 33) 31) anon11_Else_correct)))))
