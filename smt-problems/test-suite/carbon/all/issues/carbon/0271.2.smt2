...
(assert  (and (and (and (and (and (= (type Heap@@27) (MapType0Type RefType)) (= (type this@@23) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |list2#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (= (MapType0Select Heap@@27 this@@23 next2) null) (=> (and (= Mask@3 Mask@1) (= (ControlFlow 0 4) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (not (= (MapType0Select Heap@@27 this@@23 next2) null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 this@@23 next2)) (=> (HasDirectPerm Mask@1 this@@23 next2) (=> (and (and (= Mask@2 (MapType1Store Mask@1 null (list2 (MapType0Select Heap@@27 this@@23 next2)) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (list2 (MapType0Select Heap@@27 this@@23 next2)))) FullPerm)))) (state Heap@@27 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 2) 1))) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@27 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@27 this@@23 $allocated))) (and (not (= this@@23 null)) (= Mask@0 (MapType1Store ZeroMask this@@23 elem2 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@23 elem2)) FullPerm)))))) (and (and (state Heap@@27 Mask@0) (not (= this@@23 null))) (and (= Mask@1 (MapType1Store Mask@0 this@@23 next2 (real_2_U (+ (U_2_real (MapType1Select Mask@0 this@@23 next2)) FullPerm)))) (state Heap@@27 Mask@1)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@1 this@@23 next2)) (=> (HasDirectPerm Mask@1 this@@23 next2) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))))
