...
(assert (forall ((y@@1 T@U) ) (!  (=> (= (type y@@1) RefType) (IsPredicateField (Q y@@1)))
 :qid |stdinbpl.292:15|
 :skolemid |36|
 :pattern ( (Q y@@1))
)))
...
(assert (forall ((Heap@@3 T@U) (y@@2 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type y@@2) RefType)) (|Q#everUsed| (Q y@@2)))
 :qid |stdinbpl.311:15|
 :skolemid |40|
 :pattern ( (|Q#trigger| Heap@@3 (Q y@@2)))
)))
(assert  (and (and (= (Ctor WandType_wandType) 14) (forall ((arg0@@27 T@U) (arg1@@9 Real) (arg2@@3 T@U) (arg3@@1 Real) (arg4 T@U) (arg5 Real) ) (! (= (type (|wand#ft| arg0@@27 arg1@@9 arg2@@3 arg3@@1 arg4 arg5)) (FieldType WandType_wandType FrameTypeType))
 :qid |funType:wand#ft|
 :pattern ( (|wand#ft| arg0@@27 arg1@@9 arg2@@3 arg3@@1 arg4 arg5))
))) (forall ((arg0@@28 T@U) (arg1@@10 Real) (arg2@@4 T@U) (arg3@@2 Real) (arg4@@0 T@U) (arg5@@0 Real) ) (! (= (type (|wand#sm| arg0@@28 arg1@@10 arg2@@4 arg3@@2 arg4@@0 arg5@@0)) (FieldType WandType_wandType (MapType1Type RefType boolType)))
 :qid |funType:wand#sm|
 :pattern ( (|wand#sm| arg0@@28 arg1@@10 arg2@@4 arg3@@2 arg4@@0 arg5@@0))
))))
...
(assert (forall ((y@@3 T@U) (y2 T@U) ) (!  (=> (and (and (= (type y@@3) RefType) (= (type y2) RefType)) (= (Q y@@3) (Q y2))) (= y@@3 y2))
 :qid |stdinbpl.302:15|
 :skolemid |38|
 :pattern ( (Q y@@3) (Q y2))
)))
(assert (forall ((arg0@@30 T@U) ) (! (= (type (|Q#sm| arg0@@30)) (FieldType PredicateType_QType (MapType1Type RefType boolType)))
 :qid |funType:Q#sm|
 :pattern ( (|Q#sm| arg0@@30))
)))
(assert (forall ((y@@4 T@U) (y2@@0 T@U) ) (!  (=> (and (and (= (type y@@4) RefType) (= (type y2@@0) RefType)) (= (|Q#sm| y@@4) (|Q#sm| y2@@0))) (= y@@4 y2@@0))
 :qid |stdinbpl.306:15|
 :skolemid |39|
 :pattern ( (|Q#sm| y@@4) (|Q#sm| y2@@0))
)))
...
(assert (forall ((arg0@@31 T@U) (arg1@@12 Real) (arg2@@6 T@U) (arg3@@4 Real) (arg4@@2 T@U) (arg5@@2 Real) ) (! (= (type (wand arg0@@31 arg1@@12 arg2@@6 arg3@@4 arg4@@2 arg5@@2)) (FieldType WandType_wandType intType))
 :qid |funType:wand|
 :pattern ( (wand arg0@@31 arg1@@12 arg2@@6 arg3@@4 arg4@@2 arg5@@2))
)))
...
(assert  (and (forall ((arg0@@32 Real) (arg1@@14 T@U) ) (! (= (type (ConditionalFrame arg0@@32 arg1@@14)) FrameTypeType)
 :qid |funType:ConditionalFrame|
 :pattern ( (ConditionalFrame arg0@@32 arg1@@14))
...
(assert (forall ((arg1@@15 T@U) (arg2@@8 Real) (arg3@@6 T@U) (arg4@@4 Real) (arg5@@4 T@U) (arg6@@1 Real) ) (!  (=> (and (and (= (type arg1@@15) RefType) (= (type arg3@@6) RefType)) (= (type arg5@@4) RefType)) (= (getPredWandId (wand arg1@@15 arg2@@8 arg3@@6 arg4@@4 arg5@@4 arg6@@1)) 2))
 :qid |stdinbpl.203:15|
 :skolemid |27|
...
(assert (forall ((y@@5 T@U) ) (!  (=> (= (type y@@5) RefType) (= (getPredWandId (Q y@@5)) 1))
 :qid |stdinbpl.296:15|
 :skolemid |37|
 :pattern ( (Q y@@5))
)))
...
(assert (forall ((y@@6 T@U) ) (!  (=> (= (type y@@6) RefType) (= (PredicateMaskField (Q y@@6)) (|Q#sm| y@@6)))
 :qid |stdinbpl.288:15|
 :skolemid |35|
 :pattern ( (PredicateMaskField (Q y@@6)))
)))
...
(assert  (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type x@@14) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |P#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 x@@14 $allocated))) (=> (and (and (not (= x@@14 null)) (= Mask@0 (MapType1Store ZeroMask x@@14 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@14 f_7)) FullPerm))))) (and (state Heap@@11 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@0 x@@14 f_7)))))
