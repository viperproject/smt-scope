...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (Ctor RefType) 8)) (= (type left) (FieldType NormalFieldType RefType))))
(assert (distinct $allocated left)
)
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type xs) (MapType2Type RefType boolType)) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type a_2) RefType)) (= (type b_2) RefType)) (= (type n) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv3 arg0@@43)) RefType)
...
(let ((anon15_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs n))) (= (ControlFlow 0 12) 7)) anon9_correct)))
(let ((anon15_Then_correct  (=> (U_2_bool (MapType2Select xs n)) (and (=> (= (ControlFlow 0 8) (- 0 11)) (HasDirectPerm QPMask@2 n left)) (=> (HasDirectPerm QPMask@2 n left) (and (=> (= (ControlFlow 0 8) (- 0 10)) true) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm QPMask@0 n left)) (=> (HasDirectPerm QPMask@0 n left) (=> (= (ControlFlow 0 8) 7) anon9_correct)))))))))
(let ((anon14_Else_correct  (=> (forall ((n_7 T@U) ) (!  (=> (and (= (type n_7) RefType) (U_2_bool (MapType2Select xs n_7))) (= (MapType0Select ExhaleHeap@0 n_7 left) (MapType0Select Heap@@9 n_7 left)))
 :qid |stdinbpl.609:20|
 :skolemid |100|
 :pattern ( (MapType2Select xs n_7) (MapType0Select ExhaleHeap@0 n_7 left))
)) (=> (and (state ExhaleHeap@0 QPMask@2) (state ExhaleHeap@0 QPMask@2)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm QPMask@2 a_2 left)) (=> (HasDirectPerm QPMask@2 a_2 left) (=> (= (ControlFlow 0 5) (- 0 4)) (= (MapType0Select ExhaleHeap@0 a_2 left) b_2))))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((n_5 T@U) (n_5_1 T@U) ) (!  (=> (and (= (type n_5) RefType) (= (type n_5_1) RefType)) (=> (and (and (and (and (not (= n_5 n_5_1)) (U_2_bool (MapType2Select xs n_5))) (U_2_bool (MapType2Select xs n_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_5 n_5_1))))
 :qid |stdinbpl.558:15|
 :skolemid |94|
 :no-pattern (type n_5)
...
))) (=> (forall ((n_5@@0 T@U) (n_5_1@@0 T@U) ) (!  (=> (and (= (type n_5@@0) RefType) (= (type n_5_1@@0) RefType)) (=> (and (and (and (and (not (= n_5@@0 n_5_1@@0)) (U_2_bool (MapType2Select xs n_5@@0))) (U_2_bool (MapType2Select xs n_5_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_5@@0 n_5_1@@0))))
 :qid |stdinbpl.558:15|
 :skolemid |94|
...
)) (=> (and (and (and (forall ((n_5@@1 T@U) ) (!  (=> (= (type n_5@@1) RefType) (=> (and (U_2_bool (MapType2Select xs n_5@@1)) (< NoPerm FullPerm)) (and (qpRange3 n_5@@1) (= (invRecv3 n_5@@1) n_5@@1))))
 :qid |stdinbpl.564:22|
 :skolemid |95|
 :pattern ( (MapType0Select ExhaleHeap@0 n_5@@1 left))
 :pattern ( (MapType1Select QPMask@2 n_5@@1 left))
 :pattern ( (MapType2Select xs n_5@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv3 o_3))) (< NoPerm FullPerm)) (qpRange3 o_3)) (= (invRecv3 o_3) o_3)))
 :qid |stdinbpl.568:22|
 :skolemid |96|
 :pattern ( (invRecv3 o_3))
))) (and (forall ((n_5@@2 T@U) ) (!  (=> (and (= (type n_5@@2) RefType) (U_2_bool (MapType2Select xs n_5@@2))) (not (= n_5@@2 null)))
 :qid |stdinbpl.574:22|
 :skolemid |97|
 :pattern ( (MapType0Select ExhaleHeap@0 n_5@@2 left))
 :pattern ( (MapType1Select QPMask@2 n_5@@2 left))
 :pattern ( (MapType2Select xs n_5@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs (invRecv3 o_3@@0))) (< NoPerm FullPerm)) (qpRange3 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 left)) (+ (U_2_real (MapType1Select QPMask@1 o_3@@0 left)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select xs (invRecv3 o_3@@0))) (< NoPerm FullPerm)) (qpRange3 o_3@@0))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 left)) (U_2_real (MapType1Select QPMask@1 o_3@@0 left))))))
 :qid |stdinbpl.580:22|
 :skolemid |98|
...
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 17)) (forall ((n_3 T@U) (n_3_1 T@U) ) (!  (=> (and (= (type n_3) RefType) (= (type n_3_1) RefType)) (=> (and (and (and (and (not (= n_3 n_3_1)) (U_2_bool (MapType2Select xs n_3))) (U_2_bool (MapType2Select xs n_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3 n_3_1))))
 :qid |stdinbpl.510:17|
 :skolemid |88|
 :pattern ( (neverTriggered2 n_3) (neverTriggered2 n_3_1))
))) (=> (forall ((n_3@@0 T@U) (n_3_1@@0 T@U) ) (!  (=> (and (= (type n_3@@0) RefType) (= (type n_3_1@@0) RefType)) (=> (and (and (and (and (not (= n_3@@0 n_3_1@@0)) (U_2_bool (MapType2Select xs n_3@@0))) (U_2_bool (MapType2Select xs n_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3@@0 n_3_1@@0))))
 :qid |stdinbpl.510:17|
 :skolemid |88|
 :pattern ( (neverTriggered2 n_3@@0) (neverTriggered2 n_3_1@@0))
)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((n_3@@1 T@U) ) (!  (=> (and (= (type n_3@@1) RefType) (U_2_bool (MapType2Select xs n_3@@1))) (>= (U_2_real (MapType1Select QPMask@0 n_3@@1 left)) FullPerm))
 :qid |stdinbpl.517:17|
 :skolemid |89|
 :pattern ( (MapType0Select Heap@@9 n_3@@1 left))
 :pattern ( (MapType1Select QPMask@1 n_3@@1 left))
 :pattern ( (MapType2Select xs n_3@@1))
))) (=> (forall ((n_3@@2 T@U) ) (!  (=> (and (= (type n_3@@2) RefType) (U_2_bool (MapType2Select xs n_3@@2))) (>= (U_2_real (MapType1Select QPMask@0 n_3@@2 left)) FullPerm))
 :qid |stdinbpl.517:17|
 :skolemid |89|
 :pattern ( (MapType0Select Heap@@9 n_3@@2 left))
 :pattern ( (MapType1Select QPMask@1 n_3@@2 left))
 :pattern ( (MapType2Select xs n_3@@2))
)) (=> (and (forall ((n_3@@3 T@U) ) (!  (=> (= (type n_3@@3) RefType) (=> (and (U_2_bool (MapType2Select xs n_3@@3)) (< NoPerm FullPerm)) (and (qpRange2 n_3@@3) (= (invRecv2 n_3@@3) n_3@@3))))
 :qid |stdinbpl.523:22|
 :skolemid |90|
 :pattern ( (MapType0Select Heap@@9 n_3@@3 left))
 :pattern ( (MapType1Select QPMask@1 n_3@@3 left))
 :pattern ( (MapType2Select xs n_3@@3))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType2Select xs (invRecv2 o_3@@2))) (and (< NoPerm FullPerm) (qpRange2 o_3@@2))) (= (invRecv2 o_3@@2) o_3@@2)))
 :qid |stdinbpl.527:22|
 :skolemid |91|
 :pattern ( (invRecv2 o_3@@2))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType2Select xs (invRecv2 o_3@@3))) (and (< NoPerm FullPerm) (qpRange2 o_3@@3))) (and (= (invRecv2 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 left)) (- (U_2_real (MapType1Select QPMask@0 o_3@@3 left)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select xs (invRecv2 o_3@@3))) (and (< NoPerm FullPerm) (qpRange2 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 left)) (U_2_real (MapType1Select QPMask@0 o_3@@3 left))))))
 :qid |stdinbpl.533:22|
 :skolemid |92|
 :pattern ( (MapType1Select QPMask@1 o_3@@3 left))
)) (forall ((o_3@@4 T@U) (f_5@@0 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_5@@0))))
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 left))) (= (U_2_real (MapType1Select QPMask@0 o_3@@4 f_5@@0)) (U_2_real (MapType1Select QPMask@1 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.539:29|
 :skolemid |93|
 :pattern ( (MapType1Select QPMask@1 o_3@@4 f_5@@0))
))) (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 QPMask@1) (state ExhaleHeap@0 QPMask@1))) (and (=> (= (ControlFlow 0 15) 3) anon13_Then_correct) (=> (= (ControlFlow 0 15) 13) anon13_Else_correct))))))))))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 20)) (forall ((n_1 T@U) (n_1_1 T@U) ) (!  (=> (and (= (type n_1) RefType) (= (type n_1_1) RefType)) (=> (and (and (and (and (not (= n_1 n_1_1)) (U_2_bool (MapType2Select xs n_1))) (U_2_bool (MapType2Select xs n_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1))))
 :qid |stdinbpl.444:15|
 :skolemid |82|
 :no-pattern (type n_1)
...
))) (=> (forall ((n_1@@0 T@U) (n_1_1@@0 T@U) ) (!  (=> (and (= (type n_1@@0) RefType) (= (type n_1_1@@0) RefType)) (=> (and (and (and (and (not (= n_1@@0 n_1_1@@0)) (U_2_bool (MapType2Select xs n_1@@0))) (U_2_bool (MapType2Select xs n_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1@@0 n_1_1@@0))))
 :qid |stdinbpl.444:15|
 :skolemid |82|
...
)) (=> (and (and (and (forall ((n_1@@1 T@U) ) (!  (=> (= (type n_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs n_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 n_1@@1) (= (invRecv1 n_1@@1) n_1@@1))))
 :qid |stdinbpl.450:22|
 :skolemid |83|
 :pattern ( (MapType0Select Heap@@9 n_1@@1 left))
 :pattern ( (MapType1Select QPMask@0 n_1@@1 left))
 :pattern ( (MapType2Select xs n_1@@1))
...
))) (and (forall ((n_1@@2 T@U) ) (!  (=> (and (= (type n_1@@2) RefType) (U_2_bool (MapType2Select xs n_1@@2))) (not (= n_1@@2 null)))
 :qid |stdinbpl.460:22|
 :skolemid |85|
 :pattern ( (MapType0Select Heap@@9 n_1@@2 left))
 :pattern ( (MapType1Select QPMask@0 n_1@@2 left))
 :pattern ( (MapType2Select xs n_1@@2))
)) (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs (invRecv1 o_3@@6))) (< NoPerm FullPerm)) (qpRange1 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@6) o_3@@6)) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 left)) (+ (U_2_real (MapType1Select ZeroMask o_3@@6 left)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select xs (invRecv1 o_3@@6))) (< NoPerm FullPerm)) (qpRange1 o_3@@6))) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 left)) (U_2_real (MapType1Select ZeroMask o_3@@6 left))))))
 :qid |stdinbpl.466:22|
 :skolemid |86|
 :pattern ( (MapType1Select QPMask@0 o_3@@6 left))
)))) (and (and (forall ((o_3@@7 T@U) (f_5@@1 T@U) ) (! (let ((B@@13 (FieldTypeInv1 (type f_5@@1))))
(let ((A@@14 (FieldTypeInv0 (type f_5@@1))))
 (=> (and (and (= (type o_3@@7) RefType) (= (type f_5@@1) (FieldType A@@14 B@@13))) (not (= f_5@@1 left))) (= (U_2_real (MapType1Select ZeroMask o_3@@7 f_5@@1)) (U_2_real (MapType1Select QPMask@0 o_3@@7 f_5@@1))))))
 :qid |stdinbpl.470:29|
 :skolemid |87|
 :pattern ( (MapType1Select ZeroMask o_3@@7 f_5@@1))
 :pattern ( (MapType1Select QPMask@0 o_3@@7 f_5@@1))
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm QPMask@0 a_2 left)) (=> (HasDirectPerm QPMask@0 a_2 left) (=> (and (and (= (MapType0Select Heap@@9 a_2 left) b_2) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 18) 2) anon12_Then_correct) (=> (= (ControlFlow 0 18) 15) anon12_Else_correct))))))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 a_2 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@9 b_2 $allocated)) (|Set#Equal| xs (|Set#UnionOne| (|Set#Singleton| b_2) a_2))) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 21) 1) anon11_Then_correct) (=> (= (ControlFlow 0 21) 18) anon11_Else_correct))))))
