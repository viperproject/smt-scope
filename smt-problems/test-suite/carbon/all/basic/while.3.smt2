...
(declare-fun n () Int)
(assert  (and (and (and (and (and (= (type Mask@3) (MapType1Type RefType realType)) (= (type r_1) RefType)) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))))
...
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@3 r_1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 r_1 f_7))) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
(let ((anon11_Then_correct  (=> (state ExhaleHeap@0 ZeroMask) (=> (and (and (not (= r_1 null)) (= Mask@3 (MapType1Store ZeroMask r_1 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1 f_7)) FullPerm))))) (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm Mask@3 r_1 f_7)) (=> (HasDirectPerm Mask@3 r_1 f_7) (=> (and (and (< i@0 (U_2_int (MapType0Select ExhaleHeap@0 r_1 f_7))) (state ExhaleHeap@0 Mask@3)) (and (= i@1 (+ i@0 1)) (state ExhaleHeap@0 Mask@3))) (and (=> (= (ControlFlow 0 7) 4) anon12_Then_correct) (=> (= (ControlFlow 0 7) 6) anon12_Else_correct)))))))))
(let ((anon11_Else_correct true))
(let ((anon10_Then_correct true))
(let ((anon2_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 r_1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 r_1 f_7)) FullPerm)))) (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@1)) (and (and (=> (= (ControlFlow 0 9) 1) anon10_Then_correct) (=> (= (ControlFlow 0 9) 7) anon11_Then_correct)) (=> (= (ControlFlow 0 9) 2) anon11_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon2_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@0 r_1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 r_1 f_7))) (=> (= (ControlFlow 0 10) 9) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@9 r_1 $allocated)) (> n 0)) (and (state Heap@@9 ZeroMask) (not (= r_1 null)))) (and (and (= Mask@0 (MapType1Store ZeroMask r_1 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1 f_7)) FullPerm)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)))) (and (=> (= (ControlFlow 0 13) 10) anon9_Then_correct) (=> (= (ControlFlow 0 13) 12) anon9_Else_correct))))))
