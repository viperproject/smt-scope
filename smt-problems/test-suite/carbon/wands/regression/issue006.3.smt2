...
(assert  (and (= (type xs@@3) (SeqType intType)) (= (type Heap@@13) (MapType0Type RefType))))
(set-info :boogie-vc-id |sum#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_correct true))
(let ((anon7_Else_correct  (=> (and (|sum#trigger| EmptyFrame (|Seq#Drop| xs@@3 1)) (= (ControlFlow 0 4) 2)) anon5_correct)))
(let ((anon6_Then_correct  (=> (and (= (|Seq#Length| xs@@3) 0) (= (ControlFlow 0 3) 2)) anon5_correct)))
(let ((anon7_Then_correct true))
(let ((anon6_Else_correct  (=> (not (= (|Seq#Length| xs@@3) 0)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< 0 (|Seq#Length| xs@@3))) (=> (< 0 (|Seq#Length| xs@@3)) (and (=> (= (ControlFlow 0 5) 1) anon7_Then_correct) (=> (= (ControlFlow 0 5) 4) anon7_Else_correct)))))))
(let ((anon0_correct  (=> (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 7) 3) anon6_Then_correct) (=> (= (ControlFlow 0 7) 5) anon6_Else_correct)))))
