...
(declare-fun |last#trigger| (T@U T@U) Bool)
...
(let ((anon19_Else_correct  (=> (= (MapType0Select Heap@1 xs@@42 next) null) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 8) 6)) anon13_correct))))
(let ((anon19_Then_correct  (=> (not (= (MapType0Select Heap@1 xs@@42 next) null)) (=> (and (and (forall ((o_7 T@U) (f_11 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_11))))
(let ((A@@12 (FieldTypeInv0 (type f_11))))
 (=> (and (and (= (type o_7) RefType) (= (type f_11) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|list#sm| xs@@42)) o_7 f_11)) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|list#sm| (MapType0Select Heap@1 xs@@42 next))) o_7 f_11)))) (U_2_bool (MapType1Select newPMask@0 o_7 f_11)))))
 :qid |stdinbpl.1207:33|
 :skolemid |83|
 :pattern ( (MapType1Select newPMask@0 o_7 f_11))
)) (= Heap@2 (MapType0Store Heap@1 null (|list#sm| xs@@42) newPMask@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 7) 6))) anon13_correct))))
(let ((anon11_correct  (=> (and (= Heap@0 (MapType0Store Heap@@47 null (|list#sm| xs@@42) (MapType1Store (MapType0Select Heap@@47 null (|list#sm| xs@@42)) xs@@42 next (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|list#sm| xs@@42) (MapType1Store (MapType0Select Heap@0 null (|list#sm| xs@@42)) xs@@42 val (bool_2_U true))))) (and (=> (= (ControlFlow 0 9) 7) anon19_Then_correct) (=> (= (ControlFlow 0 9) 8) anon19_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (|last#trigger| (MapType0Select Heap@@47 null (list (MapType0Select Heap@@47 xs@@42 next))) (MapType0Select Heap@@47 xs@@42 next)) (= (ControlFlow 0 12) 9)) anon11_correct)))
(let ((anon16_Then_correct  (=> (= (MapType0Select Heap@@47 xs@@42 next) null) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm UnfoldingMask@4 xs@@42 val)) (=> (HasDirectPerm UnfoldingMask@4 xs@@42 val) (=> (= (ControlFlow 0 10) 9) anon11_correct))))))
...
(let ((anon4_correct  (=> (state Heap@@47 UnfoldingMask@4) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm UnfoldingMask@4 xs@@42 next)) (=> (HasDirectPerm UnfoldingMask@4 xs@@42 next) (and (=> (= (ControlFlow 0 15) 10) anon16_Then_correct) (=> (= (ControlFlow 0 15) 13) anon16_Else_correct)))))))
