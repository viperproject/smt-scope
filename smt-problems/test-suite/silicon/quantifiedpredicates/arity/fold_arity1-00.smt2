(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:24:12
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quantifiedpredicates/arity/fold_arity1.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (and
  (not (= ($SortWrappers.$RefTo$Snap x@35@01) $Snap.unit))
  (=
    ($PSF.lookup_p3 (as sm@49@01  $PSF<p3>) ($SortWrappers.$RefTo$Snap x@35@01))
    ($PSF.lookup_p3 (as sm@46@01  $PSF<p3>) ($SortWrappers.$RefTo$Snap x@35@01)))))
(assert (=>
  (ite
    (and (img@40@01 x@35@01) (Seq_contains xs@36@01 (inv@39@01 x@35@01)))
    (< $Perm.No (- $Perm.Write (pTaken@43@01 x@35@01)))
    false)
  (and
    (not (= ($SortWrappers.$RefTo$Snap x@35@01) $Snap.unit))
    (=
...
; [eval] (x in xs)
(assert (Seq_contains xs@56@01 x@54@01))
(declare-const r@58@01 $Ref)
(push) ; 2
; [eval] (r in xs)
(assert (Seq_contains xs@56@01 r@58@01))
(pop) ; 2
(declare-fun inv@59@01 ($Ref Int) $Ref)
...
(assert (not (forall ((r1@58@01 $Ref) (r2@58@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@56@01 r1@58@01)
      (Seq_contains xs@56@01 r2@58@01)
      (= r1@58@01 r2@58@01))
    (= r1@58@01 r2@58@01))
...
(assert (forall ((r@58@01 $Ref)) (!
  (=>
    (Seq_contains xs@56@01 r@58@01)
    (and (= (inv@59@01 r@58@01 i@55@01) r@58@01) (img@60@01 r@58@01 i@55@01)))
  :pattern ((Seq_contains xs@56@01 r@58@01))
  :pattern ((Seq_contains_trigger xs@56@01 r@58@01))
  :pattern ((Seq_contains_trigger xs@56@01 r@58@01))
  :pattern ((inv@59@01 r@58@01 i@55@01))
  :pattern ((img@60@01 r@58@01 i@55@01))
  :qid |quant-u-28|)))
(assert (forall ((r $Ref) (i Int)) (!
  (=>
    (and (img@60@01 r i) (Seq_contains xs@56@01 (inv@59@01 r i)))
    (and (= (inv@59@01 r i) r) (= i@55@01 i)))
  :pattern ((inv@59@01 r i))
  :qid |p4-fctOfInv|)))
; Permissions are non-negative
; State saturation: after contract
(set-option :timeout 50)
...
(push) ; 3
; [eval] (r in xs)
(assert (Seq_contains xs@56@01 r@61@01))
(pop) ; 3
(declare-const $t@62@01 $PSF<p4>)
(declare-fun inv@63@01 ($Ref Int) $Ref)
(declare-fun img@64@01 ($Ref Int) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((r1@61@01 $Ref) (r2@61@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@56@01 r1@61@01)
      (Seq_contains xs@56@01 r2@61@01)
      (= r1@61@01 r2@61@01))
    (= r1@61@01 r2@61@01))
...
(assert (forall ((r@61@01 $Ref)) (!
  (=>
    (Seq_contains xs@56@01 r@61@01)
    (and (= (inv@63@01 r@61@01 i@55@01) r@61@01) (img@64@01 r@61@01 i@55@01)))
  :pattern ((Seq_contains xs@56@01 r@61@01))
  :pattern ((Seq_contains_trigger xs@56@01 r@61@01))
  :pattern ((Seq_contains_trigger xs@56@01 r@61@01))
  :pattern ((inv@63@01 r@61@01 i@55@01))
  :pattern ((img@64@01 r@61@01 i@55@01))
  :qid |quant-u-30|)))
(assert (forall ((r $Ref) (i Int)) (!
  (=>
    (and (img@64@01 r i) (Seq_contains xs@56@01 (inv@63@01 r i)))
    (and (= (inv@63@01 r i) r) (= i@55@01 i)))
  :pattern ((inv@63@01 r i))
  :qid |p4-fctOfInv|)))
; Permissions are non-negative
(pop) ; 2
(push) ; 2
...
(assert (not (forall ((r $Ref) (i Int)) (!
  (=>
    (and (= r x@54@01) (= i i@55@01))
    (= (- $Perm.Write (pTaken@65@01 r i)) $Perm.No))
...
(assert (=>
  (and
    (img@60@01 x@54@01 i@55@01)
    (Seq_contains xs@56@01 (inv@59@01 x@54@01 i@55@01)))
  (and
    (not
      (=
        ($Snap.combine
          ($SortWrappers.$RefTo$Snap x@54@01)
    ...
    (=
      ($PSF.lookup_p4 (as sm@66@01  $PSF<p4>) ($Snap.combine
        ($SortWrappers.$RefTo$Snap x@54@01)
        ($SortWrappers.IntTo$Snap i@55@01)))
      ($PSF.lookup_p4 ($SortWrappers.$SnapTo$PSF<p4> ($Snap.second $t@57@01)) ($Snap.combine
        ($SortWrappers.$RefTo$Snap x@54@01)
        ($SortWrappers.IntTo$Snap i@55@01)))))))
...
(check-sat)
; unknown
(assert (p4%trigger ($SortWrappers.IntTo$Snap ($PSF.lookup_p4 (as sm@66@01  $PSF<p4>) ($Snap.combine
  ($SortWrappers.$RefTo$Snap x@54@01)
  ($SortWrappers.IntTo$Snap i@55@01)))) x@54@01 i@55@01))
; [exec]
; x.f := 4
; [exec]
; fold acc(p4(x, i), write)
(assert (p4%trigger ($SortWrappers.IntTo$Snap 4) x@54@01 i@55@01))
(declare-const sm@68@01 $PSF<p4>)
; Definitional axioms for singleton-SM's value
(assert (=
  ($PSF.lookup_p4 (as sm@68@01  $PSF<p4>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap x@54@01)
    ($SortWrappers.IntTo$Snap i@55@01)))
  4))
...
(push) ; 3
; [eval] (r in xs)
(assert (Seq_contains xs@56@01 r@69@01))
(pop) ; 3
(declare-fun inv@70@01 ($Ref Int) $Ref)
(declare-fun img@71@01 ($Ref Int) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((r1@69@01 $Ref) (r2@69@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@56@01 r1@69@01)
      (Seq_contains xs@56@01 r2@69@01)
      (= r1@69@01 r2@69@01))
    (= r1@69@01 r2@69@01))
...
; (get-info :all-statistics)
; Definitional axioms for inverse functions
(assert (forall ((r@69@01 $Ref)) (!
  (=>
    (Seq_contains xs@56@01 r@69@01)
    (and (= (inv@70@01 r@69@01 i@55@01) r@69@01) (img@71@01 r@69@01 i@55@01)))
  :pattern ((Seq_contains xs@56@01 r@69@01))
  :pattern ((Seq_contains_trigger xs@56@01 r@69@01))
  :pattern ((inv@70@01 r@69@01 i@55@01))
  :pattern ((img@71@01 r@69@01 i@55@01))
  :qid |p4-invOfFct|)))
(assert (forall ((r $Ref) (i Int)) (!
  (=>
    (and (img@71@01 r i) (Seq_contains xs@56@01 (inv@70@01 r i)))
    (and (= (inv@70@01 r i) r) (= i@55@01 i)))
  :pattern ((inv@70@01 r i))
  :qid |p4-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@72@01 ((r $Ref) (i Int)) $Perm
  (ite
    (and
      (Seq_contains xs@56@01 (inv@70@01 r i))
      (img@71@01 r i)
      (and (= r (inv@70@01 r i)) (= i i@55@01)))
    ($Perm.min
      (ite
        (and (img@60@01 r i) (Seq_contains xs@56@01 (inv@59@01 r i)))
        (- $Perm.Write (pTaken@65@01 r i))
        $Perm.No)
      $Perm.Write)
    $Perm.No))
(define-fun pTaken@73@01 ((r $Ref) (i Int)) $Perm
  (ite
    (and
      (Seq_contains xs@56@01 (inv@70@01 r i))
      (img@71@01 r i)
      (and (= r (inv@70@01 r i)) (= i i@55@01)))
    ($Perm.min
      (ite (and (= r x@54@01) (= i i@55@01)) $Perm.Write $Perm.No)
      (- $Perm.Write (pTaken@72@01 r i)))
    $Perm.No))
; Done precomputing, updating quantified chunks
; State saturation: before repetition
(set-option :timeout 10)
...
(push) ; 3
(set-option :timeout 500)
(assert (not (= (- $Perm.Write (pTaken@73@01 x@54@01 i@55@01)) $Perm.No)))
(check-sat)
; unsat
(pop) ; 3
; 0,00s
...
(assert (not (forall ((r $Ref) (i Int)) (!
  (=>
    (and
      ...
      (img@71@01 r i)
      (and (= r (inv@70@01 r i)) (= i i@55@01)))
    (= (- (- $Perm.Write (pTaken@72@01 r i)) (pTaken@73@01 r i)) $Perm.No))
...
; Final check if taken enough permissions
; Done removing quantified permissions
(declare-const sm@74@01 $PSF<p4>)
(declare-const s@75@01 $Snap)
; Definitional axioms for snapshot map domain
(assert (forall ((s@75@01 $Snap)) (!
  (and
    (=>
      (Set_in s@75@01 ($PSF.domain_p4 (as sm@74@01  $PSF<p4>)))
      (and
        (Seq_contains
          xs@56@01
          (inv@70@01 ($SortWrappers.$SnapTo$Ref ($Snap.first s@75@01)) ($SortWrappers.$SnapToInt ($Snap.second s@75@01))))
        (img@71@01 ($SortWrappers.$SnapTo$Ref ($Snap.first s@75@01)) ($SortWrappers.$SnapToInt ($Snap.second s@75@01)))))
    (=>
      (and
        (Seq_contains
          xs@56@01
        ...
        (img@71@01 ($SortWrappers.$SnapTo$Ref ($Snap.first s@75@01)) ($SortWrappers.$SnapToInt ($Snap.second s@75@01))))
      (Set_in s@75@01 ($PSF.domain_p4 (as sm@74@01  $PSF<p4>)))))
  :pattern ((Set_in s@75@01 ($PSF.domain_p4 (as sm@74@01  $PSF<p4>))))
  :qid |qp.psmDomDef11|)))
  ...
  (=>
    (and
      (and
        ...
        (img@71@01 ($SortWrappers.$SnapTo$Ref ($Snap.first s@75@01)) ($SortWrappers.$SnapToInt ($Snap.second s@75@01))))
      (and
        (= ($SortWrappers.$SnapTo$Ref ($Snap.first s@75@01)) x@54@01)
        (= ($SortWrappers.$SnapToInt ($Snap.second s@75@01)) i@55@01)))
    (and
      (not (= s@75@01 $Snap.unit))
      (=
        ($PSF.lookup_p4 (as sm@74@01  $PSF<p4>) s@75@01)
        ($PSF.lookup_p4 (as sm@68@01  $PSF<p4>) s@75@01))))
  :pattern (($PSF.lookup_p4 (as sm@74@01  $PSF<p4>) s@75@01))
  :pattern (($PSF.lookup_p4 (as sm@68@01  $PSF<p4>) s@75@01))
  :qid |qp.psmValDef9|)))
(assert (forall ((s@75@01 $Snap)) (!
  (=>
    (and
      ...
      (ite
        (and
          (img@60@01 ($SortWrappers.$SnapTo$Ref ($Snap.first s@75@01)) ($SortWrappers.$SnapToInt ($Snap.second s@75@01)))
          (Seq_contains
            xs@56@01
            (inv@59@01 ($SortWrappers.$SnapTo$Ref ($Snap.first s@75@01)) ($SortWrappers.$SnapToInt ($Snap.second s@75@01)))))
        (<
          $Perm.No
          (-
            $Perm.Write
            (pTaken@65@01 ($SortWrappers.$SnapTo$Ref ($Snap.first s@75@01)) ($SortWrappers.$SnapToInt ($Snap.second s@75@01)))))
        false))
    (and
      (not (= s@75@01 $Snap.unit))
      (=
        ($PSF.lookup_p4 (as sm@74@01  $PSF<p4>) s@75@01)
        ($PSF.lookup_p4 ($SortWrappers.$SnapTo$PSF<p4> ($Snap.second $t@57@01)) s@75@01))))
  :pattern (($PSF.lookup_p4 (as sm@74@01  $PSF<p4>) s@75@01))
  :pattern (($PSF.lookup_p4 ($SortWrappers.$SnapTo$PSF<p4> ($Snap.second $t@57@01)) s@75@01))
  :qid |qp.psmValDef10|)))
(pop) ; 2
(pop) ; 1
; ---------- m5 ----------
...
(declare-const xs@81@01 Seq<$Ref>)
(set-option :timeout 0)
(push) ; 1
...
; [eval] (x in xs)
(assert (Seq_contains xs@81@01 x@79@01))
(declare-const r@83@01 $Ref)
(push) ; 2
; [eval] (r in xs)
(assert (Seq_contains xs@81@01 r@83@01))
(pop) ; 2
(declare-fun inv@84@01 ($Ref Int) $Ref)
(declare-fun img@85@01 ($Ref Int) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((r1@83@01 $Ref) (r2@83@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@81@01 r1@83@01)
      (Seq_contains xs@81@01 r2@83@01)
      (= r1@83@01 r2@83@01))
    (= r1@83@01 r2@83@01))
...
(assert (forall ((r@83@01 $Ref)) (!
  (=>
    (Seq_contains xs@81@01 r@83@01)
    (and (= (inv@84@01 r@83@01 i@80@01) r@83@01) (img@85@01 r@83@01 i@80@01)))
  :pattern ((Seq_contains xs@81@01 r@83@01))
  :pattern ((Seq_contains_trigger xs@81@01 r@83@01))
  :pattern ((Seq_contains_trigger xs@81@01 r@83@01))
  :pattern ((inv@84@01 r@83@01 i@80@01))
  :pattern ((img@85@01 r@83@01 i@80@01))
  :qid |quant-u-42|)))
(assert (forall ((r $Ref) (i Int)) (!
  (=>
    (and (img@85@01 r i) (Seq_contains xs@81@01 (inv@84@01 r i)))
    (and (= (inv@84@01 r i) r) (= i@80@01 i)))
  :pattern ((inv@84@01 r i))
  :qid |p5-fctOfInv|)))
; Permissions are non-negative
; State saturation: after contract
(set-option :timeout 50)
...
; Final check if taken enough permissions
; Done removing quantified permissions
(declare-const sm@87@01 $PSF<p5>)
(declare-const s@88@01 $Snap)
; Definitional axioms for snapshot map values (instantiated)
(assert (=>
  (and
    (img@85@01 x@79@01 i@80@01)
    (Seq_contains xs@81@01 (inv@84@01 x@79@01 i@80@01)))
  (and
    (not
      (=
        ($Snap.combine
          ($SortWrappers.$RefTo$Snap x@79@01)
          ($SortWrappers.IntTo$Snap i@80@01))
        $Snap.unit))
    (=
      ($PSF.lookup_p5 (as sm@87@01  $PSF<p5>) ($Snap.combine
        ($SortWrappers.$RefTo$Snap x@79@01)
        ($SortWrappers.IntTo$Snap i@80@01)))
      ($PSF.lookup_p5 ($SortWrappers.$SnapTo$PSF<p5> ($Snap.second $t@82@01)) ($Snap.combine
        ($SortWrappers.$RefTo$Snap x@79@01)
        ($SortWrappers.IntTo$Snap i@80@01)))))))
(assert (=
  ($PSF.lookup_p5 (as sm@87@01  $PSF<p5>) ($Snap.combine
    ...
    ($SortWrappers.IntTo$Snap i@80@01)))
  ($Snap.combine
    ($Snap.first ($PSF.lookup_p5 (as sm@87@01  $PSF<p5>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap x@79@01)
      ($SortWrappers.IntTo$Snap i@80@01))))
    ($Snap.second ($PSF.lookup_p5 (as sm@87@01  $PSF<p5>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap x@79@01)
      ($SortWrappers.IntTo$Snap i@80@01)))))))
...
; [eval] r.f == i
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($PSF.lookup_p5 (as sm@87@01  $PSF<p5>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap x@79@01)
    ($SortWrappers.IntTo$Snap i@80@01)))))
  i@80@01))
; State saturation: after unfold
...
(check-sat)
; unknown
(assert (p5%trigger ($PSF.lookup_p5 (as sm@87@01  $PSF<p5>) ($Snap.combine
  ($SortWrappers.$RefTo$Snap x@79@01)
  ($SortWrappers.IntTo$Snap i@80@01))) x@79@01 i@80@01))
; [exec]
; assert x.f == i
; [eval] x.f == i
; [exec]
...
; [eval] r.f == i
(assert (p5%trigger ($Snap.combine ($SortWrappers.IntTo$Snap 4) $Snap.unit) x@79@01 4))
...
(declare-const xs@92@01 Seq<$Ref>)
...
; [eval] (x in xs)
(assert (Seq_contains xs@95@01 x@93@01))
(declare-const r@97@01 $Ref)
(push) ; 2
; [eval] (r in xs)
(assert (Seq_contains xs@95@01 r@97@01))
(pop) ; 2
(declare-fun inv@98@01 ($Ref Int) $Ref)
(declare-fun img@99@01 ($Ref Int) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((r1@97@01 $Ref) (r2@97@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@95@01 r1@97@01)
      (Seq_contains xs@95@01 r2@97@01)
      (= r1@97@01 r2@97@01))
    (= r1@97@01 r2@97@01))
...
(assert (forall ((r@97@01 $Ref)) (!
  (=>
    (Seq_contains xs@95@01 r@97@01)
    (and (= (inv@98@01 r@97@01 i@94@01) r@97@01) (img@99@01 r@97@01 i@94@01)))
  :pattern ((Seq_contains xs@95@01 r@97@01))
  :pattern ((Seq_contains_trigger xs@95@01 r@97@01))
  :pattern ((Seq_contains_trigger xs@95@01 r@97@01))
  :pattern ((inv@98@01 r@97@01 i@94@01))
  :pattern ((img@99@01 r@97@01 i@94@01))
  :qid |quant-u-48|)))
(assert (forall ((r $Ref) (i Int)) (!
  (=>
    (and (img@99@01 r i) (Seq_contains xs@95@01 (inv@98@01 r i)))
    (and (= (inv@98@01 r i) r) (= i@94@01 i)))
  :pattern ((inv@98@01 r i))
  :qid |p5-fctOfInv|)))
; Permissions are non-negative
; State saturation: after contract
(set-option :timeout 50)
...
; unfold acc(p5(x, i), write)
; Precomputing data for removing quantified permissions
(define-fun pTaken@100@01 ((r $Ref) (i Int)) $Perm
  (ite
    (and (= r x@93@01) (= i i@94@01))
    ($Perm.min
      (ite
        (and (img@99@01 r i) (Seq_contains xs@95@01 (inv@98@01 r i)))
        $Perm.Write
...
(assert (not (forall ((r $Ref) (i Int)) (!
  (=>
    (and (= r x@93@01) (= i i@94@01))
    (= (- $Perm.Write (pTaken@100@01 r i)) $Perm.No))
...
; Final check if taken enough permissions
; Done removing quantified permissions
(declare-const sm@101@01 $PSF<p5>)
(declare-const s@102@01 $Snap)
; Definitional axioms for snapshot map values (instantiated)
(assert (=>
  (and
    (img@99@01 x@93@01 i@94@01)
    (Seq_contains xs@95@01 (inv@98@01 x@93@01 i@94@01)))
  (and
    (not
      (=
        ($Snap.combine
          ($SortWrappers.$RefTo$Snap x@93@01)
          ($SortWrappers.IntTo$Snap i@94@01))
        $Snap.unit))
    (=
      ($PSF.lookup_p5 (as sm@101@01  $PSF<p5>) ($Snap.combine
        ($SortWrappers.$RefTo$Snap x@93@01)
        ($SortWrappers.IntTo$Snap i@94@01)))
      ($PSF.lookup_p5 ($SortWrappers.$SnapTo$PSF<p5> ($Snap.second $t@96@01)) ($Snap.combine
        ($SortWrappers.$RefTo$Snap x@93@01)
        ($SortWrappers.IntTo$Snap i@94@01)))))))
(assert (=
  ($PSF.lookup_p5 (as sm@101@01  $PSF<p5>) ($Snap.combine
    ...
    ($SortWrappers.IntTo$Snap i@94@01)))
  ($Snap.combine
    ($Snap.first ($PSF.lookup_p5 (as sm@101@01  $PSF<p5>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap x@93@01)
      ($SortWrappers.IntTo$Snap i@94@01))))
    ($Snap.second ($PSF.lookup_p5 (as sm@101@01  $PSF<p5>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap x@93@01)
      ($SortWrappers.IntTo$Snap i@94@01)))))))
...
; [eval] r.f == i
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($PSF.lookup_p5 (as sm@101@01  $PSF<p5>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap x@93@01)
    ($SortWrappers.IntTo$Snap i@94@01)))))
  i@94@01))
; State saturation: after unfold
...
(check-sat)
; unknown
(assert (p5%trigger ($PSF.lookup_p5 (as sm@101@01  $PSF<p5>) ($Snap.combine
  ($SortWrappers.$RefTo$Snap x@93@01)
  ($SortWrappers.IntTo$Snap i@94@01))) x@93@01 i@94@01))
; [exec]
; assert x.f == i
; [eval] x.f == i
; [exec]
...
; [eval] (x in xs)
(assert (Seq_contains xs@108@01 x@106@01))
(declare-const r@110@01 $Ref)
(push) ; 2
; [eval] (r in xs)
(assert (Seq_contains xs@108@01 r@110@01))
(pop) ; 2
...
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((r1@110@01 $Ref) (r2@110@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@108@01 r1@110@01)
      (Seq_contains xs@108@01 r2@110@01)
      (= r1@110@01 r2@110@01))
    (= r1@110@01 r2@110@01))
...
(assert (forall ((r@110@01 $Ref)) (!
  (=>
    (Seq_contains xs@108@01 r@110@01)
    (and
      (= (inv@111@01 r@110@01 i@107@01) r@110@01)
      (img@112@01 r@110@01 i@107@01)))
  :pattern ((Seq_contains xs@108@01 r@110@01))
  :pattern ((Seq_contains_trigger xs@108@01 r@110@01))
  :pattern ((Seq_contains_trigger xs@108@01 r@110@01))
  :pattern ((inv@111@01 r@110@01 i@107@01))
  :pattern ((img@112@01 r@110@01 i@107@01))
  :qid |quant-u-54|)))
(assert (forall ((r $Ref) (i Int)) (!
  (=>
    (and (img@112@01 r i) (Seq_contains xs@108@01 (inv@111@01 r i)))
    (and (= (inv@111@01 r i) r) (= i@107@01 i)))
  :pattern ((inv@111@01 r i))
  :qid |p5-fctOfInv|)))
; Permissions are non-negative
; State saturation: after contract
(set-option :timeout 50)
