...
(declare-fun i@@6 () Int)
(declare-fun j@@5 () Int)
(assert  (and (and (= (type xs) (SeqType RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 30) (let ((anon13_correct true))
(let ((anon21_Else_correct  (=> (and (not (and (<= 0 i_4) (< i_4 (|Seq#Length| xs)))) (= (ControlFlow 0 24) 19)) anon13_correct)))
(let ((anon21_Then_correct  (=> (and (<= 0 i_4) (< i_4 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 20) (- 0 23)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 20) (- 0 22)) (< i_4 (|Seq#Length| xs))) (=> (< i_4 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (HasDirectPerm QPMask@0 (|Seq#Index| xs i_4) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs i_4) f_7) (=> (and (= j_5@0 (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs i_4) f_7))) (= (ControlFlow 0 20) 19)) anon13_correct))))))))))
(let ((anon20_Else_correct true))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 25) (- 0 27)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 (|Seq#Length| xs)))) (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length| xs)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index| xs i_3) (|Seq#Index| xs i_3_1))))
 :qid |stdinbpl.630:15|
 :skolemid |59|
 ...
 :qid |stdinbpl.630:15|
 :skolemid |59|
)) (=> (and (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 (|Seq#Length| xs))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange1 (|Seq#Index| xs i_3@@1)) (= (invRecv1 (|Seq#Index| xs i_3@@1)) i_3@@1)))
 :qid |stdinbpl.636:22|
 :skolemid |60|
 :pattern ( (|Seq#Index| xs i_3@@1))
 :pattern ( (|Seq#Index| xs i_3@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv1 o_3)) (< (invRecv1 o_3) (|Seq#Length| xs))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_3)) (= (|Seq#Index| xs (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.640:22|
 :skolemid |61|
 :pattern ( (invRecv1 o_3))
))) (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((i_3@@2 Int) ) (!  (=> (and (<= 0 i_3@@2) (< i_3@@2 (|Seq#Length| xs))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.646:15|
 :skolemid |62|
 ...
 :pattern ( (|Seq#Index| xs i_3@@4))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (|Seq#Length| xs))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_3@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index| xs (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (|Seq#Length| xs))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.658:22|
 :skolemid |64|
...
)) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 25) 18) anon20_Else_correct) (=> (= (ControlFlow 0 25) 20) anon21_Then_correct)) (=> (= (ControlFlow 0 25) 24) anon21_Else_correct))))))))))
(let ((anon9_correct true))
(let ((anon19_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 (|Seq#Length| xs)))) (= (ControlFlow 0 12) 8)) anon9_correct)))
(let ((anon19_Then_correct  (=> (and (<= 0 i_2) (< i_2 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_2 (|Seq#Length| xs))) (=> (< i_2 (|Seq#Length| xs)) (=> (= (ControlFlow 0 9) 8) anon9_correct))))))))
(let ((anon18_Else_correct  (=> (not (and (<= 0 i_2) (< i_2 (|Seq#Length| xs)))) (and (=> (= (ControlFlow 0 17) 9) anon19_Then_correct) (=> (= (ControlFlow 0 17) 12) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (and (<= 0 i_2) (< i_2 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 13) (- 0 16)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 13) (- 0 15)) (< i_2 (|Seq#Length| xs))) (=> (< i_2 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm ZeroMask (|Seq#Index| xs i_2) f_7)) (=> (HasDirectPerm ZeroMask (|Seq#Index| xs i_2) f_7) (=> (= j_2@0 (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs i_2) f_7))) (and (=> (= (ControlFlow 0 13) 9) anon19_Then_correct) (=> (= (ControlFlow 0 13) 12) anon19_Else_correct))))))))))))
...
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 28) 25) anon17_Else_correct) (=> (= (ControlFlow 0 28) 13) anon18_Then_correct)) (=> (= (ControlFlow 0 28) 17) anon18_Else_correct)))))
(let ((anon3_correct true))
(let ((anon16_Else_correct  (=> (and (not (and (<= 0 i@@6) (and (< i@@6 (|Seq#Length| xs)) (and (<= 0 j@@5) (< j@@5 (|Seq#Length| xs)))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon16_Then_correct  (=> (and (<= 0 i@@6) (and (< i@@6 (|Seq#Length| xs)) (and (<= 0 j@@5) (< j@@5 (|Seq#Length| xs))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i@@6 (|Seq#Length| xs))) (=> (< i@@6 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j@@5 (|Seq#Length| xs))) (=> (< j@@5 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (and (=> (= (ControlFlow 0 29) 28) anon15_Else_correct) (=> (= (ControlFlow 0 29) 2) anon16_Then_correct)) (=> (= (ControlFlow 0 29) 7) anon16_Else_correct)))))
