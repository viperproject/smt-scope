...
(assert (forall ((a_3@@4 T@U) (i_2@@3 Int) ) (!  (=> (= (type a_3@@4) IArrayDomainTypeType) (and (= (first (loc a_3@@4 i_2@@3)) a_3@@4) (= (second (loc a_3@@4 i_2@@3)) i_2@@3)))
 :qid |stdinbpl.213:15|
 :skolemid |22|
...
(assert (forall ((a_3@@5 T@U) (i_2@@4 Int) ) (!  (=> (= (type a_3@@5) IArrayDomainTypeType) (= (getPredWandId (p_1 a_3@@5 i_2@@4)) 0))
 :qid |stdinbpl.247:15|
 :skolemid |26|
 :pattern ( (p_1 a_3@@5 i_2@@4))
)))
...
(assert (forall ((a_3@@6 T@U) (i_2@@5 Int) ) (!  (=> (= (type a_3@@6) IArrayDomainTypeType) (= (PredicateMaskField (p_1 a_3@@6 i_2@@5)) (|p#sm| a_3@@6 i_2@@5)))
 :qid |stdinbpl.239:15|
 :skolemid |24|
 :pattern ( (PredicateMaskField (p_1 a_3@@6 i_2@@5)))
)))
...
(assert  (and (and (= (type QPMask@0) (MapType1Type RefType realType)) (= (type a_3@@7) IArrayDomainTypeType)) (= (type Heap@@10) (MapType0Type RefType))))
...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p_1 a_3@@7 1))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p_1 a_3@@7 1)))) (=> (= (ControlFlow 0 4) 3) anon6_correct))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (> i_1 0) (< i_1 n))) (and (> i_1_1 0) (< i_1_1 n))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_3@@7 a_3@@7)) (not (= (+ i_1 1) (+ i_1_1 1)))))
 :qid |stdinbpl.317:17|
 :skolemid |30|
 :pattern ( (neverTriggered1 i_1) (neverTriggered1 i_1_1))
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (> i_1@@0 0) (< i_1@@0 n))) (and (> i_1_1@@0 0) (< i_1_1@@0 n))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_3@@7 a_3@@7)) (not (= (+ i_1@@0 1) (+ i_1_1@@0 1)))))
 :qid |stdinbpl.317:17|
 :skolemid |30|
 :pattern ( (neverTriggered1 i_1@@0) (neverTriggered1 i_1_1@@0))
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (and (> i_1@@1 0) (< i_1@@1 n)) (< NoPerm FullPerm)) (and (= (invRecv1 a_3@@7 (+ i_1@@1 1)) i_1@@1) (qpRange1 a_3@@7 (+ i_1@@1 1))))
 :qid |stdinbpl.323:22|
 :skolemid |31|
)) (=> (and (forall ((a_1_1 T@U) (i_2_1 Int) ) (!  (=> (= (type a_1_1) IArrayDomainTypeType) (=> (and (and (and (> (invRecv1 a_1_1 i_2_1) 0) (< (invRecv1 a_1_1 i_2_1) n)) (< NoPerm FullPerm)) (qpRange1 a_1_1 i_2_1)) (and (= a_3@@7 a_1_1) (= (+ (invRecv1 a_1_1 i_2_1) 1) i_2_1))))
 :qid |stdinbpl.327:22|
 :skolemid |32|
 :pattern ( (invRecv1 a_1_1 i_2_1))
)) (forall ((a_1_1@@0 T@U) (i_2_1@@0 Int) ) (!  (=> (= (type a_1_1@@0) IArrayDomainTypeType) (=> (and (and (and (> (invRecv1 a_1_1@@0 i_2_1@@0) 0) (< (invRecv1 a_1_1@@0 i_2_1@@0) n)) (< NoPerm FullPerm)) (qpRange1 a_1_1@@0 i_2_1@@0)) (and (=> (< NoPerm FullPerm) (and (= a_3@@7 a_1_1@@0) (= (+ (invRecv1 a_1_1@@0 i_2_1@@0) 1) i_2_1@@0))) (= (U_2_real (MapType1Select QPMask@0 null (p_1 a_1_1@@0 i_2_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (p_1 a_1_1@@0 i_2_1@@0))) FullPerm)))))
 :qid |stdinbpl.333:22|
 :skolemid |33|
