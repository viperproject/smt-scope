...
(let ((anon3_Else_correct  (=> (and (not (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U k)))) (= (ControlFlow 0 4) 1)) anon2_correct)))
(let ((anon3_Then_correct  (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U k))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= k 4)) (=> (= k 4) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (|Set#Equal| (|Map#Domain| (|Map#Build| m@@23 (int_2_U 4) (bool_2_U true))) (|Set#Singleton| (int_2_U 4)))) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))
