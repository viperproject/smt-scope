...
(assert  (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type diz) RefType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id Counter__incr)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon4_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 diz Counter__x (real_2_U (- (U_2_real (MapType1Select Mask@0 diz Counter__x)) FullPerm)))) (= (ControlFlow 0 5) (- 0 4))) (= (U_2_int (MapType0Select Heap@0 diz Counter__x)) (+ (U_2_int (MapType0Select Heap@@9 diz Counter__x)) 1)))))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@0 diz Counter__x)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 diz Counter__x))) (=> (= (ControlFlow 0 6) 5) anon4_correct))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (HasDirectPerm Mask@0 diz Counter__x)) (=> (HasDirectPerm Mask@0 diz Counter__x) (=> (= __flatten_5@0 (+ (U_2_int (MapType0Select Heap@@9 diz Counter__x)) 1)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (= FullPerm (U_2_real (MapType1Select Mask@0 diz Counter__x)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 diz Counter__x))) (=> (and (= Heap@0 (MapType0Store Heap@@9 diz Counter__x (int_2_U __flatten_5@0))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 9) 6) anon6_Then_correct) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct)))))))))))
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (not (= diz null)) (= PostMask@0 (MapType1Store ZeroMask diz Counter__x (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz Counter__x)) FullPerm))))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm PostMask@0 diz Counter__x)) (=> (HasDirectPerm PostMask@0 diz Counter__x) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@0 diz Counter__x))))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 diz $allocated))) (=> (and (and (and (not (= diz null)) (state Heap@@9 ZeroMask)) (and (>= current_thread_id 0) (state Heap@@9 ZeroMask))) (and (and (not (= diz null)) (= Mask@0 (MapType1Store ZeroMask diz Counter__x (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz Counter__x)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)))) (and (=> (= (ControlFlow 0 12) 2) anon5_Then_correct) (=> (= (ControlFlow 0 12) 9) anon5_Else_correct))))))
