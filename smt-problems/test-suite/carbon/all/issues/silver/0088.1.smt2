...
(declare-fun i@0 () Int)
(declare-fun x@@8 () T@U)
(assert  (and (= (type Heap@@9) (MapType0Type RefType)) (= (type x@@8) RefType)))
...
(let ((anon10_Then_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (state Heap@@9 ZeroMask) (< i@0 1)) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 7) 4) anon11_Then_correct) (=> (= (ControlFlow 0 7) 5) anon12_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon12_Else_correct))))))
(let ((anon10_Else_correct  (=> (not (< i@0 1)) (=> (and (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 3) (- 0 2)))) false))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 8) 1) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon10_Then_correct)) (=> (= (ControlFlow 0 8) 3) anon10_Else_correct))))))
