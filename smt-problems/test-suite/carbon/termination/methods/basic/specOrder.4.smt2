...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon7_Else_correct  (=> (and (> x@@8 y@@1) (= (ControlFlow 0 4) (- 0 6))) false)))
(let ((anon7_Then_correct true))
(let ((anon6_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (> x@@8 0)) (and (> y@@1 0) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 7) 1) anon6_Then_correct) (=> (= (ControlFlow 0 7) 2) anon7_Then_correct)) (=> (= (ControlFlow 0 7) 4) anon7_Else_correct)))))
