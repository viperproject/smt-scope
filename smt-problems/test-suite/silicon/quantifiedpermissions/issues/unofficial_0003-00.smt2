(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:18:22
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0003.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (forall ((i@5@01 Int) (j@6@01 Int)) (!
  ...
  :pattern ((Seq_index
    ...
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01))
    j@6@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0003.vpr@13@7@13@133-aux|)))
(assert (forall ((i@5@01 Int) (j@6@01 Int)) (!
  (=>
    (and
      (>= i@5@01 0)
  ...
  :pattern ((Seq_index
    ...
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01))
    j@6@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0003.vpr@13@7@13@133|)))
(assert (=
  ($Snap.second ($Snap.second $t@4@01))
  ($Snap.combine
...
(assert (forall ((i@10@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0003.vpr@15@7@19@11-aux|)))
(assert (forall ((i@10@01 Int)) (!
  (and
    (or (<= 0 i@10@01) (not (<= 0 i@10@01)))
    (=>
...
(assert (forall ((i@10@01 Int)) (!
  ...
  :pattern ((Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01))
    i@10@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0003.vpr@15@7@19@11|)))
...
(assert (forall ((i@11@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0003.vpr@37@6@41@9-aux|)))
(assert (forall ((i@11@01 Int)) (!
  (and
    (or (<= 0 i@11@01) (not (<= 0 i@11@01)))
    (=>
...
(assert (forall ((i@11@01 Int)) (!
  ...
  :pattern ((Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01))
    i@11@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0003.vpr@37@6@41@9_precondition|)))
(push) ; 3
(assert (not (forall ((i@11@01 Int)) (!
  ...
  :pattern ((Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01))
    i@11@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0003.vpr@37@6@41@9|))))
(check-sat)
; unsat
(pop) ; 3
; 0,00s
