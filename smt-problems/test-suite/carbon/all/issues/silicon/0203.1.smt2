...
(declare-fun |count'| (T@U Int Int T@U) Int)
(declare-fun DummyDomainTypeType () T@T)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |count#triggerStateless| (Int Int T@U) Int)
...
(declare-fun |recfun'| (T@U Int) Int)
...
(declare-fun |recfun#trigger| (T@U Int) Bool)
(declare-fun EmptyFrame () T@U)
(declare-fun |count#frame| (T@U Int Int T@U) Int)
(declare-fun |count#trigger| (T@U Int Int T@U) Bool)
(declare-fun sumMask (T@U T@U T@U) Bool)
(declare-fun ConditionalFrame (Real T@U) T@U)
(declare-fun NoPerm () Real)
(declare-fun count (T@U Int Int T@U) Int)
(declare-fun FullPerm () Real)
(declare-fun |recfun#frame| (T@U Int) Int)
(declare-fun ZeroPMask () T@U)
(declare-fun loc (T@U Int) Bool)
...
(assert (= (Ctor DummyDomainTypeType) 10))
(assert (forall ((Heap@@0 T@U) (lo Int) (hi Int) (a_3 T@U) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type a_3) DummyDomainTypeType)) (dummyFunction (int_2_U (|count#triggerStateless| lo hi a_3))))
 :qid |stdinbpl.200:15|
 :skolemid |23|
 :pattern ( (|count'| Heap@@0 lo hi a_3))
)))
...
(assert (forall ((Heap@@3 T@U) (x@@8 Int) ) (!  (=> (= (type Heap@@3) (MapType0Type RefType)) (dummyFunction (int_2_U (|recfun#triggerStateless| x@@8))))
 :qid |stdinbpl.270:15|
 :skolemid |28|
 :pattern ( (|recfun'| Heap@@3 x@@8))
)))
(assert (forall ((Heap@@4 T@U) (Mask@@2 T@U) (x@@9 Int) ) (!  (=> (and (and (and (= (type Heap@@4) (MapType0Type RefType)) (= (type Mask@@2) (MapType1Type RefType realType))) (and (state Heap@@4 Mask@@2) (< AssumeFunctionsAbove 0))) (> x@@9 0)) (= (recfun Heap@@4 x@@9) (- 0 x@@9)))
 :qid |stdinbpl.276:15|
 :skolemid |29|
 :pattern ( (state Heap@@4 Mask@@2) (recfun Heap@@4 x@@9))
)))
...
(assert (forall ((Heap@@6 T@U) (x@@10 Int) ) (!  (=> (= (type Heap@@6) (MapType0Type RefType)) (and (= (recfun Heap@@6 x@@10) (|recfun'| Heap@@6 x@@10)) (dummyFunction (int_2_U (|recfun#triggerStateless| x@@10)))))
 :qid |stdinbpl.266:15|
 :skolemid |27|
 :pattern ( (recfun Heap@@6 x@@10))
)))
...
(assert (forall ((Heap@@8 T@U) (Mask@@5 T@U) (x@@11 Int) ) (!  (=> (and (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@5) (MapType1Type RefType realType))) (and (state Heap@@8 Mask@@5) (or (< AssumeFunctionsAbove 0) (|recfun#trigger| EmptyFrame x@@11)))) (> x@@11 0)) (< (|recfun'| Heap@@8 x@@11) 0))
 :qid |stdinbpl.289:15|
 :skolemid |31|
 :pattern ( (state Heap@@8 Mask@@5) (|recfun'| Heap@@8 x@@11))
)))
...
(assert (forall ((Heap@@10 T@U) (Mask@@7 T@U) (lo@@0 Int) (hi@@0 Int) (a_3@@0 T@U) ) (!  (=> (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (= (type a_3@@0) DummyDomainTypeType)) (state Heap@@10 Mask@@7)) (= (|count'| Heap@@10 lo@@0 hi@@0 a_3@@0) (|count#frame| EmptyFrame lo@@0 hi@@0 a_3@@0)))
 :qid |stdinbpl.207:15|
 :skolemid |24|
 :pattern ( (state Heap@@10 Mask@@7) (|count'| Heap@@10 lo@@0 hi@@0 a_3@@0))
)))
(assert (forall ((Heap@@11 T@U) (Mask@@8 T@U) (lo@@1 Int) (hi@@1 Int) (a_3@@1 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type Mask@@8) (MapType1Type RefType realType))) (= (type a_3@@1) DummyDomainTypeType)) (and (state Heap@@11 Mask@@8) (or (< AssumeFunctionsAbove 1) (|count#trigger| EmptyFrame lo@@1 hi@@1 a_3@@1)))) (<= hi@@1 lo@@1)) (= (|count'| Heap@@11 lo@@1 hi@@1 a_3@@1) 0))
 :qid |stdinbpl.213:15|
 :skolemid |25|
 :pattern ( (state Heap@@11 Mask@@8) (|count'| Heap@@11 lo@@1 hi@@1 a_3@@1))
)))
...
(assert (forall ((Heap@@12 T@U) (lo@@2 Int) (hi@@2 Int) (a_3@@2 T@U) ) (!  (=> (and (= (type Heap@@12) (MapType0Type RefType)) (= (type a_3@@2) DummyDomainTypeType)) (and (= (count Heap@@12 lo@@2 hi@@2 a_3@@2) (|count'| Heap@@12 lo@@2 hi@@2 a_3@@2)) (dummyFunction (int_2_U (|count#triggerStateless| lo@@2 hi@@2 a_3@@2)))))
 :qid |stdinbpl.196:15|
 :skolemid |22|
 :pattern ( (count Heap@@12 lo@@2 hi@@2 a_3@@2))
)))
...
(assert (forall ((Heap@@15 T@U) (Mask@@13 T@U) (x@@12 Int) ) (!  (=> (and (and (= (type Heap@@15) (MapType0Type RefType)) (= (type Mask@@13) (MapType1Type RefType realType))) (state Heap@@15 Mask@@13)) (= (|recfun'| Heap@@15 x@@12) (|recfun#frame| EmptyFrame x@@12)))
 :qid |stdinbpl.283:15|
 :skolemid |30|
 :pattern ( (state Heap@@15 Mask@@13) (|recfun'| Heap@@15 x@@12))
)))
...
(assert (forall ((Heap@@18 T@U) (Mask@@14 T@U) (lo@@3 Int) (hi@@3 Int) (a_3@@3 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@18) (MapType0Type RefType)) (= (type Mask@@14) (MapType1Type RefType realType))) (= (type a_3@@3) DummyDomainTypeType)) (and (state Heap@@18 Mask@@14) (or (< AssumeFunctionsAbove 1) (|count#trigger| EmptyFrame lo@@3 hi@@3 a_3@@3)))) (<= lo@@3 hi@@3)) (= (|count'| Heap@@18 lo@@3 (+ hi@@3 1) a_3@@3) (+ (|count'| Heap@@18 lo@@3 hi@@3 a_3@@3) (ite (loc a_3@@3 hi@@3) 0 1))))
 :qid |stdinbpl.217:15|
 :skolemid |26|
 :pattern ( (state Heap@@18 Mask@@14) (|count'| Heap@@18 lo@@3 hi@@3 a_3@@3))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon4_Else_correct  (=> (and (|recfun#trigger| EmptyFrame x@@13) (= (ControlFlow 0 4) (- 0 3))) (< (recfun Heap@@19 x@@13) 0))))
(let ((anon4_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (> x@@13 0))))
(let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (and (= AssumeFunctionsAbove 0) (> x@@13 0)) (and (state Heap@@19 ZeroMask) (= Result@0 (- 0 x@@13)))) (and (=> (= (ControlFlow 0 5) 2) anon4_Then_correct) (=> (= (ControlFlow 0 5) 4) anon4_Else_correct))))))
