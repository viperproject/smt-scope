...
(assert  (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type this) RefType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id t2b)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon4_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 this f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 this f_7)) FullPerm)))) (= (ControlFlow 0 5) (- 0 4))) (= (U_2_int (MapType0Select Heap@0 this f_7)) (+ (U_2_int (MapType0Select Heap@@9 this f_7)) 2)))))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@0 this f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 this f_7))) (=> (= (ControlFlow 0 6) 5) anon4_correct))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (HasDirectPerm Mask@0 this f_7)) (=> (HasDirectPerm Mask@0 this f_7) (and (=> (= (ControlFlow 0 9) (- 0 10)) (= FullPerm (U_2_real (MapType1Select Mask@0 this f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 this f_7))) (=> (and (= Heap@0 (MapType0Store Heap@@9 this f_7 (int_2_U (+ (U_2_int (MapType0Select Heap@@9 this f_7)) 1)))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 9) 6) anon6_Then_correct) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct)))))))))
(let ((anon5_Then_correct  (=> (and (and (state PostHeap@0 ZeroMask) (not (= this null))) (and (= PostMask@0 (MapType1Store ZeroMask this f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this f_7)) FullPerm)))) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm PostMask@0 this f_7)) (=> (HasDirectPerm PostMask@0 this f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@0 this f_7)))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 this $allocated))) (=> (and (and (not (= this null)) (= Mask@0 (MapType1Store ZeroMask this f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this f_7)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 12) 2) anon5_Then_correct) (=> (= (ControlFlow 0 12) 9) anon5_Else_correct))))))
