...
(declare-fun j_3 () Int)
(assert  (and (= (type xs) (SeqType RefType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id leak)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_16))) (= (ControlFlow 0 15) 11)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_16)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= i_16 0)) (=> (>= i_16 0) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< i_16 (|Seq#Length| xs))) (=> (< i_16 (|Seq#Length| xs)) (=> (= (ControlFlow 0 12) 11) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_3))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_3_1))) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index| xs i_3) (|Seq#Index| xs i_3_1))))
 :qid |stdinbpl.965:15|
 :skolemid |80|
 ...
 :qid |stdinbpl.965:15|
 :skolemid |80|
)) (=> (forall ((i_3@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_3@@1)) (< NoPerm p_1)) (and (qpRange4 (|Seq#Index| xs i_3@@1)) (= (invRecv4 (|Seq#Index| xs i_3@@1)) i_3@@1)))
 :qid |stdinbpl.971:22|
 :skolemid |81|
 ...
 :pattern ( (|Seq#Index| xs i_3@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U (invRecv4 o_3))) (< NoPerm p_1)) (qpRange4 o_3)) (= (|Seq#Index| xs (invRecv4 o_3)) o_3)))
 :qid |stdinbpl.975:22|
 :skolemid |82|
 :pattern ( (invRecv4 o_3))
)) (= (ControlFlow 0 9) (- 0 8))) (forall ((i_3@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_3@@2)) (>= p_1 NoPerm))
 :qid |stdinbpl.981:15|
 :skolemid |83|
...
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 16) 9) anon11_Else_correct) (=> (= (ControlFlow 0 16) 12) anon12_Then_correct)) (=> (= (ControlFlow 0 16) 15) anon12_Else_correct)))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_12)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_3)) (not (= i_12 j_3))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_12)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_3)) (not (= i_12 j_3)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_12 0)) (=> (>= i_12 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_12 (|Seq#Length| xs))) (=> (< i_12 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_3 0)) (=> (>= j_3 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_3 (|Seq#Length| xs))) (=> (< j_3 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (<= NoPerm p_1) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 17) 16) anon9_Else_correct) (=> (= (ControlFlow 0 17) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 17) 7) anon10_Else_correct))))))
