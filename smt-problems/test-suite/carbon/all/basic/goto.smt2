...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon4_Else_correct  (=> (and (state Heap@@17 ZeroMask) (= (ControlFlow 0 3) (- 0 2))) (> r_1 0))))
(let ((anon4_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (> n 0) (state Heap@@17 ZeroMask)) (and (=> (= (ControlFlow 0 4) 1) anon4_Then_correct) (=> (= (ControlFlow 0 4) 3) anon4_Else_correct))))))
