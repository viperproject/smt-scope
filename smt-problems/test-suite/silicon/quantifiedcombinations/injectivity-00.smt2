(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:16:07
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quantifiedcombinations/injectivity.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@65@01 r) (Seq_contains xs@60@01 (inv@64@01 r)))
    (= ($FVF.lookup_f (as sm@70@01  $FVF<f>) r) ($FVF.lookup_f $t@63@01 r)))
...
(push) ; 3
; [eval] (x in xs)
(assert (Seq_contains xs@60@01 x@71@01))
(pop) ; 3
(declare-fun inv@72@01 ($Ref Int) $Ref)
(declare-fun img@73@01 ($Ref Int) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((x1@71@01 $Ref) (x2@71@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@60@01 x1@71@01)
      (Seq_contains xs@60@01 x2@71@01)
      (= x1@71@01 x2@71@01))
    (= x1@71@01 x2@71@01))
...
(assert (forall ((x@71@01 $Ref)) (!
  (=>
    (Seq_contains xs@60@01 x@71@01)
    (and (= (inv@72@01 x@71@01 1) x@71@01) (img@73@01 x@71@01 1)))
  :pattern ((Seq_contains xs@60@01 x@71@01))
  :pattern ((Seq_contains_trigger xs@60@01 x@71@01))
  :pattern ((inv@72@01 x@71@01 1))
  :pattern ((img@73@01 x@71@01 1))
  :qid |pred2-invOfFct|)))
(assert (forall ((a $Ref) (i Int)) (!
  (=>
    (and (img@73@01 a i) (Seq_contains xs@60@01 (inv@72@01 a i)))
    (and (= (inv@72@01 a i) a) (= 1 i)))
...
(assert (not (forall ((a $Ref) (i Int)) (!
  (=>
    (and
      (Seq_contains xs@60@01 (inv@72@01 a i))
      (img@73@01 a i)
      (and (= a (inv@72@01 a i)) (= i 1)))
    false)
...
(push) ; 3
; [eval] (x in xs)
(assert (Seq_contains xs@60@01 x@74@01))
(pop) ; 3
(declare-fun inv@75@01 ($Ref Int) $Ref)
(declare-fun img@76@01 ($Ref Int) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((x1@74@01 $Ref) (x2@74@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@60@01 x1@74@01)
      (Seq_contains xs@60@01 x2@74@01)
      (= x1@74@01 x2@74@01))
    (= x1@74@01 x2@74@01))
...
(assert (forall ((x@74@01 $Ref)) (!
  (=>
    (Seq_contains xs@60@01 x@74@01)
    (and (= (inv@75@01 x@74@01 1) x@74@01) (img@76@01 x@74@01 1)))
  :pattern ((Seq_contains xs@60@01 x@74@01))
  :pattern ((Seq_contains_trigger xs@60@01 x@74@01))
  :pattern ((inv@75@01 x@74@01 1))
  :pattern ((img@76@01 x@74@01 1))
  :qid |pred2-invOfFct|)))
(assert (forall ((a $Ref) (i Int)) (!
  (=>
    (and (img@76@01 a i) (Seq_contains xs@60@01 (inv@75@01 a i)))
    (and (= (inv@75@01 a i) a) (= 1 i)))
  :pattern ((inv@75@01 a i))
  :qid |pred2-fctOfInv|)))
; Precomputing data for removing quantified permissions
; Done precomputing, updating quantified chunks
; State saturation: before repetition
...
(assert (not (forall ((a $Ref) (i Int)) (!
  (=>
    (and
      (Seq_contains xs@60@01 (inv@75@01 a i))
      (img@76@01 a i)
      (and (= a (inv@75@01 a i)) (= i 1)))
    false)
