...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 t1 $allocated))) (and (U_2_bool (MapType0Select Heap@@9 t2 $allocated)) (= perm@0 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (=> (> perm@0 NoPerm) (not (= t1 null))) (= Mask@0 (MapType1Store ZeroMask t1 next (real_2_U (+ (U_2_real (MapType1Select ZeroMask t1 next)) perm@0))))) (=> (and (and (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (> wildcard@0 NoPerm) (not (= t2 null)))) (and (and (= Mask@1 (MapType1Store Mask@0 t2 next (real_2_U (+ (U_2_real (MapType1Select Mask@0 t2 next)) wildcard@0)))) (state Heap@@9 Mask@1)) (and (state Heap@@9 Mask@1) (= (ControlFlow 0 2) (- 0 1))))) (not (= t1 t2)))))))))
