...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (not (|Seq#Equal| (|Seq#Append| (|Seq#Singleton| (int_2_U 555)) (|Seq#Singleton| (int_2_U 10))) (|Seq#Append| (|Seq#Singleton| (int_2_U 666)) (|Seq#Singleton| (int_2_U 10))))))))
