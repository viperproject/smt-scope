...
(let ((anon3_Then_correct  (=> (not (= this@@54 null)) (=> (and (and (= Mask@0 (MapType1Store ZeroMask this@@54 x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@54 x@@8)) FullPerm)))) (state Heap@@64 Mask@0)) (and (state Heap@@64 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@0 this@@54 x@@8)))))
(let ((anon0_correct  (=> (state Heap@@64 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@64 this@@54 $allocated)) (= AssumeFunctionsAbove 8)) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
