...
(declare-fun y@@2 () T@U)
(assert  (and (and (and (and (and (and (and (= (type xs) (SeqType RefType)) (= (type Heap@@11) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@39 T@U) (arg1@@18 Int) ) (! (= (type (invRecv17 arg0@@39 arg1@@18)) RefType)
 :qid |funType:invRecv17|
 :pattern ( (invRecv17 arg0@@39 arg1@@18))
))) (forall ((arg0@@40 T@U) ) (! (= (type (invRecv16 arg0@@40)) RefType)
 :qid |funType:invRecv16|
 :pattern ( (invRecv16 arg0@@40))
))) (= (type y@@2) RefType)))
(set-info :boogie-vc-id test03_1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((x_5 T@U) (x_5_1 T@U) ) (!  (=> (and (= (type x_5) RefType) (= (type x_5_1) RefType)) (=> (and (and (and (and (not (= x_5 x_5_1)) (|Seq#Contains| xs x_5)) (|Seq#Contains| xs x_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_5 x_5_1))))
 :qid |stdinbpl.1643:17|
 :skolemid |176|
 :pattern ( (neverTriggered18 x_5) (neverTriggered18 x_5_1))
 ...
 :qid |stdinbpl.1643:17|
 :skolemid |176|
 :pattern ( (neverTriggered18 x_5@@0) (neverTriggered18 x_5_1@@0))
)) (=> (= (ControlFlow 0 5) (- 0 4)) (forall ((x_5@@1 T@U) ) (!  (=> (and (= (type x_5@@1) RefType) (|Seq#Contains| xs x_5@@1)) (>= (U_2_real (MapType1Select QPMask@1 x_5@@1 f_7)) FullPerm))
 :qid |stdinbpl.1650:17|
 :skolemid |177|
 :pattern ( (MapType0Select Heap@@11 x_5@@1 f_7))
 :pattern ( (MapType1Select QPMask@2 x_5@@1 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs x_5@@1))
 :pattern ( (|Seq#Contains| xs x_5@@1))
)))))))
(let ((anon9_Then_correct true))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (|Seq#Contains| xs x_3)) (|Seq#Contains| xs x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1))))
 :qid |stdinbpl.1593:17|
 :skolemid |169|
 :pattern ( (neverTriggered17 x_3) (neverTriggered17 x_3_1))
 ...
 :qid |stdinbpl.1593:17|
 :skolemid |169|
 :pattern ( (neverTriggered17 x_3@@0) (neverTriggered17 x_3_1@@0))
)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((x_3@@1 T@U) ) (!  (=> (and (= (type x_3@@1) RefType) (|Seq#Contains| xs x_3@@1)) (>= (U_2_real (MapType1Select QPMask@0 null (pred2 x_3@@1 1))) FullPerm))
 :qid |stdinbpl.1600:17|
 :skolemid |170|
 :pattern ( (MapType0Select Heap@@11 null (pred2 x_3@@1 1)))
 :pattern ( (MapType1Select QPMask@0 null (pred2 x_3@@1 1)))
 :pattern ( (|Seq#ContainsTrigger| xs x_3@@1))
 :pattern ( (|Seq#Contains| xs x_3@@1))
))) (=> (forall ((x_3@@2 T@U) ) (!  (=> (and (= (type x_3@@2) RefType) (|Seq#Contains| xs x_3@@2)) (>= (U_2_real (MapType1Select QPMask@0 null (pred2 x_3@@2 1))) FullPerm))
 :qid |stdinbpl.1600:17|
 :skolemid |170|
 :pattern ( (MapType0Select Heap@@11 null (pred2 x_3@@2 1)))
 :pattern ( (MapType1Select QPMask@0 null (pred2 x_3@@2 1)))
 :pattern ( (|Seq#ContainsTrigger| xs x_3@@2))
 :pattern ( (|Seq#Contains| xs x_3@@2))
)) (=> (forall ((x_3@@3 T@U) ) (!  (=> (= (type x_3@@3) RefType) (=> (and (|Seq#Contains| xs x_3@@3) (< NoPerm FullPerm)) (and (= (invRecv17 x_3@@3 1) x_3@@3) (qpRange17 x_3@@3 1))))
 :qid |stdinbpl.1606:22|
 :skolemid |171|
 :pattern ( (MapType0Select Heap@@11 null (pred2 x_3@@3 1)))
 :pattern ( (MapType1Select QPMask@0 null (pred2 x_3@@3 1)))
 :pattern ( (|Seq#ContainsTrigger| xs x_3@@3))
 :pattern ( (|Seq#Contains| xs x_3@@3))
)) (=> (and (and (forall ((a_1@@11 T@U) (i@@12 Int) ) (!  (=> (= (type a_1@@11) RefType) (=> (and (and (|Seq#Contains| xs (invRecv17 a_1@@11 i@@12)) (< NoPerm FullPerm)) (qpRange17 a_1@@11 i@@12)) (and (= (invRecv17 a_1@@11 i@@12) a_1@@11) (= 1 i@@12))))
 :qid |stdinbpl.1610:22|
 :skolemid |172|
 :pattern ( (invRecv17 a_1@@11 i@@12))
)) (forall ((a_1@@12 T@U) (i@@13 Int) ) (!  (=> (= (type a_1@@12) RefType) (=> (and (and (|Seq#Contains| xs (invRecv17 a_1@@12 i@@13)) (< NoPerm FullPerm)) (qpRange17 a_1@@12 i@@13)) (and (and (= (invRecv17 a_1@@12 i@@13) a_1@@12) (= 1 i@@13)) (= (U_2_real (MapType1Select QPMask@1 null (pred2 a_1@@12 i@@13))) (- (U_2_real (MapType1Select QPMask@0 null (pred2 a_1@@12 i@@13))) FullPerm)))))
 :qid |stdinbpl.1616:22|
 :skolemid |173|
 :pattern ( (MapType1Select QPMask@1 null (pred2 a_1@@12 i@@13)))
))) (and (forall ((a_1@@13 T@U) (i@@14 Int) ) (!  (=> (and (= (type a_1@@13) RefType) (not (and (and (|Seq#Contains| xs (invRecv17 a_1@@13 i@@14)) (< NoPerm FullPerm)) (qpRange17 a_1@@13 i@@14)))) (= (U_2_real (MapType1Select QPMask@1 null (pred2 a_1@@13 i@@14))) (U_2_real (MapType1Select QPMask@0 null (pred2 a_1@@13 i@@14)))))
 :qid |stdinbpl.1620:22|
 :skolemid |174|
 :pattern ( (MapType1Select QPMask@1 null (pred2 a_1@@13 i@@14)))
...
)))) (and (=> (= (ControlFlow 0 7) 3) anon9_Then_correct) (=> (= (ControlFlow 0 7) 5) anon9_Else_correct))))))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| xs x_1)) (|Seq#Contains| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| xs x_1@@1) (< NoPerm FullPerm)) (and (qpRange16 x_1@@1) (= (invRecv16 x_1@@1) x_1@@1))))
...
)) (=> (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (=> (and (and (|Seq#Contains| xs (invRecv16 o_3@@0)) (< NoPerm FullPerm)) (qpRange16 o_3@@0)) (= (invRecv16 o_3@@0) o_3@@0)))
 :qid |stdinbpl.1545:22|
 :skolemid |165|
 :pattern ( (invRecv16 o_3@@0))
...
))) (=> (and (and (forall ((o_3@@1 T@U) ) (!  (=> (= (type o_3@@1) RefType) (and (=> (and (and (|Seq#Contains| xs (invRecv16 o_3@@1)) (< NoPerm FullPerm)) (qpRange16 o_3@@1)) (and (=> (< NoPerm FullPerm) (= (invRecv16 o_3@@1) o_3@@1)) (= (U_2_real (MapType1Select QPMask@0 o_3@@1 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@1 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| xs (invRecv16 o_3@@1)) (< NoPerm FullPerm)) (qpRange16 o_3@@1))) (= (U_2_real (MapType1Select QPMask@0 o_3@@1 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@1 f_7))))))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 ...
 :qid |stdinbpl.1561:29|
 :skolemid |168|
 :pattern ( (MapType1Select ZeroMask o_3@@2 f_5@@0))
 :pattern ( (MapType1Select QPMask@0 o_3@@2 f_5@@0))
))) (and (state Heap@@11 QPMask@0) (state Heap@@11 QPMask@0))) (and (=> (= (ControlFlow 0 10) 2) anon8_Then_correct) (=> (= (ControlFlow 0 10) 7) anon8_Else_correct)))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 y@@2 $allocated))) (and (=> (= (ControlFlow 0 12) 1) anon7_Then_correct) (=> (= (ControlFlow 0 12) 10) anon7_Else_correct)))))
