...
(assert  (and (and (and (= (type s@@17) (SeqType RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id foo3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i3_2))) (= (ControlFlow 0 12) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i3_2)) (and (=> (= (ControlFlow 0 8) (- 0 11)) (>= i3_2 0)) (=> (>= i3_2 0) (and (=> (= (ControlFlow 0 8) (- 0 10)) (< i3_2 (|Seq#Length| s@@17))) (=> (< i3_2 (|Seq#Length| s@@17)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm Mask@1 (|Seq#Index| s@@17 i3_2) f_7)) (=> (HasDirectPerm Mask@1 (|Seq#Index| s@@17 i3_2) f_7) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))))))
(let ((anon11_Else_correct true))
(let ((anon9_Else_correct  (=> (and (forall ((i3_1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i3_1)) (not (= (|Seq#Index| s@@17 i3_1) null)))
 :qid |stdinbpl.1033:20|
 :skolemid |86|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i3_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i3_1)))
 :pattern ( (|Seq#Index| s@@17 i3_1))
)) (state Heap@@9 Mask@1)) (and (and (=> (= (ControlFlow 0 13) 6) anon11_Else_correct) (=> (= (ControlFlow 0 13) 8) anon12_Then_correct)) (=> (= (ControlFlow 0 13) 12) anon12_Else_correct)))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i3))) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i3)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i3 0)) (=> (>= i3 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i3 (|Seq#Length| s@@17))) (=> (< i3 (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (> (|Seq#Length| s@@17) 2)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (< 0 (|Seq#Length| s@@17))) (=> (< 0 (|Seq#Length| s@@17)) (=> (not (= (|Seq#Index| s@@17 0) null)) (=> (and (= Mask@0 (MapType1Store ZeroMask (|Seq#Index| s@@17 0) f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask (|Seq#Index| s@@17 0) f_7)) FullPerm)))) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< 1 (|Seq#Length| s@@17))) (=> (< 1 (|Seq#Length| s@@17)) (=> (and (and (not (= (|Seq#Index| s@@17 1) null)) (= Mask@1 (MapType1Store Mask@0 (|Seq#Index| s@@17 1) f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 (|Seq#Index| s@@17 1) f_7)) FullPerm))))) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1))) (and (and (=> (= (ControlFlow 0 14) 13) anon9_Else_correct) (=> (= (ControlFlow 0 14) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 14) 5) anon10_Else_correct))))))))))))
