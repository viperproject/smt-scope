...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@5) (MapType1Type RefType realType)) (= (type Mask@4) (MapType1Type RefType realType))) (= (type x1@@7) RefType)) (= (type Heap@7) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type x2) RefType)) (= (type Heap@6) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type freshVersion@1) FrameTypeType)) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (forall ((arg0@@54 T@U) ) (! (= (type (FrameFragment arg0@@54)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@54))
))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (forall ((arg0@@55 T@U) ) (! (= (type (invRecv9 arg0@@55)) RefType)
 :qid |funType:invRecv9|
 :pattern ( (invRecv9 arg0@@55))
))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id t2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 29) (let ((anon19_Else_correct  (=> (= (ControlFlow 0 24) (- 0 23)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_3))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1))))
 :qid |stdinbpl.2074:17|
 :skolemid |179|
...
(let ((anon16_correct  (=> (= Mask@5 (MapType1Store Mask@4 x1@@7 unrelatedField (real_2_U (- (U_2_real (MapType1Select Mask@4 x1@@7 unrelatedField)) FullPerm)))) (=> (and (IdenticalOnKnownLocations Heap@7 ExhaleHeap@0 Mask@5) (not (= x1@@7 null))) (=> (and (and (= Mask@6 (MapType1Store Mask@5 x1@@7 unrelatedField (real_2_U (+ (U_2_real (MapType1Select Mask@5 x1@@7 unrelatedField)) FullPerm)))) (state ExhaleHeap@0 Mask@6)) (and (state ExhaleHeap@0 Mask@6) (state ExhaleHeap@0 Mask@6))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_5 T@U) (x_5_1 T@U) ) (!  (=> (and (= (type x_5) RefType) (= (type x_5_1) RefType)) (=> (and (and (and (and (not (= x_5 x_5_1)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_5))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_5 x_5_1))))
 :qid |stdinbpl.2195:17|
 :skolemid |185|
 :pattern ( (neverTriggered11 x_5) (neverTriggered11 x_5_1))
))) (=> (forall ((x_5@@0 T@U) (x_5_1@@0 T@U) ) (!  (=> (and (= (type x_5@@0) RefType) (= (type x_5_1@@0) RefType)) (=> (and (and (and (and (not (= x_5@@0 x_5_1@@0)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_5@@0))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_5_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_5@@0 x_5_1@@0))))
 :qid |stdinbpl.2195:17|
 :skolemid |185|
 :pattern ( (neverTriggered11 x_5@@0) (neverTriggered11 x_5_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_5@@1 T@U) ) (!  (=> (and (= (type x_5@@1) RefType) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_5@@1))) (>= (U_2_real (MapType1Select Mask@6 null (valid x_5@@1 true))) FullPerm))
 :qid |stdinbpl.2202:17|
 :skolemid |186|
 :pattern ( (MapType0Select ExhaleHeap@0 null (valid x_5@@1 true)))
 :pattern ( (MapType1Select Mask@6 null (valid x_5@@1 true)))
 :pattern ( (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_5@@1))
))))))))))
(let ((anon24_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 3)) anon16_correct)))
(let ((anon24_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@4 x1@@7 unrelatedField)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 x1@@7 unrelatedField))) (=> (= (ControlFlow 0 5) 3) anon16_correct))))))
(let ((anon14_correct  (=> (= Heap@7 (MapType0Store Heap@6 null (|valid#sm| x2 true) (MapType1Store (MapType0Select Heap@6 null (|valid#sm| x2 true)) x2 f_7 (bool_2_U true)))) (=> (and (state Heap@7 Mask@4) (state Heap@7 Mask@4)) (and (=> (= (ControlFlow 0 8) 5) anon24_Then_correct) (=> (= (ControlFlow 0 8) 7) anon24_Else_correct))))))
(let ((anon23_Else_correct  (=> (HasDirectPerm Mask@4 null (valid x2 true)) (=> (and (= Heap@6 Heap@3) (= (ControlFlow 0 10) 8)) anon14_correct))))
(let ((anon23_Then_correct  (=> (not (HasDirectPerm Mask@4 null (valid x2 true))) (=> (and (and (= Heap@4 (MapType0Store Heap@3 null (|valid#sm| x2 true) ZeroPMask)) (= Heap@5 (MapType0Store Heap@4 null (valid x2 true) freshVersion@1))) (and (= Heap@6 Heap@5) (= (ControlFlow 0 9) 8))) anon14_correct))))
(let ((anon12_correct  (=> (and (= Mask@3 (MapType1Store Mask@2 x2 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@2 x2 f_7)) FullPerm)))) (= Mask@4 (MapType1Store Mask@3 null (valid x2 true) (real_2_U (+ (U_2_real (MapType1Select Mask@3 null (valid x2 true))) FullPerm))))) (=> (and (and (state Heap@3 Mask@4) (state Heap@3 Mask@4)) (and (|valid#trigger| Heap@3 (valid x2 true)) (= (MapType0Select Heap@3 null (valid x2 true)) (FrameFragment (FrameFragment (MapType0Select Heap@3 x2 f_7)))))) (and (=> (= (ControlFlow 0 11) 9) anon23_Then_correct) (=> (= (ControlFlow 0 11) 10) anon23_Else_correct))))))
(let ((anon22_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 14) 11)) anon12_correct)))
(let ((anon22_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (U_2_real (MapType1Select Mask@2 x2 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 x2 f_7))) (=> (= (ControlFlow 0 12) 11) anon12_correct))))))
(let ((anon10_correct  (=> (= Heap@3 (MapType0Store Heap@2 null (|valid#sm| x1@@7 true) (MapType1Store (MapType0Select Heap@2 null (|valid#sm| x1@@7 true)) x1@@7 f_7 (bool_2_U true)))) (=> (and (state Heap@3 Mask@2) (state Heap@3 Mask@2)) (and (=> (= (ControlFlow 0 15) 12) anon22_Then_correct) (=> (= (ControlFlow 0 15) 14) anon22_Else_correct))))))
(let ((anon21_Else_correct  (=> (HasDirectPerm Mask@2 null (valid x1@@7 true)) (=> (and (= Heap@2 Heap@@10) (= (ControlFlow 0 17) 15)) anon10_correct))))
(let ((anon21_Then_correct  (=> (not (HasDirectPerm Mask@2 null (valid x1@@7 true))) (=> (and (and (= Heap@0 (MapType0Store Heap@@10 null (|valid#sm| x1@@7 true) ZeroPMask)) (= Heap@1 (MapType0Store Heap@0 null (valid x1@@7 true) freshVersion@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 16) 15))) anon10_correct))))
(let ((anon8_correct  (=> (and (= Mask@1 (MapType1Store QPMask@0 x1@@7 f_7 (real_2_U (- (U_2_real (MapType1Select QPMask@0 x1@@7 f_7)) FullPerm)))) (= Mask@2 (MapType1Store Mask@1 null (valid x1@@7 true) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (valid x1@@7 true))) FullPerm))))) (=> (and (and (state Heap@@10 Mask@2) (state Heap@@10 Mask@2)) (and (|valid#trigger| Heap@@10 (valid x1@@7 true)) (= (MapType0Select Heap@@10 null (valid x1@@7 true)) (FrameFragment (FrameFragment (MapType0Select Heap@@10 x1@@7 f_7)))))) (and (=> (= (ControlFlow 0 18) 16) anon21_Then_correct) (=> (= (ControlFlow 0 18) 17) anon21_Else_correct))))))
(let ((anon20_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 21) 18)) anon8_correct)))
(let ((anon20_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 x1@@7 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 x1@@7 f_7))) (=> (= (ControlFlow 0 19) 18) anon8_correct))))))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_1))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_1@@0))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.2021:15|
 :skolemid |173|
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_1@@1)) (< NoPerm FullPerm)) (and (qpRange9 x_1@@1) (= (invRecv9 x_1@@1) x_1@@1))))
...
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) (invRecv9 o_3))) (< NoPerm FullPerm)) (qpRange9 o_3)) (= (invRecv9 o_3) o_3)))
 :qid |stdinbpl.2031:22|
 :skolemid |175|
 :pattern ( (invRecv9 o_3))
)) (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_1@@2))) (not (= x_1@@2 null)))
...
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) (invRecv9 o_3@@0))) (< NoPerm FullPerm)) (qpRange9 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv9 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select Mask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) (invRecv9 o_3@@0))) (< NoPerm FullPerm)) (qpRange9 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select Mask@0 o_3@@0 f_7))))))
 :qid |stdinbpl.2043:22|
 :skolemid |177|
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.2047:29|
 :skolemid |178|
 :pattern ( (MapType1Select Mask@0 o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
))) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0))) (and (and (=> (= (ControlFlow 0 26) 25) anon18_Then_correct) (=> (= (ControlFlow 0 26) 19) anon20_Then_correct)) (=> (= (ControlFlow 0 26) 21) anon20_Else_correct)))))))))
(let ((anon17_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@10 x1@@7 $allocated)) (U_2_bool (MapType0Select Heap@@10 x2 $allocated))) (and (not (= x1@@7 null)) (= Mask@0 (MapType1Store ZeroMask x1@@7 unrelatedField (real_2_U (+ (U_2_real (MapType1Select ZeroMask x1@@7 unrelatedField)) FullPerm)))))) (and (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (not (= x1@@7 x2)) (state Heap@@10 Mask@0)))) (and (=> (= (ControlFlow 0 28) 1) anon17_Then_correct) (=> (= (ControlFlow 0 28) 26) anon17_Else_correct))))))
