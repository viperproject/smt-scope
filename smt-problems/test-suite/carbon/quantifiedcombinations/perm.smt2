...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@5) (MapType0Type RefType)) (= (type Heap@4) (MapType0Type RefType))) (= (type x@@14) RefType)) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (forall ((arg0@@28 T@U) ) (! (= (type (FrameFragment arg0@@28)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@28))
))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon10_correct  (=> (= Heap@5 (MapType0Store Heap@4 null (|P#sm| x@@14) (MapType1Store (MapType0Select Heap@4 null (|P#sm| x@@14)) x@@14 f_7 (bool_2_U true)))) (=> (and (state Heap@5 Mask@4) (state Heap@5 Mask@4)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= (U_2_real (MapType1Select Mask@4 x@@14 f_7)) NoPerm)) (=> (= (U_2_real (MapType1Select Mask@4 x@@14 f_7)) NoPerm) (=> (and (state Heap@5 Mask@4) (= (ControlFlow 0 3) (- 0 2))) (= (U_2_real (MapType1Select Mask@4 null (P x@@14))) FullPerm))))))))
(let ((anon15_Else_correct  (=> (HasDirectPerm Mask@4 null (P x@@14)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 6) 3)) anon10_correct))))
(let ((anon15_Then_correct  (=> (not (HasDirectPerm Mask@4 null (P x@@14))) (=> (and (and (= Heap@2 (MapType0Store Heap@1 null (|P#sm| x@@14) ZeroPMask)) (= Heap@3 (MapType0Store Heap@2 null (P x@@14) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 5) 3))) anon10_correct))))
(let ((anon8_correct  (=> (= Mask@3 (MapType1Store Mask@2 x@@14 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@2 x@@14 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (> (U_2_int (MapType0Select Heap@1 x@@14 f_7)) 0)) (=> (> (U_2_int (MapType0Select Heap@1 x@@14 f_7)) 0) (=> (= Mask@4 (MapType1Store Mask@3 null (P x@@14) (real_2_U (+ (U_2_real (MapType1Select Mask@3 null (P x@@14))) FullPerm)))) (=> (and (and (state Heap@1 Mask@4) (state Heap@1 Mask@4)) (and (|P#trigger| Heap@1 (P x@@14)) (= (MapType0Select Heap@1 null (P x@@14)) (FrameFragment (MapType0Select Heap@1 x@@14 f_7))))) (and (=> (= (ControlFlow 0 7) 5) anon15_Then_correct) (=> (= (ControlFlow 0 7) 6) anon15_Else_correct)))))))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 7)) anon8_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@2 x@@14 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 x@@14 f_7))) (=> (= (ControlFlow 0 9) 7) anon8_correct))))))
(let ((anon6_correct  (=> (and (not (= x@@14 null)) (= Mask@2 (MapType1Store Mask@1 x@@14 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@1 x@@14 f_7)) FullPerm))))) (=> (and (and (state Heap@1 Mask@2) (> (U_2_int (MapType0Select Heap@1 x@@14 f_7)) 0)) (and (state Heap@1 Mask@2) (state Heap@1 Mask@2))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (= (U_2_real (MapType1Select Mask@2 x@@14 f_7)) FullPerm)) (=> (= (U_2_real (MapType1Select Mask@2 x@@14 f_7)) FullPerm) (=> (state Heap@1 Mask@2) (and (=> (= (ControlFlow 0 12) (- 0 13)) (= (U_2_real (MapType1Select Mask@2 null (P x@@14))) NoPerm)) (=> (= (U_2_real (MapType1Select Mask@2 null (P x@@14))) NoPerm) (=> (state Heap@1 Mask@2) (and (=> (= (ControlFlow 0 12) 9) anon14_Then_correct) (=> (= (ControlFlow 0 12) 11) anon14_Else_correct))))))))))))
(let ((anon13_Else_correct  (=> (HasDirectPerm Mask@1 null (P x@@14)) (=> (and (= Heap@1 ExhaleHeap@0) (= (ControlFlow 0 16) 12)) anon6_correct))))
(let ((anon13_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (P x@@14))) (= Heap@0 (MapType0Store ExhaleHeap@0 null (P x@@14) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 15) 12))) anon6_correct)))
(let ((anon4_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (P x@@14) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P x@@14))) FullPerm)))) (and (=> (= (ControlFlow 0 17) 15) anon13_Then_correct) (=> (= (ControlFlow 0 17) 16) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 20) 17)) anon4_correct)))
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P x@@14))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P x@@14)))) (=> (= (ControlFlow 0 18) 17) anon4_correct))))))
(let ((anon11_Else_correct  (=> (and (forall ((x_1_1 T@U) ) (!  (=> (= (type x_1_1) RefType) (= (U_2_real (MapType1Select QPMask@0 null (P x_1_1))) (U_2_real (MapType1Select ZeroMask null (P x_1_1)))))
 :qid |stdinbpl.413:22|
 :skolemid |30|
 :pattern ( (MapType1Select QPMask@0 null (P x_1_1)))
...
))) (=> (and (and (and (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@0 QPMask@0) (state ExhaleHeap@0 QPMask@0)) (and (= Mask@0 (MapType1Store QPMask@0 null (P x@@14) (real_2_U (+ (U_2_real (MapType1Select QPMask@0 null (P x@@14))) FullPerm)))) (state ExhaleHeap@0 Mask@0))) (and (and (state ExhaleHeap@0 Mask@0) (state ExhaleHeap@0 Mask@0)) (and (|P#trigger| ExhaleHeap@0 (P x@@14)) (= (MapType0Select ExhaleHeap@0 null (P x@@14)) (FrameFragment (MapType0Select ExhaleHeap@0 x@@14 f_7)))))) (and (=> (= (ControlFlow 0 21) 18) anon12_Then_correct) (=> (= (ControlFlow 0 21) 20) anon12_Else_correct))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x@@14 $allocated))) (and (=> (= (ControlFlow 0 22) 1) anon11_Then_correct) (=> (= (ControlFlow 0 22) 21) anon11_Else_correct)))))
