...
(assert  (and (forall ((arg0@@18 T@T) ) (! (= (Ctor (ListDomainTypeType arg0@@18)) 9)
...
(assert (forall ((x@@8 T@U) ) (! (let ((V (ListDomainTypeTypeInv0 (type x@@8))))
 (=> (= (type x@@8) (ListDomainTypeType V)) (bounded x@@8)))
 :qid |stdinbpl.276:19|
 :skolemid |29|
 :pattern ( (bounded x@@8))
)))
...
(assert (= (Ctor ValDomainTypeType) 11))
...
(assert (forall ((arg0@@27 T@U) (arg1@@9 T@U) ) (! (let ((V@@0 (type arg0@@27)))
(= (type (Cons arg0@@27 arg1@@9)) (ListDomainTypeType V@@0)))
 :qid |funType:Cons|
 :pattern ( (Cons arg0@@27 arg1@@9))
)))
(assert (forall ((tail_0 T@U) (value_1 T@U) ) (! (let ((V@@1 (type value_1)))
 (=> (= (type tail_0) (ListDomainTypeType V@@1)) (decreasing tail_0 (Cons value_1 tail_0))))
 :qid |stdinbpl.264:19|
 :skolemid |27|
...
(assert  (and (and (forall ((arg0@@28 T@U) ) (! (let ((V@@2 (ListDomainTypeTypeInv0 (type arg0@@28))))
(= (type (get_List_value arg0@@28)) V@@2))
 :qid |funType:get_List_value|
 :pattern ( (get_List_value arg0@@28))
)) (forall ((arg0@@29 T@U) ) (! (let ((V@@3 (ListDomainTypeTypeInv0 (type arg0@@29))))
(= (type (get_List_tail arg0@@29)) (ListDomainTypeType V@@3)))
 :qid |funType:get_List_tail|
 :pattern ( (get_List_tail arg0@@29))
))) (forall ((V@@4 T@T) ) (! (= (type (Nil V@@4)) (ListDomainTypeType V@@4))
 :qid |funType:Nil|
 :pattern ( (Nil V@@4))
))))
(assert (forall ((t_2 T@U) ) (! (let ((V@@5 (ListDomainTypeTypeInv0 (type t_2))))
 (=> (= (type t_2) (ListDomainTypeType V@@5)) (or (= t_2 (Nil V@@5)) (= t_2 (Cons (get_List_value t_2) (get_List_tail t_2))))))
 :qid |stdinbpl.248:19|
 :skolemid |26|
...
(assert (forall ((value_1@@0 T@U) (tail_1 T@U) ) (! (let ((V@@6 (type value_1@@0)))
 (=> (= (type tail_1) (ListDomainTypeType V@@6)) (= value_1@@0 (get_List_value (Cons value_1@@0 tail_1)))))
 :qid |stdinbpl.224:19|
 :skolemid |22|
 :pattern ( (Cons value_1@@0 tail_1))
)))
(assert (forall ((value_1@@1 T@U) (tail_1@@0 T@U) ) (! (let ((V@@7 (type value_1@@1)))
 (=> (= (type tail_1@@0) (ListDomainTypeType V@@7)) (= tail_1@@0 (get_List_tail (Cons value_1@@1 tail_1@@0)))))
 :qid |stdinbpl.230:19|
 :skolemid |23|
...
(assert (forall ((value_1@@2 T@U) (tail_1@@1 T@U) ) (! (let ((V@@8 (type value_1@@2)))
 (=> (= (type tail_1@@1) (ListDomainTypeType V@@8)) (= (List_tag (Cons value_1@@2 tail_1@@1)) 0)))
 :qid |stdinbpl.242:19|
 :skolemid |25|
...
(assert (forall ((v1 T@U) (v2 T@U) (v3 T@U) ) (! (let ((V@@10 (ListDomainTypeTypeInv0 (type v1))))
 (=> (and (and (and (= (type v1) (ListDomainTypeType V@@10)) (= (type v2) (ListDomainTypeType V@@10))) (= (type v3) (ListDomainTypeType V@@10))) (and (decreasing v1 v2) (decreasing v2 v3))) (decreasing v1 v3)))
 :qid |stdinbpl.270:19|
 :skolemid |28|
...
(declare-fun l@@19 () T@U)
(declare-fun Heap@@29 () T@U)
(assert  (and (= (type l@@19) (ListDomainTypeType ValDomainTypeType)) (= (type Heap@@29) (MapType0Type RefType))))
(set-info :boogie-vc-id |len2#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon7_correct  (=> (and (= Result@0 (ite (= (List_tag l@@19) 1) 0 (ite (= (List_tag (get_List_tail l@@19)) 1) 1 (+ 2 (len2 Heap@@29 (get_List_tail (get_List_tail l@@19))))))) (= (ControlFlow 0 3) (- 0 2))) (>= Result@0 0))))
(let ((anon10_Else_correct  (=> (and (|len2#trigger| EmptyFrame (get_List_tail (get_List_tail l@@19))) (= (ControlFlow 0 6) 3)) anon7_correct)))
(let ((anon9_Then_correct  (=> (and (= (List_tag (get_List_tail l@@19)) 1) (= (ControlFlow 0 5) 3)) anon7_correct)))
(let ((anon8_Then_correct  (=> (and (= (List_tag l@@19) 1) (= (ControlFlow 0 4) 3)) anon7_correct)))
(let ((anon10_Then_correct true))
(let ((anon9_Else_correct  (=> (not (= (List_tag (get_List_tail l@@19)) 1)) (and (=> (= (ControlFlow 0 7) 1) anon10_Then_correct) (=> (= (ControlFlow 0 7) 6) anon10_Else_correct)))))
(let ((anon8_Else_correct  (=> (not (= (List_tag l@@19) 1)) (and (=> (= (ControlFlow 0 8) 5) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct)))))
(let ((anon0_correct  (=> (and (state Heap@@29 ZeroMask) (= AssumeFunctionsAbove 1)) (and (=> (= (ControlFlow 0 9) 4) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct)))))
