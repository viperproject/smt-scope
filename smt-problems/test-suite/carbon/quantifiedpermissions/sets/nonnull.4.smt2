...
(declare-fun y@@6 () T@U)
(assert  (and (and (and (and (and (= (type xs) (MapType2Type RefType boolType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv1 arg0@@43)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (U_2_bool (MapType2Select xs z_1))) (U_2_bool (MapType2Select xs z_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1))))
 :qid |stdinbpl.432:15|
 :skolemid |82|
 :no-pattern (type z_1)
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (not (= x@@19 null))) (=> (not (= x@@19 null)) (=> (and (state Heap@@9 QPMask@0) (= (ControlFlow 0 3) (- 0 2))) (not (= y@@6 null))))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 x@@19 $allocated)) (U_2_bool (MapType0Select Heap@@9 y@@6 $allocated))) (and (U_2_bool (MapType2Select xs x@@19)) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 6) 1) anon3_Then_correct) (=> (= (ControlFlow 0 6) 3) anon3_Else_correct))))))
