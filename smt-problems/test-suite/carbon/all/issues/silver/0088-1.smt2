...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type Cellx) (FieldType NormalFieldType intType))))
(assert (distinct $allocated Cellx)
)
...
(assert  (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type this) RefType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id Cellvoid)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon4_correct true))
(let ((anon6_Else_correct  (=> (and (= k NoPerm) (= (ControlFlow 0 6) 3)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= k NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= k (U_2_real (MapType1Select Mask@0 this Cellx)))) (=> (<= k (U_2_real (MapType1Select Mask@0 this Cellx))) (=> (= (ControlFlow 0 4) 3) anon4_correct))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (>= k NoPerm)) (=> (>= k NoPerm) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))
(let ((anon5_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (>= k NoPerm))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 this $allocated))) (and (not (= this null)) (state Heap@@9 ZeroMask))) (and (and (< NoPerm k) (state Heap@@9 ZeroMask)) (and (< k FullPerm) (state Heap@@9 ZeroMask)))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (>= k NoPerm)) (=> (>= k NoPerm) (=> (and (and (=> (> k NoPerm) (not (= this null))) (= Mask@0 (MapType1Store ZeroMask this Cellx (real_2_U (+ (U_2_real (MapType1Select ZeroMask this Cellx)) k))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 9) 2) anon5_Then_correct) (=> (= (ControlFlow 0 9) 7) anon5_Else_correct))))))))
