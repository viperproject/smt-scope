...
(assert  (and (and (and (and (and (= (type ar@@27) (SeqType RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@33) (MapType0Type RefType))) (= (type diz) RefType)))
(set-info :boogie-vc-id Ref__loop_main_23)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 39) (let ((anon20_correct true))
(let ((anon39_Else_correct  (=> (and (not (and (<= 0 i_8) (< i_8 len))) (= (ControlFlow 0 25) 20)) anon20_correct)))
(let ((anon39_Then_correct  (=> (and (<= 0 i_8) (< i_8 len)) (and (=> (= (ControlFlow 0 21) (- 0 24)) (>= i_8 0)) (=> (>= i_8 0) (and (=> (= (ControlFlow 0 21) (- 0 23)) (< i_8 (|Seq#Length| ar@@27))) (=> (< i_8 (|Seq#Length| ar@@27)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (HasDirectPerm QPMask@1 (|Seq#Index| ar@@27 i_8) Ref__Integer_value)) (=> (HasDirectPerm QPMask@1 (|Seq#Index| ar@@27 i_8) Ref__Integer_value) (=> (= (ControlFlow 0 21) 20) anon20_correct))))))))))
(let ((anon38_Else_correct true))
(let ((anon36_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 len))) (and (<= 0 i_3_1) (< i_3_1 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ar@@27 i_3) (|Seq#Index| ar@@27 i_3_1))))
 ...
 :qid |stdinbpl.1999:15|
 :skolemid |168|
)) (=> (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 len)) (< NoPerm FullPerm)) (and (qpRange10 (|Seq#Index| ar@@27 i_3@@1)) (= (invRecv10 (|Seq#Index| ar@@27 i_3@@1)) i_3@@1)))
 :qid |stdinbpl.2005:22|
 :skolemid |169|
 :pattern ( (|Seq#Index| ar@@27 i_3@@1))
 :pattern ( (|Seq#Index| ar@@27 i_3@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv10 o_3)) (< (invRecv10 o_3) len)) (< NoPerm FullPerm)) (qpRange10 o_3)) (= (|Seq#Index| ar@@27 (invRecv10 o_3)) o_3)))
 ...
 :pattern ( (|Seq#Index| ar@@27 i_3@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv10 o_3@@0)) (< (invRecv10 o_3@@0) len)) (< NoPerm FullPerm)) (qpRange10 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| ar@@27 (invRecv10 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 Ref__Integer_value)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 Ref__Integer_value)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv10 o_3@@0)) (< (invRecv10 o_3@@0) len)) (< NoPerm FullPerm)) (qpRange10 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 Ref__Integer_value)) (U_2_real (MapType1Select ZeroMask o_3@@0 Ref__Integer_value))))))
...
(let ((anon37_Else_correct  (=> (and (not (and (<= 0 i_7) (< i_7 len))) (= (ControlFlow 0 18) 14)) anon16_correct)))
(let ((anon37_Then_correct  (=> (and (<= 0 i_7) (< i_7 len)) (and (=> (= (ControlFlow 0 15) (- 0 17)) (>= i_7 0)) (=> (>= i_7 0) (and (=> (= (ControlFlow 0 15) (- 0 16)) (< i_7 (|Seq#Length| ar@@27))) (=> (< i_7 (|Seq#Length| ar@@27)) (=> (= (ControlFlow 0 15) 14) anon16_correct))))))))
...
(let ((anon35_Then_correct  (=> (< 0 len) (=> (and (= (|Seq#Length| ar@@27) len) (= (ControlFlow 0 29) 28)) anon13_correct))))
...
(let ((anon32_Else_correct  (and (=> (= (ControlFlow 0 32) (- 0 33)) (forall ((i_1 Int) (i_1_2 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_2)) (and (<= 0 i_1) (< i_1 len))) (and (<= 0 i_1_2) (< i_1_2 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ar@@27 i_1) (|Seq#Index| ar@@27 i_1_2))))
 ...
 :pattern ( (|Seq#Index| ar@@27 i_1@@1))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (<= 0 (invRecv9 o_3@@2)) (< (invRecv9 o_3@@2) len)) (< NoPerm FullPerm)) (qpRange9 o_3@@2)) (= (|Seq#Index| ar@@27 (invRecv9 o_3@@2)) o_3@@2)))
 ...
 :pattern ( (|Seq#Index| ar@@27 i_1@@2))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (and (<= 0 (invRecv9 o_3@@3)) (< (invRecv9 o_3@@3) len)) (< NoPerm FullPerm)) (qpRange9 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| ar@@27 (invRecv9 o_3@@3)) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 Ref__Integer_value)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 Ref__Integer_value)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv9 o_3@@3)) (< (invRecv9 o_3@@3) len)) (< NoPerm FullPerm)) (qpRange9 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 Ref__Integer_value)) (U_2_real (MapType1Select ZeroMask o_3@@3 Ref__Integer_value))))))
 :qid |stdinbpl.1960:22|
 :skolemid |166|
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 ...
 :qid |stdinbpl.1964:29|
 :skolemid |167|
 :pattern ( (MapType1Select ZeroMask o_3@@4 f_5@@0))
 :pattern ( (MapType1Select QPMask@0 o_3@@4 f_5@@0))
))) (and (state Heap@@33 QPMask@0) (state Heap@@33 QPMask@0))) (and (=> (= (ControlFlow 0 32) 31) anon34_Then_correct) (=> (= (ControlFlow 0 32) 13) anon34_Else_correct)))))))))
(let ((anon9_correct true))
(let ((anon33_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 len))) (= (ControlFlow 0 12) 8)) anon9_correct)))
(let ((anon33_Then_correct  (=> (and (<= 0 i_2) (< i_2 len)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_2 (|Seq#Length| ar@@27))) (=> (< i_2 (|Seq#Length| ar@@27)) (=> (= (ControlFlow 0 9) 8) anon9_correct))))))))
(let ((anon30_Else_correct  (=> (and (forall ((j_1_1@@0 Int) (k_1_1 Int) ) (!  (=> (and (<= 0 j_1_1@@0) (and (< j_1_1@@0 len) (and (<= 0 k_1_1) (and (< k_1_1 len) (not (= j_1_1@@0 k_1_1)))))) (not (= (|Seq#Index| ar@@27 j_1_1@@0) (|Seq#Index| ar@@27 k_1_1))))
 :qid |stdinbpl.1920:20|
 :skolemid |161|
 :pattern ( (|Seq#Index| ar@@27 j_1_1@@0) (|Seq#Index| ar@@27 k_1_1))
)) (state Heap@@33 ZeroMask)) (and (and (=> (= (ControlFlow 0 34) 32) anon32_Else_correct) (=> (= (ControlFlow 0 34) 9) anon33_Then_correct)) (=> (= (ControlFlow 0 34) 12) anon33_Else_correct)))))
(let ((anon5_correct true))
(let ((anon31_Else_correct  (=> (and (not (and (<= 0 j_12) (and (< j_12 len) (and (<= 0 k_19) (and (< k_19 len) (not (= j_12 k_19))))))) (= (ControlFlow 0 7) 1)) anon5_correct)))
(let ((anon31_Then_correct  (=> (and (<= 0 j_12) (and (< j_12 len) (and (<= 0 k_19) (and (< k_19 len) (not (= j_12 k_19)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j_12 0)) (=> (>= j_12 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j_12 (|Seq#Length| ar@@27))) (=> (< j_12 (|Seq#Length| ar@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_19 0)) (=> (>= k_19 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_19 (|Seq#Length| ar@@27))) (=> (< k_19 (|Seq#Length| ar@@27)) (=> (= (ControlFlow 0 2) 1) anon5_correct))))))))))))
(let ((anon2_correct  (=> (state Heap@@33 ZeroMask) (and (and (=> (= (ControlFlow 0 35) 34) anon30_Else_correct) (=> (= (ControlFlow 0 35) 2) anon31_Then_correct)) (=> (= (ControlFlow 0 35) 7) anon31_Else_correct)))))
(let ((anon29_Else_correct  (=> (and (<= len 0) (= (ControlFlow 0 37) 35)) anon2_correct)))
(let ((anon29_Then_correct  (=> (< 0 len) (=> (and (= (|Seq#Length| ar@@27) len) (= (ControlFlow 0 36) 35)) anon2_correct))))
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@33 diz $allocated))) (=> (and (and (not (= diz null)) (state Heap@@33 ZeroMask)) (and (>= current_thread_id 0) (state Heap@@33 ZeroMask))) (and (=> (= (ControlFlow 0 38) 36) anon29_Then_correct) (=> (= (ControlFlow 0 38) 37) anon29_Else_correct)))))))
