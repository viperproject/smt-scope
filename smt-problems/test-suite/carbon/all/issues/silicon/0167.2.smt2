...
(declare-fun |f#frame| (T@U Int) Bool)
(declare-fun |g#frame| (T@U Int) Bool)
(declare-fun |h#frame| (T@U Int) Bool)
(declare-fun f_6@@0 (T@U Int) Bool)
(declare-fun g (T@U Int) Bool)
(declare-fun h (T@U Int) Bool)
...
(assert (forall ((Heap@@2 T@U) (n Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (bool_2_U (|f#triggerStateless| n))))
 :qid |stdinbpl.191:15|
 :skolemid |23|
 :pattern ( (|f'| Heap@@2 n))
)))
(assert (forall ((Heap@@3 T@U) (n@@0 Int) ) (!  (=> (= (type Heap@@3) (MapType0Type RefType)) (dummyFunction (bool_2_U (|g#triggerStateless| n@@0))))
 :qid |stdinbpl.231:15|
 :skolemid |26|
 :pattern ( (|g'| Heap@@3 n@@0))
)))
(assert (forall ((Heap@@4 T@U) (n@@1 Int) ) (!  (=> (= (type Heap@@4) (MapType0Type RefType)) (dummyFunction (bool_2_U (|h#triggerStateless| n@@1))))
 :qid |stdinbpl.282:15|
 :skolemid |29|
 :pattern ( (|h'| Heap@@4 n@@1))
)))
...
(assert (forall ((Heap@@8 T@U) (Mask@@6 T@U) (n@@2 Int) ) (!  (=> (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (state Heap@@8 Mask@@6)) (= (|f'| Heap@@8 n@@2) (|f#frame| EmptyFrame n@@2)))
 :qid |stdinbpl.198:15|
 :skolemid |24|
 :pattern ( (state Heap@@8 Mask@@6) (|f'| Heap@@8 n@@2))
)))
(assert (forall ((Heap@@9 T@U) (Mask@@7 T@U) (n@@3 Int) ) (!  (=> (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (state Heap@@9 Mask@@7)) (= (|g'| Heap@@9 n@@3) (|g#frame| EmptyFrame n@@3)))
 :qid |stdinbpl.238:15|
 :skolemid |27|
 :pattern ( (state Heap@@9 Mask@@7) (|g'| Heap@@9 n@@3))
)))
(assert (forall ((Heap@@10 T@U) (Mask@@8 T@U) (n@@4 Int) ) (!  (=> (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@8) (MapType1Type RefType realType))) (state Heap@@10 Mask@@8)) (= (|h'| Heap@@10 n@@4) (|h#frame| EmptyFrame n@@4)))
 :qid |stdinbpl.289:15|
 :skolemid |30|
 :pattern ( (state Heap@@10 Mask@@8) (|h'| Heap@@10 n@@4))
)))
(assert (forall ((Heap@@11 T@U) (n@@5 Int) ) (!  (=> (= (type Heap@@11) (MapType0Type RefType)) (and (= (f_6@@0 Heap@@11 n@@5) (|f'| Heap@@11 n@@5)) (dummyFunction (bool_2_U (|f#triggerStateless| n@@5)))))
 :qid |stdinbpl.187:15|
 :skolemid |22|
 :pattern ( (f_6@@0 Heap@@11 n@@5))
)))
(assert (forall ((Heap@@12 T@U) (n@@6 Int) ) (!  (=> (= (type Heap@@12) (MapType0Type RefType)) (and (= (g Heap@@12 n@@6) (|g'| Heap@@12 n@@6)) (dummyFunction (bool_2_U (|g#triggerStateless| n@@6)))))
 :qid |stdinbpl.227:15|
 :skolemid |25|
 :pattern ( (g Heap@@12 n@@6))
)))
(assert (forall ((Heap@@13 T@U) (n@@7 Int) ) (!  (=> (= (type Heap@@13) (MapType0Type RefType)) (and (= (h Heap@@13 n@@7) (|h'| Heap@@13 n@@7)) (dummyFunction (bool_2_U (|h#triggerStateless| n@@7)))))
 :qid |stdinbpl.278:15|
 :skolemid |28|
 :pattern ( (h Heap@@13 n@@7))
)))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon17_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (h Heap@@18 n@@8))))
(let ((anon17_Then_correct true))
(let ((anon16_Else_correct  (=> (and (g Heap@@18 n@@8) (state Heap@@18 ZeroMask)) (=> (and (and (state Heap@@18 ZeroMask) (= n@@8 5)) (and (state Heap@@18 ZeroMask) (state Heap@@18 ZeroMask))) (and (=> (= (ControlFlow 0 11) 8) anon17_Then_correct) (=> (= (ControlFlow 0 11) 10) anon17_Else_correct))))))
(let ((anon16_Then_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (f_6@@0 Heap@@18 n@@8))))
(let ((anon15_Else_correct  (=> (and (f_6@@0 Heap@@18 n@@8) (state Heap@@18 ZeroMask)) (and (=> (= (ControlFlow 0 12) 7) anon16_Then_correct) (=> (= (ControlFlow 0 12) 11) anon16_Else_correct)))))
(let ((anon15_Then_correct true))
(let ((anon12_Else_correct  (=> (and (and (forall ((i_1 Int) ) (!  (=> (> i_1 4) (h Heap@@18 i_1))
 :qid |stdinbpl.348:20|
 :skolemid |31|
 :pattern ( (|g#frame| EmptyFrame i_1))
)) (state Heap@@18 ZeroMask)) (and (state Heap@@18 ZeroMask) (state Heap@@18 ZeroMask))) (and (=> (= (ControlFlow 0 13) 5) anon15_Then_correct) (=> (= (ControlFlow 0 13) 12) anon15_Else_correct)))))
(let ((anon14_Then_correct true))
(let ((anon4_correct true))
(let ((anon13_Then_correct  (=> (> i 4) (and (=> (= (ControlFlow 0 4) 3) anon14_Then_correct) (=> (= (ControlFlow 0 4) 1) anon4_correct)))))
(let ((anon13_Else_correct  (=> (and (>= 4 i) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (state Heap@@18 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (state Heap@@18 ZeroMask)) (and (and (=> (= (ControlFlow 0 14) 13) anon12_Else_correct) (=> (= (ControlFlow 0 14) 4) anon13_Then_correct)) (=> (= (ControlFlow 0 14) 2) anon13_Else_correct))))))
