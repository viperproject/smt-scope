...
(assert  (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type x@@8) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type r_1) RefType)))
(set-info :boogie-vc-id test01a)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (not (HasDirectPerm ZeroMask r_1 f_7)) (= (ControlFlow 0 8) 4)) anon3_correct)))
(let ((anon6_Then_correct  (=> (HasDirectPerm ZeroMask r_1 f_7) (and (=> (= (ControlFlow 0 5) (- 0 7)) (HasDirectPerm ZeroMask r_1 f_7)) (=> (HasDirectPerm ZeroMask r_1 f_7) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm ZeroMask r_1 f_7)) (=> (HasDirectPerm ZeroMask r_1 f_7) (=> (= (ControlFlow 0 5) 4) anon3_correct))))))))
(let ((anon5_Else_correct  (=> (and (forall ((r_1_1 T@U) ) (!  (=> (and (= (type r_1_1) RefType) (HasDirectPerm ZeroMask r_1_1 f_7)) (> (U_2_int (MapType0Select Heap@@9 r_1_1 f_7)) 0))
 :qid |stdinbpl.222:20|
 :skolemid |22|
 :pattern ( (MapType1Select ZeroMask r_1_1 f_7))
 :pattern ( (MapType0Select Heap@@9 r_1_1 f_7))
)) (not (= x@@8 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 x@@8 f_7)) (=> (HasDirectPerm Mask@0 x@@8 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (> (U_2_int (MapType0Select Heap@@9 x@@8 f_7)) 0))))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (and (and (=> (= (ControlFlow 0 9) 2) anon5_Else_correct) (=> (= (ControlFlow 0 9) 5) anon6_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct)))))
