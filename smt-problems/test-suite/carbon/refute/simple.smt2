...
(let ((anon22_Else_correct  (=> (and (and (not __plugin_refute_nondet6) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 14) 12))) anon15_correct)))
(let ((anon21_Then_correct  (=> (> x@@8 0) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 13) 12)) anon15_correct))))
(let ((anon22_Then_correct  (=> (and __plugin_refute_nondet6 (= (ControlFlow 0 11) (- 0 10))) false)))
(let ((anon21_Else_correct  (=> (>= 0 x@@8) (and (=> (= (ControlFlow 0 15) 11) anon22_Then_correct) (=> (= (ControlFlow 0 15) 14) anon22_Else_correct)))))
(let ((anon20_Else_correct  (=> (and (not __plugin_refute_nondet5) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 16) 13) anon21_Then_correct) (=> (= (ControlFlow 0 16) 15) anon21_Else_correct)))))
(let ((anon20_Then_correct  (=> (and __plugin_refute_nondet5 (= (ControlFlow 0 9) (- 0 8))) false)))
(let ((anon19_Else_correct  (=> (and (not __plugin_refute_nondet4) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 17) 9) anon20_Then_correct) (=> (= (ControlFlow 0 17) 16) anon20_Else_correct)))))
(let ((anon19_Then_correct true))
(let ((anon18_Else_correct  (=> (and (not __plugin_refute_nondet3) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 18) 7) anon19_Then_correct) (=> (= (ControlFlow 0 18) 17) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (and __plugin_refute_nondet3 (= (ControlFlow 0 6) (- 0 5))) false)))
(let ((anon17_Else_correct  (=> (and (not __plugin_refute_nondet2) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 19) 6) anon18_Then_correct) (=> (= (ControlFlow 0 19) 18) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (and __plugin_refute_nondet2 (= (ControlFlow 0 4) (- 0 3))) (> x@@8 0))))
(let ((anon16_Else_correct  (=> (and (not __plugin_refute_nondet1) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 20) 4) anon17_Then_correct) (=> (= (ControlFlow 0 20) 19) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (and __plugin_refute_nondet1 (= (ControlFlow 0 2) (- 0 1))) (not (> x@@8 0)))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (> x@@8 10) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 21) 2) anon16_Then_correct) (=> (= (ControlFlow 0 21) 20) anon16_Else_correct))))))
