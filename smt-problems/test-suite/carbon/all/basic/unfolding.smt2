...
(let ((anon9_Then_correct  (=> (not (= (MapType0Select Heap@1 r_1@@23 next) null)) (=> (and (and (forall ((o_12 T@U) (f_17 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_17))))
(let ((A@@12 (FieldTypeInv0 (type f_17))))
 (=> (and (and (= (type o_12) RefType) (= (type f_17) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|valid#sm| r_1@@23)) o_12 f_17)) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|valid#sm| (MapType0Select Heap@1 r_1@@23 next))) o_12 f_17)))) (U_2_bool (MapType1Select newPMask@0 o_12 f_17)))))
 :qid |stdinbpl.950:33|
 :skolemid |55|
...
(let ((anon7_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid r_1@@23))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid r_1@@23)))) (=> (= (ControlFlow 0 9) 8) anon2_correct))))))
