...
(declare-fun b_62@6 () Bool)
(declare-fun neededTransfer@15 () Real)
(declare-fun Used_26Mask@3 () T@U)
(declare-fun initNeededTransfer@2 () Real)
(declare-fun b_63@0 () Bool)
(declare-fun b_63@1 () Bool)
(declare-fun Result_24Heap () T@U)
(declare-fun Result_24Mask () T@U)
(declare-fun b_63@2 () Bool)
(declare-fun Ops_21Mask () T@U)
(declare-fun b_63@3 () Bool)
(declare-fun Ops_21Heap@4 () T@U)
(declare-fun Used_26Heap@0 () T@U)
(declare-fun b_63@4 () Bool)
...
(declare-fun b_62@3 () Bool)
(declare-fun Used_26Mask@1 () T@U)
(declare-fun neededTransfer@14 () Real)
(declare-fun Used_26Mask@2 () T@U)
(declare-fun b_62@4 () Bool)
(declare-fun b_62@5 () Bool)
(declare-fun Mask@9 () T@U)
(declare-fun Heap@7 () T@U)
(declare-fun maskTransfer@6 () Real)
(declare-fun takeTransfer@5 () Real)
(declare-fun b_62@0 () Bool)
(declare-fun neededTransfer@11 () Real)
(declare-fun neededTransfer@12 () Real)
(declare-fun Used_26Mask@0 () T@U)
(declare-fun b_62@1 () Bool)
(declare-fun b_62@2 () Bool)
(declare-fun Ops_21Mask@11 () T@U)
(declare-fun Ops_21Mask@10 () T@U)
(declare-fun maskTransfer@5 () Real)
(declare-fun b_62 () Bool)
(declare-fun Ops_21Mask@9 () T@U)
(declare-fun Ops_21Mask@8 () T@U)
(declare-fun b_55@14 () Bool)
(declare-fun b_55@13 () Bool)
(declare-fun Ops_21Heap@3 () T@U)
(declare-fun b_55@15 () Bool)
(declare-fun b_55@16 () Bool)
(declare-fun Heap@5 () T@U)
(declare-fun Mask@7 () T@U)
(declare-fun b_59@2 () Bool)
(declare-fun b_60@9 () Bool)
(declare-fun neededTransfer@10 () Real)
(declare-fun Used_25Mask@5 () T@U)
...
(declare-fun Ops_21Mask@7 () T@U)
(declare-fun Ops_21Heap@2 () T@U)
(declare-fun takeTransfer@4 () Real)
(declare-fun Mask@4 () T@U)
(declare-fun Heap@2 () T@U)
(declare-fun Used_25Mask@3 () T@U)
(declare-fun b_60@6 () Bool)
(declare-fun neededTransfer@8 () Real)
(declare-fun neededTransfer@9 () Real)
(declare-fun Used_25Mask@4 () T@U)
(declare-fun b_60@7 () Bool)
(declare-fun b_60@8 () Bool)
...
(declare-fun Used_25Mask@1 () T@U)
(declare-fun neededTransfer@7 () Real)
(declare-fun Used_25Mask@2 () T@U)
(declare-fun b_60@4 () Bool)
(declare-fun b_60@5 () Bool)
(declare-fun Ops_21Mask@6 () T@U)
(declare-fun Ops_21Heap@1 () T@U)
(declare-fun maskTransfer@3 () Real)
(declare-fun takeTransfer@2 () Real)
(declare-fun b_60@0 () Bool)
(declare-fun neededTransfer@4 () Real)
(declare-fun neededTransfer@5 () Real)
(declare-fun Used_25Mask@0 () T@U)
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@12) (MapType0Type RefType realType)) (= (type x@@14) RefType)) (= (type Heap@9) (MapType1Type RefType))) (= (type Mask@11) (MapType0Type RefType realType))) (= (type Mask@8) (MapType0Type RefType realType))) (= (type Heap@6) (MapType1Type RefType))) (= (type Used_26Mask@3) (MapType0Type RefType realType))) (= (type Result_24Heap) (MapType1Type RefType))) (= (type Result_24Mask) (MapType0Type RefType realType))) (= (type Ops_21Mask) (MapType0Type RefType realType))) (= (type Ops_21Heap@4) (MapType1Type RefType))) (= (type Used_26Heap@0) (MapType1Type RefType))) (= (type Mask@10) (MapType0Type RefType realType))) (= (type Heap@8) (MapType1Type RefType))) (= (type Used_26Mask@1) (MapType0Type RefType realType))) (= (type Used_26Mask@2) (MapType0Type RefType realType))) (= (type Mask@9) (MapType0Type RefType realType))) (= (type Heap@7) (MapType1Type RefType))) (= (type Used_26Mask@0) (MapType0Type RefType realType))) (= (type Ops_21Mask@11) (MapType0Type RefType realType))) (= (type Ops_21Mask@10) (MapType0Type RefType realType))) (= (type Ops_21Mask@5) (MapType0Type RefType realType))) (= (type Heap@2) (MapType1Type RefType))) (= (type Mask@4) (MapType0Type RefType realType))) (= (type Ops_21Heap@0) (MapType1Type RefType))) (= (type Ops_21Mask@9) (MapType0Type RefType realType))) (= (type Ops_21Mask@8) (MapType0Type RefType realType))) (= (type Ops_21Heap@3) (MapType1Type RefType))) (= (type Heap@5) (MapType1Type RefType))) (= (type Mask@7) (MapType0Type RefType realType))) (= (type Used_25Mask@5) (MapType0Type RefType realType))) (= (type Result_23Heap) (MapType1Type RefType))) (= (type Result_23Mask) (MapType0Type RefType realType))) (= (type Ops_23Mask) (MapType0Type RefType realType))) (= (type Ops_23Heap@0) (MapType1Type RefType))) (= (type Used_25Heap@0) (MapType1Type RefType))) (= (type Heap@4) (MapType1Type RefType))) (= (type Mask@6) (MapType0Type RefType realType))) (= (type Ops_21Mask@7) (MapType0Type RefType realType))) (= (type Ops_21Heap@2) (MapType1Type RefType))) (= (type Used_25Mask@3) (MapType0Type RefType realType))) (= (type Used_25Mask@4) (MapType0Type RefType realType))) (= (type Mask@5) (MapType0Type RefType realType))) (= (type Heap@3) (MapType1Type RefType))) (= (type Used_25Mask@1) (MapType0Type RefType realType))) (= (type Used_25Mask@2) (MapType0Type RefType realType))) (= (type Ops_21Mask@6) (MapType0Type RefType realType))) (= (type Ops_21Heap@1) (MapType1Type RefType))) (= (type Used_25Mask@0) (MapType0Type RefType realType))) (= (type Ops_23Mask@0) (MapType0Type RefType realType))) (= (type Used_24Heap@0) (MapType1Type RefType))) (= (type Mask@1) (MapType0Type RefType realType))) (= (type Heap@@10) (MapType1Type RefType))) (= (type Ops_21Mask@4) (MapType0Type RefType realType))) (= (type Mask@3) (MapType0Type RefType realType))) (= (type Heap@1) (MapType1Type RefType))) (= (type Ops_21Mask@2) (MapType0Type RefType realType))) (= (type Ops_21Mask@1) (MapType0Type RefType realType))) (= (type Ops_21Mask@3) (MapType0Type RefType realType))) (= (type Used_23Mask@3) (MapType0Type RefType realType))) (= (type Result_22Heap) (MapType1Type RefType))) (= (type Result_22Mask) (MapType0Type RefType realType))) (= (type Used_23Heap@0) (MapType1Type RefType))) (= (type Used_23Mask@1) (MapType0Type RefType realType))) (= (type Used_23Mask@2) (MapType0Type RefType realType))) (= (type TempMask@1) (MapType0Type RefType realType))) (= (type Mask@2) (MapType0Type RefType realType))) (= (type newPMask@0) (MapType0Type RefType boolType))) (= (type Heap@0) (MapType1Type RefType))) (= (type Used_23Mask@0) (MapType0Type RefType realType))) (= (type TempMask@0) (MapType0Type RefType realType))) (= (type Ops_21Mask@0) (MapType0Type RefType realType))) (forall ((arg0@@61 T@U) ) (! (= (type (FrameFragment arg0@@61)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@61))
))) (= (type Mask@0) (MapType0Type RefType realType))) (= (type Used_22Heap@0) (MapType1Type RefType))))
(set-info :boogie-vc-id test07)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 112) (let ((anon75_correct true))
(let ((anon113_Else_correct  (=> (and (not (and (not b1) (not b2@@1))) (= (ControlFlow 0 4) 1)) anon75_correct)))
(let ((anon113_Then_correct  (=> (and (not b1) (not b2@@1)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (U_2_real (MapType0Select Mask@12 x@@14 f_7)) (/ (to_real 5) (to_real 10)))) (=> (= (U_2_real (MapType0Select Mask@12 x@@14 f_7)) (/ (to_real 5) (to_real 10))) (=> (= (ControlFlow 0 2) 1) anon75_correct))))))
(let ((anon73_correct  (=> (state Heap@9 Mask@12) (and (=> (= (ControlFlow 0 5) 2) anon113_Then_correct) (=> (= (ControlFlow 0 5) 4) anon113_Else_correct)))))
(let ((anon112_Else_correct  (=> (and (not (and (not b1) b2@@1)) (= (ControlFlow 0 8) 5)) anon73_correct)))
(let ((anon112_Then_correct  (=> (and (not b1) b2@@1) (and (=> (= (ControlFlow 0 6) (- 0 7)) (= (U_2_real (MapType0Select Mask@12 x@@14 f_7)) (/ (to_real 3) (to_real 10)))) (=> (= (U_2_real (MapType0Select Mask@12 x@@14 f_7)) (/ (to_real 3) (to_real 10))) (=> (= (ControlFlow 0 6) 5) anon73_correct))))))
(let ((anon71_correct  (=> (state Heap@9 Mask@12) (and (=> (= (ControlFlow 0 9) 6) anon112_Then_correct) (=> (= (ControlFlow 0 9) 8) anon112_Else_correct)))))
(let ((anon111_Else_correct  (=> (and (not (and b1 (not b2@@1))) (= (ControlFlow 0 12) 9)) anon71_correct)))
(let ((anon111_Then_correct  (=> (and b1 (not b2@@1)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (= (U_2_real (MapType0Select Mask@12 x@@14 f_7)) (/ (to_real 2) (to_real 10)))) (=> (= (U_2_real (MapType0Select Mask@12 x@@14 f_7)) (/ (to_real 2) (to_real 10))) (=> (= (ControlFlow 0 10) 9) anon71_correct))))))
(let ((anon69_correct  (=> (state Heap@9 Mask@12) (and (=> (= (ControlFlow 0 13) 10) anon111_Then_correct) (=> (= (ControlFlow 0 13) 12) anon111_Else_correct)))))
(let ((anon110_Else_correct  (=> (and (not (and b1 b2@@1)) (= (ControlFlow 0 16) 13)) anon69_correct)))
(let ((anon110_Then_correct  (=> (and b1 b2@@1) (and (=> (= (ControlFlow 0 14) (- 0 15)) (= (U_2_real (MapType0Select Mask@12 x@@14 f_7)) NoPerm)) (=> (= (U_2_real (MapType0Select Mask@12 x@@14 f_7)) NoPerm) (=> (= (ControlFlow 0 14) 13) anon69_correct))))))
(let ((anon67_correct  (=> (state Heap@9 Mask@12) (and (=> (= (ControlFlow 0 17) 14) anon110_Then_correct) (=> (= (ControlFlow 0 17) 16) anon110_Else_correct)))))
(let ((anon109_Else_correct  (=> (and (not (and (not b1) (not b2@@1))) (= (ControlFlow 0 20) 17)) anon67_correct)))
(let ((anon109_Then_correct  (=> (and (not b1) (not b2@@1)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (<= (/ (to_real 5) (to_real 10)) (U_2_real (MapType0Select Mask@12 x@@14 f_7)))) (=> (<= (/ (to_real 5) (to_real 10)) (U_2_real (MapType0Select Mask@12 x@@14 f_7))) (=> (= (ControlFlow 0 18) 17) anon67_correct))))))
(let ((anon65_correct  (=> (state Heap@9 Mask@12) (and (=> (= (ControlFlow 0 21) 18) anon109_Then_correct) (=> (= (ControlFlow 0 21) 20) anon109_Else_correct)))))
(let ((anon108_Else_correct  (=> (and (not (and (not b1) b2@@1)) (= (ControlFlow 0 24) 21)) anon65_correct)))
(let ((anon108_Then_correct  (=> (and (not b1) b2@@1) (and (=> (= (ControlFlow 0 22) (- 0 23)) (<= (/ (to_real 3) (to_real 10)) (U_2_real (MapType0Select Mask@12 x@@14 f_7)))) (=> (<= (/ (to_real 3) (to_real 10)) (U_2_real (MapType0Select Mask@12 x@@14 f_7))) (=> (= (ControlFlow 0 22) 21) anon65_correct))))))
(let ((anon63_correct  (=> (state Heap@9 Mask@12) (and (=> (= (ControlFlow 0 25) 22) anon108_Then_correct) (=> (= (ControlFlow 0 25) 24) anon108_Else_correct)))))
(let ((anon107_Else_correct  (=> (and (not (and b1 (not b2@@1))) (= (ControlFlow 0 28) 25)) anon63_correct)))
(let ((anon107_Then_correct  (=> (and b1 (not b2@@1)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (<= (/ (to_real 2) (to_real 10)) (U_2_real (MapType0Select Mask@12 x@@14 f_7)))) (=> (<= (/ (to_real 2) (to_real 10)) (U_2_real (MapType0Select Mask@12 x@@14 f_7))) (=> (= (ControlFlow 0 26) 25) anon63_correct))))))
(let ((anon61_correct  (=> (state Heap@9 Mask@12) (and (=> (= (ControlFlow 0 29) 26) anon107_Then_correct) (=> (= (ControlFlow 0 29) 28) anon107_Else_correct)))))
(let ((anon106_Else_correct  (=> (and (not (and b1 b2@@1)) (= (ControlFlow 0 32) 29)) anon61_correct)))
(let ((anon106_Then_correct  (=> (and b1 b2@@1) (and (=> (= (ControlFlow 0 30) (- 0 31)) (<= NoPerm (U_2_real (MapType0Select Mask@12 x@@14 f_7)))) (=> (<= NoPerm (U_2_real (MapType0Select Mask@12 x@@14 f_7))) (=> (= (ControlFlow 0 30) 29) anon61_correct))))))
(let ((anon59_correct  (=> (and (and (= Mask@12 (MapType0Store Mask@11 null (wand_5 true b1 x@@14 (/ (to_real 8) (to_real 10))) (real_2_U (+ (U_2_real (MapType0Select Mask@11 null (wand_5 true b1 x@@14 (/ (to_real 8) (to_real 10))))) FullPerm)))) (state Heap@9 Mask@12)) (and (state Heap@9 Mask@12) (state Heap@9 Mask@12))) (and (=> (= (ControlFlow 0 33) 30) anon106_Then_correct) (=> (= (ControlFlow 0 33) 32) anon106_Else_correct)))))
(let ((anon58_correct  (and (=> (= (ControlFlow 0 36) (- 0 37)) (=> (and (and b_55@17 b_55@17) b_62@6) (and (= neededTransfer@15 0.0) (= (U_2_real (MapType0Select Used_26Mask@3 x@@14 f_7)) initNeededTransfer@2)))) (=> (=> (and (and b_55@17 b_55@17) b_62@6) (and (= neededTransfer@15 0.0) (= (U_2_real (MapType0Select Used_26Mask@3 x@@14 f_7)) initNeededTransfer@2))) (=> (= b_63@0  (and b_55@17 b_62@6)) (=> (and (and (and (= b_63@1  (and b_63@0 (state Result_24Heap Result_24Mask))) (= b_63@2  (and b_63@1 (sumMask Result_24Mask Ops_21Mask Used_26Mask@3)))) (and (= b_63@3  (and (and b_63@2 (IdenticalOnKnownLocations Ops_21Heap@4 Result_24Heap Ops_21Mask)) (IdenticalOnKnownLocations Used_26Heap@0 Result_24Heap Used_26Mask@3))) (= b_63@4  (and b_63@3 (state Result_24Heap Result_24Mask))))) (and (and (= b_55@18  (and b_55@17 b_63@4)) (= Mask@11 Mask@10)) (and (= Heap@9 Heap@8) (= (ControlFlow 0 36) 33)))) anon59_correct))))))
(let ((anon105_Else_correct  (=> (>= 0.0 takeTransfer@6) (=> (and (= Heap@8 Heap@6) (= Mask@10 Mask@8)) (=> (and (and (= neededTransfer@15 neededTransfer@13) (= b_62@6 b_62@3)) (and (= Used_26Mask@3 Used_26Mask@1) (= (ControlFlow 0 40) 36))) anon58_correct)))))
(let ((anon105_Then_correct  (=> (> takeTransfer@6 0.0) (=> (and (and (= neededTransfer@14 (- neededTransfer@13 takeTransfer@6)) (= Used_26Mask@2 (MapType0Store Used_26Mask@1 x@@14 f_7 (real_2_U (+ (U_2_real (MapType0Select Used_26Mask@1 x@@14 f_7)) takeTransfer@6))))) (and (= b_62@4  (and b_62@3 (state Used_26Heap@0 Used_26Mask@2))) (= b_62@5  (and b_62@4 (= (U_2_bool (MapType1Select Heap@6 x@@14 f_7)) (U_2_bool (MapType1Select Used_26Heap@0 x@@14 f_7))))))) (=> (and (and (and (= Mask@9 (MapType0Store Mask@8 x@@14 f_7 (real_2_U (- (U_2_real (MapType0Select Mask@8 x@@14 f_7)) takeTransfer@6)))) (= Heap@7 (MapType1Store Heap@6 null (|wand_5#sm| true b1 x@@14 (/ (to_real 8) (to_real 10))) (MapType0Store (MapType1Select Heap@6 null (|wand_5#sm| true b1 x@@14 (/ (to_real 8) (to_real 10)))) x@@14 f_7 (bool_2_U true))))) (and (= Heap@8 Heap@7) (= Mask@10 Mask@9))) (and (and (= neededTransfer@15 neededTransfer@14) (= b_62@6 b_62@5)) (and (= Used_26Mask@3 Used_26Mask@2) (= (ControlFlow 0 39) 36)))) anon58_correct)))))
(let ((anon104_Else_correct  (=> (and (< maskTransfer@6 neededTransfer@13) (= takeTransfer@6 maskTransfer@6)) (and (=> (= (ControlFlow 0 42) 39) anon105_Then_correct) (=> (= (ControlFlow 0 42) 40) anon105_Else_correct)))))
(let ((anon104_Then_correct  (=> (and (<= neededTransfer@13 maskTransfer@6) (= takeTransfer@6 neededTransfer@13)) (and (=> (= (ControlFlow 0 41) 39) anon105_Then_correct) (=> (= (ControlFlow 0 41) 40) anon105_Else_correct)))))
(let ((anon103_Then_correct  (=> (and (and (and (and (and b_55@17 b_55@17) b_62@3) true) (> neededTransfer@13 0.0)) (= maskTransfer@6 (U_2_real (MapType0Select Mask@8 x@@14 f_7)))) (and (=> (= (ControlFlow 0 43) 41) anon104_Then_correct) (=> (= (ControlFlow 0 43) 42) anon104_Else_correct)))))
(let ((anon103_Else_correct  (=> (not (and (and (and (and b_55@17 b_55@17) b_62@3) true) (> neededTransfer@13 0.0))) (=> (and (= Heap@8 Heap@6) (= Mask@10 Mask@8)) (=> (and (and (= neededTransfer@15 neededTransfer@13) (= b_62@6 b_62@3)) (and (= Used_26Mask@3 Used_26Mask@1) (= (ControlFlow 0 38) 36))) anon58_correct)))))
(let ((anon102_Else_correct  (=> (and (and (>= 0.0 takeTransfer@5) (= Used_26Mask@1 ZeroMask)) (and (= b_62@3 b_62@0) (= neededTransfer@13 neededTransfer@11))) (and (=> (= (ControlFlow 0 46) 43) anon103_Then_correct) (=> (= (ControlFlow 0 46) 38) anon103_Else_correct)))))
(let ((anon102_Then_correct  (=> (> takeTransfer@5 0.0) (=> (and (and (and (= neededTransfer@12 (- neededTransfer@11 takeTransfer@5)) (= Used_26Mask@0 (MapType0Store ZeroMask x@@14 f_7 (real_2_U (+ (U_2_real (MapType0Select ZeroMask x@@14 f_7)) takeTransfer@5))))) (and (= b_62@1  (and b_62@0 (state Used_26Heap@0 Used_26Mask@0))) (= b_62@2  (and b_62@1 (= (U_2_bool (MapType1Select Ops_21Heap@4 x@@14 f_7)) (U_2_bool (MapType1Select Used_26Heap@0 x@@14 f_7))))))) (and (and (= Ops_21Mask@11 (MapType0Store Ops_21Mask@10 x@@14 f_7 (real_2_U (- (U_2_real (MapType0Select Ops_21Mask@10 x@@14 f_7)) takeTransfer@5)))) (= Used_26Mask@1 Used_26Mask@0)) (and (= b_62@3 b_62@2) (= neededTransfer@13 neededTransfer@12)))) (and (=> (= (ControlFlow 0 45) 43) anon103_Then_correct) (=> (= (ControlFlow 0 45) 38) anon103_Else_correct))))))
(let ((anon101_Else_correct  (=> (and (< maskTransfer@5 neededTransfer@11) (= takeTransfer@5 maskTransfer@5)) (and (=> (= (ControlFlow 0 48) 45) anon102_Then_correct) (=> (= (ControlFlow 0 48) 46) anon102_Else_correct)))))
(let ((anon101_Then_correct  (=> (and (<= neededTransfer@11 maskTransfer@5) (= takeTransfer@5 neededTransfer@11)) (and (=> (= (ControlFlow 0 47) 45) anon102_Then_correct) (=> (= (ControlFlow 0 47) 46) anon102_Else_correct)))))
(let ((anon100_Then_correct  (=> (and (and (and (and (and b_55@17 b_55@17) b_62@0) true) (> neededTransfer@11 0.0)) (= maskTransfer@5 (U_2_real (MapType0Select Ops_21Mask@10 x@@14 f_7)))) (and (=> (= (ControlFlow 0 49) 47) anon101_Then_correct) (=> (= (ControlFlow 0 49) 48) anon101_Else_correct)))))
(let ((anon100_Else_correct  (=> (and (and (not (and (and (and (and b_55@17 b_55@17) b_62@0) true) (> neededTransfer@11 0.0))) (= Used_26Mask@1 ZeroMask)) (and (= b_62@3 b_62@0) (= neededTransfer@13 neededTransfer@11))) (and (=> (= (ControlFlow 0 44) 43) anon103_Then_correct) (=> (= (ControlFlow 0 44) 38) anon103_Else_correct)))))
(let ((anon99_Then_correct  (=> b1 (=> (and (= neededTransfer@11 (/ (to_real 8) (to_real 10))) (= initNeededTransfer@2 (+ (U_2_real (MapType0Select ZeroMask x@@14 f_7)) neededTransfer@11))) (and (=> (= (ControlFlow 0 50) (- 0 51)) (>= neededTransfer@11 0.0)) (=> (>= neededTransfer@11 0.0) (and (=> (= (ControlFlow 0 50) 49) anon100_Then_correct) (=> (= (ControlFlow 0 50) 44) anon100_Else_correct))))))))
(let ((anon99_Else_correct  (=> (and (and (not b1) (= Mask@11 Mask@8)) (and (= Heap@9 Heap@6) (= (ControlFlow 0 35) 33))) anon59_correct)))
(let ((anon98_Then_correct  (=> (and b_55@17 b_55@17) (and (=> (= (ControlFlow 0 52) 50) anon99_Then_correct) (=> (= (ControlFlow 0 52) 35) anon99_Else_correct)))))
(let ((anon98_Else_correct  (=> (and (and (not (and b_55@17 b_55@17)) (= Mask@11 Mask@8)) (and (= Heap@9 Heap@6) (= (ControlFlow 0 34) 33))) anon59_correct)))
(let ((anon44_correct  (=> (= b_62@0  (and b_62 (state Used_26Heap@0 ZeroMask))) (and (=> (= (ControlFlow 0 53) 52) anon98_Then_correct) (=> (= (ControlFlow 0 53) 34) anon98_Else_correct)))))
(let ((anon43_correct  (=> (and (= Ops_21Mask@9 (MapType0Store Ops_21Mask@8 null (wand_5 true b2@@1 x@@14 (/ (to_real 2) (to_real 10))) (real_2_U (+ (U_2_real (MapType0Select Ops_21Mask@8 null (wand_5 true b2@@1 x@@14 (/ (to_real 2) (to_real 10))))) FullPerm)))) (= b_55@14  (and b_55@13 (state Ops_21Heap@3 Ops_21Mask@9)))) (=> (and (and (and (= b_55@15  (and b_55@14 (state Ops_21Heap@3 Ops_21Mask@9))) (= b_55@16  (and b_55@15 (state Ops_21Heap@3 Ops_21Mask@9)))) (and (= Ops_21Mask@10 Ops_21Mask@9) (= Heap@6 Heap@5))) (and (and (= b_55@17 b_55@16) (= Mask@8 Mask@7)) (and (= Ops_21Heap@4 Ops_21Heap@3) (= (ControlFlow 0 55) 53)))) anon44_correct))))
(let ((anon42_correct  (and (=> (= (ControlFlow 0 58) (- 0 59)) (=> (and (and b_59@2 (and b_59@2 b_55@13)) b_60@9) (and (= neededTransfer@10 0.0) (= (U_2_real (MapType0Select Used_25Mask@5 x@@14 f_7)) initNeededTransfer@1)))) (=> (=> (and (and b_59@2 (and b_59@2 b_55@13)) b_60@9) (and (= neededTransfer@10 0.0) (= (U_2_real (MapType0Select Used_25Mask@5 x@@14 f_7)) initNeededTransfer@1))) (=> (= b_61@0  (and b_59@2 b_60@9)) (=> (and (= b_61@1  (and b_61@0 (state Result_23Heap Result_23Mask))) (= b_61@2  (and b_61@1 (sumMask Result_23Mask Ops_23Mask Used_25Mask@5)))) (=> (and (and (and (= b_61@3  (and (and b_61@2 (IdenticalOnKnownLocations Ops_23Heap@0 Result_23Heap Ops_23Mask)) (IdenticalOnKnownLocations Used_25Heap@0 Result_23Heap Used_25Mask@5))) (= b_61@4  (and b_61@3 (state Result_23Heap Result_23Mask)))) (and (= b_59@3  (and b_59@2 b_61@4)) (= Heap@5 Heap@4))) (and (and (= Mask@7 Mask@6) (= Ops_21Mask@8 Ops_21Mask@7)) (and (= Ops_21Heap@3 Ops_21Heap@2) (= (ControlFlow 0 58) 55)))) anon43_correct)))))))
(let ((anon97_Else_correct  (=> (>= 0.0 takeTransfer@4) (=> (and (= Mask@6 Mask@4) (= Heap@4 Heap@2)) (=> (and (and (= Used_25Mask@5 Used_25Mask@3) (= b_60@9 b_60@6)) (and (= neededTransfer@10 neededTransfer@8) (= (ControlFlow 0 62) 58))) anon42_correct)))))
(let ((anon97_Then_correct  (=> (> takeTransfer@4 0.0) (=> (and (and (= neededTransfer@9 (- neededTransfer@8 takeTransfer@4)) (= Used_25Mask@4 (MapType0Store Used_25Mask@3 x@@14 f_7 (real_2_U (+ (U_2_real (MapType0Select Used_25Mask@3 x@@14 f_7)) takeTransfer@4))))) (and (= b_60@7  (and b_60@6 (state Used_25Heap@0 Used_25Mask@4))) (= b_60@8  (and b_60@7 (= (U_2_bool (MapType1Select Heap@2 x@@14 f_7)) (U_2_bool (MapType1Select Used_25Heap@0 x@@14 f_7))))))) (=> (and (and (and (= Mask@5 (MapType0Store Mask@4 x@@14 f_7 (real_2_U (- (U_2_real (MapType0Select Mask@4 x@@14 f_7)) takeTransfer@4)))) (= Heap@3 (MapType1Store Heap@2 null (|wand_5#sm| true b2@@1 x@@14 (/ (to_real 2) (to_real 10))) (MapType0Store (MapType1Select Heap@2 null (|wand_5#sm| true b2@@1 x@@14 (/ (to_real 2) (to_real 10)))) x@@14 f_7 (bool_2_U true))))) (and (= Mask@6 Mask@5) (= Heap@4 Heap@3))) (and (and (= Used_25Mask@5 Used_25Mask@4) (= b_60@9 b_60@8)) (and (= neededTransfer@10 neededTransfer@9) (= (ControlFlow 0 61) 58)))) anon42_correct)))))
(let ((anon96_Else_correct  (=> (and (< maskTransfer@4 neededTransfer@8) (= takeTransfer@4 maskTransfer@4)) (and (=> (= (ControlFlow 0 64) 61) anon97_Then_correct) (=> (= (ControlFlow 0 64) 62) anon97_Else_correct)))))
(let ((anon96_Then_correct  (=> (and (<= neededTransfer@8 maskTransfer@4) (= takeTransfer@4 neededTransfer@8)) (and (=> (= (ControlFlow 0 63) 61) anon97_Then_correct) (=> (= (ControlFlow 0 63) 62) anon97_Else_correct)))))
(let ((anon95_Then_correct  (=> (and (and (and (and (and b_59@2 (and b_59@2 b_55@13)) b_60@6) true) (> neededTransfer@8 0.0)) (= maskTransfer@4 (U_2_real (MapType0Select Mask@4 x@@14 f_7)))) (and (=> (= (ControlFlow 0 65) 63) anon96_Then_correct) (=> (= (ControlFlow 0 65) 64) anon96_Else_correct)))))
(let ((anon95_Else_correct  (=> (not (and (and (and (and b_59@2 (and b_59@2 b_55@13)) b_60@6) true) (> neededTransfer@8 0.0))) (=> (and (= Mask@6 Mask@4) (= Heap@4 Heap@2)) (=> (and (and (= Used_25Mask@5 Used_25Mask@3) (= b_60@9 b_60@6)) (and (= neededTransfer@10 neededTransfer@8) (= (ControlFlow 0 60) 58))) anon42_correct)))))
(let ((anon94_Else_correct  (=> (and (>= 0.0 takeTransfer@3) (= Ops_21Heap@2 Ops_21Heap@0)) (=> (and (and (= Ops_21Mask@7 Ops_21Mask@5) (= neededTransfer@8 neededTransfer@6)) (and (= b_60@6 b_60@3) (= Used_25Mask@3 Used_25Mask@1))) (and (=> (= (ControlFlow 0 68) 65) anon95_Then_correct) (=> (= (ControlFlow 0 68) 60) anon95_Else_correct))))))
(let ((anon94_Then_correct  (=> (and (and (> takeTransfer@3 0.0) (= neededTransfer@7 (- neededTransfer@6 takeTransfer@3))) (and (= Used_25Mask@2 (MapType0Store Used_25Mask@1 x@@14 f_7 (real_2_U (+ (U_2_real (MapType0Select Used_25Mask@1 x@@14 f_7)) takeTransfer@3)))) (= b_60@4  (and b_60@3 (state Used_25Heap@0 Used_25Mask@2))))) (=> (and (and (and (= b_60@5  (and b_60@4 (= (U_2_bool (MapType1Select Ops_21Heap@0 x@@14 f_7)) (U_2_bool (MapType1Select Used_25Heap@0 x@@14 f_7))))) (= Ops_21Mask@6 (MapType0Store Ops_21Mask@5 x@@14 f_7 (real_2_U (- (U_2_real (MapType0Select Ops_21Mask@5 x@@14 f_7)) takeTransfer@3))))) (and (= Ops_21Heap@1 (MapType1Store Ops_21Heap@0 null (|wand_5#sm| true b2@@1 x@@14 (/ (to_real 2) (to_real 10))) (MapType0Store (MapType1Select Ops_21Heap@0 null (|wand_5#sm| true b2@@1 x@@14 (/ (to_real 2) (to_real 10)))) x@@14 f_7 (bool_2_U true)))) (= Ops_21Heap@2 Ops_21Heap@1))) (and (and (= Ops_21Mask@7 Ops_21Mask@6) (= neededTransfer@8 neededTransfer@7)) (and (= b_60@6 b_60@5) (= Used_25Mask@3 Used_25Mask@2)))) (and (=> (= (ControlFlow 0 67) 65) anon95_Then_correct) (=> (= (ControlFlow 0 67) 60) anon95_Else_correct))))))
(let ((anon93_Else_correct  (=> (and (< maskTransfer@3 neededTransfer@6) (= takeTransfer@3 maskTransfer@3)) (and (=> (= (ControlFlow 0 70) 67) anon94_Then_correct) (=> (= (ControlFlow 0 70) 68) anon94_Else_correct)))))
(let ((anon93_Then_correct  (=> (and (<= neededTransfer@6 maskTransfer@3) (= takeTransfer@3 neededTransfer@6)) (and (=> (= (ControlFlow 0 69) 67) anon94_Then_correct) (=> (= (ControlFlow 0 69) 68) anon94_Else_correct)))))
(let ((anon92_Then_correct  (=> (and (and (and (and (and b_59@2 (and b_59@2 b_55@13)) b_60@3) true) (> neededTransfer@6 0.0)) (= maskTransfer@3 (U_2_real (MapType0Select Ops_21Mask@5 x@@14 f_7)))) (and (=> (= (ControlFlow 0 71) 69) anon93_Then_correct) (=> (= (ControlFlow 0 71) 70) anon93_Else_correct)))))
(let ((anon92_Else_correct  (=> (and (not (and (and (and (and b_59@2 (and b_59@2 b_55@13)) b_60@3) true) (> neededTransfer@6 0.0))) (= Ops_21Heap@2 Ops_21Heap@0)) (=> (and (and (= Ops_21Mask@7 Ops_21Mask@5) (= neededTransfer@8 neededTransfer@6)) (and (= b_60@6 b_60@3) (= Used_25Mask@3 Used_25Mask@1))) (and (=> (= (ControlFlow 0 66) 65) anon95_Then_correct) (=> (= (ControlFlow 0 66) 60) anon95_Else_correct))))))
(let ((anon91_Else_correct  (=> (and (and (>= 0.0 takeTransfer@2) (= Used_25Mask@1 ZeroMask)) (and (= b_60@3 b_60@0) (= neededTransfer@6 neededTransfer@4))) (and (=> (= (ControlFlow 0 74) 71) anon92_Then_correct) (=> (= (ControlFlow 0 74) 66) anon92_Else_correct)))))
(let ((anon91_Then_correct  (=> (> takeTransfer@2 0.0) (=> (and (and (and (= neededTransfer@5 (- neededTransfer@4 takeTransfer@2)) (= Used_25Mask@0 (MapType0Store ZeroMask x@@14 f_7 (real_2_U (+ (U_2_real (MapType0Select ZeroMask x@@14 f_7)) takeTransfer@2))))) (and (= b_60@1  (and b_60@0 (state Used_25Heap@0 Used_25Mask@0))) (= b_60@2  (and b_60@1 (= (U_2_bool (MapType1Select Ops_23Heap@0 x@@14 f_7)) (U_2_bool (MapType1Select Used_25Heap@0 x@@14 f_7))))))) (and (and (= Ops_23Mask@0 (MapType0Store ZeroMask x@@14 f_7 (real_2_U (- (U_2_real (MapType0Select ZeroMask x@@14 f_7)) takeTransfer@2)))) (= Used_25Mask@1 Used_25Mask@0)) (and (= b_60@3 b_60@2) (= neededTransfer@6 neededTransfer@5)))) (and (=> (= (ControlFlow 0 73) 71) anon92_Then_correct) (=> (= (ControlFlow 0 73) 66) anon92_Else_correct))))))
(let ((anon90_Else_correct  (=> (and (< maskTransfer@2 neededTransfer@4) (= takeTransfer@2 maskTransfer@2)) (and (=> (= (ControlFlow 0 76) 73) anon91_Then_correct) (=> (= (ControlFlow 0 76) 74) anon91_Else_correct)))))
(let ((anon90_Then_correct  (=> (and (<= neededTransfer@4 maskTransfer@2) (= takeTransfer@2 neededTransfer@4)) (and (=> (= (ControlFlow 0 75) 73) anon91_Then_correct) (=> (= (ControlFlow 0 75) 74) anon91_Else_correct)))))
(let ((anon89_Then_correct  (=> (and (and (and (and (and b_59@2 (and b_59@2 b_55@13)) b_60@0) true) (> neededTransfer@4 0.0)) (= maskTransfer@2 (U_2_real (MapType0Select ZeroMask x@@14 f_7)))) (and (=> (= (ControlFlow 0 77) 75) anon90_Then_correct) (=> (= (ControlFlow 0 77) 76) anon90_Else_correct)))))
(let ((anon89_Else_correct  (=> (and (and (not (and (and (and (and b_59@2 (and b_59@2 b_55@13)) b_60@0) true) (> neededTransfer@4 0.0))) (= Used_25Mask@1 ZeroMask)) (and (= b_60@3 b_60@0) (= neededTransfer@6 neededTransfer@4))) (and (=> (= (ControlFlow 0 72) 71) anon92_Then_correct) (=> (= (ControlFlow 0 72) 66) anon92_Else_correct)))))
(let ((anon88_Then_correct  (=> b2@@1 (=> (and (= neededTransfer@4 (/ (to_real 2) (to_real 10))) (= initNeededTransfer@1 (+ (U_2_real (MapType0Select ZeroMask x@@14 f_7)) neededTransfer@4))) (and (=> (= (ControlFlow 0 78) (- 0 79)) (>= neededTransfer@4 0.0)) (=> (>= neededTransfer@4 0.0) (and (=> (= (ControlFlow 0 78) 77) anon89_Then_correct) (=> (= (ControlFlow 0 78) 72) anon89_Else_correct))))))))
(let ((anon88_Else_correct  (=> (and (not b2@@1) (= Heap@5 Heap@2)) (=> (and (and (= Mask@7 Mask@4) (= Ops_21Mask@8 Ops_21Mask@5)) (and (= Ops_21Heap@3 Ops_21Heap@0) (= (ControlFlow 0 57) 55))) anon43_correct))))
(let ((anon87_Then_correct  (=> (and b_59@2 (and b_59@2 b_55@13)) (and (=> (= (ControlFlow 0 80) 78) anon88_Then_correct) (=> (= (ControlFlow 0 80) 57) anon88_Else_correct)))))
(let ((anon87_Else_correct  (=> (and (not (and b_59@2 (and b_59@2 b_55@13))) (= Heap@5 Heap@2)) (=> (and (and (= Mask@7 Mask@4) (= Ops_21Mask@8 Ops_21Mask@5)) (and (= Ops_21Heap@3 Ops_21Heap@0) (= (ControlFlow 0 56) 55))) anon43_correct))))
(let ((anon22_correct  (=> (= b_59@1  (and b_59@0 (state Ops_23Heap@0 ZeroMask))) (=> (and (= b_59@2  (and b_59@1 (state Ops_23Heap@0 ZeroMask))) (= b_60@0  (and b_60 (state Used_25Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 81) 80) anon87_Then_correct) (=> (= (ControlFlow 0 81) 56) anon87_Else_correct))))))
(let ((anon86_Else_correct  (=> (and (not b_59@0) (= (ControlFlow 0 83) 81)) anon22_correct)))
(let ((anon86_Then_correct  (=> (and b_59@0 (= (ControlFlow 0 82) 81)) anon22_correct)))
(let ((anon85_Then_correct  (=> b_55@13 (=> (and (= b_59@0  (and b_59 (state Ops_23Heap@0 ZeroMask))) (= b_58@0  (and b_58 (state Used_24Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 84) 82) anon86_Then_correct) (=> (= (ControlFlow 0 84) 83) anon86_Else_correct))))))
(let ((anon85_Else_correct  (=> (not b_55@13) (=> (and (= Ops_21Mask@10 Ops_21Mask@5) (= Heap@6 Heap@2)) (=> (and (and (= b_55@17 b_55@13) (= Mask@8 Mask@4)) (and (= Ops_21Heap@4 Ops_21Heap@0) (= (ControlFlow 0 54) 53))) anon44_correct)))))
(let ((anon18_correct  (=> (and (= b_55@11  (and b_55@10 (state Ops_21Heap@0 Ops_21Mask@4))) (= b_55@12  (and b_55@11 (state Ops_21Heap@0 Ops_21Mask@4)))) (=> (and (and (= Ops_21Mask@5 Ops_21Mask@4) (= Mask@4 Mask@3)) (and (= b_55@13 b_55@12) (= Heap@2 Heap@1))) (and (=> (= (ControlFlow 0 86) 84) anon85_Then_correct) (=> (= (ControlFlow 0 86) 54) anon85_Else_correct))))))
(let ((anon84_Else_correct  (=> (and (not b1) (= perm@2 (/ (to_real 5) (to_real 10)))) (and (=> (= (ControlFlow 0 89) (- 0 90)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (and (= b_55@8  (and b_55@5 (=> (> perm@2 NoPerm) (not (= x@@14 null))))) (= Ops_21Mask@3 (MapType0Store Ops_21Mask@1 x@@14 g (real_2_U (+ (U_2_real (MapType0Select Ops_21Mask@1 x@@14 g)) perm@2))))) (=> (and (and (= b_55@9  (and b_55@8 (state Ops_21Heap@0 Ops_21Mask@3))) (= b_55@10 b_55@9)) (and (= Ops_21Mask@4 Ops_21Mask@3) (= (ControlFlow 0 89) 86))) anon18_correct)))))))
(let ((anon84_Then_correct  (=> (and b1 (= perm@1 (/ (to_real 5) (to_real 10)))) (and (=> (= (ControlFlow 0 87) (- 0 88)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (= b_55@6  (and b_55@5 (=> (> perm@1 NoPerm) (not (= x@@14 null))))) (= Ops_21Mask@2 (MapType0Store Ops_21Mask@1 x@@14 f_7 (real_2_U (+ (U_2_real (MapType0Select Ops_21Mask@1 x@@14 f_7)) perm@1))))) (=> (and (and (= b_55@7  (and b_55@6 (state Ops_21Heap@0 Ops_21Mask@2))) (= b_55@10 b_55@7)) (and (= Ops_21Mask@4 Ops_21Mask@2) (= (ControlFlow 0 87) 86))) anon18_correct)))))))
(let ((anon15_correct  (and (=> (= (ControlFlow 0 91) (- 0 92)) (=> (and b_55@2 b_56@6) (and (= neededTransfer@3 0.0) (= (U_2_real (MapType0Select Used_23Mask@3 null (P x@@14 b1))) initNeededTransfer@0)))) (=> (=> (and b_55@2 b_56@6) (and (= neededTransfer@3 0.0) (= (U_2_real (MapType0Select Used_23Mask@3 null (P x@@14 b1))) initNeededTransfer@0))) (=> (and (and (and (= b_57@0  (and b_55@2 b_56@6)) (= b_57@1  (and b_57@0 (state Result_22Heap Result_22Mask)))) (and (= b_57@2  (and b_57@1 (sumMask Result_22Mask Ops_21Mask@1 Used_23Mask@3))) (= b_57@3  (and (and b_57@2 (IdenticalOnKnownLocations Ops_21Heap@0 Result_22Heap Ops_21Mask@1)) (IdenticalOnKnownLocations Used_23Heap@0 Result_22Heap Used_23Mask@3))))) (and (and (= b_57@4  (and b_57@3 (state Result_22Heap Result_22Mask))) (= b_55@3  (and b_55@2 b_57@4))) (and (= b_55@4  (and b_55@3 b_56@6)) (= b_55@5  (and b_55@4 (= Used_23Heap@0 Ops_21Heap@0)))))) (and (=> (= (ControlFlow 0 91) 87) anon84_Then_correct) (=> (= (ControlFlow 0 91) 89) anon84_Else_correct)))))))
(let ((anon83_Else_correct  (=> (>= 0.0 takeTransfer@1) (=> (and (= Mask@3 Mask@1) (= neededTransfer@3 neededTransfer@1)) (=> (and (and (= b_56@6 b_56@3) (= Used_23Mask@3 Used_23Mask@1)) (and (= Heap@1 Heap@@10) (= (ControlFlow 0 95) 91))) anon15_correct)))))
(let ((anon83_Then_correct  (=> (> takeTransfer@1 0.0) (=> (and (= neededTransfer@2 (- neededTransfer@1 takeTransfer@1)) (= Used_23Mask@2 (MapType0Store Used_23Mask@1 null (P x@@14 b1) (real_2_U (+ (U_2_real (MapType0Select Used_23Mask@1 null (P x@@14 b1))) takeTransfer@1))))) (=> (and (and (= b_56@4  (and b_56@3 (state Used_23Heap@0 Used_23Mask@2))) (= TempMask@1 (MapType0Store ZeroMask null (P x@@14 b1) (real_2_U FullPerm)))) (and (= b_56@5  (and b_56@4 (IdenticalOnKnownLocations Heap@@10 Used_23Heap@0 TempMask@1))) (= Mask@2 (MapType0Store Mask@1 null (P x@@14 b1) (real_2_U (- (U_2_real (MapType0Select Mask@1 null (P x@@14 b1))) takeTransfer@1)))))) (=> (and (and (and (forall ((o_5 T@U) (f_10 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_10))))
(let ((A@@12 (FieldTypeInv0 (type f_10))))
 (=> (and (and (= (type o_5) RefType) (= (type f_10) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType0Select (MapType1Select Heap@@10 null (|wand_5#sm| true b1 x@@14 (/ (to_real 8) (to_real 10)))) o_5 f_10)) (U_2_bool (MapType0Select (MapType1Select Heap@@10 null (|P#sm| x@@14 b1)) o_5 f_10)))) (U_2_bool (MapType0Select newPMask@0 o_5 f_10)))))
 :qid |stdinbpl.3516:39|
 :skolemid |107|
 :pattern ( (MapType0Select newPMask@0 o_5 f_10))
)) (= Heap@0 (MapType1Store Heap@@10 null (|wand_5#sm| true b1 x@@14 (/ (to_real 8) (to_real 10))) newPMask@0))) (and (= Mask@3 Mask@2) (= neededTransfer@3 neededTransfer@2))) (and (and (= b_56@6 b_56@5) (= Used_23Mask@3 Used_23Mask@2)) (and (= Heap@1 Heap@0) (= (ControlFlow 0 94) 91)))) anon15_correct))))))
(let ((anon82_Else_correct  (=> (and (< maskTransfer@1 neededTransfer@1) (= takeTransfer@1 maskTransfer@1)) (and (=> (= (ControlFlow 0 97) 94) anon83_Then_correct) (=> (= (ControlFlow 0 97) 95) anon83_Else_correct)))))
(let ((anon82_Then_correct  (=> (and (<= neededTransfer@1 maskTransfer@1) (= takeTransfer@1 neededTransfer@1)) (and (=> (= (ControlFlow 0 96) 94) anon83_Then_correct) (=> (= (ControlFlow 0 96) 95) anon83_Else_correct)))))
(let ((anon81_Then_correct  (=> (and (and (and (and b_55@2 b_56@3) true) (> neededTransfer@1 0.0)) (= maskTransfer@1 (U_2_real (MapType0Select Mask@1 null (P x@@14 b1))))) (and (=> (= (ControlFlow 0 98) 96) anon82_Then_correct) (=> (= (ControlFlow 0 98) 97) anon82_Else_correct)))))
(let ((anon81_Else_correct  (=> (not (and (and (and b_55@2 b_56@3) true) (> neededTransfer@1 0.0))) (=> (and (= Mask@3 Mask@1) (= neededTransfer@3 neededTransfer@1)) (=> (and (and (= b_56@6 b_56@3) (= Used_23Mask@3 Used_23Mask@1)) (and (= Heap@1 Heap@@10) (= (ControlFlow 0 93) 91))) anon15_correct)))))
(let ((anon80_Else_correct  (=> (>= 0.0 takeTransfer@0) (=> (and (and (= Ops_21Mask@1 ZeroMask) (= Used_23Mask@1 ZeroMask)) (and (= b_56@3 b_56@0) (= neededTransfer@1 FullPerm))) (and (=> (= (ControlFlow 0 101) 98) anon81_Then_correct) (=> (= (ControlFlow 0 101) 93) anon81_Else_correct))))))
(let ((anon80_Then_correct  (=> (> takeTransfer@0 0.0) (=> (and (= neededTransfer@0 (- FullPerm takeTransfer@0)) (= Used_23Mask@0 (MapType0Store ZeroMask null (P x@@14 b1) (real_2_U (+ (U_2_real (MapType0Select ZeroMask null (P x@@14 b1))) takeTransfer@0))))) (=> (and (and (and (= b_56@1  (and b_56@0 (state Used_23Heap@0 Used_23Mask@0))) (= TempMask@0 (MapType0Store ZeroMask null (P x@@14 b1) (real_2_U FullPerm)))) (and (= b_56@2  (and b_56@1 (IdenticalOnKnownLocations Ops_21Heap@0 Used_23Heap@0 TempMask@0))) (= Ops_21Mask@0 (MapType0Store ZeroMask null (P x@@14 b1) (real_2_U (- (U_2_real (MapType0Select ZeroMask null (P x@@14 b1))) takeTransfer@0)))))) (and (and (= Ops_21Mask@1 Ops_21Mask@0) (= Used_23Mask@1 Used_23Mask@0)) (and (= b_56@3 b_56@2) (= neededTransfer@1 neededTransfer@0)))) (and (=> (= (ControlFlow 0 100) 98) anon81_Then_correct) (=> (= (ControlFlow 0 100) 93) anon81_Else_correct)))))))
(let ((anon79_Else_correct  (=> (and (< maskTransfer@0 FullPerm) (= takeTransfer@0 maskTransfer@0)) (and (=> (= (ControlFlow 0 103) 100) anon80_Then_correct) (=> (= (ControlFlow 0 103) 101) anon80_Else_correct)))))
(let ((anon79_Then_correct  (=> (and (<= FullPerm maskTransfer@0) (= takeTransfer@0 FullPerm)) (and (=> (= (ControlFlow 0 102) 100) anon80_Then_correct) (=> (= (ControlFlow 0 102) 101) anon80_Else_correct)))))
(let ((anon78_Then_correct  (=> (and (and (and (and b_55@2 b_56@0) true) (> FullPerm 0.0)) (= maskTransfer@0 (U_2_real (MapType0Select ZeroMask null (P x@@14 b1))))) (and (=> (= (ControlFlow 0 104) 102) anon79_Then_correct) (=> (= (ControlFlow 0 104) 103) anon79_Else_correct)))))
(let ((anon78_Else_correct  (=> (not (and (and (and b_55@2 b_56@0) true) (> FullPerm 0.0))) (=> (and (and (= Ops_21Mask@1 ZeroMask) (= Used_23Mask@1 ZeroMask)) (and (= b_56@3 b_56@0) (= neededTransfer@1 FullPerm))) (and (=> (= (ControlFlow 0 99) 98) anon81_Then_correct) (=> (= (ControlFlow 0 99) 93) anon81_Else_correct))))))
(let ((anon77_Then_correct  (=> b_55@2 (=> (and (and (|P#trigger| Ops_21Heap@0 (P x@@14 b1)) (= (MapType1Select Ops_21Heap@0 null (P x@@14 b1)) (FrameFragment (ite b1 (FrameFragment (MapType1Select Ops_21Heap@0 x@@14 f_7)) (FrameFragment (MapType1Select Ops_21Heap@0 x@@14 g)))))) (and (= b_56@0  (and b_56 (state Used_23Heap@0 ZeroMask))) (= initNeededTransfer@0 (+ (U_2_real (MapType0Select ZeroMask null (P x@@14 b1))) FullPerm)))) (and (=> (= (ControlFlow 0 105) (- 0 106)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 105) 104) anon78_Then_correct) (=> (= (ControlFlow 0 105) 99) anon78_Else_correct))))))))
(let ((anon77_Else_correct  (=> (not b_55@2) (=> (and (and (= Ops_21Mask@5 ZeroMask) (= Mask@4 Mask@1)) (and (= b_55@13 b_55@2) (= Heap@2 Heap@@10))) (and (=> (= (ControlFlow 0 85) 84) anon85_Then_correct) (=> (= (ControlFlow 0 85) 54) anon85_Else_correct))))))
(let ((anon2_correct  (=> (and (= b_55@1  (and b_55@0 (state Ops_21Heap@0 ZeroMask))) (= b_55@2  (and b_55@1 (state Ops_21Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 107) 105) anon77_Then_correct) (=> (= (ControlFlow 0 107) 85) anon77_Else_correct)))))
(let ((anon76_Else_correct  (=> (and (not b_55@0) (= (ControlFlow 0 109) 107)) anon2_correct)))
(let ((anon76_Then_correct  (=> (and b_55@0 (= (ControlFlow 0 108) 107)) anon2_correct)))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType1Select Heap@@10 x@@14 $allocated)) (= perm@0 (/ (to_real 5) (to_real 10)))) (and (=> (= (ControlFlow 0 110) (- 0 111)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= x@@14 null))) (=> (and (= Mask@0 (MapType0Store ZeroMask x@@14 f_7 (real_2_U (+ (U_2_real (MapType0Select ZeroMask x@@14 f_7)) perm@0)))) (state Heap@@10 Mask@0)) (=> (and (and (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (= Mask@1 (MapType0Store Mask@0 null (P x@@14 b1) (real_2_U (+ (U_2_real (MapType0Select Mask@0 null (P x@@14 b1))) FullPerm)))) (state Heap@@10 Mask@1))) (and (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1)) (and (= b_55@0  (and b_55 (state Ops_21Heap@0 ZeroMask))) (= b_54@0  (and b_54 (state Used_22Heap@0 ZeroMask)))))) (and (=> (= (ControlFlow 0 110) 108) anon76_Then_correct) (=> (= (ControlFlow 0 110) 109) anon76_Else_correct)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 112) 110) anon0_correct)))
