...
(assert  (and (and (and (and (= (type s@@21) (SeqType RefType)) (= (type x_8) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (forall ((arg0@@52 T@U) ) (! (= (type (invRecv10 arg0@@52)) RefType)
 :qid |funType:invRecv10|
 :pattern ( (invRecv10 arg0@@52))
))))
...
(let ((anon21_Else_correct  (=> (and (not (and (<= 0 x_5) (< x_5 (|Seq#Length| s@@21)))) (= (ControlFlow 0 16) 13)) anon13_correct)))
(let ((anon21_Then_correct  (=> (and (<= 0 x_5) (< x_5 (|Seq#Length| s@@21))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| s@@21 x_5) f_7)) 0)) (=> (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| s@@21 x_5) f_7)) 0) (=> (= (ControlFlow 0 14) 13) anon13_correct))))))
(let ((anon9_correct true))
(let ((anon19_Else_correct  (=> (and (not (and (<= 0 x_9) (< x_9 (|Seq#Length| s@@21)))) (= (ControlFlow 0 12) 7)) anon9_correct)))
(let ((anon19_Then_correct  (=> (and (<= 0 x_9) (< x_9 (|Seq#Length| s@@21))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (>= x_9 0)) (=> (>= x_9 0) (and (=> (= (ControlFlow 0 8) (- 0 10)) (< x_9 (|Seq#Length| s@@21))) (=> (< x_9 (|Seq#Length| s@@21)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm QPMask@0 (|Seq#Index| s@@21 x_9) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| s@@21 x_9) f_7) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))))))
(let ((anon20_Else_correct true))
(let ((anon16_Else_correct  (=> (forall ((x_3_1 T@U) ) (!  (=> (and (= (type x_3_1) RefType) (|Seq#Contains| s@@21 x_3_1)) (= (U_2_int (MapType0Select Heap@@9 x_3_1 f_7)) 0))
 :qid |stdinbpl.1771:20|
 :skolemid |191|
 :pattern ( (|Seq#ContainsTrigger| s@@21 x_3_1))
 :pattern ( (|Seq#Contains| s@@21 x_3_1))
)) (=> (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)) (and (and (and (and (=> (= (ControlFlow 0 17) 6) anon20_Else_correct) (=> (= (ControlFlow 0 17) 14) anon21_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon21_Else_correct)) (=> (= (ControlFlow 0 17) 8) anon19_Then_correct)) (=> (= (ControlFlow 0 17) 12) anon19_Else_correct))))))
(let ((anon5_correct true))
(let ((anon17_Else_correct  (=> (and (not (|Seq#Contains| s@@21 x_8)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon17_Then_correct  (=> (|Seq#Contains| s@@21 x_8) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 x_8 f_7)) (=> (HasDirectPerm QPMask@0 x_8 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| s@@21 x_1)) (|Seq#Contains| s@@21 x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
...
)) (=> (and (and (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| s@@21 x_1@@1) (< NoPerm FullPerm)) (and (qpRange10 x_1@@1) (= (invRecv10 x_1@@1) x_1@@1))))
...
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| s@@21 (invRecv10 o_3)) (< NoPerm FullPerm)) (qpRange10 o_3)) (= (invRecv10 o_3) o_3)))
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| s@@21 (invRecv10 o_3@@0)) (< NoPerm FullPerm)) (qpRange10 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv10 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| s@@21 (invRecv10 o_3@@0)) (< NoPerm FullPerm)) (qpRange10 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (and (=> (= (ControlFlow 0 18) 17) anon16_Else_correct) (=> (= (ControlFlow 0 18) 3) anon17_Then_correct)) (=> (= (ControlFlow 0 18) 5) anon17_Else_correct)))))))
(let ((anon15_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 20) 1) anon15_Then_correct) (=> (= (ControlFlow 0 20) 18) anon15_Else_correct)))))
