...
(= (type (MapType2Store arg0@@34 arg1@@16 arg2@@3)) (MapType2Type aVar0@@1 aVar1@@3))))
 ...
 :weight 0
)))) (= (Ctor PredicateType_PType) 14)) (forall ((arg0@@35 T@U) ) (! (= (type (P arg0@@35)) (FieldType PredicateType_PType FrameTypeType))
 :qid |funType:P|
 :pattern ( (P arg0@@35))
))))
(assert (forall ((b_2 T@U) ) (!  (=> (= (type b_2) (MapType2Type RefType boolType)) (IsPredicateField (P b_2)))
 :qid |stdinbpl.403:15|
 :skolemid |83|
 :pattern ( (P b_2))
)))
(assert (forall ((Heap@@2 T@U) (b_2@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type b_2@@0) (MapType2Type RefType boolType))) (|P#everUsed| (P b_2@@0)))
 :qid |stdinbpl.422:15|
 :skolemid |87|
 :pattern ( (|P#trigger| Heap@@2 (P b_2@@0)))
)))
(assert (forall ((arg0@@36 Int) (arg1@@17 Int) ) (! (= (type (|sk_P#condqp1| arg0@@36 arg1@@17)) RefType)
 :qid |funType:sk_P#condqp1|
 :pattern ( (|sk_P#condqp1| arg0@@36 arg1@@17))
)))
(assert (forall ((Heap2Heap T@U) (Heap1Heap T@U) (b_2@@1 T@U) ) (!  (=> (and (and (and (= (type Heap2Heap) (MapType0Type RefType)) (= (type Heap1Heap) (MapType0Type RefType))) (= (type b_2@@1) (MapType2Type RefType boolType))) (and (=  (and (U_2_bool (MapType2Select b_2@@1 (|sk_P#condqp1| (|P#condqp1| Heap2Heap b_2@@1) (|P#condqp1| Heap1Heap b_2@@1)))) (< NoPerm FullPerm))  (and (U_2_bool (MapType2Select b_2@@1 (|sk_P#condqp1| (|P#condqp1| Heap2Heap b_2@@1) (|P#condqp1| Heap1Heap b_2@@1)))) (< NoPerm FullPerm))) (=> (and (U_2_bool (MapType2Select b_2@@1 (|sk_P#condqp1| (|P#condqp1| Heap2Heap b_2@@1) (|P#condqp1| Heap1Heap b_2@@1)))) (< NoPerm FullPerm)) (= (MapType0Select Heap2Heap (|sk_P#condqp1| (|P#condqp1| Heap2Heap b_2@@1) (|P#condqp1| Heap1Heap b_2@@1)) f_7) (MapType0Select Heap1Heap (|sk_P#condqp1| (|P#condqp1| Heap2Heap b_2@@1) (|P#condqp1| Heap1Heap b_2@@1)) f_7))))) (= (|P#condqp1| Heap2Heap b_2@@1) (|P#condqp1| Heap1Heap b_2@@1)))
 :qid |stdinbpl.433:15|
 :skolemid |88|
 :pattern ( (|P#condqp1| Heap2Heap b_2@@1) (|P#condqp1| Heap1Heap b_2@@1) (succHeapTrans Heap2Heap Heap1Heap))
)))
...
(assert (forall ((b_2@@2 T@U) (b2 T@U) ) (!  (=> (and (and (= (type b_2@@2) (MapType2Type RefType boolType)) (= (type b2) (MapType2Type RefType boolType))) (= (P b_2@@2) (P b2))) (= b_2@@2 b2))
 :qid |stdinbpl.413:15|
 :skolemid |85|
 :pattern ( (P b_2@@2) (P b2))
)))
(assert (forall ((arg0@@40 T@U) ) (! (= (type (|P#sm| arg0@@40)) (FieldType PredicateType_PType (MapType1Type RefType boolType)))
 :qid |funType:P#sm|
 :pattern ( (|P#sm| arg0@@40))
)))
(assert (forall ((b_2@@3 T@U) (b2@@0 T@U) ) (!  (=> (and (and (= (type b_2@@3) (MapType2Type RefType boolType)) (= (type b2@@0) (MapType2Type RefType boolType))) (= (|P#sm| b_2@@3) (|P#sm| b2@@0))) (= b_2@@3 b2@@0))
 :qid |stdinbpl.417:15|
 :skolemid |86|
 :pattern ( (|P#sm| b_2@@3) (|P#sm| b2@@0))
)))
...
(assert (forall ((b_2@@4 T@U) ) (!  (=> (= (type b_2@@4) (MapType2Type RefType boolType)) (= (getPredWandId (P b_2@@4)) 0))
 :qid |stdinbpl.407:15|
 :skolemid |84|
 :pattern ( (P b_2@@4))
)))
...
(assert (forall ((b_2@@5 T@U) ) (!  (=> (= (type b_2@@5) (MapType2Type RefType boolType)) (= (PredicateMaskField (P b_2@@5)) (|P#sm| b_2@@5)))
 :qid |stdinbpl.399:15|
 :skolemid |82|
 :pattern ( (PredicateMaskField (P b_2@@5)))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type freshObj@0) RefType)) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Heap@4) (MapType0Type RefType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type l) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@46 T@U) ) (! (= (type (invRecv2 arg0@@46)) RefType)
...
(let ((anon3_Else_correct  (=> (HasDirectPerm Mask@1 null (P (|Set#Singleton| freshObj@0))) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 3) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (not (HasDirectPerm Mask@1 null (P (|Set#Singleton| freshObj@0)))) (=> (and (and (= Heap@2 (MapType0Store Heap@1 null (|P#sm| (|Set#Singleton| freshObj@0)) ZeroPMask)) (= Heap@3 (MapType0Store Heap@2 null (P (|Set#Singleton| freshObj@0)) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 2) 1))) anon2_correct))))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 l $allocated))) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@10 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@10 freshObj@0 $allocated (bool_2_U true)))) (and (= Mask@0 (MapType1Store ZeroMask freshObj@0 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 f_7)) FullPerm)))) (state Heap@0 Mask@0))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7))) (=> (and (= Heap@1 (MapType0Store Heap@0 freshObj@0 f_7 null)) (state Heap@1 Mask@0)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((l$0 T@U) (l$0_1 T@U) ) (!  (=> (and (= (type l$0) RefType) (= (type l$0_1) RefType)) (=> (and (and (and (and (not (= l$0 l$0_1)) (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0))) (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= l$0 l$0_1))))
 :qid |stdinbpl.545:17|
 :skolemid |95|
 :pattern ( (neverTriggered2 l$0) (neverTriggered2 l$0_1))
))) (=> (forall ((l$0@@0 T@U) (l$0_1@@0 T@U) ) (!  (=> (and (= (type l$0@@0) RefType) (= (type l$0_1@@0) RefType)) (=> (and (and (and (and (not (= l$0@@0 l$0_1@@0)) (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0@@0))) (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= l$0@@0 l$0_1@@0))))
 :qid |stdinbpl.545:17|
 :skolemid |95|
 :pattern ( (neverTriggered2 l$0@@0) (neverTriggered2 l$0_1@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((l$0@@1 T@U) ) (!  (=> (and (= (type l$0@@1) RefType) (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0@@1))) (>= (U_2_real (MapType1Select Mask@0 l$0@@1 f_7)) FullPerm))
 :qid |stdinbpl.552:17|
 :skolemid |96|
 :pattern ( (MapType0Select Heap@1 l$0@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 l$0@@1 f_7))
 :pattern ( (MapType2Select (|Set#Singleton| freshObj@0) l$0@@1))
))) (=> (forall ((l$0@@2 T@U) ) (!  (=> (and (= (type l$0@@2) RefType) (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0@@2))) (>= (U_2_real (MapType1Select Mask@0 l$0@@2 f_7)) FullPerm))
 :qid |stdinbpl.552:17|
 :skolemid |96|
 :pattern ( (MapType0Select Heap@1 l$0@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 l$0@@2 f_7))
 :pattern ( (MapType2Select (|Set#Singleton| freshObj@0) l$0@@2))
)) (=> (forall ((l$0@@3 T@U) ) (!  (=> (= (type l$0@@3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0@@3)) (< NoPerm FullPerm)) (and (qpRange2 l$0@@3) (= (invRecv2 l$0@@3) l$0@@3))))
 :qid |stdinbpl.558:22|
 :skolemid |97|
 :pattern ( (MapType0Select Heap@1 l$0@@3 f_7))
 :pattern ( (MapType1Select QPMask@0 l$0@@3 f_7))
 :pattern ( (MapType2Select (|Set#Singleton| freshObj@0) l$0@@3))
)) (=> (and (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) (invRecv2 o_3))) (and (< NoPerm FullPerm) (qpRange2 o_3))) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.562:22|
 :skolemid |98|
 :pattern ( (invRecv2 o_3))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) (invRecv2 o_3@@0))) (and (< NoPerm FullPerm) (qpRange2 o_3@@0))) (and (= (invRecv2 o_3@@0) o_3@@0) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (- (U_2_real (MapType1Select Mask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) (invRecv2 o_3@@0))) (and (< NoPerm FullPerm) (qpRange2 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select Mask@0 o_3@@0 f_7))))))
 :qid |stdinbpl.568:22|
 :skolemid |99|
...
)) (= Mask@1 (MapType1Store QPMask@0 null (P (|Set#Singleton| freshObj@0)) (real_2_U (+ (U_2_real (MapType1Select QPMask@0 null (P (|Set#Singleton| freshObj@0)))) FullPerm)))))) (and (and (state Heap@1 Mask@1) (state Heap@1 Mask@1)) (and (|P#trigger| Heap@1 (P (|Set#Singleton| freshObj@0))) (= (MapType0Select Heap@1 null (P (|Set#Singleton| freshObj@0))) (FrameFragment (int_2_U (|P#condqp1| Heap@1 (|Set#Singleton| freshObj@0)))))))) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))))))))))))
