...
(let ((anon6_Then_correct  (=> (not (= perm@2 NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= perm@2 (U_2_real (MapType1Select Mask@0 (|Seq#Index| a_2 (- i@@34 1)) Ref__Integer_value)))) (=> (<= perm@2 (U_2_real (MapType1Select Mask@0 (|Seq#Index| a_2 (- i@@34 1)) Ref__Integer_value))) (=> (= (ControlFlow 0 6) 5) anon4_correct))))))
...
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (< (- i@@34 1) (- len 1)) (state PostHeap@0 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= (- i@@34 1) 0)) (=> (>= (- i@@34 1) 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< (- i@@34 1) (|Seq#Length| a_2))) (=> (< (- i@@34 1) (|Seq#Length| a_2)) (=> (and (= perm@1 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@1 NoPerm))))))))))
(let ((anon0_correct  (=> (and (and (and (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@33 diz $allocated)) (not (= diz null)))) (and (and (state Heap@@33 ZeroMask) (>= current_thread_id 0)) (and (state Heap@@33 ZeroMask) (<= 0 i@@34)))) (and (and (and (< i@@34 len) (state Heap@@33 ZeroMask)) (and (< (- i@@34 1) (- len 1)) (state Heap@@33 ZeroMask))) (and (and (> i@@34 0) (state Heap@@33 ZeroMask)) (and (<= len (|Seq#Length| a_2)) (state Heap@@33 ZeroMask))))) (and (=> (= (ControlFlow 0 12) (- 0 15)) (>= (- i@@34 1) 0)) (=> (>= (- i@@34 1) 0) (and (=> (= (ControlFlow 0 12) (- 0 14)) (< (- i@@34 1) (|Seq#Length| a_2))) (=> (< (- i@@34 1) (|Seq#Length| a_2)) (=> (= perm@0 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= (|Seq#Index| a_2 (- i@@34 1)) null))) (= Mask@0 (MapType1Store ZeroMask (|Seq#Index| a_2 (- i@@34 1)) Ref__Integer_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask (|Seq#Index| a_2 (- i@@34 1)) Ref__Integer_value)) perm@0))))) (and (state Heap@@33 Mask@0) (state Heap@@33 Mask@0))) (and (=> (= (ControlFlow 0 12) 2) anon5_Then_correct) (=> (= (ControlFlow 0 12) 9) anon5_Else_correct)))))))))))))
