...
(assert  (and (and (and (and (and (= (type x@@14) RefType) (= (type y@@1) RefType)) (= (type Heap@@10) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon8_correct true))
(let ((anon12_Else_correct  (=> (and (not (or (not (= x@@14 y@@1)) (not (= i@@5 j)))) (= (ControlFlow 0 5) 1)) anon8_correct)))
(let ((anon12_Then_correct  (=> (or (not (= x@@14 y@@1)) (not (= i@@5 j))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (not b_2)) (=> (not b_2) (=> (state Heap@@10 Mask@2) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (U_2_real (MapType1Select Mask@2 null (P y@@1 j))) NoPerm)) (=> (= (U_2_real (MapType1Select Mask@2 null (P y@@1 j))) NoPerm) (=> (and (state Heap@@10 Mask@2) (= (ControlFlow 0 2) 1)) anon8_correct)))))))))
(let ((anon6_correct  (=> (state Heap@@10 Mask@2) (and (=> (= (ControlFlow 0 6) 2) anon12_Then_correct) (=> (= (ControlFlow 0 6) 5) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (not b_2) (= (ControlFlow 0 10) 6)) anon6_correct)))
(let ((anon11_Then_correct  (=> b_2 (and (=> (= (ControlFlow 0 7) (- 0 9)) (= y@@1 x@@14)) (=> (= y@@1 x@@14) (and (=> (= (ControlFlow 0 7) (- 0 8)) (= j i@@5)) (=> (= j i@@5) (=> (= (ControlFlow 0 7) 6) anon6_correct))))))))
(let ((anon4_correct  (=> (state Heap@@10 Mask@2) (=> (and (and (state Heap@@10 Mask@2) (<= (__iar__assume_helper_2  (and (= x@@14 y@@1) (= i@@5 j))  (and b_2 (and (= y@@1 y@@1) (= j j))) (/ (to_real 1) (to_real 3)) (/ (to_real 3) (to_real 16)) (/ (to_real 0) (to_real 16))) (U_2_real (MapType1Select Mask@2 null (P y@@1 j))))) (and (state Heap@@10 Mask@2) (state Heap@@10 Mask@2))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (= (U_2_real (MapType1Select Mask@2 null (P x@@14 i@@5))) (+ (/ (to_real 1) (to_real 3)) (ite b_2 (/ (to_real 1) (to_real 4)) NoPerm)))) (=> (= (U_2_real (MapType1Select Mask@2 null (P x@@14 i@@5))) (+ (/ (to_real 1) (to_real 3)) (ite b_2 (/ (to_real 1) (to_real 4)) NoPerm))) (=> (state Heap@@10 Mask@2) (and (=> (= (ControlFlow 0 11) 7) anon11_Then_correct) (=> (= (ControlFlow 0 11) 10) anon11_Else_correct)))))))))
(let ((anon10_Else_correct  (=> (and (not b_2) (= (ControlFlow 0 14) 11)) anon4_correct)))
(let ((anon10_Then_correct  (=> b_2 (=> (and (<= (__iar__assume_helper_1  (and (= x@@14 y@@1) (= i@@5 j)) (/ (to_real 1) (to_real 3)) (/ (to_real 3) (to_real 16))) (U_2_real (MapType1Select Mask@2 null (P y@@1 j)))) (= (ControlFlow 0 13) 11)) anon4_correct))))
(let ((anon2_correct  (=> (and (and (state Heap@@10 Mask@2) (<= (/ (to_real 1) (to_real 3)) (U_2_real (MapType1Select Mask@2 null (P x@@14 i@@5))))) (and (state Heap@@10 Mask@2) (state Heap@@10 Mask@2))) (and (=> (= (ControlFlow 0 15) 13) anon10_Then_correct) (=> (= (ControlFlow 0 15) 14) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (not b_2) (=> (and (= Mask@2 Mask@0) (= (ControlFlow 0 18) 15)) anon2_correct))))
(let ((anon9_Then_correct  (=> (and b_2 (= perm@1 (/ (to_real 1) (to_real 4)))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (= Mask@1 (MapType1Store Mask@0 null (P x@@14 i@@5) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (P x@@14 i@@5))) perm@1)))) (state Heap@@10 Mask@1)) (=> (and (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 16) 15))) anon2_correct)))))))
(let ((anon0_correct  (=> (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x@@14 $allocated))) (and (U_2_bool (MapType0Select Heap@@10 y@@1 $allocated)) (= perm@0 (/ (to_real 1) (to_real 3))))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (P x@@14 i@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@14 i@@5))) perm@0)))) (state Heap@@10 Mask@0)) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 19) 16) anon9_Then_correct) (=> (= (ControlFlow 0 19) 18) anon9_Else_correct))))))))
