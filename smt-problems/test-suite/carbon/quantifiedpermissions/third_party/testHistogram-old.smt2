...
(assert  (and (= (type ar@@27) (SeqType intType)) (= (type Heap@@33) (MapType0Type RefType))))
...
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (= AssumeFunctionsAbove 5) (<= 0 i@@34)) (=> (and (and (<= i@@34 hi@@27) (state Heap@@33 ZeroMask)) (and (<= hi@@27 (|Seq#Length| ar@@27)) (state Heap@@33 ZeroMask))) (and (=> (= (ControlFlow 0 11) 8) anon5_Then_correct) (=> (= (ControlFlow 0 11) 2) anon5_Else_correct)))))))
