...
(assert  (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type x@@23) RefType)) (= (type Heap@@19) (MapType0Type RefType))))
(set-info :boogie-vc-id test03)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 4)) anon3_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@23 g)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@23 g))) (=> (= (ControlFlow 0 5) 4) anon3_correct))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 x@@23 g)) (=> (HasDirectPerm Mask@0 x@@23 g) (=> (= (ControlFlow 0 2) (- 0 1)) (= (fun02 Heap@@19 x@@23) (* 2 (U_2_int (MapType0Select Heap@@19 x@@23 g)))))))))
(let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@19 x@@23 $allocated))) (=> (and (and (not (= x@@23 null)) (= Mask@0 (MapType1Store ZeroMask x@@23 g (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@23 g)) FullPerm))))) (and (state Heap@@19 Mask@0) (state Heap@@19 Mask@0))) (and (and (=> (= (ControlFlow 0 8) 2) anon5_Else_correct) (=> (= (ControlFlow 0 8) 5) anon6_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))))
