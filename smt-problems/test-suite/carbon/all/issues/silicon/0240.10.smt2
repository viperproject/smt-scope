...
(assert  (and (and (and (and (= (type xs@@11) (MapType2Type RefType boolType)) (= (type Heap@@21) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@54 T@U) ) (! (= (type (invRecv2 arg0@@54)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@54))
))))
(set-info :boogie-vc-id |bla_qp#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon6_Else_correct true))
(let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (U_2_bool (MapType2Select xs@@11 x_3))) (U_2_bool (MapType2Select xs@@11 x_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1))))
 :qid |stdinbpl.1049:21|
 :skolemid |132|
 :pattern ( (neverTriggered3 x_3) (neverTriggered3 x_3_1))
))) (=> (forall ((x_3@@0 T@U) (x_3_1@@0 T@U) ) (!  (=> (and (= (type x_3@@0) RefType) (= (type x_3_1@@0) RefType)) (=> (and (and (and (and (not (= x_3@@0 x_3_1@@0)) (U_2_bool (MapType2Select xs@@11 x_3@@0))) (U_2_bool (MapType2Select xs@@11 x_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3@@0 x_3_1@@0))))
 :qid |stdinbpl.1049:21|
 :skolemid |132|
 :pattern ( (neverTriggered3 x_3@@0) (neverTriggered3 x_3_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_3@@1 T@U) ) (!  (=> (and (= (type x_3@@1) RefType) (U_2_bool (MapType2Select xs@@11 x_3@@1))) (>= (U_2_real (MapType1Select QPMask@0 x_3@@1 data)) FullPerm))
 :qid |stdinbpl.1056:21|
 :skolemid |133|
 :pattern ( (MapType0Select Heap@@21 x_3@@1 data))
 :pattern ( (MapType1Select QPMask@1 x_3@@1 data))
 :pattern ( (MapType2Select xs@@11 x_3@@1))
)))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((x_2 T@U) (x_2_1 T@U) ) (!  (=> (and (= (type x_2) RefType) (= (type x_2_1) RefType)) (=> (and (and (and (and (not (= x_2 x_2_1)) (U_2_bool (MapType2Select xs@@11 x_2))) (U_2_bool (MapType2Select xs@@11 x_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_2 x_2_1))))
...
))) (=> (forall ((x_2@@0 T@U) (x_2_1@@0 T@U) ) (!  (=> (and (= (type x_2@@0) RefType) (= (type x_2_1@@0) RefType)) (=> (and (and (and (and (not (= x_2@@0 x_2_1@@0)) (U_2_bool (MapType2Select xs@@11 x_2@@0))) (U_2_bool (MapType2Select xs@@11 x_2_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_2@@0 x_2_1@@0))))
 :qid |stdinbpl.1003:15|
 :skolemid |126|
...
)) (=> (forall ((x_2@@1 T@U) ) (!  (=> (= (type x_2@@1) RefType) (=> (and (U_2_bool (MapType2Select xs@@11 x_2@@1)) (< NoPerm FullPerm)) (and (qpRange2 x_2@@1) (= (invRecv2 x_2@@1) x_2@@1))))
 :qid |stdinbpl.1009:22|
 :skolemid |127|
 :pattern ( (MapType0Select Heap@@21 x_2@@1 data))
 :pattern ( (MapType1Select QPMask@0 x_2@@1 data))
 :pattern ( (MapType2Select xs@@11 x_2@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select xs@@11 (invRecv2 o_3))) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.1013:22|
 :skolemid |128|
 :pattern ( (invRecv2 o_3))
)) (forall ((x_2@@2 T@U) ) (!  (=> (and (= (type x_2@@2) RefType) (U_2_bool (MapType2Select xs@@11 x_2@@2))) (not (= x_2@@2 null)))
 :qid |stdinbpl.1019:22|
 :skolemid |129|
 :pattern ( (MapType0Select Heap@@21 x_2@@2 data))
 :pattern ( (MapType1Select QPMask@0 x_2@@2 data))
 :pattern ( (MapType2Select xs@@11 x_2@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs@@11 (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 data)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 data)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select xs@@11 (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 data)) (U_2_real (MapType1Select ZeroMask o_3@@0 data))))))
...
))) (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0))) (and (=> (= (ControlFlow 0 6) 3) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@21 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 8) 1) anon5_Then_correct) (=> (= (ControlFlow 0 8) 6) anon5_Else_correct)))))
...
(assert  (and (and (and (and (and (= (type UnfoldingMask@0) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type xs@@11) (MapType2Type RefType boolType))) (= (type Heap@@21) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@54 T@U) ) (! (= (type (invRecv7 arg0@@54)) RefType)
 :qid |funType:invRecv7|
 :pattern ( (invRecv7 arg0@@54))
))))
(set-info :boogie-vc-id test04a_qp)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon2_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (bla_qp xs@@11) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (bla_qp xs@@11))) perm@1)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((x@@19 T@U) (x_5 T@U) ) (!  (=> (and (= (type x@@19) RefType) (= (type x_5) RefType)) (=> (and (and (and (and (not (= x@@19 x_5)) (U_2_bool (MapType2Select xs@@11 x@@19))) (U_2_bool (MapType2Select xs@@11 x_5))) (< NoPerm (* FullPerm (/ (to_real 1) (to_real 2))))) (< NoPerm (* FullPerm (/ (to_real 1) (to_real 2))))) (not (= x@@19 x_5))))
 :qid |stdinbpl.2027:17|
 :skolemid |173|
...
)) (=> (forall ((x@@21 T@U) ) (!  (=> (= (type x@@21) RefType) (=> (and (U_2_bool (MapType2Select xs@@11 x@@21)) (< NoPerm (* FullPerm (/ (to_real 1) (to_real 2))))) (and (qpRange7 x@@21) (= (invRecv7 x@@21) x@@21))))
 :qid |stdinbpl.2033:24|
 :skolemid |174|
 :pattern ( (MapType0Select Heap@@21 x@@21 data))
 :pattern ( (MapType1Select QPMask@0 x@@21 data))
 :pattern ( (MapType2Select xs@@11 x@@21))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select xs@@11 (invRecv7 o_3))) (< NoPerm (* FullPerm (/ (to_real 1) (to_real 2))))) (qpRange7 o_3)) (= (invRecv7 o_3) o_3)))
 :qid |stdinbpl.2037:24|
 :skolemid |175|
 ...
 :qid |stdinbpl.2043:17|
 :skolemid |176|
 :pattern ( (MapType0Select Heap@@21 x@@22 data))
...
(let ((anon3_Then_correct  (=> (not (= perm@1 NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= perm@1 (U_2_real (MapType1Select Mask@0 null (bla_qp xs@@11))))) (=> (<= perm@1 (U_2_real (MapType1Select Mask@0 null (bla_qp xs@@11)))) (=> (= (ControlFlow 0 4) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@21 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (= perm@0 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (= Mask@0 (MapType1Store ZeroMask null (bla_qp xs@@11) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (bla_qp xs@@11))) perm@0)))) (state Heap@@21 Mask@0)) (=> (and (and (state Heap@@21 Mask@0) (|bla_qp#trigger| Heap@@21 (bla_qp xs@@11))) (and (= (MapType0Select Heap@@21 null (bla_qp xs@@11)) (FrameFragment (int_2_U (|bla_qp#condqp2| Heap@@21 xs@@11)))) (= perm@1 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (and (=> (= (ControlFlow 0 7) 4) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct))))))))))))
