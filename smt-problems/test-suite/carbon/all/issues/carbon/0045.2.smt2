...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type p_1@@3) RefType)) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type r_1) RefType)) (= (type Heap@@14) (MapType0Type RefType))) (forall ((arg0@@28 T@U) (arg1@@10 T@U) ) (! (= (type (CombineFrames arg0@@28 arg1@@10)) FrameTypeType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon8_correct  (=> (and (and (and (= UnfoldingMask@0 (MapType1Store Mask@2 null (Pair p_1@@3) (real_2_U (- (U_2_real (MapType1Select Mask@2 null (Pair p_1@@3))) FullPerm)))) (not (= p_1@@3 null))) (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 p_1@@3 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 p_1@@3 f_7)) FullPerm)))) (state ExhaleHeap@0 UnfoldingMask@1))) (and (and (not (= p_1@@3 null)) (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 p_1@@3 g (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 p_1@@3 g)) FullPerm))))) (and (state ExhaleHeap@0 UnfoldingMask@2) (state ExhaleHeap@0 UnfoldingMask@2)))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (HasDirectPerm UnfoldingMask@2 p_1@@3 f_7)) (=> (HasDirectPerm UnfoldingMask@2 p_1@@3 f_7) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm UnfoldingMask@2 p_1@@3 g)) (=> (HasDirectPerm UnfoldingMask@2 p_1@@3 g) (=> (and (and (= Heap@0 (MapType0Store ExhaleHeap@0 null (|Pair#sm| p_1@@3) (MapType1Store (MapType0Select ExhaleHeap@0 null (|Pair#sm| p_1@@3)) p_1@@3 f_7 (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|Pair#sm| p_1@@3) (MapType1Store (MapType0Select Heap@0 null (|Pair#sm| p_1@@3)) p_1@@3 g (bool_2_U true))))) (and (state Heap@1 Mask@2) (= (ControlFlow 0 6) (- 0 5)))) (= (+ (U_2_int (MapType0Select Heap@1 p_1@@3 f_7)) (U_2_int (MapType0Select Heap@1 p_1@@3 g))) x@0)))))))))
(let ((anon12_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 6)) anon8_correct)))
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null (Pair p_1@@3))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 null (Pair p_1@@3)))) (=> (= (ControlFlow 0 9) 6) anon8_correct))))))
(let ((anon6_correct  (=> (= Mask@2 (MapType1Store Mask@1 r_1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 r_1 f_7)) FullPerm)))) (=> (and (and (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)) (and (|Pair#trigger| ExhaleHeap@0 (Pair p_1@@3)) (= (MapType0Select ExhaleHeap@0 null (Pair p_1@@3)) (CombineFrames (FrameFragment (MapType0Select ExhaleHeap@0 p_1@@3 f_7)) (FrameFragment (MapType0Select ExhaleHeap@0 p_1@@3 g)))))) (and (=> (= (ControlFlow 0 12) 9) anon12_Then_correct) (=> (= (ControlFlow 0 12) 11) anon12_Else_correct))))))
(let ((anon11_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 15) 12)) anon6_correct)))
(let ((anon11_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 f_7))) (=> (= (ControlFlow 0 13) 12) anon6_correct))))))
(let ((anon9_Else_correct  (=> (and (= x@0 (sum Heap@@14 p_1@@3)) (state Heap@@14 Mask@1)) (and (=> (= (ControlFlow 0 16) 13) anon11_Then_correct) (=> (= (ControlFlow 0 16) 15) anon11_Else_correct)))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (Pair p_1@@3))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (Pair p_1@@3)))) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@14 p_1@@3 $allocated)) (U_2_bool (MapType0Select Heap@@14 r_1 $allocated))) (and (= Mask@0 (MapType1Store ZeroMask null (Pair p_1@@3) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Pair p_1@@3))) FullPerm)))) (state Heap@@14 Mask@0))) (and (and (not (= r_1 null)) (= Mask@1 (MapType1Store Mask@0 r_1 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 r_1 f_7)) FullPerm))))) (and (state Heap@@14 Mask@1) (state Heap@@14 Mask@1)))) (and (and (=> (= (ControlFlow 0 17) 16) anon9_Else_correct) (=> (= (ControlFlow 0 17) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 17) 4) anon10_Else_correct))))))
