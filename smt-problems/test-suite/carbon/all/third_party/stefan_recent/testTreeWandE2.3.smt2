...
(let ((anon18_Then_correct  (=> (not (= (MapType0Select Heap@15 (MapType0Select Heap@15 diz@@29 Wand_state_contains_for_state_contains__prev_1) Tree__right) null)) (=> (and (and (forall ((o_3 T@U) (f_7 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_7))))
(let ((A@@13 (FieldTypeInv0 (type f_7))))
 (=> (and (and (= (type o_3) RefType) (= (type f_7) (FieldType A@@13 B@@12))) (or (U_2_bool (MapType1Select (MapType0Select Heap@15 null (|Wand_state_contains_for_state_contains__valid_wand#sm| diz@@29)) o_3 f_7)) (U_2_bool (MapType1Select (MapType0Select Heap@15 null (|Tree__state#sm| (MapType0Select Heap@15 (MapType0Select Heap@15 diz@@29 Wand_state_contains_for_state_contains__prev_1) Tree__right))) o_3 f_7)))) (U_2_bool (MapType1Select newPMask@0 o_3 f_7)))))
 :qid |stdinbpl.852:35|
 :skolemid |63|
