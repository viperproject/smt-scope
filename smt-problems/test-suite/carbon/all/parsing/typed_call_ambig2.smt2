...
(assert  (and (and (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type y@@1) RefType)) (= (type ApplyingMask@1) (MapType1Type RefType realType))) (= (type ApplyingMask@0) (MapType1Type RefType realType))) (= (type x@@8) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type ApplyingMask@2) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id m)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (HasDirectPerm Mask@1 y@@1 f_7))))
(let ((anon9_Then_correct true))
(let ((anon4_correct  (=> (and (and (and (= ApplyingMask@1 (MapType1Store ApplyingMask@0 x@@8 f_7 (real_2_U (- (U_2_real (MapType1Select ApplyingMask@0 x@@8 f_7)) FullPerm)))) (state Heap@@9 ApplyingMask@1)) (and (not (= y@@1 null)) (= ApplyingMask@2 (MapType1Store ApplyingMask@1 y@@1 f_7 (real_2_U (+ (U_2_real (MapType1Select ApplyingMask@1 y@@1 f_7)) FullPerm)))))) (and (and (state Heap@@9 ApplyingMask@2) (state Heap@@9 ApplyingMask@2)) (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 ApplyingMask@2) (state ExhaleHeap@0 ApplyingMask@2)))) (and (=> (= (ControlFlow 0 5) 2) anon9_Then_correct) (=> (= (ControlFlow 0 5) 4) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon4_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select ApplyingMask@0 x@@8 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select ApplyingMask@0 x@@8 f_7))) (=> (= (ControlFlow 0 6) 5) anon4_correct))))))
(let ((anon7_Else_correct  (=> (and (and (= Mask@1 (MapType1Store Mask@0 null (wand x@@8 FullPerm y@@1 FullPerm) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (wand x@@8 FullPerm y@@1 FullPerm))) FullPerm)))) (state Heap@@9 Mask@1)) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (wand x@@8 FullPerm y@@1 FullPerm))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (wand x@@8 FullPerm y@@1 FullPerm)))) (=> (and (= ApplyingMask@0 (MapType1Store Mask@1 null (wand x@@8 FullPerm y@@1 FullPerm) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (wand x@@8 FullPerm y@@1 FullPerm))) FullPerm)))) (state Heap@@9 ApplyingMask@0)) (and (=> (= (ControlFlow 0 9) 6) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@9 y@@1 $allocated)) (not (= x@@8 null))) (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm)))) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 11) 1) anon7_Then_correct) (=> (= (ControlFlow 0 11) 9) anon7_Else_correct))))))
