...
(declare-fun k_9 () Int)
(assert  (and (and (= (type ar@@27) (SeqType RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@33) (MapType0Type RefType))))
...
(assert (not
 ...
 :skolemid |114|
)) (and (=> (= (ControlFlow 0 17) (- 0 19)) (forall ((k_5@@2 Int) ) (!  (=> (and (and (<= vmin@@9 k_5@@2) (and (< k_5@@2 vmax@@9) (and (<= lo@@14 (mod k_5@@2 step@@9)) (< (mod k_5@@2 step@@9) hi@@27)))) (dummyFunction (MapType0Select Heap@@33 (|Seq#Index| ar@@27 k_5@@2) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1371:23|
 :skolemid |115|
 :pattern ( (|Seq#Index| ar@@27 k_5@@2))
 :pattern ( (|Seq#Index| ar@@27 k_5@@2))
))) (=> (forall ((k_5@@3 Int) ) (!  (=> (and (and (<= vmin@@9 k_5@@3) (and (< k_5@@3 vmax@@9) (and (<= lo@@14 (mod k_5@@3 step@@9)) (< (mod k_5@@3 step@@9) hi@@27)))) (dummyFunction (MapType0Select Heap@@33 (|Seq#Index| ar@@27 k_5@@3) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1371:23|
 :skolemid |115|
...
(let ((anon24_Else_correct  (=> (and (|count_square#trigger| (FrameFragment (int_2_U (|count_square#condqp3| Heap@@33 (+ i@@34 1) lo@@14 hi@@27 step@@9 vmin@@9 vmax@@9 ar@@27 v_2@@13))) (+ i@@34 1) lo@@14 hi@@27 step@@9 vmin@@9 vmax@@9 ar@@27 v_2@@13) (= (ControlFlow 0 28) 14)) anon15_correct)))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.1312:29|
 :skolemid |112|
 :pattern ( (MapType1Select ZeroMask o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
))) (and (state Heap@@33 QPMask@0) (state Heap@@33 QPMask@0))) (and (=> (= (ControlFlow 0 39) 37) anon21_Then_correct) (=> (= (ControlFlow 0 39) 15) anon21_Else_correct)))))))))
...
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (= AssumeFunctionsAbove 2) (<= 0 lo@@14)) (=> (and (and (and (<= lo@@14 hi@@27) (<= hi@@27 step@@9)) (and (> step@@9 0) (state Heap@@33 ZeroMask))) (and (and (<= 0 vmin@@9) (<= vmin@@9 i@@34)) (and (<= i@@34 vmax@@9) (state Heap@@33 ZeroMask)))) (and (and (=> (= (ControlFlow 0 41) 39) anon16_Else_correct) (=> (= (ControlFlow 0 41) 13) anon17_Then_correct)) (=> (= (ControlFlow 0 41) 6) anon17_Else_correct)))))))
