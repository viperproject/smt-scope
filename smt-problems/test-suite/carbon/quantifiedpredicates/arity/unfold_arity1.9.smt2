...
(let ((anon9_Else_correct  (=> (HasDirectPerm Mask@0 null (p4 x@@11 i@@18)) (=> (and (= Heap@1 Heap@@14) (= (ControlFlow 0 5) 3)) anon6_correct))))
(let ((anon9_Then_correct  (=> (and (and (not (HasDirectPerm Mask@0 null (p4 x@@11 i@@18))) (= Heap@0 (MapType0Store Heap@@14 null (p4 x@@11 i@@18) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 4) 3))) anon6_correct)))
(let ((anon4_correct  (=> (= Mask@0 (MapType1Store QPMask@0 null (p4 x@@11 i@@18) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (p4 x@@11 i@@18))) FullPerm)))) (and (=> (= (ControlFlow 0 6) 4) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon4_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p4 x@@11 i@@18))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p4 x@@11 i@@18)))) (=> (= (ControlFlow 0 7) 6) anon4_correct))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (|Seq#Contains| xs r_1)) (|Seq#Contains| xs r_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= r_1 r_1_1)) (not (= i@@18 i@@18)))))
 :qid |stdinbpl.1338:17|
 :skolemid |107|
 :pattern ( (neverTriggered5 r_1) (neverTriggered5 r_1_1))
 ...
 :qid |stdinbpl.1338:17|
 :skolemid |107|
 :pattern ( (neverTriggered5 r_1@@0) (neverTriggered5 r_1_1@@0))
)) (=> (forall ((r_1@@1 T@U) ) (!  (=> (= (type r_1@@1) RefType) (=> (and (|Seq#Contains| xs r_1@@1) (< NoPerm FullPerm)) (and (= (invRecv5 r_1@@1 i@@18) r_1@@1) (qpRange5 r_1@@1 i@@18))))
 :qid |stdinbpl.1344:22|
 :skolemid |108|
...
)) (=> (and (and (and (forall ((r_2_1 T@U) (i_1_1 Int) ) (!  (=> (= (type r_2_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv5 r_2_1 i_1_1)) (< NoPerm FullPerm)) (qpRange5 r_2_1 i_1_1)) (and (= (invRecv5 r_2_1 i_1_1) r_2_1) (= i@@18 i_1_1))))
 :qid |stdinbpl.1348:22|
 :skolemid |109|
 :pattern ( (invRecv5 r_2_1 i_1_1))
)) (forall ((r_2_1@@0 T@U) (i_1_1@@0 Int) ) (!  (=> (= (type r_2_1@@0) RefType) (=> (and (and (|Seq#Contains| xs (invRecv5 r_2_1@@0 i_1_1@@0)) (< NoPerm FullPerm)) (qpRange5 r_2_1@@0 i_1_1@@0)) (and (=> (< NoPerm FullPerm) (and (= (invRecv5 r_2_1@@0 i_1_1@@0) r_2_1@@0) (= i@@18 i_1_1@@0))) (= (U_2_real (MapType1Select QPMask@0 null (p4 r_2_1@@0 i_1_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (p4 r_2_1@@0 i_1_1@@0))) FullPerm)))))
...
)) (forall ((r_2_1@@1 T@U) (i_1_1@@1 Int) ) (!  (=> (and (= (type r_2_1@@1) RefType) (not (and (and (|Seq#Contains| xs (invRecv5 r_2_1@@1 i_1_1@@1)) (< NoPerm FullPerm)) (qpRange5 r_2_1@@1 i_1_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (p4 r_2_1@@1 i_1_1@@1))) (U_2_real (MapType1Select ZeroMask null (p4 r_2_1@@1 i_1_1@@1)))))
 :qid |stdinbpl.1364:22|
 :skolemid |112|
 :pattern ( (MapType1Select QPMask@0 null (p4 r_2_1@@1 i_1_1@@1)))
)))) (and (and (state Heap@@14 QPMask@0) (state Heap@@14 QPMask@0)) (and (|p4#trigger| Heap@@14 (p4 x@@11 i@@18)) (= (MapType0Select Heap@@14 null (p4 x@@11 i@@18)) (FrameFragment (MapType0Select Heap@@14 x@@11 f_7)))))) (and (=> (= (ControlFlow 0 10) 7) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@14 ZeroMask) (U_2_bool (MapType0Select Heap@@14 x@@11 $allocated))) (and (|Seq#Contains| xs x@@11) (state Heap@@14 ZeroMask))) (and (=> (= (ControlFlow 0 12) 1) anon7_Then_correct) (=> (= (ControlFlow 0 12) 10) anon7_Else_correct)))))
