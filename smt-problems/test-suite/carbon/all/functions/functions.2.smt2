...
(assert  (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type Heap@@47) (MapType0Type RefType))) (= (type x@@56) RefType)))
(set-info :boogie-vc-id |err2#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon3_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 (MapType0Select Heap@@47 x@@56 h) f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 (MapType0Select Heap@@47 x@@56 h) f_7))) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (and (and (and (state Heap@@47 ZeroMask) (U_2_bool (MapType0Select Heap@@47 x@@56 $allocated))) (and (= AssumeFunctionsAbove 2) (not (= x@@56 null)))) (and (and (= Mask@0 (MapType1Store ZeroMask x@@56 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@56 f_7)) FullPerm)))) (state Heap@@47 Mask@0)) (and (state Heap@@47 Mask@0) (state Heap@@47 Mask@0)))) (and (and (=> (= (ControlFlow 0 6) 1) anon5_Else_correct) (=> (= (ControlFlow 0 6) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))
