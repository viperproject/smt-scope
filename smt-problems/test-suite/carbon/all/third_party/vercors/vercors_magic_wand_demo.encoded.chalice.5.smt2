...
(assert  (and (and (and (and (and (and (and (= (type Mask@5) (MapType1Type RefType realType)) (= (type this$_4@@5) RefType)) (= (type Heap@@26) (MapType0Type RefType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |Wand_readonly_for_writeonlyvalid_wand$#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon2_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@5 this$_4@@5 Wand_readonly_for_writeonlylemma$))))
(let ((anon3_Else_correct  (=> (not (= (U_2_int (MapType0Select Heap@@26 this$_4@@5 Wand_readonly_for_writeonlylemma$)) 1)) (=> (and (= Mask@5 Mask@3) (= (ControlFlow 0 11) 2)) anon2_correct))))
(let ((anon3_Then_correct  (=> (= (U_2_int (MapType0Select Heap@@26 this$_4@@5 Wand_readonly_for_writeonlylemma$)) 1) (and (=> (= (ControlFlow 0 3) (- 0 10)) (HasDirectPerm Mask@3 this$_4@@5 Wand_readonly_for_writeonlythis_1$)) (=> (HasDirectPerm Mask@3 this$_4@@5 Wand_readonly_for_writeonlythis_1$) (=> (not (= (MapType0Select Heap@@26 this$_4@@5 Wand_readonly_for_writeonlythis_1$) null)) (and (=> (= (ControlFlow 0 3) (- 0 9)) (HasDirectPerm Mask@3 this$_4@@5 Wand_readonly_for_writeonlythis_1$)) (=> (HasDirectPerm Mask@3 this$_4@@5 Wand_readonly_for_writeonlythis_1$) (=> (= perm@0 (/ (to_real 75) (to_real 100))) (and (=> (= (ControlFlow 0 3) (- 0 8)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= (MapType0Select Heap@@26 this$_4@@5 Wand_readonly_for_writeonlythis_1$) null))) (=> (and (= Mask@4 (MapType1Store Mask@3 (MapType0Select Heap@@26 this$_4@@5 Wand_readonly_for_writeonlythis_1$) WandDemox$ (real_2_U (+ (U_2_real (MapType1Select Mask@3 (MapType0Select Heap@@26 this$_4@@5 Wand_readonly_for_writeonlythis_1$) WandDemox$)) perm@0)))) (state Heap@@26 Mask@4)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (HasDirectPerm Mask@4 this$_4@@5 Wand_readonly_for_writeonlyin_1$)) (=> (HasDirectPerm Mask@4 this$_4@@5 Wand_readonly_for_writeonlyin_1$) (and (=> (= (ControlFlow 0 3) (- 0 6)) (HasDirectPerm Mask@4 this$_4@@5 Wand_readonly_for_writeonlythis_1$)) (=> (HasDirectPerm Mask@4 this$_4@@5 Wand_readonly_for_writeonlythis_1$) (=> (= (MapType0Select Heap@@26 this$_4@@5 Wand_readonly_for_writeonlyin_1$) (MapType0Select Heap@@26 this$_4@@5 Wand_readonly_for_writeonlythis_1$)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm Mask@4 this$_4@@5 Wand_readonly_for_writeonlyout_1$)) (=> (HasDirectPerm Mask@4 this$_4@@5 Wand_readonly_for_writeonlyout_1$) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm Mask@4 this$_4@@5 Wand_readonly_for_writeonlythis_1$)) (=> (HasDirectPerm Mask@4 this$_4@@5 Wand_readonly_for_writeonlythis_1$) (=> (= (MapType0Select Heap@@26 this$_4@@5 Wand_readonly_for_writeonlyout_1$) (MapType0Select Heap@@26 this$_4@@5 Wand_readonly_for_writeonlythis_1$)) (=> (and (= Mask@5 Mask@4) (= (ControlFlow 0 3) 2)) anon2_correct))))))))))))))))))))))))
(let ((anon0_correct  (=> (state Heap@@26 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@26 this$_4@@5 $allocated))) (=> (and (and (> wildcard@0 NoPerm) (not (= this$_4@@5 null))) (and (= Mask@0 (MapType1Store ZeroMask this$_4@@5 Wand_readonly_for_writeonlylemma$ (real_2_U (+ (U_2_real (MapType1Select ZeroMask this$_4@@5 Wand_readonly_for_writeonlylemma$)) wildcard@0)))) (state Heap@@26 Mask@0))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (HasDirectPerm Mask@0 this$_4@@5 Wand_readonly_for_writeonlylemma$)) (=> (HasDirectPerm Mask@0 this$_4@@5 Wand_readonly_for_writeonlylemma$) (=> (<= 1 (U_2_int (MapType0Select Heap@@26 this$_4@@5 Wand_readonly_for_writeonlylemma$))) (=> (and (and (> wildcard@1 NoPerm) (not (= this$_4@@5 null))) (and (= Mask@1 (MapType1Store Mask@0 this$_4@@5 Wand_readonly_for_writeonlyin_1$ (real_2_U (+ (U_2_real (MapType1Select Mask@0 this$_4@@5 Wand_readonly_for_writeonlyin_1$)) wildcard@1)))) (state Heap@@26 Mask@1))) (=> (and (and (and (> wildcard@2 NoPerm) (not (= this$_4@@5 null))) (and (= Mask@2 (MapType1Store Mask@1 this$_4@@5 Wand_readonly_for_writeonlyout_1$ (real_2_U (+ (U_2_real (MapType1Select Mask@1 this$_4@@5 Wand_readonly_for_writeonlyout_1$)) wildcard@2)))) (state Heap@@26 Mask@2))) (and (and (> wildcard@3 NoPerm) (not (= this$_4@@5 null))) (and (= Mask@3 (MapType1Store Mask@2 this$_4@@5 Wand_readonly_for_writeonlythis_1$ (real_2_U (+ (U_2_real (MapType1Select Mask@2 this$_4@@5 Wand_readonly_for_writeonlythis_1$)) wildcard@3)))) (state Heap@@26 Mask@3)))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm Mask@3 this$_4@@5 Wand_readonly_for_writeonlylemma$)) (=> (HasDirectPerm Mask@3 this$_4@@5 Wand_readonly_for_writeonlylemma$) (and (=> (= (ControlFlow 0 12) 3) anon3_Then_correct) (=> (= (ControlFlow 0 12) 11) anon3_Else_correct))))))))))))))
