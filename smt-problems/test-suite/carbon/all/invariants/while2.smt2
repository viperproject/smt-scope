...
(assert  (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type x@@8) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon6_Else_correct true))
(let ((anon6_Then_correct  (=> (and (state Heap@@9 ZeroMask) (> (U_2_int (MapType0Select Heap@@9 x@@8 f_7)) 0)) (=> (and (and (state Heap@@9 ZeroMask) b_2@0) (and (state Heap@@9 ZeroMask) (= perm@1 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (and (and (=> (> perm@1 NoPerm) (not (= x@@8 null))) (= Mask@1 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) perm@1))))) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1))) (and (and (state Heap@@9 Mask@1) (= b_2@1  (not b_2@0))) (and (state Heap@@9 Mask@1) (= (ControlFlow 0 4) (- 0 3))))) (> (U_2_int (MapType0Select Heap@@9 x@@8 f_7)) 0))))))))
(let ((anon5_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@0 x@@8 f_7))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated)) (= perm@0 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= x@@8 null))) (=> (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) perm@0)))) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (HasDirectPerm Mask@0 x@@8 f_7)) (=> (HasDirectPerm Mask@0 x@@8 f_7) (=> (and (> (U_2_int (MapType0Select Heap@@9 x@@8 f_7)) 0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (> (U_2_int (MapType0Select Heap@@9 x@@8 f_7)) 0)) (=> (> (U_2_int (MapType0Select Heap@@9 x@@8 f_7)) 0) (and (and (=> (= (ControlFlow 0 7) 2) anon5_Then_correct) (=> (= (ControlFlow 0 7) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))))))))))))
