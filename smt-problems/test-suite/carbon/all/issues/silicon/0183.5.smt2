...
(declare-fun valid__Cell (T@U Real) T@U)
(declare-fun IsPredicateField (T@U) Bool)
(declare-fun PredicateType_valid__CellType () T@T)
(declare-fun FrameTypeType () T@T)
(declare-fun |valid__Cell#trigger| (T@U T@U) Bool)
(declare-fun |valid__Cell#everUsed| (T@U) Bool)
...
(declare-fun |valid__Cell#sm| (T@U Real) T@U)
...
(assert  (and (and (= (Ctor PredicateType_valid__CellType) 11) (= (Ctor FrameTypeType) 12)) (forall ((arg0@@23 T@U) (arg1@@9 Real) ) (! (= (type (valid__Cell arg0@@23 arg1@@9)) (FieldType PredicateType_valid__CellType FrameTypeType))
 :qid |funType:valid__Cell|
 :pattern ( (valid__Cell arg0@@23 arg1@@9))
))))
(assert (forall ((self T@U) (rd Real) ) (!  (=> (= (type self) RefType) (IsPredicateField (valid__Cell self rd)))
 :qid |stdinbpl.194:15|
 :skolemid |23|
 :pattern ( (valid__Cell self rd))
)))
(assert (forall ((Heap@@0 T@U) (self@@0 T@U) (rd@@0 Real) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type self@@0) RefType)) (|valid__Cell#everUsed| (valid__Cell self@@0 rd@@0)))
 :qid |stdinbpl.213:15|
 :skolemid |27|
 :pattern ( (|valid__Cell#trigger| Heap@@0 (valid__Cell self@@0 rd@@0)))
)))
...
(assert (forall ((self@@1 T@U) (rd@@1 Real) (self2 T@U) (rd2 Real) ) (!  (=> (and (and (= (type self@@1) RefType) (= (type self2) RefType)) (= (valid__Cell self@@1 rd@@1) (valid__Cell self2 rd2))) (and (= self@@1 self2) (= rd@@1 rd2)))
 :qid |stdinbpl.204:15|
 :skolemid |25|
 :pattern ( (valid__Cell self@@1 rd@@1) (valid__Cell self2 rd2))
)))
(assert (forall ((arg0@@26 T@U) (arg1@@10 Real) ) (! (= (type (|valid__Cell#sm| arg0@@26 arg1@@10)) (FieldType PredicateType_valid__CellType (MapType1Type RefType boolType)))
 :qid |funType:valid__Cell#sm|
 :pattern ( (|valid__Cell#sm| arg0@@26 arg1@@10))
)))
(assert (forall ((self@@2 T@U) (rd@@2 Real) (self2@@0 T@U) (rd2@@0 Real) ) (!  (=> (and (and (= (type self@@2) RefType) (= (type self2@@0) RefType)) (= (|valid__Cell#sm| self@@2 rd@@2) (|valid__Cell#sm| self2@@0 rd2@@0))) (and (= self@@2 self2@@0) (= rd@@2 rd2@@0)))
 :qid |stdinbpl.208:15|
 :skolemid |26|
...
(assert (forall ((self@@3 T@U) (rd@@3 Real) ) (!  (=> (= (type self@@3) RefType) (= (getPredWandId (valid__Cell self@@3 rd@@3)) 0))
 :qid |stdinbpl.198:15|
 :skolemid |24|
...
(assert (forall ((self@@4 T@U) (rd@@4 Real) ) (!  (=> (= (type self@@4) RefType) (= (PredicateMaskField (valid__Cell self@@4 rd@@4)) (|valid__Cell#sm| self@@4 rd@@4)))
 :qid |stdinbpl.190:15|
 :skolemid |22|
 :pattern ( (PredicateMaskField (valid__Cell self@@4 rd@@4)))
)))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon4_correct  (=> (= perm@0 (* rd@@5 rd@@5)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= self@@5 null))) (=> (and (and (= Mask@2 (MapType1Store Mask@1 self@@5 v_2 (real_2_U (+ (U_2_real (MapType1Select Mask@1 self@@5 v_2)) perm@0)))) (state Heap@1 Mask@2)) (and (state Heap@1 Mask@2) (state Heap@1 Mask@2))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@2 self@@5 v_2)) (=> (HasDirectPerm Mask@2 self@@5 v_2) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@2 self@@5 v_2)) (=> (HasDirectPerm Mask@2 self@@5 v_2) (=> (= (ControlFlow 0 2) (- 0 1)) (>= (U_2_int (MapType0Select Heap@1 self@@5 v_2)) (U_2_int (MapType0Select Heap@1 self@@5 v_2)))))))))))))))
(let ((anon6_Else_correct  (=> (HasDirectPerm Mask@1 null (valid__Cell self@@5 rd@@5)) (=> (and (= Heap@1 Heap@@10) (= (ControlFlow 0 7) 2)) anon4_correct))))
(let ((anon6_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (valid__Cell self@@5 rd@@5))) (= Heap@0 (MapType0Store Heap@@10 null (valid__Cell self@@5 rd@@5) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 6) 2))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (valid__Cell self@@5 rd@@5) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid__Cell self@@5 rd@@5))) rd@@5)))) (and (=> (= (ControlFlow 0 8) 6) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (= rd@@5 NoPerm) (= (ControlFlow 0 11) 8)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= rd@@5 NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= rd@@5 (U_2_real (MapType1Select Mask@0 null (valid__Cell self@@5 rd@@5))))) (=> (<= rd@@5 (U_2_real (MapType1Select Mask@0 null (valid__Cell self@@5 rd@@5)))) (=> (= (ControlFlow 0 9) 8) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@10 self@@5 $allocated)) (< NoPerm rd@@5)) (and (< rd@@5 FullPerm) (state Heap@@10 ZeroMask))) (and (=> (= (ControlFlow 0 12) (- 0 15)) (>= rd@@5 NoPerm)) (=> (>= rd@@5 NoPerm) (=> (= Mask@0 (MapType1Store ZeroMask null (valid__Cell self@@5 rd@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid__Cell self@@5 rd@@5))) rd@@5)))) (=> (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (> rd@@5 NoPerm)) (=> (> rd@@5 NoPerm) (=> (and (|valid__Cell#trigger| Heap@@10 (valid__Cell self@@5 rd@@5)) (= (MapType0Select Heap@@10 null (valid__Cell self@@5 rd@@5)) (ConditionalFrame rd@@5 (FrameFragment (MapType0Select Heap@@10 self@@5 v_2))))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (>= rd@@5 NoPerm)) (=> (>= rd@@5 NoPerm) (and (=> (= (ControlFlow 0 12) 9) anon5_Then_correct) (=> (= (ControlFlow 0 12) 11) anon5_Else_correct)))))))))))))))
