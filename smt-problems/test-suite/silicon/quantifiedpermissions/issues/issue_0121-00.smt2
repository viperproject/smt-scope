(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:17:37
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0121.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (forall ((y@8@01 $Ref)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0121.vpr@17@12@17@65-aux|)))
(assert (forall ((y@8@01 $Ref)) (!
  (and
    (or (Set_in y@8@01 xs@2@01) (not (Set_in y@8@01 xs@2@01)))
    (or
...
(assert (forall ((y@8@01 $Ref)) (!
  ...
  :pattern ((Set_in y@8@01 xs@2@01))
  :pattern ((Set_in ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.first ($Snap.second $t@4@01))) y@8@01) xs@2@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0121.vpr@17@12@17@65|)))
