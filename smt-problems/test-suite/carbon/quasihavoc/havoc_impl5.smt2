...
(declare-fun b2 () Bool)
(declare-fun b3 () Bool)
(assert  (and (and (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type x@@8) RefType)) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id foo)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon4_correct true))
(let ((anon3_correct  (=> (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (- (U_2_real (MapType1Select ZeroMask x@@8 f_7)) perm_temp_quasihavoc_@0)))) (=> (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@0) (state ExhaleHeap@0 Mask@0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (>= perm_temp_quasihavoc_@0 NoPerm)) (=> (>= perm_temp_quasihavoc_@0 NoPerm) (=> (and (and (and (=> (> perm_temp_quasihavoc_@0 NoPerm) (not (= x@@8 null))) (= Mask@1 (MapType1Store Mask@0 x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@8 f_7)) perm_temp_quasihavoc_@0))))) (and (state ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1))) (and (and (state ExhaleHeap@0 Mask@1) (= Mask@2 Mask@1)) (and (= Heap@0 ExhaleHeap@0) (= (ControlFlow 0 3) 1)))) anon4_correct)))))))
(let ((anon6_Else_correct  (=> (and (= perm_temp_quasihavoc_@0 NoPerm) (= (ControlFlow 0 7) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (not (= perm_temp_quasihavoc_@0 NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= perm_temp_quasihavoc_@0 (U_2_real (MapType1Select ZeroMask x@@8 f_7)))) (=> (<= perm_temp_quasihavoc_@0 (U_2_real (MapType1Select ZeroMask x@@8 f_7))) (=> (= (ControlFlow 0 5) 3) anon3_correct))))))
(let ((anon5_Then_correct  (=> (=> b1 (=> b2 b3)) (=> (and (= perm_temp_quasihavoc_@0 (U_2_real (MapType1Select ZeroMask x@@8 f_7))) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (>= perm_temp_quasihavoc_@0 NoPerm)) (=> (>= perm_temp_quasihavoc_@0 NoPerm) (and (=> (= (ControlFlow 0 8) 5) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct))))))))
(let ((anon5_Else_correct  (=> (and (and (not (=> b1 (=> b2 b3))) (= Mask@2 ZeroMask)) (and (= Heap@0 Heap@@9) (= (ControlFlow 0 2) 1))) anon4_correct)))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (and (=> (= (ControlFlow 0 10) 8) anon5_Then_correct) (=> (= (ControlFlow 0 10) 2) anon5_Else_correct)))))
