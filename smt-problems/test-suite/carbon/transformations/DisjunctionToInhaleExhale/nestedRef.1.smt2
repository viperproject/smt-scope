...
(assert (forall ((Heap@@2 T@U) (vari Bool) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (bool_2_U (|NonDet1#triggerStateless| vari))))
 :qid |stdinbpl.189:15|
 :skolemid |23|
 :pattern ( (|NonDet1'| Heap@@2 vari))
)))
...
(assert (forall ((Heap@@4 T@U) (Mask@@3 T@U) (vari@@0 Bool) ) (!  (=> (and (and (= (type Heap@@4) (MapType0Type RefType)) (= (type Mask@@3) (MapType1Type RefType realType))) (and (state Heap@@4 Mask@@3) (< AssumeFunctionsAbove 0))) (NonDet1 Heap@@4 vari@@0))
 :qid |stdinbpl.195:15|
 :skolemid |24|
 :pattern ( (state Heap@@4 Mask@@3) (NonDet1 Heap@@4 vari@@0))
)))
...
(assert (forall ((Heap@@7 T@U) (Mask@@7 T@U) (vari@@1 Bool) ) (!  (=> (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (state Heap@@7 Mask@@7)) (= (|NonDet1'| Heap@@7 vari@@1) (|NonDet1#frame| EmptyFrame vari@@1)))
 :qid |stdinbpl.202:15|
 :skolemid |25|
 :pattern ( (state Heap@@7 Mask@@7) (|NonDet1'| Heap@@7 vari@@1))
)))
(assert (forall ((Heap@@8 T@U) (vari@@2 Bool) ) (!  (=> (= (type Heap@@8) (MapType0Type RefType)) (and (= (NonDet1 Heap@@8 vari@@2) (|NonDet1'| Heap@@8 vari@@2)) (dummyFunction (bool_2_U (|NonDet1#triggerStateless| vari@@2)))))
 :qid |stdinbpl.185:15|
 :skolemid |22|
 :pattern ( (NonDet1 Heap@@8 vari@@2))
)))
...
(assert (not
 ...
 :qid |stdinbpl.270:15|
 :skolemid |26|
 :pattern ( (|NonDet1#frame| EmptyFrame k_1))
)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (state Heap@@13 ZeroMask) (state Heap@@13 ZeroMask))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
