...
(declare-fun i@@9 () Int)
(declare-fun xs () T@U)
(assert  (and (= (type Heap@@12) (MapType0Type RefType)) (= (type xs) (SeqType intType))))
...
(let ((anon0_correct  (=> (and (state Heap@@12 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (>= i@@9 0)) (=> (>= i@@9 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< i@@9 (|Seq#Length| xs))) (=> (< i@@9 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 3) 1) anon3_Then_correct) (=> (= (ControlFlow 0 3) 2) anon3_Else_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 6) 3) anon0_correct)))
