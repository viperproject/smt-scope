...
(assert  (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type x@@21) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
...
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Cell x@@21))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Cell x@@21)))) (=> (= (ControlFlow 0 5) 4) anon3_correct))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Seq#Equal| (|Seq#Empty| intType) (val@@7 Heap@@14 x@@21))) (=> (|Seq#Equal| (|Seq#Empty| intType) (val@@7 Heap@@14 x@@21)) (=> (and (state Heap@@14 Mask@0) (= (ControlFlow 0 2) (- 0 1))) false)))))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@14 x@@21 $allocated))) (and (= Mask@0 (MapType1Store ZeroMask null (Cell x@@21) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Cell x@@21))) FullPerm)))) (state Heap@@14 Mask@0))) (and (and (state Heap@@14 Mask@0) (= x@@21 null)) (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0)))) (and (and (=> (= (ControlFlow 0 8) 2) anon5_Else_correct) (=> (= (ControlFlow 0 8) 5) anon6_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct))))))
