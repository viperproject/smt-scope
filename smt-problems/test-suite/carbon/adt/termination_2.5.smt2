...
(let ((anon4_Else_correct  (=> (not (= (List_tag l@@19) 1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing (get_List_tail l@@19) l@@19)) (=> (decreasing (get_List_tail l@@19) l@@19) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded l@@19)) (=> (bounded l@@19) (=> (and (state Heap@@29 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (and (= (List_tag l@@19) 1) (= (ControlFlow 0 2) 1)) anon3_correct)))
(let ((anon0_correct  (=> (and (state Heap@@29 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 6) 2) anon4_Then_correct) (=> (= (ControlFlow 0 6) 3) anon4_Else_correct)))))
