...
(declare-fun |f#triggerStateless| (T@U) Int)
(declare-fun f_6 (T@U T@U) Int)
...
(declare-fun |f#frame| (T@U T@U) Int)
...
(assert (forall ((Heap@@2 T@U) (xs_1@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type xs_1@@0) listDomainTypeType)) (dummyFunction (int_2_U (|f#triggerStateless| xs_1@@0))))
 :qid |stdinbpl.309:15|
 :skolemid |33|
 :pattern ( (|f'| Heap@@2 xs_1@@0))
)))
(assert (forall ((Heap@@3 T@U) (Mask@@2 T@U) (xs_1@@1 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@3) (MapType0Type RefType)) (= (type Mask@@2) (MapType1Type RefType realType))) (= (type xs_1@@1) listDomainTypeType)) (and (state Heap@@3 Mask@@2) (< AssumeFunctionsAbove 0))) (>= (size xs_1@@1) 0)) (= (f_6 Heap@@3 xs_1@@1) (ite (> (size xs_1@@1) 0) (|f'| Heap@@3 (tail_Cons xs_1@@1)) 6)))
 :qid |stdinbpl.315:15|
 :skolemid |34|
 :pattern ( (state Heap@@3 Mask@@2) (f_6 Heap@@3 xs_1@@1))
)))
...
(assert (forall ((Heap@@5 T@U) (xs_1@@2 T@U) ) (!  (=> (and (= (type Heap@@5) (MapType0Type RefType)) (= (type xs_1@@2) listDomainTypeType)) (and (= (f_6 Heap@@5 xs_1@@2) (|f'| Heap@@5 xs_1@@2)) (dummyFunction (int_2_U (|f#triggerStateless| xs_1@@2)))))
 :qid |stdinbpl.305:15|
 :skolemid |32|
 :pattern ( (f_6 Heap@@5 xs_1@@2))
)))
...
(assert (forall ((xs_1@@3 T@U) ) (!  (=> (= (type xs_1@@3) listDomainTypeType) (= (is_Nil xs_1@@3)  (not (is_Cons xs_1@@3))))
 :qid |stdinbpl.216:15|
 :skolemid |22|
 :pattern ( (is_Nil xs_1@@3))
 :pattern ( (is_Cons xs_1@@3))
)))
...
(assert (forall ((xs_1@@4 T@U) ) (!  (=> (= (type xs_1@@4) listDomainTypeType) (= (= (vtype xs_1@@4) type_Nil) (is_Nil xs_1@@4)))
 :qid |stdinbpl.255:15|
 :skolemid |28|
 :pattern ( (vtype xs_1@@4))
 :pattern ( (is_Nil xs_1@@4))
)))
(assert (forall ((xs_1@@5 T@U) ) (!  (=> (= (type xs_1@@5) listDomainTypeType) (= (= (vtype xs_1@@5) type_Cons) (is_Cons xs_1@@5)))
 :qid |stdinbpl.261:15|
 :skolemid |29|
 :pattern ( (vtype xs_1@@5))
 :pattern ( (is_Cons xs_1@@5))
)))
...
(assert (forall ((xs_1@@6 T@U) ) (!  (=> (= (type xs_1@@6) listDomainTypeType) (or (= (vtype xs_1@@6) type_Nil) (= (vtype xs_1@@6) type_Cons)))
 :qid |stdinbpl.249:15|
 :skolemid |27|
 :pattern ( (vtype xs_1@@6))
)))
...
(assert (forall ((Heap@@10 T@U) (Mask@@10 T@U) (xs_1@@7 T@U) ) (!  (=> (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type xs_1@@7) listDomainTypeType)) (state Heap@@10 Mask@@10)) (= (|f'| Heap@@10 xs_1@@7) (|f#frame| EmptyFrame xs_1@@7)))
 :qid |stdinbpl.322:15|
 :skolemid |35|
 :pattern ( (state Heap@@10 Mask@@10) (|f'| Heap@@10 xs_1@@7))
)))
...
(assert (forall ((xs_1@@8 T@U) ) (!  (=> (= (type xs_1@@8) listDomainTypeType) (and (= (is_Nil xs_1@@8) (= (size xs_1@@8) 0)) (and (= (is_Cons xs_1@@8) (> (size xs_1@@8) 0)) (and (= (is_Cons xs_1@@8) (> (size xs_1@@8) (size (tail_Cons xs_1@@8)))) (= (is_Cons xs_1@@8) (= (size xs_1@@8) (+ 1 (size (tail_Cons xs_1@@8)))))))))
 :qid |stdinbpl.222:15|
 :skolemid |23|
 :pattern ( (is_Nil xs_1@@8))
 :pattern ( (size xs_1@@8))
 :pattern ( (is_Cons xs_1@@8))
 :pattern ( (size (tail_Cons xs_1@@8)))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(declare-fun xs_1@@9 () T@U)
(declare-fun Heap@@13 () T@U)
(assert  (and (= (type xs_1@@9) listDomainTypeType) (= (type Heap@@13) (MapType0Type RefType))))
(set-info :boogie-vc-id f_termination_proof)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (and (>= 0 (size xs_1@@9)) (= (ControlFlow 0 5) 1)) anon2_correct)))
(let ((anon3_Then_correct  (=> (> (size xs_1@@9) 0) (and (=> (= (ControlFlow 0 2) (- 0 4)) (decreasing (int_2_U (size (tail_Cons xs_1@@9))) (int_2_U (size xs_1@@9)))) (=> (decreasing (int_2_U (size (tail_Cons xs_1@@9))) (int_2_U (size xs_1@@9))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (bounded (int_2_U (size xs_1@@9)))) (=> (bounded (int_2_U (size xs_1@@9))) (=> (and (state Heap@@13 ZeroMask) (= (ControlFlow 0 2) 1)) anon2_correct))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (>= (size xs_1@@9) 0) (state Heap@@13 ZeroMask))) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))
