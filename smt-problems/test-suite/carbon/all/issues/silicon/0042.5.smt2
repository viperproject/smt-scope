...
(assert  (and (and (and (and (= (type Heap@@15) (MapType0Type RefType)) (= (type list@@10) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |valid#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (= (MapType0Select Heap@@15 list@@10 next) null) (=> (and (= Mask@2 Mask@0) (= (ControlFlow 0 4) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (not (= (MapType0Select Heap@@15 list@@10 next) null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 list@@10 next)) (=> (HasDirectPerm Mask@0 list@@10 next) (=> (and (and (= Mask@1 (MapType1Store Mask@0 null (valid (MapType0Select Heap@@15 list@@10 next)) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (valid (MapType0Select Heap@@15 list@@10 next)))) FullPerm)))) (state Heap@@15 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 2) 1))) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@15 list@@10 $allocated)) (not (= list@@10 null))) (and (= Mask@0 (MapType1Store ZeroMask list@@10 next (real_2_U (+ (U_2_real (MapType1Select ZeroMask list@@10 next)) FullPerm)))) (state Heap@@15 Mask@0))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@0 list@@10 next)) (=> (HasDirectPerm Mask@0 list@@10 next) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))))
