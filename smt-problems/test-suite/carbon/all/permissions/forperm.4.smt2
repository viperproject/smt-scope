...
(declare-fun y_15 () T@U)
(declare-fun Heap@@9 () T@U)
(declare-fun y_14 () T@U)
(declare-fun x@@8 () T@U)
(declare-fun perm@0 () Real)
(assert  (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type y_14) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type y_15) RefType)) (= (type x@@8) RefType)))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm Mask@0 y_15 g)) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm Mask@0 y_15 g) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm Mask@0 y_15 g)) (=> (HasDirectPerm Mask@0 y_15 g) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((y_3 T@U) ) (!  (=> (and (= (type y_3) RefType) (HasDirectPerm Mask@0 y_3 g)) (not (= y_3 null)))
 :qid |stdinbpl.515:15|
 :skolemid |31|
 :pattern ( (MapType1Select Mask@0 y_3 g))
 :pattern ( (MapType0Select Heap@@9 y_3 g))
)))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((y_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (HasDirectPerm Mask@0 y_1 f_7)) (not (= y_1 null)))
 :qid |stdinbpl.496:15|
 :skolemid |30|
 :pattern ( (MapType1Select Mask@0 y_1 f_7))
 :pattern ( (MapType0Select Heap@@9 y_1 f_7))
))) (=> (forall ((y_1@@0 T@U) ) (!  (=> (and (= (type y_1@@0) RefType) (HasDirectPerm Mask@0 y_1@@0 f_7)) (not (= y_1@@0 null)))
 :qid |stdinbpl.496:15|
 :skolemid |30|
