...
(assert  (and (= (type Heap@@15) (MapType0Type RefType)) (= (type this@@3) RefType)))
(set-info :boogie-vc-id |f#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) (U_2_bool (MapType0Select Heap@@15 this@@3 $allocated))) (=> (and (and (= AssumeFunctionsAbove 0) (<= NoPerm p_1@@3)) (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (>= p_1@@3 NoPerm)))))
