...
(declare-fun y@@7 () T@U)
(assert  (and (and (and (= (type xs) (SeqType RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type x@@22) RefType)) (= (type y@@7) RefType)))
(set-info :boogie-vc-id test11)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (not (and (<= 0 i@@6) (< i@@6 (|Seq#Length| xs)))) (= (ControlFlow 0 7) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (<= 0 i@@6) (< i@@6 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< i@@6 (|Seq#Length| xs))) (=> (< i@@6 (|Seq#Length| xs)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))))
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (|Seq#Length| xs)))) (and (<= 0 i_1_1) (< i_1_1 (|Seq#Length| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_1) (|Seq#Index| xs i_1_1))))
 :qid |stdinbpl.910:15|
 :skolemid |124|
)))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 x@@22 $allocated)) (U_2_bool (MapType0Select Heap@@9 y@@7 $allocated))) (and (|Seq#Equal| xs (|Seq#Append| (|Seq#Singleton| x@@22) (|Seq#Singleton| y@@7))) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 8) 2) anon5_Else_correct) (=> (= (ControlFlow 0 8) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct))))))
