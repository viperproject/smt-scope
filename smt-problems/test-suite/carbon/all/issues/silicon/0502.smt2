...
(assert  (and (and (and (and (and (and (and (and (= (type s@@3) (MapType2Type RefType boolType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv5 arg0@@43)) RefType)
 :qid |funType:invRecv5|
 :pattern ( (invRecv5 arg0@@43))
))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type r1) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type r2) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id foo4)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select s@@3 x_1))) (U_2_bool (MapType2Select s@@3 x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.820:15|
 :skolemid |106|
 :no-pattern (type x_1)
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (U_2_bool (MapType2Select s@@3 x_1@@0))) (U_2_bool (MapType2Select s@@3 x_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.820:15|
 :skolemid |106|
...
)) (=> (and (and (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select s@@3 x_1@@1)) (< NoPerm FullPerm)) (and (qpRange5 x_1@@1) (= (invRecv5 x_1@@1) x_1@@1))))
 :qid |stdinbpl.826:22|
 :skolemid |107|
 :pattern ( (MapType0Select Heap@@9 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
 :pattern ( (MapType2Select s@@3 x_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select s@@3 (invRecv5 o_3))) (< NoPerm FullPerm)) (qpRange5 o_3)) (= (invRecv5 o_3) o_3)))
 :qid |stdinbpl.830:22|
 :skolemid |108|
 :pattern ( (invRecv5 o_3))
))) (and (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (U_2_bool (MapType2Select s@@3 x_1@@2))) (not (= x_1@@2 null)))
 :qid |stdinbpl.836:22|
 :skolemid |109|
 :pattern ( (MapType0Select Heap@@9 x_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@2 f_7))
 :pattern ( (MapType2Select s@@3 x_1@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select s@@3 (invRecv5 o_3@@0))) (< NoPerm FullPerm)) (qpRange5 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv5 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select Mask@1 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select s@@3 (invRecv5 o_3@@0))) (< NoPerm FullPerm)) (qpRange5 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select Mask@1 o_3@@0 f_7))))))
 :qid |stdinbpl.842:22|
 :skolemid |110|
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= FullPerm (U_2_real (MapType1Select QPMask@0 r1 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 r1 f_7))) (=> (= Heap@0 (MapType0Store Heap@@9 r1 f_7 (int_2_U 3))) (=> (and (state Heap@0 QPMask@0) (= (ControlFlow 0 3) (- 0 2))) (not (= r1 r2)))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 r1 $allocated))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@9 r2 $allocated)) (not (= r1 null))) (and (= Mask@0 (MapType1Store ZeroMask r1 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r1 f_7)) FullPerm)))) (state Heap@@9 Mask@0))) (and (and (not (= r2 null)) (= Mask@1 (MapType1Store Mask@0 r2 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 r2 f_7)) FullPerm))))) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1)))) (and (=> (= (ControlFlow 0 6) 1) anon3_Then_correct) (=> (= (ControlFlow 0 6) 3) anon3_Else_correct))))))
