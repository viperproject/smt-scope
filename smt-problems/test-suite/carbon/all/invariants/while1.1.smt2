...
(assert  (and (and (and (and (= (type ExhaleHeap@0) (MapType0Type RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type x@@8) RefType)) (= (type Heap@@17) (MapType0Type RefType))))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (= perm@3 NoPerm) (= (ControlFlow 0 8) 5)) anon7_correct)))
(let ((anon12_Then_correct  (=> (not (= perm@3 NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= perm@3 (U_2_real (MapType1Select Mask@2 x@@8 f_8)))) (=> (<= perm@3 (U_2_real (MapType1Select Mask@2 x@@8 f_8))) (=> (= (ControlFlow 0 6) 5) anon7_correct))))))
(let ((anon11_Then_correct  (=> (and (state ExhaleHeap@0 ZeroMask) (= perm@2 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (=> (> perm@2 NoPerm) (not (= x@@8 null))) (=> (and (and (and (= Mask@2 (MapType1Store ZeroMask x@@8 f_8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_8)) perm@2)))) (state ExhaleHeap@0 Mask@2)) (and (state ExhaleHeap@0 Mask@2) b_2@0)) (and (and (state ExhaleHeap@0 Mask@2) (= b_2@1  (not b_2@0))) (and (state ExhaleHeap@0 Mask@2) (= perm@3 (/ (to_real 1) (to_real 2)))))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (>= perm@3 NoPerm)) (=> (>= perm@3 NoPerm) (and (=> (= (ControlFlow 0 9) 6) anon12_Then_correct) (=> (= (ControlFlow 0 9) 8) anon12_Else_correct)))))))))))
(let ((anon11_Else_correct  (=> (and (and (not b_2@0) (state ExhaleHeap@0 Mask@0)) (and (= perm@4 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 4) (- 0 3)))) (>= perm@4 NoPerm))))
(let ((anon10_Then_correct  (=> (and (= perm@1 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@1 NoPerm))))
(let ((anon2_correct  (=> (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_8 (real_2_U (- (U_2_real (MapType1Select ZeroMask x@@8 f_8)) perm@0)))) (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@0 Mask@0)) (and (and (=> (= (ControlFlow 0 12) 2) anon10_Then_correct) (=> (= (ControlFlow 0 12) 9) anon11_Then_correct)) (=> (= (ControlFlow 0 12) 4) anon11_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 15) 12)) anon2_correct)))
(let ((anon9_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= perm@0 (U_2_real (MapType1Select ZeroMask x@@8 f_8)))) (=> (<= perm@0 (U_2_real (MapType1Select ZeroMask x@@8 f_8))) (=> (= (ControlFlow 0 13) 12) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@17 x@@8 $allocated)) (= perm@0 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 16) 13) anon9_Then_correct) (=> (= (ControlFlow 0 16) 15) anon9_Else_correct))))))))
