...
(let ((anon12_correct  (=> (and (= UnfoldingMask@2 (MapType1Store QPMask@0 null (p3 r_9 i@@5) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (p3 r_9 i@@5))) FullPerm)))) (not (= r_9 null))) (=> (and (and (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 r_9 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 r_9 f_7)) FullPerm)))) (state Heap@@12 UnfoldingMask@3)) (and (> i@@5 0) (state Heap@@12 UnfoldingMask@3))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm UnfoldingMask@3 r_9 f_7)) (=> (HasDirectPerm UnfoldingMask@3 r_9 f_7) (=> (= Heap@0 (MapType0Store Heap@@12 null (|p3#sm| r_9 i@@5) (MapType1Store (MapType0Select Heap@@12 null (|p3#sm| r_9 i@@5)) r_9 f_7 (bool_2_U true)))) (=> (and (state Heap@0 QPMask@0) (= (ControlFlow 0 13) 11)) anon13_correct))))))))
(let ((anon27_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 17) 13)) anon12_correct)))
(let ((anon27_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p3 r_9 i@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p3 r_9 i@@5)))) (=> (= (ControlFlow 0 15) 13) anon12_correct))))))
(let ((anon26_Then_correct  (=> (U_2_bool (MapType2Select xs r_9)) (=> (and (|p3#trigger| Heap@@12 (p3 r_9 i@@5)) (= (MapType0Select Heap@@12 null (p3 r_9 i@@5)) (FrameFragment (MapType0Select Heap@@12 r_9 f_7)))) (and (=> (= (ControlFlow 0 18) 15) anon27_Then_correct) (=> (= (ControlFlow 0 18) 17) anon27_Else_correct))))))
(let ((anon26_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs r_9))) (= (ControlFlow 0 12) 11)) anon13_correct)))
...
(let ((anon6_correct  (=> (and (= UnfoldingMask@4 (MapType1Store QPMask@0 null (p3 r_8 i@@5) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (p3 r_8 i@@5))) FullPerm)))) (not (= r_8 null))) (=> (and (and (= UnfoldingMask@5 (MapType1Store UnfoldingMask@4 r_8 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@4 r_8 f_7)) FullPerm)))) (state Heap@@12 UnfoldingMask@5)) (and (> i@@5 0) (state Heap@@12 UnfoldingMask@5))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm UnfoldingMask@5 r_8 f_7)) (=> (HasDirectPerm UnfoldingMask@5 r_8 f_7) (=> (= Heap@1 (MapType0Store Heap@@12 null (|p3#sm| r_8 i@@5) (MapType1Store (MapType0Select Heap@@12 null (|p3#sm| r_8 i@@5)) r_8 f_7 (bool_2_U true)))) (=> (and (state Heap@1 QPMask@0) (= (ControlFlow 0 4) 2)) anon7_correct))))))))
(let ((anon24_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 4)) anon6_correct)))
(let ((anon24_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p3 r_8 i@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p3 r_8 i@@5)))) (=> (= (ControlFlow 0 6) 4) anon6_correct))))))
(let ((anon23_Then_correct  (=> (U_2_bool (MapType2Select xs r_8)) (=> (and (|p3#trigger| Heap@@12 (p3 r_8 i@@5)) (= (MapType0Select Heap@@12 null (p3 r_8 i@@5)) (FrameFragment (MapType0Select Heap@@12 r_8 f_7)))) (and (=> (= (ControlFlow 0 9) 6) anon24_Then_correct) (=> (= (ControlFlow 0 9) 8) anon24_Else_correct))))))
(let ((anon23_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs r_8))) (= (ControlFlow 0 3) 2)) anon7_correct)))
...
)) (=> (forall ((r_1@@1 T@U) ) (!  (=> (= (type r_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs r_1@@1)) (< NoPerm FullPerm)) (and (= (invRecv3 r_1@@1 i@@5) r_1@@1) (qpRange3 r_1@@1 i@@5))))
 :qid |stdinbpl.931:22|
 :skolemid |116|
...
)) (=> (and (forall ((r_2_1 T@U) (i_1_1 Int) ) (!  (=> (= (type r_2_1) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv3 r_2_1 i_1_1))) (< NoPerm FullPerm)) (qpRange3 r_2_1 i_1_1)) (and (= (invRecv3 r_2_1 i_1_1) r_2_1) (= i@@5 i_1_1))))
 :qid |stdinbpl.935:22|
 :skolemid |117|
 :pattern ( (invRecv3 r_2_1 i_1_1))
)) (forall ((r_2_1@@0 T@U) (i_1_1@@0 Int) ) (!  (=> (= (type r_2_1@@0) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv3 r_2_1@@0 i_1_1@@0))) (< NoPerm FullPerm)) (qpRange3 r_2_1@@0 i_1_1@@0)) (and (=> (< NoPerm FullPerm) (and (= (invRecv3 r_2_1@@0 i_1_1@@0) r_2_1@@0) (= i@@5 i_1_1@@0))) (= (U_2_real (MapType1Select QPMask@0 null (p3 r_2_1@@0 i_1_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (p3 r_2_1@@0 i_1_1@@0))) FullPerm)))))
 :qid |stdinbpl.941:22|
 :skolemid |118|
...
)) (forall ((r_2_1@@1 T@U) (i_1_1@@1 Int) ) (!  (=> (and (= (type r_2_1@@1) RefType) (not (and (and (U_2_bool (MapType2Select xs (invRecv3 r_2_1@@1 i_1_1@@1))) (< NoPerm FullPerm)) (qpRange3 r_2_1@@1 i_1_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (p3 r_2_1@@1 i_1_1@@1))) (U_2_real (MapType1Select ZeroMask null (p3 r_2_1@@1 i_1_1@@1)))))
 :qid |stdinbpl.951:22|
 :skolemid |120|
