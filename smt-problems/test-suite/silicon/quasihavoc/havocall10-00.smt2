(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:26:52
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quasihavoc/havocall10.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(check-sat)
; unknown
(assert (p%trigger ($Snap.combine ($Snap.first $t@2@01) $t@3@01) x@1@01))
(set-option :timeout 0)
(push) ; 4
(set-option :timeout 10)
(assert (not false))
...
(declare-fun inv@6@01 ($Ref $Perm $Ref $Perm) $Ref)
(declare-fun img@7@01 ($Ref $Perm $Ref $Perm) Bool)
; Definitional axioms for havocall inverse functions
(assert (forall ((z@5@01 $Ref)) (!
  (and
    (= (inv@6@01 z@5@01 $Perm.Write z@5@01 $Perm.Write) z@5@01)
    (img@7@01 z@5@01 $Perm.Write z@5@01 $Perm.Write))
  :pattern ((inv@6@01 z@5@01 $Perm.Write z@5@01 $Perm.Write))
  :pattern ((img@7@01 z@5@01 $Perm.Write z@5@01 $Perm.Write))
  :qid |wand@0-invOfFct|)))
(assert (forall ((x0 $Ref) (x1 $Perm) (x2 $Ref) (x3 $Perm)) (!
  (=>
    (img@7@01 x0 x1 x2 x3)
    (and
      (= (inv@6@01 x0 x1 x2 x3) x0)
      (= $Perm.Write x1)
      (= (inv@6@01 x0 x1 x2 x3) x2)
      (= $Perm.Write x3)))
  :pattern ((inv@6@01 x0 x1 x2 x3))
  :qid |wand@0-fctOfInv|)))
(declare-const mwsf@8@01 $MWSF)
; [exec]
; inhale acc(x.f2, write)
...
(assert (=
  (MWSF_apply (ite
    (img@7@01 x@1@01 $Perm.Write x@1@01 $Perm.Write)
    mwsf@8@01
    mwsf@4@01) ($SortWrappers.IntTo$Snap $t@9@01))
  ($Snap.combine
...
(assert (p%trigger (MWSF_apply (ite
  (img@7@01 x@1@01 $Perm.Write x@1@01 $Perm.Write)
  mwsf@8@01
  mwsf@4@01) ($SortWrappers.IntTo$Snap $t@9@01)) x@1@01))
; [exec]
; assert x.f1 == 3
; [eval] x.f1 == 3
(set-option :timeout 0)
