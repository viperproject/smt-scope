...
(declare-fun l$0_4 () T@U)
(declare-fun l$0_2_1 () T@U)
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type freshObj@0) RefType) (= (type l$0_2_1) RefType)) (= (type Heap@2) (MapType0Type RefType))) (= (type l$0_4) RefType)) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type arg_b@0) (MapType2Type RefType boolType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@6) (MapType0Type RefType))) (= (type newPMask@1) (MapType1Type RefType boolType))) (= (type Heap@7) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@47 T@U) (arg1@@25 T@U) ) (! (= (type (CombineFrames arg0@@47 arg1@@25)) FrameTypeType)
...
))) (= (type Heap@@10) (MapType0Type RefType))) (= (type l_2) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@49 T@U) ) (! (= (type (invRecv9 arg0@@49)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 30) (let ((anon14_correct  (=> (and (= Mask@3 (MapType1Store Mask@2 null (uf_bank arg_b@0) (real_2_U (- (U_2_real (MapType1Select Mask@2 null (uf_bank arg_b@0))) FullPerm)))) (= (ControlFlow 0 12) (- 0 13))) (U_2_bool (MapType2Select arg_b@0 freshObj@0)))))
(let ((anon21_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 12)) anon14_correct)))
(let ((anon21_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null (uf_bank arg_b@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 null (uf_bank arg_b@0)))) (=> (= (ControlFlow 0 14) 12) anon14_correct))))))
(let ((anon12_correct  (=> (forall ((o_8 T@U) (f_11 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_11))))
(let ((A@@12 (FieldTypeInv0 (type f_11))))
 (=> (and (and (= (type o_8) RefType) (= (type f_11) (FieldType A@@12 B@@11))) (U_2_bool (MapType1Select (MapType0Select Heap@5 null (|uf_bank#sm| (|Set#Singleton| freshObj@0))) o_8 f_11))) (U_2_bool (MapType1Select newPMask@0 o_8 f_11)))))
 :qid |stdinbpl.1236:27|
 :skolemid |168|
 :pattern ( (MapType1Select newPMask@0 o_8 f_11))
)) (=> (and (and (and (forall ((l$0_6 T@U) ) (!  (=> (and (= (type l$0_6) RefType) (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0_6))) (U_2_bool (MapType1Select newPMask@0 l$0_6 parent)))
 :qid |stdinbpl.1240:20|
 :skolemid |169|
 :no-pattern (type l$0_6)
 :no-pattern (U_2_int l$0_6)
 :no-pattern (U_2_bool l$0_6)
)) (= Heap@6 (MapType0Store Heap@5 null (|uf_bank#sm| (|Set#Singleton| freshObj@0)) newPMask@0))) (and (forall ((o_9 T@U) (f_12 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_12))))
(let ((A@@13 (FieldTypeInv0 (type f_12))))
 (=> (and (and (= (type o_9) RefType) (= (type f_12) (FieldType A@@13 B@@12))) (U_2_bool (MapType1Select (MapType0Select Heap@6 null (|uf_bank#sm| (|Set#Singleton| freshObj@0))) o_9 f_12))) (U_2_bool (MapType1Select newPMask@1 o_9 f_12)))))
 :qid |stdinbpl.1247:27|
 :skolemid |170|
 :pattern ( (MapType1Select newPMask@1 o_9 f_12))
)) (forall ((l$0_7 T@U) ) (!  (=> (and (= (type l$0_7) RefType) (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0_7))) (U_2_bool (MapType1Select newPMask@1 l$0_7 rank)))
 :qid |stdinbpl.1251:20|
 :skolemid |171|
 :no-pattern (type l$0_7)
 :no-pattern (U_2_int l$0_7)
 :no-pattern (U_2_bool l$0_7)
)))) (and (and (= Heap@7 (MapType0Store Heap@6 null (|uf_bank#sm| (|Set#Singleton| freshObj@0)) newPMask@1)) (state Heap@7 Mask@2)) (and (state Heap@7 Mask@2) (= arg_b@0 (|Set#Singleton| freshObj@0))))) (and (=> (= (ControlFlow 0 17) 14) anon21_Then_correct) (=> (= (ControlFlow 0 17) 16) anon21_Else_correct))))))
(let ((anon20_Else_correct  (=> (HasDirectPerm Mask@2 null (uf_bank (|Set#Singleton| freshObj@0))) (=> (and (= Heap@5 Heap@2) (= (ControlFlow 0 19) 17)) anon12_correct))))
(let ((anon20_Then_correct  (=> (not (HasDirectPerm Mask@2 null (uf_bank (|Set#Singleton| freshObj@0)))) (=> (and (and (= Heap@3 (MapType0Store Heap@2 null (|uf_bank#sm| (|Set#Singleton| freshObj@0)) ZeroPMask)) (= Heap@4 (MapType0Store Heap@3 null (uf_bank (|Set#Singleton| freshObj@0)) freshVersion@0))) (and (= Heap@5 Heap@4) (= (ControlFlow 0 18) 17))) anon12_correct))))
(let ((anon18_Else_correct  (=> (and (forall ((l$0_5_1_1 T@U) ) (!  (=> (= (type l$0_5_1_1) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0_5_1_1)) (not (= (MapType0Select Heap@2 l$0_5_1_1 parent) null))) (and (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) (MapType0Select Heap@2 l$0_5_1_1 parent))) (> (U_2_int (MapType0Select Heap@2 (MapType0Select Heap@2 l$0_5_1_1 parent) rank)) (U_2_int (MapType0Select Heap@2 l$0_5_1_1 rank))))))
 :qid |stdinbpl.1219:20|
 :skolemid |167|
 :pattern ( (MapType0Select Heap@2 l$0_5_1_1 parent))
)) (= Mask@2 (MapType1Store QPMask@1 null (uf_bank (|Set#Singleton| freshObj@0)) (real_2_U (+ (U_2_real (MapType1Select QPMask@1 null (uf_bank (|Set#Singleton| freshObj@0)))) FullPerm))))) (=> (and (and (state Heap@2 Mask@2) (state Heap@2 Mask@2)) (and (|uf_bank#trigger| Heap@2 (uf_bank (|Set#Singleton| freshObj@0))) (= (MapType0Select Heap@2 null (uf_bank (|Set#Singleton| freshObj@0))) (CombineFrames (FrameFragment (int_2_U (|uf_bank#condqp1| Heap@2 (|Set#Singleton| freshObj@0)))) (FrameFragment (int_2_U (|uf_bank#condqp2| Heap@2 (|Set#Singleton| freshObj@0)))))))) (and (=> (= (ControlFlow 0 20) 18) anon20_Then_correct) (=> (= (ControlFlow 0 20) 19) anon20_Else_correct))))))
(let ((anon9_correct true))
(let ((anon19_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0_4)) (not (= (MapType0Select Heap@2 l$0_4 parent) null)))) (= (ControlFlow 0 10) 6)) anon9_correct)))
(let ((anon19_Then_correct  (=> (and (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0_4)) (not (= (MapType0Select Heap@2 l$0_4 parent) null))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) (MapType0Select Heap@2 l$0_4 parent)))) (=> (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) (MapType0Select Heap@2 l$0_4 parent))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (> (U_2_int (MapType0Select Heap@2 (MapType0Select Heap@2 l$0_4 parent) rank)) (U_2_int (MapType0Select Heap@2 l$0_4 rank)))) (=> (> (U_2_int (MapType0Select Heap@2 (MapType0Select Heap@2 l$0_4 parent) rank)) (U_2_int (MapType0Select Heap@2 l$0_4 rank))) (=> (= (ControlFlow 0 7) 6) anon9_correct))))))))
(let ((anon16_Else_correct  (=> (forall ((l$0_3_1 T@U) ) (!  (=> (and (= (type l$0_3_1) RefType) (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0_3_1))) (<= 0 (U_2_int (MapType0Select Heap@2 l$0_3_1 rank))))
 :qid |stdinbpl.1206:20|
 :skolemid |166|
 :pattern ( (MapType2Select (|Set#Singleton| freshObj@0) l$0_3_1))
...
(let ((anon17_Else_correct  (=> (and (not (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0_2_1))) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon17_Then_correct  (=> (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0_2_1)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= 0 (U_2_int (MapType0Select Heap@2 l$0_2_1 rank)))) (=> (<= 0 (U_2_int (MapType0Select Heap@2 l$0_2_1 rank))) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon15_Else_correct  (=> (U_2_bool (MapType0Select Heap@@10 l_2 $allocated)) (=> (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@10 freshObj@0 $allocated)))) (=> (and (and (= Heap@0 (MapType0Store Heap@@10 freshObj@0 $allocated (bool_2_U true))) (= Mask@0 (MapType1Store ZeroMask freshObj@0 parent (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 parent)) FullPerm))))) (and (= Mask@1 (MapType1Store Mask@0 freshObj@0 rank (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@0 rank)) FullPerm)))) (state Heap@0 Mask@1))) (and (=> (= (ControlFlow 0 22) (- 0 28)) (= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 parent)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 parent))) (=> (and (= Heap@1 (MapType0Store Heap@0 freshObj@0 parent null)) (state Heap@1 Mask@1)) (and (=> (= (ControlFlow 0 22) (- 0 27)) (= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 rank)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 rank))) (=> (and (= Heap@2 (MapType0Store Heap@1 freshObj@0 rank (int_2_U 0))) (state Heap@2 Mask@1)) (and (=> (= (ControlFlow 0 22) (- 0 26)) (forall ((l$0 T@U) (l$0_2 T@U) ) (!  (=> (and (= (type l$0) RefType) (= (type l$0_2) RefType)) (=> (and (and (and (and (not (= l$0 l$0_2)) (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0))) (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0_2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= l$0 l$0_2))))
 :qid |stdinbpl.1124:17|
 :skolemid |154|
 :pattern ( (neverTriggered9 l$0) (neverTriggered9 l$0_2))
))) (=> (forall ((l$0@@0 T@U) (l$0_2@@0 T@U) ) (!  (=> (and (= (type l$0@@0) RefType) (= (type l$0_2@@0) RefType)) (=> (and (and (and (and (not (= l$0@@0 l$0_2@@0)) (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0@@0))) (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0_2@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= l$0@@0 l$0_2@@0))))
 :qid |stdinbpl.1124:17|
 :skolemid |154|
 :pattern ( (neverTriggered9 l$0@@0) (neverTriggered9 l$0_2@@0))
)) (and (=> (= (ControlFlow 0 22) (- 0 25)) (forall ((l$0@@1 T@U) ) (!  (=> (and (= (type l$0@@1) RefType) (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0@@1))) (>= (U_2_real (MapType1Select Mask@1 l$0@@1 parent)) FullPerm))
 :qid |stdinbpl.1131:17|
 :skolemid |155|
 :pattern ( (MapType0Select Heap@2 l$0@@1 parent))
 :pattern ( (MapType1Select QPMask@0 l$0@@1 parent))
 :pattern ( (MapType2Select (|Set#Singleton| freshObj@0) l$0@@1))
))) (=> (forall ((l$0@@2 T@U) ) (!  (=> (and (= (type l$0@@2) RefType) (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0@@2))) (>= (U_2_real (MapType1Select Mask@1 l$0@@2 parent)) FullPerm))
 :qid |stdinbpl.1131:17|
 :skolemid |155|
 :pattern ( (MapType0Select Heap@2 l$0@@2 parent))
 :pattern ( (MapType1Select QPMask@0 l$0@@2 parent))
 :pattern ( (MapType2Select (|Set#Singleton| freshObj@0) l$0@@2))
)) (=> (and (and (forall ((l$0@@3 T@U) ) (!  (=> (= (type l$0@@3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0@@3)) (< NoPerm FullPerm)) (and (qpRange9 l$0@@3) (= (invRecv9 l$0@@3) l$0@@3))))
 :qid |stdinbpl.1137:22|
 :skolemid |156|
 :pattern ( (MapType0Select Heap@2 l$0@@3 parent))
 :pattern ( (MapType1Select QPMask@0 l$0@@3 parent))
 :pattern ( (MapType2Select (|Set#Singleton| freshObj@0) l$0@@3))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) (invRecv9 o_3))) (and (< NoPerm FullPerm) (qpRange9 o_3))) (= (invRecv9 o_3) o_3)))
 :qid |stdinbpl.1141:22|
 :skolemid |157|
 :pattern ( (invRecv9 o_3))
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) (invRecv9 o_3@@0))) (and (< NoPerm FullPerm) (qpRange9 o_3@@0))) (and (= (invRecv9 o_3@@0) o_3@@0) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 parent)) (- (U_2_real (MapType1Select Mask@1 o_3@@0 parent)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) (invRecv9 o_3@@0))) (and (< NoPerm FullPerm) (qpRange9 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 parent)) (U_2_real (MapType1Select Mask@1 o_3@@0 parent))))))
 :qid |stdinbpl.1147:22|
 :skolemid |158|
 :pattern ( (MapType1Select QPMask@0 o_3@@0 parent))
)) (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@13 (FieldTypeInv1 (type f_5))))
(let ((A@@14 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@14 B@@13))) (not (= f_5 parent))) (= (U_2_real (MapType1Select Mask@1 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.1153:29|
 :skolemid |159|
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
)))) (and (=> (= (ControlFlow 0 22) (- 0 24)) (forall ((l$0_1 T@U) (l$0_1_1 T@U) ) (!  (=> (and (= (type l$0_1) RefType) (= (type l$0_1_1) RefType)) (=> (and (and (and (and (not (= l$0_1 l$0_1_1)) (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0_1))) (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= l$0_1 l$0_1_1))))
 :qid |stdinbpl.1165:17|
 :skolemid |160|
 :pattern ( (neverTriggered10 l$0_1) (neverTriggered10 l$0_1_1))
))) (=> (forall ((l$0_1@@0 T@U) (l$0_1_1@@0 T@U) ) (!  (=> (and (= (type l$0_1@@0) RefType) (= (type l$0_1_1@@0) RefType)) (=> (and (and (and (and (not (= l$0_1@@0 l$0_1_1@@0)) (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0_1@@0))) (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= l$0_1@@0 l$0_1_1@@0))))
 :qid |stdinbpl.1165:17|
 :skolemid |160|
 :pattern ( (neverTriggered10 l$0_1@@0) (neverTriggered10 l$0_1_1@@0))
)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (forall ((l$0_1@@1 T@U) ) (!  (=> (and (= (type l$0_1@@1) RefType) (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0_1@@1))) (>= (U_2_real (MapType1Select QPMask@0 l$0_1@@1 rank)) FullPerm))
 :qid |stdinbpl.1172:17|
 :skolemid |161|
 :pattern ( (MapType0Select Heap@2 l$0_1@@1 rank))
 :pattern ( (MapType1Select QPMask@1 l$0_1@@1 rank))
 :pattern ( (MapType2Select (|Set#Singleton| freshObj@0) l$0_1@@1))
))) (=> (forall ((l$0_1@@2 T@U) ) (!  (=> (and (= (type l$0_1@@2) RefType) (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0_1@@2))) (>= (U_2_real (MapType1Select QPMask@0 l$0_1@@2 rank)) FullPerm))
 :qid |stdinbpl.1172:17|
 :skolemid |161|
 :pattern ( (MapType0Select Heap@2 l$0_1@@2 rank))
 :pattern ( (MapType1Select QPMask@1 l$0_1@@2 rank))
 :pattern ( (MapType2Select (|Set#Singleton| freshObj@0) l$0_1@@2))
)) (=> (and (and (forall ((l$0_1@@3 T@U) ) (!  (=> (= (type l$0_1@@3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) l$0_1@@3)) (< NoPerm FullPerm)) (and (qpRange10 l$0_1@@3) (= (invRecv10 l$0_1@@3) l$0_1@@3))))
 :qid |stdinbpl.1178:22|
 :skolemid |162|
 :pattern ( (MapType0Select Heap@2 l$0_1@@3 rank))
 :pattern ( (MapType1Select QPMask@1 l$0_1@@3 rank))
 :pattern ( (MapType2Select (|Set#Singleton| freshObj@0) l$0_1@@3))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) (invRecv10 o_3@@2))) (and (< NoPerm FullPerm) (qpRange10 o_3@@2))) (= (invRecv10 o_3@@2) o_3@@2)))
 :qid |stdinbpl.1182:22|
 :skolemid |163|
 :pattern ( (invRecv10 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) (invRecv10 o_3@@3))) (and (< NoPerm FullPerm) (qpRange10 o_3@@3))) (and (= (invRecv10 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 rank)) (- (U_2_real (MapType1Select QPMask@0 o_3@@3 rank)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select (|Set#Singleton| freshObj@0) (invRecv10 o_3@@3))) (and (< NoPerm FullPerm) (qpRange10 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 rank)) (U_2_real (MapType1Select QPMask@0 o_3@@3 rank))))))
 :qid |stdinbpl.1188:22|
 :skolemid |164|
 :pattern ( (MapType1Select QPMask@1 o_3@@3 rank))
)) (forall ((o_3@@4 T@U) (f_5@@0 T@U) ) (! (let ((B@@14 (FieldTypeInv1 (type f_5@@0))))
(let ((A@@15 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@15 B@@14))) (not (= f_5@@0 rank))) (= (U_2_real (MapType1Select QPMask@0 o_3@@4 f_5@@0)) (U_2_real (MapType1Select QPMask@1 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.1194:29|
 :skolemid |165|
...
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (and (=> (= (ControlFlow 0 29) 1) anon15_Then_correct) (=> (= (ControlFlow 0 29) 22) anon15_Else_correct)))))
