...
(declare-fun xs () T@U)
(declare-fun j_2 () Int)
(declare-fun xs_i@0 () T@U)
(declare-fun Heap@@9 () T@U)
(declare-fun i@@6 () Int)
(declare-fun j@@5 () Int)
(declare-fun i0 () Int)
(declare-fun j0 () Int)
(assert  (and (and (= (type xs) (SeqType (SeqType RefType))) (= (type xs_i@0) (SeqType RefType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 45) (let ((anon17_correct true))
(let ((anon30_Else_correct  (=> (and (not (and (and (<= 0 i_2) (< i_2 (|Seq#Length| xs))) (and (<= 0 j_2) (< j_2 (|Seq#Length| (|Seq#Index| xs i_2)))))) (= (ControlFlow 0 38) 32)) anon17_correct)))
(let ((anon30_Then_correct  (=> (and (and (<= 0 i_2) (< i_2 (|Seq#Length| xs))) (and (<= 0 j_2) (< j_2 (|Seq#Length| (|Seq#Index| xs i_2))))) (and (=> (= (ControlFlow 0 33) (- 0 37)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 33) (- 0 36)) (< i_2 (|Seq#Length| xs))) (=> (< i_2 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 33) (- 0 35)) (>= j_2 0)) (=> (>= j_2 0) (and (=> (= (ControlFlow 0 33) (- 0 34)) (< j_2 (|Seq#Length| (|Seq#Index| xs i_2)))) (=> (< j_2 (|Seq#Length| (|Seq#Index| xs i_2))) (=> (= (ControlFlow 0 33) 32) anon17_correct))))))))))))
(let ((anon29_Else_correct  (=> (not (and (<= 0 i_2) (< i_2 (|Seq#Length| xs)))) (and (=> (= (ControlFlow 0 42) 33) anon30_Then_correct) (=> (= (ControlFlow 0 42) 38) anon30_Else_correct)))))
(let ((anon29_Then_correct  (=> (and (<= 0 i_2) (< i_2 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 39) (- 0 41)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 39) (- 0 40)) (< i_2 (|Seq#Length| xs))) (=> (< i_2 (|Seq#Length| xs)) (=> (= xs_i@0 (|Seq#Index| xs i_2)) (and (=> (= (ControlFlow 0 39) 33) anon30_Then_correct) (=> (= (ControlFlow 0 39) 38) anon30_Else_correct))))))))))
(let ((anon28_Else_correct  (=> (= (ControlFlow 0 31) (- 0 30)) (forall ((i_3 Int) (j_3 Int) (i_3_1 Int) (j_3_1 Int) ) (!  (=> (and (and (and (and (and (not (= i_3 i_3_1)) (not (= j_3 j_3_1))) (and (and (<= 0 i_3) (< i_3 (|Seq#Length| xs))) (and (<= 0 j_3) (< j_3 (|Seq#Length| (|Seq#Index| xs i_3)))))) (and (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length| xs))) (and (<= 0 j_3_1) (< j_3_1 (|Seq#Length| (|Seq#Index| xs i_3_1)))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (|Seq#Index| xs i_3) j_3) (|Seq#Index| (|Seq#Index| xs i_3_1) j_3_1))))
 :qid |stdinbpl.658:15|
 :skolemid |59|
)))))
(let ((anon19_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) (i0_1 Int) (j0_1 Int) ) (!  (=> (and (<= 0 i_1) (and (< i_1 (|Seq#Length| xs)) (and (<= 0 j_1) (and (< j_1 (|Seq#Length| (|Seq#Index| xs i_1))) (and (<= 0 i0_1) (and (< i0_1 (|Seq#Length| xs)) (and (<= 0 j0_1) (and (< j0_1 (|Seq#Length| (|Seq#Index| xs i0_1))) (or (not (= i_1 i0_1)) (not (= j_1 j0_1))))))))))) (not (= (|Seq#Index| (|Seq#Index| xs i_1) j_1) (|Seq#Index| (|Seq#Index| xs i0_1) j0_1))))
 :qid |stdinbpl.629:20|
 :skolemid |58|
 :pattern ( (|Seq#Length| (|Seq#Index| xs i_1)) (|Seq#Length| (|Seq#Index| xs i0_1)) (|Seq#Index| (|Seq#Index| xs i_1) j_1) (|Seq#Index| (|Seq#Index| xs i0_1) j0_1))
 :pattern ( (|Seq#Length| (|Seq#Index| xs i_1)) (|Seq#Index| (|Seq#Index| xs i_1) j_1) (|Seq#Index| (|Seq#Index| xs i0_1) j0_1))
 :pattern ( (|Seq#Length| (|Seq#Index| xs i0_1)) (|Seq#Index| (|Seq#Index| xs i_1) j_1) (|Seq#Index| (|Seq#Index| xs i0_1) j0_1))
 :pattern ( (|Seq#Index| (|Seq#Index| xs i_1) j_1) (|Seq#Index| (|Seq#Index| xs i0_1) j0_1))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 43) 31) anon28_Else_correct) (=> (= (ControlFlow 0 43) 39) anon29_Then_correct)) (=> (= (ControlFlow 0 43) 42) anon29_Else_correct)))))
(let ((anon11_correct true))
(let ((anon27_Else_correct  (=> (and (not (and (<= 0 i@@6) (and (< i@@6 (|Seq#Length| xs)) (and (<= 0 j@@5) (and (< j@@5 (|Seq#Length| (|Seq#Index| xs i@@6))) (and (<= 0 i0) (and (< i0 (|Seq#Length| xs)) (and (<= 0 j0) (and (< j0 (|Seq#Length| (|Seq#Index| xs i0))) (or (not (= i@@6 i0)) (not (= j@@5 j0)))))))))))) (= (ControlFlow 0 11) 1)) anon11_correct)))
(let ((anon27_Then_correct  (=> (and (<= 0 i@@6) (and (< i@@6 (|Seq#Length| xs)) (and (<= 0 j@@5) (and (< j@@5 (|Seq#Length| (|Seq#Index| xs i@@6))) (and (<= 0 i0) (and (< i0 (|Seq#Length| xs)) (and (<= 0 j0) (and (< j0 (|Seq#Length| (|Seq#Index| xs i0))) (or (not (= i@@6 i0)) (not (= j@@5 j0))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 2) (- 0 9)) (< i@@6 (|Seq#Length| xs))) (=> (< i@@6 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 2) (- 0 7)) (< j@@5 (|Seq#Length| (|Seq#Index| xs i@@6)))) (=> (< j@@5 (|Seq#Length| (|Seq#Index| xs i@@6))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i0 0)) (=> (>= i0 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i0 (|Seq#Length| xs))) (=> (< i0 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j0 0)) (=> (>= j0 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j0 (|Seq#Length| (|Seq#Index| xs i0)))) (=> (< j0 (|Seq#Length| (|Seq#Index| xs i0))) (=> (= (ControlFlow 0 2) 1) anon11_correct))))))))))))))))))))
(let ((anon26_Else_correct  (=> (< j0 0) (and (=> (= (ControlFlow 0 21) 2) anon27_Then_correct) (=> (= (ControlFlow 0 21) 11) anon27_Else_correct)))))
(let ((anon26_Then_correct  (=> (<= 0 j0) (and (=> (= (ControlFlow 0 18) (- 0 20)) (>= i0 0)) (=> (>= i0 0) (and (=> (= (ControlFlow 0 18) (- 0 19)) (< i0 (|Seq#Length| xs))) (=> (< i0 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 18) 2) anon27_Then_correct) (=> (= (ControlFlow 0 18) 11) anon27_Else_correct)))))))))
(let ((anon25_Then_correct  (=> (< i0 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 22) 18) anon26_Then_correct) (=> (= (ControlFlow 0 22) 21) anon26_Else_correct)))))
(let ((anon25_Else_correct  (=> (<= (|Seq#Length| xs) i0) (and (=> (= (ControlFlow 0 17) 2) anon27_Then_correct) (=> (= (ControlFlow 0 17) 11) anon27_Else_correct)))))
(let ((anon24_Then_correct  (=> (<= 0 i0) (and (=> (= (ControlFlow 0 23) 22) anon25_Then_correct) (=> (= (ControlFlow 0 23) 17) anon25_Else_correct)))))
(let ((anon24_Else_correct  (=> (< i0 0) (and (=> (= (ControlFlow 0 16) 2) anon27_Then_correct) (=> (= (ControlFlow 0 16) 11) anon27_Else_correct)))))
(let ((anon23_Then_correct  (=> (< j@@5 (|Seq#Length| (|Seq#Index| xs i@@6))) (and (=> (= (ControlFlow 0 24) 23) anon24_Then_correct) (=> (= (ControlFlow 0 24) 16) anon24_Else_correct)))))
(let ((anon23_Else_correct  (=> (<= (|Seq#Length| (|Seq#Index| xs i@@6)) j@@5) (and (=> (= (ControlFlow 0 15) 2) anon27_Then_correct) (=> (= (ControlFlow 0 15) 11) anon27_Else_correct)))))
(let ((anon22_Then_correct  (=> (<= 0 j@@5) (and (=> (= (ControlFlow 0 25) (- 0 27)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 25) (- 0 26)) (< i@@6 (|Seq#Length| xs))) (=> (< i@@6 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 25) 24) anon23_Then_correct) (=> (= (ControlFlow 0 25) 15) anon23_Else_correct)))))))))
(let ((anon22_Else_correct  (=> (< j@@5 0) (and (=> (= (ControlFlow 0 14) 2) anon27_Then_correct) (=> (= (ControlFlow 0 14) 11) anon27_Else_correct)))))
(let ((anon21_Then_correct  (=> (< i@@6 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 28) 25) anon22_Then_correct) (=> (= (ControlFlow 0 28) 14) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (<= (|Seq#Length| xs) i@@6) (and (=> (= (ControlFlow 0 13) 2) anon27_Then_correct) (=> (= (ControlFlow 0 13) 11) anon27_Else_correct)))))
(let ((anon20_Then_correct  (=> (<= 0 i@@6) (and (=> (= (ControlFlow 0 29) 28) anon21_Then_correct) (=> (= (ControlFlow 0 29) 13) anon21_Else_correct)))))
(let ((anon20_Else_correct  (=> (< i@@6 0) (and (=> (= (ControlFlow 0 12) 2) anon27_Then_correct) (=> (= (ControlFlow 0 12) 11) anon27_Else_correct)))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (and (=> (= (ControlFlow 0 44) 43) anon19_Else_correct) (=> (= (ControlFlow 0 44) 29) anon20_Then_correct)) (=> (= (ControlFlow 0 44) 12) anon20_Else_correct)))))
