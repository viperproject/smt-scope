...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (= y@0 (+ x@@19 x@@19))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (+ x@@19 x@@19) (* 2 x@@19))) (=> (= (+ x@@19 x@@19) (* 2 x@@19)) (=> (= y_2@0 (+ x@@19 x@@19)) (=> (and (and (state Heap@@15 ZeroMask) (= y_3@0 (+ x@@19 x@@19))) (and (= y_4@0 (+ x@@19 x@@19)) (= (ControlFlow 0 2) (- 0 1)))) (= (* 2 x@@19) (+ x@@19 x@@19))))))))))
