...
(assert  (and (and (and (and (= (type QPMask@0) (MapType1Type RefType realType)) (= (type x@@11) RefType)) (= (type xs) (SeqType RefType))) (= (type Heap@@14) (MapType0Type RefType))) (forall ((arg0@@43 T@U) (arg1@@20 Int) ) (! (= (type (invRecv7 arg0@@43 arg1@@20)) RefType)
