...
(assert  (and (and (and (and (and (and (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type this@@5) RefType)) (= (type Heap@3) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (forall ((arg0@@28 T@U) ) (! (= (type (FrameFragment arg0@@28)) FrameTypeType)
...
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null (valid this@@5 true))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 null (valid this@@5 true)))) (=> (= (ControlFlow 0 3) 2) anon8_correct))))))
(let ((anon6_correct  (=> (= Heap@3 (MapType0Store Heap@2 null (|valid#sm| this@@5 false) (MapType1Store (MapType0Select Heap@2 null (|valid#sm| this@@5 false)) this@@5 g (bool_2_U true)))) (=> (and (state Heap@3 Mask@2) (state Heap@3 Mask@2)) (and (=> (= (ControlFlow 0 6) 3) anon12_Then_correct) (=> (= (ControlFlow 0 6) 5) anon12_Else_correct))))))
(let ((anon11_Else_correct  (=> (HasDirectPerm Mask@2 null (valid this@@5 false)) (=> (and (= Heap@2 Heap@@10) (= (ControlFlow 0 8) 6)) anon6_correct))))
(let ((anon11_Then_correct  (=> (not (HasDirectPerm Mask@2 null (valid this@@5 false))) (=> (and (and (= Heap@0 (MapType0Store Heap@@10 null (|valid#sm| this@@5 false) ZeroPMask)) (= Heap@1 (MapType0Store Heap@0 null (valid this@@5 false) freshVersion@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 7) 6))) anon6_correct))))
(let ((anon4_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 this@@5 g (real_2_U (- (U_2_real (MapType1Select Mask@0 this@@5 g)) FullPerm)))) (= Mask@2 (MapType1Store Mask@1 null (valid this@@5 false) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (valid this@@5 false))) FullPerm))))) (=> (and (and (state Heap@@10 Mask@2) (state Heap@@10 Mask@2)) (and (|valid#trigger| Heap@@10 (valid this@@5 false)) (= (MapType0Select Heap@@10 null (valid this@@5 false)) (FrameFragment (FrameFragment (MapType0Select Heap@@10 this@@5 g)))))) (and (=> (= (ControlFlow 0 9) 7) anon11_Then_correct) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct))))))
(let ((anon10_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon4_correct)))
(let ((anon10_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@0 this@@5 g)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 this@@5 g))) (=> (= (ControlFlow 0 10) 9) anon4_correct))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 this@@5 $allocated))) (=> (and (and (not (= this@@5 null)) (= Mask@0 (MapType1Store ZeroMask this@@5 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@5 f_7)) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (and (=> (= (ControlFlow 0 13) 1) anon9_Then_correct) (=> (= (ControlFlow 0 13) 10) anon10_Then_correct)) (=> (= (ControlFlow 0 13) 12) anon10_Else_correct))))))
