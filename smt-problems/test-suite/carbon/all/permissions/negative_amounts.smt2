...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (Ctor RefType) 8)) (= (type f_7) (FieldType NormalFieldType RefType))) (= (type p_1) (FieldType NormalFieldType realType))))
(assert (distinct $allocated f_7 p_1)
)
...
(assert  (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type x@@8) RefType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (and (= k NoPerm) (= (ControlFlow 0 4) 1)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= k NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= k (U_2_real (MapType1Select Mask@0 x@@8 f_7)))) (=> (<= k (U_2_real (MapType1Select Mask@0 x@@8 f_7))) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (=> (and (and (and (not (= x@@8 null)) (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (and (< k FullPerm) (state Heap@@9 Mask@0)) (and (not (= k NoPerm)) (state Heap@@9 Mask@0)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (>= k NoPerm)) (=> (>= k NoPerm) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))))
