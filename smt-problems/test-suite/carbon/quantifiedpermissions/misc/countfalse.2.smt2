...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon8_correct  (=> (= (ControlFlow 0 13) (- 0 12)) (= (countFalseX Heap@@17 a_3@@11 from@@9) (ite (= from@@9 (length a_3@@11)) 0 (countFalseX Heap@@17 a_3@@11 (+ from@@9 1)))))))
(let ((anon11_Then_correct  (=> (and (= from@@9 (length a_3@@11)) (= (ControlFlow 0 14) 13)) anon8_correct)))
...
(let ((anon11_Else_correct  (=> (not (= from@@9 (length a_3@@11))) (and (=> (= (ControlFlow 0 15) 8) anon12_Then_correct) (=> (= (ControlFlow 0 15) 13) anon8_correct)))))
...
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((z_1 Int) (z_1_1 Int) ) (!  (=> (and (and (and (and (not (= z_1 z_1_1)) (and (<= from@@9 z_1) (< z_1 (length a_3@@11)))) (and (<= from@@9 z_1_1) (< z_1_1 (length a_3@@11)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@11 z_1) (loc a_3@@11 z_1_1))))
 :qid |stdinbpl.654:15|
 :skolemid |58|
 ...
 :qid |stdinbpl.654:15|
 :skolemid |58|
)) (=> (forall ((z_1@@1 Int) ) (!  (=> (and (and (<= from@@9 z_1@@1) (< z_1@@1 (length a_3@@11))) (< NoPerm FullPerm)) (and (qpRange5 (loc a_3@@11 z_1@@1)) (= (invRecv5 (loc a_3@@11 z_1@@1)) z_1@@1)))
 :qid |stdinbpl.660:22|
 :skolemid |59|
 :pattern ( (loc a_3@@11 z_1@@1))
 :pattern ( (loc a_3@@11 z_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= from@@9 (invRecv5 o_3)) (< (invRecv5 o_3) (length a_3@@11))) (< NoPerm FullPerm)) (qpRange5 o_3)) (= (loc a_3@@11 (invRecv5 o_3)) o_3)))
 :qid |stdinbpl.664:22|
 :skolemid |60|
 ...
 :pattern ( (loc a_3@@11 z_1@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= from@@9 (invRecv5 o_3@@0)) (< (invRecv5 o_3@@0) (length a_3@@11))) (< NoPerm FullPerm)) (qpRange5 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@11 (invRecv5 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (and (and (<= from@@9 (invRecv5 o_3@@0)) (< (invRecv5 o_3@@0) (length a_3@@11))) (< NoPerm FullPerm)) (qpRange5 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.676:22|
 :skolemid |62|
...
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (and (=> (= (ControlFlow 0 16) 3) anon10_Then_correct) (=> (= (ControlFlow 0 16) 14) anon11_Then_correct)) (=> (= (ControlFlow 0 16) 15) anon11_Else_correct)))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (<= 0 from@@9)) (and (<= from@@9 (length a_3@@11)) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 18) 1) anon9_Then_correct) (=> (= (ControlFlow 0 18) 16) anon9_Else_correct))))))
