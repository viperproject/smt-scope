...
(declare-fun |factorialPure#trigger| (T@U Int) Bool)
(declare-fun n@@3 () Int)
...
(let ((anon0_correct  (=> (and (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove 0)) (and (>= n@@3 0) (state Heap@@14 ZeroMask))) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))
