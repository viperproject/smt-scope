...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@10 x@@14 $allocated)) (U_2_bool (MapType0Select Heap@@10 y@@1 $allocated))) (and (= Mask@0 (MapType1Store ZeroMask null (P x@@14 i@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@14 i@@5))) FullPerm)))) (state Heap@@10 Mask@0))) (=> (and (and (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (<= (/ (to_real 1) (to_real 2)) (U_2_real (MapType1Select Mask@0 null (P x@@14 i@@5)))) (state Heap@@10 Mask@0))) (and (and (state Heap@@10 Mask@0) (<= (__iar__assume_helper_1  (and (= x@@14 y@@1) (= i@@5 j)) (/ (to_real 1) (to_real 2)) (/ (to_real 1) (to_real 2))) (U_2_real (MapType1Select Mask@0 null (P y@@1 j))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= x@@14 y@@1)) (=> (= x@@14 y@@1) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= i@@5 j)) (=> (= i@@5 j) (=> (and (state Heap@@10 Mask@0) (= (ControlFlow 0 2) (- 0 1))) false))))))))))
