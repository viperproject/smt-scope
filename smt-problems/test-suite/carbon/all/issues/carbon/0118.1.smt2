...
(declare-fun i_6 () Int)
(declare-fun j_3 () Int)
(assert  (and (and (and (and (= (type S) (SeqType RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type x@@11) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (forall ((arg0@@35 T@U) ) (! (= (type (invRecv4 arg0@@35)) RefType)
 :qid |funType:invRecv4|
 :pattern ( (invRecv4 arg0@@35))
))))
...
(let ((anon15_Else_correct  (=> (and (not (and (<= 0 i_7) (< i_7 (|Seq#Length| S)))) (= (ControlFlow 0 16) 12)) anon9_correct)))
(let ((anon15_Then_correct  (=> (and (<= 0 i_7) (< i_7 (|Seq#Length| S))) (and (=> (= (ControlFlow 0 13) (- 0 15)) (>= i_7 0)) (=> (>= i_7 0) (and (=> (= (ControlFlow 0 13) (- 0 14)) (< i_7 (|Seq#Length| S))) (=> (< i_7 (|Seq#Length| S)) (=> (= (ControlFlow 0 13) 12) anon9_correct))))))))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 (|Seq#Length| S)))) (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length| S)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| S i_3) (|Seq#Index| S i_3_1))))
 :qid |stdinbpl.965:17|
 :skolemid |87|
 :pattern ( (neverTriggered5 i_3) (neverTriggered5 i_3_1))
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (and (<= 0 i_3@@0) (< i_3@@0 (|Seq#Length| S)))) (and (<= 0 i_3_1@@0) (< i_3_1@@0 (|Seq#Length| S)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| S i_3@@0) (|Seq#Index| S i_3_1@@0))))
 :qid |stdinbpl.965:17|
 :skolemid |87|
 :pattern ( (neverTriggered5 i_3@@0) (neverTriggered5 i_3_1@@0))
)) (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((i_3@@1 Int) ) (!  (=> (and (<= 0 i_3@@1) (< i_3@@1 (|Seq#Length| S))) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| S i_3@@1) f_7)) FullPerm))
 :qid |stdinbpl.972:17|
 :skolemid |88|
 :pattern ( (|Seq#Index| S i_3@@1))
 :pattern ( (|Seq#Index| S i_3@@1))
)))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (and (|Seq#Contains| S r_1) (not (= x@@11 r_1)))) (and (|Seq#Contains| S r_1_1) (not (= x@@11 r_1_1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1 r_1_1))))
 :qid |stdinbpl.909:15|
 :skolemid |81|
 :no-pattern (type r_1)
...
))) (=> (forall ((r_1@@0 T@U) (r_1_1@@0 T@U) ) (!  (=> (and (= (type r_1@@0) RefType) (= (type r_1_1@@0) RefType)) (=> (and (and (and (and (not (= r_1@@0 r_1_1@@0)) (and (|Seq#Contains| S r_1@@0) (not (= x@@11 r_1@@0)))) (and (|Seq#Contains| S r_1_1@@0) (not (= x@@11 r_1_1@@0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1@@0 r_1_1@@0))))
 :qid |stdinbpl.909:15|
 :skolemid |81|
...
)) (=> (and (and (and (forall ((r_1@@1 T@U) ) (!  (=> (= (type r_1@@1) RefType) (=> (and (and (|Seq#Contains| S r_1@@1) (not (= x@@11 r_1@@1))) (< NoPerm FullPerm)) (and (qpRange4 r_1@@1) (= (invRecv4 r_1@@1) r_1@@1))))
 :qid |stdinbpl.915:22|
 :skolemid |82|
...
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (|Seq#Contains| S (invRecv4 o_3)) (not (= x@@11 (invRecv4 o_3)))) (< NoPerm FullPerm)) (qpRange4 o_3)) (= (invRecv4 o_3) o_3)))
 :qid |stdinbpl.919:22|
 :skolemid |83|
 :pattern ( (invRecv4 o_3))
))) (and (forall ((r_1@@2 T@U) ) (!  (=> (= (type r_1@@2) RefType) (=> (and (|Seq#Contains| S r_1@@2) (not (= x@@11 r_1@@2))) (not (= r_1@@2 null))))
 :qid |stdinbpl.925:22|
 :skolemid |84|
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (|Seq#Contains| S (invRecv4 o_3@@0)) (not (= x@@11 (invRecv4 o_3@@0)))) (< NoPerm FullPerm)) (qpRange4 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (and (|Seq#Contains| S (invRecv4 o_3@@0)) (not (= x@@11 (invRecv4 o_3@@0)))) (< NoPerm FullPerm)) (qpRange4 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.931:22|
 :skolemid |85|
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (and (=> (= (ControlFlow 0 17) 10) anon14_Else_correct) (=> (= (ControlFlow 0 17) 13) anon15_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon15_Else_correct)))))))
...
)) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 19) 8) anon13_Then_correct) (=> (= (ControlFlow 0 19) 17) anon13_Else_correct)))))
(let ((anon3_correct true))
(let ((anon12_Else_correct  (=> (and (not (and (>= i_6 0) (and (< i_6 (|Seq#Length| S)) (and (>= j_3 0) (and (< j_3 (|Seq#Length| S)) (not (= i_6 j_3))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon12_Then_correct  (=> (and (>= i_6 0) (and (< i_6 (|Seq#Length| S)) (and (>= j_3 0) (and (< j_3 (|Seq#Length| S)) (not (= i_6 j_3)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_6 0)) (=> (>= i_6 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_6 (|Seq#Length| S))) (=> (< i_6 (|Seq#Length| S)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_3 0)) (=> (>= j_3 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_3 (|Seq#Length| S))) (=> (< j_3 (|Seq#Length| S)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@11 $allocated))) (and (and (=> (= (ControlFlow 0 20) 19) anon11_Else_correct) (=> (= (ControlFlow 0 20) 2) anon12_Then_correct)) (=> (= (ControlFlow 0 20) 7) anon12_Else_correct)))))
