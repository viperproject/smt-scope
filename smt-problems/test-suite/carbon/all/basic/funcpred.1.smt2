...
(let ((anon16_Else_correct  (=> (= (MapType0Select Heap@1 node@@3 next) null) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 6) 4)) anon11_correct))))
(let ((anon16_Then_correct  (=> (not (= (MapType0Select Heap@1 node@@3 next) null)) (=> (and (and (forall ((o_3 T@U) (f_8 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_8))))
(let ((A@@12 (FieldTypeInv0 (type f_8))))
 (=> (and (and (= (type o_3) RefType) (= (type f_8) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|valid#sm| node@@3)) o_3 f_8)) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|valid#sm| (MapType0Select Heap@1 node@@3 next))) o_3 f_8)))) (U_2_bool (MapType1Select newPMask@0 o_3 f_8)))))
 :qid |stdinbpl.326:33|
 :skolemid |26|
 :pattern ( (MapType1Select newPMask@0 o_3 f_8))
)) (= Heap@2 (MapType0Store Heap@1 null (|valid#sm| node@@3) newPMask@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 5) 4))) anon11_correct))))
(let ((anon9_correct  (=> (and (= Heap@0 (MapType0Store Heap@@14 null (|valid#sm| node@@3) (MapType1Store (MapType0Select Heap@@14 null (|valid#sm| node@@3)) node@@3 next (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|valid#sm| node@@3) (MapType1Store (MapType0Select Heap@0 null (|valid#sm| node@@3)) node@@3 value (bool_2_U true))))) (and (=> (= (ControlFlow 0 7) 5) anon16_Then_correct) (=> (= (ControlFlow 0 7) 6) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (|itemat#trigger| (MapType0Select Heap@@14 null (valid (MapType0Select Heap@@14 node@@3 next))) (MapType0Select Heap@@14 node@@3 next) (- i@@3 1)) (= (ControlFlow 0 10) 7)) anon9_correct)))
(let ((anon14_Then_correct  (=> (or (= i@@3 0) (= (MapType0Select Heap@@14 node@@3 next) null)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm UnfoldingMask@4 node@@3 value)) (=> (HasDirectPerm UnfoldingMask@4 node@@3 value) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
(let ((anon15_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (> (U_2_real (MapType1Select UnfoldingMask@4 null (valid (MapType0Select Heap@@14 node@@3 next)))) NoPerm)) (=> (> (U_2_real (MapType1Select UnfoldingMask@4 null (valid (MapType0Select Heap@@14 node@@3 next)))) NoPerm) (=> (and (and (> wildcard@5 NoPerm) (< wildcard@5 (U_2_real (MapType1Select UnfoldingMask@4 null (valid (MapType0Select Heap@@14 node@@3 next)))))) (and (= UnfoldingMask@5 (MapType1Store UnfoldingMask@4 null (valid (MapType0Select Heap@@14 node@@3 next)) (real_2_U (- (U_2_real (MapType1Select UnfoldingMask@4 null (valid (MapType0Select Heap@@14 node@@3 next)))) wildcard@5)))) (= (ControlFlow 0 2) (- 0 1)))) (>= (- i@@3 1) 0))))))
(let ((anon14_Else_correct  (=> (not (or (= i@@3 0) (= (MapType0Select Heap@@14 node@@3 next) null))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm UnfoldingMask@4 node@@3 next)) (=> (HasDirectPerm UnfoldingMask@4 node@@3 next) (and (=> (= (ControlFlow 0 11) 2) anon15_Then_correct) (=> (= (ControlFlow 0 11) 10) anon15_Else_correct)))))))
(let ((anon13_Else_correct  (=> (= i@@3 0) (and (=> (= (ControlFlow 0 15) 8) anon14_Then_correct) (=> (= (ControlFlow 0 15) 11) anon14_Else_correct)))))
(let ((anon13_Then_correct  (=> (not (= i@@3 0)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm UnfoldingMask@4 node@@3 next)) (=> (HasDirectPerm UnfoldingMask@4 node@@3 next) (and (=> (= (ControlFlow 0 13) 8) anon14_Then_correct) (=> (= (ControlFlow 0 13) 11) anon14_Else_correct)))))))
(let ((anon2_correct  (=> (state Heap@@14 UnfoldingMask@4) (and (=> (= (ControlFlow 0 16) 13) anon13_Then_correct) (=> (= (ControlFlow 0 16) 15) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (= (MapType0Select Heap@@14 node@@3 next) null) (=> (and (= UnfoldingMask@4 UnfoldingMask@2) (= (ControlFlow 0 18) 16)) anon2_correct))))
(let ((anon12_Then_correct  (=> (not (= (MapType0Select Heap@@14 node@@3 next) null)) (=> (and (> wildcard@4 NoPerm) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 null (valid (MapType0Select Heap@@14 node@@3 next)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 null (valid (MapType0Select Heap@@14 node@@3 next)))) wildcard@4))))) (=> (and (and (InsidePredicate (valid node@@3) (MapType0Select Heap@@14 null (valid node@@3)) (valid (MapType0Select Heap@@14 node@@3 next)) (MapType0Select Heap@@14 null (valid (MapType0Select Heap@@14 node@@3 next)))) (state Heap@@14 UnfoldingMask@3)) (and (= UnfoldingMask@4 UnfoldingMask@3) (= (ControlFlow 0 17) 16))) anon2_correct)))))
(let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (U_2_bool (MapType0Select Heap@@14 node@@3 $allocated))) (=> (and (and (and (= AssumeFunctionsAbove 0) (> wildcard@0 NoPerm)) (and (= Mask@0 (MapType1Store ZeroMask null (valid node@@3) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid node@@3))) wildcard@0)))) (state Heap@@14 Mask@0))) (and (and (>= i@@3 0) (state Heap@@14 Mask@0)) (and (|valid#trigger| Heap@@14 (valid node@@3)) (= (MapType0Select Heap@@14 null (valid node@@3)) (CombineFrames (FrameFragment (MapType0Select Heap@@14 node@@3 next)) (CombineFrames (FrameFragment (MapType0Select Heap@@14 node@@3 value)) (FrameFragment (ite (not (= (MapType0Select Heap@@14 node@@3 next) null)) (MapType0Select Heap@@14 null (valid (MapType0Select Heap@@14 node@@3 next))) EmptyFrame)))))))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (> (U_2_real (MapType1Select Mask@0 null (valid node@@3))) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@0 null (valid node@@3))) NoPerm) (=> (> wildcard@1 NoPerm) (=> (and (< wildcard@1 (U_2_real (MapType1Select Mask@0 null (valid node@@3)))) (= UnfoldingMask@0 (MapType1Store Mask@0 null (valid node@@3) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid node@@3))) wildcard@1))))) (=> (and (and (and (> wildcard@2 NoPerm) (not (= node@@3 null))) (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 node@@3 next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 node@@3 next)) wildcard@2)))) (state Heap@@14 UnfoldingMask@1))) (and (and (> wildcard@3 NoPerm) (not (= node@@3 null))) (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 node@@3 value (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 node@@3 value)) wildcard@3)))) (state Heap@@14 UnfoldingMask@2)))) (and (=> (= (ControlFlow 0 19) 17) anon12_Then_correct) (=> (= (ControlFlow 0 19) 18) anon12_Else_correct)))))))))))
