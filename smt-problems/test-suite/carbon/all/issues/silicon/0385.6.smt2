...
(let ((anon0_correct  (=> (and (and (state Heap@@25 ZeroMask) (U_2_bool (MapType0Select Heap@@25 y@@17 $allocated))) (and (U_2_bool (MapType0Select Heap@@25 x@@24 $allocated)) (= AssumeFunctionsAbove 0))) (and (=> (= (ControlFlow 0 8) 6) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))
