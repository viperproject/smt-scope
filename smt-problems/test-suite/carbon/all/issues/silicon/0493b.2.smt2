...
(assert  (and (and (and (and (and (= (type vas@@11) (MapType2Type RefType boolType)) (= (type Heap@@20) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type QPMask@2) (MapType1Type RefType realType))) (forall ((arg0@@51 T@U) ) (! (= (type (invRecv5 arg0@@51)) RefType)
 :qid |funType:invRecv5|
 :pattern ( (invRecv5 arg0@@51))
))))
(set-info :boogie-vc-id test_vals)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (= (foo_vals Heap@@20 vas@@11) 0))))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((a_3 T@U) (a_3_1 T@U) ) (!  (=> (and (= (type a_3) RefType) (= (type a_3_1) RefType)) (=> (and (and (and (and (not (= a_3 a_3_1)) (U_2_bool (MapType2Select vas@@11 a_3))) (U_2_bool (MapType2Select vas@@11 a_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_3 a_3_1))))
 :qid |stdinbpl.1031:21|
 :skolemid |136|
 :pattern ( (neverTriggered7 a_3) (neverTriggered7 a_3_1))
 ...
 :qid |stdinbpl.1031:21|
 :skolemid |136|
 :pattern ( (neverTriggered7 a_3@@0) (neverTriggered7 a_3_1@@0))
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((a_3@@1 T@U) ) (!  (=> (and (= (type a_3@@1) RefType) (U_2_bool (MapType2Select vas@@11 a_3@@1))) (>= (U_2_real (MapType1Select QPMask@0 a_3@@1 val)) FullPerm))
 :qid |stdinbpl.1038:21|
 :skolemid |137|
 :pattern ( (MapType0Select Heap@@20 a_3@@1 val))
 :pattern ( (MapType1Select QPMask@2 a_3@@1 val))
 :pattern ( (MapType0Select Heap@@20 a_3@@1 val))
)))))))
(let ((anon8_Else_correct  (=> (= (foo_vals Heap@@20 vas@@11) 0) (=> (and (state Heap@@20 QPMask@0) (state Heap@@20 QPMask@0)) (and (=> (= (ControlFlow 0 10) 6) anon9_Then_correct) (=> (= (ControlFlow 0 10) 9) anon9_Else_correct))))))
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((a_2 T@U) (a_2_2 T@U) ) (!  (=> (and (= (type a_2) RefType) (= (type a_2_2) RefType)) (=> (and (and (and (and (not (= a_2 a_2_2)) (U_2_bool (MapType2Select vas@@11 a_2))) (U_2_bool (MapType2Select vas@@11 a_2_2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_2 a_2_2))))
 :qid |stdinbpl.970:21|
 :skolemid |130|
 :pattern ( (neverTriggered6 a_2) (neverTriggered6 a_2_2))
 ...
 :qid |stdinbpl.970:21|
 :skolemid |130|
 :pattern ( (neverTriggered6 a_2@@0) (neverTriggered6 a_2_2@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((a_2@@1 T@U) ) (!  (=> (and (= (type a_2@@1) RefType) (U_2_bool (MapType2Select vas@@11 a_2@@1))) (>= (U_2_real (MapType1Select QPMask@0 a_2@@1 val)) FullPerm))
 :qid |stdinbpl.977:21|
 :skolemid |131|
 :pattern ( (MapType0Select Heap@@20 a_2@@1 val))
 :pattern ( (MapType1Select QPMask@1 a_2@@1 val))
 :pattern ( (MapType0Select Heap@@20 a_2@@1 val))
)))))))
...
)) (=> (forall ((a_1@@1 T@U) ) (!  (=> (= (type a_1@@1) RefType) (=> (and (U_2_bool (MapType2Select vas@@11 a_1@@1)) (< NoPerm FullPerm)) (and (qpRange5 a_1@@1) (= (invRecv5 a_1@@1) a_1@@1))))
 :qid |stdinbpl.926:22|
 :skolemid |125|
 :pattern ( (MapType0Select Heap@@20 a_1@@1 val))
 :pattern ( (MapType1Select QPMask@0 a_1@@1 val))
 :pattern ( (MapType0Select Heap@@20 a_1@@1 val))
)) (=> (and (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select vas@@11 (invRecv5 o_3))) (< NoPerm FullPerm)) (qpRange5 o_3)) (= (invRecv5 o_3) o_3)))
 :qid |stdinbpl.930:22|
 :skolemid |126|
 :pattern ( (invRecv5 o_3))
)) (forall ((a_1@@2 T@U) ) (!  (=> (and (= (type a_1@@2) RefType) (U_2_bool (MapType2Select vas@@11 a_1@@2))) (not (= a_1@@2 null)))
 :qid |stdinbpl.936:22|
 :skolemid |127|
 :pattern ( (MapType0Select Heap@@20 a_1@@2 val))
 :pattern ( (MapType1Select QPMask@0 a_1@@2 val))
 :pattern ( (MapType0Select Heap@@20 a_1@@2 val))
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select vas@@11 (invRecv5 o_3@@0))) (< NoPerm FullPerm)) (qpRange5 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv5 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select vas@@11 (invRecv5 o_3@@0))) (< NoPerm FullPerm)) (qpRange5 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.942:22|
 :skolemid |128|
