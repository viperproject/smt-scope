...
; unknown
; ---------- FUNCTION Property----------
(declare-fun a@0@00 () Array<Ref>)
(declare-fun b@1@00 () Array<Ref>)
(declare-fun result@2@00 () Bool)
; ----- Well-definedness of specifications -----
(set-option :timeout 0)
(push) ; 1
(assert (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$))))
(declare-const i$0@3@00 Int)
(push) ; 2
; [eval] 0 <= i$0
(assert (<= 0 i$0@3@00))
; [eval] (loc(a, i$0): Ref)
...
(push) ; 2
(assert (not (forall ((i$01@3@00 Int) (i$02@3@00 Int)) (!
  (=>
    (and
      (<= 0 i$01@3@00)
      (<= 0 i$02@3@00)
      (= (loc<Ref> a@0@00 i$01@3@00) (loc<Ref> a@0@00 i$02@3@00)))
    (= i$01@3@00 i$02@3@00))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@5@00 s@$ a@0@00 b@1@00 r) (<= 0 (inv@4@00 s@$ a@0@00 b@1@00 r)))
...
(assert (forall ((i$0@3@00 Int)) (!
  (=> (<= 0 i$0@3@00) (not (= (loc<Ref> a@0@00 i$0@3@00) $Ref.null)))
  :pattern ((loc<Ref> a@0@00 i$0@3@00))
  :qid |val-permImpliesNonNull|)))
(declare-const i$1@6@00 Int)
(push) ; 2
; [eval] 0 <= i$1
(assert (<= 0 i$1@6@00))
; [eval] (loc(b, i$1): Ref)
...
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((i$11@6@00 Int) (i$12@6@00 Int)) (!
  (=>
    (and
      (<= 0 i$11@6@00)
      (<= 0 i$12@6@00)
      (= (loc<Ref> b@1@00 i$11@6@00) (loc<Ref> b@1@00 i$12@6@00)))
    (= i$11@6@00 i$12@6@00))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@8@00 s@$ a@0@00 b@1@00 r) (<= 0 (inv@7@00 s@$ a@0@00 b@1@00 r)))
...
; Permission implies non-null receiver
(assert (forall ((i$1@6@00 Int)) (!
  (=> (<= 0 i$1@6@00) (not (= (loc<Ref> b@1@00 i$1@6@00) $Ref.null)))
  :pattern ((loc<Ref> b@1@00 i$1@6@00))
  :qid |val-permImpliesNonNull|)))
(push) ; 2
...
(assert (not (forall ((r $Ref)) (!
  (and
    (= (loc<Ref> b@1@00 i$1@6@00) (loc<Ref> a@0@00 i$0@3@00))
    (=
      (and (img@8@00 s@$ a@0@00 b@1@00 r) (<= 0 (inv@7@00 s@$ a@0@00 b@1@00 r)))
      (and (img@5@00 s@$ a@0@00 b@1@00 r) (<= 0 (inv@4@00 s@$ a@0@00 b@1@00 r)))))
...
(assert (forall ((r $Ref)) (!
  ...
  :qid |qp.fvfValDef1|)))
(declare-const pm@11@00 $FPM)
(assert (forall ((r $Ref)) (!
  (=
    ($FVF.perm_val (as pm@11@00  $FPM) r)
    (+
      (ite
        (and
      ...
      (ite
        ...
        (/ (to_real 1) (to_real 2))
        $Perm.No)))
  :pattern (($FVF.perm_val (as pm@11@00  $FPM) r))
  :qid |qp.resPrmSumDef2|)))
(push) ; 5
(assert (not (< $Perm.No ($FVF.perm_val (as pm@11@00  $FPM) (loc<Ref> b@1@00 i@9@00)))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
(assert (forall ((r $Ref)) (!
  ...
  :qid |qp.resPrmSumDef2|)))
; Joined path conditions
(assert (or (not (<= 0 i@9@00)) (<= 0 i@9@00)))
(pop) ; 2
...
(assert (forall ((i@9@00 Int)) (!
  (or (not (<= 0 i@9@00)) (<= 0 i@9@00))
  :pattern ((loc<Ref> b@1@00 i@9@00))
  :qid |prog./silicon/silver/src/test/resources/all/issues/silicon/0483b.vpr@20@3@20@56-aux|)))
(assert (=
  result@2@00
  (forall ((i@9@00 Int)) (!
    (=>
      (<= 0 i@9@00)
      ($FVF.lookup_val (sm@10@00 s@$ a@0@00 b@1@00) (loc<Ref> b@1@00 i@9@00)))
    :pattern ((loc<Ref> b@1@00 i@9@00))
    :qid |prog./silicon/silver/src/test/resources/all/issues/silicon/0483b.vpr@20@3@20@56|))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (a@0@00 Array<Ref>) (b@1@00 Array<Ref>)) (!
  (and
    (forall ((i$0@3@00 Int)) (!
