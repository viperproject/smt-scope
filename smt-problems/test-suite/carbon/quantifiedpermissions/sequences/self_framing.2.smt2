...
(declare-fun i_4 () Int)
(assert  (and (and (and (= (type s@@17) (SeqType RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id foo2korbinian)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon11_correct true))
(let ((anon18_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i_6))) (= (ControlFlow 0 17) 12)) anon11_correct)))
(let ((anon18_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i_6)) (and (=> (= (ControlFlow 0 13) (- 0 16)) (>= i_6 0)) (=> (>= i_6 0) (and (=> (= (ControlFlow 0 13) (- 0 15)) (< i_6 (|Seq#Length| s@@17))) (=> (< i_6 (|Seq#Length| s@@17)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm QPMask@1 (|Seq#Index| s@@17 i_6) f_7)) (=> (HasDirectPerm QPMask@1 (|Seq#Index| s@@17 i_6) f_7) (=> (= (ControlFlow 0 13) 12) anon11_correct))))))))))
(let ((anon17_Else_correct true))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains| (|Seq#Range| 1 2) (int_2_U i_3))) (|Seq#Contains| (|Seq#Range| 1 2) (int_2_U i_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| s@@17 i_3) (|Seq#Index| s@@17 i_3_1))))
 :qid |stdinbpl.927:15|
 :skolemid |79|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (|Seq#Contains| (|Seq#Range| 1 2) (int_2_U i_3@@0))) (|Seq#Contains| (|Seq#Range| 1 2) (int_2_U i_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| s@@17 i_3@@0) (|Seq#Index| s@@17 i_3_1@@0))))
 :qid |stdinbpl.927:15|
 :skolemid |79|
)) (=> (forall ((i_3@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 1 2) (int_2_U i_3@@1)) (< NoPerm FullPerm)) (and (qpRange4 (|Seq#Index| s@@17 i_3@@1)) (= (invRecv4 (|Seq#Index| s@@17 i_3@@1)) i_3@@1)))
 :qid |stdinbpl.933:22|
 :skolemid |80|
 :pattern ( (|Seq#Index| s@@17 i_3@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 1 2) (int_2_U i_3@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 1 2) (int_2_U i_3@@1)))
 :pattern ( (|Seq#Index| s@@17 i_3@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 1 2) (int_2_U (invRecv4 o_3))) (< NoPerm FullPerm)) (qpRange4 o_3)) (= (|Seq#Index| s@@17 (invRecv4 o_3)) o_3)))
 :qid |stdinbpl.937:22|
 :skolemid |81|
 :pattern ( (invRecv4 o_3))
)) (forall ((i_3@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 1 2) (int_2_U i_3@@2)) (not (= (|Seq#Index| s@@17 i_3@@2) null)))
 :qid |stdinbpl.943:22|
 :skolemid |82|
 :pattern ( (|Seq#Index| s@@17 i_3@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 1 2) (int_2_U i_3@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 1 2) (int_2_U i_3@@2)))
 :pattern ( (|Seq#Index| s@@17 i_3@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 1 2) (int_2_U (invRecv4 o_3@@0))) (< NoPerm FullPerm)) (qpRange4 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| s@@17 (invRecv4 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 1 2) (int_2_U (invRecv4 o_3@@0))) (< NoPerm FullPerm)) (qpRange4 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7))))))
 :qid |stdinbpl.949:22|
 :skolemid |83|
...
))) (and (state Heap@@9 QPMask@1) (state Heap@@9 QPMask@1))) (and (and (=> (= (ControlFlow 0 18) 11) anon17_Else_correct) (=> (= (ControlFlow 0 18) 13) anon18_Then_correct)) (=> (= (ControlFlow 0 18) 17) anon18_Else_correct)))))))))
(let ((anon7_correct true))
(let ((anon16_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 1 2) (int_2_U i_5))) (= (ControlFlow 0 10) 6)) anon7_correct)))
(let ((anon16_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 1 2) (int_2_U i_5)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (>= i_5 0)) (=> (>= i_5 0) (and (=> (= (ControlFlow 0 7) (- 0 8)) (< i_5 (|Seq#Length| s@@17))) (=> (< i_5 (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 7) 6) anon7_correct))))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 0 1) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 0 1) (int_2_U i_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| s@@17 i_1) (|Seq#Index| s@@17 i_1_1))))
 :qid |stdinbpl.881:15|
 :skolemid |73|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (|Seq#Contains| (|Seq#Range| 0 1) (int_2_U i_1@@0))) (|Seq#Contains| (|Seq#Range| 0 1) (int_2_U i_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| s@@17 i_1@@0) (|Seq#Index| s@@17 i_1_1@@0))))
 :qid |stdinbpl.881:15|
 :skolemid |73|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 1) (int_2_U i_1@@1)) (< NoPerm FullPerm)) (and (qpRange3 (|Seq#Index| s@@17 i_1@@1)) (= (invRecv3 (|Seq#Index| s@@17 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.887:22|
 :skolemid |74|
 :pattern ( (|Seq#Index| s@@17 i_1@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 1) (int_2_U i_1@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 1) (int_2_U i_1@@1)))
 :pattern ( (|Seq#Index| s@@17 i_1@@1))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 1) (int_2_U (invRecv3 o_3@@2))) (< NoPerm FullPerm)) (qpRange3 o_3@@2)) (= (|Seq#Index| s@@17 (invRecv3 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.891:22|
 :skolemid |75|
 :pattern ( (invRecv3 o_3@@2))
)) (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 1) (int_2_U i_1@@2)) (not (= (|Seq#Index| s@@17 i_1@@2) null)))
 :qid |stdinbpl.897:22|
 :skolemid |76|
 :pattern ( (|Seq#Index| s@@17 i_1@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 1) (int_2_U i_1@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 1) (int_2_U i_1@@2)))
 :pattern ( (|Seq#Index| s@@17 i_1@@2))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 1) (int_2_U (invRecv3 o_3@@3))) (< NoPerm FullPerm)) (qpRange3 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| s@@17 (invRecv3 o_3@@3)) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 1) (int_2_U (invRecv3 o_3@@3))) (< NoPerm FullPerm)) (qpRange3 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@3 f_7))))))
 :qid |stdinbpl.903:22|
 :skolemid |77|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 20) 18) anon15_Else_correct) (=> (= (ControlFlow 0 20) 7) anon16_Then_correct)) (=> (= (ControlFlow 0 20) 10) anon16_Else_correct)))))))))
(let ((anon3_correct true))
(let ((anon14_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 1) (int_2_U i_4))) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon14_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 1) (int_2_U i_4)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i_4 (|Seq#Length| s@@17))) (=> (< i_4 (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (> (|Seq#Length| s@@17) 2) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 22) 20) anon13_Else_correct) (=> (= (ControlFlow 0 22) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 22) 5) anon14_Else_correct))))))
