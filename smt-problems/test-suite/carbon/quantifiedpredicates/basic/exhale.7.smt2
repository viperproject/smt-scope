...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type z@@0) RefType)) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type newVersion@1) FrameTypeType)) (= (type Heap@3) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type y@@2) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (forall ((arg0@@39 T@U) ) (! (= (type (FrameFragment arg0@@39)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@39))
))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@11) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type xs) (SeqType RefType))) (forall ((arg0@@40 T@U) ) (! (= (type (invRecv11 arg0@@40)) RefType)
 :qid |funType:invRecv11|
 :pattern ( (invRecv11 arg0@@40))
))))
(set-info :boogie-vc-id test06_qp)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon10_correct true))
(let ((anon15_Else_correct  (=> (HasDirectPerm Mask@2 null (pred1 z@@0)) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 4) 2)) anon10_correct))))
(let ((anon15_Then_correct  (=> (and (and (not (HasDirectPerm Mask@2 null (pred1 z@@0))) (= Heap@2 (MapType0Store Heap@1 null (pred1 z@@0) newVersion@1))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 3) 2))) anon10_correct)))
(let ((anon8_correct  (=> (= Mask@2 (MapType1Store Mask@1 null (pred1 z@@0) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (pred1 z@@0))) FullPerm)))) (and (=> (= (ControlFlow 0 5) 3) anon15_Then_correct) (=> (= (ControlFlow 0 5) 4) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon8_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (pred1 z@@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (pred1 z@@0)))) (=> (= (ControlFlow 0 6) 5) anon8_correct))))))
(let ((anon6_correct  (=> (not (= y@@2 null)) (=> (and (= Mask@1 (MapType1Store Mask@0 y@@2 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@2 f_7)) FullPerm)))) (state Heap@1 Mask@1)) (=> (and (and (state Heap@1 Mask@1) (state Heap@1 Mask@1)) (and (|pred1#trigger| Heap@1 (pred1 z@@0)) (= (MapType0Select Heap@1 null (pred1 z@@0)) (FrameFragment (MapType0Select Heap@1 z@@0 f_7))))) (and (=> (= (ControlFlow 0 9) 6) anon14_Then_correct) (=> (= (ControlFlow 0 9) 8) anon14_Else_correct)))))))
(let ((anon13_Else_correct  (=> (HasDirectPerm Mask@0 null (pred1 y@@2)) (=> (and (= Heap@1 Heap@@11) (= (ControlFlow 0 11) 9)) anon6_correct))))
(let ((anon13_Then_correct  (=> (and (and (not (HasDirectPerm Mask@0 null (pred1 y@@2))) (= Heap@0 (MapType0Store Heap@@11 null (pred1 y@@2) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 10) 9))) anon6_correct)))
(let ((anon4_correct  (=> (= Mask@0 (MapType1Store QPMask@0 null (pred1 y@@2) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (pred1 y@@2))) FullPerm)))) (and (=> (= (ControlFlow 0 12) 10) anon13_Then_correct) (=> (= (ControlFlow 0 12) 11) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 15) 12)) anon4_correct)))
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (pred1 y@@2))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (pred1 y@@2)))) (=> (= (ControlFlow 0 13) 12) anon4_correct))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| xs x_1)) (|Seq#Contains| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.1948:17|
 :skolemid |133|
 :pattern ( (neverTriggered11 x_1) (neverTriggered11 x_1_1))
 ...
 :qid |stdinbpl.1948:17|
 :skolemid |133|
 :pattern ( (neverTriggered11 x_1@@0) (neverTriggered11 x_1_1@@0))
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| xs x_1@@1) (< NoPerm FullPerm)) (and (= (invRecv11 x_1@@1) x_1@@1) (qpRange11 x_1@@1))))
...
)) (=> (and (and (and (forall ((a_1@@11 T@U) ) (!  (=> (= (type a_1@@11) RefType) (=> (and (and (|Seq#Contains| xs (invRecv11 a_1@@11)) (< NoPerm FullPerm)) (qpRange11 a_1@@11)) (= (invRecv11 a_1@@11) a_1@@11)))
 :qid |stdinbpl.1958:22|
 :skolemid |135|
 :pattern ( (invRecv11 a_1@@11))
)) (forall ((a_1@@12 T@U) ) (!  (=> (= (type a_1@@12) RefType) (=> (and (and (|Seq#Contains| xs (invRecv11 a_1@@12)) (< NoPerm FullPerm)) (qpRange11 a_1@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv11 a_1@@12) a_1@@12)) (= (U_2_real (MapType1Select QPMask@0 null (pred1 a_1@@12))) (+ (U_2_real (MapType1Select ZeroMask null (pred1 a_1@@12))) FullPerm)))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.1970:29|
 :skolemid |137|
 :pattern ( (MapType1Select ZeroMask o_3 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3 f_5))
)) (forall ((a_1@@13 T@U) ) (!  (=> (and (= (type a_1@@13) RefType) (not (and (and (|Seq#Contains| xs (invRecv11 a_1@@13)) (< NoPerm FullPerm)) (qpRange11 a_1@@13)))) (= (U_2_real (MapType1Select QPMask@0 null (pred1 a_1@@13))) (U_2_real (MapType1Select ZeroMask null (pred1 a_1@@13)))))
 :qid |stdinbpl.1974:22|
 :skolemid |138|
 :pattern ( (MapType1Select QPMask@0 null (pred1 a_1@@13)))
)))) (and (and (state Heap@@11 QPMask@0) (state Heap@@11 QPMask@0)) (and (|pred1#trigger| Heap@@11 (pred1 y@@2)) (= (MapType0Select Heap@@11 null (pred1 y@@2)) (FrameFragment (MapType0Select Heap@@11 y@@2 f_7)))))) (and (=> (= (ControlFlow 0 16) 13) anon12_Then_correct) (=> (= (ControlFlow 0 16) 15) anon12_Else_correct))))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@11 y@@2 $allocated)) (U_2_bool (MapType0Select Heap@@11 z@@0 $allocated))) (and (|Seq#Contains| xs y@@2) (state Heap@@11 ZeroMask))) (and (=> (= (ControlFlow 0 18) 1) anon11_Then_correct) (=> (= (ControlFlow 0 18) 16) anon11_Else_correct))))))
