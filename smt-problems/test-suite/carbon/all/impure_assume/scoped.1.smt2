...
(declare-fun y@0 () T@U)
(assert  (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type x@@14) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type y@0) RefType)))
(set-info :boogie-vc-id test02b)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 x@@14 $allocated)) (= perm@0 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= x@@14 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask x@@14 r_1 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@14 r_1)) perm@0)))) (state Heap@@10 Mask@0)) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 x@@14 r_1)) (=> (HasDirectPerm Mask@0 x@@14 r_1) (=> (= y@0 (MapType0Select Heap@@10 x@@14 r_1)) (=> (and (and (<= (/ (to_real 2) (to_real 3)) (U_2_real (MapType1Select Mask@0 y@0 r_1))) (state Heap@@10 Mask@0)) (and (state Heap@@10 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) false))))))))))))
