...
(assert  (and (= (Ctor PredicateType_pType) 13) (forall ((arg0@@30 T@U) ) (! (= (type (p_1 arg0@@30)) (FieldType PredicateType_pType FrameTypeType))
 :qid |funType:p_1|
 :pattern ( (p_1 arg0@@30))
))))
...
(assert (forall ((Heap@@2 T@U) (x@@9 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type x@@9) RefType)) (|p#everUsed| (p_1 x@@9)))
 :qid |stdinbpl.425:15|
 :skolemid |87|
 :pattern ( (|p#trigger| Heap@@2 (p_1 x@@9)))
)))
...
(assert (forall ((x@@10 T@U) (x2 T@U) ) (!  (=> (and (and (= (type x@@10) RefType) (= (type x2) RefType)) (= (p_1 x@@10) (p_1 x2))) (= x@@10 x2))
 :qid |stdinbpl.416:15|
 :skolemid |85|
 :pattern ( (p_1 x@@10) (p_1 x2))
)))
...
(assert (forall ((x@@19 T@U) ) (!  (=> (= (type x@@19) RefType) (= (getPredWandId (p_1 x@@19)) 0))
 :qid |stdinbpl.410:15|
 :skolemid |84|
 :pattern ( (p_1 x@@19))
)))
...
(assert (forall ((x@@21 T@U) ) (!  (=> (= (type x@@21) RefType) (= (PredicateMaskField (p_1 x@@21)) (|p#sm| x@@21)))
 :qid |stdinbpl.402:15|
 :skolemid |82|
 :pattern ( (PredicateMaskField (p_1 x@@21)))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@3) (MapType1Type RefType realType)) (= (type y@@6) RefType)) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (forall ((arg0@@45 T@U) ) (! (= (type (FrameFragment arg0@@45)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@45))
))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type xs) (MapType2Type RefType boolType))) (forall ((arg0@@46 T@U) ) (! (= (type (invRecv2 arg0@@46)) RefType)
...
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@3 null (p_1 y@@6))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 null (p_1 y@@6)))) (=> (= (ControlFlow 0 3) 2) anon12_correct))))))
(let ((anon10_correct  (=> (= Heap@5 (MapType0Store Heap@4 null (|p#sm| y@@6) (MapType1Store (MapType0Select Heap@4 null (|p#sm| y@@6)) y@@6 f_7 (bool_2_U true)))) (=> (and (state Heap@5 Mask@3) (state Heap@5 Mask@3)) (and (=> (= (ControlFlow 0 6) 3) anon18_Then_correct) (=> (= (ControlFlow 0 6) 5) anon18_Else_correct))))))
(let ((anon17_Else_correct  (=> (HasDirectPerm Mask@3 null (p_1 y@@6)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 8) 6)) anon10_correct))))
(let ((anon17_Then_correct  (=> (not (HasDirectPerm Mask@3 null (p_1 y@@6))) (=> (and (and (= Heap@2 (MapType0Store Heap@1 null (|p#sm| y@@6) ZeroPMask)) (= Heap@3 (MapType0Store Heap@2 null (p_1 y@@6) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 7) 6))) anon10_correct))))
(let ((anon8_correct  (=> (and (= Mask@2 (MapType1Store Mask@1 y@@6 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 y@@6 f_7)) FullPerm)))) (= Mask@3 (MapType1Store Mask@2 null (p_1 y@@6) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (p_1 y@@6))) FullPerm))))) (=> (and (and (state Heap@1 Mask@3) (state Heap@1 Mask@3)) (and (|p#trigger| Heap@1 (p_1 y@@6)) (= (MapType0Select Heap@1 null (p_1 y@@6)) (FrameFragment (MapType0Select Heap@1 y@@6 f_7))))) (and (=> (= (ControlFlow 0 9) 7) anon17_Then_correct) (=> (= (ControlFlow 0 9) 8) anon17_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon8_correct)))
(let ((anon16_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@1 y@@6 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 y@@6 f_7))) (=> (= (ControlFlow 0 10) 9) anon8_correct))))))
(let ((anon6_correct  (=> (not (= y@@6 null)) (=> (and (and (= Mask@1 (MapType1Store Mask@0 y@@6 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@6 f_7)) FullPerm)))) (state Heap@1 Mask@1)) (and (state Heap@1 Mask@1) (state Heap@1 Mask@1))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (= (U_2_real (MapType1Select Mask@1 null (p_1 y@@6))) NoPerm)) (=> (= (U_2_real (MapType1Select Mask@1 null (p_1 y@@6))) NoPerm) (=> (state Heap@1 Mask@1) (and (=> (= (ControlFlow 0 13) 10) anon16_Then_correct) (=> (= (ControlFlow 0 13) 12) anon16_Else_correct)))))))))
(let ((anon15_Else_correct  (=> (HasDirectPerm Mask@0 null (p_1 y@@6)) (=> (and (= Heap@1 Heap@@10) (= (ControlFlow 0 16) 13)) anon6_correct))))
(let ((anon15_Then_correct  (=> (and (and (not (HasDirectPerm Mask@0 null (p_1 y@@6))) (= Heap@0 (MapType0Store Heap@@10 null (p_1 y@@6) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 15) 13))) anon6_correct)))
(let ((anon4_correct  (=> (= Mask@0 (MapType1Store QPMask@0 null (p_1 y@@6) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (p_1 y@@6))) FullPerm)))) (and (=> (= (ControlFlow 0 17) 15) anon15_Then_correct) (=> (= (ControlFlow 0 17) 16) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 20) 17)) anon4_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p_1 y@@6))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p_1 y@@6)))) (=> (= (ControlFlow 0 18) 17) anon4_correct))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select xs x_1))) (U_2_bool (MapType2Select xs x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.584:17|
 :skolemid |94|
 :pattern ( (neverTriggered2 x_1) (neverTriggered2 x_1_1))
 ...
 :qid |stdinbpl.584:17|
 :skolemid |94|
 :pattern ( (neverTriggered2 x_1@@0) (neverTriggered2 x_1_1@@0))
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs x_1@@1)) (< NoPerm FullPerm)) (and (= (invRecv2 x_1@@1) x_1@@1) (qpRange2 x_1@@1))))
 :qid |stdinbpl.590:22|
 :skolemid |95|
 :pattern ( (MapType0Select Heap@@10 null (p_1 x_1@@1)))
 :pattern ( (MapType1Select ZeroMask null (p_1 x_1@@1)))
 :pattern ( (MapType0Select Heap@@10 null (p_1 x_1@@1)))
)) (=> (and (and (forall ((x_2_1 T@U) ) (!  (=> (= (type x_2_1) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv2 x_2_1))) (< NoPerm FullPerm)) (qpRange2 x_2_1)) (= (invRecv2 x_2_1) x_2_1)))
 :qid |stdinbpl.594:22|
 :skolemid |96|
 :pattern ( (invRecv2 x_2_1))
)) (forall ((x_2_1@@0 T@U) ) (!  (=> (= (type x_2_1@@0) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv2 x_2_1@@0))) (< NoPerm FullPerm)) (qpRange2 x_2_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 x_2_1@@0) x_2_1@@0)) (= (U_2_real (MapType1Select QPMask@0 null (p_1 x_2_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (p_1 x_2_1@@0))) FullPerm)))))
 :qid |stdinbpl.600:22|
 :skolemid |97|
 :pattern ( (MapType1Select QPMask@0 null (p_1 x_2_1@@0)))
...
)) (forall ((x_2_1@@1 T@U) ) (!  (=> (and (= (type x_2_1@@1) RefType) (not (and (and (U_2_bool (MapType2Select xs (invRecv2 x_2_1@@1))) (< NoPerm FullPerm)) (qpRange2 x_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (p_1 x_2_1@@1))) (U_2_real (MapType1Select ZeroMask null (p_1 x_2_1@@1)))))
 :qid |stdinbpl.610:22|
 :skolemid |99|
 :pattern ( (MapType1Select QPMask@0 null (p_1 x_2_1@@1)))
)))) (=> (and (and (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0)) (and (state Heap@@10 QPMask@0) (U_2_bool (MapType2Select xs y@@6)))) (and (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0)) (and (|p#trigger| Heap@@10 (p_1 y@@6)) (= (MapType0Select Heap@@10 null (p_1 y@@6)) (FrameFragment (MapType0Select Heap@@10 y@@6 f_7)))))) (and (=> (= (ControlFlow 0 21) 18) anon14_Then_correct) (=> (= (ControlFlow 0 21) 20) anon14_Else_correct)))))))))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 y@@6 $allocated))) (and (=> (= (ControlFlow 0 23) 1) anon13_Then_correct) (=> (= (ControlFlow 0 23) 21) anon13_Else_correct)))))
