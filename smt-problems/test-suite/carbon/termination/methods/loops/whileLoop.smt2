...
(let ((anon9_Then_correct  (=> (>= y@2 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (and (decreasing (int_2_U y@2) (int_2_U y@0)) (bounded (int_2_U y@0)))) (=> (and (decreasing (int_2_U y@2) (int_2_U y@0)) (bounded (int_2_U y@0))) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
(let ((anon8_Then_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (and (state Heap@@9 ZeroMask) (>= y@0 0)) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (and (= y@1 (- y@0 1)) (state Heap@@9 ZeroMask)) (and (= y@2 (+ y@1 1)) (state Heap@@9 ZeroMask)))) (and (=> (= (ControlFlow 0 7) 4) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct))))))
(let ((anon8_Else_correct true))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 8) 1) anon7_Then_correct) (=> (= (ControlFlow 0 8) 7) anon8_Then_correct)) (=> (= (ControlFlow 0 8) 2) anon8_Else_correct)))))
