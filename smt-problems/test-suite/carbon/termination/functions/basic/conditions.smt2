...
(assert  (and (and (= (type Heap@@34) (MapType0Type RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type xs@@9) RefType)))
(set-info :boogie-vc-id f6_termination_proof)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon4_correct true))
(let ((anon6_Else_correct  (=> (and (= x@@12 0) (= (ControlFlow 0 6) 2)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= x@@12 0)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing (int_2_U (- x@@12 1)) (int_2_U x@@12))) (=> (decreasing (int_2_U (- x@@12 1)) (int_2_U x@@12)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded (int_2_U x@@12))) (=> (bounded (int_2_U x@@12)) (=> (and (state Heap@@34 Mask@0) (= (ControlFlow 0 3) 2)) anon4_correct))))))))
(let ((anon5_Else_correct  (=> (and (f7 Heap@@34 x@@12) (state Heap@@34 Mask@0)) (and (=> (= (ControlFlow 0 7) 3) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@34 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@34 xs@@9 $allocated))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (list xs@@9) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (list xs@@9))) FullPerm)))) (state Heap@@34 Mask@0)) (and (>= x@@12 0) (state Heap@@34 Mask@0))) (and (=> (= (ControlFlow 0 8) 1) anon5_Then_correct) (=> (= (ControlFlow 0 8) 7) anon5_Else_correct)))))))
