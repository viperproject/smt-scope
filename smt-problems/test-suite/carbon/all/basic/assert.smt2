...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type test) (FieldType NormalFieldType boolType))))
(assert (distinct $allocated test)
)
...
(assert  (not (IsPredicateField test)))
(assert  (not (IsWandField test)))
...
(assert  (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type r_1) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id t1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 r_1 $allocated)) b_2) (=> (and (and (not (= r_1 null)) (= Mask@0 (MapType1Store ZeroMask r_1 test (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1 test)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= FullPerm (U_2_real (MapType1Select Mask@0 r_1 test)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 r_1 test))) (=> (and (= Heap@0 (MapType0Store Heap@@9 r_1 test (bool_2_U b_2))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 r_1 test)) (=> (HasDirectPerm Mask@0 r_1 test) (=> (= (ControlFlow 0 2) (- 0 1)) (= b_2 (U_2_bool (MapType0Select Heap@0 r_1 test))))))))))))))
