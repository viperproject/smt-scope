...
(assert  (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type ar) (SeqType RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type this) RefType)))
(set-info :boogie-vc-id recv_body_102)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_Else_correct true))
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= (- i_25 1) 0)) (=> (>= (- i_25 1) 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< (- i_25 1) (|Seq#Length| ar))) (=> (< (- i_25 1) (|Seq#Length| ar)) (=> (and (= perm@0 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@0 NoPerm)))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 this $allocated)) (< 0 i_25)) (and (< (- i_25 1) (|Seq#Length| ar)) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 7) 2) anon5_Then_correct) (=> (= (ControlFlow 0 7) 6) anon5_Else_correct))))))
