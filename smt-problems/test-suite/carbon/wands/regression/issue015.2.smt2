...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 x@@20 $allocated))) (=> (and (and (not (= x@@20 null)) (= Mask@0 (MapType1Store ZeroMask x@@20 next (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@20 next)) FullPerm))))) (and (state Heap@@11 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@0 x@@20 next)))))
