...
(declare-fun node__val () T@U)
(declare-fun node__next () T@U)
...
(declare-fun node__state (T@U) T@U)
(declare-fun PredicateType_node__stateType () T@T)
(declare-fun |node__contents'| (T@U T@U) T@U)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |node__contents#triggerStateless| (T@U) T@U)
(declare-fun |node__state#trigger| (T@U T@U) Bool)
(declare-fun |node__state#everUsed| (T@U) Bool)
...
(declare-fun |node__state#sm| (T@U) T@U)
...
(declare-fun |node__contents#frame| (T@U T@U) T@U)
...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type node__val) (FieldType NormalFieldType intType))) (= (Ctor RefType) 8)) (= (type node__next) (FieldType NormalFieldType RefType))))
(assert (distinct $allocated node__val node__next)
)
...
(assert  (and (= (Ctor PredicateType_node__stateType) 13) (forall ((arg0@@29 T@U) ) (! (= (type (node__state arg0@@29)) (FieldType PredicateType_node__stateType FrameTypeType))
 :qid |funType:node__state|
 :pattern ( (node__state arg0@@29))
))))
(assert (forall ((diz T@U) ) (!  (=> (= (type diz) RefType) (IsPredicateField (node__state diz)))
 :qid |stdinbpl.706:15|
 :skolemid |64|
 :pattern ( (node__state diz))
)))
(assert  (and (forall ((arg0@@30 T@U) (arg1@@11 T@U) ) (! (= (type (|node__contents'| arg0@@30 arg1@@11)) (SeqType intType))
 :qid |funType:node__contents'|
 :pattern ( (|node__contents'| arg0@@30 arg1@@11))
)) (forall ((arg0@@31 T@U) ) (! (= (type (|node__contents#triggerStateless| arg0@@31)) (SeqType intType))
 :qid |funType:node__contents#triggerStateless|
 :pattern ( (|node__contents#triggerStateless| arg0@@31))
))))
(assert (forall ((Heap@@2 T@U) (diz@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type diz@@0) RefType)) (dummyFunction (|node__contents#triggerStateless| diz@@0)))
 :qid |stdinbpl.562:15|
 :skolemid |59|
 :pattern ( (|node__contents'| Heap@@2 diz@@0))
)))
(assert (forall ((Heap@@3 T@U) (diz@@1 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type diz@@1) RefType)) (|node__state#everUsed| (node__state diz@@1)))
 :qid |stdinbpl.725:15|
 :skolemid |68|
 :pattern ( (|node__state#trigger| Heap@@3 (node__state diz@@1)))
)))
...
(assert (forall ((arg0@@35 T@U) (arg1@@15 T@U) ) (! (= (type (node__contents arg0@@35 arg1@@15)) (SeqType intType))
 :qid |funType:node__contents|
 :pattern ( (node__contents arg0@@35 arg1@@15))
)))
(assert (forall ((Heap@@5 T@U) (diz@@2 T@U) ) (!  (=> (and (= (type Heap@@5) (MapType0Type RefType)) (= (type diz@@2) RefType)) (and (= (node__contents Heap@@5 diz@@2) (|node__contents'| Heap@@5 diz@@2)) (dummyFunction (|node__contents#triggerStateless| diz@@2))))
 :qid |stdinbpl.558:15|
 :skolemid |58|
 :pattern ( (node__contents Heap@@5 diz@@2))
)))
...
(assert (forall ((diz@@3 T@U) (diz2 T@U) ) (!  (=> (and (and (= (type diz@@3) RefType) (= (type diz2) RefType)) (= (node__state diz@@3) (node__state diz2))) (= diz@@3 diz2))
 :qid |stdinbpl.716:15|
 :skolemid |66|
 :pattern ( (node__state diz@@3) (node__state diz2))
)))
(assert (forall ((arg0@@37 T@U) ) (! (= (type (|node__state#sm| arg0@@37)) (FieldType PredicateType_node__stateType (MapType1Type RefType boolType)))
 :qid |funType:node__state#sm|
 :pattern ( (|node__state#sm| arg0@@37))
)))
(assert (forall ((diz@@4 T@U) (diz2@@0 T@U) ) (!  (=> (and (and (= (type diz@@4) RefType) (= (type diz2@@0) RefType)) (= (|node__state#sm| diz@@4) (|node__state#sm| diz2@@0))) (= diz@@4 diz2@@0))
 :qid |stdinbpl.720:15|
 :skolemid |67|
...
(assert  (not (IsPredicateField node__val)))
(assert  (not (IsWandField node__val)))
(assert  (not (IsPredicateField node__next)))
(assert  (not (IsWandField node__next)))
...
(assert (forall ((Heap@@8 T@U) (Mask@@6 T@U) (diz@@5 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (= (type diz@@5) RefType)) (and (state Heap@@8 Mask@@6) (< AssumeFunctionsAbove 0))) (not (= diz@@5 null))) (= (node__contents Heap@@8 diz@@5) (ite (= (MapType0Select Heap@@8 diz@@5 node__next) null) (|Seq#Singleton| (MapType0Select Heap@@8 diz@@5 node__val)) (|Seq#Append| (|Seq#Singleton| (MapType0Select Heap@@8 diz@@5 node__val)) (|node__contents'| Heap@@8 (MapType0Select Heap@@8 diz@@5 node__next))))))
 :qid |stdinbpl.568:15|
 :skolemid |60|
 :pattern ( (state Heap@@8 Mask@@6) (node__contents Heap@@8 diz@@5))
 :pattern ( (state Heap@@8 Mask@@6) (|node__contents#triggerStateless| diz@@5) (|node__state#trigger| Heap@@8 (node__state diz@@5)))
)))
...
(assert (forall ((diz@@6 T@U) ) (!  (=> (= (type diz@@6) RefType) (= (getPredWandId (node__state diz@@6)) 0))
 :qid |stdinbpl.710:15|
 :skolemid |65|
...
(assert (forall ((arg0@@40 T@U) (arg1@@18 T@U) ) (! (= (type (|node__contents#frame| arg0@@40 arg1@@18)) (SeqType intType))
 :qid |funType:node__contents#frame|
 :pattern ( (|node__contents#frame| arg0@@40 arg1@@18))
)))
(assert (forall ((Heap@@11 T@U) (Mask@@10 T@U) (diz@@7 T@U) ) (!  (=> (and (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type diz@@7) RefType)) (state Heap@@11 Mask@@10)) (= (|node__contents'| Heap@@11 diz@@7) (|node__contents#frame| (MapType0Select Heap@@11 null (node__state diz@@7)) diz@@7)))
 :qid |stdinbpl.575:15|
 :skolemid |61|
 :pattern ( (state Heap@@11 Mask@@10) (|node__contents'| Heap@@11 diz@@7))
 :pattern ( (state Heap@@11 Mask@@10) (|node__contents#triggerStateless| diz@@7) (|node__state#trigger| Heap@@11 (node__state diz@@7)))
)))
...
(assert (forall ((diz@@8 T@U) ) (!  (=> (= (type diz@@8) RefType) (= (PredicateMaskField (node__state diz@@8)) (|node__state#sm| diz@@8)))
 :qid |stdinbpl.702:15|
 :skolemid |63|
 :pattern ( (PredicateMaskField (node__state diz@@8)))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@9) (MapType0Type RefType)) (= (type freshObj@0) RefType)) (= (type n@@13) RefType)) (= (type Heap@@14) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@8) (MapType1Type RefType realType))) (= (type AssertMask@0) (MapType1Type RefType realType))) (= (type Heap@7) (MapType0Type RefType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@8) (MapType0Type RefType))) (= (type Heap@6) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@7) (MapType1Type RefType realType))) (forall ((arg0@@41 T@U) (arg1@@19 T@U) ) (! (= (type (CombineFrames arg0@@41 arg1@@19)) FrameTypeType)
...
))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type diz@@9) RefType)) (= (type __flatten_2) RefType)) (= (type __flatten_5) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type sys__result) RefType)) (= (type PostHeap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id node__node)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 67) (let ((anon6_correct true))
(let ((anon44_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 59) 56)) anon6_correct)))
(let ((anon44_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 57) (- 0 58)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (node__state sys__result))))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (node__state sys__result)))) (=> (= (ControlFlow 0 57) 56) anon6_correct))))))
(let ((anon43_Then_correct  (and (=> (= (ControlFlow 0 60) (- 0 61)) (not (= sys__result null))) (=> (not (= sys__result null)) (and (=> (= (ControlFlow 0 60) 57) anon44_Then_correct) (=> (= (ControlFlow 0 60) 59) anon44_Else_correct))))))
(let ((anon12_correct true))
(let ((anon47_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 52) 49)) anon12_correct)))
(let ((anon47_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 50) (- 0 51)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (node__state n@@13))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (node__state n@@13)))) (=> (= (ControlFlow 0 50) 49) anon12_correct))))))
(let ((anon46_Then_correct  (and (=> (= (ControlFlow 0 53) (- 0 54)) (not (= n@@13 null))) (=> (not (= n@@13 null)) (and (=> (= (ControlFlow 0 53) 50) anon47_Then_correct) (=> (= (ControlFlow 0 53) 52) anon47_Else_correct))))))
(let ((anon13_correct true))
(let ((anon45_Else_correct  (=> (not (= n@@13 null)) (and (=> (= (ControlFlow 0 55) 53) anon46_Then_correct) (=> (= (ControlFlow 0 55) 47) anon13_correct)))))
(let ((anon45_Then_correct  (=> (and (= n@@13 null) (= (ControlFlow 0 48) 47)) anon13_correct)))
(let ((anon42_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (not (= sys__result null)) (state PostHeap@0 ZeroMask)) (=> (and (and (= PostMask@0 (MapType1Store ZeroMask null (node__state sys__result) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (node__state sys__result))) FullPerm)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (and (=> (= (ControlFlow 0 62) 60) anon43_Then_correct) (=> (= (ControlFlow 0 62) 48) anon45_Then_correct)) (=> (= (ControlFlow 0 62) 55) anon45_Else_correct)))))))
(let ((anon31_correct true))
(let ((anon56_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 15) 12)) anon31_correct)))
(let ((anon56_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= FullPerm (U_2_real (MapType1Select Mask@8 null (node__state freshObj@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@8 null (node__state freshObj@0)))) (=> (= (ControlFlow 0 13) 12) anon31_correct))))))
(let ((anon55_Then_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (not (= freshObj@0 null))) (=> (not (= freshObj@0 null)) (and (=> (= (ControlFlow 0 16) 13) anon56_Then_correct) (=> (= (ControlFlow 0 16) 15) anon56_Else_correct))))))
(let ((anon37_correct true))
(let ((anon59_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon37_correct)))
(let ((anon59_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (node__state n@@13))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (node__state n@@13)))) (=> (= (ControlFlow 0 6) 5) anon37_correct))))))
(let ((anon58_Then_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (not (= n@@13 null))) (=> (not (= n@@13 null)) (and (=> (= (ControlFlow 0 9) 6) anon59_Then_correct) (=> (= (ControlFlow 0 9) 8) anon59_Else_correct))))))
(let ((anon38_correct  (=> (= (ControlFlow 0 2) (- 0 3)) (|Seq#Equal| (node__contents Heap@9 freshObj@0) (ite (= n@@13 null) (|Seq#Singleton| (int_2_U v_2)) (|Seq#Append| (|Seq#Singleton| (int_2_U v_2)) (node__contents Heap@@14 n@@13)))))))
(let ((anon57_Else_correct  (=> (not (= n@@13 null)) (and (=> (= (ControlFlow 0 11) 9) anon58_Then_correct) (=> (= (ControlFlow 0 11) 2) anon38_correct)))))
(let ((anon57_Then_correct  (=> (and (= n@@13 null) (= (ControlFlow 0 4) 2)) anon38_correct)))
(let ((anon28_correct  (=> (= AssertMask@0 (MapType1Store Mask@8 null (node__state freshObj@0) (real_2_U (- (U_2_real (MapType1Select Mask@8 null (node__state freshObj@0))) FullPerm)))) (and (and (=> (= (ControlFlow 0 18) 16) anon55_Then_correct) (=> (= (ControlFlow 0 18) 4) anon57_Then_correct)) (=> (= (ControlFlow 0 18) 11) anon57_Else_correct)))))
(let ((anon54_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 21) 18)) anon28_correct)))
(let ((anon54_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (<= FullPerm (U_2_real (MapType1Select Mask@8 null (node__state freshObj@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@8 null (node__state freshObj@0)))) (=> (= (ControlFlow 0 19) 18) anon28_correct))))))
(let ((anon26_correct  (=> (state Heap@9 Mask@8) (=> (and (state Heap@9 Mask@8) (state Heap@9 Mask@8)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (not (= freshObj@0 null))) (=> (not (= freshObj@0 null)) (and (=> (= (ControlFlow 0 22) 19) anon54_Then_correct) (=> (= (ControlFlow 0 22) 21) anon54_Else_correct))))))))
(let ((anon53_Else_correct  (=> (= (MapType0Select Heap@7 freshObj@0 node__next) null) (=> (and (= Heap@9 Heap@7) (= (ControlFlow 0 25) 22)) anon26_correct))))
(let ((anon53_Then_correct  (=> (not (= (MapType0Select Heap@7 freshObj@0 node__next) null)) (=> (and (and (forall ((o_4 T@U) (f_8 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_8))))
(let ((A@@12 (FieldTypeInv0 (type f_8))))
 (=> (and (and (= (type o_4) RefType) (= (type f_8) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@7 null (|node__state#sm| freshObj@0)) o_4 f_8)) (U_2_bool (MapType1Select (MapType0Select Heap@7 null (|node__state#sm| (MapType0Select Heap@7 freshObj@0 node__next))) o_4 f_8)))) (U_2_bool (MapType1Select newPMask@0 o_4 f_8)))))
 :qid |stdinbpl.957:29|
 :skolemid |69|
 :pattern ( (MapType1Select newPMask@0 o_4 f_8))
)) (= Heap@8 (MapType0Store Heap@7 null (|node__state#sm| freshObj@0) newPMask@0))) (and (= Heap@9 Heap@8) (= (ControlFlow 0 24) 22))) anon26_correct))))
(let ((anon24_correct  (=> (and (= Heap@6 (MapType0Store Heap@5 null (|node__state#sm| freshObj@0) (MapType1Store (MapType0Select Heap@5 null (|node__state#sm| freshObj@0)) freshObj@0 node__val (bool_2_U true)))) (= Heap@7 (MapType0Store Heap@6 null (|node__state#sm| freshObj@0) (MapType1Store (MapType0Select Heap@6 null (|node__state#sm| freshObj@0)) freshObj@0 node__next (bool_2_U true))))) (and (=> (= (ControlFlow 0 26) 24) anon53_Then_correct) (=> (= (ControlFlow 0 26) 25) anon53_Else_correct)))))
(let ((anon52_Else_correct  (=> (HasDirectPerm Mask@8 null (node__state freshObj@0)) (=> (and (= Heap@5 Heap@2) (= (ControlFlow 0 28) 26)) anon24_correct))))
(let ((anon52_Then_correct  (=> (not (HasDirectPerm Mask@8 null (node__state freshObj@0))) (=> (and (and (= Heap@3 (MapType0Store Heap@2 null (|node__state#sm| freshObj@0) ZeroPMask)) (= Heap@4 (MapType0Store Heap@3 null (node__state freshObj@0) freshVersion@0))) (and (= Heap@5 Heap@4) (= (ControlFlow 0 27) 26))) anon24_correct))))
(let ((anon22_correct  (=> (= Mask@8 (MapType1Store Mask@7 null (node__state freshObj@0) (real_2_U (+ (U_2_real (MapType1Select Mask@7 null (node__state freshObj@0))) FullPerm)))) (=> (and (and (state Heap@2 Mask@8) (state Heap@2 Mask@8)) (and (|node__state#trigger| Heap@2 (node__state freshObj@0)) (= (MapType0Select Heap@2 null (node__state freshObj@0)) (CombineFrames (FrameFragment (MapType0Select Heap@2 freshObj@0 node__val)) (CombineFrames (FrameFragment (MapType0Select Heap@2 freshObj@0 node__next)) (FrameFragment (ite (not (= (MapType0Select Heap@2 freshObj@0 node__next) null)) (MapType0Select Heap@2 null (node__state (MapType0Select Heap@2 freshObj@0 node__next))) EmptyFrame))))))) (and (=> (= (ControlFlow 0 29) 27) anon52_Then_correct) (=> (= (ControlFlow 0 29) 28) anon52_Else_correct))))))
(let ((anon21_correct  (=> (and (and (= Mask@6 (MapType1Store Mask@5 null (node__state (MapType0Select Heap@2 freshObj@0 node__next)) (real_2_U (- (U_2_real (MapType1Select Mask@5 null (node__state (MapType0Select Heap@2 freshObj@0 node__next)))) FullPerm)))) (InsidePredicate (node__state freshObj@0) (MapType0Select Heap@2 null (node__state freshObj@0)) (node__state (MapType0Select Heap@2 freshObj@0 node__next)) (MapType0Select Heap@2 null (node__state (MapType0Select Heap@2 freshObj@0 node__next))))) (and (= Mask@7 Mask@6) (= (ControlFlow 0 31) 29))) anon22_correct)))
(let ((anon51_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 34) 31)) anon21_correct)))
(let ((anon51_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 32) (- 0 33)) (<= FullPerm (U_2_real (MapType1Select Mask@5 null (node__state (MapType0Select Heap@2 freshObj@0 node__next)))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@5 null (node__state (MapType0Select Heap@2 freshObj@0 node__next))))) (=> (= (ControlFlow 0 32) 31) anon21_correct))))))
(let ((anon50_Then_correct  (=> (not (= (MapType0Select Heap@2 freshObj@0 node__next) null)) (and (=> (= (ControlFlow 0 35) 32) anon51_Then_correct) (=> (= (ControlFlow 0 35) 34) anon51_Else_correct)))))
(let ((anon50_Else_correct  (=> (= (MapType0Select Heap@2 freshObj@0 node__next) null) (=> (and (= Mask@7 Mask@5) (= (ControlFlow 0 30) 29)) anon22_correct))))
(let ((anon18_correct  (=> (= Mask@5 (MapType1Store Mask@4 freshObj@0 node__next (real_2_U (- (U_2_real (MapType1Select Mask@4 freshObj@0 node__next)) FullPerm)))) (and (=> (= (ControlFlow 0 36) 35) anon50_Then_correct) (=> (= (ControlFlow 0 36) 30) anon50_Else_correct)))))
(let ((anon49_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 39) 36)) anon18_correct)))
(let ((anon49_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 37) (- 0 38)) (<= FullPerm (U_2_real (MapType1Select Mask@4 freshObj@0 node__next)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 freshObj@0 node__next))) (=> (= (ControlFlow 0 37) 36) anon18_correct))))))
(let ((anon16_correct  (=> (= Mask@4 (MapType1Store Mask@3 freshObj@0 node__val (real_2_U (- (U_2_real (MapType1Select Mask@3 freshObj@0 node__val)) FullPerm)))) (and (=> (= (ControlFlow 0 40) 37) anon49_Then_correct) (=> (= (ControlFlow 0 40) 39) anon49_Else_correct)))))
(let ((anon48_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 43) 40)) anon16_correct)))
(let ((anon48_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 41) (- 0 42)) (<= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 node__val)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 node__val))) (=> (= (ControlFlow 0 41) 40) anon16_correct))))))
(let ((anon42_Else_correct  (=> (U_2_bool (MapType0Select Heap@@14 diz@@9 $allocated)) (=> (and (U_2_bool (MapType0Select Heap@@14 __flatten_2 $allocated)) (U_2_bool (MapType0Select Heap@@14 __flatten_5 $allocated))) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@14 freshObj@0 $allocated)))) (and (= Heap@0 (MapType0Store Heap@@14 freshObj@0 $allocated (bool_2_U true))) (= Mask@2 (MapType1Store Mask@1 freshObj@0 node__val (real_2_U (+ (U_2_real (MapType1Select Mask@1 freshObj@0 node__val)) FullPerm)))))) (and (and (= Mask@3 (MapType1Store Mask@2 freshObj@0 node__next (real_2_U (+ (U_2_real (MapType1Select Mask@2 freshObj@0 node__next)) FullPerm)))) (state Heap@0 Mask@3)) (and (state Heap@0 Mask@3) (state Heap@0 Mask@3)))) (and (=> (= (ControlFlow 0 44) (- 0 46)) (= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 node__val)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 node__val))) (=> (and (and (= Heap@1 (MapType0Store Heap@0 freshObj@0 node__val (int_2_U v_2))) (state Heap@1 Mask@3)) (and (state Heap@1 Mask@3) (state Heap@1 Mask@3))) (and (=> (= (ControlFlow 0 44) (- 0 45)) (= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 node__next)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 node__next))) (=> (and (= Heap@2 (MapType0Store Heap@1 freshObj@0 node__next n@@13)) (state Heap@2 Mask@3)) (and (=> (= (ControlFlow 0 44) 41) anon48_Then_correct) (=> (= (ControlFlow 0 44) 43) anon48_Else_correct)))))))))))))
(let ((anon2_correct  (=> (state Heap@@14 Mask@1) (and (=> (= (ControlFlow 0 63) 62) anon42_Then_correct) (=> (= (ControlFlow 0 63) 44) anon42_Else_correct)))))
(let ((anon41_Else_correct  (=> (= n@@13 null) (=> (and (= Mask@1 ZeroMask) (= (ControlFlow 0 65) 63)) anon2_correct))))
(let ((anon41_Then_correct  (=> (not (= n@@13 null)) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (node__state n@@13) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (node__state n@@13))) FullPerm)))) (state Heap@@14 Mask@0)) (and (= Mask@1 Mask@0) (= (ControlFlow 0 64) 63))) anon2_correct))))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@14 n@@13 $allocated))) (and (>= current_thread_id 0) (state Heap@@14 ZeroMask))) (and (=> (= (ControlFlow 0 66) 64) anon41_Then_correct) (=> (= (ControlFlow 0 66) 65) anon41_Else_correct))))))
