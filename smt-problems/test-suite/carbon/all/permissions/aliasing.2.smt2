...
(assert  (and (= (Ctor PredicateType_InvType) 13) (forall ((arg0@@29 T@U) ) (! (= (type (Inv arg0@@29)) (FieldType PredicateType_InvType FrameTypeType))
 :qid |funType:Inv|
 :pattern ( (Inv arg0@@29))
))))
(assert (forall ((r_1 T@U) ) (!  (=> (= (type r_1) RefType) (IsPredicateField (Inv r_1)))
 :qid |stdinbpl.571:15|
 :skolemid |59|
 :pattern ( (Inv r_1))
)))
(assert (forall ((Heap@@2 T@U) (r_1@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type r_1@@0) RefType)) (|Inv#everUsed| (Inv r_1@@0)))
 :qid |stdinbpl.590:15|
 :skolemid |63|
 :pattern ( (|Inv#trigger| Heap@@2 (Inv r_1@@0)))
)))
...
(assert (forall ((r_1@@1 T@U) (r2 T@U) ) (!  (=> (and (and (= (type r_1@@1) RefType) (= (type r2) RefType)) (= (Inv r_1@@1) (Inv r2))) (= r_1@@1 r2))
 :qid |stdinbpl.581:15|
 :skolemid |61|
 :pattern ( (Inv r_1@@1) (Inv r2))
)))
(assert (forall ((arg0@@34 T@U) ) (! (= (type (|Inv#sm| arg0@@34)) (FieldType PredicateType_InvType (MapType1Type RefType boolType)))
 :qid |funType:Inv#sm|
 :pattern ( (|Inv#sm| arg0@@34))
)))
(assert (forall ((r_1@@2 T@U) (r2@@0 T@U) ) (!  (=> (and (and (= (type r_1@@2) RefType) (= (type r2@@0) RefType)) (= (|Inv#sm| r_1@@2) (|Inv#sm| r2@@0))) (= r_1@@2 r2@@0))
 :qid |stdinbpl.585:15|
 :skolemid |62|
...
(assert (forall ((r_1@@3 T@U) ) (!  (=> (= (type r_1@@3) RefType) (= (getPredWandId (Inv r_1@@3)) 0))
 :qid |stdinbpl.575:15|
 :skolemid |60|
 :pattern ( (Inv r_1@@3))
)))
...
(assert (forall ((r_1@@4 T@U) ) (!  (=> (= (type r_1@@4) RefType) (= (PredicateMaskField (Inv r_1@@4)) (|Inv#sm| r_1@@4)))
 :qid |stdinbpl.567:15|
 :skolemid |58|
 :pattern ( (PredicateMaskField (Inv r_1@@4)))
)))
...
(declare-fun i@@6 () Int)
(declare-fun j@@5 () Int)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type s@@17) (SeqType RefType)) (= (type Unfolding1Mask@2) (MapType1Type RefType realType))) (= (type UnfoldingMask@3) (MapType1Type RefType realType))) (= (type Unfolding1Mask@3) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type r_1@@5) RefType)) (= (type Heap@2) (MapType0Type RefType))) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (forall ((arg0@@37 T@U) ) (! (= (type (FrameFragment arg0@@37)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@37))
))) (= (type Unfolding1Mask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Unfolding1Mask@1) (MapType1Type RefType realType))) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 45) (let ((anon23_correct true))
(let ((anon22_correct  (=> (= Unfolding1Mask@0 (MapType1Store UnfoldingMask@1 null (Inv (|Seq#Index| s@@17 i_6)) (real_2_U (- (U_2_real (MapType1Select UnfoldingMask@1 null (Inv (|Seq#Index| s@@17 i_6)))) FullPerm)))) (=> (and (and (not (= (|Seq#Index| s@@17 i_6) null)) (= Unfolding1Mask@1 (MapType1Store Unfolding1Mask@0 (|Seq#Index| s@@17 i_6) f_7 (real_2_U (+ (U_2_real (MapType1Select Unfolding1Mask@0 (|Seq#Index| s@@17 i_6) f_7)) FullPerm))))) (and (state Heap@@10 Unfolding1Mask@1) (state Heap@@10 Unfolding1Mask@1))) (and (=> (= (ControlFlow 0 31) (- 0 32)) (not (= (|Seq#Index| s@@17 i_6) r_1@@5))) (=> (not (= (|Seq#Index| s@@17 i_6) r_1@@5)) (=> (= (ControlFlow 0 31) 29) anon23_correct)))))))
(let ((anon36_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 35) 31)) anon22_correct)))
(let ((anon36_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 33) (- 0 34)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@1 null (Inv (|Seq#Index| s@@17 i_6)))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@1 null (Inv (|Seq#Index| s@@17 i_6))))) (=> (= (ControlFlow 0 33) 31) anon22_correct))))))
(let ((anon20_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (Inv r_1@@5) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (Inv r_1@@5))) FullPerm)))) (=> (and (not (= r_1@@5 null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 r_1@@5 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 r_1@@5 f_7)) FullPerm))))) (=> (and (and (state Heap@@10 UnfoldingMask@1) (state Heap@@10 UnfoldingMask@1)) (and (|Inv#trigger| Heap@@10 (Inv (|Seq#Index| s@@17 i_6))) (= (MapType0Select Heap@@10 null (Inv (|Seq#Index| s@@17 i_6))) (FrameFragment (MapType0Select Heap@@10 (|Seq#Index| s@@17 i_6) f_7))))) (and (=> (= (ControlFlow 0 36) 33) anon36_Then_correct) (=> (= (ControlFlow 0 36) 35) anon36_Else_correct)))))))
(let ((anon35_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 39) 36)) anon20_correct)))
(let ((anon35_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 37) (- 0 38)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Inv r_1@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Inv r_1@@5)))) (=> (= (ControlFlow 0 37) 36) anon20_correct))))))
(let ((anon34_Then_correct  (=> (and (and (<= 0 i_6) (< i_6 (|Seq#Length| s@@17))) (and (|Inv#trigger| Heap@@10 (Inv r_1@@5)) (= (MapType0Select Heap@@10 null (Inv r_1@@5)) (FrameFragment (MapType0Select Heap@@10 r_1@@5 f_7))))) (and (=> (= (ControlFlow 0 40) 37) anon35_Then_correct) (=> (= (ControlFlow 0 40) 39) anon35_Else_correct)))))
(let ((anon34_Else_correct  (=> (and (not (and (<= 0 i_6) (< i_6 (|Seq#Length| s@@17)))) (= (ControlFlow 0 30) 29)) anon23_correct)))
(let ((anon15_correct true))
(let ((anon14_correct  (=> (= Unfolding1Mask@2 (MapType1Store UnfoldingMask@3 null (Inv (|Seq#Index| s@@17 i_4)) (real_2_U (- (U_2_real (MapType1Select UnfoldingMask@3 null (Inv (|Seq#Index| s@@17 i_4)))) FullPerm)))) (=> (and (and (not (= (|Seq#Index| s@@17 i_4) null)) (= Unfolding1Mask@3 (MapType1Store Unfolding1Mask@2 (|Seq#Index| s@@17 i_4) f_7 (real_2_U (+ (U_2_real (MapType1Select Unfolding1Mask@2 (|Seq#Index| s@@17 i_4) f_7)) FullPerm))))) (and (state Heap@@10 Unfolding1Mask@3) (state Heap@@10 Unfolding1Mask@3))) (and (=> (= (ControlFlow 0 16) (- 0 20)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 16) (- 0 19)) (< i_4 (|Seq#Length| s@@17))) (=> (< i_4 (|Seq#Length| s@@17)) (and (=> (= (ControlFlow 0 16) (- 0 18)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 16) (- 0 17)) (< i_4 (|Seq#Length| s@@17))) (=> (< i_4 (|Seq#Length| s@@17)) (=> (= Heap@0 (MapType0Store Heap@@10 null (|Inv#sm| (|Seq#Index| s@@17 i_4)) (MapType1Store (MapType0Select Heap@@10 null (|Inv#sm| (|Seq#Index| s@@17 i_4))) (|Seq#Index| s@@17 i_4) f_7 (bool_2_U true)))) (=> (and (state Heap@0 Mask@0) (= Heap@1 (MapType0Store Heap@0 null (|Inv#sm| r_1@@5) (MapType1Store (MapType0Select Heap@0 null (|Inv#sm| r_1@@5)) r_1@@5 f_7 (bool_2_U true))))) (=> (and (and (state Heap@1 Mask@0) (= Heap@2 (MapType0Store Heap@1 null (|Inv#sm| (|Seq#Index| s@@17 i_4)) (MapType1Store (MapType0Select Heap@1 null (|Inv#sm| (|Seq#Index| s@@17 i_4))) (|Seq#Index| s@@17 i_4) f_7 (bool_2_U true))))) (and (state Heap@2 Mask@0) (= (ControlFlow 0 16) 14))) anon15_correct)))))))))))))))
(let ((anon32_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 23) 16)) anon14_correct)))
(let ((anon32_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@3 null (Inv (|Seq#Index| s@@17 i_4)))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@3 null (Inv (|Seq#Index| s@@17 i_4))))) (=> (= (ControlFlow 0 21) 16) anon14_correct))))))
(let ((anon12_correct  (=> (= UnfoldingMask@2 (MapType1Store Mask@0 null (Inv r_1@@5) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (Inv r_1@@5))) FullPerm)))) (=> (and (not (= r_1@@5 null)) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 r_1@@5 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 r_1@@5 f_7)) FullPerm))))) (=> (and (and (state Heap@@10 UnfoldingMask@3) (state Heap@@10 UnfoldingMask@3)) (and (|Inv#trigger| Heap@@10 (Inv (|Seq#Index| s@@17 i_4))) (= (MapType0Select Heap@@10 null (Inv (|Seq#Index| s@@17 i_4))) (FrameFragment (MapType0Select Heap@@10 (|Seq#Index| s@@17 i_4) f_7))))) (and (=> (= (ControlFlow 0 24) 21) anon32_Then_correct) (=> (= (ControlFlow 0 24) 23) anon32_Else_correct)))))))
(let ((anon31_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 27) 24)) anon12_correct)))
(let ((anon31_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 25) (- 0 26)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Inv r_1@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Inv r_1@@5)))) (=> (= (ControlFlow 0 25) 24) anon12_correct))))))
(let ((anon30_Then_correct  (=> (and (and (<= 0 i_4) (< i_4 (|Seq#Length| s@@17))) (and (|Inv#trigger| Heap@@10 (Inv r_1@@5)) (= (MapType0Select Heap@@10 null (Inv r_1@@5)) (FrameFragment (MapType0Select Heap@@10 r_1@@5 f_7))))) (and (=> (= (ControlFlow 0 28) 25) anon31_Then_correct) (=> (= (ControlFlow 0 28) 27) anon31_Else_correct)))))
(let ((anon30_Else_correct  (=> (and (not (and (<= 0 i_4) (< i_4 (|Seq#Length| s@@17)))) (= (ControlFlow 0 15) 14)) anon15_correct)))
(let ((anon33_Else_correct true))
(let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 41) (- 0 42)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 (|Seq#Length| s@@17)))) (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length| s@@17)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| s@@17 i_3) (|Seq#Index| s@@17 i_3_1))))
 :qid |stdinbpl.760:17|
 :skolemid |65|
 :pattern ( (neverTriggered1 i_3) (neverTriggered1 i_3_1))
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (and (<= 0 i_3@@0) (< i_3@@0 (|Seq#Length| s@@17)))) (and (<= 0 i_3_1@@0) (< i_3_1@@0 (|Seq#Length| s@@17)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| s@@17 i_3@@0) (|Seq#Index| s@@17 i_3_1@@0))))
 :qid |stdinbpl.760:17|
 :skolemid |65|
 :pattern ( (neverTriggered1 i_3@@0) (neverTriggered1 i_3_1@@0))
)) (=> (and (and (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 (|Seq#Length| s@@17))) (< NoPerm FullPerm)) (and (= (invRecv1 (|Seq#Index| s@@17 i_3@@1)) i_3@@1) (qpRange1 (|Seq#Index| s@@17 i_3@@1))))
 :qid |stdinbpl.766:22|
 :skolemid |66|
 :pattern ( (MapType0Select Heap@@10 null (Inv (|Seq#Index| s@@17 i_3@@1))))
 :pattern ( (MapType1Select ZeroMask null (Inv (|Seq#Index| s@@17 i_3@@1))))
 :pattern ( (|Seq#Index| s@@17 i_3@@1))
)) (forall ((r_1_1 T@U) ) (!  (=> (= (type r_1_1) RefType) (=> (and (and (and (<= 0 (invRecv1 r_1_1)) (< (invRecv1 r_1_1) (|Seq#Length| s@@17))) (< NoPerm FullPerm)) (qpRange1 r_1_1)) (= (|Seq#Index| s@@17 (invRecv1 r_1_1)) r_1_1)))
 :qid |stdinbpl.770:22|
 :skolemid |67|
 :pattern ( (invRecv1 r_1_1))
))) (and (forall ((r_1_1@@0 T@U) ) (!  (=> (= (type r_1_1@@0) RefType) (=> (and (and (and (<= 0 (invRecv1 r_1_1@@0)) (< (invRecv1 r_1_1@@0) (|Seq#Length| s@@17))) (< NoPerm FullPerm)) (qpRange1 r_1_1@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| s@@17 (invRecv1 r_1_1@@0)) r_1_1@@0)) (= (U_2_real (MapType1Select QPMask@0 null (Inv r_1_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (Inv r_1_1@@0))) FullPerm)))))
 :qid |stdinbpl.776:22|
 :skolemid |68|
 :pattern ( (MapType1Select QPMask@0 null (Inv r_1_1@@0)))
...
)))) (=> (and (and (and (forall ((r_1_1@@1 T@U) ) (!  (=> (and (= (type r_1_1@@1) RefType) (not (and (and (and (<= 0 (invRecv1 r_1_1@@1)) (< (invRecv1 r_1_1@@1) (|Seq#Length| s@@17))) (< NoPerm FullPerm)) (qpRange1 r_1_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (Inv r_1_1@@1))) (U_2_real (MapType1Select ZeroMask null (Inv r_1_1@@1)))))
 :qid |stdinbpl.786:22|
 :skolemid |70|
 :pattern ( (MapType1Select QPMask@0 null (Inv r_1_1@@1)))
)) (state Heap@@10 QPMask@0)) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0))) (and (and (= Mask@0 (MapType1Store QPMask@0 null (Inv r_1@@5) (real_2_U (+ (U_2_real (MapType1Select QPMask@0 null (Inv r_1@@5))) FullPerm)))) (state Heap@@10 Mask@0)) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)))) (and (and (and (and (=> (= (ControlFlow 0 41) 13) anon33_Else_correct) (=> (= (ControlFlow 0 41) 40) anon34_Then_correct)) (=> (= (ControlFlow 0 41) 30) anon34_Else_correct)) (=> (= (ControlFlow 0 41) 28) anon30_Then_correct)) (=> (= (ControlFlow 0 41) 15) anon30_Else_correct))))))))
(let ((anon7_correct true))
(let ((anon28_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 (|Seq#Length| s@@17)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon28_Then_correct  (=> (and (<= 0 i_2) (< i_2 (|Seq#Length| s@@17))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_2 (|Seq#Length| s@@17))) (=> (< i_2 (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon25_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (<= 0 i_1) (and (< i_1 (|Seq#Length| s@@17)) (and (<= 0 j_1) (and (< j_1 (|Seq#Length| s@@17)) (not (= i_1 j_1)))))) (not (= (|Seq#Index| s@@17 i_1) (|Seq#Index| s@@17 j_1))))
 :qid |stdinbpl.730:20|
 :skolemid |64|
 :pattern ( (|Seq#Index| s@@17 i_1) (|Seq#Index| s@@17 j_1))
)) (state Heap@@10 ZeroMask)) (and (and (=> (= (ControlFlow 0 43) 41) anon27_Else_correct) (=> (= (ControlFlow 0 43) 9) anon28_Then_correct)) (=> (= (ControlFlow 0 43) 12) anon28_Else_correct)))))
(let ((anon3_correct true))
(let ((anon26_Else_correct  (=> (and (not (and (<= 0 i@@6) (and (< i@@6 (|Seq#Length| s@@17)) (and (<= 0 j@@5) (and (< j@@5 (|Seq#Length| s@@17)) (not (= i@@6 j@@5))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon26_Then_correct  (=> (and (<= 0 i@@6) (and (< i@@6 (|Seq#Length| s@@17)) (and (<= 0 j@@5) (and (< j@@5 (|Seq#Length| s@@17)) (not (= i@@6 j@@5)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i@@6 (|Seq#Length| s@@17))) (=> (< i@@6 (|Seq#Length| s@@17)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j@@5 (|Seq#Length| s@@17))) (=> (< j@@5 (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 r_1@@5 $allocated))) (and (and (=> (= (ControlFlow 0 44) 43) anon25_Else_correct) (=> (= (ControlFlow 0 44) 2) anon26_Then_correct)) (=> (= (ControlFlow 0 44) 7) anon26_Else_correct)))))
