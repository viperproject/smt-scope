...
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type UnfoldingMask@2) (MapType1Type RefType realType)) (= (type Heap@@38) (MapType0Type RefType))) (= (type this@@38) RefType)) (= (type Result@0) (SeqType intType))) (= (type Heap@0) (MapType0Type RefType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (forall ((arg0@@50 T@U) (arg1@@35 T@U) ) (! (= (type (CombineFrames arg0@@50 arg1@@35)) FrameTypeType)
...
(let ((anon21_Else_correct  (=> (and (not (and (<= 0 i_2) (and (< i_2 j_2) (< j_2 (|Seq#Length| Result@0))))) (= (ControlFlow 0 16) 13)) anon13_correct)))
(let ((anon21_Then_correct  (=> (and (<= 0 i_2) (and (< i_2 j_2) (< j_2 (|Seq#Length| Result@0)))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= (U_2_int (|Seq#Index| Result@0 i_2)) (U_2_int (|Seq#Index| Result@0 j_2)))) (=> (<= (U_2_int (|Seq#Index| Result@0 i_2)) (U_2_int (|Seq#Index| Result@0 j_2))) (=> (= (ControlFlow 0 14) 13) anon13_correct))))))
(let ((anon9_correct true))
(let ((anon19_Else_correct  (=> (and (not (and (<= 0 i_3) (and (< i_3 j_3) (< j_3 (|Seq#Length| Result@0))))) (= (ControlFlow 0 12) 6)) anon9_correct)))
(let ((anon19_Then_correct  (=> (and (<= 0 i_3) (and (< i_3 j_3) (< j_3 (|Seq#Length| Result@0)))) (and (=> (= (ControlFlow 0 7) (- 0 11)) (>= i_3 0)) (=> (>= i_3 0) (and (=> (= (ControlFlow 0 7) (- 0 10)) (< i_3 (|Seq#Length| Result@0))) (=> (< i_3 (|Seq#Length| Result@0)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (>= j_3 0)) (=> (>= j_3 0) (and (=> (= (ControlFlow 0 7) (- 0 8)) (< j_3 (|Seq#Length| Result@0))) (=> (< j_3 (|Seq#Length| Result@0)) (=> (= (ControlFlow 0 7) 6) anon9_correct))))))))))))
(let ((anon20_Else_correct true))
(let ((anon16_Else_correct  (=> (= Heap@0 (MapType0Store Heap@@38 null (|List#sm| this@@38) (MapType1Store (MapType0Select Heap@@38 null (|List#sm| this@@38)) this@@38 head (bool_2_U true)))) (=> (and (and (forall ((o_14 T@U) (f_18 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_18))))
(let ((A@@12 (FieldTypeInv0 (type f_18))))
 (=> (and (and (= (type o_14) RefType) (= (type f_18) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@0 null (|List#sm| this@@38)) o_14 f_18)) (U_2_bool (MapType1Select (MapType0Select Heap@0 null (|lseg#sm| (MapType0Select Heap@0 this@@38 head) null)) o_14 f_18)))) (U_2_bool (MapType1Select newPMask@0 o_14 f_18)))))
 :qid |stdinbpl.1333:31|
 :skolemid |96|
 :pattern ( (MapType1Select newPMask@0 o_14 f_18))
)) (= Heap@1 (MapType0Store Heap@0 null (|List#sm| this@@38) newPMask@0))) (and (state Heap@1 Mask@0) (= Result@0 (contentNodes Heap@1 (MapType0Select Heap@1 this@@38 head) null)))) (and (and (and (and (=> (= (ControlFlow 0 17) 5) anon20_Else_correct) (=> (= (ControlFlow 0 17) 14) anon21_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon21_Else_correct)) (=> (= (ControlFlow 0 17) 7) anon19_Then_correct)) (=> (= (ControlFlow 0 17) 12) anon19_Else_correct))))))
(let ((anon5_correct true))
(let ((anon17_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon5_correct)))
(let ((anon17_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@2 null (lseg (MapType0Select Heap@@38 this@@38 head) null))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@2 null (lseg (MapType0Select Heap@@38 this@@38 head) null)))) (=> (= (ControlFlow 0 2) 1) anon5_correct))))))
(let ((anon2_correct  (=> (and (and (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (List this@@38) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (List this@@38))) FullPerm)))) (not (= this@@38 null))) (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this@@38 head (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this@@38 head)) FullPerm)))) (state Heap@@38 UnfoldingMask@1))) (and (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 null (lseg (MapType0Select Heap@@38 this@@38 head) null) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 null (lseg (MapType0Select Heap@@38 this@@38 head) null))) FullPerm)))) (InsidePredicate (List this@@38) (MapType0Select Heap@@38 null (List this@@38)) (lseg (MapType0Select Heap@@38 this@@38 head) null) (MapType0Select Heap@@38 null (lseg (MapType0Select Heap@@38 this@@38 head) null)))) (and (state Heap@@38 UnfoldingMask@2) (state Heap@@38 UnfoldingMask@2)))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm UnfoldingMask@2 this@@38 head)) (=> (HasDirectPerm UnfoldingMask@2 this@@38 head) (and (and (=> (= (ControlFlow 0 18) 17) anon16_Else_correct) (=> (= (ControlFlow 0 18) 2) anon17_Then_correct)) (=> (= (ControlFlow 0 18) 4) anon17_Else_correct)))))))
(let ((anon15_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 22) 18)) anon2_correct)))
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (List this@@38))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (List this@@38)))) (=> (= (ControlFlow 0 20) 18) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@38 ZeroMask) (U_2_bool (MapType0Select Heap@@38 this@@38 $allocated))) (and (= AssumeFunctionsAbove 2) (= Mask@0 (MapType1Store ZeroMask null (List this@@38) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (List this@@38))) FullPerm)))))) (and (and (state Heap@@38 Mask@0) (state Heap@@38 Mask@0)) (and (|List#trigger| Heap@@38 (List this@@38)) (= (MapType0Select Heap@@38 null (List this@@38)) (CombineFrames (FrameFragment (MapType0Select Heap@@38 this@@38 head)) (MapType0Select Heap@@38 null (lseg (MapType0Select Heap@@38 this@@38 head) null))))))) (and (=> (= (ControlFlow 0 23) 20) anon15_Then_correct) (=> (= (ControlFlow 0 23) 22) anon15_Else_correct)))))
