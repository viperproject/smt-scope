...
(declare-fun i_4 () Int)
(declare-fun j_2 () Int)
(assert  (and (and (and (= (type xs) (SeqType RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id init)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 40) (let ((anon8_correct true))
(let ((anon27_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_2))) (= (ControlFlow 0 36) 32)) anon8_correct)))
(let ((anon27_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_2)) (and (=> (= (ControlFlow 0 33) (- 0 35)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 33) (- 0 34)) (< i_2 (|Seq#Length| xs))) (=> (< i_2 (|Seq#Length| xs)) (=> (= (ControlFlow 0 33) 32) anon8_correct))))))))
(let ((anon26_Else_correct  (=> (= (ControlFlow 0 31) (- 0 30)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_3))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_3) (|Seq#Index| xs i_3_1))))
 :qid |stdinbpl.733:15|
 :skolemid |59|
)))))
(let ((anon24_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_1)) (not (= i_1 j_1)))) (not (= (|Seq#Index| xs i_1) (|Seq#Index| xs j_1))))
 :qid |stdinbpl.715:20|
 :skolemid |58|
...
(let ((anon25_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i@@6)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j@@5)) (not (= i@@6 j@@5))))) (= (ControlFlow 0 29) 23)) anon4_correct)))
(let ((anon25_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i@@6)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j@@5)) (not (= i@@6 j@@5)))) (and (=> (= (ControlFlow 0 24) (- 0 28)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 24) (- 0 27)) (< i@@6 (|Seq#Length| xs))) (=> (< i@@6 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 24) (- 0 26)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 24) (- 0 25)) (< j@@5 (|Seq#Length| xs))) (=> (< j@@5 (|Seq#Length| xs)) (=> (= (ControlFlow 0 24) 23) anon4_correct))))))))))))
...
(let ((anon33_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_4_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_2_1)) (not (= i_4_1 j_2_1))))) (= (ControlFlow 0 19) 16)) anon21_correct)))
(let ((anon33_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_4_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_2_1)) (not (= i_4_1 j_2_1)))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (not (= (|Seq#Index| xs i_4_1) (|Seq#Index| xs j_2_1)))) (=> (not (= (|Seq#Index| xs i_4_1) (|Seq#Index| xs j_2_1))) (=> (= (ControlFlow 0 17) 16) anon21_correct))))))
(let ((anon32_Else_correct  (=> (forall ((i_5_1 Int) (j_3_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_5_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_3_1)) (not (= i_5_1 j_3_1)))) (not (= (|Seq#Index| xs i_5_1) (|Seq#Index| xs j_3_1))))
 :qid |stdinbpl.860:20|
 :skolemid |72|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_5_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_3_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_5_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_3_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_5_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_3_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_5_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_3_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_5_1)) (|Seq#Index| xs j_3_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_5_1)) (|Seq#Index| xs j_3_1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_3_1)) (|Seq#Index| xs i_5_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_3_1)) (|Seq#Index| xs i_5_1))
 :pattern ( (|Seq#Index| xs i_5_1) (|Seq#Index| xs j_3_1))
)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((i_6 Int) (i_6_1 Int) ) (!  (=> (and (and (and (and (not (= i_6 i_6_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_6))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_6_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_6) (|Seq#Index| xs i_6_1))))
 :qid |stdinbpl.871:17|
 :skolemid |73|
 :pattern ( (neverTriggered2 i_6) (neverTriggered2 i_6_1))
))) (=> (forall ((i_6@@0 Int) (i_6_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_6@@0 i_6_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_6@@0))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_6_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_6@@0) (|Seq#Index| xs i_6_1@@0))))
 :qid |stdinbpl.871:17|
 :skolemid |73|
 :pattern ( (neverTriggered2 i_6@@0) (neverTriggered2 i_6_1@@0))
)) (=> (= (ControlFlow 0 14) (- 0 13)) (forall ((i_6@@1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_6@@1)) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs i_6@@1) f_7)) FullPerm))
 :qid |stdinbpl.878:17|
 :skolemid |74|
 :pattern ( (|Seq#Index| xs i_6@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_6@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_6@@1)))
 :pattern ( (|Seq#Index| xs i_6@@1))
))))))))
(let ((anon30_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((i_10 Int) (i_10_1 Int) ) (!  (=> (and (and (and (and (not (= i_10 i_10_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_10))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_10_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_10) (|Seq#Index| xs i_10_1))))
 :qid |stdinbpl.815:15|
 :skolemid |66|
))) (=> (forall ((i_10@@0 Int) (i_10_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_10@@0 i_10_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_10@@0))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_10_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_10@@0) (|Seq#Index| xs i_10_1@@0))))
 :qid |stdinbpl.815:15|
 :skolemid |66|
)) (=> (and (and (and (forall ((i_10@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_10@@1)) (< NoPerm FullPerm)) (and (qpRange3 (|Seq#Index| xs i_10@@1)) (= (invRecv3 (|Seq#Index| xs i_10@@1)) i_10@@1)))
 :qid |stdinbpl.821:22|
 :skolemid |67|
 :pattern ( (|Seq#Index| xs i_10@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_10@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_10@@1)))
 :pattern ( (|Seq#Index| xs i_10@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U (invRecv3 o_3))) (< NoPerm FullPerm)) (qpRange3 o_3)) (= (|Seq#Index| xs (invRecv3 o_3)) o_3)))
 :qid |stdinbpl.825:22|
 :skolemid |68|
 :pattern ( (invRecv3 o_3))
))) (and (forall ((i_10@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_10@@2)) (not (= (|Seq#Index| xs i_10@@2) null)))
 :qid |stdinbpl.831:22|
 :skolemid |69|
 :pattern ( (|Seq#Index| xs i_10@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_10@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_10@@2)))
 :pattern ( (|Seq#Index| xs i_10@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U (invRecv3 o_3@@0))) (< NoPerm FullPerm)) (qpRange3 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| xs (invRecv3 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U (invRecv3 o_3@@0))) (< NoPerm FullPerm)) (qpRange3 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.837:22|
 :skolemid |70|
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (and (=> (= (ControlFlow 0 20) 14) anon32_Else_correct) (=> (= (ControlFlow 0 20) 17) anon33_Then_correct)) (=> (= (ControlFlow 0 20) 19) anon33_Else_correct)))))))
(let ((anon17_correct true))
(let ((anon31_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_11))) (= (ControlFlow 0 12) 8)) anon17_correct)))
(let ((anon31_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_11)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_11 0)) (=> (>= i_11 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_11 (|Seq#Length| xs))) (=> (< i_11 (|Seq#Length| xs)) (=> (= (ControlFlow 0 9) 8) anon17_correct))))))))
(let ((anon28_Else_correct  (=> (forall ((i_8 Int) (j_5 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_8)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_5)) (not (= i_8 j_5)))) (not (= (|Seq#Index| xs i_8) (|Seq#Index| xs j_5))))
 :qid |stdinbpl.791:20|
 :skolemid |65|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_8)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_5)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_8)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_5)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_8)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_5)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_8)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_5)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_8)) (|Seq#Index| xs j_5))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_8)) (|Seq#Index| xs j_5))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_5)) (|Seq#Index| xs i_8))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_5)) (|Seq#Index| xs i_8))
 :pattern ( (|Seq#Index| xs i_8) (|Seq#Index| xs j_5))
)) (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 22) 20) anon30_Else_correct) (=> (= (ControlFlow 0 22) 9) anon31_Then_correct)) (=> (= (ControlFlow 0 22) 12) anon31_Else_correct))))))
(let ((anon13_correct true))
(let ((anon29_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_4)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_2)) (not (= i_4 j_2))))) (= (ControlFlow 0 7) 1)) anon13_correct)))
(let ((anon29_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_4)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_2)) (not (= i_4 j_2)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_4 (|Seq#Length| xs))) (=> (< i_4 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_2 0)) (=> (>= j_2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_2 (|Seq#Length| xs))) (=> (< j_2 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon13_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (and (and (=> (= (ControlFlow 0 39) 38) anon23_Then_correct) (=> (= (ControlFlow 0 39) 22) anon28_Else_correct)) (=> (= (ControlFlow 0 39) 2) anon29_Then_correct)) (=> (= (ControlFlow 0 39) 7) anon29_Else_correct)))))
