...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 null (P this) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P this))) FullPerm)))) (= (ControlFlow 0 2) (- 0 1))) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (P this)))))))
