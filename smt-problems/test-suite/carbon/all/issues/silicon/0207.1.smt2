...
(assert  (and (and (and (and (and (and (and (and (and (and (= (type UnfoldingMask@0) (MapType2Type RefType realType)) (= (type Mask@0) (MapType2Type RefType realType))) (= (type this@@11) RefType)) (= (type UnfoldingMask@1) (MapType2Type RefType realType))) (= (type Heap@@18) (MapType1Type RefType))) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@50 T@U) ) (! (= (type (invRecv1 arg0@@50)) RefType)
 :qid |funType:invRecv1|
 :pattern ( (invRecv1 arg0@@50))
))) (= (type QPMask@1) (MapType2Type RefType realType))) (forall ((arg0@@51 T@U) ) (! (= (type (invRecv2 arg0@@51)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@51))
))) (forall ((arg0@@52 T@U) (arg1@@25 T@U) ) (! (= (type (CombineFrames arg0@@52 arg1@@25)) FrameTypeType)
 :qid |funType:CombineFrames|
 :pattern ( (CombineFrames arg0@@52 arg1@@25))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon2_correct  (=> (and (and (= UnfoldingMask@0 (MapType2Store Mask@0 null (List this@@11) (real_2_U (- (U_2_real (MapType2Select Mask@0 null (List this@@11))) FullPerm)))) (not (= this@@11 null))) (and (= UnfoldingMask@1 (MapType2Store UnfoldingMask@0 this@@11 nodes (real_2_U (+ (U_2_real (MapType2Select UnfoldingMask@0 this@@11 nodes)) FullPerm)))) (state Heap@@18 UnfoldingMask@1))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((r@@5 T@U) (r_4 T@U) ) (!  (=> (and (= (type r@@5) RefType) (= (type r_4) RefType)) (=> (and (and (and (and (not (= r@@5 r_4)) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r@@5))) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r@@5 r_4))))
 :qid |stdinbpl.538:17|
 :skolemid |90|
 :no-pattern (type r@@5)
 :no-pattern (type r_4)
...
))) (=> (forall ((r@@6 T@U) (r_4@@0 T@U) ) (!  (=> (and (= (type r@@6) RefType) (= (type r_4@@0) RefType)) (=> (and (and (and (and (not (= r@@6 r_4@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r@@6))) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_4@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r@@6 r_4@@0))))
 :qid |stdinbpl.538:17|
 :skolemid |90|
 :no-pattern (type r@@6)
...
)) (=> (and (forall ((r@@7 T@U) ) (!  (=> (= (type r@@7) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r@@7)) (< NoPerm FullPerm)) (and (qpRange1 r@@7) (= (invRecv1 r@@7) r@@7))))
 :qid |stdinbpl.544:24|
 :skolemid |91|
 :pattern ( (MapType1Select Heap@@18 r@@7 val))
 :pattern ( (MapType2Select QPMask@0 r@@7 val))
 :pattern ( (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r@@7))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.548:24|
 :skolemid |92|
 :pattern ( (invRecv1 o_3))
))) (=> (and (and (forall ((r@@8 T@U) ) (!  (=> (and (= (type r@@8) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r@@8))) (not (= r@@8 null)))
 :qid |stdinbpl.554:24|
 :skolemid |93|
 :pattern ( (MapType1Select Heap@@18 r@@8 val))
 :pattern ( (MapType2Select QPMask@0 r@@8 val))
 :pattern ( (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r@@8))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@0) o_3@@0)) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType2Select UnfoldingMask@1 o_3@@0 val)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 val)) (U_2_real (MapType2Select UnfoldingMask@1 o_3@@0 val))))))
 :qid |stdinbpl.560:24|
 :skolemid |94|
 :pattern ( (MapType2Select QPMask@0 o_3@@0 val))
))) (and (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 val))) (= (U_2_real (MapType2Select UnfoldingMask@1 o_3@@1 f_5)) (U_2_real (MapType2Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.564:31|
 :skolemid |95|
 :pattern ( (MapType2Select UnfoldingMask@1 o_3@@1 f_5))
 :pattern ( (MapType2Select QPMask@0 o_3@@1 f_5))
)) (state Heap@@18 QPMask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_1))) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1 r_1_1))))
 :qid |stdinbpl.572:17|
 :skolemid |96|
 :no-pattern (type r_1)
...
))) (=> (forall ((r_1@@0 T@U) (r_1_1@@0 T@U) ) (!  (=> (and (= (type r_1@@0) RefType) (= (type r_1_1@@0) RefType)) (=> (and (and (and (and (not (= r_1@@0 r_1_1@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_1@@0))) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1@@0 r_1_1@@0))))
 :qid |stdinbpl.572:17|
 :skolemid |96|
...
)) (=> (forall ((r_1@@1 T@U) ) (!  (=> (= (type r_1@@1) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_1@@1)) (< NoPerm FullPerm)) (and (qpRange2 r_1@@1) (= (invRecv2 r_1@@1) r_1@@1))))
 :qid |stdinbpl.578:24|
 :skolemid |97|
 :pattern ( (MapType1Select Heap@@18 r_1@@1 next))
 :pattern ( (MapType2Select QPMask@1 r_1@@1 next))
 :pattern ( (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_1@@1))
)) (=> (and (and (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) (invRecv2 o_3@@2))) (< NoPerm FullPerm)) (qpRange2 o_3@@2)) (= (invRecv2 o_3@@2) o_3@@2)))
 :qid |stdinbpl.582:24|
 :skolemid |98|
 :pattern ( (invRecv2 o_3@@2))
)) (forall ((r_1@@2 T@U) ) (!  (=> (and (= (type r_1@@2) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_1@@2))) (not (= r_1@@2 null)))
 :qid |stdinbpl.588:24|
 :skolemid |99|
 :pattern ( (MapType1Select Heap@@18 r_1@@2 next))
 :pattern ( (MapType2Select QPMask@1 r_1@@2 next))
 :pattern ( (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_1@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) (invRecv2 o_3@@3))) (< NoPerm FullPerm)) (qpRange2 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@3) o_3@@3)) (= (U_2_real (MapType2Select QPMask@1 o_3@@3 next)) (+ (U_2_real (MapType2Select QPMask@0 o_3@@3 next)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) (invRecv2 o_3@@3))) (< NoPerm FullPerm)) (qpRange2 o_3@@3))) (= (U_2_real (MapType2Select QPMask@1 o_3@@3 next)) (U_2_real (MapType2Select QPMask@0 o_3@@3 next))))))
 :qid |stdinbpl.594:24|
 :skolemid |100|
 :pattern ( (MapType2Select QPMask@1 o_3@@3 next))
)) (forall ((o_3@@4 T@U) (f_5@@0 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_5@@0))))
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 next))) (= (U_2_real (MapType2Select QPMask@0 o_3@@4 f_5@@0)) (U_2_real (MapType2Select QPMask@1 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.598:31|
 :skolemid |101|
 :pattern ( (MapType2Select QPMask@0 o_3@@4 f_5@@0))
 :pattern ( (MapType2Select QPMask@1 o_3@@4 f_5@@0))
)))) (and (and (state Heap@@18 QPMask@1) (forall ((r_2_1 T@U) ) (!  (=> (= (type r_2_1) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_2_1)) (not (= (MapType1Select Heap@@18 r_2_1 next) null))) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) (MapType1Select Heap@@18 r_2_1 next)))))
 :qid |stdinbpl.604:22|
 :skolemid |102|
 :pattern ( (MapType1Select Heap@@18 r_2_1 next))
))) (and (state Heap@@18 QPMask@1) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm QPMask@1 this@@11 nodes))))))))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType2Select Mask@0 null (List this@@11))))) (=> (<= FullPerm (U_2_real (MapType2Select Mask@0 null (List this@@11)))) (=> (= (ControlFlow 0 5) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@18 ZeroMask) (U_2_bool (MapType1Select Heap@@18 this@@11 $allocated))) (and (= AssumeFunctionsAbove 1) (= Mask@0 (MapType2Store ZeroMask null (List this@@11) (real_2_U (+ (U_2_real (MapType2Select ZeroMask null (List this@@11))) FullPerm)))))) (and (and (state Heap@@18 Mask@0) (state Heap@@18 Mask@0)) (and (|List#trigger| Heap@@18 (List this@@11)) (= (MapType1Select Heap@@18 null (List this@@11)) (CombineFrames (FrameFragment (MapType1Select Heap@@18 this@@11 nodes)) (CombineFrames (FrameFragment (int_2_U (|List#condqp1| Heap@@18 this@@11))) (FrameFragment (int_2_U (|List#condqp2| Heap@@18 this@@11))))))))) (and (=> (= (ControlFlow 0 8) 5) anon3_Then_correct) (=> (= (ControlFlow 0 8) 7) anon3_Else_correct)))))
