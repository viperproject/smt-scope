...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (= Result@0 (__prim__bool___box__ Heap@@39 true)))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (= Result@0 (__prim__bool___box__ Heap@@39 true)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (issubtype (typeof Result@0) vbool)) (=> (issubtype (typeof Result@0) vbool) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@39 ZeroMask) (= AssumeFunctionsAbove 1)) (and (=> (= (ControlFlow 0 7) 1) anon5_Then_correct) (=> (= (ControlFlow 0 7) 5) anon5_Else_correct)))))
