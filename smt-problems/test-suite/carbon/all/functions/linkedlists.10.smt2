...
))) (= (type Mask@17) (MapType1Type RefType realType))) (= (type Mask@18) (MapType1Type RefType realType))) (= (type Mask@16) (MapType1Type RefType realType))) (= (type Mask@15) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@9) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type arg_xs@0) RefType)) (= (type Mask@8) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Heap@11) (MapType0Type RefType))) (= (type Mask@14) (MapType1Type RefType realType))) (= (type Heap@12) (MapType0Type RefType))) (= (type freshObj@0) RefType)) (= (type Heap@9) (MapType0Type RefType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@10) (MapType0Type RefType))) (= (type Heap@8) (MapType0Type RefType))) (= (type Heap@7) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Heap@6) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@13) (MapType1Type RefType realType))) (= (type Mask@11) (MapType1Type RefType realType))) (= (type Mask@12) (MapType1Type RefType realType))) (= (type Mask@10) (MapType1Type RefType realType))) (= (type Mask@7) (MapType1Type RefType realType))) (= (type ys) RefType)) (= (type Heap@2) (MapType0Type RefType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type Heap@3) (MapType0Type RefType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type PostMask@4) (MapType1Type RefType realType))) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type PostMask@3) (MapType1Type RefType realType))) (= (type PostMask@2) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type PostMask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id append)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 140) (let ((anon33_correct  (=> (= (ControlFlow 0 130) (- 0 129)) (not (= xs@@42 null)))))
(let ((anon100_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 133) 130)) anon33_correct)))
(let ((anon100_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 131) (- 0 132)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@42))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@42)))) (=> (= (ControlFlow 0 131) 130) anon33_correct))))))
(let ((anon38_correct  (=> (and (= PostMask@1 (MapType1Store PostMask@0 null (list xs@@42) (real_2_U (- (U_2_real (MapType1Select PostMask@0 null (list xs@@42))) FullPerm)))) (= (ControlFlow 0 123) (- 0 122))) (not (= xs@@42 null)))))
(let ((anon103_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 126) 123)) anon38_correct)))
(let ((anon103_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 124) (- 0 125)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (list xs@@42))))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (list xs@@42)))) (=> (= (ControlFlow 0 124) 123) anon38_correct))))))
(let ((anon40_correct true))
(let ((anon102_Else_correct  (=> (and (ascending PostHeap@0 xs@@42) (= (ControlFlow 0 121) 119)) anon40_correct)))
(let ((anon101_Then_correct  (=> (and (and (>= y@@2 (last Heap@@47 xs@@42)) (ascending Heap@@47 xs@@42)) (state PostHeap@0 PostMask@0)) (and (and (=> (= (ControlFlow 0 127) 121) anon102_Else_correct) (=> (= (ControlFlow 0 127) 124) anon103_Then_correct)) (=> (= (ControlFlow 0 127) 126) anon103_Else_correct)))))
(let ((anon101_Else_correct  (=> (and (not (and (>= y@@2 (last Heap@@47 xs@@42)) (ascending Heap@@47 xs@@42))) (= (ControlFlow 0 120) 119)) anon40_correct)))
(let ((anon98_Then_correct  (=> (>= y@@2 (last Heap@@47 xs@@42)) (and (and (and (=> (= (ControlFlow 0 134) 127) anon101_Then_correct) (=> (= (ControlFlow 0 134) 120) anon101_Else_correct)) (=> (= (ControlFlow 0 134) 131) anon100_Then_correct)) (=> (= (ControlFlow 0 134) 133) anon100_Else_correct)))))
(let ((anon98_Else_correct  (=> (> (last Heap@@47 xs@@42) y@@2) (and (=> (= (ControlFlow 0 128) 127) anon101_Then_correct) (=> (= (ControlFlow 0 128) 120) anon101_Else_correct)))))
(let ((anon28_correct  (=> (= (ControlFlow 0 115) (- 0 114)) (not (= xs@@42 null)))))
(let ((anon97_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 118) 115)) anon28_correct)))
(let ((anon97_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 116) (- 0 117)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@42))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@42)))) (=> (= (ControlFlow 0 116) 115) anon28_correct))))))
(let ((anon94_Else_correct  (=> (and (= (head PostHeap@0 xs@@42) (head Heap@@47 xs@@42)) (state PostHeap@0 PostMask@0)) (and (and (and (=> (= (ControlFlow 0 135) 134) anon98_Then_correct) (=> (= (ControlFlow 0 135) 128) anon98_Else_correct)) (=> (= (ControlFlow 0 135) 116) anon97_Then_correct)) (=> (= (ControlFlow 0 135) 118) anon97_Else_correct)))))
(let ((anon24_correct  (=> (= (ControlFlow 0 110) (- 0 109)) (not (= xs@@42 null)))))
(let ((anon95_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 113) 110)) anon24_correct)))
(let ((anon95_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 111) (- 0 112)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@42))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@42)))) (=> (= (ControlFlow 0 111) 110) anon24_correct))))))
(let ((anon20_correct  (=> (and (= PostMask@2 (MapType1Store PostMask@0 null (list xs@@42) (real_2_U (- (U_2_real (MapType1Select PostMask@0 null (list xs@@42))) FullPerm)))) (= (ControlFlow 0 105) (- 0 104))) (not (= xs@@42 null)))))
(let ((anon93_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 108) 105)) anon20_correct)))
(let ((anon93_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 106) (- 0 107)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (list xs@@42))))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (list xs@@42)))) (=> (= (ControlFlow 0 106) 105) anon20_correct))))))
(let ((anon90_Else_correct  (=> (|Seq#Equal| (elems PostHeap@0 xs@@42) (|Seq#Append| (elems Heap@@47 xs@@42) (|Seq#Singleton| (int_2_U y@@2)))) (=> (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)) (and (and (and (and (=> (= (ControlFlow 0 136) 135) anon94_Else_correct) (=> (= (ControlFlow 0 136) 111) anon95_Then_correct)) (=> (= (ControlFlow 0 136) 113) anon95_Else_correct)) (=> (= (ControlFlow 0 136) 106) anon93_Then_correct)) (=> (= (ControlFlow 0 136) 108) anon93_Else_correct))))))
(let ((anon16_correct  (=> (= (ControlFlow 0 100) (- 0 99)) (not (= xs@@42 null)))))
(let ((anon91_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 103) 100)) anon16_correct)))
(let ((anon91_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 101) (- 0 102)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@42))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@42)))) (=> (= (ControlFlow 0 101) 100) anon16_correct))))))
(let ((anon12_correct  (=> (and (= PostMask@3 (MapType1Store PostMask@0 null (list xs@@42) (real_2_U (- (U_2_real (MapType1Select PostMask@0 null (list xs@@42))) FullPerm)))) (= (ControlFlow 0 95) (- 0 94))) (not (= xs@@42 null)))))
(let ((anon89_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 98) 95)) anon12_correct)))
(let ((anon89_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 96) (- 0 97)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (list xs@@42))))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (list xs@@42)))) (=> (= (ControlFlow 0 96) 95) anon12_correct))))))
(let ((anon86_Else_correct  (=> (= (length PostHeap@0 xs@@42) (+ (length Heap@@47 xs@@42) 1)) (=> (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)) (and (and (and (and (=> (= (ControlFlow 0 137) 136) anon90_Else_correct) (=> (= (ControlFlow 0 137) 101) anon91_Then_correct)) (=> (= (ControlFlow 0 137) 103) anon91_Else_correct)) (=> (= (ControlFlow 0 137) 96) anon89_Then_correct)) (=> (= (ControlFlow 0 137) 98) anon89_Else_correct))))))
(let ((anon8_correct  (=> (= (ControlFlow 0 90) (- 0 89)) (not (= xs@@42 null)))))
(let ((anon87_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 93) 90)) anon8_correct)))
(let ((anon87_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 91) (- 0 92)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@42))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@42)))) (=> (= (ControlFlow 0 91) 90) anon8_correct))))))
(let ((anon4_correct  (=> (and (= PostMask@4 (MapType1Store PostMask@0 null (list xs@@42) (real_2_U (- (U_2_real (MapType1Select PostMask@0 null (list xs@@42))) FullPerm)))) (= (ControlFlow 0 85) (- 0 84))) (not (= xs@@42 null)))))
(let ((anon85_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 88) 85)) anon4_correct)))
(let ((anon85_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 86) (- 0 87)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (list xs@@42))))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (list xs@@42)))) (=> (= (ControlFlow 0 86) 85) anon4_correct))))))
(let ((anon83_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (= PostMask@0 (MapType1Store ZeroMask null (list xs@@42) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (list xs@@42))) FullPerm))))) (=> (and (and (state PostHeap@0 PostMask@0) (not (= xs@@42 null))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (and (and (and (=> (= (ControlFlow 0 138) 137) anon86_Else_correct) (=> (= (ControlFlow 0 138) 91) anon87_Then_correct)) (=> (= (ControlFlow 0 138) 93) anon87_Else_correct)) (=> (= (ControlFlow 0 138) 86) anon85_Then_correct)) (=> (= (ControlFlow 0 138) 88) anon85_Else_correct))))))
(let ((anon82_correct true))
(let ((anon123_Else_correct  (=> (and (not (and (>= y@@2 (last Heap@@47 xs@@42)) (ascending Heap@@47 xs@@42))) (= (ControlFlow 0 4) 1)) anon82_correct)))
(let ((anon123_Then_correct  (=> (and (>= y@@2 (last Heap@@47 xs@@42)) (ascending Heap@@47 xs@@42)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (ascending Heap@20 xs@@42)) (=> (ascending Heap@20 xs@@42) (=> (= (ControlFlow 0 2) 1) anon82_correct))))))
(let ((anon80_correct  (=> (= Mask@21 (MapType1Store Mask@20 null (list xs@@42) (real_2_U (- (U_2_real (MapType1Select Mask@20 null (list xs@@42))) FullPerm)))) (and (=> (= (ControlFlow 0 5) (- 0 9)) (not (= xs@@42 null))) (=> (not (= xs@@42 null)) (and (=> (= (ControlFlow 0 5) (- 0 8)) (= (length Heap@20 xs@@42) (+ (length Heap@@47 xs@@42) 1))) (=> (= (length Heap@20 xs@@42) (+ (length Heap@@47 xs@@42) 1)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (|Seq#Equal| (elems Heap@20 xs@@42) (|Seq#Append| (elems Heap@@47 xs@@42) (|Seq#Singleton| (int_2_U y@@2))))) (=> (|Seq#Equal| (elems Heap@20 xs@@42) (|Seq#Append| (elems Heap@@47 xs@@42) (|Seq#Singleton| (int_2_U y@@2)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (= (head Heap@20 xs@@42) (head Heap@@47 xs@@42))) (=> (= (head Heap@20 xs@@42) (head Heap@@47 xs@@42)) (and (=> (= (ControlFlow 0 5) 2) anon123_Then_correct) (=> (= (ControlFlow 0 5) 4) anon123_Else_correct)))))))))))))
(let ((anon122_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 5)) anon80_correct)))
(let ((anon122_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@20 null (list xs@@42))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@20 null (list xs@@42)))) (=> (= (ControlFlow 0 10) 5) anon80_correct))))))
(let ((anon78_correct  (=> (and (state Heap@20 Mask@20) (state Heap@20 Mask@20)) (and (=> (= (ControlFlow 0 13) 10) anon122_Then_correct) (=> (= (ControlFlow 0 13) 12) anon122_Else_correct)))))
(let ((anon121_Else_correct  (=> (= (MapType0Select Heap@18 xs@@42 next) null) (=> (and (= Heap@20 Heap@18) (= (ControlFlow 0 15) 13)) anon78_correct))))
(let ((anon121_Then_correct  (=> (not (= (MapType0Select Heap@18 xs@@42 next) null)) (=> (and (and (forall ((o_14 T@U) (f_18 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_18))))
(let ((A@@12 (FieldTypeInv0 (type f_18))))
 (=> (and (and (= (type o_14) RefType) (= (type f_18) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@18 null (|list#sm| xs@@42)) o_14 f_18)) (U_2_bool (MapType1Select (MapType0Select Heap@18 null (|list#sm| (MapType0Select Heap@18 xs@@42 next))) o_14 f_18)))) (U_2_bool (MapType1Select newPMask@1 o_14 f_18)))))
 :qid |stdinbpl.2678:29|
 :skolemid |112|
 :pattern ( (MapType1Select newPMask@1 o_14 f_18))
)) (= Heap@19 (MapType0Store Heap@18 null (|list#sm| xs@@42) newPMask@1))) (and (= Heap@20 Heap@19) (= (ControlFlow 0 14) 13))) anon78_correct))))
(let ((anon76_correct  (=> (and (= Heap@17 (MapType0Store Heap@16 null (|list#sm| xs@@42) (MapType1Store (MapType0Select Heap@16 null (|list#sm| xs@@42)) xs@@42 next (bool_2_U true)))) (= Heap@18 (MapType0Store Heap@17 null (|list#sm| xs@@42) (MapType1Store (MapType0Select Heap@17 null (|list#sm| xs@@42)) xs@@42 val (bool_2_U true))))) (and (=> (= (ControlFlow 0 16) 14) anon121_Then_correct) (=> (= (ControlFlow 0 16) 15) anon121_Else_correct)))))
(let ((anon120_Else_correct  (=> (HasDirectPerm Mask@20 null (list xs@@42)) (=> (and (= Heap@16 Heap@13) (= (ControlFlow 0 18) 16)) anon76_correct))))
(let ((anon120_Then_correct  (=> (not (HasDirectPerm Mask@20 null (list xs@@42))) (=> (and (and (= Heap@14 (MapType0Store Heap@13 null (|list#sm| xs@@42) ZeroPMask)) (= Heap@15 (MapType0Store Heap@14 null (list xs@@42) freshVersion@1))) (and (= Heap@16 Heap@15) (= (ControlFlow 0 17) 16))) anon76_correct))))
(let ((anon74_correct  (=> (= Mask@20 (MapType1Store Mask@19 null (list xs@@42) (real_2_U (+ (U_2_real (MapType1Select Mask@19 null (list xs@@42))) FullPerm)))) (=> (and (and (state Heap@13 Mask@20) (state Heap@13 Mask@20)) (and (|list#trigger| Heap@13 (list xs@@42)) (= (MapType0Select Heap@13 null (list xs@@42)) (CombineFrames (FrameFragment (MapType0Select Heap@13 xs@@42 next)) (CombineFrames (FrameFragment (MapType0Select Heap@13 xs@@42 val)) (FrameFragment (ite (not (= (MapType0Select Heap@13 xs@@42 next) null)) (MapType0Select Heap@13 null (list (MapType0Select Heap@13 xs@@42 next))) EmptyFrame))))))) (and (=> (= (ControlFlow 0 19) 17) anon120_Then_correct) (=> (= (ControlFlow 0 19) 18) anon120_Else_correct))))))
(let ((anon73_correct  (=> (and (= Mask@18 (MapType1Store Mask@17 null (list (MapType0Select Heap@13 xs@@42 next)) (real_2_U (- (U_2_real (MapType1Select Mask@17 null (list (MapType0Select Heap@13 xs@@42 next)))) FullPerm)))) (InsidePredicate (list xs@@42) (MapType0Select Heap@13 null (list xs@@42)) (list (MapType0Select Heap@13 xs@@42 next)) (MapType0Select Heap@13 null (list (MapType0Select Heap@13 xs@@42 next))))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (not (= (MapType0Select Heap@13 xs@@42 next) null))) (=> (not (= (MapType0Select Heap@13 xs@@42 next) null)) (=> (and (= Mask@19 Mask@18) (= (ControlFlow 0 21) 19)) anon74_correct))))))
(let ((anon119_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 25) 21)) anon73_correct)))
(let ((anon119_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (<= FullPerm (U_2_real (MapType1Select Mask@17 null (list (MapType0Select Heap@13 xs@@42 next)))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@17 null (list (MapType0Select Heap@13 xs@@42 next))))) (=> (= (ControlFlow 0 23) 21) anon73_correct))))))
(let ((anon118_Then_correct  (=> (not (= (MapType0Select Heap@13 xs@@42 next) null)) (and (=> (= (ControlFlow 0 26) 23) anon119_Then_correct) (=> (= (ControlFlow 0 26) 25) anon119_Else_correct)))))
(let ((anon118_Else_correct  (=> (= (MapType0Select Heap@13 xs@@42 next) null) (=> (and (= Mask@19 Mask@17) (= (ControlFlow 0 20) 19)) anon74_correct))))
(let ((anon70_correct  (=> (= Mask@17 (MapType1Store Mask@16 xs@@42 val (real_2_U (- (U_2_real (MapType1Select Mask@16 xs@@42 val)) FullPerm)))) (and (=> (= (ControlFlow 0 27) 26) anon118_Then_correct) (=> (= (ControlFlow 0 27) 20) anon118_Else_correct)))))
(let ((anon117_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 30) 27)) anon70_correct)))
(let ((anon117_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 28) (- 0 29)) (<= FullPerm (U_2_real (MapType1Select Mask@16 xs@@42 val)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@16 xs@@42 val))) (=> (= (ControlFlow 0 28) 27) anon70_correct))))))
(let ((anon68_correct  (=> (= Mask@16 (MapType1Store Mask@15 xs@@42 next (real_2_U (- (U_2_real (MapType1Select Mask@15 xs@@42 next)) FullPerm)))) (and (=> (= (ControlFlow 0 31) 28) anon117_Then_correct) (=> (= (ControlFlow 0 31) 30) anon117_Else_correct)))))
(let ((anon116_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 34) 31)) anon68_correct)))
(let ((anon116_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 32) (- 0 33)) (<= FullPerm (U_2_real (MapType1Select Mask@15 xs@@42 next)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@15 xs@@42 next))) (=> (= (ControlFlow 0 32) 31) anon68_correct))))))
(let ((anon66_correct  (=> (state Heap@13 Mask@15) (and (=> (= (ControlFlow 0 35) 32) anon116_Then_correct) (=> (= (ControlFlow 0 35) 34) anon116_Else_correct)))))
(let ((anon60_correct  (=> (and (state Heap@11 Mask@14) (state Heap@11 Mask@14)) (and (=> (= (ControlFlow 0 46) (- 0 47)) (= FullPerm (U_2_real (MapType1Select Mask@14 xs@@42 next)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@14 xs@@42 next))) (=> (= Heap@12 (MapType0Store Heap@11 xs@@42 next freshObj@0)) (=> (and (and (state Heap@12 Mask@14) (= Heap@13 Heap@12)) (and (= Mask@15 Mask@14) (= (ControlFlow 0 46) 35))) anon66_correct)))))))
(let ((anon113_Else_correct  (=> (= (MapType0Select Heap@9 freshObj@0 next) null) (=> (and (= Heap@11 Heap@9) (= (ControlFlow 0 49) 46)) anon60_correct))))
(let ((anon113_Then_correct  (=> (not (= (MapType0Select Heap@9 freshObj@0 next) null)) (=> (and (and (forall ((o_13 T@U) (f_17 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_17))))
(let ((A@@13 (FieldTypeInv0 (type f_17))))
 (=> (and (and (= (type o_13) RefType) (= (type f_17) (FieldType A@@13 B@@12))) (or (U_2_bool (MapType1Select (MapType0Select Heap@9 null (|list#sm| freshObj@0)) o_13 f_17)) (U_2_bool (MapType1Select (MapType0Select Heap@9 null (|list#sm| (MapType0Select Heap@9 freshObj@0 next))) o_13 f_17)))) (U_2_bool (MapType1Select newPMask@0 o_13 f_17)))))
 :qid |stdinbpl.2574:33|
 :skolemid |111|
 :pattern ( (MapType1Select newPMask@0 o_13 f_17))
)) (= Heap@10 (MapType0Store Heap@9 null (|list#sm| freshObj@0) newPMask@0))) (and (= Heap@11 Heap@10) (= (ControlFlow 0 48) 46))) anon60_correct))))
(let ((anon58_correct  (=> (and (= Heap@8 (MapType0Store Heap@7 null (|list#sm| freshObj@0) (MapType1Store (MapType0Select Heap@7 null (|list#sm| freshObj@0)) freshObj@0 next (bool_2_U true)))) (= Heap@9 (MapType0Store Heap@8 null (|list#sm| freshObj@0) (MapType1Store (MapType0Select Heap@8 null (|list#sm| freshObj@0)) freshObj@0 val (bool_2_U true))))) (and (=> (= (ControlFlow 0 50) 48) anon113_Then_correct) (=> (= (ControlFlow 0 50) 49) anon113_Else_correct)))))
(let ((anon112_Else_correct  (=> (HasDirectPerm Mask@14 null (list freshObj@0)) (=> (and (= Heap@7 Heap@4) (= (ControlFlow 0 52) 50)) anon58_correct))))
(let ((anon112_Then_correct  (=> (not (HasDirectPerm Mask@14 null (list freshObj@0))) (=> (and (and (= Heap@5 (MapType0Store Heap@4 null (|list#sm| freshObj@0) ZeroPMask)) (= Heap@6 (MapType0Store Heap@5 null (list freshObj@0) freshVersion@0))) (and (= Heap@7 Heap@6) (= (ControlFlow 0 51) 50))) anon58_correct))))
(let ((anon56_correct  (=> (= Mask@14 (MapType1Store Mask@13 null (list freshObj@0) (real_2_U (+ (U_2_real (MapType1Select Mask@13 null (list freshObj@0))) FullPerm)))) (=> (and (and (state Heap@4 Mask@14) (state Heap@4 Mask@14)) (and (|list#trigger| Heap@4 (list freshObj@0)) (= (MapType0Select Heap@4 null (list freshObj@0)) (CombineFrames (FrameFragment (MapType0Select Heap@4 freshObj@0 next)) (CombineFrames (FrameFragment (MapType0Select Heap@4 freshObj@0 val)) (FrameFragment (ite (not (= (MapType0Select Heap@4 freshObj@0 next) null)) (MapType0Select Heap@4 null (list (MapType0Select Heap@4 freshObj@0 next))) EmptyFrame))))))) (and (=> (= (ControlFlow 0 53) 51) anon112_Then_correct) (=> (= (ControlFlow 0 53) 52) anon112_Else_correct))))))
(let ((anon55_correct  (=> (and (= Mask@12 (MapType1Store Mask@11 null (list (MapType0Select Heap@4 freshObj@0 next)) (real_2_U (- (U_2_real (MapType1Select Mask@11 null (list (MapType0Select Heap@4 freshObj@0 next)))) FullPerm)))) (InsidePredicate (list freshObj@0) (MapType0Select Heap@4 null (list freshObj@0)) (list (MapType0Select Heap@4 freshObj@0 next)) (MapType0Select Heap@4 null (list (MapType0Select Heap@4 freshObj@0 next))))) (and (=> (= (ControlFlow 0 55) (- 0 56)) (not (= (MapType0Select Heap@4 freshObj@0 next) null))) (=> (not (= (MapType0Select Heap@4 freshObj@0 next) null)) (=> (and (= Mask@13 Mask@12) (= (ControlFlow 0 55) 53)) anon56_correct))))))
(let ((anon111_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 59) 55)) anon55_correct)))
(let ((anon111_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 57) (- 0 58)) (<= FullPerm (U_2_real (MapType1Select Mask@11 null (list (MapType0Select Heap@4 freshObj@0 next)))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@11 null (list (MapType0Select Heap@4 freshObj@0 next))))) (=> (= (ControlFlow 0 57) 55) anon55_correct))))))
(let ((anon110_Then_correct  (=> (not (= (MapType0Select Heap@4 freshObj@0 next) null)) (and (=> (= (ControlFlow 0 60) 57) anon111_Then_correct) (=> (= (ControlFlow 0 60) 59) anon111_Else_correct)))))
(let ((anon110_Else_correct  (=> (= (MapType0Select Heap@4 freshObj@0 next) null) (=> (and (= Mask@13 Mask@11) (= (ControlFlow 0 54) 53)) anon56_correct))))
(let ((anon52_correct  (=> (= Mask@11 (MapType1Store Mask@10 freshObj@0 val (real_2_U (- (U_2_real (MapType1Select Mask@10 freshObj@0 val)) FullPerm)))) (and (=> (= (ControlFlow 0 61) 60) anon110_Then_correct) (=> (= (ControlFlow 0 61) 54) anon110_Else_correct)))))
(let ((anon109_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 64) 61)) anon52_correct)))
(let ((anon109_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 62) (- 0 63)) (<= FullPerm (U_2_real (MapType1Select Mask@10 freshObj@0 val)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@10 freshObj@0 val))) (=> (= (ControlFlow 0 62) 61) anon52_correct))))))
(let ((anon50_correct  (=> (= Mask@10 (MapType1Store Mask@7 freshObj@0 next (real_2_U (- (U_2_real (MapType1Select Mask@7 freshObj@0 next)) FullPerm)))) (and (=> (= (ControlFlow 0 65) 62) anon109_Then_correct) (=> (= (ControlFlow 0 65) 64) anon109_Else_correct)))))
(let ((anon108_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 68) 65)) anon50_correct)))
(let ((anon108_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 66) (- 0 67)) (<= FullPerm (U_2_real (MapType1Select Mask@7 freshObj@0 next)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@7 freshObj@0 next))) (=> (= (ControlFlow 0 66) 65) anon50_correct))))))
(let ((anon107_Then_correct  (=> (and (and (and (= (MapType0Select Heap@1 xs@@42 next) null) (U_2_bool (MapType0Select Heap@1 ys $allocated))) (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@1 freshObj@0 $allocated))))) (and (and (= Heap@2 (MapType0Store Heap@1 freshObj@0 $allocated (bool_2_U true))) (= Mask@6 (MapType1Store Mask@5 freshObj@0 val (real_2_U (+ (U_2_real (MapType1Select Mask@5 freshObj@0 val)) FullPerm))))) (and (= Mask@7 (MapType1Store Mask@6 freshObj@0 next (real_2_U (+ (U_2_real (MapType1Select Mask@6 freshObj@0 next)) FullPerm)))) (state Heap@2 Mask@7)))) (and (=> (= (ControlFlow 0 69) (- 0 71)) (= FullPerm (U_2_real (MapType1Select Mask@7 freshObj@0 val)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@7 freshObj@0 val))) (=> (and (= Heap@3 (MapType0Store Heap@2 freshObj@0 val (int_2_U y@@2))) (state Heap@3 Mask@7)) (and (=> (= (ControlFlow 0 69) (- 0 70)) (= FullPerm (U_2_real (MapType1Select Mask@7 freshObj@0 next)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@7 freshObj@0 next))) (=> (and (= Heap@4 (MapType0Store Heap@3 freshObj@0 next null)) (state Heap@4 Mask@7)) (and (=> (= (ControlFlow 0 69) 66) anon108_Then_correct) (=> (= (ControlFlow 0 69) 68) anon108_Else_correct)))))))))))
(let ((anon65_correct  (=> (state ExhaleHeap@0 Mask@9) (=> (and (and (state ExhaleHeap@0 Mask@9) (= Heap@13 ExhaleHeap@0)) (and (= Mask@15 Mask@9) (= (ControlFlow 0 36) 35))) anon66_correct))))
(let ((anon115_Else_correct  (=> (and (not (and (>= y@@2 (last Heap@1 arg_xs@0)) (ascending Heap@1 arg_xs@0))) (= (ControlFlow 0 38) 36)) anon65_correct)))
(let ((anon115_Then_correct  (=> (and (and (and (>= y@@2 (last Heap@1 arg_xs@0)) (ascending Heap@1 arg_xs@0)) (state ExhaleHeap@0 Mask@9)) (and (ascending ExhaleHeap@0 arg_xs@0) (= (ControlFlow 0 37) 36))) anon65_correct)))
(let ((anon63_correct  (=> (= Mask@8 (MapType1Store Mask@5 null (list arg_xs@0) (real_2_U (- (U_2_real (MapType1Select Mask@5 null (list arg_xs@0))) FullPerm)))) (and (=> (= (ControlFlow 0 39) (- 0 40)) (not (= arg_xs@0 null))) (=> (not (= arg_xs@0 null)) (=> (and (IdenticalOnKnownLocations Heap@1 ExhaleHeap@0 Mask@8) (= Mask@9 (MapType1Store Mask@8 null (list arg_xs@0) (real_2_U (+ (U_2_real (MapType1Select Mask@8 null (list arg_xs@0))) FullPerm))))) (=> (and (and (and (state ExhaleHeap@0 Mask@9) (not (= arg_xs@0 null))) (and (state ExhaleHeap@0 Mask@9) (= (length ExhaleHeap@0 arg_xs@0) (+ (length Heap@1 arg_xs@0) 1)))) (and (and (state ExhaleHeap@0 Mask@9) (|Seq#Equal| (elems ExhaleHeap@0 arg_xs@0) (|Seq#Append| (elems Heap@1 arg_xs@0) (|Seq#Singleton| (int_2_U y@@2))))) (and (state ExhaleHeap@0 Mask@9) (= (head ExhaleHeap@0 arg_xs@0) (head Heap@1 arg_xs@0))))) (and (=> (= (ControlFlow 0 39) 37) anon115_Then_correct) (=> (= (ControlFlow 0 39) 38) anon115_Else_correct)))))))))
(let ((anon114_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 43) 39)) anon63_correct)))
(let ((anon114_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 41) (- 0 42)) (<= FullPerm (U_2_real (MapType1Select Mask@5 null (list arg_xs@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@5 null (list arg_xs@0)))) (=> (= (ControlFlow 0 41) 39) anon63_correct))))))
(let ((anon107_Else_correct  (=> (not (= (MapType0Select Heap@1 xs@@42 next) null)) (and (=> (= (ControlFlow 0 44) (- 0 45)) (HasDirectPerm Mask@5 xs@@42 next)) (=> (HasDirectPerm Mask@5 xs@@42 next) (=> (= arg_xs@0 (MapType0Select Heap@1 xs@@42 next)) (and (=> (= (ControlFlow 0 44) 41) anon114_Then_correct) (=> (= (ControlFlow 0 44) 43) anon114_Else_correct))))))))
(let ((anon47_correct  (=> (and (state Heap@1 Mask@5) (state Heap@1 Mask@5)) (and (=> (= (ControlFlow 0 72) (- 0 73)) (HasDirectPerm Mask@5 xs@@42 next)) (=> (HasDirectPerm Mask@5 xs@@42 next) (and (=> (= (ControlFlow 0 72) 69) anon107_Then_correct) (=> (= (ControlFlow 0 72) 44) anon107_Else_correct)))))))
(let ((anon106_Else_correct  (=> (= (MapType0Select Heap@1 xs@@42 next) null) (=> (and (= Mask@5 Mask@3) (= (ControlFlow 0 75) 72)) anon47_correct))))
(let ((anon106_Then_correct  (=> (not (= (MapType0Select Heap@1 xs@@42 next) null)) (=> (and (= Mask@4 (MapType1Store Mask@3 null (list (MapType0Select Heap@1 xs@@42 next)) (real_2_U (+ (U_2_real (MapType1Select Mask@3 null (list (MapType0Select Heap@1 xs@@42 next)))) FullPerm)))) (InsidePredicate (list xs@@42) (MapType0Select Heap@1 null (list xs@@42)) (list (MapType0Select Heap@1 xs@@42 next)) (MapType0Select Heap@1 null (list (MapType0Select Heap@1 xs@@42 next))))) (=> (and (and (state Heap@1 Mask@4) (not (= (MapType0Select Heap@1 xs@@42 next) null))) (and (= Mask@5 Mask@4) (= (ControlFlow 0 74) 72))) anon47_correct)))))
(let ((anon45_correct  (=> (and (not (= xs@@42 null)) (= Mask@2 (MapType1Store Mask@1 xs@@42 next (real_2_U (+ (U_2_real (MapType1Select Mask@1 xs@@42 next)) FullPerm))))) (=> (and (and (state Heap@1 Mask@2) (not (= xs@@42 null))) (and (= Mask@3 (MapType1Store Mask@2 xs@@42 val (real_2_U (+ (U_2_real (MapType1Select Mask@2 xs@@42 val)) FullPerm)))) (state Heap@1 Mask@3))) (and (=> (= (ControlFlow 0 76) 74) anon106_Then_correct) (=> (= (ControlFlow 0 76) 75) anon106_Else_correct))))))
(let ((anon105_Else_correct  (=> (HasDirectPerm Mask@1 null (list xs@@42)) (=> (and (= Heap@1 Heap@@47) (= (ControlFlow 0 78) 76)) anon45_correct))))
(let ((anon105_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (list xs@@42))) (= Heap@0 (MapType0Store Heap@@47 null (list xs@@42) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 77) 76))) anon45_correct)))
(let ((anon43_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (list xs@@42) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (list xs@@42))) FullPerm)))) (and (=> (= (ControlFlow 0 79) 77) anon105_Then_correct) (=> (= (ControlFlow 0 79) 78) anon105_Else_correct)))))
(let ((anon104_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 82) 79)) anon43_correct)))
(let ((anon104_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 80) (- 0 81)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@42))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@42)))) (=> (= (ControlFlow 0 80) 79) anon43_correct))))))
(let ((anon83_Else_correct  (=> (and (|list#trigger| Heap@@47 (list xs@@42)) (= (MapType0Select Heap@@47 null (list xs@@42)) (CombineFrames (FrameFragment (MapType0Select Heap@@47 xs@@42 next)) (CombineFrames (FrameFragment (MapType0Select Heap@@47 xs@@42 val)) (FrameFragment (ite (not (= (MapType0Select Heap@@47 xs@@42 next) null)) (MapType0Select Heap@@47 null (list (MapType0Select Heap@@47 xs@@42 next))) EmptyFrame)))))) (and (=> (= (ControlFlow 0 83) 80) anon104_Then_correct) (=> (= (ControlFlow 0 83) 82) anon104_Else_correct)))))
(let ((anon0_correct  (=> (state Heap@@47 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@47 xs@@42 $allocated))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (list xs@@42) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (list xs@@42))) FullPerm)))) (state Heap@@47 Mask@0)) (and (not (= xs@@42 null)) (state Heap@@47 Mask@0))) (and (=> (= (ControlFlow 0 139) 138) anon83_Then_correct) (=> (= (ControlFlow 0 139) 83) anon83_Else_correct)))))))
