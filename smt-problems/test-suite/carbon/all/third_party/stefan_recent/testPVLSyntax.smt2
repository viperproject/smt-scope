...
(set-info :boogie-vc-id Test__minus)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 diz $allocated)) (not (= diz null))) (=> (and (and (and (state Heap@@9 ZeroMask) (>= current_thread_id 0)) (and (state Heap@@9 ZeroMask) (= x@0 (- 0 1)))) (and (and (state Heap@@9 ZeroMask) (= x@1 (- 0 x@0))) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))))) (> x@1 0))))))
