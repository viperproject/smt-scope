...
(assert  (and (and (and (and (and (and (and (and (= (type s@@3) (MapType2Type RefType boolType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv3 arg0@@43)) RefType)
 :qid |funType:invRecv3|
 :pattern ( (invRecv3 arg0@@43))
))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type r1) RefType)) (= (type r2) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select s@@3 x_1@@1)) (< NoPerm FullPerm)) (and (qpRange3 x_1@@1) (= (invRecv3 x_1@@1) x_1@@1))))
 :qid |stdinbpl.626:22|
 :skolemid |95|
 :pattern ( (MapType0Select Heap@@9 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
 :pattern ( (MapType2Select s@@3 x_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select s@@3 (invRecv3 o_3))) (< NoPerm FullPerm)) (qpRange3 o_3)) (= (invRecv3 o_3) o_3)))
 :qid |stdinbpl.630:22|
 :skolemid |96|
...
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select s@@3 (invRecv3 o_3@@0))) (< NoPerm FullPerm)) (qpRange3 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select Mask@1 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select s@@3 (invRecv3 o_3@@0))) (< NoPerm FullPerm)) (qpRange3 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select Mask@1 o_3@@0 f_7))))))
 :qid |stdinbpl.642:22|
 :skolemid |98|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (not (= r1 r2))) (=> (not (= r1 r2)) (=> (state Heap@@9 QPMask@0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= FullPerm (U_2_real (MapType1Select QPMask@0 r1 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 r1 f_7))) (=> (= Heap@0 (MapType0Store Heap@@9 r1 f_7 (int_2_U 3))) (=> (and (state Heap@0 QPMask@0) (= (ControlFlow 0 3) (- 0 2))) (not (= r1 r2))))))))))))))))
