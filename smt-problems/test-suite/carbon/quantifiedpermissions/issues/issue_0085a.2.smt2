...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@5) (MapType1Type RefType)) (= (type Heap@4) (MapType1Type RefType))) (= (type this@@12) RefType)) (= (type Mask@4) (MapType2Type RefType realType))) (= (type Heap@2) (MapType1Type RefType))) (= (type Heap@1) (MapType1Type RefType))) (= (type Heap@3) (MapType1Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@3) (MapType2Type RefType realType))) (= (type Mask@2) (MapType2Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (FrameFragment arg0@@48)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@48))
))) (= (type Mask@1) (MapType2Type RefType realType))) (= (type Heap@0) (MapType1Type RefType))) (= (type Heap@@11) (MapType1Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@0) (MapType2Type RefType realType))))
(set-info :boogie-vc-id m1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon8_correct  (=> (= Heap@5 (MapType1Store Heap@4 null (|P#sm| this@@12) (MapType2Store (MapType1Select Heap@4 null (|P#sm| this@@12)) this@@12 n (bool_2_U true)))) (=> (and (state Heap@5 Mask@4) (state Heap@5 Mask@4)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@4 this@@12 n)) (=> (HasDirectPerm Mask@4 this@@12 n) (=> (= (ControlFlow 0 2) (- 0 1)) (= FullPerm (U_2_real (MapType2Select Mask@4 this@@12 n))))))))))
(let ((anon12_Else_correct  (=> (HasDirectPerm Mask@4 null (P this@@12)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 5) 2)) anon8_correct))))
(let ((anon12_Then_correct  (=> (not (HasDirectPerm Mask@4 null (P this@@12))) (=> (and (and (= Heap@2 (MapType1Store Heap@1 null (|P#sm| this@@12) ZeroPMask)) (= Heap@3 (MapType1Store Heap@2 null (P this@@12) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 4) 2))) anon8_correct))))
(let ((anon6_correct  (=> (and (= Mask@3 (MapType2Store Mask@2 this@@12 n (real_2_U (- (U_2_real (MapType2Select Mask@2 this@@12 n)) FullPerm)))) (= Mask@4 (MapType2Store Mask@3 null (P this@@12) (real_2_U (+ (U_2_real (MapType2Select Mask@3 null (P this@@12))) FullPerm))))) (=> (and (and (state Heap@1 Mask@4) (state Heap@1 Mask@4)) (and (|P#trigger| Heap@1 (P this@@12)) (= (MapType1Select Heap@1 null (P this@@12)) (FrameFragment (MapType1Select Heap@1 this@@12 n))))) (and (=> (= (ControlFlow 0 6) 4) anon12_Then_correct) (=> (= (ControlFlow 0 6) 5) anon12_Else_correct))))))
(let ((anon11_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon6_correct)))
(let ((anon11_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType2Select Mask@2 this@@12 n)))) (=> (<= FullPerm (U_2_real (MapType2Select Mask@2 this@@12 n))) (=> (= (ControlFlow 0 7) 6) anon6_correct))))))
(let ((anon4_correct  (=> (not (= this@@12 null)) (=> (and (and (= Mask@2 (MapType2Store Mask@1 this@@12 n (real_2_U (+ (U_2_real (MapType2Select Mask@1 this@@12 n)) FullPerm)))) (state Heap@1 Mask@2)) (and (state Heap@1 Mask@2) (state Heap@1 Mask@2))) (and (=> (= (ControlFlow 0 10) 7) anon11_Then_correct) (=> (= (ControlFlow 0 10) 9) anon11_Else_correct))))))
(let ((anon10_Else_correct  (=> (HasDirectPerm Mask@1 null (P this@@12)) (=> (and (= Heap@1 Heap@@11) (= (ControlFlow 0 12) 10)) anon4_correct))))
(let ((anon10_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (P this@@12))) (= Heap@0 (MapType1Store Heap@@11 null (P this@@12) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 11) 10))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (MapType2Store Mask@0 null (P this@@12) (real_2_U (- (U_2_real (MapType2Select Mask@0 null (P this@@12))) FullPerm)))) (and (=> (= (ControlFlow 0 13) 11) anon10_Then_correct) (=> (= (ControlFlow 0 13) 12) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 13)) anon2_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (U_2_real (MapType2Select Mask@0 null (P this@@12))))) (=> (<= FullPerm (U_2_real (MapType2Select Mask@0 null (P this@@12)))) (=> (= (ControlFlow 0 14) 13) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (U_2_bool (MapType1Select Heap@@11 this@@12 $allocated)) (= Mask@0 (MapType2Store ZeroMask null (P this@@12) (real_2_U (+ (U_2_real (MapType2Select ZeroMask null (P this@@12))) FullPerm))))) (=> (and (and (state Heap@@11 Mask@0) (state Heap@@11 Mask@0)) (and (|P#trigger| Heap@@11 (P this@@12)) (= (MapType1Select Heap@@11 null (P this@@12)) (FrameFragment (MapType1Select Heap@@11 this@@12 n))))) (and (=> (= (ControlFlow 0 17) 14) anon9_Then_correct) (=> (= (ControlFlow 0 17) 16) anon9_Else_correct)))))))
