...
(assert (forall ((this T@U) ) (!  (=> (= (type this) RefType) (IsPredicateField (P this)))
 :qid |stdinbpl.409:15|
 :skolemid |83|
 :pattern ( (P this))
)))
...
(assert (forall ((Heap@@2 T@U) (this@@1 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType1Type RefType)) (= (type this@@1) RefType)) (|P#everUsed| (P this@@1)))
 :qid |stdinbpl.428:15|
 :skolemid |87|
 :pattern ( (|P#trigger| Heap@@2 (P this@@1)))
)))
(assert (forall ((Heap@@3 T@U) (this@@2 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType1Type RefType)) (= (type this@@2) RefType)) (|inv#everUsed| (inv this@@2)))
 :qid |stdinbpl.481:15|
 :skolemid |93|
...
(assert (forall ((arg0@@37 T@U) (arg1@@17 T@U) ) (! (let ((T@@4 (MapType0TypeInv0 (type arg0@@37))))
(= (type (|Set#Union| arg0@@37 arg1@@17)) (MapType0Type T@@4 boolType)))
...
(assert (forall ((arg0@@38 T@U) (arg1@@18 T@U) ) (! (let ((T@@6 (MapType0TypeInv0 (type arg0@@38))))
(= (type (|Set#Intersection| arg0@@38 arg1@@18)) (MapType0Type T@@6 boolType)))
...
(assert (forall ((this@@3 T@U) (this2 T@U) ) (!  (=> (and (and (= (type this@@3) RefType) (= (type this2) RefType)) (= (P this@@3) (P this2))) (= this@@3 this2))
 :qid |stdinbpl.419:15|
 :skolemid |85|
 :pattern ( (P this@@3) (P this2))
)))
(assert (forall ((arg0@@40 T@U) ) (! (= (type (|P#sm| arg0@@40)) (FieldType PredicateType_PType (MapType2Type RefType boolType)))
 :qid |funType:P#sm|
 :pattern ( (|P#sm| arg0@@40))
)))
(assert (forall ((this@@4 T@U) (this2@@0 T@U) ) (!  (=> (and (and (= (type this@@4) RefType) (= (type this2@@0) RefType)) (= (|P#sm| this@@4) (|P#sm| this2@@0))) (= this@@4 this2@@0))
 :qid |stdinbpl.423:15|
 :skolemid |86|
 :pattern ( (|P#sm| this@@4) (|P#sm| this2@@0))
)))
(assert (forall ((this@@5 T@U) (this2@@1 T@U) ) (!  (=> (and (and (= (type this@@5) RefType) (= (type this2@@1) RefType)) (= (inv this@@5) (inv this2@@1))) (= this@@5 this2@@1))
 :qid |stdinbpl.472:15|
 :skolemid |91|
 :pattern ( (inv this@@5) (inv this2@@1))
)))
(assert (forall ((arg0@@41 T@U) ) (! (= (type (|inv#sm| arg0@@41)) (FieldType PredicateType_invType (MapType2Type RefType boolType)))
 :qid |funType:inv#sm|
 :pattern ( (|inv#sm| arg0@@41))
)))
(assert (forall ((this@@6 T@U) (this2@@2 T@U) ) (!  (=> (and (and (= (type this@@6) RefType) (= (type this2@@2) RefType)) (= (|inv#sm| this@@6) (|inv#sm| this2@@2))) (= this@@6 this2@@2))
 :qid |stdinbpl.476:15|
 :skolemid |92|
 :pattern ( (|inv#sm| this@@6) (|inv#sm| this2@@2))
)))
...
(assert (forall ((arg0@@43 Int) (arg1@@20 Int) ) (! (= (type (|sk_inv#condqp1| arg0@@43 arg1@@20)) RefType)
 :qid |funType:sk_inv#condqp1|
 :pattern ( (|sk_inv#condqp1| arg0@@43 arg1@@20))
)))
(assert (forall ((Heap2Heap T@U) (Heap1Heap T@U) (this@@7 T@U) ) (!  (=> (and (and (and (= (type Heap2Heap) (MapType1Type RefType)) (= (type Heap1Heap) (MapType1Type RefType))) (= (type this@@7) RefType)) (and (=  (and (U_2_bool (MapType0Select (MapType1Select Heap2Heap this@@7 n) (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap this@@7) (|inv#condqp1| Heap1Heap this@@7)))) (< NoPerm FullPerm))  (and (U_2_bool (MapType0Select (MapType1Select Heap1Heap this@@7 n) (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap this@@7) (|inv#condqp1| Heap1Heap this@@7)))) (< NoPerm FullPerm))) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap2Heap this@@7 n) (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap this@@7) (|inv#condqp1| Heap1Heap this@@7)))) (< NoPerm FullPerm)) (= (U_2_int (MapType1Select Heap2Heap (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap this@@7) (|inv#condqp1| Heap1Heap this@@7)) f_7)) (U_2_int (MapType1Select Heap1Heap (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap this@@7) (|inv#condqp1| Heap1Heap this@@7)) f_7)))))) (= (|inv#condqp1| Heap2Heap this@@7) (|inv#condqp1| Heap1Heap this@@7)))
 :qid |stdinbpl.492:15|
 :skolemid |94|
...
(assert (forall ((arg0@@46 T@U) (arg1@@22 T@U) ) (! (let ((T@@20 (MapType0TypeInv0 (type arg0@@46))))
(= (type (|Set#Difference| arg0@@46 arg1@@22)) (MapType0Type T@@20 boolType)))
...
(= (type (|Set#UnionOne| arg0@@47 arg1@@23)) (MapType0Type T@@24 boolType)))
...
(assert (forall ((this@@8 T@U) ) (!  (=> (= (type this@@8) RefType) (= (getPredWandId (P this@@8)) 0))
 :qid |stdinbpl.413:15|
 :skolemid |84|
 :pattern ( (P this@@8))
)))
(assert (forall ((this@@9 T@U) ) (!  (=> (= (type this@@9) RefType) (= (getPredWandId (inv this@@9)) 1))
 :qid |stdinbpl.466:15|
 :skolemid |90|
 :pattern ( (inv this@@9))
)))
...
(assert (forall ((this@@10 T@U) ) (!  (=> (= (type this@@10) RefType) (= (PredicateMaskField (P this@@10)) (|P#sm| this@@10)))
 :qid |stdinbpl.405:15|
 :skolemid |82|
 :pattern ( (PredicateMaskField (P this@@10)))
)))
(assert (forall ((this@@11 T@U) ) (!  (=> (= (type this@@11) RefType) (= (PredicateMaskField (inv this@@11)) (|inv#sm| this@@11)))
 :qid |stdinbpl.458:15|
 :skolemid |88|
 :pattern ( (PredicateMaskField (inv this@@11)))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@5) (MapType1Type RefType)) (= (type Heap@4) (MapType1Type RefType))) (= (type this@@12) RefType)) (= (type newPMask@0) (MapType2Type RefType boolType))) (= (type Heap@6) (MapType1Type RefType))) (= (type Mask@4) (MapType2Type RefType realType))) (= (type Heap@2) (MapType1Type RefType))) (= (type Heap@1) (MapType1Type RefType))) (= (type Heap@3) (MapType1Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@3) (MapType2Type RefType realType))) (= (type QPMask@0) (MapType2Type RefType realType))) (= (type QPMask@1) (MapType2Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv3 arg0@@48)) RefType)
 :qid |funType:invRecv3|
 :pattern ( (invRecv3 arg0@@48))
))) (forall ((arg0@@49 T@U) (arg1@@24 T@U) ) (! (= (type (CombineFrames arg0@@49 arg1@@24)) FrameTypeType)
 :qid |funType:CombineFrames|
 :pattern ( (CombineFrames arg0@@49 arg1@@24))
))) (forall ((arg0@@50 T@U) ) (! (= (type (FrameFragment arg0@@50)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@50))
))) (= (type Mask@2) (MapType2Type RefType realType))) (= (type Mask@1) (MapType2Type RefType realType))) (forall ((arg0@@51 T@U) ) (! (= (type (invRecv2 arg0@@51)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon8_correct  (=> (= Heap@5 (MapType1Store Heap@4 null (|inv#sm| this@@12) (MapType2Store (MapType1Select Heap@4 null (|inv#sm| this@@12)) this@@12 n (bool_2_U true)))) (=> (and (forall ((o_4 T@U) (f_8 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_8))))
(let ((A@@12 (FieldTypeInv0 (type f_8))))
 (=> (and (and (= (type o_4) RefType) (= (type f_8) (FieldType A@@12 B@@11))) (U_2_bool (MapType2Select (MapType1Select Heap@5 null (|inv#sm| this@@12)) o_4 f_8))) (U_2_bool (MapType2Select newPMask@0 o_4 f_8)))))
 :qid |stdinbpl.851:27|
 :skolemid |113|
 :pattern ( (MapType2Select newPMask@0 o_4 f_8))
)) (forall ((x_2 T@U) ) (!  (=> (and (= (type x_2) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@5 this@@12 n) x_2))) (U_2_bool (MapType2Select newPMask@0 x_2 f_7)))
 :qid |stdinbpl.855:20|
 :skolemid |114|
 :no-pattern (type x_2)
 :no-pattern (U_2_int x_2)
 :no-pattern (U_2_bool x_2)
))) (=> (and (and (= Heap@6 (MapType1Store Heap@5 null (|inv#sm| this@@12) newPMask@0)) (state Heap@6 Mask@4)) (and (state Heap@6 Mask@4) (= (ControlFlow 0 2) (- 0 1)))) (= FullPerm (U_2_real (MapType2Select Mask@4 this@@12 n))))))))
(let ((anon12_Else_correct  (=> (HasDirectPerm Mask@4 null (inv this@@12)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 4) 2)) anon8_correct))))
(let ((anon12_Then_correct  (=> (not (HasDirectPerm Mask@4 null (inv this@@12))) (=> (and (and (= Heap@2 (MapType1Store Heap@1 null (|inv#sm| this@@12) ZeroPMask)) (= Heap@3 (MapType1Store Heap@2 null (inv this@@12) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 3) 2))) anon8_correct))))
(let ((anon6_correct  (=> (= Mask@3 (MapType2Store QPMask@0 this@@12 n (real_2_U (- (U_2_real (MapType2Select QPMask@0 this@@12 n)) FullPerm)))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@12 n) x_1))) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@12 n) x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.803:17|
 :skolemid |107|
 :pattern ( (neverTriggered3 x_1) (neverTriggered3 x_1_1))
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@12 n) x_1@@0))) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@12 n) x_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.803:17|
 :skolemid |107|
 :pattern ( (neverTriggered3 x_1@@0) (neverTriggered3 x_1_1@@0))
)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((x_1@@1 T@U) ) (!  (=> (and (= (type x_1@@1) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@12 n) x_1@@1))) (>= (U_2_real (MapType2Select Mask@3 x_1@@1 f_7)) FullPerm))
 :qid |stdinbpl.810:17|
 :skolemid |108|
 :pattern ( (MapType1Select Heap@1 x_1@@1 f_7))
 :pattern ( (MapType2Select QPMask@1 x_1@@1 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@1 this@@12 n) x_1@@1))
))) (=> (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@12 n) x_1@@2))) (>= (U_2_real (MapType2Select Mask@3 x_1@@2 f_7)) FullPerm))
 :qid |stdinbpl.810:17|
 :skolemid |108|
 :pattern ( (MapType1Select Heap@1 x_1@@2 f_7))
 :pattern ( (MapType2Select QPMask@1 x_1@@2 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@1 this@@12 n) x_1@@2))
)) (=> (forall ((x_1@@3 T@U) ) (!  (=> (= (type x_1@@3) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@12 n) x_1@@3)) (< NoPerm FullPerm)) (and (qpRange3 x_1@@3) (= (invRecv3 x_1@@3) x_1@@3))))
 :qid |stdinbpl.816:22|
 :skolemid |109|
 :pattern ( (MapType1Select Heap@1 x_1@@3 f_7))
 :pattern ( (MapType2Select QPMask@1 x_1@@3 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@1 this@@12 n) x_1@@3))
)) (=> (and (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@12 n) (invRecv3 o_3))) (and (< NoPerm FullPerm) (qpRange3 o_3))) (= (invRecv3 o_3) o_3)))
 :qid |stdinbpl.820:22|
 :skolemid |110|
 :pattern ( (invRecv3 o_3))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@12 n) (invRecv3 o_3@@0))) (and (< NoPerm FullPerm) (qpRange3 o_3@@0))) (and (= (invRecv3 o_3@@0) o_3@@0) (= (U_2_real (MapType2Select QPMask@1 o_3@@0 f_7)) (- (U_2_real (MapType2Select Mask@3 o_3@@0 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@12 n) (invRecv3 o_3@@0))) (and (< NoPerm FullPerm) (qpRange3 o_3@@0)))) (= (U_2_real (MapType2Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType2Select Mask@3 o_3@@0 f_7))))))
 :qid |stdinbpl.826:22|
 :skolemid |111|
...
)) (= Mask@4 (MapType2Store QPMask@1 null (inv this@@12) (real_2_U (+ (U_2_real (MapType2Select QPMask@1 null (inv this@@12))) FullPerm)))))) (and (and (state Heap@1 Mask@4) (state Heap@1 Mask@4)) (and (|inv#trigger| Heap@1 (inv this@@12)) (= (MapType1Select Heap@1 null (inv this@@12)) (CombineFrames (FrameFragment (MapType1Select Heap@1 this@@12 n)) (FrameFragment (int_2_U (|inv#condqp1| Heap@1 this@@12)))))))) (and (=> (= (ControlFlow 0 5) 3) anon12_Then_correct) (=> (= (ControlFlow 0 5) 4) anon12_Else_correct)))))))))))
(let ((anon11_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 5)) anon6_correct)))
(let ((anon11_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType2Select QPMask@0 this@@12 n)))) (=> (<= FullPerm (U_2_real (MapType2Select QPMask@0 this@@12 n))) (=> (= (ControlFlow 0 8) 5) anon6_correct))))))
(let ((anon4_correct  (=> (not (= this@@12 null)) (=> (and (= Mask@2 (MapType2Store Mask@1 this@@12 n (real_2_U (+ (U_2_real (MapType2Select Mask@1 this@@12 n)) FullPerm)))) (state Heap@1 Mask@2)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((x@@19 T@U) (x_3 T@U) ) (!  (=> (and (= (type x@@19) RefType) (= (type x_3) RefType)) (=> (and (and (and (and (not (= x@@19 x_3)) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@12 n) x@@19))) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@12 n) x_3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@19 x_3))))
 :qid |stdinbpl.752:15|
 :skolemid |101|
...
))) (=> (forall ((x@@20 T@U) (x_3@@0 T@U) ) (!  (=> (and (= (type x@@20) RefType) (= (type x_3@@0) RefType)) (=> (and (and (and (and (not (= x@@20 x_3@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@12 n) x@@20))) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@12 n) x_3@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@20 x_3@@0))))
 :qid |stdinbpl.752:15|
 :skolemid |101|
...
)) (=> (and (and (and (forall ((x@@21 T@U) ) (!  (=> (= (type x@@21) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@12 n) x@@21)) (< NoPerm FullPerm)) (and (qpRange2 x@@21) (= (invRecv2 x@@21) x@@21))))
 :qid |stdinbpl.758:22|
 :skolemid |102|
 :pattern ( (MapType1Select Heap@1 x@@21 f_7))
 :pattern ( (MapType2Select QPMask@0 x@@21 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@1 this@@12 n) x@@21))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@12 n) (invRecv2 o_3@@2))) (< NoPerm FullPerm)) (qpRange2 o_3@@2)) (= (invRecv2 o_3@@2) o_3@@2)))
 :qid |stdinbpl.762:22|
 :skolemid |103|
 :pattern ( (invRecv2 o_3@@2))
))) (and (forall ((x@@22 T@U) ) (!  (=> (and (= (type x@@22) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@12 n) x@@22))) (not (= x@@22 null)))
 :qid |stdinbpl.768:22|
 :skolemid |104|
 :pattern ( (MapType1Select Heap@1 x@@22 f_7))
 :pattern ( (MapType2Select QPMask@0 x@@22 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@1 this@@12 n) x@@22))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@12 n) (invRecv2 o_3@@3))) (< NoPerm FullPerm)) (qpRange2 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@3) o_3@@3)) (= (U_2_real (MapType2Select QPMask@0 o_3@@3 f_7)) (+ (U_2_real (MapType2Select Mask@2 o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@12 n) (invRecv2 o_3@@3))) (< NoPerm FullPerm)) (qpRange2 o_3@@3))) (= (U_2_real (MapType2Select QPMask@0 o_3@@3 f_7)) (U_2_real (MapType2Select Mask@2 o_3@@3 f_7))))))
 :qid |stdinbpl.774:22|
 :skolemid |105|
...
(let ((anon10_Else_correct  (=> (HasDirectPerm Mask@1 null (inv this@@12)) (=> (and (= Heap@1 Heap@@11) (= (ControlFlow 0 14) 11)) anon4_correct))))
(let ((anon10_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (inv this@@12))) (= Heap@0 (MapType1Store Heap@@11 null (inv this@@12) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 13) 11))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (MapType2Store Mask@0 null (inv this@@12) (real_2_U (- (U_2_real (MapType2Select Mask@0 null (inv this@@12))) FullPerm)))) (and (=> (= (ControlFlow 0 15) 13) anon10_Then_correct) (=> (= (ControlFlow 0 15) 14) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 18) 15)) anon2_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= FullPerm (U_2_real (MapType2Select Mask@0 null (inv this@@12))))) (=> (<= FullPerm (U_2_real (MapType2Select Mask@0 null (inv this@@12)))) (=> (= (ControlFlow 0 16) 15) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (U_2_bool (MapType1Select Heap@@11 this@@12 $allocated)) (= Mask@0 (MapType2Store ZeroMask null (inv this@@12) (real_2_U (+ (U_2_real (MapType2Select ZeroMask null (inv this@@12))) FullPerm))))) (=> (and (and (state Heap@@11 Mask@0) (state Heap@@11 Mask@0)) (and (|inv#trigger| Heap@@11 (inv this@@12)) (= (MapType1Select Heap@@11 null (inv this@@12)) (CombineFrames (FrameFragment (MapType1Select Heap@@11 this@@12 n)) (FrameFragment (int_2_U (|inv#condqp1| Heap@@11 this@@12))))))) (and (=> (= (ControlFlow 0 19) 16) anon9_Then_correct) (=> (= (ControlFlow 0 19) 18) anon9_Else_correct)))))))
