...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= k NoPerm)) (=> (>= k NoPerm) (=> (and (=> (> k NoPerm) (not (= x@@8 null))) (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) k))))) (=> (and (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (<= NoPerm k))))))))
