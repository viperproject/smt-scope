...
(let ((anon0_correct  (=> (and (state Heap@@75 ZeroMask) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))
...
(declare-fun Heap@@75 () T@U)
(assert (= (type Heap@@75) (MapType0Type RefType)))
(set-info :boogie-vc-id |fun17#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
...
(let ((anon0_correct  (=> (and (state Heap@@75 ZeroMask) (= AssumeFunctionsAbove 5)) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
