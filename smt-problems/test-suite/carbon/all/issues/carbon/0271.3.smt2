...
(declare-fun l1@@4 () T@U)
(declare-fun l2@@4 () T@U)
(declare-fun k@@4 () Int)
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type UnfoldingMask@15) (MapType1Type RefType realType)) (= (type l2@@4) RefType)) (= (type UnfoldingMask@4) (MapType1Type RefType realType))) (= (type Heap@@27) (MapType0Type RefType))) (= (type l1@@4) RefType)) (= (type UnfoldingMask@13) (MapType1Type RefType realType))) (= (type UnfoldingMask@5) (MapType1Type RefType realType))) (= (type UnfoldingMask@11) (MapType1Type RefType realType))) (= (type Heap@7) (MapType0Type RefType))) (= (type UnfoldingMask@10) (MapType1Type RefType realType))) (= (type Heap@19) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@17) (MapType0Type RefType))) (= (type newPMask@4) (MapType1Type RefType boolType))) (= (type Heap@18) (MapType0Type RefType))) (= (type Heap@15) (MapType0Type RefType))) (= (type Heap@16) (MapType0Type RefType))) (= (type Heap@13) (MapType0Type RefType))) (= (type newPMask@3) (MapType1Type RefType boolType))) (= (type Heap@14) (MapType0Type RefType))) (= (type Heap@11) (MapType0Type RefType))) (= (type Heap@12) (MapType0Type RefType))) (= (type Heap@9) (MapType0Type RefType))) (= (type newPMask@2) (MapType1Type RefType boolType))) (= (type Heap@10) (MapType0Type RefType))) (= (type Heap@8) (MapType0Type RefType))) (= (type UnfoldingMask@9) (MapType1Type RefType realType))) (= (type UnfoldingMask@8) (MapType1Type RefType realType))) (= (type UnfoldingMask@6) (MapType1Type RefType realType))) (= (type UnfoldingMask@7) (MapType1Type RefType realType))) (= (type Heap@5) (MapType0Type RefType))) (= (type newPMask@1) (MapType1Type RefType boolType))) (= (type Heap@6) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type UnfoldingMask@3) (MapType1Type RefType realType))) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |listLength#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 73) (let ((anon45_correct  (=> (state Heap@19 Mask@1) (=> (and (= Result@0 (+ (+ (ite (= (MapType0Select Heap@19 l1@@4 next) null) 1 (+ 1 (listLength Heap@19 (MapType0Select Heap@19 l1@@4 next) l2@@4 k@@4))) (listLength Heap@19 l1@@4 l2@@4 (- k@@4 1))) (ite (= (MapType0Select Heap@19 l2@@4 next2) null) 1 (+ 1 (listLength Heap@19 l1@@4 (MapType0Select Heap@19 l2@@4 next2) k@@4))))) (= (ControlFlow 0 26) (- 0 25))) (> Result@0 0)))))
(let ((anon66_Else_correct  (=> (= (MapType0Select Heap@17 l2@@4 next2) null) (=> (and (= Heap@19 Heap@17) (= (ControlFlow 0 28) 26)) anon45_correct))))
(let ((anon66_Then_correct  (=> (not (= (MapType0Select Heap@17 l2@@4 next2) null)) (=> (and (and (forall ((o_8 T@U) (f_11 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_11))))
(let ((A@@12 (FieldTypeInv0 (type f_11))))
 (=> (and (and (= (type o_8) RefType) (= (type f_11) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@17 null (|list2#sm| l2@@4)) o_8 f_11)) (U_2_bool (MapType1Select (MapType0Select Heap@17 null (|list2#sm| (MapType0Select Heap@17 l2@@4 next2))) o_8 f_11)))) (U_2_bool (MapType1Select newPMask@4 o_8 f_11)))))
 :qid |stdinbpl.1143:33|
 :skolemid |91|
 :pattern ( (MapType1Select newPMask@4 o_8 f_11))
)) (= Heap@18 (MapType0Store Heap@17 null (|list2#sm| l2@@4) newPMask@4))) (and (= Heap@19 Heap@18) (= (ControlFlow 0 27) 26))) anon45_correct))))
(let ((anon43_correct  (=> (and (and (state Heap@15 Mask@1) (state Heap@15 Mask@1)) (and (= Heap@16 (MapType0Store Heap@15 null (|list2#sm| l2@@4) (MapType1Store (MapType0Select Heap@15 null (|list2#sm| l2@@4)) l2@@4 elem2 (bool_2_U true)))) (= Heap@17 (MapType0Store Heap@16 null (|list2#sm| l2@@4) (MapType1Store (MapType0Select Heap@16 null (|list2#sm| l2@@4)) l2@@4 next2 (bool_2_U true)))))) (and (=> (= (ControlFlow 0 29) 27) anon66_Then_correct) (=> (= (ControlFlow 0 29) 28) anon66_Else_correct)))))
(let ((anon65_Else_correct  (=> (= (MapType0Select Heap@13 l1@@4 next) null) (=> (and (= Heap@15 Heap@13) (= (ControlFlow 0 31) 29)) anon43_correct))))
(let ((anon65_Then_correct  (=> (not (= (MapType0Select Heap@13 l1@@4 next) null)) (=> (and (and (forall ((o_7 T@U) (f_10 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_10))))
(let ((A@@13 (FieldTypeInv0 (type f_10))))
 (=> (and (and (= (type o_7) RefType) (= (type f_10) (FieldType A@@13 B@@12))) (or (U_2_bool (MapType1Select (MapType0Select Heap@13 null (|list#sm| l1@@4)) o_7 f_10)) (U_2_bool (MapType1Select (MapType0Select Heap@13 null (|list#sm| (MapType0Select Heap@13 l1@@4 next))) o_7 f_10)))) (U_2_bool (MapType1Select newPMask@3 o_7 f_10)))))
 :qid |stdinbpl.1130:33|
 :skolemid |90|
 :pattern ( (MapType1Select newPMask@3 o_7 f_10))
)) (= Heap@14 (MapType0Store Heap@13 null (|list#sm| l1@@4) newPMask@3))) (and (= Heap@15 Heap@14) (= (ControlFlow 0 30) 29))) anon43_correct))))
(let ((anon41_correct  (=> (state Heap@11 Mask@1) (=> (and (= Heap@12 (MapType0Store Heap@11 null (|list#sm| l1@@4) (MapType1Store (MapType0Select Heap@11 null (|list#sm| l1@@4)) l1@@4 elem (bool_2_U true)))) (= Heap@13 (MapType0Store Heap@12 null (|list#sm| l1@@4) (MapType1Store (MapType0Select Heap@12 null (|list#sm| l1@@4)) l1@@4 next (bool_2_U true))))) (and (=> (= (ControlFlow 0 32) 30) anon65_Then_correct) (=> (= (ControlFlow 0 32) 31) anon65_Else_correct))))))
(let ((anon64_Else_correct  (=> (= (MapType0Select Heap@9 l2@@4 next2) null) (=> (and (= Heap@11 Heap@9) (= (ControlFlow 0 34) 32)) anon41_correct))))
(let ((anon64_Then_correct  (=> (not (= (MapType0Select Heap@9 l2@@4 next2) null)) (=> (and (and (forall ((o_6 T@U) (f_9 T@U) ) (! (let ((B@@13 (FieldTypeInv1 (type f_9))))
(let ((A@@14 (FieldTypeInv0 (type f_9))))
 (=> (and (and (= (type o_6) RefType) (= (type f_9) (FieldType A@@14 B@@13))) (or (U_2_bool (MapType1Select (MapType0Select Heap@9 null (|list2#sm| l2@@4)) o_6 f_9)) (U_2_bool (MapType1Select (MapType0Select Heap@9 null (|list2#sm| (MapType0Select Heap@9 l2@@4 next2))) o_6 f_9)))) (U_2_bool (MapType1Select newPMask@2 o_6 f_9)))))
 :qid |stdinbpl.1117:33|
 :skolemid |89|
 :pattern ( (MapType1Select newPMask@2 o_6 f_9))
)) (= Heap@10 (MapType0Store Heap@9 null (|list2#sm| l2@@4) newPMask@2))) (and (= Heap@11 Heap@10) (= (ControlFlow 0 33) 32))) anon41_correct))))
(let ((anon39_correct  (=> (and (= Heap@8 (MapType0Store Heap@7 null (|list2#sm| l2@@4) (MapType1Store (MapType0Select Heap@7 null (|list2#sm| l2@@4)) l2@@4 elem2 (bool_2_U true)))) (= Heap@9 (MapType0Store Heap@8 null (|list2#sm| l2@@4) (MapType1Store (MapType0Select Heap@8 null (|list2#sm| l2@@4)) l2@@4 next2 (bool_2_U true))))) (and (=> (= (ControlFlow 0 35) 33) anon64_Then_correct) (=> (= (ControlFlow 0 35) 34) anon64_Else_correct)))))
(let ((anon61_Else_correct  (=> (and (|listLength#trigger| (CombineFrames (MapType0Select Heap@7 null (list l1@@4)) (MapType0Select Heap@7 null (list2 (MapType0Select Heap@7 l2@@4 next2)))) l1@@4 (MapType0Select Heap@7 l2@@4 next2) k@@4) (= (ControlFlow 0 37) 35)) anon39_correct)))
(let ((anon60_Then_correct  (=> (and (= (MapType0Select Heap@7 l2@@4 next2) null) (= (ControlFlow 0 36) 35)) anon39_correct)))
(let ((anon37_correct true))
(let ((anon63_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 20) 17)) anon37_correct)))
(let ((anon63_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@11 null (list2 (MapType0Select Heap@7 l2@@4 next2)))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@11 null (list2 (MapType0Select Heap@7 l2@@4 next2))))) (=> (= (ControlFlow 0 18) 17) anon37_correct))))))
(let ((anon35_correct  (=> (= UnfoldingMask@11 (MapType1Store UnfoldingMask@10 null (list l1@@4) (real_2_U (- (U_2_real (MapType1Select UnfoldingMask@10 null (list l1@@4))) FullPerm)))) (and (=> (= (ControlFlow 0 21) 18) anon63_Then_correct) (=> (= (ControlFlow 0 21) 20) anon63_Else_correct)))))
(let ((anon62_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 24) 21)) anon35_correct)))
(let ((anon62_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@10 null (list l1@@4))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@10 null (list l1@@4)))) (=> (= (ControlFlow 0 22) 21) anon35_correct))))))
(let ((anon60_Else_correct  (=> (not (= (MapType0Select Heap@7 l2@@4 next2) null)) (and (=> (= (ControlFlow 0 38) (- 0 39)) (HasDirectPerm UnfoldingMask@10 l2@@4 next2)) (=> (HasDirectPerm UnfoldingMask@10 l2@@4 next2) (and (and (=> (= (ControlFlow 0 38) 37) anon61_Else_correct) (=> (= (ControlFlow 0 38) 22) anon62_Then_correct)) (=> (= (ControlFlow 0 38) 24) anon62_Else_correct)))))))
(let ((anon30_correct  (=> (state Heap@7 UnfoldingMask@10) (and (=> (= (ControlFlow 0 40) (- 0 41)) (HasDirectPerm UnfoldingMask@10 l2@@4 next2)) (=> (HasDirectPerm UnfoldingMask@10 l2@@4 next2) (and (=> (= (ControlFlow 0 40) 36) anon60_Then_correct) (=> (= (ControlFlow 0 40) 38) anon60_Else_correct)))))))
(let ((anon59_Else_correct  (=> (= (MapType0Select Heap@7 l2@@4 next2) null) (=> (and (= UnfoldingMask@10 UnfoldingMask@8) (= (ControlFlow 0 43) 40)) anon30_correct))))
(let ((anon59_Then_correct  (=> (and (not (= (MapType0Select Heap@7 l2@@4 next2) null)) (= UnfoldingMask@9 (MapType1Store UnfoldingMask@8 null (list2 (MapType0Select Heap@7 l2@@4 next2)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@8 null (list2 (MapType0Select Heap@7 l2@@4 next2)))) FullPerm))))) (=> (and (and (InsidePredicate (list2 l2@@4) (MapType0Select Heap@7 null (list2 l2@@4)) (list2 (MapType0Select Heap@7 l2@@4 next2)) (MapType0Select Heap@7 null (list2 (MapType0Select Heap@7 l2@@4 next2)))) (state Heap@7 UnfoldingMask@9)) (and (= UnfoldingMask@10 UnfoldingMask@9) (= (ControlFlow 0 42) 40))) anon30_correct))))
(let ((anon28_correct  (=> (= UnfoldingMask@6 (MapType1Store Mask@1 null (list2 l2@@4) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (list2 l2@@4))) FullPerm)))) (=> (and (not (= l2@@4 null)) (= UnfoldingMask@7 (MapType1Store UnfoldingMask@6 l2@@4 elem2 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@6 l2@@4 elem2)) FullPerm))))) (=> (and (and (state Heap@7 UnfoldingMask@7) (not (= l2@@4 null))) (and (= UnfoldingMask@8 (MapType1Store UnfoldingMask@7 l2@@4 next2 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@7 l2@@4 next2)) FullPerm)))) (state Heap@7 UnfoldingMask@8))) (and (=> (= (ControlFlow 0 44) 42) anon59_Then_correct) (=> (= (ControlFlow 0 44) 43) anon59_Else_correct)))))))
(let ((anon58_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 47) 44)) anon28_correct)))
(let ((anon58_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 45) (- 0 46)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (list2 l2@@4))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (list2 l2@@4)))) (=> (= (ControlFlow 0 45) 44) anon28_correct))))))
(let ((anon26_correct  (=> (and (and (state Heap@7 Mask@1) (state Heap@7 Mask@1)) (and (|list2#trigger| Heap@7 (list2 l2@@4)) (= (MapType0Select Heap@7 null (list2 l2@@4)) (CombineFrames (FrameFragment (MapType0Select Heap@7 l2@@4 elem2)) (CombineFrames (FrameFragment (MapType0Select Heap@7 l2@@4 next2)) (FrameFragment (ite (not (= (MapType0Select Heap@7 l2@@4 next2) null)) (MapType0Select Heap@7 null (list2 (MapType0Select Heap@7 l2@@4 next2))) EmptyFrame))))))) (and (=> (= (ControlFlow 0 48) 45) anon58_Then_correct) (=> (= (ControlFlow 0 48) 47) anon58_Else_correct)))))
(let ((anon57_Else_correct  (=> (= (MapType0Select Heap@5 l1@@4 next) null) (=> (and (= Heap@7 Heap@5) (= (ControlFlow 0 50) 48)) anon26_correct))))
(let ((anon57_Then_correct  (=> (not (= (MapType0Select Heap@5 l1@@4 next) null)) (=> (and (and (forall ((o_5 T@U) (f_8 T@U) ) (! (let ((B@@14 (FieldTypeInv1 (type f_8))))
(let ((A@@15 (FieldTypeInv0 (type f_8))))
 (=> (and (and (= (type o_5) RefType) (= (type f_8) (FieldType A@@15 B@@14))) (or (U_2_bool (MapType1Select (MapType0Select Heap@5 null (|list#sm| l1@@4)) o_5 f_8)) (U_2_bool (MapType1Select (MapType0Select Heap@5 null (|list#sm| (MapType0Select Heap@5 l1@@4 next))) o_5 f_8)))) (U_2_bool (MapType1Select newPMask@1 o_5 f_8)))))
 :qid |stdinbpl.1040:33|
 :skolemid |88|
 :pattern ( (MapType1Select newPMask@1 o_5 f_8))
)) (= Heap@6 (MapType0Store Heap@5 null (|list#sm| l1@@4) newPMask@1))) (and (= Heap@7 Heap@6) (= (ControlFlow 0 49) 48))) anon26_correct))))
(let ((anon54_Else_correct  (=> (and (and (|listLength#trigger| (CombineFrames (MapType0Select Heap@3 null (list l1@@4)) (MapType0Select Heap@3 null (list2 l2@@4))) l1@@4 l2@@4 (- k@@4 1)) (state Heap@3 Mask@1)) (and (= Heap@4 (MapType0Store Heap@3 null (|list#sm| l1@@4) (MapType1Store (MapType0Select Heap@3 null (|list#sm| l1@@4)) l1@@4 elem (bool_2_U true)))) (= Heap@5 (MapType0Store Heap@4 null (|list#sm| l1@@4) (MapType1Store (MapType0Select Heap@4 null (|list#sm| l1@@4)) l1@@4 next (bool_2_U true)))))) (and (=> (= (ControlFlow 0 51) 49) anon57_Then_correct) (=> (= (ControlFlow 0 51) 50) anon57_Else_correct)))))
(let ((anon22_correct true))
(let ((anon56_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon22_correct)))
(let ((anon56_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@13 null (list2 l2@@4))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@13 null (list2 l2@@4)))) (=> (= (ControlFlow 0 10) 9) anon22_correct))))))
(let ((anon20_correct  (=> (= UnfoldingMask@13 (MapType1Store UnfoldingMask@5 null (list l1@@4) (real_2_U (- (U_2_real (MapType1Select UnfoldingMask@5 null (list l1@@4))) FullPerm)))) (and (=> (= (ControlFlow 0 13) 10) anon56_Then_correct) (=> (= (ControlFlow 0 13) 12) anon56_Else_correct)))))
(let ((anon55_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 13)) anon20_correct)))
(let ((anon55_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@5 null (list l1@@4))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@5 null (list l1@@4)))) (=> (= (ControlFlow 0 14) 13) anon20_correct))))))
(let ((anon17_correct  (=> (and (= UnfoldingMask@5 (MapType1Store Mask@1 null (someList l1@@4 k@@4) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (someList l1@@4 k@@4))) FullPerm)))) (state Heap@3 UnfoldingMask@5)) (and (and (=> (= (ControlFlow 0 52) 51) anon54_Else_correct) (=> (= (ControlFlow 0 52) 14) anon55_Then_correct)) (=> (= (ControlFlow 0 52) 16) anon55_Else_correct)))))
(let ((anon53_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 55) 52)) anon17_correct)))
(let ((anon53_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 53) (- 0 54)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (someList l1@@4 k@@4))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (someList l1@@4 k@@4)))) (=> (= (ControlFlow 0 53) 52) anon17_correct))))))
(let ((anon15_correct  (=> (state Heap@3 Mask@1) (=> (and (|someList#trigger| Heap@3 (someList l1@@4 k@@4)) (= (MapType0Select Heap@3 null (someList l1@@4 k@@4)) EmptyFrame)) (and (=> (= (ControlFlow 0 56) 53) anon53_Then_correct) (=> (= (ControlFlow 0 56) 55) anon53_Else_correct))))))
(let ((anon52_Else_correct  (=> (= (MapType0Select Heap@1 l1@@4 next) null) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 58) 56)) anon15_correct))))
(let ((anon52_Then_correct  (=> (not (= (MapType0Select Heap@1 l1@@4 next) null)) (=> (and (and (forall ((o_4 T@U) (f_7 T@U) ) (! (let ((B@@15 (FieldTypeInv1 (type f_7))))
(let ((A@@16 (FieldTypeInv0 (type f_7))))
 (=> (and (and (= (type o_4) RefType) (= (type f_7) (FieldType A@@16 B@@15))) (or (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|list#sm| l1@@4)) o_4 f_7)) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|list#sm| (MapType0Select Heap@1 l1@@4 next))) o_4 f_7)))) (U_2_bool (MapType1Select newPMask@0 o_4 f_7)))))
 :qid |stdinbpl.984:33|
 :skolemid |87|
 :pattern ( (MapType1Select newPMask@0 o_4 f_7))
)) (= Heap@2 (MapType0Store Heap@1 null (|list#sm| l1@@4) newPMask@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 57) 56))) anon15_correct))))
(let ((anon13_correct  (=> (and (= Heap@0 (MapType0Store Heap@@27 null (|list#sm| l1@@4) (MapType1Store (MapType0Select Heap@@27 null (|list#sm| l1@@4)) l1@@4 elem (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|list#sm| l1@@4) (MapType1Store (MapType0Select Heap@0 null (|list#sm| l1@@4)) l1@@4 next (bool_2_U true))))) (and (=> (= (ControlFlow 0 59) 57) anon52_Then_correct) (=> (= (ControlFlow 0 59) 58) anon52_Else_correct)))))
(let ((anon49_Else_correct  (=> (and (|listLength#trigger| (CombineFrames (MapType0Select Heap@@27 null (list (MapType0Select Heap@@27 l1@@4 next))) (MapType0Select Heap@@27 null (list2 l2@@4))) (MapType0Select Heap@@27 l1@@4 next) l2@@4 k@@4) (= (ControlFlow 0 61) 59)) anon13_correct)))
(let ((anon48_Then_correct  (=> (and (= (MapType0Select Heap@@27 l1@@4 next) null) (= (ControlFlow 0 60) 59)) anon13_correct)))
(let ((anon11_correct true))
(let ((anon51_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon11_correct)))
(let ((anon51_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@15 null (list2 l2@@4))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@15 null (list2 l2@@4)))) (=> (= (ControlFlow 0 2) 1) anon11_correct))))))
(let ((anon9_correct  (=> (= UnfoldingMask@15 (MapType1Store UnfoldingMask@4 null (list (MapType0Select Heap@@27 l1@@4 next)) (real_2_U (- (U_2_real (MapType1Select UnfoldingMask@4 null (list (MapType0Select Heap@@27 l1@@4 next)))) FullPerm)))) (and (=> (= (ControlFlow 0 5) 2) anon51_Then_correct) (=> (= (ControlFlow 0 5) 4) anon51_Else_correct)))))
(let ((anon50_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon9_correct)))
(let ((anon50_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (list (MapType0Select Heap@@27 l1@@4 next)))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (list (MapType0Select Heap@@27 l1@@4 next))))) (=> (= (ControlFlow 0 6) 5) anon9_correct))))))
(let ((anon48_Else_correct  (=> (not (= (MapType0Select Heap@@27 l1@@4 next) null)) (and (=> (= (ControlFlow 0 62) (- 0 63)) (HasDirectPerm UnfoldingMask@4 l1@@4 next)) (=> (HasDirectPerm UnfoldingMask@4 l1@@4 next) (and (and (=> (= (ControlFlow 0 62) 61) anon49_Else_correct) (=> (= (ControlFlow 0 62) 6) anon50_Then_correct)) (=> (= (ControlFlow 0 62) 8) anon50_Else_correct)))))))
(let ((anon4_correct  (=> (state Heap@@27 UnfoldingMask@4) (and (=> (= (ControlFlow 0 64) (- 0 65)) (HasDirectPerm UnfoldingMask@4 l1@@4 next)) (=> (HasDirectPerm UnfoldingMask@4 l1@@4 next) (and (=> (= (ControlFlow 0 64) 60) anon48_Then_correct) (=> (= (ControlFlow 0 64) 62) anon48_Else_correct)))))))
(let ((anon47_Else_correct  (=> (= (MapType0Select Heap@@27 l1@@4 next) null) (=> (and (= UnfoldingMask@4 UnfoldingMask@2) (= (ControlFlow 0 67) 64)) anon4_correct))))
(let ((anon47_Then_correct  (=> (and (not (= (MapType0Select Heap@@27 l1@@4 next) null)) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 null (list (MapType0Select Heap@@27 l1@@4 next)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 null (list (MapType0Select Heap@@27 l1@@4 next)))) FullPerm))))) (=> (and (and (InsidePredicate (list l1@@4) (MapType0Select Heap@@27 null (list l1@@4)) (list (MapType0Select Heap@@27 l1@@4 next)) (MapType0Select Heap@@27 null (list (MapType0Select Heap@@27 l1@@4 next)))) (state Heap@@27 UnfoldingMask@3)) (and (= UnfoldingMask@4 UnfoldingMask@3) (= (ControlFlow 0 66) 64))) anon4_correct))))
(let ((anon2_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@1 null (list l1@@4) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (list l1@@4))) FullPerm)))) (=> (and (not (= l1@@4 null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 l1@@4 elem (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 l1@@4 elem)) FullPerm))))) (=> (and (and (state Heap@@27 UnfoldingMask@1) (not (= l1@@4 null))) (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 l1@@4 next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 l1@@4 next)) FullPerm)))) (state Heap@@27 UnfoldingMask@2))) (and (=> (= (ControlFlow 0 68) 66) anon47_Then_correct) (=> (= (ControlFlow 0 68) 67) anon47_Else_correct)))))))
(let ((anon46_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 71) 68)) anon2_correct)))
(let ((anon46_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 69) (- 0 70)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (list l1@@4))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (list l1@@4)))) (=> (= (ControlFlow 0 69) 68) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@27 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@27 l1@@4 $allocated)) (U_2_bool (MapType0Select Heap@@27 l2@@4 $allocated))) (=> (and (and (and (= AssumeFunctionsAbove 1) (= Mask@0 (MapType1Store ZeroMask null (list l1@@4) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (list l1@@4))) FullPerm))))) (and (state Heap@@27 Mask@0) (= Mask@1 (MapType1Store Mask@0 null (list2 l2@@4) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (list2 l2@@4))) FullPerm)))))) (and (and (state Heap@@27 Mask@1) (state Heap@@27 Mask@1)) (and (|list#trigger| Heap@@27 (list l1@@4)) (= (MapType0Select Heap@@27 null (list l1@@4)) (CombineFrames (FrameFragment (MapType0Select Heap@@27 l1@@4 elem)) (CombineFrames (FrameFragment (MapType0Select Heap@@27 l1@@4 next)) (FrameFragment (ite (not (= (MapType0Select Heap@@27 l1@@4 next) null)) (MapType0Select Heap@@27 null (list (MapType0Select Heap@@27 l1@@4 next))) EmptyFrame)))))))) (and (=> (= (ControlFlow 0 72) 69) anon46_Then_correct) (=> (= (ControlFlow 0 72) 71) anon46_Else_correct)))))))
