...
(declare-fun r_4 () T@U)
(declare-fun ref () T@U)
(assert  (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type r_4) RefType)) (= (type Heap@@12) (MapType0Type RefType))) (= (type r_5) RefType)) (= (type ref) RefType)))
(set-info :boogie-vc-id noPredicates2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm Mask@0 null (P2 r_5))) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm Mask@0 null (P2 r_5)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm Mask@0 null (P2 r_5))) (=> (HasDirectPerm Mask@0 null (P2 r_5)) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((r_3 T@U) ) (!  (=> (and (= (type r_3) RefType) (HasDirectPerm Mask@0 null (P2 r_3))) false)
 :qid |stdinbpl.450:15|
 :skolemid |43|
 :pattern ( (MapType1Select Mask@0 null (P2 r_3)))
 :pattern ( (MapType0Select Heap@@12 null (P2 r_3)))
)))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((r_1_1 T@U) ) (!  (=> (and (= (type r_1_1) RefType) (HasDirectPerm Mask@0 null (P1 r_1_1))) false)
 :qid |stdinbpl.431:15|
 :skolemid |42|
 :pattern ( (MapType1Select Mask@0 null (P1 r_1_1)))
 :pattern ( (MapType0Select Heap@@12 null (P1 r_1_1)))
))) (=> (forall ((r_1_1@@0 T@U) ) (!  (=> (and (= (type r_1_1@@0) RefType) (HasDirectPerm Mask@0 null (P1 r_1_1@@0))) false)
 :qid |stdinbpl.431:15|
 :skolemid |42|
 :pattern ( (MapType1Select Mask@0 null (P1 r_1_1@@0)))
 :pattern ( (MapType0Select Heap@@12 null (P1 r_1_1@@0)))
)) (=> (state Heap@@12 Mask@0) (and (and (=> (= (ControlFlow 0 11) 6) anon11_Else_correct) (=> (= (ControlFlow 0 11) 8) anon12_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon12_Else_correct)))))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (HasDirectPerm Mask@0 null (P1 r_4))) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (HasDirectPerm Mask@0 null (P1 r_4)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 null (P1 r_4))) (=> (HasDirectPerm Mask@0 null (P1 r_4)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@12 ZeroMask) (U_2_bool (MapType0Select Heap@@12 ref $allocated))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (P3 ref) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P3 ref))) FullPerm)))) (state Heap@@12 Mask@0)) (and (state Heap@@12 Mask@0) (state Heap@@12 Mask@0))) (and (and (=> (= (ControlFlow 0 13) 11) anon9_Else_correct) (=> (= (ControlFlow 0 13) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 13) 4) anon10_Else_correct))))))
