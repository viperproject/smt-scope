...
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (HasDirectPerm ZeroMask this x@@8))))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (HasDirectPerm ZeroMask this x@@8))))
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (HasDirectPerm ZeroMask this x@@8))))
...
(let ((anon5_Else_correct  (=> (not (= this null)) (=> (and (= Mask@0 (MapType1Store ZeroMask this x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this x@@8)) FullPerm)))) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 this x@@8)) (=> (HasDirectPerm Mask@0 this x@@8) (=> (and (and (= (U_2_int (MapType0Select Heap@@9 this x@@8)) 0) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (= (U_2_int (MapType0Select Heap@@9 this x@@8)) 0))))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 this $allocated))) (and (=> (= (ControlFlow 0 9) 8) anon5_Then_correct) (=> (= (ControlFlow 0 9) 2) anon5_Else_correct)))))
