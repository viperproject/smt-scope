...
(declare-fun |f'| (T@U Int Int) Bool)
(declare-fun MapType0Type (T@T) T@T)
(declare-fun RefType () T@T)
(declare-fun MapType1Type (T@T T@T) T@T)
(declare-fun |f#frame| (T@U Int Int) Bool)
...
(declare-fun g (T@U Int Int) Int)
(declare-fun |h#frame| (T@U Int) Bool)
(declare-fun h (T@U Int) Bool)
(declare-fun |g#frame| (T@U Int Int) Int)
...
(declare-fun f_6@@0 (T@U Int Int) Bool)
...
(assert (forall ((Heap T@U) (Mask T@U) (a_2 Int) (b_2 Int) ) (!  (=> (and (and (= (type Heap) (MapType0Type RefType)) (= (type Mask) (MapType1Type RefType realType))) (state Heap Mask)) (= (|f'| Heap a_2 b_2) (|f#frame| EmptyFrame a_2 b_2)))
 :qid |stdinbpl.198:15|
 :skolemid |24|
 :pattern ( (state Heap Mask) (|f'| Heap a_2 b_2))
)))
...
(assert (forall ((Heap@@1 T@U) (a_2@@0 Int) (b_2@@0 Int) ) (!  (=> (= (type Heap@@1) (MapType0Type RefType)) (dummyFunction (bool_2_U (|f#triggerStateless| a_2@@0 b_2@@0))))
 :qid |stdinbpl.191:15|
 :skolemid |23|
 :pattern ( (|f'| Heap@@1 a_2@@0 b_2@@0))
)))
(assert (forall ((Heap@@2 T@U) (a_2@@1 Int) (b_2@@1 Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (int_2_U (|g#triggerStateless| a_2@@1 b_2@@1))))
 :qid |stdinbpl.231:15|
 :skolemid |26|
 :pattern ( (|g'| Heap@@2 a_2@@1 b_2@@1))
)))
...
(assert (forall ((Heap@@5 T@U) (a_2@@2 Int) ) (!  (=> (= (type Heap@@5) (MapType0Type RefType)) (dummyFunction (bool_2_U (|h#triggerStateless| a_2@@2))))
 :qid |stdinbpl.295:15|
 :skolemid |29|
 :pattern ( (|h'| Heap@@5 a_2@@2))
)))
...
(assert (forall ((Heap@@9 T@U) (a_2@@3 Int) (b_2@@2 Int) ) (!  (=> (= (type Heap@@9) (MapType0Type RefType)) (and (= (g Heap@@9 a_2@@3 b_2@@2) (|g'| Heap@@9 a_2@@3 b_2@@2)) (dummyFunction (int_2_U (|g#triggerStateless| a_2@@3 b_2@@2)))))
 :qid |stdinbpl.227:15|
 :skolemid |25|
 :pattern ( (g Heap@@9 a_2@@3 b_2@@2))
)))
...
(assert (forall ((Heap@@10 T@U) (Mask@@7 T@U) (a_2@@4 Int) ) (!  (=> (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (state Heap@@10 Mask@@7)) (= (|h'| Heap@@10 a_2@@4) (|h#frame| EmptyFrame a_2@@4)))
 :qid |stdinbpl.302:15|
 :skolemid |30|
 :pattern ( (state Heap@@10 Mask@@7) (|h'| Heap@@10 a_2@@4))
)))
(assert (forall ((Heap@@11 T@U) (a_2@@5 Int) ) (!  (=> (= (type Heap@@11) (MapType0Type RefType)) (and (= (h Heap@@11 a_2@@5) (|h'| Heap@@11 a_2@@5)) (dummyFunction (bool_2_U (|h#triggerStateless| a_2@@5)))))
 :qid |stdinbpl.291:15|
 :skolemid |28|
 :pattern ( (h Heap@@11 a_2@@5))
)))
(assert  (and (forall ((arg0@@26 T@U) (arg1@@10 T@U) ) (! (= (type (CombineFrames arg0@@26 arg1@@10)) FrameTypeType)
 :qid |funType:CombineFrames|
 :pattern ( (CombineFrames arg0@@26 arg1@@10))
)) (forall ((arg0@@27 T@U) ) (! (= (type (FrameFragment arg0@@27)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@27))
))))
(assert (forall ((Heap@@12 T@U) (Mask@@8 T@U) (a_2@@6 Int) (b_2@@3 Int) ) (!  (=> (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@8) (MapType1Type RefType realType))) (state Heap@@12 Mask@@8)) (= (|g'| Heap@@12 a_2@@6 b_2@@3) (|g#frame| (CombineFrames (FrameFragment (ite (> a_2@@6 b_2@@3) EmptyFrame EmptyFrame)) (FrameFragment (ite (> b_2@@3 a_2@@6) EmptyFrame EmptyFrame))) a_2@@6 b_2@@3)))
 :qid |stdinbpl.238:15|
 :skolemid |27|
 :pattern ( (state Heap@@12 Mask@@8) (|g'| Heap@@12 a_2@@6 b_2@@3))
)))
...
(assert (forall ((Heap@@16 T@U) (Mask@@12 T@U) (a_2@@7 Int) ) (!  (=> (and (and (= (type Heap@@16) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (and (state Heap@@16 Mask@@12) (or (< AssumeFunctionsAbove 0) (|h#trigger| EmptyFrame a_2@@7)))) (forall ((i Int) ) (!  (=> (> (g Heap@@16 a_2@@7 i) 17) (|h'| Heap@@16 a_2@@7))
 :qid |stdinbpl.310:93|
 :skolemid |31|
 :pattern ( (|g#frame| (CombineFrames (FrameFragment EmptyFrame) (FrameFragment EmptyFrame)) a_2@@7 i))
 :pattern ( (|g#frame| (CombineFrames (FrameFragment EmptyFrame) (FrameFragment EmptyFrame)) a_2@@7 i))
 :pattern ( (|g#frame| (CombineFrames (FrameFragment EmptyFrame) (FrameFragment EmptyFrame)) a_2@@7 i))
 :pattern ( (|g#frame| (CombineFrames (FrameFragment EmptyFrame) (FrameFragment EmptyFrame)) a_2@@7 i))
)))
 :qid |stdinbpl.308:15|
 :skolemid |32|
 :pattern ( (state Heap@@16 Mask@@12) (|h'| Heap@@16 a_2@@7))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@18 T@U) (a_2@@8 Int) (b_2@@4 Int) ) (!  (=> (= (type Heap@@18) (MapType0Type RefType)) (and (= (f_6@@0 Heap@@18 a_2@@8 b_2@@4) (|f'| Heap@@18 a_2@@8 b_2@@4)) (dummyFunction (bool_2_U (|f#triggerStateless| a_2@@8 b_2@@4)))))
 :qid |stdinbpl.187:15|
 :skolemid |22|
 :pattern ( (f_6@@0 Heap@@18 a_2@@8 b_2@@4))
)))
(push 1)
...
(assert (= (type Heap@@19) (MapType0Type RefType)))
(set-info :boogie-vc-id |h#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon6_correct true))
(let ((anon12_Else_correct  (=> (and (>= a_2@@9 i_1) (= (ControlFlow 0 6) 3)) anon6_correct)))
(let ((anon12_Then_correct  (=> (> i_1 a_2@@9) (and (=> (= (ControlFlow 0 4) (- 0 5)) (f_6@@0 Heap@@19 i_1 a_2@@9)) (=> (f_6@@0 Heap@@19 i_1 a_2@@9) (=> (= (ControlFlow 0 4) 3) anon6_correct))))))
(let ((anon11_Else_correct  (=> (>= i_1 a_2@@9) (and (=> (= (ControlFlow 0 9) 4) anon12_Then_correct) (=> (= (ControlFlow 0 9) 6) anon12_Else_correct)))))
(let ((anon11_Then_correct  (=> (> a_2@@9 i_1) (and (=> (= (ControlFlow 0 7) (- 0 8)) (f_6@@0 Heap@@19 a_2@@9 i_1)) (=> (f_6@@0 Heap@@19 a_2@@9 i_1) (and (=> (= (ControlFlow 0 7) 4) anon12_Then_correct) (=> (= (ControlFlow 0 7) 6) anon12_Else_correct)))))))
(let ((anon10_Else_correct true))
(let ((anon9_Else_correct true))
(let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (= AssumeFunctionsAbove 0) (state Heap@@19 ZeroMask)) (and (and (and (=> (= (ControlFlow 0 10) 1) anon9_Else_correct) (=> (= (ControlFlow 0 10) 2) anon10_Else_correct)) (=> (= (ControlFlow 0 10) 7) anon11_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon11_Else_correct))))))
