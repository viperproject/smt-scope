...
(declare-fun |foo3#trigger| (T@U Int) Bool)
(declare-fun i@@3 () Int)
...
(let ((anon0_correct  (=> (and (and (state Heap@@25 ZeroMask) (= AssumeFunctionsAbove 0)) (and (< 0 i@@3) (state Heap@@25 ZeroMask))) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))
