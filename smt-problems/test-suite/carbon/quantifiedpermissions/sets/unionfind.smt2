...
(assert  (and (and (and (and (and (= (type Mask@0) (MapType2Type RefType realType)) (= (type this@@16) RefType)) (= (type Heap@@20) (MapType1Type RefType))) (= (type q_2) RefType)) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@54 T@U) ) (! (= (type (invRecv3 arg0@@54)) RefType)
 :qid |funType:invRecv3|
 :pattern ( (invRecv3 arg0@@54))
))))
...
(let ((anon9_Else_correct  (=> (and (not (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) q_2))) (= (ControlFlow 0 8) 4)) anon5_correct)))
(let ((anon9_Then_correct  (=> (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) q_2)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (HasDirectPerm QPMask@0 q_2 parent)) (=> (HasDirectPerm QPMask@0 q_2 parent) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm QPMask@0 this@@16 nodes)) (=> (HasDirectPerm QPMask@0 this@@16 nodes) (=> (= (ControlFlow 0 5) 4) anon5_correct))))))))
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm QPMask@0 this@@16 nodes)) (=> (HasDirectPerm QPMask@0 this@@16 nodes) (and (=> (= (ControlFlow 0 9) 5) anon9_Then_correct) (=> (= (ControlFlow 0 9) 8) anon9_Else_correct))))))
(let ((anon8_Else_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((n_2 T@U) (n_2_1 T@U) ) (!  (=> (and (= (type n_2) RefType) (= (type n_2_1) RefType)) (=> (and (and (and (and (not (= n_2 n_2_1)) (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) n_2))) (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) n_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_2 n_2_1))))
 :qid |stdinbpl.882:15|
 :skolemid |117|
 :no-pattern (type n_2)
 :no-pattern (type n_2_1)
 :no-pattern (U_2_int n_2)
 :no-pattern (U_2_bool n_2)
 :no-pattern (U_2_int n_2_1)
 :no-pattern (U_2_bool n_2_1)
))) (=> (forall ((n_2@@0 T@U) (n_2_1@@0 T@U) ) (!  (=> (and (= (type n_2@@0) RefType) (= (type n_2_1@@0) RefType)) (=> (and (and (and (and (not (= n_2@@0 n_2_1@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) n_2@@0))) (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) n_2_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_2@@0 n_2_1@@0))))
 :qid |stdinbpl.882:15|
 :skolemid |117|
 :no-pattern (type n_2@@0)
 :no-pattern (type n_2_1@@0)
 :no-pattern (U_2_int n_2@@0)
 :no-pattern (U_2_bool n_2@@0)
 :no-pattern (U_2_int n_2_1@@0)
 :no-pattern (U_2_bool n_2_1@@0)
)) (=> (and (forall ((n_2@@1 T@U) ) (!  (=> (= (type n_2@@1) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) n_2@@1)) (< NoPerm FullPerm)) (and (qpRange3 n_2@@1) (= (invRecv3 n_2@@1) n_2@@1))))
 :qid |stdinbpl.888:22|
 :skolemid |118|
 :pattern ( (MapType1Select Heap@@20 n_2@@1 parent))
 :pattern ( (MapType2Select QPMask@0 n_2@@1 parent))
 :pattern ( (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) n_2@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) (invRecv3 o_3))) (< NoPerm FullPerm)) (qpRange3 o_3)) (= (invRecv3 o_3) o_3)))
 :qid |stdinbpl.892:22|
 :skolemid |119|
 :pattern ( (invRecv3 o_3))
))) (=> (and (and (forall ((n_2@@2 T@U) ) (!  (=> (and (= (type n_2@@2) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) n_2@@2))) (not (= n_2@@2 null)))
 :qid |stdinbpl.898:22|
 :skolemid |120|
 :pattern ( (MapType1Select Heap@@20 n_2@@2 parent))
 :pattern ( (MapType2Select QPMask@0 n_2@@2 parent))
 :pattern ( (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) n_2@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) (invRecv3 o_3@@0))) (< NoPerm FullPerm)) (qpRange3 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_3@@0) o_3@@0)) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 parent)) (+ (U_2_real (MapType2Select Mask@0 o_3@@0 parent)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) (invRecv3 o_3@@0))) (< NoPerm FullPerm)) (qpRange3 o_3@@0))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 parent)) (U_2_real (MapType2Select Mask@0 o_3@@0 parent))))))
 :qid |stdinbpl.904:22|
 :skolemid |121|
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 parent))) (= (U_2_real (MapType2Select Mask@0 o_3@@1 f_5)) (U_2_real (MapType2Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.908:29|
 :skolemid |122|
 :pattern ( (MapType2Select Mask@0 o_3@@1 f_5))
 :pattern ( (MapType2Select QPMask@0 o_3@@1 f_5))
)) (state Heap@@20 QPMask@0))) (and (=> (= (ControlFlow 0 11) 9) anon8_Then_correct) (=> (= (ControlFlow 0 11) 3) anon8_Else_correct))))))))
(let ((anon7_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@0 this@@16 nodes))))
(let ((anon0_correct  (=> (and (state Heap@@20 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType1Select Heap@@20 this@@16 $allocated)) (not (= this@@16 null))) (and (= Mask@0 (MapType2Store ZeroMask this@@16 nodes (real_2_U (+ (U_2_real (MapType2Select ZeroMask this@@16 nodes)) FullPerm)))) (state Heap@@20 Mask@0))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm Mask@0 this@@16 nodes)) (=> (HasDirectPerm Mask@0 this@@16 nodes) (=> (not (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) null))) (and (=> (= (ControlFlow 0 13) 2) anon7_Then_correct) (=> (= (ControlFlow 0 13) 11) anon7_Else_correct)))))))))
