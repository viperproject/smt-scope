...
(assert  (and (and (and (and (and (and (and (= (type first@@5) RefType) (= (type last@@5) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type values@@5) (SeqType intType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))))
...
(let ((anon3_Then_correct  (=> (and (and (and (not (= first@@5 last@@5)) (not (= first@@5 null))) (and (= Mask@0 (MapType1Store ZeroMask first@@5 elem (real_2_U (+ (U_2_real (MapType1Select ZeroMask first@@5 elem)) FullPerm)))) (state Heap@@10 Mask@0))) (and (and (not (= first@@5 null)) (= Mask@1 (MapType1Store Mask@0 first@@5 next (real_2_U (+ (U_2_real (MapType1Select Mask@0 first@@5 next)) FullPerm))))) (and (state Heap@@10 Mask@1) (< 0 (|Seq#Length| values@@5))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm Mask@1 first@@5 elem)) (=> (HasDirectPerm Mask@1 first@@5 elem) (and (=> (= (ControlFlow 0 2) (- 0 4)) (< 0 (|Seq#Length| values@@5))) (=> (< 0 (|Seq#Length| values@@5)) (=> (= (U_2_int (MapType0Select Heap@@10 first@@5 elem)) (U_2_int (|Seq#Index| values@@5 0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 first@@5 next)) (=> (HasDirectPerm Mask@1 first@@5 next) (=> (and (and (= Mask@2 (MapType1Store Mask@1 null (lseg (MapType0Select Heap@@10 first@@5 next) last@@5 (|Seq#Drop| values@@5 1)) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (lseg (MapType0Select Heap@@10 first@@5 next) last@@5 (|Seq#Drop| values@@5 1)))) FullPerm)))) (state Heap@@10 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 2) 1))) anon2_correct)))))))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 first@@5 $allocated)) (U_2_bool (MapType0Select Heap@@10 last@@5 $allocated))) (and (=> (= (ControlFlow 0 7) 2) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct))))))
