...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= m@0 (|Map#Build| (|Map#Empty| intType intType) (int_2_U 2) (int_2_U 3))) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U 2)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U 2))) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 7)) (not (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U 3))))) (=> (not (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U 3)))) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 6)) (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U 2)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U 2))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (U_2_int (MapType0Select (|Map#Elements| m@0) (int_2_U 2))) 3)) (=> (= (U_2_int (MapType0Select (|Map#Elements| m@0) (int_2_U 2))) 3) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Map#Equal| (|Map#Build| m@0 (int_2_U 2) (int_2_U 4)) (|Map#Build| (|Map#Empty| intType intType) (int_2_U 2) (int_2_U 4)))) (=> (|Map#Equal| (|Map#Build| m@0 (int_2_U 2) (int_2_U 4)) (|Map#Build| (|Map#Empty| intType intType) (int_2_U 2) (int_2_U 4))) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Map#Equal| (|Map#Build| m@0 (int_2_U 7) (int_2_U 1)) (|Map#Build| (|Map#Build| (|Map#Empty| intType intType) (int_2_U 2) (int_2_U 3)) (int_2_U 7) (int_2_U 1)))) (=> (|Map#Equal| (|Map#Build| m@0 (int_2_U 7) (int_2_U 1)) (|Map#Build| (|Map#Build| (|Map#Empty| intType intType) (int_2_U 2) (int_2_U 3)) (int_2_U 7) (int_2_U 1))) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (|Map#Equal| m@0 (|Map#Build| (|Map#Empty| intType intType) (int_2_U 2) (int_2_U 3))))))))))))))))))))))))
