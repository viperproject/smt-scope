...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 r_1 $allocated)) (< NoPerm p_1)) (and (state Heap@@9 ZeroMask) (> i 0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= p_1 NoPerm)) (=> (>= p_1 NoPerm) (=> (and (and (=> (> p_1 NoPerm) (not (= r_1 null))) (= Mask@0 (MapType1Store ZeroMask r_1 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1 f_7)) p_1))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (= i 0))) (=> (not (= i 0)) (=> (= q_1@0 (/ p_1 (to_real i))) (=> (and (state Heap@@9 Mask@0) (= (ControlFlow 0 2) (- 0 1))) (< NoPerm q_1@0))))))))))))
