...
(declare-fun |int___box__'| (T@U Int) T@U)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |int___box__#triggerStateless| (Int) T@U)
...
(declare-fun |int___box__#trigger| (T@U Int) Bool)
(declare-fun EmptyFrame () T@U)
(declare-fun |int___box__#frame| (T@U Int) T@U)
...
(assert  (and (forall ((arg0@@25 T@U) (arg1@@9 Int) ) (! (= (type (|int___box__'| arg0@@25 arg1@@9)) RefType)
 :qid |funType:int___box__'|
 :pattern ( (|int___box__'| arg0@@25 arg1@@9))
)) (forall ((arg0@@26 Int) ) (! (= (type (|int___box__#triggerStateless| arg0@@26)) RefType)
 :qid |funType:int___box__#triggerStateless|
 :pattern ( (|int___box__#triggerStateless| arg0@@26))
))))
(assert (forall ((Heap@@2 T@U) (vint Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (|int___box__#triggerStateless| vint)))
 :qid |stdinbpl.189:15|
 :skolemid |23|
 :pattern ( (|int___box__'| Heap@@2 vint))
)))
...
(assert (forall ((arg0@@27 T@U) (arg1@@10 Int) ) (! (= (type (int___box__ arg0@@27 arg1@@10)) RefType)
 :qid |funType:int___box__|
 :pattern ( (int___box__ arg0@@27 arg1@@10))
)))
(assert (forall ((Heap@@4 T@U) (vint@@0 Int) ) (!  (=> (= (type Heap@@4) (MapType0Type RefType)) (and (= (int___box__ Heap@@4 vint@@0) (|int___box__'| Heap@@4 vint@@0)) (dummyFunction (|int___box__#triggerStateless| vint@@0))))
 :qid |stdinbpl.185:15|
 :skolemid |22|
 :pattern ( (int___box__ Heap@@4 vint@@0))
)))
...
(assert  (and (= (type EmptyFrame) FrameTypeType) (forall ((arg0@@28 T@U) (arg1@@11 Int) ) (! (= (type (|int___box__#frame| arg0@@28 arg1@@11)) RefType)
 :qid |funType:int___box__#frame|
 :pattern ( (|int___box__#frame| arg0@@28 arg1@@11))
))))
(assert (forall ((Heap@@7 T@U) (Mask@@5 T@U) (vint@@1 Int) ) (!  (=> (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type Mask@@5) (MapType1Type RefType realType))) (and (state Heap@@7 Mask@@5) (or (< AssumeFunctionsAbove 0) (|int___box__#trigger| EmptyFrame vint@@1)))) (forall ((other Int) ) (! (= (= (|int___box__'| Heap@@7 other) (|int___box__'| Heap@@7 vint@@1)) (= other vint@@1))
 :qid |stdinbpl.204:104|
 :skolemid |25|
 :pattern ( (|int___box__#frame| EmptyFrame other))
)))
 :qid |stdinbpl.202:15|
 :skolemid |26|
 :pattern ( (state Heap@@7 Mask@@5) (|int___box__'| Heap@@7 vint@@1))
)))
(assert (forall ((arg0@@29 Real) (arg1@@12 T@U) ) (! (= (type (ConditionalFrame arg0@@29 arg1@@12)) FrameTypeType)
 :qid |funType:ConditionalFrame|
 :pattern ( (ConditionalFrame arg0@@29 arg1@@12))
)))
...
(assert (forall ((Heap@@10 T@U) (Mask@@10 T@U) (vint@@2 Int) ) (!  (=> (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (state Heap@@10 Mask@@10)) (= (|int___box__'| Heap@@10 vint@@2) (|int___box__#frame| EmptyFrame vint@@2)))
 :qid |stdinbpl.196:15|
 :skolemid |24|
 :pattern ( (state Heap@@10 Mask@@10) (|int___box__'| Heap@@10 vint@@2))
)))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon6_Else_correct  (=> (and (and (= (int___box__ Heap@@13 i) (int___box__ Heap@@13 j)) (state Heap@@13 ZeroMask)) (and (state Heap@@13 ZeroMask) (= (ControlFlow 0 4) (- 0 3)))) (= i j))))
(let ((anon6_Then_correct true))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (state Heap@@13 ZeroMask)) (and (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 2) anon6_Then_correct)) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))))
