...
(let ((anon0_correct  (=> (and (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 this@@5 $allocated))) (and (not (= this@@5 null)) (= Mask@0 (MapType1Store ZeroMask this@@5 next (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@5 next)) FullPerm)))))) (and (and (state Heap@@10 Mask@0) (not (= this@@5 null))) (and (= Mask@1 (MapType1Store Mask@0 this@@5 val (real_2_U (+ (U_2_real (MapType1Select Mask@0 this@@5 val)) FullPerm)))) (state Heap@@10 Mask@1)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@1 this@@5 next)) (=> (HasDirectPerm Mask@1 this@@5 next) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))))
