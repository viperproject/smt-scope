...
(assert  (and (and (and (and (and (and (and (and (= (type UnfoldingMask@0) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type this@@5) RefType)) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (forall ((arg0@@28 T@U) ) (! (= (type (FrameFragment arg0@@28)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@28))
))) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (= (type UnfoldingMask@3) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id Testsuccess5)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon3_correct  (=> (= UnfoldingMask@2 (MapType1Store ZeroMask null (P this@@5) (real_2_U (- (U_2_real (MapType1Select ZeroMask null (P this@@5))) FullPerm)))) (=> (and (and (not (= this@@5 null)) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 this@@5 x@@8 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 this@@5 x@@8)) FullPerm))))) (and (state PostHeap@0 UnfoldingMask@3) (state PostHeap@0 UnfoldingMask@3))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm UnfoldingMask@3 this@@5 x@@8)) (=> (HasDirectPerm UnfoldingMask@3 this@@5 x@@8) (=> (= (ControlFlow 0 8) (- 0 7)) (HasDirectPerm UnfoldingMask@3 this@@5 x@@8))))))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 8)) anon3_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select ZeroMask null (P this@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select ZeroMask null (P this@@5)))) (=> (= (ControlFlow 0 10) 8) anon3_correct))))))
(let ((anon7_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (|P#trigger| PostHeap@0 (P this@@5)) (= (MapType0Select PostHeap@0 null (P this@@5)) (FrameFragment (MapType0Select PostHeap@0 this@@5 x@@8)))) (and (=> (= (ControlFlow 0 13) 10) anon8_Then_correct) (=> (= (ControlFlow 0 13) 12) anon8_Else_correct))))))
(let ((anon6_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (P this@@5) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P this@@5))) FullPerm)))) (not (= this@@5 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this@@5 x@@8 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this@@5 x@@8)) FullPerm)))) (state Heap@@10 UnfoldingMask@1)) (and (state Heap@@10 UnfoldingMask@1) (= (ControlFlow 0 2) (- 0 1)))) (>= (U_2_int (MapType0Select Heap@@10 this@@5 x@@8)) (U_2_int (MapType0Select Heap@@10 this@@5 x@@8)))))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon6_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P this@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P this@@5)))) (=> (= (ControlFlow 0 3) 2) anon6_correct))))))
(let ((anon7_Else_correct  (=> (and (|P#trigger| Heap@@10 (P this@@5)) (= (MapType0Select Heap@@10 null (P this@@5)) (FrameFragment (MapType0Select Heap@@10 this@@5 x@@8)))) (and (=> (= (ControlFlow 0 6) 3) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct)))))
