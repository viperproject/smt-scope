...
(assert  (and (and (and (and (and (and (and (= (type Heap@@18) (MapType0Type RefType)) (= (type x@@18) RefType)) (= (type y@@5) RefType)) (= (type ExhaleWellDef0Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@2) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test04)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon9_correct true))
(let ((anon5_correct  (=> (= ExhaleWellDef0Mask@1 (MapType1Store Mask@1 x@@18 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 x@@18 f_7)) FullPerm)))) (=> (and (= ExhaleWellDef0Mask@2 ExhaleWellDef0Mask@1) (= (ControlFlow 0 11) 5)) anon9_correct))))
(let ((anon17_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 14) 11)) anon5_correct)))
(let ((anon17_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@18 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@18 f_7))) (=> (= (ControlFlow 0 12) 11) anon5_correct))))))
(let ((anon16_Then_correct  (=> b_2@@9 (and (=> (= (ControlFlow 0 15) 12) anon17_Then_correct) (=> (= (ControlFlow 0 15) 14) anon17_Else_correct)))))
(let ((anon8_correct  (=> (= ExhaleWellDef0Mask@0 (MapType1Store Mask@1 y@@5 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 y@@5 f_7)) FullPerm)))) (=> (and (= ExhaleWellDef0Mask@2 ExhaleWellDef0Mask@0) (= (ControlFlow 0 6) 5)) anon9_correct))))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon8_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select Mask@1 y@@5 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 y@@5 f_7))) (=> (= (ControlFlow 0 7) 6) anon8_correct))))))
(let ((anon16_Else_correct  (=> (not b_2@@9) (and (=> (= (ControlFlow 0 10) 7) anon18_Then_correct) (=> (= (ControlFlow 0 10) 9) anon18_Else_correct)))))
(let ((anon15_Else_correct true))
(let ((anon19_Else_correct true))
(let ((anon19_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (> (fun2 Heap@@18 b_2@@9 x@@18 y@@5 j_1) 0))))
(let ((anon0_correct  (=> (and (and (state Heap@@18 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@18 x@@18 $allocated)) (U_2_bool (MapType0Select Heap@@18 y@@5 $allocated)))) (=> (and (and (and (not (= x@@18 null)) (= Mask@0 (MapType1Store ZeroMask x@@18 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@18 f_7)) FullPerm))))) (and (state Heap@@18 Mask@0) (not (= y@@5 null)))) (and (and (= Mask@1 (MapType1Store Mask@0 y@@5 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@5 f_7)) FullPerm)))) (state Heap@@18 Mask@1)) (and (state Heap@@18 Mask@1) (state Heap@@18 Mask@1)))) (and (and (and (and (=> (= (ControlFlow 0 16) 2) anon19_Then_correct) (=> (= (ControlFlow 0 16) 3) anon19_Else_correct)) (=> (= (ControlFlow 0 16) 4) anon15_Else_correct)) (=> (= (ControlFlow 0 16) 15) anon16_Then_correct)) (=> (= (ControlFlow 0 16) 10) anon16_Else_correct))))))
