...
(declare-fun x@0 () Int)
(assert  (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type a_3@@1) ArrayDomainTypeType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (not (= (loc a_3@@1 0) null)) (= Mask@0 (MapType1Store ZeroMask (loc a_3@@1 0) val (real_2_U (+ (U_2_real (MapType1Select ZeroMask (loc a_3@@1 0) val)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 (loc a_3@@1 0) val)) (=> (HasDirectPerm Mask@0 (loc a_3@@1 0) val) (=> (= x@0 (U_2_int (MapType0Select Heap@@9 (loc a_3@@1 0) val))) (=> (and (state Heap@@9 Mask@0) (= (ControlFlow 0 2) (- 0 1))) (= FullPerm (U_2_real (MapType1Select Mask@0 (loc a_3@@1 0) val)))))))))))
