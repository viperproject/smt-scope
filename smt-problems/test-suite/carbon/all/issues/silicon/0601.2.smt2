...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (< 0 (|Seq#Length| (|Seq#Singleton| (int_2_U 111))))) (=> (< 0 (|Seq#Length| (|Seq#Singleton| (int_2_U 111)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< 0 (|Seq#Length| (|Seq#Singleton| (int_2_U 222))))) (=> (< 0 (|Seq#Length| (|Seq#Singleton| (int_2_U 222)))) (=> (= (ControlFlow 0 2) (- 0 1)) (not (= (U_2_int (|Seq#Index| (|Seq#Singleton| (int_2_U 111)) 0)) (U_2_int (|Seq#Index| (|Seq#Singleton| (int_2_U 222)) 0))))))))))))
