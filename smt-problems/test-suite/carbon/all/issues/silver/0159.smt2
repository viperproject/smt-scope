...
(assert  (and (= (type e) RefType) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id m)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (< i_1 4) (> i_1 0))) (and (< i_1_1 4) (> i_1_1 0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= e e)))
 :qid |stdinbpl.243:17|
 :skolemid |22|
 :pattern ( (neverTriggered1 i_1) (neverTriggered1 i_1_1))
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (< i_1@@0 4) (> i_1@@0 0))) (and (< i_1_1@@0 4) (> i_1_1@@0 0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= e e)))
 :qid |stdinbpl.243:17|
 :skolemid |22|
 :pattern ( (neverTriggered1 i_1@@0) (neverTriggered1 i_1_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((i_1@@1 Int) ) (!  (=> (and (< i_1@@1 4) (> i_1@@1 0)) (>= (U_2_real (MapType1Select ZeroMask e x@@8)) FullPerm))
 :qid |stdinbpl.250:17|
 :skolemid |23|
)))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 e $allocated))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct)))))
