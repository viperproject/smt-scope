...
impl InstGraph {
    pub fn search_matching_loops(&mut self, parser: Rc<Z3Parser>) -> usize {
        ...
        if let Some(vec) = &mut self.analysis.matching_loop_graphs {
            vec.reserve(nr_matching_loop_end_nodes); 
        }
    ...
    pub fn nth_matching_loop_graph(&mut self, n: usize) -> Graph<String, ()> {
        ...
        return graph
        // if let Some(ml_graphs) = &mut self.analysis.matching_loop_graphs {
        //     ml_graphs[n] = dot_graph;
        // } 
    }
} 
