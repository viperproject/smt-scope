...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@0) (MapType0Type RefType realType)) (= (type x@@8) RefType)) (= (type Mask@7) (MapType0Type RefType realType))) (= (type Mask@10) (MapType0Type RefType realType))) (= (type y@@1) RefType)) (= (type Mask@9) (MapType0Type RefType realType))) (= (type Mask@8) (MapType0Type RefType realType))) (= (type Heap@6) (MapType1Type RefType))) (= (type ExhaleHeap@0) (MapType1Type RefType))) (= (type Heap@5) (MapType1Type RefType))) (= (type Heap@4) (MapType1Type RefType))) (= (type Heap@2) (MapType1Type RefType))) (= (type Heap@1) (MapType1Type RefType))) (= (type Heap@3) (MapType1Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@6) (MapType0Type RefType realType))) (= (type Mask@5) (MapType0Type RefType realType))) (forall ((arg0@@43 T@U) (arg1@@60 T@U) ) (! (= (type (CombineFrames arg0@@43 arg1@@60)) FrameTypeType)
...
))) (= (type Mask@4) (MapType0Type RefType realType))) (= (type Mask@3) (MapType0Type RefType realType))) (= (type Mask@2) (MapType0Type RefType realType))) (= (type Heap@0) (MapType1Type RefType))) (= (type Heap@@14) (MapType1Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@1) (MapType0Type RefType realType))) (= (type WandDefLHSMask@0) (MapType0Type RefType realType))) (= (type WandDefLHSHeap@0) (MapType1Type RefType))))
(set-info :boogie-vc-id test05)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 49) (let ((anon8_correct true))
(let ((anon35_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 45) 42)) anon8_correct)))
(let ((anon35_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 43) (- 0 44)) (<= FullPerm (U_2_real (MapType0Select WandDefLHSMask@0 null (Pair x@@8))))) (=> (<= FullPerm (U_2_real (MapType0Select WandDefLHSMask@0 null (Pair x@@8)))) (=> (= (ControlFlow 0 43) 42) anon8_correct))))))
(let ((anon34_Else_correct true))
(let ((anon33_Then_correct  (=> (= WandDefLHSMask@0 (MapType0Store ZeroMask null (Pair x@@8) (real_2_U (+ (U_2_real (MapType0Select ZeroMask null (Pair x@@8))) FullPerm)))) (=> (and (state WandDefLHSHeap@0 WandDefLHSMask@0) (state WandDefLHSHeap@0 WandDefLHSMask@0)) (and (and (=> (= (ControlFlow 0 46) 41) anon34_Else_correct) (=> (= (ControlFlow 0 46) 43) anon35_Then_correct)) (=> (= (ControlFlow 0 46) 45) anon35_Else_correct))))))
(let ((anon30_correct true))
(let ((anon45_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 10)) anon30_correct)))
(let ((anon45_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType0Select Mask@10 y@@1 f_7)))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@10 y@@1 f_7))) (=> (= (ControlFlow 0 11) 10) anon30_correct))))))
(let ((anon28_correct  (=> (= Mask@9 (MapType0Store Mask@8 null (Pair x@@8) (real_2_U (- (U_2_real (MapType0Select Mask@8 null (Pair x@@8))) FullPerm)))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (= (sum Heap@6 x@@8) w_1@0)) (=> (= (sum Heap@6 x@@8) w_1@0) (=> (and (and (and (state Heap@6 Mask@9) (not (= y@@1 null))) (and (= Mask@10 (MapType0Store Mask@9 y@@1 f_7 (real_2_U (+ (U_2_real (MapType0Select Mask@9 y@@1 f_7)) FullPerm)))) (state Heap@6 Mask@10))) (and (and (state Heap@6 Mask@10) (IdenticalOnKnownLocations Heap@6 ExhaleHeap@0 Mask@10)) (and (state ExhaleHeap@0 Mask@10) (state ExhaleHeap@0 Mask@10)))) (and (=> (= (ControlFlow 0 14) 11) anon45_Then_correct) (=> (= (ControlFlow 0 14) 13) anon45_Else_correct))))))))
(let ((anon44_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 18) 14)) anon28_correct)))
(let ((anon44_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= FullPerm (U_2_real (MapType0Select Mask@8 null (Pair x@@8))))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@8 null (Pair x@@8)))) (=> (= (ControlFlow 0 16) 14) anon28_correct))))))
(let ((anon42_Else_correct  (=> (and (= w_1@0 (sum Heap@6 x@@8)) (state Heap@6 Mask@7)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (<= FullPerm (U_2_real (MapType0Select Mask@7 null (wand_1 x@@8 FullPerm x@@8 w_1@0 y@@1 FullPerm))))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@7 null (wand_1 x@@8 FullPerm x@@8 w_1@0 y@@1 FullPerm)))) (=> (and (= Mask@8 (MapType0Store Mask@7 null (wand_1 x@@8 FullPerm x@@8 w_1@0 y@@1 FullPerm) (real_2_U (- (U_2_real (MapType0Select Mask@7 null (wand_1 x@@8 FullPerm x@@8 w_1@0 y@@1 FullPerm))) FullPerm)))) (state Heap@6 Mask@8)) (and (=> (= (ControlFlow 0 19) 16) anon44_Then_correct) (=> (= (ControlFlow 0 19) 18) anon44_Else_correct))))))))
(let ((anon25_correct true))
(let ((anon43_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon25_correct)))
(let ((anon43_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType0Select Mask@7 null (Pair x@@8))))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@7 null (Pair x@@8)))) (=> (= (ControlFlow 0 7) 6) anon25_correct))))))
(let ((anon22_correct  (=> (and (and (= Heap@5 (MapType1Store Heap@4 null (|Pair#sm| x@@8) (MapType0Store (MapType1Select Heap@4 null (|Pair#sm| x@@8)) x@@8 f_7 (bool_2_U true)))) (= Heap@6 (MapType1Store Heap@5 null (|Pair#sm| x@@8) (MapType0Store (MapType1Select Heap@5 null (|Pair#sm| x@@8)) x@@8 g (bool_2_U true))))) (and (state Heap@6 Mask@7) (state Heap@6 Mask@7))) (and (and (=> (= (ControlFlow 0 21) 19) anon42_Else_correct) (=> (= (ControlFlow 0 21) 7) anon43_Then_correct)) (=> (= (ControlFlow 0 21) 9) anon43_Else_correct)))))
(let ((anon41_Else_correct  (=> (HasDirectPerm Mask@7 null (Pair x@@8)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 23) 21)) anon22_correct))))
(let ((anon41_Then_correct  (=> (not (HasDirectPerm Mask@7 null (Pair x@@8))) (=> (and (and (= Heap@2 (MapType1Store Heap@1 null (|Pair#sm| x@@8) ZeroPMask)) (= Heap@3 (MapType1Store Heap@2 null (Pair x@@8) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 22) 21))) anon22_correct))))
(let ((anon20_correct  (=> (and (= Mask@6 (MapType0Store Mask@5 x@@8 g (real_2_U (- (U_2_real (MapType0Select Mask@5 x@@8 g)) FullPerm)))) (= Mask@7 (MapType0Store Mask@6 null (Pair x@@8) (real_2_U (+ (U_2_real (MapType0Select Mask@6 null (Pair x@@8))) FullPerm))))) (=> (and (and (state Heap@1 Mask@7) (state Heap@1 Mask@7)) (and (|Pair#trigger| Heap@1 (Pair x@@8)) (= (MapType1Select Heap@1 null (Pair x@@8)) (CombineFrames (FrameFragment (MapType1Select Heap@1 x@@8 f_7)) (FrameFragment (MapType1Select Heap@1 x@@8 g)))))) (and (=> (= (ControlFlow 0 24) 22) anon41_Then_correct) (=> (= (ControlFlow 0 24) 23) anon41_Else_correct))))))
(let ((anon40_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 27) 24)) anon20_correct)))
(let ((anon40_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 25) (- 0 26)) (<= FullPerm (U_2_real (MapType0Select Mask@5 x@@8 g)))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@5 x@@8 g))) (=> (= (ControlFlow 0 25) 24) anon20_correct))))))
(let ((anon18_correct  (=> (= Mask@5 (MapType0Store Mask@4 x@@8 f_7 (real_2_U (- (U_2_real (MapType0Select Mask@4 x@@8 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 28) 25) anon40_Then_correct) (=> (= (ControlFlow 0 28) 27) anon40_Else_correct)))))
(let ((anon39_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 31) 28)) anon18_correct)))
(let ((anon39_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (<= FullPerm (U_2_real (MapType0Select Mask@4 x@@8 f_7)))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@4 x@@8 f_7))) (=> (= (ControlFlow 0 29) 28) anon18_correct))))))
(let ((anon16_correct  (=> (and (and (and (not (= x@@8 null)) (= Mask@3 (MapType0Store Mask@2 x@@8 f_7 (real_2_U (+ (U_2_real (MapType0Select Mask@2 x@@8 f_7)) FullPerm))))) (and (state Heap@1 Mask@3) (not (= x@@8 null)))) (and (and (= Mask@4 (MapType0Store Mask@3 x@@8 g (real_2_U (+ (U_2_real (MapType0Select Mask@3 x@@8 g)) FullPerm)))) (state Heap@1 Mask@4)) (and (state Heap@1 Mask@4) (state Heap@1 Mask@4)))) (and (=> (= (ControlFlow 0 32) 29) anon39_Then_correct) (=> (= (ControlFlow 0 32) 31) anon39_Else_correct)))))
(let ((anon38_Else_correct  (=> (HasDirectPerm Mask@2 null (Pair x@@8)) (=> (and (= Heap@1 Heap@@14) (= (ControlFlow 0 34) 32)) anon16_correct))))
(let ((anon38_Then_correct  (=> (and (and (not (HasDirectPerm Mask@2 null (Pair x@@8))) (= Heap@0 (MapType1Store Heap@@14 null (Pair x@@8) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 33) 32))) anon16_correct)))
(let ((anon14_correct  (=> (= Mask@2 (MapType0Store Mask@1 null (Pair x@@8) (real_2_U (- (U_2_real (MapType0Select Mask@1 null (Pair x@@8))) FullPerm)))) (and (=> (= (ControlFlow 0 35) 33) anon38_Then_correct) (=> (= (ControlFlow 0 35) 34) anon38_Else_correct)))))
(let ((anon37_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 38) 35)) anon14_correct)))
(let ((anon37_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 36) (- 0 37)) (<= FullPerm (U_2_real (MapType0Select Mask@1 null (Pair x@@8))))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@1 null (Pair x@@8)))) (=> (= (ControlFlow 0 36) 35) anon14_correct))))))
(let ((anon36_Else_correct  (=> (and (|Pair#trigger| Heap@@14 (Pair x@@8)) (= (MapType1Select Heap@@14 null (Pair x@@8)) (CombineFrames (FrameFragment (MapType1Select Heap@@14 x@@8 f_7)) (FrameFragment (MapType1Select Heap@@14 x@@8 g))))) (and (=> (= (ControlFlow 0 39) 36) anon37_Then_correct) (=> (= (ControlFlow 0 39) 38) anon37_Else_correct)))))
(let ((anon36_Then_correct true))
(let ((anon33_Else_correct  (=> (= Mask@1 (MapType0Store Mask@0 null (wand_1 x@@8 FullPerm x@@8 a_2@0 y@@1 FullPerm) (real_2_U (+ (U_2_real (MapType0Select Mask@0 null (wand_1 x@@8 FullPerm x@@8 a_2@0 y@@1 FullPerm))) FullPerm)))) (=> (and (state Heap@@14 Mask@1) (state Heap@@14 Mask@1)) (and (=> (= (ControlFlow 0 40) 5) anon36_Then_correct) (=> (= (ControlFlow 0 40) 39) anon36_Else_correct))))))
(let ((anon31_Else_correct  (=> (and (= a_2@0 (sum Heap@@14 x@@8)) (state Heap@@14 Mask@0)) (and (=> (= (ControlFlow 0 47) 46) anon33_Then_correct) (=> (= (ControlFlow 0 47) 40) anon33_Else_correct)))))
(let ((anon3_correct true))
(let ((anon32_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon32_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType0Select Mask@0 null (Pair x@@8))))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@0 null (Pair x@@8)))) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType1Select Heap@@14 x@@8 $allocated))) (=> (and (and (U_2_bool (MapType1Select Heap@@14 y@@1 $allocated)) (= Mask@0 (MapType0Store ZeroMask null (Pair x@@8) (real_2_U (+ (U_2_real (MapType0Select ZeroMask null (Pair x@@8))) FullPerm))))) (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0))) (and (and (=> (= (ControlFlow 0 48) 47) anon31_Else_correct) (=> (= (ControlFlow 0 48) 2) anon32_Then_correct)) (=> (= (ControlFlow 0 48) 4) anon32_Else_correct)))))))
