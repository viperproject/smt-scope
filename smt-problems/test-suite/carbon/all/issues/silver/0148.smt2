...
(declare-fun MultiSet_FromSeq (T@U) T@U)
(declare-fun |Seq#Singleton| (T@U) T@U)
(declare-fun MultiSet_Singleton (T@U) T@U)
(declare-fun MultiSetDomainTypeType (T@T) T@T)
(declare-fun MultiSetDomainTypeTypeInv0 (T@T) T@T)
...
(declare-fun MultiSet_Empty (T@T) T@U)
...
(assert  (and (and (and (and (forall ((arg0@@14 T@T) ) (! (= (Ctor (MultiSetDomainTypeType arg0@@14)) 7)
 :qid |ctor:MultiSetDomainTypeType|
)) (forall ((arg0@@15 T@T) ) (! (= (MultiSetDomainTypeTypeInv0 (MultiSetDomainTypeType arg0@@15)) arg0@@15)
 :qid |typeInv:MultiSetDomainTypeTypeInv0|
 :pattern ( (MultiSetDomainTypeType arg0@@15))
))) (forall ((arg0@@16 T@U) ) (! (let ((T@@1 (SeqTypeInv0 (type arg0@@16))))
(= (type (MultiSet_FromSeq arg0@@16)) (MultiSetDomainTypeType T@@1)))
 :qid |funType:MultiSet_FromSeq|
 :pattern ( (MultiSet_FromSeq arg0@@16))
))) (forall ((arg0@@17 T@U) ) (! (let ((T@@2 (type arg0@@17)))
(= (type (|Seq#Singleton| arg0@@17)) (SeqType T@@2)))
 :qid |funType:Seq#Singleton|
 :pattern ( (|Seq#Singleton| arg0@@17))
))) (forall ((arg0@@18 T@U) ) (! (let ((T@@3 (type arg0@@18)))
(= (type (MultiSet_Singleton arg0@@18)) (MultiSetDomainTypeType T@@3)))
 :qid |funType:MultiSet_Singleton|
 :pattern ( (MultiSet_Singleton arg0@@18))
))))
(assert (forall ((x_1 T@U) ) (! (= (MultiSet_FromSeq (|Seq#Singleton| x_1)) (MultiSet_Singleton x_1))
 :qid |stdinbpl.560:19|
 :skolemid |59|
 :pattern ( (MultiSet_FromSeq (|Seq#Singleton| x_1)))
 :pattern ( (MultiSet_Singleton x_1))
)))
...
))) (forall ((arg0@@21 T@T) (arg1@@0 T@T) ) (! (= (Ctor (FieldType arg0@@21 arg1@@0)) 9)
 :qid |ctor:FieldType|
))) (forall ((arg0@@22 T@T) (arg1@@1 T@T) ) (! (= (FieldTypeInv0 (FieldType arg0@@22 arg1@@1)) arg0@@22)
 :qid |typeInv:FieldTypeInv0|
 :pattern ( (FieldType arg0@@22 arg1@@1))
))) (forall ((arg0@@23 T@T) (arg1@@2 T@T) ) (! (= (FieldTypeInv1 (FieldType arg0@@23 arg1@@2)) arg1@@2)
 :qid |typeInv:FieldTypeInv1|
 :pattern ( (FieldType arg0@@23 arg1@@2))
))) (forall ((arg0@@24 T@U) (arg1@@3 T@U) (arg2 T@U) ) (! (let ((B (FieldTypeInv1 (type arg2))))
(= (type (MapType0Select arg0@@24 arg1@@3 arg2)) B))
 :qid |funType:MapType0Select|
 :pattern ( (MapType0Select arg0@@24 arg1@@3 arg2))
))) (forall ((arg0@@25 T@U) (arg1@@4 T@U) (arg2@@0 T@U) (arg3 T@U) ) (! (let ((aVar0 (type arg1@@4)))
(= (type (MapType0Store arg0@@25 arg1@@4 arg2@@0 arg3)) (MapType0Type aVar0)))
 :qid |funType:MapType0Store|
 :pattern ( (MapType0Store arg0@@25 arg1@@4 arg2@@0 arg3))
...
(assert  (and (and (and (and (and (and (forall ((arg0@@26 T@T) (arg1@@5 T@T) ) (! (= (Ctor (MapType1Type arg0@@26 arg1@@5)) 11)
 :qid |ctor:MapType1Type|
)) (forall ((arg0@@27 T@T) (arg1@@6 T@T) ) (! (= (MapType1TypeInv0 (MapType1Type arg0@@27 arg1@@6)) arg0@@27)
 :qid |typeInv:MapType1TypeInv0|
 :pattern ( (MapType1Type arg0@@27 arg1@@6))
))) (forall ((arg0@@28 T@T) (arg1@@7 T@T) ) (! (= (MapType1TypeInv1 (MapType1Type arg0@@28 arg1@@7)) arg1@@7)
 :qid |typeInv:MapType1TypeInv1|
 :pattern ( (MapType1Type arg0@@28 arg1@@7))
))) (forall ((arg0@@29 T@U) (arg1@@8 T@U) (arg2@@1 T@U) ) (! (let ((aVar1 (MapType1TypeInv1 (type arg0@@29))))
(= (type (MapType1Select arg0@@29 arg1@@8 arg2@@1)) aVar1))
 :qid |funType:MapType1Select|
 :pattern ( (MapType1Select arg0@@29 arg1@@8 arg2@@1))
))) (forall ((arg0@@30 T@U) (arg1@@9 T@U) (arg2@@2 T@U) (arg3@@0 T@U) ) (! (let ((aVar1@@0 (type arg3@@0)))
(let ((aVar0@@0 (type arg1@@9)))
(= (type (MapType1Store arg0@@30 arg1@@9 arg2@@2 arg3@@0)) (MapType1Type aVar0@@0 aVar1@@0))))
 :qid |funType:MapType1Store|
 :pattern ( (MapType1Store arg0@@30 arg1@@9 arg2@@2 arg3@@0))
...
(assert (forall ((arg0@@31 T@U) (arg1@@10 Int) ) (! (let ((T@@4 (SeqTypeInv0 (type arg0@@31))))
(= (type (|Seq#Index| arg0@@31 arg1@@10)) T@@4))
 :qid |funType:Seq#Index|
 :pattern ( (|Seq#Index| arg0@@31 arg1@@10))
)))
...
(assert (forall ((arg0@@34 T@U) (arg1@@11 Int) (arg2@@3 T@U) ) (! (let ((T@@6 (type arg2@@3)))
(= (type (|Seq#Update| arg0@@34 arg1@@11 arg2@@3)) (SeqType T@@6)))
 :qid |funType:Seq#Update|
 :pattern ( (|Seq#Update| arg0@@34 arg1@@11 arg2@@3))
)))
...
(assert (forall ((arg0@@35 T@U) (arg1@@12 Int) ) (! (let ((T@@8 (SeqTypeInv0 (type arg0@@35))))
(= (type (|Seq#Take| arg0@@35 arg1@@12)) (SeqType T@@8)))
 :qid |funType:Seq#Take|
 :pattern ( (|Seq#Take| arg0@@35 arg1@@12))
)))
...
(assert (forall ((arg0@@36 Int) (arg1@@13 Int) ) (! (= (type (|Seq#Range| arg0@@36 arg1@@13)) (SeqType intType))
 :qid |funType:Seq#Range|
 :pattern ( (|Seq#Range| arg0@@36 arg1@@13))
)))
...
(assert (forall ((arg0@@37 T@U) (arg1@@14 T@U) ) (! (let ((T@@16 (SeqTypeInv0 (type arg0@@37))))
(= (type (|Seq#Append| arg0@@37 arg1@@14)) (SeqType T@@16)))
...
(assert (forall ((T@@23 T@T) ) (! (= (type (MultiSet_Empty T@@23)) (MultiSetDomainTypeType T@@23))
 :qid |funType:MultiSet_Empty|
 :pattern ( (MultiSet_Empty T@@23))
)))
(assert (forall ((T@@24 T@T) ) (! (= (MultiSet_FromSeq (|Seq#Empty| T@@24)) (MultiSet_Empty T@@24))
 :skolemid |58|
)))
...
(assert (forall ((s0@@2 T@U) (s1@@2 T@U) ) (! (let ((T@@27 (SeqTypeInv0 (type s0@@2))))
 (=> (and (and (= (type s0@@2) (SeqType T@@27)) (= (type s1@@2) (SeqType T@@27))) (|Seq#Equal| s0@@2 s1@@2)) (and (= (|Seq#Length| s0@@2) (|Seq#Length| s1@@2)) (forall ((j@@4 Int) ) (!  (=> (and (<= 0 j@@4) (< j@@4 (|Seq#Length| s0@@2))) (= (|Seq#Index| s0@@2 j@@4) (|Seq#Index| s1@@2 j@@4)))
 :qid |stdinbpl.491:13|
 :skolemid |50|
...
(assert (forall ((s@@14 T@U) (x@@10 T@U) (i@@5 Int) ) (! (let ((T@@34 (type x@@10)))
 (=> (= (type s@@14) (SeqType T@@34)) (=> (and (and (<= 0 i@@5) (< i@@5 (|Seq#Length| s@@14))) (= (|Seq#Index| s@@14 i@@5) x@@10)) (|Seq#Contains| s@@14 x@@10))))
 :qid |stdinbpl.392:18|
 :skolemid |48|
...
(declare-fun s@0 () T@U)
(assert  (and (= (type Heap@@9) (MapType0Type RefType)) (= (type s@0) (SeqType intType))))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= s@0 (|Seq#Empty| intType)) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (MultiSet_Empty intType) (MultiSet_FromSeq s@0))) (=> (= (MultiSet_Empty intType) (MultiSet_FromSeq s@0)) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (MultiSet_FromSeq (|Seq#Singleton| (int_2_U 2))) (MultiSet_Singleton (int_2_U 2))))))))))
