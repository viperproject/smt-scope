...
(assert  (and (and (and (and (= (type Heap@@15) (MapType0Type RefType)) (= (type x@@29) RefType)) (= (type y@@13) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |p2#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@15 x@@29 $allocated)) (U_2_bool (MapType0Select Heap@@15 y@@13 $allocated))) (and (not (= x@@29 null)) (= Mask@0 (MapType1Store ZeroMask x@@29 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@29 f_7)) FullPerm)))))) (and (and (state Heap@@15 Mask@0) (not (= y@@13 null))) (and (= Mask@1 (MapType1Store Mask@0 y@@13 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@13 f_7)) FullPerm)))) (state Heap@@15 Mask@1)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 x@@29 f_7)) (=> (HasDirectPerm Mask@1 x@@29 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@1 y@@13 f_7))))))))
