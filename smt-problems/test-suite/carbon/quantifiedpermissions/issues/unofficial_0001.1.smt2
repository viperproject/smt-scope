...
(assert (forall ((x@@15 T@U) ) (!  (=> (= (type x@@15) RefType) (= (PredicateMaskField (P x@@15)) (|P#sm| x@@15)))
 :qid |stdinbpl.573:15|
 :skolemid |58|
 :pattern ( (PredicateMaskField (P x@@15)))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type zs) (SeqType RefType)) (= (type Heap@@10) (MapType0Type RefType))) (= (type x@@17) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Heap@2) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (forall ((arg0@@37 T@U) ) (! (= (type (FrameFragment arg0@@37)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@37))
))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 41) (let ((anon19_correct true))
(let ((anon30_Else_correct  (=> (and (not (and (<= 0 i_4) (< i_4 (U_2_int (MapType0Select Heap@5 x@@17 f_7))))) (= (ControlFlow 0 23) 19)) anon19_correct)))
(let ((anon30_Then_correct  (=> (and (<= 0 i_4) (< i_4 (U_2_int (MapType0Select Heap@5 x@@17 f_7)))) (and (=> (= (ControlFlow 0 20) (- 0 22)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 20) (- 0 21)) (< i_4 (|Seq#Length| zs))) (=> (< i_4 (|Seq#Length| zs)) (=> (= (ControlFlow 0 20) 19) anon19_correct))))))))
(let ((anon29_Else_correct  (=> (< i_4 0) (and (=> (= (ControlFlow 0 26) 20) anon30_Then_correct) (=> (= (ControlFlow 0 26) 23) anon30_Else_correct)))))
(let ((anon29_Then_correct  (=> (<= 0 i_4) (and (=> (= (ControlFlow 0 24) (- 0 25)) (HasDirectPerm Mask@4 x@@17 f_7)) (=> (HasDirectPerm Mask@4 x@@17 f_7) (and (=> (= (ControlFlow 0 24) 20) anon30_Then_correct) (=> (= (ControlFlow 0 24) 23) anon30_Else_correct)))))))
(let ((anon28_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((i_5 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5 i_5_1)) (and (<= 0 i_5) (< i_5 (U_2_int (MapType0Select Heap@5 x@@17 f_7))))) (and (<= 0 i_5_1) (< i_5_1 (U_2_int (MapType0Select Heap@5 x@@17 f_7))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| zs i_5) (|Seq#Index| zs i_5_1))))
 :qid |stdinbpl.835:17|
 :skolemid |71|
 :pattern ( (neverTriggered2 i_5) (neverTriggered2 i_5_1))
))) (=> (forall ((i_5@@0 Int) (i_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_5@@0 i_5_1@@0)) (and (<= 0 i_5@@0) (< i_5@@0 (U_2_int (MapType0Select Heap@5 x@@17 f_7))))) (and (<= 0 i_5_1@@0) (< i_5_1@@0 (U_2_int (MapType0Select Heap@5 x@@17 f_7))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| zs i_5@@0) (|Seq#Index| zs i_5_1@@0))))
 :qid |stdinbpl.835:17|
 :skolemid |71|
 :pattern ( (neverTriggered2 i_5@@0) (neverTriggered2 i_5_1@@0))
)) (=> (= (ControlFlow 0 17) (- 0 16)) (forall ((i_5@@1 Int) ) (!  (=> (and (<= 0 i_5@@1) (< i_5@@1 (U_2_int (MapType0Select Heap@5 x@@17 f_7)))) (>= (U_2_real (MapType1Select Mask@4 (|Seq#Index| zs i_5@@1) g)) FullPerm))
 :qid |stdinbpl.842:17|
 :skolemid |72|
 :pattern ( (|Seq#Index| zs i_5@@1))
 :pattern ( (|Seq#Index| zs i_5@@1))
)))))))
(let ((anon14_correct  (=> (and (> wildcard@3 NoPerm) (not (= x@@17 null))) (=> (and (and (= Mask@4 (MapType1Store Mask@3 x@@17 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@3 x@@17 f_7)) wildcard@3)))) (state Heap@5 Mask@4)) (and (state Heap@5 Mask@4) (state Heap@5 Mask@4))) (and (and (=> (= (ControlFlow 0 27) 17) anon28_Else_correct) (=> (= (ControlFlow 0 27) 24) anon29_Then_correct)) (=> (= (ControlFlow 0 27) 26) anon29_Else_correct))))))
(let ((anon27_Else_correct  (=> (HasDirectPerm Mask@3 null (P x@@17)) (=> (and (= Heap@5 Heap@3) (= (ControlFlow 0 29) 27)) anon14_correct))))
(let ((anon27_Then_correct  (=> (and (and (not (HasDirectPerm Mask@3 null (P x@@17))) (= Heap@4 (MapType0Store Heap@3 null (P x@@17) newVersion@0))) (and (= Heap@5 Heap@4) (= (ControlFlow 0 28) 27))) anon14_correct)))
(let ((anon12_correct  (=> (= Heap@3 (MapType0Store Heap@2 null (|P#sm| x@@17) (MapType1Store (MapType0Select Heap@2 null (|P#sm| x@@17)) x@@17 f_7 (bool_2_U true)))) (=> (and (and (state Heap@3 Mask@2) (state Heap@3 Mask@2)) (and (|P#trigger| Heap@3 (P x@@17)) (= (MapType0Select Heap@3 null (P x@@17)) (FrameFragment (MapType0Select Heap@3 x@@17 f_7))))) (and (=> (= (ControlFlow 0 30) (- 0 31)) (> (U_2_real (MapType1Select Mask@2 null (P x@@17))) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@2 null (P x@@17))) NoPerm) (=> (> wildcard@2 NoPerm) (=> (and (< wildcard@2 (U_2_real (MapType1Select Mask@2 null (P x@@17)))) (= Mask@3 (MapType1Store Mask@2 null (P x@@17) (real_2_U (- (U_2_real (MapType1Select Mask@2 null (P x@@17))) wildcard@2))))) (and (=> (= (ControlFlow 0 30) 28) anon27_Then_correct) (=> (= (ControlFlow 0 30) 29) anon27_Else_correct))))))))))
(let ((anon26_Else_correct  (=> (HasDirectPerm Mask@2 null (P x@@17)) (=> (and (= Heap@2 Heap@@10) (= (ControlFlow 0 33) 30)) anon12_correct))))
(let ((anon26_Then_correct  (=> (not (HasDirectPerm Mask@2 null (P x@@17))) (=> (and (and (= Heap@0 (MapType0Store Heap@@10 null (|P#sm| x@@17) ZeroPMask)) (= Heap@1 (MapType0Store Heap@0 null (P x@@17) freshVersion@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 32) 30))) anon12_correct))))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 34) (- 0 36)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 (U_2_int (MapType0Select Heap@@10 x@@17 f_7))))) (and (<= 0 i_3_1) (< i_3_1 (U_2_int (MapType0Select Heap@@10 x@@17 f_7))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| zs i_3) (|Seq#Index| zs i_3_1))))
 :qid |stdinbpl.723:15|
 :skolemid |65|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (and (<= 0 i_3@@0) (< i_3@@0 (U_2_int (MapType0Select Heap@@10 x@@17 f_7))))) (and (<= 0 i_3_1@@0) (< i_3_1@@0 (U_2_int (MapType0Select Heap@@10 x@@17 f_7))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| zs i_3@@0) (|Seq#Index| zs i_3_1@@0))))
 :qid |stdinbpl.723:15|
 :skolemid |65|
)) (=> (and (and (and (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 (U_2_int (MapType0Select Heap@@10 x@@17 f_7)))) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index| zs i_3@@1)) (= (invRecv1 (|Seq#Index| zs i_3@@1)) i_3@@1)))
 :qid |stdinbpl.729:22|
 :skolemid |66|
 :pattern ( (|Seq#Index| zs i_3@@1))
 :pattern ( (|Seq#Index| zs i_3@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv1 o_3)) (< (invRecv1 o_3) (U_2_int (MapType0Select Heap@@10 x@@17 f_7)))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (|Seq#Index| zs (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.733:22|
 :skolemid |67|
 :pattern ( (invRecv1 o_3))
))) (and (forall ((i_3@@2 Int) ) (!  (=> (and (<= 0 i_3@@2) (< i_3@@2 (U_2_int (MapType0Select Heap@@10 x@@17 f_7)))) (not (= (|Seq#Index| zs i_3@@2) null)))
 :qid |stdinbpl.739:22|
 :skolemid |68|
 :pattern ( (|Seq#Index| zs i_3@@2))
 :pattern ( (|Seq#Index| zs i_3@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (U_2_int (MapType0Select Heap@@10 x@@17 f_7)))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| zs (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 g)) (+ (U_2_real (MapType1Select Mask@0 o_3@@0 g)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (U_2_int (MapType0Select Heap@@10 x@@17 f_7)))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 g)) (U_2_real (MapType1Select Mask@0 o_3@@0 g))))))
 :qid |stdinbpl.745:22|
 :skolemid |69|
...
)) (state Heap@@10 QPMask@0)) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0)))) (and (=> (= (ControlFlow 0 34) (- 0 35)) (> (U_2_real (MapType1Select QPMask@0 x@@17 f_7)) NoPerm)) (=> (> (U_2_real (MapType1Select QPMask@0 x@@17 f_7)) NoPerm) (=> (> wildcard@0 NoPerm) (=> (and (and (and (< wildcard@0 (U_2_real (MapType1Select QPMask@0 x@@17 f_7))) (= Mask@1 (MapType1Store QPMask@0 x@@17 f_7 (real_2_U (- (U_2_real (MapType1Select QPMask@0 x@@17 f_7)) wildcard@0))))) (and (> wildcard@1 NoPerm) (= Mask@2 (MapType1Store Mask@1 null (P x@@17) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (P x@@17))) wildcard@1)))))) (and (and (state Heap@@10 Mask@2) (state Heap@@10 Mask@2)) (and (|P#trigger| Heap@@10 (P x@@17)) (= (MapType0Select Heap@@10 null (P x@@17)) (FrameFragment (MapType0Select Heap@@10 x@@17 f_7)))))) (and (=> (= (ControlFlow 0 34) 32) anon26_Then_correct) (=> (= (ControlFlow 0 34) 33) anon26_Else_correct)))))))))))
(let ((anon9_correct true))
(let ((anon25_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 (U_2_int (MapType0Select Heap@@10 x@@17 f_7))))) (= (ControlFlow 0 12) 8)) anon9_correct)))
(let ((anon25_Then_correct  (=> (and (<= 0 i_2) (< i_2 (U_2_int (MapType0Select Heap@@10 x@@17 f_7)))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_2 (|Seq#Length| zs))) (=> (< i_2 (|Seq#Length| zs)) (=> (= (ControlFlow 0 9) 8) anon9_correct))))))))
(let ((anon24_Else_correct  (=> (< i_2 0) (and (=> (= (ControlFlow 0 15) 9) anon25_Then_correct) (=> (= (ControlFlow 0 15) 12) anon25_Else_correct)))))
(let ((anon24_Then_correct  (=> (<= 0 i_2) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm Mask@0 x@@17 f_7)) (=> (HasDirectPerm Mask@0 x@@17 f_7) (and (=> (= (ControlFlow 0 13) 9) anon25_Then_correct) (=> (= (ControlFlow 0 13) 12) anon25_Else_correct)))))))
(let ((anon21_Else_correct  (=> (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (>= i_1 0) (and (< i_1 (|Seq#Length| zs)) (and (>= j_1 0) (and (< j_1 (|Seq#Length| zs)) (not (= i_1 j_1)))))) (not (= (|Seq#Index| zs i_1) (|Seq#Index| zs j_1))))
 :qid |stdinbpl.696:20|
 :skolemid |64|
 :pattern ( (|Seq#Index| zs i_1) (|Seq#Index| zs j_1))
)) (=> (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (and (=> (= (ControlFlow 0 37) 34) anon23_Else_correct) (=> (= (ControlFlow 0 37) 13) anon24_Then_correct)) (=> (= (ControlFlow 0 37) 15) anon24_Else_correct))))))
(let ((anon3_correct true))
(let ((anon22_Else_correct  (=> (and (not (and (>= i@@6 0) (and (< i@@6 (|Seq#Length| zs)) (and (>= j@@5 0) (and (< j@@5 (|Seq#Length| zs)) (not (= i@@6 j@@5))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon22_Then_correct  (=> (and (>= i@@6 0) (and (< i@@6 (|Seq#Length| zs)) (and (>= j@@5 0) (and (< j@@5 (|Seq#Length| zs)) (not (= i@@6 j@@5)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i@@6 (|Seq#Length| zs))) (=> (< i@@6 (|Seq#Length| zs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j@@5 (|Seq#Length| zs))) (=> (< j@@5 (|Seq#Length| zs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 x@@17 $allocated)) (not (= x@@17 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask x@@17 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@17 f_7)) FullPerm)))) (state Heap@@10 Mask@0)) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 38) (- 0 40)) (HasDirectPerm Mask@0 x@@17 f_7)) (=> (HasDirectPerm Mask@0 x@@17 f_7) (=> (<= 0 (U_2_int (MapType0Select Heap@@10 x@@17 f_7))) (and (=> (= (ControlFlow 0 38) (- 0 39)) (HasDirectPerm Mask@0 x@@17 f_7)) (=> (HasDirectPerm Mask@0 x@@17 f_7) (=> (< (U_2_int (MapType0Select Heap@@10 x@@17 f_7)) (|Seq#Length| zs)) (=> (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (and (=> (= (ControlFlow 0 38) 37) anon21_Else_correct) (=> (= (ControlFlow 0 38) 2) anon22_Then_correct)) (=> (= (ControlFlow 0 38) 7) anon22_Else_correct))))))))))))))
