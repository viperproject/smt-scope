...
(assert  (and (and (and (and (= (type Ops_3Heap@0) (MapType0Type RefType)) (= (type Used_3Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type Used_2Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id t02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon2_correct  (=> (= b_4@3  (and b_4@2 (state Ops_3Heap@0 ZeroMask))) (=> (and (= b_4@4  (and b_4@3 (state Ops_3Heap@0 ZeroMask))) (= b_5@0  (and b_5 (state Used_3Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (and (and b_4@4 b_4@4) b_5@0) (>= x@@8 2))) (=> (=> (and (and b_4@4 b_4@4) b_5@0) (>= x@@8 2)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (and (and b_4@4 b_4@4) b_5@0) (>= x@@8 1))) (=> (=> (and (and b_4@4 b_4@4) b_5@0) (>= x@@8 1)) (=> (= Mask@0 (MapType1Store ZeroMask null (wand (>= x@@8 2)  (and (>= x@@8 2) (>= x@@8 1))) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (wand (>= x@@8 2)  (and (>= x@@8 2) (>= x@@8 1))))) FullPerm)))) (=> (and (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) false))))))))))
(let ((anon3_Else_correct  (=> (not b_4@0) (=> (and (= b_4@2 b_4@0) (= (ControlFlow 0 6) 2)) anon2_correct))))
(let ((anon3_Then_correct  (=> (and (and b_4@0 (= b_4@1  (and b_4@0 (>= x@@8 2)))) (and (= b_4@2 b_4@1) (= (ControlFlow 0 5) 2))) anon2_correct)))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= b_4@0  (and b_4 (state Ops_3Heap@0 ZeroMask))) (= b_3@0  (and b_3 (state Used_2Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 7) 5) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct))))))
