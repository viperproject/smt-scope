...
(assert (forall ((Heap@@3 T@U) (y@@1 Int) ) (!  (=> (= (type Heap@@3) (MapType0Type RefType)) (dummyFunction (int_2_U (|g#triggerStateless| y@@1))))
 :qid |stdinbpl.307:15|
 :skolemid |30|
 :pattern ( (|g'| Heap@@3 y@@1))
)))
(assert (= (type EmptyFrame) FrameTypeType))
(assert (forall ((Heap@@4 T@U) (Mask@@2 T@U) (x@@9 Int) ) (!  (=> (and (and (= (type Heap@@4) (MapType0Type RefType)) (= (type Mask@@2) (MapType1Type RefType realType))) (and (state Heap@@4 Mask@@2) (or (< AssumeFunctionsAbove 0) (|f#trigger| EmptyFrame x@@9)))) (= (|f'| Heap@@4 x@@9) x@@9))
 :qid |stdinbpl.241:15|
 :skolemid |28|
 :pattern ( (state Heap@@4 Mask@@2) (|f'| Heap@@4 x@@9))
)))
...
(assert (forall ((Heap@@6 T@U) (x@@10 Int) ) (!  (=> (= (type Heap@@6) (MapType0Type RefType)) (and (= (f_6 Heap@@6 x@@10) (|f'| Heap@@6 x@@10)) (dummyFunction (int_2_U (|f#triggerStateless| x@@10)))))
 :qid |stdinbpl.218:15|
 :skolemid |24|
 :pattern ( (f_6 Heap@@6 x@@10))
)))
(assert (forall ((Heap@@7 T@U) (y@@2 Int) ) (!  (=> (= (type Heap@@7) (MapType0Type RefType)) (and (= (g Heap@@7 y@@2) (|g'| Heap@@7 y@@2)) (dummyFunction (int_2_U (|g#triggerStateless| y@@2)))))
 :qid |stdinbpl.303:15|
 :skolemid |29|
 :pattern ( (g Heap@@7 y@@2))
)))
...
(assert (forall ((Heap@@8 T@U) (Mask@@4 T@U) (x@@11 Int) ) (!  (=> (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@4) (MapType1Type RefType realType))) (and (state Heap@@8 Mask@@4) (< AssumeFunctionsAbove 0))) (= (f_6 Heap@@8 x@@11) (ite (> x@@11 0) (+ (|f'| Heap@@8 (|f'| Heap@@8 (- x@@11 1))) 1) x@@11)))
 :qid |stdinbpl.228:15|
 :skolemid |26|
 :pattern ( (state Heap@@8 Mask@@4) (f_6 Heap@@8 x@@11))
)))
...
(assert (forall ((Heap@@11 T@U) (Mask@@7 T@U) (y@@3 Int) ) (!  (=> (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (and (state Heap@@11 Mask@@7) (< AssumeFunctionsAbove 1))) (= (g Heap@@11 y@@3) (ite (not (= y@@3 0)) (|g'| Heap@@11 (- y@@3 1)) (|g'| Heap@@11 y@@3))))
 :qid |stdinbpl.313:15|
 :skolemid |31|
 :pattern ( (state Heap@@11 Mask@@7) (g Heap@@11 y@@3))
)))
...
(assert (forall ((Heap@@14 T@U) (Mask@@12 T@U) (x@@12 Int) ) (!  (=> (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (state Heap@@14 Mask@@12)) (= (|f'| Heap@@14 x@@12) (|f#frame| EmptyFrame x@@12)))
 :qid |stdinbpl.235:15|
 :skolemid |27|
 :pattern ( (state Heap@@14 Mask@@12) (|f'| Heap@@14 x@@12))
)))
(assert (forall ((Heap@@15 T@U) (Mask@@13 T@U) (y@@4 Int) ) (!  (=> (and (and (= (type Heap@@15) (MapType0Type RefType)) (= (type Mask@@13) (MapType1Type RefType realType))) (state Heap@@15 Mask@@13)) (= (|g'| Heap@@15 y@@4) (|g#frame| EmptyFrame y@@4)))
 :qid |stdinbpl.320:15|
 :skolemid |32|
 :pattern ( (state Heap@@15 Mask@@13) (|g'| Heap@@15 y@@4))
)))
...
(let ((anon7_correct  (=> (and (state Heap@@18 ZeroMask) (= (ControlFlow 0 4) 1)) anon8_correct)))
(let ((anon12_Else_correct  (=> (and (> 0 x@@13) (= (ControlFlow 0 8) 4)) anon7_correct)))
(let ((anon12_Then_correct  (=> (>= x@@13 0) (and (=> (= (ControlFlow 0 5) (- 0 7)) (decreasing (int_2_U y@@5) (int_2_U x@@13))) (=> (decreasing (int_2_U y@@5) (int_2_U x@@13)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (bounded (int_2_U x@@13))) (=> (bounded (int_2_U x@@13)) (=> (= (ControlFlow 0 5) 4) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= y@@5 (f_6 Heap@@18 (- x@@13 1))) (=> (and (state Heap@@18 ZeroMask) (state Heap@@18 ZeroMask)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (not (>= x@@13 0)) (>= y@@5 0))) (=> (or (not (>= x@@13 0)) (>= y@@5 0)) (=> (state Heap@@18 ZeroMask) (and (=> (= (ControlFlow 0 9) 5) anon12_Then_correct) (=> (= (ControlFlow 0 9) 8) anon12_Else_correct)))))))))
(let ((anon3_correct  (=> (and (state Heap@@18 ZeroMask) (state Heap@@18 ZeroMask)) (and (=> (= (ControlFlow 0 11) 3) anon11_Then_correct) (=> (= (ControlFlow 0 11) 9) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (> 0 x@@13) (= (ControlFlow 0 15) 11)) anon3_correct)))
(let ((anon10_Then_correct  (=> (>= x@@13 0) (and (=> (= (ControlFlow 0 12) (- 0 14)) (decreasing (int_2_U (- x@@13 1)) (int_2_U x@@13))) (=> (decreasing (int_2_U (- x@@13 1)) (int_2_U x@@13)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (bounded (int_2_U x@@13))) (=> (bounded (int_2_U x@@13)) (=> (= (ControlFlow 0 12) 11) anon3_correct))))))))
(let ((anon9_Then_correct  (=> (> x@@13 0) (and (=> (= (ControlFlow 0 16) (- 0 17)) (or (not (>= x@@13 0)) (>= (- x@@13 1) 0))) (=> (or (not (>= x@@13 0)) (>= (- x@@13 1) 0)) (=> (state Heap@@18 ZeroMask) (and (=> (= (ControlFlow 0 16) 12) anon10_Then_correct) (=> (= (ControlFlow 0 16) 15) anon10_Else_correct))))))))
(let ((anon9_Else_correct  (=> (and (>= 0 x@@13) (= (ControlFlow 0 2) 1)) anon8_correct)))
(let ((anon0_correct  (=> (and (state Heap@@18 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 18) 16) anon9_Then_correct) (=> (= (ControlFlow 0 18) 2) anon9_Else_correct)))))
