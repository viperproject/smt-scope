...
(assert  (and (and (and (and (and (and (and (and (and (= (type ExhaleHeap@0) (MapType0Type RefType)) (= (type __flatten_3@0) RefType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@@14) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type diz@@9) RefType)) (= (type l) RefType)) (= (type __flatten_3) RefType)) (= (type tmp@0) (SeqType intType))))
(set-info :boogie-vc-id node__main)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 30) (let ((anon7_correct true))
(let ((anon16_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 14) 11)) anon7_correct)))
(let ((anon16_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null (node__state __flatten_3@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 null (node__state __flatten_3@0)))) (=> (= (ControlFlow 0 12) 11) anon7_correct))))))
(let ((anon15_Then_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (not (= __flatten_3@0 null))) (=> (not (= __flatten_3@0 null)) (and (=> (= (ControlFlow 0 15) 12) anon16_Then_correct) (=> (= (ControlFlow 0 15) 14) anon16_Else_correct))))))
(let ((anon11_correct true))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon11_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null (node__state __flatten_3@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 null (node__state __flatten_3@0)))) (=> (= (ControlFlow 0 4) 3) anon11_correct))))))
(let ((anon17_Then_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (not (= __flatten_3@0 null))) (=> (not (= __flatten_3@0 null)) (and (=> (= (ControlFlow 0 7) 4) anon18_Then_correct) (=> (= (ControlFlow 0 7) 6) anon18_Else_correct))))))
(let ((anon17_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (|Seq#Contains| (node__contents ExhaleHeap@0 __flatten_3@0) (int_2_U 37)))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (|Seq#Equal| (node__contents ExhaleHeap@0 __flatten_3@0) (|Seq#Singleton| (int_2_U 37)))) (=> (|Seq#Equal| (node__contents ExhaleHeap@0 __flatten_3@0) (|Seq#Singleton| (int_2_U 37))) (=> (state ExhaleHeap@0 Mask@2) (and (=> (= (ControlFlow 0 9) 7) anon17_Then_correct) (=> (= (ControlFlow 0 9) 2) anon17_Else_correct)))))))
(let ((anon4_correct  (=> (and (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@0 Mask@1) (not (= __flatten_3@0 null))) (=> (and (and (and (= Mask@2 (MapType1Store Mask@1 null (node__state __flatten_3@0) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (node__state __flatten_3@0))) FullPerm)))) (state ExhaleHeap@0 Mask@2)) (and (state ExhaleHeap@0 Mask@2) (|Seq#Equal| (node__contents ExhaleHeap@0 __flatten_3@0) (ite (= null null) (|Seq#Singleton| (int_2_U 37)) (|Seq#Append| (|Seq#Singleton| (int_2_U 37)) (node__contents Heap@@14 null)))))) (and (and (state ExhaleHeap@0 Mask@2) (U_2_bool (MapType0Select ExhaleHeap@0 __flatten_3@0 $allocated))) (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)))) (and (=> (= (ControlFlow 0 17) 15) anon15_Then_correct) (=> (= (ControlFlow 0 17) 9) anon15_Else_correct))))))
(let ((anon3_correct  (=> (= Mask@0 (MapType1Store ZeroMask null (node__state null) (real_2_U (- (U_2_real (MapType1Select ZeroMask null (node__state null))) FullPerm)))) (=> (and (= Mask@1 Mask@0) (= (ControlFlow 0 19) 17)) anon4_correct))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 22) 19)) anon3_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (<= FullPerm (U_2_real (MapType1Select ZeroMask null (node__state null))))) (=> (<= FullPerm (U_2_real (MapType1Select ZeroMask null (node__state null)))) (=> (= (ControlFlow 0 20) 19) anon3_correct))))))
(let ((anon13_Then_correct  (=> (not (= null null)) (and (=> (= (ControlFlow 0 23) 20) anon14_Then_correct) (=> (= (ControlFlow 0 23) 22) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (= null null) (=> (and (= Mask@1 ZeroMask) (= (ControlFlow 0 18) 17)) anon4_correct))))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@14 diz@@9 $allocated))) (=> (and (and (and (not (= diz@@9 null)) (state Heap@@14 ZeroMask)) (and (>= current_thread_id 0) (state Heap@@14 ZeroMask))) (and (and (U_2_bool (MapType0Select Heap@@14 l $allocated)) (U_2_bool (MapType0Select Heap@@14 __flatten_3 $allocated))) (and (= tmp@0 (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 1)) (|Seq#Singleton| (int_2_U 2))) (|Seq#Singleton| (int_2_U 3)))) (state Heap@@14 ZeroMask)))) (and (=> (= (ControlFlow 0 24) (- 0 29)) (|Seq#Equal| tmp@0 (|Seq#Append| (|Seq#Singleton| (int_2_U 1)) (|Seq#Append| (|Seq#Singleton| (int_2_U 2)) (|Seq#Singleton| (int_2_U 3)))))) (=> (|Seq#Equal| tmp@0 (|Seq#Append| (|Seq#Singleton| (int_2_U 1)) (|Seq#Append| (|Seq#Singleton| (int_2_U 2)) (|Seq#Singleton| (int_2_U 3))))) (=> (state Heap@@14 ZeroMask) (and (=> (= (ControlFlow 0 24) (- 0 28)) (< 0 (|Seq#Length| tmp@0))) (=> (< 0 (|Seq#Length| tmp@0)) (and (=> (= (ControlFlow 0 24) (- 0 27)) (= (U_2_int (|Seq#Index| tmp@0 0)) 1)) (=> (= (U_2_int (|Seq#Index| tmp@0 0)) 1) (=> (state Heap@@14 ZeroMask) (and (=> (= (ControlFlow 0 24) (- 0 26)) (|Seq#Equal| (|Seq#Drop| tmp@0 1) (|Seq#Append| (|Seq#Singleton| (int_2_U 2)) (|Seq#Singleton| (int_2_U 3))))) (=> (|Seq#Equal| (|Seq#Drop| tmp@0 1) (|Seq#Append| (|Seq#Singleton| (int_2_U 2)) (|Seq#Singleton| (int_2_U 3)))) (=> (state Heap@@14 ZeroMask) (and (=> (= (ControlFlow 0 24) (- 0 25)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (and (=> (= (ControlFlow 0 24) 23) anon13_Then_correct) (=> (= (ControlFlow 0 24) 18) anon13_Else_correct))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 30) 24) anon0_correct)))
