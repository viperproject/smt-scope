...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon2_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (valid__Cell self@@5 (/ (to_real 1) (to_real 2))) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid__Cell self@@5 (/ (to_real 1) (to_real 2))))) perm@1)))) (= perm@2 (* (/ (to_real 1) (to_real 2)) (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (=> (> perm@2 NoPerm) (not (= self@@5 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 self@@5 v_2 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 self@@5 v_2)) perm@2)))) (state Heap@@10 UnfoldingMask@1)) (and (state Heap@@10 UnfoldingMask@1) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm UnfoldingMask@1 self@@5 v_2))))))))
(let ((anon3_Else_correct  (=> (and (= perm@1 NoPerm) (= (ControlFlow 0 6) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= perm@1 NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= perm@1 (U_2_real (MapType1Select Mask@0 null (valid__Cell self@@5 (/ (to_real 1) (to_real 2))))))) (=> (<= perm@1 (U_2_real (MapType1Select Mask@0 null (valid__Cell self@@5 (/ (to_real 1) (to_real 2)))))) (=> (= (ControlFlow 0 4) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 self@@5 $allocated)) (= perm@0 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (= Mask@0 (MapType1Store ZeroMask null (valid__Cell self@@5 (/ (to_real 1) (to_real 2))) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid__Cell self@@5 (/ (to_real 1) (to_real 2))))) perm@0)))) (state Heap@@10 Mask@0)) (=> (and (and (state Heap@@10 Mask@0) (|valid__Cell#trigger| Heap@@10 (valid__Cell self@@5 (/ (to_real 1) (to_real 2))))) (and (= (MapType0Select Heap@@10 null (valid__Cell self@@5 (/ (to_real 1) (to_real 2)))) (ConditionalFrame (/ (to_real 1) (to_real 2)) (FrameFragment (MapType0Select Heap@@10 self@@5 v_2)))) (= perm@1 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (and (=> (= (ControlFlow 0 7) 4) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct))))))))))))
