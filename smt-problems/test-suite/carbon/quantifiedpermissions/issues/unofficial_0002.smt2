...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (Ctor RefType) 8)) (= (type left) (FieldType NormalFieldType RefType))) (= (type is_marked) (FieldType NormalFieldType boolType))))
(assert (distinct $allocated left is_marked)
)
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type graph) (MapType2Type RefType boolType)) (= (type x@@19) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type node) RefType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type arg_node@0) RefType)) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type QPMask@3) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type x_2) RefType)) (= (type QPMask@2) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv3 arg0@@43)) RefType)
 :qid |funType:invRecv3|
 :pattern ( (invRecv3 arg0@@43))
))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv4 arg0@@44)) RefType)
 :qid |funType:invRecv4|
 :pattern ( (invRecv4 arg0@@44))
))) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv2 arg0@@45)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@45))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@46 T@U) ) (! (= (type (invRecv1 arg0@@46)) RefType)
...
(let ((anon33_Else_correct  (=> (and (= (MapType0Select Heap@0 x_2 left) null) (= (ControlFlow 0 27) 23)) anon18_correct)))
(let ((anon33_Then_correct  (=> (not (= (MapType0Select Heap@0 x_2 left) null)) (and (=> (= (ControlFlow 0 25) (- 0 26)) (U_2_bool (MapType2Select graph (MapType0Select Heap@0 x_2 left)))) (=> (U_2_bool (MapType2Select graph (MapType0Select Heap@0 x_2 left))) (=> (= (ControlFlow 0 25) 23) anon18_correct))))))
(let ((anon32_Then_correct  (=> (U_2_bool (MapType2Select graph x_2)) (and (=> (= (ControlFlow 0 28) 25) anon33_Then_correct) (=> (= (ControlFlow 0 28) 27) anon33_Else_correct)))))
(let ((anon32_Else_correct  (=> (and (not (U_2_bool (MapType2Select graph x_2))) (= (ControlFlow 0 24) 23)) anon18_correct)))
(let ((anon22_correct  (=> (and (= Mask@2 (MapType1Store Mask@1 node is_marked (real_2_U (- (U_2_real (MapType1Select Mask@1 node is_marked)) FullPerm)))) (= (ControlFlow 0 13) (- 0 12))) (U_2_bool (MapType0Select Heap@1 node is_marked)))))
(let ((anon34_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 13)) anon22_correct)))
(let ((anon34_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (U_2_real (MapType1Select Mask@1 node is_marked)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 node is_marked))) (=> (= (ControlFlow 0 14) 13) anon22_correct))))))
(let ((anon20_correct  (=> (state Heap@1 Mask@1) (and (=> (= (ControlFlow 0 17) (- 0 19)) (HasDirectPerm Mask@1 node is_marked)) (=> (HasDirectPerm Mask@1 node is_marked) (and (=> (= (ControlFlow 0 17) (- 0 18)) (U_2_bool (MapType0Select Heap@1 node is_marked))) (=> (U_2_bool (MapType0Select Heap@1 node is_marked)) (=> (state Heap@1 Mask@1) (and (=> (= (ControlFlow 0 17) 14) anon34_Then_correct) (=> (= (ControlFlow 0 17) 16) anon34_Else_correct))))))))))
(let ((anon31_Else_correct  (=> (forall ((x_3_1 T@U) ) (!  (=> (and (and (= (type x_3_1) RefType) (U_2_bool (MapType2Select graph x_3_1))) (not (= (MapType0Select Heap@0 x_3_1 left) null))) (U_2_bool (MapType2Select graph (MapType0Select Heap@0 x_3_1 left))))
 :qid |stdinbpl.687:26|
 :skolemid |107|
 :pattern ( (MapType2Select graph x_3_1))
 :pattern ( (MapType2Select graph (MapType0Select Heap@0 x_3_1 left)))
)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (not (U_2_bool (MapType0Select Heap@0 arg_node@0 is_marked)))) (=> (not (U_2_bool (MapType0Select Heap@0 arg_node@0 is_marked))) (=> (and (IdenticalOnKnownLocations Heap@0 ExhaleHeap@0 QPMask@3) (not (= arg_node@0 null))) (=> (and (and (and (= Mask@0 (MapType1Store QPMask@3 arg_node@0 is_marked (real_2_U (+ (U_2_real (MapType1Select QPMask@3 arg_node@0 is_marked)) FullPerm)))) (state ExhaleHeap@0 Mask@0)) (and (U_2_bool (MapType0Select ExhaleHeap@0 arg_node@0 is_marked)) (state ExhaleHeap@0 Mask@0))) (and (and (state ExhaleHeap@0 Mask@0) (= Mask@1 Mask@0)) (and (= Heap@1 ExhaleHeap@0) (= (ControlFlow 0 21) 17)))) anon20_correct)))))))
(let ((anon30_Then_correct  (=> (and (not (= (MapType0Select Heap@0 node left) null)) (not (U_2_bool (MapType0Select Heap@0 (MapType0Select Heap@0 node left) is_marked)))) (and (=> (= (ControlFlow 0 29) (- 0 36)) (HasDirectPerm QPMask@1 node left)) (=> (HasDirectPerm QPMask@1 node left) (=> (= arg_node@0 (MapType0Select Heap@0 node left)) (and (=> (= (ControlFlow 0 29) (- 0 35)) (U_2_bool (MapType2Select graph arg_node@0))) (=> (U_2_bool (MapType2Select graph arg_node@0)) (and (=> (= (ControlFlow 0 29) (- 0 34)) (not (U_2_bool (MapType2Select graph null)))) (=> (not (U_2_bool (MapType2Select graph null))) (and (=> (= (ControlFlow 0 29) (- 0 33)) (forall ((a_2 T@U) (a_2_1 T@U) ) (!  (=> (and (= (type a_2) RefType) (= (type a_2_1) RefType)) (=> (and (and (and (and (not (= a_2 a_2_1)) (U_2_bool (MapType2Select graph a_2))) (U_2_bool (MapType2Select graph a_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_2 a_2_1))))
 :qid |stdinbpl.603:23|
 :skolemid |95|
 :pattern ( (neverTriggered3 a_2) (neverTriggered3 a_2_1))
))) (=> (forall ((a_2@@0 T@U) (a_2_1@@0 T@U) ) (!  (=> (and (= (type a_2@@0) RefType) (= (type a_2_1@@0) RefType)) (=> (and (and (and (and (not (= a_2@@0 a_2_1@@0)) (U_2_bool (MapType2Select graph a_2@@0))) (U_2_bool (MapType2Select graph a_2_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_2@@0 a_2_1@@0))))
 :qid |stdinbpl.603:23|
 :skolemid |95|
 :pattern ( (neverTriggered3 a_2@@0) (neverTriggered3 a_2_1@@0))
)) (and (=> (= (ControlFlow 0 29) (- 0 32)) (forall ((a_2@@1 T@U) ) (!  (=> (and (= (type a_2@@1) RefType) (U_2_bool (MapType2Select graph a_2@@1))) (>= (U_2_real (MapType1Select QPMask@1 a_2@@1 left)) FullPerm))
 :qid |stdinbpl.610:23|
 :skolemid |96|
 :pattern ( (MapType0Select Heap@0 a_2@@1 left))
 :pattern ( (MapType1Select QPMask@2 a_2@@1 left))
 :pattern ( (MapType2Select graph a_2@@1))
))) (=> (forall ((a_2@@2 T@U) ) (!  (=> (and (= (type a_2@@2) RefType) (U_2_bool (MapType2Select graph a_2@@2))) (>= (U_2_real (MapType1Select QPMask@1 a_2@@2 left)) FullPerm))
 :qid |stdinbpl.610:23|
 :skolemid |96|
 :pattern ( (MapType0Select Heap@0 a_2@@2 left))
 :pattern ( (MapType1Select QPMask@2 a_2@@2 left))
 :pattern ( (MapType2Select graph a_2@@2))
)) (=> (and (and (forall ((a_2@@3 T@U) ) (!  (=> (= (type a_2@@3) RefType) (=> (and (U_2_bool (MapType2Select graph a_2@@3)) (< NoPerm FullPerm)) (and (qpRange3 a_2@@3) (= (invRecv3 a_2@@3) a_2@@3))))
 :qid |stdinbpl.616:28|
 :skolemid |97|
 :pattern ( (MapType0Select Heap@0 a_2@@3 left))
 :pattern ( (MapType1Select QPMask@2 a_2@@3 left))
 :pattern ( (MapType2Select graph a_2@@3))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType2Select graph (invRecv3 o_3))) (and (< NoPerm FullPerm) (qpRange3 o_3))) (= (invRecv3 o_3) o_3)))
 :qid |stdinbpl.620:28|
 :skolemid |98|
 :pattern ( (invRecv3 o_3))
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType2Select graph (invRecv3 o_3@@0))) (and (< NoPerm FullPerm) (qpRange3 o_3@@0))) (and (= (invRecv3 o_3@@0) o_3@@0) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 left)) (- (U_2_real (MapType1Select QPMask@1 o_3@@0 left)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select graph (invRecv3 o_3@@0))) (and (< NoPerm FullPerm) (qpRange3 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 left)) (U_2_real (MapType1Select QPMask@1 o_3@@0 left))))))
 :qid |stdinbpl.626:28|
 :skolemid |99|
 :pattern ( (MapType1Select QPMask@2 o_3@@0 left))
)) (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 left))) (= (U_2_real (MapType1Select QPMask@1 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@2 o_3@@1 f_5))))))
 :qid |stdinbpl.632:35|
 :skolemid |100|
 :pattern ( (MapType1Select QPMask@2 o_3@@1 f_5))
)))) (and (=> (= (ControlFlow 0 29) (- 0 31)) (forall ((c_2 T@U) (c_2_1 T@U) ) (!  (=> (and (= (type c_2) RefType) (= (type c_2_1) RefType)) (=> (and (and (and (and (not (= c_2 c_2_1)) (U_2_bool (MapType2Select graph c_2))) (U_2_bool (MapType2Select graph c_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= c_2 c_2_1))))
 :qid |stdinbpl.644:23|
 :skolemid |101|
 :pattern ( (neverTriggered4 c_2) (neverTriggered4 c_2_1))
))) (=> (forall ((c_2@@0 T@U) (c_2_1@@0 T@U) ) (!  (=> (and (= (type c_2@@0) RefType) (= (type c_2_1@@0) RefType)) (=> (and (and (and (and (not (= c_2@@0 c_2_1@@0)) (U_2_bool (MapType2Select graph c_2@@0))) (U_2_bool (MapType2Select graph c_2_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= c_2@@0 c_2_1@@0))))
 :qid |stdinbpl.644:23|
 :skolemid |101|
 :pattern ( (neverTriggered4 c_2@@0) (neverTriggered4 c_2_1@@0))
)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (forall ((c_2@@1 T@U) ) (!  (=> (and (= (type c_2@@1) RefType) (U_2_bool (MapType2Select graph c_2@@1))) (>= (U_2_real (MapType1Select QPMask@2 c_2@@1 is_marked)) FullPerm))
 :qid |stdinbpl.651:23|
 :skolemid |102|
 :pattern ( (MapType0Select Heap@0 c_2@@1 is_marked))
 :pattern ( (MapType1Select QPMask@3 c_2@@1 is_marked))
 :pattern ( (MapType2Select graph c_2@@1))
))) (=> (forall ((c_2@@2 T@U) ) (!  (=> (and (= (type c_2@@2) RefType) (U_2_bool (MapType2Select graph c_2@@2))) (>= (U_2_real (MapType1Select QPMask@2 c_2@@2 is_marked)) FullPerm))
 :qid |stdinbpl.651:23|
 :skolemid |102|
 :pattern ( (MapType0Select Heap@0 c_2@@2 is_marked))
 :pattern ( (MapType1Select QPMask@3 c_2@@2 is_marked))
 :pattern ( (MapType2Select graph c_2@@2))
)) (=> (and (and (forall ((c_2@@3 T@U) ) (!  (=> (= (type c_2@@3) RefType) (=> (and (U_2_bool (MapType2Select graph c_2@@3)) (< NoPerm FullPerm)) (and (qpRange4 c_2@@3) (= (invRecv4 c_2@@3) c_2@@3))))
 :qid |stdinbpl.657:28|
 :skolemid |103|
 :pattern ( (MapType0Select Heap@0 c_2@@3 is_marked))
 :pattern ( (MapType1Select QPMask@3 c_2@@3 is_marked))
 :pattern ( (MapType2Select graph c_2@@3))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType2Select graph (invRecv4 o_3@@2))) (and (< NoPerm FullPerm) (qpRange4 o_3@@2))) (= (invRecv4 o_3@@2) o_3@@2)))
 :qid |stdinbpl.661:28|
 :skolemid |104|
 :pattern ( (invRecv4 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType2Select graph (invRecv4 o_3@@3))) (and (< NoPerm FullPerm) (qpRange4 o_3@@3))) (and (= (invRecv4 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@3 o_3@@3 is_marked)) (- (U_2_real (MapType1Select QPMask@2 o_3@@3 is_marked)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select graph (invRecv4 o_3@@3))) (and (< NoPerm FullPerm) (qpRange4 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@3 o_3@@3 is_marked)) (U_2_real (MapType1Select QPMask@2 o_3@@3 is_marked))))))
 :qid |stdinbpl.667:28|
 :skolemid |105|
 :pattern ( (MapType1Select QPMask@3 o_3@@3 is_marked))
)) (forall ((o_3@@4 T@U) (f_5@@0 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_5@@0))))
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 is_marked))) (= (U_2_real (MapType1Select QPMask@2 o_3@@4 f_5@@0)) (U_2_real (MapType1Select QPMask@3 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.673:35|
 :skolemid |106|
...
(let ((anon30_Else_correct  (=> (and (and (not (and (not (= (MapType0Select Heap@0 node left) null)) (not (U_2_bool (MapType0Select Heap@0 (MapType0Select Heap@0 node left) is_marked))))) (= Mask@1 QPMask@1)) (and (= Heap@1 Heap@0) (= (ControlFlow 0 20) 17))) anon20_correct)))
(let ((anon29_Else_correct  (=> (= (MapType0Select Heap@0 node left) null) (and (=> (= (ControlFlow 0 40) 29) anon30_Then_correct) (=> (= (ControlFlow 0 40) 20) anon30_Else_correct)))))
(let ((anon29_Then_correct  (=> (not (= (MapType0Select Heap@0 node left) null)) (and (=> (= (ControlFlow 0 37) (- 0 39)) (HasDirectPerm QPMask@1 node left)) (=> (HasDirectPerm QPMask@1 node left) (and (=> (= (ControlFlow 0 37) (- 0 38)) (HasDirectPerm QPMask@1 (MapType0Select Heap@0 node left) is_marked)) (=> (HasDirectPerm QPMask@1 (MapType0Select Heap@0 node left) is_marked) (and (=> (= (ControlFlow 0 37) 29) anon30_Then_correct) (=> (= (ControlFlow 0 37) 20) anon30_Else_correct)))))))))
(let ((anon28_Else_correct  (and (=> (= (ControlFlow 0 41) (- 0 43)) (= FullPerm (U_2_real (MapType1Select QPMask@1 node is_marked)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@1 node is_marked))) (=> (and (= Heap@0 (MapType0Store Heap@@9 node is_marked (bool_2_U true))) (state Heap@0 QPMask@1)) (and (=> (= (ControlFlow 0 41) (- 0 42)) (HasDirectPerm QPMask@1 node left)) (=> (HasDirectPerm QPMask@1 node left) (and (=> (= (ControlFlow 0 41) 37) anon29_Then_correct) (=> (= (ControlFlow 0 41) 40) anon29_Else_correct)))))))))
(let ((anon28_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (not (= node null))) (=> (and (and (= PostMask@0 (MapType1Store ZeroMask node is_marked (real_2_U (+ (U_2_real (MapType1Select ZeroMask node is_marked)) FullPerm)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (= (ControlFlow 0 11) (- 0 10)))) (HasDirectPerm PostMask@0 node is_marked)))))
(let ((anon25_Else_correct  (=> (and (forall ((x_1 T@U) ) (!  (=> (and (and (= (type x_1) RefType) (U_2_bool (MapType2Select graph x_1))) (not (= (MapType0Select Heap@@9 x_1 left) null))) (U_2_bool (MapType2Select graph (MapType0Select Heap@@9 x_1 left))))
 :qid |stdinbpl.524:20|
 :skolemid |94|
 :pattern ( (MapType2Select graph x_1))
 :pattern ( (MapType2Select graph (MapType0Select Heap@@9 x_1 left)))
)) (state Heap@@9 QPMask@1)) (and (=> (= (ControlFlow 0 44) (- 0 45)) (HasDirectPerm QPMask@1 node is_marked)) (=> (HasDirectPerm QPMask@1 node is_marked) (=> (and (not (U_2_bool (MapType0Select Heap@@9 node is_marked))) (state Heap@@9 QPMask@1)) (and (=> (= (ControlFlow 0 44) 11) anon28_Then_correct) (=> (= (ControlFlow 0 44) 41) anon28_Else_correct))))))))
(let ((anon8_correct true))
(let ((anon27_Else_correct  (=> (and (= (MapType0Select Heap@@9 x@@19 left) null) (= (ControlFlow 0 7) 3)) anon8_correct)))
(let ((anon27_Then_correct  (=> (not (= (MapType0Select Heap@@9 x@@19 left) null)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm QPMask@1 x@@19 left)) (=> (HasDirectPerm QPMask@1 x@@19 left) (=> (= (ControlFlow 0 5) 3) anon8_correct))))))
(let ((anon26_Then_correct  (=> (U_2_bool (MapType2Select graph x@@19)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm QPMask@1 x@@19 left)) (=> (HasDirectPerm QPMask@1 x@@19 left) (and (=> (= (ControlFlow 0 8) 5) anon27_Then_correct) (=> (= (ControlFlow 0 8) 7) anon27_Else_correct)))))))
(let ((anon26_Else_correct  (=> (and (not (U_2_bool (MapType2Select graph x@@19))) (= (ControlFlow 0 4) 3)) anon8_correct)))
(let ((anon24_Else_correct  (and (=> (= (ControlFlow 0 46) (- 0 47)) (forall ((c_1 T@U) (c_1_1 T@U) ) (!  (=> (and (= (type c_1) RefType) (= (type c_1_1) RefType)) (=> (and (and (and (and (not (= c_1 c_1_1)) (U_2_bool (MapType2Select graph c_1))) (U_2_bool (MapType2Select graph c_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= c_1 c_1_1))))
 :qid |stdinbpl.479:15|
 :skolemid |88|
 :no-pattern (type c_1)
 :no-pattern (type c_1_1)
 :no-pattern (U_2_int c_1)
 :no-pattern (U_2_bool c_1)
 :no-pattern (U_2_int c_1_1)
 :no-pattern (U_2_bool c_1_1)
))) (=> (forall ((c_1@@0 T@U) (c_1_1@@0 T@U) ) (!  (=> (and (= (type c_1@@0) RefType) (= (type c_1_1@@0) RefType)) (=> (and (and (and (and (not (= c_1@@0 c_1_1@@0)) (U_2_bool (MapType2Select graph c_1@@0))) (U_2_bool (MapType2Select graph c_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= c_1@@0 c_1_1@@0))))
 :qid |stdinbpl.479:15|
 :skolemid |88|
 :no-pattern (type c_1@@0)
 :no-pattern (type c_1_1@@0)
 :no-pattern (U_2_int c_1@@0)
 :no-pattern (U_2_bool c_1@@0)
 :no-pattern (U_2_int c_1_1@@0)
 :no-pattern (U_2_bool c_1_1@@0)
)) (=> (and (forall ((c_1@@1 T@U) ) (!  (=> (= (type c_1@@1) RefType) (=> (and (U_2_bool (MapType2Select graph c_1@@1)) (< NoPerm FullPerm)) (and (qpRange2 c_1@@1) (= (invRecv2 c_1@@1) c_1@@1))))
 :qid |stdinbpl.485:22|
 :skolemid |89|
 :pattern ( (MapType0Select Heap@@9 c_1@@1 is_marked))
 :pattern ( (MapType1Select QPMask@1 c_1@@1 is_marked))
 :pattern ( (MapType2Select graph c_1@@1))
)) (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (U_2_bool (MapType2Select graph (invRecv2 o_3@@5))) (< NoPerm FullPerm)) (qpRange2 o_3@@5)) (= (invRecv2 o_3@@5) o_3@@5)))
 :qid |stdinbpl.489:22|
 :skolemid |90|
 :pattern ( (invRecv2 o_3@@5))
))) (=> (and (and (forall ((c_1@@2 T@U) ) (!  (=> (and (= (type c_1@@2) RefType) (U_2_bool (MapType2Select graph c_1@@2))) (not (= c_1@@2 null)))
 :qid |stdinbpl.495:22|
 :skolemid |91|
 :pattern ( (MapType0Select Heap@@9 c_1@@2 is_marked))
 :pattern ( (MapType1Select QPMask@1 c_1@@2 is_marked))
 :pattern ( (MapType2Select graph c_1@@2))
)) (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (U_2_bool (MapType2Select graph (invRecv2 o_3@@6))) (< NoPerm FullPerm)) (qpRange2 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@6) o_3@@6)) (= (U_2_real (MapType1Select QPMask@1 o_3@@6 is_marked)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@6 is_marked)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select graph (invRecv2 o_3@@6))) (< NoPerm FullPerm)) (qpRange2 o_3@@6))) (= (U_2_real (MapType1Select QPMask@1 o_3@@6 is_marked)) (U_2_real (MapType1Select QPMask@0 o_3@@6 is_marked))))))
 :qid |stdinbpl.501:22|
 :skolemid |92|
 :pattern ( (MapType1Select QPMask@1 o_3@@6 is_marked))
))) (and (forall ((o_3@@7 T@U) (f_5@@1 T@U) ) (! (let ((B@@13 (FieldTypeInv1 (type f_5@@1))))
(let ((A@@14 (FieldTypeInv0 (type f_5@@1))))
 (=> (and (and (= (type o_3@@7) RefType) (= (type f_5@@1) (FieldType A@@14 B@@13))) (not (= f_5@@1 is_marked))) (= (U_2_real (MapType1Select QPMask@0 o_3@@7 f_5@@1)) (U_2_real (MapType1Select QPMask@1 o_3@@7 f_5@@1))))))
 :qid |stdinbpl.505:29|
 :skolemid |93|
 :pattern ( (MapType1Select QPMask@0 o_3@@7 f_5@@1))
 :pattern ( (MapType1Select QPMask@1 o_3@@7 f_5@@1))
)) (state Heap@@9 QPMask@1))) (and (and (=> (= (ControlFlow 0 46) 44) anon25_Else_correct) (=> (= (ControlFlow 0 46) 8) anon26_Then_correct)) (=> (= (ControlFlow 0 46) 4) anon26_Else_correct))))))))
(let ((anon24_Then_correct true))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 48) (- 0 49)) (forall ((a_1 T@U) (a_1_1 T@U) ) (!  (=> (and (= (type a_1) RefType) (= (type a_1_1) RefType)) (=> (and (and (and (and (not (= a_1 a_1_1)) (U_2_bool (MapType2Select graph a_1))) (U_2_bool (MapType2Select graph a_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1 a_1_1))))
 :qid |stdinbpl.440:15|
 :skolemid |82|
 :no-pattern (type a_1)
...
))) (=> (forall ((a_1@@0 T@U) (a_1_1@@0 T@U) ) (!  (=> (and (= (type a_1@@0) RefType) (= (type a_1_1@@0) RefType)) (=> (and (and (and (and (not (= a_1@@0 a_1_1@@0)) (U_2_bool (MapType2Select graph a_1@@0))) (U_2_bool (MapType2Select graph a_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1@@0 a_1_1@@0))))
 :qid |stdinbpl.440:15|
 :skolemid |82|
...
)) (=> (and (forall ((a_1@@1 T@U) ) (!  (=> (= (type a_1@@1) RefType) (=> (and (U_2_bool (MapType2Select graph a_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 a_1@@1) (= (invRecv1 a_1@@1) a_1@@1))))
 :qid |stdinbpl.446:22|
 :skolemid |83|
 :pattern ( (MapType0Select Heap@@9 a_1@@1 left))
 :pattern ( (MapType1Select QPMask@0 a_1@@1 left))
 :pattern ( (MapType2Select graph a_1@@1))
)) (forall ((o_3@@8 T@U) ) (!  (=> (= (type o_3@@8) RefType) (=> (and (and (U_2_bool (MapType2Select graph (invRecv1 o_3@@8))) (< NoPerm FullPerm)) (qpRange1 o_3@@8)) (= (invRecv1 o_3@@8) o_3@@8)))
 :qid |stdinbpl.450:22|
 :skolemid |84|
 :pattern ( (invRecv1 o_3@@8))
))) (=> (and (and (forall ((a_1@@2 T@U) ) (!  (=> (and (= (type a_1@@2) RefType) (U_2_bool (MapType2Select graph a_1@@2))) (not (= a_1@@2 null)))
 :qid |stdinbpl.456:22|
 :skolemid |85|
 :pattern ( (MapType0Select Heap@@9 a_1@@2 left))
 :pattern ( (MapType1Select QPMask@0 a_1@@2 left))
 :pattern ( (MapType2Select graph a_1@@2))
)) (forall ((o_3@@9 T@U) ) (!  (=> (= (type o_3@@9) RefType) (and (=> (and (and (U_2_bool (MapType2Select graph (invRecv1 o_3@@9))) (< NoPerm FullPerm)) (qpRange1 o_3@@9)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@9) o_3@@9)) (= (U_2_real (MapType1Select QPMask@0 o_3@@9 left)) (+ (U_2_real (MapType1Select ZeroMask o_3@@9 left)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select graph (invRecv1 o_3@@9))) (< NoPerm FullPerm)) (qpRange1 o_3@@9))) (= (U_2_real (MapType1Select QPMask@0 o_3@@9 left)) (U_2_real (MapType1Select ZeroMask o_3@@9 left))))))
 :qid |stdinbpl.462:22|
 :skolemid |86|
...
(let ((A@@15 (FieldTypeInv0 (type f_5@@2))))
 (=> (and (and (= (type o_3@@10) RefType) (= (type f_5@@2) (FieldType A@@15 B@@14))) (not (= f_5@@2 left))) (= (U_2_real (MapType1Select ZeroMask o_3@@10 f_5@@2)) (U_2_real (MapType1Select QPMask@0 o_3@@10 f_5@@2))))))
 :qid |stdinbpl.466:29|
 :skolemid |87|
 :pattern ( (MapType1Select ZeroMask o_3@@10 f_5@@2))
 :pattern ( (MapType1Select QPMask@0 o_3@@10 f_5@@2))
)) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 48) 2) anon24_Then_correct) (=> (= (ControlFlow 0 48) 46) anon24_Else_correct))))))))
(let ((anon23_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 node $allocated))) (and (U_2_bool (MapType2Select graph node)) (not (U_2_bool (MapType2Select graph null))))) (and (=> (= (ControlFlow 0 50) 1) anon23_Then_correct) (=> (= (ControlFlow 0 50) 48) anon23_Else_correct)))))
