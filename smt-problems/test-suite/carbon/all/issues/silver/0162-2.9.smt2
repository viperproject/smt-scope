...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x@@8 $allocated))) (=> (and (and (and (not (= x@@8 null)) (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (and (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@8 f_7))) (state Heap@@10 Mask@0)) (and (state Heap@@10 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) false))))
