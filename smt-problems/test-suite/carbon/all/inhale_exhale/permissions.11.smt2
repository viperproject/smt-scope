...
(set-info :boogie-vc-id inhaleExpression1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (and (and (not (= this null)) (= Mask@0 (MapType1Store ZeroMask this x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this x@@8)) FullPerm))))) (and (state Heap@@9 Mask@0) (= (ControlFlow 0 3) (- 0 2)))) (HasDirectPerm Mask@0 this x@@8))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 this $allocated))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
