...
(let ((anon6_Else_correct  (=> (= (MapType0Select Heap@1 this@@21 next) null) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 3) 1)) anon4_correct))))
(let ((anon6_Then_correct  (=> (not (= (MapType0Select Heap@1 this@@21 next) null)) (=> (and (and (forall ((o_3 T@U) (f_7 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_7))))
(let ((A@@12 (FieldTypeInv0 (type f_7))))
 (=> (and (and (= (type o_3) RefType) (= (type f_7) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|valid#sm| this@@21)) o_3 f_7)) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|valid#sm| (MapType0Select Heap@1 this@@21 next))) o_3 f_7)))) (U_2_bool (MapType1Select newPMask@0 o_3 f_7)))))
 :qid |stdinbpl.291:33|
 :skolemid |26|
 :pattern ( (MapType1Select newPMask@0 o_3 f_7))
)) (= Heap@2 (MapType0Store Heap@1 null (|valid#sm| this@@21) newPMask@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 2) 1))) anon4_correct))))
(let ((anon2_correct  (=> (state Heap@@16 UnfoldingMask@4) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm UnfoldingMask@4 this@@21 next)) (=> (HasDirectPerm UnfoldingMask@4 this@@21 next) (=> (and (= Heap@0 (MapType0Store Heap@@16 null (|valid#sm| this@@21) (MapType1Store (MapType0Select Heap@@16 null (|valid#sm| this@@21)) this@@21 next (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|valid#sm| this@@21) (MapType1Store (MapType0Select Heap@0 null (|valid#sm| this@@21)) this@@21 value (bool_2_U true))))) (and (=> (= (ControlFlow 0 4) 2) anon6_Then_correct) (=> (= (ControlFlow 0 4) 3) anon6_Else_correct))))))))
(let ((anon5_Else_correct  (=> (= (MapType0Select Heap@@16 this@@21 next) null) (=> (and (= UnfoldingMask@4 UnfoldingMask@2) (= (ControlFlow 0 7) 4)) anon2_correct))))
...
(let ((anon0_correct  (=> (state Heap@@16 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@16 this@@21 $allocated)) (= AssumeFunctionsAbove 0)) (and (> wildcard@0 NoPerm) (= Mask@0 (MapType1Store ZeroMask null (valid this@@21) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid this@@21))) wildcard@0)))))) (and (and (state Heap@@16 Mask@0) (state Heap@@16 Mask@0)) (and (|valid#trigger| Heap@@16 (valid this@@21)) (= (MapType0Select Heap@@16 null (valid this@@21)) (CombineFrames (FrameFragment (MapType0Select Heap@@16 this@@21 next)) (CombineFrames (FrameFragment (MapType0Select Heap@@16 this@@21 value)) (FrameFragment (ite (not (= (MapType0Select Heap@@16 this@@21 next) null)) (MapType0Select Heap@@16 null (valid (MapType0Select Heap@@16 this@@21 next))) EmptyFrame)))))))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (> (U_2_real (MapType1Select Mask@0 null (valid this@@21))) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@0 null (valid this@@21))) NoPerm) (=> (> wildcard@1 NoPerm) (=> (and (< wildcard@1 (U_2_real (MapType1Select Mask@0 null (valid this@@21)))) (= UnfoldingMask@0 (MapType1Store Mask@0 null (valid this@@21) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid this@@21))) wildcard@1))))) (=> (and (and (and (> wildcard@2 NoPerm) (not (= this@@21 null))) (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this@@21 next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this@@21 next)) wildcard@2)))) (state Heap@@16 UnfoldingMask@1))) (and (and (> wildcard@3 NoPerm) (not (= this@@21 null))) (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 this@@21 value (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 this@@21 value)) wildcard@3)))) (state Heap@@16 UnfoldingMask@2)))) (and (=> (= (ControlFlow 0 8) 6) anon5_Then_correct) (=> (= (ControlFlow 0 8) 7) anon5_Else_correct)))))))))))
