...
(assert  (and (= (Ctor MatrixDomainTypeType) 12) (forall ((arg0@@25 T@U) (arg1@@9 Int) (arg2@@3 Int) ) (! (= (type (loc arg0@@25 arg1@@9 arg2@@3)) RefType)
 :qid |funType:loc|
 :pattern ( (loc arg0@@25 arg1@@9 arg2@@3))
))))
(assert (forall ((m_1 T@U) (i1 Int) (i2 Int) (j1 Int) (j2 Int) ) (!  (=> (= (type m_1) MatrixDomainTypeType) (=> (and (>= i1 0) (and (>= i2 0) (and (>= j1 0) (and (>= j2 0) (and (< i1 (width m_1)) (and (< i2 (width m_1)) (and (< j1 (height m_1)) (and (< j2 (height m_1)) (or (not (= i1 i2)) (not (= j1 j2))))))))))) (not (= (loc m_1 i1 j1) (loc m_1 i2 j2)))))
 :qid |stdinbpl.208:15|
 :skolemid |22|
 :pattern ( (loc m_1 i1 j1) (loc m_1 i2 j2))
)))
...
(declare-fun m_1@@0 () T@U)
(declare-fun qpRange2 (T@U) Bool)
(declare-fun invRecv1 (T@U) Int)
(declare-fun invRecv2 (T@U) Int)
(declare-fun Heap@@9 () T@U)
(assert  (and (= (type m_1@@0) MatrixDomainTypeType) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id identity)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((q1_1 Int) (q2_1 Int) (q1_1_1 Int) (q2_1_1 Int) ) (!  (=> (and (and (and (not (= q1_1 q1_1_1)) (not (= q2_1 q2_1_1))) (< NoPerm (ite  (and (>= q2_1 0) (and (< q2_1 (height m_1@@0)) (and (>= q1_1 0) (and (<= (+ (- q2_1 (height m_1@@0)) 1) 0) (and (< q1_1 (width m_1@@0)) (= q2_1 q1_1)))))) FullPerm NoPerm))) (< NoPerm (ite  (and (>= q2_1_1 0) (and (< q2_1_1 (height m_1@@0)) (and (>= q1_1_1 0) (and (<= (+ (- q2_1_1 (height m_1@@0)) 1) 0) (and (< q1_1_1 (width m_1@@0)) (= q2_1_1 q1_1_1)))))) FullPerm NoPerm))) (not (= (loc m_1@@0 q1_1 q2_1) (loc m_1@@0 q1_1_1 q2_1_1))))
 :qid |stdinbpl.244:15|
 :skolemid |23|
))) (=> (forall ((q1_1@@0 Int) (q2_1@@0 Int) (q1_1_1@@0 Int) (q2_1_1@@0 Int) ) (!  (=> (and (and (and (not (= q1_1@@0 q1_1_1@@0)) (not (= q2_1@@0 q2_1_1@@0))) (< NoPerm (ite  (and (>= q2_1@@0 0) (and (< q2_1@@0 (height m_1@@0)) (and (>= q1_1@@0 0) (and (<= (+ (- q2_1@@0 (height m_1@@0)) 1) 0) (and (< q1_1@@0 (width m_1@@0)) (= q2_1@@0 q1_1@@0)))))) FullPerm NoPerm))) (< NoPerm (ite  (and (>= q2_1_1@@0 0) (and (< q2_1_1@@0 (height m_1@@0)) (and (>= q1_1_1@@0 0) (and (<= (+ (- q2_1_1@@0 (height m_1@@0)) 1) 0) (and (< q1_1_1@@0 (width m_1@@0)) (= q2_1_1@@0 q1_1_1@@0)))))) FullPerm NoPerm))) (not (= (loc m_1@@0 q1_1@@0 q2_1@@0) (loc m_1@@0 q1_1_1@@0 q2_1_1@@0))))
 :qid |stdinbpl.244:15|
 :skolemid |23|
)) (=> (forall ((q1_1@@1 Int) (q2_1@@1 Int) ) (!  (=> (< NoPerm (ite  (and (>= q2_1@@1 0) (and (< q2_1@@1 (height m_1@@0)) (and (>= q1_1@@1 0) (and (<= (+ (- q2_1@@1 (height m_1@@0)) 1) 0) (and (< q1_1@@1 (width m_1@@0)) (= q2_1@@1 q1_1@@1)))))) FullPerm NoPerm)) (and (and (qpRange2 (loc m_1@@0 q1_1@@1 q2_1@@1)) (= (invRecv1 (loc m_1@@0 q1_1@@1 q2_1@@1)) q1_1@@1)) (= (invRecv2 (loc m_1@@0 q1_1@@1 q2_1@@1)) q2_1@@1)))
 :qid |stdinbpl.250:22|
 :skolemid |24|
 :pattern ( (loc m_1@@0 q1_1@@1 q2_1@@1))
 :pattern ( (loc m_1@@0 q1_1@@1 q2_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (< NoPerm (ite  (and (>= (invRecv2 o_3) 0) (and (< (invRecv2 o_3) (height m_1@@0)) (and (>= (invRecv1 o_3) 0) (and (<= (+ (- (invRecv2 o_3) (height m_1@@0)) 1) 0) (and (< (invRecv1 o_3) (width m_1@@0)) (= (invRecv2 o_3) (invRecv1 o_3))))))) FullPerm NoPerm)) (qpRange2 o_3)) (= (loc m_1@@0 (invRecv1 o_3) (invRecv2 o_3)) o_3)))
 :qid |stdinbpl.254:22|
 :skolemid |25|
 :pattern ( (invRecv1 o_3) (invRecv2 o_3))
)) (= (ControlFlow 0 3) (- 0 2))) (forall ((q1_1@@2 Int) (q2_1@@2 Int) ) (! (>= (ite  (and (>= q2_1@@2 0) (and (< q2_1@@2 (height m_1@@0)) (and (>= q1_1@@2 0) (and (<= (+ (- q2_1@@2 (height m_1@@0)) 1) 0) (and (< q1_1@@2 (width m_1@@0)) (= q2_1@@2 q1_1@@2)))))) FullPerm NoPerm) NoPerm)
 :qid |stdinbpl.260:15|
 :skolemid |26|
 :pattern ( (loc m_1@@0 q1_1@@2 q2_1@@2))
 :pattern ( (loc m_1@@0 q1_1@@2 q2_1@@2))
))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct)))))
