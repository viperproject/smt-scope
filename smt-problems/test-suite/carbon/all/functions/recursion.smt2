...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon5_correct  (=> (and (= Result@0 (ite (<= n@@9 1) 1 (- (err1 Heap@@19 (- n@@9 1)) n@@9))) (= (ControlFlow 0 4) (- 0 3))) (>= Result@0 0))))
...
(let ((anon0_correct  (=> (and (and (state Heap@@19 ZeroMask) (= AssumeFunctionsAbove 0)) (and (>= n@@9 0) (state Heap@@19 ZeroMask))) (and (=> (= (ControlFlow 0 8) 5) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))
