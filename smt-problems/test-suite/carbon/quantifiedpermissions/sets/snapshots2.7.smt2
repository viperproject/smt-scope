...
(declare-fun |fun#trigger| (T@U T@U T@U Int) Bool)
...
(assert  (and (and (and (and (and (and (= (type xs@@4) (MapType1Type RefType boolType)) (= (type Heap@@13) (MapType0Type RefType))) (= (type QPMask@1) (MapType2Type RefType realType))) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv2 arg0@@45)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@45))
))) (= (type x@@24) RefType)) (forall ((arg0@@46 T@U) ) (! (= (type (invRecv1 arg0@@46)) RefType)
 :qid |funType:invRecv1|
 :pattern ( (invRecv1 arg0@@46))
))))
...
(let ((anon10_Else_correct  (=> (and (|fun#trigger| (FrameFragment (int_2_U (|fun#condqp1| Heap@@13 xs@@4 x@@24 (- n@@4 1)))) xs@@4 x@@24 (- n@@4 1)) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon9_Then_correct  (=> (= n@@4 0) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm QPMask@0 x@@24 f_7)) (=> (HasDirectPerm QPMask@0 x@@24 f_7) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((z_5 T@U) (z_5_1 T@U) ) (!  (=> (and (= (type z_5) RefType) (= (type z_5_1) RefType)) (=> (and (and (and (and (not (= z_5 z_5_1)) (U_2_bool (MapType1Select xs@@4 z_5))) (U_2_bool (MapType1Select xs@@4 z_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_5 z_5_1))))
 :qid |stdinbpl.579:23|
 :skolemid |93|
...
)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((z_5@@1 T@U) ) (!  (=> (and (= (type z_5@@1) RefType) (U_2_bool (MapType1Select xs@@4 z_5@@1))) (>= (U_2_real (MapType2Select QPMask@0 z_5@@1 f_7)) FullPerm))
 :qid |stdinbpl.586:23|
 :skolemid |94|
...
)) (=> (and (and (forall ((z_5@@3 T@U) ) (!  (=> (= (type z_5@@3) RefType) (=> (and (U_2_bool (MapType1Select xs@@4 z_5@@3)) (< NoPerm FullPerm)) (and (qpRange2 z_5@@3) (= (invRecv2 z_5@@3) z_5@@3))))
 :qid |stdinbpl.592:28|
 :skolemid |95|
 :pattern ( (MapType0Select Heap@@13 z_5@@3 f_7))
 :pattern ( (MapType2Select QPMask@1 z_5@@3 f_7))
 :pattern ( (MapType1Select xs@@4 z_5@@3))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType1Select xs@@4 (invRecv2 o_3))) (and (< NoPerm FullPerm) (qpRange2 o_3))) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.596:28|
 :skolemid |96|
 :pattern ( (invRecv2 o_3))
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType1Select xs@@4 (invRecv2 o_3@@0))) (and (< NoPerm FullPerm) (qpRange2 o_3@@0))) (and (= (invRecv2 o_3@@0) o_3@@0) (= (U_2_real (MapType2Select QPMask@1 o_3@@0 f_7)) (- (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType1Select xs@@4 (invRecv2 o_3@@0))) (and (< NoPerm FullPerm) (qpRange2 o_3@@0)))) (= (U_2_real (MapType2Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7))))))
 :qid |stdinbpl.602:28|
 :skolemid |97|
...
)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (U_2_bool (MapType1Select xs@@4 x@@24))) (=> (U_2_bool (MapType1Select xs@@4 x@@24)) (=> (= (ControlFlow 0 3) (- 0 2)) (>= (- n@@4 1) 0)))))))))))
(let ((anon9_Else_correct  (=> (not (= n@@4 0)) (and (=> (= (ControlFlow 0 11) 3) anon10_Then_correct) (=> (= (ControlFlow 0 11) 10) anon10_Else_correct)))))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((z_4 T@U) (z_4_1 T@U) ) (!  (=> (and (= (type z_4) RefType) (= (type z_4_1) RefType)) (=> (and (and (and (and (not (= z_4 z_4_1)) (U_2_bool (MapType1Select xs@@4 z_4))) (U_2_bool (MapType1Select xs@@4 z_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_4 z_4_1))))
 :qid |stdinbpl.523:15|
 :skolemid |87|
 :no-pattern (type z_4)
...
))) (=> (forall ((z_4@@0 T@U) (z_4_1@@0 T@U) ) (!  (=> (and (= (type z_4@@0) RefType) (= (type z_4_1@@0) RefType)) (=> (and (and (and (and (not (= z_4@@0 z_4_1@@0)) (U_2_bool (MapType1Select xs@@4 z_4@@0))) (U_2_bool (MapType1Select xs@@4 z_4_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_4@@0 z_4_1@@0))))
 :qid |stdinbpl.523:15|
 :skolemid |87|
...
)) (=> (forall ((z_4@@1 T@U) ) (!  (=> (= (type z_4@@1) RefType) (=> (and (U_2_bool (MapType1Select xs@@4 z_4@@1)) (< NoPerm FullPerm)) (and (qpRange1 z_4@@1) (= (invRecv1 z_4@@1) z_4@@1))))
 :qid |stdinbpl.529:22|
 :skolemid |88|
 :pattern ( (MapType0Select Heap@@13 z_4@@1 f_7))
 :pattern ( (MapType2Select QPMask@0 z_4@@1 f_7))
 :pattern ( (MapType1Select xs@@4 z_4@@1))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType1Select xs@@4 (invRecv1 o_3@@2))) (< NoPerm FullPerm)) (qpRange1 o_3@@2)) (= (invRecv1 o_3@@2) o_3@@2)))
 :qid |stdinbpl.533:22|
 :skolemid |89|
 :pattern ( (invRecv1 o_3@@2))
)) (forall ((z_4@@2 T@U) ) (!  (=> (and (= (type z_4@@2) RefType) (U_2_bool (MapType1Select xs@@4 z_4@@2))) (not (= z_4@@2 null)))
 :qid |stdinbpl.539:22|
 :skolemid |90|
 :pattern ( (MapType0Select Heap@@13 z_4@@2 f_7))
 :pattern ( (MapType2Select QPMask@0 z_4@@2 f_7))
 :pattern ( (MapType1Select xs@@4 z_4@@2))
))) (=> (and (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType1Select xs@@4 (invRecv1 o_3@@3))) (< NoPerm FullPerm)) (qpRange1 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@3) o_3@@3)) (= (U_2_real (MapType2Select QPMask@0 o_3@@3 f_7)) (+ (U_2_real (MapType2Select ZeroMask o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType1Select xs@@4 (invRecv1 o_3@@3))) (< NoPerm FullPerm)) (qpRange1 o_3@@3))) (= (U_2_real (MapType2Select QPMask@0 o_3@@3 f_7)) (U_2_real (MapType2Select ZeroMask o_3@@3 f_7))))))
 :qid |stdinbpl.545:22|
 :skolemid |91|
...
))) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0))) (and (and (U_2_bool (MapType1Select xs@@4 x@@24)) (state Heap@@13 QPMask@0)) (and (>= n@@4 0) (state Heap@@13 QPMask@0)))) (and (=> (= (ControlFlow 0 12) 8) anon9_Then_correct) (=> (= (ControlFlow 0 12) 11) anon9_Else_correct)))))))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@13 x@@24 $allocated)) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 14) 1) anon8_Then_correct) (=> (= (ControlFlow 0 14) 12) anon8_Else_correct))))))
