...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type diz) RefType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type ExhaleHeap@1) (MapType0Type RefType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id History__single)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 26) (let ((anon10_correct  (=> (and (= Mask@6 (MapType1Store Mask@5 diz History__x (real_2_U (- (U_2_real (MapType1Select Mask@5 diz History__x)) FullPerm)))) (= (ControlFlow 0 5) (- 0 4))) (= (U_2_int (MapType0Select Heap@0 diz History__x)) (+ (U_2_int (MapType0Select Heap@@9 diz History__x)) n)))))
(let ((anon15_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon10_correct)))
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@5 diz History__x)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@5 diz History__x))) (=> (= (ControlFlow 0 6) 5) anon10_correct))))))
(let ((anon8_correct  (=> (state Heap@0 Mask@5) (and (=> (= (ControlFlow 0 9) 6) anon15_Then_correct) (=> (= (ControlFlow 0 9) 8) anon15_Else_correct)))))
(let ((anon7_correct  (=> (= Mask@3 (MapType1Store Mask@2 diz History__x (real_2_U (- (U_2_real (MapType1Select Mask@2 diz History__x)) FullPerm)))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (>= arg_n@0 0)) (=> (>= arg_n@0 0) (=> (and (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@1 Mask@3) (not (= diz null))) (=> (and (and (and (= Mask@4 (MapType1Store Mask@3 diz History__x (real_2_U (+ (U_2_real (MapType1Select Mask@3 diz History__x)) FullPerm)))) (state ExhaleHeap@1 Mask@4)) (and (= (U_2_int (MapType0Select ExhaleHeap@1 diz History__x)) (+ (U_2_int (MapType0Select ExhaleHeap@0 diz History__x)) arg_n@0)) (state ExhaleHeap@1 Mask@4))) (and (and (state ExhaleHeap@1 Mask@4) (= Mask@5 Mask@4)) (and (= Heap@0 ExhaleHeap@1) (= (ControlFlow 0 11) 9)))) anon8_correct)))))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 15) 11)) anon7_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= FullPerm (U_2_real (MapType1Select Mask@2 diz History__x)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 diz History__x))) (=> (= (ControlFlow 0 13) 11) anon7_correct))))))
(let ((anon5_correct  (=> (= Mask@1 (MapType1Store Mask@0 diz History__x (real_2_U (- (U_2_real (MapType1Select Mask@0 diz History__x)) FullPerm)))) (=> (and (and (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@1) (not (= diz null))) (and (= Mask@2 (MapType1Store Mask@1 diz History__x (real_2_U (+ (U_2_real (MapType1Select Mask@1 diz History__x)) FullPerm)))) (state ExhaleHeap@0 Mask@2))) (and (and (= (U_2_int (MapType0Select ExhaleHeap@0 diz History__x)) (+ (U_2_int (MapType0Select Heap@@9 diz History__x)) 1)) (state ExhaleHeap@0 Mask@2)) (and (state ExhaleHeap@0 Mask@2) (= arg_n@0 (- n 1))))) (and (=> (= (ControlFlow 0 16) (- 0 18)) (not (= diz null))) (=> (not (= diz null)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (and (=> (= (ControlFlow 0 16) 13) anon14_Then_correct) (=> (= (ControlFlow 0 16) 15) anon14_Else_correct))))))))))
(let ((anon13_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 21) 16)) anon5_correct)))
(let ((anon13_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (<= FullPerm (U_2_real (MapType1Select Mask@0 diz History__x)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 diz History__x))) (=> (= (ControlFlow 0 19) 16) anon5_correct))))))
...
(let ((anon12_Else_correct  (=> (and (and (>= 0 n) (= Mask@5 Mask@0)) (and (= Heap@0 Heap@@9) (= (ControlFlow 0 10) 9))) anon8_correct)))
(let ((anon11_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (not (= diz null)) (= PostMask@0 (MapType1Store ZeroMask diz History__x (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz History__x)) FullPerm))))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm PostMask@0 diz History__x)) (=> (HasDirectPerm PostMask@0 diz History__x) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@0 diz History__x))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 diz $allocated))) (and (not (= diz null)) (state Heap@@9 ZeroMask))) (=> (and (and (and (>= current_thread_id 0) (state Heap@@9 ZeroMask)) (and (not (= diz null)) (= Mask@0 (MapType1Store ZeroMask diz History__x (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz History__x)) FullPerm)))))) (and (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (>= n 0) (state Heap@@9 Mask@0)))) (and (and (=> (= (ControlFlow 0 25) 2) anon11_Then_correct) (=> (= (ControlFlow 0 25) 22) anon12_Then_correct)) (=> (= (ControlFlow 0 25) 10) anon12_Else_correct))))))
