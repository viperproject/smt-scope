...
(assert  (and (and (and (and (and (and (and (and (= (type Heap@0) (MapType0Type RefType)) (= (type x@@35) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@4) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@2) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@3) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@0) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@1) (MapType1Type RefType realType))) (= (type Heap@@23) (MapType0Type RefType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon11_correct true))
(let ((anon10_correct  (=> (= ExhaleWellDef0Mask@3 (MapType1Store ExhaleWellDef0Mask@2 x@@35 v_2 (real_2_U (- (U_2_real (MapType1Select ExhaleWellDef0Mask@2 x@@35 v_2)) perm@2)))) (=> (and (= ExhaleWellDef0Mask@4 ExhaleWellDef0Mask@3) (= (ControlFlow 0 6) 4)) anon11_correct))))
(let ((anon18_Else_correct  (=> (and (= perm@2 NoPerm) (= (ControlFlow 0 9) 6)) anon10_correct)))
(let ((anon18_Then_correct  (=> (not (= perm@2 NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= perm@2 (U_2_real (MapType1Select ExhaleWellDef0Mask@2 x@@35 v_2)))) (=> (<= perm@2 (U_2_real (MapType1Select ExhaleWellDef0Mask@2 x@@35 v_2))) (=> (= (ControlFlow 0 7) 6) anon10_correct))))))
(let ((anon17_Then_correct  (=> (and b1@@3 (= perm@2 (/ (to_real 1) (to_real 3)))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (and (=> (= (ControlFlow 0 10) 7) anon18_Then_correct) (=> (= (ControlFlow 0 10) 9) anon18_Else_correct)))))))
(let ((anon17_Else_correct  (=> (not b1@@3) (=> (and (= ExhaleWellDef0Mask@4 ExhaleWellDef0Mask@2) (= (ControlFlow 0 5) 4)) anon11_correct))))
(let ((anon6_correct  (=> (and (= ExhaleWellDef0Mask@1 (MapType1Store ExhaleWellDef0Mask@0 x@@35 v_2 (real_2_U (- (U_2_real (MapType1Select ExhaleWellDef0Mask@0 x@@35 v_2)) perm@1)))) (= ExhaleWellDef0Mask@2 ExhaleWellDef0Mask@1)) (and (=> (= (ControlFlow 0 13) 10) anon17_Then_correct) (=> (= (ControlFlow 0 13) 5) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (= perm@1 NoPerm) (= (ControlFlow 0 16) 13)) anon6_correct)))
(let ((anon16_Then_correct  (=> (not (= perm@1 NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= perm@1 (U_2_real (MapType1Select ExhaleWellDef0Mask@0 x@@35 v_2)))) (=> (<= perm@1 (U_2_real (MapType1Select ExhaleWellDef0Mask@0 x@@35 v_2))) (=> (= (ControlFlow 0 14) 13) anon6_correct))))))
(let ((anon15_Then_correct  (=> (and b2@@5 (= perm@1 (/ (to_real 1) (to_real 3)))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (and (=> (= (ControlFlow 0 17) 14) anon16_Then_correct) (=> (= (ControlFlow 0 17) 16) anon16_Else_correct)))))))
(let ((anon15_Else_correct  (=> (and (not b2@@5) (= ExhaleWellDef0Mask@2 ExhaleWellDef0Mask@0)) (and (=> (= (ControlFlow 0 12) 10) anon17_Then_correct) (=> (= (ControlFlow 0 12) 5) anon17_Else_correct)))))
(let ((anon3_correct  (=> (= ExhaleWellDef0Mask@0 (MapType1Store Mask@0 x@@35 v_2 (real_2_U (- (U_2_real (MapType1Select Mask@0 x@@35 v_2)) perm@0)))) (and (=> (= (ControlFlow 0 19) 17) anon15_Then_correct) (=> (= (ControlFlow 0 19) 12) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 22) 19)) anon3_correct)))
(let ((anon14_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (<= perm@0 (U_2_real (MapType1Select Mask@0 x@@35 v_2)))) (=> (<= perm@0 (U_2_real (MapType1Select Mask@0 x@@35 v_2))) (=> (= (ControlFlow 0 20) 19) anon3_correct))))))
(let ((anon13_Then_correct  (=> (= perm@0 (/ (to_real 1) (to_real 3))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 23) 20) anon14_Then_correct) (=> (= (ControlFlow 0 23) 22) anon14_Else_correct)))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (fun01 Heap@0 x@@35 b2@@5 b1@@3) 4)) (=> (= (fun01 Heap@0 x@@35 b2@@5 b1@@3) 4) (=> (and (state Heap@0 Mask@0) (= (ControlFlow 0 2) (- 0 1))) false)))))
(let ((anon0_correct  (=> (state Heap@@23 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@23 x@@35 $allocated))) (=> (and (and (not (= x@@35 null)) (= Mask@0 (MapType1Store ZeroMask x@@35 v_2 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@35 v_2)) FullPerm))))) (and (state Heap@@23 Mask@0) (state Heap@@23 Mask@0))) (and (=> (= (ControlFlow 0 25) (- 0 26)) (= FullPerm (U_2_real (MapType1Select Mask@0 x@@35 v_2)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 x@@35 v_2))) (=> (and (= Heap@0 (MapType0Store Heap@@23 x@@35 v_2 (int_2_U 4))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 25) 23) anon13_Then_correct) (=> (= (ControlFlow 0 25) 2) anon13_Else_correct))))))))))
