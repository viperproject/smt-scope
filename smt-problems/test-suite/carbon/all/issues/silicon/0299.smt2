...
(assert (forall ((Heap@@2 T@U) (x@@8 Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (bool_2_U (|dummy#triggerStateless| x@@8))))
 :qid |stdinbpl.611:15|
 :skolemid |61|
 :pattern ( (|dummy'| Heap@@2 x@@8))
)))
...
(assert (forall ((Heap@@4 T@U) (Mask@@3 T@U) (x@@11 Int) ) (!  (=> (and (and (= (type Heap@@4) (MapType0Type RefType)) (= (type Mask@@3) (MapType1Type RefType realType))) (and (state Heap@@4 Mask@@3) (< AssumeFunctionsAbove 0))) (dummy Heap@@4 x@@11))
 :qid |stdinbpl.617:15|
 :skolemid |62|
 :pattern ( (state Heap@@4 Mask@@3) (dummy Heap@@4 x@@11))
)))
...
)) (forall ((arg0@@36 T@U) ) (! (= (type (first arg0@@36)) ArrayDomainTypeType)
 :qid |funType:first|
...
(assert (forall ((Heap@@7 T@U) (Mask@@7 T@U) (x@@12 Int) ) (!  (=> (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (state Heap@@7 Mask@@7)) (= (|dummy'| Heap@@7 x@@12) (|dummy#frame| EmptyFrame x@@12)))
 :qid |stdinbpl.624:15|
 :skolemid |63|
 :pattern ( (state Heap@@7 Mask@@7) (|dummy'| Heap@@7 x@@12))
)))
...
(assert (forall ((Heap@@8 T@U) (x@@13 Int) ) (!  (=> (= (type Heap@@8) (MapType0Type RefType)) (and (= (dummy Heap@@8 x@@13) (|dummy'| Heap@@8 x@@13)) (dummyFunction (bool_2_U (|dummy#triggerStateless| x@@13)))))
 :qid |stdinbpl.607:15|
 :skolemid |60|
 :pattern ( (dummy Heap@@8 x@@13))
)))
...
(assert (forall ((s@@14 T@U) (x@@14 T@U) (i@@5 Int) ) (! (let ((T@@30 (type x@@14)))
 (=> (= (type s@@14) (SeqType T@@30)) (=> (and (and (<= 0 i@@5) (< i@@5 (|Seq#Length| s@@14))) (= (|Seq#Index| s@@14 i@@5) x@@14)) (|Seq#Contains| s@@14 x@@14))))
 :qid |stdinbpl.416:18|
 :skolemid |48|
...
(assert  (and (and (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type a_3@@1) ArrayDomainTypeType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id quicksort_rec)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon8_correct true))
(let ((anon19_Else_correct  (=> (and (not (and (<= lo i$0) (and (<= i$0 j@@5) (<= j@@5 hi)))) (= (ControlFlow 0 16) 12)) anon8_correct)))
(let ((anon19_Then_correct  (=> (and (<= lo i$0) (and (<= i$0 j@@5) (<= j@@5 hi))) (and (=> (= (ControlFlow 0 13) (- 0 15)) (HasDirectPerm QPMask@2 (loc a_3@@1 i$0) val)) (=> (HasDirectPerm QPMask@2 (loc a_3@@1 i$0) val) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm QPMask@2 (loc a_3@@1 j@@5) val)) (=> (HasDirectPerm QPMask@2 (loc a_3@@1 j@@5) val) (=> (= (ControlFlow 0 13) 12) anon8_correct))))))))
(let ((anon18_Else_correct true))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= lo i_3) (<= i_3 hi))) (and (<= lo i_3_1) (<= i_3_1 hi))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_3) (loc a_3@@1 i_3_1))))
 :qid |stdinbpl.735:15|
 :skolemid |70|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (and (<= lo i_3@@0) (<= i_3@@0 hi))) (and (<= lo i_3_1@@0) (<= i_3_1@@0 hi))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_3@@0) (loc a_3@@1 i_3_1@@0))))
 :qid |stdinbpl.735:15|
 :skolemid |70|
)) (=> (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= lo i_3@@1) (<= i_3@@1 hi)) (< NoPerm FullPerm)) (and (qpRange2 (loc a_3@@1 i_3@@1)) (= (invRecv2 (loc a_3@@1 i_3@@1)) i_3@@1)))
 :qid |stdinbpl.741:22|
 :skolemid |71|
 :pattern ( (loc a_3@@1 i_3@@1))
 :pattern ( (MapType0Select PostHeap@0 (loc a_3@@1 i_3@@1) val))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= lo (invRecv2 o_3)) (<= (invRecv2 o_3) hi)) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (loc a_3@@1 (invRecv2 o_3)) o_3)))
 :qid |stdinbpl.745:22|
 :skolemid |72|
 :pattern ( (invRecv2 o_3))
)) (forall ((i_3@@2 Int) ) (!  (=> (and (<= lo i_3@@2) (<= i_3@@2 hi)) (not (= (loc a_3@@1 i_3@@2) null)))
 :qid |stdinbpl.751:22|
 :skolemid |73|
 :pattern ( (loc a_3@@1 i_3@@2))
 :pattern ( (MapType0Select PostHeap@0 (loc a_3@@1 i_3@@2) val))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= lo (invRecv2 o_3@@0)) (<= (invRecv2 o_3@@0) hi)) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@1 (invRecv2 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (and (and (<= lo (invRecv2 o_3@@0)) (<= (invRecv2 o_3@@0) hi)) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.757:22|
 :skolemid |74|
...
(let ((anon21_Else_correct  (=> (and (not (and (<= lo i$0_2) (and (<= i$0_2 j_2) (<= j_2 hi)))) (= (ControlFlow 0 6) 3)) anon13_correct)))
(let ((anon21_Then_correct  (=> (and (<= lo i$0_2) (and (<= i$0_2 j_2) (<= j_2 hi))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= (U_2_int (MapType0Select Heap@@13 (loc a_3@@1 i$0_2) val)) (U_2_int (MapType0Select Heap@@13 (loc a_3@@1 j_2) val)))) (=> (<= (U_2_int (MapType0Select Heap@@13 (loc a_3@@1 i$0_2) val)) (U_2_int (MapType0Select Heap@@13 (loc a_3@@1 j_2) val))) (=> (= (ControlFlow 0 4) 3) anon13_correct))))))
(let ((anon20_Else_correct true))
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((i_4 Int) (i_4_1 Int) ) (!  (=> (and (and (and (and (not (= i_4 i_4_1)) (and (<= lo i_4) (<= i_4 hi))) (and (<= lo i_4_1) (<= i_4_1 hi))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_4) (loc a_3@@1 i_4_1))))
 :qid |stdinbpl.798:17|
 :skolemid |77|
 :pattern ( (neverTriggered3 i_4) (neverTriggered3 i_4_1))
))) (=> (forall ((i_4@@0 Int) (i_4_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_4@@0 i_4_1@@0)) (and (<= lo i_4@@0) (<= i_4@@0 hi))) (and (<= lo i_4_1@@0) (<= i_4_1@@0 hi))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_4@@0) (loc a_3@@1 i_4_1@@0))))
 :qid |stdinbpl.798:17|
 :skolemid |77|
 :pattern ( (neverTriggered3 i_4@@0) (neverTriggered3 i_4_1@@0))
)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((i_4@@1 Int) ) (!  (=> (and (<= lo i_4@@1) (<= i_4@@1 hi)) (>= (U_2_real (MapType1Select QPMask@0 (loc a_3@@1 i_4@@1) val)) FullPerm))
 :qid |stdinbpl.805:17|
 :skolemid |78|
 :pattern ( (loc a_3@@1 i_4@@1))
 :pattern ( (MapType0Select Heap@@13 (loc a_3@@1 i_4@@1) val))
))) (=> (forall ((i_4@@2 Int) ) (!  (=> (and (<= lo i_4@@2) (<= i_4@@2 hi)) (>= (U_2_real (MapType1Select QPMask@0 (loc a_3@@1 i_4@@2) val)) FullPerm))
 :qid |stdinbpl.805:17|
 :skolemid |78|
 :pattern ( (loc a_3@@1 i_4@@2))
 :pattern ( (MapType0Select Heap@@13 (loc a_3@@1 i_4@@2) val))
)) (=> (and (and (forall ((i_4@@3 Int) ) (!  (=> (and (and (<= lo i_4@@3) (<= i_4@@3 hi)) (< NoPerm FullPerm)) (and (qpRange3 (loc a_3@@1 i_4@@3)) (= (invRecv3 (loc a_3@@1 i_4@@3)) i_4@@3)))
 :qid |stdinbpl.811:22|
 :skolemid |79|
 :pattern ( (loc a_3@@1 i_4@@3))
 :pattern ( (MapType0Select Heap@@13 (loc a_3@@1 i_4@@3) val))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (<= lo (invRecv3 o_3@@2)) (<= (invRecv3 o_3@@2) hi)) (and (< NoPerm FullPerm) (qpRange3 o_3@@2))) (= (loc a_3@@1 (invRecv3 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.815:22|
 :skolemid |80|
 :pattern ( (invRecv3 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (<= lo (invRecv3 o_3@@3)) (<= (invRecv3 o_3@@3) hi)) (and (< NoPerm FullPerm) (qpRange3 o_3@@3))) (and (= (loc a_3@@1 (invRecv3 o_3@@3)) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 val)) (- (U_2_real (MapType1Select QPMask@0 o_3@@3 val)) FullPerm)))) (=> (not (and (and (<= lo (invRecv3 o_3@@3)) (<= (invRecv3 o_3@@3) hi)) (and (< NoPerm FullPerm) (qpRange3 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 val)) (U_2_real (MapType1Select QPMask@0 o_3@@3 val))))))
 :qid |stdinbpl.821:22|
 :skolemid |81|
...
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= lo i_1) (<= i_1 hi))) (and (<= lo i_1_1) (<= i_1_1 hi))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_1) (loc a_3@@1 i_1_1))))
 :qid |stdinbpl.684:15|
 :skolemid |64|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= lo i_1@@0) (<= i_1@@0 hi))) (and (<= lo i_1_1@@0) (<= i_1_1@@0 hi))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_1@@0) (loc a_3@@1 i_1_1@@0))))
 :qid |stdinbpl.684:15|
 :skolemid |64|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= lo i_1@@1) (<= i_1@@1 hi)) (< NoPerm FullPerm)) (and (qpRange1 (loc a_3@@1 i_1@@1)) (= (invRecv1 (loc a_3@@1 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.690:22|
 :skolemid |65|
 :pattern ( (loc a_3@@1 i_1@@1))
 :pattern ( (MapType0Select Heap@@13 (loc a_3@@1 i_1@@1) val))
)) (=> (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (and (<= lo (invRecv1 o_3@@5)) (<= (invRecv1 o_3@@5) hi)) (< NoPerm FullPerm)) (qpRange1 o_3@@5)) (= (loc a_3@@1 (invRecv1 o_3@@5)) o_3@@5)))
 :qid |stdinbpl.694:22|
 :skolemid |66|
 :pattern ( (invRecv1 o_3@@5))
)) (forall ((i_1@@2 Int) ) (!  (=> (and (<= lo i_1@@2) (<= i_1@@2 hi)) (not (= (loc a_3@@1 i_1@@2) null)))
 :qid |stdinbpl.700:22|
 :skolemid |67|
 :pattern ( (loc a_3@@1 i_1@@2))
 :pattern ( (MapType0Select Heap@@13 (loc a_3@@1 i_1@@2) val))
))) (=> (and (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (and (<= lo (invRecv1 o_3@@6)) (<= (invRecv1 o_3@@6) hi)) (< NoPerm FullPerm)) (qpRange1 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@1 (invRecv1 o_3@@6)) o_3@@6)) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@6 val)) FullPerm)))) (=> (not (and (and (and (<= lo (invRecv1 o_3@@6)) (<= (invRecv1 o_3@@6) hi)) (< NoPerm FullPerm)) (qpRange1 o_3@@6))) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 val)) (U_2_real (MapType1Select ZeroMask o_3@@6 val))))))
 :qid |stdinbpl.706:22|
 :skolemid |68|
...
))) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0))) (and (=> (= (ControlFlow 0 20) 19) anon16_Then_correct) (=> (= (ControlFlow 0 20) 7) anon16_Else_correct)))))))))
(let ((anon15_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (>= lo 0) (state Heap@@13 ZeroMask))) (and (=> (= (ControlFlow 0 22) 1) anon15_Then_correct) (=> (= (ControlFlow 0 22) 20) anon15_Else_correct)))))
