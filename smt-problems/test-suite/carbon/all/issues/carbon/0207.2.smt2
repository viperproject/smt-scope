...
(set-info :boogie-vc-id swap02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon20_Else_correct  (=> (= (ControlFlow 0 16) (- 0 15)) (|Set#Equal| (elements Heap@1 a_3@@1) (elements Heap@@13 a_3@@1)))))
(let ((anon20_Then_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((i_4 Int) (i_4_1 Int) ) (!  (=> (and (and (and (and (not (= i_4 i_4_1)) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_4))) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_4) (loc a_3@@1 i_4_1))))
 :qid |stdinbpl.1625:21|
 :skolemid |191|
 :pattern ( (neverTriggered11 i_4) (neverTriggered11 i_4_1))
 ...
 :qid |stdinbpl.1625:21|
 :skolemid |191|
 :pattern ( (neverTriggered11 i_4@@0) (neverTriggered11 i_4_1@@0))
...
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) true) (and (=> (= (ControlFlow 0 17) 13) anon20_Then_correct) (=> (= (ControlFlow 0 17) 16) anon20_Else_correct)))))
(let ((anon19_Then_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_3))) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_3) (loc a_3@@1 i_3_1))))
 :qid |stdinbpl.1571:21|
 :skolemid |185|
 :pattern ( (neverTriggered10 i_3) (neverTriggered10 i_3_1))
 ...
 :qid |stdinbpl.1571:21|
 :skolemid |185|
 :pattern ( (neverTriggered10 i_3@@0) (neverTriggered10 i_3_1@@0))
...
(let ((anon15_Else_correct  (=> (forall ((e_1 T@U) ) (!  (=> (and (= (type e_1) intType) (U_2_bool (MapType2Select (elements Heap@@13 a_3@@1) e_1))) (exists ((j_1 Int) ) (! (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U j_1))
 :qid |stdinbpl.1523:44|
 :skolemid |183|
...
)) (=> (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)) (and (=> (= (ControlFlow 0 19) (- 0 23)) (HasDirectPerm QPMask@0 (loc a_3@@1 x@@22) val)) (=> (HasDirectPerm QPMask@0 (loc a_3@@1 x@@22) val) (=> (and (= tmp@0 (U_2_int (MapType0Select Heap@@13 (loc a_3@@1 x@@22) val))) (state Heap@@13 QPMask@0)) (and (=> (= (ControlFlow 0 19) (- 0 22)) (HasDirectPerm QPMask@0 (loc a_3@@1 y@@7) val)) (=> (HasDirectPerm QPMask@0 (loc a_3@@1 y@@7) val) (and (=> (= (ControlFlow 0 19) (- 0 21)) (= FullPerm (U_2_real (MapType1Select QPMask@0 (loc a_3@@1 x@@22) val)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 (loc a_3@@1 x@@22) val))) (=> (and (= Heap@0 (MapType0Store Heap@@13 (loc a_3@@1 x@@22) val (MapType0Select Heap@@13 (loc a_3@@1 y@@7) val))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (= FullPerm (U_2_real (MapType1Select QPMask@0 (loc a_3@@1 y@@7) val)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 (loc a_3@@1 y@@7) val))) (=> (and (= Heap@1 (MapType0Store Heap@0 (loc a_3@@1 y@@7) val (int_2_U tmp@0))) (state Heap@1 QPMask@0)) (and (=> (= (ControlFlow 0 19) 10) anon19_Then_correct) (=> (= (ControlFlow 0 19) 17) anon19_Else_correct)))))))))))))))))
(let ((anon18_Then_correct true))
(let ((anon8_correct true))
(let ((anon17_Then_correct  (=> (U_2_bool (MapType2Select (elements Heap@@13 a_3@@1) (int_2_U e_2))) (and (=> (= (ControlFlow 0 8) 7) anon18_Then_correct) (=> (= (ControlFlow 0 8) 5) anon8_correct)))))
(let ((anon17_Else_correct  (=> (and (not (U_2_bool (MapType2Select (elements Heap@@13 a_3@@1) (int_2_U e_2)))) (= (ControlFlow 0 6) 5)) anon8_correct)))
(let ((anon16_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((i_2@@0 Int) (i_2_1 Int) ) (!  (=> (and (and (and (and (not (= i_2@@0 i_2_1)) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_2@@0))) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_2@@0) (loc a_3@@1 i_2_1))))
 :qid |stdinbpl.1473:23|
 :skolemid |177|
 :pattern ( (neverTriggered9 i_2@@0) (neverTriggered9 i_2_1))
 ...
 :qid |stdinbpl.1473:23|
 :skolemid |177|
 :pattern ( (neverTriggered9 i_2@@1) (neverTriggered9 i_2_1@@0))
...
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 24) (- 0 25)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_1) (loc a_3@@1 i_1_1))))
 ...
 :qid |stdinbpl.1395:15|
 :skolemid |171|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_1@@1)) (< NoPerm FullPerm)) (and (qpRange8 (loc a_3@@1 i_1@@1)) (= (invRecv8 (loc a_3@@1 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.1401:22|
 :skolemid |172|
 :pattern ( (loc a_3@@1 i_1@@1))
 :pattern ( (MapType0Select Heap@@13 (loc a_3@@1 i_1@@1) val))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_1@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_1@@1)))
)) (=> (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U (invRecv8 o_3))) (< NoPerm FullPerm)) (qpRange8 o_3)) (= (loc a_3@@1 (invRecv8 o_3)) o_3)))
 ...
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_1@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_1@@2)))
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U (invRecv8 o_3@@0))) (< NoPerm FullPerm)) (qpRange8 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@1 (invRecv8 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U (invRecv8 o_3@@0))) (< NoPerm FullPerm)) (qpRange8 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
...
)))) (=> (and (and (and (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)) (and (state Heap@@13 QPMask@0) (<= 0 x@@22))) (and (and (< x@@22 (length a_3@@1)) (state Heap@@13 QPMask@0)) (and (state Heap@@13 QPMask@0) (<= 0 y@@7)))) (and (and (and (< y@@7 (length a_3@@1)) (state Heap@@13 QPMask@0)) (and (state Heap@@13 QPMask@0) (< x@@22 y@@7))) (and (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0))))) (and (and (and (=> (= (ControlFlow 0 24) 19) anon15_Else_correct) (=> (= (ControlFlow 0 24) 3) anon16_Then_correct)) (=> (= (ControlFlow 0 24) 8) anon17_Then_correct)) (=> (= (ControlFlow 0 24) 6) anon17_Else_correct)))))))))
(let ((anon14_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 26) 1) anon14_Then_correct) (=> (= (ControlFlow 0 26) 24) anon14_Else_correct)))))
