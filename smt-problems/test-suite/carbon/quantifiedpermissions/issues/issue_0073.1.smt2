...
(assert  (and (and (and (= (type s@@17) (SeqType RefType)) (= (type PostHeap@0) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id n1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 38) (let ((anon12_correct true))
(let ((anon21_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i3))) (= (ControlFlow 0 25) 21)) anon12_correct)))
(let ((anon21_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i3)) (and (=> (= (ControlFlow 0 22) (- 0 24)) (>= i3 0)) (=> (>= i3 0) (and (=> (= (ControlFlow 0 22) (- 0 23)) (< i3 (|Seq#Length| s@@17))) (=> (< i3 (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 22) 21) anon12_correct))))))))
(let ((anon20_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((i3_1 Int) (i3_1_1 Int) ) (!  (=> (and (and (and (and (not (= i3_1 i3_1_1)) (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i3_1))) (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i3_1_1))) (< NoPerm (/ (to_real 25) (to_real 100)))) (< NoPerm (/ (to_real 25) (to_real 100)))) (not (= (|Seq#Index| s@@17 i3_1) (|Seq#Index| s@@17 i3_1_1))))
 :qid |stdinbpl.1029:15|
 :skolemid |88|
))) (=> (forall ((i3_1@@0 Int) (i3_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i3_1@@0 i3_1_1@@0)) (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i3_1@@0))) (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i3_1_1@@0))) (< NoPerm (/ (to_real 25) (to_real 100)))) (< NoPerm (/ (to_real 25) (to_real 100)))) (not (= (|Seq#Index| s@@17 i3_1@@0) (|Seq#Index| s@@17 i3_1_1@@0))))
 :qid |stdinbpl.1029:15|
 :skolemid |88|
)) (=> (forall ((i3_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i3_1@@1)) (< NoPerm (/ (to_real 25) (to_real 100)))) (and (qpRange5 (|Seq#Index| s@@17 i3_1@@1)) (= (invRecv5 (|Seq#Index| s@@17 i3_1@@1)) i3_1@@1)))
 :qid |stdinbpl.1035:22|
 :skolemid |89|
 :pattern ( (|Seq#Index| s@@17 i3_1@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 4) (int_2_U i3_1@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i3_1@@1)))
 :pattern ( (|Seq#Index| s@@17 i3_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U (invRecv5 o_3))) (< NoPerm (/ (to_real 25) (to_real 100)))) (qpRange5 o_3)) (= (|Seq#Index| s@@17 (invRecv5 o_3)) o_3)))
 :qid |stdinbpl.1039:22|
 :skolemid |90|
 :pattern ( (invRecv5 o_3))
)) (= (ControlFlow 0 19) (- 0 18))) (forall ((i3_1@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i3_1@@2)) (>= (/ (to_real 25) (to_real 100)) NoPerm))
 :qid |stdinbpl.1045:15|
 :skolemid |91|
 :pattern ( (|Seq#Index| s@@17 i3_1@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 4) (int_2_U i3_1@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i3_1@@2)))
 :pattern ( (|Seq#Index| s@@17 i3_1@@2))
))))))))
...
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 27) (- 0 29)) (forall ((i2_3 Int) (i2_3_1 Int) ) (!  (=> (and (and (and (and (not (= i2_3 i2_3_1)) (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2_3))) (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2_3_1))) (< NoPerm (/ (to_real 50) (to_real 100)))) (< NoPerm (/ (to_real 50) (to_real 100)))) (not (= (|Seq#Index| s@@17 i2_3) (|Seq#Index| s@@17 i2_3_1))))
 :qid |stdinbpl.966:15|
 :skolemid |81|
))) (=> (forall ((i2_3@@0 Int) (i2_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i2_3@@0 i2_3_1@@0)) (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2_3@@0))) (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2_3_1@@0))) (< NoPerm (/ (to_real 50) (to_real 100)))) (< NoPerm (/ (to_real 50) (to_real 100)))) (not (= (|Seq#Index| s@@17 i2_3@@0) (|Seq#Index| s@@17 i2_3_1@@0))))
 :qid |stdinbpl.966:15|
 :skolemid |81|
)) (=> (and (forall ((i2_3@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2_3@@1)) (< NoPerm (/ (to_real 50) (to_real 100)))) (and (qpRange4 (|Seq#Index| s@@17 i2_3@@1)) (= (invRecv4 (|Seq#Index| s@@17 i2_3@@1)) i2_3@@1)))
 :qid |stdinbpl.972:22|
 :skolemid |82|
 :pattern ( (|Seq#Index| s@@17 i2_3@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 2) (int_2_U i2_3@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2_3@@1)))
 :pattern ( (|Seq#Index| s@@17 i2_3@@1))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U (invRecv4 o_3@@0))) (< NoPerm (/ (to_real 50) (to_real 100)))) (qpRange4 o_3@@0)) (= (|Seq#Index| s@@17 (invRecv4 o_3@@0)) o_3@@0)))
 :qid |stdinbpl.976:22|
 :skolemid |83|
 :pattern ( (invRecv4 o_3@@0))
))) (and (=> (= (ControlFlow 0 27) (- 0 28)) (forall ((i2_3@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2_3@@2)) (>= (/ (to_real 50) (to_real 100)) NoPerm))
 :qid |stdinbpl.982:15|
 :skolemid |84|
 :pattern ( (|Seq#Index| s@@17 i2_3@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 2) (int_2_U i2_3@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2_3@@2)))
 :pattern ( (|Seq#Index| s@@17 i2_3@@2))
))) (=> (forall ((i2_3@@3 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2_3@@3)) (>= (/ (to_real 50) (to_real 100)) NoPerm))
 :qid |stdinbpl.982:15|
 :skolemid |84|
 :pattern ( (|Seq#Index| s@@17 i2_3@@3))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 2) (int_2_U i2_3@@3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2_3@@3)))
 :pattern ( (|Seq#Index| s@@17 i2_3@@3))
)) (=> (forall ((i2_3@@4 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2_3@@4)) (> (/ (to_real 50) (to_real 100)) NoPerm)) (not (= (|Seq#Index| s@@17 i2_3@@4) null)))
 :qid |stdinbpl.988:22|
 :skolemid |85|
 :pattern ( (|Seq#Index| s@@17 i2_3@@4))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 2) (int_2_U i2_3@@4)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2_3@@4)))
 :pattern ( (|Seq#Index| s@@17 i2_3@@4))
)) (=> (and (and (forall ((o_3@@1 T@U) ) (!  (=> (= (type o_3@@1) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U (invRecv4 o_3@@1))) (< NoPerm (/ (to_real 50) (to_real 100)))) (qpRange4 o_3@@1)) (and (=> (< NoPerm (/ (to_real 50) (to_real 100))) (= (|Seq#Index| s@@17 (invRecv4 o_3@@1)) o_3@@1)) (= (U_2_real (MapType1Select QPMask@0 o_3@@1 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@1 f_7)) (/ (to_real 50) (to_real 100)))))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U (invRecv4 o_3@@1))) (< NoPerm (/ (to_real 50) (to_real 100)))) (qpRange4 o_3@@1))) (= (U_2_real (MapType1Select QPMask@0 o_3@@1 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@1 f_7))))))
 :qid |stdinbpl.994:22|
 :skolemid |86|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 27) 26) anon19_Then_correct) (=> (= (ControlFlow 0 27) 14) anon19_Else_correct)))))))))))
(let ((anon7_correct true))
(let ((anon18_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2_4))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon18_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2_4)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i2_4 0)) (=> (>= i2_4 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i2_4 (|Seq#Length| s@@17))) (=> (< i2_4 (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon15_Else_correct  (=> (and (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i1_1)) (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2_1)) (not (= i1_1 i2_1)))) (not (= (|Seq#Index| s@@17 i1_1) (|Seq#Index| s@@17 i2_1))))
 :qid |stdinbpl.948:20|
 :skolemid |80|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 2) (int_2_U i1_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 2) (int_2_U i2_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 2) (int_2_U i1_1)) (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i1_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 2) (int_2_U i2_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i1_1)) (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 2) (int_2_U i1_1)) (|Seq#Index| s@@17 i2_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i1_1)) (|Seq#Index| s@@17 i2_1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 2) (int_2_U i2_1)) (|Seq#Index| s@@17 i1_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2_1)) (|Seq#Index| s@@17 i1_1))
 :pattern ( (|Seq#Index| s@@17 i1_1) (|Seq#Index| s@@17 i2_1))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 30) 27) anon17_Else_correct) (=> (= (ControlFlow 0 30) 9) anon18_Then_correct)) (=> (= (ControlFlow 0 30) 12) anon18_Else_correct)))))
(let ((anon3_correct true))
(let ((anon16_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i1_4)) (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2_2)) (not (= i1_4 i2_2))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon16_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i1_4)) (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2_2)) (not (= i1_4 i2_2)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_4 0)) (=> (>= i1_4 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_4 (|Seq#Length| s@@17))) (=> (< i1_4 (|Seq#Length| s@@17)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_2 0)) (=> (>= i2_2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_2 (|Seq#Length| s@@17))) (=> (< i2_2 (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (> (|Seq#Length| s@@17) 4) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 31) (- 0 37)) (< 0 (|Seq#Length| s@@17))) (=> (< 0 (|Seq#Length| s@@17)) (and (=> (= (ControlFlow 0 31) (- 0 36)) (< 1 (|Seq#Length| s@@17))) (=> (< 1 (|Seq#Length| s@@17)) (=> (= (|Seq#Index| s@@17 0) (|Seq#Index| s@@17 1)) (and (=> (= (ControlFlow 0 31) (- 0 35)) (< 1 (|Seq#Length| s@@17))) (=> (< 1 (|Seq#Length| s@@17)) (and (=> (= (ControlFlow 0 31) (- 0 34)) (< 2 (|Seq#Length| s@@17))) (=> (< 2 (|Seq#Length| s@@17)) (=> (= (|Seq#Index| s@@17 1) (|Seq#Index| s@@17 2)) (and (=> (= (ControlFlow 0 31) (- 0 33)) (< 2 (|Seq#Length| s@@17))) (=> (< 2 (|Seq#Length| s@@17)) (and (=> (= (ControlFlow 0 31) (- 0 32)) (< 3 (|Seq#Length| s@@17))) (=> (< 3 (|Seq#Length| s@@17)) (=> (and (= (|Seq#Index| s@@17 2) (|Seq#Index| s@@17 3)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 31) 30) anon15_Else_correct) (=> (= (ControlFlow 0 31) 2) anon16_Then_correct)) (=> (= (ControlFlow 0 31) 7) anon16_Else_correct)))))))))))))))))))))
