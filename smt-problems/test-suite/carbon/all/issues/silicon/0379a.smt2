...
(assert  (and (and (= (type Heap@@19) (MapType0Type RefType)) (= (type self@@11) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |u32#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@19 self@@11 $allocated))) (=> (and (and (not (= self@@11 null)) (= Mask@0 (MapType1Store ZeroMask self@@11 val_int (real_2_U (+ (U_2_real (MapType1Select ZeroMask self@@11 val_int)) FullPerm))))) (and (state Heap@@19 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@0 self@@11 val_int))))))
