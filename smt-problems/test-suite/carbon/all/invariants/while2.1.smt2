...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type x@@8) RefType) (= (type Mask@11) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@12) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@10) (MapType1Type RefType realType))) (= (type Mask@8) (MapType1Type RefType realType))) (= (type Mask@9) (MapType1Type RefType realType))) (= (type Mask@7) (MapType1Type RefType realType))) (= (type ExhaleHeap@2) (MapType0Type RefType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test03)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 42) (let ((anon19_correct true))
(let ((anon18_correct  (=> (= Mask@9 (MapType1Store Mask@8 x@@8 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@8 x@@8 f_7)) perm@4)))) (=> (and (= Mask@10 Mask@9) (= (ControlFlow 0 17) 15)) anon19_correct))))
(let ((anon34_Else_correct  (=> (and (= perm@4 NoPerm) (= (ControlFlow 0 20) 17)) anon18_correct)))
(let ((anon34_Then_correct  (=> (not (= perm@4 NoPerm)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (<= perm@4 (U_2_real (MapType1Select Mask@8 x@@8 f_7)))) (=> (<= perm@4 (U_2_real (MapType1Select Mask@8 x@@8 f_7))) (=> (= (ControlFlow 0 18) 17) anon18_correct))))))
(let ((anon33_Then_correct  (=> (and b_2@1 (= perm@4 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (>= perm@4 NoPerm)) (=> (>= perm@4 NoPerm) (and (=> (= (ControlFlow 0 21) 18) anon34_Then_correct) (=> (= (ControlFlow 0 21) 20) anon34_Else_correct)))))))
(let ((anon33_Else_correct  (=> (not b_2@1) (=> (and (= Mask@10 Mask@8) (= (ControlFlow 0 16) 15)) anon19_correct))))
(let ((anon15_correct  (=> (= Mask@8 (MapType1Store Mask@7 x@@8 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@7 x@@8 f_7)) perm@3)))) (=> (and (and (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@2 Mask@8) (state ExhaleHeap@2 Mask@8)) (and (= b_2@1  (not b_2@0)) (state ExhaleHeap@2 Mask@8))) (and (=> (= (ControlFlow 0 23) 21) anon33_Then_correct) (=> (= (ControlFlow 0 23) 16) anon33_Else_correct))))))
(let ((anon32_Else_correct  (=> (and (= perm@3 NoPerm) (= (ControlFlow 0 26) 23)) anon15_correct)))
(let ((anon32_Then_correct  (=> (not (= perm@3 NoPerm)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (<= perm@3 (U_2_real (MapType1Select Mask@7 x@@8 f_7)))) (=> (<= perm@3 (U_2_real (MapType1Select Mask@7 x@@8 f_7))) (=> (= (ControlFlow 0 24) 23) anon15_correct))))))
(let ((anon13_correct  (=> (and (and (state ExhaleHeap@0 Mask@7) b_2@0) (and (state ExhaleHeap@0 Mask@7) (= perm@3 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 27) (- 0 28)) (>= perm@3 NoPerm)) (=> (>= perm@3 NoPerm) (and (=> (= (ControlFlow 0 27) 24) anon32_Then_correct) (=> (= (ControlFlow 0 27) 26) anon32_Else_correct)))))))
(let ((anon31_Else_correct  (=> (not b_2@0) (=> (and (= Mask@7 ZeroMask) (= (ControlFlow 0 31) 27)) anon13_correct))))
(let ((anon31_Then_correct  (=> (and b_2@0 (= perm@2 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 29) (- 0 30)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (=> (> perm@2 NoPerm) (not (= x@@8 null))) (=> (and (and (= Mask@6 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) perm@2)))) (state ExhaleHeap@0 Mask@6)) (and (= Mask@7 Mask@6) (= (ControlFlow 0 29) 27))) anon13_correct)))))))
(let ((anon30_Then_correct  (=> (state ExhaleHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 32) 29) anon31_Then_correct) (=> (= (ControlFlow 0 32) 31) anon31_Else_correct)))))
(let ((anon24_correct true))
(let ((anon36_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon24_correct)))
(let ((anon36_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select Mask@4 x@@8 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 x@@8 f_7))) (=> (= (ControlFlow 0 7) 6) anon24_correct))))))
(let ((anon22_correct  (=> (and (state ExhaleHeap@0 Mask@4) (state ExhaleHeap@0 Mask@4)) (and (=> (= (ControlFlow 0 10) 7) anon36_Then_correct) (=> (= (ControlFlow 0 10) 9) anon36_Else_correct)))))
(let ((anon35_Else_correct  (=> (not b_2@0) (=> (and (= Mask@4 Mask@2) (= (ControlFlow 0 13) 10)) anon22_correct))))
(let ((anon35_Then_correct  (=> (and b_2@0 (= perm@1 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (=> (> perm@1 NoPerm) (not (= x@@8 null))) (=> (and (and (= Mask@3 (MapType1Store Mask@2 x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@2 x@@8 f_7)) perm@1)))) (state ExhaleHeap@0 Mask@3)) (and (= Mask@4 Mask@3) (= (ControlFlow 0 11) 10))) anon22_correct)))))))
(let ((anon30_Else_correct  (=> (and (not b_2@0) (state ExhaleHeap@0 Mask@2)) (and (=> (= (ControlFlow 0 14) 11) anon35_Then_correct) (=> (= (ControlFlow 0 14) 13) anon35_Else_correct)))))
(let ((anon9_correct true))
(let ((anon29_Else_correct  (=> (not b_2@0) (=> (and (= Mask@12 Mask@2) (= (ControlFlow 0 5) 2)) anon9_correct))))
(let ((anon29_Then_correct  (=> (and b_2@0 (= perm@5 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (>= perm@5 NoPerm)) (=> (>= perm@5 NoPerm) (=> (=> (> perm@5 NoPerm) (not (= x@@8 null))) (=> (and (and (= Mask@11 (MapType1Store Mask@2 x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@2 x@@8 f_7)) perm@5)))) (state ExhaleHeap@0 Mask@11)) (and (= Mask@12 Mask@11) (= (ControlFlow 0 3) 2))) anon9_correct)))))))
(let ((anon6_correct  (=> (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@2) (and (and (and (=> (= (ControlFlow 0 33) 32) anon30_Then_correct) (=> (= (ControlFlow 0 33) 14) anon30_Else_correct)) (=> (= (ControlFlow 0 33) 3) anon29_Then_correct)) (=> (= (ControlFlow 0 33) 5) anon29_Else_correct)))))
(let ((anon5_correct  (=> (= Mask@1 (MapType1Store Mask@0 x@@8 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 x@@8 f_7)) perm@0)))) (=> (and (= Mask@2 Mask@1) (= (ControlFlow 0 35) 33)) anon6_correct))))
(let ((anon27_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 38) 35)) anon5_correct)))
(let ((anon27_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 36) (- 0 37)) (<= perm@0 (U_2_real (MapType1Select Mask@0 x@@8 f_7)))) (=> (<= perm@0 (U_2_real (MapType1Select Mask@0 x@@8 f_7))) (=> (= (ControlFlow 0 36) 35) anon5_correct))))))
(let ((anon26_Then_correct  (=> (and b_2 (= perm@0 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 39) (- 0 40)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 39) 36) anon27_Then_correct) (=> (= (ControlFlow 0 39) 38) anon27_Else_correct)))))))
(let ((anon26_Else_correct  (=> (not b_2) (=> (and (= Mask@2 Mask@0) (= (ControlFlow 0 34) 33)) anon6_correct))))
(let ((anon25_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (=> (and (and (not (= x@@8 null)) (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (and (=> (= (ControlFlow 0 41) 1) anon25_Then_correct) (=> (= (ControlFlow 0 41) 39) anon26_Then_correct)) (=> (= (ControlFlow 0 41) 34) anon26_Else_correct))))))
