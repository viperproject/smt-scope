...
(assert  (and (and (and (and (= (type QPMask@0) (MapType1Type RefType realType)) (= (type x@@11) RefType)) (= (type xs) (SeqType RefType))) (= (type Heap@@14) (MapType0Type RefType))) (forall ((arg0@@43 T@U) (arg1@@20 Int) ) (! (= (type (invRecv5 arg0@@43 arg1@@20)) RefType)
...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p4 x@@11 i@@18))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p4 x@@11 i@@18)))) (=> (= (ControlFlow 0 4) 3) anon6_correct))))))
...
)))) (and (and (state Heap@@14 QPMask@0) (state Heap@@14 QPMask@0)) (and (|Seq#Contains| xs x@@11) (state Heap@@14 QPMask@0)))) (and (and (=> (= (ControlFlow 0 7) 2) anon8_Then_correct) (=> (= (ControlFlow 0 7) 4) anon9_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct))))))))
