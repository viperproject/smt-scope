...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@0) (MapType2Type RefType realType)) (= (type struct@@5) RefType)) (= (type Heap@@20) (MapType1Type RefType))) (= (type this@@16) RefType)) (= (type QPMask@0) (MapType2Type RefType realType))) (= (type UnfoldingMask@2) (MapType2Type RefType realType))) (= (type Heap@1) (MapType1Type RefType))) (= (type Result@0) RefType)) (= (type Heap@0) (MapType1Type RefType))) (= (type newPMask@0) (MapType2Type RefType boolType))) (forall ((arg0@@54 T@U) (arg1@@31 T@U) ) (! (= (type (CombineFrames arg0@@54 arg1@@31)) FrameTypeType)
...
))) (= (type UnfoldingMask@0) (MapType2Type RefType realType))) (= (type UnfoldingMask@1) (MapType2Type RefType realType))) (forall ((arg0@@56 T@U) ) (! (= (type (invRecv1 arg0@@56)) RefType)
 :qid |funType:invRecv1|
 :pattern ( (invRecv1 arg0@@56))
))))
(set-info :boogie-vc-id |find#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon13_Else_correct  (=> (= (ControlFlow 0 11) (- 0 10)) (U_2_bool (MapType0Select (allNodes Heap@1 struct@@5) Result@0)))))
(let ((anon13_Then_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (> (U_2_real (MapType2Select Mask@0 null (inv struct@@5))) NoPerm))))
(let ((anon7_correct  (=> (and (= Heap@0 (MapType1Store Heap@@20 null (|inv#sm| struct@@5) (MapType2Store (MapType1Select Heap@@20 null (|inv#sm| struct@@5)) struct@@5 nodes (bool_2_U true)))) (forall ((o_4 T@U) (f_7 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_7))))
(let ((A@@12 (FieldTypeInv0 (type f_7))))
 (=> (and (and (= (type o_4) RefType) (= (type f_7) (FieldType A@@12 B@@11))) (U_2_bool (MapType2Select (MapType1Select Heap@0 null (|inv#sm| struct@@5)) o_4 f_7))) (U_2_bool (MapType2Select newPMask@0 o_4 f_7)))))
 :qid |stdinbpl.621:31|
 :skolemid |95|
 :pattern ( (MapType2Select newPMask@0 o_4 f_7))
))) (=> (and (and (forall ((n_1 T@U) ) (!  (=> (and (= (type n_1) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@0 struct@@5 nodes) n_1))) (U_2_bool (MapType2Select newPMask@0 n_1 parent)))
 :qid |stdinbpl.625:24|
 :skolemid |96|
 :no-pattern (type n_1)
 :no-pattern (U_2_int n_1)
 :no-pattern (U_2_bool n_1)
)) (= Heap@1 (MapType1Store Heap@0 null (|inv#sm| struct@@5) newPMask@0))) (and (state Heap@1 Mask@0) (= Result@0 (ite (= this@@16 (MapType1Select Heap@1 this@@16 parent)) this@@16 (find Heap@1 struct@@5 (MapType1Select Heap@1 this@@16 parent)))))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (not (= Result@0 null))) (=> (not (= Result@0 null)) (and (=> (= (ControlFlow 0 12) 9) anon13_Then_correct) (=> (= (ControlFlow 0 12) 11) anon13_Else_correct))))))))
(let ((anon12_Else_correct  (=> (and (|find#trigger| (MapType1Select Heap@@20 null (inv struct@@5)) struct@@5 (MapType1Select Heap@@20 this@@16 parent)) (= (ControlFlow 0 15) 12)) anon7_correct)))
(let ((anon11_Then_correct  (=> (and (= this@@16 (MapType1Select Heap@@20 this@@16 parent)) (= (ControlFlow 0 14) 12)) anon7_correct)))
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 4) (- 0 7)) (not (= struct@@5 null))) (=> (not (= struct@@5 null)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (not (= (MapType1Select Heap@@20 this@@16 parent) null))) (=> (not (= (MapType1Select Heap@@20 this@@16 parent) null)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (> (U_2_real (MapType2Select QPMask@0 null (inv struct@@5))) NoPerm)) (=> (> (U_2_real (MapType2Select QPMask@0 null (inv struct@@5))) NoPerm) (=> (and (and (> wildcard@4 NoPerm) (< wildcard@4 (U_2_real (MapType2Select QPMask@0 null (inv struct@@5))))) (and (= UnfoldingMask@2 (MapType2Store QPMask@0 null (inv struct@@5) (real_2_U (- (U_2_real (MapType2Select QPMask@0 null (inv struct@@5))) wildcard@4)))) (= (ControlFlow 0 4) (- 0 3)))) (U_2_bool (MapType0Select (allNodes Heap@@20 struct@@5) (MapType1Select Heap@@20 this@@16 parent))))))))))))
(let ((anon11_Else_correct  (=> (not (= this@@16 (MapType1Select Heap@@20 this@@16 parent))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm QPMask@0 this@@16 parent)) (=> (HasDirectPerm QPMask@0 this@@16 parent) (and (=> (= (ControlFlow 0 16) 4) anon12_Then_correct) (=> (= (ControlFlow 0 16) 15) anon12_Else_correct)))))))
(let ((anon10_Else_correct  (=> (and (and (U_2_bool (MapType0Select (allNodes Heap@@20 struct@@5) this@@16)) (state Heap@@20 Mask@0)) (and (|inv#trigger| Heap@@20 (inv struct@@5)) (= (MapType1Select Heap@@20 null (inv struct@@5)) (CombineFrames (FrameFragment (MapType1Select Heap@@20 struct@@5 nodes)) (FrameFragment (int_2_U (|inv#condqp1| Heap@@20 struct@@5))))))) (and (=> (= (ControlFlow 0 18) (- 0 21)) (> (U_2_real (MapType2Select Mask@0 null (inv struct@@5))) NoPerm)) (=> (> (U_2_real (MapType2Select Mask@0 null (inv struct@@5))) NoPerm) (=> (and (and (and (> wildcard@2 NoPerm) (< wildcard@2 (U_2_real (MapType2Select Mask@0 null (inv struct@@5))))) (and (= UnfoldingMask@0 (MapType2Store Mask@0 null (inv struct@@5) (real_2_U (- (U_2_real (MapType2Select Mask@0 null (inv struct@@5))) wildcard@2)))) (> wildcard@3 NoPerm))) (and (and (not (= struct@@5 null)) (= UnfoldingMask@1 (MapType2Store UnfoldingMask@0 struct@@5 nodes (real_2_U (+ (U_2_real (MapType2Select UnfoldingMask@0 struct@@5 nodes)) wildcard@3))))) (and (state Heap@@20 UnfoldingMask@1) (not (U_2_bool (MapType0Select (MapType1Select Heap@@20 struct@@5 nodes) null)))))) (and (=> (= (ControlFlow 0 18) (- 0 20)) (forall ((n T@U) (n_4 T@U) ) (!  (=> (and (= (type n) RefType) (= (type n_4) RefType)) (=> (and (and (and (and (not (= n n_4)) (U_2_bool (MapType0Select (MapType1Select Heap@@20 struct@@5 nodes) n))) (U_2_bool (MapType0Select (MapType1Select Heap@@20 struct@@5 nodes) n_4))) (< NoPerm wildcard@3)) (< NoPerm wildcard@3)) (not (= n n_4))))
 :qid |stdinbpl.547:17|
 :skolemid |88|
 :no-pattern (type n)
 :no-pattern (type n_4)
...
))) (=> (forall ((n@@0 T@U) (n_4@@0 T@U) ) (!  (=> (and (= (type n@@0) RefType) (= (type n_4@@0) RefType)) (=> (and (and (and (and (not (= n@@0 n_4@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@@20 struct@@5 nodes) n@@0))) (U_2_bool (MapType0Select (MapType1Select Heap@@20 struct@@5 nodes) n_4@@0))) (< NoPerm wildcard@3)) (< NoPerm wildcard@3)) (not (= n@@0 n_4@@0))))
 :qid |stdinbpl.547:17|
 :skolemid |88|
 :no-pattern (type n@@0)
...
)) (=> (and (and (and (forall ((n@@1 T@U) ) (!  (=> (and (= (type n@@1) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@@20 struct@@5 nodes) n@@1))) (and (qpRange1 n@@1) (= (invRecv1 n@@1) n@@1)))
 :qid |stdinbpl.553:24|
 :skolemid |89|
 :pattern ( (MapType1Select Heap@@20 n@@1 parent))
 :pattern ( (MapType2Select QPMask@0 n@@1 parent))
 :pattern ( (MapType0Select (MapType1Select Heap@@20 struct@@5 nodes) n@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@20 struct@@5 nodes) (invRecv1 o_3))) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.557:24|
 :skolemid |90|
 :pattern ( (invRecv1 o_3))
))) (and (forall ((n@@2 T@U) ) (!  (=> (= (type n@@2) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@20 struct@@5 nodes) n@@2)) (> wildcard@3 NoPerm)) (not (= n@@2 null))))
 :qid |stdinbpl.563:24|
 :skolemid |91|
 :pattern ( (MapType1Select Heap@@20 n@@2 parent))
 :pattern ( (MapType2Select QPMask@0 n@@2 parent))
 :pattern ( (MapType0Select (MapType1Select Heap@@20 struct@@5 nodes) n@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@20 struct@@5 nodes) (invRecv1 o_3@@0))) (qpRange1 o_3@@0)) (and (= (invRecv1 o_3@@0) o_3@@0) (< (U_2_real (MapType2Select UnfoldingMask@1 o_3@@0 parent)) (U_2_real (MapType2Select QPMask@0 o_3@@0 parent))))) (=> (not (and (U_2_bool (MapType0Select (MapType1Select Heap@@20 struct@@5 nodes) (invRecv1 o_3@@0))) (qpRange1 o_3@@0))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 parent)) (U_2_real (MapType2Select UnfoldingMask@1 o_3@@0 parent))))))
 :qid |stdinbpl.569:24|
 :skolemid |92|
 :pattern ( (MapType2Select QPMask@0 o_3@@0 parent))
)))) (and (and (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_5))))
(let ((A@@13 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@13 B@@12))) (not (= f_5 parent))) (= (U_2_real (MapType2Select UnfoldingMask@1 o_3@@1 f_5)) (U_2_real (MapType2Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.573:31|
 :skolemid |93|
 :pattern ( (MapType2Select UnfoldingMask@1 o_3@@1 f_5))
 :pattern ( (MapType2Select QPMask@0 o_3@@1 f_5))
)) (state Heap@@20 QPMask@0)) (and (forall ((q_1 T@U) ) (!  (=> (and (= (type q_1) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@@20 struct@@5 nodes) q_1))) (U_2_bool (MapType0Select (MapType1Select Heap@@20 struct@@5 nodes) (MapType1Select Heap@@20 q_1 parent))))
 :qid |stdinbpl.579:22|
 :skolemid |94|
 :pattern ( (MapType0Select (MapType1Select Heap@@20 struct@@5 nodes) q_1))
 :pattern ( (MapType0Select (MapType1Select Heap@@20 struct@@5 nodes) (MapType1Select Heap@@20 q_1 parent)))
)) (state Heap@@20 QPMask@0)))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm QPMask@0 this@@16 parent)) (=> (HasDirectPerm QPMask@0 this@@16 parent) (and (=> (= (ControlFlow 0 18) 14) anon11_Then_correct) (=> (= (ControlFlow 0 18) 16) anon11_Else_correct)))))))))))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (> (U_2_real (MapType2Select Mask@0 null (inv struct@@5))) NoPerm))))
(let ((anon0_correct  (=> (and (and (state Heap@@20 ZeroMask) (U_2_bool (MapType1Select Heap@@20 struct@@5 $allocated))) (and (U_2_bool (MapType1Select Heap@@20 this@@16 $allocated)) (= AssumeFunctionsAbove 0))) (=> (and (and (and (not (= struct@@5 null)) (not (= this@@16 null))) (and (state Heap@@20 ZeroMask) (> wildcard@0 NoPerm))) (and (and (= Mask@0 (MapType2Store ZeroMask null (inv struct@@5) (real_2_U (+ (U_2_real (MapType2Select ZeroMask null (inv struct@@5))) wildcard@0)))) (state Heap@@20 Mask@0)) (and (state Heap@@20 Mask@0) (state Heap@@20 Mask@0)))) (and (=> (= (ControlFlow 0 22) 2) anon10_Then_correct) (=> (= (ControlFlow 0 22) 18) anon10_Else_correct))))))
