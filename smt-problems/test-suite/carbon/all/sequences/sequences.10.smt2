...
(assert  (and (= (type Heap@@13) (MapType0Type RefType)) (= (type n@0) (SeqType intType))))
(set-info :boogie-vc-id t1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (= n@0 (|Seq#Empty| intType)) (state Heap@@13 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (|Seq#Length| n@0) 0)) (=> (= (|Seq#Length| n@0) 0) (=> (state Heap@@13 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (not (|Seq#Equal| n@0 (|Seq#Singleton| (int_2_U x@@11))))) (=> (not (|Seq#Equal| n@0 (|Seq#Singleton| (int_2_U x@@11)))) (=> (state Heap@@13 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (|Seq#Length| (|Seq#Singleton| (int_2_U 1))) 1)) (=> (= (|Seq#Length| (|Seq#Singleton| (int_2_U 1))) 1) (=> (and (state Heap@@13 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (|Seq#Length| (|Seq#Singleton| (int_2_U 0))) 0)))))))))))))
