...
(declare-fun a_1@@11 () T@U)
(declare-fun p_1@@5 () Real)
(assert  (and (= (type Heap@@11) (MapType0Type RefType)) (= (type a_1@@11) RefType)))
(set-info :boogie-vc-id |pred2#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 a_1@@11 $allocated))) (and (<= NoPerm p_1@@5) (= (ControlFlow 0 2) (- 0 1)))) (>= p_1@@5 NoPerm))))
