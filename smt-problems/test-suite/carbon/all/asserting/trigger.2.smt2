...
(assert (forall ((Heap@@4 T@U) (Mask@@3 T@U) (i@@3 Int) ) (!  (=> (and (and (= (type Heap@@4) (MapType0Type RefType)) (= (type Mask@@3) (MapType1Type RefType realType))) (and (state Heap@@4 Mask@@3) (< AssumeFunctionsAbove 0))) (trigger Heap@@4 i@@3))
 :qid |stdinbpl.557:15|
 :skolemid |60|
 :pattern ( (state Heap@@4 Mask@@3) (trigger Heap@@4 i@@3))
)))
...
(assert (forall ((Heap@@7 T@U) (Mask@@7 T@U) (i@@4 Int) ) (!  (=> (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (state Heap@@7 Mask@@7)) (= (|trigger'| Heap@@7 i@@4) (|trigger#frame| EmptyFrame i@@4)))
 :qid |stdinbpl.564:15|
 :skolemid |61|
 :pattern ( (state Heap@@7 Mask@@7) (|trigger'| Heap@@7 i@@4))
)))
...
(assert (forall ((Heap@@8 T@U) (i@@6 Int) ) (!  (=> (= (type Heap@@8) (MapType0Type RefType)) (and (= (trigger Heap@@8 i@@6) (|trigger'| Heap@@8 i@@6)) (dummyFunction (bool_2_U (|trigger#triggerStateless| i@@6)))))
 :qid |stdinbpl.547:15|
 :skolemid |58|
 :pattern ( (trigger Heap@@8 i@@6))
)))
...
(declare-fun i_1 () Int)
(assert  (and (= (type s@@17) (SeqType intType)) (= (type Heap@@13) (MapType0Type RefType))))
(set-info :boogie-vc-id triggerUse)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (trigger Heap@@13 0)) (=> (trigger Heap@@13 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< 0 (|Seq#Length| s@@17))) (=> (< 0 (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 9) (- 0 8)) (> (U_2_int (|Seq#Index| s@@17 0)) 0))))))))
(let ((anon12_Then_correct true))
(let ((anon11_Then_correct true))
(let ((anon9_Else_correct  (=> (and (forall ((i_1_1 Int) ) (!  (=> (and (<= 0 i_1_1) (< i_1_1 (|Seq#Length| s@@17))) (> (U_2_int (|Seq#Index| s@@17 i_1_1)) 0))
 :qid |stdinbpl.626:20|
 :skolemid |62|
 :pattern ( (|trigger#frame| EmptyFrame i_1_1))
)) (state Heap@@13 ZeroMask)) (and (and (=> (= (ControlFlow 0 12) 6) anon11_Then_correct) (=> (= (ControlFlow 0 12) 7) anon12_Then_correct)) (=> (= (ControlFlow 0 12) 9) anon12_Else_correct)))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (and (<= 0 i_1) (< i_1 (|Seq#Length| s@@17)))) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (<= 0 i_1) (< i_1 (|Seq#Length| s@@17))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i_1 0)) (=> (>= i_1 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i_1 (|Seq#Length| s@@17))) (=> (< i_1 (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (> (|Seq#Length| s@@17) 0)) (and (state Heap@@13 ZeroMask) (state Heap@@13 ZeroMask))) (and (and (=> (= (ControlFlow 0 13) 12) anon9_Else_correct) (=> (= (ControlFlow 0 13) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 13) 5) anon10_Else_correct))))))
