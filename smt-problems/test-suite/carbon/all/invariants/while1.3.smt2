...
(assert  (and (and (and (and (and (and (and (= (type ExhaleHeap@0) (MapType0Type RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type x@@8) RefType)) (= (type Mask@3) (MapType1Type RefType realType))) (= (type ExhaleHeap@1) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@17) (MapType0Type RefType))))
(set-info :boogie-vc-id test03)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon9_correct true))
(let ((anon15_Else_correct  (=> (and (= perm@5 NoPerm) (= (ControlFlow 0 8) 5)) anon9_correct)))
(let ((anon15_Then_correct  (=> (not (= perm@5 NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= perm@5 (U_2_real (MapType1Select Mask@5 x@@8 f_8)))) (=> (<= perm@5 (U_2_real (MapType1Select Mask@5 x@@8 f_8))) (=> (= (ControlFlow 0 6) 5) anon9_correct))))))
(let ((anon7_correct  (=> (and (= Mask@5 (MapType1Store Mask@3 x@@8 f_8 (real_2_U (- (U_2_real (MapType1Select Mask@3 x@@8 f_8)) perm@3)))) (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@1 Mask@5)) (=> (and (and (state ExhaleHeap@1 Mask@5) (= b_2@1  (not b_2@0))) (and (state ExhaleHeap@1 Mask@5) (= perm@5 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (>= perm@5 NoPerm)) (=> (>= perm@5 NoPerm) (and (=> (= (ControlFlow 0 9) 6) anon15_Then_correct) (=> (= (ControlFlow 0 9) 8) anon15_Else_correct))))))))
(let ((anon14_Else_correct  (=> (and (= perm@3 NoPerm) (= (ControlFlow 0 13) 9)) anon7_correct)))
(let ((anon14_Then_correct  (=> (not (= perm@3 NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= perm@3 (U_2_real (MapType1Select Mask@3 x@@8 f_8)))) (=> (<= perm@3 (U_2_real (MapType1Select Mask@3 x@@8 f_8))) (=> (= (ControlFlow 0 11) 9) anon7_correct))))))
(let ((anon13_Then_correct  (=> (and (state ExhaleHeap@0 ZeroMask) (= perm@2 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (=> (> perm@2 NoPerm) (not (= x@@8 null))) (=> (and (= Mask@3 (MapType1Store ZeroMask x@@8 f_8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_8)) perm@2)))) (state ExhaleHeap@0 Mask@3)) (=> (and (and (state ExhaleHeap@0 Mask@3) b_2@0) (and (state ExhaleHeap@0 Mask@3) (= perm@3 (/ (to_real 1) (to_real 4))))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (>= perm@3 NoPerm)) (=> (>= perm@3 NoPerm) (and (=> (= (ControlFlow 0 14) 11) anon14_Then_correct) (=> (= (ControlFlow 0 14) 13) anon14_Else_correct))))))))))))
(let ((anon13_Else_correct  (=> (and (and (not b_2@0) (state ExhaleHeap@0 Mask@1)) (and (= perm@4 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 4) (- 0 3)))) (>= perm@4 NoPerm))))
(let ((anon12_Then_correct  (=> (and (= perm@1 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@1 NoPerm))))
(let ((anon2_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 x@@8 f_8 (real_2_U (- (U_2_real (MapType1Select Mask@0 x@@8 f_8)) perm@0)))) (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@0 Mask@1)) (and (and (=> (= (ControlFlow 0 17) 2) anon12_Then_correct) (=> (= (ControlFlow 0 17) 14) anon13_Then_correct)) (=> (= (ControlFlow 0 17) 4) anon13_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 20) 17)) anon2_correct)))
(let ((anon11_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (<= perm@0 (U_2_real (MapType1Select Mask@0 x@@8 f_8)))) (=> (<= perm@0 (U_2_real (MapType1Select Mask@0 x@@8 f_8))) (=> (= (ControlFlow 0 18) 17) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@17 x@@8 $allocated)) (not (= x@@8 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_8)) FullPerm)))) (state Heap@@17 Mask@0)) (and (state Heap@@17 Mask@0) (= perm@0 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 21) 18) anon11_Then_correct) (=> (= (ControlFlow 0 21) 20) anon11_Else_correct)))))))))
