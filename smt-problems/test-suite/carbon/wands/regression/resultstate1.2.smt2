...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Used_3Mask@3) (MapType1Type RefType realType)) (= (type l) RefType)) (= (type Result_2Heap) (MapType0Type RefType))) (= (type Result_2Mask) (MapType1Type RefType realType))) (= (type Ops_1Mask) (MapType1Type RefType realType))) (= (type Ops_1Heap@5) (MapType0Type RefType))) (= (type Used_3Heap@0) (MapType0Type RefType))) (= (type Mask@8) (MapType1Type RefType realType))) (= (type Mask@7) (MapType1Type RefType realType))) (= (type Heap@7) (MapType0Type RefType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Used_3Mask@1) (MapType1Type RefType realType))) (= (type Used_3Mask@2) (MapType1Type RefType realType))) (= (type TempMask@3) (MapType1Type RefType realType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type newPMask@1) (MapType1Type RefType boolType))) (= (type Heap@6) (MapType0Type RefType))) (= (type Used_3Mask@0) (MapType1Type RefType realType))) (= (type TempMask@2) (MapType1Type RefType realType))) (= (type Ops_1Mask@11) (MapType1Type RefType realType))) (= (type Ops_1Mask@10) (MapType1Type RefType realType))) (= (type Ops_1Heap@0) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Ops_1Mask@6) (MapType1Type RefType realType))) (= (type Ops_1Heap@4) (MapType0Type RefType))) (= (type Ops_1Heap@3) (MapType0Type RefType))) (= (type Ops_1Mask@9) (MapType1Type RefType realType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Ops_1Heap@1) (MapType0Type RefType))) (= (type Ops_1Heap@2) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Result_1Heap) (MapType0Type RefType))) (= (type Used_2Heap@0) (MapType0Type RefType))) (= (type Ops_1Mask@8) (MapType1Type RefType realType))) (forall ((arg0@@33 T@U) ) (! (= (type (FrameFragment arg0@@33)) FrameTypeType)
...
(let ((anon71_Then_correct  (=> (> takeTransfer@5 0.0) (=> (and (= neededTransfer@10 (- neededTransfer@9 takeTransfer@5)) (= Used_3Mask@2 (MapType1Store Used_3Mask@1 null (Q l) (real_2_U (+ (U_2_real (MapType1Select Used_3Mask@1 null (Q l))) takeTransfer@5))))) (=> (and (and (= b_6@4  (and b_6@3 (state Used_3Heap@0 Used_3Mask@2))) (= TempMask@3 (MapType1Store ZeroMask null (Q l) (real_2_U FullPerm)))) (and (= b_6@5  (and b_6@4 (IdenticalOnKnownLocations Heap@5 Used_3Heap@0 TempMask@3))) (= Mask@6 (MapType1Store Mask@5 null (Q l) (real_2_U (- (U_2_real (MapType1Select Mask@5 null (Q l))) takeTransfer@5)))))) (=> (and (and (and (forall ((o_4 T@U) (f_9 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_9))))
(let ((A@@12 (FieldTypeInv0 (type f_9))))
 (=> (and (and (= (type o_4) RefType) (= (type f_9) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@5 null (|wand#sm| l FullPerm l FullPerm)) o_4 f_9)) (U_2_bool (MapType1Select (MapType0Select Heap@5 null (|Q#sm| l)) o_4 f_9)))) (U_2_bool (MapType1Select newPMask@1 o_4 f_9)))))
 :qid |stdinbpl.684:35|
 :skolemid |42|
 :pattern ( (MapType1Select newPMask@1 o_4 f_9))
)) (= Heap@6 (MapType0Store Heap@5 null (|wand#sm| l FullPerm l FullPerm) newPMask@1))) (and (= Mask@7 Mask@6) (= Heap@7 Heap@6))) (and (and (= neededTransfer@11 neededTransfer@10) (= b_6@6 b_6@5)) (and (= Used_3Mask@3 Used_3Mask@2) (= (ControlFlow 0 5) 2)))) anon47_correct))))))
...
(let ((anon69_Then_correct  (=> (and (and (and (and (and b_1_1@25 b_1_1@25) b_6@3) true) (> neededTransfer@9 0.0)) (= maskTransfer@5 (U_2_real (MapType1Select Mask@5 null (Q l))))) (and (=> (= (ControlFlow 0 9) 7) anon70_Then_correct) (=> (= (ControlFlow 0 9) 8) anon70_Else_correct)))))
...
(let ((anon68_Then_correct  (=> (and (> takeTransfer@4 0.0) (= neededTransfer@8 (- FullPerm takeTransfer@4))) (=> (and (and (and (= Used_3Mask@0 (MapType1Store ZeroMask null (Q l) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Q l))) takeTransfer@4)))) (= b_6@1  (and b_6@0 (state Used_3Heap@0 Used_3Mask@0)))) (and (= TempMask@2 (MapType1Store ZeroMask null (Q l) (real_2_U FullPerm))) (= b_6@2  (and b_6@1 (IdenticalOnKnownLocations Ops_1Heap@5 Used_3Heap@0 TempMask@2))))) (and (and (= Ops_1Mask@11 (MapType1Store Ops_1Mask@10 null (Q l) (real_2_U (- (U_2_real (MapType1Select Ops_1Mask@10 null (Q l))) takeTransfer@4)))) (= Used_3Mask@1 Used_3Mask@0)) (and (= b_6@3 b_6@2) (= neededTransfer@9 neededTransfer@8)))) (and (=> (= (ControlFlow 0 11) 9) anon69_Then_correct) (=> (= (ControlFlow 0 11) 4) anon69_Else_correct))))))
...
(let ((anon66_Then_correct  (=> (and (and (and (and (and b_1_1@25 b_1_1@25) b_6@0) true) (> FullPerm 0.0)) (= maskTransfer@4 (U_2_real (MapType1Select Ops_1Mask@10 null (Q l))))) (and (=> (= (ControlFlow 0 15) 13) anon67_Then_correct) (=> (= (ControlFlow 0 15) 14) anon67_Else_correct)))))
...
(let ((anon35_correct  (=> (and (= b_6@0  (and b_6 (state Used_3Heap@0 ZeroMask))) (= initNeededTransfer@2 (+ (U_2_real (MapType1Select ZeroMask null (Q l))) FullPerm))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 16) 15) anon66_Then_correct) (=> (= (ControlFlow 0 16) 10) anon66_Else_correct)))))))
(let ((anon34_correct  (=> (= Ops_1Heap@4 (MapType0Store Ops_1Heap@3 null (|Q#sm| l) (MapType1Store (MapType0Select Ops_1Heap@3 null (|Q#sm| l)) l h (bool_2_U true)))) (=> (and (and (and (state Ops_1Heap@4 Ops_1Mask@9) (= b_1_1@24  (and b_1_1@23 (state Ops_1Heap@4 Ops_1Mask@9)))) (and (= Ops_1Heap@5 Ops_1Heap@4) (= b_1_1@25 b_1_1@24))) (and (and (= Heap@5 Heap@4) (= Mask@5 Mask@4)) (and (= Ops_1Mask@10 Ops_1Mask@9) (= (ControlFlow 0 19) 16)))) anon35_correct))))
(let ((anon65_Else_correct  (=> (HasDirectPerm Ops_1Mask@9 null (Q l)) (=> (and (= Ops_1Heap@3 Ops_1Heap@0) (= (ControlFlow 0 21) 19)) anon34_correct))))
(let ((anon65_Then_correct  (=> (not (HasDirectPerm Ops_1Mask@9 null (Q l))) (=> (and (and (= Ops_1Heap@1 (MapType0Store Ops_1Heap@0 null (|Q#sm| l) ZeroPMask)) (= Ops_1Heap@2 (MapType0Store Ops_1Heap@1 null (Q l) freshVersion@0))) (and (= Ops_1Heap@3 Ops_1Heap@2) (= (ControlFlow 0 20) 19))) anon34_correct))))
(let ((anon32_correct  (and (=> (= (ControlFlow 0 22) (- 0 23)) (=> (and b_1_1@19 b_4@6) (not (= (MapType0Select Result_1Heap l h) null)))) (=> (=> (and b_1_1@19 b_4@6) (not (= (MapType0Select Result_1Heap l h) null))) (=> (= b_1_1@20  (and b_1_1@19 b_4@6)) (=> (and (= b_1_1@21  (and b_1_1@20 (= Used_2Heap@0 Ops_1Heap@0))) (= Ops_1Mask@9 (MapType1Store Ops_1Mask@8 null (Q l) (real_2_U (+ (U_2_real (MapType1Select Ops_1Mask@8 null (Q l))) FullPerm))))) (=> (and (and (= b_1_1@22  (and b_1_1@21 (state Ops_1Heap@0 Ops_1Mask@9))) (= b_1_1@23  (and b_1_1@22 (state Ops_1Heap@0 Ops_1Mask@9)))) (and (|Q#trigger| Ops_1Heap@0 (Q l)) (= (MapType0Select Ops_1Heap@0 null (Q l)) (FrameFragment (MapType0Select Ops_1Heap@0 l h))))) (and (=> (= (ControlFlow 0 22) 20) anon65_Then_correct) (=> (= (ControlFlow 0 22) 21) anon65_Else_correct)))))))))
(let ((anon64_Else_correct  (=> (and (not b_1_1@19) (= (ControlFlow 0 27) 22)) anon32_correct)))
(let ((anon64_Then_correct  (=> b_1_1@19 (and (=> (= (ControlFlow 0 25) (- 0 26)) (HasDirectPerm Result_1Mask l h)) (=> (HasDirectPerm Result_1Mask l h) (=> (= (ControlFlow 0 25) 22) anon32_correct))))))
...
(let ((anon62_Then_correct  (=> (> takeTransfer@3 0.0) (=> (and (and (= neededTransfer@6 (- neededTransfer@5 takeTransfer@3)) (= Used_2Mask@2 (MapType1Store Used_2Mask@1 l h (real_2_U (+ (U_2_real (MapType1Select Used_2Mask@1 l h)) takeTransfer@3))))) (and (= b_4@4  (and b_4@3 (state Used_2Heap@0 Used_2Mask@2))) (= b_4@5  (and b_4@4 (= (MapType0Select Heap@2 l h) (MapType0Select Used_2Heap@0 l h)))))) (=> (and (and (and (= Mask@3 (MapType1Store Mask@2 l h (real_2_U (- (U_2_real (MapType1Select Mask@2 l h)) takeTransfer@3)))) (= Heap@3 (MapType0Store Heap@2 null (|wand#sm| l FullPerm l FullPerm) (MapType1Store (MapType0Select Heap@2 null (|wand#sm| l FullPerm l FullPerm)) l h (bool_2_U true))))) (and (= Mask@4 Mask@3) (= neededTransfer@7 neededTransfer@6))) (and (and (= Heap@4 Heap@3) (= b_4@6 b_4@5)) (and (= Used_2Mask@3 Used_2Mask@2) (= (ControlFlow 0 32) 29)))) anon29_correct)))))
...
(let ((anon60_Then_correct  (=> (and (and (and (and b_1_1@16 b_4@3) true) (> neededTransfer@5 0.0)) (= maskTransfer@3 (U_2_real (MapType1Select Mask@2 l h)))) (and (=> (= (ControlFlow 0 36) 34) anon61_Then_correct) (=> (= (ControlFlow 0 36) 35) anon61_Else_correct)))))
...
(let ((anon59_Then_correct  (=> (and (> takeTransfer@2 0.0) (= neededTransfer@4 (- FullPerm takeTransfer@2))) (=> (and (and (and (= Used_2Mask@0 (MapType1Store ZeroMask l h (real_2_U (+ (U_2_real (MapType1Select ZeroMask l h)) takeTransfer@2)))) (= b_4@1  (and b_4@0 (state Used_2Heap@0 Used_2Mask@0)))) (and (= b_4@2  (and b_4@1 (= (MapType0Select Ops_1Heap@0 l h) (MapType0Select Used_2Heap@0 l h)))) (= Ops_1Mask@7 (MapType1Store Ops_1Mask@6 l h (real_2_U (- (U_2_real (MapType1Select Ops_1Mask@6 l h)) takeTransfer@2)))))) (and (and (= Ops_1Mask@8 Ops_1Mask@7) (= Used_2Mask@1 Used_2Mask@0)) (and (= b_4@3 b_4@2) (= neededTransfer@5 neededTransfer@4)))) (and (=> (= (ControlFlow 0 38) 36) anon60_Then_correct) (=> (= (ControlFlow 0 38) 31) anon60_Else_correct))))))
...
(let ((anon57_Then_correct  (=> (and (and (and (and b_1_1@16 b_4@0) true) (> FullPerm 0.0)) (= maskTransfer@2 (U_2_real (MapType1Select Ops_1Mask@6 l h)))) (and (=> (= (ControlFlow 0 42) 40) anon58_Then_correct) (=> (= (ControlFlow 0 42) 41) anon58_Else_correct)))))
...
(let ((anon56_Then_correct  (=> b_1_1@16 (=> (and (= b_4@0  (and b_4 (state Used_2Heap@0 ZeroMask))) (= initNeededTransfer@1 (+ (U_2_real (MapType1Select ZeroMask l h)) FullPerm))) (and (=> (= (ControlFlow 0 43) (- 0 44)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 43) 42) anon57_Then_correct) (=> (= (ControlFlow 0 43) 37) anon57_Else_correct))))))))
...
(let ((anon15_correct  (and (=> (= (ControlFlow 0 46) (- 0 47)) (=> (and b_1_1@4 b_2_1@6) (and (= neededTransfer@3 0.0) (= (U_2_real (MapType1Select Used_1Mask@3 null (P l))) initNeededTransfer@0)))) (=> (=> (and b_1_1@4 b_2_1@6) (and (= neededTransfer@3 0.0) (= (U_2_real (MapType1Select Used_1Mask@3 null (P l))) initNeededTransfer@0))) (=> (and (= b_3@0  (and b_1_1@4 b_2_1@6)) (= b_3@1  (and b_3@0 (state ResultHeap ResultMask@@0)))) (=> (and (and (= b_3@2  (and b_3@1 (sumMask ResultMask@@0 Ops_1Mask@3 Used_1Mask@3))) (= b_3@3  (and (and b_3@2 (IdenticalOnKnownLocations Ops_1Heap@0 ResultHeap Ops_1Mask@3)) (IdenticalOnKnownLocations Used_1Heap@0 ResultHeap Used_1Mask@3)))) (and (= b_3@4  (and b_3@3 (state ResultHeap ResultMask@@0))) (= b_1_1@5  (and b_1_1@4 b_3@4)))) (=> (and (and (and (and (= b_1_1@6  (and b_1_1@5 b_2_1@6)) (= b_1_1@7  (and b_1_1@6 (= Used_1Heap@0 Ops_1Heap@0)))) (and (= b_1_1@8  (and b_1_1@7 (not (= l null)))) (= Ops_1Mask@4 (MapType1Store Ops_1Mask@3 l h (real_2_U (+ (U_2_real (MapType1Select Ops_1Mask@3 l h)) FullPerm)))))) (and (and (= b_1_1@9  (and b_1_1@8 (state Ops_1Heap@0 Ops_1Mask@4))) (= b_1_1@10  (and b_1_1@9 (not (= (MapType0Select Ops_1Heap@0 l h) null))))) (and (= b_1_1@11  (and b_1_1@10 (not (= (MapType0Select Ops_1Heap@0 l h) null)))) (= Ops_1Mask@5 (MapType1Store Ops_1Mask@4 (MapType0Select Ops_1Heap@0 l h) h (real_2_U (+ (U_2_real (MapType1Select Ops_1Mask@4 (MapType0Select Ops_1Heap@0 l h) h)) FullPerm))))))) (and (and (and (= b_1_1@12  (and b_1_1@11 (state Ops_1Heap@0 Ops_1Mask@5))) (= b_1_1@13  (and b_1_1@12 (not (= (MapType0Select Ops_1Heap@0 (MapType0Select Ops_1Heap@0 l h) h) null))))) (and (= b_1_1@14  (and b_1_1@13 (state Ops_1Heap@0 Ops_1Mask@5))) (= b_1_1@15  (and b_1_1@14 (state Ops_1Heap@0 Ops_1Mask@5))))) (and (and (= b_1_1@16 b_1_1@15) (= Mask@2 Mask@1)) (and (= Ops_1Mask@6 Ops_1Mask@5) (= Heap@2 Heap@1))))) (and (=> (= (ControlFlow 0 46) 43) anon56_Then_correct) (=> (= (ControlFlow 0 46) 18) anon56_Else_correct)))))))))
(let ((anon55_Else_correct  (=> (>= 0.0 takeTransfer@1) (=> (and (= Mask@1 ZeroMask) (= neededTransfer@3 neededTransfer@1)) (=> (and (and (= b_2_1@6 b_2_1@3) (= Used_1Mask@3 Used_1Mask@1)) (and (= Heap@1 Heap@@11) (= (ControlFlow 0 50) 46))) anon15_correct)))))
(let ((anon55_Then_correct  (=> (> takeTransfer@1 0.0) (=> (and (= neededTransfer@2 (- neededTransfer@1 takeTransfer@1)) (= Used_1Mask@2 (MapType1Store Used_1Mask@1 null (P l) (real_2_U (+ (U_2_real (MapType1Select Used_1Mask@1 null (P l))) takeTransfer@1))))) (=> (and (and (= b_2_1@4  (and b_2_1@3 (state Used_1Heap@0 Used_1Mask@2))) (= TempMask@1 (MapType1Store ZeroMask null (P l) (real_2_U FullPerm)))) (and (= b_2_1@5  (and b_2_1@4 (IdenticalOnKnownLocations Heap@@11 Used_1Heap@0 TempMask@1))) (= Mask@0 (MapType1Store ZeroMask null (P l) (real_2_U (- (U_2_real (MapType1Select ZeroMask null (P l))) takeTransfer@1)))))) (=> (and (and (and (forall ((o_3 T@U) (f_8 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_8))))
(let ((A@@13 (FieldTypeInv0 (type f_8))))
 (=> (and (and (= (type o_3) RefType) (= (type f_8) (FieldType A@@13 B@@12))) (or (U_2_bool (MapType1Select (MapType0Select Heap@@11 null (|wand#sm| l FullPerm l FullPerm)) o_3 f_8)) (U_2_bool (MapType1Select (MapType0Select Heap@@11 null (|P#sm| l)) o_3 f_8)))) (U_2_bool (MapType1Select newPMask@0 o_3 f_8)))))
 :qid |stdinbpl.504:39|
 :skolemid |41|
 :pattern ( (MapType1Select newPMask@0 o_3 f_8))
)) (= Heap@0 (MapType0Store Heap@@11 null (|wand#sm| l FullPerm l FullPerm) newPMask@0))) (and (= Mask@1 Mask@0) (= neededTransfer@3 neededTransfer@2))) (and (and (= b_2_1@6 b_2_1@5) (= Used_1Mask@3 Used_1Mask@2)) (and (= Heap@1 Heap@0) (= (ControlFlow 0 49) 46)))) anon15_correct))))))
...
(let ((anon53_Then_correct  (=> (and (and (and (and b_1_1@4 b_2_1@3) true) (> neededTransfer@1 0.0)) (= maskTransfer@1 (U_2_real (MapType1Select ZeroMask null (P l))))) (and (=> (= (ControlFlow 0 53) 51) anon54_Then_correct) (=> (= (ControlFlow 0 53) 52) anon54_Else_correct)))))
(let ((anon53_Else_correct  (=> (not (and (and (and b_1_1@4 b_2_1@3) true) (> neededTransfer@1 0.0))) (=> (and (= Mask@1 ZeroMask) (= neededTransfer@3 neededTransfer@1)) (=> (and (and (= b_2_1@6 b_2_1@3) (= Used_1Mask@3 Used_1Mask@1)) (and (= Heap@1 Heap@@11) (= (ControlFlow 0 48) 46))) anon15_correct)))))
...
(let ((anon52_Then_correct  (=> (> takeTransfer@0 0.0) (=> (and (= neededTransfer@0 (- FullPerm takeTransfer@0)) (= Used_1Mask@0 (MapType1Store ZeroMask null (P l) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P l))) takeTransfer@0))))) (=> (and (and (and (= b_2_1@1  (and b_2_1@0 (state Used_1Heap@0 Used_1Mask@0))) (= TempMask@0 (MapType1Store ZeroMask null (P l) (real_2_U FullPerm)))) (and (= b_2_1@2  (and b_2_1@1 (IdenticalOnKnownLocations Ops_1Heap@0 Used_1Heap@0 TempMask@0))) (= Ops_1Mask@2 (MapType1Store Ops_1Mask@1 null (P l) (real_2_U (- (U_2_real (MapType1Select Ops_1Mask@1 null (P l))) takeTransfer@0)))))) (and (and (= Ops_1Mask@3 Ops_1Mask@2) (= Used_1Mask@1 Used_1Mask@0)) (and (= b_2_1@3 b_2_1@2) (= neededTransfer@1 neededTransfer@0)))) (and (=> (= (ControlFlow 0 55) 53) anon53_Then_correct) (=> (= (ControlFlow 0 55) 48) anon53_Else_correct)))))))
...
(let ((anon50_Then_correct  (=> (and (and (and (and b_1_1@4 b_2_1@0) true) (> FullPerm 0.0)) (= maskTransfer@0 (U_2_real (MapType1Select Ops_1Mask@1 null (P l))))) (and (=> (= (ControlFlow 0 59) 57) anon51_Then_correct) (=> (= (ControlFlow 0 59) 58) anon51_Else_correct)))))
...
(let ((anon49_Then_correct  (=> b_1_1@4 (=> (and (and (|P#trigger| Ops_1Heap@0 (P l)) (= (MapType0Select Ops_1Heap@0 null (P l)) (CombineFrames (FrameFragment (MapType0Select Ops_1Heap@0 l h)) (FrameFragment (MapType0Select Ops_1Heap@0 (MapType0Select Ops_1Heap@0 l h) h))))) (and (= b_2_1@0  (and b_2_1 (state Used_1Heap@0 ZeroMask))) (= initNeededTransfer@0 (+ (U_2_real (MapType1Select ZeroMask null (P l))) FullPerm)))) (and (=> (= (ControlFlow 0 60) (- 0 61)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 60) 59) anon50_Then_correct) (=> (= (ControlFlow 0 60) 54) anon50_Else_correct))))))))
(let ((anon49_Else_correct  (=> (not b_1_1@4) (=> (and (and (= b_1_1@16 b_1_1@4) (= Mask@2 ZeroMask)) (and (= Ops_1Mask@6 Ops_1Mask@1) (= Heap@2 Heap@@11))) (and (=> (= (ControlFlow 0 45) 43) anon56_Then_correct) (=> (= (ControlFlow 0 45) 18) anon56_Else_correct))))))
...
(let ((anon48_Then_correct  (=> (and b_1_1@0 (= Ops_1Mask@0 (MapType1Store ZeroMask null (P l) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P l))) FullPerm))))) (=> (and (and (= b_1_1@1  (and b_1_1@0 (state Ops_1Heap@0 Ops_1Mask@0))) (= Ops_1Mask@1 Ops_1Mask@0)) (and (= b_1_1@2 b_1_1@1) (= (ControlFlow 0 63) 62))) anon2_correct))))
(let ((anon0_correct  (=> (and (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 l $allocated))) (and (= b_1_1@0  (and b_1_1 (state Ops_1Heap@0 ZeroMask))) (= b_2@0  (and b_2 (state UsedHeap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 65) 63) anon48_Then_correct) (=> (= (ControlFlow 0 65) 64) anon48_Else_correct)))))
