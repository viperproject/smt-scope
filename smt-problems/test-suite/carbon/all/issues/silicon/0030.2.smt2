...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@13 diz@@8 $allocated))) (=> (and (and (and (not (= diz@@8 null)) (state Heap@@13 ZeroMask)) (and (> wildcard@0 NoPerm) (= Mask@0 (MapType1Store ZeroMask null (C__P diz@@8) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (C__P diz@@8))) wildcard@0)))))) (and (and (state Heap@@13 Mask@0) (state Heap@@13 Mask@0)) (and (= perm@0 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))))) (>= perm@0 NoPerm))))))
