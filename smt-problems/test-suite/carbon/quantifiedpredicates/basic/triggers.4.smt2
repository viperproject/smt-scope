...
(assert  (and (and (and (and (and (and (and (= (type xs) (SeqType RefType)) (= (type x_7) RefType)) (= (type Heap@@18) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type y_5) RefType)) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv9 arg0@@45)) RefType)
 :qid |funType:invRecv9|
 :pattern ( (invRecv9 arg0@@45))
))) (= (type r_1@@13) RefType)))
(set-info :boogie-vc-id t5b)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon19_Then_correct true))
(let ((anon10_correct true))
(let ((anon18_Then_correct  (=> (|Seq#Contains| xs y_5) (and (=> (= (ControlFlow 0 13) 12) anon19_Then_correct) (=> (= (ControlFlow 0 13) 10) anon10_correct)))))
(let ((anon18_Else_correct  (=> (and (not (|Seq#Contains| xs y_5)) (= (ControlFlow 0 11) 10)) anon10_correct)))
...
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((y_2 T@U) (y_2_1 T@U) ) (!  (=> (and (= (type y_2) RefType) (= (type y_2_1) RefType)) (=> (and (and (and (and (not (= y_2 y_2_1)) (|Seq#Contains| xs y_2)) (|Seq#Contains| xs y_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (fun2 Heap@@18 y_2) (fun2 Heap@@18 y_2_1)))))
 :qid |stdinbpl.1465:17|
 :skolemid |136|
 :pattern ( (neverTriggered11 y_2) (neverTriggered11 y_2_1))
))) (=> (forall ((y_2@@0 T@U) (y_2_1@@0 T@U) ) (!  (=> (and (= (type y_2@@0) RefType) (= (type y_2_1@@0) RefType)) (=> (and (and (and (and (not (= y_2@@0 y_2_1@@0)) (|Seq#Contains| xs y_2@@0)) (|Seq#Contains| xs y_2_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (fun2 Heap@@18 y_2@@0) (fun2 Heap@@18 y_2_1@@0)))))
 :qid |stdinbpl.1465:17|
 :skolemid |136|
 :pattern ( (neverTriggered11 y_2@@0) (neverTriggered11 y_2_1@@0))
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((y_2@@1 T@U) ) (!  (=> (and (= (type y_2@@1) RefType) (|Seq#Contains| xs y_2@@1)) (>= (U_2_real (MapType1Select QPMask@0 (fun2 Heap@@18 y_2@@1) f_7)) FullPerm))
 :qid |stdinbpl.1472:17|
 :skolemid |137|
 :pattern ( (|fun2#frame| EmptyFrame y_2@@1))
 :pattern ( (|fun#frame| EmptyFrame y_2@@1 i@@10))
)))))))
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| xs x_1@@1) (< NoPerm FullPerm)) (and (qpRange9 (fun Heap@@18 x_1@@1 i@@10)) (= (invRecv9 (fun Heap@@18 x_1@@1 i@@10)) x_1@@1))))
 :qid |stdinbpl.1366:22|
 :skolemid |125|
 :pattern ( (|fun#frame| EmptyFrame x_1@@1 i@@10))
 :pattern ( (|fun2#frame| EmptyFrame x_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| xs (invRecv9 o_3)) (< NoPerm FullPerm)) (qpRange9 o_3)) (= (fun Heap@@18 (invRecv9 o_3) i@@10) o_3)))
 :qid |stdinbpl.1370:22|
 :skolemid |126|
 :pattern ( (invRecv9 o_3))
)) (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (|Seq#Contains| xs x_1@@2)) (not (= (fun Heap@@18 x_1@@2 i@@10) null)))
 :qid |stdinbpl.1376:22|
 :skolemid |127|
 :pattern ( (|fun#frame| EmptyFrame x_1@@2 i@@10))
 :pattern ( (|fun2#frame| EmptyFrame x_1@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| xs (invRecv9 o_3@@0)) (< NoPerm FullPerm)) (qpRange9 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (fun Heap@@18 (invRecv9 o_3@@0) i@@10) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| xs (invRecv9 o_3@@0)) (< NoPerm FullPerm)) (qpRange9 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.1382:22|
 :skolemid |128|
...
(let ((anon14_Then_correct  (=> (|Seq#Contains| xs x_7) (and (=> (= (ControlFlow 0 4) 3) anon15_Then_correct) (=> (= (ControlFlow 0 4) 1) anon4_correct)))))
(let ((anon14_Else_correct  (=> (and (not (|Seq#Contains| xs x_7)) (= (ControlFlow 0 2) 1)) anon4_correct)))
