...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 35) (let ((anon17_correct  (=> (and (= ExhaleWellDef0Mask@0 (MapType1Store Mask@6 null (lseg freshObj@0 null) (real_2_U (- (U_2_real (MapType1Select Mask@6 null (lseg freshObj@0 null))) FullPerm)))) (= (ControlFlow 0 14) (- 0 13))) (< 1 (length ExhaleHeap@1 freshObj@0 null)))))
(let ((anon27_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 17) 14)) anon17_correct)))
(let ((anon27_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= FullPerm (U_2_real (MapType1Select Mask@6 null (lseg freshObj@0 null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@6 null (lseg freshObj@0 null)))) (=> (= (ControlFlow 0 15) 14) anon17_correct))))))
(let ((anon26_Else_correct  (=> (= (ControlFlow 0 12) (- 0 11)) (= (get ExhaleHeap@1 freshObj@0 1 null) 1))))
(let ((anon24_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (= (get ExhaleHeap@1 freshObj@0 0 null) 0)) (=> (= (get ExhaleHeap@1 freshObj@0 0 null) 0) (=> (state ExhaleHeap@1 Mask@6) (and (and (=> (= (ControlFlow 0 18) 12) anon26_Else_correct) (=> (= (ControlFlow 0 18) 15) anon27_Then_correct)) (=> (= (ControlFlow 0 18) 17) anon27_Else_correct)))))))
(let ((anon13_correct  (=> (and (= ExhaleWellDef0Mask@1 (MapType1Store Mask@6 null (lseg freshObj@0 null) (real_2_U (- (U_2_real (MapType1Select Mask@6 null (lseg freshObj@0 null))) FullPerm)))) (= (ControlFlow 0 7) (- 0 6))) (< 0 (length ExhaleHeap@1 freshObj@0 null)))))
(let ((anon25_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 7)) anon13_correct)))
(let ((anon25_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select Mask@6 null (lseg freshObj@0 null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@6 null (lseg freshObj@0 null)))) (=> (= (ControlFlow 0 8) 7) anon13_correct))))))
(let ((anon10_correct  (=> (and (and (= Mask@5 (MapType1Store Mask@4 null (lseg freshObj@0 null) (real_2_U (- (U_2_real (MapType1Select Mask@4 null (lseg freshObj@0 null))) FullPerm)))) (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@1 Mask@5)) (and (= Mask@6 (MapType1Store Mask@5 null (lseg freshObj@0 null) (real_2_U (+ (U_2_real (MapType1Select Mask@5 null (lseg freshObj@0 null))) FullPerm)))) (state ExhaleHeap@1 Mask@6))) (=> (and (and (and (state ExhaleHeap@1 Mask@6) (= (length ExhaleHeap@1 freshObj@0 null) (+ (length ExhaleHeap@0 freshObj@0 null) 1))) (and (state ExhaleHeap@1 Mask@6) (forall ((i@@3 Int) ) (!  (=> (and (<= 0 i@@3) (< i@@3 (length ExhaleHeap@0 freshObj@0 null))) (= (get ExhaleHeap@1 freshObj@0 i@@3 null) (get ExhaleHeap@0 freshObj@0 i@@3 null)))
 :qid |stdinbpl.1664:22|
 :skolemid |48|
 :pattern ( (|get#frame| (MapType0Select ExhaleHeap@0 null (lseg freshObj@0 null)) freshObj@0 i@@3 null))
)))) (and (and (state ExhaleHeap@1 Mask@6) (= (get ExhaleHeap@1 freshObj@0 (- (length ExhaleHeap@1 freshObj@0 null) 1) null) 1)) (and (state ExhaleHeap@1 Mask@6) (state ExhaleHeap@1 Mask@6)))) (and (and (=> (= (ControlFlow 0 20) 18) anon24_Else_correct) (=> (= (ControlFlow 0 20) 8) anon25_Then_correct)) (=> (= (ControlFlow 0 20) 10) anon25_Else_correct))))))
(let ((anon23_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 23) 20)) anon10_correct)))
(let ((anon23_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (<= FullPerm (U_2_real (MapType1Select Mask@4 null (lseg freshObj@0 null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 null (lseg freshObj@0 null)))) (=> (= (ControlFlow 0 21) 20) anon10_correct))))))
(let ((anon21_Else_correct  (and (=> (= (ControlFlow 0 24) (- 0 25)) (= (get ExhaleHeap@0 freshObj@0 0 null) 0)) (=> (= (get ExhaleHeap@0 freshObj@0 0 null) 0) (=> (state ExhaleHeap@0 Mask@4) (and (=> (= (ControlFlow 0 24) 21) anon23_Then_correct) (=> (= (ControlFlow 0 24) 23) anon23_Else_correct)))))))
(let ((anon7_correct  (=> (and (= ExhaleWellDef0Mask@2 (MapType1Store Mask@4 null (lseg freshObj@0 null) (real_2_U (- (U_2_real (MapType1Select Mask@4 null (lseg freshObj@0 null))) FullPerm)))) (= (ControlFlow 0 2) (- 0 1))) (< 0 (length ExhaleHeap@0 freshObj@0 null)))))
(let ((anon22_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon22_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@4 null (lseg freshObj@0 null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 null (lseg freshObj@0 null)))) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon4_correct  (=> (and (= Mask@3 (MapType1Store Mask@2 freshObj@0 value (real_2_U (- (U_2_real (MapType1Select Mask@2 freshObj@0 value)) FullPerm)))) (IdenticalOnKnownLocations Heap@0 ExhaleHeap@0 Mask@3)) (=> (and (and (and (= Mask@4 (MapType1Store Mask@3 null (lseg freshObj@0 null) (real_2_U (+ (U_2_real (MapType1Select Mask@3 null (lseg freshObj@0 null))) FullPerm)))) (state ExhaleHeap@0 Mask@4)) (and (state ExhaleHeap@0 Mask@4) (= (length ExhaleHeap@0 freshObj@0 null) 1))) (and (and (state ExhaleHeap@0 Mask@4) (= (get ExhaleHeap@0 freshObj@0 0 null) 0)) (and (state ExhaleHeap@0 Mask@4) (state ExhaleHeap@0 Mask@4)))) (and (and (=> (= (ControlFlow 0 26) 24) anon21_Else_correct) (=> (= (ControlFlow 0 26) 3) anon22_Then_correct)) (=> (= (ControlFlow 0 26) 5) anon22_Else_correct))))))
(let ((anon20_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 29) 26)) anon4_correct)))
(let ((anon20_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (<= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 value)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 value))) (=> (= (ControlFlow 0 27) 26) anon4_correct))))))
(let ((anon2_correct  (=> (= Mask@2 (MapType1Store Mask@1 freshObj@0 next (real_2_U (- (U_2_real (MapType1Select Mask@1 freshObj@0 next)) FullPerm)))) (and (=> (= (ControlFlow 0 30) 27) anon20_Then_correct) (=> (= (ControlFlow 0 30) 29) anon20_Else_correct)))))
(let ((anon19_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 33) 30)) anon2_correct)))
(let ((anon19_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 31) (- 0 32)) (<= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 next)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 next))) (=> (= (ControlFlow 0 31) 30) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@19 n $allocated))) (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@19 freshObj@0 $allocated))))) (and (and (= Heap@0 (MapType0Store Heap@@19 freshObj@0 $allocated (bool_2_U true))) (= Mask@0 (MapType1Store ZeroMask freshObj@0 next (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 next)) FullPerm))))) (and (= Mask@1 (MapType1Store Mask@0 freshObj@0 value (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@0 value)) FullPerm)))) (state Heap@0 Mask@1)))) (and (=> (= (ControlFlow 0 34) 31) anon19_Then_correct) (=> (= (ControlFlow 0 34) 33) anon19_Else_correct))))))
