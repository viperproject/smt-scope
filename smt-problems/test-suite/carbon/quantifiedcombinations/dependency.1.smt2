...
(assert  (and (= (type Heap@@15) (MapType0Type RefType)) (= (type xs@@3) (SeqType RefType))))
(set-info :boogie-vc-id |get_val#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and (= AssumeFunctionsAbove 0) (<= 0 i@@16)) (and (< i@@16 (|Seq#Length| xs@@3)) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= i@@16 0)) (=> (>= i@@16 0) (=> (= (ControlFlow 0 2) (- 0 1)) (< i@@16 (|Seq#Length| xs@@3)))))))))
