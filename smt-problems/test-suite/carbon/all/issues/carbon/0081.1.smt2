...
(assert (forall ((Heap@@2 T@U) (self@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type self@@0) RefType)) (|valid#everUsed| (valid self@@0)))
 :qid |stdinbpl.216:15|
 :skolemid |27|
 :pattern ( (|valid#trigger| Heap@@2 (valid self@@0)))
)))
...
(assert (forall ((self@@1 T@U) (self2 T@U) ) (!  (=> (and (and (= (type self@@1) RefType) (= (type self2) RefType)) (= (valid self@@1) (valid self2))) (= self@@1 self2))
 :qid |stdinbpl.207:15|
 :skolemid |25|
...
(assert (forall ((self@@2 T@U) (self2@@0 T@U) ) (!  (=> (and (and (= (type self@@2) RefType) (= (type self2@@0) RefType)) (= (|valid#sm| self@@2) (|valid#sm| self2@@0))) (= self@@2 self2@@0))
 :qid |stdinbpl.211:15|
 :skolemid |26|
...
(assert (forall ((self@@3 T@U) ) (!  (=> (= (type self@@3) RefType) (= (getPredWandId (valid self@@3)) 0))
 :qid |stdinbpl.201:15|
 :skolemid |24|
...
(assert (forall ((self@@4 T@U) ) (!  (=> (= (type self@@4) RefType) (= (PredicateMaskField (valid self@@4)) (|valid#sm| self@@4)))
 :qid |stdinbpl.193:15|
 :skolemid |22|
 :pattern ( (PredicateMaskField (valid self@@4)))
)))
...
(assert  (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type a_2) RefType)) (= (type Heap@@10) (MapType0Type RefType))))
...
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid a_2))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid a_2)))) (=> (= (ControlFlow 0 3) 2) anon4_correct))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (= (U_2_real (MapType1Select Mask@0 a_2 f_7)) NoPerm)) (=> (= (U_2_real (MapType1Select Mask@0 a_2 f_7)) NoPerm) (=> (state Heap@@10 Mask@0) (and (=> (= (ControlFlow 0 6) 3) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@10 a_2 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (valid a_2) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid a_2))) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 8) 1) anon5_Then_correct) (=> (= (ControlFlow 0 8) 6) anon5_Else_correct))))))
