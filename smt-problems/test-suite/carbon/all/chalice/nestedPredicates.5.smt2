...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 43) (let ((anon12_correct  (=> (and (state Heap@13 Mask@14) (state Heap@13 Mask@14)) (and (=> (= (ControlFlow 0 2) (- 0 10)) (HasDirectPerm Mask@14 this@@21 next)) (=> (HasDirectPerm Mask@14 this@@21 next) (and (=> (= (ControlFlow 0 2) (- 0 9)) (not (= this@@21 (MapType0Select Heap@13 this@@21 next)))) (=> (not (= this@@21 (MapType0Select Heap@13 this@@21 next))) (=> (state Heap@13 Mask@14) (and (=> (= (ControlFlow 0 2) (- 0 8)) (HasDirectPerm Mask@14 this@@21 next)) (=> (HasDirectPerm Mask@14 this@@21 next) (and (=> (= (ControlFlow 0 2) (- 0 7)) (HasDirectPerm Mask@14 this@@21 next)) (=> (HasDirectPerm Mask@14 this@@21 next) (and (=> (= (ControlFlow 0 2) (- 0 6)) (HasDirectPerm Mask@14 (MapType0Select Heap@13 this@@21 next) next)) (=> (HasDirectPerm Mask@14 (MapType0Select Heap@13 this@@21 next) next) (and (=> (= (ControlFlow 0 2) (- 0 5)) (not (= (MapType0Select Heap@13 this@@21 next) (MapType0Select Heap@13 (MapType0Select Heap@13 this@@21 next) next)))) (=> (not (= (MapType0Select Heap@13 this@@21 next) (MapType0Select Heap@13 (MapType0Select Heap@13 this@@21 next) next))) (=> (state Heap@13 Mask@14) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@14 this@@21 next)) (=> (HasDirectPerm Mask@14 this@@21 next) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@14 (MapType0Select Heap@13 this@@21 next) next)) (=> (HasDirectPerm Mask@14 (MapType0Select Heap@13 this@@21 next) next) (=> (= (ControlFlow 0 2) (- 0 1)) (not (= this@@21 (MapType0Select Heap@13 (MapType0Select Heap@13 this@@21 next) next)))))))))))))))))))))))))
(let ((anon18_Else_correct  (=> (= (MapType0Select Heap@11 this@@21 next) null) (=> (and (= Heap@13 Heap@11) (= (ControlFlow 0 12) 2)) anon12_correct))))
(let ((anon18_Then_correct  (=> (not (= (MapType0Select Heap@11 this@@21 next) null)) (=> (and (and (forall ((o_30 T@U) (f_34 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_34))))
(let ((A@@12 (FieldTypeInv0 (type f_34))))
 (=> (and (and (= (type o_30) RefType) (= (type f_34) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@11 null (|p#sm| this@@21)) o_30 f_34)) (U_2_bool (MapType1Select (MapType0Select Heap@11 null (|q#sm| (MapType0Select Heap@11 this@@21 next))) o_30 f_34)))) (U_2_bool (MapType1Select newPMask@1 o_30 f_34)))))
 :qid |stdinbpl.2028:29|
 :skolemid |71|
 :pattern ( (MapType1Select newPMask@1 o_30 f_34))
)) (= Heap@12 (MapType0Store Heap@11 null (|p#sm| this@@21) newPMask@1))) (and (= Heap@13 Heap@12) (= (ControlFlow 0 11) 2))) anon12_correct))))
(let ((anon10_correct  (=> (and (= Heap@10 (MapType0Store Heap@9 null (|p#sm| this@@21) (MapType1Store (MapType0Select Heap@9 null (|p#sm| this@@21)) this@@21 next (bool_2_U true)))) (= Heap@11 (MapType0Store Heap@10 null (|p#sm| this@@21) (MapType1Store (MapType0Select Heap@10 null (|p#sm| this@@21)) this@@21 value (bool_2_U true))))) (and (=> (= (ControlFlow 0 13) 11) anon18_Then_correct) (=> (= (ControlFlow 0 13) 12) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (HasDirectPerm Mask@14 null (p_1 this@@21)) (=> (and (= Heap@9 Heap@6) (= (ControlFlow 0 15) 13)) anon10_correct))))
(let ((anon17_Then_correct  (=> (not (HasDirectPerm Mask@14 null (p_1 this@@21))) (=> (and (and (= Heap@7 (MapType0Store Heap@6 null (|p#sm| this@@21) ZeroPMask)) (= Heap@8 (MapType0Store Heap@7 null (p_1 this@@21) freshVersion@1))) (and (= Heap@9 Heap@8) (= (ControlFlow 0 14) 13))) anon10_correct))))
(let ((anon8_correct  (=> (and (> wildcard@12 NoPerm) (= Mask@14 (MapType1Store Mask@13 null (p_1 this@@21) (real_2_U (+ (U_2_real (MapType1Select Mask@13 null (p_1 this@@21))) wildcard@12))))) (=> (and (and (state Heap@6 Mask@14) (state Heap@6 Mask@14)) (and (|p#trigger| Heap@6 (p_1 this@@21)) (= (MapType0Select Heap@6 null (p_1 this@@21)) (CombineFrames (FrameFragment (MapType0Select Heap@6 this@@21 next)) (CombineFrames (FrameFragment (MapType0Select Heap@6 this@@21 value)) (FrameFragment (ite (not (= (MapType0Select Heap@6 this@@21 next) null)) (MapType0Select Heap@6 null (q_1 (MapType0Select Heap@6 this@@21 next))) EmptyFrame))))))) (and (=> (= (ControlFlow 0 16) 14) anon17_Then_correct) (=> (= (ControlFlow 0 16) 15) anon17_Else_correct))))))
(let ((anon16_Else_correct  (=> (= (MapType0Select Heap@6 this@@21 next) null) (=> (and (= Mask@13 Mask@11) (= (ControlFlow 0 19) 16)) anon8_correct))))
(let ((anon16_Then_correct  (=> (not (= (MapType0Select Heap@6 this@@21 next) null)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (> (U_2_real (MapType1Select Mask@11 null (q_1 (MapType0Select Heap@6 this@@21 next)))) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@11 null (q_1 (MapType0Select Heap@6 this@@21 next)))) NoPerm) (=> (and (> wildcard@11 NoPerm) (< wildcard@11 (U_2_real (MapType1Select Mask@11 null (q_1 (MapType0Select Heap@6 this@@21 next)))))) (=> (and (and (= Mask@12 (MapType1Store Mask@11 null (q_1 (MapType0Select Heap@6 this@@21 next)) (real_2_U (- (U_2_real (MapType1Select Mask@11 null (q_1 (MapType0Select Heap@6 this@@21 next)))) wildcard@11)))) (InsidePredicate (p_1 this@@21) (MapType0Select Heap@6 null (p_1 this@@21)) (q_1 (MapType0Select Heap@6 this@@21 next)) (MapType0Select Heap@6 null (q_1 (MapType0Select Heap@6 this@@21 next))))) (and (= Mask@13 Mask@12) (= (ControlFlow 0 17) 16))) anon8_correct)))))))
(let ((anon6_correct  (=> (and (state Heap@6 Mask@9) (state Heap@6 Mask@9)) (and (=> (= (ControlFlow 0 20) (- 0 22)) (> (U_2_real (MapType1Select Mask@9 this@@21 next)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@9 this@@21 next)) NoPerm) (=> (> wildcard@9 NoPerm) (=> (and (< wildcard@9 (U_2_real (MapType1Select Mask@9 this@@21 next))) (= Mask@10 (MapType1Store Mask@9 this@@21 next (real_2_U (- (U_2_real (MapType1Select Mask@9 this@@21 next)) wildcard@9))))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (> (U_2_real (MapType1Select Mask@10 this@@21 value)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@10 this@@21 value)) NoPerm) (=> (> wildcard@10 NoPerm) (=> (and (< wildcard@10 (U_2_real (MapType1Select Mask@10 this@@21 value))) (= Mask@11 (MapType1Store Mask@10 this@@21 value (real_2_U (- (U_2_real (MapType1Select Mask@10 this@@21 value)) wildcard@10))))) (and (=> (= (ControlFlow 0 20) 17) anon16_Then_correct) (=> (= (ControlFlow 0 20) 19) anon16_Else_correct)))))))))))))
(let ((anon15_Else_correct  (=> (= (MapType0Select Heap@4 (MapType0Select Heap@4 this@@21 next) next) null) (=> (and (= Heap@6 Heap@4) (= (ControlFlow 0 24) 20)) anon6_correct))))
(let ((anon15_Then_correct  (=> (not (= (MapType0Select Heap@4 (MapType0Select Heap@4 this@@21 next) next) null)) (=> (and (and (forall ((o_29 T@U) (f_33 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_33))))
(let ((A@@13 (FieldTypeInv0 (type f_33))))
 (=> (and (and (= (type o_29) RefType) (= (type f_33) (FieldType A@@13 B@@12))) (or (U_2_bool (MapType1Select (MapType0Select Heap@4 null (|q#sm| (MapType0Select Heap@4 this@@21 next))) o_29 f_33)) (U_2_bool (MapType1Select (MapType0Select Heap@4 null (|p#sm| (MapType0Select Heap@4 (MapType0Select Heap@4 this@@21 next) next))) o_29 f_33)))) (U_2_bool (MapType1Select newPMask@0 o_29 f_33)))))
 :qid |stdinbpl.1980:29|
 :skolemid |70|
 :pattern ( (MapType1Select newPMask@0 o_29 f_33))
)) (= Heap@5 (MapType0Store Heap@4 null (|q#sm| (MapType0Select Heap@4 this@@21 next)) newPMask@0))) (and (= Heap@6 Heap@5) (= (ControlFlow 0 23) 20))) anon6_correct))))
