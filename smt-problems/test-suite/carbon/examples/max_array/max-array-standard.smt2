...
(assert  (and (and (and (and (and (= (type a_3@@1) IArrayDomainTypeType) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id client)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon9_correct  (=> (forall ((j$2_3 Int) ) (!  (=> (and (<= 0 j$2_3) (< j$2_3 (len a_3@@1))) (<= (U_2_int (MapType0Select ExhaleHeap@0 (loc a_3@@1 j$2_3) val)) (U_2_int (MapType0Select ExhaleHeap@0 (loc a_3@@1 x@0) val))))
 :qid |stdinbpl.1105:22|
 :skolemid |106|
 :pattern ( (loc a_3@@1 j$2_3))
)) (=> (and (state ExhaleHeap@0 QPMask@2) (state ExhaleHeap@0 QPMask@2)) (and (=> (= (ControlFlow 0 7) (- 0 13)) (HasDirectPerm QPMask@2 (loc a_3@@1 0) val)) (=> (HasDirectPerm QPMask@2 (loc a_3@@1 0) val) (and (=> (= (ControlFlow 0 7) (- 0 12)) (<= (U_2_int (MapType0Select ExhaleHeap@0 (loc a_3@@1 0) val)) x@0)) (=> (<= (U_2_int (MapType0Select ExhaleHeap@0 (loc a_3@@1 0) val)) x@0) (=> (state ExhaleHeap@0 QPMask@2) (and (=> (= (ControlFlow 0 7) (- 0 11)) (HasDirectPerm QPMask@2 (loc a_3@@1 (- (len a_3@@1) 1)) val)) (=> (HasDirectPerm QPMask@2 (loc a_3@@1 (- (len a_3@@1) 1)) val) (and (=> (= (ControlFlow 0 7) (- 0 10)) (= x@0 (U_2_int (MapType0Select ExhaleHeap@0 (loc a_3@@1 (- (len a_3@@1) 1)) val)))) (=> (= x@0 (U_2_int (MapType0Select ExhaleHeap@0 (loc a_3@@1 (- (len a_3@@1) 1)) val))) (=> (state ExhaleHeap@0 QPMask@2) (and (=> (= (ControlFlow 0 7) (- 0 9)) (= x@0 2)) (=> (= x@0 2) (=> (state ExhaleHeap@0 QPMask@2) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm QPMask@2 (loc a_3@@1 1) val)) (=> (HasDirectPerm QPMask@2 (loc a_3@@1 1) val) (=> (= (ControlFlow 0 7) (- 0 6)) (< (U_2_int (MapType0Select ExhaleHeap@0 (loc a_3@@1 1) val)) x@0)))))))))))))))))))))
(let ((anon13_Else_correct  (=> (and (and (not (= (len a_3@@1) 0)) (<= 0 x@0)) (and (< x@0 (len a_3@@1)) (= (ControlFlow 0 15) 7))) anon9_correct)))
(let ((anon13_Then_correct  (=> (= (len a_3@@1) 0) (=> (and (= x@0 (- 0 1)) (= (ControlFlow 0 14) 7)) anon9_correct))))
(let ((anon11_Else_correct  (=> (forall ((i_1_1 Int) ) (!  (=> (and (<= 0 i_1_1) (< i_1_1 (len a_3@@1))) (= (U_2_int (MapType0Select Heap@@9 (loc a_3@@1 i_1_1) val)) i_1_1))
 :qid |stdinbpl.997:20|
 :skolemid |92|
 :pattern ( (loc a_3@@1 i_1_1))
)) (=> (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)) (and (=> (= (ControlFlow 0 16) (- 0 19)) (forall ((j_2 Int) (j_2_1 Int) ) (!  (=> (and (and (and (and (not (= j_2 j_2_1)) (and (<= 0 j_2) (< j_2 (len a_3@@1)))) (and (<= 0 j_2_1) (< j_2_1 (len a_3@@1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 j_2) (loc a_3@@1 j_2_1))))
 :qid |stdinbpl.1018:19|
 :skolemid |93|
 :pattern ( (neverTriggered10 j_2) (neverTriggered10 j_2_1))
))) (=> (forall ((j_2@@0 Int) (j_2_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_2@@0 j_2_1@@0)) (and (<= 0 j_2@@0) (< j_2@@0 (len a_3@@1)))) (and (<= 0 j_2_1@@0) (< j_2_1@@0 (len a_3@@1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 j_2@@0) (loc a_3@@1 j_2_1@@0))))
 :qid |stdinbpl.1018:19|
 :skolemid |93|
 :pattern ( (neverTriggered10 j_2@@0) (neverTriggered10 j_2_1@@0))
)) (and (=> (= (ControlFlow 0 16) (- 0 18)) (forall ((j_2@@1 Int) ) (!  (=> (and (<= 0 j_2@@1) (< j_2@@1 (len a_3@@1))) (>= (U_2_real (MapType1Select QPMask@0 (loc a_3@@1 j_2@@1) val)) FullPerm))
 :qid |stdinbpl.1025:19|
 :skolemid |94|
 :pattern ( (loc a_3@@1 j_2@@1))
 :pattern ( (loc a_3@@1 j_2@@1))
))) (=> (forall ((j_2@@2 Int) ) (!  (=> (and (<= 0 j_2@@2) (< j_2@@2 (len a_3@@1))) (>= (U_2_real (MapType1Select QPMask@0 (loc a_3@@1 j_2@@2) val)) FullPerm))
 :qid |stdinbpl.1025:19|
 :skolemid |94|
 :pattern ( (loc a_3@@1 j_2@@2))
 :pattern ( (loc a_3@@1 j_2@@2))
)) (=> (forall ((j_2@@3 Int) ) (!  (=> (and (and (<= 0 j_2@@3) (< j_2@@3 (len a_3@@1))) (< NoPerm FullPerm)) (and (qpRange10 (loc a_3@@1 j_2@@3)) (= (invRecv10 (loc a_3@@1 j_2@@3)) j_2@@3)))
 :qid |stdinbpl.1031:24|
 :skolemid |95|
 :pattern ( (loc a_3@@1 j_2@@3))
 :pattern ( (loc a_3@@1 j_2@@3))
)) (=> (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (<= 0 (invRecv10 o_3)) (< (invRecv10 o_3) (len a_3@@1))) (and (< NoPerm FullPerm) (qpRange10 o_3))) (= (loc a_3@@1 (invRecv10 o_3)) o_3)))
 :qid |stdinbpl.1035:24|
 :skolemid |96|
 :pattern ( (invRecv10 o_3))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (<= 0 (invRecv10 o_3@@0)) (< (invRecv10 o_3@@0) (len a_3@@1))) (and (< NoPerm FullPerm) (qpRange10 o_3@@0))) (and (= (loc a_3@@1 (invRecv10 o_3@@0)) o_3@@0) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 val)) (- (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) FullPerm)))) (=> (not (and (and (<= 0 (invRecv10 o_3@@0)) (< (invRecv10 o_3@@0) (len a_3@@1))) (and (< NoPerm FullPerm) (qpRange10 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 val)) (U_2_real (MapType1Select QPMask@0 o_3@@0 val))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.1047:31|
 :skolemid |98|
 :pattern ( (MapType1Select QPMask@1 o_3@@1 f_5))
)) (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 QPMask@1))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((j$0 Int) (j$0_3 Int) ) (!  (=> (and (and (and (and (not (= j$0 j$0_3)) (and (<= 0 j$0) (< j$0 (len a_3@@1)))) (and (<= 0 j$0_3) (< j$0_3 (len a_3@@1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 j$0) (loc a_3@@1 j$0_3))))
 :qid |stdinbpl.1063:17|
 :skolemid |99|
))) (=> (forall ((j$0@@0 Int) (j$0_3@@0 Int) ) (!  (=> (and (and (and (and (not (= j$0@@0 j$0_3@@0)) (and (<= 0 j$0@@0) (< j$0@@0 (len a_3@@1)))) (and (<= 0 j$0_3@@0) (< j$0_3@@0 (len a_3@@1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 j$0@@0) (loc a_3@@1 j$0_3@@0))))
 :qid |stdinbpl.1063:17|
 :skolemid |99|
)) (=> (forall ((j$0@@1 Int) ) (!  (=> (and (and (<= 0 j$0@@1) (< j$0@@1 (len a_3@@1))) (< NoPerm FullPerm)) (and (qpRange11 (loc a_3@@1 j$0@@1)) (= (invRecv11 (loc a_3@@1 j$0@@1)) j$0@@1)))
 :qid |stdinbpl.1069:24|
 :skolemid |100|
 :pattern ( (loc a_3@@1 j$0@@1))
 :pattern ( (loc a_3@@1 j$0@@1))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (<= 0 (invRecv11 o_3@@2)) (< (invRecv11 o_3@@2) (len a_3@@1))) (< NoPerm FullPerm)) (qpRange11 o_3@@2)) (= (loc a_3@@1 (invRecv11 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.1073:24|
 :skolemid |101|
 :pattern ( (invRecv11 o_3@@2))
)) (forall ((j$0@@2 Int) ) (!  (=> (and (<= 0 j$0@@2) (< j$0@@2 (len a_3@@1))) (not (= (loc a_3@@1 j$0@@2) null)))
 :qid |stdinbpl.1079:24|
 :skolemid |102|
 :pattern ( (loc a_3@@1 j$0@@2))
 :pattern ( (loc a_3@@1 j$0@@2))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (and (<= 0 (invRecv11 o_3@@3)) (< (invRecv11 o_3@@3) (len a_3@@1))) (< NoPerm FullPerm)) (qpRange11 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@1 (invRecv11 o_3@@3)) o_3@@3)) (= (U_2_real (MapType1Select QPMask@2 o_3@@3 val)) (+ (U_2_real (MapType1Select QPMask@1 o_3@@3 val)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv11 o_3@@3)) (< (invRecv11 o_3@@3) (len a_3@@1))) (< NoPerm FullPerm)) (qpRange11 o_3@@3))) (= (U_2_real (MapType1Select QPMask@2 o_3@@3 val)) (U_2_real (MapType1Select QPMask@1 o_3@@3 val))))))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 ...
 :qid |stdinbpl.1089:31|
 :skolemid |104|
 :pattern ( (MapType1Select QPMask@1 o_3@@4 f_5@@0))
 :pattern ( (MapType1Select QPMask@2 o_3@@4 f_5@@0))
))) (and (state ExhaleHeap@0 QPMask@2) (forall ((j$1_3 Int) ) (!  (=> (and (<= 0 j$1_3) (< j$1_3 (len a_3@@1))) (= (U_2_int (MapType0Select ExhaleHeap@0 (loc a_3@@1 j$1_3) val)) (U_2_int (MapType0Select Heap@@9 (loc a_3@@1 j$1_3) val))))
 :qid |stdinbpl.1095:22|
 :skolemid |105|
 :pattern ( (loc a_3@@1 j$1_3))
)))) (and (=> (= (ControlFlow 0 16) 14) anon13_Then_correct) (=> (= (ControlFlow 0 16) 15) anon13_Else_correct)))))))))))))))))
(let ((anon5_correct true))
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 (len a_3@@1)))) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon12_Then_correct  (=> (and (<= 0 i_2) (< i_2 (len a_3@@1))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 (loc a_3@@1 i_2) val)) (=> (HasDirectPerm QPMask@0 (loc a_3@@1 i_2) val) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((j_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (and (not (= j_1 j_1_1)) (and (<= 0 j_1) (< j_1 (len a_3@@1)))) (and (<= 0 j_1_1) (< j_1_1 (len a_3@@1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 j_1) (loc a_3@@1 j_1_1))))
 :qid |stdinbpl.950:15|
 :skolemid |86|
 ...
 :qid |stdinbpl.950:15|
 :skolemid |86|
)) (=> (and (and (and (forall ((j_1@@1 Int) ) (!  (=> (and (and (<= 0 j_1@@1) (< j_1@@1 (len a_3@@1))) (< NoPerm FullPerm)) (and (qpRange9 (loc a_3@@1 j_1@@1)) (= (invRecv9 (loc a_3@@1 j_1@@1)) j_1@@1)))
 :qid |stdinbpl.956:22|
 :skolemid |87|
 :pattern ( (loc a_3@@1 j_1@@1))
 :pattern ( (loc a_3@@1 j_1@@1))
)) (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (and (<= 0 (invRecv9 o_3@@5)) (< (invRecv9 o_3@@5) (len a_3@@1))) (< NoPerm FullPerm)) (qpRange9 o_3@@5)) (= (loc a_3@@1 (invRecv9 o_3@@5)) o_3@@5)))
 :qid |stdinbpl.960:22|
 :skolemid |88|
 :pattern ( (invRecv9 o_3@@5))
))) (and (forall ((j_1@@2 Int) ) (!  (=> (and (<= 0 j_1@@2) (< j_1@@2 (len a_3@@1))) (not (= (loc a_3@@1 j_1@@2) null)))
 :qid |stdinbpl.966:22|
 :skolemid |89|
 :pattern ( (loc a_3@@1 j_1@@2))
 :pattern ( (loc a_3@@1 j_1@@2))
)) (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (and (<= 0 (invRecv9 o_3@@6)) (< (invRecv9 o_3@@6) (len a_3@@1))) (< NoPerm FullPerm)) (qpRange9 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@1 (invRecv9 o_3@@6)) o_3@@6)) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@6 val)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv9 o_3@@6)) (< (invRecv9 o_3@@6) (len a_3@@1))) (< NoPerm FullPerm)) (qpRange9 o_3@@6))) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 val)) (U_2_real (MapType1Select ZeroMask o_3@@6 val))))))
 :qid |stdinbpl.972:22|
 :skolemid |90|
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (and (=> (= (ControlFlow 0 20) 16) anon11_Else_correct) (=> (= (ControlFlow 0 20) 3) anon12_Then_correct)) (=> (= (ControlFlow 0 20) 5) anon12_Else_correct)))))))
(let ((anon10_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (= (len a_3@@1) 3)) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 22) 1) anon10_Then_correct) (=> (= (ControlFlow 0 22) 20) anon10_Else_correct)))))
