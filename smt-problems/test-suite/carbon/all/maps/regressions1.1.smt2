...
(assert  (and (= (type Heap@@9) (MapType1Type RefType)) (= (type m@@23) (MapType intType RefType))))
(set-info :boogie-vc-id test1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U x@@21))) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U x@@21)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U x@@21))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm ZeroMask (MapType0Select (|Map#Elements| m@@23) (int_2_U x@@21)) val)) (=> (HasDirectPerm ZeroMask (MapType0Select (|Map#Elements| m@@23) (int_2_U x@@21)) val) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 (U_2_int (MapType1Select Heap@@9 (MapType0Select (|Map#Elements| m@@23) (int_2_U x@@21)) val))))))))))))
