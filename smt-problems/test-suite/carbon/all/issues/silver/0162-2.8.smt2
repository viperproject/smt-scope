...
(assert (forall ((self T@U) ) (!  (=> (= (type self) RefType) (IsPredicateField (Tree self)))
 :qid |stdinbpl.194:15|
 :skolemid |23|
 :pattern ( (Tree self))
)))
(assert (forall ((Heap@@2 T@U) (self@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type self@@0) RefType)) (|Tree#everUsed| (Tree self@@0)))
 :qid |stdinbpl.213:15|
 :skolemid |27|
 :pattern ( (|Tree#trigger| Heap@@2 (Tree self@@0)))
)))
...
(assert (forall ((self@@1 T@U) (self2 T@U) ) (!  (=> (and (and (= (type self@@1) RefType) (= (type self2) RefType)) (= (Tree self@@1) (Tree self2))) (= self@@1 self2))
 :qid |stdinbpl.204:15|
 :skolemid |25|
...
(assert (forall ((self@@2 T@U) (self2@@0 T@U) ) (!  (=> (and (and (= (type self@@2) RefType) (= (type self2@@0) RefType)) (= (|Tree#sm| self@@2) (|Tree#sm| self2@@0))) (= self@@2 self2@@0))
 :qid |stdinbpl.208:15|
 :skolemid |26|
...
(assert (forall ((self@@3 T@U) ) (!  (=> (= (type self@@3) RefType) (= (getPredWandId (Tree self@@3)) 0))
 :qid |stdinbpl.198:15|
 :skolemid |24|
 :pattern ( (Tree self@@3))
)))
...
(assert (forall ((self@@4 T@U) ) (!  (=> (= (type self@@4) RefType) (= (PredicateMaskField (Tree self@@4)) (|Tree#sm| self@@4)))
 :qid |stdinbpl.190:15|
 :skolemid |22|
 :pattern ( (PredicateMaskField (Tree self@@4)))
)))
...
(assert  (and (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type x@@8) RefType)) (= (type y@@1) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id testAcc6)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@10 x@@8 $allocated)) (U_2_bool (MapType0Select Heap@@10 y@@1 $allocated))) (and (not (= x@@8 null)) (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm)))))) (=> (and (and (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (not (= y@@1 null)) (= Mask@1 (MapType1Store Mask@0 y@@1 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@1 f_7)) FullPerm)))))) (and (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1)) (and (state Heap@@10 Mask@1) (= (ControlFlow 0 2) (- 0 1))))) (not (= x@@8 y@@1)))))))
