...
(assert  (and (and (and (and (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (forall ((arg0@@37 T@U) ) (! (= (type (invRecv1 arg0@@37)) RefType)
 :qid |funType:invRecv1|
 :pattern ( (invRecv1 arg0@@37))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@38 T@U) ) (! (= (type (invRecv2 arg0@@38)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@38))
))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (forall ((arg0@@39 T@U) ) (! (= (type (invRecv3 arg0@@39)) RefType)
 :qid |funType:invRecv3|
 :pattern ( (invRecv3 arg0@@39))
))) (= (type r_1@@5) RefType)))
(set-info :boogie-vc-id t1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon3_Else_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 3) (- 0 11)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (not (= x_1 x_1_1)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.717:17|
 :skolemid |64|
...
)) (=> (and (and (and (forall ((x_1@@1 T@U) ) (!  (=> (and (= (type x_1@@1) RefType) (< NoPerm wildcard@0)) (and (= (invRecv1 x_1@@1) x_1@@1) (qpRange1 x_1@@1)))
 :qid |stdinbpl.723:22|
 :skolemid |65|
 :pattern ( (MapType0Select Heap@@10 null (pred x_1@@1)))
 :pattern ( (MapType1Select ZeroMask null (pred x_1@@1)))
 :pattern ( (MapType0Select Heap@@10 null (pred x_1@@1)))
)) (forall ((r_1_1 T@U) ) (!  (=> (= (type r_1_1) RefType) (=> (and (< NoPerm wildcard@0) (qpRange1 r_1_1)) (= (invRecv1 r_1_1) r_1_1)))
 :qid |stdinbpl.727:22|
 :skolemid |66|
 :pattern ( (invRecv1 r_1_1))
))) (and (forall ((r_1_1@@0 T@U) ) (!  (=> (= (type r_1_1@@0) RefType) (=> (and (< NoPerm wildcard@0) (qpRange1 r_1_1@@0)) (and (=> (< NoPerm wildcard@0) (= (invRecv1 r_1_1@@0) r_1_1@@0)) (= (U_2_real (MapType1Select QPMask@0 null (pred r_1_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (pred r_1_1@@0))) wildcard@0)))))
 :qid |stdinbpl.733:22|
 :skolemid |67|
...
)))) (and (and (forall ((r_1_1@@1 T@U) ) (!  (=> (and (= (type r_1_1@@1) RefType) (not (and (< NoPerm wildcard@0) (qpRange1 r_1_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (pred r_1_1@@1))) (U_2_real (MapType1Select ZeroMask null (pred r_1_1@@1)))))
 :qid |stdinbpl.743:22|
 :skolemid |69|
 :pattern ( (MapType1Select QPMask@0 null (pred r_1_1@@1)))
)) (state Heap@@10 QPMask@0)) (and (state Heap@@10 QPMask@0) (> wildcard@1 0.0)))) (and (=> (= (ControlFlow 0 3) (- 0 10)) (forall ((x_3 T@U) ) (!  (=> (= (type x_3) RefType) (> (U_2_real (MapType1Select QPMask@0 null (pred x_3))) NoPerm))
 :qid |stdinbpl.768:17|
 :skolemid |70|
 :no-pattern (type x_3)
 :no-pattern (U_2_int x_3)
 :no-pattern (U_2_bool x_3)
))) (=> (forall ((x_3@@0 T@U) ) (!  (=> (= (type x_3@@0) RefType) (> (U_2_real (MapType1Select QPMask@0 null (pred x_3@@0))) NoPerm))
 :qid |stdinbpl.768:17|
 :skolemid |70|
 :no-pattern (type x_3@@0)
 :no-pattern (U_2_int x_3@@0)
 :no-pattern (U_2_bool x_3@@0)
)) (=> (forall ((x_3@@1 T@U) ) (!  (=> (= (type x_3@@1) RefType) (< wildcard@1 (U_2_real (MapType1Select QPMask@0 null (pred x_3@@1)))))
 :qid |stdinbpl.772:22|
 :skolemid |71|
 :no-pattern (type x_3@@1)
 :no-pattern (U_2_int x_3@@1)
 :no-pattern (U_2_bool x_3@@1)
)) (and (=> (= (ControlFlow 0 3) (- 0 9)) (forall ((r_2_1 T@U) ) (!  (=> (and (= (type r_2_1) RefType) (qpRange2 r_2_1)) (>= wildcard@1 NoPerm))
 :qid |stdinbpl.779:19|
 :skolemid |72|
 :pattern ( (invRecv2 r_2_1))
))) (=> (forall ((r_2_1@@0 T@U) ) (!  (=> (and (= (type r_2_1@@0) RefType) (qpRange2 r_2_1@@0)) (>= wildcard@1 NoPerm))
 :qid |stdinbpl.779:19|
 :skolemid |72|
 :pattern ( (invRecv2 r_2_1@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 8)) (forall ((x_3@@2 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3@@2) RefType) (= (type x_3_1) RefType)) (=> (and (and (not (= x_3@@2 x_3_1)) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= x_3@@2 x_3_1))))
 :qid |stdinbpl.786:19|
 :skolemid |73|
 :pattern ( (neverTriggered2 x_3@@2) (neverTriggered2 x_3_1))
))) (=> (forall ((x_3@@3 T@U) (x_3_1@@0 T@U) ) (!  (=> (and (= (type x_3@@3) RefType) (= (type x_3_1@@0) RefType)) (=> (and (and (not (= x_3@@3 x_3_1@@0)) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= x_3@@3 x_3_1@@0))))
 :qid |stdinbpl.786:19|
 :skolemid |73|
 :pattern ( (neverTriggered2 x_3@@3) (neverTriggered2 x_3_1@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (forall ((x_3@@4 T@U) ) (!  (=> (= (type x_3@@4) RefType) (> (U_2_real (MapType1Select QPMask@0 null (pred x_3@@4))) 0.0))
 :qid |stdinbpl.793:19|
 :skolemid |74|
 :pattern ( (MapType0Select Heap@@10 null (pred x_3@@4)))
 :pattern ( (MapType1Select QPMask@0 null (pred x_3@@4)))
 :pattern ( (MapType0Select Heap@@10 null (pred x_3@@4)))
))) (=> (forall ((x_3@@5 T@U) ) (!  (=> (= (type x_3@@5) RefType) (> (U_2_real (MapType1Select QPMask@0 null (pred x_3@@5))) 0.0))
 :qid |stdinbpl.793:19|
 :skolemid |74|
 :pattern ( (MapType0Select Heap@@10 null (pred x_3@@5)))
 :pattern ( (MapType1Select QPMask@0 null (pred x_3@@5)))
 :pattern ( (MapType0Select Heap@@10 null (pred x_3@@5)))
)) (=> (forall ((x_3@@6 T@U) ) (!  (=> (and (= (type x_3@@6) RefType) (< NoPerm wildcard@1)) (and (= (invRecv2 x_3@@6) x_3@@6) (qpRange2 x_3@@6)))
 :qid |stdinbpl.799:24|
 :skolemid |75|
 :pattern ( (MapType0Select Heap@@10 null (pred x_3@@6)))
 :pattern ( (MapType1Select QPMask@0 null (pred x_3@@6)))
 :pattern ( (MapType0Select Heap@@10 null (pred x_3@@6)))
)) (=> (and (and (and (forall ((r_2_1@@1 T@U) ) (!  (=> (= (type r_2_1@@1) RefType) (=> (and (< NoPerm wildcard@1) (qpRange2 r_2_1@@1)) (= (invRecv2 r_2_1@@1) r_2_1@@1)))
 :qid |stdinbpl.803:24|
 :skolemid |76|
 :pattern ( (invRecv2 r_2_1@@1))
)) (forall ((r_2_1@@2 T@U) ) (!  (=> (= (type r_2_1@@2) RefType) (=> (and (< NoPerm wildcard@1) (qpRange2 r_2_1@@2)) (and (= (invRecv2 r_2_1@@2) r_2_1@@2) (= (U_2_real (MapType1Select QPMask@1 null (pred r_2_1@@2))) (- (U_2_real (MapType1Select QPMask@0 null (pred r_2_1@@2))) wildcard@1)))))
 :qid |stdinbpl.809:24|
 :skolemid |77|
 :pattern ( (MapType1Select QPMask@1 null (pred r_2_1@@2)))
))) (and (forall ((r_2_1@@3 T@U) ) (!  (=> (and (= (type r_2_1@@3) RefType) (not (and (< NoPerm wildcard@1) (qpRange2 r_2_1@@3)))) (= (U_2_real (MapType1Select QPMask@1 null (pred r_2_1@@3))) (U_2_real (MapType1Select QPMask@0 null (pred r_2_1@@3)))))
 :qid |stdinbpl.813:24|
 :skolemid |78|
 :pattern ( (MapType1Select QPMask@1 null (pred r_2_1@@3)))
...
)))) (and (and (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@0 QPMask@1) (state ExhaleHeap@0 QPMask@1)) (and (state ExhaleHeap@0 QPMask@1) (> wildcard@2 0.0)))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((x_4 T@U) ) (!  (=> (= (type x_4) RefType) (> (U_2_real (MapType1Select QPMask@1 null (pred x_4))) NoPerm))
 :qid |stdinbpl.844:17|
 :skolemid |80|
 :no-pattern (type x_4)
 :no-pattern (U_2_int x_4)
 :no-pattern (U_2_bool x_4)
))) (=> (forall ((x_4@@0 T@U) ) (!  (=> (= (type x_4@@0) RefType) (> (U_2_real (MapType1Select QPMask@1 null (pred x_4@@0))) NoPerm))
 :qid |stdinbpl.844:17|
 :skolemid |80|
 :no-pattern (type x_4@@0)
 :no-pattern (U_2_int x_4@@0)
 :no-pattern (U_2_bool x_4@@0)
)) (=> (forall ((x_4@@1 T@U) ) (!  (=> (= (type x_4@@1) RefType) (< wildcard@2 (U_2_real (MapType1Select QPMask@1 null (pred x_4@@1)))))
 :qid |stdinbpl.848:22|
 :skolemid |81|
 :no-pattern (type x_4@@1)
 :no-pattern (U_2_int x_4@@1)
 :no-pattern (U_2_bool x_4@@1)
)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((r_3_1 T@U) ) (!  (=> (and (= (type r_3_1) RefType) (qpRange3 r_3_1)) (>= wildcard@2 NoPerm))
 :qid |stdinbpl.855:19|
 :skolemid |82|
 :pattern ( (invRecv3 r_3_1))
))) (=> (forall ((r_3_1@@0 T@U) ) (!  (=> (and (= (type r_3_1@@0) RefType) (qpRange3 r_3_1@@0)) (>= wildcard@2 NoPerm))
 :qid |stdinbpl.855:19|
 :skolemid |82|
 :pattern ( (invRecv3 r_3_1@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_4@@2 T@U) (x_4_1 T@U) ) (!  (=> (and (= (type x_4@@2) RefType) (= (type x_4_1) RefType)) (=> (and (and (not (= x_4@@2 x_4_1)) (< NoPerm wildcard@2)) (< NoPerm wildcard@2)) (not (= x_4@@2 x_4_1))))
 :qid |stdinbpl.862:19|
 :skolemid |83|
 :pattern ( (neverTriggered3 x_4@@2) (neverTriggered3 x_4_1))
))) (=> (forall ((x_4@@3 T@U) (x_4_1@@0 T@U) ) (!  (=> (and (= (type x_4@@3) RefType) (= (type x_4_1@@0) RefType)) (=> (and (and (not (= x_4@@3 x_4_1@@0)) (< NoPerm wildcard@2)) (< NoPerm wildcard@2)) (not (= x_4@@3 x_4_1@@0))))
 :qid |stdinbpl.862:19|
 :skolemid |83|
 :pattern ( (neverTriggered3 x_4@@3) (neverTriggered3 x_4_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_4@@4 T@U) ) (!  (=> (= (type x_4@@4) RefType) (> (U_2_real (MapType1Select QPMask@1 null (pred x_4@@4))) 0.0))
 :qid |stdinbpl.869:19|
 :skolemid |84|
 :pattern ( (MapType0Select ExhaleHeap@0 null (pred x_4@@4)))
 :pattern ( (MapType1Select QPMask@1 null (pred x_4@@4)))
 :pattern ( (MapType0Select ExhaleHeap@0 null (pred x_4@@4)))
)))))))))))))))))))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 r_1@@5 $allocated))) (and (=> (= (ControlFlow 0 12) 1) anon3_Then_correct) (=> (= (ControlFlow 0 12) 3) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (> wildcard 0.0) true) (= (ControlFlow 0 13) 12)) anon0_correct)))
