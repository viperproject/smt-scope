...
(assert  (and (and (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type z@@0) RefType)) (= (type x@@8) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type y@@1) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id m1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon11_Then_correct  (=> (and (not (= x@@8 z@@0)) (= (ControlFlow 0 6) (- 0 7))) false)))
(let ((anon6_correct true))
(let ((anon11_Else_correct  (=> (and (= x@@8 z@@0) (= (ControlFlow 0 8) 3)) anon6_correct)))
(let ((anon10_Then_correct  (=> (HasDirectPerm Mask@2 x@@8 f_7) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm Mask@1 x@@8 f_7)) (=> (HasDirectPerm Mask@1 x@@8 f_7) (and (=> (= (ControlFlow 0 9) 6) anon11_Then_correct) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct)))))))
(let ((anon10_Else_correct  (=> (and (not (HasDirectPerm Mask@2 x@@8 f_7)) (= (ControlFlow 0 4) 3)) anon6_correct)))
(let ((anon9_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((x_1 T@U) ) (!  (=> (and (and (= (type x_1) RefType) (HasDirectPerm Mask@2 x_1 f_7)) (not (= x_1 z@@0))) (= (/ (to_real 0) (to_real 0)) (/ (to_real 0) (to_real 0))))
 :qid |stdinbpl.252:15|
 :skolemid |22|
 :pattern ( (MapType1Select Mask@2 x_1 f_7))
 :pattern ( (MapType0Select Heap@@9 x_1 f_7))
)))))
(let ((anon2_correct  (=> (= Mask@2 (MapType1Store Mask@1 y@@1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 y@@1 f_7)) FullPerm)))) (and (and (=> (= (ControlFlow 0 11) 2) anon9_Else_correct) (=> (= (ControlFlow 0 11) 9) anon10_Then_correct)) (=> (= (ControlFlow 0 11) 4) anon10_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 14) 11)) anon2_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (U_2_real (MapType1Select Mask@1 y@@1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 y@@1 f_7))) (=> (= (ControlFlow 0 12) 11) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 y@@1 $allocated)) (U_2_bool (MapType0Select Heap@@9 z@@0 $allocated))) (=> (and (and (and (not (= y@@1 null)) (= Mask@0 (MapType1Store ZeroMask y@@1 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask y@@1 f_7)) FullPerm))))) (and (state Heap@@9 Mask@0) (not (= z@@0 null)))) (and (and (= Mask@1 (MapType1Store Mask@0 z@@0 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 z@@0 f_7)) FullPerm)))) (state Heap@@9 Mask@1)) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1)))) (and (=> (= (ControlFlow 0 15) 12) anon8_Then_correct) (=> (= (ControlFlow 0 15) 14) anon8_Else_correct)))))))
