...
(assert  (and (and (and (and (and (= (type xs) (MapType2Type RefType boolType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv1 arg0@@43)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (U_2_bool (MapType2Select xs x_3))) (U_2_bool (MapType2Select xs x_3_1))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_3 x_3_1))))
 :qid |stdinbpl.515:15|
 :skolemid |89|
 :no-pattern (type x_3)
...
(let ((anon8_Else_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((x_4 T@U) ) (!  (=> (and (= (type x_4) RefType) (U_2_bool (MapType2Select xs x_4))) (> (U_2_real (MapType1Select QPMask@0 x_4 f_7)) NoPerm))
 :qid |stdinbpl.559:15|
 :skolemid |95|
 :no-pattern (type x_4)
 :no-pattern (U_2_int x_4)
 :no-pattern (U_2_bool x_4)
))) (=> (forall ((x_4@@0 T@U) ) (!  (=> (and (= (type x_4@@0) RefType) (U_2_bool (MapType2Select xs x_4@@0))) (> (U_2_real (MapType1Select QPMask@0 x_4@@0 f_7)) NoPerm))
 :qid |stdinbpl.559:15|
 :skolemid |95|
 :no-pattern (type x_4@@0)
 :no-pattern (U_2_int x_4@@0)
 :no-pattern (U_2_bool x_4@@0)
)) (=> (forall ((x_4@@1 T@U) ) (!  (=> (and (= (type x_4@@1) RefType) (U_2_bool (MapType2Select xs x_4@@1))) (< wildcard@0 (U_2_real (MapType1Select QPMask@0 x_4@@1 f_7))))
 :qid |stdinbpl.563:20|
 :skolemid |96|
 :no-pattern (type x_4@@1)
 :no-pattern (U_2_int x_4@@1)
 :no-pattern (U_2_bool x_4@@1)
)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((x_4@@2 T@U) ) (!  (=> (= (type x_4@@2) RefType) (=> (and (U_2_bool (MapType2Select xs x_4@@2)) (dummyFunction (MapType0Select Heap@@9 x_4@@2 f_7))) (>= wildcard@0 NoPerm)))
 :qid |stdinbpl.570:17|
 :skolemid |97|
 :pattern ( (MapType0Select Heap@@9 x_4@@2 f_7))
 :pattern ( (MapType1Select QPMask@1 x_4@@2 f_7))
 :pattern ( (MapType2Select xs x_4@@2))
))) (=> (forall ((x_4@@3 T@U) ) (!  (=> (= (type x_4@@3) RefType) (=> (and (U_2_bool (MapType2Select xs x_4@@3)) (dummyFunction (MapType0Select Heap@@9 x_4@@3 f_7))) (>= wildcard@0 NoPerm)))
 :qid |stdinbpl.570:17|
 :skolemid |97|
 :pattern ( (MapType0Select Heap@@9 x_4@@3 f_7))
 :pattern ( (MapType1Select QPMask@1 x_4@@3 f_7))
 :pattern ( (MapType2Select xs x_4@@3))
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_4@@4 T@U) (x_4_1 T@U) ) (!  (=> (and (= (type x_4@@4) RefType) (= (type x_4_1) RefType)) (=> (and (and (and (and (not (= x_4@@4 x_4_1)) (U_2_bool (MapType2Select xs x_4@@4))) (U_2_bool (MapType2Select xs x_4_1))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_4@@4 x_4_1))))
 :qid |stdinbpl.577:17|
 :skolemid |98|
 :pattern ( (neverTriggered3 x_4@@4) (neverTriggered3 x_4_1))
))) (=> (forall ((x_4@@5 T@U) (x_4_1@@0 T@U) ) (!  (=> (and (= (type x_4@@5) RefType) (= (type x_4_1@@0) RefType)) (=> (and (and (and (and (not (= x_4@@5 x_4_1@@0)) (U_2_bool (MapType2Select xs x_4@@5))) (U_2_bool (MapType2Select xs x_4_1@@0))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_4@@5 x_4_1@@0))))
 :qid |stdinbpl.577:17|
 :skolemid |98|
 :pattern ( (neverTriggered3 x_4@@5) (neverTriggered3 x_4_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_4@@6 T@U) ) (!  (=> (and (= (type x_4@@6) RefType) (U_2_bool (MapType2Select xs x_4@@6))) (> (U_2_real (MapType1Select QPMask@0 x_4@@6 f_7)) NoPerm))
 :qid |stdinbpl.584:17|
 :skolemid |99|
 :pattern ( (MapType0Select Heap@@9 x_4@@6 f_7))
 :pattern ( (MapType1Select QPMask@1 x_4@@6 f_7))
 :pattern ( (MapType2Select xs x_4@@6))
)))))))))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select xs x_1))) (U_2_bool (MapType2Select xs x_1_1))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.464:15|
 :skolemid |83|
 :no-pattern (type x_1)
...
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType2Select xs (invRecv1 o_3))) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.474:22|
 :skolemid |85|
...
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType2Select xs (invRecv1 o_3@@0))) (qpRange1 o_3@@0)) (and (= (invRecv1 o_3@@0) o_3@@0) (< (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7))))) (=> (not (and (U_2_bool (MapType2Select xs (invRecv1 o_3@@0))) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.486:22|
 :skolemid |87|
...
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 13) 1) anon7_Then_correct) (=> (= (ControlFlow 0 13) 11) anon7_Else_correct)))))
