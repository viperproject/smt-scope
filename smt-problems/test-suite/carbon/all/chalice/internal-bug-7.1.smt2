...
(assert  (and (and (and (= (type Heap@@15) (MapType0Type RefType)) (= (type node) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type this@@10) RefType)))
...
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P node))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P node)))) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (>= (length Heap@@15 node) 1))))
(let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@15 this@@10 $allocated))) (and (U_2_bool (MapType0Select Heap@@15 node $allocated)) (not (= node null)))) (and (and (state Heap@@15 ZeroMask) (= Mask@0 (MapType1Store ZeroMask null (P node) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P node))) FullPerm))))) (and (state Heap@@15 Mask@0) (state Heap@@15 Mask@0)))) (and (and (=> (= (ControlFlow 0 7) 2) anon5_Else_correct) (=> (= (ControlFlow 0 7) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))
