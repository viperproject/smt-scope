...
(declare-fun ref () T@U)
(assert  (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type Heap@@12) (MapType0Type RefType))) (= (type r_6) RefType)) (= (type ref) RefType)))
(set-info :boogie-vc-id permOnlyOnePredicate1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (not (HasDirectPerm Mask@0 null (P1 r_6))) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (HasDirectPerm Mask@0 null (P1 r_6)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@0 null (P1 r_6))) (=> (HasDirectPerm Mask@0 null (P1 r_6)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((r_1_1 T@U) ) (!  (=> (and (= (type r_1_1) RefType) (HasDirectPerm Mask@0 null (P1 r_1_1))) false)
 :qid |stdinbpl.505:15|
 :skolemid |44|
 :pattern ( (MapType1Select Mask@0 null (P1 r_1_1)))
 :pattern ( (MapType0Select Heap@@12 null (P1 r_1_1)))
)))))
(let ((anon0_correct  (=> (and (state Heap@@12 ZeroMask) (U_2_bool (MapType0Select Heap@@12 ref $allocated))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (P1 ref) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P1 ref))) FullPerm)))) (state Heap@@12 Mask@0)) (and (state Heap@@12 Mask@0) (state Heap@@12 Mask@0))) (and (and (=> (= (ControlFlow 0 7) 2) anon5_Else_correct) (=> (= (ControlFlow 0 7) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))
