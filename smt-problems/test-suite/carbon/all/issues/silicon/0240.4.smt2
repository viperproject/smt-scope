...
(assert  (and (and (and (= (type UnfoldingMask@0) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type this@@21) RefType)) (= (type Heap@@21) (MapType0Type RefType))))
(set-info :boogie-vc-id test04a)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon2_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (bla this@@21) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (bla this@@21))) perm@1)))) (=> (and (= perm@2 (* FullPerm (/ (to_real 1) (to_real 2)))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@2 NoPerm)))))
(let ((anon3_Else_correct  (=> (and (= perm@1 NoPerm) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= perm@1 NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= perm@1 (U_2_real (MapType1Select Mask@0 null (bla this@@21))))) (=> (<= perm@1 (U_2_real (MapType1Select Mask@0 null (bla this@@21)))) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@21 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@21 this@@21 $allocated)) (= perm@0 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (= Mask@0 (MapType1Store ZeroMask null (bla this@@21) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (bla this@@21))) perm@0)))) (state Heap@@21 Mask@0)) (=> (and (and (state Heap@@21 Mask@0) (|bla#trigger| Heap@@21 (bla this@@21))) (and (= (MapType0Select Heap@@21 null (bla this@@21)) (MapType0Select Heap@@21 null (list this@@21))) (= perm@1 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))))))))
