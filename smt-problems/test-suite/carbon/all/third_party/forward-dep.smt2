...
))) (= (Ctor RefType) 9)) (= (type ar) (FieldType NormalFieldType (SeqType RefType)))) (= (type Integer_value) (FieldType NormalFieldType intType))))
(assert (distinct $allocated ar Integer_value)
)
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type this) RefType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type PostMask@1) (MapType1Type RefType realType))) (= (type Mask@7) (MapType1Type RefType realType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type ExhaleHeap@1) (MapType0Type RefType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id main_main)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 58) (let ((anon8_correct  (=> (and (= Mask@7 (MapType1Store Mask@6 (|Seq#Index| (MapType0Select ExhaleHeap@1 this ar) tid) Integer_value (real_2_U (- (U_2_real (MapType1Select Mask@6 (|Seq#Index| (MapType0Select ExhaleHeap@1 this ar) tid) Integer_value)) perm@5)))) (= (ControlFlow 0 14) (- 0 13))) (= (U_2_int (MapType0Select ExhaleHeap@1 (|Seq#Index| (MapType0Select ExhaleHeap@1 this ar) tid) Integer_value)) (+ tid 1)))))
(let ((anon12_Else_correct  (=> (and (= perm@5 NoPerm) (= (ControlFlow 0 17) 14)) anon8_correct)))
(let ((anon12_Then_correct  (=> (not (= perm@5 NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= perm@5 (U_2_real (MapType1Select Mask@6 (|Seq#Index| (MapType0Select ExhaleHeap@1 this ar) tid) Integer_value)))) (=> (<= perm@5 (U_2_real (MapType1Select Mask@6 (|Seq#Index| (MapType0Select ExhaleHeap@1 this ar) tid) Integer_value))) (=> (= (ControlFlow 0 15) 14) anon8_correct))))))
(let ((anon6_correct  (=> (= Mask@4 (MapType1Store Mask@3 (|Seq#Index| (MapType0Select ExhaleHeap@0 this ar) tid) Integer_value (real_2_U (- (U_2_real (MapType1Select Mask@3 (|Seq#Index| (MapType0Select ExhaleHeap@0 this ar) tid) Integer_value)) perm@3)))) (=> (and (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@1 Mask@4) (state ExhaleHeap@1 Mask@4)) (and (=> (= (ControlFlow 0 18) (- 0 28)) (HasDirectPerm Mask@4 this ar)) (=> (HasDirectPerm Mask@4 this ar) (and (=> (= (ControlFlow 0 18) (- 0 27)) (>= tid 0)) (=> (>= tid 0) (and (=> (= (ControlFlow 0 18) (- 0 26)) (< tid (|Seq#Length| (MapType0Select ExhaleHeap@1 this ar)))) (=> (< tid (|Seq#Length| (MapType0Select ExhaleHeap@1 this ar))) (=> (= perm@4 (/ (to_real 1) (to_real 4))) (and (=> (= (ControlFlow 0 18) (- 0 25)) (>= perm@4 NoPerm)) (=> (>= perm@4 NoPerm) (=> (=> (> perm@4 NoPerm) (not (= (|Seq#Index| (MapType0Select ExhaleHeap@1 this ar) tid) null))) (=> (and (and (= Mask@5 (MapType1Store Mask@4 (|Seq#Index| (MapType0Select ExhaleHeap@1 this ar) tid) Integer_value (real_2_U (+ (U_2_real (MapType1Select Mask@4 (|Seq#Index| (MapType0Select ExhaleHeap@1 this ar) tid) Integer_value)) perm@4)))) (state ExhaleHeap@1 Mask@5)) (and (state ExhaleHeap@1 Mask@5) (state ExhaleHeap@1 Mask@5))) (and (=> (= (ControlFlow 0 18) (- 0 24)) (<= 0 tid)) (=> (<= 0 tid) (and (=> (= (ControlFlow 0 18) (- 0 23)) (< tid tcount)) (=> (< tid tcount) (and (=> (= (ControlFlow 0 18) (- 0 22)) (> (U_2_real (MapType1Select Mask@5 this ar)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@5 this ar)) NoPerm) (=> (> wildcard@2 NoPerm) (=> (and (< wildcard@2 (U_2_real (MapType1Select Mask@5 this ar))) (= Mask@6 (MapType1Store Mask@5 this ar (real_2_U (- (U_2_real (MapType1Select Mask@5 this ar)) wildcard@2))))) (and (=> (= (ControlFlow 0 18) (- 0 21)) (= (|Seq#Length| (MapType0Select ExhaleHeap@1 this ar)) tcount)) (=> (= (|Seq#Length| (MapType0Select ExhaleHeap@1 this ar)) tcount) (and (=> (= (ControlFlow 0 18) (- 0 20)) (|Seq#Equal| (MapType0Select ExhaleHeap@1 this ar) (MapType0Select Heap@@9 this ar))) (=> (|Seq#Equal| (MapType0Select ExhaleHeap@1 this ar) (MapType0Select Heap@@9 this ar)) (=> (= perm@5 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (>= perm@5 NoPerm)) (=> (>= perm@5 NoPerm) (and (=> (= (ControlFlow 0 18) 15) anon12_Then_correct) (=> (= (ControlFlow 0 18) 17) anon12_Else_correct))))))))))))))))))))))))))))))))
(let ((anon11_Else_correct  (=> (and (= perm@3 NoPerm) (= (ControlFlow 0 31) 18)) anon6_correct)))
(let ((anon11_Then_correct  (=> (not (= perm@3 NoPerm)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (<= perm@3 (U_2_real (MapType1Select Mask@3 (|Seq#Index| (MapType0Select ExhaleHeap@0 this ar) tid) Integer_value)))) (=> (<= perm@3 (U_2_real (MapType1Select Mask@3 (|Seq#Index| (MapType0Select ExhaleHeap@0 this ar) tid) Integer_value))) (=> (= (ControlFlow 0 29) 18) anon6_correct))))))
(let ((anon4_correct  (=> (= Mask@2 (MapType1Store Mask@1 (|Seq#Index| (MapType0Select Heap@0 this ar) tid) Integer_value (real_2_U (- (U_2_real (MapType1Select Mask@1 (|Seq#Index| (MapType0Select Heap@0 this ar) tid) Integer_value)) perm@1)))) (=> (and (IdenticalOnKnownLocations Heap@0 ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)) (and (=> (= (ControlFlow 0 32) (- 0 40)) (HasDirectPerm Mask@2 this ar)) (=> (HasDirectPerm Mask@2 this ar) (and (=> (= (ControlFlow 0 32) (- 0 39)) (>= tid 0)) (=> (>= tid 0) (and (=> (= (ControlFlow 0 32) (- 0 38)) (< tid (|Seq#Length| (MapType0Select ExhaleHeap@0 this ar)))) (=> (< tid (|Seq#Length| (MapType0Select ExhaleHeap@0 this ar))) (=> (= perm@2 (/ (to_real 1) (to_real 4))) (and (=> (= (ControlFlow 0 32) (- 0 37)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (=> (> perm@2 NoPerm) (not (= (|Seq#Index| (MapType0Select ExhaleHeap@0 this ar) tid) null))) (=> (and (and (= Mask@3 (MapType1Store Mask@2 (|Seq#Index| (MapType0Select ExhaleHeap@0 this ar) tid) Integer_value (real_2_U (+ (U_2_real (MapType1Select Mask@2 (|Seq#Index| (MapType0Select ExhaleHeap@0 this ar) tid) Integer_value)) perm@2)))) (state ExhaleHeap@0 Mask@3)) (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3))) (and (=> (= (ControlFlow 0 32) (- 0 36)) (HasDirectPerm Mask@3 this ar)) (=> (HasDirectPerm Mask@3 this ar) (and (=> (= (ControlFlow 0 32) (- 0 35)) (>= tid 0)) (=> (>= tid 0) (and (=> (= (ControlFlow 0 32) (- 0 34)) (< tid (|Seq#Length| (MapType0Select ExhaleHeap@0 this ar)))) (=> (< tid (|Seq#Length| (MapType0Select ExhaleHeap@0 this ar))) (=> (= perm@3 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 32) (- 0 33)) (>= perm@3 NoPerm)) (=> (>= perm@3 NoPerm) (and (=> (= (ControlFlow 0 32) 29) anon11_Then_correct) (=> (= (ControlFlow 0 32) 31) anon11_Else_correct))))))))))))))))))))))))))
(let ((anon10_Else_correct  (=> (and (= perm@1 NoPerm) (= (ControlFlow 0 43) 32)) anon4_correct)))
(let ((anon10_Then_correct  (=> (not (= perm@1 NoPerm)) (and (=> (= (ControlFlow 0 41) (- 0 42)) (<= perm@1 (U_2_real (MapType1Select Mask@1 (|Seq#Index| (MapType0Select Heap@0 this ar) tid) Integer_value)))) (=> (<= perm@1 (U_2_real (MapType1Select Mask@1 (|Seq#Index| (MapType0Select Heap@0 this ar) tid) Integer_value))) (=> (= (ControlFlow 0 41) 32) anon4_correct))))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 44) (- 0 52)) (HasDirectPerm Mask@1 this ar)) (=> (HasDirectPerm Mask@1 this ar) (and (=> (= (ControlFlow 0 44) (- 0 51)) (>= tid 0)) (=> (>= tid 0) (and (=> (= (ControlFlow 0 44) (- 0 50)) (< tid (|Seq#Length| (MapType0Select Heap@@9 this ar)))) (=> (< tid (|Seq#Length| (MapType0Select Heap@@9 this ar))) (and (=> (= (ControlFlow 0 44) (- 0 49)) (= FullPerm (U_2_real (MapType1Select Mask@1 (|Seq#Index| (MapType0Select Heap@@9 this ar) tid) Integer_value)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 (|Seq#Index| (MapType0Select Heap@@9 this ar) tid) Integer_value))) (=> (and (= Heap@0 (MapType0Store Heap@@9 (|Seq#Index| (MapType0Select Heap@@9 this ar) tid) Integer_value (int_2_U (+ tid 1)))) (state Heap@0 Mask@1)) (and (=> (= (ControlFlow 0 44) (- 0 48)) (HasDirectPerm Mask@1 this ar)) (=> (HasDirectPerm Mask@1 this ar) (and (=> (= (ControlFlow 0 44) (- 0 47)) (>= tid 0)) (=> (>= tid 0) (and (=> (= (ControlFlow 0 44) (- 0 46)) (< tid (|Seq#Length| (MapType0Select Heap@0 this ar)))) (=> (< tid (|Seq#Length| (MapType0Select Heap@0 this ar))) (=> (= perm@1 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 44) (- 0 45)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (and (=> (= (ControlFlow 0 44) 41) anon10_Then_correct) (=> (= (ControlFlow 0 44) 43) anon10_Else_correct))))))))))))))))))))))
(let ((anon9_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (<= 0 tid)) (=> (and (and (and (state PostHeap@0 ZeroMask) (< tid tcount)) (and (state PostHeap@0 ZeroMask) (> wildcard@1 NoPerm))) (and (and (not (= this null)) (= PostMask@0 (MapType1Store ZeroMask this ar (real_2_U (+ (U_2_real (MapType1Select ZeroMask this ar)) wildcard@1))))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (HasDirectPerm PostMask@0 this ar)) (=> (HasDirectPerm PostMask@0 this ar) (=> (and (= (|Seq#Length| (MapType0Select PostHeap@0 this ar)) tcount) (state PostHeap@0 PostMask@0)) (and (=> (= (ControlFlow 0 2) (- 0 11)) (HasDirectPerm PostMask@0 this ar)) (=> (HasDirectPerm PostMask@0 this ar) (and (=> (= (ControlFlow 0 2) (- 0 10)) (HasDirectPerm Mask@1 this ar)) (=> (HasDirectPerm Mask@1 this ar) (=> (and (|Seq#Equal| (MapType0Select PostHeap@0 this ar) (MapType0Select Heap@@9 this ar)) (state PostHeap@0 PostMask@0)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (HasDirectPerm PostMask@0 this ar)) (=> (HasDirectPerm PostMask@0 this ar) (and (=> (= (ControlFlow 0 2) (- 0 8)) (>= tid 0)) (=> (>= tid 0) (and (=> (= (ControlFlow 0 2) (- 0 7)) (< tid (|Seq#Length| (MapType0Select PostHeap@0 this ar)))) (=> (< tid (|Seq#Length| (MapType0Select PostHeap@0 this ar))) (=> (= perm@0 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= (|Seq#Index| (MapType0Select PostHeap@0 this ar) tid) null))) (= PostMask@1 (MapType1Store PostMask@0 (|Seq#Index| (MapType0Select PostHeap@0 this ar) tid) Integer_value (real_2_U (+ (U_2_real (MapType1Select PostMask@0 (|Seq#Index| (MapType0Select PostHeap@0 this ar) tid) Integer_value)) perm@0))))) (and (state PostHeap@0 PostMask@1) (state PostHeap@0 PostMask@1))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm PostMask@1 this ar)) (=> (HasDirectPerm PostMask@1 this ar) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= tid 0)) (=> (>= tid 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< tid (|Seq#Length| (MapType0Select PostHeap@0 this ar)))) (=> (< tid (|Seq#Length| (MapType0Select PostHeap@0 this ar))) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm PostMask@1 (|Seq#Index| (MapType0Select PostHeap@0 this ar) tid) Integer_value))))))))))))))))))))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 this $allocated)) (<= 0 tid)) (=> (and (and (and (state Heap@@9 ZeroMask) (< tid tcount)) (and (state Heap@@9 ZeroMask) (> wildcard@0 NoPerm))) (and (and (not (= this null)) (= Mask@0 (MapType1Store ZeroMask this ar (real_2_U (+ (U_2_real (MapType1Select ZeroMask this ar)) wildcard@0))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)))) (and (=> (= (ControlFlow 0 53) (- 0 57)) (HasDirectPerm Mask@0 this ar)) (=> (HasDirectPerm Mask@0 this ar) (=> (and (= (|Seq#Length| (MapType0Select Heap@@9 this ar)) tcount) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 53) (- 0 56)) (HasDirectPerm Mask@0 this ar)) (=> (HasDirectPerm Mask@0 this ar) (and (=> (= (ControlFlow 0 53) (- 0 55)) (>= tid 0)) (=> (>= tid 0) (and (=> (= (ControlFlow 0 53) (- 0 54)) (< tid (|Seq#Length| (MapType0Select Heap@@9 this ar)))) (=> (< tid (|Seq#Length| (MapType0Select Heap@@9 this ar))) (=> (and (and (not (= (|Seq#Index| (MapType0Select Heap@@9 this ar) tid) null)) (= Mask@1 (MapType1Store Mask@0 (|Seq#Index| (MapType0Select Heap@@9 this ar) tid) Integer_value (real_2_U (+ (U_2_real (MapType1Select Mask@0 (|Seq#Index| (MapType0Select Heap@@9 this ar) tid) Integer_value)) FullPerm))))) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1))) (and (=> (= (ControlFlow 0 53) 2) anon9_Then_correct) (=> (= (ControlFlow 0 53) 44) anon9_Else_correct)))))))))))))))))
