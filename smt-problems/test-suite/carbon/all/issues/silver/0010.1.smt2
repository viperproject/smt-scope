...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type f_7) (FieldType NormalFieldType intType))) (= (type b_2) (FieldType NormalFieldType boolType))))
(assert (distinct $allocated f_7 b_2)
)
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@3) (MapType0Type RefType)) (= (type this@@5) RefType)) (= (type Heap@4) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type UnfoldingMask@3) (MapType1Type RefType realType))) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (forall ((arg0@@28 T@U) (arg1@@10 T@U) ) (! (= (type (CombineFrames arg0@@28 arg1@@10)) FrameTypeType)
...
(let ((anon12_Else_correct  (=> (not (U_2_bool (MapType0Select Heap@3 this@@5 b_2))) (=> (and (= Heap@5 Heap@3) (= (ControlFlow 0 3) 1)) anon8_correct))))
(let ((anon12_Then_correct  (=> (and (and (U_2_bool (MapType0Select Heap@3 this@@5 b_2)) (= Heap@4 (MapType0Store Heap@3 null (|P#sm| this@@5) (MapType1Store (MapType0Select Heap@3 null (|P#sm| this@@5)) this@@5 f_7 (bool_2_U true))))) (and (= Heap@5 Heap@4) (= (ControlFlow 0 2) 1))) anon8_correct)))
(let ((anon6_correct  (=> (and (state Heap@2 Mask@0) (= Heap@3 (MapType0Store Heap@2 null (|P#sm| this@@5) (MapType1Store (MapType0Select Heap@2 null (|P#sm| this@@5)) this@@5 b_2 (bool_2_U true))))) (and (=> (= (ControlFlow 0 4) 2) anon12_Then_correct) (=> (= (ControlFlow 0 4) 3) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (not (U_2_bool (MapType0Select Heap@0 this@@5 b_2))) (=> (and (= Heap@2 Heap@0) (= (ControlFlow 0 6) 4)) anon6_correct))))
(let ((anon11_Then_correct  (=> (and (and (U_2_bool (MapType0Select Heap@0 this@@5 b_2)) (= Heap@1 (MapType0Store Heap@0 null (|P#sm| this@@5) (MapType1Store (MapType0Select Heap@0 null (|P#sm| this@@5)) this@@5 f_7 (bool_2_U true))))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 5) 4))) anon6_correct)))
(let ((anon4_correct  (=> (state Heap@@10 UnfoldingMask@3) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm UnfoldingMask@3 this@@5 b_2)) (=> (HasDirectPerm UnfoldingMask@3 this@@5 b_2) (=> (= Heap@0 (MapType0Store Heap@@10 null (|P#sm| this@@5) (MapType1Store (MapType0Select Heap@@10 null (|P#sm| this@@5)) this@@5 b_2 (bool_2_U true)))) (and (=> (= (ControlFlow 0 7) 5) anon11_Then_correct) (=> (= (ControlFlow 0 7) 6) anon11_Else_correct))))))))
(let ((anon10_Else_correct  (=> (not (U_2_bool (MapType0Select Heap@@10 this@@5 b_2))) (=> (and (= UnfoldingMask@3 UnfoldingMask@1) (= (ControlFlow 0 10) 7)) anon4_correct))))
(let ((anon10_Then_correct  (=> (and (U_2_bool (MapType0Select Heap@@10 this@@5 b_2)) (not (= this@@5 null))) (=> (and (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 this@@5 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 this@@5 f_7)) FullPerm)))) (state Heap@@10 UnfoldingMask@2)) (and (= UnfoldingMask@3 UnfoldingMask@2) (= (ControlFlow 0 9) 7))) anon4_correct))))
(let ((anon2_correct  (=> (and (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (P this@@5) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P this@@5))) FullPerm)))) (not (= this@@5 null))) (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this@@5 b_2 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this@@5 b_2)) FullPerm)))) (state Heap@@10 UnfoldingMask@1))) (and (=> (= (ControlFlow 0 11) 9) anon10_Then_correct) (=> (= (ControlFlow 0 11) 10) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 14) 11)) anon2_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P this@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P this@@5)))) (=> (= (ControlFlow 0 12) 11) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 this@@5 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (P this@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P this@@5))) FullPerm))))) (=> (and (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (|P#trigger| Heap@@10 (P this@@5)) (= (MapType0Select Heap@@10 null (P this@@5)) (CombineFrames (FrameFragment (MapType0Select Heap@@10 this@@5 b_2)) (FrameFragment (ite (U_2_bool (MapType0Select Heap@@10 this@@5 b_2)) (FrameFragment (MapType0Select Heap@@10 this@@5 f_7)) EmptyFrame)))))) (and (=> (= (ControlFlow 0 15) 12) anon9_Then_correct) (=> (= (ControlFlow 0 15) 14) anon9_Else_correct)))))))
