...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@19 x@@23 $allocated))) (=> (and (and (not (= x@@23 null)) (= Mask@0 (MapType1Store ZeroMask x@@23 g (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@23 g)) FullPerm))))) (and (state Heap@@19 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@0 x@@23 g))))))
