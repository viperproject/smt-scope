...
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 i_6) (< i_6 (|Seq#Length| xs)))) (= (ControlFlow 0 14) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (<= 0 i_6) (< i_6 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= i_6 0)) (=> (>= i_6 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< i_6 (|Seq#Length| xs))) (=> (< i_6 (|Seq#Length| xs)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 (|Seq#Length| xs)))) (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_3) (|Seq#Index| xs i_3_1))))
 :qid |stdinbpl.954:15|
 :skolemid |132|
)))))
...
(let ((anon10_Else_correct  (=> (and (not (and (<= 0 i_4) (and (< i_4 j_2) (< j_2 (|Seq#Length| xs))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (<= 0 i_4) (and (< i_4 j_2) (< j_2 (|Seq#Length| xs)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_4 (|Seq#Length| xs))) (=> (< i_4 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_2 0)) (=> (>= j_2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_2 (|Seq#Length| xs))) (=> (< j_2 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
