...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (Nil boolType) (Nil boolType))) (=> (= (Nil boolType) (Nil boolType)) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (Nil (ListDomainTypeType intType)) (Nil (ListDomainTypeType intType)))) (=> (= (Nil (ListDomainTypeType intType)) (Nil (ListDomainTypeType intType))) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (Nil intType) (Nil intType)))))))))))
