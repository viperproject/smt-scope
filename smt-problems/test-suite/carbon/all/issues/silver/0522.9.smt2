...
(assert  (and (and (and (= (type xs) (MapType2Type RefType boolType)) (= (type Heap@@14) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv7 arg0@@48)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_1 T@U) (x_1_2 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_2) RefType)) (=> (and (and (and (and (not (= x_1 x_1_2)) (U_2_bool (MapType2Select xs x_1))) (U_2_bool (MapType2Select xs x_1_2))) (< NoPerm (ite (<= NoPerm p_1@@5) p_1@@5 NoPerm))) (< NoPerm (ite (<= NoPerm p_1@@5) p_1@@5 NoPerm))) (not (= x_1 x_1_2))))
...
))) (=> (forall ((x_1@@0 T@U) (x_1_2@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_2@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_2@@0)) (U_2_bool (MapType2Select xs x_1@@0))) (U_2_bool (MapType2Select xs x_1_2@@0))) (< NoPerm (ite (<= NoPerm p_1@@5) p_1@@5 NoPerm))) (< NoPerm (ite (<= NoPerm p_1@@5) p_1@@5 NoPerm))) (not (= x_1@@0 x_1_2@@0))))
 :qid |stdinbpl.1301:15|
 :skolemid |141|
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs x_1@@1)) (< NoPerm (ite (<= NoPerm p_1@@5) p_1@@5 NoPerm))) (and (qpRange7 x_1@@1) (= (invRecv7 x_1@@1) x_1@@1))))
 :qid |stdinbpl.1307:22|
 :skolemid |142|
 :pattern ( (MapType0Select Heap@@14 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
 :pattern ( (MapType2Select xs x_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv7 o_3))) (< NoPerm (ite (<= NoPerm p_1@@5) p_1@@5 NoPerm))) (qpRange7 o_3)) (= (invRecv7 o_3) o_3)))
 :qid |stdinbpl.1311:22|
 :skolemid |143|
 :pattern ( (invRecv7 o_3))
)) (= (ControlFlow 0 3) (- 0 2))) (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (U_2_bool (MapType2Select xs x_1@@2))) (>= (ite (<= NoPerm p_1@@5) p_1@@5 NoPerm) NoPerm))
 :qid |stdinbpl.1317:15|
 :skolemid |144|
 :pattern ( (MapType0Select Heap@@14 x_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@2 f_7))
 :pattern ( (MapType2Select xs x_1@@2))
))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct)))))
...
(declare-fun Heap@@14 () T@U)
(declare-fun AssumeFunctionsAbove () Int)
(assert (= (type Heap@@14) (MapType0Type RefType)))
(set-info :boogie-vc-id test31)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (not (= r_1 r_1_1)) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= r_1 r_1_1))))
...
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
