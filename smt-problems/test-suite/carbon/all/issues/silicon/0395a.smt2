...
(declare-fun accessible_withdraw (Int Int Int) T@U)
(declare-fun IsPredicateField (T@U) Bool)
(declare-fun PredicateType_accessible_withdrawType () T@T)
(declare-fun FrameTypeType () T@T)
(declare-fun |accessible_withdraw#trigger| (T@U T@U) Bool)
(declare-fun |accessible_withdraw#everUsed| (T@U) Bool)
...
(declare-fun |isInt'| (T@U Int) Bool)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |isInt#triggerStateless| (Int) Bool)
(declare-fun |accessible_withdraw#sm| (Int Int Int) T@U)
...
(declare-fun |isInt#frame| (T@U Int) Bool)
...
(assert  (and (and (= (Ctor PredicateType_accessible_withdrawType) 10) (= (Ctor FrameTypeType) 11)) (forall ((arg0@@23 Int) (arg1@@9 Int) (arg2@@3 Int) ) (! (= (type (accessible_withdraw arg0@@23 arg1@@9 arg2@@3)) (FieldType PredicateType_accessible_withdrawType FrameTypeType))
 :qid |funType:accessible_withdraw|
 :pattern ( (accessible_withdraw arg0@@23 arg1@@9 arg2@@3))
))))
(assert (forall ((msg_sender Int) (amount Int) (parameter Int) ) (! (IsPredicateField (accessible_withdraw msg_sender amount parameter))
 :qid |stdinbpl.260:15|
 :skolemid |27|
 :pattern ( (accessible_withdraw msg_sender amount parameter))
)))
(assert (forall ((Heap@@0 T@U) (msg_sender@@0 Int) (amount@@0 Int) (parameter@@0 Int) ) (!  (=> (= (type Heap@@0) (MapType0Type RefType)) (|accessible_withdraw#everUsed| (accessible_withdraw msg_sender@@0 amount@@0 parameter@@0)))
 :qid |stdinbpl.279:15|
 :skolemid |31|
 :pattern ( (|accessible_withdraw#trigger| Heap@@0 (accessible_withdraw msg_sender@@0 amount@@0 parameter@@0)))
)))
(assert (forall ((msg_sender@@1 Int) (amount@@1 Int) (parameter@@1 Int) ) (! (= (getPredWandId (accessible_withdraw msg_sender@@1 amount@@1 parameter@@1)) 0)
 :qid |stdinbpl.264:15|
 :skolemid |28|
...
(assert (forall ((Heap@@3 T@U) (i Int) ) (!  (=> (= (type Heap@@3) (MapType0Type RefType)) (dummyFunction (bool_2_U (|isInt#triggerStateless| i))))
 :qid |stdinbpl.211:15|
 :skolemid |23|
 :pattern ( (|isInt'| Heap@@3 i))
)))
(assert (forall ((arg0@@26 Int) (arg1@@10 Int) (arg2@@4 Int) ) (! (= (type (|accessible_withdraw#sm| arg0@@26 arg1@@10 arg2@@4)) (FieldType PredicateType_accessible_withdrawType (MapType1Type RefType boolType)))
 :qid |funType:accessible_withdraw#sm|
 :pattern ( (|accessible_withdraw#sm| arg0@@26 arg1@@10 arg2@@4))
)))
(assert (forall ((msg_sender@@2 Int) (amount@@2 Int) (parameter@@2 Int) ) (! (= (PredicateMaskField (accessible_withdraw msg_sender@@2 amount@@2 parameter@@2)) (|accessible_withdraw#sm| msg_sender@@2 amount@@2 parameter@@2))
 :qid |stdinbpl.256:15|
 :skolemid |26|
 :pattern ( (PredicateMaskField (accessible_withdraw msg_sender@@2 amount@@2 parameter@@2)))
)))
...
(assert (forall ((Heap@@5 T@U) (Mask@@3 T@U) (i@@0 Int) ) (!  (=> (and (and (= (type Heap@@5) (MapType0Type RefType)) (= (type Mask@@3) (MapType1Type RefType realType))) (and (state Heap@@5 Mask@@3) (< AssumeFunctionsAbove 0))) (isInt Heap@@5 i@@0))
 :qid |stdinbpl.217:15|
 :skolemid |24|
 :pattern ( (state Heap@@5 Mask@@3) (isInt Heap@@5 i@@0))
)))
...
(assert (forall ((Heap@@8 T@U) (Mask@@7 T@U) (i@@1 Int) ) (!  (=> (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (state Heap@@8 Mask@@7)) (= (|isInt'| Heap@@8 i@@1) (|isInt#frame| EmptyFrame i@@1)))
 :qid |stdinbpl.224:15|
 :skolemid |25|
 :pattern ( (state Heap@@8 Mask@@7) (|isInt'| Heap@@8 i@@1))
)))
(assert (forall ((Heap@@9 T@U) (i@@2 Int) ) (!  (=> (= (type Heap@@9) (MapType0Type RefType)) (and (= (isInt Heap@@9 i@@2) (|isInt'| Heap@@9 i@@2)) (dummyFunction (bool_2_U (|isInt#triggerStateless| i@@2)))))
 :qid |stdinbpl.207:15|
 :skolemid |22|
 :pattern ( (isInt Heap@@9 i@@2))
)))
...
(assert  (and (= (type Heap@@14) (MapType0Type RefType)) (= (type QPMask@0) (MapType1Type RefType realType))))
...
(let ((anon10_Then_correct  (=> (isInt Heap@@14 a_3) (and (=> (= (ControlFlow 0 8) 7) anon11_Then_correct) (=> (= (ControlFlow 0 8) 5) anon6_correct)))))
(let ((anon10_Else_correct  (=> (and (not (isInt Heap@@14 a_3)) (= (ControlFlow 0 6) 5)) anon6_correct)))
(let ((anon9_Then_correct true))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((a_1 Int) (i_1 Int) (j_1 Int) (a_1_1 Int) (i_1_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (and (and (and (not (= a_1 a_1_1)) (not (= i_1 i_1_1))) (not (= j_1 j_1_1))) (and (isInt Heap@@14 a_1) (and (isInt Heap@@14 j_1) (>= balance i_1)))) (and (isInt Heap@@14 a_1_1) (and (isInt Heap@@14 j_1_1) (>= balance i_1_1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (or (not (= a_1 a_1_1)) (not (= i_1 i_1_1))) (not (= j_1 j_1_1))))
 :qid |stdinbpl.417:17|
 :skolemid |38|
 :pattern ( (neverTriggered6 a_1 i_1 j_1) (neverTriggered6 a_1_1 i_1_1 j_1_1))
))) (=> (forall ((a_1@@0 Int) (i_1@@0 Int) (j_1@@0 Int) (a_1_1@@0 Int) (i_1_1@@0 Int) (j_1_1@@0 Int) ) (!  (=> (and (and (and (and (and (and (not (= a_1@@0 a_1_1@@0)) (not (= i_1@@0 i_1_1@@0))) (not (= j_1@@0 j_1_1@@0))) (and (isInt Heap@@14 a_1@@0) (and (isInt Heap@@14 j_1@@0) (>= balance i_1@@0)))) (and (isInt Heap@@14 a_1_1@@0) (and (isInt Heap@@14 j_1_1@@0) (>= balance i_1_1@@0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (or (not (= a_1@@0 a_1_1@@0)) (not (= i_1@@0 i_1_1@@0))) (not (= j_1@@0 j_1_1@@0))))
 :qid |stdinbpl.417:17|
 :skolemid |38|
 :pattern ( (neverTriggered6 a_1@@0 i_1@@0 j_1@@0) (neverTriggered6 a_1_1@@0 i_1_1@@0 j_1_1@@0))
)) (=> (forall ((a_1@@1 Int) (i_1@@1 Int) (j_1@@1 Int) ) (!  (=> (and (and (isInt Heap@@14 a_1@@1) (and (isInt Heap@@14 j_1@@1) (>= balance i_1@@1))) (< NoPerm FullPerm)) (and (and (and (= (invRecv4 a_1@@1 i_1@@1 j_1@@1) a_1@@1) (= (invRecv5 a_1@@1 i_1@@1 j_1@@1) i_1@@1)) (= (invRecv6 a_1@@1 i_1@@1 j_1@@1) j_1@@1)) (qpRange6 a_1@@1 i_1@@1 j_1@@1)))
 :qid |stdinbpl.423:22|
 :skolemid |39|
 :pattern ( (MapType0Select Heap@@14 null (accessible_withdraw a_1@@1 i_1@@1 j_1@@1)))
 :pattern ( (MapType1Select ZeroMask null (accessible_withdraw a_1@@1 i_1@@1 j_1@@1)))
 :pattern ( (MapType0Select Heap@@14 null (accessible_withdraw a_1@@1 i_1@@1 j_1@@1)))
)) (=> (and (and (and (forall ((msg_sender_1_1 Int) (amount@@5 Int) (parameter@@5 Int) ) (!  (=> (and (and (and (isInt Heap@@14 (invRecv4 msg_sender_1_1 amount@@5 parameter@@5)) (and (isInt Heap@@14 (invRecv6 msg_sender_1_1 amount@@5 parameter@@5)) (>= balance (invRecv5 msg_sender_1_1 amount@@5 parameter@@5)))) (< NoPerm FullPerm)) (qpRange6 msg_sender_1_1 amount@@5 parameter@@5)) (and (and (= (invRecv4 msg_sender_1_1 amount@@5 parameter@@5) msg_sender_1_1) (= (invRecv5 msg_sender_1_1 amount@@5 parameter@@5) amount@@5)) (= (invRecv6 msg_sender_1_1 amount@@5 parameter@@5) parameter@@5)))
 :qid |stdinbpl.427:22|
 :skolemid |40|
...
)) (forall ((msg_sender_1_1@@0 Int) (amount@@6 Int) (parameter@@6 Int) ) (!  (=> (and (and (and (isInt Heap@@14 (invRecv4 msg_sender_1_1@@0 amount@@6 parameter@@6)) (and (isInt Heap@@14 (invRecv6 msg_sender_1_1@@0 amount@@6 parameter@@6)) (>= balance (invRecv5 msg_sender_1_1@@0 amount@@6 parameter@@6)))) (< NoPerm FullPerm)) (qpRange6 msg_sender_1_1@@0 amount@@6 parameter@@6)) (and (=> (< NoPerm FullPerm) (and (and (= (invRecv4 msg_sender_1_1@@0 amount@@6 parameter@@6) msg_sender_1_1@@0) (= (invRecv5 msg_sender_1_1@@0 amount@@6 parameter@@6) amount@@6)) (= (invRecv6 msg_sender_1_1@@0 amount@@6 parameter@@6) parameter@@6))) (= (U_2_real (MapType1Select QPMask@0 null (accessible_withdraw msg_sender_1_1@@0 amount@@6 parameter@@6))) (+ (U_2_real (MapType1Select ZeroMask null (accessible_withdraw msg_sender_1_1@@0 amount@@6 parameter@@6))) FullPerm))))
 :qid |stdinbpl.433:22|
 :skolemid |41|
 :pattern ( (MapType1Select QPMask@0 null (accessible_withdraw msg_sender_1_1@@0 amount@@6 parameter@@6)))
...
)) (forall ((msg_sender_1_1@@1 Int) (amount@@7 Int) (parameter@@7 Int) ) (!  (=> (not (and (and (and (isInt Heap@@14 (invRecv4 msg_sender_1_1@@1 amount@@7 parameter@@7)) (and (isInt Heap@@14 (invRecv6 msg_sender_1_1@@1 amount@@7 parameter@@7)) (>= balance (invRecv5 msg_sender_1_1@@1 amount@@7 parameter@@7)))) (< NoPerm FullPerm)) (qpRange6 msg_sender_1_1@@1 amount@@7 parameter@@7))) (= (U_2_real (MapType1Select QPMask@0 null (accessible_withdraw msg_sender_1_1@@1 amount@@7 parameter@@7))) (U_2_real (MapType1Select ZeroMask null (accessible_withdraw msg_sender_1_1@@1 amount@@7 parameter@@7)))))
 :qid |stdinbpl.443:22|
 :skolemid |43|
 :pattern ( (MapType1Select QPMask@0 null (accessible_withdraw msg_sender_1_1@@1 amount@@7 parameter@@7)))
)))) (and (and (state Heap@@14 QPMask@0) (state Heap@@14 QPMask@0)) (and (state Heap@@14 QPMask@0) (= (ControlFlow 0 2) (- 0 1))))) (= (U_2_real (MapType1Select QPMask@0 null (accessible_withdraw msg_sender@@5 (+ balance 1) (+ balance 2)))) NoPerm)))))))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (state Heap@@14 ZeroMask)) (and (and (and (=> (= (ControlFlow 0 9) 2) anon8_Else_correct) (=> (= (ControlFlow 0 9) 4) anon9_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon10_Then_correct)) (=> (= (ControlFlow 0 9) 6) anon10_Else_correct))))))
