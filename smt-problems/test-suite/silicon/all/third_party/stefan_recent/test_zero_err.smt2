(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:09:20
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/third_party/stefan_recent/test_zero_err.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@01)))))))))
  tcount@9@01))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@01))))))))
  ($Snap.combine
...
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@01)))))))))
  $Snap.unit))
; [eval] diz.zero__x == old(diz.zero__x)
(set-option :timeout 0)
(push) ; 3
(set-option :timeout 10)
(assert (not (< $Perm.No $k@17@01)))
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@01)))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@01))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@01)))))))))))))
; [eval] diz.zero__x[tid]
(set-option :timeout 0)
(push) ; 3
(set-option :timeout 10)
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@01))))))))))
  $Snap.unit))
; [eval] diz.zero__x[tid].Ref__Integer_value == 0
; [eval] diz.zero__x[tid]
(push) ; 3
(set-option :timeout 10)
(assert (not (< $Perm.No $k@17@01)))
...
; (get-info :all-statistics)
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@01)))))))))))
  0))
(pop) ; 2
(push) ; 2
; [exec]
; var __last_barrier: Int
(declare-const __last_barrier@18@01 Int)
; [exec]
; var __flatten_1: Ref
...
; 0,00s
; (get-info :all-statistics)
(declare-const __flatten_1@21@01 $Ref)
(assert (=
  __flatten_1@21@01
  (Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@01))))))))))
...
; 0,00s
; (get-info :all-statistics)
(assert (not (= __flatten_1@21@01 $Ref.null)))
; [eval] 0 <= tid
; [eval] tid < tcount
; [eval] 0 <= lid
; [eval] lid < gsize
...
; 0,00s
; (get-info :all-statistics)
(assert (< $k@22@01 $k@15@01))
(assert (<= $Perm.No (- $k@15@01 $k@22@01)))
(assert (<= (- $k@15@01 $k@22@01) $Perm.Write))
(assert (=> (< $Perm.No (- $k@15@01 $k@22@01)) (not (= diz@7@01 $Ref.null))))
(set-option :timeout 0)
(push) ; 3
(set-option :timeout 10)
...
(declare-const tcount@25@01 Int)
(declare-const gsize@26@01 Int)
(declare-const tid@27@01 Int)
(declare-const gid@28@01 Int)
(declare-const lid@29@01 Int)
(declare-const this_barrier@30@01 Int)
(declare-const last_barrier@31@01 Int)
(declare-const sys__result@32@01 Int)
(declare-const diz@33@01 $Ref)
(declare-const current_thread_id@34@01 Int)
(declare-const tcount@35@01 Int)
(declare-const gsize@36@01 Int)
(declare-const tid@37@01 Int)
(declare-const gid@38@01 Int)
(declare-const lid@39@01 Int)
(declare-const this_barrier@40@01 Int)
(declare-const last_barrier@41@01 Int)
(declare-const sys__result@42@01 Int)
(push) ; 1
...
; [eval] lid + gid * gsize
; [eval] gid * gsize
(assert (= tid@37@01 (+ lid@39@01 (* gid@38@01 gsize@36@01))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))))
  ($Snap.combine
...
(assert (=> (< $Perm.No $k@44@01) (not (= diz@33@01 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@43@01)))))))))
  ($Snap.combine
...
(push) ; 2
(set-option :timeout 10)
(assert (not (not (= last_barrier@41@01 0))))
(check-sat)
; unknown
(pop) ; 2
; 0,00s
...
(push) ; 2
(set-option :timeout 10)
(assert (not (= last_barrier@41@01 0)))
(check-sat)
; unknown
(pop) ; 2
; 0,00s
; (get-info :all-statistics)
; [then-branch: 0 | last_barrier@41@01 == 0 | live]
; [else-branch: 0 | last_barrier@41@01 != 0 | live]
(set-option :timeout 0)
(push) ; 2
; [then-branch: 0 | last_barrier@41@01 == 0]
(assert (= last_barrier@41@01 0))
; [eval] diz.zero__x[tid]
(push) ; 3
(set-option :timeout 10)
(assert (not (< $Perm.No $k@44@01)))
...
(assert (=> (< $Perm.No $k@46@01) (not (= diz@33@01 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@45@01)))))))
  ($Snap.combine
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@45@01)))))))))
  tcount@35@01))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@45@01))))))))
  ($Snap.combine
...
(push) ; 4
(set-option :timeout 10)
(assert (not (not (= sys__result@42@01 0))))
(check-sat)
; unknown
(pop) ; 4
; 0,00s
...
(push) ; 4
(set-option :timeout 10)
(assert (not (= sys__result@42@01 0)))
(check-sat)
; unknown
(pop) ; 4
; 0,00s
; (get-info :all-statistics)
; [then-branch: 1 | sys__result@42@01 == 0 | live]
; [else-branch: 1 | sys__result@42@01 != 0 | live]
(set-option :timeout 0)
(push) ; 4
; [then-branch: 1 | sys__result@42@01 == 0]
(assert (= sys__result@42@01 0))
; [eval] diz.zero__x[tid]
(push) ; 5
(set-option :timeout 10)
(assert (not (< $Perm.No $k@46@01)))
...
(assert (= sys__result@42@01 this_barrier@40@01))
(pop) ; 4
(push) ; 4
; [else-branch: 1 | sys__result@42@01 != 0]
(assert (not (= sys__result@42@01 0)))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@45@01))))))))))
  $Snap.unit))
...
(pop) ; 2
(push) ; 2
; [else-branch: 0 | last_barrier@41@01 != 0]
(assert (not (= last_barrier@41@01 0)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@43@01))))))))))
  $Snap.unit))
...
(assert (=> (< $Perm.No $k@48@01) (not (= diz@33@01 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@47@01)))))))
  ($Snap.combine
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@47@01)))))))))
  tcount@35@01))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@47@01))))))))
  ($Snap.combine
...
; 0,00s
; (get-info :all-statistics)
; [then-branch: 2 | sys__result@42@01 == 0 | live]
; [else-branch: 2 | sys__result@42@01 != 0 | live]
(set-option :timeout 0)
(push) ; 4
; [then-branch: 2 | sys__result@42@01 == 0]
(assert (= sys__result@42@01 0))
; [eval] diz.zero__x[tid]
(push) ; 5
(set-option :timeout 10)
...
(pop) ; 4
(push) ; 4
; [else-branch: 2 | sys__result@42@01 != 0]
(assert (not (= sys__result@42@01 0)))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@47@01))))))))))
  $Snap.unit))
