...
(set-info :boogie-vc-id |fac3#definedness|)
...
(let ((anon0_correct  (=> (state Heap@@72 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (> j (- 0 50))) (and (state Heap@@72 ZeroMask) (state Heap@@72 ZeroMask))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= tmp@0 (|fac2'| Heap@@72 3)) (=> (and (state Heap@@72 ZeroMask) (= (ControlFlow 0 3) (- 0 2))) (= tmp@0 6)))))
...
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= (funP2 Heap@3 r_1@@36) tmp@0))))
