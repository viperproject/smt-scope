...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_2))) (= (ControlFlow 0 19) 15)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_2)) (and (=> (= (ControlFlow 0 16) (- 0 18)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 16) (- 0 17)) (< i_2 (|Seq#Length| S))) (=> (< i_2 (|Seq#Length| S)) (=> (= (ControlFlow 0 16) 15) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 14)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_3))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| S i_3) (|Seq#Index| S i_3_1))))
 :qid |stdinbpl.941:15|
 :skolemid |125|
 ...
 :qid |stdinbpl.941:15|
 :skolemid |125|
)) (=> (forall ((i_3@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_3@@1)) (< NoPerm FullPerm)) (and (qpRange2 (|Seq#Index| S i_3@@1)) (= (invRecv2 (|Seq#Index| S i_3@@1)) i_3@@1)))
 :qid |stdinbpl.947:22|
 :skolemid |126|
 ...
 :pattern ( (|Seq#Index| S i_3@@2))
))) (=> (and (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| S (invRecv2 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.963:22|
 :skolemid |129|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (and (>= a_2 0) (< a_2 b_2)) (and (< b_2 (|Seq#Length| S)) (state Heap@@9 QPMask@0)))) (and (=> (= (ControlFlow 0 9) (- 0 13)) (>= a_2 0)) (=> (>= a_2 0) (and (=> (= (ControlFlow 0 9) (- 0 12)) (< a_2 (|Seq#Length| S))) (=> (< a_2 (|Seq#Length| S)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= b_2 0)) (=> (>= b_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< b_2 (|Seq#Length| S))) (=> (< b_2 (|Seq#Length| S)) (=> (= (ControlFlow 0 9) (- 0 8)) (not (= (|Seq#Index| S a_2) (|Seq#Index| S b_2)))))))))))))))))))
(let ((anon9_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (<= 0 i_1) (and (< i_1 j_1) (< j_1 (|Seq#Length| S)))) (not (= (|Seq#Index| S i_1) (|Seq#Index| S j_1))))
 :qid |stdinbpl.923:20|
 :skolemid |124|
 :pattern ( (|Seq#Index| S i_1) (|Seq#Index| S j_1))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 20) 9) anon11_Else_correct) (=> (= (ControlFlow 0 20) 16) anon12_Then_correct)) (=> (= (ControlFlow 0 20) 19) anon12_Else_correct)))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (and (<= 0 i@@6) (and (< i@@6 j@@5) (< j@@5 (|Seq#Length| S))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (<= 0 i@@6) (and (< i@@6 j@@5) (< j@@5 (|Seq#Length| S)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i@@6 (|Seq#Length| S))) (=> (< i@@6 (|Seq#Length| S)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j@@5 (|Seq#Length| S))) (=> (< j@@5 (|Seq#Length| S)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (and (=> (= (ControlFlow 0 21) 20) anon9_Else_correct) (=> (= (ControlFlow 0 21) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 21) 7) anon10_Else_correct)))))
