...
(assert (forall ((Heap@@0 T@U) (this T@U) (i Int) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type this) RefType)) (dummyFunction (int_2_U (|itemAt#triggerStateless| this i))))
 :qid |stdinbpl.349:15|
 :skolemid |29|
...
(assert (forall ((Heap@@5 T@U) (Mask@@2 T@U) (this@@3 T@U) (i@@0 Int) ) (!  (=> (and (and (and (and (= (type Heap@@5) (MapType0Type RefType)) (= (type Mask@@2) (MapType1Type RefType realType))) (= (type this@@3) RefType)) (and (state Heap@@5 Mask@@2) (< AssumeFunctionsAbove 0))) (and (<= 0 i@@0) (< i@@0 (length Heap@@5 this@@3)))) (= (itemAt Heap@@5 this@@3 i@@0) (ite  (or (= i@@0 0) (= (MapType0Select Heap@@5 this@@3 next) null)) (U_2_int (MapType0Select Heap@@5 this@@3 value)) (|itemAt'| Heap@@5 (MapType0Select Heap@@5 this@@3 next) (- i@@0 1)))))
 :qid |stdinbpl.355:15|
 :skolemid |30|
 :pattern ( (state Heap@@5 Mask@@2) (itemAt Heap@@5 this@@3 i@@0))
 :pattern ( (state Heap@@5 Mask@@2) (|itemAt#triggerStateless| this@@3 i@@0) (|valid#trigger| Heap@@5 (valid this@@3)))
)))
...
(assert (forall ((Heap@@10 T@U) (Mask@@6 T@U) (this@@7 T@U) ) (!  (=> (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (= (type this@@7) RefType)) (and (state Heap@@10 Mask@@6) (< AssumeFunctionsAbove 1))) (= (length Heap@@10 this@@7) (ite (= (MapType0Select Heap@@10 this@@7 next) null) 1 (+ 1 (|length'| Heap@@10 (MapType0Select Heap@@10 this@@7 next))))))
 :qid |stdinbpl.207:15|
 :skolemid |24|
 :pattern ( (state Heap@@10 Mask@@6) (length Heap@@10 this@@7))
 :pattern ( (state Heap@@10 Mask@@6) (|length#triggerStateless| this@@7) (|valid#trigger| Heap@@10 (valid this@@7)))
)))
...
(assert (forall ((Heap@@11 T@U) (this@@8 T@U) (i@@1 Int) ) (!  (=> (and (= (type Heap@@11) (MapType0Type RefType)) (= (type this@@8) RefType)) (and (= (itemAt Heap@@11 this@@8 i@@1) (|itemAt'| Heap@@11 this@@8 i@@1)) (dummyFunction (int_2_U (|itemAt#triggerStateless| this@@8 i@@1)))))
 :qid |stdinbpl.345:15|
 :skolemid |28|
 :pattern ( (itemAt Heap@@11 this@@8 i@@1))
)))
...
(assert (forall ((Heap@@14 T@U) (Mask@@11 T@U) (this@@10 T@U) ) (!  (=> (and (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (= (type this@@10) RefType)) (state Heap@@14 Mask@@11)) (= (|length'| Heap@@14 this@@10) (|length#frame| (MapType0Select Heap@@14 null (valid this@@10)) this@@10)))
 :qid |stdinbpl.214:15|
 :skolemid |25|
 :pattern ( (state Heap@@14 Mask@@11) (|length'| Heap@@14 this@@10))
 :pattern ( (state Heap@@14 Mask@@11) (|length#triggerStateless| this@@10) (|valid#trigger| Heap@@14 (valid this@@10)))
)))
...
(assert (forall ((Heap@@17 T@U) (Mask@@12 T@U) (this@@12 T@U) (i@@2 Int) ) (!  (=> (and (and (and (= (type Heap@@17) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (= (type this@@12) RefType)) (state Heap@@17 Mask@@12)) (= (|itemAt'| Heap@@17 this@@12 i@@2) (|itemAt#frame| (MapType0Select Heap@@17 null (valid this@@12)) this@@12 i@@2)))
 :qid |stdinbpl.362:15|
 :skolemid |31|
 :pattern ( (state Heap@@17 Mask@@12) (|itemAt'| Heap@@17 this@@12 i@@2))
 :pattern ( (state Heap@@17 Mask@@12) (|itemAt#triggerStateless| this@@12 i@@2) (|valid#trigger| Heap@@17 (valid this@@12)))
)))
(assert (forall ((Heap@@18 T@U) (Mask@@13 T@U) (this@@13 T@U) ) (!  (=> (and (and (and (= (type Heap@@18) (MapType0Type RefType)) (= (type Mask@@13) (MapType1Type RefType realType))) (= (type this@@13) RefType)) (and (state Heap@@18 Mask@@13) (or (< AssumeFunctionsAbove 1) (|length#trigger| (MapType0Select Heap@@18 null (valid this@@13)) this@@13)))) (> (|length'| Heap@@18 this@@13) 0))
 :qid |stdinbpl.220:15|
 :skolemid |26|
 :pattern ( (state Heap@@18 Mask@@13) (|length'| Heap@@18 this@@13))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
...
(let ((anon28_Else_correct  (=> (= (MapType0Select Heap@1 this@@14 next) null) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 13) 11)) anon19_correct))))
(let ((anon28_Then_correct  (=> (not (= (MapType0Select Heap@1 this@@14 next) null)) (=> (and (and (forall ((o_4 T@U) (f_8 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_8))))
(let ((A@@12 (FieldTypeInv0 (type f_8))))
 (=> (and (and (= (type o_4) RefType) (= (type f_8) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|valid#sm| this@@14)) o_4 f_8)) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|valid#sm| (MapType0Select Heap@1 this@@14 next))) o_4 f_8)))) (U_2_bool (MapType1Select newPMask@0 o_4 f_8)))))
 :qid |stdinbpl.494:33|
 :skolemid |32|
 :pattern ( (MapType1Select newPMask@0 o_4 f_8))
)) (= Heap@2 (MapType0Store Heap@1 null (|valid#sm| this@@14) newPMask@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 12) 11))) anon19_correct))))
(let ((anon17_correct  (=> (and (= Heap@0 (MapType0Store Heap@@19 null (|valid#sm| this@@14) (MapType1Store (MapType0Select Heap@@19 null (|valid#sm| this@@14)) this@@14 value (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|valid#sm| this@@14) (MapType1Store (MapType0Select Heap@0 null (|valid#sm| this@@14)) this@@14 next (bool_2_U true))))) (and (=> (= (ControlFlow 0 14) 12) anon28_Then_correct) (=> (= (ControlFlow 0 14) 13) anon28_Else_correct)))))
(let ((anon26_Else_correct  (=> (and (|itemAt#trigger| (MapType0Select Heap@@19 null (valid (MapType0Select Heap@@19 this@@14 next))) (MapType0Select Heap@@19 this@@14 next) (- i@@3 1)) (= (ControlFlow 0 17) 14)) anon17_correct)))
(let ((anon25_Then_correct  (=> (or (= i@@3 0) (= (MapType0Select Heap@@19 this@@14 next) null)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm UnfoldingMask@4 this@@14 value)) (=> (HasDirectPerm UnfoldingMask@4 this@@14 value) (=> (= (ControlFlow 0 15) 14) anon17_correct))))))
(let ((anon15_correct  (=> (= UnfoldingMask@5 (MapType1Store UnfoldingMask@4 null (valid (MapType0Select Heap@@19 this@@14 next)) (real_2_U (- (U_2_real (MapType1Select UnfoldingMask@4 null (valid (MapType0Select Heap@@19 this@@14 next)))) FullPerm)))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= 0 (- i@@3 1))) (=> (<= 0 (- i@@3 1)) (=> (= (ControlFlow 0 6) (- 0 5)) (< (- i@@3 1) (length Heap@@19 (MapType0Select Heap@@19 this@@14 next)))))))))
(let ((anon27_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 6)) anon15_correct)))
(let ((anon27_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (valid (MapType0Select Heap@@19 this@@14 next)))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (valid (MapType0Select Heap@@19 this@@14 next))))) (=> (= (ControlFlow 0 8) 6) anon15_correct))))))
(let ((anon25_Else_correct  (=> (not (or (= i@@3 0) (= (MapType0Select Heap@@19 this@@14 next) null))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm UnfoldingMask@4 this@@14 next)) (=> (HasDirectPerm UnfoldingMask@4 this@@14 next) (and (and (=> (= (ControlFlow 0 18) 17) anon26_Else_correct) (=> (= (ControlFlow 0 18) 8) anon27_Then_correct)) (=> (= (ControlFlow 0 18) 10) anon27_Else_correct)))))))
(let ((anon24_Else_correct  (=> (= i@@3 0) (and (=> (= (ControlFlow 0 22) 15) anon25_Then_correct) (=> (= (ControlFlow 0 22) 18) anon25_Else_correct)))))
(let ((anon24_Then_correct  (=> (not (= i@@3 0)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (HasDirectPerm UnfoldingMask@4 this@@14 next)) (=> (HasDirectPerm UnfoldingMask@4 this@@14 next) (and (=> (= (ControlFlow 0 20) 15) anon25_Then_correct) (=> (= (ControlFlow 0 20) 18) anon25_Else_correct)))))))
(let ((anon8_correct  (=> (state Heap@@19 UnfoldingMask@4) (and (=> (= (ControlFlow 0 23) 20) anon24_Then_correct) (=> (= (ControlFlow 0 23) 22) anon24_Else_correct)))))
(let ((anon23_Else_correct  (=> (= (MapType0Select Heap@@19 this@@14 next) null) (=> (and (= UnfoldingMask@4 UnfoldingMask@2) (= (ControlFlow 0 25) 23)) anon8_correct))))
(let ((anon23_Then_correct  (=> (and (not (= (MapType0Select Heap@@19 this@@14 next) null)) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 null (valid (MapType0Select Heap@@19 this@@14 next)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 null (valid (MapType0Select Heap@@19 this@@14 next)))) FullPerm))))) (=> (and (and (InsidePredicate (valid this@@14) (MapType0Select Heap@@19 null (valid this@@14)) (valid (MapType0Select Heap@@19 this@@14 next)) (MapType0Select Heap@@19 null (valid (MapType0Select Heap@@19 this@@14 next)))) (state Heap@@19 UnfoldingMask@3)) (and (= UnfoldingMask@4 UnfoldingMask@3) (= (ControlFlow 0 24) 23))) anon8_correct))))
(let ((anon6_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (valid this@@14) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid this@@14))) FullPerm)))) (=> (and (not (= this@@14 null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this@@14 value (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this@@14 value)) FullPerm))))) (=> (and (and (state Heap@@19 UnfoldingMask@1) (not (= this@@14 null))) (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 this@@14 next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 this@@14 next)) FullPerm)))) (state Heap@@19 UnfoldingMask@2))) (and (=> (= (ControlFlow 0 26) 24) anon23_Then_correct) (=> (= (ControlFlow 0 26) 25) anon23_Else_correct)))))))
(let ((anon22_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 29) 26)) anon6_correct)))
(let ((anon22_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid this@@14))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid this@@14)))) (=> (= (ControlFlow 0 27) 26) anon6_correct))))))
(let ((anon20_Else_correct  (=> (and (and (< i@@3 (length Heap@@19 this@@14)) (state Heap@@19 Mask@0)) (and (|valid#trigger| Heap@@19 (valid this@@14)) (= (MapType0Select Heap@@19 null (valid this@@14)) (CombineFrames (FrameFragment (MapType0Select Heap@@19 this@@14 value)) (CombineFrames (FrameFragment (MapType0Select Heap@@19 this@@14 next)) (FrameFragment (ite (not (= (MapType0Select Heap@@19 this@@14 next) null)) (MapType0Select Heap@@19 null (valid (MapType0Select Heap@@19 this@@14 next))) EmptyFrame))))))) (and (=> (= (ControlFlow 0 30) 27) anon22_Then_correct) (=> (= (ControlFlow 0 30) 29) anon22_Else_correct)))))
(let ((anon3_correct true))
(let ((anon21_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon21_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid this@@14))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid this@@14)))) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@19 this@@14 $allocated)) (= AssumeFunctionsAbove 0)) (and (= Mask@0 (MapType1Store ZeroMask null (valid this@@14) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid this@@14))) FullPerm)))) (state Heap@@19 Mask@0))) (and (and (state Heap@@19 Mask@0) (<= 0 i@@3)) (and (state Heap@@19 Mask@0) (state Heap@@19 Mask@0)))) (and (and (=> (= (ControlFlow 0 31) 30) anon20_Else_correct) (=> (= (ControlFlow 0 31) 2) anon21_Then_correct)) (=> (= (ControlFlow 0 31) 4) anon21_Else_correct))))))
