...
(= (type (MapType0Store arg0@@18 arg1@@6 arg2)) (MapType0Type aVar0 aVar1@@0))))
 ...
 :weight 0
)))) (= (Ctor RefType) 9)) (= (type nodes) (FieldType NormalFieldType (MapType0Type RefType boolType)))) (= (type f_7) (FieldType NormalFieldType intType))))
(assert (distinct $allocated nodes f_7)
)
...
(assert  (and (and (and (and (and (and (and (and (and (= (type Mask@0) (MapType2Type RefType realType)) (= (type this) RefType)) (= (type Mask@1) (MapType2Type RefType realType))) (= (type QPMask@0) (MapType2Type RefType realType))) (= (type Heap@0) (MapType1Type RefType))) (= (type QPMask@1) (MapType2Type RefType realType))) (= (type Heap@@9) (MapType1Type RefType))) (= (type PostMask@0) (MapType2Type RefType realType))) (= (type PostHeap@0) (MapType1Type RefType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv1 arg0@@43)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon11_Else_correct  (=> (= (ControlFlow 0 17) (- 0 16)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (U_2_bool (MapType0Select (MapType1Select PostHeap@0 this nodes) z_1))) (U_2_bool (MapType0Select (MapType1Select PostHeap@0 this nodes) z_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1))))
 :qid |stdinbpl.495:15|
 :skolemid |88|
 :no-pattern (type z_1)
...
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 15) (- 0 14)) (HasDirectPerm PostMask@0 this nodes))))
(let ((anon10_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (not (= this null)) (= PostMask@0 (MapType2Store ZeroMask this nodes (real_2_U (+ (U_2_real (MapType2Select ZeroMask this nodes)) FullPerm))))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 18) 15) anon11_Then_correct) (=> (= (ControlFlow 0 18) 17) anon11_Else_correct))))))
(let ((anon8_correct  (=> (= Mask@1 (MapType2Store QPMask@0 this nodes (real_2_U (- (U_2_real (MapType2Select QPMask@0 this nodes)) FullPerm)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((z_2 T@U) (z_2_1 T@U) ) (!  (=> (and (= (type z_2) RefType) (= (type z_2_1) RefType)) (=> (and (and (and (and (not (= z_2 z_2_1)) (U_2_bool (MapType0Select (MapType1Select Heap@0 this nodes) z_2))) (U_2_bool (MapType0Select (MapType1Select Heap@0 this nodes) z_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_2 z_2_1))))
 :qid |stdinbpl.567:17|
 :skolemid |94|
 :pattern ( (neverTriggered3 z_2) (neverTriggered3 z_2_1))
))) (=> (forall ((z_2@@0 T@U) (z_2_1@@0 T@U) ) (!  (=> (and (= (type z_2@@0) RefType) (= (type z_2_1@@0) RefType)) (=> (and (and (and (and (not (= z_2@@0 z_2_1@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@0 this nodes) z_2@@0))) (U_2_bool (MapType0Select (MapType1Select Heap@0 this nodes) z_2_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_2@@0 z_2_1@@0))))
 :qid |stdinbpl.567:17|
 :skolemid |94|
 :pattern ( (neverTriggered3 z_2@@0) (neverTriggered3 z_2_1@@0))
)) (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((z_2@@1 T@U) ) (!  (=> (and (= (type z_2@@1) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@0 this nodes) z_2@@1))) (>= (U_2_real (MapType2Select Mask@1 z_2@@1 f_7)) FullPerm))
 :qid |stdinbpl.574:17|
 :skolemid |95|
 :pattern ( (MapType1Select Heap@0 z_2@@1 f_7))
 :pattern ( (MapType2Select QPMask@1 z_2@@1 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@0 this nodes) z_2@@1))
))))))))
(let ((anon12_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 4)) anon8_correct)))
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType2Select QPMask@0 this nodes)))) (=> (<= FullPerm (U_2_real (MapType2Select QPMask@0 this nodes))) (=> (= (ControlFlow 0 6) 4) anon8_correct))))))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 13)) (= FullPerm (U_2_real (MapType2Select QPMask@0 this nodes)))) (=> (= FullPerm (U_2_real (MapType2Select QPMask@0 this nodes))) (=> (and (= Heap@0 (MapType1Store Heap@@9 this nodes (|Set#Empty| RefType))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 9) (- 0 12)) (HasDirectPerm QPMask@0 this nodes)) (=> (HasDirectPerm QPMask@0 this nodes) (and (=> (= (ControlFlow 0 9) (- 0 11)) (HasDirectPerm QPMask@0 this nodes)) (=> (HasDirectPerm QPMask@0 this nodes) (and (=> (= (ControlFlow 0 9) (- 0 10)) (|Set#Equal| (MapType1Select Heap@0 this nodes) (MapType1Select Heap@@9 this nodes))) (=> (|Set#Equal| (MapType1Select Heap@0 this nodes) (MapType1Select Heap@@9 this nodes)) (=> (state Heap@0 QPMask@0) (and (=> (= (ControlFlow 0 9) 6) anon12_Then_correct) (=> (= (ControlFlow 0 9) 8) anon12_Else_correct))))))))))))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType0Select (MapType1Select Heap@@9 this nodes) x_1))) (U_2_bool (MapType0Select (MapType1Select Heap@@9 this nodes) x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.437:15|
 :skolemid |82|
 :no-pattern (type x_1)
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@@9 this nodes) x_1@@0))) (U_2_bool (MapType0Select (MapType1Select Heap@@9 this nodes) x_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.437:15|
 :skolemid |82|
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@9 this nodes) x_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 x_1@@1) (= (invRecv1 x_1@@1) x_1@@1))))
 :qid |stdinbpl.443:22|
 :skolemid |83|
 :pattern ( (MapType1Select Heap@@9 x_1@@1 f_7))
 :pattern ( (MapType2Select QPMask@0 x_1@@1 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@@9 this nodes) x_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@9 this nodes) (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.447:22|
 :skolemid |84|
 :pattern ( (invRecv1 o_3))
)) (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@@9 this nodes) x_1@@2))) (not (= x_1@@2 null)))
 :qid |stdinbpl.453:22|
 :skolemid |85|
 :pattern ( (MapType1Select Heap@@9 x_1@@2 f_7))
 :pattern ( (MapType2Select QPMask@0 x_1@@2 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@@9 this nodes) x_1@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@9 this nodes) (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@0) o_3@@0)) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType2Select Mask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@9 this nodes) (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType2Select Mask@0 o_3@@0 f_7))))))
 :qid |stdinbpl.459:22|
 :skolemid |86|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 19) 18) anon10_Then_correct) (=> (= (ControlFlow 0 19) 9) anon10_Else_correct)))))))))
(let ((anon9_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@0 this nodes))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType1Select Heap@@9 this $allocated))) (=> (and (and (not (= this null)) (= Mask@0 (MapType2Store ZeroMask this nodes (real_2_U (+ (U_2_real (MapType2Select ZeroMask this nodes)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 21) 2) anon9_Then_correct) (=> (= (ControlFlow 0 21) 19) anon9_Else_correct))))))
