...
(declare-fun i@@6 () Int)
(declare-fun j@@5 () Int)
(assert  (and (= (type S) (SeqType RefType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id foo)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 (|Seq#Length| S)))) (= (ControlFlow 0 15) 11)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (<= 0 i_2) (< i_2 (|Seq#Length| S))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< i_2 (|Seq#Length| S))) (=> (< i_2 (|Seq#Length| S)) (=> (= (ControlFlow 0 12) 11) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 (|Seq#Length| S)))) (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length| S)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| S i_3) (|Seq#Index| S i_3_1))))
 :qid |stdinbpl.642:17|
 :skolemid |59|
...
)) (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((i_3@@1 Int) ) (!  (=> (and (<= 0 i_3@@1) (< i_3@@1 (|Seq#Length| S))) (>= (U_2_real (MapType1Select ZeroMask (|Seq#Index| S i_3@@1) f_7)) FullPerm))
 :qid |stdinbpl.649:17|
 :skolemid |60|
 :pattern ( (|Seq#Index| S i_3@@1))
 :pattern ( (|Seq#Index| S i_3@@1))
)))))))
(let ((anon9_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (>= i_1 0) (and (< i_1 (|Seq#Length| S)) (and (>= j_1 0) (and (< j_1 (|Seq#Length| S)) (not (= i_1 j_1)))))) (not (= (|Seq#Index| S i_1) (|Seq#Index| S j_1))))
 :qid |stdinbpl.609:20|
 :skolemid |58|
...
(let ((anon10_Else_correct  (=> (and (not (and (>= i@@6 0) (and (< i@@6 (|Seq#Length| S)) (and (>= j@@5 0) (and (< j@@5 (|Seq#Length| S)) (not (= i@@6 j@@5))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (>= i@@6 0) (and (< i@@6 (|Seq#Length| S)) (and (>= j@@5 0) (and (< j@@5 (|Seq#Length| S)) (not (= i@@6 j@@5)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i@@6 (|Seq#Length| S))) (=> (< i@@6 (|Seq#Length| S)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j@@5 (|Seq#Length| S))) (=> (< j@@5 (|Seq#Length| S)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (and (=> (= (ControlFlow 0 17) 16) anon9_Else_correct) (=> (= (ControlFlow 0 17) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 17) 7) anon10_Else_correct)))))
