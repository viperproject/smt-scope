...
(let ((anon3_Then_correct  (=> (not (= (MapType0Select Heap@@13 x@@20 next) null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 x@@20 next)) (=> (HasDirectPerm Mask@1 x@@20 next) (=> (and (and (= Mask@2 (MapType1Store Mask@1 null (LL (MapType0Select Heap@@13 x@@20 next)) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (LL (MapType0Select Heap@@13 x@@20 next)))) FullPerm)))) (state Heap@@13 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 2) 1))) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@13 ZeroMask) (U_2_bool (MapType0Select Heap@@13 x@@20 $allocated))) (and (not (= x@@20 null)) (= Mask@0 (MapType1Store ZeroMask x@@20 val (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@20 val)) FullPerm)))))) (and (and (state Heap@@13 Mask@0) (not (= x@@20 null))) (and (= Mask@1 (MapType1Store Mask@0 x@@20 next (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@20 next)) FullPerm)))) (state Heap@@13 Mask@1)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@1 x@@20 next)) (=> (HasDirectPerm Mask@1 x@@20 next) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))))
