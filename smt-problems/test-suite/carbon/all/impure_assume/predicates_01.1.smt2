...
(declare-fun i@@5 () Int)
(declare-fun j () Int)
(assert  (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type x@@14) RefType)) (= (type y@@1) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x@@14 $allocated))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@10 y@@1 $allocated)) (< NoPerm px)) (and (state Heap@@10 ZeroMask) (state Heap@@10 ZeroMask))) (and (and (< NoPerm py) (state Heap@@10 ZeroMask)) (and (state Heap@@10 ZeroMask) (= perm@0 (/ (to_real 1) (to_real 10)))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (= Mask@0 (MapType1Store ZeroMask null (P x@@14 i@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@14 i@@5))) perm@0)))) (state Heap@@10 Mask@0)) (=> (and (and (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (<= px (U_2_real (MapType1Select Mask@0 null (P x@@14 i@@5)))) (state Heap@@10 Mask@0))) (and (and (state Heap@@10 Mask@0) (<= (__iar__assume_helper_1  (and (= x@@14 y@@1) (= i@@5 j)) px py) (U_2_real (MapType1Select Mask@0 null (P y@@1 j))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= px (/ (to_real 1) (to_real 10)))) (=> (<= px (/ (to_real 1) (to_real 10))) (=> (state Heap@@10 Mask@0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= y@@1 x@@14)) (=> (= y@@1 x@@14) (=> (= (ControlFlow 0 2) (- 0 1)) (= i@@5 j)))))))))))))))
