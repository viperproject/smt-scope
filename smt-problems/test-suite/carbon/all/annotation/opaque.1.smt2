...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (and (and (|isGreaterOne'| Heap@@72 j) (state Heap@@72 ZeroMask)) (and (state Heap@@72 ZeroMask) (= (ControlFlow 0 4) (- 0 3)))) (> j 1))))
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (> j (- 0 60)))))
(let ((anon0_correct  (=> (state Heap@@72 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (> j (- 0 40))) (and (state Heap@@72 ZeroMask) (state Heap@@72 ZeroMask))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
...
(declare-fun Heap@@72 () T@U)
(assert (= (type Heap@@72) (MapType0Type RefType)))
(set-info :boogie-vc-id mFac2_3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (= tmp@0 (* 6 (fac2 Heap@@72 1)))) (=> (= tmp@0 (* 6 (fac2 Heap@@72 1))) (=> (and (state Heap@@72 ZeroMask) (= (ControlFlow 0 5) (- 0 4))) (= tmp@0 6))))))
(let ((anon9_Then_correct true))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (= tmp@0 (* 3 (fac2 Heap@@72 2)))) (=> (= tmp@0 (* 3 (fac2 Heap@@72 2))) (=> (state Heap@@72 ZeroMask) (and (=> (= (ControlFlow 0 7) 3) anon9_Then_correct) (=> (= (ControlFlow 0 7) 5) anon9_Else_correct)))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (=> (and (= tmp@0 (fac2 Heap@@72 3)) (state Heap@@72 ZeroMask)) (and (=> (= (ControlFlow 0 9) 2) anon8_Then_correct) (=> (= (ControlFlow 0 9) 7) anon8_Else_correct)))))
