...
(assert  (and (and (= (type Heap@@33) (MapType0Type RefType)) (= (type this@@3) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |Cell_get#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (and (state Heap@@33 ZeroMask) (U_2_bool (MapType0Select Heap@@33 this@@3 $allocated))) (and (= AssumeFunctionsAbove 5) (not (= this@@3 null)))) (and (and (= Mask@0 (MapType1Store ZeroMask this@@3 Cell_x (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@3 Cell_x)) FullPerm)))) (state Heap@@33 Mask@0)) (and (state Heap@@33 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm Mask@0 this@@3 Cell_x))))
...
(set-info :boogie-vc-id succeeds1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon17_Else_correct true))
(let ((anon17_Then_correct true))
(let ((anon15_Else_correct  (=> (and (forall ((i1_2_1 Int) ) (!  (=> (and (<= 0 i1_2_1) (< i1_2_1 a_2)) (>= (g Heap@@33 i1_2_1) 0))
 :qid |stdinbpl.2025:20|
 :skolemid |158|
 :pattern ( (|g#frame| EmptyFrame i1_2_1))
)) (state Heap@@33 ZeroMask)) (and (=> (= (ControlFlow 0 11) 9) anon17_Then_correct) (=> (= (ControlFlow 0 11) 10) anon17_Else_correct)))))
(let ((anon8_correct true))
(let ((anon16_Else_correct  (=> (and (not (and (<= 0 i1_1) (< i1_1 a_2))) (= (ControlFlow 0 8) 5)) anon8_correct)))
(let ((anon16_Then_correct  (=> (and (<= 0 i1_1) (< i1_1 a_2)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (>= (g Heap@@33 i1_1) 0)) (=> (>= (g Heap@@33 i1_1) 0) (=> (= (ControlFlow 0 6) 5) anon8_correct))))))
(let ((anon14_Then_correct true))
(let ((anon4_correct true))
(let ((anon13_Then_correct  (=> (and (<= 0 i1_3) (< i1_3 a_2)) (and (=> (= (ControlFlow 0 4) 3) anon14_Then_correct) (=> (= (ControlFlow 0 4) 1) anon4_correct)))))
(let ((anon13_Else_correct  (=> (and (not (and (<= 0 i1_3) (< i1_3 a_2))) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (and (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (> a_2 0) (state Heap@@33 ZeroMask))) (and (and (and (and (=> (= (ControlFlow 0 12) 11) anon15_Else_correct) (=> (= (ControlFlow 0 12) 6) anon16_Then_correct)) (=> (= (ControlFlow 0 12) 8) anon16_Else_correct)) (=> (= (ControlFlow 0 12) 4) anon13_Then_correct)) (=> (= (ControlFlow 0 12) 2) anon13_Else_correct)))))
