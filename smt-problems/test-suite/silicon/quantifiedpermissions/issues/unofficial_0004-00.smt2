(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:18:25
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0004.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (forall ((i@5@01 Int) (j@6@01 Int)) (!
  ...
  :pattern ((Seq_index
    ...
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01))
    j@6@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0004.vpr@13@7@13@133-aux|)))
(assert (forall ((i@5@01 Int) (j@6@01 Int)) (!
  (=>
    (and
      (>= i@5@01 0)
  ...
  :pattern ((Seq_index
    ...
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01))
    j@6@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0004.vpr@13@7@13@133|)))
(assert (=
  ($Snap.second ($Snap.second $t@4@01))
  ($Snap.combine
...
(assert (forall ((i@13@01 Int)) (!
  ...
  :pattern ((Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01))
    i@13@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0004.vpr@16@7@17@100-aux|)))
(assert (forall ((i@13@01 Int)) (!
  (=>
    (and
      (<= 0 i@13@01)
  ...
  :pattern ((Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01))
    i@13@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0004.vpr@16@7@17@100|)))
...
(assert (forall ((i@14@01 Int)) (!
  ...
  :pattern ((Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01))
    i@14@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0004.vpr@25@11@26@101-aux|)))
(push) ; 3
(assert (not (forall ((i@14@01 Int)) (!
  ...
  :pattern ((Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@4@01))
    i@14@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/unofficial_0004.vpr@25@11@26@101|))))
(check-sat)
; unsat
(pop) ; 3
; 0,00s
