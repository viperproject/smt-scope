...
(let ((anon4_Else_correct  (=> (not (= x@@12 0)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing (int_2_U (- x@@12 1)) (int_2_U x@@12))) (=> (decreasing (int_2_U (- x@@12 1)) (int_2_U x@@12)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded (int_2_U x@@12))) (=> (bounded (int_2_U x@@12)) (=> (and (state Heap@@13 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (and (= x@@12 0) (= (ControlFlow 0 2) 1)) anon3_correct)))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (>= x@@12 0) (state Heap@@13 ZeroMask))) (and (=> (= (ControlFlow 0 6) 2) anon4_Then_correct) (=> (= (ControlFlow 0 6) 3) anon4_Else_correct)))))
