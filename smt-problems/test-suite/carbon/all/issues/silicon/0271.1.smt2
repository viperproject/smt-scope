...
(assert  (and (and (and (= (type x@@18) RefType) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@@14) (MapType0Type RefType))) (= (type Mask@3) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |getf#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (and (and (and (not (= x@@18 null)) (= Mask@2 (MapType1Store ZeroMask x@@18 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@18 f_7)) FullPerm))))) (and (state Heap@@14 Mask@2) (not (= x@@18 null)))) (and (and (= Mask@3 (MapType1Store Mask@2 x@@18 g (real_2_U (+ (U_2_real (MapType1Select Mask@2 x@@18 g)) FullPerm)))) (state Heap@@14 Mask@3)) (and (state Heap@@14 Mask@3) (= (ControlFlow 0 3) (- 0 2))))) (HasDirectPerm Mask@3 x@@18 f_7))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@14 x@@18 $allocated)) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
