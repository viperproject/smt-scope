...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_2))) (= (ControlFlow 0 20) 16)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_2)) (and (=> (= (ControlFlow 0 17) (- 0 19)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 17) (- 0 18)) (< i_2 (|Seq#Length| xs))) (=> (< i_2 (|Seq#Length| xs)) (=> (= (ControlFlow 0 17) 16) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 15)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_3))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_3) (|Seq#Index| xs i_3_1))))
 :qid |stdinbpl.812:15|
 :skolemid |119|
 ...
 :qid |stdinbpl.812:15|
 :skolemid |119|
)) (=> (forall ((i_3@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_3@@1)) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index| xs i_3@@1)) (= (invRecv1 (|Seq#Index| xs i_3@@1)) i_3@@1)))
 :qid |stdinbpl.818:22|
 :skolemid |120|
 ...
 :pattern ( (|Seq#Index| xs i_3@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (|Seq#Index| xs (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.822:22|
 :skolemid |121|
 :pattern ( (invRecv1 o_3))
)) (forall ((i_3@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_3@@2)) (not (= (|Seq#Index| xs i_3@@2) null)))
 :qid |stdinbpl.828:22|
 :skolemid |122|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 9) (- 0 14)) (< 1 (|Seq#Length| xs))) (=> (< 1 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 9) (- 0 13)) (HasDirectPerm QPMask@0 (|Seq#Index| xs 1) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs 1) f_7) (=> (and (= a_2@0 (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs 1) f_7))) (state Heap@@9 QPMask@0)) (and (=> (= (ControlFlow 0 9) (- 0 12)) (< 1 (|Seq#Length| xs))) (=> (< 1 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (HasDirectPerm QPMask@0 (|Seq#Index| xs 1) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs 1) f_7) (=> (and (= a_2@1 (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs 1) f_7))) (state Heap@@9 QPMask@0)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< 1 (|Seq#Length| xs))) (=> (< 1 (|Seq#Length| xs)) (=> (= (ControlFlow 0 9) (- 0 8)) (HasDirectPerm QPMask@0 (|Seq#Index| xs 1) f_7)))))))))))))))))))))
(let ((anon9_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_1)) (not (= i_1 j_1)))) (not (= (|Seq#Index| xs i_1) (|Seq#Index| xs j_1))))
 :qid |stdinbpl.794:20|
 :skolemid |118|
...
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 21) 9) anon11_Else_correct) (=> (= (ControlFlow 0 21) 17) anon12_Then_correct)) (=> (= (ControlFlow 0 21) 20) anon12_Else_correct)))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i@@6)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j@@5)) (not (= i@@6 j@@5))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
...
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (> (|Seq#Length| xs) 3) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 22) 21) anon9_Else_correct) (=> (= (ControlFlow 0 22) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 22) 7) anon10_Else_correct))))))
