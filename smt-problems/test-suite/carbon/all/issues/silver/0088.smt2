...
(let ((anon10_Then_correct  (=> (and (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (< i@0 1) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 7) 4) anon11_Then_correct) (=> (= (ControlFlow 0 7) 5) anon12_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon12_Else_correct)))))
