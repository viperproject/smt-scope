...
(declare-fun _receiver0_1 () T@U)
(declare-fun _target0_1 () T@U)
(declare-fun _receiver0_1@0 () T@U)
(declare-fun freshObj@1 () T@U)
(declare-fun Heap@2 () T@U)
(declare-fun Mask@3 () T@U)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type a_2) RefType)) (= (type b_2) RefType)) (= (type c) RefType)) (= (type d) RefType)) (= (type e) RefType)) (= (type c@0) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type d@0) RefType)) (= (type freshObj@0) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type _receiver0) RefType)) (= (type _target0) RefType)) (= (type _target0@0) RefType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type e@0) RefType)) (= (type Heap@1) (MapType0Type RefType))) (= (type _receiver0_1) RefType)) (= (type _target0_1) RefType)) (= (type _receiver0_1@0) RefType)) (= (type freshObj@1) RefType)) (= (type Heap@2) (MapType0Type RefType))) (= (type Mask@3) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@10 a_2 $allocated)) (U_2_bool (MapType0Select Heap@@10 b_2 $allocated))) (and (U_2_bool (MapType0Select Heap@@10 c $allocated)) (U_2_bool (MapType0Select Heap@@10 d $allocated)))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@10 e $allocated)) (not (= c@0 null))) (and (= Mask@0 (MapType1Store ZeroMask c@0 n (real_2_U (+ (U_2_real (MapType1Select ZeroMask c@0 n)) FullPerm)))) (state Heap@@10 Mask@0))) (and (and (state Heap@@10 Mask@0) (U_2_bool (MapType0Select Heap@@10 c@0 $allocated))) (and (U_2_bool (MapType0Select Heap@@10 d@0 $allocated)) (state Heap@@10 Mask@0)))) (=> (and (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@10 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@10 freshObj@0 $allocated (bool_2_U true)))) (and (and (= Mask@1 (MapType1Store Mask@0 freshObj@0 n (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@0 n)) FullPerm)))) (state Heap@0 Mask@1)) (and (U_2_bool (MapType0Select Heap@0 _receiver0 $allocated)) (U_2_bool (MapType0Select Heap@0 _target0 $allocated))))) (and (and (and (state Heap@0 Mask@1) (not (= _target0@0 null))) (and (= Mask@2 (MapType1Store Mask@1 _target0@0 n (real_2_U (+ (U_2_real (MapType1Select Mask@1 _target0@0 n)) FullPerm)))) (state Heap@0 Mask@2))) (and (and (state Heap@0 Mask@2) (U_2_bool (MapType0Select Heap@0 _target0@0 $allocated))) (and (U_2_bool (MapType0Select Heap@0 e@0 $allocated)) (state Heap@0 Mask@2))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= FullPerm (U_2_real (MapType1Select Mask@2 c@0 n)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@2 c@0 n))) (=> (and (and (= Heap@1 (MapType0Store Heap@0 c@0 n _target0@0)) (state Heap@1 Mask@2)) (and (U_2_bool (MapType0Select Heap@1 _receiver0_1 $allocated)) (U_2_bool (MapType0Select Heap@1 _target0_1 $allocated)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@2 c@0 n)) (=> (HasDirectPerm Mask@2 c@0 n) (=> (and (and (and (= _receiver0_1@0 (MapType0Select Heap@1 c@0 n)) (state Heap@1 Mask@2)) (and (not (= freshObj@1 null)) (not (U_2_bool (MapType0Select Heap@1 freshObj@1 $allocated))))) (and (and (= Heap@2 (MapType0Store Heap@1 freshObj@1 $allocated (bool_2_U true))) (= Mask@3 (MapType1Store Mask@2 freshObj@1 n (real_2_U (+ (U_2_real (MapType1Select Mask@2 freshObj@1 n)) FullPerm))))) (and (state Heap@2 Mask@3) (= (ControlFlow 0 2) (- 0 1))))) (= FullPerm (U_2_real (MapType1Select Mask@3 _receiver0_1@0 n)))))))))))))))
