...
(let ((anon3_Then_correct  (=> (not (= (MapType0Select Heap@@11 this@@11 next) null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 this@@11 next)) (=> (HasDirectPerm Mask@0 this@@11 next) (=> (> wildcard@1 NoPerm) (=> (and (and (= Mask@1 (MapType1Store Mask@0 null (valid (MapType0Select Heap@@11 this@@11 next)) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (valid (MapType0Select Heap@@11 this@@11 next)))) wildcard@1)))) (state Heap@@11 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 2) 1))) anon2_correct)))))))
(let ((anon0_correct  (=> (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 this@@11 $allocated))) (=> (and (and (> wildcard@0 NoPerm) (not (= this@@11 null))) (and (= Mask@0 (MapType1Store ZeroMask this@@11 next (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@11 next)) wildcard@0)))) (state Heap@@11 Mask@0))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@0 this@@11 next)) (=> (HasDirectPerm Mask@0 this@@11 next) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))))
