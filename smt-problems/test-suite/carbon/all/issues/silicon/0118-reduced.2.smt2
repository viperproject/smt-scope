...
(assert  (and (and (= (type Heap@@22) (MapType0Type RefType)) (= (type this@@13) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |Node#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@22 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@22 this@@13 $allocated))) (=> (and (and (not (= this@@13 null)) (= Mask@0 (MapType1Store ZeroMask this@@13 next (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@13 next)) FullPerm))))) (and (state Heap@@22 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@0 this@@13 next))))))
