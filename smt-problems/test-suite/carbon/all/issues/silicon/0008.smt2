...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type x@@8) RefType) (= (type y@@1) RefType)) (= (type Mask@6) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type PostMask@2) (MapType1Type RefType realType))) (= (type PostMask@1) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type PostMask@3) (MapType1Type RefType realType))) (= (type PostMask@4) (MapType1Type RefType realType))) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id deAlias)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 34) (let ((anon5_correct true))
(let ((anon19_Else_correct  (=> (= x@@8 y@@1) (=> (and (= PostMask@4 PostMask@1) (= (ControlFlow 0 25) 21)) anon5_correct))))
(let ((anon19_Then_correct  (=> (not (= x@@8 y@@1)) (and (=> (= (ControlFlow 0 22) (- 0 24)) (>= k NoPerm)) (=> (>= k NoPerm) (=> (=> (> k NoPerm) (not (= x@@8 null))) (=> (and (= PostMask@2 (MapType1Store PostMask@1 x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select PostMask@1 x@@8 f_7)) k)))) (state PostHeap@0 PostMask@2)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (>= k NoPerm)) (=> (>= k NoPerm) (=> (=> (> k NoPerm) (not (= y@@1 null))) (=> (and (and (= PostMask@3 (MapType1Store PostMask@2 y@@1 f_7 (real_2_U (+ (U_2_real (MapType1Select PostMask@2 y@@1 f_7)) k)))) (state PostHeap@0 PostMask@3)) (and (= PostMask@4 PostMask@3) (= (ControlFlow 0 22) 21))) anon5_correct)))))))))))
(let ((anon3_correct  (=> (state PostHeap@0 PostMask@1) (and (=> (= (ControlFlow 0 26) 22) anon19_Then_correct) (=> (= (ControlFlow 0 26) 25) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (not (= x@@8 y@@1)) (=> (and (= PostMask@1 ZeroMask) (= (ControlFlow 0 29) 26)) anon3_correct))))
(let ((anon18_Then_correct  (=> (and (= x@@8 y@@1) (= perm@1 (* (to_real 2) k))) (and (=> (= (ControlFlow 0 27) (- 0 28)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (=> (> perm@1 NoPerm) (not (= x@@8 null))) (=> (and (and (= PostMask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) perm@1)))) (state PostHeap@0 PostMask@0)) (and (= PostMask@1 PostMask@0) (= (ControlFlow 0 27) 26))) anon3_correct)))))))
(let ((anon17_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 30) 27) anon18_Then_correct) (=> (= (ControlFlow 0 30) 29) anon18_Else_correct)))))
(let ((anon16_correct true))
(let ((anon15_correct  (=> (= Mask@5 (MapType1Store Mask@4 y@@1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@4 y@@1 f_7)) k)))) (=> (and (= Mask@6 Mask@5) (= (ControlFlow 0 3) 1)) anon16_correct))))
(let ((anon24_Else_correct  (=> (and (= k NoPerm) (= (ControlFlow 0 6) 3)) anon15_correct)))
(let ((anon24_Then_correct  (=> (not (= k NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= k (U_2_real (MapType1Select Mask@4 y@@1 f_7)))) (=> (<= k (U_2_real (MapType1Select Mask@4 y@@1 f_7))) (=> (= (ControlFlow 0 4) 3) anon15_correct))))))
(let ((anon13_correct  (=> (= Mask@4 (MapType1Store Mask@3 x@@8 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@3 x@@8 f_7)) k)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (>= k NoPerm)) (=> (>= k NoPerm) (and (=> (= (ControlFlow 0 7) 4) anon24_Then_correct) (=> (= (ControlFlow 0 7) 6) anon24_Else_correct)))))))
(let ((anon23_Else_correct  (=> (and (= k NoPerm) (= (ControlFlow 0 11) 7)) anon13_correct)))
(let ((anon23_Then_correct  (=> (not (= k NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= k (U_2_real (MapType1Select Mask@3 x@@8 f_7)))) (=> (<= k (U_2_real (MapType1Select Mask@3 x@@8 f_7))) (=> (= (ControlFlow 0 9) 7) anon13_correct))))))
(let ((anon22_Then_correct  (=> (not (= x@@8 y@@1)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (>= k NoPerm)) (=> (>= k NoPerm) (and (=> (= (ControlFlow 0 12) 9) anon23_Then_correct) (=> (= (ControlFlow 0 12) 11) anon23_Else_correct)))))))
(let ((anon22_Else_correct  (=> (= x@@8 y@@1) (=> (and (= Mask@6 Mask@3) (= (ControlFlow 0 2) 1)) anon16_correct))))
(let ((anon9_correct  (=> (and (= Mask@2 (MapType1Store Mask@1 x@@8 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 x@@8 f_7)) perm@0)))) (= Mask@3 Mask@2)) (and (=> (= (ControlFlow 0 15) 12) anon22_Then_correct) (=> (= (ControlFlow 0 15) 2) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 18) 15)) anon9_correct)))
(let ((anon21_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= perm@0 (U_2_real (MapType1Select Mask@1 x@@8 f_7)))) (=> (<= perm@0 (U_2_real (MapType1Select Mask@1 x@@8 f_7))) (=> (= (ControlFlow 0 16) 15) anon9_correct))))))
(let ((anon20_Then_correct  (=> (and (= x@@8 y@@1) (= perm@0 (* (to_real 2) k))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 19) 16) anon21_Then_correct) (=> (= (ControlFlow 0 19) 18) anon21_Else_correct)))))))
(let ((anon20_Else_correct  (=> (and (not (= x@@8 y@@1)) (= Mask@3 Mask@1)) (and (=> (= (ControlFlow 0 14) 12) anon22_Then_correct) (=> (= (ControlFlow 0 14) 2) anon22_Else_correct)))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated)) (U_2_bool (MapType0Select Heap@@9 y@@1 $allocated))) (and (<= NoPerm k) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 31) (- 0 33)) (>= k NoPerm)) (=> (>= k NoPerm) (=> (=> (> k NoPerm) (not (= x@@8 null))) (=> (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) k)))) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 31) (- 0 32)) (>= k NoPerm)) (=> (>= k NoPerm) (=> (and (and (=> (> k NoPerm) (not (= y@@1 null))) (= Mask@1 (MapType1Store Mask@0 y@@1 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@1 f_7)) k))))) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1))) (and (and (=> (= (ControlFlow 0 31) 30) anon17_Then_correct) (=> (= (ControlFlow 0 31) 19) anon20_Then_correct)) (=> (= (ControlFlow 0 31) 14) anon20_Else_correct)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 34) 31) anon0_correct)))
