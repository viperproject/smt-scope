...
(= (type (MapType1Store arg0@@22 arg1@@8 arg2@@2 arg3@@0)) (MapType1Type aVar0@@0 aVar1@@0))))
 ...
 :weight 0
)))) (= (type null) RefType)) (= (Ctor PredicateType_validType) 11)) (= (Ctor FrameTypeType) 12)) (forall ((arg0@@23 T@U) ) (! (= (type (valid arg0@@23)) (FieldType PredicateType_validType FrameTypeType))
 :qid |funType:valid|
 :pattern ( (valid arg0@@23))
))))
(assert (forall ((Heap T@U) (Mask T@U) (list T@U) ) (!  (=> (and (and (and (= (type Heap) (MapType0Type RefType)) (= (type Mask) (MapType1Type RefType realType))) (= (type list) RefType)) (and (state Heap Mask) (or (< AssumeFunctionsAbove 0) (|size#trigger| (MapType0Select Heap null (valid list)) list)))) (>= (|size'| Heap list) 1))
 :qid |stdinbpl.216:15|
 :skolemid |26|
 :pattern ( (state Heap Mask) (|size'| Heap list))
)))
...
(assert (forall ((list@@0 T@U) ) (!  (=> (= (type list@@0) RefType) (IsPredicateField (valid list@@0)))
 :qid |stdinbpl.342:15|
 :skolemid |29|
 :pattern ( (valid list@@0))
)))
(assert (forall ((Heap@@3 T@U) (list@@1 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type list@@1) RefType)) (dummyFunction (int_2_U (|size#triggerStateless| list@@1))))
 :qid |stdinbpl.197:15|
 :skolemid |23|
 :pattern ( (|size'| Heap@@3 list@@1))
)))
(assert (forall ((Heap@@4 T@U) (list@@2 T@U) ) (!  (=> (and (= (type Heap@@4) (MapType0Type RefType)) (= (type list@@2) RefType)) (|valid#everUsed| (valid list@@2)))
 :qid |stdinbpl.361:15|
 :skolemid |33|
 :pattern ( (|valid#trigger| Heap@@4 (valid list@@2)))
)))
...
(assert (forall ((Heap@@6 T@U) (list@@3 T@U) ) (!  (=> (and (= (type Heap@@6) (MapType0Type RefType)) (= (type list@@3) RefType)) (and (= (size Heap@@6 list@@3) (|size'| Heap@@6 list@@3)) (dummyFunction (int_2_U (|size#triggerStateless| list@@3)))))
 :qid |stdinbpl.193:15|
 :skolemid |22|
 :pattern ( (size Heap@@6 list@@3))
)))
(assert (forall ((list@@4 T@U) (list2 T@U) ) (!  (=> (and (and (= (type list@@4) RefType) (= (type list2) RefType)) (= (valid list@@4) (valid list2))) (= list@@4 list2))
 :qid |stdinbpl.352:15|
 :skolemid |31|
 :pattern ( (valid list@@4) (valid list2))
)))
...
(assert (forall ((list@@5 T@U) (list2@@0 T@U) ) (!  (=> (and (and (= (type list@@5) RefType) (= (type list2@@0) RefType)) (= (|valid#sm| list@@5) (|valid#sm| list2@@0))) (= list@@5 list2@@0))
 :qid |stdinbpl.356:15|
 :skolemid |32|
 :pattern ( (|valid#sm| list@@5) (|valid#sm| list2@@0))
)))
...
(assert (forall ((Heap@@9 T@U) (Mask@@6 T@U) (list@@6 T@U) ) (!  (=> (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (= (type list@@6) RefType)) (and (state Heap@@9 Mask@@6) (< AssumeFunctionsAbove 0))) (= (size Heap@@9 list@@6) (ite (= (MapType0Select Heap@@9 list@@6 next) null) 1 (+ 1 (|size'| Heap@@9 (MapType0Select Heap@@9 list@@6 next))))))
 :qid |stdinbpl.203:15|
 :skolemid |24|
 :pattern ( (state Heap@@9 Mask@@6) (size Heap@@9 list@@6))
 :pattern ( (state Heap@@9 Mask@@6) (|size#triggerStateless| list@@6) (|valid#trigger| Heap@@9 (valid list@@6)))
)))
...
(assert (forall ((list@@7 T@U) ) (!  (=> (= (type list@@7) RefType) (= (getPredWandId (valid list@@7)) 0))
 :qid |stdinbpl.346:15|
 :skolemid |30|
 :pattern ( (valid list@@7))
)))
...
(assert (forall ((Heap@@12 T@U) (Mask@@11 T@U) (list@@8 T@U) ) (!  (=> (and (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (= (type list@@8) RefType)) (state Heap@@12 Mask@@11)) (= (|size'| Heap@@12 list@@8) (|size#frame| (MapType0Select Heap@@12 null (valid list@@8)) list@@8)))
 :qid |stdinbpl.210:15|
 :skolemid |25|
 :pattern ( (state Heap@@12 Mask@@11) (|size'| Heap@@12 list@@8))
 :pattern ( (state Heap@@12 Mask@@11) (|size#triggerStateless| list@@8) (|valid#trigger| Heap@@12 (valid list@@8)))
)))
...
(assert (forall ((list@@9 T@U) ) (!  (=> (= (type list@@9) RefType) (= (PredicateMaskField (valid list@@9)) (|valid#sm| list@@9)))
 :qid |stdinbpl.338:15|
 :skolemid |28|
 :pattern ( (PredicateMaskField (valid list@@9)))
)))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon9_correct  (=> (state Heap@2 Mask@0) (=> (and (= Result@0 (ite (= (MapType0Select Heap@2 list@@10 next) null) 1 (+ 1 (size Heap@2 (MapType0Select Heap@2 list@@10 next))))) (= (ControlFlow 0 4) (- 0 3))) (>= Result@0 1)))))
(let ((anon13_Else_correct  (=> (= (MapType0Select Heap@0 list@@10 next) null) (=> (and (= Heap@2 Heap@0) (= (ControlFlow 0 6) 4)) anon9_correct))))
(let ((anon13_Then_correct  (=> (not (= (MapType0Select Heap@0 list@@10 next) null)) (=> (and (and (forall ((o_3 T@U) (f_7 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_7))))
(let ((A@@12 (FieldTypeInv0 (type f_7))))
 (=> (and (and (= (type o_3) RefType) (= (type f_7) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@0 null (|valid#sm| list@@10)) o_3 f_7)) (U_2_bool (MapType1Select (MapType0Select Heap@0 null (|valid#sm| (MapType0Select Heap@0 list@@10 next))) o_3 f_7)))) (U_2_bool (MapType1Select newPMask@0 o_3 f_7)))))
 :qid |stdinbpl.313:33|
 :skolemid |27|
 :pattern ( (MapType1Select newPMask@0 o_3 f_7))
)) (= Heap@1 (MapType0Store Heap@0 null (|valid#sm| list@@10) newPMask@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 5) 4))) anon9_correct))))
(let ((anon7_correct  (=> (= Heap@0 (MapType0Store Heap@@15 null (|valid#sm| list@@10) (MapType1Store (MapType0Select Heap@@15 null (|valid#sm| list@@10)) list@@10 next (bool_2_U true)))) (and (=> (= (ControlFlow 0 7) 5) anon13_Then_correct) (=> (= (ControlFlow 0 7) 6) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (|size#trigger| (MapType0Select Heap@@15 null (valid (MapType0Select Heap@@15 list@@10 next))) (MapType0Select Heap@@15 list@@10 next)) (= (ControlFlow 0 9) 7)) anon7_correct)))
(let ((anon11_Then_correct  (=> (and (= (MapType0Select Heap@@15 list@@10 next) null) (= (ControlFlow 0 8) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (> (U_2_real (MapType1Select UnfoldingMask@3 null (valid (MapType0Select Heap@@15 list@@10 next)))) NoPerm))))
(let ((anon11_Else_correct  (=> (not (= (MapType0Select Heap@@15 list@@10 next) null)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm UnfoldingMask@3 list@@10 next)) (=> (HasDirectPerm UnfoldingMask@3 list@@10 next) (and (=> (= (ControlFlow 0 10) 2) anon12_Then_correct) (=> (= (ControlFlow 0 10) 9) anon12_Else_correct)))))))
(let ((anon2_correct  (=> (state Heap@@15 UnfoldingMask@3) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm UnfoldingMask@3 list@@10 next)) (=> (HasDirectPerm UnfoldingMask@3 list@@10 next) (and (=> (= (ControlFlow 0 12) 8) anon11_Then_correct) (=> (= (ControlFlow 0 12) 10) anon11_Else_correct)))))))
(let ((anon10_Else_correct  (=> (= (MapType0Select Heap@@15 list@@10 next) null) (=> (and (= UnfoldingMask@3 UnfoldingMask@1) (= (ControlFlow 0 15) 12)) anon2_correct))))
(let ((anon10_Then_correct  (=> (not (= (MapType0Select Heap@@15 list@@10 next) null)) (=> (and (> wildcard@3 NoPerm) (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 null (valid (MapType0Select Heap@@15 list@@10 next)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 null (valid (MapType0Select Heap@@15 list@@10 next)))) wildcard@3))))) (=> (and (and (InsidePredicate (valid list@@10) (MapType0Select Heap@@15 null (valid list@@10)) (valid (MapType0Select Heap@@15 list@@10 next)) (MapType0Select Heap@@15 null (valid (MapType0Select Heap@@15 list@@10 next)))) (state Heap@@15 UnfoldingMask@2)) (and (= UnfoldingMask@3 UnfoldingMask@2) (= (ControlFlow 0 14) 12))) anon2_correct)))))
(let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@15 list@@10 $allocated)) (= AssumeFunctionsAbove 0)) (and (> wildcard@0 NoPerm) (= Mask@0 (MapType1Store ZeroMask null (valid list@@10) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid list@@10))) wildcard@0)))))) (and (and (state Heap@@15 Mask@0) (state Heap@@15 Mask@0)) (and (|valid#trigger| Heap@@15 (valid list@@10)) (= (MapType0Select Heap@@15 null (valid list@@10)) (CombineFrames (FrameFragment (MapType0Select Heap@@15 list@@10 next)) (FrameFragment (ite (not (= (MapType0Select Heap@@15 list@@10 next) null)) (MapType0Select Heap@@15 null (valid (MapType0Select Heap@@15 list@@10 next))) EmptyFrame))))))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (> (U_2_real (MapType1Select Mask@0 null (valid list@@10))) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@0 null (valid list@@10))) NoPerm) (=> (> wildcard@1 NoPerm) (=> (and (< wildcard@1 (U_2_real (MapType1Select Mask@0 null (valid list@@10)))) (= UnfoldingMask@0 (MapType1Store Mask@0 null (valid list@@10) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid list@@10))) wildcard@1))))) (=> (and (and (> wildcard@2 NoPerm) (not (= list@@10 null))) (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 list@@10 next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 list@@10 next)) wildcard@2)))) (state Heap@@15 UnfoldingMask@1))) (and (=> (= (ControlFlow 0 16) 14) anon10_Then_correct) (=> (= (ControlFlow 0 16) 15) anon10_Else_correct)))))))))))
