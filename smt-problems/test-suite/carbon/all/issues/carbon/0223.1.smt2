...
(assert  (and (and (and (and (= (type x@@30) RefType) (= (type PostHeap@0) (MapType0Type RefType))) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type Heap@@14) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id set)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon8_Else_correct true))
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((w T@U) (w_5 T@U) ) (!  (=> (and (= (type w) RefType) (= (type w_5) RefType)) (=> (and (and (and (and (not (= w w_5)) (U_2_bool (MapType2Select (|Set#Singleton| x@@30) w))) (U_2_bool (MapType2Select (|Set#Singleton| x@@30) w_5))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= w w_5))))
 :qid |stdinbpl.656:21|
 :skolemid |99|
 :pattern ( (neverTriggered2 w) (neverTriggered2 w_5))
 ...
 :qid |stdinbpl.656:21|
 :skolemid |99|
 :pattern ( (neverTriggered2 w@@0) (neverTriggered2 w_5@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((w@@1 T@U) ) (!  (=> (and (= (type w@@1) RefType) (U_2_bool (MapType2Select (|Set#Singleton| x@@30) w@@1))) (>= (U_2_real (MapType1Select PostMask@0 null (bar w@@1))) FullPerm))
 :qid |stdinbpl.663:21|
 :skolemid |100|
 :pattern ( (MapType0Select PostHeap@0 null (bar w@@1)))
 :pattern ( (MapType1Select PostMask@0 null (bar w@@1)))
 :pattern ( (MapType2Select (|Set#Singleton| x@@30) w@@1))
)))))))
(let ((anon7_Then_correct  (=> (and (and (state PostHeap@0 ZeroMask) (= PostMask@0 (MapType1Store ZeroMask null (bar x@@30) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (bar x@@30))) FullPerm))))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 6) 3) anon8_Then_correct) (=> (= (ControlFlow 0 6) 5) anon8_Else_correct)))))
(let ((anon7_Else_correct true))
(let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@14 x@@30 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (bar x@@30) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (bar x@@30))) FullPerm))))) (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0))) (and (=> (= (ControlFlow 0 7) 6) anon7_Then_correct) (=> (= (ControlFlow 0 7) 1) anon7_Else_correct))))))
