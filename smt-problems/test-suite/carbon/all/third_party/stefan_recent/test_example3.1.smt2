...
(assert  (and (and (and (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type __flatten_1@0) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type diz) RefType)) (= (type c) RefType)) (= (type __flatten_1) RefType)))
(set-info :boogie-vc-id parameters__main)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon2_correct  (=> (and (and (= Mask@1 (MapType1Store Mask@0 __flatten_1@0 Counter__x (real_2_U (- (U_2_real (MapType1Select Mask@0 __flatten_1@0 Counter__x)) FullPerm)))) (IdenticalOnKnownLocations Heap@0 ExhaleHeap@0 Mask@1)) (and (not (= __flatten_1@0 null)) (<= NoPerm dummy_yields_1@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= dummy_yields_1@0 NoPerm)) (=> (>= dummy_yields_1@0 NoPerm) (=> (=> (> dummy_yields_1@0 NoPerm) (not (= __flatten_1@0 null))) (=> (and (and (and (= Mask@2 (MapType1Store Mask@1 __flatten_1@0 Counter__x (real_2_U (+ (U_2_real (MapType1Select Mask@1 __flatten_1@0 Counter__x)) dummy_yields_1@0)))) (state ExhaleHeap@0 Mask@2)) (and (<= dummy_yields_1@0 FullPerm) (state ExhaleHeap@0 Mask@2))) (and (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)) (and (state ExhaleHeap@0 Mask@2) (= (ControlFlow 0 2) (- 0 1))))) (= FullPerm (U_2_real (MapType1Select Mask@2 __flatten_1@0 Counter__x))))))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@0 __flatten_1@0 Counter__x)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 __flatten_1@0 Counter__x))) (=> (= (ControlFlow 0 4) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 diz $allocated))) (and (not (= diz null)) (state Heap@@9 ZeroMask))) (and (and (>= current_thread_id 0) (state Heap@@9 ZeroMask)) (and (U_2_bool (MapType0Select Heap@@9 c $allocated)) (U_2_bool (MapType0Select Heap@@9 __flatten_1 $allocated))))) (and (=> (= (ControlFlow 0 7) (- 0 14)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (=> (not (= __flatten_1@0 null)) (=> (and (not (= __flatten_1@0 null)) (= Mask@0 (MapType1Store ZeroMask __flatten_1@0 Counter__x (real_2_U (+ (U_2_real (MapType1Select ZeroMask __flatten_1@0 Counter__x)) FullPerm))))) (=> (and (and (and (state Heap@@9 Mask@0) (= (U_2_int (MapType0Select Heap@@9 __flatten_1@0 Counter__x)) 0)) (and (state Heap@@9 Mask@0) (U_2_bool (MapType0Select Heap@@9 __flatten_1@0 $allocated)))) (and (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)))) (and (=> (= (ControlFlow 0 7) (- 0 13)) (= FullPerm (U_2_real (MapType1Select Mask@0 __flatten_1@0 Counter__x)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 __flatten_1@0 Counter__x))) (=> (and (= Heap@0 (MapType0Store Heap@@9 __flatten_1@0 Counter__x (int_2_U 37))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 7) (- 0 12)) (not (= diz null))) (=> (not (= diz null)) (and (=> (= (ControlFlow 0 7) (- 0 11)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (and (=> (= (ControlFlow 0 7) (- 0 10)) (not (= __flatten_1@0 null))) (=> (not (= __flatten_1@0 null)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (<= NoPerm FullPerm)) (=> (<= NoPerm FullPerm) (and (=> (= (ControlFlow 0 7) (- 0 8)) (>= FullPerm NoPerm)) (=> (>= FullPerm NoPerm) (and (=> (= (ControlFlow 0 7) 4) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct)))))))))))))))))))))))
