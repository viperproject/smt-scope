...
(let ((anon33_Else_correct  (=> (not (and (trigger Heap@1 i_4) (< i_4 (- (|Seq#Length| (MapType0Select Heap@1 this@@6 nodes)) 1)))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (= (MapType0Select Heap@1 (|Seq#Index| (MapType0Select Heap@1 this@@6 nodes) i_4) next) null)) (=> (= (MapType0Select Heap@1 (|Seq#Index| (MapType0Select Heap@1 this@@6 nodes) i_4) next) null) (=> (= (ControlFlow 0 21) 18) anon21_correct))))))
(let ((anon33_Then_correct  (=> (and (and (trigger Heap@1 i_4) (< i_4 (- (|Seq#Length| (MapType0Select Heap@1 this@@6 nodes)) 1))) (= (ControlFlow 0 20) 18)) anon21_correct)))
(let ((anon32_Then_correct  (=> (and (<= 0 i_4) (< i_4 (|Seq#Length| (MapType0Select Heap@1 this@@6 nodes)))) (and (=> (= (ControlFlow 0 23) 20) anon33_Then_correct) (=> (= (ControlFlow 0 23) 21) anon33_Else_correct)))))
(let ((anon32_Else_correct  (=> (and (not (and (<= 0 i_4) (< i_4 (|Seq#Length| (MapType0Select Heap@1 this@@6 nodes))))) (= (ControlFlow 0 19) 18)) anon21_correct)))
(let ((anon28_Then_correct true))
(let ((anon15_correct true))
(let ((anon30_Else_correct  (=> (not (and (trigger Heap@1 i_7) (< i_7 (- (|Seq#Length| (MapType0Select Heap@1 this@@6 nodes)) 1)))) (and (=> (= (ControlFlow 0 6) (- 0 10)) (HasDirectPerm QPMask@0 this@@6 nodes)) (=> (HasDirectPerm QPMask@0 this@@6 nodes) (and (=> (= (ControlFlow 0 6) (- 0 9)) (>= i_7 0)) (=> (>= i_7 0) (and (=> (= (ControlFlow 0 6) (- 0 8)) (< i_7 (|Seq#Length| (MapType0Select Heap@1 this@@6 nodes)))) (=> (< i_7 (|Seq#Length| (MapType0Select Heap@1 this@@6 nodes))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm QPMask@0 (|Seq#Index| (MapType0Select Heap@1 this@@6 nodes) i_7) next)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| (MapType0Select Heap@1 this@@6 nodes) i_7) next) (=> (= (ControlFlow 0 6) 2) anon15_correct))))))))))))
(let ((anon30_Then_correct  (=> (and (and (trigger Heap@1 i_7) (< i_7 (- (|Seq#Length| (MapType0Select Heap@1 this@@6 nodes)) 1))) (= (ControlFlow 0 5) 2)) anon15_correct)))
(let ((anon29_Else_correct  (=> (not (trigger Heap@1 i_7)) (and (=> (= (ControlFlow 0 13) 5) anon30_Then_correct) (=> (= (ControlFlow 0 13) 6) anon30_Else_correct)))))
(let ((anon29_Then_correct  (=> (trigger Heap@1 i_7) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm QPMask@0 this@@6 nodes)) (=> (HasDirectPerm QPMask@0 this@@6 nodes) (and (=> (= (ControlFlow 0 11) 5) anon30_Then_correct) (=> (= (ControlFlow 0 11) 6) anon30_Else_correct)))))))
(let ((anon27_Then_correct  (=> (and (<= 0 i_7) (< i_7 (|Seq#Length| (MapType0Select Heap@1 this@@6 nodes)))) (and (and (=> (= (ControlFlow 0 14) 4) anon28_Then_correct) (=> (= (ControlFlow 0 14) 11) anon29_Then_correct)) (=> (= (ControlFlow 0 14) 13) anon29_Else_correct)))))
(let ((anon27_Else_correct  (=> (and (not (and (<= 0 i_7) (< i_7 (|Seq#Length| (MapType0Select Heap@1 this@@6 nodes))))) (= (ControlFlow 0 3) 2)) anon15_correct)))
(let ((anon26_Else_correct  (=> (< i_7 0) (and (=> (= (ControlFlow 0 17) 14) anon27_Then_correct) (=> (= (ControlFlow 0 17) 3) anon27_Else_correct)))))
(let ((anon26_Then_correct  (=> (<= 0 i_7) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm QPMask@0 this@@6 nodes)) (=> (HasDirectPerm QPMask@0 this@@6 nodes) (and (=> (= (ControlFlow 0 15) 14) anon27_Then_correct) (=> (= (ControlFlow 0 15) 3) anon27_Else_correct)))))))
(let ((anon31_Else_correct true))
(let ((anon4_correct  (=> (and (and (not (= this@@6 null)) (= Mask@2 (MapType1Store Mask@1 this@@6 nodes (real_2_U (+ (U_2_real (MapType1Select Mask@1 this@@6 nodes)) FullPerm))))) (and (state Heap@1 Mask@2) (forall ((i@@10 Int) (j_2 Int) ) (!  (=> (and (>= i@@10 0) (and (< i@@10 (|Seq#Length| (MapType0Select Heap@1 this@@6 nodes))) (and (>= j_2 0) (and (< j_2 (|Seq#Length| (MapType0Select Heap@1 this@@6 nodes))) (not (= i@@10 j_2)))))) (not (= (|Seq#Index| (MapType0Select Heap@1 this@@6 nodes) i@@10) (|Seq#Index| (MapType0Select Heap@1 this@@6 nodes) j_2))))
 :qid |stdinbpl.871:20|
 :skolemid |77|
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 this@@6 nodes) i@@10) (|Seq#Index| (MapType0Select Heap@1 this@@6 nodes) j_2))
)))) (and (=> (= (ControlFlow 0 24) (- 0 25)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (|Seq#Length| (MapType0Select Heap@1 this@@6 nodes))))) (and (<= 0 i_1_1) (< i_1_1 (|Seq#Length| (MapType0Select Heap@1 this@@6 nodes))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@1 this@@6 nodes) i_1) (|Seq#Index| (MapType0Select Heap@1 this@@6 nodes) i_1_1))))
 :qid |stdinbpl.877:15|
 :skolemid |78|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= 0 i_1@@0) (< i_1@@0 (|Seq#Length| (MapType0Select Heap@1 this@@6 nodes))))) (and (<= 0 i_1_1@@0) (< i_1_1@@0 (|Seq#Length| (MapType0Select Heap@1 this@@6 nodes))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@1 this@@6 nodes) i_1@@0) (|Seq#Index| (MapType0Select Heap@1 this@@6 nodes) i_1_1@@0))))
 :qid |stdinbpl.877:15|
 :skolemid |78|
)) (=> (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 (|Seq#Length| (MapType0Select Heap@1 this@@6 nodes)))) (< NoPerm FullPerm)) (and (qpRange2 (|Seq#Index| (MapType0Select Heap@1 this@@6 nodes) i_1@@1)) (= (invRecv2 (|Seq#Index| (MapType0Select Heap@1 this@@6 nodes) i_1@@1)) i_1@@1)))
 :qid |stdinbpl.883:22|
 :skolemid |79|
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 this@@6 nodes) i_1@@1))
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 this@@6 nodes) i_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv2 o_3)) (< (invRecv2 o_3) (|Seq#Length| (MapType0Select Heap@1 this@@6 nodes)))) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (|Seq#Index| (MapType0Select Heap@1 this@@6 nodes) (invRecv2 o_3)) o_3)))
 :qid |stdinbpl.887:22|
 :skolemid |80|
 :pattern ( (invRecv2 o_3))
))) (=> (and (and (and (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (< i_1@@2 (|Seq#Length| (MapType0Select Heap@1 this@@6 nodes)))) (not (= (|Seq#Index| (MapType0Select Heap@1 this@@6 nodes) i_1@@2) null)))
 :qid |stdinbpl.893:22|
 :skolemid |81|
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 this@@6 nodes) i_1@@2))
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 this@@6 nodes) i_1@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv2 o_3@@0)) (< (invRecv2 o_3@@0) (|Seq#Length| (MapType0Select Heap@1 this@@6 nodes)))) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| (MapType0Select Heap@1 this@@6 nodes) (invRecv2 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (+ (U_2_real (MapType1Select Mask@2 o_3@@0 next)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv2 o_3@@0)) (< (invRecv2 o_3@@0) (|Seq#Length| (MapType0Select Heap@1 this@@6 nodes)))) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (U_2_real (MapType1Select Mask@2 o_3@@0 next))))))
 :qid |stdinbpl.899:22|
 :skolemid |82|
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 next))) (= (U_2_real (MapType1Select Mask@2 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.903:29|
 :skolemid |83|
 :pattern ( (MapType1Select Mask@2 o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
)) (state Heap@1 QPMask@0))) (and (and (state Heap@1 QPMask@0) (forall ((i_2_1 Int) ) (!  (=> (and (<= 0 i_2_1) (< i_2_1 (|Seq#Length| (MapType0Select Heap@1 this@@6 nodes)))) (or (and (trigger Heap@1 i_2_1) (< i_2_1 (- (|Seq#Length| (MapType0Select Heap@1 this@@6 nodes)) 1))) (= (MapType0Select Heap@1 (|Seq#Index| (MapType0Select Heap@1 this@@6 nodes) i_2_1) next) null)))
 :qid |stdinbpl.910:20|
 :skolemid |84|
 :pattern ( (|trigger#frame| EmptyFrame i_2_1))
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 this@@6 nodes) i_2_1))
...
(let ((anon24_Else_correct  (=> (HasDirectPerm Mask@1 null (List this@@6)) (=> (and (= Heap@1 Heap@@14) (= (ControlFlow 0 27) 24)) anon4_correct))))
(let ((anon24_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (List this@@6))) (= Heap@0 (MapType0Store Heap@@14 null (List this@@6) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 26) 24))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (List this@@6) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (List this@@6))) FullPerm)))) (and (=> (= (ControlFlow 0 28) 26) anon24_Then_correct) (=> (= (ControlFlow 0 28) 27) anon24_Else_correct)))))
(let ((anon23_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 31) 28)) anon2_correct)))
(let ((anon23_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (List this@@6))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (List this@@6)))) (=> (= (ControlFlow 0 29) 28) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@14 this@@6 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (List this@@6) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (List this@@6))) FullPerm)))))) (and (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0)) (and (|List#trigger| Heap@@14 (List this@@6)) (= (MapType0Select Heap@@14 null (List this@@6)) (CombineFrames (FrameFragment (MapType0Select Heap@@14 this@@6 nodes)) (FrameFragment (int_2_U (|List#condqp1| Heap@@14 this@@6)))))))) (and (=> (= (ControlFlow 0 32) 29) anon23_Then_correct) (=> (= (ControlFlow 0 32) 31) anon23_Else_correct)))))
