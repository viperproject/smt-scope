...
(assert (forall ((arg0@@39 T@U) ) (! (= (type (|P#sm| arg0@@39)) (FieldType PredicateType_PType (MapType1Type RefType boolType)))
 :qid |funType:P#sm|
...
(assert (forall ((x@@19 T@U) ) (!  (=> (= (type x@@19) RefType) (= (getPredWandId (P x@@19)) 0))
 :qid |stdinbpl.407:15|
 :skolemid |84|
 :pattern ( (P x@@19))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type xs) (MapType2Type RefType boolType)) (= (type Heap@6) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type x@@25) RefType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@3) (MapType0Type RefType))) (forall ((arg0@@45 T@U) ) (! (= (type (FrameFragment arg0@@45)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@45))
))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (forall ((arg0@@46 T@U) ) (! (= (type (invRecv1 arg0@@46)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 26) (let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((y_3 T@U) (y_3_1 T@U) ) (!  (=> (and (= (type y_3) RefType) (= (type y_3_1) RefType)) (=> (and (and (and (and (not (= y_3 y_3_1)) (U_2_bool (MapType2Select xs y_3))) (U_2_bool (MapType2Select xs y_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_3 y_3_1))))
 :qid |stdinbpl.603:17|
 :skolemid |94|
 :pattern ( (neverTriggered2 y_3) (neverTriggered2 y_3_1))
))) (=> (forall ((y_3@@0 T@U) (y_3_1@@0 T@U) ) (!  (=> (and (= (type y_3@@0) RefType) (= (type y_3_1@@0) RefType)) (=> (and (and (and (and (not (= y_3@@0 y_3_1@@0)) (U_2_bool (MapType2Select xs y_3@@0))) (U_2_bool (MapType2Select xs y_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_3@@0 y_3_1@@0))))
 :qid |stdinbpl.603:17|
 :skolemid |94|
 :pattern ( (neverTriggered2 y_3@@0) (neverTriggered2 y_3_1@@0))
)) (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((y_3@@1 T@U) ) (!  (=> (and (= (type y_3@@1) RefType) (U_2_bool (MapType2Select xs y_3@@1))) (>= (U_2_real (MapType1Select Mask@3 y_3@@1 f_7)) FullPerm))
 :qid |stdinbpl.610:17|
 :skolemid |95|
 :pattern ( (MapType0Select Heap@6 y_3@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 y_3@@1 f_7))
 :pattern ( (MapType2Select xs y_3@@1))
)))))))
(let ((anon18_Then_correct true))
(let ((anon10_correct  (=> (not (= x@@25 null)) (=> (and (and (= Mask@3 (MapType1Store Mask@2 x@@25 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@2 x@@25 f_7)) FullPerm)))) (state Heap@6 Mask@3)) (and (state Heap@6 Mask@3) (state Heap@6 Mask@3))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (HasDirectPerm Mask@3 x@@25 f_7)) (=> (HasDirectPerm Mask@3 x@@25 f_7) (and (=> (= (ControlFlow 0 6) (- 0 7)) (= (U_2_int (MapType0Select Heap@6 x@@25 f_7)) 10)) (=> (= (U_2_int (MapType0Select Heap@6 x@@25 f_7)) 10) (=> (state Heap@6 Mask@3) (and (=> (= (ControlFlow 0 6) 2) anon18_Then_correct) (=> (= (ControlFlow 0 6) 4) anon18_Else_correct)))))))))))
(let ((anon17_Else_correct  (=> (HasDirectPerm Mask@2 null (P x@@25)) (=> (and (= Heap@6 Heap@4) (= (ControlFlow 0 10) 6)) anon10_correct))))
(let ((anon17_Then_correct  (=> (and (and (not (HasDirectPerm Mask@2 null (P x@@25))) (= Heap@5 (MapType0Store Heap@4 null (P x@@25) newVersion@0))) (and (= Heap@6 Heap@5) (= (ControlFlow 0 9) 6))) anon10_correct)))
(let ((anon8_correct  (=> (= Mask@2 (MapType1Store Mask@1 null (P x@@25) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (P x@@25))) FullPerm)))) (and (=> (= (ControlFlow 0 11) 9) anon17_Then_correct) (=> (= (ControlFlow 0 11) 10) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 14) 11)) anon8_correct)))
(let ((anon16_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (P x@@25))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (P x@@25)))) (=> (= (ControlFlow 0 12) 11) anon8_correct))))))
(let ((anon6_correct  (=> (= Heap@4 (MapType0Store Heap@3 null (|P#sm| x@@25) (MapType1Store (MapType0Select Heap@3 null (|P#sm| x@@25)) x@@25 f_7 (bool_2_U true)))) (=> (and (and (state Heap@4 Mask@1) (state Heap@4 Mask@1)) (and (|P#trigger| Heap@4 (P x@@25)) (= (MapType0Select Heap@4 null (P x@@25)) (FrameFragment (MapType0Select Heap@4 x@@25 f_7))))) (and (=> (= (ControlFlow 0 15) 12) anon16_Then_correct) (=> (= (ControlFlow 0 15) 14) anon16_Else_correct))))))
(let ((anon15_Else_correct  (=> (HasDirectPerm Mask@1 null (P x@@25)) (=> (and (= Heap@3 Heap@0) (= (ControlFlow 0 17) 15)) anon6_correct))))
(let ((anon15_Then_correct  (=> (not (HasDirectPerm Mask@1 null (P x@@25))) (=> (and (and (= Heap@1 (MapType0Store Heap@0 null (|P#sm| x@@25) ZeroPMask)) (= Heap@2 (MapType0Store Heap@1 null (P x@@25) freshVersion@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 16) 15))) anon6_correct))))
(let ((anon4_correct  (=> (and (= Mask@0 (MapType1Store QPMask@0 x@@25 f_7 (real_2_U (- (U_2_real (MapType1Select QPMask@0 x@@25 f_7)) FullPerm)))) (= Mask@1 (MapType1Store Mask@0 null (P x@@25) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (P x@@25))) FullPerm))))) (=> (and (and (state Heap@0 Mask@1) (state Heap@0 Mask@1)) (and (|P#trigger| Heap@0 (P x@@25)) (= (MapType0Select Heap@0 null (P x@@25)) (FrameFragment (MapType0Select Heap@0 x@@25 f_7))))) (and (=> (= (ControlFlow 0 18) 16) anon15_Then_correct) (=> (= (ControlFlow 0 18) 17) anon15_Else_correct))))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 21) 18)) anon4_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 x@@25 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 x@@25 f_7))) (=> (= (ControlFlow 0 19) 18) anon4_correct))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 22) (- 0 24)) (forall ((y_1 T@U) (y_1_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (= (type y_1_1) RefType)) (=> (and (and (and (and (not (= y_1 y_1_1)) (U_2_bool (MapType2Select xs y_1))) (U_2_bool (MapType2Select xs y_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_1 y_1_1))))
 :qid |stdinbpl.488:15|
 :skolemid |88|
 :no-pattern (type y_1)
...
))) (=> (forall ((y_1@@0 T@U) (y_1_1@@0 T@U) ) (!  (=> (and (= (type y_1@@0) RefType) (= (type y_1_1@@0) RefType)) (=> (and (and (and (and (not (= y_1@@0 y_1_1@@0)) (U_2_bool (MapType2Select xs y_1@@0))) (U_2_bool (MapType2Select xs y_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_1@@0 y_1_1@@0))))
 :qid |stdinbpl.488:15|
 :skolemid |88|
...
)) (=> (and (and (and (forall ((y_1@@1 T@U) ) (!  (=> (= (type y_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs y_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 y_1@@1) (= (invRecv1 y_1@@1) y_1@@1))))
 :qid |stdinbpl.494:22|
 :skolemid |89|
 :pattern ( (MapType0Select Heap@@10 y_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 y_1@@1 f_7))
 :pattern ( (MapType2Select xs y_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.498:22|
 :skolemid |90|
 :pattern ( (invRecv1 o_3))
))) (and (forall ((y_1@@2 T@U) ) (!  (=> (and (= (type y_1@@2) RefType) (U_2_bool (MapType2Select xs y_1@@2))) (not (= y_1@@2 null)))
 :qid |stdinbpl.504:22|
 :skolemid |91|
 :pattern ( (MapType0Select Heap@@10 y_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 y_1@@2 f_7))
 :pattern ( (MapType2Select xs y_1@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select xs (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.510:22|
 :skolemid |92|
...
)) (state Heap@@10 QPMask@0)) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0)))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (= FullPerm (U_2_real (MapType1Select QPMask@0 x@@25 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 x@@25 f_7))) (=> (and (= Heap@0 (MapType0Store Heap@@10 x@@25 f_7 (int_2_U 10))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 22) 19) anon14_Then_correct) (=> (= (ControlFlow 0 22) 21) anon14_Else_correct))))))))))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@10 x@@25 $allocated)) (U_2_bool (MapType2Select xs x@@25))) (and (state Heap@@10 ZeroMask) (state Heap@@10 ZeroMask))) (and (=> (= (ControlFlow 0 25) 1) anon13_Then_correct) (=> (= (ControlFlow 0 25) 22) anon13_Else_correct))))))
