...
(assert  (and (and (and (and (and (and (= (type Heap@0) (MapType0Type RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type x@@8) RefType)) (= (type Heap@@17) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type LoopSumHeap@0) (MapType0Type RefType))) (= (type LoopSumMask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id m)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon11_Else_correct true))
(let ((l_correct  (=> (state Heap@0 Mask@1) (=> (and (and (= c@0 5) (state Heap@0 Mask@1)) (and (state Heap@0 Mask@1) (= (ControlFlow 0 3) (- 0 2)))) (= (U_2_real (MapType1Select Mask@1 x@@8 g)) (/ (to_real 0) (to_real 1)))))))
(let ((anon11_Then_correct  (=> (= c@0 5) (=> (and (SumHeap LoopSumHeap@0 Heap@@17 ZeroMask Heap@@17 Mask@0) (sumMask LoopSumMask@0 ZeroMask Mask@0)) (=> (and (and (state LoopSumHeap@0 LoopSumMask@0) (= Mask@1 LoopSumMask@0)) (and (= Heap@0 LoopSumHeap@0) (= (ControlFlow 0 5) 3))) l_correct)))))
(let ((anon10_Then_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and (state Heap@@17 ZeroMask) (> c@0 0)) (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 7) 5) anon11_Then_correct) (=> (= (ControlFlow 0 7) 6) anon11_Else_correct))))))
(let ((anon10_Else_correct  (=> (not (> c@0 0)) (=> (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)) (=> (and (and (state Heap@@17 Mask@0) (= Mask@1 Mask@0)) (and (= Heap@0 Heap@@17) (= (ControlFlow 0 4) 3))) l_correct)))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (and (and (and (state Heap@@17 ZeroMask) (U_2_bool (MapType0Select Heap@@17 x@@8 $allocated))) (and (state Heap@@17 ZeroMask) (not (= x@@8 null)))) (and (and (= Mask@0 (MapType1Store ZeroMask x@@8 g (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 g)) FullPerm)))) (state Heap@@17 Mask@0)) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)))) (and (and (=> (= (ControlFlow 0 8) 1) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon10_Then_correct)) (=> (= (ControlFlow 0 8) 4) anon10_Else_correct)))))
