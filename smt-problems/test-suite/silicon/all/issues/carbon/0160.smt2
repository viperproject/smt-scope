(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 19:47:52
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/issues/carbon/0160.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (forall ((r $Ref)) (!
  (=>
    (ite (img@7@01 r) (and (<= 0 (inv@6@01 r)) (< (inv@6@01 r) 10)) false)
...
(assert (= ($FVF.lookup_val (as sm@20@01  $FVF<val>) (loc<Ref> arr1@2@01 t@9@01)) 0))
; [exec]
; loc(arr2, t).val := 0
; [eval] loc(arr2, t)
(set-option :timeout 0)
...
(assert (not (=
  (-
    (ite
      ...
      $Perm.Write
      $Perm.No)
    (pTaken@22@01 (loc<Ref> arr1@2@01 t@9@01)))
  $Perm.No)))
(check-sat)
; unknown
(pop) ; 6
