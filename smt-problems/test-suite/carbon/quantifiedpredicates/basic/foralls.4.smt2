...
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 (|Seq#Length| xs)))) (= (ControlFlow 0 14) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (<= 0 i_2) (< i_2 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< i_2 (|Seq#Length| xs))) (=> (< i_2 (|Seq#Length| xs)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (|Seq#Length| xs)))) (and (<= 0 i_1_1) (< i_1_1 (|Seq#Length| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_1) (|Seq#Index| xs i_1_1))))
...
(let ((anon10_Else_correct  (=> (and (not (and (>= ix_2 0) (and (< ix_2 (|Seq#Length| xs)) (and (>= jx_2 0) (and (< jx_2 (|Seq#Length| xs)) (not (= ix_2 jx_2))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (>= ix_2 0) (and (< ix_2 (|Seq#Length| xs)) (and (>= jx_2 0) (and (< jx_2 (|Seq#Length| xs)) (not (= ix_2 jx_2)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= ix_2 0)) (=> (>= ix_2 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< ix_2 (|Seq#Length| xs))) (=> (< ix_2 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= jx_2 0)) (=> (>= jx_2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< jx_2 (|Seq#Length| xs))) (=> (< jx_2 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
