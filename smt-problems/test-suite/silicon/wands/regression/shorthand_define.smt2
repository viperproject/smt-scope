(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:37:06
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/wands/regression/shorthand_define.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
; [exec]
; apply true --* true
(assert (= (MWSF_apply mwsf@1@01 $Snap.unit) $Snap.unit))
; [state consolidation]
; State saturation: before repetition
(set-option :timeout 10)
(check-sat)
...
(assert (forall (($t@5@01 $Snap)) (!
  (= (MWSF_apply mwsf@6@01 $t@5@01) $Snap.unit)
...
; [eval] x.f == null
(assert (= ($SortWrappers.$SnapTo$Ref ($Snap.first $t@11@01)) $Ref.null))
...
(declare-const f@13@01 $Ref)
(assert (not (= z@12@01 x@8@01)))
(assert (not (= z@12@01 z@10@01)))
(assert (not (= z@12@01 ($SortWrappers.$SnapTo$Ref ($Snap.first $t@11@01)))))
; [exec]
; y.f := z
(set-option :timeout 0)
(push) ; 3
