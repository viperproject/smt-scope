...
(assert  (and (and (and (and (= (type r_1@@13) RefType) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@18) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |Peano#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (= r_1@@13 null) (=> (and (= Mask@2 ZeroMask) (= (ControlFlow 0 4) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (and (and (not (= r_1@@13 null)) (not (= r_1@@13 null))) (and (= Mask@0 (MapType1Store ZeroMask r_1@@13 nx (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1@@13 nx)) FullPerm)))) (state Heap@@18 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 r_1@@13 nx)) (=> (HasDirectPerm Mask@0 r_1@@13 nx) (=> (and (and (= Mask@1 (MapType1Store Mask@0 null (Peano (MapType0Select Heap@@18 r_1@@13 nx)) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (Peano (MapType0Select Heap@@18 r_1@@13 nx)))) FullPerm)))) (state Heap@@18 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 2) 1))) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@18 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@18 r_1@@13 $allocated))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
