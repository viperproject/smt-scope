...
(declare-fun arg_v@0 () Int)
(declare-fun Mask@1 () T@U)
(declare-fun Mask@0 () T@U)
(declare-fun Heap@@35 () T@U)
(declare-fun i () T@U)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@51) (MapType1Type RefType realType)) (= (type Mask@50) (MapType1Type RefType realType))) (= (type i@0) RefType)) (= (type ExhaleHeap@5) (MapType0Type RefType))) (= (type Mask@52) (MapType1Type RefType realType))) (= (type Mask@49) (MapType1Type RefType realType))) (= (type Mask@18) (MapType1Type RefType realType))) (= (type Mask@25) (MapType1Type RefType realType))) (= (type l) RefType)) (= (type Mask@24) (MapType1Type RefType realType))) (= (type Mask@23) (MapType1Type RefType realType))) (= (type ExhaleHeap@6) (MapType0Type RefType))) (= (type Mask@22) (MapType1Type RefType realType))) (= (type Mask@21) (MapType1Type RefType realType))) (= (type Mask@20) (MapType1Type RefType realType))) (= (type Mask@19) (MapType1Type RefType realType))) (= (type Mask@48) (MapType1Type RefType realType))) (= (type Mask@46) (MapType1Type RefType realType))) (= (type Mask@47) (MapType1Type RefType realType))) (= (type Mask@44) (MapType1Type RefType realType))) (= (type Mask@45) (MapType1Type RefType realType))) (= (type ExhaleHeap@11) (MapType0Type RefType))) (= (type Mask@43) (MapType1Type RefType realType))) (= (type Mask@42) (MapType1Type RefType realType))) (= (type Mask@41) (MapType1Type RefType realType))) (= (type Mask@40) (MapType1Type RefType realType))) (= (type Mask@39) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@35) (MapType1Type RefType realType))) (= (type Mask@34) (MapType1Type RefType realType))) (= (type ExhaleHeap@8) (MapType0Type RefType))) (= (type Mask@36) (MapType1Type RefType realType))) (= (type ExhaleHeap@9) (MapType0Type RefType))) (= (type Mask@33) (MapType1Type RefType realType))) (= (type Mask@37) (MapType1Type RefType realType))) (= (type ExhaleHeap@10) (MapType0Type RefType))) (= (type Mask@38) (MapType1Type RefType realType))) (= (type Mask@31) (MapType1Type RefType realType))) (= (type Mask@30) (MapType1Type RefType realType))) (= (type Mask@32) (MapType1Type RefType realType))) (= (type Mask@29) (MapType1Type RefType realType))) (= (type Mask@28) (MapType1Type RefType realType))) (= (type Mask@27) (MapType1Type RefType realType))) (= (type ExhaleHeap@4) (MapType0Type RefType))) (= (type Mask@16) (MapType1Type RefType realType))) (= (type Mask@17) (MapType1Type RefType realType))) (= (type Mask@14) (MapType1Type RefType realType))) (= (type Mask@15) (MapType1Type RefType realType))) (= (type Mask@13) (MapType1Type RefType realType))) (= (type Mask@12) (MapType1Type RefType realType))) (= (type Mask@11) (MapType1Type RefType realType))) (= (type Mask@10) (MapType1Type RefType realType))) (= (type Mask@9) (MapType1Type RefType realType))) (= (type ExhaleHeap@3) (MapType0Type RefType))) (= (type Mask@7) (MapType1Type RefType realType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type ExhaleHeap@2) (MapType0Type RefType))) (= (type Mask@8) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type ExhaleHeap@1) (MapType0Type RefType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@35) (MapType0Type RefType))) (= (type i) RefType)))
(set-info :boogie-vc-id main)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 109) (let ((anon58_correct true))
(let ((anon57_correct  (=> (= Mask@47 (MapType1Store Mask@46 null (Iterator_ready i@0) (real_2_U (- (U_2_real (MapType1Select Mask@46 null (Iterator_ready i@0))) FullPerm)))) (=> (and (= Mask@48 Mask@47) (= (ControlFlow 0 26) 24)) anon58_correct))))
(let ((anon96_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 29) 26)) anon57_correct)))
(let ((anon96_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (<= FullPerm (U_2_real (MapType1Select Mask@46 null (Iterator_ready i@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@46 null (Iterator_ready i@0)))) (=> (= (ControlFlow 0 27) 26) anon57_correct))))))
(let ((anon95_Then_correct  (=> (not b_2@2) (and (=> (= (ControlFlow 0 30) 27) anon96_Then_correct) (=> (= (ControlFlow 0 30) 29) anon96_Else_correct)))))
(let ((anon95_Else_correct  (=> b_2@2 (=> (and (= Mask@48 Mask@46) (= (ControlFlow 0 25) 24)) anon58_correct))))
(let ((anon53_correct  (=> (and (= Mask@45 (MapType1Store Mask@44 null (Iterator_readyForNext i@0) (real_2_U (- (U_2_real (MapType1Select Mask@44 null (Iterator_readyForNext i@0))) FullPerm)))) (= Mask@46 Mask@45)) (and (=> (= (ControlFlow 0 32) 30) anon95_Then_correct) (=> (= (ControlFlow 0 32) 25) anon95_Else_correct)))))
(let ((anon94_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 35) 32)) anon53_correct)))
(let ((anon94_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 33) (- 0 34)) (<= FullPerm (U_2_real (MapType1Select Mask@44 null (Iterator_readyForNext i@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@44 null (Iterator_readyForNext i@0)))) (=> (= (ControlFlow 0 33) 32) anon53_correct))))))
(let ((anon93_Then_correct  (=> b_2@2 (and (=> (= (ControlFlow 0 36) 33) anon94_Then_correct) (=> (= (ControlFlow 0 36) 35) anon94_Else_correct)))))
(let ((anon93_Else_correct  (=> (and (not b_2@2) (= Mask@46 Mask@44)) (and (=> (= (ControlFlow 0 31) 30) anon95_Then_correct) (=> (= (ControlFlow 0 31) 25) anon95_Else_correct)))))
(let ((anon50_correct  (=> (and (state ExhaleHeap@11 Mask@44) (state ExhaleHeap@11 Mask@44)) (and (=> (= (ControlFlow 0 37) 36) anon93_Then_correct) (=> (= (ControlFlow 0 37) 31) anon93_Else_correct)))))
(let ((anon92_Else_correct  (=> b_2@2 (=> (and (= Mask@44 Mask@42) (= (ControlFlow 0 39) 37)) anon50_correct))))
(let ((anon92_Then_correct  (=> (not b_2@2) (=> (and (and (= Mask@43 (MapType1Store Mask@42 null (Iterator_ready i@0) (real_2_U (+ (U_2_real (MapType1Select Mask@42 null (Iterator_ready i@0))) FullPerm)))) (state ExhaleHeap@11 Mask@43)) (and (= Mask@44 Mask@43) (= (ControlFlow 0 38) 37))) anon50_correct))))
(let ((anon91_Else_correct  (=> (and (not b_2@2) (= Mask@42 Mask@40)) (and (=> (= (ControlFlow 0 41) 38) anon92_Then_correct) (=> (= (ControlFlow 0 41) 39) anon92_Else_correct)))))
(let ((anon91_Then_correct  (=> (and (and b_2@2 (= Mask@41 (MapType1Store Mask@40 null (Iterator_readyForNext i@0) (real_2_U (+ (U_2_real (MapType1Select Mask@40 null (Iterator_readyForNext i@0))) FullPerm))))) (and (state ExhaleHeap@11 Mask@41) (= Mask@42 Mask@41))) (and (=> (= (ControlFlow 0 40) 38) anon92_Then_correct) (=> (= (ControlFlow 0 40) 39) anon92_Else_correct)))))
(let ((anon46_correct  (=> (and (= Mask@40 (MapType1Store Mask@39 null (Iterator_ready i@0) (real_2_U (- (U_2_real (MapType1Select Mask@39 null (Iterator_ready i@0))) FullPerm)))) (IdenticalOnKnownLocations Heap@0 ExhaleHeap@11 Mask@40)) (and (=> (= (ControlFlow 0 42) 40) anon91_Then_correct) (=> (= (ControlFlow 0 42) 41) anon91_Else_correct)))))
(let ((anon90_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 45) 42)) anon46_correct)))
(let ((anon90_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 43) (- 0 44)) (<= FullPerm (U_2_real (MapType1Select Mask@39 null (Iterator_ready i@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@39 null (Iterator_ready i@0)))) (=> (= (ControlFlow 0 43) 42) anon46_correct))))))
(let ((anon44_correct  (=> (state Heap@0 Mask@39) (and (=> (= (ControlFlow 0 46) 43) anon90_Then_correct) (=> (= (ControlFlow 0 46) 45) anon90_Else_correct)))))
(let ((anon40_correct  (=> (= Mask@37 (MapType1Store Mask@33 null (Iterator_readyForRemove i@0) (real_2_U (- (U_2_real (MapType1Select Mask@33 null (Iterator_readyForRemove i@0))) FullPerm)))) (=> (and (and (and (IdenticalOnKnownLocations ExhaleHeap@8 ExhaleHeap@10 Mask@37) (= Mask@38 (MapType1Store Mask@37 null (Iterator_ready i@0) (real_2_U (+ (U_2_real (MapType1Select Mask@37 null (Iterator_ready i@0))) FullPerm))))) (and (state ExhaleHeap@10 Mask@38) (state ExhaleHeap@10 Mask@38))) (and (and (state ExhaleHeap@10 Mask@38) (= Mask@39 Mask@38)) (and (= Heap@0 ExhaleHeap@10) (= (ControlFlow 0 53) 46)))) anon44_correct))))
(let ((anon88_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 56) 53)) anon40_correct)))
(let ((anon88_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 54) (- 0 55)) (<= FullPerm (U_2_real (MapType1Select Mask@33 null (Iterator_readyForRemove i@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@33 null (Iterator_readyForRemove i@0)))) (=> (= (ControlFlow 0 54) 53) anon40_correct))))))
(let ((anon87_Then_correct  (=> (< tmp@0 0) (and (=> (= (ControlFlow 0 57) 54) anon88_Then_correct) (=> (= (ControlFlow 0 57) 56) anon88_Else_correct)))))
(let ((anon43_correct  (=> (= Mask@35 (MapType1Store Mask@34 null (Iterator_readyForRemove i@0) (real_2_U (- (U_2_real (MapType1Select Mask@34 null (Iterator_readyForRemove i@0))) FullPerm)))) (=> (and (state ExhaleHeap@8 Mask@35) (= Mask@36 (MapType1Store Mask@35 null (Iterator_ready i@0) (real_2_U (+ (U_2_real (MapType1Select Mask@35 null (Iterator_ready i@0))) FullPerm))))) (=> (and (and (and (state ExhaleHeap@8 Mask@36) (state ExhaleHeap@8 Mask@36)) (and (IdenticalOnKnownLocations ExhaleHeap@8 ExhaleHeap@9 Mask@36) (state ExhaleHeap@9 Mask@36))) (and (and (state ExhaleHeap@9 Mask@36) (= Mask@39 Mask@36)) (and (= Heap@0 ExhaleHeap@9) (= (ControlFlow 0 47) 46)))) anon44_correct)))))
(let ((anon89_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 50) 47)) anon43_correct)))
(let ((anon89_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 48) (- 0 49)) (<= FullPerm (U_2_real (MapType1Select Mask@34 null (Iterator_readyForRemove i@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@34 null (Iterator_readyForRemove i@0)))) (=> (= (ControlFlow 0 48) 47) anon43_correct))))))
(let ((anon87_Else_correct  (=> (<= 0 tmp@0) (and (=> (= (ControlFlow 0 51) (- 0 52)) (<= FullPerm (U_2_real (MapType1Select Mask@33 null (wand i@0 FullPerm i@0 FullPerm))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@33 null (wand i@0 FullPerm i@0 FullPerm)))) (=> (and (= Mask@34 (MapType1Store Mask@33 null (wand i@0 FullPerm i@0 FullPerm) (real_2_U (- (U_2_real (MapType1Select Mask@33 null (wand i@0 FullPerm i@0 FullPerm))) FullPerm)))) (state ExhaleHeap@8 Mask@34)) (and (=> (= (ControlFlow 0 51) 48) anon89_Then_correct) (=> (= (ControlFlow 0 51) 50) anon89_Else_correct))))))))
(let ((anon37_correct  (=> (and (and (and (= Mask@31 (MapType1Store Mask@30 null (Iterator_readyForNext i@0) (real_2_U (- (U_2_real (MapType1Select Mask@30 null (Iterator_readyForNext i@0))) FullPerm)))) (IdenticalOnKnownLocations ExhaleHeap@5 ExhaleHeap@8 Mask@31)) (and (= Mask@32 (MapType1Store Mask@31 null (Iterator_readyForRemove i@0) (real_2_U (+ (U_2_real (MapType1Select Mask@31 null (Iterator_readyForRemove i@0))) FullPerm)))) (state ExhaleHeap@8 Mask@32))) (and (and (= Mask@33 (MapType1Store Mask@32 null (wand i@0 FullPerm i@0 FullPerm) (real_2_U (+ (U_2_real (MapType1Select Mask@32 null (wand i@0 FullPerm i@0 FullPerm))) FullPerm)))) (state ExhaleHeap@8 Mask@33)) (and (state ExhaleHeap@8 Mask@33) (state ExhaleHeap@8 Mask@33)))) (and (=> (= (ControlFlow 0 58) 57) anon87_Then_correct) (=> (= (ControlFlow 0 58) 51) anon87_Else_correct)))))
(let ((anon86_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 61) 58)) anon37_correct)))
(let ((anon86_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 59) (- 0 60)) (<= FullPerm (U_2_real (MapType1Select Mask@30 null (Iterator_readyForNext i@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@30 null (Iterator_readyForNext i@0)))) (=> (= (ControlFlow 0 59) 58) anon37_correct))))))
(let ((anon35_correct  (=> (state ExhaleHeap@5 Mask@30) (=> (and b_2@1 (state ExhaleHeap@5 Mask@30)) (and (=> (= (ControlFlow 0 62) 59) anon86_Then_correct) (=> (= (ControlFlow 0 62) 61) anon86_Else_correct))))))
(let ((anon85_Else_correct  (=> b_2@1 (=> (and (= Mask@30 Mask@28) (= (ControlFlow 0 64) 62)) anon35_correct))))
(let ((anon85_Then_correct  (=> (not b_2@1) (=> (and (and (= Mask@29 (MapType1Store Mask@28 null (Iterator_ready i@0) (real_2_U (+ (U_2_real (MapType1Select Mask@28 null (Iterator_ready i@0))) FullPerm)))) (state ExhaleHeap@5 Mask@29)) (and (= Mask@30 Mask@29) (= (ControlFlow 0 63) 62))) anon35_correct))))
(let ((anon84_Else_correct  (=> (and (not b_2@1) (= Mask@28 ZeroMask)) (and (=> (= (ControlFlow 0 66) 63) anon85_Then_correct) (=> (= (ControlFlow 0 66) 64) anon85_Else_correct)))))
(let ((anon84_Then_correct  (=> (and (and b_2@1 (= Mask@27 (MapType1Store ZeroMask null (Iterator_readyForNext i@0) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Iterator_readyForNext i@0))) FullPerm))))) (and (state ExhaleHeap@5 Mask@27) (= Mask@28 Mask@27))) (and (=> (= (ControlFlow 0 65) 63) anon85_Then_correct) (=> (= (ControlFlow 0 65) 64) anon85_Else_correct)))))
(let ((anon83_Then_correct  (=> (state ExhaleHeap@5 ZeroMask) (and (=> (= (ControlFlow 0 67) 65) anon84_Then_correct) (=> (= (ControlFlow 0 67) 66) anon84_Else_correct)))))
(let ((anon67_correct true))
(let ((anon100_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon67_correct)))
(let ((anon100_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@25 null (List_state l))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@25 null (List_state l)))) (=> (= (ControlFlow 0 9) 8) anon67_correct))))))
(let ((anon65_correct  (=> (and (and (and (= Mask@24 (MapType1Store Mask@23 null (Iterator_ready i@0) (real_2_U (- (U_2_real (MapType1Select Mask@23 null (Iterator_ready i@0))) FullPerm)))) (state ExhaleHeap@5 Mask@24)) (and (= Mask@25 (MapType1Store Mask@24 null (List_state l) (real_2_U (+ (U_2_real (MapType1Select Mask@24 null (List_state l))) FullPerm)))) (state ExhaleHeap@5 Mask@25))) (and (and (state ExhaleHeap@5 Mask@25) (IdenticalOnKnownLocations ExhaleHeap@5 ExhaleHeap@6 Mask@25)) (and (state ExhaleHeap@6 Mask@25) (state ExhaleHeap@6 Mask@25)))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (not (= l null))) (=> (not (= l null)) (and (=> (= (ControlFlow 0 12) 9) anon100_Then_correct) (=> (= (ControlFlow 0 12) 11) anon100_Else_correct)))))))
(let ((anon99_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 12)) anon65_correct)))
(let ((anon99_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (U_2_real (MapType1Select Mask@23 null (Iterator_ready i@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@23 null (Iterator_ready i@0)))) (=> (= (ControlFlow 0 14) 12) anon65_correct))))))
(let ((anon63_correct  (=> (and (state ExhaleHeap@5 Mask@22) (state ExhaleHeap@5 Mask@22)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (<= FullPerm (U_2_real (MapType1Select Mask@22 null (wand_1 i@0 FullPerm l FullPerm))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@22 null (wand_1 i@0 FullPerm l FullPerm)))) (=> (and (= Mask@23 (MapType1Store Mask@22 null (wand_1 i@0 FullPerm l FullPerm) (real_2_U (- (U_2_real (MapType1Select Mask@22 null (wand_1 i@0 FullPerm l FullPerm))) FullPerm)))) (state ExhaleHeap@5 Mask@23)) (and (=> (= (ControlFlow 0 17) 14) anon99_Then_correct) (=> (= (ControlFlow 0 17) 16) anon99_Else_correct))))))))
(let ((anon98_Else_correct  (=> b_2@1 (=> (and (= Mask@22 Mask@20) (= (ControlFlow 0 20) 17)) anon63_correct))))
(let ((anon98_Then_correct  (=> (not b_2@1) (=> (and (and (= Mask@21 (MapType1Store Mask@20 null (Iterator_ready i@0) (real_2_U (+ (U_2_real (MapType1Select Mask@20 null (Iterator_ready i@0))) FullPerm)))) (state ExhaleHeap@5 Mask@21)) (and (= Mask@22 Mask@21) (= (ControlFlow 0 19) 17))) anon63_correct))))
(let ((anon97_Else_correct  (=> (and (not b_2@1) (= Mask@20 Mask@18)) (and (=> (= (ControlFlow 0 22) 19) anon98_Then_correct) (=> (= (ControlFlow 0 22) 20) anon98_Else_correct)))))
(let ((anon97_Then_correct  (=> (and (and b_2@1 (= Mask@19 (MapType1Store Mask@18 null (Iterator_readyForNext i@0) (real_2_U (+ (U_2_real (MapType1Select Mask@18 null (Iterator_readyForNext i@0))) FullPerm))))) (and (state ExhaleHeap@5 Mask@19) (= Mask@20 Mask@19))) (and (=> (= (ControlFlow 0 21) 19) anon98_Then_correct) (=> (= (ControlFlow 0 21) 20) anon98_Else_correct)))))
(let ((anon83_Else_correct  (=> (and (not b_2@1) (state ExhaleHeap@5 Mask@18)) (and (=> (= (ControlFlow 0 23) 21) anon97_Then_correct) (=> (= (ControlFlow 0 23) 22) anon97_Else_correct)))))
(let ((anon29_correct true))
(let ((anon82_Else_correct  (=> b_2@1 (=> (and (= Mask@52 Mask@50) (= (ControlFlow 0 4) 2)) anon29_correct))))
(let ((anon82_Then_correct  (=> (not b_2@1) (=> (and (and (= Mask@51 (MapType1Store Mask@50 null (Iterator_ready i@0) (real_2_U (+ (U_2_real (MapType1Select Mask@50 null (Iterator_ready i@0))) FullPerm)))) (state ExhaleHeap@5 Mask@51)) (and (= Mask@52 Mask@51) (= (ControlFlow 0 3) 2))) anon29_correct))))
(let ((anon27_correct  (=> (state ExhaleHeap@5 Mask@50) (and (=> (= (ControlFlow 0 5) 3) anon82_Then_correct) (=> (= (ControlFlow 0 5) 4) anon82_Else_correct)))))
(let ((anon81_Else_correct  (=> (not b_2@1) (=> (and (= Mask@50 Mask@18) (= (ControlFlow 0 7) 5)) anon27_correct))))
(let ((anon81_Then_correct  (=> b_2@1 (=> (and (and (= Mask@49 (MapType1Store Mask@18 null (Iterator_readyForNext i@0) (real_2_U (+ (U_2_real (MapType1Select Mask@18 null (Iterator_readyForNext i@0))) FullPerm)))) (state ExhaleHeap@5 Mask@49)) (and (= Mask@50 Mask@49) (= (ControlFlow 0 6) 5))) anon27_correct))))
(let ((anon24_correct  (=> (IdenticalOnKnownLocations ExhaleHeap@4 ExhaleHeap@5 Mask@18) (and (and (and (=> (= (ControlFlow 0 68) 67) anon83_Then_correct) (=> (= (ControlFlow 0 68) 23) anon83_Else_correct)) (=> (= (ControlFlow 0 68) 6) anon81_Then_correct)) (=> (= (ControlFlow 0 68) 7) anon81_Else_correct)))))
(let ((anon23_correct  (=> (= Mask@17 (MapType1Store Mask@16 null (Iterator_ready i@0) (real_2_U (- (U_2_real (MapType1Select Mask@16 null (Iterator_ready i@0))) FullPerm)))) (=> (and (= Mask@18 Mask@17) (= (ControlFlow 0 70) 68)) anon24_correct))))
(let ((anon79_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 73) 70)) anon23_correct)))
(let ((anon79_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 71) (- 0 72)) (<= FullPerm (U_2_real (MapType1Select Mask@16 null (Iterator_ready i@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@16 null (Iterator_ready i@0)))) (=> (= (ControlFlow 0 71) 70) anon23_correct))))))
(let ((anon78_Then_correct  (=> (not b_2@0) (and (=> (= (ControlFlow 0 74) 71) anon79_Then_correct) (=> (= (ControlFlow 0 74) 73) anon79_Else_correct)))))
(let ((anon78_Else_correct  (=> b_2@0 (=> (and (= Mask@18 Mask@16) (= (ControlFlow 0 69) 68)) anon24_correct))))
(let ((anon19_correct  (=> (and (= Mask@15 (MapType1Store Mask@14 null (Iterator_readyForNext i@0) (real_2_U (- (U_2_real (MapType1Select Mask@14 null (Iterator_readyForNext i@0))) FullPerm)))) (= Mask@16 Mask@15)) (and (=> (= (ControlFlow 0 76) 74) anon78_Then_correct) (=> (= (ControlFlow 0 76) 69) anon78_Else_correct)))))
(let ((anon77_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 79) 76)) anon19_correct)))
(let ((anon77_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 77) (- 0 78)) (<= FullPerm (U_2_real (MapType1Select Mask@14 null (Iterator_readyForNext i@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@14 null (Iterator_readyForNext i@0)))) (=> (= (ControlFlow 0 77) 76) anon19_correct))))))
(let ((anon76_Then_correct  (=> b_2@0 (and (=> (= (ControlFlow 0 80) 77) anon77_Then_correct) (=> (= (ControlFlow 0 80) 79) anon77_Else_correct)))))
(let ((anon76_Else_correct  (=> (and (not b_2@0) (= Mask@16 Mask@14)) (and (=> (= (ControlFlow 0 75) 74) anon78_Then_correct) (=> (= (ControlFlow 0 75) 69) anon78_Else_correct)))))
(let ((anon16_correct  (=> (and (state ExhaleHeap@4 Mask@14) (state ExhaleHeap@4 Mask@14)) (and (=> (= (ControlFlow 0 81) 80) anon76_Then_correct) (=> (= (ControlFlow 0 81) 75) anon76_Else_correct)))))
(let ((anon75_Else_correct  (=> b_2@0 (=> (and (= Mask@14 Mask@12) (= (ControlFlow 0 83) 81)) anon16_correct))))
(let ((anon75_Then_correct  (=> (not b_2@0) (=> (and (and (= Mask@13 (MapType1Store Mask@12 null (Iterator_ready i@0) (real_2_U (+ (U_2_real (MapType1Select Mask@12 null (Iterator_ready i@0))) FullPerm)))) (state ExhaleHeap@4 Mask@13)) (and (= Mask@14 Mask@13) (= (ControlFlow 0 82) 81))) anon16_correct))))
(let ((anon74_Else_correct  (=> (and (not b_2@0) (= Mask@12 Mask@10)) (and (=> (= (ControlFlow 0 85) 82) anon75_Then_correct) (=> (= (ControlFlow 0 85) 83) anon75_Else_correct)))))
(let ((anon74_Then_correct  (=> (and (and b_2@0 (= Mask@11 (MapType1Store Mask@10 null (Iterator_readyForNext i@0) (real_2_U (+ (U_2_real (MapType1Select Mask@10 null (Iterator_readyForNext i@0))) FullPerm))))) (and (state ExhaleHeap@4 Mask@11) (= Mask@12 Mask@11))) (and (=> (= (ControlFlow 0 84) 82) anon75_Then_correct) (=> (= (ControlFlow 0 84) 83) anon75_Else_correct)))))
(let ((anon12_correct  (=> (and (= Mask@10 (MapType1Store Mask@9 null (Iterator_ready i@0) (real_2_U (- (U_2_real (MapType1Select Mask@9 null (Iterator_ready i@0))) FullPerm)))) (IdenticalOnKnownLocations ExhaleHeap@3 ExhaleHeap@4 Mask@10)) (and (=> (= (ControlFlow 0 86) 84) anon74_Then_correct) (=> (= (ControlFlow 0 86) 85) anon74_Else_correct)))))
(let ((anon73_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 89) 86)) anon12_correct)))
(let ((anon73_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 87) (- 0 88)) (<= FullPerm (U_2_real (MapType1Select Mask@9 null (Iterator_ready i@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@9 null (Iterator_ready i@0)))) (=> (= (ControlFlow 0 87) 86) anon12_correct))))))
(let ((anon10_correct  (=> (= Mask@7 (MapType1Store Mask@6 null (List_state l) (real_2_U (- (U_2_real (MapType1Select Mask@6 null (List_state l))) FullPerm)))) (=> (and (and (and (IdenticalOnKnownLocations ExhaleHeap@2 ExhaleHeap@3 Mask@7) (= Mask@8 (MapType1Store Mask@7 null (Iterator_ready i@0) (real_2_U (+ (U_2_real (MapType1Select Mask@7 null (Iterator_ready i@0))) FullPerm))))) (and (state ExhaleHeap@3 Mask@8) (= Mask@9 (MapType1Store Mask@8 null (wand_1 i@0 FullPerm l FullPerm) (real_2_U (+ (U_2_real (MapType1Select Mask@8 null (wand_1 i@0 FullPerm l FullPerm))) FullPerm)))))) (and (and (state ExhaleHeap@3 Mask@9) (state ExhaleHeap@3 Mask@9)) (and (U_2_bool (MapType0Select ExhaleHeap@3 i@0 $allocated)) (state ExhaleHeap@3 Mask@9)))) (and (=> (= (ControlFlow 0 90) 87) anon73_Then_correct) (=> (= (ControlFlow 0 90) 89) anon73_Else_correct))))))
(let ((anon72_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 93) 90)) anon10_correct)))
(let ((anon72_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 91) (- 0 92)) (<= FullPerm (U_2_real (MapType1Select Mask@6 null (List_state l))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@6 null (List_state l)))) (=> (= (ControlFlow 0 91) 90) anon10_correct))))))
(let ((anon8_correct  (=> (and (= Mask@5 (MapType1Store Mask@4 null (List_state l) (real_2_U (- (U_2_real (MapType1Select Mask@4 null (List_state l))) FullPerm)))) (IdenticalOnKnownLocations ExhaleHeap@1 ExhaleHeap@2 Mask@5)) (=> (and (and (= Mask@6 (MapType1Store Mask@5 null (List_state l) (real_2_U (+ (U_2_real (MapType1Select Mask@5 null (List_state l))) FullPerm)))) (state ExhaleHeap@2 Mask@6)) (and (state ExhaleHeap@2 Mask@6) (state ExhaleHeap@2 Mask@6))) (and (=> (= (ControlFlow 0 94) (- 0 95)) (not (= l null))) (=> (not (= l null)) (and (=> (= (ControlFlow 0 94) 91) anon72_Then_correct) (=> (= (ControlFlow 0 94) 93) anon72_Else_correct))))))))
(let ((anon71_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 98) 94)) anon8_correct)))
(let ((anon71_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 96) (- 0 97)) (<= FullPerm (U_2_real (MapType1Select Mask@4 null (List_state l))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 null (List_state l)))) (=> (= (ControlFlow 0 96) 94) anon8_correct))))))
(let ((anon6_correct  (=> (= Mask@3 (MapType1Store Mask@2 null (List_state l) (real_2_U (- (U_2_real (MapType1Select Mask@2 null (List_state l))) FullPerm)))) (=> (and (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@1 Mask@3) (= Mask@4 (MapType1Store Mask@3 null (List_state l) (real_2_U (+ (U_2_real (MapType1Select Mask@3 null (List_state l))) FullPerm))))) (=> (and (and (state ExhaleHeap@1 Mask@4) (state ExhaleHeap@1 Mask@4)) (and (state ExhaleHeap@1 Mask@4) (= arg_v@0 (- 0 1)))) (and (=> (= (ControlFlow 0 99) 96) anon71_Then_correct) (=> (= (ControlFlow 0 99) 98) anon71_Else_correct)))))))
(let ((anon70_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 102) 99)) anon6_correct)))
(let ((anon70_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 100) (- 0 101)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null (List_state l))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 null (List_state l)))) (=> (= (ControlFlow 0 100) 99) anon6_correct))))))
(let ((anon4_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 null (List_state l) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (List_state l))) FullPerm)))) (IdenticalOnKnownLocations Heap@@35 ExhaleHeap@0 Mask@1)) (=> (and (and (= Mask@2 (MapType1Store Mask@1 null (List_state l) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (List_state l))) FullPerm)))) (state ExhaleHeap@0 Mask@2)) (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2))) (and (=> (= (ControlFlow 0 103) 100) anon70_Then_correct) (=> (= (ControlFlow 0 103) 102) anon70_Else_correct))))))
(let ((anon69_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 106) 103)) anon4_correct)))
(let ((anon69_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 104) (- 0 105)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (List_state l))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (List_state l)))) (=> (= (ControlFlow 0 104) 103) anon4_correct))))))
(let ((anon68_Else_correct  (=> (U_2_bool (MapType0Select Heap@@35 i $allocated)) (and (=> (= (ControlFlow 0 107) 104) anon69_Then_correct) (=> (= (ControlFlow 0 107) 106) anon69_Else_correct)))))
(let ((anon68_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@35 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@35 l $allocated))) (=> (and (and (not (= l null)) (= Mask@0 (MapType1Store ZeroMask null (List_state l) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (List_state l))) FullPerm))))) (and (state Heap@@35 Mask@0) (state Heap@@35 Mask@0))) (and (=> (= (ControlFlow 0 108) 1) anon68_Then_correct) (=> (= (ControlFlow 0 108) 107) anon68_Else_correct)))))))
