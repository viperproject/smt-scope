...
(assert  (and (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type x@@14) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Heap@1) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (forall ((arg0@@28 T@U) ) (! (= (type (FrameFragment arg0@@28)) FrameTypeType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon4_correct  (=> (and (= perm@0 (* FullPerm p_1)) (= (ControlFlow 0 2) (- 0 1))) (>= perm@0 NoPerm))))
(let ((anon6_Else_correct  (=> (HasDirectPerm Mask@1 null (P x@@14)) (=> (and (= Heap@1 Heap@@10) (= (ControlFlow 0 4) 2)) anon4_correct))))
(let ((anon6_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (P x@@14))) (= Heap@0 (MapType0Store Heap@@10 null (P x@@14) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 3) 2))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (P x@@14) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P x@@14))) p_1)))) (and (=> (= (ControlFlow 0 5) 3) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (= p_1 NoPerm) (= (ControlFlow 0 8) 5)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= p_1 NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= p_1 (U_2_real (MapType1Select Mask@0 null (P x@@14))))) (=> (<= p_1 (U_2_real (MapType1Select Mask@0 null (P x@@14)))) (=> (= (ControlFlow 0 6) 5) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@10 x@@14 $allocated)) (= p_1 (- 0.0 (/ (to_real 1) (to_real 2))))) (and (state Heap@@10 ZeroMask) (state Heap@@10 ZeroMask))) (and (and (= Mask@0 (MapType1Store ZeroMask null (P x@@14) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@14))) FullPerm)))) (state Heap@@10 Mask@0)) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (> p_1 NoPerm)) (=> (> p_1 NoPerm) (=> (and (|P#trigger| Heap@@10 (P x@@14)) (= (MapType0Select Heap@@10 null (P x@@14)) (FrameFragment (MapType0Select Heap@@10 x@@14 f_7)))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (>= p_1 NoPerm)) (=> (>= p_1 NoPerm) (and (=> (= (ControlFlow 0 9) 6) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct)))))))))))
