...
(declare-fun _r_1_6 () T@U)
(declare-fun Heap@@51 () T@U)
(declare-fun _r_1_4 () T@U)
(declare-fun _r_1_2 () T@U)
(declare-fun _r_1 () T@U)
(declare-fun x_0 () T@U)
(declare-fun _cthread_155 () T@U)
(declare-fun __plugin_refute_nondet1 () Bool)
(declare-fun __plugin_refute_nondet2 () Bool)
(declare-fun r_1@0 () T@U)
(declare-fun __plugin_refute_nondet6 () Bool)
(declare-fun __plugin_refute_nondet5 () Bool)
(declare-fun __plugin_refute_nondet4 () Bool)
(declare-fun __plugin_refute_nondet3 () Bool)
(declare-fun _err () T@U)
(declare-fun r_1@@21 () T@U)
(declare-fun x_1_1 () T@U)
(declare-fun _method_measures_155@0 () T@U)
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type x_0) RefType) (= (type Heap@@51) (MapType1Type RefType))) (= (type r_1@0) RefType)) (= (type _err) RefType)) (= (type r_1@@21) RefType)) (= (type x_1_1) RefType)) (= (type _method_measures_155@0) (SeqType Measure$DomainTypeType))) (= (type _cthread_155) RefType)) (= (type _r_1) RefType)) (= (type _r_1_2) RefType)) (= (type _r_1_4) RefType)) (= (type _r_1_6) RefType)))
(set-info :boogie-vc-id main)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 69) (let ((anon20_correct true))
(let ((anon77_Else_correct  (=> (and (not (HasDirectPerm ZeroMask _r_1_6 MustReleaseUnbounded)) (= (ControlFlow 0 62) 59)) anon20_correct)))
(let ((anon77_Then_correct  (=> (HasDirectPerm ZeroMask _r_1_6 MustReleaseUnbounded) (and (=> (= (ControlFlow 0 60) (- 0 61)) (HasDirectPerm ZeroMask _r_1_6 MustReleaseUnbounded)) (=> (HasDirectPerm ZeroMask _r_1_6 MustReleaseUnbounded) (=> (= (ControlFlow 0 60) 59) anon20_correct))))))
(let ((anon76_Else_correct true))
(let ((anon74_Else_correct  (=> (forall ((_r_1_5 T@U) ) (!  (=> (and (= (type _r_1_5) RefType) (HasDirectPerm ZeroMask _r_1_5 MustReleaseBounded)) false)
 :qid |stdinbpl.2251:24|
 :skolemid |264|
 :pattern ( (MapType2Select ZeroMask _r_1_5 MustReleaseBounded))
 :pattern ( (MapType1Select Heap@@51 _r_1_5 MustReleaseBounded))
)) (and (and (=> (= (ControlFlow 0 63) 58) anon76_Else_correct) (=> (= (ControlFlow 0 63) 60) anon77_Then_correct)) (=> (= (ControlFlow 0 63) 62) anon77_Else_correct)))))
(let ((anon16_correct true))
(let ((anon75_Else_correct  (=> (and (not (HasDirectPerm ZeroMask _r_1_4 MustReleaseBounded)) (= (ControlFlow 0 57) 54)) anon16_correct)))
(let ((anon75_Then_correct  (=> (HasDirectPerm ZeroMask _r_1_4 MustReleaseBounded) (and (=> (= (ControlFlow 0 55) (- 0 56)) (HasDirectPerm ZeroMask _r_1_4 MustReleaseBounded)) (=> (HasDirectPerm ZeroMask _r_1_4 MustReleaseBounded) (=> (= (ControlFlow 0 55) 54) anon16_correct))))))
(let ((anon72_Else_correct  (=> (forall ((_r_1_3 T@U) ) (!  (=> (and (= (type _r_1_3) RefType) (HasDirectPerm ZeroMask null (MustInvokeUnbounded _r_1_3))) false)
 :qid |stdinbpl.2238:24|
 :skolemid |263|
 :pattern ( (MapType2Select ZeroMask null (MustInvokeUnbounded _r_1_3)))
 :pattern ( (MapType1Select Heap@@51 null (MustInvokeUnbounded _r_1_3)))
)) (and (and (=> (= (ControlFlow 0 64) 63) anon74_Else_correct) (=> (= (ControlFlow 0 64) 55) anon75_Then_correct)) (=> (= (ControlFlow 0 64) 57) anon75_Else_correct)))))
(let ((anon12_correct true))
(let ((anon73_Else_correct  (=> (and (not (HasDirectPerm ZeroMask null (MustInvokeUnbounded _r_1_2))) (= (ControlFlow 0 53) 50)) anon12_correct)))
(let ((anon73_Then_correct  (=> (HasDirectPerm ZeroMask null (MustInvokeUnbounded _r_1_2)) (and (=> (= (ControlFlow 0 51) (- 0 52)) (HasDirectPerm ZeroMask null (MustInvokeUnbounded _r_1_2))) (=> (HasDirectPerm ZeroMask null (MustInvokeUnbounded _r_1_2)) (=> (= (ControlFlow 0 51) 50) anon12_correct))))))
(let ((anon70_Else_correct  (=> (forall ((_r_1_1 T@U) ) (!  (=> (and (= (type _r_1_1) RefType) (HasDirectPerm ZeroMask null (MustInvokeBounded _r_1_1))) false)
 :qid |stdinbpl.2225:24|
 :skolemid |262|
 :pattern ( (MapType2Select ZeroMask null (MustInvokeBounded _r_1_1)))
 :pattern ( (MapType1Select Heap@@51 null (MustInvokeBounded _r_1_1)))
)) (and (and (=> (= (ControlFlow 0 65) 64) anon72_Else_correct) (=> (= (ControlFlow 0 65) 51) anon73_Then_correct)) (=> (= (ControlFlow 0 65) 53) anon73_Else_correct)))))
(let ((anon8_correct true))
(let ((anon71_Else_correct  (=> (and (not (HasDirectPerm ZeroMask null (MustInvokeBounded _r_1))) (= (ControlFlow 0 49) 46)) anon8_correct)))
(let ((anon71_Then_correct  (=> (HasDirectPerm ZeroMask null (MustInvokeBounded _r_1)) (and (=> (= (ControlFlow 0 47) (- 0 48)) (HasDirectPerm ZeroMask null (MustInvokeBounded _r_1))) (=> (HasDirectPerm ZeroMask null (MustInvokeBounded _r_1)) (=> (= (ControlFlow 0 47) 46) anon8_correct))))))
(let ((anon69_Else_correct  (=> (int___gt__ Heap@@51 (int___unbox__ Heap@@51 x_0) 10) (=> (and (state Heap@@51 ZeroMask) (= (U_2_real (MapType2Select ZeroMask null (MustTerminate _cthread_155))) NoPerm)) (and (and (=> (= (ControlFlow 0 66) 65) anon70_Else_correct) (=> (= (ControlFlow 0 66) 47) anon71_Then_correct)) (=> (= (ControlFlow 0 66) 49) anon71_Else_correct))))))
(let ((anon69_Then_correct true))
(let ((anon68_Then_correct  (=> (= (ControlFlow 0 44) (- 0 43)) (issubtype (typeof x_0) vint))))
(let ((anon67_Then_correct  (=> (not (= _cthread_155 null)) (=> (and (state Heap@@51 ZeroMask) (issubtype (typeof _cthread_155) Thread_0)) (=> (and (and (state Heap@@51 ZeroMask) (issubtype (typeof x_0) vint)) (and (state Heap@@51 ZeroMask) (state Heap@@51 ZeroMask))) (and (and (=> (= (ControlFlow 0 67) 44) anon68_Then_correct) (=> (= (ControlFlow 0 67) 45) anon69_Then_correct)) (=> (= (ControlFlow 0 67) 66) anon69_Else_correct)))))))
(let ((anon82_Else_correct  (=> (= (ControlFlow 0 39) (- 0 38)) (not (int___gt__ Heap@@51 (int___unbox__ Heap@@51 x_0) 0)))))
(let ((anon82_Then_correct true))
(let ((anon81_Then_correct  (=> (= (ControlFlow 0 36) (- 0 35)) (issubtype (typeof x_0) vint))))
(let ((anon80_Then_correct  (=> __plugin_refute_nondet1 (and (and (=> (= (ControlFlow 0 40) 36) anon81_Then_correct) (=> (= (ControlFlow 0 40) 37) anon82_Then_correct)) (=> (= (ControlFlow 0 40) 39) anon82_Else_correct)))))
(let ((anon85_Else_correct  (=> (= (ControlFlow 0 32) (- 0 31)) (int___gt__ Heap@@51 (int___unbox__ Heap@@51 x_0) 0))))
(let ((anon85_Then_correct true))
(let ((anon84_Then_correct  (=> (= (ControlFlow 0 29) (- 0 28)) (issubtype (typeof x_0) vint))))
(let ((anon83_Then_correct  (=> __plugin_refute_nondet2 (and (and (=> (= (ControlFlow 0 33) 29) anon84_Then_correct) (=> (= (ControlFlow 0 33) 30) anon85_Then_correct)) (=> (= (ControlFlow 0 33) 32) anon85_Else_correct)))))
(let ((anon92_Then_correct true))
(let ((anon65_correct true))
(let ((anon92_Else_correct  (=> (and (and (_isDefined Heap@@51 114) (state Heap@@51 ZeroMask)) (and (state Heap@@51 ZeroMask) (= (ControlFlow 0 22) 16))) anon65_correct)))
(let ((anon91_Then_correct  (=> (int___gt__ Heap@@51 (int___unbox__ Heap@@51 x_0) 0) (=> (and (state Heap@@51 ZeroMask) (state Heap@@51 ZeroMask)) (and (=> (= (ControlFlow 0 23) 21) anon92_Then_correct) (=> (= (ControlFlow 0 23) 22) anon92_Else_correct))))))
(let ((anon95_Else_correct  (=> (and (and (_isDefined Heap@@51 114) (state Heap@@51 ZeroMask)) (and (state Heap@@51 ZeroMask) (= (ControlFlow 0 17) 16))) anon65_correct)))
(let ((anon95_Then_correct true))
(let ((anon94_Else_correct  (=> (= r_1@0 (__prim__int___box__ Heap@@51 0)) (=> (and (state Heap@@51 ZeroMask) (state Heap@@51 ZeroMask)) (and (=> (= (ControlFlow 0 18) 15) anon95_Then_correct) (=> (= (ControlFlow 0 18) 17) anon95_Else_correct))))))
(let ((anon94_Then_correct true))
(let ((anon93_Else_correct  (=> (not __plugin_refute_nondet6) (=> (and (state Heap@@51 ZeroMask) (state Heap@@51 ZeroMask)) (and (=> (= (ControlFlow 0 19) 14) anon94_Then_correct) (=> (= (ControlFlow 0 19) 18) anon94_Else_correct))))))
(let ((anon93_Then_correct  (=> (and __plugin_refute_nondet6 (= (ControlFlow 0 13) (- 0 12))) false)))
(let ((anon91_Else_correct  (=> (and (not (int___gt__ Heap@@51 (int___unbox__ Heap@@51 x_0) 0)) (state Heap@@51 ZeroMask)) (and (=> (= (ControlFlow 0 20) 13) anon93_Then_correct) (=> (= (ControlFlow 0 20) 19) anon93_Else_correct)))))
(let ((anon90_Then_correct true))
(let ((anon89_Then_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (issubtype (typeof x_0) vint))))
(let ((anon88_Else_correct  (=> (and (and (not __plugin_refute_nondet5) (state Heap@@51 ZeroMask)) (and (state Heap@@51 ZeroMask) (state Heap@@51 ZeroMask))) (and (and (and (=> (= (ControlFlow 0 24) 10) anon89_Then_correct) (=> (= (ControlFlow 0 24) 11) anon90_Then_correct)) (=> (= (ControlFlow 0 24) 23) anon91_Then_correct)) (=> (= (ControlFlow 0 24) 20) anon91_Else_correct)))))
(let ((anon88_Then_correct  (=> (and __plugin_refute_nondet5 (= (ControlFlow 0 8) (- 0 7))) false)))
(let ((anon87_Else_correct  (=> (and (and (not __plugin_refute_nondet4) (state Heap@@51 ZeroMask)) (and (state Heap@@51 ZeroMask) (state Heap@@51 ZeroMask))) (and (=> (= (ControlFlow 0 25) 8) anon88_Then_correct) (=> (= (ControlFlow 0 25) 24) anon88_Else_correct)))))
(let ((anon87_Then_correct true))
(let ((anon86_Else_correct  (=> (and (and (not __plugin_refute_nondet3) (state Heap@@51 ZeroMask)) (and (state Heap@@51 ZeroMask) (state Heap@@51 ZeroMask))) (and (=> (= (ControlFlow 0 26) 6) anon87_Then_correct) (=> (= (ControlFlow 0 26) 25) anon87_Else_correct)))))
(let ((anon86_Then_correct  (=> (and __plugin_refute_nondet3 (= (ControlFlow 0 5) (- 0 4))) false)))
(let ((anon83_Else_correct  (=> (and (and (not __plugin_refute_nondet2) (state Heap@@51 ZeroMask)) (and (state Heap@@51 ZeroMask) (state Heap@@51 ZeroMask))) (and (=> (= (ControlFlow 0 27) 5) anon86_Then_correct) (=> (= (ControlFlow 0 27) 26) anon86_Else_correct)))))
(let ((anon80_Else_correct  (=> (and (and (not __plugin_refute_nondet1) (state Heap@@51 ZeroMask)) (and (state Heap@@51 ZeroMask) (state Heap@@51 ZeroMask))) (and (=> (= (ControlFlow 0 34) 33) anon83_Then_correct) (=> (= (ControlFlow 0 34) 27) anon83_Else_correct)))))
(let ((anon79_Else_correct  (=> (and (and (int___gt__ Heap@@51 (int___unbox__ Heap@@51 x_0) 10) (state Heap@@51 ZeroMask)) (and (state Heap@@51 ZeroMask) (U_2_bool (MapType1Select Heap@@51 _err $allocated)))) (=> (and (and (and (and (U_2_bool (MapType1Select Heap@@51 r_1@@21 $allocated)) (U_2_bool (MapType1Select Heap@@51 x_1_1 $allocated))) (and (state Heap@@51 ZeroMask) (state Heap@@51 ZeroMask))) (and (and (state Heap@@51 ZeroMask) (state Heap@@51 ZeroMask)) (and (state Heap@@51 ZeroMask) (state Heap@@51 ZeroMask)))) (and (and (and (state Heap@@51 ZeroMask) (state Heap@@51 ZeroMask)) (and (state Heap@@51 ZeroMask) (= _method_measures_155@0 (|Seq#Empty| Measure$DomainTypeType)))) (and (and (state Heap@@51 ZeroMask) (state Heap@@51 ZeroMask)) (and (state Heap@@51 ZeroMask) (state Heap@@51 ZeroMask))))) (and (=> (= (ControlFlow 0 41) 40) anon80_Then_correct) (=> (= (ControlFlow 0 41) 34) anon80_Else_correct))))))
(let ((anon79_Then_correct true))
(let ((anon78_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (issubtype (typeof x_0) vint))))
(let ((anon67_Else_correct  (=> (not (= _cthread_155 null)) (=> (and (state Heap@@51 ZeroMask) (issubtype (typeof _cthread_155) Thread_0)) (=> (and (and (state Heap@@51 ZeroMask) (issubtype (typeof x_0) vint)) (and (state Heap@@51 ZeroMask) (state Heap@@51 ZeroMask))) (and (and (=> (= (ControlFlow 0 42) 2) anon78_Then_correct) (=> (= (ControlFlow 0 42) 3) anon79_Then_correct)) (=> (= (ControlFlow 0 42) 41) anon79_Else_correct)))))))
(let ((anon0_correct  (=> (and (and (state Heap@@51 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType1Select Heap@@51 _cthread_155 $allocated)) (U_2_bool (MapType1Select Heap@@51 x_0 $allocated)))) (and (=> (= (ControlFlow 0 68) 67) anon67_Then_correct) (=> (= (ControlFlow 0 68) 42) anon67_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 69) 68) anon0_correct)))
PreconditionGeneratedEntry_correct))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(get-info :reason-unknown)
(assert (not (= (ControlFlow 0 39) (- 38))))
(check-sat)
(get-info :reason-unknown)
