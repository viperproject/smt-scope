...
(declare-fun |equiv'| (T@U) Bool)
(declare-fun |equiv#frame| (T@U) Bool)
(declare-fun FullPerm () Real)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |equiv#triggerStateless| () Bool)
(declare-fun ZeroPMask () T@U)
(declare-fun vequiv (T@U) Bool)
...
(assert (forall ((Heap@@5 T@U) (Mask@@6 T@U) ) (!  (=> (and (and (= (type Heap@@5) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (state Heap@@5 Mask@@6)) (= (|equiv'| Heap@@5) (|equiv#frame| EmptyFrame)))
 :qid |stdinbpl.196:15|
 :skolemid |24|
 :pattern ( (state Heap@@5 Mask@@6) (|equiv'| Heap@@5))
)))
...
(assert (forall ((Heap@@8 T@U) ) (!  (=> (= (type Heap@@8) (MapType0Type RefType)) (dummyFunction (bool_2_U |equiv#triggerStateless|)))
 :qid |stdinbpl.189:15|
 :skolemid |23|
 :pattern ( (|equiv'| Heap@@8))
)))
...
(assert (forall ((Heap@@11 T@U) ) (!  (=> (= (type Heap@@11) (MapType0Type RefType)) (and (= (vequiv Heap@@11) (|equiv'| Heap@@11)) (dummyFunction (bool_2_U |equiv#triggerStateless|))))
 :qid |stdinbpl.185:15|
 :skolemid |22|
 :pattern ( (vequiv Heap@@11))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (= b_2@0 (vequiv Heap@@12)))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (and (= b_2@0 (vequiv Heap@@12)) (state Heap@@12 ZeroMask)) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@12 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct)))))
