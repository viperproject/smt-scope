...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type lock) RefType)) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Heap@@38) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type ExhaleHeap@1) (MapType0Type RefType))) (= (type Mask@8) (MapType1Type RefType realType))) (= (type Mask@7) (MapType1Type RefType realType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type ExhaleWellDef0Mask@1) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type r_1) RefType)) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 57) (let ((anon6_correct true))
(let ((anon40_Else_correct  (=> (and (not (HasDirectPerm ZeroMask r_1 held)) (= (ControlFlow 0 54) 51)) anon6_correct)))
(let ((anon40_Then_correct  (=> (HasDirectPerm ZeroMask r_1 held) (and (=> (= (ControlFlow 0 52) (- 0 53)) (HasDirectPerm ZeroMask r_1 held)) (=> (HasDirectPerm ZeroMask r_1 held) (=> (= (ControlFlow 0 52) 51) anon6_correct))))))
(let ((anon39_Else_correct true))
(let ((anon38_Then_correct true))
(let ((anon37_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (and (and (=> (= (ControlFlow 0 55) 49) anon38_Then_correct) (=> (= (ControlFlow 0 55) 50) anon39_Else_correct)) (=> (= (ControlFlow 0 55) 52) anon40_Then_correct)) (=> (= (ControlFlow 0 55) 54) anon40_Else_correct)))))
(let ((anon18_correct  (=> (and (= ExhaleWellDef0Mask@1 (MapType1Store Mask@4 null (List lock) (real_2_U (- (U_2_real (MapType1Select Mask@4 null (List lock))) FullPerm)))) (= (ControlFlow 0 38) (- 0 37))) (< 0 (length ExhaleHeap@0 lock)))))
(let ((anon46_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 41) 38)) anon18_correct)))
(let ((anon46_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 39) (- 0 40)) (<= FullPerm (U_2_real (MapType1Select Mask@4 null (List lock))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 null (List lock)))) (=> (= (ControlFlow 0 39) 38) anon18_correct))))))
(let ((anon36_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (or (|Seq#Equal| (content Heap@@38 lock) (content Heap@1 lock)) (U_2_bool (MapType0Select Heap@1 lock changed)))) (=> (or (|Seq#Equal| (content Heap@@38 lock) (content Heap@1 lock)) (U_2_bool (MapType0Select Heap@1 lock changed))) (=> (IdenticalOnKnownLocations Heap@1 ExhaleHeap@1 Mask@8) (=> (and (state ExhaleHeap@1 Mask@8) (= (ControlFlow 0 14) (- 0 13))) (forall ((r_2 T@U) ) (!  (=> (and (= (type r_2) RefType) (HasDirectPerm Mask@8 r_2 held)) false)
 :qid |stdinbpl.6632:15|
 :skolemid |194|
 :pattern ( (MapType1Select Mask@8 r_2 held))
 :pattern ( (MapType0Select ExhaleHeap@1 r_2 held))
))))))))
(let ((anon54_Else_correct  (=> (and (|Seq#Equal| (content Heap@@38 lock) (content Heap@1 lock)) (= (ControlFlow 0 18) 14)) anon36_correct)))
(let ((anon54_Then_correct  (=> (not (|Seq#Equal| (content Heap@@38 lock) (content Heap@1 lock))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm Mask@5 lock changed)) (=> (HasDirectPerm Mask@5 lock changed) (=> (= (ControlFlow 0 16) 14) anon36_correct))))))
(let ((anon33_correct true))
(let ((anon53_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon33_correct)))
(let ((anon53_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@5 null (List lock))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@5 null (List lock)))) (=> (= (ControlFlow 0 10) 9) anon33_correct))))))
(let ((anon29_correct true))
(let ((anon51_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon29_correct)))
(let ((anon51_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null (List lock))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 null (List lock)))) (=> (= (ControlFlow 0 6) 5) anon29_correct))))))
(let ((anon26_correct  (=> (= Mask@8 (MapType1Store Mask@7 lock changed (real_2_U (- (U_2_real (MapType1Select Mask@7 lock changed)) FullPerm)))) (and (=> (= (ControlFlow 0 19) (- 0 20)) true) (and (and (and (and (and (=> (= (ControlFlow 0 19) 16) anon54_Then_correct) (=> (= (ControlFlow 0 19) 18) anon54_Else_correct)) (=> (= (ControlFlow 0 19) 10) anon53_Then_correct)) (=> (= (ControlFlow 0 19) 12) anon53_Else_correct)) (=> (= (ControlFlow 0 19) 6) anon51_Then_correct)) (=> (= (ControlFlow 0 19) 8) anon51_Else_correct))))))
(let ((anon49_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 23) 19)) anon26_correct)))
(let ((anon49_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (<= FullPerm (U_2_real (MapType1Select Mask@7 lock changed)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@7 lock changed))) (=> (= (ControlFlow 0 21) 19) anon26_correct))))))
(let ((anon24_correct  (=> (= Mask@7 (MapType1Store Mask@6 lock held (real_2_U (- (U_2_real (MapType1Select Mask@6 lock held)) FullPerm)))) (and (=> (= (ControlFlow 0 24) 21) anon49_Then_correct) (=> (= (ControlFlow 0 24) 23) anon49_Else_correct)))))
(let ((anon48_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 27) 24)) anon24_correct)))
(let ((anon48_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 25) (- 0 26)) (<= FullPerm (U_2_real (MapType1Select Mask@6 lock held)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@6 lock held))) (=> (= (ControlFlow 0 25) 24) anon24_correct))))))
(let ((anon22_correct  (=> (= Mask@6 (MapType1Store Mask@5 null (List lock) (real_2_U (- (U_2_real (MapType1Select Mask@5 null (List lock))) FullPerm)))) (and (=> (= (ControlFlow 0 28) 25) anon48_Then_correct) (=> (= (ControlFlow 0 28) 27) anon48_Else_correct)))))
(let ((anon47_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 31) 28)) anon22_correct)))
(let ((anon47_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (<= FullPerm (U_2_real (MapType1Select Mask@5 null (List lock))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@5 null (List lock)))) (=> (= (ControlFlow 0 29) 28) anon22_correct))))))
(let ((anon20_correct  (=> (state Heap@1 Mask@5) (and (=> (= (ControlFlow 0 32) 29) anon47_Then_correct) (=> (= (ControlFlow 0 32) 31) anon47_Else_correct)))))
(let ((anon45_Else_correct  (and (=> (= (ControlFlow 0 34) (- 0 36)) (<= r1@0 (peek ExhaleHeap@0 lock))) (=> (<= r1@0 (peek ExhaleHeap@0 lock)) (=> (state ExhaleHeap@0 Mask@4) (and (=> (= (ControlFlow 0 34) (- 0 35)) (= FullPerm (U_2_real (MapType1Select Mask@4 lock changed)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@4 lock changed))) (=> (= Heap@0 (MapType0Store ExhaleHeap@0 lock changed (bool_2_U true))) (=> (and (and (state Heap@0 Mask@4) (= Mask@5 Mask@4)) (and (= Heap@1 Heap@0) (= (ControlFlow 0 34) 32))) anon20_correct)))))))))
(let ((anon15_correct  (=> (= Mask@3 (MapType1Store Mask@2 null (List lock) (real_2_U (- (U_2_real (MapType1Select Mask@2 null (List lock))) FullPerm)))) (and (=> (= (ControlFlow 0 42) (- 0 43)) (< 0 (length Heap@@38 lock))) (=> (< 0 (length Heap@@38 lock)) (=> (IdenticalOnKnownLocations Heap@@38 ExhaleHeap@0 Mask@3) (=> (and (and (and (= Mask@4 (MapType1Store Mask@3 null (List lock) (real_2_U (+ (U_2_real (MapType1Select Mask@3 null (List lock))) FullPerm)))) (state ExhaleHeap@0 Mask@4)) (and (state ExhaleHeap@0 Mask@4) (= r1@0 (U_2_int (|Seq#Index| (content Heap@@38 lock) 0))))) (and (and (state ExhaleHeap@0 Mask@4) (|Seq#Equal| (content ExhaleHeap@0 lock) (|Seq#Drop| (content Heap@@38 lock) 1))) (and (state ExhaleHeap@0 Mask@4) (state ExhaleHeap@0 Mask@4)))) (and (and (=> (= (ControlFlow 0 42) 34) anon45_Else_correct) (=> (= (ControlFlow 0 42) 39) anon46_Then_correct)) (=> (= (ControlFlow 0 42) 41) anon46_Else_correct)))))))))
(let ((anon44_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 46) 42)) anon15_correct)))
(let ((anon44_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 44) (- 0 45)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null (List lock))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 null (List lock)))) (=> (= (ControlFlow 0 44) 42) anon15_correct))))))
(let ((anon43_Then_correct  (=> (<= 2 (length Heap@@38 lock)) (and (=> (= (ControlFlow 0 47) 44) anon44_Then_correct) (=> (= (ControlFlow 0 47) 46) anon44_Else_correct)))))
(let ((anon43_Else_correct  (=> (and (and (< (length Heap@@38 lock) 2) (= Mask@5 Mask@2)) (and (= Heap@1 Heap@@38) (= (ControlFlow 0 33) 32))) anon20_correct)))
(let ((anon11_correct true))
(let ((anon42_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon11_correct)))
(let ((anon42_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null (List lock))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 null (List lock)))) (=> (= (ControlFlow 0 2) 1) anon11_correct))))))
(let ((anon37_Else_correct  (=> (= Mask@0 (MapType1Store ZeroMask null (List lock) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (List lock))) FullPerm)))) (=> (and (state Heap@@38 Mask@0) (not (= lock null))) (=> (and (and (and (= Mask@1 (MapType1Store Mask@0 lock held (real_2_U (+ (U_2_real (MapType1Select Mask@0 lock held)) FullPerm)))) (state Heap@@38 Mask@1)) (and (not (= lock null)) (= Mask@2 (MapType1Store Mask@1 lock changed (real_2_U (+ (U_2_real (MapType1Select Mask@1 lock changed)) FullPerm)))))) (and (and (state Heap@@38 Mask@2) (state Heap@@38 Mask@2)) (and (state Heap@@38 Mask@2) (state Heap@@38 Mask@2)))) (and (and (and (=> (= (ControlFlow 0 48) 47) anon43_Then_correct) (=> (= (ControlFlow 0 48) 33) anon43_Else_correct)) (=> (= (ControlFlow 0 48) 2) anon42_Then_correct)) (=> (= (ControlFlow 0 48) 4) anon42_Else_correct)))))))
(let ((anon0_correct  (=> (state Heap@@38 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@38 lock $allocated))) (and (=> (= (ControlFlow 0 56) 55) anon37_Then_correct) (=> (= (ControlFlow 0 56) 48) anon37_Else_correct))))))
