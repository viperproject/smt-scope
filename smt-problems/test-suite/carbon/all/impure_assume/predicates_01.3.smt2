...
(declare-fun i@@5 () Int)
(assert  (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type x@@14) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test00_same_tight_three_right_leaning)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x@@14 $allocated))) (and (= Mask@0 (MapType1Store ZeroMask null (P x@@14 i@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@14 i@@5))) FullPerm)))) (state Heap@@10 Mask@0))) (and (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (<= (/ (to_real 3) (to_real 6)) (U_2_real (MapType1Select Mask@0 null (P x@@14 i@@5)))) (state Heap@@10 Mask@0)))) (and (and (and (state Heap@@10 Mask@0) (<= (__iar__assume_helper_1  (and (= x@@14 x@@14) (= i@@5 i@@5)) (/ (to_real 3) (to_real 6)) (/ (to_real 2) (to_real 6))) (U_2_real (MapType1Select Mask@0 null (P x@@14 i@@5))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (and (<= (__iar__assume_helper_2  (and (= x@@14 x@@14) (= i@@5 i@@5))  (and (= x@@14 x@@14) (= i@@5 i@@5)) (/ (to_real 3) (to_real 6)) (/ (to_real 2) (to_real 6)) (/ (to_real 1) (to_real 6))) (U_2_real (MapType1Select Mask@0 null (P x@@14 i@@5)))) (state Heap@@10 Mask@0)) (and (state Heap@@10 Mask@0) (= (ControlFlow 0 2) (- 0 1)))))) false)))
