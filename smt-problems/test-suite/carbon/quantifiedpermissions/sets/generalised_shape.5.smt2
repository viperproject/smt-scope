...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type xs@@8) (MapType2Type RefType boolType)) (= (type ys@@8) (MapType2Type RefType boolType))) (= (type Heap@1) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv31 arg0@@48)) RefType)
 :qid |funType:invRecv31|
 :pattern ( (invRecv31 arg0@@48))
))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@49 T@U) ) (! (= (type (invRecv32 arg0@@49)) RefType)
 :qid |funType:invRecv32|
 :pattern ( (invRecv32 arg0@@49))
))) (forall ((arg0@@50 T@U) ) (! (= (type (invRecv33 arg0@@50)) RefType)
 :qid |funType:invRecv33|
 :pattern ( (invRecv33 arg0@@50))
))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type x@@19) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@0) (MapType1Type RefType realType))) (forall ((arg0@@51 T@U) (arg1@@28 T@U) ) (! (= (type (CombineFrames arg0@@51 arg1@@28)) FrameTypeType)
...
)) (=> (and (forall ((x$0@@1 T@U) ) (!  (=> (= (type x$0@@1) RefType) (=> (and (and (U_2_bool (MapType2Select xs@@8 x$0@@1)) (not (U_2_bool (MapType2Select ys@@8 x$0@@1)))) (< NoPerm FullPerm)) (and (qpRange31 x$0@@1) (= (invRecv31 x$0@@1) x$0@@1))))
 :qid |stdinbpl.2823:22|
 :skolemid |286|
...
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (U_2_bool (MapType2Select xs@@8 (invRecv31 o_3))) (not (U_2_bool (MapType2Select ys@@8 (invRecv31 o_3))))) (< NoPerm FullPerm)) (qpRange31 o_3)) (= (invRecv31 o_3) o_3)))
 :qid |stdinbpl.2827:22|
 :skolemid |287|
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (U_2_bool (MapType2Select xs@@8 (invRecv31 o_3@@0))) (not (U_2_bool (MapType2Select ys@@8 (invRecv31 o_3@@0))))) (< NoPerm FullPerm)) (qpRange31 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv31 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select Mask@1 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (and (U_2_bool (MapType2Select xs@@8 (invRecv31 o_3@@0))) (not (U_2_bool (MapType2Select ys@@8 (invRecv31 o_3@@0))))) (< NoPerm FullPerm)) (qpRange31 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select Mask@1 o_3@@0 f_7))))))
...
)) (=> (forall ((x$0_1@@1 T@U) ) (!  (=> (= (type x$0_1@@1) RefType) (=> (and (and (U_2_bool (MapType2Select xs@@8 x$0_1@@1)) (and (not (U_2_bool (MapType2Select ys@@8 x$0_1@@1))) (not (= (U_2_int (MapType0Select Heap@1 x$0_1@@1 f_7)) 0)))) (< NoPerm FullPerm)) (and (qpRange32 x$0_1@@1) (= (invRecv32 x$0_1@@1) x$0_1@@1))))
...
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (U_2_bool (MapType2Select xs@@8 (invRecv32 o_3@@2))) (and (not (U_2_bool (MapType2Select ys@@8 (invRecv32 o_3@@2)))) (not (= (U_2_int (MapType0Select Heap@1 (invRecv32 o_3@@2) f_7)) 0)))) (< NoPerm FullPerm)) (qpRange32 o_3@@2)) (= (invRecv32 o_3@@2) o_3@@2)))
...
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (and (U_2_bool (MapType2Select xs@@8 (invRecv32 o_3@@3))) (and (not (U_2_bool (MapType2Select ys@@8 (invRecv32 o_3@@3)))) (not (= (U_2_int (MapType0Select Heap@1 (invRecv32 o_3@@3) f_7)) 0)))) (< NoPerm FullPerm)) (qpRange32 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv32 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 g)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@3 g)) FullPerm)))) (=> (not (and (and (and (U_2_bool (MapType2Select xs@@8 (invRecv32 o_3@@3))) (and (not (U_2_bool (MapType2Select ys@@8 (invRecv32 o_3@@3)))) (not (= (U_2_int (MapType0Select Heap@1 (invRecv32 o_3@@3) f_7)) 0)))) (< NoPerm FullPerm)) (qpRange32 o_3@@3))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 g)) (U_2_real (MapType1Select QPMask@0 o_3@@3 g))))))
...
)) (=> (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (and (U_2_bool (MapType2Select xs@@8 (invRecv33 o_3@@5))) (and (not (U_2_bool (MapType2Select ys@@8 (invRecv33 o_3@@5)))) (and (not (= (U_2_int (MapType0Select Heap@1 (invRecv33 o_3@@5) f_7)) 0)) (not (U_2_bool (MapType2Select xs@@8 (MapType0Select Heap@1 (invRecv33 o_3@@5) g))))))) (< NoPerm FullPerm)) (qpRange33 o_3@@5)) (= (MapType0Select Heap@1 (invRecv33 o_3@@5) g) o_3@@5)))
 :qid |stdinbpl.2899:22|
 :skolemid |300|
...
))) (=> (and (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (and (U_2_bool (MapType2Select xs@@8 (invRecv33 o_3@@6))) (and (not (U_2_bool (MapType2Select ys@@8 (invRecv33 o_3@@6)))) (and (not (= (U_2_int (MapType0Select Heap@1 (invRecv33 o_3@@6) f_7)) 0)) (not (U_2_bool (MapType2Select xs@@8 (MapType0Select Heap@1 (invRecv33 o_3@@6) g))))))) (< NoPerm FullPerm)) (qpRange33 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (MapType0Select Heap@1 (invRecv33 o_3@@6) g) o_3@@6)) (= (U_2_real (MapType1Select QPMask@2 o_3@@6 f_7)) (+ (U_2_real (MapType1Select QPMask@1 o_3@@6 f_7)) FullPerm)))) (=> (not (and (and (and (U_2_bool (MapType2Select xs@@8 (invRecv33 o_3@@6))) (and (not (U_2_bool (MapType2Select ys@@8 (invRecv33 o_3@@6)))) (and (not (= (U_2_int (MapType0Select Heap@1 (invRecv33 o_3@@6) f_7)) 0)) (not (U_2_bool (MapType2Select xs@@8 (MapType0Select Heap@1 (invRecv33 o_3@@6) g))))))) (< NoPerm FullPerm)) (qpRange33 o_3@@6))) (= (U_2_real (MapType1Select QPMask@2 o_3@@6 f_7)) (U_2_real (MapType1Select QPMask@1 o_3@@6 f_7))))))
...
(let ((A@@14 (FieldTypeInv0 (type f_5@@1))))
 ...
 :qid |stdinbpl.2915:29|
 :skolemid |303|
 :pattern ( (MapType1Select QPMask@1 o_3@@7 f_5@@1))
 :pattern ( (MapType1Select QPMask@2 o_3@@7 f_5@@1))
))) (and (state Heap@1 QPMask@2) (state Heap@1 QPMask@2))) (=> (and (and (and (state Heap@1 QPMask@2) (U_2_bool (MapType2Select xs@@8 x@@19))) (and (state Heap@1 QPMask@2) (state Heap@1 QPMask@2))) (and (and (not (= x@@19 null)) (state Heap@1 QPMask@2)) (and (state Heap@1 QPMask@2) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm QPMask@2 x@@19 f_7))))))))))))))))))
(let ((anon6_Else_correct  (=> (HasDirectPerm Mask@1 null (P xs@@8 ys@@8)) (=> (and (= Heap@1 Heap@@10) (= (ControlFlow 0 7) 2)) anon4_correct))))
(let ((anon6_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (P xs@@8 ys@@8))) (= Heap@0 (MapType0Store Heap@@10 null (P xs@@8 ys@@8) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 6) 2))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (P xs@@8 ys@@8) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P xs@@8 ys@@8))) FullPerm)))) (and (=> (= (ControlFlow 0 8) 6) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P xs@@8 ys@@8))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P xs@@8 ys@@8)))) (=> (= (ControlFlow 0 9) 8) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 x@@19 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (P xs@@8 ys@@8) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P xs@@8 ys@@8))) FullPerm))))) (=> (and (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (|P#trigger| Heap@@10 (P xs@@8 ys@@8)) (= (MapType0Select Heap@@10 null (P xs@@8 ys@@8)) (CombineFrames (FrameFragment (int_2_U (|P#condqp1| Heap@@10 xs@@8 ys@@8))) (CombineFrames (FrameFragment (int_2_U (|P#condqp2| Heap@@10 xs@@8 ys@@8))) (FrameFragment (int_2_U (|P#condqp3| Heap@@10 xs@@8 ys@@8)))))))) (and (=> (= (ControlFlow 0 12) 9) anon5_Then_correct) (=> (= (ControlFlow 0 12) 11) anon5_Else_correct)))))))
