...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type S) (MapType2Type RefType boolType)) (= (type u_1) RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type T@@56) (MapType2Type RefType boolType))) (= (type v_2) RefType)) (= (type y_2) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv5 arg0@@43)) RefType)
 :qid |funType:invRecv5|
 :pattern ( (invRecv5 arg0@@43))
))) (= (type y@@6) RefType)) (= (type QPMask@3) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv4 arg0@@44)) RefType)
 :qid |funType:invRecv4|
 :pattern ( (invRecv4 arg0@@44))
))) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv3 arg0@@45)) RefType)
 :qid |funType:invRecv3|
 :pattern ( (invRecv3 arg0@@45))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@46 T@U) ) (! (= (type (invRecv2 arg0@@46)) RefType)
...
(let ((anon34_Else_correct  (=> (and (not (U_2_bool (MapType2Select (|Set#Union| T@@56 S) y@@6))) (= (ControlFlow 0 24) 21)) anon18_correct)))
(let ((anon34_Then_correct  (=> (U_2_bool (MapType2Select (|Set#Union| T@@56 S) y@@6)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (HasDirectPerm QPMask@3 y@@6 f_7)) (=> (HasDirectPerm QPMask@3 y@@6 f_7) (=> (= (ControlFlow 0 22) 21) anon18_correct))))))
(let ((anon33_Else_correct true))
(let ((anon32_Else_correct  (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select (|Set#Union| T@@56 S) x_1))) (U_2_bool (MapType2Select (|Set#Union| T@@56 S) x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.743:15|
 :skolemid |103|
 :no-pattern (type x_1)
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (U_2_bool (MapType2Select (|Set#Union| T@@56 S) x_1@@0))) (U_2_bool (MapType2Select (|Set#Union| T@@56 S) x_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.743:15|
 :skolemid |103|
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Union| T@@56 S) x_1@@1)) (< NoPerm FullPerm)) (and (qpRange4 x_1@@1) (= (invRecv4 x_1@@1) x_1@@1))))
 :qid |stdinbpl.749:22|
 :skolemid |104|
 :pattern ( (MapType0Select PostHeap@0 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@3 x_1@@1 f_7))
 :pattern ( (MapType2Select (|Set#Union| T@@56 S) x_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select (|Set#Union| T@@56 S) (invRecv4 o_3))) (< NoPerm FullPerm)) (qpRange4 o_3)) (= (invRecv4 o_3) o_3)))
 :qid |stdinbpl.753:22|
 :skolemid |105|
 :pattern ( (invRecv4 o_3))
)) (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (U_2_bool (MapType2Select (|Set#Union| T@@56 S) x_1@@2))) (not (= x_1@@2 null)))
 :qid |stdinbpl.759:22|
 :skolemid |106|
 :pattern ( (MapType0Select PostHeap@0 x_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@3 x_1@@2 f_7))
 :pattern ( (MapType2Select (|Set#Union| T@@56 S) x_1@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select (|Set#Union| T@@56 S) (invRecv4 o_3@@0))) (< NoPerm FullPerm)) (qpRange4 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@3 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select (|Set#Union| T@@56 S) (invRecv4 o_3@@0))) (< NoPerm FullPerm)) (qpRange4 o_3@@0))) (= (U_2_real (MapType1Select QPMask@3 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.765:22|
 :skolemid |107|
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 f_7))) (= (U_2_real (MapType1Select ZeroMask o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@3 o_3@@1 f_5))))))
 :qid |stdinbpl.769:29|
 :skolemid |108|
 :pattern ( (MapType1Select ZeroMask o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@3 o_3@@1 f_5))
))) (and (state PostHeap@0 QPMask@3) (state PostHeap@0 QPMask@3))) (and (and (=> (= (ControlFlow 0 25) 20) anon33_Else_correct) (=> (= (ControlFlow 0 25) 22) anon34_Then_correct)) (=> (= (ControlFlow 0 25) 24) anon34_Else_correct)))))))))
(let ((anon32_Then_correct true))
(let ((anon31_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 27) 19) anon32_Then_correct) (=> (= (ControlFlow 0 27) 25) anon32_Else_correct)))))
(let ((anon23_correct true))
(let ((anon36_Else_correct  (=> (and (not (U_2_bool (MapType2Select (|Set#Union| T@@56 S) y_2))) (= (ControlFlow 0 15) 12)) anon23_correct)))
(let ((anon36_Then_correct  (=> (U_2_bool (MapType2Select (|Set#Union| T@@56 S) y_2)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (> (U_2_int (MapType0Select Heap@@9 y_2 f_7)) 0)) (=> (> (U_2_int (MapType0Select Heap@@9 y_2 f_7)) 0) (=> (= (ControlFlow 0 13) 12) anon23_correct))))))
(let ((anon35_Else_correct true))
(let ((anon31_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 18)) (forall ((x_2 T@U) (x_2_1 T@U) ) (!  (=> (and (= (type x_2) RefType) (= (type x_2_1) RefType)) (=> (and (and (and (and (not (= x_2 x_2_1)) (U_2_bool (MapType2Select (|Set#Union| T@@56 S) x_2))) (U_2_bool (MapType2Select (|Set#Union| T@@56 S) x_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_2 x_2_1))))
 :qid |stdinbpl.804:17|
 :skolemid |110|
 :pattern ( (neverTriggered5 x_2) (neverTriggered5 x_2_1))
))) (=> (forall ((x_2@@0 T@U) (x_2_1@@0 T@U) ) (!  (=> (and (= (type x_2@@0) RefType) (= (type x_2_1@@0) RefType)) (=> (and (and (and (and (not (= x_2@@0 x_2_1@@0)) (U_2_bool (MapType2Select (|Set#Union| T@@56 S) x_2@@0))) (U_2_bool (MapType2Select (|Set#Union| T@@56 S) x_2_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_2@@0 x_2_1@@0))))
 :qid |stdinbpl.804:17|
 :skolemid |110|
 :pattern ( (neverTriggered5 x_2@@0) (neverTriggered5 x_2_1@@0))
)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((x_2@@1 T@U) ) (!  (=> (and (= (type x_2@@1) RefType) (U_2_bool (MapType2Select (|Set#Union| T@@56 S) x_2@@1))) (>= (U_2_real (MapType1Select QPMask@1 x_2@@1 f_7)) FullPerm))
 :qid |stdinbpl.811:17|
 :skolemid |111|
 :pattern ( (MapType0Select Heap@@9 x_2@@1 f_7))
 :pattern ( (MapType1Select QPMask@2 x_2@@1 f_7))
 :pattern ( (MapType2Select (|Set#Union| T@@56 S) x_2@@1))
))) (=> (forall ((x_2@@2 T@U) ) (!  (=> (and (= (type x_2@@2) RefType) (U_2_bool (MapType2Select (|Set#Union| T@@56 S) x_2@@2))) (>= (U_2_real (MapType1Select QPMask@1 x_2@@2 f_7)) FullPerm))
 :qid |stdinbpl.811:17|
 :skolemid |111|
 :pattern ( (MapType0Select Heap@@9 x_2@@2 f_7))
 :pattern ( (MapType1Select QPMask@2 x_2@@2 f_7))
 :pattern ( (MapType2Select (|Set#Union| T@@56 S) x_2@@2))
)) (=> (and (and (forall ((x_2@@3 T@U) ) (!  (=> (= (type x_2@@3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Union| T@@56 S) x_2@@3)) (< NoPerm FullPerm)) (and (qpRange5 x_2@@3) (= (invRecv5 x_2@@3) x_2@@3))))
 :qid |stdinbpl.817:22|
 :skolemid |112|
 :pattern ( (MapType0Select Heap@@9 x_2@@3 f_7))
 :pattern ( (MapType1Select QPMask@2 x_2@@3 f_7))
 :pattern ( (MapType2Select (|Set#Union| T@@56 S) x_2@@3))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Union| T@@56 S) (invRecv5 o_3@@2))) (and (< NoPerm FullPerm) (qpRange5 o_3@@2))) (= (invRecv5 o_3@@2) o_3@@2)))
 :qid |stdinbpl.821:22|
 :skolemid |113|
 :pattern ( (invRecv5 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType2Select (|Set#Union| T@@56 S) (invRecv5 o_3@@3))) (and (< NoPerm FullPerm) (qpRange5 o_3@@3))) (and (= (invRecv5 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@2 o_3@@3 f_7)) (- (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select (|Set#Union| T@@56 S) (invRecv5 o_3@@3))) (and (< NoPerm FullPerm) (qpRange5 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@2 o_3@@3 f_7)) (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7))))))
 :qid |stdinbpl.827:22|
 :skolemid |114|
...
)))) (and (and (=> (= (ControlFlow 0 16) 11) anon35_Else_correct) (=> (= (ControlFlow 0 16) 13) anon36_Then_correct)) (=> (= (ControlFlow 0 16) 15) anon36_Else_correct)))))))))
(let ((anon29_Else_correct  (=> (and (forall ((v_1_1 T@U) ) (!  (=> (and (= (type v_1_1) RefType) (U_2_bool (MapType2Select T@@56 v_1_1))) (> (U_2_int (MapType0Select Heap@@9 v_1_1 f_7)) 0))
 :qid |stdinbpl.720:20|
 :skolemid |102|
 :pattern ( (MapType2Select T@@56 v_1_1))
)) (state Heap@@9 QPMask@1)) (and (=> (= (ControlFlow 0 28) 27) anon31_Then_correct) (=> (= (ControlFlow 0 28) 16) anon31_Else_correct)))))
(let ((anon11_correct true))
(let ((anon30_Else_correct  (=> (and (not (U_2_bool (MapType2Select T@@56 v_2))) (= (ControlFlow 0 10) 7)) anon11_correct)))
(let ((anon30_Then_correct  (=> (U_2_bool (MapType2Select T@@56 v_2)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm QPMask@1 v_2 f_7)) (=> (HasDirectPerm QPMask@1 v_2 f_7) (=> (= (ControlFlow 0 8) 7) anon11_correct))))))
(let ((anon27_Else_correct  (=> (and (forall ((u_1_1 T@U) ) (!  (=> (and (= (type u_1_1) RefType) (U_2_bool (MapType2Select S u_1_1))) (> (U_2_int (MapType0Select Heap@@9 u_1_1 f_7)) 0))
 :qid |stdinbpl.706:20|
 :skolemid |101|
 :pattern ( (MapType2Select S u_1_1))
)) (state Heap@@9 QPMask@1)) (and (and (=> (= (ControlFlow 0 29) 28) anon29_Else_correct) (=> (= (ControlFlow 0 29) 8) anon30_Then_correct)) (=> (= (ControlFlow 0 29) 10) anon30_Else_correct)))))
(let ((anon7_correct true))
(let ((anon28_Else_correct  (=> (and (not (U_2_bool (MapType2Select S u_1))) (= (ControlFlow 0 6) 3)) anon7_correct)))
(let ((anon28_Then_correct  (=> (U_2_bool (MapType2Select S u_1)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm QPMask@1 u_1 f_7)) (=> (HasDirectPerm QPMask@1 u_1 f_7) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
(let ((anon26_Else_correct  (and (=> (= (ControlFlow 0 30) (- 0 31)) (forall ((t_1 T@U) (t_1_1 T@U) ) (!  (=> (and (= (type t_1) RefType) (= (type t_1_1) RefType)) (=> (and (and (and (and (not (= t_1 t_1_1)) (U_2_bool (MapType2Select T@@56 t_1))) (U_2_bool (MapType2Select T@@56 t_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= t_1 t_1_1))))
 :qid |stdinbpl.664:15|
 :skolemid |95|
 :no-pattern (type t_1)
 :no-pattern (type t_1_1)
 :no-pattern (U_2_int t_1)
 :no-pattern (U_2_bool t_1)
 :no-pattern (U_2_int t_1_1)
 :no-pattern (U_2_bool t_1_1)
))) (=> (forall ((t_1@@0 T@U) (t_1_1@@0 T@U) ) (!  (=> (and (= (type t_1@@0) RefType) (= (type t_1_1@@0) RefType)) (=> (and (and (and (and (not (= t_1@@0 t_1_1@@0)) (U_2_bool (MapType2Select T@@56 t_1@@0))) (U_2_bool (MapType2Select T@@56 t_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= t_1@@0 t_1_1@@0))))
 :qid |stdinbpl.664:15|
 :skolemid |95|
 :no-pattern (type t_1@@0)
 :no-pattern (type t_1_1@@0)
 :no-pattern (U_2_int t_1@@0)
 :no-pattern (U_2_bool t_1@@0)
 :no-pattern (U_2_int t_1_1@@0)
 :no-pattern (U_2_bool t_1_1@@0)
)) (=> (forall ((t_1@@1 T@U) ) (!  (=> (= (type t_1@@1) RefType) (=> (and (U_2_bool (MapType2Select T@@56 t_1@@1)) (< NoPerm FullPerm)) (and (qpRange3 t_1@@1) (= (invRecv3 t_1@@1) t_1@@1))))
 :qid |stdinbpl.670:22|
 :skolemid |96|
 :pattern ( (MapType0Select Heap@@9 t_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 t_1@@1 f_7))
 :pattern ( (MapType2Select T@@56 t_1@@1))
)) (=> (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (U_2_bool (MapType2Select T@@56 (invRecv3 o_3@@5))) (< NoPerm FullPerm)) (qpRange3 o_3@@5)) (= (invRecv3 o_3@@5) o_3@@5)))
 :qid |stdinbpl.674:22|
 :skolemid |97|
 :pattern ( (invRecv3 o_3@@5))
)) (forall ((t_1@@2 T@U) ) (!  (=> (and (= (type t_1@@2) RefType) (U_2_bool (MapType2Select T@@56 t_1@@2))) (not (= t_1@@2 null)))
 :qid |stdinbpl.680:22|
 :skolemid |98|
 :pattern ( (MapType0Select Heap@@9 t_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@1 t_1@@2 f_7))
 :pattern ( (MapType2Select T@@56 t_1@@2))
))) (=> (and (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (U_2_bool (MapType2Select T@@56 (invRecv3 o_3@@6))) (< NoPerm FullPerm)) (qpRange3 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_3@@6) o_3@@6)) (= (U_2_real (MapType1Select QPMask@1 o_3@@6 f_7)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select T@@56 (invRecv3 o_3@@6))) (< NoPerm FullPerm)) (qpRange3 o_3@@6))) (= (U_2_real (MapType1Select QPMask@1 o_3@@6 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7))))))
 :qid |stdinbpl.686:22|
 :skolemid |99|
...
))) (and (state Heap@@9 QPMask@1) (state Heap@@9 QPMask@1))) (and (and (=> (= (ControlFlow 0 30) 29) anon27_Else_correct) (=> (= (ControlFlow 0 30) 4) anon28_Then_correct)) (=> (= (ControlFlow 0 30) 6) anon28_Else_correct)))))))))
(let ((anon26_Then_correct true))
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 32) (- 0 33)) (forall ((s_1 T@U) (s_1_1 T@U) ) (!  (=> (and (= (type s_1) RefType) (= (type s_1_1) RefType)) (=> (and (and (and (and (not (= s_1 s_1_1)) (U_2_bool (MapType2Select S s_1))) (U_2_bool (MapType2Select S s_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1 s_1_1))))
 :qid |stdinbpl.624:15|
 :skolemid |89|
 :no-pattern (type s_1)
...
)) (=> (forall ((s_1@@1 T@U) ) (!  (=> (= (type s_1@@1) RefType) (=> (and (U_2_bool (MapType2Select S s_1@@1)) (< NoPerm FullPerm)) (and (qpRange2 s_1@@1) (= (invRecv2 s_1@@1) s_1@@1))))
 :qid |stdinbpl.630:22|
 :skolemid |90|
 :pattern ( (MapType0Select Heap@@9 s_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 s_1@@1 f_7))
 :pattern ( (MapType2Select S s_1@@1))
)) (=> (and (forall ((o_3@@8 T@U) ) (!  (=> (= (type o_3@@8) RefType) (=> (and (and (U_2_bool (MapType2Select S (invRecv2 o_3@@8))) (< NoPerm FullPerm)) (qpRange2 o_3@@8)) (= (invRecv2 o_3@@8) o_3@@8)))
 :qid |stdinbpl.634:22|
 :skolemid |91|
 :pattern ( (invRecv2 o_3@@8))
...
))) (=> (and (and (forall ((o_3@@9 T@U) ) (!  (=> (= (type o_3@@9) RefType) (and (=> (and (and (U_2_bool (MapType2Select S (invRecv2 o_3@@9))) (< NoPerm FullPerm)) (qpRange2 o_3@@9)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@9) o_3@@9)) (= (U_2_real (MapType1Select QPMask@0 o_3@@9 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@9 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select S (invRecv2 o_3@@9))) (< NoPerm FullPerm)) (qpRange2 o_3@@9))) (= (U_2_real (MapType1Select QPMask@0 o_3@@9 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@9 f_7))))))
 :qid |stdinbpl.646:22|
 :skolemid |93|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 32) 2) anon26_Then_correct) (=> (= (ControlFlow 0 32) 30) anon26_Else_correct)))))))))
(let ((anon25_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 34) 1) anon25_Then_correct) (=> (= (ControlFlow 0 34) 32) anon25_Else_correct)))))
