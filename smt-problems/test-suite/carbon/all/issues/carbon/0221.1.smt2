...
(assert  (and (and (= (type x@@12) RefType) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@13) (MapType0Type RefType))))
(set-info :boogie-vc-id |foo#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (not (= x@@12 null)) (=> (and (and (= Mask@1 (MapType1Store ZeroMask x@@12 val (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@12 val)) FullPerm)))) (state Heap@@13 Mask@1)) (and (state Heap@@13 Mask@1) (= (ControlFlow 0 3) (- 0 2)))) (HasDirectPerm Mask@1 x@@12 val)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@13 x@@12 $allocated)) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
