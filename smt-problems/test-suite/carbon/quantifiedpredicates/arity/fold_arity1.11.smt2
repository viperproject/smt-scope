...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@3) (MapType1Type RefType realType)) (= (type x@@11) RefType)) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (FrameFragment arg0@@43)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@43))
))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@14) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type xs) (SeqType RefType))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv3 arg0@@44)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((anon14_correct true))
(let ((anon21_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon14_correct)))
(let ((anon21_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@3 null (p3 x@@11))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 null (p3 x@@11)))) (=> (= (ControlFlow 0 4) 3) anon14_correct))))))
(let ((anon12_correct  (=> (= Heap@5 (MapType0Store Heap@4 null (|p3#sm| x@@11) (MapType1Store (MapType0Select Heap@4 null (|p3#sm| x@@11)) x@@11 f_7 (bool_2_U true)))) (=> (and (state Heap@5 Mask@3) (state Heap@5 Mask@3)) (and (=> (= (ControlFlow 0 7) 4) anon21_Then_correct) (=> (= (ControlFlow 0 7) 6) anon21_Else_correct))))))
(let ((anon20_Else_correct  (=> (HasDirectPerm Mask@3 null (p3 x@@11)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 9) 7)) anon12_correct))))
(let ((anon20_Then_correct  (=> (not (HasDirectPerm Mask@3 null (p3 x@@11))) (=> (and (and (= Heap@2 (MapType0Store Heap@1 null (|p3#sm| x@@11) ZeroPMask)) (= Heap@3 (MapType0Store Heap@2 null (p3 x@@11) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 8) 7))) anon12_correct))))
(let ((anon10_correct  (=> (= Mask@2 (MapType1Store Mask@1 x@@11 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 x@@11 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (= (U_2_int (MapType0Select Heap@1 x@@11 f_7)) 0)) (=> (= (U_2_int (MapType0Select Heap@1 x@@11 f_7)) 0) (=> (= Mask@3 (MapType1Store Mask@2 null (p3 x@@11) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (p3 x@@11))) FullPerm)))) (=> (and (and (state Heap@1 Mask@3) (state Heap@1 Mask@3)) (and (|p3#trigger| Heap@1 (p3 x@@11)) (= (MapType0Select Heap@1 null (p3 x@@11)) (FrameFragment (MapType0Select Heap@1 x@@11 f_7))))) (and (=> (= (ControlFlow 0 10) 8) anon20_Then_correct) (=> (= (ControlFlow 0 10) 9) anon20_Else_correct)))))))))
(let ((anon19_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 14) 10)) anon10_correct)))
(let ((anon19_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@11 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@11 f_7))) (=> (= (ControlFlow 0 12) 10) anon10_correct))))))
(let ((anon8_correct  (=> (and (not (= x@@11 null)) (= Mask@1 (MapType1Store Mask@0 x@@11 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@11 f_7)) FullPerm))))) (=> (and (and (state Heap@1 Mask@1) (= (U_2_int (MapType0Select Heap@1 x@@11 f_7)) 0)) (and (state Heap@1 Mask@1) (state Heap@1 Mask@1))) (and (=> (= (ControlFlow 0 15) (- 0 17)) (HasDirectPerm Mask@1 x@@11 f_7)) (=> (HasDirectPerm Mask@1 x@@11 f_7) (and (=> (= (ControlFlow 0 15) (- 0 16)) (= (U_2_int (MapType0Select Heap@1 x@@11 f_7)) 0)) (=> (= (U_2_int (MapType0Select Heap@1 x@@11 f_7)) 0) (=> (state Heap@1 Mask@1) (and (=> (= (ControlFlow 0 15) 12) anon19_Then_correct) (=> (= (ControlFlow 0 15) 14) anon19_Else_correct)))))))))))
(let ((anon18_Else_correct  (=> (HasDirectPerm Mask@0 null (p3 x@@11)) (=> (and (= Heap@1 Heap@@14) (= (ControlFlow 0 19) 15)) anon8_correct))))
(let ((anon18_Then_correct  (=> (and (and (not (HasDirectPerm Mask@0 null (p3 x@@11))) (= Heap@0 (MapType0Store Heap@@14 null (p3 x@@11) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 18) 15))) anon8_correct)))
(let ((anon6_correct  (=> (= Mask@0 (MapType1Store QPMask@0 null (p3 x@@11) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (p3 x@@11))) FullPerm)))) (and (=> (= (ControlFlow 0 20) 18) anon18_Then_correct) (=> (= (ControlFlow 0 20) 19) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 23) 20)) anon6_correct)))
(let ((anon17_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p3 x@@11))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p3 x@@11)))) (=> (= (ControlFlow 0 21) 20) anon6_correct))))))
(let ((anon16_Else_correct  (=> (and (|p3#trigger| Heap@@14 (p3 x@@11)) (= (MapType0Select Heap@@14 null (p3 x@@11)) (FrameFragment (MapType0Select Heap@@14 x@@11 f_7)))) (and (=> (= (ControlFlow 0 24) 21) anon17_Then_correct) (=> (= (ControlFlow 0 24) 23) anon17_Else_correct)))))
(let ((anon16_Then_correct true))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (|Seq#Contains| xs r_1)) (|Seq#Contains| xs r_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1 r_1_1))))
...
)) (=> (and (forall ((r_2_1 T@U) ) (!  (=> (= (type r_2_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv3 r_2_1)) (< NoPerm FullPerm)) (qpRange3 r_2_1)) (= (invRecv3 r_2_1) r_2_1)))
...
))) (and (state Heap@@14 QPMask@0) (state Heap@@14 QPMask@0))) (and (=> (= (ControlFlow 0 25) 2) anon16_Then_correct) (=> (= (ControlFlow 0 25) 24) anon16_Else_correct)))))))))
(let ((anon15_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@14 ZeroMask) (U_2_bool (MapType0Select Heap@@14 x@@11 $allocated))) (and (|Seq#Contains| xs x@@11) (state Heap@@14 ZeroMask))) (and (=> (= (ControlFlow 0 27) 1) anon15_Then_correct) (=> (= (ControlFlow 0 27) 25) anon15_Else_correct)))))
