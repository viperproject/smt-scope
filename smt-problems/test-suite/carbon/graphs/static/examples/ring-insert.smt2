...
(assert  (and (and (and (and (and (and (= (type refs@@6) (MapType2Type RefType boolType)) (= (type p_3) RefType)) (= (type s_3) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Result) (MapType2Type EdgeDomainTypeType boolType))) (= (type Heap@@24) (MapType0Type RefType))) (forall ((arg0@@58 T@U) ) (! (= (type (invRecv1 arg0@@58)) RefType)
...
(let ((anon16_Else_correct  (=> (and (forall ((p_6 T@U) (s_6 T@U) ) (!  (=> (and (and (= (type p_6) RefType) (= (type s_6) RefType)) (and (U_2_bool (MapType2Select refs@@6 p_6)) (exists_path Result p_6 s_6))) (U_2_bool (MapType2Select refs@@6 s_6)))
 :qid |stdinbpl.1046:20|
 :skolemid |128|
 :pattern ( (MapType2Select refs@@6 p_6) (MapType2Select refs@@6 s_6) (exists_path Result p_6 s_6))
)) (state Heap@@24 QPMask@0)) (and (=> (= (ControlFlow 0 11) 9) anon17_Then_correct) (=> (= (ControlFlow 0 11) 10) anon17_Else_correct)))))
(let ((anon16_Then_correct true))
(let ((anon13_Else_correct  (=> (and (forall ((p_4 T@U) (s_4 T@U) ) (!  (=> (and (= (type p_4) RefType) (= (type s_4) RefType)) (=  (and (U_2_bool (MapType2Select refs@@6 p_4)) (and (U_2_bool (MapType2Select refs@@6 s_4)) (and (= (MapType0Select Heap@@24 p_4 next) s_4) (not (= p_4 s_4))))) (U_2_bool (MapType2Select Result (create_edge p_4 s_4)))))
 :qid |stdinbpl.1036:20|
 :skolemid |127|
 :pattern ( (create_edge p_4 s_4))
)) (state Heap@@24 QPMask@0)) (and (=> (= (ControlFlow 0 12) 8) anon16_Then_correct) (=> (= (ControlFlow 0 12) 11) anon16_Else_correct)))))
(let ((anon6_correct true))
(let ((anon15_Else_correct  (=> (and (not (U_2_bool (MapType2Select refs@@6 s_3))) (= (ControlFlow 0 6) 2)) anon6_correct)))
(let ((anon15_Then_correct  (=> (U_2_bool (MapType2Select refs@@6 s_3)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm QPMask@0 p_3 next)) (=> (HasDirectPerm QPMask@0 p_3 next) (=> (= (ControlFlow 0 4) 2) anon6_correct))))))
(let ((anon14_Then_correct  (=> (U_2_bool (MapType2Select refs@@6 p_3)) (and (=> (= (ControlFlow 0 7) 4) anon15_Then_correct) (=> (= (ControlFlow 0 7) 6) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (not (U_2_bool (MapType2Select refs@@6 p_3))) (= (ControlFlow 0 3) 2)) anon6_correct)))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 15)) (forall ((n_3 T@U) (n_3_1 T@U) ) (!  (=> (and (= (type n_3) RefType) (= (type n_3_1) RefType)) (=> (and (and (and (and (not (= n_3 n_3_1)) (U_2_bool (MapType2Select refs@@6 n_3))) (U_2_bool (MapType2Select refs@@6 n_3_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_3 n_3_1))))
 :qid |stdinbpl.984:15|
 :skolemid |120|
 :no-pattern (type n_3)
...
))) (=> (forall ((n_3@@0 T@U) (n_3_1@@0 T@U) ) (!  (=> (and (= (type n_3@@0) RefType) (= (type n_3_1@@0) RefType)) (=> (and (and (and (and (not (= n_3@@0 n_3_1@@0)) (U_2_bool (MapType2Select refs@@6 n_3@@0))) (U_2_bool (MapType2Select refs@@6 n_3_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_3@@0 n_3_1@@0))))
 :qid |stdinbpl.984:15|
 :skolemid |120|
...
)) (=> (and (forall ((n_3@@1 T@U) ) (!  (=> (= (type n_3@@1) RefType) (=> (and (U_2_bool (MapType2Select refs@@6 n_3@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange1 n_3@@1) (= (invRecv1 n_3@@1) n_3@@1))))
 :qid |stdinbpl.990:22|
 :skolemid |121|
 :pattern ( (MapType0Select Heap@@24 n_3@@1 next))
 :pattern ( (MapType1Select QPMask@0 n_3@@1 next))
 :pattern ( (MapType0Select Heap@@24 n_3@@1 next))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select refs@@6 (invRecv1 o_3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.994:22|
 :skolemid |122|
 :pattern ( (invRecv1 o_3))
))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((n_3@@2 T@U) ) (!  (=> (and (= (type n_3@@2) RefType) (U_2_bool (MapType2Select refs@@6 n_3@@2))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1000:15|
 :skolemid |123|
 :pattern ( (MapType0Select Heap@@24 n_3@@2 next))
 :pattern ( (MapType1Select QPMask@0 n_3@@2 next))
 :pattern ( (MapType0Select Heap@@24 n_3@@2 next))
))) (=> (forall ((n_3@@3 T@U) ) (!  (=> (and (= (type n_3@@3) RefType) (U_2_bool (MapType2Select refs@@6 n_3@@3))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1000:15|
 :skolemid |123|
 :pattern ( (MapType0Select Heap@@24 n_3@@3 next))
 :pattern ( (MapType1Select QPMask@0 n_3@@3 next))
 :pattern ( (MapType0Select Heap@@24 n_3@@3 next))
)) (=> (forall ((n_3@@4 T@U) ) (!  (=> (= (type n_3@@4) RefType) (=> (and (U_2_bool (MapType2Select refs@@6 n_3@@4)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= n_3@@4 null))))
 :qid |stdinbpl.1006:22|
 :skolemid |124|
 :pattern ( (MapType0Select Heap@@24 n_3@@4 next))
 :pattern ( (MapType1Select QPMask@0 n_3@@4 next))
 :pattern ( (MapType0Select Heap@@24 n_3@@4 next))
)) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select refs@@6 (invRecv1 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_3@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv1 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 next)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (U_2_bool (MapType2Select refs@@6 (invRecv1 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (U_2_real (MapType1Select ZeroMask o_3@@0 next))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.1016:29|
 :skolemid |126|
 :pattern ( (MapType1Select ZeroMask o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
))) (and (state Heap@@24 QPMask@0) (state Heap@@24 QPMask@0))) (and (and (=> (= (ControlFlow 0 13) 12) anon13_Else_correct) (=> (= (ControlFlow 0 13) 7) anon14_Then_correct)) (=> (= (ControlFlow 0 13) 3) anon14_Else_correct)))))))))))
(let ((anon12_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@24 ZeroMask) (= AssumeFunctionsAbove 1)) (and (=> (= (ControlFlow 0 16) 1) anon12_Then_correct) (=> (= (ControlFlow 0 16) 13) anon12_Else_correct)))))
