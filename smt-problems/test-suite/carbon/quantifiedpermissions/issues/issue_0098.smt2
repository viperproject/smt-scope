...
(declare-fun a_2 () T@U)
(declare-fun b_2 () T@U)
(assert  (and (and (and (and (and (= (type s@@3) (MapType2Type RefType boolType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv1 arg0@@43)) RefType)
 :qid |funType:invRecv1|
 :pattern ( (invRecv1 arg0@@43))
))) (= (type a_2) RefType)) (= (type b_2) RefType)))
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm QPMask@0 a_2 f_7)) (=> (HasDirectPerm QPMask@0 a_2 f_7) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 b_2 f_7)) (=> (HasDirectPerm QPMask@0 b_2 f_7) (=> (= (ControlFlow 0 3) (- 0 2)) (= (U_2_int (MapType0Select Heap@@9 a_2 f_7)) (U_2_int (MapType0Select Heap@@9 b_2 f_7)))))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 a_2 $allocated))) (and (U_2_bool (MapType0Select Heap@@9 b_2 $allocated)) (|Set#Equal| s@@3 (|Set#UnionOne| (|Set#Singleton| b_2) a_2)))) (and (and (not (= a_2 null)) (not (= b_2 null))) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)))) (and (=> (= (ControlFlow 0 7) 1) anon3_Then_correct) (=> (= (ControlFlow 0 7) 3) anon3_Else_correct)))))
