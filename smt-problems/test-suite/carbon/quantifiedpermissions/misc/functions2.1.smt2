...
(assert  (and (and (and (and (and (= (type xs@@10) (MapType2Type RefType boolType)) (= (type Heap@@17) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type y@@12) RefType)) (= (type x@@22) RefType)) (forall ((arg0@@55 T@U) ) (! (= (type (invRecv1 arg0@@55)) RefType)
...
(let ((anon9_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs@@10 x@@22))) (= (ControlFlow 0 7) 4)) anon5_correct)))
(let ((anon9_Then_correct  (=> (U_2_bool (MapType2Select xs@@10 x@@22)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm QPMask@0 x@@22 f_7)) (=> (HasDirectPerm QPMask@0 x@@22 f_7) (=> (= (ControlFlow 0 5) 4) anon5_correct))))))
(let ((anon8_Else_correct  (=> (forall ((x_8 T@U) ) (!  (=> (and (= (type x_8) RefType) (U_2_bool (MapType2Select xs@@10 x_8))) (> (U_2_int (MapType0Select Heap@@17 x_8 f_7)) 0))
 :qid |stdinbpl.896:20|
 :skolemid |130|
 :pattern ( (MapType2Select xs@@10 x_8))
)) (=> (and (and (state Heap@@17 QPMask@0) (U_2_bool (MapType2Select xs@@10 y@@12))) (and (state Heap@@17 QPMask@0) (= (ControlFlow 0 3) (- 0 2)))) (HasDirectPerm QPMask@0 y@@12 f_7)))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (forall ((x_6 T@U) (x_6_1 T@U) ) (!  (=> (and (= (type x_6) RefType) (= (type x_6_1) RefType)) (=> (and (and (and (and (not (= x_6 x_6_1)) (U_2_bool (MapType2Select xs@@10 x_6))) (U_2_bool (MapType2Select xs@@10 x_6_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_6 x_6_1))))
 :qid |stdinbpl.854:15|
 :skolemid |124|
 :no-pattern (type x_6)
...
))) (=> (forall ((x_6@@0 T@U) (x_6_1@@0 T@U) ) (!  (=> (and (= (type x_6@@0) RefType) (= (type x_6_1@@0) RefType)) (=> (and (and (and (and (not (= x_6@@0 x_6_1@@0)) (U_2_bool (MapType2Select xs@@10 x_6@@0))) (U_2_bool (MapType2Select xs@@10 x_6_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_6@@0 x_6_1@@0))))
 :qid |stdinbpl.854:15|
 :skolemid |124|
...
)) (=> (forall ((x_6@@1 T@U) ) (!  (=> (= (type x_6@@1) RefType) (=> (and (U_2_bool (MapType2Select xs@@10 x_6@@1)) (< NoPerm FullPerm)) (and (qpRange1 x_6@@1) (= (invRecv1 x_6@@1) x_6@@1))))
 :qid |stdinbpl.860:22|
 :skolemid |125|
 :pattern ( (MapType0Select Heap@@17 x_6@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_6@@1 f_7))
 :pattern ( (MapType2Select xs@@10 x_6@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select xs@@10 (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.864:22|
 :skolemid |126|
 :pattern ( (invRecv1 o_3))
)) (forall ((x_6@@2 T@U) ) (!  (=> (and (= (type x_6@@2) RefType) (U_2_bool (MapType2Select xs@@10 x_6@@2))) (not (= x_6@@2 null)))
 :qid |stdinbpl.870:22|
 :skolemid |127|
 :pattern ( (MapType0Select Heap@@17 x_6@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 x_6@@2 f_7))
 :pattern ( (MapType2Select xs@@10 x_6@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs@@10 (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select xs@@10 (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.876:22|
 :skolemid |128|
...
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (and (=> (= (ControlFlow 0 8) 3) anon8_Else_correct) (=> (= (ControlFlow 0 8) 5) anon9_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct)))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@17 y@@12 $allocated)) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 10) 1) anon7_Then_correct) (=> (= (ControlFlow 0 10) 8) anon7_Else_correct))))))
