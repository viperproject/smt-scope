...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type f_7) (FieldType NormalFieldType intType))) (= (Ctor RefType) 8)) (= (type r_1) (FieldType NormalFieldType RefType))))
(assert (distinct $allocated f_7 r_1)
)
...
(declare-fun v_2 () T@U)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type xs) (MapType2Type RefType boolType)) (= (type x@@19) RefType)) (= (type y@@6) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type x_2) RefType)) (= (type x_4) RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type x_6) RefType)) (= (type y_2) RefType)) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv4 arg0@@43)) RefType)
 :qid |funType:invRecv4|
 :pattern ( (invRecv4 arg0@@43))
))) (= (type QPMask@3) (MapType1Type RefType realType))) (= (type a_2) RefType)) (= (type v_2@0) RefType)) (= (type x_8) RefType)) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv3 arg0@@44)) RefType)
...
))) (forall ((arg0@@46 T@U) ) (! (= (type (invRecv1 arg0@@46)) RefType)
...
(let ((anon33_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs x_8))) (= (ControlFlow 0 35) 31)) anon21_correct)))
(let ((anon33_Then_correct  (=> (U_2_bool (MapType2Select xs x_8)) (and (=> (= (ControlFlow 0 32) (- 0 34)) (HasDirectPerm QPMask@2 x_8 r_1)) (=> (HasDirectPerm QPMask@2 x_8 r_1) (and (=> (= (ControlFlow 0 32) (- 0 33)) (HasDirectPerm QPMask@2 (MapType0Select Heap@@9 x_8 r_1) r_1)) (=> (HasDirectPerm QPMask@2 (MapType0Select Heap@@9 x_8 r_1) r_1) (=> (= (ControlFlow 0 32) 31) anon21_correct))))))))
(let ((anon32_Else_correct  (and (=> (= (ControlFlow 0 23) (- 0 30)) (forall ((x_11 T@U) (x_11_1 T@U) ) (!  (=> (and (= (type x_11) RefType) (= (type x_11_1) RefType)) (=> (and (and (and (and (not (= x_11 x_11_1)) (U_2_bool (MapType2Select xs x_11))) (U_2_bool (MapType2Select xs x_11_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_11 r_1) r_1) (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_11_1 r_1) r_1)))))
 :qid |stdinbpl.634:15|
 :skolemid |102|
...
))) (=> (forall ((x_11@@0 T@U) (x_11_1@@0 T@U) ) (!  (=> (and (= (type x_11@@0) RefType) (= (type x_11_1@@0) RefType)) (=> (and (and (and (and (not (= x_11@@0 x_11_1@@0)) (U_2_bool (MapType2Select xs x_11@@0))) (U_2_bool (MapType2Select xs x_11_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_11@@0 r_1) r_1) (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_11_1@@0 r_1) r_1)))))
 :qid |stdinbpl.634:15|
 :skolemid |102|
...
)) (=> (forall ((x_11@@1 T@U) ) (!  (=> (= (type x_11@@1) RefType) (=> (and (U_2_bool (MapType2Select xs x_11@@1)) (< NoPerm FullPerm)) (and (qpRange4 (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_11@@1 r_1) r_1)) (= (invRecv4 (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_11@@1 r_1) r_1)) x_11@@1))))
 :qid |stdinbpl.640:22|
 :skolemid |103|
 :pattern ( (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_11@@1 r_1) r_1))
 :pattern ( (MapType0Select Heap@@9 (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_11@@1 r_1) r_1) f_7))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv4 o_3))) (< NoPerm FullPerm)) (qpRange4 o_3)) (= (MapType0Select Heap@@9 (MapType0Select Heap@@9 (invRecv4 o_3) r_1) r_1) o_3)))
 :qid |stdinbpl.644:22|
 :skolemid |104|
 :pattern ( (invRecv4 o_3))
)) (forall ((x_11@@2 T@U) ) (!  (=> (and (= (type x_11@@2) RefType) (U_2_bool (MapType2Select xs x_11@@2))) (not (= (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_11@@2 r_1) r_1) null)))
 :qid |stdinbpl.650:22|
 :skolemid |105|
 :pattern ( (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_11@@2 r_1) r_1))
 :pattern ( (MapType0Select Heap@@9 (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_11@@2 r_1) r_1) f_7))
))) (=> (and (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs (invRecv4 o_3@@0))) (< NoPerm FullPerm)) (qpRange4 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (MapType0Select Heap@@9 (MapType0Select Heap@@9 (invRecv4 o_3@@0) r_1) r_1) o_3@@0)) (= (U_2_real (MapType1Select QPMask@3 o_3@@0 f_7)) (+ (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select xs (invRecv4 o_3@@0))) (< NoPerm FullPerm)) (qpRange4 o_3@@0))) (= (U_2_real (MapType1Select QPMask@3 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7))))))
 :qid |stdinbpl.656:22|
 :skolemid |106|
...
))) (and (state Heap@@9 QPMask@3) (state Heap@@9 QPMask@3))) (and (and (state Heap@@9 QPMask@3) (U_2_bool (MapType2Select xs a_2))) (and (state Heap@@9 QPMask@3) (state Heap@@9 QPMask@3)))) (and (=> (= (ControlFlow 0 23) (- 0 29)) (<= FullPerm (U_2_real (MapType1Select QPMask@3 a_2 r_1)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@3 a_2 r_1))) (=> (state Heap@@9 QPMask@3) (and (=> (= (ControlFlow 0 23) (- 0 28)) (HasDirectPerm QPMask@3 a_2 r_1)) (=> (HasDirectPerm QPMask@3 a_2 r_1) (=> (and (= v_2@0 (MapType0Select Heap@@9 a_2 r_1)) (state Heap@@9 QPMask@3)) (and (=> (= (ControlFlow 0 23) (- 0 27)) (HasDirectPerm QPMask@3 a_2 r_1)) (=> (HasDirectPerm QPMask@3 a_2 r_1) (and (=> (= (ControlFlow 0 23) (- 0 26)) (<= FullPerm (U_2_real (MapType1Select QPMask@3 (MapType0Select Heap@@9 a_2 r_1) f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@3 (MapType0Select Heap@@9 a_2 r_1) f_7))) (=> (state Heap@@9 QPMask@3) (and (=> (= (ControlFlow 0 23) (- 0 25)) (HasDirectPerm QPMask@3 a_2 r_1)) (=> (HasDirectPerm QPMask@3 a_2 r_1) (and (=> (= (ControlFlow 0 23) (- 0 24)) (HasDirectPerm QPMask@3 (MapType0Select Heap@@9 a_2 r_1) r_1)) (=> (HasDirectPerm QPMask@3 (MapType0Select Heap@@9 a_2 r_1) r_1) (=> (= (ControlFlow 0 23) (- 0 22)) (<= FullPerm (U_2_real (MapType1Select QPMask@3 (MapType0Select Heap@@9 (MapType0Select Heap@@9 a_2 r_1) r_1) f_7))))))))))))))))))))))))))
(let ((anon30_Else_correct  (=> (forall ((x_9 T@U) (y_3 T@U) ) (!  (=> (and (and (= (type x_9) RefType) (= (type y_3) RefType)) (and (U_2_bool (MapType2Select xs x_9)) (and (U_2_bool (MapType2Select xs y_3)) (not (= x_9 y_3))))) (not (= (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_9 r_1) r_1) (MapType0Select Heap@@9 (MapType0Select Heap@@9 y_3 r_1) r_1))))
 :qid |stdinbpl.613:20|
 :skolemid |101|
 :pattern ( (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_9 r_1) r_1) (MapType0Select Heap@@9 (MapType0Select Heap@@9 y_3 r_1) r_1))
)) (=> (and (state Heap@@9 QPMask@2) (state Heap@@9 QPMask@2)) (and (and (=> (= (ControlFlow 0 36) 23) anon32_Else_correct) (=> (= (ControlFlow 0 36) 32) anon33_Then_correct)) (=> (= (ControlFlow 0 36) 35) anon33_Else_correct))))))
(let ((anon17_correct true))
(let ((anon31_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select xs x_6)) (and (U_2_bool (MapType2Select xs y_2)) (not (= x_6 y_2))))) (= (ControlFlow 0 21) 15)) anon17_correct)))
(let ((anon31_Then_correct  (=> (and (U_2_bool (MapType2Select xs x_6)) (and (U_2_bool (MapType2Select xs y_2)) (not (= x_6 y_2)))) (and (=> (= (ControlFlow 0 16) (- 0 20)) (HasDirectPerm QPMask@2 x_6 r_1)) (=> (HasDirectPerm QPMask@2 x_6 r_1) (and (=> (= (ControlFlow 0 16) (- 0 19)) (HasDirectPerm QPMask@2 (MapType0Select Heap@@9 x_6 r_1) r_1)) (=> (HasDirectPerm QPMask@2 (MapType0Select Heap@@9 x_6 r_1) r_1) (and (=> (= (ControlFlow 0 16) (- 0 18)) (HasDirectPerm QPMask@2 y_2 r_1)) (=> (HasDirectPerm QPMask@2 y_2 r_1) (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm QPMask@2 (MapType0Select Heap@@9 y_2 r_1) r_1)) (=> (HasDirectPerm QPMask@2 (MapType0Select Heap@@9 y_2 r_1) r_1) (=> (= (ControlFlow 0 16) 15) anon17_correct))))))))))))
(let ((anon28_Else_correct  (and (=> (= (ControlFlow 0 37) (- 0 38)) (forall ((x_7 T@U) (x_7_1 T@U) ) (!  (=> (and (= (type x_7) RefType) (= (type x_7_1) RefType)) (=> (and (and (and (and (not (= x_7 x_7_1)) (U_2_bool (MapType2Select xs x_7))) (U_2_bool (MapType2Select xs x_7_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (MapType0Select Heap@@9 x_7 r_1) (MapType0Select Heap@@9 x_7_1 r_1)))))
 :qid |stdinbpl.560:15|
 :skolemid |95|
 :no-pattern (type x_7)
...
))) (=> (forall ((x_7@@0 T@U) (x_7_1@@0 T@U) ) (!  (=> (and (= (type x_7@@0) RefType) (= (type x_7_1@@0) RefType)) (=> (and (and (and (and (not (= x_7@@0 x_7_1@@0)) (U_2_bool (MapType2Select xs x_7@@0))) (U_2_bool (MapType2Select xs x_7_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (MapType0Select Heap@@9 x_7@@0 r_1) (MapType0Select Heap@@9 x_7_1@@0 r_1)))))
 :qid |stdinbpl.560:15|
 :skolemid |95|
...
)) (=> (and (and (and (forall ((x_7@@1 T@U) ) (!  (=> (= (type x_7@@1) RefType) (=> (and (U_2_bool (MapType2Select xs x_7@@1)) (< NoPerm FullPerm)) (and (qpRange3 (MapType0Select Heap@@9 x_7@@1 r_1)) (= (invRecv3 (MapType0Select Heap@@9 x_7@@1 r_1)) x_7@@1))))
 :qid |stdinbpl.566:22|
 :skolemid |96|
 :pattern ( (MapType0Select Heap@@9 x_7@@1 r_1))
 :pattern ( (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_7@@1 r_1) f_7))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv3 o_3@@2))) (< NoPerm FullPerm)) (qpRange3 o_3@@2)) (= (MapType0Select Heap@@9 (invRecv3 o_3@@2) r_1) o_3@@2)))
 :qid |stdinbpl.570:22|
 :skolemid |97|
 :pattern ( (invRecv3 o_3@@2))
))) (and (forall ((x_7@@2 T@U) ) (!  (=> (and (= (type x_7@@2) RefType) (U_2_bool (MapType2Select xs x_7@@2))) (not (= (MapType0Select Heap@@9 x_7@@2 r_1) null)))
 :qid |stdinbpl.576:22|
 :skolemid |98|
 :pattern ( (MapType0Select Heap@@9 x_7@@2 r_1))
 :pattern ( (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_7@@2 r_1) f_7))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs (invRecv3 o_3@@3))) (< NoPerm FullPerm)) (qpRange3 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (MapType0Select Heap@@9 (invRecv3 o_3@@3) r_1) o_3@@3)) (= (U_2_real (MapType1Select QPMask@2 o_3@@3 f_7)) (+ (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select xs (invRecv3 o_3@@3))) (< NoPerm FullPerm)) (qpRange3 o_3@@3))) (= (U_2_real (MapType1Select QPMask@2 o_3@@3 f_7)) (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7))))))
 :qid |stdinbpl.582:22|
 :skolemid |99|
...
)) (state Heap@@9 QPMask@2)) (and (state Heap@@9 QPMask@2) (state Heap@@9 QPMask@2)))) (and (and (=> (= (ControlFlow 0 37) 36) anon30_Else_correct) (=> (= (ControlFlow 0 37) 16) anon31_Then_correct)) (=> (= (ControlFlow 0 37) 21) anon31_Else_correct)))))))
(let ((anon13_correct true))
(let ((anon29_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs x_4))) (= (ControlFlow 0 14) 11)) anon13_correct)))
(let ((anon29_Then_correct  (=> (U_2_bool (MapType2Select xs x_4)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm QPMask@1 x_4 r_1)) (=> (HasDirectPerm QPMask@1 x_4 r_1) (=> (= (ControlFlow 0 12) 11) anon13_correct))))))
(let ((anon26_Else_correct  (and (=> (= (ControlFlow 0 39) (- 0 40)) (forall ((x_5 T@U) (x_5_1 T@U) ) (!  (=> (and (= (type x_5) RefType) (= (type x_5_1) RefType)) (=> (and (and (and (and (not (= x_5 x_5_1)) (U_2_bool (MapType2Select xs x_5))) (U_2_bool (MapType2Select xs x_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (MapType0Select Heap@@9 x_5 r_1) (MapType0Select Heap@@9 x_5_1 r_1)))))
 :qid |stdinbpl.513:15|
 :skolemid |89|
 :no-pattern (type x_5)
...
))) (=> (forall ((x_5@@0 T@U) (x_5_1@@0 T@U) ) (!  (=> (and (= (type x_5@@0) RefType) (= (type x_5_1@@0) RefType)) (=> (and (and (and (and (not (= x_5@@0 x_5_1@@0)) (U_2_bool (MapType2Select xs x_5@@0))) (U_2_bool (MapType2Select xs x_5_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (MapType0Select Heap@@9 x_5@@0 r_1) (MapType0Select Heap@@9 x_5_1@@0 r_1)))))
 :qid |stdinbpl.513:15|
 :skolemid |89|
...
)) (=> (and (and (and (forall ((x_5@@1 T@U) ) (!  (=> (= (type x_5@@1) RefType) (=> (and (U_2_bool (MapType2Select xs x_5@@1)) (< NoPerm FullPerm)) (and (qpRange2 (MapType0Select Heap@@9 x_5@@1 r_1)) (= (invRecv2 (MapType0Select Heap@@9 x_5@@1 r_1)) x_5@@1))))
 :qid |stdinbpl.519:22|
 :skolemid |90|
 :pattern ( (MapType0Select Heap@@9 x_5@@1 r_1))
 :pattern ( (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_5@@1 r_1) r_1))
)) (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv2 o_3@@5))) (< NoPerm FullPerm)) (qpRange2 o_3@@5)) (= (MapType0Select Heap@@9 (invRecv2 o_3@@5) r_1) o_3@@5)))
 :qid |stdinbpl.523:22|
 :skolemid |91|
 :pattern ( (invRecv2 o_3@@5))
))) (and (forall ((x_5@@2 T@U) ) (!  (=> (and (= (type x_5@@2) RefType) (U_2_bool (MapType2Select xs x_5@@2))) (not (= (MapType0Select Heap@@9 x_5@@2 r_1) null)))
 :qid |stdinbpl.529:22|
 :skolemid |92|
 :pattern ( (MapType0Select Heap@@9 x_5@@2 r_1))
 :pattern ( (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_5@@2 r_1) r_1))
)) (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs (invRecv2 o_3@@6))) (< NoPerm FullPerm)) (qpRange2 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (MapType0Select Heap@@9 (invRecv2 o_3@@6) r_1) o_3@@6)) (= (U_2_real (MapType1Select QPMask@1 o_3@@6 r_1)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@6 r_1)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select xs (invRecv2 o_3@@6))) (< NoPerm FullPerm)) (qpRange2 o_3@@6))) (= (U_2_real (MapType1Select QPMask@1 o_3@@6 r_1)) (U_2_real (MapType1Select QPMask@0 o_3@@6 r_1))))))
 :qid |stdinbpl.535:22|
 :skolemid |93|
 :pattern ( (MapType1Select QPMask@1 o_3@@6 r_1))
)))) (and (and (forall ((o_3@@7 T@U) (f_5@@1 T@U) ) (! (let ((B@@13 (FieldTypeInv1 (type f_5@@1))))
(let ((A@@14 (FieldTypeInv0 (type f_5@@1))))
 (=> (and (and (= (type o_3@@7) RefType) (= (type f_5@@1) (FieldType A@@14 B@@13))) (not (= f_5@@1 r_1))) (= (U_2_real (MapType1Select QPMask@0 o_3@@7 f_5@@1)) (U_2_real (MapType1Select QPMask@1 o_3@@7 f_5@@1))))))
 :qid |stdinbpl.539:29|
 :skolemid |94|
 :pattern ( (MapType1Select QPMask@0 o_3@@7 f_5@@1))
 :pattern ( (MapType1Select QPMask@1 o_3@@7 f_5@@1))
)) (state Heap@@9 QPMask@1)) (and (state Heap@@9 QPMask@1) (state Heap@@9 QPMask@1)))) (and (and (=> (= (ControlFlow 0 39) 37) anon28_Else_correct) (=> (= (ControlFlow 0 39) 12) anon29_Then_correct)) (=> (= (ControlFlow 0 39) 14) anon29_Else_correct)))))))
(let ((anon9_correct true))
(let ((anon27_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs x_2))) (= (ControlFlow 0 10) 7)) anon9_correct)))
(let ((anon27_Then_correct  (=> (U_2_bool (MapType2Select xs x_2)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm QPMask@0 x_2 r_1)) (=> (HasDirectPerm QPMask@0 x_2 r_1) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
(let ((anon24_Else_correct  (=> (forall ((x_3 T@U) (y_1 T@U) ) (!  (=> (and (and (= (type x_3) RefType) (= (type y_1) RefType)) (and (U_2_bool (MapType2Select xs x_3)) (and (U_2_bool (MapType2Select xs y_1)) (not (= x_3 y_1))))) (not (= (MapType0Select Heap@@9 x_3 r_1) (MapType0Select Heap@@9 y_1 r_1))))
 :qid |stdinbpl.494:20|
 :skolemid |88|
 :pattern ( (MapType0Select Heap@@9 x_3 r_1) (MapType0Select Heap@@9 y_1 r_1))
)) (=> (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)) (and (and (=> (= (ControlFlow 0 41) 39) anon26_Else_correct) (=> (= (ControlFlow 0 41) 8) anon27_Then_correct)) (=> (= (ControlFlow 0 41) 10) anon27_Else_correct))))))
(let ((anon5_correct true))
(let ((anon25_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select xs x@@19)) (and (U_2_bool (MapType2Select xs y@@6)) (not (= x@@19 y@@6))))) (= (ControlFlow 0 6) 2)) anon5_correct)))
(let ((anon25_Then_correct  (=> (and (U_2_bool (MapType2Select xs x@@19)) (and (U_2_bool (MapType2Select xs y@@6)) (not (= x@@19 y@@6)))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm QPMask@0 x@@19 r_1)) (=> (HasDirectPerm QPMask@0 x@@19 r_1) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 y@@6 r_1)) (=> (HasDirectPerm QPMask@0 y@@6 r_1) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 42) (- 0 43)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select xs x_1))) (U_2_bool (MapType2Select xs x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.445:15|
 :skolemid |82|
 :no-pattern (type x_1)
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (U_2_bool (MapType2Select xs x_1@@0))) (U_2_bool (MapType2Select xs x_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.445:15|
 :skolemid |82|
...
)) (=> (and (and (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs x_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 x_1@@1) (= (invRecv1 x_1@@1) x_1@@1))))
 :qid |stdinbpl.451:22|
 :skolemid |83|
 :pattern ( (MapType0Select Heap@@9 x_1@@1 r_1))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 r_1))
 :pattern ( (MapType0Select Heap@@9 x_1@@1 r_1))
)) (forall ((o_3@@8 T@U) ) (!  (=> (= (type o_3@@8) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv1 o_3@@8))) (< NoPerm FullPerm)) (qpRange1 o_3@@8)) (= (invRecv1 o_3@@8) o_3@@8)))
 :qid |stdinbpl.455:22|
 :skolemid |84|
 :pattern ( (invRecv1 o_3@@8))
))) (and (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (U_2_bool (MapType2Select xs x_1@@2))) (not (= x_1@@2 null)))
 :qid |stdinbpl.461:22|
 :skolemid |85|
 :pattern ( (MapType0Select Heap@@9 x_1@@2 r_1))
 :pattern ( (MapType1Select QPMask@0 x_1@@2 r_1))
 :pattern ( (MapType0Select Heap@@9 x_1@@2 r_1))
)) (forall ((o_3@@9 T@U) ) (!  (=> (= (type o_3@@9) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs (invRecv1 o_3@@9))) (< NoPerm FullPerm)) (qpRange1 o_3@@9)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@9) o_3@@9)) (= (U_2_real (MapType1Select QPMask@0 o_3@@9 r_1)) (+ (U_2_real (MapType1Select ZeroMask o_3@@9 r_1)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select xs (invRecv1 o_3@@9))) (< NoPerm FullPerm)) (qpRange1 o_3@@9))) (= (U_2_real (MapType1Select QPMask@0 o_3@@9 r_1)) (U_2_real (MapType1Select ZeroMask o_3@@9 r_1))))))
 :qid |stdinbpl.467:22|
 :skolemid |86|
 :pattern ( (MapType1Select QPMask@0 o_3@@9 r_1))
)))) (and (and (forall ((o_3@@10 T@U) (f_5@@2 T@U) ) (! (let ((B@@14 (FieldTypeInv1 (type f_5@@2))))
(let ((A@@15 (FieldTypeInv0 (type f_5@@2))))
 (=> (and (and (= (type o_3@@10) RefType) (= (type f_5@@2) (FieldType A@@15 B@@14))) (not (= f_5@@2 r_1))) (= (U_2_real (MapType1Select ZeroMask o_3@@10 f_5@@2)) (U_2_real (MapType1Select QPMask@0 o_3@@10 f_5@@2))))))
 :qid |stdinbpl.471:29|
 :skolemid |87|
 :pattern ( (MapType1Select ZeroMask o_3@@10 f_5@@2))
 :pattern ( (MapType1Select QPMask@0 o_3@@10 f_5@@2))
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (and (=> (= (ControlFlow 0 42) 41) anon24_Else_correct) (=> (= (ControlFlow 0 42) 3) anon25_Then_correct)) (=> (= (ControlFlow 0 42) 6) anon25_Else_correct)))))))
(let ((anon23_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 a_2 $allocated)) (U_2_bool (MapType0Select Heap@@9 v_2 $allocated))) (and (=> (= (ControlFlow 0 44) 1) anon23_Then_correct) (=> (= (ControlFlow 0 44) 42) anon23_Else_correct))))))
