(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:03:29
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/issues/silver/0222.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (not (= y@1@01 y@0@01)))
; [exec]
; inhale acc(y.val, write)
