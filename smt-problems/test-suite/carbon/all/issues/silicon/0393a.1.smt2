...
(assert  (and (and (and (and (and (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type graph@@3) (SeqType RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (forall ((arg0@@37 T@U) (arg1@@16 T@U) ) (! (= (type (CombineFrames arg0@@37 arg1@@16)) FrameTypeType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (and (= AssumeFunctionsAbove 0) (<= 0 i@@10)) (and (< i@@10 (|Seq#Length| graph@@3)) (state Heap@@14 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i@@10 0)) (=> (>= i@@10 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i@@10 (|Seq#Length| graph@@3))) (=> (< i@@10 (|Seq#Length| graph@@3)) (=> (and (> wildcard@0 NoPerm) (= Mask@0 (MapType1Store ZeroMask null (Node (|Seq#Index| graph@@3 i@@10)) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Node (|Seq#Index| graph@@3 i@@10)))) wildcard@0))))) (=> (and (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0)) (and (|Node#trigger| Heap@@14 (Node (|Seq#Index| graph@@3 i@@10))) (= (MapType0Select Heap@@14 null (Node (|Seq#Index| graph@@3 i@@10))) (CombineFrames (FrameFragment (MapType0Select Heap@@14 (|Seq#Index| graph@@3 i@@10) id)) (FrameFragment (MapType0Select Heap@@14 (|Seq#Index| graph@@3 i@@10) neighbors)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (> (U_2_real (MapType1Select Mask@0 null (Node (|Seq#Index| graph@@3 i@@10)))) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@0 null (Node (|Seq#Index| graph@@3 i@@10)))) NoPerm) (=> (> wildcard@1 NoPerm) (=> (and (and (< wildcard@1 (U_2_real (MapType1Select Mask@0 null (Node (|Seq#Index| graph@@3 i@@10))))) (= UnfoldingMask@0 (MapType1Store Mask@0 null (Node (|Seq#Index| graph@@3 i@@10)) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (Node (|Seq#Index| graph@@3 i@@10)))) wildcard@1))))) (and (> wildcard@2 NoPerm) (not (= (|Seq#Index| graph@@3 i@@10) null)))) (=> (and (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 (|Seq#Index| graph@@3 i@@10) id (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 (|Seq#Index| graph@@3 i@@10) id)) wildcard@2)))) (state Heap@@14 UnfoldingMask@1)) (and (> wildcard@3 NoPerm) (not (= (|Seq#Index| graph@@3 i@@10) null)))) (and (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 (|Seq#Index| graph@@3 i@@10) neighbors (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 (|Seq#Index| graph@@3 i@@10) neighbors)) wildcard@3)))) (state Heap@@14 UnfoldingMask@2)) (and (forall ((i$0 Int) (j@@5 Int) ) (!  (=> (and (and (<= 0 i$0) (< i$0 (|Seq#Length| (MapType0Select Heap@@14 (|Seq#Index| graph@@3 i@@10) neighbors)))) (and (and (<= 0 j@@5) (< j@@5 (|Seq#Length| (MapType0Select Heap@@14 (|Seq#Index| graph@@3 i@@10) neighbors)))) (not (= i$0 j@@5)))) (not (= (U_2_int (|Seq#Index| (MapType0Select Heap@@14 (|Seq#Index| graph@@3 i@@10) neighbors) i$0)) (U_2_int (|Seq#Index| (MapType0Select Heap@@14 (|Seq#Index| graph@@3 i@@10) neighbors) j@@5)))))
 :qid |stdinbpl.645:22|
 :skolemid |62|
 :pattern ( (|Seq#Index| (MapType0Select Heap@@14 (|Seq#Index| graph@@3 i@@10) neighbors) i$0) (|Seq#Index| (MapType0Select Heap@@14 (|Seq#Index| graph@@3 i@@10) neighbors) j@@5))
)) (state Heap@@14 UnfoldingMask@2)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= i@@10 0)) (=> (>= i@@10 0) (=> (= (ControlFlow 0 2) (- 0 1)) (< i@@10 (|Seq#Length| graph@@3))))))))))))))))))))
