...
(declare-fun r$0_1 () T@U)
(declare-fun g0@@10 () T@U)
(declare-fun r_1_1 () T@U)
...
(assert  (and (and (and (and (and (and (and (and (and (and (= (type g0@@10) (MapType2Type RefType boolType)) (= (type n$0_13) RefType)) (= (type Heap@@35) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type g1@@10) (MapType2Type RefType boolType))) (= (type n$2_2) RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type r_1_1) RefType)) (= (type r$0_1) RefType)) (forall ((arg0@@59 T@U) ) (! (= (type (invRecv29 arg0@@59)) RefType)
 :qid |funType:invRecv29|
 :pattern ( (invRecv29 arg0@@59))
))) (forall ((arg0@@60 T@U) ) (! (= (type (invRecv28 arg0@@60)) RefType)
 :qid |funType:invRecv28|
 :pattern ( (invRecv28 arg0@@60))
))))
...
(let ((anon42_Else_correct  (=> (and (not (U_2_bool (MapType2Select g1@@10 r$0_1))) (= (ControlFlow 0 27) 24)) anon27_correct)))
(let ((anon42_Then_correct  (=> (U_2_bool (MapType2Select g1@@10 r$0_1)) (and (=> (= (ControlFlow 0 25) (- 0 26)) (not (U_2_bool (MapType2Select g0@@10 r$0_1)))) (=> (not (U_2_bool (MapType2Select g0@@10 r$0_1))) (=> (= (ControlFlow 0 25) 24) anon27_correct))))))
(let ((anon41_Else_correct true))
(let ((anon40_Then_correct true))
(let ((anon38_Else_correct  (=> (forall ((r_2_1 T@U) ) (!  (=> (and (= (type r_2_1) RefType) (U_2_bool (MapType2Select g0@@10 r_2_1))) (not (U_2_bool (MapType2Select g1@@10 r_2_1))))
 :qid |stdinbpl.3014:20|
 :skolemid |339|
 :pattern ( (MapType2Select g0@@10 r_2_1) (MapType2Select g1@@10 r_2_1))
...
(let ((anon39_Else_correct  (=> (and (not (U_2_bool (MapType2Select g0@@10 r_1_1))) (= (ControlFlow 0 21) 18)) anon21_correct)))
(let ((anon39_Then_correct  (=> (U_2_bool (MapType2Select g0@@10 r_1_1)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (not (U_2_bool (MapType2Select g1@@10 r_1_1)))) (=> (not (U_2_bool (MapType2Select g1@@10 r_1_1))) (=> (= (ControlFlow 0 19) 18) anon21_correct))))))
(let ((anon37_Then_correct true))
(let ((anon34_Else_correct  (=> (and (and (forall ((n$2_1 T@U) ) (!  (=> (= (type n$2_1) RefType) (=> (and (U_2_bool (MapType2Select g1@@10 n$2_1)) (not (= (MapType0Select Heap@@35 n$2_1 next) null))) (U_2_bool (MapType2Select g1@@10 (MapType0Select Heap@@35 n$2_1 next)))))
 :qid |stdinbpl.2980:20|
 :skolemid |338|
...
)) (state Heap@@35 QPMask@1)) (and (|Set#Equal| (|Set#Intersection| g0@@10 g1@@10) (|Set#Empty| RefType)) (state Heap@@35 QPMask@1))) (and (and (and (=> (= (ControlFlow 0 29) 17) anon37_Then_correct) (=> (= (ControlFlow 0 29) 28) anon38_Else_correct)) (=> (= (ControlFlow 0 29) 19) anon39_Then_correct)) (=> (= (ControlFlow 0 29) 21) anon39_Else_correct)))))
(let ((anon15_correct true))
(let ((anon36_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g1@@10 n$2_2)) (not (= (MapType0Select Heap@@35 n$2_2 next) null)))) (= (ControlFlow 0 13) 10)) anon15_correct)))
(let ((anon36_Then_correct  (=> (and (U_2_bool (MapType2Select g1@@10 n$2_2)) (not (= (MapType0Select Heap@@35 n$2_2 next) null))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm QPMask@1 n$2_2 next)) (=> (HasDirectPerm QPMask@1 n$2_2 next) (=> (= (ControlFlow 0 11) 10) anon15_correct))))))
(let ((anon35_Else_correct  (=> (not (U_2_bool (MapType2Select g1@@10 n$2_2))) (and (=> (= (ControlFlow 0 16) 11) anon36_Then_correct) (=> (= (ControlFlow 0 16) 13) anon36_Else_correct)))))
(let ((anon35_Then_correct  (=> (U_2_bool (MapType2Select g1@@10 n$2_2)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm QPMask@1 n$2_2 next)) (=> (HasDirectPerm QPMask@1 n$2_2 next) (and (=> (= (ControlFlow 0 14) 11) anon36_Then_correct) (=> (= (ControlFlow 0 14) 13) anon36_Else_correct)))))))
(let ((anon33_Else_correct  (and (=> (= (ControlFlow 0 30) (- 0 31)) (forall ((n$1_1 T@U) (n$1_1_1 T@U) ) (!  (=> (and (= (type n$1_1) RefType) (= (type n$1_1_1) RefType)) (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (U_2_bool (MapType2Select g1@@10 n$1_1))) (U_2_bool (MapType2Select g1@@10 n$1_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1))))
 :qid |stdinbpl.2935:15|
 :skolemid |332|
...
)) (=> (and (forall ((n$1_1@@1 T@U) ) (!  (=> (= (type n$1_1@@1) RefType) (=> (and (U_2_bool (MapType2Select g1@@10 n$1_1@@1)) (< NoPerm FullPerm)) (and (qpRange29 n$1_1@@1) (= (invRecv29 n$1_1@@1) n$1_1@@1))))
 :qid |stdinbpl.2941:22|
 :skolemid |333|
 :pattern ( (MapType0Select Heap@@35 n$1_1@@1 next))
 :pattern ( (MapType1Select QPMask@1 n$1_1@@1 next))
 :pattern ( (MapType0Select Heap@@35 n$1_1@@1 next))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select g1@@10 (invRecv29 o_3))) (< NoPerm FullPerm)) (qpRange29 o_3)) (= (invRecv29 o_3) o_3)))
 ...
 :pattern ( (MapType0Select Heap@@35 n$1_1@@2 next))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select g1@@10 (invRecv29 o_3@@0))) (< NoPerm FullPerm)) (qpRange29 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv29 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 next)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select g1@@10 (invRecv29 o_3@@0))) (< NoPerm FullPerm)) (qpRange29 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 next)) (U_2_real (MapType1Select QPMask@0 o_3@@0 next))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.2961:29|
 :skolemid |337|
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@1 o_3@@1 f_5))
)) (state Heap@@35 QPMask@1))) (and (and (=> (= (ControlFlow 0 30) 29) anon34_Else_correct) (=> (= (ControlFlow 0 30) 14) anon35_Then_correct)) (=> (= (ControlFlow 0 30) 16) anon35_Else_correct))))))))
(let ((anon33_Then_correct true))
(let ((anon30_Else_correct  (=> (and (forall ((n$0_1_1 T@U) ) (!  (=> (= (type n$0_1_1) RefType) (=> (and (U_2_bool (MapType2Select g0@@10 n$0_1_1)) (not (= (MapType0Select Heap@@35 n$0_1_1 next) null))) (U_2_bool (MapType2Select g0@@10 (MapType0Select Heap@@35 n$0_1_1 next)))))
 :qid |stdinbpl.2923:20|
 :skolemid |331|
...
)) (not (U_2_bool (MapType2Select g1@@10 null)))) (and (=> (= (ControlFlow 0 32) 9) anon33_Then_correct) (=> (= (ControlFlow 0 32) 30) anon33_Else_correct)))))
(let ((anon7_correct true))
(let ((anon32_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g0@@10 n$0_13)) (not (= (MapType0Select Heap@@35 n$0_13 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon32_Then_correct  (=> (and (U_2_bool (MapType2Select g0@@10 n$0_13)) (not (= (MapType0Select Heap@@35 n$0_13 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 n$0_13 next)) (=> (HasDirectPerm QPMask@0 n$0_13 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon31_Else_correct  (=> (not (U_2_bool (MapType2Select g0@@10 n$0_13))) (and (=> (= (ControlFlow 0 8) 3) anon32_Then_correct) (=> (= (ControlFlow 0 8) 5) anon32_Else_correct)))))
(let ((anon31_Then_correct  (=> (U_2_bool (MapType2Select g0@@10 n$0_13)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm QPMask@0 n$0_13 next)) (=> (HasDirectPerm QPMask@0 n$0_13 next) (and (=> (= (ControlFlow 0 6) 3) anon32_Then_correct) (=> (= (ControlFlow 0 6) 5) anon32_Else_correct)))))))
(let ((anon29_Else_correct  (and (=> (= (ControlFlow 0 33) (- 0 34)) (forall ((n_1 T@U) (n_1_1 T@U) ) (!  (=> (and (= (type n_1) RefType) (= (type n_1_1) RefType)) (=> (and (and (and (and (not (= n_1 n_1_1)) (U_2_bool (MapType2Select g0@@10 n_1))) (U_2_bool (MapType2Select g0@@10 n_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1))))
...
)) (=> (and (forall ((n_1@@1 T@U) ) (!  (=> (= (type n_1@@1) RefType) (=> (and (U_2_bool (MapType2Select g0@@10 n_1@@1)) (< NoPerm FullPerm)) (and (qpRange28 n_1@@1) (= (invRecv28 n_1@@1) n_1@@1))))
 :qid |stdinbpl.2884:22|
 :skolemid |326|
 :pattern ( (MapType0Select Heap@@35 n_1@@1 next))
 :pattern ( (MapType1Select QPMask@0 n_1@@1 next))
 :pattern ( (MapType0Select Heap@@35 n_1@@1 next))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType2Select g0@@10 (invRecv28 o_3@@2))) (< NoPerm FullPerm)) (qpRange28 o_3@@2)) (= (invRecv28 o_3@@2) o_3@@2)))
 :qid |stdinbpl.2888:22|
 :skolemid |327|
 :pattern ( (invRecv28 o_3@@2))
 ...
 :pattern ( (MapType0Select Heap@@35 n_1@@2 next))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType2Select g0@@10 (invRecv28 o_3@@3))) (< NoPerm FullPerm)) (qpRange28 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv28 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 next)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 next)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select g0@@10 (invRecv28 o_3@@3))) (< NoPerm FullPerm)) (qpRange28 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 next)) (U_2_real (MapType1Select ZeroMask o_3@@3 next))))))
...
)) (state Heap@@35 QPMask@0))) (and (and (=> (= (ControlFlow 0 33) 32) anon30_Else_correct) (=> (= (ControlFlow 0 33) 6) anon31_Then_correct)) (=> (= (ControlFlow 0 33) 8) anon31_Else_correct))))))))
(let ((anon29_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@35 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (not (U_2_bool (MapType2Select g0@@10 null)))) (and (=> (= (ControlFlow 0 35) 1) anon29_Then_correct) (=> (= (ControlFlow 0 35) 33) anon29_Else_correct))))))
