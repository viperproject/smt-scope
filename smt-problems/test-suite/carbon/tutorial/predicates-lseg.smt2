...
(let ((anon17_Else_correct  (=> (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@10 freshObj@0 $allocated)))) (=> (and (and (= Heap@0 (MapType0Store Heap@@10 freshObj@0 $allocated (bool_2_U true))) (= Mask@1 (MapType1Store Mask@0 freshObj@0 elem (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@0 elem)) FullPerm))))) (and (= Mask@2 (MapType1Store Mask@1 freshObj@0 next (real_2_U (+ (U_2_real (MapType1Select Mask@1 freshObj@0 next)) FullPerm)))) (state Heap@0 Mask@2))) (and (=> (= (ControlFlow 0 28) (- 0 30)) (= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 elem)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 elem))) (=> (and (= Heap@1 (MapType0Store Heap@0 freshObj@0 elem (int_2_U toAdd))) (state Heap@1 Mask@2)) (and (=> (= (ControlFlow 0 28) (- 0 29)) (= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 next)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 next))) (=> (and (= Heap@2 (MapType0Store Heap@1 freshObj@0 next first@@5)) (state Heap@2 Mask@2)) (and (=> (= (ControlFlow 0 28) 27) anon18_Then_correct) (=> (= (ControlFlow 0 28) 12) anon18_Else_correct))))))))))))
(let ((anon17_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 first@@5 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@10 last@@5 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (lseg first@@5 last@@5 values@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (lseg first@@5 last@@5 values@@5))) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 31) 1) anon17_Then_correct) (=> (= (ControlFlow 0 31) 28) anon17_Else_correct))))))
