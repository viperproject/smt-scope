...
(assert  (and (= (type Heap@@30) (MapType0Type RefType)) (= (type diz@@125) RefType)))
(set-info :boogie-vc-id Main__test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@30 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@30 diz@@125 $allocated)) (not (= diz@@125 null))) (=> (and (and (state Heap@@30 ZeroMask) (>= current_thread_id 0)) (and (state Heap@@30 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (>= current_thread_id 0))))))
