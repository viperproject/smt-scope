...
(assert  (and (and (and (and (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@37 T@U) ) (! (= (type (invRecv4 arg0@@37)) RefType)
 :qid |funType:invRecv4|
 :pattern ( (invRecv4 arg0@@37))
))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@38 T@U) ) (! (= (type (invRecv5 arg0@@38)) RefType)
 :qid |funType:invRecv5|
 :pattern ( (invRecv5 arg0@@38))
))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type r_1@@5) RefType)))
(set-info :boogie-vc-id t2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 11)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (not (= x_1 x_1_1)) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.942:15|
 :skolemid |90|
 :no-pattern (type x_1)
...
)) (=> (and (and (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (and (qpRange4 x_1@@1) (= (invRecv4 x_1@@1) x_1@@1)))
 :qid |stdinbpl.948:22|
 :skolemid |91|
 :pattern ( (MapType0Select Heap@@10 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
 :pattern ( (MapType0Select Heap@@10 x_1@@1 f_7))
)) (forall ((o_3 T@U) ) (!  (=> (and (= (type o_3) RefType) (qpRange4 o_3)) (= (invRecv4 o_3) o_3))
 :qid |stdinbpl.952:22|
 :skolemid |92|
 :pattern ( (invRecv4 o_3))
))) (and (forall ((x_1@@2 T@U) ) (!  (=> (= (type x_1@@2) RefType) (not (= x_1@@2 null)))
 :qid |stdinbpl.958:22|
 :skolemid |93|
 :pattern ( (MapType0Select Heap@@10 x_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@2 f_7))
 :pattern ( (MapType0Select Heap@@10 x_1@@2 f_7))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (qpRange4 o_3@@0) (and (= (invRecv4 o_3@@0) o_3@@0) (< (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7))))) (=> (not (qpRange4 o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.964:22|
 :skolemid |94|
...
)) (state Heap@@10 QPMask@0)) (and (state Heap@@10 QPMask@0) (> wildcard@0 0.0)))) (and (=> (= (ControlFlow 0 3) (- 0 10)) (forall ((x_2 T@U) ) (!  (=> (= (type x_2) RefType) (> (U_2_real (MapType1Select QPMask@0 x_2 f_7)) NoPerm))
 :qid |stdinbpl.993:17|
 :skolemid |96|
 :no-pattern (type x_2)
 :no-pattern (U_2_int x_2)
 :no-pattern (U_2_bool x_2)
))) (=> (forall ((x_2@@0 T@U) ) (!  (=> (= (type x_2@@0) RefType) (> (U_2_real (MapType1Select QPMask@0 x_2@@0 f_7)) NoPerm))
 :qid |stdinbpl.993:17|
 :skolemid |96|
 :no-pattern (type x_2@@0)
 :no-pattern (U_2_int x_2@@0)
 :no-pattern (U_2_bool x_2@@0)
)) (=> (forall ((x_2@@1 T@U) ) (!  (=> (= (type x_2@@1) RefType) (< wildcard@0 (U_2_real (MapType1Select QPMask@0 x_2@@1 f_7))))
 :qid |stdinbpl.997:22|
 :skolemid |97|
 :no-pattern (type x_2@@1)
 :no-pattern (U_2_int x_2@@1)
 :no-pattern (U_2_bool x_2@@1)
)) (and (=> (= (ControlFlow 0 3) (- 0 9)) (forall ((x_2@@2 T@U) ) (!  (=> (and (= (type x_2@@2) RefType) (dummyFunction (MapType0Select Heap@@10 x_2@@2 f_7))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1004:19|
 :skolemid |98|
 :pattern ( (MapType0Select Heap@@10 x_2@@2 f_7))
 :pattern ( (MapType1Select QPMask@1 x_2@@2 f_7))
 :pattern ( (MapType0Select Heap@@10 x_2@@2 f_7))
))) (=> (forall ((x_2@@3 T@U) ) (!  (=> (and (= (type x_2@@3) RefType) (dummyFunction (MapType0Select Heap@@10 x_2@@3 f_7))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1004:19|
 :skolemid |98|
 :pattern ( (MapType0Select Heap@@10 x_2@@3 f_7))
 :pattern ( (MapType1Select QPMask@1 x_2@@3 f_7))
 :pattern ( (MapType0Select Heap@@10 x_2@@3 f_7))
)) (and (=> (= (ControlFlow 0 3) (- 0 8)) (forall ((x_2@@4 T@U) (x_2_1 T@U) ) (!  (=> (and (= (type x_2@@4) RefType) (= (type x_2_1) RefType)) (=> (and (and (not (= x_2@@4 x_2_1)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_2@@4 x_2_1))))
 :qid |stdinbpl.1011:19|
 :skolemid |99|
 :pattern ( (neverTriggered5 x_2@@4) (neverTriggered5 x_2_1))
))) (=> (forall ((x_2@@5 T@U) (x_2_1@@0 T@U) ) (!  (=> (and (= (type x_2@@5) RefType) (= (type x_2_1@@0) RefType)) (=> (and (and (not (= x_2@@5 x_2_1@@0)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_2@@5 x_2_1@@0))))
 :qid |stdinbpl.1011:19|
 :skolemid |99|
 :pattern ( (neverTriggered5 x_2@@5) (neverTriggered5 x_2_1@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (forall ((x_2@@6 T@U) ) (!  (=> (= (type x_2@@6) RefType) (> (U_2_real (MapType1Select QPMask@0 x_2@@6 f_7)) NoPerm))
 :qid |stdinbpl.1018:19|
 :skolemid |100|
 :pattern ( (MapType0Select Heap@@10 x_2@@6 f_7))
 :pattern ( (MapType1Select QPMask@1 x_2@@6 f_7))
 :pattern ( (MapType0Select Heap@@10 x_2@@6 f_7))
))) (=> (forall ((x_2@@7 T@U) ) (!  (=> (= (type x_2@@7) RefType) (> (U_2_real (MapType1Select QPMask@0 x_2@@7 f_7)) NoPerm))
 :qid |stdinbpl.1018:19|
 :skolemid |100|
 :pattern ( (MapType0Select Heap@@10 x_2@@7 f_7))
 :pattern ( (MapType1Select QPMask@1 x_2@@7 f_7))
 :pattern ( (MapType0Select Heap@@10 x_2@@7 f_7))
)) (=> (and (and (and (forall ((x_2@@8 T@U) ) (!  (=> (and (= (type x_2@@8) RefType) (< NoPerm wildcard@0)) (and (qpRange5 x_2@@8) (= (invRecv5 x_2@@8) x_2@@8)))
 :qid |stdinbpl.1024:24|
 :skolemid |101|
 :pattern ( (MapType0Select Heap@@10 x_2@@8 f_7))
 :pattern ( (MapType1Select QPMask@1 x_2@@8 f_7))
 :pattern ( (MapType0Select Heap@@10 x_2@@8 f_7))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (< NoPerm wildcard@0) (qpRange5 o_3@@2)) (= (invRecv5 o_3@@2) o_3@@2)))
 :qid |stdinbpl.1028:24|
 :skolemid |102|
 :pattern ( (invRecv5 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (< NoPerm wildcard@0) (qpRange5 o_3@@3)) (and (= (invRecv5 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (- (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) wildcard@0)))) (=> (not (and (< NoPerm wildcard@0) (qpRange5 o_3@@3))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7))))))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 ...
 :qid |stdinbpl.1040:31|
 :skolemid |104|
 :pattern ( (MapType1Select QPMask@1 o_3@@4 f_5@@0))
)))) (and (and (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@0 QPMask@1) (state ExhaleHeap@0 QPMask@1)) (and (state ExhaleHeap@0 QPMask@1) (> wildcard@1 0.0)))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((x_3 T@U) ) (!  (=> (= (type x_3) RefType) (> (U_2_real (MapType1Select QPMask@1 x_3 f_7)) NoPerm))
 :qid |stdinbpl.1065:17|
 :skolemid |105|
 :no-pattern (type x_3)
 :no-pattern (U_2_int x_3)
 :no-pattern (U_2_bool x_3)
))) (=> (forall ((x_3@@0 T@U) ) (!  (=> (= (type x_3@@0) RefType) (> (U_2_real (MapType1Select QPMask@1 x_3@@0 f_7)) NoPerm))
 :qid |stdinbpl.1065:17|
 :skolemid |105|
 :no-pattern (type x_3@@0)
 :no-pattern (U_2_int x_3@@0)
 :no-pattern (U_2_bool x_3@@0)
)) (=> (forall ((x_3@@1 T@U) ) (!  (=> (= (type x_3@@1) RefType) (< wildcard@1 (U_2_real (MapType1Select QPMask@1 x_3@@1 f_7))))
 :qid |stdinbpl.1069:22|
 :skolemid |106|
 :no-pattern (type x_3@@1)
 :no-pattern (U_2_int x_3@@1)
 :no-pattern (U_2_bool x_3@@1)
)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((x_3@@2 T@U) ) (!  (=> (and (= (type x_3@@2) RefType) (dummyFunction (MapType0Select ExhaleHeap@0 x_3@@2 f_7))) (>= wildcard@1 NoPerm))
 :qid |stdinbpl.1076:19|
 :skolemid |107|
 :pattern ( (MapType0Select ExhaleHeap@0 x_3@@2 f_7))
 :pattern ( (MapType1Select QPMask@2 x_3@@2 f_7))
 :pattern ( (MapType0Select ExhaleHeap@0 x_3@@2 f_7))
))) (=> (forall ((x_3@@3 T@U) ) (!  (=> (and (= (type x_3@@3) RefType) (dummyFunction (MapType0Select ExhaleHeap@0 x_3@@3 f_7))) (>= wildcard@1 NoPerm))
 :qid |stdinbpl.1076:19|
 :skolemid |107|
 :pattern ( (MapType0Select ExhaleHeap@0 x_3@@3 f_7))
 :pattern ( (MapType1Select QPMask@2 x_3@@3 f_7))
 :pattern ( (MapType0Select ExhaleHeap@0 x_3@@3 f_7))
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_3@@4 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3@@4) RefType) (= (type x_3_1) RefType)) (=> (and (and (not (= x_3@@4 x_3_1)) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= x_3@@4 x_3_1))))
 :qid |stdinbpl.1083:19|
 :skolemid |108|
 :pattern ( (neverTriggered6 x_3@@4) (neverTriggered6 x_3_1))
))) (=> (forall ((x_3@@5 T@U) (x_3_1@@0 T@U) ) (!  (=> (and (= (type x_3@@5) RefType) (= (type x_3_1@@0) RefType)) (=> (and (and (not (= x_3@@5 x_3_1@@0)) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= x_3@@5 x_3_1@@0))))
 :qid |stdinbpl.1083:19|
 :skolemid |108|
 :pattern ( (neverTriggered6 x_3@@5) (neverTriggered6 x_3_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_3@@6 T@U) ) (!  (=> (= (type x_3@@6) RefType) (> (U_2_real (MapType1Select QPMask@1 x_3@@6 f_7)) NoPerm))
 :qid |stdinbpl.1090:19|
 :skolemid |109|
 :pattern ( (MapType0Select ExhaleHeap@0 x_3@@6 f_7))
 :pattern ( (MapType1Select QPMask@2 x_3@@6 f_7))
 :pattern ( (MapType0Select ExhaleHeap@0 x_3@@6 f_7))
)))))))))))))))))))))))))
