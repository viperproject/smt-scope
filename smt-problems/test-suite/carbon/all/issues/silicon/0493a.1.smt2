...
(assert  (and (= (type set@@3) (MapType2Type RefType boolType)) (= (type Heap@@13) (MapType0Type RefType))))
(set-info :boogie-vc-id |foo#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((a_3 T@U) (a_3_1 T@U) ) (!  (=> (and (= (type a_3) RefType) (= (type a_3_1) RefType)) (=> (and (and (and (and (not (= a_3 a_3_1)) (U_2_bool (MapType2Select set@@3 a_3))) (U_2_bool (MapType2Select set@@3 a_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_3 a_3_1))))
 :qid |stdinbpl.461:17|
 :skolemid |86|
 :pattern ( (neverTriggered1 a_3) (neverTriggered1 a_3_1))
)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
