...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type sys__result) RefType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type PostMask@1) (MapType1Type RefType realType))) (= (type PostMask@2) (MapType1Type RefType realType))) (= (type AssertMask@2) (MapType1Type RefType realType))) (= (type AssertMask@1) (MapType1Type RefType realType))) (= (type freshObj@0) RefType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@3) (MapType0Type RefType))) (= (type AssertMask@0) (MapType1Type RefType realType))) (= (type Heap@@41) (MapType0Type RefType))) (= (type diz@@29) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))))
(set-info :boogie-vc-id Tree__Tree)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 30) (let ((anon8_correct  (=> (= AssertMask@2 (MapType1Store AssertMask@1 freshObj@0 Tree__right (real_2_U (- (U_2_real (MapType1Select AssertMask@1 freshObj@0 Tree__right)) FullPerm)))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (HasDirectPerm Mask@2 freshObj@0 Tree__right)) (=> (HasDirectPerm Mask@2 freshObj@0 Tree__right) (=> (= (ControlFlow 0 6) (- 0 7)) (= (MapType0Select Heap@3 freshObj@0 Tree__right) null)))))))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 6)) anon8_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select AssertMask@1 freshObj@0 Tree__right)))) (=> (<= FullPerm (U_2_real (MapType1Select AssertMask@1 freshObj@0 Tree__right))) (=> (= (ControlFlow 0 9) 6) anon8_correct))))))
(let ((anon6_correct  (=> (= AssertMask@1 (MapType1Store AssertMask@0 freshObj@0 Tree__left (real_2_U (- (U_2_real (MapType1Select AssertMask@0 freshObj@0 Tree__left)) FullPerm)))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (HasDirectPerm Mask@2 freshObj@0 Tree__left)) (=> (HasDirectPerm Mask@2 freshObj@0 Tree__left) (and (=> (= (ControlFlow 0 12) (- 0 13)) (= (MapType0Select Heap@3 freshObj@0 Tree__left) null)) (=> (= (MapType0Select Heap@3 freshObj@0 Tree__left) null) (and (=> (= (ControlFlow 0 12) 9) anon18_Then_correct) (=> (= (ControlFlow 0 12) 11) anon18_Else_correct)))))))))
(let ((anon17_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 17) 12)) anon6_correct)))
(let ((anon17_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= FullPerm (U_2_real (MapType1Select AssertMask@0 freshObj@0 Tree__left)))) (=> (<= FullPerm (U_2_real (MapType1Select AssertMask@0 freshObj@0 Tree__left))) (=> (= (ControlFlow 0 15) 12) anon6_correct))))))
(let ((anon4_correct  (=> (= AssertMask@0 (MapType1Store Mask@2 freshObj@0 Tree__data (real_2_U (- (U_2_real (MapType1Select Mask@2 freshObj@0 Tree__data)) FullPerm)))) (and (=> (= (ControlFlow 0 18) (- 0 20)) (HasDirectPerm Mask@2 freshObj@0 Tree__data)) (=> (HasDirectPerm Mask@2 freshObj@0 Tree__data) (and (=> (= (ControlFlow 0 18) (- 0 19)) (= (U_2_int (MapType0Select Heap@3 freshObj@0 Tree__data)) 0)) (=> (= (U_2_int (MapType0Select Heap@3 freshObj@0 Tree__data)) 0) (and (=> (= (ControlFlow 0 18) 15) anon17_Then_correct) (=> (= (ControlFlow 0 18) 17) anon17_Else_correct)))))))))
(let ((anon16_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 23) 18)) anon4_correct)))
(let ((anon16_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (<= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 Tree__data)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 Tree__data))) (=> (= (ControlFlow 0 21) 18) anon4_correct))))))
(let ((anon15_Else_correct  (=> (U_2_bool (MapType0Select Heap@@41 diz@@29 $allocated)) (=> (and (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@41 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@41 freshObj@0 $allocated (bool_2_U true)))) (and (= Mask@0 (MapType1Store ZeroMask freshObj@0 Tree__data (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 Tree__data)) FullPerm)))) (= Mask@1 (MapType1Store Mask@0 freshObj@0 Tree__left (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@0 Tree__left)) FullPerm)))))) (and (and (= Mask@2 (MapType1Store Mask@1 freshObj@0 Tree__right (real_2_U (+ (U_2_real (MapType1Select Mask@1 freshObj@0 Tree__right)) FullPerm)))) (state Heap@0 Mask@2)) (and (state Heap@0 Mask@2) (state Heap@0 Mask@2)))) (and (=> (= (ControlFlow 0 24) (- 0 28)) (= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 Tree__data)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 Tree__data))) (=> (and (= Heap@1 (MapType0Store Heap@0 freshObj@0 Tree__data (int_2_U 0))) (state Heap@1 Mask@2)) (and (=> (= (ControlFlow 0 24) (- 0 27)) (= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 Tree__left)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 Tree__left))) (=> (and (= Heap@2 (MapType0Store Heap@1 freshObj@0 Tree__left null)) (state Heap@2 Mask@2)) (and (=> (= (ControlFlow 0 24) (- 0 26)) (= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 Tree__right)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 Tree__right))) (=> (= Heap@3 (MapType0Store Heap@2 freshObj@0 Tree__right null)) (=> (and (state Heap@3 Mask@2) (state Heap@3 Mask@2)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (not (= freshObj@0 null))) (=> (not (= freshObj@0 null)) (and (=> (= (ControlFlow 0 24) 21) anon16_Then_correct) (=> (= (ControlFlow 0 24) 23) anon16_Else_correct))))))))))))))))))
(let ((anon15_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (not (= sys__result null))) (=> (and (and (state PostHeap@0 ZeroMask) (not (= sys__result null))) (and (= PostMask@0 (MapType1Store ZeroMask sys__result Tree__data (real_2_U (+ (U_2_real (MapType1Select ZeroMask sys__result Tree__data)) FullPerm)))) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm PostMask@0 sys__result Tree__data)) (=> (HasDirectPerm PostMask@0 sys__result Tree__data) (=> (= (U_2_int (MapType0Select PostHeap@0 sys__result Tree__data)) 0) (=> (and (and (state PostHeap@0 PostMask@0) (not (= sys__result null))) (and (= PostMask@1 (MapType1Store PostMask@0 sys__result Tree__left (real_2_U (+ (U_2_real (MapType1Select PostMask@0 sys__result Tree__left)) FullPerm)))) (state PostHeap@0 PostMask@1))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm PostMask@1 sys__result Tree__left)) (=> (HasDirectPerm PostMask@1 sys__result Tree__left) (=> (and (= (MapType0Select PostHeap@0 sys__result Tree__left) null) (state PostHeap@0 PostMask@1)) (=> (and (and (not (= sys__result null)) (= PostMask@2 (MapType1Store PostMask@1 sys__result Tree__right (real_2_U (+ (U_2_real (MapType1Select PostMask@1 sys__result Tree__right)) FullPerm))))) (and (state PostHeap@0 PostMask@2) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm PostMask@2 sys__result Tree__right)))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (>= current_thread_id 0) (state Heap@@41 ZeroMask))) (and (=> (= (ControlFlow 0 29) 2) anon15_Then_correct) (=> (= (ControlFlow 0 29) 24) anon15_Else_correct)))))
