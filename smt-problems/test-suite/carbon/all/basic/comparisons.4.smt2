...
(declare-fun i3 () Int)
(declare-fun i4 () Int)
(assert  (and (= (type Heap@@9) (MapType0Type RefType)) (= (type i2) (MultiSetType intType))))
(set-info :boogie-vc-id chainParen)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (<= (|MultiSet#Select| i2 (int_2_U i1)) i3)) (and (> i3 i4) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> i3 i4)) (=> (> i3 i4) (=> (state Heap@@9 ZeroMask) (=> (and (and (= (|MultiSet#Select| i2 (int_2_U i1)) 3) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (<= 3 i3))))))))
