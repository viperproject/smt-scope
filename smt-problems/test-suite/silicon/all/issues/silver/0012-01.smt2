(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 19:59:25
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/issues/silver/0012.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (not (= this@0@00 ($SortWrappers.$SnapTo$Ref ($Snap.first $t@1@00)))))
(check-sat)
; unknown
(pop) ; 2
; 0,00s
...
(push) ; 2
(set-option :timeout 10)
(assert (not (= this@2@00 ($SortWrappers.$SnapTo$Ref ($Snap.first $t@3@00)))))
(check-sat)
; unknown
(pop) ; 2
; 0,00s
