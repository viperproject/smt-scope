...
(assert  (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type x@@11) RefType)) (= (type Heap@@15) (MapType0Type RefType))))
(set-info :boogie-vc-id test03a)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon15_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (> (bar01 Heap@@15 5) 0))))
(let ((anon15_Then_correct true))
(let ((anon13_Else_correct  (=> (fun01 Heap@@15 x@@11 5) (=> (and (state Heap@@15 Mask@0) (state Heap@@15 Mask@0)) (and (=> (= (ControlFlow 0 10) 7) anon15_Then_correct) (=> (= (ControlFlow 0 10) 9) anon15_Else_correct))))))
(let ((anon7_correct true))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon7_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@11 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@11 f_7))) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
(let ((anon11_Else_correct  (=> (and (and (forall ((i_1 Int) ) (! (> (bar01 Heap@@15 i_1) 0)
 :qid |stdinbpl.673:20|
 :skolemid |31|
 :pattern ( (|fun01#frame| (FrameFragment (MapType0Select Heap@@15 x@@11 f_7)) x@@11 i_1))
)) (state Heap@@15 Mask@0)) (and (state Heap@@15 Mask@0) (state Heap@@15 Mask@0))) (and (and (=> (= (ControlFlow 0 11) 10) anon13_Else_correct) (=> (= (ControlFlow 0 11) 4) anon14_Then_correct)) (=> (= (ControlFlow 0 11) 6) anon14_Else_correct)))))
(let ((anon12_Else_correct true))
(let ((anon12_Then_correct true))
(let ((anon0_correct  (=> (and (and (and (state Heap@@15 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@15 x@@11 $allocated)) (not (= x@@11 null)))) (and (and (= Mask@0 (MapType1Store ZeroMask x@@11 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@11 f_7)) FullPerm)))) (state Heap@@15 Mask@0)) (and (state Heap@@15 Mask@0) (state Heap@@15 Mask@0)))) (and (and (=> (= (ControlFlow 0 12) 11) anon11_Else_correct) (=> (= (ControlFlow 0 12) 1) anon12_Then_correct)) (=> (= (ControlFlow 0 12) 2) anon12_Else_correct)))))
