...
(set-info :boogie-vc-id Ref__loop_main_79)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 39) (let ((anon20_correct true))
(let ((anon39_Else_correct  (=> (and (not (and (<= (* i@@34 N) j_13) (< j_13 (* (+ i@@34 1) N)))) (= (ControlFlow 0 25) 20)) anon20_correct)))
(let ((anon39_Then_correct  (=> (and (<= (* i@@34 N) j_13) (< j_13 (* (+ i@@34 1) N))) (and (=> (= (ControlFlow 0 21) (- 0 24)) (>= j_13 0)) (=> (>= j_13 0) (and (=> (= (ControlFlow 0 21) (- 0 23)) (< j_13 (|Seq#Length| ar@@27))) (=> (< j_13 (|Seq#Length| ar@@27)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (HasDirectPerm QPMask@1 (|Seq#Index| ar@@27 j_13) Ref__Integer_value)) (=> (HasDirectPerm QPMask@1 (|Seq#Index| ar@@27 j_13) Ref__Integer_value) (=> (= (ControlFlow 0 21) 20) anon20_correct))))))))))
(let ((anon38_Else_correct true))
(let ((anon36_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((j_5 Int) (j_5_2 Int) ) (!  (=> (and (and (and (and (not (= j_5 j_5_2)) (and (<= (* i@@34 N) j_5) (< j_5 (* (+ i@@34 1) N)))) (and (<= (* i@@34 N) j_5_2) (< j_5_2 (* (+ i@@34 1) N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ar@@27 j_5) (|Seq#Index| ar@@27 j_5_2))))
 ...
 :qid |stdinbpl.2243:15|
 :skolemid |186|
)) (=> (forall ((j_5@@1 Int) ) (!  (=> (and (and (<= (* i@@34 N) j_5@@1) (< j_5@@1 (* (+ i@@34 1) N))) (< NoPerm FullPerm)) (and (qpRange13 (|Seq#Index| ar@@27 j_5@@1)) (= (invRecv13 (|Seq#Index| ar@@27 j_5@@1)) j_5@@1)))
 :qid |stdinbpl.2249:22|
 :skolemid |187|
 :pattern ( (|Seq#Index| ar@@27 j_5@@1))
 :pattern ( (|Seq#Index| ar@@27 j_5@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= (* i@@34 N) (invRecv13 o_3)) (< (invRecv13 o_3) (* (+ i@@34 1) N))) (< NoPerm FullPerm)) (qpRange13 o_3)) (= (|Seq#Index| ar@@27 (invRecv13 o_3)) o_3)))
 ...
 :pattern ( (|Seq#Index| ar@@27 j_5@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= (* i@@34 N) (invRecv13 o_3@@0)) (< (invRecv13 o_3@@0) (* (+ i@@34 1) N))) (< NoPerm FullPerm)) (qpRange13 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| ar@@27 (invRecv13 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 Ref__Integer_value)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 Ref__Integer_value)) FullPerm)))) (=> (not (and (and (and (<= (* i@@34 N) (invRecv13 o_3@@0)) (< (invRecv13 o_3@@0) (* (+ i@@34 1) N))) (< NoPerm FullPerm)) (qpRange13 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 Ref__Integer_value)) (U_2_real (MapType1Select ZeroMask o_3@@0 Ref__Integer_value))))))
...
(let ((anon37_Else_correct  (=> (and (not (and (<= (* i@@34 N) j_12) (< j_12 (* (+ i@@34 1) N)))) (= (ControlFlow 0 18) 14)) anon16_correct)))
(let ((anon37_Then_correct  (=> (and (<= (* i@@34 N) j_12) (< j_12 (* (+ i@@34 1) N))) (and (=> (= (ControlFlow 0 15) (- 0 17)) (>= j_12 0)) (=> (>= j_12 0) (and (=> (= (ControlFlow 0 15) (- 0 16)) (< j_12 (|Seq#Length| ar@@27))) (=> (< j_12 (|Seq#Length| ar@@27)) (=> (= (ControlFlow 0 15) 14) anon16_correct))))))))
...
(let ((anon35_Else_correct  (=> (and (<= N 0) (= (ControlFlow 0 30) 28)) anon13_correct)))
(let ((anon35_Then_correct  (=> (< 0 N) (=> (and (and (<= 0 i@@34) (< i@@34 M)) (and (= (* M N) (|Seq#Length| ar@@27)) (= (ControlFlow 0 29) 28))) anon13_correct))))
...
(let ((anon32_Else_correct  (and (=> (= (ControlFlow 0 32) (- 0 33)) (forall ((j_3 Int) (j_3_1 Int) ) (!  (=> (and (and (and (and (not (= j_3 j_3_1)) (and (<= (* i@@34 N) j_3) (< j_3 (* (+ i@@34 1) N)))) (and (<= (* i@@34 N) j_3_1) (< j_3_1 (* (+ i@@34 1) N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ar@@27 j_3) (|Seq#Index| ar@@27 j_3_1))))
 :qid |stdinbpl.2180:15|
 :skolemid |180|
))) (=> (forall ((j_3@@0 Int) (j_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_3@@0 j_3_1@@0)) (and (<= (* i@@34 N) j_3@@0) (< j_3@@0 (* (+ i@@34 1) N)))) (and (<= (* i@@34 N) j_3_1@@0) (< j_3_1@@0 (* (+ i@@34 1) N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ar@@27 j_3@@0) (|Seq#Index| ar@@27 j_3_1@@0))))
 :qid |stdinbpl.2180:15|
 :skolemid |180|
)) (=> (forall ((j_3@@1 Int) ) (!  (=> (and (and (<= (* i@@34 N) j_3@@1) (< j_3@@1 (* (+ i@@34 1) N))) (< NoPerm FullPerm)) (and (qpRange12 (|Seq#Index| ar@@27 j_3@@1)) (= (invRecv12 (|Seq#Index| ar@@27 j_3@@1)) j_3@@1)))
 :qid |stdinbpl.2186:22|
 :skolemid |181|
 :pattern ( (|Seq#Index| ar@@27 j_3@@1))
 :pattern ( (|Seq#Index| ar@@27 j_3@@1))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (<= (* i@@34 N) (invRecv12 o_3@@2)) (< (invRecv12 o_3@@2) (* (+ i@@34 1) N))) (< NoPerm FullPerm)) (qpRange12 o_3@@2)) (= (|Seq#Index| ar@@27 (invRecv12 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.2190:22|
 :skolemid |182|
 :pattern ( (invRecv12 o_3@@2))
)) (forall ((j_3@@2 Int) ) (!  (=> (and (<= (* i@@34 N) j_3@@2) (< j_3@@2 (* (+ i@@34 1) N))) (not (= (|Seq#Index| ar@@27 j_3@@2) null)))
 :qid |stdinbpl.2196:22|
 :skolemid |183|
 :pattern ( (|Seq#Index| ar@@27 j_3@@2))
 :pattern ( (|Seq#Index| ar@@27 j_3@@2))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (and (<= (* i@@34 N) (invRecv12 o_3@@3)) (< (invRecv12 o_3@@3) (* (+ i@@34 1) N))) (< NoPerm FullPerm)) (qpRange12 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| ar@@27 (invRecv12 o_3@@3)) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 Ref__Integer_value)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 Ref__Integer_value)) FullPerm)))) (=> (not (and (and (and (<= (* i@@34 N) (invRecv12 o_3@@3)) (< (invRecv12 o_3@@3) (* (+ i@@34 1) N))) (< NoPerm FullPerm)) (qpRange12 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 Ref__Integer_value)) (U_2_real (MapType1Select ZeroMask o_3@@3 Ref__Integer_value))))))
...
(let ((anon33_Else_correct  (=> (and (not (and (<= (* i@@34 N) j_11) (< j_11 (* (+ i@@34 1) N)))) (= (ControlFlow 0 12) 8)) anon9_correct)))
(let ((anon33_Then_correct  (=> (and (<= (* i@@34 N) j_11) (< j_11 (* (+ i@@34 1) N))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= j_11 0)) (=> (>= j_11 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< j_11 (|Seq#Length| ar@@27))) (=> (< j_11 (|Seq#Length| ar@@27)) (=> (= (ControlFlow 0 9) 8) anon9_correct))))))))
(let ((anon30_Else_correct  (=> (and (forall ((j_1_1 Int) (k_1_1 Int) ) (!  (=> (and (<= 0 j_1_1) (and (< j_1_1 (* (+ i@@34 1) N)) (and (<= 0 k_1_1) (and (< k_1_1 (* (+ i@@34 1) N)) (not (= j_1_1 k_1_1)))))) (not (= (|Seq#Index| ar@@27 j_1_1) (|Seq#Index| ar@@27 k_1_1))))
 :qid |stdinbpl.2162:20|
 :skolemid |179|
...
(let ((anon31_Else_correct  (=> (and (not (and (<= 0 j_10) (and (< j_10 (* (+ i@@34 1) N)) (and (<= 0 k_21) (and (< k_21 (* (+ i@@34 1) N)) (not (= j_10 k_21))))))) (= (ControlFlow 0 7) 1)) anon5_correct)))
(let ((anon31_Then_correct  (=> (and (<= 0 j_10) (and (< j_10 (* (+ i@@34 1) N)) (and (<= 0 k_21) (and (< k_21 (* (+ i@@34 1) N)) (not (= j_10 k_21)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j_10 0)) (=> (>= j_10 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j_10 (|Seq#Length| ar@@27))) (=> (< j_10 (|Seq#Length| ar@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_21 0)) (=> (>= k_21 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_21 (|Seq#Length| ar@@27))) (=> (< k_21 (|Seq#Length| ar@@27)) (=> (= (ControlFlow 0 2) 1) anon5_correct))))))))))))
(let ((anon2_correct  (=> (state Heap@@33 ZeroMask) (=> (and (<= (* (+ i@@34 1) N) (|Seq#Length| ar@@27)) (state Heap@@33 ZeroMask)) (and (and (=> (= (ControlFlow 0 35) 34) anon30_Else_correct) (=> (= (ControlFlow 0 35) 2) anon31_Then_correct)) (=> (= (ControlFlow 0 35) 7) anon31_Else_correct))))))
(let ((anon29_Else_correct  (=> (and (<= N 0) (= (ControlFlow 0 37) 35)) anon2_correct)))
(let ((anon29_Then_correct  (=> (< 0 N) (=> (and (and (<= 0 i@@34) (< i@@34 M)) (and (= (* M N) (|Seq#Length| ar@@27)) (= (ControlFlow 0 36) 35))) anon2_correct))))
