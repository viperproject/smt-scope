...
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (= 1 1)) (=> (= 1 1) (=> (state Heap@@9 ZeroMask) (and (and (=> (= (ControlFlow 0 4) 1) anon5_Then_correct) (=> (= (ControlFlow 0 4) 2) anon6_Then_correct)) (=> (= (ControlFlow 0 4) 3) anon6_Else_correct)))))))))
