...
(declare-fun i@@5 () Int)
(assert  (and (and (and (and (= (type y@@1) RefType) (= (type z@@0) RefType)) (= (type Heap@@10) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type x@@14) RefType)))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon4_correct true))
(let ((anon6_Else_correct  (=> (and (not (= y@@1 z@@0)) (= (ControlFlow 0 5) 1)) anon4_correct)))
(let ((anon6_Then_correct  (=> (= y@@1 z@@0) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= NoPerm q_1)) (=> (<= NoPerm q_1) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= q_1 p_2)) (=> (<= q_1 p_2) (=> (= (ControlFlow 0 2) 1) anon4_correct))))))))
(let ((anon2_correct  (=> (state Heap@@10 Mask@0) (and (=> (= (ControlFlow 0 6) 2) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (not (and (= y@@1 z@@0) (= j k))) (= (ControlFlow 0 9) 6)) anon2_correct)))
(let ((anon5_Then_correct  (=> (and (= y@@1 z@@0) (= j k)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= (+ q_1 p_2) (/ (to_real 1) (to_real 2)))) (=> (<= (+ q_1 p_2) (/ (to_real 1) (to_real 2))) (=> (= (ControlFlow 0 7) 6) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x@@14 $allocated))) (and (U_2_bool (MapType0Select Heap@@10 y@@1 $allocated)) (U_2_bool (MapType0Select Heap@@10 z@@0 $allocated)))) (and (and (<= NoPerm q_1) (<= NoPerm p_2)) (and (state Heap@@10 ZeroMask) (= perm@0 (/ (to_real 1) (to_real 2)))))) (and (=> (= (ControlFlow 0 10) (- 0 15)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (= Mask@0 (MapType1Store ZeroMask null (P x@@14 i@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@14 i@@5))) perm@0)))) (=> (and (and (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (<= p_2 (U_2_real (MapType1Select Mask@0 null (P y@@1 j)))) (state Heap@@10 Mask@0))) (and (and (state Heap@@10 Mask@0) (<= (__iar__assume_helper_1  (and (= y@@1 z@@0) (= j k)) p_2 q_1) (U_2_real (MapType1Select Mask@0 null (P z@@0 k))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)))) (and (=> (= (ControlFlow 0 10) (- 0 14)) (<= NoPerm p_2)) (=> (<= NoPerm p_2) (and (=> (= (ControlFlow 0 10) (- 0 13)) (<= p_2 (/ (to_real 1) (to_real 2)))) (=> (<= p_2 (/ (to_real 1) (to_real 2))) (=> (state Heap@@10 Mask@0) (and (=> (= (ControlFlow 0 10) (- 0 12)) (<= NoPerm q_1)) (=> (<= NoPerm q_1) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= q_1 (/ (to_real 1) (to_real 2)))) (=> (<= q_1 (/ (to_real 1) (to_real 2))) (=> (state Heap@@10 Mask@0) (and (=> (= (ControlFlow 0 10) 7) anon5_Then_correct) (=> (= (ControlFlow 0 10) 9) anon5_Else_correct)))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 16) 10) anon0_correct)))
