...
(assert  (and (and (= (type Heap@@9) (MapType1Type RefType)) (= (type m1@0) (MapType intType intType))) (= (type m2@0) (MapType intType intType))))
(set-info :boogie-vc-id test2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (= m1@0 (|Map#Build| (|Map#Empty| intType intType) (int_2_U 2) (int_2_U 3))) (state Heap@@9 ZeroMask)) (and (= m2@0 (|Map#Build| (|Map#Empty| intType intType) (int_2_U 3) (int_2_U 2))) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (U_2_bool (MapType0Select (|Map#Domain| m2@0) (int_2_U 3)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m2@0) (int_2_U 3))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (MapType0Select (|Map#Domain| m1@0) (MapType0Select (|Map#Elements| m2@0) (int_2_U 3))))) (=> (U_2_bool (MapType0Select (|Map#Domain| m1@0) (MapType0Select (|Map#Elements| m2@0) (int_2_U 3)))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (MapType0Select (|Map#Elements| m1@0) (MapType0Select (|Map#Elements| m2@0) (int_2_U 3)))) 3))))))))))
