...
(assert  (and (and (and (and (= (type x@@14) RefType) (= (type Mask@0) (MapType0Type RefType realType))) (= (type Heap@@10) (MapType1Type RefType))) (= (type Mask@2) (MapType0Type RefType realType))) (= (type Mask@1) (MapType0Type RefType realType))))
(set-info :boogie-vc-id |P#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_correct true))
(let ((anon4_Else_correct  (=> (and (not b_2@@5) (= perm@1 (/ (to_real 5) (to_real 10)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (=> (> perm@1 NoPerm) (not (= x@@14 null))) (=> (and (and (= Mask@1 (MapType0Store ZeroMask x@@14 g (real_2_U (+ (U_2_real (MapType0Select ZeroMask x@@14 g)) perm@1)))) (state Heap@@10 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 4) 1))) anon3_correct)))))))
(let ((anon4_Then_correct  (=> (and b_2@@5 (= perm@0 (/ (to_real 5) (to_real 10)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= x@@14 null))) (=> (and (and (= Mask@0 (MapType0Store ZeroMask x@@14 f_7 (real_2_U (+ (U_2_real (MapType0Select ZeroMask x@@14 f_7)) perm@0)))) (state Heap@@10 Mask@0)) (and (= Mask@2 Mask@0) (= (ControlFlow 0 2) 1))) anon3_correct)))))))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType1Select Heap@@10 x@@14 $allocated))) (and (=> (= (ControlFlow 0 6) 2) anon4_Then_correct) (=> (= (ControlFlow 0 6) 4) anon4_Else_correct)))))
