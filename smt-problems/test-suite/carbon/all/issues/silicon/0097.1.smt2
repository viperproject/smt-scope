...
(declare-fun |PseudoListget$#trigger| (T@U T@U Int) Bool)
...
(assert  (and (and (and (and (and (and (and (and (= (type Heap@@15) (MapType0Type RefType)) (= (type this$_2@@3) RefType)) (= (type UnfoldingMask@3) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (forall ((arg0@@39 T@U) (arg1@@16 T@U) ) (! (= (type (CombineFrames arg0@@39 arg1@@16)) FrameTypeType)
 :qid |funType:CombineFrames|
 :pattern ( (CombineFrames arg0@@39 arg1@@16))
...
(let ((anon7_Else_correct  (=> (and (|PseudoListget$#trigger| (MapType0Select Heap@@15 null (PseudoListinv$ (MapType0Select Heap@@15 this$_2@@3 PseudoListnext$))) (MapType0Select Heap@@15 this$_2@@3 PseudoListnext$) (- index@@3 1)) (= (ControlFlow 0 6) 4)) anon5_correct)))
(let ((anon6_Then_correct  (=> (and (= index@@3 0) (= (ControlFlow 0 5) 4)) anon5_correct)))
(let ((anon7_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (= (MapType0Select Heap@@15 this$_2@@3 PseudoListnext$) null))) (=> (not (= (MapType0Select Heap@@15 this$_2@@3 PseudoListnext$) null)) (=> (= (ControlFlow 0 2) (- 0 1)) (> (U_2_real (MapType1Select UnfoldingMask@3 null (PseudoListinv$ (MapType0Select Heap@@15 this$_2@@3 PseudoListnext$)))) NoPerm))))))
(let ((anon6_Else_correct  (=> (not (= index@@3 0)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm UnfoldingMask@3 this$_2@@3 PseudoListnext$)) (=> (HasDirectPerm UnfoldingMask@3 this$_2@@3 PseudoListnext$) (and (=> (= (ControlFlow 0 7) 2) anon7_Then_correct) (=> (= (ControlFlow 0 7) 6) anon7_Else_correct)))))))
(let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@15 this$_2@@3 $allocated)) (= AssumeFunctionsAbove 0)) (=> (and (and (and (not (= this$_2@@3 null)) (state Heap@@15 ZeroMask)) (and (> wildcard@0 NoPerm) (= Mask@0 (MapType1Store ZeroMask null (PseudoListinv$ this$_2@@3) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (PseudoListinv$ this$_2@@3))) wildcard@0)))))) (and (and (state Heap@@15 Mask@0) (state Heap@@15 Mask@0)) (and (|PseudoListinv$#trigger| Heap@@15 (PseudoListinv$ this$_2@@3)) (= (MapType0Select Heap@@15 null (PseudoListinv$ this$_2@@3)) (CombineFrames (FrameFragment (MapType0Select Heap@@15 this$_2@@3 PseudoListvalue$)) (CombineFrames (FrameFragment (MapType0Select Heap@@15 this$_2@@3 PseudoListnext$)) (MapType0Select Heap@@15 null (PseudoListinv$ (MapType0Select Heap@@15 this$_2@@3 PseudoListnext$))))))))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (> (U_2_real (MapType1Select Mask@0 null (PseudoListinv$ this$_2@@3))) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@0 null (PseudoListinv$ this$_2@@3))) NoPerm) (=> (> wildcard@1 NoPerm) (=> (and (and (and (and (< wildcard@1 (U_2_real (MapType1Select Mask@0 null (PseudoListinv$ this$_2@@3)))) (= UnfoldingMask@0 (MapType1Store Mask@0 null (PseudoListinv$ this$_2@@3) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (PseudoListinv$ this$_2@@3))) wildcard@1))))) (and (> wildcard@2 NoPerm) (not (= this$_2@@3 null)))) (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this$_2@@3 PseudoListvalue$ (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this$_2@@3 PseudoListvalue$)) wildcard@2)))) (state Heap@@15 UnfoldingMask@1)) (and (> wildcard@3 NoPerm) (not (= this$_2@@3 null))))) (and (and (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 this$_2@@3 PseudoListnext$ (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 this$_2@@3 PseudoListnext$)) wildcard@3)))) (state Heap@@15 UnfoldingMask@2)) (and (not (= (MapType0Select Heap@@15 this$_2@@3 PseudoListnext$) null)) (> wildcard@4 NoPerm))) (and (and (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 null (PseudoListinv$ (MapType0Select Heap@@15 this$_2@@3 PseudoListnext$)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 null (PseudoListinv$ (MapType0Select Heap@@15 this$_2@@3 PseudoListnext$)))) wildcard@4)))) (InsidePredicate (PseudoListinv$ this$_2@@3) (MapType0Select Heap@@15 null (PseudoListinv$ this$_2@@3)) (PseudoListinv$ (MapType0Select Heap@@15 this$_2@@3 PseudoListnext$)) (MapType0Select Heap@@15 null (PseudoListinv$ (MapType0Select Heap@@15 this$_2@@3 PseudoListnext$))))) (and (state Heap@@15 UnfoldingMask@3) (state Heap@@15 UnfoldingMask@3))))) (and (=> (= (ControlFlow 0 9) 5) anon6_Then_correct) (=> (= (ControlFlow 0 9) 7) anon6_Else_correct)))))))))))
