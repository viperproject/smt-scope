...
(let ((anon17_Else_correct  (=> (and (not b_2) (= (ControlFlow 0 10) 8)) anon10_correct)))
(let ((anon17_Then_correct  (=> b_2 (=> (and b_2 (= (ControlFlow 0 9) 8)) anon10_correct))))
(let ((anon7_correct true))
(let ((anon16_Else_correct  (=> (not b_2) (=> (and (not b_2) (= (ControlFlow 0 7) 5)) anon7_correct))))
(let ((anon16_Then_correct  (=> (and b_2 (= (ControlFlow 0 6) 5)) anon7_correct)))
(let ((anon14_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (and (and (=> (= (ControlFlow 0 11) 9) anon17_Then_correct) (=> (= (ControlFlow 0 11) 10) anon17_Else_correct)) (=> (= (ControlFlow 0 11) 6) anon16_Then_correct)) (=> (= (ControlFlow 0 11) 7) anon16_Else_correct)))))
(let ((anon18_Else_correct true))
(let ((anon18_Then_correct  (=> (and b_2 (= (ControlFlow 0 3) (- 0 2))) b_2)))
(let ((anon13_Else_correct  (=> (state Heap@@9 ZeroMask) (and (and (=> (= (ControlFlow 0 12) 11) anon14_Then_correct) (=> (= (ControlFlow 0 12) 3) anon18_Then_correct)) (=> (= (ControlFlow 0 12) 4) anon18_Else_correct)))))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 13) 1) anon13_Then_correct) (=> (= (ControlFlow 0 13) 12) anon13_Else_correct)))))
