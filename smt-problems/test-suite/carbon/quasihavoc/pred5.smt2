...
(assert  (and (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type x@@14) RefType)) (= (type y@@7) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |Pair#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@10 x@@14 $allocated)) (U_2_bool (MapType0Select Heap@@10 y@@7 $allocated))) (and (not (= x@@14 null)) (= Mask@0 (MapType1Store ZeroMask x@@14 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@14 f_7)) FullPerm)))))) (and (and (state Heap@@10 Mask@0) (not (= y@@7 null))) (and (= Mask@1 (MapType1Store Mask@0 y@@7 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@7 f_7)) FullPerm)))) (state Heap@@10 Mask@1)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 x@@14 f_7)) (=> (HasDirectPerm Mask@1 x@@14 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@1 y@@7 f_7))))))))
