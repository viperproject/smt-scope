...
(declare-fun initial_lblGuard@0 () Bool)
(declare-fun LabelinitialMask@0 () T@U)
(declare-fun LabelinitialHeap@0 () T@U)
(declare-fun Heap@1 () T@U)
(declare-fun LabelinitialHeap () T@U)
(declare-fun LabelinitialMask () T@U)
(declare-fun Heap@2 () T@U)
(declare-fun Heap@@9 () T@U)
(declare-fun m@@7 () T@U)
(declare-fun Heap@0 () T@U)
(declare-fun i () Int)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@3) (MapType0Type RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type freshObj@0) RefType)) (= (type Heap@4) (MapType0Type RefType))) (= (type LabelinitialMask@0) (MapType1Type RefType realType))) (= (type LabelinitialHeap@0) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type LabelinitialHeap) (MapType0Type RefType))) (= (type LabelinitialMask) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type m@@7) RefType)) (= (type Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id main)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon2_correct  (=> (state Heap@3 Mask@0) (and (=> (= (ControlFlow 0 2) (- 0 7)) (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7))) (=> (and (= Heap@4 (MapType0Store Heap@3 freshObj@0 f_7 (int_2_U 3))) (state Heap@4 Mask@0)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (HasDirectPerm Mask@0 freshObj@0 f_7)) (=> (HasDirectPerm Mask@0 freshObj@0 f_7) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (U_2_int (MapType0Select Heap@4 freshObj@0 f_7)) 3)) (=> (= (U_2_int (MapType0Select Heap@4 freshObj@0 f_7)) 3) (and (=> (= (ControlFlow 0 2) (- 0 4)) initial_lblGuard@0) (=> initial_lblGuard@0 (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm LabelinitialMask@0 freshObj@0 f_7)) (=> (HasDirectPerm LabelinitialMask@0 freshObj@0 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (MapType0Select LabelinitialHeap@0 freshObj@0 f_7)) 15))))))))))))))))
(let ((anon3_Else_correct  (=> (and (= (U_2_int (MapType0Select Heap@1 freshObj@0 f_7)) 15) (= initial_lblGuard@0 false)) (=> (and (and (= Heap@3 Heap@1) (= LabelinitialHeap@0 LabelinitialHeap)) (and (= LabelinitialMask@0 LabelinitialMask) (= (ControlFlow 0 10) 2))) anon2_correct))))
(let ((anon3_Then_correct  (=> (not (= (U_2_int (MapType0Select Heap@1 freshObj@0 f_7)) 15)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7))) (=> (and (and (and (= Heap@2 (MapType0Store Heap@1 freshObj@0 f_7 (int_2_U 15))) (state Heap@2 Mask@0)) (and (state Heap@2 Mask@0) (= initial_lblGuard@0 true))) (and (and (= Heap@3 Heap@2) (= LabelinitialHeap@0 Heap@2)) (and (= LabelinitialMask@0 Mask@0) (= (ControlFlow 0 8) 2)))) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 m@@7 $allocated))) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@9 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@9 freshObj@0 $allocated (bool_2_U true)))) (and (= Mask@0 (MapType1Store ZeroMask freshObj@0 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 f_7)) FullPerm)))) (state Heap@0 Mask@0))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7))) (=> (and (= Heap@1 (MapType0Store Heap@0 freshObj@0 f_7 (int_2_U i))) (state Heap@1 Mask@0)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm Mask@0 freshObj@0 f_7)) (=> (HasDirectPerm Mask@0 freshObj@0 f_7) (and (=> (= (ControlFlow 0 11) 8) anon3_Then_correct) (=> (= (ControlFlow 0 11) 10) anon3_Else_correct)))))))))))
