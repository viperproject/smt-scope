...
(assert  (and (and (= (Ctor PredicateType_PType) 11) (= (Ctor FrameTypeType) 12)) (forall ((arg0@@28 T@U) (arg1@@12 Int) ) (! (= (type (P arg0@@28 arg1@@12)) (FieldType PredicateType_PType FrameTypeType))
 :qid |funType:P|
 :pattern ( (P arg0@@28 arg1@@12))
))))
(assert (forall ((x@@8 T@U) (idx Int) ) (!  (=> (= (type x@@8) RefType) (IsPredicateField (P x@@8 idx)))
 :qid |stdinbpl.398:15|
 :skolemid |83|
 :pattern ( (P x@@8 idx))
)))
(assert (forall ((Heap@@0 T@U) (x@@9 T@U) (idx@@0 Int) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type x@@9) RefType)) (|P#everUsed| (P x@@9 idx@@0)))
 :qid |stdinbpl.417:15|
 :skolemid |87|
 :pattern ( (|P#trigger| Heap@@0 (P x@@9 idx@@0)))
)))
...
(assert  (and (and (and (and (and (and (and (forall ((arg0@@31 T@T) (arg1@@13 T@T) ) (! (= (Ctor (MapType2Type arg0@@31 arg1@@13)) 13)
...
(assert (forall ((x@@10 T@U) (idx@@1 Int) (x2 T@U) (idx2 Int) ) (!  (=> (and (and (= (type x@@10) RefType) (= (type x2) RefType)) (= (P x@@10 idx@@1) (P x2 idx2))) (and (= x@@10 x2) (= idx@@1 idx2)))
 :qid |stdinbpl.408:15|
 :skolemid |85|
 :pattern ( (P x@@10 idx@@1) (P x2 idx2))
)))
(assert (forall ((arg0@@39 T@U) (arg1@@20 Int) ) (! (= (type (|P#sm| arg0@@39 arg1@@20)) (FieldType PredicateType_PType (MapType1Type RefType boolType)))
 :qid |funType:P#sm|
 :pattern ( (|P#sm| arg0@@39 arg1@@20))
)))
(assert (forall ((x@@11 T@U) (idx@@2 Int) (x2@@0 T@U) (idx2@@0 Int) ) (!  (=> (and (and (= (type x@@11) RefType) (= (type x2@@0) RefType)) (= (|P#sm| x@@11 idx@@2) (|P#sm| x2@@0 idx2@@0))) (and (= x@@11 x2@@0) (= idx@@2 idx2@@0)))
 :qid |stdinbpl.412:15|
 :skolemid |86|
 :pattern ( (|P#sm| x@@11 idx@@2) (|P#sm| x2@@0 idx2@@0))
)))
...
(assert (forall ((x@@16 T@U) (idx@@3 Int) ) (!  (=> (= (type x@@16) RefType) (= (getPredWandId (P x@@16 idx@@3)) 0))
 :qid |stdinbpl.402:15|
 :skolemid |84|
 :pattern ( (P x@@16 idx@@3))
)))
...
(assert (forall ((x@@21 T@U) (idx@@4 Int) ) (!  (=> (= (type x@@21) RefType) (= (PredicateMaskField (P x@@21 idx@@4)) (|P#sm| x@@21 idx@@4)))
 :qid |stdinbpl.394:15|
 :skolemid |82|
 :pattern ( (PredicateMaskField (P x@@21 idx@@4)))
)))
...
(assert  (and (and (and (and (and (forall ((arg0@@45 T@U) (arg1@@25 Int) ) (! (= (type (invRecv3 arg0@@45 arg1@@25)) RefType)
 :qid |funType:invRecv3|
 :pattern ( (invRecv3 arg0@@45 arg1@@25))
)) (= (type xs) (MapType2Type RefType boolType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type x@@25) RefType)))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon6_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((x_2_1 T@U) (idx_1 Int) ) (!  (=> (= (type x_2_1) RefType) (=> (and (U_2_bool (MapType2Select xs (invRecv3 x_2_1 idx_1))) (qpRange3 x_2_1 idx_1)) (>= (U_2_real (MapType1Select QPMask@0 null (P (invRecv3 x_2_1 idx_1) 0))) NoPerm)))
 :qid |stdinbpl.585:17|
 :skolemid |92|
 :pattern ( (invRecv3 x_2_1 idx_1))
))) (=> (forall ((x_2_1@@0 T@U) (idx_1@@0 Int) ) (!  (=> (= (type x_2_1@@0) RefType) (=> (and (U_2_bool (MapType2Select xs (invRecv3 x_2_1@@0 idx_1@@0))) (qpRange3 x_2_1@@0 idx_1@@0)) (>= (U_2_real (MapType1Select QPMask@0 null (P (invRecv3 x_2_1@@0 idx_1@@0) 0))) NoPerm)))
 :qid |stdinbpl.585:17|
 :skolemid |92|
 :pattern ( (invRecv3 x_2_1@@0 idx_1@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (U_2_bool (MapType2Select xs r_1))) (U_2_bool (MapType2Select xs r_1_1))) (< NoPerm (U_2_real (MapType1Select QPMask@0 null (P r_1 0))))) (< NoPerm (U_2_real (MapType1Select QPMask@0 null (P r_1_1 0))))) (not (= r_1 r_1_1))))
 :qid |stdinbpl.592:17|
 :skolemid |93|
 :pattern ( (neverTriggered3 r_1) (neverTriggered3 r_1_1))
))) (=> (forall ((r_1@@0 T@U) (r_1_1@@0 T@U) ) (!  (=> (and (= (type r_1@@0) RefType) (= (type r_1_1@@0) RefType)) (=> (and (and (and (and (not (= r_1@@0 r_1_1@@0)) (U_2_bool (MapType2Select xs r_1@@0))) (U_2_bool (MapType2Select xs r_1_1@@0))) (< NoPerm (U_2_real (MapType1Select QPMask@0 null (P r_1@@0 0))))) (< NoPerm (U_2_real (MapType1Select QPMask@0 null (P r_1_1@@0 0))))) (not (= r_1@@0 r_1_1@@0))))
 :qid |stdinbpl.592:17|
 :skolemid |93|
 :pattern ( (neverTriggered3 r_1@@0) (neverTriggered3 r_1_1@@0))
)) (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((r_1@@1 T@U) ) (!  (=> (and (= (type r_1@@1) RefType) (U_2_bool (MapType2Select xs r_1@@1))) (>= (U_2_real (MapType1Select QPMask@0 null (P r_1@@1 0))) (U_2_real (MapType1Select QPMask@0 null (P r_1@@1 0)))))
 :qid |stdinbpl.599:17|
 :skolemid |94|
 :pattern ( (MapType0Select Heap@@10 null (P r_1@@1 0)))
 :pattern ( (MapType1Select QPMask@0 null (P r_1@@1 0)))
 :pattern ( (MapType2Select xs r_1@@1))
)))))))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (forall ((o_3 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
...
)) (=> (and (and (forall ((x_1_1 T@U) (idx@@5 Int) ) (!  (=> (= (type x_1_1) RefType) (= (U_2_real (MapType1Select QPMask@0 null (P x_1_1 idx@@5))) (U_2_real (MapType1Select Mask@0 null (P x_1_1 idx@@5)))))
 :qid |stdinbpl.562:22|
 :skolemid |91|
 :pattern ( (MapType1Select QPMask@0 null (P x_1_1 idx@@5)))
)) (state Heap@@10 QPMask@0)) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0))) (and (=> (= (ControlFlow 0 7) 2) anon6_Then_correct) (=> (= (ControlFlow 0 7) 4) anon6_Else_correct))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x@@25 $allocated))) (=> (and (and (> wildcard@0 NoPerm) (= Mask@0 (MapType1Store ZeroMask null (P x@@25 0) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@25 0))) wildcard@0))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 8) 1) anon5_Then_correct) (=> (= (ControlFlow 0 8) 7) anon5_Else_correct))))))
