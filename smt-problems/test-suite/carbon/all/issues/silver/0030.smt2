...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type f_7) (FieldType NormalFieldType realType))))
...
(assert  (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type x@@8) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 x@@8 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 x@@8 f_7)) perm@0)))) (=> (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 x@@8 f_7)) (=> (HasDirectPerm Mask@1 x@@8 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_real (MapType1Select Mask@1 x@@8 f_7)) (- FullPerm (U_2_real (MapType0Select ExhaleHeap@0 x@@8 f_7)))))))))))
(let ((anon3_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 6) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= perm@0 (U_2_real (MapType1Select Mask@0 x@@8 f_7)))) (=> (<= perm@0 (U_2_real (MapType1Select Mask@0 x@@8 f_7))) (=> (= (ControlFlow 0 4) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated)) (not (= x@@8 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 7) (- 0 11)) (HasDirectPerm Mask@0 x@@8 f_7)) (=> (HasDirectPerm Mask@0 x@@8 f_7) (=> (< NoPerm (U_2_real (MapType0Select Heap@@9 x@@8 f_7))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (HasDirectPerm Mask@0 x@@8 f_7)) (=> (HasDirectPerm Mask@0 x@@8 f_7) (=> (< (U_2_real (MapType0Select Heap@@9 x@@8 f_7)) FullPerm) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (HasDirectPerm Mask@0 x@@8 f_7)) (=> (HasDirectPerm Mask@0 x@@8 f_7) (=> (= perm@0 (U_2_real (MapType0Select Heap@@9 x@@8 f_7))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 7) 4) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct)))))))))))))))))))
