...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type ys) (MapType2Type RefType boolType)) (= (type xs) (MapType2Type RefType boolType))) (= (type ExhaleHeap@1) (MapType0Type RefType))) (= (type QPMask@4) (MapType1Type RefType realType))) (= (type QPMask@3) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv19 arg0@@43)) RefType)
 :qid |funType:invRecv19|
 :pattern ( (invRecv19 arg0@@43))
))) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv18 arg0@@44)) RefType)
 :qid |funType:invRecv18|
 :pattern ( (invRecv18 arg0@@44))
))) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv17 arg0@@45)) RefType)
 :qid |funType:invRecv17|
 :pattern ( (invRecv17 arg0@@45))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@46 T@U) ) (! (= (type (invRecv16 arg0@@46)) RefType)
 :qid |funType:invRecv16|
 :pattern ( (invRecv16 arg0@@46))
))))
(set-info :boogie-vc-id t5)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((b_1 T@U) (b_1_1 T@U) ) (!  (=> (and (= (type b_1) RefType) (= (type b_1_1) RefType)) (=> (and (and (and (and (not (= b_1 b_1_1)) (U_2_bool (MapType2Select (|Set#Difference| ys (|Set#Intersection| ys xs)) b_1))) (U_2_bool (MapType2Select (|Set#Difference| ys (|Set#Intersection| ys xs)) b_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= b_1 b_1_1))))
 :qid |stdinbpl.1554:17|
 :skolemid |196|
 :pattern ( (neverTriggered20 b_1) (neverTriggered20 b_1_1))
))) (=> (forall ((b_1@@0 T@U) (b_1_1@@0 T@U) ) (!  (=> (and (= (type b_1@@0) RefType) (= (type b_1_1@@0) RefType)) (=> (and (and (and (and (not (= b_1@@0 b_1_1@@0)) (U_2_bool (MapType2Select (|Set#Difference| ys (|Set#Intersection| ys xs)) b_1@@0))) (U_2_bool (MapType2Select (|Set#Difference| ys (|Set#Intersection| ys xs)) b_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= b_1@@0 b_1_1@@0))))
 :qid |stdinbpl.1554:17|
 :skolemid |196|
 :pattern ( (neverTriggered20 b_1@@0) (neverTriggered20 b_1_1@@0))
)) (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((b_1@@1 T@U) ) (!  (=> (and (= (type b_1@@1) RefType) (U_2_bool (MapType2Select (|Set#Difference| ys (|Set#Intersection| ys xs)) b_1@@1))) (>= (U_2_real (MapType1Select QPMask@3 b_1@@1 f_7)) FullPerm))
 :qid |stdinbpl.1561:17|
 :skolemid |197|
 :pattern ( (MapType0Select ExhaleHeap@1 b_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@4 b_1@@1 f_7))
 :pattern ( (MapType2Select (|Set#Difference| ys (|Set#Intersection| ys xs)) b_1@@1))
)))))))
(let ((anon15_Then_correct true))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (forall ((a_1 T@U) (a_1_1 T@U) ) (!  (=> (and (= (type a_1) RefType) (= (type a_1_1) RefType)) (=> (and (and (and (and (not (= a_1 a_1_1)) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Intersection| xs ys)) a_1))) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Intersection| xs ys)) a_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1 a_1_1))))
 :qid |stdinbpl.1497:17|
 :skolemid |190|
 :pattern ( (neverTriggered19 a_1) (neverTriggered19 a_1_1))
))) (=> (forall ((a_1@@0 T@U) (a_1_1@@0 T@U) ) (!  (=> (and (= (type a_1@@0) RefType) (= (type a_1_1@@0) RefType)) (=> (and (and (and (and (not (= a_1@@0 a_1_1@@0)) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Intersection| xs ys)) a_1@@0))) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Intersection| xs ys)) a_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1@@0 a_1_1@@0))))
 :qid |stdinbpl.1497:17|
 :skolemid |190|
 :pattern ( (neverTriggered19 a_1@@0) (neverTriggered19 a_1_1@@0))
)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((a_1@@1 T@U) ) (!  (=> (and (= (type a_1@@1) RefType) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Intersection| xs ys)) a_1@@1))) (>= (U_2_real (MapType1Select QPMask@2 a_1@@1 f_7)) FullPerm))
 :qid |stdinbpl.1504:17|
 :skolemid |191|
 :pattern ( (MapType0Select ExhaleHeap@0 a_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@3 a_1@@1 f_7))
 :pattern ( (MapType2Select (|Set#Difference| xs (|Set#Intersection| xs ys)) a_1@@1))
))) (=> (forall ((a_1@@2 T@U) ) (!  (=> (and (= (type a_1@@2) RefType) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Intersection| xs ys)) a_1@@2))) (>= (U_2_real (MapType1Select QPMask@2 a_1@@2 f_7)) FullPerm))
 :qid |stdinbpl.1504:17|
 :skolemid |191|
 :pattern ( (MapType0Select ExhaleHeap@0 a_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@3 a_1@@2 f_7))
 :pattern ( (MapType2Select (|Set#Difference| xs (|Set#Intersection| xs ys)) a_1@@2))
)) (=> (and (forall ((a_1@@3 T@U) ) (!  (=> (= (type a_1@@3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Intersection| xs ys)) a_1@@3)) (< NoPerm FullPerm)) (and (qpRange19 a_1@@3) (= (invRecv19 a_1@@3) a_1@@3))))
 :qid |stdinbpl.1510:22|
 :skolemid |192|
 :pattern ( (MapType0Select ExhaleHeap@0 a_1@@3 f_7))
 :pattern ( (MapType1Select QPMask@3 a_1@@3 f_7))
 :pattern ( (MapType2Select (|Set#Difference| xs (|Set#Intersection| xs ys)) a_1@@3))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Intersection| xs ys)) (invRecv19 o_3))) (and (< NoPerm FullPerm) (qpRange19 o_3))) (= (invRecv19 o_3) o_3)))
 :qid |stdinbpl.1514:22|
 :skolemid |193|
 :pattern ( (invRecv19 o_3))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Intersection| xs ys)) (invRecv19 o_3@@0))) (and (< NoPerm FullPerm) (qpRange19 o_3@@0))) (and (= (invRecv19 o_3@@0) o_3@@0) (= (U_2_real (MapType1Select QPMask@3 o_3@@0 f_7)) (- (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Intersection| xs ys)) (invRecv19 o_3@@0))) (and (< NoPerm FullPerm) (qpRange19 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@3 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7))))))
...
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 14)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (U_2_bool (MapType2Select (|Set#Intersection| xs ys) z_1))) (U_2_bool (MapType2Select (|Set#Intersection| xs ys) z_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1))))
 :qid |stdinbpl.1440:17|
 :skolemid |184|
 :pattern ( (neverTriggered18 z_1) (neverTriggered18 z_1_1))
))) (=> (forall ((z_1@@0 T@U) (z_1_1@@0 T@U) ) (!  (=> (and (= (type z_1@@0) RefType) (= (type z_1_1@@0) RefType)) (=> (and (and (and (and (not (= z_1@@0 z_1_1@@0)) (U_2_bool (MapType2Select (|Set#Intersection| xs ys) z_1@@0))) (U_2_bool (MapType2Select (|Set#Intersection| xs ys) z_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1@@0 z_1_1@@0))))
 :qid |stdinbpl.1440:17|
 :skolemid |184|
 :pattern ( (neverTriggered18 z_1@@0) (neverTriggered18 z_1_1@@0))
)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((z_1@@1 T@U) ) (!  (=> (and (= (type z_1@@1) RefType) (U_2_bool (MapType2Select (|Set#Intersection| xs ys) z_1@@1))) (>= (U_2_real (MapType1Select QPMask@1 z_1@@1 f_7)) FullPerm))
 :qid |stdinbpl.1447:17|
 :skolemid |185|
 :pattern ( (MapType0Select Heap@@9 z_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@2 z_1@@1 f_7))
 :pattern ( (MapType2Select (|Set#Intersection| xs ys) z_1@@1))
))) (=> (forall ((z_1@@2 T@U) ) (!  (=> (and (= (type z_1@@2) RefType) (U_2_bool (MapType2Select (|Set#Intersection| xs ys) z_1@@2))) (>= (U_2_real (MapType1Select QPMask@1 z_1@@2 f_7)) FullPerm))
 :qid |stdinbpl.1447:17|
 :skolemid |185|
 :pattern ( (MapType0Select Heap@@9 z_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@2 z_1@@2 f_7))
 :pattern ( (MapType2Select (|Set#Intersection| xs ys) z_1@@2))
)) (=> (and (forall ((z_1@@3 T@U) ) (!  (=> (= (type z_1@@3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Intersection| xs ys) z_1@@3)) (< NoPerm FullPerm)) (and (qpRange18 z_1@@3) (= (invRecv18 z_1@@3) z_1@@3))))
 :qid |stdinbpl.1453:22|
 :skolemid |186|
 :pattern ( (MapType0Select Heap@@9 z_1@@3 f_7))
 :pattern ( (MapType1Select QPMask@2 z_1@@3 f_7))
 :pattern ( (MapType2Select (|Set#Intersection| xs ys) z_1@@3))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Intersection| xs ys) (invRecv18 o_3@@2))) (and (< NoPerm FullPerm) (qpRange18 o_3@@2))) (= (invRecv18 o_3@@2) o_3@@2)))
 :qid |stdinbpl.1457:22|
 :skolemid |187|
 :pattern ( (invRecv18 o_3@@2))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType2Select (|Set#Intersection| xs ys) (invRecv18 o_3@@3))) (and (< NoPerm FullPerm) (qpRange18 o_3@@3))) (and (= (invRecv18 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@2 o_3@@3 f_7)) (- (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select (|Set#Intersection| xs ys) (invRecv18 o_3@@3))) (and (< NoPerm FullPerm) (qpRange18 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@2 o_3@@3 f_7)) (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7))))))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 ...
 :qid |stdinbpl.1469:29|
 :skolemid |189|
 :pattern ( (MapType1Select QPMask@2 o_3@@4 f_5@@0))
))) (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 QPMask@2) (state ExhaleHeap@0 QPMask@2))) (and (=> (= (ControlFlow 0 12) 4) anon14_Then_correct) (=> (= (ControlFlow 0 12) 9) anon14_Else_correct))))))))))
(let ((anon13_Then_correct true))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((y_1 T@U) (y_1_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (= (type y_1_1) RefType)) (=> (and (and (and (and (not (= y_1 y_1_1)) (U_2_bool (MapType2Select ys y_1))) (U_2_bool (MapType2Select ys y_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_1 y_1_1))))
...
))) (=> (forall ((y_1@@0 T@U) (y_1_1@@0 T@U) ) (!  (=> (and (= (type y_1@@0) RefType) (= (type y_1_1@@0) RefType)) (=> (and (and (and (and (not (= y_1@@0 y_1_1@@0)) (U_2_bool (MapType2Select ys y_1@@0))) (U_2_bool (MapType2Select ys y_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_1@@0 y_1_1@@0))))
 :qid |stdinbpl.1383:15|
 :skolemid |178|
...
)) (=> (forall ((y_1@@1 T@U) ) (!  (=> (= (type y_1@@1) RefType) (=> (and (U_2_bool (MapType2Select ys y_1@@1)) (< NoPerm FullPerm)) (and (qpRange17 y_1@@1) (= (invRecv17 y_1@@1) y_1@@1))))
 :qid |stdinbpl.1389:22|
 :skolemid |179|
 :pattern ( (MapType0Select Heap@@9 y_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 y_1@@1 f_7))
 :pattern ( (MapType2Select ys y_1@@1))
)) (=> (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (U_2_bool (MapType2Select ys (invRecv17 o_3@@5))) (< NoPerm FullPerm)) (qpRange17 o_3@@5)) (= (invRecv17 o_3@@5) o_3@@5)))
 :qid |stdinbpl.1393:22|
 :skolemid |180|
 :pattern ( (invRecv17 o_3@@5))
)) (forall ((y_1@@2 T@U) ) (!  (=> (and (= (type y_1@@2) RefType) (U_2_bool (MapType2Select ys y_1@@2))) (not (= y_1@@2 null)))
 :qid |stdinbpl.1399:22|
 :skolemid |181|
 :pattern ( (MapType0Select Heap@@9 y_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@1 y_1@@2 f_7))
 :pattern ( (MapType2Select ys y_1@@2))
))) (=> (and (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (U_2_bool (MapType2Select ys (invRecv17 o_3@@6))) (< NoPerm FullPerm)) (qpRange17 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv17 o_3@@6) o_3@@6)) (= (U_2_real (MapType1Select QPMask@1 o_3@@6 f_7)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select ys (invRecv17 o_3@@6))) (< NoPerm FullPerm)) (qpRange17 o_3@@6))) (= (U_2_real (MapType1Select QPMask@1 o_3@@6 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7))))))
...
))) (and (state Heap@@9 QPMask@1) (state Heap@@9 QPMask@1))) (and (=> (= (ControlFlow 0 15) 3) anon13_Then_correct) (=> (= (ControlFlow 0 15) 12) anon13_Else_correct)))))))))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select xs x_1))) (U_2_bool (MapType2Select xs x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs x_1@@1)) (< NoPerm FullPerm)) (and (qpRange16 x_1@@1) (= (invRecv16 x_1@@1) x_1@@1))))
...
)) (=> (and (forall ((o_3@@8 T@U) ) (!  (=> (= (type o_3@@8) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv16 o_3@@8))) (< NoPerm FullPerm)) (qpRange16 o_3@@8)) (= (invRecv16 o_3@@8) o_3@@8)))
...
))) (=> (and (and (forall ((o_3@@9 T@U) ) (!  (=> (= (type o_3@@9) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs (invRecv16 o_3@@9))) (< NoPerm FullPerm)) (qpRange16 o_3@@9)) (and (=> (< NoPerm FullPerm) (= (invRecv16 o_3@@9) o_3@@9)) (= (U_2_real (MapType1Select QPMask@0 o_3@@9 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@9 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select xs (invRecv16 o_3@@9))) (< NoPerm FullPerm)) (qpRange16 o_3@@9))) (= (U_2_real (MapType1Select QPMask@0 o_3@@9 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@9 f_7))))))
...
(let ((A@@15 (FieldTypeInv0 (type f_5@@2))))
 ...
 :qid |stdinbpl.1369:29|
 :skolemid |177|
 :pattern ( (MapType1Select ZeroMask o_3@@10 f_5@@2))
 :pattern ( (MapType1Select QPMask@0 o_3@@10 f_5@@2))
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 17) 2) anon12_Then_correct) (=> (= (ControlFlow 0 17) 15) anon12_Else_correct)))))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 19) 1) anon11_Then_correct) (=> (= (ControlFlow 0 19) 17) anon11_Else_correct)))))
