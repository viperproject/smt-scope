...
(set-info :boogie-vc-id Ref__loop_main_31)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 43) (let ((anon34_Then_correct  (and (=> (= (ControlFlow 0 25) (- 0 30)) (<= 0 i_1)) (=> (<= 0 i_1) (and (=> (= (ControlFlow 0 25) (- 0 29)) (< i_1 M)) (=> (< i_1 M) (and (=> (= (ControlFlow 0 25) (- 0 28)) (<= 0 M)) (=> (<= 0 M) (and (=> (= (ControlFlow 0 25) (- 0 27)) (<= 0 j_12)) (=> (<= 0 j_12) (and (=> (= (ControlFlow 0 25) (- 0 26)) (< j_12 N)) (=> (< j_12 N) (=> (= (ControlFlow 0 25) (- 0 24)) (<= 0 N))))))))))))))
(let ((anon18_correct true))
(let ((anon34_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 34)) (>= (Ref__multidim_index_2 PostHeap@0 M N i_1 j_12) 0)) (=> (>= (Ref__multidim_index_2 PostHeap@0 M N i_1 j_12) 0) (and (=> (= (ControlFlow 0 31) (- 0 33)) (< (Ref__multidim_index_2 PostHeap@0 M N i_1 j_12) (|Seq#Length| matrix))) (=> (< (Ref__multidim_index_2 PostHeap@0 M N i_1 j_12) (|Seq#Length| matrix)) (and (=> (= (ControlFlow 0 31) (- 0 32)) (HasDirectPerm QPMask@2 (|Seq#Index| matrix (Ref__multidim_index_2 PostHeap@0 M N i_1 j_12)) Ref__Integer_value)) (=> (HasDirectPerm QPMask@2 (|Seq#Index| matrix (Ref__multidim_index_2 PostHeap@0 M N i_1 j_12)) Ref__Integer_value) (=> (= (ControlFlow 0 31) 22) anon18_correct)))))))))
(let ((anon33_Then_correct  (=> (and (<= 0 i_1) (and (< i_1 M) (and (<= 0 j_12) (< j_12 N)))) (and (=> (= (ControlFlow 0 35) 25) anon34_Then_correct) (=> (= (ControlFlow 0 35) 31) anon34_Else_correct)))))
(let ((anon33_Else_correct  (=> (and (not (and (<= 0 i_1) (and (< i_1 M) (and (<= 0 j_12) (< j_12 N))))) (= (ControlFlow 0 23) 22)) anon18_correct)))
(let ((anon32_Else_correct true))
(let ((anon30_Else_correct  (and (=> (= (ControlFlow 0 36) (- 0 37)) (forall ((j_5 Int) (j_5_2 Int) ) (!  (=> (and (and (and (and (not (= j_5 j_5_2)) (and (<= 0 j_5) (< j_5 (* M N)))) (and (<= 0 j_5_2) (< j_5_2 (* M N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| matrix j_5) (|Seq#Index| matrix j_5_2))))
 ...
 :qid |stdinbpl.2054:15|
 :skolemid |173|
)) (=> (and (and (and (forall ((j_5@@1 Int) ) (!  (=> (and (and (<= 0 j_5@@1) (< j_5@@1 (* M N))) (< NoPerm FullPerm)) (and (qpRange10 (|Seq#Index| matrix j_5@@1)) (= (invRecv10 (|Seq#Index| matrix j_5@@1)) j_5@@1)))
...
))) (and (forall ((j_5@@2 Int) ) (!  (=> (and (<= 0 j_5@@2) (< j_5@@2 (* M N))) (not (= (|Seq#Index| matrix j_5@@2) null)))
...
(let ((anon31_Else_correct  (=> (and (not (and (<= 0 j_11) (< j_11 (* M N)))) (= (ControlFlow 0 20) 16)) anon12_correct)))
(let ((anon31_Then_correct  (=> (and (<= 0 j_11) (< j_11 (* M N))) (and (=> (= (ControlFlow 0 17) (- 0 19)) (>= j_11 0)) (=> (>= j_11 0) (and (=> (= (ControlFlow 0 17) (- 0 18)) (< j_11 (|Seq#Length| matrix))) (=> (< j_11 (|Seq#Length| matrix)) (=> (= (ControlFlow 0 17) 16) anon12_correct))))))))
...
(let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 39) (- 0 40)) (forall ((j_3 Int) (j_3_1 Int) ) (!  (=> (and (and (and (and (not (= j_3 j_3_1)) (and (<= 0 j_3) (< j_3 (* M N)))) (and (<= 0 j_3_1) (< j_3_1 (* M N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| matrix j_3) (|Seq#Index| matrix j_3_1))))
 ...
 :qid |stdinbpl.1997:15|
 :skolemid |167|
)) (=> (forall ((j_3@@1 Int) ) (!  (=> (and (and (<= 0 j_3@@1) (< j_3@@1 (* M N))) (< NoPerm FullPerm)) (and (qpRange9 (|Seq#Index| matrix j_3@@1)) (= (invRecv9 (|Seq#Index| matrix j_3@@1)) j_3@@1)))
...
)) (forall ((j_3@@2 Int) ) (!  (=> (and (<= 0 j_3@@2) (< j_3@@2 (* M N))) (not (= (|Seq#Index| matrix j_3@@2) null)))
...
(let ((anon28_Else_correct  (=> (and (not (and (<= 0 j_10) (< j_10 (* M N)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon28_Then_correct  (=> (and (<= 0 j_10) (< j_10 (* M N))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= j_10 0)) (=> (>= j_10 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< j_10 (|Seq#Length| matrix))) (=> (< j_10 (|Seq#Length| matrix)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon25_Else_correct  (=> (and (forall ((j_1_1 Int) (k_1_1 Int) ) (!  (=> (and (<= 0 j_1_1) (and (< j_1_1 (* M N)) (and (<= 0 k_1_1) (and (< k_1_1 (* M N)) (not (= j_1_1 k_1_1)))))) (not (= (|Seq#Index| matrix j_1_1) (|Seq#Index| matrix k_1_1))))
...
(let ((anon26_Else_correct  (=> (and (not (and (<= 0 j_9) (and (< j_9 (* M N)) (and (<= 0 k_13) (and (< k_13 (* M N)) (not (= j_9 k_13))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon26_Then_correct  (=> (and (<= 0 j_9) (and (< j_9 (* M N)) (and (<= 0 k_13) (and (< k_13 (* M N)) (not (= j_9 k_13)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j_9 0)) (=> (>= j_9 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j_9 (|Seq#Length| matrix))) (=> (< j_9 (|Seq#Length| matrix)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_13 0)) (=> (>= k_13 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_13 (|Seq#Length| matrix))) (=> (< k_13 (|Seq#Length| matrix)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
