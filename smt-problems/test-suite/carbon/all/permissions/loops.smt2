...
(assert  (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type x@@8) RefType)) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))))
...
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@2 x@@8 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 x@@8 f_7))) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
(let ((anon11_Then_correct  (=> (state ExhaleHeap@0 ZeroMask) (=> (and (and (not (= x@@8 null)) (= Mask@2 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm))))) (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm Mask@2 x@@8 f_7)) (=> (HasDirectPerm Mask@2 x@@8 f_7) (=> (and (< (U_2_int (MapType0Select ExhaleHeap@0 x@@8 f_7)) 3) (state ExhaleHeap@0 Mask@2)) (and (=> (= (ControlFlow 0 7) 4) anon12_Then_correct) (=> (= (ControlFlow 0 7) 6) anon12_Else_correct)))))))))
(let ((anon11_Else_correct true))
(let ((anon10_Then_correct true))
(let ((anon2_correct  (=> (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (- (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm)))) (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@0)) (and (and (=> (= (ControlFlow 0 9) 1) anon10_Then_correct) (=> (= (ControlFlow 0 9) 7) anon11_Then_correct)) (=> (= (ControlFlow 0 9) 2) anon11_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon2_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select ZeroMask x@@8 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select ZeroMask x@@8 f_7))) (=> (= (ControlFlow 0 10) 9) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (and (not (= x@@8 null)) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 13) 10) anon9_Then_correct) (=> (= (ControlFlow 0 13) 12) anon9_Else_correct)))))
