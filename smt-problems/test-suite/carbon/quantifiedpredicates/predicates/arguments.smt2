...
(assert  (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type this@@5) RefType)) (= (type Heap@@10) (MapType0Type RefType))))
(set-info :boogie-vc-id unrelated)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon4_correct true))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 this@@5 unrelatedField)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 this@@5 unrelatedField))) (=> (= (ControlFlow 0 3) 2) anon4_correct))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 this@@5 $allocated))) (=> (and (and (not (= this@@5 null)) (= Mask@0 (MapType1Store ZeroMask this@@5 unrelatedField (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@5 unrelatedField)) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct))))))
