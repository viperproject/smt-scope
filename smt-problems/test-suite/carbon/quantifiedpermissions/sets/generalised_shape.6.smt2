...
(assert  (and (and (and (and (and (= (type QPMask@0) (MapType1Type RefType realType)) (= (type x1_2) RefType)) (= (type Heap@@10) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv8 arg0@@48)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon8_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_1))) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 x1_2 g)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 x1_2 g))) (=> (= (ControlFlow 0 2) 1) anon6_correct))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (forall ((x_2 T@U) (x_2_1 T@U) ) (!  (=> (and (= (type x_2) RefType) (= (type x_2_1) RefType)) (=> (and (and (and (and (not (= x_2 x_2_1)) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_2))) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_2 x_2_1))))
 :qid |stdinbpl.1119:17|
 :skolemid |134|
 :pattern ( (neverTriggered8 x_2) (neverTriggered8 x_2_1))
))) (=> (forall ((x_2@@0 T@U) (x_2_1@@0 T@U) ) (!  (=> (and (= (type x_2@@0) RefType) (= (type x_2_1@@0) RefType)) (=> (and (and (and (and (not (= x_2@@0 x_2_1@@0)) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_2@@0))) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_2_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_2@@0 x_2_1@@0))))
 :qid |stdinbpl.1119:17|
 :skolemid |134|
 :pattern ( (neverTriggered8 x_2@@0) (neverTriggered8 x_2_1@@0))
)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((x_2@@1 T@U) ) (!  (=> (and (= (type x_2@@1) RefType) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_2@@1))) (>= (U_2_real (MapType1Select Mask@0 x_2@@1 g)) FullPerm))
 :qid |stdinbpl.1126:17|
 :skolemid |135|
 :pattern ( (MapType0Select Heap@@10 x_2@@1 g))
 :pattern ( (MapType1Select QPMask@0 x_2@@1 g))
 :pattern ( (MapType2Select (|Set#Singleton| x1_2) x_2@@1))
))) (=> (forall ((x_2@@2 T@U) ) (!  (=> (and (= (type x_2@@2) RefType) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_2@@2))) (>= (U_2_real (MapType1Select Mask@0 x_2@@2 g)) FullPerm))
 :qid |stdinbpl.1126:17|
 :skolemid |135|
 :pattern ( (MapType0Select Heap@@10 x_2@@2 g))
 :pattern ( (MapType1Select QPMask@0 x_2@@2 g))
 :pattern ( (MapType2Select (|Set#Singleton| x1_2) x_2@@2))
)) (=> (and (and (forall ((x_2@@3 T@U) ) (!  (=> (= (type x_2@@3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_2@@3)) (< NoPerm FullPerm)) (and (qpRange8 x_2@@3) (= (invRecv8 x_2@@3) x_2@@3))))
 :qid |stdinbpl.1132:22|
 :skolemid |136|
 :pattern ( (MapType0Select Heap@@10 x_2@@3 g))
 :pattern ( (MapType1Select QPMask@0 x_2@@3 g))
 :pattern ( (MapType2Select (|Set#Singleton| x1_2) x_2@@3))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Singleton| x1_2) (invRecv8 o_3))) (and (< NoPerm FullPerm) (qpRange8 o_3))) (= (invRecv8 o_3) o_3)))
 :qid |stdinbpl.1136:22|
 :skolemid |137|
 :pattern ( (invRecv8 o_3))
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType2Select (|Set#Singleton| x1_2) (invRecv8 o_3@@0))) (and (< NoPerm FullPerm) (qpRange8 o_3@@0))) (and (= (invRecv8 o_3@@0) o_3@@0) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 g)) (- (U_2_real (MapType1Select Mask@0 o_3@@0 g)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select (|Set#Singleton| x1_2) (invRecv8 o_3@@0))) (and (< NoPerm FullPerm) (qpRange8 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 g)) (U_2_real (MapType1Select Mask@0 o_3@@0 g))))))
 :qid |stdinbpl.1142:22|
 :skolemid |138|
 :pattern ( (MapType1Select QPMask@0 o_3@@0 g))
)) (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 g))) (= (U_2_real (MapType1Select Mask@0 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@0 o_3@@1 f_5))))))
...
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x1_2 $allocated))) (=> (and (and (not (= x1_2 null)) (= Mask@0 (MapType1Store ZeroMask x1_2 g (real_2_U (+ (U_2_real (MapType1Select ZeroMask x1_2 g)) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 12) 11) anon7_Then_correct) (=> (= (ControlFlow 0 12) 5) anon7_Else_correct))))))
