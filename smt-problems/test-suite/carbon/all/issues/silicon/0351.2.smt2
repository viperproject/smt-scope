...
(declare-fun |dummy'| (T@U Bool) Bool)
...
(declare-fun |dummy#frame| (T@U Bool) Bool)
(declare-fun dummy (T@U Bool) Bool)
...
(assert (forall ((Heap@@2 T@U) (b_2 Bool) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (bool_2_U (|dummy#triggerStateless| b_2))))
 :qid |stdinbpl.430:15|
 :skolemid |83|
 :pattern ( (|dummy'| Heap@@2 b_2))
)))
...
(assert (forall ((Heap@@6 T@U) (Mask@@6 T@U) (b_2@@0 Bool) ) (!  (=> (and (and (= (type Heap@@6) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (state Heap@@6 Mask@@6)) (= (|dummy'| Heap@@6 b_2@@0) (|dummy#frame| EmptyFrame b_2@@0)))
 :qid |stdinbpl.437:15|
 :skolemid |84|
 :pattern ( (state Heap@@6 Mask@@6) (|dummy'| Heap@@6 b_2@@0))
)))
...
(assert (forall ((Heap@@7 T@U) (b_2@@1 Bool) ) (!  (=> (= (type Heap@@7) (MapType0Type RefType)) (and (= (dummy Heap@@7 b_2@@1) (|dummy'| Heap@@7 b_2@@1)) (dummyFunction (bool_2_U (|dummy#triggerStateless| b_2@@1)))))
 :qid |stdinbpl.426:15|
 :skolemid |82|
 :pattern ( (dummy Heap@@7 b_2@@1))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (= (type g) (MapType2Type RefType boolType)) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv5 arg0@@43)) RefType)
 :qid |funType:invRecv5|
 :pattern ( (invRecv5 arg0@@43))
))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type QPMask@3) (MapType1Type RefType realType))) (= (type Heap@@12) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv4 arg0@@44)) RefType)
 :qid |funType:invRecv4|
 :pattern ( (invRecv4 arg0@@44))
))) (= (type PostHeap@0) (MapType0Type RefType))) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv1 arg0@@45)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon13_Else_correct  (=> (= (ControlFlow 0 15) (- 0 14)) (forall ((n_0_3 T@U) (n_0_3_1 T@U) ) (!  (=> (and (= (type n_0_3) RefType) (= (type n_0_3_1) RefType)) (=> (and (and (and (and (not (= n_0_3 n_0_3_1)) (U_2_bool (MapType2Select g n_0_3))) (U_2_bool (MapType2Select g n_0_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_0_3 n_0_3_1))))
 :qid |stdinbpl.539:15|
 :skolemid |91|
 :no-pattern (type n_0_3)
 :no-pattern (type n_0_3_1)
 :no-pattern (U_2_int n_0_3)
 :no-pattern (U_2_bool n_0_3)
 :no-pattern (U_2_int n_0_3_1)
 :no-pattern (U_2_bool n_0_3_1)
)))))
...
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 8)) (forall ((n_0_8 T@U) (n_0_8_1 T@U) ) (!  (=> (and (= (type n_0_8) RefType) (= (type n_0_8_1) RefType)) (=> (and (and (and (and (not (= n_0_8 n_0_8_1)) (U_2_bool (MapType2Select g n_0_8))) (U_2_bool (MapType2Select g n_0_8_1))) (< NoPerm (/ (to_real 1) (to_real 1)))) (< NoPerm (/ (to_real 1) (to_real 1)))) (not (= n_0_8 n_0_8_1))))
 :qid |stdinbpl.647:15|
 :skolemid |104|
 :no-pattern (type n_0_8)
 :no-pattern (type n_0_8_1)
 :no-pattern (U_2_int n_0_8)
 :no-pattern (U_2_bool n_0_8)
 :no-pattern (U_2_int n_0_8_1)
 :no-pattern (U_2_bool n_0_8_1)
))) (=> (forall ((n_0_8@@0 T@U) (n_0_8_1@@0 T@U) ) (!  (=> (and (= (type n_0_8@@0) RefType) (= (type n_0_8_1@@0) RefType)) (=> (and (and (and (and (not (= n_0_8@@0 n_0_8_1@@0)) (U_2_bool (MapType2Select g n_0_8@@0))) (U_2_bool (MapType2Select g n_0_8_1@@0))) (< NoPerm (/ (to_real 1) (to_real 1)))) (< NoPerm (/ (to_real 1) (to_real 1)))) (not (= n_0_8@@0 n_0_8_1@@0))))
 :qid |stdinbpl.647:15|
 :skolemid |104|
 :no-pattern (type n_0_8@@0)
 :no-pattern (type n_0_8_1@@0)
 :no-pattern (U_2_int n_0_8@@0)
 :no-pattern (U_2_bool n_0_8@@0)
 :no-pattern (U_2_int n_0_8_1@@0)
 :no-pattern (U_2_bool n_0_8_1@@0)
)) (=> (and (forall ((n_0_8@@1 T@U) ) (!  (=> (= (type n_0_8@@1) RefType) (=> (and (U_2_bool (MapType2Select g n_0_8@@1)) (< NoPerm (/ (to_real 1) (to_real 1)))) (and (qpRange5 n_0_8@@1) (= (invRecv5 n_0_8@@1) n_0_8@@1))))
 :qid |stdinbpl.653:22|
 :skolemid |105|
 :pattern ( (MapType0Select ExhaleHeap@0 n_0_8@@1 next))
 :pattern ( (MapType1Select QPMask@2 n_0_8@@1 next))
 :pattern ( (MapType0Select ExhaleHeap@0 n_0_8@@1 next))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select g (invRecv5 o_3))) (< NoPerm (/ (to_real 1) (to_real 1)))) (qpRange5 o_3)) (= (invRecv5 o_3) o_3)))
 :qid |stdinbpl.657:22|
 :skolemid |106|
 :pattern ( (invRecv5 o_3))
))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (forall ((n_0_8@@2 T@U) ) (!  (=> (and (= (type n_0_8@@2) RefType) (U_2_bool (MapType2Select g n_0_8@@2))) (>= (/ (to_real 1) (to_real 1)) NoPerm))
 :qid |stdinbpl.663:15|
 :skolemid |107|
 :pattern ( (MapType0Select ExhaleHeap@0 n_0_8@@2 next))
 :pattern ( (MapType1Select QPMask@2 n_0_8@@2 next))
 :pattern ( (MapType0Select ExhaleHeap@0 n_0_8@@2 next))
))) (=> (forall ((n_0_8@@3 T@U) ) (!  (=> (and (= (type n_0_8@@3) RefType) (U_2_bool (MapType2Select g n_0_8@@3))) (>= (/ (to_real 1) (to_real 1)) NoPerm))
 :qid |stdinbpl.663:15|
 :skolemid |107|
 :pattern ( (MapType0Select ExhaleHeap@0 n_0_8@@3 next))
 :pattern ( (MapType1Select QPMask@2 n_0_8@@3 next))
 :pattern ( (MapType0Select ExhaleHeap@0 n_0_8@@3 next))
)) (=> (and (forall ((n_0_8@@4 T@U) ) (!  (=> (= (type n_0_8@@4) RefType) (=> (and (U_2_bool (MapType2Select g n_0_8@@4)) (> (/ (to_real 1) (to_real 1)) NoPerm)) (not (= n_0_8@@4 null))))
 :qid |stdinbpl.669:22|
 :skolemid |108|
 :pattern ( (MapType0Select ExhaleHeap@0 n_0_8@@4 next))
 :pattern ( (MapType1Select QPMask@2 n_0_8@@4 next))
 :pattern ( (MapType0Select ExhaleHeap@0 n_0_8@@4 next))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select g (invRecv5 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 1)))) (qpRange5 o_3@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 1))) (= (invRecv5 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 next)) (+ (U_2_real (MapType1Select QPMask@1 o_3@@0 next)) (/ (to_real 1) (to_real 1)))))) (=> (not (and (and (U_2_bool (MapType2Select g (invRecv5 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 1)))) (qpRange5 o_3@@0))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 next)) (U_2_real (MapType1Select QPMask@1 o_3@@0 next))))))
 :qid |stdinbpl.675:22|
 :skolemid |109|
...
)) (state ExhaleHeap@0 QPMask@2)) (and (state ExhaleHeap@0 QPMask@2) (state ExhaleHeap@0 QPMask@2))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((n_0_4 T@U) (n_0_4_1 T@U) ) (!  (=> (and (= (type n_0_4) RefType) (= (type n_0_4_1) RefType)) (=> (and (and (and (and (not (= n_0_4 n_0_4_1)) (U_2_bool (MapType2Select g n_0_4))) (U_2_bool (MapType2Select g n_0_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_0_4 n_0_4_1))))
 :qid |stdinbpl.698:17|
 :skolemid |111|
 :pattern ( (neverTriggered3 n_0_4) (neverTriggered3 n_0_4_1))
))) (=> (forall ((n_0_4@@0 T@U) (n_0_4_1@@0 T@U) ) (!  (=> (and (= (type n_0_4@@0) RefType) (= (type n_0_4_1@@0) RefType)) (=> (and (and (and (and (not (= n_0_4@@0 n_0_4_1@@0)) (U_2_bool (MapType2Select g n_0_4@@0))) (U_2_bool (MapType2Select g n_0_4_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_0_4@@0 n_0_4_1@@0))))
 :qid |stdinbpl.698:17|
 :skolemid |111|
 :pattern ( (neverTriggered3 n_0_4@@0) (neverTriggered3 n_0_4_1@@0))
)) (=> (= (ControlFlow 0 5) (- 0 4)) (forall ((n_0_4@@1 T@U) ) (!  (=> (and (= (type n_0_4@@1) RefType) (U_2_bool (MapType2Select g n_0_4@@1))) (>= (U_2_real (MapType1Select QPMask@2 n_0_4@@1 next)) FullPerm))
 :qid |stdinbpl.705:17|
 :skolemid |112|
 :pattern ( (MapType0Select ExhaleHeap@0 n_0_4@@1 next))
 :pattern ( (MapType1Select QPMask@3 n_0_4@@1 next))
 :pattern ( (MapType0Select ExhaleHeap@0 n_0_4@@1 next))
))))))))))))))
(let ((anon15_Then_correct true))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 12)) (forall ((n_0_6 T@U) ) (!  (=> (= (type n_0_6) RefType) (=> (and (U_2_bool (MapType2Select g n_0_6)) (dummyFunction (MapType0Select Heap@@12 n_0_6 next))) (>= (/ (to_real 1) (to_real 1)) NoPerm)))
 :qid |stdinbpl.590:17|
 :skolemid |97|
 :pattern ( (MapType0Select Heap@@12 n_0_6 next))
 :pattern ( (MapType1Select QPMask@1 n_0_6 next))
 :pattern ( (MapType0Select Heap@@12 n_0_6 next))
))) (=> (forall ((n_0_6@@0 T@U) ) (!  (=> (= (type n_0_6@@0) RefType) (=> (and (U_2_bool (MapType2Select g n_0_6@@0)) (dummyFunction (MapType0Select Heap@@12 n_0_6@@0 next))) (>= (/ (to_real 1) (to_real 1)) NoPerm)))
 :qid |stdinbpl.590:17|
 :skolemid |97|
 :pattern ( (MapType0Select Heap@@12 n_0_6@@0 next))
 :pattern ( (MapType1Select QPMask@1 n_0_6@@0 next))
 :pattern ( (MapType0Select Heap@@12 n_0_6@@0 next))
)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (forall ((n_0_6@@1 T@U) (n_0_6_1 T@U) ) (!  (=> (and (= (type n_0_6@@1) RefType) (= (type n_0_6_1) RefType)) (=> (and (and (and (and (not (= n_0_6@@1 n_0_6_1)) (U_2_bool (MapType2Select g n_0_6@@1))) (U_2_bool (MapType2Select g n_0_6_1))) (< NoPerm (/ (to_real 1) (to_real 1)))) (< NoPerm (/ (to_real 1) (to_real 1)))) (not (= n_0_6@@1 n_0_6_1))))
 :qid |stdinbpl.597:17|
 :skolemid |98|
 :pattern ( (neverTriggered4 n_0_6@@1) (neverTriggered4 n_0_6_1))
))) (=> (forall ((n_0_6@@2 T@U) (n_0_6_1@@0 T@U) ) (!  (=> (and (= (type n_0_6@@2) RefType) (= (type n_0_6_1@@0) RefType)) (=> (and (and (and (and (not (= n_0_6@@2 n_0_6_1@@0)) (U_2_bool (MapType2Select g n_0_6@@2))) (U_2_bool (MapType2Select g n_0_6_1@@0))) (< NoPerm (/ (to_real 1) (to_real 1)))) (< NoPerm (/ (to_real 1) (to_real 1)))) (not (= n_0_6@@2 n_0_6_1@@0))))
 :qid |stdinbpl.597:17|
 :skolemid |98|
 :pattern ( (neverTriggered4 n_0_6@@2) (neverTriggered4 n_0_6_1@@0))
)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((n_0_6@@3 T@U) ) (!  (=> (and (= (type n_0_6@@3) RefType) (U_2_bool (MapType2Select g n_0_6@@3))) (>= (U_2_real (MapType1Select QPMask@0 n_0_6@@3 next)) (/ (to_real 1) (to_real 1))))
 :qid |stdinbpl.604:17|
 :skolemid |99|
 :pattern ( (MapType0Select Heap@@12 n_0_6@@3 next))
 :pattern ( (MapType1Select QPMask@1 n_0_6@@3 next))
 :pattern ( (MapType0Select Heap@@12 n_0_6@@3 next))
))) (=> (forall ((n_0_6@@4 T@U) ) (!  (=> (and (= (type n_0_6@@4) RefType) (U_2_bool (MapType2Select g n_0_6@@4))) (>= (U_2_real (MapType1Select QPMask@0 n_0_6@@4 next)) (/ (to_real 1) (to_real 1))))
 :qid |stdinbpl.604:17|
 :skolemid |99|
 :pattern ( (MapType0Select Heap@@12 n_0_6@@4 next))
 :pattern ( (MapType1Select QPMask@1 n_0_6@@4 next))
 :pattern ( (MapType0Select Heap@@12 n_0_6@@4 next))
)) (=> (and (forall ((n_0_6@@5 T@U) ) (!  (=> (= (type n_0_6@@5) RefType) (=> (and (U_2_bool (MapType2Select g n_0_6@@5)) (< NoPerm (/ (to_real 1) (to_real 1)))) (and (qpRange4 n_0_6@@5) (= (invRecv4 n_0_6@@5) n_0_6@@5))))
 :qid |stdinbpl.610:22|
 :skolemid |100|
 :pattern ( (MapType0Select Heap@@12 n_0_6@@5 next))
 :pattern ( (MapType1Select QPMask@1 n_0_6@@5 next))
 :pattern ( (MapType0Select Heap@@12 n_0_6@@5 next))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType2Select g (invRecv4 o_3@@2))) (and (< NoPerm (/ (to_real 1) (to_real 1))) (qpRange4 o_3@@2))) (= (invRecv4 o_3@@2) o_3@@2)))
 :qid |stdinbpl.614:22|
 :skolemid |101|
 :pattern ( (invRecv4 o_3@@2))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType2Select g (invRecv4 o_3@@3))) (and (< NoPerm (/ (to_real 1) (to_real 1))) (qpRange4 o_3@@3))) (and (= (invRecv4 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 next)) (- (U_2_real (MapType1Select QPMask@0 o_3@@3 next)) (/ (to_real 1) (to_real 1)))))) (=> (not (and (U_2_bool (MapType2Select g (invRecv4 o_3@@3))) (and (< NoPerm (/ (to_real 1) (to_real 1))) (qpRange4 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 next)) (U_2_real (MapType1Select QPMask@0 o_3@@3 next))))))
 :qid |stdinbpl.620:22|
 :skolemid |102|
...
))) (and (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@0 QPMask@1) (state ExhaleHeap@0 QPMask@1))) (and (=> (= (ControlFlow 0 9) 3) anon15_Then_correct) (=> (= (ControlFlow 0 9) 5) anon15_Else_correct))))))))))))
(let ((anon14_Then_correct true))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((n_0_1 T@U) (n_0_1_1 T@U) ) (!  (=> (and (= (type n_0_1) RefType) (= (type n_0_1_1) RefType)) (=> (and (and (and (and (not (= n_0_1 n_0_1_1)) (U_2_bool (MapType2Select g n_0_1))) (U_2_bool (MapType2Select g n_0_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_0_1 n_0_1_1))))
 :qid |stdinbpl.488:15|
 :skolemid |85|
 :no-pattern (type n_0_1)
 :no-pattern (type n_0_1_1)
 :no-pattern (U_2_int n_0_1)
 :no-pattern (U_2_bool n_0_1)
 :no-pattern (U_2_int n_0_1_1)
 :no-pattern (U_2_bool n_0_1_1)
))) (=> (forall ((n_0_1@@0 T@U) (n_0_1_1@@0 T@U) ) (!  (=> (and (= (type n_0_1@@0) RefType) (= (type n_0_1_1@@0) RefType)) (=> (and (and (and (and (not (= n_0_1@@0 n_0_1_1@@0)) (U_2_bool (MapType2Select g n_0_1@@0))) (U_2_bool (MapType2Select g n_0_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_0_1@@0 n_0_1_1@@0))))
 :qid |stdinbpl.488:15|
 :skolemid |85|
 :no-pattern (type n_0_1@@0)
 :no-pattern (type n_0_1_1@@0)
 :no-pattern (U_2_int n_0_1@@0)
 :no-pattern (U_2_bool n_0_1@@0)
 :no-pattern (U_2_int n_0_1_1@@0)
 :no-pattern (U_2_bool n_0_1_1@@0)
)) (=> (forall ((n_0_1@@1 T@U) ) (!  (=> (= (type n_0_1@@1) RefType) (=> (and (U_2_bool (MapType2Select g n_0_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 n_0_1@@1) (= (invRecv1 n_0_1@@1) n_0_1@@1))))
 :qid |stdinbpl.494:22|
 :skolemid |86|
 :pattern ( (MapType0Select Heap@@12 n_0_1@@1 next))
 :pattern ( (MapType1Select QPMask@0 n_0_1@@1 next))
 :pattern ( (MapType0Select Heap@@12 n_0_1@@1 next))
)) (=> (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (U_2_bool (MapType2Select g (invRecv1 o_3@@5))) (< NoPerm FullPerm)) (qpRange1 o_3@@5)) (= (invRecv1 o_3@@5) o_3@@5)))
 :qid |stdinbpl.498:22|
 :skolemid |87|
 :pattern ( (invRecv1 o_3@@5))
)) (forall ((n_0_1@@2 T@U) ) (!  (=> (and (= (type n_0_1@@2) RefType) (U_2_bool (MapType2Select g n_0_1@@2))) (not (= n_0_1@@2 null)))
 :qid |stdinbpl.504:22|
 :skolemid |88|
 :pattern ( (MapType0Select Heap@@12 n_0_1@@2 next))
 :pattern ( (MapType1Select QPMask@0 n_0_1@@2 next))
 :pattern ( (MapType0Select Heap@@12 n_0_1@@2 next))
))) (=> (and (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (U_2_bool (MapType2Select g (invRecv1 o_3@@6))) (< NoPerm FullPerm)) (qpRange1 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@6) o_3@@6)) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 next)) (+ (U_2_real (MapType1Select ZeroMask o_3@@6 next)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select g (invRecv1 o_3@@6))) (< NoPerm FullPerm)) (qpRange1 o_3@@6))) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 next)) (U_2_real (MapType1Select ZeroMask o_3@@6 next))))))
 :qid |stdinbpl.510:22|
 :skolemid |89|
...
))) (and (state Heap@@12 QPMask@0) (state Heap@@12 QPMask@0))) (and (and (=> (= (ControlFlow 0 17) 16) anon12_Then_correct) (=> (= (ControlFlow 0 17) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 17) 9) anon14_Else_correct)))))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@12 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 19) 1) anon11_Then_correct) (=> (= (ControlFlow 0 19) 17) anon11_Else_correct)))))
