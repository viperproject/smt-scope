...
(assert  (and (= (type Heap@@19) (MapType0Type RefType)) (= (type this@@9) RefType)))
(set-info :boogie-vc-id |postFunction#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@19 this@@9 $allocated)) (= AssumeFunctionsAbove 0)) (and (not (= this@@9 null)) (state Heap@@19 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm ZeroMask this@@9 x@@8)) (=> (HasDirectPerm ZeroMask this@@9 x@@8) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (MapType0Select Heap@@19 this@@9 x@@8)) 0))))))))
