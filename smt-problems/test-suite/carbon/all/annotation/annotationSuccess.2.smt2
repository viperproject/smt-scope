...
(assert (forall ((Heap@@4 T@U) (x@@11 T@U) ) (!  (=> (and (= (type Heap@@4) (MapType0Type RefType)) (= (type x@@11) RefType)) (|P#everUsed| (P x@@11)))
 :qid |stdinbpl.346:15|
 :skolemid |33|
 :pattern ( (|P#trigger| Heap@@4 (P x@@11)))
)))
...
(assert (forall ((Heap@@7 T@U) (Mask@@4 T@U) (x@@14 T@U) (y@@3 T@U) (b_2@@1 Bool) ) (!  (=> (and (and (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type Mask@@4) (MapType1Type RefType realType))) (= (type x@@14) RefType)) (= (type y@@3) RefType)) (state Heap@@7 Mask@@4)) (= (|fun01'| Heap@@7 x@@14 y@@3 b_2@@1) (|fun01#frame| (FrameFragment (ite b_2@@1 (FrameFragment (MapType0Select Heap@@7 x@@14 f_7)) (FrameFragment (MapType0Select Heap@@7 y@@3 f_7)))) x@@14 y@@3 b_2@@1)))
 :qid |stdinbpl.218:15|
 :skolemid |24|
 :pattern ( (state Heap@@7 Mask@@4) (|fun01'| Heap@@7 x@@14 y@@3 b_2@@1))
)))
...
(assert (forall ((arg0@@29 T@U) (arg1@@10 T@U) ) (! (= (type (CombineFrames arg0@@29 arg1@@10)) FrameTypeType)
 :qid |funType:CombineFrames|
 :pattern ( (CombineFrames arg0@@29 arg1@@10))
)))
(assert (forall ((Heap@@9 T@U) (Mask@@7 T@U) (x@@15 T@U) (y@@4 T@U) (b_2@@2 Bool) ) (!  (=> (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (= (type x@@15) RefType)) (= (type y@@4) RefType)) (state Heap@@9 Mask@@7)) (= (|fun02'| Heap@@9 x@@15 y@@4 b_2@@2) (|fun02#frame| (CombineFrames (ConditionalFrame (ite b_2@@2 FullPerm NoPerm) (FrameFragment (MapType0Select Heap@@9 x@@15 f_7))) (ConditionalFrame (ite  (not b_2@@2) FullPerm NoPerm) (FrameFragment (MapType0Select Heap@@9 y@@4 f_7)))) x@@15 y@@4 b_2@@2)))
 :qid |stdinbpl.275:15|
 :skolemid |27|
 :pattern ( (state Heap@@9 Mask@@7) (|fun02'| Heap@@9 x@@15 y@@4 b_2@@2))
)))
(assert (forall ((Heap@@10 T@U) (x@@16 T@U) (y@@5 T@U) (b_2@@3 Bool) ) (!  (=> (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type x@@16) RefType)) (= (type y@@5) RefType)) (and (= (fun01 Heap@@10 x@@16 y@@5 b_2@@3) (|fun01'| Heap@@10 x@@16 y@@5 b_2@@3)) (dummyFunction (int_2_U (|fun01#triggerStateless| x@@16 y@@5 b_2@@3)))))
 :qid |stdinbpl.207:15|
 :skolemid |22|
 :pattern ( (fun01 Heap@@10 x@@16 y@@5 b_2@@3))
)))
(assert (forall ((Heap@@11 T@U) (x@@17 T@U) (y@@6 T@U) (b_2@@4 Bool) ) (!  (=> (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type x@@17) RefType)) (= (type y@@6) RefType)) (and (= (fun02 Heap@@11 x@@17 y@@6 b_2@@4) (|fun02'| Heap@@11 x@@17 y@@6 b_2@@4)) (dummyFunction (int_2_U (|fun02#triggerStateless| x@@17 y@@6 b_2@@4)))))
 :qid |stdinbpl.264:15|
 :skolemid |25|
 :pattern ( (fun02 Heap@@11 x@@17 y@@6 b_2@@4))
)))
...
(assert  (and (and (and (and (and (and (and (= (type Heap@0) (MapType0Type RefType)) (= (type x@@20) RefType)) (= (type y@@7) RefType)) (= (type ExhaleWellDef0Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@16) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id m)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((anon5_correct true))
(let ((anon15_Else_correct  (=> (and (= NoPerm NoPerm) (= (ControlFlow 0 19) 16)) anon5_correct)))
(let ((anon15_Then_correct  (=> (not (= NoPerm NoPerm)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (<= NoPerm (U_2_real (MapType1Select Mask@2 y@@7 f_7)))) (=> (<= NoPerm (U_2_real (MapType1Select Mask@2 y@@7 f_7))) (=> (= (ControlFlow 0 17) 16) anon5_correct))))))
(let ((anon3_correct  (=> (= Mask@2 (MapType1Store Mask@1 x@@20 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 x@@20 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (>= NoPerm NoPerm)) (=> (>= NoPerm NoPerm) (and (=> (= (ControlFlow 0 20) 17) anon15_Then_correct) (=> (= (ControlFlow 0 20) 19) anon15_Else_correct)))))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 24) 20)) anon3_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@20 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@20 f_7))) (=> (= (ControlFlow 0 22) 20) anon3_correct))))))
(let ((anon13_Then_correct  (and (=> (= (ControlFlow 0 25) (- 0 26)) (>= FullPerm NoPerm)) (=> (>= FullPerm NoPerm) (and (=> (= (ControlFlow 0 25) 22) anon14_Then_correct) (=> (= (ControlFlow 0 25) 24) anon14_Else_correct))))))
(let ((anon11_correct true))
(let ((anon18_Else_correct  (=> (and (= NoPerm NoPerm) (= (ControlFlow 0 6) 3)) anon11_correct)))
(let ((anon18_Then_correct  (=> (not (= NoPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= NoPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@0 y@@7 f_7)))) (=> (<= NoPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@0 y@@7 f_7))) (=> (= (ControlFlow 0 4) 3) anon11_correct))))))
(let ((anon9_correct  (=> (= ExhaleWellDef0Mask@0 (MapType1Store Mask@1 x@@20 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 x@@20 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (>= NoPerm NoPerm)) (=> (>= NoPerm NoPerm) (and (=> (= (ControlFlow 0 7) 4) anon18_Then_correct) (=> (= (ControlFlow 0 7) 6) anon18_Else_correct)))))))
(let ((anon17_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 7)) anon9_correct)))
(let ((anon17_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@20 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@20 f_7))) (=> (= (ControlFlow 0 9) 7) anon9_correct))))))
(let ((anon16_Then_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (>= FullPerm NoPerm)) (=> (>= FullPerm NoPerm) (and (=> (= (ControlFlow 0 12) 9) anon17_Then_correct) (=> (= (ControlFlow 0 12) 11) anon17_Else_correct))))))
(let ((anon16_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= tmp@0 (fun02 Heap@0 x@@20 y@@7 true)))))
(let ((anon13_Else_correct  (=> (and (= tmp@0 (fun02 Heap@@16 x@@20 y@@7 true)) (state Heap@@16 Mask@1)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (= FullPerm (U_2_real (MapType1Select Mask@1 y@@7 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 y@@7 f_7))) (=> (and (= Heap@0 (MapType0Store Heap@@16 y@@7 f_7 (int_2_U 1))) (state Heap@0 Mask@1)) (and (=> (= (ControlFlow 0 14) 12) anon16_Then_correct) (=> (= (ControlFlow 0 14) 2) anon16_Else_correct))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@16 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@16 x@@20 $allocated)) (U_2_bool (MapType0Select Heap@@16 y@@7 $allocated)))) (=> (and (and (and (not (= x@@20 null)) (= Mask@0 (MapType1Store ZeroMask x@@20 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@20 f_7)) FullPerm))))) (and (state Heap@@16 Mask@0) (state Heap@@16 Mask@0))) (and (and (not (= y@@7 null)) (= Mask@1 (MapType1Store Mask@0 y@@7 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@7 f_7)) FullPerm))))) (and (state Heap@@16 Mask@1) (state Heap@@16 Mask@1)))) (and (=> (= (ControlFlow 0 27) 25) anon13_Then_correct) (=> (= (ControlFlow 0 27) 14) anon13_Else_correct))))))
