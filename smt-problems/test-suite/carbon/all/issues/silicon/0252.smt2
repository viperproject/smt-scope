...
(assert  (and (and (and (and (= (type arr1) IArrayDomainTypeType) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type arr2) IArrayDomainTypeType)))
...
(assert (not
 ...
 :pattern ( (loc arr1 i_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (< NoPerm (ite  (and (<= 0 (invRecv1 o_3)) (< (invRecv1 o_3) 10)) FullPerm NoPerm)) (qpRange1 o_3)) (= (loc arr1 (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.322:22|
 :skolemid |32|
 ...
 :pattern ( (loc arr1 i_1@@4))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (< NoPerm (ite  (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) 10)) FullPerm NoPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm (ite  (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) 10)) FullPerm NoPerm)) (= (loc arr1 (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) (ite  (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) 10)) FullPerm NoPerm))))) (=> (not (and (< NoPerm (ite  (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) 10)) FullPerm NoPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.340:22|
 :skolemid |35|
...
)) (state Heap@@10 QPMask@0)) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= FullPerm (U_2_real (MapType1Select QPMask@0 (loc arr1 0) val)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 (loc arr1 0) val))) (=> (= Heap@0 (MapType0Store Heap@@10 (loc arr1 0) val (int_2_U 0))) (=> (and (state Heap@0 QPMask@0) (= (ControlFlow 0 3) (- 0 2))) (= FullPerm (U_2_real (MapType1Select QPMask@0 (loc arr2 0) val))))))))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (and (=> (= (ControlFlow 0 7) 1) anon3_Then_correct) (=> (= (ControlFlow 0 7) 3) anon3_Else_correct)))))
