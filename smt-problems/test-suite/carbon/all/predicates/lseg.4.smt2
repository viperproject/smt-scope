...
(declare-fun |get#trigger| (T@U T@U Int T@U) Bool)
(declare-fun i@@3 () Int)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 29) (let ((anon17_correct true))
(let ((anon25_Else_correct  (=> (= (MapType0Select Heap@1 this@@14 next) end@@14) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 13) 11)) anon17_correct))))
(let ((anon25_Then_correct  (=> (not (= (MapType0Select Heap@1 this@@14 next) end@@14)) (=> (and (and (forall ((o_3 T@U) (f_7 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_7))))
(let ((A@@12 (FieldTypeInv0 (type f_7))))
 (=> (and (and (= (type o_3) RefType) (= (type f_7) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|lseg#sm| this@@14 end@@14)) o_3 f_7)) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|lseg#sm| (MapType0Select Heap@1 this@@14 next) end@@14)) o_3 f_7)))) (U_2_bool (MapType1Select newPMask@0 o_3 f_7)))))
 :qid |stdinbpl.343:33|
 :skolemid |26|
 :pattern ( (MapType1Select newPMask@0 o_3 f_7))
)) (= Heap@2 (MapType0Store Heap@1 null (|lseg#sm| this@@14 end@@14) newPMask@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 12) 11))) anon17_correct))))
(let ((anon15_correct  (=> (and (= Heap@0 (MapType0Store Heap@@19 null (|lseg#sm| this@@14 end@@14) (MapType1Store (MapType0Select Heap@@19 null (|lseg#sm| this@@14 end@@14)) this@@14 value (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|lseg#sm| this@@14 end@@14) (MapType1Store (MapType0Select Heap@0 null (|lseg#sm| this@@14 end@@14)) this@@14 next (bool_2_U true))))) (and (=> (= (ControlFlow 0 14) 12) anon25_Then_correct) (=> (= (ControlFlow 0 14) 13) anon25_Else_correct)))))
(let ((anon23_Else_correct  (=> (and (|get#trigger| (MapType0Select Heap@@19 null (lseg (MapType0Select Heap@@19 this@@14 next) end@@14)) (MapType0Select Heap@@19 this@@14 next) (- i@@3 1) end@@14) (= (ControlFlow 0 17) 14)) anon15_correct)))
(let ((anon22_Then_correct  (=> (= i@@3 0) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm UnfoldingMask@4 this@@14 value)) (=> (HasDirectPerm UnfoldingMask@4 this@@14 value) (=> (= (ControlFlow 0 15) 14) anon15_correct))))))
(let ((anon13_correct  (=> (= UnfoldingMask@5 (MapType1Store UnfoldingMask@4 null (lseg (MapType0Select Heap@@19 this@@14 next) end@@14) (real_2_U (- (U_2_real (MapType1Select UnfoldingMask@4 null (lseg (MapType0Select Heap@@19 this@@14 next) end@@14))) FullPerm)))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= 0 (- i@@3 1))) (=> (<= 0 (- i@@3 1)) (=> (= (ControlFlow 0 6) (- 0 5)) (< (- i@@3 1) (length Heap@@19 (MapType0Select Heap@@19 this@@14 next) end@@14))))))))
(let ((anon24_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 6)) anon13_correct)))
(let ((anon24_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (lseg (MapType0Select Heap@@19 this@@14 next) end@@14))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (lseg (MapType0Select Heap@@19 this@@14 next) end@@14)))) (=> (= (ControlFlow 0 8) 6) anon13_correct))))))
(let ((anon22_Else_correct  (=> (not (= i@@3 0)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm UnfoldingMask@4 this@@14 next)) (=> (HasDirectPerm UnfoldingMask@4 this@@14 next) (and (and (=> (= (ControlFlow 0 18) 17) anon23_Else_correct) (=> (= (ControlFlow 0 18) 8) anon24_Then_correct)) (=> (= (ControlFlow 0 18) 10) anon24_Else_correct)))))))
(let ((anon8_correct  (=> (state Heap@@19 UnfoldingMask@4) (and (=> (= (ControlFlow 0 20) 15) anon22_Then_correct) (=> (= (ControlFlow 0 20) 18) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (= (MapType0Select Heap@@19 this@@14 next) end@@14) (=> (and (= UnfoldingMask@4 UnfoldingMask@2) (= (ControlFlow 0 22) 20)) anon8_correct))))
(let ((anon21_Then_correct  (=> (not (= (MapType0Select Heap@@19 this@@14 next) end@@14)) (=> (and (not (= (MapType0Select Heap@@19 this@@14 next) null)) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 null (lseg (MapType0Select Heap@@19 this@@14 next) end@@14) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 null (lseg (MapType0Select Heap@@19 this@@14 next) end@@14))) FullPerm))))) (=> (and (and (InsidePredicate (lseg this@@14 end@@14) (MapType0Select Heap@@19 null (lseg this@@14 end@@14)) (lseg (MapType0Select Heap@@19 this@@14 next) end@@14) (MapType0Select Heap@@19 null (lseg (MapType0Select Heap@@19 this@@14 next) end@@14))) (state Heap@@19 UnfoldingMask@3)) (and (= UnfoldingMask@4 UnfoldingMask@3) (= (ControlFlow 0 21) 20))) anon8_correct)))))
(let ((anon6_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (lseg this@@14 end@@14) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (lseg this@@14 end@@14))) FullPerm)))) (=> (and (not (= this@@14 null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this@@14 value (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this@@14 value)) FullPerm))))) (=> (and (and (state Heap@@19 UnfoldingMask@1) (not (= this@@14 null))) (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 this@@14 next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 this@@14 next)) FullPerm)))) (state Heap@@19 UnfoldingMask@2))) (and (=> (= (ControlFlow 0 23) 21) anon21_Then_correct) (=> (= (ControlFlow 0 23) 22) anon21_Else_correct)))))))
(let ((anon20_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 26) 23)) anon6_correct)))
(let ((anon20_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (lseg this@@14 end@@14))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (lseg this@@14 end@@14)))) (=> (= (ControlFlow 0 24) 23) anon6_correct))))))
(let ((anon18_Else_correct  (=> (and (and (< i@@3 (length Heap@@19 this@@14 end@@14)) (state Heap@@19 Mask@0)) (and (|lseg#trigger| Heap@@19 (lseg this@@14 end@@14)) (= (MapType0Select Heap@@19 null (lseg this@@14 end@@14)) (CombineFrames (FrameFragment (MapType0Select Heap@@19 this@@14 value)) (CombineFrames (FrameFragment (MapType0Select Heap@@19 this@@14 next)) (FrameFragment (ite (not (= (MapType0Select Heap@@19 this@@14 next) end@@14)) (MapType0Select Heap@@19 null (lseg (MapType0Select Heap@@19 this@@14 next) end@@14)) EmptyFrame))))))) (and (=> (= (ControlFlow 0 27) 24) anon20_Then_correct) (=> (= (ControlFlow 0 27) 26) anon20_Else_correct)))))
(let ((anon3_correct true))
(let ((anon19_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon19_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (lseg this@@14 end@@14))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (lseg this@@14 end@@14)))) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@19 this@@14 $allocated)) (U_2_bool (MapType0Select Heap@@19 end@@14 $allocated))) (and (= AssumeFunctionsAbove 0) (= Mask@0 (MapType1Store ZeroMask null (lseg this@@14 end@@14) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (lseg this@@14 end@@14))) FullPerm)))))) (and (and (state Heap@@19 Mask@0) (state Heap@@19 Mask@0)) (and (<= 0 i@@3) (state Heap@@19 Mask@0)))) (and (and (=> (= (ControlFlow 0 28) 27) anon18_Else_correct) (=> (= (ControlFlow 0 28) 2) anon19_Then_correct)) (=> (= (ControlFlow 0 28) 4) anon19_Else_correct))))))
