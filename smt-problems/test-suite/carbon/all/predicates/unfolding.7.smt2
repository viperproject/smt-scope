...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon3_correct  (=> (= UnfoldingMask@2 (MapType1Store PostMask@0 null (P this@@5) (real_2_U (- (U_2_real (MapType1Select PostMask@0 null (P this@@5))) FullPerm)))) (=> (and (and (not (= this@@5 null)) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 this@@5 x@@8 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 this@@5 x@@8)) FullPerm))))) (and (state PostHeap@0 UnfoldingMask@3) (state PostHeap@0 UnfoldingMask@3))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (HasDirectPerm UnfoldingMask@3 this@@5 x@@8)) (=> (HasDirectPerm UnfoldingMask@3 this@@5 x@@8) (=> (= (ControlFlow 0 20) (- 0 19)) (HasDirectPerm Mask@0 this@@5 x@@8))))))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 24) 20)) anon3_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (P this@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (P this@@5)))) (=> (= (ControlFlow 0 22) 20) anon3_correct))))))
(let ((anon13_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (= PostMask@0 (MapType1Store ZeroMask null (P this@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P this@@5))) FullPerm))))) (=> (and (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)) (and (|P#trigger| PostHeap@0 (P this@@5)) (= (MapType0Select PostHeap@0 null (P this@@5)) (FrameFragment (MapType0Select PostHeap@0 this@@5 x@@8))))) (and (=> (= (ControlFlow 0 25) 22) anon14_Then_correct) (=> (= (ControlFlow 0 25) 24) anon14_Else_correct))))))
