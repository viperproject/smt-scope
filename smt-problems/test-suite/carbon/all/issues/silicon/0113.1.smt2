...
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@14 this@@9 $allocated))) (and (not (= this@@9 null)) (= Mask@0 (MapType1Store ZeroMask this@@9 next (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@9 next)) FullPerm)))))) (and (and (state Heap@@14 Mask@0) (not (= this@@9 null))) (and (= Mask@1 (MapType1Store Mask@0 this@@9 value (real_2_U (+ (U_2_real (MapType1Select Mask@0 this@@9 value)) FullPerm)))) (state Heap@@14 Mask@1)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@1 this@@9 next)) (=> (HasDirectPerm Mask@1 this@@9 next) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))))
