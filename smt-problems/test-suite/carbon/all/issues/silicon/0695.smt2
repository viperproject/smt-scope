...
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type UnfoldingMask@0) (MapType2Type RefType realType)) (= (type Mask@0) (MapType2Type RefType realType))) (= (type lft@@27) (MapType intType (MapType RefType realType)))) (= (type Heap@@25) (MapType1Type RefType))) (forall ((arg0@@80 T@U) ) (! (= (type (invRecv1 arg0@@80)) RefType)
 :qid |funType:invRecv1|
 :pattern ( (invRecv1 arg0@@80))
))) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@81 T@U) ) (! (= (type (invRecv2 arg0@@81)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@81))
))) (= (type QPMask@1) (MapType2Type RefType realType))) (= (type x@@67) RefType)) (= (type Unfolding1Mask@0) (MapType2Type RefType realType))) (= (type Unfolding1Mask@1) (MapType2Type RefType realType))) (= (type Unfolding1Mask@2) (MapType2Type RefType realType))))
(set-info :boogie-vc-id |get_disc#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon6_correct  (=> (= UnfoldingMask@0 (MapType2Store Mask@0 null (LifetimeP lft@@27) (real_2_U (- (U_2_real (MapType2Select Mask@0 null (LifetimeP lft@@27))) FullPerm)))) (=> (and (and (state Heap@@25 UnfoldingMask@0) (valid_lft Heap@@25 lft@@27)) (and (forall ((x$0 T@U) ) (!  (=> (and (= (type x$0) RefType) (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0))) (< (/ (to_real 0) (to_real 1)) (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0))))
 :qid |stdinbpl.745:22|
 :skolemid |125|
 :pattern ( (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0))
 :pattern ( (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0))
)) (forall ((x$0_1 T@U) ) (!  (=> (and (= (type x$0_1) RefType) (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_1))) (<= (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_1)) (/ (to_real 1) (to_real 1))))
 :qid |stdinbpl.749:22|
 :skolemid |126|
 :pattern ( (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_1))
 :pattern ( (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_1))
)))) (and (=> (= (ControlFlow 0 4) (- 0 9)) (forall ((x$0_2 T@U) (x$0_2_1 T@U) ) (!  (=> (and (= (type x$0_2) RefType) (= (type x$0_2_1) RefType)) (=> (and (and (and (and (not (= x$0_2 x$0_2_1)) (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_2))) (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_2_1))) (< NoPerm (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_2)))) (< NoPerm (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_2_1)))) (not (= x$0_2 x$0_2_1))))
 :qid |stdinbpl.757:19|
 :skolemid |127|
 :pattern ( (neverTriggered1 x$0_2) (neverTriggered1 x$0_2_1))
))) (=> (forall ((x$0_2@@0 T@U) (x$0_2_1@@0 T@U) ) (!  (=> (and (= (type x$0_2@@0) RefType) (= (type x$0_2_1@@0) RefType)) (=> (and (and (and (and (not (= x$0_2@@0 x$0_2_1@@0)) (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_2@@0))) (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_2_1@@0))) (< NoPerm (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_2@@0)))) (< NoPerm (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_2_1@@0)))) (not (= x$0_2@@0 x$0_2_1@@0))))
 :qid |stdinbpl.757:19|
 :skolemid |127|
 :pattern ( (neverTriggered1 x$0_2@@0) (neverTriggered1 x$0_2_1@@0))
)) (=> (and (forall ((x$0_2@@1 T@U) ) (!  (=> (= (type x$0_2@@1) RefType) (=> (and (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_2@@1)) (< NoPerm (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_2@@1)))) (and (= (invRecv1 x$0_2@@1) x$0_2@@1) (qpRange1 x$0_2@@1))))
 :qid |stdinbpl.763:24|
 :skolemid |128|
 :pattern ( (MapType1Select Heap@@25 null (lft_T x$0_2@@1)))
 :pattern ( (MapType2Select UnfoldingMask@0 null (lft_T x$0_2@@1)))
 :pattern ( (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_2@@1))
 :pattern ( (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_2@@1))
)) (forall ((x_2_1 T@U) ) (!  (=> (= (type x_2_1) RefType) (=> (and (and (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) (invRecv1 x_2_1))) (< NoPerm (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) (invRecv1 x_2_1))))) (qpRange1 x_2_1)) (= (invRecv1 x_2_1) x_2_1)))
 :qid |stdinbpl.767:24|
 :skolemid |129|
 :pattern ( (invRecv1 x_2_1))
))) (and (=> (= (ControlFlow 0 4) (- 0 8)) (forall ((x$0_2@@2 T@U) ) (!  (=> (and (= (type x$0_2@@2) RefType) (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_2@@2))) (>= (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_2@@2)) NoPerm))
 :qid |stdinbpl.773:17|
 :skolemid |130|
 :pattern ( (MapType1Select Heap@@25 null (lft_T x$0_2@@2)))
 :pattern ( (MapType2Select UnfoldingMask@0 null (lft_T x$0_2@@2)))
 :pattern ( (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_2@@2))
 :pattern ( (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_2@@2))
))) (=> (forall ((x$0_2@@3 T@U) ) (!  (=> (and (= (type x$0_2@@3) RefType) (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_2@@3))) (>= (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_2@@3)) NoPerm))
 :qid |stdinbpl.773:17|
 :skolemid |130|
 :pattern ( (MapType1Select Heap@@25 null (lft_T x$0_2@@3)))
 :pattern ( (MapType2Select UnfoldingMask@0 null (lft_T x$0_2@@3)))
 :pattern ( (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_2@@3))
 :pattern ( (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) x$0_2@@3))
)) (=> (and (forall ((x_2_1@@0 T@U) ) (!  (=> (= (type x_2_1@@0) RefType) (=> (and (and (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) (invRecv1 x_2_1@@0))) (< NoPerm (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) (invRecv1 x_2_1@@0))))) (qpRange1 x_2_1@@0)) (and (=> (< NoPerm (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) (invRecv1 x_2_1@@0)))) (= (invRecv1 x_2_1@@0) x_2_1@@0)) (= (U_2_real (MapType2Select QPMask@0 null (lft_T x_2_1@@0))) (+ (U_2_real (MapType2Select UnfoldingMask@0 null (lft_T x_2_1@@0))) (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) (invRecv1 x_2_1@@0))))))))
 :qid |stdinbpl.779:24|
 :skolemid |131|
 :pattern ( (MapType2Select QPMask@0 null (lft_T x_2_1@@0)))
)) (forall ((o_3 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (or (or (not (= o_3 null)) (not (IsPredicateField f_5))) (not (= (getPredWandId f_5) 0)))) (= (U_2_real (MapType2Select UnfoldingMask@0 o_3 f_5)) (U_2_real (MapType2Select QPMask@0 o_3 f_5))))))
 :qid |stdinbpl.785:31|
 :skolemid |132|
 :pattern ( (MapType2Select UnfoldingMask@0 o_3 f_5))
 :pattern ( (MapType2Select QPMask@0 o_3 f_5))
))) (=> (and (and (forall ((x_2_1@@1 T@U) ) (!  (=> (and (= (type x_2_1@@1) RefType) (not (and (and (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) (invRecv1 x_2_1@@1))) (< NoPerm (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 0))) (invRecv1 x_2_1@@1))))) (qpRange1 x_2_1@@1)))) (= (U_2_real (MapType2Select QPMask@0 null (lft_T x_2_1@@1))) (U_2_real (MapType2Select UnfoldingMask@0 null (lft_T x_2_1@@1)))))
 :qid |stdinbpl.789:24|
 :skolemid |133|
 :pattern ( (MapType2Select QPMask@0 null (lft_T x_2_1@@1)))
)) (state Heap@@25 QPMask@0)) (and (forall ((x$0_4 T@U) ) (!  (=> (and (= (type x$0_4) RefType) (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_4))) (< (/ (to_real 0) (to_real 1)) (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_4))))
 :qid |stdinbpl.795:22|
 :skolemid |134|
 :pattern ( (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_4))
 :pattern ( (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_4))
)) (forall ((x$0_5 T@U) ) (!  (=> (and (= (type x$0_5) RefType) (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_5))) (<= (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_5)) (/ (to_real 1) (to_real 1))))
 :qid |stdinbpl.799:22|
 :skolemid |135|
 :pattern ( (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_5))
 :pattern ( (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_5))
)))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (forall ((x$0_6 T@U) (x$0_6_1 T@U) ) (!  (=> (and (= (type x$0_6) RefType) (= (type x$0_6_1) RefType)) (=> (and (and (and (and (not (= x$0_6 x$0_6_1)) (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_6))) (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_6_1))) (< NoPerm (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_6)))) (< NoPerm (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_6_1)))) (not (= x$0_6 x$0_6_1))))
 :qid |stdinbpl.807:19|
 :skolemid |136|
 :pattern ( (neverTriggered2 x$0_6) (neverTriggered2 x$0_6_1))
))) (=> (forall ((x$0_6@@0 T@U) (x$0_6_1@@0 T@U) ) (!  (=> (and (= (type x$0_6@@0) RefType) (= (type x$0_6_1@@0) RefType)) (=> (and (and (and (and (not (= x$0_6@@0 x$0_6_1@@0)) (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_6@@0))) (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_6_1@@0))) (< NoPerm (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_6@@0)))) (< NoPerm (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_6_1@@0)))) (not (= x$0_6@@0 x$0_6_1@@0))))
 :qid |stdinbpl.807:19|
 :skolemid |136|
 :pattern ( (neverTriggered2 x$0_6@@0) (neverTriggered2 x$0_6_1@@0))
)) (=> (and (forall ((x$0_6@@1 T@U) ) (!  (=> (= (type x$0_6@@1) RefType) (=> (and (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_6@@1)) (< NoPerm (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_6@@1)))) (and (= (invRecv2 x$0_6@@1) x$0_6@@1) (qpRange2 x$0_6@@1))))
 :qid |stdinbpl.813:24|
 :skolemid |137|
 :pattern ( (MapType1Select Heap@@25 null (lft_List x$0_6@@1)))
 :pattern ( (MapType2Select QPMask@0 null (lft_List x$0_6@@1)))
 :pattern ( (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_6@@1))
 :pattern ( (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_6@@1))
)) (forall ((x_3_1 T@U) ) (!  (=> (= (type x_3_1) RefType) (=> (and (and (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) (invRecv2 x_3_1))) (< NoPerm (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) (invRecv2 x_3_1))))) (qpRange2 x_3_1)) (= (invRecv2 x_3_1) x_3_1)))
 :qid |stdinbpl.817:24|
 :skolemid |138|
 :pattern ( (invRecv2 x_3_1))
))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((x$0_6@@2 T@U) ) (!  (=> (and (= (type x$0_6@@2) RefType) (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_6@@2))) (>= (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_6@@2)) NoPerm))
 :qid |stdinbpl.823:17|
 :skolemid |139|
 :pattern ( (MapType1Select Heap@@25 null (lft_List x$0_6@@2)))
 :pattern ( (MapType2Select QPMask@0 null (lft_List x$0_6@@2)))
 :pattern ( (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_6@@2))
 :pattern ( (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_6@@2))
))) (=> (forall ((x$0_6@@3 T@U) ) (!  (=> (and (= (type x$0_6@@3) RefType) (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_6@@3))) (>= (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_6@@3)) NoPerm))
 :qid |stdinbpl.823:17|
 :skolemid |139|
 :pattern ( (MapType1Select Heap@@25 null (lft_List x$0_6@@3)))
 :pattern ( (MapType2Select QPMask@0 null (lft_List x$0_6@@3)))
 :pattern ( (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_6@@3))
 :pattern ( (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x$0_6@@3))
)) (=> (forall ((x_3_1@@0 T@U) ) (!  (=> (= (type x_3_1@@0) RefType) (=> (and (and (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) (invRecv2 x_3_1@@0))) (< NoPerm (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) (invRecv2 x_3_1@@0))))) (qpRange2 x_3_1@@0)) (and (=> (< NoPerm (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) (invRecv2 x_3_1@@0)))) (= (invRecv2 x_3_1@@0) x_3_1@@0)) (= (U_2_real (MapType2Select QPMask@1 null (lft_List x_3_1@@0))) (+ (U_2_real (MapType2Select QPMask@0 null (lft_List x_3_1@@0))) (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) (invRecv2 x_3_1@@0))))))))
 :qid |stdinbpl.829:24|
 :skolemid |140|
 :pattern ( (MapType2Select QPMask@1 null (lft_List x_3_1@@0)))
)) (=> (and (forall ((o_3@@0 T@U) (f_5@@0 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_5@@0))))
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@0) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (or (or (not (= o_3@@0 null)) (not (IsPredicateField f_5@@0))) (not (= (getPredWandId f_5@@0) 1)))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 f_5@@0)) (U_2_real (MapType2Select QPMask@1 o_3@@0 f_5@@0))))))
 :qid |stdinbpl.835:31|
 :skolemid |141|
 :pattern ( (MapType2Select QPMask@0 o_3@@0 f_5@@0))
 :pattern ( (MapType2Select QPMask@1 o_3@@0 f_5@@0))
)) (forall ((x_3_1@@1 T@U) ) (!  (=> (and (= (type x_3_1@@1) RefType) (not (and (and (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) (invRecv2 x_3_1@@1))) (< NoPerm (U_2_real (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) (invRecv2 x_3_1@@1))))) (qpRange2 x_3_1@@1)))) (= (U_2_real (MapType2Select QPMask@1 null (lft_List x_3_1@@1))) (U_2_real (MapType2Select QPMask@0 null (lft_List x_3_1@@1)))))
 :qid |stdinbpl.839:24|
 :skolemid |142|
 :pattern ( (MapType2Select QPMask@1 null (lft_List x_3_1@@1)))
))) (=> (and (and (state Heap@@25 QPMask@1) (state Heap@@25 QPMask@1)) (and (|lft_List#trigger| Heap@@25 (lft_List x@@67)) (= (MapType1Select Heap@@25 null (lft_List x@@67)) (CombineFrames (FrameFragment (MapType1Select Heap@@25 x@@67 ref)) (MapType1Select Heap@@25 null (List (MapType1Select Heap@@25 x@@67 ref))))))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (> (U_2_real (MapType2Select QPMask@1 null (lft_List x@@67))) NoPerm)) (=> (> (U_2_real (MapType2Select QPMask@1 null (lft_List x@@67))) NoPerm) (=> (> wildcard@0 NoPerm) (=> (and (and (< wildcard@0 (U_2_real (MapType2Select QPMask@1 null (lft_List x@@67)))) (= Unfolding1Mask@0 (MapType2Store QPMask@1 null (lft_List x@@67) (real_2_U (- (U_2_real (MapType2Select QPMask@1 null (lft_List x@@67))) wildcard@0))))) (and (> wildcard@1 NoPerm) (not (= x@@67 null)))) (=> (and (and (and (= Unfolding1Mask@1 (MapType2Store Unfolding1Mask@0 x@@67 ref (real_2_U (+ (U_2_real (MapType2Select Unfolding1Mask@0 x@@67 ref)) wildcard@1)))) (state Heap@@25 Unfolding1Mask@1)) (and (> wildcard@2 NoPerm) (= Unfolding1Mask@2 (MapType2Store Unfolding1Mask@1 null (List (MapType1Select Heap@@25 x@@67 ref)) (real_2_U (+ (U_2_real (MapType2Select Unfolding1Mask@1 null (List (MapType1Select Heap@@25 x@@67 ref)))) wildcard@2)))))) (and (and (InsidePredicate (lft_List x@@67) (MapType1Select Heap@@25 null (lft_List x@@67)) (List (MapType1Select Heap@@25 x@@67 ref)) (MapType1Select Heap@@25 null (List (MapType1Select Heap@@25 x@@67 ref)))) (state Heap@@25 Unfolding1Mask@2)) (and (state Heap@@25 Unfolding1Mask@2) (= (ControlFlow 0 4) (- 0 3))))) (HasDirectPerm Unfolding1Mask@2 x@@67 ref)))))))))))))))))))))))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 4)) anon6_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType2Select Mask@0 null (LifetimeP lft@@27))))) (=> (<= FullPerm (U_2_real (MapType2Select Mask@0 null (LifetimeP lft@@27)))) (=> (= (ControlFlow 0 10) 4) anon6_correct))))))
(let ((anon8_Else_correct  (=> (valid_lft Heap@@25 lft@@27) (and (=> (= (ControlFlow 0 13) (- 0 14)) (U_2_bool (MapType0Select (|Map#Domain| lft@@27) (int_2_U 1)))) (=> (U_2_bool (MapType0Select (|Map#Domain| lft@@27) (int_2_U 1))) (=> (and (and (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| lft@@27) (int_2_U 1))) x@@67)) (state Heap@@25 Mask@0)) (and (|LifetimeP#trigger| Heap@@25 (LifetimeP lft@@27)) (= (MapType1Select Heap@@25 null (LifetimeP lft@@27)) (CombineFrames (FrameFragment (int_2_U (|LifetimeP#condqp1| Heap@@25 lft@@27))) (FrameFragment (int_2_U (|LifetimeP#condqp2| Heap@@25 lft@@27))))))) (and (=> (= (ControlFlow 0 13) 10) anon9_Then_correct) (=> (= (ControlFlow 0 13) 12) anon9_Else_correct))))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (=> (valid_lft Heap@@25 lft@@27) (=> (and (and (= Mask@0 (MapType2Store ZeroMask null (LifetimeP lft@@27) (real_2_U (+ (U_2_real (MapType2Select ZeroMask null (LifetimeP lft@@27))) FullPerm)))) (state Heap@@25 Mask@0)) (and (state Heap@@25 Mask@0) (state Heap@@25 Mask@0))) (and (=> (= (ControlFlow 0 15) 2) anon8_Then_correct) (=> (= (ControlFlow 0 15) 13) anon8_Else_correct))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@25 ZeroMask) (U_2_bool (MapType1Select Heap@@25 x@@67 $allocated))) (and (= AssumeFunctionsAbove 0) (state Heap@@25 ZeroMask))) (and (=> (= (ControlFlow 0 16) 1) anon7_Then_correct) (=> (= (ControlFlow 0 16) 15) anon7_Else_correct)))))
