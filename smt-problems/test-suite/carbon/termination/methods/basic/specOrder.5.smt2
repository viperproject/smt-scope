...
(let ((anon6_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 4) (- 0 6)) (> y@@1 0)) (=> (> y@@1 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (> y@@1 0)) (=> (> y@@1 0) (=> (state Heap@@9 ZeroMask) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 4) 2)) anon7_correct)))))))))
(let ((anon10_Else_correct  (=> (and (<= x@@8 y@@1) (= (ControlFlow 0 9) 4)) anon6_correct)))
(let ((anon10_Then_correct  (=> (< y@@1 x@@8) (and (=> (= (ControlFlow 0 7) (- 0 8)) (and (decreasing (int_2_U y@@1) (int_2_U x@@8)) (bounded (int_2_U x@@8)))) (=> (and (decreasing (int_2_U y@@1) (int_2_U x@@8)) (bounded (int_2_U x@@8))) (=> (= (ControlFlow 0 7) 4) anon6_correct))))))
(let ((anon9_Else_correct  (=> (> x@@8 y@@1) (and (=> (= (ControlFlow 0 10) (- 0 11)) (or (not (< y@@1 x@@8)) (< y@@1 y@@1))) (=> (or (not (< y@@1 x@@8)) (< y@@1 y@@1)) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 10) 7) anon10_Then_correct) (=> (= (ControlFlow 0 10) 9) anon10_Else_correct))))))))
(let ((anon9_Then_correct  (=> (>= y@@1 x@@8) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 3) 2)) anon7_correct))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (> x@@8 0)) (and (> y@@1 0) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 12) 1) anon8_Then_correct) (=> (= (ControlFlow 0 12) 3) anon9_Then_correct)) (=> (= (ControlFlow 0 12) 10) anon9_Else_correct)))))
