...
(declare-fun q_1@1 () Real)
(assert (= (type Heap@@9) (MapType0Type RefType)))
(set-info :boogie-vc-id split)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (< NoPerm p_1)) (and (> i 0) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (not (= i 0))) (=> (not (= i 0)) (=> (and (= q_1@0 (/ p_1 (to_real i))) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (< NoPerm q_1@0)) (=> (< NoPerm q_1@0) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (= i 0))) (=> (not (= i 0)) (=> (= q_1@1 (/ (to_real i) (to_real i))) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= q_1@1 FullPerm))))))))))))))
