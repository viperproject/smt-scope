...
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null (valid this@@9))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 null (valid this@@9)))) (=> (= (ControlFlow 0 3) 2) anon8_correct))))))
(let ((anon6_correct  (=> (= Heap@4 (MapType0Store Heap@3 null (|valid#sm| this@@9) (MapType1Store (MapType0Select Heap@3 null (|valid#sm| this@@9)) this@@9 value (bool_2_U true)))) (=> (and (state Heap@4 Mask@2) (state Heap@4 Mask@2)) (and (=> (= (ControlFlow 0 6) 3) anon12_Then_correct) (=> (= (ControlFlow 0 6) 5) anon12_Else_correct))))))
(let ((anon11_Else_correct  (=> (HasDirectPerm Mask@2 null (valid this@@9)) (=> (and (= Heap@3 Heap@0) (= (ControlFlow 0 8) 6)) anon6_correct))))
(let ((anon11_Then_correct  (=> (not (HasDirectPerm Mask@2 null (valid this@@9))) (=> (and (and (= Heap@1 (MapType0Store Heap@0 null (|valid#sm| this@@9) ZeroPMask)) (= Heap@2 (MapType0Store Heap@1 null (valid this@@9) freshVersion@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 7) 6))) anon6_correct))))
(let ((anon4_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 this@@9 value (real_2_U (- (U_2_real (MapType1Select Mask@0 this@@9 value)) FullPerm)))) (= Mask@2 (MapType1Store Mask@1 null (valid this@@9) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (valid this@@9))) FullPerm))))) (=> (and (and (state Heap@0 Mask@2) (state Heap@0 Mask@2)) (and (|valid#trigger| Heap@0 (valid this@@9)) (= (MapType0Select Heap@0 null (valid this@@9)) (FrameFragment (MapType0Select Heap@0 this@@9 value))))) (and (=> (= (ControlFlow 0 9) 7) anon11_Then_correct) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct))))))
(let ((anon10_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon4_correct)))
(let ((anon10_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@0 this@@9 value)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 this@@9 value))) (=> (= (ControlFlow 0 10) 9) anon4_correct))))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (= FullPerm (U_2_real (MapType1Select Mask@0 this@@9 value)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 this@@9 value))) (=> (and (= Heap@0 (MapType0Store Heap@@14 this@@9 value (int_2_U v_2))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 13) 10) anon10_Then_correct) (=> (= (ControlFlow 0 13) 12) anon10_Else_correct)))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@14 this@@9 $allocated))) (=> (and (and (not (= this@@9 null)) (= Mask@0 (MapType1Store ZeroMask this@@9 value (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@9 value)) FullPerm))))) (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0))) (and (=> (= (ControlFlow 0 15) 1) anon9_Then_correct) (=> (= (ControlFlow 0 15) 13) anon9_Else_correct)))))))
