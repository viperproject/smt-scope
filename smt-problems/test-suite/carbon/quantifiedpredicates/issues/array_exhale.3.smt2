...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@8 (+ i_3 1)) (loc a_3@@8 (+ i_3_1 1)))))
 :qid |stdinbpl.1883:15|
 :skolemid |178|
)))))
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((i_4 Int) (i_4_1 Int) ) (!  (=> (and (and (and (and (not (= i_4 i_4_1)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@8 (+ i_4 1)) (loc a_3@@8 (+ i_4_1 1)))))
 :qid |stdinbpl.1930:17|
 :skolemid |184|
 :pattern ( (neverTriggered20 i_4) (neverTriggered20 i_4_1))
))) (=> (forall ((i_4@@0 Int) (i_4_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_4@@0 i_4_1@@0)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4@@0))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@8 (+ i_4@@0 1)) (loc a_3@@8 (+ i_4_1@@0 1)))))
 :qid |stdinbpl.1930:17|
 :skolemid |184|
 :pattern ( (neverTriggered20 i_4@@0) (neverTriggered20 i_4_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((i_4@@1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4@@1)) (>= (U_2_real (MapType1Select QPMask@0 (loc a_3@@8 (+ i_4@@1 1)) val)) FullPerm))
...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 1 (+ n@@13 1)) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 1 (+ n@@13 1)) (int_2_U i_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@8 i_1) (loc a_3@@8 i_1_1))))
 :qid |stdinbpl.1832:15|
 :skolemid |172|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (|Seq#Contains| (|Seq#Range| 1 (+ n@@13 1)) (int_2_U i_1@@0))) (|Seq#Contains| (|Seq#Range| 1 (+ n@@13 1)) (int_2_U i_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@8 i_1@@0) (loc a_3@@8 i_1_1@@0))))
 :qid |stdinbpl.1832:15|
 :skolemid |172|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 1 (+ n@@13 1)) (int_2_U i_1@@1)) (< NoPerm FullPerm)) (and (qpRange18 (loc a_3@@8 i_1@@1)) (= (invRecv18 (loc a_3@@8 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.1838:22|
 :skolemid |173|
 :pattern ( (loc a_3@@8 i_1@@1))
 :pattern ( (loc a_3@@8 i_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 1 (+ n@@13 1)) (int_2_U (invRecv18 o_3))) (< NoPerm FullPerm)) (qpRange18 o_3)) (= (loc a_3@@8 (invRecv18 o_3)) o_3)))
 :qid |stdinbpl.1842:22|
 :skolemid |174|
 :pattern ( (invRecv18 o_3))
)) (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 1 (+ n@@13 1)) (int_2_U i_1@@2)) (not (= (loc a_3@@8 i_1@@2) null)))
 :qid |stdinbpl.1848:22|
 :skolemid |175|
 :pattern ( (loc a_3@@8 i_1@@2))
 :pattern ( (loc a_3@@8 i_1@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 1 (+ n@@13 1)) (int_2_U (invRecv18 o_3@@0))) (< NoPerm FullPerm)) (qpRange18 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@8 (invRecv18 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 1 (+ n@@13 1)) (int_2_U (invRecv18 o_3@@0))) (< NoPerm FullPerm)) (qpRange18 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
