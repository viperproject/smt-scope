...
(let ((anon6_correct  (=> (= Mask@2 (MapType1Store Mask@1 x@@11 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 x@@11 f_7)) FullPerm)))) (=> (and (and (and (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)) (and (not (= x@@11 null)) (= Mask@3 (MapType1Store Mask@2 x@@11 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@2 x@@11 f_7)) FullPerm)))))) (and (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3)) (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3)))) (and (and (=> (= (ControlFlow 0 11) 10) anon16_Else_correct) (=> (= (ControlFlow 0 11) 4) anon17_Then_correct)) (=> (= (ControlFlow 0 11) 6) anon17_Else_correct))))))
(let ((anon15_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 14) 11)) anon6_correct)))
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@11 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@11 f_7))) (=> (= (ControlFlow 0 12) 11) anon6_correct))))))
