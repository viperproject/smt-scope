...
(let ((anon6_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 (|Seq#Length| s@@17)))) (= (ControlFlow 0 8) 4)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (<= 0 i_2) (< i_2 (|Seq#Length| s@@17))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< i_2 (|Seq#Length| s@@17))) (=> (< i_2 (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 5) 4) anon3_correct))))))))
(let ((anon5_Else_correct  (=> (and (forall ((i_1_1 Int) ) (!  (=> (and (<= 0 i_1_1) (< i_1_1 (|Seq#Length| s@@17))) (> (U_2_int (|Seq#Index| s@@17 i_1_1)) 0))
 :qid |stdinbpl.705:20|
 :skolemid |63|
 :pattern ( (|trigger#frame| EmptyFrame i_1_1))
)) (state Heap@@13 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< 0 (|Seq#Length| s@@17))) (=> (< 0 (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 2) (- 0 1)) (> (U_2_int (|Seq#Index| s@@17 0)) 0)))))))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (> (|Seq#Length| s@@17) 0)) (and (state Heap@@13 ZeroMask) (state Heap@@13 ZeroMask))) (and (and (=> (= (ControlFlow 0 9) 2) anon5_Else_correct) (=> (= (ControlFlow 0 9) 5) anon6_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct))))))
