...
(declare-fun |vals'| (T@U Real T@U) T@U)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |vals#triggerStateless| (Real T@U) T@U)
...
(declare-fun |vals#condqp1| (T@U Real T@U) Int)
...
(declare-fun |vals#trigger| (T@U Real T@U) Bool)
(declare-fun FrameFragment (T@U) T@U)
(declare-fun ConditionalFrame (Real T@U) T@U)
(declare-fun EmptyFrame () T@U)
(declare-fun vals (T@U Real T@U) T@U)
(declare-fun |vals#frame| (T@U Real T@U) T@U)
...
(assert  (and (forall ((arg0@@26 T@U) (arg1@@10 Real) (arg2@@3 T@U) ) (! (= (type (|vals'| arg0@@26 arg1@@10 arg2@@3)) (SeqType intType))
 :qid |funType:vals'|
 :pattern ( (|vals'| arg0@@26 arg1@@10 arg2@@3))
)) (forall ((arg0@@27 Real) (arg1@@11 T@U) ) (! (= (type (|vals#triggerStateless| arg0@@27 arg1@@11)) (SeqType intType))
 :qid |funType:vals#triggerStateless|
 :pattern ( (|vals#triggerStateless| arg0@@27 arg1@@11))
))))
(assert (forall ((Heap@@0 T@U) (p_1 Real) (ar T@U) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type ar) (SeqType RefType))) (dummyFunction (|vals#triggerStateless| p_1 ar)))
 :qid |stdinbpl.583:15|
 :skolemid |59|
...
(assert (forall ((arg0@@31 T@U) (arg1@@13 Int) (arg2@@4 T@U) ) (! (let ((T@@3 (type arg2@@4)))
(= (type (|Seq#Update| arg0@@31 arg1@@13 arg2@@4)) (SeqType T@@3)))
 :qid |funType:Seq#Update|
 :pattern ( (|Seq#Update| arg0@@31 arg1@@13 arg2@@4))
)))
...
(assert (forall ((Heap2Heap T@U) (Heap1Heap T@U) (p_1@@0 Real) (ar@@0 T@U) ) (!  (=> (and (and (and (= (type Heap2Heap) (MapType0Type RefType)) (= (type Heap1Heap) (MapType0Type RefType))) (= (type ar@@0) (SeqType RefType))) (and (=  (and (and (<= 0 (|sk_vals#condqp1| (|vals#condqp1| Heap2Heap p_1@@0 ar@@0) (|vals#condqp1| Heap1Heap p_1@@0 ar@@0))) (< (|sk_vals#condqp1| (|vals#condqp1| Heap2Heap p_1@@0 ar@@0) (|vals#condqp1| Heap1Heap p_1@@0 ar@@0)) (|Seq#Length| ar@@0))) (< NoPerm p_1@@0))  (and (and (<= 0 (|sk_vals#condqp1| (|vals#condqp1| Heap2Heap p_1@@0 ar@@0) (|vals#condqp1| Heap1Heap p_1@@0 ar@@0))) (< (|sk_vals#condqp1| (|vals#condqp1| Heap2Heap p_1@@0 ar@@0) (|vals#condqp1| Heap1Heap p_1@@0 ar@@0)) (|Seq#Length| ar@@0))) (< NoPerm p_1@@0))) (=> (and (and (<= 0 (|sk_vals#condqp1| (|vals#condqp1| Heap2Heap p_1@@0 ar@@0) (|vals#condqp1| Heap1Heap p_1@@0 ar@@0))) (< (|sk_vals#condqp1| (|vals#condqp1| Heap2Heap p_1@@0 ar@@0) (|vals#condqp1| Heap1Heap p_1@@0 ar@@0)) (|Seq#Length| ar@@0))) (< NoPerm p_1@@0)) (= (U_2_int (MapType0Select Heap2Heap (|Seq#Index| ar@@0 (|sk_vals#condqp1| (|vals#condqp1| Heap2Heap p_1@@0 ar@@0) (|vals#condqp1| Heap1Heap p_1@@0 ar@@0))) val)) (U_2_int (MapType0Select Heap1Heap (|Seq#Index| ar@@0 (|sk_vals#condqp1| (|vals#condqp1| Heap2Heap p_1@@0 ar@@0) (|vals#condqp1| Heap1Heap p_1@@0 ar@@0))) val)))))) (= (|vals#condqp1| Heap2Heap p_1@@0 ar@@0) (|vals#condqp1| Heap1Heap p_1@@0 ar@@0)))
 :qid |stdinbpl.600:15|
 :skolemid |61|
 :pattern ( (|vals#condqp1| Heap2Heap p_1@@0 ar@@0) (|vals#condqp1| Heap1Heap p_1@@0 ar@@0) (succHeapTrans Heap2Heap Heap1Heap))
)))
...
(assert (forall ((arg0@@36 T@U) ) (! (= (type (FrameFragment arg0@@36)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@36))
)))
(assert (forall ((Heap@@6 T@U) (Mask@@5 T@U) (p_1@@1 Real) (ar@@1 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@6) (MapType0Type RefType)) (= (type Mask@@5) (MapType1Type RefType realType))) (= (type ar@@1) (SeqType RefType))) (and (state Heap@@6 Mask@@5) (or (< AssumeFunctionsAbove 0) (|vals#trigger| (FrameFragment (int_2_U (|vals#condqp1| Heap@@6 p_1@@1 ar@@1))) p_1@@1 ar@@1)))) (and (< NoPerm p_1@@1) (forall ((i_1 Int) (j@@3 Int) ) (!  (=> (and (<= 0 i_1) (and (< i_1 (|Seq#Length| ar@@1)) (and (<= 0 j@@3) (and (< j@@3 (|Seq#Length| ar@@1)) (not (= i_1 j@@3)))))) (not (= (|Seq#Index| ar@@1 i_1) (|Seq#Index| ar@@1 j@@3))))
 :qid |stdinbpl.615:148|
 :skolemid |64|
 :pattern ( (|Seq#Index| ar@@1 i_1) (|Seq#Index| ar@@1 j@@3))
)))) (forall ((i_3 Int) ) (!  (=> (and (<= 0 i_3) (< i_3 (|Seq#Length| ar@@1))) (= (U_2_int (MapType0Select Heap@@6 (|Seq#Index| ar@@1 i_3) val)) (U_2_int (|Seq#Index| (|vals'| Heap@@6 p_1@@1 ar@@1) i_3))))
 :qid |stdinbpl.618:17|
 :skolemid |65|
 :pattern ( (|Seq#Index| ar@@1 i_3))
 :pattern ( (|Seq#Index| (|vals'| Heap@@6 p_1@@1 ar@@1) i_3))
)))
 :qid |stdinbpl.613:15|
 :skolemid |66|
 :pattern ( (state Heap@@6 Mask@@5) (|vals'| Heap@@6 p_1@@1 ar@@1))
)))
(assert  (and (forall ((arg0@@37 Real) (arg1@@17 T@U) ) (! (= (type (ConditionalFrame arg0@@37 arg1@@17)) FrameTypeType)
 :qid |funType:ConditionalFrame|
 :pattern ( (ConditionalFrame arg0@@37 arg1@@17))
...
(assert (forall ((arg0@@38 T@U) (arg1@@18 Real) (arg2@@5 T@U) ) (! (= (type (vals arg0@@38 arg1@@18 arg2@@5)) (SeqType intType))
 :qid |funType:vals|
 :pattern ( (vals arg0@@38 arg1@@18 arg2@@5))
)))
(assert (forall ((Heap@@7 T@U) (p_1@@2 Real) (ar@@2 T@U) ) (!  (=> (and (= (type Heap@@7) (MapType0Type RefType)) (= (type ar@@2) (SeqType RefType))) (and (= (vals Heap@@7 p_1@@2 ar@@2) (|vals'| Heap@@7 p_1@@2 ar@@2)) (dummyFunction (|vals#triggerStateless| p_1@@2 ar@@2))))
 :qid |stdinbpl.579:15|
 :skolemid |58|
 :pattern ( (vals Heap@@7 p_1@@2 ar@@2))
)))
(assert (forall ((arg0@@39 T@U) (arg1@@19 Real) (arg2@@6 T@U) ) (! (= (type (|vals#frame| arg0@@39 arg1@@19 arg2@@6)) (SeqType intType))
 :qid |funType:vals#frame|
 :pattern ( (|vals#frame| arg0@@39 arg1@@19 arg2@@6))
)))
(assert (forall ((Heap@@8 T@U) (Mask@@7 T@U) (p_1@@3 Real) (ar@@3 T@U) ) (!  (=> (and (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (= (type ar@@3) (SeqType RefType))) (state Heap@@8 Mask@@7)) (= (|vals'| Heap@@8 p_1@@3 ar@@3) (|vals#frame| (FrameFragment (int_2_U (|vals#condqp1| Heap@@8 p_1@@3 ar@@3))) p_1@@3 ar@@3)))
 :qid |stdinbpl.590:15|
 :skolemid |60|
 :pattern ( (state Heap@@8 Mask@@7) (|vals'| Heap@@8 p_1@@3 ar@@3))
)))
...
(assert (forall ((Heap@@13 T@U) (Mask@@11 T@U) (p_1@@4 Real) (ar@@4 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (= (type ar@@4) (SeqType RefType))) (and (state Heap@@13 Mask@@11) (or (< AssumeFunctionsAbove 0) (|vals#trigger| (FrameFragment (int_2_U (|vals#condqp1| Heap@@13 p_1@@4 ar@@4))) p_1@@4 ar@@4)))) (and (< NoPerm p_1@@4) (forall ((i_1@@0 Int) (j@@6 Int) ) (!  (=> (and (<= 0 i_1@@0) (and (< i_1@@0 (|Seq#Length| ar@@4)) (and (<= 0 j@@6) (and (< j@@6 (|Seq#Length| ar@@4)) (not (= i_1@@0 j@@6)))))) (not (= (|Seq#Index| ar@@4 i_1@@0) (|Seq#Index| ar@@4 j@@6))))
 :qid |stdinbpl.608:148|
 :skolemid |62|
 :pattern ( (|Seq#Index| ar@@4 i_1@@0) (|Seq#Index| ar@@4 j@@6))
)))) (= (|Seq#Length| (|vals'| Heap@@13 p_1@@4 ar@@4)) (|Seq#Length| ar@@4)))
 :qid |stdinbpl.606:15|
 :skolemid |63|
 :pattern ( (state Heap@@13 Mask@@11) (|vals'| Heap@@13 p_1@@4 ar@@4))
)))
...
(declare-fun j_4 () Int)
(assert  (and (and (and (= (type ar@@5) (SeqType RefType)) (= (type xs@0) (SeqType intType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@14) (MapType0Type RefType))))
(set-info :boogie-vc-id Problem__problem)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 42) (let ((anon12_correct true))
(let ((anon29_Else_correct  (=> (and (not (and (<= 0 i_4_1) (and (< i_4_1 (|Seq#Length| ar@@5)) (and (<= 0 j_2) (and (< j_2 (|Seq#Length| ar@@5)) (not (= i_4_1 j_2))))))) (= (ControlFlow 0 35) 32)) anon12_correct)))
(let ((anon29_Then_correct  (=> (and (<= 0 i_4_1) (and (< i_4_1 (|Seq#Length| ar@@5)) (and (<= 0 j_2) (and (< j_2 (|Seq#Length| ar@@5)) (not (= i_4_1 j_2)))))) (and (=> (= (ControlFlow 0 33) (- 0 34)) (not (= (|Seq#Index| ar@@5 i_4_1) (|Seq#Index| ar@@5 j_2)))) (=> (not (= (|Seq#Index| ar@@5 i_4_1) (|Seq#Index| ar@@5 j_2))) (=> (= (ControlFlow 0 33) 32) anon12_correct))))))
(let ((anon28_Else_correct  (=> (forall ((i_5_1 Int) (j_3_1 Int) ) (!  (=> (and (<= 0 i_5_1) (and (< i_5_1 (|Seq#Length| ar@@5)) (and (<= 0 j_3_1) (and (< j_3_1 (|Seq#Length| ar@@5)) (not (= i_5_1 j_3_1)))))) (not (= (|Seq#Index| ar@@5 i_5_1) (|Seq#Index| ar@@5 j_3_1))))
 :qid |stdinbpl.1027:24|
 :skolemid |93|
 :pattern ( (|Seq#Index| ar@@5 i_5_1) (|Seq#Index| ar@@5 j_3_1))
)) (and (=> (= (ControlFlow 0 29) (- 0 31)) (forall ((i_6 Int) ) (!  (=> (and (and (<= 0 i_6) (< i_6 (|Seq#Length| ar@@5))) (dummyFunction (MapType0Select Heap@@14 (|Seq#Index| ar@@5 i_6) val))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1035:21|
 :skolemid |94|
 :pattern ( (|Seq#Index| ar@@5 i_6))
 :pattern ( (|Seq#Index| ar@@5 i_6))
))) (=> (forall ((i_6@@0 Int) ) (!  (=> (and (and (<= 0 i_6@@0) (< i_6@@0 (|Seq#Length| ar@@5))) (dummyFunction (MapType0Select Heap@@14 (|Seq#Index| ar@@5 i_6@@0) val))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1035:21|
 :skolemid |94|
 :pattern ( (|Seq#Index| ar@@5 i_6@@0))
 :pattern ( (|Seq#Index| ar@@5 i_6@@0))
)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (forall ((i_6@@1 Int) (i_6_1 Int) ) (!  (=> (and (and (and (and (not (= i_6@@1 i_6_1)) (and (<= 0 i_6@@1) (< i_6@@1 (|Seq#Length| ar@@5)))) (and (<= 0 i_6_1) (< i_6_1 (|Seq#Length| ar@@5)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index| ar@@5 i_6@@1) (|Seq#Index| ar@@5 i_6_1))))
 :qid |stdinbpl.1042:21|
 :skolemid |95|
 :pattern ( (neverTriggered4 i_6@@1) (neverTriggered4 i_6_1))
))) (=> (forall ((i_6@@2 Int) (i_6_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_6@@2 i_6_1@@0)) (and (<= 0 i_6@@2) (< i_6@@2 (|Seq#Length| ar@@5)))) (and (<= 0 i_6_1@@0) (< i_6_1@@0 (|Seq#Length| ar@@5)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index| ar@@5 i_6@@2) (|Seq#Index| ar@@5 i_6_1@@0))))
 :qid |stdinbpl.1042:21|
 :skolemid |95|
 :pattern ( (neverTriggered4 i_6@@2) (neverTriggered4 i_6_1@@0))
)) (=> (= (ControlFlow 0 29) (- 0 28)) (forall ((i_6@@3 Int) ) (!  (=> (and (<= 0 i_6@@3) (< i_6@@3 (|Seq#Length| ar@@5))) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| ar@@5 i_6@@3) val)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.1049:21|
 :skolemid |96|
 :pattern ( (|Seq#Index| ar@@5 i_6@@3))
 :pattern ( (|Seq#Index| ar@@5 i_6@@3))
))))))))))
...
(let ((anon33_Else_correct  (=> (and (not (and (<= 0 i_8_1) (< i_8_1 (|Seq#Length| ar@@5)))) (= (ControlFlow 0 25) 22)) anon21_correct)))
(let ((anon33_Then_correct  (=> (and (<= 0 i_8_1) (< i_8_1 (|Seq#Length| ar@@5))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (= (U_2_int (|Seq#Index| xs@0 i_8_1)) (U_2_int (MapType0Select Heap@@14 (|Seq#Index| ar@@5 i_8_1) val)))) (=> (= (U_2_int (|Seq#Index| xs@0 i_8_1)) (U_2_int (MapType0Select Heap@@14 (|Seq#Index| ar@@5 i_8_1) val))) (=> (= (ControlFlow 0 23) 22) anon21_correct))))))
(let ((anon17_correct true))
(let ((anon31_Else_correct  (=> (and (not (and (<= 0 i_14) (< i_14 (|Seq#Length| ar@@5)))) (= (ControlFlow 0 21) 14)) anon17_correct)))
(let ((anon31_Then_correct  (=> (and (<= 0 i_14) (< i_14 (|Seq#Length| ar@@5))) (and (=> (= (ControlFlow 0 15) (- 0 20)) (>= i_14 0)) (=> (>= i_14 0) (and (=> (= (ControlFlow 0 15) (- 0 19)) (< i_14 (|Seq#Length| xs@0))) (=> (< i_14 (|Seq#Length| xs@0)) (and (=> (= (ControlFlow 0 15) (- 0 18)) (>= i_14 0)) (=> (>= i_14 0) (and (=> (= (ControlFlow 0 15) (- 0 17)) (< i_14 (|Seq#Length| ar@@5))) (=> (< i_14 (|Seq#Length| ar@@5)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm QPMask@0 (|Seq#Index| ar@@5 i_14) val)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| ar@@5 i_14) val) (=> (= (ControlFlow 0 15) 14) anon17_correct))))))))))))))
(let ((anon32_Else_correct true))
(let ((anon27_Else_correct  (=> (and (= xs@0 (vals Heap@@14 (/ (to_real 1) (to_real 2)) ar@@5)) (state Heap@@14 QPMask@0)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (= (|Seq#Length| xs@0) (|Seq#Length| ar@@5))) (=> (= (|Seq#Length| xs@0) (|Seq#Length| ar@@5)) (=> (state Heap@@14 QPMask@0) (and (and (and (and (=> (= (ControlFlow 0 26) 13) anon32_Else_correct) (=> (= (ControlFlow 0 26) 23) anon33_Then_correct)) (=> (= (ControlFlow 0 26) 25) anon33_Else_correct)) (=> (= (ControlFlow 0 26) 15) anon31_Then_correct)) (=> (= (ControlFlow 0 26) 21) anon31_Else_correct))))))))
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 38) (- 0 39)) (forall ((i_3@@0 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1)) (and (<= 0 i_3@@0) (< i_3@@0 (|Seq#Length| ar@@5)))) (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length| ar@@5)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ar@@5 i_3@@0) (|Seq#Index| ar@@5 i_3_1))))
 :qid |stdinbpl.971:15|
 :skolemid |87|
))) (=> (forall ((i_3@@1 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@1 i_3_1@@0)) (and (<= 0 i_3@@1) (< i_3@@1 (|Seq#Length| ar@@5)))) (and (<= 0 i_3_1@@0) (< i_3_1@@0 (|Seq#Length| ar@@5)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ar@@5 i_3@@1) (|Seq#Index| ar@@5 i_3_1@@0))))
 :qid |stdinbpl.971:15|
 :skolemid |87|
)) (=> (forall ((i_3@@2 Int) ) (!  (=> (and (and (<= 0 i_3@@2) (< i_3@@2 (|Seq#Length| ar@@5))) (< NoPerm FullPerm)) (and (qpRange3 (|Seq#Index| ar@@5 i_3@@2)) (= (invRecv3 (|Seq#Index| ar@@5 i_3@@2)) i_3@@2)))
 :qid |stdinbpl.977:22|
 :skolemid |88|
 :pattern ( (|Seq#Index| ar@@5 i_3@@2))
 :pattern ( (|Seq#Index| ar@@5 i_3@@2))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv3 o_3)) (< (invRecv3 o_3) (|Seq#Length| ar@@5))) (< NoPerm FullPerm)) (qpRange3 o_3)) (= (|Seq#Index| ar@@5 (invRecv3 o_3)) o_3)))
 :qid |stdinbpl.981:22|
 :skolemid |89|
 :pattern ( (invRecv3 o_3))
)) (forall ((i_3@@3 Int) ) (!  (=> (and (<= 0 i_3@@3) (< i_3@@3 (|Seq#Length| ar@@5))) (not (= (|Seq#Index| ar@@5 i_3@@3) null)))
 :qid |stdinbpl.987:22|
 :skolemid |90|
 :pattern ( (|Seq#Index| ar@@5 i_3@@3))
 :pattern ( (|Seq#Index| ar@@5 i_3@@3))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv3 o_3@@0)) (< (invRecv3 o_3@@0) (|Seq#Length| ar@@5))) (< NoPerm FullPerm)) (qpRange3 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| ar@@5 (invRecv3 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv3 o_3@@0)) (< (invRecv3 o_3@@0) (|Seq#Length| ar@@5))) (< NoPerm FullPerm)) (qpRange3 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.993:22|
 :skolemid |91|
...
))) (and (state Heap@@14 QPMask@0) (state Heap@@14 QPMask@0))) (and (=> (= (ControlFlow 0 38) 36) anon27_Then_correct) (=> (= (ControlFlow 0 38) 26) anon27_Else_correct)))))))))
(let ((anon7_correct true))
(let ((anon26_Else_correct  (=> (and (not (and (<= 0 i_13) (< i_13 (|Seq#Length| ar@@5)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon26_Then_correct  (=> (and (<= 0 i_13) (< i_13 (|Seq#Length| ar@@5))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_13 0)) (=> (>= i_13 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_13 (|Seq#Length| ar@@5))) (=> (< i_13 (|Seq#Length| ar@@5)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon23_Else_correct  (=> (and (forall ((i_1@@1 Int) (j_1_1 Int) ) (!  (=> (and (<= 0 i_1@@1) (and (< i_1@@1 (|Seq#Length| ar@@5)) (and (<= 0 j_1_1) (and (< j_1_1 (|Seq#Length| ar@@5)) (not (= i_1@@1 j_1_1)))))) (not (= (|Seq#Index| ar@@5 i_1@@1) (|Seq#Index| ar@@5 j_1_1))))
 :qid |stdinbpl.953:20|
 :skolemid |86|
 :pattern ( (|Seq#Index| ar@@5 i_1@@1) (|Seq#Index| ar@@5 j_1_1))
)) (state Heap@@14 ZeroMask)) (and (and (=> (= (ControlFlow 0 40) 38) anon25_Else_correct) (=> (= (ControlFlow 0 40) 9) anon26_Then_correct)) (=> (= (ControlFlow 0 40) 12) anon26_Else_correct)))))
(let ((anon3_correct true))
(let ((anon24_Else_correct  (=> (and (not (and (<= 0 i_12) (and (< i_12 (|Seq#Length| ar@@5)) (and (<= 0 j_4) (and (< j_4 (|Seq#Length| ar@@5)) (not (= i_12 j_4))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon24_Then_correct  (=> (and (<= 0 i_12) (and (< i_12 (|Seq#Length| ar@@5)) (and (<= 0 j_4) (and (< j_4 (|Seq#Length| ar@@5)) (not (= i_12 j_4)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_12 0)) (=> (>= i_12 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_12 (|Seq#Length| ar@@5))) (=> (< i_12 (|Seq#Length| ar@@5)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_4 0)) (=> (>= j_4 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_4 (|Seq#Length| ar@@5))) (=> (< j_4 (|Seq#Length| ar@@5)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (and (=> (= (ControlFlow 0 41) 40) anon23_Else_correct) (=> (= (ControlFlow 0 41) 2) anon24_Then_correct)) (=> (= (ControlFlow 0 41) 7) anon24_Else_correct)))))
