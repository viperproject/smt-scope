...
(assert  (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type diz@@19) RefType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type PostMask@1) (MapType1Type RefType realType))) (= (type Heap@@19) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id History__free_set_x)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon7_Else_correct true))
(let ((anon7_Then_correct  (=> (and (and (state PostHeap@0 ZeroMask) (not (= diz@@19 null))) (and (= PostMask@0 (MapType1Store ZeroMask diz@@19 History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz@@19 History__x_hist_value)) FullPerm)))) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm PostMask@0 diz@@19 History__x_hist_value)) (=> (HasDirectPerm PostMask@0 diz@@19 History__x_hist_value) (=> (= (U_2_int (MapType0Select PostHeap@0 diz@@19 History__x_hist_value)) value) (=> (and (state PostHeap@0 PostMask@0) (= perm@1 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (and (=> (> perm@1 NoPerm) (not (= diz@@19 null))) (= PostMask@1 (MapType1Store PostMask@0 diz@@19 History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select PostMask@0 diz@@19 History__x_hist_mode)) perm@1))))) (and (state PostHeap@0 PostMask@1) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm PostMask@1 diz@@19 History__x_hist_mode)))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@19 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@19 diz@@19 $allocated)) (not (= diz@@19 null)))) (=> (and (and (and (state Heap@@19 ZeroMask) (>= current_thread_id 0)) (and (state Heap@@19 ZeroMask) (not (= diz@@19 null)))) (and (and (= Mask@0 (MapType1Store ZeroMask diz@@19 History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz@@19 History__x_hist_value)) FullPerm)))) (state Heap@@19 Mask@0)) (and (state Heap@@19 Mask@0) (= perm@0 (/ (to_real 1) (to_real 2)))))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= diz@@19 null))) (=> (and (= Mask@1 (MapType1Store Mask@0 diz@@19 History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select Mask@0 diz@@19 History__x_hist_mode)) perm@0)))) (state Heap@@19 Mask@1)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm Mask@1 diz@@19 History__x_hist_mode)) (=> (HasDirectPerm Mask@1 diz@@19 History__x_hist_mode) (=> (and (= (U_2_int (MapType0Select Heap@@19 diz@@19 History__x_hist_mode)) 0) (state Heap@@19 Mask@1)) (and (=> (= (ControlFlow 0 6) 2) anon7_Then_correct) (=> (= (ControlFlow 0 6) 5) anon7_Else_correct)))))))))))))
...
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(set-info :boogie-vc-id Application__if_any_random)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
