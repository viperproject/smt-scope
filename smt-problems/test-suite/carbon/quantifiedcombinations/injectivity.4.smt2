...
(declare-fun |pred2#sm| (T@U Int) T@U)
...
(assert  (and (and (= (Ctor PredicateType_pred2Type) 12) (= (Ctor FrameTypeType) 13)) (forall ((arg0@@26 T@U) (arg1@@10 Int) ) (! (= (type (pred2 arg0@@26 arg1@@10)) (FieldType PredicateType_pred2Type FrameTypeType))
 :qid |funType:pred2|
 :pattern ( (pred2 arg0@@26 arg1@@10))
))))
(assert (forall ((a_1 T@U) (i Int) ) (!  (=> (= (type a_1) RefType) (IsPredicateField (pred2 a_1 i)))
 :qid |stdinbpl.684:15|
 :skolemid |65|
 :pattern ( (pred2 a_1 i))
)))
(assert (forall ((Heap@@0 T@U) (a_1@@0 T@U) (i@@0 Int) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type a_1@@0) RefType)) (|pred2#everUsed| (pred2 a_1@@0 i@@0)))
 :qid |stdinbpl.703:15|
 :skolemid |69|
 :pattern ( (|pred2#trigger| Heap@@0 (pred2 a_1@@0 i@@0)))
)))
...
(assert (forall ((a_1@@3 T@U) (i@@4 Int) (a2 T@U) (i2 Int) ) (!  (=> (and (and (= (type a_1@@3) RefType) (= (type a2) RefType)) (= (pred2 a_1@@3 i@@4) (pred2 a2 i2))) (and (= a_1@@3 a2) (= i@@4 i2)))
 :qid |stdinbpl.694:15|
 :skolemid |67|
 :pattern ( (pred2 a_1@@3 i@@4) (pred2 a2 i2))
)))
(assert (forall ((arg0@@35 T@U) (arg1@@15 Int) ) (! (= (type (|pred2#sm| arg0@@35 arg1@@15)) (FieldType PredicateType_pred2Type (MapType1Type RefType boolType)))
 :qid |funType:pred2#sm|
 :pattern ( (|pred2#sm| arg0@@35 arg1@@15))
)))
(assert (forall ((a_1@@4 T@U) (i@@5 Int) (a2@@0 T@U) (i2@@0 Int) ) (!  (=> (and (and (= (type a_1@@4) RefType) (= (type a2@@0) RefType)) (= (|pred2#sm| a_1@@4 i@@5) (|pred2#sm| a2@@0 i2@@0))) (and (= a_1@@4 a2@@0) (= i@@5 i2@@0)))
 :qid |stdinbpl.698:15|
 :skolemid |68|
 :pattern ( (|pred2#sm| a_1@@4 i@@5) (|pred2#sm| a2@@0 i2@@0))
)))
...
(assert (forall ((a_1@@7 T@U) (i@@7 Int) ) (!  (=> (= (type a_1@@7) RefType) (= (getPredWandId (pred2 a_1@@7 i@@7)) 1))
 :qid |stdinbpl.688:15|
 :skolemid |66|
 :pattern ( (pred2 a_1@@7 i@@7))
)))
...
(assert (forall ((a_1@@9 T@U) (i@@8 Int) ) (!  (=> (= (type a_1@@9) RefType) (= (PredicateMaskField (pred2 a_1@@9 i@@8)) (|pred2#sm| a_1@@9 i@@8)))
 :qid |stdinbpl.680:15|
 :skolemid |64|
 :pattern ( (PredicateMaskField (pred2 a_1@@9 i@@8)))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type xs) (SeqType RefType)) (= (type y@@2) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@39 T@U) (arg1@@18 Int) ) (! (= (type (invRecv14 arg0@@39 arg1@@18)) RefType)
 :qid |funType:invRecv14|
 :pattern ( (invRecv14 arg0@@39 arg1@@18))
))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type Heap@@11) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (forall ((arg0@@40 T@U) (arg1@@19 Int) ) (! (= (type (invRecv12 arg0@@40 arg1@@19)) RefType)
 :qid |funType:invRecv12|
 :pattern ( (invRecv12 arg0@@40 arg1@@19))
))) (= (type QPMask@3) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (forall ((arg0@@41 T@U) ) (! (= (type (invRecv11 arg0@@41)) RefType)
 :qid |funType:invRecv11|
 :pattern ( (invRecv11 arg0@@41))
))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon12_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((x_6 T@U) (x_6_1 T@U) ) (!  (=> (and (= (type x_6) RefType) (= (type x_6_1) RefType)) (=> (and (and (and (and (not (= x_6 x_6_1)) (|Seq#Contains| xs x_6)) (|Seq#Contains| xs x_6_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_6 x_6_1))))
...
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (|Seq#Contains| xs x_3)) (|Seq#Contains| xs x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y@@2 y@@2))))
 :qid |stdinbpl.1335:17|
 :skolemid |138|
 :pattern ( (neverTriggered12 x_3) (neverTriggered12 x_3_1))
))) (=> (forall ((x_3@@0 T@U) (x_3_1@@0 T@U) ) (!  (=> (and (= (type x_3@@0) RefType) (= (type x_3_1@@0) RefType)) (=> (and (and (and (and (not (= x_3@@0 x_3_1@@0)) (|Seq#Contains| xs x_3@@0)) (|Seq#Contains| xs x_3_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y@@2 y@@2))))
 :qid |stdinbpl.1335:17|
 :skolemid |138|
 :pattern ( (neverTriggered12 x_3@@0) (neverTriggered12 x_3_1@@0))
)) (=> (and (forall ((x_3@@1 T@U) ) (!  (=> (= (type x_3@@1) RefType) (=> (and (|Seq#Contains| xs x_3@@1) (< NoPerm FullPerm)) (and (= (invRecv12 y@@2 1) x_3@@1) (qpRange12 y@@2 1))))
 :qid |stdinbpl.1341:22|
 :skolemid |139|
 :pattern ( (|Seq#ContainsTrigger| xs x_3@@1))
 :pattern ( (|Seq#Contains| xs x_3@@1))
)) (forall ((a_1@@11 T@U) (i@@12 Int) ) (!  (=> (= (type a_1@@11) RefType) (=> (and (and (|Seq#Contains| xs (invRecv12 a_1@@11 i@@12)) (< NoPerm FullPerm)) (qpRange12 a_1@@11 i@@12)) (and (= y@@2 a_1@@11) (= 1 i@@12))))
 :qid |stdinbpl.1345:22|
 :skolemid |140|
 :pattern ( (invRecv12 a_1@@11 i@@12))
))) (=> (and (and (forall ((a_1@@12 T@U) (i@@13 Int) ) (!  (=> (= (type a_1@@12) RefType) (=> (and (and (|Seq#Contains| xs (invRecv12 a_1@@12 i@@13)) (< NoPerm FullPerm)) (qpRange12 a_1@@12 i@@13)) (and (=> (< NoPerm FullPerm) (and (= y@@2 a_1@@12) (= 1 i@@13))) (= (U_2_real (MapType1Select QPMask@3 null (pred2 a_1@@12 i@@13))) (+ (U_2_real (MapType1Select ZeroMask null (pred2 a_1@@12 i@@13))) FullPerm)))))
 :qid |stdinbpl.1351:22|
 :skolemid |141|
 :pattern ( (MapType1Select QPMask@3 null (pred2 a_1@@12 i@@13)))
)) (forall ((o_3 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (or (or (not (= o_3 null)) (not (IsPredicateField f_5))) (not (= (getPredWandId f_5) 1)))) (= (U_2_real (MapType1Select ZeroMask o_3 f_5)) (U_2_real (MapType1Select QPMask@3 o_3 f_5))))))
 :qid |stdinbpl.1357:29|
 :skolemid |142|
 :pattern ( (MapType1Select ZeroMask o_3 f_5))
 :pattern ( (MapType1Select QPMask@3 o_3 f_5))
))) (and (forall ((a_1@@13 T@U) (i@@14 Int) ) (!  (=> (and (= (type a_1@@13) RefType) (not (and (and (|Seq#Contains| xs (invRecv12 a_1@@13 i@@14)) (< NoPerm FullPerm)) (qpRange12 a_1@@13 i@@14)))) (= (U_2_real (MapType1Select QPMask@3 null (pred2 a_1@@13 i@@14))) (U_2_real (MapType1Select ZeroMask null (pred2 a_1@@13 i@@14)))))
 :qid |stdinbpl.1361:22|
 :skolemid |143|
 :pattern ( (MapType1Select QPMask@3 null (pred2 a_1@@13 i@@14)))
...
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((x_7 T@U) (x_7_1 T@U) ) (!  (=> (and (= (type x_7) RefType) (= (type x_7_1) RefType)) (=> (and (and (and (and (not (= x_7 x_7_1)) (|Seq#Contains| xs x_7)) (|Seq#Contains| xs x_7_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y@@2 y@@2))))
 :qid |stdinbpl.1421:17|
 :skolemid |150|
 :pattern ( (neverTriggered14 x_7) (neverTriggered14 x_7_1))
))) (=> (forall ((x_7@@0 T@U) (x_7_1@@0 T@U) ) (!  (=> (and (= (type x_7@@0) RefType) (= (type x_7_1@@0) RefType)) (=> (and (and (and (and (not (= x_7@@0 x_7_1@@0)) (|Seq#Contains| xs x_7@@0)) (|Seq#Contains| xs x_7_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y@@2 y@@2))))
 :qid |stdinbpl.1421:17|
 :skolemid |150|
 :pattern ( (neverTriggered14 x_7@@0) (neverTriggered14 x_7_1@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((x_7@@1 T@U) ) (!  (=> (and (= (type x_7@@1) RefType) (|Seq#Contains| xs x_7@@1)) (>= (U_2_real (MapType1Select QPMask@0 null (pred2 y@@2 1))) FullPerm))
 :qid |stdinbpl.1428:17|
 :skolemid |151|
 :pattern ( (|Seq#ContainsTrigger| xs x_7@@1))
 :pattern ( (|Seq#Contains| xs x_7@@1))
))) (=> (forall ((x_7@@2 T@U) ) (!  (=> (and (= (type x_7@@2) RefType) (|Seq#Contains| xs x_7@@2)) (>= (U_2_real (MapType1Select QPMask@0 null (pred2 y@@2 1))) FullPerm))
 :qid |stdinbpl.1428:17|
 :skolemid |151|
 :pattern ( (|Seq#ContainsTrigger| xs x_7@@2))
 :pattern ( (|Seq#Contains| xs x_7@@2))
)) (=> (forall ((x_7@@3 T@U) ) (!  (=> (= (type x_7@@3) RefType) (=> (and (|Seq#Contains| xs x_7@@3) (< NoPerm FullPerm)) (and (= (invRecv14 y@@2 1) x_7@@3) (qpRange14 y@@2 1))))
 :qid |stdinbpl.1434:22|
 :skolemid |152|
 :pattern ( (|Seq#ContainsTrigger| xs x_7@@3))
 :pattern ( (|Seq#Contains| xs x_7@@3))
)) (=> (and (and (forall ((a_1_1 T@U) (i_1 Int) ) (!  (=> (= (type a_1_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv14 a_1_1 i_1)) (< NoPerm FullPerm)) (qpRange14 a_1_1 i_1)) (and (= y@@2 a_1_1) (= 1 i_1))))
 :qid |stdinbpl.1438:22|
 :skolemid |153|
 :pattern ( (invRecv14 a_1_1 i_1))
)) (forall ((a_1_1@@0 T@U) (i_1@@0 Int) ) (!  (=> (= (type a_1_1@@0) RefType) (=> (and (and (|Seq#Contains| xs (invRecv14 a_1_1@@0 i_1@@0)) (< NoPerm FullPerm)) (qpRange14 a_1_1@@0 i_1@@0)) (and (and (= y@@2 a_1_1@@0) (= 1 i_1@@0)) (= (U_2_real (MapType1Select QPMask@1 null (pred2 a_1_1@@0 i_1@@0))) (- (U_2_real (MapType1Select QPMask@0 null (pred2 a_1_1@@0 i_1@@0))) FullPerm)))))
 :qid |stdinbpl.1444:22|
 :skolemid |154|
 :pattern ( (MapType1Select QPMask@1 null (pred2 a_1_1@@0 i_1@@0)))
))) (and (forall ((a_1_1@@1 T@U) (i_1@@1 Int) ) (!  (=> (and (= (type a_1_1@@1) RefType) (not (and (and (|Seq#Contains| xs (invRecv14 a_1_1@@1 i_1@@1)) (< NoPerm FullPerm)) (qpRange14 a_1_1@@1 i_1@@1)))) (= (U_2_real (MapType1Select QPMask@1 null (pred2 a_1_1@@1 i_1@@1))) (U_2_real (MapType1Select QPMask@0 null (pred2 a_1_1@@1 i_1@@1)))))
 :qid |stdinbpl.1448:22|
 :skolemid |155|
 :pattern ( (MapType1Select QPMask@1 null (pred2 a_1_1@@1 i_1@@1)))
...
)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_8 T@U) (x_8_1 T@U) ) (!  (=> (and (= (type x_8) RefType) (= (type x_8_1) RefType)) (=> (and (and (and (and (not (= x_8 x_8_1)) (|Seq#Contains| xs x_8)) (|Seq#Contains| xs x_8_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_8 x_8_1))))
 :qid |stdinbpl.1466:17|
 :skolemid |157|
...
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_8@@1 T@U) ) (!  (=> (and (= (type x_8@@1) RefType) (|Seq#Contains| xs x_8@@1)) (>= (U_2_real (MapType1Select QPMask@1 x_8@@1 f_7)) FullPerm))
 :qid |stdinbpl.1473:17|
 :skolemid |158|
 :pattern ( (MapType0Select Heap@@11 x_8@@1 f_7))
 :pattern ( (MapType1Select QPMask@2 x_8@@1 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs x_8@@1))
 :pattern ( (|Seq#Contains| xs x_8@@1))
)))))))))))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| xs x_1)) (|Seq#Contains| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| xs x_1@@1) (< NoPerm FullPerm)) (and (qpRange11 x_1@@1) (= (invRecv11 x_1@@1) x_1@@1))))
...
)) (=> (and (forall ((o_3@@1 T@U) ) (!  (=> (= (type o_3@@1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv11 o_3@@1)) (< NoPerm FullPerm)) (qpRange11 o_3@@1)) (= (invRecv11 o_3@@1) o_3@@1)))
 :qid |stdinbpl.1292:22|
 :skolemid |134|
 :pattern ( (invRecv11 o_3@@1))
...
))) (=> (and (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (and (=> (and (and (|Seq#Contains| xs (invRecv11 o_3@@2)) (< NoPerm FullPerm)) (qpRange11 o_3@@2)) (and (=> (< NoPerm FullPerm) (= (invRecv11 o_3@@2) o_3@@2)) (= (U_2_real (MapType1Select QPMask@0 o_3@@2 f_7)) (+ (U_2_real (MapType1Select Mask@0 o_3@@2 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| xs (invRecv11 o_3@@2)) (< NoPerm FullPerm)) (qpRange11 o_3@@2))) (= (U_2_real (MapType1Select QPMask@0 o_3@@2 f_7)) (U_2_real (MapType1Select Mask@0 o_3@@2 f_7))))))
 :qid |stdinbpl.1304:22|
 :skolemid |136|
 :pattern ( (MapType1Select QPMask@0 o_3@@2 f_7))
)) (forall ((o_3@@3 T@U) (f_5@@1 T@U) ) (! (let ((B@@13 (FieldTypeInv1 (type f_5@@1))))
(let ((A@@14 (FieldTypeInv0 (type f_5@@1))))
 (=> (and (and (= (type o_3@@3) RefType) (= (type f_5@@1) (FieldType A@@14 B@@13))) (not (= f_5@@1 f_7))) (= (U_2_real (MapType1Select Mask@0 o_3@@3 f_5@@1)) (U_2_real (MapType1Select QPMask@0 o_3@@3 f_5@@1))))))
 :qid |stdinbpl.1308:29|
 :skolemid |137|
 :pattern ( (MapType1Select Mask@0 o_3@@3 f_5@@1))
 :pattern ( (MapType1Select QPMask@0 o_3@@3 f_5@@1))
))) (and (state Heap@@11 QPMask@0) (state Heap@@11 QPMask@0))) (and (=> (= (ControlFlow 0 14) 13) anon10_Then_correct) (=> (= (ControlFlow 0 14) 3) anon10_Else_correct)))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@11 y@@2 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (pred2 y@@2 1) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (pred2 y@@2 1))) FullPerm))))) (and (state Heap@@11 Mask@0) (state Heap@@11 Mask@0))) (and (=> (= (ControlFlow 0 16) 1) anon9_Then_correct) (=> (= (ControlFlow 0 16) 14) anon9_Else_correct))))))
