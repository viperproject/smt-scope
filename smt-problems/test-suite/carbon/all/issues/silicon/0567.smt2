...
(let ((anon15_Then_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (= (id Heap@@13 y_3) y_3)) (=> (= (id Heap@@13 y_3) y_3) (=> (= (ControlFlow 0 4) (- 0 3)) (= y_3 i@@3))))))
(let ((anon11_Else_correct  (=> (forall ((y_1 Int) ) (! (= (id Heap@@13 y_1) i@@3)
 :qid |stdinbpl.458:20|
 :skolemid |32|
 :pattern ( (|id#frame| EmptyFrame y_1))
)) (=> (and (state Heap@@13 ZeroMask) (state Heap@@13 ZeroMask)) (and (and (and (=> (= (ControlFlow 0 9) 4) anon15_Then_correct) (=> (= (ControlFlow 0 9) 6) anon15_Else_correct)) (=> (= (ControlFlow 0 9) 7) anon14_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon14_Else_correct))))))
(let ((anon12_Else_correct true))
(let ((anon12_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (state Heap@@13 ZeroMask)) (and (and (=> (= (ControlFlow 0 10) 9) anon11_Else_correct) (=> (= (ControlFlow 0 10) 1) anon12_Then_correct)) (=> (= (ControlFlow 0 10) 2) anon12_Else_correct))))))
