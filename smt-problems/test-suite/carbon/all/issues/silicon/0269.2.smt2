...
(assert  (and (and (and (and (= (type Heap@0) (MapType0Type RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@17) (MapType0Type RefType))) (= (type out) RefType)) (= (type error_0) RefType)))
(set-info :boogie-vc-id nested_try_finally_fixed)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon18_Else_correct  (=> (and (and (not nonDet) (state Heap@0 Mask@0)) (and (state Heap@0 Mask@0) (= (ControlFlow 0 7) (- 0 6)))) false)))
(let ((__end_correct true))
(let ((anon18_Then_correct  (=> (and nonDet (= (ControlFlow 0 5) 1)) __end_correct)))
(let ((anon17_Then_correct  (=> (and (and (> 0 1) (state Heap@0 Mask@0)) (and (state Heap@0 Mask@0) (state Heap@0 Mask@0))) (and (=> (= (ControlFlow 0 8) 5) anon18_Then_correct) (=> (= (ControlFlow 0 8) 7) anon18_Else_correct)))))
(let ((anon19_Else_correct  (=> (and (>= 0 0) (= (ControlFlow 0 3) 1)) __end_correct)))
(let ((anon19_Then_correct  (=> (and (> 0 0) (= (ControlFlow 0 2) 1)) __end_correct)))
(let ((anon17_Else_correct  (=> (and (>= 1 0) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 4) 2) anon19_Then_correct) (=> (= (ControlFlow 0 4) 3) anon19_Else_correct)))))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) (U_2_bool (MapType0Select Heap@@17 out $allocated))) (=> (and (and (and (not (= out null)) (= Mask@0 (MapType1Store ZeroMask out Container_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask out Container_value)) FullPerm))))) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0))) (and (and (U_2_bool (MapType0Select Heap@@17 error_0 $allocated)) (state Heap@@17 Mask@0)) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (= FullPerm (U_2_real (MapType1Select Mask@0 out Container_value)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 out Container_value))) (=> (= Heap@0 (MapType0Store Heap@@17 out Container_value null)) (=> (and (and (state Heap@0 Mask@0) (state Heap@0 Mask@0)) (and (state Heap@0 Mask@0) (state Heap@0 Mask@0))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (= 0 0)) (=> (= 0 0) (=> (state Heap@0 Mask@0) (and (=> (= (ControlFlow 0 9) 8) anon17_Then_correct) (=> (= (ControlFlow 0 9) 4) anon17_Else_correct)))))))))))))
