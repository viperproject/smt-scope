...
(assert  (and (and (and (and (and (and (and (and (and (= (type ys) (MapType1Type RefType boolType)) (= (type xs) (MapType1Type RefType boolType))) (= (type WandDefLHSHeap@0) (MapType0Type RefType))) (= (type QPMask@2) (MapType2Type RefType realType))) (forall ((arg0@@49 T@U) ) (! (= (type (invRecv5 arg0@@49)) RefType)
 :qid |funType:invRecv5|
 :pattern ( (invRecv5 arg0@@49))
))) (= (type Mask@0) (MapType2Type RefType realType))) (= (type WandDefLHSHeap@1) (MapType0Type RefType))) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@50 T@U) ) (! (= (type (invRecv7 arg0@@50)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon18_Else_correct  (=> (= (ControlFlow 0 12) (- 0 11)) (forall ((y_3 T@U) (y_3_1 T@U) ) (!  (=> (and (= (type y_3) RefType) (= (type y_3_1) RefType)) (=> (and (and (and (and (not (= y_3 y_3_1)) (U_2_bool (MapType1Select ys y_3))) (U_2_bool (MapType1Select ys y_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_3 y_3_1))))
 :qid |stdinbpl.1218:19|
 :skolemid |138|
 :no-pattern (type y_3)
...
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (U_2_bool (MapType1Select xs x_3))) (U_2_bool (MapType1Select xs x_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1))))
 :qid |stdinbpl.1170:19|
 :skolemid |132|
 :no-pattern (type x_3)
...
))) (=> (forall ((x_3@@0 T@U) (x_3_1@@0 T@U) ) (!  (=> (and (= (type x_3@@0) RefType) (= (type x_3_1@@0) RefType)) (=> (and (and (and (and (not (= x_3@@0 x_3_1@@0)) (U_2_bool (MapType1Select xs x_3@@0))) (U_2_bool (MapType1Select xs x_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3@@0 x_3_1@@0))))
 :qid |stdinbpl.1170:19|
 :skolemid |132|
...
)) (=> (and (and (and (forall ((x_3@@1 T@U) ) (!  (=> (= (type x_3@@1) RefType) (=> (and (U_2_bool (MapType1Select xs x_3@@1)) (< NoPerm FullPerm)) (and (qpRange7 x_3@@1) (= (invRecv7 x_3@@1) x_3@@1))))
 :qid |stdinbpl.1176:26|
 :skolemid |133|
 :pattern ( (MapType0Select WandDefLHSHeap@1 x_3@@1 f_7))
 :pattern ( (MapType2Select QPMask@0 x_3@@1 f_7))
 :pattern ( (MapType1Select xs x_3@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType1Select xs (invRecv7 o_3))) (< NoPerm FullPerm)) (qpRange7 o_3)) (= (invRecv7 o_3) o_3)))
 :qid |stdinbpl.1180:26|
 :skolemid |134|
 :pattern ( (invRecv7 o_3))
))) (and (forall ((x_3@@2 T@U) ) (!  (=> (and (= (type x_3@@2) RefType) (U_2_bool (MapType1Select xs x_3@@2))) (not (= x_3@@2 null)))
 :qid |stdinbpl.1186:26|
 :skolemid |135|
 :pattern ( (MapType0Select WandDefLHSHeap@1 x_3@@2 f_7))
 :pattern ( (MapType2Select QPMask@0 x_3@@2 f_7))
 :pattern ( (MapType1Select xs x_3@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType1Select xs (invRecv7 o_3@@0))) (< NoPerm FullPerm)) (qpRange7 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv7 o_3@@0) o_3@@0)) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType2Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType1Select xs (invRecv7 o_3@@0))) (< NoPerm FullPerm)) (qpRange7 o_3@@0))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType2Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.1192:26|
 :skolemid |136|
...
(let ((anon16_Else_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (= (U_2_real (MapType2Select Mask@0 null (wand_1 xs FullPerm ys FullPerm))) FullPerm))))
(let ((anon13_Else_correct  (=> (and (and (= Mask@0 (MapType2Store ZeroMask null (wand_1 xs FullPerm ys FullPerm) (real_2_U (+ (U_2_real (MapType2Select ZeroMask null (wand_1 xs FullPerm ys FullPerm))) FullPerm)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (and (=> (= (ControlFlow 0 15) 8) anon16_Else_correct) (=> (= (ControlFlow 0 15) 9) anon17_Then_correct)) (=> (= (ControlFlow 0 15) 13) anon17_Else_correct)))))
(let ((anon15_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((y_1 T@U) (y_1_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (= (type y_1_1) RefType)) (=> (and (and (and (and (not (= y_1 y_1_1)) (U_2_bool (MapType1Select ys y_1))) (U_2_bool (MapType1Select ys y_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_1 y_1_1))))
 :qid |stdinbpl.1113:19|
 :skolemid |126|
 :no-pattern (type y_1)
...
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType1Select xs x_1))) (U_2_bool (MapType1Select xs x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.1065:19|
 :skolemid |120|
 :no-pattern (type x_1)
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (U_2_bool (MapType1Select xs x_1@@0))) (U_2_bool (MapType1Select xs x_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.1065:19|
 :skolemid |120|
...
)) (=> (and (and (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType1Select xs x_1@@1)) (< NoPerm FullPerm)) (and (qpRange5 x_1@@1) (= (invRecv5 x_1@@1) x_1@@1))))
 :qid |stdinbpl.1071:26|
 :skolemid |121|
 :pattern ( (MapType0Select WandDefLHSHeap@0 x_1@@1 f_7))
 :pattern ( (MapType2Select QPMask@2 x_1@@1 f_7))
 :pattern ( (MapType1Select xs x_1@@1))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType1Select xs (invRecv5 o_3@@2))) (< NoPerm FullPerm)) (qpRange5 o_3@@2)) (= (invRecv5 o_3@@2) o_3@@2)))
 ...
 :qid |stdinbpl.1081:26|
 :skolemid |123|
 :pattern ( (MapType0Select WandDefLHSHeap@0 x_1@@2 f_7))
 :pattern ( (MapType2Select QPMask@2 x_1@@2 f_7))
 :pattern ( (MapType1Select xs x_1@@2))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType1Select xs (invRecv5 o_3@@3))) (< NoPerm FullPerm)) (qpRange5 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv5 o_3@@3) o_3@@3)) (= (U_2_real (MapType2Select QPMask@2 o_3@@3 f_7)) (+ (U_2_real (MapType2Select ZeroMask o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType1Select xs (invRecv5 o_3@@3))) (< NoPerm FullPerm)) (qpRange5 o_3@@3))) (= (U_2_real (MapType2Select QPMask@2 o_3@@3 f_7)) (U_2_real (MapType2Select ZeroMask o_3@@3 f_7))))))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 f_7))) (= (U_2_real (MapType2Select ZeroMask o_3@@4 f_5@@0)) (U_2_real (MapType2Select QPMask@2 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.1091:33|
 :skolemid |125|
...
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (and (=> (= (ControlFlow 0 16) 15) anon13_Else_correct) (=> (= (ControlFlow 0 16) 1) anon14_Then_correct)) (=> (= (ControlFlow 0 16) 5) anon14_Else_correct)))))
