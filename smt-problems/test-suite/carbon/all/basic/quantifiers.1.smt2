...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 25) (let ((anon26_Then_correct true))
(let ((anon8_correct true))
(let ((anon25_Then_correct  (=> (< j1_3 3) (and (=> (= (ControlFlow 0 21) 20) anon26_Then_correct) (=> (= (ControlFlow 0 21) 17) anon8_correct)))))
(let ((anon25_Else_correct  (=> (and (<= 3 j1_3) (= (ControlFlow 0 19) 17)) anon8_correct)))
(let ((anon24_Then_correct  (=> (<= 0 j1_3) (and (=> (= (ControlFlow 0 22) 21) anon25_Then_correct) (=> (= (ControlFlow 0 22) 19) anon25_Else_correct)))))
(let ((anon24_Else_correct  (=> (and (< j1_3 0) (= (ControlFlow 0 18) 17)) anon8_correct)))
(let ((anon32_Then_correct true))
(let ((anon18_correct true))
(let ((anon31_Then_correct  (=> (< j2_4 3) (and (=> (= (ControlFlow 0 11) 10) anon32_Then_correct) (=> (= (ControlFlow 0 11) 7) anon18_correct)))))
(let ((anon31_Else_correct  (=> (and (<= 3 j2_4) (= (ControlFlow 0 9) 7)) anon18_correct)))
(let ((anon30_Then_correct  (=> (<= 0 j2_4) (and (=> (= (ControlFlow 0 12) 11) anon31_Then_correct) (=> (= (ControlFlow 0 12) 9) anon31_Else_correct)))))
(let ((anon30_Else_correct  (=> (and (< j2_4 0) (= (ControlFlow 0 8) 7)) anon18_correct)))
(let ((anon20_correct true))
(let ((anon29_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (exists ((j2_1 Int) ) (!  (and (<= 0 j2_1) (and (< j2_1 3) (f2 Heap@@33 j2_1)))
 :qid |stdinbpl.2635:17|
 :skolemid |180|
 :pattern ( (|f2#frame| EmptyFrame j2_1))
))) (=> (exists ((j2_1@@0 Int) ) (!  (and (<= 0 j2_1@@0) (and (< j2_1@@0 3) (f2 Heap@@33 j2_1@@0)))
 :qid |stdinbpl.2635:17|
 :skolemid |180|
 :pattern ( (|f2#frame| EmptyFrame j2_1@@0))
)) (=> (= (ControlFlow 0 5) 3) anon20_correct)))))
(let ((anon28_Then_correct  (=> (f2 Heap@@33 0) (and (and (=> (= (ControlFlow 0 13) 5) anon29_Else_correct) (=> (= (ControlFlow 0 13) 12) anon30_Then_correct)) (=> (= (ControlFlow 0 13) 8) anon30_Else_correct)))))
(let ((anon28_Else_correct  (=> (and (not (f2 Heap@@33 0)) (= (ControlFlow 0 4) 3)) anon20_correct)))
(let ((anon27_Then_correct true))
(let ((anon10_correct  (=> (and (state Heap@@33 ZeroMask) (state Heap@@33 ZeroMask)) (and (and (=> (= (ControlFlow 0 14) 2) anon27_Then_correct) (=> (= (ControlFlow 0 14) 13) anon28_Then_correct)) (=> (= (ControlFlow 0 14) 4) anon28_Else_correct)))))
(let ((anon23_Else_correct  (=> (and (exists ((j1_1 Int) ) (!  (and (<= 0 j1_1) (and (< j1_1 3) (f2 Heap@@33 j1_1)))
 :qid |stdinbpl.2602:22|
 :skolemid |179|
 :pattern ( (|f2#frame| EmptyFrame j1_1))
)) (= (ControlFlow 0 16) 14)) anon10_correct)))
(let ((anon22_Then_correct  (=> (and (f2 Heap@@33 0) (state Heap@@33 ZeroMask)) (and (and (=> (= (ControlFlow 0 23) 16) anon23_Else_correct) (=> (= (ControlFlow 0 23) 22) anon24_Then_correct)) (=> (= (ControlFlow 0 23) 18) anon24_Else_correct)))))
(let ((anon22_Else_correct  (=> (and (not (f2 Heap@@33 0)) (= (ControlFlow 0 15) 14)) anon10_correct)))
(let ((anon21_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (> (|Seq#Length| A@@12) 10)) (and (state Heap@@33 ZeroMask) (state Heap@@33 ZeroMask))) (and (and (=> (= (ControlFlow 0 24) 1) anon21_Then_correct) (=> (= (ControlFlow 0 24) 23) anon22_Then_correct)) (=> (= (ControlFlow 0 24) 15) anon22_Else_correct))))))
