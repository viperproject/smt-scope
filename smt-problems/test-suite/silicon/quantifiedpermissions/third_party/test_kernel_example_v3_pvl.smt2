(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:23:50
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quantifiedpermissions/third_party/test_kernel_example_v3_pvl.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(declare-const tcount@52@01 Int)
(declare-const gsize@53@01 Int)
(declare-const gid@54@01 Int)
(set-option :timeout 0)
(push) ; 5
