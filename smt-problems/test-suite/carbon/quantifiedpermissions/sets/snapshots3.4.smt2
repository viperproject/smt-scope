...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@14) (MapType1Type RefType)) (= (type this@@6) RefType)) (= (type QPMask@4) (MapType2Type RefType realType))) (forall ((arg0@@49 T@U) ) (! (= (type (invRecv10 arg0@@49)) RefType)
 :qid |funType:invRecv10|
 :pattern ( (invRecv10 arg0@@49))
))) (= (type Mask@10) (MapType2Type RefType realType))) (= (type t_1) RefType)) (= (type ExhaleHeap@0) (MapType1Type RefType))) (= (type Heap@13) (MapType1Type RefType))) (= (type newVersion@2) FrameTypeType)) (= (type Mask@9) (MapType2Type RefType realType))) (= (type Mask@8) (MapType2Type RefType realType))) (= (type Mask@7) (MapType2Type RefType realType))) (= (type Heap@12) (MapType1Type RefType))) (forall ((arg0@@50 T@U) ) (! (= (type (FrameFragment arg0@@50)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@50))
))) (= (type newPMask@1) (MapType2Type RefType boolType))) (= (type Heap@11) (MapType1Type RefType))) (= (type Heap@8) (MapType1Type RefType))) (= (type Heap@9) (MapType1Type RefType))) (= (type Heap@10) (MapType1Type RefType))) (= (type freshVersion@1) FrameTypeType)) (= (type Mask@6) (MapType2Type RefType realType))) (= (type Mask@5) (MapType2Type RefType realType))) (= (type QPMask@2) (MapType2Type RefType realType))) (forall ((arg0@@51 T@U) ) (! (= (type (invRecv8 arg0@@51)) RefType)
 :qid |funType:invRecv8|
 :pattern ( (invRecv8 arg0@@51))
))) (= (type QPMask@3) (MapType2Type RefType realType))) (forall ((arg0@@52 T@U) ) (! (= (type (invRecv9 arg0@@52)) RefType)
 :qid |funType:invRecv9|
 :pattern ( (invRecv9 arg0@@52))
))) (= (type Heap@7) (MapType1Type RefType))) (= (type Heap@6) (MapType1Type RefType))) (= (type newVersion@1) FrameTypeType)) (= (type Mask@4) (MapType2Type RefType realType))) (= (type Heap@5) (MapType1Type RefType))) (= (type Heap@4) (MapType1Type RefType))) (= (type newPMask@0) (MapType2Type RefType boolType))) (forall ((arg0@@53 T@U) (arg1@@25 T@U) ) (! (= (type (CombineFrames arg0@@53 arg1@@25)) FrameTypeType)
 :qid |funType:CombineFrames|
 :pattern ( (CombineFrames arg0@@53 arg1@@25))
))) (= (type Heap@2) (MapType1Type RefType))) (= (type Heap@1) (MapType1Type RefType))) (= (type Heap@3) (MapType1Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@3) (MapType2Type RefType realType))) (= (type QPMask@0) (MapType2Type RefType realType))) (= (type QPMask@1) (MapType2Type RefType realType))) (forall ((arg0@@54 T@U) ) (! (= (type (invRecv7 arg0@@54)) RefType)
 :qid |funType:invRecv7|
 :pattern ( (invRecv7 arg0@@54))
))) (= (type Mask@2) (MapType2Type RefType realType))) (= (type Mask@1) (MapType2Type RefType realType))) (forall ((arg0@@55 T@U) ) (! (= (type (invRecv6 arg0@@55)) RefType)
 :qid |funType:invRecv6|
 :pattern ( (invRecv6 arg0@@55))
))) (= (type Heap@0) (MapType1Type RefType))) (= (type Heap@@11) (MapType1Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@0) (MapType2Type RefType realType))))
(set-info :boogie-vc-id m1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 54) (let ((anon20_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((x_6 T@U) (x_6_1 T@U) ) (!  (=> (and (= (type x_6) RefType) (= (type x_6_1) RefType)) (=> (and (and (and (and (not (= x_6 x_6_1)) (U_2_bool (MapType0Select (MapType1Select Heap@14 this@@6 n) x_6))) (U_2_bool (MapType0Select (MapType1Select Heap@14 this@@6 n) x_6_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_6 x_6_1))))
 :qid |stdinbpl.1249:15|
 :skolemid |156|
 :no-pattern (type x_6)
 :no-pattern (type x_6_1)
 :no-pattern (U_2_int x_6)
 :no-pattern (U_2_bool x_6)
 :no-pattern (U_2_int x_6_1)
 :no-pattern (U_2_bool x_6_1)
))) (=> (forall ((x_6@@0 T@U) (x_6_1@@0 T@U) ) (!  (=> (and (= (type x_6@@0) RefType) (= (type x_6_1@@0) RefType)) (=> (and (and (and (and (not (= x_6@@0 x_6_1@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@14 this@@6 n) x_6@@0))) (U_2_bool (MapType0Select (MapType1Select Heap@14 this@@6 n) x_6_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_6@@0 x_6_1@@0))))
 :qid |stdinbpl.1249:15|
 :skolemid |156|
 :no-pattern (type x_6@@0)
 :no-pattern (type x_6_1@@0)
 :no-pattern (U_2_int x_6@@0)
 :no-pattern (U_2_bool x_6@@0)
 :no-pattern (U_2_int x_6_1@@0)
 :no-pattern (U_2_bool x_6_1@@0)
)) (=> (and (and (and (forall ((x_6@@1 T@U) ) (!  (=> (= (type x_6@@1) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@14 this@@6 n) x_6@@1)) (< NoPerm FullPerm)) (and (qpRange10 x_6@@1) (= (invRecv10 x_6@@1) x_6@@1))))
 :qid |stdinbpl.1255:22|
 :skolemid |157|
 :pattern ( (MapType1Select Heap@14 x_6@@1 f_7))
 :pattern ( (MapType2Select QPMask@4 x_6@@1 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@14 this@@6 n) x_6@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@14 this@@6 n) (invRecv10 o_3))) (< NoPerm FullPerm)) (qpRange10 o_3)) (= (invRecv10 o_3) o_3)))
 :qid |stdinbpl.1259:22|
 :skolemid |158|
 :pattern ( (invRecv10 o_3))
))) (and (forall ((x_6@@2 T@U) ) (!  (=> (and (= (type x_6@@2) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@14 this@@6 n) x_6@@2))) (not (= x_6@@2 null)))
 :qid |stdinbpl.1265:22|
 :skolemid |159|
 :pattern ( (MapType1Select Heap@14 x_6@@2 f_7))
 :pattern ( (MapType2Select QPMask@4 x_6@@2 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@14 this@@6 n) x_6@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@14 this@@6 n) (invRecv10 o_3@@0))) (< NoPerm FullPerm)) (qpRange10 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv10 o_3@@0) o_3@@0)) (= (U_2_real (MapType2Select QPMask@4 o_3@@0 f_7)) (+ (U_2_real (MapType2Select Mask@10 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select (MapType1Select Heap@14 this@@6 n) (invRecv10 o_3@@0))) (< NoPerm FullPerm)) (qpRange10 o_3@@0))) (= (U_2_real (MapType2Select QPMask@4 o_3@@0 f_7)) (U_2_real (MapType2Select Mask@10 o_3@@0 f_7))))))
 :qid |stdinbpl.1271:22|
 :skolemid |160|
 :pattern ( (MapType2Select QPMask@4 o_3@@0 f_7))
)))) (and (and (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 f_7))) (= (U_2_real (MapType2Select Mask@10 o_3@@1 f_5)) (U_2_real (MapType2Select QPMask@4 o_3@@1 f_5))))))
 :qid |stdinbpl.1275:29|
 :skolemid |161|
 :pattern ( (MapType2Select Mask@10 o_3@@1 f_5))
 :pattern ( (MapType2Select QPMask@4 o_3@@1 f_5))
)) (state Heap@14 QPMask@4)) (and (state Heap@14 QPMask@4) (state Heap@14 QPMask@4)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm QPMask@4 t_1 f_7)) (=> (HasDirectPerm QPMask@4 t_1 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (= a_2@0 (U_2_int (MapType1Select Heap@14 t_1 f_7)))))))))))
(let ((anon30_Else_correct  (=> (HasDirectPerm Mask@10 null (P (MapType1Select ExhaleHeap@0 this@@6 n))) (=> (and (= Heap@14 ExhaleHeap@0) (= (ControlFlow 0 6) 2)) anon20_correct))))
(let ((anon30_Then_correct  (=> (and (and (not (HasDirectPerm Mask@10 null (P (MapType1Select ExhaleHeap@0 this@@6 n)))) (= Heap@13 (MapType1Store ExhaleHeap@0 null (P (MapType1Select ExhaleHeap@0 this@@6 n)) newVersion@2))) (and (= Heap@14 Heap@13) (= (ControlFlow 0 5) 2))) anon20_correct)))
(let ((anon18_correct  (=> (= Mask@10 (MapType2Store Mask@9 null (P (MapType1Select ExhaleHeap@0 this@@6 n)) (real_2_U (- (U_2_real (MapType2Select Mask@9 null (P (MapType1Select ExhaleHeap@0 this@@6 n)))) FullPerm)))) (and (=> (= (ControlFlow 0 7) 5) anon30_Then_correct) (=> (= (ControlFlow 0 7) 6) anon30_Else_correct)))))
(let ((anon29_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 7)) anon18_correct)))
(let ((anon29_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType2Select Mask@9 null (P (MapType1Select ExhaleHeap@0 this@@6 n)))))) (=> (<= FullPerm (U_2_real (MapType2Select Mask@9 null (P (MapType1Select ExhaleHeap@0 this@@6 n))))) (=> (= (ControlFlow 0 8) 7) anon18_correct))))))
(let ((anon16_correct  (=> (= Mask@8 (MapType2Store Mask@7 null (P (MapType1Select Heap@12 this@@6 n)) (real_2_U (- (U_2_real (MapType2Select Mask@7 null (P (MapType1Select Heap@12 this@@6 n)))) FullPerm)))) (=> (and (IdenticalOnKnownLocations Heap@12 ExhaleHeap@0 Mask@8) (state ExhaleHeap@0 Mask@8)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (HasDirectPerm Mask@8 this@@6 n)) (=> (HasDirectPerm Mask@8 this@@6 n) (=> (and (and (= Mask@9 (MapType2Store Mask@8 null (P (MapType1Select ExhaleHeap@0 this@@6 n)) (real_2_U (+ (U_2_real (MapType2Select Mask@8 null (P (MapType1Select ExhaleHeap@0 this@@6 n)))) FullPerm)))) (state ExhaleHeap@0 Mask@9)) (and (state ExhaleHeap@0 Mask@9) (state ExhaleHeap@0 Mask@9))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm Mask@9 this@@6 n)) (=> (HasDirectPerm Mask@9 this@@6 n) (=> (and (|P#trigger| ExhaleHeap@0 (P (MapType1Select ExhaleHeap@0 this@@6 n))) (= (MapType1Select ExhaleHeap@0 null (P (MapType1Select ExhaleHeap@0 this@@6 n))) (FrameFragment (int_2_U (|P#condqp1| ExhaleHeap@0 (MapType1Select ExhaleHeap@0 this@@6 n)))))) (and (=> (= (ControlFlow 0 11) 8) anon29_Then_correct) (=> (= (ControlFlow 0 11) 10) anon29_Else_correct))))))))))))
(let ((anon28_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 11)) anon16_correct)))
(let ((anon28_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (U_2_real (MapType2Select Mask@7 null (P (MapType1Select Heap@12 this@@6 n)))))) (=> (<= FullPerm (U_2_real (MapType2Select Mask@7 null (P (MapType1Select Heap@12 this@@6 n))))) (=> (= (ControlFlow 0 14) 11) anon16_correct))))))
(let ((anon14_correct  (=> (forall ((o_6 T@U) (f_10 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_10))))
(let ((A@@13 (FieldTypeInv0 (type f_10))))
 (=> (and (and (= (type o_6) RefType) (= (type f_10) (FieldType A@@13 B@@12))) (U_2_bool (MapType2Select (MapType1Select Heap@11 null (|P#sm| (MapType1Select Heap@11 this@@6 n))) o_6 f_10))) (U_2_bool (MapType2Select newPMask@1 o_6 f_10)))))
 :qid |stdinbpl.1184:27|
 :skolemid |154|
 :pattern ( (MapType2Select newPMask@1 o_6 f_10))
)) (=> (and (and (forall ((x_5_1 T@U) ) (!  (=> (and (= (type x_5_1) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@11 this@@6 n) x_5_1))) (U_2_bool (MapType2Select newPMask@1 x_5_1 f_7)))
 :qid |stdinbpl.1188:20|
 :skolemid |155|
 :no-pattern (type x_5_1)
 :no-pattern (U_2_int x_5_1)
 :no-pattern (U_2_bool x_5_1)
)) (= Heap@12 (MapType1Store Heap@11 null (|P#sm| (MapType1Select Heap@11 this@@6 n)) newPMask@1))) (and (state Heap@12 Mask@7) (state Heap@12 Mask@7))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm Mask@7 this@@6 n)) (=> (HasDirectPerm Mask@7 this@@6 n) (and (=> (= (ControlFlow 0 17) 14) anon28_Then_correct) (=> (= (ControlFlow 0 17) 16) anon28_Else_correct))))))))
(let ((anon27_Else_correct  (=> (HasDirectPerm Mask@7 null (P (MapType1Select Heap@8 this@@6 n))) (=> (and (= Heap@11 Heap@8) (= (ControlFlow 0 20) 17)) anon14_correct))))
(let ((anon27_Then_correct  (=> (not (HasDirectPerm Mask@7 null (P (MapType1Select Heap@8 this@@6 n)))) (=> (and (and (= Heap@9 (MapType1Store Heap@8 null (|P#sm| (MapType1Select Heap@8 this@@6 n)) ZeroPMask)) (= Heap@10 (MapType1Store Heap@9 null (P (MapType1Select Heap@9 this@@6 n)) freshVersion@1))) (and (= Heap@11 Heap@10) (= (ControlFlow 0 19) 17))) anon14_correct))))
(let ((anon12_correct  (=> (not (= this@@6 null)) (=> (and (= Mask@6 (MapType2Store Mask@5 this@@6 n (real_2_U (+ (U_2_real (MapType2Select Mask@5 this@@6 n)) FullPerm)))) (state Heap@8 Mask@6)) (and (=> (= (ControlFlow 0 21) (- 0 27)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (U_2_bool (MapType0Select (MapType1Select Heap@8 this@@6 n) x_3))) (U_2_bool (MapType0Select (MapType1Select Heap@8 this@@6 n) x_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1))))
...
))) (=> (forall ((x_3@@0 T@U) (x_3_1@@0 T@U) ) (!  (=> (and (= (type x_3@@0) RefType) (= (type x_3_1@@0) RefType)) (=> (and (and (and (and (not (= x_3@@0 x_3_1@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@8 this@@6 n) x_3@@0))) (U_2_bool (MapType0Select (MapType1Select Heap@8 this@@6 n) x_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3@@0 x_3_1@@0))))
 :qid |stdinbpl.1077:15|
 :skolemid |142|
...
)) (=> (and (and (and (forall ((x_3@@1 T@U) ) (!  (=> (= (type x_3@@1) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@8 this@@6 n) x_3@@1)) (< NoPerm FullPerm)) (and (qpRange8 x_3@@1) (= (invRecv8 x_3@@1) x_3@@1))))
 :qid |stdinbpl.1083:22|
 :skolemid |143|
 :pattern ( (MapType1Select Heap@8 x_3@@1 f_7))
 :pattern ( (MapType2Select QPMask@2 x_3@@1 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@8 this@@6 n) x_3@@1))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@8 this@@6 n) (invRecv8 o_3@@2))) (< NoPerm FullPerm)) (qpRange8 o_3@@2)) (= (invRecv8 o_3@@2) o_3@@2)))
 :qid |stdinbpl.1087:22|
 :skolemid |144|
 :pattern ( (invRecv8 o_3@@2))
))) (and (forall ((x_3@@2 T@U) ) (!  (=> (and (= (type x_3@@2) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@8 this@@6 n) x_3@@2))) (not (= x_3@@2 null)))
 :qid |stdinbpl.1093:22|
 :skolemid |145|
 :pattern ( (MapType1Select Heap@8 x_3@@2 f_7))
 :pattern ( (MapType2Select QPMask@2 x_3@@2 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@8 this@@6 n) x_3@@2))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@8 this@@6 n) (invRecv8 o_3@@3))) (< NoPerm FullPerm)) (qpRange8 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv8 o_3@@3) o_3@@3)) (= (U_2_real (MapType2Select QPMask@2 o_3@@3 f_7)) (+ (U_2_real (MapType2Select Mask@6 o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select (MapType1Select Heap@8 this@@6 n) (invRecv8 o_3@@3))) (< NoPerm FullPerm)) (qpRange8 o_3@@3))) (= (U_2_real (MapType2Select QPMask@2 o_3@@3 f_7)) (U_2_real (MapType2Select Mask@6 o_3@@3 f_7))))))
 :qid |stdinbpl.1099:22|
 :skolemid |146|
 :pattern ( (MapType2Select QPMask@2 o_3@@3 f_7))
)))) (and (and (forall ((o_3@@4 T@U) (f_5@@0 T@U) ) (! (let ((B@@13 (FieldTypeInv1 (type f_5@@0))))
(let ((A@@14 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@14 B@@13))) (not (= f_5@@0 f_7))) (= (U_2_real (MapType2Select Mask@6 o_3@@4 f_5@@0)) (U_2_real (MapType2Select QPMask@2 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.1103:29|
 :skolemid |147|
 :pattern ( (MapType2Select Mask@6 o_3@@4 f_5@@0))
 :pattern ( (MapType2Select QPMask@2 o_3@@4 f_5@@0))
)) (state Heap@8 QPMask@2)) (and (state Heap@8 QPMask@2) (state Heap@8 QPMask@2)))) (and (=> (= (ControlFlow 0 21) (- 0 26)) (HasDirectPerm QPMask@2 t_1 f_7)) (=> (HasDirectPerm QPMask@2 t_1 f_7) (and (=> (= (ControlFlow 0 21) (- 0 25)) (= a_2@0 (U_2_int (MapType1Select Heap@8 t_1 f_7)))) (=> (= a_2@0 (U_2_int (MapType1Select Heap@8 t_1 f_7))) (=> (state Heap@8 QPMask@2) (and (=> (= (ControlFlow 0 21) (- 0 24)) (HasDirectPerm QPMask@2 this@@6 n)) (=> (HasDirectPerm QPMask@2 this@@6 n) (and (=> (= (ControlFlow 0 21) (- 0 23)) (forall ((x_4 T@U) (x_4_1 T@U) ) (!  (=> (and (= (type x_4) RefType) (= (type x_4_1) RefType)) (=> (and (and (and (and (not (= x_4 x_4_1)) (U_2_bool (MapType0Select (MapType1Select Heap@8 this@@6 n) x_4))) (U_2_bool (MapType0Select (MapType1Select Heap@8 this@@6 n) x_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4 x_4_1))))
 :qid |stdinbpl.1137:17|
 :skolemid |148|
 :pattern ( (neverTriggered9 x_4) (neverTriggered9 x_4_1))
))) (=> (forall ((x_4@@0 T@U) (x_4_1@@0 T@U) ) (!  (=> (and (= (type x_4@@0) RefType) (= (type x_4_1@@0) RefType)) (=> (and (and (and (and (not (= x_4@@0 x_4_1@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@8 this@@6 n) x_4@@0))) (U_2_bool (MapType0Select (MapType1Select Heap@8 this@@6 n) x_4_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4@@0 x_4_1@@0))))
 :qid |stdinbpl.1137:17|
 :skolemid |148|
 :pattern ( (neverTriggered9 x_4@@0) (neverTriggered9 x_4_1@@0))
)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((x_4@@1 T@U) ) (!  (=> (and (= (type x_4@@1) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@8 this@@6 n) x_4@@1))) (>= (U_2_real (MapType2Select QPMask@2 x_4@@1 f_7)) FullPerm))
 :qid |stdinbpl.1144:17|
 :skolemid |149|
 :pattern ( (MapType1Select Heap@8 x_4@@1 f_7))
 :pattern ( (MapType2Select QPMask@3 x_4@@1 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@8 this@@6 n) x_4@@1))
))) (=> (forall ((x_4@@2 T@U) ) (!  (=> (and (= (type x_4@@2) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@8 this@@6 n) x_4@@2))) (>= (U_2_real (MapType2Select QPMask@2 x_4@@2 f_7)) FullPerm))
 :qid |stdinbpl.1144:17|
 :skolemid |149|
 :pattern ( (MapType1Select Heap@8 x_4@@2 f_7))
 :pattern ( (MapType2Select QPMask@3 x_4@@2 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@8 this@@6 n) x_4@@2))
)) (=> (forall ((x_4@@3 T@U) ) (!  (=> (= (type x_4@@3) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@8 this@@6 n) x_4@@3)) (< NoPerm FullPerm)) (and (qpRange9 x_4@@3) (= (invRecv9 x_4@@3) x_4@@3))))
 :qid |stdinbpl.1150:22|
 :skolemid |150|
 :pattern ( (MapType1Select Heap@8 x_4@@3 f_7))
 :pattern ( (MapType2Select QPMask@3 x_4@@3 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@8 this@@6 n) x_4@@3))
)) (=> (and (and (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@8 this@@6 n) (invRecv9 o_3@@5))) (and (< NoPerm FullPerm) (qpRange9 o_3@@5))) (= (invRecv9 o_3@@5) o_3@@5)))
 :qid |stdinbpl.1154:22|
 :skolemid |151|
 :pattern ( (invRecv9 o_3@@5))
)) (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@8 this@@6 n) (invRecv9 o_3@@6))) (and (< NoPerm FullPerm) (qpRange9 o_3@@6))) (and (= (invRecv9 o_3@@6) o_3@@6) (= (U_2_real (MapType2Select QPMask@3 o_3@@6 f_7)) (- (U_2_real (MapType2Select QPMask@2 o_3@@6 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType0Select (MapType1Select Heap@8 this@@6 n) (invRecv9 o_3@@6))) (and (< NoPerm FullPerm) (qpRange9 o_3@@6)))) (= (U_2_real (MapType2Select QPMask@3 o_3@@6 f_7)) (U_2_real (MapType2Select QPMask@2 o_3@@6 f_7))))))
 :qid |stdinbpl.1160:22|
 :skolemid |152|
 :pattern ( (MapType2Select QPMask@3 o_3@@6 f_7))
))) (and (forall ((o_3@@7 T@U) (f_5@@1 T@U) ) (! (let ((B@@14 (FieldTypeInv1 (type f_5@@1))))
(let ((A@@15 (FieldTypeInv0 (type f_5@@1))))
 (=> (and (and (= (type o_3@@7) RefType) (= (type f_5@@1) (FieldType A@@15 B@@14))) (not (= f_5@@1 f_7))) (= (U_2_real (MapType2Select QPMask@2 o_3@@7 f_5@@1)) (U_2_real (MapType2Select QPMask@3 o_3@@7 f_5@@1))))))
 :qid |stdinbpl.1166:29|
 :skolemid |153|
 :pattern ( (MapType2Select QPMask@3 o_3@@7 f_5@@1))
)) (= Mask@7 (MapType2Store QPMask@3 null (P (MapType1Select Heap@8 this@@6 n)) (real_2_U (+ (U_2_real (MapType2Select QPMask@3 null (P (MapType1Select Heap@8 this@@6 n)))) FullPerm)))))) (and (and (state Heap@8 Mask@7) (state Heap@8 Mask@7)) (and (|P#trigger| Heap@8 (P (MapType1Select Heap@8 this@@6 n))) (= (MapType1Select Heap@8 null (P (MapType1Select Heap@8 this@@6 n))) (FrameFragment (int_2_U (|P#condqp1| Heap@8 (MapType1Select Heap@8 this@@6 n)))))))) (and (=> (= (ControlFlow 0 21) 19) anon27_Then_correct) (=> (= (ControlFlow 0 21) 20) anon27_Else_correct))))))))))))))))))))))
(let ((anon26_Else_correct  (=> (HasDirectPerm Mask@5 null (inv this@@6)) (=> (and (= Heap@8 Heap@6) (= (ControlFlow 0 29) 21)) anon12_correct))))
(let ((anon26_Then_correct  (=> (and (and (not (HasDirectPerm Mask@5 null (inv this@@6))) (= Heap@7 (MapType1Store Heap@6 null (inv this@@6) newVersion@1))) (and (= Heap@8 Heap@7) (= (ControlFlow 0 28) 21))) anon12_correct)))
(let ((anon10_correct  (=> (= Mask@5 (MapType2Store Mask@4 null (inv this@@6) (real_2_U (- (U_2_real (MapType2Select Mask@4 null (inv this@@6))) FullPerm)))) (and (=> (= (ControlFlow 0 30) 28) anon26_Then_correct) (=> (= (ControlFlow 0 30) 29) anon26_Else_correct)))))
(let ((anon25_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 33) 30)) anon10_correct)))
(let ((anon25_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 31) (- 0 32)) (<= FullPerm (U_2_real (MapType2Select Mask@4 null (inv this@@6))))) (=> (<= FullPerm (U_2_real (MapType2Select Mask@4 null (inv this@@6)))) (=> (= (ControlFlow 0 31) 30) anon10_correct))))))
(let ((anon8_correct  (=> (and (and (and (= Heap@5 (MapType1Store Heap@4 null (|inv#sm| this@@6) (MapType2Store (MapType1Select Heap@4 null (|inv#sm| this@@6)) this@@6 n (bool_2_U true)))) (forall ((o_5 T@U) (f_9 T@U) ) (! (let ((B@@15 (FieldTypeInv1 (type f_9))))
(let ((A@@16 (FieldTypeInv0 (type f_9))))
 (=> (and (and (= (type o_5) RefType) (= (type f_9) (FieldType A@@16 B@@15))) (U_2_bool (MapType2Select (MapType1Select Heap@5 null (|inv#sm| this@@6)) o_5 f_9))) (U_2_bool (MapType2Select newPMask@0 o_5 f_9)))))
 :qid |stdinbpl.1042:27|
 :skolemid |140|
 :pattern ( (MapType2Select newPMask@0 o_5 f_9))
))) (and (forall ((x_2 T@U) ) (!  (=> (and (= (type x_2) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@5 this@@6 n) x_2))) (U_2_bool (MapType2Select newPMask@0 x_2 f_7)))
 :qid |stdinbpl.1046:20|
 :skolemid |141|
 :no-pattern (type x_2)
 :no-pattern (U_2_int x_2)
 :no-pattern (U_2_bool x_2)
)) (= Heap@6 (MapType1Store Heap@5 null (|inv#sm| this@@6) newPMask@0)))) (and (and (state Heap@6 Mask@4) (state Heap@6 Mask@4)) (and (|inv#trigger| Heap@6 (inv this@@6)) (= (MapType1Select Heap@6 null (inv this@@6)) (CombineFrames (FrameFragment (MapType1Select Heap@6 this@@6 n)) (FrameFragment (int_2_U (|inv#condqp2| Heap@6 this@@6)))))))) (and (=> (= (ControlFlow 0 34) 31) anon25_Then_correct) (=> (= (ControlFlow 0 34) 33) anon25_Else_correct)))))
(let ((anon24_Else_correct  (=> (HasDirectPerm Mask@4 null (inv this@@6)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 36) 34)) anon8_correct))))
(let ((anon24_Then_correct  (=> (not (HasDirectPerm Mask@4 null (inv this@@6))) (=> (and (and (= Heap@2 (MapType1Store Heap@1 null (|inv#sm| this@@6) ZeroPMask)) (= Heap@3 (MapType1Store Heap@2 null (inv this@@6) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 35) 34))) anon8_correct))))
(let ((anon6_correct  (=> (= Mask@3 (MapType2Store QPMask@0 this@@6 n (real_2_U (- (U_2_real (MapType2Select QPMask@0 this@@6 n)) FullPerm)))) (and (=> (= (ControlFlow 0 37) (- 0 39)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) x_1))) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.994:17|
 :skolemid |134|
 :pattern ( (neverTriggered7 x_1) (neverTriggered7 x_1_1))
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) x_1@@0))) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) x_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.994:17|
 :skolemid |134|
 :pattern ( (neverTriggered7 x_1@@0) (neverTriggered7 x_1_1@@0))
)) (and (=> (= (ControlFlow 0 37) (- 0 38)) (forall ((x_1@@1 T@U) ) (!  (=> (and (= (type x_1@@1) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) x_1@@1))) (>= (U_2_real (MapType2Select Mask@3 x_1@@1 f_7)) FullPerm))
 :qid |stdinbpl.1001:17|
 :skolemid |135|
 :pattern ( (MapType1Select Heap@1 x_1@@1 f_7))
 :pattern ( (MapType2Select QPMask@1 x_1@@1 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@1 this@@6 n) x_1@@1))
))) (=> (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) x_1@@2))) (>= (U_2_real (MapType2Select Mask@3 x_1@@2 f_7)) FullPerm))
 :qid |stdinbpl.1001:17|
 :skolemid |135|
 :pattern ( (MapType1Select Heap@1 x_1@@2 f_7))
 :pattern ( (MapType2Select QPMask@1 x_1@@2 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@1 this@@6 n) x_1@@2))
)) (=> (forall ((x_1@@3 T@U) ) (!  (=> (= (type x_1@@3) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) x_1@@3)) (< NoPerm FullPerm)) (and (qpRange7 x_1@@3) (= (invRecv7 x_1@@3) x_1@@3))))
 :qid |stdinbpl.1007:22|
 :skolemid |136|
 :pattern ( (MapType1Select Heap@1 x_1@@3 f_7))
 :pattern ( (MapType2Select QPMask@1 x_1@@3 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@1 this@@6 n) x_1@@3))
)) (=> (and (and (and (forall ((o_3@@8 T@U) ) (!  (=> (= (type o_3@@8) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) (invRecv7 o_3@@8))) (and (< NoPerm FullPerm) (qpRange7 o_3@@8))) (= (invRecv7 o_3@@8) o_3@@8)))
 :qid |stdinbpl.1011:22|
 :skolemid |137|
 :pattern ( (invRecv7 o_3@@8))
)) (forall ((o_3@@9 T@U) ) (!  (=> (= (type o_3@@9) RefType) (and (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) (invRecv7 o_3@@9))) (and (< NoPerm FullPerm) (qpRange7 o_3@@9))) (and (= (invRecv7 o_3@@9) o_3@@9) (= (U_2_real (MapType2Select QPMask@1 o_3@@9 f_7)) (- (U_2_real (MapType2Select Mask@3 o_3@@9 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) (invRecv7 o_3@@9))) (and (< NoPerm FullPerm) (qpRange7 o_3@@9)))) (= (U_2_real (MapType2Select QPMask@1 o_3@@9 f_7)) (U_2_real (MapType2Select Mask@3 o_3@@9 f_7))))))
 :qid |stdinbpl.1017:22|
 :skolemid |138|
 :pattern ( (MapType2Select QPMask@1 o_3@@9 f_7))
))) (and (forall ((o_3@@10 T@U) (f_5@@2 T@U) ) (! (let ((B@@16 (FieldTypeInv1 (type f_5@@2))))
(let ((A@@17 (FieldTypeInv0 (type f_5@@2))))
 (=> (and (and (= (type o_3@@10) RefType) (= (type f_5@@2) (FieldType A@@17 B@@16))) (not (= f_5@@2 f_7))) (= (U_2_real (MapType2Select Mask@3 o_3@@10 f_5@@2)) (U_2_real (MapType2Select QPMask@1 o_3@@10 f_5@@2))))))
 :qid |stdinbpl.1023:29|
 :skolemid |139|
 :pattern ( (MapType2Select QPMask@1 o_3@@10 f_5@@2))
)) (= Mask@4 (MapType2Store QPMask@1 null (inv this@@6) (real_2_U (+ (U_2_real (MapType2Select QPMask@1 null (inv this@@6))) FullPerm)))))) (and (and (state Heap@1 Mask@4) (state Heap@1 Mask@4)) (and (|inv#trigger| Heap@1 (inv this@@6)) (= (MapType1Select Heap@1 null (inv this@@6)) (CombineFrames (FrameFragment (MapType1Select Heap@1 this@@6 n)) (FrameFragment (int_2_U (|inv#condqp2| Heap@1 this@@6)))))))) (and (=> (= (ControlFlow 0 37) 35) anon24_Then_correct) (=> (= (ControlFlow 0 37) 36) anon24_Else_correct)))))))))))
(let ((anon23_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 42) 37)) anon6_correct)))
(let ((anon23_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 40) (- 0 41)) (<= FullPerm (U_2_real (MapType2Select QPMask@0 this@@6 n)))) (=> (<= FullPerm (U_2_real (MapType2Select QPMask@0 this@@6 n))) (=> (= (ControlFlow 0 40) 37) anon6_correct))))))
(let ((anon4_correct  (=> (not (= this@@6 null)) (=> (and (= Mask@2 (MapType2Store Mask@1 this@@6 n (real_2_U (+ (U_2_real (MapType2Select Mask@1 this@@6 n)) FullPerm)))) (state Heap@1 Mask@2)) (and (=> (= (ControlFlow 0 43) (- 0 46)) (forall ((x@@19 T@U) (x_5 T@U) ) (!  (=> (and (= (type x@@19) RefType) (= (type x_5) RefType)) (=> (and (and (and (and (not (= x@@19 x_5)) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) x@@19))) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) x_5))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@19 x_5))))
 :qid |stdinbpl.926:15|
 :skolemid |128|
...
))) (=> (forall ((x@@20 T@U) (x_5@@0 T@U) ) (!  (=> (and (= (type x@@20) RefType) (= (type x_5@@0) RefType)) (=> (and (and (and (and (not (= x@@20 x_5@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) x@@20))) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) x_5@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@20 x_5@@0))))
 :qid |stdinbpl.926:15|
 :skolemid |128|
...
)) (=> (and (and (and (forall ((x@@21 T@U) ) (!  (=> (= (type x@@21) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) x@@21)) (< NoPerm FullPerm)) (and (qpRange6 x@@21) (= (invRecv6 x@@21) x@@21))))
 :qid |stdinbpl.932:22|
 :skolemid |129|
 :pattern ( (MapType1Select Heap@1 x@@21 f_7))
 :pattern ( (MapType2Select QPMask@0 x@@21 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@1 this@@6 n) x@@21))
)) (forall ((o_3@@11 T@U) ) (!  (=> (= (type o_3@@11) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) (invRecv6 o_3@@11))) (< NoPerm FullPerm)) (qpRange6 o_3@@11)) (= (invRecv6 o_3@@11) o_3@@11)))
 :qid |stdinbpl.936:22|
 :skolemid |130|
 :pattern ( (invRecv6 o_3@@11))
))) (and (forall ((x@@22 T@U) ) (!  (=> (and (= (type x@@22) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) x@@22))) (not (= x@@22 null)))
 :qid |stdinbpl.942:22|
 :skolemid |131|
 :pattern ( (MapType1Select Heap@1 x@@22 f_7))
 :pattern ( (MapType2Select QPMask@0 x@@22 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@1 this@@6 n) x@@22))
)) (forall ((o_3@@12 T@U) ) (!  (=> (= (type o_3@@12) RefType) (and (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) (invRecv6 o_3@@12))) (< NoPerm FullPerm)) (qpRange6 o_3@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv6 o_3@@12) o_3@@12)) (= (U_2_real (MapType2Select QPMask@0 o_3@@12 f_7)) (+ (U_2_real (MapType2Select Mask@2 o_3@@12 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) (invRecv6 o_3@@12))) (< NoPerm FullPerm)) (qpRange6 o_3@@12))) (= (U_2_real (MapType2Select QPMask@0 o_3@@12 f_7)) (U_2_real (MapType2Select Mask@2 o_3@@12 f_7))))))
 :qid |stdinbpl.948:22|
 :skolemid |132|
 :pattern ( (MapType2Select QPMask@0 o_3@@12 f_7))
)))) (and (and (forall ((o_3@@13 T@U) (f_5@@3 T@U) ) (! (let ((B@@17 (FieldTypeInv1 (type f_5@@3))))
(let ((A@@18 (FieldTypeInv0 (type f_5@@3))))
 (=> (and (and (= (type o_3@@13) RefType) (= (type f_5@@3) (FieldType A@@18 B@@17))) (not (= f_5@@3 f_7))) (= (U_2_real (MapType2Select Mask@2 o_3@@13 f_5@@3)) (U_2_real (MapType2Select QPMask@0 o_3@@13 f_5@@3))))))
 :qid |stdinbpl.952:29|
 :skolemid |133|
 :pattern ( (MapType2Select Mask@2 o_3@@13 f_5@@3))
 :pattern ( (MapType2Select QPMask@0 o_3@@13 f_5@@3))
)) (state Heap@1 QPMask@0)) (and (state Heap@1 QPMask@0) (state Heap@1 QPMask@0)))) (and (=> (= (ControlFlow 0 43) (- 0 45)) (HasDirectPerm QPMask@0 this@@6 n)) (=> (HasDirectPerm QPMask@0 this@@6 n) (=> (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) t_1)) (=> (and (state Heap@1 QPMask@0) (state Heap@1 QPMask@0)) (and (=> (= (ControlFlow 0 43) (- 0 44)) (HasDirectPerm QPMask@0 t_1 f_7)) (=> (HasDirectPerm QPMask@0 t_1 f_7) (=> (and (= a_2@0 (U_2_int (MapType1Select Heap@1 t_1 f_7))) (state Heap@1 QPMask@0)) (and (=> (= (ControlFlow 0 43) 40) anon23_Then_correct) (=> (= (ControlFlow 0 43) 42) anon23_Else_correct))))))))))))))))
(let ((anon22_Else_correct  (=> (HasDirectPerm Mask@1 null (inv this@@6)) (=> (and (= Heap@1 Heap@@11) (= (ControlFlow 0 48) 43)) anon4_correct))))
(let ((anon22_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (inv this@@6))) (= Heap@0 (MapType1Store Heap@@11 null (inv this@@6) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 47) 43))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (MapType2Store Mask@0 null (inv this@@6) (real_2_U (- (U_2_real (MapType2Select Mask@0 null (inv this@@6))) FullPerm)))) (and (=> (= (ControlFlow 0 49) 47) anon22_Then_correct) (=> (= (ControlFlow 0 49) 48) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 52) 49)) anon2_correct)))
(let ((anon21_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 50) (- 0 51)) (<= FullPerm (U_2_real (MapType2Select Mask@0 null (inv this@@6))))) (=> (<= FullPerm (U_2_real (MapType2Select Mask@0 null (inv this@@6)))) (=> (= (ControlFlow 0 50) 49) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@11 ZeroMask) (U_2_bool (MapType1Select Heap@@11 this@@6 $allocated))) (and (= Mask@0 (MapType2Store ZeroMask null (inv this@@6) (real_2_U (+ (U_2_real (MapType2Select ZeroMask null (inv this@@6))) FullPerm)))) (state Heap@@11 Mask@0))) (and (and (state Heap@@11 Mask@0) (U_2_bool (MapType1Select Heap@@11 t_1 $allocated))) (and (|inv#trigger| Heap@@11 (inv this@@6)) (= (MapType1Select Heap@@11 null (inv this@@6)) (CombineFrames (FrameFragment (MapType1Select Heap@@11 this@@6 n)) (FrameFragment (int_2_U (|inv#condqp2| Heap@@11 this@@6)))))))) (and (=> (= (ControlFlow 0 53) 50) anon21_Then_correct) (=> (= (ControlFlow 0 53) 52) anon21_Else_correct)))))
