...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 38) (let ((anon12_correct  (=> (<= NoPerm FullPerm) (=> (and (= Mask@11 (MapType1Store Mask@10 null (Worker__postJoin_at_Thread __flatten_6@0 FullPerm) (real_2_U (+ (U_2_real (MapType1Select Mask@10 null (Worker__postJoin_at_Thread __flatten_6@0 FullPerm))) FullPerm)))) (InsidePredicate (Worker__postJoin_at_Worker __flatten_6@0 FullPerm) (MapType0Select Heap@1 null (Worker__postJoin_at_Worker __flatten_6@0 FullPerm)) (Worker__postJoin_at_Thread __flatten_6@0 FullPerm) (MapType0Select Heap@1 null (Worker__postJoin_at_Thread __flatten_6@0 FullPerm)))) (=> (and (and (state Heap@1 Mask@11) (> wildcard@1 NoPerm)) (and (not (= __flatten_6@0 null)) (= Mask@12 (MapType1Store Mask@11 __flatten_6@0 Worker__input (real_2_U (+ (U_2_real (MapType1Select Mask@11 __flatten_6@0 Worker__input)) wildcard@1)))))) (=> (and (and (and (state Heap@1 Mask@12) (not (= FullPerm NoPerm))) (and (not (= __flatten_6@0 null)) (= Mask@13 (MapType1Store Mask@12 __flatten_6@0 Worker__output (real_2_U (+ (U_2_real (MapType1Select Mask@12 __flatten_6@0 Worker__output)) FullPerm)))))) (and (and (state Heap@1 Mask@13) (= (U_2_int (MapType0Select Heap@1 __flatten_6@0 Worker__output)) (+ (U_2_int (MapType0Select Heap@1 __flatten_6@0 Worker__input)) 1))) (and (state Heap@1 Mask@13) (state Heap@1 Mask@13)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@13 __flatten_6@0 Worker__output)) (=> (HasDirectPerm Mask@13 __flatten_6@0 Worker__output) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (MapType0Select Heap@1 __flatten_6@0 Worker__output)) 7))))))))))
(let ((anon18_Else_correct  (=> (HasDirectPerm Mask@10 null (Worker__postJoin_at_Worker __flatten_6@0 FullPerm)) (=> (and (= Heap@1 ExhaleHeap@2) (= (ControlFlow 0 5) 2)) anon12_correct))))
(let ((anon18_Then_correct  (=> (and (and (not (HasDirectPerm Mask@10 null (Worker__postJoin_at_Worker __flatten_6@0 FullPerm))) (= Heap@0 (MapType0Store ExhaleHeap@2 null (Worker__postJoin_at_Worker __flatten_6@0 FullPerm) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 4) 2))) anon12_correct)))
(let ((anon10_correct  (=> (= Mask@10 (MapType1Store Mask@9 null (Worker__postJoin_at_Worker __flatten_6@0 FullPerm) (real_2_U (- (U_2_real (MapType1Select Mask@9 null (Worker__postJoin_at_Worker __flatten_6@0 FullPerm))) FullPerm)))) (and (=> (= (ControlFlow 0 6) 4) anon18_Then_correct) (=> (= (ControlFlow 0 6) 5) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon10_correct)))
(let ((anon17_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select Mask@9 null (Worker__postJoin_at_Worker __flatten_6@0 FullPerm))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@9 null (Worker__postJoin_at_Worker __flatten_6@0 FullPerm)))) (=> (= (ControlFlow 0 7) 6) anon10_correct))))))
(let ((anon8_correct  (=> (= Mask@8 (MapType1Store Mask@7 null (Worker__is_a_Worker __flatten_6@0) (real_2_U (- (U_2_real (MapType1Select Mask@7 null (Worker__is_a_Worker __flatten_6@0))) FullPerm)))) (=> (and (and (and (IdenticalOnKnownLocations ExhaleHeap@1 ExhaleHeap@2 Mask@8) (= Mask@9 (MapType1Store Mask@8 null (Worker__postJoin_at_Worker __flatten_6@0 FullPerm) (real_2_U (+ (U_2_real (MapType1Select Mask@8 null (Worker__postJoin_at_Worker __flatten_6@0 FullPerm))) FullPerm))))) (and (state ExhaleHeap@2 Mask@9) (state ExhaleHeap@2 Mask@9))) (and (and (U_2_bool (MapType0Select ExhaleHeap@2 sys__thrown@3 $allocated)) (state ExhaleHeap@2 Mask@9)) (and (|Worker__postJoin_at_Worker#trigger| ExhaleHeap@2 (Worker__postJoin_at_Worker __flatten_6@0 FullPerm)) (= (MapType0Select ExhaleHeap@2 null (Worker__postJoin_at_Worker __flatten_6@0 FullPerm)) (CombineFrames (MapType0Select ExhaleHeap@2 null (Worker__postJoin_at_Thread __flatten_6@0 FullPerm)) (CombineFrames (FrameFragment (MapType0Select ExhaleHeap@2 __flatten_6@0 Worker__input)) (ConditionalFrame FullPerm (FrameFragment (MapType0Select ExhaleHeap@2 __flatten_6@0 Worker__output))))))))) (and (=> (= (ControlFlow 0 10) 7) anon17_Then_correct) (=> (= (ControlFlow 0 10) 9) anon17_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 10)) anon8_correct)))
(let ((anon16_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType1Select Mask@7 null (Worker__is_a_Worker __flatten_6@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@7 null (Worker__is_a_Worker __flatten_6@0)))) (=> (= (ControlFlow 0 11) 10) anon8_correct))))))
(let ((anon6_correct  (=> (= Mask@7 (MapType1Store Mask@6 null (Worker__postJoin __flatten_6@0 FullPerm) (real_2_U (- (U_2_real (MapType1Select Mask@6 null (Worker__postJoin __flatten_6@0 FullPerm))) FullPerm)))) (and (=> (= (ControlFlow 0 14) 11) anon16_Then_correct) (=> (= (ControlFlow 0 14) 13) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 17) 14)) anon6_correct)))
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= FullPerm (U_2_real (MapType1Select Mask@6 null (Worker__postJoin __flatten_6@0 FullPerm))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@6 null (Worker__postJoin __flatten_6@0 FullPerm)))) (=> (= (ControlFlow 0 15) 14) anon6_correct))))))
(let ((anon4_correct  (=> (= Mask@5 (MapType1Store Mask@4 null (Worker__joinToken __flatten_6@0 FullPerm) (real_2_U (- (U_2_real (MapType1Select Mask@4 null (Worker__joinToken __flatten_6@0 FullPerm))) FullPerm)))) (=> (and (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@1 Mask@5) (= Mask@6 (MapType1Store Mask@5 null (Worker__postJoin __flatten_6@0 FullPerm) (real_2_U (+ (U_2_real (MapType1Select Mask@5 null (Worker__postJoin __flatten_6@0 FullPerm))) FullPerm))))) (=> (and (and (state ExhaleHeap@1 Mask@6) (state ExhaleHeap@1 Mask@6)) (and (U_2_bool (MapType0Select ExhaleHeap@1 sys__thrown@2 $allocated)) (state ExhaleHeap@1 Mask@6))) (and (=> (= (ControlFlow 0 18) (- 0 22)) (HasDirectPerm Mask@6 __flatten_6@0 Worker__input)) (=> (HasDirectPerm Mask@6 __flatten_6@0 Worker__input) (and (=> (= (ControlFlow 0 18) (- 0 21)) (= (U_2_int (MapType0Select ExhaleHeap@1 __flatten_6@0 Worker__input)) 7)) (=> (= (U_2_int (MapType0Select ExhaleHeap@1 __flatten_6@0 Worker__input)) 7) (=> (state ExhaleHeap@1 Mask@6) (and (=> (= (ControlFlow 0 18) (- 0 20)) (not (= __flatten_6@0 null))) (=> (not (= __flatten_6@0 null)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (and (=> (= (ControlFlow 0 18) 15) anon15_Then_correct) (=> (= (ControlFlow 0 18) 17) anon15_Else_correct))))))))))))))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 25) 18)) anon4_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (<= FullPerm (U_2_real (MapType1Select Mask@4 null (Worker__joinToken __flatten_6@0 FullPerm))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 null (Worker__joinToken __flatten_6@0 FullPerm)))) (=> (= (ControlFlow 0 23) 18) anon4_correct))))))
(let ((anon2_correct  (=> (= Mask@3 (MapType1Store Mask@2 null (Worker__preFork __flatten_6@0 FullPerm) (real_2_U (- (U_2_real (MapType1Select Mask@2 null (Worker__preFork __flatten_6@0 FullPerm))) FullPerm)))) (=> (and (IdenticalOnKnownLocations Heap@@30 ExhaleHeap@0 Mask@3) (= Mask@4 (MapType1Store Mask@3 null (Worker__joinToken __flatten_6@0 FullPerm) (real_2_U (+ (U_2_real (MapType1Select Mask@3 null (Worker__joinToken __flatten_6@0 FullPerm))) FullPerm))))) (=> (and (and (state ExhaleHeap@0 Mask@4) (state ExhaleHeap@0 Mask@4)) (and (U_2_bool (MapType0Select ExhaleHeap@0 sys__thrown@1 $allocated)) (state ExhaleHeap@0 Mask@4))) (and (=> (= (ControlFlow 0 26) (- 0 28)) (not (= __flatten_6@0 null))) (=> (not (= __flatten_6@0 null)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (and (=> (= (ControlFlow 0 26) 23) anon14_Then_correct) (=> (= (ControlFlow 0 26) 25) anon14_Else_correct)))))))))))
(let ((anon13_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 31) 26)) anon2_correct)))
(let ((anon13_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null (Worker__preFork __flatten_6@0 FullPerm))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 null (Worker__preFork __flatten_6@0 FullPerm)))) (=> (= (ControlFlow 0 29) 26) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@30 ZeroMask) (=> (and (and (>= current_thread_id 0) (state Heap@@30 ZeroMask)) (and (U_2_bool (MapType0Select Heap@@30 w_1 $allocated)) (U_2_bool (MapType0Select Heap@@30 __flatten_6 $allocated)))) (and (=> (= (ControlFlow 0 32) (- 0 37)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (=> (and (and (and (and (not (= __flatten_6@0 null)) (= (type_of __flatten_6@0) class_Worker)) (and (= Mask@0 (MapType1Store ZeroMask null (Worker__preFork __flatten_6@0 FullPerm) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Worker__preFork __flatten_6@0 FullPerm))) FullPerm)))) (state Heap@@30 Mask@0))) (and (and (> wildcard@0 NoPerm) (not (= __flatten_6@0 null))) (and (= Mask@1 (MapType1Store Mask@0 __flatten_6@0 Worker__input (real_2_U (+ (U_2_real (MapType1Select Mask@0 __flatten_6@0 Worker__input)) wildcard@0)))) (state Heap@@30 Mask@1)))) (and (and (and (= (U_2_int (MapType0Select Heap@@30 __flatten_6@0 Worker__input)) 7) (= Mask@2 (MapType1Store Mask@1 null (Worker__is_a_Worker __flatten_6@0) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (Worker__is_a_Worker __flatten_6@0))) FullPerm))))) (and (state Heap@@30 Mask@2) (state Heap@@30 Mask@2))) (and (and (U_2_bool (MapType0Select Heap@@30 sys__thrown@0 $allocated)) (U_2_bool (MapType0Select Heap@@30 __flatten_6@0 $allocated))) (and (state Heap@@30 Mask@2) (state Heap@@30 Mask@2))))) (and (=> (= (ControlFlow 0 32) (- 0 36)) (HasDirectPerm Mask@2 __flatten_6@0 Worker__input)) (=> (HasDirectPerm Mask@2 __flatten_6@0 Worker__input) (and (=> (= (ControlFlow 0 32) (- 0 35)) (= (U_2_int (MapType0Select Heap@@30 __flatten_6@0 Worker__input)) 7)) (=> (= (U_2_int (MapType0Select Heap@@30 __flatten_6@0 Worker__input)) 7) (=> (state Heap@@30 Mask@2) (and (=> (= (ControlFlow 0 32) (- 0 34)) (not (= __flatten_6@0 null))) (=> (not (= __flatten_6@0 null)) (and (=> (= (ControlFlow 0 32) (- 0 33)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (and (=> (= (ControlFlow 0 32) 29) anon13_Then_correct) (=> (= (ControlFlow 0 32) 31) anon13_Else_correct))))))))))))))))))
