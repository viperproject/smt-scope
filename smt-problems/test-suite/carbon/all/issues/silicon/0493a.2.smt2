...
(assert (forall ((a_5 T@U) ) (!  (=> (= (type a_5) RefType) (IsPredicateField (p_1 a_5)))
 :qid |stdinbpl.507:15|
 :skolemid |93|
 :pattern ( (p_1 a_5))
)))
(assert  (and (and (and (and (and (and (forall ((arg0@@31 T@T) (arg1@@12 T@T) ) (! (= (Ctor (MapType2Type arg0@@31 arg1@@12)) 14)
...
(assert (forall ((Heap@@2 T@U) (set T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type set) (MapType2Type RefType boolType))) (dummyFunction (int_2_U (|foo#triggerStateless| set))))
 :qid |stdinbpl.412:15|
 :skolemid |83|
 :pattern ( (|foo'| Heap@@2 set))
)))
(assert (forall ((Heap@@3 T@U) (a_5@@0 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type a_5@@0) RefType)) (|p#everUsed| (p_1 a_5@@0)))
 :qid |stdinbpl.526:15|
 :skolemid |97|
 :pattern ( (|p#trigger| Heap@@3 (p_1 a_5@@0)))
)))
...
(assert (forall ((arg0@@36 T@U) (arg1@@17 T@U) ) (! (let ((T@@4 (MapType2TypeInv0 (type arg0@@36))))
...
(assert (forall ((Heap@@5 T@U) (set@@0 T@U) ) (!  (=> (and (= (type Heap@@5) (MapType0Type RefType)) (= (type set@@0) (MapType2Type RefType boolType))) (and (= (foo Heap@@5 set@@0) (|foo'| Heap@@5 set@@0)) (dummyFunction (int_2_U (|foo#triggerStateless| set@@0)))))
 :qid |stdinbpl.408:15|
 :skolemid |82|
 :pattern ( (foo Heap@@5 set@@0))
)))
...
(assert (forall ((a_5@@1 T@U) (a2 T@U) ) (!  (=> (and (and (= (type a_5@@1) RefType) (= (type a2) RefType)) (= (p_1 a_5@@1) (p_1 a2))) (= a_5@@1 a2))
 :qid |stdinbpl.517:15|
 :skolemid |95|
 :pattern ( (p_1 a_5@@1) (p_1 a2))
)))
...
(assert (forall ((a_5@@2 T@U) (a2@@0 T@U) ) (!  (=> (and (and (= (type a_5@@2) RefType) (= (type a2@@0) RefType)) (= (|p#sm| a_5@@2) (|p#sm| a2@@0))) (= a_5@@2 a2@@0))
 :qid |stdinbpl.521:15|
 :skolemid |96|
 :pattern ( (|p#sm| a_5@@2) (|p#sm| a2@@0))
)))
...
(assert (forall ((arg0@@42 Int) (arg1@@20 Int) ) (! (= (type (|sk_foo#condqp1| arg0@@42 arg1@@20)) RefType)
 :qid |funType:sk_foo#condqp1|
 :pattern ( (|sk_foo#condqp1| arg0@@42 arg1@@20))
)))
(assert (forall ((Heap2Heap T@U) (Heap1Heap T@U) (set@@1 T@U) ) (!  (=> (and (and (and (= (type Heap2Heap) (MapType0Type RefType)) (= (type Heap1Heap) (MapType0Type RefType))) (= (type set@@1) (MapType2Type RefType boolType))) (and (=  (and (U_2_bool (MapType2Select set@@1 (|sk_foo#condqp1| (|foo#condqp1| Heap2Heap set@@1) (|foo#condqp1| Heap1Heap set@@1)))) (< NoPerm FullPerm))  (and (U_2_bool (MapType2Select set@@1 (|sk_foo#condqp1| (|foo#condqp1| Heap2Heap set@@1) (|foo#condqp1| Heap1Heap set@@1)))) (< NoPerm FullPerm))) (=> (and (U_2_bool (MapType2Select set@@1 (|sk_foo#condqp1| (|foo#condqp1| Heap2Heap set@@1) (|foo#condqp1| Heap1Heap set@@1)))) (< NoPerm FullPerm)) (= (MapType0Select Heap2Heap null (p_1 (|sk_foo#condqp1| (|foo#condqp1| Heap2Heap set@@1) (|foo#condqp1| Heap1Heap set@@1)))) (MapType0Select Heap1Heap null (p_1 (|sk_foo#condqp1| (|foo#condqp1| Heap2Heap set@@1) (|foo#condqp1| Heap1Heap set@@1)))))))) (= (|foo#condqp1| Heap2Heap set@@1) (|foo#condqp1| Heap1Heap set@@1)))
 :qid |stdinbpl.429:15|
 :skolemid |85|
 :pattern ( (|foo#condqp1| Heap2Heap set@@1) (|foo#condqp1| Heap1Heap set@@1) (succHeapTrans Heap2Heap Heap1Heap))
)))
...
(assert (forall ((a_5@@3 T@U) ) (!  (=> (= (type a_5@@3) RefType) (= (getPredWandId (p_1 a_5@@3)) 0))
 :qid |stdinbpl.511:15|
 :skolemid |94|
 :pattern ( (p_1 a_5@@3))
)))
...
(assert (forall ((a_5@@4 T@U) ) (!  (=> (= (type a_5@@4) RefType) (= (PredicateMaskField (p_1 a_5@@4)) (|p#sm| a_5@@4)))
 :qid |stdinbpl.503:15|
 :skolemid |92|
 :pattern ( (PredicateMaskField (p_1 a_5@@4)))
)))
...
(assert (forall ((Heap@@11 T@U) (Mask@@9 T@U) (set@@2 T@U) ) (!  (=> (and (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (= (type set@@2) (MapType2Type RefType boolType))) (state Heap@@11 Mask@@9)) (= (|foo'| Heap@@11 set@@2) (|foo#frame| (FrameFragment (int_2_U (|foo#condqp1| Heap@@11 set@@2))) set@@2)))
 :qid |stdinbpl.419:15|
 :skolemid |84|
 :pattern ( (state Heap@@11 Mask@@9) (|foo'| Heap@@11 set@@2))
)))
...
(assert  (and (and (and (= (type set@@3) (MapType2Type RefType boolType)) (= (type Heap@@13) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@47 T@U) ) (! (= (type (invRecv2 arg0@@47)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (= (foo Heap@@13 set@@3) 0))))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((a_6 T@U) (a_6_1 T@U) ) (!  (=> (and (= (type a_6) RefType) (= (type a_6_1) RefType)) (=> (and (and (and (and (not (= a_6 a_6_1)) (U_2_bool (MapType2Select set@@3 a_6))) (U_2_bool (MapType2Select set@@3 a_6_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_6 a_6_1))))
 :qid |stdinbpl.697:21|
 :skolemid |111|
 :pattern ( (neverTriggered4 a_6) (neverTriggered4 a_6_1))
))) (=> (forall ((a_6@@0 T@U) (a_6_1@@0 T@U) ) (!  (=> (and (= (type a_6@@0) RefType) (= (type a_6_1@@0) RefType)) (=> (and (and (and (and (not (= a_6@@0 a_6_1@@0)) (U_2_bool (MapType2Select set@@3 a_6@@0))) (U_2_bool (MapType2Select set@@3 a_6_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_6@@0 a_6_1@@0))))
 :qid |stdinbpl.697:21|
 :skolemid |111|
 :pattern ( (neverTriggered4 a_6@@0) (neverTriggered4 a_6_1@@0))
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((a_6@@1 T@U) ) (!  (=> (and (= (type a_6@@1) RefType) (U_2_bool (MapType2Select set@@3 a_6@@1))) (>= (U_2_real (MapType1Select QPMask@0 null (p_1 a_6@@1))) FullPerm))
 :qid |stdinbpl.704:21|
 :skolemid |112|
 :pattern ( (MapType0Select Heap@@13 null (p_1 a_6@@1)))
 :pattern ( (MapType1Select QPMask@0 null (p_1 a_6@@1)))
 :pattern ( (MapType0Select Heap@@13 null (p_1 a_6@@1)))
)))))))
(let ((anon8_Else_correct  (=> (and (= (foo Heap@@13 set@@3) 0) (state Heap@@13 QPMask@0)) (and (=> (= (ControlFlow 0 10) 6) anon9_Then_correct) (=> (= (ControlFlow 0 10) 9) anon9_Else_correct)))))
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((a_4 T@U) (a_4_2 T@U) ) (!  (=> (and (= (type a_4) RefType) (= (type a_4_2) RefType)) (=> (and (and (and (and (not (= a_4 a_4_2)) (U_2_bool (MapType2Select set@@3 a_4))) (U_2_bool (MapType2Select set@@3 a_4_2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_4 a_4_2))))
 :qid |stdinbpl.627:21|
 :skolemid |104|
 :pattern ( (neverTriggered3 a_4) (neverTriggered3 a_4_2))
))) (=> (forall ((a_4@@0 T@U) (a_4_2@@0 T@U) ) (!  (=> (and (= (type a_4@@0) RefType) (= (type a_4_2@@0) RefType)) (=> (and (and (and (and (not (= a_4@@0 a_4_2@@0)) (U_2_bool (MapType2Select set@@3 a_4@@0))) (U_2_bool (MapType2Select set@@3 a_4_2@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_4@@0 a_4_2@@0))))
 :qid |stdinbpl.627:21|
 :skolemid |104|
 :pattern ( (neverTriggered3 a_4@@0) (neverTriggered3 a_4_2@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((a_4@@1 T@U) ) (!  (=> (and (= (type a_4@@1) RefType) (U_2_bool (MapType2Select set@@3 a_4@@1))) (>= (U_2_real (MapType1Select QPMask@0 null (p_1 a_4@@1))) FullPerm))
 :qid |stdinbpl.634:21|
 :skolemid |105|
 :pattern ( (MapType0Select Heap@@13 null (p_1 a_4@@1)))
 :pattern ( (MapType1Select QPMask@0 null (p_1 a_4@@1)))
 :pattern ( (MapType0Select Heap@@13 null (p_1 a_4@@1)))
)))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((a_1 T@U) (a_1_1 T@U) ) (!  (=> (and (= (type a_1) RefType) (= (type a_1_1) RefType)) (=> (and (and (and (and (not (= a_1 a_1_1)) (U_2_bool (MapType2Select set@@3 a_1))) (U_2_bool (MapType2Select set@@3 a_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1 a_1_1))))
 :qid |stdinbpl.581:17|
 :skolemid |98|
 :pattern ( (neverTriggered2 a_1) (neverTriggered2 a_1_1))
))) (=> (forall ((a_1@@0 T@U) (a_1_1@@0 T@U) ) (!  (=> (and (= (type a_1@@0) RefType) (= (type a_1_1@@0) RefType)) (=> (and (and (and (and (not (= a_1@@0 a_1_1@@0)) (U_2_bool (MapType2Select set@@3 a_1@@0))) (U_2_bool (MapType2Select set@@3 a_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1@@0 a_1_1@@0))))
 :qid |stdinbpl.581:17|
 :skolemid |98|
 :pattern ( (neverTriggered2 a_1@@0) (neverTriggered2 a_1_1@@0))
)) (=> (forall ((a_1@@1 T@U) ) (!  (=> (= (type a_1@@1) RefType) (=> (and (U_2_bool (MapType2Select set@@3 a_1@@1)) (< NoPerm FullPerm)) (and (= (invRecv2 a_1@@1) a_1@@1) (qpRange2 a_1@@1))))
 :qid |stdinbpl.587:22|
 :skolemid |99|
 :pattern ( (MapType0Select Heap@@13 null (p_1 a_1@@1)))
 :pattern ( (MapType1Select ZeroMask null (p_1 a_1@@1)))
 :pattern ( (MapType0Select Heap@@13 null (p_1 a_1@@1)))
)) (=> (and (forall ((a_2_1 T@U) ) (!  (=> (= (type a_2_1) RefType) (=> (and (and (U_2_bool (MapType2Select set@@3 (invRecv2 a_2_1))) (< NoPerm FullPerm)) (qpRange2 a_2_1)) (= (invRecv2 a_2_1) a_2_1)))
 :qid |stdinbpl.591:22|
 :skolemid |100|
 :pattern ( (invRecv2 a_2_1))
)) (forall ((a_2_1@@0 T@U) ) (!  (=> (= (type a_2_1@@0) RefType) (=> (and (and (U_2_bool (MapType2Select set@@3 (invRecv2 a_2_1@@0))) (< NoPerm FullPerm)) (qpRange2 a_2_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 a_2_1@@0) a_2_1@@0)) (= (U_2_real (MapType1Select QPMask@0 null (p_1 a_2_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (p_1 a_2_1@@0))) FullPerm)))))
 :qid |stdinbpl.597:22|
 :skolemid |101|
 :pattern ( (MapType1Select QPMask@0 null (p_1 a_2_1@@0)))
...
)) (forall ((a_2_1@@1 T@U) ) (!  (=> (and (= (type a_2_1@@1) RefType) (not (and (and (U_2_bool (MapType2Select set@@3 (invRecv2 a_2_1@@1))) (< NoPerm FullPerm)) (qpRange2 a_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (p_1 a_2_1@@1))) (U_2_real (MapType1Select ZeroMask null (p_1 a_2_1@@1)))))
 :qid |stdinbpl.607:22|
 :skolemid |103|
 :pattern ( (MapType1Select QPMask@0 null (p_1 a_2_1@@1)))
))) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0))) (and (=> (= (ControlFlow 0 11) 3) anon8_Then_correct) (=> (= (ControlFlow 0 11) 10) anon8_Else_correct)))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 13) 1) anon7_Then_correct) (=> (= (ControlFlow 0 13) 11) anon7_Else_correct)))))
