...
(declare-fun |idx'| (T@U Int Int Int Int) Int)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |idx#triggerStateless| (Int Int Int Int) Int)
(declare-fun |idx_abs'| (T@U Int Int Int Int) Int)
...
(declare-fun idx_abs (T@U Int Int Int Int) Int)
(declare-fun |idx#frame| (T@U Int Int Int Int) Int)
(declare-fun |idx_abs#frame| (T@U Int Int Int Int) Int)
(declare-fun |Seq#Equal| (T@U T@U) Bool)
(declare-fun |Seq#ContainsTrigger| (T@U T@U) Bool)
(declare-fun FullPerm () Real)
(declare-fun ZeroPMask () T@U)
(declare-fun |Seq#SkolemDiff| (T@U T@U) Int)
(declare-fun |idx_abs#trigger| (T@U Int Int Int Int) Bool)
...
(assert (forall ((Heap@@5 T@U) (M Int) (N Int) (i@@2 Int) (j@@3 Int) ) (!  (=> (= (type Heap@@5) (MapType0Type RefType)) (dummyFunction (int_2_U (|idx#triggerStateless| M N i@@2 j@@3))))
 :qid |stdinbpl.578:15|
 :skolemid |59|
 :pattern ( (|idx'| Heap@@5 M N i@@2 j@@3))
)))
(assert (forall ((Heap@@6 T@U) (M@@0 Int) (N@@0 Int) (i@@3 Int) (j@@4 Int) ) (!  (=> (= (type Heap@@6) (MapType0Type RefType)) (dummyFunction (int_2_U (|idx_abs#triggerStateless| M@@0 N@@0 i@@3 j@@4))))
 :qid |stdinbpl.627:15|
 :skolemid |63|
 :pattern ( (|idx_abs'| Heap@@6 M@@0 N@@0 i@@3 j@@4))
)))
(assert (forall ((Heap@@7 T@U) (Mask@@5 T@U) (M@@1 Int) (N@@1 Int) (i@@4 Int) (j@@5 Int) ) (!  (=> (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type Mask@@5) (MapType1Type RefType realType))) (and (state Heap@@7 Mask@@5) (< AssumeFunctionsAbove 0))) (= (idx Heap@@7 M@@1 N@@1 i@@4 j@@5) 0))
 :qid |stdinbpl.584:15|
 :skolemid |60|
 :pattern ( (state Heap@@7 Mask@@5) (idx Heap@@7 M@@1 N@@1 i@@4 j@@5))
)))
...
(assert (forall ((Heap@@8 T@U) (M@@2 Int) (N@@2 Int) (i@@5 Int) (j@@7 Int) ) (!  (=> (= (type Heap@@8) (MapType0Type RefType)) (and (= (idx Heap@@8 M@@2 N@@2 i@@5 j@@7) (|idx'| Heap@@8 M@@2 N@@2 i@@5 j@@7)) (dummyFunction (int_2_U (|idx#triggerStateless| M@@2 N@@2 i@@5 j@@7)))))
 :qid |stdinbpl.574:15|
 :skolemid |58|
 :pattern ( (idx Heap@@8 M@@2 N@@2 i@@5 j@@7))
)))
(assert (forall ((Heap@@9 T@U) (M@@3 Int) (N@@3 Int) (i@@6 Int) (j@@8 Int) ) (!  (=> (= (type Heap@@9) (MapType0Type RefType)) (and (= (idx_abs Heap@@9 M@@3 N@@3 i@@6 j@@8) (|idx_abs'| Heap@@9 M@@3 N@@3 i@@6 j@@8)) (dummyFunction (int_2_U (|idx_abs#triggerStateless| M@@3 N@@3 i@@6 j@@8)))))
 :qid |stdinbpl.623:15|
 :skolemid |62|
 :pattern ( (idx_abs Heap@@9 M@@3 N@@3 i@@6 j@@8))
)))
...
(assert (forall ((Heap@@10 T@U) (Mask@@7 T@U) (M@@4 Int) (N@@4 Int) (i@@7 Int) (j@@9 Int) ) (!  (=> (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (state Heap@@10 Mask@@7)) (= (|idx'| Heap@@10 M@@4 N@@4 i@@7 j@@9) (|idx#frame| EmptyFrame M@@4 N@@4 i@@7 j@@9)))
 :qid |stdinbpl.591:15|
 :skolemid |61|
 :pattern ( (state Heap@@10 Mask@@7) (|idx'| Heap@@10 M@@4 N@@4 i@@7 j@@9))
)))
(assert (forall ((Heap@@11 T@U) (Mask@@8 T@U) (M@@5 Int) (N@@5 Int) (i@@8 Int) (j@@10 Int) ) (!  (=> (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type Mask@@8) (MapType1Type RefType realType))) (state Heap@@11 Mask@@8)) (= (|idx_abs'| Heap@@11 M@@5 N@@5 i@@8 j@@10) (|idx_abs#frame| EmptyFrame M@@5 N@@5 i@@8 j@@10)))
 :qid |stdinbpl.634:15|
 :skolemid |64|
 :pattern ( (state Heap@@11 Mask@@8) (|idx_abs'| Heap@@11 M@@5 N@@5 i@@8 j@@10))
)))
...
(assert (forall ((s0@@2 T@U) (s1@@2 T@U) ) (! (let ((T@@23 (SeqTypeInv0 (type s0@@2))))
 (=> (and (and (= (type s0@@2) (SeqType T@@23)) (= (type s1@@2) (SeqType T@@23))) (|Seq#Equal| s0@@2 s1@@2)) (and (= (|Seq#Length| s0@@2) (|Seq#Length| s1@@2)) (forall ((j@@11 Int) ) (!  (=> (and (<= 0 j@@11) (< j@@11 (|Seq#Length| s0@@2))) (= (|Seq#Index| s0@@2 j@@11) (|Seq#Index| s1@@2 j@@11)))
 :qid |stdinbpl.513:13|
 :skolemid |50|
 :pattern ( (|Seq#Index| s0@@2 j@@11))
 :pattern ( (|Seq#Index| s1@@2 j@@11))
)))))
 :qid |stdinbpl.510:18|
 :skolemid |51|
...
(assert (forall ((s@@11 T@U) (i@@10 Int) (v@@1 T@U) ) (! (let ((T@@25 (type v@@1)))
 (=> (= (type s@@11) (SeqType T@@25)) (=> (and (<= 0 i@@10) (< i@@10 (|Seq#Length| s@@11))) (= (|Seq#Length| (|Seq#Update| s@@11 i@@10 v@@1)) (|Seq#Length| s@@11)))))
 :qid |stdinbpl.267:18|
 :skolemid |34|
 :pattern ( (|Seq#Length| (|Seq#Update| s@@11 i@@10 v@@1)))
 :pattern ( (|Seq#Length| s@@11) (|Seq#Update| s@@11 i@@10 v@@1))
)))
...
(assert (forall ((s@@13 T@U) (n@@10 Int) (i@@11 Int) ) (! (let ((T@@27 (SeqTypeInv0 (type s@@13))))
 (=> (= (type s@@13) (SeqType T@@27)) (=> (and (and (< 0 n@@10) (<= n@@10 i@@11)) (< i@@11 (|Seq#Length| s@@13))) (and (= (|Seq#Add| (|Seq#Sub| i@@11 n@@10) n@@10) i@@11) (= (|Seq#Index| (|Seq#Drop| s@@13 n@@10) (|Seq#Sub| i@@11 n@@10)) (|Seq#Index| s@@13 i@@11))))))
 :qid |stdinbpl.318:18|
 :skolemid |40|
 :pattern ( (|Seq#Drop| s@@13 n@@10) (|Seq#Index| s@@13 i@@11))
)))
...
(assert (forall ((s@@14 T@U) (x@@10 T@U) (i@@12 Int) ) (! (let ((T@@30 (type x@@10)))
 (=> (= (type s@@14) (SeqType T@@30)) (=> (and (and (<= 0 i@@12) (< i@@12 (|Seq#Length| s@@14))) (= (|Seq#Index| s@@14 i@@12) x@@10)) (|Seq#Contains| s@@14 x@@10))))
 :qid |stdinbpl.414:18|
 :skolemid |48|
 :pattern ( (|Seq#Contains| s@@14 x@@10) (|Seq#Index| s@@14 i@@12))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@16 T@U) (Mask@@12 T@U) (M@@6 Int) (N@@6 Int) (i@@13 Int) (j@@12 Int) ) (!  (=> (and (and (= (type Heap@@16) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (and (state Heap@@16 Mask@@12) (or (< AssumeFunctionsAbove 1) (|idx_abs#trigger| EmptyFrame M@@6 N@@6 i@@13 j@@12)))) (and (<= 0 (|idx_abs'| Heap@@16 M@@6 N@@6 i@@13 j@@12)) (< (|idx_abs'| Heap@@16 M@@6 N@@6 i@@13 j@@12) (* N@@6 M@@6))))
 :qid |stdinbpl.640:15|
 :skolemid |65|
 :pattern ( (state Heap@@16 Mask@@12) (|idx_abs'| Heap@@16 M@@6 N@@6 i@@13 j@@12))
)))
(push 1)
...
(declare-fun j_4 () Int)
(declare-fun dst () T@U)
(assert  (and (and (and (= (type src) (SeqType RefType)) (= (type Heap@@17) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type dst) (SeqType RefType))))
...
(let ((anon26_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 22)) (>= (idx_abs Heap@@17 M@@7 N@@7 i_5 j_5) 0)) (=> (>= (idx_abs Heap@@17 M@@7 N@@7 i_5 j_5) 0) (and (=> (= (ControlFlow 0 19) (- 0 21)) (< (idx_abs Heap@@17 M@@7 N@@7 i_5 j_5) (|Seq#Length| src))) (=> (< (idx_abs Heap@@17 M@@7 N@@7 i_5 j_5) (|Seq#Length| src)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (HasDirectPerm QPMask@0 (|Seq#Index| src (idx_abs Heap@@17 M@@7 N@@7 i_5 j_5)) val)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| src (idx_abs Heap@@17 M@@7 N@@7 i_5 j_5)) val) (=> (= (ControlFlow 0 19) 16) anon15_correct)))))))))
(let ((anon25_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 N@@7) (int_2_U j_5)) (and (=> (= (ControlFlow 0 23) 18) anon26_Then_correct) (=> (= (ControlFlow 0 23) 19) anon26_Else_correct)))))
(let ((anon25_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 N@@7) (int_2_U j_5))) (= (ControlFlow 0 17) 16)) anon15_correct)))
(let ((anon16_correct true))
(let ((anon23_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 M@@7) (int_2_U i_5)) (and (and (=> (= (ControlFlow 0 24) 14) anon16_correct) (=> (= (ControlFlow 0 24) 23) anon25_Then_correct)) (=> (= (ControlFlow 0 24) 17) anon25_Else_correct)))))
(let ((anon23_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 M@@7) (int_2_U i_5))) (= (ControlFlow 0 15) 14)) anon16_correct)))
(let ((anon22_Else_correct true))
(let ((anon20_Else_correct  (and (=> (= (ControlFlow 0 25) (- 0 27)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 0 (* M@@7 N@@7)) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 0 (* M@@7 N@@7)) (int_2_U i_1_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index| src i_1) (|Seq#Index| src i_1_1))))
 :qid |stdinbpl.865:15|
 :skolemid |77|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (* M@@7 N@@7)) (int_2_U i_1@@0))) (|Seq#Contains| (|Seq#Range| 0 (* M@@7 N@@7)) (int_2_U i_1_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index| src i_1@@0) (|Seq#Index| src i_1_1@@0))))
 :qid |stdinbpl.865:15|
 :skolemid |77|
)) (=> (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (* M@@7 N@@7)) (int_2_U i_1@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange2 (|Seq#Index| src i_1@@1)) (= (invRecv2 (|Seq#Index| src i_1@@1)) i_1@@1)))
 :qid |stdinbpl.871:22|
 :skolemid |78|
 :pattern ( (|Seq#Index| src i_1@@1))
 :pattern ( (|Seq#Index| src i_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (* M@@7 N@@7)) (int_2_U (invRecv2 o_3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_3)) (= (|Seq#Index| src (invRecv2 o_3)) o_3)))
 :qid |stdinbpl.875:22|
 :skolemid |79|
 :pattern ( (invRecv2 o_3))
))) (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (* M@@7 N@@7)) (int_2_U i_1@@2)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.881:15|
 :skolemid |80|
 :pattern ( (|Seq#Index| src i_1@@2))
 :pattern ( (|Seq#Index| src i_1@@2))
))) (=> (forall ((i_1@@3 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (* M@@7 N@@7)) (int_2_U i_1@@3)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.881:15|
 :skolemid |80|
 :pattern ( (|Seq#Index| src i_1@@3))
 :pattern ( (|Seq#Index| src i_1@@3))
)) (=> (and (forall ((i_1@@4 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (* M@@7 N@@7)) (int_2_U i_1@@4)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (|Seq#Index| src i_1@@4) null)))
 :qid |stdinbpl.887:22|
 :skolemid |81|
 :pattern ( (|Seq#Index| src i_1@@4))
 :pattern ( (|Seq#Index| src i_1@@4))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (* M@@7 N@@7)) (int_2_U (invRecv2 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_3@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index| src (invRecv2 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 (* M@@7 N@@7)) (int_2_U (invRecv2 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.893:22|
 :skolemid |82|
...
)) (state Heap@@17 QPMask@0)) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (and (=> (= (ControlFlow 0 25) 13) anon22_Else_correct) (=> (= (ControlFlow 0 25) 24) anon23_Then_correct)) (=> (= (ControlFlow 0 25) 15) anon23_Else_correct)))))))))))
(let ((anon7_correct true))
(let ((anon21_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (* M@@7 N@@7)) (int_2_U i_4))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon21_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (* M@@7 N@@7)) (int_2_U i_4)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_4 (|Seq#Length| src))) (=> (< i_4 (|Seq#Length| src)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon18_Else_correct  (=> (and (forall ((k_1 Int) (j_1_1 Int) ) (!  (=> (and (>= k_1 0) (and (< k_1 (|Seq#Length| src)) (and (>= j_1_1 0) (and (< j_1_1 (|Seq#Length| src)) (not (= k_1 j_1_1)))))) (not (= (|Seq#Index| src k_1) (|Seq#Index| src j_1_1))))
 :qid |stdinbpl.847:20|
 :skolemid |76|
 :pattern ( (|Seq#Index| src k_1) (|Seq#Index| src j_1_1))
)) (state Heap@@17 ZeroMask)) (and (and (=> (= (ControlFlow 0 28) 25) anon20_Else_correct) (=> (= (ControlFlow 0 28) 9) anon21_Then_correct)) (=> (= (ControlFlow 0 28) 12) anon21_Else_correct)))))
(let ((anon3_correct true))
(let ((anon19_Else_correct  (=> (and (not (and (>= k_2 0) (and (< k_2 (|Seq#Length| src)) (and (>= j_4 0) (and (< j_4 (|Seq#Length| src)) (not (= k_2 j_4))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon19_Then_correct  (=> (and (>= k_2 0) (and (< k_2 (|Seq#Length| src)) (and (>= j_4 0) (and (< j_4 (|Seq#Length| src)) (not (= k_2 j_4)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= k_2 0)) (=> (>= k_2 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< k_2 (|Seq#Length| src))) (=> (< k_2 (|Seq#Length| src)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_4 0)) (=> (>= j_4 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_4 (|Seq#Length| src))) (=> (< j_4 (|Seq#Length| src)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (> M@@7 0)) (=> (and (and (> N@@7 0) (= (|Seq#Length| src) (* N@@7 M@@7))) (and (= (|Seq#Length| dst) (* N@@7 M@@7)) (state Heap@@17 ZeroMask))) (and (and (=> (= (ControlFlow 0 29) 28) anon18_Else_correct) (=> (= (ControlFlow 0 29) 2) anon19_Then_correct)) (=> (= (ControlFlow 0 29) 7) anon19_Else_correct)))))))
