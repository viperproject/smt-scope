...
(let ((anon73_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g n$0_10)) (not (= (MapType0Select Heap@@23 n$0_10 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon73_Then_correct  (=> (and (U_2_bool (MapType2Select g n$0_10)) (not (= (MapType0Select Heap@@23 n$0_10 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 n$0_10 next)) (=> (HasDirectPerm QPMask@0 n$0_10 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon72_Else_correct  (=> (not (U_2_bool (MapType2Select g n$0_10))) (and (=> (= (ControlFlow 0 8) 3) anon73_Then_correct) (=> (= (ControlFlow 0 8) 5) anon73_Else_correct)))))
(let ((anon72_Then_correct  (=> (U_2_bool (MapType2Select g n$0_10)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm QPMask@0 n$0_10 next)) (=> (HasDirectPerm QPMask@0 n$0_10 next) (and (=> (= (ControlFlow 0 6) 3) anon73_Then_correct) (=> (= (ControlFlow 0 6) 5) anon73_Else_correct)))))))
