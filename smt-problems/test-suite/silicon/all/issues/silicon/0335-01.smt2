...
; 0,00s
; (get-info :all-statistics)
; [then-branch: 1 | First:(Second:($t@8@00)) != Null | live]
; [else-branch: 1 | First:(Second:($t@8@00)) == Null | live]
(set-option :timeout 0)
(push) ; 2
; [then-branch: 1 | First:(Second:($t@8@00)) != Null]
(assert (not
  (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second $t@8@00))) $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@8@00)))
...
(set-option :timeout 10)
(assert (not (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@8@00)))))
  $Ref.null)))
(check-sat)
; unknown
(pop) ; 3
...
; 0,00s
; (get-info :all-statistics)
; [then-branch: 2 | First:(Second:(Second:(Second:($t@8@00)))) != Null | live]
; [else-branch: 2 | First:(Second:(Second:(Second:($t@8@00)))) == Null | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 2 | First:(Second:(Second:(Second:($t@8@00)))) != Null]
(assert (not
  (=
    ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@8@00)))))
    $Ref.null)))
...
(set-option :timeout 0)
(push) ; 3
; [else-branch: 2 | First:(Second:(Second:(Second:($t@8@00)))) == Null]
(assert (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@8@00)))))
  $Ref.null))
(assert (=
...
(pop) ; 2
(push) ; 2
; [else-branch: 1 | First:(Second:($t@8@00)) == Null]
(assert (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second $t@8@00))) $Ref.null))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@8@00))) $Snap.unit))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@8@00)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@8@00))))
...
; 0,00s
; (get-info :all-statistics)
; [then-branch: 3 | First:(Second:(Second:(Second:($t@8@00)))) != Null | live]
; [else-branch: 3 | First:(Second:(Second:(Second:($t@8@00)))) == Null | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 3 | First:(Second:(Second:(Second:($t@8@00)))) != Null]
(assert (not
  (=
    ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@8@00)))))
    $Ref.null)))
(pop) ; 3
(push) ; 3
; [else-branch: 3 | First:(Second:(Second:(Second:($t@8@00)))) == Null]
(assert (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@8@00)))))
  $Ref.null))
(assert (=
