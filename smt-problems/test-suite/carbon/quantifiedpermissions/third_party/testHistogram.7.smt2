...
(let ((anon31_Else_correct  (=> (and (not (and (<= 0 k_22) (< k_22 P))) (= (ControlFlow 0 27) 22)) anon16_correct)))
(let ((anon31_Then_correct  (=> (and (<= 0 k_22) (< k_22 P)) (and (=> (= (ControlFlow 0 23) (- 0 26)) (>= k_22 0)) (=> (>= k_22 0) (and (=> (= (ControlFlow 0 23) (- 0 25)) (< k_22 (|Seq#Length| hist))) (=> (< k_22 (|Seq#Length| hist)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (HasDirectPerm QPMask@2 (|Seq#Index| hist k_22) Ref__Integer_value)) (=> (HasDirectPerm QPMask@2 (|Seq#Index| hist k_22) Ref__Integer_value) (=> (= (ControlFlow 0 23) 22) anon16_correct))))))))))
(let ((anon30_Else_correct true))
(let ((anon28_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 29)) (forall ((k_5 Int) (k_5_1 Int) ) (!  (=> (and (and (and (and (not (= k_5 k_5_1)) (and (<= 0 k_5) (< k_5 P))) (and (<= 0 k_5_1) (< k_5_1 P))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| hist k_5) (|Seq#Index| hist k_5_1))))
 ...
 :qid |stdinbpl.2106:15|
 :skolemid |173|
)) (=> (forall ((k_5@@1 Int) ) (!  (=> (and (and (<= 0 k_5@@1) (< k_5@@1 P)) (< NoPerm FullPerm)) (and (qpRange10 (|Seq#Index| hist k_5@@1)) (= (invRecv10 (|Seq#Index| hist k_5@@1)) k_5@@1)))
...
(let ((anon29_Else_correct  (=> (and (not (and (<= 0 k_21) (< k_21 P))) (= (ControlFlow 0 20) 16)) anon12_correct)))
(let ((anon29_Then_correct  (=> (and (<= 0 k_21) (< k_21 P)) (and (=> (= (ControlFlow 0 17) (- 0 19)) (>= k_21 0)) (=> (>= k_21 0) (and (=> (= (ControlFlow 0 17) (- 0 18)) (< k_21 (|Seq#Length| hist))) (=> (< k_21 (|Seq#Length| hist)) (=> (= (ControlFlow 0 17) 16) anon12_correct))))))))
...
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 32)) (forall ((k_3 Int) (k_3_1 Int) ) (!  (=> (and (and (and (and (not (= k_3 k_3_1)) (and (<= 0 k_3) (< k_3 P))) (and (<= 0 k_3_1) (< k_3_1 P))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| hist k_3) (|Seq#Index| hist k_3_1))))
 :qid |stdinbpl.2049:15|
 :skolemid |167|
 ...
 :qid |stdinbpl.2049:15|
 :skolemid |167|
)) (=> (forall ((k_3@@1 Int) ) (!  (=> (and (and (<= 0 k_3@@1) (< k_3@@1 P)) (< NoPerm FullPerm)) (and (qpRange9 (|Seq#Index| hist k_3@@1)) (= (invRecv9 (|Seq#Index| hist k_3@@1)) k_3@@1)))
...
(let ((anon26_Else_correct  (=> (and (not (and (<= 0 k_20) (< k_20 P))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon26_Then_correct  (=> (and (<= 0 k_20) (< k_20 P)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= k_20 0)) (=> (>= k_20 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< k_20 (|Seq#Length| hist))) (=> (< k_20 (|Seq#Length| hist)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon23_Else_correct  (=> (and (forall ((j_1_1 Int) (k_1_1 Int) ) (!  (=> (and (<= 0 j_1_1) (and (< j_1_1 P) (and (<= 0 k_1_1) (and (< k_1_1 P) (not (= j_1_1 k_1_1)))))) (not (= (|Seq#Index| hist j_1_1) (|Seq#Index| hist k_1_1))))
 :qid |stdinbpl.2031:20|
 :skolemid |166|
...
(let ((anon24_Else_correct  (=> (and (not (and (<= 0 j_8) (and (< j_8 P) (and (<= 0 k_19) (and (< k_19 P) (not (= j_8 k_19))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon24_Then_correct  (=> (and (<= 0 j_8) (and (< j_8 P) (and (<= 0 k_19) (and (< k_19 P) (not (= j_8 k_19)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j_8 0)) (=> (>= j_8 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j_8 (|Seq#Length| hist))) (=> (< j_8 (|Seq#Length| hist)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_19 0)) (=> (>= k_19 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_19 (|Seq#Length| hist))) (=> (< k_19 (|Seq#Length| hist)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@41 diz $allocated))) (and (not (= diz null)) (state Heap@@41 ZeroMask))) (and (and (>= current_thread_id 0) (state Heap@@41 ZeroMask)) (and (<= P (|Seq#Length| hist)) (state Heap@@41 ZeroMask)))) (and (and (=> (= (ControlFlow 0 34) 33) anon23_Else_correct) (=> (= (ControlFlow 0 34) 2) anon24_Then_correct)) (=> (= (ControlFlow 0 34) 7) anon24_Else_correct))))))
