...
(assert  (and (and (and (and (and (and (and (and (= (type xs@@8) (MapType2Type RefType boolType)) (= (type Heap@@10) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv6 arg0@@48)) RefType)
 :qid |funType:invRecv6|
 :pattern ( (invRecv6 arg0@@48))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type y1@@5) RefType)) (= (type r_1) RefType)) (= (type x_10) RefType)) (forall ((arg0@@49 T@U) ) (! (= (type (invRecv5 arg0@@49)) RefType)
...
(let ((anon9_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs@@8 x_10))) (= (ControlFlow 0 9) 6)) anon5_correct)))
(let ((anon9_Then_correct  (=> (U_2_bool (MapType2Select xs@@8 x_10)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm QPMask@0 x_10 f_7)) (=> (HasDirectPerm QPMask@0 x_10 f_7) (=> (= (ControlFlow 0 7) 6) anon5_correct))))))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (and (U_2_bool (MapType2Select xs@@8 x_3)) (not (= (U_2_int (MapType0Select Heap@@10 x_3 f_7)) 0)))) (and (U_2_bool (MapType2Select xs@@8 x_3_1)) (not (= (U_2_int (MapType0Select Heap@@10 x_3_1 f_7)) 0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1))))
 :qid |stdinbpl.957:15|
 :skolemid |122|
 :no-pattern (type x_3)
...
))) (=> (forall ((x_3@@0 T@U) (x_3_1@@0 T@U) ) (!  (=> (and (= (type x_3@@0) RefType) (= (type x_3_1@@0) RefType)) (=> (and (and (and (and (not (= x_3@@0 x_3_1@@0)) (and (U_2_bool (MapType2Select xs@@8 x_3@@0)) (not (= (U_2_int (MapType0Select Heap@@10 x_3@@0 f_7)) 0)))) (and (U_2_bool (MapType2Select xs@@8 x_3_1@@0)) (not (= (U_2_int (MapType0Select Heap@@10 x_3_1@@0 f_7)) 0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3@@0 x_3_1@@0))))
 :qid |stdinbpl.957:15|
 :skolemid |122|
...
)) (=> (and (forall ((x_3@@1 T@U) ) (!  (=> (= (type x_3@@1) RefType) (=> (and (and (U_2_bool (MapType2Select xs@@8 x_3@@1)) (not (= (U_2_int (MapType0Select Heap@@10 x_3@@1 f_7)) 0))) (< NoPerm FullPerm)) (and (qpRange6 x_3@@1) (= (invRecv6 x_3@@1) x_3@@1))))
 :qid |stdinbpl.963:22|
 :skolemid |123|
 :pattern ( (MapType0Select Heap@@10 x_3@@1 g))
 :pattern ( (MapType1Select QPMask@1 x_3@@1 g))
 :pattern ( (MapType2Select xs@@8 x_3@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (U_2_bool (MapType2Select xs@@8 (invRecv6 o_3))) (not (= (U_2_int (MapType0Select Heap@@10 (invRecv6 o_3) f_7)) 0))) (< NoPerm FullPerm)) (qpRange6 o_3)) (= (invRecv6 o_3) o_3)))
 :qid |stdinbpl.967:22|
 :skolemid |124|
 :pattern ( (invRecv6 o_3))
))) (=> (and (and (and (forall ((x_3@@2 T@U) ) (!  (=> (= (type x_3@@2) RefType) (=> (and (U_2_bool (MapType2Select xs@@8 x_3@@2)) (not (= (U_2_int (MapType0Select Heap@@10 x_3@@2 f_7)) 0))) (not (= x_3@@2 null))))
 :qid |stdinbpl.973:22|
 :skolemid |125|
 :pattern ( (MapType0Select Heap@@10 x_3@@2 g))
 :pattern ( (MapType1Select QPMask@1 x_3@@2 g))
 :pattern ( (MapType2Select xs@@8 x_3@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (U_2_bool (MapType2Select xs@@8 (invRecv6 o_3@@0))) (not (= (U_2_int (MapType0Select Heap@@10 (invRecv6 o_3@@0) f_7)) 0))) (< NoPerm FullPerm)) (qpRange6 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv6 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 g)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@0 g)) FullPerm)))) (=> (not (and (and (and (U_2_bool (MapType2Select xs@@8 (invRecv6 o_3@@0))) (not (= (U_2_int (MapType0Select Heap@@10 (invRecv6 o_3@@0) f_7)) 0))) (< NoPerm FullPerm)) (qpRange6 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 g)) (U_2_real (MapType1Select QPMask@0 o_3@@0 g))))))
 :qid |stdinbpl.979:22|
 :skolemid |126|
...
)) (state Heap@@10 QPMask@1))) (and (and (state Heap@@10 QPMask@1) (U_2_bool (MapType2Select xs@@8 y1@@5))) (and (state Heap@@10 QPMask@1) (U_2_bool (MapType0Select Heap@@10 r_1 $allocated))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@1 y1@@5 f_7)) (=> (HasDirectPerm QPMask@1 y1@@5 f_7) (=> (= a_2@0 (U_2_int (MapType0Select Heap@@10 y1@@5 f_7))) (=> (and (state Heap@@10 QPMask@1) (= (ControlFlow 0 3) (- 0 2))) (HasDirectPerm QPMask@1 y1@@5 g)))))))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select xs@@8 x_1))) (U_2_bool (MapType2Select xs@@8 x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.913:15|
 :skolemid |116|
 :no-pattern (type x_1)
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs@@8 x_1@@1)) (< NoPerm FullPerm)) (and (qpRange5 x_1@@1) (= (invRecv5 x_1@@1) x_1@@1))))
 :qid |stdinbpl.919:22|
 :skolemid |117|
 :pattern ( (MapType0Select Heap@@10 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
 :pattern ( (MapType2Select xs@@8 x_1@@1))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType2Select xs@@8 (invRecv5 o_3@@2))) (< NoPerm FullPerm)) (qpRange5 o_3@@2)) (= (invRecv5 o_3@@2) o_3@@2)))
 :qid |stdinbpl.923:22|
 :skolemid |118|
...
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs@@8 (invRecv5 o_3@@3))) (< NoPerm FullPerm)) (qpRange5 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv5 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select xs@@8 (invRecv5 o_3@@3))) (< NoPerm FullPerm)) (qpRange5 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@3 f_7))))))
 :qid |stdinbpl.935:22|
 :skolemid |120|
...
))) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0))) (and (and (=> (= (ControlFlow 0 10) 3) anon8_Else_correct) (=> (= (ControlFlow 0 10) 7) anon9_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon9_Else_correct)))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 y1@@5 $allocated))) (and (=> (= (ControlFlow 0 12) 1) anon7_Then_correct) (=> (= (ControlFlow 0 12) 10) anon7_Else_correct)))))
