...
(set-info :boogie-vc-id Ref__loop_main_17)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 35) (let ((anon16_correct true))
(let ((anon31_Else_correct  (=> (and (not (and (<= 0 i_5) (< i_5 N))) (= (ControlFlow 0 27) 22)) anon16_correct)))
(let ((anon31_Then_correct  (=> (and (<= 0 i_5) (< i_5 N)) (and (=> (= (ControlFlow 0 23) (- 0 26)) (>= i_5 0)) (=> (>= i_5 0) (and (=> (= (ControlFlow 0 23) (- 0 25)) (< i_5 (|Seq#Length| ar@@27))) (=> (< i_5 (|Seq#Length| ar@@27)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (HasDirectPerm QPMask@2 (|Seq#Index| ar@@27 i_5) Ref__Integer_value)) (=> (HasDirectPerm QPMask@2 (|Seq#Index| ar@@27 i_5) Ref__Integer_value) (=> (= (ControlFlow 0 23) 22) anon16_correct))))))))))
(let ((anon30_Else_correct true))
(let ((anon28_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 29)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 N))) (and (<= 0 i_3_1) (< i_3_1 N))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ar@@27 i_3) (|Seq#Index| ar@@27 i_3_1))))
 ...
 :qid |stdinbpl.1955:15|
 :skolemid |165|
)) (=> (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 N)) (< NoPerm FullPerm)) (and (qpRange10 (|Seq#Index| ar@@27 i_3@@1)) (= (invRecv10 (|Seq#Index| ar@@27 i_3@@1)) i_3@@1)))
 :qid |stdinbpl.1961:22|
 :skolemid |166|
 :pattern ( (|Seq#Index| ar@@27 i_3@@1))
 :pattern ( (|Seq#Index| ar@@27 i_3@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv10 o_3)) (< (invRecv10 o_3) N)) (< NoPerm FullPerm)) (qpRange10 o_3)) (= (|Seq#Index| ar@@27 (invRecv10 o_3)) o_3)))
 :qid |stdinbpl.1965:22|
 :skolemid |167|
 ...
 :pattern ( (|Seq#Index| ar@@27 i_3@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv10 o_3@@0)) (< (invRecv10 o_3@@0) N)) (< NoPerm FullPerm)) (qpRange10 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| ar@@27 (invRecv10 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 Ref__Integer_value)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 Ref__Integer_value)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv10 o_3@@0)) (< (invRecv10 o_3@@0) N)) (< NoPerm FullPerm)) (qpRange10 o_3@@0))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 Ref__Integer_value)) (U_2_real (MapType1Select ZeroMask o_3@@0 Ref__Integer_value))))))
...
(let ((anon29_Else_correct  (=> (and (not (and (<= 0 i_4) (< i_4 N))) (= (ControlFlow 0 20) 16)) anon12_correct)))
(let ((anon29_Then_correct  (=> (and (<= 0 i_4) (< i_4 N)) (and (=> (= (ControlFlow 0 17) (- 0 19)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 17) (- 0 18)) (< i_4 (|Seq#Length| ar@@27))) (=> (< i_4 (|Seq#Length| ar@@27)) (=> (= (ControlFlow 0 17) 16) anon12_correct))))))))
...
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 32)) (forall ((i_1 Int) (i_1_2 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_2)) (and (<= 0 i_1) (< i_1 N))) (and (<= 0 i_1_2) (< i_1_2 N))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ar@@27 i_1) (|Seq#Index| ar@@27 i_1_2))))
 ...
 :qid |stdinbpl.1898:15|
 :skolemid |159|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 N)) (< NoPerm FullPerm)) (and (qpRange9 (|Seq#Index| ar@@27 i_1@@1)) (= (invRecv9 (|Seq#Index| ar@@27 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.1904:22|
 :skolemid |160|
 :pattern ( (|Seq#Index| ar@@27 i_1@@1))
 :pattern ( (|Seq#Index| ar@@27 i_1@@1))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (<= 0 (invRecv9 o_3@@2)) (< (invRecv9 o_3@@2) N)) (< NoPerm FullPerm)) (qpRange9 o_3@@2)) (= (|Seq#Index| ar@@27 (invRecv9 o_3@@2)) o_3@@2)))
 ...
 :pattern ( (|Seq#Index| ar@@27 i_1@@2))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (and (<= 0 (invRecv9 o_3@@3)) (< (invRecv9 o_3@@3) N)) (< NoPerm FullPerm)) (qpRange9 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| ar@@27 (invRecv9 o_3@@3)) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 Ref__Integer_value)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 Ref__Integer_value)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv9 o_3@@3)) (< (invRecv9 o_3@@3) N)) (< NoPerm FullPerm)) (qpRange9 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 Ref__Integer_value)) (U_2_real (MapType1Select ZeroMask o_3@@3 Ref__Integer_value))))))
...
(let ((anon23_Else_correct  (=> (and (forall ((ix_1_1 Int) (jx_1_1 Int) ) (!  (=> (and (>= ix_1_1 0) (and (< ix_1_1 (|Seq#Length| ar@@27)) (and (>= jx_1_1 0) (and (< jx_1_1 (|Seq#Length| ar@@27)) (not (= ix_1_1 jx_1_1)))))) (not (= (|Seq#Index| ar@@27 ix_1_1) (|Seq#Index| ar@@27 jx_1_1))))
 :qid |stdinbpl.1880:20|
 :skolemid |158|
...
(let ((anon24_Else_correct  (=> (and (not (and (>= ix_7 0) (and (< ix_7 (|Seq#Length| ar@@27)) (and (>= jx_7 0) (and (< jx_7 (|Seq#Length| ar@@27)) (not (= ix_7 jx_7))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon24_Then_correct  (=> (and (>= ix_7 0) (and (< ix_7 (|Seq#Length| ar@@27)) (and (>= jx_7 0) (and (< jx_7 (|Seq#Length| ar@@27)) (not (= ix_7 jx_7)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= ix_7 0)) (=> (>= ix_7 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< ix_7 (|Seq#Length| ar@@27))) (=> (< ix_7 (|Seq#Length| ar@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= jx_7 0)) (=> (>= jx_7 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< jx_7 (|Seq#Length| ar@@27))) (=> (< jx_7 (|Seq#Length| ar@@27)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
