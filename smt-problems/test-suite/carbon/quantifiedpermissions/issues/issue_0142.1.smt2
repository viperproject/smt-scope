...
(assert  (and (and (= (type xs@@9) (SeqType RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@17) (MapType0Type RefType))))
(set-info :boogie-vc-id |fun#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon12_correct true))
(let ((anon21_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i1_4)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i2_4)) (not (= i1_4 i2_4))))) (= (ControlFlow 0 20) 17)) anon12_correct)))
(let ((anon21_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i1_4)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i2_4)) (not (= i1_4 i2_4)))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (not (= (|Seq#Index| xs@@9 i1_4) (|Seq#Index| xs@@9 i2_4)))) (=> (not (= (|Seq#Index| xs@@9 i1_4) (|Seq#Index| xs@@9 i2_4))) (=> (= (ControlFlow 0 18) 17) anon12_correct))))))
(let ((anon20_Else_correct  (=> (forall ((i1_5_1 Int) (i2_5_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i1_5_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i2_5_1)) (not (= i1_5_1 i2_5_1)))) (not (= (|Seq#Index| xs@@9 i1_5_1) (|Seq#Index| xs@@9 i2_5_1))))
 :qid |stdinbpl.738:24|
 :skolemid |71|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i1_5_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i2_5_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i1_5_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i2_5_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i1_5_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i2_5_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i1_5_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i2_5_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i1_5_1)) (|Seq#Index| xs@@9 i2_5_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i1_5_1)) (|Seq#Index| xs@@9 i2_5_1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i2_5_1)) (|Seq#Index| xs@@9 i1_5_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i2_5_1)) (|Seq#Index| xs@@9 i1_5_1))
 :pattern ( (|Seq#Index| xs@@9 i1_5_1) (|Seq#Index| xs@@9 i2_5_1))
)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((i_5 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5 i_5_1)) (and (<= 0 i_5) (< i_5 (|Seq#Length| xs@@9)))) (and (<= 0 i_5_1) (< i_5_1 (|Seq#Length| xs@@9)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@9 i_5) (|Seq#Index| xs@@9 i_5_1))))
 :qid |stdinbpl.749:21|
 :skolemid |72|
 :pattern ( (neverTriggered2 i_5) (neverTriggered2 i_5_1))
))) (=> (forall ((i_5@@0 Int) (i_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_5@@0 i_5_1@@0)) (and (<= 0 i_5@@0) (< i_5@@0 (|Seq#Length| xs@@9)))) (and (<= 0 i_5_1@@0) (< i_5_1@@0 (|Seq#Length| xs@@9)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@9 i_5@@0) (|Seq#Index| xs@@9 i_5_1@@0))))
 :qid |stdinbpl.749:21|
 :skolemid |72|
 :pattern ( (neverTriggered2 i_5@@0) (neverTriggered2 i_5_1@@0))
)) (=> (= (ControlFlow 0 15) (- 0 14)) (forall ((i_5@@1 Int) ) (!  (=> (and (<= 0 i_5@@1) (< i_5@@1 (|Seq#Length| xs@@9))) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs@@9 i_5@@1) f_7)) FullPerm))
 :qid |stdinbpl.756:21|
 :skolemid |73|
 :pattern ( (|Seq#Index| xs@@9 i_5@@1))
 :pattern ( (|Seq#Index| xs@@9 i_5@@1))
))))))))
(let ((anon19_Then_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (< 0 (|Seq#Length| xs@@9))) (=> (< 0 (|Seq#Length| xs@@9)) (and (and (=> (= (ControlFlow 0 21) 15) anon20_Else_correct) (=> (= (ControlFlow 0 21) 18) anon21_Then_correct)) (=> (= (ControlFlow 0 21) 20) anon21_Else_correct))))))
(let ((anon19_Else_correct true))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 23) (- 0 24)) (forall ((i_4 Int) (i_4_1 Int) ) (!  (=> (and (and (and (and (not (= i_4 i_4_1)) (and (<= 0 i_4) (< i_4 (|Seq#Length| xs@@9)))) (and (<= 0 i_4_1) (< i_4_1 (|Seq#Length| xs@@9)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@9 i_4) (|Seq#Index| xs@@9 i_4_1))))
 :qid |stdinbpl.688:15|
 :skolemid |65|
 ...
 :qid |stdinbpl.688:15|
 :skolemid |65|
)) (=> (forall ((i_4@@1 Int) ) (!  (=> (and (and (<= 0 i_4@@1) (< i_4@@1 (|Seq#Length| xs@@9))) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index| xs@@9 i_4@@1)) (= (invRecv1 (|Seq#Index| xs@@9 i_4@@1)) i_4@@1)))
 :qid |stdinbpl.694:22|
 :skolemid |66|
 :pattern ( (|Seq#Index| xs@@9 i_4@@1))
 :pattern ( (|Seq#Index| xs@@9 i_4@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv1 o_3)) (< (invRecv1 o_3) (|Seq#Length| xs@@9))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (|Seq#Index| xs@@9 (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.698:22|
 :skolemid |67|
 :pattern ( (invRecv1 o_3))
)) (forall ((i_4@@2 Int) ) (!  (=> (and (<= 0 i_4@@2) (< i_4@@2 (|Seq#Length| xs@@9))) (not (= (|Seq#Index| xs@@9 i_4@@2) null)))
 :qid |stdinbpl.704:22|
 :skolemid |68|
...
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (=> (= (ControlFlow 0 23) 21) anon19_Then_correct) (=> (= (ControlFlow 0 23) 13) anon19_Else_correct)))))))))
(let ((anon7_correct true))
(let ((anon18_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 (|Seq#Length| xs@@9)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon18_Then_correct  (=> (and (<= 0 i_2) (< i_2 (|Seq#Length| xs@@9))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_2 (|Seq#Length| xs@@9))) (=> (< i_2 (|Seq#Length| xs@@9)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon15_Else_correct  (=> (and (forall ((i1_3 Int) (i2_3 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i1_3)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i2_3)) (not (= i1_3 i2_3)))) (not (= (|Seq#Index| xs@@9 i1_3) (|Seq#Index| xs@@9 i2_3))))
 :qid |stdinbpl.670:20|
 :skolemid |64|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i1_3)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i2_3)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i1_3)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i2_3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i1_3)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i2_3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i1_3)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i2_3)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i1_3)) (|Seq#Index| xs@@9 i2_3))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i1_3)) (|Seq#Index| xs@@9 i2_3))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i2_3)) (|Seq#Index| xs@@9 i1_3))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i2_3)) (|Seq#Index| xs@@9 i1_3))
 :pattern ( (|Seq#Index| xs@@9 i1_3) (|Seq#Index| xs@@9 i2_3))
)) (state Heap@@17 ZeroMask)) (and (and (=> (= (ControlFlow 0 25) 23) anon17_Else_correct) (=> (= (ControlFlow 0 25) 9) anon18_Then_correct)) (=> (= (ControlFlow 0 25) 12) anon18_Else_correct)))))
(let ((anon3_correct true))
(let ((anon16_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i1_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i2_1)) (not (= i1_1 i2_1))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon16_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i1_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i2_1)) (not (= i1_1 i2_1)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_1 0)) (=> (>= i1_1 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_1 (|Seq#Length| xs@@9))) (=> (< i1_1 (|Seq#Length| xs@@9)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_1 0)) (=> (>= i2_1 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_1 (|Seq#Length| xs@@9))) (=> (< i2_1 (|Seq#Length| xs@@9)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) (= AssumeFunctionsAbove 0)) (and (< 0 (|Seq#Length| xs@@9)) (state Heap@@17 ZeroMask))) (and (and (=> (= (ControlFlow 0 26) 25) anon15_Else_correct) (=> (= (ControlFlow 0 26) 2) anon16_Then_correct)) (=> (= (ControlFlow 0 26) 7) anon16_Else_correct)))))
