...
(assert (= (type Heap@@20) (MapType0Type RefType)))
(set-info :boogie-vc-id m_void$$unreachable$opensqu$0$closesqu$)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@20 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (= (ControlFlow 0 2) (- 0 1))) false))))
