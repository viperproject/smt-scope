...
(assert  (and (and (and (and (and (and (and (= (type b_2@@7) (MapType2Type RefType boolType)) (= (type l) RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type l_1) RefType)) (= (type Heap@@10) (MapType0Type RefType))) (forall ((arg0@@47 T@U) ) (! (= (type (invRecv2 arg0@@47)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@47))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv1 arg0@@48)) RefType)
...
(let ((anon23_Else_correct  (=> (and (not (U_2_bool (MapType2Select b_2@@7 (MapType0Select Heap@@10 l_1 parent)))) (= (ControlFlow 0 14) 8)) anon14_correct)))
(let ((anon23_Then_correct  (=> (U_2_bool (MapType2Select b_2@@7 (MapType0Select Heap@@10 l_1 parent))) (and (=> (= (ControlFlow 0 10) (- 0 13)) (HasDirectPerm QPMask@1 l_1 parent)) (=> (HasDirectPerm QPMask@1 l_1 parent) (and (=> (= (ControlFlow 0 10) (- 0 12)) (HasDirectPerm QPMask@1 (MapType0Select Heap@@10 l_1 parent) rank)) (=> (HasDirectPerm QPMask@1 (MapType0Select Heap@@10 l_1 parent) rank) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm QPMask@1 l_1 rank)) (=> (HasDirectPerm QPMask@1 l_1 rank) (=> (= (ControlFlow 0 10) 8) anon14_correct))))))))))
(let ((anon22_Then_correct  (=> (and (U_2_bool (MapType2Select b_2@@7 l_1)) (not (= (MapType0Select Heap@@10 l_1 parent) null))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm QPMask@1 l_1 parent)) (=> (HasDirectPerm QPMask@1 l_1 parent) (and (=> (= (ControlFlow 0 15) 10) anon23_Then_correct) (=> (= (ControlFlow 0 15) 14) anon23_Else_correct)))))))
(let ((anon22_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select b_2@@7 l_1)) (not (= (MapType0Select Heap@@10 l_1 parent) null)))) (= (ControlFlow 0 9) 8)) anon14_correct)))
(let ((anon21_Else_correct  (=> (not (U_2_bool (MapType2Select b_2@@7 l_1))) (and (=> (= (ControlFlow 0 19) 15) anon22_Then_correct) (=> (= (ControlFlow 0 19) 9) anon22_Else_correct)))))
(let ((anon21_Then_correct  (=> (U_2_bool (MapType2Select b_2@@7 l_1)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm QPMask@1 l_1 parent)) (=> (HasDirectPerm QPMask@1 l_1 parent) (and (=> (= (ControlFlow 0 17) 15) anon22_Then_correct) (=> (= (ControlFlow 0 17) 9) anon22_Else_correct)))))))
(let ((anon20_Else_correct true))
(let ((anon18_Else_correct  (=> (forall ((l_7 T@U) ) (!  (=> (and (= (type l_7) RefType) (U_2_bool (MapType2Select b_2@@7 l_7))) (<= 0 (U_2_int (MapType0Select Heap@@10 l_7 rank))))
 :qid |stdinbpl.575:20|
 :skolemid |102|
 :pattern ( (MapType2Select b_2@@7 l_7))
)) (and (and (=> (= (ControlFlow 0 20) 7) anon20_Else_correct) (=> (= (ControlFlow 0 20) 17) anon21_Then_correct)) (=> (= (ControlFlow 0 20) 19) anon21_Else_correct)))))
(let ((anon7_correct true))
(let ((anon19_Else_correct  (=> (and (not (U_2_bool (MapType2Select b_2@@7 l))) (= (ControlFlow 0 6) 3)) anon7_correct)))
(let ((anon19_Then_correct  (=> (U_2_bool (MapType2Select b_2@@7 l)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm QPMask@1 l rank)) (=> (HasDirectPerm QPMask@1 l rank) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((l_5 T@U) (l_5_1 T@U) ) (!  (=> (and (= (type l_5) RefType) (= (type l_5_1) RefType)) (=> (and (and (and (and (not (= l_5 l_5_1)) (U_2_bool (MapType2Select b_2@@7 l_5))) (U_2_bool (MapType2Select b_2@@7 l_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= l_5 l_5_1))))
 :qid |stdinbpl.534:15|
 :skolemid |96|
 :no-pattern (type l_5)
 :no-pattern (type l_5_1)
 :no-pattern (U_2_int l_5)
 :no-pattern (U_2_bool l_5)
 :no-pattern (U_2_int l_5_1)
 :no-pattern (U_2_bool l_5_1)
))) (=> (forall ((l_5@@0 T@U) (l_5_1@@0 T@U) ) (!  (=> (and (= (type l_5@@0) RefType) (= (type l_5_1@@0) RefType)) (=> (and (and (and (and (not (= l_5@@0 l_5_1@@0)) (U_2_bool (MapType2Select b_2@@7 l_5@@0))) (U_2_bool (MapType2Select b_2@@7 l_5_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= l_5@@0 l_5_1@@0))))
 :qid |stdinbpl.534:15|
 :skolemid |96|
 :no-pattern (type l_5@@0)
 :no-pattern (type l_5_1@@0)
 :no-pattern (U_2_int l_5@@0)
 :no-pattern (U_2_bool l_5@@0)
 :no-pattern (U_2_int l_5_1@@0)
 :no-pattern (U_2_bool l_5_1@@0)
)) (=> (and (forall ((l_5@@1 T@U) ) (!  (=> (= (type l_5@@1) RefType) (=> (and (U_2_bool (MapType2Select b_2@@7 l_5@@1)) (< NoPerm FullPerm)) (and (qpRange2 l_5@@1) (= (invRecv2 l_5@@1) l_5@@1))))
 :qid |stdinbpl.540:22|
 :skolemid |97|
 :pattern ( (MapType0Select Heap@@10 l_5@@1 rank))
 :pattern ( (MapType1Select QPMask@1 l_5@@1 rank))
 :pattern ( (MapType2Select b_2@@7 l_5@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select b_2@@7 (invRecv2 o_3))) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.544:22|
 :skolemid |98|
 :pattern ( (invRecv2 o_3))
))) (=> (and (and (forall ((l_5@@2 T@U) ) (!  (=> (and (= (type l_5@@2) RefType) (U_2_bool (MapType2Select b_2@@7 l_5@@2))) (not (= l_5@@2 null)))
 :qid |stdinbpl.550:22|
 :skolemid |99|
 :pattern ( (MapType0Select Heap@@10 l_5@@2 rank))
 :pattern ( (MapType1Select QPMask@1 l_5@@2 rank))
 :pattern ( (MapType2Select b_2@@7 l_5@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select b_2@@7 (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 rank)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@0 rank)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select b_2@@7 (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 rank)) (U_2_real (MapType1Select QPMask@0 o_3@@0 rank))))))
 :qid |stdinbpl.556:22|
 :skolemid |100|
 :pattern ( (MapType1Select QPMask@1 o_3@@0 rank))
))) (and (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 rank))) (= (U_2_real (MapType1Select QPMask@0 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@1 o_3@@1 f_5))))))
 :qid |stdinbpl.560:29|
 :skolemid |101|
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@1 o_3@@1 f_5))
)) (state Heap@@10 QPMask@1))) (and (and (=> (= (ControlFlow 0 21) 20) anon18_Else_correct) (=> (= (ControlFlow 0 21) 4) anon19_Then_correct)) (=> (= (ControlFlow 0 21) 6) anon19_Else_correct))))))))
(let ((anon17_Then_correct true))
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 23) (- 0 24)) (forall ((l_3 T@U) (l_3_1 T@U) ) (!  (=> (and (= (type l_3) RefType) (= (type l_3_1) RefType)) (=> (and (and (and (and (not (= l_3 l_3_1)) (U_2_bool (MapType2Select b_2@@7 l_3))) (U_2_bool (MapType2Select b_2@@7 l_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= l_3 l_3_1))))
 :qid |stdinbpl.495:15|
 :skolemid |90|
 :no-pattern (type l_3)
 :no-pattern (type l_3_1)
 :no-pattern (U_2_int l_3)
 :no-pattern (U_2_bool l_3)
 :no-pattern (U_2_int l_3_1)
 :no-pattern (U_2_bool l_3_1)
))) (=> (forall ((l_3@@0 T@U) (l_3_1@@0 T@U) ) (!  (=> (and (= (type l_3@@0) RefType) (= (type l_3_1@@0) RefType)) (=> (and (and (and (and (not (= l_3@@0 l_3_1@@0)) (U_2_bool (MapType2Select b_2@@7 l_3@@0))) (U_2_bool (MapType2Select b_2@@7 l_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= l_3@@0 l_3_1@@0))))
 :qid |stdinbpl.495:15|
 :skolemid |90|
 :no-pattern (type l_3@@0)
 :no-pattern (type l_3_1@@0)
 :no-pattern (U_2_int l_3@@0)
 :no-pattern (U_2_bool l_3@@0)
 :no-pattern (U_2_int l_3_1@@0)
 :no-pattern (U_2_bool l_3_1@@0)
)) (=> (and (forall ((l_3@@1 T@U) ) (!  (=> (= (type l_3@@1) RefType) (=> (and (U_2_bool (MapType2Select b_2@@7 l_3@@1)) (< NoPerm FullPerm)) (and (qpRange1 l_3@@1) (= (invRecv1 l_3@@1) l_3@@1))))
 :qid |stdinbpl.501:22|
 :skolemid |91|
 :pattern ( (MapType0Select Heap@@10 l_3@@1 parent))
 :pattern ( (MapType1Select QPMask@0 l_3@@1 parent))
 :pattern ( (MapType2Select b_2@@7 l_3@@1))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType2Select b_2@@7 (invRecv1 o_3@@2))) (< NoPerm FullPerm)) (qpRange1 o_3@@2)) (= (invRecv1 o_3@@2) o_3@@2)))
 :qid |stdinbpl.505:22|
 :skolemid |92|
 :pattern ( (invRecv1 o_3@@2))
))) (=> (and (and (forall ((l_3@@2 T@U) ) (!  (=> (and (= (type l_3@@2) RefType) (U_2_bool (MapType2Select b_2@@7 l_3@@2))) (not (= l_3@@2 null)))
 :qid |stdinbpl.511:22|
 :skolemid |93|
 :pattern ( (MapType0Select Heap@@10 l_3@@2 parent))
 :pattern ( (MapType1Select QPMask@0 l_3@@2 parent))
 :pattern ( (MapType2Select b_2@@7 l_3@@2))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType2Select b_2@@7 (invRecv1 o_3@@3))) (< NoPerm FullPerm)) (qpRange1 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 parent)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 parent)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select b_2@@7 (invRecv1 o_3@@3))) (< NoPerm FullPerm)) (qpRange1 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 parent)) (U_2_real (MapType1Select ZeroMask o_3@@3 parent))))))
 :qid |stdinbpl.517:22|
 :skolemid |94|
 :pattern ( (MapType1Select QPMask@0 o_3@@3 parent))
))) (and (forall ((o_3@@4 T@U) (f_5@@0 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_5@@0))))
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 parent))) (= (U_2_real (MapType1Select ZeroMask o_3@@4 f_5@@0)) (U_2_real (MapType1Select QPMask@0 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.521:29|
 :skolemid |95|
 :pattern ( (MapType1Select ZeroMask o_3@@4 f_5@@0))
 :pattern ( (MapType1Select QPMask@0 o_3@@4 f_5@@0))
)) (state Heap@@10 QPMask@0))) (and (=> (= (ControlFlow 0 23) 2) anon17_Then_correct) (=> (= (ControlFlow 0 23) 21) anon17_Else_correct))))))))
(let ((anon16_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (and (=> (= (ControlFlow 0 25) 1) anon16_Then_correct) (=> (= (ControlFlow 0 25) 23) anon16_Else_correct)))))
