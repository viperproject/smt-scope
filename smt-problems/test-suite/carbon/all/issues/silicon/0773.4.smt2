...
(declare-fun |pre'| (T@U) Bool)
(declare-fun |pre#frame| (T@U) Bool)
(declare-fun |needsPre'| (T@U) Bool)
(declare-fun |needsPre#frame| (T@U) Bool)
...
(assert (forall ((Heap@@9 T@U) (Mask@@9 T@U) ) (!  (=> (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (state Heap@@9 Mask@@9)) (= (|pre'| Heap@@9) (|pre#frame| EmptyFrame)))
 :qid |stdinbpl.254:15|
 :skolemid |36|
 :pattern ( (state Heap@@9 Mask@@9) (|pre'| Heap@@9))
)))
(assert (forall ((Heap@@10 T@U) (Mask@@10 T@U) ) (!  (=> (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (state Heap@@10 Mask@@10)) (= (|needsPre'| Heap@@10) (|needsPre#frame| EmptyFrame)))
 :qid |stdinbpl.294:15|
 :skolemid |39|
 :pattern ( (state Heap@@10 Mask@@10) (|needsPre'| Heap@@10))
)))
(assert (forall ((Heap@@11 T@U) (ExhaleHeap@@7 T@U) (Mask@@11 T@U) (pm_f@@1 T@U) ) (! (let ((C@@1 (FieldTypeInv0 (type pm_f@@1))))
 (=> (and (and (and (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type ExhaleHeap@@7) (MapType0Type RefType))) (= (type Mask@@11) (MapType1Type RefType realType))) (= (type pm_f@@1) (FieldType C@@1 FrameTypeType))) (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@7 Mask@@11)) (and (HasDirectPerm Mask@@11 null pm_f@@1) (IsPredicateField pm_f@@1))) (forall ((o2 T@U) (f_2@@0 T@U) ) (! (let ((B@@6 (FieldTypeInv1 (type f_2@@0))))
(let ((A@@7 (FieldTypeInv0 (type f_2@@0))))
 (=> (and (and (= (type o2) RefType) (= (type f_2@@0) (FieldType A@@7 B@@6))) (U_2_bool (MapType1Select (MapType0Select Heap@@11 null (PredicateMaskField pm_f@@1)) o2 f_2@@0))) (= (MapType0Select Heap@@11 o2 f_2@@0) (MapType0Select ExhaleHeap@@7 o2 f_2@@0)))))
 :qid |stdinbpl.56:134|
 :skolemid |3|
 ...
 :qid |stdinbpl.54:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@7 Mask@@11) (IsPredicateField pm_f@@1))
)))
(assert (forall ((Heap@@12 T@U) (ExhaleHeap@@8 T@U) (Mask@@12 T@U) (pm_f@@2 T@U) ) (! (let ((C@@2 (FieldTypeInv0 (type pm_f@@2))))
 (=> (and (and (and (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type ExhaleHeap@@8) (MapType0Type RefType))) (= (type Mask@@12) (MapType1Type RefType realType))) (= (type pm_f@@2) (FieldType C@@2 FrameTypeType))) (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@8 Mask@@12)) (and (HasDirectPerm Mask@@12 null pm_f@@2) (IsWandField pm_f@@2))) (forall ((o2@@0 T@U) (f_2@@1 T@U) ) (! (let ((B@@7 (FieldTypeInv1 (type f_2@@1))))
(let ((A@@8 (FieldTypeInv0 (type f_2@@1))))
 (=> (and (and (= (type o2@@0) RefType) (= (type f_2@@1) (FieldType A@@8 B@@7))) (U_2_bool (MapType1Select (MapType0Select Heap@@12 null (WandMaskField pm_f@@2)) o2@@0 f_2@@1))) (= (MapType0Select Heap@@12 o2@@0 f_2@@1) (MapType0Select ExhaleHeap@@8 o2@@0 f_2@@1)))))
 :qid |stdinbpl.69:129|
 :skolemid |6|
 ...
 :qid |stdinbpl.67:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@@8 Mask@@12) (IsWandField pm_f@@2))
)))
(assert (forall ((Heap@@13 T@U) (ExhaleHeap@@9 T@U) (Mask@@13 T@U) (pm_f_1 T@U) ) (! (let ((C@@3 (FieldTypeInv0 (type pm_f_1))))
 (=> (and (and (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type ExhaleHeap@@9) (MapType0Type RefType))) (= (type Mask@@13) (MapType1Type RefType realType))) (= (type pm_f_1) (FieldType C@@3 FrameTypeType))) (IdenticalOnKnownLocationsLiberal Heap@@13 ExhaleHeap@@9 Mask@@13)) (and (HasDirectPerm Mask@@13 null pm_f_1) (IsPredicateField pm_f_1))) (forall ((o2_1 T@U) (f_4@@0 T@U) ) (! (let ((B@@8 (FieldTypeInv1 (type f_4@@0))))
(let ((A@@9 (FieldTypeInv0 (type f_4@@0))))
 (=> (and (and (= (type o2_1) RefType) (= (type f_4@@0) (FieldType A@@9 B@@8))) (U_2_bool (MapType1Select (MapType0Select Heap@@13 null (PredicateMaskField pm_f_1)) o2_1 f_4@@0))) (= (MapType0Select Heap@@13 o2_1 f_4@@0) (MapType0Select ExhaleHeap@@9 o2_1 f_4@@0)))))
 ...
 :qid |stdinbpl.118:19|
 :skolemid |18|
 :pattern ( (IdenticalOnKnownLocationsLiberal Heap@@13 ExhaleHeap@@9 Mask@@13) (IsPredicateField pm_f_1))
)))
(assert (forall ((Heap@@14 T@U) (ExhaleHeap@@10 T@U) (Mask@@14 T@U) (pm_f_1@@0 T@U) ) (! (let ((C@@4 (FieldTypeInv0 (type pm_f_1@@0))))
 (=> (and (and (and (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type ExhaleHeap@@10) (MapType0Type RefType))) (= (type Mask@@14) (MapType1Type RefType realType))) (= (type pm_f_1@@0) (FieldType C@@4 FrameTypeType))) (IdenticalOnKnownLocationsLiberal Heap@@14 ExhaleHeap@@10 Mask@@14)) (and (HasDirectPerm Mask@@14 null pm_f_1@@0) (IsWandField pm_f_1@@0))) (forall ((o2_1@@0 T@U) (f_4@@1 T@U) ) (! (let ((B@@9 (FieldTypeInv1 (type f_4@@1))))
(let ((A@@10 (FieldTypeInv0 (type f_4@@1))))
 (=> (and (and (= (type o2_1@@0) RefType) (= (type f_4@@1) (FieldType A@@10 B@@9))) (U_2_bool (MapType1Select (MapType0Select Heap@@14 null (WandMaskField pm_f_1@@0)) o2_1@@0 f_4@@1))) (= (MapType0Select Heap@@14 o2_1@@0 f_4@@1) (MapType0Select ExhaleHeap@@10 o2_1@@0 f_4@@1)))))
 ...
 :qid |stdinbpl.134:19|
 :skolemid |22|
 :pattern ( (IdenticalOnKnownLocationsLiberal Heap@@14 ExhaleHeap@@10 Mask@@14) (IsWandField pm_f_1@@0))
)))
...
(assert (forall ((Heap@@15 T@U) ) (!  (=> (= (type Heap@@15) (MapType0Type RefType)) (dummyFunction (bool_2_U |pre#triggerStateless|)))
 :qid |stdinbpl.247:15|
 :skolemid |35|
 :pattern ( (|pre'| Heap@@15))
)))
(assert (forall ((Heap@@16 T@U) ) (!  (=> (= (type Heap@@16) (MapType0Type RefType)) (dummyFunction (bool_2_U |needsPre#triggerStateless|)))
 :qid |stdinbpl.287:15|
 :skolemid |38|
 :pattern ( (|needsPre'| Heap@@16))
)))
...
(assert (forall ((Heap@@18 T@U) (o@@0 T@U) (f_3 T@U) (v T@U) ) (! (let ((B@@11 (type v)))
(let ((A@@12 (FieldTypeInv0 (type f_3))))
 (=> (and (and (= (type Heap@@18) (MapType0Type RefType)) (= (type o@@0) RefType)) (= (type f_3) (FieldType A@@12 B@@11))) (succHeap Heap@@18 (MapType0Store Heap@@18 o@@0 f_3 v)))))
 :qid |stdinbpl.80:22|
 :skolemid |9|
...
(assert (forall ((Heap@@19 T@U) (ExhaleHeap@@11 T@U) (Mask@@16 T@U) (pm_f_1@@1 T@U) ) (! (let ((C@@6 (FieldTypeInv0 (type pm_f_1@@1))))
 (=> (and (and (and (and (and (= (type Heap@@19) (MapType0Type RefType)) (= (type ExhaleHeap@@11) (MapType0Type RefType))) (= (type Mask@@16) (MapType1Type RefType realType))) (= (type pm_f_1@@1) (FieldType C@@6 FrameTypeType))) (IdenticalOnKnownLocationsLiberal Heap@@19 ExhaleHeap@@11 Mask@@16)) (and (HasDirectPerm Mask@@16 null pm_f_1@@1) (IsPredicateField pm_f_1@@1))) (forall ((o2_1@@1 T@U) (f_4@@2 T@U) ) (! (let ((B@@14 (FieldTypeInv1 (type f_4@@2))))
(let ((A@@15 (FieldTypeInv0 (type f_4@@2))))
 (=> (and (and (= (type o2_1@@1) RefType) (= (type f_4@@2) (FieldType A@@15 B@@14))) (U_2_bool (MapType1Select (MapType0Select Heap@@19 null (PredicateMaskField pm_f_1@@1)) o2_1@@1 f_4@@2))) (U_2_bool (MapType1Select (MapType0Select ExhaleHeap@@11 null (PredicateMaskField pm_f_1@@1)) o2_1@@1 f_4@@2)))))
 ...
 :qid |stdinbpl.110:19|
 :skolemid |16|
 :pattern ( (IdenticalOnKnownLocationsLiberal Heap@@19 ExhaleHeap@@11 Mask@@16) (IsPredicateField pm_f_1@@1) (MapType0Select ExhaleHeap@@11 null (PredicateMaskField pm_f_1@@1)))
)))
(assert (forall ((Heap@@20 T@U) (ExhaleHeap@@12 T@U) (Mask@@17 T@U) (pm_f_1@@2 T@U) ) (! (let ((C@@7 (FieldTypeInv0 (type pm_f_1@@2))))
 (=> (and (and (and (and (and (= (type Heap@@20) (MapType0Type RefType)) (= (type ExhaleHeap@@12) (MapType0Type RefType))) (= (type Mask@@17) (MapType1Type RefType realType))) (= (type pm_f_1@@2) (FieldType C@@7 FrameTypeType))) (IdenticalOnKnownLocationsLiberal Heap@@20 ExhaleHeap@@12 Mask@@17)) (and (HasDirectPerm Mask@@17 null pm_f_1@@2) (IsWandField pm_f_1@@2))) (forall ((o2_1@@2 T@U) (f_4@@3 T@U) ) (! (let ((B@@15 (FieldTypeInv1 (type f_4@@3))))
(let ((A@@16 (FieldTypeInv0 (type f_4@@3))))
 (=> (and (and (= (type o2_1@@2) RefType) (= (type f_4@@3) (FieldType A@@16 B@@15))) (U_2_bool (MapType1Select (MapType0Select Heap@@20 null (WandMaskField pm_f_1@@2)) o2_1@@2 f_4@@3))) (U_2_bool (MapType1Select (MapType0Select ExhaleHeap@@12 null (WandMaskField pm_f_1@@2)) o2_1@@2 f_4@@3)))))
 ...
 :qid |stdinbpl.126:19|
 :skolemid |20|
 :pattern ( (IdenticalOnKnownLocationsLiberal Heap@@20 ExhaleHeap@@12 Mask@@17) (IsWandField pm_f_1@@2) (MapType0Select ExhaleHeap@@12 null (WandMaskField pm_f_1@@2)))
)))
(assert (forall ((Heap@@21 T@U) ) (!  (=> (= (type Heap@@21) (MapType0Type RefType)) (and (= (pre Heap@@21) (|pre'| Heap@@21)) (dummyFunction (bool_2_U |pre#triggerStateless|))))
 :qid |stdinbpl.243:15|
 :skolemid |34|
 :pattern ( (pre Heap@@21))
)))
(assert (forall ((Heap@@22 T@U) ) (!  (=> (= (type Heap@@22) (MapType0Type RefType)) (and (= (needsPre Heap@@22) (|needsPre'| Heap@@22)) (dummyFunction (bool_2_U |needsPre#triggerStateless|))))
 :qid |stdinbpl.283:15|
 :skolemid |37|
 :pattern ( (needsPre Heap@@22))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
...
(let ((anon9_correct  (=> (state Heap@@23 ZeroMask) (and (=> (= (ControlFlow 0 7) 5) anon16_Then_correct) (=> (= (ControlFlow 0 7) 6) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (not (needsPre Heap@@23)) (=> (and (state Heap@@23 ZeroMask) (= (ControlFlow 0 9) 7)) anon9_correct))))
(let ((anon15_Then_correct  (=> (needsPre Heap@@23) (=> (and (state Heap@@23 ZeroMask) (= (ControlFlow 0 8) 7)) anon9_correct))))
(let ((anon14_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (pre Heap@@23))))
(let ((anon13_Else_correct  (=> (and (and (pre Heap@@23) (state Heap@@23 ZeroMask)) (and (state Heap@@23 ZeroMask) (state Heap@@23 ZeroMask))) (and (and (=> (= (ControlFlow 0 10) 4) anon14_Then_correct) (=> (= (ControlFlow 0 10) 8) anon15_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon15_Else_correct)))))
(let ((anon13_Then_correct true))
(let ((anon12_Else_correct  (=> (and (and (state Heap@@23 ZeroMask) (state Heap@@23 ZeroMask)) (and (state Heap@@23 ZeroMask) (state Heap@@23 ZeroMask))) (and (=> (= (ControlFlow 0 11) 2) anon13_Then_correct) (=> (= (ControlFlow 0 11) 10) anon13_Else_correct)))))
(let ((anon12_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@23 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (state Heap@@23 ZeroMask)) (and (=> (= (ControlFlow 0 12) 1) anon12_Then_correct) (=> (= (ControlFlow 0 12) 11) anon12_Else_correct))))))
