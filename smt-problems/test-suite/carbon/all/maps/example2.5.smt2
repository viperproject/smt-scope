...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon2_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (<= (U_2_int (MapType0Select (|Map#Elements| m@@23) (int_2_U 20))) 0) (< 0 (U_2_int (MapType0Select (|Map#Elements| m@@23) (int_2_U 20))))))))
(let ((anon3_Else_correct  (=> (and (<= (U_2_int (MapType0Select (|Map#Elements| m@@23) (int_2_U 20))) 0) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (<= (U_2_int (MapType0Select (|Map#Elements| m@@23) (int_2_U 20))) 0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 20)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 20))) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 20))) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 20)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 20))) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))))
