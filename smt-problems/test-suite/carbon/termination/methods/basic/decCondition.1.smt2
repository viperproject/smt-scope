...
(let ((anon4_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (= arg_x@0 (- x@@8 1)) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 10) 8))) anon5_correct))))
(let ((anon12_Else_correct  (=> (and (> 0 x@@8) (= (ControlFlow 0 13) 10)) anon4_correct)))
(let ((anon12_Then_correct  (=> (>= x@@8 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (and (decreasing (int_2_U (- x@@8 1)) (int_2_U x@@8)) (bounded (int_2_U x@@8)))) (=> (and (decreasing (int_2_U (- x@@8 1)) (int_2_U x@@8)) (bounded (int_2_U x@@8))) (=> (= (ControlFlow 0 11) 10) anon4_correct))))))
(let ((anon11_Then_correct  (=> (not (= x@@8 0)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (or (not (>= x@@8 0)) (>= (- x@@8 1) 0))) (=> (or (not (>= x@@8 0)) (>= (- x@@8 1) 0)) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 14) 11) anon12_Then_correct) (=> (= (ControlFlow 0 14) 13) anon12_Else_correct))))))))
