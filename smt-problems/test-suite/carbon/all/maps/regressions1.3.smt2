...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (= m@0 (|Map#Empty| intType intType))) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (not (= (|Map#Card| m@0) 0)))))
