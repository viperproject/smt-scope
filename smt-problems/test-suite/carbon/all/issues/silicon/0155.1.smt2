...
(declare-fun |i'| (T@U T@U Int Bool) Bool)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |i#triggerStateless| (T@U Int Bool) Bool)
...
(declare-fun |i#frame| (T@U T@U Int Bool) Bool)
...
(assert (forall ((Heap@@0 T@U) (this T@U) (x@@8 Int) (y@@1 Bool) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type this) RefType)) (dummyFunction (bool_2_U (|i#triggerStateless| this x@@8 y@@1))))
 :qid |stdinbpl.197:15|
 :skolemid |23|
 :pattern ( (|i'| Heap@@0 this x@@8 y@@1))
)))
...
(assert (forall ((Heap@@3 T@U) (this@@0 T@U) (x@@9 Int) (y@@2 Bool) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type this@@0) RefType)) (and (= (i Heap@@3 this@@0 x@@9 y@@2) (|i'| Heap@@3 this@@0 x@@9 y@@2)) (dummyFunction (bool_2_U (|i#triggerStateless| this@@0 x@@9 y@@2)))))
 :qid |stdinbpl.193:15|
 :skolemid |22|
 :pattern ( (i Heap@@3 this@@0 x@@9 y@@2))
)))
...
(assert (forall ((Heap@@8 T@U) (Mask@@6 T@U) (this@@5 T@U) (x@@10 Int) (y@@3 Bool) ) (!  (=> (and (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (= (type this@@5) RefType)) (state Heap@@8 Mask@@6)) (= (|i'| Heap@@8 this@@5 x@@10 y@@3) (|i#frame| (MapType0Select Heap@@8 null (valid this@@5)) this@@5 x@@10 y@@3)))
 :qid |stdinbpl.210:15|
 :skolemid |25|
 :pattern ( (state Heap@@8 Mask@@6) (|i'| Heap@@8 this@@5 x@@10 y@@3))
 :pattern ( (state Heap@@8 Mask@@6) (|i#triggerStateless| this@@5 x@@10 y@@3) (|valid#trigger| Heap@@8 (valid this@@5)))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@13 T@U) (Mask@@10 T@U) (this@@8 T@U) (x@@11 Int) (y@@4 Bool) ) (!  (=> (and (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type this@@8) RefType)) (and (state Heap@@13 Mask@@10) (< AssumeFunctionsAbove 0))) (not (= this@@8 null))) (= (i Heap@@13 this@@8 x@@11 y@@4) (|i'| Heap@@13 (MapType0Select Heap@@13 this@@8 next) x@@11 y@@4)))
 :qid |stdinbpl.203:15|
 :skolemid |24|
 :pattern ( (state Heap@@13 Mask@@10) (i Heap@@13 this@@8 x@@11 y@@4))
 :pattern ( (state Heap@@13 Mask@@10) (|i#triggerStateless| this@@8 x@@11 y@@4) (|valid#trigger| Heap@@13 (valid this@@8)))
)))
(push 1)
...
(assert  (and (and (and (and (and (= (type this@@9) RefType) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@14) (MapType0Type RefType))) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id triggersSix$)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon14_Else_correct true))
(let ((anon14_Then_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (not (= this@@9 null))) (=> (not (= this@@9 null)) (=> (= (ControlFlow 0 11) (- 0 10)) (> (U_2_real (MapType1Select PostMask@0 null (valid this@@9))) NoPerm))))))
(let ((anon13_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (= PostMask@0 (MapType1Store ZeroMask null (valid this@@9) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid this@@9))) FullPerm)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 14) 11) anon14_Then_correct) (=> (= (ControlFlow 0 14) 13) anon14_Else_correct))))))
(let ((anon10_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 null (valid this@@9) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid this@@9))) FullPerm)))) (= (ControlFlow 0 6) (- 0 5))) (i Heap@@14 this@@9 4 true))))
(let ((anon15_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon10_correct)))
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid this@@9))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid this@@9)))) (=> (= (ControlFlow 0 7) 6) anon10_correct))))))
(let ((anon11_Else_correct  (=> (and (forall ((x_1 Int) (fresh__0_1 Bool) ) (! (i Heap@@14 this@@9 x_1 (> c d))
 :qid |stdinbpl.439:20|
 :skolemid |33|
 :pattern ( (|i#frame| (MapType0Select Heap@@14 null (valid this@@9)) this@@9 x_1 fresh__0_1))
)) (state Heap@@14 Mask@0)) (and (and (=> (= (ControlFlow 0 15) 14) anon13_Then_correct) (=> (= (ControlFlow 0 15) 7) anon15_Then_correct)) (=> (= (ControlFlow 0 15) 9) anon15_Else_correct)))))
(let ((anon12_Else_correct true))
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (= this@@9 null))) (=> (not (= this@@9 null)) (=> (= (ControlFlow 0 2) (- 0 1)) (> (U_2_real (MapType1Select Mask@0 null (valid this@@9))) NoPerm))))))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@14 this@@9 $allocated))) (=> (and (and (and (not (= this@@9 null)) (state Heap@@14 ZeroMask)) (and (> c d) (state Heap@@14 ZeroMask))) (and (and (= Mask@0 (MapType1Store ZeroMask null (valid this@@9) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid this@@9))) FullPerm)))) (state Heap@@14 Mask@0)) (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0)))) (and (and (=> (= (ControlFlow 0 16) 15) anon11_Else_correct) (=> (= (ControlFlow 0 16) 2) anon12_Then_correct)) (=> (= (ControlFlow 0 16) 4) anon12_Else_correct)))))))
