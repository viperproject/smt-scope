...
(assert  (and (= (type nodes@@6) (MapType2Type RefType boolType)) (= (type Heap@@11) (MapType0Type RefType))))
(set-info :boogie-vc-id |GRAPH#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((n_2 T@U) (n_2_1 T@U) ) (!  (=> (and (= (type n_2) RefType) (= (type n_2_1) RefType)) (=> (and (and (and (and (not (= n_2 n_2_1)) (U_2_bool (MapType2Select nodes@@6 n_2))) (U_2_bool (MapType2Select nodes@@6 n_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_2 n_2_1))))
 :qid |stdinbpl.888:15|
 :skolemid |131|
 :no-pattern (type n_2)
...
(let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
