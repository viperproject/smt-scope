...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@14 x@@34 $allocated)) (= (ControlFlow 0 2) (- 0 1)))) (>= p_1@@5 NoPerm))))
