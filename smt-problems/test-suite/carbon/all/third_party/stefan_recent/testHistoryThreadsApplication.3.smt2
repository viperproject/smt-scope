...
(assert  (and (and (and (and (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type diz@@169) RefType)) (= (type proc@@11) ProcessDomainTypeType)) (= (type PostMask@1) (MapType1Type RefType realType))) (= (type PostMask@2) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@@44) (MapType0Type RefType))) (= (type PostMask@3) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id History__incr_begin)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon11_Else_correct true))
(let ((anon11_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (not (= frac@@11 NoPerm)) (state PostHeap@0 ZeroMask)) (and (= PostMask@0 (MapType1Store ZeroMask null (History__hist_do_incr diz@@169 frac@@11 proc@@11) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (History__hist_do_incr diz@@169 frac@@11 proc@@11))) FullPerm)))) (state PostHeap@0 PostMask@0))) (=> (and (and (and (state PostHeap@0 PostMask@0) (not (= diz@@169 null))) (and (= PostMask@1 (MapType1Store PostMask@0 diz@@169 History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select PostMask@0 diz@@169 History__x_hist_value)) FullPerm)))) (state PostHeap@0 PostMask@1))) (and (and (state PostHeap@0 PostMask@1) (not (= diz@@169 null))) (and (= PostMask@2 (MapType1Store PostMask@1 diz@@169 History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select PostMask@1 diz@@169 History__x_hist_mode)) FullPerm)))) (state PostHeap@0 PostMask@2)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (HasDirectPerm PostMask@2 diz@@169 History__x_hist_mode)) (=> (HasDirectPerm PostMask@2 diz@@169 History__x_hist_mode) (=> (and (= (U_2_int (MapType0Select PostHeap@0 diz@@169 History__x_hist_mode)) 2) (state PostHeap@0 PostMask@2)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm PostMask@2 diz@@169 History__x_hist_value)) (=> (HasDirectPerm PostMask@2 diz@@169 History__x_hist_value) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@2 diz@@169 History__x_hist_value)) (=> (HasDirectPerm Mask@2 diz@@169 History__x_hist_value) (=> (and (= (U_2_int (MapType0Select PostHeap@0 diz@@169 History__x_hist_value)) (U_2_int (MapType0Select Heap@@44 diz@@169 History__x_hist_value))) (state PostHeap@0 PostMask@2)) (=> (and (and (not (= diz@@169 null)) (= PostMask@3 (MapType1Store PostMask@2 diz@@169 History__x_hist_act (real_2_U (+ (U_2_real (MapType1Select PostMask@2 diz@@169 History__x_hist_act)) FullPerm))))) (and (state PostHeap@0 PostMask@3) (state PostHeap@0 PostMask@3))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm PostMask@3 diz@@169 History__x_hist_value)) (=> (HasDirectPerm PostMask@3 diz@@169 History__x_hist_value) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm PostMask@3 diz@@169 History__x_hist_act))))))))))))))))))
(let ((anon0_correct  (=> (state Heap@@44 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@44 diz@@169 $allocated))) (=> (and (and (and (and (not (= diz@@169 null)) (state Heap@@44 ZeroMask)) (and (>= current_thread_id 0) (state Heap@@44 ZeroMask))) (and (and (not (= frac@@11 NoPerm)) (state Heap@@44 ZeroMask)) (and (= Mask@0 (MapType1Store ZeroMask null (History__hist_idle diz@@169 frac@@11 proc@@11) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (History__hist_idle diz@@169 frac@@11 proc@@11))) FullPerm)))) (state Heap@@44 Mask@0)))) (and (and (and (state Heap@@44 Mask@0) (not (= diz@@169 null))) (and (= Mask@1 (MapType1Store Mask@0 diz@@169 History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select Mask@0 diz@@169 History__x_hist_value)) FullPerm)))) (state Heap@@44 Mask@1))) (and (and (state Heap@@44 Mask@1) (not (= diz@@169 null))) (and (= Mask@2 (MapType1Store Mask@1 diz@@169 History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select Mask@1 diz@@169 History__x_hist_mode)) FullPerm)))) (state Heap@@44 Mask@2))))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm Mask@2 diz@@169 History__x_hist_mode)) (=> (HasDirectPerm Mask@2 diz@@169 History__x_hist_mode) (=> (and (= (U_2_int (MapType0Select Heap@@44 diz@@169 History__x_hist_mode)) 1) (state Heap@@44 Mask@2)) (and (=> (= (ControlFlow 0 9) 2) anon11_Then_correct) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct))))))))))
...
(declare-fun Heap@@44 () T@U)
(declare-fun diz@@169 () T@U)
(declare-fun __flatten_37 () T@U)
(declare-fun __flatten_105 () T@U)
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type sys__result) RefType)) (forall ((arg0@@85 T@U) ) (! (= (type (type_of arg0@@85)) TYPEDomainTypeType)
 :qid |funType:type_of|
 :pattern ( (type_of arg0@@85))
))) (= (type class_SubjectLock) TYPEDomainTypeType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type Heap@@44) (MapType0Type RefType))) (= (type diz@@169) RefType)) (= (type __flatten_37) RefType)) (= (type __flatten_105) RefType)) (= (type freshObj@0) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type s) RefType)) (= (type AssertMask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id SubjectLock__SubjectLock)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon3_Else_correct  (=> (U_2_bool (MapType0Select Heap@@44 diz@@169 $allocated)) (=> (and (and (U_2_bool (MapType0Select Heap@@44 __flatten_37 $allocated)) (U_2_bool (MapType0Select Heap@@44 __flatten_105 $allocated))) (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@44 freshObj@0 $allocated))))) (=> (and (and (and (= Heap@0 (MapType0Store Heap@@44 freshObj@0 $allocated (bool_2_U true))) (= Mask@0 (MapType1Store ZeroMask freshObj@0 SubjectLock__subject (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 SubjectLock__subject)) FullPerm))))) (and (state Heap@0 Mask@0) (= (type_of freshObj@0) class_SubjectLock))) (and (and (state Heap@0 Mask@0) (state Heap@0 Mask@0)) (and (state Heap@0 Mask@0) (state Heap@0 Mask@0)))) (and (=> (= (ControlFlow 0 4) (- 0 13)) (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 SubjectLock__subject)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 SubjectLock__subject))) (=> (= Heap@1 (MapType0Store Heap@0 freshObj@0 SubjectLock__subject s)) (=> (and (state Heap@1 Mask@0) (state Heap@1 Mask@0)) (and (=> (= (ControlFlow 0 4) (- 0 12)) (not (= freshObj@0 null))) (=> (not (= freshObj@0 null)) (and (=> (= (ControlFlow 0 4) (- 0 11)) (= (type_of freshObj@0) class_SubjectLock)) (=> (= (type_of freshObj@0) class_SubjectLock) (and (=> (= (ControlFlow 0 4) (- 0 10)) (> (U_2_real (MapType1Select Mask@0 freshObj@0 SubjectLock__subject)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@0 freshObj@0 SubjectLock__subject)) NoPerm) (=> (> wildcard@1 NoPerm) (=> (and (< wildcard@1 (U_2_real (MapType1Select Mask@0 freshObj@0 SubjectLock__subject))) (= AssertMask@0 (MapType1Store Mask@0 freshObj@0 SubjectLock__subject (real_2_U (- (U_2_real (MapType1Select Mask@0 freshObj@0 SubjectLock__subject)) wildcard@1))))) (and (=> (= (ControlFlow 0 4) (- 0 9)) (HasDirectPerm Mask@0 freshObj@0 SubjectLock__subject)) (=> (HasDirectPerm Mask@0 freshObj@0 SubjectLock__subject) (=> (= (ControlFlow 0 4) (- 0 8)) (= (MapType0Select Heap@1 freshObj@0 SubjectLock__subject) s)))))))))))))))))))))
(let ((anon3_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (not (= sys__result null)) (state PostHeap@0 ZeroMask)) (=> (and (and (and (= (type_of sys__result) class_SubjectLock) (state PostHeap@0 ZeroMask)) (and (> wildcard@0 NoPerm) (not (= sys__result null)))) (and (and (= PostMask@0 (MapType1Store ZeroMask sys__result SubjectLock__subject (real_2_U (+ (U_2_real (MapType1Select ZeroMask sys__result SubjectLock__subject)) wildcard@0)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm PostMask@0 sys__result SubjectLock__subject))))))
(let ((anon0_correct  (=> (state Heap@@44 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@44 s $allocated))) (and (>= current_thread_id 0) (state Heap@@44 ZeroMask))) (and (=> (= (ControlFlow 0 14) 2) anon3_Then_correct) (=> (= (ControlFlow 0 14) 4) anon3_Else_correct))))))
...
(let ((anon0_correct  (=> (and (and (state Heap@@44 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (>= current_thread_id 0) (state Heap@@44 ZeroMask))) (and (=> (= (ControlFlow 0 7) 1) anon3_Then_correct) (=> (= (ControlFlow 0 7) 3) anon3_Else_correct)))))
...
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(set-info :boogie-vc-id Worker__if_any_random)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
