...
(assert  (and (and (and (and (and (and (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type x_2) RefType)) (= (type y@@2) RefType)) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type z_6) RefType)) (forall ((arg0@@35 T@U) ) (! (= (type (invRecv8 arg0@@35)) RefType)
 :qid |funType:invRecv8|
 :pattern ( (invRecv8 arg0@@35))
))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@36 T@U) ) (! (= (type (invRecv7 arg0@@36)) RefType)
 :qid |funType:invRecv7|
 :pattern ( (invRecv7 arg0@@36))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@37 T@U) ) (! (= (type (invRecv6 arg0@@37)) RefType)
 :qid |funType:invRecv6|
 :pattern ( (invRecv6 arg0@@37))
))))
...
(let ((anon15_Else_correct  (=> (and (not (or (= z_6 x_2) (= z_6 y@@2))) (= (ControlFlow 0 12) 8)) anon9_correct)))
(let ((anon15_Then_correct  (=> (or (= z_6 x_2) (= z_6 y@@2)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (HasDirectPerm QPMask@2 z_6 f_7)) (=> (HasDirectPerm QPMask@2 z_6 f_7) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm QPMask@2 z_6 g)) (=> (HasDirectPerm QPMask@2 z_6 g) (=> (= (ControlFlow 0 9) 8) anon9_correct))))))))
(let ((anon14_Else_correct  (=> (and (forall ((z_7 T@U) ) (!  (=> (and (= (type z_7) RefType) (or (= z_7 x_2) (= z_7 y@@2))) (> (+ (U_2_int (MapType0Select Heap@@13 z_7 f_7)) (U_2_int (MapType0Select Heap@@13 z_7 g))) 0))
 :qid |stdinbpl.1326:20|
 :skolemid |113|
 :pattern ( (fun01 z_7) (MapType0Select Heap@@13 z_7 f_7) (MapType0Select Heap@@13 z_7 g))
)) (state Heap@@13 QPMask@2)) (=> (and (and (state Heap@@13 QPMask@2) (fun01 x_2)) (and (state Heap@@13 QPMask@2) (state Heap@@13 QPMask@2))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (HasDirectPerm QPMask@2 x_2 f_7)) (=> (HasDirectPerm QPMask@2 x_2 f_7) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm QPMask@2 x_2 g)) (=> (HasDirectPerm QPMask@2 x_2 g) (=> (= (ControlFlow 0 5) (- 0 4)) (> (+ (U_2_int (MapType0Select Heap@@13 x_2 f_7)) (U_2_int (MapType0Select Heap@@13 x_2 g))) 0))))))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((z_5 T@U) (z_5_1 T@U) ) (!  (=> (and (= (type z_5) RefType) (= (type z_5_1) RefType)) (=> (and (and (and (and (not (= z_5 z_5_1)) (= z_5 y@@2)) (= z_5_1 y@@2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_5 z_5_1))))
...
))) (=> (forall ((z_5@@0 T@U) (z_5_1@@0 T@U) ) (!  (=> (and (= (type z_5@@0) RefType) (= (type z_5_1@@0) RefType)) (=> (and (and (and (and (not (= z_5@@0 z_5_1@@0)) (= z_5@@0 y@@2)) (= z_5_1@@0 y@@2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_5@@0 z_5_1@@0))))
 :qid |stdinbpl.1271:15|
 :skolemid |107|
...
)) (=> (and (and (forall ((z_5@@1 T@U) ) (!  (=> (= (type z_5@@1) RefType) (=> (and (= z_5@@1 y@@2) (< NoPerm FullPerm)) (and (qpRange8 z_5@@1) (= (invRecv8 z_5@@1) z_5@@1))))
 :qid |stdinbpl.1277:22|
 :skolemid |108|
 :pattern ( (MapType0Select Heap@@13 z_5@@1 g))
 :pattern ( (MapType1Select QPMask@2 z_5@@1 g))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (= (invRecv8 o_3) y@@2) (< NoPerm FullPerm)) (qpRange8 o_3)) (= (invRecv8 o_3) o_3)))
 :qid |stdinbpl.1281:22|
 :skolemid |109|
 :pattern ( (invRecv8 o_3))
))) (and (forall ((z_5@@2 T@U) ) (!  (=> (and (= (type z_5@@2) RefType) (= z_5@@2 y@@2)) (not (= z_5@@2 null)))
 :qid |stdinbpl.1287:22|
 :skolemid |110|
 :pattern ( (MapType0Select Heap@@13 z_5@@2 g))
 :pattern ( (MapType1Select QPMask@2 z_5@@2 g))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (= (invRecv8 o_3@@0) y@@2) (< NoPerm FullPerm)) (qpRange8 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv8 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 g)) (+ (U_2_real (MapType1Select QPMask@1 o_3@@0 g)) FullPerm)))) (=> (not (and (and (= (invRecv8 o_3@@0) y@@2) (< NoPerm FullPerm)) (qpRange8 o_3@@0))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 g)) (U_2_real (MapType1Select QPMask@1 o_3@@0 g))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 g))) (= (U_2_real (MapType1Select QPMask@1 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@2 o_3@@1 f_5))))))
 :qid |stdinbpl.1297:29|
 :skolemid |112|
 :pattern ( (MapType1Select QPMask@1 o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@2 o_3@@1 f_5))
)) (state Heap@@13 QPMask@2)) (and (state Heap@@13 QPMask@2) (state Heap@@13 QPMask@2))) (and (and (not (= x_2 null)) (not (= y@@2 null))) (and (state Heap@@13 QPMask@2) (state Heap@@13 QPMask@2)))) (and (and (=> (= (ControlFlow 0 13) 5) anon14_Else_correct) (=> (= (ControlFlow 0 13) 9) anon15_Then_correct)) (=> (= (ControlFlow 0 13) 12) anon15_Else_correct))))))))
(let ((anon13_Then_correct true))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((z_3 T@U) (z_3_1 T@U) ) (!  (=> (and (= (type z_3) RefType) (= (type z_3_1) RefType)) (=> (and (and (and (and (not (= z_3 z_3_1)) (= z_3 x_2)) (= z_3_1 x_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_3 z_3_1))))
...
))) (=> (forall ((z_3@@0 T@U) (z_3_1@@0 T@U) ) (!  (=> (and (= (type z_3@@0) RefType) (= (type z_3_1@@0) RefType)) (=> (and (and (and (and (not (= z_3@@0 z_3_1@@0)) (= z_3@@0 x_2)) (= z_3_1@@0 x_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_3@@0 z_3_1@@0))))
 :qid |stdinbpl.1228:15|
 :skolemid |101|
...
)) (=> (and (and (and (forall ((z_3@@1 T@U) ) (!  (=> (= (type z_3@@1) RefType) (=> (and (= z_3@@1 x_2) (< NoPerm FullPerm)) (and (qpRange7 z_3@@1) (= (invRecv7 z_3@@1) z_3@@1))))
 :qid |stdinbpl.1234:22|
 :skolemid |102|
 :pattern ( (MapType0Select Heap@@13 z_3@@1 g))
 :pattern ( (MapType1Select QPMask@1 z_3@@1 g))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (= (invRecv7 o_3@@2) x_2) (< NoPerm FullPerm)) (qpRange7 o_3@@2)) (= (invRecv7 o_3@@2) o_3@@2)))
 :qid |stdinbpl.1238:22|
 :skolemid |103|
 :pattern ( (invRecv7 o_3@@2))
))) (and (forall ((z_3@@2 T@U) ) (!  (=> (and (= (type z_3@@2) RefType) (= z_3@@2 x_2)) (not (= z_3@@2 null)))
 :qid |stdinbpl.1244:22|
 :skolemid |104|
 :pattern ( (MapType0Select Heap@@13 z_3@@2 g))
 :pattern ( (MapType1Select QPMask@1 z_3@@2 g))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (= (invRecv7 o_3@@3) x_2) (< NoPerm FullPerm)) (qpRange7 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv7 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 g)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@3 g)) FullPerm)))) (=> (not (and (and (= (invRecv7 o_3@@3) x_2) (< NoPerm FullPerm)) (qpRange7 o_3@@3))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 g)) (U_2_real (MapType1Select QPMask@0 o_3@@3 g))))))
...
)) (state Heap@@13 QPMask@1)) (and (state Heap@@13 QPMask@1) (state Heap@@13 QPMask@1)))) (and (=> (= (ControlFlow 0 15) 3) anon13_Then_correct) (=> (= (ControlFlow 0 15) 13) anon13_Else_correct)))))))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (or (= z_1 x_2) (= z_1 y@@2))) (or (= z_1_1 x_2) (= z_1_1 y@@2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1))))
...
))) (=> (forall ((z_1@@0 T@U) (z_1_1@@0 T@U) ) (!  (=> (and (= (type z_1@@0) RefType) (= (type z_1_1@@0) RefType)) (=> (and (and (and (and (not (= z_1@@0 z_1_1@@0)) (or (= z_1@@0 x_2) (= z_1@@0 y@@2))) (or (= z_1_1@@0 x_2) (= z_1_1@@0 y@@2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1@@0 z_1_1@@0))))
 :qid |stdinbpl.1185:15|
 :skolemid |95|
...
)) (=> (and (and (and (forall ((z_1@@1 T@U) ) (!  (=> (= (type z_1@@1) RefType) (=> (and (or (= z_1@@1 x_2) (= z_1@@1 y@@2)) (< NoPerm FullPerm)) (and (qpRange6 z_1@@1) (= (invRecv6 z_1@@1) z_1@@1))))
 :qid |stdinbpl.1191:22|
 :skolemid |96|
 :pattern ( (MapType0Select Heap@@13 z_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@1 f_7))
)) (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (or (= (invRecv6 o_3@@5) x_2) (= (invRecv6 o_3@@5) y@@2)) (< NoPerm FullPerm)) (qpRange6 o_3@@5)) (= (invRecv6 o_3@@5) o_3@@5)))
 :qid |stdinbpl.1195:22|
 :skolemid |97|
 :pattern ( (invRecv6 o_3@@5))
))) (and (forall ((z_1@@2 T@U) ) (!  (=> (and (= (type z_1@@2) RefType) (or (= z_1@@2 x_2) (= z_1@@2 y@@2))) (not (= z_1@@2 null)))
 :qid |stdinbpl.1201:22|
 :skolemid |98|
 :pattern ( (MapType0Select Heap@@13 z_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@2 f_7))
)) (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (or (= (invRecv6 o_3@@6) x_2) (= (invRecv6 o_3@@6) y@@2)) (< NoPerm FullPerm)) (qpRange6 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv6 o_3@@6) o_3@@6)) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@6 f_7)) FullPerm)))) (=> (not (and (and (or (= (invRecv6 o_3@@6) x_2) (= (invRecv6 o_3@@6) y@@2)) (< NoPerm FullPerm)) (qpRange6 o_3@@6))) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@6 f_7))))))
...
(let ((A@@14 (FieldTypeInv0 (type f_5@@1))))
 ...
 :qid |stdinbpl.1211:29|
 :skolemid |100|
 :pattern ( (MapType1Select ZeroMask o_3@@7 f_5@@1))
 :pattern ( (MapType1Select QPMask@0 o_3@@7 f_5@@1))
)) (state Heap@@13 QPMask@0)) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)))) (and (=> (= (ControlFlow 0 17) 2) anon12_Then_correct) (=> (= (ControlFlow 0 17) 15) anon12_Else_correct)))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@13 x_2 $allocated)) (U_2_bool (MapType0Select Heap@@13 y@@2 $allocated)))) (and (=> (= (ControlFlow 0 19) 1) anon11_Then_correct) (=> (= (ControlFlow 0 19) 17) anon11_Else_correct)))))
...
(declare-fun i@@6 () Int)
(declare-fun j@@5 () Int)
(assert  (and (and (= (type xs) (SeqType RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@13) (MapType0Type RefType))))
(set-info :boogie-vc-id test07a)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 35) (let ((anon19_correct true))
(let ((anon30_Else_correct  (=> (and (not (and (<= 0 x_5_1) (< x_5_1 (|Seq#Length| xs)))) (= (ControlFlow 0 29) 26)) anon19_correct)))
(let ((anon30_Then_correct  (=> (and (<= 0 x_5_1) (< x_5_1 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 27) (- 0 28)) (= (U_2_int (MapType0Select Heap@@13 (|Seq#Index| xs x_5_1) f_7)) 0)) (=> (= (U_2_int (MapType0Select Heap@@13 (|Seq#Index| xs x_5_1) f_7)) 0) (=> (= (ControlFlow 0 27) 26) anon19_correct))))))
(let ((anon15_correct true))
(let ((anon28_Else_correct  (=> (and (not (and (<= 0 x_5) (< x_5 (|Seq#Length| xs)))) (= (ControlFlow 0 25) 20)) anon15_correct)))
(let ((anon28_Then_correct  (=> (and (<= 0 x_5) (< x_5 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 21) (- 0 24)) (>= x_5 0)) (=> (>= x_5 0) (and (=> (= (ControlFlow 0 21) (- 0 23)) (< x_5 (|Seq#Length| xs))) (=> (< x_5 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (HasDirectPerm QPMask@0 (|Seq#Index| xs x_5) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs x_5) f_7) (=> (= (ControlFlow 0 21) 20) anon15_correct))))))))))
(let ((anon29_Else_correct true))
(let ((anon25_Else_correct  (=> (forall ((x_3_1 Int) ) (!  (=> (and (<= 0 x_3_1) (< x_3_1 (|Seq#Length| xs))) (= (U_2_int (MapType0Select Heap@@13 (|Seq#Index| xs x_3_1) f_7)) 0))
 :qid |stdinbpl.3056:20|
 :skolemid |267|
 :pattern ( (MapType0Select Heap@@13 (|Seq#Index| xs x_3_1) f_7))
)) (=> (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)) (and (and (and (and (=> (= (ControlFlow 0 30) 19) anon29_Else_correct) (=> (= (ControlFlow 0 30) 27) anon30_Then_correct)) (=> (= (ControlFlow 0 30) 29) anon30_Else_correct)) (=> (= (ControlFlow 0 30) 21) anon28_Then_correct)) (=> (= (ControlFlow 0 30) 25) anon28_Else_correct))))))
(let ((anon11_correct true))
(let ((anon26_Else_correct  (=> (and (not (and (<= 0 x_4) (< x_4 (|Seq#Length| xs)))) (= (ControlFlow 0 18) 13)) anon11_correct)))
(let ((anon26_Then_correct  (=> (and (<= 0 x_4) (< x_4 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 14) (- 0 17)) (>= x_4 0)) (=> (>= x_4 0) (and (=> (= (ControlFlow 0 14) (- 0 16)) (< x_4 (|Seq#Length| xs))) (=> (< x_4 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm QPMask@0 (|Seq#Index| xs x_4) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs x_4) f_7) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 32)) (forall ((x_1 Int) (x_1_1 Int) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U x_1))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs x_1) (|Seq#Index| xs x_1_1))))
 :qid |stdinbpl.3007:15|
 :skolemid |261|
))) (=> (forall ((x_1@@0 Int) (x_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U x_1@@0))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U x_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs x_1@@0) (|Seq#Index| xs x_1_1@@0))))
 :qid |stdinbpl.3007:15|
 :skolemid |261|
)) (=> (and (and (and (forall ((x_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U x_1@@1)) (< NoPerm FullPerm)) (and (qpRange32 (|Seq#Index| xs x_1@@1)) (= (invRecv32 (|Seq#Index| xs x_1@@1)) x_1@@1)))
 :qid |stdinbpl.3013:22|
 :skolemid |262|
 :pattern ( (|Seq#Index| xs x_1@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U x_1@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U x_1@@1)))
 :pattern ( (|Seq#Index| xs x_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U (invRecv32 o_3))) (< NoPerm FullPerm)) (qpRange32 o_3)) (= (|Seq#Index| xs (invRecv32 o_3)) o_3)))
 :qid |stdinbpl.3017:22|
 :skolemid |263|
 :pattern ( (invRecv32 o_3))
))) (and (forall ((x_1@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U x_1@@2)) (not (= (|Seq#Index| xs x_1@@2) null)))
 :qid |stdinbpl.3023:22|
 :skolemid |264|
 :pattern ( (|Seq#Index| xs x_1@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U x_1@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U x_1@@2)))
 :pattern ( (|Seq#Index| xs x_1@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U (invRecv32 o_3@@0))) (< NoPerm FullPerm)) (qpRange32 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| xs (invRecv32 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U (invRecv32 o_3@@0))) (< NoPerm FullPerm)) (qpRange32 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
)) (state Heap@@13 QPMask@0)) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)))) (and (and (=> (= (ControlFlow 0 31) 30) anon25_Else_correct) (=> (= (ControlFlow 0 31) 14) anon26_Then_correct)) (=> (= (ControlFlow 0 31) 18) anon26_Else_correct)))))))
(let ((anon7_correct true))
(let ((anon24_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U x_3))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon24_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U x_3)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= x_3 0)) (=> (>= x_3 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< x_3 (|Seq#Length| xs))) (=> (< x_3 (|Seq#Length| xs)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon21_Else_correct  (=> (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_1)) (not (= i_1 j_1)))) (not (= (|Seq#Index| xs i_1) (|Seq#Index| xs j_1))))
 :qid |stdinbpl.2983:20|
 :skolemid |260|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_1)) (|Seq#Index| xs j_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_1)) (|Seq#Index| xs j_1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_1)) (|Seq#Index| xs i_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_1)) (|Seq#Index| xs i_1))
 :pattern ( (|Seq#Index| xs i_1) (|Seq#Index| xs j_1))
)) (=> (and (state Heap@@13 ZeroMask) (state Heap@@13 ZeroMask)) (and (and (=> (= (ControlFlow 0 33) 31) anon23_Else_correct) (=> (= (ControlFlow 0 33) 9) anon24_Then_correct)) (=> (= (ControlFlow 0 33) 12) anon24_Else_correct))))))
(let ((anon3_correct true))
(let ((anon22_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i@@6)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j@@5)) (not (= i@@6 j@@5))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon22_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i@@6)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j@@5)) (not (= i@@6 j@@5)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i@@6 (|Seq#Length| xs))) (=> (< i@@6 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j@@5 (|Seq#Length| xs))) (=> (< j@@5 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (and (=> (= (ControlFlow 0 34) 33) anon21_Else_correct) (=> (= (ControlFlow 0 34) 2) anon22_Then_correct)) (=> (= (ControlFlow 0 34) 7) anon22_Else_correct)))))
