...
(let ((anon12_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (f_7 i$0_1))))
(let ((anon11_Then_correct true))
(let ((anon10_Else_correct  (=> (forall ((i_2_1 Int) ) (! (= i_2_1 i_2_1)
 :qid |stdinbpl.222:20|
 :skolemid |22|
...
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (and (=> (= (ControlFlow 0 9) 1) anon9_Then_correct) (=> (= (ControlFlow 0 9) 3) anon10_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon10_Else_correct)))))
