...
(assert  (and (and (= (Ctor PredicateType_PType) 10) (= (Ctor FrameTypeType) 11)) (forall ((arg0@@23 T@U) (arg1@@9 Int) ) (! (= (type (P arg0@@23 arg1@@9)) (FieldType PredicateType_PType FrameTypeType))
 :qid |funType:P|
...
(assert (forall ((Heap@@0 T@U) (x@@9 T@U) (i@@0 Int) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type x@@9) RefType)) (|P#everUsed| (P x@@9 i@@0)))
 :qid |stdinbpl.230:15|
 :skolemid |29|
 :pattern ( (|P#trigger| Heap@@0 (P x@@9 i@@0)))
)))
...
(assert (forall ((x@@10 T@U) (i@@1 Int) (x2 T@U) (i2 Int) ) (!  (=> (and (and (= (type x@@10) RefType) (= (type x2) RefType)) (= (P x@@10 i@@1) (P x2 i2))) (and (= x@@10 x2) (= i@@1 i2)))
 :qid |stdinbpl.221:15|
 :skolemid |27|
 :pattern ( (P x@@10 i@@1) (P x2 i2))
)))
...
(assert (forall ((x@@11 T@U) (i@@2 Int) (x2@@0 T@U) (i2@@0 Int) ) (!  (=> (and (and (= (type x@@11) RefType) (= (type x2@@0) RefType)) (= (|P#sm| x@@11 i@@2) (|P#sm| x2@@0 i2@@0))) (and (= x@@11 x2@@0) (= i@@2 i2@@0)))
 :qid |stdinbpl.225:15|
 :skolemid |28|
 :pattern ( (|P#sm| x@@11 i@@2) (|P#sm| x2@@0 i2@@0))
)))
...
(assert (forall ((c_1_1 Bool) (p_1_1 Real) (p_0_1 Real) ) (! (= (__iar__assume_helper_1 c_1_1 p_1_1 p_0_1) (+ p_0_1 (ite c_1_1 p_1_1 NoPerm)))
 :qid |stdinbpl.189:15|
 :skolemid |22|
 :pattern ( (__iar__assume_helper_1 c_1_1 p_1_1 p_0_1))
)))
(assert (forall ((x@@12 T@U) (i@@3 Int) ) (!  (=> (= (type x@@12) RefType) (= (getPredWandId (P x@@12 i@@3)) 0))
 :qid |stdinbpl.215:15|
 :skolemid |26|
 :pattern ( (P x@@12 i@@3))
)))
...
(assert (forall ((x@@13 T@U) (i@@4 Int) ) (!  (=> (= (type x@@13) RefType) (= (PredicateMaskField (P x@@13 i@@4)) (|P#sm| x@@13 i@@4)))
 :qid |stdinbpl.207:15|
 :skolemid |24|
 :pattern ( (PredicateMaskField (P x@@13 i@@4)))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((c_2_1 Bool) (c_1_1@@0 Bool) (p_2_1 Real) (p_1_1@@0 Real) (p_0_1@@0 Real) ) (! (= (__iar__assume_helper_2 c_2_1 c_1_1@@0 p_2_1 p_1_1@@0 p_0_1@@0) (+ (+ p_0_1@@0 (ite c_1_1@@0 p_1_1@@0 NoPerm)) (ite c_2_1 p_2_1 NoPerm)))
 :qid |stdinbpl.195:15|
 :skolemid |23|
 :pattern ( (__iar__assume_helper_2 c_2_1 c_1_1@@0 p_2_1 p_1_1@@0 p_0_1@@0))
)))
(push 1)
...
(assert  (and (and (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type x@@14) RefType)) (= (type y@@1) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test01_p2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon8_correct  (=> (and (and (and (state Heap@@10 Mask@2) b_2) (and (state Heap@@10 Mask@2) (state Heap@@10 Mask@2))) (and (and (not (or (not (= x@@14 y@@1)) (not (= i@@5 j)))) (state Heap@@10 Mask@2)) (and (state Heap@@10 Mask@2) (= (ControlFlow 0 2) (- 0 1))))) false)))
(let ((anon12_Else_correct  (=> (and (not (or (not (= x@@14 y@@1)) (not (= i@@5 j)))) (= (ControlFlow 0 6) 2)) anon8_correct)))
(let ((anon12_Then_correct  (=> (or (not (= x@@14 y@@1)) (not (= i@@5 j))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (not b_2)) (=> (not b_2) (=> (state Heap@@10 Mask@2) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= (U_2_real (MapType1Select Mask@2 null (P y@@1 j))) NoPerm)) (=> (= (U_2_real (MapType1Select Mask@2 null (P y@@1 j))) NoPerm) (=> (and (state Heap@@10 Mask@2) (= (ControlFlow 0 3) 2)) anon8_correct)))))))))
(let ((anon6_correct  (=> (state Heap@@10 Mask@2) (and (=> (= (ControlFlow 0 7) 3) anon12_Then_correct) (=> (= (ControlFlow 0 7) 6) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (not b_2) (= (ControlFlow 0 11) 7)) anon6_correct)))
(let ((anon11_Then_correct  (=> b_2 (and (=> (= (ControlFlow 0 8) (- 0 10)) (= y@@1 x@@14)) (=> (= y@@1 x@@14) (and (=> (= (ControlFlow 0 8) (- 0 9)) (= j i@@5)) (=> (= j i@@5) (=> (= (ControlFlow 0 8) 7) anon6_correct))))))))
(let ((anon4_correct  (=> (state Heap@@10 Mask@2) (=> (and (and (state Heap@@10 Mask@2) (<= (__iar__assume_helper_2  (and (= x@@14 y@@1) (= i@@5 j))  (and b_2 (and (= y@@1 y@@1) (= j j))) (/ (to_real 1) (to_real 3)) (/ (to_real 3) (to_real 16)) (/ (to_real 0) (to_real 16))) (U_2_real (MapType1Select Mask@2 null (P y@@1 j))))) (and (state Heap@@10 Mask@2) (state Heap@@10 Mask@2))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (= (U_2_real (MapType1Select Mask@2 null (P x@@14 i@@5))) (+ (/ (to_real 1) (to_real 3)) (ite b_2 (/ (to_real 1) (to_real 4)) NoPerm)))) (=> (= (U_2_real (MapType1Select Mask@2 null (P x@@14 i@@5))) (+ (/ (to_real 1) (to_real 3)) (ite b_2 (/ (to_real 1) (to_real 4)) NoPerm))) (=> (state Heap@@10 Mask@2) (and (=> (= (ControlFlow 0 12) 8) anon11_Then_correct) (=> (= (ControlFlow 0 12) 11) anon11_Else_correct)))))))))
(let ((anon10_Else_correct  (=> (and (not b_2) (= (ControlFlow 0 15) 12)) anon4_correct)))
(let ((anon10_Then_correct  (=> b_2 (=> (and (<= (__iar__assume_helper_1  (and (= x@@14 y@@1) (= i@@5 j)) (/ (to_real 1) (to_real 3)) (/ (to_real 3) (to_real 16))) (U_2_real (MapType1Select Mask@2 null (P y@@1 j)))) (= (ControlFlow 0 14) 12)) anon4_correct))))
(let ((anon2_correct  (=> (and (and (state Heap@@10 Mask@2) (<= (/ (to_real 1) (to_real 3)) (U_2_real (MapType1Select Mask@2 null (P x@@14 i@@5))))) (and (state Heap@@10 Mask@2) (state Heap@@10 Mask@2))) (and (=> (= (ControlFlow 0 16) 14) anon10_Then_correct) (=> (= (ControlFlow 0 16) 15) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (not b_2) (=> (and (= Mask@2 Mask@0) (= (ControlFlow 0 19) 16)) anon2_correct))))
(let ((anon9_Then_correct  (=> (and b_2 (= perm@1 (/ (to_real 1) (to_real 4)))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (= Mask@1 (MapType1Store Mask@0 null (P x@@14 i@@5) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (P x@@14 i@@5))) perm@1)))) (state Heap@@10 Mask@1)) (=> (and (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 17) 16))) anon2_correct)))))))
(let ((anon0_correct  (=> (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x@@14 $allocated))) (and (U_2_bool (MapType0Select Heap@@10 y@@1 $allocated)) (= perm@0 (/ (to_real 1) (to_real 3))))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (P x@@14 i@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@14 i@@5))) perm@0)))) (state Heap@@10 Mask@0)) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 20) 17) anon9_Then_correct) (=> (= (ControlFlow 0 20) 19) anon9_Else_correct))))))))
