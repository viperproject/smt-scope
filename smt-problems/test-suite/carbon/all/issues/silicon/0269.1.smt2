...
(declare-fun Container_value () T@U)
(declare-fun f_8 () T@U)
...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (Ctor RefType) 8)) (= (type Container_value) (FieldType NormalFieldType RefType))) (= (type f_8) (FieldType NormalFieldType intType))))
(assert (distinct $allocated Container_value f_8)
)
...
(assert  (not (IsPredicateField Container_value)))
(assert  (not (IsWandField Container_value)))
...
(declare-fun out () T@U)
(declare-fun error_0 () T@U)
(assert  (and (and (and (and (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type LoopSumMask@0) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type LoopSumHeap@0) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@17) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type LoopSumHeap@1) (MapType0Type RefType))) (= (type LoopSumMask@1) (MapType1Type RefType realType))) (= (type out) RefType)) (= (type error_0) RefType)))
...
(let ((anon21_Then_correct  (=> nonDet (=> (and (SumHeap LoopSumHeap@1 Heap@0 ZeroMask Heap@@17 Mask@0) (sumMask LoopSumMask@1 ZeroMask Mask@0)) (=> (and (and (state LoopSumHeap@1 LoopSumMask@1) (= Mask@1 LoopSumMask@1)) (and (= Heap@1 LoopSumHeap@1) (= (ControlFlow 0 6) 2))) __end_correct)))))
...
(let ((anon20_Else_correct  (=> (>= 1 0) (=> (and (and (SumHeap LoopSumHeap@0 Heap@0 ZeroMask Heap@@17 Mask@0) (sumMask LoopSumMask@0 ZeroMask Mask@0)) (and (state LoopSumHeap@0 LoopSumMask@0) (state LoopSumHeap@0 LoopSumMask@0))) (and (=> (= (ControlFlow 0 5) 3) anon23_Then_correct) (=> (= (ControlFlow 0 5) 4) anon23_Else_correct))))))
(let ((anon24_Else_correct  (=> (state Heap@@17 ZeroMask) (=> (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask)) (and (=> (= (ControlFlow 0 10) (- 0 12)) (= FullPerm (U_2_real (MapType1Select ZeroMask out Container_value)))) (=> (= FullPerm (U_2_real (MapType1Select ZeroMask out Container_value))) (=> (= Heap@0 (MapType0Store Heap@@17 out Container_value null)) (=> (and (and (state Heap@0 ZeroMask) (state Heap@0 ZeroMask)) (and (state Heap@0 ZeroMask) (state Heap@0 ZeroMask))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (= 0 0)) (=> (= 0 0) (=> (state Heap@0 ZeroMask) (and (=> (= (ControlFlow 0 10) 9) anon20_Then_correct) (=> (= (ControlFlow 0 10) 5) anon20_Else_correct)))))))))))))
(let ((anon24_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@17 out $allocated)) (not (= out null))) (and (= Mask@0 (MapType1Store ZeroMask out Container_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask out Container_value)) FullPerm)))) (state Heap@@17 Mask@0))) (and (and (state Heap@@17 Mask@0) (U_2_bool (MapType0Select Heap@@17 error_0 $allocated))) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)))) (and (=> (= (ControlFlow 0 13) 1) anon24_Then_correct) (=> (= (ControlFlow 0 13) 10) anon24_Else_correct))))))
