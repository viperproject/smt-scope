...
(let ((anon8_Else_correct  (=> (and (not (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i_4)))) (= (ControlFlow 0 8) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i_4))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i_4)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i_4))) (=> (= (ControlFlow 0 6) 4) anon4_correct))))))
...
(let ((anon6_Else_correct  (=> (and (forall ((i_1 T@U) ) (!  (=> (= (type i_1) intType) (=> (and (<= 0 (U_2_int i_1)) (< (U_2_int i_1) 100)) (and (U_2_bool (MapType0Select (|Map#Domain| m@@23) i_1)) (= (U_2_int (MapType0Select (|Map#Elements| m@@23) i_1)) (* (U_2_int i_1) (U_2_int i_1))))))
 :qid |stdinbpl.698:20|
 :skolemid |105|
 :pattern ( (MapType0Select (|Map#Domain| m@@23) i_1))
 :pattern ( (MapType0Select (|Map#Elements| m@@23) i_1))
)) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 20)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 20))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (MapType0Select (|Map#Elements| m@@23) (int_2_U 20))) 400)))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (and (=> (= (ControlFlow 0 10) 2) anon6_Else_correct) (=> (= (ControlFlow 0 10) 9) anon7_Then_correct)) (=> (= (ControlFlow 0 10) 5) anon7_Else_correct)))))
