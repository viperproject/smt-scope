...
(set-info :boogie-vc-id test_drop_length_02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= a_2@0 (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 1)) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 5))) (|Seq#Singleton| (int_2_U 7))) (|Seq#Singleton| (int_2_U 8)))) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (= (|Seq#Length| (|Seq#Drop| a_2@0 (- 0 1))) 5)) (=> (= (|Seq#Length| (|Seq#Drop| a_2@0 (- 0 1))) 5) (=> (and (and (state Heap@@9 ZeroMask) (< e1 (- 0 1))) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (|Seq#Length| (|Seq#Drop| a_2@0 e1)) 5)) (=> (= (|Seq#Length| (|Seq#Drop| a_2@0 e1)) 5) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (|Seq#Length| (|Seq#Drop| a_2@0 6)) 0)) (=> (= (|Seq#Length| (|Seq#Drop| a_2@0 6)) 0) (=> (and (and (state Heap@@9 ZeroMask) (< 6 e2)) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (|Seq#Length| (|Seq#Drop| a_2@0 e2)) 0)) (=> (= (|Seq#Length| (|Seq#Drop| a_2@0 e2)) 0) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) false))))))))))))))))
