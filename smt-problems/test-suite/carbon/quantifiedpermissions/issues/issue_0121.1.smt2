...
(assert  (and (and (and (and (and (= (type xs) (MapType0Type RefType boolType)) (= (type y_2) RefType)) (= (type Heap@@10) (MapType1Type RefType))) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@46 T@U) ) (! (= (type (invRecv2 arg0@@46)) RefType)
...
(let ((anon12_Else_correct  (=> (and (not (and (U_2_bool (MapType0Select xs y_2)) (not (= (MapType1Select Heap@@10 y_2 f_7) null)))) (= (ControlFlow 0 6) 3)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (U_2_bool (MapType0Select xs y_2)) (not (= (MapType1Select Heap@@10 y_2 f_7) null))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm QPMask@0 y_2 f_7)) (=> (HasDirectPerm QPMask@0 y_2 f_7) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
(let ((anon11_Else_correct  (=> (not (U_2_bool (MapType0Select xs y_2))) (and (=> (= (ControlFlow 0 9) 4) anon12_Then_correct) (=> (= (ControlFlow 0 9) 6) anon12_Else_correct)))))
(let ((anon11_Then_correct  (=> (U_2_bool (MapType0Select xs y_2)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm QPMask@0 y_2 f_7)) (=> (HasDirectPerm QPMask@0 y_2 f_7) (and (=> (= (ControlFlow 0 7) 4) anon12_Then_correct) (=> (= (ControlFlow 0 7) 6) anon12_Else_correct)))))))
(let ((anon10_Else_correct true))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 12)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType0Select xs x_1))) (U_2_bool (MapType0Select xs x_1_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= x_1 x_1_1))))
 :qid |stdinbpl.563:15|
 :skolemid |97|
 :no-pattern (type x_1)
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (U_2_bool (MapType0Select xs x_1@@0))) (U_2_bool (MapType0Select xs x_1_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.563:15|
 :skolemid |97|
...
)) (=> (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType0Select xs x_1@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange2 x_1@@1) (= (invRecv2 x_1@@1) x_1@@1))))
 :qid |stdinbpl.569:22|
 :skolemid |98|
 :pattern ( (MapType1Select Heap@@10 x_1@@1 f_7))
 :pattern ( (MapType2Select QPMask@0 x_1@@1 f_7))
 :pattern ( (MapType0Select xs x_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType0Select xs (invRecv2 o_3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.573:22|
 :skolemid |99|
 :pattern ( (invRecv2 o_3))
))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (U_2_bool (MapType0Select xs x_1@@2))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.579:15|
 :skolemid |100|
 :pattern ( (MapType1Select Heap@@10 x_1@@2 f_7))
 :pattern ( (MapType2Select QPMask@0 x_1@@2 f_7))
 :pattern ( (MapType0Select xs x_1@@2))
))) (=> (forall ((x_1@@3 T@U) ) (!  (=> (and (= (type x_1@@3) RefType) (U_2_bool (MapType0Select xs x_1@@3))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.579:15|
 :skolemid |100|
 :pattern ( (MapType1Select Heap@@10 x_1@@3 f_7))
 :pattern ( (MapType2Select QPMask@0 x_1@@3 f_7))
 :pattern ( (MapType0Select xs x_1@@3))
)) (=> (forall ((x_1@@4 T@U) ) (!  (=> (= (type x_1@@4) RefType) (=> (and (U_2_bool (MapType0Select xs x_1@@4)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= x_1@@4 null))))
 :qid |stdinbpl.585:22|
 :skolemid |101|
 :pattern ( (MapType1Select Heap@@10 x_1@@4 f_7))
 :pattern ( (MapType2Select QPMask@0 x_1@@4 f_7))
 :pattern ( (MapType0Select xs x_1@@4))
)) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType0Select xs (invRecv2 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_3@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv2 o_3@@0) o_3@@0)) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType2Select ZeroMask o_3@@0 f_7)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (U_2_bool (MapType0Select xs (invRecv2 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_3@@0))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType2Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.591:22|
 :skolemid |102|
...
))) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0))) (and (and (=> (= (ControlFlow 0 10) 2) anon10_Else_correct) (=> (= (ControlFlow 0 10) 7) anon11_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon11_Else_correct)))))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType1Select Heap@@10 this@@6 $allocated))) (and (U_2_bool (MapType0Select xs this@@6)) (state Heap@@10 ZeroMask))) (and (=> (= (ControlFlow 0 13) 1) anon9_Then_correct) (=> (= (ControlFlow 0 13) 10) anon9_Else_correct)))))
