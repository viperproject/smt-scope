...
(declare-fun gi (T@U) Int)
(declare-fun MapType0Type (T@T) T@T)
(declare-fun RefType () T@T)
(declare-fun MapType1Type (T@T T@T) T@T)
(declare-fun AssumeFunctionsAbove () Int)
(declare-fun fi (T@U Int) Int)
...
(declare-fun |f#frame| (T@U Real) Real)
(declare-fun |fi#frame| (T@U Int) Int)
(declare-fun |g#frame| (T@U) Real)
(declare-fun |gi#frame| (T@U) Int)
...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type fd) (FieldType NormalFieldType intType))))
(assert (distinct $allocated fd)
)
...
(assert (forall ((Heap T@U) (Mask T@U) ) (!  (=> (and (and (= (type Heap) (MapType0Type RefType)) (= (type Mask) (MapType1Type RefType realType))) (and (state Heap Mask) (< AssumeFunctionsAbove 0))) (= (gi Heap) (fi Heap 0)))
 :qid |stdinbpl.361:15|
 :skolemid |36|
...
(assert (forall ((Heap@@3 T@U) (p_1 Real) ) (!  (=> (= (type Heap@@3) (MapType0Type RefType)) (dummyFunction (real_2_U (|f#triggerStateless| p_1))))
 :qid |stdinbpl.200:15|
 :skolemid |23|
 :pattern ( (|f'| Heap@@3 p_1))
)))
(assert (forall ((Heap@@4 T@U) (p_1@@0 Int) ) (!  (=> (= (type Heap@@4) (MapType0Type RefType)) (dummyFunction (int_2_U (|fi#triggerStateless| p_1@@0))))
 :qid |stdinbpl.249:15|
 :skolemid |27|
 :pattern ( (|fi'| Heap@@4 p_1@@0))
)))
...
(assert (forall ((Heap@@6 T@U) (p_1@@1 Real) ) (!  (=> (= (type Heap@@6) (MapType0Type RefType)) (and (= (f_6 Heap@@6 p_1@@1) (|f'| Heap@@6 p_1@@1)) (dummyFunction (real_2_U (|f#triggerStateless| p_1@@1)))))
 :qid |stdinbpl.196:15|
 :skolemid |22|
 :pattern ( (f_6 Heap@@6 p_1@@1))
)))
(assert (forall ((Heap@@7 T@U) (p_1@@2 Int) ) (!  (=> (= (type Heap@@7) (MapType0Type RefType)) (and (= (fi Heap@@7 p_1@@2) (|fi'| Heap@@7 p_1@@2)) (dummyFunction (int_2_U (|fi#triggerStateless| p_1@@2)))))
 :qid |stdinbpl.245:15|
 :skolemid |26|
 :pattern ( (fi Heap@@7 p_1@@2))
)))
...
(assert  (not (IsPredicateField fd)))
(assert  (not (IsWandField fd)))
...
(assert (forall ((Heap@@10 T@U) ) (!  (=> (= (type Heap@@10) (MapType0Type RefType)) (and (= (g Heap@@10) (|g'| Heap@@10)) (dummyFunction (real_2_U |g#triggerStateless|))))
 :qid |stdinbpl.294:15|
 :skolemid |30|
 :pattern ( (g Heap@@10))
)))
(assert (forall ((Heap@@11 T@U) ) (!  (=> (= (type Heap@@11) (MapType0Type RefType)) (and (= (gi Heap@@11) (|gi'| Heap@@11)) (dummyFunction (int_2_U |gi#triggerStateless|))))
 :qid |stdinbpl.351:15|
 :skolemid |34|
 :pattern ( (gi Heap@@11))
)))
...
(assert (forall ((Heap@@12 T@U) (Mask@@7 T@U) (p_1@@3 Real) ) (!  (=> (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (and (state Heap@@12 Mask@@7) (< AssumeFunctionsAbove 3))) (= (f_6 Heap@@12 p_1@@3) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.206:15|
 :skolemid |24|
 :pattern ( (state Heap@@12 Mask@@7) (f_6 Heap@@12 p_1@@3))
)))
...
(assert (forall ((Heap@@13 T@U) (Mask@@8 T@U) ) (!  (=> (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type Mask@@8) (MapType1Type RefType realType))) (and (state Heap@@13 Mask@@8) (< AssumeFunctionsAbove 1))) (= (g Heap@@13) (f_6 Heap@@13 (/ (to_real 1) (to_real 4)))))
 :qid |stdinbpl.304:15|
 :skolemid |32|
 :pattern ( (state Heap@@13 Mask@@8) (g Heap@@13))
)))
(assert (forall ((Heap@@14 T@U) (ExhaleHeap@@4 T@U) (Mask@@9 T@U) (pm_f@@1 T@U) ) (! (let ((C@@1 (FieldTypeInv0 (type pm_f@@1))))
 (=> (and (and (and (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type ExhaleHeap@@4) (MapType0Type RefType))) (= (type Mask@@9) (MapType1Type RefType realType))) (= (type pm_f@@1) (FieldType C@@1 FrameTypeType))) (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@4 Mask@@9)) (and (HasDirectPerm Mask@@9 null pm_f@@1) (IsPredicateField pm_f@@1))) (forall ((o2 T@U) (f_2@@0 T@U) ) (! (let ((B@@5 (FieldTypeInv1 (type f_2@@0))))
(let ((A@@6 (FieldTypeInv0 (type f_2@@0))))
 ...
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@@4 Mask@@9) (IsPredicateField pm_f@@1))
)))
(assert (forall ((Heap@@15 T@U) (ExhaleHeap@@5 T@U) (Mask@@10 T@U) (pm_f@@2 T@U) ) (! (let ((C@@2 (FieldTypeInv0 (type pm_f@@2))))
 (=> (and (and (and (and (and (= (type Heap@@15) (MapType0Type RefType)) (= (type ExhaleHeap@@5) (MapType0Type RefType))) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type pm_f@@2) (FieldType C@@2 FrameTypeType))) (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@5 Mask@@10)) (and (HasDirectPerm Mask@@10 null pm_f@@2) (IsWandField pm_f@@2))) (forall ((o2@@0 T@U) (f_2@@1 T@U) ) (! (let ((B@@6 (FieldTypeInv1 (type f_2@@1))))
(let ((A@@7 (FieldTypeInv0 (type f_2@@1))))
 ...
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@@5 Mask@@10) (IsWandField pm_f@@2))
)))
...
(assert (forall ((Heap@@16 T@U) (Mask@@12 T@U) (p_1@@4 Real) ) (!  (=> (and (and (= (type Heap@@16) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (state Heap@@16 Mask@@12)) (= (|f'| Heap@@16 p_1@@4) (|f#frame| EmptyFrame p_1@@4)))
 :qid |stdinbpl.213:15|
 :skolemid |25|
 :pattern ( (state Heap@@16 Mask@@12) (|f'| Heap@@16 p_1@@4))
)))
(assert (forall ((Heap@@17 T@U) (Mask@@13 T@U) (p_1@@5 Int) ) (!  (=> (and (and (= (type Heap@@17) (MapType0Type RefType)) (= (type Mask@@13) (MapType1Type RefType realType))) (state Heap@@17 Mask@@13)) (= (|fi'| Heap@@17 p_1@@5) (|fi#frame| EmptyFrame p_1@@5)))
 :qid |stdinbpl.262:15|
 :skolemid |29|
 :pattern ( (state Heap@@17 Mask@@13) (|fi'| Heap@@17 p_1@@5))
)))
(assert (forall ((Heap@@18 T@U) ) (!  (=> (= (type Heap@@18) (MapType0Type RefType)) (dummyFunction (real_2_U |g#triggerStateless|)))
 :qid |stdinbpl.298:15|
 :skolemid |31|
 :pattern ( (|g'| Heap@@18))
)))
(assert (forall ((Heap@@19 T@U) ) (!  (=> (= (type Heap@@19) (MapType0Type RefType)) (dummyFunction (int_2_U |gi#triggerStateless|)))
 :qid |stdinbpl.355:15|
 :skolemid |35|
 :pattern ( (|gi'| Heap@@19))
)))
...
(assert (forall ((Heap@@21 T@U) (Mask@@14 T@U) ) (!  (=> (and (and (= (type Heap@@21) (MapType0Type RefType)) (= (type Mask@@14) (MapType1Type RefType realType))) (state Heap@@21 Mask@@14)) (= (|g'| Heap@@21) (|g#frame| EmptyFrame)))
 :qid |stdinbpl.311:15|
 :skolemid |33|
 :pattern ( (state Heap@@21 Mask@@14) (|g'| Heap@@21))
)))
(assert (forall ((Heap@@22 T@U) (Mask@@15 T@U) ) (!  (=> (and (and (= (type Heap@@22) (MapType0Type RefType)) (= (type Mask@@15) (MapType1Type RefType realType))) (state Heap@@22 Mask@@15)) (= (|gi'| Heap@@22) (|gi#frame| EmptyFrame)))
 :qid |stdinbpl.368:15|
 :skolemid |37|
 :pattern ( (state Heap@@22 Mask@@15) (|gi'| Heap@@22))
)))
...
(assert (forall ((Heap@@24 T@U) (Mask@@16 T@U) (p_1@@6 Int) ) (!  (=> (and (and (= (type Heap@@24) (MapType0Type RefType)) (= (type Mask@@16) (MapType1Type RefType realType))) (and (state Heap@@24 Mask@@16) (< AssumeFunctionsAbove 2))) (= (fi Heap@@24 p_1@@6) 0))
 :qid |stdinbpl.255:15|
 :skolemid |28|
 :pattern ( (state Heap@@24 Mask@@16) (fi Heap@@24 p_1@@6))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
...
(assert  (and (and (= (type Heap@@25) (MapType0Type RefType)) (= (type r_1) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id m)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (state Heap@@25 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@25 r_1 $allocated)) (= perm@0 (/ (to_real 1) (to_real 6))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= r_1 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask r_1 fd (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1 fd)) perm@0)))) (state Heap@@25 Mask@0)) (and (state Heap@@25 Mask@0) (= p1@0 (/ (to_real 1) (to_real 7))))) (=> (and (and (and (state Heap@@25 Mask@0) (= p2@0 (/ (to_real 0) (to_real 3)))) (and (state Heap@@25 Mask@0) (state Heap@@25 Mask@0))) (and (and (= i2@0 (div 1 1)) (state Heap@@25 Mask@0)) (and (state Heap@@25 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (= (* (/ (to_real 1) (to_real 2)) (/ (to_real 2) (to_real 1))) (/ (to_real 0) (to_real 1)))))))))))
