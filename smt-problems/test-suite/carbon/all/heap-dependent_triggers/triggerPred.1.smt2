...
(assert  (and (and (and (and (= (type QPMask@0) (MapType1Type RefType realType)) (= (type y@@6) RefType)) (= (type xs) (MapType2Type RefType boolType))) (= (type Heap@@10) (MapType0Type RefType))) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv1 arg0@@45)) RefType)
...
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p_1 y@@6))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p_1 y@@6)))) (=> (= (ControlFlow 0 3) 2) anon4_correct))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select xs x_1))) (U_2_bool (MapType2Select xs x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.488:17|
 :skolemid |88|
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs x_1@@1)) (< NoPerm FullPerm)) (and (= (invRecv1 x_1@@1) x_1@@1) (qpRange1 x_1@@1))))
 :qid |stdinbpl.494:22|
 :skolemid |89|
 :pattern ( (MapType0Select Heap@@10 null (p_1 x_1@@1)))
 :pattern ( (MapType1Select ZeroMask null (p_1 x_1@@1)))
 :pattern ( (MapType0Select Heap@@10 null (p_1 x_1@@1)))
)) (=> (and (forall ((x_2_1 T@U) ) (!  (=> (= (type x_2_1) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv1 x_2_1))) (< NoPerm FullPerm)) (qpRange1 x_2_1)) (= (invRecv1 x_2_1) x_2_1)))
 :qid |stdinbpl.498:22|
 :skolemid |90|
 :pattern ( (invRecv1 x_2_1))
)) (forall ((x_2_1@@0 T@U) ) (!  (=> (= (type x_2_1@@0) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv1 x_2_1@@0))) (< NoPerm FullPerm)) (qpRange1 x_2_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 x_2_1@@0) x_2_1@@0)) (= (U_2_real (MapType1Select QPMask@0 null (p_1 x_2_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (p_1 x_2_1@@0))) FullPerm)))))
 :qid |stdinbpl.504:22|
 :skolemid |91|
...
)) (forall ((x_2_1@@1 T@U) ) (!  (=> (and (= (type x_2_1@@1) RefType) (not (and (and (U_2_bool (MapType2Select xs (invRecv1 x_2_1@@1))) (< NoPerm FullPerm)) (qpRange1 x_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (p_1 x_2_1@@1))) (U_2_real (MapType1Select ZeroMask null (p_1 x_2_1@@1)))))
 :qid |stdinbpl.514:22|
 :skolemid |93|
 :pattern ( (MapType1Select QPMask@0 null (p_1 x_2_1@@1)))
))) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0))) (and (and (state Heap@@10 QPMask@0) (U_2_bool (MapType2Select xs y@@6))) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0)))) (and (=> (= (ControlFlow 0 6) 3) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 y@@6 $allocated))) (and (=> (= (ControlFlow 0 8) 1) anon5_Then_correct) (=> (= (ControlFlow 0 8) 6) anon5_Else_correct)))))
