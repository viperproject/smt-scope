...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (pair z@@4) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (pair z@@4))) FullPerm)))) (=> (and (and (and (not (= z@@4 null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 z@@4 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 z@@4 f_7)) FullPerm))))) (and (state Heap@@37 UnfoldingMask@1) (not (= z@@4 null)))) (and (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 z@@4 g (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 z@@4 g)) FullPerm)))) (state Heap@@37 UnfoldingMask@2)) (and (state Heap@@37 UnfoldingMask@2) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm UnfoldingMask@2 z@@4 f_7)))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pair z@@4))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pair z@@4)))) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@37 ZeroMask) (U_2_bool (MapType0Select Heap@@37 z@@4 $allocated))) (and (= AssumeFunctionsAbove 5) (= Mask@0 (MapType1Store ZeroMask null (pair z@@4) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (pair z@@4))) FullPerm)))))) (and (and (state Heap@@37 Mask@0) (state Heap@@37 Mask@0)) (and (|pair#trigger| Heap@@37 (pair z@@4)) (= (MapType0Select Heap@@37 null (pair z@@4)) (CombineFrames (FrameFragment (MapType0Select Heap@@37 z@@4 f_7)) (FrameFragment (MapType0Select Heap@@37 z@@4 g))))))) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))
