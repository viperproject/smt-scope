...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon2_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (pred x@@18) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (pred x@@18))) FullPerm)))) (= perm@0 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= x@@18 null))) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x@@18 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@18 f_7)) perm@0))))) (and (state Heap@@17 UnfoldingMask@1) (= perm@1 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (=> (> perm@1 NoPerm) (not (= x@@18 null))) (=> (and (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 x@@18 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 x@@18 f_7)) perm@1)))) (state Heap@@17 UnfoldingMask@2)) (and (state Heap@@17 UnfoldingMask@2) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm UnfoldingMask@2 x@@18 f_7)))))))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pred x@@18))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pred x@@18)))) (=> (= (ControlFlow 0 5) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@17 ZeroMask) (U_2_bool (MapType0Select Heap@@17 x@@18 $allocated))) (and (= AssumeFunctionsAbove 0) (= Mask@0 (MapType1Store ZeroMask null (pred x@@18) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (pred x@@18))) FullPerm)))))) (and (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)) (and (|pred#trigger| Heap@@17 (pred x@@18)) (= (MapType0Select Heap@@17 null (pred x@@18)) (CombineFrames (FrameFragment (MapType0Select Heap@@17 x@@18 f_7)) (FrameFragment (MapType0Select Heap@@17 x@@18 f_7))))))) (and (=> (= (ControlFlow 0 8) 5) anon3_Then_correct) (=> (= (ControlFlow 0 8) 7) anon3_Else_correct)))))
