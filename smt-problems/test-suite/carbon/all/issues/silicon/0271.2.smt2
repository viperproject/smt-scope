...
(assert  (and (and (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type x@@18) RefType)) (= (type ExhaleWellDef0Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@0 x@@18 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@0 x@@18 f_7))) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
(let ((anon3_correct  (=> (= ExhaleWellDef0Mask@0 (MapType1Store Mask@1 x@@18 g (real_2_U (- (U_2_real (MapType1Select Mask@1 x@@18 g)) FullPerm)))) (and (=> (= (ControlFlow 0 7) 4) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 7)) anon3_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@18 g)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@18 g))) (=> (= (ControlFlow 0 8) 7) anon3_correct))))))
(let ((anon7_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= (getf Heap@@14 x@@18) 3))))
(let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@14 x@@18 $allocated)) (not (= x@@18 null))) (and (= Mask@0 (MapType1Store ZeroMask x@@18 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@18 f_7)) FullPerm)))) (state Heap@@14 Mask@0))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (HasDirectPerm Mask@0 x@@18 f_7)) (=> (HasDirectPerm Mask@0 x@@18 f_7) (=> (and (= (U_2_int (MapType0Select Heap@@14 x@@18 f_7)) 22) (state Heap@@14 Mask@0)) (=> (and (and (state Heap@@14 Mask@0) (not (= x@@18 null))) (and (= Mask@1 (MapType1Store Mask@0 x@@18 g (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@18 g)) FullPerm)))) (state Heap@@14 Mask@1))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm Mask@1 x@@18 g)) (=> (HasDirectPerm Mask@1 x@@18 g) (=> (= (U_2_int (MapType0Select Heap@@14 x@@18 g)) 3) (=> (and (state Heap@@14 Mask@1) (state Heap@@14 Mask@1)) (and (and (=> (= (ControlFlow 0 11) 2) anon7_Else_correct) (=> (= (ControlFlow 0 11) 8) anon8_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon8_Else_correct))))))))))))))
