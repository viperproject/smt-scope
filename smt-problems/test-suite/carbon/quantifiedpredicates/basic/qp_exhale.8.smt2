...
(assert  (and (and (= (Ctor PredicateType_p4Type) 12) (= (Ctor FrameTypeType) 13)) (forall ((arg0@@28 T@U) (arg1@@12 Int) ) (! (= (type (p4 arg0@@28 arg1@@12)) (FieldType PredicateType_p4Type FrameTypeType))
 :qid |funType:p4|
 :pattern ( (p4 arg0@@28 arg1@@12))
))))
...
(assert  (and (= (Ctor PredicateType_p5Type) 14) (forall ((arg0@@29 T@U) (arg1@@13 Int) ) (! (= (type (p5 arg0@@29 arg1@@13)) (FieldType PredicateType_p5Type FrameTypeType))
 :qid |funType:p5|
 :pattern ( (p5 arg0@@29 arg1@@13))
))))
...
(assert  (and (= (Ctor PredicateType_p2Type) 16) (forall ((arg0@@32 T@U) ) (! (= (type (p2 arg0@@32)) (FieldType PredicateType_p2Type FrameTypeType))
 :qid |funType:p2|
 :pattern ( (p2 arg0@@32))
))))
...
(assert  (and (= (Ctor PredicateType_p3Type) 17) (forall ((arg0@@33 T@U) ) (! (= (type (p3 arg0@@33)) (FieldType PredicateType_p3Type FrameTypeType))
 :qid |funType:p3|
 :pattern ( (p3 arg0@@33))
))))
...
(assert  (and (and (and (and (and (and (and (forall ((arg0@@34 T@T) (arg1@@14 T@T) ) (! (= (Ctor (MapType2Type arg0@@34 arg1@@14)) 18)
...
(assert (forall ((r_2@@7 T@U) (i@@3 Int) (r2 T@U) (i2 Int) ) (!  (=> (and (and (= (type r_2@@7) RefType) (= (type r2) RefType)) (= (p4 r_2@@7 i@@3) (p4 r2 i2))) (and (= r_2@@7 r2) (= i@@3 i2)))
 :qid |stdinbpl.581:15|
 :skolemid |98|
 :pattern ( (p4 r_2@@7 i@@3) (p4 r2 i2))
)))
(assert (forall ((arg0@@42 T@U) (arg1@@21 Int) ) (! (= (type (|p4#sm| arg0@@42 arg1@@21)) (FieldType PredicateType_p4Type (MapType1Type RefType boolType)))
 :qid |funType:p4#sm|
 :pattern ( (|p4#sm| arg0@@42 arg1@@21))
)))
(assert (forall ((r_2@@8 T@U) (i@@4 Int) (r2@@0 T@U) (i2@@0 Int) ) (!  (=> (and (and (= (type r_2@@8) RefType) (= (type r2@@0) RefType)) (= (|p4#sm| r_2@@8 i@@4) (|p4#sm| r2@@0 i2@@0))) (and (= r_2@@8 r2@@0) (= i@@4 i2@@0)))
 :qid |stdinbpl.585:15|
 :skolemid |99|
 :pattern ( (|p4#sm| r_2@@8 i@@4) (|p4#sm| r2@@0 i2@@0))
)))
(assert (forall ((r_2@@9 T@U) (i@@5 Int) (r2@@1 T@U) (i2@@1 Int) ) (!  (=> (and (and (= (type r_2@@9) RefType) (= (type r2@@1) RefType)) (= (p5 r_2@@9 i@@5) (p5 r2@@1 i2@@1))) (and (= r_2@@9 r2@@1) (= i@@5 i2@@1)))
 :qid |stdinbpl.634:15|
 :skolemid |104|
 :pattern ( (p5 r_2@@9 i@@5) (p5 r2@@1 i2@@1))
)))
(assert (forall ((arg0@@43 T@U) (arg1@@22 Int) ) (! (= (type (|p5#sm| arg0@@43 arg1@@22)) (FieldType PredicateType_p5Type (MapType1Type RefType boolType)))
 :qid |funType:p5#sm|
 :pattern ( (|p5#sm| arg0@@43 arg1@@22))
)))
(assert (forall ((r_2@@10 T@U) (i@@6 Int) (r2@@2 T@U) (i2@@2 Int) ) (!  (=> (and (and (= (type r_2@@10) RefType) (= (type r2@@2) RefType)) (= (|p5#sm| r_2@@10 i@@6) (|p5#sm| r2@@2 i2@@2))) (and (= r_2@@10 r2@@2) (= i@@6 i2@@2)))
 :qid |stdinbpl.638:15|
 :skolemid |105|
 :pattern ( (|p5#sm| r_2@@10 i@@6) (|p5#sm| r2@@2 i2@@2))
)))
...
(assert (forall ((arg0@@44 T@U) ) (! (= (type (|p2#sm| arg0@@44)) (FieldType PredicateType_p2Type (MapType1Type RefType boolType)))
 :qid |funType:p2#sm|
 :pattern ( (|p2#sm| arg0@@44))
)))
...
(assert (forall ((arg0@@45 T@U) ) (! (= (type (|p3#sm| arg0@@45)) (FieldType PredicateType_p3Type (MapType1Type RefType boolType)))
 :qid |funType:p3#sm|
 :pattern ( (|p3#sm| arg0@@45))
)))
...
(assert (forall ((arg0@@46 T@U) (arg1@@23 T@U) ) (! (let ((T@@13 (type arg1@@23)))
(= (type (|MultiSet#UnionOne| arg0@@46 arg1@@23)) (MultiSetType T@@13)))
 :qid |funType:MultiSet#UnionOne|
 :pattern ( (|MultiSet#UnionOne| arg0@@46 arg1@@23))
)))
...
(assert (forall ((r_2@@15 T@U) (i@@7 Int) ) (!  (=> (= (type r_2@@15) RefType) (= (getPredWandId (p4 r_2@@15 i@@7)) 3))
 :qid |stdinbpl.575:15|
 :skolemid |97|
 :pattern ( (p4 r_2@@15 i@@7))
)))
(assert (forall ((r_2@@16 T@U) (i@@8 Int) ) (!  (=> (= (type r_2@@16) RefType) (= (getPredWandId (p5 r_2@@16 i@@8)) 4))
 :qid |stdinbpl.628:15|
 :skolemid |103|
 :pattern ( (p5 r_2@@16 i@@8))
)))
...
(assert (forall ((r_2@@19 T@U) (i@@9 Int) ) (!  (=> (= (type r_2@@19) RefType) (= (PredicateMaskField (p4 r_2@@19 i@@9)) (|p4#sm| r_2@@19 i@@9)))
 :qid |stdinbpl.567:15|
 :skolemid |95|
 :pattern ( (PredicateMaskField (p4 r_2@@19 i@@9)))
)))
(assert (forall ((r_2@@20 T@U) (i@@10 Int) ) (!  (=> (= (type r_2@@20) RefType) (= (PredicateMaskField (p5 r_2@@20 i@@10)) (|p5#sm| r_2@@20 i@@10)))
 :qid |stdinbpl.620:15|
 :skolemid |101|
 :pattern ( (PredicateMaskField (p5 r_2@@20 i@@10)))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (= (type QPMask@0) (MapType1Type RefType realType)) (= (type z@@0) RefType)) (= (type y@@6) RefType)) (= (type x@@19) RefType)) (= (type Heap@@14) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (forall ((arg0@@51 T@U) ) (! (= (type (invRecv6 arg0@@51)) RefType)
 :qid |funType:invRecv6|
 :pattern ( (invRecv6 arg0@@51))
))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id m3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon8_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) r_1))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) r_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1 r_1_1))))
 :qid |stdinbpl.1040:17|
 :skolemid |133|
...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p2 z@@0))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p2 z@@0)))) (=> (= (ControlFlow 0 2) 1) anon6_correct))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (forall ((r_4 T@U) (r_4_1 T@U) ) (!  (=> (and (= (type r_4) RefType) (= (type r_4_1) RefType)) (=> (and (and (and (and (not (= r_4 r_4_1)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) r_4))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) r_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_4 r_4_1))))
 :qid |stdinbpl.1091:17|
 :skolemid |139|
 :pattern ( (neverTriggered6 r_4) (neverTriggered6 r_4_1))
))) (=> (forall ((r_4@@0 T@U) (r_4_1@@0 T@U) ) (!  (=> (and (= (type r_4@@0) RefType) (= (type r_4_1@@0) RefType)) (=> (and (and (and (and (not (= r_4@@0 r_4_1@@0)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) r_4@@0))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) r_4_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_4@@0 r_4_1@@0))))
 :qid |stdinbpl.1091:17|
 :skolemid |139|
 :pattern ( (neverTriggered6 r_4@@0) (neverTriggered6 r_4_1@@0))
)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((r_4@@1 T@U) ) (!  (=> (and (= (type r_4@@1) RefType) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) r_4@@1))) (>= (U_2_real (MapType1Select Mask@2 null (p2 r_4@@1))) FullPerm))
 :qid |stdinbpl.1098:17|
 :skolemid |140|
 :pattern ( (MapType0Select Heap@@14 null (p2 r_4@@1)))
 :pattern ( (MapType1Select Mask@2 null (p2 r_4@@1)))
 :pattern ( (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) r_4@@1))
))) (=> (forall ((r_4@@2 T@U) ) (!  (=> (and (= (type r_4@@2) RefType) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) r_4@@2))) (>= (U_2_real (MapType1Select Mask@2 null (p2 r_4@@2))) FullPerm))
 :qid |stdinbpl.1098:17|
 :skolemid |140|
 :pattern ( (MapType0Select Heap@@14 null (p2 r_4@@2)))
 :pattern ( (MapType1Select Mask@2 null (p2 r_4@@2)))
 :pattern ( (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) r_4@@2))
)) (=> (forall ((r_4@@3 T@U) ) (!  (=> (= (type r_4@@3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) r_4@@3)) (< NoPerm FullPerm)) (and (= (invRecv6 r_4@@3) r_4@@3) (qpRange6 r_4@@3))))
 :qid |stdinbpl.1104:22|
 :skolemid |141|
 :pattern ( (MapType0Select Heap@@14 null (p2 r_4@@3)))
 :pattern ( (MapType1Select Mask@2 null (p2 r_4@@3)))
 :pattern ( (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) r_4@@3))
)) (=> (and (and (forall ((r_5_1 T@U) ) (!  (=> (= (type r_5_1) RefType) (=> (and (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) (invRecv6 r_5_1))) (< NoPerm FullPerm)) (qpRange6 r_5_1)) (= (invRecv6 r_5_1) r_5_1)))
 :qid |stdinbpl.1108:22|
 :skolemid |142|
 :pattern ( (invRecv6 r_5_1))
)) (forall ((r_5_1@@0 T@U) ) (!  (=> (= (type r_5_1@@0) RefType) (=> (and (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) (invRecv6 r_5_1@@0))) (< NoPerm FullPerm)) (qpRange6 r_5_1@@0)) (and (= (invRecv6 r_5_1@@0) r_5_1@@0) (= (U_2_real (MapType1Select QPMask@0 null (p2 r_5_1@@0))) (- (U_2_real (MapType1Select Mask@2 null (p2 r_5_1@@0))) FullPerm)))))
 :qid |stdinbpl.1114:22|
 :skolemid |143|
 :pattern ( (MapType1Select QPMask@0 null (p2 r_5_1@@0)))
))) (and (forall ((r_5_1@@1 T@U) ) (!  (=> (and (= (type r_5_1@@1) RefType) (not (and (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) (invRecv6 r_5_1@@1))) (< NoPerm FullPerm)) (qpRange6 r_5_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (p2 r_5_1@@1))) (U_2_real (MapType1Select Mask@2 null (p2 r_5_1@@1)))))
 :qid |stdinbpl.1118:22|
 :skolemid |144|
 :pattern ( (MapType1Select QPMask@0 null (p2 r_5_1@@1)))
)) (forall ((o_3 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (or (or (not (= o_3 null)) (not (IsPredicateField f_5))) (not (= (getPredWandId f_5) 1)))) (= (U_2_real (MapType1Select Mask@2 o_3 f_5)) (U_2_real (MapType1Select QPMask@0 o_3 f_5))))))
 :qid |stdinbpl.1124:29|
 :skolemid |145|
 :pattern ( (MapType1Select Mask@2 o_3 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3 f_5))
)))) (and (=> (= (ControlFlow 0 5) 2) anon9_Then_correct) (=> (= (ControlFlow 0 5) 4) anon9_Else_correct))))))))))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@14 x@@19 $allocated)) (U_2_bool (MapType0Select Heap@@14 y@@6 $allocated))) (and (U_2_bool (MapType0Select Heap@@14 z@@0 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (p2 x@@19) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (p2 x@@19))) FullPerm)))))) (=> (and (and (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0)) (and (= Mask@1 (MapType1Store Mask@0 null (p2 y@@6) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (p2 y@@6))) FullPerm)))) (state Heap@@14 Mask@1))) (and (and (state Heap@@14 Mask@1) (= Mask@2 (MapType1Store Mask@1 null (p2 z@@0) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (p2 z@@0))) FullPerm))))) (and (state Heap@@14 Mask@2) (state Heap@@14 Mask@2)))) (and (=> (= (ControlFlow 0 12) 11) anon7_Then_correct) (=> (= (ControlFlow 0 12) 5) anon7_Else_correct)))))))
