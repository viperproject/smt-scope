...
(assert (forall ((ix@10@00 Int) (jx@11@00 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpredicates/basic/functions1.vpr@31@12@31@116-aux|)))
(assert (forall ((ix@10@00 Int) (jx@11@00 Int)) (!
  (=>
    (and
      (>= ix@10@00 0)
...
(assert (forall ((ix@16@00 Int) (jx@17@00 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpredicates/basic/functions1.vpr@7@12@7@116-aux|)))
(assert (forall ((ix@16@00 Int) (jx@17@00 Int)) (!
  (=>
    (and
      (>= ix@16@00 0)
