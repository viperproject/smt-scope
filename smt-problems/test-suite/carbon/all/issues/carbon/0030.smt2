...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 this@@5 $allocated))) (and (not (= this@@5 null)) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm ZeroMask this@@5 x@@8))))
