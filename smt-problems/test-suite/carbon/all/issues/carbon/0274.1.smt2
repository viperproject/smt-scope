...
(declare-fun node@@5 () T@U)
(declare-fun perm@0 () Real)
(assert  (and (= (type Heap@@10) (MapType1Type RefType)) (= (type node@@5) RefType)))
(set-info :boogie-vc-id |access_fields#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType1Select Heap@@10 node@@5 $allocated))) (and (= perm@0 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1)))) (>= perm@0 NoPerm))))
