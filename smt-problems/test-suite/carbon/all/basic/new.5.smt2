...
(assert  (and (and (and (and (and (and (and (and (and (and (= (type Heap@2) (MapType0Type RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type this@@5) RefType)) (= (type freshObj@0) RefType)) (= (type freshObj@1) RefType)) (= (type g) RefType)) (= (type Heap@@10) (MapType0Type RefType))) (= (type f1) RefType)) (= (type f2) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))))
...
(let ((anon10_Else_correct  (=> (and (and (not b_2) (state Heap@2 Mask@0)) (and (= d@0 3) (= (ControlFlow 0 5) 3))) anon7_correct)))
(let ((anon10_Then_correct  (=> (and (and b_2 (state Heap@2 Mask@0)) (and (= d@0 1) (= (ControlFlow 0 4) 3))) anon7_correct)))
(let ((anon4_correct  (=> (state Heap@2 Mask@0) (and (=> (= (ControlFlow 0 6) (- 0 10)) (HasDirectPerm Mask@0 this@@5 value)) (=> (HasDirectPerm Mask@0 this@@5 value) (and (=> (= (ControlFlow 0 6) (- 0 9)) (<= (U_2_int (MapType0Select Heap@2 this@@5 value)) 42)) (=> (<= (U_2_int (MapType0Select Heap@2 this@@5 value)) 42) (=> (state Heap@2 Mask@0) (and (=> (= (ControlFlow 0 6) (- 0 8)) (not (= freshObj@0 freshObj@1))) (=> (not (= freshObj@0 freshObj@1)) (=> (and (and (state Heap@2 Mask@0) (= a_2 (- 0 11))) (and (state Heap@2 Mask@0) (state Heap@2 Mask@0))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (< a_2 0)) (=> (< a_2 0) (=> (and (state Heap@2 Mask@0) (state Heap@2 Mask@0)) (and (=> (= (ControlFlow 0 6) 4) anon10_Then_correct) (=> (= (ControlFlow 0 6) 5) anon10_Else_correct))))))))))))))))
(let ((anon9_Else_correct  (=> (and (= g null) (= (ControlFlow 0 13) 6)) anon4_correct)))
(let ((anon9_Then_correct  (=> (not (= g null)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (not (= g freshObj@0))) (=> (not (= g freshObj@0)) (=> (and (state Heap@2 Mask@0) (= (ControlFlow 0 11) 6)) anon4_correct))))))
(let ((anon8_Else_correct  (=> (and (U_2_bool (MapType0Select Heap@@10 f1 $allocated)) (U_2_bool (MapType0Select Heap@@10 f2 $allocated))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (= FullPerm (U_2_real (MapType1Select Mask@0 this@@5 value)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 this@@5 value))) (=> (and (= Heap@0 (MapType0Store Heap@@10 this@@5 value (int_2_U 1))) (state Heap@0 Mask@0)) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@0 freshObj@0 $allocated)))) (and (= Heap@1 (MapType0Store Heap@0 freshObj@0 $allocated (bool_2_U true))) (state Heap@1 Mask@0))) (and (and (not (= freshObj@1 null)) (not (U_2_bool (MapType0Select Heap@1 freshObj@1 $allocated)))) (and (= Heap@2 (MapType0Store Heap@1 freshObj@1 $allocated (bool_2_U true))) (state Heap@2 Mask@0)))) (and (=> (= (ControlFlow 0 14) 11) anon9_Then_correct) (=> (= (ControlFlow 0 14) 13) anon9_Else_correct)))))))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (and (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 this@@5 $allocated))) (and (U_2_bool (MapType0Select Heap@@10 g $allocated)) b_2)) (and (and (not (= this@@5 null)) (= Mask@0 (MapType1Store ZeroMask this@@5 value (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@5 value)) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)))) (and (=> (= (ControlFlow 0 16) 1) anon8_Then_correct) (=> (= (ControlFlow 0 16) 14) anon8_Else_correct)))))
