...
(assert (= (type Heap@@17) (MapType0Type RefType)))
(set-info :boogie-vc-id |Ref__multidim_index_2#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) (= AssumeFunctionsAbove 0)) (and (<= 0 i0@@7) (state Heap@@17 ZeroMask))) (=> (and (and (and (and (< i0@@7 N0@@7) (state Heap@@17 ZeroMask)) (and (<= 0 N0@@7) (state Heap@@17 ZeroMask))) (and (and (<= 0 i1@@7) (state Heap@@17 ZeroMask)) (and (< i1@@7 N1@@7) (state Heap@@17 ZeroMask)))) (and (and (and (<= 0 N1@@7) (state Heap@@17 ZeroMask)) (and (<= 0 Result) (state Heap@@17 ZeroMask))) (and (and (< Result (* N0@@7 N1@@7)) (state Heap@@17 ZeroMask)) (and (= Result (+ (* i0@@7 N1@@7) i1@@7)) (state Heap@@17 ZeroMask))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (= N1@@7 0))) (=> (not (= N1@@7 0)) (=> (= (mod Result N1@@7) i1@@7) (=> (and (state Heap@@17 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (not (= N1@@7 0))))))))))
