...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon4_correct  (=> (and (= Heap@0 (MapType0Store Heap@@10 null (|P#sm| x@@14) (MapType1Store (MapType0Select Heap@@10 null (|P#sm| x@@14)) x@@14 p_2 (bool_2_U true)))) (state Heap@0 Mask@1)) (=> (and (and (and (and (|P#trigger| Heap@0 (P x@@14)) (= (MapType0Select Heap@0 null (P x@@14)) (FrameFragment (MapType0Select Heap@0 x@@14 p_2)))) (and (= UnfoldingMask@2 (MapType1Store Mask@1 null (P x@@14) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (P x@@14))) FullPerm)))) (not (= x@@14 null)))) (and (and (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 x@@14 p_2 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 x@@14 p_2)) FullPerm)))) (state Heap@0 UnfoldingMask@3)) (and (< NoPerm (U_2_real (MapType0Select Heap@0 x@@14 p_2))) (state Heap@0 UnfoldingMask@3)))) (and (and (and (<= (/ (to_real 1) (to_real 2)) (U_2_real (MapType1Select Mask@1 y@@1 f_7))) (<= (__iar__assume_helper_1 (= y@@1 z@@0) (/ (to_real 1) (to_real 2)) (U_2_real (MapType0Select Heap@0 x@@14 p_2))) (U_2_real (MapType1Select Mask@1 z@@0 f_7)))) (state Heap@0 Mask@1)) (and (state Heap@0 Mask@1) (= (ControlFlow 0 2) (- 0 1))))) false))))
(let ((anon6_Else_correct  (=> (and (< (U_2_real (MapType1Select UnfoldingMask@1 y@@1 f_7)) (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 5) 2)) anon4_correct)))
(let ((anon6_Then_correct  (=> (<= (/ (to_real 1) (to_real 2)) (U_2_real (MapType1Select UnfoldingMask@1 y@@1 f_7))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm UnfoldingMask@1 x@@14 p_2)) (=> (HasDirectPerm UnfoldingMask@1 x@@14 p_2) (=> (= (ControlFlow 0 3) 2) anon4_correct))))))
(let ((anon2_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@1 null (P x@@14) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (P x@@14))) FullPerm)))) (not (= x@@14 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x@@14 p_2 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@14 p_2)) FullPerm)))) (state Heap@@10 UnfoldingMask@1)) (and (< NoPerm (U_2_real (MapType0Select Heap@@10 x@@14 p_2))) (state Heap@@10 UnfoldingMask@1))) (and (=> (= (ControlFlow 0 6) 3) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct))))))
(let ((anon5_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (P x@@14))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (P x@@14)))) (=> (= (ControlFlow 0 7) 6) anon2_correct))))))
