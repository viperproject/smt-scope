...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon4_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 (|Seq#Index| ar@@27 (+ (* i@@34 N) j@@9)) Ref__Integer_value (real_2_U (- (U_2_real (MapType1Select Mask@0 (|Seq#Index| ar@@27 (+ (* i@@34 N) j@@9)) Ref__Integer_value)) FullPerm)))) (= (ControlFlow 0 8) (- 0 7))) (= (U_2_int (MapType0Select Heap@0 (|Seq#Index| ar@@27 (+ (* i@@34 N) j@@9)) Ref__Integer_value)) 0))))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@0 (|Seq#Index| ar@@27 (+ (* i@@34 N) j@@9)) Ref__Integer_value)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 (|Seq#Index| ar@@27 (+ (* i@@34 N) j@@9)) Ref__Integer_value))) (=> (= (ControlFlow 0 9) 8) anon4_correct))))))
(let ((anon5_Else_correct  (=> (U_2_bool (MapType0Select Heap@@33 __flatten_3 $allocated)) (and (=> (= (ControlFlow 0 12) (- 0 20)) (>= (+ (* i@@34 N) j@@9) 0)) (=> (>= (+ (* i@@34 N) j@@9) 0) (and (=> (= (ControlFlow 0 12) (- 0 19)) (< (+ (* i@@34 N) j@@9) (|Seq#Length| ar@@27))) (=> (< (+ (* i@@34 N) j@@9) (|Seq#Length| ar@@27)) (=> (= __flatten_3@0 (|Seq#Index| ar@@27 (+ (* i@@34 N) j@@9))) (=> (and (state Heap@@33 Mask@0) (state Heap@@33 Mask@0)) (and (=> (= (ControlFlow 0 12) (- 0 18)) (= FullPerm (U_2_real (MapType1Select Mask@0 __flatten_3@0 Ref__Integer_value)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 __flatten_3@0 Ref__Integer_value))) (=> (and (= Heap@0 (MapType0Store Heap@@33 __flatten_3@0 Ref__Integer_value (int_2_U 0))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 12) (- 0 17)) (<= 0 j@@9)) (=> (<= 0 j@@9) (and (=> (= (ControlFlow 0 12) (- 0 16)) (< j@@9 N)) (=> (< j@@9 N) (and (=> (= (ControlFlow 0 12) (- 0 15)) (<= 0 i@@34)) (=> (<= 0 i@@34) (and (=> (= (ControlFlow 0 12) (- 0 14)) (< i@@34 M)) (=> (< i@@34 M) (and (=> (= (ControlFlow 0 12) (- 0 13)) (= (* M N) (|Seq#Length| ar@@27))) (=> (= (* M N) (|Seq#Length| ar@@27)) (and (=> (= (ControlFlow 0 12) 9) anon6_Then_correct) (=> (= (ControlFlow 0 12) 11) anon6_Else_correct))))))))))))))))))))))))
(let ((anon5_Then_correct  (=> (and (and (and (state PostHeap@0 ZeroMask) (<= 0 j@@9)) (and (< j@@9 N) (state PostHeap@0 ZeroMask))) (and (and (<= 0 i@@34) (< i@@34 M)) (and (= (* M N) (|Seq#Length| ar@@27)) (state PostHeap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= (+ (* i@@34 N) j@@9) 0)) (=> (>= (+ (* i@@34 N) j@@9) 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< (+ (* i@@34 N) j@@9) (|Seq#Length| ar@@27))) (=> (< (+ (* i@@34 N) j@@9) (|Seq#Length| ar@@27)) (=> (and (and (not (= (|Seq#Index| ar@@27 (+ (* i@@34 N) j@@9)) null)) (= PostMask@0 (MapType1Store ZeroMask (|Seq#Index| ar@@27 (+ (* i@@34 N) j@@9)) Ref__Integer_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask (|Seq#Index| ar@@27 (+ (* i@@34 N) j@@9)) Ref__Integer_value)) FullPerm))))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= (+ (* i@@34 N) j@@9) 0)) (=> (>= (+ (* i@@34 N) j@@9) 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< (+ (* i@@34 N) j@@9) (|Seq#Length| ar@@27))) (=> (< (+ (* i@@34 N) j@@9) (|Seq#Length| ar@@27)) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm PostMask@0 (|Seq#Index| ar@@27 (+ (* i@@34 N) j@@9)) Ref__Integer_value))))))))))))))
(let ((anon0_correct  (=> (and (and (and (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@33 diz $allocated)) (not (= diz null)))) (and (and (state Heap@@33 ZeroMask) (>= current_thread_id 0)) (and (state Heap@@33 ZeroMask) (<= 0 j@@9)))) (and (and (and (< j@@9 N) (state Heap@@33 ZeroMask)) (and (<= 0 i@@34) (< i@@34 M))) (and (and (= (* M N) (|Seq#Length| ar@@27)) (state Heap@@33 ZeroMask)) (and (< (+ (* i@@34 N) j@@9) (|Seq#Length| ar@@27)) (state Heap@@33 ZeroMask))))) (and (=> (= (ControlFlow 0 21) (- 0 23)) (>= (+ (* i@@34 N) j@@9) 0)) (=> (>= (+ (* i@@34 N) j@@9) 0) (and (=> (= (ControlFlow 0 21) (- 0 22)) (< (+ (* i@@34 N) j@@9) (|Seq#Length| ar@@27))) (=> (< (+ (* i@@34 N) j@@9) (|Seq#Length| ar@@27)) (=> (and (and (not (= (|Seq#Index| ar@@27 (+ (* i@@34 N) j@@9)) null)) (= Mask@0 (MapType1Store ZeroMask (|Seq#Index| ar@@27 (+ (* i@@34 N) j@@9)) Ref__Integer_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask (|Seq#Index| ar@@27 (+ (* i@@34 N) j@@9)) Ref__Integer_value)) FullPerm))))) (and (state Heap@@33 Mask@0) (state Heap@@33 Mask@0))) (and (=> (= (ControlFlow 0 21) 2) anon5_Then_correct) (=> (= (ControlFlow 0 21) 12) anon5_Else_correct))))))))))
