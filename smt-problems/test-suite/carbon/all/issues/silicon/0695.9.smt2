...
(assert  (and (and (and (and (= (type x@@67) RefType) (= (type Mask@0) (MapType2Type RefType realType))) (= (type Heap@@25) (MapType1Type RefType))) (= (type Mask@1) (MapType2Type RefType realType))) (= (type Mask@2) (MapType2Type RefType realType))))
...
(let ((anon3_Then_correct  (=> (and (and (not (= x@@67 null)) (not (= x@@67 null))) (and (= Mask@0 (MapType2Store ZeroMask x@@67 ref (real_2_U (+ (U_2_real (MapType2Select ZeroMask x@@67 ref)) FullPerm)))) (state Heap@@25 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 x@@67 ref)) (=> (HasDirectPerm Mask@0 x@@67 ref) (=> (and (and (= Mask@1 (MapType2Store Mask@0 null (Node (MapType1Select Heap@@25 x@@67 ref)) (real_2_U (+ (U_2_real (MapType2Select Mask@0 null (Node (MapType1Select Heap@@25 x@@67 ref)))) FullPerm)))) (state Heap@@25 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 2) 1))) anon2_correct))))))
