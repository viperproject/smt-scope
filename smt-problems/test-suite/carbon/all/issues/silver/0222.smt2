...
(assert  (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type y@@1) RefType)) (= (type freshObj@0) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 y@@1 $allocated))) (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@9 freshObj@0 $allocated))))) (=> (and (and (and (= Heap@0 (MapType0Store Heap@@9 freshObj@0 $allocated (bool_2_U true))) (state Heap@0 ZeroMask)) (and (not (= freshObj@0 null)) (= Mask@0 (MapType1Store ZeroMask freshObj@0 val (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 val)) FullPerm)))))) (and (and (state Heap@0 Mask@0) (state Heap@0 Mask@0)) (and (state Heap@0 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) false))))
