...
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@5 r_1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@5 r_1 f_7))) (=> (= (ControlFlow 0 4) 3) anon9_correct))))))
(let ((anon7_correct  (=> (= Mask@5 (MapType1Store Mask@3 r_1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@3 r_1 f_7)) FullPerm)))) (=> (and (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@1 Mask@5) (state ExhaleHeap@1 Mask@5)) (and (=> (= (ControlFlow 0 7) 4) anon15_Then_correct) (=> (= (ControlFlow 0 7) 6) anon15_Else_correct))))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select Mask@3 r_1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 r_1 f_7))) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
(let ((anon13_Then_correct  (=> (and (state ExhaleHeap@0 ZeroMask) (not (= r_1 null))) (=> (and (and (= Mask@3 (MapType1Store ZeroMask r_1 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1 f_7)) FullPerm)))) (state ExhaleHeap@0 Mask@3)) (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3))) (and (=> (= (ControlFlow 0 11) 8) anon14_Then_correct) (=> (= (ControlFlow 0 11) 10) anon14_Else_correct))))))
(let ((anon13_Else_correct true))
(let ((anon12_Then_correct true))
(let ((anon2_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 r_1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 r_1 f_7)) FullPerm)))) (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@1)) (and (and (=> (= (ControlFlow 0 12) 1) anon12_Then_correct) (=> (= (ControlFlow 0 12) 11) anon13_Then_correct)) (=> (= (ControlFlow 0 12) 2) anon13_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 15) 12)) anon2_correct)))
(let ((anon11_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= FullPerm (U_2_real (MapType1Select Mask@0 r_1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 r_1 f_7))) (=> (= (ControlFlow 0 13) 12) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 r_1 $allocated))) (=> (and (and (not (= r_1 null)) (= Mask@0 (MapType1Store ZeroMask r_1 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1 f_7)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 16) 13) anon11_Then_correct) (=> (= (ControlFlow 0 16) 15) anon11_Else_correct))))))
