...
(assert  (and (and (and (and (and (= (type Heap@@37) (MapType0Type RefType)) (= (type diz@@37) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |List__state#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (= (MapType0Select Heap@@37 diz@@37 List__next) null) (=> (and (= Mask@3 Mask@1) (= (ControlFlow 0 4) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (not (= (MapType0Select Heap@@37 diz@@37 List__next) null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 diz@@37 List__next)) (=> (HasDirectPerm Mask@1 diz@@37 List__next) (=> (and (and (= Mask@2 (MapType1Store Mask@1 null (List__state (MapType0Select Heap@@37 diz@@37 List__next)) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (List__state (MapType0Select Heap@@37 diz@@37 List__next)))) FullPerm)))) (state Heap@@37 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 2) 1))) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@37 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@37 diz@@37 $allocated))) (and (not (= diz@@37 null)) (= Mask@0 (MapType1Store ZeroMask diz@@37 List__val (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz@@37 List__val)) FullPerm)))))) (and (and (state Heap@@37 Mask@0) (not (= diz@@37 null))) (and (= Mask@1 (MapType1Store Mask@0 diz@@37 List__next (real_2_U (+ (U_2_real (MapType1Select Mask@0 diz@@37 List__next)) FullPerm)))) (state Heap@@37 Mask@1)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@1 diz@@37 List__next)) (=> (HasDirectPerm Mask@1 diz@@37 List__next) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))))
