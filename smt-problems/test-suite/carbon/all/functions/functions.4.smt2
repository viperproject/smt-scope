...
(assert  (and (and (and (and (= (type UnfoldingMask@0) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type x@@56) RefType)) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Heap@@47) (MapType0Type RefType))))
(set-info :boogie-vc-id |fun3#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (P x@@56) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P x@@56))) FullPerm)))) (not (= x@@56 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x@@56 g (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@56 g)) FullPerm)))) (state Heap@@47 UnfoldingMask@1)) (and (state Heap@@47 UnfoldingMask@1) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm UnfoldingMask@1 x@@56 g)))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P x@@56))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P x@@56)))) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@47 ZeroMask) (U_2_bool (MapType0Select Heap@@47 x@@56 $allocated))) (and (= AssumeFunctionsAbove 4) (= Mask@0 (MapType1Store ZeroMask null (P x@@56) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@56))) FullPerm)))))) (and (and (state Heap@@47 Mask@0) (state Heap@@47 Mask@0)) (and (|P#trigger| Heap@@47 (P x@@56)) (= (MapType0Select Heap@@47 null (P x@@56)) (FrameFragment (MapType0Select Heap@@47 x@@56 g)))))) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))
