...
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type x_2) RefType)) (= (type y@@2) RefType)) (= (type QPMask@3) (MapType1Type RefType realType))) (= (type z_15) RefType)) (forall ((arg0@@35 T@U) ) (! (= (type (invRecv27 arg0@@35)) RefType)
 :qid |funType:invRecv27|
 :pattern ( (invRecv27 arg0@@35))
))) (= (type QPMask@2) (MapType1Type RefType realType))) (forall ((arg0@@36 T@U) ) (! (= (type (invRecv26 arg0@@36)) RefType)
 :qid |funType:invRecv26|
 :pattern ( (invRecv26 arg0@@36))
))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@37 T@U) ) (! (= (type (invRecv25 arg0@@37)) RefType)
 :qid |funType:invRecv25|
 :pattern ( (invRecv25 arg0@@37))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@38 T@U) ) (! (= (type (invRecv24 arg0@@38)) RefType)
 :qid |funType:invRecv24|
 :pattern ( (invRecv24 arg0@@38))
))))
...
(let ((anon20_Else_correct  (=> (and (>= 0 (U_2_int (MapType0Select Heap@@13 z_15 f_7))) (= (ControlFlow 0 13) 9)) anon12_correct)))
(let ((anon20_Then_correct  (=> (> (U_2_int (MapType0Select Heap@@13 z_15 f_7)) 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm QPMask@3 z_15 g)) (=> (HasDirectPerm QPMask@3 z_15 g) (=> (= (ControlFlow 0 11) 9) anon12_correct))))))
(let ((anon19_Then_correct  (=> (or (= z_15 x_2) (= z_15 y@@2)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm QPMask@3 z_15 f_7)) (=> (HasDirectPerm QPMask@3 z_15 f_7) (and (=> (= (ControlFlow 0 14) 11) anon20_Then_correct) (=> (= (ControlFlow 0 14) 13) anon20_Else_correct)))))))
(let ((anon19_Else_correct  (=> (and (not (or (= z_15 x_2) (= z_15 y@@2))) (= (ControlFlow 0 10) 9)) anon12_correct)))
...
)) (=> (and (and (forall ((z_7@@1 T@U) ) (!  (=> (= (type z_7@@1) RefType) (=> (and (= z_7@@1 y@@2) (< NoPerm FullPerm)) (and (qpRange27 z_7@@1) (= (invRecv27 z_7@@1) z_7@@1))))
 :qid |stdinbpl.2602:22|
 :skolemid |229|
 :pattern ( (MapType0Select Heap@@13 z_7@@1 g))
 :pattern ( (MapType1Select QPMask@3 z_7@@1 g))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (= (invRecv27 o_3) y@@2) (< NoPerm FullPerm)) (qpRange27 o_3)) (= (invRecv27 o_3) o_3)))
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (= (invRecv27 o_3@@0) y@@2) (< NoPerm FullPerm)) (qpRange27 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv27 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@3 o_3@@0 g)) (+ (U_2_real (MapType1Select QPMask@2 o_3@@0 g)) FullPerm)))) (=> (not (and (and (= (invRecv27 o_3@@0) y@@2) (< NoPerm FullPerm)) (qpRange27 o_3@@0))) (= (U_2_real (MapType1Select QPMask@3 o_3@@0 g)) (U_2_real (MapType1Select QPMask@2 o_3@@0 g))))))
...
)) (=> (and (and (and (forall ((z_5@@1 T@U) ) (!  (=> (= (type z_5@@1) RefType) (=> (and (= z_5@@1 x_2) (< NoPerm FullPerm)) (and (qpRange26 z_5@@1) (= (invRecv26 z_5@@1) z_5@@1))))
 :qid |stdinbpl.2559:22|
 :skolemid |223|
 :pattern ( (MapType0Select Heap@@13 z_5@@1 g))
 :pattern ( (MapType1Select QPMask@2 z_5@@1 g))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (= (invRecv26 o_3@@2) x_2) (< NoPerm FullPerm)) (qpRange26 o_3@@2)) (= (invRecv26 o_3@@2) o_3@@2)))
...
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (= (invRecv26 o_3@@3) x_2) (< NoPerm FullPerm)) (qpRange26 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv26 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@2 o_3@@3 g)) (+ (U_2_real (MapType1Select QPMask@1 o_3@@3 g)) FullPerm)))) (=> (not (and (and (= (invRecv26 o_3@@3) x_2) (< NoPerm FullPerm)) (qpRange26 o_3@@3))) (= (U_2_real (MapType1Select QPMask@2 o_3@@3 g)) (U_2_real (MapType1Select QPMask@1 o_3@@3 g))))))
...
)) (=> (and (and (and (forall ((z_3@@1 T@U) ) (!  (=> (= (type z_3@@1) RefType) (=> (and (= z_3@@1 y@@2) (< NoPerm FullPerm)) (and (qpRange25 z_3@@1) (= (invRecv25 z_3@@1) z_3@@1))))
 :qid |stdinbpl.2516:22|
 :skolemid |217|
 :pattern ( (MapType0Select Heap@@13 z_3@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 z_3@@1 f_7))
)) (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (= (invRecv25 o_3@@5) y@@2) (< NoPerm FullPerm)) (qpRange25 o_3@@5)) (= (invRecv25 o_3@@5) o_3@@5)))
 :qid |stdinbpl.2520:22|
 :skolemid |218|
 :pattern ( (invRecv25 o_3@@5))
...
)) (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (= (invRecv25 o_3@@6) y@@2) (< NoPerm FullPerm)) (qpRange25 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv25 o_3@@6) o_3@@6)) (= (U_2_real (MapType1Select QPMask@1 o_3@@6 f_7)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) FullPerm)))) (=> (not (and (and (= (invRecv25 o_3@@6) y@@2) (< NoPerm FullPerm)) (qpRange25 o_3@@6))) (= (U_2_real (MapType1Select QPMask@1 o_3@@6 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7))))))
...
)) (=> (and (and (and (forall ((z_1@@1 T@U) ) (!  (=> (= (type z_1@@1) RefType) (=> (and (= z_1@@1 x_2) (< NoPerm FullPerm)) (and (qpRange24 z_1@@1) (= (invRecv24 z_1@@1) z_1@@1))))
 :qid |stdinbpl.2473:22|
 :skolemid |211|
 :pattern ( (MapType0Select Heap@@13 z_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@1 f_7))
)) (forall ((o_3@@8 T@U) ) (!  (=> (= (type o_3@@8) RefType) (=> (and (and (= (invRecv24 o_3@@8) x_2) (< NoPerm FullPerm)) (qpRange24 o_3@@8)) (= (invRecv24 o_3@@8) o_3@@8)))
...
)) (forall ((o_3@@9 T@U) ) (!  (=> (= (type o_3@@9) RefType) (and (=> (and (and (= (invRecv24 o_3@@9) x_2) (< NoPerm FullPerm)) (qpRange24 o_3@@9)) (and (=> (< NoPerm FullPerm) (= (invRecv24 o_3@@9) o_3@@9)) (= (U_2_real (MapType1Select QPMask@0 o_3@@9 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@9 f_7)) FullPerm)))) (=> (not (and (and (= (invRecv24 o_3@@9) x_2) (< NoPerm FullPerm)) (qpRange24 o_3@@9))) (= (U_2_real (MapType1Select QPMask@0 o_3@@9 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@9 f_7))))))
