...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 64) (let ((anon64_Then_correct  (and (=> (= (ControlFlow 0 52) (- 0 53)) (forall ((n_14 T@U) (n_14_1 T@U) ) (!  (=> (and (= (type n_14) RefType) (= (type n_14_1) RefType)) (=> (and (and (and (and (not (= n_14 n_14_1)) (U_2_bool (MapType2Select g1@@10 n_14))) (U_2_bool (MapType2Select g1@@10 n_14_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_14 n_14_1))))
 :qid |stdinbpl.1403:27|
 :skolemid |169|
 :pattern ( (neverTriggered9 n_14) (neverTriggered9 n_14_1))
 ...
 :qid |stdinbpl.1403:27|
 :skolemid |169|
 :pattern ( (neverTriggered9 n_14@@0) (neverTriggered9 n_14_1@@0))
)) (=> (= (ControlFlow 0 52) (- 0 51)) (forall ((n_14@@1 T@U) ) (!  (=> (and (= (type n_14@@1) RefType) (U_2_bool (MapType2Select g1@@10 n_14@@1))) (>= (U_2_real (MapType1Select QPMask@1 n_14@@1 next)) FullPerm))
 :qid |stdinbpl.1410:27|
 :skolemid |170|
 :pattern ( (MapType0Select Heap@@35 n_14@@1 next))
 :pattern ( (MapType1Select QPMask@2 n_14@@1 next))
 :pattern ( (MapType0Select Heap@@35 n_14@@1 next))
)))))))
(let ((anon66_Then_correct  (and (=> (= (ControlFlow 0 46) (- 0 47)) (forall ((n_15 T@U) (n_15_1 T@U) ) (!  (=> (and (= (type n_15) RefType) (= (type n_15_1) RefType)) (=> (and (and (and (and (not (= n_15 n_15_1)) (U_2_bool (MapType2Select (|Set#Union| g1@@10 g0@@10) n_15))) (U_2_bool (MapType2Select (|Set#Union| g1@@10 g0@@10) n_15_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_15 n_15_1))))
 :qid |stdinbpl.1458:25|
 :skolemid |175|
 :pattern ( (neverTriggered10 n_15) (neverTriggered10 n_15_1))
))) (=> (forall ((n_15@@0 T@U) (n_15_1@@0 T@U) ) (!  (=> (and (= (type n_15@@0) RefType) (= (type n_15_1@@0) RefType)) (=> (and (and (and (and (not (= n_15@@0 n_15_1@@0)) (U_2_bool (MapType2Select (|Set#Union| g1@@10 g0@@10) n_15@@0))) (U_2_bool (MapType2Select (|Set#Union| g1@@10 g0@@10) n_15_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_15@@0 n_15_1@@0))))
 :qid |stdinbpl.1458:25|
 :skolemid |175|
 :pattern ( (neverTriggered10 n_15@@0) (neverTriggered10 n_15_1@@0))
)) (=> (= (ControlFlow 0 46) (- 0 45)) (forall ((n_15@@1 T@U) ) (!  (=> (and (= (type n_15@@1) RefType) (U_2_bool (MapType2Select (|Set#Union| g1@@10 g0@@10) n_15@@1))) (>= (U_2_real (MapType1Select QPMask@1 n_15@@1 next)) FullPerm))
 :qid |stdinbpl.1465:25|
 :skolemid |176|
 :pattern ( (MapType0Select Heap@@35 n_15@@1 next))
 :pattern ( (MapType1Select QPMask@3 n_15@@1 next))
 :pattern ( (MapType0Select Heap@@35 n_15@@1 next))
)))))))
(let ((anon39_correct true))
(let ((anon65_Then_correct  (=> (and (U_2_bool (MapType2Select g1@@10 u_10)) (and (U_2_bool (MapType2Select g1@@10 v_10)) (not (exists_path ($$ Heap@@35 g1@@10) u_10 v_10)))) (and (=> (= (ControlFlow 0 48) 46) anon66_Then_correct) (=> (= (ControlFlow 0 48) 43) anon39_correct)))))
(let ((anon65_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g1@@10 u_10)) (and (U_2_bool (MapType2Select g1@@10 v_10)) (not (exists_path ($$ Heap@@35 g1@@10) u_10 v_10))))) (= (ControlFlow 0 44) 43)) anon39_correct)))
(let ((anon63_Then_correct  (=> (U_2_bool (MapType2Select g1@@10 v_10)) (and (and (=> (= (ControlFlow 0 54) 52) anon64_Then_correct) (=> (= (ControlFlow 0 54) 48) anon65_Then_correct)) (=> (= (ControlFlow 0 54) 44) anon65_Else_correct)))))
(let ((anon63_Else_correct  (=> (not (U_2_bool (MapType2Select g1@@10 v_10))) (and (=> (= (ControlFlow 0 50) 48) anon65_Then_correct) (=> (= (ControlFlow 0 50) 44) anon65_Else_correct)))))
(let ((anon62_Then_correct  (=> (U_2_bool (MapType2Select g1@@10 u_10)) (and (=> (= (ControlFlow 0 55) 54) anon63_Then_correct) (=> (= (ControlFlow 0 55) 50) anon63_Else_correct)))))
(let ((anon62_Else_correct  (=> (not (U_2_bool (MapType2Select g1@@10 u_10))) (and (=> (= (ControlFlow 0 49) 48) anon65_Then_correct) (=> (= (ControlFlow 0 49) 44) anon65_Else_correct)))))
(let ((anon61_Else_correct true))
(let ((anon55_Else_correct  (=> (forall ((u_9 T@U) (v_9 T@U) ) (!  (=> (and (and (= (type u_9) RefType) (= (type v_9) RefType)) (and (U_2_bool (MapType2Select g0@@10 u_9)) (and (U_2_bool (MapType2Select g0@@10 v_9)) (not (exists_path ($$ Heap@@35 g0@@10) u_9 v_9))))) (not (exists_path ($$ Heap@@35 (|Set#Union| g0@@10 g1@@10)) u_9 v_9)))
 :qid |stdinbpl.1381:20|
 :skolemid |168|
 :pattern ( (MapType2Select g0@@10 u_9) (MapType2Select g0@@10 v_9))
 :pattern ( (MapType2Select g0@@10 u_9) (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp3| Heap@@35 g0@@10))) g0@@10) u_9 v_9))
 :pattern ( (MapType2Select g0@@10 u_9) (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp3| Heap@@35 (|Set#Union| g0@@10 g1@@10)))) (|Set#Union| g0@@10 g1@@10)) u_9 v_9))
 :pattern ( (MapType2Select g0@@10 v_9) (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp3| Heap@@35 g0@@10))) g0@@10) u_9 v_9))
 :pattern ( (MapType2Select g0@@10 v_9) (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp3| Heap@@35 (|Set#Union| g0@@10 g1@@10)))) (|Set#Union| g0@@10 g1@@10)) u_9 v_9))
 :pattern ( (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp3| Heap@@35 g0@@10))) g0@@10) u_9 v_9))
 :pattern ( (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp3| Heap@@35 (|Set#Union| g0@@10 g1@@10)))) (|Set#Union| g0@@10 g1@@10)) u_9 v_9))
)) (=> (and (state Heap@@35 QPMask@1) (state Heap@@35 QPMask@1)) (and (and (=> (= (ControlFlow 0 56) 42) anon61_Else_correct) (=> (= (ControlFlow 0 56) 55) anon62_Then_correct)) (=> (= (ControlFlow 0 56) 49) anon62_Else_correct))))))
(let ((anon58_Then_correct  (and (=> (= (ControlFlow 0 38) (- 0 39)) (forall ((n_12 T@U) (n_12_1 T@U) ) (!  (=> (and (= (type n_12) RefType) (= (type n_12_1) RefType)) (=> (and (and (and (and (not (= n_12 n_12_1)) (U_2_bool (MapType2Select g0@@10 n_12))) (U_2_bool (MapType2Select g0@@10 n_12_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_12 n_12_1))))
 :qid |stdinbpl.1282:27|
 :skolemid |156|
 :pattern ( (neverTriggered7 n_12) (neverTriggered7 n_12_1))
))) (=> (forall ((n_12@@0 T@U) (n_12_1@@0 T@U) ) (!  (=> (and (= (type n_12@@0) RefType) (= (type n_12_1@@0) RefType)) (=> (and (and (and (and (not (= n_12@@0 n_12_1@@0)) (U_2_bool (MapType2Select g0@@10 n_12@@0))) (U_2_bool (MapType2Select g0@@10 n_12_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_12@@0 n_12_1@@0))))
 :qid |stdinbpl.1282:27|
 :skolemid |156|
 :pattern ( (neverTriggered7 n_12@@0) (neverTriggered7 n_12_1@@0))
)) (=> (= (ControlFlow 0 38) (- 0 37)) (forall ((n_12@@1 T@U) ) (!  (=> (and (= (type n_12@@1) RefType) (U_2_bool (MapType2Select g0@@10 n_12@@1))) (>= (U_2_real (MapType1Select QPMask@1 n_12@@1 next)) FullPerm))
 :qid |stdinbpl.1289:27|
 :skolemid |157|
 :pattern ( (MapType0Select Heap@@35 n_12@@1 next))
 :pattern ( (MapType1Select QPMask@4 n_12@@1 next))
 :pattern ( (MapType0Select Heap@@35 n_12@@1 next))
)))))))
(let ((anon60_Then_correct  (and (=> (= (ControlFlow 0 32) (- 0 33)) (forall ((n_13 T@U) (n_13_1 T@U) ) (!  (=> (and (= (type n_13) RefType) (= (type n_13_1) RefType)) (=> (and (and (and (and (not (= n_13 n_13_1)) (U_2_bool (MapType2Select (|Set#Union| g0@@10 g1@@10) n_13))) (U_2_bool (MapType2Select (|Set#Union| g0@@10 g1@@10) n_13_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_13 n_13_1))))
 :qid |stdinbpl.1337:25|
 :skolemid |162|
 :pattern ( (neverTriggered8 n_13) (neverTriggered8 n_13_1))
))) (=> (forall ((n_13@@0 T@U) (n_13_1@@0 T@U) ) (!  (=> (and (= (type n_13@@0) RefType) (= (type n_13_1@@0) RefType)) (=> (and (and (and (and (not (= n_13@@0 n_13_1@@0)) (U_2_bool (MapType2Select (|Set#Union| g0@@10 g1@@10) n_13@@0))) (U_2_bool (MapType2Select (|Set#Union| g0@@10 g1@@10) n_13_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_13@@0 n_13_1@@0))))
 :qid |stdinbpl.1337:25|
 :skolemid |162|
 :pattern ( (neverTriggered8 n_13@@0) (neverTriggered8 n_13_1@@0))
)) (=> (= (ControlFlow 0 32) (- 0 31)) (forall ((n_13@@1 T@U) ) (!  (=> (and (= (type n_13@@1) RefType) (U_2_bool (MapType2Select (|Set#Union| g0@@10 g1@@10) n_13@@1))) (>= (U_2_real (MapType1Select QPMask@1 n_13@@1 next)) FullPerm))
 :qid |stdinbpl.1344:25|
 :skolemid |163|
...
(let ((anon59_Then_correct  (=> (and (U_2_bool (MapType2Select g0@@10 u_8)) (and (U_2_bool (MapType2Select g0@@10 v_8)) (not (exists_path ($$ Heap@@35 g0@@10) u_8 v_8)))) (and (=> (= (ControlFlow 0 34) 32) anon60_Then_correct) (=> (= (ControlFlow 0 34) 29) anon30_correct)))))
(let ((anon59_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g0@@10 u_8)) (and (U_2_bool (MapType2Select g0@@10 v_8)) (not (exists_path ($$ Heap@@35 g0@@10) u_8 v_8))))) (= (ControlFlow 0 30) 29)) anon30_correct)))
(let ((anon57_Then_correct  (=> (U_2_bool (MapType2Select g0@@10 v_8)) (and (and (=> (= (ControlFlow 0 40) 38) anon58_Then_correct) (=> (= (ControlFlow 0 40) 34) anon59_Then_correct)) (=> (= (ControlFlow 0 40) 30) anon59_Else_correct)))))
(let ((anon57_Else_correct  (=> (not (U_2_bool (MapType2Select g0@@10 v_8))) (and (=> (= (ControlFlow 0 36) 34) anon59_Then_correct) (=> (= (ControlFlow 0 36) 30) anon59_Else_correct)))))
(let ((anon56_Then_correct  (=> (U_2_bool (MapType2Select g0@@10 u_8)) (and (=> (= (ControlFlow 0 41) 40) anon57_Then_correct) (=> (= (ControlFlow 0 41) 36) anon57_Else_correct)))))
(let ((anon56_Else_correct  (=> (not (U_2_bool (MapType2Select g0@@10 u_8))) (and (=> (= (ControlFlow 0 35) 34) anon59_Then_correct) (=> (= (ControlFlow 0 35) 30) anon59_Else_correct)))))
(let ((anon49_Else_correct  (=> (forall ((u_7 T@U) (v_7 T@U) ) (!  (=> (and (and (= (type u_7) RefType) (= (type v_7) RefType)) (and (U_2_bool (MapType2Select g1@@10 u_7)) (and (U_2_bool (MapType2Select g1@@10 v_7)) (exists_path ($$ Heap@@35 g1@@10) u_7 v_7)))) (exists_path ($$ Heap@@35 (|Set#Union| g1@@10 g0@@10)) u_7 v_7))
 :qid |stdinbpl.1260:20|
 :skolemid |155|
 :pattern ( (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp3| Heap@@35 g1@@10))) g1@@10) u_7 v_7))
 :pattern ( (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp3| Heap@@35 (|Set#Union| g1@@10 g0@@10)))) (|Set#Union| g1@@10 g0@@10)) u_7 v_7))
)) (=> (and (state Heap@@35 QPMask@1) (state Heap@@35 QPMask@1)) (and (and (=> (= (ControlFlow 0 57) 56) anon55_Else_correct) (=> (= (ControlFlow 0 57) 41) anon56_Then_correct)) (=> (= (ControlFlow 0 57) 35) anon56_Else_correct))))))
(let ((anon52_Then_correct  (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((n_10 T@U) (n_10_1 T@U) ) (!  (=> (and (= (type n_10) RefType) (= (type n_10_1) RefType)) (=> (and (and (and (and (not (= n_10 n_10_1)) (U_2_bool (MapType2Select g1@@10 n_10))) (U_2_bool (MapType2Select g1@@10 n_10_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_10 n_10_1))))
 :qid |stdinbpl.1161:27|
 :skolemid |143|
 :pattern ( (neverTriggered5 n_10) (neverTriggered5 n_10_1))
))) (=> (forall ((n_10@@0 T@U) (n_10_1@@0 T@U) ) (!  (=> (and (= (type n_10@@0) RefType) (= (type n_10_1@@0) RefType)) (=> (and (and (and (and (not (= n_10@@0 n_10_1@@0)) (U_2_bool (MapType2Select g1@@10 n_10@@0))) (U_2_bool (MapType2Select g1@@10 n_10_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_10@@0 n_10_1@@0))))
 :qid |stdinbpl.1161:27|
 :skolemid |143|
 :pattern ( (neverTriggered5 n_10@@0) (neverTriggered5 n_10_1@@0))
)) (=> (= (ControlFlow 0 25) (- 0 24)) (forall ((n_10@@1 T@U) ) (!  (=> (and (= (type n_10@@1) RefType) (U_2_bool (MapType2Select g1@@10 n_10@@1))) (>= (U_2_real (MapType1Select QPMask@1 n_10@@1 next)) FullPerm))
 :qid |stdinbpl.1168:27|
 :skolemid |144|
 :pattern ( (MapType0Select Heap@@35 n_10@@1 next))
 :pattern ( (MapType1Select QPMask@6 n_10@@1 next))
 :pattern ( (MapType0Select Heap@@35 n_10@@1 next))
)))))))
(let ((anon54_Then_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((n_11 T@U) (n_11_1 T@U) ) (!  (=> (and (= (type n_11) RefType) (= (type n_11_1) RefType)) (=> (and (and (and (and (not (= n_11 n_11_1)) (U_2_bool (MapType2Select (|Set#Union| g1@@10 g0@@10) n_11))) (U_2_bool (MapType2Select (|Set#Union| g1@@10 g0@@10) n_11_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_11 n_11_1))))
 :qid |stdinbpl.1216:25|
 :skolemid |149|
 :pattern ( (neverTriggered6 n_11) (neverTriggered6 n_11_1))
))) (=> (forall ((n_11@@0 T@U) (n_11_1@@0 T@U) ) (!  (=> (and (= (type n_11@@0) RefType) (= (type n_11_1@@0) RefType)) (=> (and (and (and (and (not (= n_11@@0 n_11_1@@0)) (U_2_bool (MapType2Select (|Set#Union| g1@@10 g0@@10) n_11@@0))) (U_2_bool (MapType2Select (|Set#Union| g1@@10 g0@@10) n_11_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_11@@0 n_11_1@@0))))
 :qid |stdinbpl.1216:25|
 :skolemid |149|
 :pattern ( (neverTriggered6 n_11@@0) (neverTriggered6 n_11_1@@0))
)) (=> (= (ControlFlow 0 19) (- 0 18)) (forall ((n_11@@1 T@U) ) (!  (=> (and (= (type n_11@@1) RefType) (U_2_bool (MapType2Select (|Set#Union| g1@@10 g0@@10) n_11@@1))) (>= (U_2_real (MapType1Select QPMask@1 n_11@@1 next)) FullPerm))
 :qid |stdinbpl.1223:25|
 :skolemid |150|
 :pattern ( (MapType0Select Heap@@35 n_11@@1 next))
 :pattern ( (MapType1Select QPMask@7 n_11@@1 next))
 :pattern ( (MapType0Select Heap@@35 n_11@@1 next))
)))))))
(let ((anon21_correct true))
(let ((anon53_Then_correct  (=> (and (U_2_bool (MapType2Select g1@@10 u_6)) (and (U_2_bool (MapType2Select g1@@10 v_6)) (exists_path ($$ Heap@@35 g1@@10) u_6 v_6))) (and (=> (= (ControlFlow 0 21) 19) anon54_Then_correct) (=> (= (ControlFlow 0 21) 16) anon21_correct)))))
(let ((anon53_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g1@@10 u_6)) (and (U_2_bool (MapType2Select g1@@10 v_6)) (exists_path ($$ Heap@@35 g1@@10) u_6 v_6)))) (= (ControlFlow 0 17) 16)) anon21_correct)))
(let ((anon51_Then_correct  (=> (U_2_bool (MapType2Select g1@@10 v_6)) (and (and (=> (= (ControlFlow 0 27) 25) anon52_Then_correct) (=> (= (ControlFlow 0 27) 21) anon53_Then_correct)) (=> (= (ControlFlow 0 27) 17) anon53_Else_correct)))))
(let ((anon51_Else_correct  (=> (not (U_2_bool (MapType2Select g1@@10 v_6))) (and (=> (= (ControlFlow 0 23) 21) anon53_Then_correct) (=> (= (ControlFlow 0 23) 17) anon53_Else_correct)))))
(let ((anon50_Then_correct  (=> (U_2_bool (MapType2Select g1@@10 u_6)) (and (=> (= (ControlFlow 0 28) 27) anon51_Then_correct) (=> (= (ControlFlow 0 28) 23) anon51_Else_correct)))))
(let ((anon50_Else_correct  (=> (not (U_2_bool (MapType2Select g1@@10 u_6))) (and (=> (= (ControlFlow 0 22) 21) anon53_Then_correct) (=> (= (ControlFlow 0 22) 17) anon53_Else_correct)))))
(let ((anon43_Else_correct  (=> (forall ((u_5 T@U) (v_5 T@U) ) (!  (=> (and (and (= (type u_5) RefType) (= (type v_5) RefType)) (and (U_2_bool (MapType2Select g0@@10 u_5)) (and (U_2_bool (MapType2Select g0@@10 v_5)) (exists_path ($$ Heap@@35 g0@@10) u_5 v_5)))) (exists_path ($$ Heap@@35 (|Set#Union| g0@@10 g1@@10)) u_5 v_5))
 :qid |stdinbpl.1139:20|
 :skolemid |142|
 :pattern ( (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp3| Heap@@35 g0@@10))) g0@@10) u_5 v_5))
 :pattern ( (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp3| Heap@@35 (|Set#Union| g0@@10 g1@@10)))) (|Set#Union| g0@@10 g1@@10)) u_5 v_5))
)) (=> (and (state Heap@@35 QPMask@1) (state Heap@@35 QPMask@1)) (and (and (=> (= (ControlFlow 0 58) 57) anon49_Else_correct) (=> (= (ControlFlow 0 58) 28) anon50_Then_correct)) (=> (= (ControlFlow 0 58) 22) anon50_Else_correct))))))
(let ((anon46_Then_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((n_8 T@U) (n_8_1 T@U) ) (!  (=> (and (= (type n_8) RefType) (= (type n_8_1) RefType)) (=> (and (and (and (and (not (= n_8 n_8_1)) (U_2_bool (MapType2Select g0@@10 n_8))) (U_2_bool (MapType2Select g0@@10 n_8_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_8 n_8_1))))
 :qid |stdinbpl.1040:27|
 :skolemid |130|
 :pattern ( (neverTriggered3 n_8) (neverTriggered3 n_8_1))
 ...
 :qid |stdinbpl.1040:27|
 :skolemid |130|
 :pattern ( (neverTriggered3 n_8@@0) (neverTriggered3 n_8_1@@0))
)) (=> (= (ControlFlow 0 12) (- 0 11)) (forall ((n_8@@1 T@U) ) (!  (=> (and (= (type n_8@@1) RefType) (U_2_bool (MapType2Select g0@@10 n_8@@1))) (>= (U_2_real (MapType1Select QPMask@1 n_8@@1 next)) FullPerm))
 :qid |stdinbpl.1047:27|
 :skolemid |131|
 :pattern ( (MapType0Select Heap@@35 n_8@@1 next))
 :pattern ( (MapType1Select QPMask@8 n_8@@1 next))
 :pattern ( (MapType0Select Heap@@35 n_8@@1 next))
)))))))
(let ((anon48_Then_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((n_9 T@U) (n_9_1 T@U) ) (!  (=> (and (= (type n_9) RefType) (= (type n_9_1) RefType)) (=> (and (and (and (and (not (= n_9 n_9_1)) (U_2_bool (MapType2Select (|Set#Union| g0@@10 g1@@10) n_9))) (U_2_bool (MapType2Select (|Set#Union| g0@@10 g1@@10) n_9_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_9 n_9_1))))
 :qid |stdinbpl.1095:25|
 :skolemid |136|
 :pattern ( (neverTriggered4 n_9) (neverTriggered4 n_9_1))
))) (=> (forall ((n_9@@0 T@U) (n_9_1@@0 T@U) ) (!  (=> (and (= (type n_9@@0) RefType) (= (type n_9_1@@0) RefType)) (=> (and (and (and (and (not (= n_9@@0 n_9_1@@0)) (U_2_bool (MapType2Select (|Set#Union| g0@@10 g1@@10) n_9@@0))) (U_2_bool (MapType2Select (|Set#Union| g0@@10 g1@@10) n_9_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_9@@0 n_9_1@@0))))
 :qid |stdinbpl.1095:25|
 :skolemid |136|
 :pattern ( (neverTriggered4 n_9@@0) (neverTriggered4 n_9_1@@0))
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((n_9@@1 T@U) ) (!  (=> (and (= (type n_9@@1) RefType) (U_2_bool (MapType2Select (|Set#Union| g0@@10 g1@@10) n_9@@1))) (>= (U_2_real (MapType1Select QPMask@1 n_9@@1 next)) FullPerm))
 :qid |stdinbpl.1102:25|
 :skolemid |137|
 :pattern ( (MapType0Select Heap@@35 n_9@@1 next))
 :pattern ( (MapType1Select QPMask@9 n_9@@1 next))
 :pattern ( (MapType0Select Heap@@35 n_9@@1 next))
)))))))
(let ((anon12_correct true))
(let ((anon47_Then_correct  (=> (and (U_2_bool (MapType2Select g0@@10 u_4)) (and (U_2_bool (MapType2Select g0@@10 v_4)) (exists_path ($$ Heap@@35 g0@@10) u_4 v_4))) (and (=> (= (ControlFlow 0 8) 6) anon48_Then_correct) (=> (= (ControlFlow 0 8) 3) anon12_correct)))))
(let ((anon47_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g0@@10 u_4)) (and (U_2_bool (MapType2Select g0@@10 v_4)) (exists_path ($$ Heap@@35 g0@@10) u_4 v_4)))) (= (ControlFlow 0 4) 3)) anon12_correct)))
(let ((anon45_Then_correct  (=> (U_2_bool (MapType2Select g0@@10 v_4)) (and (and (=> (= (ControlFlow 0 14) 12) anon46_Then_correct) (=> (= (ControlFlow 0 14) 8) anon47_Then_correct)) (=> (= (ControlFlow 0 14) 4) anon47_Else_correct)))))
(let ((anon45_Else_correct  (=> (not (U_2_bool (MapType2Select g0@@10 v_4))) (and (=> (= (ControlFlow 0 10) 8) anon47_Then_correct) (=> (= (ControlFlow 0 10) 4) anon47_Else_correct)))))
(let ((anon44_Then_correct  (=> (U_2_bool (MapType2Select g0@@10 u_4)) (and (=> (= (ControlFlow 0 15) 14) anon45_Then_correct) (=> (= (ControlFlow 0 15) 10) anon45_Else_correct)))))
(let ((anon44_Else_correct  (=> (not (U_2_bool (MapType2Select g0@@10 u_4))) (and (=> (= (ControlFlow 0 9) 8) anon47_Then_correct) (=> (= (ControlFlow 0 9) 4) anon47_Else_correct)))))
(let ((anon42_Else_correct  (and (=> (= (ControlFlow 0 59) (- 0 60)) (forall ((n_7 T@U) (n_7_1 T@U) ) (!  (=> (and (= (type n_7) RefType) (= (type n_7_1) RefType)) (=> (and (and (and (and (not (= n_7 n_7_1)) (U_2_bool (MapType2Select g1@@10 n_7))) (U_2_bool (MapType2Select g1@@10 n_7_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_7 n_7_1))))
 :qid |stdinbpl.984:15|
 :skolemid |124|
 :no-pattern (type n_7)
...
)) (=> (and (and (forall ((n_7@@1 T@U) ) (!  (=> (= (type n_7@@1) RefType) (=> (and (U_2_bool (MapType2Select g1@@10 n_7@@1)) (< NoPerm FullPerm)) (and (qpRange2 n_7@@1) (= (invRecv2 n_7@@1) n_7@@1))))
 :qid |stdinbpl.990:22|
 :skolemid |125|
 :pattern ( (MapType0Select Heap@@35 n_7@@1 next))
 :pattern ( (MapType1Select QPMask@1 n_7@@1 next))
 :pattern ( (MapType0Select Heap@@35 n_7@@1 next))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select g1@@10 (invRecv2 o_3))) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.994:22|
 :skolemid |126|
 :pattern ( (invRecv2 o_3))
))) (and (forall ((n_7@@2 T@U) ) (!  (=> (and (= (type n_7@@2) RefType) (U_2_bool (MapType2Select g1@@10 n_7@@2))) (not (= n_7@@2 null)))
 :qid |stdinbpl.1000:22|
 :skolemid |127|
 :pattern ( (MapType0Select Heap@@35 n_7@@2 next))
 :pattern ( (MapType1Select QPMask@1 n_7@@2 next))
 :pattern ( (MapType0Select Heap@@35 n_7@@2 next))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select g1@@10 (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 next)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select g1@@10 (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 next)) (U_2_real (MapType1Select QPMask@0 o_3@@0 next))))))
...
)) (state Heap@@35 QPMask@1)) (and (state Heap@@35 QPMask@1) (|Set#Equal| (|Set#Intersection| g1@@10 g0@@10) (|Set#Empty| RefType)))) (and (and (state Heap@@35 QPMask@1) (|Set#Equal| (|Set#Union| g0@@10 g1@@10) (|Set#Union| g1@@10 g0@@10))) (and (state Heap@@35 QPMask@1) (state Heap@@35 QPMask@1)))) (and (and (=> (= (ControlFlow 0 59) 58) anon43_Else_correct) (=> (= (ControlFlow 0 59) 15) anon44_Then_correct)) (=> (= (ControlFlow 0 59) 9) anon44_Else_correct))))))))
(let ((anon42_Then_correct true))
(let ((anon41_Else_correct  (and (=> (= (ControlFlow 0 61) (- 0 62)) (forall ((n_5 T@U) (n_5_1 T@U) ) (!  (=> (and (= (type n_5) RefType) (= (type n_5_1) RefType)) (=> (and (and (and (and (not (= n_5 n_5_1)) (U_2_bool (MapType2Select g0@@10 n_5))) (U_2_bool (MapType2Select g0@@10 n_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_5 n_5_1))))
 :qid |stdinbpl.944:15|
 :skolemid |118|
 :no-pattern (type n_5)
...
)) (=> (forall ((n_5@@1 T@U) ) (!  (=> (= (type n_5@@1) RefType) (=> (and (U_2_bool (MapType2Select g0@@10 n_5@@1)) (< NoPerm FullPerm)) (and (qpRange1 n_5@@1) (= (invRecv1 n_5@@1) n_5@@1))))
 :qid |stdinbpl.950:22|
 :skolemid |119|
 :pattern ( (MapType0Select Heap@@35 n_5@@1 next))
 :pattern ( (MapType1Select QPMask@0 n_5@@1 next))
 :pattern ( (MapType0Select Heap@@35 n_5@@1 next))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType2Select g0@@10 (invRecv1 o_3@@2))) (< NoPerm FullPerm)) (qpRange1 o_3@@2)) (= (invRecv1 o_3@@2) o_3@@2)))
 :qid |stdinbpl.954:22|
 :skolemid |120|
 :pattern ( (invRecv1 o_3@@2))
)) (forall ((n_5@@2 T@U) ) (!  (=> (and (= (type n_5@@2) RefType) (U_2_bool (MapType2Select g0@@10 n_5@@2))) (not (= n_5@@2 null)))
 :qid |stdinbpl.960:22|
 :skolemid |121|
 :pattern ( (MapType0Select Heap@@35 n_5@@2 next))
 :pattern ( (MapType1Select QPMask@0 n_5@@2 next))
 :pattern ( (MapType0Select Heap@@35 n_5@@2 next))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType2Select g0@@10 (invRecv1 o_3@@3))) (< NoPerm FullPerm)) (qpRange1 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 next)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 next)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select g0@@10 (invRecv1 o_3@@3))) (< NoPerm FullPerm)) (qpRange1 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 next)) (U_2_real (MapType1Select ZeroMask o_3@@3 next))))))
 :qid |stdinbpl.966:22|
 :skolemid |122|
...
))) (and (state Heap@@35 QPMask@0) (state Heap@@35 QPMask@0))) (and (=> (= (ControlFlow 0 61) 2) anon42_Then_correct) (=> (= (ControlFlow 0 61) 59) anon42_Else_correct)))))))))
(let ((anon41_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@35 ZeroMask) (= AssumeFunctionsAbove 2)) (and (=> (= (ControlFlow 0 63) 1) anon41_Then_correct) (=> (= (ControlFlow 0 63) 61) anon41_Else_correct)))))
