...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type a_3) RefType) (= (type g) RefType)) (= (type QPMask@0) (MapType2Type RefType realType))) (= (type a_5) RefType)) (= (type a_6) RefType)) (= (type x@@31) RefType)) (= (type y@@12) RefType)) (= (type a_8) RefType)) (= (type z@@0) RefType)) (= (type Heap@@11) (MapType0Type RefType))) (= (type a_10) RefType)) (forall ((arg0@@53 T@U) ) (! (= (type (invRecv1 arg0@@53)) RefType)
 :qid |funType:invRecv1|
 :pattern ( (invRecv1 arg0@@53))
))) (= (type Mask@3) (MapType2Type RefType realType))) (= (type Mask@0) (MapType2Type RefType realType))) (= (type Mask@1) (MapType2Type RefType realType))) (= (type Mask@2) (MapType2Type RefType realType))))
(set-info :boogie-vc-id m1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 36) (let ((anon22_correct true))
(let ((anon35_Else_correct  (=> (and (= a_10 g) (= (ControlFlow 0 25) 21)) anon22_correct)))
(let ((anon35_Then_correct  (=> (not (= a_10 g)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (HasDirectPerm QPMask@0 a_10 f_7)) (=> (HasDirectPerm QPMask@0 a_10 f_7) (=> (= (ControlFlow 0 23) 21) anon22_correct))))))
(let ((anon34_Then_correct  (=> (HasDirectPerm QPMask@0 a_10 f_7) (and (=> (= (ControlFlow 0 26) (- 0 27)) (HasDirectPerm QPMask@0 a_10 f_7)) (=> (HasDirectPerm QPMask@0 a_10 f_7) (and (=> (= (ControlFlow 0 26) 23) anon35_Then_correct) (=> (= (ControlFlow 0 26) 25) anon35_Else_correct)))))))
(let ((anon34_Else_correct  (=> (and (not (HasDirectPerm QPMask@0 a_10 f_7)) (= (ControlFlow 0 22) 21)) anon22_correct)))
(let ((anon33_Else_correct  (=> (= (ControlFlow 0 20) (- 0 19)) (forall ((a_11 T@U) ) (!  (=> (and (= (type a_11) RefType) (HasDirectPerm QPMask@0 a_11 f_7)) (or (= a_11 g) (> (U_2_int (MapType0Select Heap@@11 a_11 f_7)) 3)))
 :qid |stdinbpl.824:15|
 :skolemid |118|
 :pattern ( (MapType2Select QPMask@0 a_11 f_7))
 :pattern ( (MapType0Select Heap@@11 a_11 f_7))
)))))
(let ((anon31_Else_correct  (=> (forall ((a_9 T@U) ) (!  (=> (and (= (type a_9) RefType) (= a_9 z@@0)) (= (U_2_int (MapType0Select Heap@@11 a_9 f_7)) 10))
 :qid |stdinbpl.800:20|
 :skolemid |117|
 :no-pattern (type a_9)
 :no-pattern (U_2_int a_9)
 :no-pattern (U_2_bool a_9)
)) (=> (and (state Heap@@11 QPMask@0) (state Heap@@11 QPMask@0)) (and (and (=> (= (ControlFlow 0 28) 20) anon33_Else_correct) (=> (= (ControlFlow 0 28) 26) anon34_Then_correct)) (=> (= (ControlFlow 0 28) 22) anon34_Else_correct))))))
(let ((anon17_correct true))
(let ((anon32_Else_correct  (=> (and (not (= a_8 z@@0)) (= (ControlFlow 0 18) 15)) anon17_correct)))
(let ((anon32_Then_correct  (=> (= a_8 z@@0) (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm QPMask@0 a_8 f_7)) (=> (HasDirectPerm QPMask@0 a_8 f_7) (=> (= (ControlFlow 0 16) 15) anon17_correct))))))
(let ((anon29_Else_correct  (=> (forall ((a_7 T@U) ) (!  (=> (and (= (type a_7) RefType) (or (= a_7 x@@31) (= a_7 y@@12))) (= (U_2_int (MapType0Select Heap@@11 a_7 f_7)) 4))
 :qid |stdinbpl.783:20|
 :skolemid |116|
 :no-pattern (type a_7)
 :no-pattern (U_2_int a_7)
 :no-pattern (U_2_bool a_7)
)) (=> (and (state Heap@@11 QPMask@0) (state Heap@@11 QPMask@0)) (and (and (=> (= (ControlFlow 0 29) 28) anon31_Else_correct) (=> (= (ControlFlow 0 29) 16) anon32_Then_correct)) (=> (= (ControlFlow 0 29) 18) anon32_Else_correct))))))
(let ((anon13_correct true))
(let ((anon30_Else_correct  (=> (and (not (or (= a_6 x@@31) (= a_6 y@@12))) (= (ControlFlow 0 14) 11)) anon13_correct)))
(let ((anon30_Then_correct  (=> (or (= a_6 x@@31) (= a_6 y@@12)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm QPMask@0 a_6 f_7)) (=> (HasDirectPerm QPMask@0 a_6 f_7) (=> (= (ControlFlow 0 12) 11) anon13_correct))))))
(let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 30) (- 0 31)) (not (forall ((a_5_1 T@U) ) (!  (=> (and (= (type a_5_1) RefType) (HasDirectPerm QPMask@0 a_5_1 f_7)) (> (U_2_int (MapType0Select Heap@@11 a_5_1 f_7)) 3))
 :qid |stdinbpl.767:16|
 :skolemid |115|
 :pattern ( (MapType2Select QPMask@0 a_5_1 f_7))
 :pattern ( (MapType0Select Heap@@11 a_5_1 f_7))
)))) (=> (not (forall ((a_5_1@@0 T@U) ) (!  (=> (and (= (type a_5_1@@0) RefType) (HasDirectPerm QPMask@0 a_5_1@@0 f_7)) (> (U_2_int (MapType0Select Heap@@11 a_5_1@@0 f_7)) 3))
 :qid |stdinbpl.767:16|
 :skolemid |115|
 :pattern ( (MapType2Select QPMask@0 a_5_1@@0 f_7))
 :pattern ( (MapType0Select Heap@@11 a_5_1@@0 f_7))
))) (=> (state Heap@@11 QPMask@0) (and (and (=> (= (ControlFlow 0 30) 29) anon29_Else_correct) (=> (= (ControlFlow 0 30) 12) anon30_Then_correct)) (=> (= (ControlFlow 0 30) 14) anon30_Else_correct)))))))
(let ((anon9_correct true))
(let ((anon28_Else_correct  (=> (and (not (HasDirectPerm QPMask@0 a_5 f_7)) (= (ControlFlow 0 10) 6)) anon9_correct)))
(let ((anon28_Then_correct  (=> (HasDirectPerm QPMask@0 a_5 f_7) (and (=> (= (ControlFlow 0 7) (- 0 9)) (HasDirectPerm QPMask@0 a_5 f_7)) (=> (HasDirectPerm QPMask@0 a_5 f_7) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm QPMask@0 a_5 f_7)) (=> (HasDirectPerm QPMask@0 a_5 f_7) (=> (= (ControlFlow 0 7) 6) anon9_correct))))))))
(let ((anon25_Else_correct  (=> (forall ((a_3_1 T@U) ) (!  (=> (and (= (type a_3_1) RefType) (= a_3_1 g)) (< (U_2_int (MapType0Select Heap@@11 a_3_1 f_7)) 3))
 :qid |stdinbpl.745:20|
 :skolemid |114|
 :no-pattern (type a_3_1)
 :no-pattern (U_2_int a_3_1)
 :no-pattern (U_2_bool a_3_1)
)) (=> (and (state Heap@@11 QPMask@0) (state Heap@@11 QPMask@0)) (and (and (=> (= (ControlFlow 0 32) 30) anon27_Else_correct) (=> (= (ControlFlow 0 32) 7) anon28_Then_correct)) (=> (= (ControlFlow 0 32) 10) anon28_Else_correct))))))
(let ((anon5_correct true))
(let ((anon26_Else_correct  (=> (and (not (= a_3 g)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon26_Then_correct  (=> (= a_3 g) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 a_3 f_7)) (=> (HasDirectPerm QPMask@0 a_3 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon24_Else_correct  (and (=> (= (ControlFlow 0 33) (- 0 34)) (forall ((a_1 T@U) (a_1_1 T@U) ) (!  (=> (and (= (type a_1) RefType) (= (type a_1_1) RefType)) (=> (and (and (and (and (not (= a_1 a_1_1)) (= a_1 g)) (= a_1_1 g)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1 a_1_1))))
 :qid |stdinbpl.704:15|
 :skolemid |108|
 :no-pattern (type a_1)
...
))) (=> (forall ((a_1@@0 T@U) (a_1_1@@0 T@U) ) (!  (=> (and (= (type a_1@@0) RefType) (= (type a_1_1@@0) RefType)) (=> (and (and (and (and (not (= a_1@@0 a_1_1@@0)) (= a_1@@0 g)) (= a_1_1@@0 g)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1@@0 a_1_1@@0))))
 :qid |stdinbpl.704:15|
 :skolemid |108|
...
)) (=> (and (forall ((a_1@@1 T@U) ) (!  (=> (= (type a_1@@1) RefType) (=> (and (= a_1@@1 g) (< NoPerm FullPerm)) (and (qpRange1 a_1@@1) (= (invRecv1 a_1@@1) a_1@@1))))
 :qid |stdinbpl.710:22|
 :skolemid |109|
 :pattern ( (MapType0Select Heap@@11 a_1@@1 f_7))
 :pattern ( (MapType2Select QPMask@0 a_1@@1 f_7))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (= (invRecv1 o_3) g) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.714:22|
 :skolemid |110|
 :pattern ( (invRecv1 o_3))
))) (=> (and (and (forall ((a_1@@2 T@U) ) (!  (=> (and (= (type a_1@@2) RefType) (= a_1@@2 g)) (not (= a_1@@2 null)))
 :qid |stdinbpl.720:22|
 :skolemid |111|
 :pattern ( (MapType0Select Heap@@11 a_1@@2 f_7))
 :pattern ( (MapType2Select QPMask@0 a_1@@2 f_7))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (= (invRecv1 o_3@@0) g) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@0) o_3@@0)) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType2Select Mask@3 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (= (invRecv1 o_3@@0) g) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType2Select Mask@3 o_3@@0 f_7))))))
 :qid |stdinbpl.726:22|
 :skolemid |112|
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 f_7))) (= (U_2_real (MapType2Select Mask@3 o_3@@1 f_5)) (U_2_real (MapType2Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.730:29|
 :skolemid |113|
 :pattern ( (MapType2Select Mask@3 o_3@@1 f_5))
 :pattern ( (MapType2Select QPMask@0 o_3@@1 f_5))
)) (state Heap@@11 QPMask@0))) (and (and (=> (= (ControlFlow 0 33) 32) anon25_Else_correct) (=> (= (ControlFlow 0 33) 3) anon26_Then_correct)) (=> (= (ControlFlow 0 33) 5) anon26_Else_correct))))))))
(let ((anon24_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@11 x@@31 $allocated)) (U_2_bool (MapType0Select Heap@@11 y@@12 $allocated))) (and (U_2_bool (MapType0Select Heap@@11 z@@0 $allocated)) (U_2_bool (MapType0Select Heap@@11 g $allocated)))) (=> (and (and (and (not (= x@@31 null)) (= Mask@0 (MapType2Store ZeroMask x@@31 f_7 (real_2_U (+ (U_2_real (MapType2Select ZeroMask x@@31 f_7)) FullPerm))))) (and (state Heap@@11 Mask@0) (state Heap@@11 Mask@0))) (and (and (state Heap@@11 Mask@0) (not (= y@@12 null))) (and (= Mask@1 (MapType2Store Mask@0 y@@12 f_7 (real_2_U (+ (U_2_real (MapType2Select Mask@0 y@@12 f_7)) FullPerm)))) (state Heap@@11 Mask@1)))) (=> (and (and (and (and (not (= z@@0 null)) (= Mask@2 (MapType2Store Mask@1 z@@0 f_7 (real_2_U (+ (U_2_real (MapType2Select Mask@1 z@@0 f_7)) FullPerm))))) (and (state Heap@@11 Mask@2) (state Heap@@11 Mask@2))) (and (and (state Heap@@11 Mask@2) (not (= y@@12 x@@31))) (and (state Heap@@11 Mask@2) (state Heap@@11 Mask@2)))) (and (and (and (not (= z@@0 x@@31)) (state Heap@@11 Mask@2)) (and (state Heap@@11 Mask@2) (not (= g null)))) (and (and (= Mask@3 (MapType2Store Mask@2 g f_7 (real_2_U (+ (U_2_real (MapType2Select Mask@2 g f_7)) FullPerm)))) (state Heap@@11 Mask@3)) (and (state Heap@@11 Mask@3) (state Heap@@11 Mask@3))))) (and (=> (= (ControlFlow 0 35) 1) anon24_Then_correct) (=> (= (ControlFlow 0 35) 33) anon24_Else_correct))))))))
