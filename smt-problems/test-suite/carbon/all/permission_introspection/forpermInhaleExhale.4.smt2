...
(declare-fun x@@8 () T@U)
(assert  (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type r_4) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type x@@8) RefType)))
(set-info :boogie-vc-id test02b)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon5_correct true))
(let ((anon9_Else_correct  (=> (and (not (HasDirectPerm Mask@1 r_4 f_7)) (= (ControlFlow 0 7) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (HasDirectPerm Mask@1 r_4 f_7) (and (=> (= (ControlFlow 0 4) (- 0 6)) (HasDirectPerm Mask@0 r_4 f_7)) (=> (HasDirectPerm Mask@0 r_4 f_7) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@0 r_4 f_7)) (=> (HasDirectPerm Mask@0 r_4 f_7) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))))
(let ((anon8_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((r_1_1 T@U) ) (!  (=> (and (= (type r_1_1) RefType) (HasDirectPerm Mask@1 r_1_1 f_7)) (> (U_2_int (MapType0Select Heap@@9 r_1_1 f_7)) 0))
 :qid |stdinbpl.442:15|
 :skolemid |25|
 :pattern ( (MapType1Select Mask@1 r_1_1 f_7))
 :pattern ( (MapType0Select Heap@@9 r_1_1 f_7))
)))))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 x@@8 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 x@@8 f_7)) FullPerm)))) (and (and (=> (= (ControlFlow 0 8) 2) anon8_Else_correct) (=> (= (ControlFlow 0 8) 4) anon9_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@8 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@8 f_7))) (=> (= (ControlFlow 0 9) 8) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated)) (not (= x@@8 null))) (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm)))) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm Mask@0 x@@8 f_7)) (=> (HasDirectPerm Mask@0 x@@8 f_7) (=> (> (U_2_int (MapType0Select Heap@@9 x@@8 f_7)) 0) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 12) 9) anon7_Then_correct) (=> (= (ControlFlow 0 12) 11) anon7_Else_correct))))))))))
