...
(let ((anon6_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_6))) (= (ControlFlow 0 7) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_6)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (>= (+ (* a_1@@5 i_6) b_2) 0)) (=> (>= (+ (* a_1@@5 i_6) b_2) 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< (+ (* a_1@@5 i_6) b_2) (|Seq#Length| xs))) (=> (< (+ (* a_1@@5 i_6) b_2) (|Seq#Length| xs)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))))
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs (+ (* a_1@@5 i_1) b_2)) (|Seq#Index| xs (+ (* a_1@@5 i_1_1) b_2)))))
 :qid |stdinbpl.1283:17|
 :skolemid |158|
 :pattern ( (neverTriggered6 i_1) (neverTriggered6 i_1_1))
)))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (<= 0 a_1@@5) (<= 0 b_2)) (=> (and (and (<= 0 n@@13) (state Heap@@10 ZeroMask)) (and (<= (+ (* a_1@@5 (- n@@13 1)) b_2) (|Seq#Length| xs)) (state Heap@@10 ZeroMask))) (and (and (=> (= (ControlFlow 0 8) 2) anon5_Else_correct) (=> (= (ControlFlow 0 8) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))))
