...
(assert  (and (and (= (type Heap@@12) (MapType1Type RefType)) (= (type x@@20) RefType)) (= (type Mask@0) (MapType0Type RefType realType))))
(set-info :boogie-vc-id |Q#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@12 ZeroMask) (U_2_bool (MapType1Select Heap@@12 x@@20 $allocated))) (=> (and (and (not (= x@@20 null)) (= Mask@0 (MapType0Store ZeroMask x@@20 h (real_2_U (+ (U_2_real (MapType0Select ZeroMask x@@20 h)) FullPerm))))) (and (state Heap@@12 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@0 x@@20 h)))))
