...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (>= i 0)) (=> (and (and (state Heap@@9 ZeroMask) (>= i2 0)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (>= (* i i2) 0)))))
