...
(assert  (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type xs) (MapType2Type boolType boolType))) (= (type Ops_5Heap@0) (MapType0Type RefType))) (= (type Used_5Heap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type Used_4Heap@0) (MapType0Type RefType))))
...
(let ((anon13_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (wand_1 xs true true)))))))
(let ((anon5_correct  (=> (= b_7@1  (and b_7 (state Ops_5Heap@0 ZeroMask))) (=> (and (= b_7@2  (and b_7@1 (state Ops_5Heap@0 ZeroMask))) (= b_8@0  (and b_8 (state Used_5Heap@0 ZeroMask)))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (wand_1 xs true true) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (wand_1 xs true true))) FullPerm)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (and (=> (= (ControlFlow 0 5) 2) anon13_Else_correct) (=> (= (ControlFlow 0 5) 3) anon14_Then_correct)) (=> (= (ControlFlow 0 5) 4) anon14_Else_correct)))))))
(let ((anon11_Else_correct  (=> (and (not b_7@0) (= (ControlFlow 0 8) 5)) anon5_correct)))
(let ((anon11_Then_correct  (=> (and b_7@0 (= (ControlFlow 0 7) 5)) anon5_correct)))
(let ((anon10_Then_correct  (=> b_7@0 (and (=> (= (ControlFlow 0 9) 7) anon11_Then_correct) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (not b_7@0) (= (ControlFlow 0 6) 5)) anon5_correct)))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= b_7@0  (and b_7 (state Ops_5Heap@0 ZeroMask))) (= b_6@0  (and b_6 (state Used_4Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 10) 9) anon10_Then_correct) (=> (= (ControlFlow 0 10) 6) anon10_Else_correct))))))
