...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type storedInt) (FieldType NormalFieldType intType))))
(assert (distinct $allocated storedInt)
)
...
(assert  (not (IsPredicateField storedInt)))
(assert  (not (IsWandField storedInt)))
...
(declare-fun x_1 () T@U)
(assert  (and (= (type Heap@@9) (MapType0Type RefType)) (= (type x_1) RefType)))
(set-info :boogie-vc-id strange)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x_1 $allocated))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm ZeroMask x_1 storedInt)) (=> (HasDirectPerm ZeroMask x_1 storedInt) (=> (= (ControlFlow 0 2) (- 0 1)) (= FullPerm (U_2_real (MapType1Select ZeroMask x_1 storedInt)))))))))
