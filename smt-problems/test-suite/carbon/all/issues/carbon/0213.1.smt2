...
(assert  (and (and (and (and (and (and (= (type UnfoldingMask@0) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type r_1@@5) RefType)) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (forall ((arg0@@28 T@U) ) (! (= (type (FrameFragment arg0@@28)) FrameTypeType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon2_correct  (=> (and (and (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (P r_1@@5) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P r_1@@5))) FullPerm)))) (not (= r_1@@5 null))) (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 r_1@@5 next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 r_1@@5 next)) FullPerm)))) (state Heap@@10 UnfoldingMask@1))) (and (and (state Heap@@10 UnfoldingMask@1) (= Heap@0 (MapType0Store Heap@@10 null (|P#sm| r_1@@5) (MapType1Store (MapType0Select Heap@@10 null (|P#sm| r_1@@5)) r_1@@5 next (bool_2_U true))))) (and (state Heap@0 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (= (U_2_real (MapType1Select Mask@0 r_1@@5 next)) FullPerm))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P r_1@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P r_1@@5)))) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@10 r_1@@5 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (P r_1@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P r_1@@5))) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (= (U_2_real (MapType1Select Mask@0 r_1@@5 next)) NoPerm)) (=> (= (U_2_real (MapType1Select Mask@0 r_1@@5 next)) NoPerm) (=> (state Heap@@10 Mask@0) (=> (and (|P#trigger| Heap@@10 (P r_1@@5)) (= (MapType0Select Heap@@10 null (P r_1@@5)) (FrameFragment (MapType0Select Heap@@10 r_1@@5 next)))) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))))))
