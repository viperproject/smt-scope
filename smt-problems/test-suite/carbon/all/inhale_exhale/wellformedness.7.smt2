...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (HasDirectPerm ZeroMask this x@@8))))
...
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 this $allocated))) (and (=> (= (ControlFlow 0 8) 7) anon5_Then_correct) (=> (= (ControlFlow 0 8) 2) anon5_Else_correct)))))
