...
(set-info :boogie-vc-id Ref__loop_body_38)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 66) (let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 54) (- 0 56)) (>= (Ref__multidim_index_2 PostHeap@0 M step@@9 i@@34 j@@9) 0)) (=> (>= (Ref__multidim_index_2 PostHeap@0 M step@@9 i@@34 j@@9) 0) (and (=> (= (ControlFlow 0 54) (- 0 55)) (< (Ref__multidim_index_2 PostHeap@0 M step@@9 i@@34 j@@9) (|Seq#Length| matrix))) (=> (< (Ref__multidim_index_2 PostHeap@0 M step@@9 i@@34 j@@9) (|Seq#Length| matrix)) (=> (= (ControlFlow 0 54) (- 0 53)) (HasDirectPerm PostMask@0 (|Seq#Index| matrix (Ref__multidim_index_2 PostHeap@0 M step@@9 i@@34 j@@9)) Ref__Integer_value))))))))
(let ((anon19_Then_correct  (and (=> (= (ControlFlow 0 47) (- 0 52)) (<= 0 i@@34)) (=> (<= 0 i@@34) (and (=> (= (ControlFlow 0 47) (- 0 51)) (< i@@34 M)) (=> (< i@@34 M) (and (=> (= (ControlFlow 0 47) (- 0 50)) (<= 0 M)) (=> (<= 0 M) (and (=> (= (ControlFlow 0 47) (- 0 49)) (<= 0 j@@9)) (=> (<= 0 j@@9) (and (=> (= (ControlFlow 0 47) (- 0 48)) (< j@@9 step@@9)) (=> (< j@@9 step@@9) (=> (= (ControlFlow 0 47) (- 0 46)) (<= 0 step@@9))))))))))))))
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 57) (- 0 59)) (>= (Ref__multidim_index_2 PostHeap@0 M step@@9 i@@34 j@@9) 0)) (=> (>= (Ref__multidim_index_2 PostHeap@0 M step@@9 i@@34 j@@9) 0) (and (=> (= (ControlFlow 0 57) (- 0 58)) (< (Ref__multidim_index_2 PostHeap@0 M step@@9 i@@34 j@@9) (|Seq#Length| matrix))) (=> (< (Ref__multidim_index_2 PostHeap@0 M step@@9 i@@34 j@@9) (|Seq#Length| matrix)) (=> (not (= (|Seq#Index| matrix (Ref__multidim_index_2 PostHeap@0 M step@@9 i@@34 j@@9)) null)) (=> (and (and (= PostMask@0 (MapType1Store ZeroMask (|Seq#Index| matrix (Ref__multidim_index_2 PostHeap@0 M step@@9 i@@34 j@@9)) Ref__Integer_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask (|Seq#Index| matrix (Ref__multidim_index_2 PostHeap@0 M step@@9 i@@34 j@@9)) Ref__Integer_value)) FullPerm)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 57) 47) anon19_Then_correct) (=> (= (ControlFlow 0 57) 54) anon19_Else_correct))))))))))
(let ((anon18_Then_correct  (and (=> (= (ControlFlow 0 40) (- 0 45)) (<= 0 i@@34)) (=> (<= 0 i@@34) (and (=> (= (ControlFlow 0 40) (- 0 44)) (< i@@34 M)) (=> (< i@@34 M) (and (=> (= (ControlFlow 0 40) (- 0 43)) (<= 0 M)) (=> (<= 0 M) (and (=> (= (ControlFlow 0 40) (- 0 42)) (<= 0 j@@9)) (=> (<= 0 j@@9) (and (=> (= (ControlFlow 0 40) (- 0 41)) (< j@@9 step@@9)) (=> (< j@@9 step@@9) (=> (= (ControlFlow 0 40) (- 0 39)) (<= 0 step@@9))))))))))))))
(let ((anon17_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (<= 0 i@@34) (< i@@34 M)) (=> (and (and (and (<= 0 j@@9) (< j@@9 N)) (and (state PostHeap@0 ZeroMask) (> M 0))) (and (and (> N 0) (>= step@@9 N)) (and (state PostHeap@0 ZeroMask) (state PostHeap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 60) 40) anon18_Then_correct) (=> (= (ControlFlow 0 60) 57) anon18_Else_correct)))))))
(let ((anon14_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 (|Seq#Index| matrix (Ref__multidim_index_2 Heap@0 M step@@9 i@@34 j@@9)) Ref__Integer_value (real_2_U (- (U_2_real (MapType1Select Mask@0 (|Seq#Index| matrix (Ref__multidim_index_2 Heap@0 M step@@9 i@@34 j@@9)) Ref__Integer_value)) FullPerm)))) (= (ControlFlow 0 23) (- 0 22))) (= (U_2_int (MapType0Select Heap@0 (|Seq#Index| matrix (Ref__multidim_index_2 Heap@0 M step@@9 i@@34 j@@9)) Ref__Integer_value)) 0))))
(let ((anon21_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 26) 23)) anon14_correct)))
(let ((anon21_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (<= FullPerm (U_2_real (MapType1Select Mask@0 (|Seq#Index| matrix (Ref__multidim_index_2 Heap@0 M step@@9 i@@34 j@@9)) Ref__Integer_value)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 (|Seq#Index| matrix (Ref__multidim_index_2 Heap@0 M step@@9 i@@34 j@@9)) Ref__Integer_value))) (=> (= (ControlFlow 0 24) 23) anon14_correct))))))
(let ((anon20_Else_correct  (=> (= __flatten_3@0 (Ref__multidim_index_2 Heap@@41 M step@@9 i@@34 j@@9)) (=> (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0)) (and (=> (= (ControlFlow 0 27) (- 0 37)) (>= __flatten_3@0 0)) (=> (>= __flatten_3@0 0) (and (=> (= (ControlFlow 0 27) (- 0 36)) (< __flatten_3@0 (|Seq#Length| matrix))) (=> (< __flatten_3@0 (|Seq#Length| matrix)) (=> (= __flatten_4@0 (|Seq#Index| matrix __flatten_3@0)) (=> (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0)) (and (=> (= (ControlFlow 0 27) (- 0 35)) (= FullPerm (U_2_real (MapType1Select Mask@0 __flatten_4@0 Ref__Integer_value)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 __flatten_4@0 Ref__Integer_value))) (=> (and (= Heap@0 (MapType0Store Heap@@41 __flatten_4@0 Ref__Integer_value (int_2_U 0))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 27) (- 0 34)) (<= 0 i@@34)) (=> (<= 0 i@@34) (and (=> (= (ControlFlow 0 27) (- 0 33)) (< i@@34 M)) (=> (< i@@34 M) (and (=> (= (ControlFlow 0 27) (- 0 32)) (<= 0 j@@9)) (=> (<= 0 j@@9) (and (=> (= (ControlFlow 0 27) (- 0 31)) (< j@@9 N)) (=> (< j@@9 N) (and (=> (= (ControlFlow 0 27) (- 0 30)) (> M 0)) (=> (> M 0) (and (=> (= (ControlFlow 0 27) (- 0 29)) (> N 0)) (=> (> N 0) (and (=> (= (ControlFlow 0 27) (- 0 28)) (>= step@@9 N)) (=> (>= step@@9 N) (and (=> (= (ControlFlow 0 27) 24) anon21_Then_correct) (=> (= (ControlFlow 0 27) 26) anon21_Else_correct)))))))))))))))))))))))))))))
(let ((anon20_Then_correct  (and (=> (= (ControlFlow 0 16) (- 0 21)) (<= 0 i@@34)) (=> (<= 0 i@@34) (and (=> (= (ControlFlow 0 16) (- 0 20)) (< i@@34 M)) (=> (< i@@34 M) (and (=> (= (ControlFlow 0 16) (- 0 19)) (<= 0 M)) (=> (<= 0 M) (and (=> (= (ControlFlow 0 16) (- 0 18)) (<= 0 j@@9)) (=> (<= 0 j@@9) (and (=> (= (ControlFlow 0 16) (- 0 17)) (< j@@9 step@@9)) (=> (< j@@9 step@@9) (=> (= (ControlFlow 0 16) (- 0 15)) (<= 0 step@@9))))))))))))))
(let ((anon17_Else_correct  (=> (U_2_bool (MapType0Select Heap@@41 __flatten_4 $allocated)) (and (=> (= (ControlFlow 0 38) 16) anon20_Then_correct) (=> (= (ControlFlow 0 38) 27) anon20_Else_correct)))))
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 61) (- 0 63)) (>= (Ref__multidim_index_2 Heap@@41 M step@@9 i@@34 j@@9) 0)) (=> (>= (Ref__multidim_index_2 Heap@@41 M step@@9 i@@34 j@@9) 0) (and (=> (= (ControlFlow 0 61) (- 0 62)) (< (Ref__multidim_index_2 Heap@@41 M step@@9 i@@34 j@@9) (|Seq#Length| matrix))) (=> (< (Ref__multidim_index_2 Heap@@41 M step@@9 i@@34 j@@9) (|Seq#Length| matrix)) (=> (and (and (not (= (|Seq#Index| matrix (Ref__multidim_index_2 Heap@@41 M step@@9 i@@34 j@@9)) null)) (= Mask@0 (MapType1Store ZeroMask (|Seq#Index| matrix (Ref__multidim_index_2 Heap@@41 M step@@9 i@@34 j@@9)) Ref__Integer_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask (|Seq#Index| matrix (Ref__multidim_index_2 Heap@@41 M step@@9 i@@34 j@@9)) Ref__Integer_value)) FullPerm))))) (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0))) (and (=> (= (ControlFlow 0 61) 60) anon17_Then_correct) (=> (= (ControlFlow 0 61) 38) anon17_Else_correct)))))))))
(let ((anon16_Then_correct  (and (=> (= (ControlFlow 0 9) (- 0 14)) (<= 0 i@@34)) (=> (<= 0 i@@34) (and (=> (= (ControlFlow 0 9) (- 0 13)) (< i@@34 M)) (=> (< i@@34 M) (and (=> (= (ControlFlow 0 9) (- 0 12)) (<= 0 M)) (=> (<= 0 M) (and (=> (= (ControlFlow 0 9) (- 0 11)) (<= 0 j@@9)) (=> (<= 0 j@@9) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< j@@9 step@@9)) (=> (< j@@9 step@@9) (=> (= (ControlFlow 0 9) (- 0 8)) (<= 0 step@@9))))))))))))))
(let ((anon15_Else_correct  (=> (< (Ref__multidim_index_2 Heap@@41 M step@@9 i@@34 j@@9) (|Seq#Length| matrix)) (=> (and (state Heap@@41 ZeroMask) (state Heap@@41 ZeroMask)) (and (=> (= (ControlFlow 0 64) 9) anon16_Then_correct) (=> (= (ControlFlow 0 64) 61) anon16_Else_correct))))))
(let ((anon15_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 7)) (<= 0 i@@34)) (=> (<= 0 i@@34) (and (=> (= (ControlFlow 0 2) (- 0 6)) (< i@@34 M)) (=> (< i@@34 M) (and (=> (= (ControlFlow 0 2) (- 0 5)) (<= 0 M)) (=> (<= 0 M) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= 0 j@@9)) (=> (<= 0 j@@9) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j@@9 step@@9)) (=> (< j@@9 step@@9) (=> (= (ControlFlow 0 2) (- 0 1)) (<= 0 step@@9))))))))))))))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@41 diz $allocated))) (and (not (= diz null)) (state Heap@@41 ZeroMask))) (and (and (>= current_thread_id 0) (state Heap@@41 ZeroMask)) (and (<= 0 i@@34) (< i@@34 M)))) (and (and (and (<= 0 j@@9) (< j@@9 N)) (and (state Heap@@41 ZeroMask) (> M 0))) (and (and (> N 0) (>= step@@9 N)) (and (state Heap@@41 ZeroMask) (state Heap@@41 ZeroMask))))) (and (=> (= (ControlFlow 0 65) 2) anon15_Then_correct) (=> (= (ControlFlow 0 65) 64) anon15_Else_correct))))))
