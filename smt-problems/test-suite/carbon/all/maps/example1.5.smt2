...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (forall ((arg0@@14 T@T) (arg1@@2 T@T) ) (! (= (Ctor (MapType arg0@@14 arg1@@2)) 8)
 :qid |ctor:MapType|
...
))) (forall ((arg0@@17 T@T) (arg1@@5 T@T) ) (! (= (Ctor (MapType0Type arg0@@17 arg1@@5)) 9)
...
(assert  (and (and (and (and (and (and (forall ((arg0@@25 T@T) ) (! (= (Ctor (MapType1Type arg0@@25)) 10)
...
))) (forall ((m@@3 T@U) (x0@@2 T@U) (x1 T@U) (val@@3 T@U) ) (! (let ((B@@0 (FieldTypeInv1 (type x1))))
 (=> (= (type val@@3) B@@0) (= (MapType1Select (MapType1Store m@@3 x0@@2 x1 val@@3) x0@@2 x1) val@@3)))
 :qid |mapAx0:MapType1Select|
 :weight 0
))) (and (and (forall ((val@@4 T@U) (m@@4 T@U) (x0@@3 T@U) (x1@@0 T@U) (y0@@1 T@U) (y1 T@U) ) (!  (or (= x0@@3 y0@@1) (= (MapType1Select (MapType1Store m@@4 x0@@3 x1@@0 val@@4) y0@@1 y1) (MapType1Select m@@4 y0@@1 y1)))
 :qid |mapAx1:MapType1Select:0|
 :weight 0
)) (forall ((val@@5 T@U) (m@@5 T@U) (x0@@4 T@U) (x1@@1 T@U) (y0@@2 T@U) (y1@@0 T@U) ) (!  (or (= x1@@1 y1@@0) (= (MapType1Select (MapType1Store m@@5 x0@@4 x1@@1 val@@5) y0@@2 y1@@0) (MapType1Select m@@5 y0@@2 y1@@0)))
 :qid |mapAx1:MapType1Select:1|
 :weight 0
))) (forall ((val@@6 T@U) (m@@6 T@U) (x0@@5 T@U) (x1@@2 T@U) (y0@@3 T@U) (y1@@1 T@U) ) (!  (or true (= (MapType1Select (MapType1Store m@@6 x0@@5 x1@@2 val@@6) y0@@3 y1@@1) (MapType1Select m@@6 y0@@3 y1@@1)))
...
))) (forall ((m@@7 T@U) (x0@@6 T@U) (x1@@3 T@U) (val@@7 T@U) ) (! (let ((aVar1@@4 (MapType2TypeInv1 (type m@@7))))
 (=> (= (type val@@7) aVar1@@4) (= (MapType2Select (MapType2Store m@@7 x0@@6 x1@@3 val@@7) x0@@6 x1@@3) val@@7)))
 :qid |mapAx0:MapType2Select|
 :weight 0
))) (and (and (forall ((val@@8 T@U) (m@@8 T@U) (x0@@7 T@U) (x1@@4 T@U) (y0@@4 T@U) (y1@@2 T@U) ) (!  (or (= x0@@7 y0@@4) (= (MapType2Select (MapType2Store m@@8 x0@@7 x1@@4 val@@8) y0@@4 y1@@2) (MapType2Select m@@8 y0@@4 y1@@2)))
 :qid |mapAx1:MapType2Select:0|
 :weight 0
)) (forall ((val@@9 T@U) (m@@9 T@U) (x0@@8 T@U) (x1@@5 T@U) (y0@@5 T@U) (y1@@3 T@U) ) (!  (or (= x1@@5 y1@@3) (= (MapType2Select (MapType2Store m@@9 x0@@8 x1@@5 val@@9) y0@@5 y1@@3) (MapType2Select m@@9 y0@@5 y1@@3)))
 :qid |mapAx1:MapType2Select:1|
 :weight 0
))) (forall ((val@@10 T@U) (m@@10 T@U) (x0@@9 T@U) (x1@@6 T@U) (y0@@6 T@U) (y1@@4 T@U) ) (!  (or true (= (MapType2Select (MapType2Store m@@10 x0@@9 x1@@6 val@@10) y0@@6 y1@@4) (MapType2Select m@@10 y0@@6 y1@@4)))
...
(assert  (and (and (= (Ctor FrameTypeType) 14) (= (type null) RefType)) (forall ((arg0@@39 T@U) ) (! (let ((A (FieldTypeInv0 (type arg0@@39))))
...
(assert  (and (forall ((arg0@@47 Real) (arg1@@24 T@U) ) (! (= (type (ConditionalFrame arg0@@47 arg1@@24)) FrameTypeType)
 :qid |funType:ConditionalFrame|
 :pattern ( (ConditionalFrame arg0@@47 arg1@@24))
...
(assert (forall ((arg0@@48 T@U) (arg1@@25 T@U) ) (! (let ((T@@20 (MapType0TypeInv0 (type arg0@@48))))
(= (type (|Set#Difference| arg0@@48 arg1@@25)) (MapType0Type T@@20 boolType)))
 :qid |funType:Set#Difference|
 :pattern ( (|Set#Difference| arg0@@48 arg1@@25))
)))
...
(assert (forall ((arg0@@49 T@U) (arg1@@26 T@U) ) (! (let ((T@@24 (type arg1@@26)))
(= (type (|Set#UnionOne| arg0@@49 arg1@@26)) (MapType0Type T@@24 boolType)))
 :qid |funType:Set#UnionOne|
 :pattern ( (|Set#UnionOne| arg0@@49 arg1@@26))
)))
...
(assert (forall ((a@@19 T@U) (x@@11 T@U) (o@@6 T@U) ) (! (let ((T@@29 (type x@@11)))
 (=> (and (= (type a@@19) (MapType0Type T@@29 boolType)) (= (type o@@6) T@@29)) (= (U_2_bool (MapType0Select (|Set#UnionOne| a@@19 x@@11) o@@6))  (or (= o@@6 x@@11) (U_2_bool (MapType0Select a@@19 o@@6))))))
 :qid |stdinbpl.212:18|
 :skolemid |29|
...
(assert (forall ((s@@1 T@U) ) (! (let ((T@@42 (MultiSetTypeInv0 (type s@@1))))
 (=> (= (type s@@1) (MultiSetType T@@42)) (and (= (= (|MultiSet#Card| s@@1) 0) (= s@@1 (|MultiSet#Empty| T@@42))) (=> (not (= (|MultiSet#Card| s@@1) 0)) (exists ((x@@17 T@U) ) (!  (and (= (type x@@17) T@@42) (< 0 (|MultiSet#Select| s@@1 x@@17)))
 :qid |stdinbpl.314:38|
 :skolemid |59|
...
(assert (forall ((s@@2 T@U) ) (! (let ((T@@48 (MapType0TypeInv0 (type s@@2))))
 (=> (= (type s@@2) (MapType0Type T@@48 boolType)) (and (= (= (|Set#Card| s@@2) 0) (= s@@2 (|Set#Empty| T@@48))) (=> (not (= (|Set#Card| s@@2) 0)) (exists ((x@@18 T@U) ) (!  (and (= (type x@@18) T@@48) (U_2_bool (MapType0Select s@@2 x@@18)))
 :qid |stdinbpl.204:33|
 :skolemid |24|
...
(assert (forall ((a@@32 T@U) (x@@19 T@U) ) (! (let ((T@@50 (type x@@19)))
 (=> (and (= (type a@@32) (MapType0Type T@@50 boolType)) (not (U_2_bool (MapType0Select a@@32 x@@19)))) (= (|Set#Card| (|Set#UnionOne| a@@32 x@@19)) (+ (|Set#Card| a@@32) 1))))
 :qid |stdinbpl.220:18|
 :skolemid |33|
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((a@@35 T@U) (x@@20 T@U) (o@@15 T@U) ) (! (let ((T@@52 (type x@@20)))
 (=> (and (= (type a@@35) (MultiSetType T@@52)) (= (type o@@15) T@@52)) (= (|MultiSet#Select| (|MultiSet#UnionOne| a@@35 x@@20) o@@15) (ite (= x@@20 o@@15) (+ (|MultiSet#Select| a@@35 o@@15) 1) (|MultiSet#Select| a@@35 o@@15)))))
 :qid |stdinbpl.324:18|
 :skolemid |64|
...
(declare-fun i_4 () Int)
(declare-fun j_2 () Int)
(assert  (and (and (and (and (= (type m@@23) (MapType intType RefType)) (= (type QPMask@0) (MapType2Type RefType realType))) (= (type Heap@0) (MapType1Type RefType))) (= (type Heap@@9) (MapType1Type RefType))) (= (type Heap@1) (MapType1Type RefType))))
(set-info :boogie-vc-id test6)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon10_correct true))
(let ((anon15_Else_correct  (=> (not (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U x@@21)))) (=> (and (= Heap@1 Heap@@9) (= (ControlFlow 0 16) 10)) anon10_correct))))
(let ((anon15_Then_correct  (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U x@@21))) (and (=> (= (ControlFlow 0 11) (- 0 15)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U x@@21)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U x@@21))) (and (=> (= (ControlFlow 0 11) (- 0 14)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U x@@21)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U x@@21))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (HasDirectPerm QPMask@0 (MapType0Select (|Map#Elements| m@@23) (int_2_U x@@21)) val)) (=> (HasDirectPerm QPMask@0 (MapType0Select (|Map#Elements| m@@23) (int_2_U x@@21)) val) (and (=> (= (ControlFlow 0 11) (- 0 12)) (= FullPerm (U_2_real (MapType2Select QPMask@0 (MapType0Select (|Map#Elements| m@@23) (int_2_U x@@21)) val)))) (=> (= FullPerm (U_2_real (MapType2Select QPMask@0 (MapType0Select (|Map#Elements| m@@23) (int_2_U x@@21)) val))) (=> (and (and (= Heap@0 (MapType1Store Heap@@9 (MapType0Select (|Map#Elements| m@@23) (int_2_U x@@21)) val (int_2_U (+ (U_2_int (MapType1Select Heap@@9 (MapType0Select (|Map#Elements| m@@23) (int_2_U x@@21)) val)) x@@21)))) (state Heap@0 QPMask@0)) (and (= Heap@1 Heap@0) (= (ControlFlow 0 11) 10))) anon10_correct))))))))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((k_1 Int) (k_1_1 Int) ) (!  (=> (and (and (and (and (not (= k_1 k_1_1)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U k_1)))) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U k_1_1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (MapType0Select (|Map#Elements| m@@23) (int_2_U k_1)) (MapType0Select (|Map#Elements| m@@23) (int_2_U k_1_1)))))
 :qid |stdinbpl.949:15|
 :skolemid |107|
))) (=> (forall ((k_1@@0 T@U) (k_1_1@@0 T@U) ) (!  (=> (and (= (type k_1@@0) intType) (= (type k_1_1@@0) intType)) (=> (and (and (and (and (not (= (U_2_int k_1@@0) (U_2_int k_1_1@@0))) (U_2_bool (MapType0Select (|Map#Domain| m@@23) k_1@@0))) (U_2_bool (MapType0Select (|Map#Domain| m@@23) k_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (MapType0Select (|Map#Elements| m@@23) k_1@@0) (MapType0Select (|Map#Elements| m@@23) k_1_1@@0)))))
 :qid |stdinbpl.949:15|
 :skolemid |107|
 :no-pattern (type k_1@@0)
 :no-pattern (type k_1_1@@0)
 :no-pattern (U_2_int k_1@@0)
 :no-pattern (U_2_bool k_1@@0)
 :no-pattern (U_2_int k_1_1@@0)
 :no-pattern (U_2_bool k_1_1@@0)
)) (=> (forall ((k_1@@1 T@U) ) (!  (=> (= (type k_1@@1) intType) (=> (and (U_2_bool (MapType0Select (|Map#Domain| m@@23) k_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 (MapType0Select (|Map#Elements| m@@23) k_1@@1)) (= (invRecv1 (MapType0Select (|Map#Elements| m@@23) k_1@@1)) (U_2_int k_1@@1)))))
 :qid |stdinbpl.955:22|
 :skolemid |108|
 :pattern ( (MapType0Select (|Map#Elements| m@@23) k_1@@1))
 :pattern ( (MapType0Select (|Map#Domain| m@@23) k_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U (invRecv1 o_3)))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (MapType0Select (|Map#Elements| m@@23) (int_2_U (invRecv1 o_3))) o_3)))
 :qid |stdinbpl.959:22|
 :skolemid |109|
 :pattern ( (invRecv1 o_3))
)) (forall ((k_1@@2 T@U) ) (!  (=> (and (= (type k_1@@2) intType) (U_2_bool (MapType0Select (|Map#Domain| m@@23) k_1@@2))) (not (= (MapType0Select (|Map#Elements| m@@23) k_1@@2) null)))
 :qid |stdinbpl.965:22|
 :skolemid |110|
 :pattern ( (MapType0Select (|Map#Elements| m@@23) k_1@@2))
 :pattern ( (MapType0Select (|Map#Domain| m@@23) k_1@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U (invRecv1 o_3@@0)))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (MapType0Select (|Map#Elements| m@@23) (int_2_U (invRecv1 o_3@@0))) o_3@@0)) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType2Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U (invRecv1 o_3@@0)))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 val)) (U_2_real (MapType2Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.971:22|
 :skolemid |111|
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 val))) (= (U_2_real (MapType2Select ZeroMask o_3@@1 f_5)) (U_2_real (MapType2Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.975:29|
 :skolemid |112|
 :pattern ( (MapType2Select ZeroMask o_3@@1 f_5))
 :pattern ( (MapType2Select QPMask@0 o_3@@1 f_5))
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 17) 11) anon15_Then_correct) (=> (= (ControlFlow 0 17) 16) anon15_Else_correct)))))))))
(let ((anon7_correct true))
(let ((anon14_Else_correct  (=> (and (not (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U k)))) (= (ControlFlow 0 9) 6)) anon7_correct)))
(let ((anon14_Then_correct  (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U k))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U k)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U k))) (=> (= (ControlFlow 0 7) 6) anon7_correct))))))
(let ((anon11_Else_correct  (=> (and (forall ((i_1 T@U) (j_1 T@U) ) (!  (=> (and (and (= (type i_1) intType) (= (type j_1) intType)) (and (U_2_bool (MapType0Select (|Map#Domain| m@@23) i_1)) (and (U_2_bool (MapType0Select (|Map#Domain| m@@23) j_1)) (not (= (U_2_int i_1) (U_2_int j_1)))))) (not (= (MapType0Select (|Map#Elements| m@@23) i_1) (MapType0Select (|Map#Elements| m@@23) j_1))))
 :qid |stdinbpl.933:20|
 :skolemid |106|
 :pattern ( (MapType0Select (|Map#Domain| m@@23) i_1) (MapType0Select (|Map#Domain| m@@23) j_1))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 19) 17) anon13_Else_correct) (=> (= (ControlFlow 0 19) 7) anon14_Then_correct)) (=> (= (ControlFlow 0 19) 9) anon14_Else_correct)))))
(let ((anon3_correct true))
(let ((anon12_Else_correct  (=> (and (not (and (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i_4))) (and (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U j_2))) (not (= i_4 j_2))))) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon12_Then_correct  (=> (and (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i_4))) (and (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U j_2))) (not (= i_4 j_2)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i_4)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i_4))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U j_2)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U j_2))) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (and (=> (= (ControlFlow 0 20) 19) anon11_Else_correct) (=> (= (ControlFlow 0 20) 2) anon12_Then_correct)) (=> (= (ControlFlow 0 20) 5) anon12_Else_correct)))))
