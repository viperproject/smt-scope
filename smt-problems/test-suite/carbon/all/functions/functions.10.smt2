...
(assert  (and (and (and (and (= (type Heap@@47) (MapType0Type RefType)) (= (type x@@56) RefType)) (= (type y@@17) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |fun1#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@47 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@47 x@@56 $allocated)) (U_2_bool (MapType0Select Heap@@47 y@@17 $allocated))) (and (= AssumeFunctionsAbove 0) (not (= x@@56 null)))) (=> (and (and (and (= Mask@0 (MapType1Store ZeroMask x@@56 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@56 f_7)) FullPerm)))) (state Heap@@47 Mask@0)) (and (not (= y@@17 null)) (= Mask@1 (MapType1Store Mask@0 y@@17 g (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@17 g)) FullPerm)))))) (and (and (state Heap@@47 Mask@1) (state Heap@@47 Mask@1)) (and (= x@@56 y@@17) (state Heap@@47 Mask@1)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 y@@17 f_7)) (=> (HasDirectPerm Mask@1 y@@17 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@1 x@@56 g)))))))))
