(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:34:40
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/wands/new_syntax/localVarAssign.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (= i@4@01 ($SortWrappers.$SnapToInt $t@2@01)))
; [exec]
; assert i == x.f
; [eval] i == x.f
; [eval] i < 0
...
(assert (forall (($t@2@01 $Snap)) (!
  (= (MWSF_apply mwsf@5@01 $t@2@01) $t@2@01)
...
; 0,00s
; (get-info :all-statistics)
; [then-branch: 1 | !(i@4@01 < 0) | live]
; [else-branch: 1 | i@4@01 < 0 | live]
(set-option :timeout 0)
(push) ; 4
; [then-branch: 1 | !(i@4@01 < 0)]
(assert (not (< i@4@01 0)))
; [exec]
; assert i >= 0
; [eval] i >= 0
...
(assert (forall (($t@2@01 $Snap)) (!
  (= (MWSF_apply mwsf@6@01 $t@2@01) $t@2@01)
  :pattern ((MWSF_apply mwsf@6@01 $t@2@01))
  :qid |quant-u-2|)))
(pop) ; 4
(set-option :timeout 0)
(push) ; 4
; [else-branch: 1 | i@4@01 < 0]
(assert (< i@4@01 0))
(pop) ; 4
(pop) ; 3
(push) ; 3
