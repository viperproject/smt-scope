...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon13_Then_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (not (= (MapType0Select Heap@@14 this@@9 next) null))) (=> (not (= (MapType0Select Heap@@14 this@@9 next) null)) (=> (= (ControlFlow 0 8) (- 0 7)) (> (U_2_real (MapType1Select UnfoldingMask@4 null (valid (MapType0Select Heap@@14 this@@9 next)))) NoPerm))))))
(let ((anon9_correct true))
(let ((anon14_Else_correct  (=> (= (MapType0Select Heap@1 this@@9 next) null) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 3) 1)) anon9_correct))))
(let ((anon14_Then_correct  (=> (not (= (MapType0Select Heap@1 this@@9 next) null)) (=> (and (and (forall ((o_3 T@U) (f_7 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_7))))
...
)) (= Heap@2 (MapType0Store Heap@1 null (|valid#sm| this@@9) newPMask@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 2) 1))) anon9_correct))))
(let ((anon7_correct  (=> (and (= Heap@0 (MapType0Store Heap@@14 null (|valid#sm| this@@9) (MapType1Store (MapType0Select Heap@@14 null (|valid#sm| this@@9)) this@@9 next (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|valid#sm| this@@9) (MapType1Store (MapType0Select Heap@0 null (|valid#sm| this@@9)) this@@9 value (bool_2_U true))))) (and (=> (= (ControlFlow 0 4) 2) anon14_Then_correct) (=> (= (ControlFlow 0 4) 3) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (|contains#trigger| (MapType0Select Heap@@14 null (valid (MapType0Select Heap@@14 this@@9 next))) (MapType0Select Heap@@14 this@@9 next) i@@3) (= (ControlFlow 0 10) 4)) anon7_correct)))
(let ((anon12_Then_correct  (=> (not (= (MapType0Select Heap@@14 this@@9 next) null)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm UnfoldingMask@4 this@@9 next)) (=> (HasDirectPerm UnfoldingMask@4 this@@9 next) (and (=> (= (ControlFlow 0 11) 8) anon13_Then_correct) (=> (= (ControlFlow 0 11) 10) anon13_Else_correct)))))))
(let ((anon12_Else_correct  (=> (and (= (MapType0Select Heap@@14 this@@9 next) null) (= (ControlFlow 0 6) 4)) anon7_correct)))
(let ((anon11_Then_correct  (=> (not (= i@@3 (U_2_int (MapType0Select Heap@@14 this@@9 value)))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm UnfoldingMask@4 this@@9 next)) (=> (HasDirectPerm UnfoldingMask@4 this@@9 next) (and (=> (= (ControlFlow 0 13) 11) anon12_Then_correct) (=> (= (ControlFlow 0 13) 6) anon12_Else_correct)))))))
(let ((anon11_Else_correct  (=> (and (= i@@3 (U_2_int (MapType0Select Heap@@14 this@@9 value))) (= (ControlFlow 0 5) 4)) anon7_correct)))
(let ((anon2_correct  (=> (state Heap@@14 UnfoldingMask@4) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm UnfoldingMask@4 this@@9 value)) (=> (HasDirectPerm UnfoldingMask@4 this@@9 value) (and (=> (= (ControlFlow 0 15) 13) anon11_Then_correct) (=> (= (ControlFlow 0 15) 5) anon11_Else_correct)))))))
(let ((anon10_Else_correct  (=> (= (MapType0Select Heap@@14 this@@9 next) null) (=> (and (= UnfoldingMask@4 UnfoldingMask@2) (= (ControlFlow 0 18) 15)) anon2_correct))))
(let ((anon10_Then_correct  (=> (not (= (MapType0Select Heap@@14 this@@9 next) null)) (=> (and (> wildcard@4 NoPerm) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 null (valid (MapType0Select Heap@@14 this@@9 next)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 null (valid (MapType0Select Heap@@14 this@@9 next)))) wildcard@4))))) (=> (and (and (InsidePredicate (valid this@@9) (MapType0Select Heap@@14 null (valid this@@9)) (valid (MapType0Select Heap@@14 this@@9 next)) (MapType0Select Heap@@14 null (valid (MapType0Select Heap@@14 this@@9 next)))) (state Heap@@14 UnfoldingMask@3)) (and (= UnfoldingMask@4 UnfoldingMask@3) (= (ControlFlow 0 17) 15))) anon2_correct)))))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@14 this@@9 $allocated)) (= AssumeFunctionsAbove 0)) (=> (and (and (and (not (= this@@9 null)) (state Heap@@14 ZeroMask)) (and (> wildcard@0 NoPerm) (= Mask@0 (MapType1Store ZeroMask null (valid this@@9) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid this@@9))) wildcard@0)))))) (and (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0)) (and (|valid#trigger| Heap@@14 (valid this@@9)) (= (MapType0Select Heap@@14 null (valid this@@9)) (CombineFrames (FrameFragment (MapType0Select Heap@@14 this@@9 next)) (CombineFrames (FrameFragment (MapType0Select Heap@@14 this@@9 value)) (FrameFragment (ite (not (= (MapType0Select Heap@@14 this@@9 next) null)) (MapType0Select Heap@@14 null (valid (MapType0Select Heap@@14 this@@9 next))) EmptyFrame)))))))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (> (U_2_real (MapType1Select Mask@0 null (valid this@@9))) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@0 null (valid this@@9))) NoPerm) (=> (> wildcard@1 NoPerm) (=> (and (< wildcard@1 (U_2_real (MapType1Select Mask@0 null (valid this@@9)))) (= UnfoldingMask@0 (MapType1Store Mask@0 null (valid this@@9) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid this@@9))) wildcard@1))))) (=> (and (and (and (> wildcard@2 NoPerm) (not (= this@@9 null))) (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this@@9 next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this@@9 next)) wildcard@2)))) (state Heap@@14 UnfoldingMask@1))) (and (and (> wildcard@3 NoPerm) (not (= this@@9 null))) (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 this@@9 value (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 this@@9 value)) wildcard@3)))) (state Heap@@14 UnfoldingMask@2)))) (and (=> (= (ControlFlow 0 19) 17) anon10_Then_correct) (=> (= (ControlFlow 0 19) 18) anon10_Else_correct))))))))))))
