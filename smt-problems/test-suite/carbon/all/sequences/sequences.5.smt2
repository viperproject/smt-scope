...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (= (ControlFlow 0 2) (- 0 1))) (|Seq#Equal| s@@17 (|Seq#Append| (|Seq#Take| s@@17 i@@10) (|Seq#Drop| s@@17 i@@10)))))))
