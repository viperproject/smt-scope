...
(assert  (and (and (and (and (and (and (and (and (and (= (type xs) (MapType2Type RefType boolType)) (= (type x@@19) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type z@@0) RefType)) (= (type y@@6) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@46 T@U) (arg1@@33 Real) (arg2@@14 T@U) (arg3@@11 Real) ) (! (= (type (invRecv2 arg0@@46 arg1@@33 arg2@@14 arg3@@11)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@46 arg1@@33 arg2@@14 arg3@@11))
))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@47 T@U) ) (! (= (type (invRecv1 arg0@@47)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon9_correct true))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon9_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select Mask@0 z@@0 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 z@@0 f_7))) (=> (= (ControlFlow 0 7) 6) anon9_correct))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 12)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (U_2_bool (MapType2Select xs x_3))) (U_2_bool (MapType2Select xs x_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (or (or (not (= x_3 x_3_1)) (not (= FullPerm FullPerm))) (not (= y@@6 y@@6))) (not (= FullPerm FullPerm)))))
 :qid |stdinbpl.562:17|
 :skolemid |95|
 :pattern ( (neverTriggered2 x_3) (neverTriggered2 x_3_1))
))) (=> (forall ((x_3@@0 T@U) (x_3_1@@0 T@U) ) (!  (=> (and (= (type x_3@@0) RefType) (= (type x_3_1@@0) RefType)) (=> (and (and (and (and (not (= x_3@@0 x_3_1@@0)) (U_2_bool (MapType2Select xs x_3@@0))) (U_2_bool (MapType2Select xs x_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (or (or (not (= x_3@@0 x_3_1@@0)) (not (= FullPerm FullPerm))) (not (= y@@6 y@@6))) (not (= FullPerm FullPerm)))))
 :qid |stdinbpl.562:17|
 :skolemid |95|
 :pattern ( (neverTriggered2 x_3@@0) (neverTriggered2 x_3_1@@0))
)) (=> (forall ((x_3@@1 T@U) ) (!  (=> (= (type x_3@@1) RefType) (=> (and (U_2_bool (MapType2Select xs x_3@@1)) (< NoPerm FullPerm)) (and (= (invRecv2 x_3@@1 FullPerm y@@6 FullPerm) x_3@@1) (qpRange2 x_3@@1 FullPerm y@@6 FullPerm))))
 :qid |stdinbpl.568:22|
 :skolemid |96|
 :pattern ( (MapType0Select Heap@@9 null (wand x_3@@1 FullPerm y@@6 FullPerm)))
 :pattern ( (MapType1Select QPMask@0 null (wand x_3@@1 FullPerm y@@6 FullPerm)))
 :pattern ( (MapType0Select Heap@@9 null (wand x_3@@1 FullPerm y@@6 FullPerm)))
)) (=> (and (forall ((arg_0 T@U) (arg_1 Real) (arg_2 T@U) (arg_3 Real) ) (!  (=> (and (= (type arg_0) RefType) (= (type arg_2) RefType)) (=> (and (and (U_2_bool (MapType2Select xs (invRecv2 arg_0 arg_1 arg_2 arg_3))) (< NoPerm FullPerm)) (qpRange2 arg_0 arg_1 arg_2 arg_3)) (and (and (and (= (invRecv2 arg_0 arg_1 arg_2 arg_3) arg_0) (= FullPerm arg_1)) (= y@@6 arg_2)) (= FullPerm arg_3))))
 :qid |stdinbpl.572:22|
 :skolemid |97|
 :pattern ( (invRecv2 arg_0 arg_1 arg_2 arg_3))
)) (forall ((arg_0@@0 T@U) (arg_1@@0 Real) (arg_2@@0 T@U) (arg_3@@0 Real) ) (!  (=> (and (= (type arg_0@@0) RefType) (= (type arg_2@@0) RefType)) (=> (and (and (U_2_bool (MapType2Select xs (invRecv2 arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0))) (< NoPerm FullPerm)) (qpRange2 arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0)) (and (=> (< NoPerm FullPerm) (and (and (and (= (invRecv2 arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0) arg_0@@0) (= FullPerm arg_1@@0)) (= y@@6 arg_2@@0)) (= FullPerm arg_3@@0))) (= (U_2_real (MapType1Select QPMask@1 null (wand arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0))) (+ (U_2_real (MapType1Select QPMask@0 null (wand arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0))) FullPerm)))))
 :qid |stdinbpl.578:22|
 :skolemid |98|
...
)) (forall ((arg_0@@1 T@U) (arg_1@@1 Real) (arg_2@@1 T@U) (arg_3@@1 Real) ) (!  (=> (and (and (= (type arg_0@@1) RefType) (= (type arg_2@@1) RefType)) (not (and (and (U_2_bool (MapType2Select xs (invRecv2 arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1))) (< NoPerm FullPerm)) (qpRange2 arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1)))) (= (U_2_real (MapType1Select QPMask@1 null (wand arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1))) (U_2_real (MapType1Select QPMask@0 null (wand arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1)))))
 :qid |stdinbpl.588:22|
 :skolemid |100|
 :pattern ( (MapType1Select QPMask@1 null (wand arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1)))
))) (and (state Heap@@9 QPMask@1) (state Heap@@9 QPMask@1))) (and (and (state Heap@@9 QPMask@1) (U_2_bool (MapType2Select xs z@@0))) (and (state Heap@@9 QPMask@1) (state Heap@@9 QPMask@1)))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select QPMask@1 null (wand z@@0 FullPerm y@@6 FullPerm))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@1 null (wand z@@0 FullPerm y@@6 FullPerm)))) (=> (and (= Mask@0 (MapType1Store QPMask@1 null (wand z@@0 FullPerm y@@6 FullPerm) (real_2_U (- (U_2_real (MapType1Select QPMask@1 null (wand z@@0 FullPerm y@@6 FullPerm))) FullPerm)))) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 10) 7) anon14_Then_correct) (=> (= (ControlFlow 0 10) 9) anon14_Else_correct))))))))))))
(let ((anon13_Then_correct true))
(let ((anon6_correct true))
(let ((anon12_Then_correct  (=> (U_2_bool (MapType2Select xs x@@19)) (and (=> (= (ControlFlow 0 5) 4) anon13_Then_correct) (=> (= (ControlFlow 0 5) 2) anon6_correct)))))
(let ((anon12_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs x@@19))) (= (ControlFlow 0 3) 2)) anon6_correct)))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select xs x_1))) (U_2_bool (MapType2Select xs x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.490:15|
 :skolemid |89|
 :no-pattern (type x_1)
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (= (invRecv1 o_3@@0) o_3@@0)))
 :qid |stdinbpl.500:22|
 :skolemid |91|
...
)) (forall ((o_3@@1 T@U) ) (!  (=> (= (type o_3@@1) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs (invRecv1 o_3@@1))) (< NoPerm FullPerm)) (qpRange1 o_3@@1)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@1) o_3@@1)) (= (U_2_real (MapType1Select QPMask@0 o_3@@1 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@1 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select xs (invRecv1 o_3@@1))) (< NoPerm FullPerm)) (qpRange1 o_3@@1))) (= (U_2_real (MapType1Select QPMask@0 o_3@@1 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@1 f_7))))))
 :qid |stdinbpl.512:22|
 :skolemid |93|
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (and (=> (= (ControlFlow 0 13) 10) anon11_Else_correct) (=> (= (ControlFlow 0 13) 5) anon12_Then_correct)) (=> (= (ControlFlow 0 13) 3) anon12_Else_correct)))))))
(let ((anon10_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 y@@6 $allocated)) (U_2_bool (MapType0Select Heap@@9 z@@0 $allocated))) (and (=> (= (ControlFlow 0 15) 1) anon10_Then_correct) (=> (= (ControlFlow 0 15) 13) anon10_Else_correct))))))
