...
(assert  (and (and (= (type x22) RefType) (= (type Heap@@20) (MapType0Type RefType))) (= (type x@@16) RefType)))
(set-info :boogie-vc-id test2_pres_termination_proof)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon6_Then_correct  (=> (and (> (U_2_real (MapType1Select ZeroMask x22 f_7)) NoPerm) (= (ControlFlow 0 4) (- 0 3))) false)))
(let ((anon4_correct true))
(let ((anon6_Else_correct  (=> (>= NoPerm (U_2_real (MapType1Select ZeroMask x22 f_7))) (=> (and (state Heap@@20 ZeroMask) (= (ControlFlow 0 5) 1)) anon4_correct))))
(let ((anon5_Then_correct  (=> (and $condInEx (U_2_bool (MapType0Select Heap@@20 x22 $allocated))) (and (=> (= (ControlFlow 0 6) 4) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (not $condInEx) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (state Heap@@20 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@20 x@@16 $allocated))) (and (=> (= (ControlFlow 0 7) 6) anon5_Then_correct) (=> (= (ControlFlow 0 7) 2) anon5_Else_correct))))))
