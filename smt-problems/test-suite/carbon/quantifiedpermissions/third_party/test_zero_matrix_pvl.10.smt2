...
(assert  (and (and (and (and (and (= (type matrix) (SeqType RefType)) (= (type PostHeap@0) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@41) (MapType0Type RefType))) (= (type diz) RefType)))
(set-info :boogie-vc-id Ref__loop_main_33)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 43) (let ((anon34_Then_correct  (and (=> (= (ControlFlow 0 25) (- 0 30)) (<= 0 i_1)) (=> (<= 0 i_1) (and (=> (= (ControlFlow 0 25) (- 0 29)) (< i_1 M)) (=> (< i_1 M) (and (=> (= (ControlFlow 0 25) (- 0 28)) (<= 0 M)) (=> (<= 0 M) (and (=> (= (ControlFlow 0 25) (- 0 27)) (<= 0 j_5)) (=> (<= 0 j_5) (and (=> (= (ControlFlow 0 25) (- 0 26)) (< j_5 N)) (=> (< j_5 N) (=> (= (ControlFlow 0 25) (- 0 24)) (<= 0 N))))))))))))))
(let ((anon18_correct true))
(let ((anon34_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 34)) (>= (Ref__multidim_index_2 PostHeap@0 M N i_1 j_5) 0)) (=> (>= (Ref__multidim_index_2 PostHeap@0 M N i_1 j_5) 0) (and (=> (= (ControlFlow 0 31) (- 0 33)) (< (Ref__multidim_index_2 PostHeap@0 M N i_1 j_5) (|Seq#Length| matrix))) (=> (< (Ref__multidim_index_2 PostHeap@0 M N i_1 j_5) (|Seq#Length| matrix)) (and (=> (= (ControlFlow 0 31) (- 0 32)) (HasDirectPerm QPMask@2 (|Seq#Index| matrix (Ref__multidim_index_2 PostHeap@0 M N i_1 j_5)) Ref__Integer_value)) (=> (HasDirectPerm QPMask@2 (|Seq#Index| matrix (Ref__multidim_index_2 PostHeap@0 M N i_1 j_5)) Ref__Integer_value) (=> (= (ControlFlow 0 31) 22) anon18_correct)))))))))
(let ((anon33_Then_correct  (=> (and (<= 0 i_1) (and (< i_1 M) (and (<= 0 j_5) (< j_5 N)))) (and (=> (= (ControlFlow 0 35) 25) anon34_Then_correct) (=> (= (ControlFlow 0 35) 31) anon34_Else_correct)))))
(let ((anon33_Else_correct  (=> (and (not (and (<= 0 i_1) (and (< i_1 M) (and (<= 0 j_5) (< j_5 N))))) (= (ControlFlow 0 23) 22)) anon18_correct)))
(let ((anon32_Else_correct true))
(let ((anon30_Else_correct  (and (=> (= (ControlFlow 0 36) (- 0 37)) (forall ((j_3 Int) (j_3_1 Int) ) (!  (=> (and (and (and (and (not (= j_3 j_3_1)) (and (<= 0 j_3) (< j_3 (* M N)))) (and (<= 0 j_3_1) (< j_3_1 (* M N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| matrix j_3) (|Seq#Index| matrix j_3_1))))
 :qid |stdinbpl.2054:15|
 :skolemid |173|
))) (=> (forall ((j_3@@0 Int) (j_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_3@@0 j_3_1@@0)) (and (<= 0 j_3@@0) (< j_3@@0 (* M N)))) (and (<= 0 j_3_1@@0) (< j_3_1@@0 (* M N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| matrix j_3@@0) (|Seq#Index| matrix j_3_1@@0))))
 :qid |stdinbpl.2054:15|
 :skolemid |173|
)) (=> (and (and (and (forall ((j_3@@1 Int) ) (!  (=> (and (and (<= 0 j_3@@1) (< j_3@@1 (* M N))) (< NoPerm FullPerm)) (and (qpRange10 (|Seq#Index| matrix j_3@@1)) (= (invRecv10 (|Seq#Index| matrix j_3@@1)) j_3@@1)))
 :qid |stdinbpl.2060:22|
 :skolemid |174|
 :pattern ( (|Seq#Index| matrix j_3@@1))
 :pattern ( (|Seq#Index| matrix j_3@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv10 o_3)) (< (invRecv10 o_3) (* M N))) (< NoPerm FullPerm)) (qpRange10 o_3)) (= (|Seq#Index| matrix (invRecv10 o_3)) o_3)))
 :qid |stdinbpl.2064:22|
 :skolemid |175|
 :pattern ( (invRecv10 o_3))
))) (and (forall ((j_3@@2 Int) ) (!  (=> (and (<= 0 j_3@@2) (< j_3@@2 (* M N))) (not (= (|Seq#Index| matrix j_3@@2) null)))
 :qid |stdinbpl.2070:22|
 :skolemid |176|
 :pattern ( (|Seq#Index| matrix j_3@@2))
 :pattern ( (|Seq#Index| matrix j_3@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv10 o_3@@0)) (< (invRecv10 o_3@@0) (* M N))) (< NoPerm FullPerm)) (qpRange10 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| matrix (invRecv10 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 Ref__Integer_value)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 Ref__Integer_value)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv10 o_3@@0)) (< (invRecv10 o_3@@0) (* M N))) (< NoPerm FullPerm)) (qpRange10 o_3@@0))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 Ref__Integer_value)) (U_2_real (MapType1Select ZeroMask o_3@@0 Ref__Integer_value))))))
...
(let ((anon31_Else_correct  (=> (and (not (and (<= 0 j_4) (< j_4 (* M N)))) (= (ControlFlow 0 20) 16)) anon12_correct)))
(let ((anon31_Then_correct  (=> (and (<= 0 j_4) (< j_4 (* M N))) (and (=> (= (ControlFlow 0 17) (- 0 19)) (>= j_4 0)) (=> (>= j_4 0) (and (=> (= (ControlFlow 0 17) (- 0 18)) (< j_4 (|Seq#Length| matrix))) (=> (< j_4 (|Seq#Length| matrix)) (=> (= (ControlFlow 0 17) 16) anon12_correct))))))))
...
(let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 39) (- 0 40)) (forall ((j_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (and (not (= j_1 j_1_1)) (and (<= 0 j_1) (< j_1 (* M N)))) (and (<= 0 j_1_1) (< j_1_1 (* M N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| matrix j_1) (|Seq#Index| matrix j_1_1))))
 ...
 :qid |stdinbpl.1997:15|
 :skolemid |167|
)) (=> (forall ((j_1@@1 Int) ) (!  (=> (and (and (<= 0 j_1@@1) (< j_1@@1 (* M N))) (< NoPerm FullPerm)) (and (qpRange9 (|Seq#Index| matrix j_1@@1)) (= (invRecv9 (|Seq#Index| matrix j_1@@1)) j_1@@1)))
 :qid |stdinbpl.2003:22|
 :skolemid |168|
 :pattern ( (|Seq#Index| matrix j_1@@1))
 :pattern ( (|Seq#Index| matrix j_1@@1))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (<= 0 (invRecv9 o_3@@2)) (< (invRecv9 o_3@@2) (* M N))) (< NoPerm FullPerm)) (qpRange9 o_3@@2)) (= (|Seq#Index| matrix (invRecv9 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.2007:22|
 :skolemid |169|
 :pattern ( (invRecv9 o_3@@2))
)) (forall ((j_1@@2 Int) ) (!  (=> (and (<= 0 j_1@@2) (< j_1@@2 (* M N))) (not (= (|Seq#Index| matrix j_1@@2) null)))
 :qid |stdinbpl.2013:22|
 :skolemid |170|
 :pattern ( (|Seq#Index| matrix j_1@@2))
 :pattern ( (|Seq#Index| matrix j_1@@2))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (and (<= 0 (invRecv9 o_3@@3)) (< (invRecv9 o_3@@3) (* M N))) (< NoPerm FullPerm)) (qpRange9 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| matrix (invRecv9 o_3@@3)) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 Ref__Integer_value)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 Ref__Integer_value)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv9 o_3@@3)) (< (invRecv9 o_3@@3) (* M N))) (< NoPerm FullPerm)) (qpRange9 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 Ref__Integer_value)) (U_2_real (MapType1Select ZeroMask o_3@@3 Ref__Integer_value))))))
...
))) (and (state Heap@@41 QPMask@0) (state Heap@@41 QPMask@0))) (and (=> (= (ControlFlow 0 39) 38) anon29_Then_correct) (=> (= (ControlFlow 0 39) 14) anon29_Else_correct)))))))))
(let ((anon7_correct true))
(let ((anon28_Else_correct  (=> (and (not (and (<= 0 j_2) (< j_2 (* M N)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon28_Then_correct  (=> (and (<= 0 j_2) (< j_2 (* M N))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= j_2 0)) (=> (>= j_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< j_2 (|Seq#Length| matrix))) (=> (< j_2 (|Seq#Length| matrix)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon25_Else_correct  (=> (and (forall ((ix_1_1 Int) (jx_1_1 Int) ) (!  (=> (and (>= ix_1_1 0) (and (< ix_1_1 (|Seq#Length| matrix)) (and (>= jx_1_1 0) (and (< jx_1_1 (|Seq#Length| matrix)) (not (= ix_1_1 jx_1_1)))))) (not (= (|Seq#Index| matrix ix_1_1) (|Seq#Index| matrix jx_1_1))))
 :qid |stdinbpl.1979:20|
 :skolemid |166|
 :pattern ( (|Seq#Index| matrix ix_1_1) (|Seq#Index| matrix jx_1_1))
)) (state Heap@@41 ZeroMask)) (and (and (=> (= (ControlFlow 0 41) 39) anon27_Else_correct) (=> (= (ControlFlow 0 41) 9) anon28_Then_correct)) (=> (= (ControlFlow 0 41) 12) anon28_Else_correct)))))
(let ((anon3_correct true))
(let ((anon26_Else_correct  (=> (and (not (and (>= ix_7 0) (and (< ix_7 (|Seq#Length| matrix)) (and (>= jx_7 0) (and (< jx_7 (|Seq#Length| matrix)) (not (= ix_7 jx_7))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon26_Then_correct  (=> (and (>= ix_7 0) (and (< ix_7 (|Seq#Length| matrix)) (and (>= jx_7 0) (and (< jx_7 (|Seq#Length| matrix)) (not (= ix_7 jx_7)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= ix_7 0)) (=> (>= ix_7 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< ix_7 (|Seq#Length| matrix))) (=> (< ix_7 (|Seq#Length| matrix)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= jx_7 0)) (=> (>= jx_7 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< jx_7 (|Seq#Length| matrix))) (=> (< jx_7 (|Seq#Length| matrix)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@41 diz $allocated))) (and (not (= diz null)) (state Heap@@41 ZeroMask))) (and (and (>= current_thread_id 0) (state Heap@@41 ZeroMask)) (and (<= (* M N) (|Seq#Length| matrix)) (state Heap@@41 ZeroMask)))) (and (and (=> (= (ControlFlow 0 42) 41) anon25_Else_correct) (=> (= (ControlFlow 0 42) 2) anon26_Then_correct)) (=> (= (ControlFlow 0 42) 7) anon26_Else_correct))))))
