...
(assert  (and (and (and (= (type Heap@@20) (MapType0Type RefType)) (= (type x@@34) RefType)) (= (type y@@11) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
...
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (FF x@@34 y@@11))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (FF x@@34 y@@11)))) (=> (= (ControlFlow 0 5) 4) anon3_correct))))))
(let ((anon5_Else_correct  (=> (and (= (fun4 Heap@@20 x@@34 y@@11) 1) (state Heap@@20 Mask@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (= x@@34 null))) (=> (not (= x@@34 null)) (=> (and (state Heap@@20 Mask@0) (= (ControlFlow 0 2) (- 0 1))) (not (= y@@11 null))))))))
(let ((anon0_correct  (=> (state Heap@@20 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@20 x@@34 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@20 y@@11 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (FF x@@34 y@@11) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (FF x@@34 y@@11))) FullPerm))))) (and (state Heap@@20 Mask@0) (state Heap@@20 Mask@0))) (and (and (=> (= (ControlFlow 0 8) 2) anon5_Else_correct) (=> (= (ControlFlow 0 8) 5) anon6_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))))
