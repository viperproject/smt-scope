...
(assert (forall ((i@4@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger
    (Seq_range
      ...
      (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))))
    i@4@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/array_problem.vpr@24@12@24@68-aux|)))
(assert (forall ((i@4@01 Int)) (!
  (or
    (not
      (Seq_contains
...
(assert (forall ((i@4@01 Int)) (!
  ...
  :pattern ((Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))
    i@4@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/array_problem.vpr@24@12@24@68|)))
(assert (=
  ($Snap.second ($Snap.second $t@2@01))
  ($Snap.combine
...
(assert (forall ((i1@5@01 Int) (i2@6@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger
    ...
    (Seq_range
      ...
      (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))))
    i2@6@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/array_problem.vpr@25@12@25@124-aux|)))
(assert (forall ((i1@5@01 Int) (i2@6@01 Int)) (!
  (and
    (=>
      (Seq_contains
...
(assert (forall ((i1@5@01 Int) (i2@6@01 Int)) (!
  ...
  :pattern ((Seq_index
    ...
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))
    i2@6@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/array_problem.vpr@25@12@25@124|)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@2@01)))
  ($Snap.combine
    ...
    (and
      ...
      (=
        ...
        (Seq_index
          ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))
          (inv@14@01 r))))
    (= (- (/ (to_real 1) (to_real 2)) (pTaken@16@01 r)) $Perm.No))
  ...
  ($Snap.combine
    ...
    ($Snap.combine
      ...
      ($Snap.combine
        $Snap.unit
        ($Snap.combine
          ($SortWrappers.$FVF<val>To$Snap (as sm@17@01  $FVF<val>))
...
(assert (=
  ($FVF.lookup_val (as sm@18@01  $FVF<val>) (Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))
    3))
...
(assert (forall ((r $Ref)) (!
  (=
    ($FVF.perm_val (as pm@20@01  $FPM) r)
    (+
      (ite
        (and
          (img@9@01 r)
      ...
      (ite
        ...
        (/ (to_real 1) (to_real 2))
        $Perm.No)))
  :pattern (($FVF.perm_val (as pm@20@01  $FPM) r))
  :qid |qp.resPrmSumDef4|)))
(push) ; 2
(assert (not (<
  $Perm.No
  ($FVF.perm_val (as pm@20@01  $FPM) (Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))
    3)))))
(check-sat)
; unsat
...
; 0,00s
; (get-info :all-statistics)
(assert ($FVF.lookup_val (as sm@19@01  $FVF<val>) (Seq_index
  ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))
  3)))
(declare-const sm@21@01 $FVF<val>)
; Definitional axioms for singleton-SM's value
(assert (=
  ($FVF.lookup_val (as sm@21@01  $FVF<val>) this@1@01)
...
(define-fun pTaken@24@01 ((r $Ref)) $Perm
  (ite
    ...
    ($Perm.min
      ...
      (- (- $Perm.Write (pTaken@22@01 r)) (pTaken@23@01 r)))
    $Perm.No))
; Done precomputing, updating quantified chunks
; State saturation: before repetition
(set-option :timeout 10)
...
(assert (not (forall ((r $Ref)) (!
  (=>
    (= r (Seq_index ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01)) 3))
    (= (- (- $Perm.Write (pTaken@22@01 r)) (pTaken@23@01 r)) $Perm.No))
...
(assert (=
  ($FVF.lookup_val (as sm@25@01  $FVF<val>) (Seq_index
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))
    3))
  false))
; [exec]
...
; [eval] |l|
(push) ; 5
; [then-branch: 9 | i@27@01 in [0..|First:($t@2@01)|] | live]
; [else-branch: 9 | !(i@27@01 in [0..|First:($t@2@01)|]) | live]
(push) ; 6
; [then-branch: 9 | i@27@01 in [0..|First:($t@2@01)|]]
(assert (Seq_contains
  (Seq_range
    0
    (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))))
...
; (get-info :all-statistics)
(push) ; 7
(assert (not (< i@27@01 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))))))
(check-sat)
; unsat
(pop) ; 7
; 0,00s
...
(pop) ; 6
(push) ; 6
; [else-branch: 9 | !(i@27@01 in [0..|First:($t@2@01)|])]
(assert (not
  (Seq_contains
    (Seq_range
      0
...
; [eval] |l|
(push) ; 5
; [then-branch: 10 | !(i1@28@01 in [0..|First:($t@2@01)|]) | live]
; [else-branch: 10 | i1@28@01 in [0..|First:($t@2@01)|] | live]
(push) ; 6
; [then-branch: 10 | !(i1@28@01 in [0..|First:($t@2@01)|])]
(assert (not
  (Seq_contains
    (Seq_range
      0
...
(pop) ; 6
(push) ; 6
; [else-branch: 10 | i1@28@01 in [0..|First:($t@2@01)|]]
(assert (Seq_contains
  (Seq_range
    0
    (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))))
...
; [eval] |l|
(push) ; 7
; [then-branch: 11 | !(i2@29@01 in [0..|First:($t@2@01)|]) | live]
; [else-branch: 11 | i2@29@01 in [0..|First:($t@2@01)|] | live]
(push) ; 8
; [then-branch: 11 | !(i2@29@01 in [0..|First:($t@2@01)|])]
(assert (not
  (Seq_contains
    (Seq_range
      0
...
(pop) ; 8
(push) ; 8
; [else-branch: 11 | i2@29@01 in [0..|First:($t@2@01)|]]
(assert (Seq_contains
  (Seq_range
    0
    (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))))
...
(assert (or
  ...
  (not
    (Seq_contains
      ...
      i1@28@01))))
(push) ; 5
; [then-branch: 12 | i1@28@01 in [0..|First:($t@2@01)|] && i2@29@01 in [0..|First:($t@2@01)|] && i1@28@01 != i2@29@01 | live]
; [else-branch: 12 | !(i1@28@01 in [0..|First:($t@2@01)|] && i2@29@01 in [0..|First:($t@2@01)|] && i1@28@01 != i2@29@01) | live]
(push) ; 6
; [then-branch: 12 | i1@28@01 in [0..|First:($t@2@01)|] && i2@29@01 in [0..|First:($t@2@01)|] && i1@28@01 != i2@29@01]
(assert (and
  (Seq_contains
    (Seq_range
      0
...
; (get-info :all-statistics)
(push) ; 7
(assert (not (< i1@28@01 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))))))
(check-sat)
; unsat
(pop) ; 7
; 0,00s
...
; (get-info :all-statistics)
(push) ; 7
(assert (not (< i2@29@01 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))))))
(check-sat)
; unsat
(pop) ; 7
; 0,00s
...
(pop) ; 6
(push) ; 6
; [else-branch: 12 | !(i1@28@01 in [0..|First:($t@2@01)|] && i2@29@01 in [0..|First:($t@2@01)|] && i1@28@01 != i2@29@01)]
(assert (not
  (and
    (Seq_contains
      (Seq_range
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i@30@01 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
  ...
  (ite
    ...
    ($Perm.min
      (ite
        ...
        $Perm.Write
        $Perm.No)
      (- (/ (to_real 1) (to_real 2)) (pTaken@33@01 r)))
    $Perm.No))
(define-fun pTaken@35@01 ((r $Ref)) $Perm
  (ite
    ...
    ($Perm.min
      (ite (= r this@1@01) $Perm.Write $Perm.No)
      (- (- (/ (to_real 1) (to_real 2)) (pTaken@33@01 r)) (pTaken@34@01 r)))
    $Perm.No))
; Done precomputing, updating quantified chunks
; State saturation: before repetition
(set-option :timeout 10)
    ...
    (and
      ...
      (=
        ...
        (Seq_index
          ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))
          (inv@31@01 r))))
    (= (- (/ (to_real 1) (to_real 2)) (pTaken@33@01 r)) $Perm.No))
        ...
        (and
          ...
          (Seq_contains
            (Seq_range
              ...
              (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))))
            (inv@8@01 r)))
        (< $Perm.No (- (/ (to_real 1) (to_real 2)) (pTaken@23@01 r)))
        false))
    (=
      ($FVF.lookup_val (as sm@36@01  $FVF<val>) r)
      ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@2@01))))) r)))
  ...
  ($Snap.combine
    ...
    ($Snap.combine
      ...
      ($Snap.combine
        $Snap.unit
        ($Snap.combine
          ($SortWrappers.$FVF<val>To$Snap (as sm@36@01  $FVF<val>))
          $Snap.unit))))) ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01)) (Seq_length
  ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01)))))
(pop) ; 3
; Joined path conditions
...
; [eval] |l|
(push) ; 5
; [then-branch: 14 | i@37@01 in [0..|First:($t@2@01)|] | live]
; [else-branch: 14 | !(i@37@01 in [0..|First:($t@2@01)|]) | live]
(push) ; 6
; [then-branch: 14 | i@37@01 in [0..|First:($t@2@01)|]]
(assert (Seq_contains
  (Seq_range
    0
    (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))))
...
; (get-info :all-statistics)
(push) ; 7
(assert (not (< i@37@01 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))))))
(check-sat)
; unsat
(pop) ; 7
; 0,00s
...
(pop) ; 6
(push) ; 6
; [else-branch: 14 | !(i@37@01 in [0..|First:($t@2@01)|])]
(assert (not
  (Seq_contains
    (Seq_range
      0
...
; [eval] |l|
(push) ; 5
; [then-branch: 15 | !(i1@38@01 in [0..|First:($t@2@01)|]) | live]
; [else-branch: 15 | i1@38@01 in [0..|First:($t@2@01)|] | live]
(push) ; 6
; [then-branch: 15 | !(i1@38@01 in [0..|First:($t@2@01)|])]
(assert (not
  (Seq_contains
    (Seq_range
      0
...
(pop) ; 6
(push) ; 6
; [else-branch: 15 | i1@38@01 in [0..|First:($t@2@01)|]]
(assert (Seq_contains
  (Seq_range
    0
    (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))))
...
; [eval] |l|
(push) ; 7
; [then-branch: 16 | !(i2@39@01 in [0..|First:($t@2@01)|]) | live]
; [else-branch: 16 | i2@39@01 in [0..|First:($t@2@01)|] | live]
(push) ; 8
; [then-branch: 16 | !(i2@39@01 in [0..|First:($t@2@01)|])]
(assert (not
  (Seq_contains
    (Seq_range
      0
...
(pop) ; 8
(push) ; 8
; [else-branch: 16 | i2@39@01 in [0..|First:($t@2@01)|]]
(assert (Seq_contains
  (Seq_range
    0
    (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))))
...
(assert (or
  ...
  (not
    (Seq_contains
      ...
      i1@38@01))))
(push) ; 5
; [then-branch: 17 | i1@38@01 in [0..|First:($t@2@01)|] && i2@39@01 in [0..|First:($t@2@01)|] && i1@38@01 != i2@39@01 | live]
; [else-branch: 17 | !(i1@38@01 in [0..|First:($t@2@01)|] && i2@39@01 in [0..|First:($t@2@01)|] && i1@38@01 != i2@39@01) | live]
(push) ; 6
; [then-branch: 17 | i1@38@01 in [0..|First:($t@2@01)|] && i2@39@01 in [0..|First:($t@2@01)|] && i1@38@01 != i2@39@01]
(assert (and
  (Seq_contains
    (Seq_range
      0
...
; (get-info :all-statistics)
(push) ; 7
(assert (not (< i1@38@01 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))))))
(check-sat)
; unsat
(pop) ; 7
; 0,00s
...
; (get-info :all-statistics)
(push) ; 7
(assert (not (< i2@39@01 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))))))
(check-sat)
; unsat
(pop) ; 7
; 0,00s
...
(pop) ; 6
(push) ; 6
; [else-branch: 17 | !(i1@38@01 in [0..|First:($t@2@01)|] && i2@39@01 in [0..|First:($t@2@01)|] && i1@38@01 != i2@39@01)]
(assert (not
  (and
    (Seq_contains
      (Seq_range
...
; Nested auxiliary terms: non-globals (aux)
(push) ; 4
(assert (not (forall ((i1@38@01 Int) (i2@39@01 Int)) (!
  (=>
    (and
      (Seq_contains
        (Seq_range
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i@40@01 (Seq_length ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first $t@2@01))))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
  ...
  (ite
    ...
    ($Perm.min
      (ite
        ...
        $Perm.Write
        $Perm.No)
      (- (/ (to_real 1) (to_real 2)) (pTaken@43@01 r)))
    $Perm.No))
(define-fun pTaken@45@01 ((r $Ref)) $Perm
  (ite
    ...
    ($Perm.min
      (ite (= r this@1@01) $Perm.Write $Perm.No)
      (- (- (/ (to_real 1) (to_real 2)) (pTaken@43@01 r)) (pTaken@44@01 r)))
    $Perm.No))
; Done precomputing, updating quantified chunks
; State saturation: before repetition
(set-option :timeout 10)
...
(assert (and
  (forall ((i@37@01 Int)) (!
    ...
    :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/array_problem.vpr@14@35@14@79|))
  (forall ((i1@38@01 Int) (i2@39@01 Int)) (!
    (=>
      (and
        (Seq_contains
          (Seq_range
