...
(assert  (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type x@@12) RefType)) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@13) (MapType0Type RefType))))
...
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@12 val)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@12 val))) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (= (foo Heap@1 x@@12) 42))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 13)) (= (foo Heap@0 x@@12) 4)) (=> (= (foo Heap@0 x@@12) 4) (=> (state Heap@0 Mask@0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (= FullPerm (U_2_real (MapType1Select Mask@0 x@@12 val)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 x@@12 val))) (=> (and (= Heap@1 (MapType0Store Heap@0 x@@12 val (int_2_U 5))) (state Heap@1 Mask@0)) (and (and (=> (= (ControlFlow 0 11) 6) anon11_Else_correct) (=> (= (ControlFlow 0 11) 8) anon12_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon12_Else_correct))))))))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@12 val)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@12 val))) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@13 x@@12 $allocated))) (=> (and (and (not (= x@@12 null)) (= Mask@0 (MapType1Store ZeroMask x@@12 val (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@12 val)) FullPerm))))) (and (state Heap@@13 Mask@0) (state Heap@@13 Mask@0))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (= FullPerm (U_2_real (MapType1Select Mask@0 x@@12 val)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 x@@12 val))) (=> (and (= Heap@0 (MapType0Store Heap@@13 x@@12 val (int_2_U 4))) (state Heap@0 Mask@0)) (and (and (=> (= (ControlFlow 0 14) 11) anon9_Else_correct) (=> (= (ControlFlow 0 14) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 14) 4) anon10_Else_correct))))))))))
