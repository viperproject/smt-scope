...
(assert  (and (and (and (and (and (and (= (type y@@17) RefType) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Heap@@25) (MapType0Type RefType))) (= (type x@@24) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |foo_2_1#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon5_correct true))
(let ((anon7_Else_correct  (=> (and (not (guard y@@17)) (= (ControlFlow 0 4) 1)) anon5_correct)))
(let ((anon7_Then_correct  (=> (guard y@@17) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@3 y@@17 flag)) (=> (HasDirectPerm Mask@3 y@@17 flag) (=> (= (ControlFlow 0 2) 1) anon5_correct))))))
(let ((anon3_correct  (=> (state Heap@@25 Mask@3) (and (=> (= (ControlFlow 0 5) 2) anon7_Then_correct) (=> (= (ControlFlow 0 5) 4) anon7_Else_correct)))))
(let ((anon6_Else_correct  (=> (and (not (guard y@@17)) (not (= x@@24 null))) (=> (and (and (= Mask@2 (MapType1Store ZeroMask x@@24 flag (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@24 flag)) FullPerm)))) (state Heap@@25 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 7) 5))) anon3_correct))))
(let ((anon6_Then_correct  (=> (guard y@@17) (=> (and (and (and (not (= x@@24 null)) (= Mask@0 (MapType1Store ZeroMask x@@24 flag (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@24 flag)) FullPerm))))) (and (state Heap@@25 Mask@0) (not (= y@@17 null)))) (and (and (= Mask@1 (MapType1Store Mask@0 y@@17 flag (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@17 flag)) FullPerm)))) (state Heap@@25 Mask@1)) (and (= Mask@3 Mask@1) (= (ControlFlow 0 6) 5)))) anon3_correct))))
(let ((anon0_correct  (=> (and (and (state Heap@@25 ZeroMask) (U_2_bool (MapType0Select Heap@@25 y@@17 $allocated))) (and (U_2_bool (MapType0Select Heap@@25 x@@24 $allocated)) (= AssumeFunctionsAbove 3))) (and (=> (= (ControlFlow 0 8) 6) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))
