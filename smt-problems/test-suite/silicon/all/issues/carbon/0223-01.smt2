...
(push) ; 1
(declare-const w@2@00 $Ref)
(push) ; 2
; [eval] (w in Set(x))
; [eval] Set(x)
(assert (Set_in w@2@00 (Set_singleton x@0@00)))
(pop) ; 2
...
(push) ; 2
(assert (not (forall ((w1@2@00 $Ref) (w2@2@00 $Ref)) (!
  (=>
    (and
      (Set_in w1@2@00 (Set_singleton x@0@00))
      (Set_in w2@2@00 (Set_singleton x@0@00))
      (= w1@2@00 w2@2@00))
    (= w1@2@00 w2@2@00))
...
(check-sat)
; unknown
; [eval] (unfolding acc(bar(x), write) in x.val)
(set-option :timeout 0)
(push) ; 2
...
(declare-const s@6@00 $Snap)
; Definitional axioms for snapshot map values (instantiated)
(assert (=>
  (and
    (img@4@00 s@$ x@0@00 x@0@00)
    (Set_in (inv@3@00 s@$ x@0@00 x@0@00) (Set_singleton x@0@00)))
  (and
    (not (= ($SortWrappers.$RefTo$Snap x@0@00) $Snap.unit))
    (=
      ($PSF.lookup_bar (sm@5@00 s@$ x@0@00) ($SortWrappers.$RefTo$Snap x@0@00))
      ($PSF.lookup_bar ($SortWrappers.$SnapTo$PSF<bar> s@$) ($SortWrappers.$RefTo$Snap x@0@00))))))
(assert (bar%trigger ($SortWrappers.IntTo$Snap ($PSF.lookup_bar (sm@5@00 s@$ x@0@00) ($SortWrappers.$RefTo$Snap x@0@00))) x@0@00))
  ...
  (=>
    ...
    (and
      ...
      (=
        ($PSF.lookup_bar (sm@5@00 s@$ x@0@00) ($SortWrappers.$RefTo$Snap x@0@00))
        ($PSF.lookup_bar ($SortWrappers.$SnapTo$PSF<bar> s@$) ($SortWrappers.$RefTo$Snap x@0@00)))))
  (bar%trigger ($SortWrappers.IntTo$Snap ($PSF.lookup_bar (sm@5@00 s@$ x@0@00) ($SortWrappers.$RefTo$Snap x@0@00))) x@0@00)
  (not (= x@0@00 $Ref.null))))
(assert (=
  result@1@00
  ($PSF.lookup_bar (sm@5@00 s@$ x@0@00) ($SortWrappers.$RefTo$Snap x@0@00))))
