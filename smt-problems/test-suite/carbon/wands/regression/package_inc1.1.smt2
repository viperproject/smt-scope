...
(assert  (and (and (and (and (and (and (and (and (and (= (type Used_3Heap@0) (MapType0Type RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type Ops_3Heap@0) (MapType0Type RefType))) (= (type Used_2Heap@0) (MapType0Type RefType))) (= (type Ops_1Mask@0) (MapType1Type RefType realType))) (= (type Ops_1Heap@0) (MapType0Type RefType))) (= (type Used_1Heap@0) (MapType0Type RefType))) (= (type x@@8) RefType)) (= (type UsedHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon6_correct  (=> (and (= b_5@0  (and b_5 (state Used_3Heap@0 ZeroMask))) (= Mask@0 (MapType1Store ZeroMask null (wand true true) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (wand true true))) FullPerm))))) (=> (and (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) false))))
(let ((anon5_correct  (=> (and (and (and (= b_3@1  (and b_3 (state Ops_3Heap@0 ZeroMask))) (= b_3@2  (and b_3@1 (state Ops_3Heap@0 ZeroMask)))) (and (= b_4@0  (and b_4 (state Used_2Heap@0 ZeroMask))) (= Ops_1Mask@0 (MapType1Store ZeroMask null (wand false true) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (wand false true))) FullPerm)))))) (and (and (= b_1_1@3  (and b_1_1@2 (state Ops_1Heap@0 Ops_1Mask@0))) (= b_1_1@4  (and b_1_1@3 (state Ops_1Heap@0 Ops_1Mask@0)))) (and (= b_1_1@5  (and b_1_1@4 (state Ops_1Heap@0 Ops_1Mask@0))) (= (ControlFlow 0 4) 2)))) anon6_correct)))
(let ((anon9_Else_correct  (=> (and (not b_3@0) (= (ControlFlow 0 6) 4)) anon5_correct)))
(let ((anon9_Then_correct  (=> (and b_3@0 (= (ControlFlow 0 5) 4)) anon5_correct)))
(let ((anon8_Then_correct  (=> b_1_1@2 (=> (and (= b_3@0  (and b_3 (state Ops_3Heap@0 ZeroMask))) (= b_2_1@0  (and b_2_1 (state Used_1Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 7) 5) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct))))))
(let ((anon8_Else_correct  (=> (and (not b_1_1@2) (= (ControlFlow 0 3) 2)) anon6_correct)))
(let ((anon2_correct  (=> (and (= b_1_1@1  (and b_1_1@0 (state Ops_1Heap@0 ZeroMask))) (= b_1_1@2  (and b_1_1@1 (state Ops_1Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 8) 7) anon8_Then_correct) (=> (= (ControlFlow 0 8) 3) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (not b_1_1@0) (= (ControlFlow 0 10) 8)) anon2_correct)))
(let ((anon7_Then_correct  (=> (and b_1_1@0 (= (ControlFlow 0 9) 8)) anon2_correct)))
