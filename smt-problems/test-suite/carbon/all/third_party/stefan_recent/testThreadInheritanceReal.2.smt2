...
(set-info :boogie-vc-id Thread__start)
...
(assert  (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type sys__result) RefType)) (forall ((arg0@@77 T@U) ) (! (= (type (type_of arg0@@77)) TYPEDomainTypeType)
 :qid |funType:type_of|
 :pattern ( (type_of arg0@@77))
))) (= (type class_Worker) TYPEDomainTypeType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type PostMask@1) (MapType1Type RefType realType))) (= (type Heap@@30) (MapType0Type RefType))))
(set-info :boogie-vc-id Worker__Worker)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon7_Else_correct true))
(let ((anon7_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (not (= sys__result null))) (=> (and (and (state PostHeap@0 ZeroMask) (= (type_of sys__result) class_Worker)) (and (state PostHeap@0 ZeroMask) (= PostMask@0 (MapType1Store ZeroMask null (Worker__preFork sys__result FullPerm) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Worker__preFork sys__result FullPerm))) FullPerm)))))) (=> (and (and (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)) (and (> wildcard@0 NoPerm) (not (= sys__result null)))) (and (and (= PostMask@1 (MapType1Store PostMask@0 sys__result Worker__input (real_2_U (+ (U_2_real (MapType1Select PostMask@0 sys__result Worker__input)) wildcard@0)))) (state PostHeap@0 PostMask@1)) (and (state PostHeap@0 PostMask@1) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm PostMask@1 sys__result Worker__input))))))
(let ((anon0_correct  (=> (state Heap@@30 ZeroMask) (=> (and (>= current_thread_id 0) (state Heap@@30 ZeroMask)) (and (=> (= (ControlFlow 0 6) 2) anon7_Then_correct) (=> (= (ControlFlow 0 6) 4) anon7_Else_correct))))))
