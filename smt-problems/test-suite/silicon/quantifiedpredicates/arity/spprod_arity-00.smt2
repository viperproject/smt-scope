(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:24:21
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quantifiedpredicates/arity/spprod_arity.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (=
  ($PSF.lookup_p2 (as sm@8@01  $PSF<p2>) ($SortWrappers.$RefTo$Snap x@2@01))
...
(push) ; 2
; [eval] (r in xs)
(assert (Seq_contains xs@12@01 r@14@01))
(pop) ; 2
...
(assert (not (forall ((r1@14@01 $Ref) (r2@14@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@12@01 r1@14@01)
      (Seq_contains xs@12@01 r2@14@01)
      (= r1@14@01 r2@14@01))
    (= r1@14@01 r2@14@01))
...
(assert (forall ((r@14@01 $Ref)) (!
  (=>
    (Seq_contains xs@12@01 r@14@01)
    (and (= (inv@15@01 r@14@01) r@14@01) (img@16@01 r@14@01)))
  :pattern ((Seq_contains xs@12@01 r@14@01))
  :pattern ((Seq_contains_trigger xs@12@01 r@14@01))
  :pattern ((Seq_contains_trigger xs@12@01 r@14@01))
...
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@16@01 r) (Seq_contains xs@12@01 (inv@15@01 r)))
    (= (inv@15@01 r) r))
  :pattern ((inv@15@01 r))
  :qid |p3-fctOfInv|)))
; Permissions are non-negative
(declare-const sm@17@01 $PSF<p3>)
; Definitional axioms for singleton-SM's value
(assert (=
  ($PSF.lookup_p3 (as sm@17@01  $PSF<p3>) ($SortWrappers.$RefTo$Snap x@11@01))
  ($Snap.second $t@13@01)))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
...
(assert (forall ((r@25@01 $Ref)) (!
  (=>
    ...
    (and (= (inv@26@01 r@25@01 i@22@01) r@25@01) (img@27@01 r@25@01 i@22@01)))
  :pattern ((Seq_contains xs@23@01 r@25@01))
  :pattern ((Seq_contains_trigger xs@23@01 r@25@01))
  :pattern ((Seq_contains_trigger xs@23@01 r@25@01))
  :pattern ((inv@26@01 r@25@01 i@22@01))
  :pattern ((img@27@01 r@25@01 i@22@01))
  :qid |quant-u-5|)))
(assert (forall ((r $Ref) (i Int)) (!
  (=>
    (and (img@27@01 r i) (Seq_contains xs@23@01 (inv@26@01 r i)))
    (and (= (inv@26@01 r i) r) (= i@22@01 i)))
  :pattern ((inv@26@01 r i))
  :qid |p4-fctOfInv|)))
; Permissions are non-negative
(declare-const sm@28@01 $PSF<p4>)
; Definitional axioms for singleton-SM's value
(assert (=
  ($PSF.lookup_p4 (as sm@28@01  $PSF<p4>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap x@21@01)
    ($SortWrappers.IntTo$Snap i@22@01)))
...
(push) ; 2
; [eval] (r in xs)
(assert (Seq_contains xs@34@01 r@36@01))
(pop) ; 2
(declare-fun inv@37@01 ($Ref Int) $Ref)
(declare-fun img@38@01 ($Ref Int) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((r1@36@01 $Ref) (r2@36@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@34@01 r1@36@01)
      (Seq_contains xs@34@01 r2@36@01)
      (= r1@36@01 r2@36@01))
    (= r1@36@01 r2@36@01))
...
(assert (forall ((r@36@01 $Ref)) (!
  (=>
    (Seq_contains xs@34@01 r@36@01)
    (and (= (inv@37@01 r@36@01 i@33@01) r@36@01) (img@38@01 r@36@01 i@33@01)))
  :pattern ((Seq_contains xs@34@01 r@36@01))
  :pattern ((Seq_contains_trigger xs@34@01 r@36@01))
  :pattern ((Seq_contains_trigger xs@34@01 r@36@01))
  :pattern ((inv@37@01 r@36@01 i@33@01))
  :pattern ((img@38@01 r@36@01 i@33@01))
  :qid |quant-u-7|)))
(assert (forall ((r $Ref) (i Int)) (!
  (=>
    (and (img@38@01 r i) (Seq_contains xs@34@01 (inv@37@01 r i)))
    (and (= (inv@37@01 r i) r) (= i@33@01 i)))
  :pattern ((inv@37@01 r i))
  :qid |p5-fctOfInv|)))
; Permissions are non-negative
(declare-const sm@39@01 $PSF<p5>)
; Definitional axioms for singleton-SM's value
(assert (=
  ($PSF.lookup_p5 (as sm@39@01  $PSF<p5>) ($Snap.combine
