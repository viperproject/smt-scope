...
(set-info :boogie-vc-id |History__hist_get_x#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@44 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@44 diz@@169 $allocated)) (= AssumeFunctionsAbove 1)) (=> (and (and (and (not (= diz@@169 null)) (state Heap@@44 ZeroMask)) (and (> wildcard@0 NoPerm) (not (= diz@@169 null)))) (and (and (= Mask@0 (MapType1Store ZeroMask diz@@169 History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz@@169 History__x_hist_value)) wildcard@0)))) (state Heap@@44 Mask@0)) (and (state Heap@@44 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm Mask@0 diz@@169 History__x_hist_value))))))
...
(assert  (and (and (and (and (and (and (and (and (= (type PostMask@0) (MapType1Type RefType realType)) (= (type diz@@169) RefType)) (= (type PostHeap@0) (MapType0Type RefType))) (= (type PostMask@2) (MapType1Type RefType realType))) (= (type PostMask@1) (MapType1Type RefType realType))) (= (type Heap@@44) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id SubjectLock__unlock)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon6_correct true))
(let ((anon17_Else_correct  (=> (not (= count@@5 1)) (=> (and (and (= PostMask@1 (MapType1Store ZeroMask null (SubjectLock__locked diz@@169 p_1@@98 (- count@@5 1)) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (SubjectLock__locked diz@@169 p_1@@98 (- count@@5 1)))) FullPerm)))) (state PostHeap@0 PostMask@1)) (and (= PostMask@2 PostMask@1) (= (ControlFlow 0 5) 2))) anon6_correct))))
(let ((anon17_Then_correct  (=> (= count@@5 1) (and (=> (= (ControlFlow 0 3) (- 0 4)) (>= p_1@@98 NoPerm)) (=> (>= p_1@@98 NoPerm) (=> (and (and (= PostMask@0 (MapType1Store ZeroMask null (SubjectLock__valid diz@@169) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (SubjectLock__valid diz@@169))) p_1@@98)))) (state PostHeap@0 PostMask@0)) (and (= PostMask@2 PostMask@0) (= (ControlFlow 0 3) 2))) anon6_correct))))))
(let ((anon16_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 6) 3) anon17_Then_correct) (=> (= (ControlFlow 0 6) 5) anon17_Else_correct)))))
(let ((anon16_Else_correct true))
(let ((anon2_correct  (=> (state Heap@@44 Mask@2) (=> (and (<= NoPerm p_1@@98) (state Heap@@44 Mask@2)) (and (=> (= (ControlFlow 0 7) 6) anon16_Then_correct) (=> (= (ControlFlow 0 7) 1) anon16_Else_correct))))))
(let ((anon15_Else_correct  (=> (not (= count@@5 1)) (=> (and (= Mask@2 Mask@0) (= (ControlFlow 0 9) 7)) anon2_correct))))
(let ((anon15_Then_correct  (=> (= count@@5 1) (=> (and (and (= Mask@1 (MapType1Store Mask@0 null (SubjectLock__inv diz@@169) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (SubjectLock__inv diz@@169))) FullPerm)))) (state Heap@@44 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 8) 7))) anon2_correct))))
(let ((anon0_correct  (=> (and (and (state Heap@@44 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@44 diz@@169 $allocated)) (not (= diz@@169 null)))) (=> (and (and (and (state Heap@@44 ZeroMask) (>= current_thread_id 0)) (and (state Heap@@44 ZeroMask) (> count@@5 0))) (and (and (state Heap@@44 ZeroMask) (= Mask@0 (MapType1Store ZeroMask null (SubjectLock__locked diz@@169 p_1@@98 count@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (SubjectLock__locked diz@@169 p_1@@98 count@@5))) FullPerm))))) (and (state Heap@@44 Mask@0) (state Heap@@44 Mask@0)))) (and (=> (= (ControlFlow 0 10) 8) anon15_Then_correct) (=> (= (ControlFlow 0 10) 9) anon15_Else_correct))))))
...
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(set-info :boogie-vc-id Thread__if_any_random)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
...
(declare-fun current_thread_id () Int)
(assert  (and (and (and (and (and (= (type Heap@@44) (MapType0Type RefType)) (= (type diz@@169) RefType)) (= (type freshObj@0) RefType)) (= (type Heap@0) (MapType0Type RefType))) (forall ((arg0@@85 T@U) ) (! (= (type (type_of arg0@@85)) TYPEDomainTypeType)
 :qid |funType:type_of|
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_Else_correct  (=> (U_2_bool (MapType0Select Heap@@44 diz@@169 $allocated)) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@44 freshObj@0 $allocated)))) (and (= Heap@0 (MapType0Store Heap@@44 freshObj@0 $allocated (bool_2_U true))) (state Heap@0 ZeroMask))) (and (and (= (type_of freshObj@0) class_Main) (state Heap@0 ZeroMask)) (and (state Heap@0 ZeroMask) (state Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (not (= freshObj@0 null))) (=> (not (= freshObj@0 null)) (=> (= (ControlFlow 0 3) (- 0 5)) (= (type_of freshObj@0) class_Main))))))))
