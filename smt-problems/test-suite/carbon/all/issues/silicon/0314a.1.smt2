...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type f_7) (FieldType NormalFieldType intType))) (= (Ctor RefType) 8)) (= (type g) (FieldType NormalFieldType RefType))) (forall ((arg0@@14 T@T) (arg1@@2 T@T) ) (! (= (Ctor (MapType0Type arg0@@14 arg1@@2)) 9)
...
(= (type (MapType0Store arg0@@18 arg1@@6 arg2)) (MapType0Type aVar0 aVar1@@0))))
 ...
 :weight 0
)))) (= (type h) (FieldType NormalFieldType (MapType0Type RefType boolType)))))
...
(assert  (and (and (and (and (and (and (and (= (type Heap@0) (MapType1Type RefType)) (= (type x_1) RefType)) (= (type Mask@1) (MapType2Type RefType realType))) (= (type y@@6) RefType)) (= (type z@0) RefType)) (= (type Heap@@9) (MapType1Type RefType))) (= (type z@@0) RefType)) (= (type Mask@0) (MapType2Type RefType realType))))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon3_Else_correct  (=> (forall ((i_1 Int) ) (!  (=> (< 0 i_1) (bar i_1))
 :qid |stdinbpl.534:20|
 :skolemid |83|
 :pattern ( (foo i_1 (U_2_int (MapType1Select Heap@0 (MapType1Select Heap@0 x_1 g) f_7))))
)) (=> (and (state Heap@0 Mask@1) (state Heap@0 Mask@1)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (HasDirectPerm Mask@1 x_1 g)) (=> (HasDirectPerm Mask@1 x_1 g) (=> (= y@@6 (MapType1Select Heap@0 x_1 g)) (=> (and (state Heap@0 Mask@1) (state Heap@0 Mask@1)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (HasDirectPerm Mask@1 x_1 g)) (=> (HasDirectPerm Mask@1 x_1 g) (=> (and (= z@0 (MapType1Select Heap@0 x_1 g)) (state Heap@0 Mask@1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm Mask@1 y@@6 f_7)) (=> (HasDirectPerm Mask@1 y@@6 f_7) (=> (foo (U_2_int (MapType1Select Heap@0 y@@6 f_7)) 5) (=> (and (state Heap@0 Mask@1) (state Heap@0 Mask@1)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm Mask@1 z@0 f_7)) (=> (HasDirectPerm Mask@1 z@0 f_7) (=> (= (ControlFlow 0 3) (- 0 2)) (bar (U_2_int (MapType1Select Heap@0 z@0 f_7)))))))))))))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType1Select Heap@@9 x_1 $allocated)) (U_2_bool (MapType1Select Heap@@9 y@@6 $allocated))) (=> (and (and (U_2_bool (MapType1Select Heap@@9 z@@0 $allocated)) (not (= x_1 null))) (and (= Mask@0 (MapType2Store ZeroMask x_1 g (real_2_U (+ (U_2_real (MapType2Select ZeroMask x_1 g)) FullPerm)))) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (HasDirectPerm Mask@0 x_1 g)) (=> (HasDirectPerm Mask@0 x_1 g) (=> (not (= (MapType1Select Heap@@9 x_1 g) null)) (=> (and (and (= Mask@1 (MapType2Store Mask@0 (MapType1Select Heap@@9 x_1 g) f_7 (real_2_U (+ (U_2_real (MapType2Select Mask@0 (MapType1Select Heap@@9 x_1 g) f_7)) FullPerm)))) (state Heap@@9 Mask@1)) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (HasDirectPerm Mask@1 x_1 g)) (=> (HasDirectPerm Mask@1 x_1 g) (and (=> (= (ControlFlow 0 8) (- 0 9)) (= FullPerm (U_2_real (MapType2Select Mask@1 (MapType1Select Heap@@9 x_1 g) f_7)))) (=> (= FullPerm (U_2_real (MapType2Select Mask@1 (MapType1Select Heap@@9 x_1 g) f_7))) (=> (and (= Heap@0 (MapType1Store Heap@@9 (MapType1Select Heap@@9 x_1 g) f_7 (int_2_U 5))) (state Heap@0 Mask@1)) (and (=> (= (ControlFlow 0 8) 1) anon3_Then_correct) (=> (= (ControlFlow 0 8) 3) anon3_Else_correct))))))))))))))))
