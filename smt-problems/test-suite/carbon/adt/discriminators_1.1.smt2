...
(assert  (and (= (type Heap@@9) (MapType0Type RefType)) (= (type tree@0) (TreeDomainTypeType intType))))
(set-info :boogie-vc-id discriminators_1b)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= tree@0 (Node (int_2_U 42) (Node (int_2_U 42) (Leaf intType) (Leaf intType)) (Node (int_2_U 42) (Leaf intType) (Leaf intType)))) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (not (= (Tree_tag tree@0) 0))) (=> (not (= (Tree_tag tree@0) 0)) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (Tree_tag (get_Tree_left (get_Tree_left tree@0))) 0)) (=> (= (Tree_tag (get_Tree_left (get_Tree_left tree@0))) 0) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (Tree_tag (get_Tree_right (get_Tree_left tree@0))) 0)) (=> (= (Tree_tag (get_Tree_right (get_Tree_left tree@0))) 0) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (Tree_tag (get_Tree_left tree@0)) 1)) (=> (= (Tree_tag (get_Tree_left tree@0)) 1) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (not (= (Tree_tag (get_Tree_right tree@0)) 0))))))))))))))))))
