...
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((e_2 T@U) (e_2_1 T@U) ) (!  (=> (and (= (type e_2) RefType) (= (type e_2_1) RefType)) (=> (and (and (and (and (not (= e_2 e_2_1)) (U_2_bool (MapType2Select (refs Heap@@33 r_1@@52) e_2))) (U_2_bool (MapType2Select (refs Heap@@33 r_1@@52) e_2_1))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= e_2 e_2_1))))
