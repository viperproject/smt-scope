...
(assert  (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type a_2) (SeqType RefType))) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@33) (MapType0Type RefType))) (= (type diz) RefType)))
(set-info :boogie-vc-id Ref__resource_check_S1_S2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon4_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 (|Seq#Index| a_2 (- i@@34 1)) Ref__Integer_value (real_2_U (- (U_2_real (MapType1Select Mask@0 (|Seq#Index| a_2 (- i@@34 1)) Ref__Integer_value)) perm@2)))) (= (ControlFlow 0 9) (- 0 8))) (= (U_2_int (MapType0Select Heap@@33 (|Seq#Index| a_2 (- i@@34 1)) Ref__Integer_value)) i@@34))))
(let ((anon6_Else_correct  (=> (and (= perm@2 NoPerm) (= (ControlFlow 0 12) 9)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= perm@2 NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= perm@2 (U_2_real (MapType1Select Mask@0 (|Seq#Index| a_2 (- i@@34 1)) Ref__Integer_value)))) (=> (<= perm@2 (U_2_real (MapType1Select Mask@0 (|Seq#Index| a_2 (- i@@34 1)) Ref__Integer_value))) (=> (= (ControlFlow 0 10) 9) anon4_correct))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 15)) (< (- i@@34 1) (- len 1))) (=> (< (- i@@34 1) (- len 1)) (=> (= perm@2 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (and (=> (= (ControlFlow 0 13) 10) anon6_Then_correct) (=> (= (ControlFlow 0 13) 12) anon6_Else_correct)))))))))
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (< (- i@@34 1) (- len 1)) (state PostHeap@0 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (>= (- i@@34 1) 0)) (=> (>= (- i@@34 1) 0) (and (=> (= (ControlFlow 0 2) (- 0 6)) (< (- i@@34 1) (|Seq#Length| a_2))) (=> (< (- i@@34 1) (|Seq#Length| a_2)) (=> (= perm@1 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (and (=> (> perm@1 NoPerm) (not (= (|Seq#Index| a_2 (- i@@34 1)) null))) (= PostMask@0 (MapType1Store ZeroMask (|Seq#Index| a_2 (- i@@34 1)) Ref__Integer_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask (|Seq#Index| a_2 (- i@@34 1)) Ref__Integer_value)) perm@1))))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= (- i@@34 1) 0)) (=> (>= (- i@@34 1) 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< (- i@@34 1) (|Seq#Length| a_2))) (=> (< (- i@@34 1) (|Seq#Length| a_2)) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm PostMask@0 (|Seq#Index| a_2 (- i@@34 1)) Ref__Integer_value))))))))))))))))))
(let ((anon0_correct  (=> (and (and (and (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@33 diz $allocated)) (not (= diz null)))) (and (and (state Heap@@33 ZeroMask) (>= current_thread_id 0)) (and (state Heap@@33 ZeroMask) (<= 0 i@@34)))) (and (and (and (< i@@34 len) (state Heap@@33 ZeroMask)) (and (< (- i@@34 1) (- len 1)) (state Heap@@33 ZeroMask))) (and (and (> i@@34 0) (state Heap@@33 ZeroMask)) (and (<= len (|Seq#Length| a_2)) (state Heap@@33 ZeroMask))))) (and (=> (= (ControlFlow 0 16) (- 0 22)) (>= (- i@@34 1) 0)) (=> (>= (- i@@34 1) 0) (and (=> (= (ControlFlow 0 16) (- 0 21)) (< (- i@@34 1) (|Seq#Length| a_2))) (=> (< (- i@@34 1) (|Seq#Length| a_2)) (=> (= perm@0 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 16) (- 0 20)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= (|Seq#Index| a_2 (- i@@34 1)) null))) (= Mask@0 (MapType1Store ZeroMask (|Seq#Index| a_2 (- i@@34 1)) Ref__Integer_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask (|Seq#Index| a_2 (- i@@34 1)) Ref__Integer_value)) perm@0))))) (and (state Heap@@33 Mask@0) (state Heap@@33 Mask@0))) (and (=> (= (ControlFlow 0 16) (- 0 19)) (>= (- i@@34 1) 0)) (=> (>= (- i@@34 1) 0) (and (=> (= (ControlFlow 0 16) (- 0 18)) (< (- i@@34 1) (|Seq#Length| a_2))) (=> (< (- i@@34 1) (|Seq#Length| a_2)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm Mask@0 (|Seq#Index| a_2 (- i@@34 1)) Ref__Integer_value)) (=> (HasDirectPerm Mask@0 (|Seq#Index| a_2 (- i@@34 1)) Ref__Integer_value) (=> (and (= (U_2_int (MapType0Select Heap@@33 (|Seq#Index| a_2 (- i@@34 1)) Ref__Integer_value)) (+ (- i@@34 1) 1)) (state Heap@@33 Mask@0)) (and (=> (= (ControlFlow 0 16) 2) anon5_Then_correct) (=> (= (ControlFlow 0 16) 13) anon5_Else_correct))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 23) 16) anon0_correct)))
