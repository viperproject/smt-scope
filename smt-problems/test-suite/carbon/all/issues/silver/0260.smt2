...
(assert  (and (and (= (type s) RefType) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))))
...
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((j_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (and (not (= j_1 j_1_1)) (= j_1 k)) (= j_1_1 k)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s s)))
 :qid |stdinbpl.234:15|
 :skolemid |22|
))) (=> (forall ((j_1@@0 Int) (j_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_1@@0 j_1_1@@0)) (= j_1@@0 k)) (= j_1_1@@0 k)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s s)))
 :qid |stdinbpl.234:15|
 :skolemid |22|
)) (=> (and (forall ((j_1@@1 Int) ) (!  (=> (and (= j_1@@1 k) (< NoPerm FullPerm)) (and (qpRange1 s) (= (invRecv1 s) j_1@@1)))
 :qid |stdinbpl.240:22|
 :skolemid |23|
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (= (invRecv1 o_3) k) (< NoPerm FullPerm)) (qpRange1 o_3)) (= s o_3)))
 :qid |stdinbpl.244:22|
 :skolemid |24|
 :pattern ( (invRecv1 o_3))
))) (=> (and (and (forall ((j_1@@2 Int) ) (!  (=> (= j_1@@2 k) (not (= s null)))
 :qid |stdinbpl.250:22|
 :skolemid |25|
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (= (invRecv1 o_3@@0) k) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= s o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (= (invRecv1 o_3@@0) k) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.256:22|
 :skolemid |26|
...
)) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 4) 2) anon6_Then_correct) (=> (= (ControlFlow 0 4) 3) anon6_Else_correct))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 s $allocated))) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 4) anon5_Else_correct)))))
