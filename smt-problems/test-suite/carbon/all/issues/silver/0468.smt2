...
(declare-fun l () T@U)
(declare-fun i@@6 () Int)
(assert  (and (and (= (type l) (SeqType intType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type y@@2) RefType)))
(set-info :boogie-vc-id r_1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm ZeroMask y@@2 f_7)) (= (ControlFlow 0 13) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm ZeroMask y@@2 f_7) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm ZeroMask y@@2 f_7)) (=> (HasDirectPerm ZeroMask y@@2 f_7) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (>= (ite (forall ((y_2 T@U) ) (!  (=> (and (= (type y_2) RefType) (HasDirectPerm ZeroMask y_2 f_7)) false)
 :qid |stdinbpl.601:21|
 :skolemid |59|
 :pattern ( (MapType1Select ZeroMask y_2 f_7))
 :pattern ( (MapType0Select Heap@@9 y_2 f_7))
)) 1 2) 0)) (=> (>= (ite (forall ((y_2@@0 T@U) ) (!  (=> (and (= (type y_2@@0) RefType) (HasDirectPerm ZeroMask y_2@@0 f_7)) false)
 :qid |stdinbpl.601:21|
 :skolemid |59|
 :pattern ( (MapType1Select ZeroMask y_2@@0 f_7))
 :pattern ( (MapType0Select Heap@@9 y_2@@0 f_7))
)) 1 2) 0) (and (=> (= (ControlFlow 0 7) (- 0 8)) (< (ite (forall ((y_2@@1 T@U) ) (!  (=> (and (= (type y_2@@1) RefType) (HasDirectPerm ZeroMask y_2@@1 f_7)) false)
 :qid |stdinbpl.606:21|
 :skolemid |60|
 :pattern ( (MapType1Select ZeroMask y_2@@1 f_7))
 :pattern ( (MapType0Select Heap@@9 y_2@@1 f_7))
)) 1 2) (|Seq#Length| l))) (=> (< (ite (forall ((y_2@@2 T@U) ) (!  (=> (and (= (type y_2@@2) RefType) (HasDirectPerm ZeroMask y_2@@2 f_7)) false)
 :qid |stdinbpl.606:21|
 :skolemid |60|
 :pattern ( (MapType1Select ZeroMask y_2@@2 f_7))
 :pattern ( (MapType0Select Heap@@9 y_2@@2 f_7))
)) 1 2) (|Seq#Length| l)) (=> (= (ControlFlow 0 7) (- 0 6)) (= (U_2_int (|Seq#Index| l (ite (forall ((y_3 T@U) ) (!  (=> (and (= (type y_3) RefType) (HasDirectPerm ZeroMask y_3 f_7)) false)
 :qid |stdinbpl.611:32|
 :skolemid |61|
 :pattern ( (MapType1Select ZeroMask y_3 f_7))
 :pattern ( (MapType0Select Heap@@9 y_3 f_7))
)) 1 2))) 4))))))))
(let ((anon9_Else_correct  (=> (and (forall ((i_1 Int) ) (!  (=> (and (<= 0 i_1) (< i_1 (|Seq#Length| l))) (= (U_2_int (|Seq#Index| l i_1)) 4))
 :qid |stdinbpl.576:20|
 :skolemid |58|
 :pattern ( (|Seq#Index| l i_1))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 14) 7) anon11_Else_correct) (=> (= (ControlFlow 0 14) 11) anon12_Then_correct)) (=> (= (ControlFlow 0 14) 13) anon12_Else_correct)))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (and (<= 0 i@@6) (< i@@6 (|Seq#Length| l)))) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (<= 0 i@@6) (< i@@6 (|Seq#Length| l))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i@@6 (|Seq#Length| l))) (=> (< i@@6 (|Seq#Length| l)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (= (|Seq#Length| l) 3)) (and (and (=> (= (ControlFlow 0 15) 14) anon9_Else_correct) (=> (= (ControlFlow 0 15) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 15) 5) anon10_Else_correct)))))
