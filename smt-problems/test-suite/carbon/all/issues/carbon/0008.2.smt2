...
(assert (forall ((Heap@@2 T@U) (i Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (int_2_U (|reqIGt0#triggerStateless| i))))
 :qid |stdinbpl.551:15|
 :skolemid |59|
 :pattern ( (|reqIGt0'| Heap@@2 i))
)))
...
(assert (forall ((Heap@@4 T@U) (i@@1 Int) ) (!  (=> (= (type Heap@@4) (MapType0Type RefType)) (and (= (reqIGt0 Heap@@4 i@@1) (|reqIGt0'| Heap@@4 i@@1)) (dummyFunction (int_2_U (|reqIGt0#triggerStateless| i@@1)))))
 :qid |stdinbpl.547:15|
 :skolemid |58|
 :pattern ( (reqIGt0 Heap@@4 i@@1))
)))
...
(assert (forall ((Heap@@7 T@U) (Mask@@6 T@U) (i@@4 Int) ) (!  (=> (and (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (and (state Heap@@7 Mask@@6) (< AssumeFunctionsAbove 0))) (>= i@@4 0)) (= (reqIGt0 Heap@@7 i@@4) i@@4))
 :qid |stdinbpl.557:15|
 :skolemid |60|
 :pattern ( (state Heap@@7 Mask@@6) (reqIGt0 Heap@@7 i@@4))
)))
...
(assert (forall ((Heap@@10 T@U) (Mask@@10 T@U) (i@@6 Int) ) (!  (=> (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (state Heap@@10 Mask@@10)) (= (|reqIGt0'| Heap@@10 i@@6) (|reqIGt0#frame| EmptyFrame i@@6)))
 :qid |stdinbpl.564:15|
 :skolemid |61|
 :pattern ( (state Heap@@10 Mask@@10) (|reqIGt0'| Heap@@10 i@@6))
)))
...
(declare-fun i_2 () Int)
(assert (= (type Heap@@13) (MapType0Type RefType)))
(set-info :boogie-vc-id succeedsExplicit10)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon17_correct true))
(let ((anon28_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U (- 0 2))) (|Seq#Singleton| (int_2_U 2))) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 6))) (|Seq#Singleton| (int_2_U 8))) (int_2_U i_4))) (= (ControlFlow 0 19) 16)) anon17_correct)))
(let ((anon28_Then_correct  (=> (|Seq#Contains| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U (- 0 2))) (|Seq#Singleton| (int_2_U 2))) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 6))) (|Seq#Singleton| (int_2_U 8))) (int_2_U i_4)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (> (reqIGt0 Heap@@13 (* i_4 i_4)) i_4)) (=> (> (reqIGt0 Heap@@13 (* i_4 i_4)) i_4) (=> (= (ControlFlow 0 17) 16) anon17_correct))))))
(let ((anon26_Then_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (>= (* i_3 i_3) 0))))
(let ((anon13_correct true))
(let ((anon25_Then_correct  (=> (|Seq#Contains| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U (- 0 2))) (|Seq#Singleton| (int_2_U 2))) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 6))) (|Seq#Singleton| (int_2_U 8))) (int_2_U i_3)) (and (=> (= (ControlFlow 0 15) 14) anon26_Then_correct) (=> (= (ControlFlow 0 15) 11) anon13_correct)))))
(let ((anon25_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U (- 0 2))) (|Seq#Singleton| (int_2_U 2))) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 6))) (|Seq#Singleton| (int_2_U 8))) (int_2_U i_3))) (= (ControlFlow 0 12) 11)) anon13_correct)))
(let ((anon27_Else_correct true))
(let ((anon22_Else_correct  (=> (and (forall ((i_2_1 T@U) ) (!  (=> (and (= (type i_2_1) intType) (|Seq#Contains| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 2)) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 6))) (|Seq#Singleton| (int_2_U 8))) i_2_1)) (> (reqIGt0 Heap@@13 (* (U_2_int i_2_1) (U_2_int i_2_1))) (U_2_int i_2_1)))
 :qid |stdinbpl.714:20|
 :skolemid |63|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 2)) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 6))) (|Seq#Singleton| (int_2_U 8))) i_2_1))
 :pattern ( (|Seq#Contains| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 2)) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 6))) (|Seq#Singleton| (int_2_U 8))) i_2_1))
)) (state Heap@@13 ZeroMask)) (and (and (and (and (=> (= (ControlFlow 0 20) 10) anon27_Else_correct) (=> (= (ControlFlow 0 20) 17) anon28_Then_correct)) (=> (= (ControlFlow 0 20) 19) anon28_Else_correct)) (=> (= (ControlFlow 0 20) 15) anon25_Then_correct)) (=> (= (ControlFlow 0 20) 12) anon25_Else_correct)))))
(let ((anon8_correct true))
(let ((anon23_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 2)) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 6))) (|Seq#Singleton| (int_2_U 8))) (int_2_U i_1_1))) (= (ControlFlow 0 9) 6)) anon8_correct)))
(let ((anon23_Then_correct  (=> (|Seq#Contains| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 2)) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 6))) (|Seq#Singleton| (int_2_U 8))) (int_2_U i_1_1)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (> (reqIGt0 Heap@@13 (* i_1_1 i_1_1)) i_1_1)) (=> (> (reqIGt0 Heap@@13 (* i_1_1 i_1_1)) i_1_1) (=> (= (ControlFlow 0 7) 6) anon8_correct))))))
(let ((anon21_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (>= (* i_2 i_2) 0))))
(let ((anon4_correct true))
(let ((anon20_Then_correct  (=> (|Seq#Contains| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 2)) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 6))) (|Seq#Singleton| (int_2_U 8))) (int_2_U i_2)) (and (=> (= (ControlFlow 0 5) 4) anon21_Then_correct) (=> (= (ControlFlow 0 5) 1) anon4_correct)))))
(let ((anon20_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 2)) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 6))) (|Seq#Singleton| (int_2_U 8))) (int_2_U i_2))) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (and (and (and (=> (= (ControlFlow 0 21) 20) anon22_Else_correct) (=> (= (ControlFlow 0 21) 7) anon23_Then_correct)) (=> (= (ControlFlow 0 21) 9) anon23_Else_correct)) (=> (= (ControlFlow 0 21) 5) anon20_Then_correct)) (=> (= (ControlFlow 0 21) 2) anon20_Else_correct)))))
