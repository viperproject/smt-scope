...
(declare-fun |lookup2'| (T@U T@U Int) Int)
(declare-fun |lookup2#triggerStateless| (T@U Int) Int)
...
(declare-fun |lookup2#frame| (T@U T@U Int) Int)
...
(assert (forall ((Heap@@0 T@U) (r_1 T@U) (i Int) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type r_1) RefType)) (dummyFunction (int_2_U (|lookup#triggerStateless| r_1 i))))
 :qid |stdinbpl.389:15|
 :skolemid |83|
 :pattern ( (|lookup'| Heap@@0 r_1 i))
)))
(assert (forall ((Heap@@1 T@U) (r_1@@0 T@U) (i@@0 Int) ) (!  (=> (and (= (type Heap@@1) (MapType0Type RefType)) (= (type r_1@@0) RefType)) (dummyFunction (int_2_U (|lookup2#triggerStateless| r_1@@0 i@@0))))
 :qid |stdinbpl.438:15|
 :skolemid |86|
...
(assert (forall ((Heap@@7 T@U) (r_1@@1 T@U) (i@@1 Int) ) (!  (=> (and (= (type Heap@@7) (MapType0Type RefType)) (= (type r_1@@1) RefType)) (and (= (lookup Heap@@7 r_1@@1 i@@1) (|lookup'| Heap@@7 r_1@@1 i@@1)) (dummyFunction (int_2_U (|lookup#triggerStateless| r_1@@1 i@@1)))))
 :qid |stdinbpl.385:15|
 :skolemid |82|
 :pattern ( (lookup Heap@@7 r_1@@1 i@@1))
)))
(assert (forall ((Heap@@8 T@U) (r_1@@2 T@U) (i@@2 Int) ) (!  (=> (and (= (type Heap@@8) (MapType0Type RefType)) (= (type r_1@@2) RefType)) (and (= (lookup2 Heap@@8 r_1@@2 i@@2) (|lookup2'| Heap@@8 r_1@@2 i@@2)) (dummyFunction (int_2_U (|lookup2#triggerStateless| r_1@@2 i@@2)))))
 :qid |stdinbpl.434:15|
 :skolemid |85|
 :pattern ( (lookup2 Heap@@8 r_1@@2 i@@2))
)))
...
(assert (forall ((Heap@@13 T@U) (Mask@@9 T@U) (r_1@@3 T@U) (i@@3 Int) ) (!  (=> (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (= (type r_1@@3) RefType)) (state Heap@@13 Mask@@9)) (= (|lookup'| Heap@@13 r_1@@3 i@@3) (|lookup#frame| (FrameFragment (MapType0Select Heap@@13 r_1@@3 f_7)) r_1@@3 i@@3)))
 :qid |stdinbpl.396:15|
 :skolemid |84|
 :pattern ( (state Heap@@13 Mask@@9) (|lookup'| Heap@@13 r_1@@3 i@@3))
)))
(assert (forall ((Heap@@14 T@U) (Mask@@10 T@U) (r_1@@4 T@U) (i@@4 Int) ) (!  (=> (and (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type r_1@@4) RefType)) (state Heap@@14 Mask@@10)) (= (|lookup2'| Heap@@14 r_1@@4 i@@4) (|lookup2#frame| (FrameFragment (MapType0Select Heap@@14 r_1@@4 f_7)) r_1@@4 i@@4)))
 :qid |stdinbpl.445:15|
 :skolemid |87|
 :pattern ( (state Heap@@14 Mask@@10) (|lookup2'| Heap@@14 r_1@@4 i@@4))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@5) (MapType1Type RefType realType)) (= (type r1) RefType)) (= (type Mask@9) (MapType1Type RefType realType))) (= (type ExhaleHeap@1) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@7) (MapType1Type RefType realType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type r2) RefType)) (= (type Mask@8) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@@15) (MapType0Type RefType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type s@0) (MapType2Type RefType boolType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
...
(let ((anon39_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (<= FullPerm (U_2_real (MapType1Select Mask@9 r1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@9 r1 f_7))) (=> (= (ControlFlow 0 19) 18) anon25_correct))))))
(let ((anon38_Else_correct  (=> (= (ControlFlow 0 17) (- 0 16)) (> (lookup2 ExhaleHeap@1 r1 5) 2))))
(let ((anon33_Else_correct  (=> (forall ((i_1 Int) ) (! (= (lookup2 ExhaleHeap@1 r1 i_1) (lookup ExhaleHeap@0 r1 i_1))
 :qid |stdinbpl.952:20|
 :skolemid |89|
 :pattern ( (|lookup#frame| (FrameFragment (MapType0Select ExhaleHeap@1 r1 f_7)) r1 i_1))
)) (=> (and (state ExhaleHeap@1 Mask@9) (state ExhaleHeap@1 Mask@9)) (and (and (=> (= (ControlFlow 0 22) 17) anon38_Else_correct) (=> (= (ControlFlow 0 22) 19) anon39_Then_correct)) (=> (= (ControlFlow 0 22) 21) anon39_Else_correct))))))
(let ((anon20_correct true))
(let ((anon37_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 10)) anon20_correct)))
(let ((anon37_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType1Select Mask@5 r1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@5 r1 f_7))) (=> (= (ControlFlow 0 11) 10) anon20_correct))))))
(let ((anon36_Else_correct true))
(let ((anon34_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) true) (and (and (=> (= (ControlFlow 0 14) 9) anon36_Else_correct) (=> (= (ControlFlow 0 14) 11) anon37_Then_correct)) (=> (= (ControlFlow 0 14) 13) anon37_Else_correct)))))
(let ((anon16_correct true))
(let ((anon35_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon16_correct)))
(let ((anon35_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@9 r1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@9 r1 f_7))) (=> (= (ControlFlow 0 6) 5) anon16_correct))))))
(let ((anon12_correct  (=> (= Mask@7 (MapType1Store Mask@6 r2 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@6 r2 f_7)) FullPerm)))) (=> (and (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@1 Mask@7) (state ExhaleHeap@1 Mask@7)) (=> (and (and (and (not (= r1 null)) (= Mask@8 (MapType1Store Mask@7 r1 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@7 r1 f_7)) FullPerm))))) (and (state ExhaleHeap@1 Mask@8) (not (= r2 null)))) (and (and (= Mask@9 (MapType1Store Mask@8 r2 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@8 r2 f_7)) FullPerm)))) (state ExhaleHeap@1 Mask@9)) (and (state ExhaleHeap@1 Mask@9) (state ExhaleHeap@1 Mask@9)))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (HasDirectPerm Mask@9 r1 f_7)) (=> (HasDirectPerm Mask@9 r1 f_7) (=> (and (and (= (U_2_int (MapType0Select ExhaleHeap@1 r1 f_7)) 4) (state ExhaleHeap@1 Mask@9)) (and (state ExhaleHeap@1 Mask@9) (state ExhaleHeap@1 Mask@9))) (and (and (and (=> (= (ControlFlow 0 23) 22) anon33_Else_correct) (=> (= (ControlFlow 0 23) 14) anon34_Else_correct)) (=> (= (ControlFlow 0 23) 6) anon35_Then_correct)) (=> (= (ControlFlow 0 23) 8) anon35_Else_correct))))))))))
(let ((anon32_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 27) 23)) anon12_correct)))
(let ((anon32_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 25) (- 0 26)) (<= FullPerm (U_2_real (MapType1Select Mask@6 r2 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@6 r2 f_7))) (=> (= (ControlFlow 0 25) 23) anon12_correct))))))
(let ((anon10_correct  (=> (= Mask@6 (MapType1Store Mask@5 r1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@5 r1 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 28) 25) anon32_Then_correct) (=> (= (ControlFlow 0 28) 27) anon32_Else_correct)))))
(let ((anon31_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 31) 28)) anon10_correct)))
(let ((anon31_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (<= FullPerm (U_2_real (MapType1Select Mask@5 r1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@5 r1 f_7))) (=> (= (ControlFlow 0 29) 28) anon10_correct))))))
(let ((anon29_Else_correct  (=> (and (and (> (lookup ExhaleHeap@0 r1 5) 3) (state ExhaleHeap@0 Mask@5)) (and (state ExhaleHeap@0 Mask@5) (state ExhaleHeap@0 Mask@5))) (and (=> (= (ControlFlow 0 32) 29) anon31_Then_correct) (=> (= (ControlFlow 0 32) 31) anon31_Else_correct)))))
(let ((anon7_correct true))
(let ((anon30_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon7_correct)))
(let ((anon30_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@5 r1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@5 r1 f_7))) (=> (= (ControlFlow 0 2) 1) anon7_correct))))))
(let ((anon4_correct  (=> (= Mask@3 (MapType1Store Mask@2 r2 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@2 r2 f_7)) FullPerm)))) (=> (and (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3)) (=> (and (and (and (not (= r1 null)) (= Mask@4 (MapType1Store Mask@3 r1 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@3 r1 f_7)) FullPerm))))) (and (state ExhaleHeap@0 Mask@4) (not (= r2 null)))) (and (and (= Mask@5 (MapType1Store Mask@4 r2 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@4 r2 f_7)) FullPerm)))) (state ExhaleHeap@0 Mask@5)) (and (state ExhaleHeap@0 Mask@5) (state ExhaleHeap@0 Mask@5)))) (and (=> (= (ControlFlow 0 33) (- 0 34)) (HasDirectPerm Mask@5 r1 f_7)) (=> (HasDirectPerm Mask@5 r1 f_7) (=> (and (= (U_2_int (MapType0Select ExhaleHeap@0 r1 f_7)) 3) (state ExhaleHeap@0 Mask@5)) (=> (and (and (state ExhaleHeap@0 Mask@5) (= s@0 (|Set#UnionOne| (|Set#Singleton| r2) r1))) (and (state ExhaleHeap@0 Mask@5) (state ExhaleHeap@0 Mask@5))) (and (and (=> (= (ControlFlow 0 33) 32) anon29_Else_correct) (=> (= (ControlFlow 0 33) 2) anon30_Then_correct)) (=> (= (ControlFlow 0 33) 4) anon30_Else_correct)))))))))))
(let ((anon28_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 37) 33)) anon4_correct)))
(let ((anon28_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 35) (- 0 36)) (<= FullPerm (U_2_real (MapType1Select Mask@2 r2 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 r2 f_7))) (=> (= (ControlFlow 0 35) 33) anon4_correct))))))
(let ((anon2_correct  (=> (= Mask@2 (MapType1Store Mask@1 r1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 r1 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 38) 35) anon28_Then_correct) (=> (= (ControlFlow 0 38) 37) anon28_Else_correct)))))
(let ((anon27_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 41) 38)) anon2_correct)))
(let ((anon27_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 39) (- 0 40)) (<= FullPerm (U_2_real (MapType1Select Mask@1 r1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 r1 f_7))) (=> (= (ControlFlow 0 39) 38) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@15 r1 $allocated))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@15 r2 $allocated)) (not (= r1 null))) (and (= Mask@0 (MapType1Store ZeroMask r1 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r1 f_7)) FullPerm)))) (state Heap@@15 Mask@0))) (and (and (not (= r2 null)) (= Mask@1 (MapType1Store Mask@0 r2 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 r2 f_7)) FullPerm))))) (and (state Heap@@15 Mask@1) (state Heap@@15 Mask@1)))) (and (=> (= (ControlFlow 0 42) (- 0 43)) (HasDirectPerm Mask@1 r1 f_7)) (=> (HasDirectPerm Mask@1 r1 f_7) (=> (= (U_2_int (MapType0Select Heap@@15 r1 f_7)) 1) (=> (and (state Heap@@15 Mask@1) (state Heap@@15 Mask@1)) (and (=> (= (ControlFlow 0 42) 39) anon27_Then_correct) (=> (= (ControlFlow 0 42) 41) anon27_Else_correct)))))))))))
