...
(assert  (and (and (= (type s@@21) (MapType2Type RefType boolType)) (= (type r_1) RefType)) (= (type Heap@@33) (MapType0Type RefType))))
(set-info :boogie-vc-id noQuantifiedPermissionsPre)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select s@@21 r_1)) (not (= r_1 null)))) (= (ControlFlow 0 5) 2)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (U_2_bool (MapType2Select s@@21 r_1)) (not (= r_1 null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm ZeroMask r_1 Cell_x)) (=> (HasDirectPerm ZeroMask r_1 Cell_x) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (and (=> (= (ControlFlow 0 6) 1) anon5_Else_correct) (=> (= (ControlFlow 0 6) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))
...
(let ((anon20_Else_correct  (=> (and (not (and (<= 0 i_1_1) (and (< i_1_1 a_2) (and (<= 0 j_1_1) (< j_1_1 a_2))))) (= (ControlFlow 0 11) 8)) anon11_correct)))
(let ((anon20_Then_correct  (=> (and (<= 0 i_1_1) (and (< i_1_1 a_2) (and (<= 0 j_1_1) (< j_1_1 a_2)))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (>= (f_6@@0 Heap@@33 i_1_1 j_1_1) 0)) (=> (>= (f_6@@0 Heap@@33 i_1_1 j_1_1) 0) (=> (= (ControlFlow 0 9) 8) anon11_correct))))))
(let ((anon17_Then_correct true))
(let ((anon5_correct true))
(let ((anon16_Then_correct  (=> (and (<= 0 i_6) (and (< i_6 a_2) (and (<= 0 j_1) (< j_1 a_2)))) (and (=> (= (ControlFlow 0 7) 6) anon17_Then_correct) (=> (= (ControlFlow 0 7) 4) anon5_correct)))))
(let ((anon16_Else_correct  (=> (and (not (and (<= 0 i_6) (and (< i_6 a_2) (and (<= 0 j_1) (< j_1 a_2))))) (= (ControlFlow 0 5) 4)) anon5_correct)))
(let ((anon15_Else_correct true))
(let ((anon19_Else_correct true))
(let ((anon18_Else_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (> a_2 0) (state Heap@@33 ZeroMask))) (and (and (and (and (and (and (=> (= (ControlFlow 0 12) 1) anon18_Else_correct) (=> (= (ControlFlow 0 12) 2) anon19_Else_correct)) (=> (= (ControlFlow 0 12) 9) anon20_Then_correct)) (=> (= (ControlFlow 0 12) 11) anon20_Else_correct)) (=> (= (ControlFlow 0 12) 3) anon15_Else_correct)) (=> (= (ControlFlow 0 12) 7) anon16_Then_correct)) (=> (= (ControlFlow 0 12) 5) anon16_Else_correct)))))
