...
(assert  (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type xs@@9) RefType)) (= (type Heap@@34) (MapType0Type RefType))))
(set-info :boogie-vc-id f6_pres_termination_proof)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon8_Else_correct true))
(let ((anon8_Then_correct true))
(let ((anon7_Then_correct  (=> b1 (and (=> (= (ControlFlow 0 5) 3) anon8_Then_correct) (=> (= (ControlFlow 0 5) 4) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (and (and (not b1) (= Mask@0 (MapType1Store ZeroMask null (list xs@@9) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (list xs@@9))) FullPerm))))) (and (state Heap@@34 Mask@0) (>= x@@12 0))) (and (and (state Heap@@34 Mask@0) (state Heap@@34 Mask@0)) (and (state Heap@@34 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (>= x@@12 0))))
(let ((anon0_correct  (=> (state Heap@@34 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@34 xs@@9 $allocated))) (and (=> (= (ControlFlow 0 6) 5) anon7_Then_correct) (=> (= (ControlFlow 0 6) 2) anon7_Else_correct))))))
