...
(set-info :boogie-vc-id callmethod1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select ZeroMask null (inv this@@9))))) (=> (<= FullPerm (U_2_real (MapType1Select ZeroMask null (inv this@@9)))) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@14 this@@9 $allocated))) (and (not (= this@@9 null)) (state Heap@@14 ZeroMask))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
...
(declare-fun this@@9 () T@U)
(declare-fun Heap@@14 () T@U)
(assert  (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type this@@9) RefType)) (= (type Heap@@14) (MapType0Type RefType))))
...
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (inv this@@9))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (inv this@@9)))) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@14 this@@9 $allocated))) (and (not (= this@@9 null)) (state Heap@@14 ZeroMask))) (and (and (not (= this@@9 null)) (= Mask@0 (MapType1Store ZeroMask this@@9 value (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@9 value)) FullPerm))))) (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0)))) (and (and (=> (= (ControlFlow 0 6) 1) anon5_Else_correct) (=> (= (ControlFlow 0 6) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct))))))
