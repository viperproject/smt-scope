...
(assert  (and (and (and (and (and (and (= (type Heap@@35) (MapType0Type RefType)) (= (type this@@55) RefType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |Node_state#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (= (MapType0Select Heap@@35 this@@55 Node_next) null) (=> (and (= Mask@4 Mask@2) (= (ControlFlow 0 4) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (not (= (MapType0Select Heap@@35 this@@55 Node_next) null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@2 this@@55 Node_next)) (=> (HasDirectPerm Mask@2 this@@55 Node_next) (=> (and (and (= Mask@3 (MapType1Store Mask@2 null (Node_state (MapType0Select Heap@@35 this@@55 Node_next)) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (Node_state (MapType0Select Heap@@35 this@@55 Node_next)))) FullPerm)))) (state Heap@@35 Mask@3)) (and (= Mask@4 Mask@3) (= (ControlFlow 0 2) 1))) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@35 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@35 this@@55 $allocated)) (not (= this@@55 null)))) (=> (and (and (and (= Mask@0 (MapType1Store ZeroMask this@@55 Node_val (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@55 Node_val)) FullPerm)))) (state Heap@@35 Mask@0)) (and (not (= this@@55 null)) (= Mask@1 (MapType1Store Mask@0 this@@55 Node_prev (real_2_U (+ (U_2_real (MapType1Select Mask@0 this@@55 Node_prev)) FullPerm)))))) (and (and (state Heap@@35 Mask@1) (not (= this@@55 null))) (and (= Mask@2 (MapType1Store Mask@1 this@@55 Node_next (real_2_U (+ (U_2_real (MapType1Select Mask@1 this@@55 Node_next)) FullPerm)))) (state Heap@@35 Mask@2)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@2 this@@55 Node_next)) (=> (HasDirectPerm Mask@2 this@@55 Node_next) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))))
...
(declare-fun sentNode_next@0 () T@U)
(declare-fun arg_n@0 () T@U)
...
(declare-fun Mask@0 () T@U)
(declare-fun sentNode_next () T@U)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@21) (MapType1Type RefType realType)) (= (type this@@55) RefType)) (= (type Heap@16) (MapType0Type RefType))) (= (type Heap@15) (MapType0Type RefType))) (= (type newPMask@1) (MapType1Type RefType boolType))) (= (type Heap@17) (MapType0Type RefType))) (= (type Heap@13) (MapType0Type RefType))) (= (type Heap@12) (MapType0Type RefType))) (= (type Heap@14) (MapType0Type RefType))) (= (type freshVersion@1) FrameTypeType)) (= (type Mask@20) (MapType1Type RefType realType))) (= (type Mask@19) (MapType1Type RefType realType))) (forall ((arg0@@64 T@U) (arg1@@45 T@U) ) (! (= (type (CombineFrames arg0@@64 arg1@@45)) FrameTypeType)
...
))) (= (type Mask@18) (MapType1Type RefType realType))) (= (type Heap@10) (MapType0Type RefType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@11) (MapType0Type RefType))) (= (type Heap@8) (MapType0Type RefType))) (= (type Heap@7) (MapType0Type RefType))) (= (type Heap@9) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@6) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@17) (MapType1Type RefType realType))) (= (type Mask@15) (MapType1Type RefType realType))) (= (type Mask@16) (MapType1Type RefType realType))) (= (type Mask@14) (MapType1Type RefType realType))) (= (type Mask@13) (MapType1Type RefType realType))) (= (type Mask@12) (MapType1Type RefType realType))) (= (type Heap@3) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@11) (MapType1Type RefType realType))) (= (type sentNode_next@0) RefType)) (= (type arg_n@0) RefType)) (= (type Mask@9) (MapType1Type RefType realType))) (= (type Mask@10) (MapType1Type RefType realType))) (= (type Mask@8) (MapType1Type RefType realType))) (= (type Mask@7) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type newVersion@1) FrameTypeType)) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@35) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type sentNode_next) RefType)))
(set-info :boogie-vc-id List_put)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 75) (let ((anon38_correct true))
(let ((anon57_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon38_correct)))
(let ((anon57_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@21 null (List_state this@@55))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@21 null (List_state this@@55)))) (=> (= (ControlFlow 0 3) 2) anon38_correct))))))
(let ((anon36_correct  (=> (= Heap@16 (MapType0Store Heap@15 null (|List_state#sm| this@@55) (MapType1Store (MapType0Select Heap@15 null (|List_state#sm| this@@55)) this@@55 List_sentinel (bool_2_U true)))) (=> (and (and (forall ((o_36 T@U) (f_40 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_40))))
(let ((A@@12 (FieldTypeInv0 (type f_40))))
 (=> (and (and (= (type o_36) RefType) (= (type f_40) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@16 null (|List_state#sm| this@@55)) o_36 f_40)) (U_2_bool (MapType1Select (MapType0Select Heap@16 null (|Node_state#sm| (MapType0Select Heap@16 this@@55 List_sentinel))) o_36 f_40)))) (U_2_bool (MapType1Select newPMask@1 o_36 f_40)))))
 :qid |stdinbpl.7089:27|
 :skolemid |125|
 :pattern ( (MapType1Select newPMask@1 o_36 f_40))
)) (= Heap@17 (MapType0Store Heap@16 null (|List_state#sm| this@@55) newPMask@1))) (and (state Heap@17 Mask@21) (state Heap@17 Mask@21))) (and (=> (= (ControlFlow 0 6) 3) anon57_Then_correct) (=> (= (ControlFlow 0 6) 5) anon57_Else_correct))))))
(let ((anon56_Else_correct  (=> (HasDirectPerm Mask@21 null (List_state this@@55)) (=> (and (= Heap@15 Heap@12) (= (ControlFlow 0 8) 6)) anon36_correct))))
(let ((anon56_Then_correct  (=> (not (HasDirectPerm Mask@21 null (List_state this@@55))) (=> (and (and (= Heap@13 (MapType0Store Heap@12 null (|List_state#sm| this@@55) ZeroPMask)) (= Heap@14 (MapType0Store Heap@13 null (List_state this@@55) freshVersion@1))) (and (= Heap@15 Heap@14) (= (ControlFlow 0 7) 6))) anon36_correct))))
(let ((anon34_correct  (=> (= Mask@20 (MapType1Store Mask@19 null (Node_state (MapType0Select Heap@12 this@@55 List_sentinel)) (real_2_U (- (U_2_real (MapType1Select Mask@19 null (Node_state (MapType0Select Heap@12 this@@55 List_sentinel)))) FullPerm)))) (=> (and (InsidePredicate (List_state this@@55) (MapType0Select Heap@12 null (List_state this@@55)) (Node_state (MapType0Select Heap@12 this@@55 List_sentinel)) (MapType0Select Heap@12 null (Node_state (MapType0Select Heap@12 this@@55 List_sentinel)))) (= Mask@21 (MapType1Store Mask@20 null (List_state this@@55) (real_2_U (+ (U_2_real (MapType1Select Mask@20 null (List_state this@@55))) FullPerm))))) (=> (and (and (state Heap@12 Mask@21) (state Heap@12 Mask@21)) (and (|List_state#trigger| Heap@12 (List_state this@@55)) (= (MapType0Select Heap@12 null (List_state this@@55)) (CombineFrames (FrameFragment (MapType0Select Heap@12 this@@55 List_sentinel)) (MapType0Select Heap@12 null (Node_state (MapType0Select Heap@12 this@@55 List_sentinel))))))) (and (=> (= (ControlFlow 0 9) 7) anon56_Then_correct) (=> (= (ControlFlow 0 9) 8) anon56_Else_correct)))))))
(let ((anon55_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon34_correct)))
(let ((anon55_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@19 null (Node_state (MapType0Select Heap@12 this@@55 List_sentinel)))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@19 null (Node_state (MapType0Select Heap@12 this@@55 List_sentinel))))) (=> (= (ControlFlow 0 10) 9) anon34_correct))))))
(let ((anon32_correct  (=> (= Mask@19 (MapType1Store Mask@18 this@@55 List_sentinel (real_2_U (- (U_2_real (MapType1Select Mask@18 this@@55 List_sentinel)) FullPerm)))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (not (= (MapType0Select Heap@12 this@@55 List_sentinel) null))) (=> (not (= (MapType0Select Heap@12 this@@55 List_sentinel) null)) (and (=> (= (ControlFlow 0 13) 10) anon55_Then_correct) (=> (= (ControlFlow 0 13) 12) anon55_Else_correct)))))))
(let ((anon54_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 17) 13)) anon32_correct)))
(let ((anon54_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= FullPerm (U_2_real (MapType1Select Mask@18 this@@55 List_sentinel)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@18 this@@55 List_sentinel))) (=> (= (ControlFlow 0 15) 13) anon32_correct))))))
(let ((anon30_correct  (=> (and (state Heap@12 Mask@18) (state Heap@12 Mask@18)) (and (=> (= (ControlFlow 0 18) 15) anon54_Then_correct) (=> (= (ControlFlow 0 18) 17) anon54_Else_correct)))))
(let ((anon53_Else_correct  (=> (= (MapType0Select Heap@10 (MapType0Select Heap@10 this@@55 List_sentinel) Node_next) null) (=> (and (= Heap@12 Heap@10) (= (ControlFlow 0 20) 18)) anon30_correct))))
(let ((anon53_Then_correct  (=> (not (= (MapType0Select Heap@10 (MapType0Select Heap@10 this@@55 List_sentinel) Node_next) null)) (=> (and (and (forall ((o_35 T@U) (f_39 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_39))))
(let ((A@@13 (FieldTypeInv0 (type f_39))))
 (=> (and (and (= (type o_35) RefType) (= (type f_39) (FieldType A@@13 B@@12))) (or (U_2_bool (MapType1Select (MapType0Select Heap@10 null (|Node_state#sm| (MapType0Select Heap@10 this@@55 List_sentinel))) o_35 f_39)) (U_2_bool (MapType1Select (MapType0Select Heap@10 null (|Node_state#sm| (MapType0Select Heap@10 (MapType0Select Heap@10 this@@55 List_sentinel) Node_next))) o_35 f_39)))) (U_2_bool (MapType1Select newPMask@0 o_35 f_39)))))
 :qid |stdinbpl.7047:29|
 :skolemid |124|
 :pattern ( (MapType1Select newPMask@0 o_35 f_39))
)) (= Heap@11 (MapType0Store Heap@10 null (|Node_state#sm| (MapType0Select Heap@10 this@@55 List_sentinel)) newPMask@0))) (and (= Heap@12 Heap@11) (= (ControlFlow 0 19) 18))) anon30_correct))))
(let ((anon28_correct  (=> (= Heap@8 (MapType0Store Heap@7 null (|Node_state#sm| (MapType0Select Heap@7 this@@55 List_sentinel)) (MapType1Store (MapType0Select Heap@7 null (|Node_state#sm| (MapType0Select Heap@7 this@@55 List_sentinel))) (MapType0Select Heap@7 this@@55 List_sentinel) Node_val (bool_2_U true)))) (=> (and (= Heap@9 (MapType0Store Heap@8 null (|Node_state#sm| (MapType0Select Heap@8 this@@55 List_sentinel)) (MapType1Store (MapType0Select Heap@8 null (|Node_state#sm| (MapType0Select Heap@8 this@@55 List_sentinel))) (MapType0Select Heap@8 this@@55 List_sentinel) Node_prev (bool_2_U true)))) (= Heap@10 (MapType0Store Heap@9 null (|Node_state#sm| (MapType0Select Heap@9 this@@55 List_sentinel)) (MapType1Store (MapType0Select Heap@9 null (|Node_state#sm| (MapType0Select Heap@9 this@@55 List_sentinel))) (MapType0Select Heap@9 this@@55 List_sentinel) Node_next (bool_2_U true))))) (and (=> (= (ControlFlow 0 21) 19) anon53_Then_correct) (=> (= (ControlFlow 0 21) 20) anon53_Else_correct))))))
(let ((anon52_Else_correct  (=> (HasDirectPerm Mask@18 null (Node_state (MapType0Select Heap@4 this@@55 List_sentinel))) (=> (and (= Heap@7 Heap@4) (= (ControlFlow 0 23) 21)) anon28_correct))))
(let ((anon52_Then_correct  (=> (not (HasDirectPerm Mask@18 null (Node_state (MapType0Select Heap@4 this@@55 List_sentinel)))) (=> (and (and (= Heap@5 (MapType0Store Heap@4 null (|Node_state#sm| (MapType0Select Heap@4 this@@55 List_sentinel)) ZeroPMask)) (= Heap@6 (MapType0Store Heap@5 null (Node_state (MapType0Select Heap@5 this@@55 List_sentinel)) freshVersion@0))) (and (= Heap@7 Heap@6) (= (ControlFlow 0 22) 21))) anon28_correct))))
(let ((anon26_correct  (=> (= Mask@18 (MapType1Store Mask@17 null (Node_state (MapType0Select Heap@4 this@@55 List_sentinel)) (real_2_U (+ (U_2_real (MapType1Select Mask@17 null (Node_state (MapType0Select Heap@4 this@@55 List_sentinel)))) FullPerm)))) (=> (and (and (state Heap@4 Mask@18) (state Heap@4 Mask@18)) (and (|Node_state#trigger| Heap@4 (Node_state (MapType0Select Heap@4 this@@55 List_sentinel))) (= (MapType0Select Heap@4 null (Node_state (MapType0Select Heap@4 this@@55 List_sentinel))) (CombineFrames (FrameFragment (MapType0Select Heap@4 (MapType0Select Heap@4 this@@55 List_sentinel) Node_val)) (CombineFrames (FrameFragment (MapType0Select Heap@4 (MapType0Select Heap@4 this@@55 List_sentinel) Node_prev)) (CombineFrames (FrameFragment (MapType0Select Heap@4 (MapType0Select Heap@4 this@@55 List_sentinel) Node_next)) (FrameFragment (ite (not (= (MapType0Select Heap@4 (MapType0Select Heap@4 this@@55 List_sentinel) Node_next) null)) (MapType0Select Heap@4 null (Node_state (MapType0Select Heap@4 (MapType0Select Heap@4 this@@55 List_sentinel) Node_next))) EmptyFrame)))))))) (and (=> (= (ControlFlow 0 24) 22) anon52_Then_correct) (=> (= (ControlFlow 0 24) 23) anon52_Else_correct))))))
(let ((anon25_correct  (=> (and (and (= Mask@16 (MapType1Store Mask@15 null (Node_state (MapType0Select Heap@4 (MapType0Select Heap@4 this@@55 List_sentinel) Node_next)) (real_2_U (- (U_2_real (MapType1Select Mask@15 null (Node_state (MapType0Select Heap@4 (MapType0Select Heap@4 this@@55 List_sentinel) Node_next)))) FullPerm)))) (InsidePredicate (Node_state (MapType0Select Heap@4 this@@55 List_sentinel)) (MapType0Select Heap@4 null (Node_state (MapType0Select Heap@4 this@@55 List_sentinel))) (Node_state (MapType0Select Heap@4 (MapType0Select Heap@4 this@@55 List_sentinel) Node_next)) (MapType0Select Heap@4 null (Node_state (MapType0Select Heap@4 (MapType0Select Heap@4 this@@55 List_sentinel) Node_next))))) (and (= Mask@17 Mask@16) (= (ControlFlow 0 26) 24))) anon26_correct)))
(let ((anon51_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 29) 26)) anon25_correct)))
(let ((anon51_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (<= FullPerm (U_2_real (MapType1Select Mask@15 null (Node_state (MapType0Select Heap@4 (MapType0Select Heap@4 this@@55 List_sentinel) Node_next)))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@15 null (Node_state (MapType0Select Heap@4 (MapType0Select Heap@4 this@@55 List_sentinel) Node_next))))) (=> (= (ControlFlow 0 27) 26) anon25_correct))))))
(let ((anon50_Then_correct  (=> (not (= (MapType0Select Heap@4 (MapType0Select Heap@4 this@@55 List_sentinel) Node_next) null)) (and (=> (= (ControlFlow 0 30) 27) anon51_Then_correct) (=> (= (ControlFlow 0 30) 29) anon51_Else_correct)))))
(let ((anon50_Else_correct  (=> (= (MapType0Select Heap@4 (MapType0Select Heap@4 this@@55 List_sentinel) Node_next) null) (=> (and (= Mask@17 Mask@15) (= (ControlFlow 0 25) 24)) anon26_correct))))
(let ((anon22_correct  (=> (= Mask@15 (MapType1Store Mask@14 (MapType0Select Heap@4 this@@55 List_sentinel) Node_next (real_2_U (- (U_2_real (MapType1Select Mask@14 (MapType0Select Heap@4 this@@55 List_sentinel) Node_next)) FullPerm)))) (and (=> (= (ControlFlow 0 31) 30) anon50_Then_correct) (=> (= (ControlFlow 0 31) 25) anon50_Else_correct)))))
(let ((anon49_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 34) 31)) anon22_correct)))
(let ((anon49_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 32) (- 0 33)) (<= FullPerm (U_2_real (MapType1Select Mask@14 (MapType0Select Heap@4 this@@55 List_sentinel) Node_next)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@14 (MapType0Select Heap@4 this@@55 List_sentinel) Node_next))) (=> (= (ControlFlow 0 32) 31) anon22_correct))))))
(let ((anon20_correct  (=> (= Mask@14 (MapType1Store Mask@13 (MapType0Select Heap@4 this@@55 List_sentinel) Node_prev (real_2_U (- (U_2_real (MapType1Select Mask@13 (MapType0Select Heap@4 this@@55 List_sentinel) Node_prev)) FullPerm)))) (and (=> (= (ControlFlow 0 35) 32) anon49_Then_correct) (=> (= (ControlFlow 0 35) 34) anon49_Else_correct)))))
(let ((anon48_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 38) 35)) anon20_correct)))
(let ((anon48_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 36) (- 0 37)) (<= FullPerm (U_2_real (MapType1Select Mask@13 (MapType0Select Heap@4 this@@55 List_sentinel) Node_prev)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@13 (MapType0Select Heap@4 this@@55 List_sentinel) Node_prev))) (=> (= (ControlFlow 0 36) 35) anon20_correct))))))
(let ((anon18_correct  (=> (= Mask@13 (MapType1Store Mask@12 (MapType0Select Heap@4 this@@55 List_sentinel) Node_val (real_2_U (- (U_2_real (MapType1Select Mask@12 (MapType0Select Heap@4 this@@55 List_sentinel) Node_val)) FullPerm)))) (and (=> (= (ControlFlow 0 39) 36) anon48_Then_correct) (=> (= (ControlFlow 0 39) 38) anon48_Else_correct)))))
(let ((anon47_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 42) 39)) anon18_correct)))
(let ((anon47_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 40) (- 0 41)) (<= FullPerm (U_2_real (MapType1Select Mask@12 (MapType0Select Heap@4 this@@55 List_sentinel) Node_val)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@12 (MapType0Select Heap@4 this@@55 List_sentinel) Node_val))) (=> (= (ControlFlow 0 40) 39) anon18_correct))))))
(let ((anon16_correct  (=> (IdenticalOnKnownLocations Heap@3 ExhaleHeap@0 Mask@11) (=> (and (and (and (= Mask@12 (MapType1Store Mask@11 null (Node_state sentNode_next@0) (real_2_U (+ (U_2_real (MapType1Select Mask@11 null (Node_state sentNode_next@0))) FullPerm)))) (state ExhaleHeap@0 Mask@12)) (and (state ExhaleHeap@0 Mask@12) (= (Node_get_next ExhaleHeap@0 sentNode_next@0) arg_n@0))) (and (and (not (= sentNode_next@0 null)) (state ExhaleHeap@0 Mask@12)) (and (U_2_bool (MapType0Select ExhaleHeap@0 sentNode_next@0 $allocated)) (state ExhaleHeap@0 Mask@12)))) (and (=> (= (ControlFlow 0 43) (- 0 46)) (HasDirectPerm Mask@12 this@@55 List_sentinel)) (=> (HasDirectPerm Mask@12 this@@55 List_sentinel) (and (=> (= (ControlFlow 0 43) (- 0 45)) (= FullPerm (U_2_real (MapType1Select Mask@12 (MapType0Select ExhaleHeap@0 this@@55 List_sentinel) Node_next)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@12 (MapType0Select ExhaleHeap@0 this@@55 List_sentinel) Node_next))) (=> (and (= Heap@4 (MapType0Store ExhaleHeap@0 (MapType0Select ExhaleHeap@0 this@@55 List_sentinel) Node_next sentNode_next@0)) (state Heap@4 Mask@12)) (and (=> (= (ControlFlow 0 43) (- 0 44)) (HasDirectPerm Mask@12 this@@55 List_sentinel)) (=> (HasDirectPerm Mask@12 this@@55 List_sentinel) (and (=> (= (ControlFlow 0 43) 40) anon47_Then_correct) (=> (= (ControlFlow 0 43) 42) anon47_Else_correct)))))))))))))
(let ((anon15_correct  (=> (= Mask@10 (MapType1Store Mask@9 null (Node_state arg_n@0) (real_2_U (- (U_2_real (MapType1Select Mask@9 null (Node_state arg_n@0))) FullPerm)))) (=> (and (= Mask@11 Mask@10) (= (ControlFlow 0 48) 43)) anon16_correct))))
(let ((anon46_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 51) 48)) anon15_correct)))
(let ((anon46_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 49) (- 0 50)) (<= FullPerm (U_2_real (MapType1Select Mask@9 null (Node_state arg_n@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@9 null (Node_state arg_n@0)))) (=> (= (ControlFlow 0 49) 48) anon15_correct))))))
(let ((anon45_Then_correct  (=> (not (= arg_n@0 null)) (and (=> (= (ControlFlow 0 52) 49) anon46_Then_correct) (=> (= (ControlFlow 0 52) 51) anon46_Else_correct)))))
(let ((anon45_Else_correct  (=> (= arg_n@0 null) (=> (and (= Mask@11 Mask@9) (= (ControlFlow 0 47) 43)) anon16_correct))))
(let ((anon12_correct  (=> (and (state Heap@3 Mask@9) (state Heap@3 Mask@9)) (and (=> (= (ControlFlow 0 53) (- 0 55)) (HasDirectPerm Mask@9 this@@55 List_sentinel)) (=> (HasDirectPerm Mask@9 this@@55 List_sentinel) (and (=> (= (ControlFlow 0 53) (- 0 54)) (HasDirectPerm Mask@9 (MapType0Select Heap@3 this@@55 List_sentinel) Node_next)) (=> (HasDirectPerm Mask@9 (MapType0Select Heap@3 this@@55 List_sentinel) Node_next) (=> (= arg_n@0 (MapType0Select Heap@3 (MapType0Select Heap@3 this@@55 List_sentinel) Node_next)) (and (=> (= (ControlFlow 0 53) 52) anon45_Then_correct) (=> (= (ControlFlow 0 53) 47) anon45_Else_correct))))))))))
(let ((anon44_Else_correct  (=> (= (MapType0Select Heap@3 (MapType0Select Heap@3 this@@55 List_sentinel) Node_next) null) (=> (and (= Mask@9 Mask@7) (= (ControlFlow 0 57) 53)) anon12_correct))))
(let ((anon44_Then_correct  (=> (and (not (= (MapType0Select Heap@3 (MapType0Select Heap@3 this@@55 List_sentinel) Node_next) null)) (= Mask@8 (MapType1Store Mask@7 null (Node_state (MapType0Select Heap@3 (MapType0Select Heap@3 this@@55 List_sentinel) Node_next)) (real_2_U (+ (U_2_real (MapType1Select Mask@7 null (Node_state (MapType0Select Heap@3 (MapType0Select Heap@3 this@@55 List_sentinel) Node_next)))) FullPerm))))) (=> (and (and (InsidePredicate (Node_state (MapType0Select Heap@3 this@@55 List_sentinel)) (MapType0Select Heap@3 null (Node_state (MapType0Select Heap@3 this@@55 List_sentinel))) (Node_state (MapType0Select Heap@3 (MapType0Select Heap@3 this@@55 List_sentinel) Node_next)) (MapType0Select Heap@3 null (Node_state (MapType0Select Heap@3 (MapType0Select Heap@3 this@@55 List_sentinel) Node_next)))) (state Heap@3 Mask@8)) (and (= Mask@9 Mask@8) (= (ControlFlow 0 56) 53))) anon12_correct))))
(let ((anon10_correct  (=> (not (= (MapType0Select Heap@3 this@@55 List_sentinel) null)) (=> (and (and (and (= Mask@5 (MapType1Store Mask@4 (MapType0Select Heap@3 this@@55 List_sentinel) Node_val (real_2_U (+ (U_2_real (MapType1Select Mask@4 (MapType0Select Heap@3 this@@55 List_sentinel) Node_val)) FullPerm)))) (state Heap@3 Mask@5)) (and (not (= (MapType0Select Heap@3 this@@55 List_sentinel) null)) (= Mask@6 (MapType1Store Mask@5 (MapType0Select Heap@3 this@@55 List_sentinel) Node_prev (real_2_U (+ (U_2_real (MapType1Select Mask@5 (MapType0Select Heap@3 this@@55 List_sentinel) Node_prev)) FullPerm)))))) (and (and (state Heap@3 Mask@6) (not (= (MapType0Select Heap@3 this@@55 List_sentinel) null))) (and (= Mask@7 (MapType1Store Mask@6 (MapType0Select Heap@3 this@@55 List_sentinel) Node_next (real_2_U (+ (U_2_real (MapType1Select Mask@6 (MapType0Select Heap@3 this@@55 List_sentinel) Node_next)) FullPerm)))) (state Heap@3 Mask@7)))) (and (=> (= (ControlFlow 0 58) 56) anon44_Then_correct) (=> (= (ControlFlow 0 58) 57) anon44_Else_correct))))))
(let ((anon43_Else_correct  (=> (HasDirectPerm Mask@4 null (Node_state (MapType0Select Heap@1 this@@55 List_sentinel))) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 60) 58)) anon10_correct))))
(let ((anon43_Then_correct  (=> (and (and (not (HasDirectPerm Mask@4 null (Node_state (MapType0Select Heap@1 this@@55 List_sentinel)))) (= Heap@2 (MapType0Store Heap@1 null (Node_state (MapType0Select Heap@1 this@@55 List_sentinel)) newVersion@1))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 59) 58))) anon10_correct)))
(let ((anon8_correct  (=> (= Mask@4 (MapType1Store Mask@3 null (Node_state (MapType0Select Heap@1 this@@55 List_sentinel)) (real_2_U (- (U_2_real (MapType1Select Mask@3 null (Node_state (MapType0Select Heap@1 this@@55 List_sentinel)))) FullPerm)))) (and (=> (= (ControlFlow 0 61) 59) anon43_Then_correct) (=> (= (ControlFlow 0 61) 60) anon43_Else_correct)))))
(let ((anon42_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 64) 61)) anon8_correct)))
(let ((anon42_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 62) (- 0 63)) (<= FullPerm (U_2_real (MapType1Select Mask@3 null (Node_state (MapType0Select Heap@1 this@@55 List_sentinel)))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 null (Node_state (MapType0Select Heap@1 this@@55 List_sentinel))))) (=> (= (ControlFlow 0 62) 61) anon8_correct))))))
(let ((anon6_correct  (=> (not (= this@@55 null)) (=> (and (and (and (= Mask@2 (MapType1Store Mask@1 this@@55 List_sentinel (real_2_U (+ (U_2_real (MapType1Select Mask@1 this@@55 List_sentinel)) FullPerm)))) (state Heap@1 Mask@2)) (and (not (= (MapType0Select Heap@1 this@@55 List_sentinel) null)) (= Mask@3 (MapType1Store Mask@2 null (Node_state (MapType0Select Heap@1 this@@55 List_sentinel)) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (Node_state (MapType0Select Heap@1 this@@55 List_sentinel)))) FullPerm)))))) (and (and (InsidePredicate (List_state this@@55) (MapType0Select Heap@1 null (List_state this@@55)) (Node_state (MapType0Select Heap@1 this@@55 List_sentinel)) (MapType0Select Heap@1 null (Node_state (MapType0Select Heap@1 this@@55 List_sentinel)))) (state Heap@1 Mask@3)) (and (state Heap@1 Mask@3) (state Heap@1 Mask@3)))) (and (=> (= (ControlFlow 0 65) (- 0 66)) (HasDirectPerm Mask@3 this@@55 List_sentinel)) (=> (HasDirectPerm Mask@3 this@@55 List_sentinel) (=> (and (|Node_state#trigger| Heap@1 (Node_state (MapType0Select Heap@1 this@@55 List_sentinel))) (= (MapType0Select Heap@1 null (Node_state (MapType0Select Heap@1 this@@55 List_sentinel))) (CombineFrames (FrameFragment (MapType0Select Heap@1 (MapType0Select Heap@1 this@@55 List_sentinel) Node_val)) (CombineFrames (FrameFragment (MapType0Select Heap@1 (MapType0Select Heap@1 this@@55 List_sentinel) Node_prev)) (CombineFrames (FrameFragment (MapType0Select Heap@1 (MapType0Select Heap@1 this@@55 List_sentinel) Node_next)) (FrameFragment (ite (not (= (MapType0Select Heap@1 (MapType0Select Heap@1 this@@55 List_sentinel) Node_next) null)) (MapType0Select Heap@1 null (Node_state (MapType0Select Heap@1 (MapType0Select Heap@1 this@@55 List_sentinel) Node_next))) EmptyFrame))))))) (and (=> (= (ControlFlow 0 65) 62) anon42_Then_correct) (=> (= (ControlFlow 0 65) 64) anon42_Else_correct)))))))))
(let ((anon41_Else_correct  (=> (HasDirectPerm Mask@1 null (List_state this@@55)) (=> (and (= Heap@1 Heap@@35) (= (ControlFlow 0 68) 65)) anon6_correct))))
(let ((anon41_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (List_state this@@55))) (= Heap@0 (MapType0Store Heap@@35 null (List_state this@@55) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 67) 65))) anon6_correct)))
(let ((anon4_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (List_state this@@55) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (List_state this@@55))) FullPerm)))) (and (=> (= (ControlFlow 0 69) 67) anon41_Then_correct) (=> (= (ControlFlow 0 69) 68) anon41_Else_correct)))))
(let ((anon40_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 72) 69)) anon4_correct)))
(let ((anon40_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 70) (- 0 71)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (List_state this@@55))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (List_state this@@55)))) (=> (= (ControlFlow 0 70) 69) anon4_correct))))))
(let ((anon39_Else_correct  (=> (U_2_bool (MapType0Select Heap@@35 sentNode_next $allocated)) (=> (and (|List_state#trigger| Heap@@35 (List_state this@@55)) (= (MapType0Select Heap@@35 null (List_state this@@55)) (CombineFrames (FrameFragment (MapType0Select Heap@@35 this@@55 List_sentinel)) (MapType0Select Heap@@35 null (Node_state (MapType0Select Heap@@35 this@@55 List_sentinel)))))) (and (=> (= (ControlFlow 0 73) 70) anon40_Then_correct) (=> (= (ControlFlow 0 73) 72) anon40_Else_correct))))))
(let ((anon39_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@35 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@35 this@@55 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (List_state this@@55) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (List_state this@@55))) FullPerm))))) (and (state Heap@@35 Mask@0) (state Heap@@35 Mask@0))) (and (=> (= (ControlFlow 0 74) 1) anon39_Then_correct) (=> (= (ControlFlow 0 74) 73) anon39_Else_correct))))))
