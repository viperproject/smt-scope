...
(declare-fun |f_get'| (T@U Int) Int)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |f_get#triggerStateless| (Int) Int)
(declare-fun |f_get2'| (T@U Int) Int)
(declare-fun |f_get2#triggerStateless| (Int) Int)
(declare-fun $allocated () T@U)
(declare-fun NormalFieldType () T@T)
(declare-fun f_get (T@U Int) Int)
(declare-fun f_get2 (T@U Int) Int)
(declare-fun |f_clamp'| (T@U) Int)
(declare-fun AssumeFunctionsAbove () Int)
(declare-fun |f_clamp#trigger| (T@U) Bool)
...
(declare-fun |f_get#frame| (T@U Int) Int)
(declare-fun |f_get2#frame| (T@U Int) Int)
(declare-fun |f_clamp#frame| (T@U) Int)
...
(assert (forall ((Heap@@2 T@U) (idx Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (int_2_U (|f_get#triggerStateless| idx))))
 :qid |stdinbpl.191:15|
 :skolemid |23|
 :pattern ( (|f_get'| Heap@@2 idx))
)))
(assert (forall ((Heap@@3 T@U) (idx@@0 Int) ) (!  (=> (= (type Heap@@3) (MapType0Type RefType)) (dummyFunction (int_2_U (|f_get2#triggerStateless| idx@@0))))
 :qid |stdinbpl.231:15|
 :skolemid |26|
 :pattern ( (|f_get2'| Heap@@3 idx@@0))
)))
...
(assert (forall ((Heap@@5 T@U) (idx@@1 Int) ) (!  (=> (= (type Heap@@5) (MapType0Type RefType)) (and (= (f_get Heap@@5 idx@@1) (|f_get'| Heap@@5 idx@@1)) (dummyFunction (int_2_U (|f_get#triggerStateless| idx@@1)))))
 :qid |stdinbpl.187:15|
 :skolemid |22|
 :pattern ( (f_get Heap@@5 idx@@1))
)))
(assert (forall ((Heap@@6 T@U) (idx@@2 Int) ) (!  (=> (= (type Heap@@6) (MapType0Type RefType)) (and (= (f_get2 Heap@@6 idx@@2) (|f_get2'| Heap@@6 idx@@2)) (dummyFunction (int_2_U (|f_get2#triggerStateless| idx@@2)))))
 :qid |stdinbpl.227:15|
 :skolemid |25|
 :pattern ( (f_get2 Heap@@6 idx@@2))
)))
(assert (= (type EmptyFrame) FrameTypeType))
(assert (forall ((Heap@@7 T@U) (Mask@@3 T@U) ) (!  (=> (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type Mask@@3) (MapType1Type RefType realType))) (and (state Heap@@7 Mask@@3) (or (< AssumeFunctionsAbove 0) (|f_clamp#trigger| EmptyFrame)))) (= (|f_clamp'| Heap@@7) 0))
 :qid |stdinbpl.288:15|
 :skolemid |31|
 :pattern ( (state Heap@@7 Mask@@3) (|f_clamp'| Heap@@7))
)))
...
(assert (forall ((Heap@@10 T@U) ) (!  (=> (= (type Heap@@10) (MapType0Type RefType)) (and (= (f_clamp Heap@@10) (|f_clamp'| Heap@@10)) (dummyFunction (int_2_U |f_clamp#triggerStateless|))))
 :qid |stdinbpl.271:15|
 :skolemid |28|
 :pattern ( (f_clamp Heap@@10))
)))
...
(assert (forall ((Heap@@13 T@U) (Mask@@10 T@U) (idx@@3 Int) ) (!  (=> (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (state Heap@@13 Mask@@10)) (= (|f_get'| Heap@@13 idx@@3) (|f_get#frame| EmptyFrame idx@@3)))
 :qid |stdinbpl.198:15|
 :skolemid |24|
 :pattern ( (state Heap@@13 Mask@@10) (|f_get'| Heap@@13 idx@@3))
)))
(assert (forall ((Heap@@14 T@U) (Mask@@11 T@U) (idx@@4 Int) ) (!  (=> (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (state Heap@@14 Mask@@11)) (= (|f_get2'| Heap@@14 idx@@4) (|f_get2#frame| EmptyFrame idx@@4)))
 :qid |stdinbpl.238:15|
 :skolemid |27|
 :pattern ( (state Heap@@14 Mask@@11) (|f_get2'| Heap@@14 idx@@4))
)))
(assert (forall ((Heap@@15 T@U) ) (!  (=> (= (type Heap@@15) (MapType0Type RefType)) (dummyFunction (int_2_U |f_clamp#triggerStateless|)))
 :qid |stdinbpl.275:15|
 :skolemid |29|
...
(assert (forall ((Heap@@17 T@U) (Mask@@12 T@U) ) (!  (=> (and (and (= (type Heap@@17) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (state Heap@@17 Mask@@12)) (= (|f_clamp'| Heap@@17) (|f_clamp#frame| EmptyFrame)))
 :qid |stdinbpl.282:15|
 :skolemid |30|
 :pattern ( (state Heap@@17 Mask@@12) (|f_clamp'| Heap@@17))
)))
...
(declare-fun qvar_2 () Int)
(assert (= (type Heap@@19) (MapType0Type RefType)))
(set-info :boogie-vc-id main2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon14_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (= (f_get2 Heap@@19 10) 0))))
(let ((anon14_Then_correct true))
(let ((anon10_Else_correct  (=> (forall ((qvar_1 Int) ) (!  (=> (> qvar_1 0) (= (f_get2 Heap@@19 qvar_1) (f_clamp Heap@@19)))
 :qid |stdinbpl.432:20|
 :skolemid |33|
 :pattern ( (|f_get2#frame| EmptyFrame qvar_1))
)) (=> (and (state Heap@@19 ZeroMask) (state Heap@@19 ZeroMask)) (and (=> (= (ControlFlow 0 10) 7) anon14_Then_correct) (=> (= (ControlFlow 0 10) 9) anon14_Else_correct))))))
(let ((anon13_Then_correct true))
(let ((anon12_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (> qvar_2 (- 0 5)))))
(let ((anon6_correct true))
(let ((anon11_Then_correct  (=> (> qvar_2 0) (and (and (=> (= (ControlFlow 0 6) 4) anon12_Then_correct) (=> (= (ControlFlow 0 6) 5) anon13_Then_correct)) (=> (= (ControlFlow 0 6) 1) anon6_correct)))))
(let ((anon11_Else_correct  (=> (and (>= 0 qvar_2) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (state Heap@@19 ZeroMask)) (and (and (=> (= (ControlFlow 0 11) 10) anon10_Else_correct) (=> (= (ControlFlow 0 11) 6) anon11_Then_correct)) (=> (= (ControlFlow 0 11) 2) anon11_Else_correct))))))
