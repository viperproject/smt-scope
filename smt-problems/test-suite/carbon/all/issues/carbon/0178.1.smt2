...
(declare-fun Node__isolated (T@U T@U) T@U)
...
(declare-fun PredicateType_Node__isolatedType () T@T)
(declare-fun FrameTypeType () T@T)
(declare-fun |Node__isolated#trigger| (T@U T@U) Bool)
(declare-fun |Node__isolated#everUsed| (T@U) Bool)
...
(declare-fun |Node__isolated#sm| (T@U T@U) T@U)
(declare-fun |Node__isolated#condqp2| (T@U T@U T@U) Int)
(declare-fun |sk_Node__isolated#condqp2| (Int Int) T@U)
...
(declare-fun |Node__isolated#condqp1| (T@U T@U T@U) Int)
(declare-fun |sk_Node__isolated#condqp1| (Int Int) T@U)
...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (Ctor RefType) 8)) (= (type data) (FieldType NormalFieldType RefType))))
(assert (distinct $allocated data)
)
...
(= (type (MapType2Store arg0@@32 arg1@@16 arg2@@3)) (MapType2Type aVar0@@1 aVar1@@3))))
 ...
 :weight 0
)))) (= (Ctor PredicateType_Node__isolatedType) 13)) (= (Ctor FrameTypeType) 14)) (forall ((arg0@@33 T@U) (arg1@@17 T@U) ) (! (= (type (Node__isolated arg0@@33 arg1@@17)) (FieldType PredicateType_Node__isolatedType FrameTypeType))
 :qid |funType:Node__isolated|
 :pattern ( (Node__isolated arg0@@33 arg1@@17))
))))
(assert (forall ((ref T@U) (wset T@U) ) (!  (=> (and (= (type ref) RefType) (= (type wset) (MapType2Type RefType boolType))) (IsPredicateField (Node__isolated ref wset)))
 :qid |stdinbpl.415:15|
 :skolemid |83|
 :pattern ( (Node__isolated ref wset))
)))
(assert (forall ((Heap@@0 T@U) (ref@@0 T@U) (wset@@0 T@U) ) (!  (=> (and (and (= (type Heap@@0) (MapType0Type RefType)) (= (type ref@@0) RefType)) (= (type wset@@0) (MapType2Type RefType boolType))) (|Node__isolated#everUsed| (Node__isolated ref@@0 wset@@0)))
 :qid |stdinbpl.434:15|
 :skolemid |87|
 :pattern ( (|Node__isolated#trigger| Heap@@0 (Node__isolated ref@@0 wset@@0)))
)))
...
(assert (forall ((ref@@1 T@U) (wset@@1 T@U) (ref2 T@U) (wset2 T@U) ) (!  (=> (and (and (and (and (= (type ref@@1) RefType) (= (type wset@@1) (MapType2Type RefType boolType))) (= (type ref2) RefType)) (= (type wset2) (MapType2Type RefType boolType))) (= (Node__isolated ref@@1 wset@@1) (Node__isolated ref2 wset2))) (and (= ref@@1 ref2) (= wset@@1 wset2)))
 :qid |stdinbpl.425:15|
 :skolemid |85|
 :pattern ( (Node__isolated ref@@1 wset@@1) (Node__isolated ref2 wset2))
)))
(assert (forall ((arg0@@39 T@U) (arg1@@20 T@U) ) (! (= (type (|Node__isolated#sm| arg0@@39 arg1@@20)) (FieldType PredicateType_Node__isolatedType (MapType1Type RefType boolType)))
 :qid |funType:Node__isolated#sm|
 :pattern ( (|Node__isolated#sm| arg0@@39 arg1@@20))
)))
(assert (forall ((ref@@2 T@U) (wset@@2 T@U) (ref2@@0 T@U) (wset2@@0 T@U) ) (!  (=> (and (and (and (and (= (type ref@@2) RefType) (= (type wset@@2) (MapType2Type RefType boolType))) (= (type ref2@@0) RefType)) (= (type wset2@@0) (MapType2Type RefType boolType))) (= (|Node__isolated#sm| ref@@2 wset@@2) (|Node__isolated#sm| ref2@@0 wset2@@0))) (and (= ref@@2 ref2@@0) (= wset@@2 wset2@@0)))
 :qid |stdinbpl.429:15|
 :skolemid |86|
 :pattern ( (|Node__isolated#sm| ref@@2 wset@@2) (|Node__isolated#sm| ref2@@0 wset2@@0))
)))
...
(assert (forall ((arg0@@40 Int) (arg1@@21 Int) ) (! (= (type (|sk_Node__isolated#condqp2| arg0@@40 arg1@@21)) RefType)
 :qid |funType:sk_Node__isolated#condqp2|
 :pattern ( (|sk_Node__isolated#condqp2| arg0@@40 arg1@@21))
)))
(assert (forall ((Heap2Heap T@U) (Heap1Heap T@U) (ref@@3 T@U) (wset@@3 T@U) ) (!  (=> (and (and (and (and (= (type Heap2Heap) (MapType0Type RefType)) (= (type Heap1Heap) (MapType0Type RefType))) (= (type ref@@3) RefType)) (= (type wset@@3) (MapType2Type RefType boolType))) (and (=  (and (U_2_bool (MapType2Select wset@@3 (|sk_Node__isolated#condqp2| (|Node__isolated#condqp2| Heap2Heap ref@@3 wset@@3) (|Node__isolated#condqp2| Heap1Heap ref@@3 wset@@3)))) (< NoPerm FullPerm))  (and (U_2_bool (MapType2Select wset@@3 (|sk_Node__isolated#condqp2| (|Node__isolated#condqp2| Heap2Heap ref@@3 wset@@3) (|Node__isolated#condqp2| Heap1Heap ref@@3 wset@@3)))) (< NoPerm FullPerm))) (=> (and (U_2_bool (MapType2Select wset@@3 (|sk_Node__isolated#condqp2| (|Node__isolated#condqp2| Heap2Heap ref@@3 wset@@3) (|Node__isolated#condqp2| Heap1Heap ref@@3 wset@@3)))) (< NoPerm FullPerm)) (= (MapType0Select Heap2Heap null (Node__isolated (|sk_Node__isolated#condqp2| (|Node__isolated#condqp2| Heap2Heap ref@@3 wset@@3) (|Node__isolated#condqp2| Heap1Heap ref@@3 wset@@3)) wset@@3)) (MapType0Select Heap1Heap null (Node__isolated (|sk_Node__isolated#condqp2| (|Node__isolated#condqp2| Heap2Heap ref@@3 wset@@3) (|Node__isolated#condqp2| Heap1Heap ref@@3 wset@@3)) wset@@3)))))) (= (|Node__isolated#condqp2| Heap2Heap ref@@3 wset@@3) (|Node__isolated#condqp2| Heap1Heap ref@@3 wset@@3)))
 :qid |stdinbpl.456:15|
 :skolemid |89|
 :pattern ( (|Node__isolated#condqp2| Heap2Heap ref@@3 wset@@3) (|Node__isolated#condqp2| Heap1Heap ref@@3 wset@@3) (succHeapTrans Heap2Heap Heap1Heap))
)))
...
(assert (forall ((ref@@4 T@U) (wset@@4 T@U) ) (!  (=> (and (= (type ref@@4) RefType) (= (type wset@@4) (MapType2Type RefType boolType))) (= (getPredWandId (Node__isolated ref@@4 wset@@4)) 0))
 :qid |stdinbpl.419:15|
 :skolemid |84|
 :pattern ( (Node__isolated ref@@4 wset@@4))
)))
...
(assert (forall ((ref@@5 T@U) (wset@@5 T@U) ) (!  (=> (and (= (type ref@@5) RefType) (= (type wset@@5) (MapType2Type RefType boolType))) (= (PredicateMaskField (Node__isolated ref@@5 wset@@5)) (|Node__isolated#sm| ref@@5 wset@@5)))
 :qid |stdinbpl.411:15|
 :skolemid |82|
 :pattern ( (PredicateMaskField (Node__isolated ref@@5 wset@@5)))
)))
...
(assert (forall ((arg0@@46 Int) (arg1@@26 Int) ) (! (= (type (|sk_Node__isolated#condqp1| arg0@@46 arg1@@26)) RefType)
 :qid |funType:sk_Node__isolated#condqp1|
 :pattern ( (|sk_Node__isolated#condqp1| arg0@@46 arg1@@26))
)))
(assert (forall ((Heap2Heap@@0 T@U) (Heap1Heap@@0 T@U) (ref@@6 T@U) (wset@@6 T@U) ) (!  (=> (and (and (and (and (= (type Heap2Heap@@0) (MapType0Type RefType)) (= (type Heap1Heap@@0) (MapType0Type RefType))) (= (type ref@@6) RefType)) (= (type wset@@6) (MapType2Type RefType boolType))) (and (=  (and (U_2_bool (MapType2Select wset@@6 (|sk_Node__isolated#condqp1| (|Node__isolated#condqp1| Heap2Heap@@0 ref@@6 wset@@6) (|Node__isolated#condqp1| Heap1Heap@@0 ref@@6 wset@@6)))) (< NoPerm FullPerm))  (and (U_2_bool (MapType2Select wset@@6 (|sk_Node__isolated#condqp1| (|Node__isolated#condqp1| Heap2Heap@@0 ref@@6 wset@@6) (|Node__isolated#condqp1| Heap1Heap@@0 ref@@6 wset@@6)))) (< NoPerm FullPerm))) (=> (and (U_2_bool (MapType2Select wset@@6 (|sk_Node__isolated#condqp1| (|Node__isolated#condqp1| Heap2Heap@@0 ref@@6 wset@@6) (|Node__isolated#condqp1| Heap1Heap@@0 ref@@6 wset@@6)))) (< NoPerm FullPerm)) (= (MapType0Select Heap2Heap@@0 (|sk_Node__isolated#condqp1| (|Node__isolated#condqp1| Heap2Heap@@0 ref@@6 wset@@6) (|Node__isolated#condqp1| Heap1Heap@@0 ref@@6 wset@@6)) data) (MapType0Select Heap1Heap@@0 (|sk_Node__isolated#condqp1| (|Node__isolated#condqp1| Heap2Heap@@0 ref@@6 wset@@6) (|Node__isolated#condqp1| Heap1Heap@@0 ref@@6 wset@@6)) data))))) (= (|Node__isolated#condqp1| Heap2Heap@@0 ref@@6 wset@@6) (|Node__isolated#condqp1| Heap1Heap@@0 ref@@6 wset@@6)))
 :qid |stdinbpl.445:15|
 :skolemid |88|
 :pattern ( (|Node__isolated#condqp1| Heap2Heap@@0 ref@@6 wset@@6) (|Node__isolated#condqp1| Heap1Heap@@0 ref@@6 wset@@6) (succHeapTrans Heap2Heap@@0 Heap1Heap@@0))
)))
...
(assert (forall ((p@@1 T@U) (v_1@@0 T@U) (q T@U) (w@@0 T@U) (r_2 T@U) (u T@U) ) (! (let ((C@@3 (FieldTypeInv0 (type r_2))))
(let ((B@@10 (FieldTypeInv0 (type q))))
(let ((A@@11 (FieldTypeInv0 (type p@@1))))
 (=> (and (and (and (and (and (and (= (type p@@1) (FieldType A@@11 FrameTypeType)) (= (type v_1@@0) FrameTypeType)) (= (type q) (FieldType B@@10 FrameTypeType))) (= (type w@@0) FrameTypeType)) (= (type r_2) (FieldType C@@3 FrameTypeType))) (= (type u) FrameTypeType)) (and (InsidePredicate p@@1 v_1@@0 q w@@0) (InsidePredicate q w@@0 r_2 u))) (InsidePredicate p@@1 v_1@@0 r_2 u)))))
 :qid |stdinbpl.195:25|
 :skolemid |20|
 :pattern ( (InsidePredicate p@@1 v_1@@0 q w@@0) (InsidePredicate q w@@0 r_2 u))
)))
...
(declare-fun invRecv4 (T@U T@U) T@U)
(declare-fun qpRange4 (T@U T@U) Bool)
...
(declare-fun invRecv6 (T@U T@U) T@U)
(declare-fun qpRange6 (T@U T@U) Bool)
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type x@@19) RefType)) (= (type x__wset) (MapType2Type RefType boolType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Heap@4) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@47 T@U) ) (! (= (type (invRecv3 arg0@@47)) RefType)
 :qid |funType:invRecv3|
 :pattern ( (invRecv3 arg0@@47))
))) (= (type Mask@1) (MapType1Type RefType realType))) (forall ((arg0@@48 T@U) (arg1@@27 T@U) ) (! (= (type (invRecv4 arg0@@48 arg1@@27)) RefType)
 :qid |funType:invRecv4|
 :pattern ( (invRecv4 arg0@@48 arg1@@27))
))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type QPMask@2) (MapType1Type RefType realType))) (forall ((arg0@@49 T@U) ) (! (= (type (invRecv5 arg0@@49)) RefType)
 :qid |funType:invRecv5|
 :pattern ( (invRecv5 arg0@@49))
))) (forall ((arg0@@50 T@U) (arg1@@28 T@U) ) (! (= (type (invRecv6 arg0@@50 arg1@@28)) RefType)
 :qid |funType:invRecv6|
 :pattern ( (invRecv6 arg0@@50 arg1@@28))
))) (= (type QPMask@3) (MapType1Type RefType realType))) (forall ((arg0@@51 T@U) (arg1@@29 T@U) ) (! (= (type (CombineFrames arg0@@51 arg1@@29)) FrameTypeType)
 :qid |funType:CombineFrames|
 :pattern ( (CombineFrames arg0@@51 arg1@@29))
...
(let ((anon9_Else_correct  (=> (HasDirectPerm Mask@2 null (Node__isolated x@@19 x__wset)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 3) 1)) anon6_correct))))
(let ((anon9_Then_correct  (=> (not (HasDirectPerm Mask@2 null (Node__isolated x@@19 x__wset))) (=> (and (and (= Heap@2 (MapType0Store Heap@1 null (|Node__isolated#sm| x@@19 x__wset) ZeroPMask)) (= Heap@3 (MapType0Store Heap@2 null (Node__isolated x@@19 x__wset) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 2) 1))) anon6_correct))))
(let ((anon4_correct  (and (=> (= (ControlFlow 0 4) (- 0 10)) (forall ((r@@5 T@U) (r_6 T@U) ) (!  (=> (and (= (type r@@5) RefType) (= (type r_6) RefType)) (=> (and (and (and (and (not (= r@@5 r_6)) (U_2_bool (MapType2Select x__wset r@@5))) (U_2_bool (MapType2Select x__wset r_6))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r@@5 r_6))))
 :qid |stdinbpl.610:15|
 :skolemid |102|
 :no-pattern (type r@@5)
 :no-pattern (type r_6)
 :no-pattern (U_2_int r@@5)
 :no-pattern (U_2_bool r@@5)
 :no-pattern (U_2_int r_6)
 :no-pattern (U_2_bool r_6)
))) (=> (forall ((r@@6 T@U) (r_6@@0 T@U) ) (!  (=> (and (= (type r@@6) RefType) (= (type r_6@@0) RefType)) (=> (and (and (and (and (not (= r@@6 r_6@@0)) (U_2_bool (MapType2Select x__wset r@@6))) (U_2_bool (MapType2Select x__wset r_6@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r@@6 r_6@@0))))
 :qid |stdinbpl.610:15|
 :skolemid |102|
 :no-pattern (type r@@6)
 :no-pattern (type r_6@@0)
 :no-pattern (U_2_int r@@6)
 :no-pattern (U_2_bool r@@6)
 :no-pattern (U_2_int r_6@@0)
 :no-pattern (U_2_bool r_6@@0)
)) (=> (and (forall ((r@@7 T@U) ) (!  (=> (= (type r@@7) RefType) (=> (and (U_2_bool (MapType2Select x__wset r@@7)) (< NoPerm FullPerm)) (and (qpRange3 r@@7) (= (invRecv3 r@@7) r@@7))))
 :qid |stdinbpl.616:22|
 :skolemid |103|
 :pattern ( (MapType0Select Heap@1 r@@7 data))
 :pattern ( (MapType1Select QPMask@0 r@@7 data))
 :pattern ( (MapType2Select x__wset r@@7))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select x__wset (invRecv3 o_3))) (< NoPerm FullPerm)) (qpRange3 o_3)) (= (invRecv3 o_3) o_3)))
 :qid |stdinbpl.620:22|
 :skolemid |104|
 :pattern ( (invRecv3 o_3))
))) (=> (and (and (forall ((r@@8 T@U) ) (!  (=> (and (= (type r@@8) RefType) (U_2_bool (MapType2Select x__wset r@@8))) (not (= r@@8 null)))
 :qid |stdinbpl.626:22|
 :skolemid |105|
 :pattern ( (MapType0Select Heap@1 r@@8 data))
 :pattern ( (MapType1Select QPMask@0 r@@8 data))
 :pattern ( (MapType2Select x__wset r@@8))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select x__wset (invRecv3 o_3@@0))) (< NoPerm FullPerm)) (qpRange3 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 data)) (+ (U_2_real (MapType1Select Mask@1 o_3@@0 data)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select x__wset (invRecv3 o_3@@0))) (< NoPerm FullPerm)) (qpRange3 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 data)) (U_2_real (MapType1Select Mask@1 o_3@@0 data))))))
 :qid |stdinbpl.632:22|
 :skolemid |106|
 :pattern ( (MapType1Select QPMask@0 o_3@@0 data))
))) (and (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 data))) (= (U_2_real (MapType1Select Mask@1 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.636:29|
 :skolemid |107|
 :pattern ( (MapType1Select Mask@1 o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
)) (state Heap@1 QPMask@0))) (and (=> (= (ControlFlow 0 4) (- 0 9)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (U_2_bool (MapType2Select x__wset r_1))) (U_2_bool (MapType2Select x__wset r_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= r_1 r_1_1)) (not (= x__wset x__wset)))))
 :qid |stdinbpl.646:17|
 :skolemid |108|
 :pattern ( (neverTriggered4 r_1) (neverTriggered4 r_1_1))
))) (=> (forall ((r_1@@0 T@U) (r_1_1@@0 T@U) ) (!  (=> (and (= (type r_1@@0) RefType) (= (type r_1_1@@0) RefType)) (=> (and (and (and (and (not (= r_1@@0 r_1_1@@0)) (U_2_bool (MapType2Select x__wset r_1@@0))) (U_2_bool (MapType2Select x__wset r_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= r_1@@0 r_1_1@@0)) (not (= x__wset x__wset)))))
 :qid |stdinbpl.646:17|
 :skolemid |108|
 :pattern ( (neverTriggered4 r_1@@0) (neverTriggered4 r_1_1@@0))
)) (=> (and (and (and (forall ((r_1@@1 T@U) ) (!  (=> (= (type r_1@@1) RefType) (=> (and (U_2_bool (MapType2Select x__wset r_1@@1)) (< NoPerm FullPerm)) (and (= (invRecv4 r_1@@1 x__wset) r_1@@1) (qpRange4 r_1@@1 x__wset))))
 :qid |stdinbpl.652:22|
 :skolemid |109|
 :pattern ( (MapType0Select Heap@1 null (Node__isolated r_1@@1 x__wset)))
 :pattern ( (MapType1Select QPMask@0 null (Node__isolated r_1@@1 x__wset)))
 :pattern ( (MapType2Select x__wset r_1@@1))
)) (forall ((ref@@7 T@U) (wset@@7 T@U) ) (!  (=> (and (= (type ref@@7) RefType) (= (type wset@@7) (MapType2Type RefType boolType))) (=> (and (and (U_2_bool (MapType2Select x__wset (invRecv4 ref@@7 wset@@7))) (< NoPerm FullPerm)) (qpRange4 ref@@7 wset@@7)) (and (= (invRecv4 ref@@7 wset@@7) ref@@7) (= x__wset wset@@7))))
 :qid |stdinbpl.656:22|
 :skolemid |110|
 :pattern ( (invRecv4 ref@@7 wset@@7))
))) (and (forall ((ref@@8 T@U) (wset@@8 T@U) ) (!  (=> (and (= (type ref@@8) RefType) (= (type wset@@8) (MapType2Type RefType boolType))) (=> (and (and (U_2_bool (MapType2Select x__wset (invRecv4 ref@@8 wset@@8))) (< NoPerm FullPerm)) (qpRange4 ref@@8 wset@@8)) (and (=> (< NoPerm FullPerm) (and (= (invRecv4 ref@@8 wset@@8) ref@@8) (= x__wset wset@@8))) (= (U_2_real (MapType1Select QPMask@1 null (Node__isolated ref@@8 wset@@8))) (+ (U_2_real (MapType1Select QPMask@0 null (Node__isolated ref@@8 wset@@8))) FullPerm)))))
 :qid |stdinbpl.662:22|
 :skolemid |111|
 :pattern ( (MapType1Select QPMask@1 null (Node__isolated ref@@8 wset@@8)))
)) (forall ((o_3@@2 T@U) (f_5@@0 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_5@@0))))
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@2) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (or (or (not (= o_3@@2 null)) (not (IsPredicateField f_5@@0))) (not (= (getPredWandId f_5@@0) 0)))) (= (U_2_real (MapType1Select QPMask@0 o_3@@2 f_5@@0)) (U_2_real (MapType1Select QPMask@1 o_3@@2 f_5@@0))))))
 :qid |stdinbpl.668:29|
 :skolemid |112|
 :pattern ( (MapType1Select QPMask@0 o_3@@2 f_5@@0))
 :pattern ( (MapType1Select QPMask@1 o_3@@2 f_5@@0))
)))) (and (and (forall ((ref@@9 T@U) (wset@@9 T@U) ) (!  (=> (and (and (= (type ref@@9) RefType) (= (type wset@@9) (MapType2Type RefType boolType))) (not (and (and (U_2_bool (MapType2Select x__wset (invRecv4 ref@@9 wset@@9))) (< NoPerm FullPerm)) (qpRange4 ref@@9 wset@@9)))) (= (U_2_real (MapType1Select QPMask@1 null (Node__isolated ref@@9 wset@@9))) (U_2_real (MapType1Select QPMask@0 null (Node__isolated ref@@9 wset@@9)))))
 :qid |stdinbpl.672:22|
 :skolemid |113|
 :pattern ( (MapType1Select QPMask@1 null (Node__isolated ref@@9 wset@@9)))
)) (state Heap@1 QPMask@1)) (and (state Heap@1 QPMask@1) (state Heap@1 QPMask@1)))) (and (=> (= (ControlFlow 0 4) (- 0 8)) (forall ((r_3 T@U) (r_3_1 T@U) ) (!  (=> (and (= (type r_3) RefType) (= (type r_3_1) RefType)) (=> (and (and (and (and (not (= r_3 r_3_1)) (U_2_bool (MapType2Select x__wset r_3))) (U_2_bool (MapType2Select x__wset r_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_3 r_3_1))))
 :qid |stdinbpl.691:17|
 :skolemid |114|
 :pattern ( (neverTriggered5 r_3) (neverTriggered5 r_3_1))
))) (=> (forall ((r_3@@0 T@U) (r_3_1@@0 T@U) ) (!  (=> (and (= (type r_3@@0) RefType) (= (type r_3_1@@0) RefType)) (=> (and (and (and (and (not (= r_3@@0 r_3_1@@0)) (U_2_bool (MapType2Select x__wset r_3@@0))) (U_2_bool (MapType2Select x__wset r_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_3@@0 r_3_1@@0))))
 :qid |stdinbpl.691:17|
 :skolemid |114|
 :pattern ( (neverTriggered5 r_3@@0) (neverTriggered5 r_3_1@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 7)) (forall ((r_3@@1 T@U) ) (!  (=> (and (= (type r_3@@1) RefType) (U_2_bool (MapType2Select x__wset r_3@@1))) (>= (U_2_real (MapType1Select QPMask@1 r_3@@1 data)) FullPerm))
 :qid |stdinbpl.698:17|
 :skolemid |115|
 :pattern ( (MapType0Select Heap@1 r_3@@1 data))
 :pattern ( (MapType1Select QPMask@2 r_3@@1 data))
 :pattern ( (MapType2Select x__wset r_3@@1))
))) (=> (forall ((r_3@@2 T@U) ) (!  (=> (and (= (type r_3@@2) RefType) (U_2_bool (MapType2Select x__wset r_3@@2))) (>= (U_2_real (MapType1Select QPMask@1 r_3@@2 data)) FullPerm))
 :qid |stdinbpl.698:17|
 :skolemid |115|
 :pattern ( (MapType0Select Heap@1 r_3@@2 data))
 :pattern ( (MapType1Select QPMask@2 r_3@@2 data))
 :pattern ( (MapType2Select x__wset r_3@@2))
)) (=> (and (and (forall ((r_3@@3 T@U) ) (!  (=> (= (type r_3@@3) RefType) (=> (and (U_2_bool (MapType2Select x__wset r_3@@3)) (< NoPerm FullPerm)) (and (qpRange5 r_3@@3) (= (invRecv5 r_3@@3) r_3@@3))))
 :qid |stdinbpl.704:22|
 :skolemid |116|
 :pattern ( (MapType0Select Heap@1 r_3@@3 data))
 :pattern ( (MapType1Select QPMask@2 r_3@@3 data))
 :pattern ( (MapType2Select x__wset r_3@@3))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (=> (and (U_2_bool (MapType2Select x__wset (invRecv5 o_3@@3))) (and (< NoPerm FullPerm) (qpRange5 o_3@@3))) (= (invRecv5 o_3@@3) o_3@@3)))
 :qid |stdinbpl.708:22|
 :skolemid |117|
 :pattern ( (invRecv5 o_3@@3))
))) (and (forall ((o_3@@4 T@U) ) (!  (=> (= (type o_3@@4) RefType) (and (=> (and (U_2_bool (MapType2Select x__wset (invRecv5 o_3@@4))) (and (< NoPerm FullPerm) (qpRange5 o_3@@4))) (and (= (invRecv5 o_3@@4) o_3@@4) (= (U_2_real (MapType1Select QPMask@2 o_3@@4 data)) (- (U_2_real (MapType1Select QPMask@1 o_3@@4 data)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select x__wset (invRecv5 o_3@@4))) (and (< NoPerm FullPerm) (qpRange5 o_3@@4)))) (= (U_2_real (MapType1Select QPMask@2 o_3@@4 data)) (U_2_real (MapType1Select QPMask@1 o_3@@4 data))))))
 :qid |stdinbpl.714:22|
 :skolemid |118|
 :pattern ( (MapType1Select QPMask@2 o_3@@4 data))
)) (forall ((o_3@@5 T@U) (f_5@@1 T@U) ) (! (let ((B@@13 (FieldTypeInv1 (type f_5@@1))))
(let ((A@@14 (FieldTypeInv0 (type f_5@@1))))
 (=> (and (and (= (type o_3@@5) RefType) (= (type f_5@@1) (FieldType A@@14 B@@13))) (not (= f_5@@1 data))) (= (U_2_real (MapType1Select QPMask@1 o_3@@5 f_5@@1)) (U_2_real (MapType1Select QPMask@2 o_3@@5 f_5@@1))))))
 :qid |stdinbpl.720:29|
 :skolemid |119|
 :pattern ( (MapType1Select QPMask@2 o_3@@5 f_5@@1))
)))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((r_4 T@U) (r_4_1 T@U) ) (!  (=> (and (= (type r_4) RefType) (= (type r_4_1) RefType)) (=> (and (and (and (and (not (= r_4 r_4_1)) (U_2_bool (MapType2Select x__wset r_4))) (U_2_bool (MapType2Select x__wset r_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= r_4 r_4_1)) (not (= x__wset x__wset)))))
 :qid |stdinbpl.732:17|
 :skolemid |120|
 :pattern ( (neverTriggered6 r_4) (neverTriggered6 r_4_1))
))) (=> (forall ((r_4@@0 T@U) (r_4_1@@0 T@U) ) (!  (=> (and (= (type r_4@@0) RefType) (= (type r_4_1@@0) RefType)) (=> (and (and (and (and (not (= r_4@@0 r_4_1@@0)) (U_2_bool (MapType2Select x__wset r_4@@0))) (U_2_bool (MapType2Select x__wset r_4_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= r_4@@0 r_4_1@@0)) (not (= x__wset x__wset)))))
 :qid |stdinbpl.732:17|
 :skolemid |120|
 :pattern ( (neverTriggered6 r_4@@0) (neverTriggered6 r_4_1@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((r_4@@1 T@U) ) (!  (=> (and (= (type r_4@@1) RefType) (U_2_bool (MapType2Select x__wset r_4@@1))) (>= (U_2_real (MapType1Select QPMask@2 null (Node__isolated r_4@@1 x__wset))) FullPerm))
 :qid |stdinbpl.739:17|
 :skolemid |121|
 :pattern ( (MapType0Select Heap@1 null (Node__isolated r_4@@1 x__wset)))
 :pattern ( (MapType1Select QPMask@2 null (Node__isolated r_4@@1 x__wset)))
 :pattern ( (MapType2Select x__wset r_4@@1))
))) (=> (forall ((r_4@@2 T@U) ) (!  (=> (and (= (type r_4@@2) RefType) (U_2_bool (MapType2Select x__wset r_4@@2))) (>= (U_2_real (MapType1Select QPMask@2 null (Node__isolated r_4@@2 x__wset))) FullPerm))
 :qid |stdinbpl.739:17|
 :skolemid |121|
 :pattern ( (MapType0Select Heap@1 null (Node__isolated r_4@@2 x__wset)))
 :pattern ( (MapType1Select QPMask@2 null (Node__isolated r_4@@2 x__wset)))
 :pattern ( (MapType2Select x__wset r_4@@2))
)) (=> (and (forall ((r_4@@3 T@U) ) (!  (=> (= (type r_4@@3) RefType) (=> (and (U_2_bool (MapType2Select x__wset r_4@@3)) (< NoPerm FullPerm)) (and (= (invRecv6 r_4@@3 x__wset) r_4@@3) (qpRange6 r_4@@3 x__wset))))
 :qid |stdinbpl.745:22|
 :skolemid |122|
 :pattern ( (MapType0Select Heap@1 null (Node__isolated r_4@@3 x__wset)))
 :pattern ( (MapType1Select QPMask@2 null (Node__isolated r_4@@3 x__wset)))
 :pattern ( (MapType2Select x__wset r_4@@3))
)) (forall ((ref_1 T@U) (wset_1 T@U) ) (!  (=> (and (= (type ref_1) RefType) (= (type wset_1) (MapType2Type RefType boolType))) (=> (and (and (U_2_bool (MapType2Select x__wset (invRecv6 ref_1 wset_1))) (< NoPerm FullPerm)) (qpRange6 ref_1 wset_1)) (and (= (invRecv6 ref_1 wset_1) ref_1) (= x__wset wset_1))))
 :qid |stdinbpl.749:22|
 :skolemid |123|
 :pattern ( (invRecv6 ref_1 wset_1))
))) (=> (and (and (and (forall ((ref_1@@0 T@U) (wset_1@@0 T@U) ) (!  (=> (and (= (type ref_1@@0) RefType) (= (type wset_1@@0) (MapType2Type RefType boolType))) (=> (and (and (U_2_bool (MapType2Select x__wset (invRecv6 ref_1@@0 wset_1@@0))) (< NoPerm FullPerm)) (qpRange6 ref_1@@0 wset_1@@0)) (and (and (= (invRecv6 ref_1@@0 wset_1@@0) ref_1@@0) (= x__wset wset_1@@0)) (= (U_2_real (MapType1Select QPMask@3 null (Node__isolated ref_1@@0 wset_1@@0))) (- (U_2_real (MapType1Select QPMask@2 null (Node__isolated ref_1@@0 wset_1@@0))) FullPerm)))))
 :qid |stdinbpl.755:22|
 :skolemid |124|
 :pattern ( (MapType1Select QPMask@3 null (Node__isolated ref_1@@0 wset_1@@0)))
)) (forall ((ref_1@@1 T@U) (wset_1@@1 T@U) ) (!  (=> (and (and (= (type ref_1@@1) RefType) (= (type wset_1@@1) (MapType2Type RefType boolType))) (not (and (and (U_2_bool (MapType2Select x__wset (invRecv6 ref_1@@1 wset_1@@1))) (< NoPerm FullPerm)) (qpRange6 ref_1@@1 wset_1@@1)))) (= (U_2_real (MapType1Select QPMask@3 null (Node__isolated ref_1@@1 wset_1@@1))) (U_2_real (MapType1Select QPMask@2 null (Node__isolated ref_1@@1 wset_1@@1)))))
 :qid |stdinbpl.759:22|
 :skolemid |125|
 :pattern ( (MapType1Select QPMask@3 null (Node__isolated ref_1@@1 wset_1@@1)))
))) (and (forall ((o_3@@6 T@U) (f_5@@2 T@U) ) (! (let ((B@@14 (FieldTypeInv1 (type f_5@@2))))
...
)) (= Mask@2 (MapType1Store QPMask@3 null (Node__isolated x@@19 x__wset) (real_2_U (+ (U_2_real (MapType1Select QPMask@3 null (Node__isolated x@@19 x__wset))) FullPerm)))))) (and (and (state Heap@1 Mask@2) (state Heap@1 Mask@2)) (and (|Node__isolated#trigger| Heap@1 (Node__isolated x@@19 x__wset)) (= (MapType0Select Heap@1 null (Node__isolated x@@19 x__wset)) (CombineFrames (FrameFragment (int_2_U (|Node__isolated#condqp1| Heap@1 x@@19 x__wset))) (FrameFragment (int_2_U (|Node__isolated#condqp2| Heap@1 x@@19 x__wset)))))))) (and (=> (= (ControlFlow 0 4) 2) anon9_Then_correct) (=> (= (ControlFlow 0 4) 3) anon9_Else_correct))))))))))))))))))))))
(let ((anon8_Else_correct  (=> (HasDirectPerm Mask@1 null (Node__isolated x@@19 x__wset)) (=> (and (= Heap@1 Heap@@10) (= (ControlFlow 0 12) 4)) anon4_correct))))
(let ((anon8_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (Node__isolated x@@19 x__wset))) (= Heap@0 (MapType0Store Heap@@10 null (Node__isolated x@@19 x__wset) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 11) 4))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (Node__isolated x@@19 x__wset) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (Node__isolated x@@19 x__wset))) FullPerm)))) (and (=> (= (ControlFlow 0 13) 11) anon8_Then_correct) (=> (= (ControlFlow 0 13) 12) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 13)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Node__isolated x@@19 x__wset))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Node__isolated x@@19 x__wset)))) (=> (= (ControlFlow 0 14) 13) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 x@@19 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (Node__isolated x@@19 x__wset) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Node__isolated x@@19 x__wset))) FullPerm))))) (=> (and (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (|Node__isolated#trigger| Heap@@10 (Node__isolated x@@19 x__wset)) (= (MapType0Select Heap@@10 null (Node__isolated x@@19 x__wset)) (CombineFrames (FrameFragment (int_2_U (|Node__isolated#condqp1| Heap@@10 x@@19 x__wset))) (FrameFragment (int_2_U (|Node__isolated#condqp2| Heap@@10 x@@19 x__wset))))))) (and (=> (= (ControlFlow 0 17) 14) anon7_Then_correct) (=> (= (ControlFlow 0 17) 16) anon7_Else_correct)))))))
