...
(assert  (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type diz@@5) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |token#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@14 diz@@5 $allocated))) (=> (and (and (> wildcard@0 NoPerm) (not (= diz@@5 null))) (and (= Mask@0 (MapType1Store ZeroMask diz@@5 unknown_x (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz@@5 unknown_x)) wildcard@0)))) (state Heap@@14 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@0 diz@@5 unknown_x)) (=> (HasDirectPerm Mask@0 diz@@5 unknown_x) (=> (<= NoPerm (unknown (U_2_int (MapType0Select Heap@@14 diz@@5 unknown_x)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 diz@@5 unknown_x)) (=> (HasDirectPerm Mask@0 diz@@5 unknown_x) (=> (and (= perm@0 (unknown (U_2_int (MapType0Select Heap@@14 diz@@5 unknown_x)))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@0 NoPerm))))))))))))
