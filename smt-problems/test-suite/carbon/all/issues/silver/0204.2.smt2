...
(declare-fun g2 (Int T@U) Bool)
(declare-fun b_19@0 () Bool)
(declare-fun b_18@0 () Bool)
(declare-fun b_18 () Bool)
(declare-fun Used_12Heap@0 () T@U)
(assert  (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type Ops_13Heap@0) (MapType0Type RefType))) (= (type Used_13Heap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type Used_12Heap@0) (MapType0Type RefType))))
...
(let ((anon13_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (wand_7 true)))))))
(let ((anon5_correct  (=> (= b_19@2  (and b_19 (state Ops_13Heap@0 ZeroMask))) (=> (and (= b_19@3  (and b_19@2 (state Ops_13Heap@0 ZeroMask))) (= b_20@0  (and b_20 (state Used_13Heap@0 ZeroMask)))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (wand_6 true) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (wand_6 true))) FullPerm)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (and (=> (= (ControlFlow 0 5) 2) anon13_Else_correct) (=> (= (ControlFlow 0 5) 3) anon14_Then_correct)) (=> (= (ControlFlow 0 5) 4) anon14_Else_correct)))))))
(let ((anon4_correct  (=> (and (= b_19@1  (and b_19 (forall ((x_3 Int) (y_3 T@U) ) (!  (=> (= (type y_3) RefType) (g2 x_3 y_3))
 :qid |stdinbpl.1651:31|
 :skolemid |164|
 :pattern ( (g2 x_3 y_3))
)))) (= (ControlFlow 0 7) 5)) anon5_correct)))
(let ((anon11_Else_correct  (=> (and (not b_19@0) (= (ControlFlow 0 9) 7)) anon4_correct)))
(let ((anon11_Then_correct  (=> (and b_19@0 (= (ControlFlow 0 8) 7)) anon4_correct)))
(let ((anon10_Then_correct  (=> b_19@0 (and (=> (= (ControlFlow 0 10) 8) anon11_Then_correct) (=> (= (ControlFlow 0 10) 9) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (not b_19@0) (= (ControlFlow 0 6) 5)) anon5_correct)))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= b_19@0  (and b_19 (state Ops_13Heap@0 ZeroMask))) (= b_18@0  (and b_18 (state Used_12Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 11) 10) anon10_Then_correct) (=> (= (ControlFlow 0 11) 6) anon10_Else_correct))))))
