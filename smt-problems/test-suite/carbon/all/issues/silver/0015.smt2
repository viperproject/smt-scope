...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type b_2) (FieldType NormalFieldType boolType))) (= (type f_7) (FieldType NormalFieldType intType))))
...
(assert  (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type x@@8) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (U_2_bool (MapType0Select Heap@@9 x@@8 b_2)) (=> (and (= Mask@2 Mask@0) (= (ControlFlow 0 3) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (and (not (U_2_bool (MapType0Select Heap@@9 x@@8 b_2))) (not (= x@@8 null))) (=> (and (and (= Mask@1 (MapType1Store Mask@0 x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@8 f_7)) FullPerm)))) (state Heap@@9 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 2) 1))) anon2_correct))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (=> (and (and (not (= x@@8 null)) (= Mask@0 (MapType1Store ZeroMask x@@8 b_2 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 b_2)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@0 x@@8 b_2)) (=> (HasDirectPerm Mask@0 x@@8 b_2) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))))
