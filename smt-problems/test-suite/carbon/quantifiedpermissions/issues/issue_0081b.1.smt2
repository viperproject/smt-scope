...
(declare-fun z@@0 () T@U)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type xs) (MapType2Type RefType boolType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type ExhaleHeap@1) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv9 arg0@@43)) RefType)
 :qid |funType:invRecv9|
 :pattern ( (invRecv9 arg0@@43))
))) (= (type ExhaleHeap@2) (MapType0Type RefType))) (= (type QPMask@3) (MapType1Type RefType realType))) (= (type y@@6) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv8 arg0@@44)) RefType)
 :qid |funType:invRecv8|
 :pattern ( (invRecv8 arg0@@44))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type PostHeap@0) (MapType0Type RefType))) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv5 arg0@@45)) RefType)
 :qid |funType:invRecv5|
 :pattern ( (invRecv5 arg0@@45))
))) (= (type z@@0) RefType)))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 29) (let ((anon15_Else_correct  (=> (= (ControlFlow 0 24) (- 0 23)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (U_2_bool (MapType2Select xs x_3))) (U_2_bool (MapType2Select xs x_3_1))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_3 x_3_1))))
 :qid |stdinbpl.721:15|
 :skolemid |115|
 :no-pattern (type x_3)
...
(let ((anon18_Else_correct  (=> (> wildcard@2 0.0) (and (=> (= (ControlFlow 0 5) (- 0 12)) (forall ((x_8 T@U) ) (!  (=> (and (= (type x_8) RefType) (U_2_bool (MapType2Select xs x_8))) (> (U_2_real (MapType1Select QPMask@1 x_8 f_7)) NoPerm))
 :qid |stdinbpl.861:15|
 :skolemid |130|
 :no-pattern (type x_8)
 :no-pattern (U_2_int x_8)
 :no-pattern (U_2_bool x_8)
))) (=> (forall ((x_8@@0 T@U) ) (!  (=> (and (= (type x_8@@0) RefType) (U_2_bool (MapType2Select xs x_8@@0))) (> (U_2_real (MapType1Select QPMask@1 x_8@@0 f_7)) NoPerm))
 :qid |stdinbpl.861:15|
 :skolemid |130|
 :no-pattern (type x_8@@0)
 :no-pattern (U_2_int x_8@@0)
 :no-pattern (U_2_bool x_8@@0)
)) (=> (forall ((x_8@@1 T@U) ) (!  (=> (and (= (type x_8@@1) RefType) (U_2_bool (MapType2Select xs x_8@@1))) (< wildcard@2 (U_2_real (MapType1Select QPMask@1 x_8@@1 f_7))))
 :qid |stdinbpl.865:20|
 :skolemid |131|
 :no-pattern (type x_8@@1)
 :no-pattern (U_2_int x_8@@1)
 :no-pattern (U_2_bool x_8@@1)
)) (and (=> (= (ControlFlow 0 5) (- 0 11)) (forall ((x_8@@2 T@U) ) (!  (=> (= (type x_8@@2) RefType) (=> (and (U_2_bool (MapType2Select xs x_8@@2)) (dummyFunction (MapType0Select ExhaleHeap@1 x_8@@2 f_7))) (>= wildcard@2 NoPerm)))
 :qid |stdinbpl.872:17|
 :skolemid |132|
 :pattern ( (MapType0Select ExhaleHeap@1 x_8@@2 f_7))
 :pattern ( (MapType1Select QPMask@2 x_8@@2 f_7))
 :pattern ( (MapType2Select xs x_8@@2))
))) (=> (forall ((x_8@@3 T@U) ) (!  (=> (= (type x_8@@3) RefType) (=> (and (U_2_bool (MapType2Select xs x_8@@3)) (dummyFunction (MapType0Select ExhaleHeap@1 x_8@@3 f_7))) (>= wildcard@2 NoPerm)))
 :qid |stdinbpl.872:17|
 :skolemid |132|
 :pattern ( (MapType0Select ExhaleHeap@1 x_8@@3 f_7))
 :pattern ( (MapType1Select QPMask@2 x_8@@3 f_7))
 :pattern ( (MapType2Select xs x_8@@3))
)) (and (=> (= (ControlFlow 0 5) (- 0 10)) (forall ((x_8@@4 T@U) (x_8_1 T@U) ) (!  (=> (and (= (type x_8@@4) RefType) (= (type x_8_1) RefType)) (=> (and (and (and (and (not (= x_8@@4 x_8_1)) (U_2_bool (MapType2Select xs x_8@@4))) (U_2_bool (MapType2Select xs x_8_1))) (< NoPerm wildcard@2)) (< NoPerm wildcard@2)) (not (= x_8@@4 x_8_1))))
 :qid |stdinbpl.879:17|
 :skolemid |133|
 :pattern ( (neverTriggered9 x_8@@4) (neverTriggered9 x_8_1))
))) (=> (forall ((x_8@@5 T@U) (x_8_1@@0 T@U) ) (!  (=> (and (= (type x_8@@5) RefType) (= (type x_8_1@@0) RefType)) (=> (and (and (and (and (not (= x_8@@5 x_8_1@@0)) (U_2_bool (MapType2Select xs x_8@@5))) (U_2_bool (MapType2Select xs x_8_1@@0))) (< NoPerm wildcard@2)) (< NoPerm wildcard@2)) (not (= x_8@@5 x_8_1@@0))))
 :qid |stdinbpl.879:17|
 :skolemid |133|
 :pattern ( (neverTriggered9 x_8@@5) (neverTriggered9 x_8_1@@0))
)) (and (=> (= (ControlFlow 0 5) (- 0 9)) (forall ((x_8@@6 T@U) ) (!  (=> (and (= (type x_8@@6) RefType) (U_2_bool (MapType2Select xs x_8@@6))) (> (U_2_real (MapType1Select QPMask@1 x_8@@6 f_7)) NoPerm))
 :qid |stdinbpl.886:17|
 :skolemid |134|
 :pattern ( (MapType0Select ExhaleHeap@1 x_8@@6 f_7))
 :pattern ( (MapType1Select QPMask@2 x_8@@6 f_7))
 :pattern ( (MapType2Select xs x_8@@6))
))) (=> (forall ((x_8@@7 T@U) ) (!  (=> (and (= (type x_8@@7) RefType) (U_2_bool (MapType2Select xs x_8@@7))) (> (U_2_real (MapType1Select QPMask@1 x_8@@7 f_7)) NoPerm))
 :qid |stdinbpl.886:17|
 :skolemid |134|
 :pattern ( (MapType0Select ExhaleHeap@1 x_8@@7 f_7))
 :pattern ( (MapType1Select QPMask@2 x_8@@7 f_7))
 :pattern ( (MapType2Select xs x_8@@7))
)) (=> (forall ((x_8@@8 T@U) ) (!  (=> (= (type x_8@@8) RefType) (=> (and (U_2_bool (MapType2Select xs x_8@@8)) (< NoPerm wildcard@2)) (and (qpRange9 x_8@@8) (= (invRecv9 x_8@@8) x_8@@8))))
 :qid |stdinbpl.892:22|
 :skolemid |135|
 :pattern ( (MapType0Select ExhaleHeap@1 x_8@@8 f_7))
 :pattern ( (MapType1Select QPMask@2 x_8@@8 f_7))
 :pattern ( (MapType2Select xs x_8@@8))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType2Select xs (invRecv9 o_3))) (and (< NoPerm wildcard@2) (qpRange9 o_3))) (= (invRecv9 o_3) o_3)))
 :qid |stdinbpl.896:22|
 :skolemid |136|
 :pattern ( (invRecv9 o_3))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType2Select xs (invRecv9 o_3@@0))) (and (< NoPerm wildcard@2) (qpRange9 o_3@@0))) (and (= (invRecv9 o_3@@0) o_3@@0) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (- (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) wildcard@2)))) (=> (not (and (U_2_bool (MapType2Select xs (invRecv9 o_3@@0))) (and (< NoPerm wildcard@2) (qpRange9 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7))))))
 :qid |stdinbpl.902:22|
 :skolemid |137|
...
)) (IdenticalOnKnownLocations ExhaleHeap@1 ExhaleHeap@2 QPMask@2)) (and (state ExhaleHeap@2 QPMask@2) (> wildcard@3 0.0))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (forall ((x_4 T@U) ) (!  (=> (and (= (type x_4) RefType) (U_2_bool (MapType2Select xs x_4))) (> (U_2_real (MapType1Select QPMask@2 x_4 f_7)) NoPerm))
 :qid |stdinbpl.926:15|
 :skolemid |139|
 :no-pattern (type x_4)
 :no-pattern (U_2_int x_4)
 :no-pattern (U_2_bool x_4)
))) (=> (forall ((x_4@@0 T@U) ) (!  (=> (and (= (type x_4@@0) RefType) (U_2_bool (MapType2Select xs x_4@@0))) (> (U_2_real (MapType1Select QPMask@2 x_4@@0 f_7)) NoPerm))
 :qid |stdinbpl.926:15|
 :skolemid |139|
 :no-pattern (type x_4@@0)
 :no-pattern (U_2_int x_4@@0)
 :no-pattern (U_2_bool x_4@@0)
)) (=> (forall ((x_4@@1 T@U) ) (!  (=> (and (= (type x_4@@1) RefType) (U_2_bool (MapType2Select xs x_4@@1))) (< wildcard@3 (U_2_real (MapType1Select QPMask@2 x_4@@1 f_7))))
 :qid |stdinbpl.930:20|
 :skolemid |140|
 :no-pattern (type x_4@@1)
 :no-pattern (U_2_int x_4@@1)
 :no-pattern (U_2_bool x_4@@1)
)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (forall ((x_4@@2 T@U) ) (!  (=> (= (type x_4@@2) RefType) (=> (and (U_2_bool (MapType2Select xs x_4@@2)) (dummyFunction (MapType0Select ExhaleHeap@2 x_4@@2 f_7))) (>= wildcard@3 NoPerm)))
 :qid |stdinbpl.937:17|
 :skolemid |141|
 :pattern ( (MapType0Select ExhaleHeap@2 x_4@@2 f_7))
 :pattern ( (MapType1Select QPMask@3 x_4@@2 f_7))
 :pattern ( (MapType2Select xs x_4@@2))
))) (=> (forall ((x_4@@3 T@U) ) (!  (=> (= (type x_4@@3) RefType) (=> (and (U_2_bool (MapType2Select xs x_4@@3)) (dummyFunction (MapType0Select ExhaleHeap@2 x_4@@3 f_7))) (>= wildcard@3 NoPerm)))
 :qid |stdinbpl.937:17|
 :skolemid |141|
 :pattern ( (MapType0Select ExhaleHeap@2 x_4@@3 f_7))
 :pattern ( (MapType1Select QPMask@3 x_4@@3 f_7))
 :pattern ( (MapType2Select xs x_4@@3))
)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((x_4@@4 T@U) (x_4_1 T@U) ) (!  (=> (and (= (type x_4@@4) RefType) (= (type x_4_1) RefType)) (=> (and (and (and (and (not (= x_4@@4 x_4_1)) (U_2_bool (MapType2Select xs x_4@@4))) (U_2_bool (MapType2Select xs x_4_1))) (< NoPerm wildcard@3)) (< NoPerm wildcard@3)) (not (= x_4@@4 x_4_1))))
 :qid |stdinbpl.944:17|
 :skolemid |142|
 :pattern ( (neverTriggered7 x_4@@4) (neverTriggered7 x_4_1))
))) (=> (forall ((x_4@@5 T@U) (x_4_1@@0 T@U) ) (!  (=> (and (= (type x_4@@5) RefType) (= (type x_4_1@@0) RefType)) (=> (and (and (and (and (not (= x_4@@5 x_4_1@@0)) (U_2_bool (MapType2Select xs x_4@@5))) (U_2_bool (MapType2Select xs x_4_1@@0))) (< NoPerm wildcard@3)) (< NoPerm wildcard@3)) (not (= x_4@@5 x_4_1@@0))))
 :qid |stdinbpl.944:17|
 :skolemid |142|
 :pattern ( (neverTriggered7 x_4@@5) (neverTriggered7 x_4_1@@0))
)) (=> (= (ControlFlow 0 5) (- 0 4)) (forall ((x_4@@6 T@U) ) (!  (=> (and (= (type x_4@@6) RefType) (U_2_bool (MapType2Select xs x_4@@6))) (> (U_2_real (MapType1Select QPMask@2 x_4@@6 f_7)) NoPerm))
 :qid |stdinbpl.951:17|
 :skolemid |143|
 :pattern ( (MapType0Select ExhaleHeap@2 x_4@@6 f_7))
 :pattern ( (MapType1Select QPMask@3 x_4@@6 f_7))
 :pattern ( (MapType2Select xs x_4@@6))
)))))))))))))))))))))))))
(let ((anon18_Then_correct true))
(let ((anon17_Else_correct  (=> (> wildcard@1 0.0) (and (=> (= (ControlFlow 0 13) (- 0 17)) (forall ((x_6 T@U) ) (!  (=> (and (= (type x_6) RefType) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_6))) (> (U_2_real (MapType1Select Mask@1 x_6 f_7)) NoPerm))
 :qid |stdinbpl.791:15|
 :skolemid |121|
 :no-pattern (type x_6)
 :no-pattern (U_2_int x_6)
 :no-pattern (U_2_bool x_6)
))) (=> (forall ((x_6@@0 T@U) ) (!  (=> (and (= (type x_6@@0) RefType) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_6@@0))) (> (U_2_real (MapType1Select Mask@1 x_6@@0 f_7)) NoPerm))
 :qid |stdinbpl.791:15|
 :skolemid |121|
 :no-pattern (type x_6@@0)
 :no-pattern (U_2_int x_6@@0)
 :no-pattern (U_2_bool x_6@@0)
)) (=> (forall ((x_6@@1 T@U) ) (!  (=> (and (= (type x_6@@1) RefType) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_6@@1))) (< wildcard@1 (U_2_real (MapType1Select Mask@1 x_6@@1 f_7))))
 :qid |stdinbpl.795:20|
 :skolemid |122|
 :no-pattern (type x_6@@1)
 :no-pattern (U_2_int x_6@@1)
 :no-pattern (U_2_bool x_6@@1)
)) (and (=> (= (ControlFlow 0 13) (- 0 16)) (forall ((x_6@@2 T@U) ) (!  (=> (= (type x_6@@2) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_6@@2)) (dummyFunction (MapType0Select Heap@0 x_6@@2 f_7))) (>= wildcard@1 NoPerm)))
 :qid |stdinbpl.802:17|
 :skolemid |123|
 :pattern ( (MapType0Select Heap@0 x_6@@2 f_7))
 :pattern ( (MapType1Select QPMask@1 x_6@@2 f_7))
 :pattern ( (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_6@@2))
))) (=> (forall ((x_6@@3 T@U) ) (!  (=> (= (type x_6@@3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_6@@3)) (dummyFunction (MapType0Select Heap@0 x_6@@3 f_7))) (>= wildcard@1 NoPerm)))
 :qid |stdinbpl.802:17|
 :skolemid |123|
 :pattern ( (MapType0Select Heap@0 x_6@@3 f_7))
 :pattern ( (MapType1Select QPMask@1 x_6@@3 f_7))
 :pattern ( (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_6@@3))
)) (and (=> (= (ControlFlow 0 13) (- 0 15)) (forall ((x_6@@4 T@U) (x_6_1 T@U) ) (!  (=> (and (= (type x_6@@4) RefType) (= (type x_6_1) RefType)) (=> (and (and (and (and (not (= x_6@@4 x_6_1)) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_6@@4))) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_6_1))) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= x_6@@4 x_6_1))))
 :qid |stdinbpl.809:17|
 :skolemid |124|
 :pattern ( (neverTriggered8 x_6@@4) (neverTriggered8 x_6_1))
))) (=> (forall ((x_6@@5 T@U) (x_6_1@@0 T@U) ) (!  (=> (and (= (type x_6@@5) RefType) (= (type x_6_1@@0) RefType)) (=> (and (and (and (and (not (= x_6@@5 x_6_1@@0)) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_6@@5))) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_6_1@@0))) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= x_6@@5 x_6_1@@0))))
 :qid |stdinbpl.809:17|
 :skolemid |124|
 :pattern ( (neverTriggered8 x_6@@5) (neverTriggered8 x_6_1@@0))
)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((x_6@@6 T@U) ) (!  (=> (and (= (type x_6@@6) RefType) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_6@@6))) (> (U_2_real (MapType1Select Mask@1 x_6@@6 f_7)) NoPerm))
 :qid |stdinbpl.816:17|
 :skolemid |125|
 :pattern ( (MapType0Select Heap@0 x_6@@6 f_7))
 :pattern ( (MapType1Select QPMask@1 x_6@@6 f_7))
 :pattern ( (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_6@@6))
))) (=> (forall ((x_6@@7 T@U) ) (!  (=> (and (= (type x_6@@7) RefType) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_6@@7))) (> (U_2_real (MapType1Select Mask@1 x_6@@7 f_7)) NoPerm))
 :qid |stdinbpl.816:17|
 :skolemid |125|
 :pattern ( (MapType0Select Heap@0 x_6@@7 f_7))
 :pattern ( (MapType1Select QPMask@1 x_6@@7 f_7))
 :pattern ( (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_6@@7))
)) (=> (and (forall ((x_6@@8 T@U) ) (!  (=> (= (type x_6@@8) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_6@@8)) (< NoPerm wildcard@1)) (and (qpRange8 x_6@@8) (= (invRecv8 x_6@@8) x_6@@8))))
 :qid |stdinbpl.822:22|
 :skolemid |126|
 :pattern ( (MapType0Select Heap@0 x_6@@8 f_7))
 :pattern ( (MapType1Select QPMask@1 x_6@@8 f_7))
 :pattern ( (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_6@@8))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) (invRecv8 o_3@@2))) (and (< NoPerm wildcard@1) (qpRange8 o_3@@2))) (= (invRecv8 o_3@@2) o_3@@2)))
 :qid |stdinbpl.826:22|
 :skolemid |127|
 :pattern ( (invRecv8 o_3@@2))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) (invRecv8 o_3@@3))) (and (< NoPerm wildcard@1) (qpRange8 o_3@@3))) (and (= (invRecv8 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (- (U_2_real (MapType1Select Mask@1 o_3@@3 f_7)) wildcard@1)))) (=> (not (and (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) (invRecv8 o_3@@3))) (and (< NoPerm wildcard@1) (qpRange8 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (U_2_real (MapType1Select Mask@1 o_3@@3 f_7))))))
 :qid |stdinbpl.832:22|
 :skolemid |128|
...
(let ((anon16_Else_correct  (=> (and (and (not (U_2_bool (MapType2Select xs y@@6))) (= Mask@1 QPMask@0)) (and (= Heap@0 Heap@@9) (= (ControlFlow 0 21) 18))) anon8_correct)))
(let ((anon16_Then_correct  (=> (U_2_bool (MapType2Select xs y@@6)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (> (U_2_real (MapType1Select QPMask@0 y@@6 f_7)) NoPerm)) (=> (> (U_2_real (MapType1Select QPMask@0 y@@6 f_7)) NoPerm) (=> (and (and (and (> wildcard@0 0.0) (< wildcard@0 (U_2_real (MapType1Select QPMask@0 y@@6 f_7)))) (and (= Mask@0 (MapType1Store QPMask@0 y@@6 f_7 (real_2_U (- (U_2_real (MapType1Select QPMask@0 y@@6 f_7)) wildcard@0)))) (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@0))) (and (and (state ExhaleHeap@0 Mask@0) (= Mask@1 Mask@0)) (and (= Heap@0 ExhaleHeap@0) (= (ControlFlow 0 19) 18)))) anon8_correct))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select xs x_1))) (U_2_bool (MapType2Select xs x_1_1))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.668:15|
 :skolemid |109|
 :no-pattern (type x_1)
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (U_2_bool (MapType2Select xs x_1@@0))) (U_2_bool (MapType2Select xs x_1_1@@0))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.668:15|
 :skolemid |109|
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (and (= (type x_1@@1) RefType) (U_2_bool (MapType2Select xs x_1@@1))) (and (qpRange5 x_1@@1) (= (invRecv5 x_1@@1) x_1@@1)))
 :qid |stdinbpl.674:22|
 :skolemid |110|
 :pattern ( (MapType0Select Heap@@9 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
 :pattern ( (MapType2Select xs x_1@@1))
)) (=> (and (and (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (U_2_bool (MapType2Select xs (invRecv5 o_3@@5))) (qpRange5 o_3@@5)) (= (invRecv5 o_3@@5) o_3@@5)))
 :qid |stdinbpl.678:22|
 :skolemid |111|
 :pattern ( (invRecv5 o_3@@5))
)) (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (U_2_bool (MapType2Select xs x_1@@2))) (not (= x_1@@2 null)))
 :qid |stdinbpl.684:22|
 :skolemid |112|
 :pattern ( (MapType0Select Heap@@9 x_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@2 f_7))
 :pattern ( (MapType2Select xs x_1@@2))
))) (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (U_2_bool (MapType2Select xs (invRecv5 o_3@@6))) (qpRange5 o_3@@6)) (and (= (invRecv5 o_3@@6) o_3@@6) (< (U_2_real (MapType1Select ZeroMask o_3@@6 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7))))) (=> (not (and (U_2_bool (MapType2Select xs (invRecv5 o_3@@6))) (qpRange5 o_3@@6))) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@6 f_7))))))
 :qid |stdinbpl.690:22|
 :skolemid |113|
...
)))) (and (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)) (and (U_2_bool (MapType2Select xs z@@0)) (state Heap@@9 QPMask@0)))) (and (and (=> (= (ControlFlow 0 26) 25) anon14_Then_correct) (=> (= (ControlFlow 0 26) 19) anon16_Then_correct)) (=> (= (ControlFlow 0 26) 21) anon16_Else_correct))))))))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 y@@6 $allocated)) (U_2_bool (MapType0Select Heap@@9 z@@0 $allocated))) (and (=> (= (ControlFlow 0 28) 1) anon13_Then_correct) (=> (= (ControlFlow 0 28) 26) anon13_Else_correct))))))
