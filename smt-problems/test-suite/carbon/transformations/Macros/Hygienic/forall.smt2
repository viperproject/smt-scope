...
(let ((anon14_Else_correct  (=> (and (forall ((i_2_1 Int) ) (!  (=> (and (<= 0 i_2_1) (< i_2_1 4)) (< i_2_1 6))
 :qid |stdinbpl.224:20|
 :skolemid |22|
)) (state Heap@@9 ZeroMask)) (and (and (and (=> (= (ControlFlow 0 12) 6) anon16_Then_correct) (=> (= (ControlFlow 0 12) 7) anon17_Else_correct)) (=> (= (ControlFlow 0 12) 9) anon18_Then_correct)) (=> (= (ControlFlow 0 12) 11) anon18_Else_correct)))))
...
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (and (and (=> (= (ControlFlow 0 13) 1) anon13_Then_correct) (=> (= (ControlFlow 0 13) 12) anon14_Else_correct)) (=> (= (ControlFlow 0 13) 3) anon15_Then_correct)) (=> (= (ControlFlow 0 13) 5) anon15_Else_correct))))))
