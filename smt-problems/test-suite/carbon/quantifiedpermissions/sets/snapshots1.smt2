...
(assert  (and (and (and (and (and (and (= (type UnfoldingMask@0) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type xs@@15) (MapType2Type RefType boolType))) (= (type x@@35) RefType)) (= (type Heap@@18) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv2 arg0@@48)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon2_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (P xs@@15 x@@35) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P xs@@15 x@@35))) FullPerm)))) (U_2_bool (MapType2Select xs@@15 x@@35))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((z@@0 T@U) (z_8 T@U) ) (!  (=> (and (= (type z@@0) RefType) (= (type z_8) RefType)) (=> (and (and (and (and (not (= z@@0 z_8)) (U_2_bool (MapType2Select xs@@15 z@@0))) (U_2_bool (MapType2Select xs@@15 z_8))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z@@0 z_8))))
 :qid |stdinbpl.647:17|
 :skolemid |97|
 :no-pattern (type z@@0)
 :no-pattern (type z_8)
...
)) (=> (and (and (and (forall ((z@@2 T@U) ) (!  (=> (= (type z@@2) RefType) (=> (and (U_2_bool (MapType2Select xs@@15 z@@2)) (< NoPerm FullPerm)) (and (qpRange2 z@@2) (= (invRecv2 z@@2) z@@2))))
 :qid |stdinbpl.653:24|
 :skolemid |98|
 :pattern ( (MapType0Select Heap@@18 z@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 z@@2 f_7))
 :pattern ( (MapType2Select xs@@15 z@@2))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select xs@@15 (invRecv2 o_3))) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.657:24|
 :skolemid |99|
 ...
 :qid |stdinbpl.663:24|
 :skolemid |100|
 :pattern ( (MapType0Select Heap@@18 z@@3 f_7))
 :pattern ( (MapType1Select QPMask@0 z@@3 f_7))
 :pattern ( (MapType2Select xs@@15 z@@3))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs@@15 (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select UnfoldingMask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select xs@@15 (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select UnfoldingMask@0 o_3@@0 f_7))))))
 :qid |stdinbpl.669:24|
 :skolemid |101|
...
)) (state Heap@@18 QPMask@0)) (and (state Heap@@18 QPMask@0) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm QPMask@0 x@@35 f_7)))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P xs@@15 x@@35))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P xs@@15 x@@35)))) (=> (= (ControlFlow 0 4) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@18 ZeroMask) (U_2_bool (MapType0Select Heap@@18 x@@35 $allocated))) (and (= AssumeFunctionsAbove 0) (= Mask@0 (MapType1Store ZeroMask null (P xs@@15 x@@35) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P xs@@15 x@@35))) FullPerm)))))) (and (and (state Heap@@18 Mask@0) (state Heap@@18 Mask@0)) (and (|P#trigger| Heap@@18 (P xs@@15 x@@35)) (= (MapType0Select Heap@@18 null (P xs@@15 x@@35)) (FrameFragment (int_2_U (|P#condqp2| Heap@@18 xs@@15 x@@35))))))) (and (=> (= (ControlFlow 0 7) 4) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct)))))
