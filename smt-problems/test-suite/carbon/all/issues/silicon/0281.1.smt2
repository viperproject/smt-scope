...
(declare-fun |extension_len_rec'| (T@U T@U Int) Int)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |extension_len_rec#triggerStateless| (T@U Int) Int)
...
(declare-fun ExtensionHeader_State (T@U) T@U)
(declare-fun PredicateType_ExtensionHeader_StateType () T@T)
(declare-fun |ExtensionHeader_State#trigger| (T@U T@U) Bool)
(declare-fun |ExtensionHeader_State#everUsed| (T@U) Bool)
(declare-fun |Seq#Update| (T@U Int T@U) T@U)
(declare-fun |Seq#Take| (T@U Int) T@U)
(declare-fun |extension_len_rec#frame| (T@U T@U Int) Int)
(declare-fun CombineFrames (T@U T@U) T@U)
(declare-fun FrameFragment (T@U) T@U)
(declare-fun |extension_len_rec#condqp1| (T@U T@U Int) Int)
(declare-fun |Seq#Contains| (T@U T@U) Bool)
(declare-fun |Seq#Range| (Int Int) T@U)
(declare-fun |Seq#Skolem| (T@U T@U) Int)
(declare-fun |Seq#Singleton| (T@U) T@U)
(declare-fun |ExtensionHeader_State#sm| (T@U) T@U)
...
(declare-fun |sk_extension_len_rec#condqp1| (Int Int) T@U)
...
))) (= (Ctor RefType) 9)) (= (type list_acc) (FieldType NormalFieldType (SeqType RefType)))))
(assert (distinct $allocated list_acc)
)
...
(assert (forall ((Heap@@0 T@U) (hdrs T@U) (index Int) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type hdrs) RefType)) (dummyFunction (int_2_U (|extension_len_rec#triggerStateless| hdrs index))))
 :qid |stdinbpl.577:15|
 :skolemid |59|
...
(assert  (and (= (Ctor PredicateType_ExtensionHeader_StateType) 13) (forall ((arg0@@29 T@U) ) (! (= (type (ExtensionHeader_State arg0@@29)) (FieldType PredicateType_ExtensionHeader_StateType FrameTypeType))
 :qid |funType:ExtensionHeader_State|
 :pattern ( (ExtensionHeader_State arg0@@29))
))))
(assert (forall ((r T@U) ) (!  (=> (= (type r) RefType) (IsPredicateField (ExtensionHeader_State r)))
 :qid |stdinbpl.794:15|
 :skolemid |79|
 :pattern ( (ExtensionHeader_State r))
)))
(assert (forall ((Heap@@3 T@U) (r@@0 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type r@@0) RefType)) (|ExtensionHeader_State#everUsed| (ExtensionHeader_State r@@0)))
 :qid |stdinbpl.813:15|
 :skolemid |83|
 :pattern ( (|ExtensionHeader_State#trigger| Heap@@3 (ExtensionHeader_State r@@0)))
)))
...
(assert  (and (forall ((arg0@@32 T@U) (arg1@@13 T@U) ) (! (= (type (CombineFrames arg0@@32 arg1@@13)) FrameTypeType)
...
(assert (forall ((Heap@@4 T@U) (Mask@@2 T@U) (hdrs@@0 T@U) (index@@0 Int) ) (!  (=> (and (and (and (= (type Heap@@4) (MapType0Type RefType)) (= (type Mask@@2) (MapType1Type RefType realType))) (= (type hdrs@@0) RefType)) (state Heap@@4 Mask@@2)) (= (|extension_len_rec'| Heap@@4 hdrs@@0 index@@0) (|extension_len_rec#frame| (CombineFrames (FrameFragment (MapType0Select Heap@@4 hdrs@@0 list_acc)) (FrameFragment (int_2_U (|extension_len_rec#condqp1| Heap@@4 hdrs@@0 index@@0)))) hdrs@@0 index@@0)))
 :qid |stdinbpl.590:15|
 :skolemid |61|
 :pattern ( (state Heap@@4 Mask@@2) (|extension_len_rec'| Heap@@4 hdrs@@0 index@@0))
)))
...
(assert (forall ((r@@1 T@U) (r2 T@U) ) (!  (=> (and (and (= (type r@@1) RefType) (= (type r2) RefType)) (= (ExtensionHeader_State r@@1) (ExtensionHeader_State r2))) (= r@@1 r2))
 :qid |stdinbpl.804:15|
 :skolemid |81|
 :pattern ( (ExtensionHeader_State r@@1) (ExtensionHeader_State r2))
)))
(assert (forall ((arg0@@36 T@U) ) (! (= (type (|ExtensionHeader_State#sm| arg0@@36)) (FieldType PredicateType_ExtensionHeader_StateType (MapType1Type RefType boolType)))
 :qid |funType:ExtensionHeader_State#sm|
 :pattern ( (|ExtensionHeader_State#sm| arg0@@36))
)))
(assert (forall ((r@@2 T@U) (r2@@0 T@U) ) (!  (=> (and (and (= (type r@@2) RefType) (= (type r2@@0) RefType)) (= (|ExtensionHeader_State#sm| r@@2) (|ExtensionHeader_State#sm| r2@@0))) (= r@@2 r2@@0))
 :qid |stdinbpl.808:15|
 :skolemid |82|
 :pattern ( (|ExtensionHeader_State#sm| r@@2) (|ExtensionHeader_State#sm| r2@@0))
)))
...
(assert (forall ((arg0@@37 T@U) (arg1@@15 T@U) ) (! (let ((T@@14 (SeqTypeInv0 (type arg0@@37))))
(= (type (|Seq#Append| arg0@@37 arg1@@15)) (SeqType T@@14)))
 :qid |funType:Seq#Append|
 :pattern ( (|Seq#Append| arg0@@37 arg1@@15))
)))
...
(assert  (and (forall ((arg0@@38 Real) (arg1@@16 T@U) ) (! (= (type (ConditionalFrame arg0@@38 arg1@@16)) FrameTypeType)
 :qid |funType:ConditionalFrame|
 :pattern ( (ConditionalFrame arg0@@38 arg1@@16))
...
(assert (forall ((Heap@@8 T@U) (hdrs@@1 T@U) (index@@1 Int) ) (!  (=> (and (= (type Heap@@8) (MapType0Type RefType)) (= (type hdrs@@1) RefType)) (and (= (extension_len_rec Heap@@8 hdrs@@1 index@@1) (|extension_len_rec'| Heap@@8 hdrs@@1 index@@1)) (dummyFunction (int_2_U (|extension_len_rec#triggerStateless| hdrs@@1 index@@1)))))
 :qid |stdinbpl.573:15|
 :skolemid |58|
 :pattern ( (extension_len_rec Heap@@8 hdrs@@1 index@@1))
)))
...
(assert (forall ((r@@3 T@U) ) (!  (=> (= (type r@@3) RefType) (= (getPredWandId (ExtensionHeader_State r@@3)) 0))
 :qid |stdinbpl.798:15|
 :skolemid |80|
 :pattern ( (ExtensionHeader_State r@@3))
)))
...
(assert (forall ((Heap@@12 T@U) (Mask@@10 T@U) (hdrs@@2 T@U) (index@@2 Int) ) (!  (=> (and (and (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type hdrs@@2) RefType)) (and (state Heap@@12 Mask@@10) (< AssumeFunctionsAbove 0))) (and (>= index@@2 0) (<= index@@2 (|Seq#Length| (MapType0Select Heap@@12 hdrs@@2 list_acc))))) (= (extension_len_rec Heap@@12 hdrs@@2 index@@2) (ite (= index@@2 (|Seq#Length| (MapType0Select Heap@@12 hdrs@@2 list_acc))) 0 (|extension_len_rec'| Heap@@12 hdrs@@2 (+ index@@2 1)))))
 :qid |stdinbpl.583:15|
 :skolemid |60|
 :pattern ( (state Heap@@12 Mask@@10) (extension_len_rec Heap@@12 hdrs@@2 index@@2))
)))
(assert (forall ((arg0@@39 Int) (arg1@@17 Int) ) (! (= (type (|sk_extension_len_rec#condqp1| arg0@@39 arg1@@17)) RefType)
 :qid |funType:sk_extension_len_rec#condqp1|
 :pattern ( (|sk_extension_len_rec#condqp1| arg0@@39 arg1@@17))
)))
(assert (forall ((Heap2Heap T@U) (Heap1Heap T@U) (hdrs@@3 T@U) (index@@3 Int) ) (!  (=> (and (and (and (= (type Heap2Heap) (MapType0Type RefType)) (= (type Heap1Heap) (MapType0Type RefType))) (= (type hdrs@@3) RefType)) (and (=  (and (|Seq#Contains| (MapType0Select Heap2Heap hdrs@@3 list_acc) (|sk_extension_len_rec#condqp1| (|extension_len_rec#condqp1| Heap2Heap hdrs@@3 index@@3) (|extension_len_rec#condqp1| Heap1Heap hdrs@@3 index@@3))) (< NoPerm (/ (to_real 1) (to_real 200))))  (and (|Seq#Contains| (MapType0Select Heap1Heap hdrs@@3 list_acc) (|sk_extension_len_rec#condqp1| (|extension_len_rec#condqp1| Heap2Heap hdrs@@3 index@@3) (|extension_len_rec#condqp1| Heap1Heap hdrs@@3 index@@3))) (< NoPerm (/ (to_real 1) (to_real 200))))) (=> (and (|Seq#Contains| (MapType0Select Heap2Heap hdrs@@3 list_acc) (|sk_extension_len_rec#condqp1| (|extension_len_rec#condqp1| Heap2Heap hdrs@@3 index@@3) (|extension_len_rec#condqp1| Heap1Heap hdrs@@3 index@@3))) (< NoPerm (/ (to_real 1) (to_real 200)))) (= (MapType0Select Heap2Heap null (ExtensionHeader_State (|sk_extension_len_rec#condqp1| (|extension_len_rec#condqp1| Heap2Heap hdrs@@3 index@@3) (|extension_len_rec#condqp1| Heap1Heap hdrs@@3 index@@3)))) (MapType0Select Heap1Heap null (ExtensionHeader_State (|sk_extension_len_rec#condqp1| (|extension_len_rec#condqp1| Heap2Heap hdrs@@3 index@@3) (|extension_len_rec#condqp1| Heap1Heap hdrs@@3 index@@3)))))))) (= (|extension_len_rec#condqp1| Heap2Heap hdrs@@3 index@@3) (|extension_len_rec#condqp1| Heap1Heap hdrs@@3 index@@3)))
 :qid |stdinbpl.600:15|
 :skolemid |62|
...
(assert (forall ((r@@4 T@U) ) (!  (=> (= (type r@@4) RefType) (= (PredicateMaskField (ExtensionHeader_State r@@4)) (|ExtensionHeader_State#sm| r@@4)))
 :qid |stdinbpl.790:15|
 :skolemid |78|
 :pattern ( (PredicateMaskField (ExtensionHeader_State r@@4)))
)))
...
(declare-fun |extension_len_rec#trigger| (T@U T@U Int) Bool)
...
(assert  (and (and (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type hdrs@@4) RefType)) (= (type Heap@@14) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@40 T@U) ) (! (= (type (invRecv2 arg0@@40)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@40))
))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@41 T@U) ) (! (= (type (invRecv1 arg0@@41)) RefType)
 :qid |funType:invRecv1|
 :pattern ( (invRecv1 arg0@@41))
))))
(set-info :boogie-vc-id |extension_len_rec#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 25) (let ((anon7_correct  (=> (= Mask@1 (MapType1Store QPMask@0 hdrs@@4 list_acc (real_2_U (- (U_2_real (MapType1Select QPMask@0 hdrs@@4 list_acc)) perm@1)))) (and (=> (= (ControlFlow 0 7) (- 0 11)) (forall ((r_1 T@U) ) (!  (=> (= (type r_1) RefType) (=> (and (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) (invRecv2 r_1)) (qpRange2 r_1)) (>= (/ (to_real 1) (to_real 200)) NoPerm)))
 :qid |stdinbpl.718:23|
 :skolemid |70|
 :pattern ( (invRecv2 r_1))
))) (=> (forall ((r_1@@0 T@U) ) (!  (=> (= (type r_1@@0) RefType) (=> (and (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) (invRecv2 r_1@@0)) (qpRange2 r_1@@0)) (>= (/ (to_real 1) (to_real 200)) NoPerm)))
 :qid |stdinbpl.718:23|
 :skolemid |70|
 :pattern ( (invRecv2 r_1@@0))
)) (and (=> (= (ControlFlow 0 7) (- 0 10)) (forall ((lambda180_26$e_6 T@U) (lambda180_26$e_6_1 T@U) ) (!  (=> (and (= (type lambda180_26$e_6) RefType) (= (type lambda180_26$e_6_1) RefType)) (=> (and (and (and (and (not (= lambda180_26$e_6 lambda180_26$e_6_1)) (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_6)) (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_6_1)) (< NoPerm (/ (to_real 1) (to_real 200)))) (< NoPerm (/ (to_real 1) (to_real 200)))) (not (= lambda180_26$e_6 lambda180_26$e_6_1))))
 :qid |stdinbpl.725:23|
 :skolemid |71|
 :pattern ( (neverTriggered2 lambda180_26$e_6) (neverTriggered2 lambda180_26$e_6_1))
))) (=> (forall ((lambda180_26$e_6@@0 T@U) (lambda180_26$e_6_1@@0 T@U) ) (!  (=> (and (= (type lambda180_26$e_6@@0) RefType) (= (type lambda180_26$e_6_1@@0) RefType)) (=> (and (and (and (and (not (= lambda180_26$e_6@@0 lambda180_26$e_6_1@@0)) (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_6@@0)) (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_6_1@@0)) (< NoPerm (/ (to_real 1) (to_real 200)))) (< NoPerm (/ (to_real 1) (to_real 200)))) (not (= lambda180_26$e_6@@0 lambda180_26$e_6_1@@0))))
 :qid |stdinbpl.725:23|
 :skolemid |71|
 :pattern ( (neverTriggered2 lambda180_26$e_6@@0) (neverTriggered2 lambda180_26$e_6_1@@0))
)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((lambda180_26$e_6@@1 T@U) ) (!  (=> (and (= (type lambda180_26$e_6@@1) RefType) (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_6@@1)) (>= (U_2_real (MapType1Select Mask@1 null (ExtensionHeader_State lambda180_26$e_6@@1))) (/ (to_real 1) (to_real 200))))
 :qid |stdinbpl.732:23|
 :skolemid |72|
 :pattern ( (MapType0Select Heap@@14 null (ExtensionHeader_State lambda180_26$e_6@@1)))
 :pattern ( (MapType1Select Mask@1 null (ExtensionHeader_State lambda180_26$e_6@@1)))
 :pattern ( (|Seq#ContainsTrigger| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_6@@1))
 :pattern ( (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_6@@1))
))) (=> (forall ((lambda180_26$e_6@@2 T@U) ) (!  (=> (and (= (type lambda180_26$e_6@@2) RefType) (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_6@@2)) (>= (U_2_real (MapType1Select Mask@1 null (ExtensionHeader_State lambda180_26$e_6@@2))) (/ (to_real 1) (to_real 200))))
 :qid |stdinbpl.732:23|
 :skolemid |72|
 :pattern ( (MapType0Select Heap@@14 null (ExtensionHeader_State lambda180_26$e_6@@2)))
 :pattern ( (MapType1Select Mask@1 null (ExtensionHeader_State lambda180_26$e_6@@2)))
 :pattern ( (|Seq#ContainsTrigger| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_6@@2))
 :pattern ( (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_6@@2))
)) (=> (forall ((lambda180_26$e_6@@3 T@U) ) (!  (=> (= (type lambda180_26$e_6@@3) RefType) (=> (and (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_6@@3) (< NoPerm (/ (to_real 1) (to_real 200)))) (and (= (invRecv2 lambda180_26$e_6@@3) lambda180_26$e_6@@3) (qpRange2 lambda180_26$e_6@@3))))
 :qid |stdinbpl.738:28|
 :skolemid |73|
 :pattern ( (MapType0Select Heap@@14 null (ExtensionHeader_State lambda180_26$e_6@@3)))
 :pattern ( (MapType1Select Mask@1 null (ExtensionHeader_State lambda180_26$e_6@@3)))
 :pattern ( (|Seq#ContainsTrigger| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_6@@3))
 :pattern ( (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_6@@3))
)) (=> (and (and (forall ((r_1@@1 T@U) ) (!  (=> (= (type r_1@@1) RefType) (=> (and (and (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) (invRecv2 r_1@@1)) (< NoPerm (/ (to_real 1) (to_real 200)))) (qpRange2 r_1@@1)) (= (invRecv2 r_1@@1) r_1@@1)))
 :qid |stdinbpl.742:28|
 :skolemid |74|
 :pattern ( (invRecv2 r_1@@1))
)) (forall ((r_1@@2 T@U) ) (!  (=> (= (type r_1@@2) RefType) (=> (and (and (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) (invRecv2 r_1@@2)) (< NoPerm (/ (to_real 1) (to_real 200)))) (qpRange2 r_1@@2)) (and (= (invRecv2 r_1@@2) r_1@@2) (= (U_2_real (MapType1Select QPMask@1 null (ExtensionHeader_State r_1@@2))) (- (U_2_real (MapType1Select Mask@1 null (ExtensionHeader_State r_1@@2))) (/ (to_real 1) (to_real 200)))))))
 :qid |stdinbpl.748:28|
 :skolemid |75|
 :pattern ( (MapType1Select QPMask@1 null (ExtensionHeader_State r_1@@2)))
))) (and (forall ((r_1@@3 T@U) ) (!  (=> (and (= (type r_1@@3) RefType) (not (and (and (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) (invRecv2 r_1@@3)) (< NoPerm (/ (to_real 1) (to_real 200)))) (qpRange2 r_1@@3)))) (= (U_2_real (MapType1Select QPMask@1 null (ExtensionHeader_State r_1@@3))) (U_2_real (MapType1Select Mask@1 null (ExtensionHeader_State r_1@@3)))))
 :qid |stdinbpl.752:28|
 :skolemid |76|
 :pattern ( (MapType1Select QPMask@1 null (ExtensionHeader_State r_1@@3)))
)) (forall ((o_3 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (or (or (not (= o_3 null)) (not (IsPredicateField f_5))) (not (= (getPredWandId f_5) 0)))) (= (U_2_real (MapType1Select Mask@1 o_3 f_5)) (U_2_real (MapType1Select QPMask@1 o_3 f_5))))))
 :qid |stdinbpl.758:35|
 :skolemid |77|
 :pattern ( (MapType1Select Mask@1 o_3 f_5))
 :pattern ( (MapType1Select QPMask@1 o_3 f_5))
)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (>= (+ index@@4 1) 0)) (=> (>= (+ index@@4 1) 0) (=> (= (ControlFlow 0 7) (- 0 6)) (<= (+ index@@4 1) (|Seq#Length| (MapType0Select Heap@@14 hdrs@@4 list_acc)))))))))))))))))
(let ((anon13_Else_correct  (=> (and (= perm@1 NoPerm) (= (ControlFlow 0 14) 7)) anon7_correct)))
(let ((anon13_Then_correct  (=> (not (= perm@1 NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= perm@1 (U_2_real (MapType1Select QPMask@0 hdrs@@4 list_acc)))) (=> (<= perm@1 (U_2_real (MapType1Select QPMask@0 hdrs@@4 list_acc))) (=> (= (ControlFlow 0 12) 7) anon7_correct))))))
(let ((anon12_Then_correct  (=> (= perm@1 (/ (to_real 1) (to_real 200))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (and (=> (= (ControlFlow 0 15) 12) anon13_Then_correct) (=> (= (ControlFlow 0 15) 14) anon13_Else_correct)))))))
(let ((anon9_correct true))
(let ((anon12_Else_correct  (=> (and (|extension_len_rec#trigger| (CombineFrames (FrameFragment (MapType0Select Heap@@14 hdrs@@4 list_acc)) (FrameFragment (int_2_U (|extension_len_rec#condqp1| Heap@@14 hdrs@@4 (+ index@@4 1))))) hdrs@@4 (+ index@@4 1)) (= (ControlFlow 0 5) 3)) anon9_correct)))
(let ((anon11_Else_correct  (=> (not cond_0_1@0) (and (=> (= (ControlFlow 0 17) 15) anon12_Then_correct) (=> (= (ControlFlow 0 17) 5) anon12_Else_correct)))))
(let ((anon11_Then_correct  (=> (and cond_0_1@0 (= (ControlFlow 0 4) 3)) anon9_correct)))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 22)) (forall ((lambda180_26$e_4 T@U) (lambda180_26$e_4_1 T@U) ) (!  (=> (and (= (type lambda180_26$e_4) RefType) (= (type lambda180_26$e_4_1) RefType)) (=> (and (and (and (and (not (= lambda180_26$e_4 lambda180_26$e_4_1)) (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_4)) (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_4_1)) (< NoPerm (/ (to_real 1) (to_real 200)))) (< NoPerm (/ (to_real 1) (to_real 200)))) (not (= lambda180_26$e_4 lambda180_26$e_4_1))))
 :qid |stdinbpl.647:17|
 :skolemid |63|
 :pattern ( (neverTriggered1 lambda180_26$e_4) (neverTriggered1 lambda180_26$e_4_1))
))) (=> (forall ((lambda180_26$e_4@@0 T@U) (lambda180_26$e_4_1@@0 T@U) ) (!  (=> (and (= (type lambda180_26$e_4@@0) RefType) (= (type lambda180_26$e_4_1@@0) RefType)) (=> (and (and (and (and (not (= lambda180_26$e_4@@0 lambda180_26$e_4_1@@0)) (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_4@@0)) (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_4_1@@0)) (< NoPerm (/ (to_real 1) (to_real 200)))) (< NoPerm (/ (to_real 1) (to_real 200)))) (not (= lambda180_26$e_4@@0 lambda180_26$e_4_1@@0))))
 :qid |stdinbpl.647:17|
 :skolemid |63|
 :pattern ( (neverTriggered1 lambda180_26$e_4@@0) (neverTriggered1 lambda180_26$e_4_1@@0))
)) (=> (and (forall ((lambda180_26$e_4@@1 T@U) ) (!  (=> (= (type lambda180_26$e_4@@1) RefType) (=> (and (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_4@@1) (< NoPerm (/ (to_real 1) (to_real 200)))) (and (= (invRecv1 lambda180_26$e_4@@1) lambda180_26$e_4@@1) (qpRange1 lambda180_26$e_4@@1))))
 :qid |stdinbpl.653:22|
 :skolemid |64|
 :pattern ( (MapType0Select Heap@@14 null (ExtensionHeader_State lambda180_26$e_4@@1)))
 :pattern ( (MapType1Select Mask@0 null (ExtensionHeader_State lambda180_26$e_4@@1)))
 :pattern ( (|Seq#ContainsTrigger| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_4@@1))
 :pattern ( (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_4@@1))
)) (forall ((r@@5 T@U) ) (!  (=> (= (type r@@5) RefType) (=> (and (and (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) (invRecv1 r@@5)) (< NoPerm (/ (to_real 1) (to_real 200)))) (qpRange1 r@@5)) (= (invRecv1 r@@5) r@@5)))
 :qid |stdinbpl.657:22|
 :skolemid |65|
 :pattern ( (invRecv1 r@@5))
))) (and (=> (= (ControlFlow 0 18) (- 0 21)) (forall ((lambda180_26$e_4@@2 T@U) ) (!  (=> (and (= (type lambda180_26$e_4@@2) RefType) (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_4@@2)) (>= (/ (to_real 1) (to_real 200)) NoPerm))
 :qid |stdinbpl.663:15|
 :skolemid |66|
 :pattern ( (MapType0Select Heap@@14 null (ExtensionHeader_State lambda180_26$e_4@@2)))
 :pattern ( (MapType1Select Mask@0 null (ExtensionHeader_State lambda180_26$e_4@@2)))
 :pattern ( (|Seq#ContainsTrigger| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_4@@2))
 :pattern ( (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_4@@2))
))) (=> (forall ((lambda180_26$e_4@@3 T@U) ) (!  (=> (and (= (type lambda180_26$e_4@@3) RefType) (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_4@@3)) (>= (/ (to_real 1) (to_real 200)) NoPerm))
 :qid |stdinbpl.663:15|
 :skolemid |66|
 :pattern ( (MapType0Select Heap@@14 null (ExtensionHeader_State lambda180_26$e_4@@3)))
 :pattern ( (MapType1Select Mask@0 null (ExtensionHeader_State lambda180_26$e_4@@3)))
 :pattern ( (|Seq#ContainsTrigger| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_4@@3))
 :pattern ( (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) lambda180_26$e_4@@3))
)) (=> (and (forall ((r@@6 T@U) ) (!  (=> (= (type r@@6) RefType) (=> (and (and (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) (invRecv1 r@@6)) (< NoPerm (/ (to_real 1) (to_real 200)))) (qpRange1 r@@6)) (and (=> (< NoPerm (/ (to_real 1) (to_real 200))) (= (invRecv1 r@@6) r@@6)) (= (U_2_real (MapType1Select QPMask@0 null (ExtensionHeader_State r@@6))) (+ (U_2_real (MapType1Select Mask@0 null (ExtensionHeader_State r@@6))) (/ (to_real 1) (to_real 200)))))))
 :qid |stdinbpl.669:22|
 :skolemid |67|
 :pattern ( (MapType1Select QPMask@0 null (ExtensionHeader_State r@@6)))
...
))) (=> (and (and (forall ((r@@7 T@U) ) (!  (=> (and (= (type r@@7) RefType) (not (and (and (|Seq#Contains| (MapType0Select Heap@@14 hdrs@@4 list_acc) (invRecv1 r@@7)) (< NoPerm (/ (to_real 1) (to_real 200)))) (qpRange1 r@@7)))) (= (U_2_real (MapType1Select QPMask@0 null (ExtensionHeader_State r@@7))) (U_2_real (MapType1Select Mask@0 null (ExtensionHeader_State r@@7)))))
 :qid |stdinbpl.679:22|
 :skolemid |69|
 :pattern ( (MapType1Select QPMask@0 null (ExtensionHeader_State r@@7)))
)) (state Heap@@14 QPMask@0)) (and (state Heap@@14 QPMask@0) (>= index@@4 0))) (and (=> (= (ControlFlow 0 18) (- 0 20)) (HasDirectPerm QPMask@0 hdrs@@4 list_acc)) (=> (HasDirectPerm QPMask@0 hdrs@@4 list_acc) (=> (and (<= index@@4 (|Seq#Length| (MapType0Select Heap@@14 hdrs@@4 list_acc))) (state Heap@@14 QPMask@0)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm QPMask@0 hdrs@@4 list_acc)) (=> (HasDirectPerm QPMask@0 hdrs@@4 list_acc) (=> (= cond_0_1@0 (= index@@4 (|Seq#Length| (MapType0Select Heap@@14 hdrs@@4 list_acc)))) (and (=> (= (ControlFlow 0 18) 4) anon11_Then_correct) (=> (= (ControlFlow 0 18) 17) anon11_Else_correct)))))))))))))))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@0 hdrs@@4 list_acc))))
(let ((anon0_correct  (=> (and (and (state Heap@@14 ZeroMask) (U_2_bool (MapType0Select Heap@@14 hdrs@@4 $allocated))) (and (= AssumeFunctionsAbove 0) (= perm@0 (/ (to_real 1) (to_real 200))))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= hdrs@@4 null))) (= Mask@0 (MapType1Store ZeroMask hdrs@@4 list_acc (real_2_U (+ (U_2_real (MapType1Select ZeroMask hdrs@@4 list_acc)) perm@0))))) (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0))) (and (=> (= (ControlFlow 0 23) 2) anon10_Then_correct) (=> (= (ControlFlow 0 23) 18) anon10_Else_correct))))))))
