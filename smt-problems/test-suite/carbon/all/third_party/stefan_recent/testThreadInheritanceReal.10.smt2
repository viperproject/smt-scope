...
(let ((anon0_correct  (=> (state Heap@@30 ZeroMask) (=> (and (>= current_thread_id 0) (state Heap@@30 ZeroMask)) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct))))))
