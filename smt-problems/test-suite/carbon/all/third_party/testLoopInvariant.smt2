...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 33) (let ((anon9_correct  (=> (= Mask@5 (MapType1Store Mask@3 diz Ref__res (real_2_U (- (U_2_real (MapType1Select Mask@3 diz Ref__res)) FullPerm)))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= __flatten_5@1 n)) (=> (<= __flatten_5@1 n) (=> (= (ControlFlow 0 15) (- 0 14)) (= (U_2_int (MapType0Select Heap@1 diz Ref__res)) (* __flatten_5@1 n))))))))
...
(let ((anon15_Else_correct  (=> (state Heap@@9 Mask@0) (and (=> (= (ControlFlow 0 29) (- 0 30)) (= FullPerm (U_2_real (MapType1Select Mask@0 diz Ref__res)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 diz Ref__res))) (=> (and (= Heap@0 (MapType0Store Heap@@9 diz Ref__res (int_2_U 0))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 29) 26) anon16_Then_correct) (=> (= (ControlFlow 0 29) 28) anon16_Else_correct))))))))
