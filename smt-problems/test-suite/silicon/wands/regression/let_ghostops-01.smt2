(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:36:15
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/wands/regression/let_ghostops.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(set-option :timeout 0)
(push) ; 2
(assert (F%trigger s@$ x@0@00))
(assert (not (= x@0@00 $Ref.null)))
(pop) ; 2
; Joined path conditions
(assert (and (F%trigger s@$ x@0@00) (not (= x@0@00 $Ref.null))))
