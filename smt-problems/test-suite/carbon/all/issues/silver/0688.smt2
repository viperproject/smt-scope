...
(declare-fun |functionUnit'| (T@U Int) T@U)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |functionUnit#triggerStateless| (Int) T@U)
(declare-fun UnitDomainTypeType () T@T)
(declare-fun $allocated () T@U)
(declare-fun NormalFieldType () T@T)
(declare-fun functionUnit (T@U Int) T@U)
(declare-fun F67 (Int Int) Int)
(declare-fun L67 () Int)
(declare-fun Unit_tag (T@U) Int)
(declare-fun unit () T@U)
...
(declare-fun lemmaLEqualR67 (T@U) T@U)
(declare-fun |lemmaLEqualR67'| (T@U) T@U)
(declare-fun |lemmaLEqualR67#triggerStateless| () T@U)
(declare-fun NoPerm () Real)
(declare-fun AssumeFunctionsAbove () Int)
(declare-fun |lemmaLEqualR67#trigger| (T@U) Bool)
(declare-fun R67 () Int)
(declare-fun FullPerm () Real)
(declare-fun |functionUnit#frame| (T@U Int) T@U)
(declare-fun |lemmaLEqualR67#frame| (T@U) T@U)
...
(assert  (and (and (= (Ctor UnitDomainTypeType) 11) (forall ((arg0@@25 T@U) (arg1@@9 Int) ) (! (= (type (|functionUnit'| arg0@@25 arg1@@9)) UnitDomainTypeType)
 :qid |funType:functionUnit'|
 :pattern ( (|functionUnit'| arg0@@25 arg1@@9))
))) (forall ((arg0@@26 Int) ) (! (= (type (|functionUnit#triggerStateless| arg0@@26)) UnitDomainTypeType)
 :qid |funType:functionUnit#triggerStateless|
 :pattern ( (|functionUnit#triggerStateless| arg0@@26))
))))
(assert (forall ((Heap@@2 T@U) (x_1 Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (|functionUnit#triggerStateless| x_1)))
 :qid |stdinbpl.240:15|
 :skolemid |26|
 :pattern ( (|functionUnit'| Heap@@2 x_1))
)))
...
(assert (forall ((arg0@@27 T@U) (arg1@@10 Int) ) (! (= (type (functionUnit arg0@@27 arg1@@10)) UnitDomainTypeType)
 :qid |funType:functionUnit|
 :pattern ( (functionUnit arg0@@27 arg1@@10))
)))
(assert (forall ((Heap@@4 T@U) (x_1@@0 Int) ) (!  (=> (= (type Heap@@4) (MapType0Type RefType)) (and (= (functionUnit Heap@@4 x_1@@0) (|functionUnit'| Heap@@4 x_1@@0)) (dummyFunction (|functionUnit#triggerStateless| x_1@@0))))
 :qid |stdinbpl.236:15|
 :skolemid |25|
 :pattern ( (functionUnit Heap@@4 x_1@@0))
)))
(assert (forall ((x_1@@1 Int) ) (! (= (F67 L67 x_1@@1) L67)
 :qid |stdinbpl.196:15|
 :skolemid |22|
 :pattern ( (F67 L67 x_1@@1))
)))
(assert (= (type unit) UnitDomainTypeType))
...
(assert (forall ((t_2 T@U) ) (!  (=> (= (type t_2) UnitDomainTypeType) (= t_2 unit))
 :qid |stdinbpl.224:15|
 :skolemid |24|
...
(assert  (and (and (forall ((arg0@@29 T@U) ) (! (= (type (lemmaLEqualR67 arg0@@29)) UnitDomainTypeType)
 :qid |funType:lemmaLEqualR67|
 :pattern ( (lemmaLEqualR67 arg0@@29))
)) (forall ((arg0@@30 T@U) ) (! (= (type (|lemmaLEqualR67'| arg0@@30)) UnitDomainTypeType)
 :qid |funType:lemmaLEqualR67'|
 :pattern ( (|lemmaLEqualR67'| arg0@@30))
))) (= (type |lemmaLEqualR67#triggerStateless|) UnitDomainTypeType)))
(assert (forall ((Heap@@7 T@U) ) (!  (=> (= (type Heap@@7) (MapType0Type RefType)) (and (= (lemmaLEqualR67 Heap@@7) (|lemmaLEqualR67'| Heap@@7)) (dummyFunction |lemmaLEqualR67#triggerStateless|)))
 :qid |stdinbpl.276:15|
 :skolemid |28|
 :pattern ( (lemmaLEqualR67 Heap@@7))
)))
...
(assert (forall ((Heap@@8 T@U) (Mask@@6 T@U) ) (!  (=> (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (and (state Heap@@8 Mask@@6) (or (< AssumeFunctionsAbove 1) (|lemmaLEqualR67#trigger| EmptyFrame)))) (= L67 R67))
 :qid |stdinbpl.299:15|
 :skolemid |32|
 :pattern ( (state Heap@@8 Mask@@6) (|lemmaLEqualR67'| Heap@@8))
)))
(assert (forall ((x_1@@2 Int) ) (! (= (F67 x_1@@2 R67) R67)
 :qid |stdinbpl.202:15|
 :skolemid |23|
 :pattern ( (F67 x_1@@2 R67))
)))
(assert (forall ((Heap@@9 T@U) (Mask@@7 T@U) ) (!  (=> (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (and (state Heap@@9 Mask@@7) (< AssumeFunctionsAbove 1))) (= (lemmaLEqualR67 Heap@@9) unit))
 :qid |stdinbpl.286:15|
 :skolemid |30|
 :pattern ( (state Heap@@9 Mask@@7) (lemmaLEqualR67 Heap@@9))
)))
...
(assert (forall ((arg0@@31 T@U) (arg1@@12 Int) ) (! (= (type (|functionUnit#frame| arg0@@31 arg1@@12)) UnitDomainTypeType)
 :qid |funType:functionUnit#frame|
 :pattern ( (|functionUnit#frame| arg0@@31 arg1@@12))
)))
(assert (forall ((Heap@@12 T@U) (Mask@@11 T@U) (x_1@@3 Int) ) (!  (=> (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (state Heap@@12 Mask@@11)) (= (|functionUnit'| Heap@@12 x_1@@3) (|functionUnit#frame| EmptyFrame x_1@@3)))
 :qid |stdinbpl.247:15|
 :skolemid |27|
 :pattern ( (state Heap@@12 Mask@@11) (|functionUnit'| Heap@@12 x_1@@3))
)))
(assert (forall ((Heap@@13 T@U) ) (!  (=> (= (type Heap@@13) (MapType0Type RefType)) (dummyFunction |lemmaLEqualR67#triggerStateless|))
 :qid |stdinbpl.280:15|
 :skolemid |29|
 :pattern ( (|lemmaLEqualR67'| Heap@@13))
)))
...
(assert (forall ((arg0@@32 T@U) ) (! (= (type (|lemmaLEqualR67#frame| arg0@@32)) UnitDomainTypeType)
 :qid |funType:lemmaLEqualR67#frame|
 :pattern ( (|lemmaLEqualR67#frame| arg0@@32))
)))
(assert (forall ((Heap@@15 T@U) (Mask@@12 T@U) ) (!  (=> (and (and (= (type Heap@@15) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (state Heap@@15 Mask@@12)) (= (|lemmaLEqualR67'| Heap@@15) (|lemmaLEqualR67#frame| EmptyFrame)))
 :qid |stdinbpl.293:15|
 :skolemid |31|
 :pattern ( (state Heap@@15 Mask@@12) (|lemmaLEqualR67'| Heap@@15))
)))
...
(declare-fun x_1_1@0 () Int)
(declare-fun Result@0 () T@U)
(assert  (and (= (type Heap@@17) (MapType0Type RefType)) (= (type Result@0) UnitDomainTypeType)))
(set-info :boogie-vc-id |lemmaLEqualR67#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and (= AssumeFunctionsAbove 1) (= x_1_1@0 (F67 L67 R67))) (and (= Result@0 unit) (= (ControlFlow 0 2) (- 0 1)))) (= L67 R67)))))
