...
(assert  (and (and (and (= (type a_3@@1) ArrayDomainTypeType) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@13) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id qpTestTwo)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (exists ((k_1 Int) ) (!  (=> (other_dummy (- k_1 2)) (<= 0 k_1))
 :qid |stdinbpl.491:15|
 :skolemid |41|
)))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= (- 0 2) i_1) (< i_1 8))) (and (<= (- 0 2) i_1_1) (< i_1_1 8))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 (+ i_1 2)) (loc a_3@@1 (+ i_1_1 2)))))
 :qid |stdinbpl.428:15|
 :skolemid |35|
 ...
 :qid |stdinbpl.428:15|
 :skolemid |35|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= (- 0 2) i_1@@1) (< i_1@@1 8)) (< NoPerm FullPerm)) (and (qpRange2 (loc a_3@@1 (+ i_1@@1 2))) (= (invRecv2 (loc a_3@@1 (+ i_1@@1 2))) i_1@@1)))
 :qid |stdinbpl.434:22|
 :skolemid |36|
 :pattern ( (other_dummy i_1@@1))
)) (=> (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= (- 0 2) (invRecv2 o_3)) (< (invRecv2 o_3) 8)) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (loc a_3@@1 (+ (invRecv2 o_3) 2)) o_3)))
 :qid |stdinbpl.438:22|
 :skolemid |37|
...
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= (- 0 2) (invRecv2 o_3@@0)) (< (invRecv2 o_3@@0) 8)) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@1 (+ (invRecv2 o_3@@0) 2)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (and (and (<= (- 0 2) (invRecv2 o_3@@0)) (< (invRecv2 o_3@@0) 8)) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.450:22|
 :skolemid |39|
...
)))) (=> (and (and (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)) (and (<= 0 j_1@@3) (< j_1@@3 10))) (and (and (state Heap@@13 QPMask@0) (other_dummy (- j_1@@3 2))) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (= FullPerm (U_2_real (MapType1Select QPMask@0 (loc a_3@@1 j_1@@3) val)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 (loc a_3@@1 j_1@@3) val))) (=> (and (= Heap@0 (MapType0Store Heap@@13 (loc a_3@@1 j_1@@3) val (int_2_U 5))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 8) 1) anon5_Then_correct) (=> (= (ControlFlow 0 8) 5) anon5_Else_correct)))))
