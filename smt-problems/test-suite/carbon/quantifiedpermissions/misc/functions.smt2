...
(let ((anon18_Else_correct  (=> (and (not (and (<= 3 j_25) (< j_25 n@@37))) (= (ControlFlow 0 19) 15)) anon11_correct)))
(let ((anon18_Then_correct  (=> (and (<= 3 j_25) (< j_25 n@@37)) (and (=> (= (ControlFlow 0 16) (- 0 18)) (>= j_25 0)) (=> (>= j_25 0) (and (=> (= (ControlFlow 0 16) (- 0 17)) (< j_25 (|Seq#Length| xs@@39))) (=> (< j_25 (|Seq#Length| xs@@39)) (=> (= (ControlFlow 0 16) 15) anon11_correct))))))))
(let ((anon17_Else_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (forall ((j_7 Int) (j_7_1 Int) ) (!  (=> (and (and (and (and (not (= j_7 j_7_1)) (and (<= 3 j_7) (< j_7 n@@37))) (and (<= 3 j_7_1) (< j_7_1 n@@37))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@39 j_7) (|Seq#Index| xs@@39 j_7_1))))
 :qid |stdinbpl.2265:15|
 :skolemid |205|
)))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((j_5 Int) (j_5_1 Int) ) (!  (=> (and (and (and (and (not (= j_5 j_5_1)) (and (<= 0 j_5) (< j_5 3))) (and (<= 0 j_5_1) (< j_5_1 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@39 j_5) (|Seq#Index| xs@@39 j_5_1))))
 ...
 :qid |stdinbpl.2220:15|
 :skolemid |199|
)) (=> (and (forall ((j_5@@1 Int) ) (!  (=> (and (and (<= 0 j_5@@1) (< j_5@@1 3)) (< NoPerm FullPerm)) (and (qpRange13 (|Seq#Index| xs@@39 j_5@@1)) (= (invRecv13 (|Seq#Index| xs@@39 j_5@@1)) j_5@@1)))
 :qid |stdinbpl.2226:22|
 :skolemid |200|
 :pattern ( (|Seq#Index| xs@@39 j_5@@1))
 :pattern ( (|Seq#Index| xs@@39 j_5@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv13 o_3)) (< (invRecv13 o_3) 3)) (< NoPerm FullPerm)) (qpRange13 o_3)) (= (|Seq#Index| xs@@39 (invRecv13 o_3)) o_3)))
 :qid |stdinbpl.2230:22|
 :skolemid |201|
 :pattern ( (invRecv13 o_3))
))) (=> (and (and (forall ((j_5@@2 Int) ) (!  (=> (and (<= 0 j_5@@2) (< j_5@@2 3)) (not (= (|Seq#Index| xs@@39 j_5@@2) null)))
 :qid |stdinbpl.2236:22|
 :skolemid |202|
 :pattern ( (|Seq#Index| xs@@39 j_5@@2))
 :pattern ( (|Seq#Index| xs@@39 j_5@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv13 o_3@@0)) (< (invRecv13 o_3@@0) 3)) (< NoPerm FullPerm)) (qpRange13 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| xs@@39 (invRecv13 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv13 o_3@@0)) (< (invRecv13 o_3@@0) 3)) (< NoPerm FullPerm)) (qpRange13 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
)) (state Heap@@41 QPMask@0))) (and (and (=> (= (ControlFlow 0 20) 14) anon17_Else_correct) (=> (= (ControlFlow 0 20) 16) anon18_Then_correct)) (=> (= (ControlFlow 0 20) 19) anon18_Else_correct))))))))
(let ((anon7_correct true))
(let ((anon16_Else_correct  (=> (and (not (and (<= 0 j_24) (< j_24 3))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon16_Then_correct  (=> (and (<= 0 j_24) (< j_24 3)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= j_24 0)) (=> (>= j_24 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< j_24 (|Seq#Length| xs@@39))) (=> (< j_24 (|Seq#Length| xs@@39)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon13_Else_correct  (=> (forall ((k_1_1@@1 Int) (j_3@@0 Int) ) (!  (=> (and (>= k_1_1@@1 0) (and (< k_1_1@@1 (|Seq#Length| xs@@39)) (and (>= j_3@@0 0) (and (< j_3@@0 (|Seq#Length| xs@@39)) (not (= k_1_1@@1 j_3@@0)))))) (not (= (|Seq#Index| xs@@39 k_1_1@@1) (|Seq#Index| xs@@39 j_3@@0))))
 :qid |stdinbpl.2203:20|
 :skolemid |198|
 :pattern ( (|Seq#Index| xs@@39 k_1_1@@1) (|Seq#Index| xs@@39 j_3@@0))
...
(let ((anon14_Else_correct  (=> (and (not (and (>= k_7 0) (and (< k_7 (|Seq#Length| xs@@39)) (and (>= j_23 0) (and (< j_23 (|Seq#Length| xs@@39)) (not (= k_7 j_23))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon14_Then_correct  (=> (and (>= k_7 0) (and (< k_7 (|Seq#Length| xs@@39)) (and (>= j_23 0) (and (< j_23 (|Seq#Length| xs@@39)) (not (= k_7 j_23)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= k_7 0)) (=> (>= k_7 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< k_7 (|Seq#Length| xs@@39))) (=> (< k_7 (|Seq#Length| xs@@39)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_23 0)) (=> (>= j_23 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_23 (|Seq#Length| xs@@39))) (=> (< j_23 (|Seq#Length| xs@@39)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (= (|Seq#Length| xs@@39) n@@37) (<= 3 n@@37))) (and (and (=> (= (ControlFlow 0 23) 22) anon13_Else_correct) (=> (= (ControlFlow 0 23) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 23) 7) anon14_Else_correct)))))
