...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon6_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (AList this@@15) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (AList this@@15))) FullPerm)))) (not (= this@@15 null))) (=> (and (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this@@15 elems (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this@@15 elems)) FullPerm)))) (state Heap@@19 UnfoldingMask@1)) (and (not (= this@@15 null)) (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 this@@15 size (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 this@@15 size)) FullPerm)))))) (and (and (state Heap@@19 UnfoldingMask@2) (<= 0 (U_2_int (MapType0Select Heap@@19 this@@15 size)))) (and (<= (U_2_int (MapType0Select Heap@@19 this@@15 size)) (len (MapType0Select Heap@@19 this@@15 elems))) (< 0 (len (MapType0Select Heap@@19 this@@15 elems)))))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (forall ((i@@0 Int) (i_10 Int) ) (!  (=> (and (and (and (and (not (= i@@0 i_10)) (and (<= 0 i@@0) (< i@@0 (len (MapType0Select Heap@@19 this@@15 elems))))) (and (<= 0 i_10) (< i_10 (len (MapType0Select Heap@@19 this@@15 elems))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc (MapType0Select Heap@@19 this@@15 elems) i@@0) (loc (MapType0Select Heap@@19 this@@15 elems) i_10))))
 :qid |stdinbpl.566:17|
 :skolemid |41|
 ...
 :qid |stdinbpl.566:17|
 :skolemid |41|
)) (=> (forall ((i@@2 Int) ) (!  (=> (and (and (<= 0 i@@2) (< i@@2 (len (MapType0Select Heap@@19 this@@15 elems)))) (< NoPerm FullPerm)) (and (qpRange2 (loc (MapType0Select Heap@@19 this@@15 elems) i@@2)) (= (invRecv2 (loc (MapType0Select Heap@@19 this@@15 elems) i@@2)) i@@2)))
 :qid |stdinbpl.572:24|
 :skolemid |42|
 :pattern ( (loc (MapType0Select Heap@@19 this@@15 elems) i@@2))
 :pattern ( (loc (MapType0Select Heap@@19 this@@15 elems) i@@2))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv2 o_3)) (< (invRecv2 o_3) (len (MapType0Select Heap@@19 this@@15 elems)))) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (loc (MapType0Select Heap@@19 this@@15 elems) (invRecv2 o_3)) o_3)))
 :qid |stdinbpl.576:24|
 :skolemid |43|
 ...
 :pattern ( (loc (MapType0Select Heap@@19 this@@15 elems) i@@3))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv2 o_3@@0)) (< (invRecv2 o_3@@0) (len (MapType0Select Heap@@19 this@@15 elems)))) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (loc (MapType0Select Heap@@19 this@@15 elems) (invRecv2 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select UnfoldingMask@2 o_3@@0 val)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv2 o_3@@0)) (< (invRecv2 o_3@@0) (len (MapType0Select Heap@@19 this@@15 elems)))) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select UnfoldingMask@2 o_3@@0 val))))))
 :qid |stdinbpl.588:24|
 :skolemid |45|
...
))) (and (state Heap@@19 QPMask@0) (state Heap@@19 QPMask@0))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm QPMask@0 this@@15 elems)) (=> (HasDirectPerm QPMask@0 this@@15 elems) (=> (= (ControlFlow 0 6) (- 0 5)) (HasDirectPerm QPMask@0 (loc (MapType0Select Heap@@19 this@@15 elems) index@@3) val)))))))))))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 6)) anon6_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (AList this@@15))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (AList this@@15)))) (=> (= (ControlFlow 0 9) 6) anon6_correct))))))
(let ((anon7_Else_correct  (=> (and (and (< index@@3 (length Heap@@19 this@@15)) (state Heap@@19 Mask@0)) (and (|AList#trigger| Heap@@19 (AList this@@15)) (= (MapType0Select Heap@@19 null (AList this@@15)) (CombineFrames (FrameFragment (MapType0Select Heap@@19 this@@15 elems)) (CombineFrames (FrameFragment (MapType0Select Heap@@19 this@@15 size)) (FrameFragment (int_2_U (|AList#condqp1| Heap@@19 this@@15)))))))) (and (=> (= (ControlFlow 0 12) 9) anon9_Then_correct) (=> (= (ControlFlow 0 12) 11) anon9_Else_correct)))))
(let ((anon3_correct true))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (AList this@@15))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (AList this@@15)))) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@19 ZeroMask) (U_2_bool (MapType0Select Heap@@19 this@@15 $allocated))) (and (= AssumeFunctionsAbove 0) (= Mask@0 (MapType1Store ZeroMask null (AList this@@15) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (AList this@@15))) FullPerm)))))) (and (and (state Heap@@19 Mask@0) (state Heap@@19 Mask@0)) (and (<= 0 index@@3) (state Heap@@19 Mask@0)))) (and (and (=> (= (ControlFlow 0 13) 12) anon7_Else_correct) (=> (= (ControlFlow 0 13) 2) anon8_Then_correct)) (=> (= (ControlFlow 0 13) 4) anon8_Else_correct)))))
