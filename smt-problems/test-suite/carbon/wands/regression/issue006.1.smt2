...
(declare-fun y_1@@0 () T@U)
(declare-fun b_1_1 () Bool)
(declare-fun b_2@0 () Bool)
(declare-fun b_2 () Bool)
(declare-fun UsedHeap@0 () T@U)
(assert  (and (and (and (and (and (and (= (type Ops_1Heap@0) (MapType0Type RefType)) (= (type Used_1Heap@0) (MapType0Type RefType))) (= (type x_1@@0) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@13) (MapType0Type RefType))) (= (type y_1@@0) RefType)) (= (type UsedHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test03)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (= b_1_1@1  (and b_1_1@0 (state Ops_1Heap@0 ZeroMask))) (=> (and (= b_1_1@2  (and b_1_1@1 (state Ops_1Heap@0 ZeroMask))) (= b_2_1@0  (and b_2_1 (state Used_1Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (and (and b_1_1@2 b_1_1@2) b_2_1@0) (= x_1@@0 x_1@@0))) (=> (=> (and (and b_1_1@2 b_1_1@2) b_2_1@0) (= x_1@@0 x_1@@0)) (=> (= Mask@0 (MapType1Store ZeroMask null (wand true (= x_1@@0 x_1@@0)) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (wand true (= x_1@@0 x_1@@0)))) FullPerm)))) (=> (and (and (state Heap@@13 Mask@0) (state Heap@@13 Mask@0)) (and (state Heap@@13 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (wand true (= x_1@@0 x_1@@0)))))))))))))
(let ((anon3_Else_correct  (=> (and (not b_1_1@0) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and b_1_1@0 (= (ControlFlow 0 4) 2)) anon2_correct)))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@13 x_1@@0 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@13 y_1@@0 $allocated)) (state Heap@@13 ZeroMask)) (and (= b_1_1@0  (and b_1_1 (state Ops_1Heap@0 ZeroMask))) (= b_2@0  (and b_2 (state UsedHeap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 6) 4) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))))
