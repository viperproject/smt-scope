...
(assert  (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type diz@@8) RefType)) (= (type Heap@@13) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
...
(let ((anon3_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= perm@0 (U_2_real (MapType1Select Mask@1 null (C__P diz@@8))))) (=> (<= perm@0 (U_2_real (MapType1Select Mask@1 null (C__P diz@@8)))) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@13 diz@@8 $allocated)) (not (= diz@@8 null)))) (and (and (state Heap@@13 ZeroMask) (= Mask@0 (MapType1Store ZeroMask null (C__P diz@@8) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (C__P diz@@8))) FullPerm))))) (and (state Heap@@13 Mask@0) (state Heap@@13 Mask@0)))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (not (= diz@@8 null))) (=> (not (= diz@@8 null)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (> (U_2_real (MapType1Select Mask@0 null (C__P diz@@8))) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@0 null (C__P diz@@8))) NoPerm) (=> (and (and (> wildcard@0 NoPerm) (< wildcard@0 (U_2_real (MapType1Select Mask@0 null (C__P diz@@8))))) (and (= Mask@1 (MapType1Store Mask@0 null (C__P diz@@8) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (C__P diz@@8))) wildcard@0)))) (= perm@0 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))))))))
