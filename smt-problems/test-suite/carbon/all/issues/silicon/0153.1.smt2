...
(assert (forall ((Heap@@2 T@U) (this T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type this) RefType)) (dummyFunction (bool_2_U (|fun#triggerStateless| this))))
 :qid |stdinbpl.197:15|
 :skolemid |23|
 :pattern ( (|fun'| Heap@@2 this))
)))
...
(assert (forall ((Heap@@6 T@U) (Mask@@6 T@U) (this@@0 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@6) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (= (type this@@0) RefType)) (and (state Heap@@6 Mask@@6) (< AssumeFunctionsAbove 0))) (not (= (MapType0Select Heap@@6 this@@0 f_7) null))) (fun Heap@@6 this@@0))
 :qid |stdinbpl.203:15|
 :skolemid |24|
 :pattern ( (state Heap@@6 Mask@@6) (fun Heap@@6 this@@0))
)))
(assert (forall ((arg0@@26 T@U) ) (! (= (type (FrameFragment arg0@@26)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@26))
)))
(assert (forall ((Heap@@7 T@U) (Mask@@7 T@U) (this@@1 T@U) ) (!  (=> (and (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (= (type this@@1) RefType)) (state Heap@@7 Mask@@7)) (= (|fun'| Heap@@7 this@@1) (|fun#frame| (FrameFragment (MapType0Select Heap@@7 this@@1 f_7)) this@@1)))
 :qid |stdinbpl.210:15|
 :skolemid |25|
 :pattern ( (state Heap@@7 Mask@@7) (|fun'| Heap@@7 this@@1))
)))
(assert (forall ((Heap@@8 T@U) (this@@2 T@U) ) (!  (=> (and (= (type Heap@@8) (MapType0Type RefType)) (= (type this@@2) RefType)) (and (= (fun Heap@@8 this@@2) (|fun'| Heap@@8 this@@2)) (dummyFunction (bool_2_U (|fun#triggerStateless| this@@2)))))
 :qid |stdinbpl.193:15|
 :skolemid |22|
 :pattern ( (fun Heap@@8 this@@2))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (= (type Mask@3) (MapType1Type RefType realType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type other) RefType)) (= (type Heap@@13) (MapType0Type RefType))) (= (type this@@3) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type PostMask@2) (MapType1Type RefType realType))) (= (type PostMask@1) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id posterr01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon4_correct  (=> (and (= PostMask@2 (MapType1Store PostMask@1 this@@3 f_7 (real_2_U (- (U_2_real (MapType1Select PostMask@1 this@@3 f_7)) perm@6)))) (= (ControlFlow 0 15) (- 0 14))) (not (= (MapType0Select PostHeap@0 this@@3 f_7) null)))))
(let ((anon13_Else_correct  (=> (and (= perm@6 NoPerm) (= (ControlFlow 0 18) 15)) anon4_correct)))
(let ((anon13_Then_correct  (=> (not (= perm@6 NoPerm)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= perm@6 (U_2_real (MapType1Select PostMask@1 this@@3 f_7)))) (=> (<= perm@6 (U_2_real (MapType1Select PostMask@1 this@@3 f_7))) (=> (= (ControlFlow 0 16) 15) anon4_correct))))))
(let ((anon12_Then_correct  (=> (= perm@6 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (>= perm@6 NoPerm)) (=> (>= perm@6 NoPerm) (and (=> (= (ControlFlow 0 19) 16) anon13_Then_correct) (=> (= (ControlFlow 0 19) 18) anon13_Else_correct)))))))
(let ((anon12_Else_correct true))
(let ((anon11_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (= perm@2 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 21) (- 0 23)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (=> (> perm@2 NoPerm) (not (= this@@3 null))) (=> (and (and (= PostMask@0 (MapType1Store ZeroMask this@@3 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@3 f_7)) perm@2)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (= perm@3 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (>= perm@3 NoPerm)) (=> (>= perm@3 NoPerm) (=> (=> (> perm@3 NoPerm) (not (= other null))) (=> (and (and (= PostMask@1 (MapType1Store PostMask@0 other f_7 (real_2_U (+ (U_2_real (MapType1Select PostMask@0 other f_7)) perm@3)))) (state PostHeap@0 PostMask@1)) (and (state PostHeap@0 PostMask@1) (state PostHeap@0 PostMask@1))) (and (=> (= (ControlFlow 0 21) 19) anon12_Then_correct) (=> (= (ControlFlow 0 21) 13) anon12_Else_correct)))))))))))))
(let ((anon10_correct  (=> (and (= Mask@3 (MapType1Store Mask@2 other f_7 (real_2_U (- (U_2_real (MapType1Select Mask@2 other f_7)) perm@5)))) (= (ControlFlow 0 2) (- 0 1))) (fun Heap@@13 this@@3))))
(let ((anon15_Else_correct  (=> (and (= perm@5 NoPerm) (= (ControlFlow 0 5) 2)) anon10_correct)))
(let ((anon15_Then_correct  (=> (not (= perm@5 NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= perm@5 (U_2_real (MapType1Select Mask@2 other f_7)))) (=> (<= perm@5 (U_2_real (MapType1Select Mask@2 other f_7))) (=> (= (ControlFlow 0 3) 2) anon10_correct))))))
(let ((anon8_correct  (=> (and (= Mask@2 (MapType1Store Mask@1 this@@3 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 this@@3 f_7)) perm@4)))) (= perm@5 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (>= perm@5 NoPerm)) (=> (>= perm@5 NoPerm) (and (=> (= (ControlFlow 0 6) 3) anon15_Then_correct) (=> (= (ControlFlow 0 6) 5) anon15_Else_correct)))))))
(let ((anon14_Else_correct  (=> (and (= perm@4 NoPerm) (= (ControlFlow 0 10) 6)) anon8_correct)))
(let ((anon14_Then_correct  (=> (not (= perm@4 NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= perm@4 (U_2_real (MapType1Select Mask@1 this@@3 f_7)))) (=> (<= perm@4 (U_2_real (MapType1Select Mask@1 this@@3 f_7))) (=> (= (ControlFlow 0 8) 6) anon8_correct))))))
(let ((anon11_Else_correct  (=> (= perm@4 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (>= perm@4 NoPerm)) (=> (>= perm@4 NoPerm) (and (=> (= (ControlFlow 0 11) 8) anon14_Then_correct) (=> (= (ControlFlow 0 11) 10) anon14_Else_correct)))))))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@13 this@@3 $allocated))) (and (U_2_bool (MapType0Select Heap@@13 other $allocated)) (= perm@0 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 24) (- 0 26)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= this@@3 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask this@@3 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@3 f_7)) perm@0)))) (state Heap@@13 Mask@0)) (and (state Heap@@13 Mask@0) (= perm@1 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 24) (- 0 25)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (and (=> (> perm@1 NoPerm) (not (= other null))) (= Mask@1 (MapType1Store Mask@0 other f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 other f_7)) perm@1))))) (and (state Heap@@13 Mask@1) (state Heap@@13 Mask@1))) (and (=> (= (ControlFlow 0 24) 21) anon11_Then_correct) (=> (= (ControlFlow 0 24) 11) anon11_Else_correct)))))))))))))
