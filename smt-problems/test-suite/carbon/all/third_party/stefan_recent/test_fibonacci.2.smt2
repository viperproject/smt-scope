...
(assert  (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type diz@@5) RefType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type PostMask@1) (MapType1Type RefType realType))) (= (type Heap@@14) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id Fib__joinOperator)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon10_Else_correct true))
(let ((anon10_Then_correct true))
(let ((anon9_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (= perm@0 (/ (to_real 1) (to_real 10)))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= diz@@5 null))) (=> (and (and (and (= PostMask@0 (MapType1Store ZeroMask diz@@5 Fib__input (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz@@5 Fib__input)) perm@0)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (not (= diz@@5 null)))) (and (and (= PostMask@1 (MapType1Store PostMask@0 diz@@5 Fib__output (real_2_U (+ (U_2_real (MapType1Select PostMask@0 diz@@5 Fib__output)) FullPerm)))) (state PostHeap@0 PostMask@1)) (and (state PostHeap@0 PostMask@1) (state PostHeap@0 PostMask@1)))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (HasDirectPerm PostMask@1 diz@@5 Fib__output)) (=> (HasDirectPerm PostMask@1 diz@@5 Fib__output) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm PostMask@1 diz@@5 Fib__input)) (=> (HasDirectPerm PostMask@1 diz@@5 Fib__input) (and (=> (= (ControlFlow 0 5) 3) anon10_Then_correct) (=> (= (ControlFlow 0 5) 4) anon10_Else_correct)))))))))))))
(let ((anon9_Else_correct true))
(let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@14 diz@@5 $allocated)) (not (= diz@@5 null))) (and (state Heap@@14 ZeroMask) (>= current_thread_id 0))) (and (and (state Heap@@14 ZeroMask) (= Mask@0 (MapType1Store ZeroMask null (Fib__joinToken diz@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Fib__joinToken diz@@5))) FullPerm))))) (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0)))) (and (=> (= (ControlFlow 0 9) 5) anon9_Then_correct) (=> (= (ControlFlow 0 9) 2) anon9_Else_correct))))))
