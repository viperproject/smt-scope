...
(assert  (and (and (and (and (and (and (and (and (and (= (type this@@5) RefType) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (forall ((arg0@@28 T@U) ) (! (= (type (FrameFragment arg0@@28)) FrameTypeType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon4_correct  (=> (and (not (= this@@5 null)) (= Mask@3 (MapType1Store Mask@2 this@@5 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@2 this@@5 f_7)) FullPerm))))) (=> (and (and (state Heap@1 Mask@3) (state Heap@1 Mask@3)) (and (state Heap@1 Mask@3) (= (ControlFlow 0 2) (- 0 1)))) (= FullPerm (U_2_real (MapType1Select Mask@3 this@@5 g)))))))
(let ((anon6_Else_correct  (=> (HasDirectPerm Mask@2 null (valid this@@5 true)) (=> (and (= Heap@1 Heap@@10) (= (ControlFlow 0 4) 2)) anon4_correct))))
(let ((anon6_Then_correct  (=> (and (and (not (HasDirectPerm Mask@2 null (valid this@@5 true))) (= Heap@0 (MapType0Store Heap@@10 null (valid this@@5 true) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 3) 2))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@2 (MapType1Store Mask@1 null (valid this@@5 true) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (valid this@@5 true))) FullPerm)))) (and (=> (= (ControlFlow 0 5) 3) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (valid this@@5 true))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (valid this@@5 true)))) (=> (= (ControlFlow 0 6) 5) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 this@@5 $allocated))) (=> (and (and (and (= Mask@0 (MapType1Store ZeroMask null (valid this@@5 b_2@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid this@@5 b_2@@5))) FullPerm)))) (state Heap@@10 Mask@0)) (and (state Heap@@10 Mask@0) (= Mask@1 (MapType1Store Mask@0 null (valid this@@5  (not b_2@@5)) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (valid this@@5  (not b_2@@5)))) FullPerm)))))) (and (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1)) (and (|valid#trigger| Heap@@10 (valid this@@5 true)) (= (MapType0Select Heap@@10 null (valid this@@5 true)) (FrameFragment (FrameFragment (MapType0Select Heap@@10 this@@5 f_7))))))) (and (=> (= (ControlFlow 0 9) 6) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct))))))
