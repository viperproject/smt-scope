...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((i_1 Int) ) (!  (=> (dummyFunction (MapType0Select Heap@@9 x@@8 f_7)) (>= (ite (= i_1 2) FullPerm NoPerm) NoPerm))
 :qid |stdinbpl.248:17|
 :skolemid |22|
))) (=> (forall ((i_1@@0 Int) ) (!  (=> (dummyFunction (MapType0Select Heap@@9 x@@8 f_7)) (>= (ite (= i_1@@0 2) FullPerm NoPerm) NoPerm))
 :qid |stdinbpl.248:17|
 :skolemid |22|
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((i_1@@1 Int) (i_1_1 Int) ) (!  (=> (and (and (not (= i_1@@1 i_1_1)) (< NoPerm (ite (= i_1@@1 2) FullPerm NoPerm))) (< NoPerm (ite (= i_1_1 2) FullPerm NoPerm))) (not (= x@@8 x@@8)))
 :qid |stdinbpl.255:17|
 :skolemid |23|
 :pattern ( (neverTriggered1 i_1@@1) (neverTriggered1 i_1_1))
))) (=> (forall ((i_1@@2 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (not (= i_1@@2 i_1_1@@0)) (< NoPerm (ite (= i_1@@2 2) FullPerm NoPerm))) (< NoPerm (ite (= i_1_1@@0 2) FullPerm NoPerm))) (not (= x@@8 x@@8)))
 :qid |stdinbpl.255:17|
 :skolemid |23|
 :pattern ( (neverTriggered1 i_1@@2) (neverTriggered1 i_1_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((i_1@@3 Int) ) (! (>= (U_2_real (MapType1Select Mask@0 x@@8 f_7)) (ite (= i_1@@3 2) FullPerm NoPerm))
 :qid |stdinbpl.262:17|
 :skolemid |24|
)))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (=> (and (and (not (= x@@8 null)) (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 6) 1) anon3_Then_correct) (=> (= (ControlFlow 0 6) 3) anon3_Else_correct))))))
