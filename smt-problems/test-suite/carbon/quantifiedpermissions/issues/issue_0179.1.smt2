...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type S@0) (MapType2Type RefType boolType)) (= (type s@@3) RefType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@2) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv1 arg0@@43)) RefType)
 :qid |funType:invRecv1|
 :pattern ( (invRecv1 arg0@@43))
))) (= (type freshObj@0) RefType)) (= (type freshObj@1) RefType)) (= (type freshObj@2) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type s1) RefType)) (= (type s2) RefType)) (= (type s3) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test04)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon5_correct true))
(let ((anon9_Else_correct  (=> (and (not (U_2_bool (MapType2Select S@0 s@@3))) (= (ControlFlow 0 6) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (U_2_bool (MapType2Select S@0 s@@3)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@2 s@@3 val)) (=> (HasDirectPerm Mask@2 s@@3 val) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
(let ((anon8_Else_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 12)) (forall ((s_1 T@U) (s_1_1 T@U) ) (!  (=> (and (= (type s_1) RefType) (= (type s_1_1) RefType)) (=> (and (and (and (and (not (= s_1 s_1_1)) (U_2_bool (MapType2Select S@0 s_1))) (U_2_bool (MapType2Select S@0 s_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1 s_1_1))))
 :qid |stdinbpl.476:17|
 :skolemid |82|
...
)) (and (=> (= (ControlFlow 0 7) (- 0 11)) (forall ((s_1@@1 T@U) ) (!  (=> (and (= (type s_1@@1) RefType) (U_2_bool (MapType2Select S@0 s_1@@1))) (>= (U_2_real (MapType1Select Mask@2 s_1@@1 val)) FullPerm))
 :qid |stdinbpl.483:17|
 :skolemid |83|
 :pattern ( (MapType0Select Heap@2 s_1@@1 val))
 :pattern ( (MapType1Select QPMask@0 s_1@@1 val))
 :pattern ( (MapType2Select S@0 s_1@@1))
))) (=> (forall ((s_1@@2 T@U) ) (!  (=> (and (= (type s_1@@2) RefType) (U_2_bool (MapType2Select S@0 s_1@@2))) (>= (U_2_real (MapType1Select Mask@2 s_1@@2 val)) FullPerm))
 :qid |stdinbpl.483:17|
 :skolemid |83|
 :pattern ( (MapType0Select Heap@2 s_1@@2 val))
 :pattern ( (MapType1Select QPMask@0 s_1@@2 val))
 :pattern ( (MapType2Select S@0 s_1@@2))
)) (=> (forall ((s_1@@3 T@U) ) (!  (=> (= (type s_1@@3) RefType) (=> (and (U_2_bool (MapType2Select S@0 s_1@@3)) (< NoPerm FullPerm)) (and (qpRange1 s_1@@3) (= (invRecv1 s_1@@3) s_1@@3))))
 :qid |stdinbpl.489:22|
 :skolemid |84|
 :pattern ( (MapType0Select Heap@2 s_1@@3 val))
 :pattern ( (MapType1Select QPMask@0 s_1@@3 val))
 :pattern ( (MapType2Select S@0 s_1@@3))
)) (=> (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType2Select S@0 (invRecv1 o_3))) (and (< NoPerm FullPerm) (qpRange1 o_3))) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.493:22|
 :skolemid |85|
 :pattern ( (invRecv1 o_3))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType2Select S@0 (invRecv1 o_3@@0))) (and (< NoPerm FullPerm) (qpRange1 o_3@@0))) (and (= (invRecv1 o_3@@0) o_3@@0) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (- (U_2_real (MapType1Select Mask@2 o_3@@0 val)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select S@0 (invRecv1 o_3@@0))) (and (< NoPerm FullPerm) (qpRange1 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select Mask@2 o_3@@0 val))))))
 :qid |stdinbpl.499:22|
 :skolemid |86|
...
)) (state Heap@2 Mask@2))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (U_2_bool (MapType2Select S@0 freshObj@0))) (=> (U_2_bool (MapType2Select S@0 freshObj@0)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (U_2_bool (MapType2Select S@0 freshObj@1))) (=> (U_2_bool (MapType2Select S@0 freshObj@1)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (U_2_bool (MapType2Select S@0 freshObj@2))) (=> (U_2_bool (MapType2Select S@0 freshObj@2)) (=> (state Heap@2 Mask@2) (and (and (=> (= (ControlFlow 0 7) 2) anon8_Else_correct) (=> (= (ControlFlow 0 7) 4) anon9_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))))))))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 s1 $allocated))) (and (U_2_bool (MapType0Select Heap@@9 s2 $allocated)) (U_2_bool (MapType0Select Heap@@9 s3 $allocated)))) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@9 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@9 freshObj@0 $allocated (bool_2_U true)))) (and (= Mask@0 (MapType1Store ZeroMask freshObj@0 val (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 val)) FullPerm)))) (state Heap@0 Mask@0))) (=> (and (and (and (and (not (= freshObj@1 null)) (not (U_2_bool (MapType0Select Heap@0 freshObj@1 $allocated)))) (= Heap@1 (MapType0Store Heap@0 freshObj@1 $allocated (bool_2_U true)))) (and (= Mask@1 (MapType1Store Mask@0 freshObj@1 val (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@1 val)) FullPerm)))) (state Heap@1 Mask@1))) (and (and (and (not (= freshObj@2 null)) (not (U_2_bool (MapType0Select Heap@1 freshObj@2 $allocated)))) (= Heap@2 (MapType0Store Heap@1 freshObj@2 $allocated (bool_2_U true)))) (and (and (= Mask@2 (MapType1Store Mask@1 freshObj@2 val (real_2_U (+ (U_2_real (MapType1Select Mask@1 freshObj@2 val)) FullPerm)))) (state Heap@2 Mask@2)) (and (= S@0 (|Set#UnionOne| (|Set#UnionOne| (|Set#Singleton| freshObj@2) freshObj@1) freshObj@0)) (state Heap@2 Mask@2))))) (and (=> (= (ControlFlow 0 13) 1) anon7_Then_correct) (=> (= (ControlFlow 0 13) 7) anon7_Else_correct)))))))
