...
(assert  (and (and (and (and (= (type Heap@@33) (MapType0Type RefType)) (= (type diz) RefType)) (= (type freshObj@0) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id Ref__Ref)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (U_2_bool (MapType0Select Heap@@33 diz $allocated)) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@33 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@33 freshObj@0 $allocated (bool_2_U true)))) (and (and (= Mask@0 (MapType1Store ZeroMask freshObj@0 Ref__Integer_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 Ref__Integer_value)) FullPerm)))) (state Heap@0 Mask@0)) (and (state Heap@0 Mask@0) (= (ControlFlow 0 3) (- 0 4))))) (not (= freshObj@0 null))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (>= current_thread_id 0) (state Heap@@33 ZeroMask))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct)))))
