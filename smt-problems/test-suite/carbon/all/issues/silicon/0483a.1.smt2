...
(assert  (and (= (type order@@3) (SeqType intType)) (= (type Heap@@18) (MapType0Type RefType))))
(set-info :boogie-vc-id |CheckBounded#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon4_correct true))
(let ((anon8_Else_correct  (=> (and (< (U_2_int (|Seq#Index| order@@3 i_6)) 0) (= (ControlFlow 0 7) 2)) anon4_correct)))
(let ((anon8_Then_correct  (=> (<= 0 (U_2_int (|Seq#Index| order@@3 i_6))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (>= i_6 0)) (=> (>= i_6 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< i_6 (|Seq#Length| order@@3))) (=> (< i_6 (|Seq#Length| order@@3)) (=> (= (ControlFlow 0 4) 2) anon4_correct))))))))
(let ((anon7_Then_correct  (=> (and (<= 0 i_6) (< i_6 (|Seq#Length| order@@3))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (>= i_6 0)) (=> (>= i_6 0) (and (=> (= (ControlFlow 0 8) (- 0 9)) (< i_6 (|Seq#Length| order@@3))) (=> (< i_6 (|Seq#Length| order@@3)) (and (=> (= (ControlFlow 0 8) 4) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct)))))))))
(let ((anon7_Else_correct  (=> (and (not (and (<= 0 i_6) (< i_6 (|Seq#Length| order@@3)))) (= (ControlFlow 0 3) 2)) anon4_correct)))
(let ((anon6_Else_correct true))
(let ((anon0_correct  (=> (state Heap@@18 ZeroMask) (=> (and (= AssumeFunctionsAbove 1) (<= (|Seq#Length| order@@3) maxLen@@10)) (and (and (=> (= (ControlFlow 0 11) 1) anon6_Else_correct) (=> (= (ControlFlow 0 11) 8) anon7_Then_correct)) (=> (= (ControlFlow 0 11) 3) anon7_Else_correct))))))
