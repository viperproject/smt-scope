...
(declare-fun x@@8 () T@U)
(assert  (and (= (type Heap@@10) (MapType0Type RefType)) (= (type x@@8) RefType)))
(set-info :boogie-vc-id testPred2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x@@8 $allocated))) (=> (and (and (<= FullPerm (U_2_real (MapType1Select ZeroMask null (Tree x@@8)))) (state Heap@@10 ZeroMask)) (and (state Heap@@10 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) false))))
