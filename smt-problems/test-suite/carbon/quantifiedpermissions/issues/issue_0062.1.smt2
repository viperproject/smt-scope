...
(assert  (and (and (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type x@@22) RefType)) (= (type y@@7) RefType)) (= (type z@@0) RefType)) (= (type xs) (MapType2Type RefType boolType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@22 $allocated))) (and (U_2_bool (MapType0Select Heap@@9 y@@7 $allocated)) (U_2_bool (MapType0Select Heap@@9 z@@0 $allocated)))) (and (and (U_2_bool (MapType2Select xs x@@22)) (U_2_bool (MapType2Select xs y@@7))) (and (U_2_bool (MapType2Select xs z@@0)) (state Heap@@9 ZeroMask)))) (and (and (and (not (= x@@22 null)) (= Mask@0 (MapType1Store ZeroMask x@@22 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@22 f_7)) FullPerm))))) (and (state Heap@@9 Mask@0) (not (= y@@7 null)))) (and (and (= Mask@1 (MapType1Store Mask@0 y@@7 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@7 f_7)) FullPerm)))) (state Heap@@9 Mask@1)) (and (state Heap@@9 Mask@1) (= (ControlFlow 0 2) (- 0 1)))))) (not (= x@@22 y@@7)))))
