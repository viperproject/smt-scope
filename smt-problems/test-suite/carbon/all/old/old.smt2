...
(assert  (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type this) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id t5)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon2_correct  (=> (and (and (and (= Mask@1 (MapType1Store Mask@0 this f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 this f_7)) FullPerm)))) (IdenticalOnKnownLocations Heap@0 ExhaleHeap@0 Mask@1)) (and (not (= this null)) (= Mask@2 (MapType1Store Mask@1 this f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@1 this f_7)) FullPerm)))))) (and (and (state ExhaleHeap@0 Mask@2) (= (U_2_int (MapType0Select ExhaleHeap@0 this f_7)) (+ (U_2_int (MapType0Select Heap@0 this f_7)) 1))) (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@2 this f_7)) (=> (HasDirectPerm Mask@2 this f_7) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (U_2_int (MapType0Select ExhaleHeap@0 this f_7)) 11)) (=> (= (U_2_int (MapType0Select ExhaleHeap@0 this f_7)) 11) (=> (and (state ExhaleHeap@0 Mask@2) (= (ControlFlow 0 2) (- 0 1))) false))))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@0 this f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 this f_7))) (=> (= (ControlFlow 0 5) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 this $allocated))) (=> (and (and (not (= this null)) (= Mask@0 (MapType1Store ZeroMask this f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this f_7)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (= FullPerm (U_2_real (MapType1Select Mask@0 this f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 this f_7))) (=> (and (= Heap@0 (MapType0Store Heap@@9 this f_7 (int_2_U 10))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 8) 5) anon3_Then_correct) (=> (= (ControlFlow 0 8) 7) anon3_Else_correct)))))))))
