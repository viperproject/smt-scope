(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 19:54:25
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/issues/silicon/0292.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (<= $Perm.No (- $Perm.Write $k@7@00)))
(push) ; 5
(set-option :timeout 10)
