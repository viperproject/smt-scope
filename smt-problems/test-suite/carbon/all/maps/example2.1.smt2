...
(assert  (and (= (type m@@23) (MapType intType intType)) (= (type Heap@@9) (MapType1Type RefType))))
(set-info :boogie-vc-id test10)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon5_correct true))
(let ((anon9_Else_correct  (=> (and (not (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i_7)))) (= (ControlFlow 0 13) 10)) anon5_correct)))
(let ((anon9_Then_correct  (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i_7))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i_7)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i_7))) (=> (= (ControlFlow 0 11) 10) anon5_correct))))))
(let ((anon8_Else_correct  (=> (and (forall ((i_3 T@U) ) (!  (=> (and (= (type i_3) intType) (U_2_bool (MapType0Select (|Map#Domain| m@@23) i_3))) (= (U_2_int (MapType0Select (|Map#Elements| m@@23) i_3)) (* (U_2_int i_3) 2)))
 :qid |stdinbpl.1227:20|
 :skolemid |121|
 :pattern ( (MapType0Select (|Map#Elements| m@@23) i_3))
)) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 3) (- 0 9)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 0)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 0))) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 3) (- 0 8)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 1)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 1))) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 3) (- 0 7)) (not (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 10))))) (=> (not (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 10)))) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 3) (- 0 6)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 0)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 0))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (= (U_2_int (MapType0Select (|Map#Elements| m@@23) (int_2_U 0))) 0)) (=> (= (U_2_int (MapType0Select (|Map#Elements| m@@23) (int_2_U 0))) 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 2)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 2))) (=> (= (ControlFlow 0 3) (- 0 2)) (= (U_2_int (MapType0Select (|Map#Elements| m@@23) (int_2_U 2))) 4))))))))))))))))))))
(let ((anon7_Else_correct  (=> (and (forall ((i_1 T@U) ) (!  (=> (= (type i_1) intType) (=  (and (<= 0 (U_2_int i_1)) (< (U_2_int i_1) 10)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) i_1))))
 :qid |stdinbpl.1213:20|
 :skolemid |120|
 :pattern ( (MapType0Select (|Map#Domain| m@@23) i_1))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 14) 3) anon8_Else_correct) (=> (= (ControlFlow 0 14) 11) anon9_Then_correct)) (=> (= (ControlFlow 0 14) 13) anon9_Else_correct)))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 15) 1) anon7_Then_correct) (=> (= (ControlFlow 0 15) 14) anon7_Else_correct)))))
