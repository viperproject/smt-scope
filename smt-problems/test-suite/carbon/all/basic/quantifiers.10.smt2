...
(assert  (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type c) RefType)) (= (type Heap@@33) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type PostMask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id fail20ForallCellGet10)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 47) (let ((anon22_correct true))
(let ((anon50_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 41) 38)) anon22_correct)))
(let ((anon50_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 39) (- 0 40)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 c Cell_x)))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 c Cell_x))) (=> (= (ControlFlow 0 39) 38) anon22_correct))))))
(let ((anon27_correct true))
(let ((anon53_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 35) 32)) anon27_correct)))
(let ((anon53_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 33) (- 0 34)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 c Cell_x)))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 c Cell_x))) (=> (= (ControlFlow 0 33) 32) anon27_correct))))))
(let ((anon28_correct true))
(let ((anon51_Then_correct  (=> (and (<= 0 i2_3) (< i2_3 (Cell_get PostHeap@0 c))) (and (and (=> (= (ControlFlow 0 36) 30) anon28_correct) (=> (= (ControlFlow 0 36) 33) anon53_Then_correct)) (=> (= (ControlFlow 0 36) 35) anon53_Else_correct)))))
(let ((anon51_Else_correct  (=> (and (not (and (<= 0 i2_3) (< i2_3 (Cell_get PostHeap@0 c)))) (= (ControlFlow 0 31) 30)) anon28_correct)))
(let ((anon48_Then_correct  (=> (<= 0 i2_3) (and (and (and (=> (= (ControlFlow 0 42) 36) anon51_Then_correct) (=> (= (ControlFlow 0 42) 31) anon51_Else_correct)) (=> (= (ControlFlow 0 42) 39) anon50_Then_correct)) (=> (= (ControlFlow 0 42) 41) anon50_Else_correct)))))
(let ((anon48_Else_correct  (=> (< i2_3 0) (and (=> (= (ControlFlow 0 37) 36) anon51_Then_correct) (=> (= (ControlFlow 0 37) 31) anon51_Else_correct)))))
(let ((anon47_Else_correct true))
(let ((anon46_Then_correct  (=> (and (and (and (state PostHeap@0 ZeroMask) (not (= c null))) (and (state PostHeap@0 ZeroMask) (not (= c null)))) (and (and (= PostMask@0 (MapType1Store ZeroMask c Cell_x (real_2_U (+ (U_2_real (MapType1Select ZeroMask c Cell_x)) FullPerm)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)))) (and (and (=> (= (ControlFlow 0 43) 29) anon47_Else_correct) (=> (= (ControlFlow 0 43) 42) anon48_Then_correct)) (=> (= (ControlFlow 0 43) 37) anon48_Else_correct)))))
(let ((anon35_correct true))
(let ((anon56_Else_correct  (=> (and (not (and (<= 0 i2_2) (< i2_2 (Cell_get Heap@@33 c)))) (= (ControlFlow 0 22) 19)) anon35_correct)))
(let ((anon56_Then_correct  (=> (and (<= 0 i2_2) (< i2_2 (Cell_get Heap@@33 c))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (<= (Cell_get Heap@@33 c) i2_2)) (=> (<= (Cell_get Heap@@33 c) i2_2) (=> (= (ControlFlow 0 20) 19) anon35_correct))))))
(let ((anon55_Else_correct true))
(let ((anon32_correct  (=> (= Mask@1 (MapType1Store Mask@0 c Cell_x (real_2_U (- (U_2_real (MapType1Select Mask@0 c Cell_x)) FullPerm)))) (and (and (=> (= (ControlFlow 0 23) 18) anon55_Else_correct) (=> (= (ControlFlow 0 23) 20) anon56_Then_correct)) (=> (= (ControlFlow 0 23) 22) anon56_Else_correct)))))
(let ((anon54_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 26) 23)) anon32_correct)))
(let ((anon54_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (<= FullPerm (U_2_real (MapType1Select Mask@0 c Cell_x)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 c Cell_x))) (=> (= (ControlFlow 0 24) 23) anon32_correct))))))
(let ((anon46_Else_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) (not (= c null))) (=> (not (= c null)) (and (=> (= (ControlFlow 0 27) 24) anon54_Then_correct) (=> (= (ControlFlow 0 27) 26) anon54_Else_correct))))))
(let ((anon39_Else_correct  (=> (and (forall ((i1_1 Int) ) (!  (=> (and (<= 0 i1_1) (< i1_1 (Cell_get Heap@@33 c))) (>= (Cell_get Heap@@33 c) i1_1))
 :qid |stdinbpl.1482:20|
 :skolemid |148|
)) (state Heap@@33 Mask@0)) (and (=> (= (ControlFlow 0 44) 43) anon46_Then_correct) (=> (= (ControlFlow 0 44) 27) anon46_Else_correct)))))
(let ((anon9_correct true))
(let ((anon42_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 13)) anon9_correct)))
(let ((anon42_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (U_2_real (MapType1Select Mask@0 c Cell_x)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 c Cell_x))) (=> (= (ControlFlow 0 14) 13) anon9_correct))))))
(let ((anon14_correct true))
(let ((anon45_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 7)) anon14_correct)))
(let ((anon45_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select Mask@0 c Cell_x)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 c Cell_x))) (=> (= (ControlFlow 0 8) 7) anon14_correct))))))
(let ((anon15_correct true))
(let ((anon43_Then_correct  (=> (and (<= 0 i1_2) (< i1_2 (Cell_get Heap@@33 c))) (and (and (=> (= (ControlFlow 0 11) 5) anon15_correct) (=> (= (ControlFlow 0 11) 8) anon45_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon45_Else_correct)))))
(let ((anon43_Else_correct  (=> (and (not (and (<= 0 i1_2) (< i1_2 (Cell_get Heap@@33 c)))) (= (ControlFlow 0 6) 5)) anon15_correct)))
(let ((anon40_Then_correct  (=> (<= 0 i1_2) (and (and (and (=> (= (ControlFlow 0 17) 11) anon43_Then_correct) (=> (= (ControlFlow 0 17) 6) anon43_Else_correct)) (=> (= (ControlFlow 0 17) 14) anon42_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon42_Else_correct)))))
(let ((anon40_Else_correct  (=> (< i1_2 0) (and (=> (= (ControlFlow 0 12) 11) anon43_Then_correct) (=> (= (ControlFlow 0 12) 6) anon43_Else_correct)))))
(let ((anon37_Else_correct  (=> (> (Cell_get Heap@@33 c) 0) (=> (and (state Heap@@33 Mask@0) (state Heap@@33 Mask@0)) (and (and (=> (= (ControlFlow 0 45) 44) anon39_Else_correct) (=> (= (ControlFlow 0 45) 17) anon40_Then_correct)) (=> (= (ControlFlow 0 45) 12) anon40_Else_correct))))))
(let ((anon3_correct true))
(let ((anon38_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon38_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@0 c Cell_x)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 c Cell_x))) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@33 c $allocated)) (not (= c null))) (and (state Heap@@33 ZeroMask) (not (= c null)))) (and (and (= Mask@0 (MapType1Store ZeroMask c Cell_x (real_2_U (+ (U_2_real (MapType1Select ZeroMask c Cell_x)) FullPerm)))) (state Heap@@33 Mask@0)) (and (state Heap@@33 Mask@0) (state Heap@@33 Mask@0)))) (and (and (=> (= (ControlFlow 0 46) 45) anon37_Else_correct) (=> (= (ControlFlow 0 46) 2) anon38_Then_correct)) (=> (= (ControlFlow 0 46) 4) anon38_Else_correct))))))
...
(declare-fun Heap@@33 () T@U)
(declare-fun i_3 () Int)
(assert (= (type Heap@@33) (MapType0Type RefType)))
(set-info :boogie-vc-id failsRange10)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon8_correct true))
(let ((anon14_Else_correct  (=> (and (not (and (<= (- 0 1) i_1_1) (< i_1_1 a_2))) (= (ControlFlow 0 10) 7)) anon8_correct)))
(let ((anon14_Then_correct  (=> (and (<= (- 0 1) i_1_1) (< i_1_1 a_2)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (= (reqIGt0 Heap@@33 i_1_1) i_1_1)) (=> (= (reqIGt0 Heap@@33 i_1_1) i_1_1) (=> (= (ControlFlow 0 8) 7) anon8_correct))))))
(let ((anon12_Then_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (>= i_3 0))))
(let ((anon4_correct true))
(let ((anon11_Then_correct  (=> (and (<= (- 0 1) i_3) (< i_3 a_2)) (and (=> (= (ControlFlow 0 6) 5) anon12_Then_correct) (=> (= (ControlFlow 0 6) 2) anon4_correct)))))
(let ((anon11_Else_correct  (=> (and (not (and (<= (- 0 1) i_3) (< i_3 a_2))) (= (ControlFlow 0 3) 2)) anon4_correct)))
(let ((anon13_Else_correct true))
(let ((anon0_correct  (=> (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (and (and (and (=> (= (ControlFlow 0 11) 1) anon13_Else_correct) (=> (= (ControlFlow 0 11) 8) anon14_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon14_Else_correct)) (=> (= (ControlFlow 0 11) 6) anon11_Then_correct)) (=> (= (ControlFlow 0 11) 3) anon11_Else_correct)))))
