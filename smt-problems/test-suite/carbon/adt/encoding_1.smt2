...
(declare-fun List_tag1 (T@U) Int)
(declare-fun get_List_value1 (T@U) T@U)
(declare-fun get_List_tail1 (T@U) T@U)
...
(= (type (get_List_value1 arg0@@27)) T))
 :qid |funType:get_List_value1|
 :pattern ( (get_List_value1 arg0@@27))
))) (forall ((arg0@@28 T@U) ) (! (let ((T@@0 (ListDomainTypeTypeInv0 (type arg0@@28))))
(= (type (get_List_tail1 arg0@@28)) (ListDomainTypeType T@@0)))
 :qid |funType:get_List_tail1|
 :pattern ( (get_List_tail1 arg0@@28))
...
(assert (forall ((t_2 T@U) ) (! (let ((T@@3 (ListDomainTypeTypeInv0 (type t_2))))
 (=> (= (type t_2) (ListDomainTypeType T@@3)) (or (= t_2 (Nil T@@3)) (= t_2 (Cons (get_List_value1 t_2) (get_List_tail1 t_2))))))
 :qid |stdinbpl.238:19|
 :skolemid |26|
 :pattern ( (List_tag1 t_2))
 :pattern ( (get_List_value1 t_2))
 :pattern ( (get_List_tail1 t_2))
)))
...
(assert (forall ((value_1 T@U) (tail_1 T@U) ) (! (let ((T@@4 (type value_1)))
 (=> (= (type tail_1) (ListDomainTypeType T@@4)) (= value_1 (get_List_value1 (Cons value_1 tail_1)))))
 :qid |stdinbpl.214:19|
 :skolemid |22|
 :pattern ( (Cons value_1 tail_1))
)))
(assert (forall ((value_1@@0 T@U) (tail_1@@0 T@U) ) (! (let ((T@@5 (type value_1@@0)))
 (=> (= (type tail_1@@0) (ListDomainTypeType T@@5)) (= tail_1@@0 (get_List_tail1 (Cons value_1@@0 tail_1@@0)))))
 :qid |stdinbpl.220:19|
 :skolemid |23|
...
(assert (forall ((value_1@@1 T@U) (tail_1@@1 T@U) ) (! (let ((T@@6 (type value_1@@1)))
 (=> (= (type tail_1@@1) (ListDomainTypeType T@@6)) (= (List_tag1 (Cons value_1@@1 tail_1@@1)) 0)))
 :qid |stdinbpl.232:19|
 :skolemid |25|
...
(assert (forall ((T@@7 T@T) ) (! (= (List_tag1 (Nil T@@7)) 1)
 :skolemid |24|
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
...
(set-info :boogie-vc-id encoding_1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 5)) (not (= (List_tag1 (Cons (int_2_U 1) (Nil intType))) 1))) (=> (not (= (List_tag1 (Cons (int_2_U 1) (Nil intType))) 1)) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (List_tag1 (Cons (int_2_U 1) (Nil intType))) 0)) (=> (= (List_tag1 (Cons (int_2_U 1) (Nil intType))) 0) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (U_2_int (get_List_value1 (Cons (int_2_U 1) (Nil intType)))) 1)) (=> (= (U_2_int (get_List_value1 (Cons (int_2_U 1) (Nil intType)))) 1) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (get_List_tail1 (Cons (int_2_U 1) (Nil intType))) (Nil intType))))))))))))))
