...
(declare-fun y@@6 () T@U)
(assert  (and (and (and (and (and (and (= (type xs) (MapType2Type RefType boolType)) (= (type ys) (MapType2Type RefType boolType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv5 arg0@@43)) RefType)
 :qid |funType:invRecv5|
 :pattern ( (invRecv5 arg0@@43))
))) (= (type x@@19) RefType)) (= (type y@@6) RefType)))
(set-info :boogie-vc-id test05)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (U_2_bool (MapType2Select (|Set#Union| xs ys) z_1))) (U_2_bool (MapType2Select (|Set#Union| xs ys) z_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1))))
 :qid |stdinbpl.758:15|
 :skolemid |107|
 :no-pattern (type z_1)
...
))) (=> (forall ((z_1@@0 T@U) (z_1_1@@0 T@U) ) (!  (=> (and (= (type z_1@@0) RefType) (= (type z_1_1@@0) RefType)) (=> (and (and (and (and (not (= z_1@@0 z_1_1@@0)) (U_2_bool (MapType2Select (|Set#Union| xs ys) z_1@@0))) (U_2_bool (MapType2Select (|Set#Union| xs ys) z_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1@@0 z_1_1@@0))))
 :qid |stdinbpl.758:15|
 :skolemid |107|
...
)) (=> (and (forall ((z_1@@1 T@U) ) (!  (=> (= (type z_1@@1) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Union| xs ys) z_1@@1)) (< NoPerm FullPerm)) (and (qpRange5 z_1@@1) (= (invRecv5 z_1@@1) z_1@@1))))
 :qid |stdinbpl.764:22|
 :skolemid |108|
 :pattern ( (MapType0Select Heap@@9 z_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@1 f_7))
 :pattern ( (MapType2Select (|Set#Union| xs ys) z_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select (|Set#Union| xs ys) (invRecv5 o_3))) (< NoPerm FullPerm)) (qpRange5 o_3)) (= (invRecv5 o_3) o_3)))
 :qid |stdinbpl.768:22|
 :skolemid |109|
 :pattern ( (invRecv5 o_3))
))) (=> (and (and (and (forall ((z_1@@2 T@U) ) (!  (=> (and (= (type z_1@@2) RefType) (U_2_bool (MapType2Select (|Set#Union| xs ys) z_1@@2))) (not (= z_1@@2 null)))
 :qid |stdinbpl.774:22|
 :skolemid |110|
 :pattern ( (MapType0Select Heap@@9 z_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@2 f_7))
 :pattern ( (MapType2Select (|Set#Union| xs ys) z_1@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select (|Set#Union| xs ys) (invRecv5 o_3@@0))) (< NoPerm FullPerm)) (qpRange5 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv5 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select (|Set#Union| xs ys) (invRecv5 o_3@@0))) (< NoPerm FullPerm)) (qpRange5 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.780:22|
 :skolemid |111|
...
)) (state Heap@@9 QPMask@0))) (and (and (state Heap@@9 QPMask@0) (U_2_bool (MapType2Select xs x@@19))) (and (U_2_bool (MapType2Select ys y@@6)) (state Heap@@9 QPMask@0)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (not (= x@@19 null))) (=> (not (= x@@19 null)) (=> (= (ControlFlow 0 3) (- 0 2)) (not (= y@@6 null)))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 x@@19 $allocated)) (U_2_bool (MapType0Select Heap@@9 y@@6 $allocated))) (and (=> (= (ControlFlow 0 6) 1) anon3_Then_correct) (=> (= (ControlFlow 0 6) 3) anon3_Else_correct))))))
