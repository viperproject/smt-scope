...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (= (type S) (MapType2Type RefType boolType)) (= (type t_2_1) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type b_2) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv14 arg0@@43)) RefType)
 :qid |funType:invRecv14|
 :pattern ( (invRecv14 arg0@@43))
))) (= (type t_3) RefType)) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv13 arg0@@44)) RefType)
...
(let ((anon19_Else_correct  (=> (and (not (U_2_bool (MapType2Select S t_3))) (= (ControlFlow 0 16) 13)) anon8_correct)))
(let ((anon19_Then_correct  (=> (U_2_bool (MapType2Select S t_3)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm QPMask@2 t_3 f_7)) (=> (HasDirectPerm QPMask@2 t_3 f_7) (=> (= (ControlFlow 0 14) 13) anon8_correct))))))
(let ((anon18_Else_correct true))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (U_2_bool (MapType2Select S r_1))) (U_2_bool (MapType2Select S r_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1 r_1_1))))
...
)) (=> (forall ((r_1@@1 T@U) ) (!  (=> (= (type r_1@@1) RefType) (=> (and (U_2_bool (MapType2Select S r_1@@1)) (< NoPerm FullPerm)) (and (qpRange13 r_1@@1) (= (invRecv13 r_1@@1) r_1@@1))))
...
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select S (invRecv13 o_3))) (< NoPerm FullPerm)) (qpRange13 o_3)) (= (invRecv13 o_3) o_3)))
...
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select S (invRecv13 o_3@@0))) (< NoPerm FullPerm)) (qpRange13 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv13 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select S (invRecv13 o_3@@0))) (< NoPerm FullPerm)) (qpRange13 o_3@@0))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
(let ((anon21_Else_correct  (=> (and (not (U_2_bool (MapType2Select S t_2_1))) (= (ControlFlow 0 6) 3)) anon13_correct)))
(let ((anon21_Then_correct  (=> (U_2_bool (MapType2Select S t_2_1)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (> (U_2_int (MapType0Select Heap@0 t_2_1 f_7)) (* 2 a_2))) (=> (> (U_2_int (MapType0Select Heap@0 t_2_1 f_7)) (* 2 a_2)) (=> (= (ControlFlow 0 4) 3) anon13_correct))))))
(let ((anon20_Else_correct true))
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 10)) (= FullPerm (U_2_real (MapType1Select QPMask@0 b_2 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 b_2 f_7))) (=> (and (= Heap@0 (MapType0Store Heap@@9 b_2 f_7 (int_2_U (+ (* 2 a_2) 1)))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((r_2 T@U) (r_2_1 T@U) ) (!  (=> (and (= (type r_2) RefType) (= (type r_2_1) RefType)) (=> (and (and (and (and (not (= r_2 r_2_1)) (U_2_bool (MapType2Select S r_2))) (U_2_bool (MapType2Select S r_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_2 r_2_1))))
 :qid |stdinbpl.1443:17|
 :skolemid |171|
 :pattern ( (neverTriggered14 r_2) (neverTriggered14 r_2_1))
 ...
 :qid |stdinbpl.1443:17|
 :skolemid |171|
 :pattern ( (neverTriggered14 r_2@@0) (neverTriggered14 r_2_1@@0))
)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((r_2@@1 T@U) ) (!  (=> (and (= (type r_2@@1) RefType) (U_2_bool (MapType2Select S r_2@@1))) (>= (U_2_real (MapType1Select QPMask@0 r_2@@1 f_7)) FullPerm))
...
)) (=> (and (and (forall ((r_2@@3 T@U) ) (!  (=> (= (type r_2@@3) RefType) (=> (and (U_2_bool (MapType2Select S r_2@@3)) (< NoPerm FullPerm)) (and (qpRange14 r_2@@3) (= (invRecv14 r_2@@3) r_2@@3))))
...
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType2Select S (invRecv14 o_3@@2))) (and (< NoPerm FullPerm) (qpRange14 o_3@@2))) (= (invRecv14 o_3@@2) o_3@@2)))
 :qid |stdinbpl.1460:22|
 :skolemid |174|
 :pattern ( (invRecv14 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType2Select S (invRecv14 o_3@@3))) (and (< NoPerm FullPerm) (qpRange14 o_3@@3))) (and (= (invRecv14 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (- (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select S (invRecv14 o_3@@3))) (and (< NoPerm FullPerm) (qpRange14 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7))))))
...
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 22)) (forall ((s_1 T@U) (s_1_1 T@U) ) (!  (=> (and (= (type s_1) RefType) (= (type s_1_1) RefType)) (=> (and (and (and (and (not (= s_1 s_1_1)) (U_2_bool (MapType2Select S s_1))) (U_2_bool (MapType2Select S s_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1 s_1_1))))
...
)) (=> (forall ((s_1@@1 T@U) ) (!  (=> (= (type s_1@@1) RefType) (=> (and (U_2_bool (MapType2Select S s_1@@1)) (< NoPerm FullPerm)) (and (qpRange12 s_1@@1) (= (invRecv12 s_1@@1) s_1@@1))))
...
)) (=> (and (and (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (U_2_bool (MapType2Select S (invRecv12 o_3@@5))) (< NoPerm FullPerm)) (qpRange12 o_3@@5)) (= (invRecv12 o_3@@5) o_3@@5)))
...
))) (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (U_2_bool (MapType2Select S (invRecv12 o_3@@6))) (< NoPerm FullPerm)) (qpRange12 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv12 o_3@@6) o_3@@6)) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@6 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select S (invRecv12 o_3@@6))) (< NoPerm FullPerm)) (qpRange12 o_3@@6))) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@6 f_7))))))
...
)))) (and (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)) (and (|Set#Equal| S (|Set#Singleton| b_2)) (state Heap@@9 QPMask@0)))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (HasDirectPerm QPMask@0 b_2 f_7)) (=> (HasDirectPerm QPMask@0 b_2 f_7) (=> (and (= (U_2_int (MapType0Select Heap@@9 b_2 f_7)) a_2) (state Heap@@9 QPMask@0)) (and (=> (= (ControlFlow 0 20) 19) anon16_Then_correct) (=> (= (ControlFlow 0 20) 7) anon16_Else_correct)))))))))))
(let ((anon15_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 b_2 $allocated))) (and (=> (= (ControlFlow 0 23) 1) anon15_Then_correct) (=> (= (ControlFlow 0 23) 20) anon15_Else_correct)))))
