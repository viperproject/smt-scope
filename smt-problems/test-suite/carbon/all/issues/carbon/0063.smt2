...
(declare-fun LinkedListvalid (T@U) T@U)
(declare-fun PredicateType_LinkedListvalidType () T@T)
(declare-fun |LinkedListvalid#trigger| (T@U T@U) Bool)
(declare-fun |LinkedListvalid#everUsed| (T@U) Bool)
(declare-fun $allocated () T@U)
(declare-fun NormalFieldType () T@T)
(declare-fun |LinkedListvalid#sm| (T@U) T@U)
...
(assert  (and (= (Ctor PredicateType_LinkedListvalidType) 11) (forall ((arg0@@25 T@U) ) (! (= (type (LinkedListvalid arg0@@25)) (FieldType PredicateType_LinkedListvalidType FrameTypeType))
 :qid |funType:LinkedListvalid|
 :pattern ( (LinkedListvalid arg0@@25))
))))
(assert (forall ((this T@U) ) (!  (=> (= (type this) RefType) (IsPredicateField (LinkedListvalid this)))
 :qid |stdinbpl.186:15|
 :skolemid |23|
 :pattern ( (LinkedListvalid this))
)))
(assert (forall ((Heap@@2 T@U) (this@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type this@@0) RefType)) (|LinkedListvalid#everUsed| (LinkedListvalid this@@0)))
 :qid |stdinbpl.205:15|
 :skolemid |27|
 :pattern ( (|LinkedListvalid#trigger| Heap@@2 (LinkedListvalid this@@0)))
)))
...
(assert (forall ((this@@1 T@U) (this2 T@U) ) (!  (=> (and (and (= (type this@@1) RefType) (= (type this2) RefType)) (= (LinkedListvalid this@@1) (LinkedListvalid this2))) (= this@@1 this2))
 :qid |stdinbpl.196:15|
 :skolemid |25|
 :pattern ( (LinkedListvalid this@@1) (LinkedListvalid this2))
)))
(assert (forall ((arg0@@26 T@U) ) (! (= (type (|LinkedListvalid#sm| arg0@@26)) (FieldType PredicateType_LinkedListvalidType (MapType1Type RefType boolType)))
 :qid |funType:LinkedListvalid#sm|
 :pattern ( (|LinkedListvalid#sm| arg0@@26))
)))
(assert (forall ((this@@2 T@U) (this2@@0 T@U) ) (!  (=> (and (and (= (type this@@2) RefType) (= (type this2@@0) RefType)) (= (|LinkedListvalid#sm| this@@2) (|LinkedListvalid#sm| this2@@0))) (= this@@2 this2@@0))
 :qid |stdinbpl.200:15|
 :skolemid |26|
 :pattern ( (|LinkedListvalid#sm| this@@2) (|LinkedListvalid#sm| this2@@0))
)))
...
(assert (forall ((this@@3 T@U) ) (!  (=> (= (type this@@3) RefType) (= (getPredWandId (LinkedListvalid this@@3)) 0))
 :qid |stdinbpl.190:15|
 :skolemid |24|
 :pattern ( (LinkedListvalid this@@3))
)))
...
(assert (forall ((this@@4 T@U) ) (!  (=> (= (type this@@4) RefType) (= (PredicateMaskField (LinkedListvalid this@@4)) (|LinkedListvalid#sm| this@@4)))
 :qid |stdinbpl.182:15|
 :skolemid |22|
 :pattern ( (PredicateMaskField (LinkedListvalid this@@4)))
)))
...
(declare-fun i () Int)
(assert  (and (and (= (type UnfoldingMask@0) (MapType1Type RefType realType)) (= (type this@@5) RefType)) (= (type Heap@@10) (MapType0Type RefType))))
(set-info :boogie-vc-id LinkedListSearch)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (and (and (= UnfoldingMask@0 (MapType1Store ZeroMask null (LinkedListvalid this@@5) (real_2_U (- (U_2_real (MapType1Select ZeroMask null (LinkedListvalid this@@5))) FullPerm)))) (state Heap@@10 UnfoldingMask@0)) (and (state Heap@@10 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (<= i 5))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select ZeroMask null (LinkedListvalid this@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select ZeroMask null (LinkedListvalid this@@5)))) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 this@@5 $allocated))) (and (|LinkedListvalid#trigger| Heap@@10 (LinkedListvalid this@@5)) (= (MapType0Select Heap@@10 null (LinkedListvalid this@@5)) EmptyFrame))) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))
