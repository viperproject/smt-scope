...
(assert  (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type t1) RefType)) (= (type t2) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test03)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 t1 $allocated))) (and (U_2_bool (MapType0Select Heap@@9 t2 $allocated)) (= perm@0 (/ (to_real 1) (to_real 3))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= t1 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask t1 next (real_2_U (+ (U_2_real (MapType1Select ZeroMask t1 next)) perm@0)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (= perm@1 (/ (to_real 1) (to_real 3))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (=> (> perm@1 NoPerm) (not (= t2 null))) (=> (and (and (= Mask@1 (MapType1Store Mask@0 t2 next (real_2_U (+ (U_2_real (MapType1Select Mask@0 t2 next)) perm@1)))) (state Heap@@9 Mask@1)) (and (state Heap@@9 Mask@1) (= (ControlFlow 0 2) (- 0 1)))) (not (= t1 t2)))))))))))))
