...
(declare-fun a_16 () T@U)
(declare-fun b_2 () T@U)
(declare-fun Heap@@11 () T@U)
(declare-fun y@@12 () T@U)
(declare-fun x@@31 () T@U)
(declare-fun z@@0 () T@U)
(declare-fun a_15 () T@U)
(declare-fun a_14 () T@U)
...
(declare-fun a_13 () T@U)
(declare-fun a_1 () T@U)
(declare-fun Mask@0 () T@U)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@1) (MapType2Type RefType realType)) (= (type a_1) RefType)) (= (type x@@31) RefType)) (= (type z@@0) RefType)) (= (type a_13) RefType)) (= (type QPMask@0) (MapType2Type RefType realType))) (= (type a_14) RefType)) (= (type a_15) RefType)) (= (type y@@12) RefType)) (= (type Heap@@11) (MapType0Type RefType))) (= (type a_16) RefType)) (= (type b_2) RefType)) (forall ((arg0@@53 T@U) (arg1@@47 Real) (arg2@@24 T@U) (arg3@@21 Real) ) (! (= (type (invRecv4 arg0@@53 arg1@@47 arg2@@24 arg3@@21)) RefType)
 :qid |funType:invRecv4|
 :pattern ( (invRecv4 arg0@@53 arg1@@47 arg2@@24 arg3@@21))
...
(let ((anon38_Then_correct  (=> (HasDirectPerm QPMask@0 null (wand a_16 FullPerm b_2 FullPerm)) (and (=> (= (ControlFlow 0 24) 23) anon39_Then_correct) (=> (= (ControlFlow 0 24) 21) anon24_correct)))))
(let ((anon38_Else_correct  (=> (and (not (HasDirectPerm QPMask@0 null (wand a_16 FullPerm b_2 FullPerm))) (= (ControlFlow 0 22) 21)) anon24_correct)))
(let ((anon37_Else_correct  (=> (= (ControlFlow 0 20) (- 0 19)) (forall ((a_11 T@U) (b_1_1 T@U) ) (!  (=> (and (and (= (type a_11) RefType) (= (type b_1_1) RefType)) (HasDirectPerm QPMask@0 null (wand a_11 FullPerm b_1_1 FullPerm))) (= b_1_1 y@@12))
 :qid |stdinbpl.1248:15|
 :skolemid |141|
 :pattern ( (MapType2Select QPMask@0 null (wand a_11 FullPerm b_1_1 FullPerm)))
 :pattern ( (MapType0Select Heap@@11 null (wand a_11 FullPerm b_1_1 FullPerm)))
)))))
(let ((anon34_Else_correct  (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((a_9 T@U) ) (!  (=> (and (= (type a_9) RefType) (HasDirectPerm QPMask@0 null (wand a_9 FullPerm y@@12 FullPerm))) (or (= a_9 x@@31) (= a_9 z@@0)))
 :qid |stdinbpl.1207:15|
 :skolemid |140|
 :pattern ( (MapType2Select QPMask@0 null (wand a_9 FullPerm y@@12 FullPerm)))
 :pattern ( (MapType0Select Heap@@11 null (wand a_9 FullPerm y@@12 FullPerm)))
))) (=> (forall ((a_9@@0 T@U) ) (!  (=> (and (= (type a_9@@0) RefType) (HasDirectPerm QPMask@0 null (wand a_9@@0 FullPerm y@@12 FullPerm))) (or (= a_9@@0 x@@31) (= a_9@@0 z@@0)))
 :qid |stdinbpl.1207:15|
 :skolemid |140|
 :pattern ( (MapType2Select QPMask@0 null (wand a_9@@0 FullPerm y@@12 FullPerm)))
 :pattern ( (MapType0Select Heap@@11 null (wand a_9@@0 FullPerm y@@12 FullPerm)))
)) (=> (state Heap@@11 QPMask@0) (and (and (=> (= (ControlFlow 0 25) 20) anon37_Else_correct) (=> (= (ControlFlow 0 25) 24) anon38_Then_correct)) (=> (= (ControlFlow 0 25) 22) anon38_Else_correct)))))))
(let ((anon36_Then_correct true))
(let ((anon19_correct true))
(let ((anon35_Then_correct  (=> (HasDirectPerm QPMask@0 null (wand a_15 FullPerm y@@12 FullPerm)) (and (=> (= (ControlFlow 0 18) 17) anon36_Then_correct) (=> (= (ControlFlow 0 18) 15) anon19_correct)))))
(let ((anon35_Else_correct  (=> (and (not (HasDirectPerm QPMask@0 null (wand a_15 FullPerm y@@12 FullPerm))) (= (ControlFlow 0 16) 15)) anon19_correct)))
(let ((anon32_Else_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) (forall ((a_7 T@U) ) (!  (=> (and (= (type a_7) RefType) (HasDirectPerm QPMask@0 a_7 f_7)) (> (U_2_int (MapType0Select Heap@@11 a_7 f_7)) 0))
 :qid |stdinbpl.1166:15|
 :skolemid |139|
 :pattern ( (MapType2Select QPMask@0 a_7 f_7))
 :pattern ( (MapType0Select Heap@@11 a_7 f_7))
))) (=> (forall ((a_7@@0 T@U) ) (!  (=> (and (= (type a_7@@0) RefType) (HasDirectPerm QPMask@0 a_7@@0 f_7)) (> (U_2_int (MapType0Select Heap@@11 a_7@@0 f_7)) 0))
 :qid |stdinbpl.1166:15|
 :skolemid |139|
 :pattern ( (MapType2Select QPMask@0 a_7@@0 f_7))
 :pattern ( (MapType0Select Heap@@11 a_7@@0 f_7))
)) (=> (state Heap@@11 QPMask@0) (and (and (=> (= (ControlFlow 0 27) 25) anon34_Else_correct) (=> (= (ControlFlow 0 27) 18) anon35_Then_correct)) (=> (= (ControlFlow 0 27) 16) anon35_Else_correct)))))))
(let ((anon14_correct true))
(let ((anon33_Else_correct  (=> (and (not (HasDirectPerm QPMask@0 a_14 f_7)) (= (ControlFlow 0 14) 10)) anon14_correct)))
(let ((anon33_Then_correct  (=> (HasDirectPerm QPMask@0 a_14 f_7) (and (=> (= (ControlFlow 0 11) (- 0 13)) (HasDirectPerm QPMask@0 a_14 f_7)) (=> (HasDirectPerm QPMask@0 a_14 f_7) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm QPMask@0 a_14 f_7)) (=> (HasDirectPerm QPMask@0 a_14 f_7) (=> (= (ControlFlow 0 11) 10) anon14_correct))))))))
(let ((anon29_Else_correct  (and (=> (= (ControlFlow 0 29) (- 0 30)) (forall ((a_4 T@U) (a_4_1 T@U) ) (!  (=> (and (= (type a_4) RefType) (= (type a_4_1) RefType)) (=> (and (and (and (and (not (= a_4 a_4_1)) (or (= a_4 x@@31) (= a_4 z@@0))) (or (= a_4_1 x@@31) (= a_4_1 z@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (or (or (not (= a_4 a_4_1)) (not (= FullPerm FullPerm))) (not (= y@@12 y@@12))) (not (= FullPerm FullPerm)))))
 :qid |stdinbpl.1116:17|
 :skolemid |133|
 :pattern ( (neverTriggered4 a_4) (neverTriggered4 a_4_1))
))) (=> (forall ((a_4@@0 T@U) (a_4_1@@0 T@U) ) (!  (=> (and (= (type a_4@@0) RefType) (= (type a_4_1@@0) RefType)) (=> (and (and (and (and (not (= a_4@@0 a_4_1@@0)) (or (= a_4@@0 x@@31) (= a_4@@0 z@@0))) (or (= a_4_1@@0 x@@31) (= a_4_1@@0 z@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (or (or (not (= a_4@@0 a_4_1@@0)) (not (= FullPerm FullPerm))) (not (= y@@12 y@@12))) (not (= FullPerm FullPerm)))))
 :qid |stdinbpl.1116:17|
 :skolemid |133|
 :pattern ( (neverTriggered4 a_4@@0) (neverTriggered4 a_4_1@@0))
)) (=> (and (and (and (forall ((a_4@@1 T@U) ) (!  (=> (= (type a_4@@1) RefType) (=> (and (or (= a_4@@1 x@@31) (= a_4@@1 z@@0)) (< NoPerm FullPerm)) (and (= (invRecv4 a_4@@1 FullPerm y@@12 FullPerm) a_4@@1) (qpRange4 a_4@@1 FullPerm y@@12 FullPerm))))
 :qid |stdinbpl.1122:22|
 :skolemid |134|
 :pattern ( (MapType0Select Heap@@11 null (wand a_4@@1 FullPerm y@@12 FullPerm)))
 :pattern ( (MapType2Select Mask@1 null (wand a_4@@1 FullPerm y@@12 FullPerm)))
)) (forall ((arg_0 T@U) (arg_1 Real) (arg_2 T@U) (arg_3 Real) ) (!  (=> (and (= (type arg_0) RefType) (= (type arg_2) RefType)) (=> (and (and (or (= (invRecv4 arg_0 arg_1 arg_2 arg_3) x@@31) (= (invRecv4 arg_0 arg_1 arg_2 arg_3) z@@0)) (< NoPerm FullPerm)) (qpRange4 arg_0 arg_1 arg_2 arg_3)) (and (and (and (= (invRecv4 arg_0 arg_1 arg_2 arg_3) arg_0) (= FullPerm arg_1)) (= y@@12 arg_2)) (= FullPerm arg_3))))
 :qid |stdinbpl.1126:22|
 :skolemid |135|
 :pattern ( (invRecv4 arg_0 arg_1 arg_2 arg_3))
))) (and (forall ((arg_0@@0 T@U) (arg_1@@0 Real) (arg_2@@0 T@U) (arg_3@@0 Real) ) (!  (=> (and (= (type arg_0@@0) RefType) (= (type arg_2@@0) RefType)) (=> (and (and (or (= (invRecv4 arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0) x@@31) (= (invRecv4 arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0) z@@0)) (< NoPerm FullPerm)) (qpRange4 arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0)) (and (=> (< NoPerm FullPerm) (and (and (and (= (invRecv4 arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0) arg_0@@0) (= FullPerm arg_1@@0)) (= y@@12 arg_2@@0)) (= FullPerm arg_3@@0))) (= (U_2_real (MapType2Select QPMask@0 null (wand arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0))) (+ (U_2_real (MapType2Select Mask@1 null (wand arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0))) FullPerm)))))
 :qid |stdinbpl.1132:22|
 :skolemid |136|
 :pattern ( (MapType2Select QPMask@0 null (wand arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0)))
)) (forall ((o_3 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (or (or (not (= o_3 null)) (not (IsWandField f_5))) (not (= (getPredWandId f_5) 2)))) (= (U_2_real (MapType2Select Mask@1 o_3 f_5)) (U_2_real (MapType2Select QPMask@0 o_3 f_5))))))
 :qid |stdinbpl.1138:29|
 :skolemid |137|
 :pattern ( (MapType2Select Mask@1 o_3 f_5))
 :pattern ( (MapType2Select QPMask@0 o_3 f_5))
)))) (and (and (forall ((arg_0@@1 T@U) (arg_1@@1 Real) (arg_2@@1 T@U) (arg_3@@1 Real) ) (!  (=> (and (and (= (type arg_0@@1) RefType) (= (type arg_2@@1) RefType)) (not (and (and (or (= (invRecv4 arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1) x@@31) (= (invRecv4 arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1) z@@0)) (< NoPerm FullPerm)) (qpRange4 arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1)))) (= (U_2_real (MapType2Select QPMask@0 null (wand arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1))) (U_2_real (MapType2Select Mask@1 null (wand arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1)))))
 :qid |stdinbpl.1142:22|
 :skolemid |138|
 :pattern ( (MapType2Select QPMask@0 null (wand arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1)))
)) (state Heap@@11 QPMask@0)) (and (state Heap@@11 QPMask@0) (state Heap@@11 QPMask@0)))) (and (and (=> (= (ControlFlow 0 29) 27) anon32_Else_correct) (=> (= (ControlFlow 0 29) 11) anon33_Then_correct)) (=> (= (ControlFlow 0 29) 14) anon33_Else_correct)))))))
(let ((anon31_Then_correct true))
(let ((anon10_correct true))
(let ((anon30_Then_correct  (=> (or (= a_13 x@@31) (= a_13 z@@0)) (and (=> (= (ControlFlow 0 9) 8) anon31_Then_correct) (=> (= (ControlFlow 0 9) 6) anon10_correct)))))
(let ((anon30_Else_correct  (=> (and (not (or (= a_13 x@@31) (= a_13 z@@0))) (= (ControlFlow 0 7) 6)) anon10_correct)))
(let ((anon27_Else_correct  (=> (and (forall ((a_2_1 T@U) ) (!  (=> (and (= (type a_2_1) RefType) (= (U_2_real (MapType2Select Mask@1 a_2_1 f_7)) FullPerm)) (or (= a_2_1 x@@31) (= a_2_1 z@@0)))
 :qid |stdinbpl.1074:20|
 :skolemid |132|
 :no-pattern (type a_2_1)
 :no-pattern (U_2_int a_2_1)
 :no-pattern (U_2_bool a_2_1)
)) (state Heap@@11 Mask@1)) (and (and (=> (= (ControlFlow 0 31) 29) anon29_Else_correct) (=> (= (ControlFlow 0 31) 9) anon30_Then_correct)) (=> (= (ControlFlow 0 31) 7) anon30_Else_correct)))))
(let ((anon5_correct true))
(let ((anon28_Else_correct  (=> (and (not (= (U_2_real (MapType2Select Mask@1 a_1 f_7)) FullPerm)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon28_Then_correct  (=> (= (U_2_real (MapType2Select Mask@1 a_1 f_7)) FullPerm) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (= a_1 x@@31) (= a_1 z@@0))) (=> (or (= a_1 x@@31) (= a_1 z@@0)) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon26_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 x@@31 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@11 y@@12 $allocated)) (U_2_bool (MapType0Select Heap@@11 z@@0 $allocated))) (and (not (= x@@31 null)) (= Mask@0 (MapType2Store ZeroMask x@@31 f_7 (real_2_U (+ (U_2_real (MapType2Select ZeroMask x@@31 f_7)) FullPerm)))))) (=> (and (and (and (state Heap@@11 Mask@0) (state Heap@@11 Mask@0)) (and (state Heap@@11 Mask@0) (not (= z@@0 null)))) (and (and (= Mask@1 (MapType2Store Mask@0 z@@0 f_7 (real_2_U (+ (U_2_real (MapType2Select Mask@0 z@@0 f_7)) FullPerm)))) (state Heap@@11 Mask@1)) (and (state Heap@@11 Mask@1) (state Heap@@11 Mask@1)))) (and (=> (= (ControlFlow 0 32) (- 0 34)) (HasDirectPerm Mask@1 x@@31 f_7)) (=> (HasDirectPerm Mask@1 x@@31 f_7) (=> (= (U_2_int (MapType0Select Heap@@11 x@@31 f_7)) 5) (=> (and (state Heap@@11 Mask@1) (state Heap@@11 Mask@1)) (and (=> (= (ControlFlow 0 32) (- 0 33)) (HasDirectPerm Mask@1 z@@0 f_7)) (=> (HasDirectPerm Mask@1 z@@0 f_7) (=> (= (U_2_int (MapType0Select Heap@@11 z@@0 f_7)) 10) (=> (and (and (and (state Heap@@11 Mask@1) (state Heap@@11 Mask@1)) (and (not (= x@@31 y@@12)) (state Heap@@11 Mask@1))) (and (and (state Heap@@11 Mask@1) (not (= z@@0 y@@12))) (and (state Heap@@11 Mask@1) (state Heap@@11 Mask@1)))) (and (and (and (=> (= (ControlFlow 0 32) 1) anon26_Then_correct) (=> (= (ControlFlow 0 32) 31) anon27_Else_correct)) (=> (= (ControlFlow 0 32) 3) anon28_Then_correct)) (=> (= (ControlFlow 0 32) 5) anon28_Else_correct)))))))))))))))
