...
(declare-fun r_3 () T@U)
(assert  (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type r_3) RefType)) (= (type x@@8) RefType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id test02a)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon6_correct true))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon6_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@8 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@8 f_7))) (=> (= (ControlFlow 0 7) 6) anon6_correct))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((r_1_1 T@U) ) (!  (=> (and (= (type r_1_1) RefType) (HasDirectPerm Mask@0 r_1_1 f_7)) (> (U_2_int (MapType0Select Heap@@9 r_1_1 f_7)) 0))
 :qid |stdinbpl.363:15|
 :skolemid |24|
 :pattern ( (MapType1Select Mask@0 r_1_1 f_7))
 :pattern ( (MapType0Select Heap@@9 r_1_1 f_7))
))) (=> (forall ((r_1_1@@0 T@U) ) (!  (=> (and (= (type r_1_1@@0) RefType) (HasDirectPerm Mask@0 r_1_1@@0 f_7)) (> (U_2_int (MapType0Select Heap@@9 r_1_1@@0 f_7)) 0))
 :qid |stdinbpl.363:15|
 :skolemid |24|
 :pattern ( (MapType1Select Mask@0 r_1_1@@0 f_7))
 :pattern ( (MapType0Select Heap@@9 r_1_1@@0 f_7))
)) (and (=> (= (ControlFlow 0 10) 7) anon9_Then_correct) (=> (= (ControlFlow 0 10) 9) anon9_Else_correct))))))
(let ((anon3_correct true))
(let ((anon8_Else_correct  (=> (and (not (HasDirectPerm Mask@0 r_3 f_7)) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon8_Then_correct  (=> (HasDirectPerm Mask@0 r_3 f_7) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@0 r_3 f_7)) (=> (HasDirectPerm Mask@0 r_3 f_7) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 r_3 f_7)) (=> (HasDirectPerm Mask@0 r_3 f_7) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated)) (not (= x@@8 null))) (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm)))) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm Mask@0 x@@8 f_7)) (=> (HasDirectPerm Mask@0 x@@8 f_7) (=> (> (U_2_int (MapType0Select Heap@@9 x@@8 f_7)) 0) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (and (=> (= (ControlFlow 0 12) 10) anon7_Else_correct) (=> (= (ControlFlow 0 12) 2) anon8_Then_correct)) (=> (= (ControlFlow 0 12) 5) anon8_Else_correct))))))))))
