...
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type xs) (MapType2Type RefType boolType)) (= (type r_6) RefType)) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@3) (MapType1Type RefType realType))) (= (type Heap@@12) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (forall ((arg0@@49 T@U) ) (! (= (type (FrameFragment arg0@@49)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@49))
))) (= (type r_5) RefType)) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (forall ((arg0@@50 T@U) ) (! (= (type (invRecv2 arg0@@50)) RefType)
...
(let ((anon12_correct  (=> (and (= UnfoldingMask@0 (MapType1Store QPMask@0 null (p2 r_5) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (p2 r_5))) FullPerm)))) (not (= r_5 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 r_5 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 r_5 f_7)) FullPerm)))) (state Heap@@12 UnfoldingMask@1)) (and (= (U_2_int (MapType0Select Heap@@12 r_5 f_7)) 5) (state Heap@@12 UnfoldingMask@1))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (= (U_2_int (MapType0Select Heap@@12 r_5 f_7)) 5)) (=> (= (U_2_int (MapType0Select Heap@@12 r_5 f_7)) 5) (=> (= (ControlFlow 0 13) 11) anon13_correct)))))))
(let ((anon21_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 17) 13)) anon12_correct)))
(let ((anon21_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p2 r_5))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p2 r_5)))) (=> (= (ControlFlow 0 15) 13) anon12_correct))))))
(let ((anon20_Then_correct  (=> (U_2_bool (MapType2Select xs r_5)) (=> (and (|p2#trigger| Heap@@12 (p2 r_5)) (= (MapType0Select Heap@@12 null (p2 r_5)) (FrameFragment (MapType0Select Heap@@12 r_5 f_7)))) (and (=> (= (ControlFlow 0 18) 15) anon21_Then_correct) (=> (= (ControlFlow 0 18) 17) anon21_Else_correct))))))
(let ((anon20_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs r_5))) (= (ControlFlow 0 12) 11)) anon13_correct)))
(let ((anon7_correct true))
(let ((anon6_correct  (=> (and (= UnfoldingMask@2 (MapType1Store QPMask@0 null (p2 r_6) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (p2 r_6))) FullPerm)))) (not (= r_6 null))) (=> (and (and (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 r_6 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 r_6 f_7)) FullPerm)))) (state Heap@@12 UnfoldingMask@3)) (and (= (U_2_int (MapType0Select Heap@@12 r_6 f_7)) 5) (state Heap@@12 UnfoldingMask@3))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm UnfoldingMask@3 r_6 f_7)) (=> (HasDirectPerm UnfoldingMask@3 r_6 f_7) (=> (= Heap@0 (MapType0Store Heap@@12 null (|p2#sm| r_6) (MapType1Store (MapType0Select Heap@@12 null (|p2#sm| r_6)) r_6 f_7 (bool_2_U true)))) (=> (and (state Heap@0 QPMask@0) (= (ControlFlow 0 5) 3)) anon7_correct))))))))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 5)) anon6_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p2 r_6))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p2 r_6)))) (=> (= (ControlFlow 0 7) 5) anon6_correct))))))
(let ((anon17_Then_correct  (=> (U_2_bool (MapType2Select xs r_6)) (=> (and (|p2#trigger| Heap@@12 (p2 r_6)) (= (MapType0Select Heap@@12 null (p2 r_6)) (FrameFragment (MapType0Select Heap@@12 r_6 f_7)))) (and (=> (= (ControlFlow 0 10) 7) anon18_Then_correct) (=> (= (ControlFlow 0 10) 9) anon18_Else_correct))))))
(let ((anon17_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs r_6))) (= (ControlFlow 0 4) 3)) anon7_correct)))
(let ((anon19_Else_correct true))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (U_2_bool (MapType2Select xs r_1))) (U_2_bool (MapType2Select xs r_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1 r_1_1))))
 :qid |stdinbpl.780:17|
 :skolemid |108|
...
)) (=> (forall ((r_1@@1 T@U) ) (!  (=> (= (type r_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs r_1@@1)) (< NoPerm FullPerm)) (and (= (invRecv2 r_1@@1) r_1@@1) (qpRange2 r_1@@1))))
 :qid |stdinbpl.786:22|
 :skolemid |109|
 :pattern ( (MapType0Select Heap@@12 null (p2 r_1@@1)))
 :pattern ( (MapType1Select ZeroMask null (p2 r_1@@1)))
 :pattern ( (MapType2Select xs r_1@@1))
)) (=> (and (forall ((r_2_1 T@U) ) (!  (=> (= (type r_2_1) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv2 r_2_1))) (< NoPerm FullPerm)) (qpRange2 r_2_1)) (= (invRecv2 r_2_1) r_2_1)))
 :qid |stdinbpl.790:22|
 :skolemid |110|
 :pattern ( (invRecv2 r_2_1))
)) (forall ((r_2_1@@0 T@U) ) (!  (=> (= (type r_2_1@@0) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv2 r_2_1@@0))) (< NoPerm FullPerm)) (qpRange2 r_2_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 r_2_1@@0) r_2_1@@0)) (= (U_2_real (MapType1Select QPMask@0 null (p2 r_2_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (p2 r_2_1@@0))) FullPerm)))))
 :qid |stdinbpl.796:22|
 :skolemid |111|
...
)) (forall ((r_2_1@@1 T@U) ) (!  (=> (and (= (type r_2_1@@1) RefType) (not (and (and (U_2_bool (MapType2Select xs (invRecv2 r_2_1@@1))) (< NoPerm FullPerm)) (qpRange2 r_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (p2 r_2_1@@1))) (U_2_real (MapType1Select ZeroMask null (p2 r_2_1@@1)))))
 :qid |stdinbpl.806:22|
 :skolemid |113|
 :pattern ( (MapType1Select QPMask@0 null (p2 r_2_1@@1)))
))) (and (state Heap@@12 QPMask@0) (state Heap@@12 QPMask@0))) (and (and (and (and (=> (= (ControlFlow 0 19) 2) anon19_Else_correct) (=> (= (ControlFlow 0 19) 18) anon20_Then_correct)) (=> (= (ControlFlow 0 19) 12) anon20_Else_correct)) (=> (= (ControlFlow 0 19) 10) anon17_Then_correct)) (=> (= (ControlFlow 0 19) 4) anon17_Else_correct)))))))))
(let ((anon15_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@12 ZeroMask) (and (=> (= (ControlFlow 0 21) 1) anon15_Then_correct) (=> (= (ControlFlow 0 21) 19) anon15_Else_correct)))))
