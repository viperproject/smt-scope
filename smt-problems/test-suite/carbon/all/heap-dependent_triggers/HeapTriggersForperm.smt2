...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (= (type x@@19) RefType) (= (type y@@6) RefType)) (= (type z@@0) RefType)) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type xs) (MapType2Type RefType boolType))) (= (type x_2) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type x_4) RefType)) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv3 arg0@@43)) RefType)
 :qid |funType:invRecv3|
 :pattern ( (invRecv3 arg0@@43))
))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv2 arg0@@44)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@44))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv1 arg0@@45)) RefType)
...
(let ((anon27_Else_correct  (=> (and (not (HasDirectPerm QPMask@2 x_4 f_7)) (= (ControlFlow 0 18) 14)) anon17_correct)))
(let ((anon27_Then_correct  (=> (HasDirectPerm QPMask@2 x_4 f_7) (and (=> (= (ControlFlow 0 15) (- 0 17)) (HasDirectPerm QPMask@2 x_4 f_7)) (=> (HasDirectPerm QPMask@2 x_4 f_7) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm QPMask@2 x_4 f_7)) (=> (HasDirectPerm QPMask@2 x_4 f_7) (=> (= (ControlFlow 0 15) 14) anon17_correct))))))))
(let ((anon26_Else_correct  (=> (= (ControlFlow 0 13) (- 0 12)) (forall ((x_11 T@U) ) (!  (=> (and (= (type x_11) RefType) (HasDirectPerm QPMask@2 x_11 f_7)) (= (U_2_int (MapType0Select Heap@@9 x_11 f_7)) 0))
 :qid |stdinbpl.606:15|
 :skolemid |102|
 :pattern ( (MapType1Select QPMask@2 x_11 f_7))
 :pattern ( (MapType0Select Heap@@9 x_11 f_7))
)))))
(let ((anon24_Else_correct  (=> (forall ((x_9 T@U) ) (!  (=> (and (= (type x_9) RefType) (U_2_bool (MapType2Select xs x_9))) (= (U_2_int (MapType0Select Heap@@9 x_9 f_7)) 0))
 :qid |stdinbpl.584:20|
 :skolemid |101|
 :pattern ( (MapType0Select Heap@@9 x_9 f_7))
)) (=> (and (state Heap@@9 QPMask@2) (state Heap@@9 QPMask@2)) (and (and (=> (= (ControlFlow 0 19) 13) anon26_Else_correct) (=> (= (ControlFlow 0 19) 15) anon27_Then_correct)) (=> (= (ControlFlow 0 19) 18) anon27_Else_correct))))))
(let ((anon13_correct true))
(let ((anon25_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs x_2))) (= (ControlFlow 0 11) 8)) anon13_correct)))
(let ((anon25_Then_correct  (=> (U_2_bool (MapType2Select xs x_2)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm QPMask@2 x_2 f_7)) (=> (HasDirectPerm QPMask@2 x_2 f_7) (=> (= (ControlFlow 0 9) 8) anon13_correct))))))
(let ((anon22_Else_correct  (=> (forall ((x_7 T@U) ) (!  (=> (and (= (type x_7) RefType) (or (= x_7 y@@6) (= x_7 z@@0))) (= (U_2_int (MapType0Select Heap@@9 x_7 f_7)) 0))
 :qid |stdinbpl.567:20|
 :skolemid |100|
 :pattern ( (MapType0Select Heap@@9 x_7 f_7))
)) (=> (and (state Heap@@9 QPMask@2) (state Heap@@9 QPMask@2)) (and (and (=> (= (ControlFlow 0 20) 19) anon24_Else_correct) (=> (= (ControlFlow 0 20) 9) anon25_Then_correct)) (=> (= (ControlFlow 0 20) 11) anon25_Else_correct))))))
(let ((anon9_correct true))
(let ((anon23_Else_correct  (=> (and (not (or (= x@@19 y@@6) (= x@@19 z@@0))) (= (ControlFlow 0 7) 4)) anon9_correct)))
(let ((anon23_Then_correct  (=> (or (= x@@19 y@@6) (= x@@19 z@@0)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm QPMask@2 x@@19 f_7)) (=> (HasDirectPerm QPMask@2 x@@19 f_7) (=> (= (ControlFlow 0 5) 4) anon9_correct))))))
(let ((anon21_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((x_5 T@U) (x_5_1 T@U) ) (!  (=> (and (= (type x_5) RefType) (= (type x_5_1) RefType)) (=> (and (and (and (and (not (= x_5 x_5_1)) (= x_5 z@@0)) (= x_5_1 z@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_5 x_5_1))))
 :qid |stdinbpl.522:15|
 :skolemid |94|
 :no-pattern (type x_5)
...
))) (=> (forall ((x_5@@0 T@U) (x_5_1@@0 T@U) ) (!  (=> (and (= (type x_5@@0) RefType) (= (type x_5_1@@0) RefType)) (=> (and (and (and (and (not (= x_5@@0 x_5_1@@0)) (= x_5@@0 z@@0)) (= x_5_1@@0 z@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_5@@0 x_5_1@@0))))
 :qid |stdinbpl.522:15|
 :skolemid |94|
...
)) (=> (and (and (and (forall ((x_5@@1 T@U) ) (!  (=> (= (type x_5@@1) RefType) (=> (and (= x_5@@1 z@@0) (< NoPerm FullPerm)) (and (qpRange3 x_5@@1) (= (invRecv3 x_5@@1) x_5@@1))))
 :qid |stdinbpl.528:22|
 :skolemid |95|
 :pattern ( (MapType0Select Heap@@9 x_5@@1 f_7))
 :pattern ( (MapType1Select QPMask@2 x_5@@1 f_7))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (= (invRecv3 o_3) z@@0) (< NoPerm FullPerm)) (qpRange3 o_3)) (= (invRecv3 o_3) o_3)))
 :qid |stdinbpl.532:22|
 :skolemid |96|
 :pattern ( (invRecv3 o_3))
))) (and (forall ((x_5@@2 T@U) ) (!  (=> (and (= (type x_5@@2) RefType) (= x_5@@2 z@@0)) (not (= x_5@@2 null)))
 :qid |stdinbpl.538:22|
 :skolemid |97|
 :pattern ( (MapType0Select Heap@@9 x_5@@2 f_7))
 :pattern ( (MapType1Select QPMask@2 x_5@@2 f_7))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (= (invRecv3 o_3@@0) z@@0) (< NoPerm FullPerm)) (qpRange3 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (+ (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (= (invRecv3 o_3@@0) z@@0) (< NoPerm FullPerm)) (qpRange3 o_3@@0))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7))))))
 :qid |stdinbpl.544:22|
 :skolemid |98|
...
)) (state Heap@@9 QPMask@2)) (and (state Heap@@9 QPMask@2) (state Heap@@9 QPMask@2)))) (and (and (=> (= (ControlFlow 0 21) 20) anon22_Else_correct) (=> (= (ControlFlow 0 21) 5) anon23_Then_correct)) (=> (= (ControlFlow 0 21) 7) anon23_Else_correct)))))))
(let ((anon21_Then_correct true))
(let ((anon20_Else_correct  (and (=> (= (ControlFlow 0 23) (- 0 24)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (= x_3 y@@6)) (= x_3_1 y@@6)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1))))
 :qid |stdinbpl.479:15|
 :skolemid |88|
 :no-pattern (type x_3)
...
))) (=> (forall ((x_3@@0 T@U) (x_3_1@@0 T@U) ) (!  (=> (and (= (type x_3@@0) RefType) (= (type x_3_1@@0) RefType)) (=> (and (and (and (and (not (= x_3@@0 x_3_1@@0)) (= x_3@@0 y@@6)) (= x_3_1@@0 y@@6)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3@@0 x_3_1@@0))))
 :qid |stdinbpl.479:15|
 :skolemid |88|
...
)) (=> (and (and (and (forall ((x_3@@1 T@U) ) (!  (=> (= (type x_3@@1) RefType) (=> (and (= x_3@@1 y@@6) (< NoPerm FullPerm)) (and (qpRange2 x_3@@1) (= (invRecv2 x_3@@1) x_3@@1))))
 :qid |stdinbpl.485:22|
 :skolemid |89|
 :pattern ( (MapType0Select Heap@@9 x_3@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 x_3@@1 f_7))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (= (invRecv2 o_3@@2) y@@6) (< NoPerm FullPerm)) (qpRange2 o_3@@2)) (= (invRecv2 o_3@@2) o_3@@2)))
 :qid |stdinbpl.489:22|
 :skolemid |90|
 :pattern ( (invRecv2 o_3@@2))
))) (and (forall ((x_3@@2 T@U) ) (!  (=> (and (= (type x_3@@2) RefType) (= x_3@@2 y@@6)) (not (= x_3@@2 null)))
 :qid |stdinbpl.495:22|
 :skolemid |91|
 :pattern ( (MapType0Select Heap@@9 x_3@@2 f_7))
 :pattern ( (MapType1Select QPMask@1 x_3@@2 f_7))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (= (invRecv2 o_3@@3) y@@6) (< NoPerm FullPerm)) (qpRange2 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (= (invRecv2 o_3@@3) y@@6) (< NoPerm FullPerm)) (qpRange2 o_3@@3))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7))))))
 :qid |stdinbpl.501:22|
 :skolemid |92|
...
)) (state Heap@@9 QPMask@1)) (and (state Heap@@9 QPMask@1) (state Heap@@9 QPMask@1)))) (and (=> (= (ControlFlow 0 23) 3) anon21_Then_correct) (=> (= (ControlFlow 0 23) 21) anon21_Else_correct)))))))
(let ((anon20_Then_correct true))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select xs x_1))) (U_2_bool (MapType2Select xs x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.436:15|
 :skolemid |82|
 :no-pattern (type x_1)
...
)) (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv1 o_3@@5))) (< NoPerm FullPerm)) (qpRange1 o_3@@5)) (= (invRecv1 o_3@@5) o_3@@5)))
 :qid |stdinbpl.446:22|
 :skolemid |84|
...
)) (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs (invRecv1 o_3@@6))) (< NoPerm FullPerm)) (qpRange1 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@6) o_3@@6)) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@6 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select xs (invRecv1 o_3@@6))) (< NoPerm FullPerm)) (qpRange1 o_3@@6))) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@6 f_7))))))
 :qid |stdinbpl.458:22|
 :skolemid |86|
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (=> (= (ControlFlow 0 25) 2) anon20_Then_correct) (=> (= (ControlFlow 0 25) 23) anon20_Else_correct)))))))
(let ((anon19_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 y@@6 $allocated)) (U_2_bool (MapType0Select Heap@@9 z@@0 $allocated))) (and (=> (= (ControlFlow 0 27) 1) anon19_Then_correct) (=> (= (ControlFlow 0 27) 25) anon19_Else_correct))))))
