...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= 1 1)) (=> (= 1 1) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= 1 1)) (=> (= 1 1) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= 1 0)) (=> (= 1 0) (=> (= (ControlFlow 0 2) (- 0 1)) (= 1 1))))))))))))
