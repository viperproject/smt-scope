...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type UnfoldingMask@8) (MapType1Type RefType realType)) (= (type Heap@@23) (MapType0Type RefType))) (= (type this@@10) RefType)) (= (type Heap@7) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@6) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@3) (MapType0Type RefType))) (= (type UnfoldingMask@6) (MapType1Type RefType realType))) (= (type UnfoldingMask@5) (MapType1Type RefType realType))) (= (type UnfoldingMask@7) (MapType1Type RefType realType))) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type UnfoldingMask@3) (MapType1Type RefType realType))) (= (type UnfoldingMask@4) (MapType1Type RefType realType))) (forall ((arg0@@29 T@U) (arg1@@10 T@U) ) (! (= (type (CombineFrames arg0@@29 arg1@@10)) FrameTypeType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon13_correct  (=> (state Heap@7 Mask@0) (=> (and (= Result@0 (ite (= (variantOfList (MapType0Select Heap@7 this@@10 List__variant)) fn$$List__Nil) 0 (+ 1 (silver_length Heap@7 (MapType0Select Heap@7 this@@10 List__Node__1))))) (= (ControlFlow 0 4) (- 0 3))) (>= Result@0 0)))))
(let ((anon19_Else_correct  (=> (not (= (variantOfList (MapType0Select Heap@4 this@@10 List__variant)) fn$$List__Nil)) (=> (and (= Heap@7 Heap@4) (= (ControlFlow 0 6) 4)) anon13_correct))))
(let ((anon19_Then_correct  (=> (= (variantOfList (MapType0Select Heap@4 this@@10 List__variant)) fn$$List__Nil) (=> (and (and (= Heap@5 (MapType0Store Heap@4 null (|valid__List#sm| this@@10) (MapType1Store (MapType0Select Heap@4 null (|valid__List#sm| this@@10)) this@@10 List__Node__0 (bool_2_U true)))) (= Heap@6 (MapType0Store Heap@5 null (|valid__List#sm| this@@10) (MapType1Store (MapType0Select Heap@5 null (|valid__List#sm| this@@10)) this@@10 List__Node__1 (bool_2_U true))))) (and (= Heap@7 Heap@6) (= (ControlFlow 0 5) 4))) anon13_correct))))
(let ((anon18_Else_correct  (=> (and (not (= (variantOfList (MapType0Select Heap@0 this@@10 List__variant)) fn$$List__Node)) (= Heap@4 Heap@0)) (and (=> (= (ControlFlow 0 8) 5) anon19_Then_correct) (=> (= (ControlFlow 0 8) 6) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (and (= (variantOfList (MapType0Select Heap@0 this@@10 List__variant)) fn$$List__Node) (= Heap@1 (MapType0Store Heap@0 null (|valid__List#sm| this@@10) (MapType1Store (MapType0Select Heap@0 null (|valid__List#sm| this@@10)) this@@10 List__Node__0 (bool_2_U true))))) (=> (and (and (= Heap@2 (MapType0Store Heap@1 null (|valid__List#sm| this@@10) (MapType1Store (MapType0Select Heap@1 null (|valid__List#sm| this@@10)) this@@10 List__Node__1 (bool_2_U true)))) (forall ((o_4 T@U) (f_8 T@U) ) (! (let ((B@@16 (FieldTypeInv1 (type f_8))))
(let ((A@@17 (FieldTypeInv0 (type f_8))))
 (=> (and (and (= (type o_4) RefType) (= (type f_8) (FieldType A@@17 B@@16))) (or (U_2_bool (MapType1Select (MapType0Select Heap@2 null (|valid__List#sm| this@@10)) o_4 f_8)) (U_2_bool (MapType1Select (MapType0Select Heap@2 null (|valid__List#sm| (MapType0Select Heap@2 this@@10 List__Node__1))) o_4 f_8)))) (U_2_bool (MapType1Select newPMask@0 o_4 f_8)))))
 :qid |stdinbpl.432:33|
 :skolemid |41|
 :pattern ( (MapType1Select newPMask@0 o_4 f_8))
))) (and (= Heap@3 (MapType0Store Heap@2 null (|valid__List#sm| this@@10) newPMask@0)) (= Heap@4 Heap@3))) (and (=> (= (ControlFlow 0 7) 5) anon19_Then_correct) (=> (= (ControlFlow 0 7) 6) anon19_Else_correct))))))
(let ((anon9_correct  (=> (= Heap@0 (MapType0Store Heap@@23 null (|valid__List#sm| this@@10) (MapType1Store (MapType0Select Heap@@23 null (|valid__List#sm| this@@10)) this@@10 List__variant (bool_2_U true)))) (and (=> (= (ControlFlow 0 9) 7) anon18_Then_correct) (=> (= (ControlFlow 0 9) 8) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (|silver_length#trigger| (MapType0Select Heap@@23 null (valid__List (MapType0Select Heap@@23 this@@10 List__Node__1))) (MapType0Select Heap@@23 this@@10 List__Node__1)) (= (ControlFlow 0 11) 9)) anon9_correct)))
(let ((anon16_Then_correct  (=> (and (= (variantOfList (MapType0Select Heap@@23 this@@10 List__variant)) fn$$List__Nil) (= (ControlFlow 0 10) 9)) anon9_correct)))
(let ((anon17_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (> (U_2_real (MapType1Select UnfoldingMask@8 null (valid__List (MapType0Select Heap@@23 this@@10 List__Node__1)))) NoPerm))))
(let ((anon16_Else_correct  (=> (not (= (variantOfList (MapType0Select Heap@@23 this@@10 List__variant)) fn$$List__Nil)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm UnfoldingMask@8 this@@10 List__Node__1)) (=> (HasDirectPerm UnfoldingMask@8 this@@10 List__Node__1) (and (=> (= (ControlFlow 0 12) 2) anon17_Then_correct) (=> (= (ControlFlow 0 12) 11) anon17_Else_correct)))))))
(let ((anon4_correct  (=> (state Heap@@23 UnfoldingMask@8) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm UnfoldingMask@8 this@@10 List__variant)) (=> (HasDirectPerm UnfoldingMask@8 this@@10 List__variant) (and (=> (= (ControlFlow 0 14) 10) anon16_Then_correct) (=> (= (ControlFlow 0 14) 12) anon16_Else_correct)))))))
(let ((anon15_Else_correct  (=> (not (= (variantOfList (MapType0Select Heap@@23 this@@10 List__variant)) fn$$List__Nil)) (=> (and (= UnfoldingMask@8 UnfoldingMask@5) (= (ControlFlow 0 17) 14)) anon4_correct))))
(let ((anon15_Then_correct  (=> (= (variantOfList (MapType0Select Heap@@23 this@@10 List__variant)) fn$$List__Nil) (=> (and (> wildcard@6 NoPerm) (not (= this@@10 null))) (=> (and (and (and (= UnfoldingMask@6 (MapType1Store UnfoldingMask@5 this@@10 List__Node__0 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@5 this@@10 List__Node__0)) wildcard@6)))) (state Heap@@23 UnfoldingMask@6)) (and (> wildcard@7 NoPerm) (not (= this@@10 null)))) (and (and (= UnfoldingMask@7 (MapType1Store UnfoldingMask@6 this@@10 List__Node__1 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@6 this@@10 List__Node__1)) wildcard@7)))) (state Heap@@23 UnfoldingMask@7)) (and (= UnfoldingMask@8 UnfoldingMask@7) (= (ControlFlow 0 16) 14)))) anon4_correct)))))
(let ((anon14_Else_correct  (=> (and (not (= (variantOfList (MapType0Select Heap@@23 this@@10 List__variant)) fn$$List__Node)) (= UnfoldingMask@5 UnfoldingMask@1)) (and (=> (= (ControlFlow 0 19) 16) anon15_Then_correct) (=> (= (ControlFlow 0 19) 17) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (and (= (variantOfList (MapType0Select Heap@@23 this@@10 List__variant)) fn$$List__Node) (> wildcard@3 NoPerm)) (=> (and (and (not (= this@@10 null)) (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 this@@10 List__Node__0 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 this@@10 List__Node__0)) wildcard@3))))) (and (state Heap@@23 UnfoldingMask@2) (> wildcard@4 NoPerm))) (=> (and (and (and (not (= this@@10 null)) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 this@@10 List__Node__1 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 this@@10 List__Node__1)) wildcard@4))))) (and (state Heap@@23 UnfoldingMask@3) (> wildcard@5 NoPerm))) (and (and (= UnfoldingMask@4 (MapType1Store UnfoldingMask@3 null (valid__List (MapType0Select Heap@@23 this@@10 List__Node__1)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@3 null (valid__List (MapType0Select Heap@@23 this@@10 List__Node__1)))) wildcard@5)))) (InsidePredicate (valid__List this@@10) (MapType0Select Heap@@23 null (valid__List this@@10)) (valid__List (MapType0Select Heap@@23 this@@10 List__Node__1)) (MapType0Select Heap@@23 null (valid__List (MapType0Select Heap@@23 this@@10 List__Node__1))))) (and (state Heap@@23 UnfoldingMask@4) (= UnfoldingMask@5 UnfoldingMask@4)))) (and (=> (= (ControlFlow 0 18) 16) anon15_Then_correct) (=> (= (ControlFlow 0 18) 17) anon15_Else_correct)))))))
(let ((anon0_correct  (=> (state Heap@@23 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@23 this@@10 $allocated)) (= AssumeFunctionsAbove 0)) (and (> wildcard@0 NoPerm) (= Mask@0 (MapType1Store ZeroMask null (valid__List this@@10) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid__List this@@10))) wildcard@0)))))) (and (and (state Heap@@23 Mask@0) (state Heap@@23 Mask@0)) (and (|valid__List#trigger| Heap@@23 (valid__List this@@10)) (= (MapType0Select Heap@@23 null (valid__List this@@10)) (CombineFrames (FrameFragment (MapType0Select Heap@@23 this@@10 List__variant)) (CombineFrames (FrameFragment (ite (= (variantOfList (MapType0Select Heap@@23 this@@10 List__variant)) fn$$List__Node) (CombineFrames (FrameFragment (MapType0Select Heap@@23 this@@10 List__Node__0)) (CombineFrames (FrameFragment (MapType0Select Heap@@23 this@@10 List__Node__1)) (MapType0Select Heap@@23 null (valid__List (MapType0Select Heap@@23 this@@10 List__Node__1))))) EmptyFrame)) (FrameFragment (ite (= (variantOfList (MapType0Select Heap@@23 this@@10 List__variant)) fn$$List__Nil) (CombineFrames (FrameFragment (MapType0Select Heap@@23 this@@10 List__Node__0)) (FrameFragment (MapType0Select Heap@@23 this@@10 List__Node__1))) EmptyFrame)))))))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (> (U_2_real (MapType1Select Mask@0 null (valid__List this@@10))) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@0 null (valid__List this@@10))) NoPerm) (=> (and (and (and (> wildcard@1 NoPerm) (< wildcard@1 (U_2_real (MapType1Select Mask@0 null (valid__List this@@10))))) (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (valid__List this@@10) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid__List this@@10))) wildcard@1)))) (> wildcard@2 NoPerm))) (and (and (not (= this@@10 null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this@@10 List__variant (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this@@10 List__variant)) wildcard@2))))) (and (state Heap@@23 UnfoldingMask@1) (isList (MapType0Select Heap@@23 this@@10 List__variant))))) (and (=> (= (ControlFlow 0 20) 18) anon14_Then_correct) (=> (= (ControlFlow 0 20) 19) anon14_Else_correct)))))))))
