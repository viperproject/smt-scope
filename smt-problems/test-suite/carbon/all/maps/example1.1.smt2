...
(declare-fun m@0 () T@U)
(declare-fun m@1 () T@U)
(assert  (and (and (= (type Heap@@9) (MapType1Type RefType)) (= (type m@0) (MapType intType boolType))) (= (type m@1) (MapType intType boolType))))
(set-info :boogie-vc-id test2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (= m@0 (|Map#Empty| intType boolType)) (state Heap@@9 ZeroMask)) (and (= m@1 (|Map#Build| m@0 (int_2_U 2) (bool_2_U true))) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (U_2_bool (MapType0Select (|Map#Domain| m@1) (int_2_U 2)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@1) (int_2_U 2))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (U_2_bool (MapType0Select (|Map#Elements| m@1) (int_2_U 2)))) (=> (U_2_bool (MapType0Select (|Map#Elements| m@1) (int_2_U 2))) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Equal| (|Map#Domain| m@1) (|Set#Singleton| (int_2_U 2)))) (=> (|Set#Equal| (|Map#Domain| m@1) (|Set#Singleton| (int_2_U 2))) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (|Set#Equal| (|Map#Values| m@1) (|Set#Singleton| (bool_2_U true)))))))))))))))
