...
(assert  (and (= (type Heap@@33) (MapType0Type RefType)) (= (type diz) RefType)))
(set-info :boogie-vc-id Ref__guard_check_S2_S1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= 1 i@@34)) (=> (<= 1 i@@34) (=> (= (ControlFlow 0 3) (- 0 2)) (< (- i@@34 1) (- N 1)))))))
