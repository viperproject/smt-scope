...
(assert  (and (and (and (and (= (type QPMask@0) (MapType1Type RefType realType)) (= (type x@@11) RefType)) (= (type xs) (SeqType RefType))) (= (type Heap@@14) (MapType0Type RefType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv2 arg0@@43)) RefType)
...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p2 x@@11))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p2 x@@11)))) (=> (= (ControlFlow 0 4) 3) anon6_correct))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (|Seq#Contains| xs r_1)) (|Seq#Contains| xs r_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1 r_1_1))))
 :qid |stdinbpl.973:17|
 :skolemid |89|
...
)) (=> (and (forall ((r_2_1 T@U) ) (!  (=> (= (type r_2_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv2 r_2_1)) (< NoPerm FullPerm)) (qpRange2 r_2_1)) (= (invRecv2 r_2_1) r_2_1)))
 :qid |stdinbpl.983:22|
 :skolemid |91|
...
))) (and (state Heap@@14 QPMask@0) (state Heap@@14 QPMask@0))) (and (and (=> (= (ControlFlow 0 7) 2) anon8_Then_correct) (=> (= (ControlFlow 0 7) 4) anon9_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (U_2_bool (MapType0Select Heap@@14 x@@11 $allocated))) (and (=> (= (ControlFlow 0 9) 1) anon7_Then_correct) (=> (= (ControlFlow 0 9) 7) anon7_Else_correct)))))
...
(assert  (and (and (and (and (= (type QPMask@0) (MapType1Type RefType realType)) (= (type x@@11) RefType)) (= (type xs) (SeqType RefType))) (= (type Heap@@14) (MapType0Type RefType))) (forall ((arg0@@43 T@U) (arg1@@20 Int) ) (! (= (type (invRecv8 arg0@@43 arg1@@20)) RefType)
...
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_correct true))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon6_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p5 x@@11 i@@18))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p5 x@@11 i@@18)))) (=> (= (ControlFlow 0 4) 3) anon6_correct))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (|Seq#Contains| xs r_1)) (|Seq#Contains| xs r_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= r_1 r_1_1)) (not (= i@@18 i@@18)))))
 ...
 :pattern ( (|Seq#ContainsTrigger| xs r_1@@1))
 :pattern ( (|Seq#Contains| xs r_1@@1))
)) (=> (and (forall ((r_2_1 T@U) (i_1_1 Int) ) (!  (=> (= (type r_2_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv8 r_2_1 i_1_1)) (< NoPerm FullPerm)) (qpRange8 r_2_1 i_1_1)) (and (= (invRecv8 r_2_1 i_1_1) r_2_1) (= i@@18 i_1_1))))
