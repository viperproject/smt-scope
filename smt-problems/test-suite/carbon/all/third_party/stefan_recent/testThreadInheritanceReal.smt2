...
(set-info :boogie-vc-id Thread__open_preFork_at_Thread)
...
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(set-info :boogie-vc-id Worker__join)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) true)
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type sys__result) RefType)) (forall ((arg0@@77 T@U) ) (! (= (type (type_of arg0@@77)) TYPEDomainTypeType)
 :qid |funType:type_of|
 :pattern ( (type_of arg0@@77))
))) (= (type class_Worker) TYPEDomainTypeType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type PostMask@1) (MapType1Type RefType realType))) (= (type AssertMask@0) (MapType1Type RefType realType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type freshObj@0) RefType)) (= (type AssertMask@1) (MapType1Type RefType realType))) (= (type Heap@10) (MapType0Type RefType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@7) (MapType0Type RefType))) (= (type Heap@8) (MapType0Type RefType))) (= (type Heap@9) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Heap@6) (MapType0Type RefType))) (= (type freshVersion@1) FrameTypeType)) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (forall ((arg0@@78 T@U) (arg1@@46 T@U) ) (! (= (type (CombineFrames arg0@@78 arg1@@46)) FrameTypeType)
 :qid |funType:CombineFrames|
 :pattern ( (CombineFrames arg0@@78 arg1@@46))
))) (forall ((arg0@@79 T@U) ) (! (= (type (FrameFragment arg0@@79)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@79))
))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Heap@@30) (MapType0Type RefType))) (= (type diz@@125) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id Worker__Worker_at_Worker)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 34) (let ((anon12_correct  (=> (= AssertMask@0 (MapType1Store Mask@6 null (Worker__preFork_at_Worker freshObj@0 FullPerm) (real_2_U (- (U_2_real (MapType1Select Mask@6 null (Worker__preFork_at_Worker freshObj@0 FullPerm))) FullPerm)))) (and (=> (= (ControlFlow 0 4) (- 0 8)) (> (U_2_real (MapType1Select AssertMask@0 freshObj@0 Worker__input)) NoPerm)) (=> (> (U_2_real (MapType1Select AssertMask@0 freshObj@0 Worker__input)) NoPerm) (=> (> wildcard@2 NoPerm) (=> (and (< wildcard@2 (U_2_real (MapType1Select AssertMask@0 freshObj@0 Worker__input))) (= AssertMask@1 (MapType1Store AssertMask@0 freshObj@0 Worker__input (real_2_U (- (U_2_real (MapType1Select AssertMask@0 freshObj@0 Worker__input)) wildcard@2))))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (HasDirectPerm Mask@6 freshObj@0 Worker__input)) (=> (HasDirectPerm Mask@6 freshObj@0 Worker__input) (=> (= (ControlFlow 0 4) (- 0 6)) (= (U_2_int (MapType0Select Heap@10 freshObj@0 Worker__input)) input)))))))))))
(let ((anon20_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 4)) anon12_correct)))
(let ((anon20_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@6 null (Worker__preFork_at_Worker freshObj@0 FullPerm))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@6 null (Worker__preFork_at_Worker freshObj@0 FullPerm)))) (=> (= (ControlFlow 0 9) 4) anon12_correct))))))
(let ((anon10_correct  (=> (forall ((o_3 T@U) (f_7 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_7))))
(let ((A@@12 (FieldTypeInv0 (type f_7))))
 (=> (and (and (= (type o_3) RefType) (= (type f_7) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@7 null (|Worker__preFork_at_Worker#sm| freshObj@0 FullPerm)) o_3 f_7)) (U_2_bool (MapType1Select (MapType0Select Heap@7 null (|Worker__preFork_at_Thread#sm| freshObj@0 FullPerm)) o_3 f_7)))) (U_2_bool (MapType1Select newPMask@0 o_3 f_7)))))
 :qid |stdinbpl.3444:27|
 :skolemid |185|
 :pattern ( (MapType1Select newPMask@0 o_3 f_7))
)) (=> (and (= Heap@8 (MapType0Store Heap@7 null (|Worker__preFork_at_Worker#sm| freshObj@0 FullPerm) newPMask@0)) (= Heap@9 (MapType0Store Heap@8 null (|Worker__preFork_at_Worker#sm| freshObj@0 FullPerm) (MapType1Store (MapType0Select Heap@8 null (|Worker__preFork_at_Worker#sm| freshObj@0 FullPerm)) freshObj@0 Worker__input (bool_2_U true))))) (=> (and (and (= Heap@10 (MapType0Store Heap@9 null (|Worker__preFork_at_Worker#sm| freshObj@0 FullPerm) (MapType1Store (MapType0Select Heap@9 null (|Worker__preFork_at_Worker#sm| freshObj@0 FullPerm)) freshObj@0 Worker__output (bool_2_U true)))) (state Heap@10 Mask@6)) (and (state Heap@10 Mask@6) (state Heap@10 Mask@6))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (not (= freshObj@0 null))) (=> (not (= freshObj@0 null)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (= (type_of freshObj@0) class_Worker)) (=> (= (type_of freshObj@0) class_Worker) (and (=> (= (ControlFlow 0 12) 9) anon20_Then_correct) (=> (= (ControlFlow 0 12) 11) anon20_Else_correct)))))))))))
(let ((anon19_Else_correct  (=> (HasDirectPerm Mask@6 null (Worker__preFork_at_Worker freshObj@0 FullPerm)) (=> (and (= Heap@7 Heap@4) (= (ControlFlow 0 16) 12)) anon10_correct))))
(let ((anon19_Then_correct  (=> (not (HasDirectPerm Mask@6 null (Worker__preFork_at_Worker freshObj@0 FullPerm))) (=> (and (and (= Heap@5 (MapType0Store Heap@4 null (|Worker__preFork_at_Worker#sm| freshObj@0 FullPerm) ZeroPMask)) (= Heap@6 (MapType0Store Heap@5 null (Worker__preFork_at_Worker freshObj@0 FullPerm) freshVersion@1))) (and (= Heap@7 Heap@6) (= (ControlFlow 0 15) 12))) anon10_correct))))
(let ((anon8_correct  (=> (and (= Mask@5 (MapType1Store Mask@4 freshObj@0 Worker__output (real_2_U (- (U_2_real (MapType1Select Mask@4 freshObj@0 Worker__output)) FullPerm)))) (= Mask@6 (MapType1Store Mask@5 null (Worker__preFork_at_Worker freshObj@0 FullPerm) (real_2_U (+ (U_2_real (MapType1Select Mask@5 null (Worker__preFork_at_Worker freshObj@0 FullPerm))) FullPerm))))) (=> (and (and (state Heap@4 Mask@6) (state Heap@4 Mask@6)) (and (|Worker__preFork_at_Worker#trigger| Heap@4 (Worker__preFork_at_Worker freshObj@0 FullPerm)) (= (MapType0Select Heap@4 null (Worker__preFork_at_Worker freshObj@0 FullPerm)) (CombineFrames (MapType0Select Heap@4 null (Worker__preFork_at_Thread freshObj@0 FullPerm)) (CombineFrames (FrameFragment (MapType0Select Heap@4 freshObj@0 Worker__input)) (ConditionalFrame FullPerm (FrameFragment (MapType0Select Heap@4 freshObj@0 Worker__output)))))))) (and (=> (= (ControlFlow 0 17) 15) anon19_Then_correct) (=> (= (ControlFlow 0 17) 16) anon19_Else_correct))))))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 20) 17)) anon8_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (<= FullPerm (U_2_real (MapType1Select Mask@4 freshObj@0 Worker__output)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 freshObj@0 Worker__output))) (=> (= (ControlFlow 0 18) 17) anon8_correct))))))
(let ((anon6_correct  (=> (and (= Mask@3 (MapType1Store Mask@2 null (Worker__preFork_at_Thread freshObj@0 FullPerm) (real_2_U (- (U_2_real (MapType1Select Mask@2 null (Worker__preFork_at_Thread freshObj@0 FullPerm))) FullPerm)))) (InsidePredicate (Worker__preFork_at_Worker freshObj@0 FullPerm) (MapType0Select Heap@4 null (Worker__preFork_at_Worker freshObj@0 FullPerm)) (Worker__preFork_at_Thread freshObj@0 FullPerm) (MapType0Select Heap@4 null (Worker__preFork_at_Thread freshObj@0 FullPerm)))) (and (=> (= (ControlFlow 0 21) (- 0 23)) (> (U_2_real (MapType1Select Mask@3 freshObj@0 Worker__input)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@3 freshObj@0 Worker__input)) NoPerm) (=> (> wildcard@1 NoPerm) (=> (and (< wildcard@1 (U_2_real (MapType1Select Mask@3 freshObj@0 Worker__input))) (= Mask@4 (MapType1Store Mask@3 freshObj@0 Worker__input (real_2_U (- (U_2_real (MapType1Select Mask@3 freshObj@0 Worker__input)) wildcard@1))))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (not (= FullPerm NoPerm))) (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 21) 18) anon18_Then_correct) (=> (= (ControlFlow 0 21) 20) anon18_Else_correct)))))))))))
(let ((anon17_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 26) 21)) anon6_correct)))
(let ((anon17_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null (Worker__preFork_at_Thread freshObj@0 FullPerm))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 null (Worker__preFork_at_Thread freshObj@0 FullPerm)))) (=> (= (ControlFlow 0 24) 21) anon6_correct))))))
(let ((anon4_correct  (=> (and (state Heap@4 Mask@2) (state Heap@4 Mask@2)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (<= NoPerm FullPerm)) (=> (<= NoPerm FullPerm) (and (=> (= (ControlFlow 0 27) 24) anon17_Then_correct) (=> (= (ControlFlow 0 27) 26) anon17_Else_correct)))))))
(let ((anon16_Else_correct  (=> (HasDirectPerm Mask@2 null (Worker__preFork_at_Thread freshObj@0 FullPerm)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 30) 27)) anon4_correct))))
(let ((anon16_Then_correct  (=> (not (HasDirectPerm Mask@2 null (Worker__preFork_at_Thread freshObj@0 FullPerm))) (=> (and (and (= Heap@2 (MapType0Store Heap@1 null (|Worker__preFork_at_Thread#sm| freshObj@0 FullPerm) ZeroPMask)) (= Heap@3 (MapType0Store Heap@2 null (Worker__preFork_at_Thread freshObj@0 FullPerm) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 29) 27))) anon4_correct))))
(let ((anon15_Else_correct  (=> (U_2_bool (MapType0Select Heap@@30 diz@@125 $allocated)) (=> (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@30 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@30 freshObj@0 $allocated (bool_2_U true)))) (=> (and (and (and (= Mask@0 (MapType1Store ZeroMask freshObj@0 Worker__input (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 Worker__input)) FullPerm)))) (= Mask@1 (MapType1Store Mask@0 freshObj@0 Worker__output (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@0 Worker__output)) FullPerm))))) (and (state Heap@0 Mask@1) (= (type_of freshObj@0) class_Worker))) (and (and (state Heap@0 Mask@1) (state Heap@0 Mask@1)) (and (state Heap@0 Mask@1) (state Heap@0 Mask@1)))) (and (=> (= (ControlFlow 0 31) (- 0 32)) (= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 Worker__input)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 Worker__input))) (=> (= Heap@1 (MapType0Store Heap@0 freshObj@0 Worker__input (int_2_U input))) (=> (and (state Heap@1 Mask@1) (= Mask@2 (MapType1Store Mask@1 null (Worker__preFork_at_Thread freshObj@0 FullPerm) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (Worker__preFork_at_Thread freshObj@0 FullPerm))) FullPerm))))) (=> (and (and (state Heap@1 Mask@2) (state Heap@1 Mask@2)) (and (|Worker__preFork_at_Thread#trigger| Heap@1 (Worker__preFork_at_Thread freshObj@0 FullPerm)) (= (MapType0Select Heap@1 null (Worker__preFork_at_Thread freshObj@0 FullPerm)) EmptyFrame))) (and (=> (= (ControlFlow 0 31) 29) anon16_Then_correct) (=> (= (ControlFlow 0 31) 30) anon16_Else_correct))))))))))))
(let ((anon15_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (not (= sys__result null))) (=> (and (and (state PostHeap@0 ZeroMask) (= (type_of sys__result) class_Worker)) (and (state PostHeap@0 ZeroMask) (= PostMask@0 (MapType1Store ZeroMask null (Worker__preFork_at_Worker sys__result FullPerm) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Worker__preFork_at_Worker sys__result FullPerm))) FullPerm)))))) (=> (and (and (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)) (and (> wildcard@0 NoPerm) (not (= sys__result null)))) (and (and (= PostMask@1 (MapType1Store PostMask@0 sys__result Worker__input (real_2_U (+ (U_2_real (MapType1Select PostMask@0 sys__result Worker__input)) wildcard@0)))) (state PostHeap@0 PostMask@1)) (and (state PostHeap@0 PostMask@1) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm PostMask@1 sys__result Worker__input))))))
(let ((anon0_correct  (=> (state Heap@@30 ZeroMask) (=> (and (>= current_thread_id 0) (state Heap@@30 ZeroMask)) (and (=> (= (ControlFlow 0 33) 2) anon15_Then_correct) (=> (= (ControlFlow 0 33) 31) anon15_Else_correct))))))
