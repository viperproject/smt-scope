...
(assert  (and (and (and (and (and (= (type a_2) (SeqType RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type Heap@@33) (MapType0Type RefType))) (= (type diz) RefType)))
(set-info :boogie-vc-id Ref__loop_main_22)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 42) (let ((anon20_correct true))
(let ((anon39_Else_correct  (=> (and (not (and (<= 0 i_5) (< i_5 len))) (= (ControlFlow 0 28) 20)) anon20_correct)))
(let ((anon39_Then_correct  (=> (and (<= 0 i_5) (< i_5 len)) (and (=> (= (ControlFlow 0 21) (- 0 27)) (>= i_5 0)) (=> (>= i_5 0) (and (=> (= (ControlFlow 0 21) (- 0 26)) (< i_5 (|Seq#Length| a_2))) (=> (< i_5 (|Seq#Length| a_2)) (and (=> (= (ControlFlow 0 21) (- 0 25)) (HasDirectPerm QPMask@1 (|Seq#Index| a_2 i_5) Ref__Integer_value)) (=> (HasDirectPerm QPMask@1 (|Seq#Index| a_2 i_5) Ref__Integer_value) (and (=> (= (ControlFlow 0 21) (- 0 24)) (>= i_5 0)) (=> (>= i_5 0) (and (=> (= (ControlFlow 0 21) (- 0 23)) (< i_5 (|Seq#Length| a_2))) (=> (< i_5 (|Seq#Length| a_2)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (HasDirectPerm QPMask@0 (|Seq#Index| a_2 i_5) Ref__Integer_value)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| a_2 i_5) Ref__Integer_value) (=> (= (ControlFlow 0 21) 20) anon20_correct))))))))))))))))
(let ((anon38_Else_correct true))
(let ((anon36_Else_correct  (and (=> (= (ControlFlow 0 29) (- 0 30)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 len))) (and (<= 0 i_3_1) (< i_3_1 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| a_2 i_3) (|Seq#Index| a_2 i_3_1))))
 :qid |stdinbpl.1961:15|
 :skolemid |165|
 ...
 :qid |stdinbpl.1961:15|
 :skolemid |165|
)) (=> (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 len)) (< NoPerm FullPerm)) (and (qpRange10 (|Seq#Index| a_2 i_3@@1)) (= (invRecv10 (|Seq#Index| a_2 i_3@@1)) i_3@@1)))
 :qid |stdinbpl.1967:22|
 :skolemid |166|
 :pattern ( (|Seq#Index| a_2 i_3@@1))
 :pattern ( (|Seq#Index| a_2 i_3@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv10 o_3)) (< (invRecv10 o_3) len)) (< NoPerm FullPerm)) (qpRange10 o_3)) (= (|Seq#Index| a_2 (invRecv10 o_3)) o_3)))
 ...
 :pattern ( (|Seq#Index| a_2 i_3@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv10 o_3@@0)) (< (invRecv10 o_3@@0) len)) (< NoPerm FullPerm)) (qpRange10 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| a_2 (invRecv10 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 Ref__Integer_value)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 Ref__Integer_value)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv10 o_3@@0)) (< (invRecv10 o_3@@0) len)) (< NoPerm FullPerm)) (qpRange10 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 Ref__Integer_value)) (U_2_real (MapType1Select ZeroMask o_3@@0 Ref__Integer_value))))))
...
(let ((anon37_Else_correct  (=> (and (not (and (<= 0 i_4) (< i_4 len))) (= (ControlFlow 0 18) 14)) anon16_correct)))
(let ((anon37_Then_correct  (=> (and (<= 0 i_4) (< i_4 len)) (and (=> (= (ControlFlow 0 15) (- 0 17)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 15) (- 0 16)) (< i_4 (|Seq#Length| a_2))) (=> (< i_4 (|Seq#Length| a_2)) (=> (= (ControlFlow 0 15) 14) anon16_correct))))))))
...
(let ((anon35_Then_correct  (=> (< 0 len) (=> (and (= (|Seq#Length| a_2) len) (= (ControlFlow 0 32) 31)) anon13_correct))))
...
(let ((anon32_Else_correct  (and (=> (= (ControlFlow 0 35) (- 0 36)) (forall ((i_1 Int) (i_1_2 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_2)) (and (<= 0 i_1) (< i_1 len))) (and (<= 0 i_1_2) (< i_1_2 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| a_2 i_1) (|Seq#Index| a_2 i_1_2))))
 :qid |stdinbpl.1900:15|
 :skolemid |159|
 ...
 :pattern ( (|Seq#Index| a_2 i_1@@1))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (<= 0 (invRecv9 o_3@@2)) (< (invRecv9 o_3@@2) len)) (< NoPerm FullPerm)) (qpRange9 o_3@@2)) (= (|Seq#Index| a_2 (invRecv9 o_3@@2)) o_3@@2)))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 ...
 :qid |stdinbpl.1926:29|
 :skolemid |164|
 :pattern ( (MapType1Select ZeroMask o_3@@4 f_5@@0))
 :pattern ( (MapType1Select QPMask@0 o_3@@4 f_5@@0))
))) (and (state Heap@@33 QPMask@0) (state Heap@@33 QPMask@0))) (and (=> (= (ControlFlow 0 35) 34) anon34_Then_correct) (=> (= (ControlFlow 0 35) 13) anon34_Else_correct)))))))))
(let ((anon9_correct true))
(let ((anon33_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 len))) (= (ControlFlow 0 12) 8)) anon9_correct)))
(let ((anon33_Then_correct  (=> (and (<= 0 i_2) (< i_2 len)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_2 (|Seq#Length| a_2))) (=> (< i_2 (|Seq#Length| a_2)) (=> (= (ControlFlow 0 9) 8) anon9_correct))))))))
(let ((anon30_Else_correct  (=> (and (forall ((k_1_1 Int) (j_1_1 Int) ) (!  (=> (and (>= k_1_1 0) (and (< k_1_1 (|Seq#Length| a_2)) (and (>= j_1_1 0) (and (< j_1_1 (|Seq#Length| a_2)) (not (= k_1_1 j_1_1)))))) (not (= (|Seq#Index| a_2 k_1_1) (|Seq#Index| a_2 j_1_1))))
 :qid |stdinbpl.1882:20|
 :skolemid |158|
 :pattern ( (|Seq#Index| a_2 k_1_1) (|Seq#Index| a_2 j_1_1))
)) (state Heap@@33 ZeroMask)) (and (and (=> (= (ControlFlow 0 37) 35) anon32_Else_correct) (=> (= (ControlFlow 0 37) 9) anon33_Then_correct)) (=> (= (ControlFlow 0 37) 12) anon33_Else_correct)))))
(let ((anon5_correct true))
(let ((anon31_Else_correct  (=> (and (not (and (>= k_13 0) (and (< k_13 (|Seq#Length| a_2)) (and (>= j_7 0) (and (< j_7 (|Seq#Length| a_2)) (not (= k_13 j_7))))))) (= (ControlFlow 0 7) 1)) anon5_correct)))
(let ((anon31_Then_correct  (=> (and (>= k_13 0) (and (< k_13 (|Seq#Length| a_2)) (and (>= j_7 0) (and (< j_7 (|Seq#Length| a_2)) (not (= k_13 j_7)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= k_13 0)) (=> (>= k_13 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< k_13 (|Seq#Length| a_2))) (=> (< k_13 (|Seq#Length| a_2)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_7 0)) (=> (>= j_7 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_7 (|Seq#Length| a_2))) (=> (< j_7 (|Seq#Length| a_2)) (=> (= (ControlFlow 0 2) 1) anon5_correct))))))))))))
(let ((anon2_correct  (=> (state Heap@@33 ZeroMask) (and (and (=> (= (ControlFlow 0 38) 37) anon30_Else_correct) (=> (= (ControlFlow 0 38) 2) anon31_Then_correct)) (=> (= (ControlFlow 0 38) 7) anon31_Else_correct)))))
(let ((anon29_Else_correct  (=> (and (<= len 0) (= (ControlFlow 0 40) 38)) anon2_correct)))
(let ((anon29_Then_correct  (=> (< 0 len) (=> (and (= (|Seq#Length| a_2) len) (= (ControlFlow 0 39) 38)) anon2_correct))))
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@33 diz $allocated))) (=> (and (and (not (= diz null)) (state Heap@@33 ZeroMask)) (and (>= current_thread_id 0) (state Heap@@33 ZeroMask))) (and (=> (= (ControlFlow 0 41) 39) anon29_Then_correct) (=> (= (ControlFlow 0 41) 40) anon29_Else_correct)))))))
