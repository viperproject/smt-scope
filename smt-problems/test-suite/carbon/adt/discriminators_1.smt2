...
(assert  (and (= (type Heap@@9) (MapType0Type RefType)) (= (type list@0) (ListDomainTypeType intType))))
(set-info :boogie-vc-id discriminators_1a)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= list@0 (Cons (int_2_U 1) (Nil intType))) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (List_tag list@0) 0)) (=> (= (List_tag list@0) 0) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (List_tag (get_List_tail list@0)) 1)) (=> (= (List_tag (get_List_tail list@0)) 1) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (not (= (List_tag (get_List_tail list@0)) 0))))))))))))
