...
(declare-fun AWTwo (Int Int) T@U)
(declare-fun IsPredicateField (T@U) Bool)
(declare-fun PredicateType_AWTwoType () T@T)
(declare-fun FrameTypeType () T@T)
(declare-fun |AWTwo#trigger| (T@U T@U) Bool)
(declare-fun |AWTwo#everUsed| (T@U) Bool)
...
(declare-fun |AWTwo#sm| (Int Int) T@U)
...
(assert  (and (and (= (Ctor PredicateType_AWTwoType) 10) (= (Ctor FrameTypeType) 11)) (forall ((arg0@@23 Int) (arg1@@9 Int) ) (! (= (type (AWTwo arg0@@23 arg1@@9)) (FieldType PredicateType_AWTwoType FrameTypeType))
 :qid |funType:AWTwo|
 :pattern ( (AWTwo arg0@@23 arg1@@9))
))))
(assert (forall ((sender Int) (amount Int) ) (! (IsPredicateField (AWTwo sender amount))
 :qid |stdinbpl.202:15|
 :skolemid |23|
 :pattern ( (AWTwo sender amount))
)))
(assert (forall ((Heap@@0 T@U) (sender@@0 Int) (amount@@0 Int) ) (!  (=> (= (type Heap@@0) (MapType0Type RefType)) (|AWTwo#everUsed| (AWTwo sender@@0 amount@@0)))
 :qid |stdinbpl.221:15|
 :skolemid |27|
 :pattern ( (|AWTwo#trigger| Heap@@0 (AWTwo sender@@0 amount@@0)))
)))
...
(assert (forall ((arg0@@26 Int) (arg1@@10 Int) ) (! (= (type (|AWTwo#sm| arg0@@26 arg1@@10)) (FieldType PredicateType_AWTwoType (MapType1Type RefType boolType)))
 :qid |funType:AWTwo#sm|
 :pattern ( (|AWTwo#sm| arg0@@26 arg1@@10))
)))
...
(assert (forall ((sender@@3 Int) (amount@@3 Int) ) (! (= (getPredWandId (AWTwo sender@@3 amount@@3)) 0)
 :qid |stdinbpl.206:15|
 :skolemid |24|
...
(assert (forall ((sender@@4 Int) (amount@@4 Int) ) (! (= (PredicateMaskField (AWTwo sender@@4 amount@@4)) (|AWTwo#sm| sender@@4 amount@@4))
 :qid |stdinbpl.198:15|
 :skolemid |22|
 :pattern ( (PredicateMaskField (AWTwo sender@@4 amount@@4)))
)))
...
(assert  (and (= (type Heap@@10) (MapType0Type RefType)) (= (type QPMask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test_AWTwo)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((s_1 Int) (a_1 Int) (s_1_1 Int) (a_1_1 Int) ) (!  (=> (and (and (and (and (and (not (= s_1 s_1_1)) (not (= a_1 a_1_1))) (<= s_1 last)) (<= s_1_1 last)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= s_1 s_1_1)) (not (= a_1 a_1_1))))
 :qid |stdinbpl.261:17|
 :skolemid |28|
 :pattern ( (neverTriggered2 s_1 a_1) (neverTriggered2 s_1_1 a_1_1))
))) (=> (forall ((s_1@@0 Int) (a_1@@0 Int) (s_1_1@@0 Int) (a_1_1@@0 Int) ) (!  (=> (and (and (and (and (and (not (= s_1@@0 s_1_1@@0)) (not (= a_1@@0 a_1_1@@0))) (<= s_1@@0 last)) (<= s_1_1@@0 last)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= s_1@@0 s_1_1@@0)) (not (= a_1@@0 a_1_1@@0))))
 :qid |stdinbpl.261:17|
 :skolemid |28|
 :pattern ( (neverTriggered2 s_1@@0 a_1@@0) (neverTriggered2 s_1_1@@0 a_1_1@@0))
)) (=> (forall ((s_1@@1 Int) (a_1@@1 Int) ) (!  (=> (and (<= s_1@@1 last) (< NoPerm FullPerm)) (and (and (= (invRecv1 s_1@@1 a_1@@1) s_1@@1) (= (invRecv2 s_1@@1 a_1@@1) a_1@@1)) (qpRange2 s_1@@1 a_1@@1)))
 :qid |stdinbpl.267:22|
 :skolemid |29|
 :pattern ( (MapType0Select Heap@@10 null (AWTwo s_1@@1 a_1@@1)))
 :pattern ( (MapType1Select ZeroMask null (AWTwo s_1@@1 a_1@@1)))
 :pattern ( (MapType0Select Heap@@10 null (AWTwo s_1@@1 a_1@@1)))
)) (=> (and (and (and (forall ((sender@@5 Int) (amount@@5 Int) ) (!  (=> (and (and (<= (invRecv1 sender@@5 amount@@5) last) (< NoPerm FullPerm)) (qpRange2 sender@@5 amount@@5)) (and (= (invRecv1 sender@@5 amount@@5) sender@@5) (= (invRecv2 sender@@5 amount@@5) amount@@5)))
 :qid |stdinbpl.271:22|
 :skolemid |30|
 :pattern ( (invRecv1 sender@@5 amount@@5) (invRecv2 sender@@5 amount@@5))
)) (forall ((sender@@6 Int) (amount@@6 Int) ) (!  (=> (and (and (<= (invRecv1 sender@@6 amount@@6) last) (< NoPerm FullPerm)) (qpRange2 sender@@6 amount@@6)) (and (=> (< NoPerm FullPerm) (and (= (invRecv1 sender@@6 amount@@6) sender@@6) (= (invRecv2 sender@@6 amount@@6) amount@@6))) (= (U_2_real (MapType1Select QPMask@0 null (AWTwo sender@@6 amount@@6))) (+ (U_2_real (MapType1Select ZeroMask null (AWTwo sender@@6 amount@@6))) FullPerm))))
 :qid |stdinbpl.277:22|
 :skolemid |31|
 :pattern ( (MapType1Select QPMask@0 null (AWTwo sender@@6 amount@@6)))
...
)) (forall ((sender@@7 Int) (amount@@7 Int) ) (!  (=> (not (and (and (<= (invRecv1 sender@@7 amount@@7) last) (< NoPerm FullPerm)) (qpRange2 sender@@7 amount@@7))) (= (U_2_real (MapType1Select QPMask@0 null (AWTwo sender@@7 amount@@7))) (U_2_real (MapType1Select ZeroMask null (AWTwo sender@@7 amount@@7)))))
 :qid |stdinbpl.287:22|
 :skolemid |33|
 :pattern ( (MapType1Select QPMask@0 null (AWTwo sender@@7 amount@@7)))
)))) (and (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0)) (and (state Heap@@10 QPMask@0) (= (ControlFlow 0 3) (- 0 2))))) (= (U_2_real (MapType1Select QPMask@0 null (AWTwo (+ last 1) 0))) NoPerm)))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct)))))
