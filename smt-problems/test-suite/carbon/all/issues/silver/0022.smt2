...
))) (= (type keys) (FieldType NormalFieldType (SeqType intType)))))
(assert (distinct $allocated keys)
)
...
(assert  (not (IsPredicateField keys)))
(assert  (not (IsWandField keys)))
...
(assert  (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type this) RefType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= FullPerm (U_2_real (MapType1Select Mask@0 this keys))))))
(let ((anon4_Else_correct  (=> (not b_2) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@0 this keys)) (=> (HasDirectPerm Mask@0 this keys) (=> (= (ControlFlow 0 4) 2) anon3_correct))))))
(let ((anon4_Then_correct  (=> (and b_2 (= (ControlFlow 0 3) 2)) anon3_correct)))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 this $allocated))) (=> (and (and (not (= this null)) (= Mask@0 (MapType1Store ZeroMask this keys (real_2_U (+ (U_2_real (MapType1Select ZeroMask this keys)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 6) 3) anon4_Then_correct) (=> (= (ControlFlow 0 6) 4) anon4_Else_correct))))))
