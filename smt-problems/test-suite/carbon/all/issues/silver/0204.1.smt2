...
(assert  (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type WandDefLHSHeap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type Ops_7Heap@0) (MapType0Type RefType))) (= (type Used_7Heap@0) (MapType0Type RefType))) (= (type Used_6Heap@0) (MapType0Type RefType))))
...
(let ((anon31_Else_correct  (=> (forall ((a_1_1 Int) (b_1_2 Int) ) (!  (=> (f2 a_1_1 b_1_2) (forall ((q_5 Int) ) (! (f3 a_1_1 b_1_2 q_5)
 :qid |stdinbpl.1261:48|
 :skolemid |152|
 :pattern ( (f3 a_1_1 b_1_2 q_5))
)))
 :qid |stdinbpl.1259:24|
 :skolemid |153|
 :pattern ( (f2 a_1_1 b_1_2))
...
(let ((anon32_Then_correct  (=> (f2 a_2 b_12) (and (=> (= (ControlFlow 0 6) 5) anon33_Then_correct) (=> (= (ControlFlow 0 6) 3) anon17_correct)))))
(let ((anon32_Else_correct  (=> (and (not (f2 a_2 b_12)) (= (ControlFlow 0 4) 3)) anon17_correct)))
(let ((anon30_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null wand_2))))))
(let ((anon12_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (=> (and (and b_10@5 b_10@5) b_11@0) (forall ((q_3 Int) ) (! (f1 q_3)
 :qid |stdinbpl.1229:42|
 :skolemid |151|
 :pattern ( (f1 q_3))
)))) (=> (=> (and (and b_10@5 b_10@5) b_11@0) (forall ((q_3@@0 Int) ) (! (f1 q_3@@0)
 :qid |stdinbpl.1229:42|
 :skolemid |151|
 :pattern ( (f1 q_3@@0))
...
(let ((anon28_Then_correct  (=> b_10@5 (and (=> (= (ControlFlow 0 15) 14) anon29_Then_correct) (=> (= (ControlFlow 0 15) 10) anon12_correct)))))
(let ((anon28_Else_correct  (=> (and (not b_10@5) (= (ControlFlow 0 13) 10)) anon12_correct)))
(let ((anon27_Then_correct  (=> (and (and b_10@5 b_10@5) b_11@0) (and (=> (= (ControlFlow 0 16) 15) anon28_Then_correct) (=> (= (ControlFlow 0 16) 13) anon28_Else_correct)))))
(let ((anon27_Else_correct  (=> (and (not (and (and b_10@5 b_10@5) b_11@0)) (= (ControlFlow 0 12) 10)) anon12_correct)))
(let ((anon8_correct  (=> (= b_10@4  (and b_10@3 (state Ops_7Heap@0 ZeroMask))) (=> (and (= b_10@5  (and b_10@4 (state Ops_7Heap@0 ZeroMask))) (= b_11@0  (and b_11 (state Used_7Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 17) 16) anon27_Then_correct) (=> (= (ControlFlow 0 17) 12) anon27_Else_correct))))))
(let ((anon7_correct  (=> (= b_10@2  (and b_10@1 (forall ((x_3 Int) (y_3 Int) ) (!  (=> (f2 x_3 y_3) (forall ((z_3 Int) ) (! (f3 x_3 y_3 z_3)
 :qid |stdinbpl.1201:42|
 :skolemid |149|
 :pattern ( (f3 x_3 y_3 z_3))
)))
 :qid |stdinbpl.1199:31|
 :skolemid |150|
 :pattern ( (f2 x_3 y_3))
)))) (=> (and (= b_10@3 b_10@2) (= (ControlFlow 0 19) 17)) anon8_correct))))
(let ((anon6_correct  (=> (and (= b_10@1 false) (= (ControlFlow 0 22) 19)) anon7_correct)))
(let ((anon25_Else_correct  (=> (and (not (f2 x_2 y_1)) (= (ControlFlow 0 24) 22)) anon6_correct)))
(let ((anon25_Then_correct  (=> (and (f2 x_2 y_1) (= (ControlFlow 0 23) 22)) anon6_correct)))
(let ((anon24_Else_correct  (=> (and (= b_10@1 b_10@0) (= (ControlFlow 0 21) 19)) anon7_correct)))
(let ((anon23_Then_correct  (=> b_10@0 (and (and (=> (= (ControlFlow 0 25) 21) anon24_Else_correct) (=> (= (ControlFlow 0 25) 23) anon25_Then_correct)) (=> (= (ControlFlow 0 25) 24) anon25_Else_correct)))))
(let ((anon23_Else_correct  (=> (not b_10@0) (=> (and (= b_10@1 b_10@0) (= (ControlFlow 0 20) 19)) anon7_correct))))
(let ((anon22_Then_correct  (=> b_10@0 (and (=> (= (ControlFlow 0 26) 25) anon23_Then_correct) (=> (= (ControlFlow 0 26) 20) anon23_Else_correct)))))
(let ((anon22_Else_correct  (=> (not b_10@0) (=> (and (= b_10@3 b_10@0) (= (ControlFlow 0 18) 17)) anon8_correct))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= b_10@0  (and b_10 (state Ops_7Heap@0 ZeroMask))) (= b_9@0  (and b_9 (state Used_6Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 27) 26) anon22_Then_correct) (=> (= (ControlFlow 0 27) 18) anon22_Else_correct))))))
