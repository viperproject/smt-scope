...
(assert  (and (= (type xs@@15) (SeqType RefType)) (= (type Heap@@18) (MapType0Type RefType))))
(set-info :boogie-vc-id |P#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i_8))) (= (ControlFlow 0 14) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i_8)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= i_8 0)) (=> (>= i_8 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< i_8 (|Seq#Length| xs@@15))) (=> (< i_8 (|Seq#Length| xs@@15)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((i_2 Int) (i_2_1 Int) ) (!  (=> (and (and (and (and (not (= i_2 i_2_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i_2))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@15 i_2) (|Seq#Index| xs@@15 i_2_1))))
 :qid |stdinbpl.976:15|
 :skolemid |92|
)))))
(let ((anon9_Else_correct  (=> (forall ((i1_1_1 Int) (i2_1_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i1_1_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i2_1_1)) (not (= i1_1_1 i2_1_1)))) (not (= (|Seq#Index| xs@@15 i1_1_1) (|Seq#Index| xs@@15 i2_1_1))))
 :qid |stdinbpl.959:20|
 :skolemid |91|
...
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i1_2)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i2_2)) (not (= i1_2 i2_2))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i1_2)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i2_2)) (not (= i1_2 i2_2)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_2 0)) (=> (>= i1_2 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_2 (|Seq#Length| xs@@15))) (=> (< i1_2 (|Seq#Length| xs@@15)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_2 0)) (=> (>= i2_2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_2 (|Seq#Length| xs@@15))) (=> (< i2_2 (|Seq#Length| xs@@15)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@18 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (< 5 (|Seq#Length| xs@@15))) (and (and (=> (= (ControlFlow 0 16) 15) anon9_Else_correct) (=> (= (ControlFlow 0 16) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 16) 7) anon10_Else_correct))))))
