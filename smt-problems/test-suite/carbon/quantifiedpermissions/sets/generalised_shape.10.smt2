...
(assert  (and (and (and (and (and (and (and (and (and (= (type x1_2) RefType) (= (type Heap@@10) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv11 arg0@@48)) RefType)
 :qid |funType:invRecv11|
 :pattern ( (invRecv11 arg0@@48))
))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type x_11) RefType)) (= (type QPMask@2) (MapType1Type RefType realType))) (forall ((arg0@@49 T@U) ) (! (= (type (invRecv9 arg0@@49)) RefType)
...
(let ((anon12_Else_correct  (=> (and (not (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_11))) (= (ControlFlow 0 12) 9)) anon6_correct)))
(let ((anon12_Then_correct  (=> (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_11)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm QPMask@2 x_11 g)) (=> (HasDirectPerm QPMask@2 x_11 g) (=> (= (ControlFlow 0 10) 9) anon6_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_3))) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (MapType0Select PostHeap@0 x_3 g) (MapType0Select PostHeap@0 x_3_1 g)))))
...
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_1))) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_1@@0))) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.1222:15|
 :skolemid |140|
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_1@@1)) (< NoPerm FullPerm)) (and (qpRange9 x_1@@1) (= (invRecv9 x_1@@1) x_1@@1))))
 :qid |stdinbpl.1228:22|
 :skolemid |141|
 :pattern ( (MapType0Select PostHeap@0 x_1@@1 g))
 :pattern ( (MapType1Select QPMask@2 x_1@@1 g))
 :pattern ( (MapType2Select (|Set#Singleton| x1_2) x_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select (|Set#Singleton| x1_2) (invRecv9 o_3))) (< NoPerm FullPerm)) (qpRange9 o_3)) (= (invRecv9 o_3) o_3)))
 :qid |stdinbpl.1232:22|
 :skolemid |142|
 :pattern ( (invRecv9 o_3))
)) (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_1@@2))) (not (= x_1@@2 null)))
 :qid |stdinbpl.1238:22|
 :skolemid |143|
 :pattern ( (MapType0Select PostHeap@0 x_1@@2 g))
 :pattern ( (MapType1Select QPMask@2 x_1@@2 g))
 :pattern ( (MapType2Select (|Set#Singleton| x1_2) x_1@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select (|Set#Singleton| x1_2) (invRecv9 o_3@@0))) (< NoPerm FullPerm)) (qpRange9 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv9 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 g)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 g)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select (|Set#Singleton| x1_2) (invRecv9 o_3@@0))) (< NoPerm FullPerm)) (qpRange9 o_3@@0))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 g)) (U_2_real (MapType1Select ZeroMask o_3@@0 g))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.1248:29|
 :skolemid |145|
 :pattern ( (MapType1Select ZeroMask o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@2 o_3@@1 f_5))
))) (and (state PostHeap@0 QPMask@2) (state PostHeap@0 QPMask@2))) (and (and (=> (= (ControlFlow 0 13) 8) anon11_Else_correct) (=> (= (ControlFlow 0 13) 10) anon12_Then_correct)) (=> (= (ControlFlow 0 13) 12) anon12_Else_correct)))))))))
(let ((anon10_Then_correct true))
(let ((anon9_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 15) 6) anon10_Then_correct) (=> (= (ControlFlow 0 15) 13) anon10_Else_correct)))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall ((x_4 T@U) (x_4_1 T@U) ) (!  (=> (and (= (type x_4) RefType) (= (type x_4_1) RefType)) (=> (and (and (and (and (not (= x_4 x_4_1)) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_4))) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4 x_4_1))))
 :qid |stdinbpl.1313:17|
 :skolemid |152|
 :pattern ( (neverTriggered11 x_4) (neverTriggered11 x_4_1))
))) (=> (forall ((x_4@@0 T@U) (x_4_1@@0 T@U) ) (!  (=> (and (= (type x_4@@0) RefType) (= (type x_4_1@@0) RefType)) (=> (and (and (and (and (not (= x_4@@0 x_4_1@@0)) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_4@@0))) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_4_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4@@0 x_4_1@@0))))
 :qid |stdinbpl.1313:17|
 :skolemid |152|
 :pattern ( (neverTriggered11 x_4@@0) (neverTriggered11 x_4_1@@0))
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((x_4@@1 T@U) ) (!  (=> (and (= (type x_4@@1) RefType) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_4@@1))) (>= (U_2_real (MapType1Select Mask@1 x_4@@1 g)) FullPerm))
 :qid |stdinbpl.1320:17|
 :skolemid |153|
 :pattern ( (MapType0Select Heap@@10 x_4@@1 g))
 :pattern ( (MapType1Select QPMask@0 x_4@@1 g))
 :pattern ( (MapType2Select (|Set#Singleton| x1_2) x_4@@1))
))) (=> (forall ((x_4@@2 T@U) ) (!  (=> (and (= (type x_4@@2) RefType) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_4@@2))) (>= (U_2_real (MapType1Select Mask@1 x_4@@2 g)) FullPerm))
 :qid |stdinbpl.1320:17|
 :skolemid |153|
 :pattern ( (MapType0Select Heap@@10 x_4@@2 g))
 :pattern ( (MapType1Select QPMask@0 x_4@@2 g))
 :pattern ( (MapType2Select (|Set#Singleton| x1_2) x_4@@2))
)) (=> (and (and (forall ((x_4@@3 T@U) ) (!  (=> (= (type x_4@@3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_4@@3)) (< NoPerm FullPerm)) (and (qpRange11 x_4@@3) (= (invRecv11 x_4@@3) x_4@@3))))
 :qid |stdinbpl.1326:22|
 :skolemid |154|
 :pattern ( (MapType0Select Heap@@10 x_4@@3 g))
 :pattern ( (MapType1Select QPMask@0 x_4@@3 g))
 :pattern ( (MapType2Select (|Set#Singleton| x1_2) x_4@@3))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Singleton| x1_2) (invRecv11 o_3@@2))) (and (< NoPerm FullPerm) (qpRange11 o_3@@2))) (= (invRecv11 o_3@@2) o_3@@2)))
 :qid |stdinbpl.1330:22|
 :skolemid |155|
 :pattern ( (invRecv11 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType2Select (|Set#Singleton| x1_2) (invRecv11 o_3@@3))) (and (< NoPerm FullPerm) (qpRange11 o_3@@3))) (and (= (invRecv11 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 g)) (- (U_2_real (MapType1Select Mask@1 o_3@@3 g)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select (|Set#Singleton| x1_2) (invRecv11 o_3@@3))) (and (< NoPerm FullPerm) (qpRange11 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 g)) (U_2_real (MapType1Select Mask@1 o_3@@3 g))))))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 g))) (= (U_2_real (MapType1Select Mask@1 o_3@@4 f_5@@0)) (U_2_real (MapType1Select QPMask@0 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.1342:29|
 :skolemid |157|
 :pattern ( (MapType1Select QPMask@0 o_3@@4 f_5@@0))
)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((x_5 T@U) (x_5_1 T@U) ) (!  (=> (and (= (type x_5) RefType) (= (type x_5_1) RefType)) (=> (and (and (and (and (not (= x_5 x_5_1)) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_5))) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (MapType0Select Heap@@10 x_5 g) (MapType0Select Heap@@10 x_5_1 g)))))
 :qid |stdinbpl.1354:17|
 :skolemid |158|
 :pattern ( (neverTriggered12 x_5) (neverTriggered12 x_5_1))
))) (=> (forall ((x_5@@0 T@U) (x_5_1@@0 T@U) ) (!  (=> (and (= (type x_5@@0) RefType) (= (type x_5_1@@0) RefType)) (=> (and (and (and (and (not (= x_5@@0 x_5_1@@0)) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_5@@0))) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_5_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (MapType0Select Heap@@10 x_5@@0 g) (MapType0Select Heap@@10 x_5_1@@0 g)))))
 :qid |stdinbpl.1354:17|
 :skolemid |158|
 :pattern ( (neverTriggered12 x_5@@0) (neverTriggered12 x_5_1@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((x_5@@1 T@U) ) (!  (=> (and (= (type x_5@@1) RefType) (U_2_bool (MapType2Select (|Set#Singleton| x1_2) x_5@@1))) (>= (U_2_real (MapType1Select QPMask@0 (MapType0Select Heap@@10 x_5@@1 g) f_7)) FullPerm))
 :qid |stdinbpl.1361:17|
 :skolemid |159|
 :pattern ( (MapType0Select Heap@@10 x_5@@1 g))
 :pattern ( (MapType2Select (|Set#Singleton| x1_2) x_5@@1))
))))))))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@10 x1_2 $allocated)) (not (= x1_2 null))) (and (= Mask@0 (MapType1Store ZeroMask x1_2 g (real_2_U (+ (U_2_real (MapType1Select ZeroMask x1_2 g)) FullPerm)))) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm Mask@0 x1_2 g)) (=> (HasDirectPerm Mask@0 x1_2 g) (=> (and (and (not (= (MapType0Select Heap@@10 x1_2 g) null)) (= Mask@1 (MapType1Store Mask@0 (MapType0Select Heap@@10 x1_2 g) f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 (MapType0Select Heap@@10 x1_2 g) f_7)) FullPerm))))) (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1))) (and (=> (= (ControlFlow 0 16) 15) anon9_Then_correct) (=> (= (ControlFlow 0 16) 2) anon9_Else_correct)))))))))
