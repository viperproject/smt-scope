...
(assert  (and (and (= (type xs@@39) (SeqType RefType)) (= (type Heap@@41) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |fun07#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 45) (let ((anon13_correct true))
(let ((anon33_Else_correct  (=> (and (not (and (>= k_4 0) (and (< k_4 (|Seq#Length| xs@@39)) (and (>= i_9 0) (and (< i_9 (|Seq#Length| xs@@39)) (not (= k_4 i_9))))))) (= (ControlFlow 0 39) 36)) anon13_correct)))
(let ((anon33_Then_correct  (=> (and (>= k_4 0) (and (< k_4 (|Seq#Length| xs@@39)) (and (>= i_9 0) (and (< i_9 (|Seq#Length| xs@@39)) (not (= k_4 i_9)))))) (and (=> (= (ControlFlow 0 37) (- 0 38)) (not (= (|Seq#Index| xs@@39 k_4) (|Seq#Index| xs@@39 i_9)))) (=> (not (= (|Seq#Index| xs@@39 k_4) (|Seq#Index| xs@@39 i_9))) (=> (= (ControlFlow 0 37) 36) anon13_correct))))))
(let ((anon32_Else_correct  (=> (forall ((k_5_1 Int) (i_10_1 Int) ) (!  (=> (and (>= k_5_1 0) (and (< k_5_1 (|Seq#Length| xs@@39)) (and (>= i_10_1 0) (and (< i_10_1 (|Seq#Length| xs@@39)) (not (= k_5_1 i_10_1)))))) (not (= (|Seq#Index| xs@@39 k_5_1) (|Seq#Index| xs@@39 i_10_1))))
 :qid |stdinbpl.1793:26|
 :skolemid |161|
 :pattern ( (|Seq#Index| xs@@39 k_5_1) (|Seq#Index| xs@@39 i_10_1))
)) (and (=> (= (ControlFlow 0 34) (- 0 35)) (forall ((i_11 Int) (i_11_1 Int) ) (!  (=> (and (and (and (and (not (= i_11 i_11_1)) (and (<= 0 i_11) (< i_11 (|Seq#Length| xs@@39)))) (and (<= 0 i_11_1) (< i_11_1 (|Seq#Length| xs@@39)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@39 i_11) (|Seq#Index| xs@@39 i_11_1))))
 :qid |stdinbpl.1804:23|
 :skolemid |162|
 :pattern ( (neverTriggered10 i_11) (neverTriggered10 i_11_1))
))) (=> (forall ((i_11@@0 Int) (i_11_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_11@@0 i_11_1@@0)) (and (<= 0 i_11@@0) (< i_11@@0 (|Seq#Length| xs@@39)))) (and (<= 0 i_11_1@@0) (< i_11_1@@0 (|Seq#Length| xs@@39)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@39 i_11@@0) (|Seq#Index| xs@@39 i_11_1@@0))))
 :qid |stdinbpl.1804:23|
 :skolemid |162|
 :pattern ( (neverTriggered10 i_11@@0) (neverTriggered10 i_11_1@@0))
)) (=> (= (ControlFlow 0 34) (- 0 33)) (forall ((i_11@@1 Int) ) (!  (=> (and (<= 0 i_11@@1) (< i_11@@1 (|Seq#Length| xs@@39))) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs@@39 i_11@@1) f_7)) FullPerm))
 :qid |stdinbpl.1811:23|
 :skolemid |163|
 :pattern ( (|Seq#Index| xs@@39 i_11@@1))
 :pattern ( (|Seq#Index| xs@@39 i_11@@1))
))))))))
(let ((anon21_correct true))
(let ((anon37_Else_correct  (=> (and (not (and (>= k_6 0) (and (< k_6 (|Seq#Length| xs@@39)) (and (>= i_12 0) (and (< i_12 (|Seq#Length| xs@@39)) (not (= k_6 i_12))))))) (= (ControlFlow 0 29) 26)) anon21_correct)))
(let ((anon37_Then_correct  (=> (and (>= k_6 0) (and (< k_6 (|Seq#Length| xs@@39)) (and (>= i_12 0) (and (< i_12 (|Seq#Length| xs@@39)) (not (= k_6 i_12)))))) (and (=> (= (ControlFlow 0 27) (- 0 28)) (not (= (|Seq#Index| xs@@39 k_6) (|Seq#Index| xs@@39 i_12)))) (=> (not (= (|Seq#Index| xs@@39 k_6) (|Seq#Index| xs@@39 i_12))) (=> (= (ControlFlow 0 27) 26) anon21_correct))))))
(let ((anon36_Else_correct  (=> (forall ((k_7_1 Int) (i_13_1 Int) ) (!  (=> (and (>= k_7_1 0) (and (< k_7_1 (|Seq#Length| xs@@39)) (and (>= i_13_1 0) (and (< i_13_1 (|Seq#Length| xs@@39)) (not (= k_7_1 i_13_1)))))) (not (= (|Seq#Index| xs@@39 k_7_1) (|Seq#Index| xs@@39 i_13_1))))
 :qid |stdinbpl.1861:28|
 :skolemid |168|
 :pattern ( (|Seq#Index| xs@@39 k_7_1) (|Seq#Index| xs@@39 i_13_1))
)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (forall ((i_14 Int) (i_14_1 Int) ) (!  (=> (and (and (and (and (not (= i_14 i_14_1)) (and (<= 0 i_14) (< i_14 (|Seq#Length| xs@@39)))) (and (<= 0 i_14_1) (< i_14_1 (|Seq#Length| xs@@39)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@39 i_14) (|Seq#Index| xs@@39 i_14_1))))
 :qid |stdinbpl.1872:25|
 :skolemid |169|
 :pattern ( (neverTriggered11 i_14) (neverTriggered11 i_14_1))
))) (=> (forall ((i_14@@0 Int) (i_14_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_14@@0 i_14_1@@0)) (and (<= 0 i_14@@0) (< i_14@@0 (|Seq#Length| xs@@39)))) (and (<= 0 i_14_1@@0) (< i_14_1@@0 (|Seq#Length| xs@@39)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@39 i_14@@0) (|Seq#Index| xs@@39 i_14_1@@0))))
 :qid |stdinbpl.1872:25|
 :skolemid |169|
 :pattern ( (neverTriggered11 i_14@@0) (neverTriggered11 i_14_1@@0))
)) (=> (= (ControlFlow 0 24) (- 0 23)) (forall ((i_14@@1 Int) ) (!  (=> (and (<= 0 i_14@@1) (< i_14@@1 (|Seq#Length| xs@@39))) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs@@39 i_14@@1) f_7)) FullPerm))
 :qid |stdinbpl.1879:25|
 :skolemid |170|
 :pattern ( (|Seq#Index| xs@@39 i_14@@1))
 :pattern ( (|Seq#Index| xs@@39 i_14@@1))
))))))))
(let ((anon25_correct  (=> (and (= Result@0 (ite (< j@@15 0) (fun07 Heap@@41 xs@@39 (+ j@@15 1)) (ite (<= (|Seq#Length| xs@@39) j@@15) (fun07 Heap@@41 xs@@39 (- j@@15 1)) (* (U_2_int (MapType0Select Heap@@41 (|Seq#Index| xs@@39 j@@15) f_7)) (U_2_int (MapType0Select Heap@@41 (|Seq#Index| xs@@39 j@@15) f_7)))))) (= (ControlFlow 0 14) (- 0 13))) (>= Result@0 0))))
(let ((anon31_Else_correct  (=> (and (|fun07#trigger| (FrameFragment (int_2_U (|fun07#condqp9| Heap@@41 xs@@39 (+ j@@15 1)))) xs@@39 (+ j@@15 1)) (= (ControlFlow 0 32) 14)) anon25_correct)))
(let ((anon30_Then_correct  (=> (< j@@15 0) (and (and (and (=> (= (ControlFlow 0 40) 32) anon31_Else_correct) (=> (= (ControlFlow 0 40) 34) anon32_Else_correct)) (=> (= (ControlFlow 0 40) 37) anon33_Then_correct)) (=> (= (ControlFlow 0 40) 39) anon33_Else_correct)))))
(let ((anon35_Else_correct  (=> (and (|fun07#trigger| (FrameFragment (int_2_U (|fun07#condqp9| Heap@@41 xs@@39 (- j@@15 1)))) xs@@39 (- j@@15 1)) (= (ControlFlow 0 22) 14)) anon25_correct)))
(let ((anon34_Then_correct  (=> (<= (|Seq#Length| xs@@39) j@@15) (and (and (and (=> (= (ControlFlow 0 30) 22) anon35_Else_correct) (=> (= (ControlFlow 0 30) 24) anon36_Else_correct)) (=> (= (ControlFlow 0 30) 27) anon37_Then_correct)) (=> (= (ControlFlow 0 30) 29) anon37_Else_correct)))))
(let ((anon34_Else_correct  (=> (< j@@15 (|Seq#Length| xs@@39)) (and (=> (= (ControlFlow 0 15) (- 0 21)) (>= j@@15 0)) (=> (>= j@@15 0) (and (=> (= (ControlFlow 0 15) (- 0 20)) (< j@@15 (|Seq#Length| xs@@39))) (=> (< j@@15 (|Seq#Length| xs@@39)) (and (=> (= (ControlFlow 0 15) (- 0 19)) (HasDirectPerm QPMask@0 (|Seq#Index| xs@@39 j@@15) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs@@39 j@@15) f_7) (and (=> (= (ControlFlow 0 15) (- 0 18)) (>= j@@15 0)) (=> (>= j@@15 0) (and (=> (= (ControlFlow 0 15) (- 0 17)) (< j@@15 (|Seq#Length| xs@@39))) (=> (< j@@15 (|Seq#Length| xs@@39)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm QPMask@0 (|Seq#Index| xs@@39 j@@15) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs@@39 j@@15) f_7) (=> (= (ControlFlow 0 15) 14) anon25_correct))))))))))))))))
(let ((anon30_Else_correct  (=> (<= 0 j@@15) (and (=> (= (ControlFlow 0 31) 30) anon34_Then_correct) (=> (= (ControlFlow 0 31) 15) anon34_Else_correct)))))
(let ((anon28_Else_correct  (and (=> (= (ControlFlow 0 41) (- 0 42)) (forall ((i_8 Int) (i_8_1 Int) ) (!  (=> (and (and (and (and (not (= i_8 i_8_1)) (and (<= 0 i_8) (< i_8 (|Seq#Length| xs@@39)))) (and (<= 0 i_8_1) (< i_8_1 (|Seq#Length| xs@@39)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@39 i_8) (|Seq#Index| xs@@39 i_8_1))))
 :qid |stdinbpl.1744:15|
 :skolemid |155|
))) (=> (forall ((i_8@@0 Int) (i_8_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_8@@0 i_8_1@@0)) (and (<= 0 i_8@@0) (< i_8@@0 (|Seq#Length| xs@@39)))) (and (<= 0 i_8_1@@0) (< i_8_1@@0 (|Seq#Length| xs@@39)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@39 i_8@@0) (|Seq#Index| xs@@39 i_8_1@@0))))
 :qid |stdinbpl.1744:15|
 :skolemid |155|
)) (=> (forall ((i_8@@1 Int) ) (!  (=> (and (and (<= 0 i_8@@1) (< i_8@@1 (|Seq#Length| xs@@39))) (< NoPerm FullPerm)) (and (qpRange9 (|Seq#Index| xs@@39 i_8@@1)) (= (invRecv9 (|Seq#Index| xs@@39 i_8@@1)) i_8@@1)))
 :qid |stdinbpl.1750:22|
 :skolemid |156|
 :pattern ( (|Seq#Index| xs@@39 i_8@@1))
 :pattern ( (|Seq#Index| xs@@39 i_8@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv9 o_3)) (< (invRecv9 o_3) (|Seq#Length| xs@@39))) (< NoPerm FullPerm)) (qpRange9 o_3)) (= (|Seq#Index| xs@@39 (invRecv9 o_3)) o_3)))
 :qid |stdinbpl.1754:22|
 :skolemid |157|
 :pattern ( (invRecv9 o_3))
)) (forall ((i_8@@2 Int) ) (!  (=> (and (<= 0 i_8@@2) (< i_8@@2 (|Seq#Length| xs@@39))) (not (= (|Seq#Index| xs@@39 i_8@@2) null)))
 :qid |stdinbpl.1760:22|
 :skolemid |158|
 :pattern ( (|Seq#Index| xs@@39 i_8@@2))
 :pattern ( (|Seq#Index| xs@@39 i_8@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv9 o_3@@0)) (< (invRecv9 o_3@@0) (|Seq#Length| xs@@39))) (< NoPerm FullPerm)) (qpRange9 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| xs@@39 (invRecv9 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv9 o_3@@0)) (< (invRecv9 o_3@@0) (|Seq#Length| xs@@39))) (< NoPerm FullPerm)) (qpRange9 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.1766:22|
 :skolemid |159|
...
))) (and (state Heap@@41 QPMask@0) (state Heap@@41 QPMask@0))) (and (=> (= (ControlFlow 0 41) 40) anon30_Then_correct) (=> (= (ControlFlow 0 41) 31) anon30_Else_correct)))))))))
(let ((anon7_correct true))
(let ((anon29_Else_correct  (=> (and (not (and (<= 0 i_16) (< i_16 (|Seq#Length| xs@@39)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon29_Then_correct  (=> (and (<= 0 i_16) (< i_16 (|Seq#Length| xs@@39))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_16 0)) (=> (>= i_16 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_16 (|Seq#Length| xs@@39))) (=> (< i_16 (|Seq#Length| xs@@39)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon26_Else_correct  (=> (and (forall ((k_3 Int) (i_6 Int) ) (!  (=> (and (>= k_3 0) (and (< k_3 (|Seq#Length| xs@@39)) (and (>= i_6 0) (and (< i_6 (|Seq#Length| xs@@39)) (not (= k_3 i_6)))))) (not (= (|Seq#Index| xs@@39 k_3) (|Seq#Index| xs@@39 i_6))))
 :qid |stdinbpl.1726:20|
 :skolemid |154|
 :pattern ( (|Seq#Index| xs@@39 k_3) (|Seq#Index| xs@@39 i_6))
)) (state Heap@@41 ZeroMask)) (and (and (=> (= (ControlFlow 0 43) 41) anon28_Else_correct) (=> (= (ControlFlow 0 43) 9) anon29_Then_correct)) (=> (= (ControlFlow 0 43) 12) anon29_Else_correct)))))
(let ((anon3_correct true))
(let ((anon27_Else_correct  (=> (and (not (and (>= k_2 0) (and (< k_2 (|Seq#Length| xs@@39)) (and (>= i_15 0) (and (< i_15 (|Seq#Length| xs@@39)) (not (= k_2 i_15))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon27_Then_correct  (=> (and (>= k_2 0) (and (< k_2 (|Seq#Length| xs@@39)) (and (>= i_15 0) (and (< i_15 (|Seq#Length| xs@@39)) (not (= k_2 i_15)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= k_2 0)) (=> (>= k_2 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< k_2 (|Seq#Length| xs@@39))) (=> (< k_2 (|Seq#Length| xs@@39)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i_15 0)) (=> (>= i_15 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i_15 (|Seq#Length| xs@@39))) (=> (< i_15 (|Seq#Length| xs@@39)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove 6)) (and (and (=> (= (ControlFlow 0 44) 43) anon26_Else_correct) (=> (= (ControlFlow 0 44) 2) anon27_Then_correct)) (=> (= (ControlFlow 0 44) 7) anon27_Else_correct)))))
...
(declare-fun invRecv54 (T@U) Int)
(declare-fun QPMask@4 () T@U)
(declare-fun qpRange55 (T@U) Bool)
(declare-fun invRecv55 (T@U) Int)
...
(declare-fun invRecv50 (T@U) Int)
(declare-fun QPMask@0 () T@U)
(declare-fun qpRange51 (T@U) Bool)
(declare-fun invRecv51 (T@U) Int)
(declare-fun Heap@@41 () T@U)
(declare-fun Heap@0 () T@U)
(declare-fun newVersion@0 () T@U)
(declare-fun Mask@0 () T@U)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@1) (MapType0Type RefType)) (= (type x@@23) RefType)) (= (type ExhaleWellDef0Mask@3) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@2) (MapType1Type RefType realType))) (= (type Heap@10) (MapType0Type RefType))) (= (type ExhaleWellDef0Mask@1) (MapType1Type RefType realType))) (= (type Mask@8) (MapType1Type RefType realType))) (= (type Heap@16) (MapType0Type RefType))) (= (type ExhaleWellDef0Mask@0) (MapType1Type RefType realType))) (= (type Heap@14) (MapType0Type RefType))) (= (type Heap@13) (MapType0Type RefType))) (= (type newPMask@2) (MapType1Type RefType boolType))) (= (type Heap@15) (MapType0Type RefType))) (= (type newPMask@3) (MapType1Type RefType boolType))) (= (type Heap@11) (MapType0Type RefType))) (= (type Heap@12) (MapType0Type RefType))) (= (type freshVersion@1) FrameTypeType)) (= (type Mask@7) (MapType1Type RefType realType))) (= (type QPMask@6) (MapType1Type RefType realType))) (= (type QPMask@7) (MapType1Type RefType realType))) (= (type QPMask@5) (MapType1Type RefType realType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Heap@9) (MapType0Type RefType))) (= (type QPMask@4) (MapType1Type RefType realType))) (= (type Heap@8) (MapType0Type RefType))) (= (type Heap@7) (MapType0Type RefType))) (= (type newVersion@1) FrameTypeType)) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@6) (MapType0Type RefType))) (= (type newPMask@1) (MapType1Type RefType boolType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@3) (MapType1Type RefType realType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type QPMask@3) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@41) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test04)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 93) (let ((anon39_correct  (=> (and (= ExhaleWellDef0Mask@0 (MapType1Store Mask@8 null (P01 x@@23 n@@37) (real_2_U (- (U_2_real (MapType1Select Mask@8 null (P01 x@@23 n@@37))) FullPerm)))) (= (ControlFlow 0 27) (- 0 26))) (< 4 n@@37))))
(let ((anon60_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 30) 27)) anon39_correct)))
(let ((anon60_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 28) (- 0 29)) (<= FullPerm (U_2_real (MapType1Select Mask@8 null (P01 x@@23 n@@37))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@8 null (P01 x@@23 n@@37)))) (=> (= (ControlFlow 0 28) 27) anon39_correct))))))
(let ((anon59_Else_correct  (=> (= (ControlFlow 0 25) (- 0 24)) (= v2@0 (fun04 Heap@16 x@@23 n@@37 4)))))
(let ((anon57_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 32)) (= v1@0 (fun04 Heap@16 x@@23 n@@37 2))) (=> (= v1@0 (fun04 Heap@16 x@@23 n@@37 2)) (=> (state Heap@16 Mask@8) (and (and (=> (= (ControlFlow 0 31) 25) anon59_Else_correct) (=> (= (ControlFlow 0 31) 28) anon60_Then_correct)) (=> (= (ControlFlow 0 31) 30) anon60_Else_correct)))))))
(let ((anon35_correct  (=> (and (= ExhaleWellDef0Mask@1 (MapType1Store Mask@8 null (P01 x@@23 n@@37) (real_2_U (- (U_2_real (MapType1Select Mask@8 null (P01 x@@23 n@@37))) FullPerm)))) (= (ControlFlow 0 20) (- 0 19))) (< 2 n@@37))))
(let ((anon58_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 23) 20)) anon35_correct)))
(let ((anon58_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (<= FullPerm (U_2_real (MapType1Select Mask@8 null (P01 x@@23 n@@37))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@8 null (P01 x@@23 n@@37)))) (=> (= (ControlFlow 0 21) 20) anon35_correct))))))
(let ((anon32_correct  (=> (= Heap@14 (MapType0Store Heap@13 null (|P01#sm| x@@23 n@@37) (MapType1Store (MapType0Select Heap@13 null (|P01#sm| x@@23 n@@37)) x@@23 ss (bool_2_U true)))) (=> (and (and (and (forall ((o_18 T@U) (f_22 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_22))))
(let ((A@@12 (FieldTypeInv0 (type f_22))))
 (=> (and (and (= (type o_18) RefType) (= (type f_22) (FieldType A@@12 B@@11))) (U_2_bool (MapType1Select (MapType0Select Heap@14 null (|P01#sm| x@@23 n@@37)) o_18 f_22))) (U_2_bool (MapType1Select newPMask@2 o_18 f_22)))))
 :qid |stdinbpl.5600:27|
 :skolemid |522|
 :pattern ( (MapType1Select newPMask@2 o_18 f_22))
)) (forall ((j_16_1 Int) ) (!  (=> (and (<= 0 j_16_1) (< j_16_1 3)) (U_2_bool (MapType1Select newPMask@2 (|Seq#Index| (MapType0Select Heap@14 x@@23 ss) j_16_1) f_7)))
 :qid |stdinbpl.5604:20|
 :skolemid |523|
))) (and (= Heap@15 (MapType0Store Heap@14 null (|P01#sm| x@@23 n@@37) newPMask@2)) (forall ((o_19 T@U) (f_23 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_23))))
(let ((A@@13 (FieldTypeInv0 (type f_23))))
 (=> (and (and (= (type o_19) RefType) (= (type f_23) (FieldType A@@13 B@@12))) (U_2_bool (MapType1Select (MapType0Select Heap@15 null (|P01#sm| x@@23 n@@37)) o_19 f_23))) (U_2_bool (MapType1Select newPMask@3 o_19 f_23)))))
 :qid |stdinbpl.5611:27|
 :skolemid |524|
 :pattern ( (MapType1Select newPMask@3 o_19 f_23))
)))) (and (and (forall ((j_17_1 Int) ) (!  (=> (and (<= 3 j_17_1) (< j_17_1 n@@37)) (U_2_bool (MapType1Select newPMask@3 (|Seq#Index| (MapType0Select Heap@15 x@@23 ss) j_17_1) f_7)))
 :qid |stdinbpl.5615:20|
 :skolemid |525|
)) (= Heap@16 (MapType0Store Heap@15 null (|P01#sm| x@@23 n@@37) newPMask@3))) (and (state Heap@16 Mask@8) (state Heap@16 Mask@8)))) (and (and (=> (= (ControlFlow 0 33) 31) anon57_Else_correct) (=> (= (ControlFlow 0 33) 21) anon58_Then_correct)) (=> (= (ControlFlow 0 33) 23) anon58_Else_correct))))))
(let ((anon56_Else_correct  (=> (HasDirectPerm Mask@8 null (P01 x@@23 n@@37)) (=> (and (= Heap@13 Heap@10) (= (ControlFlow 0 35) 33)) anon32_correct))))
(let ((anon56_Then_correct  (=> (not (HasDirectPerm Mask@8 null (P01 x@@23 n@@37))) (=> (and (and (= Heap@11 (MapType0Store Heap@10 null (|P01#sm| x@@23 n@@37) ZeroPMask)) (= Heap@12 (MapType0Store Heap@11 null (P01 x@@23 n@@37) freshVersion@1))) (and (= Heap@13 Heap@12) (= (ControlFlow 0 34) 33))) anon32_correct))))
(let ((anon54_Else_correct  (=> (forall ((k_5_1 Int) (j_13_1_1 Int) ) (!  (=> (and (>= k_5_1 0) (and (< k_5_1 (|Seq#Length| (MapType0Select Heap@10 x@@23 ss))) (and (>= j_13_1_1 0) (and (< j_13_1_1 (|Seq#Length| (MapType0Select Heap@10 x@@23 ss))) (not (= k_5_1 j_13_1_1)))))) (not (= (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) k_5_1) (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_13_1_1))))
 :qid |stdinbpl.5500:20|
 :skolemid |509|
 :pattern ( (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) k_5_1) (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_13_1_1))
)) (and (=> (= (ControlFlow 0 36) (- 0 40)) (forall ((j_14 Int) (j_14_1 Int) ) (!  (=> (and (and (and (and (not (= j_14 j_14_1)) (and (<= 0 j_14) (< j_14 3))) (and (<= 0 j_14_1) (< j_14_1 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_14) (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_14_1))))
 :qid |stdinbpl.5511:17|
 :skolemid |510|
 :pattern ( (neverTriggered56 j_14) (neverTriggered56 j_14_1))
))) (=> (forall ((j_14@@0 Int) (j_14_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_14@@0 j_14_1@@0)) (and (<= 0 j_14@@0) (< j_14@@0 3))) (and (<= 0 j_14_1@@0) (< j_14_1@@0 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_14@@0) (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_14_1@@0))))
 :qid |stdinbpl.5511:17|
 :skolemid |510|
 :pattern ( (neverTriggered56 j_14@@0) (neverTriggered56 j_14_1@@0))
)) (and (=> (= (ControlFlow 0 36) (- 0 39)) (forall ((j_14@@1 Int) ) (!  (=> (and (<= 0 j_14@@1) (< j_14@@1 3)) (>= (U_2_real (MapType1Select Mask@7 (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_14@@1) f_7)) FullPerm))
 :qid |stdinbpl.5518:17|
 :skolemid |511|
 :pattern ( (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_14@@1))
 :pattern ( (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_14@@1))
))) (=> (forall ((j_14@@2 Int) ) (!  (=> (and (<= 0 j_14@@2) (< j_14@@2 3)) (>= (U_2_real (MapType1Select Mask@7 (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_14@@2) f_7)) FullPerm))
 :qid |stdinbpl.5518:17|
 :skolemid |511|
 :pattern ( (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_14@@2))
 :pattern ( (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_14@@2))
)) (=> (and (and (forall ((j_14@@3 Int) ) (!  (=> (and (and (<= 0 j_14@@3) (< j_14@@3 3)) (< NoPerm FullPerm)) (and (qpRange56 (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_14@@3)) (= (invRecv56 (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_14@@3)) j_14@@3)))
 :qid |stdinbpl.5524:22|
 :skolemid |512|
 :pattern ( (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_14@@3))
 :pattern ( (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_14@@3))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (<= 0 (invRecv56 o_3)) (< (invRecv56 o_3) 3)) (and (< NoPerm FullPerm) (qpRange56 o_3))) (= (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) (invRecv56 o_3)) o_3)))
 :qid |stdinbpl.5528:22|
 :skolemid |513|
 :pattern ( (invRecv56 o_3))
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (<= 0 (invRecv56 o_3@@0)) (< (invRecv56 o_3@@0) 3)) (and (< NoPerm FullPerm) (qpRange56 o_3@@0))) (and (= (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) (invRecv56 o_3@@0)) o_3@@0) (= (U_2_real (MapType1Select QPMask@6 o_3@@0 f_7)) (- (U_2_real (MapType1Select Mask@7 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (<= 0 (invRecv56 o_3@@0)) (< (invRecv56 o_3@@0) 3)) (and (< NoPerm FullPerm) (qpRange56 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@6 o_3@@0 f_7)) (U_2_real (MapType1Select Mask@7 o_3@@0 f_7))))))
 :qid |stdinbpl.5534:22|
 :skolemid |514|
...
(let ((A@@14 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@14 B@@13))) (not (= f_5 f_7))) (= (U_2_real (MapType1Select Mask@7 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@6 o_3@@1 f_5))))))
 :qid |stdinbpl.5540:29|
 :skolemid |515|
 :pattern ( (MapType1Select QPMask@6 o_3@@1 f_5))
)))) (and (=> (= (ControlFlow 0 36) (- 0 38)) (forall ((j_15 Int) (j_15_1 Int) ) (!  (=> (and (and (and (and (not (= j_15 j_15_1)) (and (<= 3 j_15) (< j_15 n@@37))) (and (<= 3 j_15_1) (< j_15_1 n@@37))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_15) (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_15_1))))
 :qid |stdinbpl.5552:17|
 :skolemid |516|
 :pattern ( (neverTriggered57 j_15) (neverTriggered57 j_15_1))
))) (=> (forall ((j_15@@0 Int) (j_15_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_15@@0 j_15_1@@0)) (and (<= 3 j_15@@0) (< j_15@@0 n@@37))) (and (<= 3 j_15_1@@0) (< j_15_1@@0 n@@37))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_15@@0) (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_15_1@@0))))
 :qid |stdinbpl.5552:17|
 :skolemid |516|
 :pattern ( (neverTriggered57 j_15@@0) (neverTriggered57 j_15_1@@0))
)) (and (=> (= (ControlFlow 0 36) (- 0 37)) (forall ((j_15@@1 Int) ) (!  (=> (and (<= 3 j_15@@1) (< j_15@@1 n@@37)) (>= (U_2_real (MapType1Select QPMask@6 (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_15@@1) f_7)) FullPerm))
 :qid |stdinbpl.5559:17|
 :skolemid |517|
 :pattern ( (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_15@@1))
 :pattern ( (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_15@@1))
))) (=> (forall ((j_15@@2 Int) ) (!  (=> (and (<= 3 j_15@@2) (< j_15@@2 n@@37)) (>= (U_2_real (MapType1Select QPMask@6 (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_15@@2) f_7)) FullPerm))
 :qid |stdinbpl.5559:17|
 :skolemid |517|
 :pattern ( (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_15@@2))
 :pattern ( (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_15@@2))
)) (=> (forall ((j_15@@3 Int) ) (!  (=> (and (and (<= 3 j_15@@3) (< j_15@@3 n@@37)) (< NoPerm FullPerm)) (and (qpRange57 (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_15@@3)) (= (invRecv57 (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_15@@3)) j_15@@3)))
 :qid |stdinbpl.5565:22|
 :skolemid |518|
 :pattern ( (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_15@@3))
 :pattern ( (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_15@@3))
)) (=> (and (and (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (<= 3 (invRecv57 o_3@@2)) (< (invRecv57 o_3@@2) n@@37)) (and (< NoPerm FullPerm) (qpRange57 o_3@@2))) (= (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) (invRecv57 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.5569:22|
 :skolemid |519|
 :pattern ( (invRecv57 o_3@@2))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (<= 3 (invRecv57 o_3@@3)) (< (invRecv57 o_3@@3) n@@37)) (and (< NoPerm FullPerm) (qpRange57 o_3@@3))) (and (= (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) (invRecv57 o_3@@3)) o_3@@3) (= (U_2_real (MapType1Select QPMask@7 o_3@@3 f_7)) (- (U_2_real (MapType1Select QPMask@6 o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (<= 3 (invRecv57 o_3@@3)) (< (invRecv57 o_3@@3) n@@37)) (and (< NoPerm FullPerm) (qpRange57 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@7 o_3@@3 f_7)) (U_2_real (MapType1Select QPMask@6 o_3@@3 f_7))))))
 :qid |stdinbpl.5575:22|
 :skolemid |520|
...
(let ((A@@15 (FieldTypeInv0 (type f_5@@0))))
 ...
 :qid |stdinbpl.5581:29|
 :skolemid |521|
 :pattern ( (MapType1Select QPMask@7 o_3@@4 f_5@@0))
)) (= Mask@8 (MapType1Store QPMask@7 null (P01 x@@23 n@@37) (real_2_U (+ (U_2_real (MapType1Select QPMask@7 null (P01 x@@23 n@@37))) FullPerm)))))) (and (and (state Heap@10 Mask@8) (state Heap@10 Mask@8)) (and (|P01#trigger| Heap@10 (P01 x@@23 n@@37)) (= (MapType0Select Heap@10 null (P01 x@@23 n@@37)) (CombineFrames (FrameFragment (MapType0Select Heap@10 x@@23 ss)) (CombineFrames (FrameFragment (int_2_U (|P01#condqp7| Heap@10 x@@23 n@@37))) (FrameFragment (int_2_U (|P01#condqp8| Heap@10 x@@23 n@@37))))))))) (and (=> (= (ControlFlow 0 36) 34) anon56_Then_correct) (=> (= (ControlFlow 0 36) 35) anon56_Else_correct))))))))))))))))
(let ((anon29_correct true))
(let ((anon55_Else_correct  (=> (and (not (and (>= k_4 0) (and (< k_4 (|Seq#Length| (MapType0Select Heap@10 x@@23 ss))) (and (>= j_12 0) (and (< j_12 (|Seq#Length| (MapType0Select Heap@10 x@@23 ss))) (not (= k_4 j_12))))))) (= (ControlFlow 0 18) 15)) anon29_correct)))
(let ((anon55_Then_correct  (=> (and (>= k_4 0) (and (< k_4 (|Seq#Length| (MapType0Select Heap@10 x@@23 ss))) (and (>= j_12 0) (and (< j_12 (|Seq#Length| (MapType0Select Heap@10 x@@23 ss))) (not (= k_4 j_12)))))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (not (= (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) k_4) (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_12)))) (=> (not (= (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) k_4) (|Seq#Index| (MapType0Select Heap@10 x@@23 ss) j_12))) (=> (= (ControlFlow 0 16) 15) anon29_correct))))))
(let ((anon26_correct  (=> (= Mask@7 (MapType1Store QPMask@5 x@@23 ss (real_2_U (- (U_2_real (MapType1Select QPMask@5 x@@23 ss)) FullPerm)))) (and (=> (= (ControlFlow 0 41) (- 0 43)) (= (|Seq#Length| (MapType0Select Heap@10 x@@23 ss)) n@@37)) (=> (= (|Seq#Length| (MapType0Select Heap@10 x@@23 ss)) n@@37) (and (=> (= (ControlFlow 0 41) (- 0 42)) (<= 3 n@@37)) (=> (<= 3 n@@37) (and (and (=> (= (ControlFlow 0 41) 36) anon54_Else_correct) (=> (= (ControlFlow 0 41) 16) anon55_Then_correct)) (=> (= (ControlFlow 0 41) 18) anon55_Else_correct)))))))))
(let ((anon53_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 46) 41)) anon26_correct)))
(let ((anon53_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 44) (- 0 45)) (<= FullPerm (U_2_real (MapType1Select QPMask@5 x@@23 ss)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@5 x@@23 ss))) (=> (= (ControlFlow 0 44) 41) anon26_correct))))))
(let ((anon24_correct  (=> (and (not (= x@@23 null)) (= Mask@6 (MapType1Store Mask@5 x@@23 ss (real_2_U (+ (U_2_real (MapType1Select Mask@5 x@@23 ss)) FullPerm))))) (=> (and (and (state Heap@9 Mask@6) (= (|Seq#Length| (MapType0Select Heap@9 x@@23 ss)) n@@37)) (and (<= 3 n@@37) (forall ((k_3 Int) (j_9 Int) ) (!  (=> (and (>= k_3 0) (and (< k_3 (|Seq#Length| (MapType0Select Heap@9 x@@23 ss))) (and (>= j_9 0) (and (< j_9 (|Seq#Length| (MapType0Select Heap@9 x@@23 ss))) (not (= k_3 j_9)))))) (not (= (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) k_3) (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_9))))
 :qid |stdinbpl.5393:20|
 :skolemid |496|
 :pattern ( (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) k_3) (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_9))
)))) (and (=> (= (ControlFlow 0 47) (- 0 52)) (forall ((j_10 Int) (j_10_1 Int) ) (!  (=> (and (and (and (and (not (= j_10 j_10_1)) (and (<= 0 j_10) (< j_10 3))) (and (<= 0 j_10_1) (< j_10_1 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_10) (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_10_1))))
 :qid |stdinbpl.5399:15|
 :skolemid |497|
))) (=> (forall ((j_10@@0 Int) (j_10_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_10@@0 j_10_1@@0)) (and (<= 0 j_10@@0) (< j_10@@0 3))) (and (<= 0 j_10_1@@0) (< j_10_1@@0 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_10@@0) (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_10_1@@0))))
 :qid |stdinbpl.5399:15|
 :skolemid |497|
)) (=> (and (forall ((j_10@@1 Int) ) (!  (=> (and (and (<= 0 j_10@@1) (< j_10@@1 3)) (< NoPerm FullPerm)) (and (qpRange54 (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_10@@1)) (= (invRecv54 (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_10@@1)) j_10@@1)))
 :qid |stdinbpl.5405:22|
 :skolemid |498|
 :pattern ( (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_10@@1))
 :pattern ( (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_10@@1))
)) (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (and (<= 0 (invRecv54 o_3@@5)) (< (invRecv54 o_3@@5) 3)) (< NoPerm FullPerm)) (qpRange54 o_3@@5)) (= (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) (invRecv54 o_3@@5)) o_3@@5)))
 :qid |stdinbpl.5409:22|
 :skolemid |499|
 :pattern ( (invRecv54 o_3@@5))
))) (=> (and (and (forall ((j_10@@2 Int) ) (!  (=> (and (<= 0 j_10@@2) (< j_10@@2 3)) (not (= (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_10@@2) null)))
 :qid |stdinbpl.5415:22|
 :skolemid |500|
 :pattern ( (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_10@@2))
 :pattern ( (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_10@@2))
)) (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (and (<= 0 (invRecv54 o_3@@6)) (< (invRecv54 o_3@@6) 3)) (< NoPerm FullPerm)) (qpRange54 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) (invRecv54 o_3@@6)) o_3@@6)) (= (U_2_real (MapType1Select QPMask@4 o_3@@6 f_7)) (+ (U_2_real (MapType1Select Mask@6 o_3@@6 f_7)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv54 o_3@@6)) (< (invRecv54 o_3@@6) 3)) (< NoPerm FullPerm)) (qpRange54 o_3@@6))) (= (U_2_real (MapType1Select QPMask@4 o_3@@6 f_7)) (U_2_real (MapType1Select Mask@6 o_3@@6 f_7))))))
 :qid |stdinbpl.5421:22|
 :skolemid |501|
...
(let ((A@@16 (FieldTypeInv0 (type f_5@@1))))
 (=> (and (and (= (type o_3@@7) RefType) (= (type f_5@@1) (FieldType A@@16 B@@15))) (not (= f_5@@1 f_7))) (= (U_2_real (MapType1Select Mask@6 o_3@@7 f_5@@1)) (U_2_real (MapType1Select QPMask@4 o_3@@7 f_5@@1))))))
 :qid |stdinbpl.5425:29|
 :skolemid |502|
 :pattern ( (MapType1Select Mask@6 o_3@@7 f_5@@1))
 :pattern ( (MapType1Select QPMask@4 o_3@@7 f_5@@1))
)) (state Heap@9 QPMask@4))) (and (=> (= (ControlFlow 0 47) (- 0 51)) (forall ((j_11 Int) (j_11_1 Int) ) (!  (=> (and (and (and (and (not (= j_11 j_11_1)) (and (<= 3 j_11) (< j_11 n@@37))) (and (<= 3 j_11_1) (< j_11_1 n@@37))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_11) (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_11_1))))
 :qid |stdinbpl.5433:15|
 :skolemid |503|
))) (=> (forall ((j_11@@0 Int) (j_11_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_11@@0 j_11_1@@0)) (and (<= 3 j_11@@0) (< j_11@@0 n@@37))) (and (<= 3 j_11_1@@0) (< j_11_1@@0 n@@37))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_11@@0) (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_11_1@@0))))
 :qid |stdinbpl.5433:15|
 :skolemid |503|
)) (=> (and (and (and (forall ((j_11@@1 Int) ) (!  (=> (and (and (<= 3 j_11@@1) (< j_11@@1 n@@37)) (< NoPerm FullPerm)) (and (qpRange55 (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_11@@1)) (= (invRecv55 (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_11@@1)) j_11@@1)))
 :qid |stdinbpl.5439:22|
 :skolemid |504|
 :pattern ( (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_11@@1))
 :pattern ( (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_11@@1))
)) (forall ((o_3@@8 T@U) ) (!  (=> (= (type o_3@@8) RefType) (=> (and (and (and (<= 3 (invRecv55 o_3@@8)) (< (invRecv55 o_3@@8) n@@37)) (< NoPerm FullPerm)) (qpRange55 o_3@@8)) (= (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) (invRecv55 o_3@@8)) o_3@@8)))
 :qid |stdinbpl.5443:22|
 :skolemid |505|
 :pattern ( (invRecv55 o_3@@8))
))) (and (forall ((j_11@@2 Int) ) (!  (=> (and (<= 3 j_11@@2) (< j_11@@2 n@@37)) (not (= (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_11@@2) null)))
 :qid |stdinbpl.5449:22|
 :skolemid |506|
 :pattern ( (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_11@@2))
 :pattern ( (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) j_11@@2))
)) (forall ((o_3@@9 T@U) ) (!  (=> (= (type o_3@@9) RefType) (and (=> (and (and (and (<= 3 (invRecv55 o_3@@9)) (< (invRecv55 o_3@@9) n@@37)) (< NoPerm FullPerm)) (qpRange55 o_3@@9)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) (invRecv55 o_3@@9)) o_3@@9)) (= (U_2_real (MapType1Select QPMask@5 o_3@@9 f_7)) (+ (U_2_real (MapType1Select QPMask@4 o_3@@9 f_7)) FullPerm)))) (=> (not (and (and (and (<= 3 (invRecv55 o_3@@9)) (< (invRecv55 o_3@@9) n@@37)) (< NoPerm FullPerm)) (qpRange55 o_3@@9))) (= (U_2_real (MapType1Select QPMask@5 o_3@@9 f_7)) (U_2_real (MapType1Select QPMask@4 o_3@@9 f_7))))))
 :qid |stdinbpl.5455:22|
 :skolemid |507|
...
(let ((A@@17 (FieldTypeInv0 (type f_5@@2))))
 ...
 :qid |stdinbpl.5459:29|
 :skolemid |508|
 :pattern ( (MapType1Select QPMask@4 o_3@@10 f_5@@2))
 :pattern ( (MapType1Select QPMask@5 o_3@@10 f_5@@2))
)) (state Heap@9 QPMask@5)) (and (state Heap@9 QPMask@5) (state Heap@9 QPMask@5)))) (and (=> (= (ControlFlow 0 47) (- 0 50)) (HasDirectPerm QPMask@5 x@@23 ss)) (=> (HasDirectPerm QPMask@5 x@@23 ss) (and (=> (= (ControlFlow 0 47) (- 0 49)) (< 4 (|Seq#Length| (MapType0Select Heap@9 x@@23 ss)))) (=> (< 4 (|Seq#Length| (MapType0Select Heap@9 x@@23 ss))) (and (=> (= (ControlFlow 0 47) (- 0 48)) (= FullPerm (U_2_real (MapType1Select QPMask@5 (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) 4) f_7)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@5 (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) 4) f_7))) (=> (and (= Heap@10 (MapType0Store Heap@9 (|Seq#Index| (MapType0Select Heap@9 x@@23 ss) 4) f_7 (int_2_U 0))) (state Heap@10 QPMask@5)) (and (=> (= (ControlFlow 0 47) 44) anon53_Then_correct) (=> (= (ControlFlow 0 47) 46) anon53_Else_correct))))))))))))))))))))
(let ((anon52_Else_correct  (=> (HasDirectPerm Mask@5 null (P01 x@@23 n@@37)) (=> (and (= Heap@9 Heap@7) (= (ControlFlow 0 54) 47)) anon24_correct))))
(let ((anon52_Then_correct  (=> (and (and (not (HasDirectPerm Mask@5 null (P01 x@@23 n@@37))) (= Heap@8 (MapType0Store Heap@7 null (P01 x@@23 n@@37) newVersion@1))) (and (= Heap@9 Heap@8) (= (ControlFlow 0 53) 47))) anon24_correct)))
(let ((anon22_correct  (=> (= Mask@5 (MapType1Store Mask@4 null (P01 x@@23 n@@37) (real_2_U (- (U_2_real (MapType1Select Mask@4 null (P01 x@@23 n@@37))) FullPerm)))) (and (=> (= (ControlFlow 0 55) 53) anon52_Then_correct) (=> (= (ControlFlow 0 55) 54) anon52_Else_correct)))))
(let ((anon51_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 58) 55)) anon22_correct)))
(let ((anon51_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 56) (- 0 57)) (<= FullPerm (U_2_real (MapType1Select Mask@4 null (P01 x@@23 n@@37))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 null (P01 x@@23 n@@37)))) (=> (= (ControlFlow 0 56) 55) anon22_correct))))))
(let ((anon49_Else_correct  (and (=> (= (ControlFlow 0 59) (- 0 60)) (= v2@0 (fun04 Heap@7 x@@23 n@@37 4))) (=> (= v2@0 (fun04 Heap@7 x@@23 n@@37 4)) (=> (state Heap@7 Mask@4) (=> (and (|P01#trigger| Heap@7 (P01 x@@23 n@@37)) (= (MapType0Select Heap@7 null (P01 x@@23 n@@37)) (CombineFrames (FrameFragment (MapType0Select Heap@7 x@@23 ss)) (CombineFrames (FrameFragment (int_2_U (|P01#condqp7| Heap@7 x@@23 n@@37))) (FrameFragment (int_2_U (|P01#condqp8| Heap@7 x@@23 n@@37))))))) (and (=> (= (ControlFlow 0 59) 56) anon51_Then_correct) (=> (= (ControlFlow 0 59) 58) anon51_Else_correct))))))))
(let ((anon19_correct  (=> (and (= ExhaleWellDef0Mask@2 (MapType1Store Mask@4 null (P01 x@@23 n@@37) (real_2_U (- (U_2_real (MapType1Select Mask@4 null (P01 x@@23 n@@37))) FullPerm)))) (= (ControlFlow 0 11) (- 0 10))) (< 4 n@@37))))
(let ((anon50_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 14) 11)) anon19_correct)))
(let ((anon50_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (U_2_real (MapType1Select Mask@4 null (P01 x@@23 n@@37))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 null (P01 x@@23 n@@37)))) (=> (= (ControlFlow 0 12) 11) anon19_correct))))))
(let ((anon47_Else_correct  (and (=> (= (ControlFlow 0 61) (- 0 62)) (= v1@0 (fun04 Heap@7 x@@23 n@@37 2))) (=> (= v1@0 (fun04 Heap@7 x@@23 n@@37 2)) (=> (state Heap@7 Mask@4) (and (and (=> (= (ControlFlow 0 61) 59) anon49_Else_correct) (=> (= (ControlFlow 0 61) 12) anon50_Then_correct)) (=> (= (ControlFlow 0 61) 14) anon50_Else_correct)))))))
(let ((anon15_correct  (=> (and (= ExhaleWellDef0Mask@3 (MapType1Store Mask@4 null (P01 x@@23 n@@37) (real_2_U (- (U_2_real (MapType1Select Mask@4 null (P01 x@@23 n@@37))) FullPerm)))) (= (ControlFlow 0 6) (- 0 5))) (< 2 n@@37))))
(let ((anon48_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon15_correct)))
(let ((anon48_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select Mask@4 null (P01 x@@23 n@@37))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 null (P01 x@@23 n@@37)))) (=> (= (ControlFlow 0 7) 6) anon15_correct))))))
(let ((anon12_correct  (=> (= Heap@5 (MapType0Store Heap@4 null (|P01#sm| x@@23 n@@37) (MapType1Store (MapType0Select Heap@4 null (|P01#sm| x@@23 n@@37)) x@@23 ss (bool_2_U true)))) (=> (and (and (and (forall ((o_16 T@U) (f_20 T@U) ) (! (let ((B@@17 (FieldTypeInv1 (type f_20))))
(let ((A@@18 (FieldTypeInv0 (type f_20))))
 (=> (and (and (= (type o_16) RefType) (= (type f_20) (FieldType A@@18 B@@17))) (U_2_bool (MapType1Select (MapType0Select Heap@5 null (|P01#sm| x@@23 n@@37)) o_16 f_20))) (U_2_bool (MapType1Select newPMask@0 o_16 f_20)))))
 :qid |stdinbpl.5291:27|
 :skolemid |492|
 :pattern ( (MapType1Select newPMask@0 o_16 f_20))
)) (forall ((j_7 Int) ) (!  (=> (and (<= 0 j_7) (< j_7 3)) (U_2_bool (MapType1Select newPMask@0 (|Seq#Index| (MapType0Select Heap@5 x@@23 ss) j_7) f_7)))
 :qid |stdinbpl.5295:20|
 :skolemid |493|
))) (and (= Heap@6 (MapType0Store Heap@5 null (|P01#sm| x@@23 n@@37) newPMask@0)) (forall ((o_17 T@U) (f_21 T@U) ) (! (let ((B@@18 (FieldTypeInv1 (type f_21))))
(let ((A@@19 (FieldTypeInv0 (type f_21))))
 (=> (and (and (= (type o_17) RefType) (= (type f_21) (FieldType A@@19 B@@18))) (U_2_bool (MapType1Select (MapType0Select Heap@6 null (|P01#sm| x@@23 n@@37)) o_17 f_21))) (U_2_bool (MapType1Select newPMask@1 o_17 f_21)))))
 :qid |stdinbpl.5302:27|
 :skolemid |494|
 :pattern ( (MapType1Select newPMask@1 o_17 f_21))
)))) (and (and (forall ((j_8 Int) ) (!  (=> (and (<= 3 j_8) (< j_8 n@@37)) (U_2_bool (MapType1Select newPMask@1 (|Seq#Index| (MapType0Select Heap@6 x@@23 ss) j_8) f_7)))
 :qid |stdinbpl.5306:20|
 :skolemid |495|
)) (= Heap@7 (MapType0Store Heap@6 null (|P01#sm| x@@23 n@@37) newPMask@1))) (and (state Heap@7 Mask@4) (state Heap@7 Mask@4)))) (and (and (=> (= (ControlFlow 0 63) 61) anon47_Else_correct) (=> (= (ControlFlow 0 63) 7) anon48_Then_correct)) (=> (= (ControlFlow 0 63) 9) anon48_Else_correct))))))
(let ((anon46_Else_correct  (=> (HasDirectPerm Mask@4 null (P01 x@@23 n@@37)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 65) 63)) anon12_correct))))
(let ((anon46_Then_correct  (=> (not (HasDirectPerm Mask@4 null (P01 x@@23 n@@37))) (=> (and (and (= Heap@2 (MapType0Store Heap@1 null (|P01#sm| x@@23 n@@37) ZeroPMask)) (= Heap@3 (MapType0Store Heap@2 null (P01 x@@23 n@@37) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 64) 63))) anon12_correct))))
(let ((anon44_Else_correct  (=> (forall ((k_2_1_1 Int) (j_4_1 Int) ) (!  (=> (and (>= k_2_1_1 0) (and (< k_2_1_1 (|Seq#Length| (MapType0Select Heap@1 x@@23 ss))) (and (>= j_4_1 0) (and (< j_4_1 (|Seq#Length| (MapType0Select Heap@1 x@@23 ss))) (not (= k_2_1_1 j_4_1)))))) (not (= (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) k_2_1_1) (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_4_1))))
 :qid |stdinbpl.5191:20|
 :skolemid |479|
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) k_2_1_1) (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_4_1))
)) (and (=> (= (ControlFlow 0 66) (- 0 70)) (forall ((j_5 Int) (j_5_1 Int) ) (!  (=> (and (and (and (and (not (= j_5 j_5_1)) (and (<= 0 j_5) (< j_5 3))) (and (<= 0 j_5_1) (< j_5_1 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_5) (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_5_1))))
 :qid |stdinbpl.5202:17|
 :skolemid |480|
 :pattern ( (neverTriggered52 j_5) (neverTriggered52 j_5_1))
))) (=> (forall ((j_5@@0 Int) (j_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_5@@0 j_5_1@@0)) (and (<= 0 j_5@@0) (< j_5@@0 3))) (and (<= 0 j_5_1@@0) (< j_5_1@@0 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_5@@0) (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_5_1@@0))))
 :qid |stdinbpl.5202:17|
 :skolemid |480|
 :pattern ( (neverTriggered52 j_5@@0) (neverTriggered52 j_5_1@@0))
)) (and (=> (= (ControlFlow 0 66) (- 0 69)) (forall ((j_5@@1 Int) ) (!  (=> (and (<= 0 j_5@@1) (< j_5@@1 3)) (>= (U_2_real (MapType1Select Mask@3 (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_5@@1) f_7)) FullPerm))
 :qid |stdinbpl.5209:17|
 :skolemid |481|
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_5@@1))
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_5@@1))
))) (=> (forall ((j_5@@2 Int) ) (!  (=> (and (<= 0 j_5@@2) (< j_5@@2 3)) (>= (U_2_real (MapType1Select Mask@3 (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_5@@2) f_7)) FullPerm))
 :qid |stdinbpl.5209:17|
 :skolemid |481|
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_5@@2))
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_5@@2))
)) (=> (and (and (forall ((j_5@@3 Int) ) (!  (=> (and (and (<= 0 j_5@@3) (< j_5@@3 3)) (< NoPerm FullPerm)) (and (qpRange52 (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_5@@3)) (= (invRecv52 (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_5@@3)) j_5@@3)))
 :qid |stdinbpl.5215:22|
 :skolemid |482|
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_5@@3))
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_5@@3))
)) (forall ((o_3@@11 T@U) ) (!  (=> (= (type o_3@@11) RefType) (=> (and (and (<= 0 (invRecv52 o_3@@11)) (< (invRecv52 o_3@@11) 3)) (and (< NoPerm FullPerm) (qpRange52 o_3@@11))) (= (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) (invRecv52 o_3@@11)) o_3@@11)))
 :qid |stdinbpl.5219:22|
 :skolemid |483|
 :pattern ( (invRecv52 o_3@@11))
))) (and (forall ((o_3@@12 T@U) ) (!  (=> (= (type o_3@@12) RefType) (and (=> (and (and (<= 0 (invRecv52 o_3@@12)) (< (invRecv52 o_3@@12) 3)) (and (< NoPerm FullPerm) (qpRange52 o_3@@12))) (and (= (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) (invRecv52 o_3@@12)) o_3@@12) (= (U_2_real (MapType1Select QPMask@2 o_3@@12 f_7)) (- (U_2_real (MapType1Select Mask@3 o_3@@12 f_7)) FullPerm)))) (=> (not (and (and (<= 0 (invRecv52 o_3@@12)) (< (invRecv52 o_3@@12) 3)) (and (< NoPerm FullPerm) (qpRange52 o_3@@12)))) (= (U_2_real (MapType1Select QPMask@2 o_3@@12 f_7)) (U_2_real (MapType1Select Mask@3 o_3@@12 f_7))))))
 :qid |stdinbpl.5225:22|
 :skolemid |484|
...
(let ((A@@20 (FieldTypeInv0 (type f_5@@3))))
 (=> (and (and (= (type o_3@@13) RefType) (= (type f_5@@3) (FieldType A@@20 B@@19))) (not (= f_5@@3 f_7))) (= (U_2_real (MapType1Select Mask@3 o_3@@13 f_5@@3)) (U_2_real (MapType1Select QPMask@2 o_3@@13 f_5@@3))))))
 :qid |stdinbpl.5231:29|
 :skolemid |485|
 :pattern ( (MapType1Select QPMask@2 o_3@@13 f_5@@3))
)))) (and (=> (= (ControlFlow 0 66) (- 0 68)) (forall ((j_6 Int) (j_6_1 Int) ) (!  (=> (and (and (and (and (not (= j_6 j_6_1)) (and (<= 3 j_6) (< j_6 n@@37))) (and (<= 3 j_6_1) (< j_6_1 n@@37))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_6) (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_6_1))))
 :qid |stdinbpl.5243:17|
 :skolemid |486|
 :pattern ( (neverTriggered53 j_6) (neverTriggered53 j_6_1))
))) (=> (forall ((j_6@@0 Int) (j_6_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_6@@0 j_6_1@@0)) (and (<= 3 j_6@@0) (< j_6@@0 n@@37))) (and (<= 3 j_6_1@@0) (< j_6_1@@0 n@@37))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_6@@0) (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_6_1@@0))))
 :qid |stdinbpl.5243:17|
 :skolemid |486|
 :pattern ( (neverTriggered53 j_6@@0) (neverTriggered53 j_6_1@@0))
)) (and (=> (= (ControlFlow 0 66) (- 0 67)) (forall ((j_6@@1 Int) ) (!  (=> (and (<= 3 j_6@@1) (< j_6@@1 n@@37)) (>= (U_2_real (MapType1Select QPMask@2 (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_6@@1) f_7)) FullPerm))
 :qid |stdinbpl.5250:17|
 :skolemid |487|
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_6@@1))
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_6@@1))
))) (=> (forall ((j_6@@2 Int) ) (!  (=> (and (<= 3 j_6@@2) (< j_6@@2 n@@37)) (>= (U_2_real (MapType1Select QPMask@2 (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_6@@2) f_7)) FullPerm))
 :qid |stdinbpl.5250:17|
 :skolemid |487|
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_6@@2))
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_6@@2))
)) (=> (forall ((j_6@@3 Int) ) (!  (=> (and (and (<= 3 j_6@@3) (< j_6@@3 n@@37)) (< NoPerm FullPerm)) (and (qpRange53 (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_6@@3)) (= (invRecv53 (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_6@@3)) j_6@@3)))
 :qid |stdinbpl.5256:22|
 :skolemid |488|
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_6@@3))
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_6@@3))
)) (=> (and (and (and (forall ((o_3@@14 T@U) ) (!  (=> (= (type o_3@@14) RefType) (=> (and (and (<= 3 (invRecv53 o_3@@14)) (< (invRecv53 o_3@@14) n@@37)) (and (< NoPerm FullPerm) (qpRange53 o_3@@14))) (= (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) (invRecv53 o_3@@14)) o_3@@14)))
 :qid |stdinbpl.5260:22|
 :skolemid |489|
 :pattern ( (invRecv53 o_3@@14))
)) (forall ((o_3@@15 T@U) ) (!  (=> (= (type o_3@@15) RefType) (and (=> (and (and (<= 3 (invRecv53 o_3@@15)) (< (invRecv53 o_3@@15) n@@37)) (and (< NoPerm FullPerm) (qpRange53 o_3@@15))) (and (= (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) (invRecv53 o_3@@15)) o_3@@15) (= (U_2_real (MapType1Select QPMask@3 o_3@@15 f_7)) (- (U_2_real (MapType1Select QPMask@2 o_3@@15 f_7)) FullPerm)))) (=> (not (and (and (<= 3 (invRecv53 o_3@@15)) (< (invRecv53 o_3@@15) n@@37)) (and (< NoPerm FullPerm) (qpRange53 o_3@@15)))) (= (U_2_real (MapType1Select QPMask@3 o_3@@15 f_7)) (U_2_real (MapType1Select QPMask@2 o_3@@15 f_7))))))
 :qid |stdinbpl.5266:22|
 :skolemid |490|
...
(let ((A@@21 (FieldTypeInv0 (type f_5@@4))))
 ...
 :qid |stdinbpl.5272:29|
 :skolemid |491|
 :pattern ( (MapType1Select QPMask@3 o_3@@16 f_5@@4))
)) (= Mask@4 (MapType1Store QPMask@3 null (P01 x@@23 n@@37) (real_2_U (+ (U_2_real (MapType1Select QPMask@3 null (P01 x@@23 n@@37))) FullPerm)))))) (and (and (state Heap@1 Mask@4) (state Heap@1 Mask@4)) (and (|P01#trigger| Heap@1 (P01 x@@23 n@@37)) (= (MapType0Select Heap@1 null (P01 x@@23 n@@37)) (CombineFrames (FrameFragment (MapType0Select Heap@1 x@@23 ss)) (CombineFrames (FrameFragment (int_2_U (|P01#condqp7| Heap@1 x@@23 n@@37))) (FrameFragment (int_2_U (|P01#condqp8| Heap@1 x@@23 n@@37))))))))) (and (=> (= (ControlFlow 0 66) 64) anon46_Then_correct) (=> (= (ControlFlow 0 66) 65) anon46_Else_correct))))))))))))))))
(let ((anon9_correct true))
(let ((anon45_Else_correct  (=> (and (not (and (>= k_1_1@@1 0) (and (< k_1_1@@1 (|Seq#Length| (MapType0Select Heap@1 x@@23 ss))) (and (>= j_3@@0 0) (and (< j_3@@0 (|Seq#Length| (MapType0Select Heap@1 x@@23 ss))) (not (= k_1_1@@1 j_3@@0))))))) (= (ControlFlow 0 4) 1)) anon9_correct)))
(let ((anon45_Then_correct  (=> (and (>= k_1_1@@1 0) (and (< k_1_1@@1 (|Seq#Length| (MapType0Select Heap@1 x@@23 ss))) (and (>= j_3@@0 0) (and (< j_3@@0 (|Seq#Length| (MapType0Select Heap@1 x@@23 ss))) (not (= k_1_1@@1 j_3@@0)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (= (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) k_1_1@@1) (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_3@@0)))) (=> (not (= (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) k_1_1@@1) (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_3@@0))) (=> (= (ControlFlow 0 2) 1) anon9_correct))))))
(let ((anon6_correct  (=> (= Mask@3 (MapType1Store QPMask@1 x@@23 ss (real_2_U (- (U_2_real (MapType1Select QPMask@1 x@@23 ss)) FullPerm)))) (and (=> (= (ControlFlow 0 71) (- 0 73)) (= (|Seq#Length| (MapType0Select Heap@1 x@@23 ss)) n@@37)) (=> (= (|Seq#Length| (MapType0Select Heap@1 x@@23 ss)) n@@37) (and (=> (= (ControlFlow 0 71) (- 0 72)) (<= 3 n@@37)) (=> (<= 3 n@@37) (and (and (=> (= (ControlFlow 0 71) 66) anon44_Else_correct) (=> (= (ControlFlow 0 71) 2) anon45_Then_correct)) (=> (= (ControlFlow 0 71) 4) anon45_Else_correct)))))))))
(let ((anon43_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 76) 71)) anon6_correct)))
(let ((anon43_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 74) (- 0 75)) (<= FullPerm (U_2_real (MapType1Select QPMask@1 x@@23 ss)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@1 x@@23 ss))) (=> (= (ControlFlow 0 74) 71) anon6_correct))))))
(let ((anon4_correct  (=> (and (not (= x@@23 null)) (= Mask@2 (MapType1Store Mask@1 x@@23 ss (real_2_U (+ (U_2_real (MapType1Select Mask@1 x@@23 ss)) FullPerm))))) (=> (and (and (state Heap@1 Mask@2) (= (|Seq#Length| (MapType0Select Heap@1 x@@23 ss)) n@@37)) (and (<= 3 n@@37) (forall ((k@@2 Int) (j@@15 Int) ) (!  (=> (and (>= k@@2 0) (and (< k@@2 (|Seq#Length| (MapType0Select Heap@1 x@@23 ss))) (and (>= j@@15 0) (and (< j@@15 (|Seq#Length| (MapType0Select Heap@1 x@@23 ss))) (not (= k@@2 j@@15)))))) (not (= (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) k@@2) (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j@@15))))
 :qid |stdinbpl.5072:20|
 :skolemid |466|
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) k@@2) (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j@@15))
)))) (and (=> (= (ControlFlow 0 77) (- 0 85)) (forall ((j_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (and (not (= j_1 j_1_1)) (and (<= 0 j_1) (< j_1 3))) (and (<= 0 j_1_1) (< j_1_1 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_1) (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_1_1))))
 :qid |stdinbpl.5078:15|
 :skolemid |467|
))) (=> (forall ((j_1@@0 Int) (j_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_1@@0 j_1_1@@0)) (and (<= 0 j_1@@0) (< j_1@@0 3))) (and (<= 0 j_1_1@@0) (< j_1_1@@0 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_1@@0) (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_1_1@@0))))
 :qid |stdinbpl.5078:15|
 :skolemid |467|
)) (=> (and (forall ((j_1@@1 Int) ) (!  (=> (and (and (<= 0 j_1@@1) (< j_1@@1 3)) (< NoPerm FullPerm)) (and (qpRange50 (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_1@@1)) (= (invRecv50 (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_1@@1)) j_1@@1)))
 :qid |stdinbpl.5084:22|
 :skolemid |468|
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_1@@1))
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_1@@1))
)) (forall ((o_3@@17 T@U) ) (!  (=> (= (type o_3@@17) RefType) (=> (and (and (and (<= 0 (invRecv50 o_3@@17)) (< (invRecv50 o_3@@17) 3)) (< NoPerm FullPerm)) (qpRange50 o_3@@17)) (= (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) (invRecv50 o_3@@17)) o_3@@17)))
 :qid |stdinbpl.5088:22|
 :skolemid |469|
 :pattern ( (invRecv50 o_3@@17))
))) (=> (and (and (forall ((j_1@@2 Int) ) (!  (=> (and (<= 0 j_1@@2) (< j_1@@2 3)) (not (= (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_1@@2) null)))
 :qid |stdinbpl.5094:22|
 :skolemid |470|
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_1@@2))
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_1@@2))
)) (forall ((o_3@@18 T@U) ) (!  (=> (= (type o_3@@18) RefType) (and (=> (and (and (and (<= 0 (invRecv50 o_3@@18)) (< (invRecv50 o_3@@18) 3)) (< NoPerm FullPerm)) (qpRange50 o_3@@18)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) (invRecv50 o_3@@18)) o_3@@18)) (= (U_2_real (MapType1Select QPMask@0 o_3@@18 f_7)) (+ (U_2_real (MapType1Select Mask@2 o_3@@18 f_7)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv50 o_3@@18)) (< (invRecv50 o_3@@18) 3)) (< NoPerm FullPerm)) (qpRange50 o_3@@18))) (= (U_2_real (MapType1Select QPMask@0 o_3@@18 f_7)) (U_2_real (MapType1Select Mask@2 o_3@@18 f_7))))))
 :qid |stdinbpl.5100:22|
 :skolemid |471|
...
(let ((A@@22 (FieldTypeInv0 (type f_5@@5))))
 (=> (and (and (= (type o_3@@19) RefType) (= (type f_5@@5) (FieldType A@@22 B@@21))) (not (= f_5@@5 f_7))) (= (U_2_real (MapType1Select Mask@2 o_3@@19 f_5@@5)) (U_2_real (MapType1Select QPMask@0 o_3@@19 f_5@@5))))))
 :qid |stdinbpl.5104:29|
 :skolemid |472|
 :pattern ( (MapType1Select Mask@2 o_3@@19 f_5@@5))
 :pattern ( (MapType1Select QPMask@0 o_3@@19 f_5@@5))
)) (state Heap@1 QPMask@0))) (and (=> (= (ControlFlow 0 77) (- 0 84)) (forall ((j_2 Int) (j_2_1 Int) ) (!  (=> (and (and (and (and (not (= j_2 j_2_1)) (and (<= 3 j_2) (< j_2 n@@37))) (and (<= 3 j_2_1) (< j_2_1 n@@37))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_2) (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_2_1))))
 :qid |stdinbpl.5112:15|
 :skolemid |473|
))) (=> (forall ((j_2@@0 Int) (j_2_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_2@@0 j_2_1@@0)) (and (<= 3 j_2@@0) (< j_2@@0 n@@37))) (and (<= 3 j_2_1@@0) (< j_2_1@@0 n@@37))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_2@@0) (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_2_1@@0))))
 :qid |stdinbpl.5112:15|
 :skolemid |473|
)) (=> (and (and (and (forall ((j_2@@1 Int) ) (!  (=> (and (and (<= 3 j_2@@1) (< j_2@@1 n@@37)) (< NoPerm FullPerm)) (and (qpRange51 (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_2@@1)) (= (invRecv51 (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_2@@1)) j_2@@1)))
 :qid |stdinbpl.5118:22|
 :skolemid |474|
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_2@@1))
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_2@@1))
)) (forall ((o_3@@20 T@U) ) (!  (=> (= (type o_3@@20) RefType) (=> (and (and (and (<= 3 (invRecv51 o_3@@20)) (< (invRecv51 o_3@@20) n@@37)) (< NoPerm FullPerm)) (qpRange51 o_3@@20)) (= (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) (invRecv51 o_3@@20)) o_3@@20)))
 :qid |stdinbpl.5122:22|
 :skolemid |475|
 :pattern ( (invRecv51 o_3@@20))
))) (and (forall ((j_2@@2 Int) ) (!  (=> (and (<= 3 j_2@@2) (< j_2@@2 n@@37)) (not (= (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_2@@2) null)))
 :qid |stdinbpl.5128:22|
 :skolemid |476|
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_2@@2))
 :pattern ( (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) j_2@@2))
)) (forall ((o_3@@21 T@U) ) (!  (=> (= (type o_3@@21) RefType) (and (=> (and (and (and (<= 3 (invRecv51 o_3@@21)) (< (invRecv51 o_3@@21) n@@37)) (< NoPerm FullPerm)) (qpRange51 o_3@@21)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) (invRecv51 o_3@@21)) o_3@@21)) (= (U_2_real (MapType1Select QPMask@1 o_3@@21 f_7)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@21 f_7)) FullPerm)))) (=> (not (and (and (and (<= 3 (invRecv51 o_3@@21)) (< (invRecv51 o_3@@21) n@@37)) (< NoPerm FullPerm)) (qpRange51 o_3@@21))) (= (U_2_real (MapType1Select QPMask@1 o_3@@21 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@21 f_7))))))
 :qid |stdinbpl.5134:22|
 :skolemid |477|
...
(let ((A@@23 (FieldTypeInv0 (type f_5@@6))))
 ...
 :qid |stdinbpl.5138:29|
 :skolemid |478|
 :pattern ( (MapType1Select QPMask@0 o_3@@22 f_5@@6))
 :pattern ( (MapType1Select QPMask@1 o_3@@22 f_5@@6))
)) (state Heap@1 QPMask@1)) (and (state Heap@1 QPMask@1) (state Heap@1 QPMask@1)))) (and (=> (= (ControlFlow 0 77) (- 0 83)) (HasDirectPerm QPMask@1 x@@23 ss)) (=> (HasDirectPerm QPMask@1 x@@23 ss) (and (=> (= (ControlFlow 0 77) (- 0 82)) (< 2 (|Seq#Length| (MapType0Select Heap@1 x@@23 ss)))) (=> (< 2 (|Seq#Length| (MapType0Select Heap@1 x@@23 ss))) (and (=> (= (ControlFlow 0 77) (- 0 81)) (HasDirectPerm QPMask@1 (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) 2) f_7)) (=> (HasDirectPerm QPMask@1 (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) 2) f_7) (=> (and (= v1@0 (U_2_int (MapType0Select Heap@1 (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) 2) f_7))) (state Heap@1 QPMask@1)) (and (=> (= (ControlFlow 0 77) (- 0 80)) (HasDirectPerm QPMask@1 x@@23 ss)) (=> (HasDirectPerm QPMask@1 x@@23 ss) (and (=> (= (ControlFlow 0 77) (- 0 79)) (< 4 (|Seq#Length| (MapType0Select Heap@1 x@@23 ss)))) (=> (< 4 (|Seq#Length| (MapType0Select Heap@1 x@@23 ss))) (and (=> (= (ControlFlow 0 77) (- 0 78)) (HasDirectPerm QPMask@1 (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) 4) f_7)) (=> (HasDirectPerm QPMask@1 (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) 4) f_7) (=> (and (= v2@0 (U_2_int (MapType0Select Heap@1 (|Seq#Index| (MapType0Select Heap@1 x@@23 ss) 4) f_7))) (state Heap@1 QPMask@1)) (and (=> (= (ControlFlow 0 77) 74) anon43_Then_correct) (=> (= (ControlFlow 0 77) 76) anon43_Else_correct)))))))))))))))))))))))))))
(let ((anon42_Else_correct  (=> (HasDirectPerm Mask@1 null (P01 x@@23 n@@37)) (=> (and (= Heap@1 Heap@@41) (= (ControlFlow 0 87) 77)) anon4_correct))))
(let ((anon42_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (P01 x@@23 n@@37))) (= Heap@0 (MapType0Store Heap@@41 null (P01 x@@23 n@@37) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 86) 77))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (P01 x@@23 n@@37) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P01 x@@23 n@@37))) FullPerm)))) (and (=> (= (ControlFlow 0 88) 86) anon42_Then_correct) (=> (= (ControlFlow 0 88) 87) anon42_Else_correct)))))
(let ((anon41_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 91) 88)) anon2_correct)))
(let ((anon41_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 89) (- 0 90)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P01 x@@23 n@@37))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P01 x@@23 n@@37)))) (=> (= (ControlFlow 0 89) 88) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@41 x@@23 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (P01 x@@23 n@@37) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P01 x@@23 n@@37))) FullPerm)))))) (=> (and (and (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0)) (and (state Heap@@41 Mask@0) (< 6 n@@37))) (and (and (state Heap@@41 Mask@0) (state Heap@@41 Mask@0)) (and (|P01#trigger| Heap@@41 (P01 x@@23 n@@37)) (= (MapType0Select Heap@@41 null (P01 x@@23 n@@37)) (CombineFrames (FrameFragment (MapType0Select Heap@@41 x@@23 ss)) (CombineFrames (FrameFragment (int_2_U (|P01#condqp7| Heap@@41 x@@23 n@@37))) (FrameFragment (int_2_U (|P01#condqp8| Heap@@41 x@@23 n@@37))))))))) (and (=> (= (ControlFlow 0 92) 89) anon41_Then_correct) (=> (= (ControlFlow 0 92) 91) anon41_Else_correct))))))
