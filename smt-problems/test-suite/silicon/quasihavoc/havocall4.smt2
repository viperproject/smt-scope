(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:27:06
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quasihavoc/havocall4.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (=
  ($FVF.lookup_f (as sm@8@01  $FVF<f>) a@3@01)
...
(assert (forall ((r $Ref)) (!
  (=
    ($FVF.perm_f (as pm@10@01  $FPM) r)
    (+
      (ite (and (img@7@01 r) (Set_in (inv@6@01 r) s@2@01)) $Perm.Write $Perm.No)
      (ite (= r a@3@01) $Perm.Write $Perm.No)))
  :pattern (($FVF.perm_f (as pm@10@01  $FPM) r))
  :qid |qp.resPrmSumDef2|)))
(push) ; 2
(assert (not (< $Perm.No ($FVF.perm_f (as pm@10@01  $FPM) a@3@01))))
(check-sat)
; unsat
(pop) ; 2
; 0,00s
; (get-info :all-statistics)
(assert (= ($FVF.lookup_f (as sm@9@01  $FVF<f>) a@3@01) 3))
...
(push) ; 3
; [eval] (x in s)
(assert (Set_in x@11@01 s@2@01))
(pop) ; 3
; Check havocall receiver injectivity
(push) ; 3
(assert (not (forall ((x1@11@01 $Ref) (x2@11@01 $Ref)) (!
  (=>
    (and (Set_in x1@11@01 s@2@01) (Set_in x2@11@01 s@2@01) (= x1@11@01 x2@11@01))
    (= x1@11@01 x2@11@01))
...
(assert (forall ((x@11@01 $Ref)) (!
  (=>
    (Set_in x@11@01 s@2@01)
    (and (= (inv@12@01 x@11@01) x@11@01) (img@13@01 x@11@01)))
  :pattern ((Set_in x@11@01 s@2@01))
  :pattern ((inv@12@01 x@11@01))
  :pattern ((img@13@01 x@11@01))
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=> (and (img@13@01 r) (Set_in (inv@12@01 r) s@2@01)) (= (inv@12@01 r) r))
  :pattern ((inv@12@01 r))
  :qid |f-fctOfInv|)))
...
(assert (forall ((r $Ref)) (!
  (=>
    (not (and (Set_in (inv@12@01 r) s@2@01) (img@13@01 r)))
    (=
      ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.first $t@4@01)) r)
...
(push) ; 3
(assert (not (< $Perm.No ($FVF.perm_f (as pm@17@01  $FPM) a@3@01))))
(check-sat)
; unsat
(pop) ; 3
; 0,00s
; (get-info :all-statistics)
(push) ; 3
(assert (not (= ($FVF.lookup_f (as sm@16@01  $FVF<f>) a@3@01) 3)))
(check-sat)
; unknown
(pop) ; 3
; 0,00s
...
(assert (<= ($FVF.perm_f (as pm@19@01  $FPM) a@3@01) $Perm.Write))
...
(set-option :timeout 0)
(push) ; 3
(assert (not (< $Perm.No ($FVF.perm_f (as pm@21@01  $FPM) a@3@01))))
(check-sat)
; unsat
(pop) ; 3
; 0,00s
; (get-info :all-statistics)
(push) ; 3
(assert (not (= ($FVF.lookup_f (as sm@20@01  $FVF<f>) a@3@01) 3)))
(check-sat)
; unsat
(pop) ; 3
; 0,00s
; (get-info :all-statistics)
(assert (= ($FVF.lookup_f (as sm@20@01  $FVF<f>) a@3@01) 3))
(pop) ; 2
(pop) ; 1
