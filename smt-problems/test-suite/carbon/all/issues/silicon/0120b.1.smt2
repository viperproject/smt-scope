...
(assert  (and (and (and (and (and (and (= (type Heap@@15) (MapType0Type RefType)) (= (type this@@10) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |node#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (not (= (typeOf (MapType0Select Heap@@15 this@@10 next)) A)) (=> (and (= Mask@4 Mask@1) (= (ControlFlow 0 6) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (= (typeOf (MapType0Select Heap@@15 this@@10 next)) A) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm Mask@1 this@@10 next)) (=> (HasDirectPerm Mask@1 this@@10 next) (=> (not (= (MapType0Select Heap@@15 this@@10 next) null)) (=> (and (= Mask@2 (MapType1Store Mask@1 (MapType0Select Heap@@15 this@@10 next) a_2 (real_2_U (+ (U_2_real (MapType1Select Mask@1 (MapType0Select Heap@@15 this@@10 next) a_2)) FullPerm)))) (state Heap@@15 Mask@2)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@2 this@@10 next)) (=> (HasDirectPerm Mask@2 this@@10 next) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@2 (MapType0Select Heap@@15 this@@10 next) a_2)) (=> (HasDirectPerm Mask@2 (MapType0Select Heap@@15 this@@10 next) a_2) (=> (and (and (= Mask@3 (MapType1Store Mask@2 null (node (MapType0Select Heap@@15 (MapType0Select Heap@@15 this@@10 next) a_2)) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (node (MapType0Select Heap@@15 (MapType0Select Heap@@15 this@@10 next) a_2)))) FullPerm)))) (state Heap@@15 Mask@3)) (and (= Mask@4 Mask@3) (= (ControlFlow 0 2) 1))) anon2_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@15 this@@10 $allocated))) (and (not (= this@@10 null)) (= Mask@0 (MapType1Store ZeroMask this@@10 val (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@10 val)) FullPerm)))))) (and (and (state Heap@@15 Mask@0) (not (= this@@10 null))) (and (= Mask@1 (MapType1Store Mask@0 this@@10 next (real_2_U (+ (U_2_real (MapType1Select Mask@0 this@@10 next)) FullPerm)))) (state Heap@@15 Mask@1)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm Mask@1 this@@10 next)) (=> (HasDirectPerm Mask@1 this@@10 next) (and (=> (= (ControlFlow 0 7) 2) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct))))))))
