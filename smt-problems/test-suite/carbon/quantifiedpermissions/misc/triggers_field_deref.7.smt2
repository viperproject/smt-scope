...
(assert  (and (and (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type x_2) RefType)) (= (type y@@2) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type z@@0) RefType)) (forall ((arg0@@35 T@U) ) (! (= (type (invRecv1 arg0@@35)) RefType)
...
(let ((anon9_Else_correct  (=> (and (not (or (= z@@0 x_2) (= z@@0 y@@2))) (= (ControlFlow 0 8) 5)) anon5_correct)))
(let ((anon9_Then_correct  (=> (or (= z@@0 x_2) (= z@@0 y@@2)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm QPMask@0 z@@0 f_7)) (=> (HasDirectPerm QPMask@0 z@@0 f_7) (=> (= (ControlFlow 0 6) 5) anon5_correct))))))
(let ((anon8_Else_correct  (=> (forall ((z_3 T@U) ) (!  (=> (and (= (type z_3) RefType) (or (= z_3 x_2) (= z_3 y@@2))) (> (U_2_int (MapType0Select Heap@@13 z_3 f_7)) 0))
 :qid |stdinbpl.812:20|
 :skolemid |68|
...
)) (=> (and (and (forall ((z_1@@1 T@U) ) (!  (=> (= (type z_1@@1) RefType) (=> (and (or (= z_1@@1 x_2) (= z_1@@1 y@@2)) (< NoPerm FullPerm)) (and (qpRange1 z_1@@1) (= (invRecv1 z_1@@1) z_1@@1))))
 :qid |stdinbpl.767:22|
 :skolemid |63|
 :pattern ( (MapType0Select Heap@@13 z_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@1 f_7))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (or (= (invRecv1 o_3) x_2) (= (invRecv1 o_3) y@@2)) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.771:22|
 :skolemid |64|
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (or (= (invRecv1 o_3@@0) x_2) (= (invRecv1 o_3@@0) y@@2)) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (or (= (invRecv1 o_3@@0) x_2) (= (invRecv1 o_3@@0) y@@2)) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.783:22|
 :skolemid |66|
