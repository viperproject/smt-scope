...
(let ((anon7_correct  (=> (and (state Heap@@18 ZeroMask) (= (ControlFlow 0 4) 2)) anon8_correct)))
(let ((anon12_Else_correct  (=> (and (> 0 y@@5) (= (ControlFlow 0 8) 4)) anon7_correct)))
(let ((anon12_Then_correct  (=> (>= y@@5 0) (and (=> (= (ControlFlow 0 5) (- 0 7)) (decreasing (int_2_U (- y@@5 1)) (int_2_U y@@5))) (=> (decreasing (int_2_U (- y@@5 1)) (int_2_U y@@5)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (bounded (int_2_U y@@5))) (=> (bounded (int_2_U y@@5)) (=> (= (ControlFlow 0 5) 4) anon7_correct))))))))
(let ((anon11_Then_correct  (=> (not (= y@@5 0)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (not (>= y@@5 0)) (>= (- y@@5 1) 0))) (=> (or (not (>= y@@5 0)) (>= (- y@@5 1) 0)) (=> (state Heap@@18 ZeroMask) (and (=> (= (ControlFlow 0 9) 5) anon12_Then_correct) (=> (= (ControlFlow 0 9) 8) anon12_Else_correct))))))))
(let ((anon11_Else_correct  (=> (and (= y@@5 0) (= (ControlFlow 0 3) 2)) anon8_correct)))
(let ((anon10_Else_correct  (=> (= i (g Heap@@18 y@@5)) (=> (and (state Heap@@18 ZeroMask) (state Heap@@18 ZeroMask)) (and (=> (= (ControlFlow 0 11) 9) anon11_Then_correct) (=> (= (ControlFlow 0 11) 3) anon11_Else_correct))))))
(let ((anon10_Then_correct true))
(let ((anon2_correct  (=> (and (state Heap@@18 ZeroMask) (state Heap@@18 ZeroMask)) (and (=> (= (ControlFlow 0 12) 1) anon10_Then_correct) (=> (= (ControlFlow 0 12) 11) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (> 0 y@@5) (= (ControlFlow 0 16) 12)) anon2_correct)))
(let ((anon9_Then_correct  (=> (>= y@@5 0) (and (=> (= (ControlFlow 0 13) (- 0 15)) (decreasing (int_2_U y@@5) (int_2_U y@@5))) (=> (decreasing (int_2_U y@@5) (int_2_U y@@5)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (bounded (int_2_U y@@5))) (=> (bounded (int_2_U y@@5)) (=> (= (ControlFlow 0 13) 12) anon2_correct))))))))
(let ((anon0_correct  (=> (and (state Heap@@18 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (or (not (>= y@@5 0)) (>= y@@5 0))) (=> (or (not (>= y@@5 0)) (>= y@@5 0)) (=> (state Heap@@18 ZeroMask) (and (=> (= (ControlFlow 0 17) 13) anon9_Then_correct) (=> (= (ControlFlow 0 17) 16) anon9_Else_correct))))))))
