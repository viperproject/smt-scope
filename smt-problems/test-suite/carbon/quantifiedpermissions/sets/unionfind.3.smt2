...
(assert  (and (and (and (and (and (and (and (and (= (type Heap@@20) (MapType1Type RefType)) (= (type this@@16) RefType)) (= (type Mask@0) (MapType2Type RefType realType))) (forall ((arg0@@54 T@U) (arg1@@31 T@U) ) (! (= (type (CombineFrames arg0@@54 arg1@@31)) FrameTypeType)
...
))) (= (type UnfoldingMask@0) (MapType2Type RefType realType))) (= (type UnfoldingMask@1) (MapType2Type RefType realType))) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@56 T@U) ) (! (= (type (invRecv2 arg0@@56)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@20 ZeroMask) (=> (and (and (and (U_2_bool (MapType1Select Heap@@20 this@@16 $allocated)) (= AssumeFunctionsAbove 1)) (and (> wildcard@0 NoPerm) (= Mask@0 (MapType2Store ZeroMask null (inv this@@16) (real_2_U (+ (U_2_real (MapType2Select ZeroMask null (inv this@@16))) wildcard@0)))))) (and (and (state Heap@@20 Mask@0) (state Heap@@20 Mask@0)) (and (|inv#trigger| Heap@@20 (inv this@@16)) (= (MapType1Select Heap@@20 null (inv this@@16)) (CombineFrames (FrameFragment (MapType1Select Heap@@20 this@@16 nodes)) (FrameFragment (int_2_U (|inv#condqp1| Heap@@20 this@@16)))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (> (U_2_real (MapType2Select Mask@0 null (inv this@@16))) NoPerm)) (=> (> (U_2_real (MapType2Select Mask@0 null (inv this@@16))) NoPerm) (=> (and (and (and (> wildcard@1 NoPerm) (< wildcard@1 (U_2_real (MapType2Select Mask@0 null (inv this@@16))))) (and (= UnfoldingMask@0 (MapType2Store Mask@0 null (inv this@@16) (real_2_U (- (U_2_real (MapType2Select Mask@0 null (inv this@@16))) wildcard@1)))) (> wildcard@2 NoPerm))) (and (and (not (= this@@16 null)) (= UnfoldingMask@1 (MapType2Store UnfoldingMask@0 this@@16 nodes (real_2_U (+ (U_2_real (MapType2Select UnfoldingMask@0 this@@16 nodes)) wildcard@2))))) (and (state Heap@@20 UnfoldingMask@1) (not (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) null)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((n T@U) (n_4 T@U) ) (!  (=> (and (= (type n) RefType) (= (type n_4) RefType)) (=> (and (and (and (and (not (= n n_4)) (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) n))) (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) n_4))) (< NoPerm wildcard@2)) (< NoPerm wildcard@2)) (not (= n n_4))))
 :qid |stdinbpl.745:17|
 :skolemid |101|
 :no-pattern (type n)
 :no-pattern (type n_4)
...
))) (=> (forall ((n@@0 T@U) (n_4@@0 T@U) ) (!  (=> (and (= (type n@@0) RefType) (= (type n_4@@0) RefType)) (=> (and (and (and (and (not (= n@@0 n_4@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) n@@0))) (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) n_4@@0))) (< NoPerm wildcard@2)) (< NoPerm wildcard@2)) (not (= n@@0 n_4@@0))))
 :qid |stdinbpl.745:17|
 :skolemid |101|
 :no-pattern (type n@@0)
...
)) (=> (forall ((n@@1 T@U) ) (!  (=> (and (= (type n@@1) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) n@@1))) (and (qpRange2 n@@1) (= (invRecv2 n@@1) n@@1)))
 :qid |stdinbpl.751:24|
 :skolemid |102|
 :pattern ( (MapType1Select Heap@@20 n@@1 parent))
 :pattern ( (MapType2Select QPMask@0 n@@1 parent))
 :pattern ( (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) n@@1))
)) (=> (and (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) (invRecv2 o_3))) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.755:24|
 :skolemid |103|
 :pattern ( (invRecv2 o_3))
)) (forall ((n@@2 T@U) ) (!  (=> (= (type n@@2) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) n@@2)) (> wildcard@2 NoPerm)) (not (= n@@2 null))))
 :qid |stdinbpl.761:24|
 :skolemid |104|
 :pattern ( (MapType1Select Heap@@20 n@@2 parent))
 :pattern ( (MapType2Select QPMask@0 n@@2 parent))
 :pattern ( (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) n@@2))
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) (invRecv2 o_3@@0))) (qpRange2 o_3@@0)) (and (= (invRecv2 o_3@@0) o_3@@0) (< (U_2_real (MapType2Select UnfoldingMask@1 o_3@@0 parent)) (U_2_real (MapType2Select QPMask@0 o_3@@0 parent))))) (=> (not (and (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) (invRecv2 o_3@@0))) (qpRange2 o_3@@0))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 parent)) (U_2_real (MapType2Select UnfoldingMask@1 o_3@@0 parent))))))
 :qid |stdinbpl.767:24|
 :skolemid |105|
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 parent))) (= (U_2_real (MapType2Select UnfoldingMask@1 o_3@@1 f_5)) (U_2_real (MapType2Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.771:31|
 :skolemid |106|
 :pattern ( (MapType2Select UnfoldingMask@1 o_3@@1 f_5))
 :pattern ( (MapType2Select QPMask@0 o_3@@1 f_5))
)))) (and (and (state Heap@@20 QPMask@0) (forall ((q_1 T@U) ) (!  (=> (and (= (type q_1) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) q_1))) (U_2_bool (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) (MapType1Select Heap@@20 q_1 parent))))
 :qid |stdinbpl.777:22|
 :skolemid |107|
 :pattern ( (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) q_1))
 :pattern ( (MapType0Select (MapType1Select Heap@@20 this@@16 nodes) (MapType1Select Heap@@20 q_1 parent)))
))) (and (state Heap@@20 QPMask@0) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm QPMask@0 this@@16 nodes))))))))))))
