...
(assert  (and (and (and (and (= (type Heap@@19) (MapType0Type RefType)) (= (type self@@11) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |P#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@19 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@19 self@@11 $allocated)) (not (= self@@11 null))) (and (= Mask@0 (MapType1Store ZeroMask self@@11 f$m2 (real_2_U (+ (U_2_real (MapType1Select ZeroMask self@@11 f$m2)) FullPerm)))) (state Heap@@19 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 self@@11 f$m2)) (=> (HasDirectPerm Mask@0 self@@11 f$m2) (=> (and (= Mask@1 (MapType1Store Mask@0 null (u32 (MapType0Select Heap@@19 self@@11 f$m2)) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (u32 (MapType0Select Heap@@19 self@@11 f$m2)))) FullPerm)))) (state Heap@@19 Mask@1)) (=> (and (and (not (= self@@11 null)) (= Mask@2 (MapType1Store Mask@1 self@@11 f$m5 (real_2_U (+ (U_2_real (MapType1Select Mask@1 self@@11 f$m5)) FullPerm))))) (and (state Heap@@19 Mask@2) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@2 self@@11 f$m5)))))))))
