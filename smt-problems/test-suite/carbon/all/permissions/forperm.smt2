...
(declare-fun y_17 () T@U)
(declare-fun Heap@0 () T@U)
(declare-fun a1@0 () Int)
(declare-fun y_16 () T@U)
(declare-fun Heap@@9 () T@U)
(declare-fun x@@8 () T@U)
(declare-fun perm@0 () Real)
(declare-fun Mask@0 () T@U)
(declare-fun perm@1 () Real)
(assert  (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type y_16) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type y_17) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type x@@8) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test03)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm Mask@1 y_17 f_7)) (= (ControlFlow 0 13) 8)) anon7_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm Mask@1 y_17 f_7) (and (=> (= (ControlFlow 0 9) (- 0 12)) (HasDirectPerm Mask@1 y_17 f_7)) (=> (HasDirectPerm Mask@1 y_17 f_7) (and (=> (= (ControlFlow 0 9) (- 0 11)) (HasDirectPerm Mask@1 y_17 g)) (=> (HasDirectPerm Mask@1 y_17 g) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm Mask@1 y_17 g)) (=> (HasDirectPerm Mask@1 y_17 g) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((y_3 T@U) ) (!  (=> (and (= (type y_3) RefType) (HasDirectPerm Mask@1 y_3 f_7)) (> (U_2_int (MapType0Select Heap@0 y_3 g)) (- (U_2_int (MapType0Select Heap@0 y_3 g)) 1)))
 :qid |stdinbpl.622:15|
 :skolemid |33|
 :pattern ( (MapType1Select Mask@1 y_3 f_7))
 :pattern ( (MapType0Select Heap@0 y_3 f_7))
)))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((y_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (HasDirectPerm Mask@1 y_1 g)) (> (U_2_int (MapType0Select Heap@0 y_1 f_7)) a1@0))
 :qid |stdinbpl.599:15|
 :skolemid |32|
 :pattern ( (MapType1Select Mask@1 y_1 g))
 :pattern ( (MapType0Select Heap@0 y_1 g))
))) (=> (forall ((y_1@@0 T@U) ) (!  (=> (and (= (type y_1@@0) RefType) (HasDirectPerm Mask@1 y_1@@0 g)) (> (U_2_int (MapType0Select Heap@0 y_1@@0 f_7)) a1@0))
 :qid |stdinbpl.599:15|
 :skolemid |32|
 :pattern ( (MapType1Select Mask@1 y_1@@0 g))
 :pattern ( (MapType0Select Heap@0 y_1@@0 g))
)) (=> (state Heap@0 Mask@1) (and (and (=> (= (ControlFlow 0 14) 7) anon11_Else_correct) (=> (= (ControlFlow 0 14) 9) anon12_Then_correct)) (=> (= (ControlFlow 0 14) 13) anon12_Else_correct)))))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (HasDirectPerm Mask@1 y_16 g)) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (HasDirectPerm Mask@1 y_16 g) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@1 y_16 g)) (=> (HasDirectPerm Mask@1 y_16 g) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 y_16 f_7)) (=> (HasDirectPerm Mask@1 y_16 f_7) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated)) (= perm@0 (/ (to_real 1) (to_real 5)))) (and (=> (= (ControlFlow 0 16) (- 0 20)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= x@@8 null))) (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) perm@0))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 16) (- 0 19)) (HasDirectPerm Mask@0 x@@8 f_7)) (=> (HasDirectPerm Mask@0 x@@8 f_7) (=> (= a1@0 (U_2_int (MapType0Select Heap@@9 x@@8 f_7))) (=> (and (state Heap@@9 Mask@0) (= perm@1 (/ (to_real 4) (to_real 5)))) (and (=> (= (ControlFlow 0 16) (- 0 18)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (=> (> perm@1 NoPerm) (not (= x@@8 null))) (=> (and (and (= Mask@1 (MapType1Store Mask@0 x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@8 f_7)) perm@1)))) (state Heap@@9 Mask@1)) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (= FullPerm (U_2_real (MapType1Select Mask@1 x@@8 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 x@@8 f_7))) (=> (and (= Heap@0 (MapType0Store Heap@@9 x@@8 f_7 (int_2_U (+ a1@0 1)))) (state Heap@0 Mask@1)) (and (and (=> (= (ControlFlow 0 16) 14) anon9_Else_correct) (=> (= (ControlFlow 0 16) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 16) 5) anon10_Else_correct))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 21) 16) anon0_correct)))
