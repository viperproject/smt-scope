...
(assert  (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type c3) RefType)) (= (type r_4) RefType)) (= (type c1) RefType)) (= (type c2) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test04)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (not (HasDirectPerm Mask@1 r_4 val)) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (HasDirectPerm Mask@1 r_4 val) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@1 r_4 val)) (=> (HasDirectPerm Mask@1 r_4 val) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((r_1_1 T@U) ) (!  (=> (and (and (= (type r_1_1) RefType) (HasDirectPerm Mask@1 r_1_1 val)) (= r_1_1 c3)) false)
 :qid |stdinbpl.432:15|
 :skolemid |25|
