...
(assert  (and (= (type a_3@@5) ArrayDomainTypeType) (= (type Heap@@12) (MapType0Type RefType))))
(set-info :boogie-vc-id |Contains#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 before@@3))) (and (<= 0 i_3_1) (< i_3_1 before@@3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@5 i_3) (loc a_3@@5 i_3_1))))
 :qid |stdinbpl.329:15|
 :skolemid |28|
)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@12 ZeroMask) (=> (and (and (= AssumeFunctionsAbove 0) (<= 0 before@@3)) (and (<= before@@3 (len a_3@@5)) (state Heap@@12 ZeroMask))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
