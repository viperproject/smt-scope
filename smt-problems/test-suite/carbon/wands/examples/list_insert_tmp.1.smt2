...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@1) (MapType1Type RefType)) (= (type xs@@13) RefType)) (= (type newPMask@0) (MapType0Type RefType boolType))) (= (type Heap@2) (MapType1Type RefType))) (= (type Heap@3) (MapType1Type RefType))) (= (type Heap@@18) (MapType1Type RefType))) (= (type UnfoldingMask@4) (MapType0Type RefType realType))) (= (type Heap@0) (MapType1Type RefType))) (= (type UnfoldingMask@3) (MapType0Type RefType realType))) (= (type UnfoldingMask@2) (MapType0Type RefType realType))) (= (type UnfoldingMask@0) (MapType0Type RefType realType))) (= (type Mask@0) (MapType0Type RefType realType))) (= (type UnfoldingMask@1) (MapType0Type RefType realType))) (forall ((arg0@@44 T@U) (arg1@@29 T@U) ) (! (= (type (CombineFrames arg0@@44 arg1@@29)) FrameTypeType)
...
(let ((anon9_Else_correct  (=> (= (MapType1Select Heap@1 xs@@13 next) null) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 3) 1)) anon6_correct))))
(let ((anon9_Then_correct  (=> (not (= (MapType1Select Heap@1 xs@@13 next) null)) (=> (and (and (forall ((o_4 T@U) (f_8 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_8))))
(let ((A@@12 (FieldTypeInv0 (type f_8))))
 (=> (and (and (= (type o_4) RefType) (= (type f_8) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType0Select (MapType1Select Heap@1 null (|List#sm| xs@@13)) o_4 f_8)) (U_2_bool (MapType0Select (MapType1Select Heap@1 null (|List#sm| (MapType1Select Heap@1 xs@@13 next))) o_4 f_8)))) (U_2_bool (MapType0Select newPMask@0 o_4 f_8)))))
 :qid |stdinbpl.825:33|
 :skolemid |74|
 :pattern ( (MapType0Select newPMask@0 o_4 f_8))
)) (= Heap@2 (MapType1Store Heap@1 null (|List#sm| xs@@13) newPMask@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 2) 1))) anon6_correct))))
(let ((anon4_correct  (=> (state Heap@@18 UnfoldingMask@4) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm UnfoldingMask@4 xs@@13 val)) (=> (HasDirectPerm UnfoldingMask@4 xs@@13 val) (=> (and (= Heap@0 (MapType1Store Heap@@18 null (|List#sm| xs@@13) (MapType0Store (MapType1Select Heap@@18 null (|List#sm| xs@@13)) xs@@13 val (bool_2_U true)))) (= Heap@1 (MapType1Store Heap@0 null (|List#sm| xs@@13) (MapType0Store (MapType1Select Heap@0 null (|List#sm| xs@@13)) xs@@13 next (bool_2_U true))))) (and (=> (= (ControlFlow 0 4) 2) anon9_Then_correct) (=> (= (ControlFlow 0 4) 3) anon9_Else_correct))))))))
(let ((anon8_Else_correct  (=> (= (MapType1Select Heap@@18 xs@@13 next) null) (=> (and (= UnfoldingMask@4 UnfoldingMask@2) (= (ControlFlow 0 7) 4)) anon4_correct))))
(let ((anon8_Then_correct  (=> (and (not (= (MapType1Select Heap@@18 xs@@13 next) null)) (= UnfoldingMask@3 (MapType0Store UnfoldingMask@2 null (List (MapType1Select Heap@@18 xs@@13 next)) (real_2_U (+ (U_2_real (MapType0Select UnfoldingMask@2 null (List (MapType1Select Heap@@18 xs@@13 next)))) FullPerm))))) (=> (and (and (InsidePredicate (List xs@@13) (MapType1Select Heap@@18 null (List xs@@13)) (List (MapType1Select Heap@@18 xs@@13 next)) (MapType1Select Heap@@18 null (List (MapType1Select Heap@@18 xs@@13 next)))) (state Heap@@18 UnfoldingMask@3)) (and (= UnfoldingMask@4 UnfoldingMask@3) (= (ControlFlow 0 6) 4))) anon4_correct))))
(let ((anon2_correct  (=> (= UnfoldingMask@0 (MapType0Store Mask@0 null (List xs@@13) (real_2_U (- (U_2_real (MapType0Select Mask@0 null (List xs@@13))) FullPerm)))) (=> (and (not (= xs@@13 null)) (= UnfoldingMask@1 (MapType0Store UnfoldingMask@0 xs@@13 val (real_2_U (+ (U_2_real (MapType0Select UnfoldingMask@0 xs@@13 val)) FullPerm))))) (=> (and (and (state Heap@@18 UnfoldingMask@1) (not (= xs@@13 null))) (and (= UnfoldingMask@2 (MapType0Store UnfoldingMask@1 xs@@13 next (real_2_U (+ (U_2_real (MapType0Select UnfoldingMask@1 xs@@13 next)) FullPerm)))) (state Heap@@18 UnfoldingMask@2))) (and (=> (= (ControlFlow 0 8) 6) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct)))))))
(let ((anon7_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType0Select Mask@0 null (List xs@@13))))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@0 null (List xs@@13)))) (=> (= (ControlFlow 0 9) 8) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@18 ZeroMask) (U_2_bool (MapType1Select Heap@@18 xs@@13 $allocated))) (and (= AssumeFunctionsAbove 1) (= Mask@0 (MapType0Store ZeroMask null (List xs@@13) (real_2_U (+ (U_2_real (MapType0Select ZeroMask null (List xs@@13))) FullPerm)))))) (and (and (state Heap@@18 Mask@0) (state Heap@@18 Mask@0)) (and (|List#trigger| Heap@@18 (List xs@@13)) (= (MapType1Select Heap@@18 null (List xs@@13)) (CombineFrames (FrameFragment (MapType1Select Heap@@18 xs@@13 val)) (CombineFrames (FrameFragment (MapType1Select Heap@@18 xs@@13 next)) (FrameFragment (ite (not (= (MapType1Select Heap@@18 xs@@13 next) null)) (MapType1Select Heap@@18 null (List (MapType1Select Heap@@18 xs@@13 next))) EmptyFrame)))))))) (and (=> (= (ControlFlow 0 12) 9) anon7_Then_correct) (=> (= (ControlFlow 0 12) 11) anon7_Else_correct)))))
