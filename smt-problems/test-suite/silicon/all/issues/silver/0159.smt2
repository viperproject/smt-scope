(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:01:52
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/issues/silver/0159.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
; ------------------------------------------------------------
; ---------- m ----------
(declare-const e@0@01 $Ref)
(declare-const e@1@01 $Ref)
...
(push) ; 2
; [exec]
; assert (forall i: Int ::i < 4 && i > 0 ==> acc(e.x, write))
(declare-const i@2@01 Int)
(push) ; 3
; [eval] i < 4 && i > 0
; [eval] i < 4
(push) ; 4
; [then-branch: 0 | !(i@2@01 < 4) | live]
; [else-branch: 0 | i@2@01 < 4 | live]
(push) ; 5
; [then-branch: 0 | !(i@2@01 < 4)]
(assert (not (< i@2@01 4)))
(pop) ; 5
(push) ; 5
; [else-branch: 0 | i@2@01 < 4]
(assert (< i@2@01 4))
; [eval] i > 0
(pop) ; 5
(pop) ; 4
...
; Joined path conditions
(assert (or (< i@2@01 4) (not (< i@2@01 4))))
(assert (and (< i@2@01 4) (> i@2@01 0)))
(pop) ; 3
...
(assert (forall ((i@2@01 Int)) (!
  (=> (and (< i@2@01 4) (> i@2@01 0)) (or (< i@2@01 4) (not (< i@2@01 4))))
...
(assert (not (forall ((i1@2@01 Int) (i2@2@01 Int)) (!
  (=>
    (and (and (< i1@2@01 4) (> i1@2@01 0)) (and (< i2@2@01 4) (> i2@2@01 0)))
    (= i1@2@01 i2@2@01))
...
; [eval] i < 4
(push) ; 4
; [then-branch: 1 | !(i@5@01 < 4) | live]
; [else-branch: 1 | i@5@01 < 4 | live]
(push) ; 5
; [then-branch: 1 | !(i@5@01 < 4)]
(assert (not (< i@5@01 4)))
; [state consolidation]
; State saturation: before repetition
(set-option :timeout 10)
...
; Joined path conditions
; Joined path conditions
(assert (or (< i@5@01 4) (not (< i@5@01 4))))
(assert (and (< i@5@01 4) (> i@5@01 0)))
(pop) ; 3
...
(assert (forall ((i@5@01 Int)) (!
  (=> (and (< i@5@01 4) (> i@5@01 0)) (or (< i@5@01 4) (not (< i@5@01 4))))
...
(assert (not (forall ((i1@5@01 Int) (i2@5@01 Int)) (!
  (=>
    (and (and (< i1@5@01 4) (> i1@5@01 0)) (and (< i2@5@01 4) (> i2@5@01 0)))
    (= i1@5@01 i2@5@01))
