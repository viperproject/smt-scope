...
(declare-fun i4 () T@U)
(declare-fun i3 () Int)
(assert  (and (= (type Heap@@9) (MapType0Type RefType)) (= (type i4) (MultiSetType intType))))
(set-info :boogie-vc-id chainParen2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (< i1 i2)) (and (<= i2 (|MultiSet#Select| i4 (int_2_U i3))) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i1 i2)) (=> (< i1 i2) (=> (state Heap@@9 ZeroMask) (=> (and (and (= (|MultiSet#Select| i4 (int_2_U i3)) 3) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (<= i2 3))))))))
