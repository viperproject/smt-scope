...
(declare-fun i_5 () Int)
(declare-fun i_4 () Int)
(assert  (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type x@@18) RefType)) (= (type Heap@@17) (MapType0Type RefType))))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon21_correct true))
(let ((anon34_Else_correct  (=> (and (not (and (<= 0 i_3) (< i_3 10))) (= (ControlFlow 0 21) 18)) anon21_correct)))
(let ((anon34_Then_correct  (=> (and (<= 0 i_3) (< i_3 10)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (fun Heap@@17 (get Heap@@17 x@@18) i_3)) (=> (fun Heap@@17 (get Heap@@17 x@@18) i_3) (=> (= (ControlFlow 0 19) 18) anon21_correct))))))
(let ((anon14_correct true))
(let ((anon31_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 13)) anon14_correct)))
(let ((anon31_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pred x@@18))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pred x@@18)))) (=> (= (ControlFlow 0 14) 13) anon14_correct))))))
(let ((anon32_Then_correct true))
(let ((anon17_correct true))
(let ((anon29_Then_correct  (=> (and (<= 0 i_5) (< i_5 10)) (and (and (and (=> (= (ControlFlow 0 17) 12) anon32_Then_correct) (=> (= (ControlFlow 0 17) 10) anon17_correct)) (=> (= (ControlFlow 0 17) 14) anon31_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon31_Else_correct)))))
(let ((anon29_Else_correct  (=> (and (not (and (<= 0 i_5) (< i_5 10))) (= (ControlFlow 0 11) 10)) anon17_correct)))
(let ((anon33_Else_correct true))
(let ((anon23_Else_correct  (=> (forall ((i_1_1 Int) ) (!  (=> (and (<= 0 i_1_1) (< i_1_1 10)) (fun Heap@@17 (get Heap@@17 x@@18) i_1_1))
 :qid |stdinbpl.625:20|
 :skolemid |37|
 :pattern ( (|fun#frame| EmptyFrame (|get#frame| (MapType0Select Heap@@17 null (pred x@@18)) x@@18) i_1_1))
)) (=> (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)) (and (and (and (and (=> (= (ControlFlow 0 22) 9) anon33_Else_correct) (=> (= (ControlFlow 0 22) 19) anon34_Then_correct)) (=> (= (ControlFlow 0 22) 21) anon34_Else_correct)) (=> (= (ControlFlow 0 22) 17) anon29_Then_correct)) (=> (= (ControlFlow 0 22) 11) anon29_Else_correct))))))
(let ((anon5_correct true))
(let ((anon26_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 4)) anon5_correct)))
(let ((anon26_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pred x@@18))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pred x@@18)))) (=> (= (ControlFlow 0 5) 4) anon5_correct))))))
(let ((anon27_Then_correct true))
(let ((anon8_correct true))
(let ((anon24_Then_correct  (=> (and (<= 0 i_4) (< i_4 10)) (and (and (and (=> (= (ControlFlow 0 8) 3) anon27_Then_correct) (=> (= (ControlFlow 0 8) 1) anon8_correct)) (=> (= (ControlFlow 0 8) 5) anon26_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon26_Else_correct)))))
(let ((anon24_Else_correct  (=> (and (not (and (<= 0 i_4) (< i_4 10))) (= (ControlFlow 0 2) 1)) anon8_correct)))
(let ((anon0_correct  (=> (and (and (and (state Heap@@17 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@17 x@@18 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (pred x@@18) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (pred x@@18))) FullPerm)))))) (and (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)))) (and (and (=> (= (ControlFlow 0 23) 22) anon23_Else_correct) (=> (= (ControlFlow 0 23) 8) anon24_Then_correct)) (=> (= (ControlFlow 0 23) 2) anon24_Else_correct)))))
