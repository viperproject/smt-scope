...
(assert  (and (and (and (and (and (and (and (= (type x@@14) RefType) (= (type Ops_1Mask@0) (MapType0Type RefType realType))) (= (type Ops_1Heap@0) (MapType1Type RefType))) (= (type Ops_1Mask@1) (MapType0Type RefType realType))) (= (type Heap@@10) (MapType1Type RefType))) (= (type Mask@0) (MapType0Type RefType realType))) (= (type Mask@1) (MapType0Type RefType realType))) (= (type UsedHeap@0) (MapType1Type RefType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon6_correct true))
(let ((anon9_Else_correct  (=> (and (not b_1_1@0) (= (ControlFlow 0 9) 1)) anon6_correct)))
(let ((anon9_Then_correct  (=> (and b_1_1@0 (= perm@1 (/ (to_real 1) (to_real 10)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (and (= b_1_1@3  (and b_1_1@0 (=> (> perm@1 NoPerm) (not (= x@@14 null))))) (= Ops_1Mask@1 (MapType0Store ZeroMask x@@14 f_7 (real_2_U (+ (U_2_real (MapType0Select ZeroMask x@@14 f_7)) perm@1))))) (and (= b_1_1@4  (and b_1_1@3 (state Ops_1Heap@0 Ops_1Mask@1))) (= (ControlFlow 0 7) 1))) anon6_correct))))))
(let ((anon8_Then_correct  (=> (=> b_1_1@0 b1) (and (=> (= (ControlFlow 0 10) 7) anon9_Then_correct) (=> (= (ControlFlow 0 10) 9) anon9_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (not b_1_1@0) (= (ControlFlow 0 5) 1)) anon6_correct)))
(let ((anon10_Then_correct  (=> (and b_1_1@0 (= perm@0 (/ (to_real 1) (to_real 10)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (= b_1_1@1  (and b_1_1@0 (=> (> perm@0 NoPerm) (not (= x@@14 null))))) (= Ops_1Mask@0 (MapType0Store ZeroMask x@@14 g (real_2_U (+ (U_2_real (MapType0Select ZeroMask x@@14 g)) perm@0))))) (and (= b_1_1@2  (and b_1_1@1 (state Ops_1Heap@0 Ops_1Mask@0))) (= (ControlFlow 0 3) 1))) anon6_correct))))))
(let ((anon8_Else_correct  (=> (not (=> b_1_1@0 b1)) (and (=> (= (ControlFlow 0 6) 3) anon10_Then_correct) (=> (= (ControlFlow 0 6) 5) anon10_Else_correct)))))
(let ((anon7_Then_correct  (=> b_1_1@0 (and (=> (= (ControlFlow 0 11) 10) anon8_Then_correct) (=> (= (ControlFlow 0 11) 6) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (not b_1_1@0) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType1Select Heap@@10 x@@14 $allocated))) (and (not (= x@@14 null)) (= Mask@0 (MapType0Store ZeroMask x@@14 f_7 (real_2_U (+ (U_2_real (MapType0Select ZeroMask x@@14 f_7)) FullPerm)))))) (=> (and (and (and (state Heap@@10 Mask@0) (not (= x@@14 null))) (and (= Mask@1 (MapType0Store Mask@0 x@@14 g (real_2_U (+ (U_2_real (MapType0Select Mask@0 x@@14 g)) FullPerm)))) (state Heap@@10 Mask@1))) (and (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1)) (and (= b_1_1@0  (and b_1_1 (state Ops_1Heap@0 ZeroMask))) (= b_3@0  (and b_3 (state UsedHeap@0 ZeroMask)))))) (and (=> (= (ControlFlow 0 12) 11) anon7_Then_correct) (=> (= (ControlFlow 0 12) 2) anon7_Else_correct))))))
