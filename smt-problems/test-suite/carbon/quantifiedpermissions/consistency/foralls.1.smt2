...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 1 (+ (|Seq#Length| xs) 1)) (int_2_U i_10))) (= (ControlFlow 0 14) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 1 (+ (|Seq#Length| xs) 1)) (int_2_U i_10)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= (- i_10 1) 0)) (=> (>= (- i_10 1) 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< (- i_10 1) (|Seq#Length| xs))) (=> (< (- i_10 1) (|Seq#Length| xs)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains| (|Seq#Range| 1 (+ (|Seq#Length| xs) 1)) (int_2_U i_3))) (|Seq#Contains| (|Seq#Range| 1 (+ (|Seq#Length| xs) 1)) (int_2_U i_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs (- i_3 1)) (|Seq#Index| xs (- i_3_1 1)))))
 :qid |stdinbpl.1143:15|
 :skolemid |146|
)))))
(let ((anon9_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (<= 0 i_1) (and (< i_1 j_1) (< j_1 (|Seq#Length| xs)))) (not (= (|Seq#Index| xs i_1) (|Seq#Index| xs j_1))))
 :qid |stdinbpl.1125:20|
 :skolemid |145|
 :pattern ( (|Seq#Index| xs i_1) (|Seq#Index| xs j_1))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 15) 9) anon11_Else_correct) (=> (= (ControlFlow 0 15) 11) anon12_Then_correct)) (=> (= (ControlFlow 0 15) 14) anon12_Else_correct)))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (and (<= 0 i_9) (and (< i_9 j_4) (< j_4 (|Seq#Length| xs))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (<= 0 i_9) (and (< i_9 j_4) (< j_4 (|Seq#Length| xs)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_9 0)) (=> (>= i_9 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_9 (|Seq#Length| xs))) (=> (< i_9 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_4 0)) (=> (>= j_4 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_4 (|Seq#Length| xs))) (=> (< j_4 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (and (=> (= (ControlFlow 0 16) 15) anon9_Else_correct) (=> (= (ControlFlow 0 16) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 16) 7) anon10_Else_correct)))))
