...
(assert  (and (and (and (and (and (and (= (type ExhaleHeap@0) (MapType0Type RefType)) (= (type r_1) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id t9)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon7_correct)))
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@3 r_1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 r_1 f_7))) (=> (= (ControlFlow 0 6) 5) anon7_correct))))))
(let ((anon11_Then_correct  (=> (state ExhaleHeap@0 ZeroMask) (=> (and (and (not (= r_1 null)) (= Mask@3 (MapType1Store ZeroMask r_1 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1 f_7)) FullPerm))))) (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm Mask@3 r_1 f_7)) (=> (HasDirectPerm Mask@3 r_1 f_7) (=> (and (and (< j@0 (U_2_int (MapType0Select ExhaleHeap@0 r_1 f_7))) (state ExhaleHeap@0 Mask@3)) (and (= j@1 (+ j@0 1)) (state ExhaleHeap@0 Mask@3))) (and (=> (= (ControlFlow 0 9) 6) anon12_Then_correct) (=> (= (ControlFlow 0 9) 8) anon12_Else_correct)))))))))
(let ((anon11_Else_correct  (=> (not (< j@0 (U_2_int (MapType0Select ExhaleHeap@0 r_1 f_7)))) (=> (and (state ExhaleHeap@0 Mask@1) (not (= r_1 null))) (=> (and (and (= Mask@4 (MapType1Store Mask@1 r_1 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@1 r_1 f_7)) FullPerm)))) (state ExhaleHeap@0 Mask@4)) (and (state ExhaleHeap@0 Mask@4) (state ExhaleHeap@0 Mask@4))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm Mask@4 r_1 f_7)) (=> (HasDirectPerm Mask@4 r_1 f_7) (=> (= (ControlFlow 0 3) (- 0 2)) (>= j@0 (U_2_int (MapType0Select ExhaleHeap@0 r_1 f_7)))))))))))
(let ((anon10_Then_correct true))
(let ((anon2_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 r_1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 r_1 f_7)) FullPerm)))) (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@1)) (and (and (=> (= (ControlFlow 0 11) 1) anon10_Then_correct) (=> (= (ControlFlow 0 11) 9) anon11_Then_correct)) (=> (= (ControlFlow 0 11) 3) anon11_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 14) 11)) anon2_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (U_2_real (MapType1Select Mask@0 r_1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 r_1 f_7))) (=> (= (ControlFlow 0 12) 11) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 r_1 $allocated)) (not (= r_1 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask r_1 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1 f_7)) FullPerm)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 15) 12) anon9_Then_correct) (=> (= (ControlFlow 0 15) 14) anon9_Else_correct)))))))
