...
(let ((anon40_correct  (=> (= Heap@13 (MapType0Store Heap@12 null (|List#sm| this@@38) (MapType1Store (MapType0Select Heap@12 null (|List#sm| this@@38)) this@@38 head (bool_2_U true)))) (=> (and (and (forall ((o_87 T@U) (f_91 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_91))))
(let ((A@@12 (FieldTypeInv0 (type f_91))))
 (=> (and (and (= (type o_87) RefType) (= (type f_91) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@13 null (|List#sm| this@@38)) o_87 f_91)) (U_2_bool (MapType1Select (MapType0Select Heap@13 null (|lseg#sm| (MapType0Select Heap@13 this@@38 head) null)) o_87 f_91)))) (U_2_bool (MapType1Select newPMask@2 o_87 f_91)))))
 :qid |stdinbpl.6342:27|
 :skolemid |192|
 :pattern ( (MapType1Select newPMask@2 o_87 f_91))
...
(let ((anon58_Then_correct  (=> (not (= (MapType0Select Heap@3 (MapType0Select Heap@3 (MapType0Select Heap@3 this@@38 head) next) next) null)) (=> (and (= UnfoldingHeap@0 (MapType0Store Heap@3 null (|lseg#sm| (MapType0Select Heap@3 (MapType0Select Heap@3 (MapType0Select Heap@3 this@@38 head) next) next) null) (MapType1Store (MapType0Select Heap@3 null (|lseg#sm| (MapType0Select Heap@3 (MapType0Select Heap@3 (MapType0Select Heap@3 this@@38 head) next) next) null)) (MapType0Select Heap@3 (MapType0Select Heap@3 (MapType0Select Heap@3 this@@38 head) next) next) data (bool_2_U true)))) (= UnfoldingHeap@1 (MapType0Store UnfoldingHeap@0 null (|lseg#sm| (MapType0Select UnfoldingHeap@0 (MapType0Select UnfoldingHeap@0 (MapType0Select UnfoldingHeap@0 this@@38 head) next) next) null) (MapType1Store (MapType0Select UnfoldingHeap@0 null (|lseg#sm| (MapType0Select UnfoldingHeap@0 (MapType0Select UnfoldingHeap@0 (MapType0Select UnfoldingHeap@0 this@@38 head) next) next) null)) (MapType0Select UnfoldingHeap@0 (MapType0Select UnfoldingHeap@0 (MapType0Select UnfoldingHeap@0 this@@38 head) next) next) next (bool_2_U true))))) (=> (and (and (forall ((o_85 T@U) (f_89 T@U) ) (! (let ((B@@13 (FieldTypeInv1 (type f_89))))
(let ((A@@14 (FieldTypeInv0 (type f_89))))
 (=> (and (and (= (type o_85) RefType) (= (type f_89) (FieldType A@@14 B@@13))) (or (U_2_bool (MapType1Select (MapType0Select UnfoldingHeap@1 null (|lseg#sm| (MapType0Select UnfoldingHeap@1 (MapType0Select UnfoldingHeap@1 (MapType0Select UnfoldingHeap@1 this@@38 head) next) next) null)) o_85 f_89)) (U_2_bool (MapType1Select (MapType0Select UnfoldingHeap@1 null (|lseg#sm| (MapType0Select UnfoldingHeap@1 (MapType0Select UnfoldingHeap@1 (MapType0Select UnfoldingHeap@1 (MapType0Select UnfoldingHeap@1 this@@38 head) next) next) next) null)) o_85 f_89)))) (U_2_bool (MapType1Select newPMask@0 o_85 f_89)))))
 :qid |stdinbpl.6262:37|
 :skolemid |190|
 :pattern ( (MapType1Select newPMask@0 o_85 f_89))
