...
(let ((anon32_Else_correct  (=> (state Heap@@17 Mask@0) (=> (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)) (and (=> (= (ControlFlow 0 57) 54) anon33_Then_correct) (=> (= (ControlFlow 0 57) 56) anon33_Else_correct))))))
