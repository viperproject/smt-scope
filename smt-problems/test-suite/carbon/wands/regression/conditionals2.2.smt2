...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type x@@8) RefType) (= (type WandDefLHSMask@0) (MapType0Type RefType realType))) (= (type WandDefLHSHeap@0) (MapType1Type RefType))) (= (type WandDefRHSMask@0) (MapType0Type RefType realType))) (= (type WandDefRHSHeap@0) (MapType1Type RefType))) (= (type WandDefRHSMask@1) (MapType0Type RefType realType))) (= (type ExhaleHeap@0) (MapType1Type RefType))) (= (type Mask@6) (MapType0Type RefType realType))) (= (type Mask@3) (MapType0Type RefType realType))) (= (type Mask@2) (MapType0Type RefType realType))) (= (type Heap@@9) (MapType1Type RefType))) (= (type Mask@4) (MapType0Type RefType realType))) (= (type Mask@5) (MapType0Type RefType realType))) (= (type Mask@1) (MapType0Type RefType realType))) (= (type Mask@0) (MapType0Type RefType realType))))
(set-info :boogie-vc-id test30)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon7_correct  (=> (state ExhaleHeap@0 Mask@6) (and (=> (= (ControlFlow 0 7) (- 0 8)) (= (U_2_real (MapType0Select Mask@6 x@@8 g)) FullPerm)) (=> (= (U_2_real (MapType0Select Mask@6 x@@8 g)) FullPerm) (=> (= (ControlFlow 0 7) (- 0 6)) (= (U_2_real (MapType0Select Mask@6 x@@8 h)) FullPerm)))))))
(let ((anon10_Else_correct  (=> (not (U_2_bool (MapType1Select ExhaleHeap@0 x@@8 f_7))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (= (U_2_real (MapType0Select Mask@6 x@@8 h)) FullPerm)) (=> (= (U_2_real (MapType0Select Mask@6 x@@8 h)) FullPerm) (=> (= (ControlFlow 0 11) 7) anon7_correct))))))
(let ((anon10_Then_correct  (=> (U_2_bool (MapType1Select ExhaleHeap@0 x@@8 f_7)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (= (U_2_real (MapType0Select Mask@6 x@@8 g)) FullPerm)) (=> (= (U_2_real (MapType0Select Mask@6 x@@8 g)) FullPerm) (=> (= (ControlFlow 0 9) 7) anon7_correct))))))
(let ((anon4_correct  (=> (and (= Mask@3 (MapType0Store Mask@2 x@@8 f_7 (real_2_U (- (U_2_real (MapType0Select Mask@2 x@@8 f_7)) FullPerm)))) (state Heap@@9 Mask@3)) (=> (and (and (not (= x@@8 null)) (= Mask@4 (MapType0Store Mask@3 x@@8 f_7 (real_2_U (+ (U_2_real (MapType0Select Mask@3 x@@8 f_7)) FullPerm))))) (and (state Heap@@9 Mask@4) (= perm@2 (ite (U_2_bool (MapType1Select Heap@@9 x@@8 f_7)) FullPerm NoPerm)))) (and (=> (= (ControlFlow 0 13) (- 0 16)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (and (and (=> (> perm@2 NoPerm) (not (= x@@8 null))) (= Mask@5 (MapType0Store Mask@4 x@@8 g (real_2_U (+ (U_2_real (MapType0Select Mask@4 x@@8 g)) perm@2))))) (and (state Heap@@9 Mask@5) (= perm@3 (ite (U_2_bool (MapType1Select Heap@@9 x@@8 f_7)) NoPerm FullPerm)))) (and (=> (= (ControlFlow 0 13) (- 0 15)) (>= perm@3 NoPerm)) (=> (>= perm@3 NoPerm) (=> (=> (> perm@3 NoPerm) (not (= x@@8 null))) (=> (and (= Mask@6 (MapType0Store Mask@5 x@@8 h (real_2_U (+ (U_2_real (MapType0Select Mask@5 x@@8 h)) perm@3)))) (state Heap@@9 Mask@6)) (=> (and (and (state Heap@@9 Mask@6) (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@6)) (and (state ExhaleHeap@0 Mask@6) (state ExhaleHeap@0 Mask@6))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm Mask@6 x@@8 f_7)) (=> (HasDirectPerm Mask@6 x@@8 f_7) (and (=> (= (ControlFlow 0 13) 9) anon10_Then_correct) (=> (= (ControlFlow 0 13) 11) anon10_Else_correct))))))))))))))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 19) 13)) anon4_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (<= FullPerm (U_2_real (MapType0Select Mask@2 x@@8 f_7)))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@2 x@@8 f_7))) (=> (= (ControlFlow 0 17) 13) anon4_correct))))))
(let ((anon8_Else_correct  (=> (= Mask@1 (MapType0Store Mask@0 null (wand_2 x@@8 FullPerm x@@8 FullPerm x@@8 x@@8 FullPerm NoPerm x@@8 x@@8 NoPerm FullPerm) (real_2_U (+ (U_2_real (MapType0Select Mask@0 null (wand_2 x@@8 FullPerm x@@8 FullPerm x@@8 x@@8 FullPerm NoPerm x@@8 x@@8 NoPerm FullPerm))) FullPerm)))) (=> (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (<= FullPerm (U_2_real (MapType0Select Mask@1 null (wand_2 x@@8 FullPerm x@@8 FullPerm x@@8 x@@8 FullPerm NoPerm x@@8 x@@8 NoPerm FullPerm))))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@1 null (wand_2 x@@8 FullPerm x@@8 FullPerm x@@8 x@@8 FullPerm NoPerm x@@8 x@@8 NoPerm FullPerm)))) (=> (and (= Mask@2 (MapType0Store Mask@1 null (wand_2 x@@8 FullPerm x@@8 FullPerm x@@8 x@@8 FullPerm NoPerm x@@8 x@@8 NoPerm FullPerm) (real_2_U (- (U_2_real (MapType0Select Mask@1 null (wand_2 x@@8 FullPerm x@@8 FullPerm x@@8 x@@8 FullPerm NoPerm x@@8 x@@8 NoPerm FullPerm))) FullPerm)))) (state Heap@@9 Mask@2)) (and (=> (= (ControlFlow 0 20) 17) anon9_Then_correct) (=> (= (ControlFlow 0 20) 19) anon9_Else_correct)))))))))
(let ((anon8_Then_correct  (=> (and (and (and (not (= x@@8 null)) (= WandDefLHSMask@0 (MapType0Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType0Select ZeroMask x@@8 f_7)) FullPerm))))) (and (state WandDefLHSHeap@0 WandDefLHSMask@0) (state WandDefLHSHeap@0 WandDefLHSMask@0))) (and (and (state WandDefLHSHeap@0 WandDefLHSMask@0) (not (= x@@8 null))) (and (= WandDefRHSMask@0 (MapType0Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType0Select ZeroMask x@@8 f_7)) FullPerm)))) (state WandDefRHSHeap@0 WandDefRHSMask@0)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm WandDefRHSMask@0 x@@8 f_7)) (=> (HasDirectPerm WandDefRHSMask@0 x@@8 f_7) (=> (= perm@0 (ite (U_2_bool (MapType1Select WandDefRHSHeap@0 x@@8 f_7)) FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= x@@8 null))) (=> (and (= WandDefRHSMask@1 (MapType0Store WandDefRHSMask@0 x@@8 g (real_2_U (+ (U_2_real (MapType0Select WandDefRHSMask@0 x@@8 g)) perm@0)))) (state WandDefRHSHeap@0 WandDefRHSMask@1)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm WandDefRHSMask@1 x@@8 f_7)) (=> (HasDirectPerm WandDefRHSMask@1 x@@8 f_7) (=> (and (= perm@1 (ite (U_2_bool (MapType1Select WandDefRHSHeap@0 x@@8 f_7)) NoPerm FullPerm)) (= (ControlFlow 0 2) (- 0 1))) (>= perm@1 NoPerm))))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType1Select Heap@@9 x@@8 $allocated))) (=> (and (and (not (= x@@8 null)) (= Mask@0 (MapType0Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType0Select ZeroMask x@@8 f_7)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 22) 2) anon8_Then_correct) (=> (= (ControlFlow 0 22) 20) anon8_Else_correct))))))
