...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= a_2@0 (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 1)) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 5))) (|Seq#Singleton| (int_2_U 7))) (|Seq#Singleton| (int_2_U 8)))) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Seq#Equal| (|Seq#Drop| a_2@0 (- 0 1)) a_2@0)) (=> (|Seq#Equal| (|Seq#Drop| a_2@0 (- 0 1)) a_2@0) (=> (and (and (state Heap@@9 ZeroMask) (< e1 (- 0 1))) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Seq#Equal| (|Seq#Drop| a_2@0 e1) a_2@0)) (=> (|Seq#Equal| (|Seq#Drop| a_2@0 e1) a_2@0) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Seq#Equal| (|Seq#Drop| a_2@0 6) (|Seq#Empty| intType))) (=> (|Seq#Equal| (|Seq#Drop| a_2@0 6) (|Seq#Empty| intType)) (=> (state Heap@@9 ZeroMask) (=> (and (and (< 6 e2) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (|Seq#Equal| (|Seq#Drop| a_2@0 e2) (|Seq#Empty| intType))))))))))))))))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (= a_2@0 (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 1)) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 5))) (|Seq#Singleton| (int_2_U 7))) (|Seq#Singleton| (int_2_U 8))))) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (|Seq#Equal| (|Seq#Drop| (|Seq#Take| a_2@0 1) (- 0 1)) (|Seq#Drop| (|Seq#Take| a_2@0 1) 0)))))
