...
(declare-fun fourAnd (T@U Bool Bool Bool Bool) Bool)
...
(declare-fun |fourAnd#frame| (T@U Bool Bool Bool Bool) Bool)
...
(assert (forall ((Heap T@U) (a_2 Bool) (b_2 Bool) (c Bool) (d Bool) ) (!  (=> (= (type Heap) (MapType0Type RefType)) (and (= (fourAnd Heap a_2 b_2 c d) (|fourAnd'| Heap a_2 b_2 c d)) (dummyFunction (bool_2_U (|fourAnd#triggerStateless| a_2 b_2 c d)))))
 :qid |stdinbpl.185:15|
 :skolemid |22|
 :pattern ( (fourAnd Heap a_2 b_2 c d))
)))
...
(assert (forall ((Heap@@0 T@U) (Mask T@U) ) (!  (=> (and (and (= (type Heap@@0) (MapType0Type RefType)) (= (type Mask) (MapType1Type RefType realType))) (state Heap@@0 Mask)) (GoodMask Mask))
 :qid |stdinbpl.124:15|
 :skolemid |15|
...
(assert (forall ((Heap@@6 T@U) (Mask@@5 T@U) (a_2@@0 Bool) (b_2@@0 Bool) (c@@0 Bool) (d@@0 Bool) ) (!  (=> (and (and (= (type Heap@@6) (MapType0Type RefType)) (= (type Mask@@5) (MapType1Type RefType realType))) (and (state Heap@@6 Mask@@5) (< AssumeFunctionsAbove 0))) (= (fourAnd Heap@@6 a_2@@0 b_2@@0 c@@0 d@@0)  (and a_2@@0 (and b_2@@0 (and c@@0 d@@0)))))
 :qid |stdinbpl.195:15|
 :skolemid |24|
 :pattern ( (state Heap@@6 Mask@@5) (fourAnd Heap@@6 a_2@@0 b_2@@0 c@@0 d@@0))
)))
...
(assert (forall ((Heap@@7 T@U) (a_2@@1 Bool) (b_2@@1 Bool) (c@@1 Bool) (d@@1 Bool) ) (!  (=> (= (type Heap@@7) (MapType0Type RefType)) (dummyFunction (bool_2_U (|fourAnd#triggerStateless| a_2@@1 b_2@@1 c@@1 d@@1))))
 :qid |stdinbpl.189:15|
 :skolemid |23|
 :pattern ( (|fourAnd'| Heap@@7 a_2@@1 b_2@@1 c@@1 d@@1))
)))
...
(assert (forall ((Heap@@8 T@U) (Mask@@7 T@U) (a_2@@2 Bool) (b_2@@2 Bool) (c@@2 Bool) (d@@2 Bool) ) (!  (=> (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (state Heap@@8 Mask@@7)) (= (|fourAnd'| Heap@@8 a_2@@2 b_2@@2 c@@2 d@@2) (|fourAnd#frame| EmptyFrame a_2@@2 b_2@@2 c@@2 d@@2)))
 :qid |stdinbpl.202:15|
 :skolemid |25|
 :pattern ( (state Heap@@8 Mask@@7) (|fourAnd'| Heap@@8 a_2@@2 b_2@@2 c@@2 d@@2))
)))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon9_Else_correct  (=> (= r_1@2 (fourAnd Heap@@13 false false false false)) (=> (and (state Heap@@13 ZeroMask) (= (ControlFlow 0 5) (- 0 4))) (not r_1@2)))))
(let ((anon9_Then_correct true))
(let ((anon8_Else_correct  (=> (and (= r_1@1 (fourAnd Heap@@13 false false false false)) (state Heap@@13 ZeroMask)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (not r_1@1)) (=> (not r_1@1) (=> (state Heap@@13 ZeroMask) (and (=> (= (ControlFlow 0 6) 3) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct))))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (=> (and (= r_1@0 (fourAnd Heap@@13 true true true true)) (state Heap@@13 ZeroMask)) (and (=> (= (ControlFlow 0 8) (- 0 9)) r_1@0) (=> r_1@0 (=> (state Heap@@13 ZeroMask) (and (=> (= (ControlFlow 0 8) 2) anon8_Then_correct) (=> (= (ControlFlow 0 8) 6) anon8_Else_correct))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (state Heap@@13 ZeroMask) (state Heap@@13 ZeroMask))) (and (=> (= (ControlFlow 0 10) 1) anon7_Then_correct) (=> (= (ControlFlow 0 10) 8) anon7_Else_correct)))))
