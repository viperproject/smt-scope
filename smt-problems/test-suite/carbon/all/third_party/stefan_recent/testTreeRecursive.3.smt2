...
(let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (>= current_thread_id 0) (state Heap@@15 ZeroMask))) (and (=> (= (ControlFlow 0 29) 2) anon15_Then_correct) (=> (= (ControlFlow 0 29) 24) anon15_Else_correct)))))
