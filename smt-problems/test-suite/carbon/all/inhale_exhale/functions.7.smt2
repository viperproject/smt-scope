...
(let ((anon0_correct  (=> (state Heap@@64 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@64 this@@54 $allocated)) (= AssumeFunctionsAbove 2)) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
