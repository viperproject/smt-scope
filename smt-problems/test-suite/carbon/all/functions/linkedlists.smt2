...
(set-info :boogie-vc-id |tail#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon6_correct true))
(let ((anon9_Else_correct  (=> (= (MapType0Select Heap@1 xs@@42 next) null) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 3) 1)) anon6_correct))))
(let ((anon9_Then_correct  (=> (not (= (MapType0Select Heap@1 xs@@42 next) null)) (=> (and (and (forall ((o_6 T@U) (f_10 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_10))))
(let ((A@@12 (FieldTypeInv0 (type f_10))))
 (=> (and (and (= (type o_6) RefType) (= (type f_10) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|list#sm| xs@@42)) o_6 f_10)) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|list#sm| (MapType0Select Heap@1 xs@@42 next))) o_6 f_10)))) (U_2_bool (MapType1Select newPMask@0 o_6 f_10)))))
 :qid |stdinbpl.1065:33|
 :skolemid |78|
 :pattern ( (MapType1Select newPMask@0 o_6 f_10))
)) (= Heap@2 (MapType0Store Heap@1 null (|list#sm| xs@@42) newPMask@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 2) 1))) anon6_correct))))
(let ((anon4_correct  (=> (state Heap@@47 UnfoldingMask@4) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm UnfoldingMask@4 xs@@42 next)) (=> (HasDirectPerm UnfoldingMask@4 xs@@42 next) (=> (and (= Heap@0 (MapType0Store Heap@@47 null (|list#sm| xs@@42) (MapType1Store (MapType0Select Heap@@47 null (|list#sm| xs@@42)) xs@@42 next (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|list#sm| xs@@42) (MapType1Store (MapType0Select Heap@0 null (|list#sm| xs@@42)) xs@@42 val (bool_2_U true))))) (and (=> (= (ControlFlow 0 4) 2) anon9_Then_correct) (=> (= (ControlFlow 0 4) 3) anon9_Else_correct))))))))
(let ((anon8_Else_correct  (=> (= (MapType0Select Heap@@47 xs@@42 next) null) (=> (and (= UnfoldingMask@4 UnfoldingMask@2) (= (ControlFlow 0 7) 4)) anon4_correct))))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon13_correct  (=> (and (= ExhaleWellDef0Mask@0 (MapType1Store Mask@5 null (list (MapType0Select Heap@1 xs@@42 next)) (real_2_U (- (U_2_real (MapType1Select Mask@5 null (list (MapType0Select Heap@1 xs@@42 next)))) FullPerm)))) (= (ControlFlow 0 9) (- 0 8))) (not (= (MapType0Select Heap@1 xs@@42 next) null)))))
(let ((anon21_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon13_correct)))
(let ((anon21_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@5 null (list (MapType0Select Heap@1 xs@@42 next)))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@5 null (list (MapType0Select Heap@1 xs@@42 next))))) (=> (= (ControlFlow 0 10) 9) anon13_correct))))))
(let ((anon20_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (ascending Heap@1 (MapType0Select Heap@1 xs@@42 next)))))
(let ((anon10_correct  (=> (and (state Heap@1 Mask@5) (state Heap@1 Mask@5)) (and (=> (= (ControlFlow 0 13) (- 0 15)) (HasDirectPerm Mask@5 xs@@42 next)) (=> (HasDirectPerm Mask@5 xs@@42 next) (=> (not (= (MapType0Select Heap@1 xs@@42 next) null)) (=> (and (state Heap@1 Mask@5) (state Heap@1 Mask@5)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm Mask@5 xs@@42 next)) (=> (HasDirectPerm Mask@5 xs@@42 next) (and (and (=> (= (ControlFlow 0 13) 7) anon20_Else_correct) (=> (= (ControlFlow 0 13) 10) anon21_Then_correct)) (=> (= (ControlFlow 0 13) 12) anon21_Else_correct)))))))))))
(let ((anon19_Else_correct  (=> (= (MapType0Select Heap@1 xs@@42 next) null) (=> (and (= Mask@5 Mask@3) (= (ControlFlow 0 17) 13)) anon10_correct))))
(let ((anon19_Then_correct  (=> (not (= (MapType0Select Heap@1 xs@@42 next) null)) (=> (and (= Mask@4 (MapType1Store Mask@3 null (list (MapType0Select Heap@1 xs@@42 next)) (real_2_U (+ (U_2_real (MapType1Select Mask@3 null (list (MapType0Select Heap@1 xs@@42 next)))) FullPerm)))) (InsidePredicate (list xs@@42) (MapType0Select Heap@1 null (list xs@@42)) (list (MapType0Select Heap@1 xs@@42 next)) (MapType0Select Heap@1 null (list (MapType0Select Heap@1 xs@@42 next))))) (=> (and (and (state Heap@1 Mask@4) (not (= (MapType0Select Heap@1 xs@@42 next) null))) (and (= Mask@5 Mask@4) (= (ControlFlow 0 16) 13))) anon10_correct)))))
(let ((anon8_correct  (=> (and (not (= xs@@42 null)) (= Mask@2 (MapType1Store Mask@1 xs@@42 next (real_2_U (+ (U_2_real (MapType1Select Mask@1 xs@@42 next)) FullPerm))))) (=> (and (and (state Heap@1 Mask@2) (not (= xs@@42 null))) (and (= Mask@3 (MapType1Store Mask@2 xs@@42 val (real_2_U (+ (U_2_real (MapType1Select Mask@2 xs@@42 val)) FullPerm)))) (state Heap@1 Mask@3))) (and (=> (= (ControlFlow 0 18) 16) anon19_Then_correct) (=> (= (ControlFlow 0 18) 17) anon19_Else_correct))))))
(let ((anon18_Else_correct  (=> (HasDirectPerm Mask@1 null (list xs@@42)) (=> (and (= Heap@1 Heap@@47) (= (ControlFlow 0 20) 18)) anon8_correct))))
(let ((anon18_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (list xs@@42))) (= Heap@0 (MapType0Store Heap@@47 null (list xs@@42) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 19) 18))) anon8_correct)))
(let ((anon6_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (list xs@@42) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (list xs@@42))) FullPerm)))) (and (=> (= (ControlFlow 0 21) 19) anon18_Then_correct) (=> (= (ControlFlow 0 21) 20) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 24) 21)) anon6_correct)))
(let ((anon17_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@42))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@42)))) (=> (= (ControlFlow 0 22) 21) anon6_correct))))))
(let ((anon15_Else_correct  (=> (and (and (ascending Heap@@47 xs@@42) (state Heap@@47 Mask@0)) (and (|list#trigger| Heap@@47 (list xs@@42)) (= (MapType0Select Heap@@47 null (list xs@@42)) (CombineFrames (FrameFragment (MapType0Select Heap@@47 xs@@42 next)) (CombineFrames (FrameFragment (MapType0Select Heap@@47 xs@@42 val)) (FrameFragment (ite (not (= (MapType0Select Heap@@47 xs@@42 next) null)) (MapType0Select Heap@@47 null (list (MapType0Select Heap@@47 xs@@42 next))) EmptyFrame))))))) (and (=> (= (ControlFlow 0 25) 22) anon17_Then_correct) (=> (= (ControlFlow 0 25) 24) anon17_Else_correct)))))
(let ((anon3_correct  (=> (and (= Mask@6 (MapType1Store Mask@0 null (list xs@@42) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (list xs@@42))) FullPerm)))) (= (ControlFlow 0 2) (- 0 1))) (not (= xs@@42 null)))))
(let ((anon16_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon3_correct)))
(let ((anon16_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@42))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@42)))) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))
(let ((anon0_correct  (=> (state Heap@@47 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@47 xs@@42 $allocated))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (list xs@@42) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (list xs@@42))) FullPerm)))) (state Heap@@47 Mask@0)) (and (not (= xs@@42 null)) (state Heap@@47 Mask@0))) (and (and (=> (= (ControlFlow 0 26) 25) anon15_Else_correct) (=> (= (ControlFlow 0 26) 3) anon16_Then_correct)) (=> (= (ControlFlow 0 26) 5) anon16_Else_correct)))))))
