...
(assert  (and (and (= (type this@@54) RefType) (= (type Heap@@64) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |exhaleTrue3#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon3_Then_correct  (=> (not (= this@@54 null)) (=> (and (state Heap@@64 Mask@0) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm Mask@0 this@@54 x@@8)))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@64 ZeroMask) (U_2_bool (MapType0Select Heap@@64 this@@54 $allocated))) (and (= AssumeFunctionsAbove 9) (not (= this@@54 null)))) (and (and (= Mask@0 (MapType1Store ZeroMask this@@54 x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@54 x@@8)) FullPerm)))) (state Heap@@64 Mask@0)) (and (state Heap@@64 Mask@0) (= (ControlFlow 0 3) 2)))) anon3_Then_correct)))
...
(declare-fun this@@54 () T@U)
(declare-fun Heap@@64 () T@U)
(assert  (and (and (and (= (type Heap@@64) (MapType0Type RefType)) (= (type this@@54) RefType)) (= (type ExhaleWellDef0Mask@0) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id exhaleExpression1WithRequiresMethod)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon3_correct  (=> (and (= ExhaleWellDef0Mask@0 (MapType1Store Mask@0 this@@54 x@@8 (real_2_U (- (U_2_real (MapType1Select Mask@0 this@@54 x@@8)) FullPerm)))) (= (ControlFlow 0 4) (- 0 3))) (= (U_2_int (MapType0Select Heap@@64 this@@54 x@@8)) 1))))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 4)) anon3_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@0 this@@54 x@@8)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 this@@54 x@@8))) (=> (= (ControlFlow 0 5) 4) anon3_correct))))))
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= (exhaleExpression1WithRequires Heap@@64 this@@54) 1))))
(let ((anon0_correct  (=> (and (state Heap@@64 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@64 this@@54 $allocated)) (not (= this@@54 null))) (and (= Mask@0 (MapType1Store ZeroMask this@@54 x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@54 x@@8)) FullPerm)))) (state Heap@@64 Mask@0))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm Mask@0 this@@54 x@@8)) (=> (HasDirectPerm Mask@0 this@@54 x@@8) (=> (and (= (U_2_int (MapType0Select Heap@@64 this@@54 x@@8)) 1) (state Heap@@64 Mask@0)) (and (and (=> (= (ControlFlow 0 8) 2) anon5_Else_correct) (=> (= (ControlFlow 0 8) 5) anon6_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))))))
