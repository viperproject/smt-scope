...
(assert  (and (and (= (type xs@@15) (SeqType RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@18) (MapType0Type RefType))))
(set-info :boogie-vc-id |fun1#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i_6))) (= (ControlFlow 0 16) 12)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i_6)) (and (=> (= (ControlFlow 0 13) (- 0 15)) (>= i_6 0)) (=> (>= i_6 0) (and (=> (= (ControlFlow 0 13) (- 0 14)) (< i_6 (|Seq#Length| xs@@15))) (=> (< i_6 (|Seq#Length| xs@@15)) (=> (= (ControlFlow 0 13) 12) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (forall ((i_4 Int) (i_4_1 Int) ) (!  (=> (and (and (and (and (not (= i_4 i_4_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i_4))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@15 i_4) (|Seq#Index| xs@@15 i_4_1))))
 :qid |stdinbpl.701:15|
 :skolemid |65|
 ...
 :qid |stdinbpl.701:15|
 :skolemid |65|
)) (=> (forall ((i_4@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i_4@@1)) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index| xs@@15 i_4@@1)) (= (invRecv1 (|Seq#Index| xs@@15 i_4@@1)) i_4@@1)))
 :qid |stdinbpl.707:22|
 :skolemid |66|
 ...
 :pattern ( (|Seq#Index| xs@@15 i_4@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (|Seq#Index| xs@@15 (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.711:22|
 :skolemid |67|
 :pattern ( (invRecv1 o_3))
)) (forall ((i_4@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i_4@@2)) (not (= (|Seq#Index| xs@@15 i_4@@2) null)))
 :qid |stdinbpl.717:22|
 :skolemid |68|
 ...
 :pattern ( (|Seq#Index| xs@@15 i_4@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| xs@@15 (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.723:22|
 :skolemid |69|
...
))) (and (state Heap@@18 QPMask@0) (state Heap@@18 QPMask@0))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< 0 (|Seq#Length| xs@@15))) (=> (< 0 (|Seq#Length| xs@@15)) (=> (= (ControlFlow 0 9) (- 0 8)) (HasDirectPerm QPMask@0 (|Seq#Index| xs@@15 0) f_7)))))))))))
(let ((anon9_Else_correct  (=> (and (forall ((i1_3 Int) (i2_3 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i1_3)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i2_3)) (not (= i1_3 i2_3)))) (not (= (|Seq#Index| xs@@15 i1_3) (|Seq#Index| xs@@15 i2_3))))
 :qid |stdinbpl.683:20|
 :skolemid |64|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i1_3)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i2_3)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i1_3)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i2_3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i1_3)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i2_3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i1_3)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i2_3)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i1_3)) (|Seq#Index| xs@@15 i2_3))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i1_3)) (|Seq#Index| xs@@15 i2_3))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i2_3)) (|Seq#Index| xs@@15 i1_3))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i2_3)) (|Seq#Index| xs@@15 i1_3))
 :pattern ( (|Seq#Index| xs@@15 i1_3) (|Seq#Index| xs@@15 i2_3))
)) (state Heap@@18 ZeroMask)) (and (and (=> (= (ControlFlow 0 17) 9) anon11_Else_correct) (=> (= (ControlFlow 0 17) 13) anon12_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon12_Else_correct)))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i1_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i2_1)) (not (= i1_1 i2_1))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i1_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@15)) (int_2_U i2_1)) (not (= i1_1 i2_1)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_1 0)) (=> (>= i1_1 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_1 (|Seq#Length| xs@@15))) (=> (< i1_1 (|Seq#Length| xs@@15)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_1 0)) (=> (>= i2_1 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_1 (|Seq#Length| xs@@15))) (=> (< i2_1 (|Seq#Length| xs@@15)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@18 ZeroMask) (= AssumeFunctionsAbove 0)) (and (< 5 (|Seq#Length| xs@@15)) (state Heap@@18 ZeroMask))) (and (and (=> (= (ControlFlow 0 18) 17) anon9_Else_correct) (=> (= (ControlFlow 0 18) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 18) 7) anon10_Else_correct)))))
