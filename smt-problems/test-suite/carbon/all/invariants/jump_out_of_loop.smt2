...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (Ctor RefType) 8)) (= (type g) (FieldType NormalFieldType RefType))))
...
(assert  (and (and (and (and (and (and (and (= (type Heap@0) (MapType0Type RefType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type x@@8) RefType)) (= (type Heap@@17) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type LoopSumHeap@0) (MapType0Type RefType))) (= (type LoopSumMask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id m)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon11_Else_correct true))
(let ((l_correct  (=> (and (and (state Heap@0 Mask@2) (= c@0 5)) (and (state Heap@0 Mask@2) (state Heap@0 Mask@2))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= (U_2_real (MapType1Select Mask@2 x@@8 g)) (+ (/ (to_real 1) (to_real 2)) (/ (to_real 1) (to_real 3))))) (=> (= (U_2_real (MapType1Select Mask@2 x@@8 g)) (+ (/ (to_real 1) (to_real 2)) (/ (to_real 1) (to_real 3)))) (=> (and (state Heap@0 Mask@2) (= (ControlFlow 0 3) (- 0 2))) false))))))
(let ((anon11_Then_correct  (=> (and (= c@0 5) (= perm@1 (/ (to_real 1) (to_real 3)))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (=> (> perm@1 NoPerm) (not (= x@@8 null))) (=> (and (= Mask@1 (MapType1Store ZeroMask x@@8 g (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 g)) perm@1)))) (state Heap@@17 Mask@1)) (=> (and (and (and (state Heap@@17 Mask@1) (state Heap@@17 Mask@1)) (and (SumHeap LoopSumHeap@0 Heap@@17 Mask@1 Heap@@17 Mask@0) (sumMask LoopSumMask@0 Mask@1 Mask@0))) (and (and (state LoopSumHeap@0 LoopSumMask@0) (= Mask@2 LoopSumMask@0)) (and (= Heap@0 LoopSumHeap@0) (= (ControlFlow 0 6) 3)))) l_correct))))))))
(let ((anon10_Then_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and (state Heap@@17 ZeroMask) (> c@0 0)) (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 9) 6) anon11_Then_correct) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct))))))
(let ((anon10_Else_correct  (=> (not (> c@0 0)) (=> (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)) (=> (and (and (state Heap@@17 Mask@0) (= Mask@2 Mask@0)) (and (= Heap@0 Heap@@17) (= (ControlFlow 0 5) 3))) l_correct)))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) (U_2_bool (MapType0Select Heap@@17 x@@8 $allocated))) (and (state Heap@@17 ZeroMask) (= perm@0 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= x@@8 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask x@@8 g (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 g)) perm@0)))) (state Heap@@17 Mask@0)) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0))) (and (and (=> (= (ControlFlow 0 10) 1) anon9_Then_correct) (=> (= (ControlFlow 0 10) 9) anon10_Then_correct)) (=> (= (ControlFlow 0 10) 5) anon10_Else_correct)))))))))
