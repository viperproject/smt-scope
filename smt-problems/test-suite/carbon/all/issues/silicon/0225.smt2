...
(declare-fun j_1 () Int)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type y@@5) RefType)) (= (type Result_1Heap) (MapType0Type RefType))) (= (type Result_1Mask) (MapType1Type RefType realType))) (= (type Used_3Mask@3) (MapType1Type RefType realType))) (= (type Ops_3Mask@3) (MapType1Type RefType realType))) (= (type Ops_3Heap@0) (MapType0Type RefType))) (= (type Used_3Heap@0) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Used_3Mask@1) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@@18) (MapType0Type RefType))) (= (type Used_3Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Ops_3Mask@1) (MapType1Type RefType realType))) (= (type Used_3Mask@0) (MapType1Type RefType realType))) (= (type Ops_3Mask@2) (MapType1Type RefType realType))) (= (type Ops_3Mask@0) (MapType1Type RefType realType))) (= (type Used_2Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 41) (let ((anon28_correct true))
(let ((anon47_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 17) 14)) anon28_correct)))
(let ((anon47_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= FullPerm (U_2_real (MapType1Select Result_1Mask y@@5 v_2)))) (=> (<= FullPerm (U_2_real (MapType1Select Result_1Mask y@@5 v_2))) (=> (= (ControlFlow 0 15) 14) anon28_correct))))))
(let ((anon29_correct true))
(let ((anon45_Then_correct  (=> (> j_2 0) (and (and (=> (= (ControlFlow 0 18) 12) anon29_correct) (=> (= (ControlFlow 0 18) 15) anon47_Then_correct)) (=> (= (ControlFlow 0 18) 17) anon47_Else_correct)))))
(let ((anon45_Else_correct  (=> (and (>= 0 j_2) (= (ControlFlow 0 13) 12)) anon29_correct)))
(let ((anon30_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (=> (and (and b_5@6 b_5@6) b_6@6) (forall ((j_5 Int) ) (!  (=> (> j_5 0) (= (f2 Result_1Heap y@@5 j_5) j_5))
 :qid |stdinbpl.771:39|
 :skolemid |48|
 :pattern ( (|f2#frame| (FrameFragment (MapType0Select Result_1Heap y@@5 v_2)) y@@5 j_5))
))))))
(let ((anon43_Then_correct  (=> b_5@6 (and (and (=> (= (ControlFlow 0 19) 9) anon30_correct) (=> (= (ControlFlow 0 19) 18) anon45_Then_correct)) (=> (= (ControlFlow 0 19) 13) anon45_Else_correct)))))
(let ((anon43_Else_correct  (=> (and (not b_5@6) (= (ControlFlow 0 11) 9)) anon30_correct)))
(let ((anon42_Then_correct  (=> (and (and b_5@6 b_5@6) b_6@6) (and (=> (= (ControlFlow 0 20) 19) anon43_Then_correct) (=> (= (ControlFlow 0 20) 11) anon43_Else_correct)))))
(let ((anon42_Else_correct  (=> (and (not (and (and b_5@6 b_5@6) b_6@6)) (= (ControlFlow 0 10) 9)) anon30_correct)))
(let ((anon21_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (=> (and (and b_5@5 b_5@5) b_6@6) (and (= neededTransfer@3 0.0) (= (U_2_real (MapType1Select Used_3Mask@3 y@@5 v_2)) initNeededTransfer@0)))) (=> (=> (and (and b_5@5 b_5@5) b_6@6) (and (= neededTransfer@3 0.0) (= (U_2_real (MapType1Select Used_3Mask@3 y@@5 v_2)) initNeededTransfer@0))) (=> (and (= b_7@0  (and b_5@5 b_6@6)) (= b_7@1  (and b_7@0 (state Result_1Heap Result_1Mask)))) (=> (and (and (= b_7@2  (and b_7@1 (sumMask Result_1Mask Ops_3Mask@3 Used_3Mask@3))) (= b_7@3  (and (and b_7@2 (IdenticalOnKnownLocations Ops_3Heap@0 Result_1Heap Ops_3Mask@3)) (IdenticalOnKnownLocations Used_3Heap@0 Result_1Heap Used_3Mask@3)))) (and (= b_7@4  (and b_7@3 (state Result_1Heap Result_1Mask))) (= b_5@6  (and b_5@5 b_7@4)))) (and (=> (= (ControlFlow 0 21) 20) anon42_Then_correct) (=> (= (ControlFlow 0 21) 10) anon42_Else_correct))))))))
(let ((anon41_Else_correct  (=> (>= 0.0 takeTransfer@1) (=> (and (= Mask@2 Mask@0) (= neededTransfer@3 neededTransfer@1)) (=> (and (and (= b_6@6 b_6@3) (= Used_3Mask@3 Used_3Mask@1)) (and (= Heap@1 Heap@@18) (= (ControlFlow 0 25) 21))) anon21_correct)))))
(let ((anon41_Then_correct  (=> (> takeTransfer@1 0.0) (=> (and (and (= neededTransfer@2 (- neededTransfer@1 takeTransfer@1)) (= Used_3Mask@2 (MapType1Store Used_3Mask@1 y@@5 v_2 (real_2_U (+ (U_2_real (MapType1Select Used_3Mask@1 y@@5 v_2)) takeTransfer@1))))) (and (= b_6@4  (and b_6@3 (state Used_3Heap@0 Used_3Mask@2))) (= b_6@5  (and b_6@4 (= (U_2_int (MapType0Select Heap@@18 y@@5 v_2)) (U_2_int (MapType0Select Used_3Heap@0 y@@5 v_2))))))) (=> (and (and (and (= Mask@1 (MapType1Store Mask@0 y@@5 v_2 (real_2_U (- (U_2_real (MapType1Select Mask@0 y@@5 v_2)) takeTransfer@1)))) (= Heap@0 (MapType0Store Heap@@18 null (|wand_1#sm| y@@5 FullPerm y@@5 FullPerm 0 y@@5) (MapType1Store (MapType0Select Heap@@18 null (|wand_1#sm| y@@5 FullPerm y@@5 FullPerm 0 y@@5)) y@@5 v_2 (bool_2_U true))))) (and (= Mask@2 Mask@1) (= neededTransfer@3 neededTransfer@2))) (and (and (= b_6@6 b_6@5) (= Used_3Mask@3 Used_3Mask@2)) (and (= Heap@1 Heap@0) (= (ControlFlow 0 24) 21)))) anon21_correct)))))
(let ((anon40_Else_correct  (=> (and (< maskTransfer@1 neededTransfer@1) (= takeTransfer@1 maskTransfer@1)) (and (=> (= (ControlFlow 0 27) 24) anon41_Then_correct) (=> (= (ControlFlow 0 27) 25) anon41_Else_correct)))))
(let ((anon40_Then_correct  (=> (and (<= neededTransfer@1 maskTransfer@1) (= takeTransfer@1 neededTransfer@1)) (and (=> (= (ControlFlow 0 26) 24) anon41_Then_correct) (=> (= (ControlFlow 0 26) 25) anon41_Else_correct)))))
(let ((anon39_Then_correct  (=> (and (and (and (and (and b_5@5 b_5@5) b_6@3) true) (> neededTransfer@1 0.0)) (= maskTransfer@1 (U_2_real (MapType1Select Mask@0 y@@5 v_2)))) (and (=> (= (ControlFlow 0 28) 26) anon40_Then_correct) (=> (= (ControlFlow 0 28) 27) anon40_Else_correct)))))
(let ((anon39_Else_correct  (=> (not (and (and (and (and b_5@5 b_5@5) b_6@3) true) (> neededTransfer@1 0.0))) (=> (and (= Mask@2 Mask@0) (= neededTransfer@3 neededTransfer@1)) (=> (and (and (= b_6@6 b_6@3) (= Used_3Mask@3 Used_3Mask@1)) (and (= Heap@1 Heap@@18) (= (ControlFlow 0 23) 21))) anon21_correct)))))
(let ((anon38_Else_correct  (=> (>= 0.0 takeTransfer@0) (=> (and (and (= Ops_3Mask@3 Ops_3Mask@1) (= Used_3Mask@1 ZeroMask)) (and (= b_6@3 b_6@0) (= neededTransfer@1 FullPerm))) (and (=> (= (ControlFlow 0 31) 28) anon39_Then_correct) (=> (= (ControlFlow 0 31) 23) anon39_Else_correct))))))
(let ((anon38_Then_correct  (=> (and (> takeTransfer@0 0.0) (= neededTransfer@0 (- FullPerm takeTransfer@0))) (=> (and (and (and (= Used_3Mask@0 (MapType1Store ZeroMask y@@5 v_2 (real_2_U (+ (U_2_real (MapType1Select ZeroMask y@@5 v_2)) takeTransfer@0)))) (= b_6@1  (and b_6@0 (state Used_3Heap@0 Used_3Mask@0)))) (and (= b_6@2  (and b_6@1 (= (U_2_int (MapType0Select Ops_3Heap@0 y@@5 v_2)) (U_2_int (MapType0Select Used_3Heap@0 y@@5 v_2))))) (= Ops_3Mask@2 (MapType1Store Ops_3Mask@1 y@@5 v_2 (real_2_U (- (U_2_real (MapType1Select Ops_3Mask@1 y@@5 v_2)) takeTransfer@0)))))) (and (and (= Ops_3Mask@3 Ops_3Mask@2) (= Used_3Mask@1 Used_3Mask@0)) (and (= b_6@3 b_6@2) (= neededTransfer@1 neededTransfer@0)))) (and (=> (= (ControlFlow 0 30) 28) anon39_Then_correct) (=> (= (ControlFlow 0 30) 23) anon39_Else_correct))))))
(let ((anon37_Else_correct  (=> (and (< maskTransfer@0 FullPerm) (= takeTransfer@0 maskTransfer@0)) (and (=> (= (ControlFlow 0 33) 30) anon38_Then_correct) (=> (= (ControlFlow 0 33) 31) anon38_Else_correct)))))
(let ((anon37_Then_correct  (=> (and (<= FullPerm maskTransfer@0) (= takeTransfer@0 FullPerm)) (and (=> (= (ControlFlow 0 32) 30) anon38_Then_correct) (=> (= (ControlFlow 0 32) 31) anon38_Else_correct)))))
(let ((anon36_Then_correct  (=> (and (and (and (and (and b_5@5 b_5@5) b_6@0) true) (> FullPerm 0.0)) (= maskTransfer@0 (U_2_real (MapType1Select Ops_3Mask@1 y@@5 v_2)))) (and (=> (= (ControlFlow 0 34) 32) anon37_Then_correct) (=> (= (ControlFlow 0 34) 33) anon37_Else_correct)))))
(let ((anon36_Else_correct  (=> (not (and (and (and (and b_5@5 b_5@5) b_6@0) true) (> FullPerm 0.0))) (=> (and (and (= Ops_3Mask@3 Ops_3Mask@1) (= Used_3Mask@1 ZeroMask)) (and (= b_6@3 b_6@0) (= neededTransfer@1 FullPerm))) (and (=> (= (ControlFlow 0 29) 28) anon39_Then_correct) (=> (= (ControlFlow 0 29) 23) anon39_Else_correct))))))
(let ((anon9_correct  (=> (and (and (= b_5@4  (and b_5@3 (state Ops_3Heap@0 Ops_3Mask@1))) (= b_5@5  (and b_5@4 (state Ops_3Heap@0 Ops_3Mask@1)))) (and (= b_6@0  (and b_6 (state Used_3Heap@0 ZeroMask))) (= initNeededTransfer@0 (+ (U_2_real (MapType1Select ZeroMask y@@5 v_2)) FullPerm)))) (and (=> (= (ControlFlow 0 35) (- 0 36)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 35) 34) anon36_Then_correct) (=> (= (ControlFlow 0 35) 29) anon36_Else_correct)))))))
(let ((anon35_Else_correct  (=> (and (and (not b_5@0) (= Ops_3Mask@1 ZeroMask)) (and (= b_5@3 b_5@0) (= (ControlFlow 0 38) 35))) anon9_correct)))
(let ((anon35_Then_correct  (=> b_5@0 (=> (and (= b_5@1  (and b_5@0 (not (= y@@5 null)))) (= Ops_3Mask@0 (MapType1Store ZeroMask y@@5 v_2 (real_2_U (+ (U_2_real (MapType1Select ZeroMask y@@5 v_2)) FullPerm))))) (=> (and (and (= b_5@2  (and b_5@1 (state Ops_3Heap@0 Ops_3Mask@0))) (= Ops_3Mask@1 Ops_3Mask@0)) (and (= b_5@3 b_5@2) (= (ControlFlow 0 37) 35))) anon9_correct)))))
(let ((anon31_Else_correct  (=> (and (and (forall ((j_1_1 Int) ) (!  (=> (> j_1_1 0) (= (f2 Heap@@18 y@@5 j_1_1) j_1_1))
 :qid |stdinbpl.644:20|
 :skolemid |47|
 :pattern ( (|f2#frame| (FrameFragment (MapType0Select Heap@@18 y@@5 v_2)) y@@5 j_1_1))
)) (state Heap@@18 Mask@0)) (and (= b_5@0  (and b_5 (state Ops_3Heap@0 ZeroMask))) (= b_4@0  (and b_4 (state Used_2Heap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 39) 37) anon35_Then_correct) (=> (= (ControlFlow 0 39) 38) anon35_Else_correct)))))
(let ((anon5_correct true))
(let ((anon34_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon5_correct)))
(let ((anon34_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@0 y@@5 v_2)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 y@@5 v_2))) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
(let ((anon6_correct true))
(let ((anon32_Then_correct  (=> (> j_1 0) (and (and (=> (= (ControlFlow 0 7) 1) anon6_correct) (=> (= (ControlFlow 0 7) 4) anon34_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon34_Else_correct)))))
(let ((anon32_Else_correct  (=> (and (>= 0 j_1) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (and (and (and (state Heap@@18 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@18 y@@5 $allocated)) (not (= y@@5 null)))) (and (and (= Mask@0 (MapType1Store ZeroMask y@@5 v_2 (real_2_U (+ (U_2_real (MapType1Select ZeroMask y@@5 v_2)) FullPerm)))) (state Heap@@18 Mask@0)) (and (state Heap@@18 Mask@0) (state Heap@@18 Mask@0)))) (and (and (=> (= (ControlFlow 0 40) 39) anon31_Else_correct) (=> (= (ControlFlow 0 40) 7) anon32_Then_correct)) (=> (= (ControlFlow 0 40) 2) anon32_Else_correct)))))
