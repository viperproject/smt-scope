...
(check-sat)
; unknown
(assert (= result@1@00 (/ (to_real 1) (to_real 2))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (p@0@00 $Perm)) (!
...
(set-option :timeout 0)
(push) ; 2
(assert (f%precondition $Snap.unit (/ (to_real 1) (to_real 4))))
(pop) ; 2
; Joined path conditions
(assert (f%precondition $Snap.unit (/ (to_real 1) (to_real 4))))
(assert (= result@4@00 (f $Snap.unit (/ (to_real 1) (to_real 4)))))
(pop) ; 1
(assert (forall ((s@$ $Snap)) (!
  (=>
    (g%precondition s@$)
...
(set-option :timeout 0)
(push) ; 2
(assert (fi%precondition $Snap.unit (div 1 5)))
(pop) ; 2
; Joined path conditions
(assert (fi%precondition $Snap.unit (div 1 5)))
(assert (= result@5@00 (fi $Snap.unit (div 1 5))))
(pop) ; 1
(assert (forall ((s@$ $Snap)) (!
