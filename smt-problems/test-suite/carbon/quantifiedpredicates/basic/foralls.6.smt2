...
(declare-fun a_1@@5 () Int)
(declare-fun b_2 () Int)
(assert  (and (and (= (type ss) (MapType2Type intType boolType)) (= (type xs) (SeqType RefType))) (= (type Heap@@10) (MapType0Type RefType))))
(set-info :boogie-vc-id test11)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (U_2_bool (MapType2Select ss (int_2_U i_7)))) (= (ControlFlow 0 9) 5)) anon7_correct)))
(let ((anon12_Then_correct  (=> (U_2_bool (MapType2Select ss (int_2_U i_7))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (>= i_7 0)) (=> (>= i_7 0) (and (=> (= (ControlFlow 0 6) (- 0 7)) (< i_7 (|Seq#Length| xs))) (=> (< i_7 (|Seq#Length| xs)) (=> (= (ControlFlow 0 6) 5) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((i_5 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5 i_5_1)) (U_2_bool (MapType2Select ss (int_2_U i_5)))) (U_2_bool (MapType2Select ss (int_2_U i_5_1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_5) (|Seq#Index| xs i_5_1))))
 :qid |stdinbpl.1384:17|
 :skolemid |166|
 :pattern ( (neverTriggered7 i_5) (neverTriggered7 i_5_1))
)))))
(let ((anon10_Else_correct  (=> (and (forall ((i_3_1 T@U) ) (!  (=> (and (= (type i_3_1) intType) (U_2_bool (MapType2Select ss i_3_1))) (<= 0 (U_2_int i_3_1)))
 :qid |stdinbpl.1364:20|
 :skolemid |165|
 :pattern ( (MapType2Select ss i_3_1))
)) (state Heap@@10 ZeroMask)) (and (and (=> (= (ControlFlow 0 10) 4) anon11_Else_correct) (=> (= (ControlFlow 0 10) 6) anon12_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon12_Else_correct)))))
(let ((anon10_Then_correct true))
(let ((anon9_Else_correct  (=> (and (forall ((i_1 T@U) ) (!  (=> (and (= (type i_1) intType) (|Seq#Contains| (|Seq#Range| 0 n@@13) i_1)) (U_2_bool (MapType2Select ss (int_2_U (+ (* a_1@@5 (U_2_int i_1)) b_2)))))
 :qid |stdinbpl.1354:20|
 :skolemid |164|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) i_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) i_1))
)) (state Heap@@10 ZeroMask)) (and (=> (= (ControlFlow 0 11) 2) anon10_Then_correct) (=> (= (ControlFlow 0 11) 10) anon10_Else_correct)))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (and (<= 0 a_1@@5) (<= 0 b_2)) (and (<= 0 n@@13) (state Heap@@10 ZeroMask))) (and (and (<= (+ (* a_1@@5 (- n@@13 1)) b_2) (|Seq#Length| xs)) (state Heap@@10 ZeroMask)) (and (= (|Set#Card| ss) n@@13) (state Heap@@10 ZeroMask)))) (and (=> (= (ControlFlow 0 12) 1) anon9_Then_correct) (=> (= (ControlFlow 0 12) 11) anon9_Else_correct))))))
