...
(assert  (and (and (= (type a_2) (SeqType RefType)) (= (type Heap@@33) (MapType0Type RefType))) (= (type diz) RefType)))
(set-info :boogie-vc-id Ref__guard_check_S2_S1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= 1 i@@34)) (=> (<= 1 i@@34) (=> (= (ControlFlow 0 3) (- 0 2)) (< (- i@@34 1) (- (|Seq#Length| a_2) 1)))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@33 diz $allocated)) (not (= diz null)))) (=> (and (and (and (state Heap@@33 ZeroMask) (>= current_thread_id 0)) (and (state Heap@@33 ZeroMask) (<= 0 i@@34))) (and (and (< i@@34 (|Seq#Length| a_2)) (state Heap@@33 ZeroMask)) (and (> i@@34 0) (state Heap@@33 ZeroMask)))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct))))))
