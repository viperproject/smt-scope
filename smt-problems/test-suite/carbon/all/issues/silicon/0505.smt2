...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type set) (MapType2Type RefType boolType)) (= (type x@@19) RefType)) (= (type y@@6) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type x_2) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type new_set@0) (MapType2Type RefType boolType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type x_4) RefType)) (= (type QPMask@2) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv3 arg0@@43)) RefType)
 :qid |funType:invRecv3|
 :pattern ( (invRecv3 arg0@@43))
))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv2 arg0@@44)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@44))
))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type r_1) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv1 arg0@@45)) RefType)
...
(let ((anon24_Else_correct  (=> (and (not (U_2_bool (MapType2Select new_set@0 x_4))) (= (ControlFlow 0 19) 16)) anon15_correct)))
(let ((anon24_Then_correct  (=> (U_2_bool (MapType2Select new_set@0 x_4)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm Mask@1 x_4 f_7)) (=> (HasDirectPerm Mask@1 x_4 f_7) (=> (= (ControlFlow 0 17) 16) anon15_correct))))))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 15)) (forall ((x_9 T@U) ) (!  (=> (= (type x_9) RefType) (=> (and (U_2_bool (MapType2Select new_set@0 x_9)) (dummyFunction (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_9 f_7) g))) (>= (/ (to_real 2) (to_real 3)) NoPerm)))
 :qid |stdinbpl.652:17|
 :skolemid |104|
 :pattern ( (MapType0Select Heap@@9 x_9 f_7))
 :pattern ( (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_9 f_7) g))
))) (=> (forall ((x_9@@0 T@U) ) (!  (=> (= (type x_9@@0) RefType) (=> (and (U_2_bool (MapType2Select new_set@0 x_9@@0)) (dummyFunction (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_9@@0 f_7) g))) (>= (/ (to_real 2) (to_real 3)) NoPerm)))
 :qid |stdinbpl.652:17|
 :skolemid |104|
 :pattern ( (MapType0Select Heap@@9 x_9@@0 f_7))
 :pattern ( (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_9@@0 f_7) g))
)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((x_9@@1 T@U) (x_9_1 T@U) ) (!  (=> (and (= (type x_9@@1) RefType) (= (type x_9_1) RefType)) (=> (and (and (and (and (not (= x_9@@1 x_9_1)) (U_2_bool (MapType2Select new_set@0 x_9@@1))) (U_2_bool (MapType2Select new_set@0 x_9_1))) (< NoPerm (/ (to_real 2) (to_real 3)))) (< NoPerm (/ (to_real 2) (to_real 3)))) (not (= (MapType0Select Heap@@9 x_9@@1 f_7) (MapType0Select Heap@@9 x_9_1 f_7)))))
 :qid |stdinbpl.659:17|
 :skolemid |105|
 :pattern ( (neverTriggered4 x_9@@1) (neverTriggered4 x_9_1))
))) (=> (forall ((x_9@@2 T@U) (x_9_1@@0 T@U) ) (!  (=> (and (= (type x_9@@2) RefType) (= (type x_9_1@@0) RefType)) (=> (and (and (and (and (not (= x_9@@2 x_9_1@@0)) (U_2_bool (MapType2Select new_set@0 x_9@@2))) (U_2_bool (MapType2Select new_set@0 x_9_1@@0))) (< NoPerm (/ (to_real 2) (to_real 3)))) (< NoPerm (/ (to_real 2) (to_real 3)))) (not (= (MapType0Select Heap@@9 x_9@@2 f_7) (MapType0Select Heap@@9 x_9_1@@0 f_7)))))
 :qid |stdinbpl.659:17|
 :skolemid |105|
 :pattern ( (neverTriggered4 x_9@@2) (neverTriggered4 x_9_1@@0))
)) (=> (= (ControlFlow 0 13) (- 0 12)) (forall ((x_9@@3 T@U) ) (!  (=> (and (= (type x_9@@3) RefType) (U_2_bool (MapType2Select new_set@0 x_9@@3))) (>= (U_2_real (MapType1Select Mask@1 (MapType0Select Heap@@9 x_9@@3 f_7) g)) (/ (to_real 2) (to_real 3))))
 :qid |stdinbpl.666:17|
 :skolemid |106|
 :pattern ( (MapType0Select Heap@@9 x_9@@3 f_7))
 :pattern ( (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_9@@3 f_7) g))
)))))))))
(let ((anon22_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 23)) (forall ((x_7 T@U) ) (!  (=> (= (type x_7) RefType) (=> (and (U_2_bool (MapType2Select new_set@0 x_7)) (dummyFunction (MapType0Select Heap@@9 x_7 f_7))) (>= (/ (to_real 1) (to_real 3)) NoPerm)))
 :qid |stdinbpl.591:17|
 :skolemid |97|
 :pattern ( (MapType0Select Heap@@9 x_7 f_7))
 :pattern ( (MapType1Select QPMask@2 x_7 f_7))
 :pattern ( (MapType0Select Heap@@9 x_7 f_7))
))) (=> (forall ((x_7@@0 T@U) ) (!  (=> (= (type x_7@@0) RefType) (=> (and (U_2_bool (MapType2Select new_set@0 x_7@@0)) (dummyFunction (MapType0Select Heap@@9 x_7@@0 f_7))) (>= (/ (to_real 1) (to_real 3)) NoPerm)))
 :qid |stdinbpl.591:17|
 :skolemid |97|
 :pattern ( (MapType0Select Heap@@9 x_7@@0 f_7))
 :pattern ( (MapType1Select QPMask@2 x_7@@0 f_7))
 :pattern ( (MapType0Select Heap@@9 x_7@@0 f_7))
)) (and (=> (= (ControlFlow 0 20) (- 0 22)) (forall ((x_7@@1 T@U) (x_7_1 T@U) ) (!  (=> (and (= (type x_7@@1) RefType) (= (type x_7_1) RefType)) (=> (and (and (and (and (not (= x_7@@1 x_7_1)) (U_2_bool (MapType2Select new_set@0 x_7@@1))) (U_2_bool (MapType2Select new_set@0 x_7_1))) (< NoPerm (/ (to_real 1) (to_real 3)))) (< NoPerm (/ (to_real 1) (to_real 3)))) (not (= x_7@@1 x_7_1))))
 :qid |stdinbpl.598:17|
 :skolemid |98|
 :pattern ( (neverTriggered3 x_7@@1) (neverTriggered3 x_7_1))
))) (=> (forall ((x_7@@2 T@U) (x_7_1@@0 T@U) ) (!  (=> (and (= (type x_7@@2) RefType) (= (type x_7_1@@0) RefType)) (=> (and (and (and (and (not (= x_7@@2 x_7_1@@0)) (U_2_bool (MapType2Select new_set@0 x_7@@2))) (U_2_bool (MapType2Select new_set@0 x_7_1@@0))) (< NoPerm (/ (to_real 1) (to_real 3)))) (< NoPerm (/ (to_real 1) (to_real 3)))) (not (= x_7@@2 x_7_1@@0))))
 :qid |stdinbpl.598:17|
 :skolemid |98|
 :pattern ( (neverTriggered3 x_7@@2) (neverTriggered3 x_7_1@@0))
)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((x_7@@3 T@U) ) (!  (=> (and (= (type x_7@@3) RefType) (U_2_bool (MapType2Select new_set@0 x_7@@3))) (>= (U_2_real (MapType1Select Mask@1 x_7@@3 f_7)) (/ (to_real 1) (to_real 3))))
 :qid |stdinbpl.605:17|
 :skolemid |99|
 :pattern ( (MapType0Select Heap@@9 x_7@@3 f_7))
 :pattern ( (MapType1Select QPMask@2 x_7@@3 f_7))
 :pattern ( (MapType0Select Heap@@9 x_7@@3 f_7))
))) (=> (forall ((x_7@@4 T@U) ) (!  (=> (and (= (type x_7@@4) RefType) (U_2_bool (MapType2Select new_set@0 x_7@@4))) (>= (U_2_real (MapType1Select Mask@1 x_7@@4 f_7)) (/ (to_real 1) (to_real 3))))
 :qid |stdinbpl.605:17|
 :skolemid |99|
 :pattern ( (MapType0Select Heap@@9 x_7@@4 f_7))
 :pattern ( (MapType1Select QPMask@2 x_7@@4 f_7))
 :pattern ( (MapType0Select Heap@@9 x_7@@4 f_7))
)) (=> (forall ((x_7@@5 T@U) ) (!  (=> (= (type x_7@@5) RefType) (=> (and (U_2_bool (MapType2Select new_set@0 x_7@@5)) (< NoPerm (/ (to_real 1) (to_real 3)))) (and (qpRange3 x_7@@5) (= (invRecv3 x_7@@5) x_7@@5))))
 :qid |stdinbpl.611:22|
 :skolemid |100|
 :pattern ( (MapType0Select Heap@@9 x_7@@5 f_7))
 :pattern ( (MapType1Select QPMask@2 x_7@@5 f_7))
 :pattern ( (MapType0Select Heap@@9 x_7@@5 f_7))
)) (=> (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType2Select new_set@0 (invRecv3 o_3))) (and (< NoPerm (/ (to_real 1) (to_real 3))) (qpRange3 o_3))) (= (invRecv3 o_3) o_3)))
 :qid |stdinbpl.615:22|
 :skolemid |101|
 :pattern ( (invRecv3 o_3))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType2Select new_set@0 (invRecv3 o_3@@0))) (and (< NoPerm (/ (to_real 1) (to_real 3))) (qpRange3 o_3@@0))) (and (= (invRecv3 o_3@@0) o_3@@0) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (- (U_2_real (MapType1Select Mask@1 o_3@@0 f_7)) (/ (to_real 1) (to_real 3)))))) (=> (not (and (U_2_bool (MapType2Select new_set@0 (invRecv3 o_3@@0))) (and (< NoPerm (/ (to_real 1) (to_real 3))) (qpRange3 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (U_2_real (MapType1Select Mask@1 o_3@@0 f_7))))))
 :qid |stdinbpl.621:22|
 :skolemid |102|
...
)) (state Heap@@9 Mask@1))) (and (and (=> (= (ControlFlow 0 20) 13) anon23_Else_correct) (=> (= (ControlFlow 0 20) 17) anon24_Then_correct)) (=> (= (ControlFlow 0 20) 19) anon24_Else_correct))))))))))))
(let ((anon22_Then_correct true))
(let ((anon20_Else_correct  (and (=> (= (ControlFlow 0 24) (- 0 29)) (forall ((x_5 T@U) (x_5_1 T@U) ) (!  (=> (and (= (type x_5) RefType) (= (type x_5_1) RefType)) (=> (and (and (and (and (not (= x_5 x_5_1)) (U_2_bool (MapType2Select set x_5))) (U_2_bool (MapType2Select set x_5_1))) (< NoPerm (/ (to_real 2) (to_real 3)))) (< NoPerm (/ (to_real 2) (to_real 3)))) (not (= (MapType0Select Heap@@9 x_5 f_7) (MapType0Select Heap@@9 x_5_1 f_7)))))
 :qid |stdinbpl.503:15|
 :skolemid |90|
 :no-pattern (type x_5)
...
))) (=> (forall ((x_5@@0 T@U) (x_5_1@@0 T@U) ) (!  (=> (and (= (type x_5@@0) RefType) (= (type x_5_1@@0) RefType)) (=> (and (and (and (and (not (= x_5@@0 x_5_1@@0)) (U_2_bool (MapType2Select set x_5@@0))) (U_2_bool (MapType2Select set x_5_1@@0))) (< NoPerm (/ (to_real 2) (to_real 3)))) (< NoPerm (/ (to_real 2) (to_real 3)))) (not (= (MapType0Select Heap@@9 x_5@@0 f_7) (MapType0Select Heap@@9 x_5_1@@0 f_7)))))
 :qid |stdinbpl.503:15|
 :skolemid |90|
...
)) (=> (and (forall ((x_5@@1 T@U) ) (!  (=> (= (type x_5@@1) RefType) (=> (and (U_2_bool (MapType2Select set x_5@@1)) (< NoPerm (/ (to_real 2) (to_real 3)))) (and (qpRange2 (MapType0Select Heap@@9 x_5@@1 f_7)) (= (invRecv2 (MapType0Select Heap@@9 x_5@@1 f_7)) x_5@@1))))
 :qid |stdinbpl.509:22|
 :skolemid |91|
 :pattern ( (MapType0Select Heap@@9 x_5@@1 f_7))
 :pattern ( (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_5@@1 f_7) g))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType2Select set (invRecv2 o_3@@2))) (< NoPerm (/ (to_real 2) (to_real 3)))) (qpRange2 o_3@@2)) (= (MapType0Select Heap@@9 (invRecv2 o_3@@2) f_7) o_3@@2)))
 :qid |stdinbpl.513:22|
 :skolemid |92|
 :pattern ( (invRecv2 o_3@@2))
))) (and (=> (= (ControlFlow 0 24) (- 0 28)) (forall ((x_5@@2 T@U) ) (!  (=> (and (= (type x_5@@2) RefType) (U_2_bool (MapType2Select set x_5@@2))) (>= (/ (to_real 2) (to_real 3)) NoPerm))
 :qid |stdinbpl.519:15|
 :skolemid |93|
 :pattern ( (MapType0Select Heap@@9 x_5@@2 f_7))
 :pattern ( (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_5@@2 f_7) g))
))) (=> (forall ((x_5@@3 T@U) ) (!  (=> (and (= (type x_5@@3) RefType) (U_2_bool (MapType2Select set x_5@@3))) (>= (/ (to_real 2) (to_real 3)) NoPerm))
 :qid |stdinbpl.519:15|
 :skolemid |93|
 :pattern ( (MapType0Select Heap@@9 x_5@@3 f_7))
 :pattern ( (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_5@@3 f_7) g))
)) (=> (and (and (and (forall ((x_5@@4 T@U) ) (!  (=> (= (type x_5@@4) RefType) (=> (and (U_2_bool (MapType2Select set x_5@@4)) (> (/ (to_real 2) (to_real 3)) NoPerm)) (not (= (MapType0Select Heap@@9 x_5@@4 f_7) null))))
 :qid |stdinbpl.525:22|
 :skolemid |94|
 :pattern ( (MapType0Select Heap@@9 x_5@@4 f_7))
 :pattern ( (MapType0Select Heap@@9 (MapType0Select Heap@@9 x_5@@4 f_7) g))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType2Select set (invRecv2 o_3@@3))) (< NoPerm (/ (to_real 2) (to_real 3)))) (qpRange2 o_3@@3)) (and (=> (< NoPerm (/ (to_real 2) (to_real 3))) (= (MapType0Select Heap@@9 (invRecv2 o_3@@3) f_7) o_3@@3)) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 g)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@3 g)) (/ (to_real 2) (to_real 3)))))) (=> (not (and (and (U_2_bool (MapType2Select set (invRecv2 o_3@@3))) (< NoPerm (/ (to_real 2) (to_real 3)))) (qpRange2 o_3@@3))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 g)) (U_2_real (MapType1Select QPMask@0 o_3@@3 g))))))
 :qid |stdinbpl.531:22|
 :skolemid |95|
...
)) (state Heap@@9 QPMask@1))) (and (and (state Heap@@9 QPMask@1) (= new_set@0 (|Set#Union| set (|Set#Singleton| r_1)))) (and (state Heap@@9 QPMask@1) (= perm@0 (/ (to_real 1) (to_real 3)))))) (and (=> (= (ControlFlow 0 24) (- 0 27)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= r_1 null))) (=> (and (and (= Mask@0 (MapType1Store QPMask@1 r_1 f_7 (real_2_U (+ (U_2_real (MapType1Select QPMask@1 r_1 f_7)) perm@0)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 24) (- 0 26)) (HasDirectPerm Mask@0 r_1 f_7)) (=> (HasDirectPerm Mask@0 r_1 f_7) (=> (= perm@1 (/ (to_real 2) (to_real 3))) (and (=> (= (ControlFlow 0 24) (- 0 25)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (=> (> perm@1 NoPerm) (not (= (MapType0Select Heap@@9 r_1 f_7) null))) (=> (and (and (= Mask@1 (MapType1Store Mask@0 (MapType0Select Heap@@9 r_1 f_7) g (real_2_U (+ (U_2_real (MapType1Select Mask@0 (MapType0Select Heap@@9 r_1 f_7) g)) perm@1)))) (state Heap@@9 Mask@1)) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1))) (and (=> (= (ControlFlow 0 24) 11) anon22_Then_correct) (=> (= (ControlFlow 0 24) 20) anon22_Else_correct)))))))))))))))))))))
(let ((anon9_correct true))
(let ((anon21_Else_correct  (=> (and (not (U_2_bool (MapType2Select set x_2))) (= (ControlFlow 0 10) 7)) anon9_correct)))
(let ((anon21_Then_correct  (=> (U_2_bool (MapType2Select set x_2)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm QPMask@0 x_2 f_7)) (=> (HasDirectPerm QPMask@0 x_2 f_7) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
(let ((anon18_Else_correct  (=> (and (forall ((x_3 T@U) (y_1 T@U) ) (!  (=> (and (and (= (type x_3) RefType) (= (type y_1) RefType)) (and (U_2_bool (MapType2Select set x_3)) (and (U_2_bool (MapType2Select set y_1)) (not (= x_3 y_1))))) (not (= (MapType0Select Heap@@9 x_3 f_7) (MapType0Select Heap@@9 y_1 f_7))))
 :qid |stdinbpl.487:20|
 :skolemid |89|
 :pattern ( (MapType2Select set x_3) (MapType2Select set y_1))
)) (state Heap@@9 QPMask@0)) (and (and (=> (= (ControlFlow 0 30) 24) anon20_Else_correct) (=> (= (ControlFlow 0 30) 8) anon21_Then_correct)) (=> (= (ControlFlow 0 30) 10) anon21_Else_correct)))))
(let ((anon5_correct true))
(let ((anon19_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select set x@@19)) (and (U_2_bool (MapType2Select set y@@6)) (not (= x@@19 y@@6))))) (= (ControlFlow 0 6) 2)) anon5_correct)))
(let ((anon19_Then_correct  (=> (and (U_2_bool (MapType2Select set x@@19)) (and (U_2_bool (MapType2Select set y@@6)) (not (= x@@19 y@@6)))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm QPMask@0 x@@19 f_7)) (=> (HasDirectPerm QPMask@0 x@@19 f_7) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 y@@6 f_7)) (=> (HasDirectPerm QPMask@0 y@@6 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 33)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select set x_1))) (U_2_bool (MapType2Select set x_1_1))) (< NoPerm (/ (to_real 1) (to_real 3)))) (< NoPerm (/ (to_real 1) (to_real 3)))) (not (= x_1 x_1_1))))
 :qid |stdinbpl.437:15|
 :skolemid |82|
 :no-pattern (type x_1)
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (U_2_bool (MapType2Select set x_1@@0))) (U_2_bool (MapType2Select set x_1_1@@0))) (< NoPerm (/ (to_real 1) (to_real 3)))) (< NoPerm (/ (to_real 1) (to_real 3)))) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.437:15|
 :skolemid |82|
...
)) (=> (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select set x_1@@1)) (< NoPerm (/ (to_real 1) (to_real 3)))) (and (qpRange1 x_1@@1) (= (invRecv1 x_1@@1) x_1@@1))))
 :qid |stdinbpl.443:22|
 :skolemid |83|
 :pattern ( (MapType0Select Heap@@9 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
 :pattern ( (MapType0Select Heap@@9 x_1@@1 f_7))
)) (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (U_2_bool (MapType2Select set (invRecv1 o_3@@5))) (< NoPerm (/ (to_real 1) (to_real 3)))) (qpRange1 o_3@@5)) (= (invRecv1 o_3@@5) o_3@@5)))
 :qid |stdinbpl.447:22|
 :skolemid |84|
 :pattern ( (invRecv1 o_3@@5))
))) (and (=> (= (ControlFlow 0 31) (- 0 32)) (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (U_2_bool (MapType2Select set x_1@@2))) (>= (/ (to_real 1) (to_real 3)) NoPerm))
 :qid |stdinbpl.453:15|
 :skolemid |85|
 :pattern ( (MapType0Select Heap@@9 x_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@2 f_7))
 :pattern ( (MapType0Select Heap@@9 x_1@@2 f_7))
))) (=> (forall ((x_1@@3 T@U) ) (!  (=> (and (= (type x_1@@3) RefType) (U_2_bool (MapType2Select set x_1@@3))) (>= (/ (to_real 1) (to_real 3)) NoPerm))
 :qid |stdinbpl.453:15|
 :skolemid |85|
 :pattern ( (MapType0Select Heap@@9 x_1@@3 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@3 f_7))
 :pattern ( (MapType0Select Heap@@9 x_1@@3 f_7))
)) (=> (forall ((x_1@@4 T@U) ) (!  (=> (= (type x_1@@4) RefType) (=> (and (U_2_bool (MapType2Select set x_1@@4)) (> (/ (to_real 1) (to_real 3)) NoPerm)) (not (= x_1@@4 null))))
 :qid |stdinbpl.459:22|
 :skolemid |86|
 :pattern ( (MapType0Select Heap@@9 x_1@@4 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@4 f_7))
 :pattern ( (MapType0Select Heap@@9 x_1@@4 f_7))
)) (=> (and (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (U_2_bool (MapType2Select set (invRecv1 o_3@@6))) (< NoPerm (/ (to_real 1) (to_real 3)))) (qpRange1 o_3@@6)) (and (=> (< NoPerm (/ (to_real 1) (to_real 3))) (= (invRecv1 o_3@@6) o_3@@6)) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@6 f_7)) (/ (to_real 1) (to_real 3)))))) (=> (not (and (and (U_2_bool (MapType2Select set (invRecv1 o_3@@6))) (< NoPerm (/ (to_real 1) (to_real 3)))) (qpRange1 o_3@@6))) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@6 f_7))))))
 :qid |stdinbpl.465:22|
 :skolemid |87|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 31) 30) anon18_Else_correct) (=> (= (ControlFlow 0 31) 3) anon19_Then_correct)) (=> (= (ControlFlow 0 31) 6) anon19_Else_correct)))))))))))
(let ((anon17_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 r_1 $allocated))) (and (=> (= (ControlFlow 0 34) 1) anon17_Then_correct) (=> (= (ControlFlow 0 34) 31) anon17_Else_correct)))))
