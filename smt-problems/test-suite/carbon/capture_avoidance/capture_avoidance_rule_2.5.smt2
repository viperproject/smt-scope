...
(set-info :boogie-vc-id |function8#definedness|)
...
(declare-fun z_21 () Int)
(declare-fun res@8 () Bool)
(declare-fun z_17 () Int)
(declare-fun res@7 () Bool)
(declare-fun y@@12 () Int)
(declare-fun y$0 () Int)
(declare-fun x$0_6 () Int)
(declare-fun res@6 () Bool)
(declare-fun res@5 () Bool)
(declare-fun z$0_11 () Int)
(declare-fun z$0_9 () Int)
(declare-fun res@4 () Bool)
(declare-fun z$0_5 () Int)
(declare-fun z$0_3 () Int)
(declare-fun res@3 () Bool)
(declare-fun z$0 () Int)
(declare-fun res@2 () Bool)
(declare-fun x$0_4 () Int)
(declare-fun res@1 () Bool)
(declare-fun x$0_2 () Int)
(declare-fun res@0 () Bool)
(declare-fun x$0 () Int)
(assert (= (type Heap@@46) (MapType0Type RefType)))
(set-info :boogie-vc-id client1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 77) (let ((anon90_Then_correct true))
(let ((anon92_Then_correct true))
(let ((anon109_Else_correct true))
(let ((anon109_Then_correct  (=> (= (ControlFlow 0 57) (- 0 56)) (exists ((x$0_11 Int) ) (!  (=> (= x$0_11 x@@22) (= x$0_11 0))
 :qid |stdinbpl.1487:19|
 :skolemid |167|
)))))
(let ((anon108_Else_correct  (=> (and (= res@10 (function9 Heap@@46)) (state Heap@@46 ZeroMask)) (and (=> (= (ControlFlow 0 59) 57) anon109_Then_correct) (=> (= (ControlFlow 0 59) 58) anon109_Else_correct)))))
(let ((anon108_Then_correct  (=> (= (ControlFlow 0 55) (- 0 54)) (exists ((x$0_10 Int) ) (! (= x$0_10 x$0_10)
 :qid |stdinbpl.1469:19|
 :skolemid |166|
)))))
(let ((anon105_Else_correct  (=> (and (= res@9 (function8 Heap@@46 (forall ((z_24 Int) ) (! (= z_24 z_24)
 :qid |stdinbpl.1455:36|
 :skolemid |165|
)) 5)) (state Heap@@46 ZeroMask)) (and (=> (= (ControlFlow 0 60) 55) anon108_Then_correct) (=> (= (ControlFlow 0 60) 59) anon108_Else_correct)))))
(let ((anon107_Else_correct true))
(let ((anon107_Then_correct  (=> (= (ControlFlow 0 52) (- 0 51)) (= z_21 z_21))))
(let ((anon106_Else_correct true))
(let ((anon104_Then_correct true))
(let ((anon102_Else_correct  (=> (and (= res@8 (function7 Heap@@46 (forall ((z_19 Int) ) (! (= z_19 z_19)
 :qid |stdinbpl.1417:36|
 :skolemid |161|
)) 5)) (state Heap@@46 ZeroMask)) (and (and (and (and (=> (= (ControlFlow 0 61) 49) anon104_Then_correct) (=> (= (ControlFlow 0 61) 60) anon105_Else_correct)) (=> (= (ControlFlow 0 61) 50) anon106_Else_correct)) (=> (= (ControlFlow 0 61) 52) anon107_Then_correct)) (=> (= (ControlFlow 0 61) 53) anon107_Else_correct)))))
(let ((anon103_Else_correct true))
(let ((anon103_Then_correct  (=> (= (ControlFlow 0 47) (- 0 46)) (= z_17 z_17))))
(let ((anon101_Then_correct true))
(let ((anon98_Else_correct  (=> (and (= res@7 (function6 Heap@@46 x@@22 y@@12)) (state Heap@@46 ZeroMask)) (and (and (and (=> (= (ControlFlow 0 62) 45) anon101_Then_correct) (=> (= (ControlFlow 0 62) 61) anon102_Else_correct)) (=> (= (ControlFlow 0 62) 47) anon103_Then_correct)) (=> (= (ControlFlow 0 62) 48) anon103_Else_correct)))))
(let ((anon100_Else_correct true))
(let ((anon100_Then_correct  (and (=> (= (ControlFlow 0 40) (- 0 41)) (= y$0 y$0)) (=> (= y$0 y$0) (=> (= (ControlFlow 0 40) (- 0 39)) (= x@@22 y@@12))))))
(let ((anon99_Then_correct  (and (=> (= (ControlFlow 0 43) (- 0 44)) (= x$0_6 x$0_6)) (=> (= x$0_6 x$0_6) (and (=> (= (ControlFlow 0 43) 40) anon100_Then_correct) (=> (= (ControlFlow 0 43) 42) anon100_Else_correct))))))
(let ((anon99_Else_correct true))
(let ((anon97_Else_correct  (=> (and (= res@6 (function5 Heap@@46 y@@12 x@@22)) (state Heap@@46 ZeroMask)) (and (and (=> (= (ControlFlow 0 63) 62) anon98_Else_correct) (=> (= (ControlFlow 0 63) 43) anon99_Then_correct)) (=> (= (ControlFlow 0 63) 38) anon99_Else_correct)))))
(let ((anon97_Then_correct  (=> (= (ControlFlow 0 37) (- 0 36)) (or (= y@@12 0) (= x@@22 0)))))
(let ((anon93_Else_correct  (=> (and (= res@5 (function4 Heap@@46  (and (= x@@22 0) (forall ((z_14 Int) ) (! (= z_14 z_14)
 :qid |stdinbpl.1335:46|
 :skolemid |155|
)))  (and (= y@@12 0) (forall ((z_15 Int) ) (! (= z_15 z_15)
 :qid |stdinbpl.1338:26|
 :skolemid |156|
))))) (state Heap@@46 ZeroMask)) (and (=> (= (ControlFlow 0 64) 37) anon97_Then_correct) (=> (= (ControlFlow 0 64) 63) anon97_Else_correct)))))
(let ((anon96_Else_correct true))
(let ((anon96_Then_correct  (=> (= (ControlFlow 0 30) (- 0 29)) (= z$0_11 z$0_11))))
(let ((anon95_Else_correct  (=> (forall ((z$0_10_1 Int) ) (! (= z$0_10_1 z$0_10_1)
 :qid |stdinbpl.1305:26|
 :skolemid |150|
)) (and (=> (= (ControlFlow 0 32) (- 0 33)) (= y@@12 0)) (=> (= y@@12 0) (and (=> (= (ControlFlow 0 32) 30) anon96_Then_correct) (=> (= (ControlFlow 0 32) 31) anon96_Else_correct)))))))
(let ((anon95_Then_correct  (=> (= (ControlFlow 0 28) (- 0 27)) (= z$0_9 z$0_9))))
(let ((anon94_Then_correct  (and (=> (= (ControlFlow 0 34) (- 0 35)) (= x@@22 0)) (=> (= x@@22 0) (and (=> (= (ControlFlow 0 34) 28) anon95_Then_correct) (=> (= (ControlFlow 0 34) 32) anon95_Else_correct))))))
(let ((anon94_Else_correct true))
(let ((anon91_Then_correct  (=> (= y@@12 0) (and (and (and (=> (= (ControlFlow 0 67) 66) anon92_Then_correct) (=> (= (ControlFlow 0 67) 64) anon93_Else_correct)) (=> (= (ControlFlow 0 67) 34) anon94_Then_correct)) (=> (= (ControlFlow 0 67) 26) anon94_Else_correct)))))
(let ((anon91_Else_correct  (=> (not (= y@@12 0)) (and (and (=> (= (ControlFlow 0 65) 64) anon93_Else_correct) (=> (= (ControlFlow 0 65) 34) anon94_Then_correct)) (=> (= (ControlFlow 0 65) 26) anon94_Else_correct)))))
(let ((anon89_Then_correct  (=> (= x@@22 0) (and (and (=> (= (ControlFlow 0 70) 69) anon90_Then_correct) (=> (= (ControlFlow 0 70) 67) anon91_Then_correct)) (=> (= (ControlFlow 0 70) 65) anon91_Else_correct)))))
(let ((anon89_Else_correct  (=> (not (= x@@22 0)) (and (=> (= (ControlFlow 0 68) 67) anon91_Then_correct) (=> (= (ControlFlow 0 68) 65) anon91_Else_correct)))))
(let ((anon85_Else_correct  (=> (and (= res@4 (function4 Heap@@46 (forall ((z_8 Int) ) (! (= z_8 z_8)
 :qid |stdinbpl.1270:36|
 :skolemid |148|
)) (forall ((z_9 Int) ) (! (= z_9 z_9)
 :qid |stdinbpl.1273:16|
 :skolemid |149|
)))) (state Heap@@46 ZeroMask)) (and (=> (= (ControlFlow 0 71) 70) anon89_Then_correct) (=> (= (ControlFlow 0 71) 68) anon89_Else_correct)))))
(let ((anon88_Else_correct true))
(let ((anon88_Then_correct  (=> (= (ControlFlow 0 23) (- 0 22)) (= z$0_5 z$0_5))))
(let ((anon87_Else_correct  (=> (forall ((z$0_4_1 Int) ) (! (= z$0_4_1 z$0_4_1)
 :qid |stdinbpl.1242:26|
 :skolemid |143|
)) (and (=> (= (ControlFlow 0 25) 23) anon88_Then_correct) (=> (= (ControlFlow 0 25) 24) anon88_Else_correct)))))
(let ((anon87_Then_correct  (=> (= (ControlFlow 0 21) (- 0 20)) (= z$0_3 z$0_3))))
(let ((anon86_Else_correct true))
(let ((anon84_Then_correct true))
(let ((anon83_Then_correct true))
(let ((anon80_Else_correct  (=> (and (= res@3 (function3 Heap@@46 (forall ((z_3 Int) ) (! (= z_3 z_3)
 :qid |stdinbpl.1217:36|
 :skolemid |142|
)))) (state Heap@@46 ZeroMask)) (and (and (and (and (and (=> (= (ControlFlow 0 72) 17) anon83_Then_correct) (=> (= (ControlFlow 0 72) 18) anon84_Then_correct)) (=> (= (ControlFlow 0 72) 71) anon85_Else_correct)) (=> (= (ControlFlow 0 72) 19) anon86_Else_correct)) (=> (= (ControlFlow 0 72) 21) anon87_Then_correct)) (=> (= (ControlFlow 0 72) 25) anon87_Else_correct)))))
(let ((anon82_Else_correct true))
(let ((anon82_Then_correct  (=> (= (ControlFlow 0 15) (- 0 14)) (= z$0 z$0))))
(let ((anon81_Else_correct true))
(let ((anon79_Then_correct true))
(let ((anon77_Else_correct  (=> (and (= res@2 (function2 Heap@@46 x@@22 y@@12)) (state Heap@@46 ZeroMask)) (and (and (and (and (=> (= (ControlFlow 0 73) 12) anon79_Then_correct) (=> (= (ControlFlow 0 73) 72) anon80_Else_correct)) (=> (= (ControlFlow 0 73) 13) anon81_Else_correct)) (=> (= (ControlFlow 0 73) 15) anon82_Then_correct)) (=> (= (ControlFlow 0 73) 16) anon82_Else_correct)))))
(let ((anon78_Else_correct true))
(let ((anon78_Then_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (= x$0_4 x$0_4)) (=> (= x$0_4 x$0_4) (=> (= (ControlFlow 0 9) (- 0 8)) (= x@@22 y@@12))))))
(let ((anon75_Else_correct  (=> (and (= res@1 (function1 Heap@@46 x@@22)) (state Heap@@46 ZeroMask)) (and (and (=> (= (ControlFlow 0 74) 73) anon77_Else_correct) (=> (= (ControlFlow 0 74) 9) anon78_Then_correct)) (=> (= (ControlFlow 0 74) 11) anon78_Else_correct)))))
(let ((anon76_Else_correct true))
(let ((anon76_Then_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (= x$0_2 x$0_2)) (=> (= x$0_2 x$0_2) (=> (= (ControlFlow 0 5) (- 0 4)) (= x@@22 0))))))
(let ((anon73_Else_correct  (=> (and (= res@0 (function0 Heap@@46)) (state Heap@@46 ZeroMask)) (and (and (=> (= (ControlFlow 0 75) 74) anon75_Else_correct) (=> (= (ControlFlow 0 75) 5) anon76_Then_correct)) (=> (= (ControlFlow 0 75) 7) anon76_Else_correct)))))
(let ((anon74_Else_correct true))
(let ((anon74_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= x$0 x$0))))
(let ((anon0_correct  (=> (state Heap@@46 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (= x@@22 0)) (and (= y@@12 0) (state Heap@@46 ZeroMask))) (and (and (=> (= (ControlFlow 0 76) 75) anon73_Else_correct) (=> (= (ControlFlow 0 76) 2) anon74_Then_correct)) (=> (= (ControlFlow 0 76) 3) anon74_Else_correct))))))
