...
(assert  (and (and (and (= (type vas@@11) (MapType2Type RefType boolType)) (= (type Heap@@20) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@51 T@U) ) (! (= (type (invRecv13 arg0@@51)) RefType)
 :qid |funType:invRecv13|
 :pattern ( (invRecv13 arg0@@51))
))))
(set-info :boogie-vc-id test_ones)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (= (foo_ones Heap@@20 vas@@11) 0))))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((a_6 T@U) (a_6_2 T@U) ) (!  (=> (and (= (type a_6) RefType) (= (type a_6_2) RefType)) (=> (and (and (and (and (not (= a_6 a_6_2)) (U_2_bool (MapType2Select vas@@11 a_6))) (U_2_bool (MapType2Select vas@@11 a_6_2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_6 a_6_2))))
 :qid |stdinbpl.1548:21|
 :skolemid |185|
 :pattern ( (neverTriggered15 a_6) (neverTriggered15 a_6_2))
))) (=> (forall ((a_6@@0 T@U) (a_6_2@@0 T@U) ) (!  (=> (and (= (type a_6@@0) RefType) (= (type a_6_2@@0) RefType)) (=> (and (and (and (and (not (= a_6@@0 a_6_2@@0)) (U_2_bool (MapType2Select vas@@11 a_6@@0))) (U_2_bool (MapType2Select vas@@11 a_6_2@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_6@@0 a_6_2@@0))))
 :qid |stdinbpl.1548:21|
 :skolemid |185|
 :pattern ( (neverTriggered15 a_6@@0) (neverTriggered15 a_6_2@@0))
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((a_6@@1 T@U) ) (!  (=> (and (= (type a_6@@1) RefType) (U_2_bool (MapType2Select vas@@11 a_6@@1))) (>= (U_2_real (MapType1Select QPMask@0 null (one a_6@@1))) FullPerm))
 :qid |stdinbpl.1555:21|
 :skolemid |186|
 :pattern ( (MapType0Select Heap@@20 null (one a_6@@1)))
 :pattern ( (MapType1Select QPMask@0 null (one a_6@@1)))
 :pattern ( (MapType0Select Heap@@20 null (one a_6@@1)))
)))))))
(let ((anon8_Else_correct  (=> (= (foo_ones Heap@@20 vas@@11) 0) (=> (and (state Heap@@20 QPMask@0) (state Heap@@20 QPMask@0)) (and (=> (= (ControlFlow 0 10) 6) anon9_Then_correct) (=> (= (ControlFlow 0 10) 9) anon9_Else_correct))))))
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((a_4 T@U) (a_4_2 T@U) ) (!  (=> (and (= (type a_4) RefType) (= (type a_4_2) RefType)) (=> (and (and (and (and (not (= a_4 a_4_2)) (U_2_bool (MapType2Select vas@@11 a_4))) (U_2_bool (MapType2Select vas@@11 a_4_2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_4 a_4_2))))
 :qid |stdinbpl.1483:21|
 :skolemid |178|
 :pattern ( (neverTriggered14 a_4) (neverTriggered14 a_4_2))
))) (=> (forall ((a_4@@0 T@U) (a_4_2@@0 T@U) ) (!  (=> (and (= (type a_4@@0) RefType) (= (type a_4_2@@0) RefType)) (=> (and (and (and (and (not (= a_4@@0 a_4_2@@0)) (U_2_bool (MapType2Select vas@@11 a_4@@0))) (U_2_bool (MapType2Select vas@@11 a_4_2@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_4@@0 a_4_2@@0))))
 :qid |stdinbpl.1483:21|
 :skolemid |178|
 :pattern ( (neverTriggered14 a_4@@0) (neverTriggered14 a_4_2@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((a_4@@1 T@U) ) (!  (=> (and (= (type a_4@@1) RefType) (U_2_bool (MapType2Select vas@@11 a_4@@1))) (>= (U_2_real (MapType1Select QPMask@0 null (one a_4@@1))) FullPerm))
 :qid |stdinbpl.1490:21|
 :skolemid |179|
 :pattern ( (MapType0Select Heap@@20 null (one a_4@@1)))
 :pattern ( (MapType1Select QPMask@0 null (one a_4@@1)))
 :pattern ( (MapType0Select Heap@@20 null (one a_4@@1)))
)))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((a_1 T@U) (a_1_1 T@U) ) (!  (=> (and (= (type a_1) RefType) (= (type a_1_1) RefType)) (=> (and (and (and (and (not (= a_1 a_1_1)) (U_2_bool (MapType2Select vas@@11 a_1))) (U_2_bool (MapType2Select vas@@11 a_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1 a_1_1))))
 :qid |stdinbpl.1433:17|
 :skolemid |172|
 :pattern ( (neverTriggered13 a_1) (neverTriggered13 a_1_1))
 ...
 :qid |stdinbpl.1433:17|
 :skolemid |172|
 :pattern ( (neverTriggered13 a_1@@0) (neverTriggered13 a_1_1@@0))
)) (=> (forall ((a_1@@1 T@U) ) (!  (=> (= (type a_1@@1) RefType) (=> (and (U_2_bool (MapType2Select vas@@11 a_1@@1)) (< NoPerm FullPerm)) (and (= (invRecv13 a_1@@1) a_1@@1) (qpRange13 a_1@@1))))
 :qid |stdinbpl.1439:22|
 :skolemid |173|
 :pattern ( (MapType0Select Heap@@20 null (one a_1@@1)))
 :pattern ( (MapType1Select ZeroMask null (one a_1@@1)))
 :pattern ( (MapType0Select Heap@@20 null (one a_1@@1)))
)) (=> (and (and (and (forall ((a_2_1 T@U) ) (!  (=> (= (type a_2_1) RefType) (=> (and (and (U_2_bool (MapType2Select vas@@11 (invRecv13 a_2_1))) (< NoPerm FullPerm)) (qpRange13 a_2_1)) (= (invRecv13 a_2_1) a_2_1)))
 :qid |stdinbpl.1443:22|
 :skolemid |174|
 :pattern ( (invRecv13 a_2_1))
)) (forall ((a_2_1@@0 T@U) ) (!  (=> (= (type a_2_1@@0) RefType) (=> (and (and (U_2_bool (MapType2Select vas@@11 (invRecv13 a_2_1@@0))) (< NoPerm FullPerm)) (qpRange13 a_2_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv13 a_2_1@@0) a_2_1@@0)) (= (U_2_real (MapType1Select QPMask@0 null (one a_2_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (one a_2_1@@0))) FullPerm)))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.1455:29|
 :skolemid |176|
 :pattern ( (MapType1Select ZeroMask o_3 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3 f_5))
)) (forall ((a_2_1@@1 T@U) ) (!  (=> (and (= (type a_2_1@@1) RefType) (not (and (and (U_2_bool (MapType2Select vas@@11 (invRecv13 a_2_1@@1))) (< NoPerm FullPerm)) (qpRange13 a_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (one a_2_1@@1))) (U_2_real (MapType1Select ZeroMask null (one a_2_1@@1)))))
