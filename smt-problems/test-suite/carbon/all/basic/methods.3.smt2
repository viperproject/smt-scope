...
(assert  (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type r_1) RefType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id t6_b)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct true))
(let ((anon3_Then_correct  (=> (and (and (state PostHeap@0 ZeroMask) (not (= r_1 null))) (and (state PostHeap@0 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm ZeroMask r_1 f_7))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 r_1 $allocated))) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 4) anon3_Else_correct)))))
...
(assert  (and (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type x@@8) RefType)) (= (type y@@1) RefType)) (= (type x@0) RefType)) (= (type freshObj@0) RefType)) (= (type Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id t11)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@9 y@@1 $allocated)) (state Heap@@9 ZeroMask)) (and (U_2_bool (MapType0Select Heap@@9 x@0 $allocated)) (state Heap@@9 ZeroMask))) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@9 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@9 freshObj@0 $allocated (bool_2_U true)))) (and (state Heap@0 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (not (= x@0 freshObj@0)))))))
