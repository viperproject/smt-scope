...
(assert  (and (and (and (and (and (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type xs@@11) (MapType2Type RefType boolType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@21) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Heap@2) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@54 T@U) ) (! (= (type (invRecv5 arg0@@54)) RefType)
 :qid |funType:invRecv5|
 :pattern ( (invRecv5 arg0@@54))
))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@55 T@U) ) (! (= (type (invRecv6 arg0@@55)) RefType)
...
(let ((anon6_Else_correct  (=> (HasDirectPerm Mask@0 null (bla_qp xs@@11)) (=> (and (= Heap@2 Heap@@21) (= (ControlFlow 0 4) 2)) anon4_correct))))
(let ((anon6_Then_correct  (=> (not (HasDirectPerm Mask@0 null (bla_qp xs@@11))) (=> (and (and (= Heap@0 (MapType0Store Heap@@21 null (|bla_qp#sm| xs@@11) ZeroPMask)) (= Heap@1 (MapType0Store Heap@0 null (bla_qp xs@@11) freshVersion@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 3) 2))) anon4_correct))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 12)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select xs@@11 x_1))) (U_2_bool (MapType2Select xs@@11 x_1_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= x_1 x_1_1))))
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (U_2_bool (MapType2Select xs@@11 x_1@@0))) (U_2_bool (MapType2Select xs@@11 x_1_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.1844:15|
 :skolemid |157|
...
)) (=> (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs@@11 x_1@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange5 x_1@@1) (= (invRecv5 x_1@@1) x_1@@1))))
 :qid |stdinbpl.1850:22|
 :skolemid |158|
 :pattern ( (MapType0Select Heap@@21 x_1@@1 data))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 data))
 :pattern ( (MapType2Select xs@@11 x_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select xs@@11 (invRecv5 o_3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange5 o_3)) (= (invRecv5 o_3) o_3)))
 :qid |stdinbpl.1854:22|
 :skolemid |159|
 :pattern ( (invRecv5 o_3))
))) (and (=> (= (ControlFlow 0 5) (- 0 11)) (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (U_2_bool (MapType2Select xs@@11 x_1@@2))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1860:15|
 :skolemid |160|
 :pattern ( (MapType0Select Heap@@21 x_1@@2 data))
 :pattern ( (MapType1Select QPMask@0 x_1@@2 data))
 :pattern ( (MapType2Select xs@@11 x_1@@2))
))) (=> (forall ((x_1@@3 T@U) ) (!  (=> (and (= (type x_1@@3) RefType) (U_2_bool (MapType2Select xs@@11 x_1@@3))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1860:15|
 :skolemid |160|
 :pattern ( (MapType0Select Heap@@21 x_1@@3 data))
 :pattern ( (MapType1Select QPMask@0 x_1@@3 data))
 :pattern ( (MapType2Select xs@@11 x_1@@3))
)) (=> (forall ((x_1@@4 T@U) ) (!  (=> (= (type x_1@@4) RefType) (=> (and (U_2_bool (MapType2Select xs@@11 x_1@@4)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= x_1@@4 null))))
 :qid |stdinbpl.1866:22|
 :skolemid |161|
 :pattern ( (MapType0Select Heap@@21 x_1@@4 data))
 :pattern ( (MapType1Select QPMask@0 x_1@@4 data))
 :pattern ( (MapType2Select xs@@11 x_1@@4))
)) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs@@11 (invRecv5 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange5 o_3@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv5 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 data)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 data)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (U_2_bool (MapType2Select xs@@11 (invRecv5 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange5 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 data)) (U_2_real (MapType1Select ZeroMask o_3@@0 data))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 data))) (= (U_2_real (MapType1Select ZeroMask o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.1876:29|
 :skolemid |163|
 :pattern ( (MapType1Select ZeroMask o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
))) (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0))) (and (=> (= (ControlFlow 0 5) (- 0 10)) (forall ((x_2 T@U) ) (!  (=> (= (type x_2) RefType) (=> (and (U_2_bool (MapType2Select xs@@11 x_2)) (dummyFunction (MapType0Select Heap@@21 x_2 data))) (>= (* FullPerm (/ (to_real 1) (to_real 2))) NoPerm)))
 :qid |stdinbpl.1897:17|
 :skolemid |164|
 :pattern ( (MapType0Select Heap@@21 x_2 data))
 :pattern ( (MapType1Select QPMask@1 x_2 data))
 :pattern ( (MapType2Select xs@@11 x_2))
))) (=> (forall ((x_2@@0 T@U) ) (!  (=> (= (type x_2@@0) RefType) (=> (and (U_2_bool (MapType2Select xs@@11 x_2@@0)) (dummyFunction (MapType0Select Heap@@21 x_2@@0 data))) (>= (* FullPerm (/ (to_real 1) (to_real 2))) NoPerm)))
 :qid |stdinbpl.1897:17|
 :skolemid |164|
 :pattern ( (MapType0Select Heap@@21 x_2@@0 data))
 :pattern ( (MapType1Select QPMask@1 x_2@@0 data))
 :pattern ( (MapType2Select xs@@11 x_2@@0))
)) (and (=> (= (ControlFlow 0 5) (- 0 9)) (forall ((x_2@@1 T@U) (x_2_1 T@U) ) (!  (=> (and (= (type x_2@@1) RefType) (= (type x_2_1) RefType)) (=> (and (and (and (and (not (= x_2@@1 x_2_1)) (U_2_bool (MapType2Select xs@@11 x_2@@1))) (U_2_bool (MapType2Select xs@@11 x_2_1))) (< NoPerm (* FullPerm (/ (to_real 1) (to_real 2))))) (< NoPerm (* FullPerm (/ (to_real 1) (to_real 2))))) (not (= x_2@@1 x_2_1))))
 :qid |stdinbpl.1904:17|
 :skolemid |165|
 :pattern ( (neverTriggered6 x_2@@1) (neverTriggered6 x_2_1))
))) (=> (forall ((x_2@@2 T@U) (x_2_1@@0 T@U) ) (!  (=> (and (= (type x_2@@2) RefType) (= (type x_2_1@@0) RefType)) (=> (and (and (and (and (not (= x_2@@2 x_2_1@@0)) (U_2_bool (MapType2Select xs@@11 x_2@@2))) (U_2_bool (MapType2Select xs@@11 x_2_1@@0))) (< NoPerm (* FullPerm (/ (to_real 1) (to_real 2))))) (< NoPerm (* FullPerm (/ (to_real 1) (to_real 2))))) (not (= x_2@@2 x_2_1@@0))))
 :qid |stdinbpl.1904:17|
 :skolemid |165|
 :pattern ( (neverTriggered6 x_2@@2) (neverTriggered6 x_2_1@@0))
)) (and (=> (= (ControlFlow 0 5) (- 0 8)) (forall ((x_2@@3 T@U) ) (!  (=> (and (= (type x_2@@3) RefType) (U_2_bool (MapType2Select xs@@11 x_2@@3))) (>= (U_2_real (MapType1Select QPMask@0 x_2@@3 data)) (* FullPerm (/ (to_real 1) (to_real 2)))))
 :qid |stdinbpl.1911:17|
 :skolemid |166|
 :pattern ( (MapType0Select Heap@@21 x_2@@3 data))
 :pattern ( (MapType1Select QPMask@1 x_2@@3 data))
 :pattern ( (MapType2Select xs@@11 x_2@@3))
))) (=> (forall ((x_2@@4 T@U) ) (!  (=> (and (= (type x_2@@4) RefType) (U_2_bool (MapType2Select xs@@11 x_2@@4))) (>= (U_2_real (MapType1Select QPMask@0 x_2@@4 data)) (* FullPerm (/ (to_real 1) (to_real 2)))))
 :qid |stdinbpl.1911:17|
 :skolemid |166|
 :pattern ( (MapType0Select Heap@@21 x_2@@4 data))
 :pattern ( (MapType1Select QPMask@1 x_2@@4 data))
 :pattern ( (MapType2Select xs@@11 x_2@@4))
)) (=> (and (and (forall ((x_2@@5 T@U) ) (!  (=> (= (type x_2@@5) RefType) (=> (and (U_2_bool (MapType2Select xs@@11 x_2@@5)) (< NoPerm (* FullPerm (/ (to_real 1) (to_real 2))))) (and (qpRange6 x_2@@5) (= (invRecv6 x_2@@5) x_2@@5))))
 :qid |stdinbpl.1917:22|
 :skolemid |167|
 :pattern ( (MapType0Select Heap@@21 x_2@@5 data))
 :pattern ( (MapType1Select QPMask@1 x_2@@5 data))
 :pattern ( (MapType2Select xs@@11 x_2@@5))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType2Select xs@@11 (invRecv6 o_3@@2))) (and (< NoPerm (* FullPerm (/ (to_real 1) (to_real 2)))) (qpRange6 o_3@@2))) (= (invRecv6 o_3@@2) o_3@@2)))
 :qid |stdinbpl.1921:22|
 :skolemid |168|
 :pattern ( (invRecv6 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType2Select xs@@11 (invRecv6 o_3@@3))) (and (< NoPerm (* FullPerm (/ (to_real 1) (to_real 2)))) (qpRange6 o_3@@3))) (and (= (invRecv6 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 data)) (- (U_2_real (MapType1Select QPMask@0 o_3@@3 data)) (* FullPerm (/ (to_real 1) (to_real 2))))))) (=> (not (and (U_2_bool (MapType2Select xs@@11 (invRecv6 o_3@@3))) (and (< NoPerm (* FullPerm (/ (to_real 1) (to_real 2)))) (qpRange6 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 data)) (U_2_real (MapType1Select QPMask@0 o_3@@3 data))))))
 :qid |stdinbpl.1927:22|
 :skolemid |169|
 :pattern ( (MapType1Select QPMask@1 o_3@@3 data))
)) (forall ((o_3@@4 T@U) (f_5@@0 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_5@@0))))
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 data))) (= (U_2_real (MapType1Select QPMask@0 o_3@@4 f_5@@0)) (U_2_real (MapType1Select QPMask@1 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.1933:29|
 :skolemid |170|
 :pattern ( (MapType1Select QPMask@1 o_3@@4 f_5@@0))
)))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (foo_qp Heap@@21 xs@@11)) (=> (foo_qp Heap@@21 xs@@11) (=> (= perm@0 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (= Mask@0 (MapType1Store QPMask@1 null (bla_qp xs@@11) (real_2_U (+ (U_2_real (MapType1Select QPMask@1 null (bla_qp xs@@11))) perm@0)))) (=> (and (and (state Heap@@21 Mask@0) (state Heap@@21 Mask@0)) (and (|bla_qp#trigger| Heap@@21 (bla_qp xs@@11)) (= (MapType0Select Heap@@21 null (bla_qp xs@@11)) (FrameFragment (int_2_U (|bla_qp#condqp2| Heap@@21 xs@@11)))))) (and (=> (= (ControlFlow 0 5) 3) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))))))))))))))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@21 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 13) 1) anon5_Then_correct) (=> (= (ControlFlow 0 13) 5) anon5_Else_correct)))))
