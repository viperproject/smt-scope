...
(assert  (and (and (= (type xs@@3) (SeqType RefType)) (= (type x_13) RefType)) (= (type Heap@@15) (MapType0Type RefType))))
(set-info :boogie-vc-id m2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (|Seq#Contains| xs@@3 x_3)) (|Seq#Contains| xs@@3 x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1))))
...
(let ((anon7_Else_correct  (=> (forall ((x_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (|Seq#Contains| xs@@3 x_1)) (> (U_2_int (MapType0Select Heap@@15 x_1 f_7)) 0))
 :qid |stdinbpl.1037:20|
 :skolemid |95|
 :pattern ( (|Seq#ContainsTrigger| xs@@3 x_1))
 :pattern ( (|Seq#Contains| xs@@3 x_1))
)) (and (=> (= (ControlFlow 0 8) 5) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct)))))
(let ((anon3_correct true))
(let ((anon8_Else_correct  (=> (and (not (|Seq#Contains| xs@@3 x_13)) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon8_Then_correct  (=> (|Seq#Contains| xs@@3 x_13) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm ZeroMask x_13 f_7)) (=> (HasDirectPerm ZeroMask x_13 f_7) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (and (=> (= (ControlFlow 0 9) 8) anon7_Else_correct) (=> (= (ControlFlow 0 9) 2) anon8_Then_correct)) (=> (= (ControlFlow 0 9) 4) anon8_Else_correct)))))
