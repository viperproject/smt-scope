...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 26) (let ((anon15_correct  (=> (state Heap@5 Mask@0) (=> (and (= Result@0 (+ 1 (ite (= (MapType0Select Heap@5 this@@10 next) null) 0 (length Heap@5 (MapType0Select Heap@5 this@@10 next))))) (= (ControlFlow 0 6) (- 0 5))) (> Result@0 0)))))
(let ((anon22_Else_correct  (=> (= (MapType0Select Heap@3 this@@10 next) null) (=> (and (= Heap@5 Heap@3) (= (ControlFlow 0 8) 6)) anon15_correct))))
(let ((anon22_Then_correct  (=> (not (= (MapType0Select Heap@3 this@@10 next) null)) (=> (and (and (forall ((o_4 T@U) (f_8 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_8))))
(let ((A@@12 (FieldTypeInv0 (type f_8))))
 (=> (and (and (= (type o_4) RefType) (= (type f_8) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@3 null (|node#sm| this@@10)) o_4 f_8)) (U_2_bool (MapType1Select (MapType0Select Heap@3 null (|node#sm| (MapType0Select Heap@3 this@@10 next))) o_4 f_8)))) (U_2_bool (MapType1Select newPMask@1 o_4 f_8)))))
 :qid |stdinbpl.323:33|
 :skolemid |28|
 :pattern ( (MapType1Select newPMask@1 o_4 f_8))
)) (= Heap@4 (MapType0Store Heap@3 null (|node#sm| this@@10) newPMask@1))) (and (= Heap@5 Heap@4) (= (ControlFlow 0 7) 6))) anon15_correct))))
(let ((anon13_correct  (=> (and (state Heap@2 Mask@0) (= Heap@3 (MapType0Store Heap@2 null (|node#sm| this@@10) (MapType1Store (MapType0Select Heap@2 null (|node#sm| this@@10)) this@@10 next (bool_2_U true))))) (and (=> (= (ControlFlow 0 9) 7) anon22_Then_correct) (=> (= (ControlFlow 0 9) 8) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (= (MapType0Select Heap@0 this@@10 next) null) (=> (and (= Heap@2 Heap@0) (= (ControlFlow 0 11) 9)) anon13_correct))))
(let ((anon21_Then_correct  (=> (not (= (MapType0Select Heap@0 this@@10 next) null)) (=> (and (and (forall ((o_3 T@U) (f_7 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_7))))
(let ((A@@13 (FieldTypeInv0 (type f_7))))
 (=> (and (and (= (type o_3) RefType) (= (type f_7) (FieldType A@@13 B@@12))) (or (U_2_bool (MapType1Select (MapType0Select Heap@0 null (|node#sm| this@@10)) o_3 f_7)) (U_2_bool (MapType1Select (MapType0Select Heap@0 null (|node#sm| (MapType0Select Heap@0 this@@10 next))) o_3 f_7)))) (U_2_bool (MapType1Select newPMask@0 o_3 f_7)))))
 :qid |stdinbpl.311:33|
 :skolemid |27|
 :pattern ( (MapType1Select newPMask@0 o_3 f_7))
)) (= Heap@1 (MapType0Store Heap@0 null (|node#sm| this@@10) newPMask@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 10) 9))) anon13_correct))))
(let ((anon11_correct  (=> (= Heap@0 (MapType0Store Heap@@15 null (|node#sm| this@@10) (MapType1Store (MapType0Select Heap@@15 null (|node#sm| this@@10)) this@@10 next (bool_2_U true)))) (and (=> (= (ControlFlow 0 12) 10) anon21_Then_correct) (=> (= (ControlFlow 0 12) 11) anon21_Else_correct)))))
(let ((anon19_Else_correct  (=> (and (|length#trigger| (MapType0Select Heap@@15 null (node (MapType0Select Heap@@15 this@@10 next))) (MapType0Select Heap@@15 this@@10 next)) (= (ControlFlow 0 14) 12)) anon11_correct)))
(let ((anon18_Then_correct  (=> (and (= (MapType0Select Heap@@15 this@@10 next) null) (= (ControlFlow 0 13) 12)) anon11_correct)))
(let ((anon9_correct true))
(let ((anon20_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon9_correct)))
(let ((anon20_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@3 null (node (MapType0Select Heap@@15 this@@10 next)))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@3 null (node (MapType0Select Heap@@15 this@@10 next))))) (=> (= (ControlFlow 0 2) 1) anon9_correct))))))
(let ((anon18_Else_correct  (=> (not (= (MapType0Select Heap@@15 this@@10 next) null)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm UnfoldingMask@3 this@@10 next)) (=> (HasDirectPerm UnfoldingMask@3 this@@10 next) (and (and (=> (= (ControlFlow 0 15) 14) anon19_Else_correct) (=> (= (ControlFlow 0 15) 2) anon20_Then_correct)) (=> (= (ControlFlow 0 15) 4) anon20_Else_correct)))))))
(let ((anon4_correct  (=> (state Heap@@15 UnfoldingMask@3) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm UnfoldingMask@3 this@@10 next)) (=> (HasDirectPerm UnfoldingMask@3 this@@10 next) (and (=> (= (ControlFlow 0 17) 13) anon18_Then_correct) (=> (= (ControlFlow 0 17) 15) anon18_Else_correct)))))))
(let ((anon17_Else_correct  (=> (= (MapType0Select Heap@@15 this@@10 next) null) (=> (and (= UnfoldingMask@3 UnfoldingMask@1) (= (ControlFlow 0 20) 17)) anon4_correct))))
(let ((anon17_Then_correct  (=> (and (not (= (MapType0Select Heap@@15 this@@10 next) null)) (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 null (node (MapType0Select Heap@@15 this@@10 next)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 null (node (MapType0Select Heap@@15 this@@10 next)))) FullPerm))))) (=> (and (and (InsidePredicate (node this@@10) (MapType0Select Heap@@15 null (node this@@10)) (node (MapType0Select Heap@@15 this@@10 next)) (MapType0Select Heap@@15 null (node (MapType0Select Heap@@15 this@@10 next)))) (state Heap@@15 UnfoldingMask@2)) (and (= UnfoldingMask@3 UnfoldingMask@2) (= (ControlFlow 0 19) 17))) anon4_correct))))
(let ((anon2_correct  (=> (and (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (node this@@10) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (node this@@10))) FullPerm)))) (not (= this@@10 null))) (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this@@10 next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this@@10 next)) FullPerm)))) (state Heap@@15 UnfoldingMask@1))) (and (=> (= (ControlFlow 0 21) 19) anon17_Then_correct) (=> (= (ControlFlow 0 21) 20) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 24) 21)) anon2_correct)))
(let ((anon16_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (node this@@10))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (node this@@10)))) (=> (= (ControlFlow 0 22) 21) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@15 ZeroMask) (U_2_bool (MapType0Select Heap@@15 this@@10 $allocated))) (and (= AssumeFunctionsAbove 0) (= Mask@0 (MapType1Store ZeroMask null (node this@@10) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (node this@@10))) FullPerm)))))) (and (and (state Heap@@15 Mask@0) (state Heap@@15 Mask@0)) (and (|node#trigger| Heap@@15 (node this@@10)) (= (MapType0Select Heap@@15 null (node this@@10)) (CombineFrames (FrameFragment (MapType0Select Heap@@15 this@@10 next)) (FrameFragment (ite (not (= (MapType0Select Heap@@15 this@@10 next) null)) (MapType0Select Heap@@15 null (node (MapType0Select Heap@@15 this@@10 next))) EmptyFrame))))))) (and (=> (= (ControlFlow 0 25) 22) anon16_Then_correct) (=> (= (ControlFlow 0 25) 24) anon16_Else_correct)))))
