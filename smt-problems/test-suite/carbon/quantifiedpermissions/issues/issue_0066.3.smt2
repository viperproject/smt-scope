...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (Ctor RefType) 8)) (= (type f_7) (FieldType NormalFieldType RefType))) (= (type g) (FieldType NormalFieldType intType))))
...
(declare-fun s_11 () T@U)
(declare-fun s1_5 () T@U)
(declare-fun s2_5 () T@U)
(declare-fun qpRange12 (T@U) Bool)
(declare-fun invRecv12 (T@U) T@U)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type S) (MapType2Type RefType boolType)) (= (type s1_5) RefType)) (= (type s2_5) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type s_11) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type s1_4_1) RefType)) (= (type s2_4_1) RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv16 arg0@@43)) RefType)
 :qid |funType:invRecv16|
 :pattern ( (invRecv16 arg0@@43))
))) (= (type s1_6) RefType)) (= (type s2_6) RefType)) (= (type QPMask@4) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv15 arg0@@44)) RefType)
 :qid |funType:invRecv15|
 :pattern ( (invRecv15 arg0@@44))
))) (= (type s_12) RefType)) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv14 arg0@@45)) RefType)
 :qid |funType:invRecv14|
 :pattern ( (invRecv14 arg0@@45))
))) (forall ((arg0@@46 T@U) ) (! (= (type (invRecv13 arg0@@46)) RefType)
 :qid |funType:invRecv13|
 :pattern ( (invRecv13 arg0@@46))
))) (forall ((arg0@@47 T@U) ) (! (= (type (invRecv12 arg0@@47)) RefType)
...
(let ((anon37_Else_correct  (=> (and (not (U_2_bool (MapType2Select S s_12))) (= (ControlFlow 0 35) 32)) anon20_correct)))
(let ((anon37_Then_correct  (=> (U_2_bool (MapType2Select S s_12)) (and (=> (= (ControlFlow 0 33) (- 0 34)) (HasDirectPerm QPMask@4 s_12 f_7)) (=> (HasDirectPerm QPMask@4 s_12 f_7) (=> (= (ControlFlow 0 33) 32) anon20_correct))))))
(let ((anon36_Else_correct  (and (=> (= (ControlFlow 0 30) (- 0 31)) (forall ((s_7 T@U) (s_7_1 T@U) ) (!  (=> (and (= (type s_7) RefType) (= (type s_7_1) RefType)) (=> (and (and (and (and (not (= s_7 s_7_1)) (U_2_bool (MapType2Select S s_7))) (U_2_bool (MapType2Select S s_7_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (MapType0Select PostHeap@0 s_7 f_7) (MapType0Select PostHeap@0 s_7_1 f_7)))))
 :qid |stdinbpl.1407:15|
 :skolemid |175|
 :no-pattern (type s_7)
 :no-pattern (type s_7_1)
 :no-pattern (U_2_int s_7)
 :no-pattern (U_2_bool s_7)
 :no-pattern (U_2_int s_7_1)
 :no-pattern (U_2_bool s_7_1)
))) (=> (forall ((s_7@@0 T@U) (s_7_1@@0 T@U) ) (!  (=> (and (= (type s_7@@0) RefType) (= (type s_7_1@@0) RefType)) (=> (and (and (and (and (not (= s_7@@0 s_7_1@@0)) (U_2_bool (MapType2Select S s_7@@0))) (U_2_bool (MapType2Select S s_7_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (MapType0Select PostHeap@0 s_7@@0 f_7) (MapType0Select PostHeap@0 s_7_1@@0 f_7)))))
 :qid |stdinbpl.1407:15|
 :skolemid |175|
 :no-pattern (type s_7@@0)
 :no-pattern (type s_7_1@@0)
 :no-pattern (U_2_int s_7@@0)
 :no-pattern (U_2_bool s_7@@0)
 :no-pattern (U_2_int s_7_1@@0)
 :no-pattern (U_2_bool s_7_1@@0)
)) (=> (forall ((s_7@@1 T@U) ) (!  (=> (= (type s_7@@1) RefType) (=> (and (U_2_bool (MapType2Select S s_7@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange15 (MapType0Select PostHeap@0 s_7@@1 f_7)) (= (invRecv15 (MapType0Select PostHeap@0 s_7@@1 f_7)) s_7@@1))))
 :qid |stdinbpl.1413:22|
 :skolemid |176|
 :pattern ( (MapType0Select PostHeap@0 s_7@@1 f_7))
 :pattern ( (MapType2Select S s_7@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select S (invRecv15 o_3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange15 o_3)) (= (MapType0Select PostHeap@0 (invRecv15 o_3) f_7) o_3)))
 :qid |stdinbpl.1417:22|
 :skolemid |177|
 :pattern ( (invRecv15 o_3))
)) (= (ControlFlow 0 30) (- 0 29))) (forall ((s_7@@2 T@U) ) (!  (=> (and (= (type s_7@@2) RefType) (U_2_bool (MapType2Select S s_7@@2))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1423:15|
 :skolemid |178|
 :pattern ( (MapType0Select PostHeap@0 s_7@@2 f_7))
 :pattern ( (MapType2Select S s_7@@2))
))))))))
(let ((anon34_Else_correct  (=> (and (forall ((s1_3_1 T@U) (s2_3_1 T@U) ) (!  (=> (and (and (= (type s1_3_1) RefType) (= (type s2_3_1) RefType)) (and (U_2_bool (MapType2Select S s1_3_1)) (and (U_2_bool (MapType2Select S s2_3_1)) (not (= s1_3_1 s2_3_1))))) (not (= (MapType0Select PostHeap@0 s1_3_1 f_7) (MapType0Select PostHeap@0 s2_3_1 f_7))))
 :qid |stdinbpl.1391:20|
 :skolemid |174|
 :pattern ( (MapType2Select S s1_3_1) (MapType2Select S s2_3_1))
...
(let ((anon35_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select S s1_6)) (and (U_2_bool (MapType2Select S s2_6)) (not (= s1_6 s2_6))))) (= (ControlFlow 0 28) 24)) anon16_correct)))
(let ((anon35_Then_correct  (=> (and (U_2_bool (MapType2Select S s1_6)) (and (U_2_bool (MapType2Select S s2_6)) (not (= s1_6 s2_6)))) (and (=> (= (ControlFlow 0 25) (- 0 27)) (HasDirectPerm QPMask@4 s1_6 f_7)) (=> (HasDirectPerm QPMask@4 s1_6 f_7) (and (=> (= (ControlFlow 0 25) (- 0 26)) (HasDirectPerm QPMask@4 s2_6 f_7)) (=> (HasDirectPerm QPMask@4 s2_6 f_7) (=> (= (ControlFlow 0 25) 24) anon16_correct))))))))
(let ((anon33_Else_correct  (and (=> (= (ControlFlow 0 37) (- 0 39)) (forall ((s_5 T@U) (s_5_1 T@U) ) (!  (=> (and (= (type s_5) RefType) (= (type s_5_1) RefType)) (=> (and (and (and (and (not (= s_5 s_5_1)) (U_2_bool (MapType2Select S s_5))) (U_2_bool (MapType2Select S s_5_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= s_5 s_5_1))))
 :qid |stdinbpl.1341:15|
 :skolemid |167|
 :no-pattern (type s_5)
 :no-pattern (type s_5_1)
 :no-pattern (U_2_int s_5)
 :no-pattern (U_2_bool s_5)
 :no-pattern (U_2_int s_5_1)
 :no-pattern (U_2_bool s_5_1)
))) (=> (forall ((s_5@@0 T@U) (s_5_1@@0 T@U) ) (!  (=> (and (= (type s_5@@0) RefType) (= (type s_5_1@@0) RefType)) (=> (and (and (and (and (not (= s_5@@0 s_5_1@@0)) (U_2_bool (MapType2Select S s_5@@0))) (U_2_bool (MapType2Select S s_5_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= s_5@@0 s_5_1@@0))))
 :qid |stdinbpl.1341:15|
 :skolemid |167|
 :no-pattern (type s_5@@0)
 :no-pattern (type s_5_1@@0)
 :no-pattern (U_2_int s_5@@0)
 :no-pattern (U_2_bool s_5@@0)
 :no-pattern (U_2_int s_5_1@@0)
 :no-pattern (U_2_bool s_5_1@@0)
)) (=> (and (forall ((s_5@@1 T@U) ) (!  (=> (= (type s_5@@1) RefType) (=> (and (U_2_bool (MapType2Select S s_5@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange14 s_5@@1) (= (invRecv14 s_5@@1) s_5@@1))))
 :qid |stdinbpl.1347:22|
 :skolemid |168|
 :pattern ( (MapType0Select PostHeap@0 s_5@@1 f_7))
 :pattern ( (MapType1Select QPMask@4 s_5@@1 f_7))
 :pattern ( (MapType2Select S s_5@@1))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (=> (and (and (U_2_bool (MapType2Select S (invRecv14 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange14 o_3@@0)) (= (invRecv14 o_3@@0) o_3@@0)))
 :qid |stdinbpl.1351:22|
 :skolemid |169|
 :pattern ( (invRecv14 o_3@@0))
))) (and (=> (= (ControlFlow 0 37) (- 0 38)) (forall ((s_5@@2 T@U) ) (!  (=> (and (= (type s_5@@2) RefType) (U_2_bool (MapType2Select S s_5@@2))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1357:15|
 :skolemid |170|
 :pattern ( (MapType0Select PostHeap@0 s_5@@2 f_7))
 :pattern ( (MapType1Select QPMask@4 s_5@@2 f_7))
 :pattern ( (MapType2Select S s_5@@2))
))) (=> (forall ((s_5@@3 T@U) ) (!  (=> (and (= (type s_5@@3) RefType) (U_2_bool (MapType2Select S s_5@@3))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1357:15|
 :skolemid |170|
 :pattern ( (MapType0Select PostHeap@0 s_5@@3 f_7))
 :pattern ( (MapType1Select QPMask@4 s_5@@3 f_7))
 :pattern ( (MapType2Select S s_5@@3))
)) (=> (forall ((s_5@@4 T@U) ) (!  (=> (= (type s_5@@4) RefType) (=> (and (U_2_bool (MapType2Select S s_5@@4)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= s_5@@4 null))))
 :qid |stdinbpl.1363:22|
 :skolemid |171|
 :pattern ( (MapType0Select PostHeap@0 s_5@@4 f_7))
 :pattern ( (MapType1Select QPMask@4 s_5@@4 f_7))
 :pattern ( (MapType2Select S s_5@@4))
)) (=> (and (and (forall ((o_3@@1 T@U) ) (!  (=> (= (type o_3@@1) RefType) (and (=> (and (and (U_2_bool (MapType2Select S (invRecv14 o_3@@1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange14 o_3@@1)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv14 o_3@@1) o_3@@1)) (= (U_2_real (MapType1Select QPMask@4 o_3@@1 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@1 f_7)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (U_2_bool (MapType2Select S (invRecv14 o_3@@1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange14 o_3@@1))) (= (U_2_real (MapType1Select QPMask@4 o_3@@1 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@1 f_7))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@2) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 f_7))) (= (U_2_real (MapType1Select ZeroMask o_3@@2 f_5)) (U_2_real (MapType1Select QPMask@4 o_3@@2 f_5))))))
 :qid |stdinbpl.1373:29|
 :skolemid |173|
 :pattern ( (MapType1Select ZeroMask o_3@@2 f_5))
 :pattern ( (MapType1Select QPMask@4 o_3@@2 f_5))
...
(let ((anon39_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select S s1_4_1)) (and (U_2_bool (MapType2Select S s2_4_1)) (not (= s1_4_1 s2_4_1))))) (= (ControlFlow 0 18) 15)) anon25_correct)))
(let ((anon39_Then_correct  (=> (and (U_2_bool (MapType2Select S s1_4_1)) (and (U_2_bool (MapType2Select S s2_4_1)) (not (= s1_4_1 s2_4_1)))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (not (= (MapType0Select Heap@@9 s1_4_1 f_7) (MapType0Select Heap@@9 s2_4_1 f_7)))) (=> (not (= (MapType0Select Heap@@9 s1_4_1 f_7) (MapType0Select Heap@@9 s2_4_1 f_7))) (=> (= (ControlFlow 0 16) 15) anon25_correct))))))
(let ((anon38_Else_correct  (=> (forall ((s1_5_1 T@U) (s2_5_1 T@U) ) (!  (=> (and (and (= (type s1_5_1) RefType) (= (type s2_5_1) RefType)) (and (U_2_bool (MapType2Select S s1_5_1)) (and (U_2_bool (MapType2Select S s2_5_1)) (not (= s1_5_1 s2_5_1))))) (not (= (MapType0Select Heap@@9 s1_5_1 f_7) (MapType0Select Heap@@9 s2_5_1 f_7))))
 :qid |stdinbpl.1505:20|
 :skolemid |189|
 :pattern ( (MapType2Select S s1_5_1) (MapType2Select S s2_5_1))
)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (forall ((s_9 T@U) ) (!  (=> (= (type s_9) RefType) (=> (and (U_2_bool (MapType2Select S s_9)) (dummyFunction (MapType0Select Heap@@9 (MapType0Select Heap@@9 s_9 f_7) g))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.1513:17|
 :skolemid |190|
 :pattern ( (MapType0Select Heap@@9 s_9 f_7))
 :pattern ( (MapType2Select S s_9))
))) (=> (forall ((s_9@@0 T@U) ) (!  (=> (= (type s_9@@0) RefType) (=> (and (U_2_bool (MapType2Select S s_9@@0)) (dummyFunction (MapType0Select Heap@@9 (MapType0Select Heap@@9 s_9@@0 f_7) g))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.1513:17|
 :skolemid |190|
 :pattern ( (MapType0Select Heap@@9 s_9@@0 f_7))
 :pattern ( (MapType2Select S s_9@@0))
)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((s_9@@1 T@U) (s_9_1 T@U) ) (!  (=> (and (= (type s_9@@1) RefType) (= (type s_9_1) RefType)) (=> (and (and (and (and (not (= s_9@@1 s_9_1)) (U_2_bool (MapType2Select S s_9@@1))) (U_2_bool (MapType2Select S s_9_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (MapType0Select Heap@@9 s_9@@1 f_7) (MapType0Select Heap@@9 s_9_1 f_7)))))
 :qid |stdinbpl.1520:17|
 :skolemid |191|
 :pattern ( (neverTriggered17 s_9@@1) (neverTriggered17 s_9_1))
))) (=> (forall ((s_9@@2 T@U) (s_9_1@@0 T@U) ) (!  (=> (and (= (type s_9@@2) RefType) (= (type s_9_1@@0) RefType)) (=> (and (and (and (and (not (= s_9@@2 s_9_1@@0)) (U_2_bool (MapType2Select S s_9@@2))) (U_2_bool (MapType2Select S s_9_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (MapType0Select Heap@@9 s_9@@2 f_7) (MapType0Select Heap@@9 s_9_1@@0 f_7)))))
 :qid |stdinbpl.1520:17|
 :skolemid |191|
 :pattern ( (neverTriggered17 s_9@@2) (neverTriggered17 s_9_1@@0))
)) (=> (= (ControlFlow 0 12) (- 0 11)) (forall ((s_9@@3 T@U) ) (!  (=> (and (= (type s_9@@3) RefType) (U_2_bool (MapType2Select S s_9@@3))) (>= (U_2_real (MapType1Select QPMask@2 (MapType0Select Heap@@9 s_9@@3 f_7) g)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.1527:17|
 :skolemid |192|
 :pattern ( (MapType0Select Heap@@9 s_9@@3 f_7))
 :pattern ( (MapType2Select S s_9@@3))
))))))))))
(let ((anon32_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 22)) (forall ((s_8 T@U) ) (!  (=> (= (type s_8) RefType) (=> (and (U_2_bool (MapType2Select S s_8)) (dummyFunction (MapType0Select Heap@@9 s_8 f_7))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.1457:17|
 :skolemid |182|
 :pattern ( (MapType0Select Heap@@9 s_8 f_7))
 :pattern ( (MapType1Select QPMask@2 s_8 f_7))
 :pattern ( (MapType2Select S s_8))
))) (=> (forall ((s_8@@0 T@U) ) (!  (=> (= (type s_8@@0) RefType) (=> (and (U_2_bool (MapType2Select S s_8@@0)) (dummyFunction (MapType0Select Heap@@9 s_8@@0 f_7))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.1457:17|
 :skolemid |182|
 :pattern ( (MapType0Select Heap@@9 s_8@@0 f_7))
 :pattern ( (MapType1Select QPMask@2 s_8@@0 f_7))
 :pattern ( (MapType2Select S s_8@@0))
)) (and (=> (= (ControlFlow 0 19) (- 0 21)) (forall ((s_8@@1 T@U) (s_8_1 T@U) ) (!  (=> (and (= (type s_8@@1) RefType) (= (type s_8_1) RefType)) (=> (and (and (and (and (not (= s_8@@1 s_8_1)) (U_2_bool (MapType2Select S s_8@@1))) (U_2_bool (MapType2Select S s_8_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= s_8@@1 s_8_1))))
 :qid |stdinbpl.1464:17|
 :skolemid |183|
 :pattern ( (neverTriggered16 s_8@@1) (neverTriggered16 s_8_1))
))) (=> (forall ((s_8@@2 T@U) (s_8_1@@0 T@U) ) (!  (=> (and (= (type s_8@@2) RefType) (= (type s_8_1@@0) RefType)) (=> (and (and (and (and (not (= s_8@@2 s_8_1@@0)) (U_2_bool (MapType2Select S s_8@@2))) (U_2_bool (MapType2Select S s_8_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= s_8@@2 s_8_1@@0))))
 :qid |stdinbpl.1464:17|
 :skolemid |183|
 :pattern ( (neverTriggered16 s_8@@2) (neverTriggered16 s_8_1@@0))
)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((s_8@@3 T@U) ) (!  (=> (and (= (type s_8@@3) RefType) (U_2_bool (MapType2Select S s_8@@3))) (>= (U_2_real (MapType1Select QPMask@1 s_8@@3 f_7)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.1471:17|
 :skolemid |184|
 :pattern ( (MapType0Select Heap@@9 s_8@@3 f_7))
 :pattern ( (MapType1Select QPMask@2 s_8@@3 f_7))
 :pattern ( (MapType2Select S s_8@@3))
))) (=> (forall ((s_8@@4 T@U) ) (!  (=> (and (= (type s_8@@4) RefType) (U_2_bool (MapType2Select S s_8@@4))) (>= (U_2_real (MapType1Select QPMask@1 s_8@@4 f_7)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.1471:17|
 :skolemid |184|
 :pattern ( (MapType0Select Heap@@9 s_8@@4 f_7))
 :pattern ( (MapType1Select QPMask@2 s_8@@4 f_7))
 :pattern ( (MapType2Select S s_8@@4))
)) (=> (and (and (forall ((s_8@@5 T@U) ) (!  (=> (= (type s_8@@5) RefType) (=> (and (U_2_bool (MapType2Select S s_8@@5)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange16 s_8@@5) (= (invRecv16 s_8@@5) s_8@@5))))
 :qid |stdinbpl.1477:22|
 :skolemid |185|
 :pattern ( (MapType0Select Heap@@9 s_8@@5 f_7))
 :pattern ( (MapType1Select QPMask@2 s_8@@5 f_7))
 :pattern ( (MapType2Select S s_8@@5))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (=> (and (U_2_bool (MapType2Select S (invRecv16 o_3@@3))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange16 o_3@@3))) (= (invRecv16 o_3@@3) o_3@@3)))
 :qid |stdinbpl.1481:22|
 :skolemid |186|
 :pattern ( (invRecv16 o_3@@3))
))) (and (forall ((o_3@@4 T@U) ) (!  (=> (= (type o_3@@4) RefType) (and (=> (and (U_2_bool (MapType2Select S (invRecv16 o_3@@4))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange16 o_3@@4))) (and (= (invRecv16 o_3@@4) o_3@@4) (= (U_2_real (MapType1Select QPMask@2 o_3@@4 f_7)) (- (U_2_real (MapType1Select QPMask@1 o_3@@4 f_7)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (U_2_bool (MapType2Select S (invRecv16 o_3@@4))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange16 o_3@@4)))) (= (U_2_real (MapType1Select QPMask@2 o_3@@4 f_7)) (U_2_real (MapType1Select QPMask@1 o_3@@4 f_7))))))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@5) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 f_7))) (= (U_2_real (MapType1Select QPMask@1 o_3@@5 f_5@@0)) (U_2_real (MapType1Select QPMask@2 o_3@@5 f_5@@0))))))
 :qid |stdinbpl.1493:29|
 :skolemid |188|
 :pattern ( (MapType1Select QPMask@2 o_3@@5 f_5@@0))
...
(let ((anon30_Else_correct  (and (=> (= (ControlFlow 0 41) (- 0 43)) (forall ((s_3 T@U) (s_3_1 T@U) ) (!  (=> (and (= (type s_3) RefType) (= (type s_3_1) RefType)) (=> (and (and (and (and (not (= s_3 s_3_1)) (U_2_bool (MapType2Select S s_3))) (U_2_bool (MapType2Select S s_3_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (MapType0Select Heap@@9 s_3 f_7) (MapType0Select Heap@@9 s_3_1 f_7)))))
 :qid |stdinbpl.1284:15|
 :skolemid |160|
 :no-pattern (type s_3)
 :no-pattern (type s_3_1)
 :no-pattern (U_2_int s_3)
 :no-pattern (U_2_bool s_3)
 :no-pattern (U_2_int s_3_1)
 :no-pattern (U_2_bool s_3_1)
))) (=> (forall ((s_3@@0 T@U) (s_3_1@@0 T@U) ) (!  (=> (and (= (type s_3@@0) RefType) (= (type s_3_1@@0) RefType)) (=> (and (and (and (and (not (= s_3@@0 s_3_1@@0)) (U_2_bool (MapType2Select S s_3@@0))) (U_2_bool (MapType2Select S s_3_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (MapType0Select Heap@@9 s_3@@0 f_7) (MapType0Select Heap@@9 s_3_1@@0 f_7)))))
 :qid |stdinbpl.1284:15|
 :skolemid |160|
 :no-pattern (type s_3@@0)
 :no-pattern (type s_3_1@@0)
 :no-pattern (U_2_int s_3@@0)
 :no-pattern (U_2_bool s_3@@0)
 :no-pattern (U_2_int s_3_1@@0)
 :no-pattern (U_2_bool s_3_1@@0)
)) (=> (and (forall ((s_3@@1 T@U) ) (!  (=> (= (type s_3@@1) RefType) (=> (and (U_2_bool (MapType2Select S s_3@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange13 (MapType0Select Heap@@9 s_3@@1 f_7)) (= (invRecv13 (MapType0Select Heap@@9 s_3@@1 f_7)) s_3@@1))))
 :qid |stdinbpl.1290:22|
 :skolemid |161|
 :pattern ( (MapType0Select Heap@@9 s_3@@1 f_7))
 :pattern ( (MapType2Select S s_3@@1))
)) (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (=> (and (and (U_2_bool (MapType2Select S (invRecv13 o_3@@6))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange13 o_3@@6)) (= (MapType0Select Heap@@9 (invRecv13 o_3@@6) f_7) o_3@@6)))
 :qid |stdinbpl.1294:22|
 :skolemid |162|
 :pattern ( (invRecv13 o_3@@6))
))) (and (=> (= (ControlFlow 0 41) (- 0 42)) (forall ((s_3@@2 T@U) ) (!  (=> (and (= (type s_3@@2) RefType) (U_2_bool (MapType2Select S s_3@@2))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1300:15|
 :skolemid |163|
 :pattern ( (MapType0Select Heap@@9 s_3@@2 f_7))
 :pattern ( (MapType2Select S s_3@@2))
))) (=> (forall ((s_3@@3 T@U) ) (!  (=> (and (= (type s_3@@3) RefType) (U_2_bool (MapType2Select S s_3@@3))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1300:15|
 :skolemid |163|
 :pattern ( (MapType0Select Heap@@9 s_3@@3 f_7))
 :pattern ( (MapType2Select S s_3@@3))
)) (=> (forall ((s_3@@4 T@U) ) (!  (=> (= (type s_3@@4) RefType) (=> (and (U_2_bool (MapType2Select S s_3@@4)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (MapType0Select Heap@@9 s_3@@4 f_7) null))))
 :qid |stdinbpl.1306:22|
 :skolemid |164|
 :pattern ( (MapType0Select Heap@@9 s_3@@4 f_7))
 :pattern ( (MapType2Select S s_3@@4))
)) (=> (and (and (forall ((o_3@@7 T@U) ) (!  (=> (= (type o_3@@7) RefType) (and (=> (and (and (U_2_bool (MapType2Select S (invRecv13 o_3@@7))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange13 o_3@@7)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (MapType0Select Heap@@9 (invRecv13 o_3@@7) f_7) o_3@@7)) (= (U_2_real (MapType1Select QPMask@1 o_3@@7 g)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@7 g)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (U_2_bool (MapType2Select S (invRecv13 o_3@@7))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange13 o_3@@7))) (= (U_2_real (MapType1Select QPMask@1 o_3@@7 g)) (U_2_real (MapType1Select QPMask@0 o_3@@7 g))))))
 :qid |stdinbpl.1312:22|
 :skolemid |165|
 :pattern ( (MapType1Select QPMask@1 o_3@@7 g))
)) (forall ((o_3@@8 T@U) (f_5@@1 T@U) ) (! (let ((B@@13 (FieldTypeInv1 (type f_5@@1))))
(let ((A@@14 (FieldTypeInv0 (type f_5@@1))))
 (=> (and (and (= (type o_3@@8) RefType) (= (type f_5@@1) (FieldType A@@14 B@@13))) (not (= f_5@@1 g))) (= (U_2_real (MapType1Select QPMask@0 o_3@@8 f_5@@1)) (U_2_real (MapType1Select QPMask@1 o_3@@8 f_5@@1))))))
 :qid |stdinbpl.1316:29|
 :skolemid |166|
 :pattern ( (MapType1Select QPMask@0 o_3@@8 f_5@@1))
 :pattern ( (MapType1Select QPMask@1 o_3@@8 f_5@@1))
))) (and (state Heap@@9 QPMask@1) (state Heap@@9 QPMask@1))) (and (=> (= (ControlFlow 0 41) 40) anon32_Then_correct) (=> (= (ControlFlow 0 41) 19) anon32_Else_correct)))))))))))
(let ((anon9_correct true))
(let ((anon31_Else_correct  (=> (and (not (U_2_bool (MapType2Select S s_11))) (= (ControlFlow 0 10) 7)) anon9_correct)))
(let ((anon31_Then_correct  (=> (U_2_bool (MapType2Select S s_11)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm QPMask@0 s_11 f_7)) (=> (HasDirectPerm QPMask@0 s_11 f_7) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
(let ((anon28_Else_correct  (=> (and (forall ((s1_1 T@U) (s2_1 T@U) ) (!  (=> (and (and (= (type s1_1) RefType) (= (type s2_1) RefType)) (and (U_2_bool (MapType2Select S s1_1)) (and (U_2_bool (MapType2Select S s2_1)) (not (= s1_1 s2_1))))) (not (= (MapType0Select Heap@@9 s1_1 f_7) (MapType0Select Heap@@9 s2_1 f_7))))
 :qid |stdinbpl.1268:20|
 :skolemid |159|
 :pattern ( (MapType2Select S s1_1) (MapType2Select S s2_1))
)) (state Heap@@9 QPMask@0)) (and (and (=> (= (ControlFlow 0 44) 41) anon30_Else_correct) (=> (= (ControlFlow 0 44) 8) anon31_Then_correct)) (=> (= (ControlFlow 0 44) 10) anon31_Else_correct)))))
(let ((anon5_correct true))
(let ((anon29_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select S s1_5)) (and (U_2_bool (MapType2Select S s2_5)) (not (= s1_5 s2_5))))) (= (ControlFlow 0 6) 2)) anon5_correct)))
(let ((anon29_Then_correct  (=> (and (U_2_bool (MapType2Select S s1_5)) (and (U_2_bool (MapType2Select S s2_5)) (not (= s1_5 s2_5)))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm QPMask@0 s1_5 f_7)) (=> (HasDirectPerm QPMask@0 s1_5 f_7) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 s2_5 f_7)) (=> (HasDirectPerm QPMask@0 s2_5 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))))
(let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 45) (- 0 47)) (forall ((s_1 T@U) (s_1_1 T@U) ) (!  (=> (and (= (type s_1) RefType) (= (type s_1_1) RefType)) (=> (and (and (and (and (not (= s_1 s_1_1)) (U_2_bool (MapType2Select S s_1))) (U_2_bool (MapType2Select S s_1_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= s_1 s_1_1))))
 :qid |stdinbpl.1218:15|
 :skolemid |152|
 :no-pattern (type s_1)
 :no-pattern (type s_1_1)
 :no-pattern (U_2_int s_1)
 :no-pattern (U_2_bool s_1)
 :no-pattern (U_2_int s_1_1)
 :no-pattern (U_2_bool s_1_1)
))) (=> (forall ((s_1@@0 T@U) (s_1_1@@0 T@U) ) (!  (=> (and (= (type s_1@@0) RefType) (= (type s_1_1@@0) RefType)) (=> (and (and (and (and (not (= s_1@@0 s_1_1@@0)) (U_2_bool (MapType2Select S s_1@@0))) (U_2_bool (MapType2Select S s_1_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= s_1@@0 s_1_1@@0))))
 :qid |stdinbpl.1218:15|
 :skolemid |152|
 :no-pattern (type s_1@@0)
 :no-pattern (type s_1_1@@0)
 :no-pattern (U_2_int s_1@@0)
 :no-pattern (U_2_bool s_1@@0)
 :no-pattern (U_2_int s_1_1@@0)
 :no-pattern (U_2_bool s_1_1@@0)
)) (=> (and (forall ((s_1@@1 T@U) ) (!  (=> (= (type s_1@@1) RefType) (=> (and (U_2_bool (MapType2Select S s_1@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange12 s_1@@1) (= (invRecv12 s_1@@1) s_1@@1))))
 :qid |stdinbpl.1224:22|
 :skolemid |153|
 :pattern ( (MapType0Select Heap@@9 s_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 s_1@@1 f_7))
 :pattern ( (MapType2Select S s_1@@1))
)) (forall ((o_3@@9 T@U) ) (!  (=> (= (type o_3@@9) RefType) (=> (and (and (U_2_bool (MapType2Select S (invRecv12 o_3@@9))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange12 o_3@@9)) (= (invRecv12 o_3@@9) o_3@@9)))
 :qid |stdinbpl.1228:22|
 :skolemid |154|
 :pattern ( (invRecv12 o_3@@9))
))) (and (=> (= (ControlFlow 0 45) (- 0 46)) (forall ((s_1@@2 T@U) ) (!  (=> (and (= (type s_1@@2) RefType) (U_2_bool (MapType2Select S s_1@@2))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1234:15|
 :skolemid |155|
 :pattern ( (MapType0Select Heap@@9 s_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 s_1@@2 f_7))
 :pattern ( (MapType2Select S s_1@@2))
))) (=> (forall ((s_1@@3 T@U) ) (!  (=> (and (= (type s_1@@3) RefType) (U_2_bool (MapType2Select S s_1@@3))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1234:15|
 :skolemid |155|
 :pattern ( (MapType0Select Heap@@9 s_1@@3 f_7))
 :pattern ( (MapType1Select QPMask@0 s_1@@3 f_7))
 :pattern ( (MapType2Select S s_1@@3))
)) (=> (forall ((s_1@@4 T@U) ) (!  (=> (= (type s_1@@4) RefType) (=> (and (U_2_bool (MapType2Select S s_1@@4)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= s_1@@4 null))))
 :qid |stdinbpl.1240:22|
 :skolemid |156|
 :pattern ( (MapType0Select Heap@@9 s_1@@4 f_7))
 :pattern ( (MapType1Select QPMask@0 s_1@@4 f_7))
 :pattern ( (MapType2Select S s_1@@4))
)) (=> (and (and (forall ((o_3@@10 T@U) ) (!  (=> (= (type o_3@@10) RefType) (and (=> (and (and (U_2_bool (MapType2Select S (invRecv12 o_3@@10))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange12 o_3@@10)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv12 o_3@@10) o_3@@10)) (= (U_2_real (MapType1Select QPMask@0 o_3@@10 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@10 f_7)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (U_2_bool (MapType2Select S (invRecv12 o_3@@10))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange12 o_3@@10))) (= (U_2_real (MapType1Select QPMask@0 o_3@@10 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@10 f_7))))))
 :qid |stdinbpl.1246:22|
 :skolemid |157|
 :pattern ( (MapType1Select QPMask@0 o_3@@10 f_7))
)) (forall ((o_3@@11 T@U) (f_5@@2 T@U) ) (! (let ((B@@14 (FieldTypeInv1 (type f_5@@2))))
(let ((A@@15 (FieldTypeInv0 (type f_5@@2))))
 (=> (and (and (= (type o_3@@11) RefType) (= (type f_5@@2) (FieldType A@@15 B@@14))) (not (= f_5@@2 f_7))) (= (U_2_real (MapType1Select ZeroMask o_3@@11 f_5@@2)) (U_2_real (MapType1Select QPMask@0 o_3@@11 f_5@@2))))))
 :qid |stdinbpl.1250:29|
 :skolemid |158|
 :pattern ( (MapType1Select ZeroMask o_3@@11 f_5@@2))
 :pattern ( (MapType1Select QPMask@0 o_3@@11 f_5@@2))
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 45) 44) anon28_Else_correct) (=> (= (ControlFlow 0 45) 3) anon29_Then_correct)) (=> (= (ControlFlow 0 45) 6) anon29_Else_correct)))))))))))
(let ((anon27_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 48) 1) anon27_Then_correct) (=> (= (ControlFlow 0 48) 45) anon27_Else_correct)))))
