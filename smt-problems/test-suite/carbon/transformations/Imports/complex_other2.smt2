...
(assert (forall ((Heap@@2 T@U) (y@@1 Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (int_2_U (|bar#triggerStateless| y@@1))))
 :qid |stdinbpl.189:15|
 :skolemid |23|
 :pattern ( (|bar'| Heap@@2 y@@1))
)))
...
(assert (forall ((Heap@@4 T@U) (y@@2 Int) ) (!  (=> (= (type Heap@@4) (MapType0Type RefType)) (and (= (bar Heap@@4 y@@2) (|bar'| Heap@@4 y@@2)) (dummyFunction (int_2_U (|bar#triggerStateless| y@@2)))))
 :qid |stdinbpl.185:15|
 :skolemid |22|
 :pattern ( (bar Heap@@4 y@@2))
)))
...
(assert (forall ((Heap@@7 T@U) (Mask@@6 T@U) (y@@3 Int) ) (!  (=> (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (and (state Heap@@7 Mask@@6) (< AssumeFunctionsAbove 0))) (= (bar Heap@@7 y@@3) (- y@@3 2)))
 :qid |stdinbpl.195:15|
 :skolemid |24|
 :pattern ( (state Heap@@7 Mask@@6) (bar Heap@@7 y@@3))
)))
...
(assert (forall ((Heap@@10 T@U) (Mask@@10 T@U) (y@@4 Int) ) (!  (=> (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (state Heap@@10 Mask@@10)) (= (|bar'| Heap@@10 y@@4) (|bar#frame| EmptyFrame y@@4)))
 :qid |stdinbpl.202:15|
 :skolemid |25|
 :pattern ( (state Heap@@10 Mask@@10) (|bar'| Heap@@10 y@@4))
)))
