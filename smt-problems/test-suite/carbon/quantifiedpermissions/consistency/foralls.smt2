...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_8))) (= (ControlFlow 0 14) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_8)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= i_8 0)) (=> (>= i_8 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< i_8 (|Seq#Length| xs))) (=> (< i_8 (|Seq#Length| xs)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_3) (|Seq#Index| xs i_3_1))))
 :qid |stdinbpl.1050:15|
 :skolemid |139|
)))))
(let ((anon9_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (<= 0 i_1) (and (< i_1 j_1) (< j_1 n@@13))) (not (= (|Seq#Index| xs i_1) (|Seq#Index| xs j_1))))
...
(let ((anon10_Else_correct  (=> (and (not (and (<= 0 i_7) (and (< i_7 j_3) (< j_3 n@@13)))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (<= 0 i_7) (and (< i_7 j_3) (< j_3 n@@13))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_7 0)) (=> (>= i_7 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_7 (|Seq#Length| xs))) (=> (< i_7 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_3 0)) (=> (>= j_3 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_3 (|Seq#Length| xs))) (=> (< j_3 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (<= 0 n@@13)) (and (<= n@@13 (|Seq#Length| xs)) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 16) 15) anon9_Else_correct) (=> (= (ControlFlow 0 16) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 16) 7) anon10_Else_correct)))))
