...
(assert  (and (and (and (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type sys__result) RefType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type AssertMask@0) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type freshObj@0) RefType)) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type diz) RefType)) (= (type Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id Counter__Counter)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon4_correct  (=> (= AssertMask@0 (MapType1Store Mask@0 freshObj@0 Counter__x (real_2_U (- (U_2_real (MapType1Select Mask@0 freshObj@0 Counter__x)) FullPerm)))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (HasDirectPerm Mask@0 freshObj@0 Counter__x)) (=> (HasDirectPerm Mask@0 freshObj@0 Counter__x) (=> (= (ControlFlow 0 4) (- 0 5)) (= (U_2_int (MapType0Select Heap@1 freshObj@0 Counter__x)) 0)))))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 Counter__x)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 Counter__x))) (=> (= (ControlFlow 0 7) 4) anon4_correct))))))
(let ((anon7_Else_correct  (=> (U_2_bool (MapType0Select Heap@@9 diz $allocated)) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@9 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@9 freshObj@0 $allocated (bool_2_U true)))) (and (and (= Mask@0 (MapType1Store ZeroMask freshObj@0 Counter__x (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 Counter__x)) FullPerm)))) (state Heap@0 Mask@0)) (and (state Heap@0 Mask@0) (state Heap@0 Mask@0)))) (and (=> (= (ControlFlow 0 10) (- 0 12)) (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 Counter__x)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 Counter__x))) (=> (= Heap@1 (MapType0Store Heap@0 freshObj@0 Counter__x (int_2_U 0))) (=> (and (state Heap@1 Mask@0) (state Heap@1 Mask@0)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (not (= freshObj@0 null))) (=> (not (= freshObj@0 null)) (and (=> (= (ControlFlow 0 10) 7) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct))))))))))))
(let ((anon7_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (not (= sys__result null)) (state PostHeap@0 ZeroMask)) (=> (and (and (not (= sys__result null)) (= PostMask@0 (MapType1Store ZeroMask sys__result Counter__x (real_2_U (+ (U_2_real (MapType1Select ZeroMask sys__result Counter__x)) FullPerm))))) (and (state PostHeap@0 PostMask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm PostMask@0 sys__result Counter__x))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (>= current_thread_id 0) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 13) 2) anon7_Then_correct) (=> (= (ControlFlow 0 13) 10) anon7_Else_correct))))))
