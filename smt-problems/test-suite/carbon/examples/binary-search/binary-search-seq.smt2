...
(declare-fun i@@6 () Int)
(declare-fun j@@5 () Int)
(assert  (and (and (= (type xs) (SeqType intType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id binary_search)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 110) (let ((anon11_correct true))
(let ((anon70_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 (|Seq#Length| xs)))) (= (ControlFlow 0 100) 96)) anon11_correct)))
(let ((anon70_Then_correct  (=> (and (<= 0 i_2) (< i_2 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 97) (- 0 99)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 97) (- 0 98)) (< i_2 (|Seq#Length| xs))) (=> (< i_2 (|Seq#Length| xs)) (=> (= (ControlFlow 0 97) 96) anon11_correct))))))))
(let ((anon13_correct true))
(let ((anon69_Else_correct  (=> (and (forall ((i_3 Int) ) (!  (=> (and (<= 0 i_3) (< i_3 (|Seq#Length| xs))) (not (= (U_2_int (|Seq#Index| xs i_3)) key)))
 :qid |stdinbpl.624:22|
 :skolemid |59|
...
(let ((anon67_Then_correct  (=> (<= 0 index) (and (=> (= (ControlFlow 0 103) (- 0 105)) (>= index 0)) (=> (>= index 0) (and (=> (= (ControlFlow 0 103) (- 0 104)) (< index (|Seq#Length| xs))) (=> (< index (|Seq#Length| xs)) (=> (and (= (U_2_int (|Seq#Index| xs index)) key) (= (ControlFlow 0 103) 102)) anon7_correct))))))))
(let ((anon66_Then_correct  (=> (and (and (state PostHeap@0 ZeroMask) (<= (- 0 1) index)) (and (< index (|Seq#Length| xs)) (state PostHeap@0 ZeroMask))) (and (=> (= (ControlFlow 0 107) 103) anon67_Then_correct) (=> (= (ControlFlow 0 107) 106) anon67_Else_correct)))))
(let ((anon18_correct true))
(let ((anon73_Else_correct  (=> (and (not (and (<= 0 i_6) (and (< i_6 (|Seq#Length| xs)) (not (and (<= 0 i_6) (< i_6 high@0)))))) (= (ControlFlow 0 87) 84)) anon18_correct)))
(let ((anon73_Then_correct  (=> (and (<= 0 i_6) (and (< i_6 (|Seq#Length| xs)) (not (and (<= 0 i_6) (< i_6 high@0))))) (and (=> (= (ControlFlow 0 85) (- 0 86)) (not (= (U_2_int (|Seq#Index| xs i_6)) key))) (=> (not (= (U_2_int (|Seq#Index| xs i_6)) key)) (=> (= (ControlFlow 0 85) 84) anon18_correct))))))
(let ((anon27_correct true))
(let ((anon78_Else_correct  (=> (and (not (and (<= 0 i_4) (and (< i_4 (|Seq#Length| xs)) (not (and (<= low@0 i_4) (< i_4 high@1)))))) (= (ControlFlow 0 73) 69)) anon27_correct)))
(let ((anon78_Then_correct  (=> (and (<= 0 i_4) (and (< i_4 (|Seq#Length| xs)) (not (and (<= low@0 i_4) (< i_4 high@1))))) (and (=> (= (ControlFlow 0 70) (- 0 72)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 70) (- 0 71)) (< i_4 (|Seq#Length| xs))) (=> (< i_4 (|Seq#Length| xs)) (=> (= (ControlFlow 0 70) 69) anon27_correct))))))))
(let ((anon31_correct true))
(let ((anon79_Else_correct  (=> (and (< index@1 0) (= (ControlFlow 0 65) 61)) anon31_correct)))
(let ((anon79_Then_correct  (=> (<= 0 index@1) (and (=> (= (ControlFlow 0 62) (- 0 64)) (>= index@1 0)) (=> (>= index@1 0) (and (=> (= (ControlFlow 0 62) (- 0 63)) (< index@1 (|Seq#Length| xs))) (=> (< index@1 (|Seq#Length| xs)) (=> (and (= (U_2_int (|Seq#Index| xs index@1)) key) (= (ControlFlow 0 62) 61)) anon31_correct))))))))
(let ((anon29_correct  (=> (and (and (state Heap@@9 ZeroMask) (<= (- 0 1) index@1)) (and (< index@1 (|Seq#Length| xs)) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 66) 62) anon79_Then_correct) (=> (= (ControlFlow 0 66) 65) anon79_Else_correct)))))
(let ((anon77_Else_correct  (=> (and (forall ((i_9 Int) ) (!  (=> (and (<= 0 i_9) (and (< i_9 (|Seq#Length| xs)) (not (and (<= low@0 i_9) (< i_9 high@1))))) (not (= (U_2_int (|Seq#Index| xs i_9)) key)))
 :qid |stdinbpl.702:26|
 :skolemid |61|
...
(let ((anon75_Then_correct  (=> (and (and (<= 0 low@0) (<= low@0 high@1)) (and (<= high@1 (|Seq#Length| xs)) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 75) 74) anon76_Then_correct) (=> (= (ControlFlow 0 75) 67) anon76_Else_correct)))))
(let ((anon47_correct true))
(let ((anon87_Else_correct  (=> (and (not (and (<= 0 i_11) (and (< i_11 (|Seq#Length| xs)) (not (and (<= low@2 i_11) (< i_11 high@2)))))) (= (ControlFlow 0 39) 36)) anon47_correct)))
(let ((anon87_Then_correct  (=> (and (<= 0 i_11) (and (< i_11 (|Seq#Length| xs)) (not (and (<= low@2 i_11) (< i_11 high@2))))) (and (=> (= (ControlFlow 0 37) (- 0 38)) (not (= (U_2_int (|Seq#Index| xs i_11)) key))) (=> (not (= (U_2_int (|Seq#Index| xs i_11)) key)) (=> (= (ControlFlow 0 37) 36) anon47_correct))))))
(let ((anon51_correct true))
(let ((anon88_Else_correct  (=> (and (< index@3 0) (= (ControlFlow 0 30) 27)) anon51_correct)))
(let ((anon88_Then_correct  (=> (<= 0 index@3) (and (=> (= (ControlFlow 0 28) (- 0 29)) (= (U_2_int (|Seq#Index| xs index@3)) key)) (=> (= (U_2_int (|Seq#Index| xs index@3)) key) (=> (= (ControlFlow 0 28) 27) anon51_correct))))))
(let ((anon49_correct  (and (=> (= (ControlFlow 0 31) (- 0 33)) (<= (- 0 1) index@3)) (=> (<= (- 0 1) index@3) (and (=> (= (ControlFlow 0 31) (- 0 32)) (< index@3 (|Seq#Length| xs))) (=> (< index@3 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 31) 28) anon88_Then_correct) (=> (= (ControlFlow 0 31) 30) anon88_Else_correct))))))))
(let ((anon86_Else_correct  (=> (and (forall ((i_12_1 Int) ) (!  (=> (and (<= 0 i_12_1) (and (< i_12_1 (|Seq#Length| xs)) (not (and (<= low@2 i_12_1) (< i_12_1 high@2))))) (not (= (U_2_int (|Seq#Index| xs i_12_1)) key)))
 :qid |stdinbpl.813:26|
 :skolemid |63|
 :pattern ( (|Seq#Index| xs i_12_1))
...
(let ((anon43_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 41) (- 0 44)) (<= 0 low@2)) (=> (<= 0 low@2) (and (=> (= (ControlFlow 0 41) (- 0 43)) (<= low@2 high@2)) (=> (<= low@2 high@2) (and (=> (= (ControlFlow 0 41) (- 0 42)) (<= high@2 (|Seq#Length| xs))) (=> (<= high@2 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 41) 40) anon85_Then_correct) (=> (= (ControlFlow 0 41) 34) anon85_Else_correct)))))))))))
(let ((anon42_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (= low@2 low@0) (= high@2 mid@0)) (and (= index@3 index@2) (= (ControlFlow 0 46) 41))) anon43_correct))))
(let ((anon84_Else_correct  (=> (<= (U_2_int (|Seq#Index| xs mid@0)) key) (=> (and (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (= index@2 mid@0) (= (ControlFlow 0 48) 46))) anon42_correct))))
(let ((anon84_Then_correct  (=> (and (and (< key (U_2_int (|Seq#Index| xs mid@0))) (state Heap@@9 ZeroMask)) (and (= index@2 index@1) (= (ControlFlow 0 47) 46))) anon42_correct)))
(let ((anon83_Else_correct  (=> (<= key (U_2_int (|Seq#Index| xs mid@0))) (and (=> (= (ControlFlow 0 49) (- 0 51)) (>= mid@0 0)) (=> (>= mid@0 0) (and (=> (= (ControlFlow 0 49) (- 0 50)) (< mid@0 (|Seq#Length| xs))) (=> (< mid@0 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 49) 47) anon84_Then_correct) (=> (= (ControlFlow 0 49) 48) anon84_Else_correct)))))))))
(let ((anon83_Then_correct  (=> (< (U_2_int (|Seq#Index| xs mid@0)) key) (=> (and (= low@1 (+ mid@0 1)) (state Heap@@9 ZeroMask)) (=> (and (and (= low@2 low@1) (= high@2 high@1)) (and (= index@3 index@1) (= (ControlFlow 0 45) 41))) anon43_correct)))))
(let ((anon37_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (and (< low@0 high@1) (= index@1 (- 0 1))) (state Heap@@9 ZeroMask)) (and (= mid@0 (div (+ low@0 high@1) 2)) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 52) (- 0 54)) (>= mid@0 0)) (=> (>= mid@0 0) (and (=> (= (ControlFlow 0 52) (- 0 53)) (< mid@0 (|Seq#Length| xs))) (=> (< mid@0 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 52) 45) anon83_Then_correct) (=> (= (ControlFlow 0 52) 49) anon83_Else_correct))))))))))
(let ((anon82_Else_correct  (=> (and (< index@1 0) (= (ControlFlow 0 56) 52)) anon37_correct)))
(let ((anon82_Then_correct  (=> (<= 0 index@1) (=> (and (= (U_2_int (|Seq#Index| xs index@1)) key) (= (ControlFlow 0 55) 52)) anon37_correct))))
(let ((anon35_correct  (=> (and (<= (- 0 1) index@1) (< index@1 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 57) 55) anon82_Then_correct) (=> (= (ControlFlow 0 57) 56) anon82_Else_correct)))))
(let ((anon81_Else_correct  (=> (and (not (= index@1 (- 0 1))) (= (ControlFlow 0 59) 57)) anon35_correct)))
(let ((anon81_Then_correct  (=> (= index@1 (- 0 1)) (=> (and (forall ((i_10 Int) ) (!  (=> (and (<= 0 i_10) (and (< i_10 (|Seq#Length| xs)) (not (and (<= low@0 i_10) (< i_10 high@1))))) (not (= (U_2_int (|Seq#Index| xs i_10)) key)))
 :qid |stdinbpl.736:26|
 :skolemid |62|
 :pattern ( (|Seq#Index| xs i_10))
)) (= (ControlFlow 0 58) 57)) anon35_correct))))
(let ((anon80_Then_correct  (=> (and (and (state Heap@@9 ZeroMask) (<= 0 low@0)) (and (<= low@0 high@1) (<= high@1 (|Seq#Length| xs)))) (and (=> (= (ControlFlow 0 60) 58) anon81_Then_correct) (=> (= (ControlFlow 0 60) 59) anon81_Else_correct)))))
(let ((anon62_correct true))
(let ((anon94_Else_correct  (=> (and (not (and (<= 0 i_4_1) (< i_4_1 (|Seq#Length| xs)))) (= (ControlFlow 0 13) 10)) anon62_correct)))
(let ((anon94_Then_correct  (=> (and (<= 0 i_4_1) (< i_4_1 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (not (= (U_2_int (|Seq#Index| xs i_4_1)) key))) (=> (not (= (U_2_int (|Seq#Index| xs i_4_1)) key)) (=> (= (ControlFlow 0 11) 10) anon62_correct))))))
...
(let ((anon91_Then_correct  (=> (<= 0 index@1) (and (=> (= (ControlFlow 0 15) (- 0 16)) (= (U_2_int (|Seq#Index| xs index@1)) key)) (=> (= (U_2_int (|Seq#Index| xs index@1)) key) (and (=> (= (ControlFlow 0 15) 14) anon92_Then_correct) (=> (= (ControlFlow 0 15) 8) anon92_Else_correct)))))))
(let ((anon56_correct  (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 18) (- 0 20)) (<= (- 0 1) index@1)) (=> (<= (- 0 1) index@1) (and (=> (= (ControlFlow 0 18) (- 0 19)) (< index@1 (|Seq#Length| xs))) (=> (< index@1 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 18) 15) anon91_Then_correct) (=> (= (ControlFlow 0 18) 17) anon91_Else_correct)))))))))
(let ((anon90_Else_correct  (=> (and (< index@1 0) (= (ControlFlow 0 22) 18)) anon56_correct)))
(let ((anon90_Then_correct  (=> (<= 0 index@1) (=> (and (= (U_2_int (|Seq#Index| xs index@1)) key) (= (ControlFlow 0 21) 18)) anon56_correct))))
(let ((anon54_correct  (=> (and (<= (- 0 1) index@1) (< index@1 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 23) 21) anon90_Then_correct) (=> (= (ControlFlow 0 23) 22) anon90_Else_correct)))))
(let ((anon89_Else_correct  (=> (and (not (= index@1 (- 0 1))) (= (ControlFlow 0 25) 23)) anon54_correct)))
(let ((anon89_Then_correct  (=> (= index@1 (- 0 1)) (=> (and (forall ((i_13 Int) ) (!  (=> (and (<= 0 i_13) (and (< i_13 (|Seq#Length| xs)) (not (and (<= low@0 i_13) (< i_13 high@1))))) (not (= (U_2_int (|Seq#Index| xs i_13)) key)))
 :qid |stdinbpl.837:24|
 :skolemid |64|
 :pattern ( (|Seq#Index| xs i_13))
)) (= (ControlFlow 0 24) 23)) anon54_correct))))
(let ((anon80_Else_correct  (=> (not (and (< low@0 high@1) (= index@1 (- 0 1)))) (=> (and (and (state Heap@@9 ZeroMask) (<= 0 low@0)) (and (<= low@0 high@1) (<= high@1 (|Seq#Length| xs)))) (and (=> (= (ControlFlow 0 26) 24) anon89_Then_correct) (=> (= (ControlFlow 0 26) 25) anon89_Else_correct))))))
...
(let ((anon74_Then_correct  (=> (<= 0 index@0) (and (=> (= (ControlFlow 0 76) (- 0 77)) (= (U_2_int (|Seq#Index| xs index@0)) key)) (=> (= (U_2_int (|Seq#Index| xs index@0)) key) (and (and (=> (= (ControlFlow 0 76) 75) anon75_Then_correct) (=> (= (ControlFlow 0 76) 60) anon80_Then_correct)) (=> (= (ControlFlow 0 76) 26) anon80_Else_correct)))))))
(let ((anon20_correct  (and (=> (= (ControlFlow 0 79) (- 0 81)) (<= (- 0 1) index@0)) (=> (<= (- 0 1) index@0) (and (=> (= (ControlFlow 0 79) (- 0 80)) (< index@0 (|Seq#Length| xs))) (=> (< index@0 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 79) 76) anon74_Then_correct) (=> (= (ControlFlow 0 79) 78) anon74_Else_correct))))))))
(let ((anon72_Else_correct  (=> (and (forall ((i_7_1 Int) ) (!  (=> (and (<= 0 i_7_1) (and (< i_7_1 (|Seq#Length| xs)) (not (and (<= 0 i_7_1) (< i_7_1 high@0))))) (not (= (U_2_int (|Seq#Index| xs i_7_1)) key)))
 :qid |stdinbpl.667:26|
 :skolemid |60|
 :pattern ( (|Seq#Index| xs i_7_1))
...
(let ((anon66_Else_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (= high@0 (|Seq#Length| xs)) (state Heap@@9 ZeroMask)) (and (= index@0 (- 0 1)) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 89) (- 0 92)) (<= 0 0)) (=> (<= 0 0) (and (=> (= (ControlFlow 0 89) (- 0 91)) (<= 0 high@0)) (=> (<= 0 high@0) (and (=> (= (ControlFlow 0 89) (- 0 90)) (<= high@0 (|Seq#Length| xs))) (=> (<= high@0 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 89) 88) anon71_Then_correct) (=> (= (ControlFlow 0 89) 82) anon71_Else_correct))))))))))))
(let ((anon64_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (<= 0 i_1) (and (< j_1 (|Seq#Length| xs)) (< i_1 j_1))) (< (U_2_int (|Seq#Index| xs i_1)) (U_2_int (|Seq#Index| xs j_1))))
 :qid |stdinbpl.583:20|
 :skolemid |58|
 :pattern ( (|Seq#Index| xs i_1) (|Seq#Index| xs j_1))
)) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 108) 107) anon66_Then_correct) (=> (= (ControlFlow 0 108) 89) anon66_Else_correct)))))
(let ((anon3_correct true))
(let ((anon65_Else_correct  (=> (and (not (and (<= 0 i@@6) (and (< j@@5 (|Seq#Length| xs)) (< i@@6 j@@5)))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon65_Then_correct  (=> (and (<= 0 i@@6) (and (< j@@5 (|Seq#Length| xs)) (< i@@6 j@@5))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i@@6 (|Seq#Length| xs))) (=> (< i@@6 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j@@5 (|Seq#Length| xs))) (=> (< j@@5 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (and (=> (= (ControlFlow 0 109) 108) anon64_Else_correct) (=> (= (ControlFlow 0 109) 2) anon65_Then_correct)) (=> (= (ControlFlow 0 109) 7) anon65_Else_correct)))))
