...
(set-info :boogie-vc-id test_extend_left)
...
(let ((anon9_Then_correct  (=> (|Seq#Contains| s@@21 (int_2_U i_1)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (|Seq#Contains| (|Seq#Drop| ss@0 1) (int_2_U i_1))) (=> (|Seq#Contains| (|Seq#Drop| ss@0 1) (int_2_U i_1)) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
(let ((anon8_Else_correct true))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (= ss@0 (|Seq#Append| (|Seq#Singleton| (int_2_U 42)) s@@21)) (state Heap@@13 ZeroMask))) (and (and (and (=> (= (ControlFlow 0 7) 1) anon7_Then_correct) (=> (= (ControlFlow 0 7) 2) anon8_Else_correct)) (=> (= (ControlFlow 0 7) 4) anon9_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))
