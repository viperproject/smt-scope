...
(assert  (and (and (and (and (and (= (type S2) (MapType2Type RefType boolType)) (= (type y_4) RefType)) (= (type PostHeap@0) (MapType0Type RefType))) (= (type S1) (SeqType RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type x@@22) RefType)))
(set-info :boogie-vc-id m04)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon13_Else_correct true))
(let ((anon13_Then_correct true))
(let ((anon12_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 9) 7) anon13_Then_correct) (=> (= (ControlFlow 0 9) 8) anon13_Else_correct)))))
(let ((anon9_correct true))
(let ((anon15_Else_correct  (=> (and (not (U_2_bool (MapType2Select S2 y_4))) (= (ControlFlow 0 6) 3)) anon9_correct)))
(let ((anon15_Then_correct  (=> (U_2_bool (MapType2Select S2 y_4)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= y_4 null))) (=> (not (= y_4 null)) (=> (= (ControlFlow 0 4) 3) anon9_correct))))))
(let ((anon14_Else_correct true))
(let ((anon11_Else_correct  (=> (and (forall ((y_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (|Seq#Contains| S1 y_1)) (not (= y_1 null)))
 :qid |stdinbpl.1254:20|
 :skolemid |157|
 :pattern ( (|Seq#ContainsTrigger| S1 y_1))
 :pattern ( (|Seq#Contains| S1 y_1))
)) (state Heap@@9 ZeroMask)) (and (and (and (=> (= (ControlFlow 0 10) 9) anon12_Then_correct) (=> (= (ControlFlow 0 10) 2) anon14_Else_correct)) (=> (= (ControlFlow 0 10) 4) anon15_Then_correct)) (=> (= (ControlFlow 0 10) 6) anon15_Else_correct)))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 x@@22 $allocated)) (|Seq#Equal| S1 (|Seq#Singleton| x@@22))) (and (|Set#Equal| S2 (|Set#Singleton| x@@22)) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 11) 1) anon11_Then_correct) (=> (= (ControlFlow 0 11) 10) anon11_Else_correct))))))
