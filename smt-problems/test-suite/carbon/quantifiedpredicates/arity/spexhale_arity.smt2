...
(assert  (and (and (and (and (= (type QPMask@0) (MapType1Type RefType realType)) (= (type x@@11) RefType)) (= (type xs) (SeqType RefType))) (= (type Heap@@14) (MapType0Type RefType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv4 arg0@@43)) RefType)
...
)) (=> (and (forall ((r_2_1 T@U) ) (!  (=> (= (type r_2_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv4 r_2_1)) (< NoPerm FullPerm)) (qpRange4 r_2_1)) (= (invRecv4 r_2_1) r_2_1)))
