...
(set-info :boogie-vc-id |List__get_next#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon6_correct true))
(let ((anon9_Else_correct  (=> (= (MapType0Select Heap@1 diz@@37 List__next) null) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 3) 1)) anon6_correct))))
(let ((anon9_Then_correct  (=> (not (= (MapType0Select Heap@1 diz@@37 List__next) null)) (=> (and (and (forall ((o_8 T@U) (f_12 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_12))))
(let ((A@@12 (FieldTypeInv0 (type f_12))))
 (=> (and (and (= (type o_8) RefType) (= (type f_12) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|List__state#sm| diz@@37)) o_8 f_12)) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|List__state#sm| (MapType0Select Heap@1 diz@@37 List__next))) o_8 f_12)))) (U_2_bool (MapType1Select newPMask@0 o_8 f_12)))))
 :qid |stdinbpl.1816:33|
 :skolemid |89|
 :pattern ( (MapType1Select newPMask@0 o_8 f_12))
)) (= Heap@2 (MapType0Store Heap@1 null (|List__state#sm| diz@@37) newPMask@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 2) 1))) anon6_correct))))
(let ((anon4_correct  (=> (state Heap@@37 UnfoldingMask@4) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm UnfoldingMask@4 diz@@37 List__next)) (=> (HasDirectPerm UnfoldingMask@4 diz@@37 List__next) (=> (and (= Heap@0 (MapType0Store Heap@@37 null (|List__state#sm| diz@@37) (MapType1Store (MapType0Select Heap@@37 null (|List__state#sm| diz@@37)) diz@@37 List__val (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|List__state#sm| diz@@37) (MapType1Store (MapType0Select Heap@0 null (|List__state#sm| diz@@37)) diz@@37 List__next (bool_2_U true))))) (and (=> (= (ControlFlow 0 4) 2) anon9_Then_correct) (=> (= (ControlFlow 0 4) 3) anon9_Else_correct))))))))
(let ((anon8_Else_correct  (=> (= (MapType0Select Heap@@37 diz@@37 List__next) null) (=> (and (= UnfoldingMask@4 UnfoldingMask@2) (= (ControlFlow 0 7) 4)) anon4_correct))))
