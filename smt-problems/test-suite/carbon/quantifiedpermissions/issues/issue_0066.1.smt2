...
(assert  (and (and (and (and (and (and (and (and (and (= (type S) (MapType2Type RefType boolType)) (= (type s1) RefType)) (= (type s2) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type s@@3) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type s_2) RefType)) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv2 arg0@@43)) RefType)
...
(let ((anon21_Else_correct  (=> (and (not (U_2_bool (MapType2Select S s_2))) (= (ControlFlow 0 17) 14)) anon13_correct)))
(let ((anon21_Then_correct  (=> (U_2_bool (MapType2Select S s_2)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm QPMask@1 s_2 f_7)) (=> (HasDirectPerm QPMask@1 s_2 f_7) (=> (= (ControlFlow 0 15) 14) anon13_correct))))))
(let ((anon20_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((s_5 T@U) (s_5_1 T@U) ) (!  (=> (and (= (type s_5) RefType) (= (type s_5_1) RefType)) (=> (and (and (and (and (not (= s_5 s_5_1)) (U_2_bool (MapType2Select S s_5))) (U_2_bool (MapType2Select S s_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (MapType0Select Heap@@9 s_5 f_7) (MapType0Select Heap@@9 s_5_1 f_7)))))
 :qid |stdinbpl.598:17|
 :skolemid |95|
 :pattern ( (neverTriggered3 s_5) (neverTriggered3 s_5_1))
))) (=> (forall ((s_5@@0 T@U) (s_5_1@@0 T@U) ) (!  (=> (and (= (type s_5@@0) RefType) (= (type s_5_1@@0) RefType)) (=> (and (and (and (and (not (= s_5@@0 s_5_1@@0)) (U_2_bool (MapType2Select S s_5@@0))) (U_2_bool (MapType2Select S s_5_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (MapType0Select Heap@@9 s_5@@0 f_7) (MapType0Select Heap@@9 s_5_1@@0 f_7)))))
 :qid |stdinbpl.598:17|
 :skolemid |95|
 :pattern ( (neverTriggered3 s_5@@0) (neverTriggered3 s_5_1@@0))
)) (=> (= (ControlFlow 0 12) (- 0 11)) (forall ((s_5@@1 T@U) ) (!  (=> (and (= (type s_5@@1) RefType) (U_2_bool (MapType2Select S s_5@@1))) (>= (U_2_real (MapType1Select QPMask@1 (MapType0Select Heap@@9 s_5@@1 f_7) g)) FullPerm))
 :qid |stdinbpl.605:17|
 :skolemid |96|
 :pattern ( (MapType0Select Heap@@9 s_5@@1 f_7))
 :pattern ( (MapType2Select S s_5@@1))
)))))))
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((s_3 T@U) (s_3_1 T@U) ) (!  (=> (and (= (type s_3) RefType) (= (type s_3_1) RefType)) (=> (and (and (and (and (not (= s_3 s_3_1)) (U_2_bool (MapType2Select S s_3))) (U_2_bool (MapType2Select S s_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (MapType0Select Heap@@9 s_3 f_7) (MapType0Select Heap@@9 s_3_1 f_7)))))
 :qid |stdinbpl.544:15|
 :skolemid |89|
 :no-pattern (type s_3)
...
)) (=> (and (and (and (forall ((s_3@@1 T@U) ) (!  (=> (= (type s_3@@1) RefType) (=> (and (U_2_bool (MapType2Select S s_3@@1)) (< NoPerm FullPerm)) (and (qpRange2 (MapType0Select Heap@@9 s_3@@1 f_7)) (= (invRecv2 (MapType0Select Heap@@9 s_3@@1 f_7)) s_3@@1))))
 :qid |stdinbpl.550:22|
 :skolemid |90|
 :pattern ( (MapType0Select Heap@@9 s_3@@1 f_7))
 :pattern ( (MapType2Select S s_3@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select S (invRecv2 o_3))) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (MapType0Select Heap@@9 (invRecv2 o_3) f_7) o_3)))
 :qid |stdinbpl.554:22|
 :skolemid |91|
 :pattern ( (invRecv2 o_3))
))) (and (forall ((s_3@@2 T@U) ) (!  (=> (and (= (type s_3@@2) RefType) (U_2_bool (MapType2Select S s_3@@2))) (not (= (MapType0Select Heap@@9 s_3@@2 f_7) null)))
 :qid |stdinbpl.560:22|
 :skolemid |92|
 :pattern ( (MapType0Select Heap@@9 s_3@@2 f_7))
 :pattern ( (MapType2Select S s_3@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select S (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (MapType0Select Heap@@9 (invRecv2 o_3@@0) f_7) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 g)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@0 g)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select S (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 g)) (U_2_real (MapType1Select QPMask@0 o_3@@0 g))))))
 :qid |stdinbpl.566:22|
 :skolemid |93|
...
)) (state Heap@@9 QPMask@1)) (and (state Heap@@9 QPMask@1) (state Heap@@9 QPMask@1)))) (and (and (=> (= (ControlFlow 0 18) 12) anon20_Else_correct) (=> (= (ControlFlow 0 18) 15) anon21_Then_correct)) (=> (= (ControlFlow 0 18) 17) anon21_Else_correct)))))))
(let ((anon9_correct true))
(let ((anon19_Else_correct  (=> (and (not (U_2_bool (MapType2Select S s@@3))) (= (ControlFlow 0 10) 7)) anon9_correct)))
(let ((anon19_Then_correct  (=> (U_2_bool (MapType2Select S s@@3)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm QPMask@0 s@@3 f_7)) (=> (HasDirectPerm QPMask@0 s@@3 f_7) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
(let ((anon16_Else_correct  (=> (forall ((s1_1 T@U) (s2_1 T@U) ) (!  (=> (and (and (= (type s1_1) RefType) (= (type s2_1) RefType)) (and (U_2_bool (MapType2Select S s1_1)) (and (U_2_bool (MapType2Select S s2_1)) (not (= s1_1 s2_1))))) (not (= (MapType0Select Heap@@9 s1_1 f_7) (MapType0Select Heap@@9 s2_1 f_7))))
 :qid |stdinbpl.525:20|
 :skolemid |88|
 :pattern ( (MapType2Select S s1_1) (MapType2Select S s2_1))
)) (=> (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)) (and (and (=> (= (ControlFlow 0 20) 18) anon18_Else_correct) (=> (= (ControlFlow 0 20) 8) anon19_Then_correct)) (=> (= (ControlFlow 0 20) 10) anon19_Else_correct))))))
(let ((anon5_correct true))
(let ((anon17_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select S s1)) (and (U_2_bool (MapType2Select S s2)) (not (= s1 s2))))) (= (ControlFlow 0 6) 2)) anon5_correct)))
(let ((anon17_Then_correct  (=> (and (U_2_bool (MapType2Select S s1)) (and (U_2_bool (MapType2Select S s2)) (not (= s1 s2)))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm QPMask@0 s1 f_7)) (=> (HasDirectPerm QPMask@0 s1 f_7) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 s2 f_7)) (=> (HasDirectPerm QPMask@0 s2 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((s_1 T@U) (s_1_1 T@U) ) (!  (=> (and (= (type s_1) RefType) (= (type s_1_1) RefType)) (=> (and (and (and (and (not (= s_1 s_1_1)) (U_2_bool (MapType2Select S s_1))) (U_2_bool (MapType2Select S s_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1 s_1_1))))
 :qid |stdinbpl.476:15|
 :skolemid |82|
 :no-pattern (type s_1)
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (and (=> (= (ControlFlow 0 21) 20) anon16_Else_correct) (=> (= (ControlFlow 0 21) 3) anon17_Then_correct)) (=> (= (ControlFlow 0 21) 6) anon17_Else_correct)))))))
(let ((anon15_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 23) 1) anon15_Then_correct) (=> (= (ControlFlow 0 23) 21) anon15_Else_correct)))))
