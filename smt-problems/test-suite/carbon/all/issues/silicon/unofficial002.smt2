...
(declare-fun end@@5 () T@U)
(declare-fun Mask@2 () T@U)
(declare-fun Mask@0 () T@U)
(declare-fun Heap@@14 () T@U)
(declare-fun Mask@1 () T@U)
(assert  (and (and (and (and (and (= (type this@@9) RefType) (= (type end@@5) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@14) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |lseg#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (= this@@9 end@@5) (=> (and (= Mask@2 ZeroMask) (= (ControlFlow 0 5) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (and (and (not (= this@@9 end@@5)) (not (= this@@9 null))) (and (= Mask@0 (MapType1Store ZeroMask this@@9 sibling (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@9 sibling)) FullPerm)))) (state Heap@@14 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@0 this@@9 sibling)) (=> (HasDirectPerm Mask@0 this@@9 sibling) (=> (not (= (MapType0Select Heap@@14 this@@9 sibling) null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 this@@9 sibling)) (=> (HasDirectPerm Mask@0 this@@9 sibling) (=> (and (and (= Mask@1 (MapType1Store Mask@0 null (lseg (MapType0Select Heap@@14 this@@9 sibling) end@@5) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (lseg (MapType0Select Heap@@14 this@@9 sibling) end@@5))) FullPerm)))) (state Heap@@14 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 2) 1))) anon2_correct)))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@14 this@@9 $allocated)) (U_2_bool (MapType0Select Heap@@14 end@@5 $allocated)))) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))
