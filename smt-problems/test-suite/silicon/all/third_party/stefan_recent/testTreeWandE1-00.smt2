(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:08:42
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/third_party/stefan_recent/testTreeWandE1.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (forall ((s@$ $Snap) (s@2@00 Seq<Int>)) (!
  (=>
    ...
    (=
      ...
      (forall ((i Int) (j Int)) (!
        (=>
          (and (<= 1 i) (and (< i j) (< j (Seq_length s@2@00))))
