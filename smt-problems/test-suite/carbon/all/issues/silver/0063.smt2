...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (> i 0) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (= i 0))) (=> (not (= i 0)) (=> (= q_1@0 (/ p_1 (to_real i))) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (< NoPerm q_1@0)))))))))
