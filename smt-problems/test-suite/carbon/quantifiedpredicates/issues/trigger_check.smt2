...
(declare-fun |e'| (T@U T@U) T@U)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |e#triggerStateless| (T@U) T@U)
...
(declare-fun |e#frame| (T@U T@U) T@U)
...
(assert  (and (and (= (Ctor PredicateType_pType) 12) (= (Ctor FrameTypeType) 13)) (forall ((arg0@@26 T@U) (arg1@@10 Int) ) (! (= (type (p_1 arg0@@26 arg1@@10)) (FieldType PredicateType_pType FrameTypeType))
 :qid |funType:p_1|
 :pattern ( (p_1 arg0@@26 arg1@@10))
))))
(assert (forall ((r T@U) (i Int) ) (!  (=> (= (type r) RefType) (IsPredicateField (p_1 r i)))
 :qid |stdinbpl.630:15|
 :skolemid |62|
 :pattern ( (p_1 r i))
)))
(assert (forall ((Heap@@0 T@U) (r@@0 T@U) (i@@0 Int) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type r@@0) RefType)) (|p#everUsed| (p_1 r@@0 i@@0)))
 :qid |stdinbpl.649:15|
 :skolemid |66|
 :pattern ( (|p#trigger| Heap@@0 (p_1 r@@0 i@@0)))
)))
...
(assert  (and (forall ((arg0@@30 T@U) (arg1@@12 T@U) ) (! (= (type (|e'| arg0@@30 arg1@@12)) RefType)
 :qid |funType:e'|
 :pattern ( (|e'| arg0@@30 arg1@@12))
)) (forall ((arg0@@31 T@U) ) (! (= (type (|e#triggerStateless| arg0@@31)) RefType)
 :qid |funType:e#triggerStateless|
 :pattern ( (|e#triggerStateless| arg0@@31))
))))
(assert (forall ((Heap@@3 T@U) (x@@8 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type x@@8) RefType)) (dummyFunction (|e#triggerStateless| x@@8)))
 :qid |stdinbpl.589:15|
 :skolemid |59|
 :pattern ( (|e'| Heap@@3 x@@8))
)))
(assert (forall ((arg0@@32 T@U) (arg1@@13 Int) (arg2@@3 T@U) ) (! (let ((T@@3 (type arg2@@3)))
(= (type (|Seq#Update| arg0@@32 arg1@@13 arg2@@3)) (SeqType T@@3)))
 :qid |funType:Seq#Update|
 :pattern ( (|Seq#Update| arg0@@32 arg1@@13 arg2@@3))
)))
...
(assert (forall ((arg0@@33 T@U) (arg1@@14 Int) ) (! (let ((T@@5 (SeqTypeInv0 (type arg0@@33))))
(= (type (|Seq#Take| arg0@@33 arg1@@14)) (SeqType T@@5)))
 :qid |funType:Seq#Take|
 :pattern ( (|Seq#Take| arg0@@33 arg1@@14))
)))
...
(assert (forall ((arg0@@34 Int) (arg1@@15 Int) ) (! (= (type (|Seq#Range| arg0@@34 arg1@@15)) (SeqType intType))
 :qid |funType:Seq#Range|
 :pattern ( (|Seq#Range| arg0@@34 arg1@@15))
)))
...
(assert (forall ((arg0@@35 T@U) (arg1@@16 T@U) ) (! (= (type (e arg0@@35 arg1@@16)) RefType)
 :qid |funType:e|
 :pattern ( (e arg0@@35 arg1@@16))
)))
(assert (forall ((Heap@@5 T@U) (x@@10 T@U) ) (!  (=> (and (= (type Heap@@5) (MapType0Type RefType)) (= (type x@@10) RefType)) (and (= (e Heap@@5 x@@10) (|e'| Heap@@5 x@@10)) (dummyFunction (|e#triggerStateless| x@@10))))
 :qid |stdinbpl.585:15|
 :skolemid |58|
 :pattern ( (e Heap@@5 x@@10))
)))
...
(assert (forall ((r@@1 T@U) (i@@4 Int) (r2 T@U) (i2 Int) ) (!  (=> (and (and (= (type r@@1) RefType) (= (type r2) RefType)) (= (p_1 r@@1 i@@4) (p_1 r2 i2))) (and (= r@@1 r2) (= i@@4 i2)))
 :qid |stdinbpl.640:15|
 :skolemid |64|
 :pattern ( (p_1 r@@1 i@@4) (p_1 r2 i2))
)))
(assert (forall ((arg0@@37 T@U) (arg1@@17 Int) ) (! (= (type (|p#sm| arg0@@37 arg1@@17)) (FieldType PredicateType_pType (MapType1Type RefType boolType)))
 :qid |funType:p#sm|
 :pattern ( (|p#sm| arg0@@37 arg1@@17))
)))
(assert (forall ((r@@2 T@U) (i@@5 Int) (r2@@0 T@U) (i2@@0 Int) ) (!  (=> (and (and (= (type r@@2) RefType) (= (type r2@@0) RefType)) (= (|p#sm| r@@2 i@@5) (|p#sm| r2@@0 i2@@0))) (and (= r@@2 r2@@0) (= i@@5 i2@@0)))
 :qid |stdinbpl.644:15|
 :skolemid |65|
 :pattern ( (|p#sm| r@@2 i@@5) (|p#sm| r2@@0 i2@@0))
)))
...
(assert (forall ((arg0@@38 T@U) (arg1@@18 T@U) ) (! (let ((T@@14 (SeqTypeInv0 (type arg0@@38))))
(= (type (|Seq#Append| arg0@@38 arg1@@18)) (SeqType T@@14)))
 :qid |funType:Seq#Append|
 :pattern ( (|Seq#Append| arg0@@38 arg1@@18))
)))
...
(assert  (and (forall ((arg0@@39 Real) (arg1@@19 T@U) ) (! (= (type (ConditionalFrame arg0@@39 arg1@@19)) FrameTypeType)
 :qid |funType:ConditionalFrame|
 :pattern ( (ConditionalFrame arg0@@39 arg1@@19))
...
(assert (forall ((r@@3 T@U) (i@@7 Int) ) (!  (=> (= (type r@@3) RefType) (= (getPredWandId (p_1 r@@3 i@@7)) 0))
 :qid |stdinbpl.634:15|
 :skolemid |63|
 :pattern ( (p_1 r@@3 i@@7))
)))
...
(assert (forall ((arg0@@40 T@U) (arg1@@20 T@U) ) (! (= (type (|e#frame| arg0@@40 arg1@@20)) RefType)
 :qid |funType:e#frame|
 :pattern ( (|e#frame| arg0@@40 arg1@@20))
)))
(assert (forall ((Heap@@10 T@U) (Mask@@9 T@U) (x@@12 T@U) ) (!  (=> (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (= (type x@@12) RefType)) (state Heap@@10 Mask@@9)) (= (|e'| Heap@@10 x@@12) (|e#frame| EmptyFrame x@@12)))
 :qid |stdinbpl.596:15|
 :skolemid |60|
 :pattern ( (state Heap@@10 Mask@@9) (|e'| Heap@@10 x@@12))
)))
...
(assert (forall ((r@@4 T@U) (i@@8 Int) ) (!  (=> (= (type r@@4) RefType) (= (PredicateMaskField (p_1 r@@4 i@@8)) (|p#sm| r@@4 i@@8)))
 :qid |stdinbpl.626:15|
 :skolemid |61|
 :pattern ( (PredicateMaskField (p_1 r@@4 i@@8)))
)))
...
(assert (forall ((s@@14 T@U) (x@@13 T@U) (i@@11 Int) ) (! (let ((T@@30 (type x@@13)))
 (=> (= (type s@@14) (SeqType T@@30)) (=> (and (and (<= 0 i@@11) (< i@@11 (|Seq#Length| s@@14))) (= (|Seq#Index| s@@14 i@@11) x@@13)) (|Seq#Contains| s@@14 x@@13))))
 :qid |stdinbpl.425:18|
 :skolemid |48|
 :pattern ( (|Seq#Contains| s@@14 x@@13) (|Seq#Index| s@@14 i@@11))
)))
...
(assert  (and (and (and (and (and (and (and (and (= (type xs) (SeqType RefType)) (= (type ix_2) RefType)) (= (type jx_2) RefType)) (= (type x_7) RefType)) (= (type Heap@@13) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type x_8) RefType)) (forall ((arg0@@41 T@U) (arg1@@21 Int) ) (! (= (type (invRecv4 arg0@@41 arg1@@21)) RefType)
 :qid |funType:invRecv4|
 :pattern ( (invRecv4 arg0@@41 arg1@@21))
))))
...
(let ((anon29_Then_correct  (=> (|Seq#Contains| xs x_8) (and (=> (= (ControlFlow 0 18) 17) anon30_Then_correct) (=> (= (ControlFlow 0 18) 15) anon17_correct)))))
(let ((anon29_Else_correct  (=> (and (not (|Seq#Contains| xs x_8)) (= (ControlFlow 0 16) 15)) anon17_correct)))
(let ((anon28_Else_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (forall ((x_4 T@U) (x_4_1 T@U) ) (!  (=> (and (= (type x_4) RefType) (= (type x_4_1) RefType)) (=> (and (and (and (and (not (= x_4 x_4_1)) (|Seq#Contains| xs x_4)) (|Seq#Contains| xs x_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= (e PostHeap@0 x_4) (e PostHeap@0 x_4_1))) (not (= (+ i@@12 1) (+ i@@12 1))))))
...
(let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((x_6 T@U) (x_6_1 T@U) ) (!  (=> (and (= (type x_6) RefType) (= (type x_6_1) RefType)) (=> (and (and (and (and (not (= x_6 x_6_1)) (|Seq#Contains| xs x_6)) (|Seq#Contains| xs x_6_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= (e Heap@@13 x_6) (e Heap@@13 x_6_1))) (not (= (+ i@@12 1) (+ i@@12 1))))))
 :qid |stdinbpl.1054:17|
 :skolemid |99|
 :pattern ( (neverTriggered6 x_6) (neverTriggered6 x_6_1))
))) (=> (forall ((x_6@@0 T@U) (x_6_1@@0 T@U) ) (!  (=> (and (= (type x_6@@0) RefType) (= (type x_6_1@@0) RefType)) (=> (and (and (and (and (not (= x_6@@0 x_6_1@@0)) (|Seq#Contains| xs x_6@@0)) (|Seq#Contains| xs x_6_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= (e Heap@@13 x_6@@0) (e Heap@@13 x_6_1@@0))) (not (= (+ i@@12 1) (+ i@@12 1))))))
 :qid |stdinbpl.1054:17|
 :skolemid |99|
 :pattern ( (neverTriggered6 x_6@@0) (neverTriggered6 x_6_1@@0))
)) (=> (= (ControlFlow 0 11) (- 0 10)) (forall ((x_6@@1 T@U) ) (!  (=> (and (= (type x_6@@1) RefType) (|Seq#Contains| xs x_6@@1)) (>= (U_2_real (MapType1Select QPMask@0 null (p_1 (e Heap@@13 x_6@@1) (+ i@@12 1)))) FullPerm))
...
(let ((anon24_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| xs x_1)) (|Seq#Contains| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= (e Heap@@13 x_1) (e Heap@@13 x_1_1))) (not (= (+ i@@12 1) (+ i@@12 1))))))
 :qid |stdinbpl.947:17|
 :skolemid |87|
 :pattern ( (neverTriggered4 x_1) (neverTriggered4 x_1_1))
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (|Seq#Contains| xs x_1@@0)) (|Seq#Contains| xs x_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= (e Heap@@13 x_1@@0) (e Heap@@13 x_1_1@@0))) (not (= (+ i@@12 1) (+ i@@12 1))))))
 :qid |stdinbpl.947:17|
 :skolemid |87|
 :pattern ( (neverTriggered4 x_1@@0) (neverTriggered4 x_1_1@@0))
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| xs x_1@@1) (< NoPerm FullPerm)) (and (= (invRecv4 (e Heap@@13 x_1@@1) (+ i@@12 1)) x_1@@1) (qpRange4 (e Heap@@13 x_1@@1) (+ i@@12 1)))))
 :qid |stdinbpl.953:22|
 :skolemid |88|
 :pattern ( (|Seq#ContainsTrigger| xs x_1@@1))
 :pattern ( (|Seq#Contains| xs x_1@@1))
 :pattern ( (|e#frame| EmptyFrame x_1@@1))
)) (=> (and (forall ((r@@5 T@U) (i_1_1 Int) ) (!  (=> (= (type r@@5) RefType) (=> (and (and (|Seq#Contains| xs (invRecv4 r@@5 i_1_1)) (< NoPerm FullPerm)) (qpRange4 r@@5 i_1_1)) (and (= (e Heap@@13 (invRecv4 r@@5 i_1_1)) r@@5) (= (+ i@@12 1) i_1_1))))
 :qid |stdinbpl.957:22|
 :skolemid |89|
 :pattern ( (invRecv4 r@@5 i_1_1))
)) (forall ((r@@6 T@U) (i_1_1@@0 Int) ) (!  (=> (= (type r@@6) RefType) (=> (and (and (|Seq#Contains| xs (invRecv4 r@@6 i_1_1@@0)) (< NoPerm FullPerm)) (qpRange4 r@@6 i_1_1@@0)) (and (=> (< NoPerm FullPerm) (and (= (e Heap@@13 (invRecv4 r@@6 i_1_1@@0)) r@@6) (= (+ i@@12 1) i_1_1@@0))) (= (U_2_real (MapType1Select QPMask@0 null (p_1 r@@6 i_1_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (p_1 r@@6 i_1_1@@0))) FullPerm)))))
 :qid |stdinbpl.963:22|
 :skolemid |90|
 :pattern ( (MapType1Select QPMask@0 null (p_1 r@@6 i_1_1@@0)))
...
)) (forall ((r@@7 T@U) (i_1_1@@1 Int) ) (!  (=> (and (= (type r@@7) RefType) (not (and (and (|Seq#Contains| xs (invRecv4 r@@7 i_1_1@@1)) (< NoPerm FullPerm)) (qpRange4 r@@7 i_1_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (p_1 r@@7 i_1_1@@1))) (U_2_real (MapType1Select ZeroMask null (p_1 r@@7 i_1_1@@1)))))
 :qid |stdinbpl.973:22|
 :skolemid |92|
 :pattern ( (MapType1Select QPMask@0 null (p_1 r@@7 i_1_1@@1)))
))) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0))) (and (=> (= (ControlFlow 0 20) 19) anon27_Then_correct) (=> (= (ControlFlow 0 20) 11) anon27_Else_correct)))))))))
(let ((anon26_Then_correct true))
(let ((anon11_correct true))
(let ((anon25_Then_correct  (=> (|Seq#Contains| xs x_7) (and (=> (= (ControlFlow 0 9) 8) anon26_Then_correct) (=> (= (ControlFlow 0 9) 6) anon11_correct)))))
(let ((anon25_Else_correct  (=> (and (not (|Seq#Contains| xs x_7)) (= (ControlFlow 0 7) 6)) anon11_correct)))
(let ((anon20_Else_correct  (=> (forall ((ix_1 T@U) (jx_1 T@U) ) (!  (=> (and (and (= (type ix_1) RefType) (= (type jx_1) RefType)) (and (|Seq#Contains| xs ix_1) (and (|Seq#Contains| xs jx_1) (not (= ix_1 jx_1))))) (not (= (e Heap@@13 ix_1) (e Heap@@13 jx_1))))
 :qid |stdinbpl.926:20|
 :skolemid |86|
 :pattern ( (|Seq#ContainsTrigger| xs ix_1) (|Seq#ContainsTrigger| xs jx_1))
 :pattern ( (|Seq#ContainsTrigger| xs ix_1) (|Seq#Contains| xs jx_1))
 :pattern ( (|Seq#Contains| xs ix_1) (|Seq#ContainsTrigger| xs jx_1))
 :pattern ( (|Seq#Contains| xs ix_1) (|Seq#Contains| xs jx_1))
 :pattern ( (|Seq#ContainsTrigger| xs ix_1) (|e#frame| EmptyFrame jx_1))
 :pattern ( (|Seq#Contains| xs ix_1) (|e#frame| EmptyFrame jx_1))
 :pattern ( (|Seq#ContainsTrigger| xs jx_1) (|e#frame| EmptyFrame ix_1))
 :pattern ( (|Seq#Contains| xs jx_1) (|e#frame| EmptyFrame ix_1))
 :pattern ( (|e#frame| EmptyFrame ix_1) (|e#frame| EmptyFrame jx_1))
)) (=> (and (state Heap@@13 ZeroMask) (state Heap@@13 ZeroMask)) (and (and (=> (= (ControlFlow 0 22) 20) anon24_Else_correct) (=> (= (ControlFlow 0 22) 9) anon25_Then_correct)) (=> (= (ControlFlow 0 22) 7) anon25_Else_correct))))))
(let ((anon23_Then_correct true))
(let ((anon22_Then_correct true))
(let ((anon6_correct true))
(let ((anon21_Then_correct  (=> (and (|Seq#Contains| xs ix_2) (and (|Seq#Contains| xs jx_2) (not (= ix_2 jx_2)))) (and (and (=> (= (ControlFlow 0 5) 3) anon22_Then_correct) (=> (= (ControlFlow 0 5) 4) anon23_Then_correct)) (=> (= (ControlFlow 0 5) 1) anon6_correct)))))
(let ((anon21_Else_correct  (=> (and (not (and (|Seq#Contains| xs ix_2) (and (|Seq#Contains| xs jx_2) (not (= ix_2 jx_2))))) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (state Heap@@13 ZeroMask)) (and (and (=> (= (ControlFlow 0 23) 22) anon20_Else_correct) (=> (= (ControlFlow 0 23) 5) anon21_Then_correct)) (=> (= (ControlFlow 0 23) 2) anon21_Else_correct))))))
