...
(assert  (and (and (= (type Heap@@21) (MapType0Type RefType)) (= (type xs@@3) (SeqType RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
...
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@0 (|Seq#Index| xs@@3 0) f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 (|Seq#Index| xs@@3 0) f_7))) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
(let ((anon5_Then_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (< 0 (|Seq#Length| xs@@3))) (=> (< 0 (|Seq#Length| xs@@3)) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= (get02 Heap@@21 xs@@3 0) 5))))
(let ((anon0_correct  (=> (and (and (state Heap@@21 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (< 0 (|Seq#Length| xs@@3)) (state Heap@@21 ZeroMask))) (and (=> (= (ControlFlow 0 9) (- 0 12)) (< 0 (|Seq#Length| xs@@3))) (=> (< 0 (|Seq#Length| xs@@3)) (=> (and (and (not (= (|Seq#Index| xs@@3 0) null)) (= Mask@0 (MapType1Store ZeroMask (|Seq#Index| xs@@3 0) f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask (|Seq#Index| xs@@3 0) f_7)) FullPerm))))) (and (state Heap@@21 Mask@0) (state Heap@@21 Mask@0))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (< 0 (|Seq#Length| xs@@3))) (=> (< 0 (|Seq#Length| xs@@3)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm Mask@0 (|Seq#Index| xs@@3 0) f_7)) (=> (HasDirectPerm Mask@0 (|Seq#Index| xs@@3 0) f_7) (=> (and (= (U_2_int (MapType0Select Heap@@21 (|Seq#Index| xs@@3 0) f_7)) 5) (state Heap@@21 Mask@0)) (and (=> (= (ControlFlow 0 9) 7) anon5_Then_correct) (=> (= (ControlFlow 0 9) 2) anon5_Else_correct)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 13) 9) anon0_correct)))
