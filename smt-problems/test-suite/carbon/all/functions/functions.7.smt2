...
(assert  (and (= (type Heap@@47) (MapType0Type RefType)) (= (type x@@56) RefType)))
(set-info :boogie-vc-id |err1#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@47 ZeroMask) (U_2_bool (MapType0Select Heap@@47 x@@56 $allocated))) (and (= AssumeFunctionsAbove 8) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm ZeroMask x@@56 h))))
