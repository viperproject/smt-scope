...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type f_7) (FieldType NormalFieldType intType))) (= (type b1) (FieldType NormalFieldType boolType))) (= (type b2) (FieldType NormalFieldType boolType))))
(assert (distinct $allocated f_7 b1 b2)
)
...
(assert  (not (IsPredicateField b1)))
(assert  (not (IsWandField b1)))
(assert  (not (IsPredicateField b2)))
(assert  (not (IsWandField b2)))
...
(assert  (and (and (and (and (and (and (and (and (= (type x@@11) RefType) (= (type y1@@5) RefType)) (= (type Mask@3) (MapType1Type RefType realType))) (= (type y2) RefType)) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id foo4)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon7_correct true))
(let ((anon10_Else_correct  (=> (not (= x@@11 y1@@5)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (HasDirectPerm Mask@3 y1@@5 f_7)) (=> (HasDirectPerm Mask@3 y1@@5 f_7) (and (=> (= (ControlFlow 0 5) (- 0 6)) (= (U_2_int (MapType0Select ExhaleHeap@0 y1@@5 f_7)) 1)) (=> (= (U_2_int (MapType0Select ExhaleHeap@0 y1@@5 f_7)) 1) (=> (and (state ExhaleHeap@0 Mask@3) (= (ControlFlow 0 5) 1)) anon7_correct))))))))
(let ((anon10_Then_correct  (=> (= x@@11 y1@@5) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@3 y2 f_7)) (=> (HasDirectPerm Mask@3 y2 f_7) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (U_2_int (MapType0Select ExhaleHeap@0 y2 f_7)) 2)) (=> (= (U_2_int (MapType0Select ExhaleHeap@0 y2 f_7)) 2) (=> (and (state ExhaleHeap@0 Mask@3) (= (ControlFlow 0 2) 1)) anon7_correct))))))))
(let ((anon4_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (= (U_2_int (MapType0Select ExhaleHeap@0 y1@@5 f_7)) 1) (= (U_2_int (MapType0Select ExhaleHeap@0 y2 f_7)) 2))) (=> (or (= (U_2_int (MapType0Select ExhaleHeap@0 y1@@5 f_7)) 1) (= (U_2_int (MapType0Select ExhaleHeap@0 y2 f_7)) 2)) (=> (state ExhaleHeap@0 Mask@3) (and (=> (= (ControlFlow 0 8) 2) anon10_Then_correct) (=> (= (ControlFlow 0 8) 5) anon10_Else_correct)))))))
(let ((anon9_Else_correct  (=> (and (= (U_2_int (MapType0Select ExhaleHeap@0 y1@@5 f_7)) 1) (= (ControlFlow 0 12) 8)) anon4_correct)))
(let ((anon9_Then_correct  (=> (not (= (U_2_int (MapType0Select ExhaleHeap@0 y1@@5 f_7)) 1)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm Mask@3 y2 f_7)) (=> (HasDirectPerm Mask@3 y2 f_7) (=> (= (ControlFlow 0 10) 8) anon4_correct))))))
(let ((anon2_correct  (=> (= Mask@2 (MapType1Store Mask@1 x@@11 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 x@@11 f_7)) perm_temp_quasihavoc_@0)))) (=> (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)) (and (=> (= (ControlFlow 0 13) (- 0 15)) (>= perm_temp_quasihavoc_@0 NoPerm)) (=> (>= perm_temp_quasihavoc_@0 NoPerm) (=> (=> (> perm_temp_quasihavoc_@0 NoPerm) (not (= x@@11 null))) (=> (and (and (= Mask@3 (MapType1Store Mask@2 x@@11 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@2 x@@11 f_7)) perm_temp_quasihavoc_@0)))) (state ExhaleHeap@0 Mask@3)) (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm Mask@3 y1@@5 f_7)) (=> (HasDirectPerm Mask@3 y1@@5 f_7) (and (=> (= (ControlFlow 0 13) 10) anon9_Then_correct) (=> (= (ControlFlow 0 13) 12) anon9_Else_correct))))))))))))
(let ((anon8_Else_correct  (=> (and (= perm_temp_quasihavoc_@0 NoPerm) (= (ControlFlow 0 18) 13)) anon2_correct)))
(let ((anon8_Then_correct  (=> (not (= perm_temp_quasihavoc_@0 NoPerm)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= perm_temp_quasihavoc_@0 (U_2_real (MapType1Select Mask@1 x@@11 f_7)))) (=> (<= perm_temp_quasihavoc_@0 (U_2_real (MapType1Select Mask@1 x@@11 f_7))) (=> (= (ControlFlow 0 16) 13) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 x@@11 $allocated)) (U_2_bool (MapType0Select Heap@@9 y1@@5 $allocated))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@9 y2 $allocated)) (not (= y1@@5 null))) (and (= Mask@0 (MapType1Store ZeroMask y1@@5 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask y1@@5 f_7)) FullPerm)))) (state Heap@@9 Mask@0))) (and (and (not (= y2 null)) (= Mask@1 (MapType1Store Mask@0 y2 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y2 f_7)) FullPerm))))) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1)))) (and (=> (= (ControlFlow 0 19) (- 0 22)) (HasDirectPerm Mask@1 y1@@5 f_7)) (=> (HasDirectPerm Mask@1 y1@@5 f_7) (=> (= (U_2_int (MapType0Select Heap@@9 y1@@5 f_7)) 1) (and (=> (= (ControlFlow 0 19) (- 0 21)) (HasDirectPerm Mask@1 y2 f_7)) (=> (HasDirectPerm Mask@1 y2 f_7) (=> (and (= (U_2_int (MapType0Select Heap@@9 y2 f_7)) 2) (state Heap@@9 Mask@1)) (=> (and (and (or (= x@@11 y1@@5) (= x@@11 y2)) (state Heap@@9 Mask@1)) (and (= perm_temp_quasihavoc_@0 (U_2_real (MapType1Select Mask@1 x@@11 f_7))) (state Heap@@9 Mask@1))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (>= perm_temp_quasihavoc_@0 NoPerm)) (=> (>= perm_temp_quasihavoc_@0 NoPerm) (and (=> (= (ControlFlow 0 19) 16) anon8_Then_correct) (=> (= (ControlFlow 0 19) 18) anon8_Else_correct))))))))))))))))
