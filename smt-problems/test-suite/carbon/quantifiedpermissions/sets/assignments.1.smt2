...
(assert  (and (and (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type x@@19) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type xs) (MapType2Type RefType boolType))) (= (type Heap@@9) (MapType0Type RefType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv4 arg0@@43)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon4_correct  (=> (= Mask@0 (MapType1Store QPMask@0 x@@19 f_7 (real_2_U (- (U_2_real (MapType1Select QPMask@0 x@@19 f_7)) FullPerm)))) (=> (and (IdenticalOnKnownLocations Heap@0 ExhaleHeap@0 Mask@0) (state ExhaleHeap@0 Mask@0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm Mask@0 x@@19 f_7)) (=> (HasDirectPerm Mask@0 x@@19 f_7) (=> (= (ControlFlow 0 3) (- 0 2)) (= (MapType0Select ExhaleHeap@0 x@@19 f_7) x@@19))))))))
...
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 10)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (U_2_bool (MapType2Select xs z_1))) (U_2_bool (MapType2Select xs z_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1))))
 :qid |stdinbpl.621:15|
 :skolemid |100|
 :no-pattern (type z_1)
...
)) (=> (forall ((z_1@@1 T@U) ) (!  (=> (= (type z_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs z_1@@1)) (< NoPerm FullPerm)) (and (qpRange4 z_1@@1) (= (invRecv4 z_1@@1) z_1@@1))))
 :qid |stdinbpl.627:22|
 :skolemid |101|
 :pattern ( (MapType0Select Heap@@9 z_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@1 f_7))
 :pattern ( (MapType2Select xs z_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv4 o_3))) (< NoPerm FullPerm)) (qpRange4 o_3)) (= (invRecv4 o_3) o_3)))
 :qid |stdinbpl.631:22|
 :skolemid |102|
...
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@19 $allocated))) (and (U_2_bool (MapType2Select xs x@@19)) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 11) 1) anon5_Then_correct) (=> (= (ControlFlow 0 11) 8) anon5_Else_correct)))))
