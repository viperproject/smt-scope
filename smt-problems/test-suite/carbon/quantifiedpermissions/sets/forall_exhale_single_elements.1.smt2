...
(assert  (and (and (and (and (and (and (and (= (type QPMask@0) (MapType1Type RefType realType)) (= (type x@@19) RefType)) (= (type y@@6) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv4 arg0@@43)) RefType)
...
(let ((anon6_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= perm@0 (U_2_real (MapType1Select QPMask@0 x@@19 f_7)))) (=> (<= perm@0 (U_2_real (MapType1Select QPMask@0 x@@19 f_7))) (=> (= (ControlFlow 0 3) 2) anon4_correct))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 9)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) z_1))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) z_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1))))
 :qid |stdinbpl.747:17|
 :skolemid |100|
 :pattern ( (neverTriggered4 z_1) (neverTriggered4 z_1_1))
))) (=> (forall ((z_1@@0 T@U) (z_1_1@@0 T@U) ) (!  (=> (and (= (type z_1@@0) RefType) (= (type z_1_1@@0) RefType)) (=> (and (and (and (and (not (= z_1@@0 z_1_1@@0)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) z_1@@0))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) z_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1@@0 z_1_1@@0))))
 :qid |stdinbpl.747:17|
 :skolemid |100|
 :pattern ( (neverTriggered4 z_1@@0) (neverTriggered4 z_1_1@@0))
)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (forall ((z_1@@1 T@U) ) (!  (=> (and (= (type z_1@@1) RefType) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) z_1@@1))) (>= (U_2_real (MapType1Select Mask@1 z_1@@1 f_7)) FullPerm))
 :qid |stdinbpl.754:17|
 :skolemid |101|
 :pattern ( (MapType0Select Heap@@9 z_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@1 f_7))
 :pattern ( (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) z_1@@1))
))) (=> (forall ((z_1@@2 T@U) ) (!  (=> (and (= (type z_1@@2) RefType) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) z_1@@2))) (>= (U_2_real (MapType1Select Mask@1 z_1@@2 f_7)) FullPerm))
 :qid |stdinbpl.754:17|
 :skolemid |101|
 :pattern ( (MapType0Select Heap@@9 z_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@2 f_7))
 :pattern ( (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) z_1@@2))
)) (=> (forall ((z_1@@3 T@U) ) (!  (=> (= (type z_1@@3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) z_1@@3)) (< NoPerm FullPerm)) (and (qpRange4 z_1@@3) (= (invRecv4 z_1@@3) z_1@@3))))
 :qid |stdinbpl.760:22|
 :skolemid |102|
 :pattern ( (MapType0Select Heap@@9 z_1@@3 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@3 f_7))
 :pattern ( (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) z_1@@3))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) (invRecv4 o_3))) (and (< NoPerm FullPerm) (qpRange4 o_3))) (= (invRecv4 o_3) o_3)))
 :qid |stdinbpl.764:22|
 :skolemid |103|
 :pattern ( (invRecv4 o_3))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) (invRecv4 o_3@@0))) (and (< NoPerm FullPerm) (qpRange4 o_3@@0))) (and (= (invRecv4 o_3@@0) o_3@@0) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (- (U_2_real (MapType1Select Mask@1 o_3@@0 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) (invRecv4 o_3@@0))) (and (< NoPerm FullPerm) (qpRange4 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select Mask@1 o_3@@0 f_7))))))
 :qid |stdinbpl.770:22|
 :skolemid |104|
