...
(set-info :boogie-vc-id |Wand_readonly_for_writeonlyget_in_1$#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon4_correct true))
(let ((anon6_Else_correct  (=> (not (= (U_2_int (MapType0Select Heap@3 this$_1@@3 Wand_readonly_for_writeonlylemma$)) 1)) (=> (and (= Heap@5 Heap@3) (= (ControlFlow 0 3) 1)) anon4_correct))))
(let ((anon6_Then_correct  (=> (and (and (= (U_2_int (MapType0Select Heap@3 this$_1@@3 Wand_readonly_for_writeonlylemma$)) 1) (= Heap@4 (MapType0Store Heap@3 null (|Wand_readonly_for_writeonlyvalid_wand$#sm| this$_1@@3) (MapType1Store (MapType0Select Heap@3 null (|Wand_readonly_for_writeonlyvalid_wand$#sm| this$_1@@3)) (MapType0Select Heap@3 this$_1@@3 Wand_readonly_for_writeonlythis_1$) WandDemox$ (bool_2_U true))))) (and (= Heap@5 Heap@4) (= (ControlFlow 0 2) 1))) anon4_correct)))
(let ((anon2_correct  (=> (and (<= (U_2_int (MapType0Select Heap@@26 this$_1@@3 Wand_readonly_for_writeonlylemma$)) 1) (state Heap@@26 UnfoldingMask@6)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm UnfoldingMask@6 this$_1@@3 Wand_readonly_for_writeonlyin_1$)) (=> (HasDirectPerm UnfoldingMask@6 this$_1@@3 Wand_readonly_for_writeonlyin_1$) (=> (and (and (= Heap@0 (MapType0Store Heap@@26 null (|Wand_readonly_for_writeonlyvalid_wand$#sm| this$_1@@3) (MapType1Store (MapType0Select Heap@@26 null (|Wand_readonly_for_writeonlyvalid_wand$#sm| this$_1@@3)) this$_1@@3 Wand_readonly_for_writeonlylemma$ (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|Wand_readonly_for_writeonlyvalid_wand$#sm| this$_1@@3) (MapType1Store (MapType0Select Heap@0 null (|Wand_readonly_for_writeonlyvalid_wand$#sm| this$_1@@3)) this$_1@@3 Wand_readonly_for_writeonlyin_1$ (bool_2_U true))))) (and (= Heap@2 (MapType0Store Heap@1 null (|Wand_readonly_for_writeonlyvalid_wand$#sm| this$_1@@3) (MapType1Store (MapType0Select Heap@1 null (|Wand_readonly_for_writeonlyvalid_wand$#sm| this$_1@@3)) this$_1@@3 Wand_readonly_for_writeonlyout_1$ (bool_2_U true)))) (= Heap@3 (MapType0Store Heap@2 null (|Wand_readonly_for_writeonlyvalid_wand$#sm| this$_1@@3) (MapType1Store (MapType0Select Heap@2 null (|Wand_readonly_for_writeonlyvalid_wand$#sm| this$_1@@3)) this$_1@@3 Wand_readonly_for_writeonlythis_1$ (bool_2_U true)))))) (and (=> (= (ControlFlow 0 4) 2) anon6_Then_correct) (=> (= (ControlFlow 0 4) 3) anon6_Else_correct))))))))
(let ((anon5_Else_correct  (=> (not (= (U_2_int (MapType0Select Heap@@26 this$_1@@3 Wand_readonly_for_writeonlylemma$)) 1)) (=> (and (= UnfoldingMask@6 UnfoldingMask@4) (= (ControlFlow 0 7) 4)) anon2_correct))))
(let ((anon5_Then_correct  (=> (and (= (U_2_int (MapType0Select Heap@@26 this$_1@@3 Wand_readonly_for_writeonlylemma$)) 1) (not (= (MapType0Select Heap@@26 this$_1@@3 Wand_readonly_for_writeonlythis_1$) null))) (=> (and (and (and (> wildcard@6 NoPerm) (not (= (MapType0Select Heap@@26 this$_1@@3 Wand_readonly_for_writeonlythis_1$) null))) (and (= UnfoldingMask@5 (MapType1Store UnfoldingMask@4 (MapType0Select Heap@@26 this$_1@@3 Wand_readonly_for_writeonlythis_1$) WandDemox$ (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@4 (MapType0Select Heap@@26 this$_1@@3 Wand_readonly_for_writeonlythis_1$) WandDemox$)) wildcard@6)))) (state Heap@@26 UnfoldingMask@5))) (and (and (= (MapType0Select Heap@@26 this$_1@@3 Wand_readonly_for_writeonlyin_1$) (MapType0Select Heap@@26 this$_1@@3 Wand_readonly_for_writeonlythis_1$)) (= (MapType0Select Heap@@26 this$_1@@3 Wand_readonly_for_writeonlyout_1$) (MapType0Select Heap@@26 this$_1@@3 Wand_readonly_for_writeonlythis_1$))) (and (= UnfoldingMask@6 UnfoldingMask@5) (= (ControlFlow 0 6) 4)))) anon2_correct))))
(let ((anon0_correct  (=> (state Heap@@26 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@26 this$_1@@3 $allocated)) (= AssumeFunctionsAbove 1)) (=> (and (and (and (not (= this$_1@@3 null)) (state Heap@@26 ZeroMask)) (and (> wildcard@0 NoPerm) (= Mask@0 (MapType1Store ZeroMask null (Wand_readonly_for_writeonlyvalid_wand$ this$_1@@3) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Wand_readonly_for_writeonlyvalid_wand$ this$_1@@3))) wildcard@0)))))) (and (and (state Heap@@26 Mask@0) (state Heap@@26 Mask@0)) (and (|Wand_readonly_for_writeonlyvalid_wand$#trigger| Heap@@26 (Wand_readonly_for_writeonlyvalid_wand$ this$_1@@3)) (= (MapType0Select Heap@@26 null (Wand_readonly_for_writeonlyvalid_wand$ this$_1@@3)) (CombineFrames (FrameFragment (MapType0Select Heap@@26 this$_1@@3 Wand_readonly_for_writeonlylemma$)) (CombineFrames (FrameFragment (MapType0Select Heap@@26 this$_1@@3 Wand_readonly_for_writeonlyin_1$)) (CombineFrames (FrameFragment (MapType0Select Heap@@26 this$_1@@3 Wand_readonly_for_writeonlyout_1$)) (CombineFrames (FrameFragment (MapType0Select Heap@@26 this$_1@@3 Wand_readonly_for_writeonlythis_1$)) (FrameFragment (ite (= (U_2_int (MapType0Select Heap@@26 this$_1@@3 Wand_readonly_for_writeonlylemma$)) 1) (FrameFragment (MapType0Select Heap@@26 (MapType0Select Heap@@26 this$_1@@3 Wand_readonly_for_writeonlythis_1$) WandDemox$)) EmptyFrame)))))))))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (> (U_2_real (MapType1Select Mask@0 null (Wand_readonly_for_writeonlyvalid_wand$ this$_1@@3))) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@0 null (Wand_readonly_for_writeonlyvalid_wand$ this$_1@@3))) NoPerm) (=> (and (and (> wildcard@1 NoPerm) (< wildcard@1 (U_2_real (MapType1Select Mask@0 null (Wand_readonly_for_writeonlyvalid_wand$ this$_1@@3))))) (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (Wand_readonly_for_writeonlyvalid_wand$ this$_1@@3) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (Wand_readonly_for_writeonlyvalid_wand$ this$_1@@3))) wildcard@1)))) (> wildcard@2 NoPerm))) (=> (and (and (and (and (not (= this$_1@@3 null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this$_1@@3 Wand_readonly_for_writeonlylemma$ (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this$_1@@3 Wand_readonly_for_writeonlylemma$)) wildcard@2))))) (and (state Heap@@26 UnfoldingMask@1) (<= 1 (U_2_int (MapType0Select Heap@@26 this$_1@@3 Wand_readonly_for_writeonlylemma$))))) (and (and (> wildcard@3 NoPerm) (not (= this$_1@@3 null))) (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 this$_1@@3 Wand_readonly_for_writeonlyin_1$ (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 this$_1@@3 Wand_readonly_for_writeonlyin_1$)) wildcard@3)))) (state Heap@@26 UnfoldingMask@2)))) (and (and (and (> wildcard@4 NoPerm) (not (= this$_1@@3 null))) (and (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 this$_1@@3 Wand_readonly_for_writeonlyout_1$ (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 this$_1@@3 Wand_readonly_for_writeonlyout_1$)) wildcard@4)))) (state Heap@@26 UnfoldingMask@3))) (and (and (> wildcard@5 NoPerm) (not (= this$_1@@3 null))) (and (= UnfoldingMask@4 (MapType1Store UnfoldingMask@3 this$_1@@3 Wand_readonly_for_writeonlythis_1$ (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@3 this$_1@@3 Wand_readonly_for_writeonlythis_1$)) wildcard@5)))) (state Heap@@26 UnfoldingMask@4))))) (and (=> (= (ControlFlow 0 8) 6) anon5_Then_correct) (=> (= (ControlFlow 0 8) 7) anon5_Else_correct)))))))))))
