...
(assert  (and (= (type this) RefType) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id e2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct true))
(let ((anon3_Then_correct  (=> (and (not (= this null)) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm ZeroMask this x@@8))))
...
(declare-fun Heap@@9 () T@U)
(assert  (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type this) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id t4)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon8_Else_correct true))
(let ((anon8_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (not (= this null)) (= (ControlFlow 0 8) (- 0 7))) (HasDirectPerm ZeroMask this x@@8)))))
...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@0 this x@@8)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 this x@@8))) (=> (= (ControlFlow 0 2) 1) anon6_correct))))))
(let ((anon7_Else_correct  (=> (not (= this null)) (=> (and (= Mask@0 (MapType1Store ZeroMask this x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this x@@8)) FullPerm)))) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@0 this x@@8)) (=> (HasDirectPerm Mask@0 this x@@8) (=> (= (U_2_int (MapType0Select Heap@@9 this x@@8)) 0) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 5) 2) anon9_Then_correct) (=> (= (ControlFlow 0 5) 4) anon9_Else_correct))))))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 this $allocated))) (and (=> (= (ControlFlow 0 11) 10) anon7_Then_correct) (=> (= (ControlFlow 0 11) 5) anon7_Else_correct)))))
