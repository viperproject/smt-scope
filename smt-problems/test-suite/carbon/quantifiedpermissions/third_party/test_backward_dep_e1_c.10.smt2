...
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (< (- i@@34 1) (- len 1))) (=> (< (- i@@34 1) (- len 1)) (=> (= perm@2 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (and (=> (= (ControlFlow 0 9) 6) anon6_Then_correct) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct)))))))))
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (< (- i@@34 1) (- len 1)) (state PostHeap@0 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i@@34 0)) (=> (>= i@@34 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i@@34 (|Seq#Length| a_2))) (=> (< i@@34 (|Seq#Length| a_2)) (=> (and (= perm@1 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@1 NoPerm))))))))))
