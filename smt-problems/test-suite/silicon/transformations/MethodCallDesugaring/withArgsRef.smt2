(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:32:35
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/transformations/MethodCallDesugaring/withArgsRef.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
; [eval] y + x + 1
; [eval] y + x
(assert (< (+ x@5@01 y@6@01) (+ (+ y@6@01 x@5@01) 1)))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
