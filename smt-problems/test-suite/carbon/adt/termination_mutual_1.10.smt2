...
(set-info :boogie-vc-id len2Bad_termination_proof)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_correct true))
(let ((anon4_Else_correct  (=> (not (= l_1@@28 Empty)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing l_1@@28 l_1@@28)) (=> (decreasing l_1@@28 l_1@@28) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded l_1@@28)) (=> (bounded l_1@@28) (=> (and (state Heap@@53 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
