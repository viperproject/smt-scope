...
(assert  (and (and (and (and (and (= (type xs@@19) (MapType2Type RefType boolType)) (= (type Heap@@28) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@57 T@U) ) (! (= (type (invRecv7 arg0@@57)) RefType)
 :qid |funType:invRecv7|
 :pattern ( (invRecv7 arg0@@57))
))))
...
(let ((anon17_Then_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (U_2_bool (MapType2Select xs@@19 x_3))) (U_2_bool (MapType2Select xs@@19 x_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1))))
 :qid |stdinbpl.1291:23|
 :skolemid |164|
...
)) (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((x_3@@1 T@U) ) (!  (=> (and (= (type x_3@@1) RefType) (U_2_bool (MapType2Select xs@@19 x_3@@1))) (>= (U_2_real (MapType1Select QPMask@0 x_3@@1 f_7)) FullPerm))
 :qid |stdinbpl.1298:23|
 :skolemid |165|
 :pattern ( (MapType0Select Heap@@28 x_3@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 x_3@@1 f_7))
 :pattern ( (MapType2Select xs@@19 x_3@@1))
)))))))
(let ((anon18_Else_correct true))
(let ((anon18_Then_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (foo Heap@@28 xs@@19 i_3))))
(let ((anon14_Else_correct  (=> (forall ((i_1_2 Int) ) (! (foo Heap@@28 xs@@19 i_1_2)
 :qid |stdinbpl.1267:20|
 :skolemid |163|
 :pattern ( (|foo#frame| (FrameFragment (int_2_U (|foo#condqp1| Heap@@28 xs@@19 i_1_2))) xs@@19 i_1_2))
)) (=> (and (state Heap@@28 QPMask@0) (state Heap@@28 QPMask@0)) (and (and (and (=> (= (ControlFlow 0 13) 7) anon18_Then_correct) (=> (= (ControlFlow 0 13) 8) anon18_Else_correct)) (=> (= (ControlFlow 0 13) 10) anon17_Then_correct)) (=> (= (ControlFlow 0 13) 12) anon17_Else_correct))))))
(let ((anon15_Else_correct true))
(let ((anon15_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_2 T@U) (x_2_1 T@U) ) (!  (=> (and (= (type x_2) RefType) (= (type x_2_1) RefType)) (=> (and (and (and (and (not (= x_2 x_2_1)) (U_2_bool (MapType2Select xs@@19 x_2))) (U_2_bool (MapType2Select xs@@19 x_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_2 x_2_1))))
 :qid |stdinbpl.1224:23|
 :skolemid |157|
 :pattern ( (neverTriggered8 x_2) (neverTriggered8 x_2_1))
 ...
 :qid |stdinbpl.1224:23|
 :skolemid |157|
 :pattern ( (neverTriggered8 x_2@@0) (neverTriggered8 x_2_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_2@@1 T@U) ) (!  (=> (and (= (type x_2@@1) RefType) (U_2_bool (MapType2Select xs@@19 x_2@@1))) (>= (U_2_real (MapType1Select QPMask@0 x_2@@1 f_7)) FullPerm))
 :qid |stdinbpl.1231:23|
 :skolemid |158|
 :pattern ( (MapType0Select Heap@@28 x_2@@1 f_7))
 :pattern ( (MapType1Select QPMask@2 x_2@@1 f_7))
 :pattern ( (MapType2Select xs@@19 x_2@@1))
)))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select xs@@19 x_1))) (U_2_bool (MapType2Select xs@@19 x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs@@19 x_1@@1)) (< NoPerm FullPerm)) (and (qpRange7 x_1@@1) (= (invRecv7 x_1@@1) x_1@@1))))
...
)) (=> (and (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select xs@@19 (invRecv7 o_3))) (< NoPerm FullPerm)) (qpRange7 o_3)) (= (invRecv7 o_3) o_3)))
 :qid |stdinbpl.1183:22|
 :skolemid |153|
 :pattern ( (invRecv7 o_3))
)) (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (U_2_bool (MapType2Select xs@@19 x_1@@2))) (not (= x_1@@2 null)))
 :qid |stdinbpl.1189:22|
 :skolemid |154|
 :pattern ( (MapType0Select Heap@@28 x_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@2 f_7))
 :pattern ( (MapType2Select xs@@19 x_1@@2))
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs@@19 (invRecv7 o_3@@0))) (< NoPerm FullPerm)) (qpRange7 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv7 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select xs@@19 (invRecv7 o_3@@0))) (< NoPerm FullPerm)) (qpRange7 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
)))) (and (and (state Heap@@28 QPMask@0) (state Heap@@28 QPMask@0)) (and (state Heap@@28 QPMask@0) (state Heap@@28 QPMask@0)))) (and (and (=> (= (ControlFlow 0 14) 13) anon14_Else_correct) (=> (= (ControlFlow 0 14) 3) anon15_Then_correct)) (=> (= (ControlFlow 0 14) 5) anon15_Else_correct))))))))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@28 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 16) 1) anon13_Then_correct) (=> (= (ControlFlow 0 16) 14) anon13_Else_correct)))))
