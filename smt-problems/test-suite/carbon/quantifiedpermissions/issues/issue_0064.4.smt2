...
(assert  (and (and (and (= (type s@@21) (SeqType RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (forall ((arg0@@52 T@U) ) (! (= (type (invRecv9 arg0@@52)) RefType)
 :qid |funType:invRecv9|
 :pattern ( (invRecv9 arg0@@52))
))))
(set-info :boogie-vc-id reprotwo)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon13_correct true))
(let ((anon21_Else_correct  (=> (and (not (and (<= 0 x_5) (< x_5 (|Seq#Length| s@@21)))) (= (ControlFlow 0 18) 15)) anon13_correct)))
(let ((anon21_Then_correct  (=> (and (<= 0 x_5) (< x_5 (|Seq#Length| s@@21))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| s@@21 x_5) f_7)) 0)) (=> (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| s@@21 x_5) f_7)) 0) (=> (= (ControlFlow 0 16) 15) anon13_correct))))))
(let ((anon9_correct true))
(let ((anon19_Else_correct  (=> (and (not (and (<= 0 x_7) (< x_7 (|Seq#Length| s@@21)))) (= (ControlFlow 0 14) 9)) anon9_correct)))
(let ((anon19_Then_correct  (=> (and (<= 0 x_7) (< x_7 (|Seq#Length| s@@21))) (and (=> (= (ControlFlow 0 10) (- 0 13)) (>= x_7 0)) (=> (>= x_7 0) (and (=> (= (ControlFlow 0 10) (- 0 12)) (< x_7 (|Seq#Length| s@@21))) (=> (< x_7 (|Seq#Length| s@@21)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm QPMask@0 (|Seq#Index| s@@21 x_7) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| s@@21 x_7) f_7) (=> (= (ControlFlow 0 10) 9) anon9_correct))))))))))
(let ((anon20_Else_correct true))
(let ((anon16_Else_correct  (=> (forall ((x_3_1 Int) ) (!  (=> (and (<= 0 x_3_1) (< x_3_1 (|Seq#Length| s@@21))) (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| s@@21 x_3_1) f_7)) 0))
 :qid |stdinbpl.1655:20|
 :skolemid |183|
 :pattern ( (|Seq#Index| s@@21 x_3_1))
)) (=> (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)) (and (and (and (and (=> (= (ControlFlow 0 19) 8) anon20_Else_correct) (=> (= (ControlFlow 0 19) 16) anon21_Then_correct)) (=> (= (ControlFlow 0 19) 18) anon21_Else_correct)) (=> (= (ControlFlow 0 19) 10) anon19_Then_correct)) (=> (= (ControlFlow 0 19) 14) anon19_Else_correct))))))
(let ((anon5_correct true))
(let ((anon17_Else_correct  (=> (and (not (and (<= 0 x_6) (< x_6 (|Seq#Length| s@@21)))) (= (ControlFlow 0 7) 2)) anon5_correct)))
(let ((anon17_Then_correct  (=> (and (<= 0 x_6) (< x_6 (|Seq#Length| s@@21))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (>= x_6 0)) (=> (>= x_6 0) (and (=> (= (ControlFlow 0 3) (- 0 5)) (< x_6 (|Seq#Length| s@@21))) (=> (< x_6 (|Seq#Length| s@@21)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 (|Seq#Index| s@@21 x_6) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| s@@21 x_6) f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| s@@21 x_1)) (|Seq#Contains| s@@21 x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
...
)) (=> (and (and (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| s@@21 x_1@@1) (< NoPerm FullPerm)) (and (qpRange9 x_1@@1) (= (invRecv9 x_1@@1) x_1@@1))))
...
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| s@@21 (invRecv9 o_3)) (< NoPerm FullPerm)) (qpRange9 o_3)) (= (invRecv9 o_3) o_3)))
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| s@@21 (invRecv9 o_3@@0)) (< NoPerm FullPerm)) (qpRange9 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv9 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| s@@21 (invRecv9 o_3@@0)) (< NoPerm FullPerm)) (qpRange9 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (and (=> (= (ControlFlow 0 20) 19) anon16_Else_correct) (=> (= (ControlFlow 0 20) 3) anon17_Then_correct)) (=> (= (ControlFlow 0 20) 7) anon17_Else_correct)))))))
(let ((anon15_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 22) 1) anon15_Then_correct) (=> (= (ControlFlow 0 22) 20) anon15_Else_correct)))))
