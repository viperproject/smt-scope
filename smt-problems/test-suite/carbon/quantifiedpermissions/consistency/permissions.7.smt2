...
(declare-fun y@@2 () T@U)
(assert  (and (and (and (and (= (type xs) (SeqType RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@35 T@U) ) (! (= (type (invRecv3 arg0@@35)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| xs x_1)) (|Seq#Contains| xs x_1_1)) (< NoPerm p_1)) (< NoPerm p_1)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.991:15|
 :skolemid |70|
 :no-pattern (type x_1)
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (|Seq#Contains| xs x_1@@0)) (|Seq#Contains| xs x_1_1@@0)) (< NoPerm p_1)) (< NoPerm p_1)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.991:15|
 :skolemid |70|
...
)) (=> (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| xs x_1@@1) (< NoPerm p_1)) (and (qpRange3 x_1@@1) (= (invRecv3 x_1@@1) x_1@@1))))
 :qid |stdinbpl.997:22|
 :skolemid |71|
...
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| xs (invRecv3 o_3)) (< NoPerm p_1)) (qpRange3 o_3)) (= (invRecv3 o_3) o_3)))
 :qid |stdinbpl.1001:22|
 :skolemid |72|
 :pattern ( (invRecv3 o_3))
))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (|Seq#Contains| xs x_1@@2)) (>= p_1 NoPerm))
...
))) (=> (forall ((x_1@@3 T@U) ) (!  (=> (and (= (type x_1@@3) RefType) (|Seq#Contains| xs x_1@@3)) (>= p_1 NoPerm))
 :qid |stdinbpl.1007:15|
 :skolemid |73|
 :pattern ( (MapType0Select Heap@@9 x_1@@3 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@3 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs x_1@@3))
 :pattern ( (|Seq#Contains| xs x_1@@3))
)) (=> (forall ((x_1@@4 T@U) ) (!  (=> (= (type x_1@@4) RefType) (=> (and (|Seq#Contains| xs x_1@@4) (> p_1 NoPerm)) (not (= x_1@@4 null))))
 :qid |stdinbpl.1013:22|
 :skolemid |74|
 :pattern ( (MapType0Select Heap@@9 x_1@@4 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@4 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs x_1@@4))
 :pattern ( (|Seq#Contains| xs x_1@@4))
)) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| xs (invRecv3 o_3@@0)) (< NoPerm p_1)) (qpRange3 o_3@@0)) (and (=> (< NoPerm p_1) (= (invRecv3 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) p_1)))) (=> (not (and (and (|Seq#Contains| xs (invRecv3 o_3@@0)) (< NoPerm p_1)) (qpRange3 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (not (= y@@2 null))) (=> (not (= y@@2 null)) (=> (and (state Heap@@9 QPMask@0) (= (ControlFlow 0 3) (- 0 2))) (not (= p_1 NoPerm))))))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 y@@2 $allocated))) (=> (and (and (|Seq#Contains| xs y@@2) (state Heap@@9 ZeroMask)) (and (<= NoPerm p_1) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 7) 1) anon3_Then_correct) (=> (= (ControlFlow 0 7) 3) anon3_Else_correct))))))
