...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 t1 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@9 t2 $allocated)) (> wildcard@0 NoPerm)) (and (not (= t1 null)) (= Mask@0 (MapType1Store ZeroMask t1 next (real_2_U (+ (U_2_real (MapType1Select ZeroMask t1 next)) wildcard@0)))))) (=> (and (and (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (> wildcard@1 NoPerm) (not (= t2 null)))) (and (and (= Mask@1 (MapType1Store Mask@0 t2 next (real_2_U (+ (U_2_real (MapType1Select Mask@0 t2 next)) wildcard@1)))) (state Heap@@9 Mask@1)) (and (state Heap@@9 Mask@1) (= (ControlFlow 0 2) (- 0 1))))) (not (= t1 t2)))))))
