...
(declare-fun bs@0 () T@U)
(assert  (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type xs@0) (SeqType intType))) (= (type bs@0) (SeqType boolType))))
(set-info :boogie-vc-id test3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (= xs@0 (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 0)) (|Seq#Singleton| (int_2_U 1))) (|Seq#Singleton| (int_2_U 2))) (|Seq#Singleton| (int_2_U 3))) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 5))) (|Seq#Singleton| (int_2_U 6))) (|Seq#Singleton| (int_2_U 7)))) (state Heap@@13 ZeroMask)) (and (= bs@0 (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (bool_2_U true)) (|Seq#Singleton| (bool_2_U true))) (|Seq#Singleton| (bool_2_U false))) (|Seq#Singleton| (bool_2_U true))) (|Seq#Append| (|Seq#Singleton| (bool_2_U false)) (|Seq#Singleton| (bool_2_U true))))) (state Heap@@13 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (|Seq#Length| (|Seq#Take| (|Seq#Drop| xs@0 1) 6)) (|Seq#Length| bs@0))) (=> (= (|Seq#Length| (|Seq#Take| (|Seq#Drop| xs@0 1) 6)) (|Seq#Length| bs@0)) (=> (and (state Heap@@13 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (|Seq#Length| (|Seq#Drop| xs@0 1)) (|Seq#Length| xs@0)))))))))
