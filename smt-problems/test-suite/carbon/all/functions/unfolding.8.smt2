...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon4_correct  (=> (and (= UnfoldingMask@2 (MapType1Store Mask@1 null (G x@@48) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (G x@@48))) FullPerm)))) (not (= x@@48 null))) (=> (and (and (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 x@@48 g (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 x@@48 g)) FullPerm)))) (state Heap@0 UnfoldingMask@3)) (and (state Heap@0 UnfoldingMask@3) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm UnfoldingMask@3 x@@48 g)))))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (G x@@48))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (G x@@48)))) (=> (= (ControlFlow 0 3) 2) anon4_correct))))))
(let ((anon2_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@1 null (F x@@48) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (F x@@48))) FullPerm)))) (=> (and (and (not (= x@@48 null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x@@48 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@48 f_7)) FullPerm))))) (and (state Heap@@37 UnfoldingMask@1) (state Heap@@37 UnfoldingMask@1))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm UnfoldingMask@1 x@@48 f_7)) (=> (HasDirectPerm UnfoldingMask@1 x@@48 f_7) (=> (and (and (= Heap@0 (MapType0Store Heap@@37 null (|F#sm| x@@48) (MapType1Store (MapType0Select Heap@@37 null (|F#sm| x@@48)) x@@48 f_7 (bool_2_U true)))) (state Heap@0 Mask@1)) (and (|G#trigger| Heap@0 (G x@@48)) (= (MapType0Select Heap@0 null (G x@@48)) (FrameFragment (MapType0Select Heap@0 x@@48 g))))) (and (=> (= (ControlFlow 0 6) 3) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))))))
(let ((anon5_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 6)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (F x@@48))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (F x@@48)))) (=> (= (ControlFlow 0 8) 6) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@37 ZeroMask) (U_2_bool (MapType0Select Heap@@37 x@@48 $allocated))) (=> (and (and (and (= AssumeFunctionsAbove 4) (= Mask@0 (MapType1Store ZeroMask null (F x@@48) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (F x@@48))) FullPerm))))) (and (state Heap@@37 Mask@0) (= Mask@1 (MapType1Store Mask@0 null (G x@@48) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (G x@@48))) FullPerm)))))) (and (and (state Heap@@37 Mask@1) (state Heap@@37 Mask@1)) (and (|F#trigger| Heap@@37 (F x@@48)) (= (MapType0Select Heap@@37 null (F x@@48)) (FrameFragment (MapType0Select Heap@@37 x@@48 f_7)))))) (and (=> (= (ControlFlow 0 11) 8) anon5_Then_correct) (=> (= (ControlFlow 0 11) 10) anon5_Else_correct))))))
