...
(assert  (and (and (and (and (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type x_2) RefType)) (= (type y@@2) RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type z_4) RefType)) (forall ((arg0@@35 T@U) ) (! (= (type (invRecv5 arg0@@35)) RefType)
 :qid |funType:invRecv5|
 :pattern ( (invRecv5 arg0@@35))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@36 T@U) ) (! (= (type (invRecv4 arg0@@36)) RefType)
 :qid |funType:invRecv4|
 :pattern ( (invRecv4 arg0@@36))
))))
...
(let ((anon12_Else_correct  (=> (and (not (or (= z_4 x_2) (= z_4 y@@2))) (= (ControlFlow 0 11) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (or (= z_4 x_2) (= z_4 y@@2)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (HasDirectPerm QPMask@1 z_4 f_7)) (=> (HasDirectPerm QPMask@1 z_4 f_7) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm QPMask@1 z_4 g)) (=> (HasDirectPerm QPMask@1 z_4 g) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (and (forall ((z_5 T@U) ) (!  (=> (and (= (type z_5) RefType) (or (= z_5 x_2) (= z_5 y@@2))) (> (+ (U_2_int (MapType0Select Heap@@13 z_5 f_7)) (U_2_int (MapType0Select Heap@@13 z_5 g))) 0))
 :qid |stdinbpl.1122:20|
 :skolemid |94|
 :pattern ( (fun01 z_5) (MapType0Select Heap@@13 z_5 f_7) (MapType0Select Heap@@13 z_5 g))
)) (state Heap@@13 QPMask@1)) (=> (and (and (state Heap@@13 QPMask@1) (fun01 x_2)) (and (state Heap@@13 QPMask@1) (state Heap@@13 QPMask@1))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (HasDirectPerm QPMask@1 x_2 f_7)) (=> (HasDirectPerm QPMask@1 x_2 f_7) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm QPMask@1 x_2 g)) (=> (HasDirectPerm QPMask@1 x_2 g) (=> (= (ControlFlow 0 4) (- 0 3)) (> (+ (U_2_int (MapType0Select Heap@@13 x_2 f_7)) (U_2_int (MapType0Select Heap@@13 x_2 g))) 0))))))))))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((z_3 T@U) (z_3_1 T@U) ) (!  (=> (and (= (type z_3) RefType) (= (type z_3_1) RefType)) (=> (and (and (and (and (not (= z_3 z_3_1)) (or (= z_3 x_2) (= z_3 y@@2))) (or (= z_3_1 x_2) (= z_3_1 y@@2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_3 z_3_1))))
...
)) (=> (and (and (forall ((z_3@@1 T@U) ) (!  (=> (= (type z_3@@1) RefType) (=> (and (or (= z_3@@1 x_2) (= z_3@@1 y@@2)) (< NoPerm FullPerm)) (and (qpRange5 z_3@@1) (= (invRecv5 z_3@@1) z_3@@1))))
 :qid |stdinbpl.1073:22|
 :skolemid |89|
 :pattern ( (MapType0Select Heap@@13 z_3@@1 g))
 :pattern ( (MapType1Select QPMask@1 z_3@@1 g))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (or (= (invRecv5 o_3) x_2) (= (invRecv5 o_3) y@@2)) (< NoPerm FullPerm)) (qpRange5 o_3)) (= (invRecv5 o_3) o_3)))
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (or (= (invRecv5 o_3@@0) x_2) (= (invRecv5 o_3@@0) y@@2)) (< NoPerm FullPerm)) (qpRange5 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv5 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 g)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@0 g)) FullPerm)))) (=> (not (and (and (or (= (invRecv5 o_3@@0) x_2) (= (invRecv5 o_3@@0) y@@2)) (< NoPerm FullPerm)) (qpRange5 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 g)) (U_2_real (MapType1Select QPMask@0 o_3@@0 g))))))
...
)) (state Heap@@13 QPMask@1)) (and (state Heap@@13 QPMask@1) (state Heap@@13 QPMask@1))) (and (and (not (= x_2 null)) (not (= y@@2 null))) (and (state Heap@@13 QPMask@1) (state Heap@@13 QPMask@1)))) (and (and (=> (= (ControlFlow 0 12) 4) anon11_Else_correct) (=> (= (ControlFlow 0 12) 8) anon12_Then_correct)) (=> (= (ControlFlow 0 12) 11) anon12_Else_correct))))))))
(let ((anon10_Then_correct true))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (or (= z_1 x_2) (= z_1 y@@2))) (or (= z_1_1 x_2) (= z_1_1 y@@2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1))))
...
)) (=> (and (and (and (forall ((z_1@@1 T@U) ) (!  (=> (= (type z_1@@1) RefType) (=> (and (or (= z_1@@1 x_2) (= z_1@@1 y@@2)) (< NoPerm FullPerm)) (and (qpRange4 z_1@@1) (= (invRecv4 z_1@@1) z_1@@1))))
 :qid |stdinbpl.1030:22|
 :skolemid |83|
 :pattern ( (MapType0Select Heap@@13 z_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@1 f_7))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (or (= (invRecv4 o_3@@2) x_2) (= (invRecv4 o_3@@2) y@@2)) (< NoPerm FullPerm)) (qpRange4 o_3@@2)) (= (invRecv4 o_3@@2) o_3@@2)))
...
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (or (= (invRecv4 o_3@@3) x_2) (= (invRecv4 o_3@@3) y@@2)) (< NoPerm FullPerm)) (qpRange4 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (or (= (invRecv4 o_3@@3) x_2) (= (invRecv4 o_3@@3) y@@2)) (< NoPerm FullPerm)) (qpRange4 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@3 f_7))))))
...
)) (state Heap@@13 QPMask@0)) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)))) (and (=> (= (ControlFlow 0 14) 2) anon10_Then_correct) (=> (= (ControlFlow 0 14) 12) anon10_Else_correct)))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@13 x_2 $allocated)) (U_2_bool (MapType0Select Heap@@13 y@@2 $allocated)))) (and (=> (= (ControlFlow 0 16) 1) anon9_Then_correct) (=> (= (ControlFlow 0 16) 14) anon9_Else_correct)))))
