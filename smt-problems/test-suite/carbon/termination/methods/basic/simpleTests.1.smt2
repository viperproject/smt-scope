...
(let ((anon4_Else_correct  (=> (> x@@8 y@@1) (and (=> (= (ControlFlow 0 3) (- 0 6)) (and (decreasing (int_2_U y@@1) (int_2_U x@@8)) (bounded (int_2_U x@@8)))) (=> (and (decreasing (int_2_U y@@1) (int_2_U x@@8)) (bounded (int_2_U x@@8))) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 3) (- 0 5)) (> y@@1 0)) (=> (> y@@1 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (> y@@1 0)) (=> (> y@@1 0) (=> (state Heap@@9 ZeroMask) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))))))
(let ((anon4_Then_correct  (=> (>= y@@1 x@@8) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) 1)) anon3_correct))))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (> x@@8 0)) (and (> y@@1 0) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 7) 2) anon4_Then_correct) (=> (= (ControlFlow 0 7) 3) anon4_Else_correct)))))
