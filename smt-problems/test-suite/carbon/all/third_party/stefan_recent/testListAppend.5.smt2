...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@9) (MapType0Type RefType)) (= (type freshObj@0) RefType)) (= (type Mask@6) (MapType1Type RefType realType))) (= (type AssertMask@0) (MapType1Type RefType realType))) (= (type Heap@7) (MapType0Type RefType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@8) (MapType0Type RefType))) (= (type Heap@6) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@5) (MapType1Type RefType realType))) (forall ((arg0@@63 T@U) (arg1@@34 T@U) ) (! (= (type (CombineFrames arg0@@63 arg1@@34)) FrameTypeType)
...
))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@37) (MapType0Type RefType))) (= (type diz@@37) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type sys__result) RefType)) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id List__List)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 48) (let ((anon4_correct true))
(let ((anon29_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 43) 40)) anon4_correct)))
(let ((anon29_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 41) (- 0 42)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (List__state sys__result))))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (List__state sys__result)))) (=> (= (ControlFlow 0 41) 40) anon4_correct))))))
(let ((anon28_Then_correct  (and (=> (= (ControlFlow 0 44) (- 0 45)) (not (= sys__result null))) (=> (not (= sys__result null)) (and (=> (= (ControlFlow 0 44) 41) anon29_Then_correct) (=> (= (ControlFlow 0 44) 43) anon29_Else_correct))))))
(let ((anon28_Else_correct true))
(let ((anon27_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (not (= sys__result null)) (state PostHeap@0 ZeroMask)) (=> (and (and (= PostMask@0 (MapType1Store ZeroMask null (List__state sys__result) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (List__state sys__result))) FullPerm)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 46) 44) anon28_Then_correct) (=> (= (ControlFlow 0 46) 39) anon28_Else_correct)))))))
(let ((anon23_correct true))
(let ((anon38_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 4)) anon23_correct)))
(let ((anon38_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@6 null (List__state freshObj@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@6 null (List__state freshObj@0)))) (=> (= (ControlFlow 0 5) 4) anon23_correct))))))
(let ((anon37_Then_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (not (= freshObj@0 null))) (=> (not (= freshObj@0 null)) (and (=> (= (ControlFlow 0 8) 5) anon38_Then_correct) (=> (= (ControlFlow 0 8) 7) anon38_Else_correct))))))
(let ((anon37_Else_correct  (=> (= (ControlFlow 0 2) (- 0 3)) (|Seq#Equal| (List__contents Heap@9 freshObj@0) (|Seq#Singleton| (int_2_U v_2))))))
(let ((anon20_correct  (=> (= AssertMask@0 (MapType1Store Mask@6 null (List__state freshObj@0) (real_2_U (- (U_2_real (MapType1Select Mask@6 null (List__state freshObj@0))) FullPerm)))) (and (=> (= (ControlFlow 0 10) 8) anon37_Then_correct) (=> (= (ControlFlow 0 10) 2) anon37_Else_correct)))))
(let ((anon36_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 10)) anon20_correct)))
(let ((anon36_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType1Select Mask@6 null (List__state freshObj@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@6 null (List__state freshObj@0)))) (=> (= (ControlFlow 0 11) 10) anon20_correct))))))
(let ((anon18_correct  (=> (state Heap@9 Mask@6) (=> (and (state Heap@9 Mask@6) (state Heap@9 Mask@6)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (not (= freshObj@0 null))) (=> (not (= freshObj@0 null)) (and (=> (= (ControlFlow 0 14) 11) anon36_Then_correct) (=> (= (ControlFlow 0 14) 13) anon36_Else_correct))))))))
(let ((anon35_Else_correct  (=> (= (MapType0Select Heap@7 freshObj@0 List__next) null) (=> (and (= Heap@9 Heap@7) (= (ControlFlow 0 17) 14)) anon18_correct))))
(let ((anon35_Then_correct  (=> (not (= (MapType0Select Heap@7 freshObj@0 List__next) null)) (=> (and (and (forall ((o_10 T@U) (f_14 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_14))))
(let ((A@@12 (FieldTypeInv0 (type f_14))))
 (=> (and (and (= (type o_10) RefType) (= (type f_14) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@7 null (|List__state#sm| freshObj@0)) o_10 f_14)) (U_2_bool (MapType1Select (MapType0Select Heap@7 null (|List__state#sm| (MapType0Select Heap@7 freshObj@0 List__next))) o_10 f_14)))) (U_2_bool (MapType1Select newPMask@0 o_10 f_14)))))
 :qid |stdinbpl.3956:29|
 :skolemid |103|
 :pattern ( (MapType1Select newPMask@0 o_10 f_14))
)) (= Heap@8 (MapType0Store Heap@7 null (|List__state#sm| freshObj@0) newPMask@0))) (and (= Heap@9 Heap@8) (= (ControlFlow 0 16) 14))) anon18_correct))))
(let ((anon16_correct  (=> (and (= Heap@6 (MapType0Store Heap@5 null (|List__state#sm| freshObj@0) (MapType1Store (MapType0Select Heap@5 null (|List__state#sm| freshObj@0)) freshObj@0 List__val (bool_2_U true)))) (= Heap@7 (MapType0Store Heap@6 null (|List__state#sm| freshObj@0) (MapType1Store (MapType0Select Heap@6 null (|List__state#sm| freshObj@0)) freshObj@0 List__next (bool_2_U true))))) (and (=> (= (ControlFlow 0 18) 16) anon35_Then_correct) (=> (= (ControlFlow 0 18) 17) anon35_Else_correct)))))
(let ((anon34_Else_correct  (=> (HasDirectPerm Mask@6 null (List__state freshObj@0)) (=> (and (= Heap@5 Heap@2) (= (ControlFlow 0 20) 18)) anon16_correct))))
(let ((anon34_Then_correct  (=> (not (HasDirectPerm Mask@6 null (List__state freshObj@0))) (=> (and (and (= Heap@3 (MapType0Store Heap@2 null (|List__state#sm| freshObj@0) ZeroPMask)) (= Heap@4 (MapType0Store Heap@3 null (List__state freshObj@0) freshVersion@0))) (and (= Heap@5 Heap@4) (= (ControlFlow 0 19) 18))) anon16_correct))))
(let ((anon14_correct  (=> (= Mask@6 (MapType1Store Mask@5 null (List__state freshObj@0) (real_2_U (+ (U_2_real (MapType1Select Mask@5 null (List__state freshObj@0))) FullPerm)))) (=> (and (and (state Heap@2 Mask@6) (state Heap@2 Mask@6)) (and (|List__state#trigger| Heap@2 (List__state freshObj@0)) (= (MapType0Select Heap@2 null (List__state freshObj@0)) (CombineFrames (FrameFragment (MapType0Select Heap@2 freshObj@0 List__val)) (CombineFrames (FrameFragment (MapType0Select Heap@2 freshObj@0 List__next)) (FrameFragment (ite (not (= (MapType0Select Heap@2 freshObj@0 List__next) null)) (MapType0Select Heap@2 null (List__state (MapType0Select Heap@2 freshObj@0 List__next))) EmptyFrame))))))) (and (=> (= (ControlFlow 0 21) 19) anon34_Then_correct) (=> (= (ControlFlow 0 21) 20) anon34_Else_correct))))))
(let ((anon13_correct  (=> (and (and (= Mask@4 (MapType1Store Mask@3 null (List__state (MapType0Select Heap@2 freshObj@0 List__next)) (real_2_U (- (U_2_real (MapType1Select Mask@3 null (List__state (MapType0Select Heap@2 freshObj@0 List__next)))) FullPerm)))) (InsidePredicate (List__state freshObj@0) (MapType0Select Heap@2 null (List__state freshObj@0)) (List__state (MapType0Select Heap@2 freshObj@0 List__next)) (MapType0Select Heap@2 null (List__state (MapType0Select Heap@2 freshObj@0 List__next))))) (and (= Mask@5 Mask@4) (= (ControlFlow 0 23) 21))) anon14_correct)))
(let ((anon33_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 26) 23)) anon13_correct)))
(let ((anon33_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (<= FullPerm (U_2_real (MapType1Select Mask@3 null (List__state (MapType0Select Heap@2 freshObj@0 List__next)))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 null (List__state (MapType0Select Heap@2 freshObj@0 List__next))))) (=> (= (ControlFlow 0 24) 23) anon13_correct))))))
(let ((anon32_Then_correct  (=> (not (= (MapType0Select Heap@2 freshObj@0 List__next) null)) (and (=> (= (ControlFlow 0 27) 24) anon33_Then_correct) (=> (= (ControlFlow 0 27) 26) anon33_Else_correct)))))
(let ((anon32_Else_correct  (=> (= (MapType0Select Heap@2 freshObj@0 List__next) null) (=> (and (= Mask@5 Mask@3) (= (ControlFlow 0 22) 21)) anon14_correct))))
(let ((anon10_correct  (=> (= Mask@3 (MapType1Store Mask@2 freshObj@0 List__next (real_2_U (- (U_2_real (MapType1Select Mask@2 freshObj@0 List__next)) FullPerm)))) (and (=> (= (ControlFlow 0 28) 27) anon32_Then_correct) (=> (= (ControlFlow 0 28) 22) anon32_Else_correct)))))
(let ((anon31_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 31) 28)) anon10_correct)))
(let ((anon31_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (<= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 List__next)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 List__next))) (=> (= (ControlFlow 0 29) 28) anon10_correct))))))
(let ((anon8_correct  (=> (= Mask@2 (MapType1Store Mask@1 freshObj@0 List__val (real_2_U (- (U_2_real (MapType1Select Mask@1 freshObj@0 List__val)) FullPerm)))) (and (=> (= (ControlFlow 0 32) 29) anon31_Then_correct) (=> (= (ControlFlow 0 32) 31) anon31_Else_correct)))))
(let ((anon30_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 35) 32)) anon8_correct)))
(let ((anon30_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 33) (- 0 34)) (<= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 List__val)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 List__val))) (=> (= (ControlFlow 0 33) 32) anon8_correct))))))
(let ((anon27_Else_correct  (=> (U_2_bool (MapType0Select Heap@@37 diz@@37 $allocated)) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@37 freshObj@0 $allocated)))) (and (= Heap@0 (MapType0Store Heap@@37 freshObj@0 $allocated (bool_2_U true))) (= Mask@0 (MapType1Store ZeroMask freshObj@0 List__val (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 List__val)) FullPerm)))))) (and (and (= Mask@1 (MapType1Store Mask@0 freshObj@0 List__next (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@0 List__next)) FullPerm)))) (state Heap@0 Mask@1)) (and (state Heap@0 Mask@1) (state Heap@0 Mask@1)))) (and (=> (= (ControlFlow 0 36) (- 0 38)) (= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 List__val)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 List__val))) (=> (and (= Heap@1 (MapType0Store Heap@0 freshObj@0 List__val (int_2_U v_2))) (state Heap@1 Mask@1)) (and (=> (= (ControlFlow 0 36) (- 0 37)) (= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 List__next)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 List__next))) (=> (and (= Heap@2 (MapType0Store Heap@1 freshObj@0 List__next null)) (state Heap@2 Mask@1)) (and (=> (= (ControlFlow 0 36) 33) anon30_Then_correct) (=> (= (ControlFlow 0 36) 35) anon30_Else_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@37 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (>= current_thread_id 0) (state Heap@@37 ZeroMask))) (and (=> (= (ControlFlow 0 47) 46) anon27_Then_correct) (=> (= (ControlFlow 0 47) 36) anon27_Else_correct)))))
