...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((arg0@@11 T@T) (arg1 T@T) ) (! (= (Ctor (FieldType arg0@@11 arg1)) 6)
 :qid |ctor:FieldType|
...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (Ctor RefType) 8)) (= (type p_1) (FieldType NormalFieldType RefType))) (forall ((arg0@@14 T@T) (arg1@@2 T@T) ) (! (= (Ctor (MapType0Type arg0@@14 arg1@@2)) 9)
...
(= (type (MapType0Store arg0@@18 arg1@@6 arg2)) (MapType0Type aVar0 aVar1@@0))))
 ...
 :weight 0
)))) (= (type s) (FieldType NormalFieldType (MapType0Type RefType boolType)))) (= (type left) (FieldType NormalFieldType RefType))) (= (type all) (FieldType NormalFieldType (MapType0Type RefType boolType)))))
(assert (distinct $allocated p_1 s left all)
)
...
(assert  (and (forall ((arg0@@33 Int) (arg1@@17 Int) ) (! (= (type (|sk_inv#condqp2| arg0@@33 arg1@@17)) RefType)
 :qid |funType:sk_inv#condqp2|
 :pattern ( (|sk_inv#condqp2| arg0@@33 arg1@@17))
)) (= (type null) RefType)))
(assert (forall ((Heap2Heap T@U) (Heap1Heap T@U) (this T@U) ) (!  (=> (and (and (and (= (type Heap2Heap) (MapType1Type RefType)) (= (type Heap1Heap) (MapType1Type RefType))) (= (type this) RefType)) (and (=  (and (and (U_2_bool (MapType0Select (MapType1Select Heap2Heap this all) (|sk_inv#condqp2| (|inv#condqp2| Heap2Heap this) (|inv#condqp2| Heap1Heap this)))) (= (MapType1Select Heap2Heap (|sk_inv#condqp2| (|inv#condqp2| Heap2Heap this) (|inv#condqp2| Heap1Heap this)) left) null)) (< NoPerm (/ (to_real 1) (to_real 2))))  (and (and (U_2_bool (MapType0Select (MapType1Select Heap1Heap this all) (|sk_inv#condqp2| (|inv#condqp2| Heap2Heap this) (|inv#condqp2| Heap1Heap this)))) (= (MapType1Select Heap1Heap (|sk_inv#condqp2| (|inv#condqp2| Heap2Heap this) (|inv#condqp2| Heap1Heap this)) left) null)) (< NoPerm (/ (to_real 1) (to_real 2))))) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap2Heap this all) (|sk_inv#condqp2| (|inv#condqp2| Heap2Heap this) (|inv#condqp2| Heap1Heap this)))) (= (MapType1Select Heap2Heap (|sk_inv#condqp2| (|inv#condqp2| Heap2Heap this) (|inv#condqp2| Heap1Heap this)) left) null)) (< NoPerm (/ (to_real 1) (to_real 2)))) (= (MapType1Select Heap2Heap (|sk_inv#condqp2| (|inv#condqp2| Heap2Heap this) (|inv#condqp2| Heap1Heap this)) left) (MapType1Select Heap1Heap (|sk_inv#condqp2| (|inv#condqp2| Heap2Heap this) (|inv#condqp2| Heap1Heap this)) left))))) (= (|inv#condqp2| Heap2Heap this) (|inv#condqp2| Heap1Heap this)))
 :qid |stdinbpl.477:15|
 :skolemid |89|
 :pattern ( (|inv#condqp2| Heap2Heap this) (|inv#condqp2| Heap1Heap this) (succHeapTrans Heap2Heap Heap1Heap))
)))
...
(assert  (and (= (Ctor FrameTypeType) 13) (forall ((arg0@@34 T@U) ) (! (let ((A (FieldTypeInv0 (type arg0@@34))))
...
(assert  (and (= (Ctor PredicateType_invType) 14) (forall ((arg0@@36 T@U) ) (! (= (type (inv arg0@@36)) (FieldType PredicateType_invType FrameTypeType))
 :qid |funType:inv|
 :pattern ( (inv arg0@@36))
))))
...
(assert (forall ((Heap@@2 T@U) (this@@1 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType1Type RefType)) (= (type this@@1) RefType)) (|inv#everUsed| (inv this@@1)))
 :qid |stdinbpl.455:15|
 :skolemid |87|
 :pattern ( (|inv#trigger| Heap@@2 (inv this@@1)))
)))
...
(assert (forall ((this@@2 T@U) (this2 T@U) ) (!  (=> (and (and (= (type this@@2) RefType) (= (type this2) RefType)) (= (inv this@@2) (inv this2))) (= this@@2 this2))
 :qid |stdinbpl.446:15|
 :skolemid |85|
...
(assert (forall ((this@@3 T@U) (this2@@0 T@U) ) (!  (=> (and (and (= (type this@@3) RefType) (= (type this2@@0) RefType)) (= (|inv#sm| this@@3) (|inv#sm| this2@@0))) (= this@@3 this2@@0))
 :qid |stdinbpl.450:15|
 :skolemid |86|
...
(assert  (not (IsPredicateField p_1)))
(assert  (not (IsWandField p_1)))
(assert  (not (IsPredicateField s)))
(assert  (not (IsWandField s)))
(assert  (not (IsPredicateField left)))
(assert  (not (IsWandField left)))
(assert  (not (IsPredicateField all)))
(assert  (not (IsWandField all)))
(assert (forall ((Heap@@5 T@U) (ExhaleHeap@@3 T@U) (Mask@@4 T@U) ) (!  (=> (and (and (and (= (type Heap@@5) (MapType1Type RefType)) (= (type ExhaleHeap@@3) (MapType1Type RefType))) (= (type Mask@@4) (MapType2Type RefType realType))) (IdenticalOnKnownLocations Heap@@5 ExhaleHeap@@3 Mask@@4)) (succHeap Heap@@5 ExhaleHeap@@3))
 :qid |stdinbpl.83:15|
 :skolemid |10|
...
(assert (forall ((arg0@@44 T@U) (arg1@@22 T@U) ) (! (let ((T@@20 (MapType0TypeInv0 (type arg0@@44))))
(= (type (|Set#Difference| arg0@@44 arg1@@22)) (MapType0Type T@@20 boolType)))
 :qid |funType:Set#Difference|
 :pattern ( (|Set#Difference| arg0@@44 arg1@@22))
)))
...
(assert (forall ((arg0@@45 T@U) (arg1@@23 T@U) ) (! (let ((T@@24 (type arg1@@23)))
(= (type (|Set#UnionOne| arg0@@45 arg1@@23)) (MapType0Type T@@24 boolType)))
 :qid |funType:Set#UnionOne|
 :pattern ( (|Set#UnionOne| arg0@@45 arg1@@23))
)))
...
(assert (forall ((s@@0 T@U) ) (! (let ((T@@32 (MapType0TypeInv0 (type s@@0))))
 (=> (= (type s@@0) (MapType0Type T@@32 boolType)) (<= 0 (|Set#Card| s@@0))))
 :qid |stdinbpl.225:18|
 :skolemid |22|
 :pattern ( (|Set#Card| s@@0))
)))
(assert (forall ((s@@1 T@U) ) (! (let ((T@@33 (MultiSetTypeInv0 (type s@@1))))
 (=> (= (type s@@1) (MultiSetType T@@33)) (<= 0 (|MultiSet#Card| s@@1))))
 :qid |stdinbpl.333:18|
 :skolemid |57|
...
(assert (forall ((Heap@@6 T@U) (ExhaleHeap@@4 T@U) (Mask@@6 T@U) (pm_f@@1 T@U) ) (! (let ((C@@1 (FieldTypeInv0 (type pm_f@@1))))
 (=> (and (and (and (and (and (= (type Heap@@6) (MapType1Type RefType)) (= (type ExhaleHeap@@4) (MapType1Type RefType))) (= (type Mask@@6) (MapType2Type RefType realType))) (= (type pm_f@@1) (FieldType C@@1 FrameTypeType))) (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@4 Mask@@6)) (and (HasDirectPerm Mask@@6 null pm_f@@1) (IsPredicateField pm_f@@1))) (forall ((o2 T@U) (f_2@@0 T@U) ) (! (let ((B@@5 (FieldTypeInv1 (type f_2@@0))))
(let ((A@@6 (FieldTypeInv0 (type f_2@@0))))
 (=> (and (and (= (type o2) RefType) (= (type f_2@@0) (FieldType A@@6 B@@5))) (U_2_bool (MapType2Select (MapType1Select Heap@@6 null (PredicateMaskField pm_f@@1)) o2 f_2@@0))) (= (MapType1Select Heap@@6 o2 f_2@@0) (MapType1Select ExhaleHeap@@4 o2 f_2@@0)))))
 :qid |stdinbpl.54:134|
 :skolemid |3|
...
(assert (forall ((Heap@@7 T@U) (ExhaleHeap@@5 T@U) (Mask@@7 T@U) (pm_f@@2 T@U) ) (! (let ((C@@2 (FieldTypeInv0 (type pm_f@@2))))
 (=> (and (and (and (and (and (= (type Heap@@7) (MapType1Type RefType)) (= (type ExhaleHeap@@5) (MapType1Type RefType))) (= (type Mask@@7) (MapType2Type RefType realType))) (= (type pm_f@@2) (FieldType C@@2 FrameTypeType))) (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@5 Mask@@7)) (and (HasDirectPerm Mask@@7 null pm_f@@2) (IsWandField pm_f@@2))) (forall ((o2@@0 T@U) (f_2@@1 T@U) ) (! (let ((B@@6 (FieldTypeInv1 (type f_2@@1))))
(let ((A@@7 (FieldTypeInv0 (type f_2@@1))))
 (=> (and (and (= (type o2@@0) RefType) (= (type f_2@@1) (FieldType A@@7 B@@6))) (U_2_bool (MapType2Select (MapType1Select Heap@@7 null (WandMaskField pm_f@@2)) o2@@0 f_2@@1))) (= (MapType1Select Heap@@7 o2@@0 f_2@@1) (MapType1Select ExhaleHeap@@5 o2@@0 f_2@@1)))))
 :qid |stdinbpl.67:129|
 :skolemid |6|
...
(assert (forall ((this@@4 T@U) ) (!  (=> (= (type this@@4) RefType) (= (getPredWandId (inv this@@4)) 0))
 :qid |stdinbpl.440:15|
 :skolemid |84|
 :pattern ( (inv this@@4))
)))
...
(assert (forall ((s@@2 T@U) ) (! (let ((T@@42 (MultiSetTypeInv0 (type s@@2))))
 (=> (= (type s@@2) (MultiSetType T@@42)) (and (= (= (|MultiSet#Card| s@@2) 0) (= s@@2 (|MultiSet#Empty| T@@42))) (=> (not (= (|MultiSet#Card| s@@2) 0)) (exists ((x@@15 T@U) ) (!  (and (= (type x@@15) T@@42) (< 0 (|MultiSet#Select| s@@2 x@@15)))
 :qid |stdinbpl.341:38|
 :skolemid |59|
...
(assert (forall ((o@@8 T@U) (f T@U) (Heap@@8 T@U) ) (!  (=> (and (and (and (= (type o@@8) RefType) (= (type f) (FieldType NormalFieldType RefType))) (= (type Heap@@8) (MapType1Type RefType))) (U_2_bool (MapType1Select Heap@@8 o@@8 $allocated))) (U_2_bool (MapType1Select Heap@@8 (MapType1Select Heap@@8 o@@8 f) $allocated)))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (MapType1Select Heap@@8 o@@8 f))
)))
...
(assert (forall ((s@@3 T@U) ) (! (let ((T@@48 (MapType0TypeInv0 (type s@@3))))
 (=> (= (type s@@3) (MapType0Type T@@48 boolType)) (and (= (= (|Set#Card| s@@3) 0) (= s@@3 (|Set#Empty| T@@48))) (=> (not (= (|Set#Card| s@@3) 0)) (exists ((x@@16 T@U) ) (!  (and (= (type x@@16) T@@48) (U_2_bool (MapType0Select s@@3 x@@16)))
 :qid |stdinbpl.231:33|
 :skolemid |24|
...
(let ((A@@9 (FieldTypeInv0 (type f_3))))
 (=> (and (and (= (type Heap@@9) (MapType1Type RefType)) (= (type o@@11) RefType)) (= (type f_3) (FieldType A@@9 B@@8))) (succHeap Heap@@9 (MapType1Store Heap@@9 o@@11 f_3 v)))))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (MapType1Store Heap@@9 o@@11 f_3 v))
)))
...
(assert (forall ((p@@1 T@U) (v_1@@0 T@U) (q_1 T@U) (w@@0 T@U) (r@@5 T@U) (u T@U) ) (! (let ((C@@3 (FieldTypeInv0 (type r@@5))))
(let ((B@@10 (FieldTypeInv0 (type q_1))))
(let ((A@@11 (FieldTypeInv0 (type p@@1))))
 (=> (and (and (and (and (and (and (= (type p@@1) (FieldType A@@11 FrameTypeType)) (= (type v_1@@0) FrameTypeType)) (= (type q_1) (FieldType B@@10 FrameTypeType))) (= (type w@@0) FrameTypeType)) (= (type r@@5) (FieldType C@@3 FrameTypeType))) (= (type u) FrameTypeType)) (and (InsidePredicate p@@1 v_1@@0 q_1 w@@0) (InsidePredicate q_1 w@@0 r@@5 u))) (InsidePredicate p@@1 v_1@@0 r@@5 u)))))
 :qid |stdinbpl.207:25|
 :skolemid |20|
 :pattern ( (InsidePredicate p@@1 v_1@@0 q_1 w@@0) (InsidePredicate q_1 w@@0 r@@5 u))
)))
...
(assert (forall ((Heap2Heap@@0 T@U) (Heap1Heap@@0 T@U) (this@@6 T@U) ) (!  (=> (and (and (and (= (type Heap2Heap@@0) (MapType1Type RefType)) (= (type Heap1Heap@@0) (MapType1Type RefType))) (= (type this@@6) RefType)) (and (=  (and (U_2_bool (MapType0Select (MapType1Select Heap2Heap@@0 this@@6 all) (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap@@0 this@@6) (|inv#condqp1| Heap1Heap@@0 this@@6)))) (< NoPerm (/ (to_real 1) (to_real 2))))  (and (U_2_bool (MapType0Select (MapType1Select Heap1Heap@@0 this@@6 all) (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap@@0 this@@6) (|inv#condqp1| Heap1Heap@@0 this@@6)))) (< NoPerm (/ (to_real 1) (to_real 2))))) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap2Heap@@0 this@@6 all) (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap@@0 this@@6) (|inv#condqp1| Heap1Heap@@0 this@@6)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (= (MapType1Select Heap2Heap@@0 (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap@@0 this@@6) (|inv#condqp1| Heap1Heap@@0 this@@6)) left) (MapType1Select Heap1Heap@@0 (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap@@0 this@@6) (|inv#condqp1| Heap1Heap@@0 this@@6)) left))))) (= (|inv#condqp1| Heap2Heap@@0 this@@6) (|inv#condqp1| Heap1Heap@@0 this@@6)))
 :qid |stdinbpl.466:15|
 :skolemid |88|
 :pattern ( (|inv#condqp1| Heap2Heap@@0 this@@6) (|inv#condqp1| Heap1Heap@@0 this@@6) (succHeapTrans Heap2Heap@@0 Heap1Heap@@0))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@3) (MapType2Type RefType realType)) (= (type t_1) RefType)) (= (type Heap@0) (MapType1Type RefType))) (= (type Heap@@10) (MapType1Type RefType))) (= (type Heap@1) (MapType1Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Heap@2) (MapType1Type RefType))) (= (type Mask@2) (MapType2Type RefType realType))) (= (type Mask@1) (MapType2Type RefType realType))) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@47 T@U) ) (! (= (type (invRecv7 arg0@@47)) RefType)
 :qid |funType:invRecv7|
 :pattern ( (invRecv7 arg0@@47))
))) (= (type QPMask@1) (MapType2Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv8 arg0@@48)) RefType)
 :qid |funType:invRecv8|
 :pattern ( (invRecv8 arg0@@48))
))) (forall ((arg0@@49 T@U) (arg1@@25 T@U) ) (! (= (type (CombineFrames arg0@@49 arg1@@25)) FrameTypeType)
...
))) (= (type x_6) RefType)) (= (type Mask@0) (MapType2Type RefType realType))))
(set-info :boogie-vc-id foo)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon4_correct true))
(let ((anon6_Else_correct  (=> (HasDirectPerm Mask@3 null (inv t_1)) (=> (and (= Heap@2 Heap@@10) (= (ControlFlow 0 3) 1)) anon4_correct))))
(let ((anon6_Then_correct  (=> (not (HasDirectPerm Mask@3 null (inv t_1))) (=> (and (and (= Heap@0 (MapType1Store Heap@@10 null (|inv#sm| t_1) ZeroPMask)) (= Heap@1 (MapType1Store Heap@0 null (inv t_1) freshVersion@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 2) 1))) anon4_correct))))
(let ((anon2_correct  (=> (= Mask@2 (MapType2Store Mask@1 t_1 all (real_2_U (- (U_2_real (MapType2Select Mask@1 t_1 all)) FullPerm)))) (and (=> (= (ControlFlow 0 4) (- 0 10)) (forall ((q T@U) ) (!  (=> (= (type q) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) q)) (dummyFunction (MapType1Select Heap@@10 q left))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.1031:17|
 :skolemid |132|
 :pattern ( (MapType1Select Heap@@10 q left))
 :pattern ( (MapType2Select QPMask@0 q left))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 t_1 all) q))
))) (=> (forall ((q@@0 T@U) ) (!  (=> (= (type q@@0) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) q@@0)) (dummyFunction (MapType1Select Heap@@10 q@@0 left))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.1031:17|
 :skolemid |132|
 :pattern ( (MapType1Select Heap@@10 q@@0 left))
 :pattern ( (MapType2Select QPMask@0 q@@0 left))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 t_1 all) q@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 9)) (forall ((q@@1 T@U) (q_3 T@U) ) (!  (=> (and (= (type q@@1) RefType) (= (type q_3) RefType)) (=> (and (and (and (and (not (= q@@1 q_3)) (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) q@@1))) (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) q_3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= q@@1 q_3))))
 :qid |stdinbpl.1038:17|
 :skolemid |133|
 :pattern ( (neverTriggered7 q@@1) (neverTriggered7 q_3))
))) (=> (forall ((q@@2 T@U) (q_3@@0 T@U) ) (!  (=> (and (= (type q@@2) RefType) (= (type q_3@@0) RefType)) (=> (and (and (and (and (not (= q@@2 q_3@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) q@@2))) (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) q_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= q@@2 q_3@@0))))
 :qid |stdinbpl.1038:17|
 :skolemid |133|
 :pattern ( (neverTriggered7 q@@2) (neverTriggered7 q_3@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 8)) (forall ((q@@3 T@U) ) (!  (=> (and (= (type q@@3) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) q@@3))) (>= (U_2_real (MapType2Select Mask@2 q@@3 left)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.1045:17|
 :skolemid |134|
 :pattern ( (MapType1Select Heap@@10 q@@3 left))
 :pattern ( (MapType2Select QPMask@0 q@@3 left))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 t_1 all) q@@3))
))) (=> (forall ((q@@4 T@U) ) (!  (=> (and (= (type q@@4) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) q@@4))) (>= (U_2_real (MapType2Select Mask@2 q@@4 left)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.1045:17|
 :skolemid |134|
 :pattern ( (MapType1Select Heap@@10 q@@4 left))
 :pattern ( (MapType2Select QPMask@0 q@@4 left))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 t_1 all) q@@4))
)) (=> (and (and (forall ((q@@5 T@U) ) (!  (=> (= (type q@@5) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) q@@5)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange7 q@@5) (= (invRecv7 q@@5) q@@5))))
 :qid |stdinbpl.1051:22|
 :skolemid |135|
 :pattern ( (MapType1Select Heap@@10 q@@5 left))
 :pattern ( (MapType2Select QPMask@0 q@@5 left))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 t_1 all) q@@5))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) (invRecv7 o_3))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange7 o_3))) (= (invRecv7 o_3) o_3)))
 :qid |stdinbpl.1055:22|
 :skolemid |136|
 :pattern ( (invRecv7 o_3))
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) (invRecv7 o_3@@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange7 o_3@@0))) (and (= (invRecv7 o_3@@0) o_3@@0) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 left)) (- (U_2_real (MapType2Select Mask@2 o_3@@0 left)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) (invRecv7 o_3@@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange7 o_3@@0)))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 left)) (U_2_real (MapType2Select Mask@2 o_3@@0 left))))))
 :qid |stdinbpl.1061:22|
 :skolemid |137|
 :pattern ( (MapType2Select QPMask@0 o_3@@0 left))
)) (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 left))) (= (U_2_real (MapType2Select Mask@2 o_3@@1 f_5)) (U_2_real (MapType2Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.1067:29|
 :skolemid |138|
 :pattern ( (MapType2Select QPMask@0 o_3@@1 f_5))
)))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (forall ((x$0 T@U) ) (!  (=> (= (type x$0) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) x$0)) (= (MapType1Select Heap@@10 x$0 left) null)) (dummyFunction (MapType1Select Heap@@10 x$0 left))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.1076:17|
 :skolemid |139|
 :pattern ( (MapType1Select Heap@@10 x$0 left))
 :pattern ( (MapType2Select QPMask@1 x$0 left))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 t_1 all) x$0))
))) (=> (forall ((x$0@@0 T@U) ) (!  (=> (= (type x$0@@0) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) x$0@@0)) (= (MapType1Select Heap@@10 x$0@@0 left) null)) (dummyFunction (MapType1Select Heap@@10 x$0@@0 left))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.1076:17|
 :skolemid |139|
 :pattern ( (MapType1Select Heap@@10 x$0@@0 left))
 :pattern ( (MapType2Select QPMask@1 x$0@@0 left))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 t_1 all) x$0@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((x$0@@1 T@U) (x$0_1 T@U) ) (!  (=> (and (= (type x$0@@1) RefType) (= (type x$0_1) RefType)) (=> (and (and (and (and (not (= x$0@@1 x$0_1)) (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) x$0@@1)) (= (MapType1Select Heap@@10 x$0@@1 left) null))) (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) x$0_1)) (= (MapType1Select Heap@@10 x$0_1 left) null))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= x$0@@1 x$0_1))))
 :qid |stdinbpl.1083:17|
 :skolemid |140|
 :pattern ( (neverTriggered8 x$0@@1) (neverTriggered8 x$0_1))
))) (=> (forall ((x$0@@2 T@U) (x$0_1@@0 T@U) ) (!  (=> (and (= (type x$0@@2) RefType) (= (type x$0_1@@0) RefType)) (=> (and (and (and (and (not (= x$0@@2 x$0_1@@0)) (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) x$0@@2)) (= (MapType1Select Heap@@10 x$0@@2 left) null))) (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) x$0_1@@0)) (= (MapType1Select Heap@@10 x$0_1@@0 left) null))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= x$0@@2 x$0_1@@0))))
 :qid |stdinbpl.1083:17|
 :skolemid |140|
 :pattern ( (neverTriggered8 x$0@@2) (neverTriggered8 x$0_1@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((x$0@@3 T@U) ) (!  (=> (= (type x$0@@3) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) x$0@@3)) (= (MapType1Select Heap@@10 x$0@@3 left) null)) (>= (U_2_real (MapType2Select QPMask@0 x$0@@3 left)) (/ (to_real 1) (to_real 2)))))
 :qid |stdinbpl.1090:17|
 :skolemid |141|
 :pattern ( (MapType1Select Heap@@10 x$0@@3 left))
 :pattern ( (MapType2Select QPMask@1 x$0@@3 left))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 t_1 all) x$0@@3))
))) (=> (forall ((x$0@@4 T@U) ) (!  (=> (= (type x$0@@4) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) x$0@@4)) (= (MapType1Select Heap@@10 x$0@@4 left) null)) (>= (U_2_real (MapType2Select QPMask@0 x$0@@4 left)) (/ (to_real 1) (to_real 2)))))
 :qid |stdinbpl.1090:17|
 :skolemid |141|
 :pattern ( (MapType1Select Heap@@10 x$0@@4 left))
 :pattern ( (MapType2Select QPMask@1 x$0@@4 left))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 t_1 all) x$0@@4))
)) (=> (forall ((x$0@@5 T@U) ) (!  (=> (= (type x$0@@5) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) x$0@@5)) (= (MapType1Select Heap@@10 x$0@@5 left) null)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange8 x$0@@5) (= (invRecv8 x$0@@5) x$0@@5))))
 :qid |stdinbpl.1096:22|
 :skolemid |142|
 :pattern ( (MapType1Select Heap@@10 x$0@@5 left))
 :pattern ( (MapType2Select QPMask@1 x$0@@5 left))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 t_1 all) x$0@@5))
)) (=> (and (and (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) (invRecv8 o_3@@2))) (= (MapType1Select Heap@@10 (invRecv8 o_3@@2) left) null)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange8 o_3@@2))) (= (invRecv8 o_3@@2) o_3@@2)))
 :qid |stdinbpl.1100:22|
 :skolemid |143|
 :pattern ( (invRecv8 o_3@@2))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) (invRecv8 o_3@@3))) (= (MapType1Select Heap@@10 (invRecv8 o_3@@3) left) null)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange8 o_3@@3))) (and (= (invRecv8 o_3@@3) o_3@@3) (= (U_2_real (MapType2Select QPMask@1 o_3@@3 left)) (- (U_2_real (MapType2Select QPMask@0 o_3@@3 left)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 t_1 all) (invRecv8 o_3@@3))) (= (MapType1Select Heap@@10 (invRecv8 o_3@@3) left) null)) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange8 o_3@@3)))) (= (U_2_real (MapType2Select QPMask@1 o_3@@3 left)) (U_2_real (MapType2Select QPMask@0 o_3@@3 left))))))
 :qid |stdinbpl.1106:22|
 :skolemid |144|
 :pattern ( (MapType2Select QPMask@1 o_3@@3 left))
))) (and (forall ((o_3@@4 T@U) (f_5@@0 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_5@@0))))
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 left))) (= (U_2_real (MapType2Select QPMask@0 o_3@@4 f_5@@0)) (U_2_real (MapType2Select QPMask@1 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.1112:29|
 :skolemid |145|
 :pattern ( (MapType2Select QPMask@1 o_3@@4 f_5@@0))
)) (= Mask@3 (MapType2Store QPMask@1 null (inv t_1) (real_2_U (+ (U_2_real (MapType2Select QPMask@1 null (inv t_1))) FullPerm)))))) (and (and (state Heap@@10 Mask@3) (state Heap@@10 Mask@3)) (and (|inv#trigger| Heap@@10 (inv t_1)) (= (MapType1Select Heap@@10 null (inv t_1)) (CombineFrames (FrameFragment (MapType1Select Heap@@10 t_1 all)) (CombineFrames (FrameFragment (int_2_U (|inv#condqp1| Heap@@10 t_1))) (FrameFragment (int_2_U (|inv#condqp2| Heap@@10 t_1))))))))) (and (=> (= (ControlFlow 0 4) 2) anon6_Then_correct) (=> (= (ControlFlow 0 4) 3) anon6_Else_correct))))))))))))))))))))
(let ((anon5_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 4)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType2Select Mask@1 t_1 all)))) (=> (<= FullPerm (U_2_real (MapType2Select Mask@1 t_1 all))) (=> (= (ControlFlow 0 11) 4) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType1Select Heap@@10 x_6 $allocated))) (=> (and (and (U_2_bool (MapType1Select Heap@@10 t_1 $allocated)) (not (= x_6 null))) (and (= Mask@0 (MapType2Store ZeroMask x_6 left (real_2_U (+ (U_2_real (MapType2Select ZeroMask x_6 left)) FullPerm)))) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (HasDirectPerm Mask@0 x_6 left)) (=> (HasDirectPerm Mask@0 x_6 left) (=> (and (= (MapType1Select Heap@@10 x_6 left) null) (state Heap@@10 Mask@0)) (=> (and (and (state Heap@@10 Mask@0) (not (= t_1 null))) (and (= Mask@1 (MapType2Store Mask@0 t_1 all (real_2_U (+ (U_2_real (MapType2Select Mask@0 t_1 all)) FullPerm)))) (state Heap@@10 Mask@1))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm Mask@1 t_1 all)) (=> (HasDirectPerm Mask@1 t_1 all) (=> (|Set#Equal| (MapType1Select Heap@@10 t_1 all) (|Set#Singleton| x_6)) (=> (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1)) (and (=> (= (ControlFlow 0 14) 11) anon5_Then_correct) (=> (= (ControlFlow 0 14) 13) anon5_Else_correct))))))))))))))
