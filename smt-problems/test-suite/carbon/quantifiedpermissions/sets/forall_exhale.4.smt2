...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((w_1 T@U) (w_1_1 T@U) ) (!  (=> (and (= (type w_1) RefType) (= (type w_1_1) RefType)) (=> (and (and (and (and (not (= w_1 w_1_1)) (U_2_bool (MapType2Select xs w_1))) (U_2_bool (MapType2Select xs w_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= w_1 w_1_1))))
 :qid |stdinbpl.600:17|
 :skolemid |94|
 :pattern ( (neverTriggered3 w_1) (neverTriggered3 w_1_1))
))) (=> (forall ((w_1@@0 T@U) (w_1_1@@0 T@U) ) (!  (=> (and (= (type w_1@@0) RefType) (= (type w_1_1@@0) RefType)) (=> (and (and (and (and (not (= w_1@@0 w_1_1@@0)) (U_2_bool (MapType2Select xs w_1@@0))) (U_2_bool (MapType2Select xs w_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= w_1@@0 w_1_1@@0))))
 :qid |stdinbpl.600:17|
 :skolemid |94|
 :pattern ( (neverTriggered3 w_1@@0) (neverTriggered3 w_1_1@@0))
)) (=> (= (ControlFlow 0 5) (- 0 4)) (forall ((w_1@@1 T@U) ) (!  (=> (and (= (type w_1@@1) RefType) (U_2_bool (MapType2Select xs w_1@@1))) (>= (U_2_real (MapType1Select QPMask@1 w_1@@1 f_7)) FullPerm))
 :qid |stdinbpl.607:17|
 :skolemid |95|
 :pattern ( (MapType0Select ExhaleHeap@0 w_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@2 w_1@@1 f_7))
 :pattern ( (MapType2Select xs w_1@@1))
)))))))
(let ((anon9_Then_correct true))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (U_2_bool (MapType2Select xs z_1))) (U_2_bool (MapType2Select xs z_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1))))
 :qid |stdinbpl.545:17|
 :skolemid |88|
...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((y_1 T@U) (y_1_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (= (type y_1_1) RefType)) (=> (and (and (and (and (not (= y_1 y_1_1)) (U_2_bool (MapType2Select xs y_1))) (U_2_bool (MapType2Select xs y_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_1 y_1_1))))
 :qid |stdinbpl.490:15|
 :skolemid |82|
 :no-pattern (type y_1)
...
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv1 o_3@@2))) (< NoPerm FullPerm)) (qpRange1 o_3@@2)) (= (invRecv1 o_3@@2) o_3@@2)))
 :qid |stdinbpl.500:22|
 :skolemid |84|
