...
(let ((anon4_Else_correct  (=> (not (= (List_tag l@@44) 1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing (get_List_tail l@@44) l@@44)) (=> (decreasing (get_List_tail l@@44) l@@44) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded l@@44)) (=> (bounded l@@44) (=> (and (state Heap@@58 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (and (= (List_tag l@@44) 1) (= (ControlFlow 0 2) 1)) anon3_correct)))
...
(declare-fun l@@44 () T@U)
(assert  (and (= (type Heap@@58) (MapType0Type RefType)) (= (type l@@44) IntListDomainTypeType)))
(set-info :boogie-vc-id ilenBad_termination_proof)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@58 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (decreasing (ICons v_2@@9 INil) l@@44)) (=> (decreasing (ICons v_2@@9 INil) l@@44) (=> (= (ControlFlow 0 2) (- 0 1)) (bounded l@@44)))))))
