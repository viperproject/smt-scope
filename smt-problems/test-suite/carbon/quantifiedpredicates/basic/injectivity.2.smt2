...
(declare-fun y@@2 () T@U)
(assert  (and (and (= (type xs) (SeqType RefType)) (= (type Heap@@11) (MapType0Type RefType))) (= (type y@@2) RefType)))
(set-info :boogie-vc-id test03)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| xs x_1)) (|Seq#Contains| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
...
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_1@@1 T@U) ) (!  (=> (and (= (type x_1@@1) RefType) (|Seq#Contains| xs x_1@@1)) (>= (U_2_real (MapType1Select ZeroMask null (pred2 x_1@@1 1))) FullPerm))
 :qid |stdinbpl.1009:17|
 :skolemid |97|
 :pattern ( (MapType0Select Heap@@11 null (pred2 x_1@@1 1)))
 :pattern ( (MapType1Select ZeroMask null (pred2 x_1@@1 1)))
 :pattern ( (|Seq#ContainsTrigger| xs x_1@@1))
 :pattern ( (|Seq#Contains| xs x_1@@1))
)))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 y@@2 $allocated))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct)))))
