...
(assert  (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type this) RefType)) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test04b)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon6_correct true))
(let ((anon5_correct  (=> (= Mask@2 (MapType1Store Mask@1 null (P this) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (P this))) FullPerm)))) (=> (and (= Mask@3 Mask@2) (= (ControlFlow 0 3) 1)) anon6_correct))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (P this))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (P this)))) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
(let ((anon8_Then_correct  (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (P this)))) (and (=> (= (ControlFlow 0 7) 4) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (< (U_2_real (MapType1Select Mask@1 null (P this))) FullPerm) (=> (and (= Mask@3 Mask@1) (= (ControlFlow 0 2) 1)) anon6_correct))))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (P this) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P this))) FullPerm)))) (=> (and (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1)) (and (=> (= (ControlFlow 0 8) 7) anon8_Then_correct) (=> (= (ControlFlow 0 8) 2) anon8_Else_correct))))))
(let ((anon7_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P this))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P this)))) (=> (= (ControlFlow 0 9) 8) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 this $allocated))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (P this) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P this))) FullPerm)))) (state Heap@@10 Mask@0)) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 12) 9) anon7_Then_correct) (=> (= (ControlFlow 0 12) 11) anon7_Else_correct))))))
