...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Used_7Mask@3) (MapType0Type RefType realType)) (= (type Mask@3) (MapType0Type RefType realType))) (= (type Mask@1) (MapType0Type RefType realType))) (= (type Used_7Mask@1) (MapType0Type RefType realType))) (= (type Used_7Mask@2) (MapType0Type RefType realType))) (= (type Used_7Heap@0) (MapType1Type RefType))) (= (type Mask@2) (MapType0Type RefType realType))) (= (type Used_7Mask@0) (MapType0Type RefType realType))) (= (type Ops_7Mask@0) (MapType0Type RefType realType))) (= (type Ops_7Heap@0) (MapType1Type RefType))) (= (type Ops_5Heap@0) (MapType1Type RefType))) (= (type Used_5Heap@0) (MapType1Type RefType))) (= (type Mask@0) (MapType0Type RefType realType))) (= (type Heap@1) (MapType1Type RefType))) (= (type Used_6Heap@0) (MapType1Type RefType))) (= (type Heap@@15) (MapType1Type RefType))) (= (type x@@44) RefType)) (= (type freshObj@0) RefType)) (= (type Heap@0) (MapType1Type RefType))) (= (type Used_4Heap@0) (MapType1Type RefType))))
(set-info :boogie-vc-id call_triple_nested)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 31) (let ((anon25_Then_correct true))
(let ((anon20_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (and (and b_12@2 b_12@2) b_13@4) (and (= neededTransfer@3 0.0) (= (U_2_real (MapType0Select Used_7Mask@3 null (wand_5 true true))) initNeededTransfer@0))))))
(let ((anon31_Else_correct  (=> (and (>= 0.0 takeTransfer@1) (= Mask@3 Mask@1)) (=> (and (and (= neededTransfer@3 neededTransfer@1) (= b_13@4 b_13@2)) (and (= Used_7Mask@3 Used_7Mask@1) (= (ControlFlow 0 5) 2))) anon20_correct))))
(let ((anon31_Then_correct  (=> (and (> takeTransfer@1 0.0) (= neededTransfer@2 (- neededTransfer@1 takeTransfer@1))) (=> (and (and (and (= Used_7Mask@2 (MapType0Store Used_7Mask@1 null (wand_5 true true) (real_2_U (+ (U_2_real (MapType0Select Used_7Mask@1 null (wand_5 true true))) takeTransfer@1)))) (= b_13@3  (and b_13@2 (state Used_7Heap@0 Used_7Mask@2)))) (and (= Mask@2 (MapType0Store Mask@1 null (wand_5 true true) (real_2_U (- (U_2_real (MapType0Select Mask@1 null (wand_5 true true))) takeTransfer@1)))) (= Mask@3 Mask@2))) (and (and (= neededTransfer@3 neededTransfer@2) (= b_13@4 b_13@3)) (and (= Used_7Mask@3 Used_7Mask@2) (= (ControlFlow 0 4) 2)))) anon20_correct))))
(let ((anon30_Else_correct  (=> (and (< maskTransfer@1 neededTransfer@1) (= takeTransfer@1 maskTransfer@1)) (and (=> (= (ControlFlow 0 7) 4) anon31_Then_correct) (=> (= (ControlFlow 0 7) 5) anon31_Else_correct)))))
(let ((anon30_Then_correct  (=> (and (<= neededTransfer@1 maskTransfer@1) (= takeTransfer@1 neededTransfer@1)) (and (=> (= (ControlFlow 0 6) 4) anon31_Then_correct) (=> (= (ControlFlow 0 6) 5) anon31_Else_correct)))))
(let ((anon29_Then_correct  (=> (and (and (and (and (and b_12@2 b_12@2) b_13@2) true) (> neededTransfer@1 0.0)) (= maskTransfer@1 (U_2_real (MapType0Select Mask@1 null (wand_5 true true))))) (and (=> (= (ControlFlow 0 8) 6) anon30_Then_correct) (=> (= (ControlFlow 0 8) 7) anon30_Else_correct)))))
(let ((anon29_Else_correct  (=> (and (not (and (and (and (and b_12@2 b_12@2) b_13@2) true) (> neededTransfer@1 0.0))) (= Mask@3 Mask@1)) (=> (and (and (= neededTransfer@3 neededTransfer@1) (= b_13@4 b_13@2)) (and (= Used_7Mask@3 Used_7Mask@1) (= (ControlFlow 0 3) 2))) anon20_correct))))
(let ((anon28_Else_correct  (=> (and (and (>= 0.0 takeTransfer@0) (= Used_7Mask@1 ZeroMask)) (and (= b_13@2 b_13@0) (= neededTransfer@1 1.0))) (and (=> (= (ControlFlow 0 11) 8) anon29_Then_correct) (=> (= (ControlFlow 0 11) 3) anon29_Else_correct)))))
(let ((anon28_Then_correct  (=> (and (and (and (> takeTransfer@0 0.0) (= neededTransfer@0 (- 1.0 takeTransfer@0))) (and (= Used_7Mask@0 (MapType0Store ZeroMask null (wand_5 true true) (real_2_U (+ (U_2_real (MapType0Select ZeroMask null (wand_5 true true))) takeTransfer@0)))) (= b_13@1  (and b_13@0 (state Used_7Heap@0 Used_7Mask@0))))) (and (and (= Ops_7Mask@0 (MapType0Store ZeroMask null (wand_5 true true) (real_2_U (- (U_2_real (MapType0Select ZeroMask null (wand_5 true true))) takeTransfer@0)))) (= Used_7Mask@1 Used_7Mask@0)) (and (= b_13@2 b_13@1) (= neededTransfer@1 neededTransfer@0)))) (and (=> (= (ControlFlow 0 10) 8) anon29_Then_correct) (=> (= (ControlFlow 0 10) 3) anon29_Else_correct)))))
(let ((anon27_Else_correct  (=> (and (< maskTransfer@0 1.0) (= takeTransfer@0 maskTransfer@0)) (and (=> (= (ControlFlow 0 13) 10) anon28_Then_correct) (=> (= (ControlFlow 0 13) 11) anon28_Else_correct)))))
(let ((anon27_Then_correct  (=> (and (<= 1.0 maskTransfer@0) (= takeTransfer@0 1.0)) (and (=> (= (ControlFlow 0 12) 10) anon28_Then_correct) (=> (= (ControlFlow 0 12) 11) anon28_Else_correct)))))
(let ((anon26_Then_correct  (=> (and (and (and (and (and b_12@2 b_12@2) b_13@0) true) (> 1.0 0.0)) (= maskTransfer@0 (U_2_real (MapType0Select ZeroMask null (wand_5 true true))))) (and (=> (= (ControlFlow 0 14) 12) anon27_Then_correct) (=> (= (ControlFlow 0 14) 13) anon27_Else_correct)))))
(let ((anon26_Else_correct  (=> (and (and (not (and (and (and (and b_12@2 b_12@2) b_13@0) true) (> 1.0 0.0))) (= Used_7Mask@1 ZeroMask)) (and (= b_13@2 b_13@0) (= neededTransfer@1 1.0))) (and (=> (= (ControlFlow 0 9) 8) anon29_Then_correct) (=> (= (ControlFlow 0 9) 3) anon29_Else_correct)))))
(let ((anon8_correct  (=> (= initNeededTransfer@0 (+ (U_2_real (MapType0Select ZeroMask null (wand_5 true true))) 1.0)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (>= 1.0 0.0)) (=> (>= 1.0 0.0) (and (=> (= (ControlFlow 0 15) 14) anon26_Then_correct) (=> (= (ControlFlow 0 15) 9) anon26_Else_correct)))))))
(let ((anon24_Then_correct  (=> b_12@2 (and (=> (= (ControlFlow 0 20) 19) anon25_Then_correct) (=> (= (ControlFlow 0 20) 15) anon8_correct)))))
(let ((anon24_Else_correct  (=> (and (not b_12@2) (= (ControlFlow 0 18) 15)) anon8_correct)))
(let ((anon23_Then_correct  (=> (and (and b_12@2 b_12@2) b_13@0) (and (=> (= (ControlFlow 0 21) 20) anon24_Then_correct) (=> (= (ControlFlow 0 21) 18) anon24_Else_correct)))))
(let ((anon23_Else_correct  (=> (and (not (and (and b_12@2 b_12@2) b_13@0)) (= (ControlFlow 0 17) 15)) anon8_correct)))
(let ((anon4_correct  (=> (= b_12@1  (and b_12@0 (state Ops_7Heap@0 ZeroMask))) (=> (and (= b_12@2  (and b_12@1 (state Ops_7Heap@0 ZeroMask))) (= b_13@0  (and b_13 (state Used_7Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 22) 21) anon23_Then_correct) (=> (= (ControlFlow 0 22) 17) anon23_Else_correct))))))
(let ((anon22_Else_correct  (=> (and (not b_12@0) (= (ControlFlow 0 24) 22)) anon4_correct)))
(let ((anon22_Then_correct  (=> (and b_12@0 (= (ControlFlow 0 23) 22)) anon4_correct)))
(let ((anon2_correct  (=> (= b_9@1  (and b_9@0 (state Ops_5Heap@0 ZeroMask))) (=> (and (and (and (= b_9@2  (and b_9@1 (state Ops_5Heap@0 ZeroMask))) (= b_10@0  (and b_10 (state Used_5Heap@0 ZeroMask)))) (and (= Mask@1 (MapType0Store Mask@0 null (wand_5 true true) (real_2_U (+ (U_2_real (MapType0Select Mask@0 null (wand_5 true true))) FullPerm)))) (state Heap@1 Mask@1))) (and (and (state Heap@1 Mask@1) (state Heap@1 Mask@1)) (and (= b_12@0  (and b_12 (state Ops_7Heap@0 ZeroMask))) (= b_11@0  (and b_11 (state Used_6Heap@0 ZeroMask)))))) (and (=> (= (ControlFlow 0 25) 23) anon22_Then_correct) (=> (= (ControlFlow 0 25) 24) anon22_Else_correct))))))
(let ((anon21_Else_correct  (=> (and (not b_9@0) (= (ControlFlow 0 27) 25)) anon2_correct)))
(let ((anon21_Then_correct  (=> (and b_9@0 (= (ControlFlow 0 26) 25)) anon2_correct)))
(let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) (U_2_bool (MapType1Select Heap@@15 x@@44 $allocated))) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType1Select Heap@@15 freshObj@0 $allocated)))) (= Heap@0 (MapType1Store Heap@@15 freshObj@0 $allocated (bool_2_U true)))) (and (= Mask@0 (MapType0Store ZeroMask freshObj@0 f_7 (real_2_U (+ (U_2_real (MapType0Select ZeroMask freshObj@0 f_7)) FullPerm)))) (state Heap@0 Mask@0))) (and (=> (= (ControlFlow 0 28) (- 0 30)) (= FullPerm (U_2_real (MapType0Select Mask@0 freshObj@0 f_7)))) (=> (= FullPerm (U_2_real (MapType0Select Mask@0 freshObj@0 f_7))) (=> (and (= Heap@1 (MapType1Store Heap@0 freshObj@0 f_7 (int_2_U 1))) (state Heap@1 Mask@0)) (and (=> (= (ControlFlow 0 28) (- 0 29)) (HasDirectPerm Mask@0 freshObj@0 f_7)) (=> (HasDirectPerm Mask@0 freshObj@0 f_7) (=> (and (and (= a_2@0 (U_2_int (MapType1Select Heap@1 freshObj@0 f_7))) (state Heap@1 Mask@0)) (and (= b_9@0  (and b_9 (state Ops_5Heap@0 ZeroMask))) (= b_8@0  (and b_8 (state Used_4Heap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 28) 26) anon21_Then_correct) (=> (= (ControlFlow 0 28) 27) anon21_Else_correct))))))))))))
