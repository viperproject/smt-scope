...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon8_Else_correct  (=> (and (and (not (= this null)) (= PostMask@0 (MapType1Store ZeroMask this x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this x@@8)) FullPerm))))) (and (state PostHeap@0 PostMask@0) (= (ControlFlow 0 8) (- 0 7)))) (HasDirectPerm PostMask@0 this x@@8))))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon8_Else_correct  (=> (not (= this null)) (=> (and (and (= PostMask@0 (MapType1Store ZeroMask this x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this x@@8)) FullPerm)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (= (ControlFlow 0 10) (- 0 9)))) (HasDirectPerm PostMask@0 this x@@8)))))
(let ((anon8_Then_correct true))
