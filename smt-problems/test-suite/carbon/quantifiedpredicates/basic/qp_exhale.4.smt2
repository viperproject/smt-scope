...
(assert  (and (and (and (and (and (and (= (type z@@0) RefType) (= (type y@@6) RefType)) (= (type x@@19) RefType)) (= (type Heap@@14) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
...
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((r_4@@1 T@U) ) (!  (=> (and (= (type r_4@@1) RefType) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#UnionOne| (|Set#Singleton| z@@0) y@@6) x@@19) r_4@@1))) (>= (U_2_real (MapType1Select Mask@1 null (p2 r_4@@1))) FullPerm))
 :qid |stdinbpl.1250:17|
 :skolemid |153|
 :pattern ( (MapType0Select Heap@@14 null (p2 r_4@@1)))
 :pattern ( (MapType1Select Mask@1 null (p2 r_4@@1)))
 :pattern ( (MapType2Select (|Set#UnionOne| (|Set#UnionOne| (|Set#Singleton| z@@0) y@@6) x@@19) r_4@@1))
)))))))
(let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (U_2_bool (MapType0Select Heap@@14 x@@19 $allocated))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@14 y@@6 $allocated)) (U_2_bool (MapType0Select Heap@@14 z@@0 $allocated))) (and (= Mask@0 (MapType1Store ZeroMask null (p2 x@@19) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (p2 x@@19))) FullPerm)))) (state Heap@@14 Mask@0))) (and (and (state Heap@@14 Mask@0) (= Mask@1 (MapType1Store Mask@0 null (p2 y@@6) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (p2 y@@6))) FullPerm))))) (and (state Heap@@14 Mask@1) (state Heap@@14 Mask@1)))) (and (=> (= (ControlFlow 0 8) 7) anon5_Then_correct) (=> (= (ControlFlow 0 8) 2) anon5_Else_correct))))))
