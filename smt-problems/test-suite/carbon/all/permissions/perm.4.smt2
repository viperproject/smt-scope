...
(assert  (and (and (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type c1) RefType)) (= (type c2) RefType)) (= (type c3) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test01b)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 c1 $allocated)) (U_2_bool (MapType0Select Heap@@9 c2 $allocated))) (and (U_2_bool (MapType0Select Heap@@9 c3 $allocated)) (= perm@0 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= c1 null))) (= Mask@0 (MapType1Store ZeroMask c1 val (real_2_U (+ (U_2_real (MapType1Select ZeroMask c1 val)) perm@0))))) (and (state Heap@@9 Mask@0) (= perm@1 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (and (=> (> perm@1 NoPerm) (not (= c2 null))) (= Mask@1 (MapType1Store Mask@0 c2 val (real_2_U (+ (U_2_real (MapType1Select Mask@0 c2 val)) perm@1))))) (and (state Heap@@9 Mask@1) (= perm@2 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (and (=> (> perm@2 NoPerm) (not (= c2 null))) (= Mask@2 (MapType1Store Mask@1 c2 val (real_2_U (+ (U_2_real (MapType1Select Mask@1 c2 val)) perm@2))))) (=> (and (and (and (state Heap@@9 Mask@2) (state Heap@@9 Mask@2)) (and (or (= c3 c1) (= c3 c2)) (state Heap@@9 Mask@2))) (and (and (<= (/ (to_real 1) (to_real 1)) (U_2_real (MapType1Select Mask@2 c3 val))) (state Heap@@9 Mask@2)) (and (state Heap@@9 Mask@2) (= (ControlFlow 0 2) (- 0 1))))) false))))))))))))))
