...
(assert (and
  (pred%trigger s@$ x@3@00)
  (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$)))
  (not (= x@3@00 $Ref.null))
  (=
    ($SortWrappers.$SnapToInt ($Snap.first s@$))
    ($SortWrappers.$SnapToInt ($Snap.second s@$)))))
(assert (= result@4@00 ($SortWrappers.$SnapToInt ($Snap.first s@$))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (x@3@00 $Ref)) (!
  (=>
...
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first $t@6@00))
  ($SortWrappers.$SnapToInt ($Snap.second $t@6@00))))
(pop) ; 1
