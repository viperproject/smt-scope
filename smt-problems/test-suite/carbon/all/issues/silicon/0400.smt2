...
(assert  (and (= (type Heap@@9) (MapType0Type RefType)) (= (type a_2@0) (SeqType intType))))
(set-info :boogie-vc-id test_take_drop_01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= a_2@0 (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 1)) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 5))) (|Seq#Singleton| (int_2_U 7))) (|Seq#Singleton| (int_2_U 8)))) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Seq#Equal| (|Seq#Drop| (|Seq#Take| a_2@0 2) 0) (|Seq#Drop| (|Seq#Take| a_2@0 2) 0))) (=> (|Seq#Equal| (|Seq#Drop| (|Seq#Take| a_2@0 2) 0) (|Seq#Drop| (|Seq#Take| a_2@0 2) 0)) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Seq#Equal| (|Seq#Drop| (|Seq#Take| a_2@0 4) 2) (|Seq#Drop| (|Seq#Take| a_2@0 4) 2))) (=> (|Seq#Equal| (|Seq#Drop| (|Seq#Take| a_2@0 4) 2) (|Seq#Drop| (|Seq#Take| a_2@0 4) 2)) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Seq#Equal| (|Seq#Drop| (|Seq#Take| a_2@0 5) 0) (|Seq#Drop| (|Seq#Take| a_2@0 5) 0))) (=> (|Seq#Equal| (|Seq#Drop| (|Seq#Take| a_2@0 5) 0) (|Seq#Drop| (|Seq#Take| a_2@0 5) 0)) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (|Seq#Equal| (|Seq#Drop| (|Seq#Take| a_2@0 1) 1) (|Seq#Drop| (|Seq#Take| a_2@0 1) 1)))))))))))))))
...
(declare-fun e3 () Int)
(assert  (and (= (type Heap@@9) (MapType0Type RefType)) (= (type a_2@0) (SeqType intType))))
(set-info :boogie-vc-id test_take_drop_02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= a_2@0 (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 1)) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 5))) (|Seq#Singleton| (int_2_U 7))) (|Seq#Singleton| (int_2_U 8)))) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Seq#Equal| (|Seq#Drop| (|Seq#Take| a_2@0 2) 2) (|Seq#Empty| intType))) (=> (|Seq#Equal| (|Seq#Drop| (|Seq#Take| a_2@0 2) 2) (|Seq#Empty| intType)) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Seq#Equal| (|Seq#Drop| (|Seq#Take| a_2@0 2) 3) (|Seq#Empty| intType))) (=> (|Seq#Equal| (|Seq#Drop| (|Seq#Take| a_2@0 2) 3) (|Seq#Empty| intType)) (=> (and (state Heap@@9 ZeroMask) (<= 0 e2)) (=> (and (and (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (<= e2 e1) (state Heap@@9 ZeroMask))) (and (and (state Heap@@9 ZeroMask) (<= e1 (|Seq#Length| a_2@0))) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Seq#Equal| (|Seq#Drop| (|Seq#Take| a_2@0 e2) e1) (|Seq#Empty| intType))) (=> (|Seq#Equal| (|Seq#Drop| (|Seq#Take| a_2@0 e2) e1) (|Seq#Empty| intType)) (=> (state Heap@@9 ZeroMask) (=> (and (and (<= e4 e3) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (|Seq#Equal| (|Seq#Drop| (|Seq#Take| a_2@0 e4) e3) (|Seq#Empty| intType)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 6) 2) anon0_correct)))
PreconditionGeneratedEntry_correct)))
))
(check-sat)
