...
(let ((anon14_Then_correct  (=> (not (= i$0 0)) (and (=> (= (ControlFlow 0 10) 9) anon15_Then_correct) (=> (= (ControlFlow 0 10) 7) anon5_correct)))))
(let ((anon14_Else_correct  (=> (and (= i$0 0) (= (ControlFlow 0 8) 7)) anon5_correct)))
...
(let ((anon17_Then_correct  (=> (not (= i$0_2 0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (not (= i$0_2 (f_6 Heap@@13 i@@3)))) (=> (not (= i$0_2 (f_6 Heap@@13 i@@3))) (=> (= (ControlFlow 0 3) 2) anon10_correct))))))
(let ((anon16_Else_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (= i@@3 0) (state Heap@@13 ZeroMask))) (and (and (and (=> (= (ControlFlow 0 12) 11) anon12_Then_correct) (=> (= (ControlFlow 0 12) 1) anon16_Else_correct)) (=> (= (ControlFlow 0 12) 3) anon17_Then_correct)) (=> (= (ControlFlow 0 12) 5) anon17_Else_correct)))))
