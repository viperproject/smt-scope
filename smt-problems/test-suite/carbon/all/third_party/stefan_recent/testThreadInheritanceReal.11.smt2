...
(set-info :boogie-vc-id |Worker__postJoin_at_Thread#definedness|)
...
(assert (= (type Heap@@30) (MapType0Type RefType)))
...
(let ((anon0_correct  (=> (state Heap@@30 ZeroMask) (=> (and (>= current_thread_id 0) (state Heap@@30 ZeroMask)) (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon5_Else_correct))))))
...
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(set-info :boogie-vc-id Worker__open_preFork_at_Worker)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
