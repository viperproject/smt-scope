...
(declare-fun |h_e#trigger| (T@U Int) Bool)
(declare-fun x@@28 () Int)
(declare-fun Heap@@29 () T@U)
(assert (= (type Heap@@29) (MapType0Type RefType)))
(set-info :boogie-vc-id |h_e#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon7_correct true))
(let ((anon10_Else_correct  (=> (and (|h_e#trigger| EmptyFrame (- x@@28 1)) (= (ControlFlow 0 6) 4)) anon7_correct)))
(let ((anon9_Then_correct  (=> (and (<= x@@28 0) (= (ControlFlow 0 5) 4)) anon7_correct)))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (= (f1 Heap@@29 (- x@@28 1)) (- x@@28 1)))))
(let ((anon9_Else_correct  (=> (< 0 x@@28) (and (=> (= (ControlFlow 0 7) 3) anon10_Then_correct) (=> (= (ControlFlow 0 7) 6) anon10_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (= (f1 Heap@@29 x@@28) x@@28) (state Heap@@29 ZeroMask)) (and (=> (= (ControlFlow 0 8) 5) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct)))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@29 ZeroMask) (=> (and (= AssumeFunctionsAbove 1) (state Heap@@29 ZeroMask)) (and (=> (= (ControlFlow 0 9) 1) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct))))))
