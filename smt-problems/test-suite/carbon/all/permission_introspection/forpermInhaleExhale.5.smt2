...
(declare-fun r_6 () T@U)
(assert  (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type r_6) RefType)) (= (type x@@8) RefType)) (= (type Heap@@9) (MapType0Type RefType))))
...
(let ((anon8_Else_correct  (=> (and (not (HasDirectPerm Mask@0 r_6 f_7)) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon8_Then_correct  (=> (HasDirectPerm Mask@0 r_6 f_7) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@0 r_6 f_7)) (=> (HasDirectPerm Mask@0 r_6 f_7) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 r_6 f_7)) (=> (HasDirectPerm Mask@0 r_6 f_7) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
