...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= one@0 (/ (to_real 1) (to_real 1))) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (not (= one@0 0.0))) (=> (not (= one@0 0.0)) (=> (and (and (= r1@0 (/ p_1 one@0)) (state Heap@@9 ZeroMask)) (and (= r2@0 (/ p_1 (to_real 2))) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= r1@0 p_1)) (=> (= r1@0 p_1) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (* (/ (to_real 2) (to_real 1)) r2@0) p_1)) (=> (= (* (/ (to_real 2) (to_real 1)) r2@0) p_1) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= r2@0 p_1))))))))))))))
