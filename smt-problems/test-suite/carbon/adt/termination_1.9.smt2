...
(set-info :boogie-vc-id |ilen2#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon7_correct  (=> (and (= Result@0 (ite (= (IntList_tag l@@44) 1) 0 (ite (= (IntList_tag (get_IntList_itail l@@44)) 1) 1 (+ 2 (ilen2 Heap@@58 (get_IntList_itail (get_IntList_itail l@@44))))))) (= (ControlFlow 0 3) (- 0 2))) (>= Result@0 0))))
(let ((anon10_Else_correct  (=> (and (|ilen2#trigger| EmptyFrame (get_IntList_itail (get_IntList_itail l@@44))) (= (ControlFlow 0 6) 3)) anon7_correct)))
(let ((anon9_Then_correct  (=> (and (= (IntList_tag (get_IntList_itail l@@44)) 1) (= (ControlFlow 0 5) 3)) anon7_correct)))
(let ((anon8_Then_correct  (=> (and (= (IntList_tag l@@44) 1) (= (ControlFlow 0 4) 3)) anon7_correct)))
(let ((anon10_Then_correct true))
(let ((anon9_Else_correct  (=> (not (= (IntList_tag (get_IntList_itail l@@44)) 1)) (and (=> (= (ControlFlow 0 7) 1) anon10_Then_correct) (=> (= (ControlFlow 0 7) 6) anon10_Else_correct)))))
(let ((anon8_Else_correct  (=> (not (= (IntList_tag l@@44) 1)) (and (=> (= (ControlFlow 0 8) 5) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct)))))
(let ((anon0_correct  (=> (and (state Heap@@58 ZeroMask) (= AssumeFunctionsAbove 7)) (and (=> (= (ControlFlow 0 9) 4) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct)))))
...
(let ((anon4_Else_correct  (=> (not (= (DList_tag l@@44) 1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing (get_DList_dtail l@@44) l@@44)) (=> (decreasing (get_DList_dtail l@@44) l@@44) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded l@@44)) (=> (bounded l@@44) (=> (and (state Heap@@58 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (and (= (DList_tag l@@44) 1) (= (ControlFlow 0 2) 1)) anon3_correct)))
(let ((anon0_correct  (=> (and (state Heap@@58 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 6) 2) anon4_Then_correct) (=> (= (ControlFlow 0 6) 3) anon4_Else_correct)))))
