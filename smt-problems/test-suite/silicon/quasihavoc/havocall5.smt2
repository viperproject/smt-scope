(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:27:09
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quasihavoc/havocall5.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (forall ((x@8@01 $Ref)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quasihavoc/havocall5.vpr@6@14@6@62-aux|)))
(assert (forall ((x@8@01 $Ref)) (!
  (=>
    ...
    (=
      ...
      3))
  :pattern ((Set_in x@8@01 s@2@01))
  :qid |prog./silicon/silver/src/test/resources/quasihavoc/havocall5.vpr@6@14@6@62|)))
...
(assert (forall ((x@13@01 $Ref)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quasihavoc/havocall5.vpr@11@12@11@48-aux|)))
(push) ; 3
(assert (not (forall ((x@13@01 $Ref)) (!
  ...
  :pattern ((Set_in x@13@01 s@2@01))
  :qid |prog./silicon/silver/src/test/resources/quasihavoc/havocall5.vpr@11@12@11@48|))))
(check-sat)
; unsat
(pop) ; 3
; 0,00s
