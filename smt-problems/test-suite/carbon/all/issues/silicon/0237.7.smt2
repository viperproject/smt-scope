...
(declare-fun arr () T@U)
(assert  (and (= (type Heap@@9) (MapType0Type RefType)) (= (type arr) RefType)))
(set-info :boogie-vc-id test07)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 arr $allocated)) (= (ControlFlow 0 2) (- 0 1))) (= (U_2_real (MapType1Select ZeroMask null val)) NoPerm)))))
