...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type _balance) (FieldType NormalFieldType intType))))
(assert (distinct $allocated _balance)
)
...
(assert  (and (= (Ctor PredicateType_accountType) 12) (forall ((arg0@@25 T@U) ) (! (= (type (account arg0@@25)) (FieldType PredicateType_accountType FrameTypeType))
 :qid |funType:account|
 :pattern ( (account arg0@@25))
))))
(assert (forall ((this T@U) ) (!  (=> (= (type this) RefType) (IsPredicateField (account this)))
 :qid |stdinbpl.245:15|
 :skolemid |26|
 :pattern ( (account this))
)))
(assert (forall ((Heap@@2 T@U) (this@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type this@@0) RefType)) (dummyFunction (int_2_U (|balance#triggerStateless| this@@0))))
 :qid |stdinbpl.197:15|
 :skolemid |23|
 :pattern ( (|balance'| Heap@@2 this@@0))
)))
(assert (forall ((Heap@@3 T@U) (this@@1 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type this@@1) RefType)) (|account#everUsed| (account this@@1)))
 :qid |stdinbpl.264:15|
 :skolemid |30|
 :pattern ( (|account#trigger| Heap@@3 (account this@@1)))
)))
...
(assert (forall ((Heap@@5 T@U) (this@@2 T@U) ) (!  (=> (and (= (type Heap@@5) (MapType0Type RefType)) (= (type this@@2) RefType)) (and (= (balance Heap@@5 this@@2) (|balance'| Heap@@5 this@@2)) (dummyFunction (int_2_U (|balance#triggerStateless| this@@2)))))
 :qid |stdinbpl.193:15|
 :skolemid |22|
 :pattern ( (balance Heap@@5 this@@2))
)))
(assert (forall ((this@@3 T@U) (this2 T@U) ) (!  (=> (and (and (= (type this@@3) RefType) (= (type this2) RefType)) (= (account this@@3) (account this2))) (= this@@3 this2))
 :qid |stdinbpl.255:15|
 :skolemid |28|
 :pattern ( (account this@@3) (account this2))
)))
(assert (forall ((arg0@@26 T@U) ) (! (= (type (|account#sm| arg0@@26)) (FieldType PredicateType_accountType (MapType1Type RefType boolType)))
 :qid |funType:account#sm|
 :pattern ( (|account#sm| arg0@@26))
)))
(assert (forall ((this@@4 T@U) (this2@@0 T@U) ) (!  (=> (and (and (= (type this@@4) RefType) (= (type this2@@0) RefType)) (= (|account#sm| this@@4) (|account#sm| this2@@0))) (= this@@4 this2@@0))
 :qid |stdinbpl.259:15|
 :skolemid |29|
...
(assert (forall ((this@@5 T@U) ) (!  (=> (= (type this@@5) RefType) (= (getPredWandId (account this@@5)) 0))
 :qid |stdinbpl.249:15|
 :skolemid |27|
 :pattern ( (account this@@5))
)))
...
(assert (forall ((Heap@@10 T@U) (Mask@@9 T@U) (this@@6 T@U) ) (!  (=> (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (= (type this@@6) RefType)) (state Heap@@10 Mask@@9)) (= (|balance'| Heap@@10 this@@6) (|balance#frame| (MapType0Select Heap@@10 null (account this@@6)) this@@6)))
 :qid |stdinbpl.204:15|
 :skolemid |24|
 :pattern ( (state Heap@@10 Mask@@9) (|balance'| Heap@@10 this@@6))
)))
...
(assert (forall ((this@@7 T@U) ) (!  (=> (= (type this@@7) RefType) (= (PredicateMaskField (account this@@7)) (|account#sm| this@@7)))
 :qid |stdinbpl.241:15|
 :skolemid |25|
 :pattern ( (PredicateMaskField (account this@@7)))
)))
...
(declare-fun n () Int)
(assert  (and (and (and (and (= (type PostMask@0) (MapType1Type RefType realType)) (= (type this@@8) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type Heap@@13) (MapType0Type RefType))))
...
(let ((anon17_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (account this@@8))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (account this@@8)))) (=> (= (ControlFlow 0 8) 7) anon8_correct))))))
(let ((anon4_correct true))
(let ((anon15_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon4_correct)))
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (account this@@8))))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (account this@@8)))) (=> (= (ControlFlow 0 4) 3) anon4_correct))))))
(let ((anon16_Else_correct true))
(let ((anon13_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (= PostMask@0 (MapType1Store ZeroMask null (account this@@8) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (account this@@8))) FullPerm)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (and (and (and (=> (= (ControlFlow 0 11) 2) anon16_Else_correct) (=> (= (ControlFlow 0 11) 8) anon17_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon17_Else_correct)) (=> (= (ControlFlow 0 11) 4) anon15_Then_correct)) (=> (= (ControlFlow 0 11) 6) anon15_Else_correct))))))
(let ((anon13_Else_correct true))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@13 this@@8 $allocated))) (=> (and (and (< 0 n) (= Mask@0 (MapType1Store ZeroMask null (account this@@8) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (account this@@8))) FullPerm))))) (and (state Heap@@13 Mask@0) (state Heap@@13 Mask@0))) (and (=> (= (ControlFlow 0 12) 11) anon13_Then_correct) (=> (= (ControlFlow 0 12) 1) anon13_Else_correct)))))))
