...
(declare-fun |fun'| (T@U T@U) Real)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |fun#triggerStateless| (T@U) Real)
(declare-fun fun (T@U T@U) Real)
...
(declare-fun |fun#frame| (T@U T@U) Real)
...
(assert (forall ((Heap@@2 T@U) (x@@8 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type x@@8) RefType)) (dummyFunction (real_2_U (|fun#triggerStateless| x@@8))))
 :qid |stdinbpl.197:15|
 :skolemid |23|
...
(assert (forall ((Heap@@4 T@U) (x@@9 T@U) ) (!  (=> (and (= (type Heap@@4) (MapType0Type RefType)) (= (type x@@9) RefType)) (and (= (fun Heap@@4 x@@9) (|fun'| Heap@@4 x@@9)) (dummyFunction (real_2_U (|fun#triggerStateless| x@@9)))))
 :qid |stdinbpl.193:15|
 :skolemid |22|
 :pattern ( (fun Heap@@4 x@@9))
)))
...
(assert (forall ((Heap@@9 T@U) (Mask@@9 T@U) (x@@10 T@U) ) (!  (=> (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (= (type x@@10) RefType)) (state Heap@@9 Mask@@9)) (= (|fun'| Heap@@9 x@@10) (|fun#frame| EmptyFrame x@@10)))
 :qid |stdinbpl.210:15|
 :skolemid |25|
 :pattern ( (state Heap@@9 Mask@@9) (|fun'| Heap@@9 x@@10))
)))
...
(assert (forall ((Heap@@12 T@U) (Mask@@10 T@U) (x@@11 T@U) ) (!  (=> (and (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type x@@11) RefType)) (and (state Heap@@12 Mask@@10) (< AssumeFunctionsAbove 0))) (= (fun Heap@@12 x@@11) FullPerm))
 :qid |stdinbpl.203:15|
 :skolemid |24|
 :pattern ( (state Heap@@12 Mask@@10) (fun Heap@@12 x@@11))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
...
(assert  (and (= (type Heap@@13) (MapType0Type RefType)) (= (type x@@12) RefType)))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (< NoPerm (* (to_real (- 0 1)) (fun Heap@@13 (MapType0Select Heap@@13 x@@12 f_7)))))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (< NoPerm (* (to_real (- 0 1)) (fun Heap@@13 (MapType0Select Heap@@13 x@@12 f_7))))) (=> (< NoPerm (* (to_real (- 0 1)) (fun Heap@@13 (MapType0Select Heap@@13 x@@12 f_7)))) (=> (state Heap@@13 ZeroMask) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm ZeroMask x@@12 f_7)) (=> (HasDirectPerm ZeroMask x@@12 f_7) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@13 x@@12 $allocated))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm ZeroMask x@@12 f_7)) (=> (HasDirectPerm ZeroMask x@@12 f_7) (and (=> (= (ControlFlow 0 8) 1) anon5_Then_correct) (=> (= (ControlFlow 0 8) 5) anon5_Else_correct))))))))
