...
(declare-fun this$_3@@5 () T@U)
(declare-fun Mask@0 () T@U)
(declare-fun Mask@1 () T@U)
(assert  (and (and (and (= (type Heap@@15) (MapType0Type RefType)) (= (type this$_3@@5) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |PseudoListinv$#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@15 this$_3@@5 $allocated))) (and (not (= this$_3@@5 null)) (= Mask@0 (MapType1Store ZeroMask this$_3@@5 PseudoListvalue$ (real_2_U (+ (U_2_real (MapType1Select ZeroMask this$_3@@5 PseudoListvalue$)) FullPerm)))))) (and (and (state Heap@@15 Mask@0) (not (= this$_3@@5 null))) (and (= Mask@1 (MapType1Store Mask@0 this$_3@@5 PseudoListnext$ (real_2_U (+ (U_2_real (MapType1Select Mask@0 this$_3@@5 PseudoListnext$)) FullPerm)))) (state Heap@@15 Mask@1)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 this$_3@@5 PseudoListnext$)) (=> (HasDirectPerm Mask@1 this$_3@@5 PseudoListnext$) (=> (and (not (= (MapType0Select Heap@@15 this$_3@@5 PseudoListnext$) null)) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm Mask@1 this$_3@@5 PseudoListnext$))))))))
