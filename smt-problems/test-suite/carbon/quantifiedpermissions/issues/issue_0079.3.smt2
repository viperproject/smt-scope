...
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@4) (MapType2Type RefType realType)) (= (type Mask@3) (MapType2Type RefType realType))) (= (type Heap@@18) (MapType1Type RefType))) (= (type this@@3) RefType)) (= (type Mask@1) (MapType2Type RefType realType))) (= (type Heap@1) (MapType1Type RefType))) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv4 arg0@@48)) RefType)
 :qid |funType:invRecv4|
 :pattern ( (invRecv4 arg0@@48))
))) (= (type Mask@2) (MapType2Type RefType realType))) (= (type Heap@0) (MapType1Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@0) (MapType2Type RefType realType))))
(set-info :boogie-vc-id foo)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 25) (let ((anon10_correct  (and (=> (= (ControlFlow 0 11) (- 0 13)) (forall ((x@@19 T@U) (x_1 T@U) ) (!  (=> (and (= (type x@@19) RefType) (= (type x_1) RefType)) (=> (and (and (and (and (not (= x@@19 x_1)) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@3 col) x@@19))) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@3 col) x_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@19 x_1))))
 :qid |stdinbpl.894:15|
 :skolemid |119|
...
))) (=> (forall ((x@@20 T@U) (x_1@@0 T@U) ) (!  (=> (and (= (type x@@20) RefType) (= (type x_1@@0) RefType)) (=> (and (and (and (and (not (= x@@20 x_1@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@3 col) x@@20))) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@3 col) x_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@20 x_1@@0))))
 :qid |stdinbpl.894:15|
 :skolemid |119|
...
)) (=> (and (and (and (forall ((x@@21 T@U) ) (!  (=> (= (type x@@21) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@3 col) x@@21)) (< NoPerm FullPerm)) (and (qpRange4 x@@21) (= (invRecv4 x@@21) x@@21))))
 :qid |stdinbpl.900:22|
 :skolemid |120|
 :pattern ( (MapType1Select Heap@1 x@@21 fld))
 :pattern ( (MapType2Select QPMask@0 x@@21 fld))
 :pattern ( (MapType0Select (MapType1Select Heap@1 this@@3 col) x@@21))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@3 col) (invRecv4 o_3))) (< NoPerm FullPerm)) (qpRange4 o_3)) (= (invRecv4 o_3) o_3)))
 :qid |stdinbpl.904:22|
 :skolemid |121|
 :pattern ( (invRecv4 o_3))
))) (and (forall ((x@@22 T@U) ) (!  (=> (and (= (type x@@22) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@3 col) x@@22))) (not (= x@@22 null)))
 :qid |stdinbpl.910:22|
 :skolemid |122|
 :pattern ( (MapType1Select Heap@1 x@@22 fld))
 :pattern ( (MapType2Select QPMask@0 x@@22 fld))
 :pattern ( (MapType0Select (MapType1Select Heap@1 this@@3 col) x@@22))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@3 col) (invRecv4 o_3@@0))) (< NoPerm FullPerm)) (qpRange4 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_3@@0) o_3@@0)) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 fld)) (+ (U_2_real (MapType2Select Mask@2 o_3@@0 fld)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@3 col) (invRecv4 o_3@@0))) (< NoPerm FullPerm)) (qpRange4 o_3@@0))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 fld)) (U_2_real (MapType2Select Mask@2 o_3@@0 fld))))))
 :qid |stdinbpl.916:22|
 :skolemid |123|
 :pattern ( (MapType2Select QPMask@0 o_3@@0 fld))
)))) (and (and (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 fld))) (= (U_2_real (MapType2Select Mask@2 o_3@@1 f_5)) (U_2_real (MapType2Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.920:29|
 :skolemid |124|
 :pattern ( (MapType2Select Mask@2 o_3@@1 f_5))
 :pattern ( (MapType2Select QPMask@0 o_3@@1 f_5))
)) (state Heap@1 QPMask@0)) (and (state Heap@1 QPMask@0) (state Heap@1 QPMask@0)))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm QPMask@0 this@@3 fld)) (=> (HasDirectPerm QPMask@0 this@@3 fld) (=> (= (ControlFlow 0 11) (- 0 10)) (= (U_2_int (MapType1Select Heap@1 this@@3 fld)) 5)))))))))
(let ((anon15_Else_correct  (=> (HasDirectPerm Mask@2 null (inv (MapType1Select Heap@@18 this@@3 col))) (=> (and (= Heap@1 Heap@@18) (= (ControlFlow 0 15) 11)) anon10_correct))))
(let ((anon15_Then_correct  (=> (and (and (not (HasDirectPerm Mask@2 null (inv (MapType1Select Heap@@18 this@@3 col)))) (= Heap@0 (MapType1Store Heap@@18 null (inv (MapType1Select Heap@@18 this@@3 col)) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 14) 11))) anon10_correct)))
(let ((anon8_correct  (=> (= Mask@2 (MapType2Store Mask@1 null (inv (MapType1Select Heap@@18 this@@3 col)) (real_2_U (- (U_2_real (MapType2Select Mask@1 null (inv (MapType1Select Heap@@18 this@@3 col)))) FullPerm)))) (and (=> (= (ControlFlow 0 16) 14) anon15_Then_correct) (=> (= (ControlFlow 0 16) 15) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 19) 16)) anon8_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (<= FullPerm (U_2_real (MapType2Select Mask@1 null (inv (MapType1Select Heap@@18 this@@3 col)))))) (=> (<= FullPerm (U_2_real (MapType2Select Mask@1 null (inv (MapType1Select Heap@@18 this@@3 col))))) (=> (= (ControlFlow 0 17) 16) anon8_correct))))))
(let ((anon11_Else_correct  (=> (and (= (getField Heap@@18 this@@3) 5) (state Heap@@18 Mask@1)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (HasDirectPerm Mask@1 this@@3 col)) (=> (HasDirectPerm Mask@1 this@@3 col) (=> (and (|inv#trigger| Heap@@18 (inv (MapType1Select Heap@@18 this@@3 col))) (= (MapType1Select Heap@@18 null (inv (MapType1Select Heap@@18 this@@3 col))) (FrameFragment (int_2_U (|inv#condqp1| Heap@@18 (MapType1Select Heap@@18 this@@3 col)))))) (and (=> (= (ControlFlow 0 20) 17) anon14_Then_correct) (=> (= (ControlFlow 0 20) 19) anon14_Else_correct))))))))
(let ((anon5_correct  (=> (and (= Mask@4 (MapType2Store Mask@3 null (inv (MapType1Select Heap@@18 this@@3 col)) (real_2_U (- (U_2_real (MapType2Select Mask@3 null (inv (MapType1Select Heap@@18 this@@3 col)))) FullPerm)))) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@3 col) this@@3)))))
(let ((anon13_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon13_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType2Select Mask@3 null (inv (MapType1Select Heap@@18 this@@3 col)))))) (=> (<= FullPerm (U_2_real (MapType2Select Mask@3 null (inv (MapType1Select Heap@@18 this@@3 col))))) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon3_correct  (=> (= Mask@3 (MapType2Store Mask@1 this@@3 col (real_2_U (- (U_2_real (MapType2Select Mask@1 this@@3 col)) FullPerm)))) (and (=> (= (ControlFlow 0 6) 3) anon13_Then_correct) (=> (= (ControlFlow 0 6) 5) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon3_correct)))
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType2Select Mask@1 this@@3 col)))) (=> (<= FullPerm (U_2_real (MapType2Select Mask@1 this@@3 col))) (=> (= (ControlFlow 0 7) 6) anon3_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@18 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType1Select Heap@@18 this@@3 $allocated)) (not (= this@@3 null))) (and (= Mask@0 (MapType2Store ZeroMask this@@3 col (real_2_U (+ (U_2_real (MapType2Select ZeroMask this@@3 col)) FullPerm)))) (state Heap@@18 Mask@0))) (and (=> (= (ControlFlow 0 22) (- 0 24)) (HasDirectPerm Mask@0 this@@3 col)) (=> (HasDirectPerm Mask@0 this@@3 col) (=> (and (= Mask@1 (MapType2Store Mask@0 null (inv (MapType1Select Heap@@18 this@@3 col)) (real_2_U (+ (U_2_real (MapType2Select Mask@0 null (inv (MapType1Select Heap@@18 this@@3 col)))) FullPerm)))) (state Heap@@18 Mask@1)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (HasDirectPerm Mask@1 this@@3 col)) (=> (HasDirectPerm Mask@1 this@@3 col) (=> (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@3 col) this@@3)) (=> (and (state Heap@@18 Mask@1) (state Heap@@18 Mask@1)) (and (and (=> (= (ControlFlow 0 22) 20) anon11_Else_correct) (=> (= (ControlFlow 0 22) 7) anon12_Then_correct)) (=> (= (ControlFlow 0 22) 9) anon12_Else_correct)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 25) 22) anon0_correct)))
