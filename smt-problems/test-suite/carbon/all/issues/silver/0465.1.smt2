...
(declare-fun i@@6 () Int)
(assert  (and (= (type l) (SeqType intType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id o_3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 10)) (>= (ite (exists ((i_4 Int) ) (! (= i_4 0)
 :qid |stdinbpl.779:21|
 :skolemid |119|
)) 1 2) 0)) (=> (>= (ite (exists ((i_4@@0 Int) ) (! (= i_4@@0 0)
 :qid |stdinbpl.779:21|
 :skolemid |119|
)) 1 2) 0) (and (=> (= (ControlFlow 0 8) (- 0 9)) (< (ite (exists ((i_4@@1 Int) ) (! (= i_4@@1 0)
 :qid |stdinbpl.784:21|
 :skolemid |120|
)) 1 2) (|Seq#Length| l))) (=> (< (ite (exists ((i_4@@2 Int) ) (! (= i_4@@2 0)
 :qid |stdinbpl.784:21|
 :skolemid |120|
)) 1 2) (|Seq#Length| l)) (=> (= (ControlFlow 0 8) (- 0 7)) (= (U_2_int (|Seq#Index| l (ite (exists ((i_5 Int) ) (! (= i_5 0)
 :qid |stdinbpl.789:32|
 :skolemid |121|
)) 1 2))) 4))))))))
(let ((anon9_Then_correct true))
(let ((anon7_Else_correct  (=> (and (forall ((i_1 Int) ) (!  (=> (and (<= 0 i_1) (< i_1 (|Seq#Length| l))) (= (U_2_int (|Seq#Index| l i_1)) 4))
 :qid |stdinbpl.758:20|
 :skolemid |118|
 :pattern ( (|Seq#Index| l i_1))
)) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 11) 6) anon9_Then_correct) (=> (= (ControlFlow 0 11) 8) anon9_Else_correct)))))
(let ((anon3_correct true))
(let ((anon8_Else_correct  (=> (and (not (and (<= 0 i@@6) (< i@@6 (|Seq#Length| l)))) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon8_Then_correct  (=> (and (<= 0 i@@6) (< i@@6 (|Seq#Length| l))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i@@6 (|Seq#Length| l))) (=> (< i@@6 (|Seq#Length| l)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (= (|Seq#Length| l) 3)) (and (and (=> (= (ControlFlow 0 12) 11) anon7_Else_correct) (=> (= (ControlFlow 0 12) 2) anon8_Then_correct)) (=> (= (ControlFlow 0 12) 5) anon8_Else_correct)))))
