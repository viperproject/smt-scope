(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 19:51:04
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/issues/silicon/0112.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(set-option :timeout 0)
(push) ; 3
(assert (val%precondition ($SortWrappers.IntTo$Snap $t@2@01) x@1@01))
(pop) ; 3
...
(assert (not (Seq_equal
  (as Seq_empty  Seq<Int>)
  (val ($SortWrappers.IntTo$Snap $t@2@01) x@1@01))))
(check-sat)
; unsat
(pop) ; 3
; 0,00s
