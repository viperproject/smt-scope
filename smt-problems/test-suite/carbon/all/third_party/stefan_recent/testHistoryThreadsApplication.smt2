...
(let ((anon9_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (not (= frac@@11 NoPerm)) (state PostHeap@0 ZeroMask)) (and (= PostMask@0 (MapType1Store ZeroMask null (History__hist_idle diz@@169 frac@@11 (p_seq proc@@11 p_incr)) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (History__hist_idle diz@@169 frac@@11 (p_seq proc@@11 p_incr)))) FullPerm)))) (state PostHeap@0 PostMask@0))) (=> (and (and (and (state PostHeap@0 PostMask@0) (not (= diz@@169 null))) (and (= PostMask@1 (MapType1Store PostMask@0 diz@@169 History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select PostMask@0 diz@@169 History__x_hist_value)) FullPerm)))) (state PostHeap@0 PostMask@1))) (and (and (state PostHeap@0 PostMask@1) (not (= diz@@169 null))) (and (= PostMask@2 (MapType1Store PostMask@1 diz@@169 History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select PostMask@1 diz@@169 History__x_hist_mode)) FullPerm)))) (state PostHeap@0 PostMask@2)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm PostMask@2 diz@@169 History__x_hist_mode)) (=> (HasDirectPerm PostMask@2 diz@@169 History__x_hist_mode) (=> (and (= (U_2_int (MapType0Select PostHeap@0 diz@@169 History__x_hist_mode)) 1) (state PostHeap@0 PostMask@2)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm PostMask@2 diz@@169 History__x_hist_value)) (=> (HasDirectPerm PostMask@2 diz@@169 History__x_hist_value) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@3 diz@@169 History__x_hist_value))))))))))))
(let ((anon0_correct  (=> (state Heap@@44 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@44 diz@@169 $allocated))) (=> (and (and (not (= diz@@169 null)) (state Heap@@44 ZeroMask)) (and (>= current_thread_id 0) (state Heap@@44 ZeroMask))) (=> (and (and (and (and (not (= frac@@11 NoPerm)) (state Heap@@44 ZeroMask)) (and (= Mask@0 (MapType1Store ZeroMask null (History__hist_do_incr diz@@169 frac@@11 proc@@11) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (History__hist_do_incr diz@@169 frac@@11 proc@@11))) FullPerm)))) (state Heap@@44 Mask@0))) (and (and (state Heap@@44 Mask@0) (not (= diz@@169 null))) (and (= Mask@1 (MapType1Store Mask@0 diz@@169 History__x_hist_act (real_2_U (+ (U_2_real (MapType1Select Mask@0 diz@@169 History__x_hist_act)) FullPerm)))) (state Heap@@44 Mask@1)))) (and (and (and (state Heap@@44 Mask@1) (not (= diz@@169 null))) (and (= Mask@2 (MapType1Store Mask@1 diz@@169 History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select Mask@1 diz@@169 History__x_hist_value)) FullPerm)))) (state Heap@@44 Mask@2))) (and (and (state Heap@@44 Mask@2) (not (= diz@@169 null))) (and (= Mask@3 (MapType1Store Mask@2 diz@@169 History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select Mask@2 diz@@169 History__x_hist_mode)) FullPerm)))) (state Heap@@44 Mask@3))))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (HasDirectPerm Mask@3 diz@@169 History__x_hist_mode)) (=> (HasDirectPerm Mask@3 diz@@169 History__x_hist_mode) (=> (and (= (U_2_int (MapType0Select Heap@@44 diz@@169 History__x_hist_mode)) 2) (state Heap@@44 Mask@3)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (HasDirectPerm Mask@3 diz@@169 History__x_hist_value)) (=> (HasDirectPerm Mask@3 diz@@169 History__x_hist_value) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm Mask@3 diz@@169 History__x_hist_act)) (=> (HasDirectPerm Mask@3 diz@@169 History__x_hist_act) (=> (and (= (U_2_int (MapType0Select Heap@@44 diz@@169 History__x_hist_value)) (+ (U_2_int (MapType0Select Heap@@44 diz@@169 History__x_hist_act)) 1)) (state Heap@@44 Mask@3)) (and (=> (= (ControlFlow 0 7) 2) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct))))))))))))))))
