...
(let ((anon3_Else_correct  (=> (= (MapType0Select Heap@@16 this@@21 next) null) (=> (and (= Mask@3 Mask@1) (= (ControlFlow 0 4) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (not (= (MapType0Select Heap@@16 this@@21 next) null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 this@@21 next)) (=> (HasDirectPerm Mask@1 this@@21 next) (=> (> wildcard@2 NoPerm) (=> (and (and (= Mask@2 (MapType1Store Mask@1 null (valid (MapType0Select Heap@@16 this@@21 next)) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (valid (MapType0Select Heap@@16 this@@21 next)))) wildcard@2)))) (state Heap@@16 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 2) 1))) anon2_correct)))))))
(let ((anon0_correct  (=> (state Heap@@16 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@16 this@@21 $allocated))) (=> (and (and (and (> wildcard@0 NoPerm) (not (= this@@21 null))) (and (= Mask@0 (MapType1Store ZeroMask this@@21 next (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@21 next)) wildcard@0)))) (state Heap@@16 Mask@0))) (and (and (> wildcard@1 NoPerm) (not (= this@@21 null))) (and (= Mask@1 (MapType1Store Mask@0 this@@21 value (real_2_U (+ (U_2_real (MapType1Select Mask@0 this@@21 value)) wildcard@1)))) (state Heap@@16 Mask@1)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@1 this@@21 next)) (=> (HasDirectPerm Mask@1 this@@21 next) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))))))
