...
(let ((anon13_Then_correct  (=> (= sys__result 0) (and (=> (= (ControlFlow 0 12) (- 0 15)) (HasDirectPerm PostMask@0 diz zero__x)) (=> (HasDirectPerm PostMask@0 diz zero__x) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= tid 0)) (=> (>= tid 0) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< tid (|Seq#Length| (MapType0Select PostHeap@0 diz zero__x)))) (=> (< tid (|Seq#Length| (MapType0Select PostHeap@0 diz zero__x))) (=> (not (= (|Seq#Index| (MapType0Select PostHeap@0 diz zero__x) tid) null)) (=> (and (and (= PostMask@1 (MapType1Store PostMask@0 (|Seq#Index| (MapType0Select PostHeap@0 diz zero__x) tid) Ref__Integer_value (real_2_U (+ (U_2_real (MapType1Select PostMask@0 (|Seq#Index| (MapType0Select PostHeap@0 diz zero__x) tid) Ref__Integer_value)) FullPerm)))) (state PostHeap@0 PostMask@1)) (and (= PostMask@2 PostMask@1) (= (ControlFlow 0 12) 11))) anon5_correct)))))))))))
(let ((anon12_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (<= 0 tid)) (=> (and (and (and (and (state PostHeap@0 ZeroMask) (< tid tcount)) (and (state PostHeap@0 ZeroMask) (<= 0 lid))) (and (and (state PostHeap@0 ZeroMask) (< lid gsize)) (and (state PostHeap@0 ZeroMask) (<= 0 gid)))) (and (and (and (state PostHeap@0 ZeroMask) (= tid (+ lid (* gid gsize)))) (and (state PostHeap@0 ZeroMask) (> wildcard@1 NoPerm))) (and (and (not (= diz null)) (= PostMask@0 (MapType1Store ZeroMask diz zero__x (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz zero__x)) wildcard@1))))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))))) (and (=> (= (ControlFlow 0 17) (- 0 20)) (HasDirectPerm PostMask@0 diz zero__x)) (=> (HasDirectPerm PostMask@0 diz zero__x) (=> (and (= (|Seq#Length| (MapType0Select PostHeap@0 diz zero__x)) tcount) (state PostHeap@0 PostMask@0)) (and (=> (= (ControlFlow 0 17) (- 0 19)) (HasDirectPerm PostMask@0 diz zero__x)) (=> (HasDirectPerm PostMask@0 diz zero__x) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm Mask@2 diz zero__x)) (=> (HasDirectPerm Mask@2 diz zero__x) (=> (and (|Seq#Equal| (MapType0Select PostHeap@0 diz zero__x) (MapType0Select Heap@@9 diz zero__x)) (state PostHeap@0 PostMask@0)) (and (=> (= (ControlFlow 0 17) 12) anon13_Then_correct) (=> (= (ControlFlow 0 17) 16) anon13_Else_correct))))))))))))))
(let ((anon12_Else_correct true))
(let ((anon2_correct  (=> (state Heap@@9 Mask@2) (and (=> (= (ControlFlow 0 21) 17) anon12_Then_correct) (=> (= (ControlFlow 0 21) 2) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (not (= last_barrier 0)) (=> (and (= Mask@2 Mask@0) (= (ControlFlow 0 26) 21)) anon2_correct))))
(let ((anon11_Then_correct  (=> (= last_barrier 0) (and (=> (= (ControlFlow 0 22) (- 0 25)) (HasDirectPerm Mask@0 diz zero__x)) (=> (HasDirectPerm Mask@0 diz zero__x) (and (=> (= (ControlFlow 0 22) (- 0 24)) (>= tid 0)) (=> (>= tid 0) (and (=> (= (ControlFlow 0 22) (- 0 23)) (< tid (|Seq#Length| (MapType0Select Heap@@9 diz zero__x)))) (=> (< tid (|Seq#Length| (MapType0Select Heap@@9 diz zero__x))) (=> (not (= (|Seq#Index| (MapType0Select Heap@@9 diz zero__x) tid) null)) (=> (and (and (= Mask@1 (MapType1Store Mask@0 (|Seq#Index| (MapType0Select Heap@@9 diz zero__x) tid) Ref__Integer_value (real_2_U (+ (U_2_real (MapType1Select Mask@0 (|Seq#Index| (MapType0Select Heap@@9 diz zero__x) tid) Ref__Integer_value)) FullPerm)))) (state Heap@@9 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 22) 21))) anon2_correct)))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 diz $allocated)) (not (= diz null))) (=> (and (and (state Heap@@9 ZeroMask) (>= current_thread_id 0)) (and (state Heap@@9 ZeroMask) (<= 0 tid))) (=> (and (and (and (and (state Heap@@9 ZeroMask) (< tid tcount)) (and (state Heap@@9 ZeroMask) (<= 0 lid))) (and (and (state Heap@@9 ZeroMask) (< lid gsize)) (and (state Heap@@9 ZeroMask) (<= 0 gid)))) (and (and (and (state Heap@@9 ZeroMask) (= tid (+ lid (* gid gsize)))) (and (state Heap@@9 ZeroMask) (> wildcard@0 NoPerm))) (and (and (not (= diz null)) (= Mask@0 (MapType1Store ZeroMask diz zero__x (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz zero__x)) wildcard@0))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))))) (and (=> (= (ControlFlow 0 27) (- 0 28)) (HasDirectPerm Mask@0 diz zero__x)) (=> (HasDirectPerm Mask@0 diz zero__x) (=> (and (= (|Seq#Length| (MapType0Select Heap@@9 diz zero__x)) tcount) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 27) 22) anon11_Then_correct) (=> (= (ControlFlow 0 27) 26) anon11_Else_correct)))))))))))
