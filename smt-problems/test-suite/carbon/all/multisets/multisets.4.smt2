...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (= (|MultiSet#Card| B@@11) n) (state Heap@@9 ZeroMask)) (and (= B1@0 (|MultiSet#Intersection| B@@11 B@@11)) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|MultiSet#Equal| B1@0 B@@11)) (=> (|MultiSet#Equal| B1@0 B@@11) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (|MultiSet#Card| B1@0) n))))))))
