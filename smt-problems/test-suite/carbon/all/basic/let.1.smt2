...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (and (= y@0 (fun01 Heap@@19 x@@23)) (= (ControlFlow 0 4) (- 0 3))) (> (+ (* (fun01 Heap@@19 x@@23) (fun01 Heap@@19 x@@23)) (fun01 Heap@@19 x@@23)) 0))))
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (> (U_2_real (MapType1Select Mask@0 null (P x@@23))) NoPerm))))
(let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@19 x@@23 $allocated))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (P x@@23) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@23))) FullPerm)))) (state Heap@@19 Mask@0)) (and (state Heap@@19 Mask@0) (state Heap@@19 Mask@0))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))))
