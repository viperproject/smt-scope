...
(assert  (and (and (and (and (= (type Ops_1Heap@0) (MapType0Type RefType)) (= (type Used_1Heap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type ys) RefType)) (= (type UsedHeap@0) (MapType0Type RefType))))
...
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 ys $allocated))) (=> (and (and (not (= ys null)) (state Heap@@9 ZeroMask)) (and (= b_1_1@0  (and b_1_1 (state Ops_1Heap@0 ZeroMask))) (= b_2@0  (and b_2 (state UsedHeap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 5) 3) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
