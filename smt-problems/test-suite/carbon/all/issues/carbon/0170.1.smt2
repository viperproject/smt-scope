...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (Ctor RefType) 8)) (= (type f1) (FieldType NormalFieldType RefType))) (= (type f2) (FieldType NormalFieldType RefType))))
(assert (distinct $allocated f1 f2)
)
...
(assert  (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type a_2) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type r_1) RefType)) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon6_correct true))
(let ((anon14_Else_correct  (=> (and (not (HasDirectPerm PostMask@0 r_1 f2)) (= (ControlFlow 0 13) 10)) anon6_correct)))
(let ((anon14_Then_correct  (=> (HasDirectPerm PostMask@0 r_1 f2) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm PostMask@0 r_1 f2)) (=> (HasDirectPerm PostMask@0 r_1 f2) (=> (= (ControlFlow 0 11) 10) anon6_correct))))))
(let ((anon13_Else_correct true))
(let ((anon12_Else_correct  (=> (= perm@1 (- FullPerm (U_2_real (MapType1Select ZeroMask a_2 f1)))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (and (=> (> perm@1 NoPerm) (not (= a_2 null))) (= PostMask@0 (MapType1Store ZeroMask a_2 f2 (real_2_U (+ (U_2_real (MapType1Select ZeroMask a_2 f2)) perm@1))))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (and (=> (= (ControlFlow 0 14) 9) anon13_Else_correct) (=> (= (ControlFlow 0 14) 11) anon14_Then_correct)) (=> (= (ControlFlow 0 14) 13) anon14_Else_correct))))))))
...
(let ((anon10_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 a_2 f2 (real_2_U (- (U_2_real (MapType1Select Mask@0 a_2 f2)) perm@0)))) (= (ControlFlow 0 2) (- 0 1))) (forall ((r_2 T@U) ) (!  (=> (and (= (type r_2) RefType) (HasDirectPerm Mask@1 r_2 f2)) false)
 :qid |stdinbpl.273:15|
 :skolemid |23|
 :pattern ( (MapType1Select Mask@1 r_2 f2))
 :pattern ( (MapType0Select Heap@@9 r_2 f2))
)))))
(let ((anon15_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 5) 2)) anon10_correct)))
(let ((anon15_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= perm@0 (U_2_real (MapType1Select Mask@0 a_2 f2)))) (=> (<= perm@0 (U_2_real (MapType1Select Mask@0 a_2 f2))) (=> (= (ControlFlow 0 3) 2) anon10_correct))))))
(let ((anon11_Else_correct  (=> (= perm@0 (- FullPerm (U_2_real (MapType1Select Mask@0 a_2 f1)))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 6) 3) anon15_Then_correct) (=> (= (ControlFlow 0 6) 5) anon15_Else_correct)))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 a_2 $allocated))) (=> (and (and (not (= a_2 null)) (= Mask@0 (MapType1Store ZeroMask a_2 f2 (real_2_U (+ (U_2_real (MapType1Select ZeroMask a_2 f2)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 17) 16) anon11_Then_correct) (=> (= (ControlFlow 0 17) 6) anon11_Else_correct))))))
