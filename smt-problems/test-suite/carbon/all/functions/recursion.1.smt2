...
(declare-fun |fac'| (T@U Int) Int)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |fac#triggerStateless| (Int) Int)
(declare-fun |err1'| (T@U Int) Int)
...
(declare-fun |fac#frame| (T@U Int) Int)
(declare-fun |err1#frame| (T@U Int) Int)
(declare-fun |err1#trigger| (T@U Int) Bool)
(declare-fun |fac#trigger| (T@U Int) Bool)
...
(assert (forall ((Heap@@2 T@U) (n Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (int_2_U (|fac#triggerStateless| n))))
 :qid |stdinbpl.198:15|
 :skolemid |23|
 :pattern ( (|fac'| Heap@@2 n))
)))
(assert (forall ((Heap@@3 T@U) (n@@0 Int) ) (!  (=> (= (type Heap@@3) (MapType0Type RefType)) (dummyFunction (int_2_U (|err1#triggerStateless| n@@0))))
 :qid |stdinbpl.284:15|
 :skolemid |28|
 :pattern ( (|err1'| Heap@@3 n@@0))
)))
...
(assert (forall ((Heap@@5 T@U) (n@@1 Int) ) (!  (=> (= (type Heap@@5) (MapType0Type RefType)) (and (= (fac Heap@@5 n@@1) (|fac'| Heap@@5 n@@1)) (dummyFunction (int_2_U (|fac#triggerStateless| n@@1)))))
 :qid |stdinbpl.194:15|
 :skolemid |22|
 :pattern ( (fac Heap@@5 n@@1))
)))
(assert (forall ((Heap@@6 T@U) (n@@2 Int) ) (!  (=> (= (type Heap@@6) (MapType0Type RefType)) (and (= (err1 Heap@@6 n@@2) (|err1'| Heap@@6 n@@2)) (dummyFunction (int_2_U (|err1#triggerStateless| n@@2)))))
 :qid |stdinbpl.280:15|
 :skolemid |27|
 :pattern ( (err1 Heap@@6 n@@2))
)))
...
(assert (forall ((Heap@@9 T@U) (Mask@@6 T@U) (n@@3 Int) ) (!  (=> (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (and (state Heap@@9 Mask@@6) (< AssumeFunctionsAbove 0))) (>= n@@3 0)) (= (err1 Heap@@9 n@@3) (ite (<= n@@3 1) 1 (- (|err1'| Heap@@9 (- n@@3 1)) n@@3))))
 :qid |stdinbpl.290:15|
 :skolemid |29|
 :pattern ( (state Heap@@9 Mask@@6) (err1 Heap@@9 n@@3))
)))
(assert (forall ((Heap@@10 T@U) (Mask@@7 T@U) (n@@4 Int) ) (!  (=> (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (and (state Heap@@10 Mask@@7) (< AssumeFunctionsAbove 1))) (>= n@@4 0)) (= (fac Heap@@10 n@@4) (ite (< n@@4 2) n@@4 (* n@@4 (|fac'| Heap@@10 (- n@@4 1))))))
 :qid |stdinbpl.204:15|
 :skolemid |24|
 :pattern ( (state Heap@@10 Mask@@7) (fac Heap@@10 n@@4))
)))
...
(assert (forall ((Heap@@13 T@U) (Mask@@11 T@U) (n@@5 Int) ) (!  (=> (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (state Heap@@13 Mask@@11)) (= (|fac'| Heap@@13 n@@5) (|fac#frame| EmptyFrame n@@5)))
 :qid |stdinbpl.211:15|
 :skolemid |25|
 :pattern ( (state Heap@@13 Mask@@11) (|fac'| Heap@@13 n@@5))
)))
(assert (forall ((Heap@@14 T@U) (Mask@@12 T@U) (n@@6 Int) ) (!  (=> (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (state Heap@@14 Mask@@12)) (= (|err1'| Heap@@14 n@@6) (|err1#frame| EmptyFrame n@@6)))
 :qid |stdinbpl.297:15|
 :skolemid |30|
 :pattern ( (state Heap@@14 Mask@@12) (|err1'| Heap@@14 n@@6))
)))
...
(assert (forall ((Heap@@16 T@U) (Mask@@13 T@U) (n@@7 Int) ) (!  (=> (and (and (and (= (type Heap@@16) (MapType0Type RefType)) (= (type Mask@@13) (MapType1Type RefType realType))) (and (state Heap@@16 Mask@@13) (or (< AssumeFunctionsAbove 0) (|err1#trigger| EmptyFrame n@@7)))) (>= n@@7 0)) (>= (|err1'| Heap@@16 n@@7) 0))
 :qid |stdinbpl.303:15|
 :skolemid |31|
 :pattern ( (state Heap@@16 Mask@@13) (|err1'| Heap@@16 n@@7))
)))
(assert (forall ((Heap@@17 T@U) (Mask@@14 T@U) (n@@8 Int) ) (!  (=> (and (and (and (= (type Heap@@17) (MapType0Type RefType)) (= (type Mask@@14) (MapType1Type RefType realType))) (and (state Heap@@17 Mask@@14) (or (< AssumeFunctionsAbove 1) (|fac#trigger| EmptyFrame n@@8)))) (>= n@@8 0)) (>= (|fac'| Heap@@17 n@@8) 0))
 :qid |stdinbpl.217:15|
 :skolemid |26|
 :pattern ( (state Heap@@17 Mask@@14) (|fac'| Heap@@17 n@@8))
)))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon18_Else_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (>= (fac Heap@@19 7) 0))))
(let ((anon18_Then_correct true))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (= (fac Heap@@19 4) 24)) (=> (= (fac Heap@@19 4) 24) (=> (state Heap@@19 ZeroMask) (and (=> (= (ControlFlow 0 9) 6) anon18_Then_correct) (=> (= (ControlFlow 0 9) 8) anon18_Else_correct)))))))
(let ((anon17_Then_correct true))
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (= (fac Heap@@19 3) 6)) (=> (= (fac Heap@@19 3) 6) (=> (state Heap@@19 ZeroMask) (and (=> (= (ControlFlow 0 11) 5) anon17_Then_correct) (=> (= (ControlFlow 0 11) 9) anon17_Else_correct)))))))
(let ((anon16_Then_correct true))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (= (fac Heap@@19 2) 2)) (=> (= (fac Heap@@19 2) 2) (=> (state Heap@@19 ZeroMask) (and (=> (= (ControlFlow 0 13) 4) anon16_Then_correct) (=> (= (ControlFlow 0 13) 11) anon16_Else_correct)))))))
(let ((anon15_Then_correct true))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (= (fac Heap@@19 1) 1)) (=> (= (fac Heap@@19 1) 1) (=> (state Heap@@19 ZeroMask) (and (=> (= (ControlFlow 0 15) 3) anon15_Then_correct) (=> (= (ControlFlow 0 15) 13) anon15_Else_correct)))))))
(let ((anon14_Then_correct true))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (= (fac Heap@@19 0) 0)) (=> (= (fac Heap@@19 0) 0) (=> (state Heap@@19 ZeroMask) (and (=> (= (ControlFlow 0 17) 2) anon14_Then_correct) (=> (= (ControlFlow 0 17) 15) anon14_Else_correct)))))))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@19 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 19) 1) anon13_Then_correct) (=> (= (ControlFlow 0 19) 17) anon13_Else_correct)))))
