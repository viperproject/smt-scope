(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:37:04
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/wands/regression/resultstate1.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
; unknown
; [eval] x.h != null
(assert (Q%trigger ($Snap.combine ($Snap.first $t@2@01) $Snap.unit) l@1@01))
(set-option :timeout 0)
(push) ; 4
(set-option :timeout 10)
(assert (not false))
