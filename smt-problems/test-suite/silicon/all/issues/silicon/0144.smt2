(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 19:51:34
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/issues/silicon/0144.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
; [exec]
; var r: Int
(declare-const r@11@01 Int)
; [exec]
; r := callee(x)
(declare-const r@12@01 Int)
(declare-const $t@13@01 $Snap)
(assert (= $t@13@01 $Snap.unit))
; [eval] r == 1 / x
; [eval] 1 / x
(push) ; 3
(assert (not (not (= x@10@01 0))))
(check-sat)
; unknown
(pop) ; 3
; 0,00s
