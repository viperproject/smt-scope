...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon4_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 (|Seq#Index| hist k@@3) Ref__Integer_value (real_2_U (- (U_2_real (MapType1Select Mask@0 (|Seq#Index| hist k@@3) Ref__Integer_value)) FullPerm)))) (= (ControlFlow 0 8) (- 0 7))) (= (U_2_int (MapType0Select Heap@0 (|Seq#Index| hist k@@3) Ref__Integer_value)) 0))))
...
(let ((anon5_Else_correct  (=> (U_2_bool (MapType0Select Heap@@33 __flatten_3 $allocated)) (and (=> (= (ControlFlow 0 12) (- 0 16)) (>= k@@3 0)) (=> (>= k@@3 0) (and (=> (= (ControlFlow 0 12) (- 0 15)) (< k@@3 (|Seq#Length| hist))) (=> (< k@@3 (|Seq#Length| hist)) (=> (and (= __flatten_3@0 (|Seq#Index| hist k@@3)) (state Heap@@33 Mask@0)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (= FullPerm (U_2_real (MapType1Select Mask@0 __flatten_3@0 Ref__Integer_value)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 __flatten_3@0 Ref__Integer_value))) (=> (and (= Heap@0 (MapType0Store Heap@@33 __flatten_3@0 Ref__Integer_value (int_2_U 0))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (|Seq#Contains| (|Seq#Range| 0 P) (int_2_U k@@3))) (=> (|Seq#Contains| (|Seq#Range| 0 P) (int_2_U k@@3)) (and (=> (= (ControlFlow 0 12) 9) anon6_Then_correct) (=> (= (ControlFlow 0 12) 11) anon6_Else_correct)))))))))))))))
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (|Seq#Contains| (|Seq#Range| 0 P) (int_2_U k@@3)) (state PostHeap@0 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= k@@3 0)) (=> (>= k@@3 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< k@@3 (|Seq#Length| hist))) (=> (< k@@3 (|Seq#Length| hist)) (=> (and (and (not (= (|Seq#Index| hist k@@3) null)) (= PostMask@0 (MapType1Store ZeroMask (|Seq#Index| hist k@@3) Ref__Integer_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask (|Seq#Index| hist k@@3) Ref__Integer_value)) FullPerm))))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k@@3 0)) (=> (>= k@@3 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k@@3 (|Seq#Length| hist))) (=> (< k@@3 (|Seq#Length| hist)) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm PostMask@0 (|Seq#Index| hist k@@3) Ref__Integer_value)))))))))))))))
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@33 diz $allocated))) (and (not (= diz null)) (state Heap@@33 ZeroMask))) (and (and (|Seq#Contains| (|Seq#Range| 0 P) (int_2_U k@@3)) (state Heap@@33 ZeroMask)) (and (<= P (|Seq#Length| hist)) (state Heap@@33 ZeroMask)))) (and (=> (= (ControlFlow 0 17) (- 0 19)) (>= k@@3 0)) (=> (>= k@@3 0) (and (=> (= (ControlFlow 0 17) (- 0 18)) (< k@@3 (|Seq#Length| hist))) (=> (< k@@3 (|Seq#Length| hist)) (=> (and (and (not (= (|Seq#Index| hist k@@3) null)) (= Mask@0 (MapType1Store ZeroMask (|Seq#Index| hist k@@3) Ref__Integer_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask (|Seq#Index| hist k@@3) Ref__Integer_value)) FullPerm))))) (and (state Heap@@33 Mask@0) (state Heap@@33 Mask@0))) (and (=> (= (ControlFlow 0 17) 2) anon5_Then_correct) (=> (= (ControlFlow 0 17) 12) anon5_Else_correct)))))))))))
