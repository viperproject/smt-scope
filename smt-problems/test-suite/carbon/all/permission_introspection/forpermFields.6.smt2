...
(declare-fun r_28 () T@U)
(declare-fun Heap@@9 () T@U)
(declare-fun r_27 () T@U)
(declare-fun r1 () T@U)
(declare-fun r2 () T@U)
(assert  (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type r_27) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type r_28) RefType)) (= (type r1) RefType)) (= (type r2) RefType)))
(set-info :boogie-vc-id permCheck2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm Mask@0 r_28 f2)) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm Mask@0 r_28 f2) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm Mask@0 r_28 f2)) (=> (HasDirectPerm Mask@0 r_28 f2) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((r_3 T@U) ) (!  (=> (and (= (type r_3) RefType) (HasDirectPerm Mask@0 r_3 f2)) false)
 :qid |stdinbpl.975:15|
 :skolemid |44|
 :pattern ( (MapType1Select Mask@0 r_3 f2))
 :pattern ( (MapType0Select Heap@@9 r_3 f2))
)))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((r_1_1 T@U) ) (!  (=> (and (= (type r_1_1) RefType) (HasDirectPerm Mask@0 r_1_1 f1)) false)
 :qid |stdinbpl.956:15|
 :skolemid |43|
 :pattern ( (MapType1Select Mask@0 r_1_1 f1))
 :pattern ( (MapType0Select Heap@@9 r_1_1 f1))
))) (=> (forall ((r_1_1@@0 T@U) ) (!  (=> (and (= (type r_1_1@@0) RefType) (HasDirectPerm Mask@0 r_1_1@@0 f1)) false)
 :qid |stdinbpl.956:15|
 :skolemid |43|
 :pattern ( (MapType1Select Mask@0 r_1_1@@0 f1))
 :pattern ( (MapType0Select Heap@@9 r_1_1@@0 f1))
)) (=> (state Heap@@9 Mask@0) (and (and (=> (= (ControlFlow 0 11) 6) anon11_Else_correct) (=> (= (ControlFlow 0 11) 8) anon12_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon12_Else_correct)))))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (HasDirectPerm Mask@0 r_27 f1)) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (HasDirectPerm Mask@0 r_27 f1) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 r_27 f1)) (=> (HasDirectPerm Mask@0 r_27 f1) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 r1 $allocated))) (and (U_2_bool (MapType0Select Heap@@9 r2 $allocated)) (not (= r1 null)))) (and (and (= Mask@0 (MapType1Store ZeroMask r1 f1 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r1 f1)) FullPerm)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)))) (and (and (=> (= (ControlFlow 0 13) 11) anon9_Else_correct) (=> (= (ControlFlow 0 13) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 13) 4) anon10_Else_correct)))))
