...
(assert  (and (and (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type x@@14) RefType)) (= (type _receiver0) RefType)) (= (type _target0) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type _target0@0) RefType)))
(set-info :boogie-vc-id test3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x@@14 $allocated))) (and (U_2_bool (MapType0Select Heap@@10 _receiver0 $allocated)) (U_2_bool (MapType0Select Heap@@10 _target0 $allocated)))) (=> (and (and (and (state Heap@@10 ZeroMask) (not (= x@@14 null))) (and (= Mask@0 (MapType1Store ZeroMask x@@14 n (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@14 n)) FullPerm)))) (state Heap@@10 Mask@0))) (and (and (state Heap@@10 Mask@0) (U_2_bool (MapType0Select Heap@@10 _target0@0 $allocated))) (and (state Heap@@10 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (= FullPerm (U_2_real (MapType1Select Mask@0 x@@14 n)))))))
