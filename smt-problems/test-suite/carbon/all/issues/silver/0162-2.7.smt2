...
(assert  (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type x@@8) RefType)) (= (type y@@1) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id testAcc5)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 x@@8 $allocated)) (U_2_bool (MapType0Select Heap@@10 y@@1 $allocated))) (=> (and (and (and (not (= x@@8 null)) (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (and (<= FullPerm (U_2_real (MapType1Select Mask@0 y@@1 f_7))) (state Heap@@10 Mask@0)) (and (state Heap@@10 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (= x@@8 y@@1))))))
