...
(assert  (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@11) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Heap@2) (MapType0Type RefType))))
(set-info :boogie-vc-id test_fold_unknown)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (HasDirectPerm Mask@0 null tru) (=> (and (= Heap@2 Heap@@11) (= (ControlFlow 0 3) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (not (HasDirectPerm Mask@0 null tru)) (=> (and (and (= Heap@0 (MapType0Store Heap@@11 null |tru#sm| ZeroPMask)) (= Heap@1 (MapType0Store Heap@0 null tru freshVersion@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 2) 1))) anon2_correct))))
(let ((anon0_correct  (=> (and (and (state Heap@@11 ZeroMask) (<= NoPerm p_1)) (and (state Heap@@11 ZeroMask) (state Heap@@11 ZeroMask))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (> p_1 NoPerm)) (=> (> p_1 NoPerm) (and (=> (= (ControlFlow 0 4) (- 0 5)) (>= p_1 NoPerm)) (=> (>= p_1 NoPerm) (=> (= Mask@0 (MapType1Store ZeroMask null tru (real_2_U (+ (U_2_real (MapType1Select ZeroMask null tru)) p_1)))) (=> (and (and (state Heap@@11 Mask@0) (state Heap@@11 Mask@0)) (and (|tru#trigger| Heap@@11 tru) (= (MapType0Select Heap@@11 null tru) EmptyFrame))) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))))))))
