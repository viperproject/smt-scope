...
(assert  (and (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type this@@9) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@14) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))))
...
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null (inv this@@9))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 null (inv this@@9)))) (=> (= (ControlFlow 0 2) 1) anon4_correct))))))
(let ((anon2_correct  (=> (and (and (and (= Mask@1 (MapType1Store Mask@0 null (inv this@@9) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (inv this@@9))) FullPerm)))) (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@0 Mask@1)) (and (= Mask@2 (MapType1Store Mask@1 null (inv this@@9) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (inv this@@9))) FullPerm)))) (state ExhaleHeap@0 Mask@2))) (and (and (state ExhaleHeap@0 Mask@2) (= (get ExhaleHeap@0 this@@9) 3)) (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)))) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (inv this@@9))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (inv this@@9)))) (=> (= (ControlFlow 0 6) 5) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@14 this@@9 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (inv this@@9) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (inv this@@9))) FullPerm))))) (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0))) (and (=> (= (ControlFlow 0 9) 6) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct))))))
