...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon2_correct  (=> (and (and (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (pair x@@48) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (pair x@@48))) FullPerm)))) (not (= x@@48 null))) (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x@@48 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@48 f_7)) FullPerm)))) (state Heap@@37 UnfoldingMask@1))) (and (and (not (= x@@48 null)) (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 x@@48 g (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 x@@48 g)) FullPerm))))) (and (state Heap@@37 UnfoldingMask@2) (state Heap@@37 UnfoldingMask@2)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm UnfoldingMask@2 x@@48 f_7)) (=> (HasDirectPerm UnfoldingMask@2 x@@48 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm UnfoldingMask@2 x@@48 g)))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pair x@@48))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pair x@@48)))) (=> (= (ControlFlow 0 4) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@37 ZeroMask) (U_2_bool (MapType0Select Heap@@37 x@@48 $allocated))) (and (= AssumeFunctionsAbove 0) (= Mask@0 (MapType1Store ZeroMask null (pair x@@48) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (pair x@@48))) FullPerm)))))) (and (and (state Heap@@37 Mask@0) (state Heap@@37 Mask@0)) (and (|pair#trigger| Heap@@37 (pair x@@48)) (= (MapType0Select Heap@@37 null (pair x@@48)) (CombineFrames (FrameFragment (MapType0Select Heap@@37 x@@48 f_7)) (FrameFragment (MapType0Select Heap@@37 x@@48 g))))))) (and (=> (= (ControlFlow 0 7) 4) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct)))))
