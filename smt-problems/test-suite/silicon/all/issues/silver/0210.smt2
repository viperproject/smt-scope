(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:03:08
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/issues/silver/0210.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (not (forall ((i$0@1@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0210.vpr@13@39@13@46|))))
(check-sat)
; unknown
(pop) ; 3
; 0,00s
