...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon2_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (Tree_valid self@@5) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (Tree_valid self@@5))) FullPerm)))) (= perm@0 (/ (to_real 1) (to_real 10)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= self@@5 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 self@@5 Tree_height (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 self@@5 Tree_height)) perm@0)))) (state Heap@@10 UnfoldingMask@1)) (and (state Heap@@10 UnfoldingMask@1) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm UnfoldingMask@1 self@@5 Tree_height))))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Tree_valid self@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Tree_valid self@@5)))) (=> (= (ControlFlow 0 4) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 self@@5 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (Tree_valid self@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Tree_valid self@@5))) FullPerm))))) (=> (and (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (|Tree_valid#trigger| Heap@@10 (Tree_valid self@@5)) (= (MapType0Select Heap@@10 null (Tree_valid self@@5)) (FrameFragment (MapType0Select Heap@@10 self@@5 Tree_height))))) (and (=> (= (ControlFlow 0 7) 4) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct)))))))
