...
(let ((anon4_Else_correct  (=> (not (or (< x@@8 5) (< y@@1 8))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (and (decreasing (int_2_U (- x@@8 2)) (int_2_U x@@8)) (bounded (int_2_U x@@8))) (and (= (- x@@8 2) x@@8) (and (decreasing (int_2_U (- y@@1 3)) (int_2_U y@@1)) (bounded (int_2_U y@@1)))))) (=> (or (and (decreasing (int_2_U (- x@@8 2)) (int_2_U x@@8)) (bounded (int_2_U x@@8))) (and (= (- x@@8 2) x@@8) (and (decreasing (int_2_U (- y@@1 3)) (int_2_U y@@1)) (bounded (int_2_U y@@1))))) (=> (and (state Heap@@9 ZeroMask) (= arg_x@0 (- x@@8 2))) (=> (and (and (= arg_y@0 (- y@@1 3)) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 3) 1))) anon3_correct)))))))
(let ((anon4_Then_correct  (=> (or (< x@@8 5) (< y@@1 8)) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) 1)) anon3_correct))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 5) 2) anon4_Then_correct) (=> (= (ControlFlow 0 5) 3) anon4_Else_correct)))))
