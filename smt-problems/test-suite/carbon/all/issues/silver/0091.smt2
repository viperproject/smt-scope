...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (and (not (= x@@19 y@@6)) (state Heap@@9 ZeroMask)) (and (= (|MultiSet#Select| B@@11 (int_2_U x@@19)) xc) (state Heap@@9 ZeroMask))) (and (and (= (|MultiSet#Select| B@@11 (int_2_U y@@6)) yc) (state Heap@@9 ZeroMask)) (and (= B1@0 (|MultiSet#Union| B@@11 (|MultiSet#UnionOne| (|MultiSet#UnionOne| (|MultiSet#Singleton| (int_2_U x@@19)) (int_2_U y@@6)) (int_2_U x@@19)))) (state Heap@@9 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (|MultiSet#Select| B1@0 (int_2_U y@@6)) (+ yc 1))) (=> (= (|MultiSet#Select| B1@0 (int_2_U y@@6)) (+ yc 1)) (=> (= (ControlFlow 0 2) (- 0 1)) (= (|MultiSet#Select| B1@0 (int_2_U x@@19)) (+ xc 2)))))))))
