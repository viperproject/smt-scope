...
(assert  (and (and (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type x_2) RefType)) (= (type y@@2) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type z_13) RefType)) (forall ((arg0@@35 T@U) ) (! (= (type (invRecv19 arg0@@35)) RefType)
 :qid |funType:invRecv19|
 :pattern ( (invRecv19 arg0@@35))
))))
(set-info :boogie-vc-id test04c)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon11_Then_correct true))
(let ((anon6_correct true))
(let ((anon10_Then_correct  (=> (or (= z_13 x_2) (= z_13 y@@2)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm QPMask@0 z_13 f_7)) (=> (HasDirectPerm QPMask@0 z_13 f_7) (and (=> (= (ControlFlow 0 8) 7) anon11_Then_correct) (=> (= (ControlFlow 0 8) 5) anon6_correct)))))))
(let ((anon10_Else_correct  (=> (and (not (or (= z_13 x_2) (= z_13 y@@2))) (= (ControlFlow 0 6) 5)) anon6_correct)))
(let ((anon9_Else_correct  (=> (forall ((z_3 T@U) ) (!  (=> (and (= (type z_3) RefType) (or (= z_3 x_2) (= z_3 y@@2))) (inv Heap@@13 (U_2_int (MapType0Select Heap@@13 z_3 f_7))))
 ...
 :skolemid |184|
 :pattern ( (MapType0Select Heap@@13 z_3 f_7))
...
)) (=> (forall ((z_1@@1 T@U) ) (!  (=> (= (type z_1@@1) RefType) (=> (and (or (= z_1@@1 x_2) (= z_1@@1 y@@2)) (< NoPerm FullPerm)) (and (qpRange19 z_1@@1) (= (invRecv19 z_1@@1) z_1@@1))))
 :qid |stdinbpl.2112:22|
 :skolemid |179|
 :pattern ( (MapType0Select Heap@@13 z_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@1 f_7))
)) (=> (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (or (= (invRecv19 o_3) x_2) (= (invRecv19 o_3) y@@2)) (< NoPerm FullPerm)) (qpRange19 o_3)) (= (invRecv19 o_3) o_3)))
...
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (or (= (invRecv19 o_3@@0) x_2) (= (invRecv19 o_3@@0) y@@2)) (< NoPerm FullPerm)) (qpRange19 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv19 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (or (= (invRecv19 o_3@@0) x_2) (= (invRecv19 o_3@@0) y@@2)) (< NoPerm FullPerm)) (qpRange19 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
