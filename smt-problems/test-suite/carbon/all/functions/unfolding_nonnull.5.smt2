...
(assert  (and (and (= (type Heap@@20) (MapType0Type RefType)) (= (type x@@34) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
...
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (F x@@34))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (F x@@34)))) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
(let ((anon5_Else_correct  (=> (= (fun3 Heap@@20 x@@34) 1) (=> (and (state Heap@@20 Mask@0) (= (ControlFlow 0 2) (- 0 1))) (not (= x@@34 null))))))
(let ((anon0_correct  (=> (and (state Heap@@20 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@20 x@@34 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (F x@@34) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (F x@@34))) FullPerm))))) (and (state Heap@@20 Mask@0) (state Heap@@20 Mask@0))) (and (and (=> (= (ControlFlow 0 7) 2) anon5_Else_correct) (=> (= (ControlFlow 0 7) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))
