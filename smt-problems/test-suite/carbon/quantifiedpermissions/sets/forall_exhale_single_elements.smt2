...
(assert  (and (and (and (and (and (and (and (and (= (type QPMask@0) (MapType1Type RefType realType)) (= (type y@@6) RefType)) (= (type AssertMask@0) (MapType1Type RefType realType))) (= (type x@@19) RefType)) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv3 arg0@@43)) RefType)
...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 y@@6 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 y@@6 f_7))) (=> (= (ControlFlow 0 3) 2) anon6_correct))))))
(let ((anon4_correct  (=> (and (= AssertMask@0 (MapType1Store QPMask@0 x@@19 f_7 (real_2_U (- (U_2_real (MapType1Select QPMask@0 x@@19 f_7)) FullPerm)))) (state ExhaleHeap@0 QPMask@0)) (and (=> (= (ControlFlow 0 6) 3) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon4_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 x@@19 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 x@@19 f_7))) (=> (= (ControlFlow 0 7) 6) anon4_correct))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 12)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (U_2_bool (MapType2Select (|Set#Singleton| y@@6) z_1))) (U_2_bool (MapType2Select (|Set#Singleton| y@@6) z_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1))))
 :qid |stdinbpl.620:17|
 :skolemid |94|
 :pattern ( (neverTriggered3 z_1) (neverTriggered3 z_1_1))
))) (=> (forall ((z_1@@0 T@U) (z_1_1@@0 T@U) ) (!  (=> (and (= (type z_1@@0) RefType) (= (type z_1_1@@0) RefType)) (=> (and (and (and (and (not (= z_1@@0 z_1_1@@0)) (U_2_bool (MapType2Select (|Set#Singleton| y@@6) z_1@@0))) (U_2_bool (MapType2Select (|Set#Singleton| y@@6) z_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1@@0 z_1_1@@0))))
 :qid |stdinbpl.620:17|
 :skolemid |94|
 :pattern ( (neverTriggered3 z_1@@0) (neverTriggered3 z_1_1@@0))
)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((z_1@@1 T@U) ) (!  (=> (and (= (type z_1@@1) RefType) (U_2_bool (MapType2Select (|Set#Singleton| y@@6) z_1@@1))) (>= (U_2_real (MapType1Select Mask@1 z_1@@1 f_7)) FullPerm))
 :qid |stdinbpl.627:17|
 :skolemid |95|
 :pattern ( (MapType0Select Heap@@9 z_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@1 f_7))
 :pattern ( (MapType2Select (|Set#Singleton| y@@6) z_1@@1))
))) (=> (forall ((z_1@@2 T@U) ) (!  (=> (and (= (type z_1@@2) RefType) (U_2_bool (MapType2Select (|Set#Singleton| y@@6) z_1@@2))) (>= (U_2_real (MapType1Select Mask@1 z_1@@2 f_7)) FullPerm))
 :qid |stdinbpl.627:17|
 :skolemid |95|
 :pattern ( (MapType0Select Heap@@9 z_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@2 f_7))
 :pattern ( (MapType2Select (|Set#Singleton| y@@6) z_1@@2))
)) (=> (and (forall ((z_1@@3 T@U) ) (!  (=> (= (type z_1@@3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Singleton| y@@6) z_1@@3)) (< NoPerm FullPerm)) (and (qpRange3 z_1@@3) (= (invRecv3 z_1@@3) z_1@@3))))
 :qid |stdinbpl.633:22|
 :skolemid |96|
 :pattern ( (MapType0Select Heap@@9 z_1@@3 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@3 f_7))
 :pattern ( (MapType2Select (|Set#Singleton| y@@6) z_1@@3))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Singleton| y@@6) (invRecv3 o_3))) (and (< NoPerm FullPerm) (qpRange3 o_3))) (= (invRecv3 o_3) o_3)))
 :qid |stdinbpl.637:22|
 :skolemid |97|
 :pattern ( (invRecv3 o_3))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType2Select (|Set#Singleton| y@@6) (invRecv3 o_3@@0))) (and (< NoPerm FullPerm) (qpRange3 o_3@@0))) (and (= (invRecv3 o_3@@0) o_3@@0) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (- (U_2_real (MapType1Select Mask@1 o_3@@0 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select (|Set#Singleton| y@@6) (invRecv3 o_3@@0))) (and (< NoPerm FullPerm) (qpRange3 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select Mask@1 o_3@@0 f_7))))))
 :qid |stdinbpl.643:22|
 :skolemid |98|
...
))) (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 QPMask@0) (state ExhaleHeap@0 QPMask@0))) (and (=> (= (ControlFlow 0 10) 7) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct))))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 x@@19 $allocated)) (U_2_bool (MapType0Select Heap@@9 y@@6 $allocated))) (=> (and (and (and (not (= x@@19 null)) (= Mask@0 (MapType1Store ZeroMask x@@19 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@19 f_7)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (and (not (= y@@6 null)) (= Mask@1 (MapType1Store Mask@0 y@@6 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@6 f_7)) FullPerm))))) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1)))) (and (=> (= (ControlFlow 0 13) 1) anon7_Then_correct) (=> (= (ControlFlow 0 13) 10) anon7_Else_correct)))))))
