...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (Ctor RefType) 8)) (= (type tk) (FieldType NormalFieldType RefType))) (= (type f_7) (FieldType NormalFieldType intType))))
(assert (distinct $allocated tk f_7)
)
...
(assert  (not (IsPredicateField tk)))
(assert  (not (IsWandField tk)))
...
(assert  (and (and (and (and (and (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type freshObj@0) RefType)) (= (type Heap@2) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type m@@7) RefType)) (= (type Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon2_correct  (=> (= Mask@2 (MapType1Store Mask@1 freshObj@0 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 freshObj@0 f_7)) FullPerm)))) (=> (and (IdenticalOnKnownLocations Heap@2 ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 freshObj@0 f_7)) (=> (HasDirectPerm Mask@0 freshObj@0 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (MapType0Select Heap@1 freshObj@0 f_7)) 15)))))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 f_7))) (=> (= (ControlFlow 0 5) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 m@@7 $allocated))) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@9 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@9 freshObj@0 $allocated (bool_2_U true)))) (and (= Mask@0 (MapType1Store ZeroMask freshObj@0 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 f_7)) FullPerm)))) (state Heap@0 Mask@0))) (and (=> (= (ControlFlow 0 8) (- 0 18)) (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7))) (=> (= Heap@1 (MapType0Store Heap@0 freshObj@0 f_7 (int_2_U 15))) (=> (and (state Heap@1 Mask@0) (state Heap@1 Mask@0)) (and (=> (= (ControlFlow 0 8) (- 0 17)) (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7))) (=> (= Heap@2 (MapType0Store Heap@1 freshObj@0 f_7 (int_2_U 3))) (=> (and (state Heap@2 Mask@0) (not (= freshObj@0 null))) (=> (and (and (= Mask@1 (MapType1Store Mask@0 freshObj@0 tk (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@0 tk)) FullPerm)))) (state Heap@2 Mask@1)) (and (state Heap@2 Mask@1) (state Heap@2 Mask@1))) (and (=> (= (ControlFlow 0 8) (- 0 16)) (HasDirectPerm Mask@1 freshObj@0 f_7)) (=> (HasDirectPerm Mask@1 freshObj@0 f_7) (and (=> (= (ControlFlow 0 8) (- 0 15)) (= (U_2_int (MapType0Select Heap@2 freshObj@0 f_7)) 3)) (=> (= (U_2_int (MapType0Select Heap@2 freshObj@0 f_7)) 3) (and (=> (= (ControlFlow 0 8) (- 0 14)) true) (and (=> (= (ControlFlow 0 8) (- 0 13)) (HasDirectPerm Mask@0 freshObj@0 f_7)) (=> (HasDirectPerm Mask@0 freshObj@0 f_7) (and (=> (= (ControlFlow 0 8) (- 0 12)) (= (U_2_int (MapType0Select Heap@1 freshObj@0 f_7)) 15)) (=> (= (U_2_int (MapType0Select Heap@1 freshObj@0 f_7)) 15) (=> (state Heap@2 Mask@1) (and (=> (= (ControlFlow 0 8) (- 0 11)) (= (U_2_real (MapType1Select Mask@1 freshObj@0 tk)) FullPerm)) (=> (= (U_2_real (MapType1Select Mask@1 freshObj@0 tk)) FullPerm) (and (=> (= (ControlFlow 0 8) (- 0 10)) true) (and (=> (= (ControlFlow 0 8) (- 0 9)) (= (U_2_real (MapType1Select Mask@0 freshObj@0 tk)) NoPerm)) (=> (= (U_2_real (MapType1Select Mask@0 freshObj@0 tk)) NoPerm) (=> (state Heap@2 Mask@1) (and (=> (= (ControlFlow 0 8) 5) anon3_Then_correct) (=> (= (ControlFlow 0 8) 7) anon3_Else_correct)))))))))))))))))))))))))))))))
