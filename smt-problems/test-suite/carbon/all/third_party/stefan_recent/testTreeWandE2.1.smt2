...
(assert  (and (and (and (and (and (= (type t_1@@7) RefType) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@@41) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |Tree__sorted#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon7_correct true))
(let ((anon6_correct  (=> (= Mask@2 (MapType1Store Mask@1 null (Tree__state t_1@@7) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (Tree__state t_1@@7))) FullPerm)))) (=> (and (= Mask@3 Mask@2) (= (ControlFlow 0 5) 3)) anon7_correct))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon6_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (Tree__state t_1@@7))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (Tree__state t_1@@7)))) (=> (= (ControlFlow 0 6) 5) anon6_correct))))))
(let ((anon13_Then_correct  (=> (not (= t_1@@7 null)) (and (=> (= (ControlFlow 0 9) 6) anon14_Then_correct) (=> (= (ControlFlow 0 9) 8) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (= t_1@@7 null) (=> (and (= Mask@3 Mask@1) (= (ControlFlow 0 4) 3)) anon7_correct))))
(let ((anon15_Else_correct true))
(let ((anon15_Then_correct true))
(let ((anon2_correct  (=> (state Heap@@41 Mask@1) (and (and (and (=> (= (ControlFlow 0 10) 1) anon15_Then_correct) (=> (= (ControlFlow 0 10) 2) anon15_Else_correct)) (=> (= (ControlFlow 0 10) 9) anon13_Then_correct)) (=> (= (ControlFlow 0 10) 4) anon13_Else_correct)))))
(let ((anon11_Else_correct  (=> (= t_1@@7 null) (=> (and (= Mask@1 ZeroMask) (= (ControlFlow 0 12) 10)) anon2_correct))))
(let ((anon11_Then_correct  (=> (not (= t_1@@7 null)) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (Tree__state t_1@@7) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Tree__state t_1@@7))) FullPerm)))) (state Heap@@41 Mask@0)) (and (= Mask@1 Mask@0) (= (ControlFlow 0 11) 10))) anon2_correct))))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@41 t_1@@7 $allocated)) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 13) 11) anon11_Then_correct) (=> (= (ControlFlow 0 13) 12) anon11_Else_correct))))))
