...
(declare-fun |isArray#condqp1| (T@U T@U) Int)
...
(declare-fun isArray (T@U) T@U)
(declare-fun PredicateType_isArrayType () T@T)
(declare-fun |isArray#trigger| (T@U T@U) Bool)
(declare-fun |isArray#everUsed| (T@U) Bool)
(declare-fun |isArray#sm| (T@U) T@U)
...
(assert (forall ((Heap2Heap T@U) (Heap1Heap T@U) (xs T@U) ) (!  (=> (and (and (and (= (type Heap2Heap) (MapType0Type RefType)) (= (type Heap1Heap) (MapType0Type RefType))) (= (type xs) RefType)) (and (= (< NoPerm FullPerm) (< NoPerm FullPerm)) (=> (< NoPerm FullPerm) (= (U_2_int (MapType0Select Heap2Heap xs val)) (U_2_int (MapType0Select Heap1Heap xs val)))))) (= (|isArray#condqp1| Heap2Heap xs) (|isArray#condqp1| Heap1Heap xs)))
 :qid |stdinbpl.239:15|
 :skolemid |28|
 :pattern ( (|isArray#condqp1| Heap2Heap xs) (|isArray#condqp1| Heap1Heap xs) (succHeapTrans Heap2Heap Heap1Heap))
)))
...
(assert  (and (= (Ctor PredicateType_isArrayType) 12) (forall ((arg0@@25 T@U) ) (! (= (type (isArray arg0@@25)) (FieldType PredicateType_isArrayType FrameTypeType))
 :qid |funType:isArray|
 :pattern ( (isArray arg0@@25))
))))
(assert (forall ((xs@@0 T@U) ) (!  (=> (= (type xs@@0) RefType) (IsPredicateField (isArray xs@@0)))
 :qid |stdinbpl.209:15|
 :skolemid |23|
 :pattern ( (isArray xs@@0))
)))
(assert (forall ((Heap@@2 T@U) (xs@@1 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type xs@@1) RefType)) (|isArray#everUsed| (isArray xs@@1)))
 :qid |stdinbpl.228:15|
 :skolemid |27|
 :pattern ( (|isArray#trigger| Heap@@2 (isArray xs@@1)))
)))
...
(assert (forall ((xs@@2 T@U) (xs2 T@U) ) (!  (=> (and (and (= (type xs@@2) RefType) (= (type xs2) RefType)) (= (isArray xs@@2) (isArray xs2))) (= xs@@2 xs2))
 :qid |stdinbpl.219:15|
 :skolemid |25|
 :pattern ( (isArray xs@@2) (isArray xs2))
)))
(assert (forall ((arg0@@26 T@U) ) (! (= (type (|isArray#sm| arg0@@26)) (FieldType PredicateType_isArrayType (MapType1Type RefType boolType)))
 :qid |funType:isArray#sm|
 :pattern ( (|isArray#sm| arg0@@26))
)))
(assert (forall ((xs@@3 T@U) (xs2@@0 T@U) ) (!  (=> (and (and (= (type xs@@3) RefType) (= (type xs2@@0) RefType)) (= (|isArray#sm| xs@@3) (|isArray#sm| xs2@@0))) (= xs@@3 xs2@@0))
 :qid |stdinbpl.223:15|
 :skolemid |26|
 :pattern ( (|isArray#sm| xs@@3) (|isArray#sm| xs2@@0))
)))
...
(assert (forall ((xs@@4 T@U) ) (!  (=> (= (type xs@@4) RefType) (= (getPredWandId (isArray xs@@4)) 0))
 :qid |stdinbpl.213:15|
 :skolemid |24|
 :pattern ( (isArray xs@@4))
)))
...
(assert (forall ((xs@@5 T@U) ) (!  (=> (= (type xs@@5) RefType) (= (PredicateMaskField (isArray xs@@5)) (|isArray#sm| xs@@5)))
 :qid |stdinbpl.205:15|
 :skolemid |22|
 :pattern ( (PredicateMaskField (isArray xs@@5)))
)))
...
(assert  (and (= (type xs@@6) RefType) (= (type Heap@@10) (MapType0Type RefType))))
(set-info :boogie-vc-id |isArray#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((i_2 Int) (i_2_1 Int) ) (!  (=> (and (and (not (= i_2 i_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= xs@@6 xs@@6)))
 :qid |stdinbpl.262:15|
 :skolemid |29|
)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 xs@@6 $allocated))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
