...
(let ((anon11_Then_correct  (=> (and (and (and (state PostHeap@0 ZeroMask) (not (= diz@@19 null))) (and (= PostMask@0 (MapType1Store ZeroMask diz@@19 History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz@@19 History__x_hist_value)) FullPerm)))) (state PostHeap@0 PostMask@0))) (and (and (state PostHeap@0 PostMask@0) (not (= diz@@19 null))) (and (= PostMask@1 (MapType1Store PostMask@0 diz@@19 History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select PostMask@0 diz@@19 History__x_hist_mode)) FullPerm)))) (state PostHeap@0 PostMask@1)))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (HasDirectPerm PostMask@1 diz@@19 History__x_hist_mode)) (=> (HasDirectPerm PostMask@1 diz@@19 History__x_hist_mode) (=> (and (= (U_2_int (MapType0Select PostHeap@0 diz@@19 History__x_hist_mode)) 0) (state PostHeap@0 PostMask@1)) (=> (and (and (and (not (= diz@@19 null)) (= PostMask@2 (MapType1Store PostMask@1 diz@@19 History__x_hist_init (real_2_U (+ (U_2_real (MapType1Select PostMask@1 diz@@19 History__x_hist_init)) FullPerm))))) (and (state PostHeap@0 PostMask@2) (state PostHeap@0 PostMask@2))) (and (and (not (= diz@@19 null)) (= PostMask@3 (MapType1Store PostMask@2 diz@@19 History__x_hist_act (real_2_U (+ (U_2_real (MapType1Select PostMask@2 diz@@19 History__x_hist_act)) FullPerm))))) (and (state PostHeap@0 PostMask@3) (state PostHeap@0 PostMask@3)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (HasDirectPerm PostMask@3 diz@@19 History__x_hist_value)) (=> (HasDirectPerm PostMask@3 diz@@19 History__x_hist_value) (and (=> (= (ControlFlow 0 2) (- 0 6)) (HasDirectPerm Mask@2 diz@@19 History__x_hist_value)) (=> (HasDirectPerm Mask@2 diz@@19 History__x_hist_value) (=> (and (= (U_2_int (MapType0Select PostHeap@0 diz@@19 History__x_hist_value)) (U_2_int (MapType0Select Heap@@19 diz@@19 History__x_hist_value))) (state PostHeap@0 PostMask@3)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm PostMask@3 diz@@19 History__x_hist_init)) (=> (HasDirectPerm PostMask@3 diz@@19 History__x_hist_init) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@2 diz@@19 History__x_hist_value)) (=> (HasDirectPerm Mask@2 diz@@19 History__x_hist_value) (=> (and (= (U_2_int (MapType0Select PostHeap@0 diz@@19 History__x_hist_init)) (U_2_int (MapType0Select Heap@@19 diz@@19 History__x_hist_value))) (state PostHeap@0 PostMask@3)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm PostMask@3 diz@@19 History__x_hist_value)) (=> (HasDirectPerm PostMask@3 diz@@19 History__x_hist_value) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@2 diz@@19 History__x_hist_init)))))))))))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@19 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@19 diz@@19 $allocated)) (not (= diz@@19 null))) (and (state Heap@@19 ZeroMask) (>= current_thread_id 0))) (=> (and (and (and (state Heap@@19 ZeroMask) (not (= diz@@19 null))) (and (= Mask@0 (MapType1Store ZeroMask diz@@19 History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz@@19 History__x_hist_value)) FullPerm)))) (state Heap@@19 Mask@0))) (and (and (state Heap@@19 Mask@0) (not (= diz@@19 null))) (and (= Mask@1 (MapType1Store Mask@0 diz@@19 History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select Mask@0 diz@@19 History__x_hist_mode)) FullPerm)))) (state Heap@@19 Mask@1)))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm Mask@1 diz@@19 History__x_hist_mode)) (=> (HasDirectPerm Mask@1 diz@@19 History__x_hist_mode) (=> (and (= (U_2_int (MapType0Select Heap@@19 diz@@19 History__x_hist_mode)) 1) (state Heap@@19 Mask@1)) (=> (and (and (not (= diz@@19 null)) (= Mask@2 (MapType1Store Mask@1 diz@@19 History__x_hist_init (real_2_U (+ (U_2_real (MapType1Select Mask@1 diz@@19 History__x_hist_init)) FullPerm))))) (and (state Heap@@19 Mask@2) (state Heap@@19 Mask@2))) (and (=> (= (ControlFlow 0 10) 2) anon11_Then_correct) (=> (= (ControlFlow 0 10) 9) anon11_Else_correct)))))))))))
