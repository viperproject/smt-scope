...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@14 x@@34 $allocated))) (and (= perm@0 (- 0.0 FullPerm)) (= (ControlFlow 0 2) (- 0 1)))) (>= perm@0 NoPerm)))))
