...
(let ((anon6_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i_2))) (= (ControlFlow 0 7) 2)) anon3_correct)))
(let ((anon6_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i_2)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 3) (- 0 5)) (< i_2 (|Seq#Length| s@@17))) (=> (< i_2 (|Seq#Length| s@@17)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm Mask@1 (|Seq#Index| s@@17 i_2) f_7)) (=> (HasDirectPerm Mask@1 (|Seq#Index| s@@17 i_2) f_7) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))))))
