...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (Cons (int_2_U 1) (Nil intType)) (Cons (int_2_U 1) (Nil intType)))) (=> (= (Cons (int_2_U 1) (Nil intType)) (Cons (int_2_U 1) (Nil intType))) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (get_List_tail (Cons (int_2_U 1) (Cons (int_2_U 1) (Nil intType)))) (Cons (int_2_U 1) (Nil intType)))))))))
