...
(assert  (and (and (and (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type x@@8) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type y@@1) RefType)) (= (type Heap@1) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon2_correct  (=> (and (state Heap@@9 Mask@2) (state Heap@@9 Mask@2)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= FullPerm (U_2_real (MapType1Select Mask@2 x@@8 val)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@2 x@@8 val))) (=> (and (= Heap@0 (MapType0Store Heap@@9 x@@8 val (int_2_U 4))) (state Heap@0 Mask@2)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= FullPerm (U_2_real (MapType1Select Mask@2 y@@1 val)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@2 y@@1 val))) (=> (and (= Heap@1 (MapType0Store Heap@0 y@@1 val (int_2_U 3))) (state Heap@1 Mask@2)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@2 x@@8 val)) (=> (HasDirectPerm Mask@2 x@@8 val) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (MapType0Select Heap@1 x@@8 val)) 4)))))))))))))
(let ((anon3_Else_correct  (=> (= x@@8 y@@1) (=> (and (= Mask@2 Mask@0) (= (ControlFlow 0 7) 2)) anon2_correct))))
(let ((anon3_Then_correct  (=> (and (not (= x@@8 y@@1)) (not (= y@@1 null))) (=> (and (and (= Mask@1 (MapType1Store Mask@0 y@@1 val (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@1 val)) FullPerm)))) (state Heap@@9 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 6) 2))) anon2_correct))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@9 y@@1 $allocated)) (not (= x@@8 null))) (and (= Mask@0 (MapType1Store ZeroMask x@@8 val (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 val)) FullPerm)))) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 8) 6) anon3_Then_correct) (=> (= (ControlFlow 0 8) 7) anon3_Else_correct))))))
