...
(assert  (and (forall ((arg0@@25 T@U) (arg1@@9 T@U) ) (! (= (type (|foo'| arg0@@25 arg1@@9)) RefType)
 :qid |funType:foo'|
 :pattern ( (|foo'| arg0@@25 arg1@@9))
)) (forall ((arg0@@26 T@U) ) (! (= (type (|foo#triggerStateless| arg0@@26)) RefType)
 :qid |funType:foo#triggerStateless|
 :pattern ( (|foo#triggerStateless| arg0@@26))
))))
(assert (forall ((Heap@@2 T@U) (this T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type this) RefType)) (dummyFunction (|foo#triggerStateless| this)))
 :qid |stdinbpl.189:15|
 :skolemid |23|
 :pattern ( (|foo'| Heap@@2 this))
)))
...
(assert (forall ((arg0@@27 T@U) (arg1@@10 T@U) ) (! (= (type (foo arg0@@27 arg1@@10)) RefType)
 :qid |funType:foo|
 :pattern ( (foo arg0@@27 arg1@@10))
)))
(assert (forall ((Heap@@4 T@U) (this@@0 T@U) ) (!  (=> (and (= (type Heap@@4) (MapType0Type RefType)) (= (type this@@0) RefType)) (and (= (foo Heap@@4 this@@0) (|foo'| Heap@@4 this@@0)) (dummyFunction (|foo#triggerStateless| this@@0))))
 :qid |stdinbpl.185:15|
 :skolemid |22|
 :pattern ( (foo Heap@@4 this@@0))
)))
...
(assert (forall ((arg0@@29 T@U) (arg1@@12 T@U) ) (! (= (type (|foo#frame| arg0@@29 arg1@@12)) RefType)
 :qid |funType:foo#frame|
 :pattern ( (|foo#frame| arg0@@29 arg1@@12))
)))
(assert (forall ((Heap@@9 T@U) (Mask@@9 T@U) (this@@1 T@U) ) (!  (=> (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (= (type this@@1) RefType)) (state Heap@@9 Mask@@9)) (= (|foo'| Heap@@9 this@@1) (|foo#frame| EmptyFrame this@@1)))
 :qid |stdinbpl.202:15|
 :skolemid |25|
 :pattern ( (state Heap@@9 Mask@@9) (|foo'| Heap@@9 this@@1))
)))
...
(assert (forall ((Heap@@12 T@U) (Mask@@10 T@U) (this@@2 T@U) ) (!  (=> (and (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type this@@2) RefType)) (and (state Heap@@12 Mask@@10) (< AssumeFunctionsAbove 0))) (= (foo Heap@@12 this@@2) this@@2))
 :qid |stdinbpl.195:15|
 :skolemid |24|
 :pattern ( (state Heap@@12 Mask@@10) (foo Heap@@12 this@@2))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
