...
(declare-fun b_2 () T@U)
(declare-fun a_2 () T@U)
(assert  (and (and (= (type a_2) RefType) (= (type Heap@@10) (MapType0Type RefType))) (= (type b_2) RefType)))
(set-info :boogie-vc-id t4)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon4_correct true))
(let ((anon3_correct  (=> (and (state Heap@@10 ZeroMask) (= (ControlFlow 0 3) 1)) anon4_correct)))
(let ((anon6_Else_correct  (=> (and (= b_2 null) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (not (= b_2 null)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= a_2 b_2))) (=> (not (= a_2 b_2)) (=> (and (state Heap@@10 ZeroMask) (= (ControlFlow 0 4) 3)) anon3_correct))))))
(let ((anon5_Then_correct  (=> (= a_2 null) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (not (= a_2 null)) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 a_2 $allocated)) (U_2_bool (MapType0Select Heap@@10 b_2 $allocated))) (and (=> (= (ControlFlow 0 8) 7) anon5_Then_correct) (=> (= (ControlFlow 0 8) 2) anon5_Else_correct))))))
