...
(assert  (and (and (= (type s@@3) (MapType2Type RefType boolType)) (= (type x@@19) RefType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id m2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (not (U_2_bool (MapType2Select s@@3 x@@19))) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (U_2_bool (MapType2Select s@@3 x@@19)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= x@@19 null))) (=> (not (= x@@19 null)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select s@@3 x_1))) (U_2_bool (MapType2Select s@@3 x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.613:15|
 :skolemid |94|
 :no-pattern (type x_1)
...
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (> (|Set#Card| s@@3) 0) (state Heap@@9 ZeroMask)) (and (not (U_2_bool (MapType2Select s@@3 null))) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 7) 2) anon5_Else_correct) (=> (= (ControlFlow 0 7) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))
