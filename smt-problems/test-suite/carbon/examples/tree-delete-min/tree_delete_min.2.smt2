...
(let ((anon20_correct  (=> (and (state Heap@5 Mask@0) (= (ControlFlow 0 11) 9)) anon21_correct)))
(let ((anon29_Else_correct  (=> (and (not (= x@@25 null)) (= Heap@0 (MapType0Store Heap@@18 null (|Tree#sm| x@@25) (MapType1Store (MapType0Select Heap@@18 null (|Tree#sm| x@@25)) x@@25 v_2 (bool_2_U true))))) (=> (and (and (and (= Heap@1 (MapType0Store Heap@0 null (|Tree#sm| x@@25) (MapType1Store (MapType0Select Heap@0 null (|Tree#sm| x@@25)) x@@25 l (bool_2_U true)))) (forall ((o_5 T@U) (f_9 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_9))))
(let ((A@@12 (FieldTypeInv0 (type f_9))))
 (=> (and (and (= (type o_5) RefType) (= (type f_9) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|Tree#sm| x@@25)) o_5 f_9)) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|Tree#sm| (MapType0Select Heap@1 x@@25 l))) o_5 f_9)))) (U_2_bool (MapType1Select newPMask@0 o_5 f_9)))))
 :qid |stdinbpl.879:35|
 :skolemid |75|
 :pattern ( (MapType1Select newPMask@0 o_5 f_9))
))) (and (= Heap@2 (MapType0Store Heap@1 null (|Tree#sm| x@@25) newPMask@0)) (= Heap@3 (MapType0Store Heap@2 null (|Tree#sm| x@@25) (MapType1Store (MapType0Select Heap@2 null (|Tree#sm| x@@25)) x@@25 r_1 (bool_2_U true)))))) (and (and (forall ((o_6 T@U) (f_10 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_10))))
(let ((A@@13 (FieldTypeInv0 (type f_10))))
 (=> (and (and (= (type o_6) RefType) (= (type f_10) (FieldType A@@13 B@@12))) (or (U_2_bool (MapType1Select (MapType0Select Heap@3 null (|Tree#sm| x@@25)) o_6 f_10)) (U_2_bool (MapType1Select (MapType0Select Heap@3 null (|Tree#sm| (MapType0Select Heap@3 x@@25 r_1))) o_6 f_10)))) (U_2_bool (MapType1Select newPMask@1 o_6 f_10)))))
 :qid |stdinbpl.886:35|
 :skolemid |76|
 :pattern ( (MapType1Select newPMask@1 o_6 f_10))
)) (= Heap@4 (MapType0Store Heap@3 null (|Tree#sm| x@@25) newPMask@1))) (and (= Heap@5 Heap@4) (= (ControlFlow 0 13) 11)))) anon20_correct))))
(let ((anon29_Then_correct  (=> (= x@@25 null) (=> (and (= Heap@5 Heap@@18) (= (ControlFlow 0 12) 11)) anon20_correct))))
(let ((anon27_Else_correct  (=> (|vals#trigger| (MapType0Select Heap@@18 null (Tree (MapType0Select Heap@@18 x@@25 r_1))) (MapType0Select Heap@@18 x@@25 r_1)) (and (=> (= (ControlFlow 0 14) 12) anon29_Then_correct) (=> (= (ControlFlow 0 14) 13) anon29_Else_correct)))))
(let ((anon22_Then_correct  (=> (and (= x@@25 null) (= (ControlFlow 0 10) 9)) anon21_correct)))
(let ((anon15_correct true))
(let ((anon28_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon15_correct)))
(let ((anon28_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@6 null (Tree (MapType0Select Heap@@18 x@@25 r_1)))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@6 null (Tree (MapType0Select Heap@@18 x@@25 r_1))))) (=> (= (ControlFlow 0 6) 5) anon15_correct))))))
(let ((anon25_Else_correct  (=> (|vals#trigger| (MapType0Select Heap@@18 null (Tree (MapType0Select Heap@@18 x@@25 l))) (MapType0Select Heap@@18 x@@25 l)) (and (=> (= (ControlFlow 0 15) (- 0 17)) (HasDirectPerm UnfoldingMask@6 x@@25 v_2)) (=> (HasDirectPerm UnfoldingMask@6 x@@25 v_2) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm UnfoldingMask@6 x@@25 r_1)) (=> (HasDirectPerm UnfoldingMask@6 x@@25 r_1) (and (and (=> (= (ControlFlow 0 15) 14) anon27_Else_correct) (=> (= (ControlFlow 0 15) 6) anon28_Then_correct)) (=> (= (ControlFlow 0 15) 8) anon28_Else_correct)))))))))
(let ((anon10_correct true))
(let ((anon26_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon10_correct)))
(let ((anon26_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@6 null (Tree (MapType0Select Heap@@18 x@@25 l)))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@6 null (Tree (MapType0Select Heap@@18 x@@25 l))))) (=> (= (ControlFlow 0 2) 1) anon10_correct))))))
(let ((anon7_correct  (=> (state Heap@@18 UnfoldingMask@6) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm UnfoldingMask@6 x@@25 l)) (=> (HasDirectPerm UnfoldingMask@6 x@@25 l) (and (and (=> (= (ControlFlow 0 18) 15) anon25_Else_correct) (=> (= (ControlFlow 0 18) 2) anon26_Then_correct)) (=> (= (ControlFlow 0 18) 4) anon26_Else_correct)))))))
(let ((anon24_Else_correct  (=> (and (not (= x@@25 null)) (not (= x@@25 null))) (=> (and (and (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x@@25 v_2 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@25 v_2)) FullPerm)))) (state Heap@@18 UnfoldingMask@1)) (and (not (= x@@25 null)) (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 x@@25 l (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 x@@25 l)) FullPerm)))))) (and (and (state Heap@@18 UnfoldingMask@2) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 null (Tree (MapType0Select Heap@@18 x@@25 l)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 null (Tree (MapType0Select Heap@@18 x@@25 l)))) FullPerm))))) (and (InsidePredicate (Tree x@@25) (MapType0Select Heap@@18 null (Tree x@@25)) (Tree (MapType0Select Heap@@18 x@@25 l)) (MapType0Select Heap@@18 null (Tree (MapType0Select Heap@@18 x@@25 l)))) (state Heap@@18 UnfoldingMask@3)))) (and (and (and (not (= x@@25 null)) (= UnfoldingMask@4 (MapType1Store UnfoldingMask@3 x@@25 r_1 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@3 x@@25 r_1)) FullPerm))))) (and (state Heap@@18 UnfoldingMask@4) (= UnfoldingMask@5 (MapType1Store UnfoldingMask@4 null (Tree (MapType0Select Heap@@18 x@@25 r_1)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@4 null (Tree (MapType0Select Heap@@18 x@@25 r_1)))) FullPerm)))))) (and (and (InsidePredicate (Tree x@@25) (MapType0Select Heap@@18 null (Tree x@@25)) (Tree (MapType0Select Heap@@18 x@@25 r_1)) (MapType0Select Heap@@18 null (Tree (MapType0Select Heap@@18 x@@25 r_1)))) (state Heap@@18 UnfoldingMask@5)) (and (= UnfoldingMask@6 UnfoldingMask@5) (= (ControlFlow 0 21) 18))))) anon7_correct))))
(let ((anon24_Then_correct  (=> (= x@@25 null) (=> (and (= UnfoldingMask@6 UnfoldingMask@0) (= (ControlFlow 0 20) 18)) anon7_correct))))
(let ((anon4_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (Tree x@@25) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (Tree x@@25))) FullPerm)))) (and (=> (= (ControlFlow 0 22) 20) anon24_Then_correct) (=> (= (ControlFlow 0 22) 21) anon24_Else_correct)))))
(let ((anon23_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 25) 22)) anon4_correct)))
(let ((anon23_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Tree x@@25))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Tree x@@25)))) (=> (= (ControlFlow 0 23) 22) anon4_correct))))))
(let ((anon22_Else_correct  (=> (not (= x@@25 null)) (=> (and (|Tree#trigger| Heap@@18 (Tree x@@25)) (= (MapType0Select Heap@@18 null (Tree x@@25)) (FrameFragment (ite (= x@@25 null) EmptyFrame (CombineFrames (FrameFragment (MapType0Select Heap@@18 x@@25 v_2)) (CombineFrames (FrameFragment (MapType0Select Heap@@18 x@@25 l)) (CombineFrames (MapType0Select Heap@@18 null (Tree (MapType0Select Heap@@18 x@@25 l))) (CombineFrames (FrameFragment (MapType0Select Heap@@18 x@@25 r_1)) (MapType0Select Heap@@18 null (Tree (MapType0Select Heap@@18 x@@25 r_1))))))))))) (and (=> (= (ControlFlow 0 26) 23) anon23_Then_correct) (=> (= (ControlFlow 0 26) 25) anon23_Else_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@18 ZeroMask) (U_2_bool (MapType0Select Heap@@18 x@@25 $allocated))) (=> (and (and (= AssumeFunctionsAbove 0) (= Mask@0 (MapType1Store ZeroMask null (Tree x@@25) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Tree x@@25))) FullPerm))))) (and (state Heap@@18 Mask@0) (state Heap@@18 Mask@0))) (and (=> (= (ControlFlow 0 27) 10) anon22_Then_correct) (=> (= (ControlFlow 0 27) 26) anon22_Else_correct))))))
