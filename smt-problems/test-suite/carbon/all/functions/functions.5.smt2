...
(assert  (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type x@@56) RefType)) (= (type Heap@@47) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |fun6#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon4_correct true))
(let ((anon6_Else_correct  (=> (and (not b_2@@3) (= (ControlFlow 0 4) 1)) anon4_correct)))
(let ((anon6_Then_correct  (=> b_2@@3 (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 x@@56 f_7)) (=> (HasDirectPerm Mask@1 x@@56 f_7) (=> (= (ControlFlow 0 2) 1) anon4_correct))))))
(let ((anon2_correct  (=> (state Heap@@47 Mask@1) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (not b_2@@3) (=> (and (= Mask@1 ZeroMask) (= (ControlFlow 0 7) 5)) anon2_correct))))
(let ((anon5_Then_correct  (=> (and b_2@@3 (not (= x@@56 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask x@@56 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@56 f_7)) FullPerm)))) (state Heap@@47 Mask@0)) (and (= Mask@1 Mask@0) (= (ControlFlow 0 6) 5))) anon2_correct))))
(let ((anon0_correct  (=> (state Heap@@47 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@47 x@@56 $allocated)) (= AssumeFunctionsAbove 5)) (and (=> (= (ControlFlow 0 8) 6) anon5_Then_correct) (=> (= (ControlFlow 0 8) 7) anon5_Else_correct))))))
