...
(let ((anon27_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 18) 15)) anon17_correct)))
(let ((anon27_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= FullPerm (U_2_real (MapType1Select Mask@3 null (valid y@@1))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 null (valid y@@1)))) (=> (= (ControlFlow 0 16) 15) anon17_correct))))))
(let ((anon26_Else_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (= j@0 (itemAt ExhaleHeap@0 y@@1 0)))))
(let ((anon24_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (= i@0 (itemAt ExhaleHeap@0 x@@8 0))) (=> (= i@0 (itemAt ExhaleHeap@0 x@@8 0)) (=> (state ExhaleHeap@0 Mask@3) (and (and (=> (= (ControlFlow 0 19) 14) anon26_Else_correct) (=> (= (ControlFlow 0 19) 16) anon27_Then_correct)) (=> (= (ControlFlow 0 19) 18) anon27_Else_correct)))))))
(let ((anon13_correct true))
(let ((anon25_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon13_correct)))
(let ((anon25_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@3 null (valid x@@8))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 null (valid x@@8)))) (=> (= (ControlFlow 0 10) 9) anon13_correct))))))
(let ((anon10_correct  (=> (and (= Mask@2 (MapType1Store Mask@1 null (valid y@@1) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (valid y@@1))) FullPerm)))) (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@0 Mask@2)) (=> (and (and (= Mask@3 (MapType1Store Mask@2 null (valid y@@1) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (valid y@@1))) FullPerm)))) (state ExhaleHeap@0 Mask@3)) (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3))) (and (and (=> (= (ControlFlow 0 21) 19) anon24_Else_correct) (=> (= (ControlFlow 0 21) 10) anon25_Then_correct)) (=> (= (ControlFlow 0 21) 12) anon25_Else_correct))))))
(let ((anon23_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 24) 21)) anon10_correct)))
(let ((anon23_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (valid y@@1))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (valid y@@1)))) (=> (= (ControlFlow 0 22) 21) anon10_correct))))))
(let ((anon21_Else_correct  (=> (and (= j@0 (itemAt Heap@@14 y@@1 0)) (state Heap@@14 Mask@1)) (and (=> (= (ControlFlow 0 25) 22) anon23_Then_correct) (=> (= (ControlFlow 0 25) 24) anon23_Else_correct)))))
(let ((anon7_correct true))
(let ((anon22_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon7_correct)))
(let ((anon22_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (valid y@@1))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (valid y@@1)))) (=> (= (ControlFlow 0 6) 5) anon7_correct))))))
(let ((anon19_Else_correct  (=> (and (= i@0 (itemAt Heap@@14 x@@8 0)) (state Heap@@14 Mask@1)) (and (and (=> (= (ControlFlow 0 26) 25) anon21_Else_correct) (=> (= (ControlFlow 0 26) 6) anon22_Then_correct)) (=> (= (ControlFlow 0 26) 8) anon22_Else_correct)))))
(let ((anon3_correct true))
(let ((anon20_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon20_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (valid x@@8))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (valid x@@8)))) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@14 this@@9 $allocated))) (and (U_2_bool (MapType0Select Heap@@14 x@@8 $allocated)) (U_2_bool (MapType0Select Heap@@14 y@@1 $allocated)))) (=> (and (and (and (not (= x@@8 null)) (not (= y@@1 null))) (and (not (= x@@8 y@@1)) (= Mask@0 (MapType1Store ZeroMask null (valid x@@8) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid x@@8))) FullPerm)))))) (and (and (state Heap@@14 Mask@0) (= Mask@1 (MapType1Store Mask@0 null (valid y@@1) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (valid y@@1))) FullPerm))))) (and (state Heap@@14 Mask@1) (state Heap@@14 Mask@1)))) (and (and (=> (= (ControlFlow 0 27) 26) anon19_Else_correct) (=> (= (ControlFlow 0 27) 2) anon20_Then_correct)) (=> (= (ControlFlow 0 27) 4) anon20_Else_correct)))))))
