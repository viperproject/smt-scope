...
(assert  (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type Ops_11Heap@0) (MapType0Type RefType))) (= (type Used_11Heap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type Used_10Heap@0) (MapType0Type RefType))))
...
(let ((anon15_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (wand_5 true)))))))
(let ((anon5_correct  (=> (= b_16@2  (and b_16 (state Ops_11Heap@0 ZeroMask))) (=> (and (= b_16@3  (and b_16@2 (state Ops_11Heap@0 ZeroMask))) (= b_17@0  (and b_17 (state Used_11Heap@0 ZeroMask)))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (wand_4 true) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (wand_4 true))) FullPerm)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (and (and (=> (= (ControlFlow 0 6) 2) anon15_Else_correct) (=> (= (ControlFlow 0 6) 3) anon16_Else_correct)) (=> (= (ControlFlow 0 6) 4) anon17_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon17_Else_correct)))))))
(let ((anon4_correct  (=> (and (= b_16@1  (and b_16 (forall ((x_3 Int) (y_3 Int) ) (! (f2 x_3 y_3)
 :qid |stdinbpl.1525:31|
 :skolemid |161|
 :pattern ( (f2 x_3 y_3))
)))) (= (ControlFlow 0 8) 6)) anon5_correct)))
(let ((anon13_Else_correct  (=> (and (not b_16@0) (= (ControlFlow 0 10) 8)) anon4_correct)))
(let ((anon13_Then_correct  (=> (and b_16@0 (= (ControlFlow 0 9) 8)) anon4_correct)))
(let ((anon12_Then_correct  (=> b_16@0 (and (=> (= (ControlFlow 0 11) 9) anon13_Then_correct) (=> (= (ControlFlow 0 11) 10) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (not b_16@0) (= (ControlFlow 0 7) 6)) anon5_correct)))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= b_16@0  (and b_16 (state Ops_11Heap@0 ZeroMask))) (= b_15@0  (and b_15 (state Used_10Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 12) 11) anon12_Then_correct) (=> (= (ControlFlow 0 12) 7) anon12_Else_correct))))))
