...
(declare-fun m@@7 (T@U Int) Int)
(declare-fun AssumeFunctionsAbove () Int)
(declare-fun f_6 (T@U Int Int) Bool)
...
(declare-fun |m'| (T@U Int) Int)
(declare-fun |m#triggerStateless| (Int) Int)
...
(declare-fun |m#frame| (T@U Int) Int)
...
(assert (forall ((Heap@@1 T@U) (Mask@@1 T@U) (a_2@@0 Int) ) (!  (=> (and (and (and (= (type Heap@@1) (MapType0Type RefType)) (= (type Mask@@1) (MapType1Type RefType realType))) (and (state Heap@@1 Mask@@1) (< AssumeFunctionsAbove 0))) (forall ((b_2@@0 Int) ) (! (f_6 Heap@@1 a_2@@0 b_2@@0)
 :qid |stdinbpl.238:61|
 :skolemid |27|
 :pattern ( (|f#frame| EmptyFrame a_2@@0 b_2@@0))
))) (= (m@@7 Heap@@1 a_2@@0) 14))
 :qid |stdinbpl.236:15|
 :skolemid |28|
 :pattern ( (state Heap@@1 Mask@@1) (m@@7 Heap@@1 a_2@@0))
)))
(assert (forall ((Heap@@2 T@U) (a_2@@1 Int) (b_2@@1 Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (bool_2_U (|f#triggerStateless| a_2@@1 b_2@@1))))
 :qid |stdinbpl.190:15|
 :skolemid |23|
 :pattern ( (|f'| Heap@@2 a_2@@1 b_2@@1))
)))
...
(assert (forall ((Heap@@5 T@U) (a_2@@2 Int) ) (!  (=> (= (type Heap@@5) (MapType0Type RefType)) (dummyFunction (int_2_U (|m#triggerStateless| a_2@@2))))
 :qid |stdinbpl.230:15|
 :skolemid |26|
 :pattern ( (|m'| Heap@@5 a_2@@2))
)))
...
(assert (forall ((Heap@@7 T@U) (a_2@@3 Int) ) (!  (=> (= (type Heap@@7) (MapType0Type RefType)) (and (= (m@@7 Heap@@7 a_2@@3) (|m'| Heap@@7 a_2@@3)) (dummyFunction (int_2_U (|m#triggerStateless| a_2@@3)))))
 :qid |stdinbpl.226:15|
 :skolemid |25|
 :pattern ( (m@@7 Heap@@7 a_2@@3))
)))
...
(assert (forall ((Heap@@12 T@U) (Mask@@11 T@U) (a_2@@4 Int) ) (!  (=> (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (state Heap@@12 Mask@@11)) (= (|m'| Heap@@12 a_2@@4) (|m#frame| EmptyFrame a_2@@4)))
 :qid |stdinbpl.246:15|
 :skolemid |29|
 :pattern ( (state Heap@@12 Mask@@11) (|m'| Heap@@12 a_2@@4))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@15 T@U) (a_2@@5 Int) (b_2@@2 Int) ) (!  (=> (= (type Heap@@15) (MapType0Type RefType)) (and (= (f_6 Heap@@15 a_2@@5 b_2@@2) (|f'| Heap@@15 a_2@@5 b_2@@2)) (dummyFunction (bool_2_U (|f#triggerStateless| a_2@@5 b_2@@2)))))
 :qid |stdinbpl.186:15|
 :skolemid |22|
 :pattern ( (f_6 Heap@@15 a_2@@5 b_2@@2))
)))
(push 1)
...
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (f_6 Heap@@16 3 b_2@@3))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (and (state Heap@@16 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (and (=> (= (ControlFlow 0 5) 1) anon5_Else_correct) (=> (= (ControlFlow 0 5) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
