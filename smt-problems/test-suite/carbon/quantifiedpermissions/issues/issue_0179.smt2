...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type xs@0) (MapType2Type RefType boolType)) (= (type y_5) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type x2) RefType)) (= (type x1@@7) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv3 arg0@@43)) RefType)
 :qid |funType:invRecv3|
 :pattern ( (invRecv3 arg0@@43))
))) (= (type xs) (MapType2Type RefType boolType))) (= (type y@@6) RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv2 arg0@@44)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon6_correct true))
(let ((anon16_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs y@@6))) (= (ControlFlow 0 14) 11)) anon6_correct)))
(let ((anon16_Then_correct  (=> (U_2_bool (MapType2Select xs y@@6)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm QPMask@1 y@@6 val)) (=> (HasDirectPerm QPMask@1 y@@6 val) (=> (= (ControlFlow 0 12) 11) anon6_correct))))))
(let ((anon15_Else_correct true))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((y_1 T@U) (y_1_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (= (type y_1_1) RefType)) (=> (and (and (and (and (not (= y_1 y_1_1)) (U_2_bool (MapType2Select xs y_1))) (U_2_bool (MapType2Select xs y_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_1 y_1_1))))
 :qid |stdinbpl.607:15|
 :skolemid |89|
 :no-pattern (type y_1)
...
)) (=> (forall ((y_1@@1 T@U) ) (!  (=> (= (type y_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs y_1@@1)) (< NoPerm FullPerm)) (and (qpRange2 y_1@@1) (= (invRecv2 y_1@@1) y_1@@1))))
 :qid |stdinbpl.613:22|
 :skolemid |90|
 :pattern ( (MapType0Select PostHeap@0 y_1@@1 val))
 :pattern ( (MapType1Select QPMask@1 y_1@@1 val))
 :pattern ( (MapType2Select xs y_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv2 o_3))) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.617:22|
 :skolemid |91|
 :pattern ( (invRecv2 o_3))
)) (forall ((y_1@@2 T@U) ) (!  (=> (and (= (type y_1@@2) RefType) (U_2_bool (MapType2Select xs y_1@@2))) (not (= y_1@@2 null)))
 :qid |stdinbpl.623:22|
 :skolemid |92|
 :pattern ( (MapType0Select PostHeap@0 y_1@@2 val))
 :pattern ( (MapType1Select QPMask@1 y_1@@2 val))
 :pattern ( (MapType2Select xs y_1@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select xs (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.629:22|
 :skolemid |93|
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 val))) (= (U_2_real (MapType1Select ZeroMask o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@1 o_3@@1 f_5))))))
 :qid |stdinbpl.633:29|
 :skolemid |94|
 :pattern ( (MapType1Select ZeroMask o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@1 o_3@@1 f_5))
))) (and (state PostHeap@0 QPMask@1) (state PostHeap@0 QPMask@1))) (and (and (=> (= (ControlFlow 0 15) 10) anon15_Else_correct) (=> (= (ControlFlow 0 15) 12) anon16_Then_correct)) (=> (= (ControlFlow 0 15) 14) anon16_Else_correct)))))))))
(let ((anon14_Then_correct true))
(let ((anon13_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 17) 9) anon14_Then_correct) (=> (= (ControlFlow 0 17) 15) anon14_Else_correct)))))
(let ((anon11_correct true))
(let ((anon18_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs@0 y_5))) (= (ControlFlow 0 5) 2)) anon11_correct)))
(let ((anon18_Then_correct  (=> (U_2_bool (MapType2Select xs@0 y_5)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (> (U_2_int (MapType0Select Heap@@9 y_5 val)) 0)) (=> (> (U_2_int (MapType0Select Heap@@9 y_5 val)) 0) (=> (= (ControlFlow 0 3) 2) anon11_correct))))))
(let ((anon17_Else_correct true))
(let ((anon13_Else_correct  (=> (and (= xs@0 (|Set#UnionOne| (|Set#Singleton| x2) x1@@7)) (state Heap@@9 Mask@1)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (forall ((y_4 T@U) (y_4_1 T@U) ) (!  (=> (and (= (type y_4) RefType) (= (type y_4_1) RefType)) (=> (and (and (and (and (not (= y_4 y_4_1)) (U_2_bool (MapType2Select xs@0 y_4))) (U_2_bool (MapType2Select xs@0 y_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_4 y_4_1))))
 :qid |stdinbpl.672:17|
 :skolemid |96|
 :pattern ( (neverTriggered3 y_4) (neverTriggered3 y_4_1))
))) (=> (forall ((y_4@@0 T@U) (y_4_1@@0 T@U) ) (!  (=> (and (= (type y_4@@0) RefType) (= (type y_4_1@@0) RefType)) (=> (and (and (and (and (not (= y_4@@0 y_4_1@@0)) (U_2_bool (MapType2Select xs@0 y_4@@0))) (U_2_bool (MapType2Select xs@0 y_4_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_4@@0 y_4_1@@0))))
 :qid |stdinbpl.672:17|
 :skolemid |96|
 :pattern ( (neverTriggered3 y_4@@0) (neverTriggered3 y_4_1@@0))
)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((y_4@@1 T@U) ) (!  (=> (and (= (type y_4@@1) RefType) (U_2_bool (MapType2Select xs@0 y_4@@1))) (>= (U_2_real (MapType1Select Mask@1 y_4@@1 val)) FullPerm))
 :qid |stdinbpl.679:17|
 :skolemid |97|
 :pattern ( (MapType0Select Heap@@9 y_4@@1 val))
 :pattern ( (MapType1Select QPMask@0 y_4@@1 val))
 :pattern ( (MapType2Select xs@0 y_4@@1))
))) (=> (forall ((y_4@@2 T@U) ) (!  (=> (and (= (type y_4@@2) RefType) (U_2_bool (MapType2Select xs@0 y_4@@2))) (>= (U_2_real (MapType1Select Mask@1 y_4@@2 val)) FullPerm))
 :qid |stdinbpl.679:17|
 :skolemid |97|
 :pattern ( (MapType0Select Heap@@9 y_4@@2 val))
 :pattern ( (MapType1Select QPMask@0 y_4@@2 val))
 :pattern ( (MapType2Select xs@0 y_4@@2))
)) (=> (and (and (forall ((y_4@@3 T@U) ) (!  (=> (= (type y_4@@3) RefType) (=> (and (U_2_bool (MapType2Select xs@0 y_4@@3)) (< NoPerm FullPerm)) (and (qpRange3 y_4@@3) (= (invRecv3 y_4@@3) y_4@@3))))
 :qid |stdinbpl.685:22|
 :skolemid |98|
 :pattern ( (MapType0Select Heap@@9 y_4@@3 val))
 :pattern ( (MapType1Select QPMask@0 y_4@@3 val))
 :pattern ( (MapType2Select xs@0 y_4@@3))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType2Select xs@0 (invRecv3 o_3@@2))) (and (< NoPerm FullPerm) (qpRange3 o_3@@2))) (= (invRecv3 o_3@@2) o_3@@2)))
 :qid |stdinbpl.689:22|
 :skolemid |99|
 :pattern ( (invRecv3 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType2Select xs@0 (invRecv3 o_3@@3))) (and (< NoPerm FullPerm) (qpRange3 o_3@@3))) (and (= (invRecv3 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 val)) (- (U_2_real (MapType1Select Mask@1 o_3@@3 val)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select xs@0 (invRecv3 o_3@@3))) (and (< NoPerm FullPerm) (qpRange3 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 val)) (U_2_real (MapType1Select Mask@1 o_3@@3 val))))))
 :qid |stdinbpl.695:22|
 :skolemid |100|
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 val))) (= (U_2_real (MapType1Select Mask@1 o_3@@4 f_5@@0)) (U_2_real (MapType1Select QPMask@0 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.701:29|
 :skolemid |101|
 :pattern ( (MapType1Select QPMask@0 o_3@@4 f_5@@0))
)))) (and (and (=> (= (ControlFlow 0 6) 1) anon17_Else_correct) (=> (= (ControlFlow 0 6) 3) anon18_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon18_Else_correct))))))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x1@@7 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@9 x2 $allocated)) (not (= x1@@7 null))) (and (= Mask@0 (MapType1Store ZeroMask x1@@7 val (real_2_U (+ (U_2_real (MapType1Select ZeroMask x1@@7 val)) FullPerm)))) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 18) (- 0 20)) (HasDirectPerm Mask@0 x1@@7 val)) (=> (HasDirectPerm Mask@0 x1@@7 val) (=> (> (U_2_int (MapType0Select Heap@@9 x1@@7 val)) 0) (=> (and (and (state Heap@@9 Mask@0) (not (= x2 null))) (and (= Mask@1 (MapType1Store Mask@0 x2 val (real_2_U (+ (U_2_real (MapType1Select Mask@0 x2 val)) FullPerm)))) (state Heap@@9 Mask@1))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm Mask@1 x2 val)) (=> (HasDirectPerm Mask@1 x2 val) (=> (and (> (U_2_int (MapType0Select Heap@@9 x2 val)) 0) (state Heap@@9 Mask@1)) (and (=> (= (ControlFlow 0 18) 17) anon13_Then_correct) (=> (= (ControlFlow 0 18) 6) anon13_Else_correct)))))))))))))
