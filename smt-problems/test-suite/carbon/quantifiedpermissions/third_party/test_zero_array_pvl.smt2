...
(let ((anon36_Else_correct  (=> (and (forall ((ix_5_1 Int) (jx_5_1 Int) ) (!  (=> (and (>= ix_5_1 0) (and (< ix_5_1 (|Seq#Length| ar@@27)) (and (>= jx_5_1 0) (and (< jx_5_1 (|Seq#Length| ar@@27)) (not (= ix_5_1 jx_5_1)))))) (not (= (|Seq#Index| ar@@27 ix_5_1) (|Seq#Index| ar@@27 jx_5_1))))
 ...
 :skolemid |100|
)) (and (=> (= (ControlFlow 0 25) (- 0 27)) (forall ((k_5@@2 Int) ) (!  (=> (and (and (<= vmin@@9 k_5@@2) (and (< k_5@@2 vmax@@9) (and (<= lo@@14 (mod k_5@@2 step@@9)) (< (mod k_5@@2 step@@9) hi@@27)))) (dummyFunction (MapType0Select Heap@@33 (|Seq#Index| ar@@27 k_5@@2) Ref__Integer_value))) (>= wildcard@0 NoPerm))
...
(let ((anon35_Else_correct  (=> (and (|sum_square#trigger| (FrameFragment (int_2_U (|sum_square#condqp2| Heap@@33 (+ i@@34 1) lo@@14 hi@@27 step@@9 vmin@@9 vmax@@9 ar@@27))) (+ i@@34 1) lo@@14 hi@@27 step@@9 vmin@@9 vmax@@9 ar@@27) (= (ControlFlow 0 23) 21)) anon24_correct)))
...
))) (and (state Heap@@33 QPMask@0) (state Heap@@33 QPMask@0))) (and (=> (= (ControlFlow 0 52) 50) anon32_Then_correct) (=> (= (ControlFlow 0 52) 22) anon32_Else_correct)))))))))
...
)) (state Heap@@33 ZeroMask)) (and (and (=> (= (ControlFlow 0 54) 52) anon27_Else_correct) (=> (= (ControlFlow 0 54) 20) anon28_Then_correct)) (=> (= (ControlFlow 0 54) 13) anon28_Else_correct)))))
