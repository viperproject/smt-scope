...
(assert  (and (and (and (and (and (and (and (and (= (type xs@@11) (MapType2Type RefType boolType)) (= (type Heap@@21) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (forall ((arg0@@54 T@U) ) (! (= (type (invRecv8 arg0@@54)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon6_Else_correct  (=> (forall ((o_23 T@U) (f_26 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_26))))
(let ((A@@12 (FieldTypeInv0 (type f_26))))
 (=> (and (and (= (type o_23) RefType) (= (type f_26) (FieldType A@@12 B@@11))) (U_2_bool (MapType1Select (MapType0Select Heap@@21 null (|bla_qp#sm| xs@@11)) o_23 f_26))) (U_2_bool (MapType1Select newPMask@0 o_23 f_26)))))
 :qid |stdinbpl.2256:31|
 :skolemid |197|
 :pattern ( (MapType1Select newPMask@0 o_23 f_26))
)) (=> (and (and (forall ((x_2 T@U) ) (!  (=> (and (= (type x_2) RefType) (U_2_bool (MapType2Select xs@@11 x_2))) (U_2_bool (MapType1Select newPMask@0 x_2 data)))
 :qid |stdinbpl.2260:24|
 :skolemid |198|
 :no-pattern (type x_2)
 :no-pattern (U_2_int x_2)
 :no-pattern (U_2_bool x_2)
)) (= Heap@0 (MapType0Store Heap@@21 null (|bla_qp#sm| xs@@11) newPMask@0))) (and (state Heap@0 Mask@0) (= (ControlFlow 0 5) (- 0 4)))) (foo_qp Heap@0 xs@@11)))))
(let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select xs@@11 x_1))) (U_2_bool (MapType2Select xs@@11 x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.2211:21|
 :skolemid |191|
 :pattern ( (neverTriggered9 x_1) (neverTriggered9 x_1_1))
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (U_2_bool (MapType2Select xs@@11 x_1@@0))) (U_2_bool (MapType2Select xs@@11 x_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.2211:21|
 :skolemid |191|
 :pattern ( (neverTriggered9 x_1@@0) (neverTriggered9 x_1_1@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((x_1@@1 T@U) ) (!  (=> (and (= (type x_1@@1) RefType) (U_2_bool (MapType2Select xs@@11 x_1@@1))) (>= (U_2_real (MapType1Select QPMask@0 x_1@@1 data)) FullPerm))
 :qid |stdinbpl.2218:21|
 :skolemid |192|
 :pattern ( (MapType0Select Heap@@21 x_1@@1 data))
 :pattern ( (MapType1Select QPMask@1 x_1@@1 data))
 :pattern ( (MapType2Select xs@@11 x_1@@1))
)))))))
(let ((anon2_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (bla_qp xs@@11) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (bla_qp xs@@11))) perm@1)))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (forall ((x@@19 T@U) (x_5 T@U) ) (!  (=> (and (= (type x@@19) RefType) (= (type x_5) RefType)) (=> (and (and (and (and (not (= x@@19 x_5)) (U_2_bool (MapType2Select xs@@11 x@@19))) (U_2_bool (MapType2Select xs@@11 x_5))) (< NoPerm (* FullPerm (/ (to_real 1) (to_real 2))))) (< NoPerm (* FullPerm (/ (to_real 1) (to_real 2))))) (not (= x@@19 x_5))))
 :qid |stdinbpl.2159:17|
 :skolemid |184|
...
)) (=> (and (forall ((x@@21 T@U) ) (!  (=> (= (type x@@21) RefType) (=> (and (U_2_bool (MapType2Select xs@@11 x@@21)) (< NoPerm (* FullPerm (/ (to_real 1) (to_real 2))))) (and (qpRange8 x@@21) (= (invRecv8 x@@21) x@@21))))
...
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select xs@@11 (invRecv8 o_3))) (< NoPerm (* FullPerm (/ (to_real 1) (to_real 2))))) (qpRange8 o_3)) (= (invRecv8 o_3) o_3)))
 :qid |stdinbpl.2169:24|
 :skolemid |186|
 :pattern ( (invRecv8 o_3))
))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((x@@22 T@U) ) (!  (=> (and (= (type x@@22) RefType) (U_2_bool (MapType2Select xs@@11 x@@22))) (>= (* FullPerm (/ (to_real 1) (to_real 2))) NoPerm))
 :qid |stdinbpl.2175:17|
 :skolemid |187|
 :pattern ( (MapType0Select Heap@@21 x@@22 data))
 :pattern ( (MapType1Select QPMask@0 x@@22 data))
 :pattern ( (MapType2Select xs@@11 x@@22))
))) (=> (forall ((x@@23 T@U) ) (!  (=> (and (= (type x@@23) RefType) (U_2_bool (MapType2Select xs@@11 x@@23))) (>= (* FullPerm (/ (to_real 1) (to_real 2))) NoPerm))
 :qid |stdinbpl.2175:17|
 :skolemid |187|
 :pattern ( (MapType0Select Heap@@21 x@@23 data))
 :pattern ( (MapType1Select QPMask@0 x@@23 data))
 :pattern ( (MapType2Select xs@@11 x@@23))
)) (=> (forall ((x@@24 T@U) ) (!  (=> (= (type x@@24) RefType) (=> (and (U_2_bool (MapType2Select xs@@11 x@@24)) (> (* FullPerm (/ (to_real 1) (to_real 2))) NoPerm)) (not (= x@@24 null))))
 :qid |stdinbpl.2181:24|
 :skolemid |188|
 :pattern ( (MapType0Select Heap@@21 x@@24 data))
 :pattern ( (MapType1Select QPMask@0 x@@24 data))
 :pattern ( (MapType2Select xs@@11 x@@24))
)) (=> (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs@@11 (invRecv8 o_3@@0))) (< NoPerm (* FullPerm (/ (to_real 1) (to_real 2))))) (qpRange8 o_3@@0)) (and (=> (< NoPerm (* FullPerm (/ (to_real 1) (to_real 2)))) (= (invRecv8 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 data)) (+ (U_2_real (MapType1Select UnfoldingMask@0 o_3@@0 data)) (* FullPerm (/ (to_real 1) (to_real 2))))))) (=> (not (and (and (U_2_bool (MapType2Select xs@@11 (invRecv8 o_3@@0))) (< NoPerm (* FullPerm (/ (to_real 1) (to_real 2))))) (qpRange8 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 data)) (U_2_real (MapType1Select UnfoldingMask@0 o_3@@0 data))))))
...
(let ((A@@13 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@13 B@@12))) (not (= f_5 data))) (= (U_2_real (MapType1Select UnfoldingMask@0 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.2191:31|
 :skolemid |190|
 :pattern ( (MapType1Select UnfoldingMask@0 o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
))) (=> (and (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0)) (and (foo_qp Heap@@21 xs@@11) (state Heap@@21 QPMask@0))) (and (=> (= (ControlFlow 0 6) 2) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))))))))))
(let ((anon5_Else_correct  (=> (and (= perm@1 NoPerm) (= (ControlFlow 0 11) 6)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= perm@1 NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= perm@1 (U_2_real (MapType1Select Mask@0 null (bla_qp xs@@11))))) (=> (<= perm@1 (U_2_real (MapType1Select Mask@0 null (bla_qp xs@@11)))) (=> (= (ControlFlow 0 9) 6) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@21 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (= perm@0 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (= Mask@0 (MapType1Store ZeroMask null (bla_qp xs@@11) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (bla_qp xs@@11))) perm@0)))) (state Heap@@21 Mask@0)) (=> (and (and (state Heap@@21 Mask@0) (|bla_qp#trigger| Heap@@21 (bla_qp xs@@11))) (and (= (MapType0Select Heap@@21 null (bla_qp xs@@11)) (FrameFragment (int_2_U (|bla_qp#condqp2| Heap@@21 xs@@11)))) (= perm@1 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (and (=> (= (ControlFlow 0 12) 9) anon5_Then_correct) (=> (= (ControlFlow 0 12) 11) anon5_Else_correct))))))))))))
