(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:07:16
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/predicates/receiverless.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(check-sat)
; unsat
(assert (valid%trigger $t@9@01 false))
; [exec]
; assert false
(set-option :timeout 0)
(check-sat)
...
(check-sat)
; unknown
(assert (valid%trigger $t@14@01 true))
; [exec]
; assert false
(set-option :timeout 0)
(check-sat)
