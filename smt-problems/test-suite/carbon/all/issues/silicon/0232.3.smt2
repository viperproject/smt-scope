...
(assert  (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type this) RefType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))))
(set-info :boogie-vc-id test2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon4_correct true))
(let ((anon3_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (P this) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P this))) perm@0)))) (=> (and (= Mask@2 Mask@1) (= (ControlFlow 0 3) 1)) anon4_correct))))
(let ((anon6_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= perm@0 (U_2_real (MapType1Select Mask@0 null (P this))))) (=> (<= perm@0 (U_2_real (MapType1Select Mask@0 null (P this)))) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
(let ((anon5_Then_correct  (=> (and (< NoPerm (U_2_real (MapType1Select Mask@0 null (P this)))) (= perm@0 (U_2_real (MapType1Select Mask@0 null (P this))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))))
(let ((anon5_Else_correct  (=> (<= (U_2_real (MapType1Select Mask@0 null (P this))) NoPerm) (=> (and (= Mask@2 Mask@0) (= (ControlFlow 0 2) 1)) anon4_correct))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@10 this $allocated)) (= Mask@0 (MapType1Store ZeroMask null (P this) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P this))) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 9) 7) anon5_Then_correct) (=> (= (ControlFlow 0 9) 2) anon5_Else_correct))))))
