...
(declare-fun r_2@@17 () T@U)
(declare-fun Mask@0 () T@U)
(assert  (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type r_2@@17) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |p2#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@12 ZeroMask) (U_2_bool (MapType0Select Heap@@12 r_2@@17 $allocated))) (=> (and (and (not (= r_2@@17 null)) (= Mask@0 (MapType1Store ZeroMask r_2@@17 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_2@@17 f_7)) FullPerm))))) (and (state Heap@@12 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@0 r_2@@17 f_7)))))
