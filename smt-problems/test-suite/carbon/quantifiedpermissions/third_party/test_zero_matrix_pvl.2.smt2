...
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (= AssumeFunctionsAbove 5) (<= 0 i@@34)) (=> (and (and (<= i@@34 hi@@27) (state Heap@@41 ZeroMask)) (and (<= hi@@27 (|Seq#Length| ar@@27)) (state Heap@@41 ZeroMask))) (and (=> (= (ControlFlow 0 11) 8) anon5_Then_correct) (=> (= (ControlFlow 0 11) 2) anon5_Else_correct)))))))
