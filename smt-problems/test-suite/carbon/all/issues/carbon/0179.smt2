...
(assert (forall ((r$ T@U) ) (!  (=> (= (type r$) RefType) (IsPredicateField (P1 r$)))
 :qid |stdinbpl.186:15|
 :skolemid |23|
 :pattern ( (P1 r$))
)))
(assert  (and (= (Ctor PredicateType_P3Type) 12) (forall ((arg0@@26 T@U) ) (! (= (type (P3 arg0@@26)) (FieldType PredicateType_P3Type FrameTypeType))
 :qid |funType:P3|
 :pattern ( (P3 arg0@@26))
))))
(assert (forall ((r$@@0 T@U) ) (!  (=> (= (type r$@@0) RefType) (IsPredicateField (P3 r$@@0)))
 :qid |stdinbpl.221:15|
 :skolemid |29|
 :pattern ( (P3 r$@@0))
)))
(assert (forall ((Heap@@2 T@U) (r$@@1 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type r$@@1) RefType)) (|P1#everUsed| (P1 r$@@1)))
 :qid |stdinbpl.205:15|
 :skolemid |27|
 :pattern ( (|P1#trigger| Heap@@2 (P1 r$@@1)))
)))
(assert (forall ((Heap@@3 T@U) (r$@@2 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type r$@@2) RefType)) (|P3#everUsed| (P3 r$@@2)))
 :qid |stdinbpl.240:15|
 :skolemid |33|
 :pattern ( (|P3#trigger| Heap@@3 (P3 r$@@2)))
)))
...
(assert (forall ((r$@@3 T@U) (r$2 T@U) ) (!  (=> (and (and (= (type r$@@3) RefType) (= (type r$2) RefType)) (= (P1 r$@@3) (P1 r$2))) (= r$@@3 r$2))
 :qid |stdinbpl.196:15|
 :skolemid |25|
...
(assert (forall ((r$@@4 T@U) (r$2@@0 T@U) ) (!  (=> (and (and (= (type r$@@4) RefType) (= (type r$2@@0) RefType)) (= (|P1#sm| r$@@4) (|P1#sm| r$2@@0))) (= r$@@4 r$2@@0))
 :qid |stdinbpl.200:15|
 :skolemid |26|
 :pattern ( (|P1#sm| r$@@4) (|P1#sm| r$2@@0))
)))
(assert (forall ((r$@@5 T@U) (r$2@@1 T@U) ) (!  (=> (and (and (= (type r$@@5) RefType) (= (type r$2@@1) RefType)) (= (P3 r$@@5) (P3 r$2@@1))) (= r$@@5 r$2@@1))
 :qid |stdinbpl.231:15|
 :skolemid |31|
 :pattern ( (P3 r$@@5) (P3 r$2@@1))
)))
(assert (forall ((arg0@@28 T@U) ) (! (= (type (|P3#sm| arg0@@28)) (FieldType PredicateType_P3Type (MapType1Type RefType boolType)))
 :qid |funType:P3#sm|
 :pattern ( (|P3#sm| arg0@@28))
)))
(assert (forall ((r$@@6 T@U) (r$2@@2 T@U) ) (!  (=> (and (and (= (type r$@@6) RefType) (= (type r$2@@2) RefType)) (= (|P3#sm| r$@@6) (|P3#sm| r$2@@2))) (= r$@@6 r$2@@2))
 :qid |stdinbpl.235:15|
 :skolemid |32|
...
(assert (forall ((r$@@7 T@U) ) (!  (=> (= (type r$@@7) RefType) (= (getPredWandId (P1 r$@@7)) 0))
 :qid |stdinbpl.190:15|
 :skolemid |24|
 :pattern ( (P1 r$@@7))
)))
(assert (forall ((r$@@8 T@U) ) (!  (=> (= (type r$@@8) RefType) (= (getPredWandId (P3 r$@@8)) 1))
 :qid |stdinbpl.225:15|
 :skolemid |30|
 :pattern ( (P3 r$@@8))
)))
...
(assert (forall ((r$@@9 T@U) ) (!  (=> (= (type r$@@9) RefType) (= (PredicateMaskField (P1 r$@@9)) (|P1#sm| r$@@9)))
 :qid |stdinbpl.182:15|
 :skolemid |22|
 :pattern ( (PredicateMaskField (P1 r$@@9)))
)))
(assert (forall ((r$@@10 T@U) ) (!  (=> (= (type r$@@10) RefType) (= (PredicateMaskField (P3 r$@@10)) (|P3#sm| r$@@10)))
 :qid |stdinbpl.217:15|
 :skolemid |28|
 :pattern ( (PredicateMaskField (P3 r$@@10)))
)))
...
(assert  (and (and (and (and (and (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type b_2) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon8_correct  (=> (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@0 Mask@4) (=> (and (state ExhaleHeap@0 Mask@4) (= (ControlFlow 0 2) (- 0 1))) (= (U_2_real (MapType1Select Mask@4 null (P1 b_2))) FullPerm)))))
(let ((anon3_correct  (=> (= Mask@3 (MapType1Store Mask@1 null (P3 b_2) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (P3 b_2))) FullPerm)))) (=> (and (= Mask@4 Mask@3) (= (ControlFlow 0 11) 2)) anon8_correct))))
(let ((anon10_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 14) 11)) anon3_correct)))
(let ((anon10_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (P3 b_2))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (P3 b_2)))) (=> (= (ControlFlow 0 12) 11) anon3_correct))))))
(let ((anon9_Then_correct  (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (P3 b_2)))) (and (=> (= (ControlFlow 0 15) 12) anon10_Then_correct) (=> (= (ControlFlow 0 15) 14) anon10_Else_correct)))))
(let ((anon7_correct  (=> (= Mask@2 (MapType1Store Mask@1 null (P1 b_2) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (P1 b_2))) perm@0)))) (=> (and (= Mask@4 Mask@2) (= (ControlFlow 0 4) 2)) anon8_correct))))
(let ((anon12_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 7) 4)) anon7_correct)))
(let ((anon12_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= perm@0 (U_2_real (MapType1Select Mask@1 null (P1 b_2))))) (=> (<= perm@0 (U_2_real (MapType1Select Mask@1 null (P1 b_2)))) (=> (= (ControlFlow 0 5) 4) anon7_correct))))))
(let ((anon11_Then_correct  (=> (and (< NoPerm (U_2_real (MapType1Select Mask@1 null (P1 b_2)))) (= perm@0 (- FullPerm (U_2_real (MapType1Select Mask@1 null (P3 b_2)))))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 8) 5) anon12_Then_correct) (=> (= (ControlFlow 0 8) 7) anon12_Else_correct)))))))
(let ((anon11_Else_correct  (=> (<= (U_2_real (MapType1Select Mask@1 null (P1 b_2))) NoPerm) (=> (and (= Mask@4 Mask@1) (= (ControlFlow 0 3) 2)) anon8_correct))))
(let ((anon9_Else_correct  (=> (< (U_2_real (MapType1Select Mask@1 null (P3 b_2))) FullPerm) (and (=> (= (ControlFlow 0 10) 8) anon11_Then_correct) (=> (= (ControlFlow 0 10) 3) anon11_Else_correct)))))
(let ((anon0_correct  (=> (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 b_2 $allocated))) (=> (and (and (and (= Mask@0 (MapType1Store ZeroMask null (P1 b_2) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P1 b_2))) FullPerm)))) (state Heap@@11 Mask@0)) (and (state Heap@@11 Mask@0) (state Heap@@11 Mask@0))) (and (and (= Mask@1 (MapType1Store Mask@0 null (P3 b_2) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (P3 b_2))) FullPerm)))) (state Heap@@11 Mask@1)) (and (state Heap@@11 Mask@1) (state Heap@@11 Mask@1)))) (and (=> (= (ControlFlow 0 16) 15) anon9_Then_correct) (=> (= (ControlFlow 0 16) 10) anon9_Else_correct))))))
