...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Unfolding1Mask@0) (MapType1Type RefType realType)) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (= (type y@@9) RefType)) (= (type Unfolding1Mask@1) (MapType1Type RefType realType))) (= (type Heap@@37) (MapType0Type RefType))) (= (type Unfolding1Mask@2) (MapType1Type RefType realType))) (= (type UnfoldingHeap@0) (MapType0Type RefType))) (= (type UnfoldingHeap@1) (MapType0Type RefType))) (= (type UnfoldingHeap@2) (MapType0Type RefType))) (= (type UnfoldingHeap@3) (MapType0Type RefType))) (= (type x@@48) RefType)) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (forall ((arg0@@35 T@U) ) (! (= (type (FrameFragment arg0@@35)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@35))
))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |add#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon4_correct  (=> (and (= Unfolding1Mask@0 (MapType1Store UnfoldingMask@2 null (pair y@@9) (real_2_U (- (U_2_real (MapType1Select UnfoldingMask@2 null (pair y@@9))) perm@5)))) (= perm@6 (* FullPerm (/ (to_real 1) (to_real 3))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (>= perm@6 NoPerm)) (=> (>= perm@6 NoPerm) (=> (and (and (=> (> perm@6 NoPerm) (not (= y@@9 null))) (= Unfolding1Mask@1 (MapType1Store Unfolding1Mask@0 y@@9 f_7 (real_2_U (+ (U_2_real (MapType1Select Unfolding1Mask@0 y@@9 f_7)) perm@6))))) (and (state Heap@@37 Unfolding1Mask@1) (= perm@7 (* FullPerm (/ (to_real 1) (to_real 3)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= perm@7 NoPerm)) (=> (>= perm@7 NoPerm) (=> (and (and (=> (> perm@7 NoPerm) (not (= y@@9 null))) (= Unfolding1Mask@2 (MapType1Store Unfolding1Mask@1 y@@9 g (real_2_U (+ (U_2_real (MapType1Select Unfolding1Mask@1 y@@9 g)) perm@7))))) (and (state Heap@@37 Unfolding1Mask@2) (state Heap@@37 Unfolding1Mask@2))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Unfolding1Mask@2 y@@9 f_7)) (=> (HasDirectPerm Unfolding1Mask@2 y@@9 f_7) (=> (= UnfoldingHeap@0 (MapType0Store Heap@@37 null (|pair#sm| y@@9) (MapType1Store (MapType0Select Heap@@37 null (|pair#sm| y@@9)) y@@9 f_7 (bool_2_U true)))) (=> (and (= UnfoldingHeap@1 (MapType0Store UnfoldingHeap@0 null (|pair#sm| y@@9) (MapType1Store (MapType0Select UnfoldingHeap@0 null (|pair#sm| y@@9)) y@@9 g (bool_2_U true)))) (state UnfoldingHeap@1 UnfoldingMask@2)) (=> (and (and (= UnfoldingHeap@2 (MapType0Store UnfoldingHeap@1 null (|pair#sm| y@@9) (MapType1Store (MapType0Select UnfoldingHeap@1 null (|pair#sm| y@@9)) y@@9 f_7 (bool_2_U true)))) (= UnfoldingHeap@3 (MapType0Store UnfoldingHeap@2 null (|pair#sm| y@@9) (MapType1Store (MapType0Select UnfoldingHeap@2 null (|pair#sm| y@@9)) y@@9 g (bool_2_U true))))) (and (state UnfoldingHeap@3 UnfoldingMask@2) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm UnfoldingMask@2 x@@48 g)))))))))))))))
(let ((anon6_Else_correct  (=> (and (= perm@5 NoPerm) (= (ControlFlow 0 8) 2)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= perm@5 NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= perm@5 (U_2_real (MapType1Select UnfoldingMask@2 null (pair y@@9))))) (=> (<= perm@5 (U_2_real (MapType1Select UnfoldingMask@2 null (pair y@@9)))) (=> (= (ControlFlow 0 6) 2) anon4_correct))))))
(let ((anon2_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@1 null (pair x@@48) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (pair x@@48))) perm@2)))) (= perm@3 (* FullPerm (/ (to_real 1) (to_real 3))))) (and (=> (= (ControlFlow 0 9) (- 0 13)) (>= perm@3 NoPerm)) (=> (>= perm@3 NoPerm) (=> (and (and (=> (> perm@3 NoPerm) (not (= x@@48 null))) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x@@48 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@48 f_7)) perm@3))))) (and (state Heap@@37 UnfoldingMask@1) (= perm@4 (* FullPerm (/ (to_real 1) (to_real 3)))))) (and (=> (= (ControlFlow 0 9) (- 0 12)) (>= perm@4 NoPerm)) (=> (>= perm@4 NoPerm) (=> (and (and (=> (> perm@4 NoPerm) (not (= x@@48 null))) (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 x@@48 g (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 x@@48 g)) perm@4))))) (and (state Heap@@37 UnfoldingMask@2) (state Heap@@37 UnfoldingMask@2))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (HasDirectPerm UnfoldingMask@2 x@@48 f_7)) (=> (HasDirectPerm UnfoldingMask@2 x@@48 f_7) (=> (|pair#trigger| Heap@@37 (pair y@@9)) (=> (and (= (MapType0Select Heap@@37 null (pair y@@9)) (CombineFrames (FrameFragment (MapType0Select Heap@@37 y@@9 f_7)) (FrameFragment (MapType0Select Heap@@37 y@@9 g)))) (= perm@5 (/ (to_real 1) (to_real 3)))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (>= perm@5 NoPerm)) (=> (>= perm@5 NoPerm) (and (=> (= (ControlFlow 0 9) 6) anon6_Then_correct) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct)))))))))))))))))
(let ((anon5_Else_correct  (=> (and (= perm@2 NoPerm) (= (ControlFlow 0 16) 9)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= perm@2 NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= perm@2 (U_2_real (MapType1Select Mask@1 null (pair x@@48))))) (=> (<= perm@2 (U_2_real (MapType1Select Mask@1 null (pair x@@48)))) (=> (= (ControlFlow 0 14) 9) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@37 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@37 x@@48 $allocated)) (U_2_bool (MapType0Select Heap@@37 y@@9 $allocated))) (and (= AssumeFunctionsAbove 2) (= perm@0 (/ (to_real 1) (to_real 3))))) (and (=> (= (ControlFlow 0 17) (- 0 20)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (pair x@@48) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (pair x@@48))) perm@0)))) (state Heap@@37 Mask@0)) (and (state Heap@@37 Mask@0) (= perm@1 (/ (to_real 1) (to_real 3))))) (and (=> (= (ControlFlow 0 17) (- 0 19)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (= Mask@1 (MapType1Store Mask@0 null (pair y@@9) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (pair y@@9))) perm@1)))) (state Heap@@37 Mask@1)) (=> (and (and (state Heap@@37 Mask@1) (|pair#trigger| Heap@@37 (pair x@@48))) (and (= (MapType0Select Heap@@37 null (pair x@@48)) (CombineFrames (FrameFragment (MapType0Select Heap@@37 x@@48 f_7)) (FrameFragment (MapType0Select Heap@@37 x@@48 g)))) (= perm@2 (/ (to_real 1) (to_real 3))))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (and (=> (= (ControlFlow 0 17) 14) anon5_Then_correct) (=> (= (ControlFlow 0 17) 16) anon5_Else_correct)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 21) 17) anon0_correct)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@9) (MapType1Type RefType realType)) (= (type freshObj@0) RefType)) (= (type freshObj@1) RefType)) (= (type Heap@21) (MapType0Type RefType))) (= (type Mask@15) (MapType1Type RefType realType))) (= (type Heap@20) (MapType0Type RefType))) (= (type Heap@19) (MapType0Type RefType))) (= (type Heap@17) (MapType0Type RefType))) (= (type Heap@16) (MapType0Type RefType))) (= (type Heap@18) (MapType0Type RefType))) (= (type freshVersion@2) FrameTypeType)) (= (type Mask@14) (MapType1Type RefType realType))) (= (type Mask@13) (MapType1Type RefType realType))) (forall ((arg0@@35 T@U) ) (! (= (type (FrameFragment arg0@@35)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@35))
))) (= (type Mask@12) (MapType1Type RefType realType))) (= (type Mask@11) (MapType1Type RefType realType))) (= (type Mask@10) (MapType1Type RefType realType))) (= (type Heap@15) (MapType0Type RefType))) (= (type Heap@14) (MapType0Type RefType))) (= (type Heap@13) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Heap@12) (MapType0Type RefType))) (= (type Heap@11) (MapType0Type RefType))) (= (type Heap@9) (MapType0Type RefType))) (= (type Heap@8) (MapType0Type RefType))) (= (type Heap@10) (MapType0Type RefType))) (= (type freshVersion@1) FrameTypeType)) (= (type Mask@8) (MapType1Type RefType realType))) (= (type Mask@7) (MapType1Type RefType realType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type Heap@7) (MapType0Type RefType))) (= (type Heap@6) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Heap@@37) (MapType0Type RefType))) (= (type x@@48) RefType)) (= (type y@@9) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@2) (MapType0Type RefType))))
(set-info :boogie-vc-id test1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 68) (let ((anon37_correct true))
(let ((anon57_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 18) 15)) anon37_correct)))
(let ((anon57_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= FullPerm (U_2_real (MapType1Select Mask@15 null (pair freshObj@1))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@15 null (pair freshObj@1)))) (=> (= (ControlFlow 0 16) 15) anon37_correct))))))
(let ((anon33_correct true))
(let ((anon55_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 14) 11)) anon33_correct)))
(let ((anon55_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (U_2_real (MapType1Select Mask@15 null (pair freshObj@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@15 null (pair freshObj@0)))) (=> (= (ControlFlow 0 12) 11) anon33_correct))))))
(let ((anon56_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (= (sum Heap@21 freshObj@0) (sum Heap@21 freshObj@1)))))
(let ((anon30_correct  (=> (and (and (= Heap@20 (MapType0Store Heap@19 null (|pair#sm| freshObj@0) (MapType1Store (MapType0Select Heap@19 null (|pair#sm| freshObj@0)) freshObj@0 f_7 (bool_2_U true)))) (= Heap@21 (MapType0Store Heap@20 null (|pair#sm| freshObj@0) (MapType1Store (MapType0Select Heap@20 null (|pair#sm| freshObj@0)) freshObj@0 g (bool_2_U true))))) (and (state Heap@21 Mask@15) (state Heap@21 Mask@15))) (and (and (and (and (=> (= (ControlFlow 0 19) 10) anon56_Else_correct) (=> (= (ControlFlow 0 19) 16) anon57_Then_correct)) (=> (= (ControlFlow 0 19) 18) anon57_Else_correct)) (=> (= (ControlFlow 0 19) 12) anon55_Then_correct)) (=> (= (ControlFlow 0 19) 14) anon55_Else_correct)))))
(let ((anon53_Else_correct  (=> (HasDirectPerm Mask@15 null (pair freshObj@0)) (=> (and (= Heap@19 Heap@16) (= (ControlFlow 0 21) 19)) anon30_correct))))
(let ((anon53_Then_correct  (=> (not (HasDirectPerm Mask@15 null (pair freshObj@0))) (=> (and (and (= Heap@17 (MapType0Store Heap@16 null (|pair#sm| freshObj@0) ZeroPMask)) (= Heap@18 (MapType0Store Heap@17 null (pair freshObj@0) freshVersion@2))) (and (= Heap@19 Heap@18) (= (ControlFlow 0 20) 19))) anon30_correct))))
(let ((anon28_correct  (=> (and (= Mask@14 (MapType1Store Mask@13 freshObj@0 g (real_2_U (- (U_2_real (MapType1Select Mask@13 freshObj@0 g)) FullPerm)))) (= Mask@15 (MapType1Store Mask@14 null (pair freshObj@0) (real_2_U (+ (U_2_real (MapType1Select Mask@14 null (pair freshObj@0))) FullPerm))))) (=> (and (and (state Heap@16 Mask@15) (state Heap@16 Mask@15)) (and (|pair#trigger| Heap@16 (pair freshObj@0)) (= (MapType0Select Heap@16 null (pair freshObj@0)) (CombineFrames (FrameFragment (MapType0Select Heap@16 freshObj@0 f_7)) (FrameFragment (MapType0Select Heap@16 freshObj@0 g)))))) (and (=> (= (ControlFlow 0 22) 20) anon53_Then_correct) (=> (= (ControlFlow 0 22) 21) anon53_Else_correct))))))
(let ((anon52_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 25) 22)) anon28_correct)))
(let ((anon52_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (<= FullPerm (U_2_real (MapType1Select Mask@13 freshObj@0 g)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@13 freshObj@0 g))) (=> (= (ControlFlow 0 23) 22) anon28_correct))))))
(let ((anon26_correct  (=> (= Mask@13 (MapType1Store Mask@12 freshObj@0 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@12 freshObj@0 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 26) 23) anon52_Then_correct) (=> (= (ControlFlow 0 26) 25) anon52_Else_correct)))))
(let ((anon51_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 29) 26)) anon26_correct)))
(let ((anon51_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (<= FullPerm (U_2_real (MapType1Select Mask@12 freshObj@0 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@12 freshObj@0 f_7))) (=> (= (ControlFlow 0 27) 26) anon26_correct))))))
(let ((anon24_correct  (=> (and (and (and (not (= freshObj@0 null)) (= Mask@11 (MapType1Store Mask@10 freshObj@0 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@10 freshObj@0 f_7)) FullPerm))))) (and (state Heap@15 Mask@11) (not (= freshObj@0 null)))) (and (and (= Mask@12 (MapType1Store Mask@11 freshObj@0 g (real_2_U (+ (U_2_real (MapType1Select Mask@11 freshObj@0 g)) FullPerm)))) (state Heap@15 Mask@12)) (and (state Heap@15 Mask@12) (state Heap@15 Mask@12)))) (and (=> (= (ControlFlow 0 30) (- 0 32)) (HasDirectPerm Mask@12 freshObj@0 f_7)) (=> (HasDirectPerm Mask@12 freshObj@0 f_7) (and (=> (= (ControlFlow 0 30) (- 0 31)) (= FullPerm (U_2_real (MapType1Select Mask@12 freshObj@0 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@12 freshObj@0 f_7))) (=> (and (= Heap@16 (MapType0Store Heap@15 freshObj@0 f_7 (int_2_U (+ (U_2_int (MapType0Select Heap@15 freshObj@0 f_7)) 1)))) (state Heap@16 Mask@12)) (and (=> (= (ControlFlow 0 30) 27) anon51_Then_correct) (=> (= (ControlFlow 0 30) 29) anon51_Else_correct))))))))))
(let ((anon50_Else_correct  (=> (HasDirectPerm Mask@10 null (pair freshObj@0)) (=> (and (= Heap@15 Heap@13) (= (ControlFlow 0 34) 30)) anon24_correct))))
(let ((anon50_Then_correct  (=> (and (and (not (HasDirectPerm Mask@10 null (pair freshObj@0))) (= Heap@14 (MapType0Store Heap@13 null (pair freshObj@0) newVersion@0))) (and (= Heap@15 Heap@14) (= (ControlFlow 0 33) 30))) anon24_correct)))
(let ((anon22_correct  (=> (= Mask@10 (MapType1Store Mask@9 null (pair freshObj@0) (real_2_U (- (U_2_real (MapType1Select Mask@9 null (pair freshObj@0))) FullPerm)))) (and (=> (= (ControlFlow 0 35) 33) anon50_Then_correct) (=> (= (ControlFlow 0 35) 34) anon50_Else_correct)))))
(let ((anon49_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 38) 35)) anon22_correct)))
(let ((anon49_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 36) (- 0 37)) (<= FullPerm (U_2_real (MapType1Select Mask@9 null (pair freshObj@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@9 null (pair freshObj@0)))) (=> (= (ControlFlow 0 36) 35) anon22_correct))))))
(let ((anon47_Else_correct  (and (=> (= (ControlFlow 0 39) (- 0 40)) (= (sum Heap@13 freshObj@0) (sum Heap@13 freshObj@1))) (=> (= (sum Heap@13 freshObj@0) (sum Heap@13 freshObj@1)) (=> (state Heap@13 Mask@9) (=> (and (|pair#trigger| Heap@13 (pair freshObj@0)) (= (MapType0Select Heap@13 null (pair freshObj@0)) (CombineFrames (FrameFragment (MapType0Select Heap@13 freshObj@0 f_7)) (FrameFragment (MapType0Select Heap@13 freshObj@0 g))))) (and (=> (= (ControlFlow 0 39) 36) anon49_Then_correct) (=> (= (ControlFlow 0 39) 38) anon49_Else_correct))))))))
(let ((anon19_correct true))
(let ((anon48_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon19_correct)))
(let ((anon48_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@9 null (pair freshObj@1))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@9 null (pair freshObj@1)))) (=> (= (ControlFlow 0 6) 5) anon19_correct))))))
(let ((anon15_correct true))
(let ((anon46_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon15_correct)))
(let ((anon46_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@9 null (pair freshObj@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@9 null (pair freshObj@0)))) (=> (= (ControlFlow 0 2) 1) anon15_correct))))))
(let ((anon12_correct  (=> (and (and (= Heap@12 (MapType0Store Heap@11 null (|pair#sm| freshObj@1) (MapType1Store (MapType0Select Heap@11 null (|pair#sm| freshObj@1)) freshObj@1 f_7 (bool_2_U true)))) (= Heap@13 (MapType0Store Heap@12 null (|pair#sm| freshObj@1) (MapType1Store (MapType0Select Heap@12 null (|pair#sm| freshObj@1)) freshObj@1 g (bool_2_U true))))) (and (state Heap@13 Mask@9) (state Heap@13 Mask@9))) (and (and (and (and (=> (= (ControlFlow 0 41) 39) anon47_Else_correct) (=> (= (ControlFlow 0 41) 6) anon48_Then_correct)) (=> (= (ControlFlow 0 41) 8) anon48_Else_correct)) (=> (= (ControlFlow 0 41) 2) anon46_Then_correct)) (=> (= (ControlFlow 0 41) 4) anon46_Else_correct)))))
(let ((anon44_Else_correct  (=> (HasDirectPerm Mask@9 null (pair freshObj@1)) (=> (and (= Heap@11 Heap@8) (= (ControlFlow 0 43) 41)) anon12_correct))))
(let ((anon44_Then_correct  (=> (not (HasDirectPerm Mask@9 null (pair freshObj@1))) (=> (and (and (= Heap@9 (MapType0Store Heap@8 null (|pair#sm| freshObj@1) ZeroPMask)) (= Heap@10 (MapType0Store Heap@9 null (pair freshObj@1) freshVersion@1))) (and (= Heap@11 Heap@10) (= (ControlFlow 0 42) 41))) anon12_correct))))
(let ((anon10_correct  (=> (and (= Mask@8 (MapType1Store Mask@7 freshObj@1 g (real_2_U (- (U_2_real (MapType1Select Mask@7 freshObj@1 g)) FullPerm)))) (= Mask@9 (MapType1Store Mask@8 null (pair freshObj@1) (real_2_U (+ (U_2_real (MapType1Select Mask@8 null (pair freshObj@1))) FullPerm))))) (=> (and (and (state Heap@8 Mask@9) (state Heap@8 Mask@9)) (and (|pair#trigger| Heap@8 (pair freshObj@1)) (= (MapType0Select Heap@8 null (pair freshObj@1)) (CombineFrames (FrameFragment (MapType0Select Heap@8 freshObj@1 f_7)) (FrameFragment (MapType0Select Heap@8 freshObj@1 g)))))) (and (=> (= (ControlFlow 0 44) 42) anon44_Then_correct) (=> (= (ControlFlow 0 44) 43) anon44_Else_correct))))))
(let ((anon43_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 47) 44)) anon10_correct)))
(let ((anon43_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 45) (- 0 46)) (<= FullPerm (U_2_real (MapType1Select Mask@7 freshObj@1 g)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@7 freshObj@1 g))) (=> (= (ControlFlow 0 45) 44) anon10_correct))))))
(let ((anon8_correct  (=> (= Mask@7 (MapType1Store Mask@6 freshObj@1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@6 freshObj@1 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 48) 45) anon43_Then_correct) (=> (= (ControlFlow 0 48) 47) anon43_Else_correct)))))
(let ((anon42_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 51) 48)) anon8_correct)))
(let ((anon42_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 49) (- 0 50)) (<= FullPerm (U_2_real (MapType1Select Mask@6 freshObj@1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@6 freshObj@1 f_7))) (=> (= (ControlFlow 0 49) 48) anon8_correct))))))
(let ((anon6_correct  (=> (and (and (= Heap@7 (MapType0Store Heap@6 null (|pair#sm| freshObj@0) (MapType1Store (MapType0Select Heap@6 null (|pair#sm| freshObj@0)) freshObj@0 f_7 (bool_2_U true)))) (= Heap@8 (MapType0Store Heap@7 null (|pair#sm| freshObj@0) (MapType1Store (MapType0Select Heap@7 null (|pair#sm| freshObj@0)) freshObj@0 g (bool_2_U true))))) (and (state Heap@8 Mask@6) (state Heap@8 Mask@6))) (and (=> (= (ControlFlow 0 52) 49) anon42_Then_correct) (=> (= (ControlFlow 0 52) 51) anon42_Else_correct)))))
(let ((anon41_Else_correct  (=> (HasDirectPerm Mask@6 null (pair freshObj@0)) (=> (and (= Heap@6 Heap@3) (= (ControlFlow 0 54) 52)) anon6_correct))))
(let ((anon41_Then_correct  (=> (not (HasDirectPerm Mask@6 null (pair freshObj@0))) (=> (and (and (= Heap@4 (MapType0Store Heap@3 null (|pair#sm| freshObj@0) ZeroPMask)) (= Heap@5 (MapType0Store Heap@4 null (pair freshObj@0) freshVersion@0))) (and (= Heap@6 Heap@5) (= (ControlFlow 0 53) 52))) anon6_correct))))
(let ((anon4_correct  (=> (and (= Mask@5 (MapType1Store Mask@4 freshObj@0 g (real_2_U (- (U_2_real (MapType1Select Mask@4 freshObj@0 g)) FullPerm)))) (= Mask@6 (MapType1Store Mask@5 null (pair freshObj@0) (real_2_U (+ (U_2_real (MapType1Select Mask@5 null (pair freshObj@0))) FullPerm))))) (=> (and (and (state Heap@3 Mask@6) (state Heap@3 Mask@6)) (and (|pair#trigger| Heap@3 (pair freshObj@0)) (= (MapType0Select Heap@3 null (pair freshObj@0)) (CombineFrames (FrameFragment (MapType0Select Heap@3 freshObj@0 f_7)) (FrameFragment (MapType0Select Heap@3 freshObj@0 g)))))) (and (=> (= (ControlFlow 0 55) 53) anon41_Then_correct) (=> (= (ControlFlow 0 55) 54) anon41_Else_correct))))))
(let ((anon40_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 58) 55)) anon4_correct)))
(let ((anon40_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 56) (- 0 57)) (<= FullPerm (U_2_real (MapType1Select Mask@4 freshObj@0 g)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 freshObj@0 g))) (=> (= (ControlFlow 0 56) 55) anon4_correct))))))
(let ((anon2_correct  (=> (= Mask@4 (MapType1Store Mask@3 freshObj@0 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@3 freshObj@0 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 59) 56) anon40_Then_correct) (=> (= (ControlFlow 0 59) 58) anon40_Else_correct)))))
(let ((anon39_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 62) 59)) anon2_correct)))
(let ((anon39_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 60) (- 0 61)) (<= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 f_7))) (=> (= (ControlFlow 0 60) 59) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (and (state Heap@@37 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@37 x@@48 $allocated)) (U_2_bool (MapType0Select Heap@@37 y@@9 $allocated)))) (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@37 freshObj@0 $allocated)))) (and (= Heap@0 (MapType0Store Heap@@37 freshObj@0 $allocated (bool_2_U true))) (= Mask@0 (MapType1Store ZeroMask freshObj@0 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 f_7)) FullPerm))))))) (and (and (and (= Mask@1 (MapType1Store Mask@0 freshObj@0 g (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@0 g)) FullPerm)))) (state Heap@0 Mask@1)) (and (not (= freshObj@1 null)) (not (U_2_bool (MapType0Select Heap@0 freshObj@1 $allocated))))) (and (and (= Heap@1 (MapType0Store Heap@0 freshObj@1 $allocated (bool_2_U true))) (= Mask@2 (MapType1Store Mask@1 freshObj@1 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@1 freshObj@1 f_7)) FullPerm))))) (and (= Mask@3 (MapType1Store Mask@2 freshObj@1 g (real_2_U (+ (U_2_real (MapType1Select Mask@2 freshObj@1 g)) FullPerm)))) (state Heap@1 Mask@3))))) (and (=> (= (ControlFlow 0 63) (- 0 67)) (HasDirectPerm Mask@3 freshObj@1 f_7)) (=> (HasDirectPerm Mask@3 freshObj@1 f_7) (and (=> (= (ControlFlow 0 63) (- 0 66)) (= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 f_7))) (=> (and (= Heap@2 (MapType0Store Heap@1 freshObj@0 f_7 (MapType0Select Heap@1 freshObj@1 f_7))) (state Heap@2 Mask@3)) (and (=> (= (ControlFlow 0 63) (- 0 65)) (HasDirectPerm Mask@3 freshObj@0 g)) (=> (HasDirectPerm Mask@3 freshObj@0 g) (and (=> (= (ControlFlow 0 63) (- 0 64)) (= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@1 g)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@1 g))) (=> (and (= Heap@3 (MapType0Store Heap@2 freshObj@1 g (MapType0Select Heap@2 freshObj@0 g))) (state Heap@3 Mask@3)) (and (=> (= (ControlFlow 0 63) 60) anon39_Then_correct) (=> (= (ControlFlow 0 63) 62) anon39_Else_correct)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 68) 63) anon0_correct)))
PreconditionGeneratedEntry_correct))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
