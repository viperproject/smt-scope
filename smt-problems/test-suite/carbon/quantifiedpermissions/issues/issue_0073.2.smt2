...
(declare-fun i1 () Int)
(declare-fun i2 () Int)
(assert  (and (and (= (type s@@17) (SeqType RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id m)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 25) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i@@6))) (= (ControlFlow 0 22) 18)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i@@6)) (and (=> (= (ControlFlow 0 19) (- 0 21)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 19) (- 0 20)) (< i@@6 (|Seq#Length| s@@17))) (=> (< i@@6 (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 19) 18) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 17)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i_1_1))) (< NoPerm (/ (to_real 25) (to_real 100)))) (< NoPerm (/ (to_real 25) (to_real 100)))) (not (= (|Seq#Index| s@@17 i_1) (|Seq#Index| s@@17 i_1_1))))
 :qid |stdinbpl.631:15|
 :skolemid |59|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i_1@@0))) (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i_1_1@@0))) (< NoPerm (/ (to_real 25) (to_real 100)))) (< NoPerm (/ (to_real 25) (to_real 100)))) (not (= (|Seq#Index| s@@17 i_1@@0) (|Seq#Index| s@@17 i_1_1@@0))))
 :qid |stdinbpl.631:15|
 :skolemid |59|
)) (=> (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i_1@@1)) (< NoPerm (/ (to_real 25) (to_real 100)))) (and (qpRange1 (|Seq#Index| s@@17 i_1@@1)) (= (invRecv1 (|Seq#Index| s@@17 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.637:22|
 :skolemid |60|
 :pattern ( (|Seq#Index| s@@17 i_1@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 4) (int_2_U i_1@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i_1@@1)))
 :pattern ( (|Seq#Index| s@@17 i_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U (invRecv1 o_3))) (< NoPerm (/ (to_real 25) (to_real 100)))) (qpRange1 o_3)) (= (|Seq#Index| s@@17 (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.641:22|
 :skolemid |61|
 :pattern ( (invRecv1 o_3))
))) (and (=> (= (ControlFlow 0 9) (- 0 16)) (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i_1@@2)) (>= (/ (to_real 25) (to_real 100)) NoPerm))
 :qid |stdinbpl.647:15|
 :skolemid |62|
 :pattern ( (|Seq#Index| s@@17 i_1@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 4) (int_2_U i_1@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i_1@@2)))
 :pattern ( (|Seq#Index| s@@17 i_1@@2))
))) (=> (forall ((i_1@@3 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i_1@@3)) (>= (/ (to_real 25) (to_real 100)) NoPerm))
 :qid |stdinbpl.647:15|
 :skolemid |62|
 :pattern ( (|Seq#Index| s@@17 i_1@@3))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 4) (int_2_U i_1@@3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i_1@@3)))
 :pattern ( (|Seq#Index| s@@17 i_1@@3))
)) (=> (forall ((i_1@@4 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i_1@@4)) (> (/ (to_real 25) (to_real 100)) NoPerm)) (not (= (|Seq#Index| s@@17 i_1@@4) null)))
 :qid |stdinbpl.653:22|
 :skolemid |63|
 :pattern ( (|Seq#Index| s@@17 i_1@@4))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 4) (int_2_U i_1@@4)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i_1@@4)))
 :pattern ( (|Seq#Index| s@@17 i_1@@4))
)) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U (invRecv1 o_3@@0))) (< NoPerm (/ (to_real 25) (to_real 100)))) (qpRange1 o_3@@0)) (and (=> (< NoPerm (/ (to_real 25) (to_real 100))) (= (|Seq#Index| s@@17 (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) (/ (to_real 25) (to_real 100)))))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U (invRecv1 o_3@@0))) (< NoPerm (/ (to_real 25) (to_real 100)))) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.659:22|
 :skolemid |64|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 9) (- 0 15)) (< 0 (|Seq#Length| s@@17))) (=> (< 0 (|Seq#Length| s@@17)) (and (=> (= (ControlFlow 0 9) (- 0 14)) (< 1 (|Seq#Length| s@@17))) (=> (< 1 (|Seq#Length| s@@17)) (=> (= (|Seq#Index| s@@17 0) (|Seq#Index| s@@17 1)) (and (=> (= (ControlFlow 0 9) (- 0 13)) (< 1 (|Seq#Length| s@@17))) (=> (< 1 (|Seq#Length| s@@17)) (and (=> (= (ControlFlow 0 9) (- 0 12)) (< 2 (|Seq#Length| s@@17))) (=> (< 2 (|Seq#Length| s@@17)) (=> (= (|Seq#Index| s@@17 1) (|Seq#Index| s@@17 2)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (< 2 (|Seq#Length| s@@17))) (=> (< 2 (|Seq#Length| s@@17)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< 3 (|Seq#Length| s@@17))) (=> (< 3 (|Seq#Length| s@@17)) (=> (= (|Seq#Index| s@@17 2) (|Seq#Index| s@@17 3)) (=> (and (state Heap@@9 QPMask@0) (= (ControlFlow 0 9) (- 0 8))) false)))))))))))))))))))))))))
(let ((anon9_Else_correct  (=> (and (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i1_1)) (and (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i2_1)) (not (= i1_1 i2_1)))) (not (= (|Seq#Index| s@@17 i1_1) (|Seq#Index| s@@17 i2_1))))
 :qid |stdinbpl.613:20|
 :skolemid |58|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 4) (int_2_U i1_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 4) (int_2_U i2_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 4) (int_2_U i1_1)) (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i2_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i1_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 4) (int_2_U i2_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i1_1)) (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i2_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 4) (int_2_U i1_1)) (|Seq#Index| s@@17 i2_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i1_1)) (|Seq#Index| s@@17 i2_1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 4) (int_2_U i2_1)) (|Seq#Index| s@@17 i1_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i2_1)) (|Seq#Index| s@@17 i1_1))
 :pattern ( (|Seq#Index| s@@17 i1_1) (|Seq#Index| s@@17 i2_1))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 23) 9) anon11_Else_correct) (=> (= (ControlFlow 0 23) 19) anon12_Then_correct)) (=> (= (ControlFlow 0 23) 22) anon12_Else_correct)))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i1)) (and (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i2)) (not (= i1 i2))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i1)) (and (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i2)) (not (= i1 i2)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1 0)) (=> (>= i1 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1 (|Seq#Length| s@@17))) (=> (< i1 (|Seq#Length| s@@17)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2 0)) (=> (>= i2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2 (|Seq#Length| s@@17))) (=> (< i2 (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (> (|Seq#Length| s@@17) 4) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 24) 23) anon9_Else_correct) (=> (= (ControlFlow 0 24) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 24) 7) anon10_Else_correct))))))
