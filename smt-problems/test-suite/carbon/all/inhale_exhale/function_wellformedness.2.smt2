...
(set-info :boogie-vc-id |s1Abstract#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@121 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@121 this@@111 $allocated)) (= AssumeFunctionsAbove 20)) (and (not (= this@@111 null)) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm ZeroMask this@@111 x@@8)))))
...
(set-info :boogie-vc-id |ie0Abstract#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
...
(let ((anon0_correct  (=> (state Heap@@121 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@121 this@@111 $allocated)) (= AssumeFunctionsAbove 12)) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
