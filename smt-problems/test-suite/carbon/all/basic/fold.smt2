...
(assert (forall ((Heap@@2 T@U) (r_1@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type r_1@@0) RefType)) (|valid#everUsed| (valid r_1@@0)))
 :qid |stdinbpl.213:15|
 :skolemid |27|
 :pattern ( (|valid#trigger| Heap@@2 (valid r_1@@0)))
)))
...
(assert (forall ((r_1@@1 T@U) (r2 T@U) ) (!  (=> (and (and (= (type r_1@@1) RefType) (= (type r2) RefType)) (= (valid r_1@@1) (valid r2))) (= r_1@@1 r2))
 :qid |stdinbpl.204:15|
 :skolemid |25|
...
(assert (forall ((r_1@@2 T@U) (r2@@0 T@U) ) (!  (=> (and (and (= (type r_1@@2) RefType) (= (type r2@@0) RefType)) (= (|valid#sm| r_1@@2) (|valid#sm| r2@@0))) (= r_1@@2 r2@@0))
 :qid |stdinbpl.208:15|
 :skolemid |26|
...
(assert (forall ((r_1@@3 T@U) ) (!  (=> (= (type r_1@@3) RefType) (= (getPredWandId (valid r_1@@3)) 0))
 :qid |stdinbpl.198:15|
 :skolemid |24|
 :pattern ( (valid r_1@@3))
)))
...
(assert (forall ((r_1@@4 T@U) ) (!  (=> (= (type r_1@@4) RefType) (= (PredicateMaskField (valid r_1@@4)) (|valid#sm| r_1@@4)))
 :qid |stdinbpl.190:15|
 :skolemid |22|
 :pattern ( (PredicateMaskField (valid r_1@@4)))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type r_1@@5) RefType) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Heap@6) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@3) (MapType0Type RefType))) (forall ((arg0@@28 T@U) ) (! (= (type (FrameFragment arg0@@28)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@28))
))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))))
(set-info :boogie-vc-id t1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon8_correct  (=> (not (= r_1@@5 null)) (=> (and (= Mask@4 (MapType1Store Mask@3 r_1@@5 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@3 r_1@@5 f_7)) FullPerm)))) (state Heap@6 Mask@4)) (=> (and (and (= (U_2_int (MapType0Select Heap@6 r_1@@5 f_7)) 0) (state Heap@6 Mask@4)) (and (state Heap@6 Mask@4) (= (ControlFlow 0 2) (- 0 1)))) false)))))
(let ((anon12_Else_correct  (=> (HasDirectPerm Mask@3 null (valid r_1@@5)) (=> (and (= Heap@6 Heap@4) (= (ControlFlow 0 4) 2)) anon8_correct))))
(let ((anon12_Then_correct  (=> (and (and (not (HasDirectPerm Mask@3 null (valid r_1@@5))) (= Heap@5 (MapType0Store Heap@4 null (valid r_1@@5) newVersion@0))) (and (= Heap@6 Heap@5) (= (ControlFlow 0 3) 2))) anon8_correct)))
(let ((anon6_correct  (=> (= Mask@3 (MapType1Store Mask@2 null (valid r_1@@5) (real_2_U (- (U_2_real (MapType1Select Mask@2 null (valid r_1@@5))) FullPerm)))) (and (=> (= (ControlFlow 0 5) 3) anon12_Then_correct) (=> (= (ControlFlow 0 5) 4) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon6_correct)))
(let ((anon11_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null (valid r_1@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 null (valid r_1@@5)))) (=> (= (ControlFlow 0 6) 5) anon6_correct))))))
(let ((anon4_correct  (=> (= Heap@4 (MapType0Store Heap@3 null (|valid#sm| r_1@@5) (MapType1Store (MapType0Select Heap@3 null (|valid#sm| r_1@@5)) r_1@@5 f_7 (bool_2_U true)))) (=> (and (and (state Heap@4 Mask@2) (state Heap@4 Mask@2)) (and (|valid#trigger| Heap@4 (valid r_1@@5)) (= (MapType0Select Heap@4 null (valid r_1@@5)) (FrameFragment (MapType0Select Heap@4 r_1@@5 f_7))))) (and (=> (= (ControlFlow 0 9) 6) anon11_Then_correct) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct))))))
(let ((anon10_Else_correct  (=> (HasDirectPerm Mask@2 null (valid r_1@@5)) (=> (and (= Heap@3 Heap@0) (= (ControlFlow 0 11) 9)) anon4_correct))))
(let ((anon10_Then_correct  (=> (not (HasDirectPerm Mask@2 null (valid r_1@@5))) (=> (and (and (= Heap@1 (MapType0Store Heap@0 null (|valid#sm| r_1@@5) ZeroPMask)) (= Heap@2 (MapType0Store Heap@1 null (valid r_1@@5) freshVersion@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 10) 9))) anon4_correct))))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 r_1@@5 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 r_1@@5 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (= (U_2_int (MapType0Select Heap@0 r_1@@5 f_7)) 0)) (=> (= (U_2_int (MapType0Select Heap@0 r_1@@5 f_7)) 0) (=> (= Mask@2 (MapType1Store Mask@1 null (valid r_1@@5) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (valid r_1@@5))) FullPerm)))) (=> (and (and (state Heap@0 Mask@2) (state Heap@0 Mask@2)) (and (|valid#trigger| Heap@0 (valid r_1@@5)) (= (MapType0Select Heap@0 null (valid r_1@@5)) (FrameFragment (MapType0Select Heap@0 r_1@@5 f_7))))) (and (=> (= (ControlFlow 0 12) 10) anon10_Then_correct) (=> (= (ControlFlow 0 12) 11) anon10_Else_correct)))))))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 12)) anon2_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (U_2_real (MapType1Select Mask@0 r_1@@5 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 r_1@@5 f_7))) (=> (= (ControlFlow 0 14) 12) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 r_1@@5 $allocated))) (=> (and (and (not (= r_1@@5 null)) (= Mask@0 (MapType1Store ZeroMask r_1@@5 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1@@5 f_7)) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (= FullPerm (U_2_real (MapType1Select Mask@0 r_1@@5 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 r_1@@5 f_7))) (=> (and (= Heap@0 (MapType0Store Heap@@10 r_1@@5 f_7 (int_2_U 0))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 17) 14) anon9_Then_correct) (=> (= (ControlFlow 0 17) 16) anon9_Else_correct)))))))))
