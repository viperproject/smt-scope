...
(let ((anon0_correct  (=> (and (and (and (state Heap@@17 ZeroMask) (U_2_bool (MapType0Select Heap@@17 x@@8 $allocated))) (and (U_2_bool (MapType0Select Heap@@17 y@@1 $allocated)) (not (= x@@8 null)))) (and (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_8)) FullPerm)))) (state Heap@@17 Mask@0)) (and (not (= x@@8 y@@1)) (state Heap@@17 Mask@0)))) (and (=> (= (ControlFlow 0 42) 41) anon26_Then_correct) (=> (= (ControlFlow 0 42) 34) anon26_Else_correct)))))
