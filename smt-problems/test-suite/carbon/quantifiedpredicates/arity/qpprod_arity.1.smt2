...
(assert  (and (and (= (type xs) (SeqType RefType)) (= (type Heap@@14) (MapType0Type RefType))) (= (type x@@11) RefType)))
(set-info :boogie-vc-id m5)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (|Seq#Contains| xs r_1)) (|Seq#Contains| xs r_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= r_1 r_1_1)) (not (= i@@18 i@@18)))))
 :qid |stdinbpl.1059:17|
 :skolemid |101|
 :pattern ( (neverTriggered4 r_1) (neverTriggered4 r_1_1))
)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (U_2_bool (MapType0Select Heap@@14 x@@11 $allocated))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
