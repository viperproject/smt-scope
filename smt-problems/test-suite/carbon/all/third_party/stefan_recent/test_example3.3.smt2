...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon4_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 c Counter__x (real_2_U (- (U_2_real (MapType1Select Mask@0 c Counter__x)) q_1@0)))) (= (ControlFlow 0 4) (- 0 3))) (<= q_1@0 p_1))))
(let ((anon6_Else_correct  (=> (and (= q_1@0 NoPerm) (= (ControlFlow 0 7) 4)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= q_1@0 NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= q_1@0 (U_2_real (MapType1Select Mask@0 c Counter__x)))) (=> (<= q_1@0 (U_2_real (MapType1Select Mask@0 c Counter__x))) (=> (= (ControlFlow 0 5) 4) anon4_correct))))))
(let ((anon5_Else_correct  (=> (and (= q_1@0 (/ p_1 (to_real 2))) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 8) (- 0 11)) (not (= c null))) (=> (not (= c null)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (<= NoPerm q_1@0)) (=> (<= NoPerm q_1@0) (and (=> (= (ControlFlow 0 8) (- 0 9)) (>= q_1@0 NoPerm)) (=> (>= q_1@0 NoPerm) (and (=> (= (ControlFlow 0 8) 5) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))))))))
