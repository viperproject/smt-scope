...
(declare-fun wrap (T@U) T@U)
(declare-fun PredicateType_wrapType () T@T)
(declare-fun |fun'| (T@U Int) Bool)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |fun#triggerStateless| (Int) Bool)
(declare-fun |wrap#trigger| (T@U T@U) Bool)
(declare-fun |wrap#everUsed| (T@U) Bool)
(declare-fun |Seq#Update| (T@U Int T@U) T@U)
(declare-fun |wrap#condqp1| (T@U T@U) Int)
(declare-fun |Seq#Contains| (T@U T@U) Bool)
(declare-fun |sk_wrap#condqp1| (Int Int) T@U)
...
(declare-fun |fun#frame| (T@U Int) Bool)
...
(assert  (and (= (Ctor PredicateType_wrapType) 13) (forall ((arg0@@29 T@U) ) (! (= (type (wrap arg0@@29)) (FieldType PredicateType_wrapType FrameTypeType))
 :qid |funType:wrap|
 :pattern ( (wrap arg0@@29))
))))
(assert (forall ((xs T@U) ) (!  (=> (= (type xs) (SeqType RefType)) (IsPredicateField (wrap xs)))
 :qid |stdinbpl.623:15|
 :skolemid |62|
 :pattern ( (wrap xs))
)))
(assert (forall ((Heap@@2 T@U) (a_2 Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (bool_2_U (|fun#triggerStateless| a_2))))
 :qid |stdinbpl.583:15|
 :skolemid |59|
 :pattern ( (|fun'| Heap@@2 a_2))
)))
(assert (forall ((Heap@@3 T@U) (xs@@0 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type xs@@0) (SeqType RefType))) (|wrap#everUsed| (wrap xs@@0)))
 :qid |stdinbpl.642:15|
 :skolemid |66|
 :pattern ( (|wrap#trigger| Heap@@3 (wrap xs@@0)))
)))
...
(assert (forall ((arg0@@31 Int) (arg1@@12 Int) ) (! (= (type (|sk_wrap#condqp1| arg0@@31 arg1@@12)) RefType)
 :qid |funType:sk_wrap#condqp1|
 :pattern ( (|sk_wrap#condqp1| arg0@@31 arg1@@12))
)))
(assert (forall ((Heap2Heap T@U) (Heap1Heap T@U) (xs@@1 T@U) ) (!  (=> (and (and (and (= (type Heap2Heap) (MapType0Type RefType)) (= (type Heap1Heap) (MapType0Type RefType))) (= (type xs@@1) (SeqType RefType))) (and (=  (and (|Seq#Contains| xs@@1 (|sk_wrap#condqp1| (|wrap#condqp1| Heap2Heap xs@@1) (|wrap#condqp1| Heap1Heap xs@@1))) (< NoPerm FullPerm))  (and (|Seq#Contains| xs@@1 (|sk_wrap#condqp1| (|wrap#condqp1| Heap2Heap xs@@1) (|wrap#condqp1| Heap1Heap xs@@1))) (< NoPerm FullPerm))) (=> (and (|Seq#Contains| xs@@1 (|sk_wrap#condqp1| (|wrap#condqp1| Heap2Heap xs@@1) (|wrap#condqp1| Heap1Heap xs@@1))) (< NoPerm FullPerm)) (= (U_2_int (MapType0Select Heap2Heap (|sk_wrap#condqp1| (|wrap#condqp1| Heap2Heap xs@@1) (|wrap#condqp1| Heap1Heap xs@@1)) f_7)) (U_2_int (MapType0Select Heap1Heap (|sk_wrap#condqp1| (|wrap#condqp1| Heap2Heap xs@@1) (|wrap#condqp1| Heap1Heap xs@@1)) f_7)))))) (= (|wrap#condqp1| Heap2Heap xs@@1) (|wrap#condqp1| Heap1Heap xs@@1)))
 :qid |stdinbpl.653:15|
 :skolemid |67|
 :pattern ( (|wrap#condqp1| Heap2Heap xs@@1) (|wrap#condqp1| Heap1Heap xs@@1) (succHeapTrans Heap2Heap Heap1Heap))
)))
...
(assert (forall ((xs@@2 T@U) (xs2 T@U) ) (!  (=> (and (and (= (type xs@@2) (SeqType RefType)) (= (type xs2) (SeqType RefType))) (= (wrap xs@@2) (wrap xs2))) (= xs@@2 xs2))
 :qid |stdinbpl.633:15|
 :skolemid |64|
 :pattern ( (wrap xs@@2) (wrap xs2))
)))
(assert (forall ((arg0@@35 T@U) ) (! (= (type (|wrap#sm| arg0@@35)) (FieldType PredicateType_wrapType (MapType1Type RefType boolType)))
 :qid |funType:wrap#sm|
 :pattern ( (|wrap#sm| arg0@@35))
)))
(assert (forall ((xs@@3 T@U) (xs2@@0 T@U) ) (!  (=> (and (and (= (type xs@@3) (SeqType RefType)) (= (type xs2@@0) (SeqType RefType))) (= (|wrap#sm| xs@@3) (|wrap#sm| xs2@@0))) (= xs@@3 xs2@@0))
 :qid |stdinbpl.637:15|
 :skolemid |65|
 :pattern ( (|wrap#sm| xs@@3) (|wrap#sm| xs2@@0))
)))
...
(assert (forall ((Heap@@7 T@U) (Mask@@6 T@U) (a_2@@0 Int) ) (!  (=> (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (state Heap@@7 Mask@@6)) (= (|fun'| Heap@@7 a_2@@0) (|fun#frame| EmptyFrame a_2@@0)))
 :qid |stdinbpl.590:15|
 :skolemid |60|
 :pattern ( (state Heap@@7 Mask@@6) (|fun'| Heap@@7 a_2@@0))
)))
...
(assert (forall ((Heap@@8 T@U) (a_2@@1 Int) ) (!  (=> (= (type Heap@@8) (MapType0Type RefType)) (and (= (fun Heap@@8 a_2@@1) (|fun'| Heap@@8 a_2@@1)) (dummyFunction (bool_2_U (|fun#triggerStateless| a_2@@1)))))
 :qid |stdinbpl.579:15|
 :skolemid |58|
 :pattern ( (fun Heap@@8 a_2@@1))
)))
...
(assert (forall ((xs@@4 T@U) ) (!  (=> (= (type xs@@4) (SeqType RefType)) (= (getPredWandId (wrap xs@@4)) 0))
 :qid |stdinbpl.627:15|
 :skolemid |63|
 :pattern ( (wrap xs@@4))
)))
...
(assert (forall ((xs@@5 T@U) ) (!  (=> (= (type xs@@5) (SeqType RefType)) (= (PredicateMaskField (wrap xs@@5)) (|wrap#sm| xs@@5)))
 :qid |stdinbpl.619:15|
 :skolemid |61|
 :pattern ( (PredicateMaskField (wrap xs@@5)))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type xs@@6) (SeqType RefType)) (= (type xx) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type x_3) RefType)) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type x_4) RefType)) (= (type Heap@5) (MapType0Type RefType))) (forall ((arg0@@38 T@U) ) (! (= (type (invRecv4 arg0@@38)) RefType)
 :qid |funType:invRecv4|
 :pattern ( (invRecv4 arg0@@38))
))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@2) (MapType0Type RefType))) (forall ((arg0@@39 T@U) ) (! (= (type (FrameFragment arg0@@39)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@39))
))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@13) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@40 T@U) ) (! (= (type (invRecv3 arg0@@40)) RefType)
 :qid |funType:invRecv3|
 :pattern ( (invRecv3 arg0@@40))
))) (forall ((arg0@@41 T@U) ) (! (= (type (invRecv2 arg0@@41)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@41))
))))
...
(let ((anon34_Else_correct  (=> (and (not (|Seq#Contains| xs@@6 x_4)) (= (ControlFlow 0 16) 13)) anon21_correct)))
(let ((anon34_Then_correct  (=> (|Seq#Contains| xs@@6 x_4) (and (=> (= (ControlFlow 0 14) (- 0 15)) (fun Heap@5 (U_2_int (MapType0Select Heap@5 x_4 f_7)))) (=> (fun Heap@5 (U_2_int (MapType0Select Heap@5 x_4 f_7))) (=> (= (ControlFlow 0 14) 13) anon21_correct))))))
(let ((anon32_Then_correct true))
(let ((anon17_correct true))
(let ((anon31_Then_correct  (=> (|Seq#Contains| xs@@6 x_3) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm QPMask@2 x_3 f_7)) (=> (HasDirectPerm QPMask@2 x_3 f_7) (and (=> (= (ControlFlow 0 11) 10) anon32_Then_correct) (=> (= (ControlFlow 0 11) 8) anon17_correct)))))))
(let ((anon31_Else_correct  (=> (and (not (|Seq#Contains| xs@@6 x_3)) (= (ControlFlow 0 9) 8)) anon17_correct)))
(let ((anon33_Else_correct true))
(let ((anon13_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((x_2 T@U) (x_2_1 T@U) ) (!  (=> (and (= (type x_2) RefType) (= (type x_2_1) RefType)) (=> (and (and (and (and (not (= x_2 x_2_1)) (|Seq#Contains| xs@@6 x_2)) (|Seq#Contains| xs@@6 x_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_2 x_2_1))))
 :qid |stdinbpl.891:15|
 :skolemid |89|
 :no-pattern (type x_2)
...
))) (=> (forall ((x_2@@0 T@U) (x_2_1@@0 T@U) ) (!  (=> (and (= (type x_2@@0) RefType) (= (type x_2_1@@0) RefType)) (=> (and (and (and (and (not (= x_2@@0 x_2_1@@0)) (|Seq#Contains| xs@@6 x_2@@0)) (|Seq#Contains| xs@@6 x_2_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_2@@0 x_2_1@@0))))
 :qid |stdinbpl.891:15|
 :skolemid |89|
...
)) (=> (and (and (and (forall ((x_2@@1 T@U) ) (!  (=> (= (type x_2@@1) RefType) (=> (and (|Seq#Contains| xs@@6 x_2@@1) (< NoPerm FullPerm)) (and (qpRange4 x_2@@1) (= (invRecv4 x_2@@1) x_2@@1))))
 :qid |stdinbpl.897:22|
 :skolemid |90|
 :pattern ( (MapType0Select Heap@5 x_2@@1 f_7))
 :pattern ( (MapType1Select QPMask@2 x_2@@1 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs@@6 x_2@@1))
 :pattern ( (|Seq#Contains| xs@@6 x_2@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| xs@@6 (invRecv4 o_3)) (< NoPerm FullPerm)) (qpRange4 o_3)) (= (invRecv4 o_3) o_3)))
 :qid |stdinbpl.901:22|
 :skolemid |91|
 :pattern ( (invRecv4 o_3))
))) (and (forall ((x_2@@2 T@U) ) (!  (=> (and (= (type x_2@@2) RefType) (|Seq#Contains| xs@@6 x_2@@2)) (not (= x_2@@2 null)))
 :qid |stdinbpl.907:22|
 :skolemid |92|
 :pattern ( (MapType0Select Heap@5 x_2@@2 f_7))
 :pattern ( (MapType1Select QPMask@2 x_2@@2 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs@@6 x_2@@2))
 :pattern ( (|Seq#Contains| xs@@6 x_2@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| xs@@6 (invRecv4 o_3@@0)) (< NoPerm FullPerm)) (qpRange4 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (+ (U_2_real (MapType1Select Mask@1 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| xs@@6 (invRecv4 o_3@@0)) (< NoPerm FullPerm)) (qpRange4 o_3@@0))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (U_2_real (MapType1Select Mask@1 o_3@@0 f_7))))))
 :qid |stdinbpl.913:22|
 :skolemid |93|
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 f_7))) (= (U_2_real (MapType1Select Mask@1 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@2 o_3@@1 f_5))))))
 :qid |stdinbpl.917:29|
 :skolemid |94|
...
(let ((anon29_Else_correct  (=> (HasDirectPerm Mask@1 null (wrap xs@@6)) (=> (and (= Heap@5 Heap@3) (= (ControlFlow 0 20) 17)) anon13_correct))))
(let ((anon29_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (wrap xs@@6))) (= Heap@4 (MapType0Store Heap@3 null (wrap xs@@6) newVersion@0))) (and (= Heap@5 Heap@4) (= (ControlFlow 0 19) 17))) anon13_correct)))
(let ((anon11_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (wrap xs@@6) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (wrap xs@@6))) FullPerm)))) (and (=> (= (ControlFlow 0 21) 19) anon29_Then_correct) (=> (= (ControlFlow 0 21) 20) anon29_Else_correct)))))
(let ((anon28_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 24) 21)) anon11_correct)))
(let ((anon28_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (wrap xs@@6))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (wrap xs@@6)))) (=> (= (ControlFlow 0 22) 21) anon11_correct))))))
(let ((anon9_correct  (=> (forall ((o_4 T@U) (f_8 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_8))))
(let ((A@@13 (FieldTypeInv0 (type f_8))))
 (=> (and (and (= (type o_4) RefType) (= (type f_8) (FieldType A@@13 B@@12))) (U_2_bool (MapType1Select (MapType0Select Heap@2 null (|wrap#sm| xs@@6)) o_4 f_8))) (U_2_bool (MapType1Select newPMask@0 o_4 f_8)))))
 :qid |stdinbpl.860:27|
 :skolemid |87|
 :pattern ( (MapType1Select newPMask@0 o_4 f_8))
)) (=> (and (forall ((x_1_1 T@U) ) (!  (=> (and (= (type x_1_1) RefType) (|Seq#Contains| xs@@6 x_1_1)) (U_2_bool (MapType1Select newPMask@0 x_1_1 f_7)))
 :qid |stdinbpl.864:20|
 :skolemid |88|
 :no-pattern (type x_1_1)
 :no-pattern (U_2_int x_1_1)
 :no-pattern (U_2_bool x_1_1)
)) (= Heap@3 (MapType0Store Heap@2 null (|wrap#sm| xs@@6) newPMask@0))) (=> (and (and (state Heap@3 Mask@0) (state Heap@3 Mask@0)) (and (|wrap#trigger| Heap@3 (wrap xs@@6)) (= (MapType0Select Heap@3 null (wrap xs@@6)) (FrameFragment (int_2_U (|wrap#condqp1| Heap@3 xs@@6)))))) (and (=> (= (ControlFlow 0 25) 22) anon28_Then_correct) (=> (= (ControlFlow 0 25) 24) anon28_Else_correct)))))))
(let ((anon27_Else_correct  (=> (HasDirectPerm Mask@0 null (wrap xs@@6)) (=> (and (= Heap@2 Heap@@13) (= (ControlFlow 0 27) 25)) anon9_correct))))
(let ((anon27_Then_correct  (=> (not (HasDirectPerm Mask@0 null (wrap xs@@6))) (=> (and (and (= Heap@0 (MapType0Store Heap@@13 null (|wrap#sm| xs@@6) ZeroPMask)) (= Heap@1 (MapType0Store Heap@0 null (wrap xs@@6) freshVersion@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 26) 25))) anon9_correct))))
(let ((anon24_Else_correct  (=> (and (forall ((xx_3 T@U) ) (!  (=> (and (= (type xx_3) RefType) (|Seq#Contains| xs@@6 xx_3)) (fun Heap@@13 (U_2_int (MapType0Select Heap@@13 xx_3 f_7))))
 :qid |stdinbpl.791:20|
 :skolemid |80|
 :pattern ( (|Seq#ContainsTrigger| xs@@6 xx_3))
 :pattern ( (|Seq#Contains| xs@@6 xx_3))
 :pattern ( (|fun#frame| EmptyFrame (U_2_int (MapType0Select Heap@@13 xx_3 f_7))))
)) (state Heap@@13 QPMask@0)) (and (=> (= (ControlFlow 0 28) (- 0 30)) (forall ((x@@11 T@U) (x_1 T@U) ) (!  (=> (and (= (type x@@11) RefType) (= (type x_1) RefType)) (=> (and (and (and (and (not (= x@@11 x_1)) (|Seq#Contains| xs@@6 x@@11)) (|Seq#Contains| xs@@6 x_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@11 x_1))))
 :qid |stdinbpl.813:17|
 :skolemid |81|
 :pattern ( (neverTriggered3 x@@11) (neverTriggered3 x_1))
))) (=> (forall ((x@@12 T@U) (x_1@@0 T@U) ) (!  (=> (and (= (type x@@12) RefType) (= (type x_1@@0) RefType)) (=> (and (and (and (and (not (= x@@12 x_1@@0)) (|Seq#Contains| xs@@6 x@@12)) (|Seq#Contains| xs@@6 x_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@12 x_1@@0))))
 :qid |stdinbpl.813:17|
 :skolemid |81|
 :pattern ( (neverTriggered3 x@@12) (neverTriggered3 x_1@@0))
)) (and (=> (= (ControlFlow 0 28) (- 0 29)) (forall ((x@@13 T@U) ) (!  (=> (and (= (type x@@13) RefType) (|Seq#Contains| xs@@6 x@@13)) (>= (U_2_real (MapType1Select QPMask@0 x@@13 f_7)) FullPerm))
 :qid |stdinbpl.820:17|
 :skolemid |82|
 :pattern ( (MapType0Select Heap@@13 x@@13 f_7))
 :pattern ( (MapType1Select QPMask@1 x@@13 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs@@6 x@@13))
 :pattern ( (|Seq#Contains| xs@@6 x@@13))
))) (=> (forall ((x@@14 T@U) ) (!  (=> (and (= (type x@@14) RefType) (|Seq#Contains| xs@@6 x@@14)) (>= (U_2_real (MapType1Select QPMask@0 x@@14 f_7)) FullPerm))
 :qid |stdinbpl.820:17|
 :skolemid |82|
 :pattern ( (MapType0Select Heap@@13 x@@14 f_7))
 :pattern ( (MapType1Select QPMask@1 x@@14 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs@@6 x@@14))
 :pattern ( (|Seq#Contains| xs@@6 x@@14))
)) (=> (forall ((x@@15 T@U) ) (!  (=> (= (type x@@15) RefType) (=> (and (|Seq#Contains| xs@@6 x@@15) (< NoPerm FullPerm)) (and (qpRange3 x@@15) (= (invRecv3 x@@15) x@@15))))
 :qid |stdinbpl.826:22|
 :skolemid |83|
 :pattern ( (MapType0Select Heap@@13 x@@15 f_7))
 :pattern ( (MapType1Select QPMask@1 x@@15 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs@@6 x@@15))
 :pattern ( (|Seq#Contains| xs@@6 x@@15))
)) (=> (and (and (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (|Seq#Contains| xs@@6 (invRecv3 o_3@@2)) (and (< NoPerm FullPerm) (qpRange3 o_3@@2))) (= (invRecv3 o_3@@2) o_3@@2)))
 :qid |stdinbpl.830:22|
 :skolemid |84|
 :pattern ( (invRecv3 o_3@@2))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (|Seq#Contains| xs@@6 (invRecv3 o_3@@3)) (and (< NoPerm FullPerm) (qpRange3 o_3@@3))) (and (= (invRecv3 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (- (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) FullPerm)))) (=> (not (and (|Seq#Contains| xs@@6 (invRecv3 o_3@@3)) (and (< NoPerm FullPerm) (qpRange3 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7))))))
 :qid |stdinbpl.836:22|
 :skolemid |85|
...
)) (= Mask@0 (MapType1Store QPMask@1 null (wrap xs@@6) (real_2_U (+ (U_2_real (MapType1Select QPMask@1 null (wrap xs@@6))) FullPerm)))))) (and (and (state Heap@@13 Mask@0) (state Heap@@13 Mask@0)) (and (|wrap#trigger| Heap@@13 (wrap xs@@6)) (= (MapType0Select Heap@@13 null (wrap xs@@6)) (FrameFragment (int_2_U (|wrap#condqp1| Heap@@13 xs@@6))))))) (and (=> (= (ControlFlow 0 28) 26) anon27_Then_correct) (=> (= (ControlFlow 0 28) 27) anon27_Else_correct)))))))))))
(let ((anon26_Then_correct true))
(let ((anon6_correct true))
(let ((anon25_Then_correct  (=> (|Seq#Contains| xs@@6 xx) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm QPMask@0 xx f_7)) (=> (HasDirectPerm QPMask@0 xx f_7) (and (=> (= (ControlFlow 0 5) 4) anon26_Then_correct) (=> (= (ControlFlow 0 5) 2) anon6_correct)))))))
(let ((anon25_Else_correct  (=> (and (not (|Seq#Contains| xs@@6 xx)) (= (ControlFlow 0 3) 2)) anon6_correct)))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 32)) (forall ((xx_1 T@U) (xx_1_1 T@U) ) (!  (=> (and (= (type xx_1) RefType) (= (type xx_1_1) RefType)) (=> (and (and (and (and (not (= xx_1 xx_1_1)) (|Seq#Contains| xs@@6 xx_1)) (|Seq#Contains| xs@@6 xx_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= xx_1 xx_1_1))))
 :qid |stdinbpl.744:15|
 :skolemid |74|
 :no-pattern (type xx_1)
 :no-pattern (type xx_1_1)
 :no-pattern (U_2_int xx_1)
 :no-pattern (U_2_bool xx_1)
 :no-pattern (U_2_int xx_1_1)
 :no-pattern (U_2_bool xx_1_1)
))) (=> (forall ((xx_1@@0 T@U) (xx_1_1@@0 T@U) ) (!  (=> (and (= (type xx_1@@0) RefType) (= (type xx_1_1@@0) RefType)) (=> (and (and (and (and (not (= xx_1@@0 xx_1_1@@0)) (|Seq#Contains| xs@@6 xx_1@@0)) (|Seq#Contains| xs@@6 xx_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= xx_1@@0 xx_1_1@@0))))
 :qid |stdinbpl.744:15|
 :skolemid |74|
 :no-pattern (type xx_1@@0)
 :no-pattern (type xx_1_1@@0)
 :no-pattern (U_2_int xx_1@@0)
 :no-pattern (U_2_bool xx_1@@0)
 :no-pattern (U_2_int xx_1_1@@0)
 :no-pattern (U_2_bool xx_1_1@@0)
)) (=> (and (and (and (forall ((xx_1@@1 T@U) ) (!  (=> (= (type xx_1@@1) RefType) (=> (and (|Seq#Contains| xs@@6 xx_1@@1) (< NoPerm FullPerm)) (and (qpRange2 xx_1@@1) (= (invRecv2 xx_1@@1) xx_1@@1))))
 :qid |stdinbpl.750:22|
 :skolemid |75|
 :pattern ( (MapType0Select Heap@@13 xx_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 xx_1@@1 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs@@6 xx_1@@1))
 :pattern ( (|Seq#Contains| xs@@6 xx_1@@1))
)) (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (|Seq#Contains| xs@@6 (invRecv2 o_3@@5)) (< NoPerm FullPerm)) (qpRange2 o_3@@5)) (= (invRecv2 o_3@@5) o_3@@5)))
 :qid |stdinbpl.754:22|
 :skolemid |76|
 :pattern ( (invRecv2 o_3@@5))
))) (and (forall ((xx_1@@2 T@U) ) (!  (=> (and (= (type xx_1@@2) RefType) (|Seq#Contains| xs@@6 xx_1@@2)) (not (= xx_1@@2 null)))
 :qid |stdinbpl.760:22|
 :skolemid |77|
 :pattern ( (MapType0Select Heap@@13 xx_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 xx_1@@2 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs@@6 xx_1@@2))
 :pattern ( (|Seq#Contains| xs@@6 xx_1@@2))
)) (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (|Seq#Contains| xs@@6 (invRecv2 o_3@@6)) (< NoPerm FullPerm)) (qpRange2 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@6) o_3@@6)) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@6 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| xs@@6 (invRecv2 o_3@@6)) (< NoPerm FullPerm)) (qpRange2 o_3@@6))) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@6 f_7))))))
 :qid |stdinbpl.766:22|
 :skolemid |78|
...
(let ((A@@15 (FieldTypeInv0 (type f_5@@1))))
 (=> (and (and (= (type o_3@@7) RefType) (= (type f_5@@1) (FieldType A@@15 B@@14))) (not (= f_5@@1 f_7))) (= (U_2_real (MapType1Select ZeroMask o_3@@7 f_5@@1)) (U_2_real (MapType1Select QPMask@0 o_3@@7 f_5@@1))))))
 :qid |stdinbpl.770:29|
 :skolemid |79|
 :pattern ( (MapType1Select ZeroMask o_3@@7 f_5@@1))
 :pattern ( (MapType1Select QPMask@0 o_3@@7 f_5@@1))
)) (state Heap@@13 QPMask@0)) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)))) (and (and (=> (= (ControlFlow 0 31) 28) anon24_Else_correct) (=> (= (ControlFlow 0 31) 5) anon25_Then_correct)) (=> (= (ControlFlow 0 31) 3) anon25_Else_correct)))))))
(let ((anon23_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 33) 1) anon23_Then_correct) (=> (= (ControlFlow 0 33) 31) anon23_Else_correct)))))
