...
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type xs) (SeqType RefType)) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type y@@2) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type x@@11) RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test5)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 67) (let ((anon16_correct true))
(let ((anon31_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 2 n@@13) (int_2_U i_15))) (= (ControlFlow 0 53) 45)) anon16_correct)))
(let ((anon31_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 2 n@@13) (int_2_U i_15)) (and (=> (= (ControlFlow 0 46) (- 0 52)) (>= i_15 0)) (=> (>= i_15 0) (and (=> (= (ControlFlow 0 46) (- 0 51)) (< i_15 (|Seq#Length| xs))) (=> (< i_15 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 46) (- 0 50)) (HasDirectPerm QPMask@2 (|Seq#Index| xs i_15) f_7)) (=> (HasDirectPerm QPMask@2 (|Seq#Index| xs i_15) f_7) (and (=> (= (ControlFlow 0 46) (- 0 49)) (>= i_15 0)) (=> (>= i_15 0) (and (=> (= (ControlFlow 0 46) (- 0 48)) (< i_15 (|Seq#Length| xs))) (=> (< i_15 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 46) (- 0 47)) (HasDirectPerm QPMask@0 (|Seq#Index| xs i_15) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs i_15) f_7) (=> (= (ControlFlow 0 46) 45) anon16_correct))))))))))))))))
(let ((anon30_Else_correct  (=> (and (forall ((i_5 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 2 n@@13) (int_2_U i_5)) (= (U_2_int (MapType0Select PostHeap@0 (|Seq#Index| xs i_5) f_7)) (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs i_5) f_7))))
 :qid |stdinbpl.1442:20|
 :skolemid |122|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 2 n@@13) (int_2_U i_5)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 2 n@@13) (int_2_U i_5)))
 :pattern ( (|Seq#Index| xs i_5))
)) (state PostHeap@0 QPMask@2)) (and (=> (= (ControlFlow 0 37) (- 0 44)) (< 0 (|Seq#Length| xs))) (=> (< 0 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 37) (- 0 43)) (HasDirectPerm QPMask@2 (|Seq#Index| xs 0) f_7)) (=> (HasDirectPerm QPMask@2 (|Seq#Index| xs 0) f_7) (and (=> (= (ControlFlow 0 37) (- 0 42)) (< 1 (|Seq#Length| xs))) (=> (< 1 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 37) (- 0 41)) (HasDirectPerm QPMask@0 (|Seq#Index| xs 1) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs 1) f_7) (=> (and (= (U_2_int (MapType0Select PostHeap@0 (|Seq#Index| xs 0) f_7)) (+ (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs 1) f_7)) 1)) (state PostHeap@0 QPMask@2)) (and (=> (= (ControlFlow 0 37) (- 0 40)) (< 1 (|Seq#Length| xs))) (=> (< 1 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 37) (- 0 39)) (HasDirectPerm QPMask@2 (|Seq#Index| xs 1) f_7)) (=> (HasDirectPerm QPMask@2 (|Seq#Index| xs 1) f_7) (and (=> (= (ControlFlow 0 37) (- 0 38)) (< 1 (|Seq#Length| xs))) (=> (< 1 (|Seq#Length| xs)) (=> (= (ControlFlow 0 37) (- 0 36)) (HasDirectPerm QPMask@0 (|Seq#Index| xs 1) f_7))))))))))))))))))))
(let ((anon28_Else_correct  (and (=> (= (ControlFlow 0 54) (- 0 56)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3_1))) (< NoPerm (ite (< i_3 2) FullPerm (/ (to_real 1) (to_real 10))))) (< NoPerm (ite (< i_3_1 2) FullPerm (/ (to_real 1) (to_real 10))))) (not (= (|Seq#Index| xs i_3) (|Seq#Index| xs i_3_1))))
 :qid |stdinbpl.1384:15|
 :skolemid |115|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@0))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3_1@@0))) (< NoPerm (ite (< i_3@@0 2) FullPerm (/ (to_real 1) (to_real 10))))) (< NoPerm (ite (< i_3_1@@0 2) FullPerm (/ (to_real 1) (to_real 10))))) (not (= (|Seq#Index| xs i_3@@0) (|Seq#Index| xs i_3_1@@0))))
 :qid |stdinbpl.1384:15|
 :skolemid |115|
)) (=> (and (forall ((i_3@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@1)) (< NoPerm (ite (< i_3@@1 2) FullPerm (/ (to_real 1) (to_real 10))))) (and (qpRange9 (|Seq#Index| xs i_3@@1)) (= (invRecv9 (|Seq#Index| xs i_3@@1)) i_3@@1)))
 :qid |stdinbpl.1390:22|
 :skolemid |116|
 :pattern ( (|Seq#Index| xs i_3@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_3@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@1)))
 :pattern ( (|Seq#Index| xs i_3@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv9 o_3))) (< NoPerm (ite (< (invRecv9 o_3) 2) FullPerm (/ (to_real 1) (to_real 10))))) (qpRange9 o_3)) (= (|Seq#Index| xs (invRecv9 o_3)) o_3)))
 :qid |stdinbpl.1394:22|
 :skolemid |117|
 :pattern ( (invRecv9 o_3))
))) (and (=> (= (ControlFlow 0 54) (- 0 55)) (forall ((i_3@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@2)) (>= (ite (< i_3@@2 2) FullPerm (/ (to_real 1) (to_real 10))) NoPerm))
 :qid |stdinbpl.1400:15|
 :skolemid |118|
 :pattern ( (|Seq#Index| xs i_3@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_3@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@2)))
 :pattern ( (|Seq#Index| xs i_3@@2))
))) (=> (forall ((i_3@@3 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@3)) (>= (ite (< i_3@@3 2) FullPerm (/ (to_real 1) (to_real 10))) NoPerm))
 :qid |stdinbpl.1400:15|
 :skolemid |118|
 :pattern ( (|Seq#Index| xs i_3@@3))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_3@@3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@3)))
 :pattern ( (|Seq#Index| xs i_3@@3))
)) (=> (forall ((i_3@@4 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@4)) (> (ite (< i_3@@4 2) FullPerm (/ (to_real 1) (to_real 10))) NoPerm)) (not (= (|Seq#Index| xs i_3@@4) null)))
 :qid |stdinbpl.1406:22|
 :skolemid |119|
 :pattern ( (|Seq#Index| xs i_3@@4))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_3@@4)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@4)))
 :pattern ( (|Seq#Index| xs i_3@@4))
)) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv9 o_3@@0))) (< NoPerm (ite (< (invRecv9 o_3@@0) 2) FullPerm (/ (to_real 1) (to_real 10))))) (qpRange9 o_3@@0)) (and (=> (< NoPerm (ite (< (invRecv9 o_3@@0) 2) FullPerm (/ (to_real 1) (to_real 10)))) (= (|Seq#Index| xs (invRecv9 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) (ite (< (invRecv9 o_3@@0) 2) FullPerm (/ (to_real 1) (to_real 10))))))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv9 o_3@@0))) (< NoPerm (ite (< (invRecv9 o_3@@0) 2) FullPerm (/ (to_real 1) (to_real 10))))) (qpRange9 o_3@@0))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
(let ((anon29_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_14))) (= (ControlFlow 0 35) 31)) anon12_correct)))
(let ((anon29_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_14)) (and (=> (= (ControlFlow 0 32) (- 0 34)) (>= i_14 0)) (=> (>= i_14 0) (and (=> (= (ControlFlow 0 32) (- 0 33)) (< i_14 (|Seq#Length| xs))) (=> (< i_14 (|Seq#Length| xs)) (=> (= (ControlFlow 0 32) 31) anon12_correct))))))))
...
(let ((anon33_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 2 n@@13) (int_2_U i_7_1))) (= (ControlFlow 0 20) 17)) anon21_correct)))
(let ((anon33_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 2 n@@13) (int_2_U i_7_1)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (= (U_2_int (MapType0Select Heap@1 (|Seq#Index| xs i_7_1) f_7)) (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs i_7_1) f_7)))) (=> (= (U_2_int (MapType0Select Heap@1 (|Seq#Index| xs i_7_1) f_7)) (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs i_7_1) f_7))) (=> (= (ControlFlow 0 18) 17) anon21_correct))))))
(let ((anon32_Else_correct  (=> (forall ((i_8_1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 2 n@@13) (int_2_U i_8_1)) (= (U_2_int (MapType0Select Heap@1 (|Seq#Index| xs i_8_1) f_7)) (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs i_8_1) f_7))))
 :qid |stdinbpl.1560:20|
 :skolemid |130|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 2 n@@13) (int_2_U i_8_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 2 n@@13) (int_2_U i_8_1)))
 :pattern ( (|Seq#Index| xs i_8_1))
)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (= (U_2_int (MapType0Select Heap@1 (|Seq#Index| xs 0) f_7)) (+ (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs 1) f_7)) 1))) (=> (= (U_2_int (MapType0Select Heap@1 (|Seq#Index| xs 0) f_7)) (+ (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs 1) f_7)) 1)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (= (U_2_int (MapType0Select Heap@1 (|Seq#Index| xs 1) f_7)) (+ (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs 1) f_7)) 2))) (=> (= (U_2_int (MapType0Select Heap@1 (|Seq#Index| xs 1) f_7)) (+ (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs 1) f_7)) 2)) (=> (= (ControlFlow 0 14) (- 0 13)) false))))))))
(let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 30)) (< 0 (|Seq#Length| xs))) (=> (< 0 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 21) (- 0 29)) (HasDirectPerm QPMask@0 y@@2 f_7)) (=> (HasDirectPerm QPMask@0 y@@2 f_7) (and (=> (= (ControlFlow 0 21) (- 0 28)) (= FullPerm (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs 0) f_7)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs 0) f_7))) (=> (and (= Heap@0 (MapType0Store Heap@@9 (|Seq#Index| xs 0) f_7 (int_2_U (+ (U_2_int (MapType0Select Heap@@9 y@@2 f_7)) 1)))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 21) (- 0 27)) (< 1 (|Seq#Length| xs))) (=> (< 1 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 21) (- 0 26)) (HasDirectPerm QPMask@0 x@@11 f_7)) (=> (HasDirectPerm QPMask@0 x@@11 f_7) (and (=> (= (ControlFlow 0 21) (- 0 25)) (= FullPerm (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs 1) f_7)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs 1) f_7))) (=> (and (= Heap@1 (MapType0Store Heap@0 (|Seq#Index| xs 1) f_7 (int_2_U (+ (U_2_int (MapType0Select Heap@0 x@@11 f_7)) 1)))) (state Heap@1 QPMask@0)) (and (=> (= (ControlFlow 0 21) (- 0 24)) (forall ((i_6 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_6)) (dummyFunction (MapType0Select Heap@1 (|Seq#Index| xs i_6) f_7))) (>= (ite (< i_6 2) FullPerm (/ (to_real 1) (to_real 10))) NoPerm))
 :qid |stdinbpl.1512:17|
 :skolemid |123|
 :pattern ( (|Seq#Index| xs i_6))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_6)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_6)))
 :pattern ( (|Seq#Index| xs i_6))
))) (=> (forall ((i_6@@0 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_6@@0)) (dummyFunction (MapType0Select Heap@1 (|Seq#Index| xs i_6@@0) f_7))) (>= (ite (< i_6@@0 2) FullPerm (/ (to_real 1) (to_real 10))) NoPerm))
 :qid |stdinbpl.1512:17|
 :skolemid |123|
 :pattern ( (|Seq#Index| xs i_6@@0))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_6@@0)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_6@@0)))
 :pattern ( (|Seq#Index| xs i_6@@0))
)) (and (=> (= (ControlFlow 0 21) (- 0 23)) (forall ((i_6@@1 Int) (i_6_1 Int) ) (!  (=> (and (and (and (and (not (= i_6@@1 i_6_1)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_6@@1))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_6_1))) (< NoPerm (ite (< i_6@@1 2) FullPerm (/ (to_real 1) (to_real 10))))) (< NoPerm (ite (< i_6_1 2) FullPerm (/ (to_real 1) (to_real 10))))) (not (= (|Seq#Index| xs i_6@@1) (|Seq#Index| xs i_6_1))))
 :qid |stdinbpl.1519:17|
 :skolemid |124|
 :pattern ( (neverTriggered10 i_6@@1) (neverTriggered10 i_6_1))
))) (=> (forall ((i_6@@2 Int) (i_6_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_6@@2 i_6_1@@0)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_6@@2))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_6_1@@0))) (< NoPerm (ite (< i_6@@2 2) FullPerm (/ (to_real 1) (to_real 10))))) (< NoPerm (ite (< i_6_1@@0 2) FullPerm (/ (to_real 1) (to_real 10))))) (not (= (|Seq#Index| xs i_6@@2) (|Seq#Index| xs i_6_1@@0))))
 :qid |stdinbpl.1519:17|
 :skolemid |124|
 :pattern ( (neverTriggered10 i_6@@2) (neverTriggered10 i_6_1@@0))
)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((i_6@@3 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_6@@3)) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs i_6@@3) f_7)) (ite (< i_6@@3 2) FullPerm (/ (to_real 1) (to_real 10)))))
 :qid |stdinbpl.1526:17|
 :skolemid |125|
 :pattern ( (|Seq#Index| xs i_6@@3))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_6@@3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_6@@3)))
 :pattern ( (|Seq#Index| xs i_6@@3))
))) (=> (forall ((i_6@@4 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_6@@4)) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs i_6@@4) f_7)) (ite (< i_6@@4 2) FullPerm (/ (to_real 1) (to_real 10)))))
 :qid |stdinbpl.1526:17|
 :skolemid |125|
 :pattern ( (|Seq#Index| xs i_6@@4))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_6@@4)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_6@@4)))
 :pattern ( (|Seq#Index| xs i_6@@4))
)) (=> (and (and (forall ((i_6@@5 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_6@@5)) (< NoPerm (ite (< i_6@@5 2) FullPerm (/ (to_real 1) (to_real 10))))) (and (qpRange10 (|Seq#Index| xs i_6@@5)) (= (invRecv10 (|Seq#Index| xs i_6@@5)) i_6@@5)))
 :qid |stdinbpl.1532:22|
 :skolemid |126|
 :pattern ( (|Seq#Index| xs i_6@@5))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_6@@5)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_6@@5)))
 :pattern ( (|Seq#Index| xs i_6@@5))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv10 o_3@@2))) (and (< NoPerm (ite (< (invRecv10 o_3@@2) 2) FullPerm (/ (to_real 1) (to_real 10)))) (qpRange10 o_3@@2))) (= (|Seq#Index| xs (invRecv10 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.1536:22|
 :skolemid |127|
 :pattern ( (invRecv10 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv10 o_3@@3))) (and (< NoPerm (ite (< (invRecv10 o_3@@3) 2) FullPerm (/ (to_real 1) (to_real 10)))) (qpRange10 o_3@@3))) (and (= (|Seq#Index| xs (invRecv10 o_3@@3)) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (- (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (ite (< (invRecv10 o_3@@3) 2) FullPerm (/ (to_real 1) (to_real 10))))))) (=> (not (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv10 o_3@@3))) (and (< NoPerm (ite (< (invRecv10 o_3@@3) 2) FullPerm (/ (to_real 1) (to_real 10)))) (qpRange10 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7))))))
...
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 58) (- 0 60)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1_1))) (< NoPerm (/ (to_real 1) (to_real 10)))) (< NoPerm (/ (to_real 1) (to_real 10)))) (not (= (|Seq#Index| xs i_1) (|Seq#Index| xs i_1_1))))
 :qid |stdinbpl.1321:15|
 :skolemid |108|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@0))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1_1@@0))) (< NoPerm (/ (to_real 1) (to_real 10)))) (< NoPerm (/ (to_real 1) (to_real 10)))) (not (= (|Seq#Index| xs i_1@@0) (|Seq#Index| xs i_1_1@@0))))
 :qid |stdinbpl.1321:15|
 :skolemid |108|
)) (=> (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@1)) (< NoPerm (/ (to_real 1) (to_real 10)))) (and (qpRange8 (|Seq#Index| xs i_1@@1)) (= (invRecv8 (|Seq#Index| xs i_1@@1)) i_1@@1)))
 :qid |stdinbpl.1327:22|
 :skolemid |109|
 :pattern ( (|Seq#Index| xs i_1@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_1@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@1)))
 :pattern ( (|Seq#Index| xs i_1@@1))
)) (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv8 o_3@@5))) (< NoPerm (/ (to_real 1) (to_real 10)))) (qpRange8 o_3@@5)) (= (|Seq#Index| xs (invRecv8 o_3@@5)) o_3@@5)))
 :qid |stdinbpl.1331:22|
 :skolemid |110|
 :pattern ( (invRecv8 o_3@@5))
))) (and (=> (= (ControlFlow 0 58) (- 0 59)) (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@2)) (>= (/ (to_real 1) (to_real 10)) NoPerm))
 :qid |stdinbpl.1337:15|
 :skolemid |111|
 :pattern ( (|Seq#Index| xs i_1@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_1@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@2)))
 :pattern ( (|Seq#Index| xs i_1@@2))
))) (=> (forall ((i_1@@3 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@3)) (>= (/ (to_real 1) (to_real 10)) NoPerm))
 :qid |stdinbpl.1337:15|
 :skolemid |111|
 :pattern ( (|Seq#Index| xs i_1@@3))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_1@@3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@3)))
 :pattern ( (|Seq#Index| xs i_1@@3))
)) (=> (forall ((i_1@@4 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@4)) (> (/ (to_real 1) (to_real 10)) NoPerm)) (not (= (|Seq#Index| xs i_1@@4) null)))
 :qid |stdinbpl.1343:22|
 :skolemid |112|
 :pattern ( (|Seq#Index| xs i_1@@4))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_1@@4)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@4)))
 :pattern ( (|Seq#Index| xs i_1@@4))
)) (=> (and (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv8 o_3@@6))) (< NoPerm (/ (to_real 1) (to_real 10)))) (qpRange8 o_3@@6)) (and (=> (< NoPerm (/ (to_real 1) (to_real 10))) (= (|Seq#Index| xs (invRecv8 o_3@@6)) o_3@@6)) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (+ (U_2_real (MapType1Select Mask@1 o_3@@6 f_7)) (/ (to_real 1) (to_real 10)))))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv8 o_3@@6))) (< NoPerm (/ (to_real 1) (to_real 10)))) (qpRange8 o_3@@6))) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (U_2_real (MapType1Select Mask@1 o_3@@6 f_7))))))
...
(let ((A@@14 (FieldTypeInv0 (type f_5@@1))))
 (=> (and (and (= (type o_3@@7) RefType) (= (type f_5@@1) (FieldType A@@14 B@@13))) (not (= f_5@@1 f_7))) (= (U_2_real (MapType1Select Mask@1 o_3@@7 f_5@@1)) (U_2_real (MapType1Select QPMask@0 o_3@@7 f_5@@1))))))
 :qid |stdinbpl.1353:29|
 :skolemid |114|
 :pattern ( (MapType1Select Mask@1 o_3@@7 f_5@@1))
 :pattern ( (MapType1Select QPMask@0 o_3@@7 f_5@@1))
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 58) 57) anon27_Then_correct) (=> (= (ControlFlow 0 58) 21) anon27_Else_correct)))))))))))
(let ((anon7_correct true))
(let ((anon26_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_13))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon26_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_13)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_13 0)) (=> (>= i_13 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_13 (|Seq#Length| xs))) (=> (< i_13 (|Seq#Length| xs)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon23_Else_correct  (=> (and (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i1_1)) (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i2_1)) (not (= i1_1 i2_1)))) (not (= (|Seq#Index| xs i1_1) (|Seq#Index| xs i2_1))))
 ...
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i1_1)) (|Seq#Index| xs i2_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i1_1)) (|Seq#Index| xs i2_1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i2_1)) (|Seq#Index| xs i1_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i2_1)) (|Seq#Index| xs i1_1))
 :pattern ( (|Seq#Index| xs i1_1) (|Seq#Index| xs i2_1))
)) (state Heap@@9 Mask@1)) (and (and (=> (= (ControlFlow 0 61) 58) anon25_Else_correct) (=> (= (ControlFlow 0 61) 9) anon26_Then_correct)) (=> (= (ControlFlow 0 61) 12) anon26_Else_correct)))))
(let ((anon3_correct true))
(let ((anon24_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i1_4)) (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i2_4)) (not (= i1_4 i2_4))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon24_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i1_4)) (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i2_4)) (not (= i1_4 i2_4)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_4 0)) (=> (>= i1_4 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_4 (|Seq#Length| xs))) (=> (< i1_4 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_4 0)) (=> (>= i2_4 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_4 (|Seq#Length| xs))) (=> (< i2_4 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@11 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@9 y@@2 $allocated)) (= (|Seq#Length| xs) n@@13)) (and (> n@@13 2) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 62) (- 0 66)) (< 0 (|Seq#Length| xs))) (=> (< 0 (|Seq#Length| xs)) (=> (= (|Seq#Index| xs 0) x@@11) (and (=> (= (ControlFlow 0 62) (- 0 65)) (< 1 (|Seq#Length| xs))) (=> (< 1 (|Seq#Length| xs)) (=> (= (|Seq#Index| xs 1) y@@2) (=> (and (state Heap@@9 ZeroMask) (= perm@0 (/ (to_real 9) (to_real 10)))) (and (=> (= (ControlFlow 0 62) (- 0 64)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= x@@11 null))) (= Mask@0 (MapType1Store ZeroMask x@@11 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@11 f_7)) perm@0))))) (and (state Heap@@9 Mask@0) (= perm@1 (/ (to_real 9) (to_real 10))))) (and (=> (= (ControlFlow 0 62) (- 0 63)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (and (=> (> perm@1 NoPerm) (not (= y@@2 null))) (= Mask@1 (MapType1Store Mask@0 y@@2 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@2 f_7)) perm@1))))) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1))) (and (and (=> (= (ControlFlow 0 62) 61) anon23_Else_correct) (=> (= (ControlFlow 0 62) 2) anon24_Then_correct)) (=> (= (ControlFlow 0 62) 7) anon24_Else_correct)))))))))))))))))))
