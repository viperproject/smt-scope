...
(let ((anon6_Then_correct  (=> (and (and (and (state Heap@@9 ZeroMask) (<= i@0 n)) (and (state Heap@@9 ZeroMask) (< i@0 n))) (and (and (state Heap@@9 ZeroMask) (= i@1 (+ i@0 1))) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 3) (- 0 2))))) (<= i@1 n))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (> n 0)) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= 0 n)) (=> (<= 0 n) (and (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))))
