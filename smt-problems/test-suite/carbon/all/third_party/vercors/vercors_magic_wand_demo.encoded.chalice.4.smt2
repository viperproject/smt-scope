...
(declare-fun this$_7@@5 () T@U)
(declare-fun perm@0 () Real)
(assert  (and (= (type Heap@@26) (MapType0Type RefType)) (= (type this$_7@@5) RefType)))
(set-info :boogie-vc-id |WandDemoreadonly$#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@26 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@26 this$_7@@5 $allocated))) (and (= perm@0 (/ (to_real 25) (to_real 100))) (= (ControlFlow 0 2) (- 0 1)))) (>= perm@0 NoPerm)))))
