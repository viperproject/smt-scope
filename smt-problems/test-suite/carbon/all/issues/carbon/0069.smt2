...
(declare-fun |postFunction'| (T@U T@U) Int)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |postFunction#triggerStateless| (T@U) Int)
(declare-fun |postFunction2'| (T@U T@U) Int)
(declare-fun |postFunction2#triggerStateless| (T@U) Int)
(declare-fun postFunction (T@U T@U) Int)
(declare-fun postFunction2 (T@U T@U) Int)
...
(declare-fun |postFunction2#trigger| (T@U T@U) Bool)
(declare-fun FrameFragment (T@U) T@U)
(declare-fun |postFunction#trigger| (T@U T@U) Bool)
(declare-fun FullPerm () Real)
(declare-fun |postFunction#frame| (T@U T@U) Int)
(declare-fun |postFunction2#frame| (T@U T@U) Int)
...
(assert (forall ((Heap@@2 T@U) (this T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type this) RefType)) (dummyFunction (int_2_U (|postFunction#triggerStateless| this))))
 :qid |stdinbpl.198:15|
 :skolemid |23|
 :pattern ( (|postFunction'| Heap@@2 this))
)))
(assert (forall ((Heap@@3 T@U) (this@@0 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type this@@0) RefType)) (dummyFunction (int_2_U (|postFunction2#triggerStateless| this@@0))))
 :qid |stdinbpl.270:15|
 :skolemid |28|
 :pattern ( (|postFunction2'| Heap@@3 this@@0))
)))
...
(assert (forall ((Heap@@5 T@U) (this@@1 T@U) ) (!  (=> (and (= (type Heap@@5) (MapType0Type RefType)) (= (type this@@1) RefType)) (and (= (postFunction Heap@@5 this@@1) (|postFunction'| Heap@@5 this@@1)) (dummyFunction (int_2_U (|postFunction#triggerStateless| this@@1)))))
 :qid |stdinbpl.194:15|
 :skolemid |22|
 :pattern ( (postFunction Heap@@5 this@@1))
)))
(assert (forall ((Heap@@6 T@U) (this@@2 T@U) ) (!  (=> (and (= (type Heap@@6) (MapType0Type RefType)) (= (type this@@2) RefType)) (and (= (postFunction2 Heap@@6 this@@2) (|postFunction2'| Heap@@6 this@@2)) (dummyFunction (int_2_U (|postFunction2#triggerStateless| this@@2)))))
 :qid |stdinbpl.266:15|
 :skolemid |27|
 :pattern ( (postFunction2 Heap@@6 this@@2))
)))
...
(assert (forall ((Heap@@9 T@U) (Mask@@6 T@U) (this@@3 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (= (type this@@3) RefType)) (and (state Heap@@9 Mask@@6) (< AssumeFunctionsAbove 0))) (not (= this@@3 null))) (= (postFunction Heap@@9 this@@3) 1))
 :qid |stdinbpl.204:15|
 :skolemid |24|
 :pattern ( (state Heap@@9 Mask@@6) (postFunction Heap@@9 this@@3))
)))
(assert (forall ((Heap@@10 T@U) (Mask@@7 T@U) (this@@4 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (= (type this@@4) RefType)) (and (state Heap@@10 Mask@@7) (< AssumeFunctionsAbove 1))) (not (= this@@4 null))) (= (postFunction2 Heap@@10 this@@4) 1))
 :qid |stdinbpl.276:15|
 :skolemid |29|
 :pattern ( (state Heap@@10 Mask@@7) (postFunction2 Heap@@10 this@@4))
)))
(assert (forall ((arg0@@26 T@U) ) (! (= (type (FrameFragment arg0@@26)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@26))
)))
(assert (forall ((Heap@@11 T@U) (Mask@@8 T@U) (this@@5 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type Mask@@8) (MapType1Type RefType realType))) (= (type this@@5) RefType)) (and (state Heap@@11 Mask@@8) (or (< AssumeFunctionsAbove 1) (|postFunction2#trigger| (FrameFragment (MapType0Select Heap@@11 this@@5 x@@8)) this@@5)))) (not (= this@@5 null))) (= (U_2_int (MapType0Select Heap@@11 this@@5 x@@8)) 0))
 :qid |stdinbpl.289:15|
 :skolemid |31|
 :pattern ( (state Heap@@11 Mask@@8) (|postFunction2'| Heap@@11 this@@5))
)))
...
(assert (forall ((Heap@@12 T@U) (Mask@@9 T@U) (this@@6 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (= (type this@@6) RefType)) (and (state Heap@@12 Mask@@9) (or (< AssumeFunctionsAbove 0) (|postFunction#trigger| EmptyFrame this@@6)))) (not (= this@@6 null))) (= (U_2_int (MapType0Select Heap@@12 this@@6 x@@8)) 0))
 :qid |stdinbpl.217:15|
 :skolemid |26|
 :pattern ( (state Heap@@12 Mask@@9) (|postFunction'| Heap@@12 this@@6))
)))
...
(assert (forall ((Heap@@15 T@U) (Mask@@13 T@U) (this@@7 T@U) ) (!  (=> (and (and (and (= (type Heap@@15) (MapType0Type RefType)) (= (type Mask@@13) (MapType1Type RefType realType))) (= (type this@@7) RefType)) (state Heap@@15 Mask@@13)) (= (|postFunction'| Heap@@15 this@@7) (|postFunction#frame| EmptyFrame this@@7)))
 :qid |stdinbpl.211:15|
 :skolemid |25|
 :pattern ( (state Heap@@15 Mask@@13) (|postFunction'| Heap@@15 this@@7))
)))
(assert (forall ((Heap@@16 T@U) (Mask@@14 T@U) (this@@8 T@U) ) (!  (=> (and (and (and (= (type Heap@@16) (MapType0Type RefType)) (= (type Mask@@14) (MapType1Type RefType realType))) (= (type this@@8) RefType)) (state Heap@@16 Mask@@14)) (= (|postFunction2'| Heap@@16 this@@8) (|postFunction2#frame| (FrameFragment (MapType0Select Heap@@16 this@@8 x@@8)) this@@8)))
 :qid |stdinbpl.283:15|
 :skolemid |30|
 :pattern ( (state Heap@@16 Mask@@14) (|postFunction2'| Heap@@16 this@@8))
)))
...
(assert  (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type this@@9) RefType)) (= (type Heap@@19) (MapType0Type RefType))))
(set-info :boogie-vc-id postMethod)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (= (U_2_int (MapType0Select Heap@@19 this@@9 x@@8)) 0))))
(let ((anon3_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm ZeroMask this@@9 x@@8))))
(let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@19 this@@9 $allocated))) (and (not (= this@@9 null)) (state Heap@@19 ZeroMask))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
