...
(assert  (and (and (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type y_2) RefType)) (= (type y_5) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type y_6) RefType)) (= (type y_4) RefType)) (= (type y@@1) RefType)) (= (type x@@8) RefType)))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 36) (let ((anon4_correct true))
(let ((anon27_Else_correct  (=> (and (not (HasDirectPerm Mask@0 y@@1 f_7)) (= (ControlFlow 0 32) 29)) anon4_correct)))
(let ((anon27_Then_correct  (=> (HasDirectPerm Mask@0 y@@1 f_7) (and (=> (= (ControlFlow 0 30) (- 0 31)) (HasDirectPerm Mask@0 y@@1 f_7)) (=> (HasDirectPerm Mask@0 y@@1 f_7) (=> (= (ControlFlow 0 30) 29) anon4_correct))))))
(let ((anon13_correct true))
(let ((anon32_Else_correct  (=> (and (not (HasDirectPerm Mask@0 y_4 f_7)) (= (ControlFlow 0 24) 21)) anon13_correct)))
(let ((anon32_Then_correct  (=> (HasDirectPerm Mask@0 y_4 f_7) (and (=> (= (ControlFlow 0 22) (- 0 23)) (HasDirectPerm Mask@0 y_4 f_7)) (=> (HasDirectPerm Mask@0 y_4 f_7) (=> (= (ControlFlow 0 22) 21) anon13_correct))))))
(let ((anon23_correct true))
(let ((anon37_Else_correct  (=> (and (not (HasDirectPerm Mask@0 y_6 f_7)) (= (ControlFlow 0 14) 11)) anon23_correct)))
(let ((anon37_Then_correct  (=> (HasDirectPerm Mask@0 y_6 f_7) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm Mask@0 y_6 f_7)) (=> (HasDirectPerm Mask@0 y_6 f_7) (=> (= (ControlFlow 0 12) 11) anon23_correct))))))
(let ((anon36_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((y_9 T@U) ) (!  (=> (and (= (type y_9) RefType) (HasDirectPerm Mask@0 y_9 f_7)) false)
 :qid |stdinbpl.309:15|
 :skolemid |25|
 :pattern ( (MapType1Select Mask@0 y_9 f_7))
 :pattern ( (MapType0Select Heap@@9 y_9 f_7))
)))))
(let ((anon20_correct  (=> (state Heap@@9 Mask@0) (and (and (=> (= (ControlFlow 0 15) 10) anon36_Else_correct) (=> (= (ControlFlow 0 15) 12) anon37_Then_correct)) (=> (= (ControlFlow 0 15) 14) anon37_Else_correct)))))
(let ((anon35_Else_correct  (=> (and (not (forall ((y_7 T@U) ) (!  (=> (and (= (type y_7) RefType) (HasDirectPerm Mask@0 y_7 f_7)) false)
 :qid |stdinbpl.287:17|
 :skolemid |24|
 :pattern ( (MapType1Select Mask@0 y_7 f_7))
 :pattern ( (MapType0Select Heap@@9 y_7 f_7))
))) (= (ControlFlow 0 18) 15)) anon20_correct)))
(let ((anon35_Then_correct  (=> (forall ((y_7@@0 T@U) ) (!  (=> (and (= (type y_7@@0) RefType) (HasDirectPerm Mask@0 y_7@@0 f_7)) false)
 :qid |stdinbpl.287:17|
 :skolemid |24|
 :pattern ( (MapType1Select Mask@0 y_7@@0 f_7))
 :pattern ( (MapType0Select Heap@@9 y_7@@0 f_7))
)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (not b_2)) (=> (not b_2) (=> (= (ControlFlow 0 16) 15) anon20_correct))))))
(let ((anon17_correct true))
(let ((anon34_Else_correct  (=> (and (not (HasDirectPerm Mask@0 y_5 f_7)) (= (ControlFlow 0 8) 5)) anon17_correct)))
(let ((anon34_Then_correct  (=> (HasDirectPerm Mask@0 y_5 f_7) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm Mask@0 y_5 f_7)) (=> (HasDirectPerm Mask@0 y_5 f_7) (=> (= (ControlFlow 0 6) 5) anon17_correct))))))
(let ((anon14_correct  (=> (state Heap@@9 Mask@0) (and (and (and (=> (= (ControlFlow 0 19) 16) anon35_Then_correct) (=> (= (ControlFlow 0 19) 18) anon35_Else_correct)) (=> (= (ControlFlow 0 19) 6) anon34_Then_correct)) (=> (= (ControlFlow 0 19) 8) anon34_Else_correct)))))
(let ((anon30_Then_correct  (=> (forall ((y_3 T@U) ) (!  (=> (and (= (type y_3) RefType) (HasDirectPerm Mask@0 y_3 f_7)) false)
 :qid |stdinbpl.259:17|
 :skolemid |23|
 :pattern ( (MapType1Select Mask@0 y_3 f_7))
 :pattern ( (MapType0Select Heap@@9 y_3 f_7))
)) (and (and (=> (= (ControlFlow 0 25) 19) anon14_correct) (=> (= (ControlFlow 0 25) 22) anon32_Then_correct)) (=> (= (ControlFlow 0 25) 24) anon32_Else_correct)))))
(let ((anon30_Else_correct  (=> (and (not (forall ((y_3@@0 T@U) ) (!  (=> (and (= (type y_3@@0) RefType) (HasDirectPerm Mask@0 y_3@@0 f_7)) false)
 :qid |stdinbpl.259:17|
 :skolemid |23|
 :pattern ( (MapType1Select Mask@0 y_3@@0 f_7))
 :pattern ( (MapType0Select Heap@@9 y_3@@0 f_7))
))) (= (ControlFlow 0 20) 19)) anon14_correct)))
(let ((anon8_correct true))
(let ((anon29_Else_correct  (=> (and (not (HasDirectPerm Mask@0 y_2 f_7)) (= (ControlFlow 0 4) 1)) anon8_correct)))
(let ((anon29_Then_correct  (=> (HasDirectPerm Mask@0 y_2 f_7) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 y_2 f_7)) (=> (HasDirectPerm Mask@0 y_2 f_7) (=> (= (ControlFlow 0 2) 1) anon8_correct))))))
(let ((anon5_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (or b_2 (forall ((y_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (HasDirectPerm Mask@0 y_1 f_7)) false)
 :qid |stdinbpl.241:22|
 :skolemid |22|
 :pattern ( (MapType1Select Mask@0 y_1 f_7))
 :pattern ( (MapType0Select Heap@@9 y_1 f_7))
)))) (=> (or b_2 (forall ((y_1@@0 T@U) ) (!  (=> (and (= (type y_1@@0) RefType) (HasDirectPerm Mask@0 y_1@@0 f_7)) false)
 :qid |stdinbpl.241:22|
 :skolemid |22|
 :pattern ( (MapType1Select Mask@0 y_1@@0 f_7))
 :pattern ( (MapType0Select Heap@@9 y_1@@0 f_7))
))) (=> (state Heap@@9 Mask@0) (and (and (and (=> (= (ControlFlow 0 26) 25) anon30_Then_correct) (=> (= (ControlFlow 0 26) 20) anon30_Else_correct)) (=> (= (ControlFlow 0 26) 2) anon29_Then_correct)) (=> (= (ControlFlow 0 26) 4) anon29_Else_correct)))))))
(let ((anon25_Then_correct  (=> (not b_2) (and (and (=> (= (ControlFlow 0 33) 26) anon5_correct) (=> (= (ControlFlow 0 33) 30) anon27_Then_correct)) (=> (= (ControlFlow 0 33) 32) anon27_Else_correct)))))
(let ((anon25_Else_correct  (=> (and b_2 (= (ControlFlow 0 28) 26)) anon5_correct)))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated)) (= perm@0 (ite b_2 FullPerm NoPerm))) (and (=> (= (ControlFlow 0 34) (- 0 35)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= x@@8 null))) (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) perm@0))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 34) 33) anon25_Then_correct) (=> (= (ControlFlow 0 34) 28) anon25_Else_correct)))))))))
