...
(assert  (and (= (type Result) RefType) (= (type Heap@@33) (MapType0Type RefType))))
...
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (and (= AssumeFunctionsAbove 4) (= (typeof Result) vint)) (and (state Heap@@33 ZeroMask) (state Heap@@33 ZeroMask))) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
