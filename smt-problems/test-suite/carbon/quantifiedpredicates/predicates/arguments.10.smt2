...
(let ((anon6_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (valid this@@5 b_1@@5) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid this@@5 b_1@@5))) FullPerm)))) (and (=> (= (ControlFlow 0 37) 35) anon34_Then_correct) (=> (= (ControlFlow 0 37) 36) anon34_Else_correct)))))
(let ((anon33_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 40) 37)) anon6_correct)))
(let ((anon33_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 38) (- 0 39)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid this@@5 b_1@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid this@@5 b_1@@5)))) (=> (= (ControlFlow 0 38) 37) anon6_correct))))))
...
(let ((anon31_Else_correct  (and (=> (= (ControlFlow 0 42) (- 0 43)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| xs x_1)) (|Seq#Contains| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.976:15|
 :skolemid |124|
 :no-pattern (type x_1)
...
)) (=> (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| xs x_1@@1) (< NoPerm FullPerm)) (and (qpRange1 x_1@@1) (= (invRecv1 x_1@@1) x_1@@1))))
 :qid |stdinbpl.982:22|
 :skolemid |125|
...
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| xs (invRecv1 o_3)) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.986:22|
 :skolemid |126|
 :pattern ( (invRecv1 o_3))
))) (=> (and (and (and (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (|Seq#Contains| xs x_1@@2)) (not (= x_1@@2 null)))
 :qid |stdinbpl.992:22|
 :skolemid |127|
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| xs (invRecv1 o_3@@0)) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 unrelatedField)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 unrelatedField)) FullPerm)))) (=> (not (and (and (|Seq#Contains| xs (invRecv1 o_3@@0)) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 unrelatedField)) (U_2_real (MapType1Select ZeroMask o_3@@0 unrelatedField))))))
 :qid |stdinbpl.998:22|
 :skolemid |128|
 :pattern ( (MapType1Select QPMask@0 o_3@@0 unrelatedField))
))) (and (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 unrelatedField))) (= (U_2_real (MapType1Select ZeroMask o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.1002:29|
 :skolemid |129|
 :pattern ( (MapType1Select ZeroMask o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
)) (state Heap@@10 QPMask@0))) (and (and (state Heap@@10 QPMask@0) (= Mask@0 (MapType1Store QPMask@0 null (valid this@@5 b_1@@5) (real_2_U (+ (U_2_real (MapType1Select QPMask@0 null (valid this@@5 b_1@@5))) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)))) (and (=> (= (ControlFlow 0 42) 2) anon32_Then_correct) (=> (= (ControlFlow 0 42) 41) anon32_Else_correct))))))))
(let ((anon31_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 this@@5 $allocated))) (and (|Seq#Contains| xs this@@5) (state Heap@@10 ZeroMask))) (and (=> (= (ControlFlow 0 44) 1) anon31_Then_correct) (=> (= (ControlFlow 0 44) 42) anon31_Else_correct)))))
