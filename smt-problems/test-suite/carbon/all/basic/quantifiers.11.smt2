...
(set-info :boogie-vc-id |g2#definedness|)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 36) (let ((anon29_correct true))
(let ((anon50_Else_correct  (=> (and (not (and (<= 0 v2_1) (and (< v2_1 3) (f2 Heap@@33 v2_1)))) (= (ControlFlow 0 33) 30)) anon29_correct)))
(let ((anon50_Then_correct  (=> (and (<= 0 v2_1) (and (< v2_1 3) (f2 Heap@@33 v2_1))) (and (=> (= (ControlFlow 0 31) (- 0 32)) (exists ((j2_1 Int) ) (!  (and (<= 0 j2_1) (and (< j2_1 3) (g2 Heap@@33 j2_1 v2_1)))
 :qid |stdinbpl.2333:19|
 :skolemid |169|
 :pattern ( (|g2#frame| EmptyFrame j2_1 v2_1))
))) (=> (exists ((j2_1@@0 Int) ) (!  (and (<= 0 j2_1@@0) (and (< j2_1@@0 3) (g2 Heap@@33 j2_1@@0 v2_1)))
 :qid |stdinbpl.2333:19|
 :skolemid |169|
 :pattern ( (|g2#frame| EmptyFrame j2_1@@0 v2_1))
)) (=> (= (ControlFlow 0 31) 30) anon29_correct))))))
(let ((anon43_Then_correct true))
(let ((anon48_Then_correct true))
(let ((anon24_correct true))
(let ((anon47_Then_correct  (=> (< j2 3) (and (=> (= (ControlFlow 0 22) 21) anon48_Then_correct) (=> (= (ControlFlow 0 22) 18) anon24_correct)))))
(let ((anon47_Else_correct  (=> (and (<= 3 j2) (= (ControlFlow 0 20) 18)) anon24_correct)))
(let ((anon46_Then_correct  (=> (<= 0 j2) (and (=> (= (ControlFlow 0 23) 22) anon47_Then_correct) (=> (= (ControlFlow 0 23) 20) anon47_Else_correct)))))
(let ((anon46_Else_correct  (=> (and (< j2 0) (= (ControlFlow 0 19) 18)) anon24_correct)))
(let ((anon25_correct true))
(let ((anon44_Then_correct  (=> (and (<= 0 v2_2) (and (< v2_2 3) (f2 Heap@@33 v2_2))) (and (and (=> (= (ControlFlow 0 24) 16) anon25_correct) (=> (= (ControlFlow 0 24) 23) anon46_Then_correct)) (=> (= (ControlFlow 0 24) 19) anon46_Else_correct)))))
(let ((anon44_Else_correct  (=> (and (not (and (<= 0 v2_2) (and (< v2_2 3) (f2 Heap@@33 v2_2)))) (= (ControlFlow 0 17) 16)) anon25_correct)))
(let ((anon42_Then_correct  (=> (< v2_2 3) (and (and (=> (= (ControlFlow 0 28) 27) anon43_Then_correct) (=> (= (ControlFlow 0 28) 24) anon44_Then_correct)) (=> (= (ControlFlow 0 28) 17) anon44_Else_correct)))))
(let ((anon42_Else_correct  (=> (<= 3 v2_2) (and (=> (= (ControlFlow 0 26) 24) anon44_Then_correct) (=> (= (ControlFlow 0 26) 17) anon44_Else_correct)))))
(let ((anon41_Then_correct  (=> (<= 0 v2_2) (and (=> (= (ControlFlow 0 29) 28) anon42_Then_correct) (=> (= (ControlFlow 0 29) 26) anon42_Else_correct)))))
(let ((anon41_Else_correct  (=> (< v2_2 0) (and (=> (= (ControlFlow 0 25) 24) anon44_Then_correct) (=> (= (ControlFlow 0 25) 17) anon44_Else_correct)))))
(let ((anon49_Else_correct true))
(let ((anon31_Else_correct  (=> (forall ((v1_1 Int) ) (!  (=> (and (<= 0 v1_1) (and (< v1_1 3) (f2 Heap@@33 v1_1))) (exists ((j1_1 Int) ) (!  (and (<= 0 j1_1) (and (< j1_1 3) (g2 Heap@@33 j1_1 v1_1)))
 :qid |stdinbpl.2290:61|
 :skolemid |167|
 :pattern ( (|g2#frame| EmptyFrame j1_1 v1_1))
)))
 :qid |stdinbpl.2288:20|
 :skolemid |168|
 :pattern ( (|f2#frame| EmptyFrame v1_1))
)) (=> (and (state Heap@@33 ZeroMask) (state Heap@@33 ZeroMask)) (and (and (and (and (=> (= (ControlFlow 0 34) 15) anon49_Else_correct) (=> (= (ControlFlow 0 34) 31) anon50_Then_correct)) (=> (= (ControlFlow 0 34) 33) anon50_Else_correct)) (=> (= (ControlFlow 0 34) 29) anon41_Then_correct)) (=> (= (ControlFlow 0 34) 25) anon41_Else_correct))))))
(let ((anon34_Then_correct true))
(let ((anon39_Then_correct true))
(let ((anon11_correct true))
(let ((anon38_Then_correct  (=> (< j1 3) (and (=> (= (ControlFlow 0 7) 6) anon39_Then_correct) (=> (= (ControlFlow 0 7) 3) anon11_correct)))))
(let ((anon38_Else_correct  (=> (and (<= 3 j1) (= (ControlFlow 0 5) 3)) anon11_correct)))
(let ((anon37_Then_correct  (=> (<= 0 j1) (and (=> (= (ControlFlow 0 8) 7) anon38_Then_correct) (=> (= (ControlFlow 0 8) 5) anon38_Else_correct)))))
(let ((anon37_Else_correct  (=> (and (< j1 0) (= (ControlFlow 0 4) 3)) anon11_correct)))
(let ((anon12_correct true))
(let ((anon35_Then_correct  (=> (and (<= 0 v1_2) (and (< v1_2 3) (f2 Heap@@33 v1_2))) (and (and (=> (= (ControlFlow 0 9) 1) anon12_correct) (=> (= (ControlFlow 0 9) 8) anon37_Then_correct)) (=> (= (ControlFlow 0 9) 4) anon37_Else_correct)))))
(let ((anon35_Else_correct  (=> (and (not (and (<= 0 v1_2) (and (< v1_2 3) (f2 Heap@@33 v1_2)))) (= (ControlFlow 0 2) 1)) anon12_correct)))
(let ((anon33_Then_correct  (=> (< v1_2 3) (and (and (=> (= (ControlFlow 0 13) 12) anon34_Then_correct) (=> (= (ControlFlow 0 13) 9) anon35_Then_correct)) (=> (= (ControlFlow 0 13) 2) anon35_Else_correct)))))
(let ((anon33_Else_correct  (=> (<= 3 v1_2) (and (=> (= (ControlFlow 0 11) 9) anon35_Then_correct) (=> (= (ControlFlow 0 11) 2) anon35_Else_correct)))))
(let ((anon32_Then_correct  (=> (<= 0 v1_2) (and (=> (= (ControlFlow 0 14) 13) anon33_Then_correct) (=> (= (ControlFlow 0 14) 11) anon33_Else_correct)))))
(let ((anon32_Else_correct  (=> (< v1_2 0) (and (=> (= (ControlFlow 0 10) 9) anon35_Then_correct) (=> (= (ControlFlow 0 10) 2) anon35_Else_correct)))))
(let ((anon0_correct  (=> (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (> (|Seq#Length| A@@12) 10) (state Heap@@33 ZeroMask)) (and (state Heap@@33 ZeroMask) (state Heap@@33 ZeroMask))) (and (and (=> (= (ControlFlow 0 35) 34) anon31_Else_correct) (=> (= (ControlFlow 0 35) 14) anon32_Then_correct)) (=> (= (ControlFlow 0 35) 10) anon32_Else_correct))))))
