...
(assert  (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type x@@8) RefType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id foo)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon3_Else_correct  (=> (state Heap@@9 Mask@0) (and (=> (= (ControlFlow 0 4) (- 0 7)) (= FullPerm (U_2_real (MapType1Select Mask@0 x@@8 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 x@@8 f_7))) (=> (and (= Heap@0 (MapType0Store Heap@@9 x@@8 f_7 (int_2_U y@@1))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (= y@@1 y@@1)) (=> (= y@@1 y@@1) (and (=> (= (ControlFlow 0 4) (- 0 5)) (> (U_2_real (MapType1Select Mask@0 x@@8 f_7)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@0 x@@8 f_7)) NoPerm) (=> (and (and (> wildcard@1 NoPerm) (< wildcard@1 (U_2_real (MapType1Select Mask@0 x@@8 f_7)))) (and (= Mask@1 (MapType1Store Mask@0 x@@8 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 x@@8 f_7)) wildcard@1)))) (= (ControlFlow 0 4) (- 0 3)))) (= (U_2_int (MapType0Select Heap@0 x@@8 f_7)) y@@1))))))))))))
(let ((anon3_Then_correct  (=> (and (and (and (state PostHeap@0 ZeroMask) (= r1 y@@1)) (and (state PostHeap@0 ZeroMask) (> wildcard@0 NoPerm))) (and (and (not (= x@@8 null)) (= PostMask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) wildcard@0))))) (and (state PostHeap@0 PostMask@0) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm PostMask@0 x@@8 f_7))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated)) (not (= x@@8 null))) (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm)))) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm Mask@0 x@@8 f_7)) (=> (HasDirectPerm Mask@0 x@@8 f_7) (=> (and (= (U_2_int (MapType0Select Heap@@9 x@@8 f_7)) 5) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 8) 2) anon3_Then_correct) (=> (= (ControlFlow 0 8) 4) anon3_Else_correct)))))))))
