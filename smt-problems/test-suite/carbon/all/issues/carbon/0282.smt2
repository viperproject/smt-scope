...
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (foo j_1_1 j_1_1))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@12 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (state Heap@@12 ZeroMask)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (= 0 0)) (=> (= 0 0) (=> (forall ((i$0 Int) ) (! (foo i$0 0)
 :qid |stdinbpl.349:22|
 :skolemid |28|
 :pattern ( (foo i$0 0))
)) (=> (and (state Heap@@12 ZeroMask) (state Heap@@12 ZeroMask)) (and (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))))))))
