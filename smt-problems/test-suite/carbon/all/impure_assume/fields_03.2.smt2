...
(declare-fun y@@1 () T@U)
(declare-fun a_2 () T@U)
(assert  (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type x@@8) RefType)) (= (type y@@1) RefType)) (= (type a_2) RefType)))
...
(let ((anon4_correct  (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 4) 2) anon9_Then_correct) (=> (= (ControlFlow 0 4) 3) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (not b2) (= (ControlFlow 0 6) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> b2 (=> (and (<= (__iar__assume_helper_1  (and b1 (= x@@8 y@@1)) FullPerm FullPerm) (U_2_real (MapType1Select Mask@0 y@@1 f_7))) (= (ControlFlow 0 5) 4)) anon4_correct))))
(let ((anon2_correct  (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 7) 5) anon8_Then_correct) (=> (= (ControlFlow 0 7) 6) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (not b1) (= (ControlFlow 0 9) 7)) anon2_correct)))
(let ((anon7_Then_correct  (=> b1 (=> (and (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@8 f_7))) (= (ControlFlow 0 8) 7)) anon2_correct))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 a_2 $allocated))) (and (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated)) (U_2_bool (MapType0Select Heap@@9 y@@1 $allocated)))) (and (and (not (= a_2 null)) (= Mask@0 (MapType1Store ZeroMask a_2 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask a_2 f_7)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)))) (and (=> (= (ControlFlow 0 10) 8) anon7_Then_correct) (=> (= (ControlFlow 0 10) 9) anon7_Else_correct)))))
