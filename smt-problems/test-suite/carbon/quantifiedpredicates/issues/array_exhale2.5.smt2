...
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (and (> i_1@@1 0) (< i_1@@1 n)) (< NoPerm FullPerm)) (and (= (invRecv1 a_3@@8 (+ i_1@@1 1)) i_1@@1) (qpRange1 a_3@@8 (+ i_1@@1 1))))
 :qid |stdinbpl.415:22|
 :skolemid |32|
)) (=> (and (forall ((a_1_1 T@U) (i_2_1 Int) ) (!  (=> (= (type a_1_1) IArrayDomainTypeType) (=> (and (and (and (> (invRecv1 a_1_1 i_2_1) 0) (< (invRecv1 a_1_1 i_2_1) n)) (< NoPerm FullPerm)) (qpRange1 a_1_1 i_2_1)) (and (= a_3@@8 a_1_1) (= (+ (invRecv1 a_1_1 i_2_1) 1) i_2_1))))
 :qid |stdinbpl.419:22|
 :skolemid |33|
 :pattern ( (invRecv1 a_1_1 i_2_1))
)) (forall ((a_1_1@@0 T@U) (i_2_1@@0 Int) ) (!  (=> (= (type a_1_1@@0) IArrayDomainTypeType) (=> (and (and (and (> (invRecv1 a_1_1@@0 i_2_1@@0) 0) (< (invRecv1 a_1_1@@0 i_2_1@@0) n)) (< NoPerm FullPerm)) (qpRange1 a_1_1@@0 i_2_1@@0)) (and (=> (< NoPerm FullPerm) (and (= a_3@@8 a_1_1@@0) (= (+ (invRecv1 a_1_1@@0 i_2_1@@0) 1) i_2_1@@0))) (= (U_2_real (MapType1Select QPMask@0 null (p_1 a_1_1@@0 i_2_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (p_1 a_1_1@@0 i_2_1@@0))) FullPerm)))))
 :qid |stdinbpl.425:22|
 :skolemid |34|
...
)) (forall ((a_1_1@@1 T@U) (i_2_1@@1 Int) ) (!  (=> (and (= (type a_1_1@@1) IArrayDomainTypeType) (not (and (and (and (> (invRecv1 a_1_1@@1 i_2_1@@1) 0) (< (invRecv1 a_1_1@@1 i_2_1@@1) n)) (< NoPerm FullPerm)) (qpRange1 a_1_1@@1 i_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (p_1 a_1_1@@1 i_2_1@@1))) (U_2_real (MapType1Select ZeroMask null (p_1 a_1_1@@1 i_2_1@@1)))))
 :qid |stdinbpl.435:22|
 :skolemid |36|
