...
(declare-fun x_3_1 () T@U)
(declare-fun qpRange8 (T@U) Bool)
(declare-fun invRecv8 (T@U) T@U)
(assert  (and (and (and (and (= (type s@@21) (SeqType RefType)) (= (type x_3_1) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@52 T@U) ) (! (= (type (invRecv8 arg0@@52)) RefType)
 :qid |funType:invRecv8|
 :pattern ( (invRecv8 arg0@@52))
))))
...
(let ((anon24_Else_correct  (=> (and (not (and (<= 0 i_1) (< i_1 (|Seq#Length| s@@21)))) (= (ControlFlow 0 16) 13)) anon15_correct)))
(let ((anon24_Then_correct  (=> (and (<= 0 i_1) (< i_1 (|Seq#Length| s@@21))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (not (= (|Seq#Index| s@@21 i_1) null))) (=> (not (= (|Seq#Index| s@@21 i_1) null)) (=> (= (ControlFlow 0 14) 13) anon15_correct))))))
(let ((anon11_correct true))
(let ((anon22_Else_correct  (=> (and (not (and (<= 0 i_5) (< i_5 (|Seq#Length| s@@21)))) (= (ControlFlow 0 12) 8)) anon11_correct)))
(let ((anon22_Then_correct  (=> (and (<= 0 i_5) (< i_5 (|Seq#Length| s@@21))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_5 0)) (=> (>= i_5 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_5 (|Seq#Length| s@@21))) (=> (< i_5 (|Seq#Length| s@@21)) (=> (= (ControlFlow 0 9) 8) anon11_correct))))))))
(let ((anon23_Else_correct true))
(let ((anon19_Else_correct  (=> (and (forall ((x_4_1 T@U) ) (!  (=> (and (= (type x_4_1) RefType) (|Seq#Contains| s@@21 x_4_1)) (not (= x_4_1 null)))
 :qid |stdinbpl.1538:20|
 :skolemid |175|
 :pattern ( (|Seq#ContainsTrigger| s@@21 x_4_1))
 :pattern ( (|Seq#Contains| s@@21 x_4_1))
)) (state Heap@@9 QPMask@0)) (and (and (and (and (=> (= (ControlFlow 0 17) 7) anon23_Else_correct) (=> (= (ControlFlow 0 17) 14) anon24_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon24_Else_correct)) (=> (= (ControlFlow 0 17) 9) anon22_Then_correct)) (=> (= (ControlFlow 0 17) 12) anon22_Else_correct)))))
(let ((anon7_correct true))
(let ((anon20_Else_correct  (=> (and (not (|Seq#Contains| s@@21 x_3_1)) (= (ControlFlow 0 6) 3)) anon7_correct)))
(let ((anon20_Then_correct  (=> (|Seq#Contains| s@@21 x_3_1) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= x_3_1 null))) (=> (not (= x_3_1 null)) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
(let ((anon18_Then_correct true))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| s@@21 x_1)) (|Seq#Contains| s@@21 x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
...
)) (=> (and (and (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| s@@21 x_1@@1) (< NoPerm FullPerm)) (and (qpRange8 x_1@@1) (= (invRecv8 x_1@@1) x_1@@1))))
...
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| s@@21 (invRecv8 o_3)) (< NoPerm FullPerm)) (qpRange8 o_3)) (= (invRecv8 o_3) o_3)))
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| s@@21 (invRecv8 o_3@@0)) (< NoPerm FullPerm)) (qpRange8 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv8 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| s@@21 (invRecv8 o_3@@0)) (< NoPerm FullPerm)) (qpRange8 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (and (and (=> (= (ControlFlow 0 18) 2) anon18_Then_correct) (=> (= (ControlFlow 0 18) 17) anon19_Else_correct)) (=> (= (ControlFlow 0 18) 4) anon20_Then_correct)) (=> (= (ControlFlow 0 18) 6) anon20_Else_correct)))))))
(let ((anon17_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 20) 1) anon17_Then_correct) (=> (= (ControlFlow 0 20) 18) anon17_Else_correct)))))
