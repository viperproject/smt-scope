...
(assert  (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type x@@12) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |foo#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@13 x@@12 $allocated)) (= AssumeFunctionsAbove 0)) (=> (and (and (not (= x@@12 null)) (= Mask@0 (MapType1Store ZeroMask x@@12 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@12 f_7)) FullPerm))))) (and (state Heap@@13 Mask@0) (state Heap@@13 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 x@@12 f_7)) (=> (HasDirectPerm Mask@0 x@@12 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@0 x@@12 f_7)))))))))
