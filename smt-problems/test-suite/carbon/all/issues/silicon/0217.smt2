...
(assert  (and (= (type x@@14) RefType) (= (type Heap@@10) (MapType0Type RefType))))
...
(let ((anon3_Then_correct  (=> (not (= NoPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= NoPerm (U_2_real (MapType1Select ZeroMask null (P x@@14))))) (=> (<= NoPerm (U_2_real (MapType1Select ZeroMask null (P x@@14)))) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x@@14 $allocated))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))
