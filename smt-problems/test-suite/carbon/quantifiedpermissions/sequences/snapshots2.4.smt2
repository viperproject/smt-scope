...
(assert  (and (and (= (type Heap@@21) (MapType0Type RefType)) (= (type x@@19) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
...
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@0 (id Heap@@21 x@@19) f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 (id Heap@@21 x@@19) f_7))) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= (get01 Heap@@21 x@@19) 5))))
(let ((anon0_correct  (=> (state Heap@@21 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@21 x@@19 $allocated))) (=> (and (and (not (= x@@19 null)) (= Mask@0 (MapType1Store ZeroMask x@@19 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@19 f_7)) FullPerm))))) (and (state Heap@@21 Mask@0) (state Heap@@21 Mask@0))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm Mask@0 x@@19 f_7)) (=> (HasDirectPerm Mask@0 x@@19 f_7) (=> (and (= (U_2_int (MapType0Select Heap@@21 x@@19 f_7)) 5) (state Heap@@21 Mask@0)) (and (and (=> (= (ControlFlow 0 7) 2) anon5_Else_correct) (=> (= (ControlFlow 0 7) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))))))
