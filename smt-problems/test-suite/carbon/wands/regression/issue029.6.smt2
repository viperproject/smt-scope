...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@9) (MapType1Type RefType realType)) (= (type AssertMask@1) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Mask@7) (MapType1Type RefType realType))) (= (type Mask@8) (MapType1Type RefType realType))) (= (type AssertMask@0) (MapType1Type RefType realType))) (= (type Used_10Mask@3) (MapType1Type RefType realType))) (= (type Result_5Heap) (MapType0Type RefType))) (= (type Result_5Mask) (MapType1Type RefType realType))) (= (type Ops_9Mask) (MapType1Type RefType realType))) (= (type Ops_9Heap@6) (MapType0Type RefType))) (= (type Used_10Heap@0) (MapType0Type RefType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type Heap@3) (MapType0Type RefType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Used_10Mask@1) (MapType1Type RefType realType))) (= (type Used_10Mask@2) (MapType1Type RefType realType))) (= (type TempMask@3) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type newPMask@2) (MapType1Type RefType boolType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Used_10Mask@0) (MapType1Type RefType realType))) (= (type TempMask@2) (MapType1Type RefType realType))) (= (type Ops_9Mask@5) (MapType1Type RefType realType))) (= (type Ops_9Mask@4) (MapType1Type RefType realType))) (= (type Ops_9Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@13) (MapType0Type RefType))) (= (type Ops_9Heap@5) (MapType0Type RefType))) (= (type Ops_9Mask@3) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Heap@2) (MapType0Type RefType))) (= (type newPMask@1) (MapType1Type RefType boolType))) (= (type Ops_9Heap@3) (MapType0Type RefType))) (= (type Ops_9Heap@4) (MapType0Type RefType))) (= (type Ops_9Heap@1) (MapType0Type RefType))) (= (type Ops_9Heap@2) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Result_4Heap) (MapType0Type RefType))) (= (type Result_4Mask) (MapType1Type RefType realType))) (= (type Ops_9Mask@2) (MapType1Type RefType realType))) (= (type Used_9Mask@4) (MapType1Type RefType realType))) (= (type Used_9Heap@0) (MapType0Type RefType))) (forall ((arg0@@47 T@U) ) (! (= (type (FrameFragment arg0@@47)) FrameTypeType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 62) (let ((anon42_correct true))
(let ((anon63_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon42_correct)))
(let ((anon63_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@9 null P)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@9 null P))) (=> (= (ControlFlow 0 2) 1) anon42_correct))))))
(let ((anon40_correct  (=> (and (= AssertMask@1 (MapType1Store Mask@9 null (Q b_2@@5) (real_2_U (- (U_2_real (MapType1Select Mask@9 null (Q b_2@@5))) FullPerm)))) (state ExhaleHeap@0 Mask@9)) (and (=> (= (ControlFlow 0 5) 2) anon63_Then_correct) (=> (= (ControlFlow 0 5) 4) anon63_Else_correct)))))
(let ((anon62_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon40_correct)))
(let ((anon62_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@9 null (Q b_2@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@9 null (Q b_2@@5)))) (=> (= (ControlFlow 0 6) 5) anon40_correct))))))
(let ((anon38_correct  (=> (state Heap@5 Mask@7) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@7 null (wand_3 true b_2@@5 FullPerm))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@7 null (wand_3 true b_2@@5 FullPerm)))) (=> (= Mask@8 (MapType1Store Mask@7 null (wand_3 true b_2@@5 FullPerm) (real_2_U (- (U_2_real (MapType1Select Mask@7 null (wand_3 true b_2@@5 FullPerm))) FullPerm)))) (=> (and (and (and (state Heap@5 Mask@8) (state Heap@5 Mask@8)) (and (= Mask@9 (MapType1Store Mask@8 null (Q b_2@@5) (real_2_U (+ (U_2_real (MapType1Select Mask@8 null (Q b_2@@5))) FullPerm)))) (state Heap@5 Mask@9))) (and (and (state Heap@5 Mask@9) (IdenticalOnKnownLocations Heap@5 ExhaleHeap@0 Mask@9)) (and (state ExhaleHeap@0 Mask@9) (state ExhaleHeap@0 Mask@9)))) (and (=> (= (ControlFlow 0 9) 6) anon62_Then_correct) (=> (= (ControlFlow 0 9) 8) anon62_Else_correct)))))))))
(let ((anon37_correct  (=> (and (= AssertMask@0 (MapType1Store Mask@7 null P (real_2_U (- (U_2_real (MapType1Select Mask@7 null P)) FullPerm)))) (= (ControlFlow 0 12) 9)) anon38_correct)))
(let ((anon61_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 15) 12)) anon37_correct)))
(let ((anon61_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= FullPerm (U_2_real (MapType1Select Mask@7 null P)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@7 null P))) (=> (= (ControlFlow 0 13) 12) anon37_correct))))))
(let ((anon60_Then_correct  (=> (not b_2@@5) (and (=> (= (ControlFlow 0 16) 13) anon61_Then_correct) (=> (= (ControlFlow 0 16) 15) anon61_Else_correct)))))
(let ((anon60_Else_correct  (=> (and b_2@@5 (= (ControlFlow 0 11) 9)) anon38_correct)))
(let ((anon34_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (=> (and (and b_16@11 b_16@11) b_20@6) (and (= neededTransfer@7 0.0) (= (U_2_real (MapType1Select Used_10Mask@3 null (Q b_2@@5))) initNeededTransfer@1)))) (=> (=> (and (and b_16@11 b_16@11) b_20@6) (and (= neededTransfer@7 0.0) (= (U_2_real (MapType1Select Used_10Mask@3 null (Q b_2@@5))) initNeededTransfer@1))) (=> (and (= b_21@0  (and b_16@11 b_20@6)) (= b_21@1  (and b_21@0 (state Result_5Heap Result_5Mask)))) (=> (and (and (and (= b_21@2  (and b_21@1 (sumMask Result_5Mask Ops_9Mask Used_10Mask@3))) (= b_21@3  (and (and b_21@2 (IdenticalOnKnownLocations Ops_9Heap@6 Result_5Heap Ops_9Mask)) (IdenticalOnKnownLocations Used_10Heap@0 Result_5Heap Used_10Mask@3)))) (and (= b_21@4  (and b_21@3 (state Result_5Heap Result_5Mask))) (= b_16@12  (and b_16@11 b_21@4)))) (and (and (= Mask@7 (MapType1Store Mask@6 null (wand_3 true b_2@@5 FullPerm) (real_2_U (+ (U_2_real (MapType1Select Mask@6 null (wand_3 true b_2@@5 FullPerm))) FullPerm)))) (state Heap@5 Mask@7)) (and (state Heap@5 Mask@7) (state Heap@5 Mask@7)))) (and (=> (= (ControlFlow 0 17) 16) anon60_Then_correct) (=> (= (ControlFlow 0 17) 11) anon60_Else_correct))))))))
(let ((anon59_Else_correct  (=> (>= 0.0 takeTransfer@3) (=> (and (= Heap@5 Heap@3) (= Mask@6 Mask@4)) (=> (and (and (= neededTransfer@7 neededTransfer@5) (= b_20@6 b_20@3)) (and (= Used_10Mask@3 Used_10Mask@1) (= (ControlFlow 0 21) 17))) anon34_correct)))))
(let ((anon59_Then_correct  (=> (> takeTransfer@3 0.0) (=> (and (= neededTransfer@6 (- neededTransfer@5 takeTransfer@3)) (= Used_10Mask@2 (MapType1Store Used_10Mask@1 null (Q b_2@@5) (real_2_U (+ (U_2_real (MapType1Select Used_10Mask@1 null (Q b_2@@5))) takeTransfer@3))))) (=> (and (and (= b_20@4  (and b_20@3 (state Used_10Heap@0 Used_10Mask@2))) (= TempMask@3 (MapType1Store ZeroMask null (Q b_2@@5) (real_2_U FullPerm)))) (and (= b_20@5  (and b_20@4 (IdenticalOnKnownLocations Heap@3 Used_10Heap@0 TempMask@3))) (= Mask@5 (MapType1Store Mask@4 null (Q b_2@@5) (real_2_U (- (U_2_real (MapType1Select Mask@4 null (Q b_2@@5))) takeTransfer@3)))))) (=> (and (and (and (forall ((o_79 T@U) (f_83 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_83))))
(let ((A@@12 (FieldTypeInv0 (type f_83))))
 (=> (and (and (= (type o_79) RefType) (= (type f_83) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@3 null (|wand_3#sm| true b_2@@5 FullPerm)) o_79 f_83)) (U_2_bool (MapType1Select (MapType0Select Heap@3 null (|Q#sm| b_2@@5)) o_79 f_83)))) (U_2_bool (MapType1Select newPMask@2 o_79 f_83)))))
 :qid |stdinbpl.4670:35|
 :skolemid |152|
 :pattern ( (MapType1Select newPMask@2 o_79 f_83))
)) (= Heap@4 (MapType0Store Heap@3 null (|wand_3#sm| true b_2@@5 FullPerm) newPMask@2))) (and (= Heap@5 Heap@4) (= Mask@6 Mask@5))) (and (and (= neededTransfer@7 neededTransfer@6) (= b_20@6 b_20@5)) (and (= Used_10Mask@3 Used_10Mask@2) (= (ControlFlow 0 20) 17)))) anon34_correct))))))
(let ((anon58_Else_correct  (=> (and (< maskTransfer@3 neededTransfer@5) (= takeTransfer@3 maskTransfer@3)) (and (=> (= (ControlFlow 0 23) 20) anon59_Then_correct) (=> (= (ControlFlow 0 23) 21) anon59_Else_correct)))))
(let ((anon58_Then_correct  (=> (and (<= neededTransfer@5 maskTransfer@3) (= takeTransfer@3 neededTransfer@5)) (and (=> (= (ControlFlow 0 22) 20) anon59_Then_correct) (=> (= (ControlFlow 0 22) 21) anon59_Else_correct)))))
(let ((anon57_Then_correct  (=> (and (and (and (and (and b_16@11 b_16@11) b_20@3) true) (> neededTransfer@5 0.0)) (= maskTransfer@3 (U_2_real (MapType1Select Mask@4 null (Q b_2@@5))))) (and (=> (= (ControlFlow 0 24) 22) anon58_Then_correct) (=> (= (ControlFlow 0 24) 23) anon58_Else_correct)))))
(let ((anon57_Else_correct  (=> (not (and (and (and (and b_16@11 b_16@11) b_20@3) true) (> neededTransfer@5 0.0))) (=> (and (= Heap@5 Heap@3) (= Mask@6 Mask@4)) (=> (and (and (= neededTransfer@7 neededTransfer@5) (= b_20@6 b_20@3)) (and (= Used_10Mask@3 Used_10Mask@1) (= (ControlFlow 0 19) 17))) anon34_correct)))))
(let ((anon56_Else_correct  (=> (and (and (>= 0.0 takeTransfer@2) (= Used_10Mask@1 ZeroMask)) (and (= b_20@3 b_20@0) (= neededTransfer@5 FullPerm))) (and (=> (= (ControlFlow 0 27) 24) anon57_Then_correct) (=> (= (ControlFlow 0 27) 19) anon57_Else_correct)))))
(let ((anon56_Then_correct  (=> (and (> takeTransfer@2 0.0) (= neededTransfer@4 (- FullPerm takeTransfer@2))) (=> (and (and (and (= Used_10Mask@0 (MapType1Store ZeroMask null (Q b_2@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Q b_2@@5))) takeTransfer@2)))) (= b_20@1  (and b_20@0 (state Used_10Heap@0 Used_10Mask@0)))) (and (= TempMask@2 (MapType1Store ZeroMask null (Q b_2@@5) (real_2_U FullPerm))) (= b_20@2  (and b_20@1 (IdenticalOnKnownLocations Ops_9Heap@6 Used_10Heap@0 TempMask@2))))) (and (and (= Ops_9Mask@5 (MapType1Store Ops_9Mask@4 null (Q b_2@@5) (real_2_U (- (U_2_real (MapType1Select Ops_9Mask@4 null (Q b_2@@5))) takeTransfer@2)))) (= Used_10Mask@1 Used_10Mask@0)) (and (= b_20@3 b_20@2) (= neededTransfer@5 neededTransfer@4)))) (and (=> (= (ControlFlow 0 26) 24) anon57_Then_correct) (=> (= (ControlFlow 0 26) 19) anon57_Else_correct))))))
(let ((anon55_Else_correct  (=> (and (< maskTransfer@2 FullPerm) (= takeTransfer@2 maskTransfer@2)) (and (=> (= (ControlFlow 0 29) 26) anon56_Then_correct) (=> (= (ControlFlow 0 29) 27) anon56_Else_correct)))))
(let ((anon55_Then_correct  (=> (and (<= FullPerm maskTransfer@2) (= takeTransfer@2 FullPerm)) (and (=> (= (ControlFlow 0 28) 26) anon56_Then_correct) (=> (= (ControlFlow 0 28) 27) anon56_Else_correct)))))
(let ((anon54_Then_correct  (=> (and (and (and (and (and b_16@11 b_16@11) b_20@0) true) (> FullPerm 0.0)) (= maskTransfer@2 (U_2_real (MapType1Select Ops_9Mask@4 null (Q b_2@@5))))) (and (=> (= (ControlFlow 0 30) 28) anon55_Then_correct) (=> (= (ControlFlow 0 30) 29) anon55_Else_correct)))))
(let ((anon54_Else_correct  (=> (and (and (not (and (and (and (and b_16@11 b_16@11) b_20@0) true) (> FullPerm 0.0))) (= Used_10Mask@1 ZeroMask)) (and (= b_20@3 b_20@0) (= neededTransfer@5 FullPerm))) (and (=> (= (ControlFlow 0 25) 24) anon57_Then_correct) (=> (= (ControlFlow 0 25) 19) anon57_Else_correct)))))
(let ((anon22_correct  (=> (and (= b_20@0  (and b_20 (state Used_10Heap@0 ZeroMask))) (= initNeededTransfer@1 (+ (U_2_real (MapType1Select ZeroMask null (Q b_2@@5))) FullPerm))) (and (=> (= (ControlFlow 0 31) (- 0 32)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 31) 30) anon54_Then_correct) (=> (= (ControlFlow 0 31) 25) anon54_Else_correct)))))))
(let ((anon21_correct  (=> (and (and (and (state Ops_9Heap@5 Ops_9Mask@3) (= b_16@10  (and b_16@9 (state Ops_9Heap@5 Ops_9Mask@3)))) (and (= Ops_9Heap@6 Ops_9Heap@5) (= b_16@11 b_16@10))) (and (and (= Ops_9Mask@4 Ops_9Mask@3) (= Mask@4 Mask@3)) (and (= Heap@3 Heap@2) (= (ControlFlow 0 34) 31)))) anon22_correct)))
(let ((anon53_Else_correct  (=> (not b_2@@5) (=> (and (= Ops_9Heap@5 Ops_9Heap@3) (= (ControlFlow 0 36) 34)) anon21_correct))))
(let ((anon53_Then_correct  (=> b_2@@5 (=> (and (and (forall ((o_78 T@U) (f_82 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_82))))
(let ((A@@13 (FieldTypeInv0 (type f_82))))
 (=> (and (and (= (type o_78) RefType) (= (type f_82) (FieldType A@@13 B@@12))) (or (U_2_bool (MapType1Select (MapType0Select Ops_9Heap@3 null (|Q#sm| b_2@@5)) o_78 f_82)) (U_2_bool (MapType1Select (MapType0Select Ops_9Heap@3 null |P#sm|) o_78 f_82)))) (U_2_bool (MapType1Select newPMask@1 o_78 f_82)))))
 :qid |stdinbpl.4609:33|
 :skolemid |151|
 :pattern ( (MapType1Select newPMask@1 o_78 f_82))
)) (= Ops_9Heap@4 (MapType0Store Ops_9Heap@3 null (|Q#sm| b_2@@5) newPMask@1))) (and (= Ops_9Heap@5 Ops_9Heap@4) (= (ControlFlow 0 35) 34))) anon21_correct))))
(let ((anon52_Else_correct  (=> (and (HasDirectPerm Ops_9Mask@3 null (Q b_2@@5)) (= Ops_9Heap@3 Ops_9Heap@0)) (and (=> (= (ControlFlow 0 38) 35) anon53_Then_correct) (=> (= (ControlFlow 0 38) 36) anon53_Else_correct)))))
(let ((anon52_Then_correct  (=> (and (and (not (HasDirectPerm Ops_9Mask@3 null (Q b_2@@5))) (= Ops_9Heap@1 (MapType0Store Ops_9Heap@0 null (|Q#sm| b_2@@5) ZeroPMask))) (and (= Ops_9Heap@2 (MapType0Store Ops_9Heap@1 null (Q b_2@@5) freshVersion@0)) (= Ops_9Heap@3 Ops_9Heap@2))) (and (=> (= (ControlFlow 0 37) 35) anon53_Then_correct) (=> (= (ControlFlow 0 37) 36) anon53_Else_correct)))))
(let ((anon17_correct  (=> (= b_19@0  (and b_16@6 b_17@7)) (=> (and (= b_19@1  (and b_19@0 (state Result_4Heap Result_4Mask))) (= b_19@2  (and b_19@1 (sumMask Result_4Mask Ops_9Mask@2 Used_9Mask@4)))) (=> (and (and (and (= b_19@3  (and (and b_19@2 (IdenticalOnKnownLocations Ops_9Heap@0 Result_4Heap Ops_9Mask@2)) (IdenticalOnKnownLocations Used_9Heap@0 Result_4Heap Used_9Mask@4))) (= b_19@4  (and b_19@3 (state Result_4Heap Result_4Mask)))) (and (= b_16@7  (and b_16@6 b_19@4)) (= Ops_9Mask@3 (MapType1Store Ops_9Mask@2 null (Q b_2@@5) (real_2_U (+ (U_2_real (MapType1Select Ops_9Mask@2 null (Q b_2@@5))) FullPerm)))))) (and (and (= b_16@8  (and b_16@7 (state Ops_9Heap@0 Ops_9Mask@3))) (= b_16@9  (and b_16@8 (state Ops_9Heap@0 Ops_9Mask@3)))) (and (|Q#trigger| Ops_9Heap@0 (Q b_2@@5)) (= (MapType0Select Ops_9Heap@0 null (Q b_2@@5)) (FrameFragment (ite b_2@@5 (MapType0Select Ops_9Heap@0 null P) EmptyFrame)))))) (and (=> (= (ControlFlow 0 39) 37) anon52_Then_correct) (=> (= (ControlFlow 0 39) 38) anon52_Else_correct)))))))
(let ((anon16_correct  (and (=> (= (ControlFlow 0 41) (- 0 42)) (=> (and b_16@2 b_17@6) (and (= neededTransfer@3 0.0) (= (U_2_real (MapType1Select Used_9Mask@3 null P)) initNeededTransfer@0)))) (=> (=> (and b_16@2 b_17@6) (and (= neededTransfer@3 0.0) (= (U_2_real (MapType1Select Used_9Mask@3 null P)) initNeededTransfer@0))) (=> (= b_18@0  (and b_16@2 b_17@6)) (=> (and (= b_18@1  (and b_18@0 (state Result_3Heap Result_3Mask))) (= b_18@2  (and b_18@1 (sumMask Result_3Mask Ops_9Mask@1 Used_9Mask@3)))) (=> (and (and (= b_18@3  (and (and b_18@2 (IdenticalOnKnownLocations Ops_9Heap@0 Result_3Heap Ops_9Mask@1)) (IdenticalOnKnownLocations Used_9Heap@0 Result_3Heap Used_9Mask@3))) (= b_18@4  (and b_18@3 (state Result_3Heap Result_3Mask)))) (and (= b_16@3  (and b_16@2 b_18@4)) (= b_16@4  (and b_16@3 b_17@6)))) (=> (and (and (and (= b_16@5  (and b_16@4 (= Used_9Heap@0 Ops_9Heap@0))) (= Used_9Mask@4 Used_9Mask@3)) (and (= b_17@7 b_17@6) (= b_16@6 b_16@5))) (and (and (= Mask@3 Mask@2) (= Ops_9Mask@2 Ops_9Mask@1)) (and (= Heap@2 Heap@1) (= (ControlFlow 0 41) 39)))) anon17_correct))))))))
(let ((anon51_Else_correct  (=> (>= 0.0 takeTransfer@1) (=> (and (= Mask@2 Mask@0) (= neededTransfer@3 neededTransfer@1)) (=> (and (and (= b_17@6 b_17@3) (= Used_9Mask@3 Used_9Mask@1)) (and (= Heap@1 Heap@@13) (= (ControlFlow 0 45) 41))) anon16_correct)))))
(let ((anon51_Then_correct  (=> (> takeTransfer@1 0.0) (=> (and (= neededTransfer@2 (- neededTransfer@1 takeTransfer@1)) (= Used_9Mask@2 (MapType1Store Used_9Mask@1 null P (real_2_U (+ (U_2_real (MapType1Select Used_9Mask@1 null P)) takeTransfer@1))))) (=> (and (and (= b_17@4  (and b_17@3 (state Used_9Heap@0 Used_9Mask@2))) (= TempMask@1 (MapType1Store ZeroMask null P (real_2_U FullPerm)))) (and (= b_17@5  (and b_17@4 (IdenticalOnKnownLocations Heap@@13 Used_9Heap@0 TempMask@1))) (= Mask@1 (MapType1Store Mask@0 null P (real_2_U (- (U_2_real (MapType1Select Mask@0 null P)) takeTransfer@1)))))) (=> (and (and (and (forall ((o_77 T@U) (f_81 T@U) ) (! (let ((B@@13 (FieldTypeInv1 (type f_81))))
(let ((A@@14 (FieldTypeInv0 (type f_81))))
 (=> (and (and (= (type o_77) RefType) (= (type f_81) (FieldType A@@14 B@@13))) (or (U_2_bool (MapType1Select (MapType0Select Heap@@13 null (|wand_3#sm| true b_2@@5 FullPerm)) o_77 f_81)) (U_2_bool (MapType1Select (MapType0Select Heap@@13 null |P#sm|) o_77 f_81)))) (U_2_bool (MapType1Select newPMask@0 o_77 f_81)))))
 :qid |stdinbpl.4567:41|
 :skolemid |150|
 :pattern ( (MapType1Select newPMask@0 o_77 f_81))
)) (= Heap@0 (MapType0Store Heap@@13 null (|wand_3#sm| true b_2@@5 FullPerm) newPMask@0))) (and (= Mask@2 Mask@1) (= neededTransfer@3 neededTransfer@2))) (and (and (= b_17@6 b_17@5) (= Used_9Mask@3 Used_9Mask@2)) (and (= Heap@1 Heap@0) (= (ControlFlow 0 44) 41)))) anon16_correct))))))
(let ((anon50_Else_correct  (=> (and (< maskTransfer@1 neededTransfer@1) (= takeTransfer@1 maskTransfer@1)) (and (=> (= (ControlFlow 0 47) 44) anon51_Then_correct) (=> (= (ControlFlow 0 47) 45) anon51_Else_correct)))))
(let ((anon50_Then_correct  (=> (and (<= neededTransfer@1 maskTransfer@1) (= takeTransfer@1 neededTransfer@1)) (and (=> (= (ControlFlow 0 46) 44) anon51_Then_correct) (=> (= (ControlFlow 0 46) 45) anon51_Else_correct)))))
(let ((anon49_Then_correct  (=> (and (and (and (and b_16@2 b_17@3) true) (> neededTransfer@1 0.0)) (= maskTransfer@1 (U_2_real (MapType1Select Mask@0 null P)))) (and (=> (= (ControlFlow 0 48) 46) anon50_Then_correct) (=> (= (ControlFlow 0 48) 47) anon50_Else_correct)))))
(let ((anon49_Else_correct  (=> (not (and (and (and b_16@2 b_17@3) true) (> neededTransfer@1 0.0))) (=> (and (= Mask@2 Mask@0) (= neededTransfer@3 neededTransfer@1)) (=> (and (and (= b_17@6 b_17@3) (= Used_9Mask@3 Used_9Mask@1)) (and (= Heap@1 Heap@@13) (= (ControlFlow 0 43) 41))) anon16_correct)))))
(let ((anon48_Else_correct  (=> (>= 0.0 takeTransfer@0) (=> (and (and (= Ops_9Mask@1 ZeroMask) (= Used_9Mask@1 ZeroMask)) (and (= b_17@3 b_17@0) (= neededTransfer@1 FullPerm))) (and (=> (= (ControlFlow 0 51) 48) anon49_Then_correct) (=> (= (ControlFlow 0 51) 43) anon49_Else_correct))))))
(let ((anon48_Then_correct  (=> (> takeTransfer@0 0.0) (=> (and (= neededTransfer@0 (- FullPerm takeTransfer@0)) (= Used_9Mask@0 (MapType1Store ZeroMask null P (real_2_U (+ (U_2_real (MapType1Select ZeroMask null P)) takeTransfer@0))))) (=> (and (and (and (= b_17@1  (and b_17@0 (state Used_9Heap@0 Used_9Mask@0))) (= TempMask@0 (MapType1Store ZeroMask null P (real_2_U FullPerm)))) (and (= b_17@2  (and b_17@1 (IdenticalOnKnownLocations Ops_9Heap@0 Used_9Heap@0 TempMask@0))) (= Ops_9Mask@0 (MapType1Store ZeroMask null P (real_2_U (- (U_2_real (MapType1Select ZeroMask null P)) takeTransfer@0)))))) (and (and (= Ops_9Mask@1 Ops_9Mask@0) (= Used_9Mask@1 Used_9Mask@0)) (and (= b_17@3 b_17@2) (= neededTransfer@1 neededTransfer@0)))) (and (=> (= (ControlFlow 0 50) 48) anon49_Then_correct) (=> (= (ControlFlow 0 50) 43) anon49_Else_correct)))))))
(let ((anon47_Else_correct  (=> (and (< maskTransfer@0 FullPerm) (= takeTransfer@0 maskTransfer@0)) (and (=> (= (ControlFlow 0 53) 50) anon48_Then_correct) (=> (= (ControlFlow 0 53) 51) anon48_Else_correct)))))
(let ((anon47_Then_correct  (=> (and (<= FullPerm maskTransfer@0) (= takeTransfer@0 FullPerm)) (and (=> (= (ControlFlow 0 52) 50) anon48_Then_correct) (=> (= (ControlFlow 0 52) 51) anon48_Else_correct)))))
(let ((anon46_Then_correct  (=> (and (and (and (and b_16@2 b_17@0) true) (> FullPerm 0.0)) (= maskTransfer@0 (U_2_real (MapType1Select ZeroMask null P)))) (and (=> (= (ControlFlow 0 54) 52) anon47_Then_correct) (=> (= (ControlFlow 0 54) 53) anon47_Else_correct)))))
(let ((anon46_Else_correct  (=> (not (and (and (and b_16@2 b_17@0) true) (> FullPerm 0.0))) (=> (and (and (= Ops_9Mask@1 ZeroMask) (= Used_9Mask@1 ZeroMask)) (and (= b_17@3 b_17@0) (= neededTransfer@1 FullPerm))) (and (=> (= (ControlFlow 0 49) 48) anon49_Then_correct) (=> (= (ControlFlow 0 49) 43) anon49_Else_correct))))))
(let ((anon45_Then_correct  (=> (and (=> b_16@2 b_2@@5) (= initNeededTransfer@0 (+ (U_2_real (MapType1Select ZeroMask null P)) FullPerm))) (and (=> (= (ControlFlow 0 55) (- 0 56)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 55) 54) anon46_Then_correct) (=> (= (ControlFlow 0 55) 49) anon46_Else_correct)))))))
(let ((anon45_Else_correct  (=> (and (and (and (not (=> b_16@2 b_2@@5)) (= Used_9Mask@4 ZeroMask)) (and (= b_17@7 b_17@0) (= b_16@6 b_16@2))) (and (and (= Mask@3 Mask@0) (= Ops_9Mask@2 ZeroMask)) (and (= Heap@2 Heap@@13) (= (ControlFlow 0 40) 39)))) anon17_correct)))
(let ((anon44_Then_correct  (=> (and b_16@2 (= b_17@0  (and b_17 (state Used_9Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 57) 55) anon45_Then_correct) (=> (= (ControlFlow 0 57) 40) anon45_Else_correct)))))
(let ((anon44_Else_correct  (=> (not b_16@2) (=> (and (= Ops_9Heap@6 Ops_9Heap@0) (= b_16@11 b_16@2)) (=> (and (and (= Ops_9Mask@4 ZeroMask) (= Mask@4 Mask@0)) (and (= Heap@3 Heap@@13) (= (ControlFlow 0 33) 31))) anon22_correct)))))
(let ((anon2_correct  (=> (and (= b_16@1  (and b_16@0 (state Ops_9Heap@0 ZeroMask))) (= b_16@2  (and b_16@1 (state Ops_9Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 58) 57) anon44_Then_correct) (=> (= (ControlFlow 0 58) 33) anon44_Else_correct)))))
(let ((anon43_Else_correct  (=> (and (not b_16@0) (= (ControlFlow 0 60) 58)) anon2_correct)))
(let ((anon43_Then_correct  (=> (and b_16@0 (= (ControlFlow 0 59) 58)) anon2_correct)))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (= Mask@0 (MapType1Store ZeroMask null P (real_2_U (+ (U_2_real (MapType1Select ZeroMask null P)) FullPerm)))) (state Heap@@13 Mask@0)) (=> (and (and (state Heap@@13 Mask@0) (state Heap@@13 Mask@0)) (and (= b_16@0  (and b_16 (state Ops_9Heap@0 ZeroMask))) (= b_15@0  (and b_15 (state Used_8Heap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 61) 59) anon43_Then_correct) (=> (= (ControlFlow 0 61) 60) anon43_Else_correct)))))))
