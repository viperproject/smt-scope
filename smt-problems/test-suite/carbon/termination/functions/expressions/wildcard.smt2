...
(assert (forall ((Heap@@4 T@U) (Mask@@3 T@U) (x@@9 T@U) ) (!  (=> (and (and (and (= (type Heap@@4) (MapType0Type RefType)) (= (type Mask@@3) (MapType1Type RefType realType))) (= (type x@@9) RefType)) (and (state Heap@@4 Mask@@3) (< AssumeFunctionsAbove 0))) (test Heap@@4 x@@9))
 :qid |stdinbpl.216:15|
 :skolemid |24|
 :pattern ( (state Heap@@4 Mask@@3) (test Heap@@4 x@@9))
)))
...
(assert (forall ((Heap@@7 T@U) (Mask@@7 T@U) (x@@10 T@U) ) (!  (=> (and (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (= (type x@@10) RefType)) (state Heap@@7 Mask@@7)) (= (|test'| Heap@@7 x@@10) (|test#frame| (FrameFragment (MapType0Select Heap@@7 x@@10 f_7)) x@@10)))
 :qid |stdinbpl.223:15|
 :skolemid |25|
 :pattern ( (state Heap@@7 Mask@@7) (|test'| Heap@@7 x@@10))
)))
(assert (forall ((Heap@@8 T@U) (x@@11 T@U) ) (!  (=> (and (= (type Heap@@8) (MapType0Type RefType)) (= (type x@@11) RefType)) (and (= (test Heap@@8 x@@11) (|test'| Heap@@8 x@@11)) (dummyFunction (bool_2_U (|test#triggerStateless| x@@11)))))
 :qid |stdinbpl.206:15|
 :skolemid |22|
 :pattern ( (test Heap@@8 x@@11))
)))
