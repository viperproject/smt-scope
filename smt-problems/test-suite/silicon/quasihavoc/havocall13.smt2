(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:26:59
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quasihavoc/havocall13.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (not (forall ((z1@5@01 $Ref) (z2@5@01 $Ref)) (!
  (=>
    (and (Set_in z1@5@01 s@2@01) (Set_in z2@5@01 s@2@01) (= z1@5@01 z2@5@01))
    (= z1@5@01 z2@5@01))
...
(assert (forall ((z@5@01 $Ref)) (!
  (=>
    (Set_in z@5@01 s@2@01)
    (and (= (inv@6@01 z@5@01) z@5@01) (img@7@01 z@5@01)))
  :pattern ((Set_in z@5@01 s@2@01))
...
(assert (forall ((z@5@01 $Ref)) (!
  (=> (Set_in z@5@01 s@2@01) (not (= z@5@01 $Ref.null)))
  :pattern ((Set_in z@5@01 s@2@01))
  :pattern ((inv@6@01 z@5@01))
  :pattern ((img@7@01 z@5@01))
...
; [eval] (forall z: Ref :: { (z in s) } (z in s) ==> z.f == 42)
(declare-const z@8@01 $Ref)
(push) ; 2
; [eval] (z in s) ==> z.f == 42
; [eval] (z in s)
(push) ; 3
; [then-branch: 0 | z@8@01 in s@2@01 | live]
; [else-branch: 0 | !(z@8@01 in s@2@01) | live]
(push) ; 4
; [then-branch: 0 | z@8@01 in s@2@01]
(assert (Set_in z@8@01 s@2@01))
; [eval] z.f == 42
(push) ; 5
(assert (not (and (img@7@01 z@8@01) (Set_in (inv@6@01 z@8@01) s@2@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
(pop) ; 4
(push) ; 4
; [else-branch: 0 | !(z@8@01 in s@2@01)]
(assert (not (Set_in z@8@01 s@2@01)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(assert (or (not (Set_in z@8@01 s@2@01)) (Set_in z@8@01 s@2@01)))
(pop) ; 2
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((z@8@01 $Ref)) (!
  (or (not (Set_in z@8@01 s@2@01)) (Set_in z@8@01 s@2@01))
  :pattern ((Set_in z@8@01 s@2@01))
  :qid |prog./silicon/silver/src/test/resources/quasihavoc/havocall13.vpr@6@14@6@63-aux|)))
(assert (forall ((z@8@01 $Ref)) (!
  (=>
    (Set_in z@8@01 s@2@01)
    (=
      ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.first $t@4@01)) z@8@01)
      42))
  :pattern ((Set_in z@8@01 s@2@01))
  :qid |prog./silicon/silver/src/test/resources/quasihavoc/havocall13.vpr@6@14@6@63|)))
(assert (= ($Snap.second ($Snap.second $t@4@01)) $Snap.unit))
; [eval] (x in s)
(assert (Set_in x@3@01 s@2@01))
...
; [eval] x.f == 42
(push) ; 3
(assert (not (and (img@7@01 x@3@01) (Set_in (inv@6@01 x@3@01) s@2@01))))
(check-sat)
; unsat
(pop) ; 3
; 0,00s
; (get-info :all-statistics)
(push) ; 3
(assert (not (= ($FVF.lookup_f (as sm@12@01  $FVF<f>) x@3@01) 42)))
(check-sat)
; unknown
(pop) ; 3
; 0,00s
...
(assert (forall ((r $Ref)) (!
  (<= ($FVF.perm_f (as pm@14@01  $FPM) r) $Perm.Write)
  :pattern ((inv@6@01 r))
  :qid |qp-fld-prm-bnd|)))
; [eval] x.f == 42
(set-option :timeout 0)
...
; (get-info :all-statistics)
(push) ; 3
(assert (not (= ($FVF.lookup_f (as sm@13@01  $FVF<f>) x@3@01) 42)))
(check-sat)
; unknown
(pop) ; 3
; 0,00s
...
; (get-info :all-statistics)
(push) ; 3
(assert (not (= ($FVF.lookup_f (as sm@15@01  $FVF<f>) x@3@01) 42)))
(check-sat)
; unknown
(pop) ; 3
; 0,00s
