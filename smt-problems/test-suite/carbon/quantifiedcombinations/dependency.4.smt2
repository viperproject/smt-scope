...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type xs@@3) (SeqType RefType)) (= (type x_19) RefType)) (= (type UnfoldingMask@4) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@5) (MapType1Type RefType realType))) (= (type Heap@@15) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (forall ((arg0@@43 T@U) ) (! (= (type (FrameFragment arg0@@43)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@43))
))) (= (type x_12) RefType)) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type x_20) RefType)) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (= (type UnfoldingMask@3) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type PostHeap@1) (MapType0Type RefType))) (= (type y@@2) RefType)) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv8 arg0@@44)) RefType)
 :qid |funType:invRecv8|
 :pattern ( (invRecv8 arg0@@44))
))))
(set-info :boogie-vc-id m3_b)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 34) (let ((anon14_correct true))
(let ((anon13_correct  (=> (and (and (and (= UnfoldingMask@2 (MapType1Store ZeroMask null (pred x_20) (real_2_U (- (U_2_real (MapType1Select ZeroMask null (pred x_20))) FullPerm)))) (not (= x_20 null))) (and (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 x_20 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 x_20 f_7)) FullPerm)))) (state PostHeap@0 UnfoldingMask@3))) (and (and (state PostHeap@0 UnfoldingMask@3) (= PostHeap@1 (MapType0Store PostHeap@0 null (|pred#sm| x_20) (MapType1Store (MapType0Select PostHeap@0 null (|pred#sm| x_20)) x_20 f_7 (bool_2_U true))))) (and (state PostHeap@1 ZeroMask) (= (ControlFlow 0 24) 22)))) anon14_correct)))
(let ((anon32_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 27) 24)) anon13_correct)))
(let ((anon32_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 25) (- 0 26)) (<= FullPerm (U_2_real (MapType1Select ZeroMask null (pred x_20))))) (=> (<= FullPerm (U_2_real (MapType1Select ZeroMask null (pred x_20)))) (=> (= (ControlFlow 0 25) 24) anon13_correct))))))
(let ((anon31_Then_correct  (=> (|Seq#Contains| xs@@3 x_20) (=> (and (|pred#trigger| PostHeap@0 (pred x_20)) (= (MapType0Select PostHeap@0 null (pred x_20)) (FrameFragment (MapType0Select PostHeap@0 x_20 f_7)))) (and (=> (= (ControlFlow 0 28) 25) anon32_Then_correct) (=> (= (ControlFlow 0 28) 27) anon32_Else_correct))))))
(let ((anon31_Else_correct  (=> (and (not (|Seq#Contains| xs@@3 x_20)) (= (ControlFlow 0 23) 22)) anon14_correct)))
(let ((anon33_Else_correct  (=> (= (ControlFlow 0 21) (- 0 20)) (forall ((x_9 T@U) (x_9_1 T@U) ) (!  (=> (and (= (type x_9) RefType) (= (type x_9_1) RefType)) (=> (and (and (and (and (not (= x_9 x_9_1)) (|Seq#Contains| xs@@3 x_9)) (|Seq#Contains| xs@@3 x_9_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_9 x_9_1))))
 :qid |stdinbpl.1510:17|
 :skolemid |127|
 :pattern ( (neverTriggered9 x_9) (neverTriggered9 x_9_1))
)))))
(let ((anon33_Then_correct true))
(let ((anon29_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (and (and (=> (= (ControlFlow 0 29) 19) anon33_Then_correct) (=> (= (ControlFlow 0 29) 21) anon33_Else_correct)) (=> (= (ControlFlow 0 29) 28) anon31_Then_correct)) (=> (= (ControlFlow 0 29) 23) anon31_Else_correct)))))
(let ((anon23_correct true))
(let ((anon22_correct  (=> (and (= UnfoldingMask@0 (MapType1Store QPMask@0 null (pred x_12) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (pred x_12))) FullPerm)))) (not (= x_12 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x_12 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x_12 f_7)) FullPerm)))) (state Heap@@15 UnfoldingMask@1)) (and (state Heap@@15 UnfoldingMask@1) (= (ControlFlow 0 14) 12))) anon23_correct))))
(let ((anon36_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 17) 14)) anon22_correct)))
(let ((anon36_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (pred x_12))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (pred x_12)))) (=> (= (ControlFlow 0 15) 14) anon22_correct))))))
(let ((anon35_Then_correct  (=> (|Seq#Contains| xs@@3 x_12) (=> (and (|pred#trigger| Heap@@15 (pred x_12)) (= (MapType0Select Heap@@15 null (pred x_12)) (FrameFragment (MapType0Select Heap@@15 x_12 f_7)))) (and (=> (= (ControlFlow 0 18) 15) anon36_Then_correct) (=> (= (ControlFlow 0 18) 17) anon36_Else_correct))))))
(let ((anon35_Else_correct  (=> (and (not (|Seq#Contains| xs@@3 x_12)) (= (ControlFlow 0 13) 12)) anon23_correct)))
(let ((anon34_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((x_14 T@U) (x_14_1 T@U) ) (!  (=> (and (= (type x_14) RefType) (= (type x_14_1) RefType)) (=> (and (and (and (and (not (= x_14 x_14_1)) (|Seq#Contains| xs@@3 x_14)) (|Seq#Contains| xs@@3 x_14_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_14 x_14_1))))
 :qid |stdinbpl.1581:17|
 :skolemid |133|
 :pattern ( (neverTriggered10 x_14) (neverTriggered10 x_14_1))
))) (=> (forall ((x_14@@0 T@U) (x_14_1@@0 T@U) ) (!  (=> (and (= (type x_14@@0) RefType) (= (type x_14_1@@0) RefType)) (=> (and (and (and (and (not (= x_14@@0 x_14_1@@0)) (|Seq#Contains| xs@@3 x_14@@0)) (|Seq#Contains| xs@@3 x_14_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_14@@0 x_14_1@@0))))
 :qid |stdinbpl.1581:17|
 :skolemid |133|
 :pattern ( (neverTriggered10 x_14@@0) (neverTriggered10 x_14_1@@0))
)) (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((x_14@@1 T@U) ) (!  (=> (and (= (type x_14@@1) RefType) (|Seq#Contains| xs@@3 x_14@@1)) (>= (U_2_real (MapType1Select QPMask@0 null (pred x_14@@1))) FullPerm))
 :qid |stdinbpl.1588:17|
 :skolemid |134|
 :pattern ( (MapType0Select Heap@@15 null (pred x_14@@1)))
 :pattern ( (MapType1Select QPMask@0 null (pred x_14@@1)))
 :pattern ( (|Seq#ContainsTrigger| xs@@3 x_14@@1))
 :pattern ( (|Seq#Contains| xs@@3 x_14@@1))
)))))))
(let ((anon26_Else_correct  (=> (state Heap@@15 QPMask@0) (=> (and (|Seq#Contains| xs@@3 y@@2) (state Heap@@15 QPMask@0)) (and (and (and (=> (= (ControlFlow 0 30) 29) anon29_Then_correct) (=> (= (ControlFlow 0 30) 10) anon34_Else_correct)) (=> (= (ControlFlow 0 30) 18) anon35_Then_correct)) (=> (= (ControlFlow 0 30) 13) anon35_Else_correct))))))
(let ((anon7_correct true))
(let ((anon6_correct  (=> (and (and (and (= UnfoldingMask@4 (MapType1Store QPMask@0 null (pred x_19) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (pred x_19))) FullPerm)))) (not (= x_19 null))) (and (= UnfoldingMask@5 (MapType1Store UnfoldingMask@4 x_19 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@4 x_19 f_7)) FullPerm)))) (state Heap@@15 UnfoldingMask@5))) (and (and (state Heap@@15 UnfoldingMask@5) (= Heap@0 (MapType0Store Heap@@15 null (|pred#sm| x_19) (MapType1Store (MapType0Select Heap@@15 null (|pred#sm| x_19)) x_19 f_7 (bool_2_U true))))) (and (state Heap@0 QPMask@0) (= (ControlFlow 0 4) 2)))) anon7_correct)))
(let ((anon28_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 4)) anon6_correct)))
(let ((anon28_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (pred x_19))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (pred x_19)))) (=> (= (ControlFlow 0 5) 4) anon6_correct))))))
(let ((anon27_Then_correct  (=> (|Seq#Contains| xs@@3 x_19) (=> (and (|pred#trigger| Heap@@15 (pred x_19)) (= (MapType0Select Heap@@15 null (pred x_19)) (FrameFragment (MapType0Select Heap@@15 x_19 f_7)))) (and (=> (= (ControlFlow 0 8) 5) anon28_Then_correct) (=> (= (ControlFlow 0 8) 7) anon28_Else_correct))))))
(let ((anon27_Else_correct  (=> (and (not (|Seq#Contains| xs@@3 x_19)) (= (ControlFlow 0 3) 2)) anon7_correct)))
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 32)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| xs@@3 x_1)) (|Seq#Contains| xs@@3 x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.1399:17|
 :skolemid |121|
...
)) (=> (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| xs@@3 x_1@@1) (< NoPerm FullPerm)) (and (= (invRecv8 x_1@@1) x_1@@1) (qpRange8 x_1@@1))))
...
)) (forall ((x_2_1 T@U) ) (!  (=> (= (type x_2_1) RefType) (=> (and (and (|Seq#Contains| xs@@3 (invRecv8 x_2_1)) (< NoPerm FullPerm)) (qpRange8 x_2_1)) (= (invRecv8 x_2_1) x_2_1)))
 :qid |stdinbpl.1409:22|
 :skolemid |123|
 :pattern ( (invRecv8 x_2_1))
))) (=> (and (and (forall ((x_2_1@@0 T@U) ) (!  (=> (= (type x_2_1@@0) RefType) (=> (and (and (|Seq#Contains| xs@@3 (invRecv8 x_2_1@@0)) (< NoPerm FullPerm)) (qpRange8 x_2_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv8 x_2_1@@0) x_2_1@@0)) (= (U_2_real (MapType1Select QPMask@0 null (pred x_2_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (pred x_2_1@@0))) FullPerm)))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.1421:29|
 :skolemid |125|
 :pattern ( (MapType1Select ZeroMask o_3 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3 f_5))
))) (and (forall ((x_2_1@@1 T@U) ) (!  (=> (and (= (type x_2_1@@1) RefType) (not (and (and (|Seq#Contains| xs@@3 (invRecv8 x_2_1@@1)) (< NoPerm FullPerm)) (qpRange8 x_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (pred x_2_1@@1))) (U_2_real (MapType1Select ZeroMask null (pred x_2_1@@1)))))
 :qid |stdinbpl.1425:22|
 :skolemid |126|
 :pattern ( (MapType1Select QPMask@0 null (pred x_2_1@@1)))
)) (state Heap@@15 QPMask@0))) (and (and (=> (= (ControlFlow 0 31) 30) anon26_Else_correct) (=> (= (ControlFlow 0 31) 8) anon27_Then_correct)) (=> (= (ControlFlow 0 31) 3) anon27_Else_correct))))))))
(let ((anon25_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@15 y@@2 $allocated))) (and (=> (= (ControlFlow 0 33) 1) anon25_Then_correct) (=> (= (ControlFlow 0 33) 31) anon25_Else_correct))))))
