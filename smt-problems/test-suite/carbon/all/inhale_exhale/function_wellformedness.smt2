...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@121 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@121 this@@111 $allocated)) (= AssumeFunctionsAbove 5)) (and (not (= this@@111 null)) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm ZeroMask this@@111 x@@8)))))
...
(set-info :boogie-vc-id |t3#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 6)) (not (= this@@111 null))) (=> (not (= this@@111 null)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@0 this@@111 x@@8)) (=> (HasDirectPerm Mask@0 this@@111 x@@8) (=> (= (ControlFlow 0 4) (- 0 3)) (= (U_2_int (MapType0Select Heap@@121 this@@111 x@@8)) 0))))))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (not (= this@@111 null)) (=> (and (= Mask@0 (MapType1Store ZeroMask this@@111 x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@111 x@@8)) FullPerm)))) (state Heap@@121 Mask@0)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm Mask@0 this@@111 x@@8)) (=> (HasDirectPerm Mask@0 this@@111 x@@8) (=> (and (= (U_2_int (MapType0Select Heap@@121 this@@111 x@@8)) 0) (state Heap@@121 Mask@0)) (and (=> (= (ControlFlow 0 7) 2) anon6_Then_correct) (=> (= (ControlFlow 0 7) 4) anon6_Else_correct)))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@121 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@121 this@@111 $allocated)) (= AssumeFunctionsAbove 6)) (and (=> (= (ControlFlow 0 9) 1) anon5_Then_correct) (=> (= (ControlFlow 0 9) 7) anon5_Else_correct))))))
