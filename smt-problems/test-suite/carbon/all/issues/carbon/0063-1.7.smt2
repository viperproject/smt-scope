...
(assert  (and (= (type Heap@@11) (MapType0Type RefType)) (= (type this@@11) RefType)))
(set-info :boogie-vc-id test1Reference)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@11 this@@11 $allocated)) (not (= this@@11 null))) (and (state Heap@@11 ZeroMask) (state Heap@@11 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm ZeroMask this@@11 x@@8)) (=> (HasDirectPerm ZeroMask this@@11 x@@8) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (MapType0Select Heap@@11 this@@11 x@@8)) 0))))))))
