...
(declare-fun k () Int)
(declare-fun i@@5 () Int)
(assert  (and (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type z@@0) RefType)) (= (type x@@14) RefType)) (= (type y@@1) RefType)))
...
(let ((anon8_correct  (=> (state Heap@@10 Mask@0) (and (=> (= (ControlFlow 0 4) 2) anon15_Then_correct) (=> (= (ControlFlow 0 4) 3) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (not b2) (= (ControlFlow 0 7) 4)) anon8_correct)))
(let ((anon14_Then_correct  (=> b2 (and (=> (= (ControlFlow 0 5) (- 0 6)) (= z@@0 x@@14)) (=> (= z@@0 x@@14) (=> (= (ControlFlow 0 5) 4) anon8_correct))))))
(let ((anon6_correct  (=> (state Heap@@10 Mask@0) (and (=> (= (ControlFlow 0 8) 5) anon14_Then_correct) (=> (= (ControlFlow 0 8) 7) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (not b1) (= (ControlFlow 0 11) 8)) anon6_correct)))
(let ((anon13_Then_correct  (=> b1 (and (=> (= (ControlFlow 0 9) (- 0 10)) (= y@@1 x@@14)) (=> (= y@@1 x@@14) (=> (= (ControlFlow 0 9) 8) anon6_correct))))))
(let ((anon4_correct  (=> (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (=> (= (ControlFlow 0 12) 9) anon13_Then_correct) (=> (= (ControlFlow 0 12) 11) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (not b2) (= (ControlFlow 0 14) 12)) anon4_correct)))
(let ((anon12_Then_correct  (=> b2 (=> (and (<= (__iar__assume_helper_1  (and b1 (and (= y@@1 z@@0) (= j k))) FullPerm FullPerm) (U_2_real (MapType1Select Mask@0 null (P z@@0 k)))) (= (ControlFlow 0 13) 12)) anon4_correct))))
(let ((anon2_correct  (=> (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (=> (= (ControlFlow 0 15) 13) anon12_Then_correct) (=> (= (ControlFlow 0 15) 14) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (not b1) (= (ControlFlow 0 17) 15)) anon2_correct)))
(let ((anon11_Then_correct  (=> b1 (=> (and (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P y@@1 j)))) (= (ControlFlow 0 16) 15)) anon2_correct))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 x@@14 $allocated)) (U_2_bool (MapType0Select Heap@@10 y@@1 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@10 z@@0 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (P x@@14 i@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@14 i@@5))) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 18) 16) anon11_Then_correct) (=> (= (ControlFlow 0 18) 17) anon11_Else_correct)))))))
