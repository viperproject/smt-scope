...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (and (state Heap@@17 ZeroMask) (U_2_bool (MapType0Select Heap@@17 x@@16 $allocated))) (and (U_2_bool (MapType0Select Heap@@17 y@@9 $allocated)) (= AssumeFunctionsAbove 1))) (and (and (not (= x@@16 null)) (= Mask@0 (MapType1Store ZeroMask x@@16 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@16 f_7)) FullPerm))))) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (= x@@16 y@@9))) (=> (not (= x@@16 y@@9)) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@0 x@@16 f_7)))))))
