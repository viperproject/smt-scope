...
(assert  (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type arr) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id client)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 arr $allocated))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (forall ((p Int) ) (!  (=> (dummyFunction (MapType0Select Heap@@9 (loc arr p) val)) (>= NoPerm NoPerm))
 :qid |stdinbpl.290:19|
 :skolemid |24|
 :pattern ( (loc arr p))
 :pattern ( (loc arr p))
))) (=> (forall ((p@@0 Int) ) (!  (=> (dummyFunction (MapType0Select Heap@@9 (loc arr p@@0) val)) (>= NoPerm NoPerm))
 :qid |stdinbpl.290:19|
 :skolemid |24|
 :pattern ( (loc arr p@@0))
 :pattern ( (loc arr p@@0))
)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall ((p@@1 Int) (p_6 Int) ) (!  (=> (and (and (not (= p@@1 p_6)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p@@1) (loc arr p_6))))
 :qid |stdinbpl.297:19|
 :skolemid |25|
 :pattern ( (neverTriggered1 p@@1) (neverTriggered1 p_6))
))) (=> (forall ((p@@2 Int) (p_6@@0 Int) ) (!  (=> (and (and (not (= p@@2 p_6@@0)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p@@2) (loc arr p_6@@0))))
 :qid |stdinbpl.297:19|
 :skolemid |25|
 :pattern ( (neverTriggered1 p@@2) (neverTriggered1 p_6@@0))
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((p@@3 Int) ) (! (>= (U_2_real (MapType1Select ZeroMask (loc arr p@@3) val)) NoPerm)
 :qid |stdinbpl.304:19|
 :skolemid |26|
 :pattern ( (loc arr p@@3))
 :pattern ( (loc arr p@@3))
))) (=> (forall ((p@@4 Int) ) (! (>= (U_2_real (MapType1Select ZeroMask (loc arr p@@4) val)) NoPerm)
 :qid |stdinbpl.304:19|
 :skolemid |26|
 :pattern ( (loc arr p@@4))
 :pattern ( (loc arr p@@4))
)) (=> (forall ((p@@5 Int) ) (!  (=> (< NoPerm NoPerm) (and (qpRange1 (loc arr p@@5)) (= (invRecv1 (loc arr p@@5)) p@@5)))
 :qid |stdinbpl.310:24|
 :skolemid |27|
 :pattern ( (loc arr p@@5))
 :pattern ( (loc arr p@@5))
)) (=> (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (< NoPerm NoPerm) (qpRange1 o_3)) (= (loc arr (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.314:24|
 :skolemid |28|
 :pattern ( (invRecv1 o_3))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (< NoPerm NoPerm) (qpRange1 o_3@@0)) (and (= (loc arr (invRecv1 o_3@@0)) o_3@@0) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (- (U_2_real (MapType1Select ZeroMask o_3@@0 val)) NoPerm)))) (=> (not (and (< NoPerm NoPerm) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.320:24|
 :skolemid |29|
...
)) (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 QPMask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((p_1 Int) (p_1_1 Int) ) (!  (=> (and (and (not (= p_1 p_1_1)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_1) (loc arr p_1_1))))
 :qid |stdinbpl.339:17|
 :skolemid |31|
))) (=> (forall ((p_1@@0 Int) (p_1_1@@0 Int) ) (!  (=> (and (and (not (= p_1@@0 p_1_1@@0)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_1@@0) (loc arr p_1_1@@0))))
 :qid |stdinbpl.339:17|
 :skolemid |31|
)) (=> (forall ((p_1@@1 Int) ) (!  (=> (< NoPerm NoPerm) (and (qpRange2 (loc arr p_1@@1)) (= (invRecv2 (loc arr p_1@@1)) p_1@@1)))
 :qid |stdinbpl.345:24|
 :skolemid |32|
 :pattern ( (loc arr p_1@@1))
 :pattern ( (loc arr p_1@@1))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (< NoPerm NoPerm) (qpRange2 o_3@@2)) (= (loc arr (invRecv2 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.349:24|
 :skolemid |33|
 :pattern ( (invRecv2 o_3@@2))
)) (= (ControlFlow 0 2) (- 0 1))) (forall ((p_1@@2 Int) ) (! (>= NoPerm NoPerm)
 :qid |stdinbpl.355:17|
 :skolemid |34|
