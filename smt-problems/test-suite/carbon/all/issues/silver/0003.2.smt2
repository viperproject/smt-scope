...
(let ((anon6_Then_correct  (=> (and (and (and (state Heap@@9 ZeroMask) (not (= r_1 null))) (and (= (U_2_int (MapType0Select Heap@@9 r_1 f_7)) 2) (state Heap@@9 ZeroMask))) (and (and (< j@0 3) (state Heap@@9 ZeroMask)) (and (= j@1 (+ j@0 1)) (state Heap@@9 ZeroMask)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= r_1 null))) (=> (not (= r_1 null)) (=> (= (ControlFlow 0 4) (- 0 3)) (= (U_2_int (MapType0Select Heap@@9 r_1 f_7)) 2)))))))
(let ((anon5_Then_correct  (=> (and (not (= r_1 null)) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm ZeroMask r_1 f_7))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 r_1 $allocated)) (not (= r_1 null))) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (not (= r_1 null))) (=> (not (= r_1 null)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (= (U_2_int (MapType0Select Heap@@9 r_1 f_7)) 2)) (=> (= (U_2_int (MapType0Select Heap@@9 r_1 f_7)) 2) (and (and (=> (= (ControlFlow 0 7) 2) anon5_Then_correct) (=> (= (ControlFlow 0 7) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))))))
