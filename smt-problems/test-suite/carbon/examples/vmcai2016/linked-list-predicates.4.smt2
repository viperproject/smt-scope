...
(assert  (and (and (= (type Heap@@38) (MapType0Type RefType)) (= (type this@@38) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |List#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@38 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@38 this@@38 $allocated))) (=> (and (and (not (= this@@38 null)) (= Mask@0 (MapType1Store ZeroMask this@@38 head (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@38 head)) FullPerm))))) (and (state Heap@@38 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@0 this@@38 head))))))
