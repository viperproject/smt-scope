...
(assert  (and (and (and (and (and (and (and (and (= (type vas) (MapType1Type RefType boolType)) (= (type a_4) RefType)) (= (type QPMask@1) (MapType2Type RefType realType))) (= (type y@@6) RefType)) (= (type x@@19) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@49 T@U) (arg1@@43 Real) (arg2@@24 T@U) (arg3@@21 Real) ) (! (= (type (invRecv2 arg0@@49 arg1@@43 arg2@@24 arg3@@21)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@49 arg1@@43 arg2@@24 arg3@@21))
))) (forall ((arg0@@50 T@U) ) (! (= (type (invRecv1 arg0@@50)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon20_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (= (U_2_real (MapType2Select QPMask@1 null (wand y@@6 FullPerm y@@6 FullPerm))) FullPerm))))
(let ((anon20_Then_correct true))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (= (U_2_real (MapType2Select QPMask@1 null (wand y@@6 FullPerm x@@19 FullPerm))) FullPerm)) (=> (= (U_2_real (MapType2Select QPMask@1 null (wand y@@6 FullPerm x@@19 FullPerm))) FullPerm) (=> (state Heap@@9 QPMask@1) (and (=> (= (ControlFlow 0 11) 8) anon20_Then_correct) (=> (= (ControlFlow 0 11) 10) anon20_Else_correct)))))))
(let ((anon19_Then_correct true))
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (= (U_2_real (MapType2Select QPMask@1 null (wand x@@19 FullPerm x@@19 FullPerm))) FullPerm)) (=> (= (U_2_real (MapType2Select QPMask@1 null (wand x@@19 FullPerm x@@19 FullPerm))) FullPerm) (=> (state Heap@@9 QPMask@1) (and (=> (= (ControlFlow 0 13) 7) anon19_Then_correct) (=> (= (ControlFlow 0 13) 11) anon19_Else_correct)))))))
(let ((anon18_Then_correct true))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((a_3 T@U) (a_3_1 T@U) ) (!  (=> (and (= (type a_3) RefType) (= (type a_3_1) RefType)) (=> (and (and (and (and (not (= a_3 a_3_1)) (U_2_bool (MapType1Select vas a_3))) (U_2_bool (MapType1Select vas a_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (or (or (not (= a_3 a_3_1)) (not (= FullPerm FullPerm))) (not (= x@@19 x@@19))) (not (= FullPerm FullPerm)))))
 :qid |stdinbpl.603:17|
 :skolemid |102|
 :pattern ( (neverTriggered2 a_3) (neverTriggered2 a_3_1))
))) (=> (forall ((a_3@@0 T@U) (a_3_1@@0 T@U) ) (!  (=> (and (= (type a_3@@0) RefType) (= (type a_3_1@@0) RefType)) (=> (and (and (and (and (not (= a_3@@0 a_3_1@@0)) (U_2_bool (MapType1Select vas a_3@@0))) (U_2_bool (MapType1Select vas a_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (or (or (not (= a_3@@0 a_3_1@@0)) (not (= FullPerm FullPerm))) (not (= x@@19 x@@19))) (not (= FullPerm FullPerm)))))
 :qid |stdinbpl.603:17|
 :skolemid |102|
 :pattern ( (neverTriggered2 a_3@@0) (neverTriggered2 a_3_1@@0))
)) (=> (and (forall ((a_3@@1 T@U) ) (!  (=> (= (type a_3@@1) RefType) (=> (and (U_2_bool (MapType1Select vas a_3@@1)) (< NoPerm FullPerm)) (and (= (invRecv2 a_3@@1 FullPerm x@@19 FullPerm) a_3@@1) (qpRange2 a_3@@1 FullPerm x@@19 FullPerm))))
 :qid |stdinbpl.609:22|
 :skolemid |103|
...
)) (forall ((arg_0 T@U) (arg_1 Real) (arg_2 T@U) (arg_3 Real) ) (!  (=> (and (= (type arg_0) RefType) (= (type arg_2) RefType)) (=> (and (and (U_2_bool (MapType1Select vas (invRecv2 arg_0 arg_1 arg_2 arg_3))) (< NoPerm FullPerm)) (qpRange2 arg_0 arg_1 arg_2 arg_3)) (and (and (and (= (invRecv2 arg_0 arg_1 arg_2 arg_3) arg_0) (= FullPerm arg_1)) (= x@@19 arg_2)) (= FullPerm arg_3))))
 :qid |stdinbpl.613:22|
 :skolemid |104|
 :pattern ( (invRecv2 arg_0 arg_1 arg_2 arg_3))
))) (=> (and (and (forall ((arg_0@@0 T@U) (arg_1@@0 Real) (arg_2@@0 T@U) (arg_3@@0 Real) ) (!  (=> (and (= (type arg_0@@0) RefType) (= (type arg_2@@0) RefType)) (=> (and (and (U_2_bool (MapType1Select vas (invRecv2 arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0))) (< NoPerm FullPerm)) (qpRange2 arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0)) (and (=> (< NoPerm FullPerm) (and (and (and (= (invRecv2 arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0) arg_0@@0) (= FullPerm arg_1@@0)) (= x@@19 arg_2@@0)) (= FullPerm arg_3@@0))) (= (U_2_real (MapType2Select QPMask@1 null (wand arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0))) (+ (U_2_real (MapType2Select QPMask@0 null (wand arg_0@@0 arg_1@@0 arg_2@@0 arg_3@@0))) FullPerm)))))
 :qid |stdinbpl.619:22|
 :skolemid |105|
...
))) (and (forall ((arg_0@@1 T@U) (arg_1@@1 Real) (arg_2@@1 T@U) (arg_3@@1 Real) ) (!  (=> (and (and (= (type arg_0@@1) RefType) (= (type arg_2@@1) RefType)) (not (and (and (U_2_bool (MapType1Select vas (invRecv2 arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1))) (< NoPerm FullPerm)) (qpRange2 arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1)))) (= (U_2_real (MapType2Select QPMask@1 null (wand arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1))) (U_2_real (MapType2Select QPMask@0 null (wand arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1)))))
 :qid |stdinbpl.629:22|
 :skolemid |107|
 :pattern ( (MapType2Select QPMask@1 null (wand arg_0@@1 arg_1@@1 arg_2@@1 arg_3@@1)))
)) (state Heap@@9 QPMask@1))) (=> (and (and (and (state Heap@@9 QPMask@1) (state Heap@@9 QPMask@1)) (and (U_2_bool (MapType1Select vas x@@19)) (state Heap@@9 QPMask@1))) (and (and (state Heap@@9 QPMask@1) (U_2_bool (MapType1Select vas y@@6))) (and (state Heap@@9 QPMask@1) (state Heap@@9 QPMask@1)))) (and (=> (= (ControlFlow 0 15) 6) anon18_Then_correct) (=> (= (ControlFlow 0 15) 13) anon18_Else_correct)))))))))
(let ((anon17_Then_correct true))
(let ((anon6_correct true))
(let ((anon16_Then_correct  (=> (U_2_bool (MapType1Select vas a_4)) (and (=> (= (ControlFlow 0 5) 4) anon17_Then_correct) (=> (= (ControlFlow 0 5) 2) anon6_correct)))))
(let ((anon16_Else_correct  (=> (and (not (U_2_bool (MapType1Select vas a_4))) (= (ControlFlow 0 3) 2)) anon6_correct)))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((a_1 T@U) (a_1_1 T@U) ) (!  (=> (and (= (type a_1) RefType) (= (type a_1_1) RefType)) (=> (and (and (and (and (not (= a_1 a_1_1)) (U_2_bool (MapType1Select vas a_1))) (U_2_bool (MapType1Select vas a_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1 a_1_1))))
 :qid |stdinbpl.531:15|
 :skolemid |96|
 :no-pattern (type a_1)
...
)) (=> (and (and (and (forall ((a_1@@1 T@U) ) (!  (=> (= (type a_1@@1) RefType) (=> (and (U_2_bool (MapType1Select vas a_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 a_1@@1) (= (invRecv1 a_1@@1) a_1@@1))))
 :qid |stdinbpl.537:22|
 :skolemid |97|
 :pattern ( (MapType0Select Heap@@9 a_1@@1 f_7))
 :pattern ( (MapType2Select QPMask@0 a_1@@1 f_7))
 :pattern ( (MapType1Select vas a_1@@1))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (=> (and (and (U_2_bool (MapType1Select vas (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (= (invRecv1 o_3@@0) o_3@@0)))
 :qid |stdinbpl.541:22|
 :skolemid |98|
 :pattern ( (invRecv1 o_3@@0))
))) (and (forall ((a_1@@2 T@U) ) (!  (=> (and (= (type a_1@@2) RefType) (U_2_bool (MapType1Select vas a_1@@2))) (not (= a_1@@2 null)))
 :qid |stdinbpl.547:22|
 :skolemid |99|
 :pattern ( (MapType0Select Heap@@9 a_1@@2 f_7))
 :pattern ( (MapType2Select QPMask@0 a_1@@2 f_7))
 :pattern ( (MapType1Select vas a_1@@2))
)) (forall ((o_3@@1 T@U) ) (!  (=> (= (type o_3@@1) RefType) (and (=> (and (and (U_2_bool (MapType1Select vas (invRecv1 o_3@@1))) (< NoPerm FullPerm)) (qpRange1 o_3@@1)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@1) o_3@@1)) (= (U_2_real (MapType2Select QPMask@0 o_3@@1 f_7)) (+ (U_2_real (MapType2Select ZeroMask o_3@@1 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType1Select vas (invRecv1 o_3@@1))) (< NoPerm FullPerm)) (qpRange1 o_3@@1))) (= (U_2_real (MapType2Select QPMask@0 o_3@@1 f_7)) (U_2_real (MapType2Select ZeroMask o_3@@1 f_7))))))
 :qid |stdinbpl.553:22|
 :skolemid |100|
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (and (=> (= (ControlFlow 0 17) 15) anon15_Else_correct) (=> (= (ControlFlow 0 17) 5) anon16_Then_correct)) (=> (= (ControlFlow 0 17) 3) anon16_Else_correct)))))))
(let ((anon14_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 x@@19 $allocated)) (U_2_bool (MapType0Select Heap@@9 y@@6 $allocated))) (and (=> (= (ControlFlow 0 19) 1) anon14_Then_correct) (=> (= (ControlFlow 0 19) 17) anon14_Else_correct))))))
