...
(assert  (and (and (and (and (and (and (and (= (type xs) (MapType2Type RefType boolType)) (= (type ys) (MapType2Type RefType boolType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv22 arg0@@43)) RefType)
 :qid |funType:invRecv22|
 :pattern ( (invRecv22 arg0@@43))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv21 arg0@@44)) RefType)
 :qid |funType:invRecv21|
 :pattern ( (invRecv21 arg0@@44))
))))
(set-info :boogie-vc-id t6)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (U_2_bool (MapType2Select (|Set#Intersection| xs ys) z_1))) (U_2_bool (MapType2Select (|Set#Intersection| xs ys) z_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1))))
 :qid |stdinbpl.1730:17|
 :skolemid |216|
 :pattern ( (neverTriggered23 z_1) (neverTriggered23 z_1_1))
 ...
 :qid |stdinbpl.1730:17|
 :skolemid |216|
 :pattern ( (neverTriggered23 z_1@@0) (neverTriggered23 z_1_1@@0))
)) (=> (= (ControlFlow 0 5) (- 0 4)) (forall ((z_1@@1 T@U) ) (!  (=> (and (= (type z_1@@1) RefType) (U_2_bool (MapType2Select (|Set#Intersection| xs ys) z_1@@1))) (>= (U_2_real (MapType1Select QPMask@1 z_1@@1 f_7)) FullPerm))
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((y_1 T@U) (y_1_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (= (type y_1_1) RefType)) (=> (and (and (and (and (not (= y_1 y_1_1)) (U_2_bool (MapType2Select ys y_1))) (U_2_bool (MapType2Select ys y_1_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= y_1 y_1_1))))
...
))) (=> (forall ((y_1@@0 T@U) (y_1_1@@0 T@U) ) (!  (=> (and (= (type y_1@@0) RefType) (= (type y_1_1@@0) RefType)) (=> (and (and (and (and (not (= y_1@@0 y_1_1@@0)) (U_2_bool (MapType2Select ys y_1@@0))) (U_2_bool (MapType2Select ys y_1_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= y_1@@0 y_1_1@@0))))
 :qid |stdinbpl.1667:15|
 :skolemid |209|
...
)) (=> (and (forall ((y_1@@1 T@U) ) (!  (=> (= (type y_1@@1) RefType) (=> (and (U_2_bool (MapType2Select ys y_1@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange22 y_1@@1) (= (invRecv22 y_1@@1) y_1@@1))))
...
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select ys (invRecv22 o_3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange22 o_3)) (= (invRecv22 o_3) o_3)))
 :qid |stdinbpl.1677:22|
 :skolemid |211|
 :pattern ( (invRecv22 o_3))
))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((y_1@@2 T@U) ) (!  (=> (and (= (type y_1@@2) RefType) (U_2_bool (MapType2Select ys y_1@@2))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
...
))) (=> (forall ((y_1@@3 T@U) ) (!  (=> (and (= (type y_1@@3) RefType) (U_2_bool (MapType2Select ys y_1@@3))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1683:15|
 :skolemid |212|
 :pattern ( (MapType0Select Heap@@9 y_1@@3 f_7))
 :pattern ( (MapType1Select QPMask@1 y_1@@3 f_7))
 :pattern ( (MapType2Select ys y_1@@3))
)) (=> (forall ((y_1@@4 T@U) ) (!  (=> (= (type y_1@@4) RefType) (=> (and (U_2_bool (MapType2Select ys y_1@@4)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= y_1@@4 null))))
 :qid |stdinbpl.1689:22|
 :skolemid |213|
 :pattern ( (MapType0Select Heap@@9 y_1@@4 f_7))
 :pattern ( (MapType1Select QPMask@1 y_1@@4 f_7))
 :pattern ( (MapType2Select ys y_1@@4))
)) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select ys (invRecv22 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange22 o_3@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv22 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (U_2_bool (MapType2Select ys (invRecv22 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange22 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7))))))
...
))) (and (state Heap@@9 QPMask@1) (state Heap@@9 QPMask@1))) (and (=> (= (ControlFlow 0 7) 3) anon9_Then_correct) (=> (= (ControlFlow 0 7) 5) anon9_Else_correct)))))))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 12)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select xs x_1))) (U_2_bool (MapType2Select xs x_1_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= x_1 x_1_1))))
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (U_2_bool (MapType2Select xs x_1@@0))) (U_2_bool (MapType2Select xs x_1_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.1621:15|
 :skolemid |202|
...
)) (=> (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs x_1@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange21 x_1@@1) (= (invRecv21 x_1@@1) x_1@@1))))
...
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv21 o_3@@2))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange21 o_3@@2)) (= (invRecv21 o_3@@2) o_3@@2)))
 :qid |stdinbpl.1631:22|
 :skolemid |204|
 :pattern ( (invRecv21 o_3@@2))
))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (U_2_bool (MapType2Select xs x_1@@2))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 ...
 :qid |stdinbpl.1653:29|
 :skolemid |208|
 :pattern ( (MapType1Select ZeroMask o_3@@4 f_5@@0))
 :pattern ( (MapType1Select QPMask@0 o_3@@4 f_5@@0))
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 10) 2) anon8_Then_correct) (=> (= (ControlFlow 0 10) 7) anon8_Else_correct)))))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 13) 1) anon7_Then_correct) (=> (= (ControlFlow 0 13) 10) anon7_Else_correct)))))
