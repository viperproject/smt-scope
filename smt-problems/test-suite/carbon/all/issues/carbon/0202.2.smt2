...
(assert (forall ((Heap@@2 T@U) (j_1 Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (bool_2_U (|dummy#triggerStateless| j_1))))
 :qid |stdinbpl.256:15|
 :skolemid |25|
 :pattern ( (|dummy'| Heap@@2 j_1))
)))
...
(assert (forall ((Heap@@4 T@U) (Mask@@3 T@U) (j_1@@0 Int) ) (!  (=> (and (and (= (type Heap@@4) (MapType0Type RefType)) (= (type Mask@@3) (MapType1Type RefType realType))) (and (state Heap@@4 Mask@@3) (< AssumeFunctionsAbove 0))) (dummy Heap@@4 j_1@@0))
 :qid |stdinbpl.262:15|
 :skolemid |26|
 :pattern ( (state Heap@@4 Mask@@3) (dummy Heap@@4 j_1@@0))
)))
...
)) (forall ((arg0@@27 T@U) ) (! (= (type (first arg0@@27)) ArrayDomainTypeType)
 :qid |funType:first|
...
(assert (forall ((Heap@@7 T@U) (Mask@@7 T@U) (j_1@@1 Int) ) (!  (=> (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (state Heap@@7 Mask@@7)) (= (|dummy'| Heap@@7 j_1@@1) (|dummy#frame| EmptyFrame j_1@@1)))
 :qid |stdinbpl.269:15|
 :skolemid |27|
 :pattern ( (state Heap@@7 Mask@@7) (|dummy'| Heap@@7 j_1@@1))
)))
(assert (forall ((Heap@@8 T@U) (j_1@@2 Int) ) (!  (=> (= (type Heap@@8) (MapType0Type RefType)) (and (= (dummy Heap@@8 j_1@@2) (|dummy'| Heap@@8 j_1@@2)) (dummyFunction (bool_2_U (|dummy#triggerStateless| j_1@@2)))))
 :qid |stdinbpl.252:15|
 :skolemid |24|
 :pattern ( (dummy Heap@@8 j_1@@2))
)))
...
(declare-fun j_1@@3 () Int)
(declare-fun QPMask@0 () T@U)
(declare-fun a_3@@1 () T@U)
(declare-fun qpRange1 (T@U) Bool)
(declare-fun invRecv1 (T@U) Int)
(assert  (and (and (and (= (type Heap@0) (MapType0Type RefType)) (= (type Heap@@13) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type a_3@@1) ArrayDomainTypeType)))
...
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (exists ((k_1 Int) ) (!  (and (dummy Heap@0 (- k_1 2)) (<= 0 k_1))
 :qid |stdinbpl.395:15|
 :skolemid |34|
)))))
(let ((anon10_Else_correct  (=> (dummy Heap@@13 (- j_1@@3 2)) (=> (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (= FullPerm (U_2_real (MapType1Select QPMask@0 (loc a_3@@1 j_1@@3) val)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 (loc a_3@@1 j_1@@3) val))) (=> (and (= Heap@0 (MapType0Store Heap@@13 (loc a_3@@1 j_1@@3) val (int_2_U 5))) (state Heap@0 QPMask@0)) (and (and (=> (= (ControlFlow 0 7) 4) anon11_Else_correct) (=> (= (ControlFlow 0 7) 5) anon12_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon12_Else_correct)))))))))
(let ((anon10_Then_correct true))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= (- 0 2) i_1) (< i_1 8))) (and (<= (- 0 2) i_1_1) (< i_1_1 8))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 (+ i_1 2)) (loc a_3@@1 (+ i_1_1 2)))))
 :qid |stdinbpl.321:15|
 :skolemid |28|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= (- 0 2) i_1@@0) (< i_1@@0 8))) (and (<= (- 0 2) i_1_1@@0) (< i_1_1@@0 8))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 (+ i_1@@0 2)) (loc a_3@@1 (+ i_1_1@@0 2)))))
 :qid |stdinbpl.321:15|
 :skolemid |28|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= (- 0 2) i_1@@1) (< i_1@@1 8)) (< NoPerm FullPerm)) (and (qpRange1 (loc a_3@@1 (+ i_1@@1 2))) (= (invRecv1 (loc a_3@@1 (+ i_1@@1 2))) i_1@@1)))
 :qid |stdinbpl.327:22|
 :skolemid |29|
 :pattern ( (|dummy#frame| EmptyFrame i_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= (- 0 2) (invRecv1 o_3)) (< (invRecv1 o_3) 8)) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (loc a_3@@1 (+ (invRecv1 o_3) 2)) o_3)))
 :qid |stdinbpl.331:22|
 :skolemid |30|
 :pattern ( (invRecv1 o_3))
)) (forall ((i_1@@2 Int) ) (!  (=> (and (<= (- 0 2) i_1@@2) (< i_1@@2 8)) (not (= (loc a_3@@1 (+ i_1@@2 2)) null)))
 :qid |stdinbpl.337:22|
 :skolemid |31|
 :pattern ( (|dummy#frame| EmptyFrame i_1@@2))
))) (=> (and (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= (- 0 2) (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) 8)) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@1 (+ (invRecv1 o_3@@0) 2)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (and (and (<= (- 0 2) (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) 8)) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.343:22|
 :skolemid |32|
...
))) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0))) (and (and (<= 0 j_1@@3) (< j_1@@3 10)) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)))) (and (=> (= (ControlFlow 0 9) 2) anon10_Then_correct) (=> (= (ControlFlow 0 9) 7) anon10_Else_correct)))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (state Heap@@13 ZeroMask)) (and (=> (= (ControlFlow 0 11) 1) anon9_Then_correct) (=> (= (ControlFlow 0 11) 9) anon9_Else_correct))))))
