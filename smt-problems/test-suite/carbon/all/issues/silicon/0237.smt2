...
(assert  (and (and (and (= (type arr) RefType) (= (type PostHeap@0) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))))
...
(let ((anon10_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 7) 5) anon11_Then_correct) (=> (= (ControlFlow 0 7) 6) anon11_Else_correct)))))
(let ((anon12_Else_correct true))
(let ((anon12_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (not (= (loc arr p_4) null)))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 10)) (forall ((p_1 Int) (p_1_1 Int) ) (!  (=> (and (and (not (= p_1 p_1_1)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_1) (loc arr p_1_1))))
 :qid |stdinbpl.722:15|
 :skolemid |69|
))) (=> (forall ((p_1@@0 Int) (p_1_1@@0 Int) ) (!  (=> (and (and (not (= p_1@@0 p_1_1@@0)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_1@@0) (loc arr p_1_1@@0))))
 :qid |stdinbpl.722:15|
 :skolemid |69|
)) (=> (and (forall ((p_1@@1 Int) ) (!  (=> (< NoPerm NoPerm) (and (qpRange8 (loc arr p_1@@1)) (= (invRecv8 (loc arr p_1@@1)) p_1@@1)))
 :qid |stdinbpl.728:22|
 :skolemid |70|
 :pattern ( (loc arr p_1@@1))
 :pattern ( (loc arr p_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (< NoPerm NoPerm) (qpRange8 o_3)) (= (loc arr (invRecv8 o_3)) o_3)))
 :qid |stdinbpl.732:22|
 :skolemid |71|
 :pattern ( (invRecv8 o_3))
))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (forall ((p_1@@2 Int) ) (! (>= NoPerm NoPerm)
 :qid |stdinbpl.738:15|
 :skolemid |72|
 ...
 :pattern ( (loc arr p_1@@3))
)) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (< NoPerm NoPerm) (qpRange8 o_3@@0)) (and (=> (< NoPerm NoPerm) (= (loc arr (invRecv8 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) NoPerm)))) (=> (not (and (< NoPerm NoPerm) (qpRange8 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.747:22|
 :skolemid |73|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 8) 7) anon10_Then_correct) (=> (= (ControlFlow 0 8) 3) anon12_Then_correct)) (=> (= (ControlFlow 0 8) 4) anon12_Else_correct))))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 arr $allocated))) (and (=> (= (ControlFlow 0 11) 1) anon9_Then_correct) (=> (= (ControlFlow 0 11) 8) anon9_Else_correct)))))
