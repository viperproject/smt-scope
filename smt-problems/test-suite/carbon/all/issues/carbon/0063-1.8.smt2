...
(assert  (and (= (Ctor PredicateType_VType) 13) (forall ((arg0@@26 T@U) ) (! (= (type (V arg0@@26)) (FieldType PredicateType_VType FrameTypeType))
 :qid |funType:V|
 :pattern ( (V arg0@@26))
))))
(assert (forall ((this@@0 T@U) ) (!  (=> (= (type this@@0) RefType) (IsPredicateField (V this@@0)))
 :qid |stdinbpl.245:15|
 :skolemid |29|
 :pattern ( (V this@@0))
)))
(assert (forall ((Heap@@2 T@U) (this@@1 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type this@@1) RefType)) (|P#everUsed| (P this@@1)))
 :qid |stdinbpl.216:15|
 :skolemid |27|
 :pattern ( (|P#trigger| Heap@@2 (P this@@1)))
)))
(assert (forall ((Heap@@3 T@U) (this@@2 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type this@@2) RefType)) (|V#everUsed| (V this@@2)))
 :qid |stdinbpl.264:15|
 :skolemid |33|
 :pattern ( (|V#trigger| Heap@@3 (V this@@2)))
)))
...
(assert (forall ((this@@5 T@U) (this2@@1 T@U) ) (!  (=> (and (and (= (type this@@5) RefType) (= (type this2@@1) RefType)) (= (V this@@5) (V this2@@1))) (= this@@5 this2@@1))
 :qid |stdinbpl.255:15|
 :skolemid |31|
 :pattern ( (V this@@5) (V this2@@1))
)))
(assert (forall ((arg0@@28 T@U) ) (! (= (type (|V#sm| arg0@@28)) (FieldType PredicateType_VType (MapType1Type RefType boolType)))
 :qid |funType:V#sm|
 :pattern ( (|V#sm| arg0@@28))
)))
(assert (forall ((this@@6 T@U) (this2@@2 T@U) ) (!  (=> (and (and (= (type this@@6) RefType) (= (type this2@@2) RefType)) (= (|V#sm| this@@6) (|V#sm| this2@@2))) (= this@@6 this2@@2))
 :qid |stdinbpl.259:15|
 :skolemid |32|
...
(assert (forall ((this@@8 T@U) ) (!  (=> (= (type this@@8) RefType) (= (getPredWandId (V this@@8)) 1))
 :qid |stdinbpl.249:15|
 :skolemid |30|
 :pattern ( (V this@@8))
)))
...
(assert (forall ((this@@10 T@U) ) (!  (=> (= (type this@@10) RefType) (= (PredicateMaskField (V this@@10)) (|V#sm| this@@10)))
 :qid |stdinbpl.241:15|
 :skolemid |28|
 :pattern ( (PredicateMaskField (V this@@10)))
)))
...
(assert  (and (and (and (and (and (and (= (type UnfoldingMask@0) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type this@@11) RefType)) (= (type Heap@@11) (MapType0Type RefType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type UnfoldingMask@2) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test0)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon3_correct  (=> (and (and (and (= UnfoldingMask@1 (MapType1Store ZeroMask null (P this@@11) (real_2_U (- (U_2_real (MapType1Select ZeroMask null (P this@@11))) FullPerm)))) (state PostHeap@0 UnfoldingMask@1)) (and (state PostHeap@0 ZeroMask) (|P#trigger| PostHeap@0 (P this@@11)))) (and (and (= (MapType0Select PostHeap@0 null (P this@@11)) EmptyFrame) (= UnfoldingMask@2 (MapType1Store ZeroMask null (P this@@11) (real_2_U (- (U_2_real (MapType1Select ZeroMask null (P this@@11))) FullPerm))))) (and (state PostHeap@0 UnfoldingMask@2) (= (ControlFlow 0 8) (- 0 7))))) (HasDirectPerm ZeroMask this@@11 x@@8))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon3_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select ZeroMask null (P this@@11))))) (=> (<= FullPerm (U_2_real (MapType1Select ZeroMask null (P this@@11)))) (=> (= (ControlFlow 0 9) 8) anon3_correct))))))
(let ((anon7_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (|P#trigger| PostHeap@0 (P this@@11)) (= (MapType0Select PostHeap@0 null (P this@@11)) EmptyFrame)) (and (=> (= (ControlFlow 0 12) 9) anon8_Then_correct) (=> (= (ControlFlow 0 12) 11) anon8_Else_correct))))))
(let ((anon6_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (P this@@11) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P this@@11))) FullPerm)))) (=> (and (state Heap@@11 UnfoldingMask@0) (= (ControlFlow 0 2) (- 0 1))) (= (U_2_int (MapType0Select Heap@@11 this@@11 x@@8)) 0)))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon6_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P this@@11))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P this@@11)))) (=> (= (ControlFlow 0 3) 2) anon6_correct))))))
(let ((anon7_Else_correct  (=> (and (|P#trigger| Heap@@11 (P this@@11)) (= (MapType0Select Heap@@11 null (P this@@11)) EmptyFrame)) (and (=> (= (ControlFlow 0 6) 3) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct)))))
(let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@11 this@@11 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (P this@@11) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P this@@11))) FullPerm))))) (and (state Heap@@11 Mask@0) (state Heap@@11 Mask@0))) (and (=> (= (ControlFlow 0 13) 12) anon7_Then_correct) (=> (= (ControlFlow 0 13) 6) anon7_Else_correct))))))
