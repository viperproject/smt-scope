...
(assert  (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type self@@2) RefType)) (= (type Heap@@17) (MapType0Type RefType))))
(set-info :boogie-vc-id |lookup#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 5) 2)) anon3_correct)))
(let ((anon6_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= perm@0 (U_2_real (MapType1Select Mask@0 null (VecI32 self@@2))))) (=> (<= perm@0 (U_2_real (MapType1Select Mask@0 null (VecI32 self@@2)))) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))
(let ((anon5_Then_correct  (=> (= perm@0 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 6) 3) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@17 self@@2 $allocated)) (= AssumeFunctionsAbove 0)) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (VecI32 self@@2) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (VecI32 self@@2))) FullPerm)))) (state Heap@@17 Mask@0)) (and (<= 0 index@@2) (state Heap@@17 Mask@0))) (and (=> (= (ControlFlow 0 8) 6) anon5_Then_correct) (=> (= (ControlFlow 0 8) 1) anon5_Else_correct)))))))
