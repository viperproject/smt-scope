...
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (List this@@38))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (List this@@38)))) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
(let ((anon14_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (= Result@0 (|Seq#Length| (content Heap@1 this@@38))))))
(let ((anon12_Else_correct  (=> (= Heap@0 (MapType0Store Heap@@38 null (|List#sm| this@@38) (MapType1Store (MapType0Select Heap@@38 null (|List#sm| this@@38)) this@@38 head (bool_2_U true)))) (=> (and (and (forall ((o_15 T@U) (f_19 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_19))))
(let ((A@@12 (FieldTypeInv0 (type f_19))))
 (=> (and (and (= (type o_15) RefType) (= (type f_19) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@0 null (|List#sm| this@@38)) o_15 f_19)) (U_2_bool (MapType1Select (MapType0Select Heap@0 null (|lseg#sm| (MapType0Select Heap@0 this@@38 head) null)) o_15 f_19)))) (U_2_bool (MapType1Select newPMask@0 o_15 f_19)))))
 :qid |stdinbpl.1490:31|
 :skolemid |103|
 :pattern ( (MapType1Select newPMask@0 o_15 f_19))
)) (= Heap@1 (MapType0Store Heap@0 null (|List#sm| this@@38) newPMask@0))) (and (state Heap@1 Mask@0) (= Result@0 (lengthNodes Heap@1 (MapType0Select Heap@1 this@@38 head) null)))) (and (and (=> (= (ControlFlow 0 11) 6) anon14_Else_correct) (=> (= (ControlFlow 0 11) 8) anon15_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon15_Else_correct))))))
(let ((anon5_correct true))
(let ((anon13_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon5_correct)))
(let ((anon13_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@2 null (lseg (MapType0Select Heap@@38 this@@38 head) null))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@2 null (lseg (MapType0Select Heap@@38 this@@38 head) null)))) (=> (= (ControlFlow 0 2) 1) anon5_correct))))))
(let ((anon2_correct  (=> (and (and (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (List this@@38) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (List this@@38))) FullPerm)))) (not (= this@@38 null))) (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this@@38 head (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this@@38 head)) FullPerm)))) (state Heap@@38 UnfoldingMask@1))) (and (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 null (lseg (MapType0Select Heap@@38 this@@38 head) null) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 null (lseg (MapType0Select Heap@@38 this@@38 head) null))) FullPerm)))) (InsidePredicate (List this@@38) (MapType0Select Heap@@38 null (List this@@38)) (lseg (MapType0Select Heap@@38 this@@38 head) null) (MapType0Select Heap@@38 null (lseg (MapType0Select Heap@@38 this@@38 head) null)))) (and (state Heap@@38 UnfoldingMask@2) (state Heap@@38 UnfoldingMask@2)))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm UnfoldingMask@2 this@@38 head)) (=> (HasDirectPerm UnfoldingMask@2 this@@38 head) (and (and (=> (= (ControlFlow 0 12) 11) anon12_Else_correct) (=> (= (ControlFlow 0 12) 2) anon13_Then_correct)) (=> (= (ControlFlow 0 12) 4) anon13_Else_correct)))))))
(let ((anon11_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 12)) anon2_correct)))
(let ((anon11_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (List this@@38))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (List this@@38)))) (=> (= (ControlFlow 0 14) 12) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@38 ZeroMask) (U_2_bool (MapType0Select Heap@@38 this@@38 $allocated))) (and (= AssumeFunctionsAbove 1) (= Mask@0 (MapType1Store ZeroMask null (List this@@38) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (List this@@38))) FullPerm)))))) (and (and (state Heap@@38 Mask@0) (state Heap@@38 Mask@0)) (and (|List#trigger| Heap@@38 (List this@@38)) (= (MapType0Select Heap@@38 null (List this@@38)) (CombineFrames (FrameFragment (MapType0Select Heap@@38 this@@38 head)) (MapType0Select Heap@@38 null (lseg (MapType0Select Heap@@38 this@@38 head) null))))))) (and (=> (= (ControlFlow 0 17) 14) anon11_Then_correct) (=> (= (ControlFlow 0 17) 16) anon11_Else_correct)))))
