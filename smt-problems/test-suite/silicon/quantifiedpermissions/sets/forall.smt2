(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:20:15
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quantifiedpermissions/sets/forall.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (not (forall ((y1@5@01 $Ref) (y2@5@01 $Ref)) (!
  (=>
    (and (Set_in y1@5@01 xs@3@01) (Set_in y2@5@01 xs@3@01) (= y1@5@01 y2@5@01))
    (= y1@5@01 y2@5@01))
...
(assert (forall ((y@5@01 $Ref)) (!
  (=>
    (Set_in y@5@01 xs@3@01)
    (and (= (inv@6@01 y@5@01) y@5@01) (img@7@01 y@5@01)))
  :pattern ((Set_in y@5@01 xs@3@01))
...
(assert (forall ((y@5@01 $Ref)) (!
  (=> (Set_in y@5@01 xs@3@01) (not (= y@5@01 $Ref.null)))
  :pattern ((Set_in y@5@01 xs@3@01))
  :pattern ((inv@6@01 y@5@01))
  :pattern ((img@7@01 y@5@01))
...
(assert (=>
  (and (img@7@01 x@2@01) (Set_in (inv@6@01 x@2@01) xs@3@01))
  (=
    ($FVF.lookup_f (as sm@9@01  $FVF<f>) x@2@01)
    ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.first $t@4@01)) x@2@01))))
; [exec]
; x.f := 5
; Precomputing data for removing quantified permissions
...
(assert (= ($FVF.lookup_f (as sm@11@01  $FVF<f>) x@2@01) 5))
(pop) ; 2
(pop) ; 1
