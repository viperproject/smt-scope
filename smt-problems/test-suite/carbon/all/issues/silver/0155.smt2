...
(declare-fun g () T@U)
(assert  (and (= (type Heap@@9) (MapType0Type RefType)) (= (type g) (MapType2Type RefType boolType))))
(set-info :boogie-vc-id foo)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (|Set#Equal| g (|Set#Union| g (|Set#Empty| RefType))))))
