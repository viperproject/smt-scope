...
(assert  (and (and (and (and (and (and (and (and (and (= (type Mask@3) (MapType1Type RefType realType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type z@@0) RefType)) (= (type y@@6) RefType)) (= (type x@@19) RefType)) (= (type Heap@@14) (MapType0Type RefType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id m2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon8_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) r_1))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) r_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1 r_1_1))))
 :qid |stdinbpl.884:17|
 :skolemid |120|
 :pattern ( (neverTriggered3 r_1) (neverTriggered3 r_1_1))
)))))
(let ((anon8_Then_correct true))
(let ((anon7_Then_correct  (=> (and (and (state PostHeap@0 ZeroMask) (= PostMask@0 (MapType1Store ZeroMask null (p2 z@@0) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (p2 z@@0))) FullPerm))))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 10) 7) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct)))))
(let ((anon6_correct  (=> (= Mask@3 (MapType1Store Mask@2 null (p2 z@@0) (real_2_U (- (U_2_real (MapType1Select Mask@2 null (p2 z@@0))) FullPerm)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((r_4 T@U) (r_4_1 T@U) ) (!  (=> (and (= (type r_4) RefType) (= (type r_4_1) RefType)) (=> (and (and (and (and (not (= r_4 r_4_1)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) r_4))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| y@@6) x@@19) r_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_4 r_4_1))))
 :qid |stdinbpl.937:17|
 :skolemid |126|
 :pattern ( (neverTriggered4 r_4) (neverTriggered4 r_4_1))
