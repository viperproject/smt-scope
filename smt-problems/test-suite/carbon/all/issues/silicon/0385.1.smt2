...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type s) RefType) (= (type ExhaleWellDef0Mask@20) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@18) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@19) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type r_1) RefType)) (= (type ExhaleWellDef0Mask@17) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@15) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@16) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@14) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@12) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@13) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@8) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@11) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@10) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@9) (MapType1Type RefType realType))) (= (type Heap@@25) (MapType0Type RefType))) (= (type ExhaleWellDef0Mask@4) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@7) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@6) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@5) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@0) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@3) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@2) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id testC)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 86) (let ((anon56_correct true))
(let ((anon52_correct  (=> (= ExhaleWellDef0Mask@2 (MapType1Store ExhaleWellDef0Mask@1 s flag (real_2_U (- (U_2_real (MapType1Select ExhaleWellDef0Mask@1 s flag)) FullPerm)))) (=> (and (= ExhaleWellDef0Mask@3 ExhaleWellDef0Mask@2) (= (ControlFlow 0 72) 66)) anon56_correct))))
(let ((anon83_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 75) 72)) anon52_correct)))
(let ((anon83_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 73) (- 0 74)) (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@1 s flag)))) (=> (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@1 s flag))) (=> (= (ControlFlow 0 73) 72) anon52_correct))))))
(let ((anon50_correct  (=> (= ExhaleWellDef0Mask@1 (MapType1Store Mask@1 r_1 flag (real_2_U (- (U_2_real (MapType1Select Mask@1 r_1 flag)) FullPerm)))) (and (=> (= (ControlFlow 0 76) 73) anon83_Then_correct) (=> (= (ControlFlow 0 76) 75) anon83_Else_correct)))))
(let ((anon82_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 79) 76)) anon50_correct)))
(let ((anon82_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 77) (- 0 78)) (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag))) (=> (= (ControlFlow 0 77) 76) anon50_correct))))))
(let ((anon81_Then_correct  (=> (guard s) (and (=> (= (ControlFlow 0 80) 77) anon82_Then_correct) (=> (= (ControlFlow 0 80) 79) anon82_Else_correct)))))
(let ((anon55_correct  (=> (= ExhaleWellDef0Mask@0 (MapType1Store Mask@1 r_1 flag (real_2_U (- (U_2_real (MapType1Select Mask@1 r_1 flag)) FullPerm)))) (=> (and (= ExhaleWellDef0Mask@3 ExhaleWellDef0Mask@0) (= (ControlFlow 0 67) 66)) anon56_correct))))
(let ((anon84_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 70) 67)) anon55_correct)))
(let ((anon84_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 68) (- 0 69)) (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag))) (=> (= (ControlFlow 0 68) 67) anon55_correct))))))
(let ((anon81_Else_correct  (=> (not (guard s)) (and (=> (= (ControlFlow 0 71) 68) anon84_Then_correct) (=> (= (ControlFlow 0 71) 70) anon84_Else_correct)))))
(let ((anon45_correct true))
(let ((anon41_correct  (=> (= ExhaleWellDef0Mask@6 (MapType1Store ExhaleWellDef0Mask@5 s flag (real_2_U (- (U_2_real (MapType1Select ExhaleWellDef0Mask@5 s flag)) FullPerm)))) (=> (and (= ExhaleWellDef0Mask@7 ExhaleWellDef0Mask@6) (= (ControlFlow 0 57) 51)) anon45_correct))))
(let ((anon78_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 60) 57)) anon41_correct)))
(let ((anon78_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 58) (- 0 59)) (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@5 s flag)))) (=> (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@5 s flag))) (=> (= (ControlFlow 0 58) 57) anon41_correct))))))
(let ((anon39_correct  (=> (= ExhaleWellDef0Mask@5 (MapType1Store Mask@1 r_1 flag (real_2_U (- (U_2_real (MapType1Select Mask@1 r_1 flag)) FullPerm)))) (and (=> (= (ControlFlow 0 61) 58) anon78_Then_correct) (=> (= (ControlFlow 0 61) 60) anon78_Else_correct)))))
(let ((anon77_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 64) 61)) anon39_correct)))
(let ((anon77_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 62) (- 0 63)) (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag))) (=> (= (ControlFlow 0 62) 61) anon39_correct))))))
(let ((anon76_Then_correct  (=> (guard s) (and (=> (= (ControlFlow 0 65) 62) anon77_Then_correct) (=> (= (ControlFlow 0 65) 64) anon77_Else_correct)))))
(let ((anon44_correct  (=> (= ExhaleWellDef0Mask@4 (MapType1Store Mask@1 r_1 flag (real_2_U (- (U_2_real (MapType1Select Mask@1 r_1 flag)) FullPerm)))) (=> (and (= ExhaleWellDef0Mask@7 ExhaleWellDef0Mask@4) (= (ControlFlow 0 52) 51)) anon45_correct))))
(let ((anon79_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 55) 52)) anon44_correct)))
(let ((anon79_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 53) (- 0 54)) (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag))) (=> (= (ControlFlow 0 53) 52) anon44_correct))))))
(let ((anon76_Else_correct  (=> (not (guard s)) (and (=> (= (ControlFlow 0 56) 53) anon79_Then_correct) (=> (= (ControlFlow 0 56) 55) anon79_Else_correct)))))
(let ((anon80_Else_correct  (=> (= (ControlFlow 0 50) (- 0 49)) (= (foo_2_1 Heap@@25 s r_1) (foo_2_2 Heap@@25 s r_1)))))
(let ((anon70_Else_correct  (and (=> (= (ControlFlow 0 81) (- 0 82)) (= (foo_1_2 Heap@@25 s r_1) (foo_2_1 Heap@@25 s r_1))) (=> (= (foo_1_2 Heap@@25 s r_1) (foo_2_1 Heap@@25 s r_1)) (and (and (and (and (=> (= (ControlFlow 0 81) 50) anon80_Else_correct) (=> (= (ControlFlow 0 81) 80) anon81_Then_correct)) (=> (= (ControlFlow 0 81) 71) anon81_Else_correct)) (=> (= (ControlFlow 0 81) 65) anon76_Then_correct)) (=> (= (ControlFlow 0 81) 56) anon76_Else_correct))))))
(let ((anon34_correct true))
(let ((anon30_correct  (=> (= ExhaleWellDef0Mask@10 (MapType1Store ExhaleWellDef0Mask@9 s flag (real_2_U (- (U_2_real (MapType1Select ExhaleWellDef0Mask@9 s flag)) FullPerm)))) (=> (and (= ExhaleWellDef0Mask@11 ExhaleWellDef0Mask@10) (= (ControlFlow 0 40) 34)) anon34_correct))))
(let ((anon73_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 43) 40)) anon30_correct)))
(let ((anon73_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 41) (- 0 42)) (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@9 s flag)))) (=> (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@9 s flag))) (=> (= (ControlFlow 0 41) 40) anon30_correct))))))
(let ((anon28_correct  (=> (= ExhaleWellDef0Mask@9 (MapType1Store Mask@1 r_1 flag (real_2_U (- (U_2_real (MapType1Select Mask@1 r_1 flag)) FullPerm)))) (and (=> (= (ControlFlow 0 44) 41) anon73_Then_correct) (=> (= (ControlFlow 0 44) 43) anon73_Else_correct)))))
(let ((anon72_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 47) 44)) anon28_correct)))
(let ((anon72_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 45) (- 0 46)) (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag))) (=> (= (ControlFlow 0 45) 44) anon28_correct))))))
(let ((anon71_Then_correct  (=> (guard s) (and (=> (= (ControlFlow 0 48) 45) anon72_Then_correct) (=> (= (ControlFlow 0 48) 47) anon72_Else_correct)))))
(let ((anon33_correct  (=> (= ExhaleWellDef0Mask@8 (MapType1Store Mask@1 r_1 flag (real_2_U (- (U_2_real (MapType1Select Mask@1 r_1 flag)) FullPerm)))) (=> (and (= ExhaleWellDef0Mask@11 ExhaleWellDef0Mask@8) (= (ControlFlow 0 35) 34)) anon34_correct))))
(let ((anon74_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 38) 35)) anon33_correct)))
(let ((anon74_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 36) (- 0 37)) (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag))) (=> (= (ControlFlow 0 36) 35) anon33_correct))))))
(let ((anon71_Else_correct  (=> (not (guard s)) (and (=> (= (ControlFlow 0 39) 36) anon74_Then_correct) (=> (= (ControlFlow 0 39) 38) anon74_Else_correct)))))
(let ((anon23_correct true))
(let ((anon22_correct  (=> (= ExhaleWellDef0Mask@13 (MapType1Store ExhaleWellDef0Mask@12 s flag (real_2_U (- (U_2_real (MapType1Select ExhaleWellDef0Mask@12 s flag)) FullPerm)))) (=> (and (= ExhaleWellDef0Mask@14 ExhaleWellDef0Mask@13) (= (ControlFlow 0 25) 23)) anon23_correct))))
(let ((anon69_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 28) 25)) anon22_correct)))
(let ((anon69_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@12 s flag)))) (=> (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@12 s flag))) (=> (= (ControlFlow 0 26) 25) anon22_correct))))))
(let ((anon68_Then_correct  (=> (guard s) (and (=> (= (ControlFlow 0 29) 26) anon69_Then_correct) (=> (= (ControlFlow 0 29) 28) anon69_Else_correct)))))
(let ((anon68_Else_correct  (=> (not (guard s)) (=> (and (= ExhaleWellDef0Mask@14 ExhaleWellDef0Mask@12) (= (ControlFlow 0 24) 23)) anon23_correct))))
(let ((anon19_correct  (=> (= ExhaleWellDef0Mask@12 (MapType1Store Mask@1 r_1 flag (real_2_U (- (U_2_real (MapType1Select Mask@1 r_1 flag)) FullPerm)))) (and (=> (= (ControlFlow 0 30) 29) anon68_Then_correct) (=> (= (ControlFlow 0 30) 24) anon68_Else_correct)))))
(let ((anon67_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 33) 30)) anon19_correct)))
(let ((anon67_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 31) (- 0 32)) (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag))) (=> (= (ControlFlow 0 31) 30) anon19_correct))))))
(let ((anon62_Else_correct  (and (=> (= (ControlFlow 0 83) (- 0 84)) (= (foo_1_1 Heap@@25 s r_1) (foo_1_2 Heap@@25 s r_1))) (=> (= (foo_1_1 Heap@@25 s r_1) (foo_1_2 Heap@@25 s r_1)) (and (and (and (and (=> (= (ControlFlow 0 83) 81) anon70_Else_correct) (=> (= (ControlFlow 0 83) 48) anon71_Then_correct)) (=> (= (ControlFlow 0 83) 39) anon71_Else_correct)) (=> (= (ControlFlow 0 83) 31) anon67_Then_correct)) (=> (= (ControlFlow 0 83) 33) anon67_Else_correct))))))
(let ((anon15_correct true))
(let ((anon14_correct  (=> (= ExhaleWellDef0Mask@16 (MapType1Store ExhaleWellDef0Mask@15 s flag (real_2_U (- (U_2_real (MapType1Select ExhaleWellDef0Mask@15 s flag)) FullPerm)))) (=> (and (= ExhaleWellDef0Mask@17 ExhaleWellDef0Mask@16) (= (ControlFlow 0 14) 12)) anon15_correct))))
(let ((anon65_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 17) 14)) anon14_correct)))
(let ((anon65_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@15 s flag)))) (=> (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@15 s flag))) (=> (= (ControlFlow 0 15) 14) anon14_correct))))))
(let ((anon64_Then_correct  (=> (guard s) (and (=> (= (ControlFlow 0 18) 15) anon65_Then_correct) (=> (= (ControlFlow 0 18) 17) anon65_Else_correct)))))
(let ((anon64_Else_correct  (=> (not (guard s)) (=> (and (= ExhaleWellDef0Mask@17 ExhaleWellDef0Mask@15) (= (ControlFlow 0 13) 12)) anon15_correct))))
(let ((anon11_correct  (=> (= ExhaleWellDef0Mask@15 (MapType1Store Mask@1 r_1 flag (real_2_U (- (U_2_real (MapType1Select Mask@1 r_1 flag)) FullPerm)))) (and (=> (= (ControlFlow 0 19) 18) anon64_Then_correct) (=> (= (ControlFlow 0 19) 13) anon64_Else_correct)))))
(let ((anon63_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 22) 19)) anon11_correct)))
(let ((anon63_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag))) (=> (= (ControlFlow 0 20) 19) anon11_correct))))))
(let ((anon7_correct true))
(let ((anon6_correct  (=> (= ExhaleWellDef0Mask@19 (MapType1Store ExhaleWellDef0Mask@18 s flag (real_2_U (- (U_2_real (MapType1Select ExhaleWellDef0Mask@18 s flag)) FullPerm)))) (=> (and (= ExhaleWellDef0Mask@20 ExhaleWellDef0Mask@19) (= (ControlFlow 0 3) 1)) anon7_correct))))
(let ((anon61_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon6_correct)))
(let ((anon61_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@18 s flag)))) (=> (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@18 s flag))) (=> (= (ControlFlow 0 4) 3) anon6_correct))))))
(let ((anon60_Then_correct  (=> (guard s) (and (=> (= (ControlFlow 0 7) 4) anon61_Then_correct) (=> (= (ControlFlow 0 7) 6) anon61_Else_correct)))))
(let ((anon60_Else_correct  (=> (not (guard s)) (=> (and (= ExhaleWellDef0Mask@20 ExhaleWellDef0Mask@18) (= (ControlFlow 0 2) 1)) anon7_correct))))
(let ((anon3_correct  (=> (= ExhaleWellDef0Mask@18 (MapType1Store Mask@1 r_1 flag (real_2_U (- (U_2_real (MapType1Select Mask@1 r_1 flag)) FullPerm)))) (and (=> (= (ControlFlow 0 8) 7) anon60_Then_correct) (=> (= (ControlFlow 0 8) 2) anon60_Else_correct)))))
(let ((anon59_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon3_correct)))
(let ((anon59_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag))) (=> (= (ControlFlow 0 9) 8) anon3_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@25 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@25 s $allocated)) (U_2_bool (MapType0Select Heap@@25 r_1 $allocated)))) (=> (and (and (and (not (= r_1 null)) (= Mask@0 (MapType1Store ZeroMask r_1 flag (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1 flag)) FullPerm))))) (and (state Heap@@25 Mask@0) (state Heap@@25 Mask@0))) (and (and (not (= s null)) (= Mask@1 (MapType1Store Mask@0 s flag (real_2_U (+ (U_2_real (MapType1Select Mask@0 s flag)) FullPerm))))) (and (state Heap@@25 Mask@1) (state Heap@@25 Mask@1)))) (and (and (and (and (=> (= (ControlFlow 0 85) 83) anon62_Else_correct) (=> (= (ControlFlow 0 85) 20) anon63_Then_correct)) (=> (= (ControlFlow 0 85) 22) anon63_Else_correct)) (=> (= (ControlFlow 0 85) 9) anon59_Then_correct)) (=> (= (ControlFlow 0 85) 11) anon59_Else_correct))))))
