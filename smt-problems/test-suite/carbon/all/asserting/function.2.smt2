...
(assert  (and (and (and (= (type Heap@@17) (MapType0Type RefType)) (= (type x@@16) RefType)) (= (type y@@9) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |fplusone#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (and (state Heap@@17 ZeroMask) (U_2_bool (MapType0Select Heap@@17 x@@16 $allocated))) (and (U_2_bool (MapType0Select Heap@@17 y@@9 $allocated)) (= AssumeFunctionsAbove 0))) (and (and (not (= x@@16 null)) (= Mask@0 (MapType1Store ZeroMask x@@16 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@16 f_7)) FullPerm))))) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (= x@@16 null))) (=> (not (= x@@16 null)) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@0 x@@16 f_7)))))))
