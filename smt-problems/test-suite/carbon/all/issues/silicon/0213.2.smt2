...
(declare-fun self@@5 () T@U)
(declare-fun Mask@0 () T@U)
(assert  (and (and (= (type Heap@@10) (MapType1Type RefType)) (= (type self@@5) RefType)) (= (type Mask@0) (MapType0Type RefType realType))))
(set-info :boogie-vc-id |Foo#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType1Select Heap@@10 self@@5 $allocated))) (=> (and (and (not (= self@@5 null)) (= Mask@0 (MapType0Store ZeroMask self@@5 f1 (real_2_U (+ (U_2_real (MapType0Select ZeroMask self@@5 f1)) FullPerm))))) (and (state Heap@@10 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@0 self@@5 f1)))))
