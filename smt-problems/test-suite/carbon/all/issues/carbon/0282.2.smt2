...
(declare-fun |f1#frame| (T@U Int) Bool)
(declare-fun f1 (T@U Int) Bool)
...
(assert (forall ((Heap@@2 T@U) (idx Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (bool_2_U (|f1#triggerStateless| idx))))
 :qid |stdinbpl.199:15|
 :skolemid |23|
 :pattern ( (|f1'| Heap@@2 idx))
)))
...
(assert (forall ((Heap@@6 T@U) (Mask@@6 T@U) (idx@@0 Int) ) (!  (=> (and (and (= (type Heap@@6) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (state Heap@@6 Mask@@6)) (= (|f1'| Heap@@6 idx@@0) (|f1#frame| EmptyFrame idx@@0)))
 :qid |stdinbpl.206:15|
 :skolemid |24|
 :pattern ( (state Heap@@6 Mask@@6) (|f1'| Heap@@6 idx@@0))
)))
(assert (forall ((Heap@@7 T@U) (idx@@1 Int) ) (!  (=> (= (type Heap@@7) (MapType0Type RefType)) (and (= (f1 Heap@@7 idx@@1) (|f1'| Heap@@7 idx@@1)) (dummyFunction (bool_2_U (|f1#triggerStateless| idx@@1)))))
 :qid |stdinbpl.195:15|
 :skolemid |22|
 :pattern ( (f1 Heap@@7 idx@@1))
)))
...
(let ((anon12_Then_correct  (=> (and (<= 0 i$0) (< i$0 10)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (foo i$0 i_3)) (=> (foo i$0 i_3) (=> (= (ControlFlow 0 5) 4) anon6_correct))))))
(let ((anon11_Else_correct true))
(let ((anon10_Else_correct true))
(let ((anon9_Else_correct  (=> (forall ((j_1_1 Int) ) (!  (=> (and (<= 0 j_1_1) (< j_1_1 10)) (foo j_1_1 i_3))
 :qid |stdinbpl.408:20|
 :skolemid |30|
 :pattern ( (foo j_1_1 i_3))
)) (=> (and (state Heap@@12 ZeroMask) (state Heap@@12 ZeroMask)) (and (and (and (=> (= (ControlFlow 0 8) 2) anon10_Else_correct) (=> (= (ControlFlow 0 8) 3) anon11_Else_correct)) (=> (= (ControlFlow 0 8) 5) anon12_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon12_Else_correct))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@12 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 9) 1) anon9_Then_correct) (=> (= (ControlFlow 0 9) 8) anon9_Else_correct)))))
