...
(assert  (and (and (and (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type ys@@9) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |List#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (= (MapType0Select Heap@@14 ys@@9 next) null) (=> (and (= Mask@3 Mask@1) (= (ControlFlow 0 4) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (not (= (MapType0Select Heap@@14 ys@@9 next) null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 ys@@9 next)) (=> (HasDirectPerm Mask@1 ys@@9 next) (=> (and (and (= Mask@2 (MapType1Store Mask@1 null (List (MapType0Select Heap@@14 ys@@9 next)) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (List (MapType0Select Heap@@14 ys@@9 next)))) FullPerm)))) (state Heap@@14 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 2) 1))) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@14 ys@@9 $allocated))) (and (not (= ys@@9 null)) (= Mask@0 (MapType1Store ZeroMask ys@@9 val (real_2_U (+ (U_2_real (MapType1Select ZeroMask ys@@9 val)) FullPerm)))))) (and (and (state Heap@@14 Mask@0) (not (= ys@@9 null))) (and (= Mask@1 (MapType1Store Mask@0 ys@@9 next (real_2_U (+ (U_2_real (MapType1Select Mask@0 ys@@9 next)) FullPerm)))) (state Heap@@14 Mask@1)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@1 ys@@9 next)) (=> (HasDirectPerm Mask@1 ys@@9 next) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))))
