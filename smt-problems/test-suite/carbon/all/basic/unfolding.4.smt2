...
(assert  (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type r_1@@23) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id t7)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@13 ZeroMask) (U_2_bool (MapType0Select Heap@@13 r_1@@23 $allocated))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (strange r_1@@23) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (strange r_1@@23))) FullPerm)))) (state Heap@@13 Mask@0)) (and (state Heap@@13 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) false))))
...
(declare-fun Mask@0 () T@U)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@8) (MapType0Type RefType)) (= (type Mask@7) (MapType1Type RefType realType))) (= (type r_1@@23) RefType)) (= (type Heap@1) (MapType0Type RefType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Heap@7) (MapType0Type RefType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type Heap@3) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type newPMask@1) (MapType1Type RefType boolType))) (= (type Heap@6) (MapType0Type RefType))) (= (type UnfoldingHeap@6) (MapType0Type RefType))) (= (type UnfoldingMask@6) (MapType1Type RefType realType))) (= (type Heap@2) (MapType0Type RefType))) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (= (type UnfoldingHeap@5) (MapType0Type RefType))) (= (type UnfoldingMask@5) (MapType1Type RefType realType))) (= (type UnfoldingHeap@1) (MapType0Type RefType))) (= (type UnfoldingHeap@2) (MapType0Type RefType))) (= (type UnfoldingHeap@3) (MapType0Type RefType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type UnfoldingHeap@4) (MapType0Type RefType))) (= (type UnfoldingMask@3) (MapType1Type RefType realType))) (= (type UnfoldingMask@4) (MapType1Type RefType realType))) (= (type UnfoldingHeap@0) (MapType0Type RefType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (forall ((arg0@@34 T@U) (arg1@@10 T@U) ) (! (= (type (CombineFrames arg0@@34 arg1@@10)) FrameTypeType)
...
(set-info :boogie-vc-id t9)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon12_correct  (=> (and (state Heap@8 Mask@7) (state Heap@8 Mask@7)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@7 r_1@@23 next)) (=> (HasDirectPerm Mask@7 r_1@@23 next) (=> (= (ControlFlow 0 2) (- 0 1)) (= (MapType0Select Heap@8 r_1@@23 next) null)))))))
(let ((anon11_correct  (=> (and (and (state Heap@7 Mask@6) (= Mask@7 Mask@6)) (and (= Heap@8 Heap@7) (= (ControlFlow 0 5) 2))) anon12_correct)))
(let ((anon18_Else_correct  (=> (= (MapType0Select Heap@3 r_1@@23 next) null) (=> (and (= Heap@7 Heap@3) (= (ControlFlow 0 7) 5)) anon11_correct))))
(let ((anon18_Then_correct  (=> (not (= (MapType0Select Heap@3 r_1@@23 next) null)) (=> (and (= Heap@4 (MapType0Store Heap@3 null (|strange#sm| r_1@@23) (MapType1Store (MapType0Select Heap@3 null (|strange#sm| r_1@@23)) (MapType0Select Heap@3 r_1@@23 next) f_7 (bool_2_U true)))) (= Heap@5 (MapType0Store Heap@4 null (|strange#sm| r_1@@23) (MapType1Store (MapType0Select Heap@4 null (|strange#sm| r_1@@23)) (MapType0Select Heap@4 r_1@@23 next) next (bool_2_U true))))) (=> (and (and (forall ((o_35 T@U) (f_40 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_40))))
(let ((A@@12 (FieldTypeInv0 (type f_40))))
 (=> (and (and (= (type o_35) RefType) (= (type f_40) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@5 null (|strange#sm| r_1@@23)) o_35 f_40)) (U_2_bool (MapType1Select (MapType0Select Heap@5 null (|strange#sm| r_1@@23)) o_35 f_40)))) (U_2_bool (MapType1Select newPMask@1 o_35 f_40)))))
 :qid |stdinbpl.2114:33|
 :skolemid |78|
 :pattern ( (MapType1Select newPMask@1 o_35 f_40))
)) (= Heap@6 (MapType0Store Heap@5 null (|strange#sm| r_1@@23) newPMask@1))) (and (= Heap@7 Heap@6) (= (ControlFlow 0 6) 5))) anon11_correct)))))
(let ((anon9_correct  (=> (state UnfoldingHeap@6 UnfoldingMask@6) (=> (and (= Heap@2 (MapType0Store Heap@1 null (|strange#sm| r_1@@23) (MapType1Store (MapType0Select Heap@1 null (|strange#sm| r_1@@23)) r_1@@23 f_7 (bool_2_U true)))) (= Heap@3 (MapType0Store Heap@2 null (|strange#sm| r_1@@23) (MapType1Store (MapType0Select Heap@2 null (|strange#sm| r_1@@23)) r_1@@23 next (bool_2_U true))))) (and (=> (= (ControlFlow 0 8) 6) anon18_Then_correct) (=> (= (ControlFlow 0 8) 7) anon18_Else_correct))))))
(let ((anon8_correct  (=> (and (and (state UnfoldingHeap@5 UnfoldingMask@5) (= UnfoldingHeap@6 UnfoldingHeap@5)) (and (= UnfoldingMask@6 UnfoldingMask@5) (= (ControlFlow 0 10) 8))) anon9_correct)))
(let ((anon17_Else_correct  (=> (= (MapType0Select UnfoldingHeap@1 r_1@@23 next) null) (=> (and (= UnfoldingHeap@5 UnfoldingHeap@1) (= (ControlFlow 0 12) 10)) anon8_correct))))
(let ((anon17_Then_correct  (=> (not (= (MapType0Select UnfoldingHeap@1 r_1@@23 next) null)) (=> (and (= UnfoldingHeap@2 (MapType0Store UnfoldingHeap@1 null (|strange#sm| r_1@@23) (MapType1Store (MapType0Select UnfoldingHeap@1 null (|strange#sm| r_1@@23)) (MapType0Select UnfoldingHeap@1 r_1@@23 next) f_7 (bool_2_U true)))) (= UnfoldingHeap@3 (MapType0Store UnfoldingHeap@2 null (|strange#sm| r_1@@23) (MapType1Store (MapType0Select UnfoldingHeap@2 null (|strange#sm| r_1@@23)) (MapType0Select UnfoldingHeap@2 r_1@@23 next) next (bool_2_U true))))) (=> (and (and (forall ((o_34 T@U) (f_39 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_39))))
(let ((A@@13 (FieldTypeInv0 (type f_39))))
 (=> (and (and (= (type o_34) RefType) (= (type f_39) (FieldType A@@13 B@@12))) (or (U_2_bool (MapType1Select (MapType0Select UnfoldingHeap@3 null (|strange#sm| r_1@@23)) o_34 f_39)) (U_2_bool (MapType1Select (MapType0Select UnfoldingHeap@3 null (|strange#sm| r_1@@23)) o_34 f_39)))) (U_2_bool (MapType1Select newPMask@0 o_34 f_39)))))
 :qid |stdinbpl.2097:37|
 :skolemid |77|
 :pattern ( (MapType1Select newPMask@0 o_34 f_39))
)) (= UnfoldingHeap@4 (MapType0Store UnfoldingHeap@3 null (|strange#sm| r_1@@23) newPMask@0))) (and (= UnfoldingHeap@5 UnfoldingHeap@4) (= (ControlFlow 0 11) 10))) anon8_correct)))))
(let ((anon16_Then_correct  (=> (and (and (not (= (MapType0Select Heap@1 r_1@@23 next) null)) (not (= (MapType0Select Heap@1 r_1@@23 next) null))) (and (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 (MapType0Select Heap@1 r_1@@23 next) f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 (MapType0Select Heap@1 r_1@@23 next) f_7)) FullPerm)))) (state Heap@1 UnfoldingMask@3))) (=> (and (and (and (not (= (MapType0Select Heap@1 r_1@@23 next) null)) (= UnfoldingMask@4 (MapType1Store UnfoldingMask@3 (MapType0Select Heap@1 r_1@@23 next) next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@3 (MapType0Select Heap@1 r_1@@23 next) next)) FullPerm))))) (and (state Heap@1 UnfoldingMask@4) (= UnfoldingMask@5 (MapType1Store UnfoldingMask@4 null (strange r_1@@23) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@4 null (strange r_1@@23))) FullPerm)))))) (and (and (InsidePredicate (strange r_1@@23) (MapType0Select Heap@1 null (strange r_1@@23)) (strange r_1@@23) (MapType0Select Heap@1 null (strange r_1@@23))) (state Heap@1 UnfoldingMask@5)) (and (= UnfoldingHeap@0 (MapType0Store Heap@1 null (|strange#sm| r_1@@23) (MapType1Store (MapType0Select Heap@1 null (|strange#sm| r_1@@23)) r_1@@23 f_7 (bool_2_U true)))) (= UnfoldingHeap@1 (MapType0Store UnfoldingHeap@0 null (|strange#sm| r_1@@23) (MapType1Store (MapType0Select UnfoldingHeap@0 null (|strange#sm| r_1@@23)) r_1@@23 next (bool_2_U true))))))) (and (=> (= (ControlFlow 0 13) 11) anon17_Then_correct) (=> (= (ControlFlow 0 13) 12) anon17_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (and (= (MapType0Select Heap@1 r_1@@23 next) null) (= UnfoldingHeap@6 Heap@1)) (and (= UnfoldingMask@6 UnfoldingMask@2) (= (ControlFlow 0 9) 8))) anon9_correct)))
(let ((anon15_Then_correct  (=> (not (= (MapType0Select Heap@1 r_1@@23 next) null)) (=> (and (not (= (MapType0Select Heap@1 r_1@@23 next) null)) (= Mask@4 (MapType1Store Mask@3 (MapType0Select Heap@1 r_1@@23 next) f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@3 (MapType0Select Heap@1 r_1@@23 next) f_7)) FullPerm))))) (=> (and (and (and (and (state Heap@1 Mask@4) (not (= (MapType0Select Heap@1 r_1@@23 next) null))) (and (= Mask@5 (MapType1Store Mask@4 (MapType0Select Heap@1 r_1@@23 next) next (real_2_U (+ (U_2_real (MapType1Select Mask@4 (MapType0Select Heap@1 r_1@@23 next) next)) FullPerm)))) (state Heap@1 Mask@5))) (and (and (= Mask@6 (MapType1Store Mask@5 null (strange r_1@@23) (real_2_U (+ (U_2_real (MapType1Select Mask@5 null (strange r_1@@23))) FullPerm)))) (InsidePredicate (strange r_1@@23) (MapType0Select Heap@1 null (strange r_1@@23)) (strange r_1@@23) (MapType0Select Heap@1 null (strange r_1@@23)))) (and (state Heap@1 Mask@6) (|strange#trigger| Heap@1 (strange r_1@@23))))) (and (and (and (= (MapType0Select Heap@1 null (strange r_1@@23)) (CombineFrames (FrameFragment (MapType0Select Heap@1 r_1@@23 f_7)) (CombineFrames (FrameFragment (MapType0Select Heap@1 r_1@@23 next)) (FrameFragment (ite (not (= (MapType0Select Heap@1 r_1@@23 next) null)) (CombineFrames (FrameFragment (MapType0Select Heap@1 (MapType0Select Heap@1 r_1@@23 next) f_7)) (CombineFrames (FrameFragment (MapType0Select Heap@1 (MapType0Select Heap@1 r_1@@23 next) next)) (MapType0Select Heap@1 null (strange r_1@@23)))) EmptyFrame))))) (= UnfoldingMask@0 (MapType1Store Mask@6 null (strange r_1@@23) (real_2_U (- (U_2_real (MapType1Select Mask@6 null (strange r_1@@23))) FullPerm))))) (and (not (= r_1@@23 null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 r_1@@23 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 r_1@@23 f_7)) FullPerm)))))) (and (and (state Heap@1 UnfoldingMask@1) (not (= r_1@@23 null))) (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 r_1@@23 next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 r_1@@23 next)) FullPerm)))) (state Heap@1 UnfoldingMask@2))))) (and (=> (= (ControlFlow 0 14) 13) anon16_Then_correct) (=> (= (ControlFlow 0 14) 9) anon16_Else_correct)))))))
(let ((anon15_Else_correct  (=> (and (and (= (MapType0Select Heap@1 r_1@@23 next) null) (= Mask@7 Mask@3)) (and (= Heap@8 Heap@1) (= (ControlFlow 0 4) 2))) anon12_correct)))
(let ((anon4_correct  (=> (and (not (= r_1@@23 null)) (= Mask@2 (MapType1Store Mask@1 r_1@@23 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@1 r_1@@23 f_7)) FullPerm))))) (=> (and (and (state Heap@1 Mask@2) (not (= r_1@@23 null))) (and (= Mask@3 (MapType1Store Mask@2 r_1@@23 next (real_2_U (+ (U_2_real (MapType1Select Mask@2 r_1@@23 next)) FullPerm)))) (state Heap@1 Mask@3))) (and (=> (= (ControlFlow 0 15) 14) anon15_Then_correct) (=> (= (ControlFlow 0 15) 4) anon15_Else_correct))))))
(let ((anon14_Else_correct  (=> (HasDirectPerm Mask@1 null (strange r_1@@23)) (=> (and (= Heap@1 Heap@@13) (= (ControlFlow 0 17) 15)) anon4_correct))))
(let ((anon14_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (strange r_1@@23))) (= Heap@0 (MapType0Store Heap@@13 null (strange r_1@@23) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 16) 15))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (strange r_1@@23) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (strange r_1@@23))) FullPerm)))) (and (=> (= (ControlFlow 0 18) 16) anon14_Then_correct) (=> (= (ControlFlow 0 18) 17) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 21) 18)) anon2_correct)))
(let ((anon13_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (strange r_1@@23))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (strange r_1@@23)))) (=> (= (ControlFlow 0 19) 18) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@13 r_1@@23 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (strange r_1@@23) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (strange r_1@@23))) FullPerm))))) (=> (and (and (state Heap@@13 Mask@0) (state Heap@@13 Mask@0)) (and (|strange#trigger| Heap@@13 (strange r_1@@23)) (= (MapType0Select Heap@@13 null (strange r_1@@23)) (CombineFrames (FrameFragment (MapType0Select Heap@@13 r_1@@23 f_7)) (CombineFrames (FrameFragment (MapType0Select Heap@@13 r_1@@23 next)) (FrameFragment (ite (not (= (MapType0Select Heap@@13 r_1@@23 next) null)) (CombineFrames (FrameFragment (MapType0Select Heap@@13 (MapType0Select Heap@@13 r_1@@23 next) f_7)) (CombineFrames (FrameFragment (MapType0Select Heap@@13 (MapType0Select Heap@@13 r_1@@23 next) next)) (MapType0Select Heap@@13 null (strange r_1@@23)))) EmptyFrame))))))) (and (=> (= (ControlFlow 0 22) 19) anon13_Then_correct) (=> (= (ControlFlow 0 22) 21) anon13_Else_correct)))))))
