...
(check-sat)
; unknown
; [eval] (unfolding acc(valid(this), write) in this.ptr)
(set-option :timeout 0)
(push) ; 2
...
(assert (= result@1@00 ($SortWrappers.$SnapToPtr ($Snap.first s@$))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (this@0@00 $Ref)) (!
  (=>
...
(check-sat)
; unknown
; [eval] 0 <= j && j < (unfolding acc(valid(this), write) in this.len)
; [eval] 0 <= j
(set-option :timeout 0)
(push) ; 2
; [then-branch: 0 | !(0 <= j@3@00) | live]
; [else-branch: 0 | 0 <= j@3@00 | live]
(push) ; 3
; [then-branch: 0 | !(0 <= j@3@00)]
(assert (not (<= 0 j@3@00)))
(pop) ; 3
(push) ; 3
; [else-branch: 0 | 0 <= j@3@00]
(assert (<= 0 j@3@00))
; [eval] j < (unfolding acc(valid(this), write) in this.len)
; [eval] (unfolding acc(valid(this), write) in this.len)
(push) ; 4
(assert (valid%trigger s@$ this@2@00))
(assert (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$))))
(assert (not (= this@2@00 $Ref.null)))
(pop) ; 4
; Joined path conditions
(assert (and
  (valid%trigger s@$ this@2@00)
  (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$)))
...
(assert (=>
  ...
  (and
    ...
    (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$)))
    (not (= this@2@00 $Ref.null)))))
(assert (or (<= 0 j@3@00) (not (<= 0 j@3@00))))
(assert (=
  result@4@00
  (and (<= 0 j@3@00) (< j@3@00 ($SortWrappers.$SnapToInt ($Snap.second s@$))))))
(pop) ; 1
(assert (forall ((s@$ $Snap) (this@2@00 $Ref) (j@3@00 Int)) (!
  (=>
