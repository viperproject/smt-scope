...
(assert  (and (= (type a_3@@8) ArrayDomainTypeType) (= (type Heap@@10) (MapType0Type RefType))))
(set-info :boogie-vc-id |array#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((i_2 Int) (i_2_1 Int) ) (!  (=> (and (and (and (and (not (= i_2 i_2_1)) (and (<= 0 i_2) (< i_2 (len a_3@@8)))) (and (<= 0 i_2_1) (< i_2_1 (len a_3@@8)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@8 i_2) (loc a_3@@8 i_2_1))))
 :qid |stdinbpl.307:15|
 :skolemid |31|
)))))
