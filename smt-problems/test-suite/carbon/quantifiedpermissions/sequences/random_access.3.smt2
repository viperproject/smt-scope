...
(declare-fun i_1 () Int)
(declare-fun i_5 () Int)
(assert  (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type s@@17) (SeqType RefType))) (= (type QPMask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test04)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 37) (let ((anon38_Else_correct  (and (=> (= (ControlFlow 0 29) (- 0 31)) (>= (exp Heap@@13 a_2@@3 j@@5 b_2@@3) 0)) (=> (>= (exp Heap@@13 a_2@@3 j@@5 b_2@@3) 0) (and (=> (= (ControlFlow 0 29) (- 0 30)) (< (exp Heap@@13 a_2@@3 j@@5 b_2@@3) (|Seq#Length| s@@17))) (=> (< (exp Heap@@13 a_2@@3 j@@5 b_2@@3) (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 29) (- 0 28)) (not (= (|Seq#Index| s@@17 (exp Heap@@13 a_2@@3 j@@5 b_2@@3)) null)))))))))
(let ((anon38_Then_correct true))
(let ((anon35_Else_correct  (and (=> (= (ControlFlow 0 32) (- 0 33)) (forall ((i_4 Int) (i_4_1 Int) ) (!  (=> (and (and (and (and (not (= i_4 i_4_1)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| s@@17 (exp Heap@@13 a_2@@3 i_4 b_2@@3)) (|Seq#Index| s@@17 (exp Heap@@13 a_2@@3 i_4_1 b_2@@3)))))
 :qid |stdinbpl.914:15|
 :skolemid |71|
))) (=> (forall ((i_4@@0 Int) (i_4_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_4@@0 i_4_1@@0)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4@@0))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| s@@17 (exp Heap@@13 a_2@@3 i_4@@0 b_2@@3)) (|Seq#Index| s@@17 (exp Heap@@13 a_2@@3 i_4_1@@0 b_2@@3)))))
 :qid |stdinbpl.914:15|
 :skolemid |71|
)) (=> (and (and (and (forall ((i_4@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4@@1)) (< NoPerm FullPerm)) (and (qpRange2 (|Seq#Index| s@@17 (exp Heap@@13 a_2@@3 i_4@@1 b_2@@3))) (= (invRecv2 (|Seq#Index| s@@17 (exp Heap@@13 a_2@@3 i_4@@1 b_2@@3))) i_4@@1)))
 :qid |stdinbpl.920:22|
 :skolemid |72|
 :pattern ( (|Seq#Index| s@@17 (|exp#frame| EmptyFrame a_2@@3 i_4@@1 b_2@@3)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_4@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4@@1)))
 :pattern ( (|Seq#Index| s@@17 (|exp#frame| EmptyFrame a_2@@3 i_4@@1 b_2@@3)))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv2 o_3))) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (|Seq#Index| s@@17 (exp Heap@@13 a_2@@3 (invRecv2 o_3) b_2@@3)) o_3)))
 :qid |stdinbpl.924:22|
 :skolemid |73|
 :pattern ( (invRecv2 o_3))
))) (and (forall ((i_4@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4@@2)) (not (= (|Seq#Index| s@@17 (exp Heap@@13 a_2@@3 i_4@@2 b_2@@3)) null)))
 :qid |stdinbpl.930:22|
 :skolemid |74|
 :pattern ( (|Seq#Index| s@@17 (|exp#frame| EmptyFrame a_2@@3 i_4@@2 b_2@@3)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_4@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4@@2)))
 :pattern ( (|Seq#Index| s@@17 (|exp#frame| EmptyFrame a_2@@3 i_4@@2 b_2@@3)))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| s@@17 (exp Heap@@13 a_2@@3 (invRecv2 o_3@@0) b_2@@3)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.936:22|
 :skolemid |75|
...
)) (state Heap@@13 QPMask@0)) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)))) (and (=> (= (ControlFlow 0 32) 27) anon38_Then_correct) (=> (= (ControlFlow 0 32) 29) anon38_Else_correct)))))))
(let ((anon37_Then_correct true))
(let ((anon22_correct true))
(let ((anon37_Else_correct  (and (=> (= (ControlFlow 0 23) (- 0 25)) (>= (exp Heap@@13 a_2@@3 i_10 b_2@@3) 0)) (=> (>= (exp Heap@@13 a_2@@3 i_10 b_2@@3) 0) (and (=> (= (ControlFlow 0 23) (- 0 24)) (< (exp Heap@@13 a_2@@3 i_10 b_2@@3) (|Seq#Length| s@@17))) (=> (< (exp Heap@@13 a_2@@3 i_10 b_2@@3) (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 23) 20) anon22_correct)))))))
(let ((anon36_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_10)) (and (=> (= (ControlFlow 0 26) 22) anon37_Then_correct) (=> (= (ControlFlow 0 26) 23) anon37_Else_correct)))))
(let ((anon36_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_10))) (= (ControlFlow 0 21) 20)) anon22_correct)))
(let ((anon31_Else_correct  (=> (and (and (forall ((i1_1 T@U) (i2_1 T@U) ) (!  (=> (and (and (= (type i1_1) intType) (= (type i2_1) intType)) (and (|Seq#Contains| (|Seq#Range| 0 n@@13) i1_1) (and (|Seq#Contains| (|Seq#Range| 0 n@@13) i2_1) (not (= (U_2_int i1_1) (U_2_int i2_1)))))) (not (= (|Seq#Index| s@@17 (exp Heap@@13 a_2@@3 (U_2_int i1_1) b_2@@3)) (|Seq#Index| s@@17 (exp Heap@@13 a_2@@3 (U_2_int i2_1) b_2@@3)))))
 :qid |stdinbpl.885:20|
 :skolemid |70|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) i1_1) (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) i2_1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) i1_1) (|Seq#Contains| (|Seq#Range| 0 n@@13) i2_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) i1_1) (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) i2_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) i1_1) (|Seq#Contains| (|Seq#Range| 0 n@@13) i2_1))
)) (state Heap@@13 ZeroMask)) (and (state Heap@@13 ZeroMask) (state Heap@@13 ZeroMask))) (and (and (=> (= (ControlFlow 0 34) 32) anon35_Else_correct) (=> (= (ControlFlow 0 34) 26) anon36_Then_correct)) (=> (= (ControlFlow 0 34) 21) anon36_Else_correct)))))
(let ((anon34_Then_correct true))
(let ((anon33_Then_correct true))
(let ((anon16_correct true))
(let ((anon34_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 15)) (>= (exp Heap@@13 a_2@@3 i2_2 b_2@@3) 0)) (=> (>= (exp Heap@@13 a_2@@3 i2_2 b_2@@3) 0) (and (=> (= (ControlFlow 0 13) (- 0 14)) (< (exp Heap@@13 a_2@@3 i2_2 b_2@@3) (|Seq#Length| s@@17))) (=> (< (exp Heap@@13 a_2@@3 i2_2 b_2@@3) (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 13) 9) anon16_correct)))))))
(let ((anon33_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 18)) (>= (exp Heap@@13 a_2@@3 i1_2 b_2@@3) 0)) (=> (>= (exp Heap@@13 a_2@@3 i1_2 b_2@@3) 0) (and (=> (= (ControlFlow 0 16) (- 0 17)) (< (exp Heap@@13 a_2@@3 i1_2 b_2@@3) (|Seq#Length| s@@17))) (=> (< (exp Heap@@13 a_2@@3 i1_2 b_2@@3) (|Seq#Length| s@@17)) (and (=> (= (ControlFlow 0 16) 12) anon34_Then_correct) (=> (= (ControlFlow 0 16) 13) anon34_Else_correct))))))))
(let ((anon32_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i1_2)) (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i2_2)) (not (= i1_2 i2_2)))) (and (=> (= (ControlFlow 0 19) 11) anon33_Then_correct) (=> (= (ControlFlow 0 19) 16) anon33_Else_correct)))))
(let ((anon32_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i1_2)) (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i2_2)) (not (= i1_2 i2_2))))) (= (ControlFlow 0 10) 9)) anon16_correct)))
(let ((anon29_Else_correct  (=> (forall ((i_2_1 T@U) ) (!  (=> (and (= (type i_2_1) intType) (|Seq#Contains| (|Seq#Range| 0 n@@13) i_2_1)) (< (exp Heap@@13 a_2@@3 (U_2_int i_2_1) b_2@@3) (|Seq#Length| s@@17)))
 :qid |stdinbpl.851:20|
 :skolemid |69|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) i_2_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) i_2_1))
)) (=> (and (state Heap@@13 ZeroMask) (state Heap@@13 ZeroMask)) (and (and (=> (= (ControlFlow 0 35) 34) anon31_Else_correct) (=> (= (ControlFlow 0 35) 19) anon32_Then_correct)) (=> (= (ControlFlow 0 35) 10) anon32_Else_correct))))))
(let ((anon8_correct true))
(let ((anon30_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1))) (= (ControlFlow 0 8) 5)) anon8_correct)))
(let ((anon30_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (< (exp Heap@@13 a_2@@3 i_1 b_2@@3) (|Seq#Length| s@@17))) (=> (< (exp Heap@@13 a_2@@3 i_1 b_2@@3) (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 6) 5) anon8_correct))))))
(let ((anon28_Then_correct true))
(let ((anon4_correct true))
(let ((anon27_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_5)) (and (=> (= (ControlFlow 0 4) 3) anon28_Then_correct) (=> (= (ControlFlow 0 4) 1) anon4_correct)))))
(let ((anon27_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_5))) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (<= 0 a_2@@3) (< 0 b_2@@3))) (=> (and (and (and (< 0 n@@13) (state Heap@@13 ZeroMask)) (and (< (+ a_2@@3 (* n@@13 b_2@@3)) (|Seq#Length| s@@17)) (state Heap@@13 ZeroMask))) (and (and (<= 0 j@@5) (< j@@5 n@@13)) (and (state Heap@@13 ZeroMask) (state Heap@@13 ZeroMask)))) (and (and (and (and (=> (= (ControlFlow 0 36) 35) anon29_Else_correct) (=> (= (ControlFlow 0 36) 6) anon30_Then_correct)) (=> (= (ControlFlow 0 36) 8) anon30_Else_correct)) (=> (= (ControlFlow 0 36) 4) anon27_Then_correct)) (=> (= (ControlFlow 0 36) 2) anon27_Else_correct))))))
