...
(assert  (and (= (type s@@17) (SeqType RefType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id test05)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i_5))) (= (ControlFlow 0 7) 2)) anon3_correct)))
(let ((anon6_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i_5)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (>= i_5 0)) (=> (>= i_5 0) (and (=> (= (ControlFlow 0 3) (- 0 5)) (< i_5 (|Seq#Length| s@@17))) (=> (< i_5 (|Seq#Length| s@@17)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm ZeroMask (|Seq#Index| s@@17 i_5) f_7)) (=> (HasDirectPerm ZeroMask (|Seq#Index| s@@17 i_5) f_7) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (> (|Seq#Length| s@@17) 2) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (< 0 (|Seq#Length| s@@17))) (=> (< 0 (|Seq#Length| s@@17)) (=> (not (= (|Seq#Index| s@@17 0) null)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (< 1 (|Seq#Length| s@@17))) (=> (< 1 (|Seq#Length| s@@17)) (=> (and (not (= (|Seq#Index| s@@17 1) null)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 8) 1) anon5_Else_correct) (=> (= (ControlFlow 0 8) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct))))))))))))
