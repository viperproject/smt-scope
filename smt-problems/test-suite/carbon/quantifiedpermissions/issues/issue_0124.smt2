...
(declare-fun k () Int)
(declare-fun i@@6 () Int)
(assert  (and (and (= (type xs) (SeqType intType)) (= (type ys@0) (SeqType intType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon11_correct true))
(let ((anon18_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| ys@0) 1)) (int_2_U i_3))) (= (ControlFlow 0 19) 16)) anon11_correct)))
(let ((anon18_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| ys@0) 1)) (int_2_U i_3)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (< (U_2_int (|Seq#Index| ys@0 i_3)) (U_2_int (|Seq#Index| ys@0 (+ i_3 1))))) (=> (< (U_2_int (|Seq#Index| ys@0 i_3)) (U_2_int (|Seq#Index| ys@0 (+ i_3 1)))) (=> (= (ControlFlow 0 17) 16) anon11_correct))))))
(let ((anon7_correct true))
(let ((anon16_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| ys@0) 1)) (int_2_U i_2))) (= (ControlFlow 0 15) 9)) anon7_correct)))
(let ((anon16_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| ys@0) 1)) (int_2_U i_2)) (and (=> (= (ControlFlow 0 10) (- 0 14)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 10) (- 0 13)) (< i_2 (|Seq#Length| ys@0))) (=> (< i_2 (|Seq#Length| ys@0)) (and (=> (= (ControlFlow 0 10) (- 0 12)) (>= (+ i_2 1) 0)) (=> (>= (+ i_2 1) 0) (and (=> (= (ControlFlow 0 10) (- 0 11)) (< (+ i_2 1) (|Seq#Length| ys@0))) (=> (< (+ i_2 1) (|Seq#Length| ys@0)) (=> (= (ControlFlow 0 10) 9) anon7_correct))))))))))))
(let ((anon17_Else_correct true))
(let ((anon13_Else_correct  (=> (forall ((i_1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| xs) 1)) (int_2_U i_1)) (< (U_2_int (|Seq#Index| xs i_1)) (U_2_int (|Seq#Index| xs (+ i_1 1)))))
 :qid |stdinbpl.613:20|
 :skolemid |58|
 :pattern ( (|Seq#Index| xs i_1))
)) (=> (and (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (= ys@0 (|Seq#Drop| (|Seq#Take| xs (|Seq#Length| xs)) k)) (state Heap@@9 ZeroMask))) (and (and (and (and (=> (= (ControlFlow 0 20) 8) anon17_Else_correct) (=> (= (ControlFlow 0 20) 17) anon18_Then_correct)) (=> (= (ControlFlow 0 20) 19) anon18_Else_correct)) (=> (= (ControlFlow 0 20) 10) anon16_Then_correct)) (=> (= (ControlFlow 0 20) 15) anon16_Else_correct))))))
(let ((anon3_correct true))
(let ((anon14_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| xs) 1)) (int_2_U i@@6))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon14_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| xs) 1)) (int_2_U i@@6)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i@@6 (|Seq#Length| xs))) (=> (< i@@6 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= (+ i@@6 1) 0)) (=> (>= (+ i@@6 1) 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< (+ i@@6 1) (|Seq#Length| xs))) (=> (< (+ i@@6 1) (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (<= 0 k) (< k (|Seq#Length| xs))) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 21) 20) anon13_Else_correct) (=> (= (ControlFlow 0 21) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 21) 7) anon14_Else_correct))))))
