...
(assert  (and (and (and (and (and (and (= (type refs@@6) (MapType2Type RefType boolType)) (= (type p_3) RefType)) (= (type s_3) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Result) (MapType2Type EdgeDomainTypeType boolType))) (= (type Heap@@23) (MapType0Type RefType))) (forall ((arg0@@56 T@U) ) (! (= (type (invRecv1 arg0@@56)) RefType)
