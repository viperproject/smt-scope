...
(assert  (and (and (and (= (type QPMask@0) (MapType1Type RefType realType)) (= (type x@@8) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (forall ((arg0@@26 T@U) ) (! (= (type (invRecv3 arg0@@26)) RefType)
 :qid |funType:invRecv3|
 :pattern ( (invRecv3 arg0@@26))
))))
(set-info :boogie-vc-id test99)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon4_correct true))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 x@@8 next)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 x@@8 next))) (=> (= (ControlFlow 0 3) 2) anon4_correct))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (not (= r_1 null))) (not (= r_1_1 null))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1 r_1_1))))
 :qid |stdinbpl.413:15|
 :skolemid |34|
 :no-pattern (type r_1)
...
))) (=> (forall ((r_1@@0 T@U) (r_1_1@@0 T@U) ) (!  (=> (and (= (type r_1@@0) RefType) (= (type r_1_1@@0) RefType)) (=> (and (and (and (and (not (= r_1@@0 r_1_1@@0)) (not (= r_1@@0 null))) (not (= r_1_1@@0 null))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1@@0 r_1_1@@0))))
 :qid |stdinbpl.413:15|
 :skolemid |34|
...
)) (=> (forall ((r_1@@1 T@U) ) (!  (=> (= (type r_1@@1) RefType) (=> (and (not (= r_1@@1 null)) (< NoPerm FullPerm)) (and (qpRange3 r_1@@1) (= (invRecv3 r_1@@1) r_1@@1))))
 :qid |stdinbpl.419:22|
 :skolemid |35|
 :pattern ( (MapType0Select Heap@@9 r_1@@1 next))
 :pattern ( (MapType1Select QPMask@0 r_1@@1 next))
 :pattern ( (MapType0Select Heap@@9 r_1@@1 next))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (not (= (invRecv3 o_3) null)) (< NoPerm FullPerm)) (qpRange3 o_3)) (= (invRecv3 o_3) o_3)))
 :qid |stdinbpl.423:22|
 :skolemid |36|
 :pattern ( (invRecv3 o_3))
)) (forall ((r_1@@2 T@U) ) (!  (=> (and (= (type r_1@@2) RefType) (not (= r_1@@2 null))) (not (= r_1@@2 null)))
 :qid |stdinbpl.429:22|
 :skolemid |37|
 :pattern ( (MapType0Select Heap@@9 r_1@@2 next))
 :pattern ( (MapType1Select QPMask@0 r_1@@2 next))
 :pattern ( (MapType0Select Heap@@9 r_1@@2 next))
))) (=> (and (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (not (= (invRecv3 o_3@@0) null)) (< NoPerm FullPerm)) (qpRange3 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 next)) FullPerm)))) (=> (not (and (and (not (= (invRecv3 o_3@@0) null)) (< NoPerm FullPerm)) (qpRange3 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (U_2_real (MapType1Select ZeroMask o_3@@0 next))))))
 :qid |stdinbpl.435:22|
 :skolemid |38|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (and (state Heap@@9 QPMask@0) (not (= x@@8 null))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (=> (= (ControlFlow 0 6) 3) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (and (=> (= (ControlFlow 0 8) 1) anon5_Then_correct) (=> (= (ControlFlow 0 8) 6) anon5_Else_correct)))))
