...
(assert  (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type x@@11) RefType)) (= (type y@@2) RefType)) (= (type Heap@@10) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (and (not b_2) (= (ControlFlow 0 6) 1)) anon2_correct)))
(let ((anon3_Then_correct  (=> b_2 (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm Mask@1 x@@11 f_7)) (=> (HasDirectPerm Mask@1 x@@11 f_7) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@1 y@@2 f_7)) (=> (HasDirectPerm Mask@1 y@@2 f_7) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (U_2_int (MapType0Select Heap@@10 x@@11 f_7)) (U_2_int (MapType0Select Heap@@10 y@@2 f_7)))) (=> (= (U_2_int (MapType0Select Heap@@10 x@@11 f_7)) (U_2_int (MapType0Select Heap@@10 y@@2 f_7))) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))))))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x@@11 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@10 y@@2 $allocated)) (< NoPerm k)) (and (state Heap@@10 ZeroMask) (state Heap@@10 ZeroMask))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (>= k NoPerm)) (=> (>= k NoPerm) (=> (=> (> k NoPerm) (not (= x@@11 null))) (=> (and (= Mask@0 (MapType1Store ZeroMask x@@11 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@11 f_7)) k)))) (state Heap@@10 Mask@0)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (>= k NoPerm)) (=> (>= k NoPerm) (=> (and (and (and (=> (> k NoPerm) (not (= y@@2 null))) (= Mask@1 (MapType1Store Mask@0 y@@2 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@2 f_7)) k))))) (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1))) (and (and (state Heap@@10 Mask@1) (= b_2 (= x@@11 y@@2))) (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1)))) (and (=> (= (ControlFlow 0 7) 2) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct)))))))))))))
