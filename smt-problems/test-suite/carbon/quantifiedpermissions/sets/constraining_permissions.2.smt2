...
(assert (forall ((x_2 T@U) ) (!  (=> (= (type x_2) RefType) (< NoPerm (foo x_2)))
 :qid |stdinbpl.422:15|
 :skolemid |82|
 :pattern ( (foo x_2))
)))
...
(declare-fun z@@0 () T@U)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type ExhaleHeap@2) (MapType0Type RefType)) (= (type QPMask@3) (MapType1Type RefType realType))) (= (type xs) (MapType2Type RefType boolType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type ExhaleHeap@1) (MapType0Type RefType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv10 arg0@@43)) RefType)
 :qid |funType:invRecv10|
 :pattern ( (invRecv10 arg0@@43))
))) (= (type y@@6) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv9 arg0@@44)) RefType)
 :qid |funType:invRecv9|
 :pattern ( (invRecv9 arg0@@44))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv8 arg0@@45)) RefType)
 :qid |funType:invRecv8|
 :pattern ( (invRecv8 arg0@@45))
))) (= (type z@@0) RefType)))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 26) (let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 8)) (forall ((x_7 T@U) ) (!  (=> (= (type x_7) RefType) (=> (and (U_2_bool (MapType2Select xs x_7)) (dummyFunction (MapType0Select ExhaleHeap@2 x_7 f_7))) (>= k0 NoPerm)))
 :qid |stdinbpl.1091:17|
 :skolemid |155|
 :pattern ( (MapType0Select ExhaleHeap@2 x_7 f_7))
 :pattern ( (MapType1Select QPMask@3 x_7 f_7))
 :pattern ( (MapType2Select xs x_7))
))) (=> (forall ((x_7@@0 T@U) ) (!  (=> (= (type x_7@@0) RefType) (=> (and (U_2_bool (MapType2Select xs x_7@@0)) (dummyFunction (MapType0Select ExhaleHeap@2 x_7@@0 f_7))) (>= k0 NoPerm)))
 :qid |stdinbpl.1091:17|
 :skolemid |155|
 :pattern ( (MapType0Select ExhaleHeap@2 x_7@@0 f_7))
 :pattern ( (MapType1Select QPMask@3 x_7@@0 f_7))
 :pattern ( (MapType2Select xs x_7@@0))
)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((x_7@@1 T@U) (x_7_1 T@U) ) (!  (=> (and (= (type x_7@@1) RefType) (= (type x_7_1) RefType)) (=> (and (and (and (and (not (= x_7@@1 x_7_1)) (U_2_bool (MapType2Select xs x_7@@1))) (U_2_bool (MapType2Select xs x_7_1))) (< NoPerm k0)) (< NoPerm k0)) (not (= x_7@@1 x_7_1))))
 :qid |stdinbpl.1098:17|
 :skolemid |156|
 :pattern ( (neverTriggered11 x_7@@1) (neverTriggered11 x_7_1))
))) (=> (forall ((x_7@@2 T@U) (x_7_1@@0 T@U) ) (!  (=> (and (= (type x_7@@2) RefType) (= (type x_7_1@@0) RefType)) (=> (and (and (and (and (not (= x_7@@2 x_7_1@@0)) (U_2_bool (MapType2Select xs x_7@@2))) (U_2_bool (MapType2Select xs x_7_1@@0))) (< NoPerm k0)) (< NoPerm k0)) (not (= x_7@@2 x_7_1@@0))))
 :qid |stdinbpl.1098:17|
 :skolemid |156|
 :pattern ( (neverTriggered11 x_7@@2) (neverTriggered11 x_7_1@@0))
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((x_7@@3 T@U) ) (!  (=> (and (= (type x_7@@3) RefType) (U_2_bool (MapType2Select xs x_7@@3))) (>= (U_2_real (MapType1Select QPMask@2 x_7@@3 f_7)) k0))
 :qid |stdinbpl.1105:17|
 :skolemid |157|
 :pattern ( (MapType0Select ExhaleHeap@2 x_7@@3 f_7))
 :pattern ( (MapType1Select QPMask@3 x_7@@3 f_7))
 :pattern ( (MapType2Select xs x_7@@3))
)))))))))
(let ((anon15_Then_correct true))
(let ((anon14_Else_correct  (=> (> wildcard@2 0.0) (and (=> (= (ControlFlow 0 9) (- 0 13)) (forall ((x_5 T@U) ) (!  (=> (and (= (type x_5) RefType) (U_2_bool (MapType2Select xs x_5))) (> (U_2_real (MapType1Select QPMask@1 x_5 f_7)) NoPerm))
 :qid |stdinbpl.1016:15|
 :skolemid |146|
 :no-pattern (type x_5)
 :no-pattern (U_2_int x_5)
 :no-pattern (U_2_bool x_5)
))) (=> (forall ((x_5@@0 T@U) ) (!  (=> (and (= (type x_5@@0) RefType) (U_2_bool (MapType2Select xs x_5@@0))) (> (U_2_real (MapType1Select QPMask@1 x_5@@0 f_7)) NoPerm))
 :qid |stdinbpl.1016:15|
 :skolemid |146|
 :no-pattern (type x_5@@0)
 :no-pattern (U_2_int x_5@@0)
 :no-pattern (U_2_bool x_5@@0)
)) (=> (forall ((x_5@@1 T@U) ) (!  (=> (and (= (type x_5@@1) RefType) (U_2_bool (MapType2Select xs x_5@@1))) (< wildcard@2 (U_2_real (MapType1Select QPMask@1 x_5@@1 f_7))))
 :qid |stdinbpl.1020:20|
 :skolemid |147|
 :no-pattern (type x_5@@1)
 :no-pattern (U_2_int x_5@@1)
 :no-pattern (U_2_bool x_5@@1)
)) (and (=> (= (ControlFlow 0 9) (- 0 12)) (forall ((x_5@@2 T@U) ) (!  (=> (= (type x_5@@2) RefType) (=> (and (U_2_bool (MapType2Select xs x_5@@2)) (dummyFunction (MapType0Select ExhaleHeap@1 x_5@@2 f_7))) (>= wildcard@2 NoPerm)))
 :qid |stdinbpl.1027:17|
 :skolemid |148|
 :pattern ( (MapType0Select ExhaleHeap@1 x_5@@2 f_7))
 :pattern ( (MapType1Select QPMask@2 x_5@@2 f_7))
 :pattern ( (MapType2Select xs x_5@@2))
))) (=> (forall ((x_5@@3 T@U) ) (!  (=> (= (type x_5@@3) RefType) (=> (and (U_2_bool (MapType2Select xs x_5@@3)) (dummyFunction (MapType0Select ExhaleHeap@1 x_5@@3 f_7))) (>= wildcard@2 NoPerm)))
 :qid |stdinbpl.1027:17|
 :skolemid |148|
 :pattern ( (MapType0Select ExhaleHeap@1 x_5@@3 f_7))
 :pattern ( (MapType1Select QPMask@2 x_5@@3 f_7))
 :pattern ( (MapType2Select xs x_5@@3))
)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (forall ((x_5@@4 T@U) (x_5_1 T@U) ) (!  (=> (and (= (type x_5@@4) RefType) (= (type x_5_1) RefType)) (=> (and (and (and (and (not (= x_5@@4 x_5_1)) (U_2_bool (MapType2Select xs x_5@@4))) (U_2_bool (MapType2Select xs x_5_1))) (< NoPerm wildcard@2)) (< NoPerm wildcard@2)) (not (= x_5@@4 x_5_1))))
 :qid |stdinbpl.1034:17|
 :skolemid |149|
 :pattern ( (neverTriggered10 x_5@@4) (neverTriggered10 x_5_1))
))) (=> (forall ((x_5@@5 T@U) (x_5_1@@0 T@U) ) (!  (=> (and (= (type x_5@@5) RefType) (= (type x_5_1@@0) RefType)) (=> (and (and (and (and (not (= x_5@@5 x_5_1@@0)) (U_2_bool (MapType2Select xs x_5@@5))) (U_2_bool (MapType2Select xs x_5_1@@0))) (< NoPerm wildcard@2)) (< NoPerm wildcard@2)) (not (= x_5@@5 x_5_1@@0))))
 :qid |stdinbpl.1034:17|
 :skolemid |149|
 :pattern ( (neverTriggered10 x_5@@5) (neverTriggered10 x_5_1@@0))
)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((x_5@@6 T@U) ) (!  (=> (and (= (type x_5@@6) RefType) (U_2_bool (MapType2Select xs x_5@@6))) (> (U_2_real (MapType1Select QPMask@1 x_5@@6 f_7)) NoPerm))
 :qid |stdinbpl.1041:17|
 :skolemid |150|
 :pattern ( (MapType0Select ExhaleHeap@1 x_5@@6 f_7))
 :pattern ( (MapType1Select QPMask@2 x_5@@6 f_7))
 :pattern ( (MapType2Select xs x_5@@6))
))) (=> (forall ((x_5@@7 T@U) ) (!  (=> (and (= (type x_5@@7) RefType) (U_2_bool (MapType2Select xs x_5@@7))) (> (U_2_real (MapType1Select QPMask@1 x_5@@7 f_7)) NoPerm))
 :qid |stdinbpl.1041:17|
 :skolemid |150|
 :pattern ( (MapType0Select ExhaleHeap@1 x_5@@7 f_7))
 :pattern ( (MapType1Select QPMask@2 x_5@@7 f_7))
 :pattern ( (MapType2Select xs x_5@@7))
)) (=> (forall ((x_5@@8 T@U) ) (!  (=> (= (type x_5@@8) RefType) (=> (and (U_2_bool (MapType2Select xs x_5@@8)) (< NoPerm wildcard@2)) (and (qpRange10 x_5@@8) (= (invRecv10 x_5@@8) x_5@@8))))
 :qid |stdinbpl.1047:22|
 :skolemid |151|
 :pattern ( (MapType0Select ExhaleHeap@1 x_5@@8 f_7))
 :pattern ( (MapType1Select QPMask@2 x_5@@8 f_7))
 :pattern ( (MapType2Select xs x_5@@8))
)) (=> (and (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType2Select xs (invRecv10 o_3))) (and (< NoPerm wildcard@2) (qpRange10 o_3))) (= (invRecv10 o_3) o_3)))
 :qid |stdinbpl.1051:22|
 :skolemid |152|
 :pattern ( (invRecv10 o_3))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType2Select xs (invRecv10 o_3@@0))) (and (< NoPerm wildcard@2) (qpRange10 o_3@@0))) (and (= (invRecv10 o_3@@0) o_3@@0) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (- (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) wildcard@2)))) (=> (not (and (U_2_bool (MapType2Select xs (invRecv10 o_3@@0))) (and (< NoPerm wildcard@2) (qpRange10 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7))))))
...
(let ((anon13_Else_correct  (=> (> wildcard@1 0.0) (and (=> (= (ControlFlow 0 14) (- 0 18)) (forall ((x_3 T@U) ) (!  (=> (and (= (type x_3) RefType) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_3))) (> (U_2_real (MapType1Select Mask@1 x_3 f_7)) NoPerm))
 :qid |stdinbpl.946:15|
 :skolemid |137|
 :no-pattern (type x_3)
 :no-pattern (U_2_int x_3)
 :no-pattern (U_2_bool x_3)
))) (=> (forall ((x_3@@0 T@U) ) (!  (=> (and (= (type x_3@@0) RefType) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_3@@0))) (> (U_2_real (MapType1Select Mask@1 x_3@@0 f_7)) NoPerm))
 :qid |stdinbpl.946:15|
 :skolemid |137|
 :no-pattern (type x_3@@0)
 :no-pattern (U_2_int x_3@@0)
 :no-pattern (U_2_bool x_3@@0)
)) (=> (forall ((x_3@@1 T@U) ) (!  (=> (and (= (type x_3@@1) RefType) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_3@@1))) (< wildcard@1 (U_2_real (MapType1Select Mask@1 x_3@@1 f_7))))
 :qid |stdinbpl.950:20|
 :skolemid |138|
 :no-pattern (type x_3@@1)
 :no-pattern (U_2_int x_3@@1)
 :no-pattern (U_2_bool x_3@@1)
)) (and (=> (= (ControlFlow 0 14) (- 0 17)) (forall ((x_3@@2 T@U) ) (!  (=> (= (type x_3@@2) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_3@@2)) (dummyFunction (MapType0Select Heap@0 x_3@@2 f_7))) (>= wildcard@1 NoPerm)))
 :qid |stdinbpl.957:17|
 :skolemid |139|
 :pattern ( (MapType0Select Heap@0 x_3@@2 f_7))
 :pattern ( (MapType1Select QPMask@1 x_3@@2 f_7))
 :pattern ( (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_3@@2))
))) (=> (forall ((x_3@@3 T@U) ) (!  (=> (= (type x_3@@3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_3@@3)) (dummyFunction (MapType0Select Heap@0 x_3@@3 f_7))) (>= wildcard@1 NoPerm)))
 :qid |stdinbpl.957:17|
 :skolemid |139|
 :pattern ( (MapType0Select Heap@0 x_3@@3 f_7))
 :pattern ( (MapType1Select QPMask@1 x_3@@3 f_7))
 :pattern ( (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_3@@3))
)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (forall ((x_3@@4 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3@@4) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3@@4 x_3_1)) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_3@@4))) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_3_1))) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= x_3@@4 x_3_1))))
 :qid |stdinbpl.964:17|
 :skolemid |140|
 :pattern ( (neverTriggered9 x_3@@4) (neverTriggered9 x_3_1))
))) (=> (forall ((x_3@@5 T@U) (x_3_1@@0 T@U) ) (!  (=> (and (= (type x_3@@5) RefType) (= (type x_3_1@@0) RefType)) (=> (and (and (and (and (not (= x_3@@5 x_3_1@@0)) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_3@@5))) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_3_1@@0))) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= x_3@@5 x_3_1@@0))))
 :qid |stdinbpl.964:17|
 :skolemid |140|
 :pattern ( (neverTriggered9 x_3@@5) (neverTriggered9 x_3_1@@0))
)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((x_3@@6 T@U) ) (!  (=> (and (= (type x_3@@6) RefType) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_3@@6))) (> (U_2_real (MapType1Select Mask@1 x_3@@6 f_7)) NoPerm))
 :qid |stdinbpl.971:17|
 :skolemid |141|
 :pattern ( (MapType0Select Heap@0 x_3@@6 f_7))
 :pattern ( (MapType1Select QPMask@1 x_3@@6 f_7))
 :pattern ( (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_3@@6))
))) (=> (forall ((x_3@@7 T@U) ) (!  (=> (and (= (type x_3@@7) RefType) (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_3@@7))) (> (U_2_real (MapType1Select Mask@1 x_3@@7 f_7)) NoPerm))
 :qid |stdinbpl.971:17|
 :skolemid |141|
 :pattern ( (MapType0Select Heap@0 x_3@@7 f_7))
 :pattern ( (MapType1Select QPMask@1 x_3@@7 f_7))
 :pattern ( (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_3@@7))
)) (=> (and (forall ((x_3@@8 T@U) ) (!  (=> (= (type x_3@@8) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_3@@8)) (< NoPerm wildcard@1)) (and (qpRange9 x_3@@8) (= (invRecv9 x_3@@8) x_3@@8))))
 :qid |stdinbpl.977:22|
 :skolemid |142|
 :pattern ( (MapType0Select Heap@0 x_3@@8 f_7))
 :pattern ( (MapType1Select QPMask@1 x_3@@8 f_7))
 :pattern ( (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) x_3@@8))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) (invRecv9 o_3@@2))) (and (< NoPerm wildcard@1) (qpRange9 o_3@@2))) (= (invRecv9 o_3@@2) o_3@@2)))
 :qid |stdinbpl.981:22|
 :skolemid |143|
 :pattern ( (invRecv9 o_3@@2))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) (invRecv9 o_3@@3))) (and (< NoPerm wildcard@1) (qpRange9 o_3@@3))) (and (= (invRecv9 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (- (U_2_real (MapType1Select Mask@1 o_3@@3 f_7)) wildcard@1)))) (=> (not (and (U_2_bool (MapType2Select (|Set#Difference| xs (|Set#Singleton| y@@6)) (invRecv9 o_3@@3))) (and (< NoPerm wildcard@1) (qpRange9 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (U_2_real (MapType1Select Mask@1 o_3@@3 f_7))))))
 :qid |stdinbpl.987:22|
 :skolemid |144|
...
(let ((anon12_Else_correct  (=> (and (and (not (U_2_bool (MapType2Select xs y@@6))) (= Mask@1 QPMask@0)) (and (= Heap@0 Heap@@9) (= (ControlFlow 0 22) 19))) anon4_correct)))
(let ((anon12_Then_correct  (=> (U_2_bool (MapType2Select xs y@@6)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (> (U_2_real (MapType1Select QPMask@0 y@@6 f_7)) NoPerm)) (=> (> (U_2_real (MapType1Select QPMask@0 y@@6 f_7)) NoPerm) (=> (and (and (and (> wildcard@0 0.0) (< wildcard@0 (U_2_real (MapType1Select QPMask@0 y@@6 f_7)))) (and (= Mask@0 (MapType1Store QPMask@0 y@@6 f_7 (real_2_U (- (U_2_real (MapType1Select QPMask@0 y@@6 f_7)) wildcard@0)))) (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@0))) (and (and (state ExhaleHeap@0 Mask@0) (= Mask@1 Mask@0)) (and (= Heap@0 ExhaleHeap@0) (= (ControlFlow 0 20) 19)))) anon4_correct))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 23) (- 0 24)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select xs x_1))) (U_2_bool (MapType2Select xs x_1_1))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.871:15|
 :skolemid |131|
 :no-pattern (type x_1)
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (and (= (type x_1@@1) RefType) (U_2_bool (MapType2Select xs x_1@@1))) (and (qpRange8 x_1@@1) (= (invRecv8 x_1@@1) x_1@@1)))
 :qid |stdinbpl.877:22|
 :skolemid |132|
 :pattern ( (MapType0Select Heap@@9 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
 :pattern ( (MapType2Select xs x_1@@1))
)) (=> (and (and (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (U_2_bool (MapType2Select xs (invRecv8 o_3@@5))) (qpRange8 o_3@@5)) (= (invRecv8 o_3@@5) o_3@@5)))
 :qid |stdinbpl.881:22|
 :skolemid |133|
...
))) (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (U_2_bool (MapType2Select xs (invRecv8 o_3@@6))) (qpRange8 o_3@@6)) (and (= (invRecv8 o_3@@6) o_3@@6) (< (U_2_real (MapType1Select ZeroMask o_3@@6 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7))))) (=> (not (and (U_2_bool (MapType2Select xs (invRecv8 o_3@@6))) (qpRange8 o_3@@6))) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@6 f_7))))))
 :qid |stdinbpl.893:22|
 :skolemid |135|
...
)))) (and (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)) (and (U_2_bool (MapType2Select xs z@@0)) (state Heap@@9 QPMask@0)))) (and (=> (= (ControlFlow 0 23) 20) anon12_Then_correct) (=> (= (ControlFlow 0 23) 22) anon12_Else_correct))))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 y@@6 $allocated)) (U_2_bool (MapType0Select Heap@@9 z@@0 $allocated))) (and (=> (= (ControlFlow 0 25) 1) anon11_Then_correct) (=> (= (ControlFlow 0 25) 23) anon11_Else_correct))))))
