...
(declare-fun b_2 () (_ BitVec 1))
(assert (= (type Heap@@9) (MapType0Type RefType)))
(set-info :boogie-vc-id m)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (= a_2@0 #b0)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (= a_2@0 b_2))))
