...
(let ((anon9_Else_correct  (=> (= (MapType0Select Heap@1 xs@@9 next) null) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 3) 1)) anon6_correct))))
(let ((anon9_Then_correct  (=> (not (= (MapType0Select Heap@1 xs@@9 next) null)) (=> (and (and (forall ((o_3 T@U) (f_7 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_7))))
(let ((A@@12 (FieldTypeInv0 (type f_7))))
 (=> (and (and (= (type o_3) RefType) (= (type f_7) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|List#sm| xs@@9)) o_3 f_7)) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|List#sm| (MapType0Select Heap@1 xs@@9 next))) o_3 f_7)))) (U_2_bool (MapType1Select newPMask@0 o_3 f_7)))))
 :qid |stdinbpl.324:33|
 :skolemid |33|
 :pattern ( (MapType1Select newPMask@0 o_3 f_7))
)) (= Heap@2 (MapType0Store Heap@1 null (|List#sm| xs@@9) newPMask@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 2) 1))) anon6_correct))))
(let ((anon4_correct  (=> (state Heap@@14 UnfoldingMask@4) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm UnfoldingMask@4 xs@@9 val)) (=> (HasDirectPerm UnfoldingMask@4 xs@@9 val) (=> (and (= Heap@0 (MapType0Store Heap@@14 null (|List#sm| xs@@9) (MapType1Store (MapType0Select Heap@@14 null (|List#sm| xs@@9)) xs@@9 val (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|List#sm| xs@@9) (MapType1Store (MapType0Select Heap@0 null (|List#sm| xs@@9)) xs@@9 next (bool_2_U true))))) (and (=> (= (ControlFlow 0 4) 2) anon9_Then_correct) (=> (= (ControlFlow 0 4) 3) anon9_Else_correct))))))))
(let ((anon8_Else_correct  (=> (= (MapType0Select Heap@@14 xs@@9 next) null) (=> (and (= UnfoldingMask@4 UnfoldingMask@2) (= (ControlFlow 0 7) 4)) anon4_correct))))
(let ((anon8_Then_correct  (=> (and (not (= (MapType0Select Heap@@14 xs@@9 next) null)) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 null (List (MapType0Select Heap@@14 xs@@9 next)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 null (List (MapType0Select Heap@@14 xs@@9 next)))) FullPerm))))) (=> (and (and (InsidePredicate (List xs@@9) (MapType0Select Heap@@14 null (List xs@@9)) (List (MapType0Select Heap@@14 xs@@9 next)) (MapType0Select Heap@@14 null (List (MapType0Select Heap@@14 xs@@9 next)))) (state Heap@@14 UnfoldingMask@3)) (and (= UnfoldingMask@4 UnfoldingMask@3) (= (ControlFlow 0 6) 4))) anon4_correct))))
(let ((anon2_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (List xs@@9) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (List xs@@9))) FullPerm)))) (=> (and (not (= xs@@9 null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 xs@@9 val (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 xs@@9 val)) FullPerm))))) (=> (and (and (state Heap@@14 UnfoldingMask@1) (not (= xs@@9 null))) (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 xs@@9 next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 xs@@9 next)) FullPerm)))) (state Heap@@14 UnfoldingMask@2))) (and (=> (= (ControlFlow 0 8) 6) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct)))))))
(let ((anon7_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (List xs@@9))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (List xs@@9)))) (=> (= (ControlFlow 0 9) 8) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@14 ZeroMask) (U_2_bool (MapType0Select Heap@@14 xs@@9 $allocated))) (and (= AssumeFunctionsAbove 0) (= Mask@0 (MapType1Store ZeroMask null (List xs@@9) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (List xs@@9))) FullPerm)))))) (and (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0)) (and (|List#trigger| Heap@@14 (List xs@@9)) (= (MapType0Select Heap@@14 null (List xs@@9)) (CombineFrames (FrameFragment (MapType0Select Heap@@14 xs@@9 val)) (CombineFrames (FrameFragment (MapType0Select Heap@@14 xs@@9 next)) (FrameFragment (ite (not (= (MapType0Select Heap@@14 xs@@9 next) null)) (MapType0Select Heap@@14 null (List (MapType0Select Heap@@14 xs@@9 next))) EmptyFrame)))))))) (and (=> (= (ControlFlow 0 12) 9) anon7_Then_correct) (=> (= (ControlFlow 0 12) 11) anon7_Else_correct)))))
