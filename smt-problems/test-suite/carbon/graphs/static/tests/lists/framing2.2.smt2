...
(assert  (and (and (and (and (and (= (type refs@@4) (MapType2Type RefType boolType)) (= (type p_3) RefType)) (= (type s_2) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@27) (MapType0Type RefType))) (forall ((arg0@@58 T@U) ) (! (= (type (invRecv1 arg0@@58)) RefType)
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (forall ((n_3 T@U) (n_3_1 T@U) ) (!  (=> (and (= (type n_3) RefType) (= (type n_3_1) RefType)) (=> (and (and (and (and (not (= n_3 n_3_1)) (U_2_bool (MapType2Select refs@@4 n_3))) (U_2_bool (MapType2Select refs@@4 n_3_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_3 n_3_1))))
 ...
 :qid |stdinbpl.834:22|
 :skolemid |114|
 :pattern ( (MapType0Select Heap@@27 n_3@@4 next))
...
))) (and (state Heap@@27 QPMask@0) (state Heap@@27 QPMask@0))) (and (and (=> (= (ControlFlow 0 9) 2) anon9_Else_correct) (=> (= (ControlFlow 0 9) 8) anon10_Then_correct)) (=> (= (ControlFlow 0 9) 4) anon10_Else_correct)))))))))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@27 ZeroMask) (= AssumeFunctionsAbove 3)) (and (=> (= (ControlFlow 0 12) 1) anon8_Then_correct) (=> (= (ControlFlow 0 12) 9) anon8_Else_correct)))))
