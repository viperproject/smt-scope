...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (and (state Heap@@15 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@15 list@@10 $allocated)) (> wildcard@0 NoPerm))) (and (and (= Mask@0 (MapType1Store ZeroMask null (valid list@@10) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid list@@10))) wildcard@0)))) (state Heap@@15 Mask@0)) (and (state Heap@@15 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (not (= list@@10 null)))))
