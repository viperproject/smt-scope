...
(assert (= (type Heap@@16) (MapType0Type RefType)))
(set-info :boogie-vc-id |fib#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon8_correct  (=> (= Result@0 (ite (<= n@@5 1) n@@5 (+ (fib Heap@@16 (- n@@5 1)) (fib Heap@@16 (- n@@5 2))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (= (= Result@0 0) (= n@@5 0))) (=> (= (= Result@0 0) (= n@@5 0)) (=> (= (ControlFlow 0 6) (- 0 5)) (>= Result@0 0)))))))
(let ((anon11_Else_correct  (=> (and (|fib#trigger| EmptyFrame (- n@@5 2)) (= (ControlFlow 0 9) 6)) anon8_correct)))
(let ((anon9_Then_correct  (=> (and (<= n@@5 1) (= (ControlFlow 0 8) 6)) anon8_correct)))
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (>= (- n@@5 2) 0))))
(let ((anon10_Else_correct  (=> (|fib#trigger| EmptyFrame (- n@@5 1)) (and (=> (= (ControlFlow 0 10) 4) anon11_Then_correct) (=> (= (ControlFlow 0 10) 9) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (>= (- n@@5 1) 0))))
(let ((anon9_Else_correct  (=> (< 1 n@@5) (and (=> (= (ControlFlow 0 11) 2) anon10_Then_correct) (=> (= (ControlFlow 0 11) 10) anon10_Else_correct)))))
(let ((anon0_correct  (=> (and (and (state Heap@@16 ZeroMask) (= AssumeFunctionsAbove 0)) (and (>= n@@5 0) (state Heap@@16 ZeroMask))) (and (=> (= (ControlFlow 0 12) 8) anon9_Then_correct) (=> (= (ControlFlow 0 12) 11) anon9_Else_correct)))))
