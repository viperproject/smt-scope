...
(declare-fun m@0 () T@U)
(assert  (and (= (type Heap@@9) (MapType1Type RefType)) (= (type m@0) (MapType intType boolType))))
(set-info :boogie-vc-id test3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (= m@0 (|Map#Build| (|Map#Build| (|Map#Empty| intType boolType) (int_2_U 6) (bool_2_U false)) (int_2_U 2) (bool_2_U false)))) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (or (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U 4))) (U_2_bool (MapType0Select (|Map#Values| m@0) (bool_2_U true)))))))
