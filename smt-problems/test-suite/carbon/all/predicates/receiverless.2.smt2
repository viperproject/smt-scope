...
(assert  (and (= (Ctor PredicateType_validType) 11) (forall ((arg0@@25 Bool) ) (! (= (type (valid arg0@@25)) (FieldType PredicateType_validType FrameTypeType))
 :qid |funType:valid|
 :pattern ( (valid arg0@@25))
))))
(assert (forall ((b_2 Bool) ) (! (IsPredicateField (valid b_2))
 :qid |stdinbpl.186:15|
 :skolemid |23|
 :pattern ( (valid b_2))
)))
(assert (forall ((Heap@@2 T@U) (b_2@@0 Bool) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (|valid#everUsed| (valid b_2@@0)))
 :qid |stdinbpl.205:15|
 :skolemid |27|
 :pattern ( (|valid#trigger| Heap@@2 (valid b_2@@0)))
)))
(assert (forall ((b_2@@1 Bool) (b2 Bool) ) (!  (=> (= (valid b_2@@1) (valid b2)) (= b_2@@1 b2))
 :qid |stdinbpl.196:15|
 :skolemid |25|
 :pattern ( (valid b_2@@1) (valid b2))
)))
(assert (forall ((arg0@@26 Bool) ) (! (= (type (|valid#sm| arg0@@26)) (FieldType PredicateType_validType (MapType1Type RefType boolType)))
 :qid |funType:valid#sm|
 :pattern ( (|valid#sm| arg0@@26))
)))
(assert (forall ((b_2@@2 Bool) (b2@@0 Bool) ) (!  (=> (= (|valid#sm| b_2@@2) (|valid#sm| b2@@0)) (= b_2@@2 b2@@0))
 :qid |stdinbpl.200:15|
 :skolemid |26|
 :pattern ( (|valid#sm| b_2@@2) (|valid#sm| b2@@0))
)))
...
(assert (forall ((b_2@@3 Bool) ) (! (= (getPredWandId (valid b_2@@3)) 0)
 :qid |stdinbpl.190:15|
 :skolemid |24|
 :pattern ( (valid b_2@@3))
)))
...
(assert (forall ((b_2@@4 Bool) ) (! (= (PredicateMaskField (valid b_2@@4)) (|valid#sm| b_2@@4))
 :qid |stdinbpl.182:15|
 :skolemid |22|
 :pattern ( (PredicateMaskField (valid b_2@@4)))
)))
...
(assert  (and (and (and (and (and (and (and (= (type Heap@1) (MapType0Type RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type this) RefType)) (forall ((arg0@@28 T@U) ) (! (= (type (FrameFragment arg0@@28)) FrameTypeType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon4_correct  (=> (state Heap@1 Mask@1) (=> (and (state Heap@1 Mask@1) (= (ControlFlow 0 2) (- 0 1))) false))))
(let ((anon6_Else_correct  (=> (HasDirectPerm Mask@1 null (valid true)) (=> (and (= Heap@1 Heap@@10) (= (ControlFlow 0 4) 2)) anon4_correct))))
(let ((anon6_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (valid true))) (= Heap@0 (MapType0Store Heap@@10 null (valid true) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 3) 2))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (valid true) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid true))) FullPerm)))) (and (=> (= (ControlFlow 0 5) 3) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid true))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid true)))) (=> (= (ControlFlow 0 6) 5) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 this $allocated)) (= Mask@0 (MapType1Store ZeroMask null (valid true) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid true))) FullPerm))))) (=> (and (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (|valid#trigger| Heap@@10 (valid true)) (= (MapType0Select Heap@@10 null (valid true)) (FrameFragment EmptyFrame)))) (and (=> (= (ControlFlow 0 9) 6) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct)))))))
