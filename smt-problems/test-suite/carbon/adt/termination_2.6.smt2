...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_correct  (=> (and (= Result@0 (ite (= (List_tag l@@19) 1) 0 (+ 1 (len Heap@@29 (get_List_tail l@@19))))) (= (ControlFlow 0 3) (- 0 2))) (>= Result@0 0))))
(let ((anon7_Else_correct  (=> (and (|len#trigger| EmptyFrame (get_List_tail l@@19)) (= (ControlFlow 0 5) 3)) anon5_correct)))
(let ((anon6_Then_correct  (=> (and (= (List_tag l@@19) 1) (= (ControlFlow 0 4) 3)) anon5_correct)))
(let ((anon7_Then_correct true))
(let ((anon6_Else_correct  (=> (not (= (List_tag l@@19) 1)) (and (=> (= (ControlFlow 0 6) 1) anon7_Then_correct) (=> (= (ControlFlow 0 6) 5) anon7_Else_correct)))))
(let ((anon0_correct  (=> (and (state Heap@@29 ZeroMask) (= AssumeFunctionsAbove 2)) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))
