...
(set-info :boogie-vc-id |i0#definedness|)
...
(let ((anon0_correct  (=> (state Heap@@121 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@121 this@@111 $allocated)) (= AssumeFunctionsAbove 15)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (not (= this@@111 null))) (=> (not (= this@@111 null)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm ZeroMask this@@111 x@@8)) (=> (HasDirectPerm ZeroMask this@@111 x@@8) (=> (= (ControlFlow 0 5) (- 0 4)) (= (U_2_int (MapType0Select Heap@@121 this@@111 x@@8)) 0))))))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (state Heap@@121 ZeroMask) (and (=> (= (ControlFlow 0 8) 3) anon6_Then_correct) (=> (= (ControlFlow 0 8) 5) anon6_Else_correct)))))
...
(let ((anon0_correct  (=> (state Heap@@121 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@121 this@@111 $allocated)) (= AssumeFunctionsAbove 9)) (and (=> (= (ControlFlow 0 9) 2) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct))))))
