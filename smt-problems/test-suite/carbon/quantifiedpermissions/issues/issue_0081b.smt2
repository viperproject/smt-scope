...
)) (=> (forall ((x_3@@1 T@U) ) (!  (=> (and (= (type x_3@@1) RefType) (U_2_bool (MapType2Select ys x_3@@1))) (and (qpRange2 x_3@@1) (= (invRecv2 x_3@@1) x_3@@1)))
 :qid |stdinbpl.488:22|
 :skolemid |89|
 :pattern ( (MapType0Select Heap@@9 x_3@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 x_3@@1 f_7))
 :pattern ( (MapType2Select ys x_3@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType2Select ys (invRecv2 o_3))) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.492:22|
 :skolemid |90|
...
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType2Select ys (invRecv2 o_3@@0))) (qpRange2 o_3@@0)) (and (= (invRecv2 o_3@@0) o_3@@0) (< (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7))))) (=> (not (and (U_2_bool (MapType2Select ys (invRecv2 o_3@@0))) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7))))))
 :qid |stdinbpl.504:22|
 :skolemid |92|
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (and (= (type x_1@@1) RefType) (U_2_bool (MapType2Select xs x_1@@1))) (and (qpRange1 x_1@@1) (= (invRecv1 x_1@@1) x_1@@1)))
 :qid |stdinbpl.448:22|
 :skolemid |83|
 :pattern ( (MapType0Select Heap@@9 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
 :pattern ( (MapType2Select xs x_1@@1))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType2Select xs (invRecv1 o_3@@2))) (qpRange1 o_3@@2)) (= (invRecv1 o_3@@2) o_3@@2)))
 :qid |stdinbpl.452:22|
 :skolemid |84|
