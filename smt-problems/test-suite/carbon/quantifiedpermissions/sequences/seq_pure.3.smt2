...
(let ((anon43_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 1)) (int_2_U j_22))) (= (ControlFlow 0 53) 45)) anon20_correct)))
(let ((anon43_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 1)) (int_2_U j_22)) (and (=> (= (ControlFlow 0 46) (- 0 52)) (>= j_22 0)) (=> (>= j_22 0) (and (=> (= (ControlFlow 0 46) (- 0 51)) (< j_22 (|Seq#Length| S))) (=> (< j_22 (|Seq#Length| S)) (and (=> (= (ControlFlow 0 46) (- 0 50)) (HasDirectPerm QPMask@2 (|Seq#Index| S j_22) f_7)) (=> (HasDirectPerm QPMask@2 (|Seq#Index| S j_22) f_7) (and (=> (= (ControlFlow 0 46) (- 0 49)) (>= (+ j_22 1) 0)) (=> (>= (+ j_22 1) 0) (and (=> (= (ControlFlow 0 46) (- 0 48)) (< (+ j_22 1) (|Seq#Length| S))) (=> (< (+ j_22 1) (|Seq#Length| S)) (and (=> (= (ControlFlow 0 46) (- 0 47)) (HasDirectPerm QPMask@2 (|Seq#Index| S (+ j_22 1)) f_7)) (=> (HasDirectPerm QPMask@2 (|Seq#Index| S (+ j_22 1)) f_7) (=> (= (ControlFlow 0 46) 45) anon20_correct))))))))))))))))
(let ((anon42_Else_correct true))
(let ((anon40_Else_correct  (and (=> (= (ControlFlow 0 54) (- 0 55)) (forall ((j_5 Int) (j_5_1 Int) ) (!  (=> (and (and (and (and (not (= j_5 j_5_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U j_5))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U j_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| S j_5) (|Seq#Index| S j_5_1))))
 ...
 :qid |stdinbpl.1580:15|
 :skolemid |133|
)) (=> (forall ((j_5@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U j_5@@1)) (< NoPerm FullPerm)) (and (qpRange11 (|Seq#Index| S j_5@@1)) (= (invRecv11 (|Seq#Index| S j_5@@1)) j_5@@1)))
 ...
 :pattern ( (|Seq#Index| S j_5@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U (invRecv11 o_3))) (< NoPerm FullPerm)) (qpRange11 o_3)) (= (|Seq#Index| S (invRecv11 o_3)) o_3)))
 ...
 :pattern ( (|Seq#Index| S j_5@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U (invRecv11 o_3@@0))) (< NoPerm FullPerm)) (qpRange11 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| S (invRecv11 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U (invRecv11 o_3@@0))) (< NoPerm FullPerm)) (qpRange11 o_3@@0))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
(let ((anon41_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U j_21))) (= (ControlFlow 0 43) 39)) anon16_correct)))
(let ((anon41_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U j_21)) (and (=> (= (ControlFlow 0 40) (- 0 42)) (>= j_21 0)) (=> (>= j_21 0) (and (=> (= (ControlFlow 0 40) (- 0 41)) (< j_21 (|Seq#Length| S))) (=> (< j_21 (|Seq#Length| S)) (=> (= (ControlFlow 0 40) 39) anon16_correct))))))))
...
(let ((anon48_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 1)) (int_2_U j_9))) (= (ControlFlow 0 31) 28)) anon31_correct)))
(let ((anon48_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 1)) (int_2_U j_9)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (<= (U_2_int (MapType0Select Heap@0 (|Seq#Index| S j_9) f_7)) (U_2_int (MapType0Select Heap@0 (|Seq#Index| S (+ j_9 1)) f_7)))) (=> (<= (U_2_int (MapType0Select Heap@0 (|Seq#Index| S j_9) f_7)) (U_2_int (MapType0Select Heap@0 (|Seq#Index| S (+ j_9 1)) f_7))) (=> (= (ControlFlow 0 29) 28) anon31_correct))))))
(let ((anon47_Else_correct true))
(let ((anon45_Else_correct  (=> (and (forall ((j_13_1 T@U) ) (!  (=> (and (= (type j_13_1) intType) (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 1)) j_13_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) j_13_1))
 :qid |stdinbpl.1670:20|
 :skolemid |140|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| S)) j_13_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) j_13_1))
)) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 32) (- 0 34)) (forall ((j_8 Int) (j_8_1 Int) ) (!  (=> (and (and (and (and (not (= j_8 j_8_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U j_8))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U j_8_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| S j_8) (|Seq#Index| S j_8_1))))
...
)) (and (=> (= (ControlFlow 0 32) (- 0 33)) (forall ((j_8@@1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U j_8@@1)) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| S j_8@@1) f_7)) FullPerm))
 ...
 :pattern ( (|Seq#Index| S j_8@@2))
)) (=> (and (and (forall ((j_8@@3 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U j_8@@3)) (< NoPerm FullPerm)) (and (qpRange12 (|Seq#Index| S j_8@@3)) (= (invRecv12 (|Seq#Index| S j_8@@3)) j_8@@3)))
 ...
 :pattern ( (|Seq#Index| S j_8@@3))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U (invRecv12 o_3@@2))) (and (< NoPerm FullPerm) (qpRange12 o_3@@2))) (= (|Seq#Index| S (invRecv12 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.1703:22|
 :skolemid |144|
 :pattern ( (invRecv12 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U (invRecv12 o_3@@3))) (and (< NoPerm FullPerm) (qpRange12 o_3@@3))) (and (= (|Seq#Index| S (invRecv12 o_3@@3)) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (- (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) FullPerm)))) (=> (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U (invRecv12 o_3@@3))) (and (< NoPerm FullPerm) (qpRange12 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7))))))
...
(let ((anon46_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 1)) (int_2_U j_12_1))) (= (ControlFlow 0 26) 23)) anon27_correct)))
(let ((anon46_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 1)) (int_2_U j_12_1)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U j_12_1))) (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U j_12_1)) (=> (= (ControlFlow 0 24) 23) anon27_correct))))))
(let ((anon44_Then_correct true))
(let ((anon39_Else_correct  (and (=> (= (ControlFlow 0 35) (- 0 38)) (>= a_2 0)) (=> (>= a_2 0) (and (=> (= (ControlFlow 0 35) (- 0 37)) (< a_2 (|Seq#Length| S))) (=> (< a_2 (|Seq#Length| S)) (and (=> (= (ControlFlow 0 35) (- 0 36)) (= FullPerm (U_2_real (MapType1Select QPMask@0 (|Seq#Index| S a_2) f_7)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 (|Seq#Index| S a_2) f_7))) (=> (and (= Heap@0 (MapType0Store Heap@@9 (|Seq#Index| S a_2) f_7 (int_2_U 5))) (state Heap@0 QPMask@0)) (and (and (and (=> (= (ControlFlow 0 35) 22) anon44_Then_correct) (=> (= (ControlFlow 0 35) 32) anon45_Else_correct)) (=> (= (ControlFlow 0 35) 24) anon46_Then_correct)) (=> (= (ControlFlow 0 35) 26) anon46_Else_correct)))))))))))
(let ((anon37_Else_correct  (=> (and (forall ((j_3 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 1)) (int_2_U j_3)) (<= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| S j_3) f_7)) (U_2_int (MapType0Select Heap@@9 (|Seq#Index| S (+ j_3 1)) f_7))))
 :qid |stdinbpl.1551:20|
 :skolemid |132|
 :pattern ( (|Seq#Index| S j_3))
)) (state Heap@@9 QPMask@0)) (and (=> (= (ControlFlow 0 57) 56) anon39_Then_correct) (=> (= (ControlFlow 0 57) 35) anon39_Else_correct)))))
(let ((anon11_correct true))
(let ((anon38_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 1)) (int_2_U j_20))) (= (ControlFlow 0 21) 13)) anon11_correct)))
(let ((anon38_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 1)) (int_2_U j_20)) (and (=> (= (ControlFlow 0 14) (- 0 20)) (>= j_20 0)) (=> (>= j_20 0) (and (=> (= (ControlFlow 0 14) (- 0 19)) (< j_20 (|Seq#Length| S))) (=> (< j_20 (|Seq#Length| S)) (and (=> (= (ControlFlow 0 14) (- 0 18)) (HasDirectPerm QPMask@0 (|Seq#Index| S j_20) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| S j_20) f_7) (and (=> (= (ControlFlow 0 14) (- 0 17)) (>= (+ j_20 1) 0)) (=> (>= (+ j_20 1) 0) (and (=> (= (ControlFlow 0 14) (- 0 16)) (< (+ j_20 1) (|Seq#Length| S))) (=> (< (+ j_20 1) (|Seq#Length| S)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm QPMask@0 (|Seq#Index| S (+ j_20 1)) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| S (+ j_20 1)) f_7) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))))))))))
(let ((anon35_Else_correct  (and (=> (= (ControlFlow 0 58) (- 0 59)) (forall ((j_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (and (not (= j_1 j_1_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U j_1))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U j_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| S j_1) (|Seq#Index| S j_1_1))))
 ...
 :qid |stdinbpl.1499:15|
 :skolemid |126|
)) (=> (forall ((j_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U j_1@@1)) (< NoPerm FullPerm)) (and (qpRange10 (|Seq#Index| S j_1@@1)) (= (invRecv10 (|Seq#Index| S j_1@@1)) j_1@@1)))
 ...
 :pattern ( (|Seq#Index| S j_1@@1))
)) (=> (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U (invRecv10 o_3@@5))) (< NoPerm FullPerm)) (qpRange10 o_3@@5)) (= (|Seq#Index| S (invRecv10 o_3@@5)) o_3@@5)))
 ...
 :pattern ( (|Seq#Index| S j_1@@2))
))) (=> (and (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U (invRecv10 o_3@@6))) (< NoPerm FullPerm)) (qpRange10 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| S (invRecv10 o_3@@6)) o_3@@6)) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@6 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U (invRecv10 o_3@@6))) (< NoPerm FullPerm)) (qpRange10 o_3@@6))) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@6 f_7))))))
...
(let ((A@@14 (FieldTypeInv0 (type f_5@@1))))
 ...
 :qid |stdinbpl.1525:29|
 :skolemid |131|
 :pattern ( (MapType1Select ZeroMask o_3@@7 f_5@@1))
 :pattern ( (MapType1Select QPMask@0 o_3@@7 f_5@@1))
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 58) 57) anon37_Else_correct) (=> (= (ControlFlow 0 58) 14) anon38_Then_correct)) (=> (= (ControlFlow 0 58) 21) anon38_Else_correct)))))))))
(let ((anon7_correct true))
(let ((anon36_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U j_19))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon36_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U j_19)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= j_19 0)) (=> (>= j_19 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< j_19 (|Seq#Length| S))) (=> (< j_19 (|Seq#Length| S)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon33_Else_correct  (=> (and (forall ((j1_1 Int) (j2_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U j1_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U j2_1)) (not (= j1_1 j2_1)))) (not (= (|Seq#Index| S j1_1) (|Seq#Index| S j2_1))))
 :qid |stdinbpl.1481:20|
 :skolemid |125|
 :pattern ( (|Seq#Index| S j1_1) (|Seq#Index| S j2_1))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 60) 58) anon35_Else_correct) (=> (= (ControlFlow 0 60) 9) anon36_Then_correct)) (=> (= (ControlFlow 0 60) 12) anon36_Else_correct)))))
(let ((anon3_correct true))
(let ((anon34_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U j1_4)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U j2_4)) (not (= j1_4 j2_4))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon34_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U j1_4)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U j2_4)) (not (= j1_4 j2_4)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j1_4 0)) (=> (>= j1_4 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j1_4 (|Seq#Length| S))) (=> (< j1_4 (|Seq#Length| S)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j2_4 0)) (=> (>= j2_4 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j2_4 (|Seq#Length| S))) (=> (< j2_4 (|Seq#Length| S)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (<= 0 a_2)) (and (< a_2 (|Seq#Length| S)) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 61) 60) anon33_Else_correct) (=> (= (ControlFlow 0 61) 2) anon34_Then_correct)) (=> (= (ControlFlow 0 61) 7) anon34_Else_correct)))))
