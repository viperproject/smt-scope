...
(assert  (and (and (and (= (type t_1) (SeqType intType)) (= (type ss@0) (SeqType intType))) (= (type s@@21) (SeqType intType))) (= (type Heap@@13) (MapType0Type RefType))))
(set-info :boogie-vc-id test_append_right)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_correct true))
(let ((anon9_Else_correct  (=> (and (not (|Seq#Contains| t_1 (int_2_U i_1))) (= (ControlFlow 0 6) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (|Seq#Contains| t_1 (int_2_U i_1)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (|Seq#Contains| (|Seq#Drop| ss@0 (|Seq#Length| s@@21)) (int_2_U i_1))) (=> (|Seq#Contains| (|Seq#Drop| ss@0 (|Seq#Length| s@@21)) (int_2_U i_1)) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
(let ((anon8_Else_correct true))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (= ss@0 (|Seq#Append| s@@21 t_1)) (state Heap@@13 ZeroMask))) (and (and (and (=> (= (ControlFlow 0 7) 1) anon7_Then_correct) (=> (= (ControlFlow 0 7) 2) anon8_Else_correct)) (=> (= (ControlFlow 0 7) 4) anon9_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))
