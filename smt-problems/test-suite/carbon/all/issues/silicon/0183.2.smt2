...
(assert  (and (and (and (and (and (= (type UnfoldingMask@0) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type self@@5) RefType)) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (forall ((arg0@@28 T@U) ) (! (= (type (FrameFragment arg0@@28)) FrameTypeType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon2_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (valid__Cell self@@5 rd@@5) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid__Cell self@@5 rd@@5))) rd@@5)))) (= perm@0 (* rd@@5 rd@@5))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= self@@5 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 self@@5 v_2 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 self@@5 v_2)) perm@0)))) (state Heap@@10 UnfoldingMask@1)) (and (state Heap@@10 UnfoldingMask@1) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm UnfoldingMask@1 self@@5 v_2))))))))
(let ((anon3_Else_correct  (=> (and (= rd@@5 NoPerm) (= (ControlFlow 0 6) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= rd@@5 NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= rd@@5 (U_2_real (MapType1Select Mask@0 null (valid__Cell self@@5 rd@@5))))) (=> (<= rd@@5 (U_2_real (MapType1Select Mask@0 null (valid__Cell self@@5 rd@@5)))) (=> (= (ControlFlow 0 4) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@10 self@@5 $allocated)) (< NoPerm rd@@5)) (and (< rd@@5 FullPerm) (state Heap@@10 ZeroMask))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (>= rd@@5 NoPerm)) (=> (>= rd@@5 NoPerm) (=> (= Mask@0 (MapType1Store ZeroMask null (valid__Cell self@@5 rd@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid__Cell self@@5 rd@@5))) rd@@5)))) (=> (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (> rd@@5 NoPerm)) (=> (> rd@@5 NoPerm) (=> (and (|valid__Cell#trigger| Heap@@10 (valid__Cell self@@5 rd@@5)) (= (MapType0Select Heap@@10 null (valid__Cell self@@5 rd@@5)) (ConditionalFrame rd@@5 (FrameFragment (MapType0Select Heap@@10 self@@5 v_2))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (>= rd@@5 NoPerm)) (=> (>= rd@@5 NoPerm) (and (=> (= (ControlFlow 0 7) 4) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct)))))))))))))))
