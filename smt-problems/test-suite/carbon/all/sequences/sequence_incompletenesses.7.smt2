...
(declare-fun isStart@@3 () Bool)
(declare-fun lenTiles@@3 () Int)
(declare-fun |valid#trigger| (T@U T@U Int Bool) Bool)
(declare-fun Heap@@13 () T@U)
(assert  (and (= (type s@@21) (SeqType intType)) (= (type Heap@@13) (MapType0Type RefType))))
(set-info :boogie-vc-id |valid#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 33) (let ((anon27_Then_correct true))
(let ((anon17_correct true))
(let ((anon22_Else_correct  (=> (and (= (U_2_int (|Seq#Index| s@@21 0)) 0) (= (ControlFlow 0 25) 1)) anon17_correct)))
(let ((anon22_Then_correct  (=> (not (= (U_2_int (|Seq#Index| s@@21 0)) 0)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (< 0 (|Seq#Length| s@@21))) (=> (< 0 (|Seq#Length| s@@21)) (=> (= (ControlFlow 0 23) 1) anon17_correct))))))
(let ((anon21_Then_correct  (=> isStart@@3 (and (=> (= (ControlFlow 0 26) (- 0 27)) (< 0 (|Seq#Length| s@@21))) (=> (< 0 (|Seq#Length| s@@21)) (and (=> (= (ControlFlow 0 26) 23) anon22_Then_correct) (=> (= (ControlFlow 0 26) 25) anon22_Else_correct)))))))
(let ((anon21_Else_correct  (=> (not isStart@@3) (and (=> (= (ControlFlow 0 21) (- 0 22)) (< 0 (|Seq#Length| s@@21))) (=> (< 0 (|Seq#Length| s@@21)) (=> (= (ControlFlow 0 21) 1) anon17_correct))))))
(let ((anon20_Then_correct  (=> (= lenTiles@@3 (U_2_int (|Seq#Index| s@@21 0))) (and (=> (= (ControlFlow 0 28) 26) anon21_Then_correct) (=> (= (ControlFlow 0 28) 21) anon21_Else_correct)))))
(let ((anon20_Else_correct  (=> (and (not (= lenTiles@@3 (U_2_int (|Seq#Index| s@@21 0)))) (= (ControlFlow 0 20) 1)) anon17_correct)))
(let ((anon19_Then_correct  (=> (= (|Seq#Length| s@@21) 1) (and (=> (= (ControlFlow 0 29) (- 0 30)) (< 0 (|Seq#Length| s@@21))) (=> (< 0 (|Seq#Length| s@@21)) (and (=> (= (ControlFlow 0 29) 28) anon20_Then_correct) (=> (= (ControlFlow 0 29) 20) anon20_Else_correct)))))))
(let ((anon27_Else_correct  (=> (and (|valid#trigger| EmptyFrame (|Seq#Drop| s@@21 2) (- (- lenTiles@@3 (U_2_int (|Seq#Index| s@@21 1))) (U_2_int (|Seq#Index| s@@21 0))) false) (= (ControlFlow 0 6) 1)) anon17_correct)))
(let ((anon26_Then_correct  (=> (> (U_2_int (|Seq#Index| s@@21 1)) 0) (and (=> (= (ControlFlow 0 7) (- 0 9)) (< 1 (|Seq#Length| s@@21))) (=> (< 1 (|Seq#Length| s@@21)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (< 0 (|Seq#Length| s@@21))) (=> (< 0 (|Seq#Length| s@@21)) (and (=> (= (ControlFlow 0 7) 5) anon27_Then_correct) (=> (= (ControlFlow 0 7) 6) anon27_Else_correct)))))))))
(let ((anon26_Else_correct  (=> (and (>= 0 (U_2_int (|Seq#Index| s@@21 1))) (= (ControlFlow 0 4) 1)) anon17_correct)))
(let ((anon25_Then_correct  (=> (ite isStart@@3  (or (= (U_2_int (|Seq#Index| s@@21 0)) 0) (>= (U_2_int (|Seq#Index| s@@21 0)) 3)) (>= (U_2_int (|Seq#Index| s@@21 0)) 3)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (< 1 (|Seq#Length| s@@21))) (=> (< 1 (|Seq#Length| s@@21)) (and (=> (= (ControlFlow 0 10) 7) anon26_Then_correct) (=> (= (ControlFlow 0 10) 4) anon26_Else_correct)))))))
(let ((anon25_Else_correct  (=> (and (not (ite isStart@@3  (or (= (U_2_int (|Seq#Index| s@@21 0)) 0) (>= (U_2_int (|Seq#Index| s@@21 0)) 3)) (>= (U_2_int (|Seq#Index| s@@21 0)) 3))) (= (ControlFlow 0 3) 1)) anon17_correct)))
(let ((anon24_Else_correct  (=> (= (U_2_int (|Seq#Index| s@@21 0)) 0) (and (=> (= (ControlFlow 0 16) 10) anon25_Then_correct) (=> (= (ControlFlow 0 16) 3) anon25_Else_correct)))))
(let ((anon24_Then_correct  (=> (not (= (U_2_int (|Seq#Index| s@@21 0)) 0)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< 0 (|Seq#Length| s@@21))) (=> (< 0 (|Seq#Length| s@@21)) (and (=> (= (ControlFlow 0 14) 10) anon25_Then_correct) (=> (= (ControlFlow 0 14) 3) anon25_Else_correct)))))))
(let ((anon23_Then_correct  (=> isStart@@3 (and (=> (= (ControlFlow 0 17) (- 0 18)) (< 0 (|Seq#Length| s@@21))) (=> (< 0 (|Seq#Length| s@@21)) (and (=> (= (ControlFlow 0 17) 14) anon24_Then_correct) (=> (= (ControlFlow 0 17) 16) anon24_Else_correct)))))))
(let ((anon23_Else_correct  (=> (not isStart@@3) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< 0 (|Seq#Length| s@@21))) (=> (< 0 (|Seq#Length| s@@21)) (and (=> (= (ControlFlow 0 12) 10) anon25_Then_correct) (=> (= (ControlFlow 0 12) 3) anon25_Else_correct)))))))
(let ((anon19_Else_correct  (=> (not (= (|Seq#Length| s@@21) 1)) (and (=> (= (ControlFlow 0 19) 17) anon23_Then_correct) (=> (= (ControlFlow 0 19) 12) anon23_Else_correct)))))
(let ((anon18_Else_correct  (=> (not (= (|Seq#Length| s@@21) 0)) (and (=> (= (ControlFlow 0 31) 29) anon19_Then_correct) (=> (= (ControlFlow 0 31) 19) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (and (= (|Seq#Length| s@@21) 0) (= (ControlFlow 0 2) 1)) anon17_correct)))
(let ((anon0_correct  (=> (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 32) 2) anon18_Then_correct) (=> (= (ControlFlow 0 32) 31) anon18_Else_correct)))))
