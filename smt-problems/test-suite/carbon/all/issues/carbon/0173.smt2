...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove 0)) (=> (and (and (> r_1@@4 0) (state Heap@@14 ZeroMask)) (and (= Result@0 (> r_1@@4 0)) (= (ControlFlow 0 2) (- 0 1)))) (> r_1@@4 0)))))
