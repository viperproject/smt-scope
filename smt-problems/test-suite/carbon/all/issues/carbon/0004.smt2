...
(let ((anon3_Then_correct  (=> (not (= perm@1 NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= perm@1 (U_2_real (MapType1Select Mask@0 x@@8 f_7)))) (=> (<= perm@1 (U_2_real (MapType1Select Mask@0 x@@8 f_7))) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated)) (= perm@0 (ite b_2 (/ (to_real 1) (to_real 5)) NoPerm))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= x@@8 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) perm@0)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (= perm@1 (ite b_2 (/ (to_real 1) (to_real 5)) NoPerm)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))))))))
