...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type p_2) (FieldType NormalFieldType realType))) (= (type f_7) (FieldType NormalFieldType intType))) (= (Ctor RefType) 8)) (= (type r_1) (FieldType NormalFieldType RefType))))
(assert (distinct $allocated p_2 f_7 r_1)
)
...
(assert  (not (IsPredicateField p_2)))
(assert  (not (IsWandField p_2)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@0) (MapType0Type RefType)) (= (type Heap@@10) (MapType0Type RefType))) (= (type x@@14) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (forall ((arg0@@28 T@U) ) (! (= (type (FrameFragment arg0@@28)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@28))
))) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (= (type UnfoldingMask@3) (MapType1Type RefType realType))) (= (type y@@1) RefType)) (= (type z@@0) RefType)) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test01a)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon4_correct  (=> (and (= Heap@0 (MapType0Store Heap@@10 null (|P#sm| x@@14) (MapType1Store (MapType0Select Heap@@10 null (|P#sm| x@@14)) x@@14 p_2 (bool_2_U true)))) (state Heap@0 Mask@1)) (=> (and (and (|P#trigger| Heap@0 (P x@@14)) (= (MapType0Select Heap@0 null (P x@@14)) (FrameFragment (MapType0Select Heap@0 x@@14 p_2)))) (and (= UnfoldingMask@2 (MapType1Store Mask@1 null (P x@@14) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (P x@@14))) FullPerm)))) (not (= x@@14 null)))) (=> (and (and (and (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 x@@14 p_2 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 x@@14 p_2)) FullPerm)))) (state Heap@0 UnfoldingMask@3)) (and (< NoPerm (U_2_real (MapType0Select Heap@0 x@@14 p_2))) (state Heap@0 UnfoldingMask@3))) (and (and (<= (/ (to_real 1) (to_real 2)) (U_2_real (MapType1Select Mask@1 y@@1 f_7))) (<= (__iar__assume_helper_1 (= y@@1 z@@0) (/ (to_real 1) (to_real 2)) (U_2_real (MapType0Select Heap@0 x@@14 p_2))) (U_2_real (MapType1Select Mask@1 z@@0 f_7)))) (and (state Heap@0 Mask@1) (state Heap@0 Mask@1)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= x@@14 y@@1)) (=> (= x@@14 y@@1) (=> (= (ControlFlow 0 2) (- 0 1)) (= y@@1 z@@0)))))))))
(let ((anon6_Else_correct  (=> (and (< (U_2_real (MapType1Select UnfoldingMask@1 y@@1 f_7)) (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 6) 2)) anon4_correct)))
(let ((anon6_Then_correct  (=> (<= (/ (to_real 1) (to_real 2)) (U_2_real (MapType1Select UnfoldingMask@1 y@@1 f_7))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm UnfoldingMask@1 x@@14 p_2)) (=> (HasDirectPerm UnfoldingMask@1 x@@14 p_2) (=> (= (ControlFlow 0 4) 2) anon4_correct))))))
(let ((anon2_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@1 null (P x@@14) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (P x@@14))) FullPerm)))) (not (= x@@14 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x@@14 p_2 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@14 p_2)) FullPerm)))) (state Heap@@10 UnfoldingMask@1)) (and (< NoPerm (U_2_real (MapType0Select Heap@@10 x@@14 p_2))) (state Heap@@10 UnfoldingMask@1))) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))
(let ((anon5_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 7)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (P x@@14))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (P x@@14)))) (=> (= (ControlFlow 0 8) 7) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 x@@14 $allocated)) (U_2_bool (MapType0Select Heap@@10 y@@1 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@10 z@@0 $allocated)) (not (= x@@14 null))) (and (= Mask@0 (MapType1Store ZeroMask x@@14 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@14 f_7)) FullPerm)))) (state Heap@@10 Mask@0))) (=> (and (and (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (= Mask@1 (MapType1Store Mask@0 null (P x@@14) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (P x@@14))) FullPerm)))) (state Heap@@10 Mask@1))) (and (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1)) (and (|P#trigger| Heap@@10 (P x@@14)) (= (MapType0Select Heap@@10 null (P x@@14)) (FrameFragment (MapType0Select Heap@@10 x@@14 p_2)))))) (and (=> (= (ControlFlow 0 11) 8) anon5_Then_correct) (=> (= (ControlFlow 0 11) 10) anon5_Else_correct))))))))
