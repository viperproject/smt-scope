...
(declare-fun num (T@U) Int)
(declare-fun Mask@0 () T@U)
(declare-fun z1 () T@U)
(declare-fun Mask@1 () T@U)
(declare-fun z2 () T@U)
(assert  (and (and (and (and (and (= (type Heap@@9) (MapType1Type RefType)) (= (type x_1) RefType)) (= (type Mask@0) (MapType2Type RefType realType))) (= (type z1) RefType)) (= (type Mask@1) (MapType2Type RefType realType))) (= (type z2) RefType)))
(set-info :boogie-vc-id test03)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon3_Else_correct  (=> (forall ((y_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (not (= y_1 null))) (bar (num y_1)))
 :qid |stdinbpl.634:20|
 :skolemid |84|
 :pattern ( (MapType0Select (MapType1Select Heap@@9 x_1 h) y_1))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 3) (- 0 9)) (HasDirectPerm Mask@0 x_1 h)) (=> (HasDirectPerm Mask@0 x_1 h) (=> (U_2_bool (MapType0Select (MapType1Select Heap@@9 x_1 h) z1)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 3) (- 0 8)) (bar (num z1))) (=> (bar (num z1)) (=> (and (state Heap@@9 Mask@0) (not (= x_1 null))) (=> (and (and (= Mask@1 (MapType2Store Mask@0 x_1 g (real_2_U (+ (U_2_real (MapType2Select Mask@0 x_1 g)) FullPerm)))) (state Heap@@9 Mask@1)) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (HasDirectPerm Mask@1 x_1 g)) (=> (HasDirectPerm Mask@1 x_1 g) (and (=> (= (ControlFlow 0 3) (- 0 6)) (HasDirectPerm Mask@1 x_1 h)) (=> (HasDirectPerm Mask@1 x_1 h) (=> (U_2_bool (MapType0Select (MapType1Select Heap@@9 x_1 h) (MapType1Select Heap@@9 x_1 g))) (=> (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm Mask@1 x_1 g)) (=> (HasDirectPerm Mask@1 x_1 g) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bar (num (MapType1Select Heap@@9 x_1 g)))) (=> (bar (num (MapType1Select Heap@@9 x_1 g))) (=> (and (state Heap@@9 Mask@1) (= (ControlFlow 0 3) (- 0 2))) (bar (num z2)))))))))))))))))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (and (U_2_bool (MapType1Select Heap@@9 x_1 $allocated)) (U_2_bool (MapType1Select Heap@@9 z1 $allocated))) (and (U_2_bool (MapType1Select Heap@@9 z2 $allocated)) (not (= x_1 null)))) (and (and (= Mask@0 (MapType2Store ZeroMask x_1 h (real_2_U (+ (U_2_real (MapType2Select ZeroMask x_1 h)) FullPerm)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm Mask@0 x_1 h)) (=> (HasDirectPerm Mask@0 x_1 h) (=> (not (U_2_bool (MapType0Select (MapType1Select Heap@@9 x_1 h) null))) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 10) 1) anon3_Then_correct) (=> (= (ControlFlow 0 10) 3) anon3_Else_correct))))))))))
