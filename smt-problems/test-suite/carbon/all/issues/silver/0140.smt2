...
(assert  (and (= (Ctor WandType_wandType) 9) (forall ((arg0@@18 Bool) (arg1@@4 Bool) (arg2@@1 Bool) (arg3@@0 Bool) ) (! (= (type (wand arg0@@18 arg1@@4 arg2@@1 arg3@@0)) (FieldType WandType_wandType intType))
 :qid |funType:wand|
 :pattern ( (wand arg0@@18 arg1@@4 arg2@@1 arg3@@0))
))))
(assert (forall ((arg1@@5 Bool) (arg2@@2 Bool) (arg3@@1 Bool) (arg4 Bool) ) (! (= (getPredWandId (wand arg1@@5 arg2@@2 arg3@@1 arg4)) 0)
 :qid |stdinbpl.203:15|
 :skolemid |27|
 :pattern ( (wand arg1@@5 arg2@@2 arg3@@1 arg4))
)))
(assert  (and (and (and (and (and (and (forall ((arg0@@19 T@T) (arg1@@6 T@T) ) (! (= (Ctor (MapType1Type arg0@@19 arg1@@6)) 10)
...
(assert  (and (= (Ctor WandType_wand_1Type) 11) (forall ((arg0@@24 Bool) (arg1@@11 Bool) ) (! (= (type (wand_1 arg0@@24 arg1@@11)) (FieldType WandType_wand_1Type intType))
 :qid |funType:wand_1|
 :pattern ( (wand_1 arg0@@24 arg1@@11))
))))
(assert (forall ((arg1@@12 Bool) (arg2@@5 Bool) ) (! (IsWandField (wand_1 arg1@@12 arg2@@5))
 :qid |stdinbpl.215:15|
 :skolemid |29|
 :pattern ( (wand_1 arg1@@12 arg2@@5))
)))
(assert  (and (= (Ctor FrameTypeType) 12) (forall ((arg0@@25 Bool) (arg1@@13 Bool) ) (! (= (type (|wand_1#ft| arg0@@25 arg1@@13)) (FieldType WandType_wand_1Type FrameTypeType))
 :qid |funType:wand_1#ft|
 :pattern ( (|wand_1#ft| arg0@@25 arg1@@13))
))))
(assert (forall ((arg1@@14 Bool) (arg2@@6 Bool) ) (! (IsWandField (|wand_1#ft| arg1@@14 arg2@@6))
 :qid |stdinbpl.219:15|
 :skolemid |30|
 :pattern ( (|wand_1#ft| arg1@@14 arg2@@6))
)))
...
(assert (forall ((arg1@@15 Bool) (arg2@@7 Bool) ) (!  (not (IsPredicateField (wand_1 arg1@@15 arg2@@7)))
 :qid |stdinbpl.223:15|
 :skolemid |31|
 :pattern ( (wand_1 arg1@@15 arg2@@7))
)))
(assert (forall ((arg1@@16 Bool) (arg2@@8 Bool) ) (!  (not (IsPredicateField (|wand_1#ft| arg1@@16 arg2@@8)))
 :qid |stdinbpl.227:15|
 :skolemid |32|
...
(assert (forall ((arg1@@17 Bool) (arg2@@9 Bool) (arg3@@3 Bool) (arg4@@0 Bool) (arg1_2 Bool) (arg2_2 Bool) (arg3_2 Bool) (arg4_2 Bool) ) (!  (=> (= (wand arg1@@17 arg2@@9 arg3@@3 arg4@@0) (wand arg1_2 arg2_2 arg3_2 arg4_2)) (and (= arg1@@17 arg1_2) (and (= arg2@@9 arg2_2) (and (= arg3@@3 arg3_2) (= arg4@@0 arg4_2)))))
 :qid |stdinbpl.207:15|
 :skolemid |28|
 :pattern ( (wand arg1@@17 arg2@@9 arg3@@3 arg4@@0) (wand arg1_2 arg2_2 arg3_2 arg4_2))
)))
...
(assert (forall ((arg1@@18 Bool) (arg2@@10 Bool) (arg3@@4 Bool) (arg4@@1 Bool) ) (! (IsWandField (wand arg1@@18 arg2@@10 arg3@@4 arg4@@1))
 :qid |stdinbpl.183:15|
 :skolemid |22|
 :pattern ( (wand arg1@@18 arg2@@10 arg3@@4 arg4@@1))
)))
(assert (forall ((arg0@@28 Bool) (arg1@@19 Bool) (arg2@@11 Bool) (arg3@@5 Bool) ) (! (= (type (|wand#ft| arg0@@28 arg1@@19 arg2@@11 arg3@@5)) (FieldType WandType_wandType FrameTypeType))
 :qid |funType:wand#ft|
 :pattern ( (|wand#ft| arg0@@28 arg1@@19 arg2@@11 arg3@@5))
)))
(assert (forall ((arg1@@20 Bool) (arg2@@12 Bool) (arg3@@6 Bool) (arg4@@2 Bool) ) (! (IsWandField (|wand#ft| arg1@@20 arg2@@12 arg3@@6 arg4@@2))
 :qid |stdinbpl.187:15|
 :skolemid |23|
 :pattern ( (|wand#ft| arg1@@20 arg2@@12 arg3@@6 arg4@@2))
)))
...
(assert (forall ((arg1@@22 Bool) (arg2@@13 Bool) (arg3@@7 Bool) (arg4@@3 Bool) ) (!  (not (IsPredicateField (wand arg1@@22 arg2@@13 arg3@@7 arg4@@3)))
 :qid |stdinbpl.191:15|
 :skolemid |24|
 :pattern ( (wand arg1@@22 arg2@@13 arg3@@7 arg4@@3))
)))
(assert (forall ((arg1@@23 Bool) (arg2@@14 Bool) (arg3@@8 Bool) (arg4@@4 Bool) ) (!  (not (IsPredicateField (|wand#ft| arg1@@23 arg2@@14 arg3@@8 arg4@@4)))
 :qid |stdinbpl.195:15|
 :skolemid |25|
 :pattern ( (|wand#ft| arg1@@23 arg2@@14 arg3@@8 arg4@@4))
)))
...
(assert (forall ((arg0@@30 Bool) (arg1@@24 Bool) (arg2@@15 Bool) (arg3@@9 Bool) ) (! (= (type (|wand#sm| arg0@@30 arg1@@24 arg2@@15 arg3@@9)) (FieldType WandType_wandType (MapType1Type RefType boolType)))
 :qid |funType:wand#sm|
 :pattern ( (|wand#sm| arg0@@30 arg1@@24 arg2@@15 arg3@@9))
)))
(assert (forall ((arg1@@25 Bool) (arg2@@16 Bool) (arg3@@10 Bool) (arg4@@5 Bool) ) (! (= (|wand#sm| arg1@@25 arg2@@16 arg3@@10 arg4@@5) (WandMaskField (|wand#ft| arg1@@25 arg2@@16 arg3@@10 arg4@@5)))
 :qid |stdinbpl.199:15|
 :skolemid |26|
 :pattern ( (WandMaskField (|wand#ft| arg1@@25 arg2@@16 arg3@@10 arg4@@5)))
)))
...
(assert (forall ((arg1@@26 Bool) (arg2@@17 Bool) (arg1_2@@0 Bool) (arg2_2@@0 Bool) ) (!  (=> (= (wand_1 arg1@@26 arg2@@17) (wand_1 arg1_2@@0 arg2_2@@0)) (and (= arg1@@26 arg1_2@@0) (= arg2@@17 arg2_2@@0)))
 :qid |stdinbpl.239:15|
 :skolemid |35|
 :pattern ( (wand_1 arg1@@26 arg2@@17) (wand_1 arg1_2@@0 arg2_2@@0))
)))
(assert (forall ((arg1@@27 Bool) (arg2@@18 Bool) ) (! (= (getPredWandId (wand_1 arg1@@27 arg2@@18)) 1)
 :qid |stdinbpl.235:15|
 :skolemid |34|
 :pattern ( (wand_1 arg1@@27 arg2@@18))
)))
...
(assert (forall ((arg0@@31 Bool) (arg1@@28 Bool) ) (! (= (type (|wand_1#sm| arg0@@31 arg1@@28)) (FieldType WandType_wand_1Type (MapType1Type RefType boolType)))
 :qid |funType:wand_1#sm|
 :pattern ( (|wand_1#sm| arg0@@31 arg1@@28))
)))
(assert (forall ((arg1@@29 Bool) (arg2@@19 Bool) ) (! (= (|wand_1#sm| arg1@@29 arg2@@19) (WandMaskField (|wand_1#ft| arg1@@29 arg2@@19)))
 :qid |stdinbpl.231:15|
 :skolemid |33|
 :pattern ( (WandMaskField (|wand_1#ft| arg1@@29 arg2@@19)))
)))
...
(assert  (and (and (and (and (= (type WandDefRHSMask@1) (MapType1Type RefType realType)) (= (type WandDefRHSMask@0) (MapType1Type RefType realType))) (= (type WandDefRHSHeap@0) (MapType0Type RefType))) (= (type WandDefLHSHeap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))))
...
(let ((anon9_Else_correct  (=> (and (and (= WandDefRHSMask@0 (MapType1Store ZeroMask null (wand_1 true true) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (wand_1 true true))) FullPerm)))) (state WandDefRHSHeap@0 WandDefRHSMask@0)) (and (= WandDefRHSMask@1 WandDefRHSMask@0) (= (ControlFlow 0 6) 3))) anon5_correct)))
(let ((anon8_Then_correct  (=> b_2 (and (=> (= (ControlFlow 0 7) 5) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (not b_2) (=> (and (= WandDefRHSMask@1 ZeroMask) (= (ControlFlow 0 4) 3)) anon5_correct))))
...
(let ((anon7_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (<= FullPerm (U_2_real (MapType1Select ZeroMask null (wand true b_2 true true)))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 9) 8) anon7_Then_correct) (=> (= (ControlFlow 0 9) 2) anon7_Else_correct)))))
