...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((a_1 Int) (i_1 Int) (j_1 Int) (a_1_1 Int) (i_1_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (and (and (and (not (= a_1 a_1_1)) (not (= i_1 i_1_1))) (not (= j_1 j_1_1))) (>= balance i_1)) (>= balance i_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (or (not (= a_1 a_1_1)) (not (= i_1 i_1_1))) (not (= j_1 j_1_1))))
 :qid |stdinbpl.322:17|
 :skolemid |32|
 :pattern ( (neverTriggered3 a_1 i_1 j_1) (neverTriggered3 a_1_1 i_1_1 j_1_1))
))) (=> (forall ((a_1@@0 Int) (i_1@@0 Int) (j_1@@0 Int) (a_1_1@@0 Int) (i_1_1@@0 Int) (j_1_1@@0 Int) ) (!  (=> (and (and (and (and (and (and (not (= a_1@@0 a_1_1@@0)) (not (= i_1@@0 i_1_1@@0))) (not (= j_1@@0 j_1_1@@0))) (>= balance i_1@@0)) (>= balance i_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (or (not (= a_1@@0 a_1_1@@0)) (not (= i_1@@0 i_1_1@@0))) (not (= j_1@@0 j_1_1@@0))))
 :qid |stdinbpl.322:17|
 :skolemid |32|
 :pattern ( (neverTriggered3 a_1@@0 i_1@@0 j_1@@0) (neverTriggered3 a_1_1@@0 i_1_1@@0 j_1_1@@0))
)) (=> (forall ((a_1@@1 Int) (i_1@@1 Int) (j_1@@1 Int) ) (!  (=> (and (>= balance i_1@@1) (< NoPerm FullPerm)) (and (and (and (= (invRecv1 a_1@@1 i_1@@1 j_1@@1) a_1@@1) (= (invRecv2 a_1@@1 i_1@@1 j_1@@1) i_1@@1)) (= (invRecv3 a_1@@1 i_1@@1 j_1@@1) j_1@@1)) (qpRange3 a_1@@1 i_1@@1 j_1@@1)))
 :qid |stdinbpl.328:22|
 :skolemid |33|
 ...
 :pattern ( (MapType0Select Heap@@14 null (accessible_withdraw a_1@@1 i_1@@1 j_1@@1)))
)) (=> (and (and (and (forall ((msg_sender_1_1 Int) (amount@@5 Int) (parameter@@5 Int) ) (!  (=> (and (and (>= balance (invRecv2 msg_sender_1_1 amount@@5 parameter@@5)) (< NoPerm FullPerm)) (qpRange3 msg_sender_1_1 amount@@5 parameter@@5)) (and (and (= (invRecv1 msg_sender_1_1 amount@@5 parameter@@5) msg_sender_1_1) (= (invRecv2 msg_sender_1_1 amount@@5 parameter@@5) amount@@5)) (= (invRecv3 msg_sender_1_1 amount@@5 parameter@@5) parameter@@5)))
 :qid |stdinbpl.332:22|
 :skolemid |34|
...
)) (forall ((msg_sender_1_1@@0 Int) (amount@@6 Int) (parameter@@6 Int) ) (!  (=> (and (and (>= balance (invRecv2 msg_sender_1_1@@0 amount@@6 parameter@@6)) (< NoPerm FullPerm)) (qpRange3 msg_sender_1_1@@0 amount@@6 parameter@@6)) (and (=> (< NoPerm FullPerm) (and (and (= (invRecv1 msg_sender_1_1@@0 amount@@6 parameter@@6) msg_sender_1_1@@0) (= (invRecv2 msg_sender_1_1@@0 amount@@6 parameter@@6) amount@@6)) (= (invRecv3 msg_sender_1_1@@0 amount@@6 parameter@@6) parameter@@6))) (= (U_2_real (MapType1Select QPMask@0 null (accessible_withdraw msg_sender_1_1@@0 amount@@6 parameter@@6))) (+ (U_2_real (MapType1Select ZeroMask null (accessible_withdraw msg_sender_1_1@@0 amount@@6 parameter@@6))) FullPerm))))
 :qid |stdinbpl.338:22|
 :skolemid |35|
...
)) (forall ((msg_sender_1_1@@1 Int) (amount@@7 Int) (parameter@@7 Int) ) (!  (=> (not (and (and (>= balance (invRecv2 msg_sender_1_1@@1 amount@@7 parameter@@7)) (< NoPerm FullPerm)) (qpRange3 msg_sender_1_1@@1 amount@@7 parameter@@7))) (= (U_2_real (MapType1Select QPMask@0 null (accessible_withdraw msg_sender_1_1@@1 amount@@7 parameter@@7))) (U_2_real (MapType1Select ZeroMask null (accessible_withdraw msg_sender_1_1@@1 amount@@7 parameter@@7)))))
 :qid |stdinbpl.348:22|
 :skolemid |37|
 :pattern ( (MapType1Select QPMask@0 null (accessible_withdraw msg_sender_1_1@@1 amount@@7 parameter@@7)))
)))) (and (and (state Heap@@14 QPMask@0) (state Heap@@14 QPMask@0)) (and (state Heap@@14 QPMask@0) (= (ControlFlow 0 3) (- 0 2))))) (= (U_2_real (MapType1Select QPMask@0 null (accessible_withdraw msg_sender@@5 (+ balance 1) (+ balance 2)))) NoPerm)))))))
