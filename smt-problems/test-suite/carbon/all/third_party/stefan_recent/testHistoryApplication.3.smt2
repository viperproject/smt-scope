...
(assert  (and (and (= (type Heap@@19) (MapType0Type RefType)) (= (type diz@@19) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |History__hist_get_x#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@19 diz@@19 $allocated)) (= AssumeFunctionsAbove 1)) (=> (and (and (and (not (= diz@@19 null)) (state Heap@@19 ZeroMask)) (and (> wildcard@0 NoPerm) (not (= diz@@19 null)))) (and (and (= Mask@0 (MapType1Store ZeroMask diz@@19 History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz@@19 History__x_hist_value)) wildcard@0)))) (state Heap@@19 Mask@0)) (and (state Heap@@19 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm Mask@0 diz@@19 History__x_hist_value))))))
