(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:24:53
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quantifiedpredicates/basic/permissions.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
; Final check if taken enough permissions
; Done removing quantified permissions
(declare-const sm@71@01 $PSF<pred2>)
(declare-const s@72@01 $Snap)
; Definitional axioms for snapshot map values
(assert (forall ((s@72@01 $Snap)) (!
  (=>
    (and
      (img@66@01 ($SortWrappers.$SnapTo$Ref ($Snap.first s@72@01)) ($SortWrappers.$SnapTo$Perm ($Snap.second s@72@01)))
      (Seq_contains
        xs@60@01
        (inv@65@01 ($SortWrappers.$SnapTo$Ref ($Snap.first s@72@01)) ($SortWrappers.$SnapTo$Perm ($Snap.second s@72@01)))))
    (and
      (not (= s@72@01 $Snap.unit))
      (=
        ($PSF.lookup_pred2 (as sm@71@01  $PSF<pred2>) s@72@01)
        ($PSF.lookup_pred2 ($SortWrappers.$SnapTo$PSF<pred2> ($Snap.second ($Snap.second $t@63@01))) s@72@01))))
  :pattern (($PSF.lookup_pred2 (as sm@71@01  $PSF<pred2>) s@72@01))
  :pattern (($PSF.lookup_pred2 ($SortWrappers.$SnapTo$PSF<pred2> ($Snap.second ($Snap.second $t@63@01))) s@72@01))
  :qid |qp.psmValDef2|)))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
