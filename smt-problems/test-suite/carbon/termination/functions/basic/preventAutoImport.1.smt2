...
(assert (forall ((Heap@@2 T@U) (x@@8 Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (int_2_U (|fact#triggerStateless| x@@8))))
 :qid |stdinbpl.209:15|
 :skolemid |23|
 :pattern ( (|fact'| Heap@@2 x@@8))
)))
...
(assert (forall ((Heap@@4 T@U) (x@@9 Int) ) (!  (=> (= (type Heap@@4) (MapType0Type RefType)) (and (= (fact Heap@@4 x@@9) (|fact'| Heap@@4 x@@9)) (dummyFunction (int_2_U (|fact#triggerStateless| x@@9)))))
 :qid |stdinbpl.205:15|
 :skolemid |22|
 :pattern ( (fact Heap@@4 x@@9))
)))
...
(assert (forall ((Heap@@9 T@U) (Mask@@9 T@U) (x@@10 Int) ) (!  (=> (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (state Heap@@9 Mask@@9)) (= (|fact'| Heap@@9 x@@10) (|fact#frame| EmptyFrame x@@10)))
 :qid |stdinbpl.222:15|
 :skolemid |25|
 :pattern ( (state Heap@@9 Mask@@9) (|fact'| Heap@@9 x@@10))
)))
...
(assert (forall ((Heap@@12 T@U) (Mask@@10 T@U) (x@@11 Int) ) (!  (=> (and (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (and (state Heap@@12 Mask@@10) (< AssumeFunctionsAbove 0))) (>= x@@11 0)) (= (fact Heap@@12 x@@11) (ite (= x@@11 0) 1 (* x@@11 (|fact'| Heap@@12 (- x@@11 1))))))
 :qid |stdinbpl.215:15|
 :skolemid |24|
 :pattern ( (state Heap@@12 Mask@@10) (fact Heap@@12 x@@11))
)))
...
(let ((anon7_Else_correct  (=> (and (|fact#trigger| EmptyFrame (- x@@12 1)) (= (ControlFlow 0 5) 3)) anon5_correct)))
(let ((anon6_Then_correct  (=> (and (= x@@12 0) (= (ControlFlow 0 4) 3)) anon5_correct)))
(let ((anon7_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (>= (- x@@12 1) 0))))
(let ((anon6_Else_correct  (=> (not (= x@@12 0)) (and (=> (= (ControlFlow 0 6) 2) anon7_Then_correct) (=> (= (ControlFlow 0 6) 5) anon7_Else_correct)))))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove 0)) (and (>= x@@12 0) (state Heap@@13 ZeroMask))) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))
