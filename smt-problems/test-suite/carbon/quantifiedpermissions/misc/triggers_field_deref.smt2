...
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type x_2) RefType)) (= (type y@@2) RefType)) (= (type QPMask@3) (MapType1Type RefType realType))) (= (type z_14) RefType)) (forall ((arg0@@35 T@U) ) (! (= (type (invRecv23 arg0@@35)) RefType)
 :qid |funType:invRecv23|
 :pattern ( (invRecv23 arg0@@35))
))) (= (type QPMask@2) (MapType1Type RefType realType))) (forall ((arg0@@36 T@U) ) (! (= (type (invRecv22 arg0@@36)) RefType)
 :qid |funType:invRecv22|
 :pattern ( (invRecv22 arg0@@36))
))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@37 T@U) ) (! (= (type (invRecv21 arg0@@37)) RefType)
 :qid |funType:invRecv21|
 :pattern ( (invRecv21 arg0@@37))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@38 T@U) ) (! (= (type (invRecv20 arg0@@38)) RefType)
...
(let ((anon18_Else_correct  (=> (and (not (or (= z_14 x_2) (= z_14 y@@2))) (= (ControlFlow 0 14) 9)) anon11_correct)))
(let ((anon18_Then_correct  (=> (or (= z_14 x_2) (= z_14 y@@2)) (and (=> (= (ControlFlow 0 10) (- 0 13)) (HasDirectPerm QPMask@3 z_14 f_7)) (=> (HasDirectPerm QPMask@3 z_14 f_7) (and (=> (= (ControlFlow 0 10) (- 0 12)) (HasDirectPerm QPMask@3 z_14 g)) (=> (HasDirectPerm QPMask@3 z_14 g) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm QPMask@3 z_14 f_7)) (=> (HasDirectPerm QPMask@3 z_14 f_7) (=> (= (ControlFlow 0 10) 9) anon11_correct))))))))))
(let ((anon17_Else_correct  (=> (and (forall ((z_9 T@U) ) (!  (=> (and (= (type z_9) RefType) (or (= z_9 x_2) (= z_9 y@@2))) (> (+ (+ (U_2_int (MapType0Select Heap@@13 z_9 f_7)) (U_2_int (MapType0Select Heap@@13 z_9 g))) (U_2_int (MapType0Select Heap@@13 z_9 f_7))) 0))
 :qid |stdinbpl.2404:20|
 :skolemid |209|
 :pattern ( (fun01 z_9) (MapType0Select Heap@@13 z_9 f_7) (MapType0Select Heap@@13 z_9 g))
)) (state Heap@@13 QPMask@3)) (=> (and (and (state Heap@@13 QPMask@3) (fun01 x_2)) (and (state Heap@@13 QPMask@3) (state Heap@@13 QPMask@3))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (HasDirectPerm QPMask@3 x_2 f_7)) (=> (HasDirectPerm QPMask@3 x_2 f_7) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm QPMask@3 x_2 g)) (=> (HasDirectPerm QPMask@3 x_2 g) (=> (= (ControlFlow 0 6) (- 0 5)) (> (+ (* 2 (U_2_int (MapType0Select Heap@@13 x_2 f_7))) (U_2_int (MapType0Select Heap@@13 x_2 g))) 0))))))))))
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((z_7 T@U) (z_7_1 T@U) ) (!  (=> (and (= (type z_7) RefType) (= (type z_7_1) RefType)) (=> (and (and (and (and (not (= z_7 z_7_1)) (= z_7 y@@2)) (= z_7_1 y@@2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_7 z_7_1))))
 :qid |stdinbpl.2347:15|
 :skolemid |203|
 :no-pattern (type z_7)
...
)) (=> (and (and (forall ((z_7@@1 T@U) ) (!  (=> (= (type z_7@@1) RefType) (=> (and (= z_7@@1 y@@2) (< NoPerm FullPerm)) (and (qpRange23 z_7@@1) (= (invRecv23 z_7@@1) z_7@@1))))
 :qid |stdinbpl.2353:22|
 :skolemid |204|
 :pattern ( (MapType0Select Heap@@13 z_7@@1 g))
 :pattern ( (MapType1Select QPMask@3 z_7@@1 g))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (= (invRecv23 o_3) y@@2) (< NoPerm FullPerm)) (qpRange23 o_3)) (= (invRecv23 o_3) o_3)))
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (= (invRecv23 o_3@@0) y@@2) (< NoPerm FullPerm)) (qpRange23 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv23 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@3 o_3@@0 g)) (+ (U_2_real (MapType1Select QPMask@2 o_3@@0 g)) FullPerm)))) (=> (not (and (and (= (invRecv23 o_3@@0) y@@2) (< NoPerm FullPerm)) (qpRange23 o_3@@0))) (= (U_2_real (MapType1Select QPMask@3 o_3@@0 g)) (U_2_real (MapType1Select QPMask@2 o_3@@0 g))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.2373:29|
 :skolemid |208|
 :pattern ( (MapType1Select QPMask@2 o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@3 o_3@@1 f_5))
)) (state Heap@@13 QPMask@3)) (and (state Heap@@13 QPMask@3) (state Heap@@13 QPMask@3))) (and (and (not (= x_2 null)) (not (= y@@2 null))) (and (state Heap@@13 QPMask@3) (state Heap@@13 QPMask@3)))) (and (and (=> (= (ControlFlow 0 15) 6) anon17_Else_correct) (=> (= (ControlFlow 0 15) 10) anon18_Then_correct)) (=> (= (ControlFlow 0 15) 14) anon18_Else_correct))))))))
(let ((anon16_Then_correct true))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((z_5 T@U) (z_5_1 T@U) ) (!  (=> (and (= (type z_5) RefType) (= (type z_5_1) RefType)) (=> (and (and (and (and (not (= z_5 z_5_1)) (= z_5 x_2)) (= z_5_1 x_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_5 z_5_1))))
...
)) (=> (and (and (and (forall ((z_5@@1 T@U) ) (!  (=> (= (type z_5@@1) RefType) (=> (and (= z_5@@1 x_2) (< NoPerm FullPerm)) (and (qpRange22 z_5@@1) (= (invRecv22 z_5@@1) z_5@@1))))
 :qid |stdinbpl.2310:22|
 :skolemid |198|
 :pattern ( (MapType0Select Heap@@13 z_5@@1 g))
 :pattern ( (MapType1Select QPMask@2 z_5@@1 g))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (= (invRecv22 o_3@@2) x_2) (< NoPerm FullPerm)) (qpRange22 o_3@@2)) (= (invRecv22 o_3@@2) o_3@@2)))
...
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (= (invRecv22 o_3@@3) x_2) (< NoPerm FullPerm)) (qpRange22 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv22 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@2 o_3@@3 g)) (+ (U_2_real (MapType1Select QPMask@1 o_3@@3 g)) FullPerm)))) (=> (not (and (and (= (invRecv22 o_3@@3) x_2) (< NoPerm FullPerm)) (qpRange22 o_3@@3))) (= (U_2_real (MapType1Select QPMask@2 o_3@@3 g)) (U_2_real (MapType1Select QPMask@1 o_3@@3 g))))))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 ...
 :qid |stdinbpl.2330:29|
 :skolemid |202|
 :pattern ( (MapType1Select QPMask@1 o_3@@4 f_5@@0))
 :pattern ( (MapType1Select QPMask@2 o_3@@4 f_5@@0))
)) (state Heap@@13 QPMask@2)) (and (state Heap@@13 QPMask@2) (state Heap@@13 QPMask@2)))) (and (=> (= (ControlFlow 0 17) 4) anon16_Then_correct) (=> (= (ControlFlow 0 17) 15) anon16_Else_correct)))))))
(let ((anon15_Then_correct true))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((z_3 T@U) (z_3_1 T@U) ) (!  (=> (and (= (type z_3) RefType) (= (type z_3_1) RefType)) (=> (and (and (and (and (not (= z_3 z_3_1)) (= z_3 y@@2)) (= z_3_1 y@@2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_3 z_3_1))))
 :qid |stdinbpl.2261:15|
 :skolemid |191|
 :no-pattern (type z_3)
...
)) (=> (and (and (and (forall ((z_3@@1 T@U) ) (!  (=> (= (type z_3@@1) RefType) (=> (and (= z_3@@1 y@@2) (< NoPerm FullPerm)) (and (qpRange21 z_3@@1) (= (invRecv21 z_3@@1) z_3@@1))))
 :qid |stdinbpl.2267:22|
 :skolemid |192|
 :pattern ( (MapType0Select Heap@@13 z_3@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 z_3@@1 f_7))
)) (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (= (invRecv21 o_3@@5) y@@2) (< NoPerm FullPerm)) (qpRange21 o_3@@5)) (= (invRecv21 o_3@@5) o_3@@5)))
...
)) (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (= (invRecv21 o_3@@6) y@@2) (< NoPerm FullPerm)) (qpRange21 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv21 o_3@@6) o_3@@6)) (= (U_2_real (MapType1Select QPMask@1 o_3@@6 f_7)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) FullPerm)))) (=> (not (and (and (= (invRecv21 o_3@@6) y@@2) (< NoPerm FullPerm)) (qpRange21 o_3@@6))) (= (U_2_real (MapType1Select QPMask@1 o_3@@6 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7))))))
...
)) (state Heap@@13 QPMask@1)) (and (state Heap@@13 QPMask@1) (state Heap@@13 QPMask@1)))) (and (=> (= (ControlFlow 0 19) 3) anon15_Then_correct) (=> (= (ControlFlow 0 19) 17) anon15_Else_correct)))))))
(let ((anon14_Then_correct true))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (= z_1 x_2)) (= z_1_1 x_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1))))
...
)) (=> (and (and (and (forall ((z_1@@1 T@U) ) (!  (=> (= (type z_1@@1) RefType) (=> (and (= z_1@@1 x_2) (< NoPerm FullPerm)) (and (qpRange20 z_1@@1) (= (invRecv20 z_1@@1) z_1@@1))))
 :qid |stdinbpl.2224:22|
 :skolemid |186|
 :pattern ( (MapType0Select Heap@@13 z_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@1 f_7))
)) (forall ((o_3@@8 T@U) ) (!  (=> (= (type o_3@@8) RefType) (=> (and (and (= (invRecv20 o_3@@8) x_2) (< NoPerm FullPerm)) (qpRange20 o_3@@8)) (= (invRecv20 o_3@@8) o_3@@8)))
...
)) (forall ((o_3@@9 T@U) ) (!  (=> (= (type o_3@@9) RefType) (and (=> (and (and (= (invRecv20 o_3@@9) x_2) (< NoPerm FullPerm)) (qpRange20 o_3@@9)) (and (=> (< NoPerm FullPerm) (= (invRecv20 o_3@@9) o_3@@9)) (= (U_2_real (MapType1Select QPMask@0 o_3@@9 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@9 f_7)) FullPerm)))) (=> (not (and (and (= (invRecv20 o_3@@9) x_2) (< NoPerm FullPerm)) (qpRange20 o_3@@9))) (= (U_2_real (MapType1Select QPMask@0 o_3@@9 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@9 f_7))))))
...
)) (state Heap@@13 QPMask@0)) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)))) (and (=> (= (ControlFlow 0 21) 2) anon14_Then_correct) (=> (= (ControlFlow 0 21) 19) anon14_Else_correct)))))))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@13 x_2 $allocated)) (U_2_bool (MapType0Select Heap@@13 y@@2 $allocated)))) (and (=> (= (ControlFlow 0 23) 1) anon13_Then_correct) (=> (= (ControlFlow 0 23) 21) anon13_Else_correct)))))
