...
(assert  (and (= (type arr) RefType) (= (type Heap@@9) (MapType0Type RefType))))
...
(let ((anon3_Then_correct  (=> (not (= NoPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= NoPerm (U_2_real (MapType1Select ZeroMask arr val)))) (=> (<= NoPerm (U_2_real (MapType1Select ZeroMask arr val))) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 arr $allocated))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))
