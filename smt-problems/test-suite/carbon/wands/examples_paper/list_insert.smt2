...
(let ((anon9_Else_correct  (=> (= (MapType0Select Heap@1 xs@@13 next) null) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 3) 1)) anon6_correct))))
(let ((anon9_Then_correct  (=> (not (= (MapType0Select Heap@1 xs@@13 next) null)) (=> (and (and (forall ((o_4 T@U) (f_8 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_8))))
(let ((A@@12 (FieldTypeInv0 (type f_8))))
 (=> (and (and (= (type o_4) RefType) (= (type f_8) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|List#sm| xs@@13)) o_4 f_8)) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|List#sm| (MapType0Select Heap@1 xs@@13 next))) o_4 f_8)))) (U_2_bool (MapType1Select newPMask@0 o_4 f_8)))))
 :qid |stdinbpl.825:33|
 :skolemid |74|
 :pattern ( (MapType1Select newPMask@0 o_4 f_8))
)) (= Heap@2 (MapType0Store Heap@1 null (|List#sm| xs@@13) newPMask@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 2) 1))) anon6_correct))))
(let ((anon4_correct  (=> (state Heap@@18 UnfoldingMask@4) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm UnfoldingMask@4 xs@@13 val)) (=> (HasDirectPerm UnfoldingMask@4 xs@@13 val) (=> (and (= Heap@0 (MapType0Store Heap@@18 null (|List#sm| xs@@13) (MapType1Store (MapType0Select Heap@@18 null (|List#sm| xs@@13)) xs@@13 val (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|List#sm| xs@@13) (MapType1Store (MapType0Select Heap@0 null (|List#sm| xs@@13)) xs@@13 next (bool_2_U true))))) (and (=> (= (ControlFlow 0 4) 2) anon9_Then_correct) (=> (= (ControlFlow 0 4) 3) anon9_Else_correct))))))))
(let ((anon8_Else_correct  (=> (= (MapType0Select Heap@@18 xs@@13 next) null) (=> (and (= UnfoldingMask@4 UnfoldingMask@2) (= (ControlFlow 0 7) 4)) anon4_correct))))
