...
(declare-fun p_11 () Real)
(declare-fun Heap@@9 () T@U)
(declare-fun Mask@0 () T@U)
(declare-fun AssertMask@0 () T@U)
(declare-fun inv_10 (T@U) T@U)
(declare-fun xs11 () T@U)
(declare-fun inv_0 (T@U) T@U)
(declare-fun xs2 () T@U)
(declare-fun inv_1 (T@U) T@U)
(declare-fun xs3 () T@U)
(declare-fun inv_2 (T@U) T@U)
(declare-fun xs4 () T@U)
(declare-fun inv_3 (T@U) T@U)
(declare-fun xs5 () T@U)
(declare-fun inv_4 (T@U) T@U)
(declare-fun xs6 () T@U)
(declare-fun inv_5 (T@U) T@U)
(declare-fun xs7 () T@U)
(declare-fun inv_6 (T@U) T@U)
(declare-fun xs8 () T@U)
(declare-fun inv_7 (T@U) T@U)
(declare-fun xs9 () T@U)
(declare-fun inv_8 (T@U) T@U)
(declare-fun xs10 () T@U)
(declare-fun inv_9 (T@U) T@U)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type xs1) (MapType2Type RefType boolType)) (= (type x@@19) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type AssertMask@0) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (inv_10 arg0@@43)) RefType)
 :qid |funType:inv_10|
 :pattern ( (inv_10 arg0@@43))
))) (= (type xs11) (MapType2Type RefType boolType))) (forall ((arg0@@44 T@U) ) (! (= (type (inv_0 arg0@@44)) RefType)
 :qid |funType:inv_0|
 :pattern ( (inv_0 arg0@@44))
))) (= (type xs2) (MapType2Type RefType boolType))) (forall ((arg0@@45 T@U) ) (! (= (type (inv_1 arg0@@45)) RefType)
 :qid |funType:inv_1|
 :pattern ( (inv_1 arg0@@45))
))) (= (type xs3) (MapType2Type RefType boolType))) (forall ((arg0@@46 T@U) ) (! (= (type (inv_2 arg0@@46)) RefType)
 :qid |funType:inv_2|
 :pattern ( (inv_2 arg0@@46))
))) (= (type xs4) (MapType2Type RefType boolType))) (forall ((arg0@@47 T@U) ) (! (= (type (inv_3 arg0@@47)) RefType)
 :qid |funType:inv_3|
 :pattern ( (inv_3 arg0@@47))
))) (= (type xs5) (MapType2Type RefType boolType))) (forall ((arg0@@48 T@U) ) (! (= (type (inv_4 arg0@@48)) RefType)
 :qid |funType:inv_4|
 :pattern ( (inv_4 arg0@@48))
))) (= (type xs6) (MapType2Type RefType boolType))) (forall ((arg0@@49 T@U) ) (! (= (type (inv_5 arg0@@49)) RefType)
 :qid |funType:inv_5|
 :pattern ( (inv_5 arg0@@49))
))) (= (type xs7) (MapType2Type RefType boolType))) (forall ((arg0@@50 T@U) ) (! (= (type (inv_6 arg0@@50)) RefType)
 :qid |funType:inv_6|
 :pattern ( (inv_6 arg0@@50))
))) (= (type xs8) (MapType2Type RefType boolType))) (forall ((arg0@@51 T@U) ) (! (= (type (inv_7 arg0@@51)) RefType)
 :qid |funType:inv_7|
 :pattern ( (inv_7 arg0@@51))
))) (= (type xs9) (MapType2Type RefType boolType))) (forall ((arg0@@52 T@U) ) (! (= (type (inv_8 arg0@@52)) RefType)
 :qid |funType:inv_8|
 :pattern ( (inv_8 arg0@@52))
))) (= (type xs10) (MapType2Type RefType boolType))) (forall ((arg0@@53 T@U) ) (! (= (type (inv_9 arg0@@53)) RefType)
 :qid |funType:inv_9|
 :pattern ( (inv_9 arg0@@53))
))))
...
(let ((anon108_Else_correct  (=> (and (not (and (> (|Set#Card| xs1) 0) (U_2_bool (MapType2Select xs1 x@@19)))) (= (ControlFlow 0 39) 36)) anon72_correct)))
(let ((anon108_Then_correct  (=> (and (> (|Set#Card| xs1) 0) (U_2_bool (MapType2Select xs1 x@@19))) (and (=> (= (ControlFlow 0 37) (- 0 38)) (< p_11 FullPerm)) (=> (< p_11 FullPerm) (=> (= (ControlFlow 0 37) 36) anon72_correct))))))
(let ((anon107_Else_correct  (=> (and (<= p_11 NoPerm) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 40) 37) anon108_Then_correct) (=> (= (ControlFlow 0 40) 39) anon108_Else_correct)))))
(let ((anon107_Then_correct  (=> (and (< NoPerm p_11) (= (ControlFlow 0 35) (- 0 34))) false)))
(let ((anon68_correct  (=> (and (= AssertMask@0 (MapType1Store Mask@0 x@@19 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 x@@19 f_7)) p_11)))) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 41) 35) anon107_Then_correct) (=> (= (ControlFlow 0 41) 40) anon107_Else_correct)))))
(let ((anon106_Else_correct  (=> (and (= p_11 NoPerm) (= (ControlFlow 0 44) 41)) anon68_correct)))
(let ((anon106_Then_correct  (=> (not (= p_11 NoPerm)) (and (=> (= (ControlFlow 0 42) (- 0 43)) (<= p_11 (U_2_real (MapType1Select Mask@0 x@@19 f_7)))) (=> (<= p_11 (U_2_real (MapType1Select Mask@0 x@@19 f_7))) (=> (= (ControlFlow 0 42) 41) anon68_correct))))))
(let ((anon105_Else_correct  (=> (forall ((r_43 T@U) ) (!  (=> (and (= (type r_43) RefType) (U_2_bool (MapType2Select xs11 (inv_10 r_43)))) (<= (__iar__assume_helper_10  (and (U_2_bool (MapType2Select xs1 (inv_0 r_43))) (= r_43 r_43))  (and (U_2_bool (MapType2Select xs2 (inv_1 r_43))) (= r_43 r_43))  (and (U_2_bool (MapType2Select xs3 (inv_2 r_43))) (= r_43 r_43))  (and (U_2_bool (MapType2Select xs4 (inv_3 r_43))) (= r_43 r_43))  (and (U_2_bool (MapType2Select xs5 (inv_4 r_43))) (= r_43 r_43))  (and (U_2_bool (MapType2Select xs6 (inv_5 r_43))) (= r_43 r_43))  (and (U_2_bool (MapType2Select xs7 (inv_6 r_43))) (= r_43 r_43))  (and (U_2_bool (MapType2Select xs8 (inv_7 r_43))) (= r_43 r_43))  (and (U_2_bool (MapType2Select xs9 (inv_8 r_43))) (= r_43 r_43))  (and (U_2_bool (MapType2Select xs10 (inv_9 r_43))) (= r_43 r_43)) p_11 p_11 p_11 p_11 p_11 p_11 p_11 p_11 p_11 p_11 p_11) (U_2_real (MapType1Select Mask@0 r_43 f_7))))
 :qid |stdinbpl.1120:20|
 :skolemid |124|
 :pattern ( (inv_10 r_43))
)) (=> (and (and (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (U_2_bool (MapType2Select xs1 x@@19)) (state Heap@@9 Mask@0))) (and (and (state Heap@@9 Mask@0) (U_2_bool (MapType2Select xs2 x@@19))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)))) (and (=> (= (ControlFlow 0 45) (- 0 46)) (>= p_11 NoPerm)) (=> (>= p_11 NoPerm) (and (=> (= (ControlFlow 0 45) 42) anon106_Then_correct) (=> (= (ControlFlow 0 45) 44) anon106_Else_correct))))))))
(let ((anon105_Then_correct true))
(let ((anon104_Else_correct  (=> (forall ((r_41 T@U) ) (!  (=> (and (= (type r_41) RefType) (U_2_bool (MapType2Select xs11 (inv_10 r_41)))) (= (inv_10 r_41) r_41))
 :qid |stdinbpl.1097:20|
 :skolemid |123|
 :pattern ( (inv_10 r_41))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 47) 33) anon105_Then_correct) (=> (= (ControlFlow 0 47) 45) anon105_Else_correct))))))
(let ((anon104_Then_correct true))
(let ((anon103_Else_correct  (=> (forall ((x11_1 T@U) ) (!  (=> (and (= (type x11_1) RefType) (U_2_bool (MapType2Select xs11 x11_1))) (= (inv_10 x11_1) x11_1))
 :qid |stdinbpl.1082:20|
 :skolemid |122|
 :pattern ( (MapType0Select Heap@@9 x11_1 f_7))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 48) 32) anon104_Then_correct) (=> (= (ControlFlow 0 48) 47) anon104_Else_correct))))))
(let ((anon103_Then_correct true))
(let ((anon102_Else_correct  (=> (forall ((r_39 T@U) ) (!  (=> (and (= (type r_39) RefType) (U_2_bool (MapType2Select xs10 (inv_9 r_39)))) (<= (__iar__assume_helper_9  (and (U_2_bool (MapType2Select xs1 (inv_0 r_39))) (= r_39 r_39))  (and (U_2_bool (MapType2Select xs2 (inv_1 r_39))) (= r_39 r_39))  (and (U_2_bool (MapType2Select xs3 (inv_2 r_39))) (= r_39 r_39))  (and (U_2_bool (MapType2Select xs4 (inv_3 r_39))) (= r_39 r_39))  (and (U_2_bool (MapType2Select xs5 (inv_4 r_39))) (= r_39 r_39))  (and (U_2_bool (MapType2Select xs6 (inv_5 r_39))) (= r_39 r_39))  (and (U_2_bool (MapType2Select xs7 (inv_6 r_39))) (= r_39 r_39))  (and (U_2_bool (MapType2Select xs8 (inv_7 r_39))) (= r_39 r_39))  (and (U_2_bool (MapType2Select xs9 (inv_8 r_39))) (= r_39 r_39)) p_11 p_11 p_11 p_11 p_11 p_11 p_11 p_11 p_11 p_11) (U_2_real (MapType1Select Mask@0 r_39 f_7))))
 :qid |stdinbpl.1067:20|
 :skolemid |121|
 :pattern ( (inv_9 r_39))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 49) 31) anon103_Then_correct) (=> (= (ControlFlow 0 49) 48) anon103_Else_correct))))))
(let ((anon102_Then_correct true))
(let ((anon101_Else_correct  (=> (forall ((r_37 T@U) ) (!  (=> (and (= (type r_37) RefType) (U_2_bool (MapType2Select xs10 (inv_9 r_37)))) (= (inv_9 r_37) r_37))
 :qid |stdinbpl.1045:20|
 :skolemid |120|
 :pattern ( (inv_9 r_37))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 50) 30) anon102_Then_correct) (=> (= (ControlFlow 0 50) 49) anon102_Else_correct))))))
(let ((anon101_Then_correct true))
(let ((anon100_Else_correct  (=> (forall ((x10_1 T@U) ) (!  (=> (and (= (type x10_1) RefType) (U_2_bool (MapType2Select xs10 x10_1))) (= (inv_9 x10_1) x10_1))
 :qid |stdinbpl.1032:20|
 :skolemid |119|
 :pattern ( (MapType0Select Heap@@9 x10_1 f_7))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 51) 29) anon101_Then_correct) (=> (= (ControlFlow 0 51) 50) anon101_Else_correct))))))
(let ((anon100_Then_correct true))
(let ((anon99_Else_correct  (=> (forall ((r_35 T@U) ) (!  (=> (and (= (type r_35) RefType) (U_2_bool (MapType2Select xs9 (inv_8 r_35)))) (<= (__iar__assume_helper_8  (and (U_2_bool (MapType2Select xs1 (inv_0 r_35))) (= r_35 r_35))  (and (U_2_bool (MapType2Select xs2 (inv_1 r_35))) (= r_35 r_35))  (and (U_2_bool (MapType2Select xs3 (inv_2 r_35))) (= r_35 r_35))  (and (U_2_bool (MapType2Select xs4 (inv_3 r_35))) (= r_35 r_35))  (and (U_2_bool (MapType2Select xs5 (inv_4 r_35))) (= r_35 r_35))  (and (U_2_bool (MapType2Select xs6 (inv_5 r_35))) (= r_35 r_35))  (and (U_2_bool (MapType2Select xs7 (inv_6 r_35))) (= r_35 r_35))  (and (U_2_bool (MapType2Select xs8 (inv_7 r_35))) (= r_35 r_35)) p_11 p_11 p_11 p_11 p_11 p_11 p_11 p_11 p_11) (U_2_real (MapType1Select Mask@0 r_35 f_7))))
 :qid |stdinbpl.1017:20|
 :skolemid |118|
 :pattern ( (inv_8 r_35))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 52) 28) anon100_Then_correct) (=> (= (ControlFlow 0 52) 51) anon100_Else_correct))))))
(let ((anon99_Then_correct true))
(let ((anon98_Else_correct  (=> (forall ((r_33 T@U) ) (!  (=> (and (= (type r_33) RefType) (U_2_bool (MapType2Select xs9 (inv_8 r_33)))) (= (inv_8 r_33) r_33))
 :qid |stdinbpl.995:20|
 :skolemid |117|
 :pattern ( (inv_8 r_33))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 53) 27) anon99_Then_correct) (=> (= (ControlFlow 0 53) 52) anon99_Else_correct))))))
(let ((anon98_Then_correct true))
(let ((anon97_Else_correct  (=> (forall ((x9_1 T@U) ) (!  (=> (and (= (type x9_1) RefType) (U_2_bool (MapType2Select xs9 x9_1))) (= (inv_8 x9_1) x9_1))
 :qid |stdinbpl.982:20|
 :skolemid |116|
 :pattern ( (MapType0Select Heap@@9 x9_1 f_7))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 54) 26) anon98_Then_correct) (=> (= (ControlFlow 0 54) 53) anon98_Else_correct))))))
(let ((anon97_Then_correct true))
(let ((anon96_Else_correct  (=> (forall ((r_31 T@U) ) (!  (=> (and (= (type r_31) RefType) (U_2_bool (MapType2Select xs8 (inv_7 r_31)))) (<= (__iar__assume_helper_7  (and (U_2_bool (MapType2Select xs1 (inv_0 r_31))) (= r_31 r_31))  (and (U_2_bool (MapType2Select xs2 (inv_1 r_31))) (= r_31 r_31))  (and (U_2_bool (MapType2Select xs3 (inv_2 r_31))) (= r_31 r_31))  (and (U_2_bool (MapType2Select xs4 (inv_3 r_31))) (= r_31 r_31))  (and (U_2_bool (MapType2Select xs5 (inv_4 r_31))) (= r_31 r_31))  (and (U_2_bool (MapType2Select xs6 (inv_5 r_31))) (= r_31 r_31))  (and (U_2_bool (MapType2Select xs7 (inv_6 r_31))) (= r_31 r_31)) p_11 p_11 p_11 p_11 p_11 p_11 p_11 p_11) (U_2_real (MapType1Select Mask@0 r_31 f_7))))
 :qid |stdinbpl.969:20|
 :skolemid |115|
 :pattern ( (inv_7 r_31))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 55) 25) anon97_Then_correct) (=> (= (ControlFlow 0 55) 54) anon97_Else_correct))))))
(let ((anon96_Then_correct true))
(let ((anon95_Else_correct  (=> (forall ((r_29 T@U) ) (!  (=> (and (= (type r_29) RefType) (U_2_bool (MapType2Select xs8 (inv_7 r_29)))) (= (inv_7 r_29) r_29))
 :qid |stdinbpl.948:20|
 :skolemid |114|
 :pattern ( (inv_7 r_29))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 56) 24) anon96_Then_correct) (=> (= (ControlFlow 0 56) 55) anon96_Else_correct))))))
(let ((anon95_Then_correct true))
(let ((anon94_Else_correct  (=> (forall ((x8_1 T@U) ) (!  (=> (and (= (type x8_1) RefType) (U_2_bool (MapType2Select xs8 x8_1))) (= (inv_7 x8_1) x8_1))
 :qid |stdinbpl.935:20|
 :skolemid |113|
 :pattern ( (MapType0Select Heap@@9 x8_1 f_7))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 57) 23) anon95_Then_correct) (=> (= (ControlFlow 0 57) 56) anon95_Else_correct))))))
(let ((anon94_Then_correct true))
(let ((anon93_Else_correct  (=> (forall ((r_27 T@U) ) (!  (=> (and (= (type r_27) RefType) (U_2_bool (MapType2Select xs7 (inv_6 r_27)))) (<= (__iar__assume_helper_6  (and (U_2_bool (MapType2Select xs1 (inv_0 r_27))) (= r_27 r_27))  (and (U_2_bool (MapType2Select xs2 (inv_1 r_27))) (= r_27 r_27))  (and (U_2_bool (MapType2Select xs3 (inv_2 r_27))) (= r_27 r_27))  (and (U_2_bool (MapType2Select xs4 (inv_3 r_27))) (= r_27 r_27))  (and (U_2_bool (MapType2Select xs5 (inv_4 r_27))) (= r_27 r_27))  (and (U_2_bool (MapType2Select xs6 (inv_5 r_27))) (= r_27 r_27)) p_11 p_11 p_11 p_11 p_11 p_11 p_11) (U_2_real (MapType1Select Mask@0 r_27 f_7))))
 :qid |stdinbpl.922:20|
 :skolemid |112|
 :pattern ( (inv_6 r_27))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 58) 22) anon94_Then_correct) (=> (= (ControlFlow 0 58) 57) anon94_Else_correct))))))
(let ((anon93_Then_correct true))
(let ((anon92_Else_correct  (=> (forall ((r_25 T@U) ) (!  (=> (and (= (type r_25) RefType) (U_2_bool (MapType2Select xs7 (inv_6 r_25)))) (= (inv_6 r_25) r_25))
 :qid |stdinbpl.902:20|
 :skolemid |111|
 :pattern ( (inv_6 r_25))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 59) 21) anon93_Then_correct) (=> (= (ControlFlow 0 59) 58) anon93_Else_correct))))))
(let ((anon92_Then_correct true))
(let ((anon91_Else_correct  (=> (forall ((x7_1 T@U) ) (!  (=> (and (= (type x7_1) RefType) (U_2_bool (MapType2Select xs7 x7_1))) (= (inv_6 x7_1) x7_1))
 :qid |stdinbpl.889:20|
 :skolemid |110|
 :pattern ( (MapType0Select Heap@@9 x7_1 f_7))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 60) 20) anon92_Then_correct) (=> (= (ControlFlow 0 60) 59) anon92_Else_correct))))))
(let ((anon91_Then_correct true))
(let ((anon90_Else_correct  (=> (forall ((r_23 T@U) ) (!  (=> (and (= (type r_23) RefType) (U_2_bool (MapType2Select xs6 (inv_5 r_23)))) (<= (__iar__assume_helper_5  (and (U_2_bool (MapType2Select xs1 (inv_0 r_23))) (= r_23 r_23))  (and (U_2_bool (MapType2Select xs2 (inv_1 r_23))) (= r_23 r_23))  (and (U_2_bool (MapType2Select xs3 (inv_2 r_23))) (= r_23 r_23))  (and (U_2_bool (MapType2Select xs4 (inv_3 r_23))) (= r_23 r_23))  (and (U_2_bool (MapType2Select xs5 (inv_4 r_23))) (= r_23 r_23)) p_11 p_11 p_11 p_11 p_11 p_11) (U_2_real (MapType1Select Mask@0 r_23 f_7))))
 :qid |stdinbpl.876:20|
 :skolemid |109|
 :pattern ( (inv_5 r_23))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 61) 19) anon91_Then_correct) (=> (= (ControlFlow 0 61) 60) anon91_Else_correct))))))
(let ((anon90_Then_correct true))
(let ((anon89_Else_correct  (=> (forall ((r_21 T@U) ) (!  (=> (and (= (type r_21) RefType) (U_2_bool (MapType2Select xs6 (inv_5 r_21)))) (= (inv_5 r_21) r_21))
 :qid |stdinbpl.856:20|
 :skolemid |108|
 :pattern ( (inv_5 r_21))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 62) 18) anon90_Then_correct) (=> (= (ControlFlow 0 62) 61) anon90_Else_correct))))))
(let ((anon89_Then_correct true))
(let ((anon88_Else_correct  (=> (forall ((x6_1 T@U) ) (!  (=> (and (= (type x6_1) RefType) (U_2_bool (MapType2Select xs6 x6_1))) (= (inv_5 x6_1) x6_1))
 :qid |stdinbpl.843:20|
 :skolemid |107|
 :pattern ( (MapType0Select Heap@@9 x6_1 f_7))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 63) 17) anon89_Then_correct) (=> (= (ControlFlow 0 63) 62) anon89_Else_correct))))))
(let ((anon88_Then_correct true))
(let ((anon87_Else_correct  (=> (forall ((r_19 T@U) ) (!  (=> (and (= (type r_19) RefType) (U_2_bool (MapType2Select xs5 (inv_4 r_19)))) (<= (__iar__assume_helper_4  (and (U_2_bool (MapType2Select xs1 (inv_0 r_19))) (= r_19 r_19))  (and (U_2_bool (MapType2Select xs2 (inv_1 r_19))) (= r_19 r_19))  (and (U_2_bool (MapType2Select xs3 (inv_2 r_19))) (= r_19 r_19))  (and (U_2_bool (MapType2Select xs4 (inv_3 r_19))) (= r_19 r_19)) p_11 p_11 p_11 p_11 p_11) (U_2_real (MapType1Select Mask@0 r_19 f_7))))
 :qid |stdinbpl.830:20|
 :skolemid |106|
 :pattern ( (inv_4 r_19))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 64) 16) anon88_Then_correct) (=> (= (ControlFlow 0 64) 63) anon88_Else_correct))))))
(let ((anon87_Then_correct true))
(let ((anon86_Else_correct  (=> (forall ((r_17 T@U) ) (!  (=> (and (= (type r_17) RefType) (U_2_bool (MapType2Select xs5 (inv_4 r_17)))) (= (inv_4 r_17) r_17))
 :qid |stdinbpl.811:20|
 :skolemid |105|
 :pattern ( (inv_4 r_17))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 65) 15) anon87_Then_correct) (=> (= (ControlFlow 0 65) 64) anon87_Else_correct))))))
(let ((anon86_Then_correct true))
(let ((anon85_Else_correct  (=> (forall ((x5_1 T@U) ) (!  (=> (and (= (type x5_1) RefType) (U_2_bool (MapType2Select xs5 x5_1))) (= (inv_4 x5_1) x5_1))
 :qid |stdinbpl.798:20|
 :skolemid |104|
 :pattern ( (MapType0Select Heap@@9 x5_1 f_7))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 66) 14) anon86_Then_correct) (=> (= (ControlFlow 0 66) 65) anon86_Else_correct))))))
(let ((anon85_Then_correct true))
(let ((anon84_Else_correct  (=> (forall ((r_15 T@U) ) (!  (=> (and (= (type r_15) RefType) (U_2_bool (MapType2Select xs4 (inv_3 r_15)))) (<= (__iar__assume_helper_3  (and (U_2_bool (MapType2Select xs1 (inv_0 r_15))) (= r_15 r_15))  (and (U_2_bool (MapType2Select xs2 (inv_1 r_15))) (= r_15 r_15))  (and (U_2_bool (MapType2Select xs3 (inv_2 r_15))) (= r_15 r_15)) p_11 p_11 p_11 p_11) (U_2_real (MapType1Select Mask@0 r_15 f_7))))
 :qid |stdinbpl.785:20|
 :skolemid |103|
 :pattern ( (inv_3 r_15))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 67) 13) anon85_Then_correct) (=> (= (ControlFlow 0 67) 66) anon85_Else_correct))))))
(let ((anon84_Then_correct true))
(let ((anon83_Else_correct  (=> (forall ((r_13 T@U) ) (!  (=> (and (= (type r_13) RefType) (U_2_bool (MapType2Select xs4 (inv_3 r_13)))) (= (inv_3 r_13) r_13))
 :qid |stdinbpl.767:20|
 :skolemid |102|
 :pattern ( (inv_3 r_13))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 68) 12) anon84_Then_correct) (=> (= (ControlFlow 0 68) 67) anon84_Else_correct))))))
(let ((anon83_Then_correct true))
(let ((anon82_Else_correct  (=> (forall ((x4_1 T@U) ) (!  (=> (and (= (type x4_1) RefType) (U_2_bool (MapType2Select xs4 x4_1))) (= (inv_3 x4_1) x4_1))
 :qid |stdinbpl.754:20|
 :skolemid |101|
 :pattern ( (MapType0Select Heap@@9 x4_1 f_7))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 69) 11) anon83_Then_correct) (=> (= (ControlFlow 0 69) 68) anon83_Else_correct))))))
(let ((anon82_Then_correct true))
(let ((anon81_Else_correct  (=> (forall ((r_11 T@U) ) (!  (=> (and (= (type r_11) RefType) (U_2_bool (MapType2Select xs3 (inv_2 r_11)))) (<= (__iar__assume_helper_2  (and (U_2_bool (MapType2Select xs1 (inv_0 r_11))) (= r_11 r_11))  (and (U_2_bool (MapType2Select xs2 (inv_1 r_11))) (= r_11 r_11)) p_11 p_11 p_11) (U_2_real (MapType1Select Mask@0 r_11 f_7))))
 :qid |stdinbpl.741:20|
 :skolemid |100|
 :pattern ( (inv_2 r_11))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 70) 10) anon82_Then_correct) (=> (= (ControlFlow 0 70) 69) anon82_Else_correct))))))
(let ((anon81_Then_correct true))
(let ((anon80_Else_correct  (=> (forall ((r_9 T@U) ) (!  (=> (and (= (type r_9) RefType) (U_2_bool (MapType2Select xs3 (inv_2 r_9)))) (= (inv_2 r_9) r_9))
 :qid |stdinbpl.723:20|
 :skolemid |99|
 :pattern ( (inv_2 r_9))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 71) 9) anon81_Then_correct) (=> (= (ControlFlow 0 71) 70) anon81_Else_correct))))))
(let ((anon80_Then_correct true))
(let ((anon79_Else_correct  (=> (forall ((x3_1 T@U) ) (!  (=> (and (= (type x3_1) RefType) (U_2_bool (MapType2Select xs3 x3_1))) (= (inv_2 x3_1) x3_1))
 :qid |stdinbpl.710:20|
 :skolemid |98|
 :pattern ( (MapType0Select Heap@@9 x3_1 f_7))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 72) 8) anon80_Then_correct) (=> (= (ControlFlow 0 72) 71) anon80_Else_correct))))))
(let ((anon79_Then_correct true))
(let ((anon78_Else_correct  (=> (forall ((r_7 T@U) ) (!  (=> (and (= (type r_7) RefType) (U_2_bool (MapType2Select xs2 (inv_1 r_7)))) (<= (__iar__assume_helper_1  (and (U_2_bool (MapType2Select xs1 (inv_0 r_7))) (= r_7 r_7)) p_11 p_11) (U_2_real (MapType1Select Mask@0 r_7 f_7))))
 :qid |stdinbpl.697:20|
 :skolemid |97|
 :pattern ( (inv_1 r_7))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 73) 7) anon79_Then_correct) (=> (= (ControlFlow 0 73) 72) anon79_Else_correct))))))
(let ((anon78_Then_correct true))
(let ((anon77_Else_correct  (=> (forall ((r_5 T@U) ) (!  (=> (and (= (type r_5) RefType) (U_2_bool (MapType2Select xs2 (inv_1 r_5)))) (= (inv_1 r_5) r_5))
 :qid |stdinbpl.681:20|
 :skolemid |96|
 :pattern ( (inv_1 r_5))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 74) 6) anon78_Then_correct) (=> (= (ControlFlow 0 74) 73) anon78_Else_correct))))))
(let ((anon77_Then_correct true))
(let ((anon76_Else_correct  (=> (forall ((x2_1 T@U) ) (!  (=> (and (= (type x2_1) RefType) (U_2_bool (MapType2Select xs2 x2_1))) (= (inv_1 x2_1) x2_1))
 :qid |stdinbpl.668:20|
 :skolemid |95|
 :pattern ( (MapType0Select Heap@@9 x2_1 f_7))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 75) 5) anon77_Then_correct) (=> (= (ControlFlow 0 75) 74) anon77_Else_correct))))))
(let ((anon76_Then_correct true))
(let ((anon75_Else_correct  (=> (forall ((r_3 T@U) ) (!  (=> (and (= (type r_3) RefType) (U_2_bool (MapType2Select xs1 (inv_0 r_3)))) (<= p_11 (U_2_real (MapType1Select Mask@0 r_3 f_7))))
 :qid |stdinbpl.655:20|
 :skolemid |94|
 :pattern ( (inv_0 r_3))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 76) 4) anon76_Then_correct) (=> (= (ControlFlow 0 76) 75) anon76_Else_correct))))))
(let ((anon75_Then_correct true))
(let ((anon74_Else_correct  (=> (forall ((r_1_1 T@U) ) (!  (=> (and (= (type r_1_1) RefType) (U_2_bool (MapType2Select xs1 (inv_0 r_1_1)))) (= (inv_0 r_1_1) r_1_1))
 :qid |stdinbpl.642:20|
 :skolemid |93|
 :pattern ( (inv_0 r_1_1))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 77) 3) anon75_Then_correct) (=> (= (ControlFlow 0 77) 76) anon75_Else_correct))))))
(let ((anon74_Then_correct true))
(let ((anon73_Else_correct  (=> (forall ((x1_1 T@U) ) (!  (=> (and (= (type x1_1) RefType) (U_2_bool (MapType2Select xs1 x1_1))) (= (inv_0 x1_1) x1_1))
 :qid |stdinbpl.629:20|
 :skolemid |92|
 :pattern ( (MapType0Select Heap@@9 x1_1 f_7))
)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 78) 2) anon74_Then_correct) (=> (= (ControlFlow 0 78) 77) anon74_Else_correct))))))
(let ((anon73_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@19 $allocated))) (and (<= NoPerm p_11) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 79) (- 0 80)) (>= p_11 NoPerm)) (=> (>= p_11 NoPerm) (=> (=> (> p_11 NoPerm) (not (= x@@19 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask x@@19 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@19 f_7)) p_11)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 79) 1) anon73_Then_correct) (=> (= (ControlFlow 0 79) 78) anon73_Else_correct)))))))))
