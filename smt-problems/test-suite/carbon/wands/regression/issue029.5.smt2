...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Ops_1Heap) (MapType0Type RefType)) (= (type Ops_1Mask@1) (MapType1Type RefType realType))) (= (type newPMask@1) (MapType1Type RefType boolType))) (= (type Ops_1Heap@2) (MapType0Type RefType))) (= (type UnfoldingMask) (MapType1Type RefType realType))) (= (type UnfoldingMask@3) (MapType1Type RefType realType))) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (forall ((arg0@@47 T@U) ) (! (= (type (FrameFragment arg0@@47)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@47))
))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Ops_1Heap@0) (MapType0Type RefType))) (= (type Ops_1Heap@1) (MapType0Type RefType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type Ops_1Mask@0) (MapType1Type RefType realType))) (= (type Heap@@13) (MapType0Type RefType))) (= (type UsedHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((anon17_correct true))
(let ((anon16_correct  (=> (and (= b_1_1@16  (and b_1_1 (state Ops_1Heap Ops_1Mask@1))) (= (ControlFlow 0 4) 1)) anon17_correct)))
(let ((anon26_Else_correct  (=> (and (not b_2@@5) (= (ControlFlow 0 6) 4)) anon16_correct)))
(let ((anon26_Then_correct  (=> (and (and b_2@@5 (= b_1_1@15  (and b_1_1@14 (forall ((o_4 T@U) (f_8 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_8))))
(let ((A@@12 (FieldTypeInv0 (type f_8))))
 (=> (and (and (= (type o_4) RefType) (= (type f_8) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Ops_1Heap null (|Q#sm| b_2@@5)) o_4 f_8)) (U_2_bool (MapType1Select (MapType0Select Ops_1Heap null |P#sm|) o_4 f_8)))) (U_2_bool (MapType1Select newPMask@1 o_4 f_8)))))
 :qid |stdinbpl.683:46|
 :skolemid |77|
 :pattern ( (MapType1Select newPMask@1 o_4 f_8))
))))) (and (= Ops_1Heap@2 (MapType0Store Ops_1Heap null (|Q#sm| b_2@@5) newPMask@1)) (= (ControlFlow 0 5) 4))) anon16_correct)))
(let ((anon14_correct  (=> (= b_1_1@14  (and b_1_1 (state Ops_1Heap UnfoldingMask))) (and (=> (= (ControlFlow 0 7) 5) anon26_Then_correct) (=> (= (ControlFlow 0 7) 6) anon26_Else_correct)))))
(let ((anon25_Else_correct  (=> (and (not b_2@@5) (= (ControlFlow 0 9) 7)) anon14_correct)))
(let ((anon25_Then_correct  (=> b_2@@5 (=> (and (and (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 null P (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 null P)) FullPerm)))) (= b_1_1@12  (and b_1_1@11 (InsidePredicate (Q b_2@@5) (MapType0Select Ops_1Heap null (Q b_2@@5)) P (MapType0Select Ops_1Heap null P))))) (and (= b_1_1@13  (and b_1_1@12 (state Ops_1Heap UnfoldingMask@3))) (= (ControlFlow 0 8) 7))) anon14_correct))))
(let ((anon12_correct  (=> (= b_1_1@10  (and b_1_1 (|Q#trigger| Ops_1Heap (Q b_2@@5)))) (=> (and (= b_1_1@11  (and b_1_1@10 (= (MapType0Select Ops_1Heap null (Q b_2@@5)) (FrameFragment (ite b_2@@5 (MapType0Select Ops_1Heap null P) EmptyFrame))))) (= UnfoldingMask@2 (MapType1Store Ops_1Mask@1 null (Q b_2@@5) (real_2_U (- (U_2_real (MapType1Select Ops_1Mask@1 null (Q b_2@@5))) FullPerm))))) (and (=> (= (ControlFlow 0 10) 8) anon25_Then_correct) (=> (= (ControlFlow 0 10) 9) anon25_Else_correct))))))
(let ((anon11_correct  (=> (and (= b_1_1@9  (and b_1_1 (state Ops_1Heap Ops_1Mask@1))) (= (ControlFlow 0 12) 10)) anon12_correct)))
(let ((anon24_Else_correct  (=> (and (not b_2@@5) (= (ControlFlow 0 14) 12)) anon11_correct)))
(let ((anon24_Then_correct  (=> (and (and b_2@@5 (= b_1_1@8  (and b_1_1@7 (forall ((o_3 T@U) (f_7 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_7))))
(let ((A@@13 (FieldTypeInv0 (type f_7))))
 (=> (and (and (= (type o_3) RefType) (= (type f_7) (FieldType A@@13 B@@12))) (or (U_2_bool (MapType1Select (MapType0Select Ops_1Heap@0 null (|Q#sm| b_2@@5)) o_3 f_7)) (U_2_bool (MapType1Select (MapType0Select Ops_1Heap@0 null |P#sm|) o_3 f_7)))) (U_2_bool (MapType1Select newPMask@0 o_3 f_7)))))
 :qid |stdinbpl.650:50|
 :skolemid |76|
 :pattern ( (MapType1Select newPMask@0 o_3 f_7))
))))) (and (= Ops_1Heap@1 (MapType0Store Ops_1Heap@0 null (|Q#sm| b_2@@5) newPMask@0)) (= (ControlFlow 0 13) 12))) anon11_correct)))
(let ((anon9_correct  (=> (= b_1_1@7  (and b_1_1 (state Ops_1Heap@0 UnfoldingMask))) (and (=> (= (ControlFlow 0 15) 13) anon24_Then_correct) (=> (= (ControlFlow 0 15) 14) anon24_Else_correct)))))
(let ((anon23_Else_correct  (=> (and (not b_2@@5) (= (ControlFlow 0 17) 15)) anon9_correct)))
(let ((anon23_Then_correct  (=> b_2@@5 (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 null P (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 null P)) FullPerm)))) (= b_1_1@5  (and b_1_1@4 (InsidePredicate (Q b_2@@5) (MapType0Select Ops_1Heap@0 null (Q b_2@@5)) P (MapType0Select Ops_1Heap@0 null P))))) (and (= b_1_1@6  (and b_1_1@5 (state Ops_1Heap@0 UnfoldingMask@1))) (= (ControlFlow 0 16) 15))) anon9_correct))))
(let ((anon7_correct  (=> (= UnfoldingMask@0 (MapType1Store Ops_1Mask@1 null (Q b_2@@5) (real_2_U (- (U_2_real (MapType1Select Ops_1Mask@1 null (Q b_2@@5))) FullPerm)))) (and (=> (= (ControlFlow 0 18) 16) anon23_Then_correct) (=> (= (ControlFlow 0 18) 17) anon23_Else_correct)))))
(let ((anon22_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 21) 18)) anon7_correct)))
(let ((anon22_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (<= FullPerm (U_2_real (MapType1Select Ops_1Mask@1 null (Q b_2@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select Ops_1Mask@1 null (Q b_2@@5)))) (=> (= (ControlFlow 0 19) 18) anon7_correct))))))
(let ((anon21_Then_correct  (=> b_1_1@2 (=> (and (= b_1_1@3  (and b_1_1@2 (|Q#trigger| Ops_1Heap@0 (Q b_2@@5)))) (= b_1_1@4  (and b_1_1@3 (= (MapType0Select Ops_1Heap@0 null (Q b_2@@5)) (FrameFragment (ite b_2@@5 (MapType0Select Ops_1Heap@0 null P) EmptyFrame)))))) (and (=> (= (ControlFlow 0 22) 19) anon22_Then_correct) (=> (= (ControlFlow 0 22) 21) anon22_Else_correct))))))
(let ((anon21_Else_correct  (=> (and (not b_1_1@2) (= (ControlFlow 0 11) 10)) anon12_correct)))
(let ((anon20_Then_correct  (=> b_1_1@2 (and (=> (= (ControlFlow 0 23) 22) anon21_Then_correct) (=> (= (ControlFlow 0 23) 11) anon21_Else_correct)))))
(let ((anon20_Else_correct  (=> (and (not b_1_1@2) (= (ControlFlow 0 3) 1)) anon17_correct)))
(let ((anon19_Else_correct  (=> (not b_1_1@0) (=> (and (= Ops_1Mask@1 ZeroMask) (= b_1_1@2 b_1_1@0)) (and (=> (= (ControlFlow 0 25) 23) anon20_Then_correct) (=> (= (ControlFlow 0 25) 3) anon20_Else_correct))))))
(let ((anon19_Then_correct  (=> b_1_1@0 (=> (and (and (= Ops_1Mask@0 (MapType1Store ZeroMask null (Q b_2@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Q b_2@@5))) FullPerm)))) (= b_1_1@1  (and b_1_1@0 (state Ops_1Heap@0 Ops_1Mask@0)))) (and (= Ops_1Mask@1 Ops_1Mask@0) (= b_1_1@2 b_1_1@1))) (and (=> (= (ControlFlow 0 24) 23) anon20_Then_correct) (=> (= (ControlFlow 0 24) 3) anon20_Else_correct))))))
(let ((anon18_Then_correct  (=> b_1_1@0 (and (=> (= (ControlFlow 0 26) 24) anon19_Then_correct) (=> (= (ControlFlow 0 26) 25) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (and (not b_1_1@0) (= (ControlFlow 0 2) 1)) anon17_correct)))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (= b_1_1@0  (and b_1_1 (state Ops_1Heap@0 ZeroMask))) (= b_3@0  (and b_3 (state UsedHeap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 27) 26) anon18_Then_correct) (=> (= (ControlFlow 0 27) 2) anon18_Else_correct))))))
