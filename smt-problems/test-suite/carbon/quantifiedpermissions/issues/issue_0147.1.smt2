...
(declare-fun |idx'| (T@U Int Int T@U Int) Int)
(declare-fun AssumeFunctionsAbove () Int)
(declare-fun |idx#trigger| (T@U Int Int T@U Int) Bool)
(declare-fun EmptyFrame () T@U)
(declare-fun |Seq#Append| (T@U T@U) T@U)
(declare-fun sumMask (T@U T@U T@U) Bool)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |idx#triggerStateless| (Int Int T@U Int) Int)
(declare-fun ConditionalFrame (Real T@U) T@U)
(declare-fun NoPerm () Real)
(declare-fun idx (T@U Int Int T@U Int) Int)
(declare-fun |idx#frame| (T@U Int Int T@U Int) Int)
...
(assert (forall ((Heap@@4 T@U) (Mask@@4 T@U) (a_2 Int) (b_2 Int) (c T@U) (n@@5 Int) ) (!  (=> (and (and (and (= (type Heap@@4) (MapType0Type RefType)) (= (type Mask@@4) (MapType1Type RefType realType))) (= (type c) RefType)) (and (state Heap@@4 Mask@@4) (or (< AssumeFunctionsAbove 0) (|idx#trigger| EmptyFrame a_2 b_2 c n@@5)))) (and (<= 0 (|idx'| Heap@@4 a_2 b_2 c n@@5)) (< (|idx'| Heap@@4 a_2 b_2 c n@@5) n@@5)))
 :qid |stdinbpl.587:15|
 :skolemid |61|
 :pattern ( (state Heap@@4 Mask@@4) (|idx'| Heap@@4 a_2 b_2 c n@@5))
)))
...
(assert (forall ((Heap@@5 T@U) (ExhaleHeap@@3 T@U) (Mask@@5 T@U) ) (!  (=> (and (and (and (= (type Heap@@5) (MapType0Type RefType)) (= (type ExhaleHeap@@3) (MapType0Type RefType))) (= (type Mask@@5) (MapType1Type RefType realType))) (IdenticalOnKnownLocations Heap@@5 ExhaleHeap@@3 Mask@@5)) (succHeap Heap@@5 ExhaleHeap@@3))
 :qid |stdinbpl.83:15|
 :skolemid |10|
 :pattern ( (IdenticalOnKnownLocations Heap@@5 ExhaleHeap@@3 Mask@@5))
)))
...
(assert (forall ((Heap@@6 T@U) (a_2@@0 Int) (b_2@@0 Int) (c@@0 T@U) (n@@7 Int) ) (!  (=> (and (= (type Heap@@6) (MapType0Type RefType)) (= (type c@@0) RefType)) (dummyFunction (int_2_U (|idx#triggerStateless| a_2@@0 b_2@@0 c@@0 n@@7))))
 :qid |stdinbpl.574:15|
 :skolemid |59|
 :pattern ( (|idx'| Heap@@6 a_2@@0 b_2@@0 c@@0 n@@7))
)))
...
(assert (forall ((Heap@@7 T@U) (a_2@@1 Int) (b_2@@1 Int) (c@@1 T@U) (n@@9 Int) ) (!  (=> (and (= (type Heap@@7) (MapType0Type RefType)) (= (type c@@1) RefType)) (and (= (idx Heap@@7 a_2@@1 b_2@@1 c@@1 n@@9) (|idx'| Heap@@7 a_2@@1 b_2@@1 c@@1 n@@9)) (dummyFunction (int_2_U (|idx#triggerStateless| a_2@@1 b_2@@1 c@@1 n@@9)))))
 :qid |stdinbpl.570:15|
 :skolemid |58|
 :pattern ( (idx Heap@@7 a_2@@1 b_2@@1 c@@1 n@@9))
)))
...
(assert (forall ((Heap@@8 T@U) (Mask@@7 T@U) (a_2@@2 Int) (b_2@@2 Int) (c@@2 T@U) (n@@10 Int) ) (!  (=> (and (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (= (type c@@2) RefType)) (state Heap@@8 Mask@@7)) (= (|idx'| Heap@@8 a_2@@2 b_2@@2 c@@2 n@@10) (|idx#frame| EmptyFrame a_2@@2 b_2@@2 c@@2 n@@10)))
 :qid |stdinbpl.581:15|
 :skolemid |60|
 :pattern ( (state Heap@@8 Mask@@7) (|idx'| Heap@@8 a_2@@2 b_2@@2 c@@2 n@@10))
)))
(assert (forall ((s@@7 T@U) (t@@0 T@U) (n@@11 Int) ) (! (let ((T@@18 (SeqTypeInv0 (type s@@7))))
 (=> (and (and (= (type s@@7) (SeqType T@@18)) (= (type t@@0) (SeqType T@@18))) (and (> n@@11 0) (> n@@11 (|Seq#Length| s@@7)))) (and (= (|Seq#Add| (|Seq#Sub| n@@11 (|Seq#Length| s@@7)) (|Seq#Length| s@@7)) n@@11) (= (|Seq#Take| (|Seq#Append| s@@7 t@@0) n@@11) (|Seq#Append| s@@7 (|Seq#Take| t@@0 (|Seq#Sub| n@@11 (|Seq#Length| s@@7))))))))
 :qid |stdinbpl.368:18|
 :skolemid |42|
 :pattern ( (|Seq#Take| (|Seq#Append| s@@7 t@@0) n@@11))
)))
...
(assert (forall ((s@@10 T@U) (t@@3 T@U) (n@@12 Int) ) (! (let ((T@@24 (SeqTypeInv0 (type s@@10))))
 (=> (and (and (= (type s@@10) (SeqType T@@24)) (= (type t@@3) (SeqType T@@24))) (and (< 0 n@@12) (<= n@@12 (|Seq#Length| s@@10)))) (= (|Seq#Take| (|Seq#Append| s@@10 t@@3) n@@12) (|Seq#Take| s@@10 n@@12))))
 :qid |stdinbpl.364:18|
 :skolemid |41|
 :pattern ( (|Seq#Take| (|Seq#Append| s@@10 t@@3) n@@12))
)))
...
(declare-fun i1 () Int)
(declare-fun i2 () Int)
(assert  (and (and (= (type xs) (SeqType RefType)) (= (type Heap@@13) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 35) (let ((anon24_Else_correct  (and (=> (= (ControlFlow 0 25) (- 0 28)) (>= (idx Heap@@13 5 2 (|Seq#Index| xs 3) n@@17) 0)) (=> (>= (idx Heap@@13 5 2 (|Seq#Index| xs 3) n@@17) 0) (and (=> (= (ControlFlow 0 25) (- 0 27)) (< (idx Heap@@13 5 2 (|Seq#Index| xs 3) n@@17) (|Seq#Length| xs))) (=> (< (idx Heap@@13 5 2 (|Seq#Index| xs 3) n@@17) (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 25) (- 0 26)) (HasDirectPerm QPMask@0 (|Seq#Index| xs (idx Heap@@13 5 2 (|Seq#Index| xs 3) n@@17)) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs (idx Heap@@13 5 2 (|Seq#Index| xs 3) n@@17)) f_7) (=> (= (ControlFlow 0 25) (- 0 24)) (= (U_2_int (MapType0Select Heap@@13 (|Seq#Index| xs (idx Heap@@13 5 2 (|Seq#Index| xs 3) n@@17)) f_7)) 7))))))))))
(let ((anon24_Then_correct true))
(let ((anon21_Else_correct  (=> (forall ((i_3 Int) (j_1 Int) (fresh__2_1 Int) ) (!  (=> (and (<= 0 i_3) (and (< i_3 n@@17) (and (<= 0 j_1) (< j_1 i_3)))) (= (U_2_int (MapType0Select Heap@@13 (|Seq#Index| xs (idx Heap@@13 i_3 j_1 (|Seq#Index| xs (+ j_1 1)) n@@17)) f_7)) (+ i_3 j_1)))
 :qid |stdinbpl.757:20|
 :skolemid |69|
 :pattern ( (|Seq#Index| xs (|idx#frame| EmptyFrame i_3 j_1 (|Seq#Index| xs fresh__2_1) n@@17)))
)) (=> (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (< 3 (|Seq#Length| xs))) (=> (< 3 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 29) 23) anon24_Then_correct) (=> (= (ControlFlow 0 29) 25) anon24_Else_correct))))))))
(let ((anon23_Then_correct true))
(let ((anon13_correct true))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 19)) (>= (idx Heap@@13 i_2 j@@5 (|Seq#Index| xs (+ j@@5 1)) n@@17) 0)) (=> (>= (idx Heap@@13 i_2 j@@5 (|Seq#Index| xs (+ j@@5 1)) n@@17) 0) (and (=> (= (ControlFlow 0 16) (- 0 18)) (< (idx Heap@@13 i_2 j@@5 (|Seq#Index| xs (+ j@@5 1)) n@@17) (|Seq#Length| xs))) (=> (< (idx Heap@@13 i_2 j@@5 (|Seq#Index| xs (+ j@@5 1)) n@@17) (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm QPMask@0 (|Seq#Index| xs (idx Heap@@13 i_2 j@@5 (|Seq#Index| xs (+ j@@5 1)) n@@17)) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs (idx Heap@@13 i_2 j@@5 (|Seq#Index| xs (+ j@@5 1)) n@@17)) f_7) (=> (= (ControlFlow 0 16) 13) anon13_correct)))))))))
(let ((anon22_Then_correct  (=> (and (<= 0 i_2) (and (< i_2 n@@17) (and (<= 0 j@@5) (< j@@5 i_2)))) (and (=> (= (ControlFlow 0 20) (- 0 22)) (>= (+ j@@5 1) 0)) (=> (>= (+ j@@5 1) 0) (and (=> (= (ControlFlow 0 20) (- 0 21)) (< (+ j@@5 1) (|Seq#Length| xs))) (=> (< (+ j@@5 1) (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 20) 15) anon23_Then_correct) (=> (= (ControlFlow 0 20) 16) anon23_Else_correct)))))))))
(let ((anon22_Else_correct  (=> (and (not (and (<= 0 i_2) (and (< i_2 n@@17) (and (<= 0 j@@5) (< j@@5 i_2))))) (= (ControlFlow 0 14) 13)) anon13_correct)))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 32)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 n@@17))) (and (<= 0 i_1_1) (< i_1_1 n@@17))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_1) (|Seq#Index| xs i_1_1))))
 :qid |stdinbpl.696:15|
 :skolemid |63|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= 0 i_1@@0) (< i_1@@0 n@@17))) (and (<= 0 i_1_1@@0) (< i_1_1@@0 n@@17))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_1@@0) (|Seq#Index| xs i_1_1@@0))))
 :qid |stdinbpl.696:15|
 :skolemid |63|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 n@@17)) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index| xs i_1@@1)) (= (invRecv1 (|Seq#Index| xs i_1@@1)) i_1@@1)))
 :qid |stdinbpl.702:22|
 :skolemid |64|
 :pattern ( (|Seq#Index| xs i_1@@1))
 :pattern ( (|Seq#Index| xs i_1@@1))
)) (=> (and (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv1 o_3)) (< (invRecv1 o_3) n@@17)) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (|Seq#Index| xs (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.706:22|
 :skolemid |65|
 :pattern ( (invRecv1 o_3))
)) (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (< i_1@@2 n@@17)) (not (= (|Seq#Index| xs i_1@@2) null)))
 :qid |stdinbpl.712:22|
 :skolemid |66|
 :pattern ( (|Seq#Index| xs i_1@@2))
 :pattern ( (|Seq#Index| xs i_1@@2))
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) n@@17)) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| xs (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) n@@17)) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.718:22|
 :skolemid |67|
...
)))) (and (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)))) (and (and (=> (= (ControlFlow 0 31) 29) anon21_Else_correct) (=> (= (ControlFlow 0 31) 20) anon22_Then_correct)) (=> (= (ControlFlow 0 31) 14) anon22_Else_correct))))))))
(let ((anon7_correct true))
(let ((anon20_Else_correct  (=> (and (not (and (<= 0 i@@6) (< i@@6 n@@17))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon20_Then_correct  (=> (and (<= 0 i@@6) (< i@@6 n@@17)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i@@6 (|Seq#Length| xs))) (=> (< i@@6 (|Seq#Length| xs)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon17_Else_correct  (=> (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@17) (int_2_U i1_1)) (and (|Seq#Contains| (|Seq#Range| 0 n@@17) (int_2_U i2_1)) (not (= i1_1 i2_1)))) (not (= (|Seq#Index| xs i1_1) (|Seq#Index| xs i2_1))))
 :qid |stdinbpl.675:20|
 :skolemid |62|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@17) (int_2_U i1_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@17) (int_2_U i2_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@17) (int_2_U i1_1)) (|Seq#Contains| (|Seq#Range| 0 n@@17) (int_2_U i2_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@17) (int_2_U i1_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@17) (int_2_U i2_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@17) (int_2_U i1_1)) (|Seq#Contains| (|Seq#Range| 0 n@@17) (int_2_U i2_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@17) (int_2_U i1_1)) (|Seq#Index| xs i2_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@17) (int_2_U i1_1)) (|Seq#Index| xs i2_1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@17) (int_2_U i2_1)) (|Seq#Index| xs i1_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@17) (int_2_U i2_1)) (|Seq#Index| xs i1_1))
 :pattern ( (|Seq#Index| xs i1_1) (|Seq#Index| xs i2_1))
)) (=> (and (state Heap@@13 ZeroMask) (state Heap@@13 ZeroMask)) (and (and (=> (= (ControlFlow 0 33) 31) anon19_Else_correct) (=> (= (ControlFlow 0 33) 9) anon20_Then_correct)) (=> (= (ControlFlow 0 33) 12) anon20_Else_correct))))))
(let ((anon3_correct true))
(let ((anon18_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 n@@17) (int_2_U i1)) (and (|Seq#Contains| (|Seq#Range| 0 n@@17) (int_2_U i2)) (not (= i1 i2))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon18_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@17) (int_2_U i1)) (and (|Seq#Contains| (|Seq#Range| 0 n@@17) (int_2_U i2)) (not (= i1 i2)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1 0)) (=> (>= i1 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1 (|Seq#Length| xs))) (=> (< i1 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2 0)) (=> (>= i2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2 (|Seq#Length| xs))) (=> (< i2 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (< 10 n@@17) (state Heap@@13 ZeroMask))) (and (and (state Heap@@13 ZeroMask) (<= n@@17 (|Seq#Length| xs))) (and (state Heap@@13 ZeroMask) (state Heap@@13 ZeroMask)))) (and (and (=> (= (ControlFlow 0 34) 33) anon17_Else_correct) (=> (= (ControlFlow 0 34) 2) anon18_Then_correct)) (=> (= (ControlFlow 0 34) 7) anon18_Else_correct)))))
