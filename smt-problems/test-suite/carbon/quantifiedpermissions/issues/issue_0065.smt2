...
(declare-fun i@@6 () Int)
(declare-fun j@@5 () Int)
(assert  (and (and (and (= (type S) (SeqType RefType)) (= (type PostHeap@0) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id m)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon17_Else_correct  (=> (= (ControlFlow 0 16) (- 0 15)) false)))
(let ((anon17_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (= (ControlFlow 0 14) (- 0 13))) (< 0 (|Seq#Length| S)))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 19)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i_3))) (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i_3_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index| S i_3) (|Seq#Index| S i_3_1))))
 :qid |stdinbpl.628:15|
 :skolemid |59|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i_3@@0))) (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i_3_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index| S i_3@@0) (|Seq#Index| S i_3_1@@0))))
 :qid |stdinbpl.628:15|
 :skolemid |59|
)) (=> (and (forall ((i_3@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i_3@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange1 (|Seq#Index| S i_3@@1)) (= (invRecv1 (|Seq#Index| S i_3@@1)) i_3@@1)))
 :qid |stdinbpl.634:22|
 :skolemid |60|
 ...
 :pattern ( (|Seq#Index| S i_3@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U (invRecv1 o_3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_3)) (= (|Seq#Index| S (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.638:22|
 :skolemid |61|
 :pattern ( (invRecv1 o_3))
))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((i_3@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i_3@@2)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.644:15|
 :skolemid |62|
 ...
 :pattern ( (|Seq#Index| S i_3@@2))
))) (=> (forall ((i_3@@3 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i_3@@3)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.644:15|
 :skolemid |62|
 :pattern ( (|Seq#Index| S i_3@@3))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 2) (int_2_U i_3@@3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i_3@@3)))
 :pattern ( (|Seq#Index| S i_3@@3))
)) (=> (forall ((i_3@@4 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i_3@@4)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (|Seq#Index| S i_3@@4) null)))
 :qid |stdinbpl.650:22|
 :skolemid |63|
 :pattern ( (|Seq#Index| S i_3@@4))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 2) (int_2_U i_3@@4)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i_3@@4)))
 :pattern ( (|Seq#Index| S i_3@@4))
)) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U (invRecv1 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_3@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index| S (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U (invRecv1 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.656:22|
 :skolemid |64|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 17) 14) anon17_Then_correct) (=> (= (ControlFlow 0 17) 16) anon17_Else_correct)))))))))))
(let ((anon7_correct true))
(let ((anon16_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i_2))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon16_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i_2)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_2 (|Seq#Length| S))) (=> (< i_2 (|Seq#Length| S)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon13_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (<= 0 i_1) (and (< i_1 j_1) (< j_1 (|Seq#Length| S)))) (not (= (|Seq#Index| S i_1) (|Seq#Index| S j_1))))
 :qid |stdinbpl.610:20|
 :skolemid |58|
 :pattern ( (|Seq#Index| S i_1) (|Seq#Index| S j_1))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 20) 17) anon15_Else_correct) (=> (= (ControlFlow 0 20) 9) anon16_Then_correct)) (=> (= (ControlFlow 0 20) 12) anon16_Else_correct)))))
(let ((anon3_correct true))
(let ((anon14_Else_correct  (=> (and (not (and (<= 0 i@@6) (and (< i@@6 j@@5) (< j@@5 (|Seq#Length| S))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon14_Then_correct  (=> (and (<= 0 i@@6) (and (< i@@6 j@@5) (< j@@5 (|Seq#Length| S)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i@@6 (|Seq#Length| S))) (=> (< i@@6 (|Seq#Length| S)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j@@5 (|Seq#Length| S))) (=> (< j@@5 (|Seq#Length| S)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= (|Seq#Length| S) 2) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 21) (- 0 23)) (< 0 (|Seq#Length| S))) (=> (< 0 (|Seq#Length| S)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (< 1 (|Seq#Length| S))) (=> (< 1 (|Seq#Length| S)) (=> (and (= (|Seq#Index| S 0) (|Seq#Index| S 1)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 21) 20) anon13_Else_correct) (=> (= (ControlFlow 0 21) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 21) 7) anon14_Else_correct)))))))))))
