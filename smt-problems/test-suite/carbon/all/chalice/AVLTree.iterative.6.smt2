...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 49) (let ((anon30_correct true))
(let ((anon45_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon30_correct)))
(let ((anon45_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@8 null (valid1 this@@53))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@8 null (valid1 this@@53)))) (=> (= (ControlFlow 0 3) 2) anon30_correct))))))
(let ((anon28_correct  (=> (and (state Heap@10 Mask@8) (state Heap@10 Mask@8)) (and (=> (= (ControlFlow 0 6) 3) anon45_Then_correct) (=> (= (ControlFlow 0 6) 5) anon45_Else_correct)))))
(let ((anon44_Else_correct  (=> (= (MapType0Select Heap@8 this@@53 root1) null) (=> (and (= Heap@10 Heap@8) (= (ControlFlow 0 8) 6)) anon28_correct))))
(let ((anon44_Then_correct  (=> (and (and (not (= (MapType0Select Heap@8 this@@53 root1) null)) (= Heap@9 (MapType0Store Heap@8 null (|valid1#sm| this@@53) (MapType1Store (MapType0Select Heap@8 null (|valid1#sm| this@@53)) (MapType0Select Heap@8 this@@53 root1) root (bool_2_U true))))) (and (= Heap@10 Heap@9) (= (ControlFlow 0 7) 6))) anon28_correct)))
(let ((anon43_Else_correct  (=> (and (= (MapType0Select Heap@6 this@@53 root1) null) (= Heap@8 Heap@6)) (and (=> (= (ControlFlow 0 10) 7) anon44_Then_correct) (=> (= (ControlFlow 0 10) 8) anon44_Else_correct)))))
(let ((anon43_Then_correct  (=> (not (= (MapType0Select Heap@6 this@@53 root1) null)) (=> (and (= Heap@7 (MapType0Store Heap@6 null (|valid1#sm| this@@53) (MapType1Store (MapType0Select Heap@6 null (|valid1#sm| this@@53)) (MapType0Select Heap@6 this@@53 root1) parent (bool_2_U true)))) (= Heap@8 Heap@7)) (and (=> (= (ControlFlow 0 9) 7) anon44_Then_correct) (=> (= (ControlFlow 0 9) 8) anon44_Else_correct))))))
(let ((anon42_Else_correct  (=> (and (= (MapType0Select Heap@4 this@@53 root1) null) (= Heap@6 Heap@4)) (and (=> (= (ControlFlow 0 12) 9) anon43_Then_correct) (=> (= (ControlFlow 0 12) 10) anon43_Else_correct)))))
(let ((anon42_Then_correct  (=> (and (and (not (= (MapType0Select Heap@4 this@@53 root1) null)) (forall ((o_3 T@U) (f_7 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_7))))
(let ((A@@12 (FieldTypeInv0 (type f_7))))
 (=> (and (and (= (type o_3) RefType) (= (type f_7) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@4 null (|valid1#sm| this@@53)) o_3 f_7)) (U_2_bool (MapType1Select (MapType0Select Heap@4 null (|valid#sm| (MapType0Select Heap@4 this@@53 root1))) o_3 f_7)))) (U_2_bool (MapType1Select newPMask@0 o_3 f_7)))))
 :qid |stdinbpl.1343:29|
 :skolemid |76|
 :pattern ( (MapType1Select newPMask@0 o_3 f_7))
))) (and (= Heap@5 (MapType0Store Heap@4 null (|valid1#sm| this@@53) newPMask@0)) (= Heap@6 Heap@5))) (and (=> (= (ControlFlow 0 11) 9) anon43_Then_correct) (=> (= (ControlFlow 0 11) 10) anon43_Else_correct)))))
(let ((anon22_correct  (=> (= Heap@4 (MapType0Store Heap@3 null (|valid1#sm| this@@53) (MapType1Store (MapType0Select Heap@3 null (|valid1#sm| this@@53)) this@@53 root1 (bool_2_U true)))) (and (=> (= (ControlFlow 0 13) 11) anon42_Then_correct) (=> (= (ControlFlow 0 13) 12) anon42_Else_correct)))))
(let ((anon41_Else_correct  (=> (HasDirectPerm Mask@8 null (valid1 this@@53)) (=> (and (= Heap@3 Heap@0) (= (ControlFlow 0 15) 13)) anon22_correct))))
(let ((anon41_Then_correct  (=> (not (HasDirectPerm Mask@8 null (valid1 this@@53))) (=> (and (and (= Heap@1 (MapType0Store Heap@0 null (|valid1#sm| this@@53) ZeroPMask)) (= Heap@2 (MapType0Store Heap@1 null (valid1 this@@53) freshVersion@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 14) 13))) anon22_correct))))
(let ((anon20_correct  (=> (= Mask@8 (MapType1Store Mask@7 null (valid1 this@@53) (real_2_U (+ (U_2_real (MapType1Select Mask@7 null (valid1 this@@53))) FullPerm)))) (=> (and (and (state Heap@0 Mask@8) (state Heap@0 Mask@8)) (and (|valid1#trigger| Heap@0 (valid1 this@@53)) (= (MapType0Select Heap@0 null (valid1 this@@53)) (CombineFrames (FrameFragment (MapType0Select Heap@0 this@@53 root1)) (CombineFrames (FrameFragment (ite (not (= (MapType0Select Heap@0 this@@53 root1) null)) (MapType0Select Heap@0 null (valid (MapType0Select Heap@0 this@@53 root1))) EmptyFrame)) (CombineFrames (FrameFragment (ite (not (= (MapType0Select Heap@0 this@@53 root1) null)) (FrameFragment (MapType0Select Heap@0 (MapType0Select Heap@0 this@@53 root1) parent)) EmptyFrame)) (CombineFrames (FrameFragment (ite (not (= (MapType0Select Heap@0 this@@53 root1) null)) EmptyFrame EmptyFrame)) (CombineFrames (FrameFragment (ite (not (= (MapType0Select Heap@0 this@@53 root1) null)) (FrameFragment (MapType0Select Heap@0 (MapType0Select Heap@0 this@@53 root1) root)) EmptyFrame)) (FrameFragment (ite (not (= (MapType0Select Heap@0 this@@53 root1) null)) EmptyFrame EmptyFrame)))))))))) (and (=> (= (ControlFlow 0 16) 14) anon41_Then_correct) (=> (= (ControlFlow 0 16) 15) anon41_Else_correct))))))
(let ((anon40_Else_correct  (=> (and (= (MapType0Select Heap@0 this@@53 root1) null) (= (ControlFlow 0 19) 16)) anon20_correct)))
(let ((anon40_Then_correct  (=> (not (= (MapType0Select Heap@0 this@@53 root1) null)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (= (MapType0Select Heap@0 (MapType0Select Heap@0 this@@53 root1) root) (MapType0Select Heap@0 this@@53 root1))) (=> (= (MapType0Select Heap@0 (MapType0Select Heap@0 this@@53 root1) root) (MapType0Select Heap@0 this@@53 root1)) (=> (= (ControlFlow 0 17) 16) anon20_correct))))))
(let ((anon17_correct  (=> (and (= Mask@6 (MapType1Store Mask@5 (MapType0Select Heap@0 this@@53 root1) root (real_2_U (- (U_2_real (MapType1Select Mask@5 (MapType0Select Heap@0 this@@53 root1) root)) perm@0)))) (= Mask@7 Mask@6)) (and (=> (= (ControlFlow 0 21) 17) anon40_Then_correct) (=> (= (ControlFlow 0 21) 19) anon40_Else_correct)))))
(let ((anon39_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 24) 21)) anon17_correct)))
(let ((anon39_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (<= perm@0 (U_2_real (MapType1Select Mask@5 (MapType0Select Heap@0 this@@53 root1) root)))) (=> (<= perm@0 (U_2_real (MapType1Select Mask@5 (MapType0Select Heap@0 this@@53 root1) root))) (=> (= (ControlFlow 0 22) 21) anon17_correct))))))
(let ((anon38_Then_correct  (=> (and (not (= (MapType0Select Heap@0 this@@53 root1) null)) (= perm@0 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 25) (- 0 26)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 25) 22) anon39_Then_correct) (=> (= (ControlFlow 0 25) 24) anon39_Else_correct)))))))
(let ((anon38_Else_correct  (=> (and (= (MapType0Select Heap@0 this@@53 root1) null) (= Mask@7 Mask@5)) (and (=> (= (ControlFlow 0 20) 17) anon40_Then_correct) (=> (= (ControlFlow 0 20) 19) anon40_Else_correct)))))
(let ((anon37_Else_correct  (=> (= (MapType0Select Heap@0 this@@53 root1) null) (and (=> (= (ControlFlow 0 29) 25) anon38_Then_correct) (=> (= (ControlFlow 0 29) 20) anon38_Else_correct)))))
(let ((anon37_Then_correct  (=> (not (= (MapType0Select Heap@0 this@@53 root1) null)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (= (MapType0Select Heap@0 (MapType0Select Heap@0 this@@53 root1) parent) null)) (=> (= (MapType0Select Heap@0 (MapType0Select Heap@0 this@@53 root1) parent) null) (and (=> (= (ControlFlow 0 27) 25) anon38_Then_correct) (=> (= (ControlFlow 0 27) 20) anon38_Else_correct)))))))
(let ((anon11_correct  (=> (and (= Mask@4 (MapType1Store Mask@3 (MapType0Select Heap@0 this@@53 root1) parent (real_2_U (- (U_2_real (MapType1Select Mask@3 (MapType0Select Heap@0 this@@53 root1) parent)) FullPerm)))) (= Mask@5 Mask@4)) (and (=> (= (ControlFlow 0 31) 27) anon37_Then_correct) (=> (= (ControlFlow 0 31) 29) anon37_Else_correct)))))
(let ((anon36_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 34) 31)) anon11_correct)))
(let ((anon36_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 32) (- 0 33)) (<= FullPerm (U_2_real (MapType1Select Mask@3 (MapType0Select Heap@0 this@@53 root1) parent)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 (MapType0Select Heap@0 this@@53 root1) parent))) (=> (= (ControlFlow 0 32) 31) anon11_correct))))))
(let ((anon35_Then_correct  (=> (not (= (MapType0Select Heap@0 this@@53 root1) null)) (and (=> (= (ControlFlow 0 35) 32) anon36_Then_correct) (=> (= (ControlFlow 0 35) 34) anon36_Else_correct)))))
(let ((anon35_Else_correct  (=> (and (= (MapType0Select Heap@0 this@@53 root1) null) (= Mask@5 Mask@3)) (and (=> (= (ControlFlow 0 30) 27) anon37_Then_correct) (=> (= (ControlFlow 0 30) 29) anon37_Else_correct)))))
(let ((anon7_correct  (=> (= Mask@2 (MapType1Store Mask@1 null (valid (MapType0Select Heap@0 this@@53 root1)) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (valid (MapType0Select Heap@0 this@@53 root1)))) FullPerm)))) (=> (and (InsidePredicate (valid1 this@@53) (MapType0Select Heap@0 null (valid1 this@@53)) (valid (MapType0Select Heap@0 this@@53 root1)) (MapType0Select Heap@0 null (valid (MapType0Select Heap@0 this@@53 root1)))) (= Mask@3 Mask@2)) (and (=> (= (ControlFlow 0 37) 35) anon35_Then_correct) (=> (= (ControlFlow 0 37) 30) anon35_Else_correct))))))
(let ((anon34_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 40) 37)) anon7_correct)))
(let ((anon34_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 38) (- 0 39)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (valid (MapType0Select Heap@0 this@@53 root1)))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (valid (MapType0Select Heap@0 this@@53 root1))))) (=> (= (ControlFlow 0 38) 37) anon7_correct))))))
(let ((anon33_Then_correct  (=> (not (= (MapType0Select Heap@0 this@@53 root1) null)) (and (=> (= (ControlFlow 0 41) 38) anon34_Then_correct) (=> (= (ControlFlow 0 41) 40) anon34_Else_correct)))))
(let ((anon33_Else_correct  (=> (and (= (MapType0Select Heap@0 this@@53 root1) null) (= Mask@3 Mask@1)) (and (=> (= (ControlFlow 0 36) 35) anon35_Then_correct) (=> (= (ControlFlow 0 36) 30) anon35_Else_correct)))))
(let ((anon4_correct  (=> (= Mask@1 (MapType1Store Mask@0 this@@53 root1 (real_2_U (- (U_2_real (MapType1Select Mask@0 this@@53 root1)) FullPerm)))) (and (=> (= (ControlFlow 0 42) 41) anon33_Then_correct) (=> (= (ControlFlow 0 42) 36) anon33_Else_correct)))))
(let ((anon32_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 45) 42)) anon4_correct)))
(let ((anon32_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 43) (- 0 44)) (<= FullPerm (U_2_real (MapType1Select Mask@0 this@@53 root1)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 this@@53 root1))) (=> (= (ControlFlow 0 43) 42) anon4_correct))))))
(let ((anon31_Else_correct  (and (=> (= (ControlFlow 0 46) (- 0 47)) (= FullPerm (U_2_real (MapType1Select Mask@0 this@@53 root1)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 this@@53 root1))) (=> (and (= Heap@0 (MapType0Store Heap@@18 this@@53 root1 null)) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 46) 43) anon32_Then_correct) (=> (= (ControlFlow 0 46) 45) anon32_Else_correct)))))))
(let ((anon31_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@18 ZeroMask) (U_2_bool (MapType0Select Heap@@18 this@@53 $allocated))) (=> (and (and (not (= this@@53 null)) (= Mask@0 (MapType1Store ZeroMask this@@53 root1 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@53 root1)) FullPerm))))) (and (state Heap@@18 Mask@0) (state Heap@@18 Mask@0))) (and (=> (= (ControlFlow 0 48) 1) anon31_Then_correct) (=> (= (ControlFlow 0 48) 46) anon31_Else_correct))))))
