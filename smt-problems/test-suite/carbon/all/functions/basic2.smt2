...
(assert  (and (= (Ctor FrameTypeType) 10) (= (type EmptyFrame) FrameTypeType)))
(assert (forall ((Heap@@0 T@U) (Mask@@0 T@U) ) (!  (=> (and (and (= (type Heap@@0) (MapType0Type RefType)) (= (type Mask@@0) (MapType1Type RefType realType))) (and (state Heap@@0 Mask@@0) (or (< AssumeFunctionsAbove 0) (|fun03#trigger| EmptyFrame)))) (and (not (= (|fun03'| Heap@@0) 0)) (not (= (div 1 (|fun03'| Heap@@0)) 1))))
 :qid |stdinbpl.318:15|
 :skolemid |34|
...
(assert (forall ((Heap@@3 T@U) (ExhaleHeap@@1 T@U) (Mask@@3 T@U) (o_1 T@U) ) (!  (=> (and (and (and (and (and (= (type Heap@@3) (MapType0Type RefType)) (= (type ExhaleHeap@@1) (MapType0Type RefType))) (= (type Mask@@3) (MapType1Type RefType realType))) (= (type o_1) RefType)) (IdenticalOnKnownLocations Heap@@3 ExhaleHeap@@1 Mask@@3)) (U_2_bool (MapType0Select Heap@@3 o_1 $allocated))) (U_2_bool (MapType0Select ExhaleHeap@@1 o_1 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@3 ExhaleHeap@@1 Mask@@3) (MapType0Select ExhaleHeap@@1 o_1 $allocated))
)))
(assert (forall ((Heap@@4 T@U) (Mask@@4 T@U) ) (!  (=> (and (and (= (type Heap@@4) (MapType0Type RefType)) (= (type Mask@@4) (MapType1Type RefType realType))) (and (state Heap@@4 Mask@@4) (or (< AssumeFunctionsAbove 2) (|fun02#trigger| EmptyFrame)))) (not (= (|fun02'| Heap@@4) 0)))
 :qid |stdinbpl.258:15|
 :skolemid |29|
 :pattern ( (state Heap@@4 Mask@@4) (|fun02'| Heap@@4))
)))
(assert (forall ((Heap@@5 T@U) (ExhaleHeap@@2 T@U) (Mask@@5 T@U) (o_1@@0 T@U) (f_2 T@U) ) (! (let ((B@@1 (FieldTypeInv1 (type f_2))))
(let ((A@@1 (FieldTypeInv0 (type f_2))))
 (=> (and (and (and (and (and (and (= (type Heap@@5) (MapType0Type RefType)) (= (type ExhaleHeap@@2) (MapType0Type RefType))) (= (type Mask@@5) (MapType1Type RefType realType))) (= (type o_1@@0) RefType)) (= (type f_2) (FieldType A@@1 B@@1))) (IdenticalOnKnownLocations Heap@@5 ExhaleHeap@@2 Mask@@5)) (HasDirectPerm Mask@@5 o_1@@0 f_2)) (= (MapType0Select Heap@@5 o_1@@0 f_2) (MapType0Select ExhaleHeap@@2 o_1@@0 f_2)))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@5 ExhaleHeap@@2 Mask@@5) (MapType0Select ExhaleHeap@@2 o_1@@0 f_2))
)))
...
(assert (forall ((Heap@@6 T@U) (ExhaleHeap@@3 T@U) (Mask@@6 T@U) ) (!  (=> (and (and (and (= (type Heap@@6) (MapType0Type RefType)) (= (type ExhaleHeap@@3) (MapType0Type RefType))) (= (type Mask@@6) (MapType1Type RefType realType))) (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@3 Mask@@6)) (succHeap Heap@@6 ExhaleHeap@@3))
 :qid |stdinbpl.83:15|
 :skolemid |10|
 :pattern ( (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@3 Mask@@6))
)))
(assert (forall ((Heap@@7 T@U) (Mask@@7 T@U) ) (!  (=> (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (and (state Heap@@7 Mask@@7) (or (< AssumeFunctionsAbove 1) (|fun01#trigger| EmptyFrame)))) (not (= (div 1 (|fun01'| Heap@@7)) 1)))
 :qid |stdinbpl.204:15|
 :skolemid |25|
 :pattern ( (state Heap@@7 Mask@@7) (|fun01'| Heap@@7))
)))
(assert (forall ((Heap@@8 T@U) (Mask@@8 T@U) ) (!  (=> (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@8) (MapType1Type RefType realType))) (and (state Heap@@8 Mask@@8) (or (< AssumeFunctionsAbove 2) (|fun02#trigger| EmptyFrame)))) (not (= (div 1 (|fun02'| Heap@@8)) 1)))
 :qid |stdinbpl.262:15|
 :skolemid |30|
 :pattern ( (state Heap@@8 Mask@@8) (|fun02'| Heap@@8))
)))
...
(assert (forall ((Heap@@9 T@U) ) (!  (=> (= (type Heap@@9) (MapType0Type RefType)) (and (= (fun01 Heap@@9) (|fun01'| Heap@@9)) (dummyFunction (int_2_U |fun01#triggerStateless|))))
 :qid |stdinbpl.187:15|
 :skolemid |22|
 :pattern ( (fun01 Heap@@9))
)))
(assert (forall ((Heap@@10 T@U) ) (!  (=> (= (type Heap@@10) (MapType0Type RefType)) (and (= (fun02 Heap@@10) (|fun02'| Heap@@10)) (dummyFunction (int_2_U |fun02#triggerStateless|))))
 :qid |stdinbpl.241:15|
 :skolemid |26|
 :pattern ( (fun02 Heap@@10))
)))
(assert (forall ((Heap@@11 T@U) ) (!  (=> (= (type Heap@@11) (MapType0Type RefType)) (and (= (fun03 Heap@@11) (|fun03'| Heap@@11)) (dummyFunction (int_2_U |fun03#triggerStateless|))))
 :qid |stdinbpl.301:15|
 :skolemid |31|
 :pattern ( (fun03 Heap@@11))
)))
...
(assert (forall ((Heap@@14 T@U) ) (!  (=> (= (type Heap@@14) (MapType0Type RefType)) (dummyFunction (int_2_U |fun01#triggerStateless|)))
 :qid |stdinbpl.191:15|
 :skolemid |23|
 :pattern ( (|fun01'| Heap@@14))
)))
(assert (forall ((Heap@@15 T@U) ) (!  (=> (= (type Heap@@15) (MapType0Type RefType)) (dummyFunction (int_2_U |fun02#triggerStateless|)))
 :qid |stdinbpl.245:15|
 :skolemid |27|
 :pattern ( (|fun02'| Heap@@15))
)))
(assert (forall ((Heap@@16 T@U) ) (!  (=> (= (type Heap@@16) (MapType0Type RefType)) (dummyFunction (int_2_U |fun03#triggerStateless|)))
 :qid |stdinbpl.305:15|
 :skolemid |32|
...
(assert (forall ((Heap@@18 T@U) (Mask@@13 T@U) ) (!  (=> (and (and (= (type Heap@@18) (MapType0Type RefType)) (= (type Mask@@13) (MapType1Type RefType realType))) (state Heap@@18 Mask@@13)) (= (|fun01'| Heap@@18) (|fun01#frame| EmptyFrame)))
 :qid |stdinbpl.198:15|
 :skolemid |24|
 :pattern ( (state Heap@@18 Mask@@13) (|fun01'| Heap@@18))
)))
(assert (forall ((Heap@@19 T@U) (Mask@@14 T@U) ) (!  (=> (and (and (= (type Heap@@19) (MapType0Type RefType)) (= (type Mask@@14) (MapType1Type RefType realType))) (state Heap@@19 Mask@@14)) (= (|fun02'| Heap@@19) (|fun02#frame| EmptyFrame)))
 :qid |stdinbpl.252:15|
 :skolemid |28|
 :pattern ( (state Heap@@19 Mask@@14) (|fun02'| Heap@@19))
)))
(assert (forall ((Heap@@20 T@U) (Mask@@15 T@U) ) (!  (=> (and (and (= (type Heap@@20) (MapType0Type RefType)) (= (type Mask@@15) (MapType1Type RefType realType))) (state Heap@@20 Mask@@15)) (= (|fun03'| Heap@@20) (|fun03#frame| EmptyFrame)))
 :qid |stdinbpl.312:15|
 :skolemid |33|
 :pattern ( (state Heap@@20 Mask@@15) (|fun03'| Heap@@20))
)))
...
(assert (= (type Heap@@22) (MapType0Type RefType)))
(set-info :boogie-vc-id |fun02#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@22 ZeroMask) (=> (and (and (= AssumeFunctionsAbove 2) (not (= Result 0))) (and (state Heap@@22 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (not (= Result 0))))))
