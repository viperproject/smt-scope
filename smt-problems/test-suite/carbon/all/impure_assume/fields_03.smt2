...
(assert  (and (and (and (and (= (type x@@8) RefType) (= (type y@@1) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type a_2) RefType)))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon4_correct true))
(let ((anon6_Else_correct  (=> (and (not (= x@@8 y@@1)) (= (ControlFlow 0 5) 1)) anon4_correct)))
(let ((anon6_Then_correct  (=> (= x@@8 y@@1) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= NoPerm q_1)) (=> (<= NoPerm q_1) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= q_1 p_2)) (=> (<= q_1 p_2) (=> (= (ControlFlow 0 2) 1) anon4_correct))))))))
(let ((anon2_correct  (=> (state Heap@@9 Mask@0) (and (=> (= (ControlFlow 0 6) 2) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (not (= x@@8 y@@1)) (= (ControlFlow 0 10) 6)) anon2_correct)))
(let ((anon5_Then_correct  (=> (= x@@8 y@@1) (and (=> (= (ControlFlow 0 7) (- 0 9)) (<= NoPerm q_1)) (=> (<= NoPerm q_1) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= q_1 (- (/ (to_real 1) (to_real 2)) p_2))) (=> (<= q_1 (- (/ (to_real 1) (to_real 2)) p_2)) (=> (= (ControlFlow 0 7) 6) anon2_correct))))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 a_2 $allocated))) (and (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated)) (U_2_bool (MapType0Select Heap@@9 y@@1 $allocated)))) (and (and (<= NoPerm q_1) (<= NoPerm p_2)) (and (state Heap@@9 ZeroMask) (= perm@0 (/ (to_real 1) (to_real 2)))))) (and (=> (= (ControlFlow 0 11) (- 0 16)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (=> (> perm@0 NoPerm) (not (= a_2 null))) (= Mask@0 (MapType1Store ZeroMask a_2 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask a_2 f_7)) perm@0))))) (=> (and (and (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (<= p_2 (U_2_real (MapType1Select Mask@0 x@@8 f_7))) (state Heap@@9 Mask@0))) (and (and (state Heap@@9 Mask@0) (<= (__iar__assume_helper_1 (= x@@8 y@@1) p_2 q_1) (U_2_real (MapType1Select Mask@0 y@@1 f_7)))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)))) (and (=> (= (ControlFlow 0 11) (- 0 15)) (<= NoPerm p_2)) (=> (<= NoPerm p_2) (and (=> (= (ControlFlow 0 11) (- 0 14)) (<= p_2 (/ (to_real 1) (to_real 2)))) (=> (<= p_2 (/ (to_real 1) (to_real 2))) (=> (state Heap@@9 Mask@0) (and (=> (= (ControlFlow 0 11) (- 0 13)) (<= NoPerm q_1)) (=> (<= NoPerm q_1) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= q_1 (/ (to_real 1) (to_real 2)))) (=> (<= q_1 (/ (to_real 1) (to_real 2))) (=> (state Heap@@9 Mask@0) (and (=> (= (ControlFlow 0 11) 7) anon5_Then_correct) (=> (= (ControlFlow 0 11) 10) anon5_Else_correct)))))))))))))))))))
