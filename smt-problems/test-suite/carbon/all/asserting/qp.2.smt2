...
(assert  (and (and (= (type s@@3) (MapType2Type RefType boolType)) (= (type x_4) RefType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id m3Fail)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (not (U_2_bool (MapType2Select s@@3 x_4))) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (U_2_bool (MapType2Select s@@3 x_4)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= x_4 null))) (=> (not (= x_4 null)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
...
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (> (|Set#Card| s@@3) 0) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 7) 2) anon5_Else_correct) (=> (= (ControlFlow 0 7) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))
