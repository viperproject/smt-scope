...
(declare-fun invRecv4 (T@U Real) T@U)
(declare-fun qpRange4 (T@U Real) Bool)
(declare-fun QPMask@0 () T@U)
(declare-fun y@@2 () T@U)
(declare-fun neverTriggered5 (T@U) Bool)
(declare-fun invRecv5 (T@U Real) T@U)
(declare-fun qpRange5 (T@U Real) Bool)
(declare-fun QPMask@1 () T@U)
(declare-fun ExhaleHeap@0 () T@U)
(assert  (and (and (and (and (and (and (and (= (type xs) (SeqType RefType)) (= (type Heap@@11) (MapType0Type RefType))) (forall ((arg0@@39 T@U) (arg1@@18 Real) ) (! (= (type (invRecv4 arg0@@39 arg1@@18)) RefType)
 :qid |funType:invRecv4|
 :pattern ( (invRecv4 arg0@@39 arg1@@18))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type y@@2) RefType)) (forall ((arg0@@40 T@U) (arg1@@19 Real) ) (! (= (type (invRecv5 arg0@@40 arg1@@19)) RefType)
 :qid |funType:invRecv5|
 :pattern ( (invRecv5 arg0@@40 arg1@@19))
))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test02_qp_client)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 8)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| xs x_1)) (|Seq#Contains| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= x_1 x_1_1)) (not (= p_1@@5 p_1@@5)))))
 :qid |stdinbpl.1328:17|
 :skolemid |89|
 :pattern ( (neverTriggered4 x_1) (neverTriggered4 x_1_1))
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (|Seq#Contains| xs x_1@@0)) (|Seq#Contains| xs x_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= x_1@@0 x_1_1@@0)) (not (= p_1@@5 p_1@@5)))))
 :qid |stdinbpl.1328:17|
 :skolemid |89|
 :pattern ( (neverTriggered4 x_1@@0) (neverTriggered4 x_1_1@@0))
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| xs x_1@@1) (< NoPerm FullPerm)) (and (= (invRecv4 x_1@@1 p_1@@5) x_1@@1) (qpRange4 x_1@@1 p_1@@5))))
 :qid |stdinbpl.1334:22|
 :skolemid |90|
 :pattern ( (MapType0Select Heap@@11 null (pred2 x_1@@1 p_1@@5)))
 :pattern ( (MapType1Select ZeroMask null (pred2 x_1@@1 p_1@@5)))
 :pattern ( (|Seq#ContainsTrigger| xs x_1@@1))
 :pattern ( (|Seq#Contains| xs x_1@@1))
)) (=> (and (forall ((a_1@@11 T@U) (p_1_1 Real) ) (!  (=> (= (type a_1@@11) RefType) (=> (and (and (|Seq#Contains| xs (invRecv4 a_1@@11 p_1_1)) (< NoPerm FullPerm)) (qpRange4 a_1@@11 p_1_1)) (and (= (invRecv4 a_1@@11 p_1_1) a_1@@11) (= p_1@@5 p_1_1))))
 :qid |stdinbpl.1338:22|
 :skolemid |91|
 :pattern ( (invRecv4 a_1@@11 p_1_1))
)) (forall ((a_1@@12 T@U) (p_1_1@@0 Real) ) (!  (=> (= (type a_1@@12) RefType) (=> (and (and (|Seq#Contains| xs (invRecv4 a_1@@12 p_1_1@@0)) (< NoPerm FullPerm)) (qpRange4 a_1@@12 p_1_1@@0)) (and (=> (< NoPerm FullPerm) (and (= (invRecv4 a_1@@12 p_1_1@@0) a_1@@12) (= p_1@@5 p_1_1@@0))) (= (U_2_real (MapType1Select QPMask@0 null (pred2 a_1@@12 p_1_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (pred2 a_1@@12 p_1_1@@0))) FullPerm)))))
 :qid |stdinbpl.1344:22|
 :skolemid |92|
 :pattern ( (MapType1Select QPMask@0 null (pred2 a_1@@12 p_1_1@@0)))
...
)) (forall ((a_1@@13 T@U) (p_1_1@@1 Real) ) (!  (=> (and (= (type a_1@@13) RefType) (not (and (and (|Seq#Contains| xs (invRecv4 a_1@@13 p_1_1@@1)) (< NoPerm FullPerm)) (qpRange4 a_1@@13 p_1_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (pred2 a_1@@13 p_1_1@@1))) (U_2_real (MapType1Select ZeroMask null (pred2 a_1@@13 p_1_1@@1)))))
 :qid |stdinbpl.1354:22|
 :skolemid |94|
 :pattern ( (MapType1Select QPMask@0 null (pred2 a_1@@13 p_1_1@@1)))
))) (and (state Heap@@11 QPMask@0) (state Heap@@11 QPMask@0))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (|Seq#Contains| xs y@@2)) (=> (|Seq#Contains| xs y@@2) (and (=> (= (ControlFlow 0 3) (- 0 6)) (<= NoPerm p_1@@5)) (=> (<= NoPerm p_1@@5) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (|Seq#Contains| xs x_3)) (|Seq#Contains| xs x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= x_3 x_3_1)) (not (= p_1@@5 p_1@@5)))))
 :qid |stdinbpl.1386:19|
 :skolemid |95|
 :pattern ( (neverTriggered5 x_3) (neverTriggered5 x_3_1))
))) (=> (forall ((x_3@@0 T@U) (x_3_1@@0 T@U) ) (!  (=> (and (= (type x_3@@0) RefType) (= (type x_3_1@@0) RefType)) (=> (and (and (and (and (not (= x_3@@0 x_3_1@@0)) (|Seq#Contains| xs x_3@@0)) (|Seq#Contains| xs x_3_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= x_3@@0 x_3_1@@0)) (not (= p_1@@5 p_1@@5)))))
 :qid |stdinbpl.1386:19|
 :skolemid |95|
 :pattern ( (neverTriggered5 x_3@@0) (neverTriggered5 x_3_1@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_3@@1 T@U) ) (!  (=> (and (= (type x_3@@1) RefType) (|Seq#Contains| xs x_3@@1)) (>= (U_2_real (MapType1Select QPMask@0 null (pred2 x_3@@1 p_1@@5))) FullPerm))
 :qid |stdinbpl.1393:19|
 :skolemid |96|
 :pattern ( (MapType0Select Heap@@11 null (pred2 x_3@@1 p_1@@5)))
 :pattern ( (MapType1Select QPMask@0 null (pred2 x_3@@1 p_1@@5)))
 :pattern ( (|Seq#ContainsTrigger| xs x_3@@1))
 :pattern ( (|Seq#Contains| xs x_3@@1))
))) (=> (forall ((x_3@@2 T@U) ) (!  (=> (and (= (type x_3@@2) RefType) (|Seq#Contains| xs x_3@@2)) (>= (U_2_real (MapType1Select QPMask@0 null (pred2 x_3@@2 p_1@@5))) FullPerm))
 :qid |stdinbpl.1393:19|
 :skolemid |96|
 :pattern ( (MapType0Select Heap@@11 null (pred2 x_3@@2 p_1@@5)))
 :pattern ( (MapType1Select QPMask@0 null (pred2 x_3@@2 p_1@@5)))
 :pattern ( (|Seq#ContainsTrigger| xs x_3@@2))
 :pattern ( (|Seq#Contains| xs x_3@@2))
)) (=> (forall ((x_3@@3 T@U) ) (!  (=> (= (type x_3@@3) RefType) (=> (and (|Seq#Contains| xs x_3@@3) (< NoPerm FullPerm)) (and (= (invRecv5 x_3@@3 p_1@@5) x_3@@3) (qpRange5 x_3@@3 p_1@@5))))
 :qid |stdinbpl.1399:24|
 :skolemid |97|
 :pattern ( (MapType0Select Heap@@11 null (pred2 x_3@@3 p_1@@5)))
 :pattern ( (MapType1Select QPMask@0 null (pred2 x_3@@3 p_1@@5)))
 :pattern ( (|Seq#ContainsTrigger| xs x_3@@3))
 :pattern ( (|Seq#Contains| xs x_3@@3))
)) (=> (and (and (and (forall ((a_1_1 T@U) (p_2_1 Real) ) (!  (=> (= (type a_1_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv5 a_1_1 p_2_1)) (< NoPerm FullPerm)) (qpRange5 a_1_1 p_2_1)) (and (= (invRecv5 a_1_1 p_2_1) a_1_1) (= p_1@@5 p_2_1))))
 :qid |stdinbpl.1403:24|
 :skolemid |98|
 :pattern ( (invRecv5 a_1_1 p_2_1))
)) (forall ((a_1_1@@0 T@U) (p_2_1@@0 Real) ) (!  (=> (= (type a_1_1@@0) RefType) (=> (and (and (|Seq#Contains| xs (invRecv5 a_1_1@@0 p_2_1@@0)) (< NoPerm FullPerm)) (qpRange5 a_1_1@@0 p_2_1@@0)) (and (and (= (invRecv5 a_1_1@@0 p_2_1@@0) a_1_1@@0) (= p_1@@5 p_2_1@@0)) (= (U_2_real (MapType1Select QPMask@1 null (pred2 a_1_1@@0 p_2_1@@0))) (- (U_2_real (MapType1Select QPMask@0 null (pred2 a_1_1@@0 p_2_1@@0))) FullPerm)))))
 :qid |stdinbpl.1409:24|
 :skolemid |99|
 :pattern ( (MapType1Select QPMask@1 null (pred2 a_1_1@@0 p_2_1@@0)))
))) (and (forall ((a_1_1@@1 T@U) (p_2_1@@1 Real) ) (!  (=> (and (= (type a_1_1@@1) RefType) (not (and (and (|Seq#Contains| xs (invRecv5 a_1_1@@1 p_2_1@@1)) (< NoPerm FullPerm)) (qpRange5 a_1_1@@1 p_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@1 null (pred2 a_1_1@@1 p_2_1@@1))) (U_2_real (MapType1Select QPMask@0 null (pred2 a_1_1@@1 p_2_1@@1)))))
 :qid |stdinbpl.1413:24|
 :skolemid |100|
 :pattern ( (MapType1Select QPMask@1 null (pred2 a_1_1@@1 p_2_1@@1)))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 ...
 :qid |stdinbpl.1419:31|
 :skolemid |101|
 :pattern ( (MapType1Select QPMask@0 o_3@@0 f_5@@0))
 :pattern ( (MapType1Select QPMask@1 o_3@@0 f_5@@0))
)))) (and (and (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@0 QPMask@1) (state ExhaleHeap@0 QPMask@1)) (and (state ExhaleHeap@0 QPMask@1) (= (ControlFlow 0 3) (- 0 2))))) false)))))))))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 y@@2 $allocated))) (=> (and (and (= p_1@@5 NoPerm) (state Heap@@11 ZeroMask)) (and (|Seq#Contains| xs y@@2) (state Heap@@11 ZeroMask))) (and (=> (= (ControlFlow 0 9) 1) anon3_Then_correct) (=> (= (ControlFlow 0 9) 3) anon3_Else_correct))))))
