...
(assert (forall ((Heap@@2 T@U) (x@@8 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type x@@8) RefType)) (dummyFunction (int_2_U (|foo#triggerStateless| x@@8))))
 :qid |stdinbpl.197:15|
 :skolemid |23|
...
(assert (forall ((Heap@@4 T@U) (x@@9 T@U) ) (!  (=> (and (= (type Heap@@4) (MapType0Type RefType)) (= (type x@@9) RefType)) (and (= (foo Heap@@4 x@@9) (|foo'| Heap@@4 x@@9)) (dummyFunction (int_2_U (|foo#triggerStateless| x@@9)))))
 :qid |stdinbpl.193:15|
 :skolemid |22|
 :pattern ( (foo Heap@@4 x@@9))
)))
...
(assert (forall ((Heap@@9 T@U) (Mask@@9 T@U) (x@@10 T@U) ) (!  (=> (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (= (type x@@10) RefType)) (state Heap@@9 Mask@@9)) (= (|foo'| Heap@@9 x@@10) (|foo#frame| (FrameFragment (MapType0Select Heap@@9 x@@10 val)) x@@10)))
 :qid |stdinbpl.210:15|
 :skolemid |25|
 :pattern ( (state Heap@@9 Mask@@9) (|foo'| Heap@@9 x@@10))
)))
...
(assert (forall ((Heap@@12 T@U) (Mask@@10 T@U) (x@@11 T@U) ) (!  (=> (and (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type x@@11) RefType)) (and (state Heap@@12 Mask@@10) (< AssumeFunctionsAbove 0))) (= (foo Heap@@12 x@@11) (U_2_int (MapType0Select Heap@@12 x@@11 val))))
 :qid |stdinbpl.203:15|
 :skolemid |24|
 :pattern ( (state Heap@@12 Mask@@10) (foo Heap@@12 x@@11))
)))
...
(assert  (and (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type x@@12) RefType)) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type z@@0) RefType)) (= (type Heap@@13) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon11_correct true))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 14) 11)) anon11_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@12 val)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@12 val))) (=> (= (ControlFlow 0 12) 11) anon11_correct))))))
(let ((anon17_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (= (foo Heap@2 x@@12) 42))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 17)) (= (foo Heap@1 x@@12) 4)) (=> (= (foo Heap@1 x@@12) 4) (=> (state Heap@1 Mask@1) (and (=> (= (ControlFlow 0 15) (- 0 16)) (= FullPerm (U_2_real (MapType1Select Mask@1 x@@12 val)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 x@@12 val))) (=> (and (= Heap@2 (MapType0Store Heap@1 x@@12 val (int_2_U 5))) (state Heap@2 Mask@1)) (and (and (=> (= (ControlFlow 0 15) 10) anon17_Else_correct) (=> (= (ControlFlow 0 15) 12) anon18_Then_correct)) (=> (= (ControlFlow 0 15) 14) anon18_Else_correct))))))))))
(let ((anon7_correct true))
(let ((anon16_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon7_correct)))
(let ((anon16_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@12 val)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@12 val))) (=> (= (ControlFlow 0 6) 5) anon7_correct))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 20)) (= (foo Heap@0 x@@12) 4)) (=> (= (foo Heap@0 x@@12) 4) (=> (state Heap@0 Mask@1) (and (=> (= (ControlFlow 0 18) (- 0 19)) (= FullPerm (U_2_real (MapType1Select Mask@1 z@@0 val)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 z@@0 val))) (=> (and (= Heap@1 (MapType0Store Heap@0 z@@0 val (int_2_U 3))) (state Heap@1 Mask@1)) (and (and (=> (= (ControlFlow 0 18) 15) anon15_Else_correct) (=> (= (ControlFlow 0 18) 6) anon16_Then_correct)) (=> (= (ControlFlow 0 18) 8) anon16_Else_correct))))))))))
(let ((anon3_correct true))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@12 val)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@12 val))) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@13 x@@12 $allocated))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@13 z@@0 $allocated)) (not (= x@@12 null))) (and (= Mask@0 (MapType1Store ZeroMask x@@12 val (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@12 val)) FullPerm)))) (state Heap@@13 Mask@0))) (and (and (not (= z@@0 null)) (= Mask@1 (MapType1Store Mask@0 z@@0 val (real_2_U (+ (U_2_real (MapType1Select Mask@0 z@@0 val)) FullPerm))))) (and (state Heap@@13 Mask@1) (state Heap@@13 Mask@1)))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (= FullPerm (U_2_real (MapType1Select Mask@1 x@@12 val)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 x@@12 val))) (=> (and (= Heap@0 (MapType0Store Heap@@13 x@@12 val (int_2_U 4))) (state Heap@0 Mask@1)) (and (and (=> (= (ControlFlow 0 21) 18) anon13_Else_correct) (=> (= (ControlFlow 0 21) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 21) 4) anon14_Else_correct))))))))))
