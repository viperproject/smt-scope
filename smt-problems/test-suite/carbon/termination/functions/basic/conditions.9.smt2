...
(declare-fun |f6#trigger| (T@U T@U Int) Bool)
(assert  (and (and (and (= (type Heap@@34) (MapType0Type RefType)) (= (type xs@@9) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |f6#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon6_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (list xs@@9) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (list xs@@9))) FullPerm)))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (>= (- x@@12 1) 0)) (=> (>= (- x@@12 1) 0) (=> (= (ControlFlow 0 6) (- 0 5)) (f7 Heap@@34 (- x@@12 1))))))))
(let ((anon12_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 6)) anon6_correct)))
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@9))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@9)))) (=> (= (ControlFlow 0 8) 6) anon6_correct))))))
(let ((anon8_correct true))
(let ((anon11_Else_correct  (=> (and (|f6#trigger| (MapType0Select Heap@@34 null (list xs@@9)) xs@@9 (- x@@12 1)) (= (ControlFlow 0 4) 2)) anon8_correct)))
(let ((anon10_Then_correct  (=> (not (= x@@12 0)) (and (and (=> (= (ControlFlow 0 11) 4) anon11_Else_correct) (=> (= (ControlFlow 0 11) 8) anon12_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon12_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (= x@@12 0) (= (ControlFlow 0 3) 2)) anon8_correct)))
(let ((anon9_Else_correct  (=> (and (f7 Heap@@34 x@@12) (state Heap@@34 Mask@0)) (and (=> (= (ControlFlow 0 12) 11) anon10_Then_correct) (=> (= (ControlFlow 0 12) 3) anon10_Else_correct)))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@34 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@34 xs@@9 $allocated)) (= AssumeFunctionsAbove 1)) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (list xs@@9) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (list xs@@9))) FullPerm)))) (state Heap@@34 Mask@0)) (and (>= x@@12 0) (state Heap@@34 Mask@0))) (and (=> (= (ControlFlow 0 13) 1) anon9_Then_correct) (=> (= (ControlFlow 0 13) 12) anon9_Else_correct)))))))
