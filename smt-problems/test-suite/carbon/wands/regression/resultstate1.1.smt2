...
(assert  (and (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type x@@20) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |P#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@11 x@@20 $allocated)) (not (= x@@20 null))) (and (= Mask@0 (MapType1Store ZeroMask x@@20 h (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@20 h)) FullPerm)))) (state Heap@@11 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm Mask@0 x@@20 h)) (=> (HasDirectPerm Mask@0 x@@20 h) (=> (not (= (MapType0Select Heap@@11 x@@20 h) null)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@0 x@@20 h)) (=> (HasDirectPerm Mask@0 x@@20 h) (=> (not (= (MapType0Select Heap@@11 x@@20 h) null)) (=> (and (= Mask@1 (MapType1Store Mask@0 (MapType0Select Heap@@11 x@@20 h) h (real_2_U (+ (U_2_real (MapType1Select Mask@0 (MapType0Select Heap@@11 x@@20 h) h)) FullPerm)))) (state Heap@@11 Mask@1)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 x@@20 h)) (=> (HasDirectPerm Mask@1 x@@20 h) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@1 (MapType0Select Heap@@11 x@@20 h) h)))))))))))))))
