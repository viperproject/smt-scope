...
(assert  (and (and (and (and (= (type ExhaleHeap@0) (MapType0Type RefType)) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@11) (MapType0Type RefType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon11_Else_correct true))
(let ((anon11_Then_correct  (=> (and (state ExhaleHeap@0 ZeroMask) (= Mask@3 (MapType1Store ZeroMask null P (real_2_U (+ (U_2_real (MapType1Select ZeroMask null P)) FullPerm))))) (=> (and (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3)) (and (state ExhaleHeap@0 Mask@3) (= (ControlFlow 0 3) (- 0 2)))) false))))
(let ((anon10_Then_correct true))
(let ((anon2_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 null P (real_2_U (- (U_2_real (MapType1Select Mask@0 null P)) FullPerm)))) (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@0 Mask@1)) (and (and (=> (= (ControlFlow 0 5) 1) anon10_Then_correct) (=> (= (ControlFlow 0 5) 3) anon11_Then_correct)) (=> (= (ControlFlow 0 5) 4) anon11_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon2_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null P)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null P))) (=> (= (ControlFlow 0 6) 5) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null P (real_2_U (+ (U_2_real (MapType1Select ZeroMask null P)) FullPerm)))) (state Heap@@11 Mask@0)) (and (state Heap@@11 Mask@0) (state Heap@@11 Mask@0))) (and (=> (= (ControlFlow 0 9) 6) anon9_Then_correct) (=> (= (ControlFlow 0 9) 8) anon9_Else_correct))))))
