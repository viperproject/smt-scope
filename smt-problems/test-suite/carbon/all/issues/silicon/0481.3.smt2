...
(assert  (and (= (type arr@@6) (SeqType RefType)) (= (type Heap@@16) (MapType0Type RefType))))
(set-info :boogie-vc-id |array#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 i_3) (< i_3 (|Seq#Length| arr@@6)))) (= (ControlFlow 0 14) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (<= 0 i_3) (< i_3 (|Seq#Length| arr@@6))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= i_3 0)) (=> (>= i_3 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< i_3 (|Seq#Length| arr@@6))) (=> (< i_3 (|Seq#Length| arr@@6)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((i_4 Int) (i_4_1 Int) ) (!  (=> (and (and (and (and (not (= i_4 i_4_1)) (and (<= 0 i_4) (< i_4 (|Seq#Length| arr@@6)))) (and (<= 0 i_4_1) (< i_4_1 (|Seq#Length| arr@@6)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| arr@@6 i_4) (|Seq#Index| arr@@6 i_4_1))))
 :qid |stdinbpl.771:17|
 :skolemid |77|
 :pattern ( (neverTriggered1 i_4) (neverTriggered1 i_4_1))
)))))
(let ((anon9_Else_correct  (=> (forall ((i_2 Int) (j_1 Int) ) (!  (=> (and (<= 0 i_2) (and (< i_2 (|Seq#Length| arr@@6)) (and (<= 0 j_1) (< j_1 i_2)))) (not (= (|Seq#Index| arr@@6 i_2) (|Seq#Index| arr@@6 j_1))))
 :qid |stdinbpl.752:20|
 :skolemid |76|
 :pattern ( (|Seq#Index| arr@@6 i_2) (|Seq#Index| arr@@6 j_1))
...
(let ((anon10_Else_correct  (=> (and (not (and (<= 0 i@@6) (and (< i@@6 (|Seq#Length| arr@@6)) (and (<= 0 j@@5) (< j@@5 i@@6))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (<= 0 i@@6) (and (< i@@6 (|Seq#Length| arr@@6)) (and (<= 0 j@@5) (< j@@5 i@@6)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i@@6 (|Seq#Length| arr@@6))) (=> (< i@@6 (|Seq#Length| arr@@6)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j@@5 (|Seq#Length| arr@@6))) (=> (< j@@5 (|Seq#Length| arr@@6)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@16 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (= (|Seq#Length| arr@@6) 3)) (and (and (=> (= (ControlFlow 0 16) 15) anon9_Else_correct) (=> (= (ControlFlow 0 16) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 16) 7) anon10_Else_correct))))))
