...
(declare-fun p_1@@89 () Real)
(declare-fun Mask@0 () T@U)
(declare-fun wildcard@0 () Real)
(declare-fun Mask@1 () T@U)
(declare-fun Mask@2 () T@U)
(declare-fun wildcard () Real)
(assert  (and (and (and (and (= (type Heap@@30) (MapType0Type RefType)) (= (type diz@@125) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |Worker__postJoin_at_Worker#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (state Heap@@30 ZeroMask) (U_2_bool (MapType0Select Heap@@30 diz@@125 $allocated))) (=> (and (and (and (<= NoPerm p_1@@89) (= Mask@0 (MapType1Store ZeroMask null (Worker__postJoin_at_Thread diz@@125 p_1@@89) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Worker__postJoin_at_Thread diz@@125 p_1@@89))) FullPerm))))) (and (state Heap@@30 Mask@0) (> wildcard@0 NoPerm))) (and (and (not (= diz@@125 null)) (= Mask@1 (MapType1Store Mask@0 diz@@125 Worker__input (real_2_U (+ (U_2_real (MapType1Select Mask@0 diz@@125 Worker__input)) wildcard@0))))) (and (state Heap@@30 Mask@1) (not (= p_1@@89 NoPerm))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= p_1@@89 NoPerm)) (=> (>= p_1@@89 NoPerm) (=> (=> (> p_1@@89 NoPerm) (not (= diz@@125 null))) (=> (and (= Mask@2 (MapType1Store Mask@1 diz@@125 Worker__output (real_2_U (+ (U_2_real (MapType1Select Mask@1 diz@@125 Worker__output)) p_1@@89)))) (state Heap@@30 Mask@2)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@2 diz@@125 Worker__output)) (=> (HasDirectPerm Mask@2 diz@@125 Worker__output) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@2 diz@@125 Worker__input))))))))))))
...
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(set-info :boogie-vc-id Worker__open_preFork_at_Thread)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
...
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(set-info :boogie-vc-id Worker__open_postJoin_at_Worker)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) true)
