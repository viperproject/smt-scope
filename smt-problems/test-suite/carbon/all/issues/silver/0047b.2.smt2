...
(assert (forall ((Heap@@2 T@U) (r_1@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type r_1@@0) RefType)) (|F1#everUsed| (F1 r_1@@0)))
 :qid |stdinbpl.205:15|
 :skolemid |27|
 :pattern ( (|F1#trigger| Heap@@2 (F1 r_1@@0)))
)))
...
(assert (forall ((r_1@@1 T@U) (r2 T@U) ) (!  (=> (and (and (= (type r_1@@1) RefType) (= (type r2) RefType)) (= (F1 r_1@@1) (F1 r2))) (= r_1@@1 r2))
 :qid |stdinbpl.196:15|
 :skolemid |25|
 :pattern ( (F1 r_1@@1) (F1 r2))
)))
(assert (forall ((arg0@@26 T@U) ) (! (= (type (|F1#sm| arg0@@26)) (FieldType PredicateType_F1Type (MapType1Type RefType boolType)))
 :qid |funType:F1#sm|
 :pattern ( (|F1#sm| arg0@@26))
)))
(assert (forall ((r_1@@2 T@U) (r2@@0 T@U) ) (!  (=> (and (and (= (type r_1@@2) RefType) (= (type r2@@0) RefType)) (= (|F1#sm| r_1@@2) (|F1#sm| r2@@0))) (= r_1@@2 r2@@0))
 :qid |stdinbpl.200:15|
 :skolemid |26|
...
(assert (forall ((r_1@@3 T@U) ) (!  (=> (= (type r_1@@3) RefType) (= (getPredWandId (F1 r_1@@3)) 0))
 :qid |stdinbpl.190:15|
 :skolemid |24|
 :pattern ( (F1 r_1@@3))
)))
...
(assert (forall ((r_1@@4 T@U) ) (!  (=> (= (type r_1@@4) RefType) (= (PredicateMaskField (F1 r_1@@4)) (|F1#sm| r_1@@4)))
 :qid |stdinbpl.182:15|
 :skolemid |22|
 :pattern ( (PredicateMaskField (F1 r_1@@4)))
)))
