...
(assert  (and (and (and (and (and (and (and (and (and (and (= (type ExhaleHeap@0) (MapType0Type RefType)) (= (type freshObj@0) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type m@@7) RefType)) (= (type Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id main3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon7_correct)))
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 f_7))) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))
(let ((anon11_Then_correct  (=> (state ExhaleHeap@0 ZeroMask) (=> (and (and (not (= freshObj@0 null)) (= Mask@3 (MapType1Store ZeroMask freshObj@0 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 f_7)) FullPerm))))) (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3))) (and (=> (= (ControlFlow 0 12) (- 0 15)) (HasDirectPerm Mask@3 freshObj@0 f_7)) (=> (HasDirectPerm Mask@3 freshObj@0 f_7) (=> (not (= (U_2_int (MapType0Select ExhaleHeap@0 freshObj@0 f_7)) 3)) (=> (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (HasDirectPerm Mask@3 freshObj@0 f_7)) (=> (HasDirectPerm Mask@3 freshObj@0 f_7) (and (=> (= (ControlFlow 0 12) (- 0 13)) (= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 f_7))) (=> (and (= Heap@2 (MapType0Store ExhaleHeap@0 freshObj@0 f_7 (int_2_U (- (U_2_int (MapType0Select ExhaleHeap@0 freshObj@0 f_7)) 1)))) (state Heap@2 Mask@3)) (and (=> (= (ControlFlow 0 12) 9) anon12_Then_correct) (=> (= (ControlFlow 0 12) 11) anon12_Else_correct)))))))))))))))
(let ((anon11_Else_correct  (=> (not (not (= (U_2_int (MapType0Select ExhaleHeap@0 freshObj@0 f_7)) 3))) (=> (and (state ExhaleHeap@0 Mask@1) (not (= freshObj@0 null))) (=> (and (and (= Mask@4 (MapType1Store Mask@1 freshObj@0 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@1 freshObj@0 f_7)) FullPerm)))) (state ExhaleHeap@0 Mask@4)) (and (state ExhaleHeap@0 Mask@4) (state ExhaleHeap@0 Mask@4))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (HasDirectPerm Mask@4 freshObj@0 f_7)) (=> (HasDirectPerm Mask@4 freshObj@0 f_7) (and (=> (= (ControlFlow 0 3) (- 0 6)) (= (U_2_int (MapType0Select ExhaleHeap@0 freshObj@0 f_7)) 3)) (=> (= (U_2_int (MapType0Select ExhaleHeap@0 freshObj@0 f_7)) 3) (=> (= (ControlFlow 0 3) (- 0 5)) false))))))))))
(let ((anon10_Then_correct true))
(let ((anon2_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 freshObj@0 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 freshObj@0 f_7)) FullPerm)))) (IdenticalOnKnownLocations Heap@1 ExhaleHeap@0 Mask@1)) (and (and (=> (= (ControlFlow 0 16) 1) anon10_Then_correct) (=> (= (ControlFlow 0 16) 12) anon11_Then_correct)) (=> (= (ControlFlow 0 16) 3) anon11_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 19) 16)) anon2_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (<= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7))) (=> (= (ControlFlow 0 17) 16) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 m@@7 $allocated))) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@9 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@9 freshObj@0 $allocated (bool_2_U true)))) (and (= Mask@0 (MapType1Store ZeroMask freshObj@0 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 f_7)) FullPerm)))) (state Heap@0 Mask@0))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7))) (=> (and (= Heap@1 (MapType0Store Heap@0 freshObj@0 f_7 (int_2_U 15))) (state Heap@1 Mask@0)) (and (=> (= (ControlFlow 0 20) 17) anon9_Then_correct) (=> (= (ControlFlow 0 20) 19) anon9_Else_correct)))))))))
