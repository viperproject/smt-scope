...
(assert  (and (= (type QPMask@0) (MapType1Type RefType realType)) (= (type Heap@@12) (MapType0Type RefType))))
(set-info :boogie-vc-id test_two)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon20_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (= FullPerm (U_2_real (MapType1Select QPMask@0 (matrix Heap@@12 3 4) val))))))
(let ((anon20_Then_correct true))
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((i_1 Int) (j_1 Int) (i_1_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (not (= i_1 i_1_1)) (not (= j_1 j_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (matrix Heap@@12 i_1 j_1) (matrix Heap@@12 i_1_1 j_1_1))))
 :qid |stdinbpl.775:15|
 :skolemid |70|
))) (=> (forall ((i_1@@0 Int) (j_1@@0 Int) (i_1_1@@0 Int) (j_1_1@@0 Int) ) (!  (=> (and (and (and (not (= i_1@@0 i_1_1@@0)) (not (= j_1@@0 j_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (matrix Heap@@12 i_1@@0 j_1@@0) (matrix Heap@@12 i_1_1@@0 j_1_1@@0))))
 :qid |stdinbpl.775:15|
 :skolemid |70|
)) (=> (and (and (and (forall ((i_1@@1 Int) (j_1@@1 Int) ) (!  (=> (< NoPerm FullPerm) (and (and (qpRange4 (matrix Heap@@12 i_1@@1 j_1@@1)) (= (invRecv3 (matrix Heap@@12 i_1@@1 j_1@@1)) i_1@@1)) (= (invRecv4 (matrix Heap@@12 i_1@@1 j_1@@1)) j_1@@1)))
 :qid |stdinbpl.781:22|
 :skolemid |71|
 :pattern ( (|matrix#frame| EmptyFrame i_1@@1 j_1@@1))
 :pattern ( (|matrix#frame| EmptyFrame i_1@@1 j_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (< NoPerm FullPerm) (qpRange4 o_3)) (= (matrix Heap@@12 (invRecv3 o_3) (invRecv4 o_3)) o_3)))
 :qid |stdinbpl.785:22|
 :skolemid |72|
 :pattern ( (invRecv3 o_3) (invRecv4 o_3))
))) (and (forall ((i_1@@2 Int) (j_1@@2 Int) ) (! (not (= (matrix Heap@@12 i_1@@2 j_1@@2) null))
 :qid |stdinbpl.791:22|
 :skolemid |73|
 :pattern ( (|matrix#frame| EmptyFrame i_1@@2 j_1@@2))
 :pattern ( (|matrix#frame| EmptyFrame i_1@@2 j_1@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (< NoPerm FullPerm) (qpRange4 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (matrix Heap@@12 (invRecv3 o_3@@0) (invRecv4 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (< NoPerm FullPerm) (qpRange4 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.797:22|
 :skolemid |74|
...
)) (state Heap@@12 QPMask@0)) (and (state Heap@@12 QPMask@0) (state Heap@@12 QPMask@0)))) (and (=> (= (ControlFlow 0 11) 8) anon20_Then_correct) (=> (= (ControlFlow 0 11) 10) anon20_Else_correct)))))))
(let ((anon19_Else_correct true))
(let ((anon19_Then_correct true))
(let ((anon14_Else_correct  (=> (forall ((i1_1 Int) (j1_1 Int) (i2_1 Int) (j2_1 Int) ) (!  (=> (or (not (= i1_1 i2_1)) (not (= j1_1 j2_1))) (not (= (matrix Heap@@12 i1_1 j1_1) (matrix Heap@@12 i2_1 j2_1))))
 :qid |stdinbpl.748:20|
 :skolemid |69|
 :pattern ( (|matrix#frame| EmptyFrame i1_1 j1_1) (|matrix#frame| EmptyFrame i2_1 j2_1))
)) (=> (and (state Heap@@12 ZeroMask) (state Heap@@12 ZeroMask)) (and (and (=> (= (ControlFlow 0 13) 11) anon18_Else_correct) (=> (= (ControlFlow 0 13) 6) anon19_Then_correct)) (=> (= (ControlFlow 0 13) 7) anon19_Else_correct))))))
(let ((anon17_Then_correct true))
(let ((anon16_Then_correct true))
(let ((anon6_correct true))
(let ((anon15_Then_correct  (=> (or (not (= i1 i2)) (not (= j1 j2))) (and (and (=> (= (ControlFlow 0 5) 3) anon16_Then_correct) (=> (= (ControlFlow 0 5) 4) anon17_Then_correct)) (=> (= (ControlFlow 0 5) 1) anon6_correct)))))
(let ((anon15_Else_correct  (=> (and (not (or (not (= i1 i2)) (not (= j1 j2)))) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (state Heap@@12 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (state Heap@@12 ZeroMask)) (and (and (=> (= (ControlFlow 0 14) 13) anon14_Else_correct) (=> (= (ControlFlow 0 14) 5) anon15_Then_correct)) (=> (= (ControlFlow 0 14) 2) anon15_Else_correct))))))
