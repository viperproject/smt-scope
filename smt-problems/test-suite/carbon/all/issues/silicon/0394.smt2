...
(assert (forall ((arg0@@43 Int) ) (! (= (type (foo arg0@@43)) (MultiSetType intType))
 :qid |funType:foo|
 :pattern ( (foo arg0@@43))
)))
(assert (forall ((a_3 Int) (b_3 Int) ) (! (= (bar a_3 b_3) (|MultiSet#Subset| (foo a_3) (foo b_3)))
 :qid |stdinbpl.380:15|
 :skolemid |82|
 :pattern ( (bar a_3 b_3))
)))
...
(declare-fun a_3@@0 () Int)
(declare-fun b_3@@0 () Int)
(declare-fun c () Int)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (|MultiSet#Equal| (|MultiSet#Union| (foo a_3@@0) (foo b_3@@0)) (foo c)) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (bar a_3@@0 c)) (=> (bar a_3@@0 c) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (bar b_3@@0 c)) (=> (bar b_3@@0 c) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (bar a_3@@0 b_3@@0)))))))))))
