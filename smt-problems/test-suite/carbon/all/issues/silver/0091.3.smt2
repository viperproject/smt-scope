...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (not (= x@@19 y@@6))) (and (state Heap@@9 ZeroMask) (= (|MultiSet#Select| B@@11 (int_2_U x@@19)) xc))) (=> (and (and (and (state Heap@@9 ZeroMask) (= (|MultiSet#Select| B@@11 (int_2_U y@@6)) yc)) (and (state Heap@@9 ZeroMask) (> xc 10))) (and (and (> yc 10) (state Heap@@9 ZeroMask)) (and (= B1@0 (|MultiSet#Difference| B@@11 (|MultiSet#UnionOne| (|MultiSet#UnionOne| (|MultiSet#Singleton| (int_2_U y@@6)) (int_2_U y@@6)) (int_2_U x@@19)))) (state Heap@@9 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (|MultiSet#Select| B1@0 (int_2_U y@@6)) (- yc 2))) (=> (= (|MultiSet#Select| B1@0 (int_2_U y@@6)) (- yc 2)) (=> (= (ControlFlow 0 2) (- 0 1)) (= (|MultiSet#Select| B1@0 (int_2_U x@@19)) (- xc 1)))))))))
