...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type k) (FieldType NormalFieldType realType))) (= (type f_7) (FieldType NormalFieldType intType))))
(assert (distinct $allocated k f_7)
)
...
(assert  (not (IsPredicateField k)))
(assert  (not (IsWandField k)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type S) (MapType2Type RefType boolType)) (= (type s_9) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type s_10) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type b_2) RefType)) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type ExhaleHeap@1) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type a_2) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv8 arg0@@43)) RefType)
 :qid |funType:invRecv8|
 :pattern ( (invRecv8 arg0@@43))
))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv7 arg0@@44)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 30) (let ((anon14_correct  (=> (and (and (= Mask@1 (MapType1Store Mask@0 b_2 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 b_2 f_7)) perm@1)))) (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@1 Mask@1)) (and (state ExhaleHeap@1 Mask@1) (= (ControlFlow 0 11) (- 0 10)))) false)))
(let ((anon21_Else_correct  (=> (and (= perm@1 NoPerm) (= (ControlFlow 0 14) 11)) anon14_correct)))
(let ((anon21_Then_correct  (=> (not (= perm@1 NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= perm@1 (U_2_real (MapType1Select Mask@0 b_2 f_7)))) (=> (<= perm@1 (U_2_real (MapType1Select Mask@0 b_2 f_7))) (=> (= (ControlFlow 0 12) 11) anon14_correct))))))
(let ((anon12_correct  (=> (= Mask@0 (MapType1Store QPMask@1 a_2 f_7 (real_2_U (- (U_2_real (MapType1Select QPMask@1 a_2 f_7)) perm@0)))) (=> (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@0) (state ExhaleHeap@0 Mask@0)) (and (=> (= (ControlFlow 0 15) (- 0 17)) (HasDirectPerm Mask@0 b_2 k)) (=> (HasDirectPerm Mask@0 b_2 k) (=> (= perm@1 (U_2_real (MapType0Select ExhaleHeap@0 b_2 k))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (and (=> (= (ControlFlow 0 15) 12) anon21_Then_correct) (=> (= (ControlFlow 0 15) 14) anon21_Else_correct)))))))))))
(let ((anon20_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 20) 15)) anon12_correct)))
(let ((anon20_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (<= perm@0 (U_2_real (MapType1Select QPMask@1 a_2 f_7)))) (=> (<= perm@0 (U_2_real (MapType1Select QPMask@1 a_2 f_7))) (=> (= (ControlFlow 0 18) 15) anon12_correct))))))
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 25)) (forall ((s_5 T@U) (s_5_1 T@U) ) (!  (=> (and (= (type s_5) RefType) (= (type s_5_1) RefType)) (=> (and (and (and (and (not (= s_5 s_5_1)) (and (U_2_bool (MapType2Select S s_5)) (not (= s_5 null)))) (and (U_2_bool (MapType2Select S s_5_1)) (not (= s_5_1 null)))) (< NoPerm (U_2_real (MapType0Select Heap@@9 s_5 k)))) (< NoPerm (U_2_real (MapType0Select Heap@@9 s_5_1 k)))) (not (= s_5 s_5_1))))
...
))) (=> (forall ((s_5@@0 T@U) (s_5_1@@0 T@U) ) (!  (=> (and (= (type s_5@@0) RefType) (= (type s_5_1@@0) RefType)) (=> (and (and (and (and (not (= s_5@@0 s_5_1@@0)) (and (U_2_bool (MapType2Select S s_5@@0)) (not (= s_5@@0 null)))) (and (U_2_bool (MapType2Select S s_5_1@@0)) (not (= s_5_1@@0 null)))) (< NoPerm (U_2_real (MapType0Select Heap@@9 s_5@@0 k)))) (< NoPerm (U_2_real (MapType0Select Heap@@9 s_5_1@@0 k)))) (not (= s_5@@0 s_5_1@@0))))
 :qid |stdinbpl.1051:15|
 :skolemid |131|
...
)) (=> (and (forall ((s_5@@1 T@U) ) (!  (=> (= (type s_5@@1) RefType) (=> (and (and (U_2_bool (MapType2Select S s_5@@1)) (not (= s_5@@1 null))) (< NoPerm (U_2_real (MapType0Select Heap@@9 s_5@@1 k)))) (and (qpRange8 s_5@@1) (= (invRecv8 s_5@@1) s_5@@1))))
 :qid |stdinbpl.1057:22|
 :skolemid |132|
 :pattern ( (MapType0Select Heap@@9 s_5@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 s_5@@1 f_7))
 :pattern ( (MapType2Select S s_5@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (U_2_bool (MapType2Select S (invRecv8 o_3))) (not (= (invRecv8 o_3) null))) (< NoPerm (U_2_real (MapType0Select Heap@@9 (invRecv8 o_3) k)))) (qpRange8 o_3)) (= (invRecv8 o_3) o_3)))
 :qid |stdinbpl.1061:22|
 :skolemid |133|
 :pattern ( (invRecv8 o_3))
))) (and (=> (= (ControlFlow 0 21) (- 0 24)) (forall ((s_5@@2 T@U) ) (!  (=> (= (type s_5@@2) RefType) (=> (and (U_2_bool (MapType2Select S s_5@@2)) (not (= s_5@@2 null))) (>= (U_2_real (MapType0Select Heap@@9 s_5@@2 k)) NoPerm)))
 :qid |stdinbpl.1067:15|
 :skolemid |134|
 :pattern ( (MapType0Select Heap@@9 s_5@@2 f_7))
 :pattern ( (MapType1Select QPMask@1 s_5@@2 f_7))
 :pattern ( (MapType2Select S s_5@@2))
))) (=> (forall ((s_5@@3 T@U) ) (!  (=> (= (type s_5@@3) RefType) (=> (and (U_2_bool (MapType2Select S s_5@@3)) (not (= s_5@@3 null))) (>= (U_2_real (MapType0Select Heap@@9 s_5@@3 k)) NoPerm)))
 :qid |stdinbpl.1067:15|
 :skolemid |134|
 :pattern ( (MapType0Select Heap@@9 s_5@@3 f_7))
 :pattern ( (MapType1Select QPMask@1 s_5@@3 f_7))
 :pattern ( (MapType2Select S s_5@@3))
)) (=> (and (forall ((s_5@@4 T@U) ) (!  (=> (= (type s_5@@4) RefType) (=> (and (and (U_2_bool (MapType2Select S s_5@@4)) (not (= s_5@@4 null))) (> (U_2_real (MapType0Select Heap@@9 s_5@@4 k)) NoPerm)) (not (= s_5@@4 null))))
 :qid |stdinbpl.1073:22|
 :skolemid |135|
 :pattern ( (MapType0Select Heap@@9 s_5@@4 f_7))
 :pattern ( (MapType1Select QPMask@1 s_5@@4 f_7))
 :pattern ( (MapType2Select S s_5@@4))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (U_2_bool (MapType2Select S (invRecv8 o_3@@0))) (not (= (invRecv8 o_3@@0) null))) (< NoPerm (U_2_real (MapType0Select Heap@@9 (invRecv8 o_3@@0) k)))) (qpRange8 o_3@@0)) (and (=> (< NoPerm (U_2_real (MapType0Select Heap@@9 (invRecv8 o_3@@0) k))) (= (invRecv8 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType0Select Heap@@9 (invRecv8 o_3@@0) k)))))) (=> (not (and (and (and (U_2_bool (MapType2Select S (invRecv8 o_3@@0))) (not (= (invRecv8 o_3@@0) null))) (< NoPerm (U_2_real (MapType0Select Heap@@9 (invRecv8 o_3@@0) k)))) (qpRange8 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7))))))
...
)) (state Heap@@9 QPMask@1)) (and (state Heap@@9 QPMask@1) (U_2_bool (MapType2Select S a_2)))) (and (and (U_2_bool (MapType2Select S b_2)) (state Heap@@9 QPMask@1)) (and (not (= a_2 b_2)) (state Heap@@9 QPMask@1)))) (and (=> (= (ControlFlow 0 21) (- 0 23)) (HasDirectPerm QPMask@1 a_2 k)) (=> (HasDirectPerm QPMask@1 a_2 k) (=> (= perm@0 (U_2_real (MapType0Select Heap@@9 a_2 k))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 21) 18) anon20_Then_correct) (=> (= (ControlFlow 0 21) 20) anon20_Else_correct))))))))))))))))
(let ((anon9_correct true))
(let ((anon19_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select S s_10)) (not (= s_10 null)))) (= (ControlFlow 0 9) 6)) anon9_correct)))
(let ((anon19_Then_correct  (=> (and (U_2_bool (MapType2Select S s_10)) (not (= s_10 null))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm QPMask@0 s_10 k)) (=> (HasDirectPerm QPMask@0 s_10 k) (=> (= (ControlFlow 0 7) 6) anon9_correct))))))
(let ((anon16_Else_correct  (=> (and (forall ((s_3 T@U) ) (!  (=> (and (= (type s_3) RefType) (U_2_bool (MapType2Select S s_3))) (< NoPerm (U_2_real (MapType0Select Heap@@9 s_3 k))))
 :qid |stdinbpl.1035:20|
 :skolemid |130|
 :pattern ( (MapType2Select S s_3))
)) (state Heap@@9 QPMask@0)) (and (and (=> (= (ControlFlow 0 26) 21) anon18_Else_correct) (=> (= (ControlFlow 0 26) 7) anon19_Then_correct)) (=> (= (ControlFlow 0 26) 9) anon19_Else_correct)))))
(let ((anon5_correct true))
(let ((anon17_Else_correct  (=> (and (not (U_2_bool (MapType2Select S s_9))) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon17_Then_correct  (=> (U_2_bool (MapType2Select S s_9)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 s_9 k)) (=> (HasDirectPerm QPMask@0 s_9 k) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) (forall ((s_1 T@U) (s_1_1 T@U) ) (!  (=> (and (= (type s_1) RefType) (= (type s_1_1) RefType)) (=> (and (and (and (and (not (= s_1 s_1_1)) (U_2_bool (MapType2Select S s_1))) (U_2_bool (MapType2Select S s_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1 s_1_1))))
 :qid |stdinbpl.993:15|
 :skolemid |124|
 :no-pattern (type s_1)
...
)) (=> (forall ((s_1@@1 T@U) ) (!  (=> (= (type s_1@@1) RefType) (=> (and (U_2_bool (MapType2Select S s_1@@1)) (< NoPerm FullPerm)) (and (qpRange7 s_1@@1) (= (invRecv7 s_1@@1) s_1@@1))))
 :qid |stdinbpl.999:22|
 :skolemid |125|
 :pattern ( (MapType0Select Heap@@9 s_1@@1 k))
 :pattern ( (MapType1Select QPMask@0 s_1@@1 k))
 :pattern ( (MapType2Select S s_1@@1))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType2Select S (invRecv7 o_3@@2))) (< NoPerm FullPerm)) (qpRange7 o_3@@2)) (= (invRecv7 o_3@@2) o_3@@2)))
 ...
 :skolemid |127|
 :pattern ( (MapType0Select Heap@@9 s_1@@2 k))
 :pattern ( (MapType1Select QPMask@0 s_1@@2 k))
 :pattern ( (MapType2Select S s_1@@2))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType2Select S (invRecv7 o_3@@3))) (< NoPerm FullPerm)) (qpRange7 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv7 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 k)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 k)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select S (invRecv7 o_3@@3))) (< NoPerm FullPerm)) (qpRange7 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 k)) (U_2_real (MapType1Select ZeroMask o_3@@3 k))))))
 :qid |stdinbpl.1015:22|
 :skolemid |128|
 :pattern ( (MapType1Select QPMask@0 o_3@@3 k))
)) (forall ((o_3@@4 T@U) (f_5@@0 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_5@@0))))
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 k))) (= (U_2_real (MapType1Select ZeroMask o_3@@4 f_5@@0)) (U_2_real (MapType1Select QPMask@0 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.1019:29|
 :skolemid |129|
 :pattern ( (MapType1Select ZeroMask o_3@@4 f_5@@0))
 :pattern ( (MapType1Select QPMask@0 o_3@@4 f_5@@0))
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 27) 26) anon16_Else_correct) (=> (= (ControlFlow 0 27) 3) anon17_Then_correct)) (=> (= (ControlFlow 0 27) 5) anon17_Else_correct)))))))))
(let ((anon15_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 a_2 $allocated)) (U_2_bool (MapType0Select Heap@@9 b_2 $allocated))) (and (=> (= (ControlFlow 0 29) 1) anon15_Then_correct) (=> (= (ControlFlow 0 29) 27) anon15_Else_correct))))))
