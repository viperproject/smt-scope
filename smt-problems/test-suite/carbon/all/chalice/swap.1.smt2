...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type F) (FieldType NormalFieldType intType))) (= (type G) (FieldType NormalFieldType intType))))
(assert (distinct $allocated F G)
)
...
(assert  (not (IsPredicateField F)))
(assert  (not (IsWandField F)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type this) RefType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type PostMask@1) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id n)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon6_correct  (=> (= Mask@3 (MapType1Store Mask@2 this G (real_2_U (- (U_2_real (MapType1Select Mask@2 this G)) FullPerm)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (= (U_2_int (MapType0Select Heap@1 this F)) (U_2_int (MapType0Select Heap@@9 this G)))) (=> (= (U_2_int (MapType0Select Heap@1 this F)) (U_2_int (MapType0Select Heap@@9 this G))) (=> (= (ControlFlow 0 7) (- 0 6)) (= (U_2_int (MapType0Select Heap@1 this G)) (U_2_int (MapType0Select Heap@@9 this F)))))))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 7)) anon6_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@2 this G)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 this G))) (=> (= (ControlFlow 0 9) 7) anon6_correct))))))
(let ((anon4_correct  (=> (= Mask@2 (MapType1Store Mask@1 this F (real_2_U (- (U_2_real (MapType1Select Mask@1 this F)) FullPerm)))) (and (=> (= (ControlFlow 0 12) 9) anon9_Then_correct) (=> (= (ControlFlow 0 12) 11) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 15) 12)) anon4_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= FullPerm (U_2_real (MapType1Select Mask@1 this F)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 this F))) (=> (= (ControlFlow 0 13) 12) anon4_correct))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 20)) (HasDirectPerm Mask@1 this F)) (=> (HasDirectPerm Mask@1 this F) (=> (and (= tmp@0 (U_2_int (MapType0Select Heap@@9 this F))) (state Heap@@9 Mask@1)) (and (=> (= (ControlFlow 0 16) (- 0 19)) (HasDirectPerm Mask@1 this G)) (=> (HasDirectPerm Mask@1 this G) (and (=> (= (ControlFlow 0 16) (- 0 18)) (= FullPerm (U_2_real (MapType1Select Mask@1 this F)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 this F))) (=> (and (= Heap@0 (MapType0Store Heap@@9 this F (MapType0Select Heap@@9 this G))) (state Heap@0 Mask@1)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (= FullPerm (U_2_real (MapType1Select Mask@1 this G)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 this G))) (=> (and (= Heap@1 (MapType0Store Heap@0 this G (int_2_U tmp@0))) (state Heap@1 Mask@1)) (and (=> (= (ControlFlow 0 16) 13) anon8_Then_correct) (=> (= (ControlFlow 0 16) 15) anon8_Else_correct)))))))))))))))
(let ((anon7_Then_correct  (=> (and (and (and (state PostHeap@0 ZeroMask) (not (= this null))) (and (= PostMask@0 (MapType1Store ZeroMask this F (real_2_U (+ (U_2_real (MapType1Select ZeroMask this F)) FullPerm)))) (state PostHeap@0 PostMask@0))) (and (and (not (= this null)) (= PostMask@1 (MapType1Store PostMask@0 this G (real_2_U (+ (U_2_real (MapType1Select PostMask@0 this G)) FullPerm))))) (and (state PostHeap@0 PostMask@1) (state PostHeap@0 PostMask@1)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm PostMask@1 this F)) (=> (HasDirectPerm PostMask@1 this F) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@1 this G)) (=> (HasDirectPerm Mask@1 this G) (=> (= (U_2_int (MapType0Select PostHeap@0 this F)) (U_2_int (MapType0Select Heap@@9 this G))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm PostMask@1 this G)) (=> (HasDirectPerm PostMask@1 this G) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@1 this F))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@9 this $allocated)) (not (= this null))) (and (= Mask@0 (MapType1Store ZeroMask this F (real_2_U (+ (U_2_real (MapType1Select ZeroMask this F)) FullPerm)))) (state Heap@@9 Mask@0))) (and (and (not (= this null)) (= Mask@1 (MapType1Store Mask@0 this G (real_2_U (+ (U_2_real (MapType1Select Mask@0 this G)) FullPerm))))) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1)))) (and (=> (= (ControlFlow 0 21) 2) anon7_Then_correct) (=> (= (ControlFlow 0 21) 16) anon7_Else_correct))))))
