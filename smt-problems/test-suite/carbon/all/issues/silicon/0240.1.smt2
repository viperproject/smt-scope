...
(assert  (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type this@@21) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@21) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Heap@1) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon4_correct  (=> (and (= perm@2 (* FullPerm (/ (to_real 1) (to_real 2)))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@2 NoPerm))))
(let ((anon6_Else_correct  (=> (HasDirectPerm Mask@1 null (bla this@@21)) (=> (and (= Heap@1 Heap@@21) (= (ControlFlow 0 4) 2)) anon4_correct))))
(let ((anon6_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (bla this@@21))) (= Heap@0 (MapType0Store Heap@@21 null (bla this@@21) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 3) 2))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (bla this@@21) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (bla this@@21))) perm@1)))) (and (=> (= (ControlFlow 0 5) 3) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (= perm@1 NoPerm) (= (ControlFlow 0 8) 5)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= perm@1 NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= perm@1 (U_2_real (MapType1Select Mask@0 null (bla this@@21))))) (=> (<= perm@1 (U_2_real (MapType1Select Mask@0 null (bla this@@21)))) (=> (= (ControlFlow 0 6) 5) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@21 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@21 this@@21 $allocated)) (= perm@0 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (= Mask@0 (MapType1Store ZeroMask null (bla this@@21) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (bla this@@21))) perm@0)))) (state Heap@@21 Mask@0)) (=> (and (and (state Heap@@21 Mask@0) (|bla#trigger| Heap@@21 (bla this@@21))) (and (= (MapType0Select Heap@@21 null (bla this@@21)) (MapType0Select Heap@@21 null (list this@@21))) (= perm@1 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (and (=> (= (ControlFlow 0 9) 6) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct)))))))))))
