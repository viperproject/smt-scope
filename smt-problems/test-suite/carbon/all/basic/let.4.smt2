...
(assert (forall ((Heap@@2 T@U) (x@@9 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type x@@9) RefType)) (dummyFunction (int_2_U (|fun01#triggerStateless| x@@9))))
 :qid |stdinbpl.201:15|
 :skolemid |23|
 :pattern ( (|fun01'| Heap@@2 x@@9))
)))
(assert (forall ((Heap@@3 T@U) (x@@10 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type x@@10) RefType)) (dummyFunction (int_2_U (|fun02#triggerStateless| x@@10))))
 :qid |stdinbpl.304:15|
 :skolemid |28|
 :pattern ( (|fun02'| Heap@@3 x@@10))
)))
...
(assert (forall ((Heap@@6 T@U) (x@@12 T@U) ) (!  (=> (and (= (type Heap@@6) (MapType0Type RefType)) (= (type x@@12) RefType)) (and (= (fun01 Heap@@6 x@@12) (|fun01'| Heap@@6 x@@12)) (dummyFunction (int_2_U (|fun01#triggerStateless| x@@12)))))
 :qid |stdinbpl.197:15|
 :skolemid |22|
 :pattern ( (fun01 Heap@@6 x@@12))
)))
(assert (forall ((Heap@@7 T@U) (x@@13 T@U) ) (!  (=> (and (= (type Heap@@7) (MapType0Type RefType)) (= (type x@@13) RefType)) (and (= (fun02 Heap@@7 x@@13) (|fun02'| Heap@@7 x@@13)) (dummyFunction (int_2_U (|fun02#triggerStateless| x@@13)))))
 :qid |stdinbpl.300:15|
 :skolemid |27|
 :pattern ( (fun02 Heap@@7 x@@13))
)))
...
(assert (forall ((Heap@@10 T@U) (Mask@@5 T@U) (x@@16 T@U) ) (!  (=> (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@5) (MapType1Type RefType realType))) (= (type x@@16) RefType)) (and (state Heap@@10 Mask@@5) (< AssumeFunctionsAbove 0))) (= (fun02 Heap@@10 x@@16) (+ (U_2_int (MapType0Select Heap@@10 x@@16 g)) (U_2_int (MapType0Select Heap@@10 x@@16 g)))))
 :qid |stdinbpl.310:15|
 :skolemid |29|
 :pattern ( (state Heap@@10 Mask@@5) (fun02 Heap@@10 x@@16))
)))
...
(assert (forall ((Heap@@13 T@U) (Mask@@10 T@U) (x@@18 T@U) ) (!  (=> (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type x@@18) RefType)) (state Heap@@13 Mask@@10)) (= (|fun01'| Heap@@13 x@@18) (|fun01#frame| (MapType0Select Heap@@13 null (P x@@18)) x@@18)))
 :qid |stdinbpl.214:15|
 :skolemid |25|
 :pattern ( (state Heap@@13 Mask@@10) (|fun01'| Heap@@13 x@@18))
)))
(assert (forall ((arg0@@28 T@U) ) (! (= (type (FrameFragment arg0@@28)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@28))
)))
(assert (forall ((Heap@@14 T@U) (Mask@@11 T@U) (x@@19 T@U) ) (!  (=> (and (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (= (type x@@19) RefType)) (state Heap@@14 Mask@@11)) (= (|fun02'| Heap@@14 x@@19) (|fun02#frame| (FrameFragment (MapType0Select Heap@@14 x@@19 g)) x@@19)))
 :qid |stdinbpl.317:15|
 :skolemid |30|
 :pattern ( (state Heap@@14 Mask@@11) (|fun02'| Heap@@14 x@@19))
)))
...
(assert (forall ((Heap@@17 T@U) (Mask@@12 T@U) (x@@21 T@U) ) (!  (=> (and (and (and (= (type Heap@@17) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (= (type x@@21) RefType)) (and (state Heap@@17 Mask@@12) (< AssumeFunctionsAbove 1))) (= (fun01 Heap@@17 x@@21) (U_2_int (MapType0Select Heap@@17 x@@21 g))))
 :qid |stdinbpl.207:15|
 :skolemid |24|
 :pattern ( (state Heap@@17 Mask@@12) (fun01 Heap@@17 x@@21))
 :pattern ( (state Heap@@17 Mask@@12) (|fun01#triggerStateless| x@@21) (|P#trigger| Heap@@17 (P x@@21)))
)))
...
(assert (forall ((Heap@@18 T@U) (Mask@@13 T@U) (x@@22 T@U) ) (!  (=> (and (and (and (= (type Heap@@18) (MapType0Type RefType)) (= (type Mask@@13) (MapType1Type RefType realType))) (= (type x@@22) RefType)) (and (state Heap@@18 Mask@@13) (or (< AssumeFunctionsAbove 1) (|fun01#trigger| (MapType0Select Heap@@18 null (P x@@22)) x@@22)))) (> (|fun01'| Heap@@18 x@@22) 0))
 :qid |stdinbpl.220:15|
 :skolemid |26|
 :pattern ( (state Heap@@18 Mask@@13) (|fun01'| Heap@@18 x@@22))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
...
(assert  (and (and (and (and (and (= (type Heap@@19) (MapType0Type RefType)) (= (type x@@23) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id |fun01#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@19 x@@23 $allocated)) (= AssumeFunctionsAbove 1)) (and (> wildcard@0 NoPerm) (= Mask@0 (MapType1Store ZeroMask null (P x@@23) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@23))) wildcard@0)))))) (and (and (state Heap@@19 Mask@0) (state Heap@@19 Mask@0)) (and (|P#trigger| Heap@@19 (P x@@23)) (= (MapType0Select Heap@@19 null (P x@@23)) (FrameFragment (MapType0Select Heap@@19 x@@23 g)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (> (U_2_real (MapType1Select Mask@0 null (P x@@23))) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@0 null (P x@@23))) NoPerm) (=> (> wildcard@1 NoPerm) (=> (and (and (and (< wildcard@1 (U_2_real (MapType1Select Mask@0 null (P x@@23)))) (= UnfoldingMask@0 (MapType1Store Mask@0 null (P x@@23) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P x@@23))) wildcard@1))))) (and (> wildcard@2 NoPerm) (not (= x@@23 null)))) (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x@@23 g (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@23 g)) wildcard@2)))) (state Heap@@19 UnfoldingMask@1)) (and (= (U_2_int (MapType0Select Heap@@19 x@@23 g)) 1) (state Heap@@19 UnfoldingMask@1)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm UnfoldingMask@1 x@@23 g)) (=> (HasDirectPerm UnfoldingMask@1 x@@23 g) (=> (and (and (= Heap@0 (MapType0Store Heap@@19 null (|P#sm| x@@23) (MapType1Store (MapType0Select Heap@@19 null (|P#sm| x@@23)) x@@23 g (bool_2_U true)))) (state Heap@0 Mask@0)) (and (= Result@0 (U_2_int (MapType0Select Heap@0 x@@23 g))) (= (ControlFlow 0 2) (- 0 1)))) (> Result@0 0))))))))))))
