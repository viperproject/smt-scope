...
(declare-fun P2 (Int) T@U)
(declare-fun PredicateType_P2Type () T@T)
(declare-fun |loopkup'| (T@U T@U) T@U)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |loopkup#triggerStateless| (T@U) T@U)
(declare-fun SnapDomainTypeType () T@T)
...
(declare-fun |loopkup#frame| (T@U T@U) T@U)
...
(assert (forall ((address T@U) ) (!  (=> (= (type address) RefType) (IsPredicateField (P1 address)))
 :qid |stdinbpl.264:15|
 :skolemid |26|
 :pattern ( (P1 address))
)))
(assert  (and (= (Ctor PredicateType_P2Type) 12) (forall ((arg0@@26 Int) ) (! (= (type (P2 arg0@@26)) (FieldType PredicateType_P2Type FrameTypeType))
 :qid |funType:P2|
 :pattern ( (P2 arg0@@26))
))))
(assert (forall ((index Int) ) (! (IsPredicateField (P2 index))
 :qid |stdinbpl.299:15|
 :skolemid |32|
 :pattern ( (P2 index))
)))
(assert  (and (and (= (Ctor SnapDomainTypeType) 13) (forall ((arg0@@27 T@U) (arg1@@9 T@U) ) (! (= (type (|loopkup'| arg0@@27 arg1@@9)) SnapDomainTypeType)
 :qid |funType:loopkup'|
 :pattern ( (|loopkup'| arg0@@27 arg1@@9))
))) (forall ((arg0@@28 T@U) ) (! (= (type (|loopkup#triggerStateless| arg0@@28)) SnapDomainTypeType)
 :qid |funType:loopkup#triggerStateless|
 :pattern ( (|loopkup#triggerStateless| arg0@@28))
))))
(assert (forall ((Heap@@2 T@U) (address@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type address@@0) RefType)) (dummyFunction (|loopkup#triggerStateless| address@@0)))
 :qid |stdinbpl.214:15|
 :skolemid |23|
 :pattern ( (|loopkup'| Heap@@2 address@@0))
)))
(assert (forall ((Heap@@3 T@U) (address@@1 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type address@@1) RefType)) (|P1#everUsed| (P1 address@@1)))
 :qid |stdinbpl.283:15|
 :skolemid |30|
 :pattern ( (|P1#trigger| Heap@@3 (P1 address@@1)))
)))
(assert (forall ((Heap@@4 T@U) (index@@0 Int) ) (!  (=> (= (type Heap@@4) (MapType0Type RefType)) (|P2#everUsed| (P2 index@@0)))
 :qid |stdinbpl.318:15|
 :skolemid |36|
 :pattern ( (|P2#trigger| Heap@@4 (P2 index@@0)))
)))
...
(assert (forall ((arg0@@29 T@U) (arg1@@10 T@U) ) (! (= (type (loopkup arg0@@29 arg1@@10)) SnapDomainTypeType)
 :qid |funType:loopkup|
 :pattern ( (loopkup arg0@@29 arg1@@10))
)))
(assert (forall ((Heap@@6 T@U) (address@@2 T@U) ) (!  (=> (and (= (type Heap@@6) (MapType0Type RefType)) (= (type address@@2) RefType)) (and (= (loopkup Heap@@6 address@@2) (|loopkup'| Heap@@6 address@@2)) (dummyFunction (|loopkup#triggerStateless| address@@2))))
 :qid |stdinbpl.210:15|
 :skolemid |22|
 :pattern ( (loopkup Heap@@6 address@@2))
)))
(assert (forall ((address@@3 T@U) (address2 T@U) ) (!  (=> (and (and (= (type address@@3) RefType) (= (type address2) RefType)) (= (P1 address@@3) (P1 address2))) (= address@@3 address2))
 :qid |stdinbpl.274:15|
 :skolemid |28|
 :pattern ( (P1 address@@3) (P1 address2))
)))
(assert (forall ((arg0@@30 T@U) ) (! (= (type (|P1#sm| arg0@@30)) (FieldType PredicateType_P1Type (MapType1Type RefType boolType)))
 :qid |funType:P1#sm|
 :pattern ( (|P1#sm| arg0@@30))
)))
(assert (forall ((address@@4 T@U) (address2@@0 T@U) ) (!  (=> (and (and (= (type address@@4) RefType) (= (type address2@@0) RefType)) (= (|P1#sm| address@@4) (|P1#sm| address2@@0))) (= address@@4 address2@@0))
 :qid |stdinbpl.278:15|
 :skolemid |29|
...
(assert (forall ((arg0@@31 Int) ) (! (= (type (|P2#sm| arg0@@31)) (FieldType PredicateType_P2Type (MapType1Type RefType boolType)))
 :qid |funType:P2#sm|
 :pattern ( (|P2#sm| arg0@@31))
)))
...
(assert (forall ((address@@5 T@U) ) (!  (=> (= (type address@@5) RefType) (= (getPredWandId (P1 address@@5)) 0))
 :qid |stdinbpl.268:15|
 :skolemid |27|
 :pattern ( (P1 address@@5))
)))
(assert (forall ((index@@3 Int) ) (! (= (getPredWandId (P2 index@@3)) 1)
 :qid |stdinbpl.303:15|
 :skolemid |33|
 :pattern ( (P2 index@@3))
)))
...
(assert (forall ((arg0@@33 T@U) (arg1@@12 T@U) ) (! (= (type (|loopkup#frame| arg0@@33 arg1@@12)) SnapDomainTypeType)
 :qid |funType:loopkup#frame|
 :pattern ( (|loopkup#frame| arg0@@33 arg1@@12))
)))
(assert (forall ((Heap@@11 T@U) (Mask@@9 T@U) (address@@6 T@U) ) (!  (=> (and (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (= (type address@@6) RefType)) (state Heap@@11 Mask@@9)) (= (|loopkup'| Heap@@11 address@@6) (|loopkup#frame| (MapType0Select Heap@@11 null (P1 address@@6)) address@@6)))
 :qid |stdinbpl.221:15|
 :skolemid |24|
 :pattern ( (state Heap@@11 Mask@@9) (|loopkup'| Heap@@11 address@@6))
)))
...
(assert (forall ((address@@7 T@U) ) (!  (=> (= (type address@@7) RefType) (= (PredicateMaskField (P1 address@@7)) (|P1#sm| address@@7)))
 :qid |stdinbpl.260:15|
 :skolemid |25|
 :pattern ( (PredicateMaskField (P1 address@@7)))
)))
(assert (forall ((index@@4 Int) ) (! (= (PredicateMaskField (P2 index@@4)) (|P2#sm| index@@4))
 :qid |stdinbpl.295:15|
 :skolemid |31|
 :pattern ( (PredicateMaskField (P2 index@@4)))
)))
...
(declare-fun address@@8 () T@U)
(declare-fun marcoAddress () T@U)
(declare-fun marco () Real)
(assert  (and (and (and (and (and (= (type QPMask@0) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@14) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type address@@8) RefType)) (= (type marcoAddress) RefType)))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (forall ((index_2_1 Int) ) (! (= (U_2_real (MapType1Select QPMask@0 null (P2 index_2_1))) (U_2_real (MapType1Select Mask@0 null (P2 index_2_1))))
 :qid |stdinbpl.400:22|
 :skolemid |37|
 :pattern ( (MapType1Select QPMask@0 null (P2 index_2_1)))
)) (=> (and (and (forall ((o_3 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (or (or (not (= o_3 null)) (not (IsPredicateField f_5))) (not (= (getPredWandId f_5) 1)))) (= (U_2_real (MapType1Select Mask@0 o_3 f_5)) (U_2_real (MapType1Select QPMask@0 o_3 f_5))))))
 :qid |stdinbpl.406:29|
 :skolemid |38|
 :pattern ( (MapType1Select Mask@0 o_3 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3 f_5))
)) (IdenticalOnKnownLocations Heap@@14 ExhaleHeap@0 QPMask@0)) (and (state ExhaleHeap@0 QPMask@0) (= (ControlFlow 0 3) (- 0 2)))) false))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@14 address@@8 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@14 marcoAddress $allocated)) (<= NoPerm marco)) (and (state Heap@@14 ZeroMask) (state Heap@@14 ZeroMask))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (>= marco NoPerm)) (=> (>= marco NoPerm) (=> (= Mask@0 (MapType1Store ZeroMask null (P1 marcoAddress) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P1 marcoAddress))) marco)))) (=> (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0)) (=> (and (and (state Heap@@14 Mask@0) (<= marco NoPerm)) (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))))))))
