...
(let ((anon17_Then_correct  (=> (f2 Heap@@33 0) (and (=> (= (ControlFlow 0 8) 5) anon18_Then_correct) (=> (= (ControlFlow 0 8) 6) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (not (f2 Heap@@33 0)) (= (ControlFlow 0 4) 3)) anon12_correct)))
(let ((anon16_Then_correct true))
(let ((anon6_correct  (=> (and (state Heap@@33 ZeroMask) (state Heap@@33 ZeroMask)) (and (and (=> (= (ControlFlow 0 9) 2) anon16_Then_correct) (=> (= (ControlFlow 0 9) 8) anon17_Then_correct)) (=> (= (ControlFlow 0 9) 4) anon17_Else_correct)))))
...
(let ((anon14_Then_correct  (=> (f2 Heap@@33 0) (and (=> (= (ControlFlow 0 13) 11) anon15_Then_correct) (=> (= (ControlFlow 0 13) 12) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (not (f2 Heap@@33 0)) (= (ControlFlow 0 10) 9)) anon6_correct)))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (> (|Seq#Length| A@@12) 10)) (and (state Heap@@33 ZeroMask) (state Heap@@33 ZeroMask))) (and (and (=> (= (ControlFlow 0 14) 1) anon13_Then_correct) (=> (= (ControlFlow 0 14) 13) anon14_Then_correct)) (=> (= (ControlFlow 0 14) 10) anon14_Else_correct))))))
