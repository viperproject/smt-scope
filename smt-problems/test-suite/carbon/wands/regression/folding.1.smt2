...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type p_1@@3) RefType)) (= (type ResultHeap) (MapType0Type RefType))) (= (type ResultMask@@0) (MapType1Type RefType realType))) (= (type Used_1Mask@3) (MapType1Type RefType realType))) (= (type Ops_1Mask@1) (MapType1Type RefType realType))) (= (type Ops_1Heap@0) (MapType0Type RefType))) (= (type Used_1Heap@0) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Used_1Mask@1) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@@14) (MapType0Type RefType))) (= (type Used_1Mask@2) (MapType1Type RefType realType))) (= (type TempMask@1) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Used_1Mask@0) (MapType1Type RefType realType))) (= (type TempMask@0) (MapType1Type RefType realType))) (= (type Ops_1Mask@0) (MapType1Type RefType realType))) (= (type UsedHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test00)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 35) (let ((anon23_correct true))
(let ((anon37_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon23_correct)))
(let ((anon37_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select ResultMask@@0 null (Pair p_1@@3))))) (=> (<= FullPerm (U_2_real (MapType1Select ResultMask@@0 null (Pair p_1@@3)))) (=> (= (ControlFlow 0 10) 9) anon23_correct))))))
(let ((anon24_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (=> (and (and b_1_1@3 b_1_1@3) b_2_1@6) (> (sum ResultHeap p_1@@3) 0)))))
(let ((anon35_Then_correct  (=> b_1_1@3 (and (and (=> (= (ControlFlow 0 13) 6) anon24_correct) (=> (= (ControlFlow 0 13) 10) anon37_Then_correct)) (=> (= (ControlFlow 0 13) 12) anon37_Else_correct)))))
(let ((anon35_Else_correct  (=> (and (not b_1_1@3) (= (ControlFlow 0 8) 6)) anon24_correct)))
(let ((anon34_Then_correct  (=> (and (and b_1_1@3 b_1_1@3) b_2_1@6) (and (=> (= (ControlFlow 0 14) 13) anon35_Then_correct) (=> (= (ControlFlow 0 14) 8) anon35_Else_correct)))))
(let ((anon34_Else_correct  (=> (and (not (and (and b_1_1@3 b_1_1@3) b_2_1@6)) (= (ControlFlow 0 7) 6)) anon24_correct)))
(let ((anon18_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (=> (and (and b_1_1@2 b_1_1@2) b_2_1@6) (and (= neededTransfer@3 0.0) (= (U_2_real (MapType1Select Used_1Mask@3 null (Pair p_1@@3))) initNeededTransfer@0)))) (=> (=> (and (and b_1_1@2 b_1_1@2) b_2_1@6) (and (= neededTransfer@3 0.0) (= (U_2_real (MapType1Select Used_1Mask@3 null (Pair p_1@@3))) initNeededTransfer@0))) (=> (and (= b_3@0  (and b_1_1@2 b_2_1@6)) (= b_3@1  (and b_3@0 (state ResultHeap ResultMask@@0)))) (=> (and (and (= b_3@2  (and b_3@1 (sumMask ResultMask@@0 Ops_1Mask@1 Used_1Mask@3))) (= b_3@3  (and (and b_3@2 (IdenticalOnKnownLocations Ops_1Heap@0 ResultHeap Ops_1Mask@1)) (IdenticalOnKnownLocations Used_1Heap@0 ResultHeap Used_1Mask@3)))) (and (= b_3@4  (and b_3@3 (state ResultHeap ResultMask@@0))) (= b_1_1@3  (and b_1_1@2 b_3@4)))) (and (=> (= (ControlFlow 0 15) 14) anon34_Then_correct) (=> (= (ControlFlow 0 15) 7) anon34_Else_correct))))))))
(let ((anon33_Else_correct  (=> (>= 0.0 takeTransfer@1) (=> (and (= Mask@2 Mask@0) (= neededTransfer@3 neededTransfer@1)) (=> (and (and (= b_2_1@6 b_2_1@3) (= Used_1Mask@3 Used_1Mask@1)) (and (= Heap@1 Heap@@14) (= (ControlFlow 0 19) 15))) anon18_correct)))))
(let ((anon33_Then_correct  (=> (> takeTransfer@1 0.0) (=> (and (= neededTransfer@2 (- neededTransfer@1 takeTransfer@1)) (= Used_1Mask@2 (MapType1Store Used_1Mask@1 null (Pair p_1@@3) (real_2_U (+ (U_2_real (MapType1Select Used_1Mask@1 null (Pair p_1@@3))) takeTransfer@1))))) (=> (and (and (= b_2_1@4  (and b_2_1@3 (state Used_1Heap@0 Used_1Mask@2))) (= TempMask@1 (MapType1Store ZeroMask null (Pair p_1@@3) (real_2_U FullPerm)))) (and (= b_2_1@5  (and b_2_1@4 (IdenticalOnKnownLocations Heap@@14 Used_1Heap@0 TempMask@1))) (= Mask@1 (MapType1Store Mask@0 null (Pair p_1@@3) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (Pair p_1@@3))) takeTransfer@1)))))) (=> (and (and (and (forall ((o_3 T@U) (f_8 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_8))))
(let ((A@@12 (FieldTypeInv0 (type f_8))))
 (=> (and (and (= (type o_3) RefType) (= (type f_8) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@@14 null (|wand#sm| true p_1@@3 FullPerm p_1@@3 0)) o_3 f_8)) (U_2_bool (MapType1Select (MapType0Select Heap@@14 null (|Pair#sm| p_1@@3)) o_3 f_8)))) (U_2_bool (MapType1Select newPMask@0 o_3 f_8)))))
 :qid |stdinbpl.530:35|
 :skolemid |39|
 :pattern ( (MapType1Select newPMask@0 o_3 f_8))
)) (= Heap@0 (MapType0Store Heap@@14 null (|wand#sm| true p_1@@3 FullPerm p_1@@3 0) newPMask@0))) (and (= Mask@2 Mask@1) (= neededTransfer@3 neededTransfer@2))) (and (and (= b_2_1@6 b_2_1@5) (= Used_1Mask@3 Used_1Mask@2)) (and (= Heap@1 Heap@0) (= (ControlFlow 0 18) 15)))) anon18_correct))))))
(let ((anon32_Else_correct  (=> (and (< maskTransfer@1 neededTransfer@1) (= takeTransfer@1 maskTransfer@1)) (and (=> (= (ControlFlow 0 21) 18) anon33_Then_correct) (=> (= (ControlFlow 0 21) 19) anon33_Else_correct)))))
(let ((anon32_Then_correct  (=> (and (<= neededTransfer@1 maskTransfer@1) (= takeTransfer@1 neededTransfer@1)) (and (=> (= (ControlFlow 0 20) 18) anon33_Then_correct) (=> (= (ControlFlow 0 20) 19) anon33_Else_correct)))))
(let ((anon31_Then_correct  (=> (and (and (and (and (and b_1_1@2 b_1_1@2) b_2_1@3) true) (> neededTransfer@1 0.0)) (= maskTransfer@1 (U_2_real (MapType1Select Mask@0 null (Pair p_1@@3))))) (and (=> (= (ControlFlow 0 22) 20) anon32_Then_correct) (=> (= (ControlFlow 0 22) 21) anon32_Else_correct)))))
(let ((anon31_Else_correct  (=> (not (and (and (and (and b_1_1@2 b_1_1@2) b_2_1@3) true) (> neededTransfer@1 0.0))) (=> (and (= Mask@2 Mask@0) (= neededTransfer@3 neededTransfer@1)) (=> (and (and (= b_2_1@6 b_2_1@3) (= Used_1Mask@3 Used_1Mask@1)) (and (= Heap@1 Heap@@14) (= (ControlFlow 0 17) 15))) anon18_correct)))))
(let ((anon30_Else_correct  (=> (>= 0.0 takeTransfer@0) (=> (and (and (= Ops_1Mask@1 ZeroMask) (= Used_1Mask@1 ZeroMask)) (and (= b_2_1@3 b_2_1@0) (= neededTransfer@1 FullPerm))) (and (=> (= (ControlFlow 0 25) 22) anon31_Then_correct) (=> (= (ControlFlow 0 25) 17) anon31_Else_correct))))))
(let ((anon30_Then_correct  (=> (> takeTransfer@0 0.0) (=> (and (= neededTransfer@0 (- FullPerm takeTransfer@0)) (= Used_1Mask@0 (MapType1Store ZeroMask null (Pair p_1@@3) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Pair p_1@@3))) takeTransfer@0))))) (=> (and (and (and (= b_2_1@1  (and b_2_1@0 (state Used_1Heap@0 Used_1Mask@0))) (= TempMask@0 (MapType1Store ZeroMask null (Pair p_1@@3) (real_2_U FullPerm)))) (and (= b_2_1@2  (and b_2_1@1 (IdenticalOnKnownLocations Ops_1Heap@0 Used_1Heap@0 TempMask@0))) (= Ops_1Mask@0 (MapType1Store ZeroMask null (Pair p_1@@3) (real_2_U (- (U_2_real (MapType1Select ZeroMask null (Pair p_1@@3))) takeTransfer@0)))))) (and (and (= Ops_1Mask@1 Ops_1Mask@0) (= Used_1Mask@1 Used_1Mask@0)) (and (= b_2_1@3 b_2_1@2) (= neededTransfer@1 neededTransfer@0)))) (and (=> (= (ControlFlow 0 24) 22) anon31_Then_correct) (=> (= (ControlFlow 0 24) 17) anon31_Else_correct)))))))
(let ((anon29_Else_correct  (=> (and (< maskTransfer@0 FullPerm) (= takeTransfer@0 maskTransfer@0)) (and (=> (= (ControlFlow 0 27) 24) anon30_Then_correct) (=> (= (ControlFlow 0 27) 25) anon30_Else_correct)))))
(let ((anon29_Then_correct  (=> (and (<= FullPerm maskTransfer@0) (= takeTransfer@0 FullPerm)) (and (=> (= (ControlFlow 0 26) 24) anon30_Then_correct) (=> (= (ControlFlow 0 26) 25) anon30_Else_correct)))))
(let ((anon28_Then_correct  (=> (and (and (and (and (and b_1_1@2 b_1_1@2) b_2_1@0) true) (> FullPerm 0.0)) (= maskTransfer@0 (U_2_real (MapType1Select ZeroMask null (Pair p_1@@3))))) (and (=> (= (ControlFlow 0 28) 26) anon29_Then_correct) (=> (= (ControlFlow 0 28) 27) anon29_Else_correct)))))
(let ((anon28_Else_correct  (=> (not (and (and (and (and b_1_1@2 b_1_1@2) b_2_1@0) true) (> FullPerm 0.0))) (=> (and (and (= Ops_1Mask@1 ZeroMask) (= Used_1Mask@1 ZeroMask)) (and (= b_2_1@3 b_2_1@0) (= neededTransfer@1 FullPerm))) (and (=> (= (ControlFlow 0 23) 22) anon31_Then_correct) (=> (= (ControlFlow 0 23) 17) anon31_Else_correct))))))
(let ((anon6_correct  (=> (and (and (= b_1_1@1  (and b_1_1@0 (state Ops_1Heap@0 ZeroMask))) (= b_1_1@2  (and b_1_1@1 (state Ops_1Heap@0 ZeroMask)))) (and (= b_2_1@0  (and b_2_1 (state Used_1Heap@0 ZeroMask))) (= initNeededTransfer@0 (+ (U_2_real (MapType1Select ZeroMask null (Pair p_1@@3))) FullPerm)))) (and (=> (= (ControlFlow 0 29) (- 0 30)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 29) 28) anon28_Then_correct) (=> (= (ControlFlow 0 29) 23) anon28_Else_correct)))))))
(let ((anon27_Else_correct  (=> (and (not b_1_1@0) (= (ControlFlow 0 32) 29)) anon6_correct)))
(let ((anon27_Then_correct  (=> (and b_1_1@0 (= (ControlFlow 0 31) 29)) anon6_correct)))
(let ((anon25_Else_correct  (=> (and (and (> (sum Heap@@14 p_1@@3) 0) (state Heap@@14 Mask@0)) (and (= b_1_1@0  (and b_1_1 (state Ops_1Heap@0 ZeroMask))) (= b_2@0  (and b_2 (state UsedHeap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 33) 31) anon27_Then_correct) (=> (= (ControlFlow 0 33) 32) anon27_Else_correct)))))
(let ((anon3_correct true))
(let ((anon26_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon26_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Pair p_1@@3))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Pair p_1@@3)))) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@14 p_1@@3 $allocated))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (Pair p_1@@3) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Pair p_1@@3))) FullPerm)))) (state Heap@@14 Mask@0)) (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0))) (and (and (=> (= (ControlFlow 0 34) 33) anon25_Else_correct) (=> (= (ControlFlow 0 34) 2) anon26_Then_correct)) (=> (= (ControlFlow 0 34) 4) anon26_Else_correct)))))))
