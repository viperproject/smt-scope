...
(assert  (and (and (= (type this) RefType) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))))
...
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((x_3 Int) (x_3_1 Int) ) (!  (=> (and (and (not (= x_3 x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= this this)))
 :qid |stdinbpl.317:15|
 :skolemid |30|
))) (=> (forall ((x_3@@0 Int) (x_3_1@@0 Int) ) (!  (=> (and (and (not (= x_3@@0 x_3_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= this this)))
 :qid |stdinbpl.317:15|
 :skolemid |30|
)) (=> (and (forall ((x_3@@1 Int) ) (!  (=> (< NoPerm FullPerm) (and (qpRange2 this) (= (invRecv2 this) x_3@@1)))
 :qid |stdinbpl.323:22|
 :skolemid |31|
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (< NoPerm FullPerm) (qpRange2 o_3)) (= this o_3)))
 :qid |stdinbpl.327:22|
 :skolemid |32|
 :pattern ( (invRecv2 o_3))
))) (=> (and (and (not (= this null)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (< NoPerm FullPerm) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= this o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (< NoPerm FullPerm) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.339:22|
 :skolemid |34|
...
)) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 6) 3) anon11_Else_correct) (=> (= (ControlFlow 0 6) 4) anon12_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon12_Else_correct))))))))
(let ((anon10_Then_correct true))
(let ((anon9_Else_correct  (=> (forall ((x_1 Int) ) (!  (=> (> (+ x_1 1) 4) (> x_1 3))
 :qid |stdinbpl.306:20|
 :skolemid |29|
)) (and (=> (= (ControlFlow 0 8) 2) anon10_Then_correct) (=> (= (ControlFlow 0 8) 6) anon10_Else_correct)))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 this $allocated))) (and (=> (= (ControlFlow 0 9) 1) anon9_Then_correct) (=> (= (ControlFlow 0 9) 8) anon9_Else_correct)))))
