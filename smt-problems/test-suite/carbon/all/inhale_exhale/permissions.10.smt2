...
(let ((anon6_Then_correct  (=> (not (= this null)) (=> (and (and (= PostMask@0 (MapType1Store ZeroMask this x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this x@@8)) FullPerm)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (= (ControlFlow 0 3) (- 0 2)))) (HasDirectPerm PostMask@0 this x@@8)))))
