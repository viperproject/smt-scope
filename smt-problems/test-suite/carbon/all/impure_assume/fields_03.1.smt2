...
(declare-fun a_2 () T@U)
(declare-fun x@@8 () T@U)
(assert  (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type y@@1) RefType)) (= (type a_2) RefType)) (= (type x@@8) RefType)))
...
(let ((anon8_correct  (=> (state Heap@@9 Mask@0) (and (=> (= (ControlFlow 0 4) 2) anon15_Then_correct) (=> (= (ControlFlow 0 4) 3) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (not b2) (= (ControlFlow 0 7) 4)) anon8_correct)))
(let ((anon14_Then_correct  (=> b2 (and (=> (= (ControlFlow 0 5) (- 0 6)) (= y@@1 a_2)) (=> (= y@@1 a_2) (=> (= (ControlFlow 0 5) 4) anon8_correct))))))
(let ((anon6_correct  (=> (state Heap@@9 Mask@0) (and (=> (= (ControlFlow 0 8) 5) anon14_Then_correct) (=> (= (ControlFlow 0 8) 7) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (not b1) (= (ControlFlow 0 11) 8)) anon6_correct)))
(let ((anon13_Then_correct  (=> b1 (and (=> (= (ControlFlow 0 9) (- 0 10)) (= x@@8 a_2)) (=> (= x@@8 a_2) (=> (= (ControlFlow 0 9) 8) anon6_correct))))))
(let ((anon4_correct  (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 12) 9) anon13_Then_correct) (=> (= (ControlFlow 0 12) 11) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (not b2) (= (ControlFlow 0 14) 12)) anon4_correct)))
(let ((anon12_Then_correct  (=> b2 (=> (and (<= (__iar__assume_helper_1  (and b1 (= x@@8 y@@1)) FullPerm FullPerm) (U_2_real (MapType1Select Mask@0 y@@1 f_7))) (= (ControlFlow 0 13) 12)) anon4_correct))))
(let ((anon2_correct  (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 15) 13) anon12_Then_correct) (=> (= (ControlFlow 0 15) 14) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (not b1) (= (ControlFlow 0 17) 15)) anon2_correct)))
(let ((anon11_Then_correct  (=> b1 (=> (and (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@8 f_7))) (= (ControlFlow 0 16) 15)) anon2_correct))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 a_2 $allocated))) (and (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated)) (U_2_bool (MapType0Select Heap@@9 y@@1 $allocated)))) (and (and (not (= a_2 null)) (= Mask@0 (MapType1Store ZeroMask a_2 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask a_2 f_7)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)))) (and (=> (= (ControlFlow 0 18) 16) anon11_Then_correct) (=> (= (ControlFlow 0 18) 17) anon11_Else_correct)))))
