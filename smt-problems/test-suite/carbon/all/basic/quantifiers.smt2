...
(declare-fun r_2_1 () T@U)
(declare-fun Heap@@33 () T@U)
(assert  (and (and (and (and (= (type s@@21) (MapType2Type RefType boolType)) (= (type r_2_1) RefType)) (= (type Heap@@33) (MapType0Type RefType))) (= (type r_2) RefType)) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id noQuantifiedPermissionsPost)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon10_correct true))
(let ((anon24_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 13)) anon10_correct)))
(let ((anon24_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (U_2_real (MapType1Select ZeroMask r_2 Cell_x)))) (=> (<= FullPerm (U_2_real (MapType1Select ZeroMask r_2 Cell_x))) (=> (= (ControlFlow 0 14) 13) anon10_correct))))))
(let ((anon6_correct true))
(let ((anon22_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon6_correct)))
(let ((anon22_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select ZeroMask r_2 Cell_x)))) (=> (<= FullPerm (U_2_real (MapType1Select ZeroMask r_2 Cell_x))) (=> (= (ControlFlow 0 10) 9) anon6_correct))))))
(let ((anon11_correct true))
(let ((anon20_Then_correct  (=> (and (U_2_bool (MapType2Select s@@21 r_2)) (not (= r_2 null))) (and (and (and (and (=> (= (ControlFlow 0 17) 7) anon11_correct) (=> (= (ControlFlow 0 17) 14) anon24_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon24_Else_correct)) (=> (= (ControlFlow 0 17) 10) anon22_Then_correct)) (=> (= (ControlFlow 0 17) 12) anon22_Else_correct)))))
(let ((anon20_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select s@@21 r_2)) (not (= r_2 null)))) (= (ControlFlow 0 8) 7)) anon11_correct)))
(let ((anon19_Else_correct true))
(let ((anon18_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (state PostHeap@0 ZeroMask)) (and (and (=> (= (ControlFlow 0 18) 6) anon19_Else_correct) (=> (= (ControlFlow 0 18) 17) anon20_Then_correct)) (=> (= (ControlFlow 0 18) 8) anon20_Else_correct)))))
(let ((anon16_correct true))
(let ((anon26_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select s@@21 r_2_1)) (not (= r_2_1 null)))) (= (ControlFlow 0 5) 2)) anon16_correct)))
(let ((anon26_Then_correct  (=> (and (U_2_bool (MapType2Select s@@21 r_2_1)) (not (= r_2_1 null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (>= (Cell_get Heap@@33 r_2_1) (Cell_get Heap@@33 r_2_1))) (=> (>= (Cell_get Heap@@33 r_2_1) (Cell_get Heap@@33 r_2_1)) (=> (= (ControlFlow 0 3) 2) anon16_correct))))))
(let ((anon25_Else_correct true))
(let ((anon0_correct  (=> (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (and (and (=> (= (ControlFlow 0 19) 18) anon18_Then_correct) (=> (= (ControlFlow 0 19) 1) anon25_Else_correct)) (=> (= (ControlFlow 0 19) 3) anon26_Then_correct)) (=> (= (ControlFlow 0 19) 5) anon26_Else_correct)))))
