...
(declare-fun y@@6 () T@U)
(assert  (and (and (and (= (type Heap@@9) (MapType1Type RefType)) (= (type xs) (MapType0Type RefType boolType))) (= (type Mask@0) (MapType2Type RefType realType))) (= (type y@@6) RefType)))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (and (forall ((x_1 T@U) (i_1 Int) ) (!  (=> (= (type x_1) RefType) (=> (and (U_2_bool (MapType0Select xs x_1)) (< 0 i_1)) (bar i_1)))
 :qid |stdinbpl.438:20|
 :skolemid |82|
 :pattern ( (foo i_1 (U_2_int (MapType1Select Heap@@9 x_1 f_7))))
)) (state Heap@@9 Mask@0)) (=> (and (and (state Heap@@9 Mask@0) (U_2_bool (MapType0Select xs y@@6))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm Mask@0 y@@6 f_7)) (=> (HasDirectPerm Mask@0 y@@6 f_7) (=> (and (and (foo 1 (U_2_int (MapType1Select Heap@@9 y@@6 f_7))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (= (ControlFlow 0 3) (- 0 2)))) (bar 1))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType1Select Heap@@9 y@@6 $allocated)) (not (= y@@6 null))) (=> (and (and (= Mask@0 (MapType2Store ZeroMask y@@6 f_7 (real_2_U (+ (U_2_real (MapType2Select ZeroMask y@@6 f_7)) FullPerm)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct)))))))
