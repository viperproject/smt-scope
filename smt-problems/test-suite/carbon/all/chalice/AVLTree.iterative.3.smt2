...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@@18) (MapType0Type RefType)) (= (type this@@53) RefType)) (= (type Mask@11) (MapType1Type RefType realType))) (= (type Mask@10) (MapType1Type RefType realType))) (= (type Mask@12) (MapType1Type RefType realType))) (= (type Mask@9) (MapType1Type RefType realType))) (= (type Mask@8) (MapType1Type RefType realType))) (= (type Mask@7) (MapType1Type RefType realType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |udValid#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon8_correct true))
(let ((anon12_Else_correct  (=> (not (=> (U_2_bool (MapType0Select Heap@@18 this@@53 leftDown)) false)) (=> (and (= Mask@12 Mask@10) (= (ControlFlow 0 3) 1)) anon8_correct))))
(let ((anon12_Then_correct  (=> (=> (U_2_bool (MapType0Select Heap@@18 this@@53 leftDown)) false) (=> (and (and (= Mask@11 (MapType1Store Mask@10 null (rightOpen this@@53) (real_2_U (+ (U_2_real (MapType1Select Mask@10 null (rightOpen this@@53))) FullPerm)))) (state Heap@@18 Mask@11)) (and (= Mask@12 Mask@11) (= (ControlFlow 0 2) 1))) anon8_correct))))
(let ((anon6_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@10 this@@53 leftDown)) (=> (HasDirectPerm Mask@10 this@@53 leftDown) (and (=> (= (ControlFlow 0 4) 2) anon12_Then_correct) (=> (= (ControlFlow 0 4) 3) anon12_Else_correct))))))
(let ((anon11_Else_correct  (=> (not (=> (U_2_bool (MapType0Select Heap@@18 this@@53 leftDown)) false)) (=> (and (= Mask@10 Mask@8) (= (ControlFlow 0 7) 4)) anon6_correct))))
(let ((anon11_Then_correct  (=> (=> (U_2_bool (MapType0Select Heap@@18 this@@53 leftDown)) false) (=> (and (and (= Mask@9 (MapType1Store Mask@8 null (leftValid this@@53) (real_2_U (+ (U_2_real (MapType1Select Mask@8 null (leftValid this@@53))) FullPerm)))) (state Heap@@18 Mask@9)) (and (= Mask@10 Mask@9) (= (ControlFlow 0 6) 4))) anon6_correct))))
(let ((anon4_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm Mask@8 this@@53 leftDown)) (=> (HasDirectPerm Mask@8 this@@53 leftDown) (and (=> (= (ControlFlow 0 8) 6) anon11_Then_correct) (=> (= (ControlFlow 0 8) 7) anon11_Else_correct))))))
(let ((anon10_Else_correct  (=> (not (U_2_bool (MapType0Select Heap@@18 this@@53 leftDown))) (=> (and (= Mask@8 Mask@6) (= (ControlFlow 0 11) 8)) anon4_correct))))
(let ((anon10_Then_correct  (=> (U_2_bool (MapType0Select Heap@@18 this@@53 leftDown)) (=> (and (and (= Mask@7 (MapType1Store Mask@6 null (leftOpen this@@53) (real_2_U (+ (U_2_real (MapType1Select Mask@6 null (leftOpen this@@53))) FullPerm)))) (state Heap@@18 Mask@7)) (and (= Mask@8 Mask@7) (= (ControlFlow 0 10) 8))) anon4_correct))))
(let ((anon2_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm Mask@6 this@@53 leftDown)) (=> (HasDirectPerm Mask@6 this@@53 leftDown) (and (=> (= (ControlFlow 0 12) 10) anon10_Then_correct) (=> (= (ControlFlow 0 12) 11) anon10_Else_correct))))))
(let ((anon9_Else_correct  (=> (not (U_2_bool (MapType0Select Heap@@18 this@@53 leftDown))) (=> (and (= Mask@6 Mask@4) (= (ControlFlow 0 15) 12)) anon2_correct))))
(let ((anon9_Then_correct  (=> (U_2_bool (MapType0Select Heap@@18 this@@53 leftDown)) (=> (and (and (= Mask@5 (MapType1Store Mask@4 null (rightValid this@@53) (real_2_U (+ (U_2_real (MapType1Select Mask@4 null (rightValid this@@53))) FullPerm)))) (state Heap@@18 Mask@5)) (and (= Mask@6 Mask@5) (= (ControlFlow 0 14) 12))) anon2_correct))))
(let ((anon0_correct  (=> (and (state Heap@@18 ZeroMask) (U_2_bool (MapType0Select Heap@@18 this@@53 $allocated))) (=> (and (and (not (= this@@53 null)) (= Mask@0 (MapType1Store ZeroMask this@@53 key (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@53 key)) FullPerm))))) (and (state Heap@@18 Mask@0) (= perm@0 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 16) (- 0 21)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= this@@53 null))) (= Mask@1 (MapType1Store Mask@0 this@@53 leftDown (real_2_U (+ (U_2_real (MapType1Select Mask@0 this@@53 leftDown)) perm@0))))) (and (state Heap@@18 Mask@1) (= perm@1 (/ (to_real 1) (to_real 4))))) (and (=> (= (ControlFlow 0 16) (- 0 20)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (and (=> (> perm@1 NoPerm) (not (= this@@53 null))) (= Mask@2 (MapType1Store Mask@1 this@@53 left (real_2_U (+ (U_2_real (MapType1Select Mask@1 this@@53 left)) perm@1))))) (and (state Heap@@18 Mask@2) (= perm@2 (/ (to_real 1) (to_real 4))))) (and (=> (= (ControlFlow 0 16) (- 0 19)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (and (and (=> (> perm@2 NoPerm) (not (= this@@53 null))) (= Mask@3 (MapType1Store Mask@2 this@@53 right (real_2_U (+ (U_2_real (MapType1Select Mask@2 this@@53 right)) perm@2))))) (and (state Heap@@18 Mask@3) (= perm@3 (/ (to_real 1) (to_real 5))))) (and (=> (= (ControlFlow 0 16) (- 0 18)) (>= perm@3 NoPerm)) (=> (>= perm@3 NoPerm) (=> (=> (> perm@3 NoPerm) (not (= this@@53 null))) (=> (and (= Mask@4 (MapType1Store Mask@3 this@@53 root (real_2_U (+ (U_2_real (MapType1Select Mask@3 this@@53 root)) perm@3)))) (state Heap@@18 Mask@4)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm Mask@4 this@@53 leftDown)) (=> (HasDirectPerm Mask@4 this@@53 leftDown) (and (=> (= (ControlFlow 0 16) 14) anon9_Then_correct) (=> (= (ControlFlow 0 16) 15) anon9_Else_correct)))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 22) 16) anon0_correct)))
