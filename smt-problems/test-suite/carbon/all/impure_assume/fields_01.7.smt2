...
(assert  (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type x@@8) RefType)) (= (type y@@1) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@9 y@@1 $allocated)) (< NoPerm px)) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (and (< NoPerm py) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (= perm@0 (/ (to_real 1) (to_real 10)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= x@@8 null))) (=> (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) perm@0)))) (state Heap@@9 Mask@0)) (=> (and (and (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (<= px (U_2_real (MapType1Select Mask@0 x@@8 f_7))) (state Heap@@9 Mask@0))) (and (and (state Heap@@9 Mask@0) (<= (__iar__assume_helper_1 (= x@@8 y@@1) px py) (U_2_real (MapType1Select Mask@0 y@@1 f_7)))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= px (/ (to_real 1) (to_real 10)))) (=> (<= px (/ (to_real 1) (to_real 10))) (=> (and (state Heap@@9 Mask@0) (= (ControlFlow 0 2) (- 0 1))) (= y@@1 x@@8)))))))))))))
