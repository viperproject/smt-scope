(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 19:58:00
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/issues/silicon/0688.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(push) ; 5
(set-option :timeout 10)
(assert (not (not (= marco@1@01 $Perm.No))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
; (get-info :all-statistics)
(assert (< $k@7@01 marco@1@01))
(assert (<= $Perm.No (- marco@1@01 $k@7@01)))
(set-option :timeout 0)
(push) ; 5
(set-option :timeout 10)
...
(assert (and
  (< $k@7@01 marco@1@01)
  (<= $Perm.No (- marco@1@01 $k@7@01))
  (loopkup%precondition $t@4@01 address@0@01)))
(assert ($Perm.isReadVar $k@7@01))
(assert (< $k@7@01 marco@1@01))
(assert (<= $Perm.No (- marco@1@01 $k@7@01)))
(assert (loopkup%precondition $t@4@01 address@0@01))
