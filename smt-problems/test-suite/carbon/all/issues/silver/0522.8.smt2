...
(assert  (and (and (and (= (type xs) (MapType2Type RefType boolType)) (= (type Heap@@14) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv1 arg0@@48)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_1 T@U) (x_1_2 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_2) RefType)) (=> (and (and (and (and (not (= x_1 x_1_2)) (U_2_bool (MapType2Select xs x_1))) (U_2_bool (MapType2Select xs x_1_2))) (< NoPerm p_1@@5)) (< NoPerm p_1@@5)) (not (= x_1 x_1_2))))
 :qid |stdinbpl.914:15|
 :skolemid |97|
 :no-pattern (type x_1)
...
))) (=> (forall ((x_1@@0 T@U) (x_1_2@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_2@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_2@@0)) (U_2_bool (MapType2Select xs x_1@@0))) (U_2_bool (MapType2Select xs x_1_2@@0))) (< NoPerm p_1@@5)) (< NoPerm p_1@@5)) (not (= x_1@@0 x_1_2@@0))))
 :qid |stdinbpl.914:15|
 :skolemid |97|
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs x_1@@1)) (< NoPerm p_1@@5)) (and (qpRange1 x_1@@1) (= (invRecv1 x_1@@1) x_1@@1))))
 :qid |stdinbpl.920:22|
 :skolemid |98|
 :pattern ( (MapType0Select Heap@@14 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
 :pattern ( (MapType2Select xs x_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv1 o_3))) (< NoPerm p_1@@5)) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.924:22|
 :skolemid |99|
 :pattern ( (invRecv1 o_3))
)) (= (ControlFlow 0 3) (- 0 2))) (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (U_2_bool (MapType2Select xs x_1@@2))) (>= p_1@@5 NoPerm))
 :qid |stdinbpl.930:15|
 :skolemid |100|
