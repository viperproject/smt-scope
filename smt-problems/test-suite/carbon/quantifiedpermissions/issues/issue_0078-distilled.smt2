...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (Ctor RefType) 8)) (= (type left) (FieldType NormalFieldType RefType))) (forall ((arg0@@14 T@T) (arg1@@2 T@T) ) (! (= (Ctor (MapType0Type arg0@@14 arg1@@2)) 9)
...
(= (type (MapType0Store arg0@@18 arg1@@6 arg2)) (MapType0Type aVar0 aVar1@@0))))
 ...
 :weight 0
)))) (= (type all) (FieldType NormalFieldType (MapType0Type RefType boolType)))))
(assert (distinct $allocated left all)
)
...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType2Select QPMask@1 x@@19 left)))) (=> (<= FullPerm (U_2_real (MapType2Select QPMask@1 x@@19 left))) (=> (= (ControlFlow 0 2) 1) anon6_correct))))))
...
)) (=> (and (forall ((q@@1 T@U) ) (!  (=> (= (type q@@1) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) q@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange3 q@@1) (= (invRecv3 q@@1) q@@1))))
 :qid |stdinbpl.644:22|
 :skolemid |105|
...
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) (invRecv3 o_3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange3 o_3)) (= (invRecv3 o_3) o_3)))
 :qid |stdinbpl.648:22|
 :skolemid |106|
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) (invRecv3 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange3 o_3@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv3 o_3@@0) o_3@@0)) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 left)) (+ (U_2_real (MapType2Select Mask@2 o_3@@0 left)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) (invRecv3 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange3 o_3@@0))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 left)) (U_2_real (MapType2Select Mask@2 o_3@@0 left))))))
 :qid |stdinbpl.666:22|
 :skolemid |109|
...
)) (state Heap@1 QPMask@0))) (and (=> (= (ControlFlow 0 5) (- 0 9)) (forall ((s@@3 T@U) (s_3 T@U) ) (!  (=> (and (= (type s@@3) RefType) (= (type s_3) RefType)) (=> (and (and (and (and (not (= s@@3 s_3)) (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) s@@3)) (= (MapType1Select Heap@1 s@@3 left) null))) (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) s_3)) (= (MapType1Select Heap@1 s_3 left) null))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= s@@3 s_3))))
 :qid |stdinbpl.678:15|
 :skolemid |111|
 :no-pattern (type s@@3)
 :no-pattern (type s_3)
 :no-pattern (U_2_int s@@3)
 :no-pattern (U_2_bool s@@3)
 :no-pattern (U_2_int s_3)
 :no-pattern (U_2_bool s_3)
))) (=> (forall ((s@@4 T@U) (s_3@@0 T@U) ) (!  (=> (and (= (type s@@4) RefType) (= (type s_3@@0) RefType)) (=> (and (and (and (and (not (= s@@4 s_3@@0)) (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) s@@4)) (= (MapType1Select Heap@1 s@@4 left) null))) (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) s_3@@0)) (= (MapType1Select Heap@1 s_3@@0 left) null))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= s@@4 s_3@@0))))
 :qid |stdinbpl.678:15|
 :skolemid |111|
 :no-pattern (type s@@4)
 :no-pattern (type s_3@@0)
 :no-pattern (U_2_int s@@4)
 :no-pattern (U_2_bool s@@4)
 :no-pattern (U_2_int s_3@@0)
 :no-pattern (U_2_bool s_3@@0)
)) (=> (and (forall ((s@@5 T@U) ) (!  (=> (= (type s@@5) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) s@@5)) (= (MapType1Select Heap@1 s@@5 left) null)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange4 s@@5) (= (invRecv4 s@@5) s@@5))))
 :qid |stdinbpl.684:22|
 :skolemid |112|
 :pattern ( (MapType1Select Heap@1 s@@5 left))
 :pattern ( (MapType2Select QPMask@1 s@@5 left))
 :pattern ( (MapType0Select (MapType1Select Heap@1 t_1 all) s@@5))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) (invRecv4 o_3@@2))) (= (MapType1Select Heap@1 (invRecv4 o_3@@2) left) null)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange4 o_3@@2)) (= (invRecv4 o_3@@2) o_3@@2)))
 :qid |stdinbpl.688:22|
 :skolemid |113|
 :pattern ( (invRecv4 o_3@@2))
))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (forall ((s@@6 T@U) ) (!  (=> (= (type s@@6) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) s@@6)) (= (MapType1Select Heap@1 s@@6 left) null)) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.694:15|
 :skolemid |114|
 :pattern ( (MapType1Select Heap@1 s@@6 left))
 :pattern ( (MapType2Select QPMask@1 s@@6 left))
 :pattern ( (MapType0Select (MapType1Select Heap@1 t_1 all) s@@6))
))) (=> (forall ((s@@7 T@U) ) (!  (=> (= (type s@@7) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) s@@7)) (= (MapType1Select Heap@1 s@@7 left) null)) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.694:15|
 :skolemid |114|
 :pattern ( (MapType1Select Heap@1 s@@7 left))
 :pattern ( (MapType2Select QPMask@1 s@@7 left))
 :pattern ( (MapType0Select (MapType1Select Heap@1 t_1 all) s@@7))
)) (=> (and (forall ((s@@8 T@U) ) (!  (=> (= (type s@@8) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) s@@8)) (= (MapType1Select Heap@1 s@@8 left) null)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= s@@8 null))))
 :qid |stdinbpl.700:22|
 :skolemid |115|
 :pattern ( (MapType1Select Heap@1 s@@8 left))
 :pattern ( (MapType2Select QPMask@1 s@@8 left))
 :pattern ( (MapType0Select (MapType1Select Heap@1 t_1 all) s@@8))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) (invRecv4 o_3@@3))) (= (MapType1Select Heap@1 (invRecv4 o_3@@3) left) null)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange4 o_3@@3)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv4 o_3@@3) o_3@@3)) (= (U_2_real (MapType2Select QPMask@1 o_3@@3 left)) (+ (U_2_real (MapType2Select QPMask@0 o_3@@3 left)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) (invRecv4 o_3@@3))) (= (MapType1Select Heap@1 (invRecv4 o_3@@3) left) null)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange4 o_3@@3))) (= (U_2_real (MapType2Select QPMask@1 o_3@@3 left)) (U_2_real (MapType2Select QPMask@0 o_3@@3 left))))))
 :qid |stdinbpl.706:22|
 :skolemid |116|
...
)) (state Heap@1 QPMask@1)) (and (state Heap@1 QPMask@1) (state Heap@1 QPMask@1))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (HasDirectPerm QPMask@1 t_1 all)) (=> (HasDirectPerm QPMask@1 t_1 all) (=> (U_2_bool (MapType0Select (MapType1Select Heap@1 t_1 all) x@@19)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm QPMask@1 x@@19 left)) (=> (HasDirectPerm QPMask@1 x@@19 left) (=> (= (MapType1Select Heap@1 x@@19 left) null) (=> (and (state Heap@1 QPMask@1) (state Heap@1 QPMask@1)) (and (=> (= (ControlFlow 0 5) 2) anon9_Then_correct) (=> (= (ControlFlow 0 5) 4) anon9_Else_correct))))))))))))))))))))))))))
