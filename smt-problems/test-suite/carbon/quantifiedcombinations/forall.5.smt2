...
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type xs) (SeqType RefType)) (= (type Heap@@10) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@37 T@U) ) (! (= (type (invRecv17 arg0@@37)) RefType)
 :qid |funType:invRecv17|
 :pattern ( (invRecv17 arg0@@37))
))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type QPMask@3) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (forall ((arg0@@38 T@U) ) (! (= (type (invRecv15 arg0@@38)) RefType)
 :qid |funType:invRecv15|
 :pattern ( (invRecv15 arg0@@38))
))) (= (type QPMask@4) (MapType1Type RefType realType))) (forall ((arg0@@39 T@U) ) (! (= (type (invRecv14 arg0@@39)) RefType)
 :qid |funType:invRecv14|
 :pattern ( (invRecv14 arg0@@39))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@40 T@U) ) (! (= (type (invRecv13 arg0@@40)) RefType)
 :qid |funType:invRecv13|
 :pattern ( (invRecv13 arg0@@40))
))))
(set-info :boogie-vc-id m4)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon15_Else_correct  (=> (= (ControlFlow 0 11) (- 0 10)) (forall ((x_11 T@U) (x_11_1 T@U) ) (!  (=> (and (= (type x_11) RefType) (= (type x_11_1) RefType)) (=> (and (and (and (and (not (= x_11 x_11_1)) (|Seq#Contains| xs x_11)) (|Seq#Contains| xs x_11_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_11 x_11_1))))
...
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((x_7 T@U) (x_7_1 T@U) ) (!  (=> (and (= (type x_7) RefType) (= (type x_7_1) RefType)) (=> (and (and (and (and (not (= x_7 x_7_1)) (|Seq#Contains| xs x_7)) (|Seq#Contains| xs x_7_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_7 x_7_1))))
...
)) (=> (and (forall ((x_7@@1 T@U) ) (!  (=> (= (type x_7@@1) RefType) (=> (and (|Seq#Contains| xs x_7@@1) (< NoPerm FullPerm)) (and (= (invRecv15 x_7@@1) x_7@@1) (qpRange15 x_7@@1))))
...
)) (forall ((x_8_1 T@U) ) (!  (=> (= (type x_8_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv15 x_8_1)) (< NoPerm FullPerm)) (qpRange15 x_8_1)) (= (invRecv15 x_8_1) x_8_1)))
 :qid |stdinbpl.1520:22|
 :skolemid |151|
 :pattern ( (invRecv15 x_8_1))
))) (=> (and (and (forall ((x_8_1@@0 T@U) ) (!  (=> (= (type x_8_1@@0) RefType) (=> (and (and (|Seq#Contains| xs (invRecv15 x_8_1@@0)) (< NoPerm FullPerm)) (qpRange15 x_8_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv15 x_8_1@@0) x_8_1@@0)) (= (U_2_real (MapType1Select QPMask@4 null (pred x_8_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (pred x_8_1@@0))) FullPerm)))))
 :qid |stdinbpl.1526:22|
 :skolemid |152|
 :pattern ( (MapType1Select QPMask@4 null (pred x_8_1@@0)))
...
))) (and (forall ((x_8_1@@1 T@U) ) (!  (=> (and (= (type x_8_1@@1) RefType) (not (and (and (|Seq#Contains| xs (invRecv15 x_8_1@@1)) (< NoPerm FullPerm)) (qpRange15 x_8_1@@1)))) (= (U_2_real (MapType1Select QPMask@4 null (pred x_8_1@@1))) (U_2_real (MapType1Select ZeroMask null (pred x_8_1@@1)))))
 :qid |stdinbpl.1536:22|
 :skolemid |154|
 :pattern ( (MapType1Select QPMask@4 null (pred x_8_1@@1)))
...
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 7)) (forall ((x_12 T@U) (x_12_1 T@U) ) (!  (=> (and (= (type x_12) RefType) (= (type x_12_1) RefType)) (=> (and (and (and (and (not (= x_12 x_12_1)) (|Seq#Contains| xs x_12)) (|Seq#Contains| xs x_12_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_12 x_12_1))))
 :qid |stdinbpl.1596:17|
 :skolemid |161|
 :pattern ( (neverTriggered17 x_12) (neverTriggered17 x_12_1))
))) (=> (forall ((x_12@@0 T@U) (x_12_1@@0 T@U) ) (!  (=> (and (= (type x_12@@0) RefType) (= (type x_12_1@@0) RefType)) (=> (and (and (and (and (not (= x_12@@0 x_12_1@@0)) (|Seq#Contains| xs x_12@@0)) (|Seq#Contains| xs x_12_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_12@@0 x_12_1@@0))))
 :qid |stdinbpl.1596:17|
 :skolemid |161|
 :pattern ( (neverTriggered17 x_12@@0) (neverTriggered17 x_12_1@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((x_12@@1 T@U) ) (!  (=> (and (= (type x_12@@1) RefType) (|Seq#Contains| xs x_12@@1)) (>= (U_2_real (MapType1Select QPMask@1 null (pred x_12@@1))) FullPerm))
 :qid |stdinbpl.1603:17|
 :skolemid |162|
 :pattern ( (MapType0Select Heap@@10 null (pred x_12@@1)))
 :pattern ( (MapType1Select QPMask@1 null (pred x_12@@1)))
 :pattern ( (|Seq#ContainsTrigger| xs x_12@@1))
 :pattern ( (|Seq#Contains| xs x_12@@1))
))) (=> (forall ((x_12@@2 T@U) ) (!  (=> (and (= (type x_12@@2) RefType) (|Seq#Contains| xs x_12@@2)) (>= (U_2_real (MapType1Select QPMask@1 null (pred x_12@@2))) FullPerm))
 :qid |stdinbpl.1603:17|
 :skolemid |162|
 :pattern ( (MapType0Select Heap@@10 null (pred x_12@@2)))
 :pattern ( (MapType1Select QPMask@1 null (pred x_12@@2)))
 :pattern ( (|Seq#ContainsTrigger| xs x_12@@2))
 :pattern ( (|Seq#Contains| xs x_12@@2))
)) (=> (forall ((x_12@@3 T@U) ) (!  (=> (= (type x_12@@3) RefType) (=> (and (|Seq#Contains| xs x_12@@3) (< NoPerm FullPerm)) (and (= (invRecv17 x_12@@3) x_12@@3) (qpRange17 x_12@@3))))
 :qid |stdinbpl.1609:22|
 :skolemid |163|
 :pattern ( (MapType0Select Heap@@10 null (pred x_12@@3)))
 :pattern ( (MapType1Select QPMask@1 null (pred x_12@@3)))
 :pattern ( (|Seq#ContainsTrigger| xs x_12@@3))
 :pattern ( (|Seq#Contains| xs x_12@@3))
)) (=> (and (and (forall ((x_13_1 T@U) ) (!  (=> (= (type x_13_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv17 x_13_1)) (< NoPerm FullPerm)) (qpRange17 x_13_1)) (= (invRecv17 x_13_1) x_13_1)))
 :qid |stdinbpl.1613:22|
 :skolemid |164|
 :pattern ( (invRecv17 x_13_1))
)) (forall ((x_13_1@@0 T@U) ) (!  (=> (= (type x_13_1@@0) RefType) (=> (and (and (|Seq#Contains| xs (invRecv17 x_13_1@@0)) (< NoPerm FullPerm)) (qpRange17 x_13_1@@0)) (and (= (invRecv17 x_13_1@@0) x_13_1@@0) (= (U_2_real (MapType1Select QPMask@2 null (pred x_13_1@@0))) (- (U_2_real (MapType1Select QPMask@1 null (pred x_13_1@@0))) FullPerm)))))
 :qid |stdinbpl.1619:22|
 :skolemid |165|
 :pattern ( (MapType1Select QPMask@2 null (pred x_13_1@@0)))
))) (and (forall ((x_13_1@@1 T@U) ) (!  (=> (and (= (type x_13_1@@1) RefType) (not (and (and (|Seq#Contains| xs (invRecv17 x_13_1@@1)) (< NoPerm FullPerm)) (qpRange17 x_13_1@@1)))) (= (U_2_real (MapType1Select QPMask@2 null (pred x_13_1@@1))) (U_2_real (MapType1Select QPMask@1 null (pred x_13_1@@1)))))
 :qid |stdinbpl.1623:22|
 :skolemid |166|
 :pattern ( (MapType1Select QPMask@2 null (pred x_13_1@@1)))
...
)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((x_14 T@U) (x_14_2 T@U) ) (!  (=> (and (= (type x_14) RefType) (= (type x_14_2) RefType)) (=> (and (and (and (and (not (= x_14 x_14_2)) (|Seq#Contains| xs x_14)) (|Seq#Contains| xs x_14_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_14 x_14_2))))
 :qid |stdinbpl.1641:17|
 :skolemid |168|
 :pattern ( (neverTriggered18 x_14) (neverTriggered18 x_14_2))
))) (=> (forall ((x_14@@0 T@U) (x_14_2@@0 T@U) ) (!  (=> (and (= (type x_14@@0) RefType) (= (type x_14_2@@0) RefType)) (=> (and (and (and (and (not (= x_14@@0 x_14_2@@0)) (|Seq#Contains| xs x_14@@0)) (|Seq#Contains| xs x_14_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_14@@0 x_14_2@@0))))
 :qid |stdinbpl.1641:17|
 :skolemid |168|
 :pattern ( (neverTriggered18 x_14@@0) (neverTriggered18 x_14_2@@0))
)) (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((x_14@@1 T@U) ) (!  (=> (and (= (type x_14@@1) RefType) (|Seq#Contains| xs x_14@@1)) (>= (U_2_real (MapType1Select QPMask@2 x_14@@1 g)) FullPerm))
 :qid |stdinbpl.1648:17|
 :skolemid |169|
 :pattern ( (MapType0Select Heap@@10 x_14@@1 g))
 :pattern ( (MapType1Select QPMask@3 x_14@@1 g))
 :pattern ( (|Seq#ContainsTrigger| xs x_14@@1))
 :pattern ( (|Seq#Contains| xs x_14@@1))
)))))))))))))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((x_5 T@U) (x_5_1 T@U) ) (!  (=> (and (= (type x_5) RefType) (= (type x_5_1) RefType)) (=> (and (and (and (and (not (= x_5 x_5_1)) (|Seq#Contains| xs x_5)) (|Seq#Contains| xs x_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_5 x_5_1))))
 :qid |stdinbpl.1457:15|
 :skolemid |143|
 :no-pattern (type x_5)
...
)) (=> (forall ((x_5@@1 T@U) ) (!  (=> (= (type x_5@@1) RefType) (=> (and (|Seq#Contains| xs x_5@@1) (< NoPerm FullPerm)) (and (qpRange14 x_5@@1) (= (invRecv14 x_5@@1) x_5@@1))))
 :qid |stdinbpl.1463:22|
 :skolemid |144|
 :pattern ( (MapType0Select Heap@@10 x_5@@1 g))
 :pattern ( (MapType1Select QPMask@1 x_5@@1 g))
 :pattern ( (|Seq#ContainsTrigger| xs x_5@@1))
 :pattern ( (|Seq#Contains| xs x_5@@1))
)) (=> (and (forall ((o_3@@1 T@U) ) (!  (=> (= (type o_3@@1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv14 o_3@@1)) (< NoPerm FullPerm)) (qpRange14 o_3@@1)) (= (invRecv14 o_3@@1) o_3@@1)))
 :qid |stdinbpl.1467:22|
 :skolemid |145|
 :pattern ( (invRecv14 o_3@@1))
)) (forall ((x_5@@2 T@U) ) (!  (=> (and (= (type x_5@@2) RefType) (|Seq#Contains| xs x_5@@2)) (not (= x_5@@2 null)))
 :qid |stdinbpl.1473:22|
 :skolemid |146|
 :pattern ( (MapType0Select Heap@@10 x_5@@2 g))
 :pattern ( (MapType1Select QPMask@1 x_5@@2 g))
 :pattern ( (|Seq#ContainsTrigger| xs x_5@@2))
 :pattern ( (|Seq#Contains| xs x_5@@2))
))) (=> (and (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (and (=> (and (and (|Seq#Contains| xs (invRecv14 o_3@@2)) (< NoPerm FullPerm)) (qpRange14 o_3@@2)) (and (=> (< NoPerm FullPerm) (= (invRecv14 o_3@@2) o_3@@2)) (= (U_2_real (MapType1Select QPMask@1 o_3@@2 g)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@2 g)) FullPerm)))) (=> (not (and (and (|Seq#Contains| xs (invRecv14 o_3@@2)) (< NoPerm FullPerm)) (qpRange14 o_3@@2))) (= (U_2_real (MapType1Select QPMask@1 o_3@@2 g)) (U_2_real (MapType1Select QPMask@0 o_3@@2 g))))))
 :qid |stdinbpl.1479:22|
 :skolemid |147|
 :pattern ( (MapType1Select QPMask@1 o_3@@2 g))
)) (forall ((o_3@@3 T@U) (f_5@@1 T@U) ) (! (let ((B@@13 (FieldTypeInv1 (type f_5@@1))))
(let ((A@@14 (FieldTypeInv0 (type f_5@@1))))
 (=> (and (and (= (type o_3@@3) RefType) (= (type f_5@@1) (FieldType A@@14 B@@13))) (not (= f_5@@1 g))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_5@@1)) (U_2_real (MapType1Select QPMask@1 o_3@@3 f_5@@1))))))
 :qid |stdinbpl.1483:29|
 :skolemid |148|
 :pattern ( (MapType1Select QPMask@0 o_3@@3 f_5@@1))
 :pattern ( (MapType1Select QPMask@1 o_3@@3 f_5@@1))
))) (and (state Heap@@10 QPMask@1) (state Heap@@10 QPMask@1))) (and (=> (= (ControlFlow 0 15) 14) anon13_Then_correct) (=> (= (ControlFlow 0 15) 4) anon13_Else_correct)))))))))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| xs x_1)) (|Seq#Contains| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
...
)) (=> (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| xs x_1@@1) (< NoPerm FullPerm)) (and (= (invRecv13 x_1@@1) x_1@@1) (qpRange13 x_1@@1))))
 :qid |stdinbpl.1424:22|
 :skolemid |138|
 :pattern ( (MapType0Select Heap@@10 null (pred x_1@@1)))
 :pattern ( (MapType1Select ZeroMask null (pred x_1@@1)))
 :pattern ( (|Seq#ContainsTrigger| xs x_1@@1))
 :pattern ( (|Seq#Contains| xs x_1@@1))
)) (forall ((x_2_1 T@U) ) (!  (=> (= (type x_2_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv13 x_2_1)) (< NoPerm FullPerm)) (qpRange13 x_2_1)) (= (invRecv13 x_2_1) x_2_1)))
 :qid |stdinbpl.1428:22|
 :skolemid |139|
 :pattern ( (invRecv13 x_2_1))
))) (=> (and (and (forall ((x_2_1@@0 T@U) ) (!  (=> (= (type x_2_1@@0) RefType) (=> (and (and (|Seq#Contains| xs (invRecv13 x_2_1@@0)) (< NoPerm FullPerm)) (qpRange13 x_2_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv13 x_2_1@@0) x_2_1@@0)) (= (U_2_real (MapType1Select QPMask@0 null (pred x_2_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (pred x_2_1@@0))) FullPerm)))))
 :qid |stdinbpl.1434:22|
 :skolemid |140|
 :pattern ( (MapType1Select QPMask@0 null (pred x_2_1@@0)))
)) (forall ((o_3@@4 T@U) (f_5@@2 T@U) ) (! (let ((B@@14 (FieldTypeInv1 (type f_5@@2))))
(let ((A@@15 (FieldTypeInv0 (type f_5@@2))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@2) (FieldType A@@15 B@@14))) (or (or (not (= o_3@@4 null)) (not (IsPredicateField f_5@@2))) (not (= (getPredWandId f_5@@2) 0)))) (= (U_2_real (MapType1Select ZeroMask o_3@@4 f_5@@2)) (U_2_real (MapType1Select QPMask@0 o_3@@4 f_5@@2))))))
 :qid |stdinbpl.1440:29|
 :skolemid |141|
 :pattern ( (MapType1Select ZeroMask o_3@@4 f_5@@2))
 :pattern ( (MapType1Select QPMask@0 o_3@@4 f_5@@2))
))) (and (forall ((x_2_1@@1 T@U) ) (!  (=> (and (= (type x_2_1@@1) RefType) (not (and (and (|Seq#Contains| xs (invRecv13 x_2_1@@1)) (< NoPerm FullPerm)) (qpRange13 x_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (pred x_2_1@@1))) (U_2_real (MapType1Select ZeroMask null (pred x_2_1@@1)))))
 :qid |stdinbpl.1444:22|
 :skolemid |142|
 :pattern ( (MapType1Select QPMask@0 null (pred x_2_1@@1)))
)) (state Heap@@10 QPMask@0))) (and (=> (= (ControlFlow 0 17) 2) anon12_Then_correct) (=> (= (ControlFlow 0 17) 15) anon12_Else_correct))))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (and (=> (= (ControlFlow 0 19) 1) anon11_Then_correct) (=> (= (ControlFlow 0 19) 17) anon11_Else_correct)))))
