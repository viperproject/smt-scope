...
(assert  (and (and (and (and (and (= (type s@@3) (MapType2Type RefType boolType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type x@@19) RefType)) (= (type z@@0) RefType)) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv1 arg0@@43)) RefType)
...
(let ((anon9_Else_correct  (=> (and (not (U_2_bool (MapType2Select s@@3 z@@0))) (= (ControlFlow 0 8) 5)) anon5_correct)))
(let ((anon9_Then_correct  (=> (U_2_bool (MapType2Select s@@3 z@@0)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm QPMask@0 z@@0 f_7)) (=> (HasDirectPerm QPMask@0 z@@0 f_7) (=> (= (ControlFlow 0 6) 5) anon5_correct))))))
(let ((anon8_Else_correct  (=> (forall ((z_3 T@U) ) (!  (=> (and (= (type z_3) RefType) (U_2_bool (MapType2Select s@@3 z_3))) (= (U_2_int (MapType0Select Heap@@9 z_3 f_7)) 3))
 :qid |stdinbpl.459:20|
 :skolemid |88|
 :pattern ( (MapType2Select s@@3 z_3))
)) (=> (and (and (state Heap@@9 QPMask@0) (U_2_bool (MapType2Select s@@3 x@@19))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 x@@19 f_7)) (=> (HasDirectPerm QPMask@0 x@@19 f_7) (=> (= (ControlFlow 0 3) (- 0 2)) (= (U_2_int (MapType0Select Heap@@9 x@@19 f_7)) 3))))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (U_2_bool (MapType2Select s@@3 z_1))) (U_2_bool (MapType2Select s@@3 z_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1))))
 :qid |stdinbpl.418:15|
 :skolemid |82|
 :no-pattern (type z_1)
...
))) (=> (forall ((z_1@@0 T@U) (z_1_1@@0 T@U) ) (!  (=> (and (= (type z_1@@0) RefType) (= (type z_1_1@@0) RefType)) (=> (and (and (and (and (not (= z_1@@0 z_1_1@@0)) (U_2_bool (MapType2Select s@@3 z_1@@0))) (U_2_bool (MapType2Select s@@3 z_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1@@0 z_1_1@@0))))
 :qid |stdinbpl.418:15|
 :skolemid |82|
...
)) (=> (and (forall ((z_1@@1 T@U) ) (!  (=> (= (type z_1@@1) RefType) (=> (and (U_2_bool (MapType2Select s@@3 z_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 z_1@@1) (= (invRecv1 z_1@@1) z_1@@1))))
 :qid |stdinbpl.424:22|
 :skolemid |83|
 :pattern ( (MapType0Select Heap@@9 z_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@1 f_7))
 :pattern ( (MapType2Select s@@3 z_1@@1))
...
))) (=> (and (and (forall ((z_1@@2 T@U) ) (!  (=> (and (= (type z_1@@2) RefType) (U_2_bool (MapType2Select s@@3 z_1@@2))) (not (= z_1@@2 null)))
 :qid |stdinbpl.434:22|
 :skolemid |85|
 :pattern ( (MapType0Select Heap@@9 z_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@2 f_7))
 :pattern ( (MapType2Select s@@3 z_1@@2))
...
)) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 9) 3) anon8_Else_correct) (=> (= (ControlFlow 0 9) 6) anon9_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon9_Else_correct))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@19 $allocated))) (and (=> (= (ControlFlow 0 11) 1) anon7_Then_correct) (=> (= (ControlFlow 0 11) 9) anon7_Else_correct)))))
