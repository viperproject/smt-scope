...
(assert  (and (= (type Heap@@10) (MapType0Type RefType)) (= (type self@@5) RefType)))
(set-info :boogie-vc-id foo_fail_gist)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 self@@5 $allocated))) (=> (and (and (< NoPerm rd@@5) (< rd@@5 FullPerm)) (and (state Heap@@10 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (< NoPerm (* rd@@5 rd@@5))))))
