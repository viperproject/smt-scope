...
(set-info :boogie-vc-id |i1#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon3_Then_correct  (=> (and (not (= this@@111 null)) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm ZeroMask this@@111 x@@8))))
(let ((anon0_correct  (=> (and (and (state Heap@@121 ZeroMask) (U_2_bool (MapType0Select Heap@@121 this@@111 $allocated))) (and (= AssumeFunctionsAbove 24) (= (ControlFlow 0 3) 2))) anon3_Then_correct)))
...
(set-info :boogie-vc-id |t3Abstract#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon6_Else_correct  (=> (and (not (= this@@111 null)) (= (ControlFlow 0 4) (- 0 3))) (HasDirectPerm Mask@0 this@@111 x@@8))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (not (= this@@111 null)) (=> (and (= Mask@0 (MapType1Store ZeroMask this@@111 x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@111 x@@8)) FullPerm)))) (state Heap@@121 Mask@0)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@0 this@@111 x@@8)) (=> (HasDirectPerm Mask@0 this@@111 x@@8) (=> (and (= (U_2_int (MapType0Select Heap@@121 this@@111 x@@8)) 0) (state Heap@@121 Mask@0)) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@121 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@121 this@@111 $allocated)) (= AssumeFunctionsAbove 4)) (and (=> (= (ControlFlow 0 7) 1) anon5_Then_correct) (=> (= (ControlFlow 0 7) 5) anon5_Else_correct))))))
