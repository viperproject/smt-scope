...
(assert  (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type diz) RefType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id History__empty)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct true))
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (not (= diz null)) (= PostMask@0 (MapType1Store ZeroMask diz History__x (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz History__x)) FullPerm))))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm PostMask@0 diz History__x)) (=> (HasDirectPerm PostMask@0 diz History__x) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@0 diz History__x))))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 diz $allocated))) (and (not (= diz null)) (state Heap@@9 ZeroMask))) (and (and (not (= diz null)) (= Mask@0 (MapType1Store ZeroMask diz History__x (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz History__x)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)))) (and (=> (= (ControlFlow 0 5) 2) anon5_Then_correct) (=> (= (ControlFlow 0 5) 4) anon5_Else_correct)))))
