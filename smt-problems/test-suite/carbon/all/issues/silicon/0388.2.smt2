...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (= i_1 0)) (= i_1_1 0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) false)
 :qid |stdinbpl.372:17|
 :skolemid |39|
