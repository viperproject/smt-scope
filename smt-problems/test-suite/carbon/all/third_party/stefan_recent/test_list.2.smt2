...
(declare-fun |node__contents#trigger| (T@U T@U) Bool)
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@1) (MapType0Type RefType)) (= (type diz@@9) RefType)) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@14) (MapType0Type RefType))) (= (type UnfoldingMask@4) (MapType1Type RefType realType))) (= (type UnfoldingMask@3) (MapType1Type RefType realType))) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (forall ((arg0@@41 T@U) (arg1@@19 T@U) ) (! (= (type (CombineFrames arg0@@41 arg1@@19)) FrameTypeType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 26) (let ((anon9_correct true))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon9_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (node__state (MapType0Select Heap@@14 diz@@9 node__next)))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (node__state (MapType0Select Heap@@14 diz@@9 node__next))))) (=> (= (ControlFlow 0 9) 8) anon9_correct))))))
(let ((anon17_Then_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (not (= (MapType0Select Heap@@14 diz@@9 node__next) null))) (=> (not (= (MapType0Select Heap@@14 diz@@9 node__next) null)) (and (=> (= (ControlFlow 0 12) 9) anon18_Then_correct) (=> (= (ControlFlow 0 12) 11) anon18_Else_correct))))))
(let ((anon13_correct true))
(let ((anon19_Else_correct  (=> (= (MapType0Select Heap@1 diz@@9 node__next) null) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 3) 1)) anon13_correct))))
(let ((anon19_Then_correct  (=> (not (= (MapType0Select Heap@1 diz@@9 node__next) null)) (=> (and (and (forall ((o_3 T@U) (f_7 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_7))))
(let ((A@@12 (FieldTypeInv0 (type f_7))))
 (=> (and (and (= (type o_3) RefType) (= (type f_7) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|node__state#sm| diz@@9)) o_3 f_7)) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|node__state#sm| (MapType0Select Heap@1 diz@@9 node__next))) o_3 f_7)))) (U_2_bool (MapType1Select newPMask@0 o_3 f_7)))))
 :qid |stdinbpl.683:33|
 :skolemid |62|
 :pattern ( (MapType1Select newPMask@0 o_3 f_7))
)) (= Heap@2 (MapType0Store Heap@1 null (|node__state#sm| diz@@9) newPMask@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 2) 1))) anon13_correct))))
(let ((anon11_correct  (=> (and (= Heap@0 (MapType0Store Heap@@14 null (|node__state#sm| diz@@9) (MapType1Store (MapType0Select Heap@@14 null (|node__state#sm| diz@@9)) diz@@9 node__val (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|node__state#sm| diz@@9) (MapType1Store (MapType0Select Heap@0 null (|node__state#sm| diz@@9)) diz@@9 node__next (bool_2_U true))))) (and (=> (= (ControlFlow 0 4) 2) anon19_Then_correct) (=> (= (ControlFlow 0 4) 3) anon19_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (|node__contents#trigger| (MapType0Select Heap@@14 null (node__state (MapType0Select Heap@@14 diz@@9 node__next))) (MapType0Select Heap@@14 diz@@9 node__next)) (= (ControlFlow 0 7) 4)) anon11_correct)))
(let ((anon16_Else_correct  (=> (not (= (MapType0Select Heap@@14 diz@@9 node__next) null)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (HasDirectPerm UnfoldingMask@4 diz@@9 node__val)) (=> (HasDirectPerm UnfoldingMask@4 diz@@9 node__val) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm UnfoldingMask@4 diz@@9 node__next)) (=> (HasDirectPerm UnfoldingMask@4 diz@@9 node__next) (and (=> (= (ControlFlow 0 14) 12) anon17_Then_correct) (=> (= (ControlFlow 0 14) 7) anon17_Else_correct)))))))))
(let ((anon16_Then_correct  (=> (= (MapType0Select Heap@@14 diz@@9 node__next) null) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm UnfoldingMask@4 diz@@9 node__val)) (=> (HasDirectPerm UnfoldingMask@4 diz@@9 node__val) (=> (= (ControlFlow 0 5) 4) anon11_correct))))))
(let ((anon4_correct  (=> (state Heap@@14 UnfoldingMask@4) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm UnfoldingMask@4 diz@@9 node__next)) (=> (HasDirectPerm UnfoldingMask@4 diz@@9 node__next) (and (=> (= (ControlFlow 0 17) 5) anon16_Then_correct) (=> (= (ControlFlow 0 17) 14) anon16_Else_correct)))))))
(let ((anon15_Else_correct  (=> (= (MapType0Select Heap@@14 diz@@9 node__next) null) (=> (and (= UnfoldingMask@4 UnfoldingMask@2) (= (ControlFlow 0 20) 17)) anon4_correct))))
(let ((anon15_Then_correct  (=> (and (not (= (MapType0Select Heap@@14 diz@@9 node__next) null)) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 null (node__state (MapType0Select Heap@@14 diz@@9 node__next)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 null (node__state (MapType0Select Heap@@14 diz@@9 node__next)))) FullPerm))))) (=> (and (and (InsidePredicate (node__state diz@@9) (MapType0Select Heap@@14 null (node__state diz@@9)) (node__state (MapType0Select Heap@@14 diz@@9 node__next)) (MapType0Select Heap@@14 null (node__state (MapType0Select Heap@@14 diz@@9 node__next)))) (state Heap@@14 UnfoldingMask@3)) (and (= UnfoldingMask@4 UnfoldingMask@3) (= (ControlFlow 0 19) 17))) anon4_correct))))
(let ((anon2_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (node__state diz@@9) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (node__state diz@@9))) FullPerm)))) (=> (and (not (= diz@@9 null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 diz@@9 node__val (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 diz@@9 node__val)) FullPerm))))) (=> (and (and (state Heap@@14 UnfoldingMask@1) (not (= diz@@9 null))) (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 diz@@9 node__next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 diz@@9 node__next)) FullPerm)))) (state Heap@@14 UnfoldingMask@2))) (and (=> (= (ControlFlow 0 21) 19) anon15_Then_correct) (=> (= (ControlFlow 0 21) 20) anon15_Else_correct)))))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 24) 21)) anon2_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (node__state diz@@9))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (node__state diz@@9)))) (=> (= (ControlFlow 0 22) 21) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (U_2_bool (MapType0Select Heap@@14 diz@@9 $allocated))) (=> (and (and (and (= AssumeFunctionsAbove 0) (not (= diz@@9 null))) (and (state Heap@@14 ZeroMask) (= Mask@0 (MapType1Store ZeroMask null (node__state diz@@9) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (node__state diz@@9))) FullPerm)))))) (and (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0)) (and (|node__state#trigger| Heap@@14 (node__state diz@@9)) (= (MapType0Select Heap@@14 null (node__state diz@@9)) (CombineFrames (FrameFragment (MapType0Select Heap@@14 diz@@9 node__val)) (CombineFrames (FrameFragment (MapType0Select Heap@@14 diz@@9 node__next)) (FrameFragment (ite (not (= (MapType0Select Heap@@14 diz@@9 node__next) null)) (MapType0Select Heap@@14 null (node__state (MapType0Select Heap@@14 diz@@9 node__next))) EmptyFrame)))))))) (and (=> (= (ControlFlow 0 25) 22) anon14_Then_correct) (=> (= (ControlFlow 0 25) 24) anon14_Else_correct))))))
