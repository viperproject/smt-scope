...
(declare-fun i@@6 () Int)
(declare-fun j@@5 () Int)
(assert  (and (and (and (and (= (type xs) (SeqType RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id m7)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 39) (let ((anon19_correct true))
(let ((anon30_Else_correct  (=> (and (not (and (<= 0 i_7) (< i_7 (|Seq#Length| xs)))) (= (ControlFlow 0 27) 24)) anon19_correct)))
(let ((anon30_Then_correct  (=> (and (<= 0 i_7) (< i_7 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 25) (- 0 26)) (= (U_2_real (MapType1Select QPMask@1 (|Seq#Index| xs i_7) f_7)) NoPerm)) (=> (= (U_2_real (MapType1Select QPMask@1 (|Seq#Index| xs i_7) f_7)) NoPerm) (=> (= (ControlFlow 0 25) 24) anon19_correct))))))
(let ((anon15_correct true))
(let ((anon28_Else_correct  (=> (and (not (and (<= 0 i_6) (< i_6 (|Seq#Length| xs)))) (= (ControlFlow 0 23) 19)) anon15_correct)))
(let ((anon28_Then_correct  (=> (and (<= 0 i_6) (< i_6 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 20) (- 0 22)) (>= i_6 0)) (=> (>= i_6 0) (and (=> (= (ControlFlow 0 20) (- 0 21)) (< i_6 (|Seq#Length| xs))) (=> (< i_6 (|Seq#Length| xs)) (=> (= (ControlFlow 0 20) 19) anon15_correct))))))))
(let ((anon29_Else_correct true))
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 30)) (forall ((i_5 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5 i_5_1)) (and (<= 0 i_5) (< i_5 (|Seq#Length| xs)))) (and (<= 0 i_5_1) (< i_5_1 (|Seq#Length| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_5) (|Seq#Index| xs i_5_1))))
 :qid |stdinbpl.920:17|
 :skolemid |125|
 :pattern ( (neverTriggered2 i_5) (neverTriggered2 i_5_1))
))) (=> (forall ((i_5@@0 Int) (i_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_5@@0 i_5_1@@0)) (and (<= 0 i_5@@0) (< i_5@@0 (|Seq#Length| xs)))) (and (<= 0 i_5_1@@0) (< i_5_1@@0 (|Seq#Length| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_5@@0) (|Seq#Index| xs i_5_1@@0))))
 :qid |stdinbpl.920:17|
 :skolemid |125|
 :pattern ( (neverTriggered2 i_5@@0) (neverTriggered2 i_5_1@@0))
)) (and (=> (= (ControlFlow 0 28) (- 0 29)) (forall ((i_5@@1 Int) ) (!  (=> (and (<= 0 i_5@@1) (< i_5@@1 (|Seq#Length| xs))) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs i_5@@1) f_7)) FullPerm))
 :qid |stdinbpl.927:17|
 :skolemid |126|
 :pattern ( (|Seq#Index| xs i_5@@1))
 :pattern ( (MapType0Select Heap@@9 (|Seq#Index| xs i_5@@1) f_7))
))) (=> (forall ((i_5@@2 Int) ) (!  (=> (and (<= 0 i_5@@2) (< i_5@@2 (|Seq#Length| xs))) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs i_5@@2) f_7)) FullPerm))
 :qid |stdinbpl.927:17|
 :skolemid |126|
 :pattern ( (|Seq#Index| xs i_5@@2))
 :pattern ( (MapType0Select Heap@@9 (|Seq#Index| xs i_5@@2) f_7))
)) (=> (and (forall ((i_5@@3 Int) ) (!  (=> (and (and (<= 0 i_5@@3) (< i_5@@3 (|Seq#Length| xs))) (< NoPerm FullPerm)) (and (qpRange2 (|Seq#Index| xs i_5@@3)) (= (invRecv2 (|Seq#Index| xs i_5@@3)) i_5@@3)))
 :qid |stdinbpl.933:22|
 :skolemid |127|
 :pattern ( (|Seq#Index| xs i_5@@3))
 :pattern ( (MapType0Select Heap@@9 (|Seq#Index| xs i_5@@3) f_7))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (<= 0 (invRecv2 o_3)) (< (invRecv2 o_3) (|Seq#Length| xs))) (and (< NoPerm FullPerm) (qpRange2 o_3))) (= (|Seq#Index| xs (invRecv2 o_3)) o_3)))
 :qid |stdinbpl.937:22|
 :skolemid |128|
 :pattern ( (invRecv2 o_3))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (<= 0 (invRecv2 o_3@@0)) (< (invRecv2 o_3@@0) (|Seq#Length| xs))) (and (< NoPerm FullPerm) (qpRange2 o_3@@0))) (and (= (|Seq#Index| xs (invRecv2 o_3@@0)) o_3@@0) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (- (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (<= 0 (invRecv2 o_3@@0)) (< (invRecv2 o_3@@0) (|Seq#Length| xs))) (and (< NoPerm FullPerm) (qpRange2 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7))))))
 :qid |stdinbpl.943:22|
 :skolemid |129|
...
))) (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 QPMask@1) (state ExhaleHeap@0 QPMask@1))) (and (and (and (and (=> (= (ControlFlow 0 28) 18) anon29_Else_correct) (=> (= (ControlFlow 0 28) 25) anon30_Then_correct)) (=> (= (ControlFlow 0 28) 27) anon30_Else_correct)) (=> (= (ControlFlow 0 28) 20) anon28_Then_correct)) (=> (= (ControlFlow 0 28) 23) anon28_Else_correct))))))))))
(let ((anon11_correct true))
(let ((anon26_Else_correct  (=> (and (not (and (<= 0 i_4) (< i_4 (|Seq#Length| xs)))) (= (ControlFlow 0 17) 13)) anon11_correct)))
(let ((anon26_Then_correct  (=> (and (<= 0 i_4) (< i_4 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< i_4 (|Seq#Length| xs))) (=> (< i_4 (|Seq#Length| xs)) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 36)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 (|Seq#Length| xs)))) (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_3) (|Seq#Index| xs i_3_1))))
 :qid |stdinbpl.841:15|
 :skolemid |119|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (and (<= 0 i_3@@0) (< i_3@@0 (|Seq#Length| xs)))) (and (<= 0 i_3_1@@0) (< i_3_1@@0 (|Seq#Length| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_3@@0) (|Seq#Index| xs i_3_1@@0))))
 :qid |stdinbpl.841:15|
 :skolemid |119|
)) (=> (and (and (and (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 (|Seq#Length| xs))) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index| xs i_3@@1)) (= (invRecv1 (|Seq#Index| xs i_3@@1)) i_3@@1)))
 :qid |stdinbpl.847:22|
 :skolemid |120|
 :pattern ( (|Seq#Index| xs i_3@@1))
 :pattern ( (MapType0Select Heap@@9 (|Seq#Index| xs i_3@@1) f_7))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (<= 0 (invRecv1 o_3@@2)) (< (invRecv1 o_3@@2) (|Seq#Length| xs))) (< NoPerm FullPerm)) (qpRange1 o_3@@2)) (= (|Seq#Index| xs (invRecv1 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.851:22|
 :skolemid |121|
 :pattern ( (invRecv1 o_3@@2))
))) (and (forall ((i_3@@2 Int) ) (!  (=> (and (<= 0 i_3@@2) (< i_3@@2 (|Seq#Length| xs))) (not (= (|Seq#Index| xs i_3@@2) null)))
 :qid |stdinbpl.857:22|
 :skolemid |122|
 :pattern ( (|Seq#Index| xs i_3@@2))
 :pattern ( (MapType0Select Heap@@9 (|Seq#Index| xs i_3@@2) f_7))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (and (<= 0 (invRecv1 o_3@@3)) (< (invRecv1 o_3@@3) (|Seq#Length| xs))) (< NoPerm FullPerm)) (qpRange1 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| xs (invRecv1 o_3@@3)) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_3@@3)) (< (invRecv1 o_3@@3) (|Seq#Length| xs))) (< NoPerm FullPerm)) (qpRange1 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@3 f_7))))))
 :qid |stdinbpl.863:22|
 :skolemid |123|
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (=> (= (ControlFlow 0 31) (- 0 35)) (< 0 (|Seq#Length| xs))) (=> (< 0 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 31) (- 0 34)) (HasDirectPerm QPMask@0 (|Seq#Index| xs 0) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs 0) f_7) (=> (and (= v_2@0 (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs 0) f_7))) (state Heap@@9 QPMask@0)) (and (=> (= (ControlFlow 0 31) (- 0 33)) (< 0 (|Seq#Length| xs))) (=> (< 0 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 31) (- 0 32)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs 0) f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs 0) f_7))) (=> (state Heap@@9 QPMask@0) (and (and (=> (= (ControlFlow 0 31) 28) anon25_Else_correct) (=> (= (ControlFlow 0 31) 14) anon26_Then_correct)) (=> (= (ControlFlow 0 31) 17) anon26_Else_correct)))))))))))))))))
...
)) (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 37) 31) anon23_Else_correct) (=> (= (ControlFlow 0 37) 9) anon24_Then_correct)) (=> (= (ControlFlow 0 37) 12) anon24_Else_correct))))))
...
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (>= (|Seq#Length| xs) 1)) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 38) 37) anon21_Else_correct) (=> (= (ControlFlow 0 38) 2) anon22_Then_correct)) (=> (= (ControlFlow 0 38) 7) anon22_Else_correct)))))
