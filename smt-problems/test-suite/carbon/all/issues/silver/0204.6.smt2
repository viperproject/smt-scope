...
(assert  (and (and (and (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type Ops_3Heap@0) (MapType0Type RefType))) (= (type Ops_3Mask) (MapType1Type RefType realType))) (= (type Used_3Heap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@61 T@U) ) (! (= (type (invRecv5 arg0@@61)) RefType)
 :qid |funType:invRecv5|
 :pattern ( (invRecv5 arg0@@61))
))) (= (type head) RefType)) (= (type Used_2Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon14_Else_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (forall ((n_5 T@U) (n_5_1 T@U) ) (!  (=> (and (= (type n_5) RefType) (= (type n_5_1) RefType)) (=> (and (and (not (= n_5 n_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_5 n_5_1))))
 :qid |stdinbpl.961:19|
 :skolemid |143|
 :no-pattern (type n_5)
...
(let ((anon5_correct  (=> (= b_4@7  (and b_4 (state Ops_3Heap@0 Ops_3Mask))) (=> (and (= b_4@8  (and b_4@7 (state Ops_3Heap@0 Ops_3Mask))) (= b_5@0  (and b_5 (state Used_3Heap@0 ZeroMask)))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (wand FullPerm true) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (wand FullPerm true))) FullPerm)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (and (=> (= (ControlFlow 0 6) 2) anon13_Else_correct) (=> (= (ControlFlow 0 6) 3) anon14_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon14_Else_correct)))))))
...
)) (=> (= b_4@1  (and b_4 (forall ((n_3@@1 T@U) ) (!  (=> (and (= (type n_3@@1) RefType) (< NoPerm FullPerm)) (and (qpRange5 n_3@@1) (= (invRecv5 n_3@@1) n_3@@1)))
 :qid |stdinbpl.902:31|
 :skolemid |138|
 :pattern ( (MapType0Select Ops_3Heap@0 n_3@@1 val))
 :pattern ( (MapType1Select QPMask@0 n_3@@1 val))
)))) (=> (and (= b_4@2  (and b_4@1 (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (< NoPerm FullPerm) (qpRange5 o_3)) (= (invRecv5 o_3) o_3)))
 :qid |stdinbpl.906:31|
 :skolemid |139|
 :pattern ( (invRecv5 o_3))
)))) (= b_4@3  (and b_4@2 (forall ((n_3@@2 T@U) ) (!  (=> (= (type n_3@@2) RefType) (not (= n_3@@2 null)))
 :qid |stdinbpl.912:31|
 :skolemid |140|
 :pattern ( (MapType0Select Ops_3Heap@0 n_3@@2 val))
 :pattern ( (MapType1Select QPMask@0 n_3@@2 val))
))))) (=> (and (and (= b_4@4  (and b_4@3 (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (< NoPerm FullPerm) (qpRange5 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv5 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (< NoPerm FullPerm) (qpRange5 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.918:31|
 :skolemid |141|
 :pattern ( (MapType1Select QPMask@0 o_3@@0 val))
)))) (= b_4@5  (and b_4@4 (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
...
))))) (and (= b_4@6  (and b_4@5 (state Ops_3Heap@0 QPMask@0))) (= (ControlFlow 0 8) 6))) anon5_correct)))))))
(let ((anon11_Else_correct  (=> (and (not b_4@0) (= (ControlFlow 0 11) 8)) anon4_correct)))
(let ((anon11_Then_correct  (=> (and b_4@0 (= (ControlFlow 0 10) 8)) anon4_correct)))
(let ((anon10_Then_correct  (=> b_4@0 (and (=> (= (ControlFlow 0 12) 10) anon11_Then_correct) (=> (= (ControlFlow 0 12) 11) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (not b_4@0) (= (ControlFlow 0 7) 6)) anon5_correct)))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 head $allocated))) (and (= b_4@0  (and b_4 (state Ops_3Heap@0 ZeroMask))) (= b_3@0  (and b_3 (state Used_2Heap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 13) 12) anon10_Then_correct) (=> (= (ControlFlow 0 13) 7) anon10_Else_correct)))))
