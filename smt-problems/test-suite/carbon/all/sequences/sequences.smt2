...
(assert  (and (= (type Heap@@13) (MapType0Type RefType)) (= (type s@0) (SeqType intType))))
(set-info :boogie-vc-id test_build_index_definedness_large)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (trivial Heap@@13 (U_2_int (|Seq#Index| s@0 0))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (>= i@@10 0) (state Heap@@13 ZeroMask)) (and (= s@0 (|Seq#Append| (|Seq#Take| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 3)) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 5))) (|Seq#Singleton| (int_2_U 6))) i@@10) (|Seq#Append| (|Seq#Singleton| (int_2_U 3)) (|Seq#Drop| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 3)) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 5))) (|Seq#Singleton| (int_2_U 6))) (+ i@@10 1))))) (state Heap@@13 ZeroMask))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< 0 (|Seq#Length| s@0))) (=> (< 0 (|Seq#Length| s@0)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))))
