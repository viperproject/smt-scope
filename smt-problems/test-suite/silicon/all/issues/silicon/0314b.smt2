(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 19:54:59
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/issues/silicon/0314b.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (forall ((x@6@01 $Ref) (i@7@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/all/issues/silicon/0314b.vpr@16@10@16@76-aux|)))
(assert (forall ((x@6@01 $Ref) (i@7@01 Int)) (!
  (=> (and (Set_in x@6@01 xs@2@01) (< 0 i@7@01)) (bar<Bool> i@7@01))
  
  :qid |prog./silicon/silver/src/test/resources/all/issues/silicon/0314b.vpr@16@10@16@76|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
