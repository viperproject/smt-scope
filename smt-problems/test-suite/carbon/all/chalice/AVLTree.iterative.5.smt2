...
(assert  (and (and (and (and (and (and (= (type Heap@@18) (MapType0Type RefType)) (= (type this@@53) RefType)) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |validRest#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (and (not (= (MapType0Select Heap@@18 this@@53 right) (MapType0Select Heap@@18 this@@53 left))) (= (ControlFlow 0 4) 1)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (not (= (MapType0Select Heap@@18 this@@53 right) (MapType0Select Heap@@18 this@@53 left)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@4 this@@53 right)) (=> (HasDirectPerm Mask@4 this@@53 right) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@18 ZeroMask) (U_2_bool (MapType0Select Heap@@18 this@@53 $allocated))) (=> (and (and (not (= this@@53 null)) (= Mask@0 (MapType1Store ZeroMask this@@53 key (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@53 key)) FullPerm))))) (and (state Heap@@18 Mask@0) (= perm@0 (/ (to_real 3) (to_real 10))))) (and (=> (= (ControlFlow 0 5) (- 0 10)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= this@@53 null))) (= Mask@1 (MapType1Store Mask@0 this@@53 root (real_2_U (+ (U_2_real (MapType1Select Mask@0 this@@53 root)) perm@0))))) (and (state Heap@@18 Mask@1) (= perm@1 (/ (to_real 3) (to_real 4))))) (and (=> (= (ControlFlow 0 5) (- 0 9)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (and (=> (> perm@1 NoPerm) (not (= this@@53 null))) (= Mask@2 (MapType1Store Mask@1 this@@53 left (real_2_U (+ (U_2_real (MapType1Select Mask@1 this@@53 left)) perm@1))))) (and (state Heap@@18 Mask@2) (= perm@2 (/ (to_real 3) (to_real 4))))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (and (=> (> perm@2 NoPerm) (not (= this@@53 null))) (= Mask@3 (MapType1Store Mask@2 this@@53 right (real_2_U (+ (U_2_real (MapType1Select Mask@2 this@@53 right)) perm@2))))) (=> (and (and (state Heap@@18 Mask@3) (not (= this@@53 null))) (and (= Mask@4 (MapType1Store Mask@3 this@@53 leftDown (real_2_U (+ (U_2_real (MapType1Select Mask@3 this@@53 leftDown)) FullPerm)))) (state Heap@@18 Mask@4))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (HasDirectPerm Mask@4 this@@53 right)) (=> (HasDirectPerm Mask@4 this@@53 right) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@4 this@@53 left)) (=> (HasDirectPerm Mask@4 this@@53 left) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 11) 5) anon0_correct)))
