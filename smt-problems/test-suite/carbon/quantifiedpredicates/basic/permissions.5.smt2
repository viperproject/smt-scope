...
(assert  (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type x@@11) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 x@@11 $allocated))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (pred2 x@@11 p_1@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (pred2 x@@11 p_1@@5))) FullPerm)))) (state Heap@@11 Mask@0)) (and (state Heap@@11 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (not (= x@@11 null))))))
