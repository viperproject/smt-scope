...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@5) (MapType1Type RefType realType)) (= (type this@@5) RefType)) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Heap@3) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (forall ((arg0@@28 T@U) ) (! (= (type (FrameFragment arg0@@28)) FrameTypeType)
...
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@5 null (valid this@@5 true))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@5 null (valid this@@5 true)))) (=> (= (ControlFlow 0 3) 2) anon10_correct))))))
(let ((anon8_correct  (=> (= Mask@4 (MapType1Store Mask@3 this@@5 unrelatedField (real_2_U (- (U_2_real (MapType1Select Mask@3 this@@5 unrelatedField)) FullPerm)))) (=> (and (IdenticalOnKnownLocations Heap@3 ExhaleHeap@0 Mask@4) (not (= this@@5 null))) (=> (and (and (= Mask@5 (MapType1Store Mask@4 this@@5 unrelatedField (real_2_U (+ (U_2_real (MapType1Select Mask@4 this@@5 unrelatedField)) FullPerm)))) (state ExhaleHeap@0 Mask@5)) (and (state ExhaleHeap@0 Mask@5) (state ExhaleHeap@0 Mask@5))) (and (=> (= (ControlFlow 0 6) 3) anon15_Then_correct) (=> (= (ControlFlow 0 6) 5) anon15_Else_correct)))))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon8_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select Mask@3 this@@5 unrelatedField)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 this@@5 unrelatedField))) (=> (= (ControlFlow 0 7) 6) anon8_correct))))))
(let ((anon6_correct  (=> (= Heap@3 (MapType0Store Heap@2 null (|valid#sm| this@@5 true) (MapType1Store (MapType0Select Heap@2 null (|valid#sm| this@@5 true)) this@@5 f_7 (bool_2_U true)))) (=> (and (state Heap@3 Mask@3) (state Heap@3 Mask@3)) (and (=> (= (ControlFlow 0 10) 7) anon14_Then_correct) (=> (= (ControlFlow 0 10) 9) anon14_Else_correct))))))
(let ((anon13_Else_correct  (=> (HasDirectPerm Mask@3 null (valid this@@5 true)) (=> (and (= Heap@2 Heap@@10) (= (ControlFlow 0 12) 10)) anon6_correct))))
(let ((anon13_Then_correct  (=> (not (HasDirectPerm Mask@3 null (valid this@@5 true))) (=> (and (and (= Heap@0 (MapType0Store Heap@@10 null (|valid#sm| this@@5 true) ZeroPMask)) (= Heap@1 (MapType0Store Heap@0 null (valid this@@5 true) freshVersion@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 11) 10))) anon6_correct))))
(let ((anon4_correct  (=> (and (= Mask@2 (MapType1Store Mask@1 this@@5 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 this@@5 f_7)) FullPerm)))) (= Mask@3 (MapType1Store Mask@2 null (valid this@@5 true) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (valid this@@5 true))) FullPerm))))) (=> (and (and (state Heap@@10 Mask@3) (state Heap@@10 Mask@3)) (and (|valid#trigger| Heap@@10 (valid this@@5 true)) (= (MapType0Select Heap@@10 null (valid this@@5 true)) (FrameFragment (FrameFragment (MapType0Select Heap@@10 this@@5 f_7)))))) (and (=> (= (ControlFlow 0 13) 11) anon13_Then_correct) (=> (= (ControlFlow 0 13) 12) anon13_Else_correct))))))
(let ((anon12_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 13)) anon4_correct)))
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (U_2_real (MapType1Select Mask@1 this@@5 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 this@@5 f_7))) (=> (= (ControlFlow 0 14) 13) anon4_correct))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 this@@5 $allocated))) (=> (and (and (and (not (= this@@5 null)) (= Mask@0 (MapType1Store ZeroMask this@@5 unrelatedField (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@5 unrelatedField)) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (and (not (= this@@5 null)) (= Mask@1 (MapType1Store Mask@0 this@@5 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 this@@5 f_7)) FullPerm))))) (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1)))) (and (and (=> (= (ControlFlow 0 17) 1) anon11_Then_correct) (=> (= (ControlFlow 0 17) 14) anon12_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon12_Else_correct))))))
