...
(assert  (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type this) RefType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id test4)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 this x@@8 (real_2_U (- (U_2_real (MapType1Select Mask@0 this x@@8)) FullPerm)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 this x@@8)) (=> (HasDirectPerm Mask@0 this x@@8) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (MapType0Select Heap@@9 this x@@8)) 1)))))))
