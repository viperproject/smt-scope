...
(set-info :boogie-vc-id |valid__Cell#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 self@@5 $allocated)) (= (ControlFlow 0 2) (- 0 1))) (>= rd@@5 NoPerm)))))
