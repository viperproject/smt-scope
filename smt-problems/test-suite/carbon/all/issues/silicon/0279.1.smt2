...
(declare-fun n2_2 () T@U)
(declare-fun n1_2 () T@U)
(declare-fun qpRange2 (T@U) Bool)
(declare-fun invRecv2 (T@U) T@U)
(assert  (and (and (and (and (and (and (and (= (type g) (MapType2Type RefType boolType)) (= (type n1_2) RefType)) (= (type n2_2) RefType)) (= (type Heap@@17) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type n1_1) RefType)) (= (type n2_1) RefType)) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv2 arg0@@45)) RefType)
...
(let ((anon28_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g n1_1)) (U_2_bool (MapType2Select g n2_1)))) (= (ControlFlow 0 20) 16)) anon17_correct)))
(let ((anon28_Then_correct  (=> (and (U_2_bool (MapType2Select g n1_1)) (U_2_bool (MapType2Select g n2_1))) (and (=> (= (ControlFlow 0 17) (- 0 19)) ($ Heap@@17 n1_1)) (=> ($ Heap@@17 n1_1) (and (=> (= (ControlFlow 0 17) (- 0 18)) ($ Heap@@17 n2_1)) (=> ($ Heap@@17 n2_1) (=> (= (ControlFlow 0 17) 16) anon17_correct))))))))
(let ((anon12_correct true))
(let ((anon26_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 10)) anon12_correct)))
(let ((anon26_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 n2_2 car)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 n2_2 car))) (=> (= (ControlFlow 0 11) 10) anon12_correct))))))
(let ((anon7_correct true))
(let ((anon23_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon7_correct)))
(let ((anon23_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 n1_2 car)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 n1_2 car))) (=> (= (ControlFlow 0 7) 6) anon7_correct))))))
(let ((anon13_correct true))
(let ((anon24_Then_correct  (=> ($ Heap@@17 n1_2) (and (and (=> (= (ControlFlow 0 14) 3) anon13_correct) (=> (= (ControlFlow 0 14) 11) anon26_Then_correct)) (=> (= (ControlFlow 0 14) 13) anon26_Else_correct)))))
(let ((anon24_Else_correct  (=> (and (not ($ Heap@@17 n1_2)) (= (ControlFlow 0 5) 3)) anon13_correct)))
(let ((anon21_Then_correct  (=> (and (U_2_bool (MapType2Select g n1_2)) (U_2_bool (MapType2Select g n2_2))) (and (and (and (=> (= (ControlFlow 0 15) 14) anon24_Then_correct) (=> (= (ControlFlow 0 15) 5) anon24_Else_correct)) (=> (= (ControlFlow 0 15) 7) anon23_Then_correct)) (=> (= (ControlFlow 0 15) 9) anon23_Else_correct)))))
(let ((anon21_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g n1_2)) (U_2_bool (MapType2Select g n2_2)))) (= (ControlFlow 0 4) 3)) anon13_correct)))
(let ((anon27_Else_correct true))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((n_1 T@U) (n_1_1 T@U) ) (!  (=> (and (= (type n_1) RefType) (= (type n_1_1) RefType)) (=> (and (and (and (and (not (= n_1 n_1_1)) (U_2_bool (MapType2Select g n_1))) (U_2_bool (MapType2Select g n_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1))))
 :qid |stdinbpl.681:15|
 :skolemid |97|
 :no-pattern (type n_1)
...
)) (=> (forall ((n_1@@1 T@U) ) (!  (=> (= (type n_1@@1) RefType) (=> (and (U_2_bool (MapType2Select g n_1@@1)) (< NoPerm FullPerm)) (and (qpRange2 n_1@@1) (= (invRecv2 n_1@@1) n_1@@1))))
 :qid |stdinbpl.687:22|
 :skolemid |98|
 :pattern ( (MapType0Select Heap@@17 n_1@@1 car))
 :pattern ( (MapType1Select QPMask@0 n_1@@1 car))
 :pattern ( (MapType2Select g n_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select g (invRecv2 o_3))) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.691:22|
 :skolemid |99|
...
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select g (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 car)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 car)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select g (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 car)) (U_2_real (MapType1Select ZeroMask o_3@@0 car))))))
 :qid |stdinbpl.703:22|
 :skolemid |101|
...
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (and (and (and (=> (= (ControlFlow 0 21) 2) anon27_Else_correct) (=> (= (ControlFlow 0 21) 17) anon28_Then_correct)) (=> (= (ControlFlow 0 21) 20) anon28_Else_correct)) (=> (= (ControlFlow 0 21) 15) anon21_Then_correct)) (=> (= (ControlFlow 0 21) 4) anon21_Else_correct)))))))))
(let ((anon19_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 23) 1) anon19_Then_correct) (=> (= (ControlFlow 0 23) 21) anon19_Else_correct)))))
