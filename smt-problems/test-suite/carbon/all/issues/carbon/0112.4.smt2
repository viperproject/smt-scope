...
(set-info :boogie-vc-id |fun13#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (not (= x@@36 0)) (=> (and (state Heap@@75 ZeroMask) (= (ControlFlow 0 4) (- 0 3))) (not (= x@@36 0))))))
(let ((anon3_Then_correct  (=> (and (state Heap@@75 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (not (= x@@36 0)))))
(let ((anon0_correct  (=> (and (state Heap@@75 ZeroMask) (= AssumeFunctionsAbove 7)) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))
...
(declare-fun Heap@@75 () T@U)
(assert (= (type Heap@@75) (MapType0Type RefType)))
(set-info :boogie-vc-id |fun18#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
...
(let ((anon0_correct  (=> (and (state Heap@@75 ZeroMask) (= AssumeFunctionsAbove 6)) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
