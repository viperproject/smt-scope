...
(declare-fun j_6 () Int)
(declare-fun ys () T@U)
(assert  (and (and (and (= (type xs) (SeqType RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type ys) (SeqType intType))))
(set-info :boogie-vc-id test4)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 31) (let ((anon13_correct true))
(let ((anon21_Else_correct  (=> (and (not (and (<= 0 i_11) (< i_11 (|Seq#Length| xs)))) (= (ControlFlow 0 25) 20)) anon13_correct)))
(let ((anon21_Then_correct  (=> (and (<= 0 i_11) (< i_11 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 21) (- 0 24)) (>= i_11 0)) (=> (>= i_11 0) (and (=> (= (ControlFlow 0 21) (- 0 23)) (< i_11 (|Seq#Length| xs))) (=> (< i_11 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (HasDirectPerm QPMask@0 (|Seq#Index| xs i_11) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs i_11) f_7) (=> (= (ControlFlow 0 21) 20) anon13_correct))))))))))
(let ((anon20_Else_correct  (=> (forall ((i_5 Int) ) (!  (=> (and (<= 0 i_5) (< i_5 (|Seq#Length| xs))) (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs i_5) f_7)) 0))
 :qid |stdinbpl.1012:20|
 :skolemid |84|
 :pattern ( (|Seq#Index| xs i_5))
)) (=> (and (and (state Heap@@9 QPMask@0) (> (|Seq#Length| xs) 3)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 16) (- 0 19)) (< 2 (|Seq#Length| xs))) (=> (< 2 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 16) (- 0 18)) (HasDirectPerm QPMask@0 (|Seq#Index| xs 2) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs 2) f_7) (and (=> (= (ControlFlow 0 16) (- 0 17)) (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs 2) f_7)) 0)) (=> (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs 2) f_7)) 0) (=> (and (state Heap@@9 QPMask@0) (= (ControlFlow 0 16) (- 0 15))) false)))))))))))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 28)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 (|Seq#Length| xs)))) (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length| xs)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index| xs i_3) (|Seq#Index| xs i_3_1))))
 :qid |stdinbpl.960:15|
 :skolemid |77|
 ...
 :qid |stdinbpl.960:15|
 :skolemid |77|
)) (=> (and (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 (|Seq#Length| xs))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange3 (|Seq#Index| xs i_3@@1)) (= (invRecv3 (|Seq#Index| xs i_3@@1)) i_3@@1)))
 :qid |stdinbpl.966:22|
 :skolemid |78|
 :pattern ( (|Seq#Index| xs i_3@@1))
 :pattern ( (|Seq#Index| xs i_3@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv3 o_3)) (< (invRecv3 o_3) (|Seq#Length| xs))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange3 o_3)) (= (|Seq#Index| xs (invRecv3 o_3)) o_3)))
 :qid |stdinbpl.970:22|
 :skolemid |79|
 :pattern ( (invRecv3 o_3))
))) (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((i_3@@2 Int) ) (!  (=> (and (<= 0 i_3@@2) (< i_3@@2 (|Seq#Length| xs))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.976:15|
 :skolemid |80|
 ...
 :pattern ( (|Seq#Index| xs i_3@@4))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv3 o_3@@0)) (< (invRecv3 o_3@@0) (|Seq#Length| xs))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange3 o_3@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index| xs (invRecv3 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 0 (invRecv3 o_3@@0)) (< (invRecv3 o_3@@0) (|Seq#Length| xs))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange3 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.988:22|
 :skolemid |82|
...
)) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 26) 16) anon20_Else_correct) (=> (= (ControlFlow 0 26) 21) anon21_Then_correct)) (=> (= (ControlFlow 0 26) 25) anon21_Else_correct))))))))))
(let ((anon9_correct true))
(let ((anon19_Else_correct  (=> (and (not (and (<= 0 i_10) (< i_10 (|Seq#Length| xs)))) (= (ControlFlow 0 12) 8)) anon9_correct)))
(let ((anon19_Then_correct  (=> (and (<= 0 i_10) (< i_10 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_10 0)) (=> (>= i_10 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_10 (|Seq#Length| xs))) (=> (< i_10 (|Seq#Length| xs)) (=> (= (ControlFlow 0 9) 8) anon9_correct))))))))
(let ((anon18_Else_correct  (=> (not (and (<= 0 i_10) (< i_10 (|Seq#Length| xs)))) (and (=> (= (ControlFlow 0 14) 9) anon19_Then_correct) (=> (= (ControlFlow 0 14) 12) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (and (<= 0 i_10) (< i_10 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 13) 9) anon19_Then_correct) (=> (= (ControlFlow 0 13) 12) anon19_Else_correct)))))
...
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 29) 26) anon17_Else_correct) (=> (= (ControlFlow 0 29) 13) anon18_Then_correct)) (=> (= (ControlFlow 0 29) 14) anon18_Else_correct)))))
(let ((anon3_correct true))
(let ((anon16_Else_correct  (=> (and (not (and (<= 0 i_9) (and (< i_9 (|Seq#Length| xs)) (and (<= 0 j_6) (< j_6 (|Seq#Length| xs)))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon16_Then_correct  (=> (and (<= 0 i_9) (and (< i_9 (|Seq#Length| xs)) (and (<= 0 j_6) (< j_6 (|Seq#Length| xs))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_9 0)) (=> (>= i_9 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_9 (|Seq#Length| xs))) (=> (< i_9 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_6 0)) (=> (>= j_6 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_6 (|Seq#Length| xs))) (=> (< j_6 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= (|Seq#Length| xs) (|Seq#Length| ys)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 30) 29) anon15_Else_correct) (=> (= (ControlFlow 0 30) 2) anon16_Then_correct)) (=> (= (ControlFlow 0 30) 7) anon16_Else_correct))))))
