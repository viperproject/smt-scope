...
(assert (forall ((arg1@@13 T@U) (arg2@@7 Real) (arg3@@3 Bool) ) (!  (=> (= (type arg1@@13) RefType) (= (getPredWandId (wand_1 arg1@@13 arg2@@7 arg3@@3)) 1))
 :qid |stdinbpl.235:15|
 :skolemid |34|
 :pattern ( (wand_1 arg1@@13 arg2@@7 arg3@@3))
)))
(assert (forall ((arg1@@14 T@U) (arg2@@8 Real) (arg3@@4 Bool) ) (!  (=> (= (type arg1@@14) RefType) (not (IsPredicateField (wand_1 arg1@@14 arg2@@8 arg3@@4))))
 :qid |stdinbpl.223:15|
 :skolemid |31|
 :pattern ( (wand_1 arg1@@14 arg2@@8 arg3@@4))
)))
(assert (forall ((arg1@@15 T@U) (arg2@@9 Real) (arg3@@5 Bool) ) (!  (=> (= (type arg1@@15) RefType) (not (IsPredicateField (|wand_1#ft| arg1@@15 arg2@@9 arg3@@5))))
 :qid |stdinbpl.227:15|
 :skolemid |32|
 :pattern ( (|wand_1#ft| arg1@@15 arg2@@9 arg3@@5))
)))
(assert  (and (= (Ctor WandType_wandType) 13) (forall ((arg0@@25 Bool) (arg1@@16 Bool) ) (! (= (type (wand arg0@@25 arg1@@16)) (FieldType WandType_wandType intType))
 :qid |funType:wand|
 :pattern ( (wand arg0@@25 arg1@@16))
))))
(assert (forall ((arg1@@17 Bool) (arg2@@10 Bool) ) (! (IsWandField (wand arg1@@17 arg2@@10))
 :qid |stdinbpl.183:15|
 :skolemid |22|
 :pattern ( (wand arg1@@17 arg2@@10))
)))
(assert (forall ((arg0@@26 Bool) (arg1@@18 Bool) ) (! (= (type (|wand#ft| arg0@@26 arg1@@18)) (FieldType WandType_wandType FrameTypeType))
 :qid |funType:wand#ft|
 :pattern ( (|wand#ft| arg0@@26 arg1@@18))
)))
(assert (forall ((arg1@@19 Bool) (arg2@@11 Bool) ) (! (IsWandField (|wand#ft| arg1@@19 arg2@@11))
 :qid |stdinbpl.187:15|
 :skolemid |23|
 :pattern ( (|wand#ft| arg1@@19 arg2@@11))
)))
...
(assert (forall ((arg1@@20 Bool) (arg2@@12 Bool) ) (!  (not (IsPredicateField (wand arg1@@20 arg2@@12)))
 :qid |stdinbpl.191:15|
 :skolemid |24|
 :pattern ( (wand arg1@@20 arg2@@12))
)))
(assert (forall ((arg1@@21 Bool) (arg2@@13 Bool) ) (!  (not (IsPredicateField (|wand#ft| arg1@@21 arg2@@13)))
 :qid |stdinbpl.195:15|
 :skolemid |25|
 :pattern ( (|wand#ft| arg1@@21 arg2@@13))
)))
(assert (forall ((arg1@@22 T@U) (arg2@@14 Real) (arg3@@6 Bool) (arg1_2 T@U) (arg2_2 Real) (arg3_2 Bool) ) (!  (=> (and (and (= (type arg1@@22) RefType) (= (type arg1_2) RefType)) (= (wand_1 arg1@@22 arg2@@14 arg3@@6) (wand_1 arg1_2 arg2_2 arg3_2))) (and (= arg1@@22 arg1_2) (and (= arg2@@14 arg2_2) (= arg3@@6 arg3_2))))
 :qid |stdinbpl.239:15|
 :skolemid |35|
 :pattern ( (wand_1 arg1@@22 arg2@@14 arg3@@6) (wand_1 arg1_2 arg2_2 arg3_2))
)))
(assert (forall ((arg0@@29 T@U) (arg1@@23 Real) (arg2@@15 Bool) ) (! (= (type (|wand_1#sm| arg0@@29 arg1@@23 arg2@@15)) (FieldType WandType_wand_1Type (MapType1Type RefType boolType)))
 :qid |funType:wand_1#sm|
 :pattern ( (|wand_1#sm| arg0@@29 arg1@@23 arg2@@15))
)))
(assert (forall ((arg1@@24 T@U) (arg2@@16 Real) (arg3@@7 Bool) ) (!  (=> (= (type arg1@@24) RefType) (= (|wand_1#sm| arg1@@24 arg2@@16 arg3@@7) (WandMaskField (|wand_1#ft| arg1@@24 arg2@@16 arg3@@7))))
 :qid |stdinbpl.231:15|
 :skolemid |33|
 :pattern ( (WandMaskField (|wand_1#ft| arg1@@24 arg2@@16 arg3@@7)))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (= (type Ops_3Heap@0) (MapType0Type RefType)) (= (type Ops_3Mask@1) (MapType1Type RefType realType))) (= (type Used_2Heap@0) (MapType0Type RefType))) (= (type Ops_1Mask@0) (MapType1Type RefType realType))) (= (type x@@8) RefType)) (= (type Ops_1Heap@0) (MapType0Type RefType))) (= (type Ops_3Mask@0) (MapType1Type RefType realType))) (= (type Used_1Heap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type UsedHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon6_correct true))
(let ((anon5_correct  (=> (= b_3@4  (and b_3@3 (state Ops_3Heap@0 Ops_3Mask@1))) (=> (and (= b_3@5  (and b_3@4 (state Ops_3Heap@0 Ops_3Mask@1))) (= b_4@0  (and b_4 (state Used_2Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> (and (and b_3@5 (and b_3@5 b_1_1@3)) b_4@0) false)) (=> (=> (and (and b_3@5 (and b_3@5 b_1_1@3)) b_4@0) false) (=> (= Ops_1Mask@0 (MapType1Store ZeroMask null (wand_1 x@@8 FullPerm false) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (wand_1 x@@8 FullPerm false))) FullPerm)))) (=> (and (and (= b_1_1@4  (and b_1_1@3 (state Ops_1Heap@0 Ops_1Mask@0))) (= b_1_1@5  (and b_1_1@4 (state Ops_1Heap@0 Ops_1Mask@0)))) (and (= b_1_1@6  (and b_1_1@5 (state Ops_1Heap@0 Ops_1Mask@0))) (= (ControlFlow 0 3) 1))) anon6_correct))))))))
(let ((anon9_Else_correct  (=> (and (and (not b_3@0) (= Ops_3Mask@1 ZeroMask)) (and (= b_3@3 b_3@0) (= (ControlFlow 0 6) 3))) anon5_correct)))
(let ((anon9_Then_correct  (=> b_3@0 (=> (and (= b_3@1  (and b_3@0 (not (= x@@8 null)))) (= Ops_3Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm))))) (=> (and (and (= b_3@2  (and b_3@1 (state Ops_3Heap@0 Ops_3Mask@0))) (= Ops_3Mask@1 Ops_3Mask@0)) (and (= b_3@3 b_3@2) (= (ControlFlow 0 5) 3))) anon5_correct)))))
(let ((anon8_Then_correct  (=> b_1_1@3 (=> (and (= b_3@0  (and b_3 (state Ops_3Heap@0 ZeroMask))) (= b_2_1@0  (and b_2_1 (state Used_1Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 7) 5) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct))))))
(let ((anon8_Else_correct  (=> (and (not b_1_1@3) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon2_correct  (=> (and (= b_1_1@2  (and b_1_1@1 (state Ops_1Heap@0 ZeroMask))) (= b_1_1@3  (and b_1_1@2 (state Ops_1Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 8) 7) anon8_Then_correct) (=> (= (ControlFlow 0 8) 2) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (not b_1_1@0) (=> (and (= b_1_1@1 b_1_1@0) (= (ControlFlow 0 10) 8)) anon2_correct))))
(let ((anon7_Then_correct  (=> b_1_1@0 (=> (and (= b_1_1@1 false) (= (ControlFlow 0 9) 8)) anon2_correct))))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (and (= b_1_1@0  (and b_1_1 (state Ops_1Heap@0 ZeroMask))) (= b_2@0  (and b_2 (state UsedHeap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 11) 9) anon7_Then_correct) (=> (= (ControlFlow 0 11) 10) anon7_Else_correct)))))
