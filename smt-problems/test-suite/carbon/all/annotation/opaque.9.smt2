...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (= tmp@0 (* 3 (|fac2'| Heap@@72 2))))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (and (= tmp@0 (|fac2'| Heap@@72 3)) (state Heap@@72 ZeroMask)) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
