...
(assert  (and (and (and (and (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type vas@0) (SeqType RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type x@@11) RefType)) (= (type a_3) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@35 T@U) ) (! (= (type (invRecv1 arg0@@35)) RefType)
 :qid |funType:invRecv1|
 :pattern ( (invRecv1 arg0@@35))
))) (= (type y@@2) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id m)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon5_correct true))
(let ((anon9_Else_correct  (=> (and (not (|Seq#Contains| vas@0 a_3)) (= (ControlFlow 0 8) 5)) anon5_correct)))
(let ((anon9_Then_correct  (=> (|Seq#Contains| vas@0 a_3) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm Mask@1 a_3 f_7)) (=> (HasDirectPerm Mask@1 a_3 f_7) (=> (= (ControlFlow 0 6) 5) anon5_correct))))))
(let ((anon8_Else_correct  (=> (forall ((a_3_1 T@U) ) (!  (=> (and (= (type a_3_1) RefType) (|Seq#Contains| vas@0 a_3_1)) (> (U_2_int (MapType0Select Heap@@9 a_3_1 f_7)) 0))
 :qid |stdinbpl.671:20|
 :skolemid |64|
 :pattern ( (MapType0Select Heap@@9 a_3_1 f_7))
)) (=> (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm Mask@1 x@@11 f_7)) (=> (HasDirectPerm Mask@1 x@@11 f_7) (=> (= (ControlFlow 0 3) (- 0 2)) (> (U_2_int (MapType0Select Heap@@9 x@@11 f_7)) 0))))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (forall ((a_1 T@U) (a_1_1 T@U) ) (!  (=> (and (= (type a_1) RefType) (= (type a_1_1) RefType)) (=> (and (and (and (and (not (= a_1 a_1_1)) (|Seq#Contains| vas@0 a_1)) (|Seq#Contains| vas@0 a_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1 a_1_1))))
 :qid |stdinbpl.625:17|
 :skolemid |58|
 :pattern ( (neverTriggered1 a_1) (neverTriggered1 a_1_1))
))) (=> (forall ((a_1@@0 T@U) (a_1_1@@0 T@U) ) (!  (=> (and (= (type a_1@@0) RefType) (= (type a_1_1@@0) RefType)) (=> (and (and (and (and (not (= a_1@@0 a_1_1@@0)) (|Seq#Contains| vas@0 a_1@@0)) (|Seq#Contains| vas@0 a_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1@@0 a_1_1@@0))))
 :qid |stdinbpl.625:17|
 :skolemid |58|
 :pattern ( (neverTriggered1 a_1@@0) (neverTriggered1 a_1_1@@0))
)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((a_1@@1 T@U) ) (!  (=> (and (= (type a_1@@1) RefType) (|Seq#Contains| vas@0 a_1@@1)) (>= (U_2_real (MapType1Select Mask@1 a_1@@1 f_7)) FullPerm))
 :qid |stdinbpl.632:17|
 :skolemid |59|
 :pattern ( (MapType0Select Heap@@9 a_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 a_1@@1 f_7))
 :pattern ( (|Seq#ContainsTrigger| vas@0 a_1@@1))
 :pattern ( (|Seq#Contains| vas@0 a_1@@1))
))) (=> (forall ((a_1@@2 T@U) ) (!  (=> (and (= (type a_1@@2) RefType) (|Seq#Contains| vas@0 a_1@@2)) (>= (U_2_real (MapType1Select Mask@1 a_1@@2 f_7)) FullPerm))
 :qid |stdinbpl.632:17|
 :skolemid |59|
 :pattern ( (MapType0Select Heap@@9 a_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 a_1@@2 f_7))
 :pattern ( (|Seq#ContainsTrigger| vas@0 a_1@@2))
 :pattern ( (|Seq#Contains| vas@0 a_1@@2))
)) (=> (forall ((a_1@@3 T@U) ) (!  (=> (= (type a_1@@3) RefType) (=> (and (|Seq#Contains| vas@0 a_1@@3) (< NoPerm FullPerm)) (and (qpRange1 a_1@@3) (= (invRecv1 a_1@@3) a_1@@3))))
 :qid |stdinbpl.638:22|
 :skolemid |60|
 :pattern ( (MapType0Select Heap@@9 a_1@@3 f_7))
 :pattern ( (MapType1Select QPMask@0 a_1@@3 f_7))
 :pattern ( (|Seq#ContainsTrigger| vas@0 a_1@@3))
 :pattern ( (|Seq#Contains| vas@0 a_1@@3))
)) (=> (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (|Seq#Contains| vas@0 (invRecv1 o_3)) (and (< NoPerm FullPerm) (qpRange1 o_3))) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.642:22|
 :skolemid |61|
 :pattern ( (invRecv1 o_3))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (|Seq#Contains| vas@0 (invRecv1 o_3@@0)) (and (< NoPerm FullPerm) (qpRange1 o_3@@0))) (and (= (invRecv1 o_3@@0) o_3@@0) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (- (U_2_real (MapType1Select Mask@1 o_3@@0 f_7)) FullPerm)))) (=> (not (and (|Seq#Contains| vas@0 (invRecv1 o_3@@0)) (and (< NoPerm FullPerm) (qpRange1 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select Mask@1 o_3@@0 f_7))))))
 :qid |stdinbpl.648:22|
 :skolemid |62|
...
)) (state Heap@@9 Mask@1))) (and (and (=> (= (ControlFlow 0 9) 3) anon8_Else_correct) (=> (= (ControlFlow 0 9) 6) anon9_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon9_Else_correct))))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 x@@11 $allocated)) (U_2_bool (MapType0Select Heap@@9 y@@2 $allocated))) (and (not (= x@@11 null)) (= Mask@0 (MapType1Store ZeroMask x@@11 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@11 f_7)) FullPerm)))))) (=> (and (and (and (state Heap@@9 Mask@0) (not (= y@@2 null))) (and (= Mask@1 (MapType1Store Mask@0 y@@2 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@2 f_7)) FullPerm)))) (state Heap@@9 Mask@1))) (and (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1)) (and (= vas@0 (|Seq#Append| (|Seq#Singleton| x@@11) (|Seq#Singleton| y@@2))) (state Heap@@9 Mask@1)))) (and (=> (= (ControlFlow 0 12) 1) anon7_Then_correct) (=> (= (ControlFlow 0 12) 9) anon7_Else_correct)))))))
