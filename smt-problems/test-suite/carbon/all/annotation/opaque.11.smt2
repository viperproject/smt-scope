...
(set-info :boogie-vc-id |isGreaterOne3#definedness|)
...
(let ((anon0_correct  (=> (and (state Heap@@72 ZeroMask) (U_2_bool (MapType0Select Heap@@72 r_1@@36 $allocated))) (=> (and (and (= AssumeFunctionsAbove 8) (not (= r_1@@36 null))) (and (= Mask@0 (MapType1Store ZeroMask r_1@@36 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1@@36 f_7)) FullPerm)))) (state Heap@@72 Mask@0))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (HasDirectPerm Mask@0 r_1@@36 f_7)) (=> (HasDirectPerm Mask@0 r_1@@36 f_7) (=> (and (> (U_2_int (MapType0Select Heap@@72 r_1@@36 f_7)) (- 0 38)) (state Heap@@72 Mask@0)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm Mask@0 r_1@@36 f_7)) (=> (HasDirectPerm Mask@0 r_1@@36 f_7) (and (=> (= (ControlFlow 0 8) 2) anon4_Then_correct) (=> (= (ControlFlow 0 8) 6) anon4_Else_correct)))))))))))
...
(let ((anon0_correct  (=> (and (state Heap@@72 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
...
(let ((anon5_Else_correct  (=> (isGreaterOne2 Heap@@72 r_1@@36) (=> (and (state Heap@@72 Mask@0) (state Heap@@72 Mask@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 r_1@@36 f_7)) (=> (HasDirectPerm Mask@0 r_1@@36 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (> (U_2_int (MapType0Select Heap@@72 r_1@@36 f_7)) 1))))))))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (= tmp@0 (* 6 (|fac2'| Heap@@72 1))))))
(let ((anon9_Then_correct true))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (= tmp@0 (* 3 (|fac2'| Heap@@72 2)))) (=> (= tmp@0 (* 3 (|fac2'| Heap@@72 2))) (=> (state Heap@@72 ZeroMask) (and (=> (= (ControlFlow 0 6) 3) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct)))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (=> (and (= tmp@0 (fac2 Heap@@72 3)) (state Heap@@72 ZeroMask)) (and (=> (= (ControlFlow 0 8) 2) anon8_Then_correct) (=> (= (ControlFlow 0 8) 6) anon8_Else_correct)))))
