...
(assert  (and (and (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type r_1) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type PostMask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id t4)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon11_Else_correct  (=> (not (= r_1 null)) (=> (and (and (= PostMask@1 (MapType1Store ZeroMask r_1 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1 f_7)) FullPerm)))) (state PostHeap@0 PostMask@1)) (and (state PostHeap@0 PostMask@1) (= (ControlFlow 0 10) (- 0 9)))) (HasDirectPerm PostMask@1 r_1 f_7)))))
(let ((anon11_Then_correct  (=> (not (= r_1 null)) (=> (and (and (= PostMask@0 (MapType1Store ZeroMask r_1 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1 f_7)) FullPerm)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (= (ControlFlow 0 8) (- 0 7)))) (HasDirectPerm PostMask@0 r_1 f_7)))))
...
(let ((anon8_correct  (=> (and (= Mask@2 (MapType1Store Mask@1 r_1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 r_1 f_7)) FullPerm)))) (= (ControlFlow 0 3) (- 0 2))) (= (U_2_int (MapType0Select Heap@@9 r_1 f_7)) 3))))
(let ((anon12_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon8_correct)))
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 f_7))) (=> (= (ControlFlow 0 4) 3) anon8_correct))))))
(let ((anon9_Else_correct  (=> (and (and (not (= r_1 null)) (= Mask@1 (MapType1Store ZeroMask r_1 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1 f_7)) FullPerm))))) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm Mask@1 r_1 f_7)) (=> (HasDirectPerm Mask@1 r_1 f_7) (=> (and (= (U_2_int (MapType0Select Heap@@9 r_1 f_7)) 2) (state Heap@@9 Mask@1)) (and (and (=> (= (ControlFlow 0 12) 11) anon10_Then_correct) (=> (= (ControlFlow 0 12) 4) anon12_Then_correct)) (=> (= (ControlFlow 0 12) 6) anon12_Else_correct))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 r_1 $allocated))) (and (=> (= (ControlFlow 0 14) 1) anon9_Then_correct) (=> (= (ControlFlow 0 14) 12) anon9_Else_correct)))))
