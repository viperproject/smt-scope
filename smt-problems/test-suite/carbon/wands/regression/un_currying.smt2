...
(declare-fun x@@8 () T@U)
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@4) (MapType1Type RefType realType)) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Heap@@12) (MapType0Type RefType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type WandDefLHSMask@2) (MapType1Type RefType realType))) (= (type WandDefLHSHeap@1) (MapType0Type RefType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type x@@8) RefType)))
(set-info :boogie-vc-id curry_test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon16_Else_correct true))
(let ((anon16_Then_correct true))
(let ((anon15_Then_correct  (=> (and (and (= WandDefLHSMask@2 (MapType1Store ZeroMask null P (real_2_U (+ (U_2_real (MapType1Select ZeroMask null P)) FullPerm)))) (state WandDefLHSHeap@1 WandDefLHSMask@2)) (and (state WandDefLHSHeap@1 WandDefLHSMask@2) (state WandDefLHSHeap@1 WandDefLHSMask@2))) (and (=> (= (ControlFlow 0 16) 14) anon16_Then_correct) (=> (= (ControlFlow 0 16) 15) anon16_Else_correct)))))
(let ((anon15_Else_correct true))
(let ((anon14_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 17) 16) anon15_Then_correct) (=> (= (ControlFlow 0 17) 13) anon15_Else_correct)))))
(let ((anon12_correct  (=> (= Mask@4 (MapType1Store Mask@3 null Q (real_2_U (- (U_2_real (MapType1Select Mask@3 null Q)) FullPerm)))) (=> (and (and (and (state Heap@@12 Mask@4) (= Mask@5 (MapType1Store Mask@4 null R (real_2_U (+ (U_2_real (MapType1Select Mask@4 null R)) FullPerm))))) (and (state Heap@@12 Mask@5) (state Heap@@12 Mask@5))) (and (and (IdenticalOnKnownLocations Heap@@12 ExhaleHeap@0 Mask@5) (state ExhaleHeap@0 Mask@5)) (and (state ExhaleHeap@0 Mask@5) (= (ControlFlow 0 3) (- 0 2))))) (<= FullPerm (U_2_real (MapType1Select Mask@5 null (wand FullPerm FullPerm FullPerm))))))))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon12_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@3 null Q)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 null Q))) (=> (= (ControlFlow 0 4) 3) anon12_correct))))))
(let ((anon10_correct  (=> (= Mask@3 (MapType1Store Mask@2 null P (real_2_U (- (U_2_real (MapType1Select Mask@2 null P)) FullPerm)))) (and (=> (= (ControlFlow 0 7) 4) anon18_Then_correct) (=> (= (ControlFlow 0 7) 6) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 7)) anon10_correct)))
(let ((anon17_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null P)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 null P))) (=> (= (ControlFlow 0 8) 7) anon10_correct))))))
(let ((anon14_Else_correct  (=> (and (and (= Mask@1 (MapType1Store Mask@0 null P (real_2_U (+ (U_2_real (MapType1Select Mask@0 null P)) FullPerm)))) (state Heap@@12 Mask@1)) (and (state Heap@@12 Mask@1) (state Heap@@12 Mask@1))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (wand_2 FullPerm FullPerm FullPerm))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (wand_2 FullPerm FullPerm FullPerm)))) (=> (and (= Mask@2 (MapType1Store Mask@1 null (wand_2 FullPerm FullPerm FullPerm) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (wand_2 FullPerm FullPerm FullPerm))) FullPerm)))) (state Heap@@12 Mask@2)) (and (=> (= (ControlFlow 0 11) 8) anon17_Then_correct) (=> (= (ControlFlow 0 11) 10) anon17_Else_correct))))))))
(let ((anon13_Else_correct  (=> (= Mask@0 (MapType1Store ZeroMask null (wand_2 FullPerm FullPerm FullPerm) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (wand_2 FullPerm FullPerm FullPerm))) FullPerm)))) (=> (and (state Heap@@12 Mask@0) (state Heap@@12 Mask@0)) (and (=> (= (ControlFlow 0 18) 17) anon14_Then_correct) (=> (= (ControlFlow 0 18) 11) anon14_Else_correct))))))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@12 ZeroMask) (U_2_bool (MapType0Select Heap@@12 x@@8 $allocated))) (and (=> (= (ControlFlow 0 19) 1) anon13_Then_correct) (=> (= (ControlFlow 0 19) 18) anon13_Else_correct)))))
