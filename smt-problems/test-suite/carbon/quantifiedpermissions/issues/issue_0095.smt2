...
(declare-fun |Valid#condqp1| (T@U T@U) Int)
(declare-fun |sk_Valid#condqp1| (Int Int) T@U)
...
(= (type (MapType2Store arg0@@34 arg1@@16 arg2@@3)) (MapType2Type aVar0@@1 aVar1@@3))))
 ...
 :weight 0
)))) (= (Ctor PredicateType_ValidType) 14)) (forall ((arg0@@35 T@U) ) (! (= (type (Valid arg0@@35)) (FieldType PredicateType_ValidType FrameTypeType))
 :qid |funType:Valid|
 :pattern ( (Valid arg0@@35))
))))
(assert (forall ((nodes T@U) ) (!  (=> (= (type nodes) (MapType2Type RefType boolType)) (IsPredicateField (Valid nodes)))
 :qid |stdinbpl.412:15|
 :skolemid |83|
 :pattern ( (Valid nodes))
)))
(assert (forall ((Heap@@2 T@U) (nodes@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type nodes@@0) (MapType2Type RefType boolType))) (|Valid#everUsed| (Valid nodes@@0)))
 :qid |stdinbpl.431:15|
 :skolemid |87|
 :pattern ( (|Valid#trigger| Heap@@2 (Valid nodes@@0)))
)))
(assert (forall ((arg0@@36 Int) (arg1@@17 Int) ) (! (= (type (|sk_Valid#condqp1| arg0@@36 arg1@@17)) RefType)
 :qid |funType:sk_Valid#condqp1|
 :pattern ( (|sk_Valid#condqp1| arg0@@36 arg1@@17))
)))
(assert (forall ((Heap2Heap T@U) (Heap1Heap T@U) (nodes@@1 T@U) ) (!  (=> (and (and (and (= (type Heap2Heap) (MapType0Type RefType)) (= (type Heap1Heap) (MapType0Type RefType))) (= (type nodes@@1) (MapType2Type RefType boolType))) (and (=  (and (U_2_bool (MapType2Select nodes@@1 (|sk_Valid#condqp1| (|Valid#condqp1| Heap2Heap nodes@@1) (|Valid#condqp1| Heap1Heap nodes@@1)))) (< NoPerm FullPerm))  (and (U_2_bool (MapType2Select nodes@@1 (|sk_Valid#condqp1| (|Valid#condqp1| Heap2Heap nodes@@1) (|Valid#condqp1| Heap1Heap nodes@@1)))) (< NoPerm FullPerm))) (=> (and (U_2_bool (MapType2Select nodes@@1 (|sk_Valid#condqp1| (|Valid#condqp1| Heap2Heap nodes@@1) (|Valid#condqp1| Heap1Heap nodes@@1)))) (< NoPerm FullPerm)) (= (MapType0Select Heap2Heap (|sk_Valid#condqp1| (|Valid#condqp1| Heap2Heap nodes@@1) (|Valid#condqp1| Heap1Heap nodes@@1)) next) (MapType0Select Heap1Heap (|sk_Valid#condqp1| (|Valid#condqp1| Heap2Heap nodes@@1) (|Valid#condqp1| Heap1Heap nodes@@1)) next))))) (= (|Valid#condqp1| Heap2Heap nodes@@1) (|Valid#condqp1| Heap1Heap nodes@@1)))
 :qid |stdinbpl.442:15|
 :skolemid |88|
 :pattern ( (|Valid#condqp1| Heap2Heap nodes@@1) (|Valid#condqp1| Heap1Heap nodes@@1) (succHeapTrans Heap2Heap Heap1Heap))
)))
...
(assert (forall ((nodes@@2 T@U) (nodes2 T@U) ) (!  (=> (and (and (= (type nodes@@2) (MapType2Type RefType boolType)) (= (type nodes2) (MapType2Type RefType boolType))) (= (Valid nodes@@2) (Valid nodes2))) (= nodes@@2 nodes2))
 :qid |stdinbpl.422:15|
 :skolemid |85|
 :pattern ( (Valid nodes@@2) (Valid nodes2))
)))
(assert (forall ((arg0@@40 T@U) ) (! (= (type (|Valid#sm| arg0@@40)) (FieldType PredicateType_ValidType (MapType1Type RefType boolType)))
 :qid |funType:Valid#sm|
 :pattern ( (|Valid#sm| arg0@@40))
)))
(assert (forall ((nodes@@3 T@U) (nodes2@@0 T@U) ) (!  (=> (and (and (= (type nodes@@3) (MapType2Type RefType boolType)) (= (type nodes2@@0) (MapType2Type RefType boolType))) (= (|Valid#sm| nodes@@3) (|Valid#sm| nodes2@@0))) (= nodes@@3 nodes2@@0))
 :qid |stdinbpl.426:15|
 :skolemid |86|
 :pattern ( (|Valid#sm| nodes@@3) (|Valid#sm| nodes2@@0))
)))
...
(assert (forall ((nodes@@4 T@U) ) (!  (=> (= (type nodes@@4) (MapType2Type RefType boolType)) (= (getPredWandId (Valid nodes@@4)) 0))
 :qid |stdinbpl.416:15|
 :skolemid |84|
 :pattern ( (Valid nodes@@4))
)))
...
(assert (forall ((nodes@@5 T@U) ) (!  (=> (= (type nodes@@5) (MapType2Type RefType boolType)) (= (PredicateMaskField (Valid nodes@@5)) (|Valid#sm| nodes@@5)))
 :qid |stdinbpl.408:15|
 :skolemid |82|
 :pattern ( (PredicateMaskField (Valid nodes@@5)))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type nodes@@6) (MapType2Type RefType boolType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Heap@4) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@46 T@U) ) (! (= (type (invRecv4 arg0@@46)) RefType)
 :qid |funType:invRecv4|
 :pattern ( (invRecv4 arg0@@46))
))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@47 T@U) ) (! (= (type (invRecv5 arg0@@47)) RefType)
...
(let ((anon9_Else_correct  (=> (HasDirectPerm Mask@2 null (Valid nodes@@6)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 3) 1)) anon6_correct))))
(let ((anon9_Then_correct  (=> (not (HasDirectPerm Mask@2 null (Valid nodes@@6))) (=> (and (and (= Heap@2 (MapType0Store Heap@1 null (|Valid#sm| nodes@@6) ZeroPMask)) (= Heap@3 (MapType0Store Heap@2 null (Valid nodes@@6) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 2) 1))) anon6_correct))))
(let ((anon4_correct  (and (=> (= (ControlFlow 0 4) (- 0 11)) (forall ((n T@U) (n_3 T@U) ) (!  (=> (and (= (type n) RefType) (= (type n_3) RefType)) (=> (and (and (and (and (not (= n n_3)) (U_2_bool (MapType2Select nodes@@6 n))) (U_2_bool (MapType2Select nodes@@6 n_3))) (< NoPerm (* FullPerm rd))) (< NoPerm (* FullPerm rd))) (not (= n n_3))))
 :qid |stdinbpl.738:15|
 :skolemid |111|
 :no-pattern (type n)
 :no-pattern (type n_3)
...
))) (=> (forall ((n@@0 T@U) (n_3@@0 T@U) ) (!  (=> (and (= (type n@@0) RefType) (= (type n_3@@0) RefType)) (=> (and (and (and (and (not (= n@@0 n_3@@0)) (U_2_bool (MapType2Select nodes@@6 n@@0))) (U_2_bool (MapType2Select nodes@@6 n_3@@0))) (< NoPerm (* FullPerm rd))) (< NoPerm (* FullPerm rd))) (not (= n@@0 n_3@@0))))
 :qid |stdinbpl.738:15|
 :skolemid |111|
 :no-pattern (type n@@0)
...
)) (=> (and (forall ((n@@1 T@U) ) (!  (=> (= (type n@@1) RefType) (=> (and (U_2_bool (MapType2Select nodes@@6 n@@1)) (< NoPerm (* FullPerm rd))) (and (qpRange4 n@@1) (= (invRecv4 n@@1) n@@1))))
 :qid |stdinbpl.744:22|
 :skolemid |112|
 :pattern ( (MapType0Select Heap@1 n@@1 next))
 :pattern ( (MapType1Select QPMask@0 n@@1 next))
 :pattern ( (MapType2Select nodes@@6 n@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select nodes@@6 (invRecv4 o_3))) (< NoPerm (* FullPerm rd))) (qpRange4 o_3)) (= (invRecv4 o_3) o_3)))
 :qid |stdinbpl.748:22|
 :skolemid |113|
 :pattern ( (invRecv4 o_3))
))) (and (=> (= (ControlFlow 0 4) (- 0 10)) (forall ((n@@2 T@U) ) (!  (=> (and (= (type n@@2) RefType) (U_2_bool (MapType2Select nodes@@6 n@@2))) (>= (* FullPerm rd) NoPerm))
 :qid |stdinbpl.754:15|
 :skolemid |114|
 :pattern ( (MapType0Select Heap@1 n@@2 next))
 :pattern ( (MapType1Select QPMask@0 n@@2 next))
 :pattern ( (MapType2Select nodes@@6 n@@2))
))) (=> (forall ((n@@3 T@U) ) (!  (=> (and (= (type n@@3) RefType) (U_2_bool (MapType2Select nodes@@6 n@@3))) (>= (* FullPerm rd) NoPerm))
 :qid |stdinbpl.754:15|
 :skolemid |114|
 :pattern ( (MapType0Select Heap@1 n@@3 next))
 :pattern ( (MapType1Select QPMask@0 n@@3 next))
 :pattern ( (MapType2Select nodes@@6 n@@3))
)) (=> (and (forall ((n@@4 T@U) ) (!  (=> (= (type n@@4) RefType) (=> (and (U_2_bool (MapType2Select nodes@@6 n@@4)) (> (* FullPerm rd) NoPerm)) (not (= n@@4 null))))
 :qid |stdinbpl.760:22|
 :skolemid |115|
 :pattern ( (MapType0Select Heap@1 n@@4 next))
 :pattern ( (MapType1Select QPMask@0 n@@4 next))
 :pattern ( (MapType2Select nodes@@6 n@@4))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select nodes@@6 (invRecv4 o_3@@0))) (< NoPerm (* FullPerm rd))) (qpRange4 o_3@@0)) (and (=> (< NoPerm (* FullPerm rd)) (= (invRecv4 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (+ (U_2_real (MapType1Select Mask@1 o_3@@0 next)) (* FullPerm rd))))) (=> (not (and (and (U_2_bool (MapType2Select nodes@@6 (invRecv4 o_3@@0))) (< NoPerm (* FullPerm rd))) (qpRange4 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (U_2_real (MapType1Select Mask@1 o_3@@0 next))))))
 :qid |stdinbpl.766:22|
 :skolemid |116|
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 next))) (= (U_2_real (MapType1Select Mask@1 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.770:29|
 :skolemid |117|
 :pattern ( (MapType1Select Mask@1 o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
)) (state Heap@1 QPMask@0)) (and (state Heap@1 QPMask@0) (state Heap@1 QPMask@0))) (and (=> (= (ControlFlow 0 4) (- 0 9)) (> rd NoPerm)) (=> (> rd NoPerm) (and (=> (= (ControlFlow 0 4) (- 0 8)) (forall ((n_1 T@U) ) (!  (=> (= (type n_1) RefType) (=> (and (U_2_bool (MapType2Select nodes@@6 n_1)) (dummyFunction (MapType0Select Heap@1 n_1 next))) (>= (* FullPerm rd) NoPerm)))
 :qid |stdinbpl.788:17|
 :skolemid |118|
 :pattern ( (MapType0Select Heap@1 n_1 next))
 :pattern ( (MapType1Select QPMask@1 n_1 next))
 :pattern ( (MapType2Select nodes@@6 n_1))
))) (=> (forall ((n_1@@0 T@U) ) (!  (=> (= (type n_1@@0) RefType) (=> (and (U_2_bool (MapType2Select nodes@@6 n_1@@0)) (dummyFunction (MapType0Select Heap@1 n_1@@0 next))) (>= (* FullPerm rd) NoPerm)))
 :qid |stdinbpl.788:17|
 :skolemid |118|
 :pattern ( (MapType0Select Heap@1 n_1@@0 next))
 :pattern ( (MapType1Select QPMask@1 n_1@@0 next))
 :pattern ( (MapType2Select nodes@@6 n_1@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 7)) (forall ((n_1@@1 T@U) (n_1_1 T@U) ) (!  (=> (and (= (type n_1@@1) RefType) (= (type n_1_1) RefType)) (=> (and (and (and (and (not (= n_1@@1 n_1_1)) (U_2_bool (MapType2Select nodes@@6 n_1@@1))) (U_2_bool (MapType2Select nodes@@6 n_1_1))) (< NoPerm (* FullPerm rd))) (< NoPerm (* FullPerm rd))) (not (= n_1@@1 n_1_1))))
 :qid |stdinbpl.795:17|
 :skolemid |119|
 :pattern ( (neverTriggered5 n_1@@1) (neverTriggered5 n_1_1))
))) (=> (forall ((n_1@@2 T@U) (n_1_1@@0 T@U) ) (!  (=> (and (= (type n_1@@2) RefType) (= (type n_1_1@@0) RefType)) (=> (and (and (and (and (not (= n_1@@2 n_1_1@@0)) (U_2_bool (MapType2Select nodes@@6 n_1@@2))) (U_2_bool (MapType2Select nodes@@6 n_1_1@@0))) (< NoPerm (* FullPerm rd))) (< NoPerm (* FullPerm rd))) (not (= n_1@@2 n_1_1@@0))))
 :qid |stdinbpl.795:17|
 :skolemid |119|
 :pattern ( (neverTriggered5 n_1@@2) (neverTriggered5 n_1_1@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((n_1@@3 T@U) ) (!  (=> (and (= (type n_1@@3) RefType) (U_2_bool (MapType2Select nodes@@6 n_1@@3))) (>= (U_2_real (MapType1Select QPMask@0 n_1@@3 next)) (* FullPerm rd)))
 :qid |stdinbpl.802:17|
 :skolemid |120|
 :pattern ( (MapType0Select Heap@1 n_1@@3 next))
 :pattern ( (MapType1Select QPMask@1 n_1@@3 next))
 :pattern ( (MapType2Select nodes@@6 n_1@@3))
))) (=> (forall ((n_1@@4 T@U) ) (!  (=> (and (= (type n_1@@4) RefType) (U_2_bool (MapType2Select nodes@@6 n_1@@4))) (>= (U_2_real (MapType1Select QPMask@0 n_1@@4 next)) (* FullPerm rd)))
 :qid |stdinbpl.802:17|
 :skolemid |120|
 :pattern ( (MapType0Select Heap@1 n_1@@4 next))
 :pattern ( (MapType1Select QPMask@1 n_1@@4 next))
 :pattern ( (MapType2Select nodes@@6 n_1@@4))
)) (=> (and (and (forall ((n_1@@5 T@U) ) (!  (=> (= (type n_1@@5) RefType) (=> (and (U_2_bool (MapType2Select nodes@@6 n_1@@5)) (< NoPerm (* FullPerm rd))) (and (qpRange5 n_1@@5) (= (invRecv5 n_1@@5) n_1@@5))))
 :qid |stdinbpl.808:22|
 :skolemid |121|
 :pattern ( (MapType0Select Heap@1 n_1@@5 next))
 :pattern ( (MapType1Select QPMask@1 n_1@@5 next))
 :pattern ( (MapType2Select nodes@@6 n_1@@5))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType2Select nodes@@6 (invRecv5 o_3@@2))) (and (< NoPerm (* FullPerm rd)) (qpRange5 o_3@@2))) (= (invRecv5 o_3@@2) o_3@@2)))
 :qid |stdinbpl.812:22|
 :skolemid |122|
 :pattern ( (invRecv5 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType2Select nodes@@6 (invRecv5 o_3@@3))) (and (< NoPerm (* FullPerm rd)) (qpRange5 o_3@@3))) (and (= (invRecv5 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 next)) (- (U_2_real (MapType1Select QPMask@0 o_3@@3 next)) (* FullPerm rd))))) (=> (not (and (U_2_bool (MapType2Select nodes@@6 (invRecv5 o_3@@3))) (and (< NoPerm (* FullPerm rd)) (qpRange5 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 next)) (U_2_real (MapType1Select QPMask@0 o_3@@3 next))))))
 :qid |stdinbpl.818:22|
 :skolemid |123|
...
)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (>= rd NoPerm)) (=> (>= rd NoPerm) (=> (= Mask@2 (MapType1Store QPMask@1 null (Valid nodes@@6) (real_2_U (+ (U_2_real (MapType1Select QPMask@1 null (Valid nodes@@6))) rd)))) (=> (and (and (state Heap@1 Mask@2) (state Heap@1 Mask@2)) (and (|Valid#trigger| Heap@1 (Valid nodes@@6)) (= (MapType0Select Heap@1 null (Valid nodes@@6)) (FrameFragment (int_2_U (|Valid#condqp1| Heap@1 nodes@@6)))))) (and (=> (= (ControlFlow 0 4) 2) anon9_Then_correct) (=> (= (ControlFlow 0 4) 3) anon9_Else_correct))))))))))))))))))))))))
(let ((anon8_Else_correct  (=> (HasDirectPerm Mask@1 null (Valid nodes@@6)) (=> (and (= Heap@1 Heap@@10) (= (ControlFlow 0 13) 4)) anon4_correct))))
(let ((anon8_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (Valid nodes@@6))) (= Heap@0 (MapType0Store Heap@@10 null (Valid nodes@@6) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 12) 4))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (Valid nodes@@6) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (Valid nodes@@6))) rd)))) (and (=> (= (ControlFlow 0 14) 12) anon8_Then_correct) (=> (= (ControlFlow 0 14) 13) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (= rd NoPerm) (= (ControlFlow 0 17) 14)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= rd NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= rd (U_2_real (MapType1Select Mask@0 null (Valid nodes@@6))))) (=> (<= rd (U_2_real (MapType1Select Mask@0 null (Valid nodes@@6)))) (=> (= (ControlFlow 0 15) 14) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (= rd FullPerm) (state Heap@@10 ZeroMask)) (and (=> (= (ControlFlow 0 18) (- 0 21)) (>= rd NoPerm)) (=> (>= rd NoPerm) (=> (= Mask@0 (MapType1Store ZeroMask null (Valid nodes@@6) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Valid nodes@@6))) rd)))) (=> (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (=> (= (ControlFlow 0 18) (- 0 20)) (> rd NoPerm)) (=> (> rd NoPerm) (=> (and (|Valid#trigger| Heap@@10 (Valid nodes@@6)) (= (MapType0Select Heap@@10 null (Valid nodes@@6)) (FrameFragment (int_2_U (|Valid#condqp1| Heap@@10 nodes@@6))))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (>= rd NoPerm)) (=> (>= rd NoPerm) (and (=> (= (ControlFlow 0 18) 15) anon7_Then_correct) (=> (= (ControlFlow 0 18) 17) anon7_Else_correct)))))))))))))))
