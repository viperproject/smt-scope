...
(assert  (and (and (and (and (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type diz@@11) RefType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type PostMask@1) (MapType1Type RefType realType))) (= (type Heap@@11) (MapType0Type RefType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type S@@5) (MultiSetType RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id Lock__unlock)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon8_Else_correct true))
(let ((anon8_Then_correct  (=> (and (and (state PostHeap@0 ZeroMask) (> wildcard@2 NoPerm)) (and (not (= diz@@11 null)) (= PostMask@0 (MapType1Store ZeroMask diz@@11 Lock__owner (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz@@11 Lock__owner)) wildcard@2)))))) (=> (and (and (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)) (and (> wildcard@3 NoPerm) (not (= diz@@11 null)))) (and (and (= PostMask@1 (MapType1Store PostMask@0 diz@@11 Lock__user (real_2_U (+ (U_2_real (MapType1Select PostMask@0 diz@@11 Lock__user)) wildcard@3)))) (state PostHeap@0 PostMask@1)) (and (state PostHeap@0 PostMask@1) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm PostMask@1 diz@@11 Lock__owner)))))
(let ((anon2_correct  (=> (state Heap@@11 Mask@4) (and (=> (= (ControlFlow 0 6) 2) anon8_Then_correct) (=> (= (ControlFlow 0 6) 4) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (not (= (|MultiSet#Select| S@@5 diz@@11) 0)) (=> (and (= Mask@4 Mask@2) (= (ControlFlow 0 9) 6)) anon2_correct))))
(let ((anon7_Then_correct  (=> (= (|MultiSet#Select| S@@5 diz@@11) 0) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm Mask@2 diz@@11 Lock__user)) (=> (HasDirectPerm Mask@2 diz@@11 Lock__user) (=> (and (and (= Mask@3 (MapType1Store Mask@2 null (Client__inv (MapType0Select Heap@@11 diz@@11 Lock__user) FullPerm) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (Client__inv (MapType0Select Heap@@11 diz@@11 Lock__user) FullPerm))) FullPerm)))) (state Heap@@11 Mask@3)) (and (= Mask@4 Mask@3) (= (ControlFlow 0 7) 6))) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 diz@@11 $allocated))) (and (not (= diz@@11 null)) (state Heap@@11 ZeroMask))) (and (and (>= current_thread_id 0) (state Heap@@11 ZeroMask)) (and (> wildcard@0 NoPerm) (not (= diz@@11 null))))) (and (and (and (= Mask@0 (MapType1Store ZeroMask diz@@11 Lock__owner (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz@@11 Lock__owner)) wildcard@0)))) (state Heap@@11 Mask@0)) (and (state Heap@@11 Mask@0) (> wildcard@1 NoPerm))) (and (and (not (= diz@@11 null)) (= Mask@1 (MapType1Store Mask@0 diz@@11 Lock__user (real_2_U (+ (U_2_real (MapType1Select Mask@0 diz@@11 Lock__user)) wildcard@1))))) (and (state Heap@@11 Mask@1) (state Heap@@11 Mask@1))))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm Mask@1 diz@@11 Lock__owner)) (=> (HasDirectPerm Mask@1 diz@@11 Lock__owner) (=> (= Mask@2 (MapType1Store Mask@1 null (LockSet__lockset (MapType0Select Heap@@11 diz@@11 Lock__owner) (|MultiSet#Union| S@@5 (|MultiSet#Singleton| diz@@11))) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (LockSet__lockset (MapType0Select Heap@@11 diz@@11 Lock__owner) (|MultiSet#Union| S@@5 (|MultiSet#Singleton| diz@@11))))) FullPerm)))) (=> (and (state Heap@@11 Mask@2) (state Heap@@11 Mask@2)) (and (=> (= (ControlFlow 0 10) 7) anon7_Then_correct) (=> (= (ControlFlow 0 10) 9) anon7_Else_correct)))))))))
