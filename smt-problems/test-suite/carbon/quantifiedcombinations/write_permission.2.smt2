...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@2) (MapType0Type RefType)) (= (type r_1@@11) RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type xs) (SeqType RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (forall ((arg0@@39 T@U) ) (! (= (type (invRecv11 arg0@@39)) RefType)
 :qid |funType:invRecv11|
 :pattern ( (invRecv11 arg0@@39))
))) (= (type QPMask@3) (MapType1Type RefType realType))) (forall ((arg0@@40 T@U) ) (! (= (type (invRecv12 arg0@@40)) RefType)
 :qid |funType:invRecv12|
 :pattern ( (invRecv12 arg0@@40))
))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@11) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type QPMask@5) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (forall ((arg0@@41 T@U) ) (! (= (type (invRecv10 arg0@@41)) RefType)
 :qid |funType:invRecv10|
 :pattern ( (invRecv10 arg0@@41))
))) (= (type QPMask@4) (MapType1Type RefType realType))) (forall ((arg0@@42 T@U) ) (! (= (type (invRecv9 arg0@@42)) RefType)
 :qid |funType:invRecv9|
 :pattern ( (invRecv9 arg0@@42))
))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv8 arg0@@43)) RefType)
 :qid |funType:invRecv8|
 :pattern ( (invRecv8 arg0@@43))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv7 arg0@@44)) RefType)
 :qid |funType:invRecv7|
 :pattern ( (invRecv7 arg0@@44))
))))
(set-info :boogie-vc-id m1_2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 32) (let ((anon11_correct true))
(let ((anon22_Else_correct  (=> (and (< 0 i@@12) (= (ControlFlow 0 21) 18)) anon11_correct)))
(let ((anon22_Then_correct  (=> (<= i@@12 0) (and (=> (= (ControlFlow 0 19) (- 0 20)) (HasDirectPerm QPMask@5 r_1@@11 g)) (=> (HasDirectPerm QPMask@5 r_1@@11 g) (=> (and (= (U_2_int (MapType0Select PostHeap@0 r_1@@11 g)) 4) (= (ControlFlow 0 19) 18)) anon11_correct))))))
...
)) (=> (forall ((x_7@@1 T@U) ) (!  (=> (= (type x_7@@1) RefType) (=> (and (and (|Seq#Contains| xs x_7@@1) (<= i@@12 0)) (< NoPerm FullPerm)) (and (qpRange10 x_7@@1) (= (invRecv10 x_7@@1) x_7@@1))))
...
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (|Seq#Contains| xs (invRecv10 o_3)) (<= i@@12 0)) (< NoPerm FullPerm)) (qpRange10 o_3)) (= (invRecv10 o_3) o_3)))
...
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (|Seq#Contains| xs (invRecv10 o_3@@0)) (<= i@@12 0)) (< NoPerm FullPerm)) (qpRange10 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv10 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@5 o_3@@0 g)) (+ (U_2_real (MapType1Select QPMask@4 o_3@@0 g)) FullPerm)))) (=> (not (and (and (and (|Seq#Contains| xs (invRecv10 o_3@@0)) (<= i@@12 0)) (< NoPerm FullPerm)) (qpRange10 o_3@@0))) (= (U_2_real (MapType1Select QPMask@5 o_3@@0 g)) (U_2_real (MapType1Select QPMask@4 o_3@@0 g))))))
...
)) (=> (and (forall ((x_5@@1 T@U) ) (!  (=> (= (type x_5@@1) RefType) (=> (and (and (|Seq#Contains| xs x_5@@1) (> i@@12 0)) (< NoPerm FullPerm)) (and (qpRange9 x_5@@1) (= (invRecv9 x_5@@1) x_5@@1))))
...
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (|Seq#Contains| xs (invRecv9 o_3@@2)) (> i@@12 0)) (< NoPerm FullPerm)) (qpRange9 o_3@@2)) (= (invRecv9 o_3@@2) o_3@@2)))
...
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (and (|Seq#Contains| xs (invRecv9 o_3@@3)) (> i@@12 0)) (< NoPerm FullPerm)) (qpRange9 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv9 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@4 o_3@@3 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (and (|Seq#Contains| xs (invRecv9 o_3@@3)) (> i@@12 0)) (< NoPerm FullPerm)) (qpRange9 o_3@@3))) (= (U_2_real (MapType1Select QPMask@4 o_3@@3 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@3 f_7))))))
...
(let ((anon24_Then_correct  (=> (<= i@@12 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (= (U_2_int (MapType0Select Heap@2 r_1@@11 g)) 4)) (=> (= (U_2_int (MapType0Select Heap@2 r_1@@11 g)) 4) (=> (= (ControlFlow 0 4) 3) anon16_correct))))))
...
)) (=> (and (and (forall ((x_8@@3 T@U) ) (!  (=> (= (type x_8@@3) RefType) (=> (and (and (|Seq#Contains| xs x_8@@3) (> i@@12 0)) (< NoPerm FullPerm)) (and (qpRange11 x_8@@3) (= (invRecv11 x_8@@3) x_8@@3))))
...
)) (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (|Seq#Contains| xs (invRecv11 o_3@@5)) (> i@@12 0)) (and (< NoPerm FullPerm) (qpRange11 o_3@@5))) (= (invRecv11 o_3@@5) o_3@@5)))
 :qid |stdinbpl.1349:22|
 :skolemid |133|
 :pattern ( (invRecv11 o_3@@5))
))) (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (|Seq#Contains| xs (invRecv11 o_3@@6)) (> i@@12 0)) (and (< NoPerm FullPerm) (qpRange11 o_3@@6))) (and (= (invRecv11 o_3@@6) o_3@@6) (= (U_2_real (MapType1Select QPMask@2 o_3@@6 f_7)) (- (U_2_real (MapType1Select QPMask@1 o_3@@6 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| xs (invRecv11 o_3@@6)) (> i@@12 0)) (and (< NoPerm FullPerm) (qpRange11 o_3@@6)))) (= (U_2_real (MapType1Select QPMask@2 o_3@@6 f_7)) (U_2_real (MapType1Select QPMask@1 o_3@@6 f_7))))))
...
)) (=> (and (and (forall ((x_9@@3 T@U) ) (!  (=> (= (type x_9@@3) RefType) (=> (and (and (|Seq#Contains| xs x_9@@3) (<= i@@12 0)) (< NoPerm FullPerm)) (and (qpRange12 x_9@@3) (= (invRecv12 x_9@@3) x_9@@3))))
...
)) (forall ((o_3@@8 T@U) ) (!  (=> (= (type o_3@@8) RefType) (=> (and (and (|Seq#Contains| xs (invRecv12 o_3@@8)) (<= i@@12 0)) (and (< NoPerm FullPerm) (qpRange12 o_3@@8))) (= (invRecv12 o_3@@8) o_3@@8)))
 :qid |stdinbpl.1390:22|
 :skolemid |139|
 :pattern ( (invRecv12 o_3@@8))
))) (and (forall ((o_3@@9 T@U) ) (!  (=> (= (type o_3@@9) RefType) (and (=> (and (and (|Seq#Contains| xs (invRecv12 o_3@@9)) (<= i@@12 0)) (and (< NoPerm FullPerm) (qpRange12 o_3@@9))) (and (= (invRecv12 o_3@@9) o_3@@9) (= (U_2_real (MapType1Select QPMask@3 o_3@@9 g)) (- (U_2_real (MapType1Select QPMask@2 o_3@@9 g)) FullPerm)))) (=> (not (and (and (|Seq#Contains| xs (invRecv12 o_3@@9)) (<= i@@12 0)) (and (< NoPerm FullPerm) (qpRange12 o_3@@9)))) (= (U_2_real (MapType1Select QPMask@3 o_3@@9 g)) (U_2_real (MapType1Select QPMask@2 o_3@@9 g))))))
...
(let ((anon23_Then_correct  (=> (<= i@@12 0) (and (=> (= (ControlFlow 0 12) (- 0 14)) (= FullPerm (U_2_real (MapType1Select QPMask@1 r_1@@11 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@1 r_1@@11 f_7))) (=> (and (= Heap@0 (MapType0Store Heap@@11 r_1@@11 f_7 (int_2_U 3))) (state Heap@0 QPMask@1)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (= FullPerm (U_2_real (MapType1Select QPMask@1 r_1@@11 g)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@1 r_1@@11 g))) (=> (and (and (= Heap@1 (MapType0Store Heap@0 r_1@@11 g (int_2_U 4))) (state Heap@1 QPMask@1)) (and (= Heap@2 Heap@1) (= (ControlFlow 0 12) 7))) anon14_correct)))))))))
...
)) (=> (forall ((x_3@@1 T@U) ) (!  (=> (= (type x_3@@1) RefType) (=> (and (and (|Seq#Contains| xs x_3@@1) (<= i@@12 0)) (< NoPerm FullPerm)) (and (qpRange8 x_3@@1) (= (invRecv8 x_3@@1) x_3@@1))))
 :qid |stdinbpl.1176:22|
 :skolemid |113|
...
)) (=> (and (forall ((o_3@@11 T@U) ) (!  (=> (= (type o_3@@11) RefType) (=> (and (and (and (|Seq#Contains| xs (invRecv8 o_3@@11)) (<= i@@12 0)) (< NoPerm FullPerm)) (qpRange8 o_3@@11)) (= (invRecv8 o_3@@11) o_3@@11)))
...
))) (=> (and (and (forall ((o_3@@12 T@U) ) (!  (=> (= (type o_3@@12) RefType) (and (=> (and (and (and (|Seq#Contains| xs (invRecv8 o_3@@12)) (<= i@@12 0)) (< NoPerm FullPerm)) (qpRange8 o_3@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv8 o_3@@12) o_3@@12)) (= (U_2_real (MapType1Select QPMask@1 o_3@@12 g)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@12 g)) FullPerm)))) (=> (not (and (and (and (|Seq#Contains| xs (invRecv8 o_3@@12)) (<= i@@12 0)) (< NoPerm FullPerm)) (qpRange8 o_3@@12))) (= (U_2_real (MapType1Select QPMask@1 o_3@@12 g)) (U_2_real (MapType1Select QPMask@0 o_3@@12 g))))))
...
)) (=> (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (and (|Seq#Contains| xs x_1@@1) (> i@@12 0)) (< NoPerm FullPerm)) (and (qpRange7 x_1@@1) (= (invRecv7 x_1@@1) x_1@@1))))
...
)) (forall ((o_3@@14 T@U) ) (!  (=> (= (type o_3@@14) RefType) (=> (and (and (and (|Seq#Contains| xs (invRecv7 o_3@@14)) (> i@@12 0)) (< NoPerm FullPerm)) (qpRange7 o_3@@14)) (= (invRecv7 o_3@@14) o_3@@14)))
 :qid |stdinbpl.1141:22|
 :skolemid |108|
 :pattern ( (invRecv7 o_3@@14))
...
)) (forall ((o_3@@15 T@U) ) (!  (=> (= (type o_3@@15) RefType) (and (=> (and (and (and (|Seq#Contains| xs (invRecv7 o_3@@15)) (> i@@12 0)) (< NoPerm FullPerm)) (qpRange7 o_3@@15)) (and (=> (< NoPerm FullPerm) (= (invRecv7 o_3@@15) o_3@@15)) (= (U_2_real (MapType1Select QPMask@0 o_3@@15 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@15 f_7)) FullPerm)))) (=> (not (and (and (and (|Seq#Contains| xs (invRecv7 o_3@@15)) (> i@@12 0)) (< NoPerm FullPerm)) (qpRange7 o_3@@15))) (= (U_2_real (MapType1Select QPMask@0 o_3@@15 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@15 f_7))))))
