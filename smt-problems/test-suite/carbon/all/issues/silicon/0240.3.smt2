...
(assert  (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type this@@21) RefType)) (= (type Heap@@21) (MapType0Type RefType))))
...
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list this@@21))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list this@@21)))) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (and (state Heap@@21 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@21 this@@21 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (list this@@21) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (list this@@21))) FullPerm))))) (and (state Heap@@21 Mask@0) (state Heap@@21 Mask@0))) (and (and (=> (= (ControlFlow 0 6) 1) anon5_Else_correct) (=> (= (ControlFlow 0 6) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct))))))
