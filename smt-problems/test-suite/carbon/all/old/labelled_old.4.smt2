...
(assert  (and (and (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type z@@0) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type z_2) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type x@@8) RefType)) (= (type y@@1) RefType)) (= (type freshObj@0) RefType)))
(set-info :boogie-vc-id test04)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm Mask@1 z_2 f_7)) (= (ControlFlow 0 16) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm Mask@1 z_2 f_7) (and (=> (= (ControlFlow 0 11) (- 0 15)) (HasDirectPerm Mask@1 z_2 f_7)) (=> (HasDirectPerm Mask@1 z_2 f_7) (and (=> (= (ControlFlow 0 11) (- 0 14)) (HasDirectPerm Mask@1 z_2 f_7)) (=> (HasDirectPerm Mask@1 z_2 f_7) (and (=> (= (ControlFlow 0 11) (- 0 13)) true) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm Mask@0 z_2 f_7)) (=> (HasDirectPerm Mask@0 z_2 f_7) (=> (= (ControlFlow 0 11) 10) anon7_correct)))))))))))
...
(let ((anon10_Else_correct  (=> (and (not (HasDirectPerm Mask@1 z@@0 f_7)) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (HasDirectPerm Mask@1 z@@0 f_7) (and (=> (= (ControlFlow 0 2) (- 0 6)) (HasDirectPerm Mask@1 z@@0 f_7)) (=> (HasDirectPerm Mask@1 z@@0 f_7) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm Mask@1 z@@0 f_7)) (=> (HasDirectPerm Mask@1 z@@0 f_7) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 z@@0 f_7)) (=> (HasDirectPerm Mask@1 z@@0 f_7) (=> (= (ControlFlow 0 2) 1) anon3_correct)))))))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (=> (and (and (not (= x@@8 null)) (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@9 y@@1 $allocated)) (state Heap@@9 Mask@0)) (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@9 freshObj@0 $allocated))))) (and (and (= Heap@0 (MapType0Store Heap@@9 freshObj@0 $allocated (bool_2_U true))) (= Mask@1 (MapType1Store Mask@0 freshObj@0 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@0 f_7)) FullPerm))))) (and (state Heap@0 Mask@1) (state Heap@0 Mask@1)))) (and (and (=> (= (ControlFlow 0 19) 17) anon9_Else_correct) (=> (= (ControlFlow 0 19) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 19) 7) anon10_Else_correct)))))))
