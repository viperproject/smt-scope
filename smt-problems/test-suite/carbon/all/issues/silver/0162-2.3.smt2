...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x@@8 $allocated))) (=> (and (and (and (= Mask@0 (MapType1Store ZeroMask null (Tree x@@8) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Tree x@@8))) FullPerm)))) (state Heap@@10 Mask@0)) (and (state Heap@@10 Mask@0) (= Mask@1 (MapType1Store Mask@0 null (Tree x@@8) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (Tree x@@8))) FullPerm)))))) (and (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1)) (and (state Heap@@10 Mask@1) (= (ControlFlow 0 2) (- 0 1))))) false))))
