...
(declare-fun y@@2 () T@U)
(assert  (and (and (and (and (= (type xs) (SeqType RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@35 T@U) ) (! (= (type (invRecv1 arg0@@35)) RefType)
...
)) (=> (and (and (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| xs x_1@@1) (< NoPerm FullPerm)) (and (qpRange1 x_1@@1) (= (invRecv1 x_1@@1) x_1@@1))))
 :qid |stdinbpl.698:22|
 :skolemid |59|
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (= (ControlFlow 0 3) (- 0 2))))) (not (= y@@2 null)))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 y@@2 $allocated))) (and (|Seq#Contains| xs y@@2) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct)))))
