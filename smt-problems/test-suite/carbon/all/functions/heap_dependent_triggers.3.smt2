...
(assert  (and (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type x@@11) RefType)) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@15) (MapType0Type RefType))))
...
(let ((anon16_Else_correct  (=> (fun01 ExhaleHeap@0 x@@11 5) (=> (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)) (and (=> (= (ControlFlow 0 10) 7) anon18_Then_correct) (=> (= (ControlFlow 0 10) 9) anon18_Else_correct))))))
(let ((anon9_correct true))
(let ((anon17_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon9_correct)))
(let ((anon17_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@2 x@@11 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 x@@11 f_7))) (=> (= (ControlFlow 0 4) 3) anon9_correct))))))
(let ((anon6_correct  (=> (= Mask@1 (MapType1Store Mask@0 x@@11 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 x@@11 f_7)) FullPerm)))) (=> (and (and (and (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1)) (and (not (= x@@11 null)) (= Mask@2 (MapType1Store Mask@1 x@@11 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@1 x@@11 f_7)) FullPerm)))))) (and (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)) (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)))) (and (and (=> (= (ControlFlow 0 11) 10) anon16_Else_correct) (=> (= (ControlFlow 0 11) 4) anon17_Then_correct)) (=> (= (ControlFlow 0 11) 6) anon17_Else_correct))))))
(let ((anon15_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 14) 11)) anon6_correct)))
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@11 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@11 f_7))) (=> (= (ControlFlow 0 12) 11) anon6_correct))))))
...
)) (=> (and (state Heap@@15 Mask@0) (state Heap@@15 Mask@0)) (and (=> (= (ControlFlow 0 15) 12) anon15_Then_correct) (=> (= (ControlFlow 0 15) 14) anon15_Else_correct))))))
(let ((anon14_Else_correct true))
(let ((anon14_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@15 x@@11 $allocated))) (and (not (= x@@11 null)) (= Mask@0 (MapType1Store ZeroMask x@@11 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@11 f_7)) FullPerm)))))) (and (and (state Heap@@15 Mask@0) (state Heap@@15 Mask@0)) (and (state Heap@@15 Mask@0) (state Heap@@15 Mask@0)))) (and (and (=> (= (ControlFlow 0 16) 15) anon13_Else_correct) (=> (= (ControlFlow 0 16) 1) anon14_Then_correct)) (=> (= (ControlFlow 0 16) 2) anon14_Else_correct))))))
