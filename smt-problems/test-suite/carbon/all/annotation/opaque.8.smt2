...
(set-info :boogie-vc-id |isGreaterOne33#definedness|)
...
(let ((anon0_correct  (=> (state Heap@@72 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@72 r_1@@36 $allocated)) (= AssumeFunctionsAbove 7)) (=> (and (and (not (= r_1@@36 null)) (= Mask@0 (MapType1Store ZeroMask r_1@@36 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1@@36 f_7)) FullPerm))))) (and (state Heap@@72 Mask@0) (state Heap@@72 Mask@0))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm Mask@0 r_1@@36 f_7)) (=> (HasDirectPerm Mask@0 r_1@@36 f_7) (and (=> (= (ControlFlow 0 8) 2) anon4_Then_correct) (=> (= (ControlFlow 0 8) 6) anon4_Else_correct)))))))))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (isGreaterOne Heap@@72 j))))
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (> j (- 0 60)))))
(let ((anon0_correct  (=> (and (and (state Heap@@72 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (> j 1) (state Heap@@72 ZeroMask))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))
...
(declare-fun Heap@@72 () T@U)
(assert (= (type Heap@@72) (MapType0Type RefType)))
(set-info :boogie-vc-id mFac1_2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (= tmp@0 (* 6 (fac1 Heap@@72 1)))) (=> (= tmp@0 (* 6 (fac1 Heap@@72 1))) (=> (and (state Heap@@72 ZeroMask) (= (ControlFlow 0 5) (- 0 4))) (= tmp@0 6))))))
(let ((anon9_Then_correct true))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (= tmp@0 (* 3 (fac1 Heap@@72 2)))) (=> (= tmp@0 (* 3 (fac1 Heap@@72 2))) (=> (state Heap@@72 ZeroMask) (and (=> (= (ControlFlow 0 7) 3) anon9_Then_correct) (=> (= (ControlFlow 0 7) 5) anon9_Else_correct)))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (=> (and (= tmp@0 (fac1 Heap@@72 3)) (state Heap@@72 ZeroMask)) (and (=> (= (ControlFlow 0 9) 2) anon8_Then_correct) (=> (= (ControlFlow 0 9) 7) anon8_Else_correct)))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@72 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 10) 1) anon7_Then_correct) (=> (= (ControlFlow 0 10) 9) anon7_Else_correct)))))
...
(declare-fun Mask@0 () T@U)
(assert  (and (and (and (and (and (and (and (and (and (= (type Heap@3) (MapType0Type RefType)) (= (type r_1@@36) RefType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@72) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id mFold)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon7_correct)))
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null (P r_1@@36))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 null (P r_1@@36)))) (=> (= (ControlFlow 0 4) 3) anon7_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= (|funP'| Heap@3 r_1@@36) tmp@0))))
(let ((anon4_correct  (=> (= Heap@3 (MapType0Store Heap@2 null (|P#sm| r_1@@36) (MapType1Store (MapType0Select Heap@2 null (|P#sm| r_1@@36)) r_1@@36 f_7 (bool_2_U true)))) (=> (and (state Heap@3 Mask@2) (state Heap@3 Mask@2)) (and (and (=> (= (ControlFlow 0 7) 2) anon11_Else_correct) (=> (= (ControlFlow 0 7) 4) anon12_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon12_Else_correct))))))
(let ((anon10_Else_correct  (=> (HasDirectPerm Mask@2 null (P r_1@@36)) (=> (and (= Heap@2 Heap@@72) (= (ControlFlow 0 9) 7)) anon4_correct))))
(let ((anon10_Then_correct  (=> (not (HasDirectPerm Mask@2 null (P r_1@@36))) (=> (and (and (= Heap@0 (MapType0Store Heap@@72 null (|P#sm| r_1@@36) ZeroPMask)) (= Heap@1 (MapType0Store Heap@0 null (P r_1@@36) freshVersion@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 8) 7))) anon4_correct))))
(let ((anon2_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 r_1@@36 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 r_1@@36 f_7)) FullPerm)))) (= Mask@2 (MapType1Store Mask@1 null (P r_1@@36) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (P r_1@@36))) FullPerm))))) (=> (and (and (state Heap@@72 Mask@2) (state Heap@@72 Mask@2)) (and (|P#trigger| Heap@@72 (P r_1@@36)) (= (MapType0Select Heap@@72 null (P r_1@@36)) (FrameFragment (MapType0Select Heap@@72 r_1@@36 f_7))))) (and (=> (= (ControlFlow 0 10) 8) anon10_Then_correct) (=> (= (ControlFlow 0 10) 9) anon10_Else_correct))))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 10)) anon2_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType1Select Mask@0 r_1@@36 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 r_1@@36 f_7))) (=> (= (ControlFlow 0 11) 10) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@72 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@72 r_1@@36 $allocated))) (=> (and (and (not (= r_1@@36 null)) (= Mask@0 (MapType1Store ZeroMask r_1@@36 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1@@36 f_7)) FullPerm))))) (and (state Heap@@72 Mask@0) (state Heap@@72 Mask@0))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm Mask@0 r_1@@36 f_7)) (=> (HasDirectPerm Mask@0 r_1@@36 f_7) (=> (and (= tmp@0 (U_2_int (MapType0Select Heap@@72 r_1@@36 f_7))) (state Heap@@72 Mask@0)) (and (=> (= (ControlFlow 0 14) 11) anon9_Then_correct) (=> (= (ControlFlow 0 14) 13) anon9_Else_correct))))))))))
