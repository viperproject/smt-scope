...
(set-info :boogie-vc-id |leftOpen#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon4_correct true))
(let ((anon6_Else_correct  (=> (and (= (MapType0Select Heap@@18 this@@53 left) null) (= (ControlFlow 0 5) 1)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= (MapType0Select Heap@@18 this@@53 left) null)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@3 this@@53 left)) (=> (HasDirectPerm Mask@3 this@@53 left) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@3 (MapType0Select Heap@@18 this@@53 left) parent)) (=> (HasDirectPerm Mask@3 (MapType0Select Heap@@18 this@@53 left) parent) (=> (and (= (MapType0Select Heap@@18 (MapType0Select Heap@@18 this@@53 left) parent) this@@53) (= (ControlFlow 0 2) 1)) anon4_correct))))))))
(let ((anon2_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm Mask@3 this@@53 left)) (=> (HasDirectPerm Mask@3 this@@53 left) (and (=> (= (ControlFlow 0 6) 2) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct))))))
(let ((anon5_Else_correct  (=> (= (MapType0Select Heap@@18 this@@53 left) null) (=> (and (= Mask@3 Mask@1) (= (ControlFlow 0 11) 6)) anon2_correct))))
(let ((anon5_Then_correct  (=> (not (= (MapType0Select Heap@@18 this@@53 left) null)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (HasDirectPerm Mask@1 this@@53 left)) (=> (HasDirectPerm Mask@1 this@@53 left) (=> (= perm@2 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (=> (> perm@2 NoPerm) (not (= (MapType0Select Heap@@18 this@@53 left) null))) (=> (and (and (= Mask@2 (MapType1Store Mask@1 (MapType0Select Heap@@18 this@@53 left) parent (real_2_U (+ (U_2_real (MapType1Select Mask@1 (MapType0Select Heap@@18 this@@53 left) parent)) perm@2)))) (state Heap@@18 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 8) 6))) anon2_correct))))))))))
(let ((anon0_correct  (=> (state Heap@@18 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@18 this@@53 $allocated)) (= perm@0 (/ (to_real 1) (to_real 4)))) (and (=> (= (ControlFlow 0 12) (- 0 15)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= this@@53 null))) (= Mask@0 (MapType1Store ZeroMask this@@53 left (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@53 left)) perm@0))))) (and (state Heap@@18 Mask@0) (= perm@1 (/ (to_real 1) (to_real 10))))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (=> (> perm@1 NoPerm) (not (= this@@53 null))) (=> (and (= Mask@1 (MapType1Store Mask@0 this@@53 root (real_2_U (+ (U_2_real (MapType1Select Mask@0 this@@53 root)) perm@1)))) (state Heap@@18 Mask@1)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm Mask@1 this@@53 left)) (=> (HasDirectPerm Mask@1 this@@53 left) (and (=> (= (ControlFlow 0 12) 8) anon5_Then_correct) (=> (= (ControlFlow 0 12) 11) anon5_Else_correct)))))))))))))))
