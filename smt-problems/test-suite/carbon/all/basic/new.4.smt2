...
(assert  (and (and (and (and (and (and (and (and (and (and (= (type Mask@4) (MapType1Type RefType realType)) (= (type freshObj@0) RefType)) (= (type Mask@3) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type ExhaleHeap@1) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type m@@7) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@4 freshObj@0 value)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 freshObj@0 value))) (=> (= (ControlFlow 0 2) 1) anon6_correct))))))
(let ((anon4_correct  (=> (= Mask@4 (MapType1Store Mask@3 freshObj@0 Node_n (real_2_U (- (U_2_real (MapType1Select Mask@3 freshObj@0 Node_n)) FullPerm)))) (=> (and (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@1 Mask@4) (state ExhaleHeap@1 Mask@4)) (and (=> (= (ControlFlow 0 5) 2) anon9_Then_correct) (=> (= (ControlFlow 0 5) 4) anon9_Else_correct))))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon4_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 Node_n)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 Node_n))) (=> (= (ControlFlow 0 6) 5) anon4_correct))))))
(let ((anon2_correct  (=> (= Mask@3 (MapType1Store Mask@2 freshObj@0 Node_v (real_2_U (- (U_2_real (MapType1Select Mask@2 freshObj@0 Node_v)) FullPerm)))) (=> (and (IdenticalOnKnownLocations Heap@0 ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3)) (and (=> (= (ControlFlow 0 9) 6) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct))))))
(let ((anon7_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 Node_v)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 Node_v))) (=> (= (ControlFlow 0 10) 9) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 m@@7 $allocated))) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@10 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@10 freshObj@0 $allocated (bool_2_U true)))) (and (and (= Mask@0 (MapType1Store ZeroMask freshObj@0 value (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 value)) FullPerm)))) (= Mask@1 (MapType1Store Mask@0 freshObj@0 Node_v (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@0 Node_v)) FullPerm))))) (and (= Mask@2 (MapType1Store Mask@1 freshObj@0 Node_n (real_2_U (+ (U_2_real (MapType1Select Mask@1 freshObj@0 Node_n)) FullPerm)))) (state Heap@0 Mask@2)))) (and (=> (= (ControlFlow 0 13) 10) anon7_Then_correct) (=> (= (ControlFlow 0 13) 12) anon7_Else_correct))))))
