...
(set-info :boogie-vc-id |getptr#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (valid this@@13) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid this@@13))) FullPerm)))) (=> (and (and (and (not (= this@@13 null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this@@13 ptr (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this@@13 ptr)) FullPerm))))) (and (state Heap@@18 UnfoldingMask@1) (not (= this@@13 null)))) (and (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 this@@13 len (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 this@@13 len)) FullPerm)))) (state Heap@@18 UnfoldingMask@2)) (and (state Heap@@18 UnfoldingMask@2) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm UnfoldingMask@2 this@@13 ptr)))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid this@@13))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid this@@13)))) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@18 ZeroMask) (U_2_bool (MapType0Select Heap@@18 this@@13 $allocated))) (and (= AssumeFunctionsAbove 1) (= Mask@0 (MapType1Store ZeroMask null (valid this@@13) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid this@@13))) FullPerm)))))) (and (and (state Heap@@18 Mask@0) (state Heap@@18 Mask@0)) (and (|valid#trigger| Heap@@18 (valid this@@13)) (= (MapType0Select Heap@@18 null (valid this@@13)) (CombineFrames (FrameFragment (MapType0Select Heap@@18 this@@13 ptr)) (FrameFragment (MapType0Select Heap@@18 this@@13 len))))))) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))
