...
(assert  (and (and (and (= (type Heap@@9) (MapType1Type RefType)) (= (type x@@19) RefType)) (= (type Mask@0) (MapType2Type RefType realType))) (= (type Heap@0) (MapType1Type RefType))))
(set-info :boogie-vc-id m3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType1Select Heap@@9 x@@19 $allocated)) (not (= x@@19 null))) (=> (and (and (not (= x@@19 null)) (= Mask@0 (MapType2Store ZeroMask x@@19 f_7 (real_2_U (+ (U_2_real (MapType2Select ZeroMask x@@19 f_7)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= FullPerm (U_2_real (MapType2Select Mask@0 x@@19 f_7)))) (=> (= FullPerm (U_2_real (MapType2Select Mask@0 x@@19 f_7))) (=> (and (= Heap@0 (MapType1Store Heap@@9 x@@19 f_7 (int_2_U 3))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 x@@19 f_7)) (=> (HasDirectPerm Mask@0 x@@19 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (MapType1Select Heap@0 x@@19 f_7)) 3))))))))))))
