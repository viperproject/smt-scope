...
(assert  (and (and (and (= (type xs@@39) (SeqType RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@41) (MapType0Type RefType))))
(set-info :boogie-vc-id |fun03#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon11_correct true))
(let ((anon18_Else_correct  (=> (and (not (and (<= 3 j_20) (< j_20 (|Seq#Length| xs@@39)))) (= (ControlFlow 0 22) 18)) anon11_correct)))
(let ((anon18_Then_correct  (=> (and (<= 3 j_20) (< j_20 (|Seq#Length| xs@@39))) (and (=> (= (ControlFlow 0 19) (- 0 21)) (>= j_20 0)) (=> (>= j_20 0) (and (=> (= (ControlFlow 0 19) (- 0 20)) (< j_20 (|Seq#Length| xs@@39))) (=> (< j_20 (|Seq#Length| xs@@39)) (=> (= (ControlFlow 0 19) 18) anon11_correct))))))))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 17)) (forall ((j_13 Int) (j_13_1 Int) ) (!  (=> (and (and (and (and (not (= j_13 j_13_1)) (and (<= 3 j_13) (< j_13 (|Seq#Length| xs@@39)))) (and (<= 3 j_13_1) (< j_13_1 (|Seq#Length| xs@@39)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@39 j_13) (|Seq#Index| xs@@39 j_13_1))))
 ...
 :qid |stdinbpl.1199:15|
 :skolemid |98|
)) (=> (and (forall ((j_13@@1 Int) ) (!  (=> (and (and (<= 3 j_13@@1) (< j_13@@1 (|Seq#Length| xs@@39))) (< NoPerm FullPerm)) (and (qpRange4 (|Seq#Index| xs@@39 j_13@@1)) (= (invRecv4 (|Seq#Index| xs@@39 j_13@@1)) j_13@@1)))
 :qid |stdinbpl.1205:22|
 :skolemid |99|
 :pattern ( (|Seq#Index| xs@@39 j_13@@1))
 :pattern ( (|Seq#Index| xs@@39 j_13@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 3 (invRecv4 o_3)) (< (invRecv4 o_3) (|Seq#Length| xs@@39))) (< NoPerm FullPerm)) (qpRange4 o_3)) (= (|Seq#Index| xs@@39 (invRecv4 o_3)) o_3)))
 :qid |stdinbpl.1209:22|
 :skolemid |100|
 :pattern ( (invRecv4 o_3))
))) (=> (and (and (and (forall ((j_13@@2 Int) ) (!  (=> (and (<= 3 j_13@@2) (< j_13@@2 (|Seq#Length| xs@@39))) (not (= (|Seq#Index| xs@@39 j_13@@2) null)))
 :qid |stdinbpl.1215:22|
 :skolemid |101|
 :pattern ( (|Seq#Index| xs@@39 j_13@@2))
 :pattern ( (|Seq#Index| xs@@39 j_13@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 3 (invRecv4 o_3@@0)) (< (invRecv4 o_3@@0) (|Seq#Length| xs@@39))) (< NoPerm FullPerm)) (qpRange4 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| xs@@39 (invRecv4 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (and (<= 3 (invRecv4 o_3@@0)) (< (invRecv4 o_3@@0) (|Seq#Length| xs@@39))) (< NoPerm FullPerm)) (qpRange4 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.1225:29|
 :skolemid |103|
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@1 o_3@@1 f_5))
)) (state Heap@@41 QPMask@1))) (and (and (state Heap@@41 QPMask@1) (<= 0 i@@29)) (and (< i@@29 (|Seq#Length| xs@@39)) (state Heap@@41 QPMask@1)))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= i@@29 0)) (=> (>= i@@29 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< i@@29 (|Seq#Length| xs@@39))) (=> (< i@@29 (|Seq#Length| xs@@39)) (=> (= (ControlFlow 0 14) (- 0 13)) (HasDirectPerm QPMask@1 (|Seq#Index| xs@@39 i@@29) f_7))))))))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 23) (- 0 24)) (forall ((j_11 Int) (j_11_1 Int) ) (!  (=> (and (and (and (and (not (= j_11 j_11_1)) (and (<= 0 j_11) (< j_11 3))) (and (<= 0 j_11_1) (< j_11_1 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@39 j_11) (|Seq#Index| xs@@39 j_11_1))))
 :qid |stdinbpl.1153:15|
 :skolemid |92|
))) (=> (forall ((j_11@@0 Int) (j_11_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_11@@0 j_11_1@@0)) (and (<= 0 j_11@@0) (< j_11@@0 3))) (and (<= 0 j_11_1@@0) (< j_11_1@@0 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@39 j_11@@0) (|Seq#Index| xs@@39 j_11_1@@0))))
 :qid |stdinbpl.1153:15|
 :skolemid |92|
)) (=> (forall ((j_11@@1 Int) ) (!  (=> (and (and (<= 0 j_11@@1) (< j_11@@1 3)) (< NoPerm FullPerm)) (and (qpRange3 (|Seq#Index| xs@@39 j_11@@1)) (= (invRecv3 (|Seq#Index| xs@@39 j_11@@1)) j_11@@1)))
 :qid |stdinbpl.1159:22|
 :skolemid |93|
 :pattern ( (|Seq#Index| xs@@39 j_11@@1))
 :pattern ( (|Seq#Index| xs@@39 j_11@@1))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (<= 0 (invRecv3 o_3@@2)) (< (invRecv3 o_3@@2) 3)) (< NoPerm FullPerm)) (qpRange3 o_3@@2)) (= (|Seq#Index| xs@@39 (invRecv3 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.1163:22|
 :skolemid |94|
 :pattern ( (invRecv3 o_3@@2))
)) (forall ((j_11@@2 Int) ) (!  (=> (and (<= 0 j_11@@2) (< j_11@@2 3)) (not (= (|Seq#Index| xs@@39 j_11@@2) null)))
 :qid |stdinbpl.1169:22|
 :skolemid |95|
 :pattern ( (|Seq#Index| xs@@39 j_11@@2))
 :pattern ( (|Seq#Index| xs@@39 j_11@@2))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (and (<= 0 (invRecv3 o_3@@3)) (< (invRecv3 o_3@@3) 3)) (< NoPerm FullPerm)) (qpRange3 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| xs@@39 (invRecv3 o_3@@3)) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv3 o_3@@3)) (< (invRecv3 o_3@@3) 3)) (< NoPerm FullPerm)) (qpRange3 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@3 f_7))))))
...
))) (and (state Heap@@41 QPMask@0) (state Heap@@41 QPMask@0))) (and (and (=> (= (ControlFlow 0 23) 14) anon17_Else_correct) (=> (= (ControlFlow 0 23) 19) anon18_Then_correct)) (=> (= (ControlFlow 0 23) 22) anon18_Else_correct)))))))))
(let ((anon7_correct true))
(let ((anon16_Else_correct  (=> (and (not (and (<= 0 j_19) (< j_19 3))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon16_Then_correct  (=> (and (<= 0 j_19) (< j_19 3)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= j_19 0)) (=> (>= j_19 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< j_19 (|Seq#Length| xs@@39))) (=> (< j_19 (|Seq#Length| xs@@39)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon13_Else_correct  (=> (and (forall ((k_3 Int) (j_9 Int) ) (!  (=> (and (>= k_3 0) (and (< k_3 (|Seq#Length| xs@@39)) (and (>= j_9 0) (and (< j_9 (|Seq#Length| xs@@39)) (not (= k_3 j_9)))))) (not (= (|Seq#Index| xs@@39 k_3) (|Seq#Index| xs@@39 j_9))))
 :qid |stdinbpl.1135:20|
 :skolemid |91|
 :pattern ( (|Seq#Index| xs@@39 k_3) (|Seq#Index| xs@@39 j_9))
)) (state Heap@@41 ZeroMask)) (and (and (=> (= (ControlFlow 0 25) 23) anon15_Else_correct) (=> (= (ControlFlow 0 25) 9) anon16_Then_correct)) (=> (= (ControlFlow 0 25) 12) anon16_Else_correct)))))
(let ((anon3_correct true))
(let ((anon14_Else_correct  (=> (and (not (and (>= k_1 0) (and (< k_1 (|Seq#Length| xs@@39)) (and (>= j_18 0) (and (< j_18 (|Seq#Length| xs@@39)) (not (= k_1 j_18))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon14_Then_correct  (=> (and (>= k_1 0) (and (< k_1 (|Seq#Length| xs@@39)) (and (>= j_18 0) (and (< j_18 (|Seq#Length| xs@@39)) (not (= k_1 j_18)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= k_1 0)) (=> (>= k_1 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< k_1 (|Seq#Length| xs@@39))) (=> (< k_1 (|Seq#Length| xs@@39)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_18 0)) (=> (>= j_18 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_18 (|Seq#Length| xs@@39))) (=> (< j_18 (|Seq#Length| xs@@39)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove 1)) (and (> (|Seq#Length| xs@@39) 6) (state Heap@@41 ZeroMask))) (and (and (=> (= (ControlFlow 0 26) 25) anon13_Else_correct) (=> (= (ControlFlow 0 26) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 26) 7) anon14_Else_correct)))))
