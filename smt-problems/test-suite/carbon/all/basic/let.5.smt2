...
(assert  (and (and (= (type Heap@@19) (MapType0Type RefType)) (= (type x@@23) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |fun02#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@19 x@@23 $allocated)) (= AssumeFunctionsAbove 0)) (=> (and (and (not (= x@@23 null)) (= Mask@0 (MapType1Store ZeroMask x@@23 g (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@23 g)) FullPerm))))) (and (state Heap@@19 Mask@0) (state Heap@@19 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 x@@23 g)) (=> (HasDirectPerm Mask@0 x@@23 g) (=> (and (= y_1@0 (U_2_int (MapType0Select Heap@@19 x@@23 g))) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm Mask@0 x@@23 g)))))))))
