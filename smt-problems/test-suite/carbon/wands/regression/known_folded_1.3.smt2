...
(let ((anon77_Then_correct  (=> (> takeTransfer@5 0.0) (=> (and (and (= neededTransfer@10 (- neededTransfer@9 takeTransfer@5)) (= Used_3Mask@2 (MapType0Store Used_3Mask@1 x@@20 f_7 (real_2_U (+ (U_2_real (MapType0Select Used_3Mask@1 x@@20 f_7)) takeTransfer@5))))) (and (= b_6@4  (and b_6@3 (state Used_3Heap@0 Used_3Mask@2))) (= b_6@5  (and b_6@4 (= (U_2_int (MapType1Select Heap@5 x@@20 f_7)) (U_2_int (MapType1Select Used_3Heap@0 x@@20 f_7))))))) (=> (and (and (and (= Mask@6 (MapType0Store Mask@5 x@@20 f_7 (real_2_U (- (U_2_real (MapType0Select Mask@5 x@@20 f_7)) takeTransfer@5)))) (= Heap@6 (MapType1Store Heap@5 null (|wand#sm| x@@20 FullPerm x@@20 2 x@@20 FullPerm x@@20 2) (MapType0Store (MapType1Select Heap@5 null (|wand#sm| x@@20 FullPerm x@@20 2 x@@20 FullPerm x@@20 2)) x@@20 f_7 (bool_2_U true))))) (and (= neededTransfer@11 neededTransfer@10) (= Heap@7 Heap@6))) (and (and (= Mask@7 Mask@6) (= b_6@6 b_6@5)) (and (= Used_3Mask@3 Used_3Mask@2) (= (ControlFlow 0 12) 9)))) anon49_correct)))))
...
(let ((anon75_Then_correct  (=> (and (and (and (and (and b_1_1@22 b_1_1@22) b_6@3) true) (> neededTransfer@9 0.0)) (= maskTransfer@5 (U_2_real (MapType0Select Mask@5 x@@20 f_7)))) (and (=> (= (ControlFlow 0 16) 14) anon76_Then_correct) (=> (= (ControlFlow 0 16) 15) anon76_Else_correct)))))
...
(let ((anon74_Then_correct  (=> (and (> takeTransfer@4 0.0) (= neededTransfer@8 (- FullPerm takeTransfer@4))) (=> (and (and (and (= Used_3Mask@0 (MapType0Store ZeroMask x@@20 f_7 (real_2_U (+ (U_2_real (MapType0Select ZeroMask x@@20 f_7)) takeTransfer@4)))) (= b_6@1  (and b_6@0 (state Used_3Heap@0 Used_3Mask@0)))) (and (= b_6@2  (and b_6@1 (= (U_2_int (MapType1Select Ops_1Heap@5 x@@20 f_7)) (U_2_int (MapType1Select Used_3Heap@0 x@@20 f_7))))) (= Ops_1Mask@11 (MapType0Store Ops_1Mask@10 x@@20 f_7 (real_2_U (- (U_2_real (MapType0Select Ops_1Mask@10 x@@20 f_7)) takeTransfer@4)))))) (and (and (= Ops_1Mask@12 Ops_1Mask@11) (= Used_3Mask@1 Used_3Mask@0)) (and (= b_6@3 b_6@2) (= neededTransfer@9 neededTransfer@8)))) (and (=> (= (ControlFlow 0 18) 16) anon75_Then_correct) (=> (= (ControlFlow 0 18) 11) anon75_Else_correct))))))
...
(let ((anon72_Then_correct  (=> (and (and (and (and (and b_1_1@22 b_1_1@22) b_6@0) true) (> FullPerm 0.0)) (= maskTransfer@4 (U_2_real (MapType0Select Ops_1Mask@10 x@@20 f_7)))) (and (=> (= (ControlFlow 0 22) 20) anon73_Then_correct) (=> (= (ControlFlow 0 22) 21) anon73_Else_correct)))))
...
(let ((anon37_correct  (=> (and (= b_6@0  (and b_6 (state Used_3Heap@0 ZeroMask))) (= initNeededTransfer@2 (+ (U_2_real (MapType0Select ZeroMask x@@20 f_7)) FullPerm))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 23) 22) anon72_Then_correct) (=> (= (ControlFlow 0 23) 17) anon72_Else_correct)))))))
(let ((anon36_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (=> (and b_1_1@14 b_4@6) (and (= neededTransfer@7 0.0) (= (U_2_real (MapType0Select Used_2Mask@3 null (P x@@20))) initNeededTransfer@1)))) (=> (=> (and b_1_1@14 b_4@6) (and (= neededTransfer@7 0.0) (= (U_2_real (MapType0Select Used_2Mask@3 null (P x@@20))) initNeededTransfer@1))) (=> (and (= b_5@0  (and b_1_1@14 b_4@6)) (= b_5@1  (and b_5@0 (state Result_1Heap Result_1Mask)))) (=> (and (and (and (and (= b_5@2  (and b_5@1 (sumMask Result_1Mask Ops_1Mask@8 Used_2Mask@3))) (= b_5@3  (and (and b_5@2 (IdenticalOnKnownLocations Ops_1Heap@5 Result_1Heap Ops_1Mask@8)) (IdenticalOnKnownLocations Used_2Heap@0 Result_1Heap Used_2Mask@3)))) (and (= b_5@4  (and b_5@3 (state Result_1Heap Result_1Mask))) (= b_1_1@15  (and b_1_1@14 b_5@4)))) (and (and (= b_1_1@16  (and b_1_1@15 b_4@6)) (= b_1_1@17  (and b_1_1@16 (= Used_2Heap@0 Ops_1Heap@5)))) (and (= b_1_1@18  (and b_1_1@17 (not (= x@@20 null)))) (= Ops_1Mask@9 (MapType0Store Ops_1Mask@8 x@@20 f_7 (real_2_U (+ (U_2_real (MapType0Select Ops_1Mask@8 x@@20 f_7)) FullPerm))))))) (and (and (and (= b_1_1@19  (and b_1_1@18 (state Ops_1Heap@5 Ops_1Mask@9))) (= b_1_1@20  (and b_1_1@19 (state Ops_1Heap@5 Ops_1Mask@9)))) (and (= b_1_1@21  (and b_1_1@20 (state Ops_1Heap@5 Ops_1Mask@9))) (= b_1_1@22 b_1_1@21))) (and (and (= Heap@5 Heap@4) (= Mask@5 Mask@4)) (and (= Ops_1Mask@10 Ops_1Mask@9) (= (ControlFlow 0 26) 23))))) anon37_correct))))))
...
(let ((anon71_Then_correct  (=> (> takeTransfer@3 0.0) (=> (and (= neededTransfer@6 (- neededTransfer@5 takeTransfer@3)) (= Used_2Mask@2 (MapType0Store Used_2Mask@1 null (P x@@20) (real_2_U (+ (U_2_real (MapType0Select Used_2Mask@1 null (P x@@20))) takeTransfer@3))))) (=> (and (and (= b_4@4  (and b_4@3 (state Used_2Heap@0 Used_2Mask@2))) (= TempMask@1 (MapType0Store ZeroMask null (P x@@20) (real_2_U FullPerm)))) (and (= b_4@5  (and b_4@4 (IdenticalOnKnownLocations Heap@2 Used_2Heap@0 TempMask@1))) (= Mask@3 (MapType0Store Mask@2 null (P x@@20) (real_2_U (- (U_2_real (MapType0Select Mask@2 null (P x@@20))) takeTransfer@3)))))) (=> (and (and (and (forall ((o_3 T@U) (f_8 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_8))))
(let ((A@@12 (FieldTypeInv0 (type f_8))))
 (=> (and (and (= (type o_3) RefType) (= (type f_8) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType0Select (MapType1Select Heap@2 null (|wand#sm| x@@20 FullPerm x@@20 2 x@@20 FullPerm x@@20 2)) o_3 f_8)) (U_2_bool (MapType0Select (MapType1Select Heap@2 null (|P#sm| x@@20)) o_3 f_8)))) (U_2_bool (MapType0Select newPMask@0 o_3 f_8)))))
 :qid |stdinbpl.633:39|
 :skolemid |55|
 :pattern ( (MapType0Select newPMask@0 o_3 f_8))
)) (= Heap@3 (MapType1Store Heap@2 null (|wand#sm| x@@20 FullPerm x@@20 2 x@@20 FullPerm x@@20 2) newPMask@0))) (and (= neededTransfer@7 neededTransfer@6) (= Mask@4 Mask@3))) (and (and (= Heap@4 Heap@3) (= b_4@6 b_4@5)) (and (= Used_2Mask@3 Used_2Mask@2) (= (ControlFlow 0 29) 26)))) anon36_correct))))))
...
(let ((anon69_Then_correct  (=> (and (and (and (and b_1_1@14 b_4@3) true) (> neededTransfer@5 0.0)) (= maskTransfer@3 (U_2_real (MapType0Select Mask@2 null (P x@@20))))) (and (=> (= (ControlFlow 0 33) 31) anon70_Then_correct) (=> (= (ControlFlow 0 33) 32) anon70_Else_correct)))))
...
(let ((anon68_Then_correct  (=> (> takeTransfer@2 0.0) (=> (and (= neededTransfer@4 (- FullPerm takeTransfer@2)) (= Used_2Mask@0 (MapType0Store ZeroMask null (P x@@20) (real_2_U (+ (U_2_real (MapType0Select ZeroMask null (P x@@20))) takeTransfer@2))))) (=> (and (and (and (= b_4@1  (and b_4@0 (state Used_2Heap@0 Used_2Mask@0))) (= TempMask@0 (MapType0Store ZeroMask null (P x@@20) (real_2_U FullPerm)))) (and (= b_4@2  (and b_4@1 (IdenticalOnKnownLocations Ops_1Heap@5 Used_2Heap@0 TempMask@0))) (= Ops_1Mask@7 (MapType0Store Ops_1Mask@6 null (P x@@20) (real_2_U (- (U_2_real (MapType0Select Ops_1Mask@6 null (P x@@20))) takeTransfer@2)))))) (and (and (= Ops_1Mask@8 Ops_1Mask@7) (= Used_2Mask@1 Used_2Mask@0)) (and (= b_4@3 b_4@2) (= neededTransfer@5 neededTransfer@4)))) (and (=> (= (ControlFlow 0 35) 33) anon69_Then_correct) (=> (= (ControlFlow 0 35) 28) anon69_Else_correct)))))))
...
(let ((anon66_Then_correct  (=> (and (and (and (and b_1_1@14 b_4@0) true) (> FullPerm 0.0)) (= maskTransfer@2 (U_2_real (MapType0Select Ops_1Mask@6 null (P x@@20))))) (and (=> (= (ControlFlow 0 39) 37) anon67_Then_correct) (=> (= (ControlFlow 0 39) 38) anon67_Else_correct)))))
...
(let ((anon65_Then_correct  (=> b_1_1@14 (=> (and (and (|P#trigger| Ops_1Heap@5 (P x@@20)) (= (MapType1Select Ops_1Heap@5 null (P x@@20)) (FrameFragment (MapType1Select Ops_1Heap@5 x@@20 f_7)))) (and (= b_4@0  (and b_4 (state Used_2Heap@0 ZeroMask))) (= initNeededTransfer@1 (+ (U_2_real (MapType0Select ZeroMask null (P x@@20))) FullPerm)))) (and (=> (= (ControlFlow 0 40) (- 0 41)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 40) 39) anon66_Then_correct) (=> (= (ControlFlow 0 40) 34) anon66_Else_correct))))))))
...
(let ((anon22_correct  (=> (and (and (and (= Ops_1Heap@4 (MapType1Store Ops_1Heap@3 null (|P#sm| x@@20) (MapType0Store (MapType1Select Ops_1Heap@3 null (|P#sm| x@@20)) x@@20 f_7 (bool_2_U true)))) (state Ops_1Heap@4 Ops_1Mask@5)) (and (= b_1_1@13  (and b_1_1@12 (state Ops_1Heap@4 Ops_1Mask@5))) (= Ops_1Heap@5 Ops_1Heap@4))) (and (and (= b_1_1@14 b_1_1@13) (= Mask@2 Mask@1)) (and (= Ops_1Mask@6 Ops_1Mask@5) (= Heap@2 Heap@1)))) (and (=> (= (ControlFlow 0 43) 40) anon65_Then_correct) (=> (= (ControlFlow 0 43) 25) anon65_Else_correct)))))
(let ((anon64_Else_correct  (=> (HasDirectPerm Ops_1Mask@5 null (P x@@20)) (=> (and (= Ops_1Heap@3 Ops_1Heap@0) (= (ControlFlow 0 45) 43)) anon22_correct))))
(let ((anon64_Then_correct  (=> (not (HasDirectPerm Ops_1Mask@5 null (P x@@20))) (=> (and (and (= Ops_1Heap@1 (MapType1Store Ops_1Heap@0 null (|P#sm| x@@20) ZeroPMask)) (= Ops_1Heap@2 (MapType1Store Ops_1Heap@1 null (P x@@20) freshVersion@0))) (and (= Ops_1Heap@3 Ops_1Heap@2) (= (ControlFlow 0 44) 43))) anon22_correct))))
(let ((anon20_correct  (and (=> (= (ControlFlow 0 46) (- 0 47)) (=> (and b_1_1@7 b_2_1@6) (and (= neededTransfer@3 0.0) (= (U_2_real (MapType0Select Used_1Mask@3 x@@20 f_7)) initNeededTransfer@0)))) (=> (=> (and b_1_1@7 b_2_1@6) (and (= neededTransfer@3 0.0) (= (U_2_real (MapType0Select Used_1Mask@3 x@@20 f_7)) initNeededTransfer@0))) (=> (= b_3@0  (and b_1_1@7 b_2_1@6)) (=> (and (and (= b_3@1  (and b_3@0 (state ResultHeap ResultMask@@0))) (= b_3@2  (and b_3@1 (sumMask ResultMask@@0 Ops_1Mask@4 Used_1Mask@3)))) (and (= b_3@3  (and (and b_3@2 (IdenticalOnKnownLocations Ops_1Heap@0 ResultHeap Ops_1Mask@4)) (IdenticalOnKnownLocations Used_1Heap@0 ResultHeap Used_1Mask@3))) (= b_3@4  (and b_3@3 (state ResultHeap ResultMask@@0))))) (=> (and (and (and (= b_1_1@8  (and b_1_1@7 b_3@4)) (= b_1_1@9  (and b_1_1@8 b_2_1@6))) (and (= b_1_1@10  (and b_1_1@9 (= Used_1Heap@0 Ops_1Heap@0))) (= Ops_1Mask@5 (MapType0Store Ops_1Mask@4 null (P x@@20) (real_2_U (+ (U_2_real (MapType0Select Ops_1Mask@4 null (P x@@20))) FullPerm)))))) (and (and (= b_1_1@11  (and b_1_1@10 (state Ops_1Heap@0 Ops_1Mask@5))) (= b_1_1@12  (and b_1_1@11 (state Ops_1Heap@0 Ops_1Mask@5)))) (and (|P#trigger| Ops_1Heap@0 (P x@@20)) (= (MapType1Select Ops_1Heap@0 null (P x@@20)) (FrameFragment (MapType1Select Ops_1Heap@0 x@@20 f_7)))))) (and (=> (= (ControlFlow 0 46) 44) anon64_Then_correct) (=> (= (ControlFlow 0 46) 45) anon64_Else_correct)))))))))
(let ((anon63_Else_correct  (=> (>= 0.0 takeTransfer@1) (=> (and (= Mask@1 ZeroMask) (= neededTransfer@3 neededTransfer@1)) (=> (and (and (= b_2_1@6 b_2_1@3) (= Used_1Mask@3 Used_1Mask@1)) (and (= Heap@1 Heap@@11) (= (ControlFlow 0 50) 46))) anon20_correct)))))
(let ((anon63_Then_correct  (=> (> takeTransfer@1 0.0) (=> (and (and (= neededTransfer@2 (- neededTransfer@1 takeTransfer@1)) (= Used_1Mask@2 (MapType0Store Used_1Mask@1 x@@20 f_7 (real_2_U (+ (U_2_real (MapType0Select Used_1Mask@1 x@@20 f_7)) takeTransfer@1))))) (and (= b_2_1@4  (and b_2_1@3 (state Used_1Heap@0 Used_1Mask@2))) (= b_2_1@5  (and b_2_1@4 (= (U_2_int (MapType1Select Heap@@11 x@@20 f_7)) (U_2_int (MapType1Select Used_1Heap@0 x@@20 f_7))))))) (=> (and (and (and (= Mask@0 (MapType0Store ZeroMask x@@20 f_7 (real_2_U (- (U_2_real (MapType0Select ZeroMask x@@20 f_7)) takeTransfer@1)))) (= Heap@0 (MapType1Store Heap@@11 null (|wand#sm| x@@20 FullPerm x@@20 2 x@@20 FullPerm x@@20 2) (MapType0Store (MapType1Select Heap@@11 null (|wand#sm| x@@20 FullPerm x@@20 2 x@@20 FullPerm x@@20 2)) x@@20 f_7 (bool_2_U true))))) (and (= Mask@1 Mask@0) (= neededTransfer@3 neededTransfer@2))) (and (and (= b_2_1@6 b_2_1@5) (= Used_1Mask@3 Used_1Mask@2)) (and (= Heap@1 Heap@0) (= (ControlFlow 0 49) 46)))) anon20_correct)))))
...
(let ((anon61_Then_correct  (=> (and (and (and (and b_1_1@7 b_2_1@3) true) (> neededTransfer@1 0.0)) (= maskTransfer@1 (U_2_real (MapType0Select ZeroMask x@@20 f_7)))) (and (=> (= (ControlFlow 0 53) 51) anon62_Then_correct) (=> (= (ControlFlow 0 53) 52) anon62_Else_correct)))))
(let ((anon61_Else_correct  (=> (not (and (and (and b_1_1@7 b_2_1@3) true) (> neededTransfer@1 0.0))) (=> (and (= Mask@1 ZeroMask) (= neededTransfer@3 neededTransfer@1)) (=> (and (and (= b_2_1@6 b_2_1@3) (= Used_1Mask@3 Used_1Mask@1)) (and (= Heap@1 Heap@@11) (= (ControlFlow 0 48) 46))) anon20_correct)))))
...
(let ((anon60_Then_correct  (=> (and (> takeTransfer@0 0.0) (= neededTransfer@0 (- FullPerm takeTransfer@0))) (=> (and (and (and (= Used_1Mask@0 (MapType0Store ZeroMask x@@20 f_7 (real_2_U (+ (U_2_real (MapType0Select ZeroMask x@@20 f_7)) takeTransfer@0)))) (= b_2_1@1  (and b_2_1@0 (state Used_1Heap@0 Used_1Mask@0)))) (and (= b_2_1@2  (and b_2_1@1 (= (U_2_int (MapType1Select Ops_1Heap@0 x@@20 f_7)) (U_2_int (MapType1Select Used_1Heap@0 x@@20 f_7))))) (= Ops_1Mask@3 (MapType0Store Ops_1Mask@2 x@@20 f_7 (real_2_U (- (U_2_real (MapType0Select Ops_1Mask@2 x@@20 f_7)) takeTransfer@0)))))) (and (and (= Ops_1Mask@4 Ops_1Mask@3) (= Used_1Mask@1 Used_1Mask@0)) (and (= b_2_1@3 b_2_1@2) (= neededTransfer@1 neededTransfer@0)))) (and (=> (= (ControlFlow 0 55) 53) anon61_Then_correct) (=> (= (ControlFlow 0 55) 48) anon61_Else_correct))))))
...
(let ((anon58_Then_correct  (=> (and (and (and (and b_1_1@7 b_2_1@0) true) (> FullPerm 0.0)) (= maskTransfer@0 (U_2_real (MapType0Select Ops_1Mask@2 x@@20 f_7)))) (and (=> (= (ControlFlow 0 59) 57) anon59_Then_correct) (=> (= (ControlFlow 0 59) 58) anon59_Else_correct)))))
...
(let ((anon57_Then_correct  (=> b_1_1@7 (=> (and (= b_2_1@0  (and b_2_1 (state Used_1Heap@0 ZeroMask))) (= initNeededTransfer@0 (+ (U_2_real (MapType0Select ZeroMask x@@20 f_7)) FullPerm))) (and (=> (= (ControlFlow 0 60) (- 0 61)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 60) 59) anon58_Then_correct) (=> (= (ControlFlow 0 60) 54) anon58_Else_correct))))))))
(let ((anon57_Else_correct  (=> (and (not b_1_1@7) (= Ops_1Heap@5 Ops_1Heap@0)) (=> (and (and (= b_1_1@14 b_1_1@7) (= Mask@2 ZeroMask)) (and (= Ops_1Mask@6 Ops_1Mask@2) (= Heap@2 Heap@@11))) (and (=> (= (ControlFlow 0 42) 40) anon65_Then_correct) (=> (= (ControlFlow 0 42) 25) anon65_Else_correct))))))
...
(let ((anon6_correct  (=> (and (and (= b_1_1@4  (and b_1_1@3 (= (U_2_int (MapType1Select Ops_1Heap@0 x@@20 f_7)) 2))) (= b_1_1@5 b_1_1@4)) (and (= Ops_1Mask@2 Ops_1Mask@1) (= (ControlFlow 0 65) 62))) anon7_correct)))
(let ((anon56_Else_correct  (=> (and (not b_1_1@3) (= (ControlFlow 0 68) 65)) anon6_correct)))
(let ((anon56_Then_correct  (=> b_1_1@3 (and (=> (= (ControlFlow 0 66) (- 0 67)) (HasDirectPerm Ops_1Mask@1 x@@20 f_7)) (=> (HasDirectPerm Ops_1Mask@1 x@@20 f_7) (=> (= (ControlFlow 0 66) 65) anon6_correct))))))
...
(let ((anon54_Then_correct  (=> (and b_1_1@0 (= b_1_1@1  (and b_1_1@0 (not (= x@@20 null))))) (=> (and (and (= Ops_1Mask@0 (MapType0Store ZeroMask x@@20 f_7 (real_2_U (+ (U_2_real (MapType0Select ZeroMask x@@20 f_7)) FullPerm)))) (= b_1_1@2  (and b_1_1@1 (state Ops_1Heap@0 Ops_1Mask@0)))) (and (= Ops_1Mask@1 Ops_1Mask@0) (= b_1_1@3 b_1_1@2))) (and (=> (= (ControlFlow 0 70) 69) anon55_Then_correct) (=> (= (ControlFlow 0 70) 64) anon55_Else_correct))))))
...
(let ((anon0_correct  (=> (and (and (state Heap@@11 ZeroMask) (U_2_bool (MapType1Select Heap@@11 x@@20 $allocated))) (and (= b_1_1@0  (and b_1_1 (state Ops_1Heap@0 ZeroMask))) (= b_2@0  (and b_2 (state UsedHeap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 73) 72) anon53_Then_correct) (=> (= (ControlFlow 0 73) 63) anon53_Else_correct)))))
