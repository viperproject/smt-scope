...
(assert  (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type x@@28) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |p1#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x@@28 $allocated))) (=> (and (and (not (= x@@28 null)) (= Mask@0 (MapType1Store ZeroMask x@@28 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@28 f_7)) FullPerm))))) (and (state Heap@@10 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@0 x@@28 f_7)))))
