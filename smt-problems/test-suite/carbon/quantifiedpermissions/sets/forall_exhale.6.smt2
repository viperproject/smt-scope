...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((q_1 T@U) (q_1_1 T@U) ) (!  (=> (and (= (type q_1) RefType) (= (type q_1_1) RefType)) (=> (and (and (and (and (not (= q_1 q_1_1)) (U_2_bool (MapType2Select zs q_1))) (U_2_bool (MapType2Select zs q_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= q_1 q_1_1))))
 :qid |stdinbpl.779:17|
 :skolemid |112|
 :pattern ( (neverTriggered6 q_1) (neverTriggered6 q_1_1))
))) (=> (forall ((q_1@@0 T@U) (q_1_1@@0 T@U) ) (!  (=> (and (= (type q_1@@0) RefType) (= (type q_1_1@@0) RefType)) (=> (and (and (and (and (not (= q_1@@0 q_1_1@@0)) (U_2_bool (MapType2Select zs q_1@@0))) (U_2_bool (MapType2Select zs q_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= q_1@@0 q_1_1@@0))))
 :qid |stdinbpl.779:17|
 :skolemid |112|
 :pattern ( (neverTriggered6 q_1@@0) (neverTriggered6 q_1_1@@0))
)) (=> (= (ControlFlow 0 5) (- 0 4)) (forall ((q_1@@1 T@U) ) (!  (=> (and (= (type q_1@@1) RefType) (U_2_bool (MapType2Select zs q_1@@1))) (>= (U_2_real (MapType1Select QPMask@1 q_1@@1 f_7)) FullPerm))
 :qid |stdinbpl.786:17|
 :skolemid |113|
 :pattern ( (MapType0Select ExhaleHeap@0 q_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@2 q_1@@1 f_7))
 :pattern ( (MapType2Select zs q_1@@1))
)))))))
(let ((anon9_Then_correct true))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((u_1 T@U) (u_1_1 T@U) ) (!  (=> (and (= (type u_1) RefType) (= (type u_1_1) RefType)) (=> (and (and (and (and (not (= u_1 u_1_1)) (U_2_bool (MapType2Select ys u_1))) (U_2_bool (MapType2Select ys u_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= u_1 u_1_1))))
 :qid |stdinbpl.724:17|
 :skolemid |106|
 :pattern ( (neverTriggered5 u_1) (neverTriggered5 u_1_1))
))) (=> (forall ((u_1@@0 T@U) (u_1_1@@0 T@U) ) (!  (=> (and (= (type u_1@@0) RefType) (= (type u_1_1@@0) RefType)) (=> (and (and (and (and (not (= u_1@@0 u_1_1@@0)) (U_2_bool (MapType2Select ys u_1@@0))) (U_2_bool (MapType2Select ys u_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= u_1@@0 u_1_1@@0))))
 :qid |stdinbpl.724:17|
 :skolemid |106|
 :pattern ( (neverTriggered5 u_1@@0) (neverTriggered5 u_1_1@@0))
)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((u_1@@1 T@U) ) (!  (=> (and (= (type u_1@@1) RefType) (U_2_bool (MapType2Select ys u_1@@1))) (>= (U_2_real (MapType1Select QPMask@0 u_1@@1 f_7)) FullPerm))
 :qid |stdinbpl.731:17|
 :skolemid |107|
 :pattern ( (MapType0Select Heap@@9 u_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 u_1@@1 f_7))
 :pattern ( (MapType2Select ys u_1@@1))
))) (=> (forall ((u_1@@2 T@U) ) (!  (=> (and (= (type u_1@@2) RefType) (U_2_bool (MapType2Select ys u_1@@2))) (>= (U_2_real (MapType1Select QPMask@0 u_1@@2 f_7)) FullPerm))
 :qid |stdinbpl.731:17|
 :skolemid |107|
 :pattern ( (MapType0Select Heap@@9 u_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@1 u_1@@2 f_7))
 :pattern ( (MapType2Select ys u_1@@2))
)) (=> (and (forall ((u_1@@3 T@U) ) (!  (=> (= (type u_1@@3) RefType) (=> (and (U_2_bool (MapType2Select ys u_1@@3)) (< NoPerm FullPerm)) (and (qpRange5 u_1@@3) (= (invRecv5 u_1@@3) u_1@@3))))
 :qid |stdinbpl.737:22|
 :skolemid |108|
 :pattern ( (MapType0Select Heap@@9 u_1@@3 f_7))
 :pattern ( (MapType1Select QPMask@1 u_1@@3 f_7))
 :pattern ( (MapType2Select ys u_1@@3))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType2Select ys (invRecv5 o_3))) (and (< NoPerm FullPerm) (qpRange5 o_3))) (= (invRecv5 o_3) o_3)))
 :qid |stdinbpl.741:22|
 :skolemid |109|
 :pattern ( (invRecv5 o_3))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType2Select ys (invRecv5 o_3@@0))) (and (< NoPerm FullPerm) (qpRange5 o_3@@0))) (and (= (invRecv5 o_3@@0) o_3@@0) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (- (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select ys (invRecv5 o_3@@0))) (and (< NoPerm FullPerm) (qpRange5 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7))))))
 :qid |stdinbpl.747:22|
 :skolemid |110|
...
))) (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 QPMask@1) (state ExhaleHeap@0 QPMask@1))) (and (=> (= (ControlFlow 0 7) 3) anon9_Then_correct) (=> (= (ControlFlow 0 7) 5) anon9_Else_correct))))))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select zs x_1))) (U_2_bool (MapType2Select zs x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.667:15|
 :skolemid |100|
 :no-pattern (type x_1)
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (U_2_bool (MapType2Select zs x_1@@0))) (U_2_bool (MapType2Select zs x_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.667:15|
 :skolemid |100|
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select zs x_1@@1)) (< NoPerm FullPerm)) (and (qpRange4 x_1@@1) (= (invRecv4 x_1@@1) x_1@@1))))
 :qid |stdinbpl.673:22|
 :skolemid |101|
 :pattern ( (MapType0Select Heap@@9 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
 :pattern ( (MapType2Select zs x_1@@1))
)) (=> (and (and (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType2Select zs (invRecv4 o_3@@2))) (< NoPerm FullPerm)) (qpRange4 o_3@@2)) (= (invRecv4 o_3@@2) o_3@@2)))
 :qid |stdinbpl.677:22|
 :skolemid |102|
 :pattern ( (invRecv4 o_3@@2))
)) (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (U_2_bool (MapType2Select zs x_1@@2))) (not (= x_1@@2 null)))
 :qid |stdinbpl.683:22|
 :skolemid |103|
 :pattern ( (MapType0Select Heap@@9 x_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@2 f_7))
 :pattern ( (MapType2Select zs x_1@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType2Select zs (invRecv4 o_3@@3))) (< NoPerm FullPerm)) (qpRange4 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select zs (invRecv4 o_3@@3))) (< NoPerm FullPerm)) (qpRange4 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@3 f_7))))))
 :qid |stdinbpl.689:22|
 :skolemid |104|
...
)))) (and (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)) (and (|Set#Subset| ys zs) (state Heap@@9 QPMask@0)))) (and (=> (= (ControlFlow 0 10) 2) anon8_Then_correct) (=> (= (ControlFlow 0 10) 7) anon8_Else_correct))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 12) 1) anon7_Then_correct) (=> (= (ControlFlow 0 12) 10) anon7_Else_correct)))))
