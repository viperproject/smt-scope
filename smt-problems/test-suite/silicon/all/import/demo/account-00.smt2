(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 19:44:23
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/import/demo/account.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
; [eval] balance(this)
(push) ; 3
(assert (balance%precondition ($Snap.first $t@5@01) this@2@01))
(pop) ; 3
...
; [eval] balance(this)
(push) ; 3
(assert (balance%precondition ($Snap.second $t@4@01) this@2@01))
(pop) ; 3
; Joined path conditions
(assert (balance%precondition ($Snap.second $t@4@01) this@2@01))
(assert (=
  (balance ($Snap.first $t@5@01) this@2@01)
  (+ (balance ($Snap.second $t@4@01) this@2@01) n@3@01)))
(pop) ; 2
(push) ; 2
; [exec]
; inhale false
