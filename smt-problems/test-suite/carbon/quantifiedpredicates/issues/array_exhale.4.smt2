...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 (loc a_3@@8 1) val)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 (loc a_3@@8 1) val))) (=> (= (ControlFlow 0 4) 3) anon6_correct))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@8 (+ i_1 1)) (loc a_3@@8 (+ i_1_1 1)))))
 ...
 :qid |stdinbpl.1214:15|
 :skolemid |110|
)) (=> (forall ((i_1@@1 T@U) ) (!  (=> (= (type i_1@@1) intType) (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) i_1@@1) (< NoPerm FullPerm)) (and (qpRange8 (loc a_3@@8 (+ (U_2_int i_1@@1) 1))) (= (invRecv8 (loc a_3@@8 (+ (U_2_int i_1@@1) 1))) (U_2_int i_1@@1)))))
 :qid |stdinbpl.1220:22|
 :skolemid |111|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) i_1@@1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) i_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv8 o_3))) (< NoPerm FullPerm)) (qpRange8 o_3)) (= (loc a_3@@8 (+ (invRecv8 o_3) 1)) o_3)))
...
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv8 o_3@@0))) (< NoPerm FullPerm)) (qpRange8 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@8 (+ (invRecv8 o_3@@0) 1)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv8 o_3@@0))) (< NoPerm FullPerm)) (qpRange8 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
