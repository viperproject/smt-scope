...
(declare-fun ys () T@U)
(declare-fun zs () T@U)
(assert  (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type xs) (MapType2Type RefType boolType))) (= (type ys) (MapType2Type RefType boolType))) (= (type zs) (MapType2Type RefType boolType))))
(set-info :boogie-vc-id test1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (|Set#Equal| (|Set#Intersection| xs ys) zs) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (|Set#Equal| (|Set#Intersection| ys xs) zs)))))
