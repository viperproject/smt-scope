...
(assert (forall ((Heap@@4 T@U) (i_1@@0 Int) ) (!  (=> (= (type Heap@@4) (MapType0Type RefType)) (and (= (interp Heap@@4 i_1@@0) (|interp'| Heap@@4 i_1@@0)) (dummyFunction (int_2_U (|interp#triggerStateless| i_1@@0)))))
 :qid |stdinbpl.201:15|
 :skolemid |23|
 :pattern ( (interp Heap@@4 i_1@@0))
)))
...
(assert (forall ((Heap@@7 T@U) (Mask@@6 T@U) (i_1@@1 Int) ) (!  (=> (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (and (state Heap@@7 Mask@@6) (< AssumeFunctionsAbove 0))) (= (interp Heap@@7 i_1@@1) (+ i_1@@1 1)))
 :qid |stdinbpl.211:15|
 :skolemid |25|
 :pattern ( (state Heap@@7 Mask@@6) (interp Heap@@7 i_1@@1))
)))
...
(assert (forall ((Heap@@10 T@U) (Mask@@10 T@U) (i_1@@2 Int) ) (!  (=> (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (state Heap@@10 Mask@@10)) (= (|interp'| Heap@@10 i_1@@2) (|interp#frame| EmptyFrame i_1@@2)))
 :qid |stdinbpl.218:15|
 :skolemid |26|
 :pattern ( (state Heap@@10 Mask@@10) (|interp'| Heap@@10 i_1@@2))
)))
...
(assert (forall ((i_1@@3 Int) ) (! (= (unint i_1@@3) (+ (interp dummyHeap i_1@@3) 1))
 :qid |stdinbpl.189:15|
 :skolemid |22|
 :pattern ( (unint i_1@@3))
)))
...
(set-info :boogie-vc-id huh)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (unint 4) 6)) (=> (= (unint 4) 6) (=> (and (state Heap@@13 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (unint 14) 14)))))))
