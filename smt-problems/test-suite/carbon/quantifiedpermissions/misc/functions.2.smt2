...
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 i_13) (< i_13 (|Seq#Length| xs@@39)))) (= (ControlFlow 0 18) 14)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (<= 0 i_13) (< i_13 (|Seq#Length| xs@@39))) (and (=> (= (ControlFlow 0 15) (- 0 17)) (>= i_13 0)) (=> (>= i_13 0) (and (=> (= (ControlFlow 0 15) (- 0 16)) (< i_13 (|Seq#Length| xs@@39))) (=> (< i_13 (|Seq#Length| xs@@39)) (=> (= (ControlFlow 0 15) 14) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 13)) (forall ((i_8 Int) (i_8_1 Int) ) (!  (=> (and (and (and (and (not (= i_8 i_8_1)) (and (<= 0 i_8) (< i_8 (|Seq#Length| xs@@39)))) (and (<= 0 i_8_1) (< i_8_1 (|Seq#Length| xs@@39)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@39 i_8) (|Seq#Index| xs@@39 i_8_1))))
 :qid |stdinbpl.992:15|
 :skolemid |78|
 ...
 :qid |stdinbpl.992:15|
 :skolemid |78|
)) (=> (forall ((i_8@@1 Int) ) (!  (=> (and (and (<= 0 i_8@@1) (< i_8@@1 (|Seq#Length| xs@@39))) (< NoPerm FullPerm)) (and (qpRange2 (|Seq#Index| xs@@39 i_8@@1)) (= (invRecv2 (|Seq#Index| xs@@39 i_8@@1)) i_8@@1)))
 :qid |stdinbpl.998:22|
 :skolemid |79|
 :pattern ( (|Seq#Index| xs@@39 i_8@@1))
 :pattern ( (|Seq#Index| xs@@39 i_8@@1))
)) (=> (and (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv2 o_3)) (< (invRecv2 o_3) (|Seq#Length| xs@@39))) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (|Seq#Index| xs@@39 (invRecv2 o_3)) o_3)))
 ...
 :pattern ( (|Seq#Index| xs@@39 i_8@@2))
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv2 o_3@@0)) (< (invRecv2 o_3@@0) (|Seq#Length| xs@@39))) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| xs@@39 (invRecv2 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv2 o_3@@0)) (< (invRecv2 o_3@@0) (|Seq#Length| xs@@39))) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
)))) (and (and (state Heap@@41 QPMask@0) (state Heap@@41 QPMask@0)) (and (> (|Seq#Length| xs@@39) 3) (state Heap@@41 QPMask@0)))) (and (=> (= (ControlFlow 0 9) (- 0 12)) (< 0 (|Seq#Length| xs@@39))) (=> (< 0 (|Seq#Length| xs@@39)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (HasDirectPerm QPMask@0 (|Seq#Index| xs@@39 0) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs@@39 0) f_7) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< 1 (|Seq#Length| xs@@39))) (=> (< 1 (|Seq#Length| xs@@39)) (=> (= (ControlFlow 0 9) (- 0 8)) (HasDirectPerm QPMask@0 (|Seq#Index| xs@@39 1) f_7))))))))))))))
(let ((anon9_Else_correct  (=> (and (forall ((i_6 Int) (j_3@@0 Int) ) (!  (=> (and (>= i_6 0) (and (< i_6 (|Seq#Length| xs@@39)) (and (>= j_3@@0 0) (and (< j_3@@0 (|Seq#Length| xs@@39)) (not (= i_6 j_3@@0)))))) (not (= (|Seq#Index| xs@@39 i_6) (|Seq#Index| xs@@39 j_3@@0))))
 :qid |stdinbpl.974:20|
 :skolemid |77|
 :pattern ( (|Seq#Index| xs@@39 i_6) (|Seq#Index| xs@@39 j_3@@0))
)) (state Heap@@41 ZeroMask)) (and (and (=> (= (ControlFlow 0 19) 9) anon11_Else_correct) (=> (= (ControlFlow 0 19) 15) anon12_Then_correct)) (=> (= (ControlFlow 0 19) 18) anon12_Else_correct)))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (and (>= i_10 0) (and (< i_10 (|Seq#Length| xs@@39)) (and (>= j_17 0) (and (< j_17 (|Seq#Length| xs@@39)) (not (= i_10 j_17))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (>= i_10 0) (and (< i_10 (|Seq#Length| xs@@39)) (and (>= j_17 0) (and (< j_17 (|Seq#Length| xs@@39)) (not (= i_10 j_17)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_10 0)) (=> (>= i_10 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_10 (|Seq#Length| xs@@39))) (=> (< i_10 (|Seq#Length| xs@@39)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_17 0)) (=> (>= j_17 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_17 (|Seq#Length| xs@@39))) (=> (< j_17 (|Seq#Length| xs@@39)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove 2)) (and (and (=> (= (ControlFlow 0 20) 19) anon9_Else_correct) (=> (= (ControlFlow 0 20) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 20) 7) anon10_Else_correct)))))
