...
(assert  (and (and (and (and (and (= (type l@@4) RefType) (= (type Heap@@27) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |someFun#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((i_4 Int) (i_4_1 Int) ) (!  (=> (and (and (not (= i_4 i_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= l@@4 l@@4)) (not (= i_4 i_4_1))))
 :qid |stdinbpl.794:17|
 :skolemid |76|
 :pattern ( (neverTriggered2 i_4) (neverTriggered2 i_4_1))
))) (=> (forall ((i_4@@0 Int) (i_4_1@@0 Int) ) (!  (=> (and (and (not (= i_4@@0 i_4_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= l@@4 l@@4)) (not (= i_4@@0 i_4_1@@0))))
 :qid |stdinbpl.794:17|
 :skolemid |76|
 :pattern ( (neverTriggered2 i_4@@0) (neverTriggered2 i_4_1@@0))
)) (=> (and (forall ((i_4@@1 Int) ) (!  (=> (< NoPerm FullPerm) (and (= (invRecv2 l@@4 i_4@@1) i_4@@1) (qpRange2 l@@4 i_4@@1)))
 :qid |stdinbpl.800:22|
 :skolemid |77|
 :pattern ( (MapType0Select Heap@@27 null (someList l@@4 i_4@@1)))
 :pattern ( (MapType1Select Mask@1 null (someList l@@4 i_4@@1)))
)) (forall ((this@@23 T@U) (i_5_1 Int) ) (!  (=> (= (type this@@23) RefType) (=> (and (< NoPerm FullPerm) (qpRange2 this@@23 i_5_1)) (and (= l@@4 this@@23) (= (invRecv2 this@@23 i_5_1) i_5_1))))
 :qid |stdinbpl.804:22|
 :skolemid |78|
 :pattern ( (invRecv2 this@@23 i_5_1))
))) (=> (and (and (and (forall ((this@@24 T@U) (i_5_1@@0 Int) ) (!  (=> (= (type this@@24) RefType) (=> (and (< NoPerm FullPerm) (qpRange2 this@@24 i_5_1@@0)) (and (=> (< NoPerm FullPerm) (and (= l@@4 this@@24) (= (invRecv2 this@@24 i_5_1@@0) i_5_1@@0))) (= (U_2_real (MapType1Select QPMask@0 null (someList this@@24 i_5_1@@0))) (+ (U_2_real (MapType1Select Mask@1 null (someList this@@24 i_5_1@@0))) FullPerm)))))
 :qid |stdinbpl.810:22|
 :skolemid |79|
 :pattern ( (MapType1Select QPMask@0 null (someList this@@24 i_5_1@@0)))
)) (forall ((o_3 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (or (or (not (= o_3 null)) (not (IsPredicateField f_5))) (not (= (getPredWandId f_5) 1)))) (= (U_2_real (MapType1Select Mask@1 o_3 f_5)) (U_2_real (MapType1Select QPMask@0 o_3 f_5))))))
 :qid |stdinbpl.816:29|
 :skolemid |80|
 :pattern ( (MapType1Select Mask@1 o_3 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3 f_5))
))) (and (forall ((this@@25 T@U) (i_5_1@@1 Int) ) (!  (=> (and (= (type this@@25) RefType) (not (and (< NoPerm FullPerm) (qpRange2 this@@25 i_5_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (someList this@@25 i_5_1@@1))) (U_2_real (MapType1Select Mask@1 null (someList this@@25 i_5_1@@1)))))
 :qid |stdinbpl.820:22|
 :skolemid |81|
 :pattern ( (MapType1Select QPMask@0 null (someList this@@25 i_5_1@@1)))
)) (state Heap@@27 QPMask@0))) (and (and (= Mask@2 (MapType1Store QPMask@0 null (otherList l@@4) (real_2_U (+ (U_2_real (MapType1Select QPMask@0 null (otherList l@@4))) FullPerm)))) (state Heap@@27 Mask@2)) (and (state Heap@@27 Mask@2) (= (ControlFlow 0 3) (- 0 2))))) (HasDirectPerm Mask@2 l@@4 elem)))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (and (and (state Heap@@27 ZeroMask) (U_2_bool (MapType0Select Heap@@27 l@@4 $allocated))) (and (= AssumeFunctionsAbove 2) (= Mask@0 (MapType1Store ZeroMask null (list l@@4) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (list l@@4))) FullPerm)))))) (and (and (state Heap@@27 Mask@0) (not (= l@@4 null))) (and (= Mask@1 (MapType1Store Mask@0 l@@4 elem (real_2_U (+ (U_2_real (MapType1Select Mask@0 l@@4 elem)) FullPerm)))) (state Heap@@27 Mask@1)))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct)))))
