...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type visited) (FieldType NormalFieldType boolType))) (= (type bad_field) (FieldType NormalFieldType boolType))))
...
(assert  (and (= (Ctor PredicateType_NodeType) 13) (forall ((arg0@@30 T@U) ) (! (= (type (Node arg0@@30)) (FieldType PredicateType_NodeType FrameTypeType))
 :qid |funType:Node|
 :pattern ( (Node arg0@@30))
))))
(assert (forall ((node T@U) ) (!  (=> (= (type node) RefType) (IsPredicateField (Node node)))
 :qid |stdinbpl.403:15|
 :skolemid |83|
 :pattern ( (Node node))
)))
(assert (forall ((Heap@@2 T@U) (node@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type node@@0) RefType)) (|Node#everUsed| (Node node@@0)))
 :qid |stdinbpl.422:15|
 :skolemid |87|
 :pattern ( (|Node#trigger| Heap@@2 (Node node@@0)))
)))
...
(assert (forall ((node@@1 T@U) (node2 T@U) ) (!  (=> (and (and (= (type node@@1) RefType) (= (type node2) RefType)) (= (Node node@@1) (Node node2))) (= node@@1 node2))
 :qid |stdinbpl.413:15|
 :skolemid |85|
 :pattern ( (Node node@@1) (Node node2))
)))
(assert (forall ((arg0@@39 T@U) ) (! (= (type (|Node#sm| arg0@@39)) (FieldType PredicateType_NodeType (MapType1Type RefType boolType)))
 :qid |funType:Node#sm|
 :pattern ( (|Node#sm| arg0@@39))
)))
(assert (forall ((node@@2 T@U) (node2@@0 T@U) ) (!  (=> (and (and (= (type node@@2) RefType) (= (type node2@@0) RefType)) (= (|Node#sm| node@@2) (|Node#sm| node2@@0))) (= node@@2 node2@@0))
 :qid |stdinbpl.417:15|
 :skolemid |86|
...
(assert  (not (IsPredicateField bad_field)))
(assert  (not (IsWandField bad_field)))
...
(assert (forall ((node@@3 T@U) ) (!  (=> (= (type node@@3) RefType) (= (getPredWandId (Node node@@3)) 0))
 :qid |stdinbpl.407:15|
 :skolemid |84|
 :pattern ( (Node node@@3))
)))
...
(assert (forall ((node@@4 T@U) ) (!  (=> (= (type node@@4) RefType) (= (PredicateMaskField (Node node@@4)) (|Node#sm| node@@4)))
 :qid |stdinbpl.399:15|
 :skolemid |82|
 :pattern ( (PredicateMaskField (Node node@@4)))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type all_nodes) (MapType2Type RefType boolType)) (= (type nn) RefType)) (= (type UnfoldingMask@3) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type UnfoldingMask@4) (MapType1Type RefType realType))) (= (type Heap@7) (MapType0Type RefType))) (= (type UnfoldingMask@5) (MapType1Type RefType realType))) (= (type Heap@8) (MapType0Type RefType))) (= (type Heap@9) (MapType0Type RefType))) (forall ((arg0@@45 T@U) (arg1@@23 T@U) ) (! (= (type (CombineFrames arg0@@45 arg1@@23)) FrameTypeType)
 :qid |funType:CombineFrames|
 :pattern ( (CombineFrames arg0@@45 arg1@@23))
))) (forall ((arg0@@46 T@U) ) (! (= (type (FrameFragment arg0@@46)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@46))
))) (= (type nn_1) RefType)) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (= (type Heap@6) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type curr_node) RefType)) (= (type Heap@3) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@47 T@U) ) (! (= (type (invRecv1 arg0@@47)) RefType)
 :qid |funType:invRecv1|
 :pattern ( (invRecv1 arg0@@47))
))))
...
(let ((anon22_correct  (=> (and (and (and (= UnfoldingMask@0 (MapType1Store Mask@5 null (Node nn_1) (real_2_U (- (U_2_real (MapType1Select Mask@5 null (Node nn_1))) FullPerm)))) (not (= nn_1 null))) (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 nn_1 visited (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 nn_1 visited)) FullPerm)))) (state Heap@7 UnfoldingMask@1))) (and (and (not (= nn_1 null)) (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 nn_1 bad_field (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 nn_1 bad_field)) FullPerm))))) (and (state Heap@7 UnfoldingMask@2) (state Heap@7 UnfoldingMask@2)))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (U_2_bool (MapType0Select Heap@7 nn_1 visited))) (=> (U_2_bool (MapType0Select Heap@7 nn_1 visited)) (=> (= (ControlFlow 0 13) 11) anon23_correct))))))
(let ((anon36_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 17) 13)) anon22_correct)))
(let ((anon36_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= FullPerm (U_2_real (MapType1Select Mask@5 null (Node nn_1))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@5 null (Node nn_1)))) (=> (= (ControlFlow 0 15) 13) anon22_correct))))))
(let ((anon35_Then_correct  (=> (U_2_bool (MapType2Select all_nodes nn_1)) (=> (and (|Node#trigger| Heap@7 (Node nn_1)) (= (MapType0Select Heap@7 null (Node nn_1)) (CombineFrames (FrameFragment (MapType0Select Heap@7 nn_1 visited)) (FrameFragment (MapType0Select Heap@7 nn_1 bad_field))))) (and (=> (= (ControlFlow 0 18) 15) anon36_Then_correct) (=> (= (ControlFlow 0 18) 17) anon36_Else_correct))))))
(let ((anon35_Else_correct  (=> (and (not (U_2_bool (MapType2Select all_nodes nn_1))) (= (ControlFlow 0 12) 11)) anon23_correct)))
(let ((anon17_correct true))
(let ((anon16_correct  (=> (and (and (and (= UnfoldingMask@3 (MapType1Store Mask@5 null (Node nn) (real_2_U (- (U_2_real (MapType1Select Mask@5 null (Node nn))) FullPerm)))) (not (= nn null))) (and (= UnfoldingMask@4 (MapType1Store UnfoldingMask@3 nn visited (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@3 nn visited)) FullPerm)))) (state Heap@7 UnfoldingMask@4))) (and (and (not (= nn null)) (= UnfoldingMask@5 (MapType1Store UnfoldingMask@4 nn bad_field (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@4 nn bad_field)) FullPerm))))) (and (state Heap@7 UnfoldingMask@5) (state Heap@7 UnfoldingMask@5)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm UnfoldingMask@5 nn visited)) (=> (HasDirectPerm UnfoldingMask@5 nn visited) (=> (and (and (= Heap@8 (MapType0Store Heap@7 null (|Node#sm| nn) (MapType1Store (MapType0Select Heap@7 null (|Node#sm| nn)) nn visited (bool_2_U true)))) (= Heap@9 (MapType0Store Heap@8 null (|Node#sm| nn) (MapType1Store (MapType0Select Heap@8 null (|Node#sm| nn)) nn bad_field (bool_2_U true))))) (and (state Heap@9 Mask@5) (= (ControlFlow 0 5) 3))) anon17_correct))))))
(let ((anon33_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 5)) anon16_correct)))
(let ((anon33_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select Mask@5 null (Node nn))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@5 null (Node nn)))) (=> (= (ControlFlow 0 7) 5) anon16_correct))))))
(let ((anon32_Then_correct  (=> (U_2_bool (MapType2Select all_nodes nn)) (=> (and (|Node#trigger| Heap@7 (Node nn)) (= (MapType0Select Heap@7 null (Node nn)) (CombineFrames (FrameFragment (MapType0Select Heap@7 nn visited)) (FrameFragment (MapType0Select Heap@7 nn bad_field))))) (and (=> (= (ControlFlow 0 10) 7) anon33_Then_correct) (=> (= (ControlFlow 0 10) 9) anon33_Else_correct))))))
(let ((anon32_Else_correct  (=> (and (not (U_2_bool (MapType2Select all_nodes nn))) (= (ControlFlow 0 4) 3)) anon17_correct)))
(let ((anon34_Else_correct true))
(let ((anon12_correct  (=> (and (and (= Heap@6 (MapType0Store Heap@5 null (|Node#sm| curr_node) (MapType1Store (MapType0Select Heap@5 null (|Node#sm| curr_node)) curr_node visited (bool_2_U true)))) (= Heap@7 (MapType0Store Heap@6 null (|Node#sm| curr_node) (MapType1Store (MapType0Select Heap@6 null (|Node#sm| curr_node)) curr_node bad_field (bool_2_U true))))) (and (state Heap@7 Mask@5) (state Heap@7 Mask@5))) (and (and (and (and (=> (= (ControlFlow 0 19) 2) anon34_Else_correct) (=> (= (ControlFlow 0 19) 18) anon35_Then_correct)) (=> (= (ControlFlow 0 19) 12) anon35_Else_correct)) (=> (= (ControlFlow 0 19) 10) anon32_Then_correct)) (=> (= (ControlFlow 0 19) 4) anon32_Else_correct)))))
(let ((anon30_Else_correct  (=> (HasDirectPerm Mask@5 null (Node curr_node)) (=> (and (= Heap@5 Heap@2) (= (ControlFlow 0 21) 19)) anon12_correct))))
(let ((anon30_Then_correct  (=> (not (HasDirectPerm Mask@5 null (Node curr_node))) (=> (and (and (= Heap@3 (MapType0Store Heap@2 null (|Node#sm| curr_node) ZeroPMask)) (= Heap@4 (MapType0Store Heap@3 null (Node curr_node) freshVersion@0))) (and (= Heap@5 Heap@4) (= (ControlFlow 0 20) 19))) anon12_correct))))
(let ((anon10_correct  (=> (and (= Mask@4 (MapType1Store Mask@3 curr_node bad_field (real_2_U (- (U_2_real (MapType1Select Mask@3 curr_node bad_field)) FullPerm)))) (= Mask@5 (MapType1Store Mask@4 null (Node curr_node) (real_2_U (+ (U_2_real (MapType1Select Mask@4 null (Node curr_node))) FullPerm))))) (=> (and (and (state Heap@2 Mask@5) (state Heap@2 Mask@5)) (and (|Node#trigger| Heap@2 (Node curr_node)) (= (MapType0Select Heap@2 null (Node curr_node)) (CombineFrames (FrameFragment (MapType0Select Heap@2 curr_node visited)) (FrameFragment (MapType0Select Heap@2 curr_node bad_field)))))) (and (=> (= (ControlFlow 0 22) 20) anon30_Then_correct) (=> (= (ControlFlow 0 22) 21) anon30_Else_correct))))))
(let ((anon29_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 25) 22)) anon10_correct)))
(let ((anon29_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (<= FullPerm (U_2_real (MapType1Select Mask@3 curr_node bad_field)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 curr_node bad_field))) (=> (= (ControlFlow 0 23) 22) anon10_correct))))))
(let ((anon8_correct  (=> (= Mask@3 (MapType1Store Mask@2 curr_node visited (real_2_U (- (U_2_real (MapType1Select Mask@2 curr_node visited)) FullPerm)))) (and (=> (= (ControlFlow 0 26) 23) anon29_Then_correct) (=> (= (ControlFlow 0 26) 25) anon29_Else_correct)))))
(let ((anon28_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 29) 26)) anon8_correct)))
(let ((anon28_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (<= FullPerm (U_2_real (MapType1Select Mask@2 curr_node visited)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 curr_node visited))) (=> (= (ControlFlow 0 27) 26) anon8_correct))))))
(let ((anon6_correct  (=> (and (and (and (not (= curr_node null)) (= Mask@1 (MapType1Store Mask@0 curr_node visited (real_2_U (+ (U_2_real (MapType1Select Mask@0 curr_node visited)) FullPerm))))) (and (state Heap@1 Mask@1) (not (= curr_node null)))) (and (and (= Mask@2 (MapType1Store Mask@1 curr_node bad_field (real_2_U (+ (U_2_real (MapType1Select Mask@1 curr_node bad_field)) FullPerm)))) (state Heap@1 Mask@2)) (and (state Heap@1 Mask@2) (state Heap@1 Mask@2)))) (and (=> (= (ControlFlow 0 30) (- 0 31)) (= FullPerm (U_2_real (MapType1Select Mask@2 curr_node visited)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@2 curr_node visited))) (=> (and (= Heap@2 (MapType0Store Heap@1 curr_node visited (bool_2_U true))) (state Heap@2 Mask@2)) (and (=> (= (ControlFlow 0 30) 27) anon28_Then_correct) (=> (= (ControlFlow 0 30) 29) anon28_Else_correct))))))))
(let ((anon27_Else_correct  (=> (HasDirectPerm Mask@0 null (Node curr_node)) (=> (and (= Heap@1 Heap@@10) (= (ControlFlow 0 33) 30)) anon6_correct))))
(let ((anon27_Then_correct  (=> (and (and (not (HasDirectPerm Mask@0 null (Node curr_node))) (= Heap@0 (MapType0Store Heap@@10 null (Node curr_node) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 32) 30))) anon6_correct)))
(let ((anon4_correct  (=> (= Mask@0 (MapType1Store QPMask@0 null (Node curr_node) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (Node curr_node))) FullPerm)))) (and (=> (= (ControlFlow 0 34) 32) anon27_Then_correct) (=> (= (ControlFlow 0 34) 33) anon27_Else_correct)))))
(let ((anon26_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 37) 34)) anon4_correct)))
(let ((anon26_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 35) (- 0 36)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (Node curr_node))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (Node curr_node)))) (=> (= (ControlFlow 0 35) 34) anon4_correct))))))
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 38) (- 0 39)) (forall ((n_1 T@U) (n_1_1 T@U) ) (!  (=> (and (= (type n_1) RefType) (= (type n_1_1) RefType)) (=> (and (and (and (and (not (= n_1 n_1_1)) (U_2_bool (MapType2Select all_nodes n_1))) (U_2_bool (MapType2Select all_nodes n_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1))))
 :qid |stdinbpl.488:17|
 :skolemid |88|
 :pattern ( (neverTriggered1 n_1) (neverTriggered1 n_1_1))
))) (=> (forall ((n_1@@0 T@U) (n_1_1@@0 T@U) ) (!  (=> (and (= (type n_1@@0) RefType) (= (type n_1_1@@0) RefType)) (=> (and (and (and (and (not (= n_1@@0 n_1_1@@0)) (U_2_bool (MapType2Select all_nodes n_1@@0))) (U_2_bool (MapType2Select all_nodes n_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1@@0 n_1_1@@0))))
 :qid |stdinbpl.488:17|
 :skolemid |88|
 :pattern ( (neverTriggered1 n_1@@0) (neverTriggered1 n_1_1@@0))
)) (=> (forall ((n_1@@1 T@U) ) (!  (=> (= (type n_1@@1) RefType) (=> (and (U_2_bool (MapType2Select all_nodes n_1@@1)) (< NoPerm FullPerm)) (and (= (invRecv1 n_1@@1) n_1@@1) (qpRange1 n_1@@1))))
 :qid |stdinbpl.494:22|
 :skolemid |89|
 :pattern ( (MapType0Select Heap@@10 null (Node n_1@@1)))
 :pattern ( (MapType1Select ZeroMask null (Node n_1@@1)))
 :pattern ( (MapType2Select all_nodes n_1@@1))
)) (=> (and (forall ((node@@5 T@U) ) (!  (=> (= (type node@@5) RefType) (=> (and (and (U_2_bool (MapType2Select all_nodes (invRecv1 node@@5))) (< NoPerm FullPerm)) (qpRange1 node@@5)) (= (invRecv1 node@@5) node@@5)))
 :qid |stdinbpl.498:22|
 :skolemid |90|
 :pattern ( (invRecv1 node@@5))
)) (forall ((node@@6 T@U) ) (!  (=> (= (type node@@6) RefType) (=> (and (and (U_2_bool (MapType2Select all_nodes (invRecv1 node@@6))) (< NoPerm FullPerm)) (qpRange1 node@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv1 node@@6) node@@6)) (= (U_2_real (MapType1Select QPMask@0 null (Node node@@6))) (+ (U_2_real (MapType1Select ZeroMask null (Node node@@6))) FullPerm)))))
 :qid |stdinbpl.504:22|
 :skolemid |91|
 :pattern ( (MapType1Select QPMask@0 null (Node node@@6)))
))) (=> (and (and (and (forall ((o_3 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
...
)) (forall ((node@@7 T@U) ) (!  (=> (and (= (type node@@7) RefType) (not (and (and (U_2_bool (MapType2Select all_nodes (invRecv1 node@@7))) (< NoPerm FullPerm)) (qpRange1 node@@7)))) (= (U_2_real (MapType1Select QPMask@0 null (Node node@@7))) (U_2_real (MapType1Select ZeroMask null (Node node@@7)))))
 :qid |stdinbpl.514:22|
 :skolemid |93|
 :pattern ( (MapType1Select QPMask@0 null (Node node@@7)))
))) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0))) (and (and (U_2_bool (MapType2Select all_nodes curr_node)) (state Heap@@10 QPMask@0)) (and (|Node#trigger| Heap@@10 (Node curr_node)) (= (MapType0Select Heap@@10 null (Node curr_node)) (CombineFrames (FrameFragment (MapType0Select Heap@@10 curr_node visited)) (FrameFragment (MapType0Select Heap@@10 curr_node bad_field))))))) (and (=> (= (ControlFlow 0 38) 35) anon26_Then_correct) (=> (= (ControlFlow 0 38) 37) anon26_Else_correct)))))))))
(let ((anon25_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 curr_node $allocated))) (and (=> (= (ControlFlow 0 40) 1) anon25_Then_correct) (=> (= (ControlFlow 0 40) 38) anon25_Else_correct)))))
