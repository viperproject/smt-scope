...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@121 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@121 this@@111 $allocated)) (= AssumeFunctionsAbove 26)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (not (= this@@111 null))) (=> (not (= this@@111 null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm ZeroMask this@@111 x@@8)) (=> (HasDirectPerm ZeroMask this@@111 x@@8) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (MapType0Select Heap@@121 this@@111 x@@8)) 0))))))))))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 6)) (not (= this@@111 null))) (=> (not (= this@@111 null)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm ZeroMask this@@111 x@@8)) (=> (HasDirectPerm ZeroMask this@@111 x@@8) (=> (= (ControlFlow 0 4) (- 0 3)) (= (U_2_int (MapType0Select Heap@@121 this@@111 x@@8)) 0))))))))
(let ((anon3_Then_correct  (=> (and (not (= this@@111 null)) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm ZeroMask this@@111 x@@8))))
(let ((anon0_correct  (=> (state Heap@@121 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@121 this@@111 $allocated)) (= AssumeFunctionsAbove 7)) (and (=> (= (ControlFlow 0 7) 2) anon3_Then_correct) (=> (= (ControlFlow 0 7) 4) anon3_Else_correct))))))
...
(declare-fun Heap@@121 () T@U)
(assert  (and (and (= (type this@@111) RefType) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@121) (MapType0Type RefType))))
(set-info :boogie-vc-id |t6Abstract#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Else_correct true))
(let ((anon6_Then_correct  (=> (and (not (= this@@111 null)) (= (ControlFlow 0 3) (- 0 2))) (HasDirectPerm Mask@0 this@@111 x@@8))))
(let ((anon5_Else_correct  (=> (and (and (not (= this@@111 null)) (= Mask@0 (MapType1Store ZeroMask this@@111 x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@111 x@@8)) FullPerm))))) (and (state Heap@@121 Mask@0) (state Heap@@121 Mask@0))) (and (=> (= (ControlFlow 0 5) 3) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@121 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@121 this@@111 $allocated)) (= AssumeFunctionsAbove 19)) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct))))))
