...
(declare-fun |idx00'| (T@U Int Int Int Int) Int)
(declare-fun AssumeFunctionsAbove () Int)
(declare-fun |idx00#trigger| (T@U Int Int Int Int) Bool)
...
(declare-fun idx00 (T@U Int Int Int Int) Int)
(declare-fun |idx00#frame| (T@U Int Int Int Int) Int)
...
(assert (forall ((Heap@@4 T@U) (Mask@@4 T@U) (a_2 Int) (b_2 Int) (c Int) (n@@5 Int) ) (!  (=> (and (and (= (type Heap@@4) (MapType0Type RefType)) (= (type Mask@@4) (MapType1Type RefType realType))) (and (state Heap@@4 Mask@@4) (or (< AssumeFunctionsAbove 0) (|idx00#trigger| EmptyFrame a_2 b_2 c n@@5)))) (and (<= 0 (|idx00'| Heap@@4 a_2 b_2 c n@@5)) (< (|idx00'| Heap@@4 a_2 b_2 c n@@5) n@@5)))
 :qid |stdinbpl.572:15|
 :skolemid |61|
 :pattern ( (state Heap@@4 Mask@@4) (|idx00'| Heap@@4 a_2 b_2 c n@@5))
)))
...
(assert (forall ((Heap@@6 T@U) (a_2@@0 Int) (b_2@@0 Int) (c@@0 Int) (n@@7 Int) ) (!  (=> (= (type Heap@@6) (MapType0Type RefType)) (dummyFunction (int_2_U (|idx00#triggerStateless| a_2@@0 b_2@@0 c@@0 n@@7))))
 :qid |stdinbpl.559:15|
 :skolemid |59|
 :pattern ( (|idx00'| Heap@@6 a_2@@0 b_2@@0 c@@0 n@@7))
)))
...
(assert (forall ((Heap@@7 T@U) (a_2@@1 Int) (b_2@@1 Int) (c@@1 Int) (n@@9 Int) ) (!  (=> (= (type Heap@@7) (MapType0Type RefType)) (and (= (idx00 Heap@@7 a_2@@1 b_2@@1 c@@1 n@@9) (|idx00'| Heap@@7 a_2@@1 b_2@@1 c@@1 n@@9)) (dummyFunction (int_2_U (|idx00#triggerStateless| a_2@@1 b_2@@1 c@@1 n@@9)))))
 :qid |stdinbpl.555:15|
 :skolemid |58|
 :pattern ( (idx00 Heap@@7 a_2@@1 b_2@@1 c@@1 n@@9))
)))
...
(assert (forall ((Heap@@8 T@U) (Mask@@7 T@U) (a_2@@2 Int) (b_2@@2 Int) (c@@2 Int) (n@@10 Int) ) (!  (=> (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (state Heap@@8 Mask@@7)) (= (|idx00'| Heap@@8 a_2@@2 b_2@@2 c@@2 n@@10) (|idx00#frame| EmptyFrame a_2@@2 b_2@@2 c@@2 n@@10)))
 :qid |stdinbpl.566:15|
 :skolemid |60|
 :pattern ( (state Heap@@8 Mask@@7) (|idx00'| Heap@@8 a_2@@2 b_2@@2 c@@2 n@@10))
)))
...
(declare-fun i@@6 () Int)
(declare-fun j@@5 () Int)
(assert  (and (= (type Heap@@13) (MapType0Type RefType)) (= (type xs) (SeqType intType))))
(set-info :boogie-vc-id test00)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 12)) (>= (idx00 Heap@@13 5 2 3 n@@17) 0)) (=> (>= (idx00 Heap@@13 5 2 3 n@@17) 0) (and (=> (= (ControlFlow 0 10) (- 0 11)) (< (idx00 Heap@@13 5 2 3 n@@17) (|Seq#Length| xs))) (=> (< (idx00 Heap@@13 5 2 3 n@@17) (|Seq#Length| xs)) (=> (= (ControlFlow 0 10) (- 0 9)) (= (U_2_int (|Seq#Index| xs (idx00 Heap@@13 5 2 3 n@@17))) 7))))))))
(let ((anon12_Then_correct true))
(let ((anon9_Else_correct  (=> (forall ((i_1 Int) (j_1 Int) (fresh__1_1 Int) ) (!  (=> (and (<= 0 i_1) (and (< i_1 n@@17) (and (<= 0 j_1) (< j_1 i_1)))) (= (U_2_int (|Seq#Index| xs (idx00 Heap@@13 i_1 j_1 (+ j_1 1) n@@17))) (+ i_1 j_1)))
 :qid |stdinbpl.654:20|
 :skolemid |62|
 :pattern ( (|Seq#Index| xs (|idx00#frame| EmptyFrame i_1 j_1 fresh__1_1 n@@17)))
)) (=> (and (state Heap@@13 ZeroMask) (state Heap@@13 ZeroMask)) (and (=> (= (ControlFlow 0 13) 8) anon12_Then_correct) (=> (= (ControlFlow 0 13) 10) anon12_Else_correct))))))
(let ((anon11_Then_correct true))
(let ((anon5_correct true))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 6)) (>= (idx00 Heap@@13 i@@6 j@@5 (+ j@@5 1) n@@17) 0)) (=> (>= (idx00 Heap@@13 i@@6 j@@5 (+ j@@5 1) n@@17) 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< (idx00 Heap@@13 i@@6 j@@5 (+ j@@5 1) n@@17) (|Seq#Length| xs))) (=> (< (idx00 Heap@@13 i@@6 j@@5 (+ j@@5 1) n@@17) (|Seq#Length| xs)) (=> (= (ControlFlow 0 4) 1) anon5_correct)))))))
(let ((anon10_Then_correct  (=> (and (<= 0 i@@6) (and (< i@@6 n@@17) (and (<= 0 j@@5) (< j@@5 i@@6)))) (and (=> (= (ControlFlow 0 7) 3) anon11_Then_correct) (=> (= (ControlFlow 0 7) 4) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (not (and (<= 0 i@@6) (and (< i@@6 n@@17) (and (<= 0 j@@5) (< j@@5 i@@6))))) (= (ControlFlow 0 2) 1)) anon5_correct)))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (< 10 n@@17)) (and (state Heap@@13 ZeroMask) (state Heap@@13 ZeroMask))) (and (and (<= n@@17 (|Seq#Length| xs)) (state Heap@@13 ZeroMask)) (and (state Heap@@13 ZeroMask) (state Heap@@13 ZeroMask)))) (and (and (=> (= (ControlFlow 0 14) 13) anon9_Else_correct) (=> (= (ControlFlow 0 14) 7) anon10_Then_correct)) (=> (= (ControlFlow 0 14) 2) anon10_Else_correct))))))
