...
(declare-fun y@@10 () T@U)
(declare-fun Heap@@18 () T@U)
(declare-fun Heap@0 () T@U)
(declare-fun newVersion@0 () T@U)
(declare-fun Mask@0 () T@U)
(declare-fun Mask@2 () T@U)
(assert  (and (and (and (and (and (and (and (and (and (and (= (type Mask@2) (MapType2Type RefType realType)) (= (type Mask@0) (MapType2Type RefType realType))) (= (type xs@@3) (MapType0Type RefType boolType))) (= (type y@@10) RefType)) (= (type Heap@1) (MapType1Type RefType))) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv8 arg0@@48)) RefType)
 :qid |funType:invRecv8|
 :pattern ( (invRecv8 arg0@@48))
))) (= (type Mask@1) (MapType2Type RefType realType))) (= (type Heap@0) (MapType1Type RefType))) (= (type Heap@@18) (MapType1Type RefType))) (= (type newVersion@0) FrameTypeType)))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon8_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((x@@19 T@U) (x_1 T@U) ) (!  (=> (and (= (type x@@19) RefType) (= (type x_1) RefType)) (=> (and (and (and (and (not (= x@@19 x_1)) (U_2_bool (MapType0Select xs@@3 x@@19))) (U_2_bool (MapType0Select xs@@3 x_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@19 x_1))))
...
))) (=> (forall ((x@@20 T@U) (x_1@@0 T@U) ) (!  (=> (and (= (type x@@20) RefType) (= (type x_1@@0) RefType)) (=> (and (and (and (and (not (= x@@20 x_1@@0)) (U_2_bool (MapType0Select xs@@3 x@@20))) (U_2_bool (MapType0Select xs@@3 x_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@20 x_1@@0))))
 :qid |stdinbpl.1237:15|
 :skolemid |145|
...
)) (=> (and (and (and (forall ((x@@21 T@U) ) (!  (=> (= (type x@@21) RefType) (=> (and (U_2_bool (MapType0Select xs@@3 x@@21)) (< NoPerm FullPerm)) (and (qpRange8 x@@21) (= (invRecv8 x@@21) x@@21))))
 :qid |stdinbpl.1243:22|
 :skolemid |146|
 :pattern ( (MapType1Select Heap@1 x@@21 fld))
 :pattern ( (MapType2Select QPMask@0 x@@21 fld))
 :pattern ( (MapType0Select xs@@3 x@@21))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType0Select xs@@3 (invRecv8 o_3))) (< NoPerm FullPerm)) (qpRange8 o_3)) (= (invRecv8 o_3) o_3)))
 :qid |stdinbpl.1247:22|
 :skolemid |147|
 :pattern ( (invRecv8 o_3))
))) (and (forall ((x@@22 T@U) ) (!  (=> (and (= (type x@@22) RefType) (U_2_bool (MapType0Select xs@@3 x@@22))) (not (= x@@22 null)))
 :qid |stdinbpl.1253:22|
 :skolemid |148|
 :pattern ( (MapType1Select Heap@1 x@@22 fld))
 :pattern ( (MapType2Select QPMask@0 x@@22 fld))
 :pattern ( (MapType0Select xs@@3 x@@22))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType0Select xs@@3 (invRecv8 o_3@@0))) (< NoPerm FullPerm)) (qpRange8 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv8 o_3@@0) o_3@@0)) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 fld)) (+ (U_2_real (MapType2Select Mask@1 o_3@@0 fld)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select xs@@3 (invRecv8 o_3@@0))) (< NoPerm FullPerm)) (qpRange8 o_3@@0))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 fld)) (U_2_real (MapType2Select Mask@1 o_3@@0 fld))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 fld))) (= (U_2_real (MapType2Select Mask@1 o_3@@1 f_5)) (U_2_real (MapType2Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.1263:29|
 :skolemid |150|
 :pattern ( (MapType2Select Mask@1 o_3@@1 f_5))
 :pattern ( (MapType2Select QPMask@0 o_3@@1 f_5))
)) (state Heap@1 QPMask@0)) (and (state Heap@1 QPMask@0) (state Heap@1 QPMask@0)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm QPMask@0 y@@10 fld)) (=> (HasDirectPerm QPMask@0 y@@10 fld) (=> (= (ControlFlow 0 7) (- 0 6)) (= (U_2_int (MapType1Select Heap@1 y@@10 fld)) 5)))))))))
(let ((anon12_Else_correct  (=> (HasDirectPerm Mask@1 null (inv xs@@3)) (=> (and (= Heap@1 Heap@@18) (= (ControlFlow 0 11) 7)) anon8_correct))))
(let ((anon12_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (inv xs@@3))) (= Heap@0 (MapType1Store Heap@@18 null (inv xs@@3) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 10) 7))) anon8_correct)))
(let ((anon6_correct  (=> (= Mask@1 (MapType2Store Mask@0 null (inv xs@@3) (real_2_U (- (U_2_real (MapType2Select Mask@0 null (inv xs@@3))) FullPerm)))) (and (=> (= (ControlFlow 0 12) 10) anon12_Then_correct) (=> (= (ControlFlow 0 12) 11) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 15) 12)) anon6_correct)))
(let ((anon11_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= FullPerm (U_2_real (MapType2Select Mask@0 null (inv xs@@3))))) (=> (<= FullPerm (U_2_real (MapType2Select Mask@0 null (inv xs@@3)))) (=> (= (ControlFlow 0 13) 12) anon6_correct))))))
(let ((anon9_Else_correct  (=> (and (and (= (getField01 Heap@@18 xs@@3 y@@10) 5) (state Heap@@18 Mask@0)) (and (|inv#trigger| Heap@@18 (inv xs@@3)) (= (MapType1Select Heap@@18 null (inv xs@@3)) (FrameFragment (int_2_U (|inv#condqp1| Heap@@18 xs@@3)))))) (and (=> (= (ControlFlow 0 16) 13) anon11_Then_correct) (=> (= (ControlFlow 0 16) 15) anon11_Else_correct)))))
(let ((anon3_correct  (=> (and (= Mask@2 (MapType2Store Mask@0 null (inv xs@@3) (real_2_U (- (U_2_real (MapType2Select Mask@0 null (inv xs@@3))) FullPerm)))) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (MapType0Select xs@@3 y@@10)))))
(let ((anon10_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon3_correct)))
(let ((anon10_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType2Select Mask@0 null (inv xs@@3))))) (=> (<= FullPerm (U_2_real (MapType2Select Mask@0 null (inv xs@@3)))) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@18 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType1Select Heap@@18 y@@10 $allocated)) (= Mask@0 (MapType2Store ZeroMask null (inv xs@@3) (real_2_U (+ (U_2_real (MapType2Select ZeroMask null (inv xs@@3))) FullPerm)))))) (and (and (state Heap@@18 Mask@0) (U_2_bool (MapType0Select xs@@3 y@@10))) (and (state Heap@@18 Mask@0) (state Heap@@18 Mask@0)))) (and (and (=> (= (ControlFlow 0 17) 16) anon9_Else_correct) (=> (= (ControlFlow 0 17) 3) anon10_Then_correct)) (=> (= (ControlFlow 0 17) 5) anon10_Else_correct)))))
