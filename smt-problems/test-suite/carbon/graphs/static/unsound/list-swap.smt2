...
(assert  (and (and (and (and (and (and (= (type refs@@6) (MapType2Type RefType boolType)) (= (type p_3) RefType)) (= (type s_3) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Result) (MapType2Type EdgeDomainTypeType boolType))) (= (type Heap@@23) (MapType0Type RefType))) (forall ((arg0@@58 T@U) ) (! (= (type (invRecv1 arg0@@58)) RefType)
...
)) (state Heap@@23 QPMask@0)) (and (=> (= (ControlFlow 0 11) 9) anon17_Then_correct) (=> (= (ControlFlow 0 11) 10) anon17_Else_correct)))))
(let ((anon16_Then_correct true))
(let ((anon13_Else_correct  (=> (and (forall ((p_4 T@U) (s_4 T@U) ) (!  (=> (and (= (type p_4) RefType) (= (type s_4) RefType)) (=  (and (U_2_bool (MapType2Select refs@@6 p_4)) (and (U_2_bool (MapType2Select refs@@6 s_4)) (= (MapType0Select Heap@@23 p_4 next) s_4))) (U_2_bool (MapType2Select Result (create_edge p_4 s_4)))))
 :qid |stdinbpl.899:20|
 :skolemid |118|
 :pattern ( (create_edge p_4 s_4))
)) (state Heap@@23 QPMask@0)) (and (=> (= (ControlFlow 0 12) 8) anon16_Then_correct) (=> (= (ControlFlow 0 12) 11) anon16_Else_correct)))))
...
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 15)) (forall ((n_3 T@U) (n_3_1 T@U) ) (!  (=> (and (= (type n_3) RefType) (= (type n_3_1) RefType)) (=> (and (and (and (and (not (= n_3 n_3_1)) (U_2_bool (MapType2Select refs@@6 n_3))) (U_2_bool (MapType2Select refs@@6 n_3_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_3 n_3_1))))
 ...
 :qid |stdinbpl.853:22|
 :skolemid |112|
 :pattern ( (MapType0Select Heap@@23 n_3@@1 next))
 ...
 :qid |stdinbpl.863:15|
 :skolemid |114|
 :pattern ( (MapType0Select Heap@@23 n_3@@2 next))
 ...
 :qid |stdinbpl.869:22|
 :skolemid |115|
 :pattern ( (MapType0Select Heap@@23 n_3@@4 next))
...
))) (and (state Heap@@23 QPMask@0) (state Heap@@23 QPMask@0))) (and (and (=> (= (ControlFlow 0 13) 12) anon13_Else_correct) (=> (= (ControlFlow 0 13) 7) anon14_Then_correct)) (=> (= (ControlFlow 0 13) 3) anon14_Else_correct)))))))))))
(let ((anon12_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@23 ZeroMask) (= AssumeFunctionsAbove 1)) (and (=> (= (ControlFlow 0 16) 1) anon12_Then_correct) (=> (= (ControlFlow 0 16) 13) anon12_Else_correct)))))
