...
(assert  (and (and (and (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type ys) (SeqType RefType))) (= (type xs) (SeqType RefType))) (= (type z@@0) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type y@@2) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@35 T@U) ) (! (= (type (invRecv1 arg0@@35)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon6_Else_correct  (=> (and (forall ((x_3 T@U) ) (!  (=> (and (= (type x_3) RefType) (|Seq#Contains| xs x_3)) (not (= x_3 z@@0)))
 :qid |stdinbpl.657:20|
 :skolemid |64|
 :pattern ( (MapType0Select Heap@@9 (|Seq#Index| ys (U_2_int (MapType0Select Heap@@9 x_3 f_7))) f_7))
)) (state Heap@@9 Mask@0)) (=> (and (and (state Heap@@9 Mask@0) (|Seq#Contains| xs y@@2)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 4) (- 0 9)) (HasDirectPerm Mask@0 y@@2 f_7)) (=> (HasDirectPerm Mask@0 y@@2 f_7) (=> (= (U_2_int (MapType0Select Heap@@9 y@@2 f_7)) 0) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 4) (- 0 8)) (HasDirectPerm Mask@0 y@@2 f_7)) (=> (HasDirectPerm Mask@0 y@@2 f_7) (and (=> (= (ControlFlow 0 4) (- 0 7)) (>= (U_2_int (MapType0Select Heap@@9 y@@2 f_7)) 0)) (=> (>= (U_2_int (MapType0Select Heap@@9 y@@2 f_7)) 0) (and (=> (= (ControlFlow 0 4) (- 0 6)) (< (U_2_int (MapType0Select Heap@@9 y@@2 f_7)) (|Seq#Length| ys))) (=> (< (U_2_int (MapType0Select Heap@@9 y@@2 f_7)) (|Seq#Length| ys)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@0 (|Seq#Index| ys (U_2_int (MapType0Select Heap@@9 y@@2 f_7))) f_7)) (=> (HasDirectPerm Mask@0 (|Seq#Index| ys (U_2_int (MapType0Select Heap@@9 y@@2 f_7))) f_7) (=> (and (and (not (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| ys (U_2_int (MapType0Select Heap@@9 y@@2 f_7))) f_7)) 0)) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (= (ControlFlow 0 4) (- 0 3)))) (not (= y@@2 z@@0)))))))))))))))))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 12)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| xs x_1)) (|Seq#Contains| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.599:15|
 :skolemid |58|
 :no-pattern (type x_1)
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (and (state Heap@@9 QPMask@0) (>= (|Seq#Length| ys) 1)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (< 0 (|Seq#Length| ys))) (=> (< 0 (|Seq#Length| ys)) (=> (not (= (|Seq#Index| ys 0) null)) (=> (and (and (= Mask@0 (MapType1Store QPMask@0 (|Seq#Index| ys 0) f_7 (real_2_U (+ (U_2_real (MapType1Select QPMask@0 (|Seq#Index| ys 0) f_7)) FullPerm)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 10) 2) anon6_Then_correct) (=> (= (ControlFlow 0 10) 4) anon6_Else_correct)))))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 z@@0 $allocated)) (U_2_bool (MapType0Select Heap@@9 y@@2 $allocated))) (and (=> (= (ControlFlow 0 13) 1) anon5_Then_correct) (=> (= (ControlFlow 0 13) 10) anon5_Else_correct))))))
