...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Else_correct  (=> (not (= 5 7)) (=> (and (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 5) (- 0 4)))) (= (+ (+ (+ 4 3) 2) 7) (- (- (- (- 100 7) (* 20 3)) (* 7 2)) (div (- 7 1) 2)))))))
(let ((anon6_Then_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (state Heap@@9 ZeroMask) (= 5 7)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 3) (- 0 2)))) (not (= 7 0))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (=> (and (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))))
