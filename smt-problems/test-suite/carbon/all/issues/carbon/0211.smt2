...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 8)) (> x@@8 3)) (=> (> x@@8 3) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 7)) (> x@@8 4)) (=> (> x@@8 4) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 6)) (> x@@8 5)) (=> (> x@@8 5) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 5)) (> x@@8 6)) (=> (> x@@8 6) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (> x@@8 7)) (=> (> x@@8 7) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> x@@8 8)) (=> (> x@@8 8) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (> x@@8 9))))))))))))))))))))))
