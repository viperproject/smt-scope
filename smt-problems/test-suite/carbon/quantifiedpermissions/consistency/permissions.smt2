...
(assert  (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type x@@11) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@11 $allocated))) (and (<= NoPerm p_1) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= p_1 NoPerm)) (=> (>= p_1 NoPerm) (=> (and (and (=> (> p_1 NoPerm) (not (= x@@11 null))) (= Mask@0 (MapType1Store ZeroMask x@@11 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@11 f_7)) p_1))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (= x@@11 null))) (=> (not (= x@@11 null)) (=> (and (state Heap@@9 Mask@0) (= (ControlFlow 0 2) (- 0 1))) (not (= p_1 NoPerm)))))))))))
