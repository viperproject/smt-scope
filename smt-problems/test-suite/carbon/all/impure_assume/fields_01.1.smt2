...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@9 y@@1 $allocated)) (not (= x@@8 null))) (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm)))) (state Heap@@9 Mask@0))) (=> (and (and (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (<= (/ (to_real 1) (to_real 2)) (U_2_real (MapType1Select Mask@0 x@@8 f_7))) (state Heap@@9 Mask@0))) (and (and (state Heap@@9 Mask@0) (<= (__iar__assume_helper_1 (= x@@8 y@@1) (/ (to_real 1) (to_real 2)) (/ (to_real 1) (to_real 2))) (U_2_real (MapType1Select Mask@0 y@@1 f_7)))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= x@@8 y@@1)) (=> (= x@@8 y@@1) (=> (and (state Heap@@9 Mask@0) (= (ControlFlow 0 2) (- 0 1))) false))))))))
