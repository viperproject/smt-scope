...
(assert  (and (and (and (and (and (= (type x@@11) RefType) (= (type y@@2) RefType)) (= (type Heap@@13) (MapType0Type RefType))) (= (type xs@@3) (SeqType RefType))) (= (type ys@@3) (SeqType RefType))) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon6_Else_correct true))
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (or (= (|Seq#Length| xs@@3) (|Seq#Length| ys@@3)) (= (|Seq#Length| xs@@3) (+ (|Seq#Length| ys@@3) 1))))))
...
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (|Seq#Equal| (|Seq#Append| (|Seq#Singleton| x@@11) (|Seq#Singleton| y@@2)) (zip Heap@@13 xs@@3 ys@@3)))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@13 x@@11 $allocated)) (U_2_bool (MapType0Select Heap@@13 y@@2 $allocated)))) (and (and (|Seq#Equal| xs@@3 (|Seq#Singleton| x@@11)) (state Heap@@13 ZeroMask)) (and (|Seq#Equal| ys@@3 (|Seq#Singleton| y@@2)) (state Heap@@13 ZeroMask)))) (and (=> (= (ControlFlow 0 7) 6) anon5_Then_correct) (=> (= (ControlFlow 0 7) 2) anon5_Else_correct)))))
