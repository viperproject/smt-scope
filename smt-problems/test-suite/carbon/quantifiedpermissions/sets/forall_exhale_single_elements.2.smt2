...
(assert  (and (and (and (and (and (and (and (and (= (type QPMask@1) (MapType1Type RefType realType)) (= (type x@@19) RefType)) (= (type xs) (MapType2Type RefType boolType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv2 arg0@@43)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@43))
))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type AssertMask@0) (MapType1Type RefType realType))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv1 arg0@@44)) RefType)
...
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select QPMask@1 x@@19 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@1 x@@19 f_7))) (=> (= (ControlFlow 0 4) 3) anon8_correct))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (U_2_bool (MapType2Select xs z_1))) (U_2_bool (MapType2Select xs z_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1))))
 :qid |stdinbpl.506:17|
 :skolemid |88|
...
)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((z_1@@1 T@U) ) (!  (=> (and (= (type z_1@@1) RefType) (U_2_bool (MapType2Select xs z_1@@1))) (>= (U_2_real (MapType1Select QPMask@0 z_1@@1 f_7)) FullPerm))
 :qid |stdinbpl.513:17|
 :skolemid |89|
 :pattern ( (MapType0Select Heap@@9 z_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 z_1@@1 f_7))
 :pattern ( (MapType2Select xs z_1@@1))
))) (=> (forall ((z_1@@2 T@U) ) (!  (=> (and (= (type z_1@@2) RefType) (U_2_bool (MapType2Select xs z_1@@2))) (>= (U_2_real (MapType1Select QPMask@0 z_1@@2 f_7)) FullPerm))
 :qid |stdinbpl.513:17|
 :skolemid |89|
 :pattern ( (MapType0Select Heap@@9 z_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@1 z_1@@2 f_7))
 :pattern ( (MapType2Select xs z_1@@2))
)) (=> (and (forall ((z_1@@3 T@U) ) (!  (=> (= (type z_1@@3) RefType) (=> (and (U_2_bool (MapType2Select xs z_1@@3)) (< NoPerm FullPerm)) (and (qpRange2 z_1@@3) (= (invRecv2 z_1@@3) z_1@@3))))
 :qid |stdinbpl.519:22|
 :skolemid |90|
 :pattern ( (MapType0Select Heap@@9 z_1@@3 f_7))
 :pattern ( (MapType1Select QPMask@1 z_1@@3 f_7))
 :pattern ( (MapType2Select xs z_1@@3))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType2Select xs (invRecv2 o_3))) (and (< NoPerm FullPerm) (qpRange2 o_3))) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.523:22|
 :skolemid |91|
 :pattern ( (invRecv2 o_3))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType2Select xs (invRecv2 o_3@@0))) (and (< NoPerm FullPerm) (qpRange2 o_3@@0))) (and (= (invRecv2 o_3@@0) o_3@@0) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (- (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select xs (invRecv2 o_3@@0))) (and (< NoPerm FullPerm) (qpRange2 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7))))))
 :qid |stdinbpl.529:22|
 :skolemid |92|
...
))) (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 QPMask@1) (state ExhaleHeap@0 QPMask@1))) (and (=> (= (ControlFlow 0 7) 4) anon12_Then_correct) (=> (= (ControlFlow 0 7) 6) anon12_Else_correct))))))))))
(let ((anon11_Then_correct true))
(let ((anon4_correct  (=> (and (= AssertMask@0 (MapType1Store QPMask@0 x@@19 f_7 (real_2_U (- (U_2_real (MapType1Select QPMask@0 x@@19 f_7)) FullPerm)))) (state Heap@@9 QPMask@0)) (and (=> (= (ControlFlow 0 10) 2) anon11_Then_correct) (=> (= (ControlFlow 0 10) 7) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 10)) anon4_correct)))
(let ((anon10_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 x@@19 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 x@@19 f_7))) (=> (= (ControlFlow 0 11) 10) anon4_correct))))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((y_1 T@U) (y_1_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (= (type y_1_1) RefType)) (=> (and (and (and (and (not (= y_1 y_1_1)) (U_2_bool (MapType2Select xs y_1))) (U_2_bool (MapType2Select xs y_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_1 y_1_1))))
 :qid |stdinbpl.436:15|
 :skolemid |82|
 :no-pattern (type y_1)
...
)) (=> (forall ((y_1@@1 T@U) ) (!  (=> (= (type y_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs y_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 y_1@@1) (= (invRecv1 y_1@@1) y_1@@1))))
 :qid |stdinbpl.442:22|
 :skolemid |83|
 :pattern ( (MapType0Select Heap@@9 y_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 y_1@@1 f_7))
 :pattern ( (MapType2Select xs y_1@@1))
)) (=> (and (and (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv1 o_3@@2))) (< NoPerm FullPerm)) (qpRange1 o_3@@2)) (= (invRecv1 o_3@@2) o_3@@2)))
 :qid |stdinbpl.446:22|
 :skolemid |84|
...
)))) (and (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)) (and (U_2_bool (MapType2Select xs x@@19)) (state Heap@@9 QPMask@0)))) (and (=> (= (ControlFlow 0 14) 11) anon10_Then_correct) (=> (= (ControlFlow 0 14) 13) anon10_Else_correct))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@19 $allocated))) (and (=> (= (ControlFlow 0 16) 1) anon9_Then_correct) (=> (= (ControlFlow 0 16) 14) anon9_Else_correct)))))
