...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (|Seq#Contains| xs r_1)) (|Seq#Contains| xs r_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= r_1 r_1_1)) (not (= i@@18 i@@18)))))
 :qid |stdinbpl.1441:17|
 :skolemid |113|
 :pattern ( (neverTriggered6 r_1) (neverTriggered6 r_1_1))
 ...
 :qid |stdinbpl.1441:17|
 :skolemid |113|
 :pattern ( (neverTriggered6 r_1@@0) (neverTriggered6 r_1_1@@0))
)) (=> (forall ((r_1@@1 T@U) ) (!  (=> (= (type r_1@@1) RefType) (=> (and (|Seq#Contains| xs r_1@@1) (< NoPerm FullPerm)) (and (= (invRecv6 r_1@@1 i@@18) r_1@@1) (qpRange6 r_1@@1 i@@18))))
...
)) (=> (and (and (and (forall ((r_2_1 T@U) (i_1_1 Int) ) (!  (=> (= (type r_2_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv6 r_2_1 i_1_1)) (< NoPerm FullPerm)) (qpRange6 r_2_1 i_1_1)) (and (= (invRecv6 r_2_1 i_1_1) r_2_1) (= i@@18 i_1_1))))
 :qid |stdinbpl.1451:22|
 :skolemid |115|
 :pattern ( (invRecv6 r_2_1 i_1_1))
)) (forall ((r_2_1@@0 T@U) (i_1_1@@0 Int) ) (!  (=> (= (type r_2_1@@0) RefType) (=> (and (and (|Seq#Contains| xs (invRecv6 r_2_1@@0 i_1_1@@0)) (< NoPerm FullPerm)) (qpRange6 r_2_1@@0 i_1_1@@0)) (and (=> (< NoPerm FullPerm) (and (= (invRecv6 r_2_1@@0 i_1_1@@0) r_2_1@@0) (= i@@18 i_1_1@@0))) (= (U_2_real (MapType1Select QPMask@0 null (p4 r_2_1@@0 i_1_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (p4 r_2_1@@0 i_1_1@@0))) FullPerm)))))
...
)) (forall ((r_2_1@@1 T@U) (i_1_1@@1 Int) ) (!  (=> (and (= (type r_2_1@@1) RefType) (not (and (and (|Seq#Contains| xs (invRecv6 r_2_1@@1 i_1_1@@1)) (< NoPerm FullPerm)) (qpRange6 r_2_1@@1 i_1_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (p4 r_2_1@@1 i_1_1@@1))) (U_2_real (MapType1Select ZeroMask null (p4 r_2_1@@1 i_1_1@@1)))))
