...
(assert  (and (and (= (type ys@0) ListDomainTypeType) (= (type xs@@8) ListDomainTypeType)) (= (type Heap@@18) (MapType0Type RefType))))
(set-info :boogie-vc-id prepend)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (and (= ys@0 (Cons v_2 xs@@8)) (state Heap@@18 ZeroMask)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= (get_List_head ys@0) v_2)) (=> (= (get_List_head ys@0) v_2) (=> (= (ControlFlow 0 3) (- 0 2)) (= (get_List_tail ys@0) xs@@8)))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@18 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct)))))
