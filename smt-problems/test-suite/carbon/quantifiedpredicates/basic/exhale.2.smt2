...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@4) (MapType1Type RefType realType)) (= (type x@@11) RefType)) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (forall ((arg0@@39 T@U) ) (! (= (type (FrameFragment arg0@@39)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@39))
))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@11) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@0) (MapType1Type RefType realType))))
...
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@4 null (pred1 x@@11))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 null (pred1 x@@11)))) (=> (= (ControlFlow 0 3) 2) anon12_correct))))))
(let ((anon10_correct  (=> (= Heap@5 (MapType0Store Heap@4 null (|pred1#sm| x@@11) (MapType1Store (MapType0Select Heap@4 null (|pred1#sm| x@@11)) x@@11 f_7 (bool_2_U true)))) (=> (and (state Heap@5 Mask@4) (state Heap@5 Mask@4)) (and (=> (= (ControlFlow 0 6) 3) anon18_Then_correct) (=> (= (ControlFlow 0 6) 5) anon18_Else_correct))))))
(let ((anon17_Else_correct  (=> (HasDirectPerm Mask@4 null (pred1 x@@11)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 8) 6)) anon10_correct))))
(let ((anon17_Then_correct  (=> (not (HasDirectPerm Mask@4 null (pred1 x@@11))) (=> (and (and (= Heap@2 (MapType0Store Heap@1 null (|pred1#sm| x@@11) ZeroPMask)) (= Heap@3 (MapType0Store Heap@2 null (pred1 x@@11) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 7) 6))) anon10_correct))))
(let ((anon8_correct  (=> (and (= Mask@3 (MapType1Store Mask@2 x@@11 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@2 x@@11 f_7)) FullPerm)))) (= Mask@4 (MapType1Store Mask@3 null (pred1 x@@11) (real_2_U (+ (U_2_real (MapType1Select Mask@3 null (pred1 x@@11))) FullPerm))))) (=> (and (and (state Heap@1 Mask@4) (state Heap@1 Mask@4)) (and (|pred1#trigger| Heap@1 (pred1 x@@11)) (= (MapType0Select Heap@1 null (pred1 x@@11)) (FrameFragment (MapType0Select Heap@1 x@@11 f_7))))) (and (=> (= (ControlFlow 0 9) 7) anon17_Then_correct) (=> (= (ControlFlow 0 9) 8) anon17_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon8_correct)))
(let ((anon16_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@2 x@@11 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 x@@11 f_7))) (=> (= (ControlFlow 0 10) 9) anon8_correct))))))
(let ((anon6_correct  (=> (not (= x@@11 null)) (=> (and (and (= Mask@2 (MapType1Store Mask@1 x@@11 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@1 x@@11 f_7)) FullPerm)))) (state Heap@1 Mask@2)) (and (state Heap@1 Mask@2) (state Heap@1 Mask@2))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (not (= x@@11 null))) (=> (not (= x@@11 null)) (=> (state Heap@1 Mask@2) (and (=> (= (ControlFlow 0 13) 10) anon16_Then_correct) (=> (= (ControlFlow 0 13) 12) anon16_Else_correct)))))))))
(let ((anon15_Else_correct  (=> (HasDirectPerm Mask@1 null (pred1 x@@11)) (=> (and (= Heap@1 Heap@@11) (= (ControlFlow 0 16) 13)) anon6_correct))))
(let ((anon15_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (pred1 x@@11))) (= Heap@0 (MapType0Store Heap@@11 null (pred1 x@@11) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 15) 13))) anon6_correct)))
(let ((anon4_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (pred1 x@@11) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (pred1 x@@11))) FullPerm)))) (and (=> (= (ControlFlow 0 17) 15) anon15_Then_correct) (=> (= (ControlFlow 0 17) 16) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 20) 17)) anon4_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pred1 x@@11))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pred1 x@@11)))) (=> (= (ControlFlow 0 18) 17) anon4_correct))))))
(let ((anon13_Else_correct  (=> (and (|pred1#trigger| Heap@@11 (pred1 x@@11)) (= (MapType0Select Heap@@11 null (pred1 x@@11)) (FrameFragment (MapType0Select Heap@@11 x@@11 f_7)))) (and (=> (= (ControlFlow 0 21) 18) anon14_Then_correct) (=> (= (ControlFlow 0 21) 20) anon14_Else_correct)))))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@11 x@@11 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (pred1 x@@11) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (pred1 x@@11))) FullPerm))))) (and (state Heap@@11 Mask@0) (state Heap@@11 Mask@0))) (and (=> (= (ControlFlow 0 22) 1) anon13_Then_correct) (=> (= (ControlFlow 0 22) 21) anon13_Else_correct))))))
