...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type a_2) (SeqType RefType))) (= (type Mask@8) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type Heap@@33) (MapType0Type RefType))) (= (type Mask@7) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type __flatten_5@0) RefType)) (= (type __flatten_7@0) RefType)) (= (type diz) RefType)) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type __flatten_5) RefType)) (= (type __flatten_7) RefType)) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id Ref__loop_body_11)
...
(let ((anon21_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@8 (|Seq#Index| a_2 i@@34) Ref__Integer_value)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@8 (|Seq#Index| a_2 i@@34) Ref__Integer_value))) (=> (= (ControlFlow 0 5) 4) anon14_correct))))))
(let ((anon12_correct  (=> (state Heap@1 Mask@8) (and (=> (= (ControlFlow 0 8) (- 0 10)) (<= 0 i@@34)) (=> (<= 0 i@@34) (and (=> (= (ControlFlow 0 8) (- 0 9)) (< i@@34 (|Seq#Length| a_2))) (=> (< i@@34 (|Seq#Length| a_2)) (and (=> (= (ControlFlow 0 8) 5) anon21_Then_correct) (=> (= (ControlFlow 0 8) 7) anon21_Else_correct)))))))))
(let ((anon11_correct  (=> (= Mask@7 (MapType1Store Mask@6 (|Seq#Index| a_2 (+ i@@34 1)) Ref__Integer_value (real_2_U (- (U_2_real (MapType1Select Mask@6 (|Seq#Index| a_2 (+ i@@34 1)) Ref__Integer_value)) perm@4)))) (=> (and (IdenticalOnKnownLocations Heap@0 ExhaleHeap@0 Mask@7) (state ExhaleHeap@0 Mask@7)) (=> (and (and (state ExhaleHeap@0 Mask@7) (= Mask@8 Mask@7)) (and (= Heap@1 ExhaleHeap@0) (= (ControlFlow 0 12) 8))) anon12_correct)))))
(let ((anon20_Else_correct  (=> (and (= perm@4 NoPerm) (= (ControlFlow 0 15) 12)) anon11_correct)))
(let ((anon20_Then_correct  (=> (not (= perm@4 NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= perm@4 (U_2_real (MapType1Select Mask@6 (|Seq#Index| a_2 (+ i@@34 1)) Ref__Integer_value)))) (=> (<= perm@4 (U_2_real (MapType1Select Mask@6 (|Seq#Index| a_2 (+ i@@34 1)) Ref__Integer_value))) (=> (= (ControlFlow 0 13) 12) anon11_correct))))))
(let ((anon19_Then_correct  (=> (< i@@34 (- (|Seq#Length| a_2) 1)) (and (=> (= (ControlFlow 0 16) (- 0 27)) (>= i@@34 0)) (=> (>= i@@34 0) (and (=> (= (ControlFlow 0 16) (- 0 26)) (< i@@34 (|Seq#Length| a_2))) (=> (< i@@34 (|Seq#Length| a_2)) (=> (and (= __flatten_5@0 (|Seq#Index| a_2 i@@34)) (state Heap@@33 Mask@6)) (and (=> (= (ControlFlow 0 16) (- 0 25)) (>= (+ i@@34 1) 0)) (=> (>= (+ i@@34 1) 0) (and (=> (= (ControlFlow 0 16) (- 0 24)) (< (+ i@@34 1) (|Seq#Length| a_2))) (=> (< (+ i@@34 1) (|Seq#Length| a_2)) (=> (and (= __flatten_7@0 (|Seq#Index| a_2 (+ i@@34 1))) (state Heap@@33 Mask@6)) (and (=> (= (ControlFlow 0 16) (- 0 23)) (HasDirectPerm Mask@6 __flatten_7@0 Ref__Integer_value)) (=> (HasDirectPerm Mask@6 __flatten_7@0 Ref__Integer_value) (=> (and (= __flatten_6@0 (U_2_int (MapType0Select Heap@@33 __flatten_7@0 Ref__Integer_value))) (state Heap@@33 Mask@6)) (and (=> (= (ControlFlow 0 16) (- 0 22)) (= FullPerm (U_2_real (MapType1Select Mask@6 __flatten_5@0 Ref__Integer_value)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@6 __flatten_5@0 Ref__Integer_value))) (=> (and (= Heap@0 (MapType0Store Heap@@33 __flatten_5@0 Ref__Integer_value (int_2_U __flatten_6@0))) (state Heap@0 Mask@6)) (and (=> (= (ControlFlow 0 16) (- 0 21)) (not (= diz null))) (=> (not (= diz null)) (and (=> (= (ControlFlow 0 16) (- 0 20)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (and (=> (= (ControlFlow 0 16) (- 0 19)) (<= 0 i@@34)) (=> (<= 0 i@@34) (and (=> (= (ControlFlow 0 16) (- 0 18)) (< (+ i@@34 1) (|Seq#Length| a_2))) (=> (< (+ i@@34 1) (|Seq#Length| a_2)) (=> (= perm@4 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (>= perm@4 NoPerm)) (=> (>= perm@4 NoPerm) (and (=> (= (ControlFlow 0 16) 13) anon20_Then_correct) (=> (= (ControlFlow 0 16) 15) anon20_Else_correct))))))))))))))))))))))))))))))))
(let ((anon19_Else_correct  (=> (and (and (<= (- (|Seq#Length| a_2) 1) i@@34) (= Mask@8 Mask@6)) (and (= Heap@1 Heap@@33) (= (ControlFlow 0 11) 8))) anon12_correct)))
(let ((anon8_correct  (=> (state Heap@@33 Mask@6) (and (=> (= (ControlFlow 0 28) 16) anon19_Then_correct) (=> (= (ControlFlow 0 28) 11) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (>= 0 i@@34) (=> (and (= Mask@6 Mask@4) (= (ControlFlow 0 35) 28)) anon8_correct))))
(let ((anon18_Then_correct  (=> (> i@@34 0) (and (=> (= (ControlFlow 0 29) (- 0 34)) (not (= diz null))) (=> (not (= diz null)) (and (=> (= (ControlFlow 0 29) (- 0 33)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (and (=> (= (ControlFlow 0 29) (- 0 32)) (<= 0 i@@34)) (=> (<= 0 i@@34) (and (=> (= (ControlFlow 0 29) (- 0 31)) (< i@@34 (|Seq#Length| a_2))) (=> (< i@@34 (|Seq#Length| a_2)) (=> (= perm@3 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 29) (- 0 30)) (>= perm@3 NoPerm)) (=> (>= perm@3 NoPerm) (=> (=> (> perm@3 NoPerm) (not (= (|Seq#Index| a_2 i@@34) null))) (=> (and (= Mask@5 (MapType1Store Mask@4 (|Seq#Index| a_2 i@@34) Ref__Integer_value (real_2_U (+ (U_2_real (MapType1Select Mask@4 (|Seq#Index| a_2 i@@34) Ref__Integer_value)) perm@3)))) (state Heap@@33 Mask@5)) (=> (and (and (state Heap@@33 Mask@5) (state Heap@@33 Mask@5)) (and (= Mask@6 Mask@5) (= (ControlFlow 0 29) 28))) anon8_correct)))))))))))))))))
(let ((anon17_Else_correct  (=> (and (U_2_bool (MapType0Select Heap@@33 __flatten_5 $allocated)) (U_2_bool (MapType0Select Heap@@33 __flatten_7 $allocated))) (and (=> (= (ControlFlow 0 36) 29) anon18_Then_correct) (=> (= (ControlFlow 0 36) 35) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (and (and (state PostHeap@0 ZeroMask) (<= 0 i@@34)) (and (< i@@34 (|Seq#Length| a_2)) (state PostHeap@0 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= i@@34 0)) (=> (>= i@@34 0) (=> (= (ControlFlow 0 2) (- 0 1)) (< i@@34 (|Seq#Length| a_2))))))))
(let ((anon4_correct  (=> (state Heap@@33 Mask@4) (and (=> (= (ControlFlow 0 37) 2) anon17_Then_correct) (=> (= (ControlFlow 0 37) 36) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (<= (- (|Seq#Length| a_2) 1) i@@34) (=> (and (= Mask@4 Mask@2) (= (ControlFlow 0 42) 37)) anon4_correct))))
(let ((anon16_Then_correct  (=> (< i@@34 (- (|Seq#Length| a_2) 1)) (and (=> (= (ControlFlow 0 38) (- 0 41)) (>= (+ i@@34 1) 0)) (=> (>= (+ i@@34 1) 0) (and (=> (= (ControlFlow 0 38) (- 0 40)) (< (+ i@@34 1) (|Seq#Length| a_2))) (=> (< (+ i@@34 1) (|Seq#Length| a_2)) (=> (= perm@2 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 38) (- 0 39)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (=> (> perm@2 NoPerm) (not (= (|Seq#Index| a_2 (+ i@@34 1)) null))) (=> (and (and (= Mask@3 (MapType1Store Mask@2 (|Seq#Index| a_2 (+ i@@34 1)) Ref__Integer_value (real_2_U (+ (U_2_real (MapType1Select Mask@2 (|Seq#Index| a_2 (+ i@@34 1)) Ref__Integer_value)) perm@2)))) (state Heap@@33 Mask@3)) (and (= Mask@4 Mask@3) (= (ControlFlow 0 38) 37))) anon4_correct))))))))))))
(let ((anon2_correct  (=> (state Heap@@33 Mask@2) (and (=> (= (ControlFlow 0 43) 38) anon16_Then_correct) (=> (= (ControlFlow 0 43) 42) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (not (= i@@34 0)) (=> (and (= Mask@2 Mask@0) (= (ControlFlow 0 48) 43)) anon2_correct))))
(let ((anon15_Then_correct  (=> (= i@@34 0) (and (=> (= (ControlFlow 0 44) (- 0 47)) (>= i@@34 0)) (=> (>= i@@34 0) (and (=> (= (ControlFlow 0 44) (- 0 46)) (< i@@34 (|Seq#Length| a_2))) (=> (< i@@34 (|Seq#Length| a_2)) (=> (= perm@1 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 44) (- 0 45)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (=> (> perm@1 NoPerm) (not (= (|Seq#Index| a_2 i@@34) null))) (=> (and (and (= Mask@1 (MapType1Store Mask@0 (|Seq#Index| a_2 i@@34) Ref__Integer_value (real_2_U (+ (U_2_real (MapType1Select Mask@0 (|Seq#Index| a_2 i@@34) Ref__Integer_value)) perm@1)))) (state Heap@@33 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 44) 43))) anon2_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@33 diz $allocated)) (not (= diz null))) (and (state Heap@@33 ZeroMask) (>= current_thread_id 0))) (and (and (state Heap@@33 ZeroMask) (<= 0 i@@34)) (and (< i@@34 (|Seq#Length| a_2)) (state Heap@@33 ZeroMask)))) (and (=> (= (ControlFlow 0 49) (- 0 52)) (>= i@@34 0)) (=> (>= i@@34 0) (and (=> (= (ControlFlow 0 49) (- 0 51)) (< i@@34 (|Seq#Length| a_2))) (=> (< i@@34 (|Seq#Length| a_2)) (=> (= perm@0 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 49) (- 0 50)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= (|Seq#Index| a_2 i@@34) null))) (= Mask@0 (MapType1Store ZeroMask (|Seq#Index| a_2 i@@34) Ref__Integer_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask (|Seq#Index| a_2 i@@34) Ref__Integer_value)) perm@0))))) (and (state Heap@@33 Mask@0) (state Heap@@33 Mask@0))) (and (=> (= (ControlFlow 0 49) 44) anon15_Then_correct) (=> (= (ControlFlow 0 49) 48) anon15_Else_correct))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 53) 49) anon0_correct)))
