...
(assert  (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type x@@34) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@14) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Heap@1) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test4)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon4_correct  (=> (and (= perm@0 (* FullPerm p_1@@5)) (= (ControlFlow 0 2) (- 0 1))) (>= perm@0 NoPerm))))
(let ((anon6_Else_correct  (=> (HasDirectPerm Mask@1 null (P x@@34)) (=> (and (= Heap@1 Heap@@14) (= (ControlFlow 0 4) 2)) anon4_correct))))
(let ((anon6_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (P x@@34))) (= Heap@0 (MapType0Store Heap@@14 null (P x@@34) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 3) 2))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (P x@@34) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P x@@34))) p_1@@5)))) (and (=> (= (ControlFlow 0 5) 3) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (= p_1@@5 NoPerm) (= (ControlFlow 0 8) 5)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= p_1@@5 NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= p_1@@5 (U_2_real (MapType1Select Mask@0 null (P x@@34))))) (=> (<= p_1@@5 (U_2_real (MapType1Select Mask@0 null (P x@@34)))) (=> (= (ControlFlow 0 6) 5) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@14 x@@34 $allocated))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (P x@@34) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@34))) FullPerm)))) (state Heap@@14 Mask@0)) (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (> p_1@@5 NoPerm)) (=> (> p_1@@5 NoPerm) (=> (and (|P#trigger| Heap@@14 (P x@@34)) (= (MapType0Select Heap@@14 null (P x@@34)) (FrameFragment (MapType0Select Heap@@14 x@@34 f_7)))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (>= p_1@@5 NoPerm)) (=> (>= p_1@@5 NoPerm) (and (=> (= (ControlFlow 0 9) 6) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct))))))))))))
