...
(declare-fun i@@5 () Int)
(assert  (and (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type y@@1) RefType)) (= (type z@@0) RefType)) (= (type x@@14) RefType)))
...
(let ((anon4_correct  (=> (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (=> (= (ControlFlow 0 4) 2) anon9_Then_correct) (=> (= (ControlFlow 0 4) 3) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (not b2) (= (ControlFlow 0 6) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> b2 (=> (and (<= (__iar__assume_helper_1  (and b1 (and (= y@@1 z@@0) (= j k))) FullPerm FullPerm) (U_2_real (MapType1Select Mask@0 null (P z@@0 k)))) (= (ControlFlow 0 5) 4)) anon4_correct))))
(let ((anon2_correct  (=> (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (=> (= (ControlFlow 0 7) 5) anon8_Then_correct) (=> (= (ControlFlow 0 7) 6) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (not b1) (= (ControlFlow 0 9) 7)) anon2_correct)))
(let ((anon7_Then_correct  (=> b1 (=> (and (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P y@@1 j)))) (= (ControlFlow 0 8) 7)) anon2_correct))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 x@@14 $allocated)) (U_2_bool (MapType0Select Heap@@10 y@@1 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@10 z@@0 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (P x@@14 i@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@14 i@@5))) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 10) 8) anon7_Then_correct) (=> (= (ControlFlow 0 10) 9) anon7_Else_correct)))))))
