(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:08:46
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/third_party/stefan_recent/testTreeWandE2.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(declare-fun joined_unfolding@38@00 ($Snap $Ref) $Ref)
...
(declare-fun joined_unfolding@61@00 ($Snap $Ref) Seq<Int>)
...
(declare-fun joined_unfolding@84@00 ($Snap $Ref) Seq<Int>)
