...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon2_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (AList this@@15) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (AList this@@15))) FullPerm)))) (not (= this@@15 null))) (=> (and (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this@@15 elems (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this@@15 elems)) FullPerm)))) (state Heap@@19 UnfoldingMask@1)) (and (not (= this@@15 null)) (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 this@@15 size (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 this@@15 size)) FullPerm)))))) (and (and (state Heap@@19 UnfoldingMask@2) (<= 0 (U_2_int (MapType0Select Heap@@19 this@@15 size)))) (and (<= (U_2_int (MapType0Select Heap@@19 this@@15 size)) (len (MapType0Select Heap@@19 this@@15 elems))) (< 0 (len (MapType0Select Heap@@19 this@@15 elems)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((i@@0 Int) (i_10 Int) ) (!  (=> (and (and (and (and (not (= i@@0 i_10)) (and (<= 0 i@@0) (< i@@0 (len (MapType0Select Heap@@19 this@@15 elems))))) (and (<= 0 i_10) (< i_10 (len (MapType0Select Heap@@19 this@@15 elems))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc (MapType0Select Heap@@19 this@@15 elems) i@@0) (loc (MapType0Select Heap@@19 this@@15 elems) i_10))))
 :qid |stdinbpl.393:17|
 :skolemid |29|
))) (=> (forall ((i@@1 Int) (i_10@@0 Int) ) (!  (=> (and (and (and (and (not (= i@@1 i_10@@0)) (and (<= 0 i@@1) (< i@@1 (len (MapType0Select Heap@@19 this@@15 elems))))) (and (<= 0 i_10@@0) (< i_10@@0 (len (MapType0Select Heap@@19 this@@15 elems))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc (MapType0Select Heap@@19 this@@15 elems) i@@1) (loc (MapType0Select Heap@@19 this@@15 elems) i_10@@0))))
 :qid |stdinbpl.393:17|
 :skolemid |29|
)) (=> (forall ((i@@2 Int) ) (!  (=> (and (and (<= 0 i@@2) (< i@@2 (len (MapType0Select Heap@@19 this@@15 elems)))) (< NoPerm FullPerm)) (and (qpRange1 (loc (MapType0Select Heap@@19 this@@15 elems) i@@2)) (= (invRecv1 (loc (MapType0Select Heap@@19 this@@15 elems) i@@2)) i@@2)))
 :qid |stdinbpl.399:24|
 :skolemid |30|
 :pattern ( (loc (MapType0Select Heap@@19 this@@15 elems) i@@2))
 :pattern ( (loc (MapType0Select Heap@@19 this@@15 elems) i@@2))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv1 o_3)) (< (invRecv1 o_3) (len (MapType0Select Heap@@19 this@@15 elems)))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (loc (MapType0Select Heap@@19 this@@15 elems) (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.403:24|
 :skolemid |31|
 :pattern ( (invRecv1 o_3))
)) (forall ((i@@3 Int) ) (!  (=> (and (<= 0 i@@3) (< i@@3 (len (MapType0Select Heap@@19 this@@15 elems)))) (not (= (loc (MapType0Select Heap@@19 this@@15 elems) i@@3) null)))
 :qid |stdinbpl.409:24|
 :skolemid |32|
 :pattern ( (loc (MapType0Select Heap@@19 this@@15 elems) i@@3))
 :pattern ( (loc (MapType0Select Heap@@19 this@@15 elems) i@@3))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (len (MapType0Select Heap@@19 this@@15 elems)))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (loc (MapType0Select Heap@@19 this@@15 elems) (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select UnfoldingMask@2 o_3@@0 val)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (len (MapType0Select Heap@@19 this@@15 elems)))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select UnfoldingMask@2 o_3@@0 val))))))
 :qid |stdinbpl.415:24|
 :skolemid |33|
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 val))) (= (U_2_real (MapType1Select UnfoldingMask@2 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.419:31|
 :skolemid |34|
 :pattern ( (MapType1Select UnfoldingMask@2 o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
))) (and (state Heap@@19 QPMask@0) (state Heap@@19 QPMask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm QPMask@0 this@@15 size)) (=> (HasDirectPerm QPMask@0 this@@15 size) (=> (and (and (and (= Heap@0 (MapType0Store Heap@@19 null (|AList#sm| this@@15) (MapType1Store (MapType0Select Heap@@19 null (|AList#sm| this@@15)) this@@15 elems (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|AList#sm| this@@15) (MapType1Store (MapType0Select Heap@0 null (|AList#sm| this@@15)) this@@15 size (bool_2_U true))))) (and (forall ((o_4 T@U) (f_7 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_7))))
(let ((A@@13 (FieldTypeInv0 (type f_7))))
 (=> (and (and (= (type o_4) RefType) (= (type f_7) (FieldType A@@13 B@@12))) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|AList#sm| this@@15)) o_4 f_7))) (U_2_bool (MapType1Select newPMask@0 o_4 f_7)))))
 :qid |stdinbpl.434:31|
 :skolemid |35|
 :pattern ( (MapType1Select newPMask@0 o_4 f_7))
)) (forall ((i_1 Int) ) (!  (=> (and (<= 0 i_1) (< i_1 (len (MapType0Select Heap@1 this@@15 elems)))) (U_2_bool (MapType1Select newPMask@0 (loc (MapType0Select Heap@1 this@@15 elems) i_1) val)))
 :qid |stdinbpl.438:24|
 :skolemid |36|
)))) (and (and (= Heap@2 (MapType0Store Heap@1 null (|AList#sm| this@@15) newPMask@0)) (state Heap@2 Mask@0)) (and (= Result@0 (U_2_int (MapType0Select Heap@2 this@@15 size))) (= (ControlFlow 0 2) (- 0 1))))) (>= Result@0 0)))))))))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (AList this@@15))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (AList this@@15)))) (=> (= (ControlFlow 0 5) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@19 ZeroMask) (U_2_bool (MapType0Select Heap@@19 this@@15 $allocated))) (and (= AssumeFunctionsAbove 1) (= Mask@0 (MapType1Store ZeroMask null (AList this@@15) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (AList this@@15))) FullPerm)))))) (and (and (state Heap@@19 Mask@0) (state Heap@@19 Mask@0)) (and (|AList#trigger| Heap@@19 (AList this@@15)) (= (MapType0Select Heap@@19 null (AList this@@15)) (CombineFrames (FrameFragment (MapType0Select Heap@@19 this@@15 elems)) (CombineFrames (FrameFragment (MapType0Select Heap@@19 this@@15 size)) (FrameFragment (int_2_U (|AList#condqp1| Heap@@19 this@@15))))))))) (and (=> (= (ControlFlow 0 8) 5) anon3_Then_correct) (=> (= (ControlFlow 0 8) 7) anon3_Else_correct)))))
