...
(declare-fun |zip#trigger| (T@U T@U T@U) Bool)
...
(let ((anon7_Else_correct  (=> (and (|zip#trigger| EmptyFrame (|Seq#Drop| xs@@3 1) (|Seq#Drop| ys@@3 1)) (= (ControlFlow 0 5) 3)) anon5_correct)))
(let ((anon6_Then_correct  (=> (and (|Seq#Equal| ys@@3 (|Seq#Empty| RefType)) (= (ControlFlow 0 4) 3)) anon5_correct)))
(let ((anon7_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (= (|Seq#Length| (|Seq#Drop| xs@@3 1)) (|Seq#Length| (|Seq#Drop| ys@@3 1))) (= (|Seq#Length| (|Seq#Drop| xs@@3 1)) (+ (|Seq#Length| (|Seq#Drop| ys@@3 1)) 1))))))
(let ((anon6_Else_correct  (=> (not (|Seq#Equal| ys@@3 (|Seq#Empty| RefType))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (< 0 (|Seq#Length| xs@@3))) (=> (< 0 (|Seq#Length| xs@@3)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (< 0 (|Seq#Length| ys@@3))) (=> (< 0 (|Seq#Length| ys@@3)) (and (=> (= (ControlFlow 0 6) 2) anon7_Then_correct) (=> (= (ControlFlow 0 6) 5) anon7_Else_correct)))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove 0)) (and (or (= (|Seq#Length| xs@@3) (|Seq#Length| ys@@3)) (= (|Seq#Length| xs@@3) (+ (|Seq#Length| ys@@3) 1))) (state Heap@@13 ZeroMask))) (and (=> (= (ControlFlow 0 9) 4) anon6_Then_correct) (=> (= (ControlFlow 0 9) 6) anon6_Else_correct)))))
