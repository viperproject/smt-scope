...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@5) (MapType1Type RefType realType)) (= (type Mask@4) (MapType1Type RefType realType))) (= (type this@@19) RefType)) (= (type Heap@6) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (forall ((arg0@@30 T@U) ) (! (= (type (FrameFragment arg0@@30)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@30))
))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@19) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))))
...
(let ((anon19_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (X this@@19))))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (X this@@19)))) (=> (= (ControlFlow 0 24) 23) anon4_correct))))))
(let ((anon18_Else_correct true))
(let ((anon17_Then_correct  (=> (and (and (state PostHeap@0 ZeroMask) (= PostMask@0 (MapType1Store ZeroMask null (X this@@19) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (X this@@19))) FullPerm))))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (and (=> (= (ControlFlow 0 27) 22) anon18_Else_correct) (=> (= (ControlFlow 0 27) 24) anon19_Then_correct)) (=> (= (ControlFlow 0 27) 26) anon19_Else_correct)))))
(let ((anon16_correct  (=> (and (= Mask@5 (MapType1Store Mask@4 null (X this@@19) (real_2_U (- (U_2_real (MapType1Select Mask@4 null (X this@@19))) FullPerm)))) (= (ControlFlow 0 2) (- 0 1))) (= (getX Heap@6 this@@19) v_2))))
(let ((anon24_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon16_correct)))
(let ((anon24_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@4 null (X this@@19))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 null (X this@@19)))) (=> (= (ControlFlow 0 3) 2) anon16_correct))))))
(let ((anon14_correct  (=> (= Heap@6 (MapType0Store Heap@5 null (|X#sm| this@@19) (MapType1Store (MapType0Select Heap@5 null (|X#sm| this@@19)) this@@19 x@@8 (bool_2_U true)))) (=> (and (state Heap@6 Mask@4) (state Heap@6 Mask@4)) (and (=> (= (ControlFlow 0 6) 3) anon24_Then_correct) (=> (= (ControlFlow 0 6) 5) anon24_Else_correct))))))
(let ((anon23_Else_correct  (=> (HasDirectPerm Mask@4 null (X this@@19)) (=> (and (= Heap@5 Heap@2) (= (ControlFlow 0 8) 6)) anon14_correct))))
(let ((anon23_Then_correct  (=> (not (HasDirectPerm Mask@4 null (X this@@19))) (=> (and (and (= Heap@3 (MapType0Store Heap@2 null (|X#sm| this@@19) ZeroPMask)) (= Heap@4 (MapType0Store Heap@3 null (X this@@19) freshVersion@0))) (and (= Heap@5 Heap@4) (= (ControlFlow 0 7) 6))) anon14_correct))))
(let ((anon12_correct  (=> (and (= Mask@3 (MapType1Store Mask@2 this@@19 x@@8 (real_2_U (- (U_2_real (MapType1Select Mask@2 this@@19 x@@8)) FullPerm)))) (= Mask@4 (MapType1Store Mask@3 null (X this@@19) (real_2_U (+ (U_2_real (MapType1Select Mask@3 null (X this@@19))) FullPerm))))) (=> (and (and (state Heap@2 Mask@4) (state Heap@2 Mask@4)) (and (|X#trigger| Heap@2 (X this@@19)) (= (MapType0Select Heap@2 null (X this@@19)) (FrameFragment (MapType0Select Heap@2 this@@19 x@@8))))) (and (=> (= (ControlFlow 0 9) 7) anon23_Then_correct) (=> (= (ControlFlow 0 9) 8) anon23_Else_correct))))))
(let ((anon22_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon12_correct)))
(let ((anon22_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@2 this@@19 x@@8)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 this@@19 x@@8))) (=> (= (ControlFlow 0 10) 9) anon12_correct))))))
(let ((anon10_correct  (=> (not (= this@@19 null)) (=> (and (and (= Mask@2 (MapType1Store Mask@1 this@@19 x@@8 (real_2_U (+ (U_2_real (MapType1Select Mask@1 this@@19 x@@8)) FullPerm)))) (state Heap@1 Mask@2)) (and (state Heap@1 Mask@2) (state Heap@1 Mask@2))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (= FullPerm (U_2_real (MapType1Select Mask@2 this@@19 x@@8)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@2 this@@19 x@@8))) (=> (and (= Heap@2 (MapType0Store Heap@1 this@@19 x@@8 (int_2_U v_2))) (state Heap@2 Mask@2)) (and (=> (= (ControlFlow 0 13) 10) anon22_Then_correct) (=> (= (ControlFlow 0 13) 12) anon22_Else_correct)))))))))
(let ((anon21_Else_correct  (=> (HasDirectPerm Mask@1 null (X this@@19)) (=> (and (= Heap@1 Heap@@19) (= (ControlFlow 0 16) 13)) anon10_correct))))
(let ((anon21_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (X this@@19))) (= Heap@0 (MapType0Store Heap@@19 null (X this@@19) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 15) 13))) anon10_correct)))
(let ((anon8_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (X this@@19) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (X this@@19))) FullPerm)))) (and (=> (= (ControlFlow 0 17) 15) anon21_Then_correct) (=> (= (ControlFlow 0 17) 16) anon21_Else_correct)))))
(let ((anon20_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 20) 17)) anon8_correct)))
(let ((anon20_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (X this@@19))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (X this@@19)))) (=> (= (ControlFlow 0 18) 17) anon8_correct))))))
(let ((anon17_Else_correct  (=> (and (|X#trigger| Heap@@19 (X this@@19)) (= (MapType0Select Heap@@19 null (X this@@19)) (FrameFragment (MapType0Select Heap@@19 this@@19 x@@8)))) (and (=> (= (ControlFlow 0 21) 18) anon20_Then_correct) (=> (= (ControlFlow 0 21) 20) anon20_Else_correct)))))
(let ((anon0_correct  (=> (and (state Heap@@19 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@19 this@@19 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (X this@@19) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (X this@@19))) FullPerm))))) (and (state Heap@@19 Mask@0) (state Heap@@19 Mask@0))) (and (=> (= (ControlFlow 0 28) 27) anon17_Then_correct) (=> (= (ControlFlow 0 28) 21) anon17_Else_correct))))))
