...
(let ((anon6_Else_correct  (=> (and (not (and (<= 0 i@@6) (<= i@@6 (|Seq#Length| xs)))) (= (ControlFlow 0 6) 2)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (<= 0 i@@6) (<= i@@6 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< i@@6 (|Seq#Length| xs))) (=> (< i@@6 (|Seq#Length| xs)) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))))
