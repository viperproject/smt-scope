...
(= (type (MapType0Store arg0@@18 arg1@@6 arg2)) (MapType0Type aVar0 aVar1@@0))))
 ...
 :weight 0
)))) (= (Ctor RefType) 9)) (= (type all) (FieldType NormalFieldType (MapType0Type RefType boolType)))) (= (type f_7) (FieldType NormalFieldType RefType))))
(assert (distinct $allocated all f_7)
)
...
(assert (forall ((this@@3 T@U) ) (!  (=> (= (type this@@3) RefType) (= (getPredWandId (inv this@@3)) 0))
 :qid |stdinbpl.413:15|
 :skolemid |84|
 :pattern ( (inv this@@3))
)))
...
(assert (forall ((this@@4 T@U) ) (!  (=> (= (type this@@4) RefType) (= (PredicateMaskField (inv this@@4)) (|inv#sm| this@@4)))
 :qid |stdinbpl.405:15|
 :skolemid |82|
 :pattern ( (PredicateMaskField (inv this@@4)))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@5) (MapType1Type RefType)) (= (type Heap@4) (MapType1Type RefType))) (= (type b_2) RefType)) (= (type Mask@3) (MapType2Type RefType realType))) (= (type S) (MapType0Type RefType boolType))) (= (type Heap@2) (MapType1Type RefType))) (= (type Heap@1) (MapType1Type RefType))) (= (type Heap@3) (MapType1Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@2) (MapType2Type RefType realType))) (= (type Mask@1) (MapType2Type RefType realType))) (forall ((arg0@@45 T@U) ) (! (= (type (FrameFragment arg0@@45)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@45))
))) (= (type Mask@0) (MapType2Type RefType realType))) (= (type v_2@0) RefType)) (= (type Heap@0) (MapType1Type RefType))) (= (type Heap@@10) (MapType1Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type QPMask@0) (MapType2Type RefType realType))) (= (type v_2) RefType)) (= (type PostHeap@0) (MapType1Type RefType))) (forall ((arg0@@46 T@U) ) (! (= (type (invRecv1 arg0@@46)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 29) (let ((anon17_Else_correct  (=> (= (ControlFlow 0 24) (- 0 23)) (forall ((x1_1 T@U) (x1_1_1 T@U) ) (!  (=> (and (= (type x1_1) RefType) (= (type x1_1_1) RefType)) (=> (and (and (and (and (not (= x1_1 x1_1_1)) (U_2_bool (MapType0Select S x1_1))) (U_2_bool (MapType0Select S x1_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x1_1 x1_1_1))))
 :qid |stdinbpl.541:17|
 :skolemid |94|
...
(let ((anon14_correct  (=> (= Heap@5 (MapType1Store Heap@4 null (|inv#sm| b_2) (MapType2Store (MapType1Select Heap@4 null (|inv#sm| b_2)) b_2 f_7 (bool_2_U true)))) (=> (and (state Heap@5 Mask@3) (state Heap@5 Mask@3)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x1_3 T@U) (x1_3_1 T@U) ) (!  (=> (and (= (type x1_3) RefType) (= (type x1_3_1) RefType)) (=> (and (and (and (and (not (= x1_3 x1_3_1)) (U_2_bool (MapType0Select S x1_3))) (U_2_bool (MapType0Select S x1_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x1_3 x1_3_1))))
 :qid |stdinbpl.657:17|
 :skolemid |100|
 :pattern ( (neverTriggered3 x1_3) (neverTriggered3 x1_3_1))
))) (=> (forall ((x1_3@@0 T@U) (x1_3_1@@0 T@U) ) (!  (=> (and (= (type x1_3@@0) RefType) (= (type x1_3_1@@0) RefType)) (=> (and (and (and (and (not (= x1_3@@0 x1_3_1@@0)) (U_2_bool (MapType0Select S x1_3@@0))) (U_2_bool (MapType0Select S x1_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x1_3@@0 x1_3_1@@0))))
 :qid |stdinbpl.657:17|
 :skolemid |100|
 :pattern ( (neverTriggered3 x1_3@@0) (neverTriggered3 x1_3_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x1_3@@1 T@U) ) (!  (=> (and (= (type x1_3@@1) RefType) (U_2_bool (MapType0Select S x1_3@@1))) (>= (U_2_real (MapType2Select Mask@3 null (inv x1_3@@1))) FullPerm))
 :qid |stdinbpl.664:17|
 :skolemid |101|
 :pattern ( (MapType1Select Heap@5 null (inv x1_3@@1)))
 :pattern ( (MapType2Select Mask@3 null (inv x1_3@@1)))
 :pattern ( (MapType0Select S x1_3@@1))
)))))))))
(let ((anon21_Else_correct  (=> (HasDirectPerm Mask@3 null (inv b_2)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 6) 3)) anon14_correct))))
(let ((anon21_Then_correct  (=> (not (HasDirectPerm Mask@3 null (inv b_2))) (=> (and (and (= Heap@2 (MapType1Store Heap@1 null (|inv#sm| b_2) ZeroPMask)) (= Heap@3 (MapType1Store Heap@2 null (inv b_2) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 5) 3))) anon14_correct))))
(let ((anon12_correct  (=> (and (= Mask@2 (MapType2Store Mask@1 b_2 f_7 (real_2_U (- (U_2_real (MapType2Select Mask@1 b_2 f_7)) perm@1)))) (= Mask@3 (MapType2Store Mask@2 null (inv b_2) (real_2_U (+ (U_2_real (MapType2Select Mask@2 null (inv b_2))) FullPerm))))) (=> (and (and (state Heap@1 Mask@3) (state Heap@1 Mask@3)) (and (|inv#trigger| Heap@1 (inv b_2)) (= (MapType1Select Heap@1 null (inv b_2)) (FrameFragment (MapType1Select Heap@1 b_2 f_7))))) (and (=> (= (ControlFlow 0 7) 5) anon21_Then_correct) (=> (= (ControlFlow 0 7) 6) anon21_Else_correct))))))
(let ((anon20_Else_correct  (=> (and (= perm@1 NoPerm) (= (ControlFlow 0 10) 7)) anon12_correct)))
(let ((anon20_Then_correct  (=> (not (= perm@1 NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= perm@1 (U_2_real (MapType2Select Mask@1 b_2 f_7)))) (=> (<= perm@1 (U_2_real (MapType2Select Mask@1 b_2 f_7))) (=> (= (ControlFlow 0 8) 7) anon12_correct))))))
(let ((anon10_correct  (=> (= perm@0 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 11) (- 0 14)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= b_2 null))) (=> (and (and (= Mask@1 (MapType2Store Mask@0 b_2 f_7 (real_2_U (+ (U_2_real (MapType2Select Mask@0 b_2 f_7)) perm@0)))) (state Heap@1 Mask@1)) (and (state Heap@1 Mask@1) (state Heap@1 Mask@1))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (HasDirectPerm Mask@1 b_2 f_7)) (=> (HasDirectPerm Mask@1 b_2 f_7) (=> (= v_2@0 (MapType1Select Heap@1 b_2 f_7)) (=> (and (state Heap@1 Mask@1) (= perm@1 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (and (=> (= (ControlFlow 0 11) 8) anon20_Then_correct) (=> (= (ControlFlow 0 11) 10) anon20_Else_correct)))))))))))))))
(let ((anon19_Else_correct  (=> (HasDirectPerm Mask@0 null (inv b_2)) (=> (and (= Heap@1 Heap@@10) (= (ControlFlow 0 16) 11)) anon10_correct))))
(let ((anon19_Then_correct  (=> (and (and (not (HasDirectPerm Mask@0 null (inv b_2))) (= Heap@0 (MapType1Store Heap@@10 null (inv b_2) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 15) 11))) anon10_correct)))
(let ((anon8_correct  (=> (= Mask@0 (MapType2Store QPMask@0 null (inv b_2) (real_2_U (- (U_2_real (MapType2Select QPMask@0 null (inv b_2))) FullPerm)))) (and (=> (= (ControlFlow 0 17) 15) anon19_Then_correct) (=> (= (ControlFlow 0 17) 16) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 20) 17)) anon8_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (<= FullPerm (U_2_real (MapType2Select QPMask@0 null (inv b_2))))) (=> (<= FullPerm (U_2_real (MapType2Select QPMask@0 null (inv b_2)))) (=> (= (ControlFlow 0 18) 17) anon8_correct))))))
(let ((anon16_Else_correct  (=> (U_2_bool (MapType1Select Heap@@10 b_2 $allocated)) (=> (and (U_2_bool (MapType1Select Heap@@10 v_2 $allocated)) (U_2_bool (MapType0Select S b_2))) (=> (and (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0)) (and (|inv#trigger| Heap@@10 (inv b_2)) (= (MapType1Select Heap@@10 null (inv b_2)) (FrameFragment (MapType1Select Heap@@10 b_2 f_7))))) (and (=> (= (ControlFlow 0 21) 18) anon18_Then_correct) (=> (= (ControlFlow 0 21) 20) anon18_Else_correct)))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType0Select S x_1))) (U_2_bool (MapType0Select S x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.488:17|
 :skolemid |88|
 :pattern ( (neverTriggered1 x_1) (neverTriggered1 x_1_1))
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (U_2_bool (MapType0Select S x_1@@0))) (U_2_bool (MapType0Select S x_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.488:17|
 :skolemid |88|
 :pattern ( (neverTriggered1 x_1@@0) (neverTriggered1 x_1_1@@0))
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType0Select S x_1@@1)) (< NoPerm FullPerm)) (and (= (invRecv1 x_1@@1) x_1@@1) (qpRange1 x_1@@1))))
 :qid |stdinbpl.494:22|
 :skolemid |89|
 :pattern ( (MapType1Select Heap@@10 null (inv x_1@@1)))
 :pattern ( (MapType2Select ZeroMask null (inv x_1@@1)))
 :pattern ( (MapType0Select S x_1@@1))
)) (=> (and (forall ((this@@5 T@U) ) (!  (=> (= (type this@@5) RefType) (=> (and (and (U_2_bool (MapType0Select S (invRecv1 this@@5))) (< NoPerm FullPerm)) (qpRange1 this@@5)) (= (invRecv1 this@@5) this@@5)))
 :qid |stdinbpl.498:22|
 :skolemid |90|
 :pattern ( (invRecv1 this@@5))
)) (forall ((this@@6 T@U) ) (!  (=> (= (type this@@6) RefType) (=> (and (and (U_2_bool (MapType0Select S (invRecv1 this@@6))) (< NoPerm FullPerm)) (qpRange1 this@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv1 this@@6) this@@6)) (= (U_2_real (MapType2Select QPMask@0 null (inv this@@6))) (+ (U_2_real (MapType2Select ZeroMask null (inv this@@6))) FullPerm)))))
 :qid |stdinbpl.504:22|
 :skolemid |91|
 :pattern ( (MapType2Select QPMask@0 null (inv this@@6)))
...
)) (forall ((this@@7 T@U) ) (!  (=> (and (= (type this@@7) RefType) (not (and (and (U_2_bool (MapType0Select S (invRecv1 this@@7))) (< NoPerm FullPerm)) (qpRange1 this@@7)))) (= (U_2_real (MapType2Select QPMask@0 null (inv this@@7))) (U_2_real (MapType2Select ZeroMask null (inv this@@7)))))
 :qid |stdinbpl.514:22|
 :skolemid |93|
 :pattern ( (MapType2Select QPMask@0 null (inv this@@7)))
))) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0))) (and (=> (= (ControlFlow 0 26) 25) anon16_Then_correct) (=> (= (ControlFlow 0 26) 21) anon16_Else_correct)))))))))
(let ((anon15_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (and (=> (= (ControlFlow 0 28) 1) anon15_Then_correct) (=> (= (ControlFlow 0 28) 26) anon15_Else_correct)))))
