...
(declare-fun |otherDummy'| (T@U Int) Bool)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |otherDummy#triggerStateless| (Int) Bool)
(declare-fun |thirdDummy'| (T@U Int) Bool)
...
(declare-fun |otherDummy#frame| (T@U Int) Bool)
(declare-fun |thirdDummy#frame| (T@U Int) Bool)
(declare-fun otherDummy (T@U Int) Bool)
(declare-fun thirdDummy (T@U Int) Bool)
...
(assert (forall ((Heap@@2 T@U) (i Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (bool_2_U (|otherDummy#triggerStateless| i))))
 :qid |stdinbpl.190:15|
 :skolemid |23|
 :pattern ( (|otherDummy'| Heap@@2 i))
)))
(assert (forall ((Heap@@3 T@U) (i@@0 Int) ) (!  (=> (= (type Heap@@3) (MapType0Type RefType)) (dummyFunction (bool_2_U (|thirdDummy#triggerStateless| i@@0))))
 :qid |stdinbpl.230:15|
 :skolemid |26|
 :pattern ( (|thirdDummy'| Heap@@3 i@@0))
)))
...
(assert (forall ((Heap@@7 T@U) (Mask@@6 T@U) (i@@1 Int) ) (!  (=> (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (state Heap@@7 Mask@@6)) (= (|otherDummy'| Heap@@7 i@@1) (|otherDummy#frame| EmptyFrame i@@1)))
 :qid |stdinbpl.197:15|
 :skolemid |24|
 :pattern ( (state Heap@@7 Mask@@6) (|otherDummy'| Heap@@7 i@@1))
)))
(assert (forall ((Heap@@8 T@U) (Mask@@7 T@U) (i@@2 Int) ) (!  (=> (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (state Heap@@8 Mask@@7)) (= (|thirdDummy'| Heap@@8 i@@2) (|thirdDummy#frame| EmptyFrame i@@2)))
 :qid |stdinbpl.237:15|
 :skolemid |27|
 :pattern ( (state Heap@@8 Mask@@7) (|thirdDummy'| Heap@@8 i@@2))
)))
(assert (forall ((Heap@@9 T@U) (i@@3 Int) ) (!  (=> (= (type Heap@@9) (MapType0Type RefType)) (and (= (otherDummy Heap@@9 i@@3) (|otherDummy'| Heap@@9 i@@3)) (dummyFunction (bool_2_U (|otherDummy#triggerStateless| i@@3)))))
 :qid |stdinbpl.186:15|
 :skolemid |22|
 :pattern ( (otherDummy Heap@@9 i@@3))
)))
(assert (forall ((Heap@@10 T@U) (i@@4 Int) ) (!  (=> (= (type Heap@@10) (MapType0Type RefType)) (and (= (thirdDummy Heap@@10 i@@4) (|thirdDummy'| Heap@@10 i@@4)) (dummyFunction (bool_2_U (|thirdDummy#triggerStateless| i@@4)))))
 :qid |stdinbpl.226:15|
 :skolemid |25|
 :pattern ( (thirdDummy Heap@@10 i@@4))
)))
...
(set-info :boogie-vc-id shouldNotTrigger)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon17_Then_correct true))
(let ((anon11_correct true))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (otherDummy Heap@@15 5)) (=> (otherDummy Heap@@15 5) (=> (and (state Heap@@15 ZeroMask) (= (ControlFlow 0 8) 5)) anon11_correct)))))
(let ((anon16_Then_correct  (=> b_2 (and (=> (= (ControlFlow 0 10) 7) anon17_Then_correct) (=> (= (ControlFlow 0 10) 8) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (not b_2) (= (ControlFlow 0 6) 5)) anon11_correct)))
(let ((anon7_correct  (=> (state Heap@@15 ZeroMask) (and (=> (= (ControlFlow 0 11) 10) anon16_Then_correct) (=> (= (ControlFlow 0 11) 6) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (not (exists ((i_1_1 Int) ) (!  (not (=> (> i_1_1 0) (otherDummy Heap@@15 i_1_1)))
 :qid |stdinbpl.289:17|
 :skolemid |28|
 :pattern ( (|thirdDummy#frame| EmptyFrame i_1_1))
))) (= (ControlFlow 0 13) 11)) anon7_correct)))
(let ((anon15_Then_correct  (=> (exists ((i_1_1@@0 Int) ) (!  (not (=> (> i_1_1@@0 0) (otherDummy Heap@@15 i_1_1@@0)))
 :qid |stdinbpl.289:17|
 :skolemid |28|
 :pattern ( (|thirdDummy#frame| EmptyFrame i_1_1@@0))
)) (=> (and (not b_2) (= (ControlFlow 0 12) 11)) anon7_correct))))
(let ((anon14_Then_correct true))
(let ((anon4_correct true))
(let ((anon13_Then_correct  (=> (> i_1 0) (and (=> (= (ControlFlow 0 4) 3) anon14_Then_correct) (=> (= (ControlFlow 0 4) 1) anon4_correct)))))
(let ((anon13_Else_correct  (=> (and (>= 0 i_1) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (and (and (=> (= (ControlFlow 0 14) 12) anon15_Then_correct) (=> (= (ControlFlow 0 14) 13) anon15_Else_correct)) (=> (= (ControlFlow 0 14) 4) anon13_Then_correct)) (=> (= (ControlFlow 0 14) 2) anon13_Else_correct)))))
