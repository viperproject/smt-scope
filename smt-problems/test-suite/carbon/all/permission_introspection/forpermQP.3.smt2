...
(declare-fun a_17 () T@U)
(declare-fun Heap@@11 () T@U)
(declare-fun x@@31 () T@U)
(declare-fun neverTriggered5 (T@U) Bool)
(declare-fun y@@12 () T@U)
(declare-fun invRecv5 (T@U T@U) T@U)
(declare-fun qpRange5 (T@U T@U) Bool)
(assert  (and (and (and (and (and (= (type QPMask@0) (MapType2Type RefType realType)) (= (type Heap@@11) (MapType0Type RefType))) (= (type x@@31) RefType)) (= (type a_17) RefType)) (= (type y@@12) RefType)) (forall ((arg0@@53 T@U) (arg1@@47 T@U) ) (! (= (type (invRecv5 arg0@@53 arg1@@47)) RefType)
 :qid |funType:invRecv5|
 :pattern ( (invRecv5 arg0@@53 arg1@@47))
))))
...
(let ((anon9_Else_correct  (=> (and (not (HasDirectPerm QPMask@0 null (p2 a_17 a_17))) (= (ControlFlow 0 7) 4)) anon5_correct)))
(let ((anon9_Then_correct  (=> (HasDirectPerm QPMask@0 null (p2 a_17 a_17)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm QPMask@0 null (p2 a_17 a_17))) (=> (HasDirectPerm QPMask@0 null (p2 a_17 a_17)) (=> (= (ControlFlow 0 5) 4) anon5_correct))))))
(let ((anon8_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((a_4 T@U) ) (!  (=> (and (= (type a_4) RefType) (HasDirectPerm QPMask@0 null (p2 a_4 a_4))) (= a_4 x@@31))
 :qid |stdinbpl.1346:15|
 :skolemid |148|
 :pattern ( (MapType2Select QPMask@0 null (p2 a_4 a_4)))
 :pattern ( (MapType0Select Heap@@11 null (p2 a_4 a_4)))
)))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (forall ((a_1 T@U) (a_1_1 T@U) ) (!  (=> (and (= (type a_1) RefType) (= (type a_1_1) RefType)) (=> (and (and (and (and (not (= a_1 a_1_1)) (or (= a_1 x@@31) (= a_1 y@@12))) (or (= a_1_1 x@@31) (= a_1_1 y@@12))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_1 a_1_1)) (not (= x@@31 x@@31)))))
 :qid |stdinbpl.1293:17|
 :skolemid |142|
 :pattern ( (neverTriggered5 a_1) (neverTriggered5 a_1_1))
))) (=> (forall ((a_1@@0 T@U) (a_1_1@@0 T@U) ) (!  (=> (and (= (type a_1@@0) RefType) (= (type a_1_1@@0) RefType)) (=> (and (and (and (and (not (= a_1@@0 a_1_1@@0)) (or (= a_1@@0 x@@31) (= a_1@@0 y@@12))) (or (= a_1_1@@0 x@@31) (= a_1_1@@0 y@@12))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_1@@0 a_1_1@@0)) (not (= x@@31 x@@31)))))
 :qid |stdinbpl.1293:17|
 :skolemid |142|
 :pattern ( (neverTriggered5 a_1@@0) (neverTriggered5 a_1_1@@0))
)) (=> (forall ((a_1@@1 T@U) ) (!  (=> (= (type a_1@@1) RefType) (=> (and (or (= a_1@@1 x@@31) (= a_1@@1 y@@12)) (< NoPerm FullPerm)) (and (= (invRecv5 a_1@@1 x@@31) a_1@@1) (qpRange5 a_1@@1 x@@31))))
 :qid |stdinbpl.1299:22|
 :skolemid |143|
 :pattern ( (MapType0Select Heap@@11 null (p2 a_1@@1 x@@31)))
 :pattern ( (MapType2Select ZeroMask null (p2 a_1@@1 x@@31)))
)) (=> (and (forall ((x_1_1 T@U) (y_1_1 T@U) ) (!  (=> (and (= (type x_1_1) RefType) (= (type y_1_1) RefType)) (=> (and (and (or (= (invRecv5 x_1_1 y_1_1) x@@31) (= (invRecv5 x_1_1 y_1_1) y@@12)) (< NoPerm FullPerm)) (qpRange5 x_1_1 y_1_1)) (and (= (invRecv5 x_1_1 y_1_1) x_1_1) (= x@@31 y_1_1))))
 :qid |stdinbpl.1303:22|
 :skolemid |144|
 :pattern ( (invRecv5 x_1_1 y_1_1))
)) (forall ((x_1_1@@0 T@U) (y_1_1@@0 T@U) ) (!  (=> (and (= (type x_1_1@@0) RefType) (= (type y_1_1@@0) RefType)) (=> (and (and (or (= (invRecv5 x_1_1@@0 y_1_1@@0) x@@31) (= (invRecv5 x_1_1@@0 y_1_1@@0) y@@12)) (< NoPerm FullPerm)) (qpRange5 x_1_1@@0 y_1_1@@0)) (and (=> (< NoPerm FullPerm) (and (= (invRecv5 x_1_1@@0 y_1_1@@0) x_1_1@@0) (= x@@31 y_1_1@@0))) (= (U_2_real (MapType2Select QPMask@0 null (p2 x_1_1@@0 y_1_1@@0))) (+ (U_2_real (MapType2Select ZeroMask null (p2 x_1_1@@0 y_1_1@@0))) FullPerm)))))
 :qid |stdinbpl.1309:22|
 :skolemid |145|
 :pattern ( (MapType2Select QPMask@0 null (p2 x_1_1@@0 y_1_1@@0)))
))) (=> (and (and (and (forall ((o_3 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (or (or (not (= o_3 null)) (not (IsPredicateField f_5))) (not (= (getPredWandId f_5) 1)))) (= (U_2_real (MapType2Select ZeroMask o_3 f_5)) (U_2_real (MapType2Select QPMask@0 o_3 f_5))))))
 :qid |stdinbpl.1315:29|
 :skolemid |146|
 :pattern ( (MapType2Select ZeroMask o_3 f_5))
 :pattern ( (MapType2Select QPMask@0 o_3 f_5))
)) (forall ((x_1_1@@1 T@U) (y_1_1@@1 T@U) ) (!  (=> (and (and (= (type x_1_1@@1) RefType) (= (type y_1_1@@1) RefType)) (not (and (and (or (= (invRecv5 x_1_1@@1 y_1_1@@1) x@@31) (= (invRecv5 x_1_1@@1 y_1_1@@1) y@@12)) (< NoPerm FullPerm)) (qpRange5 x_1_1@@1 y_1_1@@1)))) (= (U_2_real (MapType2Select QPMask@0 null (p2 x_1_1@@1 y_1_1@@1))) (U_2_real (MapType2Select ZeroMask null (p2 x_1_1@@1 y_1_1@@1)))))
 :qid |stdinbpl.1319:22|
 :skolemid |147|
 :pattern ( (MapType2Select QPMask@0 null (p2 x_1_1@@1 y_1_1@@1)))
))) (and (state Heap@@11 QPMask@0) (state Heap@@11 QPMask@0))) (and (and (state Heap@@11 QPMask@0) (not (= x@@31 y@@12))) (and (state Heap@@11 QPMask@0) (state Heap@@11 QPMask@0)))) (and (and (=> (= (ControlFlow 0 8) 3) anon8_Else_correct) (=> (= (ControlFlow 0 8) 5) anon9_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct)))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@11 x@@31 $allocated)) (U_2_bool (MapType0Select Heap@@11 y@@12 $allocated))) (and (=> (= (ControlFlow 0 10) 1) anon7_Then_correct) (=> (= (ControlFlow 0 10) 8) anon7_Else_correct))))))
