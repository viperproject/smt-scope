...
(assert  (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type this) RefType)) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id loopExpressionTrue)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon7_correct true))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon7_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@1 this x@@8)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 this x@@8))) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))
(let ((anon13_Then_correct  (=> (state ExhaleHeap@0 ZeroMask) (=> (and (and (and (not (= this null)) (= Mask@1 (MapType1Store ZeroMask this x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this x@@8)) FullPerm))))) (and (state ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1))) (and (and (< i@0 10) (state ExhaleHeap@0 Mask@1)) (and (= i@1 (+ i@0 1)) (state ExhaleHeap@0 Mask@1)))) (and (=> (= (ControlFlow 0 12) 9) anon14_Then_correct) (=> (= (ControlFlow 0 12) 11) anon14_Else_correct))))))
(let ((anon10_correct true))
(let ((anon15_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon10_correct)))
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@2 this x@@8)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 this x@@8))) (=> (= (ControlFlow 0 4) 3) anon10_correct))))))
(let ((anon13_Else_correct  (=> (not (< i@0 10)) (=> (and (state ExhaleHeap@0 ZeroMask) (not (= this null))) (=> (and (and (= Mask@2 (MapType1Store ZeroMask this x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this x@@8)) FullPerm)))) (state ExhaleHeap@0 Mask@2)) (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2))) (and (=> (= (ControlFlow 0 7) 4) anon15_Then_correct) (=> (= (ControlFlow 0 7) 6) anon15_Else_correct)))))))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (=> (and (state Heap@@9 ZeroMask) (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 ZeroMask)) (and (and (=> (= (ControlFlow 0 13) 2) anon12_Then_correct) (=> (= (ControlFlow 0 13) 12) anon13_Then_correct)) (=> (= (ControlFlow 0 13) 7) anon13_Else_correct)))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 this $allocated))) (and (=> (= (ControlFlow 0 14) 1) anon11_Then_correct) (=> (= (ControlFlow 0 14) 13) anon11_Else_correct)))))
