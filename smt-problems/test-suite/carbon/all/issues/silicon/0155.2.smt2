...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@14 this@@9 $allocated)) (not (= this@@9 null))) (and (= Mask@0 (MapType1Store ZeroMask this@@9 next (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@9 next)) FullPerm)))) (state Heap@@14 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 this@@9 next)) (=> (HasDirectPerm Mask@0 this@@9 next) (=> (and (not (= (MapType0Select Heap@@14 this@@9 next) null)) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm Mask@0 this@@9 next))))))))
