...
(assert  (and (and (and (and (and (= (type matrix) (SeqType RefType)) (= (type PostHeap@0) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@41) (MapType0Type RefType))) (= (type diz) RefType)))
(set-info :boogie-vc-id Ref__loop_main_38)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 55) (let ((anon54_Then_correct  (and (=> (= (ControlFlow 0 35) (- 0 40)) (<= 0 i_2)) (=> (<= 0 i_2) (and (=> (= (ControlFlow 0 35) (- 0 39)) (< i_2 M)) (=> (< i_2 M) (and (=> (= (ControlFlow 0 35) (- 0 38)) (<= 0 M)) (=> (<= 0 M) (and (=> (= (ControlFlow 0 35) (- 0 37)) (<= 0 j_12)) (=> (<= 0 j_12) (and (=> (= (ControlFlow 0 35) (- 0 36)) (< j_12 step@@9)) (=> (< j_12 step@@9) (=> (= (ControlFlow 0 35) (- 0 34)) (<= 0 step@@9))))))))))))))
(let ((anon28_correct true))
(let ((anon54_Else_correct  (and (=> (= (ControlFlow 0 41) (- 0 44)) (>= (Ref__multidim_index_2 PostHeap@0 M step@@9 i_2 j_12) 0)) (=> (>= (Ref__multidim_index_2 PostHeap@0 M step@@9 i_2 j_12) 0) (and (=> (= (ControlFlow 0 41) (- 0 43)) (< (Ref__multidim_index_2 PostHeap@0 M step@@9 i_2 j_12) (|Seq#Length| matrix))) (=> (< (Ref__multidim_index_2 PostHeap@0 M step@@9 i_2 j_12) (|Seq#Length| matrix)) (and (=> (= (ControlFlow 0 41) (- 0 42)) (HasDirectPerm QPMask@1 (|Seq#Index| matrix (Ref__multidim_index_2 PostHeap@0 M step@@9 i_2 j_12)) Ref__Integer_value)) (=> (HasDirectPerm QPMask@1 (|Seq#Index| matrix (Ref__multidim_index_2 PostHeap@0 M step@@9 i_2 j_12)) Ref__Integer_value) (=> (= (ControlFlow 0 41) 32) anon28_correct)))))))))
(let ((anon53_Then_correct  (=> (and (<= 0 i_2) (and (< i_2 M) (and (<= 0 j_12) (< j_12 N)))) (and (=> (= (ControlFlow 0 45) 35) anon54_Then_correct) (=> (= (ControlFlow 0 45) 41) anon54_Else_correct)))))
(let ((anon53_Else_correct  (=> (and (not (and (<= 0 i_2) (and (< i_2 M) (and (<= 0 j_12) (< j_12 N))))) (= (ControlFlow 0 33) 32)) anon28_correct)))
(let ((anon52_Else_correct true))
(let ((anon48_Else_correct  (and (=> (= (ControlFlow 0 46) (- 0 47)) (forall ((j_5 Int) (j_5_2 Int) ) (!  (=> (and (and (and (and (not (= j_5 j_5_2)) (and (<= 0 j_5) (and (< j_5 (* M step@@9)) (< (mod j_5 step@@9) N)))) (and (<= 0 j_5_2) (and (< j_5_2 (* M step@@9)) (< (mod j_5_2 step@@9) N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| matrix j_5) (|Seq#Index| matrix j_5_2))))
 :qid |stdinbpl.2091:15|
 :skolemid |175|
 ...
 :qid |stdinbpl.2091:15|
 :skolemid |175|
)) (=> (and (and (and (forall ((j_5@@1 Int) ) (!  (=> (and (and (<= 0 j_5@@1) (and (< j_5@@1 (* M step@@9)) (< (mod j_5@@1 step@@9) N))) (< NoPerm FullPerm)) (and (qpRange10 (|Seq#Index| matrix j_5@@1)) (= (invRecv10 (|Seq#Index| matrix j_5@@1)) j_5@@1)))
 :qid |stdinbpl.2097:22|
 :skolemid |176|
 :pattern ( (|Seq#Index| matrix j_5@@1))
 :pattern ( (|Seq#Index| matrix j_5@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv10 o_3)) (and (< (invRecv10 o_3) (* M step@@9)) (< (mod (invRecv10 o_3) step@@9) N))) (< NoPerm FullPerm)) (qpRange10 o_3)) (= (|Seq#Index| matrix (invRecv10 o_3)) o_3)))
 :qid |stdinbpl.2101:22|
 :skolemid |177|
 :pattern ( (invRecv10 o_3))
))) (and (forall ((j_5@@2 Int) ) (!  (=> (and (<= 0 j_5@@2) (and (< j_5@@2 (* M step@@9)) (< (mod j_5@@2 step@@9) N))) (not (= (|Seq#Index| matrix j_5@@2) null)))
 :qid |stdinbpl.2107:22|
 :skolemid |178|
 :pattern ( (|Seq#Index| matrix j_5@@2))
 :pattern ( (|Seq#Index| matrix j_5@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv10 o_3@@0)) (and (< (invRecv10 o_3@@0) (* M step@@9)) (< (mod (invRecv10 o_3@@0) step@@9) N))) (< NoPerm FullPerm)) (qpRange10 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| matrix (invRecv10 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 Ref__Integer_value)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 Ref__Integer_value)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv10 o_3@@0)) (and (< (invRecv10 o_3@@0) (* M step@@9)) (< (mod (invRecv10 o_3@@0) step@@9) N))) (< NoPerm FullPerm)) (qpRange10 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 Ref__Integer_value)) (U_2_real (MapType1Select ZeroMask o_3@@0 Ref__Integer_value))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 Ref__Integer_value))) (= (U_2_real (MapType1Select ZeroMask o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@1 o_3@@1 f_5))))))
 :qid |stdinbpl.2117:29|
 :skolemid |180|
...
(let ((anon51_Else_correct  (=> (and (not (and (<= 0 j_11) (and (< j_11 (* M step@@9)) (< (mod j_11 step@@9) N)))) (= (ControlFlow 0 25) 21)) anon22_correct)))
(let ((anon51_Then_correct  (=> (and (<= 0 j_11) (and (< j_11 (* M step@@9)) (< (mod j_11 step@@9) N))) (and (=> (= (ControlFlow 0 22) (- 0 24)) (>= j_11 0)) (=> (>= j_11 0) (and (=> (= (ControlFlow 0 22) (- 0 23)) (< j_11 (|Seq#Length| matrix))) (=> (< j_11 (|Seq#Length| matrix)) (=> (= (ControlFlow 0 22) 21) anon22_correct))))))))
(let ((anon50_Else_correct  (=> (<= (* M step@@9) j_11) (and (=> (= (ControlFlow 0 29) 22) anon51_Then_correct) (=> (= (ControlFlow 0 29) 25) anon51_Else_correct)))))
(let ((anon50_Then_correct  (=> (< j_11 (* M step@@9)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (not (= step@@9 0))) (=> (not (= step@@9 0)) (and (=> (= (ControlFlow 0 27) 22) anon51_Then_correct) (=> (= (ControlFlow 0 27) 25) anon51_Else_correct)))))))
(let ((anon49_Then_correct  (=> (<= 0 j_11) (and (=> (= (ControlFlow 0 30) 27) anon50_Then_correct) (=> (= (ControlFlow 0 30) 29) anon50_Else_correct)))))
(let ((anon49_Else_correct  (=> (< j_11 0) (and (=> (= (ControlFlow 0 26) 22) anon51_Then_correct) (=> (= (ControlFlow 0 26) 25) anon51_Else_correct)))))
(let ((anon47_Else_correct  (=> (and (and (forall ((i_3 Int) ) (!  (=> (and (<= 0 i_3) (and (< i_3 M) (< 0 N))) (and (> M 0) (and (> N 0) (>= step@@9 N))))
 :qid |stdinbpl.2065:20|
 :skolemid |174|
...
(let ((anon42_Else_correct  (and (=> (= (ControlFlow 0 50) (- 0 51)) (forall ((j_3 Int) (j_3_1 Int) ) (!  (=> (and (and (and (and (not (= j_3 j_3_1)) (and (<= 0 j_3) (and (< j_3 (* M step@@9)) (< (mod j_3 step@@9) N)))) (and (<= 0 j_3_1) (and (< j_3_1 (* M step@@9)) (< (mod j_3_1 step@@9) N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| matrix j_3) (|Seq#Index| matrix j_3_1))))
 :qid |stdinbpl.2016:15|
 :skolemid |168|
))) (=> (forall ((j_3@@0 Int) (j_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_3@@0 j_3_1@@0)) (and (<= 0 j_3@@0) (and (< j_3@@0 (* M step@@9)) (< (mod j_3@@0 step@@9) N)))) (and (<= 0 j_3_1@@0) (and (< j_3_1@@0 (* M step@@9)) (< (mod j_3_1@@0 step@@9) N)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| matrix j_3@@0) (|Seq#Index| matrix j_3_1@@0))))
 :qid |stdinbpl.2016:15|
 :skolemid |168|
)) (=> (forall ((j_3@@1 Int) ) (!  (=> (and (and (<= 0 j_3@@1) (and (< j_3@@1 (* M step@@9)) (< (mod j_3@@1 step@@9) N))) (< NoPerm FullPerm)) (and (qpRange9 (|Seq#Index| matrix j_3@@1)) (= (invRecv9 (|Seq#Index| matrix j_3@@1)) j_3@@1)))
 :qid |stdinbpl.2022:22|
 :skolemid |169|
 :pattern ( (|Seq#Index| matrix j_3@@1))
 :pattern ( (|Seq#Index| matrix j_3@@1))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (<= 0 (invRecv9 o_3@@2)) (and (< (invRecv9 o_3@@2) (* M step@@9)) (< (mod (invRecv9 o_3@@2) step@@9) N))) (< NoPerm FullPerm)) (qpRange9 o_3@@2)) (= (|Seq#Index| matrix (invRecv9 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.2026:22|
 :skolemid |170|
 :pattern ( (invRecv9 o_3@@2))
)) (forall ((j_3@@2 Int) ) (!  (=> (and (<= 0 j_3@@2) (and (< j_3@@2 (* M step@@9)) (< (mod j_3@@2 step@@9) N))) (not (= (|Seq#Index| matrix j_3@@2) null)))
 :qid |stdinbpl.2032:22|
 :skolemid |171|
 :pattern ( (|Seq#Index| matrix j_3@@2))
 :pattern ( (|Seq#Index| matrix j_3@@2))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (and (<= 0 (invRecv9 o_3@@3)) (and (< (invRecv9 o_3@@3) (* M step@@9)) (< (mod (invRecv9 o_3@@3) step@@9) N))) (< NoPerm FullPerm)) (qpRange9 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| matrix (invRecv9 o_3@@3)) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 Ref__Integer_value)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 Ref__Integer_value)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv9 o_3@@3)) (and (< (invRecv9 o_3@@3) (* M step@@9)) (< (mod (invRecv9 o_3@@3) step@@9) N))) (< NoPerm FullPerm)) (qpRange9 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 Ref__Integer_value)) (U_2_real (MapType1Select ZeroMask o_3@@3 Ref__Integer_value))))))
...
))) (and (state Heap@@41 QPMask@0) (state Heap@@41 QPMask@0))) (and (=> (= (ControlFlow 0 50) 49) anon46_Then_correct) (=> (= (ControlFlow 0 50) 19) anon46_Else_correct)))))))))
(let ((anon12_correct true))
(let ((anon45_Else_correct  (=> (and (not (and (<= 0 j_10) (and (< j_10 (* M step@@9)) (< (mod j_10 step@@9) N)))) (= (ControlFlow 0 13) 9)) anon12_correct)))
(let ((anon45_Then_correct  (=> (and (<= 0 j_10) (and (< j_10 (* M step@@9)) (< (mod j_10 step@@9) N))) (and (=> (= (ControlFlow 0 10) (- 0 12)) (>= j_10 0)) (=> (>= j_10 0) (and (=> (= (ControlFlow 0 10) (- 0 11)) (< j_10 (|Seq#Length| matrix))) (=> (< j_10 (|Seq#Length| matrix)) (=> (= (ControlFlow 0 10) 9) anon12_correct))))))))
(let ((anon44_Else_correct  (=> (<= (* M step@@9) j_10) (and (=> (= (ControlFlow 0 17) 10) anon45_Then_correct) (=> (= (ControlFlow 0 17) 13) anon45_Else_correct)))))
(let ((anon44_Then_correct  (=> (< j_10 (* M step@@9)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (not (= step@@9 0))) (=> (not (= step@@9 0)) (and (=> (= (ControlFlow 0 15) 10) anon45_Then_correct) (=> (= (ControlFlow 0 15) 13) anon45_Else_correct)))))))
(let ((anon43_Then_correct  (=> (<= 0 j_10) (and (=> (= (ControlFlow 0 18) 15) anon44_Then_correct) (=> (= (ControlFlow 0 18) 17) anon44_Else_correct)))))
(let ((anon43_Else_correct  (=> (< j_10 0) (and (=> (= (ControlFlow 0 14) 10) anon45_Then_correct) (=> (= (ControlFlow 0 14) 13) anon45_Else_correct)))))
(let ((anon40_Else_correct  (=> (and (forall ((j_1_1 Int) (k_1_1 Int) ) (!  (=> (and (<= 0 j_1_1) (and (< j_1_1 (* M step@@9)) (and (<= 0 k_1_1) (and (< k_1_1 (* M step@@9)) (not (= j_1_1 k_1_1)))))) (not (= (|Seq#Index| matrix j_1_1) (|Seq#Index| matrix k_1_1))))
 :qid |stdinbpl.1992:20|
 :skolemid |167|
 :pattern ( (|Seq#Index| matrix j_1_1) (|Seq#Index| matrix k_1_1))
)) (state Heap@@41 ZeroMask)) (and (and (=> (= (ControlFlow 0 52) 50) anon42_Else_correct) (=> (= (ControlFlow 0 52) 18) anon43_Then_correct)) (=> (= (ControlFlow 0 52) 14) anon43_Else_correct)))))
(let ((anon5_correct true))
(let ((anon41_Else_correct  (=> (and (not (and (<= 0 j_9) (and (< j_9 (* M step@@9)) (and (<= 0 k_13) (and (< k_13 (* M step@@9)) (not (= j_9 k_13))))))) (= (ControlFlow 0 8) 2)) anon5_correct)))
(let ((anon41_Then_correct  (=> (and (<= 0 j_9) (and (< j_9 (* M step@@9)) (and (<= 0 k_13) (and (< k_13 (* M step@@9)) (not (= j_9 k_13)))))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (>= j_9 0)) (=> (>= j_9 0) (and (=> (= (ControlFlow 0 3) (- 0 6)) (< j_9 (|Seq#Length| matrix))) (=> (< j_9 (|Seq#Length| matrix)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (>= k_13 0)) (=> (>= k_13 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< k_13 (|Seq#Length| matrix))) (=> (< k_13 (|Seq#Length| matrix)) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))))))))
(let ((anon39_Else_correct  (=> (and (forall ((i_1 Int) ) (!  (=> (and (<= 0 i_1) (and (< i_1 M) (< 0 N))) (and (> M 0) (and (> N 0) (>= step@@9 N))))
 :qid |stdinbpl.1968:20|
 :skolemid |166|
)) (state Heap@@41 ZeroMask)) (=> (and (and (<= N step@@9) (state Heap@@41 ZeroMask)) (and (<= (* M step@@9) (|Seq#Length| matrix)) (state Heap@@41 ZeroMask))) (and (and (=> (= (ControlFlow 0 53) 52) anon40_Else_correct) (=> (= (ControlFlow 0 53) 3) anon41_Then_correct)) (=> (= (ControlFlow 0 53) 8) anon41_Else_correct))))))
(let ((anon39_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@41 diz $allocated))) (=> (and (and (not (= diz null)) (state Heap@@41 ZeroMask)) (and (>= current_thread_id 0) (state Heap@@41 ZeroMask))) (and (=> (= (ControlFlow 0 54) 1) anon39_Then_correct) (=> (= (ControlFlow 0 54) 53) anon39_Else_correct)))))))
