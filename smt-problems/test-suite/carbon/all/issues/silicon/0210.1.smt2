...
(declare-fun tail$1 () T@U)
(declare-fun Mask@0 () T@U)
(declare-fun Heap@@23 () T@U)
(declare-fun current$1 () T@U)
(declare-fun PostHeap@0 () T@U)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type LoopSumMask@0) (MapType1Type RefType realType))) (= (type list$1) RefType)) (= (type Heap@12) (MapType0Type RefType))) (= (type Mask@22) (MapType1Type RefType realType))) (= (type LoopSumHeap@0) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@9) (MapType0Type RefType))) (= (type current$1@0) RefType)) (= (type Heap@10) (MapType0Type RefType))) (= (type Heap@11) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@6) (MapType0Type RefType))) (= (type Heap@7) (MapType0Type RefType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@8) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@21) (MapType1Type RefType realType))) (forall ((arg0@@29 T@U) (arg1@@10 T@U) ) (! (= (type (CombineFrames arg0@@29 arg1@@10)) FrameTypeType)
...
(let ((anon67_Then_correct  (=> (not (= rd$1 NoPerm)) (and (=> (= (ControlFlow 0 60) (- 0 61)) (<= rd$1 (U_2_real (MapType1Select Mask@13 null (valid__List tail$1@0))))) (=> (<= rd$1 (U_2_real (MapType1Select Mask@13 null (valid__List tail$1@0)))) (=> (= (ControlFlow 0 60) 59) anon43_correct))))))
(let ((anon55_Then_correct  (=> (and (and (= (variantOfList (MapType0Select Heap@1 current$1@0 List__variant)) fn$$List__Node) (= counter$1@1 (+ counter$1@0 1))) (and (state Heap@1 Mask@13) (state Heap@1 Mask@13))) (and (=> (= (ControlFlow 0 63) (- 0 65)) (< NoPerm (U_2_real (MapType1Select Mask@13 null (valid__List tail$1@0))))) (=> (< NoPerm (U_2_real (MapType1Select Mask@13 null (valid__List tail$1@0)))) (=> (state Heap@1 Mask@13) (=> (and (state Heap@1 Mask@13) (state Heap@1 Mask@13)) (and (=> (= (ControlFlow 0 63) (- 0 64)) (>= rd$1 NoPerm)) (=> (>= rd$1 NoPerm) (and (=> (= (ControlFlow 0 63) 60) anon67_Then_correct) (=> (= (ControlFlow 0 63) 62) anon67_Else_correct)))))))))))
(let ((anon46_correct true))
(let ((anon68_Else_correct  (=> (and (= rd$1 NoPerm) (= (ControlFlow 0 10) 7)) anon46_correct)))
(let ((anon68_Then_correct  (=> (not (= rd$1 NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= rd$1 (U_2_real (MapType1Select LoopSumMask@0 null (valid__List list$1))))) (=> (<= rd$1 (U_2_real (MapType1Select LoopSumMask@0 null (valid__List list$1)))) (=> (= (ControlFlow 0 8) 7) anon46_correct))))))
...
(let ((anon66_Else_correct  (=> (not (= (variantOfList (MapType0Select Heap@9 current$1@0 List__variant)) fn$$List__Nil)) (=> (and (= Heap@12 Heap@9) (= (ControlFlow 0 14) 11)) anon39_correct))))
(let ((anon66_Then_correct  (=> (= (variantOfList (MapType0Select Heap@9 current$1@0 List__variant)) fn$$List__Nil) (=> (and (and (= Heap@10 (MapType0Store Heap@9 null (|valid__List#sm| current$1@0) (MapType1Store (MapType0Select Heap@9 null (|valid__List#sm| current$1@0)) current$1@0 List__Node__0 (bool_2_U true)))) (= Heap@11 (MapType0Store Heap@10 null (|valid__List#sm| current$1@0) (MapType1Store (MapType0Select Heap@10 null (|valid__List#sm| current$1@0)) current$1@0 List__Node__1 (bool_2_U true))))) (and (= Heap@12 Heap@11) (= (ControlFlow 0 13) 11))) anon39_correct))))
(let ((anon65_Else_correct  (=> (and (not (= (variantOfList (MapType0Select Heap@5 current$1@0 List__variant)) fn$$List__Node)) (= Heap@9 Heap@5)) (and (=> (= (ControlFlow 0 16) 13) anon66_Then_correct) (=> (= (ControlFlow 0 16) 14) anon66_Else_correct)))))
(let ((anon65_Then_correct  (=> (and (= (variantOfList (MapType0Select Heap@5 current$1@0 List__variant)) fn$$List__Node) (= Heap@6 (MapType0Store Heap@5 null (|valid__List#sm| current$1@0) (MapType1Store (MapType0Select Heap@5 null (|valid__List#sm| current$1@0)) current$1@0 List__Node__0 (bool_2_U true))))) (=> (and (and (= Heap@7 (MapType0Store Heap@6 null (|valid__List#sm| current$1@0) (MapType1Store (MapType0Select Heap@6 null (|valid__List#sm| current$1@0)) current$1@0 List__Node__1 (bool_2_U true)))) (forall ((o_5 T@U) (f_9 T@U) ) (! (let ((B@@16 (FieldTypeInv1 (type f_9))))
(let ((A@@17 (FieldTypeInv0 (type f_9))))
 (=> (and (and (= (type o_5) RefType) (= (type f_9) (FieldType A@@17 B@@16))) (or (U_2_bool (MapType1Select (MapType0Select Heap@7 null (|valid__List#sm| current$1@0)) o_5 f_9)) (U_2_bool (MapType1Select (MapType0Select Heap@7 null (|valid__List#sm| (MapType0Select Heap@7 current$1@0 List__Node__1))) o_5 f_9)))) (U_2_bool (MapType1Select newPMask@0 o_5 f_9)))))
 :qid |stdinbpl.893:41|
 :skolemid |48|
 :pattern ( (MapType1Select newPMask@0 o_5 f_9))
))) (and (= Heap@8 (MapType0Store Heap@7 null (|valid__List#sm| current$1@0) newPMask@0)) (= Heap@9 Heap@8))) (and (=> (= (ControlFlow 0 15) 13) anon66_Then_correct) (=> (= (ControlFlow 0 15) 14) anon66_Else_correct))))))
(let ((anon35_correct  (=> (= Heap@5 (MapType0Store Heap@4 null (|valid__List#sm| current$1@0) (MapType1Store (MapType0Select Heap@4 null (|valid__List#sm| current$1@0)) current$1@0 List__variant (bool_2_U true)))) (and (=> (= (ControlFlow 0 17) 15) anon65_Then_correct) (=> (= (ControlFlow 0 17) 16) anon65_Else_correct)))))
(let ((anon64_Else_correct  (=> (HasDirectPerm Mask@22 null (valid__List current$1@0)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 19) 17)) anon35_correct))))
(let ((anon64_Then_correct  (=> (not (HasDirectPerm Mask@22 null (valid__List current$1@0))) (=> (and (and (= Heap@2 (MapType0Store Heap@1 null (|valid__List#sm| current$1@0) ZeroPMask)) (= Heap@3 (MapType0Store Heap@2 null (valid__List current$1@0) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 18) 17))) anon35_correct))))
(let ((anon33_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (>= rd$1 NoPerm)) (=> (>= rd$1 NoPerm) (=> (= Mask@22 (MapType1Store Mask@21 null (valid__List current$1@0) (real_2_U (+ (U_2_real (MapType1Select Mask@21 null (valid__List current$1@0))) rd$1)))) (=> (and (and (state Heap@1 Mask@22) (state Heap@1 Mask@22)) (and (|valid__List#trigger| Heap@1 (valid__List current$1@0)) (= (MapType0Select Heap@1 null (valid__List current$1@0)) (CombineFrames (FrameFragment (MapType0Select Heap@1 current$1@0 List__variant)) (CombineFrames (FrameFragment (ite (= (variantOfList (MapType0Select Heap@1 current$1@0 List__variant)) fn$$List__Node) (CombineFrames (FrameFragment (MapType0Select Heap@1 current$1@0 List__Node__0)) (CombineFrames (FrameFragment (MapType0Select Heap@1 current$1@0 List__Node__1)) (MapType0Select Heap@1 null (valid__List (MapType0Select Heap@1 current$1@0 List__Node__1))))) EmptyFrame)) (FrameFragment (ite (= (variantOfList (MapType0Select Heap@1 current$1@0 List__variant)) fn$$List__Nil) (CombineFrames (FrameFragment (MapType0Select Heap@1 current$1@0 List__Node__0)) (FrameFragment (MapType0Select Heap@1 current$1@0 List__Node__1))) EmptyFrame))))))) (and (=> (= (ControlFlow 0 20) 18) anon64_Then_correct) (=> (= (ControlFlow 0 20) 19) anon64_Else_correct))))))))
(let ((anon32_correct  (=> (= Mask@20 (MapType1Store Mask@19 current$1@0 List__Node__1 (real_2_U (- (U_2_real (MapType1Select Mask@19 current$1@0 List__Node__1)) perm@11)))) (=> (and (= Mask@21 Mask@20) (= (ControlFlow 0 23) 20)) anon33_correct))))
(let ((anon63_Else_correct  (=> (and (= perm@11 NoPerm) (= (ControlFlow 0 26) 23)) anon32_correct)))
(let ((anon63_Then_correct  (=> (not (= perm@11 NoPerm)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (<= perm@11 (U_2_real (MapType1Select Mask@19 current$1@0 List__Node__1)))) (=> (<= perm@11 (U_2_real (MapType1Select Mask@19 current$1@0 List__Node__1))) (=> (= (ControlFlow 0 24) 23) anon32_correct))))))
(let ((anon30_correct  (=> (and (= Mask@19 (MapType1Store Mask@18 current$1@0 List__Node__0 (real_2_U (- (U_2_real (MapType1Select Mask@18 current$1@0 List__Node__0)) perm@10)))) (= perm@11 (* FullPerm rd$1))) (and (=> (= (ControlFlow 0 27) (- 0 28)) (>= perm@11 NoPerm)) (=> (>= perm@11 NoPerm) (and (=> (= (ControlFlow 0 27) 24) anon63_Then_correct) (=> (= (ControlFlow 0 27) 26) anon63_Else_correct)))))))
(let ((anon62_Else_correct  (=> (and (= perm@10 NoPerm) (= (ControlFlow 0 31) 27)) anon30_correct)))
(let ((anon62_Then_correct  (=> (not (= perm@10 NoPerm)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (<= perm@10 (U_2_real (MapType1Select Mask@18 current$1@0 List__Node__0)))) (=> (<= perm@10 (U_2_real (MapType1Select Mask@18 current$1@0 List__Node__0))) (=> (= (ControlFlow 0 29) 27) anon30_correct))))))
(let ((anon61_Then_correct  (=> (and (= (variantOfList (MapType0Select Heap@1 current$1@0 List__variant)) fn$$List__Nil) (= perm@10 (* FullPerm rd$1))) (and (=> (= (ControlFlow 0 32) (- 0 33)) (>= perm@10 NoPerm)) (=> (>= perm@10 NoPerm) (and (=> (= (ControlFlow 0 32) 29) anon62_Then_correct) (=> (= (ControlFlow 0 32) 31) anon62_Else_correct)))))))
(let ((anon61_Else_correct  (=> (not (= (variantOfList (MapType0Select Heap@1 current$1@0 List__variant)) fn$$List__Nil)) (=> (and (= Mask@21 Mask@18) (= (ControlFlow 0 22) 20)) anon33_correct))))
(let ((anon26_correct  (=> (= Mask@17 (MapType1Store Mask@16 null (valid__List (MapType0Select Heap@1 current$1@0 List__Node__1)) (real_2_U (- (U_2_real (MapType1Select Mask@16 null (valid__List (MapType0Select Heap@1 current$1@0 List__Node__1)))) perm@9)))) (=> (and (InsidePredicate (valid__List current$1@0) (MapType0Select Heap@1 null (valid__List current$1@0)) (valid__List (MapType0Select Heap@1 current$1@0 List__Node__1)) (MapType0Select Heap@1 null (valid__List (MapType0Select Heap@1 current$1@0 List__Node__1)))) (= Mask@18 Mask@17)) (and (=> (= (ControlFlow 0 35) 32) anon61_Then_correct) (=> (= (ControlFlow 0 35) 22) anon61_Else_correct))))))
(let ((anon60_Else_correct  (=> (and (= perm@9 NoPerm) (= (ControlFlow 0 38) 35)) anon26_correct)))
(let ((anon60_Then_correct  (=> (not (= perm@9 NoPerm)) (and (=> (= (ControlFlow 0 36) (- 0 37)) (<= perm@9 (U_2_real (MapType1Select Mask@16 null (valid__List (MapType0Select Heap@1 current$1@0 List__Node__1)))))) (=> (<= perm@9 (U_2_real (MapType1Select Mask@16 null (valid__List (MapType0Select Heap@1 current$1@0 List__Node__1))))) (=> (= (ControlFlow 0 36) 35) anon26_correct))))))
(let ((anon24_correct  (=> (and (= Mask@16 (MapType1Store Mask@15 current$1@0 List__Node__1 (real_2_U (- (U_2_real (MapType1Select Mask@15 current$1@0 List__Node__1)) perm@8)))) (= perm@9 (* FullPerm rd$1))) (and (=> (= (ControlFlow 0 39) (- 0 40)) (>= perm@9 NoPerm)) (=> (>= perm@9 NoPerm) (and (=> (= (ControlFlow 0 39) 36) anon60_Then_correct) (=> (= (ControlFlow 0 39) 38) anon60_Else_correct)))))))
(let ((anon59_Else_correct  (=> (and (= perm@8 NoPerm) (= (ControlFlow 0 43) 39)) anon24_correct)))
(let ((anon59_Then_correct  (=> (not (= perm@8 NoPerm)) (and (=> (= (ControlFlow 0 41) (- 0 42)) (<= perm@8 (U_2_real (MapType1Select Mask@15 current$1@0 List__Node__1)))) (=> (<= perm@8 (U_2_real (MapType1Select Mask@15 current$1@0 List__Node__1))) (=> (= (ControlFlow 0 41) 39) anon24_correct))))))
(let ((anon22_correct  (=> (and (= Mask@15 (MapType1Store Mask@14 current$1@0 List__Node__0 (real_2_U (- (U_2_real (MapType1Select Mask@14 current$1@0 List__Node__0)) perm@7)))) (= perm@8 (* FullPerm rd$1))) (and (=> (= (ControlFlow 0 44) (- 0 45)) (>= perm@8 NoPerm)) (=> (>= perm@8 NoPerm) (and (=> (= (ControlFlow 0 44) 41) anon59_Then_correct) (=> (= (ControlFlow 0 44) 43) anon59_Else_correct)))))))
(let ((anon58_Else_correct  (=> (and (= perm@7 NoPerm) (= (ControlFlow 0 48) 44)) anon22_correct)))
(let ((anon58_Then_correct  (=> (not (= perm@7 NoPerm)) (and (=> (= (ControlFlow 0 46) (- 0 47)) (<= perm@7 (U_2_real (MapType1Select Mask@14 current$1@0 List__Node__0)))) (=> (<= perm@7 (U_2_real (MapType1Select Mask@14 current$1@0 List__Node__0))) (=> (= (ControlFlow 0 46) 44) anon22_correct))))))
(let ((anon57_Then_correct  (=> (and (= (variantOfList (MapType0Select Heap@1 current$1@0 List__variant)) fn$$List__Node) (= perm@7 (* FullPerm rd$1))) (and (=> (= (ControlFlow 0 49) (- 0 50)) (>= perm@7 NoPerm)) (=> (>= perm@7 NoPerm) (and (=> (= (ControlFlow 0 49) 46) anon58_Then_correct) (=> (= (ControlFlow 0 49) 48) anon58_Else_correct)))))))
(let ((anon57_Else_correct  (=> (and (not (= (variantOfList (MapType0Select Heap@1 current$1@0 List__variant)) fn$$List__Node)) (= Mask@18 Mask@14)) (and (=> (= (ControlFlow 0 34) 32) anon61_Then_correct) (=> (= (ControlFlow 0 34) 22) anon61_Else_correct)))))
(let ((anon19_correct  (=> (= Mask@14 (MapType1Store Mask@13 current$1@0 List__variant (real_2_U (- (U_2_real (MapType1Select Mask@13 current$1@0 List__variant)) perm@6)))) (and (=> (= (ControlFlow 0 51) (- 0 52)) (isList (MapType0Select Heap@1 current$1@0 List__variant))) (=> (isList (MapType0Select Heap@1 current$1@0 List__variant)) (and (=> (= (ControlFlow 0 51) 49) anon57_Then_correct) (=> (= (ControlFlow 0 51) 34) anon57_Else_correct)))))))
(let ((anon56_Else_correct  (=> (and (= perm@6 NoPerm) (= (ControlFlow 0 55) 51)) anon19_correct)))
(let ((anon56_Then_correct  (=> (not (= perm@6 NoPerm)) (and (=> (= (ControlFlow 0 53) (- 0 54)) (<= perm@6 (U_2_real (MapType1Select Mask@13 current$1@0 List__variant)))) (=> (<= perm@6 (U_2_real (MapType1Select Mask@13 current$1@0 List__variant))) (=> (= (ControlFlow 0 53) 51) anon19_correct))))))
(let ((anon55_Else_correct  (=> (not (= (variantOfList (MapType0Select Heap@1 current$1@0 List__variant)) fn$$List__Node)) (and (=> (= (ControlFlow 0 56) (- 0 58)) (> rd$1 NoPerm)) (=> (> rd$1 NoPerm) (=> (= perm@6 (* FullPerm rd$1)) (and (=> (= (ControlFlow 0 56) (- 0 57)) (>= perm@6 NoPerm)) (=> (>= perm@6 NoPerm) (and (=> (= (ControlFlow 0 56) 53) anon56_Then_correct) (=> (= (ControlFlow 0 56) 55) anon56_Else_correct))))))))))
(let ((anon15_correct  (=> (state Heap@1 Mask@13) (=> (and (state Heap@1 Mask@13) (state Heap@1 Mask@13)) (and (=> (= (ControlFlow 0 66) (- 0 68)) (HasDirectPerm Mask@13 current$1@0 List__Node__1)) (=> (HasDirectPerm Mask@13 current$1@0 List__Node__1) (=> (and (= tail$1@0 (MapType0Select Heap@1 current$1@0 List__Node__1)) (state Heap@1 Mask@13)) (and (=> (= (ControlFlow 0 66) (- 0 67)) (HasDirectPerm Mask@13 current$1@0 List__variant)) (=> (HasDirectPerm Mask@13 current$1@0 List__variant) (and (=> (= (ControlFlow 0 66) 63) anon55_Then_correct) (=> (= (ControlFlow 0 66) 56) anon55_Else_correct)))))))))))
(let ((anon54_Else_correct  (=> (not (= (variantOfList (MapType0Select Heap@1 current$1@0 List__variant)) fn$$List__Nil)) (=> (and (= Mask@13 Mask@10) (= (ControlFlow 0 72) 66)) anon15_correct))))
(let ((anon54_Then_correct  (=> (and (= (variantOfList (MapType0Select Heap@1 current$1@0 List__variant)) fn$$List__Nil) (= perm@4 (* FullPerm rd$1))) (and (=> (= (ControlFlow 0 69) (- 0 71)) (>= perm@4 NoPerm)) (=> (>= perm@4 NoPerm) (=> (and (and (=> (> perm@4 NoPerm) (not (= current$1@0 null))) (= Mask@11 (MapType1Store Mask@10 current$1@0 List__Node__0 (real_2_U (+ (U_2_real (MapType1Select Mask@10 current$1@0 List__Node__0)) perm@4))))) (and (state Heap@1 Mask@11) (= perm@5 (* FullPerm rd$1)))) (and (=> (= (ControlFlow 0 69) (- 0 70)) (>= perm@5 NoPerm)) (=> (>= perm@5 NoPerm) (=> (=> (> perm@5 NoPerm) (not (= current$1@0 null))) (=> (and (and (= Mask@12 (MapType1Store Mask@11 current$1@0 List__Node__1 (real_2_U (+ (U_2_real (MapType1Select Mask@11 current$1@0 List__Node__1)) perm@5)))) (state Heap@1 Mask@12)) (and (= Mask@13 Mask@12) (= (ControlFlow 0 69) 66))) anon15_correct))))))))))
(let ((anon53_Else_correct  (=> (and (not (= (variantOfList (MapType0Select Heap@1 current$1@0 List__variant)) fn$$List__Node)) (= Mask@10 Mask@6)) (and (=> (= (ControlFlow 0 77) 69) anon54_Then_correct) (=> (= (ControlFlow 0 77) 72) anon54_Else_correct)))))
(let ((anon53_Then_correct  (=> (and (= (variantOfList (MapType0Select Heap@1 current$1@0 List__variant)) fn$$List__Node) (= perm@1 (* FullPerm rd$1))) (and (=> (= (ControlFlow 0 73) (- 0 76)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (and (=> (> perm@1 NoPerm) (not (= current$1@0 null))) (= Mask@7 (MapType1Store Mask@6 current$1@0 List__Node__0 (real_2_U (+ (U_2_real (MapType1Select Mask@6 current$1@0 List__Node__0)) perm@1))))) (and (state Heap@1 Mask@7) (= perm@2 (* FullPerm rd$1)))) (and (=> (= (ControlFlow 0 73) (- 0 75)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (and (and (=> (> perm@2 NoPerm) (not (= current$1@0 null))) (= Mask@8 (MapType1Store Mask@7 current$1@0 List__Node__1 (real_2_U (+ (U_2_real (MapType1Select Mask@7 current$1@0 List__Node__1)) perm@2))))) (and (state Heap@1 Mask@8) (= perm@3 (* FullPerm rd$1)))) (and (=> (= (ControlFlow 0 73) (- 0 74)) (>= perm@3 NoPerm)) (=> (>= perm@3 NoPerm) (=> (and (and (= Mask@9 (MapType1Store Mask@8 null (valid__List (MapType0Select Heap@1 current$1@0 List__Node__1)) (real_2_U (+ (U_2_real (MapType1Select Mask@8 null (valid__List (MapType0Select Heap@1 current$1@0 List__Node__1)))) perm@3)))) (InsidePredicate (valid__List current$1@0) (MapType0Select Heap@1 null (valid__List current$1@0)) (valid__List (MapType0Select Heap@1 current$1@0 List__Node__1)) (MapType0Select Heap@1 null (valid__List (MapType0Select Heap@1 current$1@0 List__Node__1))))) (and (state Heap@1 Mask@9) (= Mask@10 Mask@9))) (and (=> (= (ControlFlow 0 73) 69) anon54_Then_correct) (=> (= (ControlFlow 0 73) 72) anon54_Else_correct))))))))))))))
(let ((anon11_correct  (=> (= perm@0 (* FullPerm rd$1)) (and (=> (= (ControlFlow 0 78) (- 0 79)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= current$1@0 null))) (= Mask@6 (MapType1Store Mask@5 current$1@0 List__variant (real_2_U (+ (U_2_real (MapType1Select Mask@5 current$1@0 List__variant)) perm@0))))) (and (state Heap@1 Mask@6) (isList (MapType0Select Heap@1 current$1@0 List__variant)))) (and (=> (= (ControlFlow 0 78) 73) anon53_Then_correct) (=> (= (ControlFlow 0 78) 77) anon53_Else_correct))))))))
(let ((anon52_Else_correct  (=> (HasDirectPerm Mask@5 null (valid__List current$1@0)) (=> (and (= Heap@1 ExhaleHeap@0) (= (ControlFlow 0 81) 78)) anon11_correct))))
(let ((anon52_Then_correct  (=> (and (and (not (HasDirectPerm Mask@5 null (valid__List current$1@0))) (= Heap@0 (MapType0Store ExhaleHeap@0 null (valid__List current$1@0) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 80) 78))) anon11_correct)))
(let ((anon9_correct  (=> (= Mask@5 (MapType1Store Mask@3 null (valid__List current$1@0) (real_2_U (- (U_2_real (MapType1Select Mask@3 null (valid__List current$1@0))) rd$1)))) (and (=> (= (ControlFlow 0 82) 80) anon52_Then_correct) (=> (= (ControlFlow 0 82) 81) anon52_Else_correct)))))
(let ((anon51_Else_correct  (=> (and (= rd$1 NoPerm) (= (ControlFlow 0 85) 82)) anon9_correct)))
(let ((anon51_Then_correct  (=> (not (= rd$1 NoPerm)) (and (=> (= (ControlFlow 0 83) (- 0 84)) (<= rd$1 (U_2_real (MapType1Select Mask@3 null (valid__List current$1@0))))) (=> (<= rd$1 (U_2_real (MapType1Select Mask@3 null (valid__List current$1@0)))) (=> (= (ControlFlow 0 83) 82) anon9_correct))))))
(let ((anon50_Then_correct  (=> (state ExhaleHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 86) (- 0 89)) (>= rd$1 NoPerm)) (=> (>= rd$1 NoPerm) (=> (= Mask@3 (MapType1Store ZeroMask null (valid__List current$1@0) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid__List current$1@0))) rd$1)))) (=> (and (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3)) (and (state ExhaleHeap@0 Mask@3) (U_2_bool (MapType0Select ExhaleHeap@0 tail$1 $allocated)))) (and (=> (= (ControlFlow 0 86) (- 0 88)) (> rd$1 NoPerm)) (=> (> rd$1 NoPerm) (=> (and (|valid__List#trigger| ExhaleHeap@0 (valid__List current$1@0)) (= (MapType0Select ExhaleHeap@0 null (valid__List current$1@0)) (CombineFrames (FrameFragment (MapType0Select ExhaleHeap@0 current$1@0 List__variant)) (CombineFrames (FrameFragment (ite (= (variantOfList (MapType0Select ExhaleHeap@0 current$1@0 List__variant)) fn$$List__Node) (CombineFrames (FrameFragment (MapType0Select ExhaleHeap@0 current$1@0 List__Node__0)) (CombineFrames (FrameFragment (MapType0Select ExhaleHeap@0 current$1@0 List__Node__1)) (MapType0Select ExhaleHeap@0 null (valid__List (MapType0Select ExhaleHeap@0 current$1@0 List__Node__1))))) EmptyFrame)) (FrameFragment (ite (= (variantOfList (MapType0Select ExhaleHeap@0 current$1@0 List__variant)) fn$$List__Nil) (CombineFrames (FrameFragment (MapType0Select ExhaleHeap@0 current$1@0 List__Node__0)) (FrameFragment (MapType0Select ExhaleHeap@0 current$1@0 List__Node__1))) EmptyFrame)))))) (and (=> (= (ControlFlow 0 86) (- 0 87)) (>= rd$1 NoPerm)) (=> (>= rd$1 NoPerm) (and (=> (= (ControlFlow 0 86) 83) anon51_Then_correct) (=> (= (ControlFlow 0 86) 85) anon51_Else_correct))))))))))))))
(let ((anon50_Else_correct true))
(let ((anon49_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (>= rd$1 NoPerm))))
(let ((anon4_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (valid__List list$1) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid__List list$1))) rd$1)))) (=> (and (IdenticalOnKnownLocations Heap@@23 ExhaleHeap@0 Mask@1) (U_2_bool (MapType0Select ExhaleHeap@0 current$1@0 $allocated))) (and (and (=> (= (ControlFlow 0 90) 4) anon49_Then_correct) (=> (= (ControlFlow 0 90) 86) anon50_Then_correct)) (=> (= (ControlFlow 0 90) 6) anon50_Else_correct))))))
(let ((anon48_Else_correct  (=> (and (= rd$1 NoPerm) (= (ControlFlow 0 93) 90)) anon4_correct)))
(let ((anon48_Then_correct  (=> (not (= rd$1 NoPerm)) (and (=> (= (ControlFlow 0 91) (- 0 92)) (<= rd$1 (U_2_real (MapType1Select Mask@0 null (valid__List list$1))))) (=> (<= rd$1 (U_2_real (MapType1Select Mask@0 null (valid__List list$1)))) (=> (= (ControlFlow 0 91) 90) anon4_correct))))))
(let ((anon47_Else_correct  (=> (U_2_bool (MapType0Select Heap@@23 current$1 $allocated)) (=> (and (and (state Heap@@23 Mask@0) (state Heap@@23 Mask@0)) (and (state Heap@@23 Mask@0) (state Heap@@23 Mask@0))) (and (=> (= (ControlFlow 0 94) (- 0 95)) (>= rd$1 NoPerm)) (=> (>= rd$1 NoPerm) (and (=> (= (ControlFlow 0 94) 91) anon48_Then_correct) (=> (= (ControlFlow 0 94) 93) anon48_Else_correct))))))))
(let ((anon47_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (>= rd$1 NoPerm))))
(let ((anon0_correct  (=> (and (state Heap@@23 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@23 list$1 $allocated)) (< NoPerm rd$1)) (and (< rd$1 FullPerm) (state Heap@@23 ZeroMask))) (and (=> (= (ControlFlow 0 96) (- 0 97)) (>= rd$1 NoPerm)) (=> (>= rd$1 NoPerm) (=> (= Mask@0 (MapType1Store ZeroMask null (valid__List list$1) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid__List list$1))) rd$1)))) (=> (and (state Heap@@23 Mask@0) (state Heap@@23 Mask@0)) (and (=> (= (ControlFlow 0 96) 2) anon47_Then_correct) (=> (= (ControlFlow 0 96) 94) anon47_Else_correct))))))))))
