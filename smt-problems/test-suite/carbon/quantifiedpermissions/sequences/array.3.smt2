...
(assert (forall ((Heap@@0 T@U) (this T@U) (i Int) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type this) RefType)) (dummyFunction (int_2_U (|get#triggerStateless| this i))))
 :qid |stdinbpl.586:15|
 :skolemid |59|
...
(assert (forall ((Heap@@6 T@U) (this@@0 T@U) (i@@3 Int) ) (!  (=> (and (= (type Heap@@6) (MapType0Type RefType)) (= (type this@@0) RefType)) (and (= (get Heap@@6 this@@0 i@@3) (|get'| Heap@@6 this@@0 i@@3)) (dummyFunction (int_2_U (|get#triggerStateless| this@@0 i@@3)))))
 :qid |stdinbpl.582:15|
 :skolemid |58|
 :pattern ( (get Heap@@6 this@@0 i@@3))
)))
...
(assert (forall ((Heap@@7 T@U) (Mask@@6 T@U) (this@@1 T@U) (i@@4 Int) ) (!  (=> (and (and (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (= (type this@@1) RefType)) (and (state Heap@@7 Mask@@6) (< AssumeFunctionsAbove 0))) (and (<= 0 i@@4) (< i@@4 (|Seq#Length| (MapType0Select Heap@@7 this@@1 array))))) (= (get Heap@@7 this@@1 i@@4) (U_2_int (MapType0Select Heap@@7 (|Seq#Index| (MapType0Select Heap@@7 this@@1 array) i@@4) value))))
 :qid |stdinbpl.592:15|
 :skolemid |60|
 :pattern ( (state Heap@@7 Mask@@6) (get Heap@@7 this@@1 i@@4))
)))
...
(assert (forall ((s@@11 T@U) (i@@6 Int) (v@@1 T@U) ) (! (let ((T@@25 (type v@@1)))
 (=> (= (type s@@11) (SeqType T@@25)) (=> (and (<= 0 i@@6) (< i@@6 (|Seq#Length| s@@11))) (= (|Seq#Length| (|Seq#Update| s@@11 i@@6 v@@1)) (|Seq#Length| s@@11)))))
 :qid |stdinbpl.272:18|
 :skolemid |34|
 :pattern ( (|Seq#Length| (|Seq#Update| s@@11 i@@6 v@@1)))
 :pattern ( (|Seq#Length| s@@11) (|Seq#Update| s@@11 i@@6 v@@1))
)))
...
(assert (forall ((s@@13 T@U) (n@@10 Int) (i@@7 Int) ) (! (let ((T@@27 (SeqTypeInv0 (type s@@13))))
 (=> (= (type s@@13) (SeqType T@@27)) (=> (and (and (< 0 n@@10) (<= n@@10 i@@7)) (< i@@7 (|Seq#Length| s@@13))) (and (= (|Seq#Add| (|Seq#Sub| i@@7 n@@10) n@@10) i@@7) (= (|Seq#Index| (|Seq#Drop| s@@13 n@@10) (|Seq#Sub| i@@7 n@@10)) (|Seq#Index| s@@13 i@@7))))))
 :qid |stdinbpl.323:18|
 :skolemid |40|
 :pattern ( (|Seq#Drop| s@@13 n@@10) (|Seq#Index| s@@13 i@@7))
)))
...
(assert (forall ((s@@14 T@U) (x@@10 T@U) (i@@8 Int) ) (! (let ((T@@30 (type x@@10)))
 (=> (= (type s@@14) (SeqType T@@30)) (=> (and (and (<= 0 i@@8) (< i@@8 (|Seq#Length| s@@14))) (= (|Seq#Index| s@@14 i@@8) x@@10)) (|Seq#Contains| s@@14 x@@10))))
 :qid |stdinbpl.419:18|
 :skolemid |48|
 :pattern ( (|Seq#Contains| s@@14 x@@10) (|Seq#Index| s@@14 i@@8))
)))
...
(assert (forall ((Heap@@12 T@U) (Mask@@10 T@U) (this@@2 T@U) (i@@9 Int) ) (!  (=> (and (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type this@@2) RefType)) (state Heap@@12 Mask@@10)) (= (|get'| Heap@@12 this@@2 i@@9) (|get#frame| (CombineFrames (FrameFragment (MapType0Select Heap@@12 this@@2 array)) (FrameFragment (MapType0Select Heap@@12 (|Seq#Index| (MapType0Select Heap@@12 this@@2 array) i@@9) value))) this@@2 i@@9)))
 :qid |stdinbpl.599:15|
 :skolemid |61|
 :pattern ( (state Heap@@12 Mask@@10) (|get'| Heap@@12 this@@2 i@@9))
)))
(push 1)
...
(assert  (and (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type this@@3) RefType)) (= (type Heap@@13) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id init)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 51) (let ((anon8_correct true))
(let ((anon27_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_2))) (= (ControlFlow 0 46) 41)) anon8_correct)))
(let ((anon27_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_2)) (and (=> (= (ControlFlow 0 42) (- 0 45)) (HasDirectPerm PostMask@0 this@@3 array)) (=> (HasDirectPerm PostMask@0 this@@3 array) (and (=> (= (ControlFlow 0 42) (- 0 44)) (>= k_2 0)) (=> (>= k_2 0) (and (=> (= (ControlFlow 0 42) (- 0 43)) (< k_2 (|Seq#Length| (MapType0Select PostHeap@0 this@@3 array)))) (=> (< k_2 (|Seq#Length| (MapType0Select PostHeap@0 this@@3 array))) (=> (= (ControlFlow 0 42) 41) anon8_correct))))))))))
(let ((anon26_Else_correct  (=> (= (ControlFlow 0 40) (- 0 39)) (forall ((k_3 Int) (k_3_1 Int) ) (!  (=> (and (and (and (and (not (= k_3 k_3_1)) (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_3))) (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select PostHeap@0 this@@3 array) k_3) (|Seq#Index| (MapType0Select PostHeap@0 this@@3 array) k_3_1))))
 :qid |stdinbpl.770:15|
 :skolemid |63|
)))))
(let ((anon24_Else_correct  (=> (and (forall ((k_1 Int) (j_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_1)) (and (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U j_1)) (not (= k_1 j_1)))) (not (= (|Seq#Index| (MapType0Select PostHeap@0 this@@3 array) k_1) (|Seq#Index| (MapType0Select PostHeap@0 this@@3 array) j_1))))
 :qid |stdinbpl.750:20|
 :skolemid |62|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 i@@10) (int_2_U k_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 i@@10) (int_2_U j_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 i@@10) (int_2_U k_1)) (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U j_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 i@@10) (int_2_U j_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_1)) (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U j_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 i@@10) (int_2_U k_1)) (|Seq#Index| (MapType0Select PostHeap@0 this@@3 array) j_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_1)) (|Seq#Index| (MapType0Select PostHeap@0 this@@3 array) j_1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 i@@10) (int_2_U j_1)) (|Seq#Index| (MapType0Select PostHeap@0 this@@3 array) k_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U j_1)) (|Seq#Index| (MapType0Select PostHeap@0 this@@3 array) k_1))
 :pattern ( (|Seq#Index| (MapType0Select PostHeap@0 this@@3 array) k_1) (|Seq#Index| (MapType0Select PostHeap@0 this@@3 array) j_1))
...
(let ((anon25_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k)) (and (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U j@@5)) (not (= k j@@5))))) (= (ControlFlow 0 38) 30)) anon4_correct)))
(let ((anon25_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k)) (and (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U j@@5)) (not (= k j@@5)))) (and (=> (= (ControlFlow 0 31) (- 0 37)) (HasDirectPerm PostMask@0 this@@3 array)) (=> (HasDirectPerm PostMask@0 this@@3 array) (and (=> (= (ControlFlow 0 31) (- 0 36)) (>= k 0)) (=> (>= k 0) (and (=> (= (ControlFlow 0 31) (- 0 35)) (< k (|Seq#Length| (MapType0Select PostHeap@0 this@@3 array)))) (=> (< k (|Seq#Length| (MapType0Select PostHeap@0 this@@3 array))) (and (=> (= (ControlFlow 0 31) (- 0 34)) (HasDirectPerm PostMask@0 this@@3 array)) (=> (HasDirectPerm PostMask@0 this@@3 array) (and (=> (= (ControlFlow 0 31) (- 0 33)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 31) (- 0 32)) (< j@@5 (|Seq#Length| (MapType0Select PostHeap@0 this@@3 array)))) (=> (< j@@5 (|Seq#Length| (MapType0Select PostHeap@0 this@@3 array))) (=> (= (ControlFlow 0 31) 30) anon4_correct))))))))))))))))
(let ((anon23_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (> wildcard@0 NoPerm)) (=> (and (and (not (= this@@3 null)) (= PostMask@0 (MapType1Store ZeroMask this@@3 array (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@3 array)) wildcard@0))))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 48) (- 0 49)) (HasDirectPerm PostMask@0 this@@3 array)) (=> (HasDirectPerm PostMask@0 this@@3 array) (=> (and (= (|Seq#Length| (MapType0Select PostHeap@0 this@@3 array)) i@@10) (state PostHeap@0 PostMask@0)) (and (and (=> (= (ControlFlow 0 48) 47) anon24_Else_correct) (=> (= (ControlFlow 0 48) 31) anon25_Then_correct)) (=> (= (ControlFlow 0 48) 38) anon25_Else_correct)))))))))
(let ((anon21_correct true))
(let ((anon33_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_4_1)) (and (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U j_2_1)) (not (= k_4_1 j_2_1))))) (= (ControlFlow 0 22) 19)) anon21_correct)))
(let ((anon33_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_4_1)) (and (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U j_2_1)) (not (= k_4_1 j_2_1)))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (not (= (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_4_1) (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) j_2_1)))) (=> (not (= (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_4_1) (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) j_2_1))) (=> (= (ControlFlow 0 20) 19) anon21_correct))))))
(let ((anon32_Else_correct  (=> (forall ((k_5_1 Int) (j_3_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_5_1)) (and (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U j_3_1)) (not (= k_5_1 j_3_1)))) (not (= (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_5_1) (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) j_3_1))))
 :qid |stdinbpl.914:20|
 :skolemid |76|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 i@@10) (int_2_U k_5_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 i@@10) (int_2_U j_3_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 i@@10) (int_2_U k_5_1)) (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U j_3_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_5_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 i@@10) (int_2_U j_3_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_5_1)) (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U j_3_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 i@@10) (int_2_U k_5_1)) (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) j_3_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_5_1)) (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) j_3_1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 i@@10) (int_2_U j_3_1)) (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_5_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U j_3_1)) (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_5_1))
 :pattern ( (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_5_1) (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) j_3_1))
)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((k_6 Int) (k_6_1 Int) ) (!  (=> (and (and (and (and (not (= k_6 k_6_1)) (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_6))) (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_6_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_6) (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_6_1))))
 :qid |stdinbpl.925:17|
 :skolemid |77|
 :pattern ( (neverTriggered2 k_6) (neverTriggered2 k_6_1))
))) (=> (forall ((k_6@@0 Int) (k_6_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_6@@0 k_6_1@@0)) (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_6@@0))) (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_6_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_6@@0) (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_6_1@@0))))
 :qid |stdinbpl.925:17|
 :skolemid |77|
 :pattern ( (neverTriggered2 k_6@@0) (neverTriggered2 k_6_1@@0))
)) (=> (= (ControlFlow 0 17) (- 0 16)) (forall ((k_6@@1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_6@@1)) (>= (U_2_real (MapType1Select Mask@1 (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_6@@1) value)) FullPerm))
 :qid |stdinbpl.932:17|
 :skolemid |78|
 :pattern ( (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_6@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 i@@10) (int_2_U k_6@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_6@@1)))
 :pattern ( (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_6@@1))
))))))))
(let ((anon30_Else_correct  (and (=> (= (ControlFlow 0 23) (- 0 26)) (forall ((k_10 Int) (k_10_1 Int) ) (!  (=> (and (and (and (and (not (= k_10 k_10_1)) (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_10))) (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_10_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_10) (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_10_1))))
 :qid |stdinbpl.862:15|
 :skolemid |70|
))) (=> (forall ((k_10@@0 Int) (k_10_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_10@@0 k_10_1@@0)) (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_10@@0))) (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_10_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_10@@0) (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_10_1@@0))))
 :qid |stdinbpl.862:15|
 :skolemid |70|
)) (=> (and (and (and (forall ((k_10@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_10@@1)) (< NoPerm FullPerm)) (and (qpRange3 (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_10@@1)) (= (invRecv3 (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_10@@1)) k_10@@1)))
 :qid |stdinbpl.868:22|
 :skolemid |71|
 :pattern ( (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_10@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 i@@10) (int_2_U k_10@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_10@@1)))
 :pattern ( (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_10@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U (invRecv3 o_3))) (< NoPerm FullPerm)) (qpRange3 o_3)) (= (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) (invRecv3 o_3)) o_3)))
 :qid |stdinbpl.872:22|
 :skolemid |72|
 :pattern ( (invRecv3 o_3))
))) (and (forall ((k_10@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_10@@2)) (not (= (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_10@@2) null)))
 :qid |stdinbpl.878:22|
 :skolemid |73|
 :pattern ( (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_10@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 i@@10) (int_2_U k_10@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_10@@2)))
 :pattern ( (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_10@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U (invRecv3 o_3@@0))) (< NoPerm FullPerm)) (qpRange3 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) (invRecv3 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 value)) (+ (U_2_real (MapType1Select Mask@0 o_3@@0 value)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U (invRecv3 o_3@@0))) (< NoPerm FullPerm)) (qpRange3 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 value)) (U_2_real (MapType1Select Mask@0 o_3@@0 value))))))
 :qid |stdinbpl.884:22|
 :skolemid |74|
 :pattern ( (MapType1Select QPMask@0 o_3@@0 value))
)))) (and (and (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 value))) (= (U_2_real (MapType1Select Mask@0 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.888:29|
 :skolemid |75|
 :pattern ( (MapType1Select Mask@0 o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
)) (state Heap@@13 QPMask@0)) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)))) (and (=> (= (ControlFlow 0 23) (- 0 25)) (> (U_2_real (MapType1Select QPMask@0 this@@3 array)) NoPerm)) (=> (> (U_2_real (MapType1Select QPMask@0 this@@3 array)) NoPerm) (=> (> wildcard@1 NoPerm) (=> (and (< wildcard@1 (U_2_real (MapType1Select QPMask@0 this@@3 array))) (= Mask@1 (MapType1Store QPMask@0 this@@3 array (real_2_U (- (U_2_real (MapType1Select QPMask@0 this@@3 array)) wildcard@1))))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (= (|Seq#Length| (MapType0Select Heap@@13 this@@3 array)) i@@10)) (=> (= (|Seq#Length| (MapType0Select Heap@@13 this@@3 array)) i@@10) (and (and (=> (= (ControlFlow 0 23) 17) anon32_Else_correct) (=> (= (ControlFlow 0 23) 20) anon33_Then_correct)) (=> (= (ControlFlow 0 23) 22) anon33_Else_correct)))))))))))))
(let ((anon17_correct true))
(let ((anon31_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_5))) (= (ControlFlow 0 15) 10)) anon17_correct)))
(let ((anon31_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_5)) (and (=> (= (ControlFlow 0 11) (- 0 14)) (HasDirectPerm Mask@0 this@@3 array)) (=> (HasDirectPerm Mask@0 this@@3 array) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= k_5 0)) (=> (>= k_5 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< k_5 (|Seq#Length| (MapType0Select Heap@@13 this@@3 array)))) (=> (< k_5 (|Seq#Length| (MapType0Select Heap@@13 this@@3 array))) (=> (= (ControlFlow 0 11) 10) anon17_correct))))))))))
(let ((anon28_Else_correct  (=> (forall ((k_8 Int) (j_5 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_8)) (and (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U j_5)) (not (= k_8 j_5)))) (not (= (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_8) (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) j_5))))
 :qid |stdinbpl.843:20|
 :skolemid |69|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 i@@10) (int_2_U k_8)) (|Seq#ContainsTrigger| (|Seq#Range| 0 i@@10) (int_2_U j_5)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 i@@10) (int_2_U k_8)) (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U j_5)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_8)) (|Seq#ContainsTrigger| (|Seq#Range| 0 i@@10) (int_2_U j_5)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_8)) (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U j_5)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 i@@10) (int_2_U k_8)) (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) j_5))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_8)) (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) j_5))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 i@@10) (int_2_U j_5)) (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_8))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U j_5)) (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_8))
 :pattern ( (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) k_8) (|Seq#Index| (MapType0Select Heap@@13 this@@3 array) j_5))
...
(let ((anon29_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_4)) (and (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U j_2)) (not (= k_4 j_2))))) (= (ControlFlow 0 9) 1)) anon13_correct)))
(let ((anon29_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U k_4)) (and (|Seq#Contains| (|Seq#Range| 0 i@@10) (int_2_U j_2)) (not (= k_4 j_2)))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (HasDirectPerm Mask@0 this@@3 array)) (=> (HasDirectPerm Mask@0 this@@3 array) (and (=> (= (ControlFlow 0 2) (- 0 7)) (>= k_4 0)) (=> (>= k_4 0) (and (=> (= (ControlFlow 0 2) (- 0 6)) (< k_4 (|Seq#Length| (MapType0Select Heap@@13 this@@3 array)))) (=> (< k_4 (|Seq#Length| (MapType0Select Heap@@13 this@@3 array))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm Mask@0 this@@3 array)) (=> (HasDirectPerm Mask@0 this@@3 array) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_2 0)) (=> (>= j_2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_2 (|Seq#Length| (MapType0Select Heap@@13 this@@3 array)))) (=> (< j_2 (|Seq#Length| (MapType0Select Heap@@13 this@@3 array))) (=> (= (ControlFlow 0 2) 1) anon13_correct))))))))))))))))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 29)) (HasDirectPerm Mask@0 this@@3 array)) (=> (HasDirectPerm Mask@0 this@@3 array) (=> (= (|Seq#Length| (MapType0Select Heap@@13 this@@3 array)) i@@10) (and (and (=> (= (ControlFlow 0 28) 27) anon28_Else_correct) (=> (= (ControlFlow 0 28) 2) anon29_Then_correct)) (=> (= (ControlFlow 0 28) 9) anon29_Else_correct)))))))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@13 this@@3 $allocated))) (=> (and (and (not (= this@@3 null)) (= Mask@0 (MapType1Store ZeroMask this@@3 array (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@3 array)) FullPerm))))) (and (state Heap@@13 Mask@0) (state Heap@@13 Mask@0))) (and (=> (= (ControlFlow 0 50) 48) anon23_Then_correct) (=> (= (ControlFlow 0 50) 28) anon23_Else_correct)))))))
