...
(assert  (and (and (and (and (and (and (= (type s@@21) (SeqType RefType)) (= (type x_10) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type x_11) RefType)) (= (type x_5) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (forall ((arg0@@52 T@U) ) (! (= (type (invRecv11 arg0@@52)) RefType)
 :qid |funType:invRecv11|
 :pattern ( (invRecv11 arg0@@52))
))))
(set-info :boogie-vc-id reprofour)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 25) (let ((anon16_correct true))
(let ((anon24_Else_correct  (=> (and (>= 0 (|Seq#Length| s@@21)) (= (ControlFlow 0 19) 14)) anon16_correct)))
(let ((anon24_Then_correct  (=> (> (|Seq#Length| s@@21) 0) (and (=> (= (ControlFlow 0 15) (- 0 18)) (< 0 (|Seq#Length| s@@21))) (=> (< 0 (|Seq#Length| s@@21)) (and (=> (= (ControlFlow 0 15) (- 0 17)) (HasDirectPerm QPMask@0 (|Seq#Index| s@@21 0) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| s@@21 0) f_7) (and (=> (= (ControlFlow 0 15) (- 0 16)) (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| s@@21 0) f_7)) 0)) (=> (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| s@@21 0) f_7)) 0) (=> (= (ControlFlow 0 15) 14) anon16_correct))))))))))
(let ((anon22_Else_correct  (=> (and (forall ((x_6_1 T@U) ) (!  (=> (and (= (type x_6_1) RefType) (|Seq#Contains| s@@21 x_6_1)) (= (U_2_int (MapType0Select Heap@@9 x_6_1 f_7)) 0))
 :qid |stdinbpl.1913:20|
 :skolemid |200|
 :pattern ( (|Seq#ContainsTrigger| s@@21 x_6_1))
 :pattern ( (|Seq#Contains| s@@21 x_6_1))
)) (state Heap@@9 QPMask@0)) (and (=> (= (ControlFlow 0 20) 15) anon24_Then_correct) (=> (= (ControlFlow 0 20) 19) anon24_Else_correct)))))
(let ((anon13_correct true))
(let ((anon23_Else_correct  (=> (and (not (|Seq#Contains| s@@21 x_5)) (= (ControlFlow 0 13) 10)) anon13_correct)))
(let ((anon23_Then_correct  (=> (|Seq#Contains| s@@21 x_5) (and (=> (= (ControlFlow 0 11) (- 0 12)) (= (U_2_int (MapType0Select Heap@@9 x_5 f_7)) 0)) (=> (= (U_2_int (MapType0Select Heap@@9 x_5 f_7)) 0) (=> (= (ControlFlow 0 11) 10) anon13_correct))))))
(let ((anon9_correct true))
(let ((anon21_Else_correct  (=> (and (not (|Seq#Contains| s@@21 x_11)) (= (ControlFlow 0 9) 6)) anon9_correct)))
(let ((anon21_Then_correct  (=> (|Seq#Contains| s@@21 x_11) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm QPMask@0 x_11 f_7)) (=> (HasDirectPerm QPMask@0 x_11 f_7) (=> (= (ControlFlow 0 7) 6) anon9_correct))))))
(let ((anon18_Else_correct  (=> (forall ((x_3_1 T@U) ) (!  (=> (and (= (type x_3_1) RefType) (|Seq#Contains| s@@21 x_3_1)) (= (U_2_int (MapType0Select Heap@@9 x_3_1 f_7)) 0))
 :qid |stdinbpl.1887:20|
 :skolemid |199|
 :pattern ( (|Seq#ContainsTrigger| s@@21 x_3_1))
 :pattern ( (|Seq#Contains| s@@21 x_3_1))
)) (=> (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)) (and (and (and (and (=> (= (ControlFlow 0 21) 20) anon22_Else_correct) (=> (= (ControlFlow 0 21) 11) anon23_Then_correct)) (=> (= (ControlFlow 0 21) 13) anon23_Else_correct)) (=> (= (ControlFlow 0 21) 7) anon21_Then_correct)) (=> (= (ControlFlow 0 21) 9) anon21_Else_correct))))))
(let ((anon5_correct true))
(let ((anon19_Else_correct  (=> (and (not (|Seq#Contains| s@@21 x_10)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon19_Then_correct  (=> (|Seq#Contains| s@@21 x_10) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 x_10 f_7)) (=> (HasDirectPerm QPMask@0 x_10 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 22) (- 0 23)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| s@@21 x_1)) (|Seq#Contains| s@@21 x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (|Seq#Contains| s@@21 x_1@@0)) (|Seq#Contains| s@@21 x_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.1842:15|
 :skolemid |193|
...
)) (=> (and (and (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| s@@21 x_1@@1) (< NoPerm FullPerm)) (and (qpRange11 x_1@@1) (= (invRecv11 x_1@@1) x_1@@1))))
 :qid |stdinbpl.1848:22|
 :skolemid |194|
 :pattern ( (MapType0Select Heap@@9 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
 :pattern ( (|Seq#ContainsTrigger| s@@21 x_1@@1))
 :pattern ( (|Seq#Contains| s@@21 x_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| s@@21 (invRecv11 o_3)) (< NoPerm FullPerm)) (qpRange11 o_3)) (= (invRecv11 o_3) o_3)))
 :qid |stdinbpl.1852:22|
 :skolemid |195|
 :pattern ( (invRecv11 o_3))
))) (and (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (|Seq#Contains| s@@21 x_1@@2)) (not (= x_1@@2 null)))
 :qid |stdinbpl.1858:22|
 :skolemid |196|
 :pattern ( (MapType0Select Heap@@9 x_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@2 f_7))
 :pattern ( (|Seq#ContainsTrigger| s@@21 x_1@@2))
 :pattern ( (|Seq#Contains| s@@21 x_1@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| s@@21 (invRecv11 o_3@@0)) (< NoPerm FullPerm)) (qpRange11 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv11 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| s@@21 (invRecv11 o_3@@0)) (< NoPerm FullPerm)) (qpRange11 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (and (=> (= (ControlFlow 0 22) 21) anon18_Else_correct) (=> (= (ControlFlow 0 22) 3) anon19_Then_correct)) (=> (= (ControlFlow 0 22) 5) anon19_Else_correct)))))))
(let ((anon17_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 24) 1) anon17_Then_correct) (=> (= (ControlFlow 0 24) 22) anon17_Else_correct)))))
