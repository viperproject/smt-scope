...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon5_correct  (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 4) (- 0 3))) (<= y@1 x@@8))))
(let ((anon9_Else_correct  (=> (and (> 0 y@1) (= (ControlFlow 0 7) 4)) anon5_correct)))
(let ((anon9_Then_correct  (=> (>= y@1 0) (and (=> (= (ControlFlow 0 5) (- 0 6)) (and (decreasing (int_2_U y@1) (int_2_U y@0)) (bounded (int_2_U y@0)))) (=> (and (decreasing (int_2_U y@1) (int_2_U y@0)) (bounded (int_2_U y@0))) (=> (= (ControlFlow 0 5) 4) anon5_correct))))))
(let ((anon8_Then_correct  (=> (and (and (and (state Heap@@9 ZeroMask) (<= y@0 x@@8)) (and (state Heap@@9 ZeroMask) (>= y@0 0))) (and (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (= y@1 (- y@0 1)) (state Heap@@9 ZeroMask)))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (and (decreasing (int_2_U y@1) (int_2_U x@@8)) (bounded (int_2_U x@@8)))) (=> (and (decreasing (int_2_U y@1) (int_2_U x@@8)) (bounded (int_2_U x@@8))) (=> (state Heap@@9 ZeroMask) (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 8) 5) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct)))))))))
(let ((anon8_Else_correct true))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= x@@8 x@@8)) (=> (<= x@@8 x@@8) (and (and (=> (= (ControlFlow 0 10) 1) anon7_Then_correct) (=> (= (ControlFlow 0 10) 8) anon8_Then_correct)) (=> (= (ControlFlow 0 10) 2) anon8_Else_correct)))))))
