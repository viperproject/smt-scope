...
(declare-fun |t#frame| (T@U Int) Bool)
(declare-fun t (T@U Int) Bool)
...
(assert (forall ((Heap@@2 T@U) (r_1 Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (bool_2_U (|t#triggerStateless| r_1))))
 :qid |stdinbpl.189:15|
 :skolemid |23|
 :pattern ( (|t'| Heap@@2 r_1))
)))
...
(assert (forall ((Heap@@5 T@U) (Mask@@4 T@U) (r_1@@0 Int) ) (!  (=> (and (and (and (= (type Heap@@5) (MapType0Type RefType)) (= (type Mask@@4) (MapType1Type RefType realType))) (and (state Heap@@5 Mask@@4) (or (< AssumeFunctionsAbove 0) (|t#trigger| EmptyFrame r_1@@0)))) (> r_1@@0 0)) (> r_1@@0 0))
 :qid |stdinbpl.208:15|
 :skolemid |26|
...
(assert (forall ((Heap@@7 T@U) (Mask@@7 T@U) (r_1@@1 Int) ) (!  (=> (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (state Heap@@7 Mask@@7)) (= (|t'| Heap@@7 r_1@@1) (|t#frame| EmptyFrame r_1@@1)))
 :qid |stdinbpl.202:15|
 :skolemid |25|
 :pattern ( (state Heap@@7 Mask@@7) (|t'| Heap@@7 r_1@@1))
)))
(assert (forall ((Heap@@8 T@U) (Mask@@8 T@U) (r_1@@2 Int) ) (!  (=> (and (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@8) (MapType1Type RefType realType))) (and (state Heap@@8 Mask@@8) (< AssumeFunctionsAbove 0))) (> r_1@@2 0)) (= (t Heap@@8 r_1@@2) (> r_1@@2 0)))
 :qid |stdinbpl.195:15|
 :skolemid |24|
 :pattern ( (state Heap@@8 Mask@@8) (t Heap@@8 r_1@@2))
)))
(assert (forall ((Heap@@9 T@U) (r_1@@3 Int) ) (!  (=> (= (type Heap@@9) (MapType0Type RefType)) (and (= (t Heap@@9 r_1@@3) (|t'| Heap@@9 r_1@@3)) (dummyFunction (bool_2_U (|t#triggerStateless| r_1@@3)))))
 :qid |stdinbpl.185:15|
 :skolemid |22|
 :pattern ( (t Heap@@9 r_1@@3))
)))
...
(assert  (and (= (type Heap@@14) (MapType0Type RefType)) (= (type PostHeap@0) (MapType0Type RefType))))
...
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (t Heap@@14 0))))
(let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 7) 6) anon5_Then_correct) (=> (= (ControlFlow 0 7) 2) anon5_Else_correct)))))
