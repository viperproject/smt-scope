...
(let ((anon8_Else_correct  (=> (not (= (List_tag (get_List_tail l@@44)) 1)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (decreasing (get_List_tail (get_List_tail l@@44)) l@@44)) (=> (decreasing (get_List_tail (get_List_tail l@@44)) l@@44) (and (=> (= (ControlFlow 0 5) (- 0 6)) (bounded l@@44)) (=> (bounded l@@44) (=> (and (state Heap@@58 ZeroMask) (= (ControlFlow 0 5) 3)) anon5_correct))))))))
(let ((anon8_Then_correct  (=> (and (= (List_tag (get_List_tail l@@44)) 1) (= (ControlFlow 0 4) 3)) anon5_correct)))
(let ((anon7_Else_correct  (=> (not (= (List_tag l@@44) 1)) (and (=> (= (ControlFlow 0 8) 4) anon8_Then_correct) (=> (= (ControlFlow 0 8) 5) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (and (= (List_tag l@@44) 1) (= (ControlFlow 0 2) 1)) anon6_correct)))
...
(declare-fun Heap@@58 () T@U)
(declare-fun l@@44 () T@U)
(assert  (and (= (type Heap@@58) (MapType0Type RefType)) (= (type l@@44) (ListDomainTypeType ValDomainTypeType))))
(set-info :boogie-vc-id lenBad2_termination_proof)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@58 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (decreasing l@@44 l@@44)) (=> (decreasing l@@44 l@@44) (=> (= (ControlFlow 0 2) (- 0 1)) (bounded l@@44)))))))
