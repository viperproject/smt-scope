...
(declare-fun falze () T@U)
(declare-fun PredicateType_falzeType () T@T)
(declare-fun tru () T@U)
(declare-fun PredicateType_truType () T@T)
...
(declare-fun |falze#trigger| (T@U T@U) Bool)
(declare-fun |falze#everUsed| (T@U) Bool)
(declare-fun |tru#trigger| (T@U T@U) Bool)
(declare-fun |tru#everUsed| (T@U) Bool)
(declare-fun |falze#sm| () T@U)
(declare-fun |tru#sm| () T@U)
...
(assert  (and (= (Ctor PredicateType_falzeType) 11) (= (type falze) (FieldType PredicateType_falzeType FrameTypeType))))
(assert (IsPredicateField falze))
(assert  (and (= (Ctor PredicateType_truType) 12) (= (type tru) (FieldType PredicateType_truType FrameTypeType))))
(assert (IsPredicateField tru))
(assert (= (getPredWandId falze) 0))
(assert (= (getPredWandId tru) 1))
...
(assert (forall ((Heap@@7 T@U) ) (!  (=> (= (type Heap@@7) (MapType0Type RefType)) (|falze#everUsed| falze))
 :qid |stdinbpl.188:15|
 :skolemid |22|
 :pattern ( (|falze#trigger| Heap@@7 falze))
)))
(assert (forall ((Heap@@8 T@U) ) (!  (=> (= (type Heap@@8) (MapType0Type RefType)) (|tru#everUsed| tru))
 :qid |stdinbpl.219:15|
 :skolemid |23|
 :pattern ( (|tru#trigger| Heap@@8 tru))
)))
...
(assert (= (type |falze#sm|) (FieldType PredicateType_falzeType (MapType1Type RefType boolType))))
(assert (= (PredicateMaskField falze) |falze#sm|))
(assert (= (type |tru#sm|) (FieldType PredicateType_truType (MapType1Type RefType boolType))))
(assert (= (PredicateMaskField tru) |tru#sm|))
...
(assert  (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@11) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)))
(set-info :boogie-vc-id test_unfold_unknown)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon4_correct true))
(let ((anon6_Else_correct  (=> (and (HasDirectPerm Mask@0 null falze) (= (ControlFlow 0 4) 2)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (HasDirectPerm Mask@0 null falze)) (=> (and (= Heap@0 (MapType0Store Heap@@11 null falze newVersion@0)) (= (ControlFlow 0 3) 2)) anon4_correct))))
(let ((anon2_correct  (=> (= Mask@0 (MapType1Store ZeroMask null falze (real_2_U (- (U_2_real (MapType1Select ZeroMask null falze)) p_1)))) (and (=> (= (ControlFlow 0 5) 3) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (= p_1 NoPerm) (= (ControlFlow 0 8) 5)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= p_1 NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= p_1 (U_2_real (MapType1Select ZeroMask null falze)))) (=> (<= p_1 (U_2_real (MapType1Select ZeroMask null falze))) (=> (= (ControlFlow 0 6) 5) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@11 ZeroMask) (<= NoPerm p_1)) (and (state Heap@@11 ZeroMask) (state Heap@@11 ZeroMask))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (> p_1 NoPerm)) (=> (> p_1 NoPerm) (=> (and (|falze#trigger| Heap@@11 falze) (= (MapType0Select Heap@@11 null falze) EmptyFrame)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (>= p_1 NoPerm)) (=> (>= p_1 NoPerm) (and (=> (= (ControlFlow 0 9) 6) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct))))))))))
