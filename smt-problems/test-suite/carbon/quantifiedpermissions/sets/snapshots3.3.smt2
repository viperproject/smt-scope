...
(assert  (and (= (type xs@@6) (MapType0Type RefType boolType)) (= (type Heap@@11) (MapType1Type RefType))))
(set-info :boogie-vc-id |P#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_2 T@U) (x_2_1 T@U) ) (!  (=> (and (= (type x_2) RefType) (= (type x_2_1) RefType)) (=> (and (and (and (and (not (= x_2 x_2_1)) (U_2_bool (MapType0Select xs@@6 x_2))) (U_2_bool (MapType0Select xs@@6 x_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_2 x_2_1))))
 :qid |stdinbpl.494:15|
 :skolemid |89|
 :no-pattern (type x_2)
