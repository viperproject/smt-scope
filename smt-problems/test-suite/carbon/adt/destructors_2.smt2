...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 6)) (= (U_2_int (get_List_value (Cons (int_2_U 1) (Nil intType)))) 1)) (=> (= (U_2_int (get_List_value (Cons (int_2_U 1) (Nil intType)))) 1) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (get_List_tail (Cons (int_2_U 1) (Nil intType))) (Nil intType))) (=> (= (get_List_tail (Cons (int_2_U 1) (Nil intType))) (Nil intType)) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (U_2_int (get_Tree_value (Node (int_2_U 42) (Node (int_2_U 42) (Leaf intType) (Node (int_2_U 42) (Node (int_2_U 42) (Leaf intType) (Leaf intType)) (Leaf intType))) (Leaf intType)))) 42)) (=> (= (U_2_int (get_Tree_value (Node (int_2_U 42) (Node (int_2_U 42) (Leaf intType) (Node (int_2_U 42) (Node (int_2_U 42) (Leaf intType) (Leaf intType)) (Leaf intType))) (Leaf intType)))) 42) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (U_2_int (get_Tree_value (get_Tree_left (get_Tree_right (get_Tree_left (Node (int_2_U 42) (Node (int_2_U 42) (Leaf intType) (Node (int_2_U 42) (Node (int_2_U 42) (Leaf intType) (Leaf intType)) (Leaf intType))) (Leaf intType))))))) 42)) (=> (= (U_2_int (get_Tree_value (get_Tree_left (get_Tree_right (get_Tree_left (Node (int_2_U 42) (Node (int_2_U 42) (Leaf intType) (Node (int_2_U 42) (Node (int_2_U 42) (Leaf intType) (Leaf intType)) (Leaf intType))) (Leaf intType))))))) 42) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (U_2_int (get_Tree_value (get_Tree_left (get_Tree_right (get_Tree_left (Node (int_2_U 42) (Node (int_2_U 42) (Leaf intType) (Node (int_2_U 42) (Node (int_2_U 42) (Leaf intType) (Leaf intType)) (Leaf intType))) (Leaf intType))))))) 42))))))))))))))))
