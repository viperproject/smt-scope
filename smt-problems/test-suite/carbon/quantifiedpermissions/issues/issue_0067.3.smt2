...
(assert  (and (and (and (and (and (and (and (and (and (and (= (type S) (MapType2Type RefType boolType)) (= (type s@@3) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type s_2) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type a_2) RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv2 arg0@@43)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@43))
))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv1 arg0@@44)) RefType)
...
(let ((anon21_Then_correct  (=> (not (= perm@1 NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= perm@1 (U_2_real (MapType1Select Mask@0 a_2 f_7)))) (=> (<= perm@1 (U_2_real (MapType1Select Mask@0 a_2 f_7))) (=> (= (ControlFlow 0 11) 10) anon14_correct))))))
...
)) (=> (and (forall ((s_5@@1 T@U) ) (!  (=> (= (type s_5@@1) RefType) (=> (and (and (U_2_bool (MapType2Select S s_5@@1)) (not (= s_5@@1 null))) (< NoPerm (U_2_real (MapType0Select Heap@@9 s_5@@1 k)))) (and (qpRange2 s_5@@1) (= (invRecv2 s_5@@1) s_5@@1))))
 :qid |stdinbpl.509:22|
 :skolemid |90|
 :pattern ( (MapType0Select Heap@@9 s_5@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 s_5@@1 f_7))
 :pattern ( (MapType2Select S s_5@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (U_2_bool (MapType2Select S (invRecv2 o_3))) (not (= (invRecv2 o_3) null))) (< NoPerm (U_2_real (MapType0Select Heap@@9 (invRecv2 o_3) k)))) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.513:22|
 :skolemid |91|
...
)) (=> (forall ((s_5@@4 T@U) ) (!  (=> (= (type s_5@@4) RefType) (=> (and (and (U_2_bool (MapType2Select S s_5@@4)) (not (= s_5@@4 null))) (> (U_2_real (MapType0Select Heap@@9 s_5@@4 k)) NoPerm)) (not (= s_5@@4 null))))
 :qid |stdinbpl.525:22|
 :skolemid |93|
 :pattern ( (MapType0Select Heap@@9 s_5@@4 f_7))
 :pattern ( (MapType1Select QPMask@1 s_5@@4 f_7))
 :pattern ( (MapType2Select S s_5@@4))
)) (=> (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (U_2_bool (MapType2Select S (invRecv2 o_3@@0))) (not (= (invRecv2 o_3@@0) null))) (< NoPerm (U_2_real (MapType0Select Heap@@9 (invRecv2 o_3@@0) k)))) (qpRange2 o_3@@0)) (and (=> (< NoPerm (U_2_real (MapType0Select Heap@@9 (invRecv2 o_3@@0) k))) (= (invRecv2 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType0Select Heap@@9 (invRecv2 o_3@@0) k)))))) (=> (not (and (and (and (U_2_bool (MapType2Select S (invRecv2 o_3@@0))) (not (= (invRecv2 o_3@@0) null))) (< NoPerm (U_2_real (MapType0Select Heap@@9 (invRecv2 o_3@@0) k)))) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7))))))
 :qid |stdinbpl.531:22|
 :skolemid |94|
...
(let ((anon17_Else_correct  (=> (and (not (U_2_bool (MapType2Select S s@@3))) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon17_Then_correct  (=> (U_2_bool (MapType2Select S s@@3)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 s@@3 k)) (=> (HasDirectPerm QPMask@0 s@@3 k) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
...
)) (=> (forall ((s_1@@1 T@U) ) (!  (=> (= (type s_1@@1) RefType) (=> (and (U_2_bool (MapType2Select S s_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 s_1@@1) (= (invRecv1 s_1@@1) s_1@@1))))
 :qid |stdinbpl.451:22|
 :skolemid |83|
 :pattern ( (MapType0Select Heap@@9 s_1@@1 k))
 :pattern ( (MapType1Select QPMask@0 s_1@@1 k))
 :pattern ( (MapType2Select S s_1@@1))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType2Select S (invRecv1 o_3@@2))) (< NoPerm FullPerm)) (qpRange1 o_3@@2)) (= (invRecv1 o_3@@2) o_3@@2)))
 :qid |stdinbpl.455:22|
 :skolemid |84|
...
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType2Select S (invRecv1 o_3@@3))) (< NoPerm FullPerm)) (qpRange1 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 k)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 k)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select S (invRecv1 o_3@@3))) (< NoPerm FullPerm)) (qpRange1 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 k)) (U_2_real (MapType1Select ZeroMask o_3@@3 k))))))
 :qid |stdinbpl.467:22|
 :skolemid |86|
...
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 a_2 $allocated))) (and (=> (= (ControlFlow 0 28) 1) anon15_Then_correct) (=> (= (ControlFlow 0 28) 26) anon15_Else_correct)))))
