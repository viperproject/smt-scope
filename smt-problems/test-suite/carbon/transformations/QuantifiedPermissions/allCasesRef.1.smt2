...
(assert (forall ((Heap@@3 T@U) (r@@0 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type r@@0) RefType)) (|p#everUsed| (p_1 r@@0)))
 :qid |stdinbpl.670:15|
 :skolemid |69|
 :pattern ( (|p#trigger| Heap@@3 (p_1 r@@0)))
)))
...
(assert (forall ((arg0@@35 T@U) ) (! (= (type (|pred#sm| arg0@@35)) (FieldType PredicateType_predType (MapType1Type RefType boolType)))
 :qid |funType:pred#sm|
 :pattern ( (|pred#sm| arg0@@35))
)))
...
(assert (forall ((r@@3 T@U) ) (!  (=> (= (type r@@3) RefType) (= (getPredWandId (p_1 r@@3)) 1))
 :qid |stdinbpl.655:15|
 :skolemid |66|
 :pattern ( (p_1 r@@3))
)))
