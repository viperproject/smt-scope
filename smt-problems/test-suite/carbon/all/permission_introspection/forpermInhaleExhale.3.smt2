...
(declare-fun x@@8 () T@U)
(assert  (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type r_5) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type x@@8) RefType)))
(set-info :boogie-vc-id test03a)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon5_correct true))
(let ((anon9_Else_correct  (=> (and (not (HasDirectPerm Mask@1 r_5 f_7)) (= (ControlFlow 0 7) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (HasDirectPerm Mask@1 r_5 f_7) (and (=> (= (ControlFlow 0 4) (- 0 6)) (HasDirectPerm Mask@0 r_5 f_7)) (=> (HasDirectPerm Mask@0 r_5 f_7) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@0 r_5 f_7)) (=> (HasDirectPerm Mask@0 r_5 f_7) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))))
