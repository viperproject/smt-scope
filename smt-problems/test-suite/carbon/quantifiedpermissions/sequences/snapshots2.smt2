...
(assert  (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type Heap@@21) (MapType0Type RefType))) (= (type x@@19) RefType)))
(set-info :boogie-vc-id |get01#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (HasDirectPerm Mask@0 (id Heap@@21 x@@19) f_7))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (and (and (not (= (id Heap@@21 x@@19) null)) (= Mask@0 (MapType1Store ZeroMask (id Heap@@21 x@@19) f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask (id Heap@@21 x@@19) f_7)) FullPerm))))) (and (state Heap@@21 Mask@0) (state Heap@@21 Mask@0))) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@21 ZeroMask) (U_2_bool (MapType0Select Heap@@21 x@@19 $allocated))) (and (= AssumeFunctionsAbove 1) (state Heap@@21 ZeroMask))) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct)))))
