...
(assert  (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type r_1@@11) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |p2#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 r_1@@11 $allocated))) (=> (and (and (not (= r_1@@11 null)) (= Mask@0 (MapType1Store ZeroMask r_1@@11 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1@@11 f_7)) FullPerm))))) (and (state Heap@@11 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@0 r_1@@11 f_7)))))
