...
(assert  (and (= (type s@@17) (SeqType intType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id wow)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (forall ((i_1 T@U) ) (!  (=> (= (type i_1) intType) (= (|Seq#Contains| s@@17 i_1) (> (U_2_int i_1) 5)))
 :qid |stdinbpl.559:20|
 :skolemid |58|
 :pattern ( (|Seq#ContainsTrigger| s@@17 i_1))
 :pattern ( (|Seq#Contains| s@@17 i_1))
)) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 3) (- 0 2))) (|Seq#Contains| s@@17 (int_2_U 7))))))
