...
(assert  (and (and (and (and (= (type a1) IArrayDomainTypeType) (= (type a2) IArrayDomainTypeType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon9_correct true))
(let ((anon15_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_5))) (= (ControlFlow 0 8) 5)) anon9_correct)))
(let ((anon15_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_5)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (not (= (loc a1 i_5) (loc a2 i_5)))) (=> (not (= (loc a1 i_5) (loc a2 i_5))) (=> (= (ControlFlow 0 6) 5) anon9_correct))))))
(let ((anon14_Else_correct true))
(let ((anon13_Then_correct true))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3_1))) (< NoPerm (/ (to_real 1) (to_real 3)))) (< NoPerm (/ (to_real 1) (to_real 3)))) (not (= (loc a2 i_3) (loc a2 i_3_1))))
 :qid |stdinbpl.893:15|
 :skolemid |88|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@0))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3_1@@0))) (< NoPerm (/ (to_real 1) (to_real 3)))) (< NoPerm (/ (to_real 1) (to_real 3)))) (not (= (loc a2 i_3@@0) (loc a2 i_3_1@@0))))
 :qid |stdinbpl.893:15|
 :skolemid |88|
)) (=> (and (forall ((i_3@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@1)) (< NoPerm (/ (to_real 1) (to_real 3)))) (and (qpRange5 (loc a2 i_3@@1)) (= (invRecv5 (loc a2 i_3@@1)) i_3@@1)))
 :qid |stdinbpl.899:22|
 :skolemid |89|
 :pattern ( (loc a2 i_3@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_3@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@1)))
 :pattern ( (loc a2 i_3@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv5 o_3))) (< NoPerm (/ (to_real 1) (to_real 3)))) (qpRange5 o_3)) (= (loc a2 (invRecv5 o_3)) o_3)))
 :qid |stdinbpl.903:22|
 :skolemid |90|
 :pattern ( (invRecv5 o_3))
))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_3@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@2)) (>= (/ (to_real 1) (to_real 3)) NoPerm))
 :qid |stdinbpl.909:15|
 :skolemid |91|
 :pattern ( (loc a2 i_3@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_3@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@2)))
 :pattern ( (loc a2 i_3@@2))
))) (=> (forall ((i_3@@3 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@3)) (>= (/ (to_real 1) (to_real 3)) NoPerm))
 :qid |stdinbpl.909:15|
 :skolemid |91|
 :pattern ( (loc a2 i_3@@3))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_3@@3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@3)))
 :pattern ( (loc a2 i_3@@3))
)) (=> (forall ((i_3@@4 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@4)) (> (/ (to_real 1) (to_real 3)) NoPerm)) (not (= (loc a2 i_3@@4) null)))
 :qid |stdinbpl.915:22|
 :skolemid |92|
 :pattern ( (loc a2 i_3@@4))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_3@@4)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@4)))
 :pattern ( (loc a2 i_3@@4))
)) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv5 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 3)))) (qpRange5 o_3@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 3))) (= (loc a2 (invRecv5 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 val)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (/ (to_real 1) (to_real 3)))))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv5 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 3)))) (qpRange5 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 val)) (U_2_real (MapType1Select QPMask@0 o_3@@0 val))))))
 :qid |stdinbpl.921:22|
 :skolemid |93|
...
))) (and (state Heap@@9 QPMask@1) (state Heap@@9 QPMask@1))) (and (and (and (=> (= (ControlFlow 0 9) 3) anon13_Then_correct) (=> (= (ControlFlow 0 9) 4) anon14_Else_correct)) (=> (= (ControlFlow 0 9) 6) anon15_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon15_Else_correct)))))))))))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 14)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1_1))) (< NoPerm (/ (to_real 1) (to_real 3)))) (< NoPerm (/ (to_real 1) (to_real 3)))) (not (= (loc a1 i_1) (loc a1 i_1_1))))
 :qid |stdinbpl.847:15|
 :skolemid |81|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@0))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1_1@@0))) (< NoPerm (/ (to_real 1) (to_real 3)))) (< NoPerm (/ (to_real 1) (to_real 3)))) (not (= (loc a1 i_1@@0) (loc a1 i_1_1@@0))))
 :qid |stdinbpl.847:15|
 :skolemid |81|
)) (=> (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@1)) (< NoPerm (/ (to_real 1) (to_real 3)))) (and (qpRange4 (loc a1 i_1@@1)) (= (invRecv4 (loc a1 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.853:22|
 :skolemid |82|
 :pattern ( (loc a1 i_1@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_1@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@1)))
 :pattern ( (loc a1 i_1@@1))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv4 o_3@@2))) (< NoPerm (/ (to_real 1) (to_real 3)))) (qpRange4 o_3@@2)) (= (loc a1 (invRecv4 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.857:22|
 :skolemid |83|
 :pattern ( (invRecv4 o_3@@2))
))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@2)) (>= (/ (to_real 1) (to_real 3)) NoPerm))
 :qid |stdinbpl.863:15|
 :skolemid |84|
 :pattern ( (loc a1 i_1@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_1@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@2)))
 :pattern ( (loc a1 i_1@@2))
))) (=> (forall ((i_1@@3 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@3)) (>= (/ (to_real 1) (to_real 3)) NoPerm))
 :qid |stdinbpl.863:15|
 :skolemid |84|
 :pattern ( (loc a1 i_1@@3))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_1@@3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@3)))
 :pattern ( (loc a1 i_1@@3))
)) (=> (forall ((i_1@@4 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@4)) (> (/ (to_real 1) (to_real 3)) NoPerm)) (not (= (loc a1 i_1@@4) null)))
 :qid |stdinbpl.869:22|
 :skolemid |85|
 :pattern ( (loc a1 i_1@@4))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_1@@4)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@4)))
 :pattern ( (loc a1 i_1@@4))
)) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv4 o_3@@3))) (< NoPerm (/ (to_real 1) (to_real 3)))) (qpRange4 o_3@@3)) (and (=> (< NoPerm (/ (to_real 1) (to_real 3))) (= (loc a1 (invRecv4 o_3@@3)) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 val)) (/ (to_real 1) (to_real 3)))))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv4 o_3@@3))) (< NoPerm (/ (to_real 1) (to_real 3)))) (qpRange4 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 val)) (U_2_real (MapType1Select ZeroMask o_3@@3 val))))))
 :qid |stdinbpl.875:22|
 :skolemid |86|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 12) 2) anon12_Then_correct) (=> (= (ControlFlow 0 12) 9) anon12_Else_correct)))))))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (not (= a1 a2)) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 15) 1) anon11_Then_correct) (=> (= (ControlFlow 0 15) 12) anon11_Else_correct))))))
