(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 19:41:59
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/basic/unique.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
; [eval] u2()
(push) ; 3
(assert (not (not (= (as u1<Test>  Test) (as u2<Test>  Test)))))
(check-sat)
; unsat
(pop) ; 3
; 0,00s
; (get-info :all-statistics)
(assert (not (= (as u1<Test>  Test) (as u2<Test>  Test))))
; [exec]
; assert c() != u1()
; [eval] c() != u1()
; [eval] c()
; [eval] u1()
(push) ; 3
(assert (not (not (= (as c<Test>  Test) (as u1<Test>  Test)))))
(check-sat)
; unknown
(pop) ; 3
; 0,00s
