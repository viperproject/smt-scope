...
(declare-fun i () Int)
(assert  (and (= (type m@@23) (MapType intType (MapType intType boolType))) (= (type Heap@@9) (MapType1Type RefType))))
(set-info :boogie-vc-id test5)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon9_correct true))
(let ((anon15_Else_correct  (=> (and (not (and (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i_2))) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U j))))) (= (ControlFlow 0 23) 19)) anon9_correct)))
(let ((anon15_Then_correct  (=> (and (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i_2))) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U j)))) (and (=> (= (ControlFlow 0 20) (- 0 22)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i_2)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i_2))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| m@@23) (int_2_U i_2))) (int_2_U j)))) (=> (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| m@@23) (int_2_U i_2))) (int_2_U j))) (=> (= (ControlFlow 0 20) 19) anon9_correct))))))))
(let ((anon14_Else_correct  (=> (and (forall ((i_5 T@U) (j_3 T@U) ) (!  (=> (and (and (= (type i_5) intType) (= (type j_3) intType)) (and (U_2_bool (MapType0Select (|Map#Domain| m@@23) i_5)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) j_3)))) (= (U_2_bool (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| m@@23) i_5)) j_3)) (= (U_2_int i_5) (U_2_int j_3))))
 :qid |stdinbpl.828:20|
 :skolemid |105|
 :pattern ( (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| m@@23) i_5)) j_3))
)) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 7) (- 0 18)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 2)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 2))) (and (=> (= (ControlFlow 0 7) (- 0 17)) (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| m@@23) (int_2_U 2))) (int_2_U 2)))) (=> (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| m@@23) (int_2_U 2))) (int_2_U 2))) (and (=> (= (ControlFlow 0 7) (- 0 16)) (U_2_bool (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| m@@23) (int_2_U 2))) (int_2_U 2)))) (=> (U_2_bool (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| m@@23) (int_2_U 2))) (int_2_U 2))) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 7) (- 0 15)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 1)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 1))) (and (=> (= (ControlFlow 0 7) (- 0 14)) (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| m@@23) (int_2_U 1))) (int_2_U 2)))) (=> (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| m@@23) (int_2_U 1))) (int_2_U 2))) (and (=> (= (ControlFlow 0 7) (- 0 13)) (not (U_2_bool (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| m@@23) (int_2_U 1))) (int_2_U 2))))) (=> (not (U_2_bool (MapType0Select (|Map#Elements| (MapType0Select (|Map#Elements| m@@23) (int_2_U 1))) (int_2_U 2)))) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 7) (- 0 12)) (|Set#Equal| (|Map#Domain| m@@23) (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| (|Set#Singleton| (int_2_U 3)) (int_2_U 2)) (int_2_U 1)) (int_2_U 0)))) (=> (|Set#Equal| (|Map#Domain| m@@23) (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| (|Set#Singleton| (int_2_U 3)) (int_2_U 2)) (int_2_U 1)) (int_2_U 0))) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 7) (- 0 11)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 0)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 0))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (|Set#Equal| (|Map#Domain| (MapType0Select (|Map#Elements| m@@23) (int_2_U 0))) (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| (|Set#Singleton| (int_2_U 3)) (int_2_U 2)) (int_2_U 1)) (int_2_U 0)))) (=> (|Set#Equal| (|Map#Domain| (MapType0Select (|Map#Elements| m@@23) (int_2_U 0))) (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| (|Set#Singleton| (int_2_U 3)) (int_2_U 2)) (int_2_U 1)) (int_2_U 0))) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 7) (- 0 9)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 2)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 2))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (|Map#Equal| (MapType0Select (|Map#Elements| m@@23) (int_2_U 2)) (|Map#Build| (|Map#Build| (|Map#Build| (|Map#Build| (|Map#Empty| intType boolType) (int_2_U 0) (bool_2_U false)) (int_2_U 1) (bool_2_U false)) (int_2_U 2) (bool_2_U true)) (int_2_U 3) (bool_2_U false)))) (=> (|Map#Equal| (MapType0Select (|Map#Elements| m@@23) (int_2_U 2)) (|Map#Build| (|Map#Build| (|Map#Build| (|Map#Build| (|Map#Empty| intType boolType) (int_2_U 0) (bool_2_U false)) (int_2_U 1) (bool_2_U false)) (int_2_U 2) (bool_2_U true)) (int_2_U 3) (bool_2_U false))) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 7) (- 0 6))) (U_2_bool (MapType0Select (|Map#Values| m@@23) (|Map#Build| (|Map#Build| (|Map#Build| (|Map#Build| (|Map#Empty| intType boolType) (int_2_U 0) (bool_2_U false)) (int_2_U 1) (bool_2_U false)) (int_2_U 2) (bool_2_U true)) (int_2_U 3) (bool_2_U false))))))))))))))))))))))))))))))))))
(let ((anon12_Else_correct  (=> (and (forall ((i_3 T@U) (j_1 T@U) ) (!  (=> (and (and (= (type i_3) intType) (= (type j_1) intType)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) i_3))) (=  (and (<= 0 (U_2_int j_1)) (< (U_2_int j_1) 4)) (U_2_bool (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| m@@23) i_3)) j_1))))
 :qid |stdinbpl.812:20|
 :skolemid |104|
 :pattern ( (MapType0Select (|Map#Domain| (MapType0Select (|Map#Elements| m@@23) i_3)) j_1))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 24) 7) anon14_Else_correct) (=> (= (ControlFlow 0 24) 20) anon15_Then_correct)) (=> (= (ControlFlow 0 24) 23) anon15_Else_correct)))))
(let ((anon5_correct true))
(let ((anon13_Else_correct  (=> (and (not (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i)))) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon13_Then_correct  (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i))) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon11_Else_correct  (=> (and (forall ((i_1 T@U) ) (!  (=> (= (type i_1) intType) (=  (and (<= 0 (U_2_int i_1)) (< (U_2_int i_1) 4)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) i_1))))
 :qid |stdinbpl.798:20|
 :skolemid |103|
 :pattern ( (MapType0Select (|Map#Domain| m@@23) i_1))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 25) 24) anon12_Else_correct) (=> (= (ControlFlow 0 25) 3) anon13_Then_correct)) (=> (= (ControlFlow 0 25) 5) anon13_Else_correct)))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 26) 1) anon11_Then_correct) (=> (= (ControlFlow 0 26) 25) anon11_Else_correct)))))
