...
(assert  (and (= (type Heap@@17) (MapType0Type RefType)) (= (type x@@18) RefType)))
(set-info :boogie-vc-id |len#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@17 x@@18 $allocated)) (= AssumeFunctionsAbove 1)) (and (= perm@0 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1)))) (>= perm@0 NoPerm)))))
