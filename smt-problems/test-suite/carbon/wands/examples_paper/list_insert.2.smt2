...
(declare-fun |elems#trigger| (T@U T@U) Bool)
...
(let ((anon19_Else_correct  (=> (= (MapType0Select Heap@1 xs@@13 next) null) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 7) 5)) anon13_correct))))
(let ((anon19_Then_correct  (=> (not (= (MapType0Select Heap@1 xs@@13 next) null)) (=> (and (and (forall ((o_3 T@U) (f_7 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_7))))
(let ((A@@12 (FieldTypeInv0 (type f_7))))
 (=> (and (and (= (type o_3) RefType) (= (type f_7) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|List#sm| xs@@13)) o_3 f_7)) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|List#sm| (MapType0Select Heap@1 xs@@13 next))) o_3 f_7)))) (U_2_bool (MapType1Select newPMask@0 o_3 f_7)))))
 :qid |stdinbpl.715:33|
 :skolemid |69|
 :pattern ( (MapType1Select newPMask@0 o_3 f_7))
)) (= Heap@2 (MapType0Store Heap@1 null (|List#sm| xs@@13) newPMask@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 6) 5))) anon13_correct))))
(let ((anon11_correct  (=> (and (= Heap@0 (MapType0Store Heap@@18 null (|List#sm| xs@@13) (MapType1Store (MapType0Select Heap@@18 null (|List#sm| xs@@13)) xs@@13 val (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|List#sm| xs@@13) (MapType1Store (MapType0Select Heap@0 null (|List#sm| xs@@13)) xs@@13 next (bool_2_U true))))) (and (=> (= (ControlFlow 0 8) 6) anon19_Then_correct) (=> (= (ControlFlow 0 8) 7) anon19_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (|elems#trigger| (MapType0Select Heap@@18 null (List (MapType0Select Heap@@18 xs@@13 next))) (MapType0Select Heap@@18 xs@@13 next)) (= (ControlFlow 0 10) 8)) anon11_correct)))
(let ((anon16_Then_correct  (=> (and (= (MapType0Select Heap@@18 xs@@13 next) null) (= (ControlFlow 0 9) 8)) anon11_correct)))
(let ((anon9_correct true))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon9_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (List (MapType0Select Heap@@18 xs@@13 next)))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (List (MapType0Select Heap@@18 xs@@13 next))))) (=> (= (ControlFlow 0 2) 1) anon9_correct))))))
(let ((anon16_Else_correct  (=> (not (= (MapType0Select Heap@@18 xs@@13 next) null)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm UnfoldingMask@4 xs@@13 next)) (=> (HasDirectPerm UnfoldingMask@4 xs@@13 next) (and (and (=> (= (ControlFlow 0 11) 10) anon17_Else_correct) (=> (= (ControlFlow 0 11) 2) anon18_Then_correct)) (=> (= (ControlFlow 0 11) 4) anon18_Else_correct)))))))
(let ((anon4_correct  (=> (state Heap@@18 UnfoldingMask@4) (and (=> (= (ControlFlow 0 13) (- 0 15)) (HasDirectPerm UnfoldingMask@4 xs@@13 val)) (=> (HasDirectPerm UnfoldingMask@4 xs@@13 val) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm UnfoldingMask@4 xs@@13 next)) (=> (HasDirectPerm UnfoldingMask@4 xs@@13 next) (and (=> (= (ControlFlow 0 13) 9) anon16_Then_correct) (=> (= (ControlFlow 0 13) 11) anon16_Else_correct)))))))))
(let ((anon15_Else_correct  (=> (= (MapType0Select Heap@@18 xs@@13 next) null) (=> (and (= UnfoldingMask@4 UnfoldingMask@2) (= (ControlFlow 0 17) 13)) anon4_correct))))
(let ((anon15_Then_correct  (=> (and (not (= (MapType0Select Heap@@18 xs@@13 next) null)) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 null (List (MapType0Select Heap@@18 xs@@13 next)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 null (List (MapType0Select Heap@@18 xs@@13 next)))) FullPerm))))) (=> (and (and (InsidePredicate (List xs@@13) (MapType0Select Heap@@18 null (List xs@@13)) (List (MapType0Select Heap@@18 xs@@13 next)) (MapType0Select Heap@@18 null (List (MapType0Select Heap@@18 xs@@13 next)))) (state Heap@@18 UnfoldingMask@3)) (and (= UnfoldingMask@4 UnfoldingMask@3) (= (ControlFlow 0 16) 13))) anon4_correct))))
(let ((anon2_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (List xs@@13) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (List xs@@13))) FullPerm)))) (=> (and (not (= xs@@13 null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 xs@@13 val (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 xs@@13 val)) FullPerm))))) (=> (and (and (state Heap@@18 UnfoldingMask@1) (not (= xs@@13 null))) (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 xs@@13 next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 xs@@13 next)) FullPerm)))) (state Heap@@18 UnfoldingMask@2))) (and (=> (= (ControlFlow 0 18) 16) anon15_Then_correct) (=> (= (ControlFlow 0 18) 17) anon15_Else_correct)))))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 21) 18)) anon2_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (List xs@@13))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (List xs@@13)))) (=> (= (ControlFlow 0 19) 18) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@18 ZeroMask) (U_2_bool (MapType0Select Heap@@18 xs@@13 $allocated))) (and (= AssumeFunctionsAbove 0) (= Mask@0 (MapType1Store ZeroMask null (List xs@@13) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (List xs@@13))) FullPerm)))))) (and (and (state Heap@@18 Mask@0) (state Heap@@18 Mask@0)) (and (|List#trigger| Heap@@18 (List xs@@13)) (= (MapType0Select Heap@@18 null (List xs@@13)) (CombineFrames (FrameFragment (MapType0Select Heap@@18 xs@@13 val)) (CombineFrames (FrameFragment (MapType0Select Heap@@18 xs@@13 next)) (FrameFragment (ite (not (= (MapType0Select Heap@@18 xs@@13 next) null)) (MapType0Select Heap@@18 null (List (MapType0Select Heap@@18 xs@@13 next))) EmptyFrame)))))))) (and (=> (= (ControlFlow 0 22) 19) anon14_Then_correct) (=> (= (ControlFlow 0 22) 21) anon14_Else_correct)))))
