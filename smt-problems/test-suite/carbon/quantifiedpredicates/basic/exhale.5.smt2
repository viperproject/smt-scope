...
(declare-fun pred2 (T@U Real) T@U)
...
(declare-fun pred1 (T@U) T@U)
(declare-fun PredicateType_pred1Type () T@T)
(declare-fun |pred1#trigger| (T@U T@U) Bool)
(declare-fun |pred1#everUsed| (T@U) Bool)
...
(declare-fun |pred2#sm| (T@U Real) T@U)
(declare-fun |pred1#sm| (T@U) T@U)
...
(assert  (and (and (= (Ctor PredicateType_pred2Type) 12) (= (Ctor FrameTypeType) 13)) (forall ((arg0@@26 T@U) (arg1@@10 Real) ) (! (= (type (pred2 arg0@@26 arg1@@10)) (FieldType PredicateType_pred2Type FrameTypeType))
 :qid |funType:pred2|
 :pattern ( (pred2 arg0@@26 arg1@@10))
))))
(assert (forall ((a_1 T@U) (p_1 Real) ) (!  (=> (= (type a_1) RefType) (IsPredicateField (pred2 a_1 p_1)))
 :qid |stdinbpl.657:15|
 :skolemid |65|
 :pattern ( (pred2 a_1 p_1))
)))
(assert (forall ((Heap@@0 T@U) (a_1@@0 T@U) (p_1@@0 Real) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type a_1@@0) RefType)) (|pred2#everUsed| (pred2 a_1@@0 p_1@@0)))
 :qid |stdinbpl.676:15|
 :skolemid |69|
 :pattern ( (|pred2#trigger| Heap@@0 (pred2 a_1@@0 p_1@@0)))
)))
...
(assert  (and (= (Ctor PredicateType_pred1Type) 14) (forall ((arg0@@30 T@U) ) (! (= (type (pred1 arg0@@30)) (FieldType PredicateType_pred1Type FrameTypeType))
 :qid |funType:pred1|
 :pattern ( (pred1 arg0@@30))
))))
(assert (forall ((a_1@@1 T@U) ) (!  (=> (= (type a_1@@1) RefType) (IsPredicateField (pred1 a_1@@1)))
 :qid |stdinbpl.604:15|
 :skolemid |59|
 :pattern ( (pred1 a_1@@1))
)))
(assert (forall ((Heap@@3 T@U) (a_1@@2 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type a_1@@2) RefType)) (|pred1#everUsed| (pred1 a_1@@2)))
 :qid |stdinbpl.623:15|
 :skolemid |63|
 :pattern ( (|pred1#trigger| Heap@@3 (pred1 a_1@@2)))
)))
...
(assert (forall ((a_1@@3 T@U) (p_1@@1 Real) (a2 T@U) (p2 Real) ) (!  (=> (and (and (= (type a_1@@3) RefType) (= (type a2) RefType)) (= (pred2 a_1@@3 p_1@@1) (pred2 a2 p2))) (and (= a_1@@3 a2) (= p_1@@1 p2)))
 :qid |stdinbpl.667:15|
 :skolemid |67|
 :pattern ( (pred2 a_1@@3 p_1@@1) (pred2 a2 p2))
)))
(assert (forall ((arg0@@35 T@U) (arg1@@15 Real) ) (! (= (type (|pred2#sm| arg0@@35 arg1@@15)) (FieldType PredicateType_pred2Type (MapType1Type RefType boolType)))
 :qid |funType:pred2#sm|
 :pattern ( (|pred2#sm| arg0@@35 arg1@@15))
)))
(assert (forall ((a_1@@4 T@U) (p_1@@2 Real) (a2@@0 T@U) (p2@@0 Real) ) (!  (=> (and (and (= (type a_1@@4) RefType) (= (type a2@@0) RefType)) (= (|pred2#sm| a_1@@4 p_1@@2) (|pred2#sm| a2@@0 p2@@0))) (and (= a_1@@4 a2@@0) (= p_1@@2 p2@@0)))
 :qid |stdinbpl.671:15|
 :skolemid |68|
 :pattern ( (|pred2#sm| a_1@@4 p_1@@2) (|pred2#sm| a2@@0 p2@@0))
)))
...
(assert (forall ((a_1@@5 T@U) (a2@@1 T@U) ) (!  (=> (and (and (= (type a_1@@5) RefType) (= (type a2@@1) RefType)) (= (pred1 a_1@@5) (pred1 a2@@1))) (= a_1@@5 a2@@1))
 :qid |stdinbpl.614:15|
 :skolemid |61|
 :pattern ( (pred1 a_1@@5) (pred1 a2@@1))
)))
(assert (forall ((arg0@@36 T@U) ) (! (= (type (|pred1#sm| arg0@@36)) (FieldType PredicateType_pred1Type (MapType1Type RefType boolType)))
 :qid |funType:pred1#sm|
 :pattern ( (|pred1#sm| arg0@@36))
)))
(assert (forall ((a_1@@6 T@U) (a2@@2 T@U) ) (!  (=> (and (and (= (type a_1@@6) RefType) (= (type a2@@2) RefType)) (= (|pred1#sm| a_1@@6) (|pred1#sm| a2@@2))) (= a_1@@6 a2@@2))
 :qid |stdinbpl.618:15|
 :skolemid |62|
 :pattern ( (|pred1#sm| a_1@@6) (|pred1#sm| a2@@2))
)))
...
(assert (forall ((a_1@@7 T@U) (p_1@@3 Real) ) (!  (=> (= (type a_1@@7) RefType) (= (getPredWandId (pred2 a_1@@7 p_1@@3)) 1))
 :qid |stdinbpl.661:15|
 :skolemid |66|
 :pattern ( (pred2 a_1@@7 p_1@@3))
)))
...
(assert (forall ((a_1@@8 T@U) ) (!  (=> (= (type a_1@@8) RefType) (= (getPredWandId (pred1 a_1@@8)) 0))
 :qid |stdinbpl.608:15|
 :skolemid |60|
 :pattern ( (pred1 a_1@@8))
)))
...
(assert (forall ((a_1@@9 T@U) (p_1@@4 Real) ) (!  (=> (= (type a_1@@9) RefType) (= (PredicateMaskField (pred2 a_1@@9 p_1@@4)) (|pred2#sm| a_1@@9 p_1@@4)))
 :qid |stdinbpl.653:15|
 :skolemid |64|
 :pattern ( (PredicateMaskField (pred2 a_1@@9 p_1@@4)))
)))
...
(assert (forall ((a_1@@10 T@U) ) (!  (=> (= (type a_1@@10) RefType) (= (PredicateMaskField (pred1 a_1@@10)) (|pred1#sm| a_1@@10)))
 :qid |stdinbpl.600:15|
 :skolemid |58|
 :pattern ( (PredicateMaskField (pred1 a_1@@10)))
)))
...
(let ((anon36_Else_correct  (=> (HasDirectPerm Mask@9 null (pred1 y@@2)) (=> (and (= Heap@14 ExhaleHeap@0) (= (ControlFlow 0 4) 2)) anon24_correct))))
(let ((anon36_Then_correct  (=> (and (and (not (HasDirectPerm Mask@9 null (pred1 y@@2))) (= Heap@13 (MapType0Store ExhaleHeap@0 null (pred1 y@@2) newVersion@2))) (and (= Heap@14 Heap@13) (= (ControlFlow 0 3) 2))) anon24_correct)))
(let ((anon22_correct  (=> (= Mask@9 (MapType1Store Mask@8 null (pred1 y@@2) (real_2_U (- (U_2_real (MapType1Select Mask@8 null (pred1 y@@2))) FullPerm)))) (and (=> (= (ControlFlow 0 5) 3) anon36_Then_correct) (=> (= (ControlFlow 0 5) 4) anon36_Else_correct)))))
(let ((anon35_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon22_correct)))
(let ((anon35_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@8 null (pred1 y@@2))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@8 null (pred1 y@@2)))) (=> (= (ControlFlow 0 6) 5) anon22_correct))))))
(let ((anon20_correct  (=> (= Mask@8 (MapType1Store Mask@7 null (pred1 y@@2) (real_2_U (- (U_2_real (MapType1Select Mask@7 null (pred1 y@@2))) FullPerm)))) (=> (and (and (IdenticalOnKnownLocations Heap@12 ExhaleHeap@0 Mask@8) (state ExhaleHeap@0 Mask@8)) (and (|pred1#trigger| ExhaleHeap@0 (pred1 y@@2)) (= (MapType0Select ExhaleHeap@0 null (pred1 y@@2)) (FrameFragment (MapType0Select ExhaleHeap@0 y@@2 f_7))))) (and (=> (= (ControlFlow 0 9) 6) anon35_Then_correct) (=> (= (ControlFlow 0 9) 8) anon35_Else_correct))))))
(let ((anon34_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon20_correct)))
(let ((anon34_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@7 null (pred1 y@@2))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@7 null (pred1 y@@2)))) (=> (= (ControlFlow 0 10) 9) anon20_correct))))))
(let ((anon18_correct  (=> (= Heap@12 (MapType0Store Heap@11 null (|pred1#sm| y@@2) (MapType1Store (MapType0Select Heap@11 null (|pred1#sm| y@@2)) y@@2 f_7 (bool_2_U true)))) (=> (and (state Heap@12 Mask@7) (state Heap@12 Mask@7)) (and (=> (= (ControlFlow 0 13) 10) anon34_Then_correct) (=> (= (ControlFlow 0 13) 12) anon34_Else_correct))))))
(let ((anon33_Else_correct  (=> (HasDirectPerm Mask@7 null (pred1 y@@2)) (=> (and (= Heap@11 Heap@8) (= (ControlFlow 0 15) 13)) anon18_correct))))
(let ((anon33_Then_correct  (=> (not (HasDirectPerm Mask@7 null (pred1 y@@2))) (=> (and (and (= Heap@9 (MapType0Store Heap@8 null (|pred1#sm| y@@2) ZeroPMask)) (= Heap@10 (MapType0Store Heap@9 null (pred1 y@@2) freshVersion@1))) (and (= Heap@11 Heap@10) (= (ControlFlow 0 14) 13))) anon18_correct))))
(let ((anon16_correct  (=> (and (= Mask@6 (MapType1Store Mask@5 y@@2 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@5 y@@2 f_7)) FullPerm)))) (= Mask@7 (MapType1Store Mask@6 null (pred1 y@@2) (real_2_U (+ (U_2_real (MapType1Select Mask@6 null (pred1 y@@2))) FullPerm))))) (=> (and (and (state Heap@8 Mask@7) (state Heap@8 Mask@7)) (and (|pred1#trigger| Heap@8 (pred1 y@@2)) (= (MapType0Select Heap@8 null (pred1 y@@2)) (FrameFragment (MapType0Select Heap@8 y@@2 f_7))))) (and (=> (= (ControlFlow 0 16) 14) anon33_Then_correct) (=> (= (ControlFlow 0 16) 15) anon33_Else_correct))))))
(let ((anon32_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 19) 16)) anon16_correct)))
(let ((anon32_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (<= FullPerm (U_2_real (MapType1Select Mask@5 y@@2 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@5 y@@2 f_7))) (=> (= (ControlFlow 0 17) 16) anon16_correct))))))
(let ((anon14_correct  (=> (not (= y@@2 null)) (=> (and (and (= Mask@5 (MapType1Store Mask@4 y@@2 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@4 y@@2 f_7)) FullPerm)))) (state Heap@8 Mask@5)) (and (state Heap@8 Mask@5) (state Heap@8 Mask@5))) (and (=> (= (ControlFlow 0 20) (- 0 22)) (HasDirectPerm Mask@5 y@@2 f_7)) (=> (HasDirectPerm Mask@5 y@@2 f_7) (and (=> (= (ControlFlow 0 20) (- 0 21)) (= (U_2_int (MapType0Select Heap@8 y@@2 f_7)) 1)) (=> (= (U_2_int (MapType0Select Heap@8 y@@2 f_7)) 1) (=> (state Heap@8 Mask@5) (and (=> (= (ControlFlow 0 20) 17) anon32_Then_correct) (=> (= (ControlFlow 0 20) 19) anon32_Else_correct)))))))))))
(let ((anon31_Else_correct  (=> (HasDirectPerm Mask@4 null (pred1 y@@2)) (=> (and (= Heap@8 Heap@6) (= (ControlFlow 0 24) 20)) anon14_correct))))
(let ((anon31_Then_correct  (=> (and (and (not (HasDirectPerm Mask@4 null (pred1 y@@2))) (= Heap@7 (MapType0Store Heap@6 null (pred1 y@@2) newVersion@1))) (and (= Heap@8 Heap@7) (= (ControlFlow 0 23) 20))) anon14_correct)))
(let ((anon12_correct  (=> (= Mask@4 (MapType1Store Mask@3 null (pred1 y@@2) (real_2_U (- (U_2_real (MapType1Select Mask@3 null (pred1 y@@2))) FullPerm)))) (and (=> (= (ControlFlow 0 25) 23) anon31_Then_correct) (=> (= (ControlFlow 0 25) 24) anon31_Else_correct)))))
(let ((anon30_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 28) 25)) anon12_correct)))
(let ((anon30_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (<= FullPerm (U_2_real (MapType1Select Mask@3 null (pred1 y@@2))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 null (pred1 y@@2)))) (=> (= (ControlFlow 0 26) 25) anon12_correct))))))
(let ((anon10_correct  (=> (= Heap@6 (MapType0Store Heap@5 null (|pred1#sm| y@@2) (MapType1Store (MapType0Select Heap@5 null (|pred1#sm| y@@2)) y@@2 f_7 (bool_2_U true)))) (=> (and (and (state Heap@6 Mask@3) (state Heap@6 Mask@3)) (and (|pred1#trigger| Heap@6 (pred1 y@@2)) (= (MapType0Select Heap@6 null (pred1 y@@2)) (FrameFragment (MapType0Select Heap@6 y@@2 f_7))))) (and (=> (= (ControlFlow 0 29) 26) anon30_Then_correct) (=> (= (ControlFlow 0 29) 28) anon30_Else_correct))))))
(let ((anon29_Else_correct  (=> (HasDirectPerm Mask@3 null (pred1 y@@2)) (=> (and (= Heap@5 Heap@2) (= (ControlFlow 0 31) 29)) anon10_correct))))
(let ((anon29_Then_correct  (=> (not (HasDirectPerm Mask@3 null (pred1 y@@2))) (=> (and (and (= Heap@3 (MapType0Store Heap@2 null (|pred1#sm| y@@2) ZeroPMask)) (= Heap@4 (MapType0Store Heap@3 null (pred1 y@@2) freshVersion@0))) (and (= Heap@5 Heap@4) (= (ControlFlow 0 30) 29))) anon10_correct))))
(let ((anon8_correct  (=> (and (= Mask@2 (MapType1Store Mask@1 y@@2 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 y@@2 f_7)) FullPerm)))) (= Mask@3 (MapType1Store Mask@2 null (pred1 y@@2) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (pred1 y@@2))) FullPerm))))) (=> (and (and (state Heap@2 Mask@3) (state Heap@2 Mask@3)) (and (|pred1#trigger| Heap@2 (pred1 y@@2)) (= (MapType0Select Heap@2 null (pred1 y@@2)) (FrameFragment (MapType0Select Heap@2 y@@2 f_7))))) (and (=> (= (ControlFlow 0 32) 30) anon29_Then_correct) (=> (= (ControlFlow 0 32) 31) anon29_Else_correct))))))
(let ((anon28_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 35) 32)) anon8_correct)))
(let ((anon28_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 33) (- 0 34)) (<= FullPerm (U_2_real (MapType1Select Mask@1 y@@2 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 y@@2 f_7))) (=> (= (ControlFlow 0 33) 32) anon8_correct))))))
(let ((anon6_correct  (=> (not (= y@@2 null)) (=> (and (and (= Mask@1 (MapType1Store Mask@0 y@@2 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@2 f_7)) FullPerm)))) (state Heap@1 Mask@1)) (and (state Heap@1 Mask@1) (state Heap@1 Mask@1))) (and (=> (= (ControlFlow 0 36) (- 0 37)) (= FullPerm (U_2_real (MapType1Select Mask@1 y@@2 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 y@@2 f_7))) (=> (and (= Heap@2 (MapType0Store Heap@1 y@@2 f_7 (int_2_U 1))) (state Heap@2 Mask@1)) (and (=> (= (ControlFlow 0 36) 33) anon28_Then_correct) (=> (= (ControlFlow 0 36) 35) anon28_Else_correct)))))))))
(let ((anon27_Else_correct  (=> (HasDirectPerm Mask@0 null (pred1 y@@2)) (=> (and (= Heap@1 Heap@@11) (= (ControlFlow 0 39) 36)) anon6_correct))))
(let ((anon27_Then_correct  (=> (and (and (not (HasDirectPerm Mask@0 null (pred1 y@@2))) (= Heap@0 (MapType0Store Heap@@11 null (pred1 y@@2) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 38) 36))) anon6_correct)))
(let ((anon4_correct  (=> (= Mask@0 (MapType1Store QPMask@0 null (pred1 y@@2) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (pred1 y@@2))) FullPerm)))) (and (=> (= (ControlFlow 0 40) 38) anon27_Then_correct) (=> (= (ControlFlow 0 40) 39) anon27_Else_correct)))))
(let ((anon26_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 43) 40)) anon4_correct)))
(let ((anon26_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 41) (- 0 42)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (pred1 y@@2))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (pred1 y@@2)))) (=> (= (ControlFlow 0 41) 40) anon4_correct))))))
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 44) (- 0 45)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| xs x_1)) (|Seq#Contains| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.1720:17|
 :skolemid |127|
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| xs x_1@@1) (< NoPerm FullPerm)) (and (= (invRecv10 x_1@@1) x_1@@1) (qpRange10 x_1@@1))))
 :qid |stdinbpl.1726:22|
 :skolemid |128|
 :pattern ( (MapType0Select Heap@@11 null (pred1 x_1@@1)))
 :pattern ( (MapType1Select ZeroMask null (pred1 x_1@@1)))
 :pattern ( (|Seq#ContainsTrigger| xs x_1@@1))
 :pattern ( (|Seq#Contains| xs x_1@@1))
)) (=> (and (and (and (forall ((a_1@@11 T@U) ) (!  (=> (= (type a_1@@11) RefType) (=> (and (and (|Seq#Contains| xs (invRecv10 a_1@@11)) (< NoPerm FullPerm)) (qpRange10 a_1@@11)) (= (invRecv10 a_1@@11) a_1@@11)))
 :qid |stdinbpl.1730:22|
 :skolemid |129|
 :pattern ( (invRecv10 a_1@@11))
)) (forall ((a_1@@12 T@U) ) (!  (=> (= (type a_1@@12) RefType) (=> (and (and (|Seq#Contains| xs (invRecv10 a_1@@12)) (< NoPerm FullPerm)) (qpRange10 a_1@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv10 a_1@@12) a_1@@12)) (= (U_2_real (MapType1Select QPMask@0 null (pred1 a_1@@12))) (+ (U_2_real (MapType1Select ZeroMask null (pred1 a_1@@12))) FullPerm)))))
 :qid |stdinbpl.1736:22|
 :skolemid |130|
 :pattern ( (MapType1Select QPMask@0 null (pred1 a_1@@12)))
...
)) (forall ((a_1@@13 T@U) ) (!  (=> (and (= (type a_1@@13) RefType) (not (and (and (|Seq#Contains| xs (invRecv10 a_1@@13)) (< NoPerm FullPerm)) (qpRange10 a_1@@13)))) (= (U_2_real (MapType1Select QPMask@0 null (pred1 a_1@@13))) (U_2_real (MapType1Select ZeroMask null (pred1 a_1@@13)))))
 :qid |stdinbpl.1746:22|
 :skolemid |132|
 :pattern ( (MapType1Select QPMask@0 null (pred1 a_1@@13)))
)))) (and (and (state Heap@@11 QPMask@0) (state Heap@@11 QPMask@0)) (and (|pred1#trigger| Heap@@11 (pred1 y@@2)) (= (MapType0Select Heap@@11 null (pred1 y@@2)) (FrameFragment (MapType0Select Heap@@11 y@@2 f_7)))))) (and (=> (= (ControlFlow 0 44) 41) anon26_Then_correct) (=> (= (ControlFlow 0 44) 43) anon26_Else_correct))))))))
(let ((anon25_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 y@@2 $allocated))) (=> (and (and (|Seq#Contains| xs y@@2) (state Heap@@11 ZeroMask)) (and (not (= y@@2 null)) (state Heap@@11 ZeroMask))) (and (=> (= (ControlFlow 0 46) 1) anon25_Then_correct) (=> (= (ControlFlow 0 46) 44) anon25_Else_correct))))))
