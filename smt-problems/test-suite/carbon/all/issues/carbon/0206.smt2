...
(declare-fun |elements'| (T@U T@U) T@U)
(declare-fun ArrayDomainTypeType () T@T)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |elements#triggerStateless| (T@U) T@U)
...
(declare-fun |elements#condqp1| (T@U T@U) Int)
(declare-fun |sk_elements#condqp1| (Int Int) Int)
(declare-fun FullPerm () Real)
(declare-fun |MultiSet#Empty| (T@T) T@U)
(declare-fun AssumeFunctionsAbove () Int)
(declare-fun |elements#trigger| (T@U T@U) Bool)
(declare-fun FrameFragment (T@U) T@U)
(declare-fun |Set#Empty| (T@T) T@U)
(declare-fun |elements#frame| (T@U T@U) T@U)
...
(assert  (and (and (and (and (and (and (and (and (and (= (Ctor ArrayDomainTypeType) 14) (forall ((arg0@@34 T@T) (arg1@@14 T@T) ) (! (= (Ctor (MapType2Type arg0@@34 arg1@@14)) 15)
...
(= (type (MapType2Store arg0@@38 arg1@@18 arg2@@3)) (MapType2Type aVar0@@1 aVar1@@3))))
 ...
 :weight 0
)))) (forall ((arg0@@39 T@U) (arg1@@19 T@U) ) (! (= (type (|elements'| arg0@@39 arg1@@19)) (MapType2Type intType boolType))
 :qid |funType:elements'|
 :pattern ( (|elements'| arg0@@39 arg1@@19))
))) (forall ((arg0@@40 T@U) ) (! (= (type (|elements#triggerStateless| arg0@@40)) (MapType2Type intType boolType))
 :qid |funType:elements#triggerStateless|
 :pattern ( (|elements#triggerStateless| arg0@@40))
))))
(assert (forall ((Heap@@2 T@U) (this T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type this) ArrayDomainTypeType)) (dummyFunction (|elements#triggerStateless| this)))
 :qid |stdinbpl.824:15|
 :skolemid |121|
 :pattern ( (|elements'| Heap@@2 this))
)))
(assert (forall ((arg0@@41 T@U) (arg1@@20 Int) (arg2@@4 T@U) ) (! (let ((T@@7 (type arg2@@4)))
(= (type (|Seq#Update| arg0@@41 arg1@@20 arg2@@4)) (SeqType T@@7)))
 :qid |funType:Seq#Update|
 :pattern ( (|Seq#Update| arg0@@41 arg1@@20 arg2@@4))
)))
...
(assert (forall ((arg0@@42 T@U) (arg1@@21 T@U) ) (! (let ((T@@10 (MapType2TypeInv0 (type arg0@@42))))
(= (type (|Set#Union| arg0@@42 arg1@@21)) (MapType2Type T@@10 boolType)))
...
(assert (forall ((arg0@@43 T@U) (arg1@@22 T@U) ) (! (let ((T@@12 (MapType2TypeInv0 (type arg0@@43))))
(= (type (|Set#Intersection| arg0@@43 arg1@@22)) (MapType2Type T@@12 boolType)))
...
(assert (forall ((arg0@@45 T@U) (arg1@@23 Int) ) (! (let ((T@@17 (SeqTypeInv0 (type arg0@@45))))
(= (type (|Seq#Take| arg0@@45 arg1@@23)) (SeqType T@@17)))
 :qid |funType:Seq#Take|
 :pattern ( (|Seq#Take| arg0@@45 arg1@@23))
)))
...
(assert (forall ((arg0@@46 Int) (arg1@@24 Int) ) (! (= (type (|Seq#Range| arg0@@46 arg1@@24)) (SeqType intType))
 :qid |funType:Seq#Range|
 :pattern ( (|Seq#Range| arg0@@46 arg1@@24))
)))
...
(assert (forall ((arg0@@47 T@U) (arg1@@25 T@U) ) (! (= (type (elements arg0@@47 arg1@@25)) (MapType2Type intType boolType))
 :qid |funType:elements|
 :pattern ( (elements arg0@@47 arg1@@25))
)))
(assert (forall ((Heap@@4 T@U) (this@@0 T@U) ) (!  (=> (and (= (type Heap@@4) (MapType0Type RefType)) (= (type this@@0) ArrayDomainTypeType)) (and (= (elements Heap@@4 this@@0) (|elements'| Heap@@4 this@@0)) (dummyFunction (|elements#triggerStateless| this@@0))))
 :qid |stdinbpl.820:15|
 :skolemid |120|
 :pattern ( (elements Heap@@4 this@@0))
)))
...
(assert  (and (forall ((arg0@@53 T@U) (arg1@@29 Int) ) (! (= (type (loc arg0@@53 arg1@@29)) RefType)
 :qid |funType:loc|
 :pattern ( (loc arg0@@53 arg1@@29))
)) (forall ((arg0@@54 T@U) ) (! (= (type (first arg0@@54)) ArrayDomainTypeType)
 :qid |funType:first|
 :pattern ( (first arg0@@54))
))))
...
(assert (forall ((arg0@@55 T@U) (arg1@@30 T@U) ) (! (let ((T@@40 (MapType2TypeInv0 (type arg0@@55))))
(= (type (|Set#Difference| arg0@@55 arg1@@30)) (MapType2Type T@@40 boolType)))
 :qid |funType:Set#Difference|
 :pattern ( (|Set#Difference| arg0@@55 arg1@@30))
)))
...
(assert (forall ((arg0@@56 T@U) (arg1@@31 T@U) ) (! (let ((T@@45 (type arg1@@31)))
(= (type (|Set#UnionOne| arg0@@56 arg1@@31)) (MapType2Type T@@45 boolType)))
 :qid |funType:Set#UnionOne|
 :pattern ( (|Set#UnionOne| arg0@@56 arg1@@31))
)))
...
(assert (forall ((Heap2Heap T@U) (Heap1Heap T@U) (this@@1 T@U) ) (!  (=> (and (and (and (= (type Heap2Heap) (MapType0Type RefType)) (= (type Heap1Heap) (MapType0Type RefType))) (= (type this@@1) ArrayDomainTypeType)) (and (=  (and (|Seq#Contains| (|Seq#Range| 0 (length this@@1)) (int_2_U (|sk_elements#condqp1| (|elements#condqp1| Heap2Heap this@@1) (|elements#condqp1| Heap1Heap this@@1)))) (< NoPerm FullPerm))  (and (|Seq#Contains| (|Seq#Range| 0 (length this@@1)) (int_2_U (|sk_elements#condqp1| (|elements#condqp1| Heap2Heap this@@1) (|elements#condqp1| Heap1Heap this@@1)))) (< NoPerm FullPerm))) (=> (and (|Seq#Contains| (|Seq#Range| 0 (length this@@1)) (int_2_U (|sk_elements#condqp1| (|elements#condqp1| Heap2Heap this@@1) (|elements#condqp1| Heap1Heap this@@1)))) (< NoPerm FullPerm)) (= (U_2_int (MapType0Select Heap2Heap (loc this@@1 (|sk_elements#condqp1| (|elements#condqp1| Heap2Heap this@@1) (|elements#condqp1| Heap1Heap this@@1))) val)) (U_2_int (MapType0Select Heap1Heap (loc this@@1 (|sk_elements#condqp1| (|elements#condqp1| Heap2Heap this@@1) (|elements#condqp1| Heap1Heap this@@1))) val)))))) (= (|elements#condqp1| Heap2Heap this@@1) (|elements#condqp1| Heap1Heap this@@1)))
 :qid |stdinbpl.841:15|
 :skolemid |123|
 :pattern ( (|elements#condqp1| Heap2Heap this@@1) (|elements#condqp1| Heap1Heap this@@1) (succHeapTrans Heap2Heap Heap1Heap))
)))
...
(assert (forall ((arg0@@57 T@U) ) (! (= (type (FrameFragment arg0@@57)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@57))
)))
(assert (forall ((Heap@@9 T@U) (Mask@@9 T@U) (this@@2 T@U) ) (!  (=> (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (= (type this@@2) ArrayDomainTypeType)) (and (state Heap@@9 Mask@@9) (or (< AssumeFunctionsAbove 0) (|elements#trigger| (FrameFragment (int_2_U (|elements#condqp1| Heap@@9 this@@2))) this@@2)))) (forall ((i_2_1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (length this@@2)) (int_2_U i_2_1)) (U_2_bool (MapType2Select (|elements'| Heap@@9 this@@2) (MapType0Select Heap@@9 (loc this@@2 i_2_1) val))))
 :qid |stdinbpl.849:134|
 :skolemid |124|
 :pattern ( (MapType0Select Heap@@9 (loc this@@2 i_2_1) val))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (length this@@2)) (int_2_U i_2_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (length this@@2)) (int_2_U i_2_1)))
)))
 :qid |stdinbpl.847:15|
 :skolemid |125|
 :pattern ( (state Heap@@9 Mask@@9) (|elements'| Heap@@9 this@@2))
)))
...
(assert (forall ((arg0@@58 T@U) (arg1@@32 T@U) ) (! (= (type (|elements#frame| arg0@@58 arg1@@32)) (MapType2Type intType boolType))
 :qid |funType:elements#frame|
 :pattern ( (|elements#frame| arg0@@58 arg1@@32))
)))
(assert (forall ((Heap@@11 T@U) (Mask@@10 T@U) (this@@3 T@U) ) (!  (=> (and (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type this@@3) ArrayDomainTypeType)) (state Heap@@11 Mask@@10)) (= (|elements'| Heap@@11 this@@3) (|elements#frame| (FrameFragment (int_2_U (|elements#condqp1| Heap@@11 this@@3))) this@@3)))
 :qid |stdinbpl.831:15|
 :skolemid |122|
 :pattern ( (state Heap@@11 Mask@@10) (|elements'| Heap@@11 this@@3))
)))
...
(assert (forall ((Heap@@12 T@U) (o@@11 T@U) (f_3 T@U) (v@@2 T@U) ) (! (let ((B@@8 (type v@@2)))
(let ((A@@9 (FieldTypeInv0 (type f_3))))
 (=> (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type o@@11) RefType)) (= (type f_3) (FieldType A@@9 B@@8))) (succHeap Heap@@12 (MapType0Store Heap@@12 o@@11 f_3 v@@2)))))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (MapType0Store Heap@@12 o@@11 f_3 v@@2))
)))
...
(declare-fun y@@7 () Int)
(assert  (and (and (and (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type a_3@@1) ArrayDomainTypeType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type QPMask@3) (MapType1Type RefType realType))))
(set-info :boogie-vc-id swap)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((anon20_Else_correct true))
(let ((anon20_Then_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((i_5 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5 i_5_1)) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_5))) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_5) (loc a_3@@1 i_5_1))))
 :qid |stdinbpl.1118:21|
 :skolemid |151|
 :pattern ( (neverTriggered5 i_5) (neverTriggered5 i_5_1))
))) (=> (forall ((i_5@@0 Int) (i_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_5@@0 i_5_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_5@@0))) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_5_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_5@@0) (loc a_3@@1 i_5_1@@0))))
 :qid |stdinbpl.1118:21|
 :skolemid |151|
 :pattern ( (neverTriggered5 i_5@@0) (neverTriggered5 i_5_1@@0))
)) (=> (= (ControlFlow 0 19) (- 0 18)) (forall ((i_5@@1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_5@@1)) (>= (U_2_real (MapType1Select QPMask@0 (loc a_3@@1 i_5@@1) val)) FullPerm))
 :qid |stdinbpl.1125:21|
 :skolemid |152|
 :pattern ( (loc a_3@@1 i_5@@1))
 :pattern ( (MapType0Select Heap@@13 (loc a_3@@1 i_5@@1) val))
)))))))
(let ((anon19_Then_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((i_4 Int) (i_4_1 Int) ) (!  (=> (and (and (and (and (not (= i_4 i_4_1)) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_4))) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_4) (loc a_3@@1 i_4_1))))
 :qid |stdinbpl.1066:21|
 :skolemid |145|
 :pattern ( (neverTriggered4 i_4) (neverTriggered4 i_4_1))
))) (=> (forall ((i_4@@0 Int) (i_4_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_4@@0 i_4_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_4@@0))) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_4_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_4@@0) (loc a_3@@1 i_4_1@@0))))
 :qid |stdinbpl.1066:21|
 :skolemid |145|
 :pattern ( (neverTriggered4 i_4@@0) (neverTriggered4 i_4_1@@0))
)) (=> (= (ControlFlow 0 16) (- 0 15)) (forall ((i_4@@1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_4@@1)) (>= (U_2_real (MapType1Select QPMask@3 (loc a_3@@1 i_4@@1) val)) FullPerm))
 :qid |stdinbpl.1073:21|
 :skolemid |146|
 :pattern ( (loc a_3@@1 i_4@@1))
 :pattern ( (MapType0Select PostHeap@0 (loc a_3@@1 i_4@@1) val))
)))))))
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 22) (- 0 23)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_3))) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_3) (loc a_3@@1 i_3_1))))
 :qid |stdinbpl.1019:15|
 :skolemid |139|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_3@@0))) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_3@@0) (loc a_3@@1 i_3_1@@0))))
 :qid |stdinbpl.1019:15|
 :skolemid |139|
)) (=> (and (and (and (forall ((i_3@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_3@@1)) (< NoPerm FullPerm)) (and (qpRange3 (loc a_3@@1 i_3@@1)) (= (invRecv3 (loc a_3@@1 i_3@@1)) i_3@@1)))
 :qid |stdinbpl.1025:22|
 :skolemid |140|
 :pattern ( (loc a_3@@1 i_3@@1))
 :pattern ( (MapType0Select PostHeap@0 (loc a_3@@1 i_3@@1) val))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U (invRecv3 o_3))) (< NoPerm FullPerm)) (qpRange3 o_3)) (= (loc a_3@@1 (invRecv3 o_3)) o_3)))
 :qid |stdinbpl.1029:22|
 :skolemid |141|
 :pattern ( (invRecv3 o_3))
))) (and (forall ((i_3@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_3@@2)) (not (= (loc a_3@@1 i_3@@2) null)))
 :qid |stdinbpl.1035:22|
 :skolemid |142|
 :pattern ( (loc a_3@@1 i_3@@2))
 :pattern ( (MapType0Select PostHeap@0 (loc a_3@@1 i_3@@2) val))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U (invRecv3 o_3@@0))) (< NoPerm FullPerm)) (qpRange3 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@1 (invRecv3 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@3 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U (invRecv3 o_3@@0))) (< NoPerm FullPerm)) (qpRange3 o_3@@0))) (= (U_2_real (MapType1Select QPMask@3 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 val))) (= (U_2_real (MapType1Select ZeroMask o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@3 o_3@@1 f_5))))))
 :qid |stdinbpl.1045:29|
 :skolemid |144|
...
(let ((anon23_Then_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((i_7 Int) (i_7_1 Int) ) (!  (=> (and (and (and (and (not (= i_7 i_7_1)) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_7))) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_7_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_7) (loc a_3@@1 i_7_1))))
 :qid |stdinbpl.1181:25|
 :skolemid |157|
 :pattern ( (neverTriggered7 i_7) (neverTriggered7 i_7_1))
))) (=> (forall ((i_7@@0 Int) (i_7_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_7@@0 i_7_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_7@@0))) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_7_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_7@@0) (loc a_3@@1 i_7_1@@0))))
 :qid |stdinbpl.1181:25|
 :skolemid |157|
 :pattern ( (neverTriggered7 i_7@@0) (neverTriggered7 i_7_1@@0))
)) (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((i_7@@1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_7@@1)) (>= (U_2_real (MapType1Select QPMask@0 (loc a_3@@1 i_7@@1) val)) FullPerm))
 :qid |stdinbpl.1188:25|
 :skolemid |158|
 :pattern ( (loc a_3@@1 i_7@@1))
 :pattern ( (MapType0Select Heap@@13 (loc a_3@@1 i_7@@1) val))
)))))))
(let ((anon14_correct true))
(let ((anon22_Then_correct  (=> (and (<= 0 j@@5) (< j@@5 (length a_3@@1))) (and (=> (= (ControlFlow 0 12) 10) anon23_Then_correct) (=> (= (ControlFlow 0 12) 7) anon14_correct)))))
(let ((anon22_Else_correct  (=> (and (not (and (<= 0 j@@5) (< j@@5 (length a_3@@1)))) (= (ControlFlow 0 8) 7)) anon14_correct)))
(let ((anon21_Else_correct  (=> (forall ((j_1 T@U) ) (!  (=> (= (type j_1) intType) (=> (and (<= 0 (U_2_int j_1)) (< (U_2_int j_1) (length a_3@@1))) (dummy (U_2_bool (MapType2Select (elements Heap@@13 a_3@@1) j_1)))))
 :qid |stdinbpl.1225:20|
 :skolemid |163|
 :pattern ( (MapType2Select (|elements#frame| (FrameFragment (int_2_U (|elements#condqp1| Heap@@13 a_3@@1))) a_3@@1) j_1))
)) (=> (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (= FullPerm (U_2_real (MapType1Select QPMask@0 (loc a_3@@1 x@@22) val)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 (loc a_3@@1 x@@22) val))) (=> (and (= Heap@0 (MapType0Store Heap@@13 (loc a_3@@1 x@@22) val (int_2_U (- 0 77)))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((i_6 Int) (i_6_1 Int) ) (!  (=> (and (and (and (and (not (= i_6 i_6_1)) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_6))) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_6_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_6) (loc a_3@@1 i_6_1))))
 :qid |stdinbpl.1248:17|
 :skolemid |164|
 :pattern ( (neverTriggered6 i_6) (neverTriggered6 i_6_1))
))) (=> (forall ((i_6@@0 Int) (i_6_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_6@@0 i_6_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_6@@0))) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_6_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_6@@0) (loc a_3@@1 i_6_1@@0))))
 :qid |stdinbpl.1248:17|
 :skolemid |164|
 :pattern ( (neverTriggered6 i_6@@0) (neverTriggered6 i_6_1@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((i_6@@1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_6@@1)) (>= (U_2_real (MapType1Select QPMask@0 (loc a_3@@1 i_6@@1) val)) FullPerm))
 :qid |stdinbpl.1255:17|
 :skolemid |165|
 :pattern ( (loc a_3@@1 i_6@@1))
 :pattern ( (MapType0Select Heap@0 (loc a_3@@1 i_6@@1) val))
))) (=> (forall ((i_6@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_6@@2)) (>= (U_2_real (MapType1Select QPMask@0 (loc a_3@@1 i_6@@2) val)) FullPerm))
 :qid |stdinbpl.1255:17|
 :skolemid |165|
 :pattern ( (loc a_3@@1 i_6@@2))
 :pattern ( (MapType0Select Heap@0 (loc a_3@@1 i_6@@2) val))
)) (=> (forall ((i_6@@3 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_6@@3)) (< NoPerm FullPerm)) (and (qpRange6 (loc a_3@@1 i_6@@3)) (= (invRecv6 (loc a_3@@1 i_6@@3)) i_6@@3)))
 :qid |stdinbpl.1261:22|
 :skolemid |166|
 :pattern ( (loc a_3@@1 i_6@@3))
 :pattern ( (MapType0Select Heap@0 (loc a_3@@1 i_6@@3) val))
)) (=> (and (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U (invRecv6 o_3@@2))) (and (< NoPerm FullPerm) (qpRange6 o_3@@2))) (= (loc a_3@@1 (invRecv6 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.1265:22|
 :skolemid |167|
 :pattern ( (invRecv6 o_3@@2))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U (invRecv6 o_3@@3))) (and (< NoPerm FullPerm) (qpRange6 o_3@@3))) (and (= (loc a_3@@1 (invRecv6 o_3@@3)) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 val)) (- (U_2_real (MapType1Select QPMask@0 o_3@@3 val)) FullPerm)))) (=> (not (and (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U (invRecv6 o_3@@3))) (and (< NoPerm FullPerm) (qpRange6 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 val)) (U_2_real (MapType1Select QPMask@0 o_3@@3 val))))))
...
)) (= (ControlFlow 0 3) (- 0 2)))) (|Set#Equal| (elements Heap@0 a_3@@1) (elements Heap@@13 a_3@@1)))))))))))))))
(let ((anon17_Else_correct  (=> (state Heap@@13 QPMask@0) (and (and (=> (= (ControlFlow 0 13) 3) anon21_Else_correct) (=> (= (ControlFlow 0 13) 12) anon22_Then_correct)) (=> (= (ControlFlow 0 13) 8) anon22_Else_correct)))))
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_1) (loc a_3@@1 i_1_1))))
 :qid |stdinbpl.962:15|
 :skolemid |133|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_1@@0))) (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_1@@0) (loc a_3@@1 i_1_1@@0))))
 :qid |stdinbpl.962:15|
 :skolemid |133|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_1@@1)) (< NoPerm FullPerm)) (and (qpRange2 (loc a_3@@1 i_1@@1)) (= (invRecv2 (loc a_3@@1 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.968:22|
 :skolemid |134|
 :pattern ( (loc a_3@@1 i_1@@1))
 :pattern ( (MapType0Select Heap@@13 (loc a_3@@1 i_1@@1) val))
)) (=> (and (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U (invRecv2 o_3@@5))) (< NoPerm FullPerm)) (qpRange2 o_3@@5)) (= (loc a_3@@1 (invRecv2 o_3@@5)) o_3@@5)))
 :qid |stdinbpl.972:22|
 :skolemid |135|
 :pattern ( (invRecv2 o_3@@5))
)) (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U i_1@@2)) (not (= (loc a_3@@1 i_1@@2) null)))
 :qid |stdinbpl.978:22|
 :skolemid |136|
 :pattern ( (loc a_3@@1 i_1@@2))
 :pattern ( (MapType0Select Heap@@13 (loc a_3@@1 i_1@@2) val))
))) (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U (invRecv2 o_3@@6))) (< NoPerm FullPerm)) (qpRange2 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@1 (invRecv2 o_3@@6)) o_3@@6)) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@6 val)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 (length a_3@@1)) (int_2_U (invRecv2 o_3@@6))) (< NoPerm FullPerm)) (qpRange2 o_3@@6))) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 val)) (U_2_real (MapType1Select ZeroMask o_3@@6 val))))))
 :qid |stdinbpl.984:22|
 :skolemid |137|
...
)))) (=> (and (and (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)) (and (<= 0 x@@22) (< x@@22 (length a_3@@1)))) (and (and (state Heap@@13 QPMask@0) (<= 0 y@@7)) (and (< y@@7 (length a_3@@1)) (state Heap@@13 QPMask@0)))) (and (=> (= (ControlFlow 0 25) 24) anon17_Then_correct) (=> (= (ControlFlow 0 25) 13) anon17_Else_correct)))))))))
(let ((anon16_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 27) 1) anon16_Then_correct) (=> (= (ControlFlow 0 27) 25) anon16_Else_correct)))))
