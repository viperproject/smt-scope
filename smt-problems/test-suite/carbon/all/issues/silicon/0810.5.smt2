...
(assert  (and (and (= (type Heap@@33) (MapType0Type RefType)) (= (type self@@14) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |list___len__#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@33 self@@14 $allocated)) (= AssumeFunctionsAbove 3)) (and (> wildcard@0 NoPerm) (not (= self@@14 null)))) (and (and (= Mask@0 (MapType1Store ZeroMask self@@14 list_acc (real_2_U (+ (U_2_real (MapType1Select ZeroMask self@@14 list_acc)) wildcard@0)))) (state Heap@@33 Mask@0)) (and (state Heap@@33 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm Mask@0 self@@14 list_acc)))))
