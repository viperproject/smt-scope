...
(assert  (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type s@@17) (SeqType RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test02ProofObligation)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@1 (|Seq#Index| s@@17 i_3) f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 (|Seq#Index| s@@17 i_3) f_7))) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (> (|Seq#Length| s@@17) 2)) (and (=> (= (ControlFlow 0 5) (- 0 9)) (< 0 (|Seq#Length| s@@17))) (=> (< 0 (|Seq#Length| s@@17)) (=> (not (= (|Seq#Index| s@@17 0) null)) (=> (and (= Mask@0 (MapType1Store ZeroMask (|Seq#Index| s@@17 0) f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask (|Seq#Index| s@@17 0) f_7)) FullPerm)))) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 5) (- 0 8)) (< 1 (|Seq#Length| s@@17))) (=> (< 1 (|Seq#Length| s@@17)) (=> (not (= (|Seq#Index| s@@17 1) null)) (=> (and (and (and (= Mask@1 (MapType1Store Mask@0 (|Seq#Index| s@@17 1) f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 (|Seq#Index| s@@17 1) f_7)) FullPerm)))) (state Heap@@9 Mask@1)) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1))) (and (and (<= 0 i_3) (< i_3 2)) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1)))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (>= i_3 0)) (=> (>= i_3 0) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< i_3 (|Seq#Length| s@@17))) (=> (< i_3 (|Seq#Length| s@@17)) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))))))))))))))
