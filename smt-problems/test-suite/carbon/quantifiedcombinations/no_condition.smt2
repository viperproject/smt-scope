...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type xs) (SeqType RefType)) (= (type r@@5) RefType)) (= (type Heap@1) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type QPMask@2) (MapType1Type RefType realType))) (forall ((arg0@@37 T@U) ) (! (= (type (invRecv11 arg0@@37)) RefType)
 :qid |funType:invRecv11|
 :pattern ( (invRecv11 arg0@@37))
))) (= (type ys) (SeqType RefType))) (forall ((arg0@@38 T@U) ) (! (= (type (invRecv12 arg0@@38)) RefType)
 :qid |funType:invRecv12|
 :pattern ( (invRecv12 arg0@@38))
))) (= (type QPMask@3) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type QPMask@5) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type QPMask@4) (MapType1Type RefType realType))) (forall ((arg0@@39 T@U) ) (! (= (type (invRecv10 arg0@@39)) RefType)
 :qid |funType:invRecv10|
 :pattern ( (invRecv10 arg0@@39))
))) (forall ((arg0@@40 T@U) ) (! (= (type (invRecv9 arg0@@40)) RefType)
 :qid |funType:invRecv9|
 :pattern ( (invRecv9 arg0@@40))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@41 T@U) ) (! (= (type (invRecv8 arg0@@41)) RefType)
 :qid |funType:invRecv8|
 :pattern ( (invRecv8 arg0@@41))
))) (forall ((arg0@@42 T@U) ) (! (= (type (invRecv7 arg0@@42)) RefType)
 :qid |funType:invRecv7|
 :pattern ( (invRecv7 arg0@@42))
))))
...
(let ((anon22_Else_correct  (=> (and (not (|Seq#Contains| xs r@@5)) (= (ControlFlow 0 20) 17)) anon11_correct)))
(let ((anon22_Then_correct  (=> (|Seq#Contains| xs r@@5) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm QPMask@5 r@@5 f_7)) (=> (HasDirectPerm QPMask@5 r@@5 f_7) (=> (and (= (U_2_int (MapType0Select PostHeap@0 r@@5 f_7)) 4) (= (ControlFlow 0 18) 17)) anon11_correct))))))
(let ((anon21_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((x_8 T@U) (x_8_1 T@U) ) (!  (=> (and (= (type x_8) RefType) (= (type x_8_1) RefType)) (=> (and (and (and (and (not (= x_8 x_8_1)) (|Seq#Contains| ys x_8)) (|Seq#Contains| ys x_8_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_8 x_8_1))))
 :qid |stdinbpl.1168:17|
 :skolemid |119|
...
)) (=> (forall ((x_8@@1 T@U) ) (!  (=> (= (type x_8@@1) RefType) (=> (and (|Seq#Contains| ys x_8@@1) (< NoPerm FullPerm)) (and (= (invRecv10 x_8@@1) x_8@@1) (qpRange10 x_8@@1))))
...
)) (=> (and (forall ((r_2_1 T@U) ) (!  (=> (= (type r_2_1) RefType) (=> (and (and (|Seq#Contains| ys (invRecv10 r_2_1)) (< NoPerm FullPerm)) (qpRange10 r_2_1)) (= (invRecv10 r_2_1) r_2_1)))
 :qid |stdinbpl.1178:22|
 :skolemid |121|
 :pattern ( (invRecv10 r_2_1))
)) (forall ((r_2_1@@0 T@U) ) (!  (=> (= (type r_2_1@@0) RefType) (=> (and (and (|Seq#Contains| ys (invRecv10 r_2_1@@0)) (< NoPerm FullPerm)) (qpRange10 r_2_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv10 r_2_1@@0) r_2_1@@0)) (= (U_2_real (MapType1Select QPMask@5 null (p_1 r_2_1@@0))) (+ (U_2_real (MapType1Select QPMask@4 null (p_1 r_2_1@@0))) FullPerm)))))
...
)) (forall ((r_2_1@@1 T@U) ) (!  (=> (and (= (type r_2_1@@1) RefType) (not (and (and (|Seq#Contains| ys (invRecv10 r_2_1@@1)) (< NoPerm FullPerm)) (qpRange10 r_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@5 null (p_1 r_2_1@@1))) (U_2_real (MapType1Select QPMask@4 null (p_1 r_2_1@@1)))))
...
(let ((anon20_Else_correct  (and (=> (= (ControlFlow 0 23) (- 0 24)) (forall ((x_6 T@U) (x_6_1 T@U) ) (!  (=> (and (= (type x_6) RefType) (= (type x_6_1) RefType)) (=> (and (and (and (and (not (= x_6 x_6_1)) (|Seq#Contains| xs x_6)) (|Seq#Contains| xs x_6_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_6 x_6_1))))
...
)) (=> (and (forall ((x_6@@1 T@U) ) (!  (=> (= (type x_6@@1) RefType) (=> (and (|Seq#Contains| xs x_6@@1) (< NoPerm FullPerm)) (and (qpRange9 x_6@@1) (= (invRecv9 x_6@@1) x_6@@1))))
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (=> (and (and (|Seq#Contains| xs (invRecv9 o_3@@0)) (< NoPerm FullPerm)) (qpRange9 o_3@@0)) (= (invRecv9 o_3@@0) o_3@@0)))
 :qid |stdinbpl.1137:22|
 :skolemid |115|
 :pattern ( (invRecv9 o_3@@0))
...
)) (forall ((o_3@@1 T@U) ) (!  (=> (= (type o_3@@1) RefType) (and (=> (and (and (|Seq#Contains| xs (invRecv9 o_3@@1)) (< NoPerm FullPerm)) (qpRange9 o_3@@1)) (and (=> (< NoPerm FullPerm) (= (invRecv9 o_3@@1) o_3@@1)) (= (U_2_real (MapType1Select QPMask@4 o_3@@1 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@1 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| xs (invRecv9 o_3@@1)) (< NoPerm FullPerm)) (qpRange9 o_3@@1))) (= (U_2_real (MapType1Select QPMask@4 o_3@@1 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@1 f_7))))))
...
(let ((anon24_Else_correct  (=> (and (not (|Seq#Contains| xs r@@5)) (= (ControlFlow 0 6) 3)) anon16_correct)))
(let ((anon24_Then_correct  (=> (|Seq#Contains| xs r@@5) (and (=> (= (ControlFlow 0 4) (- 0 5)) (= (U_2_int (MapType0Select Heap@1 r@@5 f_7)) 4)) (=> (= (U_2_int (MapType0Select Heap@1 r@@5 f_7)) 4) (=> (= (ControlFlow 0 4) 3) anon16_correct))))))
(let ((anon14_correct  (=> (state Heap@1 QPMask@1) (and (=> (= (ControlFlow 0 7) (- 0 11)) (forall ((x_10 T@U) (x_10_1 T@U) ) (!  (=> (and (= (type x_10) RefType) (= (type x_10_1) RefType)) (=> (and (and (and (and (not (= x_10 x_10_1)) (|Seq#Contains| xs x_10)) (|Seq#Contains| xs x_10_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_10 x_10_1))))
 :qid |stdinbpl.1234:17|
 :skolemid |125|
 :pattern ( (neverTriggered11 x_10) (neverTriggered11 x_10_1))
 ...
 :qid |stdinbpl.1234:17|
 :skolemid |125|
 :pattern ( (neverTriggered11 x_10@@0) (neverTriggered11 x_10_1@@0))
)) (and (=> (= (ControlFlow 0 7) (- 0 10)) (forall ((x_10@@1 T@U) ) (!  (=> (and (= (type x_10@@1) RefType) (|Seq#Contains| xs x_10@@1)) (>= (U_2_real (MapType1Select QPMask@1 x_10@@1 f_7)) FullPerm))
...
))) (=> (forall ((x_10@@2 T@U) ) (!  (=> (and (= (type x_10@@2) RefType) (|Seq#Contains| xs x_10@@2)) (>= (U_2_real (MapType1Select QPMask@1 x_10@@2 f_7)) FullPerm))
 :qid |stdinbpl.1241:17|
 :skolemid |126|
...
)) (=> (and (and (forall ((x_10@@3 T@U) ) (!  (=> (= (type x_10@@3) RefType) (=> (and (|Seq#Contains| xs x_10@@3) (< NoPerm FullPerm)) (and (qpRange11 x_10@@3) (= (invRecv11 x_10@@3) x_10@@3))))
...
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (=> (and (|Seq#Contains| xs (invRecv11 o_3@@3)) (and (< NoPerm FullPerm) (qpRange11 o_3@@3))) (= (invRecv11 o_3@@3) o_3@@3)))
 :qid |stdinbpl.1251:22|
 :skolemid |128|
 :pattern ( (invRecv11 o_3@@3))
))) (and (forall ((o_3@@4 T@U) ) (!  (=> (= (type o_3@@4) RefType) (and (=> (and (|Seq#Contains| xs (invRecv11 o_3@@4)) (and (< NoPerm FullPerm) (qpRange11 o_3@@4))) (and (= (invRecv11 o_3@@4) o_3@@4) (= (U_2_real (MapType1Select QPMask@2 o_3@@4 f_7)) (- (U_2_real (MapType1Select QPMask@1 o_3@@4 f_7)) FullPerm)))) (=> (not (and (|Seq#Contains| xs (invRecv11 o_3@@4)) (and (< NoPerm FullPerm) (qpRange11 o_3@@4)))) (= (U_2_real (MapType1Select QPMask@2 o_3@@4 f_7)) (U_2_real (MapType1Select QPMask@1 o_3@@4 f_7))))))
...
(let ((A@@14 (FieldTypeInv0 (type f_5@@1))))
 (=> (and (and (= (type o_3@@5) RefType) (= (type f_5@@1) (FieldType A@@14 B@@13))) (not (= f_5@@1 f_7))) (= (U_2_real (MapType1Select QPMask@1 o_3@@5 f_5@@1)) (U_2_real (MapType1Select QPMask@2 o_3@@5 f_5@@1))))))
 :qid |stdinbpl.1263:29|
 :skolemid |130|
 :pattern ( (MapType1Select QPMask@2 o_3@@5 f_5@@1))
)))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((x_11 T@U) (x_11_1 T@U) ) (!  (=> (and (= (type x_11) RefType) (= (type x_11_1) RefType)) (=> (and (and (and (and (not (= x_11 x_11_1)) (|Seq#Contains| ys x_11)) (|Seq#Contains| ys x_11_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_11 x_11_1))))
...
)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((x_11@@1 T@U) ) (!  (=> (and (= (type x_11@@1) RefType) (|Seq#Contains| ys x_11@@1)) (>= (U_2_real (MapType1Select QPMask@2 null (p_1 x_11@@1))) FullPerm))
 :qid |stdinbpl.1282:17|
 :skolemid |132|
 :pattern ( (MapType0Select Heap@1 null (p_1 x_11@@1)))
 ...
 :qid |stdinbpl.1282:17|
 :skolemid |132|
 :pattern ( (MapType0Select Heap@1 null (p_1 x_11@@2)))
 :pattern ( (MapType1Select QPMask@2 null (p_1 x_11@@2)))
 :pattern ( (|Seq#ContainsTrigger| ys x_11@@2))
 :pattern ( (|Seq#Contains| ys x_11@@2))
)) (=> (forall ((x_11@@3 T@U) ) (!  (=> (= (type x_11@@3) RefType) (=> (and (|Seq#Contains| ys x_11@@3) (< NoPerm FullPerm)) (and (= (invRecv12 x_11@@3) x_11@@3) (qpRange12 x_11@@3))))
 :qid |stdinbpl.1288:22|
 :skolemid |133|
 :pattern ( (MapType0Select Heap@1 null (p_1 x_11@@3)))
 :pattern ( (MapType1Select QPMask@2 null (p_1 x_11@@3)))
 :pattern ( (|Seq#ContainsTrigger| ys x_11@@3))
 :pattern ( (|Seq#Contains| ys x_11@@3))
)) (=> (and (and (forall ((r_3_1 T@U) ) (!  (=> (= (type r_3_1) RefType) (=> (and (and (|Seq#Contains| ys (invRecv12 r_3_1)) (< NoPerm FullPerm)) (qpRange12 r_3_1)) (= (invRecv12 r_3_1) r_3_1)))
 :qid |stdinbpl.1292:22|
 :skolemid |134|
 :pattern ( (invRecv12 r_3_1))
)) (forall ((r_3_1@@0 T@U) ) (!  (=> (= (type r_3_1@@0) RefType) (=> (and (and (|Seq#Contains| ys (invRecv12 r_3_1@@0)) (< NoPerm FullPerm)) (qpRange12 r_3_1@@0)) (and (= (invRecv12 r_3_1@@0) r_3_1@@0) (= (U_2_real (MapType1Select QPMask@3 null (p_1 r_3_1@@0))) (- (U_2_real (MapType1Select QPMask@2 null (p_1 r_3_1@@0))) FullPerm)))))
 :qid |stdinbpl.1298:22|
 :skolemid |135|
 :pattern ( (MapType1Select QPMask@3 null (p_1 r_3_1@@0)))
))) (and (forall ((r_3_1@@1 T@U) ) (!  (=> (and (= (type r_3_1@@1) RefType) (not (and (and (|Seq#Contains| ys (invRecv12 r_3_1@@1)) (< NoPerm FullPerm)) (qpRange12 r_3_1@@1)))) (= (U_2_real (MapType1Select QPMask@3 null (p_1 r_3_1@@1))) (U_2_real (MapType1Select QPMask@2 null (p_1 r_3_1@@1)))))
...
(let ((anon23_Else_correct  (=> (not (|Seq#Contains| xs r@@5)) (=> (and (= Heap@1 Heap@@10) (= (ControlFlow 0 14) 7)) anon14_correct))))
(let ((anon23_Then_correct  (=> (|Seq#Contains| xs r@@5) (and (=> (= (ControlFlow 0 12) (- 0 13)) (= FullPerm (U_2_real (MapType1Select QPMask@1 r@@5 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@1 r@@5 f_7))) (=> (and (and (= Heap@0 (MapType0Store Heap@@10 r@@5 f_7 (int_2_U 4))) (state Heap@0 QPMask@1)) (and (= Heap@1 Heap@0) (= (ControlFlow 0 12) 7))) anon14_correct))))))
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (|Seq#Contains| ys x_3)) (|Seq#Contains| ys x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1))))
...
)) (=> (forall ((x_3@@1 T@U) ) (!  (=> (= (type x_3@@1) RefType) (=> (and (|Seq#Contains| ys x_3@@1) (< NoPerm FullPerm)) (and (= (invRecv8 x_3@@1) x_3@@1) (qpRange8 x_3@@1))))
...
)) (=> (and (forall ((r_1_1 T@U) ) (!  (=> (= (type r_1_1) RefType) (=> (and (and (|Seq#Contains| ys (invRecv8 r_1_1)) (< NoPerm FullPerm)) (qpRange8 r_1_1)) (= (invRecv8 r_1_1) r_1_1)))
 :qid |stdinbpl.1086:22|
 :skolemid |109|
 :pattern ( (invRecv8 r_1_1))
)) (forall ((r_1_1@@0 T@U) ) (!  (=> (= (type r_1_1@@0) RefType) (=> (and (and (|Seq#Contains| ys (invRecv8 r_1_1@@0)) (< NoPerm FullPerm)) (qpRange8 r_1_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv8 r_1_1@@0) r_1_1@@0)) (= (U_2_real (MapType1Select QPMask@1 null (p_1 r_1_1@@0))) (+ (U_2_real (MapType1Select QPMask@0 null (p_1 r_1_1@@0))) FullPerm)))))
...
)) (forall ((r_1_1@@1 T@U) ) (!  (=> (and (= (type r_1_1@@1) RefType) (not (and (and (|Seq#Contains| ys (invRecv8 r_1_1@@1)) (< NoPerm FullPerm)) (qpRange8 r_1_1@@1)))) (= (U_2_real (MapType1Select QPMask@1 null (p_1 r_1_1@@1))) (U_2_real (MapType1Select QPMask@0 null (p_1 r_1_1@@1)))))
 :qid |stdinbpl.1102:22|
 :skolemid |112|
 :pattern ( (MapType1Select QPMask@1 null (p_1 r_1_1@@1)))
))) (and (state Heap@@10 QPMask@1) (state Heap@@10 QPMask@1))) (and (and (=> (= (ControlFlow 0 26) 25) anon19_Then_correct) (=> (= (ControlFlow 0 26) 12) anon23_Then_correct)) (=> (= (ControlFlow 0 26) 14) anon23_Else_correct)))))))))
(let ((anon18_Then_correct true))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 29)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| xs x_1)) (|Seq#Contains| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
...
)) (=> (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| xs x_1@@1) (< NoPerm FullPerm)) (and (qpRange7 x_1@@1) (= (invRecv7 x_1@@1) x_1@@1))))
...
)) (forall ((o_3@@8 T@U) ) (!  (=> (= (type o_3@@8) RefType) (=> (and (and (|Seq#Contains| xs (invRecv7 o_3@@8)) (< NoPerm FullPerm)) (qpRange7 o_3@@8)) (= (invRecv7 o_3@@8) o_3@@8)))
...
)) (forall ((o_3@@9 T@U) ) (!  (=> (= (type o_3@@9) RefType) (and (=> (and (and (|Seq#Contains| xs (invRecv7 o_3@@9)) (< NoPerm FullPerm)) (qpRange7 o_3@@9)) (and (=> (< NoPerm FullPerm) (= (invRecv7 o_3@@9) o_3@@9)) (= (U_2_real (MapType1Select QPMask@0 o_3@@9 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@9 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| xs (invRecv7 o_3@@9)) (< NoPerm FullPerm)) (qpRange7 o_3@@9))) (= (U_2_real (MapType1Select QPMask@0 o_3@@9 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@9 f_7))))))
...
)) (state Heap@@10 QPMask@0))) (and (=> (= (ControlFlow 0 28) 2) anon18_Then_correct) (=> (= (ControlFlow 0 28) 26) anon18_Else_correct))))))))
(let ((anon17_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 r@@5 $allocated))) (and (=> (= (ControlFlow 0 30) 1) anon17_Then_correct) (=> (= (ControlFlow 0 30) 28) anon17_Else_correct)))))
