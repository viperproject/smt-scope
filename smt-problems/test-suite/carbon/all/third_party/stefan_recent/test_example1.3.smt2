...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@3) (MapType1Type RefType realType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type __flatten_1@0) RefType)) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type ExhaleHeap@1) (MapType0Type RefType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type diz) RefType)) (= (type c) RefType)) (= (type __flatten_1) RefType)))
(set-info :boogie-vc-id Main__main)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon4_correct  (=> (and (and (and (= Mask@3 (MapType1Store Mask@2 __flatten_1@0 Counter__x (real_2_U (- (U_2_real (MapType1Select Mask@2 __flatten_1@0 Counter__x)) FullPerm)))) (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@1 Mask@3)) (and (not (= __flatten_1@0 null)) (= Mask@4 (MapType1Store Mask@3 __flatten_1@0 Counter__x (real_2_U (+ (U_2_real (MapType1Select Mask@3 __flatten_1@0 Counter__x)) FullPerm)))))) (and (and (state ExhaleHeap@1 Mask@4) (= (U_2_int (MapType0Select ExhaleHeap@1 __flatten_1@0 Counter__x)) (+ (U_2_int (MapType0Select ExhaleHeap@0 __flatten_1@0 Counter__x)) 1))) (and (state ExhaleHeap@1 Mask@4) (state ExhaleHeap@1 Mask@4)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@4 __flatten_1@0 Counter__x)) (=> (HasDirectPerm Mask@4 __flatten_1@0 Counter__x) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (MapType0Select ExhaleHeap@1 __flatten_1@0 Counter__x)) 17)))))))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 2)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@2 __flatten_1@0 Counter__x)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 __flatten_1@0 Counter__x))) (=> (= (ControlFlow 0 4) 2) anon4_correct))))))
(let ((anon2_correct  (=> (and (and (and (= Mask@1 (MapType1Store Mask@0 __flatten_1@0 Counter__x (real_2_U (- (U_2_real (MapType1Select Mask@0 __flatten_1@0 Counter__x)) FullPerm)))) (IdenticalOnKnownLocations Heap@0 ExhaleHeap@0 Mask@1)) (and (not (= __flatten_1@0 null)) (= Mask@2 (MapType1Store Mask@1 __flatten_1@0 Counter__x (real_2_U (+ (U_2_real (MapType1Select Mask@1 __flatten_1@0 Counter__x)) FullPerm)))))) (and (and (state ExhaleHeap@0 Mask@2) (= (U_2_int (MapType0Select ExhaleHeap@0 __flatten_1@0 Counter__x)) (+ (U_2_int (MapType0Select Heap@0 __flatten_1@0 Counter__x)) 1))) (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)))) (and (=> (= (ControlFlow 0 7) (- 0 11)) (HasDirectPerm Mask@2 __flatten_1@0 Counter__x)) (=> (HasDirectPerm Mask@2 __flatten_1@0 Counter__x) (and (=> (= (ControlFlow 0 7) (- 0 10)) (= (U_2_int (MapType0Select ExhaleHeap@0 __flatten_1@0 Counter__x)) 17)) (=> (= (U_2_int (MapType0Select ExhaleHeap@0 __flatten_1@0 Counter__x)) 17) (=> (state ExhaleHeap@0 Mask@2) (and (=> (= (ControlFlow 0 7) (- 0 9)) (not (= __flatten_1@0 null))) (=> (not (= __flatten_1@0 null)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))))))))))
(let ((anon5_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 14) 7)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (U_2_real (MapType1Select Mask@0 __flatten_1@0 Counter__x)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 __flatten_1@0 Counter__x))) (=> (= (ControlFlow 0 12) 7) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 diz $allocated))) (and (not (= diz null)) (state Heap@@9 ZeroMask))) (and (and (>= current_thread_id 0) (state Heap@@9 ZeroMask)) (and (U_2_bool (MapType0Select Heap@@9 c $allocated)) (U_2_bool (MapType0Select Heap@@9 __flatten_1 $allocated))))) (and (=> (= (ControlFlow 0 15) (- 0 19)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (=> (not (= __flatten_1@0 null)) (=> (and (not (= __flatten_1@0 null)) (= Mask@0 (MapType1Store ZeroMask __flatten_1@0 Counter__x (real_2_U (+ (U_2_real (MapType1Select ZeroMask __flatten_1@0 Counter__x)) FullPerm))))) (=> (and (and (and (state Heap@@9 Mask@0) (= (U_2_int (MapType0Select Heap@@9 __flatten_1@0 Counter__x)) 0)) (and (state Heap@@9 Mask@0) (U_2_bool (MapType0Select Heap@@9 __flatten_1@0 $allocated)))) (and (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)))) (and (=> (= (ControlFlow 0 15) (- 0 18)) (= FullPerm (U_2_real (MapType1Select Mask@0 __flatten_1@0 Counter__x)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 __flatten_1@0 Counter__x))) (=> (and (= Heap@0 (MapType0Store Heap@@9 __flatten_1@0 Counter__x (int_2_U 16))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 15) (- 0 17)) (not (= __flatten_1@0 null))) (=> (not (= __flatten_1@0 null)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (and (=> (= (ControlFlow 0 15) 12) anon5_Then_correct) (=> (= (ControlFlow 0 15) 14) anon5_Else_correct)))))))))))))))))
