...
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i_26 0)) (=> (>= i_26 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i_26 (|Seq#Length| ar))) (=> (< i_26 (|Seq#Length| ar)) (=> (and (= perm@0 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@0 NoPerm)))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 this $allocated)) (<= 0 i_26)) (and (< i_26 (|Seq#Length| ar)) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 7) 2) anon5_Then_correct) (=> (= (ControlFlow 0 7) 6) anon5_Else_correct))))))
