...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon8_correct  (=> (and (and (and (state Heap@@9 Mask@2) b_2) (and (state Heap@@9 Mask@2) (state Heap@@9 Mask@2))) (and (and (not (= x@@8 y@@1)) (state Heap@@9 Mask@2)) (and (state Heap@@9 Mask@2) (= (ControlFlow 0 2) (- 0 1))))) false)))
