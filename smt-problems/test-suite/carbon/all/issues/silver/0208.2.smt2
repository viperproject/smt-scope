...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (= (- i_1@@1 1) j)) (=> (and (and (and (state Heap@@10 ZeroMask) (state Heap@@10 ZeroMask)) (and (< 0 m@@7) (state Heap@@10 ZeroMask))) (and (and (state Heap@@10 ZeroMask) (<= m@@7 j)) (and (state Heap@@10 ZeroMask) (state Heap@@10 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< 0 m@@7)) (=> (< 0 m@@7) (=> (= (ControlFlow 0 2) (- 0 1)) (<= m@@7 (- i_1@@1 1)))))))))
