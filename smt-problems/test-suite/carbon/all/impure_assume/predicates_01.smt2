...
(set-info :boogie-vc-id test00_same_tight_second)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@10 x@@14 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (P x@@14 i@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@14 i@@5))) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (=> (and (and (and (state Heap@@10 Mask@0) (<= (/ (to_real 2) (to_real 3)) (U_2_real (MapType1Select Mask@0 null (P x@@14 i@@5))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (and (<= (__iar__assume_helper_1  (and (= x@@14 x@@14) (= i@@5 i@@5)) (/ (to_real 2) (to_real 3)) (/ (to_real 1) (to_real 3))) (U_2_real (MapType1Select Mask@0 null (P x@@14 i@@5)))) (state Heap@@10 Mask@0)) (and (state Heap@@10 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) false)))))
