...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon4_correct  (=> (state Heap@1 Mask@4) (=> (and (state Heap@1 Mask@4) (= (ControlFlow 0 2) (- 0 1))) (not (= list@@10 null))))))
(let ((anon6_Else_correct  (=> (= (MapType0Select Heap@1 list@@10 next) null) (=> (and (= Mask@4 Mask@2) (= (ControlFlow 0 4) 2)) anon4_correct))))
(let ((anon6_Then_correct  (=> (not (= (MapType0Select Heap@1 list@@10 next) null)) (=> (and (> wildcard@3 NoPerm) (= Mask@3 (MapType1Store Mask@2 null (valid (MapType0Select Heap@1 list@@10 next)) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (valid (MapType0Select Heap@1 list@@10 next)))) wildcard@3))))) (=> (and (and (InsidePredicate (valid list@@10) (MapType0Select Heap@1 null (valid list@@10)) (valid (MapType0Select Heap@1 list@@10 next)) (MapType0Select Heap@1 null (valid (MapType0Select Heap@1 list@@10 next)))) (state Heap@1 Mask@3)) (and (= Mask@4 Mask@3) (= (ControlFlow 0 3) 2))) anon4_correct)))))
(let ((anon2_correct  (=> (and (and (> wildcard@2 NoPerm) (not (= list@@10 null))) (and (= Mask@2 (MapType1Store Mask@1 list@@10 next (real_2_U (+ (U_2_real (MapType1Select Mask@1 list@@10 next)) wildcard@2)))) (state Heap@1 Mask@2))) (and (=> (= (ControlFlow 0 5) 3) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (HasDirectPerm Mask@1 null (valid list@@10)) (=> (and (= Heap@1 Heap@@15) (= (ControlFlow 0 7) 5)) anon2_correct))))
(let ((anon5_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (valid list@@10))) (= Heap@0 (MapType0Store Heap@@15 null (valid list@@10) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 6) 5))) anon2_correct)))
(let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@15 list@@10 $allocated))) (and (> wildcard@0 NoPerm) (= Mask@0 (MapType1Store ZeroMask null (valid list@@10) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid list@@10))) wildcard@0)))))) (and (and (state Heap@@15 Mask@0) (state Heap@@15 Mask@0)) (and (|valid#trigger| Heap@@15 (valid list@@10)) (= (MapType0Select Heap@@15 null (valid list@@10)) (CombineFrames (FrameFragment (MapType0Select Heap@@15 list@@10 next)) (FrameFragment (ite (not (= (MapType0Select Heap@@15 list@@10 next) null)) (MapType0Select Heap@@15 null (valid (MapType0Select Heap@@15 list@@10 next))) EmptyFrame))))))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (> (U_2_real (MapType1Select Mask@0 null (valid list@@10))) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@0 null (valid list@@10))) NoPerm) (=> (> wildcard@1 NoPerm) (=> (and (< wildcard@1 (U_2_real (MapType1Select Mask@0 null (valid list@@10)))) (= Mask@1 (MapType1Store Mask@0 null (valid list@@10) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid list@@10))) wildcard@1))))) (and (=> (= (ControlFlow 0 8) 6) anon5_Then_correct) (=> (= (ControlFlow 0 8) 7) anon5_Else_correct))))))))))
