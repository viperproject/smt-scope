...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@5) (MapType0Type RefType)) (= (type freshObj@0) RefType)) (= (type ExhaleWellDef0Mask@0) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (forall ((arg0@@35 T@U) ) (! (= (type (FrameFragment arg0@@35)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@35))
))) (= (type Heap@@37) (MapType0Type RefType))) (= (type x@@48) RefType)) (= (type Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test5)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon7_correct  (=> (and (= ExhaleWellDef0Mask@0 (MapType1Store Mask@2 null (F freshObj@0) (real_2_U (- (U_2_real (MapType1Select Mask@2 null (F freshObj@0))) FullPerm)))) (= (ControlFlow 0 4) (- 0 3))) (not (= freshObj@0 null)))))
(let ((anon12_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 4)) anon7_correct)))
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null (F freshObj@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 null (F freshObj@0)))) (=> (= (ControlFlow 0 5) 4) anon7_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= (fun2 Heap@5 freshObj@0) 3))))
(let ((anon4_correct  (=> (= Heap@5 (MapType0Store Heap@4 null (|F#sm| freshObj@0) (MapType1Store (MapType0Select Heap@4 null (|F#sm| freshObj@0)) freshObj@0 f_7 (bool_2_U true)))) (=> (and (state Heap@5 Mask@2) (state Heap@5 Mask@2)) (and (and (=> (= (ControlFlow 0 8) 2) anon11_Else_correct) (=> (= (ControlFlow 0 8) 5) anon12_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon12_Else_correct))))))
(let ((anon10_Else_correct  (=> (HasDirectPerm Mask@2 null (F freshObj@0)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 10) 8)) anon4_correct))))
(let ((anon10_Then_correct  (=> (not (HasDirectPerm Mask@2 null (F freshObj@0))) (=> (and (and (= Heap@2 (MapType0Store Heap@1 null (|F#sm| freshObj@0) ZeroPMask)) (= Heap@3 (MapType0Store Heap@2 null (F freshObj@0) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 9) 8))) anon4_correct))))
(let ((anon2_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 freshObj@0 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 freshObj@0 f_7)) FullPerm)))) (= Mask@2 (MapType1Store Mask@1 null (F freshObj@0) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (F freshObj@0))) FullPerm))))) (=> (and (and (state Heap@1 Mask@2) (state Heap@1 Mask@2)) (and (|F#trigger| Heap@1 (F freshObj@0)) (= (MapType0Select Heap@1 null (F freshObj@0)) (FrameFragment (MapType0Select Heap@1 freshObj@0 f_7))))) (and (=> (= (ControlFlow 0 11) 9) anon10_Then_correct) (=> (= (ControlFlow 0 11) 10) anon10_Else_correct))))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 14) 11)) anon2_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7))) (=> (= (ControlFlow 0 12) 11) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@37 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@37 x@@48 $allocated))) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@37 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@37 freshObj@0 $allocated (bool_2_U true)))) (and (= Mask@0 (MapType1Store ZeroMask freshObj@0 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 f_7)) FullPerm)))) (state Heap@0 Mask@0))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7))) (=> (and (= Heap@1 (MapType0Store Heap@0 freshObj@0 f_7 (int_2_U 3))) (state Heap@1 Mask@0)) (and (=> (= (ControlFlow 0 15) 12) anon9_Then_correct) (=> (= (ControlFlow 0 15) 14) anon9_Else_correct))))))))))
...
(let ((anon21_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pair y@@9))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pair y@@9)))) (=> (= (ControlFlow 0 12) 11) anon13_correct))))))
(let ((anon9_correct true))
(let ((anon19_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 7)) anon9_correct)))
(let ((anon19_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pair y@@9))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pair y@@9)))) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
(let ((anon20_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (= (getf Heap@1 y@@9) (- (sum Heap@1 y@@9) v_2@0)))))
(let ((anon6_correct  (=> (and (and (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (pair y@@9) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (pair y@@9))) FullPerm)))) (not (= y@@9 null))) (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 y@@9 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 y@@9 f_7)) FullPerm)))) (state Heap@@37 UnfoldingMask@1))) (and (and (not (= y@@9 null)) (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 y@@9 g (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 y@@9 g)) FullPerm))))) (and (state Heap@@37 UnfoldingMask@2) (state Heap@@37 UnfoldingMask@2)))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm UnfoldingMask@2 y@@9 g)) (=> (HasDirectPerm UnfoldingMask@2 y@@9 g) (=> (= Heap@0 (MapType0Store Heap@@37 null (|pair#sm| y@@9) (MapType1Store (MapType0Select Heap@@37 null (|pair#sm| y@@9)) y@@9 f_7 (bool_2_U true)))) (=> (and (and (= Heap@1 (MapType0Store Heap@0 null (|pair#sm| y@@9) (MapType1Store (MapType0Select Heap@0 null (|pair#sm| y@@9)) y@@9 g (bool_2_U true)))) (state Heap@1 Mask@0)) (and (= v_2@0 (U_2_int (MapType0Select Heap@1 y@@9 g))) (state Heap@1 Mask@0))) (and (and (and (and (=> (= (ControlFlow 0 15) 6) anon20_Else_correct) (=> (= (ControlFlow 0 15) 12) anon21_Then_correct)) (=> (= (ControlFlow 0 15) 14) anon21_Else_correct)) (=> (= (ControlFlow 0 15) 8) anon19_Then_correct)) (=> (= (ControlFlow 0 15) 10) anon19_Else_correct)))))))))
(let ((anon17_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 19) 15)) anon6_correct)))
(let ((anon17_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pair y@@9))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pair y@@9)))) (=> (= (ControlFlow 0 17) 15) anon6_correct))))))
(let ((anon15_Else_correct  (=> (and (and (> (getf Heap@@37 y@@9) 0) (state Heap@@37 Mask@0)) (and (|pair#trigger| Heap@@37 (pair y@@9)) (= (MapType0Select Heap@@37 null (pair y@@9)) (CombineFrames (FrameFragment (MapType0Select Heap@@37 y@@9 f_7)) (FrameFragment (MapType0Select Heap@@37 y@@9 g)))))) (and (=> (= (ControlFlow 0 20) 17) anon17_Then_correct) (=> (= (ControlFlow 0 20) 19) anon17_Else_correct)))))
(let ((anon3_correct true))
(let ((anon16_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon16_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pair y@@9))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pair y@@9)))) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@37 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@37 y@@9 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (pair y@@9) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (pair y@@9))) FullPerm))))) (and (state Heap@@37 Mask@0) (state Heap@@37 Mask@0))) (and (and (=> (= (ControlFlow 0 21) 20) anon15_Else_correct) (=> (= (ControlFlow 0 21) 2) anon16_Then_correct)) (=> (= (ControlFlow 0 21) 4) anon16_Else_correct))))))
