...
(declare-fun |f'| (T@U T@U Real) Bool)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |f#triggerStateless| (T@U Real) Bool)
...
(declare-fun |f#frame| (T@U T@U Real) Bool)
...
(declare-fun f_6@@0 (T@U T@U Real) Bool)
...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (Ctor RefType) 8)) (= (type f1) (FieldType NormalFieldType RefType))) (= (type f2) (FieldType NormalFieldType RefType))) (= (type val) (FieldType NormalFieldType boolType))))
...
(assert (forall ((Heap@@0 T@U) (this T@U) (p_1 Real) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type this) RefType)) (dummyFunction (bool_2_U (|f#triggerStateless| this p_1))))
 :qid |stdinbpl.203:15|
 :skolemid |23|
 :pattern ( (|f'| Heap@@0 this p_1))
)))
...
(assert (forall ((Heap@@6 T@U) (Mask@@3 T@U) (this@@0 T@U) (p_1@@0 Real) ) (!  (=> (and (and (and (= (type Heap@@6) (MapType0Type RefType)) (= (type Mask@@3) (MapType1Type RefType realType))) (= (type this@@0) RefType)) (state Heap@@6 Mask@@3)) (= (|f'| Heap@@6 this@@0 p_1@@0) (|f#frame| (ConditionalFrame p_1@@0 (MapType0Select Heap@@6 null (P this@@0))) this@@0 p_1@@0)))
 :qid |stdinbpl.216:15|
 :skolemid |25|
 :pattern ( (state Heap@@6 Mask@@3) (|f'| Heap@@6 this@@0 p_1@@0))
)))
...
(assert (forall ((arg0@@29 T@U) ) (! (= (type (|u32#sm| arg0@@29)) (FieldType PredicateType_u32Type (MapType1Type RefType boolType)))
 :qid |funType:u32#sm|
 :pattern ( (|u32#sm| arg0@@29))
)))
...
(assert (forall ((Heap@@13 T@U) (Mask@@10 T@U) (this@@1 T@U) (p_1@@1 Real) ) (!  (=> (and (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type this@@1) RefType)) (and (state Heap@@13 Mask@@10) (< AssumeFunctionsAbove 0))) (<= NoPerm p_1@@1)) (f_6@@0 Heap@@13 this@@1 p_1@@1))
 :qid |stdinbpl.209:15|
 :skolemid |24|
 :pattern ( (state Heap@@13 Mask@@10) (f_6@@0 Heap@@13 this@@1 p_1@@1))
 :pattern ( (state Heap@@13 Mask@@10) (|f#triggerStateless| this@@1 p_1@@1) (|P#trigger| Heap@@13 (P this@@1)))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@14 T@U) (this@@2 T@U) (p_1@@2 Real) ) (!  (=> (and (= (type Heap@@14) (MapType0Type RefType)) (= (type this@@2) RefType)) (and (= (f_6@@0 Heap@@14 this@@2 p_1@@2) (|f'| Heap@@14 this@@2 p_1@@2)) (dummyFunction (bool_2_U (|f#triggerStateless| this@@2 p_1@@2)))))
 :qid |stdinbpl.199:15|
 :skolemid |22|
 :pattern ( (f_6@@0 Heap@@14 this@@2 p_1@@2))
)))
(push 1)
...
(assert  (and (and (and (and (= (type Heap@@15) (MapType0Type RefType)) (= (type self@@11) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |P#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@15 self@@11 $allocated)) (not (= self@@11 null))) (and (= Mask@0 (MapType1Store ZeroMask self@@11 f1 (real_2_U (+ (U_2_real (MapType1Select ZeroMask self@@11 f1)) FullPerm)))) (state Heap@@15 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 self@@11 f1)) (=> (HasDirectPerm Mask@0 self@@11 f1) (=> (and (= Mask@1 (MapType1Store Mask@0 null (u32 (MapType0Select Heap@@15 self@@11 f1)) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (u32 (MapType0Select Heap@@15 self@@11 f1)))) FullPerm)))) (state Heap@@15 Mask@1)) (=> (and (and (not (= self@@11 null)) (= Mask@2 (MapType1Store Mask@1 self@@11 f2 (real_2_U (+ (U_2_real (MapType1Select Mask@1 self@@11 f2)) FullPerm))))) (and (state Heap@@15 Mask@2) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@2 self@@11 f2)))))))))
