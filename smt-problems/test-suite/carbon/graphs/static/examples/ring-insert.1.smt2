...
(declare-fun new_graph () T@U)
(declare-fun PostMask@0 () T@U)
(declare-fun PostMask@1 () T@U)
(declare-fun Heap@@24 () T@U)
(assert  (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type graph) (MapType2Type RefType boolType))) (= (type new_node) RefType)) (= (type new_graph) (MapType2Type RefType boolType))) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type PostMask@1) (MapType1Type RefType realType))) (= (type Heap@@24) (MapType0Type RefType))))
(set-info :boogie-vc-id create_node)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon7_Else_correct true))
(let ((anon7_Then_correct  (=> (and (and (state PostHeap@0 ZeroMask) (not (U_2_bool (MapType2Select graph new_node)))) (and (state PostHeap@0 ZeroMask) (|Set#Equal| new_graph (|Set#Union| graph (|Set#Singleton| new_node))))) (=> (and (and (and (state PostHeap@0 ZeroMask) (not (= new_node null))) (and (= PostMask@0 (MapType1Store ZeroMask new_node next (real_2_U (+ (U_2_real (MapType1Select ZeroMask new_node next)) FullPerm)))) (state PostHeap@0 PostMask@0))) (and (and (not (= new_node null)) (= PostMask@1 (MapType1Store PostMask@0 new_node val (real_2_U (+ (U_2_real (MapType1Select PostMask@0 new_node val)) FullPerm))))) (and (state PostHeap@0 PostMask@1) (state PostHeap@0 PostMask@1)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm PostMask@1 new_node next)) (=> (HasDirectPerm PostMask@1 new_node next) (=> (= (MapType0Select PostHeap@0 new_node next) null) (=> (and (state PostHeap@0 PostMask@1) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm PostMask@1 new_node val)))))))))
(let ((anon0_correct  (=> (and (state Heap@@24 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 7) 2) anon7_Then_correct) (=> (= (ControlFlow 0 7) 5) anon7_Else_correct)))))
