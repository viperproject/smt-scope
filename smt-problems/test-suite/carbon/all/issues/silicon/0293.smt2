...
(declare-fun refSet_b1 () T@U)
(declare-fun Mask@0 () T@U)
(declare-fun Heap@0 () T@U)
(declare-fun Heap@@9 () T@U)
(declare-fun a_2 () T@U)
(declare-fun freshObj@0 () T@U)
(assert  (and (and (and (and (and (= (type refSet_b1) (MapType2Type RefType boolType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type a_2) RefType)) (= (type freshObj@0) RefType)))
(set-info :boogie-vc-id client)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (and (and (forall ((r_1 T@U) ) (!  (=> (= (type r_1) RefType) (= (U_2_bool (MapType2Select refSet_b1 r_1)) (< NoPerm (U_2_real (MapType1Select Mask@0 r_1 val)))))
 :qid |stdinbpl.425:20|
 :skolemid |82|
 :pattern ( (MapType2Select refSet_b1 r_1))
)) (state Heap@0 Mask@0)) (and (state Heap@0 Mask@0) (= (ControlFlow 0 3) (- 0 2)))) false)))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 a_2 $allocated))) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@9 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@9 freshObj@0 $allocated (bool_2_U true)))) (and (= Mask@0 (MapType1Store ZeroMask freshObj@0 val (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 val)) FullPerm)))) (state Heap@0 Mask@0))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (U_2_bool (MapType2Select refSet_b1 freshObj@0)))) (=> (not (U_2_bool (MapType2Select refSet_b1 freshObj@0))) (=> (state Heap@0 Mask@0) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))))))
