...
(assert  (and (and (= (type Heap@@11) (MapType1Type RefType)) (= (type x@@20) RefType)) (= (type Mask@0) (MapType0Type RefType realType))))
(set-info :boogie-vc-id |P#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@11 ZeroMask) (U_2_bool (MapType1Select Heap@@11 x@@20 $allocated))) (=> (and (and (not (= x@@20 null)) (= Mask@0 (MapType0Store ZeroMask x@@20 next (real_2_U (+ (U_2_real (MapType0Select ZeroMask x@@20 next)) FullPerm))))) (and (state Heap@@11 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@0 x@@20 next)))))
