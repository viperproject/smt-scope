...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 (loc a_3@@7 1) val)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 (loc a_3@@7 1) val))) (=> (= (ControlFlow 0 4) 3) anon6_correct))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (> i_1 0) (< i_1 n))) (and (> i_1_1 0) (< i_1_1 n))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@7 (+ i_1 1)) (loc a_3@@7 (+ i_1_1 1)))))
 :qid |stdinbpl.415:15|
 :skolemid |36|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (> i_1@@0 0) (< i_1@@0 n))) (and (> i_1_1@@0 0) (< i_1_1@@0 n))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@7 (+ i_1@@0 1)) (loc a_3@@7 (+ i_1_1@@0 1)))))
 :qid |stdinbpl.415:15|
 :skolemid |36|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (and (> i_1@@1 0) (< i_1@@1 n)) (< NoPerm FullPerm)) (and (qpRange2 (loc a_3@@7 (+ i_1@@1 1))) (= (invRecv2 (loc a_3@@7 (+ i_1@@1 1))) i_1@@1)))
 :qid |stdinbpl.421:22|
 :skolemid |37|
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (> (invRecv2 o_3) 0) (< (invRecv2 o_3) n)) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (loc a_3@@7 (+ (invRecv2 o_3) 1)) o_3)))
 :qid |stdinbpl.425:22|
 :skolemid |38|
 :pattern ( (invRecv2 o_3))
)) (forall ((i_1@@2 Int) ) (!  (=> (and (> i_1@@2 0) (< i_1@@2 n)) (not (= (loc a_3@@7 (+ i_1@@2 1)) null)))
 :qid |stdinbpl.431:22|
 :skolemid |39|
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (> (invRecv2 o_3@@0) 0) (< (invRecv2 o_3@@0) n)) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@7 (+ (invRecv2 o_3@@0) 1)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (and (and (> (invRecv2 o_3@@0) 0) (< (invRecv2 o_3@@0) n)) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.437:22|
 :skolemid |40|
