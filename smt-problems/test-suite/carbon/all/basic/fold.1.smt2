...
(assert  (and (and (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type r_1@@5) RefType)) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Heap@2) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (forall ((arg0@@28 T@U) ) (! (= (type (FrameFragment arg0@@28)) FrameTypeType)
...
(let ((anon6_Else_correct  (=> (HasDirectPerm Mask@1 null (valid r_1@@5)) (=> (and (= Heap@2 Heap@0) (= (ControlFlow 0 3) 1)) anon4_correct))))
(let ((anon6_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (valid r_1@@5))) (= Heap@1 (MapType0Store Heap@0 null (valid r_1@@5) newVersion@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 2) 1))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (valid r_1@@5) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid r_1@@5))) FullPerm)))) (and (=> (= (ControlFlow 0 4) 2) anon6_Then_correct) (=> (= (ControlFlow 0 4) 3) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 4)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid r_1@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid r_1@@5)))) (=> (= (ControlFlow 0 5) 4) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 r_1@@5 $allocated))) (=> (and (and (not (= r_1@@5 null)) (= Mask@0 (MapType1Store ZeroMask r_1@@5 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1@@5 f_7)) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (= FullPerm (U_2_real (MapType1Select Mask@0 r_1@@5 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 r_1@@5 f_7))) (=> (and (and (= Heap@0 (MapType0Store Heap@@10 r_1@@5 f_7 (int_2_U 1))) (state Heap@0 Mask@0)) (and (|valid#trigger| Heap@0 (valid r_1@@5)) (= (MapType0Select Heap@0 null (valid r_1@@5)) (FrameFragment (MapType0Select Heap@0 r_1@@5 f_7))))) (and (=> (= (ControlFlow 0 8) 5) anon5_Then_correct) (=> (= (ControlFlow 0 8) 7) anon5_Else_correct)))))))))
