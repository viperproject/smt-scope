...
(assert  (and (and (= (type Mask@0) (MapType2Type RefType realType)) (= (type this@@12) RefType)) (= (type Heap@@11) (MapType1Type RefType))))
(set-info :boogie-vc-id |inv#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((x_2 T@U) (x_2_1 T@U) ) (!  (=> (and (= (type x_2) RefType) (= (type x_2_1) RefType)) (=> (and (and (and (and (not (= x_2 x_2_1)) (U_2_bool (MapType0Select (MapType1Select Heap@@11 this@@12 n) x_2))) (U_2_bool (MapType0Select (MapType1Select Heap@@11 this@@12 n) x_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_2 x_2_1))))
 :qid |stdinbpl.522:15|
 :skolemid |95|
 :no-pattern (type x_2)
...
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@0 this@@12 n))))
(let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (and (U_2_bool (MapType1Select Heap@@11 this@@12 $allocated)) (not (= this@@12 null))) (and (= Mask@0 (MapType2Store ZeroMask this@@12 n (real_2_U (+ (U_2_real (MapType2Select ZeroMask this@@12 n)) FullPerm)))) (state Heap@@11 Mask@0))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
