...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon2_correct  (=> (and (and (and (= UnfoldingMask@0 (MapType0Store Mask@0 null (Pair p_1@@3) (real_2_U (- (U_2_real (MapType0Select Mask@0 null (Pair p_1@@3))) FullPerm)))) (not (= p_1@@3 null))) (and (= UnfoldingMask@1 (MapType0Store UnfoldingMask@0 p_1@@3 f_7 (real_2_U (+ (U_2_real (MapType0Select UnfoldingMask@0 p_1@@3 f_7)) FullPerm)))) (state Heap@@14 UnfoldingMask@1))) (and (and (not (= p_1@@3 null)) (= UnfoldingMask@2 (MapType0Store UnfoldingMask@1 p_1@@3 g (real_2_U (+ (U_2_real (MapType0Select UnfoldingMask@1 p_1@@3 g)) FullPerm))))) (and (state Heap@@14 UnfoldingMask@2) (state Heap@@14 UnfoldingMask@2)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm UnfoldingMask@2 p_1@@3 f_7)) (=> (HasDirectPerm UnfoldingMask@2 p_1@@3 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm UnfoldingMask@2 p_1@@3 g)))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType0Select Mask@0 null (Pair p_1@@3))))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@0 null (Pair p_1@@3)))) (=> (= (ControlFlow 0 4) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@14 ZeroMask) (U_2_bool (MapType1Select Heap@@14 p_1@@3 $allocated))) (and (= AssumeFunctionsAbove 0) (= Mask@0 (MapType0Store ZeroMask null (Pair p_1@@3) (real_2_U (+ (U_2_real (MapType0Select ZeroMask null (Pair p_1@@3))) FullPerm)))))) (and (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0)) (and (|Pair#trigger| Heap@@14 (Pair p_1@@3)) (= (MapType1Select Heap@@14 null (Pair p_1@@3)) (CombineFrames (FrameFragment (MapType1Select Heap@@14 p_1@@3 f_7)) (FrameFragment (MapType1Select Heap@@14 p_1@@3 g))))))) (and (=> (= (ControlFlow 0 7) 4) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct)))))
