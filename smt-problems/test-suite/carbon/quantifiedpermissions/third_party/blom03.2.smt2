...
(declare-fun i@@6 () Int)
(declare-fun j_1 () Int)
(assert  (and (and (and (= (type ar@@5) (SeqType RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Result) (SeqType intType))) (= (type Heap@@14) (MapType0Type RefType))))
(set-info :boogie-vc-id |vals#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon11_correct true))
(let ((anon18_Else_correct  (=> (and (not (and (<= 0 i_4) (< i_4 (|Seq#Length| ar@@5)))) (= (ControlFlow 0 21) 14)) anon11_correct)))
(let ((anon18_Then_correct  (=> (and (<= 0 i_4) (< i_4 (|Seq#Length| ar@@5))) (and (=> (= (ControlFlow 0 15) (- 0 20)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 15) (- 0 19)) (< i_4 (|Seq#Length| ar@@5))) (=> (< i_4 (|Seq#Length| ar@@5)) (and (=> (= (ControlFlow 0 15) (- 0 18)) (HasDirectPerm QPMask@0 (|Seq#Index| ar@@5 i_4) val)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| ar@@5 i_4) val) (and (=> (= (ControlFlow 0 15) (- 0 17)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 15) (- 0 16)) (< i_4 (|Seq#Length| Result))) (=> (< i_4 (|Seq#Length| Result)) (=> (= (ControlFlow 0 15) 14) anon11_correct))))))))))))))
(let ((anon17_Else_correct true))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 22) (- 0 24)) (forall ((i_7 Int) (i_7_1 Int) ) (!  (=> (and (and (and (and (not (= i_7 i_7_1)) (and (<= 0 i_7) (< i_7 (|Seq#Length| ar@@5)))) (and (<= 0 i_7_1) (< i_7_1 (|Seq#Length| ar@@5)))) (< NoPerm p_1@@5)) (< NoPerm p_1@@5)) (not (= (|Seq#Index| ar@@5 i_7) (|Seq#Index| ar@@5 i_7_1))))
 :qid |stdinbpl.681:15|
 :skolemid |68|
))) (=> (forall ((i_7@@0 Int) (i_7_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_7@@0 i_7_1@@0)) (and (<= 0 i_7@@0) (< i_7@@0 (|Seq#Length| ar@@5)))) (and (<= 0 i_7_1@@0) (< i_7_1@@0 (|Seq#Length| ar@@5)))) (< NoPerm p_1@@5)) (< NoPerm p_1@@5)) (not (= (|Seq#Index| ar@@5 i_7@@0) (|Seq#Index| ar@@5 i_7_1@@0))))
 :qid |stdinbpl.681:15|
 :skolemid |68|
)) (=> (and (forall ((i_7@@1 Int) ) (!  (=> (and (and (<= 0 i_7@@1) (< i_7@@1 (|Seq#Length| ar@@5))) (< NoPerm p_1@@5)) (and (qpRange1 (|Seq#Index| ar@@5 i_7@@1)) (= (invRecv1 (|Seq#Index| ar@@5 i_7@@1)) i_7@@1)))
 :qid |stdinbpl.687:22|
 :skolemid |69|
 :pattern ( (|Seq#Index| ar@@5 i_7@@1))
 :pattern ( (|Seq#Index| ar@@5 i_7@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv1 o_3)) (< (invRecv1 o_3) (|Seq#Length| ar@@5))) (< NoPerm p_1@@5)) (qpRange1 o_3)) (= (|Seq#Index| ar@@5 (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.691:22|
 :skolemid |70|
 :pattern ( (invRecv1 o_3))
))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (forall ((i_7@@2 Int) ) (!  (=> (and (<= 0 i_7@@2) (< i_7@@2 (|Seq#Length| ar@@5))) (>= p_1@@5 NoPerm))
 :qid |stdinbpl.697:15|
 :skolemid |71|
 :pattern ( (|Seq#Index| ar@@5 i_7@@2))
 :pattern ( (|Seq#Index| ar@@5 i_7@@2))
))) (=> (forall ((i_7@@3 Int) ) (!  (=> (and (<= 0 i_7@@3) (< i_7@@3 (|Seq#Length| ar@@5))) (>= p_1@@5 NoPerm))
 :qid |stdinbpl.697:15|
 :skolemid |71|
 :pattern ( (|Seq#Index| ar@@5 i_7@@3))
 :pattern ( (|Seq#Index| ar@@5 i_7@@3))
)) (=> (forall ((i_7@@4 Int) ) (!  (=> (and (and (<= 0 i_7@@4) (< i_7@@4 (|Seq#Length| ar@@5))) (> p_1@@5 NoPerm)) (not (= (|Seq#Index| ar@@5 i_7@@4) null)))
 :qid |stdinbpl.703:22|
 :skolemid |72|
 :pattern ( (|Seq#Index| ar@@5 i_7@@4))
 :pattern ( (|Seq#Index| ar@@5 i_7@@4))
)) (=> (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (|Seq#Length| ar@@5))) (< NoPerm p_1@@5)) (qpRange1 o_3@@0)) (and (=> (< NoPerm p_1@@5) (= (|Seq#Index| ar@@5 (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) p_1@@5)))) (=> (not (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (|Seq#Length| ar@@5))) (< NoPerm p_1@@5)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.709:22|
 :skolemid |73|
...
))) (=> (and (and (state Heap@@14 QPMask@0) (state Heap@@14 QPMask@0)) (and (= (|Seq#Length| Result) (|Seq#Length| ar@@5)) (state Heap@@14 QPMask@0))) (and (and (=> (= (ControlFlow 0 22) 13) anon17_Else_correct) (=> (= (ControlFlow 0 22) 15) anon18_Then_correct)) (=> (= (ControlFlow 0 22) 21) anon18_Else_correct))))))))))))
(let ((anon7_correct true))
(let ((anon16_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 (|Seq#Length| ar@@5)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon16_Then_correct  (=> (and (<= 0 i_2) (< i_2 (|Seq#Length| ar@@5))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_2 (|Seq#Length| ar@@5))) (=> (< i_2 (|Seq#Length| ar@@5)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon13_Else_correct  (=> (and (forall ((i_5 Int) (j_2 Int) ) (!  (=> (and (<= 0 i_5) (and (< i_5 (|Seq#Length| ar@@5)) (and (<= 0 j_2) (and (< j_2 (|Seq#Length| ar@@5)) (not (= i_5 j_2)))))) (not (= (|Seq#Index| ar@@5 i_5) (|Seq#Index| ar@@5 j_2))))
 :qid |stdinbpl.663:20|
 :skolemid |67|
 :pattern ( (|Seq#Index| ar@@5 i_5) (|Seq#Index| ar@@5 j_2))
)) (state Heap@@14 ZeroMask)) (and (and (=> (= (ControlFlow 0 25) 22) anon15_Else_correct) (=> (= (ControlFlow 0 25) 9) anon16_Then_correct)) (=> (= (ControlFlow 0 25) 12) anon16_Else_correct)))))
(let ((anon3_correct true))
(let ((anon14_Else_correct  (=> (and (not (and (<= 0 i@@6) (and (< i@@6 (|Seq#Length| ar@@5)) (and (<= 0 j_1) (and (< j_1 (|Seq#Length| ar@@5)) (not (= i@@6 j_1))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon14_Then_correct  (=> (and (<= 0 i@@6) (and (< i@@6 (|Seq#Length| ar@@5)) (and (<= 0 j_1) (and (< j_1 (|Seq#Length| ar@@5)) (not (= i@@6 j_1)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i@@6 (|Seq#Length| ar@@5))) (=> (< i@@6 (|Seq#Length| ar@@5)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_1 0)) (=> (>= j_1 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_1 (|Seq#Length| ar@@5))) (=> (< j_1 (|Seq#Length| ar@@5)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove 0)) (and (< NoPerm p_1@@5) (state Heap@@14 ZeroMask))) (and (and (=> (= (ControlFlow 0 26) 25) anon13_Else_correct) (=> (= (ControlFlow 0 26) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 26) 7) anon14_Else_correct)))))
