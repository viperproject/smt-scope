...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 r_1 $allocated))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (/ (to_real 1) (to_real 3)) (/ (to_real 1) (to_real 3)))) (=> (= (/ (to_real 1) (to_real 3)) (/ (to_real 1) (to_real 3))) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< (/ (to_real 1) (to_real 10000)) FullPerm)) (=> (< (/ (to_real 1) (to_real 10000)) FullPerm) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (< FullPerm (/ (to_real 1) (to_real 10000))))))))))))
