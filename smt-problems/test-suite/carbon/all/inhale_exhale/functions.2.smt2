...
(set-info :boogie-vc-id |exhaleExpression3WithRequires#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (not (= this@@54 null))) (=> (not (= this@@54 null)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm Mask@0 this@@54 x@@8)) (=> (HasDirectPerm Mask@0 this@@54 x@@8) (=> (= (ControlFlow 0 3) (- 0 2)) (= (U_2_int (MapType0Select Heap@@64 this@@54 x@@8)) 1))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@64 ZeroMask) (U_2_bool (MapType0Select Heap@@64 this@@54 $allocated))) (=> (and (and (= AssumeFunctionsAbove 10) (not (= this@@54 null))) (and (= Mask@0 (MapType1Store ZeroMask this@@54 x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@54 x@@8)) FullPerm)))) (state Heap@@64 Mask@0))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (HasDirectPerm Mask@0 this@@54 x@@8)) (=> (HasDirectPerm Mask@0 this@@54 x@@8) (=> (and (= (U_2_int (MapType0Select Heap@@64 this@@54 x@@8)) 1) (state Heap@@64 Mask@0)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm Mask@0 this@@54 x@@8)) (=> (HasDirectPerm Mask@0 this@@54 x@@8) (=> (= Result@0 (U_2_int (MapType0Select Heap@@64 this@@54 x@@8))) (and (=> (= (ControlFlow 0 6) 1) anon3_Then_correct) (=> (= (ControlFlow 0 6) 3) anon3_Else_correct))))))))))))
...
(declare-fun this@@54 () T@U)
(declare-fun Heap@@64 () T@U)
(assert  (and (and (= (type Heap@@64) (MapType0Type RefType)) (= (type this@@54) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id exhaleTrue1Method)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon3_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@0 this@@54 x@@8)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 this@@54 x@@8))) (=> (= (ControlFlow 0 6) 5) anon3_correct))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (exhaleTrue1 Heap@@64 this@@54) 0)) (=> (= (exhaleTrue1 Heap@@64 this@@54) 0) (=> (state Heap@@64 Mask@0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 this@@54 x@@8)) (=> (HasDirectPerm Mask@0 this@@54 x@@8) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (MapType0Select Heap@@64 this@@54 x@@8)) 1)))))))))
(let ((anon0_correct  (=> (state Heap@@64 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@64 this@@54 $allocated))) (=> (and (and (not (= this@@54 null)) (= Mask@0 (MapType1Store ZeroMask this@@54 x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@54 x@@8)) FullPerm))))) (and (state Heap@@64 Mask@0) (state Heap@@64 Mask@0))) (and (and (=> (= (ControlFlow 0 9) 2) anon5_Else_correct) (=> (= (ControlFlow 0 9) 6) anon6_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct)))))))
