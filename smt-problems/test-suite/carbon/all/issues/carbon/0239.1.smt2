...
(declare-fun |bool2Ref'| (T@U Bool) T@U)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |bool2Ref#triggerStateless| (Bool) T@U)
(declare-fun bool2Ref (T@U Bool) T@U)
(declare-fun AssumeFunctionsAbove () Int)
(declare-fun |bool2Ref#trigger| (T@U Bool) Bool)
...
(declare-fun |bool2Ref#frame| (T@U Bool) T@U)
...
(assert  (and (forall ((arg0@@25 T@U) (arg1@@9 Bool) ) (! (= (type (|bool2Ref'| arg0@@25 arg1@@9)) RefType)
 :qid |funType:bool2Ref'|
 :pattern ( (|bool2Ref'| arg0@@25 arg1@@9))
)) (forall ((arg0@@26 Bool) ) (! (= (type (|bool2Ref#triggerStateless| arg0@@26)) RefType)
 :qid |funType:bool2Ref#triggerStateless|
 :pattern ( (|bool2Ref#triggerStateless| arg0@@26))
))))
(assert (forall ((Heap@@2 T@U) (b_3 Bool) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (|bool2Ref#triggerStateless| b_3)))
 :qid |stdinbpl.212:15|
 :skolemid |23|
 :pattern ( (|bool2Ref'| Heap@@2 b_3))
)))
...
(assert (forall ((arg0@@27 T@U) (arg1@@10 Bool) ) (! (= (type (bool2Ref arg0@@27 arg1@@10)) RefType)
 :qid |funType:bool2Ref|
 :pattern ( (bool2Ref arg0@@27 arg1@@10))
)))
(assert (forall ((Heap@@4 T@U) (b_3@@0 Bool) ) (!  (=> (= (type Heap@@4) (MapType0Type RefType)) (and (= (bool2Ref Heap@@4 b_3@@0) (|bool2Ref'| Heap@@4 b_3@@0)) (dummyFunction (|bool2Ref#triggerStateless| b_3@@0))))
 :qid |stdinbpl.208:15|
 :skolemid |22|
 :pattern ( (bool2Ref Heap@@4 b_3@@0))
)))
...
(assert (forall ((Heap@@6 T@U) (Mask@@4 T@U) (b_3@@1 Bool) ) (!  (=> (and (and (= (type Heap@@6) (MapType0Type RefType)) (= (type Mask@@4) (MapType1Type RefType realType))) (and (state Heap@@6 Mask@@4) (or (< AssumeFunctionsAbove 0) (|bool2Ref#trigger| EmptyFrame b_3@@1)))) (and (not (= (|bool2Ref'| Heap@@6 b_3@@1) null)) (not (= (|bool2Ref'| Heap@@6 true) (|bool2Ref'| Heap@@6 false)))))
 :qid |stdinbpl.225:15|
 :skolemid |25|
 :pattern ( (state Heap@@6 Mask@@4) (|bool2Ref'| Heap@@6 b_3@@1))
)))
...
(assert (forall ((arg0@@28 Real) (arg1@@11 T@U) ) (! (= (type (ConditionalFrame arg0@@28 arg1@@11)) FrameTypeType)
...
(assert (forall ((arg0@@29 T@U) (arg1@@12 Bool) ) (! (= (type (|bool2Ref#frame| arg0@@29 arg1@@12)) RefType)
 :qid |funType:bool2Ref#frame|
 :pattern ( (|bool2Ref#frame| arg0@@29 arg1@@12))
)))
(assert (forall ((Heap@@10 T@U) (Mask@@10 T@U) (b_3@@2 Bool) ) (!  (=> (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (state Heap@@10 Mask@@10)) (= (|bool2Ref'| Heap@@10 b_3@@2) (|bool2Ref#frame| EmptyFrame b_3@@2)))
 :qid |stdinbpl.219:15|
 :skolemid |24|
 :pattern ( (state Heap@@10 Mask@@10) (|bool2Ref'| Heap@@10 b_3@@2))
)))
...
(declare-fun invRecv1 (T@U) Bool)
(declare-fun QPMask@0 () T@U)
(declare-fun x@@8 () T@U)
(declare-fun Heap@0 () T@U)
(assert  (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type x@@8) RefType)) (= (type Heap@0) (MapType0Type RefType))))
...
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((b_1 Bool) (b_1_1 Bool) ) (!  (=> (and (and (= b_1  (not b_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (bool2Ref Heap@@13 b_1) (bool2Ref Heap@@13 b_1_1))))
 :qid |stdinbpl.303:15|
 :skolemid |26|
))) (=> (forall ((b_1@@0 Bool) (b_1_1@@0 Bool) ) (!  (=> (and (and (= b_1@@0  (not b_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (bool2Ref Heap@@13 b_1@@0) (bool2Ref Heap@@13 b_1_1@@0))))
 :qid |stdinbpl.303:15|
 :skolemid |26|
)) (=> (forall ((b_1@@1 Bool) ) (!  (=> (< NoPerm FullPerm) (and (qpRange1 (bool2Ref Heap@@13 b_1@@1)) (= (invRecv1 (bool2Ref Heap@@13 b_1@@1)) b_1@@1)))
 :qid |stdinbpl.309:22|
 :skolemid |27|
 :pattern ( (|bool2Ref#frame| EmptyFrame b_1@@1))
 :pattern ( (|bool2Ref#frame| EmptyFrame b_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (< NoPerm FullPerm) (qpRange1 o_3)) (= (bool2Ref Heap@@13 (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.313:22|
 :skolemid |28|
 :pattern ( (invRecv1 o_3))
)) (forall ((b_1@@2 Bool) ) (! (not (= (bool2Ref Heap@@13 b_1@@2) null))
 :qid |stdinbpl.319:22|
 :skolemid |29|
 :pattern ( (|bool2Ref#frame| EmptyFrame b_1@@2))
 :pattern ( (|bool2Ref#frame| EmptyFrame b_1@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (< NoPerm FullPerm) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (bool2Ref Heap@@13 (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (< NoPerm FullPerm) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.325:22|
 :skolemid |30|
...
))) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= FullPerm (U_2_real (MapType1Select QPMask@0 x@@8 val)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 x@@8 val))) (=> (= Heap@0 (MapType0Store Heap@@13 x@@8 val (int_2_U 42))) (=> (and (state Heap@0 QPMask@0) (= (ControlFlow 0 2) (- 0 1))) false)))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@13 x@@8 $allocated)) (state Heap@@13 ZeroMask))) (and (and (=> (= (ControlFlow 0 7) 2) anon5_Else_correct) (=> (= (ControlFlow 0 7) 5) anon6_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))
