...
))) (and (= (|Seq#Length| pw@0) 11) (forall ((i_11_1 Int) ) (!  (=> (and (<= 0 i_11_1) (<= i_11_1 10)) (and (<= 0 (U_2_int (|Seq#Index| pw@0 i_11_1))) (<= (U_2_int (|Seq#Index| pw@0 i_11_1)) 10)))
 :qid |stdinbpl.3178:22|
 :skolemid |257|
 :pattern ( (|Seq#Index| pw@0 i_11_1))
)))) (and (and (forall ((i_12_1 Int) (j@@5 Int) ) (!  (=> (and (<= 0 i_12_1) (and (< i_12_1 j@@5) (<= j@@5 10))) (not (= (U_2_int (|Seq#Index| pw@0 i_12_1)) (U_2_int (|Seq#Index| pw@0 j@@5)))))
 :qid |stdinbpl.3182:22|
 :skolemid |258|
 :pattern ( (|Seq#Index| pw@0 i_12_1) (|Seq#Index| pw@0 j@@5))
)) (forall ((i_13 Int) ) (!  (=> (and (<= 0 i_13) (<= i_13 10)) (= (U_2_int (MapType0Select ExhaleHeap@0 (loc a_3@@1 i_13) val)) (U_2_int (MapType0Select Heap@@13 (loc a_3@@1 (U_2_int (|Seq#Index| pw@0 i_13))) val))))
