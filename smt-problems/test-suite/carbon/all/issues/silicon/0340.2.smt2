...
(assert  (and (and (and (= (type AssertMask@0) (MapType1Type RefType realType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (forall ((arg0@@26 T@U) ) (! (= (type (invRecv1 arg0@@26)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon4_correct  (=> (= AssertMask@0 (MapType1Store QPMask@0 null next (real_2_U (- (U_2_real (MapType1Select QPMask@0 null next)) FullPerm)))) (=> (and (state Heap@@9 QPMask@0) (= (ControlFlow 0 3) (- 0 2))) false))))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null next)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null next))) (=> (= (ControlFlow 0 4) 3) anon4_correct))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (not (= r_1 r_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1 r_1_1))))
 :qid |stdinbpl.232:15|
 :skolemid |22|
 :no-pattern (type r_1)
...
))) (=> (forall ((r_1@@0 T@U) (r_1_1@@0 T@U) ) (!  (=> (and (= (type r_1@@0) RefType) (= (type r_1_1@@0) RefType)) (=> (and (and (not (= r_1@@0 r_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1@@0 r_1_1@@0))))
 :qid |stdinbpl.232:15|
 :skolemid |22|
...
)) (=> (forall ((r_1@@1 T@U) ) (!  (=> (and (= (type r_1@@1) RefType) (< NoPerm FullPerm)) (and (qpRange1 r_1@@1) (= (invRecv1 r_1@@1) r_1@@1)))
 :qid |stdinbpl.238:22|
 :skolemid |23|
...
)) (forall ((r_1@@2 T@U) ) (!  (=> (= (type r_1@@2) RefType) (not (= r_1@@2 null)))
 :qid |stdinbpl.248:22|
 :skolemid |25|
 :pattern ( (MapType0Select Heap@@9 r_1@@2 next))
 :pattern ( (MapType1Select QPMask@0 r_1@@2 next))
 :pattern ( (MapType0Select Heap@@9 r_1@@2 next))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (< NoPerm FullPerm) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 next)) FullPerm)))) (=> (not (and (< NoPerm FullPerm) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (U_2_real (MapType1Select ZeroMask o_3@@0 next))))))
 :qid |stdinbpl.254:22|
 :skolemid |26|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 9) 1) anon5_Then_correct) (=> (= (ControlFlow 0 9) 7) anon5_Else_correct)))))
