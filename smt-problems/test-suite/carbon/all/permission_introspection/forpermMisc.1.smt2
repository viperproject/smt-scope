...
(declare-fun c2 () T@U)
(declare-fun c1 () T@U)
(assert  (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type c2) RefType)) (= (type r_5) RefType)) (= (type c1) RefType)))
(set-info :boogie-vc-id test07a)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (not (HasDirectPerm Mask@0 r_5 val)) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (HasDirectPerm Mask@0 r_5 val) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@0 r_5 val)) (=> (HasDirectPerm Mask@0 r_5 val) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
