...
(assert  (and (and (and (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type s@@17) (SeqType RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type x@@11) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id foo3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon2_correct  (=> (= Mask@2 (MapType1Store Mask@1 (|Seq#Index| s@@17 0) f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 (|Seq#Index| s@@17 0) f_7)) perm_temp_quasihavoc_@0)))) (=> (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< 0 (|Seq#Length| s@@17))) (=> (< 0 (|Seq#Length| s@@17)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= perm_temp_quasihavoc_@0 NoPerm)) (=> (>= perm_temp_quasihavoc_@0 NoPerm) (=> (=> (> perm_temp_quasihavoc_@0 NoPerm) (not (= (|Seq#Index| s@@17 0) null))) (=> (and (and (= Mask@3 (MapType1Store Mask@2 (|Seq#Index| s@@17 0) f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@2 (|Seq#Index| s@@17 0) f_7)) perm_temp_quasihavoc_@0)))) (state ExhaleHeap@0 Mask@3)) (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@3 x@@11 f_7)) (=> (HasDirectPerm Mask@3 x@@11 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (MapType0Select ExhaleHeap@0 x@@11 f_7)) 42))))))))))))))
(let ((anon3_Else_correct  (=> (and (= perm_temp_quasihavoc_@0 NoPerm) (= (ControlFlow 0 8) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= perm_temp_quasihavoc_@0 NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= perm_temp_quasihavoc_@0 (U_2_real (MapType1Select Mask@1 (|Seq#Index| s@@17 0) f_7)))) (=> (<= perm_temp_quasihavoc_@0 (U_2_real (MapType1Select Mask@1 (|Seq#Index| s@@17 0) f_7))) (=> (= (ControlFlow 0 6) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 x@@11 $allocated)) (>= (|Seq#Length| s@@17) 1)) (and (=> (= (ControlFlow 0 9) (- 0 14)) (< 0 (|Seq#Length| s@@17))) (=> (< 0 (|Seq#Length| s@@17)) (=> (not (= (|Seq#Index| s@@17 0) null)) (=> (and (= Mask@0 (MapType1Store ZeroMask (|Seq#Index| s@@17 0) f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask (|Seq#Index| s@@17 0) f_7)) FullPerm)))) (state Heap@@9 Mask@0)) (=> (and (and (state Heap@@9 Mask@0) (not (= x@@11 null))) (and (= Mask@1 (MapType1Store Mask@0 x@@11 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@11 f_7)) FullPerm)))) (state Heap@@9 Mask@1))) (and (=> (= (ControlFlow 0 9) (- 0 13)) (HasDirectPerm Mask@1 x@@11 f_7)) (=> (HasDirectPerm Mask@1 x@@11 f_7) (=> (and (and (= (U_2_int (MapType0Select Heap@@9 x@@11 f_7)) 42) (state Heap@@9 Mask@1)) (and (not (|Seq#Contains| s@@17 x@@11)) (state Heap@@9 Mask@1))) (and (=> (= (ControlFlow 0 9) (- 0 12)) (< 0 (|Seq#Length| s@@17))) (=> (< 0 (|Seq#Length| s@@17)) (=> (and (= perm_temp_quasihavoc_@0 (U_2_real (MapType1Select Mask@1 (|Seq#Index| s@@17 0) f_7))) (state Heap@@9 Mask@1)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (< 0 (|Seq#Length| s@@17))) (=> (< 0 (|Seq#Length| s@@17)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (>= perm_temp_quasihavoc_@0 NoPerm)) (=> (>= perm_temp_quasihavoc_@0 NoPerm) (and (=> (= (ControlFlow 0 9) 6) anon3_Then_correct) (=> (= (ControlFlow 0 9) 8) anon3_Else_correct)))))))))))))))))))))
