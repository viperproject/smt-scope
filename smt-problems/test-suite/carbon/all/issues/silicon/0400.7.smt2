...
(set-info :boogie-vc-id test_drop_index_01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= a_2@0 (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 1)) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 5))) (|Seq#Singleton| (int_2_U 7))) (|Seq#Singleton| (int_2_U 8)))) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< 3 (|Seq#Length| (|Seq#Drop| a_2@0 0)))) (=> (< 3 (|Seq#Length| (|Seq#Drop| a_2@0 0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (U_2_int (|Seq#Index| (|Seq#Drop| a_2@0 0) 3)) 7)) (=> (= (U_2_int (|Seq#Index| (|Seq#Drop| a_2@0 0) 3)) 7) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< 3 (|Seq#Length| (|Seq#Drop| a_2@0 (- 0 1))))) (=> (< 3 (|Seq#Length| (|Seq#Drop| a_2@0 (- 0 1)))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (|Seq#Index| (|Seq#Drop| a_2@0 (- 0 1)) 3)) 7)))))))))))))
