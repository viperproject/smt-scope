...
(assert  (and (and (and (and (= (type xs) (MapType2Type RefType boolType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv4 arg0@@43)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (U_2_bool (MapType2Select xs z_1))) (U_2_bool (MapType2Select xs z_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1))))
 :qid |stdinbpl.679:15|
 :skolemid |101|
 :no-pattern (type z_1)
...
)) (=> (and (forall ((z_1@@1 T@U) ) (!  (=> (= (type z_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs z_1@@1)) (< NoPerm FullPerm)) (and (qpRange4 z_1@@1) (= (invRecv4 z_1@@1) z_1@@1))))
 :qid |stdinbpl.685:22|
 :skolemid |102|
...
))) (=> (and (and (and (forall ((z_1@@2 T@U) ) (!  (=> (and (= (type z_1@@2) RefType) (U_2_bool (MapType2Select xs z_1@@2))) (not (= z_1@@2 null)))
 :qid |stdinbpl.695:22|
 :skolemid |104|
...
)) (state Heap@@9 QPMask@0))) (and (and (state Heap@@9 QPMask@0) (U_2_bool (MapType2Select xs x@@19))) (and (state Heap@@9 QPMask@0) (= (ControlFlow 0 3) (- 0 2))))) (not (= x@@19 null))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@19 $allocated))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct)))))
