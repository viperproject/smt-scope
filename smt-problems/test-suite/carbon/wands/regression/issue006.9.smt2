...
(assert  (and (and (and (and (and (and (= (type Ops_15Heap@0) (MapType0Type RefType)) (= (type xs@@3) (SeqType intType))) (= (type Heap@@13) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type ys@0) (SeqType intType))) (= (type Used_15Heap@0) (MapType0Type RefType))) (= (type Used_14Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test07)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon13_Then_correct true))
(let ((anon8_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (=> (and (and b_24@2 b_24@2) b_25@0) (= (sum Ops_15Heap@0 xs@@3) n@@13))) (=> (=> (and (and b_24@2 b_24@2) b_25@0) (= (sum Ops_15Heap@0 xs@@3) n@@13)) (=> (state Heap@@13 ZeroMask) (=> (and (= Mask@0 (MapType1Store ZeroMask null (wand true (= (sum Heap@@13 xs@@3) n@@13)) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (wand true (= (sum Heap@@13 xs@@3) n@@13)))) FullPerm)))) (state Heap@@13 Mask@0)) (=> (and (and (state Heap@@13 Mask@0) (state Heap@@13 Mask@0)) (and (= ys@0 (|Seq#Append| (|Seq#Singleton| (int_2_U n@@13)) xs@@3)) (state Heap@@13 Mask@0))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (|Seq#Equal| xs@@3 (|Seq#Drop| ys@0 1))) (=> (|Seq#Equal| xs@@3 (|Seq#Drop| ys@0 1)) (=> (and (state Heap@@13 Mask@0) (= (ControlFlow 0 3) (- 0 2))) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (wand true (= (sum Heap@@13 ys@0) (* 2 n@@13))))))))))))))))
(let ((anon12_Then_correct  (=> b_24@2 (and (=> (= (ControlFlow 0 9) 8) anon13_Then_correct) (=> (= (ControlFlow 0 9) 3) anon8_correct)))))
(let ((anon12_Else_correct  (=> (and (not b_24@2) (= (ControlFlow 0 7) 3)) anon8_correct)))
(let ((anon11_Then_correct  (=> (and (and b_24@2 b_24@2) b_25@0) (and (=> (= (ControlFlow 0 10) 9) anon12_Then_correct) (=> (= (ControlFlow 0 10) 7) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (not (and (and b_24@2 b_24@2) b_25@0)) (= (ControlFlow 0 6) 3)) anon8_correct)))
(let ((anon4_correct  (=> (= b_24@1  (and b_24@0 (state Ops_15Heap@0 ZeroMask))) (=> (and (= b_24@2  (and b_24@1 (state Ops_15Heap@0 ZeroMask))) (= b_25@0  (and b_25 (state Used_15Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 11) 10) anon11_Then_correct) (=> (= (ControlFlow 0 11) 6) anon11_Else_correct))))))
(let ((anon10_Else_correct  (=> (and (not b_24@0) (= (ControlFlow 0 13) 11)) anon4_correct)))
(let ((anon10_Then_correct  (=> (and b_24@0 (= (ControlFlow 0 12) 11)) anon4_correct)))
(let ((anon9_Else_correct  (=> (and (and (= (sum Heap@@13 xs@@3) n@@13) (state Heap@@13 ZeroMask)) (and (= b_24@0  (and b_24 (state Ops_15Heap@0 ZeroMask))) (= b_23@0  (and b_23 (state Used_14Heap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 14) 12) anon10_Then_correct) (=> (= (ControlFlow 0 14) 13) anon10_Else_correct)))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (state Heap@@13 ZeroMask)) (and (=> (= (ControlFlow 0 15) 1) anon9_Then_correct) (=> (= (ControlFlow 0 15) 14) anon9_Else_correct))))))
