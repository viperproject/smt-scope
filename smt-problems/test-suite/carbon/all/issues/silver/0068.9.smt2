...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (|Set#Equal| (|Set#Intersection| (|Set#Intersection| xs ys) zs) vas) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (|Set#Equal| (|Set#Intersection| xs (|Set#Intersection| zs ys)) vas)))))
