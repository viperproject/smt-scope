...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (Ctor float24e8Type) 8)) (= (type ff) (FieldType NormalFieldType float24e8Type))))
(assert (distinct $allocated ff)
)
...
(assert  (and (and (= (Ctor FrameTypeType) 13) (= (type null) RefType)) (forall ((arg0@@27 T@U) ) (! (let ((A (FieldTypeInv0 (type arg0@@27))))
...
(assert  (not (IsPredicateField ff)))
(assert  (not (IsWandField ff)))
...
(declare-fun float24e8_2_U ((_ FloatingPoint 8 24)) T@U)
(declare-fun fs@0 () T@U)
(declare-fun U_2_float24e8 (T@U) (_ FloatingPoint 8 24))
(assert  (and (and (and (and (and (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type r_1) RefType)) (= (type freshObj@0) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (forall ((arg0@@35 (_ FloatingPoint 8 24)) ) (! (= (U_2_float24e8 (float24e8_2_U arg0@@35)) arg0@@35)
 :qid |typeInv:U_2_float24e8|
 :pattern ( (float24e8_2_U arg0@@35))
))) (forall ((x@@11 T@U) ) (!  (=> (= (type x@@11) float24e8Type) (= (float24e8_2_U (U_2_float24e8 x@@11)) x@@11))
 :qid |cast:U_2_float24e8|
 :pattern ( (U_2_float24e8 x@@11))
))) (forall ((arg0@@36 (_ FloatingPoint 8 24)) ) (! (= (type (float24e8_2_U arg0@@36)) float24e8Type)
 :qid |funType:float24e8_2_U|
 :pattern ( (float24e8_2_U arg0@@36))
))) (= (type fs@0) (SeqType float24e8Type))))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 r_1 $allocated))) (and (= tmp@0 ((_ int2bv 32) 1081081856)) (state Heap@@9 ZeroMask))) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@9 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@9 freshObj@0 $allocated (bool_2_U true)))) (and (= Mask@0 (MapType1Store ZeroMask freshObj@0 ff (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 ff)) FullPerm)))) (state Heap@0 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 ff)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 ff))) (=> (and (and (= Heap@1 (MapType0Store Heap@0 freshObj@0 ff (float24e8_2_U ((_ to_fp 8 24) ((_ int2bv 32) 1103888384))))) (state Heap@1 Mask@0)) (and (= fs@0 (|Seq#Singleton| (float24e8_2_U ((_ to_fp 8 24) ((_ int2bv 32) 1081081856))))) (state Heap@1 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (HasDirectPerm Mask@0 freshObj@0 ff)) (=> (HasDirectPerm Mask@0 freshObj@0 ff) (and (=> (= (ControlFlow 0 2) (- 0 8)) (< 0 (|Seq#Length| fs@0))) (=> (< 0 (|Seq#Length| fs@0)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (fp.eq (fp.min ((_ to_fp 8 24) tmp@0) (U_2_float24e8 (MapType0Select Heap@1 freshObj@0 ff))) (U_2_float24e8 (|Seq#Index| fs@0 0)))) (=> (fp.eq (fp.min ((_ to_fp 8 24) tmp@0) (U_2_float24e8 (MapType0Select Heap@1 freshObj@0 ff))) (U_2_float24e8 (|Seq#Index| fs@0 0))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (fp.eq (fp.max ((_ to_fp 8 24) ((_ int2bv 32) 1081081856)) ((_ to_fp 8 24) ((_ int2bv 32) 1103888384))) ((_ to_fp 8 24) ((_ int2bv 32) 1103888384)))) (=> (fp.eq (fp.max ((_ to_fp 8 24) ((_ int2bv 32) 1081081856)) ((_ to_fp 8 24) ((_ int2bv 32) 1103888384))) ((_ to_fp 8 24) ((_ int2bv 32) 1103888384))) (=> (state Heap@1 Mask@0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm Mask@0 freshObj@0 ff)) (=> (HasDirectPerm Mask@0 freshObj@0 ff) (and (=> (= (ControlFlow 0 2) (- 0 4)) (< 0 (|Seq#Length| fs@0))) (=> (< 0 (|Seq#Length| fs@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (fp.eq (fp.min ((_ to_fp 8 24) tmp@0) (U_2_float24e8 (MapType0Select Heap@1 freshObj@0 ff))) (U_2_float24e8 (|Seq#Index| fs@0 0)))) (=> (fp.eq (fp.min ((_ to_fp 8 24) tmp@0) (U_2_float24e8 (MapType0Select Heap@1 freshObj@0 ff))) (U_2_float24e8 (|Seq#Index| fs@0 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (fp.eq (fp.max ((_ to_fp 8 24) ((_ int2bv 32) 1081081856)) ((_ to_fp 8 24) ((_ int2bv 32) 1103888384))) ((_ to_fp 8 24) ((_ int2bv 32) 110388838))))))))))))))))))))))))))
