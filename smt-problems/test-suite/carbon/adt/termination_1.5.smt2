...
(assert  (and (= (type l@@44) (ListDomainTypeType ValDomainTypeType)) (= (type Heap@@58) (MapType0Type RefType))))
(set-info :boogie-vc-id |len2#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon7_correct  (=> (and (= Result@0 (ite (= (List_tag l@@44) 1) 0 (ite (= (List_tag (get_List_tail l@@44)) 1) 1 (+ 2 (len2 Heap@@58 (get_List_tail (get_List_tail l@@44))))))) (= (ControlFlow 0 3) (- 0 2))) (>= Result@0 0))))
(let ((anon10_Else_correct  (=> (and (|len2#trigger| EmptyFrame (get_List_tail (get_List_tail l@@44))) (= (ControlFlow 0 6) 3)) anon7_correct)))
(let ((anon9_Then_correct  (=> (and (= (List_tag (get_List_tail l@@44)) 1) (= (ControlFlow 0 5) 3)) anon7_correct)))
(let ((anon8_Then_correct  (=> (and (= (List_tag l@@44) 1) (= (ControlFlow 0 4) 3)) anon7_correct)))
(let ((anon10_Then_correct true))
(let ((anon9_Else_correct  (=> (not (= (List_tag (get_List_tail l@@44)) 1)) (and (=> (= (ControlFlow 0 7) 1) anon10_Then_correct) (=> (= (ControlFlow 0 7) 6) anon10_Else_correct)))))
(let ((anon8_Else_correct  (=> (not (= (List_tag l@@44) 1)) (and (=> (= (ControlFlow 0 8) 5) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct)))))
(let ((anon0_correct  (=> (and (state Heap@@58 ZeroMask) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 9) 4) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct)))))
...
(declare-fun ControlFlow (Int Int) Int)
(declare-fun Heap@@58 () T@U)
(declare-fun v_2@@9 () T@U)
(declare-fun l@@44 () T@U)
(assert  (and (and (= (type Heap@@58) (MapType0Type RefType)) (= (type v_2@@9) ValDomainTypeType)) (= (type l@@44) (ListDomainTypeType ValDomainTypeType))))
(set-info :boogie-vc-id lenBad_termination_proof)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@58 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (decreasing (Cons v_2@@9 (Nil ValDomainTypeType)) l@@44)) (=> (decreasing (Cons v_2@@9 (Nil ValDomainTypeType)) l@@44) (=> (= (ControlFlow 0 2) (- 0 1)) (bounded l@@44)))))))
