...
(declare-fun invRecv20 (T@U Bool) T@U)
(declare-fun qpRange20 (T@U Bool) Bool)
(declare-fun QPMask@0 () T@U)
(declare-fun FrameFragment (T@U) T@U)
(declare-fun neverTriggered19 (T@U) Bool)
(declare-fun invRecv19 (T@U Bool) T@U)
(declare-fun qpRange19 (T@U Bool) Bool)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type this@@5) RefType) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type xs) (SeqType RefType))) (forall ((arg0@@54 T@U) (arg1@@31 Bool) ) (! (= (type (invRecv20 arg0@@54 arg1@@31)) RefType)
 :qid |funType:invRecv20|
 :pattern ( (invRecv20 arg0@@54 arg1@@31))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@55 T@U) ) (! (= (type (FrameFragment arg0@@55)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@55))
))) (forall ((arg0@@56 T@U) (arg1@@32 Bool) ) (! (= (type (invRecv19 arg0@@56 arg1@@32)) RefType)
 :qid |funType:invRecv19|
 :pattern ( (invRecv19 arg0@@56 arg1@@32))
))))
(set-info :boogie-vc-id t3b)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon8_correct  (=> (not (= this@@5 null)) (=> (and (and (= Mask@1 (MapType1Store Mask@0 this@@5 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 this@@5 f_7)) FullPerm)))) (state Heap@1 Mask@1)) (and (state Heap@1 Mask@1) (state Heap@1 Mask@1))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (= FullPerm (U_2_real (MapType1Select Mask@1 this@@5 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 this@@5 f_7))) (=> (= Heap@2 (MapType0Store Heap@1 this@@5 f_7 (int_2_U 1))) (=> (and (state Heap@2 Mask@1) (= (ControlFlow 0 4) (- 0 3))) (= FullPerm (U_2_real (MapType1Select Mask@1 this@@5 g)))))))))))
(let ((anon12_Else_correct  (=> (HasDirectPerm Mask@0 null (valid this@@5 true)) (=> (and (= Heap@1 Heap@@10) (= (ControlFlow 0 7) 4)) anon8_correct))))
(let ((anon12_Then_correct  (=> (and (and (not (HasDirectPerm Mask@0 null (valid this@@5 true))) (= Heap@0 (MapType0Store Heap@@10 null (valid this@@5 true) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 6) 4))) anon8_correct)))
(let ((anon6_correct  (=> (= Mask@0 (MapType1Store QPMask@1 null (valid this@@5 true) (real_2_U (- (U_2_real (MapType1Select QPMask@1 null (valid this@@5 true))) FullPerm)))) (and (=> (= (ControlFlow 0 8) 6) anon12_Then_correct) (=> (= (ControlFlow 0 8) 7) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon6_correct)))
(let ((anon11_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select QPMask@1 null (valid this@@5 true))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@1 null (valid this@@5 true)))) (=> (= (ControlFlow 0 9) 8) anon6_correct))))))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((x_4 T@U) (x_4_1 T@U) ) (!  (=> (and (= (type x_4) RefType) (= (type x_4_1) RefType)) (=> (and (and (and (and (not (= x_4 x_4_1)) (|Seq#Contains| xs x_4)) (|Seq#Contains| xs x_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= x_4 x_4_1)) (=  (not b_1@@5)  (not (not b_1@@5))))))
...
)) (=> (forall ((x_4@@1 T@U) ) (!  (=> (= (type x_4@@1) RefType) (=> (and (|Seq#Contains| xs x_4@@1) (< NoPerm FullPerm)) (and (= (invRecv20 x_4@@1  (not b_1@@5)) x_4@@1) (qpRange20 x_4@@1  (not b_1@@5)))))
 :qid |stdinbpl.3214:22|
 :skolemid |242|
 :pattern ( (|Seq#ContainsTrigger| xs x_4@@1))
 :pattern ( (|Seq#Contains| xs x_4@@1))
)) (=> (and (and (and (forall ((this_2_1 T@U) (b_2_1 Bool) ) (!  (=> (= (type this_2_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv20 this_2_1 b_2_1)) (< NoPerm FullPerm)) (qpRange20 this_2_1 b_2_1)) (and (= (invRecv20 this_2_1 b_2_1) this_2_1) (=  (not b_1@@5) b_2_1))))
 :qid |stdinbpl.3218:22|
 :skolemid |243|
 :pattern ( (invRecv20 this_2_1 b_2_1))
)) (forall ((this_2_1@@0 T@U) (b_2_1@@0 Bool) ) (!  (=> (= (type this_2_1@@0) RefType) (=> (and (and (|Seq#Contains| xs (invRecv20 this_2_1@@0 b_2_1@@0)) (< NoPerm FullPerm)) (qpRange20 this_2_1@@0 b_2_1@@0)) (and (=> (< NoPerm FullPerm) (and (= (invRecv20 this_2_1@@0 b_2_1@@0) this_2_1@@0) (=  (not b_1@@5) b_2_1@@0))) (= (U_2_real (MapType1Select QPMask@1 null (valid this_2_1@@0 b_2_1@@0))) (+ (U_2_real (MapType1Select QPMask@0 null (valid this_2_1@@0 b_2_1@@0))) FullPerm)))))
...
)) (forall ((this_2_1@@1 T@U) (b_2_1@@1 Bool) ) (!  (=> (and (= (type this_2_1@@1) RefType) (not (and (and (|Seq#Contains| xs (invRecv20 this_2_1@@1 b_2_1@@1)) (< NoPerm FullPerm)) (qpRange20 this_2_1@@1 b_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@1 null (valid this_2_1@@1 b_2_1@@1))) (U_2_real (MapType1Select QPMask@0 null (valid this_2_1@@1 b_2_1@@1)))))
 :qid |stdinbpl.3234:22|
 :skolemid |246|
 :pattern ( (MapType1Select QPMask@1 null (valid this_2_1@@1 b_2_1@@1)))
)))) (and (and (state Heap@@10 QPMask@1) (state Heap@@10 QPMask@1)) (and (|valid#trigger| Heap@@10 (valid this@@5 true)) (= (MapType0Select Heap@@10 null (valid this@@5 true)) (FrameFragment (FrameFragment (MapType0Select Heap@@10 this@@5 f_7))))))) (and (=> (= (ControlFlow 0 12) 9) anon11_Then_correct) (=> (= (ControlFlow 0 12) 11) anon11_Else_correct))))))))
(let ((anon10_Then_correct true))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| xs x_1)) (|Seq#Contains| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= x_1 x_1_1)) (= b_1@@5  (not b_1@@5)))))
 :qid |stdinbpl.3166:17|
 :skolemid |235|
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| xs x_1@@1) (< NoPerm FullPerm)) (and (= (invRecv19 x_1@@1 b_1@@5) x_1@@1) (qpRange19 x_1@@1 b_1@@5))))
 :qid |stdinbpl.3172:22|
 :skolemid |236|
 :pattern ( (MapType0Select Heap@@10 null (valid x_1@@1 b_1@@5)))
 :pattern ( (MapType1Select ZeroMask null (valid x_1@@1 b_1@@5)))
 :pattern ( (|Seq#ContainsTrigger| xs x_1@@1))
 :pattern ( (|Seq#Contains| xs x_1@@1))
)) (=> (and (forall ((this_1_1 T@U) (b_1_1 Bool) ) (!  (=> (= (type this_1_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv19 this_1_1 b_1_1)) (< NoPerm FullPerm)) (qpRange19 this_1_1 b_1_1)) (and (= (invRecv19 this_1_1 b_1_1) this_1_1) (= b_1@@5 b_1_1))))
 :qid |stdinbpl.3176:22|
 :skolemid |237|
 :pattern ( (invRecv19 this_1_1 b_1_1))
)) (forall ((this_1_1@@0 T@U) (b_1_1@@0 Bool) ) (!  (=> (= (type this_1_1@@0) RefType) (=> (and (and (|Seq#Contains| xs (invRecv19 this_1_1@@0 b_1_1@@0)) (< NoPerm FullPerm)) (qpRange19 this_1_1@@0 b_1_1@@0)) (and (=> (< NoPerm FullPerm) (and (= (invRecv19 this_1_1@@0 b_1_1@@0) this_1_1@@0) (= b_1@@5 b_1_1@@0))) (= (U_2_real (MapType1Select QPMask@0 null (valid this_1_1@@0 b_1_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (valid this_1_1@@0 b_1_1@@0))) FullPerm)))))
 :qid |stdinbpl.3182:22|
 :skolemid |238|
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 ...
 :qid |stdinbpl.3188:29|
 :skolemid |239|
 :pattern ( (MapType1Select ZeroMask o_3@@0 f_5@@0))
 :pattern ( (MapType1Select QPMask@0 o_3@@0 f_5@@0))
)) (forall ((this_1_1@@1 T@U) (b_1_1@@1 Bool) ) (!  (=> (and (= (type this_1_1@@1) RefType) (not (and (and (|Seq#Contains| xs (invRecv19 this_1_1@@1 b_1_1@@1)) (< NoPerm FullPerm)) (qpRange19 this_1_1@@1 b_1_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (valid this_1_1@@1 b_1_1@@1))) (U_2_real (MapType1Select ZeroMask null (valid this_1_1@@1 b_1_1@@1)))))
 :qid |stdinbpl.3192:22|
 :skolemid |240|
 :pattern ( (MapType1Select QPMask@0 null (valid this_1_1@@1 b_1_1@@1)))
))) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0))) (and (=> (= (ControlFlow 0 14) 2) anon10_Then_correct) (=> (= (ControlFlow 0 14) 12) anon10_Else_correct)))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 this@@5 $allocated))) (and (|Seq#Contains| xs this@@5) (state Heap@@10 ZeroMask))) (and (=> (= (ControlFlow 0 16) 1) anon9_Then_correct) (=> (= (ControlFlow 0 16) 14) anon9_Else_correct)))))
