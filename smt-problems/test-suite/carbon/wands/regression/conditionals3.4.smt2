...
(declare-fun b_67@15 () Bool)
(declare-fun b_65@2 () Bool)
(declare-fun b_71@9 () Bool)
(declare-fun neededTransfer@11 () Real)
(declare-fun Used_31Mask@5 () T@U)
(declare-fun initNeededTransfer@1 () Real)
(declare-fun b_72@0 () Bool)
(declare-fun b_72@1 () Bool)
(declare-fun Result_26Heap () T@U)
(declare-fun Result_26Mask () T@U)
(declare-fun b_72@2 () Bool)
(declare-fun Ops_27Mask () T@U)
(declare-fun b_72@3 () Bool)
(declare-fun Ops_27Heap@1 () T@U)
(declare-fun Used_31Heap@0 () T@U)
(declare-fun b_72@4 () Bool)
(declare-fun b_67@16 () Bool)
(declare-fun Ops_25Mask@4 () T@U)
(declare-fun Ops_25Mask () T@U)
(declare-fun b_65@3 () Bool)
(declare-fun Ops_25Heap () T@U)
...
(declare-fun b_68@6 () Bool)
(declare-fun neededTransfer@5 () Real)
(declare-fun Used_29Mask@5 () T@U)
(declare-fun initNeededTransfer@0 () Real)
(declare-fun b_69@0 () Bool)
(declare-fun b_69@1 () Bool)
(declare-fun Result_25Heap () T@U)
(declare-fun Result_25Mask () T@U)
(declare-fun b_69@2 () Bool)
(declare-fun Ops_27Mask@1 () T@U)
(declare-fun b_69@3 () Bool)
(declare-fun Ops_27Heap@0 () T@U)
(declare-fun Used_29Heap@0 () T@U)
(declare-fun b_69@4 () Bool)
(declare-fun b_67@3 () Bool)
(declare-fun b_67@4 () Bool)
(declare-fun b_67@5 () Bool)
(declare-fun b_67@6 () Bool)
(declare-fun b_70@0 () Bool)
(declare-fun b_70 () Bool)
(declare-fun Used_30Heap@0 () T@U)
(declare-fun b_67@7 () Bool)
(declare-fun b_67@8 () Bool)
(declare-fun b_67@9 () Bool)
(declare-fun b_67@10 () Bool)
(declare-fun Ops_27Mask@2 () T@U)
(declare-fun b_67@11 () Bool)
(declare-fun b_67@12 () Bool)
(declare-fun ExhaleHeap@0 () T@U)
(declare-fun b_67@13 () Bool)
(declare-fun b_67@14 () Bool)
(declare-fun Mask@3 () T@U)
(declare-fun Ops_25Mask@1 () T@U)
(declare-fun takeTransfer@2 () Real)
(declare-fun Mask@1 () T@U)
(declare-fun Used_29Mask@3 () T@U)
(declare-fun b_68@4 () Bool)
(declare-fun neededTransfer@3 () Real)
(declare-fun neededTransfer@4 () Real)
(declare-fun Used_29Mask@4 () T@U)
(declare-fun b_68@5 () Bool)
(declare-fun Mask@2 () T@U)
(declare-fun maskTransfer@2 () Real)
(declare-fun takeTransfer@1 () Real)
(declare-fun neededTransfer@1 () Real)
(declare-fun b_68@2 () Bool)
(declare-fun Used_29Mask@1 () T@U)
(declare-fun neededTransfer@2 () Real)
(declare-fun Used_29Mask@2 () T@U)
(declare-fun b_68@3 () Bool)
(declare-fun Ops_25Mask@0 () T@U)
(declare-fun maskTransfer@1 () Real)
(declare-fun takeTransfer@0 () Real)
(declare-fun b_68@0 () Bool)
(declare-fun neededTransfer@0 () Real)
(declare-fun Used_29Mask@0 () T@U)
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@10) (MapType0Type RefType realType)) (= (type Mask@9) (MapType0Type RefType realType))) (= (type x@@14) RefType)) (= (type ExhaleHeap@1) (MapType1Type RefType))) (= (type ExhaleHeap@2) (MapType1Type RefType))) (= (type Mask@8) (MapType0Type RefType realType))) (= (type Heap@2) (MapType1Type RefType))) (= (type Used_32Heap@0) (MapType1Type RefType))) (= (type Mask@7) (MapType0Type RefType realType))) (= (type Mask@1) (MapType0Type RefType realType))) (= (type Heap@@10) (MapType1Type RefType))) (= (type Used_31Mask@5) (MapType0Type RefType realType))) (= (type Result_26Heap) (MapType1Type RefType))) (= (type Result_26Mask) (MapType0Type RefType realType))) (= (type Ops_27Mask) (MapType0Type RefType realType))) (= (type Ops_27Heap@1) (MapType1Type RefType))) (= (type Used_31Heap@0) (MapType1Type RefType))) (= (type Ops_25Mask@4) (MapType0Type RefType realType))) (= (type Ops_25Mask) (MapType0Type RefType realType))) (= (type Ops_25Heap) (MapType1Type RefType))) (= (type Mask@6) (MapType0Type RefType realType))) (= (type Heap@1) (MapType1Type RefType))) (= (type Mask@4) (MapType0Type RefType realType))) (= (type Used_31Mask@3) (MapType0Type RefType realType))) (= (type Used_31Mask@4) (MapType0Type RefType realType))) (= (type Mask@5) (MapType0Type RefType realType))) (= (type Heap@0) (MapType1Type RefType))) (= (type Used_31Mask@1) (MapType0Type RefType realType))) (= (type Used_31Mask@2) (MapType0Type RefType realType))) (= (type Ops_25Heap@0) (MapType1Type RefType))) (= (type Ops_25Mask@3) (MapType0Type RefType realType))) (= (type Ops_25Mask@2) (MapType0Type RefType realType))) (= (type Ops_25Heap@1) (MapType1Type RefType))) (= (type Used_31Mask@0) (MapType0Type RefType realType))) (= (type Ops_27Mask@4) (MapType0Type RefType realType))) (= (type Ops_27Mask@3) (MapType0Type RefType realType))) (= (type Ops_27Heap@0) (MapType1Type RefType))) (= (type Used_29Mask@5) (MapType0Type RefType realType))) (= (type Result_25Heap) (MapType1Type RefType))) (= (type Result_25Mask) (MapType0Type RefType realType))) (= (type Ops_27Mask@1) (MapType0Type RefType realType))) (= (type Used_29Heap@0) (MapType1Type RefType))) (= (type Used_30Heap@0) (MapType1Type RefType))) (= (type Ops_27Mask@2) (MapType0Type RefType realType))) (= (type ExhaleHeap@0) (MapType1Type RefType))) (= (type Mask@3) (MapType0Type RefType realType))) (= (type Ops_25Mask@1) (MapType0Type RefType realType))) (= (type Used_29Mask@3) (MapType0Type RefType realType))) (= (type Used_29Mask@4) (MapType0Type RefType realType))) (= (type Mask@2) (MapType0Type RefType realType))) (= (type Used_29Mask@1) (MapType0Type RefType realType))) (= (type Used_29Mask@2) (MapType0Type RefType realType))) (= (type Ops_25Mask@0) (MapType0Type RefType realType))) (= (type Used_29Mask@0) (MapType0Type RefType realType))) (= (type Ops_27Mask@0) (MapType0Type RefType realType))) (= (type Used_28Heap@0) (MapType1Type RefType))) (= (type Mask@0) (MapType0Type RefType realType))) (= (type Used_27Heap@0) (MapType1Type RefType))))
(set-info :boogie-vc-id curry_test03)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 72) (let ((anon62_Then_correct true))
(let ((anon54_correct  (=> (and (and (= Mask@10 (MapType0Store Mask@9 x@@14 f_7 (real_2_U (- (U_2_real (MapType0Select Mask@9 x@@14 f_7)) FullPerm)))) (IdenticalOnKnownLocations ExhaleHeap@1 ExhaleHeap@2 Mask@10)) (and (state ExhaleHeap@2 Mask@10) (= (ControlFlow 0 4) (- 0 3)))) false)))
(let ((anon82_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 4)) anon54_correct)))
(let ((anon82_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType0Select Mask@9 x@@14 f_7)))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@9 x@@14 f_7))) (=> (= (ControlFlow 0 5) 4) anon54_correct))))))
(let ((anon81_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType0Select Mask@8 null (wand_6 true true))))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@8 null (wand_6 true true)))) (=> (= Mask@9 (MapType0Store Mask@8 null (wand_6 true true) (real_2_U (- (U_2_real (MapType0Select Mask@8 null (wand_6 true true))) FullPerm)))) (=> (and (IdenticalOnKnownLocations Heap@2 ExhaleHeap@1 Mask@9) (state ExhaleHeap@1 Mask@9)) (and (=> (= (ControlFlow 0 8) 5) anon82_Then_correct) (=> (= (ControlFlow 0 8) 7) anon82_Else_correct))))))))
(let ((anon81_Then_correct true))
(let ((anon50_correct  (=> (= b_73@0  (and b_73 (state Used_32Heap@0 ZeroMask))) (=> (and (and (= Mask@8 (MapType0Store Mask@7 null (wand_6 true true) (real_2_U (+ (U_2_real (MapType0Select Mask@7 null (wand_6 true true))) FullPerm)))) (state Heap@2 Mask@8)) (and (state Heap@2 Mask@8) (state Heap@2 Mask@8))) (and (=> (= (ControlFlow 0 10) 2) anon81_Then_correct) (=> (= (ControlFlow 0 10) 8) anon81_Else_correct))))))
(let ((anon49_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (=> (and (and b_67@15 (and b_67@15 b_65@2)) b_71@9) (and (= neededTransfer@11 0.0) (= (U_2_real (MapType0Select Used_31Mask@5 x@@14 f_7)) initNeededTransfer@1)))) (=> (=> (and (and b_67@15 (and b_67@15 b_65@2)) b_71@9) (and (= neededTransfer@11 0.0) (= (U_2_real (MapType0Select Used_31Mask@5 x@@14 f_7)) initNeededTransfer@1))) (=> (= b_72@0  (and b_67@15 b_71@9)) (=> (and (and (= b_72@1  (and b_72@0 (state Result_26Heap Result_26Mask))) (= b_72@2  (and b_72@1 (sumMask Result_26Mask Ops_27Mask Used_31Mask@5)))) (and (= b_72@3  (and (and b_72@2 (IdenticalOnKnownLocations Ops_27Heap@1 Result_26Heap Ops_27Mask)) (IdenticalOnKnownLocations Used_31Heap@0 Result_26Heap Used_31Mask@5))) (= b_72@4  (and b_72@3 (state Result_26Heap Result_26Mask))))) (=> (and (and (and (= b_67@16  (and b_67@15 b_72@4)) (= Ops_25Mask@4 (MapType0Store Ops_25Mask null (wand_7 true x@@14 FullPerm) (real_2_U (+ (U_2_real (MapType0Select Ops_25Mask null (wand_7 true x@@14 FullPerm))) FullPerm))))) (and (= b_65@3  (and b_65@2 (state Ops_25Heap Ops_25Mask@4))) (= b_65@4  (and b_65@3 (state Ops_25Heap Ops_25Mask@4))))) (and (and (= b_65@5  (and b_65@4 (state Ops_25Heap Ops_25Mask@4))) (= Mask@7 Mask@6)) (and (= Heap@2 Heap@1) (= (ControlFlow 0 12) 10)))) anon50_correct)))))))
(let ((anon80_Else_correct  (=> (>= 0.0 takeTransfer@5) (=> (and (= Mask@6 Mask@4) (= Used_31Mask@5 Used_31Mask@3)) (=> (and (and (= b_71@9 b_71@6) (= neededTransfer@11 neededTransfer@9)) (and (= Heap@1 Heap@@10) (= (ControlFlow 0 16) 12))) anon49_correct)))))
(let ((anon80_Then_correct  (=> (> takeTransfer@5 0.0) (=> (and (and (= neededTransfer@10 (- neededTransfer@9 takeTransfer@5)) (= Used_31Mask@4 (MapType0Store Used_31Mask@3 x@@14 f_7 (real_2_U (+ (U_2_real (MapType0Select Used_31Mask@3 x@@14 f_7)) takeTransfer@5))))) (and (= b_71@7  (and b_71@6 (state Used_31Heap@0 Used_31Mask@4))) (= b_71@8  (and b_71@7 (= (U_2_bool (MapType1Select Heap@@10 x@@14 f_7)) (U_2_bool (MapType1Select Used_31Heap@0 x@@14 f_7))))))) (=> (and (and (and (= Mask@5 (MapType0Store Mask@4 x@@14 f_7 (real_2_U (- (U_2_real (MapType0Select Mask@4 x@@14 f_7)) takeTransfer@5)))) (= Heap@0 (MapType1Store Heap@@10 null (|wand_7#sm| true x@@14 FullPerm) (MapType0Store (MapType1Select Heap@@10 null (|wand_7#sm| true x@@14 FullPerm)) x@@14 f_7 (bool_2_U true))))) (and (= Mask@6 Mask@5) (= Used_31Mask@5 Used_31Mask@4))) (and (and (= b_71@9 b_71@8) (= neededTransfer@11 neededTransfer@10)) (and (= Heap@1 Heap@0) (= (ControlFlow 0 15) 12)))) anon49_correct)))))
...
(let ((anon78_Then_correct  (=> (and (and (and (and (and b_67@15 (and b_67@15 b_65@2)) b_71@6) true) (> neededTransfer@9 0.0)) (= maskTransfer@5 (U_2_real (MapType0Select Mask@4 x@@14 f_7)))) (and (=> (= (ControlFlow 0 19) 17) anon79_Then_correct) (=> (= (ControlFlow 0 19) 18) anon79_Else_correct)))))
(let ((anon78_Else_correct  (=> (not (and (and (and (and b_67@15 (and b_67@15 b_65@2)) b_71@6) true) (> neededTransfer@9 0.0))) (=> (and (= Mask@6 Mask@4) (= Used_31Mask@5 Used_31Mask@3)) (=> (and (and (= b_71@9 b_71@6) (= neededTransfer@11 neededTransfer@9)) (and (= Heap@1 Heap@@10) (= (ControlFlow 0 14) 12))) anon49_correct)))))
(let ((anon77_Else_correct  (=> (and (and (>= 0.0 takeTransfer@4) (= neededTransfer@9 neededTransfer@7)) (and (= b_71@6 b_71@3) (= Used_31Mask@3 Used_31Mask@1))) (and (=> (= (ControlFlow 0 22) 19) anon78_Then_correct) (=> (= (ControlFlow 0 22) 14) anon78_Else_correct)))))
(let ((anon77_Then_correct  (=> (and (> takeTransfer@4 0.0) (= neededTransfer@8 (- neededTransfer@7 takeTransfer@4))) (=> (and (and (and (= Used_31Mask@2 (MapType0Store Used_31Mask@1 x@@14 f_7 (real_2_U (+ (U_2_real (MapType0Select Used_31Mask@1 x@@14 f_7)) takeTransfer@4)))) (= b_71@4  (and b_71@3 (state Used_31Heap@0 Used_31Mask@2)))) (and (= b_71@5  (and b_71@4 (= (U_2_bool (MapType1Select Ops_25Heap@0 x@@14 f_7)) (U_2_bool (MapType1Select Used_31Heap@0 x@@14 f_7))))) (= Ops_25Mask@3 (MapType0Store Ops_25Mask@2 x@@14 f_7 (real_2_U (- (U_2_real (MapType0Select Ops_25Mask@2 x@@14 f_7)) takeTransfer@4)))))) (and (and (= Ops_25Heap@1 (MapType1Store Ops_25Heap@0 null (|wand_7#sm| true x@@14 FullPerm) (MapType0Store (MapType1Select Ops_25Heap@0 null (|wand_7#sm| true x@@14 FullPerm)) x@@14 f_7 (bool_2_U true)))) (= neededTransfer@9 neededTransfer@8)) (and (= b_71@6 b_71@5) (= Used_31Mask@3 Used_31Mask@2)))) (and (=> (= (ControlFlow 0 21) 19) anon78_Then_correct) (=> (= (ControlFlow 0 21) 14) anon78_Else_correct))))))
...
(let ((anon75_Then_correct  (=> (and (and (and (and (and b_67@15 (and b_67@15 b_65@2)) b_71@3) true) (> neededTransfer@7 0.0)) (= maskTransfer@4 (U_2_real (MapType0Select Ops_25Mask@2 x@@14 f_7)))) (and (=> (= (ControlFlow 0 25) 23) anon76_Then_correct) (=> (= (ControlFlow 0 25) 24) anon76_Else_correct)))))
(let ((anon75_Else_correct  (=> (and (and (not (and (and (and (and b_67@15 (and b_67@15 b_65@2)) b_71@3) true) (> neededTransfer@7 0.0))) (= neededTransfer@9 neededTransfer@7)) (and (= b_71@6 b_71@3) (= Used_31Mask@3 Used_31Mask@1))) (and (=> (= (ControlFlow 0 20) 19) anon78_Then_correct) (=> (= (ControlFlow 0 20) 14) anon78_Else_correct)))))
(let ((anon74_Else_correct  (=> (and (and (>= 0.0 takeTransfer@3) (= Used_31Mask@1 ZeroMask)) (and (= b_71@3 b_71@0) (= neededTransfer@7 FullPerm))) (and (=> (= (ControlFlow 0 28) 25) anon75_Then_correct) (=> (= (ControlFlow 0 28) 20) anon75_Else_correct)))))
(let ((anon74_Then_correct  (=> (> takeTransfer@3 0.0) (=> (and (and (and (= neededTransfer@6 (- FullPerm takeTransfer@3)) (= Used_31Mask@0 (MapType0Store ZeroMask x@@14 f_7 (real_2_U (+ (U_2_real (MapType0Select ZeroMask x@@14 f_7)) takeTransfer@3))))) (and (= b_71@1  (and b_71@0 (state Used_31Heap@0 Used_31Mask@0))) (= b_71@2  (and b_71@1 (= (U_2_bool (MapType1Select Ops_27Heap@1 x@@14 f_7)) (U_2_bool (MapType1Select Used_31Heap@0 x@@14 f_7))))))) (and (and (= Ops_27Mask@4 (MapType0Store Ops_27Mask@3 x@@14 f_7 (real_2_U (- (U_2_real (MapType0Select Ops_27Mask@3 x@@14 f_7)) takeTransfer@3)))) (= Used_31Mask@1 Used_31Mask@0)) (and (= b_71@3 b_71@2) (= neededTransfer@7 neededTransfer@6)))) (and (=> (= (ControlFlow 0 27) 25) anon75_Then_correct) (=> (= (ControlFlow 0 27) 20) anon75_Else_correct))))))
...
(let ((anon72_Then_correct  (=> (and (and (and (and (and b_67@15 (and b_67@15 b_65@2)) b_71@0) true) (> FullPerm 0.0)) (= maskTransfer@3 (U_2_real (MapType0Select Ops_27Mask@3 x@@14 f_7)))) (and (=> (= (ControlFlow 0 31) 29) anon73_Then_correct) (=> (= (ControlFlow 0 31) 30) anon73_Else_correct)))))
(let ((anon72_Else_correct  (=> (and (and (not (and (and (and (and b_67@15 (and b_67@15 b_65@2)) b_71@0) true) (> FullPerm 0.0))) (= Used_31Mask@1 ZeroMask)) (and (= b_71@3 b_71@0) (= neededTransfer@7 FullPerm))) (and (=> (= (ControlFlow 0 26) 25) anon75_Then_correct) (=> (= (ControlFlow 0 26) 20) anon75_Else_correct)))))
(let ((anon31_correct  (=> (and (= b_71@0  (and b_71 (state Used_31Heap@0 ZeroMask))) (= initNeededTransfer@1 (+ (U_2_real (MapType0Select ZeroMask x@@14 f_7)) FullPerm))) (and (=> (= (ControlFlow 0 32) (- 0 33)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 32) 31) anon72_Then_correct) (=> (= (ControlFlow 0 32) 26) anon72_Else_correct)))))))
(let ((anon30_correct  (and (=> (= (ControlFlow 0 35) (- 0 36)) (=> (and b_67@2 b_68@6) (and (= neededTransfer@5 0.0) (= (U_2_real (MapType0Select Used_29Mask@5 null (wand_7 true x@@14 FullPerm))) initNeededTransfer@0)))) (=> (=> (and b_67@2 b_68@6) (and (= neededTransfer@5 0.0) (= (U_2_real (MapType0Select Used_29Mask@5 null (wand_7 true x@@14 FullPerm))) initNeededTransfer@0))) (=> (and (= b_69@0  (and b_67@2 b_68@6)) (= b_69@1  (and b_69@0 (state Result_25Heap Result_25Mask)))) (=> (and (and (and (= b_69@2  (and b_69@1 (sumMask Result_25Mask Ops_27Mask@1 Used_29Mask@5))) (= b_69@3  (and (and b_69@2 (IdenticalOnKnownLocations Ops_27Heap@0 Result_25Heap Ops_27Mask@1)) (IdenticalOnKnownLocations Used_29Heap@0 Result_25Heap Used_29Mask@5)))) (and (= b_69@4  (and b_69@3 (state Result_25Heap Result_25Mask))) (= b_67@3  (and b_67@2 b_69@4)))) (and (and (= b_67@4  (and b_67@3 b_68@6)) (= b_67@5  (and b_67@4 (= Used_29Heap@0 Ops_27Heap@0)))) (and (= b_67@6  (and b_67@5 (state Ops_27Heap@0 Ops_27Mask@1))) (= b_70@0  (and b_70 (state Used_30Heap@0 ZeroMask)))))) (=> (and (and (and (and (= b_67@7  (and b_67@6 b_70@0)) (= b_67@8  (and b_67@7 (= Used_30Heap@0 Ops_27Heap@0)))) (and (= b_67@9  (and b_67@8 (state Ops_27Heap@0 Ops_27Mask@1))) (= b_67@10  (and b_67@9 (not (= x@@14 null)))))) (and (and (= Ops_27Mask@2 (MapType0Store Ops_27Mask@1 x@@14 f_7 (real_2_U (+ (U_2_real (MapType0Select Ops_27Mask@1 x@@14 f_7)) FullPerm)))) (= b_67@11  (and b_67@10 (state Ops_27Heap@0 Ops_27Mask@2)))) (and (= b_67@12  (and b_67@11 (state Ops_27Heap@0 Ops_27Mask@2))) (IdenticalOnKnownLocations Ops_27Heap@0 ExhaleHeap@0 Ops_27Mask@2)))) (and (and (and (= b_67@13  (and b_67@12 (state ExhaleHeap@0 Ops_27Mask@2))) (= b_67@14  (and b_67@13 (state ExhaleHeap@0 Ops_27Mask@2)))) (and (= Ops_27Heap@1 ExhaleHeap@0) (= b_67@15 b_67@14))) (and (and (= Mask@4 Mask@3) (= Ops_25Mask@2 Ops_25Mask@1)) (and (= Ops_27Mask@3 Ops_27Mask@2) (= (ControlFlow 0 35) 32))))) anon31_correct)))))))
(let ((anon71_Else_correct  (=> (and (>= 0.0 takeTransfer@2) (= Mask@3 Mask@1)) (=> (and (and (= Used_29Mask@5 Used_29Mask@3) (= b_68@6 b_68@4)) (and (= neededTransfer@5 neededTransfer@3) (= (ControlFlow 0 39) 35))) anon30_correct))))
(let ((anon71_Then_correct  (=> (and (> takeTransfer@2 0.0) (= neededTransfer@4 (- neededTransfer@3 takeTransfer@2))) (=> (and (and (and (= Used_29Mask@4 (MapType0Store Used_29Mask@3 null (wand_7 true x@@14 FullPerm) (real_2_U (+ (U_2_real (MapType0Select Used_29Mask@3 null (wand_7 true x@@14 FullPerm))) takeTransfer@2)))) (= b_68@5  (and b_68@4 (state Used_29Heap@0 Used_29Mask@4)))) (and (= Mask@2 (MapType0Store Mask@1 null (wand_7 true x@@14 FullPerm) (real_2_U (- (U_2_real (MapType0Select Mask@1 null (wand_7 true x@@14 FullPerm))) takeTransfer@2)))) (= Mask@3 Mask@2))) (and (and (= Used_29Mask@5 Used_29Mask@4) (= b_68@6 b_68@5)) (and (= neededTransfer@5 neededTransfer@4) (= (ControlFlow 0 38) 35)))) anon30_correct))))
...
(let ((anon69_Then_correct  (=> (and (and (and (and b_67@2 b_68@4) true) (> neededTransfer@3 0.0)) (= maskTransfer@2 (U_2_real (MapType0Select Mask@1 null (wand_7 true x@@14 FullPerm))))) (and (=> (= (ControlFlow 0 42) 40) anon70_Then_correct) (=> (= (ControlFlow 0 42) 41) anon70_Else_correct)))))
(let ((anon69_Else_correct  (=> (and (not (and (and (and b_67@2 b_68@4) true) (> neededTransfer@3 0.0))) (= Mask@3 Mask@1)) (=> (and (and (= Used_29Mask@5 Used_29Mask@3) (= b_68@6 b_68@4)) (and (= neededTransfer@5 neededTransfer@3) (= (ControlFlow 0 37) 35))) anon30_correct))))
(let ((anon68_Else_correct  (=> (>= 0.0 takeTransfer@1) (=> (and (and (= Ops_25Mask@1 ZeroMask) (= neededTransfer@3 neededTransfer@1)) (and (= b_68@4 b_68@2) (= Used_29Mask@3 Used_29Mask@1))) (and (=> (= (ControlFlow 0 45) 42) anon69_Then_correct) (=> (= (ControlFlow 0 45) 37) anon69_Else_correct))))))
(let ((anon68_Then_correct  (=> (> takeTransfer@1 0.0) (=> (and (and (and (= neededTransfer@2 (- neededTransfer@1 takeTransfer@1)) (= Used_29Mask@2 (MapType0Store Used_29Mask@1 null (wand_7 true x@@14 FullPerm) (real_2_U (+ (U_2_real (MapType0Select Used_29Mask@1 null (wand_7 true x@@14 FullPerm))) takeTransfer@1))))) (and (= b_68@3  (and b_68@2 (state Used_29Heap@0 Used_29Mask@2))) (= Ops_25Mask@0 (MapType0Store ZeroMask null (wand_7 true x@@14 FullPerm) (real_2_U (- (U_2_real (MapType0Select ZeroMask null (wand_7 true x@@14 FullPerm))) takeTransfer@1)))))) (and (and (= Ops_25Mask@1 Ops_25Mask@0) (= neededTransfer@3 neededTransfer@2)) (and (= b_68@4 b_68@3) (= Used_29Mask@3 Used_29Mask@2)))) (and (=> (= (ControlFlow 0 44) 42) anon69_Then_correct) (=> (= (ControlFlow 0 44) 37) anon69_Else_correct))))))
...
(let ((anon66_Then_correct  (=> (and (and (and (and b_67@2 b_68@2) true) (> neededTransfer@1 0.0)) (= maskTransfer@1 (U_2_real (MapType0Select ZeroMask null (wand_7 true x@@14 FullPerm))))) (and (=> (= (ControlFlow 0 48) 46) anon67_Then_correct) (=> (= (ControlFlow 0 48) 47) anon67_Else_correct)))))
(let ((anon66_Else_correct  (=> (not (and (and (and b_67@2 b_68@2) true) (> neededTransfer@1 0.0))) (=> (and (and (= Ops_25Mask@1 ZeroMask) (= neededTransfer@3 neededTransfer@1)) (and (= b_68@4 b_68@2) (= Used_29Mask@3 Used_29Mask@1))) (and (=> (= (ControlFlow 0 43) 42) anon69_Then_correct) (=> (= (ControlFlow 0 43) 37) anon69_Else_correct))))))
(let ((anon65_Else_correct  (=> (>= 0.0 takeTransfer@0) (=> (and (and (= Ops_27Mask@1 ZeroMask) (= Used_29Mask@1 ZeroMask)) (and (= b_68@2 b_68@0) (= neededTransfer@1 1.0))) (and (=> (= (ControlFlow 0 51) 48) anon66_Then_correct) (=> (= (ControlFlow 0 51) 43) anon66_Else_correct))))))
(let ((anon65_Then_correct  (=> (> takeTransfer@0 0.0) (=> (and (and (and (= neededTransfer@0 (- 1.0 takeTransfer@0)) (= Used_29Mask@0 (MapType0Store ZeroMask null (wand_7 true x@@14 FullPerm) (real_2_U (+ (U_2_real (MapType0Select ZeroMask null (wand_7 true x@@14 FullPerm))) takeTransfer@0))))) (and (= b_68@1  (and b_68@0 (state Used_29Heap@0 Used_29Mask@0))) (= Ops_27Mask@0 (MapType0Store ZeroMask null (wand_7 true x@@14 FullPerm) (real_2_U (- (U_2_real (MapType0Select ZeroMask null (wand_7 true x@@14 FullPerm))) takeTransfer@0)))))) (and (and (= Ops_27Mask@1 Ops_27Mask@0) (= Used_29Mask@1 Used_29Mask@0)) (and (= b_68@2 b_68@1) (= neededTransfer@1 neededTransfer@0)))) (and (=> (= (ControlFlow 0 50) 48) anon66_Then_correct) (=> (= (ControlFlow 0 50) 43) anon66_Else_correct))))))
...
(let ((anon63_Then_correct  (=> (and (and (and (and b_67@2 b_68@0) true) (> 1.0 0.0)) (= maskTransfer@0 (U_2_real (MapType0Select ZeroMask null (wand_7 true x@@14 FullPerm))))) (and (=> (= (ControlFlow 0 54) 52) anon64_Then_correct) (=> (= (ControlFlow 0 54) 53) anon64_Else_correct)))))
(let ((anon63_Else_correct  (=> (not (and (and (and b_67@2 b_68@0) true) (> 1.0 0.0))) (=> (and (and (= Ops_27Mask@1 ZeroMask) (= Used_29Mask@1 ZeroMask)) (and (= b_68@2 b_68@0) (= neededTransfer@1 1.0))) (and (=> (= (ControlFlow 0 49) 48) anon66_Then_correct) (=> (= (ControlFlow 0 49) 43) anon66_Else_correct))))))
(let ((anon12_correct  (=> (= initNeededTransfer@0 (+ (U_2_real (MapType0Select ZeroMask null (wand_7 true x@@14 FullPerm))) 1.0)) (and (=> (= (ControlFlow 0 55) (- 0 56)) (>= 1.0 0.0)) (=> (>= 1.0 0.0) (and (=> (= (ControlFlow 0 55) 54) anon63_Then_correct) (=> (= (ControlFlow 0 55) 49) anon63_Else_correct)))))))
(let ((anon61_Then_correct  (=> b_67@2 (and (=> (= (ControlFlow 0 60) 59) anon62_Then_correct) (=> (= (ControlFlow 0 60) 55) anon12_correct)))))
(let ((anon61_Else_correct  (=> (and (not b_67@2) (= (ControlFlow 0 58) 55)) anon12_correct)))
(let ((anon60_Then_correct  (=> (and b_67@2 b_68@0) (and (=> (= (ControlFlow 0 61) 60) anon61_Then_correct) (=> (= (ControlFlow 0 61) 58) anon61_Else_correct)))))
(let ((anon60_Else_correct  (=> (and (not (and b_67@2 b_68@0)) (= (ControlFlow 0 57) 55)) anon12_correct)))
(let ((anon59_Then_correct  (=> (and (and b_67@2 b_65@2) (= b_68@0  (and b_68 (state Used_29Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 62) 61) anon60_Then_correct) (=> (= (ControlFlow 0 62) 57) anon60_Else_correct)))))
(let ((anon59_Else_correct  (=> (not (and b_67@2 b_65@2)) (=> (and (= Ops_27Heap@1 Ops_27Heap@0) (= b_67@15 b_67@2)) (=> (and (and (= Mask@4 Mask@1) (= Ops_25Mask@2 ZeroMask)) (and (= Ops_27Mask@3 ZeroMask) (= (ControlFlow 0 34) 32))) anon31_correct)))))
(let ((anon7_correct  (=> (and (= b_67@1  (and b_67@0 (state Ops_27Heap@0 ZeroMask))) (= b_67@2  (and b_67@1 (state Ops_27Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 63) 62) anon59_Then_correct) (=> (= (ControlFlow 0 63) 34) anon59_Else_correct)))))
(let ((anon58_Else_correct  (=> (and (not b_67@0) (= (ControlFlow 0 65) 63)) anon7_correct)))
(let ((anon58_Then_correct  (=> (and b_67@0 (= (ControlFlow 0 64) 63)) anon7_correct)))
(let ((anon57_Then_correct  (=> b_65@2 (=> (and (= b_67@0  (and b_67 (state Ops_27Heap@0 ZeroMask))) (= b_66@0  (and b_66 (state Used_28Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 66) 64) anon58_Then_correct) (=> (= (ControlFlow 0 66) 65) anon58_Else_correct))))))
(let ((anon57_Else_correct  (=> (and (and (not b_65@2) (= Mask@7 Mask@1)) (and (= Heap@2 Heap@@10) (= (ControlFlow 0 11) 10))) anon50_correct)))
(let ((anon4_correct  (=> (and (= b_65@1  (and b_65@0 (state Ops_25Heap@0 ZeroMask))) (= b_65@2  (and b_65@1 (state Ops_25Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 67) 66) anon57_Then_correct) (=> (= (ControlFlow 0 67) 11) anon57_Else_correct)))))
(let ((anon56_Else_correct  (=> (and (not b_65@0) (= (ControlFlow 0 69) 67)) anon4_correct)))
(let ((anon56_Then_correct  (=> (and b_65@0 (= (ControlFlow 0 68) 67)) anon4_correct)))
(let ((anon55_Else_correct  (=> (and (= Mask@1 (MapType0Store Mask@0 null (wand_7 true x@@14 FullPerm) (real_2_U (+ (U_2_real (MapType0Select Mask@0 null (wand_7 true x@@14 FullPerm))) FullPerm)))) (state Heap@@10 Mask@1)) (=> (and (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1)) (and (= b_65@0  (and b_65 (state Ops_25Heap@0 ZeroMask))) (= b_64@0  (and b_64 (state Used_27Heap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 70) 68) anon56_Then_correct) (=> (= (ControlFlow 0 70) 69) anon56_Else_correct))))))
(let ((anon55_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType1Select Heap@@10 x@@14 $allocated)) (not (= x@@14 null))) (=> (and (and (= Mask@0 (MapType0Store ZeroMask x@@14 f_7 (real_2_U (+ (U_2_real (MapType0Select ZeroMask x@@14 f_7)) FullPerm)))) (state Heap@@10 Mask@0)) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 71) 1) anon55_Then_correct) (=> (= (ControlFlow 0 71) 70) anon55_Else_correct)))))))
