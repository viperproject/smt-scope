...
(assert  (and (and (and (= (type Heap@@44) (MapType0Type RefType)) (= (type diz@@169) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |History__inv#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@44 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@44 diz@@169 $allocated)) (not (= diz@@169 null))) (and (= Mask@0 (MapType1Store ZeroMask diz@@169 History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz@@169 History__x_hist_value)) FullPerm)))) (state Heap@@44 Mask@0))) (and (and (not (= diz@@169 null)) (= Mask@1 (MapType1Store Mask@0 diz@@169 History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select Mask@0 diz@@169 History__x_hist_mode)) FullPerm))))) (and (state Heap@@44 Mask@1) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm Mask@1 diz@@169 History__x_hist_mode)))))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type sys__result) RefType)) (forall ((arg0@@85 T@U) ) (! (= (type (type_of arg0@@85)) TYPEDomainTypeType)
 :qid |funType:type_of|
 :pattern ( (type_of arg0@@85))
))) (= (type class_Worker) TYPEDomainTypeType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type l) RefType)) (= (type PostMask@1) (MapType1Type RefType realType))) (= (type Heap@@44) (MapType0Type RefType))) (= (type s) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))))
(set-info :boogie-vc-id Worker__Worker)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon7_Else_correct true))
...
(let ((anon0_correct  (=> (state Heap@@44 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@44 s $allocated))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@44 l $allocated)) (>= current_thread_id 0)) (and (state Heap@@44 ZeroMask) (> wildcard@0 NoPerm))) (and (and (not (= l null)) (= Mask@0 (MapType1Store ZeroMask l SubjectLock__subject (real_2_U (+ (U_2_real (MapType1Select ZeroMask l SubjectLock__subject)) wildcard@0))))) (and (state Heap@@44 Mask@0) (state Heap@@44 Mask@0)))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (HasDirectPerm Mask@0 l SubjectLock__subject)) (=> (HasDirectPerm Mask@0 l SubjectLock__subject) (=> (= (MapType0Select Heap@@44 l SubjectLock__subject) s) (=> (and (state Heap@@44 Mask@0) (= perm@0 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (= Mask@1 (MapType1Store Mask@0 null (SubjectLock__valid l) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (SubjectLock__valid l))) perm@0)))) (state Heap@@44 Mask@1)) (=> (and (and (state Heap@@44 Mask@1) (= Mask@2 (MapType1Store Mask@1 null (History__hist_idle s (/ (to_real 1) (to_real 2)) p_empty) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (History__hist_idle s (/ (to_real 1) (to_real 2)) p_empty))) FullPerm))))) (and (state Heap@@44 Mask@2) (state Heap@@44 Mask@2))) (and (=> (= (ControlFlow 0 11) 2) anon7_Then_correct) (=> (= (ControlFlow 0 11) 5) anon7_Else_correct)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (> wildcard NoPerm) true) (= (ControlFlow 0 14) 11)) anon0_correct)))
PreconditionGeneratedEntry_correct)))))
))
(check-sat)
(pop 1)
