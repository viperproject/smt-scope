...
(assert  (and (= (type Heap@@11) (MapType0Type RefType)) (= (type diz@@11) RefType)))
(set-info :boogie-vc-id |Client__inv#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 diz@@11 $allocated))) (and (<= NoPerm p_1@@5) (= (ControlFlow 0 2) (- 0 1)))) (>= p_1@@5 NoPerm))))
