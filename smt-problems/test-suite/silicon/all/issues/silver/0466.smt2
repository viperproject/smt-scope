(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:04:28
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/issues/silver/0466.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (forall ((i@3@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0466.vpr@5@24@5@74-aux|)))
(assert (forall ((i@3@01 Int)) (!
  (=>
    (and (<= 0 i@3@01) (< i@3@01 (Seq_length l@1@01)))
    (= (Seq_index l@1@01 i@3@01) 4))
  :pattern ((Seq_index l@1@01 i@3@01))
  :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0466.vpr@5@24@5@74|)))
...
(assert (not (not
  (exists ((i@4@01 Int) (s@5@01 Multiset<Int>)) (!
    ...
    :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0466.vpr@7@13@7@54|)))))
(check-sat)
; unknown
(pop) ; 4
; 0,00s
