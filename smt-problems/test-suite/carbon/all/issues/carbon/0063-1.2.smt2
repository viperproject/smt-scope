...
(set-info :boogie-vc-id |V#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 this@@11 $allocated))) (=> (and (and (not (= this@@11 null)) (= Mask@0 (MapType1Store ZeroMask this@@11 y@@1 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@11 y@@1)) FullPerm))))) (and (state Heap@@11 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@0 this@@11 y@@1)))))
