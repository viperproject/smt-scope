...
(set-info :boogie-vc-id test_take_02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= a_2@0 (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 1)) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 5))) (|Seq#Singleton| (int_2_U 7))) (|Seq#Singleton| (int_2_U 8)))) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (|Seq#Equal| (|Seq#Take| a_2@0 (- 0 1)) (|Seq#Empty| intType))) (=> (|Seq#Equal| (|Seq#Take| a_2@0 (- 0 1)) (|Seq#Empty| intType)) (=> (and (and (state Heap@@9 ZeroMask) (< e1 (- 0 1))) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Seq#Equal| (|Seq#Take| a_2@0 e1) (|Seq#Empty| intType))) (=> (|Seq#Equal| (|Seq#Take| a_2@0 e1) (|Seq#Empty| intType)) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Seq#Equal| (|Seq#Take| a_2@0 6) a_2@0)) (=> (|Seq#Equal| (|Seq#Take| a_2@0 6) a_2@0) (=> (and (and (state Heap@@9 ZeroMask) (< 6 e2)) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Seq#Equal| (|Seq#Take| a_2@0 e2) a_2@0)) (=> (|Seq#Equal| (|Seq#Take| a_2@0 e2) a_2@0) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) false))))))))))))))))
