...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type h) RefType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type PostMask@1) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type Mask@7) (MapType1Type RefType realType))) (= (type Mask@16) (MapType1Type RefType realType))) (= (type p_1@@2) ProcessDomainTypeType)) (= (type Mask@15) (MapType1Type RefType realType))) (= (type Mask@14) (MapType1Type RefType realType))) (= (type Mask@12) (MapType1Type RefType realType))) (= (type Mask@13) (MapType1Type RefType realType))) (= (type Mask@37) (MapType1Type RefType realType))) (= (type Mask@36) (MapType1Type RefType realType))) (= (type ExhaleHeap@4) (MapType0Type RefType))) (= (type Mask@35) (MapType1Type RefType realType))) (= (type Mask@32) (MapType1Type RefType realType))) (= (type Mask@31) (MapType1Type RefType realType))) (= (type ExhaleHeap@3) (MapType0Type RefType))) (= (type Mask@33) (MapType1Type RefType realType))) (= (type arg_proc_1@0) ProcessDomainTypeType)) (= (type Mask@34) (MapType1Type RefType realType))) (= (type Mask@30) (MapType1Type RefType realType))) (= (type Mask@29) (MapType1Type RefType realType))) (= (type Mask@28) (MapType1Type RefType realType))) (= (type Mask@26) (MapType1Type RefType realType))) (= (type Mask@25) (MapType1Type RefType realType))) (= (type ExhaleHeap@2) (MapType0Type RefType))) (= (type Mask@27) (MapType1Type RefType realType))) (= (type Mask@24) (MapType1Type RefType realType))) (= (type Mask@20) (MapType1Type RefType realType))) (= (type Mask@19) (MapType1Type RefType realType))) (= (type Mask@21) (MapType1Type RefType realType))) (= (type arg_proc@0) ProcessDomainTypeType)) (= (type Mask@22) (MapType1Type RefType realType))) (= (type Mask@23) (MapType1Type RefType realType))) (= (type Mask@18) (MapType1Type RefType realType))) (= (type Mask@11) (MapType1Type RefType realType))) (= (type Mask@9) (MapType1Type RefType realType))) (= (type Mask@10) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Heap@@19) (MapType0Type RefType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type diz@@19) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id Application__do_incr_loop)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 106) (let ((anon35_correct true))
(let ((anon60_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 22) 19)) anon35_correct)))
(let ((anon60_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (<= FullPerm (U_2_real (MapType1Select Mask@37 null (History__hist_idle h q_1 (p_seq p_1@@2 (p_single i@1))))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@37 null (History__hist_idle h q_1 (p_seq p_1@@2 (p_single i@1)))))) (=> (= (ControlFlow 0 20) 19) anon35_correct))))))
(let ((anon33_correct  (=> (= Mask@37 (MapType1Store Mask@36 h History__x_hist_mode (real_2_U (- (U_2_real (MapType1Select Mask@36 h History__x_hist_mode)) FullPerm)))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (= (U_2_int (MapType0Select ExhaleHeap@4 h History__x_hist_mode)) 1)) (=> (= (U_2_int (MapType0Select ExhaleHeap@4 h History__x_hist_mode)) 1) (and (=> (= (ControlFlow 0 23) 20) anon60_Then_correct) (=> (= (ControlFlow 0 23) 22) anon60_Else_correct)))))))
(let ((anon59_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 27) 23)) anon33_correct)))
(let ((anon59_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 25) (- 0 26)) (<= FullPerm (U_2_real (MapType1Select Mask@36 h History__x_hist_mode)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@36 h History__x_hist_mode))) (=> (= (ControlFlow 0 25) 23) anon33_correct))))))
(let ((anon31_correct  (=> (= Mask@36 (MapType1Store Mask@35 h History__x_hist_value (real_2_U (- (U_2_real (MapType1Select Mask@35 h History__x_hist_value)) FullPerm)))) (and (=> (= (ControlFlow 0 28) 25) anon59_Then_correct) (=> (= (ControlFlow 0 28) 27) anon59_Else_correct)))))
(let ((anon58_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 31) 28)) anon31_correct)))
(let ((anon58_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (<= FullPerm (U_2_real (MapType1Select Mask@35 h History__x_hist_value)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@35 h History__x_hist_value))) (=> (= (ControlFlow 0 29) 28) anon31_correct))))))
(let ((anon29_correct  (=> (= Mask@32 (MapType1Store Mask@31 h History__x_hist_mode (real_2_U (- (U_2_real (MapType1Select Mask@31 h History__x_hist_mode)) FullPerm)))) (and (=> (= (ControlFlow 0 32) (- 0 37)) (= (U_2_int (MapType0Select ExhaleHeap@3 h History__x_hist_mode)) 2)) (=> (= (U_2_int (MapType0Select ExhaleHeap@3 h History__x_hist_mode)) 2) (and (=> (= (ControlFlow 0 32) (- 0 36)) (= (U_2_int (MapType0Select ExhaleHeap@3 h History__x_hist_value)) (+ (U_2_int (MapType0Select ExhaleHeap@3 h History__x_hist_act)) 1))) (=> (= (U_2_int (MapType0Select ExhaleHeap@3 h History__x_hist_value)) (+ (U_2_int (MapType0Select ExhaleHeap@3 h History__x_hist_act)) 1)) (=> (and (and (and (and (IdenticalOnKnownLocations ExhaleHeap@3 ExhaleHeap@4 Mask@32) (not (= q_1 NoPerm))) (and (= Mask@33 (MapType1Store Mask@32 null (History__hist_idle h q_1 (p_seq arg_proc_1@0 p_incr)) (real_2_U (+ (U_2_real (MapType1Select Mask@32 null (History__hist_idle h q_1 (p_seq arg_proc_1@0 p_incr)))) FullPerm)))) (state ExhaleHeap@4 Mask@33))) (and (and (not (= h null)) (= Mask@34 (MapType1Store Mask@33 h History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select Mask@33 h History__x_hist_value)) FullPerm))))) (and (state ExhaleHeap@4 Mask@34) (not (= h null))))) (and (and (and (= Mask@35 (MapType1Store Mask@34 h History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select Mask@34 h History__x_hist_mode)) FullPerm)))) (state ExhaleHeap@4 Mask@35)) (and (= (U_2_int (MapType0Select ExhaleHeap@4 h History__x_hist_mode)) 1) (= (U_2_int (MapType0Select ExhaleHeap@4 h History__x_hist_value)) (U_2_int (MapType0Select ExhaleHeap@3 h History__x_hist_value))))) (and (and (state ExhaleHeap@4 Mask@35) (state ExhaleHeap@4 Mask@35)) (and (= i@1 (+ i@0 1)) (state ExhaleHeap@4 Mask@35))))) (and (=> (= (ControlFlow 0 32) (- 0 35)) (<= 0 i@1)) (=> (<= 0 i@1) (and (=> (= (ControlFlow 0 32) (- 0 34)) (<= i@1 n_1@@3)) (=> (<= i@1 n_1@@3) (and (=> (= (ControlFlow 0 32) (- 0 33)) (not (= q_1 NoPerm))) (=> (not (= q_1 NoPerm)) (and (=> (= (ControlFlow 0 32) 29) anon58_Then_correct) (=> (= (ControlFlow 0 32) 31) anon58_Else_correct))))))))))))))))
(let ((anon57_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 40) 32)) anon29_correct)))
(let ((anon57_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 38) (- 0 39)) (<= FullPerm (U_2_real (MapType1Select Mask@31 h History__x_hist_mode)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@31 h History__x_hist_mode))) (=> (= (ControlFlow 0 38) 32) anon29_correct))))))
(let ((anon27_correct  (=> (= Mask@31 (MapType1Store Mask@30 h History__x_hist_value (real_2_U (- (U_2_real (MapType1Select Mask@30 h History__x_hist_value)) FullPerm)))) (and (=> (= (ControlFlow 0 41) 38) anon57_Then_correct) (=> (= (ControlFlow 0 41) 40) anon57_Else_correct)))))
(let ((anon56_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 44) 41)) anon27_correct)))
(let ((anon56_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 42) (- 0 43)) (<= FullPerm (U_2_real (MapType1Select Mask@30 h History__x_hist_value)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@30 h History__x_hist_value))) (=> (= (ControlFlow 0 42) 41) anon27_correct))))))
(let ((anon25_correct  (=> (= Mask@30 (MapType1Store Mask@29 h History__x_hist_act (real_2_U (- (U_2_real (MapType1Select Mask@29 h History__x_hist_act)) FullPerm)))) (and (=> (= (ControlFlow 0 45) 42) anon56_Then_correct) (=> (= (ControlFlow 0 45) 44) anon56_Else_correct)))))
(let ((anon55_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 48) 45)) anon25_correct)))
(let ((anon55_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 46) (- 0 47)) (<= FullPerm (U_2_real (MapType1Select Mask@29 h History__x_hist_act)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@29 h History__x_hist_act))) (=> (= (ControlFlow 0 46) 45) anon25_correct))))))
(let ((anon23_correct  (=> (= Mask@29 (MapType1Store Mask@28 null (History__hist_do_incr h q_1 arg_proc_1@0) (real_2_U (- (U_2_real (MapType1Select Mask@28 null (History__hist_do_incr h q_1 arg_proc_1@0))) FullPerm)))) (and (=> (= (ControlFlow 0 49) 46) anon55_Then_correct) (=> (= (ControlFlow 0 49) 48) anon55_Else_correct)))))
(let ((anon54_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 52) 49)) anon23_correct)))
(let ((anon54_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 50) (- 0 51)) (<= FullPerm (U_2_real (MapType1Select Mask@28 null (History__hist_do_incr h q_1 arg_proc_1@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@28 null (History__hist_do_incr h q_1 arg_proc_1@0)))) (=> (= (ControlFlow 0 50) 49) anon23_correct))))))
(let ((anon21_correct  (=> (= Mask@26 (MapType1Store Mask@25 h History__x_hist_mode (real_2_U (- (U_2_real (MapType1Select Mask@25 h History__x_hist_mode)) perm@0)))) (and (=> (= (ControlFlow 0 53) (- 0 58)) (= (U_2_int (MapType0Select ExhaleHeap@2 h History__x_hist_mode)) 2)) (=> (= (U_2_int (MapType0Select ExhaleHeap@2 h History__x_hist_mode)) 2) (=> (and (IdenticalOnKnownLocations ExhaleHeap@2 ExhaleHeap@3 Mask@26) (not (= h null))) (=> (and (and (= Mask@27 (MapType1Store Mask@26 h History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select Mask@26 h History__x_hist_value)) FullPerm)))) (state ExhaleHeap@3 Mask@27)) (and (= (U_2_int (MapType0Select ExhaleHeap@3 h History__x_hist_value)) arg_value@0) (= perm@1 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 53) (- 0 57)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (=> (> perm@1 NoPerm) (not (= h null))) (=> (and (= Mask@28 (MapType1Store Mask@27 h History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select Mask@27 h History__x_hist_mode)) perm@1)))) (state ExhaleHeap@3 Mask@28)) (=> (and (and (= (U_2_int (MapType0Select ExhaleHeap@3 h History__x_hist_mode)) 2) (state ExhaleHeap@3 Mask@28)) (and (state ExhaleHeap@3 Mask@28) (= arg_proc_1@0 (p_seq p_1@@2 (p_single i@0))))) (and (=> (= (ControlFlow 0 53) (- 0 56)) (not (= h null))) (=> (not (= h null)) (and (=> (= (ControlFlow 0 53) (- 0 55)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (and (=> (= (ControlFlow 0 53) (- 0 54)) (not (= q_1 NoPerm))) (=> (not (= q_1 NoPerm)) (and (=> (= (ControlFlow 0 53) 50) anon54_Then_correct) (=> (= (ControlFlow 0 53) 52) anon54_Else_correct))))))))))))))))))))
(let ((anon53_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 61) 53)) anon21_correct)))
(let ((anon53_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 59) (- 0 60)) (<= perm@0 (U_2_real (MapType1Select Mask@25 h History__x_hist_mode)))) (=> (<= perm@0 (U_2_real (MapType1Select Mask@25 h History__x_hist_mode))) (=> (= (ControlFlow 0 59) 53) anon21_correct))))))
(let ((anon19_correct  (=> (and (= Mask@25 (MapType1Store Mask@24 h History__x_hist_value (real_2_U (- (U_2_real (MapType1Select Mask@24 h History__x_hist_value)) FullPerm)))) (= perm@0 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 62) (- 0 63)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 62) 59) anon53_Then_correct) (=> (= (ControlFlow 0 62) 61) anon53_Else_correct)))))))
(let ((anon52_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 66) 62)) anon19_correct)))
(let ((anon52_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 64) (- 0 65)) (<= FullPerm (U_2_real (MapType1Select Mask@24 h History__x_hist_value)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@24 h History__x_hist_value))) (=> (= (ControlFlow 0 64) 62) anon19_correct))))))
(let ((anon17_correct  (=> (= Mask@20 (MapType1Store Mask@19 h History__x_hist_mode (real_2_U (- (U_2_real (MapType1Select Mask@19 h History__x_hist_mode)) FullPerm)))) (and (=> (= (ControlFlow 0 67) (- 0 71)) (= (U_2_int (MapType0Select ExhaleHeap@0 h History__x_hist_mode)) 1)) (=> (= (U_2_int (MapType0Select ExhaleHeap@0 h History__x_hist_mode)) 1) (=> (and (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@2 Mask@20) (not (= q_1 NoPerm))) (=> (and (and (and (and (= Mask@21 (MapType1Store Mask@20 null (History__hist_do_incr h q_1 arg_proc@0) (real_2_U (+ (U_2_real (MapType1Select Mask@20 null (History__hist_do_incr h q_1 arg_proc@0))) FullPerm)))) (state ExhaleHeap@2 Mask@21)) (and (not (= h null)) (= Mask@22 (MapType1Store Mask@21 h History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select Mask@21 h History__x_hist_value)) FullPerm)))))) (and (and (state ExhaleHeap@2 Mask@22) (not (= h null))) (and (= Mask@23 (MapType1Store Mask@22 h History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select Mask@22 h History__x_hist_mode)) FullPerm)))) (state ExhaleHeap@2 Mask@23)))) (and (and (and (= (U_2_int (MapType0Select ExhaleHeap@2 h History__x_hist_mode)) 2) (= (U_2_int (MapType0Select ExhaleHeap@2 h History__x_hist_value)) (U_2_int (MapType0Select ExhaleHeap@0 h History__x_hist_value)))) (and (not (= h null)) (= Mask@24 (MapType1Store Mask@23 h History__x_hist_act (real_2_U (+ (U_2_real (MapType1Select Mask@23 h History__x_hist_act)) FullPerm)))))) (and (and (state ExhaleHeap@2 Mask@24) (= (U_2_int (MapType0Select ExhaleHeap@2 h History__x_hist_value)) (U_2_int (MapType0Select ExhaleHeap@2 h History__x_hist_act)))) (and (state ExhaleHeap@2 Mask@24) (state ExhaleHeap@2 Mask@24))))) (and (=> (= (ControlFlow 0 67) (- 0 70)) (HasDirectPerm Mask@24 h History__x_hist_value)) (=> (HasDirectPerm Mask@24 h History__x_hist_value) (=> (= arg_value@0 (+ (U_2_int (MapType0Select ExhaleHeap@2 h History__x_hist_value)) 1)) (and (=> (= (ControlFlow 0 67) (- 0 69)) (not (= h null))) (=> (not (= h null)) (and (=> (= (ControlFlow 0 67) (- 0 68)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (and (=> (= (ControlFlow 0 67) 64) anon52_Then_correct) (=> (= (ControlFlow 0 67) 66) anon52_Else_correct))))))))))))))))
(let ((anon51_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 74) 67)) anon17_correct)))
(let ((anon51_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 72) (- 0 73)) (<= FullPerm (U_2_real (MapType1Select Mask@19 h History__x_hist_mode)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@19 h History__x_hist_mode))) (=> (= (ControlFlow 0 72) 67) anon17_correct))))))
(let ((anon15_correct  (=> (= Mask@19 (MapType1Store Mask@18 h History__x_hist_value (real_2_U (- (U_2_real (MapType1Select Mask@18 h History__x_hist_value)) FullPerm)))) (and (=> (= (ControlFlow 0 75) 72) anon51_Then_correct) (=> (= (ControlFlow 0 75) 74) anon51_Else_correct)))))
(let ((anon50_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 78) 75)) anon15_correct)))
(let ((anon50_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 76) (- 0 77)) (<= FullPerm (U_2_real (MapType1Select Mask@18 h History__x_hist_value)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@18 h History__x_hist_value))) (=> (= (ControlFlow 0 76) 75) anon15_correct))))))
(let ((anon13_correct  (=> (= Mask@18 (MapType1Store Mask@11 null (History__hist_idle h q_1 arg_proc@0) (real_2_U (- (U_2_real (MapType1Select Mask@11 null (History__hist_idle h q_1 arg_proc@0))) FullPerm)))) (and (=> (= (ControlFlow 0 79) 76) anon50_Then_correct) (=> (= (ControlFlow 0 79) 78) anon50_Else_correct)))))
(let ((anon49_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 82) 79)) anon13_correct)))
(let ((anon49_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 80) (- 0 81)) (<= FullPerm (U_2_real (MapType1Select Mask@11 null (History__hist_idle h q_1 arg_proc@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@11 null (History__hist_idle h q_1 arg_proc@0)))) (=> (= (ControlFlow 0 80) 79) anon13_correct))))))
(let ((anon48_Then_correct  (=> (state ExhaleHeap@0 ZeroMask) (=> (and (and (and (and (<= 0 i@0) (<= i@0 n_1@@3)) (and (not (= q_1 NoPerm)) (not (= h null)))) (and (and (= Mask@9 (MapType1Store ZeroMask h History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask h History__x_hist_value)) FullPerm)))) (state ExhaleHeap@0 Mask@9)) (and (not (= h null)) (= Mask@10 (MapType1Store Mask@9 h History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select Mask@9 h History__x_hist_mode)) FullPerm))))))) (and (and (and (state ExhaleHeap@0 Mask@10) (= (U_2_int (MapType0Select ExhaleHeap@0 h History__x_hist_mode)) 1)) (and (= Mask@11 (MapType1Store Mask@10 null (History__hist_idle h q_1 (p_seq p_1@@2 (p_single i@0))) (real_2_U (+ (U_2_real (MapType1Select Mask@10 null (History__hist_idle h q_1 (p_seq p_1@@2 (p_single i@0))))) FullPerm)))) (state ExhaleHeap@0 Mask@11))) (and (and (state ExhaleHeap@0 Mask@11) (< i@0 n_1@@3)) (and (state ExhaleHeap@0 Mask@11) (= arg_proc@0 (p_seq p_1@@2 (p_single i@0))))))) (and (=> (= (ControlFlow 0 83) (- 0 86)) (not (= h null))) (=> (not (= h null)) (and (=> (= (ControlFlow 0 83) (- 0 85)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (and (=> (= (ControlFlow 0 83) (- 0 84)) (not (= q_1 NoPerm))) (=> (not (= q_1 NoPerm)) (and (=> (= (ControlFlow 0 83) 80) anon49_Then_correct) (=> (= (ControlFlow 0 83) 82) anon49_Else_correct))))))))))))
(let ((anon42_correct true))
(let ((anon63_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon42_correct)))
(let ((anon63_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@16 null (History__hist_idle h q_1 (p_seq p_1@@2 (p_single n_1@@3))))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@16 null (History__hist_idle h q_1 (p_seq p_1@@2 (p_single n_1@@3)))))) (=> (= (ControlFlow 0 6) 5) anon42_correct))))))
(let ((anon40_correct  (=> (= Mask@16 (MapType1Store Mask@15 h History__x_hist_mode (real_2_U (- (U_2_real (MapType1Select Mask@15 h History__x_hist_mode)) FullPerm)))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (= (U_2_int (MapType0Select ExhaleHeap@0 h History__x_hist_mode)) 1)) (=> (= (U_2_int (MapType0Select ExhaleHeap@0 h History__x_hist_mode)) 1) (and (=> (= (ControlFlow 0 9) 6) anon63_Then_correct) (=> (= (ControlFlow 0 9) 8) anon63_Else_correct)))))))
(let ((anon62_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 9)) anon40_correct)))
(let ((anon62_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType1Select Mask@15 h History__x_hist_mode)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@15 h History__x_hist_mode))) (=> (= (ControlFlow 0 11) 9) anon40_correct))))))
(let ((anon38_correct  (=> (= Mask@15 (MapType1Store Mask@14 h History__x_hist_value (real_2_U (- (U_2_real (MapType1Select Mask@14 h History__x_hist_value)) FullPerm)))) (and (=> (= (ControlFlow 0 14) 11) anon62_Then_correct) (=> (= (ControlFlow 0 14) 13) anon62_Else_correct)))))
(let ((anon61_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 17) 14)) anon38_correct)))
(let ((anon61_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= FullPerm (U_2_real (MapType1Select Mask@14 h History__x_hist_value)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@14 h History__x_hist_value))) (=> (= (ControlFlow 0 15) 14) anon38_correct))))))
(let ((anon48_Else_correct  (=> (and (and (and (and (not (< i@0 n_1@@3)) (state ExhaleHeap@0 Mask@5)) (and (<= 0 i@0) (<= i@0 n_1@@3))) (and (and (not (= q_1 NoPerm)) (not (= h null))) (and (= Mask@12 (MapType1Store Mask@5 h History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select Mask@5 h History__x_hist_value)) FullPerm)))) (state ExhaleHeap@0 Mask@12)))) (and (and (and (not (= h null)) (= Mask@13 (MapType1Store Mask@12 h History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select Mask@12 h History__x_hist_mode)) FullPerm))))) (and (state ExhaleHeap@0 Mask@13) (= (U_2_int (MapType0Select ExhaleHeap@0 h History__x_hist_mode)) 1))) (and (and (= Mask@14 (MapType1Store Mask@13 null (History__hist_idle h q_1 (p_seq p_1@@2 (p_single i@0))) (real_2_U (+ (U_2_real (MapType1Select Mask@13 null (History__hist_idle h q_1 (p_seq p_1@@2 (p_single i@0))))) FullPerm)))) (state ExhaleHeap@0 Mask@14)) (and (state ExhaleHeap@0 Mask@14) (state ExhaleHeap@0 Mask@14))))) (and (=> (= (ControlFlow 0 18) 15) anon61_Then_correct) (=> (= (ControlFlow 0 18) 17) anon61_Else_correct)))))
(let ((anon47_Then_correct  (=> (and (<= 0 i@0) (state ExhaleHeap@0 Mask@5)) (=> (and (and (<= i@0 n_1@@3) (state ExhaleHeap@0 Mask@5)) (and (not (= q_1 NoPerm)) (state ExhaleHeap@0 Mask@5))) (=> (and (and (and (not (= h null)) (= Mask@6 (MapType1Store Mask@5 h History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select Mask@5 h History__x_hist_value)) FullPerm))))) (and (state ExhaleHeap@0 Mask@6) (state ExhaleHeap@0 Mask@6))) (and (and (not (= h null)) (= Mask@7 (MapType1Store Mask@6 h History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select Mask@6 h History__x_hist_mode)) FullPerm))))) (and (state ExhaleHeap@0 Mask@7) (= (ControlFlow 0 4) (- 0 3))))) (HasDirectPerm Mask@7 h History__x_hist_mode))))))
(let ((anon8_correct  (=> (and (= Mask@5 (MapType1Store Mask@4 null (History__hist_idle h q_1 (p_seq p_1@@2 (p_single 0))) (real_2_U (- (U_2_real (MapType1Select Mask@4 null (History__hist_idle h q_1 (p_seq p_1@@2 (p_single 0))))) FullPerm)))) (IdenticalOnKnownLocations Heap@@19 ExhaleHeap@0 Mask@5)) (and (and (=> (= (ControlFlow 0 87) 4) anon47_Then_correct) (=> (= (ControlFlow 0 87) 83) anon48_Then_correct)) (=> (= (ControlFlow 0 87) 18) anon48_Else_correct)))))
(let ((anon46_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 90) 87)) anon8_correct)))
(let ((anon46_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 88) (- 0 89)) (<= FullPerm (U_2_real (MapType1Select Mask@4 null (History__hist_idle h q_1 (p_seq p_1@@2 (p_single 0))))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 null (History__hist_idle h q_1 (p_seq p_1@@2 (p_single 0)))))) (=> (= (ControlFlow 0 88) 87) anon8_correct))))))
(let ((anon6_correct  (=> (= Mask@4 (MapType1Store Mask@3 h History__x_hist_mode (real_2_U (- (U_2_real (MapType1Select Mask@3 h History__x_hist_mode)) FullPerm)))) (and (=> (= (ControlFlow 0 91) (- 0 92)) (= (U_2_int (MapType0Select Heap@@19 h History__x_hist_mode)) 1)) (=> (= (U_2_int (MapType0Select Heap@@19 h History__x_hist_mode)) 1) (and (=> (= (ControlFlow 0 91) 88) anon46_Then_correct) (=> (= (ControlFlow 0 91) 90) anon46_Else_correct)))))))
(let ((anon45_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 95) 91)) anon6_correct)))
(let ((anon45_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 93) (- 0 94)) (<= FullPerm (U_2_real (MapType1Select Mask@3 h History__x_hist_mode)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 h History__x_hist_mode))) (=> (= (ControlFlow 0 93) 91) anon6_correct))))))
(let ((anon4_correct  (=> (= Mask@3 (MapType1Store Mask@2 h History__x_hist_value (real_2_U (- (U_2_real (MapType1Select Mask@2 h History__x_hist_value)) FullPerm)))) (and (=> (= (ControlFlow 0 96) 93) anon45_Then_correct) (=> (= (ControlFlow 0 96) 95) anon45_Else_correct)))))
(let ((anon44_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 99) 96)) anon4_correct)))
(let ((anon44_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 97) (- 0 98)) (<= FullPerm (U_2_real (MapType1Select Mask@2 h History__x_hist_value)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 h History__x_hist_value))) (=> (= (ControlFlow 0 97) 96) anon4_correct))))))
(let ((anon43_Else_correct  (=> (state Heap@@19 Mask@2) (and (=> (= (ControlFlow 0 100) (- 0 103)) (<= 0 0)) (=> (<= 0 0) (and (=> (= (ControlFlow 0 100) (- 0 102)) (<= 0 n_1@@3)) (=> (<= 0 n_1@@3) (and (=> (= (ControlFlow 0 100) (- 0 101)) (not (= q_1 NoPerm))) (=> (not (= q_1 NoPerm)) (and (=> (= (ControlFlow 0 100) 97) anon44_Then_correct) (=> (= (ControlFlow 0 100) 99) anon44_Else_correct)))))))))))
(let ((anon43_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (and (not (= h null)) (= PostMask@0 (MapType1Store ZeroMask h History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask h History__x_hist_value)) FullPerm))))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (and (not (= h null)) (= PostMask@1 (MapType1Store PostMask@0 h History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select PostMask@0 h History__x_hist_mode)) FullPerm))))) (and (state PostHeap@0 PostMask@1) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm PostMask@1 h History__x_hist_mode)))))
(let ((anon0_correct  (=> (and (state Heap@@19 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@19 diz@@19 $allocated)) (U_2_bool (MapType0Select Heap@@19 h $allocated))) (and (not (= diz@@19 null)) (state Heap@@19 ZeroMask))) (=> (and (and (and (and (>= current_thread_id 0) (state Heap@@19 ZeroMask)) (and (>= n_1@@3 0) (state Heap@@19 ZeroMask))) (and (and (not (= q_1 NoPerm)) (state Heap@@19 ZeroMask)) (and (= Mask@0 (MapType1Store ZeroMask null (History__hist_idle h q_1 p_1@@2) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (History__hist_idle h q_1 p_1@@2))) FullPerm)))) (state Heap@@19 Mask@0)))) (and (and (and (state Heap@@19 Mask@0) (not (= h null))) (and (= Mask@1 (MapType1Store Mask@0 h History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select Mask@0 h History__x_hist_value)) FullPerm)))) (state Heap@@19 Mask@1))) (and (and (state Heap@@19 Mask@1) (not (= h null))) (and (= Mask@2 (MapType1Store Mask@1 h History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select Mask@1 h History__x_hist_mode)) FullPerm)))) (state Heap@@19 Mask@2))))) (and (=> (= (ControlFlow 0 104) (- 0 105)) (HasDirectPerm Mask@2 h History__x_hist_mode)) (=> (HasDirectPerm Mask@2 h History__x_hist_mode) (=> (and (= (U_2_int (MapType0Select Heap@@19 h History__x_hist_mode)) 1) (state Heap@@19 Mask@2)) (and (=> (= (ControlFlow 0 104) 2) anon43_Then_correct) (=> (= (ControlFlow 0 104) 100) anon43_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 106) 104) anon0_correct)))
