...
(declare-fun f2b (T@U) Int)
(declare-fun f1 (T@U) T@U)
(declare-fun f1b (T@U) Int)
(declare-fun D1DomainTypeTypeInv0 (T@T) T@T)
(declare-fun D1DomainTypeType (T@T) T@T)
(declare-fun D2DomainTypeType (T@T) T@T)
(declare-fun D2DomainTypeTypeInv0 (T@T) T@T)
...
(assert  (and (and (and (and (forall ((arg0@@25 T@T) ) (! (= (Ctor (D1DomainTypeType arg0@@25)) 11)
 :qid |ctor:D1DomainTypeType|
)) (forall ((arg0@@26 T@T) ) (! (= (D1DomainTypeTypeInv0 (D1DomainTypeType arg0@@26)) arg0@@26)
 :qid |typeInv:D1DomainTypeTypeInv0|
 :pattern ( (D1DomainTypeType arg0@@26))
))) (forall ((arg0@@27 T@T) ) (! (= (Ctor (D2DomainTypeType arg0@@27)) 12)
 :qid |ctor:D2DomainTypeType|
))) (forall ((arg0@@28 T@T) ) (! (= (D2DomainTypeTypeInv0 (D2DomainTypeType arg0@@28)) arg0@@28)
 :qid |typeInv:D2DomainTypeTypeInv0|
 :pattern ( (D2DomainTypeType arg0@@28))
))) (forall ((arg0@@29 T@U) ) (! (let ((T (D1DomainTypeTypeInv0 (type arg0@@29))))
(= (type (f1 arg0@@29)) (D2DomainTypeType T)))
 :qid |funType:f1|
 :pattern ( (f1 arg0@@29))
))))
(assert (forall ((x_1 T@U) ) (! (let ((T@@0 (D1DomainTypeTypeInv0 (type x_1))))
 (=> (and (= (type x_1) (D1DomainTypeType T@@0)) (> (f2b (f1 x_1)) 0)) (= (f1b x_1) 0)))
 :qid |stdinbpl.208:19|
 :skolemid |23|
 :pattern ( (f2b (f1 x_1)))
 :pattern ( (f1b x_1))
...
(assert  (and (forall ((arg0@@30 Real) (arg1@@9 T@U) ) (! (= (type (ConditionalFrame arg0@@30 arg1@@9)) FrameTypeType)
...
(assert (forall ((x_1@@0 T@U) ) (! (let ((T@@1 (D1DomainTypeTypeInv0 (type x_1@@0))))
 (=> (and (= (type x_1@@0) (D1DomainTypeType T@@1)) (>= (f1b x_1@@0) 0)) (> (f2b (f1 x_1@@0)) 0)))
 :qid |stdinbpl.202:19|
 :skolemid |22|
 :pattern ( (f1b x_1@@0))
 :pattern ( (f2b (f1 x_1@@0)))
)))
...
(assert  (and (= (type d1x) (D1DomainTypeType intType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id m1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (and (> 0 (f1b d1x)) (= (ControlFlow 0 4) 1)) anon2_correct)))
(let ((anon3_Then_correct  (=> (>= (f1b d1x) 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (f1b d1x) 0)) (=> (= (f1b d1x) 0) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))
