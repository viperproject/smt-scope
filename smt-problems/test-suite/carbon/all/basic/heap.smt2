...
(assert  (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type r_1) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id t3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 r_1 $allocated))) (and (not (= r_1 null)) (state Heap@@9 ZeroMask))) (and (and (not (= r_1 null)) (= Mask@0 (MapType1Store ZeroMask r_1 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1 f_7)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm Mask@0 r_1 f_7)) (=> (HasDirectPerm Mask@0 r_1 f_7) (=> (and (not (= (MapType0Select Heap@@9 r_1 f_7) null)) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@0 r_1 f_7)) (=> (HasDirectPerm Mask@0 r_1 f_7) (=> (and (and (not (= (MapType0Select Heap@@9 r_1 f_7) null)) (= Mask@1 (MapType1Store Mask@0 (MapType0Select Heap@@9 r_1 f_7) f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 (MapType0Select Heap@@9 r_1 f_7) f_7)) FullPerm))))) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 r_1 f_7)) (=> (HasDirectPerm Mask@1 r_1 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@1 (MapType0Select Heap@@9 r_1 f_7) f_7)))))))))))))
