...
(declare-fun y@@6 () T@U)
(declare-fun z@@0 () T@U)
(assert  (and (and (and (and (and (= (type x@@19) (MapType0Type RefType boolType)) (= (type Heap@@10) (MapType1Type RefType))) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@47 T@U) ) (! (= (type (invRecv5 arg0@@47)) RefType)
 :qid |funType:invRecv5|
 :pattern ( (invRecv5 arg0@@47))
))) (= (type y@@6) RefType)) (= (type z@@0) RefType)))
(set-info :boogie-vc-id doo)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 7)) (forall ((w_1 T@U) (w_1_1 T@U) ) (!  (=> (and (= (type w_1) RefType) (= (type w_1_1) RefType)) (=> (and (and (and (and (not (= w_1 w_1_1)) (U_2_bool (MapType0Select x@@19 w_1))) (U_2_bool (MapType0Select x@@19 w_1_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= w_1 w_1_1))))
 :qid |stdinbpl.797:15|
 :skolemid |118|
 :no-pattern (type w_1)
 :no-pattern (type w_1_1)
 :no-pattern (U_2_int w_1)
 :no-pattern (U_2_bool w_1)
 :no-pattern (U_2_int w_1_1)
 :no-pattern (U_2_bool w_1_1)
))) (=> (forall ((w_1@@0 T@U) (w_1_1@@0 T@U) ) (!  (=> (and (= (type w_1@@0) RefType) (= (type w_1_1@@0) RefType)) (=> (and (and (and (and (not (= w_1@@0 w_1_1@@0)) (U_2_bool (MapType0Select x@@19 w_1@@0))) (U_2_bool (MapType0Select x@@19 w_1_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= w_1@@0 w_1_1@@0))))
 :qid |stdinbpl.797:15|
 :skolemid |118|
 :no-pattern (type w_1@@0)
 :no-pattern (type w_1_1@@0)
 :no-pattern (U_2_int w_1@@0)
 :no-pattern (U_2_bool w_1@@0)
 :no-pattern (U_2_int w_1_1@@0)
 :no-pattern (U_2_bool w_1_1@@0)
)) (=> (and (forall ((w_1@@1 T@U) ) (!  (=> (= (type w_1@@1) RefType) (=> (and (U_2_bool (MapType0Select x@@19 w_1@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange5 w_1@@1) (= (invRecv5 w_1@@1) w_1@@1))))
 :qid |stdinbpl.803:22|
 :skolemid |119|
 :pattern ( (MapType1Select Heap@@10 w_1@@1 left))
 :pattern ( (MapType2Select QPMask@0 w_1@@1 left))
 :pattern ( (MapType0Select x@@19 w_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType0Select x@@19 (invRecv5 o_3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange5 o_3)) (= (invRecv5 o_3) o_3)))
 :qid |stdinbpl.807:22|
 :skolemid |120|
 :pattern ( (invRecv5 o_3))
))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((w_1@@2 T@U) ) (!  (=> (and (= (type w_1@@2) RefType) (U_2_bool (MapType0Select x@@19 w_1@@2))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.813:15|
 :skolemid |121|
 :pattern ( (MapType1Select Heap@@10 w_1@@2 left))
 :pattern ( (MapType2Select QPMask@0 w_1@@2 left))
 :pattern ( (MapType0Select x@@19 w_1@@2))
))) (=> (forall ((w_1@@3 T@U) ) (!  (=> (and (= (type w_1@@3) RefType) (U_2_bool (MapType0Select x@@19 w_1@@3))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.813:15|
 :skolemid |121|
 :pattern ( (MapType1Select Heap@@10 w_1@@3 left))
 :pattern ( (MapType2Select QPMask@0 w_1@@3 left))
 :pattern ( (MapType0Select x@@19 w_1@@3))
)) (=> (and (forall ((w_1@@4 T@U) ) (!  (=> (= (type w_1@@4) RefType) (=> (and (U_2_bool (MapType0Select x@@19 w_1@@4)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= w_1@@4 null))))
 :qid |stdinbpl.819:22|
 :skolemid |122|
 :pattern ( (MapType1Select Heap@@10 w_1@@4 left))
 :pattern ( (MapType2Select QPMask@0 w_1@@4 left))
 :pattern ( (MapType0Select x@@19 w_1@@4))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType0Select x@@19 (invRecv5 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange5 o_3@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv5 o_3@@0) o_3@@0)) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 left)) (+ (U_2_real (MapType2Select ZeroMask o_3@@0 left)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (U_2_bool (MapType0Select x@@19 (invRecv5 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange5 o_3@@0))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 left)) (U_2_real (MapType2Select ZeroMask o_3@@0 left))))))
 :qid |stdinbpl.825:22|
 :skolemid |123|
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 left))) (= (U_2_real (MapType2Select ZeroMask o_3@@1 f_5)) (U_2_real (MapType2Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.829:29|
 :skolemid |124|
 :pattern ( (MapType2Select ZeroMask o_3@@1 f_5))
 :pattern ( (MapType2Select QPMask@0 o_3@@1 f_5))
)) (state Heap@@10 QPMask@0)) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm QPMask@0 y@@6 left)) (=> (HasDirectPerm QPMask@0 y@@6 left) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 z@@0 left)) (=> (HasDirectPerm QPMask@0 z@@0 left) (=> (= (ControlFlow 0 3) (- 0 2)) (= (MapType1Select Heap@@10 y@@6 left) (MapType1Select Heap@@10 z@@0 left))))))))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType1Select Heap@@10 y@@6 $allocated))) (and (U_2_bool (MapType1Select Heap@@10 z@@0 $allocated)) (|Set#Equal| x@@19 (|Set#UnionOne| (|Set#Singleton| z@@0) y@@6)))) (and (and (not (= y@@6 null)) (not (= z@@0 null))) (and (state Heap@@10 ZeroMask) (state Heap@@10 ZeroMask)))) (and (=> (= (ControlFlow 0 8) 1) anon3_Then_correct) (=> (= (ControlFlow 0 8) 3) anon3_Else_correct)))))
