...
(let ((anon10_Else_correct  (=> (not (= x@@28 0)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (decreasing (int_2_U (- x@@28 1)) (int_2_U x@@28))) (=> (decreasing (int_2_U (- x@@28 1)) (int_2_U x@@28)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (bounded (int_2_U x@@28))) (=> (bounded (int_2_U x@@28)) (=> (and (state Heap@@29 ZeroMask) (= (ControlFlow 0 5) 3)) anon7_correct))))))))
(let ((anon10_Then_correct  (=> (and (= x@@28 0) (= (ControlFlow 0 4) 3)) anon7_correct)))
(let ((anon9_Else_correct  (=> (and (= (f1 Heap@@29 x@@28) 0) (state Heap@@29 ZeroMask)) (and (=> (= (ControlFlow 0 8) 4) anon10_Then_correct) (=> (= (ControlFlow 0 8) 5) anon10_Else_correct)))))
(let ((anon9_Then_correct true))
(let ((anon8_Else_correct  (=> (= (f_6 Heap@@29 x@@28) 0) (=> (and (state Heap@@29 ZeroMask) (state Heap@@29 ZeroMask)) (and (=> (= (ControlFlow 0 9) 2) anon9_Then_correct) (=> (= (ControlFlow 0 9) 8) anon9_Else_correct))))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@29 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (state Heap@@29 ZeroMask)) (and (=> (= (ControlFlow 0 10) 1) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct))))))
