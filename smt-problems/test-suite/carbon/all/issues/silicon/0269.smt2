...
(assert  (and (and (and (= (type AssertMask@0) (MapType1Type RefType realType)) (= (type x@@8) RefType)) (= (type Heap@@17) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
...
(let ((anon4_correct  (=> (and (= AssertMask@0 (MapType1Store ZeroMask x@@8 f_8 (real_2_U (- (U_2_real (MapType1Select ZeroMask x@@8 f_8)) FullPerm)))) (state Heap@@17 ZeroMask)) (and (=> (= (ControlFlow 0 4) 2) anon12_Then_correct) (=> (= (ControlFlow 0 4) 3) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 4)) anon4_correct)))
(let ((anon11_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select ZeroMask x@@8 f_8)))) (=> (<= FullPerm (U_2_real (MapType1Select ZeroMask x@@8 f_8))) (=> (= (ControlFlow 0 5) 4) anon4_correct))))))
(let ((anon10_Else_correct  (=> (state Heap@@17 ZeroMask) (=> (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (not false)) (=> (not false) (=> (state Heap@@17 ZeroMask) (and (=> (= (ControlFlow 0 8) 5) anon11_Then_correct) (=> (= (ControlFlow 0 8) 7) anon11_Else_correct)))))))))
(let ((anon10_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@17 x@@8 $allocated)) (not (= x@@8 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_8)) FullPerm)))) (state Heap@@17 Mask@0)) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0))) (and (=> (= (ControlFlow 0 10) 1) anon10_Then_correct) (=> (= (ControlFlow 0 10) 8) anon10_Else_correct)))))))
