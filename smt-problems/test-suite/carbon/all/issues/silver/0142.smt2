...
(set-info :boogie-vc-id helper)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (+ (- 0 a_2) b_2) (+ (- 0 a_2) b_2))) (=> (= (+ (- 0 a_2) b_2) (+ (- 0 a_2) b_2)) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (+ (- 0 a_2) b_2) (- 0 (+ a_2 b_2)))))))))
