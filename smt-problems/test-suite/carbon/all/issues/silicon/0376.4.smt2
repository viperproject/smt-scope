...
(declare-fun x@@13 () T@U)
(declare-fun Mask@0 () T@U)
(declare-fun Mask@1 () T@U)
(declare-fun Result@0 () Int)
(assert  (and (and (and (= (type Heap@@20) (MapType0Type RefType)) (= (type x@@13) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |foo#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@20 ZeroMask) (U_2_bool (MapType0Select Heap@@20 x@@13 $allocated))) (=> (and (and (and (= AssumeFunctionsAbove 1) (not (= x@@13 null))) (and (= Mask@0 (MapType1Store ZeroMask x@@13 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@13 f_7)) FullPerm)))) (state Heap@@20 Mask@0))) (and (and (not (= x@@13 null)) (= Mask@1 (MapType1Store Mask@0 x@@13 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@13 f_7)) FullPerm))))) (and (state Heap@@20 Mask@1) (state Heap@@20 Mask@1)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 x@@13 f_7)) (=> (HasDirectPerm Mask@1 x@@13 f_7) (=> (and (= Result@0 (U_2_int (MapType0Select Heap@@20 x@@13 f_7))) (= (ControlFlow 0 2) (- 0 1))) false)))))))
