...
(assert  (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type x@@8) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test00_same_tight_three_right_leaning)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (and (and (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated)) (not (= x@@8 null))) (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm)))) (state Heap@@9 Mask@0))) (and (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (<= (/ (to_real 3) (to_real 6)) (U_2_real (MapType1Select Mask@0 x@@8 f_7))) (state Heap@@9 Mask@0)))) (and (and (and (state Heap@@9 Mask@0) (<= (__iar__assume_helper_1 (= x@@8 x@@8) (/ (to_real 3) (to_real 6)) (/ (to_real 2) (to_real 6))) (U_2_real (MapType1Select Mask@0 x@@8 f_7)))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (and (<= (__iar__assume_helper_2 (= x@@8 x@@8) (= x@@8 x@@8) (/ (to_real 3) (to_real 6)) (/ (to_real 2) (to_real 6)) (/ (to_real 1) (to_real 6))) (U_2_real (MapType1Select Mask@0 x@@8 f_7))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (= (ControlFlow 0 2) (- 0 1)))))) false))))
