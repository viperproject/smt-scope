...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon4_Else_correct  (=> (|lenBad2#trigger| EmptyFrame l@@44) (=> (and (= Result@0 (+ 1 (lenBad2 Heap@@58 l@@44))) (= (ControlFlow 0 3) (- 0 2))) (>= Result@0 0)))))
(let ((anon4_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@58 ZeroMask) (= AssumeFunctionsAbove 5)) (and (=> (= (ControlFlow 0 4) 1) anon4_Then_correct) (=> (= (ControlFlow 0 4) 3) anon4_Else_correct)))))
