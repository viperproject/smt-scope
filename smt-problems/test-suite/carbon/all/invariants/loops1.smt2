...
(assert  (and (and (and (and (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type x@@8) RefType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type LoopSumMask@0) (MapType1Type RefType realType))) (= (type LoopSumHeap@0) (MapType0Type RefType))) (= (type Heap@@17) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test03)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 34) (let ((anon20_correct  (=> (and (= Mask@6 (MapType1Store LoopSumMask@0 x@@8 f_8 (real_2_U (- (U_2_real (MapType1Select LoopSumMask@0 x@@8 f_8)) FullPerm)))) (= (ControlFlow 0 17) (- 0 16))) (= (U_2_int (MapType0Select LoopSumHeap@0 x@@8 f_8)) (U_2_int (MapType0Select Heap@@17 x@@8 f_8))))))
(let ((anon28_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 20) 17)) anon20_correct)))
(let ((anon28_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (<= FullPerm (U_2_real (MapType1Select LoopSumMask@0 x@@8 f_8)))) (=> (<= FullPerm (U_2_real (MapType1Select LoopSumMask@0 x@@8 f_8))) (=> (= (ControlFlow 0 18) 17) anon20_correct))))))
...
(let ((anon26_Then_correct  (=> (not (= perm@4 NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= perm@4 (U_2_real (MapType1Select Mask@3 x@@8 f_8)))) (=> (<= perm@4 (U_2_real (MapType1Select Mask@3 x@@8 f_8))) (=> (= (ControlFlow 0 10) 9) anon14_correct))))))
...
(let ((anon23_Else_correct  (=> (and (state ExhaleHeap@0 ZeroMask) (= perm@2 (/ (to_real 1) (to_real 3)))) (and (=> (= (ControlFlow 0 23) (- 0 25)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (=> (> perm@2 NoPerm) (not (= x@@8 null))) (=> (and (and (= Mask@3 (MapType1Store ZeroMask x@@8 f_8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_8)) perm@2)))) (state ExhaleHeap@0 Mask@3)) (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (= (U_2_real (MapType1Select Mask@3 x@@8 f_8)) (/ (to_real 1) (to_real 3)))) (=> (= (U_2_real (MapType1Select Mask@3 x@@8 f_8)) (/ (to_real 1) (to_real 3))) (=> (state ExhaleHeap@0 Mask@3) (=> (and (= n2@1 (+ n2@0 1)) (state ExhaleHeap@0 Mask@3)) (and (=> (= (ControlFlow 0 23) 21) anon24_Then_correct) (=> (= (ControlFlow 0 23) 15) anon24_Else_correct)))))))))))))
(let ((anon23_Then_correct  (=> (and (= perm@1 (/ (to_real 1) (to_real 3))) (= (ControlFlow 0 5) (- 0 4))) (>= perm@1 NoPerm))))
(let ((anon4_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 x@@8 f_8 (real_2_U (- (U_2_real (MapType1Select Mask@0 x@@8 f_8)) perm@0)))) (IdenticalOnKnownLocations Heap@@17 ExhaleHeap@0 Mask@1)) (and (=> (= (ControlFlow 0 26) 5) anon23_Then_correct) (=> (= (ControlFlow 0 26) 23) anon23_Else_correct)))))
(let ((anon22_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 29) 26)) anon4_correct)))
(let ((anon22_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (<= perm@0 (U_2_real (MapType1Select Mask@0 x@@8 f_8)))) (=> (<= perm@0 (U_2_real (MapType1Select Mask@0 x@@8 f_8))) (=> (= (ControlFlow 0 27) 26) anon4_correct))))))
(let ((anon21_Else_correct  (=> (and (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)) (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0))) (and (=> (= (ControlFlow 0 30) (- 0 32)) (= (U_2_real (MapType1Select Mask@0 x@@8 f_8)) (/ (to_real 1) (to_real 2)))) (=> (= (U_2_real (MapType1Select Mask@0 x@@8 f_8)) (/ (to_real 1) (to_real 2))) (=> (and (state Heap@@17 Mask@0) (= perm@0 (/ (to_real 1) (to_real 3)))) (and (=> (= (ControlFlow 0 30) (- 0 31)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 30) 27) anon22_Then_correct) (=> (= (ControlFlow 0 30) 29) anon22_Else_correct))))))))))
