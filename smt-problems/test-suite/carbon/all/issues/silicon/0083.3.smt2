...
(assert (forall ((Heap@@2 T@U) (i Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (bool_2_U (|fun#triggerStateless| i))))
 :qid |stdinbpl.574:15|
 :skolemid |59|
 :pattern ( (|fun'| Heap@@2 i))
)))
...
(assert (forall ((Heap@@6 T@U) (Mask@@6 T@U) (i@@3 Int) ) (!  (=> (and (and (= (type Heap@@6) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (state Heap@@6 Mask@@6)) (= (|fun'| Heap@@6 i@@3) (|fun#frame| EmptyFrame i@@3)))
 :qid |stdinbpl.581:15|
 :skolemid |60|
 :pattern ( (state Heap@@6 Mask@@6) (|fun'| Heap@@6 i@@3))
)))
...
(assert (forall ((Heap@@7 T@U) (i@@5 Int) ) (!  (=> (= (type Heap@@7) (MapType0Type RefType)) (and (= (fun Heap@@7 i@@5) (|fun'| Heap@@7 i@@5)) (dummyFunction (bool_2_U (|fun#triggerStateless| i@@5)))))
 :qid |stdinbpl.570:15|
 :skolemid |58|
 :pattern ( (fun Heap@@7 i@@5))
)))
...
(assert  (and (and (= (type xs) (SeqType RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@12) (MapType0Type RefType))))
(set-info :boogie-vc-id test3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4))) (= (ControlFlow 0 16) 12)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4)) (and (=> (= (ControlFlow 0 13) (- 0 15)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 13) (- 0 14)) (< i_4 (|Seq#Length| xs))) (=> (< i_4 (|Seq#Length| xs)) (=> (= (ControlFlow 0 13) 12) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_3) (|Seq#Index| xs i_3_1))))
 :qid |stdinbpl.810:15|
 :skolemid |63|
 ...
 :qid |stdinbpl.810:15|
 :skolemid |63|
)) (=> (forall ((i_3@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@1)) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index| xs i_3@@1)) (= (invRecv1 (|Seq#Index| xs i_3@@1)) i_3@@1)))
 :qid |stdinbpl.816:22|
 :skolemid |64|
 ...
 :pattern ( (|Seq#Index| xs i_3@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (|Seq#Index| xs (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.820:22|
 :skolemid |65|
 :pattern ( (invRecv1 o_3))
)) (forall ((i_3@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@2)) (not (= (|Seq#Index| xs i_3@@2) null)))
 :qid |stdinbpl.826:22|
 :skolemid |66|
...
))) (and (state Heap@@12 QPMask@0) (state Heap@@12 QPMask@0))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< 3 (|Seq#Length| xs))) (=> (< 3 (|Seq#Length| xs)) (=> (= (ControlFlow 0 9) (- 0 8)) (HasDirectPerm QPMask@0 (|Seq#Index| xs 3) f_7)))))))))))
(let ((anon9_Else_correct  (=> (and (forall ((i_1_1 Int) (j_1 Int) ) (!  (=> (and (>= i_1_1 0) (and (< i_1_1 (|Seq#Length| xs)) (and (>= j_1 0) (and (< j_1 (|Seq#Length| xs)) (not (= i_1_1 j_1)))))) (not (= (|Seq#Index| xs i_1_1) (|Seq#Index| xs j_1))))
 :qid |stdinbpl.792:20|
 :skolemid |62|
 :pattern ( (|Seq#Index| xs i_1_1) (|Seq#Index| xs j_1))
)) (state Heap@@12 ZeroMask)) (and (and (=> (= (ControlFlow 0 17) 9) anon11_Else_correct) (=> (= (ControlFlow 0 17) 13) anon12_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon12_Else_correct)))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (and (>= i_2 0) (and (< i_2 (|Seq#Length| xs)) (and (>= j@@5 0) (and (< j@@5 (|Seq#Length| xs)) (not (= i_2 j@@5))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (>= i_2 0) (and (< i_2 (|Seq#Length| xs)) (and (>= j@@5 0) (and (< j@@5 (|Seq#Length| xs)) (not (= i_2 j@@5)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_2 (|Seq#Length| xs))) (=> (< i_2 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j@@5 (|Seq#Length| xs))) (=> (< j@@5 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@12 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (< 5 n@@13)) (and (< n@@13 (|Seq#Length| xs)) (state Heap@@12 ZeroMask))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (< 0 (|Seq#Length| xs))) (=> (< 0 (|Seq#Length| xs)) (=> (and (not (= (|Seq#Index| xs 0) null)) (state Heap@@12 ZeroMask)) (and (and (=> (= (ControlFlow 0 18) 17) anon9_Else_correct) (=> (= (ControlFlow 0 18) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 18) 7) anon10_Else_correct)))))))))
