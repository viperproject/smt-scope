...
(assert  (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type r_3) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type a_2) RefType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id test2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon5_correct true))
(let ((anon9_Else_correct  (=> (and (not (HasDirectPerm Mask@1 r_3 f2)) (= (ControlFlow 0 6) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (HasDirectPerm Mask@1 r_3 f2) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@1 r_3 f2)) (=> (HasDirectPerm Mask@1 r_3 f2) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
(let ((anon8_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((r_1_1 T@U) ) (!  (=> (and (= (type r_1_1) RefType) (HasDirectPerm Mask@1 r_1_1 f2)) false)
 :qid |stdinbpl.349:15|
 :skolemid |24|
 :pattern ( (MapType1Select Mask@1 r_1_1 f2))
 :pattern ( (MapType0Select ExhaleHeap@0 r_1_1 f2))
)))))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 a_2 f2 (real_2_U (- (U_2_real (MapType1Select Mask@0 a_2 f2)) perm@0)))) (=> (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1)) (and (and (=> (= (ControlFlow 0 7) 2) anon8_Else_correct) (=> (= (ControlFlow 0 7) 4) anon9_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct))))))
(let ((anon7_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 10) 7)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= perm@0 (U_2_real (MapType1Select Mask@0 a_2 f2)))) (=> (<= perm@0 (U_2_real (MapType1Select Mask@0 a_2 f2))) (=> (= (ControlFlow 0 8) 7) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 a_2 $allocated))) (and (not (= a_2 null)) (= Mask@0 (MapType1Store ZeroMask a_2 f2 (real_2_U (+ (U_2_real (MapType1Select ZeroMask a_2 f2)) FullPerm)))))) (and (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (= perm@0 (- FullPerm (U_2_real (MapType1Select Mask@0 a_2 f1))))))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 11) 8) anon7_Then_correct) (=> (= (ControlFlow 0 11) 10) anon7_Else_correct)))))))
