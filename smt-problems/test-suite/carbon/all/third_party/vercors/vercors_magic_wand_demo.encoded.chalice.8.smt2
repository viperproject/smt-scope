...
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type this$_10) RefType)) (= (type Heap@3) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@26) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (forall ((arg0@@44 T@U) ) (! (= (type (FrameFragment arg0@@44)) FrameTypeType)
...
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null (WandDemowriteonly$ this$_10))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 null (WandDemowriteonly$ this$_10)))) (=> (= (ControlFlow 0 3) 2) anon8_correct))))))
(let ((anon6_correct  (=> (= Heap@3 (MapType0Store Heap@2 null (|WandDemowriteonly$#sm| this$_10) (MapType1Store (MapType0Select Heap@2 null (|WandDemowriteonly$#sm| this$_10)) this$_10 WandDemox$ (bool_2_U true)))) (=> (and (state Heap@3 Mask@2) (state Heap@3 Mask@2)) (and (=> (= (ControlFlow 0 6) 3) anon12_Then_correct) (=> (= (ControlFlow 0 6) 5) anon12_Else_correct))))))
(let ((anon11_Else_correct  (=> (HasDirectPerm Mask@2 null (WandDemowriteonly$ this$_10)) (=> (and (= Heap@2 Heap@@26) (= (ControlFlow 0 8) 6)) anon6_correct))))
(let ((anon11_Then_correct  (=> (not (HasDirectPerm Mask@2 null (WandDemowriteonly$ this$_10))) (=> (and (and (= Heap@0 (MapType0Store Heap@@26 null (|WandDemowriteonly$#sm| this$_10) ZeroPMask)) (= Heap@1 (MapType0Store Heap@0 null (WandDemowriteonly$ this$_10) freshVersion@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 7) 6))) anon6_correct))))
(let ((anon4_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 this$_10 WandDemox$ (real_2_U (- (U_2_real (MapType1Select Mask@0 this$_10 WandDemox$)) perm@1)))) (= Mask@2 (MapType1Store Mask@1 null (WandDemowriteonly$ this$_10) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (WandDemowriteonly$ this$_10))) FullPerm))))) (=> (and (and (state Heap@@26 Mask@2) (state Heap@@26 Mask@2)) (and (|WandDemowriteonly$#trigger| Heap@@26 (WandDemowriteonly$ this$_10)) (= (MapType0Select Heap@@26 null (WandDemowriteonly$ this$_10)) (FrameFragment (MapType0Select Heap@@26 this$_10 WandDemox$))))) (and (=> (= (ControlFlow 0 9) 7) anon11_Then_correct) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct))))))
(let ((anon10_Else_correct  (=> (and (= perm@1 NoPerm) (= (ControlFlow 0 12) 9)) anon4_correct)))
(let ((anon10_Then_correct  (=> (not (= perm@1 NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= perm@1 (U_2_real (MapType1Select Mask@0 this$_10 WandDemox$)))) (=> (<= perm@1 (U_2_real (MapType1Select Mask@0 this$_10 WandDemox$))) (=> (= (ControlFlow 0 10) 9) anon4_correct))))))
(let ((anon9_Else_correct  (=> (and (U_2_bool (MapType0Select Heap@@26 n$_2 $allocated)) (= perm@1 (/ (to_real 100) (to_real 100)))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (and (=> (= (ControlFlow 0 13) 10) anon10_Then_correct) (=> (= (ControlFlow 0 13) 12) anon10_Else_correct)))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@26 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@26 this$_10 $allocated)) (not (= this$_10 null))) (and (state Heap@@26 ZeroMask) (< NoPerm k$_2))) (and (and (state Heap@@26 ZeroMask) (< k$_2 FullPerm)) (and (state Heap@@26 ZeroMask) (= perm@0 (/ (to_real 100) (to_real 100)))))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= this$_10 null))) (= Mask@0 (MapType1Store ZeroMask this$_10 WandDemox$ (real_2_U (+ (U_2_real (MapType1Select ZeroMask this$_10 WandDemox$)) perm@0))))) (and (state Heap@@26 Mask@0) (state Heap@@26 Mask@0))) (and (=> (= (ControlFlow 0 15) 1) anon9_Then_correct) (=> (= (ControlFlow 0 15) 13) anon9_Else_correct)))))))))
