...
(let ((anon9_Else_correct  (=> (not (p Heap@@17)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (HasDirectPerm Mask@1 t_1@@9 r_1)) (=> (HasDirectPerm Mask@1 t_1@@9 r_1) (=> (and (= Mask@4 (MapType1Store Mask@1 null (I (MapType0Select Heap@@17 t_1@@9 r_1)) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (I (MapType0Select Heap@@17 t_1@@9 r_1)))) FullPerm)))) (state Heap@@17 Mask@4)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm Mask@4 t_1@@9 l)) (=> (HasDirectPerm Mask@4 t_1@@9 l) (=> (and (and (= Mask@5 (MapType1Store Mask@4 null (I (MapType0Select Heap@@17 t_1@@9 l)) (real_2_U (+ (U_2_real (MapType1Select Mask@4 null (I (MapType0Select Heap@@17 t_1@@9 l)))) FullPerm)))) (state Heap@@17 Mask@5)) (and (= Mask@6 Mask@5) (= (ControlFlow 0 7) 1))) anon6_correct)))))))))
(let ((anon9_Then_correct  (=> (p Heap@@17) (and (=> (= (ControlFlow 0 4) (- 0 6)) (HasDirectPerm Mask@1 t_1@@9 r_1)) (=> (HasDirectPerm Mask@1 t_1@@9 r_1) (=> (and (= Mask@2 (MapType1Store Mask@1 null (I (MapType0Select Heap@@17 t_1@@9 r_1)) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (I (MapType0Select Heap@@17 t_1@@9 r_1)))) FullPerm)))) (state Heap@@17 Mask@2)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@2 t_1@@9 l)) (=> (HasDirectPerm Mask@2 t_1@@9 l) (=> (and (and (= Mask@3 (MapType1Store Mask@2 null (I (MapType0Select Heap@@17 t_1@@9 l)) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (I (MapType0Select Heap@@17 t_1@@9 l)))) FullPerm)))) (state Heap@@17 Mask@3)) (and (= Mask@6 Mask@3) (= (ControlFlow 0 4) 1))) anon6_correct)))))))))
(let ((anon7_Then_correct  (=> (not (= t_1@@9 null)) (=> (and (not (= t_1@@9 null)) (= Mask@0 (MapType1Store ZeroMask t_1@@9 r_1 (real_2_U (+ (U_2_real (MapType1Select ZeroMask t_1@@9 r_1)) FullPerm))))) (=> (and (and (state Heap@@17 Mask@0) (not (= t_1@@9 null))) (and (= Mask@1 (MapType1Store Mask@0 t_1@@9 l (real_2_U (+ (U_2_real (MapType1Select Mask@0 t_1@@9 l)) FullPerm)))) (state Heap@@17 Mask@1))) (and (and (=> (= (ControlFlow 0 10) 3) anon8_Then_correct) (=> (= (ControlFlow 0 10) 4) anon9_Then_correct)) (=> (= (ControlFlow 0 10) 7) anon9_Else_correct)))))))
(let ((anon7_Else_correct  (=> (= t_1@@9 null) (=> (and (= Mask@6 ZeroMask) (= (ControlFlow 0 2) 1)) anon6_correct))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@17 t_1@@9 $allocated))) (and (=> (= (ControlFlow 0 11) 10) anon7_Then_correct) (=> (= (ControlFlow 0 11) 2) anon7_Else_correct))))))
