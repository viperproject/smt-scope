...
(assert  (and (and (and (and (and (and (and (= (type s@@3) (MapType2Type RefType boolType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv2 arg0@@43)) RefType)
...
(assert (not
...
)) (=> (and (and (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select s@@3 x_1@@1)) (< NoPerm FullPerm)) (and (qpRange2 x_1@@1) (= (invRecv2 x_1@@1) x_1@@1))))
 :qid |stdinbpl.539:22|
 :skolemid |89|
 :pattern ( (MapType0Select Heap@@9 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
 :pattern ( (MapType0Select Heap@@9 x_1@@1 f_7))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select s@@3 (invRecv2 o_3))) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.543:22|
 :skolemid |90|
 ...
 :pattern ( (MapType0Select Heap@@9 x_1@@2 f_7))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select s@@3 (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select Mask@1 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select s@@3 (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select Mask@1 o_3@@0 f_7))))))
 :qid |stdinbpl.555:22|
 :skolemid |92|
