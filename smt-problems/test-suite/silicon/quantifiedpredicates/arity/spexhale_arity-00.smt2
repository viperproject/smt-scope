(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:24:18
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quantifiedpredicates/arity/spexhale_arity.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (=>
  ...
  (and
    ...
    (=
      ...
      ($PSF.lookup_p2 ($SortWrappers.$SnapTo$PSF<p2> ($Snap.first $t@4@01)) ($SortWrappers.$RefTo$Snap x@2@01))))))
(pop) ; 2
(pop) ; 1
; ---------- m3 ----------
...
(push) ; 2
; [eval] (r in xs)
(assert (Seq_contains xs@16@01 r@17@01))
(pop) ; 2
(declare-const $t@18@01 $PSF<p2>)
...
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((r1@17@01 $Ref) (r2@17@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@16@01 r1@17@01)
      (Seq_contains xs@16@01 r2@17@01)
      (= r1@17@01 r2@17@01))
    (= r1@17@01 r2@17@01))
...
; (get-info :all-statistics)
; Definitional axioms for inverse functions
(assert (forall ((r@17@01 $Ref)) (!
  (=>
    (Seq_contains xs@16@01 r@17@01)
    (and (= (inv@19@01 r@17@01) r@17@01) (img@20@01 r@17@01)))
  :pattern ((Seq_contains xs@16@01 r@17@01))
  :pattern ((Seq_contains_trigger xs@16@01 r@17@01))
  :pattern ((Seq_contains_trigger xs@16@01 r@17@01))
  :pattern ((inv@19@01 r@17@01))
  :pattern ((img@20@01 r@17@01))
  :qid |quant-u-7|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@20@01 r) (Seq_contains xs@16@01 (inv@19@01 r)))
    (= (inv@19@01 r) r))
  :pattern ((inv@19@01 r))
  :qid |p2-fctOfInv|)))
; Permissions are non-negative
...
; Definitional axioms for singleton-SM's value
(assert (=
  ($PSF.lookup_p2 (as sm@22@01  $PSF<p2>) ($SortWrappers.$RefTo$Snap x@15@01))
  $t@21@01))
(pop) ; 2
(push) ; 2
; Precomputing data for removing quantified permissions
...
(set-option :timeout 500)
(assert (not (forall ((r $Ref)) (!
  (=> (= r x@15@01) (= (- $Perm.Write (pTaken@23@01 r)) $Perm.No))
...
(set-option :timeout 500)
(assert (not (forall ((r $Ref)) (!
  (=> (= r x@15@01) (= (- $Perm.Write (pTaken@24@01 r)) $Perm.No))
...
(push) ; 2
; [eval] (r in xs)
(assert (Seq_contains xs@28@01 r@30@01))
(pop) ; 2
...
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((r1@30@01 $Ref) (r2@30@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@28@01 r1@30@01)
      (Seq_contains xs@28@01 r2@30@01)
      (= r1@30@01 r2@30@01))
    (= r1@30@01 r2@30@01))
...
; (get-info :all-statistics)
; Definitional axioms for inverse functions
(assert (forall ((r@30@01 $Ref)) (!
  (=>
    (Seq_contains xs@28@01 r@30@01)
    (and (= (inv@31@01 r@30@01) r@30@01) (img@32@01 r@30@01)))
  :pattern ((Seq_contains xs@28@01 r@30@01))
  :pattern ((Seq_contains_trigger xs@28@01 r@30@01))
  :pattern ((Seq_contains_trigger xs@28@01 r@30@01))
  :pattern ((inv@31@01 r@30@01))
  :pattern ((img@32@01 r@30@01))
  :qid |quant-u-17|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@32@01 r) (Seq_contains xs@28@01 (inv@31@01 r)))
    (= (inv@31@01 r) r))
  :pattern ((inv@31@01 r))
  :qid |p3-fctOfInv|)))
; Permissions are non-negative
...
; [eval] (x in xs)
(assert (Seq_contains xs@28@01 x@27@01))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
; Definitional axioms for singleton-SM's value
(assert (=
  ($PSF.lookup_p3 (as sm@34@01  $PSF<p3>) ($SortWrappers.$RefTo$Snap x@27@01))
  $t@33@01))
(pop) ; 2
(push) ; 2
; Precomputing data for removing quantified permissions
...
(set-option :timeout 500)
(assert (not (forall ((r $Ref)) (!
  (=> (= r x@27@01) (= (- $Perm.Write (pTaken@35@01 r)) $Perm.No))
...
; Final check if taken enough permissions
; Done removing quantified permissions
(declare-const sm@36@01 $PSF<p3>)
(declare-const s@37@01 $Snap)
; Definitional axioms for snapshot map values (instantiated)
(assert (=>
  (and (img@32@01 x@27@01) (Seq_contains xs@28@01 (inv@31@01 x@27@01)))
  (and
    (not (= ($SortWrappers.$RefTo$Snap x@27@01) $Snap.unit))
    (=
      ($PSF.lookup_p3 (as sm@36@01  $PSF<p3>) ($SortWrappers.$RefTo$Snap x@27@01))
      ($PSF.lookup_p3 ($SortWrappers.$SnapTo$PSF<p3> ($Snap.first $t@29@01)) ($SortWrappers.$RefTo$Snap x@27@01))))))
(pop) ; 2
(pop) ; 1
; ---------- m5 ----------
...
(push) ; 2
; [eval] (r in xs)
(assert (Seq_contains xs@41@01 r@42@01))
(pop) ; 2
...
(assert (not (forall ((r1@42@01 $Ref) (r2@42@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@41@01 r1@42@01)
      (Seq_contains xs@41@01 r2@42@01)
      (= r1@42@01 r2@42@01))
    (= r1@42@01 r2@42@01))
...
(assert (forall ((r@42@01 $Ref)) (!
  (=>
    (Seq_contains xs@41@01 r@42@01)
    (and (= (inv@44@01 r@42@01) r@42@01) (img@45@01 r@42@01)))
  :pattern ((Seq_contains xs@41@01 r@42@01))
  :pattern ((Seq_contains_trigger xs@41@01 r@42@01))
  :pattern ((Seq_contains_trigger xs@41@01 r@42@01))
  :pattern ((inv@44@01 r@42@01))
  :pattern ((img@45@01 r@42@01))
  :qid |quant-u-23|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and (img@45@01 r) (Seq_contains xs@41@01 (inv@44@01 r)))
    (= (inv@44@01 r) r))
  :pattern ((inv@44@01 r))
  :qid |p3-fctOfInv|)))
; Permissions are non-negative
...
(declare-const sm@47@01 $PSF<p3>)
; Definitional axioms for singleton-SM's value
(assert (=
  ($PSF.lookup_p3 (as sm@47@01  $PSF<p3>) ($SortWrappers.$RefTo$Snap x@40@01))
  $t@46@01))
(pop) ; 2
(push) ; 2
; Precomputing data for removing quantified permissions
...
(set-option :timeout 500)
(assert (not (forall ((r $Ref)) (!
  (=> (= r x@40@01) (= (- $Perm.Write (pTaken@48@01 r)) $Perm.No))
...
(set-option :timeout 500)
(assert (not (forall ((r $Ref)) (!
  (=> (= r x@40@01) (= (- $Perm.Write (pTaken@49@01 r)) $Perm.No))
...
(push) ; 2
; [eval] (r in xs)
(assert (Seq_contains xs@55@01 r@57@01))
(pop) ; 2
(declare-fun inv@58@01 ($Ref Int) $Ref)
(declare-fun img@59@01 ($Ref Int) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((r1@57@01 $Ref) (r2@57@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@55@01 r1@57@01)
      (Seq_contains xs@55@01 r2@57@01)
      (= r1@57@01 r2@57@01))
    (= r1@57@01 r2@57@01))
...
(assert (forall ((r@57@01 $Ref)) (!
  (=>
    (Seq_contains xs@55@01 r@57@01)
    (and (= (inv@58@01 r@57@01 i@54@01) r@57@01) (img@59@01 r@57@01 i@54@01)))
  :pattern ((Seq_contains xs@55@01 r@57@01))
  :pattern ((Seq_contains_trigger xs@55@01 r@57@01))
  :pattern ((Seq_contains_trigger xs@55@01 r@57@01))
  :pattern ((inv@58@01 r@57@01 i@54@01))
  :pattern ((img@59@01 r@57@01 i@54@01))
  :qid |quant-u-33|)))
(assert (forall ((r $Ref) (i Int)) (!
  (=>
    (and (img@59@01 r i) (Seq_contains xs@55@01 (inv@58@01 r i)))
    (and (= (inv@58@01 r i) r) (= i@54@01 i)))
  :pattern ((inv@58@01 r i))
  :qid |p4-fctOfInv|)))
; Permissions are non-negative
(assert (= ($Snap.second $t@56@01) $Snap.unit))
; [eval] (x in xs)
(assert (Seq_contains xs@55@01 x@53@01))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
(declare-const sm@61@01 $PSF<p4>)
; Definitional axioms for singleton-SM's value
(assert (=
  ($PSF.lookup_p4 (as sm@61@01  $PSF<p4>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap x@53@01)
    ($SortWrappers.IntTo$Snap i@54@01)))
  $t@60@01))
(pop) ; 2
(push) ; 2
; Precomputing data for removing quantified permissions
...
; Final check if taken enough permissions
; Done removing quantified permissions
(declare-const sm@63@01 $PSF<p4>)
(declare-const s@64@01 $Snap)
; Definitional axioms for snapshot map values (instantiated)
(assert (=>
  (and
    (img@59@01 x@53@01 i@54@01)
    (Seq_contains xs@55@01 (inv@58@01 x@53@01 i@54@01)))
  (and
    (not
      (=
        ($Snap.combine
        ...
        $Snap.unit))
    (=
      ($PSF.lookup_p4 (as sm@63@01  $PSF<p4>) ($Snap.combine
        ($SortWrappers.$RefTo$Snap x@53@01)
        ($SortWrappers.IntTo$Snap i@54@01)))
      ($PSF.lookup_p4 ($SortWrappers.$SnapTo$PSF<p4> ($Snap.first $t@56@01)) ($Snap.combine
        ($SortWrappers.$RefTo$Snap x@53@01)
        ($SortWrappers.IntTo$Snap i@54@01)))))))
(pop) ; 2
(pop) ; 1
...
(push) ; 2
; [eval] (r in xs)
(assert (Seq_contains xs@70@01 r@71@01))
(pop) ; 2
(declare-const $t@72@01 $PSF<p4>)
...
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((r1@71@01 $Ref) (r2@71@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@70@01 r1@71@01)
      (Seq_contains xs@70@01 r2@71@01)
      (= r1@71@01 r2@71@01))
    (= r1@71@01 r2@71@01))
...
(assert (forall ((r@71@01 $Ref)) (!
  (=>
    (Seq_contains xs@70@01 r@71@01)
    (and (= (inv@73@01 r@71@01 i@69@01) r@71@01) (img@74@01 r@71@01 i@69@01)))
  :pattern ((Seq_contains xs@70@01 r@71@01))
  :pattern ((Seq_contains_trigger xs@70@01 r@71@01))
  :pattern ((Seq_contains_trigger xs@70@01 r@71@01))
  :pattern ((inv@73@01 r@71@01 i@69@01))
  :pattern ((img@74@01 r@71@01 i@69@01))
  :qid |quant-u-39|)))
(assert (forall ((r $Ref) (i Int)) (!
  (=>
...
(declare-const sm@76@01 $PSF<p4>)
; Definitional axioms for singleton-SM's value
(assert (=
  ($PSF.lookup_p4 (as sm@76@01  $PSF<p4>) ($Snap.combine
...
(push) ; 2
; Precomputing data for removing quantified permissions
(define-fun pTaken@77@01 ((r $Ref) (i Int)) $Perm
  (ite
...
(assert (not (forall ((r $Ref) (i Int)) (!
  (=>
    (and (= r x@68@01) (= i i@69@01))
    (= (- $Perm.Write (pTaken@77@01 r i)) $Perm.No))
...
; unknown
; Precomputing data for removing quantified permissions
(define-fun pTaken@78@01 ((r $Ref) (i Int)) $Perm
  (ite
    (and (= r x@68@01) (= i i@69@01))
    ($Perm.min
      (ite
...
(assert (not (forall ((r $Ref) (i Int)) (!
  (=>
    (and (= r x@68@01) (= i i@69@01))
    (= (- $Perm.Write (pTaken@78@01 r i)) $Perm.No))
...
(push) ; 2
; [eval] (r in xs)
(assert (Seq_contains xs@84@01 r@86@01))
(pop) ; 2
(declare-fun inv@87@01 ($Ref Int) $Ref)
(declare-fun img@88@01 ($Ref Int) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
; Check receiver injectivity
(push) ; 2
(assert (not (forall ((r1@86@01 $Ref) (r2@86@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@84@01 r1@86@01)
      (Seq_contains xs@84@01 r2@86@01)
      (= r1@86@01 r2@86@01))
    (= r1@86@01 r2@86@01))
...
; (get-info :all-statistics)
; Definitional axioms for inverse functions
(assert (forall ((r@86@01 $Ref)) (!
  (=>
    (Seq_contains xs@84@01 r@86@01)
    (and (= (inv@87@01 r@86@01 i@83@01) r@86@01) (img@88@01 r@86@01 i@83@01)))
  :pattern ((Seq_contains xs@84@01 r@86@01))
  :pattern ((Seq_contains_trigger xs@84@01 r@86@01))
  :pattern ((Seq_contains_trigger xs@84@01 r@86@01))
  :pattern ((inv@87@01 r@86@01 i@83@01))
  :pattern ((img@88@01 r@86@01 i@83@01))
  :qid |quant-u-49|)))
(assert (forall ((r $Ref) (i Int)) (!
  (=>
    (and (img@88@01 r i) (Seq_contains xs@84@01 (inv@87@01 r i)))
    (and (= (inv@87@01 r i) r) (= i@83@01 i)))
  :pattern ((inv@87@01 r i))
  :qid |p5-fctOfInv|)))
; Permissions are non-negative
(assert (= ($Snap.second $t@85@01) $Snap.unit))
; [eval] (x in xs)
(assert (Seq_contains xs@84@01 x@82@01))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
(declare-const sm@90@01 $PSF<p5>)
; Definitional axioms for singleton-SM's value
(assert (=
  ($PSF.lookup_p5 (as sm@90@01  $PSF<p5>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap x@82@01)
    ($SortWrappers.IntTo$Snap i@83@01)))
  $t@89@01))
(pop) ; 2
(push) ; 2
; Precomputing data for removing quantified permissions
...
; Final check if taken enough permissions
; Done removing quantified permissions
(declare-const sm@92@01 $PSF<p5>)
(declare-const s@93@01 $Snap)
; Definitional axioms for snapshot map values (instantiated)
(assert (=>
  (and
    (img@88@01 x@82@01 i@83@01)
    (Seq_contains xs@84@01 (inv@87@01 x@82@01 i@83@01)))
  (and
    (not
      (=
        ($Snap.combine
        ...
        $Snap.unit))
    (=
      ($PSF.lookup_p5 (as sm@92@01  $PSF<p5>) ($Snap.combine
        ($SortWrappers.$RefTo$Snap x@82@01)
        ($SortWrappers.IntTo$Snap i@83@01)))
      ($PSF.lookup_p5 ($SortWrappers.$SnapTo$PSF<p5> ($Snap.first $t@85@01)) ($Snap.combine
        ($SortWrappers.$RefTo$Snap x@82@01)
        ($SortWrappers.IntTo$Snap i@83@01)))))))
(pop) ; 2
(pop) ; 1
...
(push) ; 2
; [eval] (r in xs)
(assert (Seq_contains xs@99@01 r@100@01))
(pop) ; 2
(declare-const $t@101@01 $PSF<p5>)
(declare-fun inv@102@01 ($Ref Int) $Ref)
...
(assert (not (forall ((r1@100@01 $Ref) (r2@100@01 $Ref)) (!
  (=>
    (and
      (Seq_contains xs@99@01 r1@100@01)
      (Seq_contains xs@99@01 r2@100@01)
      (= r1@100@01 r2@100@01))
    (= r1@100@01 r2@100@01))
...
(assert (forall ((r@100@01 $Ref)) (!
  (=>
    (Seq_contains xs@99@01 r@100@01)
    (and
      (= (inv@102@01 r@100@01 i@98@01) r@100@01)
      (img@103@01 r@100@01 i@98@01)))
  :pattern ((Seq_contains xs@99@01 r@100@01))
  :pattern ((Seq_contains_trigger xs@99@01 r@100@01))
  :pattern ((Seq_contains_trigger xs@99@01 r@100@01))
  :pattern ((inv@102@01 r@100@01 i@98@01))
  :pattern ((img@103@01 r@100@01 i@98@01))
  :qid |quant-u-55|)))
(assert (forall ((r $Ref) (i Int)) (!
  (=>
    (and (img@103@01 r i) (Seq_contains xs@99@01 (inv@102@01 r i)))
    (and (= (inv@102@01 r i) r) (= i@98@01 i)))
  :pattern ((inv@102@01 r i))
  :qid |p5-fctOfInv|)))
; Permissions are non-negative
; State saturation: after contract
(set-option :timeout 50)
...
(declare-const sm@105@01 $PSF<p5>)
; Definitional axioms for singleton-SM's value
(assert (=
  ($PSF.lookup_p5 (as sm@105@01  $PSF<p5>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap x@97@01)
    ($SortWrappers.IntTo$Snap i@98@01)))
  $t@104@01))
(pop) ; 2
(push) ; 2
; Precomputing data for removing quantified permissions
(define-fun pTaken@106@01 ((r $Ref) (i Int)) $Perm
  (ite
    (and (= r x@97@01) (= i i@98@01))
    ($Perm.min
      (ite
        (and (img@103@01 r i) (Seq_contains xs@99@01 (inv@102@01 r i)))
        $Perm.Write
...
(assert (not (forall ((r $Ref) (i Int)) (!
  (=>
    (and (= r x@97@01) (= i i@98@01))
    (= (- $Perm.Write (pTaken@106@01 r i)) $Perm.No))
...
; unknown
; Precomputing data for removing quantified permissions
(define-fun pTaken@107@01 ((r $Ref) (i Int)) $Perm
  (ite
    (and (= r x@97@01) (= i i@98@01))
    ($Perm.min
      (ite
...
(assert (not (forall ((r $Ref) (i Int)) (!
  (=>
    (and (= r x@97@01) (= i i@98@01))
    (= (- $Perm.Write (pTaken@107@01 r i)) $Perm.No))
