...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type vas@@11) (MapType2Type RefType boolType)) (= (type Heap@@20) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type ExhaleHeap@1) (MapType0Type RefType))) (= (type QPMask@4) (MapType1Type RefType realType))) (= (type QPMask@3) (MapType1Type RefType realType))) (= (type bs) (MapType2Type RefType boolType))) (= (type Heap@1) (MapType0Type RefType))) (forall ((arg0@@51 T@U) ) (! (= (type (invRecv11 arg0@@51)) RefType)
 :qid |funType:invRecv11|
 :pattern ( (invRecv11 arg0@@51))
))) (= (type a1) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type b1) RefType)) (forall ((arg0@@52 T@U) ) (! (= (type (invRecv9 arg0@@52)) RefType)
 :qid |funType:invRecv9|
 :pattern ( (invRecv9 arg0@@52))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@53 T@U) ) (! (= (type (invRecv8 arg0@@53)) RefType)
 :qid |funType:invRecv8|
 :pattern ( (invRecv8 arg0@@53))
))))
(set-info :boogie-vc-id test_vals_2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon15_Else_correct  (=> (= (ControlFlow 0 11) (- 0 10)) (= (foo_vals ExhaleHeap@1 vas@@11) 0))))
(let ((anon15_Then_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (forall ((a_3 T@U) (a_3_1 T@U) ) (!  (=> (and (= (type a_3) RefType) (= (type a_3_1) RefType)) (=> (and (and (and (and (not (= a_3 a_3_1)) (U_2_bool (MapType2Select vas@@11 a_3))) (U_2_bool (MapType2Select vas@@11 a_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_3 a_3_1))))
 :qid |stdinbpl.1350:21|
 :skolemid |166|
 :pattern ( (neverTriggered12 a_3) (neverTriggered12 a_3_1))
))) (=> (forall ((a_3@@0 T@U) (a_3_1@@0 T@U) ) (!  (=> (and (= (type a_3@@0) RefType) (= (type a_3_1@@0) RefType)) (=> (and (and (and (and (not (= a_3@@0 a_3_1@@0)) (U_2_bool (MapType2Select vas@@11 a_3@@0))) (U_2_bool (MapType2Select vas@@11 a_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_3@@0 a_3_1@@0))))
 :qid |stdinbpl.1350:21|
 :skolemid |166|
 :pattern ( (neverTriggered12 a_3@@0) (neverTriggered12 a_3_1@@0))
)) (=> (= (ControlFlow 0 8) (- 0 7)) (forall ((a_3@@1 T@U) ) (!  (=> (and (= (type a_3@@1) RefType) (U_2_bool (MapType2Select vas@@11 a_3@@1))) (>= (U_2_real (MapType1Select QPMask@3 a_3@@1 val)) FullPerm))
 :qid |stdinbpl.1357:21|
 :skolemid |167|
 :pattern ( (MapType0Select ExhaleHeap@1 a_3@@1 val))
 :pattern ( (MapType1Select QPMask@4 a_3@@1 val))
 :pattern ( (MapType0Select ExhaleHeap@1 a_3@@1 val))
)))))))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 14)) (forall ((a$1_1 T@U) (a$1_1_1 T@U) ) (!  (=> (and (= (type a$1_1) RefType) (= (type a$1_1_1) RefType)) (=> (and (and (and (and (not (= a$1_1 a$1_1_1)) (U_2_bool (MapType2Select bs a$1_1))) (U_2_bool (MapType2Select bs a$1_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a$1_1 a$1_1_1))))
 :qid |stdinbpl.1294:17|
 :skolemid |160|
 :pattern ( (neverTriggered11 a$1_1) (neverTriggered11 a$1_1_1))
))) (=> (forall ((a$1_1@@0 T@U) (a$1_1_1@@0 T@U) ) (!  (=> (and (= (type a$1_1@@0) RefType) (= (type a$1_1_1@@0) RefType)) (=> (and (and (and (and (not (= a$1_1@@0 a$1_1_1@@0)) (U_2_bool (MapType2Select bs a$1_1@@0))) (U_2_bool (MapType2Select bs a$1_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a$1_1@@0 a$1_1_1@@0))))
 :qid |stdinbpl.1294:17|
 :skolemid |160|
 :pattern ( (neverTriggered11 a$1_1@@0) (neverTriggered11 a$1_1_1@@0))
)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((a$1_1@@1 T@U) ) (!  (=> (and (= (type a$1_1@@1) RefType) (U_2_bool (MapType2Select bs a$1_1@@1))) (>= (U_2_real (MapType1Select QPMask@1 a$1_1@@1 val)) FullPerm))
 :qid |stdinbpl.1301:17|
 :skolemid |161|
 :pattern ( (MapType0Select Heap@1 a$1_1@@1 val))
 :pattern ( (MapType1Select QPMask@3 a$1_1@@1 val))
 :pattern ( (MapType0Select Heap@1 a$1_1@@1 val))
))) (=> (forall ((a$1_1@@2 T@U) ) (!  (=> (and (= (type a$1_1@@2) RefType) (U_2_bool (MapType2Select bs a$1_1@@2))) (>= (U_2_real (MapType1Select QPMask@1 a$1_1@@2 val)) FullPerm))
 :qid |stdinbpl.1301:17|
 :skolemid |161|
 :pattern ( (MapType0Select Heap@1 a$1_1@@2 val))
 :pattern ( (MapType1Select QPMask@3 a$1_1@@2 val))
 :pattern ( (MapType0Select Heap@1 a$1_1@@2 val))
)) (=> (and (forall ((a$1_1@@3 T@U) ) (!  (=> (= (type a$1_1@@3) RefType) (=> (and (U_2_bool (MapType2Select bs a$1_1@@3)) (< NoPerm FullPerm)) (and (qpRange11 a$1_1@@3) (= (invRecv11 a$1_1@@3) a$1_1@@3))))
 :qid |stdinbpl.1307:22|
 :skolemid |162|
 :pattern ( (MapType0Select Heap@1 a$1_1@@3 val))
 :pattern ( (MapType1Select QPMask@3 a$1_1@@3 val))
 :pattern ( (MapType0Select Heap@1 a$1_1@@3 val))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType2Select bs (invRecv11 o_3))) (and (< NoPerm FullPerm) (qpRange11 o_3))) (= (invRecv11 o_3) o_3)))
 :qid |stdinbpl.1311:22|
 :skolemid |163|
 :pattern ( (invRecv11 o_3))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType2Select bs (invRecv11 o_3@@0))) (and (< NoPerm FullPerm) (qpRange11 o_3@@0))) (and (= (invRecv11 o_3@@0) o_3@@0) (= (U_2_real (MapType1Select QPMask@3 o_3@@0 val)) (- (U_2_real (MapType1Select QPMask@1 o_3@@0 val)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select bs (invRecv11 o_3@@0))) (and (< NoPerm FullPerm) (qpRange11 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@3 o_3@@0 val)) (U_2_real (MapType1Select QPMask@1 o_3@@0 val))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 val))) (= (U_2_real (MapType1Select QPMask@1 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@3 o_3@@1 f_5))))))
 :qid |stdinbpl.1323:29|
 :skolemid |165|
 :pattern ( (MapType1Select QPMask@3 o_3@@1 f_5))
))) (and (IdenticalOnKnownLocations Heap@1 ExhaleHeap@1 QPMask@3) (state ExhaleHeap@1 QPMask@3))) (and (=> (= (ControlFlow 0 12) 8) anon15_Then_correct) (=> (= (ControlFlow 0 12) 11) anon15_Else_correct))))))))))
(let ((anon14_Then_correct true))
(let ((anon13_Else_correct  (=> (and (= (foo_vals Heap@@20 vas@@11) 0) (state Heap@@20 QPMask@1)) (=> (and (and (state Heap@@20 QPMask@1) (U_2_bool (MapType2Select vas@@11 a1))) (and (state Heap@@20 QPMask@1) (state Heap@@20 QPMask@1))) (and (=> (= (ControlFlow 0 15) (- 0 18)) (HasDirectPerm QPMask@1 a1 val)) (=> (HasDirectPerm QPMask@1 a1 val) (and (=> (= (ControlFlow 0 15) (- 0 17)) (= FullPerm (U_2_real (MapType1Select QPMask@1 a1 val)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@1 a1 val))) (=> (= Heap@0 (MapType0Store Heap@@20 a1 val (int_2_U (- (+ 1 (U_2_int (MapType0Select Heap@@20 a1 val))) 1)))) (=> (and (and (state Heap@0 QPMask@1) (U_2_bool (MapType2Select bs b1))) (and (state Heap@0 QPMask@1) (state Heap@0 QPMask@1))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (= FullPerm (U_2_real (MapType1Select QPMask@1 b1 val)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@1 b1 val))) (=> (and (= Heap@1 (MapType0Store Heap@0 b1 val (int_2_U 1))) (state Heap@1 QPMask@1)) (and (=> (= (ControlFlow 0 15) 6) anon14_Then_correct) (=> (= (ControlFlow 0 15) 12) anon14_Else_correct)))))))))))))))
(let ((anon13_Then_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((a_2 T@U) (a_2_2 T@U) ) (!  (=> (and (= (type a_2) RefType) (= (type a_2_2) RefType)) (=> (and (and (and (and (not (= a_2 a_2_2)) (U_2_bool (MapType2Select vas@@11 a_2))) (U_2_bool (MapType2Select vas@@11 a_2_2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_2 a_2_2))))
 :qid |stdinbpl.1208:21|
 :skolemid |154|
 :pattern ( (neverTriggered10 a_2) (neverTriggered10 a_2_2))
))) (=> (forall ((a_2@@0 T@U) (a_2_2@@0 T@U) ) (!  (=> (and (= (type a_2@@0) RefType) (= (type a_2_2@@0) RefType)) (=> (and (and (and (and (not (= a_2@@0 a_2_2@@0)) (U_2_bool (MapType2Select vas@@11 a_2@@0))) (U_2_bool (MapType2Select vas@@11 a_2_2@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_2@@0 a_2_2@@0))))
 :qid |stdinbpl.1208:21|
 :skolemid |154|
 :pattern ( (neverTriggered10 a_2@@0) (neverTriggered10 a_2_2@@0))
)) (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((a_2@@1 T@U) ) (!  (=> (and (= (type a_2@@1) RefType) (U_2_bool (MapType2Select vas@@11 a_2@@1))) (>= (U_2_real (MapType1Select QPMask@1 a_2@@1 val)) FullPerm))
 :qid |stdinbpl.1215:21|
 :skolemid |155|
 :pattern ( (MapType0Select Heap@@20 a_2@@1 val))
 :pattern ( (MapType1Select QPMask@2 a_2@@1 val))
 :pattern ( (MapType0Select Heap@@20 a_2@@1 val))
)))))))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((a$0_1 T@U) (a$0_1_1 T@U) ) (!  (=> (and (= (type a$0_1) RefType) (= (type a$0_1_1) RefType)) (=> (and (and (and (and (not (= a$0_1 a$0_1_1)) (U_2_bool (MapType2Select bs a$0_1))) (U_2_bool (MapType2Select bs a$0_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a$0_1 a$0_1_1))))
 :qid |stdinbpl.1158:15|
 :skolemid |148|
 :no-pattern (type a$0_1)
 :no-pattern (type a$0_1_1)
 :no-pattern (U_2_int a$0_1)
 :no-pattern (U_2_bool a$0_1)
 :no-pattern (U_2_int a$0_1_1)
 :no-pattern (U_2_bool a$0_1_1)
 ...
 :qid |stdinbpl.1158:15|
 :skolemid |148|
 :no-pattern (type a$0_1@@0)
 :no-pattern (type a$0_1_1@@0)
 :no-pattern (U_2_int a$0_1@@0)
 :no-pattern (U_2_bool a$0_1@@0)
 :no-pattern (U_2_int a$0_1_1@@0)
 :no-pattern (U_2_bool a$0_1_1@@0)
)) (=> (forall ((a$0_1@@1 T@U) ) (!  (=> (= (type a$0_1@@1) RefType) (=> (and (U_2_bool (MapType2Select bs a$0_1@@1)) (< NoPerm FullPerm)) (and (qpRange9 a$0_1@@1) (= (invRecv9 a$0_1@@1) a$0_1@@1))))
 :qid |stdinbpl.1164:22|
 :skolemid |149|
 :pattern ( (MapType0Select Heap@@20 a$0_1@@1 val))
 :pattern ( (MapType1Select QPMask@1 a$0_1@@1 val))
 :pattern ( (MapType0Select Heap@@20 a$0_1@@1 val))
)) (=> (and (and (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType2Select bs (invRecv9 o_3@@2))) (< NoPerm FullPerm)) (qpRange9 o_3@@2)) (= (invRecv9 o_3@@2) o_3@@2)))
 :qid |stdinbpl.1168:22|
 :skolemid |150|
 :pattern ( (invRecv9 o_3@@2))
)) (forall ((a$0_1@@2 T@U) ) (!  (=> (and (= (type a$0_1@@2) RefType) (U_2_bool (MapType2Select bs a$0_1@@2))) (not (= a$0_1@@2 null)))
 :qid |stdinbpl.1174:22|
 :skolemid |151|
 :pattern ( (MapType0Select Heap@@20 a$0_1@@2 val))
 :pattern ( (MapType1Select QPMask@1 a$0_1@@2 val))
 :pattern ( (MapType0Select Heap@@20 a$0_1@@2 val))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType2Select bs (invRecv9 o_3@@3))) (< NoPerm FullPerm)) (qpRange9 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv9 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 val)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@3 val)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select bs (invRecv9 o_3@@3))) (< NoPerm FullPerm)) (qpRange9 o_3@@3))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 val)) (U_2_real (MapType1Select QPMask@0 o_3@@3 val))))))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 val))) (= (U_2_real (MapType1Select QPMask@0 o_3@@4 f_5@@0)) (U_2_real (MapType1Select QPMask@1 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.1184:29|
 :skolemid |153|
 :pattern ( (MapType1Select QPMask@0 o_3@@4 f_5@@0))
 :pattern ( (MapType1Select QPMask@1 o_3@@4 f_5@@0))
)))) (and (and (state Heap@@20 QPMask@1) (state Heap@@20 QPMask@1)) (and (state Heap@@20 QPMask@1) (state Heap@@20 QPMask@1)))) (and (=> (= (ControlFlow 0 19) 4) anon13_Then_correct) (=> (= (ControlFlow 0 19) 15) anon13_Else_correct))))))))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((a_1 T@U) (a_1_1 T@U) ) (!  (=> (and (= (type a_1) RefType) (= (type a_1_1) RefType)) (=> (and (and (and (and (not (= a_1 a_1_1)) (U_2_bool (MapType2Select vas@@11 a_1))) (U_2_bool (MapType2Select vas@@11 a_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1 a_1_1))))
 :qid |stdinbpl.1119:15|
 :skolemid |142|
 :no-pattern (type a_1)
 :no-pattern (type a_1_1)
 :no-pattern (U_2_int a_1)
 :no-pattern (U_2_bool a_1)
 :no-pattern (U_2_int a_1_1)
 :no-pattern (U_2_bool a_1_1)
 ...
 :qid |stdinbpl.1119:15|
 :skolemid |142|
 :no-pattern (type a_1@@0)
 :no-pattern (type a_1_1@@0)
 :no-pattern (U_2_int a_1@@0)
 :no-pattern (U_2_bool a_1@@0)
 :no-pattern (U_2_int a_1_1@@0)
 :no-pattern (U_2_bool a_1_1@@0)
)) (=> (and (forall ((a_1@@1 T@U) ) (!  (=> (= (type a_1@@1) RefType) (=> (and (U_2_bool (MapType2Select vas@@11 a_1@@1)) (< NoPerm FullPerm)) (and (qpRange8 a_1@@1) (= (invRecv8 a_1@@1) a_1@@1))))
 :qid |stdinbpl.1125:22|
 :skolemid |143|
 :pattern ( (MapType0Select Heap@@20 a_1@@1 val))
 :pattern ( (MapType1Select QPMask@0 a_1@@1 val))
 :pattern ( (MapType0Select Heap@@20 a_1@@1 val))
)) (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (U_2_bool (MapType2Select vas@@11 (invRecv8 o_3@@5))) (< NoPerm FullPerm)) (qpRange8 o_3@@5)) (= (invRecv8 o_3@@5) o_3@@5)))
 :qid |stdinbpl.1129:22|
 :skolemid |144|
 :pattern ( (invRecv8 o_3@@5))
))) (=> (and (and (forall ((a_1@@2 T@U) ) (!  (=> (and (= (type a_1@@2) RefType) (U_2_bool (MapType2Select vas@@11 a_1@@2))) (not (= a_1@@2 null)))
 :qid |stdinbpl.1135:22|
 :skolemid |145|
 :pattern ( (MapType0Select Heap@@20 a_1@@2 val))
 :pattern ( (MapType1Select QPMask@0 a_1@@2 val))
 :pattern ( (MapType0Select Heap@@20 a_1@@2 val))
)) (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (U_2_bool (MapType2Select vas@@11 (invRecv8 o_3@@6))) (< NoPerm FullPerm)) (qpRange8 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv8 o_3@@6) o_3@@6)) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@6 val)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select vas@@11 (invRecv8 o_3@@6))) (< NoPerm FullPerm)) (qpRange8 o_3@@6))) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 val)) (U_2_real (MapType1Select ZeroMask o_3@@6 val))))))
...
(let ((A@@14 (FieldTypeInv0 (type f_5@@1))))
 (=> (and (and (= (type o_3@@7) RefType) (= (type f_5@@1) (FieldType A@@14 B@@13))) (not (= f_5@@1 val))) (= (U_2_real (MapType1Select ZeroMask o_3@@7 f_5@@1)) (U_2_real (MapType1Select QPMask@0 o_3@@7 f_5@@1))))))
 :qid |stdinbpl.1145:29|
 :skolemid |147|
 :pattern ( (MapType1Select ZeroMask o_3@@7 f_5@@1))
 :pattern ( (MapType1Select QPMask@0 o_3@@7 f_5@@1))
)) (state Heap@@20 QPMask@0))) (and (=> (= (ControlFlow 0 21) 2) anon12_Then_correct) (=> (= (ControlFlow 0 21) 19) anon12_Else_correct))))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@20 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@20 a1 $allocated)) (U_2_bool (MapType0Select Heap@@20 b1 $allocated)))) (and (=> (= (ControlFlow 0 23) 1) anon11_Then_correct) (=> (= (ControlFlow 0 23) 21) anon11_Else_correct)))))
