...
(assert (forall ((a_3@@0 T@U) (i_2 Int) ) (!  (=> (= (type a_3@@0) IArrayDomainTypeType) (and (= (first (loc a_3@@0 i_2)) a_3@@0) (= (second (loc a_3@@0 i_2)) i_2)))
 :qid |stdinbpl.213:15|
 :skolemid |22|
...
(assert  (and (and (and (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type arr2) IArrayDomainTypeType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Heap@1) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type arr1) IArrayDomainTypeType)))
(set-info :boogie-vc-id test2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon8_correct true))
(let ((anon12_Else_correct  (=> (HasDirectPerm Mask@0 null (P (loc arr2 0))) (=> (and (= Heap@1 Heap@@10) (= (ControlFlow 0 4) 2)) anon8_correct))))
(let ((anon12_Then_correct  (=> (and (and (not (HasDirectPerm Mask@0 null (P (loc arr2 0)))) (= Heap@0 (MapType0Store Heap@@10 null (P (loc arr2 0)) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 3) 2))) anon8_correct)))
(let ((anon6_correct  (=> (= Mask@0 (MapType1Store QPMask@0 null (P (loc arr2 0)) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (P (loc arr2 0)))) FullPerm)))) (and (=> (= (ControlFlow 0 5) 3) anon12_Then_correct) (=> (= (ControlFlow 0 5) 4) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon6_correct)))
(let ((anon11_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (P (loc arr2 0)))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (P (loc arr2 0))))) (=> (= (ControlFlow 0 6) 5) anon6_correct))))))
(let ((anon4_correct  (=> (and (and (= UnfoldingMask@0 (MapType1Store QPMask@0 null (P (loc arr1 0)) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (P (loc arr1 0)))) FullPerm)))) (not (= (loc arr1 0) null))) (and (state Heap@@10 UnfoldingMask@0) (state Heap@@10 QPMask@0))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (not (= (loc arr1 0) null))) (=> (not (= (loc arr1 0) null)) (=> (and (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0)) (and (|P#trigger| Heap@@10 (P (loc arr2 0))) (= (MapType0Select Heap@@10 null (P (loc arr2 0))) EmptyFrame))) (and (=> (= (ControlFlow 0 9) 6) anon11_Then_correct) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct))))))))
(let ((anon10_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 9)) anon4_correct)))
(let ((anon10_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (P (loc arr1 0)))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (P (loc arr1 0))))) (=> (= (ControlFlow 0 11) 9) anon4_correct))))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 16)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (not (= i_1 i_1_1)) (< NoPerm (ite  (and (<= 0 i_1) (< i_1 10)) FullPerm NoPerm))) (< NoPerm (ite  (and (<= 0 i_1_1) (< i_1_1 10)) FullPerm NoPerm))) (not (= (loc arr1 i_1) (loc arr1 i_1_1))))
 :qid |stdinbpl.407:17|
 :skolemid |37|
...
)) (=> (and (forall ((i_1@@1 Int) ) (!  (=> (< NoPerm (ite  (and (<= 0 i_1@@1) (< i_1@@1 10)) FullPerm NoPerm)) (and (= (invRecv2 (loc arr1 i_1@@1)) i_1@@1) (qpRange2 (loc arr1 i_1@@1))))
 :qid |stdinbpl.413:22|
 :skolemid |38|
 :pattern ( (MapType0Select Heap@@10 null (P (loc arr1 i_1@@1))))
 :pattern ( (MapType1Select ZeroMask null (P (loc arr1 i_1@@1))))
 :pattern ( (loc arr1 i_1@@1))
)) (forall ((x@@14 T@U) ) (!  (=> (= (type x@@14) RefType) (=> (and (< NoPerm (ite  (and (<= 0 (invRecv2 x@@14)) (< (invRecv2 x@@14) 10)) FullPerm NoPerm)) (qpRange2 x@@14)) (= (loc arr1 (invRecv2 x@@14)) x@@14)))
 :qid |stdinbpl.417:22|
 :skolemid |39|
 :pattern ( (invRecv2 x@@14))
))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((i_1@@2 Int) ) (! (>= (ite  (and (<= 0 i_1@@2) (< i_1@@2 10)) FullPerm NoPerm) NoPerm)
 :qid |stdinbpl.423:15|
 :skolemid |40|
 :pattern ( (MapType0Select Heap@@10 null (P (loc arr1 i_1@@2))))
 :pattern ( (MapType1Select ZeroMask null (P (loc arr1 i_1@@2))))
 :pattern ( (loc arr1 i_1@@2))
))) (=> (forall ((i_1@@3 Int) ) (! (>= (ite  (and (<= 0 i_1@@3) (< i_1@@3 10)) FullPerm NoPerm) NoPerm)
 :qid |stdinbpl.423:15|
 :skolemid |40|
 :pattern ( (MapType0Select Heap@@10 null (P (loc arr1 i_1@@3))))
 :pattern ( (MapType1Select ZeroMask null (P (loc arr1 i_1@@3))))
 :pattern ( (loc arr1 i_1@@3))
)) (=> (and (and (and (forall ((x@@15 T@U) ) (!  (=> (= (type x@@15) RefType) (=> (and (< NoPerm (ite  (and (<= 0 (invRecv2 x@@15)) (< (invRecv2 x@@15) 10)) FullPerm NoPerm)) (qpRange2 x@@15)) (and (=> (< NoPerm (ite  (and (<= 0 (invRecv2 x@@15)) (< (invRecv2 x@@15) 10)) FullPerm NoPerm)) (= (loc arr1 (invRecv2 x@@15)) x@@15)) (= (U_2_real (MapType1Select QPMask@0 null (P x@@15))) (+ (U_2_real (MapType1Select ZeroMask null (P x@@15))) (ite  (and (<= 0 (invRecv2 x@@15)) (< (invRecv2 x@@15) 10)) FullPerm NoPerm))))))
 :qid |stdinbpl.429:22|
 :skolemid |41|
 :pattern ( (MapType1Select QPMask@0 null (P x@@15)))
...
))) (and (forall ((x@@16 T@U) ) (!  (=> (and (= (type x@@16) RefType) (not (and (< NoPerm (ite  (and (<= 0 (invRecv2 x@@16)) (< (invRecv2 x@@16) 10)) FullPerm NoPerm)) (qpRange2 x@@16)))) (= (U_2_real (MapType1Select QPMask@0 null (P x@@16))) (U_2_real (MapType1Select ZeroMask null (P x@@16)))))
 :qid |stdinbpl.439:22|
 :skolemid |43|
 :pattern ( (MapType1Select QPMask@0 null (P x@@16)))
)) (state Heap@@10 QPMask@0))) (and (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0)) (and (|P#trigger| Heap@@10 (P (loc arr1 0))) (= (MapType0Select Heap@@10 null (P (loc arr1 0))) EmptyFrame)))) (and (=> (= (ControlFlow 0 14) 11) anon10_Then_correct) (=> (= (ControlFlow 0 14) 13) anon10_Else_correct))))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (and (=> (= (ControlFlow 0 17) 1) anon9_Then_correct) (=> (= (ControlFlow 0 17) 14) anon9_Else_correct)))))
