...
(assert  (and (and (and (and (and (and (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type root@@5) RefType)) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |tree#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon4_correct true))
(let ((anon6_Else_correct  (=> (= (MapType0Select Heap@@11 root@@5 right) null) (=> (and (= Mask@6 Mask@4) (= (ControlFlow 0 4) 1)) anon4_correct))))
(let ((anon6_Then_correct  (=> (not (= (MapType0Select Heap@@11 root@@5 right) null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@4 root@@5 right)) (=> (HasDirectPerm Mask@4 root@@5 right) (=> (and (and (= Mask@5 (MapType1Store Mask@4 null (tree (MapType0Select Heap@@11 root@@5 right)) (real_2_U (+ (U_2_real (MapType1Select Mask@4 null (tree (MapType0Select Heap@@11 root@@5 right)))) FullPerm)))) (state Heap@@11 Mask@5)) (and (= Mask@6 Mask@5) (= (ControlFlow 0 2) 1))) anon4_correct))))))
(let ((anon2_correct  (=> (not (= root@@5 null)) (=> (and (= Mask@4 (MapType1Store Mask@3 root@@5 right (real_2_U (+ (U_2_real (MapType1Select Mask@3 root@@5 right)) FullPerm)))) (state Heap@@11 Mask@4)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@4 root@@5 right)) (=> (HasDirectPerm Mask@4 root@@5 right) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))))))
(let ((anon5_Else_correct  (=> (= (MapType0Select Heap@@11 root@@5 left) null) (=> (and (= Mask@3 Mask@1) (= (ControlFlow 0 9) 5)) anon2_correct))))
(let ((anon5_Then_correct  (=> (not (= (MapType0Select Heap@@11 root@@5 left) null)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm Mask@1 root@@5 left)) (=> (HasDirectPerm Mask@1 root@@5 left) (=> (and (and (= Mask@2 (MapType1Store Mask@1 null (tree (MapType0Select Heap@@11 root@@5 left)) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (tree (MapType0Select Heap@@11 root@@5 left)))) FullPerm)))) (state Heap@@11 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 7) 5))) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 root@@5 $allocated))) (and (not (= root@@5 null)) (= Mask@0 (MapType1Store ZeroMask root@@5 val (real_2_U (+ (U_2_real (MapType1Select ZeroMask root@@5 val)) FullPerm)))))) (and (and (state Heap@@11 Mask@0) (not (= root@@5 null))) (and (= Mask@1 (MapType1Store Mask@0 root@@5 left (real_2_U (+ (U_2_real (MapType1Select Mask@0 root@@5 left)) FullPerm)))) (state Heap@@11 Mask@1)))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm Mask@1 root@@5 left)) (=> (HasDirectPerm Mask@1 root@@5 left) (and (=> (= (ControlFlow 0 10) 7) anon5_Then_correct) (=> (= (ControlFlow 0 10) 9) anon5_Else_correct)))))))
