...
(let ((anon6_Then_correct  (=> (state Heap@@9 ZeroMask) (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= 1 1)) (=> (= 1 1) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 3) (- 0 2))) (= j@0 2))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 r_1 $allocated))) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))
