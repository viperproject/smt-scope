...
))) (= (type s_1) RefType)) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv1 arg0@@48)) RefType)
...
(let ((anon9_Else_correct  (=> (and (not (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) s_1))) (= (ControlFlow 0 9) 6)) anon5_correct)))
(let ((anon9_Then_correct  (=> (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) s_1)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm QPMask@0 s_1 left)) (=> (HasDirectPerm QPMask@0 s_1 left) (=> (= (ControlFlow 0 7) 6) anon5_correct))))))
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((s_2 T@U) (s_2_1 T@U) ) (!  (=> (and (= (type s_2) RefType) (= (type s_2_1) RefType)) (=> (and (and (and (and (not (= s_2 s_2_1)) (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) s_2)) (= (MapType1Select Heap@@10 s_2 left) null))) (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) s_2_1)) (= (MapType1Select Heap@@10 s_2_1 left) null))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= s_2 s_2_1))))
 :qid |stdinbpl.538:15|
 :skolemid |97|
 :no-pattern (type s_2)
 :no-pattern (type s_2_1)
 :no-pattern (U_2_int s_2)
 :no-pattern (U_2_bool s_2)
 :no-pattern (U_2_int s_2_1)
 :no-pattern (U_2_bool s_2_1)
))) (=> (forall ((s_2@@0 T@U) (s_2_1@@0 T@U) ) (!  (=> (and (= (type s_2@@0) RefType) (= (type s_2_1@@0) RefType)) (=> (and (and (and (and (not (= s_2@@0 s_2_1@@0)) (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) s_2@@0)) (= (MapType1Select Heap@@10 s_2@@0 left) null))) (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) s_2_1@@0)) (= (MapType1Select Heap@@10 s_2_1@@0 left) null))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= s_2@@0 s_2_1@@0))))
 :qid |stdinbpl.538:15|
 :skolemid |97|
 :no-pattern (type s_2@@0)
 :no-pattern (type s_2_1@@0)
 :no-pattern (U_2_int s_2@@0)
 :no-pattern (U_2_bool s_2@@0)
 :no-pattern (U_2_int s_2_1@@0)
 :no-pattern (U_2_bool s_2_1@@0)
)) (=> (forall ((s_2@@1 T@U) ) (!  (=> (= (type s_2@@1) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) s_2@@1)) (= (MapType1Select Heap@@10 s_2@@1 left) null)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange2 s_2@@1) (= (invRecv2 s_2@@1) s_2@@1))))
 :qid |stdinbpl.544:22|
 :skolemid |98|
 :pattern ( (MapType1Select Heap@@10 s_2@@1 left))
 :pattern ( (MapType2Select QPMask@1 s_2@@1 left))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 this@@7 all) s_2@@1))
...
)) (= (ControlFlow 0 4) (- 0 3))) (forall ((s_2@@2 T@U) ) (!  (=> (= (type s_2@@2) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 all) s_2@@2)) (= (MapType1Select Heap@@10 s_2@@2 left) null)) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.554:15|
 :skolemid |100|
 :pattern ( (MapType1Select Heap@@10 s_2@@2 left))
 :pattern ( (MapType2Select QPMask@1 s_2@@2 left))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 this@@7 all) s_2@@2))
))))))))
