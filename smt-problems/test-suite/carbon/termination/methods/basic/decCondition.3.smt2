...
(let ((anon5_correct  (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 8) 1)) anon9_correct)))
(let ((anon4_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (= arg_x@0 (- x@@8 2)) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 10) 8))) anon5_correct))))
(let ((anon12_Else_correct  (=> (and (> 0 x@@8) (= (ControlFlow 0 13) 10)) anon4_correct)))
(let ((anon12_Then_correct  (=> (>= x@@8 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (and (decreasing (int_2_U (- x@@8 2)) (int_2_U x@@8)) (bounded (int_2_U x@@8)))) (=> (and (decreasing (int_2_U (- x@@8 2)) (int_2_U x@@8)) (bounded (int_2_U x@@8))) (=> (= (ControlFlow 0 11) 10) anon4_correct))))))
(let ((anon11_Then_correct  (=> (not (= x@@8 0)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (or (not (>= x@@8 0)) (>= (- x@@8 2) 0))) (=> (or (not (>= x@@8 0)) (>= (- x@@8 2) 0)) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 14) 11) anon12_Then_correct) (=> (= (ControlFlow 0 14) 13) anon12_Else_correct))))))))
(let ((anon11_Else_correct  (=> (and (= x@@8 0) (= (ControlFlow 0 9) 8)) anon5_correct)))
(let ((anon10_Then_correct  (=> (>= x@@8 0) (and (=> (= (ControlFlow 0 16) 14) anon11_Then_correct) (=> (= (ControlFlow 0 16) 9) anon11_Else_correct)))))
(let ((anon8_correct  (=> (and (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) 1))) anon9_correct)))
(let ((anon13_Else_correct  (=> (and (> 0 x@@8) (= (ControlFlow 0 5) 2)) anon8_correct)))
(let ((anon13_Then_correct  (=> (>= x@@8 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (decreasing (int_2_U y@@1) (int_2_U x@@8)) (bounded (int_2_U x@@8)))) (=> (and (decreasing (int_2_U y@@1) (int_2_U x@@8)) (bounded (int_2_U x@@8))) (=> (= (ControlFlow 0 3) 2) anon8_correct))))))
(let ((anon10_Else_correct  (=> (> 0 x@@8) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (not (>= x@@8 0)) (>= y@@1 0))) (=> (or (not (>= x@@8 0)) (>= y@@1 0)) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 6) 3) anon13_Then_correct) (=> (= (ControlFlow 0 6) 5) anon13_Else_correct))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 17) 16) anon10_Then_correct) (=> (= (ControlFlow 0 17) 6) anon10_Else_correct)))))
