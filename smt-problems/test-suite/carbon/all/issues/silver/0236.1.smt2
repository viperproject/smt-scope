...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (Option2_discr (Option2_None boolType)) 0)) (=> (= (Option2_discr (Option2_None boolType)) 0) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (Option2_discr (Option2_None boolType)) 1)))))))
