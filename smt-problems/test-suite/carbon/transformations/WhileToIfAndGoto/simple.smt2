...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon6_Else_correct  (=> (and (not (< i@0 5)) (state Heap@@9 ZeroMask)) (=> (and (and (<= i@0 5) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 5) (- 0 4)))) (= i@0 5)))))
(let ((anon6_Then_correct  (=> (and (and (and (state Heap@@9 ZeroMask) (<= i@0 5)) (and (state Heap@@9 ZeroMask) (< i@0 5))) (and (and (state Heap@@9 ZeroMask) (= i@1 (+ i@0 1))) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 3) (- 0 2))))) (<= i@1 5))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= 1 5)) (=> (<= 1 5) (and (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))))
