...
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type xs) (SeqType RefType)) (= (type y@@2) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@39 T@U) ) (! (= (type (invRecv4 arg0@@39)) RefType)
 :qid |funType:invRecv4|
 :pattern ( (invRecv4 arg0@@39))
))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type Heap@@11) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (forall ((arg0@@40 T@U) ) (! (= (type (invRecv2 arg0@@40)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@40))
))) (= (type QPMask@3) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (forall ((arg0@@41 T@U) ) (! (= (type (invRecv1 arg0@@41)) RefType)
 :qid |funType:invRecv1|
 :pattern ( (invRecv1 arg0@@41))
))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test01_1)
...
)) (=> (and (forall ((x_3@@1 T@U) ) (!  (=> (= (type x_3@@1) RefType) (=> (and (|Seq#Contains| xs x_3@@1) (< NoPerm FullPerm)) (and (= (invRecv2 y@@2) x_3@@1) (qpRange2 y@@2))))
 :qid |stdinbpl.821:22|
 :skolemid |77|
 :pattern ( (|Seq#ContainsTrigger| xs x_3@@1))
 :pattern ( (|Seq#Contains| xs x_3@@1))
)) (forall ((a_1@@11 T@U) ) (!  (=> (= (type a_1@@11) RefType) (=> (and (and (|Seq#Contains| xs (invRecv2 a_1@@11)) (< NoPerm FullPerm)) (qpRange2 a_1@@11)) (= y@@2 a_1@@11)))
 :qid |stdinbpl.825:22|
 :skolemid |78|
 :pattern ( (invRecv2 a_1@@11))
))) (=> (and (and (forall ((a_1@@12 T@U) ) (!  (=> (= (type a_1@@12) RefType) (=> (and (and (|Seq#Contains| xs (invRecv2 a_1@@12)) (< NoPerm FullPerm)) (qpRange2 a_1@@12)) (and (=> (< NoPerm FullPerm) (= y@@2 a_1@@12)) (= (U_2_real (MapType1Select QPMask@3 null (pred1 a_1@@12))) (+ (U_2_real (MapType1Select ZeroMask null (pred1 a_1@@12))) FullPerm)))))
 :qid |stdinbpl.831:22|
 :skolemid |79|
 :pattern ( (MapType1Select QPMask@3 null (pred1 a_1@@12)))
...
))) (and (forall ((a_1@@13 T@U) ) (!  (=> (and (= (type a_1@@13) RefType) (not (and (and (|Seq#Contains| xs (invRecv2 a_1@@13)) (< NoPerm FullPerm)) (qpRange2 a_1@@13)))) (= (U_2_real (MapType1Select QPMask@3 null (pred1 a_1@@13))) (U_2_real (MapType1Select ZeroMask null (pred1 a_1@@13)))))
 :qid |stdinbpl.841:22|
 :skolemid |81|
 :pattern ( (MapType1Select QPMask@3 null (pred1 a_1@@13)))
...
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((x_7 T@U) (x_7_1 T@U) ) (!  (=> (and (= (type x_7) RefType) (= (type x_7_1) RefType)) (=> (and (and (and (and (not (= x_7 x_7_1)) (|Seq#Contains| xs x_7)) (|Seq#Contains| xs x_7_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y@@2 y@@2))))
 :qid |stdinbpl.901:17|
 :skolemid |88|
 :pattern ( (neverTriggered4 x_7) (neverTriggered4 x_7_1))
 ...
 :qid |stdinbpl.901:17|
 :skolemid |88|
 :pattern ( (neverTriggered4 x_7@@0) (neverTriggered4 x_7_1@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((x_7@@1 T@U) ) (!  (=> (and (= (type x_7@@1) RefType) (|Seq#Contains| xs x_7@@1)) (>= (U_2_real (MapType1Select QPMask@0 null (pred1 y@@2))) FullPerm))
 :qid |stdinbpl.908:17|
 :skolemid |89|
 :pattern ( (|Seq#ContainsTrigger| xs x_7@@1))
 :pattern ( (|Seq#Contains| xs x_7@@1))
))) (=> (forall ((x_7@@2 T@U) ) (!  (=> (and (= (type x_7@@2) RefType) (|Seq#Contains| xs x_7@@2)) (>= (U_2_real (MapType1Select QPMask@0 null (pred1 y@@2))) FullPerm))
 :qid |stdinbpl.908:17|
 :skolemid |89|
 :pattern ( (|Seq#ContainsTrigger| xs x_7@@2))
 :pattern ( (|Seq#Contains| xs x_7@@2))
)) (=> (forall ((x_7@@3 T@U) ) (!  (=> (= (type x_7@@3) RefType) (=> (and (|Seq#Contains| xs x_7@@3) (< NoPerm FullPerm)) (and (= (invRecv4 y@@2) x_7@@3) (qpRange4 y@@2))))
 :qid |stdinbpl.914:22|
 :skolemid |90|
 :pattern ( (|Seq#ContainsTrigger| xs x_7@@3))
 :pattern ( (|Seq#Contains| xs x_7@@3))
)) (=> (and (and (forall ((a_1_1 T@U) ) (!  (=> (= (type a_1_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv4 a_1_1)) (< NoPerm FullPerm)) (qpRange4 a_1_1)) (= y@@2 a_1_1)))
 :qid |stdinbpl.918:22|
 :skolemid |91|
 :pattern ( (invRecv4 a_1_1))
)) (forall ((a_1_1@@0 T@U) ) (!  (=> (= (type a_1_1@@0) RefType) (=> (and (and (|Seq#Contains| xs (invRecv4 a_1_1@@0)) (< NoPerm FullPerm)) (qpRange4 a_1_1@@0)) (and (= y@@2 a_1_1@@0) (= (U_2_real (MapType1Select QPMask@1 null (pred1 a_1_1@@0))) (- (U_2_real (MapType1Select QPMask@0 null (pred1 a_1_1@@0))) FullPerm)))))
 :qid |stdinbpl.924:22|
 :skolemid |92|
 :pattern ( (MapType1Select QPMask@1 null (pred1 a_1_1@@0)))
))) (and (forall ((a_1_1@@1 T@U) ) (!  (=> (and (= (type a_1_1@@1) RefType) (not (and (and (|Seq#Contains| xs (invRecv4 a_1_1@@1)) (< NoPerm FullPerm)) (qpRange4 a_1_1@@1)))) (= (U_2_real (MapType1Select QPMask@1 null (pred1 a_1_1@@1))) (U_2_real (MapType1Select QPMask@0 null (pred1 a_1_1@@1)))))
 :qid |stdinbpl.928:22|
 :skolemid |93|
 :pattern ( (MapType1Select QPMask@1 null (pred1 a_1_1@@1)))
...
)) (=> (and (forall ((o_3@@1 T@U) ) (!  (=> (= (type o_3@@1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv1 o_3@@1)) (< NoPerm FullPerm)) (qpRange1 o_3@@1)) (= (invRecv1 o_3@@1) o_3@@1)))
 :qid |stdinbpl.772:22|
 :skolemid |72|
 :pattern ( (invRecv1 o_3@@1))
...
))) (=> (and (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (and (=> (and (and (|Seq#Contains| xs (invRecv1 o_3@@2)) (< NoPerm FullPerm)) (qpRange1 o_3@@2)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@2) o_3@@2)) (= (U_2_real (MapType1Select QPMask@0 o_3@@2 f_7)) (+ (U_2_real (MapType1Select Mask@0 o_3@@2 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| xs (invRecv1 o_3@@2)) (< NoPerm FullPerm)) (qpRange1 o_3@@2))) (= (U_2_real (MapType1Select QPMask@0 o_3@@2 f_7)) (U_2_real (MapType1Select Mask@0 o_3@@2 f_7))))))
 :qid |stdinbpl.784:22|
 :skolemid |74|
