...
(assert  (and (and (and (and (and (= (type AssertMask@0) (MapType1Type RefType realType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type x@@19) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type xs) (MapType2Type RefType boolType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv1 arg0@@43)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon4_correct  (=> (= AssertMask@0 (MapType1Store QPMask@0 x@@19 f_7 (real_2_U (- (U_2_real (MapType1Select QPMask@0 x@@19 f_7)) FullPerm)))) (=> (and (state Heap@@9 QPMask@0) (= (ControlFlow 0 3) (- 0 2))) (= FullPerm (U_2_real (MapType1Select QPMask@0 x@@19 f_7)))))))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 x@@19 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 x@@19 f_7))) (=> (= (ControlFlow 0 4) 3) anon4_correct))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((y_1 T@U) (y_1_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (= (type y_1_1) RefType)) (=> (and (and (and (and (not (= y_1 y_1_1)) (U_2_bool (MapType2Select xs y_1))) (U_2_bool (MapType2Select xs y_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_1 y_1_1))))
 :qid |stdinbpl.420:15|
 :skolemid |82|
 :no-pattern (type y_1)
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (and (not (= x@@19 null)) (state Heap@@9 QPMask@0)) (and (U_2_bool (MapType2Select xs x@@19)) (state Heap@@9 QPMask@0)))) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@19 $allocated))) (and (=> (= (ControlFlow 0 9) 1) anon5_Then_correct) (=> (= (ControlFlow 0 9) 7) anon5_Else_correct)))))
