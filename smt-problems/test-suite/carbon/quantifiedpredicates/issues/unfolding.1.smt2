...
(assert  (and (= (Ctor PredicateType_p2Type) 13) (forall ((arg0@@30 T@U) ) (! (= (type (p2 arg0@@30)) (FieldType PredicateType_p2Type FrameTypeType))
 :qid |funType:p2|
 :pattern ( (p2 arg0@@30))
))))
(assert (forall ((r_2 T@U) ) (!  (=> (= (type r_2) RefType) (IsPredicateField (p2 r_2)))
 :qid |stdinbpl.400:15|
 :skolemid |83|
 :pattern ( (p2 r_2))
)))
(assert (forall ((Heap@@2 T@U) (r_2@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type r_2@@0) RefType)) (|p2#everUsed| (p2 r_2@@0)))
 :qid |stdinbpl.419:15|
 :skolemid |87|
 :pattern ( (|p2#trigger| Heap@@2 (p2 r_2@@0)))
)))
...
(assert (forall ((r_2@@1 T@U) (r2 T@U) ) (!  (=> (and (and (= (type r_2@@1) RefType) (= (type r2) RefType)) (= (p2 r_2@@1) (p2 r2))) (= r_2@@1 r2))
 :qid |stdinbpl.410:15|
 :skolemid |85|
 :pattern ( (p2 r_2@@1) (p2 r2))
)))
...
(assert (forall ((r_2@@2 T@U) (r2@@0 T@U) ) (!  (=> (and (and (= (type r_2@@2) RefType) (= (type r2@@0) RefType)) (= (|p2#sm| r_2@@2) (|p2#sm| r2@@0))) (= r_2@@2 r2@@0))
 :qid |stdinbpl.414:15|
 :skolemid |86|
 :pattern ( (|p2#sm| r_2@@2) (|p2#sm| r2@@0))
)))
...
(assert (forall ((r_2@@3 T@U) ) (!  (=> (= (type r_2@@3) RefType) (= (getPredWandId (p2 r_2@@3)) 0))
 :qid |stdinbpl.404:15|
 :skolemid |84|
 :pattern ( (p2 r_2@@3))
)))
...
(assert (forall ((r_2@@4 T@U) ) (!  (=> (= (type r_2@@4) RefType) (= (PredicateMaskField (p2 r_2@@4)) (|p2#sm| r_2@@4)))
 :qid |stdinbpl.396:15|
 :skolemid |82|
 :pattern ( (PredicateMaskField (p2 r_2@@4)))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (= (type xs) (MapType2Type RefType boolType)) (= (type r_3) RefType)) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@3) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (forall ((arg0@@45 T@U) ) (! (= (type (FrameFragment arg0@@45)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@45))
))) (= (type r_5) RefType)) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (forall ((arg0@@46 T@U) ) (! (= (type (invRecv1 arg0@@46)) RefType)
...
(let ((anon12_correct  (=> (and (= UnfoldingMask@0 (MapType1Store QPMask@0 null (p2 r_5) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (p2 r_5))) FullPerm)))) (not (= r_5 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 r_5 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 r_5 f_7)) FullPerm)))) (state Heap@@10 UnfoldingMask@1)) (and (= (U_2_int (MapType0Select Heap@@10 r_5 f_7)) 5) (state Heap@@10 UnfoldingMask@1))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (= (U_2_int (MapType0Select Heap@@10 r_5 f_7)) 5)) (=> (= (U_2_int (MapType0Select Heap@@10 r_5 f_7)) 5) (=> (= (ControlFlow 0 13) 11) anon13_correct)))))))
...
(let ((anon20_Then_correct  (=> (U_2_bool (MapType2Select xs r_5)) (=> (and (|p2#trigger| Heap@@10 (p2 r_5)) (= (MapType0Select Heap@@10 null (p2 r_5)) (FrameFragment (MapType0Select Heap@@10 r_5 f_7)))) (and (=> (= (ControlFlow 0 18) 15) anon21_Then_correct) (=> (= (ControlFlow 0 18) 17) anon21_Else_correct))))))
(let ((anon20_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs r_5))) (= (ControlFlow 0 12) 11)) anon13_correct)))
(let ((anon7_correct true))
(let ((anon6_correct  (=> (and (= UnfoldingMask@2 (MapType1Store QPMask@0 null (p2 r_3) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (p2 r_3))) FullPerm)))) (not (= r_3 null))) (=> (and (and (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 r_3 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 r_3 f_7)) FullPerm)))) (state Heap@@10 UnfoldingMask@3)) (and (= (U_2_int (MapType0Select Heap@@10 r_3 f_7)) 5) (state Heap@@10 UnfoldingMask@3))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm UnfoldingMask@3 r_3 f_7)) (=> (HasDirectPerm UnfoldingMask@3 r_3 f_7) (=> (= Heap@0 (MapType0Store Heap@@10 null (|p2#sm| r_3) (MapType1Store (MapType0Select Heap@@10 null (|p2#sm| r_3)) r_3 f_7 (bool_2_U true)))) (=> (and (state Heap@0 QPMask@0) (= (ControlFlow 0 5) 3)) anon7_correct))))))))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 5)) anon6_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p2 r_3))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p2 r_3)))) (=> (= (ControlFlow 0 7) 5) anon6_correct))))))
(let ((anon17_Then_correct  (=> (U_2_bool (MapType2Select xs r_3)) (=> (and (|p2#trigger| Heap@@10 (p2 r_3)) (= (MapType0Select Heap@@10 null (p2 r_3)) (FrameFragment (MapType0Select Heap@@10 r_3 f_7)))) (and (=> (= (ControlFlow 0 10) 7) anon18_Then_correct) (=> (= (ControlFlow 0 10) 9) anon18_Else_correct))))))
(let ((anon17_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs r_3))) (= (ControlFlow 0 4) 3)) anon7_correct)))
...
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (U_2_bool (MapType2Select xs r_1))) (U_2_bool (MapType2Select xs r_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1 r_1_1))))
 ...
 :qid |stdinbpl.492:22|
 :skolemid |89|
 :pattern ( (MapType0Select Heap@@10 null (p2 r_1@@1)))
...
)) (forall ((r_2_1@@0 T@U) ) (!  (=> (= (type r_2_1@@0) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv1 r_2_1@@0))) (< NoPerm FullPerm)) (qpRange1 r_2_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 r_2_1@@0) r_2_1@@0)) (= (U_2_real (MapType1Select QPMask@0 null (p2 r_2_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (p2 r_2_1@@0))) FullPerm)))))
 :qid |stdinbpl.502:22|
 :skolemid |91|
...
)) (forall ((r_2_1@@1 T@U) ) (!  (=> (and (= (type r_2_1@@1) RefType) (not (and (and (U_2_bool (MapType2Select xs (invRecv1 r_2_1@@1))) (< NoPerm FullPerm)) (qpRange1 r_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (p2 r_2_1@@1))) (U_2_real (MapType1Select ZeroMask null (p2 r_2_1@@1)))))
 :qid |stdinbpl.512:22|
 :skolemid |93|
 :pattern ( (MapType1Select QPMask@0 null (p2 r_2_1@@1)))
))) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0))) (and (and (and (and (=> (= (ControlFlow 0 19) 2) anon19_Else_correct) (=> (= (ControlFlow 0 19) 18) anon20_Then_correct)) (=> (= (ControlFlow 0 19) 12) anon20_Else_correct)) (=> (= (ControlFlow 0 19) 10) anon17_Then_correct)) (=> (= (ControlFlow 0 19) 4) anon17_Else_correct)))))))))
(let ((anon15_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x@@19 $allocated))) (and (U_2_bool (MapType2Select xs x@@19)) (state Heap@@10 ZeroMask))) (and (=> (= (ControlFlow 0 21) 1) anon15_Then_correct) (=> (= (ControlFlow 0 21) 19) anon15_Else_correct)))))
