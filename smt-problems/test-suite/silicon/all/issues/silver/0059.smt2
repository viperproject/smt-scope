(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:00:20
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/issues/silver/0059.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (exists ((j@3@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0059.vpr@5@13@5@45-aux|)))
(assert (exists ((j@3@01 Int)) (!
  (or (Seq_contains a@1@01 j@3@01) (not (Seq_contains a@1@01 j@3@01)))
  :pattern ((Seq_contains_trigger a@1@01 j@3@01))
  :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0059.vpr@5@13@5@45-aux|)))
(assert (exists ((j@3@01 Int)) (!
  ...
  :pattern ((Seq_contains a@1@01 j@3@01))
  :pattern ((Seq_contains_trigger a@1@01 j@3@01))
  :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0059.vpr@5@13@5@45|)))
(assert (=
  ($Snap.second $t@2@01)
  ($Snap.combine
...
(assert (exists ((j@4@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0059.vpr@6@13@6@63-aux|)))
(assert (exists ((j@4@01 Int)) (!
  (and
    (<= 0 j@4@01)
    (and (< j@4@01 (Seq_length a@1@01)) (> (Seq_index a@1@01 j@4@01) 0)))
  :pattern ((Seq_index a@1@01 j@4@01))
  :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0059.vpr@6@13@6@63|)))
...
(assert (exists ((k@6@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0059.vpr@7@42@7@74-aux|)))
(assert (exists ((k@6@01 Int)) (!
  (or (Seq_contains a@1@01 k@6@01) (not (Seq_contains a@1@01 k@6@01)))
  :pattern ((Seq_contains_trigger a@1@01 k@6@01))
  :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0059.vpr@7@42@7@74-aux|)))
...
(assert (forall ((j@5@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0059.vpr@7@13@7@75-aux|)))
(assert (forall ((j@5@01 Int)) (!
  (and
    (=>
      (Seq_contains a@1@01 j@5@01)
...
(assert (forall ((j@5@01 Int)) (!
  (=>
    ...
    (exists ((k@6@01 Int)) (!
      ...
      :pattern ((Seq_contains a@1@01 k@6@01))
      :pattern ((Seq_contains_trigger a@1@01 k@6@01))
      :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0059.vpr@7@42@7@74|)))
  :pattern ((Seq_contains a@1@01 j@5@01))
  :pattern ((Seq_contains_trigger a@1@01 j@5@01))
  :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0059.vpr@7@13@7@75|)))
...
(assert (exists ((j@7@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0059.vpr@9@11@9@43-aux|)))
(assert (exists ((j@7@01 Int)) (!
  (or (Seq_contains a@1@01 j@7@01) (not (Seq_contains a@1@01 j@7@01)))
  :pattern ((Seq_contains_trigger a@1@01 j@7@01))
  :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0059.vpr@9@11@9@43-aux|)))
...
(assert (not (exists ((j@7@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger a@1@01 j@7@01))
  :pattern ((Seq_contains_trigger a@1@01 j@7@01))
  :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0059.vpr@9@11@9@43|))))
(check-sat)
; unsat
(pop) ; 3
; 0,00s
...
(assert (exists ((j@8@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0059.vpr@10@11@10@61-aux|)))
(push) ; 3
(assert (not (exists ((j@8@01 Int)) (!
  ...
  :pattern ((Seq_index a@1@01 j@8@01))
  :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0059.vpr@10@11@10@61|))))
(check-sat)
; unsat
(pop) ; 3
; 0,00s
...
(assert (exists ((k@10@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0059.vpr@11@40@11@72-aux|)))
(assert (exists ((k@10@01 Int)) (!
  (or (Seq_contains a@1@01 k@10@01) (not (Seq_contains a@1@01 k@10@01)))
  :pattern ((Seq_contains_trigger a@1@01 k@10@01))
  :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0059.vpr@11@40@11@72-aux|)))
...
(assert (forall ((j@9@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0059.vpr@11@11@11@73-aux|)))
(assert (forall ((j@9@01 Int)) (!
  (and
    (=>
      (Seq_contains a@1@01 j@9@01)
...
(assert (not (forall ((j@9@01 Int)) (!
  (=>
    ...
    (exists ((k@10@01 Int)) (!
      ...
      :pattern ((Seq_contains a@1@01 k@10@01))
      :pattern ((Seq_contains_trigger a@1@01 k@10@01))
      :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0059.vpr@11@40@11@72|)))
  :pattern ((Seq_contains a@1@01 j@9@01))
  :pattern ((Seq_contains_trigger a@1@01 j@9@01))
  :pattern ((Seq_contains_trigger a@1@01 j@9@01))
  :qid |prog./silicon/silver/src/test/resources/all/issues/silver/0059.vpr@11@11@11@73|))))
(check-sat)
; unsat
(pop) ; 3
; 0,00s
