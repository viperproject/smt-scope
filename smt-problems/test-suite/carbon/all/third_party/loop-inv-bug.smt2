...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (and (state Heap@@9 ZeroMask) (= i n)) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (and (= res (* i n)) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))))) (= res (* n n)))))
