...
(declare-fun |matrix'| (T@U Int Int) T@U)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |matrix#triggerStateless| (Int Int) T@U)
...
(declare-fun |matrix#frame| (T@U Int Int) T@U)
...
(assert  (and (forall ((arg0@@26 T@U) (arg1@@10 Int) (arg2@@3 Int) ) (! (= (type (|matrix'| arg0@@26 arg1@@10 arg2@@3)) RefType)
 :qid |funType:matrix'|
 :pattern ( (|matrix'| arg0@@26 arg1@@10 arg2@@3))
)) (forall ((arg0@@27 Int) (arg1@@11 Int) ) (! (= (type (|matrix#triggerStateless| arg0@@27 arg1@@11)) RefType)
 :qid |funType:matrix#triggerStateless|
 :pattern ( (|matrix#triggerStateless| arg0@@27 arg1@@11))
))))
(assert (forall ((Heap@@0 T@U) (i Int) (j Int) ) (!  (=> (= (type Heap@@0) (MapType0Type RefType)) (dummyFunction (|matrix#triggerStateless| i j)))
 :qid |stdinbpl.579:15|
 :skolemid |59|
...
(assert  (and (forall ((arg0@@31 T@U) (arg1@@13 Int) (arg2@@4 Int) ) (! (= (type (|matrix#frame| arg0@@31 arg1@@13 arg2@@4)) RefType)
 :qid |funType:matrix#frame|
 :pattern ( (|matrix#frame| arg0@@31 arg1@@13 arg2@@4))
)) (= (type EmptyFrame) FrameTypeType)))
(assert (forall ((Heap@@3 T@U) (Mask@@2 T@U) (i@@0 Int) (j@@1 Int) ) (!  (=> (and (and (= (type Heap@@3) (MapType0Type RefType)) (= (type Mask@@2) (MapType1Type RefType realType))) (state Heap@@3 Mask@@2)) (= (|matrix'| Heap@@3 i@@0 j@@1) (|matrix#frame| EmptyFrame i@@0 j@@1)))
 :qid |stdinbpl.586:15|
 :skolemid |60|
 :pattern ( (state Heap@@3 Mask@@2) (|matrix'| Heap@@3 i@@0 j@@1))
)))
(assert (forall ((arg0@@32 T@U) (arg1@@14 Int) (arg2@@5 T@U) ) (! (let ((T@@3 (type arg2@@5)))
(= (type (|Seq#Update| arg0@@32 arg1@@14 arg2@@5)) (SeqType T@@3)))
 :qid |funType:Seq#Update|
 :pattern ( (|Seq#Update| arg0@@32 arg1@@14 arg2@@5))
)))
...
(assert (forall ((arg0@@36 T@U) (arg1@@17 T@U) ) (! (let ((T@@14 (SeqTypeInv0 (type arg0@@36))))
(= (type (|Seq#Append| arg0@@36 arg1@@17)) (SeqType T@@14)))
 :qid |funType:Seq#Append|
 :pattern ( (|Seq#Append| arg0@@36 arg1@@17))
)))
...
(assert (forall ((arg0@@37 Real) (arg1@@18 T@U) ) (! (= (type (ConditionalFrame arg0@@37 arg1@@18)) FrameTypeType)
 :qid |funType:ConditionalFrame|
 :pattern ( (ConditionalFrame arg0@@37 arg1@@18))
)))
...
(assert (forall ((arg0@@38 T@U) (arg1@@19 Int) (arg2@@6 Int) ) (! (= (type (matrix arg0@@38 arg1@@19 arg2@@6)) RefType)
 :qid |funType:matrix|
 :pattern ( (matrix arg0@@38 arg1@@19 arg2@@6))
)))
(assert (forall ((Heap@@7 T@U) (i@@4 Int) (j@@6 Int) ) (!  (=> (= (type Heap@@7) (MapType0Type RefType)) (and (= (matrix Heap@@7 i@@4 j@@6) (|matrix'| Heap@@7 i@@4 j@@6)) (dummyFunction (|matrix#triggerStateless| i@@4 j@@6))))
 :qid |stdinbpl.575:15|
 :skolemid |58|
 :pattern ( (matrix Heap@@7 i@@4 j@@6))
)))
...
(assert  (and (= (type xs) (SeqType RefType)) (= (type Heap@@12) (MapType0Type RefType))))
(set-info :boogie-vc-id minimal_example)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (and (and (<= 0 i_4) (< i_4 m@@8)) (and (<= (* i_4 n@@13) j_4) (< j_4 (* (+ i_4 1) n@@13))))) (= (ControlFlow 0 15) 11)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (and (<= 0 i_4) (< i_4 m@@8)) (and (<= (* i_4 n@@13) j_4) (< j_4 (* (+ i_4 1) n@@13)))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= j_4 0)) (=> (>= j_4 0) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< j_4 (|Seq#Length| xs))) (=> (< j_4 (|Seq#Length| xs)) (=> (= (ControlFlow 0 12) 11) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_3 Int) (j_3 Int) (i_3_1 Int) (j_3_1 Int) ) (!  (=> (and (and (and (and (and (not (= i_3 i_3_1)) (not (= j_3 j_3_1))) (and (and (<= 0 i_3) (< i_3 m@@8)) (and (<= (* i_3 n@@13) j_3) (< j_3 (* (+ i_3 1) n@@13))))) (and (and (<= 0 i_3_1) (< i_3_1 m@@8)) (and (<= (* i_3_1 n@@13) j_3_1) (< j_3_1 (* (+ i_3_1 1) n@@13))))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index| xs j_3) (|Seq#Index| xs j_3_1))))
 :qid |stdinbpl.664:15|
 :skolemid |62|
))) (=> (forall ((i_3@@0 Int) (j_3@@0 Int) (i_3_1@@0 Int) (j_3_1@@0 Int) ) (!  (=> (and (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (not (= j_3@@0 j_3_1@@0))) (and (and (<= 0 i_3@@0) (< i_3@@0 m@@8)) (and (<= (* i_3@@0 n@@13) j_3@@0) (< j_3@@0 (* (+ i_3@@0 1) n@@13))))) (and (and (<= 0 i_3_1@@0) (< i_3_1@@0 m@@8)) (and (<= (* i_3_1@@0 n@@13) j_3_1@@0) (< j_3_1@@0 (* (+ i_3_1@@0 1) n@@13))))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index| xs j_3@@0) (|Seq#Index| xs j_3_1@@0))))
 :qid |stdinbpl.664:15|
 :skolemid |62|
)) (=> (forall ((i_3@@1 Int) (j_3@@1 Int) ) (!  (=> (and (and (and (<= 0 i_3@@1) (< i_3@@1 m@@8)) (and (<= (* i_3@@1 n@@13) j_3@@1) (< j_3@@1 (* (+ i_3@@1 1) n@@13)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (and (qpRange2 (|Seq#Index| xs j_3@@1)) (= (invRecv1 (|Seq#Index| xs j_3@@1)) i_3@@1)) (= (invRecv2 (|Seq#Index| xs j_3@@1)) j_3@@1)))
 :qid |stdinbpl.670:22|
 :skolemid |63|
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (and (<= 0 (invRecv1 o_3)) (< (invRecv1 o_3) m@@8)) (and (<= (* (invRecv1 o_3) n@@13) (invRecv2 o_3)) (< (invRecv2 o_3) (* (+ (invRecv1 o_3) 1) n@@13)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_3)) (= (|Seq#Index| xs (invRecv2 o_3)) o_3)))
 :qid |stdinbpl.674:22|
 :skolemid |64|
 :pattern ( (invRecv1 o_3) (invRecv2 o_3))
)) (= (ControlFlow 0 9) (- 0 8))) (forall ((i_3@@2 Int) (j_3@@2 Int) ) (!  (=> (and (and (<= 0 i_3@@2) (< i_3@@2 m@@8)) (and (<= (* i_3@@2 n@@13) j_3@@2) (< j_3@@2 (* (+ i_3@@2 1) n@@13)))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.680:15|
 :skolemid |65|
))))))))
(let ((anon9_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (>= i_1 0) (and (< i_1 (|Seq#Length| xs)) (and (>= j_1 0) (and (< j_1 (|Seq#Length| xs)) (not (= i_1 j_1)))))) (not (= (|Seq#Index| xs i_1) (|Seq#Index| xs j_1))))
 :qid |stdinbpl.646:20|
 :skolemid |61|
 :pattern ( (|Seq#Index| xs i_1) (|Seq#Index| xs j_1))
)) (state Heap@@12 ZeroMask)) (and (and (=> (= (ControlFlow 0 16) 9) anon11_Else_correct) (=> (= (ControlFlow 0 16) 12) anon12_Then_correct)) (=> (= (ControlFlow 0 16) 15) anon12_Else_correct)))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (and (>= i_2 0) (and (< i_2 (|Seq#Length| xs)) (and (>= j_2 0) (and (< j_2 (|Seq#Length| xs)) (not (= i_2 j_2))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (>= i_2 0) (and (< i_2 (|Seq#Length| xs)) (and (>= j_2 0) (and (< j_2 (|Seq#Length| xs)) (not (= i_2 j_2)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_2 (|Seq#Length| xs))) (=> (< i_2 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_2 0)) (=> (>= j_2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_2 (|Seq#Length| xs))) (=> (< j_2 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@12 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (= (* m@@8 n@@13) (|Seq#Length| xs)) (state Heap@@12 ZeroMask))) (and (and (=> (= (ControlFlow 0 17) 16) anon9_Else_correct) (=> (= (ControlFlow 0 17) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 17) 7) anon10_Else_correct)))))
