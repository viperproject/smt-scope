...
(assert  (and (= (type Heap@@18) (MapType0Type RefType)) (= (type x@@18) RefType)))
(set-info :boogie-vc-id test03)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon11_correct true))
(let ((anon18_Else_correct  (=> (not b_2@@9) (and (=> (= (ControlFlow 0 10) (- 0 11)) (> (fun1 Heap@@18 j_1) 1)) (=> (> (fun1 Heap@@18 j_1) 1) (=> (= (ControlFlow 0 10) 7) anon11_correct))))))
(let ((anon18_Then_correct  (=> b_2@@9 (and (=> (= (ControlFlow 0 8) (- 0 9)) (> (fun1 Heap@@18 j_1) 0)) (=> (> (fun1 Heap@@18 j_1) 0) (=> (= (ControlFlow 0 8) 7) anon11_correct))))))
(let ((anon15_Then_correct true))
(let ((anon6_correct true))
(let ((anon14_Then_correct  (=> b_2@@9 (and (=> (= (ControlFlow 0 6) 5) anon15_Then_correct) (=> (= (ControlFlow 0 6) 3) anon6_correct)))))
(let ((anon16_Then_correct true))
(let ((anon14_Else_correct  (=> (not b_2@@9) (and (=> (= (ControlFlow 0 4) 2) anon16_Then_correct) (=> (= (ControlFlow 0 4) 3) anon6_correct)))))
(let ((anon17_Else_correct true))
(let ((anon0_correct  (=> (state Heap@@18 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@18 x@@18 $allocated))) (and (and (and (and (=> (= (ControlFlow 0 12) 1) anon17_Else_correct) (=> (= (ControlFlow 0 12) 8) anon18_Then_correct)) (=> (= (ControlFlow 0 12) 10) anon18_Else_correct)) (=> (= (ControlFlow 0 12) 6) anon14_Then_correct)) (=> (= (ControlFlow 0 12) 4) anon14_Else_correct))))))
