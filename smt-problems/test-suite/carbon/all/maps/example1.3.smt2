...
(assert  (and (and (and (= (type Heap@@9) (MapType1Type RefType)) (= (type m@0) (MapType intType boolType))) (= (type d@0) (MapType0Type intType boolType))) (= (type r_1@0) (MapType0Type boolType boolType))))
(set-info :boogie-vc-id test1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= m@0 (|Map#Empty| intType boolType)) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (|Map#Card| (|Map#Empty| intType boolType)) 0)) (=> (= (|Map#Card| (|Map#Empty| intType boolType)) 0) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (|Map#Card| m@0) 0)) (=> (= (|Map#Card| m@0) 0) (=> (state Heap@@9 ZeroMask) (=> (and (= d@0 (|Map#Domain| m@0)) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Equal| d@0 (|Set#Empty| intType))) (=> (|Set#Equal| d@0 (|Set#Empty| intType)) (=> (and (and (state Heap@@9 ZeroMask) (= r_1@0 (|Map#Values| m@0))) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (= (|Set#Card| (|Map#Values| m@0)) 0)))))))))))))))
