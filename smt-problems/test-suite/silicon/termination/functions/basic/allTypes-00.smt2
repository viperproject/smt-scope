...
(assert (and
  ...
  (PI_list%precondition $t@34@01 xs@33@01)))
...
(assert (and
  ...
  (PI_list%precondition ($Snap.second $t@34@01) ($SortWrappers.$SnapTo$Ref ($Snap.first $t@34@01)))))
...
(assert (and
  ...
  (PI_list%precondition $t@52@01 xs@51@01)))
...
(assert (and
  ...
  (PI_list%precondition ($Snap.second $t@52@01) ($SortWrappers.$SnapTo$Ref ($Snap.first $t@52@01)))))
...
; Joined path conditions
(assert ($Perm.isReadVar $k@63@01))
(assert (and (< $k@63@01 $Perm.Write) (<= $Perm.No (- $Perm.Write $k@63@01))))
(set-option :timeout 0)
(push) ; 5
