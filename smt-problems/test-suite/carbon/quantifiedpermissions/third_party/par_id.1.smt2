...
(assert  (and (and (and (and (and (and (and (and (and (= (type ar) (SeqType RefType)) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type QPMask@3) (MapType1Type RefType realType))) (= (type QPMask@4) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type this) RefType)))
(set-info :boogie-vc-id par_id)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 53) (let ((anon16_correct true))
(let ((anon35_Else_correct  (=> (and (not (and (<= 0 i_16) (< i_16 len))) (= (ControlFlow 0 45) 37)) anon16_correct)))
(let ((anon35_Then_correct  (=> (and (<= 0 i_16) (< i_16 len)) (and (=> (= (ControlFlow 0 38) (- 0 44)) (>= i_16 0)) (=> (>= i_16 0) (and (=> (= (ControlFlow 0 38) (- 0 43)) (< i_16 (|Seq#Length| ar))) (=> (< i_16 (|Seq#Length| ar)) (and (=> (= (ControlFlow 0 38) (- 0 42)) (HasDirectPerm QPMask@4 (|Seq#Index| ar i_16) Integer_value)) (=> (HasDirectPerm QPMask@4 (|Seq#Index| ar i_16) Integer_value) (and (=> (= (ControlFlow 0 38) (- 0 41)) (>= i_16 0)) (=> (>= i_16 0) (and (=> (= (ControlFlow 0 38) (- 0 40)) (< i_16 (|Seq#Length| ar))) (=> (< i_16 (|Seq#Length| ar)) (and (=> (= (ControlFlow 0 38) (- 0 39)) (HasDirectPerm QPMask@0 (|Seq#Index| ar i_16) Integer_value)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| ar i_16) Integer_value) (=> (= (ControlFlow 0 38) 37) anon16_correct))))))))))))))))
(let ((anon34_Else_correct true))
(let ((anon32_Else_correct  (and (=> (= (ControlFlow 0 46) (- 0 47)) (forall ((i_5 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5 i_5_1)) (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_5))) (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ar i_5) (|Seq#Index| ar i_5_1))))
 :qid |stdinbpl.1092:15|
 :skolemid |86|
))) (=> (forall ((i_5@@0 Int) (i_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_5@@0 i_5_1@@0)) (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_5@@0))) (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_5_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ar i_5@@0) (|Seq#Index| ar i_5_1@@0))))
 :qid |stdinbpl.1092:15|
 :skolemid |86|
)) (=> (forall ((i_5@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_5@@1)) (< NoPerm FullPerm)) (and (qpRange5 (|Seq#Index| ar i_5@@1)) (= (invRecv5 (|Seq#Index| ar i_5@@1)) i_5@@1)))
 :qid |stdinbpl.1098:22|
 :skolemid |87|
 :pattern ( (|Seq#Index| ar i_5@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 len) (int_2_U i_5@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_5@@1)))
 :pattern ( (|Seq#Index| ar i_5@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U (invRecv5 o_3))) (< NoPerm FullPerm)) (qpRange5 o_3)) (= (|Seq#Index| ar (invRecv5 o_3)) o_3)))
 :qid |stdinbpl.1102:22|
 :skolemid |88|
 :pattern ( (invRecv5 o_3))
)) (forall ((i_5@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_5@@2)) (not (= (|Seq#Index| ar i_5@@2) null)))
 :qid |stdinbpl.1108:22|
 :skolemid |89|
 :pattern ( (|Seq#Index| ar i_5@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 len) (int_2_U i_5@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_5@@2)))
 :pattern ( (|Seq#Index| ar i_5@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U (invRecv5 o_3@@0))) (< NoPerm FullPerm)) (qpRange5 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| ar (invRecv5 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@4 o_3@@0 Integer_value)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 Integer_value)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U (invRecv5 o_3@@0))) (< NoPerm FullPerm)) (qpRange5 o_3@@0))) (= (U_2_real (MapType1Select QPMask@4 o_3@@0 Integer_value)) (U_2_real (MapType1Select ZeroMask o_3@@0 Integer_value))))))
 :qid |stdinbpl.1114:22|
 :skolemid |90|
 :pattern ( (MapType1Select QPMask@4 o_3@@0 Integer_value))
)) (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 Integer_value))) (= (U_2_real (MapType1Select ZeroMask o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@4 o_3@@1 f_5))))))
 :qid |stdinbpl.1118:29|
 :skolemid |91|
...
(let ((anon33_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_15))) (= (ControlFlow 0 35) 31)) anon12_correct)))
(let ((anon33_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_15)) (and (=> (= (ControlFlow 0 32) (- 0 34)) (>= i_15 0)) (=> (>= i_15 0) (and (=> (= (ControlFlow 0 32) (- 0 33)) (< i_15 (|Seq#Length| ar))) (=> (< i_15 (|Seq#Length| ar)) (=> (= (ControlFlow 0 32) 31) anon12_correct))))))))
(let ((anon31_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (= (|Seq#Length| ar) len) (state PostHeap@0 ZeroMask)) (and (and (=> (= (ControlFlow 0 48) 46) anon32_Else_correct) (=> (= (ControlFlow 0 48) 32) anon33_Then_correct)) (=> (= (ControlFlow 0 48) 35) anon33_Else_correct))))))
(let ((anon25_correct true))
(let ((anon39_Else_correct  (=> (and (not (and (<= 0 i_9) (< i_9 len))) (= (ControlFlow 0 21) 18)) anon25_correct)))
(let ((anon39_Then_correct  (=> (and (<= 0 i_9) (< i_9 len)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (= (U_2_int (MapType0Select ExhaleHeap@0 (|Seq#Index| ar i_9) Integer_value)) (U_2_int (MapType0Select Heap@@9 (|Seq#Index| ar i_9) Integer_value)))) (=> (= (U_2_int (MapType0Select ExhaleHeap@0 (|Seq#Index| ar i_9) Integer_value)) (U_2_int (MapType0Select Heap@@9 (|Seq#Index| ar i_9) Integer_value))) (=> (= (ControlFlow 0 19) 18) anon25_correct))))))
(let ((anon38_Else_correct true))
(let ((anon36_Else_correct  (=> (forall ((i_12_1 Int) (j_3_1 Int) ) (!  (=> (and (<= 0 i_12_1) (and (< i_12_1 (|Seq#Length| ar)) (and (<= 0 j_3_1) (and (< j_3_1 (|Seq#Length| ar)) (not (= i_12_1 j_3_1)))))) (not (= (|Seq#Index| ar i_12_1) (|Seq#Index| ar j_3_1))))
 :qid |stdinbpl.1169:22|
 :skolemid |93|
 :pattern ( (|Seq#Index| ar i_12_1) (|Seq#Index| ar j_3_1))
)) (and (=> (= (ControlFlow 0 22) (- 0 28)) (forall ((i_13 Int) (i_13_1 Int) ) (!  (=> (and (and (and (and (not (= i_13 i_13_1)) (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_13))) (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_13_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ar i_13) (|Seq#Index| ar i_13_1))))
 :qid |stdinbpl.1180:19|
 :skolemid |94|
 :pattern ( (neverTriggered7 i_13) (neverTriggered7 i_13_1))
 ...
 :qid |stdinbpl.1180:19|
 :skolemid |94|
 :pattern ( (neverTriggered7 i_13@@0) (neverTriggered7 i_13_1@@0))
)) (and (=> (= (ControlFlow 0 22) (- 0 27)) (forall ((i_13@@1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_13@@1)) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| ar i_13@@1) Integer_value)) FullPerm))
 ...
 :pattern ( (|Seq#Index| ar i_13@@1))
))) (=> (forall ((i_13@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_13@@2)) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| ar i_13@@2) Integer_value)) FullPerm))
 :qid |stdinbpl.1187:19|
 :skolemid |95|
 ...
 :pattern ( (|Seq#Index| ar i_13@@2))
)) (=> (and (forall ((i_13@@3 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_13@@3)) (< NoPerm FullPerm)) (and (qpRange7 (|Seq#Index| ar i_13@@3)) (= (invRecv7 (|Seq#Index| ar i_13@@3)) i_13@@3)))
 :qid |stdinbpl.1193:24|
 :skolemid |96|
 ...
 :pattern ( (|Seq#Index| ar i_13@@3))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U (invRecv7 o_3@@2))) (and (< NoPerm FullPerm) (qpRange7 o_3@@2))) (= (|Seq#Index| ar (invRecv7 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.1197:24|
 :skolemid |97|
 :pattern ( (invRecv7 o_3@@2))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U (invRecv7 o_3@@3))) (and (< NoPerm FullPerm) (qpRange7 o_3@@3))) (and (= (|Seq#Index| ar (invRecv7 o_3@@3)) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 Integer_value)) (- (U_2_real (MapType1Select QPMask@0 o_3@@3 Integer_value)) FullPerm)))) (=> (not (and (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U (invRecv7 o_3@@3))) (and (< NoPerm FullPerm) (qpRange7 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 Integer_value)) (U_2_real (MapType1Select QPMask@0 o_3@@3 Integer_value))))))
 :qid |stdinbpl.1203:24|
 :skolemid |98|
 :pattern ( (MapType1Select QPMask@1 o_3@@3 Integer_value))
)) (forall ((o_3@@4 T@U) (f_5@@0 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_5@@0))))
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 Integer_value))) (= (U_2_real (MapType1Select QPMask@0 o_3@@4 f_5@@0)) (U_2_real (MapType1Select QPMask@1 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.1209:31|
 :skolemid |99|
 :pattern ( (MapType1Select QPMask@1 o_3@@4 f_5@@0))
))) (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 QPMask@1) (= (|Seq#Length| ar) len))) (and (=> (= (ControlFlow 0 22) (- 0 26)) (forall ((i_14 Int) (i_14_1 Int) ) (!  (=> (and (and (and (and (not (= i_14 i_14_1)) (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_14))) (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_14_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ar i_14) (|Seq#Index| ar i_14_1))))
 :qid |stdinbpl.1223:17|
 :skolemid |100|
))) (=> (forall ((i_14@@0 Int) (i_14_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_14@@0 i_14_1@@0)) (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_14@@0))) (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_14_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ar i_14@@0) (|Seq#Index| ar i_14_1@@0))))
 :qid |stdinbpl.1223:17|
 :skolemid |100|
)) (=> (forall ((i_14@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_14@@1)) (< NoPerm FullPerm)) (and (qpRange8 (|Seq#Index| ar i_14@@1)) (= (invRecv8 (|Seq#Index| ar i_14@@1)) i_14@@1)))
 :qid |stdinbpl.1229:24|
 :skolemid |101|
 :pattern ( (|Seq#Index| ar i_14@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 len) (int_2_U i_14@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_14@@1)))
 :pattern ( (|Seq#Index| ar i_14@@1))
)) (=> (and (and (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U (invRecv8 o_3@@5))) (< NoPerm FullPerm)) (qpRange8 o_3@@5)) (= (|Seq#Index| ar (invRecv8 o_3@@5)) o_3@@5)))
 :qid |stdinbpl.1233:24|
 :skolemid |102|
 :pattern ( (invRecv8 o_3@@5))
)) (forall ((i_14@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_14@@2)) (not (= (|Seq#Index| ar i_14@@2) null)))
 :qid |stdinbpl.1239:24|
 :skolemid |103|
 :pattern ( (|Seq#Index| ar i_14@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 len) (int_2_U i_14@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_14@@2)))
 :pattern ( (|Seq#Index| ar i_14@@2))
))) (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U (invRecv8 o_3@@6))) (< NoPerm FullPerm)) (qpRange8 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| ar (invRecv8 o_3@@6)) o_3@@6)) (= (U_2_real (MapType1Select QPMask@2 o_3@@6 Integer_value)) (+ (U_2_real (MapType1Select QPMask@1 o_3@@6 Integer_value)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U (invRecv8 o_3@@6))) (< NoPerm FullPerm)) (qpRange8 o_3@@6))) (= (U_2_real (MapType1Select QPMask@2 o_3@@6 Integer_value)) (U_2_real (MapType1Select QPMask@1 o_3@@6 Integer_value))))))
...
(let ((A@@14 (FieldTypeInv0 (type f_5@@1))))
 (=> (and (and (= (type o_3@@7) RefType) (= (type f_5@@1) (FieldType A@@14 B@@13))) (not (= f_5@@1 Integer_value))) (= (U_2_real (MapType1Select QPMask@1 o_3@@7 f_5@@1)) (U_2_real (MapType1Select QPMask@2 o_3@@7 f_5@@1))))))
 :qid |stdinbpl.1249:31|
 :skolemid |105|
 :pattern ( (MapType1Select QPMask@1 o_3@@7 f_5@@1))
 :pattern ( (MapType1Select QPMask@2 o_3@@7 f_5@@1))
)))) (and (and (state ExhaleHeap@0 QPMask@2) (forall ((i_15_1 Int) ) (!  (=> (and (<= 0 i_15_1) (< i_15_1 len)) (= (U_2_int (MapType0Select ExhaleHeap@0 (|Seq#Index| ar i_15_1) Integer_value)) (U_2_int (MapType0Select Heap@@9 (|Seq#Index| ar i_15_1) Integer_value))))
 :qid |stdinbpl.1255:22|
 :skolemid |106|
 :pattern ( (|Seq#Index| ar i_15_1))
))) (and (state ExhaleHeap@0 QPMask@2) (state ExhaleHeap@0 QPMask@2)))) (and (=> (= (ControlFlow 0 22) (- 0 25)) (= (|Seq#Length| ar) len)) (=> (= (|Seq#Length| ar) len) (and (=> (= (ControlFlow 0 22) (- 0 24)) (forall ((i_8 Int) (i_8_1 Int) ) (!  (=> (and (and (and (and (not (= i_8 i_8_1)) (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_8))) (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_8_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ar i_8) (|Seq#Index| ar i_8_1))))
 :qid |stdinbpl.1274:17|
 :skolemid |107|
 :pattern ( (neverTriggered6 i_8) (neverTriggered6 i_8_1))
))) (=> (forall ((i_8@@0 Int) (i_8_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_8@@0 i_8_1@@0)) (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_8@@0))) (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_8_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ar i_8@@0) (|Seq#Index| ar i_8_1@@0))))
 :qid |stdinbpl.1274:17|
 :skolemid |107|
 :pattern ( (neverTriggered6 i_8@@0) (neverTriggered6 i_8_1@@0))
)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (forall ((i_8@@1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_8@@1)) (>= (U_2_real (MapType1Select QPMask@2 (|Seq#Index| ar i_8@@1) Integer_value)) FullPerm))
 :qid |stdinbpl.1281:17|
 :skolemid |108|
 :pattern ( (|Seq#Index| ar i_8@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 len) (int_2_U i_8@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_8@@1)))
 :pattern ( (|Seq#Index| ar i_8@@1))
))) (=> (forall ((i_8@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_8@@2)) (>= (U_2_real (MapType1Select QPMask@2 (|Seq#Index| ar i_8@@2) Integer_value)) FullPerm))
 :qid |stdinbpl.1281:17|
 :skolemid |108|
 :pattern ( (|Seq#Index| ar i_8@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 len) (int_2_U i_8@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_8@@2)))
 :pattern ( (|Seq#Index| ar i_8@@2))
)) (=> (and (and (forall ((i_8@@3 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_8@@3)) (< NoPerm FullPerm)) (and (qpRange6 (|Seq#Index| ar i_8@@3)) (= (invRecv6 (|Seq#Index| ar i_8@@3)) i_8@@3)))
 :qid |stdinbpl.1287:22|
 :skolemid |109|
 :pattern ( (|Seq#Index| ar i_8@@3))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 len) (int_2_U i_8@@3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_8@@3)))
 :pattern ( (|Seq#Index| ar i_8@@3))
)) (forall ((o_3@@8 T@U) ) (!  (=> (= (type o_3@@8) RefType) (=> (and (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U (invRecv6 o_3@@8))) (and (< NoPerm FullPerm) (qpRange6 o_3@@8))) (= (|Seq#Index| ar (invRecv6 o_3@@8)) o_3@@8)))
 :qid |stdinbpl.1291:22|
 :skolemid |110|
 :pattern ( (invRecv6 o_3@@8))
))) (and (forall ((o_3@@9 T@U) ) (!  (=> (= (type o_3@@9) RefType) (and (=> (and (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U (invRecv6 o_3@@9))) (and (< NoPerm FullPerm) (qpRange6 o_3@@9))) (and (= (|Seq#Index| ar (invRecv6 o_3@@9)) o_3@@9) (= (U_2_real (MapType1Select QPMask@3 o_3@@9 Integer_value)) (- (U_2_real (MapType1Select QPMask@2 o_3@@9 Integer_value)) FullPerm)))) (=> (not (and (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U (invRecv6 o_3@@9))) (and (< NoPerm FullPerm) (qpRange6 o_3@@9)))) (= (U_2_real (MapType1Select QPMask@3 o_3@@9 Integer_value)) (U_2_real (MapType1Select QPMask@2 o_3@@9 Integer_value))))))
...
(let ((anon37_Else_correct  (=> (and (not (and (<= 0 i_11_1) (and (< i_11_1 (|Seq#Length| ar)) (and (<= 0 j_2_1) (and (< j_2_1 (|Seq#Length| ar)) (not (= i_11_1 j_2_1))))))) (= (ControlFlow 0 16) 13)) anon21_correct)))
(let ((anon37_Then_correct  (=> (and (<= 0 i_11_1) (and (< i_11_1 (|Seq#Length| ar)) (and (<= 0 j_2_1) (and (< j_2_1 (|Seq#Length| ar)) (not (= i_11_1 j_2_1)))))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (not (= (|Seq#Index| ar i_11_1) (|Seq#Index| ar j_2_1)))) (=> (not (= (|Seq#Index| ar i_11_1) (|Seq#Index| ar j_2_1))) (=> (= (ControlFlow 0 14) 13) anon21_correct))))))
(let ((anon31_Else_correct  (and (=> (= (ControlFlow 0 29) (- 0 30)) (= (|Seq#Length| ar) len)) (=> (= (|Seq#Length| ar) len) (and (and (=> (= (ControlFlow 0 29) 22) anon36_Else_correct) (=> (= (ControlFlow 0 29) 14) anon37_Then_correct)) (=> (= (ControlFlow 0 29) 16) anon37_Else_correct))))))
(let ((anon29_Else_correct  (and (=> (= (ControlFlow 0 49) (- 0 50)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_3))) (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ar i_3) (|Seq#Index| ar i_3_1))))
 ...
 :qid |stdinbpl.1033:15|
 :skolemid |80|
)) (=> (forall ((i_3@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_3@@1)) (< NoPerm FullPerm)) (and (qpRange4 (|Seq#Index| ar i_3@@1)) (= (invRecv4 (|Seq#Index| ar i_3@@1)) i_3@@1)))
 ...
 :pattern ( (|Seq#Index| ar i_3@@1))
)) (=> (and (forall ((o_3@@11 T@U) ) (!  (=> (= (type o_3@@11) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U (invRecv4 o_3@@11))) (< NoPerm FullPerm)) (qpRange4 o_3@@11)) (= (|Seq#Index| ar (invRecv4 o_3@@11)) o_3@@11)))
 ...
 :pattern ( (|Seq#Index| ar i_3@@2))
))) (=> (and (and (forall ((o_3@@12 T@U) ) (!  (=> (= (type o_3@@12) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U (invRecv4 o_3@@12))) (< NoPerm FullPerm)) (qpRange4 o_3@@12)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| ar (invRecv4 o_3@@12)) o_3@@12)) (= (U_2_real (MapType1Select QPMask@0 o_3@@12 Integer_value)) (+ (U_2_real (MapType1Select ZeroMask o_3@@12 Integer_value)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U (invRecv4 o_3@@12))) (< NoPerm FullPerm)) (qpRange4 o_3@@12))) (= (U_2_real (MapType1Select QPMask@0 o_3@@12 Integer_value)) (U_2_real (MapType1Select ZeroMask o_3@@12 Integer_value))))))
 :qid |stdinbpl.1055:22|
 :skolemid |84|
 :pattern ( (MapType1Select QPMask@0 o_3@@12 Integer_value))
)) (forall ((o_3@@13 T@U) (f_5@@3 T@U) ) (! (let ((B@@15 (FieldTypeInv1 (type f_5@@3))))
(let ((A@@16 (FieldTypeInv0 (type f_5@@3))))
 (=> (and (and (= (type o_3@@13) RefType) (= (type f_5@@3) (FieldType A@@16 B@@15))) (not (= f_5@@3 Integer_value))) (= (U_2_real (MapType1Select ZeroMask o_3@@13 f_5@@3)) (U_2_real (MapType1Select QPMask@0 o_3@@13 f_5@@3))))))
 :qid |stdinbpl.1059:29|
 :skolemid |85|
 :pattern ( (MapType1Select ZeroMask o_3@@13 f_5@@3))
 :pattern ( (MapType1Select QPMask@0 o_3@@13 f_5@@3))
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 49) 48) anon31_Then_correct) (=> (= (ControlFlow 0 49) 29) anon31_Else_correct)))))))))
(let ((anon7_correct true))
(let ((anon30_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_12))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon30_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_12)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_12 0)) (=> (>= i_12 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_12 (|Seq#Length| ar))) (=> (< i_12 (|Seq#Length| ar)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon27_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (<= 0 i_1) (and (< i_1 (|Seq#Length| ar)) (and (<= 0 j_1) (and (< j_1 (|Seq#Length| ar)) (not (= i_1 j_1)))))) (not (= (|Seq#Index| ar i_1) (|Seq#Index| ar j_1))))
 :qid |stdinbpl.1015:20|
 :skolemid |79|
 :pattern ( (|Seq#Index| ar i_1) (|Seq#Index| ar j_1))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 51) 49) anon29_Else_correct) (=> (= (ControlFlow 0 51) 9) anon30_Then_correct)) (=> (= (ControlFlow 0 51) 12) anon30_Else_correct)))))
(let ((anon3_correct true))
(let ((anon28_Else_correct  (=> (and (not (and (<= 0 i_11) (and (< i_11 (|Seq#Length| ar)) (and (<= 0 j_2) (and (< j_2 (|Seq#Length| ar)) (not (= i_11 j_2))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon28_Then_correct  (=> (and (<= 0 i_11) (and (< i_11 (|Seq#Length| ar)) (and (<= 0 j_2) (and (< j_2 (|Seq#Length| ar)) (not (= i_11 j_2)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_11 0)) (=> (>= i_11 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_11 (|Seq#Length| ar))) (=> (< i_11 (|Seq#Length| ar)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_2 0)) (=> (>= j_2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_2 (|Seq#Length| ar))) (=> (< j_2 (|Seq#Length| ar)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 this $allocated))) (and (= (|Seq#Length| ar) len) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 52) 51) anon27_Else_correct) (=> (= (ControlFlow 0 52) 2) anon28_Then_correct)) (=> (= (ControlFlow 0 52) 7) anon28_Else_correct)))))
