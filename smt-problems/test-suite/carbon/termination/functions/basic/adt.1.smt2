...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon6_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (>= (size (tail_Cons xs_1@@9)) 0))))
(let ((anon4_correct true))
(let ((anon6_Else_correct  (=> (and (|f#trigger| EmptyFrame (tail_Cons xs_1@@9)) (= (ControlFlow 0 5) 1)) anon4_correct)))
(let ((anon5_Then_correct  (=> (> (size xs_1@@9) 0) (and (=> (= (ControlFlow 0 6) 4) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (>= 0 (size xs_1@@9)) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove 0)) (and (>= (size xs_1@@9) 0) (state Heap@@13 ZeroMask))) (and (=> (= (ControlFlow 0 7) 6) anon5_Then_correct) (=> (= (ControlFlow 0 7) 2) anon5_Else_correct)))))
