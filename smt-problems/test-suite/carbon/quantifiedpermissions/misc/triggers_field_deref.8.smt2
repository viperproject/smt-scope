...
(assert  (and (and (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type x_2) RefType)) (= (type y@@2) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type z_11) RefType)) (forall ((arg0@@35 T@U) ) (! (= (type (invRecv17 arg0@@35)) RefType)
 :qid |funType:invRecv17|
 :pattern ( (invRecv17 arg0@@35))
))))
...
(let ((anon9_Else_correct  (=> (and (not (or (= z_11 x_2) (= z_11 y@@2))) (= (ControlFlow 0 8) 5)) anon5_correct)))
(let ((anon9_Then_correct  (=> (or (= z_11 x_2) (= z_11 y@@2)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm QPMask@0 z_11 f_7)) (=> (HasDirectPerm QPMask@0 z_11 f_7) (=> (= (ControlFlow 0 6) 5) anon5_correct))))))
(let ((anon8_Else_correct  (=> (forall ((z_3 T@U) ) (!  (=> (and (= (type z_3) RefType) (or (= z_3 x_2) (= z_3 y@@2))) (= (fun02 (U_2_int (MapType0Select Heap@@13 z_3 f_7))) 0))
 :qid |stdinbpl.1938:20|
 :skolemid |170|
 :pattern ( (fun02 (U_2_int (MapType0Select Heap@@13 z_3 f_7))))
)) (=> (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 x_2 f_7)) (=> (HasDirectPerm QPMask@0 x_2 f_7) (=> (= (ControlFlow 0 3) (- 0 2)) (>= (fun02 (U_2_int (MapType0Select Heap@@13 x_2 f_7))) 0))))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (or (= z_1 x_2) (= z_1 y@@2))) (or (= z_1_1 x_2) (= z_1_1 y@@2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1))))
...
)) (=> (and (and (forall ((z_1@@1 T@U) ) (!  (=> (= (type z_1@@1) RefType) (=> (and (or (= z_1@@1 x_2) (= z_1@@1 y@@2)) (< NoPerm FullPerm)) (and (qpRange17 z_1@@1) (= (invRecv17 z_1@@1) z_1@@1))))
 :qid |stdinbpl.1891:22|
 :skolemid |165|
 :pattern ( (MapType0Select Heap@@13 z_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@1 f_7))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (or (= (invRecv17 o_3) x_2) (= (invRecv17 o_3) y@@2)) (< NoPerm FullPerm)) (qpRange17 o_3)) (= (invRecv17 o_3) o_3)))
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (or (= (invRecv17 o_3@@0) x_2) (= (invRecv17 o_3@@0) y@@2)) (< NoPerm FullPerm)) (qpRange17 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv17 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (or (= (invRecv17 o_3@@0) x_2) (= (invRecv17 o_3@@0) y@@2)) (< NoPerm FullPerm)) (qpRange17 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.1911:29|
 :skolemid |169|
 :pattern ( (MapType1Select ZeroMask o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
)) (state Heap@@13 QPMask@0)) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0))) (and (and (not (= x_2 null)) (not (= y@@2 null))) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)))) (and (and (=> (= (ControlFlow 0 9) 3) anon8_Else_correct) (=> (= (ControlFlow 0 9) 6) anon9_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon9_Else_correct))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@13 x_2 $allocated)) (U_2_bool (MapType0Select Heap@@13 y@@2 $allocated)))) (and (=> (= (ControlFlow 0 11) 1) anon7_Then_correct) (=> (= (ControlFlow 0 11) 9) anon7_Else_correct)))))
