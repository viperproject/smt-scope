...
(let ((anon39_Else_correct  (=> (and (not (and (<= 0 i_5) (< i_5 len))) (= (ControlFlow 0 25) 20)) anon20_correct)))
(let ((anon39_Then_correct  (=> (and (<= 0 i_5) (< i_5 len)) (and (=> (= (ControlFlow 0 21) (- 0 24)) (>= i_5 0)) (=> (>= i_5 0) (and (=> (= (ControlFlow 0 21) (- 0 23)) (< i_5 (|Seq#Length| ar@@27))) (=> (< i_5 (|Seq#Length| ar@@27)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (HasDirectPerm QPMask@1 (|Seq#Index| ar@@27 i_5) Ref__Integer_value)) (=> (HasDirectPerm QPMask@1 (|Seq#Index| ar@@27 i_5) Ref__Integer_value) (=> (= (ControlFlow 0 21) 20) anon20_correct))))))))))
...
(let ((anon37_Then_correct  (=> (and (<= 0 i_4) (< i_4 len)) (and (=> (= (ControlFlow 0 15) (- 0 17)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 15) (- 0 16)) (< i_4 (|Seq#Length| ar@@27))) (=> (< i_4 (|Seq#Length| ar@@27)) (=> (= (ControlFlow 0 15) 14) anon16_correct))))))))
...
(let ((anon30_Else_correct  (=> (and (forall ((j_1_1 Int) (k_1_1 Int) ) (!  (=> (and (<= 0 j_1_1) (and (< j_1_1 len) (and (<= 0 k_1_1) (and (< k_1_1 len) (not (= j_1_1 k_1_1)))))) (not (= (|Seq#Index| ar@@27 j_1_1) (|Seq#Index| ar@@27 k_1_1))))
...
(let ((anon31_Else_correct  (=> (and (not (and (<= 0 j_7) (and (< j_7 len) (and (<= 0 k_13) (and (< k_13 len) (not (= j_7 k_13))))))) (= (ControlFlow 0 7) 1)) anon5_correct)))
(let ((anon31_Then_correct  (=> (and (<= 0 j_7) (and (< j_7 len) (and (<= 0 k_13) (and (< k_13 len) (not (= j_7 k_13)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j_7 0)) (=> (>= j_7 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j_7 (|Seq#Length| ar@@27))) (=> (< j_7 (|Seq#Length| ar@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_13 0)) (=> (>= k_13 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_13 (|Seq#Length| ar@@27))) (=> (< k_13 (|Seq#Length| ar@@27)) (=> (= (ControlFlow 0 2) 1) anon5_correct))))))))))))
