...
(set-info :boogie-vc-id |SubjectLock__inv#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (and (state Heap@@44 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@44 diz@@169 $allocated)) (> wildcard@0 NoPerm))) (and (and (not (= diz@@169 null)) (= Mask@0 (MapType1Store ZeroMask diz@@169 SubjectLock__subject (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz@@169 SubjectLock__subject)) wildcard@0))))) (and (state Heap@@44 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm Mask@0 diz@@169 SubjectLock__subject))))
...
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(set-info :boogie-vc-id SubjectLock__uncommit)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
