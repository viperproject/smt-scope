...
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type xs) (SeqType RefType)) (= (type Heap@@10) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@37 T@U) ) (! (= (type (invRecv11 arg0@@37)) RefType)
 :qid |funType:invRecv11|
 :pattern ( (invRecv11 arg0@@37))
))) (= (type QPMask@3) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type QPMask@4) (MapType1Type RefType realType))) (forall ((arg0@@38 T@U) ) (! (= (type (invRecv9 arg0@@38)) RefType)
 :qid |funType:invRecv9|
 :pattern ( (invRecv9 arg0@@38))
))) (forall ((arg0@@39 T@U) ) (! (= (type (invRecv8 arg0@@39)) RefType)
 :qid |funType:invRecv8|
 :pattern ( (invRecv8 arg0@@39))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@40 T@U) ) (! (= (type (invRecv7 arg0@@40)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon15_Else_correct  (=> (= (ControlFlow 0 11) (- 0 10)) (forall ((x_7 T@U) (x_7_1 T@U) ) (!  (=> (and (= (type x_7) RefType) (= (type x_7_1) RefType)) (=> (and (and (and (and (not (= x_7 x_7_1)) (|Seq#Contains| xs x_7)) (|Seq#Contains| xs x_7_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_7 x_7_1))))
...
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((x_5 T@U) (x_5_1 T@U) ) (!  (=> (and (= (type x_5) RefType) (= (type x_5_1) RefType)) (=> (and (and (and (and (not (= x_5 x_5_1)) (|Seq#Contains| xs x_5)) (|Seq#Contains| xs x_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_5 x_5_1))))
...
)) (=> (and (forall ((x_5@@1 T@U) ) (!  (=> (= (type x_5@@1) RefType) (=> (and (|Seq#Contains| xs x_5@@1) (< NoPerm FullPerm)) (and (qpRange9 x_5@@1) (= (invRecv9 x_5@@1) x_5@@1))))
...
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| xs (invRecv9 o_3)) (< NoPerm FullPerm)) (qpRange9 o_3)) (= (invRecv9 o_3) o_3)))
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| xs (invRecv9 o_3@@0)) (< NoPerm FullPerm)) (qpRange9 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv9 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@4 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| xs (invRecv9 o_3@@0)) (< NoPerm FullPerm)) (qpRange9 o_3@@0))) (= (U_2_real (MapType1Select QPMask@4 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 7)) (forall ((x_8 T@U) (x_8_2 T@U) ) (!  (=> (and (= (type x_8) RefType) (= (type x_8_2) RefType)) (=> (and (and (and (and (not (= x_8 x_8_2)) (|Seq#Contains| xs x_8)) (|Seq#Contains| xs x_8_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_8 x_8_2))))
 :qid |stdinbpl.1307:17|
 :skolemid |125|
 :pattern ( (neverTriggered11 x_8) (neverTriggered11 x_8_2))
))) (=> (forall ((x_8@@0 T@U) (x_8_2@@0 T@U) ) (!  (=> (and (= (type x_8@@0) RefType) (= (type x_8_2@@0) RefType)) (=> (and (and (and (and (not (= x_8@@0 x_8_2@@0)) (|Seq#Contains| xs x_8@@0)) (|Seq#Contains| xs x_8_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_8@@0 x_8_2@@0))))
 :qid |stdinbpl.1307:17|
 :skolemid |125|
 :pattern ( (neverTriggered11 x_8@@0) (neverTriggered11 x_8_2@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((x_8@@1 T@U) ) (!  (=> (and (= (type x_8@@1) RefType) (|Seq#Contains| xs x_8@@1)) (>= (U_2_real (MapType1Select QPMask@1 x_8@@1 f_7)) FullPerm))
 :qid |stdinbpl.1314:17|
 :skolemid |126|
 :pattern ( (MapType0Select Heap@@10 x_8@@1 f_7))
 ...
 :qid |stdinbpl.1314:17|
 :skolemid |126|
 :pattern ( (MapType0Select Heap@@10 x_8@@2 f_7))
 :pattern ( (MapType1Select QPMask@2 x_8@@2 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs x_8@@2))
 :pattern ( (|Seq#Contains| xs x_8@@2))
)) (=> (and (and (forall ((x_8@@3 T@U) ) (!  (=> (= (type x_8@@3) RefType) (=> (and (|Seq#Contains| xs x_8@@3) (< NoPerm FullPerm)) (and (qpRange11 x_8@@3) (= (invRecv11 x_8@@3) x_8@@3))))
 :qid |stdinbpl.1320:22|
 :skolemid |127|
 :pattern ( (MapType0Select Heap@@10 x_8@@3 f_7))
 :pattern ( (MapType1Select QPMask@2 x_8@@3 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs x_8@@3))
 :pattern ( (|Seq#Contains| xs x_8@@3))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (|Seq#Contains| xs (invRecv11 o_3@@2)) (and (< NoPerm FullPerm) (qpRange11 o_3@@2))) (= (invRecv11 o_3@@2) o_3@@2)))
 :qid |stdinbpl.1324:22|
 :skolemid |128|
 :pattern ( (invRecv11 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (|Seq#Contains| xs (invRecv11 o_3@@3)) (and (< NoPerm FullPerm) (qpRange11 o_3@@3))) (and (= (invRecv11 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@2 o_3@@3 f_7)) (- (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) FullPerm)))) (=> (not (and (|Seq#Contains| xs (invRecv11 o_3@@3)) (and (< NoPerm FullPerm) (qpRange11 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@2 o_3@@3 f_7)) (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7))))))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
...
)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((x_9 T@U) (x_9_2 T@U) ) (!  (=> (and (= (type x_9) RefType) (= (type x_9_2) RefType)) (=> (and (and (and (and (not (= x_9 x_9_2)) (|Seq#Contains| xs x_9)) (|Seq#Contains| xs x_9_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_9 x_9_2))))
 :qid |stdinbpl.1348:17|
 :skolemid |131|
 :pattern ( (neverTriggered12 x_9) (neverTriggered12 x_9_2))
 ...
 :qid |stdinbpl.1348:17|
 :skolemid |131|
 :pattern ( (neverTriggered12 x_9@@0) (neverTriggered12 x_9_2@@0))
)) (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((x_9@@1 T@U) ) (!  (=> (and (= (type x_9@@1) RefType) (|Seq#Contains| xs x_9@@1)) (>= (U_2_real (MapType1Select QPMask@2 x_9@@1 g)) FullPerm))
 :qid |stdinbpl.1355:17|
 :skolemid |132|
 :pattern ( (MapType0Select Heap@@10 x_9@@1 g))
...
)) (=> (forall ((x_3@@1 T@U) ) (!  (=> (= (type x_3@@1) RefType) (=> (and (|Seq#Contains| xs x_3@@1) (< NoPerm FullPerm)) (and (qpRange8 x_3@@1) (= (invRecv8 x_3@@1) x_3@@1))))
...
)) (=> (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (|Seq#Contains| xs (invRecv8 o_3@@5)) (< NoPerm FullPerm)) (qpRange8 o_3@@5)) (= (invRecv8 o_3@@5) o_3@@5)))
...
))) (=> (and (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (|Seq#Contains| xs (invRecv8 o_3@@6)) (< NoPerm FullPerm)) (qpRange8 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv8 o_3@@6) o_3@@6)) (= (U_2_real (MapType1Select QPMask@1 o_3@@6 g)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@6 g)) FullPerm)))) (=> (not (and (and (|Seq#Contains| xs (invRecv8 o_3@@6)) (< NoPerm FullPerm)) (qpRange8 o_3@@6))) (= (U_2_real (MapType1Select QPMask@1 o_3@@6 g)) (U_2_real (MapType1Select QPMask@0 o_3@@6 g))))))
