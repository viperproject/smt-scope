...
(declare-fun r_1 () T@U)
(assert  (and (and (= (type r_1) RefType) (= (type Heap@@12) (MapType0Type RefType))) (= (type r_2) RefType)))
(set-info :boogie-vc-id noPredicates)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm ZeroMask null (P2 r_2))) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm ZeroMask null (P2 r_2)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm ZeroMask null (P2 r_2))) (=> (HasDirectPerm ZeroMask null (P2 r_2)) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((r_3 T@U) ) (!  (=> (and (= (type r_3) RefType) (HasDirectPerm ZeroMask null (P2 r_3))) false)
 :qid |stdinbpl.375:15|
 :skolemid |41|
 :pattern ( (MapType1Select ZeroMask null (P2 r_3)))
 :pattern ( (MapType0Select Heap@@12 null (P2 r_3)))
)))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((r_1_1 T@U) ) (!  (=> (and (= (type r_1_1) RefType) (HasDirectPerm ZeroMask null (P1 r_1_1))) false)
 :qid |stdinbpl.356:15|
 :skolemid |40|
 :pattern ( (MapType1Select ZeroMask null (P1 r_1_1)))
 :pattern ( (MapType0Select Heap@@12 null (P1 r_1_1)))
))) (=> (forall ((r_1_1@@0 T@U) ) (!  (=> (and (= (type r_1_1@@0) RefType) (HasDirectPerm ZeroMask null (P1 r_1_1@@0))) false)
 :qid |stdinbpl.356:15|
 :skolemid |40|
 :pattern ( (MapType1Select ZeroMask null (P1 r_1_1@@0)))
 :pattern ( (MapType0Select Heap@@12 null (P1 r_1_1@@0)))
)) (=> (state Heap@@12 ZeroMask) (and (and (=> (= (ControlFlow 0 11) 6) anon11_Else_correct) (=> (= (ControlFlow 0 11) 8) anon12_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon12_Else_correct)))))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (HasDirectPerm ZeroMask null (P1 r_1))) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (HasDirectPerm ZeroMask null (P1 r_1)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm ZeroMask null (P1 r_1))) (=> (HasDirectPerm ZeroMask null (P1 r_1)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (state Heap@@12 ZeroMask) (and (and (=> (= (ControlFlow 0 13) 11) anon9_Else_correct) (=> (= (ControlFlow 0 13) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 13) 4) anon10_Else_correct)))))
