...
(assert  (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type r_1) RefType)) (= (type x@@8) RefType)))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (not (HasDirectPerm Mask@0 r_1 val)) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (HasDirectPerm Mask@0 r_1 val) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@0 r_1 val)) (=> (HasDirectPerm Mask@0 r_1 val) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
(let ((anon5_Else_correct  (=> (and (and (forall ((r_1_1 T@U) ) (!  (=> (and (= (type r_1_1) RefType) (HasDirectPerm Mask@0 r_1_1 val)) false)
 :qid |stdinbpl.234:20|
 :skolemid |22|
 :pattern ( (MapType1Select Mask@0 r_1_1 val))
 :pattern ( (MapType0Select Heap@@9 r_1_1 val))
)) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) false)))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (and (<= NoPerm p_1) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (>= p_1 NoPerm)) (=> (>= p_1 NoPerm) (=> (=> (> p_1 NoPerm) (not (= x@@8 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask x@@8 val (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 val)) p_1)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (and (=> (= (ControlFlow 0 7) 2) anon5_Else_correct) (=> (= (ControlFlow 0 7) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))))))
