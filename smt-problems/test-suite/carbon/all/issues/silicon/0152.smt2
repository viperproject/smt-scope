...
(assert  (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type this) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id m)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (= FullPerm (U_2_real (MapType1Select Mask@0 this x@@8)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 this x@@8))) (=> (= Heap@0 (MapType0Store Heap@@9 this x@@8 (int_2_U z@@0))) (=> (and (state Heap@0 Mask@0) (= (ControlFlow 0 4) (- 0 3))) (= (U_2_int (MapType0Select Heap@0 this x@@8)) z@@0)))))))
(let ((anon3_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm ZeroMask this x@@8))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 this $allocated))) (and (not (= this null)) (state Heap@@9 ZeroMask))) (and (and (not (= this null)) (= Mask@0 (MapType1Store ZeroMask this x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this x@@8)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)))) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 4) anon3_Else_correct)))))
