...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (Ctor RefType) 8)) (= (type next) (FieldType NormalFieldType RefType))) (= (type elem) (FieldType NormalFieldType intType))))
(assert (distinct $allocated next elem)
)
...
(assert (forall ((Heap@@0 T@U) (this T@U) (index Int) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type this) RefType)) (dummyFunction (int_2_U (|get#triggerStateless| this index))))
 :qid |stdinbpl.200:15|
 :skolemid |23|
...
(assert (forall ((this@@2 T@U) (this2 T@U) ) (!  (=> (and (and (= (type this@@2) RefType) (= (type this2) RefType)) (= (valid this@@2) (valid this2))) (= this@@2 this2))
 :qid |stdinbpl.344:15|
 :skolemid |30|
...
(assert (forall ((this@@3 T@U) (this2@@0 T@U) ) (!  (=> (and (and (= (type this@@3) RefType) (= (type this2@@0) RefType)) (= (|valid#sm| this@@3) (|valid#sm| this2@@0))) (= this@@3 this2@@0))
 :qid |stdinbpl.348:15|
 :skolemid |31|
 :pattern ( (|valid#sm| this@@3) (|valid#sm| this2@@0))
)))
(assert (forall ((Heap@@5 T@U) (Mask@@3 T@U) (this@@4 T@U) (index@@0 Int) ) (!  (=> (and (and (and (= (type Heap@@5) (MapType0Type RefType)) (= (type Mask@@3) (MapType1Type RefType realType))) (= (type this@@4) RefType)) (and (state Heap@@5 Mask@@3) (< AssumeFunctionsAbove 0))) (= (get Heap@@5 this@@4 index@@0) 0))
 :qid |stdinbpl.206:15|
 :skolemid |24|
 :pattern ( (state Heap@@5 Mask@@3) (get Heap@@5 this@@4 index@@0))
 :pattern ( (state Heap@@5 Mask@@3) (|get#triggerStateless| this@@4 index@@0) (|valid#trigger| Heap@@5 (valid this@@4)) (|valid#trigger| Heap@@5 (valid this@@4)))
)))
...
(assert (forall ((Heap@@8 T@U) (this@@5 T@U) (index@@1 Int) ) (!  (=> (and (= (type Heap@@8) (MapType0Type RefType)) (= (type this@@5) RefType)) (and (= (get Heap@@8 this@@5 index@@1) (|get'| Heap@@8 this@@5 index@@1)) (dummyFunction (int_2_U (|get#triggerStateless| this@@5 index@@1)))))
 :qid |stdinbpl.196:15|
 :skolemid |22|
 :pattern ( (get Heap@@8 this@@5 index@@1))
)))
...
(assert (forall ((Heap@@13 T@U) (Mask@@10 T@U) (this@@8 T@U) (index@@2 Int) ) (!  (=> (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type this@@8) RefType)) (state Heap@@13 Mask@@10)) (= (|get'| Heap@@13 this@@8 index@@2) (|get#frame| (MapType0Select Heap@@13 null (valid this@@8)) this@@8 index@@2)))
 :qid |stdinbpl.213:15|
 :skolemid |25|
 :pattern ( (state Heap@@13 Mask@@10) (|get'| Heap@@13 this@@8 index@@2))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
...
(let ((anon12_Else_correct  (=> (= (MapType0Select Heap@3 this@@9 next) null) (=> (and (= UnfoldingMask@9 UnfoldingMask@7) (= (ControlFlow 0 3) 1)) anon8_correct))))
(let ((anon12_Then_correct  (=> (and (not (= (MapType0Select Heap@3 this@@9 next) null)) (= UnfoldingMask@8 (MapType1Store UnfoldingMask@7 null (valid (MapType0Select Heap@3 this@@9 next)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@7 null (valid (MapType0Select Heap@3 this@@9 next)))) FullPerm))))) (=> (and (and (InsidePredicate (valid this@@9) (MapType0Select Heap@3 null (valid this@@9)) (valid (MapType0Select Heap@3 this@@9 next)) (MapType0Select Heap@3 null (valid (MapType0Select Heap@3 this@@9 next)))) (state Heap@3 UnfoldingMask@8)) (and (= UnfoldingMask@9 UnfoldingMask@8) (= (ControlFlow 0 2) 1))) anon8_correct))))
(let ((anon6_correct  (=> (and (state Heap@3 Mask@0) (|valid#trigger| Heap@3 (valid this@@9))) (=> (and (and (and (= (MapType0Select Heap@3 null (valid this@@9)) (CombineFrames (FrameFragment (MapType0Select Heap@3 this@@9 elem)) (CombineFrames (FrameFragment (MapType0Select Heap@3 this@@9 next)) (FrameFragment (ite (not (= (MapType0Select Heap@3 this@@9 next) null)) (MapType0Select Heap@3 null (valid (MapType0Select Heap@3 this@@9 next))) EmptyFrame))))) (= UnfoldingMask@5 (MapType1Store Mask@0 null (valid this@@9) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid this@@9))) FullPerm))))) (and (not (= this@@9 null)) (= UnfoldingMask@6 (MapType1Store UnfoldingMask@5 this@@9 elem (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@5 this@@9 elem)) FullPerm)))))) (and (and (state Heap@3 UnfoldingMask@6) (not (= this@@9 null))) (and (= UnfoldingMask@7 (MapType1Store UnfoldingMask@6 this@@9 next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@6 this@@9 next)) FullPerm)))) (state Heap@3 UnfoldingMask@7)))) (and (=> (= (ControlFlow 0 4) 2) anon12_Then_correct) (=> (= (ControlFlow 0 4) 3) anon12_Else_correct))))))
(let ((anon11_Else_correct  (=> (= (MapType0Select Heap@1 this@@9 next) null) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 6) 4)) anon6_correct))))
(let ((anon11_Then_correct  (=> (not (= (MapType0Select Heap@1 this@@9 next) null)) (=> (and (and (forall ((o_3 T@U) (f_7 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_7))))
...
)) (= Heap@2 (MapType0Store Heap@1 null (|valid#sm| this@@9) newPMask@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 5) 4))) anon6_correct))))
(let ((anon4_correct  (=> (state Heap@@14 UnfoldingMask@4) (=> (and (= Heap@0 (MapType0Store Heap@@14 null (|valid#sm| this@@9) (MapType1Store (MapType0Select Heap@@14 null (|valid#sm| this@@9)) this@@9 elem (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|valid#sm| this@@9) (MapType1Store (MapType0Select Heap@0 null (|valid#sm| this@@9)) this@@9 next (bool_2_U true))))) (and (=> (= (ControlFlow 0 7) 5) anon11_Then_correct) (=> (= (ControlFlow 0 7) 6) anon11_Else_correct))))))
(let ((anon10_Else_correct  (=> (= (MapType0Select Heap@@14 this@@9 next) null) (=> (and (= UnfoldingMask@4 UnfoldingMask@2) (= (ControlFlow 0 9) 7)) anon4_correct))))
(let ((anon10_Then_correct  (=> (and (not (= (MapType0Select Heap@@14 this@@9 next) null)) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 null (valid (MapType0Select Heap@@14 this@@9 next)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 null (valid (MapType0Select Heap@@14 this@@9 next)))) FullPerm))))) (=> (and (and (InsidePredicate (valid this@@9) (MapType0Select Heap@@14 null (valid this@@9)) (valid (MapType0Select Heap@@14 this@@9 next)) (MapType0Select Heap@@14 null (valid (MapType0Select Heap@@14 this@@9 next)))) (state Heap@@14 UnfoldingMask@3)) (and (= UnfoldingMask@4 UnfoldingMask@3) (= (ControlFlow 0 8) 7))) anon4_correct))))
(let ((anon2_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (valid this@@9) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid this@@9))) FullPerm)))) (=> (and (not (= this@@9 null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this@@9 elem (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this@@9 elem)) FullPerm))))) (=> (and (and (state Heap@@14 UnfoldingMask@1) (not (= this@@9 null))) (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 this@@9 next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 this@@9 next)) FullPerm)))) (state Heap@@14 UnfoldingMask@2))) (and (=> (= (ControlFlow 0 10) 8) anon10_Then_correct) (=> (= (ControlFlow 0 10) 9) anon10_Else_correct)))))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 10)) anon2_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid this@@9))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid this@@9)))) (=> (= (ControlFlow 0 11) 10) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@14 ZeroMask) (U_2_bool (MapType0Select Heap@@14 this@@9 $allocated))) (and (= AssumeFunctionsAbove 0) (= Mask@0 (MapType1Store ZeroMask null (valid this@@9) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid this@@9))) FullPerm)))))) (and (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0)) (and (|valid#trigger| Heap@@14 (valid this@@9)) (= (MapType0Select Heap@@14 null (valid this@@9)) (CombineFrames (FrameFragment (MapType0Select Heap@@14 this@@9 elem)) (CombineFrames (FrameFragment (MapType0Select Heap@@14 this@@9 next)) (FrameFragment (ite (not (= (MapType0Select Heap@@14 this@@9 next) null)) (MapType0Select Heap@@14 null (valid (MapType0Select Heap@@14 this@@9 next))) EmptyFrame)))))))) (and (=> (= (ControlFlow 0 14) 11) anon9_Then_correct) (=> (= (ControlFlow 0 14) 13) anon9_Else_correct)))))
