...
(set-info :boogie-vc-id h_e_pres_termination_proof)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@29 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (= (ControlFlow 0 2) (- 0 1))) (>= x@@28 0)))))
