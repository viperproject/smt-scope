...
(assert  (and (= (type Heap@@11) (MapType0Type RefType)) (= (type self@@5) RefType)))
(set-info :boogie-vc-id |Tree_valid#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 self@@5 $allocated))) (and (= perm@0 (/ (to_real 1) (to_real 10))) (= (ControlFlow 0 2) (- 0 1)))) (>= perm@0 NoPerm))))
