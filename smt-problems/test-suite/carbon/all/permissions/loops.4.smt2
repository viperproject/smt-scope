...
(assert  (and (and (and (= (type x@@8) RefType) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon6_Else_correct true))
(let ((anon6_Then_correct  (=> (and (state Heap@@9 ZeroMask) (not (= x@@8 null))) (=> (and (and (not (= (U_2_int (MapType0Select Heap@@9 x@@8 f_7)) 3)) (state Heap@@9 ZeroMask)) (and b_2@0 (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (= FullPerm (U_2_real (MapType1Select ZeroMask x@@8 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select ZeroMask x@@8 f_7))) (=> (= Heap@0 (MapType0Store Heap@@9 x@@8 f_7 (int_2_U 4))) (=> (and (state Heap@0 ZeroMask) (state Heap@0 ZeroMask)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= x@@8 null))) (=> (not (= x@@8 null)) (=> (= (ControlFlow 0 4) (- 0 3)) (not (= (U_2_int (MapType0Select Heap@0 x@@8 f_7)) 3)))))))))))))
(let ((anon5_Then_correct  (=> (and (not (= x@@8 null)) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm Mask@0 x@@8 f_7))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated)) (not (= x@@8 null))) (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm)))) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (HasDirectPerm Mask@0 x@@8 f_7)) (=> (HasDirectPerm Mask@0 x@@8 f_7) (=> (not (= (U_2_int (MapType0Select Heap@@9 x@@8 f_7)) 3)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (not (= x@@8 null))) (=> (not (= x@@8 null)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (not (= (U_2_int (MapType0Select Heap@@9 x@@8 f_7)) 3))) (=> (not (= (U_2_int (MapType0Select Heap@@9 x@@8 f_7)) 3)) (and (and (=> (= (ControlFlow 0 8) 2) anon5_Then_correct) (=> (= (ControlFlow 0 8) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct))))))))))))))
