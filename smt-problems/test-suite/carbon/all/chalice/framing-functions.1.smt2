...
(assert (forall ((Heap@@4 T@U) (Mask@@2 T@U) (this@@2 T@U) (i@@0 Int) ) (!  (=> (and (and (and (and (= (type Heap@@4) (MapType0Type RefType)) (= (type Mask@@2) (MapType1Type RefType realType))) (= (type this@@2) RefType)) (and (state Heap@@4 Mask@@2) (< AssumeFunctionsAbove 0))) (<= 0 i@@0)) (= (itemAt Heap@@4 this@@2 i@@0) (ite  (or (= i@@0 0) (= (MapType0Select Heap@@4 this@@2 next) null)) (U_2_int (MapType0Select Heap@@4 this@@2 value)) (|itemAt'| Heap@@4 (MapType0Select Heap@@4 this@@2 next) (- i@@0 1)))))
 :qid |stdinbpl.206:15|
 :skolemid |24|
 :pattern ( (state Heap@@4 Mask@@2) (itemAt Heap@@4 this@@2 i@@0))
 :pattern ( (state Heap@@4 Mask@@2) (|itemAt#triggerStateless| this@@2 i@@0) (|valid#trigger| Heap@@4 (valid this@@2)))
)))
...
(assert (forall ((Heap@@8 T@U) (this@@5 T@U) (i@@1 Int) ) (!  (=> (and (= (type Heap@@8) (MapType0Type RefType)) (= (type this@@5) RefType)) (and (= (itemAt Heap@@8 this@@5 i@@1) (|itemAt'| Heap@@8 this@@5 i@@1)) (dummyFunction (int_2_U (|itemAt#triggerStateless| this@@5 i@@1)))))
 :qid |stdinbpl.196:15|
 :skolemid |22|
 :pattern ( (itemAt Heap@@8 this@@5 i@@1))
)))
...
(assert (forall ((this@@6 T@U) ) (!  (=> (= (type this@@6) RefType) (= (getPredWandId (valid this@@6)) 0))
 :qid |stdinbpl.347:15|
 :skolemid |29|
...
(assert (forall ((this@@7 T@U) ) (!  (=> (= (type this@@7) RefType) (= (PredicateMaskField (valid this@@7)) (|valid#sm| this@@7)))
 :qid |stdinbpl.339:15|
 :skolemid |27|
 :pattern ( (PredicateMaskField (valid this@@7)))
)))
...
(assert (forall ((Heap@@13 T@U) (Mask@@10 T@U) (this@@8 T@U) (i@@2 Int) ) (!  (=> (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type this@@8) RefType)) (state Heap@@13 Mask@@10)) (= (|itemAt'| Heap@@13 this@@8 i@@2) (|itemAt#frame| (MapType0Select Heap@@13 null (valid this@@8)) this@@8 i@@2)))
 :qid |stdinbpl.213:15|
 :skolemid |25|
 :pattern ( (state Heap@@13 Mask@@10) (|itemAt'| Heap@@13 this@@8 i@@2))
 :pattern ( (state Heap@@13 Mask@@10) (|itemAt#triggerStateless| this@@8 i@@2) (|valid#trigger| Heap@@13 (valid this@@8)))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
...
(let ((anon22_Else_correct  (=> (= (MapType0Select Heap@1 this@@9 next) null) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 8) 6)) anon15_correct))))
(let ((anon22_Then_correct  (=> (not (= (MapType0Select Heap@1 this@@9 next) null)) (=> (and (and (forall ((o_3 T@U) (f_7 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_7))))
(let ((A@@12 (FieldTypeInv0 (type f_7))))
 (=> (and (and (= (type o_3) RefType) (= (type f_7) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|valid#sm| this@@9)) o_3 f_7)) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|valid#sm| (MapType0Select Heap@1 this@@9 next))) o_3 f_7)))) (U_2_bool (MapType1Select newPMask@0 o_3 f_7)))))
 :qid |stdinbpl.320:33|
 :skolemid |26|
 :pattern ( (MapType1Select newPMask@0 o_3 f_7))
)) (= Heap@2 (MapType0Store Heap@1 null (|valid#sm| this@@9) newPMask@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 7) 6))) anon15_correct))))
(let ((anon13_correct  (=> (and (= Heap@0 (MapType0Store Heap@@14 null (|valid#sm| this@@9) (MapType1Store (MapType0Select Heap@@14 null (|valid#sm| this@@9)) this@@9 value (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|valid#sm| this@@9) (MapType1Store (MapType0Select Heap@0 null (|valid#sm| this@@9)) this@@9 next (bool_2_U true))))) (and (=> (= (ControlFlow 0 9) 7) anon22_Then_correct) (=> (= (ControlFlow 0 9) 8) anon22_Else_correct)))))
(let ((anon20_Else_correct  (=> (and (|itemAt#trigger| (MapType0Select Heap@@14 null (valid (MapType0Select Heap@@14 this@@9 next))) (MapType0Select Heap@@14 this@@9 next) (- i@@3 1)) (= (ControlFlow 0 12) 9)) anon13_correct)))
(let ((anon19_Then_correct  (=> (or (= i@@3 0) (= (MapType0Select Heap@@14 this@@9 next) null)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm UnfoldingMask@4 this@@9 value)) (=> (HasDirectPerm UnfoldingMask@4 this@@9 value) (=> (= (ControlFlow 0 10) 9) anon13_correct))))))
(let ((anon11_correct  (=> (and (= UnfoldingMask@5 (MapType1Store UnfoldingMask@4 null (valid (MapType0Select Heap@@14 this@@9 next)) (real_2_U (- (U_2_real (MapType1Select UnfoldingMask@4 null (valid (MapType0Select Heap@@14 this@@9 next)))) FullPerm)))) (= (ControlFlow 0 2) (- 0 1))) (<= 0 (- i@@3 1)))))
(let ((anon21_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon11_correct)))
(let ((anon21_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (valid (MapType0Select Heap@@14 this@@9 next)))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (valid (MapType0Select Heap@@14 this@@9 next))))) (=> (= (ControlFlow 0 3) 2) anon11_correct))))))
(let ((anon19_Else_correct  (=> (not (or (= i@@3 0) (= (MapType0Select Heap@@14 this@@9 next) null))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm UnfoldingMask@4 this@@9 next)) (=> (HasDirectPerm UnfoldingMask@4 this@@9 next) (and (and (=> (= (ControlFlow 0 13) 12) anon20_Else_correct) (=> (= (ControlFlow 0 13) 3) anon21_Then_correct)) (=> (= (ControlFlow 0 13) 5) anon21_Else_correct)))))))
(let ((anon18_Else_correct  (=> (= i@@3 0) (and (=> (= (ControlFlow 0 17) 10) anon19_Then_correct) (=> (= (ControlFlow 0 17) 13) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (not (= i@@3 0)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm UnfoldingMask@4 this@@9 next)) (=> (HasDirectPerm UnfoldingMask@4 this@@9 next) (and (=> (= (ControlFlow 0 15) 10) anon19_Then_correct) (=> (= (ControlFlow 0 15) 13) anon19_Else_correct)))))))
(let ((anon4_correct  (=> (state Heap@@14 UnfoldingMask@4) (and (=> (= (ControlFlow 0 18) 15) anon18_Then_correct) (=> (= (ControlFlow 0 18) 17) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (= (MapType0Select Heap@@14 this@@9 next) null) (=> (and (= UnfoldingMask@4 UnfoldingMask@2) (= (ControlFlow 0 20) 18)) anon4_correct))))
(let ((anon17_Then_correct  (=> (and (not (= (MapType0Select Heap@@14 this@@9 next) null)) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 null (valid (MapType0Select Heap@@14 this@@9 next)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 null (valid (MapType0Select Heap@@14 this@@9 next)))) FullPerm))))) (=> (and (and (InsidePredicate (valid this@@9) (MapType0Select Heap@@14 null (valid this@@9)) (valid (MapType0Select Heap@@14 this@@9 next)) (MapType0Select Heap@@14 null (valid (MapType0Select Heap@@14 this@@9 next)))) (state Heap@@14 UnfoldingMask@3)) (and (= UnfoldingMask@4 UnfoldingMask@3) (= (ControlFlow 0 19) 18))) anon4_correct))))
(let ((anon2_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (valid this@@9) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid this@@9))) FullPerm)))) (=> (and (not (= this@@9 null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this@@9 value (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this@@9 value)) FullPerm))))) (=> (and (and (state Heap@@14 UnfoldingMask@1) (not (= this@@9 null))) (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 this@@9 next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 this@@9 next)) FullPerm)))) (state Heap@@14 UnfoldingMask@2))) (and (=> (= (ControlFlow 0 21) 19) anon17_Then_correct) (=> (= (ControlFlow 0 21) 20) anon17_Else_correct)))))))
(let ((anon16_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 24) 21)) anon2_correct)))
(let ((anon16_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid this@@9))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid this@@9)))) (=> (= (ControlFlow 0 22) 21) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@14 this@@9 $allocated)) (= AssumeFunctionsAbove 0)) (and (= Mask@0 (MapType1Store ZeroMask null (valid this@@9) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid this@@9))) FullPerm)))) (state Heap@@14 Mask@0))) (and (and (<= 0 i@@3) (state Heap@@14 Mask@0)) (and (|valid#trigger| Heap@@14 (valid this@@9)) (= (MapType0Select Heap@@14 null (valid this@@9)) (CombineFrames (FrameFragment (MapType0Select Heap@@14 this@@9 value)) (CombineFrames (FrameFragment (MapType0Select Heap@@14 this@@9 next)) (FrameFragment (ite (not (= (MapType0Select Heap@@14 this@@9 next) null)) (MapType0Select Heap@@14 null (valid (MapType0Select Heap@@14 this@@9 next))) EmptyFrame)))))))) (and (=> (= (ControlFlow 0 25) 22) anon16_Then_correct) (=> (= (ControlFlow 0 25) 24) anon16_Else_correct))))))
