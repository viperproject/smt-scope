...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type UnfoldingMask@4) (MapType0Type RefType realType)) (= (type Heap@@19) (MapType1Type RefType))) (= (type x@@28) RefType)) (= (type Heap@1) (MapType1Type RefType))) (= (type newPMask@0) (MapType0Type RefType boolType))) (= (type Heap@2) (MapType1Type RefType))) (= (type Heap@3) (MapType1Type RefType))) (= (type Heap@0) (MapType1Type RefType))) (= (type UnfoldingMask@3) (MapType0Type RefType realType))) (= (type UnfoldingMask@2) (MapType0Type RefType realType))) (= (type UnfoldingMask@0) (MapType0Type RefType realType))) (= (type Mask@0) (MapType0Type RefType realType))) (= (type UnfoldingMask@1) (MapType0Type RefType realType))) (forall ((arg0@@51 T@U) (arg1@@80 T@U) ) (! (= (type (CombineFrames arg0@@51 arg1@@80)) FrameTypeType)
...
(let ((anon19_Else_correct  (=> (= (MapType1Select Heap@1 x@@28 next) null) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 7) 5)) anon13_correct))))
(let ((anon19_Then_correct  (=> (not (= (MapType1Select Heap@1 x@@28 next) null)) (=> (and (and (forall ((o_3 T@U) (f_8 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_8))))
(let ((A@@12 (FieldTypeInv0 (type f_8))))
 (=> (and (and (= (type o_3) RefType) (= (type f_8) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType0Select (MapType1Select Heap@1 null (|List#sm| x@@28)) o_3 f_8)) (U_2_bool (MapType0Select (MapType1Select Heap@1 null (|List#sm| (MapType1Select Heap@1 x@@28 next))) o_3 f_8)))) (U_2_bool (MapType0Select newPMask@0 o_3 f_8)))))
 :qid |stdinbpl.546:33|
 :skolemid |75|
 :pattern ( (MapType0Select newPMask@0 o_3 f_8))
)) (= Heap@2 (MapType1Store Heap@1 null (|List#sm| x@@28) newPMask@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 6) 5))) anon13_correct))))
(let ((anon11_correct  (=> (and (= Heap@0 (MapType1Store Heap@@19 null (|List#sm| x@@28) (MapType0Store (MapType1Select Heap@@19 null (|List#sm| x@@28)) x@@28 f_7 (bool_2_U true)))) (= Heap@1 (MapType1Store Heap@0 null (|List#sm| x@@28) (MapType0Store (MapType1Select Heap@0 null (|List#sm| x@@28)) x@@28 next (bool_2_U true))))) (and (=> (= (ControlFlow 0 8) 6) anon19_Then_correct) (=> (= (ControlFlow 0 8) 7) anon19_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (|length#trigger| (MapType1Select Heap@@19 null (List (MapType1Select Heap@@19 x@@28 next))) (MapType1Select Heap@@19 x@@28 next)) (= (ControlFlow 0 10) 8)) anon11_correct)))
(let ((anon16_Then_correct  (=> (and (= (MapType1Select Heap@@19 x@@28 next) null) (= (ControlFlow 0 9) 8)) anon11_correct)))
(let ((anon9_correct true))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon9_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType0Select UnfoldingMask@4 null (List (MapType1Select Heap@@19 x@@28 next)))))) (=> (<= FullPerm (U_2_real (MapType0Select UnfoldingMask@4 null (List (MapType1Select Heap@@19 x@@28 next))))) (=> (= (ControlFlow 0 2) 1) anon9_correct))))))
(let ((anon16_Else_correct  (=> (not (= (MapType1Select Heap@@19 x@@28 next) null)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm UnfoldingMask@4 x@@28 next)) (=> (HasDirectPerm UnfoldingMask@4 x@@28 next) (and (and (=> (= (ControlFlow 0 11) 10) anon17_Else_correct) (=> (= (ControlFlow 0 11) 2) anon18_Then_correct)) (=> (= (ControlFlow 0 11) 4) anon18_Else_correct)))))))
(let ((anon4_correct  (=> (state Heap@@19 UnfoldingMask@4) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm UnfoldingMask@4 x@@28 next)) (=> (HasDirectPerm UnfoldingMask@4 x@@28 next) (and (=> (= (ControlFlow 0 13) 9) anon16_Then_correct) (=> (= (ControlFlow 0 13) 11) anon16_Else_correct)))))))
(let ((anon15_Else_correct  (=> (= (MapType1Select Heap@@19 x@@28 next) null) (=> (and (= UnfoldingMask@4 UnfoldingMask@2) (= (ControlFlow 0 16) 13)) anon4_correct))))
(let ((anon15_Then_correct  (=> (and (not (= (MapType1Select Heap@@19 x@@28 next) null)) (= UnfoldingMask@3 (MapType0Store UnfoldingMask@2 null (List (MapType1Select Heap@@19 x@@28 next)) (real_2_U (+ (U_2_real (MapType0Select UnfoldingMask@2 null (List (MapType1Select Heap@@19 x@@28 next)))) FullPerm))))) (=> (and (and (InsidePredicate (List x@@28) (MapType1Select Heap@@19 null (List x@@28)) (List (MapType1Select Heap@@19 x@@28 next)) (MapType1Select Heap@@19 null (List (MapType1Select Heap@@19 x@@28 next)))) (state Heap@@19 UnfoldingMask@3)) (and (= UnfoldingMask@4 UnfoldingMask@3) (= (ControlFlow 0 15) 13))) anon4_correct))))
(let ((anon2_correct  (=> (= UnfoldingMask@0 (MapType0Store Mask@0 null (List x@@28) (real_2_U (- (U_2_real (MapType0Select Mask@0 null (List x@@28))) FullPerm)))) (=> (and (not (= x@@28 null)) (= UnfoldingMask@1 (MapType0Store UnfoldingMask@0 x@@28 f_7 (real_2_U (+ (U_2_real (MapType0Select UnfoldingMask@0 x@@28 f_7)) FullPerm))))) (=> (and (and (state Heap@@19 UnfoldingMask@1) (not (= x@@28 null))) (and (= UnfoldingMask@2 (MapType0Store UnfoldingMask@1 x@@28 next (real_2_U (+ (U_2_real (MapType0Select UnfoldingMask@1 x@@28 next)) FullPerm)))) (state Heap@@19 UnfoldingMask@2))) (and (=> (= (ControlFlow 0 17) 15) anon15_Then_correct) (=> (= (ControlFlow 0 17) 16) anon15_Else_correct)))))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 20) 17)) anon2_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (<= FullPerm (U_2_real (MapType0Select Mask@0 null (List x@@28))))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@0 null (List x@@28)))) (=> (= (ControlFlow 0 18) 17) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@19 ZeroMask) (U_2_bool (MapType1Select Heap@@19 x@@28 $allocated))) (and (= AssumeFunctionsAbove 0) (= Mask@0 (MapType0Store ZeroMask null (List x@@28) (real_2_U (+ (U_2_real (MapType0Select ZeroMask null (List x@@28))) FullPerm)))))) (and (and (state Heap@@19 Mask@0) (state Heap@@19 Mask@0)) (and (|List#trigger| Heap@@19 (List x@@28)) (= (MapType1Select Heap@@19 null (List x@@28)) (CombineFrames (FrameFragment (MapType1Select Heap@@19 x@@28 f_7)) (CombineFrames (FrameFragment (MapType1Select Heap@@19 x@@28 next)) (FrameFragment (ite (not (= (MapType1Select Heap@@19 x@@28 next) null)) (MapType1Select Heap@@19 null (List (MapType1Select Heap@@19 x@@28 next))) EmptyFrame)))))))) (and (=> (= (ControlFlow 0 21) 18) anon14_Then_correct) (=> (= (ControlFlow 0 21) 20) anon14_Else_correct)))))
