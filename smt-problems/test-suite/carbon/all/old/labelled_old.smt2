...
(assert  (and (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type z_4) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type z_5) RefType)) (= (type x@@8) RefType)) (= (type y@@1) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test05)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm Mask@1 z_5 f_7)) (= (ControlFlow 0 16) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm Mask@1 z_5 f_7) (and (=> (= (ControlFlow 0 11) (- 0 15)) (HasDirectPerm Mask@1 z_5 f_7)) (=> (HasDirectPerm Mask@1 z_5 f_7) (and (=> (= (ControlFlow 0 11) (- 0 14)) (HasDirectPerm Mask@1 z_5 f_7)) (=> (HasDirectPerm Mask@1 z_5 f_7) (and (=> (= (ControlFlow 0 11) (- 0 13)) true) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm Mask@1 z_5 f_7)) (=> (HasDirectPerm Mask@1 z_5 f_7) (=> (= (ControlFlow 0 11) 10) anon7_correct)))))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((z_3 T@U) ) (!  (=> (and (= (type z_3) RefType) (HasDirectPerm Mask@1 z_3 f_7)) (= (U_2_int (MapType0Select Heap@0 z_3 f_7)) (U_2_int (MapType0Select Heap@@9 z_3 f_7))))
 :qid |stdinbpl.769:15|
 :skolemid |25|
 :pattern ( (MapType1Select Mask@1 z_3 f_7))
 :pattern ( (MapType0Select Heap@0 z_3 f_7))
)))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((z_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (HasDirectPerm Mask@1 z_1 f_7)) (= (U_2_int (MapType0Select Heap@0 z_1 f_7)) (U_2_int (MapType0Select Heap@0 z_1 f_7))))
 :qid |stdinbpl.744:15|
 :skolemid |24|
 :pattern ( (MapType1Select Mask@1 z_1 f_7))
 :pattern ( (MapType0Select Heap@0 z_1 f_7))
))) (=> (forall ((z_1@@0 T@U) ) (!  (=> (and (= (type z_1@@0) RefType) (HasDirectPerm Mask@1 z_1@@0 f_7)) (= (U_2_int (MapType0Select Heap@0 z_1@@0 f_7)) (U_2_int (MapType0Select Heap@0 z_1@@0 f_7))))
 :qid |stdinbpl.744:15|
 :skolemid |24|
 :pattern ( (MapType1Select Mask@1 z_1@@0 f_7))
 :pattern ( (MapType0Select Heap@0 z_1@@0 f_7))
...
(let ((anon10_Else_correct  (=> (and (not (HasDirectPerm Mask@1 z_4 f_7)) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (HasDirectPerm Mask@1 z_4 f_7) (and (=> (= (ControlFlow 0 2) (- 0 6)) (HasDirectPerm Mask@1 z_4 f_7)) (=> (HasDirectPerm Mask@1 z_4 f_7) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm Mask@1 z_4 f_7)) (=> (HasDirectPerm Mask@1 z_4 f_7) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 z_4 f_7)) (=> (HasDirectPerm Mask@1 z_4 f_7) (=> (= (ControlFlow 0 2) 1) anon3_correct)))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated)) (U_2_bool (MapType0Select Heap@@9 y@@1 $allocated))) (=> (and (and (and (not (= x@@8 null)) (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm))))) (and (state Heap@@9 Mask@0) (not (= y@@1 null)))) (and (and (= Mask@1 (MapType1Store Mask@0 y@@1 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@1 f_7)) FullPerm)))) (state Heap@@9 Mask@1)) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1)))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (= FullPerm (U_2_real (MapType1Select Mask@1 y@@1 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 y@@1 f_7))) (=> (= Heap@0 (MapType0Store Heap@@9 y@@1 f_7 (int_2_U 0))) (=> (and (state Heap@0 Mask@1) (state Heap@0 Mask@1)) (and (and (=> (= (ControlFlow 0 19) 17) anon9_Else_correct) (=> (= (ControlFlow 0 19) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 19) 7) anon10_Else_correct)))))))))))
