...
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (= i@@34 (+ (- i@@34 1) 1)) (state PostHeap@0 ZeroMask)) (and (= (|Seq#Length| a_2) len) (state PostHeap@0 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i@@34 0)) (=> (>= i@@34 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i@@34 (|Seq#Length| a_2))) (=> (< i@@34 (|Seq#Length| a_2)) (=> (and (= perm@0 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@0 NoPerm))))))))))
(let ((anon0_correct  (=> (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@33 diz $allocated)) (not (= diz null))) (and (state Heap@@33 ZeroMask) (>= current_thread_id 0))) (and (and (state Heap@@33 ZeroMask) (<= 0 i@@34)) (and (< i@@34 (|Seq#Length| a_2)) (state Heap@@33 ZeroMask)))) (and (=> (= (ControlFlow 0 9) 2) anon5_Then_correct) (=> (= (ControlFlow 0 9) 6) anon5_Else_correct))))))
