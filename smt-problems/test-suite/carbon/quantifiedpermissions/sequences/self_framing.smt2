...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i1_2))) (= (ControlFlow 0 16) 12)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i1_2)) (and (=> (= (ControlFlow 0 13) (- 0 15)) (>= i1_2 0)) (=> (>= i1_2 0) (and (=> (= (ControlFlow 0 13) (- 0 14)) (< i1_2 (|Seq#Length| s@@17))) (=> (< i1_2 (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 13) 12) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (forall ((i1_3 Int) (i1_3_1 Int) ) (!  (=> (and (and (and (and (not (= i1_3 i1_3_1)) (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i1_3))) (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i1_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| s@@17 i1_3) (|Seq#Index| s@@17 i1_3_1))))
 :qid |stdinbpl.731:15|
 :skolemid |66|
))) (=> (forall ((i1_3@@0 Int) (i1_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i1_3@@0 i1_3_1@@0)) (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i1_3@@0))) (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i1_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| s@@17 i1_3@@0) (|Seq#Index| s@@17 i1_3_1@@0))))
 :qid |stdinbpl.731:15|
 :skolemid |66|
)) (=> (forall ((i1_3@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i1_3@@1)) (< NoPerm FullPerm)) (and (qpRange2 (|Seq#Index| s@@17 i1_3@@1)) (= (invRecv2 (|Seq#Index| s@@17 i1_3@@1)) i1_3@@1)))
 :qid |stdinbpl.737:22|
 :skolemid |67|
 :pattern ( (|Seq#Index| s@@17 i1_3@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 2) (int_2_U i1_3@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i1_3@@1)))
 :pattern ( (|Seq#Index| s@@17 i1_3@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U (invRecv2 o_3))) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (|Seq#Index| s@@17 (invRecv2 o_3)) o_3)))
 :qid |stdinbpl.741:22|
 :skolemid |68|
 :pattern ( (invRecv2 o_3))
)) (forall ((i1_3@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i1_3@@2)) (not (= (|Seq#Index| s@@17 i1_3@@2) null)))
 :qid |stdinbpl.747:22|
 :skolemid |69|
 :pattern ( (|Seq#Index| s@@17 i1_3@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 2) (int_2_U i1_3@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i1_3@@2)))
 :pattern ( (|Seq#Index| s@@17 i1_3@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| s@@17 (invRecv2 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.753:22|
 :skolemid |70|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< 0 (|Seq#Length| s@@17))) (=> (< 0 (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 9) (- 0 8)) (HasDirectPerm QPMask@0 (|Seq#Index| s@@17 0) f_7)))))))))))
(let ((anon9_Else_correct  (=> (and (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i1_1)) (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2_1)) (not (= i1_1 i2_1)))) (not (= (|Seq#Index| s@@17 i1_1) (|Seq#Index| s@@17 i2_1))))
 :qid |stdinbpl.713:20|
 :skolemid |65|
...
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 17) 9) anon11_Else_correct) (=> (= (ControlFlow 0 17) 13) anon12_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon12_Else_correct)))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i1)) (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2)) (not (= i1 i2))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i1)) (and (|Seq#Contains| (|Seq#Range| 0 2) (int_2_U i2)) (not (= i1 i2)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1 0)) (=> (>= i1 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1 (|Seq#Length| s@@17))) (=> (< i1 (|Seq#Length| s@@17)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2 0)) (=> (>= i2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2 (|Seq#Length| s@@17))) (=> (< i2 (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (> (|Seq#Length| s@@17) 2) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 18) 17) anon9_Else_correct) (=> (= (ControlFlow 0 18) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 18) 7) anon10_Else_correct))))))
