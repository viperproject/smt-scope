...
(assert  (and (and (and (and (and (= (type S1) (SeqType RefType)) (= (type S2) (MapType2Type RefType boolType))) (= (type y_2) RefType)) (= (type PostHeap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type x@@22) RefType)))
(set-info :boogie-vc-id m03)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon16_Else_correct true))
(let ((anon16_Then_correct true))
(let ((anon15_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 13) 11) anon16_Then_correct) (=> (= (ControlFlow 0 13) 12) anon16_Else_correct)))))
(let ((anon11_correct true))
(let ((anon18_Else_correct  (=> (and (not (U_2_bool (MapType2Select S2 y_2))) (= (ControlFlow 0 10) 7)) anon11_correct)))
(let ((anon18_Then_correct  (=> (U_2_bool (MapType2Select S2 y_2)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (not (= y_2 null))) (=> (not (= y_2 null)) (=> (= (ControlFlow 0 8) 7) anon11_correct))))))
(let ((anon17_Else_correct true))
(let ((anon13_Else_correct  (=> (and (forall ((i_1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U i_1)) (not (= (|Seq#Index| S1 i_1) null)))
 :qid |stdinbpl.1177:20|
 :skolemid |154|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U i_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U i_1)))
 :pattern ( (|Seq#Index| S1 i_1))
)) (state Heap@@9 ZeroMask)) (and (and (and (=> (= (ControlFlow 0 14) 13) anon15_Then_correct) (=> (= (ControlFlow 0 14) 6) anon17_Else_correct)) (=> (= (ControlFlow 0 14) 8) anon18_Then_correct)) (=> (= (ControlFlow 0 14) 10) anon18_Else_correct)))))
(let ((anon3_correct true))
(let ((anon14_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U i_3))) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon14_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U i_3)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i_3 0)) (=> (>= i_3 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i_3 (|Seq#Length| S1))) (=> (< i_3 (|Seq#Length| S1)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 x@@22 $allocated)) (|Seq#Equal| S1 (|Seq#Singleton| x@@22))) (and (|Set#Equal| S2 (|Set#Singleton| x@@22)) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 15) 14) anon13_Else_correct) (=> (= (ControlFlow 0 15) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 15) 5) anon14_Else_correct))))))
