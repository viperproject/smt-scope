...
(assert  (and (and (and (and (and (and (and (= (type QPMask@1) (MapType1Type RefType realType)) (= (type x@@19) RefType)) (= (type ys) (MapType2Type RefType boolType))) (= (type Heap@@9) (MapType0Type RefType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv6 arg0@@43)) RefType)
 :qid |funType:invRecv6|
 :pattern ( (invRecv6 arg0@@43))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type xs) (MapType2Type RefType boolType))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv5 arg0@@44)) RefType)
...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select QPMask@1 x@@19 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@1 x@@19 f_7))) (=> (= (ControlFlow 0 4) 3) anon6_correct))))))
...
)) (=> (and (forall ((y_1@@1 T@U) ) (!  (=> (= (type y_1@@1) RefType) (=> (and (U_2_bool (MapType2Select ys y_1@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange6 y_1@@1) (= (invRecv6 y_1@@1) y_1@@1))))
 :qid |stdinbpl.886:22|
 :skolemid |114|
 :pattern ( (MapType0Select Heap@@9 y_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 y_1@@1 f_7))
 :pattern ( (MapType2Select ys y_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select ys (invRecv6 o_3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange6 o_3)) (= (invRecv6 o_3) o_3)))
 :qid |stdinbpl.890:22|
 :skolemid |115|
...
)) (=> (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select ys (invRecv6 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange6 o_3@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv6 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (U_2_bool (MapType2Select ys (invRecv6 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange6 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7))))))
 :qid |stdinbpl.908:22|
 :skolemid |118|
...
))) (=> (and (and (and (state Heap@@9 QPMask@1) (state Heap@@9 QPMask@1)) (and (U_2_bool (MapType2Select xs x@@19)) (state Heap@@9 QPMask@1))) (and (and (U_2_bool (MapType2Select ys x@@19)) (state Heap@@9 QPMask@1)) (and (not (= x@@19 null)) (state Heap@@9 QPMask@1)))) (and (=> (= (ControlFlow 0 7) 4) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct))))))))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 12)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (U_2_bool (MapType2Select xs z_1))) (U_2_bool (MapType2Select xs z_1_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= z_1 z_1_1))))
 :qid |stdinbpl.834:15|
 :skolemid |106|
 :no-pattern (type z_1)
...
))) (=> (forall ((z_1@@0 T@U) (z_1_1@@0 T@U) ) (!  (=> (and (= (type z_1@@0) RefType) (= (type z_1_1@@0) RefType)) (=> (and (and (and (and (not (= z_1@@0 z_1_1@@0)) (U_2_bool (MapType2Select xs z_1@@0))) (U_2_bool (MapType2Select xs z_1_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= z_1@@0 z_1_1@@0))))
 :qid |stdinbpl.834:15|
 :skolemid |106|
...
)) (=> (and (forall ((z_1@@1 T@U) ) (!  (=> (= (type z_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs z_1@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange5 z_1@@1) (= (invRecv5 z_1@@1) z_1@@1))))
 :qid |stdinbpl.840:22|
 :skolemid |107|
 :pattern ( (MapType0Select Heap@@9 z_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@1 f_7))
 :pattern ( (MapType2Select xs z_1@@1))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv5 o_3@@2))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange5 o_3@@2)) (= (invRecv5 o_3@@2) o_3@@2)))
 :qid |stdinbpl.844:22|
 :skolemid |108|
 :pattern ( (invRecv5 o_3@@2))
))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((z_1@@2 T@U) ) (!  (=> (and (= (type z_1@@2) RefType) (U_2_bool (MapType2Select xs z_1@@2))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.850:15|
 :skolemid |109|
 :pattern ( (MapType0Select Heap@@9 z_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@2 f_7))
 :pattern ( (MapType2Select xs z_1@@2))
))) (=> (forall ((z_1@@3 T@U) ) (!  (=> (and (= (type z_1@@3) RefType) (U_2_bool (MapType2Select xs z_1@@3))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.850:15|
 :skolemid |109|
 :pattern ( (MapType0Select Heap@@9 z_1@@3 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@3 f_7))
 :pattern ( (MapType2Select xs z_1@@3))
)) (=> (forall ((z_1@@4 T@U) ) (!  (=> (= (type z_1@@4) RefType) (=> (and (U_2_bool (MapType2Select xs z_1@@4)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= z_1@@4 null))))
 :qid |stdinbpl.856:22|
 :skolemid |110|
 :pattern ( (MapType0Select Heap@@9 z_1@@4 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@4 f_7))
 :pattern ( (MapType2Select xs z_1@@4))
)) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs (invRecv5 o_3@@3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange5 o_3@@3)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv5 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 f_7)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (U_2_bool (MapType2Select xs (invRecv5 o_3@@3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange5 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@3 f_7))))))
 :qid |stdinbpl.862:22|
 :skolemid |111|
...
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@19 $allocated))) (and (=> (= (ControlFlow 0 13) 1) anon7_Then_correct) (=> (= (ControlFlow 0 13) 10) anon7_Else_correct)))))
