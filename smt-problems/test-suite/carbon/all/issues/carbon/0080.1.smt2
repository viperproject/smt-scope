...
(assert  (and (and (and (and (and (= (type UnfoldingMask@0) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type self@@9) RefType)) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Heap@@14) (MapType0Type RefType))) (forall ((arg0@@28 T@U) ) (! (= (type (FrameFragment arg0@@28)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@28))
))))
(set-info :boogie-vc-id |readValid#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon2_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (valid self@@9) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid self@@9))) perm@1)))) (= perm@2 (* FullPerm (/ (to_real 1) (to_real 4))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (=> (> perm@2 NoPerm) (not (= self@@9 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 self@@9 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 self@@9 f_7)) perm@2)))) (state Heap@@14 UnfoldingMask@1)) (and (state Heap@@14 UnfoldingMask@1) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm UnfoldingMask@1 self@@9 f_7))))))))
(let ((anon3_Else_correct  (=> (and (= perm@1 NoPerm) (= (ControlFlow 0 6) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= perm@1 NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= perm@1 (U_2_real (MapType1Select Mask@0 null (valid self@@9))))) (=> (<= perm@1 (U_2_real (MapType1Select Mask@0 null (valid self@@9)))) (=> (= (ControlFlow 0 4) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@14 ZeroMask) (U_2_bool (MapType0Select Heap@@14 self@@9 $allocated))) (and (= AssumeFunctionsAbove 0) (= perm@0 (/ (to_real 1) (to_real 4))))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (= Mask@0 (MapType1Store ZeroMask null (valid self@@9) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid self@@9))) perm@0)))) (state Heap@@14 Mask@0)) (=> (and (and (state Heap@@14 Mask@0) (|valid#trigger| Heap@@14 (valid self@@9))) (and (= (MapType0Select Heap@@14 null (valid self@@9)) (FrameFragment (MapType0Select Heap@@14 self@@9 f_7))) (= perm@1 (/ (to_real 1) (to_real 4))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (and (=> (= (ControlFlow 0 7) 4) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct)))))))))))
