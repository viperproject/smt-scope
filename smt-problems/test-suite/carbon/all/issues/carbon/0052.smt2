...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (= FullPerm (U_2_real (MapType1Select Mask@0 this x@@8)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 this x@@8))) (=> (= Heap@0 (MapType0Store Heap@@9 this x@@8 (int_2_U 1))) (=> (and (state Heap@0 Mask@0) (= (ControlFlow 0 4) (- 0 3))) (= (U_2_int (MapType0Select Heap@0 this x@@8)) 1)))))))
