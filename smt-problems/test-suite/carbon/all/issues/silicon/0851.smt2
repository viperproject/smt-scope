...
(assert  (and (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type x@@12) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |fun01#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (U_2_bool (MapType0Select Heap@@13 x@@12 $allocated))) (and (= AssumeFunctionsAbove 0) (= perm@0 (/ (to_real 1) (to_real 3))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= x@@12 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask x@@12 v_2 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@12 v_2)) perm@0)))) (state Heap@@13 Mask@0)) (and (state Heap@@13 Mask@0) (= perm@1 (ite b1@@3 (/ (to_real 1) (to_real 3)) NoPerm)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (=> (> perm@1 NoPerm) (not (= x@@12 null))) (=> (and (and (= Mask@1 (MapType1Store Mask@0 x@@12 v_2 (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@12 v_2)) perm@1)))) (state Heap@@13 Mask@1)) (and (state Heap@@13 Mask@1) (= perm@2 (ite b2@@3 (/ (to_real 1) (to_real 3)) NoPerm)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (=> (> perm@2 NoPerm) (not (= x@@12 null))) (=> (and (and (= Mask@2 (MapType1Store Mask@1 x@@12 v_2 (real_2_U (+ (U_2_real (MapType1Select Mask@1 x@@12 v_2)) perm@2)))) (state Heap@@13 Mask@2)) (and (state Heap@@13 Mask@2) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@2 x@@12 v_2))))))))))))))))
