(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:17:40
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0122.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (not (forall ((x1@3@00 $Ref) (x2@3@00 $Ref)) (!
  (=>
    (and (Set_in x1@3@00 xs@0@00) (Set_in x2@3@00 xs@0@00) (= x1@3@00 x2@3@00))
    (= x1@3@00 x2@3@00))
...
(push) ; 2
(assert (not (and
  (img@5@00 s@$ xs@0@00 y@1@00 y@1@00)
  (Set_in (inv@4@00 s@$ xs@0@00 y@1@00 y@1@00) xs@0@00))))
(check-sat)
; unsat
(pop) ; 2
; 0,00s
