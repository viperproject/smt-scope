...
(assert  (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type this) RefType)) (= (type r_1) RefType)) (= (type freshObj@0) RefType)) (= (type Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id t3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 this $allocated)) (U_2_bool (MapType0Select Heap@@9 r_1 $allocated))) (=> (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@9 freshObj@0 $allocated)))) (and (= Heap@0 (MapType0Store Heap@@9 freshObj@0 $allocated (bool_2_U true))) (state Heap@0 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm ZeroMask freshObj@0 f_7)) (=> (HasDirectPerm ZeroMask freshObj@0 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (> (U_2_int (MapType0Select Heap@@9 freshObj@0 f_7)) 0)))))))))
