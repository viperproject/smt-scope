...
(set-info :boogie-vc-id |function7#definedness|)
...
(assert  (and (and (and (= (type e) RefType) (= (type Heap@@46) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id client2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (function11 Heap@@46 (|Set#Singleton| e)))))
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((e$0 T@U) (e$0_1 T@U) ) (!  (=> (and (= (type e$0) RefType) (= (type e$0_1) RefType)) (=> (and (and (and (and (not (= e$0 e$0_1)) (U_2_bool (MapType2Select (|Set#Singleton| e) e$0))) (U_2_bool (MapType2Select (|Set#Singleton| e) e$0_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= e$0 e$0_1))))
 :qid |stdinbpl.1552:21|
 :skolemid |168|
 :pattern ( (neverTriggered2 e$0) (neverTriggered2 e$0_1))
))) (=> (forall ((e$0@@0 T@U) (e$0_1@@0 T@U) ) (!  (=> (and (= (type e$0@@0) RefType) (= (type e$0_1@@0) RefType)) (=> (and (and (and (and (not (= e$0@@0 e$0_1@@0)) (U_2_bool (MapType2Select (|Set#Singleton| e) e$0@@0))) (U_2_bool (MapType2Select (|Set#Singleton| e) e$0_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= e$0@@0 e$0_1@@0))))
 :qid |stdinbpl.1552:21|
 :skolemid |168|
 :pattern ( (neverTriggered2 e$0@@0) (neverTriggered2 e$0_1@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((e$0@@1 T@U) ) (!  (=> (and (= (type e$0@@1) RefType) (U_2_bool (MapType2Select (|Set#Singleton| e) e$0@@1))) (>= (U_2_real (MapType1Select Mask@0 e$0@@1 f_7)) FullPerm))
 :qid |stdinbpl.1559:21|
 :skolemid |169|
 :pattern ( (MapType0Select Heap@@46 e$0@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 e$0@@1 f_7))
 :pattern ( (MapType2Select (|Set#Singleton| e) e$0@@1))
)))))))
(let ((anon0_correct  (=> (state Heap@@46 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@46 e $allocated))) (=> (and (and (not (= e null)) (= Mask@0 (MapType1Store ZeroMask e f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask e f_7)) FullPerm))))) (and (state Heap@@46 Mask@0) (state Heap@@46 Mask@0))) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))))
