...
(declare-fun |getField01'| (T@U T@U T@U) Int)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |getField01#triggerStateless| (T@U T@U) Int)
...
(declare-fun |getField'| (T@U T@U) Int)
(declare-fun |getField#triggerStateless| (T@U) Int)
...
(declare-fun |getField#frame| (T@U T@U) Int)
...
(declare-fun |getField01#frame| (T@U T@U T@U) Int)
...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type fld) (FieldType NormalFieldType intType))) (forall ((arg0@@14 T@T) (arg1@@2 T@T) ) (! (= (Ctor (MapType0Type arg0@@14 arg1@@2)) 8)
...
(= (type (MapType0Store arg0@@18 arg1@@6 arg2)) (MapType0Type aVar0 aVar1@@0))))
 ...
 :weight 0
)))) (= (Ctor RefType) 9)) (= (type col) (FieldType NormalFieldType (MapType0Type RefType boolType)))))
(assert (distinct $allocated fld col)
)
...
(assert (forall ((Heap@@0 T@U) (xs T@U) (y@@1 T@U) ) (!  (=> (and (and (= (type Heap@@0) (MapType1Type RefType)) (= (type xs) (MapType0Type RefType boolType))) (= (type y@@1) RefType)) (dummyFunction (int_2_U (|getField01#triggerStateless| xs y@@1))))
 :qid |stdinbpl.573:15|
 :skolemid |95|
 :pattern ( (|getField01'| Heap@@0 xs y@@1))
)))
...
(assert  (and (= (Ctor PredicateType_invType) 14) (forall ((arg0@@35 T@U) ) (! (= (type (inv arg0@@35)) (FieldType PredicateType_invType FrameTypeType))
 :qid |funType:inv|
 :pattern ( (inv arg0@@35))
))))
(assert (forall ((collection T@U) ) (!  (=> (= (type collection) (MapType0Type RefType boolType)) (IsPredicateField (inv collection)))
 :qid |stdinbpl.704:15|
 :skolemid |107|
 :pattern ( (inv collection))
)))
(assert (forall ((Heap@@3 T@U) (this T@U) ) (!  (=> (and (= (type Heap@@3) (MapType1Type RefType)) (= (type this) RefType)) (dummyFunction (int_2_U (|getField#triggerStateless| this))))
 :qid |stdinbpl.428:15|
 :skolemid |83|
 :pattern ( (|getField'| Heap@@3 this))
)))
(assert (forall ((Heap@@4 T@U) (collection@@0 T@U) ) (!  (=> (and (= (type Heap@@4) (MapType1Type RefType)) (= (type collection@@0) (MapType0Type RefType boolType))) (|inv#everUsed| (inv collection@@0)))
 :qid |stdinbpl.723:15|
 :skolemid |111|
 :pattern ( (|inv#trigger| Heap@@4 (inv collection@@0)))
)))
(assert (forall ((arg0@@36 Int) (arg1@@17 Int) ) (! (= (type (|sk_inv#condqp1| arg0@@36 arg1@@17)) RefType)
 :qid |funType:sk_inv#condqp1|
 :pattern ( (|sk_inv#condqp1| arg0@@36 arg1@@17))
)))
(assert (forall ((Heap2Heap T@U) (Heap1Heap T@U) (collection@@1 T@U) ) (!  (=> (and (and (and (= (type Heap2Heap) (MapType1Type RefType)) (= (type Heap1Heap) (MapType1Type RefType))) (= (type collection@@1) (MapType0Type RefType boolType))) (and (=  (and (U_2_bool (MapType0Select collection@@1 (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap collection@@1) (|inv#condqp1| Heap1Heap collection@@1)))) (< NoPerm FullPerm))  (and (U_2_bool (MapType0Select collection@@1 (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap collection@@1) (|inv#condqp1| Heap1Heap collection@@1)))) (< NoPerm FullPerm))) (=> (and (U_2_bool (MapType0Select collection@@1 (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap collection@@1) (|inv#condqp1| Heap1Heap collection@@1)))) (< NoPerm FullPerm)) (= (U_2_int (MapType1Select Heap2Heap (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap collection@@1) (|inv#condqp1| Heap1Heap collection@@1)) fld)) (U_2_int (MapType1Select Heap1Heap (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap collection@@1) (|inv#condqp1| Heap1Heap collection@@1)) fld)))))) (= (|inv#condqp1| Heap2Heap collection@@1) (|inv#condqp1| Heap1Heap collection@@1)))
 :qid |stdinbpl.734:15|
 :skolemid |112|
 :pattern ( (|inv#condqp1| Heap2Heap collection@@1) (|inv#condqp1| Heap1Heap collection@@1) (succHeapTrans Heap2Heap Heap1Heap))
)))
...
(assert (forall ((arg0@@37 T@U) (arg1@@18 T@U) ) (! (let ((T@@4 (MapType0TypeInv0 (type arg0@@37))))
(= (type (|Set#Union| arg0@@37 arg1@@18)) (MapType0Type T@@4 boolType)))
...
(assert (forall ((arg0@@38 T@U) (arg1@@19 T@U) ) (! (let ((T@@6 (MapType0TypeInv0 (type arg0@@38))))
(= (type (|Set#Intersection| arg0@@38 arg1@@19)) (MapType0Type T@@6 boolType)))
...
(= (type (|Set#Singleton| arg0@@39)) (MapType0Type T@@9 boolType)))
...
(assert (forall ((Heap@@5 T@U) (Mask@@2 T@U) (xs@@0 T@U) (y@@3 T@U) ) (!  (=> (and (and (and (and (and (= (type Heap@@5) (MapType1Type RefType)) (= (type Mask@@2) (MapType2Type RefType realType))) (= (type xs@@0) (MapType0Type RefType boolType))) (= (type y@@3) RefType)) (and (state Heap@@5 Mask@@2) (< AssumeFunctionsAbove 1))) (U_2_bool (MapType0Select xs@@0 y@@3))) (= (getField01 Heap@@5 xs@@0 y@@3) (U_2_int (MapType1Select Heap@@5 y@@3 fld))))
 :qid |stdinbpl.579:15|
 :skolemid |96|
 :pattern ( (state Heap@@5 Mask@@2) (getField01 Heap@@5 xs@@0 y@@3))
 :pattern ( (state Heap@@5 Mask@@2) (|getField01#triggerStateless| xs@@0 y@@3) (|inv#trigger| Heap@@5 (inv xs@@0)))
)))
...
(assert (forall ((Heap@@6 T@U) (ExhaleHeap@@1 T@U) (Mask@@3 T@U) (o_1 T@U) ) (!  (=> (and (and (and (and (and (= (type Heap@@6) (MapType1Type RefType)) (= (type ExhaleHeap@@1) (MapType1Type RefType))) (= (type Mask@@3) (MapType2Type RefType realType))) (= (type o_1) RefType)) (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@1 Mask@@3)) (U_2_bool (MapType1Select Heap@@6 o_1 $allocated))) (U_2_bool (MapType1Select ExhaleHeap@@1 o_1 $allocated)))
 :qid |stdinbpl.73:15|
 :skolemid |8|
 :pattern ( (IdenticalOnKnownLocations Heap@@6 ExhaleHeap@@1 Mask@@3) (MapType1Select ExhaleHeap@@1 o_1 $allocated))
)))
(assert (forall ((Heap@@7 T@U) (this@@0 T@U) ) (!  (=> (and (= (type Heap@@7) (MapType1Type RefType)) (= (type this@@0) RefType)) (and (= (getField Heap@@7 this@@0) (|getField'| Heap@@7 this@@0)) (dummyFunction (int_2_U (|getField#triggerStateless| this@@0)))))
 :qid |stdinbpl.424:15|
 :skolemid |82|
 :pattern ( (getField Heap@@7 this@@0))
)))
...
(assert (forall ((collection@@2 T@U) (collection2 T@U) ) (!  (=> (and (and (= (type collection@@2) (MapType0Type RefType boolType)) (= (type collection2) (MapType0Type RefType boolType))) (= (inv collection@@2) (inv collection2))) (= collection@@2 collection2))
 :qid |stdinbpl.714:15|
 :skolemid |109|
 :pattern ( (inv collection@@2) (inv collection2))
)))
(assert (forall ((arg0@@40 T@U) ) (! (= (type (|inv#sm| arg0@@40)) (FieldType PredicateType_invType (MapType2Type RefType boolType)))
 :qid |funType:inv#sm|
 :pattern ( (|inv#sm| arg0@@40))
)))
(assert (forall ((collection@@3 T@U) (collection2@@0 T@U) ) (!  (=> (and (and (= (type collection@@3) (MapType0Type RefType boolType)) (= (type collection2@@0) (MapType0Type RefType boolType))) (= (|inv#sm| collection@@3) (|inv#sm| collection2@@0))) (= collection@@3 collection2@@0))
 :qid |stdinbpl.718:15|
 :skolemid |110|
 :pattern ( (|inv#sm| collection@@3) (|inv#sm| collection2@@0))
)))
...
(assert (forall ((arg0@@41 T@U) (arg1@@20 T@U) ) (! (let ((T@@13 (type arg1@@20)))
(= (type (|MultiSet#UnionOne| arg0@@41 arg1@@20)) (MultiSetType T@@13)))
 :qid |funType:MultiSet#UnionOne|
 :pattern ( (|MultiSet#UnionOne| arg0@@41 arg1@@20))
)))
...
(assert  (not (IsPredicateField fld)))
(assert  (not (IsWandField fld)))
(assert  (not (IsPredicateField col)))
(assert  (not (IsWandField col)))
...
(assert  (and (forall ((arg0@@43 Real) (arg1@@21 T@U) ) (! (= (type (ConditionalFrame arg0@@43 arg1@@21)) FrameTypeType)
...
(assert (forall ((Heap@@10 T@U) (xs@@1 T@U) (y@@4 T@U) ) (!  (=> (and (and (= (type Heap@@10) (MapType1Type RefType)) (= (type xs@@1) (MapType0Type RefType boolType))) (= (type y@@4) RefType)) (and (= (getField01 Heap@@10 xs@@1 y@@4) (|getField01'| Heap@@10 xs@@1 y@@4)) (dummyFunction (int_2_U (|getField01#triggerStateless| xs@@1 y@@4)))))
 :qid |stdinbpl.569:15|
 :skolemid |94|
 :pattern ( (getField01 Heap@@10 xs@@1 y@@4))
)))
(assert (forall ((Heap@@11 T@U) (Mask@@7 T@U) (this@@1 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@11) (MapType1Type RefType)) (= (type Mask@@7) (MapType2Type RefType realType))) (= (type this@@1) RefType)) (and (state Heap@@11 Mask@@7) (< AssumeFunctionsAbove 0))) (U_2_bool (MapType0Select (MapType1Select Heap@@11 this@@1 col) this@@1))) (= (getField Heap@@11 this@@1) (U_2_int (MapType1Select Heap@@11 this@@1 fld))))
 :qid |stdinbpl.434:15|
 :skolemid |84|
 :pattern ( (state Heap@@11 Mask@@7) (getField Heap@@11 this@@1))
 :pattern ( (state Heap@@11 Mask@@7) (|getField#triggerStateless| this@@1) (|inv#trigger| Heap@@11 (inv (MapType1Select Heap@@11 this@@1 col))))
)))
...
(assert  (and (forall ((arg0@@44 T@U) (arg1@@22 T@U) ) (! (= (type (CombineFrames arg0@@44 arg1@@22)) FrameTypeType)
 :qid |funType:CombineFrames|
 :pattern ( (CombineFrames arg0@@44 arg1@@22))
)) (forall ((arg0@@45 T@U) ) (! (= (type (FrameFragment arg0@@45)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@45))
))))
(assert (forall ((Heap@@12 T@U) (Mask@@8 T@U) (this@@2 T@U) ) (!  (=> (and (and (and (= (type Heap@@12) (MapType1Type RefType)) (= (type Mask@@8) (MapType2Type RefType realType))) (= (type this@@2) RefType)) (state Heap@@12 Mask@@8)) (= (|getField'| Heap@@12 this@@2) (|getField#frame| (CombineFrames (FrameFragment (MapType1Select Heap@@12 this@@2 col)) (MapType1Select Heap@@12 null (inv (MapType1Select Heap@@12 this@@2 col)))) this@@2)))
 :qid |stdinbpl.441:15|
 :skolemid |85|
 :pattern ( (state Heap@@12 Mask@@8) (|getField'| Heap@@12 this@@2))
)))
(assert (forall ((arg0@@46 T@U) (arg1@@23 T@U) ) (! (let ((T@@20 (MapType0TypeInv0 (type arg0@@46))))
(= (type (|Set#Difference| arg0@@46 arg1@@23)) (MapType0Type T@@20 boolType)))
 :qid |funType:Set#Difference|
 :pattern ( (|Set#Difference| arg0@@46 arg1@@23))
)))
...
(assert (forall ((arg0@@47 T@U) (arg1@@24 T@U) ) (! (let ((T@@24 (type arg1@@24)))
(= (type (|Set#UnionOne| arg0@@47 arg1@@24)) (MapType0Type T@@24 boolType)))
 :qid |funType:Set#UnionOne|
 :pattern ( (|Set#UnionOne| arg0@@47 arg1@@24))
)))
(assert (forall ((a@@16 T@U) (x@@9 T@U) (y@@5 T@U) ) (! (let ((T@@25 (type x@@9)))
 (=> (and (and (= (type a@@16) (MapType0Type T@@25 boolType)) (= (type y@@5) T@@25)) (U_2_bool (MapType0Select a@@16 y@@5))) (U_2_bool (MapType0Select (|Set#UnionOne| a@@16 x@@9) y@@5))))
 :qid |stdinbpl.241:18|
 :skolemid |31|
 :pattern ( (|Set#UnionOne| a@@16 x@@9) (MapType0Select a@@16 y@@5))
)))
(assert (forall ((a@@17 T@U) (b@@14 T@U) (y@@6 T@U) ) (! (let ((T@@26 (type y@@6)))
 (=> (and (and (= (type a@@17) (MapType0Type T@@26 boolType)) (= (type b@@14) (MapType0Type T@@26 boolType))) (U_2_bool (MapType0Select a@@17 y@@6))) (U_2_bool (MapType0Select (|Set#Union| a@@17 b@@14) y@@6))))
 :qid |stdinbpl.251:18|
 :skolemid |35|
 :pattern ( (|Set#Union| a@@17 b@@14) (MapType0Select a@@17 y@@6))
)))
(assert (forall ((a@@18 T@U) (b@@15 T@U) (y@@7 T@U) ) (! (let ((T@@27 (type y@@7)))
 (=> (and (and (= (type a@@18) (MapType0Type T@@27 boolType)) (= (type b@@15) (MapType0Type T@@27 boolType))) (U_2_bool (MapType0Select b@@15 y@@7))) (U_2_bool (MapType0Select (|Set#Union| a@@18 b@@15) y@@7))))
 :qid |stdinbpl.253:18|
 :skolemid |36|
 :pattern ( (|Set#Union| a@@18 b@@15) (MapType0Select b@@15 y@@7))
)))
...
(assert (forall ((a@@20 T@U) (b@@16 T@U) (y@@8 T@U) ) (! (let ((T@@30 (type y@@8)))
 (=> (and (and (= (type a@@20) (MapType0Type T@@30 boolType)) (= (type b@@16) (MapType0Type T@@30 boolType))) (U_2_bool (MapType0Select b@@16 y@@8))) (not (U_2_bool (MapType0Select (|Set#Difference| a@@20 b@@16) y@@8)))))
 :qid |stdinbpl.278:18|
 :skolemid |44|
 :pattern ( (|Set#Difference| a@@20 b@@16) (MapType0Select b@@16 y@@8))
)))
...
(assert (forall ((collection@@4 T@U) ) (!  (=> (= (type collection@@4) (MapType0Type RefType boolType)) (= (getPredWandId (inv collection@@4)) 0))
 :qid |stdinbpl.708:15|
 :skolemid |108|
 :pattern ( (inv collection@@4))
)))
...
(assert (forall ((o@@8 T@U) (f T@U) (Heap@@15 T@U) ) (!  (=> (and (and (and (= (type o@@8) RefType) (= (type f) (FieldType NormalFieldType RefType))) (= (type Heap@@15) (MapType1Type RefType))) (U_2_bool (MapType1Select Heap@@15 o@@8 $allocated))) (U_2_bool (MapType1Select Heap@@15 (MapType1Select Heap@@15 o@@8 f) $allocated)))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (MapType1Select Heap@@15 o@@8 f))
)))
...
(assert (forall ((collection@@5 T@U) ) (!  (=> (= (type collection@@5) (MapType0Type RefType boolType)) (= (PredicateMaskField (inv collection@@5)) (|inv#sm| collection@@5)))
 :qid |stdinbpl.700:15|
 :skolemid |106|
 :pattern ( (PredicateMaskField (inv collection@@5)))
)))
...
(let ((A@@9 (FieldTypeInv0 (type f_3))))
 (=> (and (and (= (type Heap@@16) (MapType1Type RefType)) (= (type o@@11) RefType)) (= (type f_3) (FieldType A@@9 B@@8))) (succHeap Heap@@16 (MapType1Store Heap@@16 o@@11 f_3 v)))))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (MapType1Store Heap@@16 o@@11 f_3 v))
)))
...
(assert (forall ((Heap@@17 T@U) (Mask@@12 T@U) (xs@@2 T@U) (y@@9 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@17) (MapType1Type RefType)) (= (type Mask@@12) (MapType2Type RefType realType))) (= (type xs@@2) (MapType0Type RefType boolType))) (= (type y@@9) RefType)) (state Heap@@17 Mask@@12)) (= (|getField01'| Heap@@17 xs@@2 y@@9) (|getField01#frame| (MapType1Select Heap@@17 null (inv xs@@2)) xs@@2 y@@9)))
 :qid |stdinbpl.586:15|
 :skolemid |97|
 :pattern ( (state Heap@@17 Mask@@12) (|getField01'| Heap@@17 xs@@2 y@@9))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type xs@@3) (MapType0Type RefType boolType)) (= (type Heap@5) (MapType1Type RefType))) (= (type QPMask@2) (MapType2Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv7 arg0@@48)) RefType)
 :qid |funType:invRecv7|
 :pattern ( (invRecv7 arg0@@48))
))) (= (type Mask@1) (MapType2Type RefType realType))) (= (type x@@19) RefType)) (= (type Heap@4) (MapType1Type RefType))) (= (type Heap@3) (MapType1Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@0) (MapType2Type RefType realType))) (= (type newPMask@0) (MapType2Type RefType boolType))) (= (type Heap@2) (MapType1Type RefType))) (= (type Heap@0) (MapType1Type RefType))) (= (type Heap@@18) (MapType1Type RefType))) (= (type Heap@1) (MapType1Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@49 T@U) ) (! (= (type (invRecv5 arg0@@49)) RefType)
 :qid |funType:invRecv5|
 :pattern ( (invRecv5 arg0@@49))
))) (= (type QPMask@1) (MapType2Type RefType realType))) (forall ((arg0@@50 T@U) ) (! (= (type (invRecv6 arg0@@50)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon8_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((x$0_2 T@U) (x$0_2_1 T@U) ) (!  (=> (and (= (type x$0_2) RefType) (= (type x$0_2_1) RefType)) (=> (and (and (and (and (not (= x$0_2 x$0_2_1)) (U_2_bool (MapType0Select xs@@3 x$0_2))) (U_2_bool (MapType0Select xs@@3 x$0_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x$0_2 x$0_2_1))))
...
))) (=> (forall ((x$0_2@@0 T@U) (x$0_2_1@@0 T@U) ) (!  (=> (and (= (type x$0_2@@0) RefType) (= (type x$0_2_1@@0) RefType)) (=> (and (and (and (and (not (= x$0_2@@0 x$0_2_1@@0)) (U_2_bool (MapType0Select xs@@3 x$0_2@@0))) (U_2_bool (MapType0Select xs@@3 x$0_2_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x$0_2@@0 x$0_2_1@@0))))
 :qid |stdinbpl.1110:15|
 :skolemid |139|
...
)) (=> (and (and (and (forall ((x$0_2@@1 T@U) ) (!  (=> (= (type x$0_2@@1) RefType) (=> (and (U_2_bool (MapType0Select xs@@3 x$0_2@@1)) (< NoPerm FullPerm)) (and (qpRange7 x$0_2@@1) (= (invRecv7 x$0_2@@1) x$0_2@@1))))
 :qid |stdinbpl.1116:22|
 :skolemid |140|
 :pattern ( (MapType1Select Heap@5 x$0_2@@1 fld))
 :pattern ( (MapType2Select QPMask@2 x$0_2@@1 fld))
 :pattern ( (MapType0Select xs@@3 x$0_2@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType0Select xs@@3 (invRecv7 o_3))) (< NoPerm FullPerm)) (qpRange7 o_3)) (= (invRecv7 o_3) o_3)))
 :qid |stdinbpl.1120:22|
 :skolemid |141|
 :pattern ( (invRecv7 o_3))
))) (and (forall ((x$0_2@@2 T@U) ) (!  (=> (and (= (type x$0_2@@2) RefType) (U_2_bool (MapType0Select xs@@3 x$0_2@@2))) (not (= x$0_2@@2 null)))
 :qid |stdinbpl.1126:22|
 :skolemid |142|
 :pattern ( (MapType1Select Heap@5 x$0_2@@2 fld))
 :pattern ( (MapType2Select QPMask@2 x$0_2@@2 fld))
 :pattern ( (MapType0Select xs@@3 x$0_2@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType0Select xs@@3 (invRecv7 o_3@@0))) (< NoPerm FullPerm)) (qpRange7 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv7 o_3@@0) o_3@@0)) (= (U_2_real (MapType2Select QPMask@2 o_3@@0 fld)) (+ (U_2_real (MapType2Select Mask@1 o_3@@0 fld)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select xs@@3 (invRecv7 o_3@@0))) (< NoPerm FullPerm)) (qpRange7 o_3@@0))) (= (U_2_real (MapType2Select QPMask@2 o_3@@0 fld)) (U_2_real (MapType2Select Mask@1 o_3@@0 fld))))))
 :qid |stdinbpl.1132:22|
 :skolemid |143|
 :pattern ( (MapType2Select QPMask@2 o_3@@0 fld))
)))) (and (and (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 fld))) (= (U_2_real (MapType2Select Mask@1 o_3@@1 f_5)) (U_2_real (MapType2Select QPMask@2 o_3@@1 f_5))))))
 :qid |stdinbpl.1136:29|
 :skolemid |144|
 :pattern ( (MapType2Select Mask@1 o_3@@1 f_5))
 :pattern ( (MapType2Select QPMask@2 o_3@@1 f_5))
)) (state Heap@5 QPMask@2)) (and (state Heap@5 QPMask@2) (state Heap@5 QPMask@2)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@2 x@@19 fld)) (=> (HasDirectPerm QPMask@2 x@@19 fld) (=> (= (ControlFlow 0 3) (- 0 2)) (= (U_2_int (MapType1Select Heap@5 x@@19 fld)) 0)))))))))
(let ((anon12_Else_correct  (=> (HasDirectPerm Mask@1 null (inv xs@@3)) (=> (and (= Heap@5 Heap@3) (= (ControlFlow 0 7) 3)) anon8_correct))))
(let ((anon12_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (inv xs@@3))) (= Heap@4 (MapType1Store Heap@3 null (inv xs@@3) newVersion@0))) (and (= Heap@5 Heap@4) (= (ControlFlow 0 6) 3))) anon8_correct)))
(let ((anon6_correct  (=> (= Mask@1 (MapType2Store Mask@0 null (inv xs@@3) (real_2_U (- (U_2_real (MapType2Select Mask@0 null (inv xs@@3))) FullPerm)))) (and (=> (= (ControlFlow 0 8) 6) anon12_Then_correct) (=> (= (ControlFlow 0 8) 7) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon6_correct)))
(let ((anon11_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType2Select Mask@0 null (inv xs@@3))))) (=> (<= FullPerm (U_2_real (MapType2Select Mask@0 null (inv xs@@3)))) (=> (= (ControlFlow 0 9) 8) anon6_correct))))))
(let ((anon4_correct  (=> (forall ((o_6 T@U) (f_9 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_9))))
(let ((A@@13 (FieldTypeInv0 (type f_9))))
 (=> (and (and (= (type o_6) RefType) (= (type f_9) (FieldType A@@13 B@@12))) (U_2_bool (MapType2Select (MapType1Select Heap@2 null (|inv#sm| xs@@3)) o_6 f_9))) (U_2_bool (MapType2Select newPMask@0 o_6 f_9)))))
 :qid |stdinbpl.1079:27|
 :skolemid |137|
 :pattern ( (MapType2Select newPMask@0 o_6 f_9))
)) (=> (and (forall ((x$0_1_1 T@U) ) (!  (=> (and (= (type x$0_1_1) RefType) (U_2_bool (MapType0Select xs@@3 x$0_1_1))) (U_2_bool (MapType2Select newPMask@0 x$0_1_1 fld)))
 :qid |stdinbpl.1083:20|
 :skolemid |138|
 :no-pattern (type x$0_1_1)
 :no-pattern (U_2_int x$0_1_1)
 :no-pattern (U_2_bool x$0_1_1)
)) (= Heap@3 (MapType1Store Heap@2 null (|inv#sm| xs@@3) newPMask@0))) (=> (and (and (state Heap@3 Mask@0) (state Heap@3 Mask@0)) (and (|inv#trigger| Heap@3 (inv xs@@3)) (= (MapType1Select Heap@3 null (inv xs@@3)) (FrameFragment (int_2_U (|inv#condqp1| Heap@3 xs@@3)))))) (and (=> (= (ControlFlow 0 12) 9) anon11_Then_correct) (=> (= (ControlFlow 0 12) 11) anon11_Else_correct)))))))
(let ((anon10_Else_correct  (=> (HasDirectPerm Mask@0 null (inv xs@@3)) (=> (and (= Heap@2 Heap@@18) (= (ControlFlow 0 14) 12)) anon4_correct))))
(let ((anon10_Then_correct  (=> (not (HasDirectPerm Mask@0 null (inv xs@@3))) (=> (and (and (= Heap@0 (MapType1Store Heap@@18 null (|inv#sm| xs@@3) ZeroPMask)) (= Heap@1 (MapType1Store Heap@0 null (inv xs@@3) freshVersion@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 13) 12))) anon4_correct))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 19)) (forall ((y_1 T@U) (y_1_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (= (type y_1_1) RefType)) (=> (and (and (and (and (not (= y_1 y_1_1)) (U_2_bool (MapType0Select xs@@3 y_1))) (U_2_bool (MapType0Select xs@@3 y_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_1 y_1_1))))
 :qid |stdinbpl.974:15|
 :skolemid |125|
 :no-pattern (type y_1)
 :no-pattern (type y_1_1)
 :no-pattern (U_2_int y_1)
 :no-pattern (U_2_bool y_1)
 :no-pattern (U_2_int y_1_1)
 :no-pattern (U_2_bool y_1_1)
))) (=> (forall ((y_1@@0 T@U) (y_1_1@@0 T@U) ) (!  (=> (and (= (type y_1@@0) RefType) (= (type y_1_1@@0) RefType)) (=> (and (and (and (and (not (= y_1@@0 y_1_1@@0)) (U_2_bool (MapType0Select xs@@3 y_1@@0))) (U_2_bool (MapType0Select xs@@3 y_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_1@@0 y_1_1@@0))))
 :qid |stdinbpl.974:15|
 :skolemid |125|
 :no-pattern (type y_1@@0)
 :no-pattern (type y_1_1@@0)
 :no-pattern (U_2_int y_1@@0)
 :no-pattern (U_2_bool y_1@@0)
 :no-pattern (U_2_int y_1_1@@0)
 :no-pattern (U_2_bool y_1_1@@0)
)) (=> (forall ((y_1@@1 T@U) ) (!  (=> (= (type y_1@@1) RefType) (=> (and (U_2_bool (MapType0Select xs@@3 y_1@@1)) (< NoPerm FullPerm)) (and (qpRange5 y_1@@1) (= (invRecv5 y_1@@1) y_1@@1))))
 :qid |stdinbpl.980:22|
 :skolemid |126|
 :pattern ( (MapType1Select Heap@@18 y_1@@1 fld))
 :pattern ( (MapType2Select QPMask@0 y_1@@1 fld))
 :pattern ( (MapType0Select xs@@3 y_1@@1))
)) (=> (and (and (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType0Select xs@@3 (invRecv5 o_3@@2))) (< NoPerm FullPerm)) (qpRange5 o_3@@2)) (= (invRecv5 o_3@@2) o_3@@2)))
 :qid |stdinbpl.984:22|
 :skolemid |127|
 :pattern ( (invRecv5 o_3@@2))
)) (forall ((y_1@@2 T@U) ) (!  (=> (and (= (type y_1@@2) RefType) (U_2_bool (MapType0Select xs@@3 y_1@@2))) (not (= y_1@@2 null)))
 :qid |stdinbpl.990:22|
 :skolemid |128|
 :pattern ( (MapType1Select Heap@@18 y_1@@2 fld))
 :pattern ( (MapType2Select QPMask@0 y_1@@2 fld))
 :pattern ( (MapType0Select xs@@3 y_1@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType0Select xs@@3 (invRecv5 o_3@@3))) (< NoPerm FullPerm)) (qpRange5 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv5 o_3@@3) o_3@@3)) (= (U_2_real (MapType2Select QPMask@0 o_3@@3 fld)) (+ (U_2_real (MapType2Select ZeroMask o_3@@3 fld)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select xs@@3 (invRecv5 o_3@@3))) (< NoPerm FullPerm)) (qpRange5 o_3@@3))) (= (U_2_real (MapType2Select QPMask@0 o_3@@3 fld)) (U_2_real (MapType2Select ZeroMask o_3@@3 fld))))))
 :qid |stdinbpl.996:22|
 :skolemid |129|
 :pattern ( (MapType2Select QPMask@0 o_3@@3 fld))
)) (forall ((o_3@@4 T@U) (f_5@@0 T@U) ) (! (let ((B@@13 (FieldTypeInv1 (type f_5@@0))))
(let ((A@@14 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@14 B@@13))) (not (= f_5@@0 fld))) (= (U_2_real (MapType2Select ZeroMask o_3@@4 f_5@@0)) (U_2_real (MapType2Select QPMask@0 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.1000:29|
 :skolemid |130|
 :pattern ( (MapType2Select ZeroMask o_3@@4 f_5@@0))
 :pattern ( (MapType2Select QPMask@0 o_3@@4 f_5@@0))
)))) (and (and (state Heap@@18 QPMask@0) (state Heap@@18 QPMask@0)) (and (U_2_bool (MapType0Select xs@@3 x@@19)) (state Heap@@18 QPMask@0)))) (and (=> (= (ControlFlow 0 15) (- 0 18)) (HasDirectPerm QPMask@0 x@@19 fld)) (=> (HasDirectPerm QPMask@0 x@@19 fld) (=> (and (= (U_2_int (MapType1Select Heap@@18 x@@19 fld)) 0) (state Heap@@18 QPMask@0)) (and (=> (= (ControlFlow 0 15) (- 0 17)) (forall ((x$0 T@U) (x$0_1 T@U) ) (!  (=> (and (= (type x$0) RefType) (= (type x$0_1) RefType)) (=> (and (and (and (and (not (= x$0 x$0_1)) (U_2_bool (MapType0Select xs@@3 x$0))) (U_2_bool (MapType0Select xs@@3 x$0_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x$0 x$0_1))))
 :qid |stdinbpl.1032:17|
 :skolemid |131|
 :pattern ( (neverTriggered6 x$0) (neverTriggered6 x$0_1))
))) (=> (forall ((x$0@@0 T@U) (x$0_1@@0 T@U) ) (!  (=> (and (= (type x$0@@0) RefType) (= (type x$0_1@@0) RefType)) (=> (and (and (and (and (not (= x$0@@0 x$0_1@@0)) (U_2_bool (MapType0Select xs@@3 x$0@@0))) (U_2_bool (MapType0Select xs@@3 x$0_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x$0@@0 x$0_1@@0))))
 :qid |stdinbpl.1032:17|
 :skolemid |131|
 :pattern ( (neverTriggered6 x$0@@0) (neverTriggered6 x$0_1@@0))
)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((x$0@@1 T@U) ) (!  (=> (and (= (type x$0@@1) RefType) (U_2_bool (MapType0Select xs@@3 x$0@@1))) (>= (U_2_real (MapType2Select QPMask@0 x$0@@1 fld)) FullPerm))
 :qid |stdinbpl.1039:17|
 :skolemid |132|
 :pattern ( (MapType1Select Heap@@18 x$0@@1 fld))
 :pattern ( (MapType2Select QPMask@1 x$0@@1 fld))
 :pattern ( (MapType0Select xs@@3 x$0@@1))
))) (=> (forall ((x$0@@2 T@U) ) (!  (=> (and (= (type x$0@@2) RefType) (U_2_bool (MapType0Select xs@@3 x$0@@2))) (>= (U_2_real (MapType2Select QPMask@0 x$0@@2 fld)) FullPerm))
 :qid |stdinbpl.1039:17|
 :skolemid |132|
 :pattern ( (MapType1Select Heap@@18 x$0@@2 fld))
 :pattern ( (MapType2Select QPMask@1 x$0@@2 fld))
 :pattern ( (MapType0Select xs@@3 x$0@@2))
)) (=> (forall ((x$0@@3 T@U) ) (!  (=> (= (type x$0@@3) RefType) (=> (and (U_2_bool (MapType0Select xs@@3 x$0@@3)) (< NoPerm FullPerm)) (and (qpRange6 x$0@@3) (= (invRecv6 x$0@@3) x$0@@3))))
 :qid |stdinbpl.1045:22|
 :skolemid |133|
 :pattern ( (MapType1Select Heap@@18 x$0@@3 fld))
 :pattern ( (MapType2Select QPMask@1 x$0@@3 fld))
 :pattern ( (MapType0Select xs@@3 x$0@@3))
)) (=> (and (and (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (U_2_bool (MapType0Select xs@@3 (invRecv6 o_3@@5))) (and (< NoPerm FullPerm) (qpRange6 o_3@@5))) (= (invRecv6 o_3@@5) o_3@@5)))
 :qid |stdinbpl.1049:22|
 :skolemid |134|
 :pattern ( (invRecv6 o_3@@5))
)) (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (U_2_bool (MapType0Select xs@@3 (invRecv6 o_3@@6))) (and (< NoPerm FullPerm) (qpRange6 o_3@@6))) (and (= (invRecv6 o_3@@6) o_3@@6) (= (U_2_real (MapType2Select QPMask@1 o_3@@6 fld)) (- (U_2_real (MapType2Select QPMask@0 o_3@@6 fld)) FullPerm)))) (=> (not (and (U_2_bool (MapType0Select xs@@3 (invRecv6 o_3@@6))) (and (< NoPerm FullPerm) (qpRange6 o_3@@6)))) (= (U_2_real (MapType2Select QPMask@1 o_3@@6 fld)) (U_2_real (MapType2Select QPMask@0 o_3@@6 fld))))))
 :qid |stdinbpl.1055:22|
 :skolemid |135|
 :pattern ( (MapType2Select QPMask@1 o_3@@6 fld))
))) (and (forall ((o_3@@7 T@U) (f_5@@1 T@U) ) (! (let ((B@@14 (FieldTypeInv1 (type f_5@@1))))
(let ((A@@15 (FieldTypeInv0 (type f_5@@1))))
 (=> (and (and (= (type o_3@@7) RefType) (= (type f_5@@1) (FieldType A@@15 B@@14))) (not (= f_5@@1 fld))) (= (U_2_real (MapType2Select QPMask@0 o_3@@7 f_5@@1)) (U_2_real (MapType2Select QPMask@1 o_3@@7 f_5@@1))))))
 :qid |stdinbpl.1061:29|
 :skolemid |136|
 :pattern ( (MapType2Select QPMask@1 o_3@@7 f_5@@1))
)) (= Mask@0 (MapType2Store QPMask@1 null (inv xs@@3) (real_2_U (+ (U_2_real (MapType2Select QPMask@1 null (inv xs@@3))) FullPerm)))))) (and (and (state Heap@@18 Mask@0) (state Heap@@18 Mask@0)) (and (|inv#trigger| Heap@@18 (inv xs@@3)) (= (MapType1Select Heap@@18 null (inv xs@@3)) (FrameFragment (int_2_U (|inv#condqp1| Heap@@18 xs@@3))))))) (and (=> (= (ControlFlow 0 15) 13) anon10_Then_correct) (=> (= (ControlFlow 0 15) 14) anon10_Else_correct)))))))))))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@18 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType1Select Heap@@18 x@@19 $allocated))) (and (=> (= (ControlFlow 0 20) 1) anon9_Then_correct) (=> (= (ControlFlow 0 20) 15) anon9_Else_correct))))))
