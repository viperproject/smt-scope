...
(assert (forall ((Heap@@2 T@U) (n T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type n) RefType)) (dummyFunction (bool_2_U (|foo#triggerStateless| n))))
 :qid |stdinbpl.403:15|
 :skolemid |83|
 :pattern ( (|foo'| Heap@@2 n))
)))
...
(assert (forall ((Heap@@6 T@U) (Mask@@6 T@U) (n@@0 T@U) ) (!  (=> (and (and (and (= (type Heap@@6) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (= (type n@@0) RefType)) (state Heap@@6 Mask@@6)) (= (|foo'| Heap@@6 n@@0) (|foo#frame| (FrameFragment (MapType0Select Heap@@6 n@@0 m)) n@@0)))
 :qid |stdinbpl.410:15|
 :skolemid |84|
 :pattern ( (state Heap@@6 Mask@@6) (|foo'| Heap@@6 n@@0))
)))
...
(assert (forall ((Heap@@7 T@U) (n@@1 T@U) ) (!  (=> (and (= (type Heap@@7) (MapType0Type RefType)) (= (type n@@1) RefType)) (and (= (foo Heap@@7 n@@1) (|foo'| Heap@@7 n@@1)) (dummyFunction (bool_2_U (|foo#triggerStateless| n@@1)))))
 :qid |stdinbpl.399:15|
 :skolemid |82|
 :pattern ( (foo Heap@@7 n@@1))
)))
...
(assert  (and (and (and (and (and (and (= (type graph@0) (MapType2Type RefType boolType)) (= (type q_1) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@12) (MapType0Type RefType))) (= (type vroot) RefType)) (= (type root) RefType)) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv1 arg0@@44)) RefType)
...
(let ((anon26_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 19) 16)) anon16_correct)))
(let ((anon26_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 root m)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 root m))) (=> (= (ControlFlow 0 17) 16) anon16_correct))))))
(let ((anon12_correct true))
(let ((anon24_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 15) 12)) anon12_correct)))
(let ((anon24_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 vroot m)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 vroot m))) (=> (= (ControlFlow 0 13) 12) anon12_correct))))))
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (= (foo Heap@@12 vroot) (foo Heap@@12 root))) (=> (= (foo Heap@@12 vroot) (foo Heap@@12 root)) (=> (and (state Heap@@12 QPMask@0) (= (ControlFlow 0 10) (- 0 9))) false)))))
(let ((anon19_Else_correct  (=> (forall ((q_1_1 T@U) ) (!  (=> (and (= (type q_1_1) RefType) (U_2_bool (MapType2Select graph@0 q_1_1))) (foo Heap@@12 q_1_1))
 :qid |stdinbpl.558:20|
 :skolemid |91|
 :pattern ( (MapType2Select graph@0 q_1_1))
 :pattern ( (|foo#frame| (FrameFragment (MapType0Select Heap@@12 q_1_1 m)) q_1_1))
)) (=> (and (state Heap@@12 QPMask@0) (state Heap@@12 QPMask@0)) (and (and (and (and (=> (= (ControlFlow 0 20) 10) anon25_Else_correct) (=> (= (ControlFlow 0 20) 17) anon26_Then_correct)) (=> (= (ControlFlow 0 20) 19) anon26_Else_correct)) (=> (= (ControlFlow 0 20) 13) anon24_Then_correct)) (=> (= (ControlFlow 0 20) 15) anon24_Else_correct))))))
(let ((anon7_correct true))
(let ((anon22_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 4)) anon7_correct)))
(let ((anon22_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 q_1 m)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 q_1 m))) (=> (= (ControlFlow 0 5) 4) anon7_correct))))))
(let ((anon8_correct true))
(let ((anon20_Then_correct  (=> (U_2_bool (MapType2Select graph@0 q_1)) (and (and (=> (= (ControlFlow 0 8) 2) anon8_correct) (=> (= (ControlFlow 0 8) 5) anon22_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon22_Else_correct)))))
(let ((anon20_Else_correct  (=> (and (not (U_2_bool (MapType2Select graph@0 q_1))) (= (ControlFlow 0 3) 2)) anon8_correct)))
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((n_1 T@U) (n_1_1 T@U) ) (!  (=> (and (= (type n_1) RefType) (= (type n_1_1) RefType)) (=> (and (and (and (and (not (= n_1 n_1_1)) (U_2_bool (MapType2Select graph@0 n_1))) (U_2_bool (MapType2Select graph@0 n_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1))))
 :qid |stdinbpl.494:15|
 :skolemid |85|
 :no-pattern (type n_1)
...
)) (=> (forall ((n_1@@1 T@U) ) (!  (=> (= (type n_1@@1) RefType) (=> (and (U_2_bool (MapType2Select graph@0 n_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 n_1@@1) (= (invRecv1 n_1@@1) n_1@@1))))
 :qid |stdinbpl.500:22|
 :skolemid |86|
 :pattern ( (MapType0Select Heap@@12 n_1@@1 m))
 :pattern ( (MapType1Select QPMask@0 n_1@@1 m))
 :pattern ( (MapType2Select graph@0 n_1@@1))
)) (=> (and (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select graph@0 (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.504:22|
 :skolemid |87|
 :pattern ( (invRecv1 o_3))
)) (forall ((n_1@@2 T@U) ) (!  (=> (and (= (type n_1@@2) RefType) (U_2_bool (MapType2Select graph@0 n_1@@2))) (not (= n_1@@2 null)))
 :qid |stdinbpl.510:22|
 :skolemid |88|
 :pattern ( (MapType0Select Heap@@12 n_1@@2 m))
 :pattern ( (MapType1Select QPMask@0 n_1@@2 m))
 :pattern ( (MapType2Select graph@0 n_1@@2))
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select graph@0 (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 m)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 m)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select graph@0 (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 m)) (U_2_real (MapType1Select ZeroMask o_3@@0 m))))))
 :qid |stdinbpl.516:22|
 :skolemid |89|
...
)))) (and (and (state Heap@@12 QPMask@0) (state Heap@@12 QPMask@0)) (and (state Heap@@12 QPMask@0) (state Heap@@12 QPMask@0)))) (and (and (=> (= (ControlFlow 0 21) 20) anon19_Else_correct) (=> (= (ControlFlow 0 21) 8) anon20_Then_correct)) (=> (= (ControlFlow 0 21) 3) anon20_Else_correct))))))))
(let ((anon18_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@12 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@12 vroot $allocated))) (and (U_2_bool (MapType0Select Heap@@12 root $allocated)) (= graph@0 (|Set#UnionOne| (|Set#Singleton| root) vroot)))) (and (and (state Heap@@12 ZeroMask) (not (= vroot root))) (and (state Heap@@12 ZeroMask) (state Heap@@12 ZeroMask)))) (and (=> (= (ControlFlow 0 23) 1) anon18_Then_correct) (=> (= (ControlFlow 0 23) 21) anon18_Else_correct))))))
