...
(declare-fun TestDomainTypeType () T@T)
...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (Ctor TestDomainTypeType) 8)) (= (type u1) TestDomainTypeType)) (= (type u2) TestDomainTypeType)))
(assert (distinct $allocated u1 u2)
)
...
(declare-fun c () T@U)
(assert  (and (= (type Heap@@9) (MapType0Type RefType)) (= (type c) TestDomainTypeType)))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (= u1 u2))) (=> (not (= u1 u2)) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (not (= c u1))))))))
