...
(set-info :boogie-vc-id test2Reference)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 this@@11 $allocated))) (=> (and (and (not (= this@@11 null)) (state Heap@@11 ZeroMask)) (and (state Heap@@11 ZeroMask) (= (ControlFlow 0 2) (- 0 4)))) false))))
