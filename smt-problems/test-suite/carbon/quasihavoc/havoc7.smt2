...
(assert  (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type y@@7) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |p#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 y@@7 $allocated)) (= perm@0 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= y@@7 null))) (= Mask@0 (MapType1Store ZeroMask y@@7 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask y@@7 f_7)) perm@0))))) (and (state Heap@@10 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@0 y@@7 f_7))))))))
