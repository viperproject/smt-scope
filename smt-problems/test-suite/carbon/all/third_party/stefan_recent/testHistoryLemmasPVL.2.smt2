...
(assert  (and (and (and (and (= (Ctor ProcessDomainTypeType) 6) (forall ((arg0@@11 Int) ) (! (= (type (p_single arg0@@11)) ProcessDomainTypeType)
 :qid |funType:p_single|
 :pattern ( (p_single arg0@@11))
))) (forall ((arg0@@12 T@U) (arg1 T@U) ) (! (= (type (p_seq arg0@@12 arg1)) ProcessDomainTypeType)
 :qid |funType:p_seq|
 :pattern ( (p_seq arg0@@12 arg1))
...
))) (forall ((arg0@@15 T@T) (arg1@@0 T@T) ) (! (= (Ctor (FieldType arg0@@15 arg1@@0)) 8)
 :qid |ctor:FieldType|
))) (forall ((arg0@@16 T@T) (arg1@@1 T@T) ) (! (= (FieldTypeInv0 (FieldType arg0@@16 arg1@@1)) arg0@@16)
 :qid |typeInv:FieldTypeInv0|
 :pattern ( (FieldType arg0@@16 arg1@@1))
))) (forall ((arg0@@17 T@T) (arg1@@2 T@T) ) (! (= (FieldTypeInv1 (FieldType arg0@@17 arg1@@2)) arg1@@2)
 :qid |typeInv:FieldTypeInv1|
 :pattern ( (FieldType arg0@@17 arg1@@2))
...
(assert  (and (and (and (and (and (and (forall ((arg0@@20 T@T) (arg1@@5 T@T) ) (! (= (Ctor (MapType1Type arg0@@20 arg1@@5)) 10)
...
(assert  (and (forall ((arg0@@27 Int) (arg1@@10 Int) ) (! (= (type (p_dual arg0@@27 arg1@@10)) ProcessDomainTypeType)
 :qid |funType:p_dual|
 :pattern ( (p_dual arg0@@27 arg1@@10))
)) (forall ((arg0@@28 T@U) (arg1@@11 T@U) ) (! (= (type (p_merge arg0@@28 arg1@@11)) ProcessDomainTypeType)
 :qid |funType:p_merge|
 :pattern ( (p_merge arg0@@28 arg1@@11))
))))
...
(assert  (and (forall ((arg0@@29 Real) (arg1@@12 T@U) ) (! (= (type (ConditionalFrame arg0@@29 arg1@@12)) FrameTypeType)
...
(declare-fun n_1@@1 () Int)
(declare-fun arg_n@0 () Int)
(declare-fun diz () T@U)
(declare-fun current_thread_id () Int)
(assert  (and (= (type Heap@@9) (MapType0Type RefType)) (= (type diz) RefType)))
(set-info :boogie-vc-id History__lemma)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon4_correct  (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 3) (- 0 2))) (= (p_single n_1@@1) (ite (> n_1@@1 0) (p_seq (p_single (- n_1@@1 1)) p_incr) p_empty)))))
(let ((anon6_Else_correct  (=> (and (> 2 n_1@@1) (= (ControlFlow 0 8) 3)) anon4_correct)))
(let ((anon6_Then_correct  (=> (and (>= n_1@@1 2) (= arg_n@0 (- n_1@@1 2))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (not (= diz null))) (=> (not (= diz null)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (>= arg_n@0 0)) (=> (>= arg_n@0 0) (=> (and (and (= (p_single arg_n@0) (ite (> arg_n@0 0) (p_seq (p_single (- arg_n@0 1)) p_incr) p_empty)) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 4) 3))) anon4_correct))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 diz $allocated))) (and (not (= diz null)) (state Heap@@9 ZeroMask))) (and (and (>= current_thread_id 0) (state Heap@@9 ZeroMask)) (and (>= n_1@@1 0) (state Heap@@9 ZeroMask)))) (and (and (=> (= (ControlFlow 0 9) 1) anon5_Then_correct) (=> (= (ControlFlow 0 9) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct)))))
