...
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (HasDirectPerm Mask@0 diz Counter__x)) (=> (HasDirectPerm Mask@0 diz Counter__x) (=> (= __flatten_2@0 (+ (U_2_int (MapType0Select Heap@@9 diz Counter__x)) 1)) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (= FullPerm (U_2_real (MapType1Select Mask@0 diz Counter__x)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 diz Counter__x))) (=> (and (= Heap@0 (MapType0Store Heap@@9 diz Counter__x (int_2_U __flatten_2@0))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 9) 6) anon6_Then_correct) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct)))))))))))
