...
(assert (= (type Heap@@11) (MapType0Type RefType)))
(set-info :boogie-vc-id LockSet__LockSet)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon7_Else_correct true))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (>= current_thread_id 0) (state Heap@@11 ZeroMask)) (and (=> (= (ControlFlow 0 4) 1) anon7_Then_correct) (=> (= (ControlFlow 0 4) 3) anon7_Else_correct))))))
