...
(assert  (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type x@@8) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id fails0)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon6_correct true))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon6_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@2 x@@8 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 x@@8 f_7))) (=> (= (ControlFlow 0 3) 2) anon6_correct))))))
(let ((anon4_correct  (=> (= Mask@2 (MapType1Store Mask@1 x@@8 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 x@@8 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 6) 3) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon4_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@8 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@8 f_7))) (=> (= (ControlFlow 0 7) 6) anon4_correct))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated)) (= perm@0 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 10) (- 0 12)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= x@@8 null))) (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) perm@0))))) (and (state Heap@@9 Mask@0) (= perm@1 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (and (=> (> perm@1 NoPerm) (not (= x@@8 null))) (= Mask@1 (MapType1Store Mask@0 x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@8 f_7)) perm@1))))) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1))) (and (and (=> (= (ControlFlow 0 10) 1) anon7_Then_correct) (=> (= (ControlFlow 0 10) 7) anon8_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct))))))))))))
