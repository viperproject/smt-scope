...
(declare-fun |peek_neighbors'| (T@U T@U Int) Bool)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |peek_neighbors#triggerStateless| (T@U Int) Bool)
...
(declare-fun |peek_neighbors#frame| (T@U T@U Int) Bool)
...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type id) (FieldType NormalFieldType intType))) (forall ((arg0@@14 T@T) ) (! (= (Ctor (SeqType arg0@@14)) 8)
 :qid |ctor:SeqType|
))) (forall ((arg0@@15 T@T) ) (! (= (SeqTypeInv0 (SeqType arg0@@15)) arg0@@15)
 :qid |typeInv:SeqTypeInv0|
 :pattern ( (SeqType arg0@@15))
))) (= (type neighbors) (FieldType NormalFieldType (SeqType intType)))) (= (type value) (FieldType NormalFieldType boolType))))
(assert (distinct $allocated id neighbors value)
)
...
(assert (forall ((Heap@@0 T@U) (graph T@U) (i Int) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type graph) (SeqType RefType))) (dummyFunction (bool_2_U (|peek_neighbors#triggerStateless| graph i))))
 :qid |stdinbpl.565:15|
 :skolemid |59|
 :pattern ( (|peek_neighbors'| Heap@@0 graph i))
)))
...
(assert  (and (= (Ctor PredicateType_NodeType) 13) (forall ((arg0@@29 T@U) ) (! (= (type (Node arg0@@29)) (FieldType PredicateType_NodeType FrameTypeType))
 :qid |funType:Node|
 :pattern ( (Node arg0@@29))
))))
...
(assert (forall ((Heap@@3 T@U) (self@@0 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type self@@0) RefType)) (|Node#everUsed| (Node self@@0)))
 :qid |stdinbpl.694:15|
 :skolemid |68|
 :pattern ( (|Node#trigger| Heap@@3 (Node self@@0)))
)))
...
(assert (forall ((Heap@@5 T@U) (Mask@@3 T@U) (graph@@0 T@U) (i@@3 Int) ) (!  (=> (and (and (and (= (type Heap@@5) (MapType0Type RefType)) (= (type Mask@@3) (MapType1Type RefType realType))) (= (type graph@@0) (SeqType RefType))) (state Heap@@5 Mask@@3)) (= (|peek_neighbors'| Heap@@5 graph@@0 i@@3) (|peek_neighbors#frame| (MapType0Select Heap@@5 null (Node (|Seq#Index| graph@@0 i@@3))) graph@@0 i@@3)))
 :qid |stdinbpl.578:15|
 :skolemid |61|
 :pattern ( (state Heap@@5 Mask@@3) (|peek_neighbors'| Heap@@5 graph@@0 i@@3))
)))
...
(assert (forall ((arg0@@34 T@U) ) (! (= (type (|Node#sm| arg0@@34)) (FieldType PredicateType_NodeType (MapType1Type RefType boolType)))
 :qid |funType:Node#sm|
 :pattern ( (|Node#sm| arg0@@34))
)))
...
(assert  (not (IsPredicateField id)))
(assert  (not (IsWandField id)))
(assert  (not (IsPredicateField neighbors)))
(assert  (not (IsWandField neighbors)))
...
(assert (forall ((Heap@@12 T@U) (Mask@@10 T@U) (graph@@1 T@U) (i@@7 Int) ) (!  (=> (and (and (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type graph@@1) (SeqType RefType))) (and (state Heap@@12 Mask@@10) (< AssumeFunctionsAbove 0))) (and (<= 0 i@@7) (< i@@7 (|Seq#Length| graph@@1)))) (peek_neighbors Heap@@12 graph@@1 i@@7))
 :qid |stdinbpl.571:15|
 :skolemid |60|
 :pattern ( (state Heap@@12 Mask@@10) (peek_neighbors Heap@@12 graph@@1 i@@7))
 :pattern ( (state Heap@@12 Mask@@10) (|peek_neighbors#triggerStateless| graph@@1 i@@7) (|Node#trigger| Heap@@12 (Node (|Seq#Index| graph@@1 i@@7))))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@13 T@U) (graph@@2 T@U) (i@@9 Int) ) (!  (=> (and (= (type Heap@@13) (MapType0Type RefType)) (= (type graph@@2) (SeqType RefType))) (and (= (peek_neighbors Heap@@13 graph@@2 i@@9) (|peek_neighbors'| Heap@@13 graph@@2 i@@9)) (dummyFunction (bool_2_U (|peek_neighbors#triggerStateless| graph@@2 i@@9)))))
 :qid |stdinbpl.561:15|
 :skolemid |58|
 :pattern ( (peek_neighbors Heap@@13 graph@@2 i@@9))
)))
(push 1)
...
(assert  (and (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type self@@5) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |Node#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon8_correct true))
(let ((anon14_Else_correct  (=> (and (not (and (and (<= 0 i_1) (< i_1 (|Seq#Length| (MapType0Select Heap@@14 self@@5 neighbors)))) (and (and (<= 0 j_1) (< j_1 (|Seq#Length| (MapType0Select Heap@@14 self@@5 neighbors)))) (not (= i_1 j_1))))) (= (ControlFlow 0 10) 2)) anon8_correct)))
(let ((anon14_Then_correct  (=> (and (and (<= 0 i_1) (< i_1 (|Seq#Length| (MapType0Select Heap@@14 self@@5 neighbors)))) (and (and (<= 0 j_1) (< j_1 (|Seq#Length| (MapType0Select Heap@@14 self@@5 neighbors)))) (not (= i_1 j_1)))) (and (=> (= (ControlFlow 0 3) (- 0 9)) (HasDirectPerm Mask@1 self@@5 neighbors)) (=> (HasDirectPerm Mask@1 self@@5 neighbors) (and (=> (= (ControlFlow 0 3) (- 0 8)) (>= i_1 0)) (=> (>= i_1 0) (and (=> (= (ControlFlow 0 3) (- 0 7)) (< i_1 (|Seq#Length| (MapType0Select Heap@@14 self@@5 neighbors)))) (=> (< i_1 (|Seq#Length| (MapType0Select Heap@@14 self@@5 neighbors))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (HasDirectPerm Mask@1 self@@5 neighbors)) (=> (HasDirectPerm Mask@1 self@@5 neighbors) (and (=> (= (ControlFlow 0 3) (- 0 5)) (>= j_1 0)) (=> (>= j_1 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< j_1 (|Seq#Length| (MapType0Select Heap@@14 self@@5 neighbors)))) (=> (< j_1 (|Seq#Length| (MapType0Select Heap@@14 self@@5 neighbors))) (=> (= (ControlFlow 0 3) 2) anon8_correct))))))))))))))))
(let ((anon13_Else_correct  (=> (< j_1 0) (and (=> (= (ControlFlow 0 14) 3) anon14_Then_correct) (=> (= (ControlFlow 0 14) 10) anon14_Else_correct)))))
(let ((anon13_Then_correct  (=> (<= 0 j_1) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm Mask@1 self@@5 neighbors)) (=> (HasDirectPerm Mask@1 self@@5 neighbors) (and (=> (= (ControlFlow 0 12) 3) anon14_Then_correct) (=> (= (ControlFlow 0 12) 10) anon14_Else_correct)))))))
(let ((anon12_Then_correct  (=> (and (<= 0 i_1) (< i_1 (|Seq#Length| (MapType0Select Heap@@14 self@@5 neighbors)))) (and (=> (= (ControlFlow 0 15) 12) anon13_Then_correct) (=> (= (ControlFlow 0 15) 14) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (not (and (<= 0 i_1) (< i_1 (|Seq#Length| (MapType0Select Heap@@14 self@@5 neighbors))))) (and (=> (= (ControlFlow 0 11) 3) anon14_Then_correct) (=> (= (ControlFlow 0 11) 10) anon14_Else_correct)))))
(let ((anon11_Else_correct  (=> (< i_1 0) (and (=> (= (ControlFlow 0 18) 15) anon12_Then_correct) (=> (= (ControlFlow 0 18) 11) anon12_Else_correct)))))
(let ((anon11_Then_correct  (=> (<= 0 i_1) (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm Mask@1 self@@5 neighbors)) (=> (HasDirectPerm Mask@1 self@@5 neighbors) (and (=> (= (ControlFlow 0 16) 15) anon12_Then_correct) (=> (= (ControlFlow 0 16) 11) anon12_Else_correct)))))))
(let ((anon10_Else_correct true))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@14 self@@5 $allocated))) (and (not (= self@@5 null)) (= Mask@0 (MapType1Store ZeroMask self@@5 id (real_2_U (+ (U_2_real (MapType1Select ZeroMask self@@5 id)) FullPerm)))))) (and (and (state Heap@@14 Mask@0) (not (= self@@5 null))) (and (= Mask@1 (MapType1Store Mask@0 self@@5 neighbors (real_2_U (+ (U_2_real (MapType1Select Mask@0 self@@5 neighbors)) FullPerm)))) (state Heap@@14 Mask@1)))) (and (and (=> (= (ControlFlow 0 19) 1) anon10_Else_correct) (=> (= (ControlFlow 0 19) 16) anon11_Then_correct)) (=> (= (ControlFlow 0 19) 18) anon11_Else_correct))))))
