...
(assert  (and (and (and (and (and (and (and (and (and (and (= (type xs@@8) (MapType2Type RefType boolType)) (= (type x_7) RefType)) (= (type ys@@8) (MapType2Type RefType boolType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type x1@@7) RefType)) (= (type Heap@@10) (MapType0Type RefType))) (= (type x2) RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type x_9) RefType)) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv2 arg0@@48)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@48))
))) (forall ((arg0@@49 T@U) ) (! (= (type (invRecv1 arg0@@49)) RefType)
 :qid |funType:invRecv1|
 :pattern ( (invRecv1 arg0@@49))
))))
(set-info :boogie-vc-id |P#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 51) (let ((anon26_correct true))
(let ((anon45_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select xs@@8 x_9)) (and (not (U_2_bool (MapType2Select ys@@8 x_9))) (and (not (= (U_2_int (MapType0Select Heap@@10 x_9 f_7)) 0)) (not (U_2_bool (MapType2Select xs@@8 (MapType0Select Heap@@10 x_9 g)))))))) (= (ControlFlow 0 36) 33)) anon26_correct)))
(let ((anon45_Then_correct  (=> (and (U_2_bool (MapType2Select xs@@8 x_9)) (and (not (U_2_bool (MapType2Select ys@@8 x_9))) (and (not (= (U_2_int (MapType0Select Heap@@10 x_9 f_7)) 0)) (not (U_2_bool (MapType2Select xs@@8 (MapType0Select Heap@@10 x_9 g))))))) (and (=> (= (ControlFlow 0 34) (- 0 35)) (HasDirectPerm QPMask@1 x_9 g)) (=> (HasDirectPerm QPMask@1 x_9 g) (=> (= (ControlFlow 0 34) 33) anon26_correct))))))
(let ((anon44_Else_correct  (=> (= (U_2_int (MapType0Select Heap@@10 x_9 f_7)) 0) (and (=> (= (ControlFlow 0 41) 34) anon45_Then_correct) (=> (= (ControlFlow 0 41) 36) anon45_Else_correct)))))
(let ((anon44_Then_correct  (=> (not (= (U_2_int (MapType0Select Heap@@10 x_9 f_7)) 0)) (and (=> (= (ControlFlow 0 39) (- 0 40)) (HasDirectPerm QPMask@1 x_9 g)) (=> (HasDirectPerm QPMask@1 x_9 g) (and (=> (= (ControlFlow 0 39) 34) anon45_Then_correct) (=> (= (ControlFlow 0 39) 36) anon45_Else_correct)))))))
(let ((anon43_Then_correct  (=> (not (U_2_bool (MapType2Select ys@@8 x_9))) (and (=> (= (ControlFlow 0 42) (- 0 43)) (HasDirectPerm QPMask@1 x_9 f_7)) (=> (HasDirectPerm QPMask@1 x_9 f_7) (and (=> (= (ControlFlow 0 42) 39) anon44_Then_correct) (=> (= (ControlFlow 0 42) 41) anon44_Else_correct)))))))
(let ((anon43_Else_correct  (=> (U_2_bool (MapType2Select ys@@8 x_9)) (and (=> (= (ControlFlow 0 38) 34) anon45_Then_correct) (=> (= (ControlFlow 0 38) 36) anon45_Else_correct)))))
(let ((anon42_Then_correct  (=> (U_2_bool (MapType2Select xs@@8 x_9)) (and (=> (= (ControlFlow 0 44) 42) anon43_Then_correct) (=> (= (ControlFlow 0 44) 38) anon43_Else_correct)))))
(let ((anon42_Else_correct  (=> (not (U_2_bool (MapType2Select xs@@8 x_9))) (and (=> (= (ControlFlow 0 37) 34) anon45_Then_correct) (=> (= (ControlFlow 0 37) 36) anon45_Else_correct)))))
(let ((anon41_Else_correct  (=> (= (ControlFlow 0 32) (- 0 31)) (forall ((x_8 T@U) (x_8_1 T@U) ) (!  (=> (and (= (type x_8) RefType) (= (type x_8_1) RefType)) (=> (and (and (and (and (not (= x_8 x_8_1)) (and (U_2_bool (MapType2Select xs@@8 x_8)) (and (not (U_2_bool (MapType2Select ys@@8 x_8))) (and (not (= (U_2_int (MapType0Select Heap@@10 x_8 f_7)) 0)) (not (U_2_bool (MapType2Select xs@@8 (MapType0Select Heap@@10 x_8 g)))))))) (and (U_2_bool (MapType2Select xs@@8 x_8_1)) (and (not (U_2_bool (MapType2Select ys@@8 x_8_1))) (and (not (= (U_2_int (MapType0Select Heap@@10 x_8_1 f_7)) 0)) (not (U_2_bool (MapType2Select xs@@8 (MapType0Select Heap@@10 x_8_1 g)))))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (MapType0Select Heap@@10 x_8 g) (MapType0Select Heap@@10 x_8_1 g)))))
 :qid |stdinbpl.739:15|
 :skolemid |104|
 :no-pattern (type x_8)
 :no-pattern (type x_8_1)
 :no-pattern (U_2_int x_8)
 :no-pattern (U_2_bool x_8)
 :no-pattern (U_2_int x_8_1)
 :no-pattern (U_2_bool x_8_1)
)))))
(let ((anon32_Else_correct  (=> (forall ((x1_1 T@U) (x2_1 T@U) ) (!  (=> (and (and (= (type x1_1) RefType) (= (type x2_1) RefType)) (and (U_2_bool (MapType2Select xs@@8 x1_1)) (and (not (U_2_bool (MapType2Select ys@@8 x1_1))) (and (not (= (U_2_int (MapType0Select Heap@@10 x1_1 f_7)) 0)) (and (not (U_2_bool (MapType2Select xs@@8 (MapType0Select Heap@@10 x1_1 g)))) (and (U_2_bool (MapType2Select xs@@8 x2_1)) (and (not (U_2_bool (MapType2Select ys@@8 x2_1))) (and (not (= (U_2_int (MapType0Select Heap@@10 x2_1 f_7)) 0)) (and (not (U_2_bool (MapType2Select xs@@8 (MapType0Select Heap@@10 x2_1 g)))) (not (= x1_1 x2_1))))))))))) (not (= (MapType0Select Heap@@10 x1_1 g) (MapType0Select Heap@@10 x2_1 g))))
 :qid |stdinbpl.714:20|
 :skolemid |103|
 :pattern ( (MapType2Select xs@@8 x1_1) (MapType2Select xs@@8 x2_1))
 :pattern ( (MapType2Select xs@@8 x1_1) (MapType2Select ys@@8 x2_1))
 :pattern ( (MapType2Select xs@@8 x1_1) (MapType2Select xs@@8 (MapType0Select Heap@@10 x2_1 g)))
 :pattern ( (MapType2Select ys@@8 x1_1) (MapType2Select xs@@8 x2_1))
 :pattern ( (MapType2Select ys@@8 x1_1) (MapType2Select ys@@8 x2_1))
 :pattern ( (MapType2Select ys@@8 x1_1) (MapType2Select xs@@8 (MapType0Select Heap@@10 x2_1 g)))
 :pattern ( (MapType2Select xs@@8 (MapType0Select Heap@@10 x1_1 g)) (MapType2Select xs@@8 x2_1))
 :pattern ( (MapType2Select xs@@8 (MapType0Select Heap@@10 x1_1 g)) (MapType2Select ys@@8 x2_1))
 :pattern ( (MapType2Select xs@@8 (MapType0Select Heap@@10 x1_1 g)) (MapType2Select xs@@8 (MapType0Select Heap@@10 x2_1 g)))
)) (and (and (=> (= (ControlFlow 0 45) 32) anon41_Else_correct) (=> (= (ControlFlow 0 45) 44) anon42_Then_correct)) (=> (= (ControlFlow 0 45) 37) anon42_Else_correct)))))
(let ((anon18_correct true))
(let ((anon40_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select xs@@8 x1@@7)) (and (not (U_2_bool (MapType2Select ys@@8 x1@@7))) (and (not (= (U_2_int (MapType0Select Heap@@10 x1@@7 f_7)) 0)) (and (not (U_2_bool (MapType2Select xs@@8 (MapType0Select Heap@@10 x1@@7 g)))) (and (U_2_bool (MapType2Select xs@@8 x2)) (and (not (U_2_bool (MapType2Select ys@@8 x2))) (and (not (= (U_2_int (MapType0Select Heap@@10 x2 f_7)) 0)) (and (not (U_2_bool (MapType2Select xs@@8 (MapType0Select Heap@@10 x2 g)))) (not (= x1@@7 x2))))))))))) (= (ControlFlow 0 12) 8)) anon18_correct)))
(let ((anon40_Then_correct  (=> (and (U_2_bool (MapType2Select xs@@8 x1@@7)) (and (not (U_2_bool (MapType2Select ys@@8 x1@@7))) (and (not (= (U_2_int (MapType0Select Heap@@10 x1@@7 f_7)) 0)) (and (not (U_2_bool (MapType2Select xs@@8 (MapType0Select Heap@@10 x1@@7 g)))) (and (U_2_bool (MapType2Select xs@@8 x2)) (and (not (U_2_bool (MapType2Select ys@@8 x2))) (and (not (= (U_2_int (MapType0Select Heap@@10 x2 f_7)) 0)) (and (not (U_2_bool (MapType2Select xs@@8 (MapType0Select Heap@@10 x2 g)))) (not (= x1@@7 x2)))))))))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (HasDirectPerm QPMask@1 x1@@7 g)) (=> (HasDirectPerm QPMask@1 x1@@7 g) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm QPMask@1 x2 g)) (=> (HasDirectPerm QPMask@1 x2 g) (=> (= (ControlFlow 0 9) 8) anon18_correct))))))))
(let ((anon39_Else_correct  (=> (= (U_2_int (MapType0Select Heap@@10 x2 f_7)) 0) (and (=> (= (ControlFlow 0 21) 9) anon40_Then_correct) (=> (= (ControlFlow 0 21) 12) anon40_Else_correct)))))
(let ((anon39_Then_correct  (=> (not (= (U_2_int (MapType0Select Heap@@10 x2 f_7)) 0)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (HasDirectPerm QPMask@1 x2 g)) (=> (HasDirectPerm QPMask@1 x2 g) (and (=> (= (ControlFlow 0 19) 9) anon40_Then_correct) (=> (= (ControlFlow 0 19) 12) anon40_Else_correct)))))))
(let ((anon38_Then_correct  (=> (not (U_2_bool (MapType2Select ys@@8 x2))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (HasDirectPerm QPMask@1 x2 f_7)) (=> (HasDirectPerm QPMask@1 x2 f_7) (and (=> (= (ControlFlow 0 22) 19) anon39_Then_correct) (=> (= (ControlFlow 0 22) 21) anon39_Else_correct)))))))
(let ((anon38_Else_correct  (=> (U_2_bool (MapType2Select ys@@8 x2)) (and (=> (= (ControlFlow 0 18) 9) anon40_Then_correct) (=> (= (ControlFlow 0 18) 12) anon40_Else_correct)))))
(let ((anon37_Then_correct  (=> (U_2_bool (MapType2Select xs@@8 x2)) (and (=> (= (ControlFlow 0 24) 22) anon38_Then_correct) (=> (= (ControlFlow 0 24) 18) anon38_Else_correct)))))
(let ((anon37_Else_correct  (=> (not (U_2_bool (MapType2Select xs@@8 x2))) (and (=> (= (ControlFlow 0 17) 9) anon40_Then_correct) (=> (= (ControlFlow 0 17) 12) anon40_Else_correct)))))
(let ((anon36_Then_correct  (=> (not (U_2_bool (MapType2Select xs@@8 (MapType0Select Heap@@10 x1@@7 g)))) (and (=> (= (ControlFlow 0 25) 24) anon37_Then_correct) (=> (= (ControlFlow 0 25) 17) anon37_Else_correct)))))
(let ((anon36_Else_correct  (=> (U_2_bool (MapType2Select xs@@8 (MapType0Select Heap@@10 x1@@7 g))) (and (=> (= (ControlFlow 0 16) 9) anon40_Then_correct) (=> (= (ControlFlow 0 16) 12) anon40_Else_correct)))))
(let ((anon35_Then_correct  (=> (not (= (U_2_int (MapType0Select Heap@@10 x1@@7 f_7)) 0)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (HasDirectPerm QPMask@1 x1@@7 g)) (=> (HasDirectPerm QPMask@1 x1@@7 g) (and (=> (= (ControlFlow 0 26) 25) anon36_Then_correct) (=> (= (ControlFlow 0 26) 16) anon36_Else_correct)))))))
(let ((anon35_Else_correct  (=> (= (U_2_int (MapType0Select Heap@@10 x1@@7 f_7)) 0) (and (=> (= (ControlFlow 0 15) 9) anon40_Then_correct) (=> (= (ControlFlow 0 15) 12) anon40_Else_correct)))))
(let ((anon34_Then_correct  (=> (not (U_2_bool (MapType2Select ys@@8 x1@@7))) (and (=> (= (ControlFlow 0 28) (- 0 29)) (HasDirectPerm QPMask@1 x1@@7 f_7)) (=> (HasDirectPerm QPMask@1 x1@@7 f_7) (and (=> (= (ControlFlow 0 28) 26) anon35_Then_correct) (=> (= (ControlFlow 0 28) 15) anon35_Else_correct)))))))
(let ((anon34_Else_correct  (=> (U_2_bool (MapType2Select ys@@8 x1@@7)) (and (=> (= (ControlFlow 0 14) 9) anon40_Then_correct) (=> (= (ControlFlow 0 14) 12) anon40_Else_correct)))))
(let ((anon33_Then_correct  (=> (U_2_bool (MapType2Select xs@@8 x1@@7)) (and (=> (= (ControlFlow 0 30) 28) anon34_Then_correct) (=> (= (ControlFlow 0 30) 14) anon34_Else_correct)))))
(let ((anon33_Else_correct  (=> (not (U_2_bool (MapType2Select xs@@8 x1@@7))) (and (=> (= (ControlFlow 0 13) 9) anon40_Then_correct) (=> (= (ControlFlow 0 13) 12) anon40_Else_correct)))))
(let ((anon29_Else_correct  (and (=> (= (ControlFlow 0 46) (- 0 47)) (forall ((x_6 T@U) (x_6_1 T@U) ) (!  (=> (and (= (type x_6) RefType) (= (type x_6_1) RefType)) (=> (and (and (and (and (not (= x_6 x_6_1)) (and (U_2_bool (MapType2Select xs@@8 x_6)) (and (not (U_2_bool (MapType2Select ys@@8 x_6))) (not (= (U_2_int (MapType0Select Heap@@10 x_6 f_7)) 0))))) (and (U_2_bool (MapType2Select xs@@8 x_6_1)) (and (not (U_2_bool (MapType2Select ys@@8 x_6_1))) (not (= (U_2_int (MapType0Select Heap@@10 x_6_1 f_7)) 0))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_6 x_6_1))))
 :qid |stdinbpl.649:15|
 :skolemid |97|
 :no-pattern (type x_6)
...
))) (=> (forall ((x_6@@0 T@U) (x_6_1@@0 T@U) ) (!  (=> (and (= (type x_6@@0) RefType) (= (type x_6_1@@0) RefType)) (=> (and (and (and (and (not (= x_6@@0 x_6_1@@0)) (and (U_2_bool (MapType2Select xs@@8 x_6@@0)) (and (not (U_2_bool (MapType2Select ys@@8 x_6@@0))) (not (= (U_2_int (MapType0Select Heap@@10 x_6@@0 f_7)) 0))))) (and (U_2_bool (MapType2Select xs@@8 x_6_1@@0)) (and (not (U_2_bool (MapType2Select ys@@8 x_6_1@@0))) (not (= (U_2_int (MapType0Select Heap@@10 x_6_1@@0 f_7)) 0))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_6@@0 x_6_1@@0))))
 :qid |stdinbpl.649:15|
 :skolemid |97|
...
)) (=> (and (forall ((x_6@@1 T@U) ) (!  (=> (= (type x_6@@1) RefType) (=> (and (and (U_2_bool (MapType2Select xs@@8 x_6@@1)) (and (not (U_2_bool (MapType2Select ys@@8 x_6@@1))) (not (= (U_2_int (MapType0Select Heap@@10 x_6@@1 f_7)) 0)))) (< NoPerm FullPerm)) (and (qpRange2 x_6@@1) (= (invRecv2 x_6@@1) x_6@@1))))
 :qid |stdinbpl.655:22|
 :skolemid |98|
 :pattern ( (MapType0Select Heap@@10 x_6@@1 g))
 :pattern ( (MapType1Select QPMask@1 x_6@@1 g))
 :pattern ( (MapType2Select xs@@8 x_6@@1))
 :pattern ( (MapType2Select ys@@8 x_6@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (U_2_bool (MapType2Select xs@@8 (invRecv2 o_3))) (and (not (U_2_bool (MapType2Select ys@@8 (invRecv2 o_3)))) (not (= (U_2_int (MapType0Select Heap@@10 (invRecv2 o_3) f_7)) 0)))) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.659:22|
 :skolemid |99|
 :pattern ( (invRecv2 o_3))
))) (=> (and (and (forall ((x_6@@2 T@U) ) (!  (=> (= (type x_6@@2) RefType) (=> (and (U_2_bool (MapType2Select xs@@8 x_6@@2)) (and (not (U_2_bool (MapType2Select ys@@8 x_6@@2))) (not (= (U_2_int (MapType0Select Heap@@10 x_6@@2 f_7)) 0)))) (not (= x_6@@2 null))))
 :qid |stdinbpl.665:22|
 :skolemid |100|
 :pattern ( (MapType0Select Heap@@10 x_6@@2 g))
 :pattern ( (MapType1Select QPMask@1 x_6@@2 g))
 :pattern ( (MapType2Select xs@@8 x_6@@2))
 :pattern ( (MapType2Select ys@@8 x_6@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (U_2_bool (MapType2Select xs@@8 (invRecv2 o_3@@0))) (and (not (U_2_bool (MapType2Select ys@@8 (invRecv2 o_3@@0)))) (not (= (U_2_int (MapType0Select Heap@@10 (invRecv2 o_3@@0) f_7)) 0)))) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 g)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@0 g)) FullPerm)))) (=> (not (and (and (and (U_2_bool (MapType2Select xs@@8 (invRecv2 o_3@@0))) (and (not (U_2_bool (MapType2Select ys@@8 (invRecv2 o_3@@0)))) (not (= (U_2_int (MapType0Select Heap@@10 (invRecv2 o_3@@0) f_7)) 0)))) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 g)) (U_2_real (MapType1Select QPMask@0 o_3@@0 g))))))
 :qid |stdinbpl.671:22|
 :skolemid |101|
 :pattern ( (MapType1Select QPMask@1 o_3@@0 g))
))) (and (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 g))) (= (U_2_real (MapType1Select QPMask@0 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@1 o_3@@1 f_5))))))
 :qid |stdinbpl.675:29|
 :skolemid |102|
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@1 o_3@@1 f_5))
)) (state Heap@@10 QPMask@1))) (and (and (=> (= (ControlFlow 0 46) 45) anon32_Else_correct) (=> (= (ControlFlow 0 46) 30) anon33_Then_correct)) (=> (= (ControlFlow 0 46) 13) anon33_Else_correct))))))))
(let ((anon6_correct true))
(let ((anon31_Else_correct  (=> (and (U_2_bool (MapType2Select ys@@8 x_7)) (= (ControlFlow 0 6) 2)) anon6_correct)))
(let ((anon31_Then_correct  (=> (not (U_2_bool (MapType2Select ys@@8 x_7))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm QPMask@0 x_7 f_7)) (=> (HasDirectPerm QPMask@0 x_7 f_7) (=> (= (ControlFlow 0 4) 2) anon6_correct))))))
(let ((anon30_Then_correct  (=> (U_2_bool (MapType2Select xs@@8 x_7)) (and (=> (= (ControlFlow 0 7) 4) anon31_Then_correct) (=> (= (ControlFlow 0 7) 6) anon31_Else_correct)))))
(let ((anon30_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs@@8 x_7))) (= (ControlFlow 0 3) 2)) anon6_correct)))
(let ((anon28_Else_correct  (and (=> (= (ControlFlow 0 48) (- 0 49)) (forall ((x_4 T@U) (x_4_1 T@U) ) (!  (=> (and (= (type x_4) RefType) (= (type x_4_1) RefType)) (=> (and (and (and (and (not (= x_4 x_4_1)) (and (U_2_bool (MapType2Select xs@@8 x_4)) (not (U_2_bool (MapType2Select ys@@8 x_4))))) (and (U_2_bool (MapType2Select xs@@8 x_4_1)) (not (U_2_bool (MapType2Select ys@@8 x_4_1))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4 x_4_1))))
 :qid |stdinbpl.604:15|
 :skolemid |91|
 :no-pattern (type x_4)
...
))) (=> (forall ((x_4@@0 T@U) (x_4_1@@0 T@U) ) (!  (=> (and (= (type x_4@@0) RefType) (= (type x_4_1@@0) RefType)) (=> (and (and (and (and (not (= x_4@@0 x_4_1@@0)) (and (U_2_bool (MapType2Select xs@@8 x_4@@0)) (not (U_2_bool (MapType2Select ys@@8 x_4@@0))))) (and (U_2_bool (MapType2Select xs@@8 x_4_1@@0)) (not (U_2_bool (MapType2Select ys@@8 x_4_1@@0))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4@@0 x_4_1@@0))))
 :qid |stdinbpl.604:15|
 :skolemid |91|
...
)) (=> (and (forall ((x_4@@1 T@U) ) (!  (=> (= (type x_4@@1) RefType) (=> (and (and (U_2_bool (MapType2Select xs@@8 x_4@@1)) (not (U_2_bool (MapType2Select ys@@8 x_4@@1)))) (< NoPerm FullPerm)) (and (qpRange1 x_4@@1) (= (invRecv1 x_4@@1) x_4@@1))))
 :qid |stdinbpl.610:22|
 :skolemid |92|
 :pattern ( (MapType0Select Heap@@10 x_4@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_4@@1 f_7))
 :pattern ( (MapType2Select xs@@8 x_4@@1))
 :pattern ( (MapType2Select ys@@8 x_4@@1))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (U_2_bool (MapType2Select xs@@8 (invRecv1 o_3@@2))) (not (U_2_bool (MapType2Select ys@@8 (invRecv1 o_3@@2))))) (< NoPerm FullPerm)) (qpRange1 o_3@@2)) (= (invRecv1 o_3@@2) o_3@@2)))
 :qid |stdinbpl.614:22|
 :skolemid |93|
 :pattern ( (invRecv1 o_3@@2))
))) (=> (and (and (forall ((x_4@@2 T@U) ) (!  (=> (= (type x_4@@2) RefType) (=> (and (U_2_bool (MapType2Select xs@@8 x_4@@2)) (not (U_2_bool (MapType2Select ys@@8 x_4@@2)))) (not (= x_4@@2 null))))
 :qid |stdinbpl.620:22|
 :skolemid |94|
 :pattern ( (MapType0Select Heap@@10 x_4@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 x_4@@2 f_7))
 :pattern ( (MapType2Select xs@@8 x_4@@2))
 :pattern ( (MapType2Select ys@@8 x_4@@2))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (and (U_2_bool (MapType2Select xs@@8 (invRecv1 o_3@@3))) (not (U_2_bool (MapType2Select ys@@8 (invRecv1 o_3@@3))))) (< NoPerm FullPerm)) (qpRange1 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (and (U_2_bool (MapType2Select xs@@8 (invRecv1 o_3@@3))) (not (U_2_bool (MapType2Select ys@@8 (invRecv1 o_3@@3))))) (< NoPerm FullPerm)) (qpRange1 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@3 f_7))))))
 :qid |stdinbpl.626:22|
 :skolemid |95|
...
)) (state Heap@@10 QPMask@0))) (and (and (=> (= (ControlFlow 0 48) 46) anon29_Else_correct) (=> (= (ControlFlow 0 48) 7) anon30_Then_correct)) (=> (= (ControlFlow 0 48) 3) anon30_Else_correct))))))))
(let ((anon28_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (and (=> (= (ControlFlow 0 50) 1) anon28_Then_correct) (=> (= (ControlFlow 0 50) 48) anon28_Else_correct)))))
