...
(declare-fun i2@@7 () Int)
(declare-fun Heap@@52 () T@U)
(assert (= (type Heap@@52) (MapType0Type RefType)))
(set-info :boogie-vc-id |onlyWorksWithPreExhale2#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct true))
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (> i2@@7 17))))
(let ((anon0_correct  (=> (and (state Heap@@52 ZeroMask) (= AssumeFunctionsAbove 1)) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
