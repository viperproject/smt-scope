...
(declare-fun |allSet#trigger| (T@U T@U Int Int) Bool)
...
(let ((anon21_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon10_correct)))
(let ((anon21_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (list (MapType0Select Heap@@14 r_2@@9 next) (- i@@9 1)))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (list (MapType0Select Heap@@14 r_2@@9 next) (- i@@9 1))))) (=> (= (ControlFlow 0 9) 8) anon10_correct))))))
(let ((anon15_correct true))
(let ((anon14_correct  (=> (and (state Heap@3 Mask@0) (= (ControlFlow 0 3) 1)) anon15_correct)))
(let ((anon22_Else_correct  (=> (>= 0 i@@9) (=> (and (= Heap@3 Heap@@14) (= (ControlFlow 0 5) 3)) anon14_correct))))
(let ((anon22_Then_correct  (=> (> i@@9 0) (=> (and (= Heap@0 (MapType0Store Heap@@14 null (|list#sm| r_2@@9 i@@9) (MapType1Store (MapType0Select Heap@@14 null (|list#sm| r_2@@9 i@@9)) r_2@@9 val (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|list#sm| r_2@@9 i@@9) (MapType1Store (MapType0Select Heap@0 null (|list#sm| r_2@@9 i@@9)) r_2@@9 next (bool_2_U true))))) (=> (and (and (forall ((o_3 T@U) (f_7 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_7))))
(let ((A@@12 (FieldTypeInv0 (type f_7))))
 (=> (and (and (= (type o_3) RefType) (= (type f_7) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|list#sm| r_2@@9 i@@9)) o_3 f_7)) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|list#sm| (MapType0Select Heap@1 r_2@@9 next) (- i@@9 1))) o_3 f_7)))) (U_2_bool (MapType1Select newPMask@0 o_3 f_7)))))
 :qid |stdinbpl.652:35|
 :skolemid |86|
 :pattern ( (MapType1Select newPMask@0 o_3 f_7))
)) (= Heap@2 (MapType0Store Heap@1 null (|list#sm| r_2@@9 i@@9) newPMask@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 4) 3))) anon14_correct)))))
(let ((anon20_Else_correct  (=> (|allSet#trigger| (MapType0Select Heap@@14 null (list (MapType0Select Heap@@14 r_2@@9 next) (- i@@9 1))) (MapType0Select Heap@@14 r_2@@9 next) (- i@@9 1) v_2@@3) (and (=> (= (ControlFlow 0 7) 4) anon22_Then_correct) (=> (= (ControlFlow 0 7) 5) anon22_Else_correct)))))
(let ((anon19_Then_correct  (=> (= (U_2_int (MapType0Select Heap@@14 r_2@@9 val)) v_2@@3) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm UnfoldingMask@4 r_2@@9 next)) (=> (HasDirectPerm UnfoldingMask@4 r_2@@9 next) (and (and (=> (= (ControlFlow 0 12) 7) anon20_Else_correct) (=> (= (ControlFlow 0 12) 9) anon21_Then_correct)) (=> (= (ControlFlow 0 12) 11) anon21_Else_correct)))))))
(let ((anon19_Else_correct  (=> (not (= (U_2_int (MapType0Select Heap@@14 r_2@@9 val)) v_2@@3)) (and (=> (= (ControlFlow 0 6) 4) anon22_Then_correct) (=> (= (ControlFlow 0 6) 5) anon22_Else_correct)))))
(let ((anon6_correct  (=> (state Heap@@14 UnfoldingMask@4) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm UnfoldingMask@4 r_2@@9 val)) (=> (HasDirectPerm UnfoldingMask@4 r_2@@9 val) (and (=> (= (ControlFlow 0 14) 12) anon19_Then_correct) (=> (= (ControlFlow 0 14) 6) anon19_Else_correct)))))))
(let ((anon18_Else_correct  (=> (>= 0 i@@9) (=> (and (= UnfoldingMask@4 UnfoldingMask@0) (= (ControlFlow 0 17) 14)) anon6_correct))))
(let ((anon18_Then_correct  (=> (and (and (> i@@9 0) (not (= r_2@@9 null))) (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 r_2@@9 val (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 r_2@@9 val)) FullPerm)))) (state Heap@@14 UnfoldingMask@1))) (=> (and (and (and (not (= r_2@@9 null)) (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 r_2@@9 next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 r_2@@9 next)) FullPerm))))) (and (state Heap@@14 UnfoldingMask@2) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 null (list (MapType0Select Heap@@14 r_2@@9 next) (- i@@9 1)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 null (list (MapType0Select Heap@@14 r_2@@9 next) (- i@@9 1)))) FullPerm)))))) (and (and (InsidePredicate (list r_2@@9 i@@9) (MapType0Select Heap@@14 null (list r_2@@9 i@@9)) (list (MapType0Select Heap@@14 r_2@@9 next) (- i@@9 1)) (MapType0Select Heap@@14 null (list (MapType0Select Heap@@14 r_2@@9 next) (- i@@9 1)))) (state Heap@@14 UnfoldingMask@3)) (and (= UnfoldingMask@4 UnfoldingMask@3) (= (ControlFlow 0 16) 14)))) anon6_correct))))
(let ((anon4_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (list r_2@@9 i@@9) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (list r_2@@9 i@@9))) FullPerm)))) (and (=> (= (ControlFlow 0 18) 16) anon18_Then_correct) (=> (= (ControlFlow 0 18) 17) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 21) 18)) anon4_correct)))
(let ((anon17_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list r_2@@9 i@@9))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list r_2@@9 i@@9)))) (=> (= (ControlFlow 0 19) 18) anon4_correct))))))
(let ((anon16_Else_correct  (=> (< 0 i@@9) (=> (and (|list#trigger| Heap@@14 (list r_2@@9 i@@9)) (= (MapType0Select Heap@@14 null (list r_2@@9 i@@9)) (FrameFragment (ite (> i@@9 0) (CombineFrames (FrameFragment (MapType0Select Heap@@14 r_2@@9 val)) (CombineFrames (FrameFragment (MapType0Select Heap@@14 r_2@@9 next)) (MapType0Select Heap@@14 null (list (MapType0Select Heap@@14 r_2@@9 next) (- i@@9 1))))) EmptyFrame)))) (and (=> (= (ControlFlow 0 22) 19) anon17_Then_correct) (=> (= (ControlFlow 0 22) 21) anon17_Else_correct))))))
(let ((anon16_Then_correct  (=> (and (<= i@@9 0) (= (ControlFlow 0 2) 1)) anon15_correct)))
(let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (U_2_bool (MapType0Select Heap@@14 r_2@@9 $allocated))) (=> (and (and (= AssumeFunctionsAbove 0) (= Mask@0 (MapType1Store ZeroMask null (list r_2@@9 i@@9) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (list r_2@@9 i@@9))) FullPerm))))) (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0))) (and (=> (= (ControlFlow 0 23) 2) anon16_Then_correct) (=> (= (ControlFlow 0 23) 22) anon16_Else_correct))))))
