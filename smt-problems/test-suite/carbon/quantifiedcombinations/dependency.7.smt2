...
(declare-fun x_23 () T@U)
(assert  (and (and (and (and (and (= (type xs@@3) (SeqType RefType)) (= (type x_23) RefType)) (= (type Heap@@15) (MapType0Type RefType))) (= (type x_24) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv17 arg0@@43)) RefType)
 :qid |funType:invRecv17|
 :pattern ( (invRecv17 arg0@@43))
))))
...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains| xs@@3 x_24)) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains| xs@@3 x_24) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm QPMask@0 x_24 f_7)) (=> (HasDirectPerm QPMask@0 x_24 f_7) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (and (|Seq#Contains| xs@@3 x_3) (> (U_2_int (MapType0Select Heap@@15 x_3 f_7)) 0))) (and (|Seq#Contains| xs@@3 x_3_1) (> (U_2_int (MapType0Select Heap@@15 x_3_1 f_7)) 0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1))))
 :qid |stdinbpl.2053:15|
 :skolemid |186|
 :no-pattern (type x_3)
...
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (and (|Seq#Contains| xs@@3 x_1) (> (U_2_int (MapType0Select Heap@@15 x_1 g)) 0))) (and (|Seq#Contains| xs@@3 x_1_1) (> (U_2_int (MapType0Select Heap@@15 x_1_1 g)) 0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (and (|Seq#Contains| xs@@3 x_1@@0) (> (U_2_int (MapType0Select Heap@@15 x_1@@0 g)) 0))) (and (|Seq#Contains| xs@@3 x_1_1@@0) (> (U_2_int (MapType0Select Heap@@15 x_1_1@@0 g)) 0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.2010:15|
 :skolemid |180|
...
)) (=> (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (and (|Seq#Contains| xs@@3 x_1@@1) (> (U_2_int (MapType0Select Heap@@15 x_1@@1 g)) 0)) (< NoPerm FullPerm)) (and (qpRange17 x_1@@1) (= (invRecv17 x_1@@1) x_1@@1))))
...
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (|Seq#Contains| xs@@3 (invRecv17 o_3)) (> (U_2_int (MapType0Select Heap@@15 (invRecv17 o_3) g)) 0)) (< NoPerm FullPerm)) (qpRange17 o_3)) (= (invRecv17 o_3) o_3)))
 :qid |stdinbpl.2020:22|
 :skolemid |182|
 :pattern ( (invRecv17 o_3))
))) (=> (and (and (forall ((x_1@@2 T@U) ) (!  (=> (= (type x_1@@2) RefType) (=> (and (|Seq#Contains| xs@@3 x_1@@2) (> (U_2_int (MapType0Select Heap@@15 x_1@@2 g)) 0)) (not (= x_1@@2 null))))
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (|Seq#Contains| xs@@3 (invRecv17 o_3@@0)) (> (U_2_int (MapType0Select Heap@@15 (invRecv17 o_3@@0) g)) 0)) (< NoPerm FullPerm)) (qpRange17 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv17 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (and (|Seq#Contains| xs@@3 (invRecv17 o_3@@0)) (> (U_2_int (MapType0Select Heap@@15 (invRecv17 o_3@@0) g)) 0)) (< NoPerm FullPerm)) (qpRange17 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
)) (state Heap@@15 QPMask@0))) (and (and (=> (= (ControlFlow 0 11) 6) anon11_Else_correct) (=> (= (ControlFlow 0 11) 8) anon12_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon12_Else_correct))))))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (|Seq#Contains| xs@@3 x_23)) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (|Seq#Contains| xs@@3 x_23) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm ZeroMask x_23 g)) (=> (HasDirectPerm ZeroMask x_23 g) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@15 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (and (=> (= (ControlFlow 0 13) 11) anon9_Else_correct) (=> (= (ControlFlow 0 13) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 13) 4) anon10_Else_correct)))))
