...
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@5 x@@8 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@5 x@@8 f_7))) (=> (= (ControlFlow 0 4) 3) anon9_correct))))))
(let ((anon7_correct  (=> (= Mask@5 (MapType1Store Mask@3 x@@8 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@3 x@@8 f_7)) FullPerm)))) (=> (and (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@1 Mask@5) (state ExhaleHeap@1 Mask@5)) (and (=> (= (ControlFlow 0 7) 4) anon15_Then_correct) (=> (= (ControlFlow 0 7) 6) anon15_Else_correct))))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select Mask@3 x@@8 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 x@@8 f_7))) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
(let ((anon13_Then_correct  (=> (state ExhaleHeap@0 ZeroMask) (=> (and (and (not (= x@@8 null)) (= Mask@3 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm))))) (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm Mask@3 x@@8 f_7)) (=> (HasDirectPerm Mask@3 x@@8 f_7) (=> (and (< (U_2_int (MapType0Select ExhaleHeap@0 x@@8 f_7)) 3) (state ExhaleHeap@0 Mask@3)) (and (=> (= (ControlFlow 0 11) 8) anon14_Then_correct) (=> (= (ControlFlow 0 11) 10) anon14_Else_correct)))))))))
(let ((anon13_Else_correct true))
(let ((anon12_Then_correct true))
(let ((anon2_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 x@@8 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 x@@8 f_7)) FullPerm)))) (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@1)) (and (and (=> (= (ControlFlow 0 13) 1) anon12_Then_correct) (=> (= (ControlFlow 0 13) 11) anon13_Then_correct)) (=> (= (ControlFlow 0 13) 2) anon13_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 13)) anon2_correct)))
(let ((anon11_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@8 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@8 f_7))) (=> (= (ControlFlow 0 14) 13) anon2_correct))))))
