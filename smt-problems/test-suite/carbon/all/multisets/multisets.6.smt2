...
(declare-fun B@@11 () T@U)
(declare-fun n () Int)
(declare-fun x@@19 () Int)
(declare-fun y@@6 () Int)
(declare-fun B1@0 () T@U)
(assert  (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type B@@11) (MultiSetType intType))) (= (type B1@0) (MultiSetType intType))))
(set-info :boogie-vc-id test04a)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= (|MultiSet#Card| B@@11) n) (state Heap@@9 ZeroMask)) (=> (and (and (and (> (|MultiSet#Select| B@@11 (int_2_U x@@19)) 0) (state Heap@@9 ZeroMask)) (and (> (|MultiSet#Select| B@@11 (int_2_U y@@6)) 0) (state Heap@@9 ZeroMask))) (and (and (not (= x@@19 y@@6)) (state Heap@@9 ZeroMask)) (and (= B1@0 (|MultiSet#Difference| B@@11 (|MultiSet#Singleton| (int_2_U x@@19)))) (state Heap@@9 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (> (|MultiSet#Select| B1@0 (int_2_U y@@6)) 0)) (=> (> (|MultiSet#Select| B1@0 (int_2_U y@@6)) 0) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (|MultiSet#Card| B1@0) (- n 1))) (=> (= (|MultiSet#Card| B1@0) (- n 1)) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (> (|MultiSet#Select| B1@0 (int_2_U x@@19)) 0))))))))))))
