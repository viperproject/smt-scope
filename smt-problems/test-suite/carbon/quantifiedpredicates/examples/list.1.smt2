...
(assert  (and (and (and (and (and (= (type r_2@@9) RefType) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@14) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))))
...
(let ((anon3_Then_correct  (=> (> i@@9 0) (=> (and (not (= r_2@@9 null)) (= Mask@0 (MapType1Store ZeroMask r_2@@9 val (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_2@@9 val)) FullPerm))))) (=> (and (and (state Heap@@14 Mask@0) (not (= r_2@@9 null))) (and (= Mask@1 (MapType1Store Mask@0 r_2@@9 next (real_2_U (+ (U_2_real (MapType1Select Mask@0 r_2@@9 next)) FullPerm)))) (state Heap@@14 Mask@1))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 r_2@@9 next)) (=> (HasDirectPerm Mask@1 r_2@@9 next) (=> (and (and (= Mask@2 (MapType1Store Mask@1 null (list (MapType0Select Heap@@14 r_2@@9 next) (- i@@9 1)) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (list (MapType0Select Heap@@14 r_2@@9 next) (- i@@9 1)))) FullPerm)))) (state Heap@@14 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 2) 1))) anon2_correct))))))))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@14 r_2@@9 $allocated))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
