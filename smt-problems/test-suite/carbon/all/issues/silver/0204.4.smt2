...
(assert  (and (and (and (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type Ops_1Heap@0) (MapType0Type RefType))) (= (type Ops_1Mask) (MapType1Type RefType realType))) (= (type Used_1Heap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@61 T@U) ) (! (= (type (invRecv2 arg0@@61)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@61))
))) (= (type head) RefType)) (= (type UsedHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon14_Else_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (forall ((n$0_1 T@U) (n$0_1_1 T@U) ) (!  (=> (and (= (type n$0_1) RefType) (= (type n$0_1_1) RefType)) (=> (and (and (not (= n$0_1 n$0_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_1 n$0_1_1))))
 :qid |stdinbpl.777:19|
 :skolemid |131|
...
(let ((anon13_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (wand FullPerm true)))))))
(let ((anon5_correct  (=> (= b_1_1@7  (and b_1_1 (state Ops_1Heap@0 Ops_1Mask))) (=> (and (= b_1_1@8  (and b_1_1@7 (state Ops_1Heap@0 Ops_1Mask))) (= b_2_1@0  (and b_2_1 (state Used_1Heap@0 ZeroMask)))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (wand FullPerm true) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (wand FullPerm true))) FullPerm)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (and (=> (= (ControlFlow 0 6) 2) anon13_Else_correct) (=> (= (ControlFlow 0 6) 3) anon14_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon14_Else_correct)))))))
(let ((anon4_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (forall ((n_3 T@U) (n_3_1 T@U) ) (!  (=> (and (= (type n_3) RefType) (= (type n_3_1) RefType)) (=> (and (and (not (= n_3 n_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3 n_3_1))))
 :qid |stdinbpl.712:17|
 :skolemid |125|
 :no-pattern (type n_3)
...
))) (=> (forall ((n_3@@0 T@U) (n_3_1@@0 T@U) ) (!  (=> (and (= (type n_3@@0) RefType) (= (type n_3_1@@0) RefType)) (=> (and (and (not (= n_3@@0 n_3_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3@@0 n_3_1@@0))))
 :qid |stdinbpl.712:17|
 :skolemid |125|
...
)) (=> (= b_1_1@1  (and b_1_1 (forall ((n_3@@1 T@U) ) (!  (=> (and (= (type n_3@@1) RefType) (< NoPerm FullPerm)) (and (qpRange2 n_3@@1) (= (invRecv2 n_3@@1) n_3@@1)))
 :qid |stdinbpl.718:35|
 :skolemid |126|
 :pattern ( (MapType0Select Ops_1Heap@0 n_3@@1 val))
 :pattern ( (MapType1Select QPMask@0 n_3@@1 val))
)))) (=> (and (= b_1_1@2  (and b_1_1@1 (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (< NoPerm FullPerm) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.722:35|
 :skolemid |127|
 :pattern ( (invRecv2 o_3))
)))) (= b_1_1@3  (and b_1_1@2 (forall ((n_3@@2 T@U) ) (!  (=> (= (type n_3@@2) RefType) (not (= n_3@@2 null)))
 :qid |stdinbpl.728:35|
 :skolemid |128|
 :pattern ( (MapType0Select Ops_1Heap@0 n_3@@2 val))
 :pattern ( (MapType1Select QPMask@0 n_3@@2 val))
))))) (=> (and (and (= b_1_1@4  (and b_1_1@3 (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (< NoPerm FullPerm) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (< NoPerm FullPerm) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.734:35|
 :skolemid |129|
 :pattern ( (MapType1Select QPMask@0 o_3@@0 val))
)))) (= b_1_1@5  (and b_1_1@4 (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
...
))))) (and (= b_1_1@6  (and b_1_1@5 (state Ops_1Heap@0 QPMask@0))) (= (ControlFlow 0 8) 6))) anon5_correct)))))))
(let ((anon11_Else_correct  (=> (and (not b_1_1@0) (= (ControlFlow 0 11) 8)) anon4_correct)))
(let ((anon11_Then_correct  (=> (and b_1_1@0 (= (ControlFlow 0 10) 8)) anon4_correct)))
(let ((anon10_Then_correct  (=> b_1_1@0 (and (=> (= (ControlFlow 0 12) 10) anon11_Then_correct) (=> (= (ControlFlow 0 12) 11) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (not b_1_1@0) (= (ControlFlow 0 7) 6)) anon5_correct)))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 head $allocated))) (and (= b_1_1@0  (and b_1_1 (state Ops_1Heap@0 ZeroMask))) (= b_2@0  (and b_2 (state UsedHeap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 13) 12) anon10_Then_correct) (=> (= (ControlFlow 0 13) 7) anon10_Else_correct)))))
