(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:24:47
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quantifiedpredicates/basic/knownfolded.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (and
  (not
    (=
      ...
      $Snap.unit))
  (=
    ($PSF.lookup_P (as sm@37@01  $PSF<P>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap x@18@01)
      ($SortWrappers.BoolTo$Snap b@20@01)))
    ($PSF.lookup_P (as sm@34@01  $PSF<P>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap x@18@01)
...
(push) ; 6
; Precomputing data for removing quantified permissions
(define-fun pTaken@39@01 ((x $Ref) (b Bool)) $Perm
  (ite
    (and (= x x@18@01) (= b b@20@01))
    ($Perm.min
      (ite (and (= x x@18@01) (= b b@20@01)) $Perm.Write $Perm.No)
      $Perm.Write)
    $Perm.No))
(define-fun pTaken@40@01 ((x $Ref) (b Bool)) $Perm
  (ite
    (and (= x x@18@01) (= b b@20@01))
    ($Perm.min
      (ite
...
(push) ; 7
(set-option :timeout 500)
(assert (not (= (- $Perm.Write (pTaken@39@01 x@18@01 b@20@01)) $Perm.No)))
(check-sat)
; unsat
(pop) ; 7
; 0,00s
...
(assert (not (forall ((x $Ref) (b Bool)) (!
  (=>
    (and (= x x@18@01) (= b b@20@01))
    (= (- $Perm.Write (pTaken@39@01 x b)) $Perm.No))
...
(assert (and
  ...
  (=
    ...
    ($PSF.lookup_P (as sm@34@01  $PSF<P>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap x@18@01)
      ($SortWrappers.BoolTo$Snap b@20@01))))))
(assert (P%trigger ($PSF.lookup_P (as sm@37@01  $PSF<P>) ($Snap.combine
  ($SortWrappers.$RefTo$Snap x@18@01)
  ($SortWrappers.BoolTo$Snap b@20@01))) x@18@01 b@20@01))
(set-option :timeout 0)
(push) ; 7
...
(assert (and
  ...
  (=
    ...
    ($PSF.lookup_P (as sm@34@01  $PSF<P>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap x@18@01)
      ($SortWrappers.BoolTo$Snap b@20@01))))
  (P%trigger ($PSF.lookup_P (as sm@37@01  $PSF<P>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap x@18@01)
    ($SortWrappers.BoolTo$Snap b@20@01))) x@18@01 b@20@01)))
(push) ; 6
(assert (not (=
  ($SortWrappers.$SnapToInt ($PSF.lookup_P (as sm@37@01  $PSF<P>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap x@18@01)
    ($SortWrappers.BoolTo$Snap b@20@01))))
  0)))
(check-sat)
...
(assert (and
  (not
    (=
      ...
      $Snap.unit))
  (=
    ($PSF.lookup_P (as sm@44@01  $PSF<P>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap x@18@01)
      ($SortWrappers.BoolTo$Snap b@20@01)))
    ($PSF.lookup_P (as sm@41@01  $PSF<P>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap x@18@01)
...
(push) ; 6
; Precomputing data for removing quantified permissions
(define-fun pTaken@46@01 ((x $Ref) (b Bool)) $Perm
  (ite
    (and (= x x@18@01) (= b b@20@01))
    ($Perm.min
      (ite (and (= x x@18@01) (= b b@20@01)) $Perm.Write $Perm.No)
      $Perm.Write)
    $Perm.No))
(define-fun pTaken@47@01 ((x $Ref) (b Bool)) $Perm
  (ite
    (and (= x x@18@01) (= b b@20@01))
    ($Perm.min
      (ite
...
(push) ; 7
(set-option :timeout 500)
(assert (not (= (- $Perm.Write (pTaken@46@01 x@18@01 b@20@01)) $Perm.No)))
(check-sat)
; unsat
(pop) ; 7
; 0,00s
...
(assert (not (forall ((x $Ref) (b Bool)) (!
  (=>
    (and (= x x@18@01) (= b b@20@01))
    (= (- $Perm.Write (pTaken@46@01 x b)) $Perm.No))
...
(assert (and
  ...
  (=
    ...
    ($PSF.lookup_P (as sm@41@01  $PSF<P>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap x@18@01)
      ($SortWrappers.BoolTo$Snap b@20@01))))))
(assert (P%trigger ($PSF.lookup_P (as sm@44@01  $PSF<P>) ($Snap.combine
  ($SortWrappers.$RefTo$Snap x@18@01)
  ($SortWrappers.BoolTo$Snap b@20@01))) x@18@01 b@20@01))
...
(assert (and
  ...
  (=
    ...
    ($PSF.lookup_P (as sm@41@01  $PSF<P>) ($Snap.combine
      ($SortWrappers.$RefTo$Snap x@18@01)
      ($SortWrappers.BoolTo$Snap b@20@01))))
  (P%trigger ($PSF.lookup_P (as sm@44@01  $PSF<P>) ($Snap.combine
    ($SortWrappers.$RefTo$Snap x@18@01)
    ($SortWrappers.BoolTo$Snap b@20@01))) x@18@01 b@20@01)))
(push) ; 6
(assert (not ($SortWrappers.$SnapToBool ($PSF.lookup_P (as sm@44@01  $PSF<P>) ($Snap.combine
  ($SortWrappers.$RefTo$Snap x@18@01)
  ($SortWrappers.BoolTo$Snap b@20@01))))))
(check-sat)
; unsat
...
; 0,00s
; (get-info :all-statistics)
(assert ($SortWrappers.$SnapToBool ($PSF.lookup_P (as sm@44@01  $PSF<P>) ($Snap.combine
  ($SortWrappers.$RefTo$Snap x@18@01)
  ($SortWrappers.BoolTo$Snap b@20@01)))))
(pop) ; 5
(pop) ; 4
