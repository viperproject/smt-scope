...
; 0,00s
; (get-info :all-statistics)
(assert (Nodelist$%trigger ($Snap.second s@$) this$_3@0@00))
(assert (=
  ($Snap.second s@$)
  ($Snap.combine
...
(assert (=> (< $Perm.No $k@5@00) (not (= this$_3@0@00 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second s@$))
  ($Snap.combine
...
(push) ; 4
(set-option :timeout 10)
(assert (not (= this$_3@0@00 ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))))))
(check-sat)
; unknown
(pop) ; 4
; 0,00s
...
(assert (=>
  (not
    (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) $Ref.null))
  (=
    (joined_unfolding@8@00 s@$ this$_3@0@00)
    (Seq_append
...
(assert (and
  ...
  (Nodelist$%trigger ($Snap.second s@$) this$_3@0@00)
  (=
    ($Snap.second s@$)
    ($Snap.combine
      ($Snap.first ($Snap.second s@$))
  ...
  (<= $Perm.No $k@5@00)
  (<= $k@5@00 $Perm.Write)
  (=> (< $Perm.No $k@5@00) (not (= this$_3@0@00 $Ref.null)))
  (=
    ($Snap.second ($Snap.second s@$))
    ($Snap.combine
      ($Snap.first ($Snap.second ($Snap.second s@$)))
...
(assert (or
  ...
  (not
    (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) $Ref.null))))
(assert (= result@1@00 (joined_unfolding@8@00 s@$ this$_3@0@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (this$_3@0@00 $Ref)) (!
  (and
...
(assert (= ($Snap.first s@$) $Snap.unit))
; [eval] this$_2 != null
(assert (not (= this$_2@2@00 $Ref.null)))
...
; 0,00s
; (get-info :all-statistics)
(assert (Nodelist$%trigger ($Snap.second s@$) this$_2@2@00))
(assert (=
  ($Snap.second s@$)
  ($Snap.combine
    ($Snap.first ($Snap.second s@$))
...
(assert (=> (< $Perm.No $k@10@00) (not (= this$_2@2@00 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second s@$))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second s@$)))
...
(push) ; 4
(set-option :timeout 10)
(assert (not (= this$_2@2@00 ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))))))
(check-sat)
; unknown
(pop) ; 4
; 0,00s
...
(assert (=>
  (not
    (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) $Ref.null))
  (=
    (joined_unfolding@13@00 s@$ this$_2@2@00)
    (Seq_append
      (Seq_singleton ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second s@$)))))
...
(assert (and
  ...
  (Nodelist$%trigger ($Snap.second s@$) this$_2@2@00)
  (=
    ($Snap.second s@$)
    ($Snap.combine
      ($Snap.first ($Snap.second s@$))
  ...
  (<= $Perm.No $k@10@00)
  (<= $k@10@00 $Perm.Write)
  (=> (< $Perm.No $k@10@00) (not (= this$_2@2@00 $Ref.null)))
  (=
    ($Snap.second ($Snap.second s@$))
    ($Snap.combine
      ($Snap.first ($Snap.second ($Snap.second s@$)))
...
(assert (or
  ...
  (not
    (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second s@$))) $Ref.null))))
(assert (= result@3@00 (joined_unfolding@13@00 s@$ this$_2@2@00)))
(pop) ; 1
(assert (forall ((s@$ $Snap) (this$_2@2@00 $Ref)) (!
  (and
