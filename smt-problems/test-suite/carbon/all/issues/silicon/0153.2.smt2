...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon4_correct  (=> (and (= PostMask@2 (MapType1Store PostMask@1 this@@3 f_7 (real_2_U (- (U_2_real (MapType1Select PostMask@1 this@@3 f_7)) perm@0)))) (= (ControlFlow 0 12) (- 0 11))) (not (= (MapType0Select PostHeap@0 this@@3 f_7) null)))))
(let ((anon13_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 15) 12)) anon4_correct)))
(let ((anon13_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= perm@0 (U_2_real (MapType1Select PostMask@1 this@@3 f_7)))) (=> (<= perm@0 (U_2_real (MapType1Select PostMask@1 this@@3 f_7))) (=> (= (ControlFlow 0 13) 12) anon4_correct))))))
(let ((anon12_Then_correct  (=> (= perm@0 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 16) 13) anon13_Then_correct) (=> (= (ControlFlow 0 16) 15) anon13_Else_correct)))))))
(let ((anon12_Else_correct true))
(let ((anon11_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (not (= this@@3 null))) (=> (and (and (and (= PostMask@0 (MapType1Store ZeroMask this@@3 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@3 f_7)) FullPerm)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (not (= other null)))) (and (and (= PostMask@1 (MapType1Store PostMask@0 other f_7 (real_2_U (+ (U_2_real (MapType1Select PostMask@0 other f_7)) FullPerm)))) (state PostHeap@0 PostMask@1)) (and (state PostHeap@0 PostMask@1) (state PostHeap@0 PostMask@1)))) (and (=> (= (ControlFlow 0 18) 16) anon12_Then_correct) (=> (= (ControlFlow 0 18) 10) anon12_Else_correct))))))
(let ((anon10_correct  (=> (and (= Mask@3 (MapType1Store Mask@2 other f_7 (real_2_U (- (U_2_real (MapType1Select Mask@2 other f_7)) FullPerm)))) (= (ControlFlow 0 2) (- 0 1))) (fun Heap@@13 this@@3))))
(let ((anon15_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon10_correct)))
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@2 other f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 other f_7))) (=> (= (ControlFlow 0 3) 2) anon10_correct))))))
(let ((anon8_correct  (=> (= Mask@2 (MapType1Store Mask@1 this@@3 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 this@@3 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 6) 3) anon15_Then_correct) (=> (= (ControlFlow 0 6) 5) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon8_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select Mask@1 this@@3 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 this@@3 f_7))) (=> (= (ControlFlow 0 7) 6) anon8_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@13 this@@3 $allocated)) (U_2_bool (MapType0Select Heap@@13 other $allocated)))) (=> (and (and (and (not (= this@@3 null)) (= Mask@0 (MapType1Store ZeroMask this@@3 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@3 f_7)) FullPerm))))) (and (state Heap@@13 Mask@0) (state Heap@@13 Mask@0))) (and (and (not (= other null)) (= Mask@1 (MapType1Store Mask@0 other f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 other f_7)) FullPerm))))) (and (state Heap@@13 Mask@1) (state Heap@@13 Mask@1)))) (and (and (=> (= (ControlFlow 0 19) 18) anon11_Then_correct) (=> (= (ControlFlow 0 19) 7) anon14_Then_correct)) (=> (= (ControlFlow 0 19) 9) anon14_Else_correct))))))
