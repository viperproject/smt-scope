...
(declare-fun y_8 () T@U)
(declare-fun y_11 () T@U)
(declare-fun y_13 () T@U)
(declare-fun Heap@@9 () T@U)
(declare-fun b_2 () Bool)
(declare-fun y_12 () T@U)
(declare-fun y_10 () T@U)
(declare-fun x@@8 () T@U)
(declare-fun Mask@0 () T@U)
(assert  (and (and (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type y_10) RefType)) (= (type y_12) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type y_13) RefType)) (= (type y_11) RefType)) (= (type y_8) RefType)) (= (type x@@8) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test01b)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 38) (let ((anon6_correct true))
(let ((anon30_Else_correct  (=> (and (not (HasDirectPerm Mask@1 y_8 f_7)) (= (ControlFlow 0 32) 29)) anon6_correct)))
(let ((anon30_Then_correct  (=> (HasDirectPerm Mask@1 y_8 f_7) (and (=> (= (ControlFlow 0 30) (- 0 31)) (HasDirectPerm Mask@1 y_8 f_7)) (=> (HasDirectPerm Mask@1 y_8 f_7) (=> (= (ControlFlow 0 30) 29) anon6_correct))))))
(let ((anon15_correct true))
(let ((anon35_Else_correct  (=> (and (not (HasDirectPerm Mask@1 y_11 f_7)) (= (ControlFlow 0 24) 21)) anon15_correct)))
(let ((anon35_Then_correct  (=> (HasDirectPerm Mask@1 y_11 f_7) (and (=> (= (ControlFlow 0 22) (- 0 23)) (HasDirectPerm Mask@1 y_11 f_7)) (=> (HasDirectPerm Mask@1 y_11 f_7) (=> (= (ControlFlow 0 22) 21) anon15_correct))))))
(let ((anon25_correct true))
(let ((anon40_Else_correct  (=> (and (not (HasDirectPerm Mask@1 y_13 f_7)) (= (ControlFlow 0 14) 11)) anon25_correct)))
(let ((anon40_Then_correct  (=> (HasDirectPerm Mask@1 y_13 f_7) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm Mask@1 y_13 f_7)) (=> (HasDirectPerm Mask@1 y_13 f_7) (=> (= (ControlFlow 0 12) 11) anon25_correct))))))
(let ((anon39_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((y_9 T@U) ) (!  (=> (and (= (type y_9) RefType) (HasDirectPerm Mask@1 y_9 f_7)) false)
 :qid |stdinbpl.439:15|
 :skolemid |29|
 :pattern ( (MapType1Select Mask@1 y_9 f_7))
 :pattern ( (MapType0Select Heap@@9 y_9 f_7))
)))))
(let ((anon22_correct  (=> (state Heap@@9 Mask@1) (and (and (=> (= (ControlFlow 0 15) 10) anon39_Else_correct) (=> (= (ControlFlow 0 15) 12) anon40_Then_correct)) (=> (= (ControlFlow 0 15) 14) anon40_Else_correct)))))
(let ((anon38_Else_correct  (=> (and (not (forall ((y_7 T@U) ) (!  (=> (and (= (type y_7) RefType) (HasDirectPerm Mask@1 y_7 f_7)) false)
 :qid |stdinbpl.417:17|
 :skolemid |28|
 :pattern ( (MapType1Select Mask@1 y_7 f_7))
 :pattern ( (MapType0Select Heap@@9 y_7 f_7))
))) (= (ControlFlow 0 18) 15)) anon22_correct)))
(let ((anon38_Then_correct  (=> (forall ((y_7@@0 T@U) ) (!  (=> (and (= (type y_7@@0) RefType) (HasDirectPerm Mask@1 y_7@@0 f_7)) false)
 :qid |stdinbpl.417:17|
 :skolemid |28|
 :pattern ( (MapType1Select Mask@1 y_7@@0 f_7))
 :pattern ( (MapType0Select Heap@@9 y_7@@0 f_7))
)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (not b_2)) (=> (not b_2) (=> (= (ControlFlow 0 16) 15) anon22_correct))))))
(let ((anon19_correct true))
(let ((anon37_Else_correct  (=> (and (not (HasDirectPerm Mask@1 y_12 f_7)) (= (ControlFlow 0 8) 5)) anon19_correct)))
(let ((anon37_Then_correct  (=> (HasDirectPerm Mask@1 y_12 f_7) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm Mask@1 y_12 f_7)) (=> (HasDirectPerm Mask@1 y_12 f_7) (=> (= (ControlFlow 0 6) 5) anon19_correct))))))
(let ((anon16_correct  (=> (state Heap@@9 Mask@1) (and (and (and (=> (= (ControlFlow 0 19) 16) anon38_Then_correct) (=> (= (ControlFlow 0 19) 18) anon38_Else_correct)) (=> (= (ControlFlow 0 19) 6) anon37_Then_correct)) (=> (= (ControlFlow 0 19) 8) anon37_Else_correct)))))
(let ((anon33_Then_correct  (=> (forall ((y_3 T@U) ) (!  (=> (and (= (type y_3) RefType) (HasDirectPerm Mask@1 y_3 f_7)) false)
 :qid |stdinbpl.389:17|
 :skolemid |27|
 :pattern ( (MapType1Select Mask@1 y_3 f_7))
 :pattern ( (MapType0Select Heap@@9 y_3 f_7))
...
(let ((anon33_Else_correct  (=> (and (not (forall ((y_3@@0 T@U) ) (!  (=> (and (= (type y_3@@0) RefType) (HasDirectPerm Mask@1 y_3@@0 f_7)) false)
 :qid |stdinbpl.389:17|
 :skolemid |27|
 :pattern ( (MapType1Select Mask@1 y_3@@0 f_7))
 :pattern ( (MapType0Select Heap@@9 y_3@@0 f_7))
))) (= (ControlFlow 0 20) 19)) anon16_correct)))
(let ((anon10_correct true))
(let ((anon32_Else_correct  (=> (and (not (HasDirectPerm Mask@1 y_10 f_7)) (= (ControlFlow 0 4) 1)) anon10_correct)))
(let ((anon32_Then_correct  (=> (HasDirectPerm Mask@1 y_10 f_7) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 y_10 f_7)) (=> (HasDirectPerm Mask@1 y_10 f_7) (=> (= (ControlFlow 0 2) 1) anon10_correct))))))
(let ((anon7_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (or b_2 (forall ((y_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (HasDirectPerm Mask@1 y_1 f_7)) false)
 :qid |stdinbpl.371:22|
 :skolemid |26|
 :pattern ( (MapType1Select Mask@1 y_1 f_7))
 :pattern ( (MapType0Select Heap@@9 y_1 f_7))
)))) (=> (or b_2 (forall ((y_1@@0 T@U) ) (!  (=> (and (= (type y_1@@0) RefType) (HasDirectPerm Mask@1 y_1@@0 f_7)) false)
 :qid |stdinbpl.371:22|
 :skolemid |26|
 :pattern ( (MapType1Select Mask@1 y_1@@0 f_7))
 :pattern ( (MapType0Select Heap@@9 y_1@@0 f_7))
))) (=> (state Heap@@9 Mask@1) (and (and (and (=> (= (ControlFlow 0 26) 25) anon33_Then_correct) (=> (= (ControlFlow 0 26) 20) anon33_Else_correct)) (=> (= (ControlFlow 0 26) 2) anon32_Then_correct)) (=> (= (ControlFlow 0 26) 4) anon32_Else_correct)))))))
(let ((anon28_Then_correct  (=> (not b_2) (and (and (=> (= (ControlFlow 0 33) 26) anon7_correct) (=> (= (ControlFlow 0 33) 30) anon30_Then_correct)) (=> (= (ControlFlow 0 33) 32) anon30_Else_correct)))))
(let ((anon28_Else_correct  (=> (and b_2 (= (ControlFlow 0 28) 26)) anon7_correct)))
(let ((anon2_correct  (=> (state Heap@@9 Mask@1) (and (=> (= (ControlFlow 0 34) 33) anon28_Then_correct) (=> (= (ControlFlow 0 34) 28) anon28_Else_correct)))))
(let ((anon27_Else_correct  (=> (not b_2) (=> (and (= Mask@1 ZeroMask) (= (ControlFlow 0 36) 34)) anon2_correct))))
(let ((anon27_Then_correct  (=> (and b_2 (not (= x@@8 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm)))) (state Heap@@9 Mask@0)) (and (= Mask@1 Mask@0) (= (ControlFlow 0 35) 34))) anon2_correct))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (and (=> (= (ControlFlow 0 37) 35) anon27_Then_correct) (=> (= (ControlFlow 0 37) 36) anon27_Else_correct)))))
