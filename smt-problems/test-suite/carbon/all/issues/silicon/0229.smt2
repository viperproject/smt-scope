...
(assert  (and (and (and (and (= (type Heap@@11) (MapType1Type RefType)) (= (type self@@11) RefType)) (= (type Mask@0) (MapType0Type RefType realType))) (= (type Mask@1) (MapType0Type RefType realType))) (= (type Mask@2) (MapType0Type RefType realType))))
(set-info :boogie-vc-id |valid__Foo#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (and (U_2_bool (MapType1Select Heap@@11 self@@11 $allocated)) (not (= self@@11 null))) (and (= Mask@0 (MapType0Store ZeroMask self@@11 Foo__v1 (real_2_U (+ (U_2_real (MapType0Select ZeroMask self@@11 Foo__v1)) FullPerm)))) (state Heap@@11 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 self@@11 Foo__v1)) (=> (HasDirectPerm Mask@0 self@@11 Foo__v1) (=> (not (= (MapType1Select Heap@@11 self@@11 Foo__v1) null)) (=> (and (= Mask@1 (MapType0Store Mask@0 (MapType1Select Heap@@11 self@@11 Foo__v1) Int__v (real_2_U (+ (U_2_real (MapType0Select Mask@0 (MapType1Select Heap@@11 self@@11 Foo__v1) Int__v)) FullPerm)))) (state Heap@@11 Mask@1)) (=> (and (and (not (= self@@11 null)) (= Mask@2 (MapType0Store Mask@1 self@@11 Foo__v2 (real_2_U (+ (U_2_real (MapType0Select Mask@1 self@@11 Foo__v2)) FullPerm))))) (and (state Heap@@11 Mask@2) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@2 self@@11 Foo__v2))))))))))
