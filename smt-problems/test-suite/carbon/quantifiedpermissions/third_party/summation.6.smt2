...
(let ((anon18_Else_correct  (=> (and (not (and (<= 0 j_6) (and (< j_6 (|Seq#Length| ar@@27)) (and (<= 0 k_15) (and (< k_15 (|Seq#Length| ar@@27)) (not (= j_6 k_15))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon18_Then_correct  (=> (and (<= 0 j_6) (and (< j_6 (|Seq#Length| ar@@27)) (and (<= 0 k_15) (and (< k_15 (|Seq#Length| ar@@27)) (not (= j_6 k_15)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= j_6 0)) (=> (>= j_6 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< j_6 (|Seq#Length| ar@@27))) (=> (< j_6 (|Seq#Length| ar@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_15 0)) (=> (>= k_15 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_15 (|Seq#Length| ar@@27))) (=> (< k_15 (|Seq#Length| ar@@27)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
