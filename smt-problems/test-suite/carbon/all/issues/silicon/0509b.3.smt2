...
(let ((anon33_Else_correct  (=> (forall ((i_1 Int) ) (! (= (lookup2 ExhaleHeap@1 r1 i_1) (lookup ExhaleHeap@0 r1 i_1))
 :qid |stdinbpl.1207:20|
 :skolemid |90|
 :pattern ( (|lookup#frame| (FrameFragment (MapType0Select Heap@@15 r1 f_7)) r1 i_1))
