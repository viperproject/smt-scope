...
(declare-fun r2@@4 () T@U)
(assert  (and (and (= (type Heap@@52) (MapType0Type RefType)) (= (type Result@0) RefType)) (= (type r2@@4) RefType)))
(set-info :boogie-vc-id |main#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (= (helper Heap@@52 Result@0) 2))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (= Result@0 (postInhale Heap@@52 r2@@4)) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@52 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@52 r2@@4 $allocated)) (= AssumeFunctionsAbove 4)) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct))))))
