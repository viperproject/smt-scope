...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type g) (MapType0Type RefType boolType)) (= (type n$0) RefType)) (= (type Heap@@13) (MapType1Type RefType))) (= (type QPMask@0) (MapType2Type RefType realType))) (= (type n$2) RefType)) (= (type PostHeap@0) (MapType1Type RefType))) (= (type QPMask@2) (MapType2Type RefType realType))) (= (type y@@7) RefType)) (= (type x_1@@1) RefType)) (= (type QPMask@5) (MapType2Type RefType realType))) (= (type QPMask@6) (MapType2Type RefType realType))) (= (type v1_2) RefType)) (= (type v2_2) RefType)) (= (type QPMask@7) (MapType2Type RefType realType))) (= (type QPMask@8) (MapType2Type RefType realType))) (= (type QPMask@9) (MapType2Type RefType realType))) (= (type QPMask@10) (MapType2Type RefType realType))) (= (type QPMask@3) (MapType2Type RefType realType))) (= (type QPMask@4) (MapType2Type RefType realType))) (forall ((arg0@@55 T@U) ) (! (= (type (invRecv3 arg0@@55)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 75) (let ((anon75_Then_correct  (and (=> (= (ControlFlow 0 59) (- 0 60)) (forall ((n_3 T@U) (n_3_1 T@U) ) (!  (=> (and (= (type n_3) RefType) (= (type n_3_1) RefType)) (=> (and (and (and (and (not (= n_3 n_3_1)) (U_2_bool (MapType0Select g n_3))) (U_2_bool (MapType0Select g n_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3 n_3_1))))
...
)) (=> (= (ControlFlow 0 59) (- 0 58)) (forall ((n_3@@1 T@U) ) (!  (=> (and (= (type n_3@@1) RefType) (U_2_bool (MapType0Select g n_3@@1))) (>= (U_2_real (MapType2Select QPMask@0 n_3@@1 next)) FullPerm))
 :qid |stdinbpl.1199:23|
 :skolemid |143|
 :pattern ( (MapType1Select Heap@@13 n_3@@1 next))
 :pattern ( (MapType2Select QPMask@4 n_3@@1 next))
 :pattern ( (MapType1Select Heap@@13 n_3@@1 next))
)))))))
(let ((anon74_Then_correct  (and (=> (= (ControlFlow 0 56) (- 0 57)) (forall ((n_2 T@U) (n_2_1 T@U) ) (!  (=> (and (= (type n_2) RefType) (= (type n_2_1) RefType)) (=> (and (and (and (and (not (= n_2 n_2_1)) (U_2_bool (MapType0Select g n_2))) (U_2_bool (MapType0Select g n_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_2 n_2_1))))
...
)) (=> (= (ControlFlow 0 56) (- 0 55)) (forall ((n_2@@1 T@U) ) (!  (=> (and (= (type n_2@@1) RefType) (U_2_bool (MapType0Select g n_2@@1))) (>= (U_2_real (MapType2Select QPMask@2 n_2@@1 next)) FullPerm))
 :qid |stdinbpl.1147:23|
 :skolemid |137|
 :pattern ( (MapType1Select PostHeap@0 n_2@@1 next))
 :pattern ( (MapType2Select QPMask@3 n_2@@1 next))
 :pattern ( (MapType1Select PostHeap@0 n_2@@1 next))
)))))))
(let ((anon79_Else_correct true))
(let ((anon79_Then_correct  (and (=> (= (ControlFlow 0 49) (- 0 50)) (forall ((n_5 T@U) (n_5_1 T@U) ) (!  (=> (and (= (type n_5) RefType) (= (type n_5_1) RefType)) (=> (and (and (and (and (not (= n_5 n_5_1)) (U_2_bool (MapType0Select g n_5))) (U_2_bool (MapType0Select g n_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_5 n_5_1))))
 :qid |stdinbpl.1301:25|
 :skolemid |154|
...
)) (=> (= (ControlFlow 0 49) (- 0 48)) (forall ((n_5@@1 T@U) ) (!  (=> (and (= (type n_5@@1) RefType) (U_2_bool (MapType0Select g n_5@@1))) (>= (U_2_real (MapType2Select QPMask@0 n_5@@1 next)) FullPerm))
 :qid |stdinbpl.1308:25|
 :skolemid |155|
 :pattern ( (MapType1Select Heap@@13 n_5@@1 next))
 :pattern ( (MapType2Select QPMask@10 n_5@@1 next))
 :pattern ( (MapType1Select Heap@@13 n_5@@1 next))
)))))))
(let ((anon78_Then_correct  (and (=> (= (ControlFlow 0 46) (- 0 47)) (forall ((n_4 T@U) (n_4_1 T@U) ) (!  (=> (and (= (type n_4) RefType) (= (type n_4_1) RefType)) (=> (and (and (and (and (not (= n_4 n_4_1)) (U_2_bool (MapType0Select g n_4))) (U_2_bool (MapType0Select g n_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4 n_4_1))))
 :qid |stdinbpl.1249:25|
 :skolemid |148|
...
)) (=> (= (ControlFlow 0 46) (- 0 45)) (forall ((n_4@@1 T@U) ) (!  (=> (and (= (type n_4@@1) RefType) (U_2_bool (MapType0Select g n_4@@1))) (>= (U_2_real (MapType2Select QPMask@2 n_4@@1 next)) FullPerm))
 :qid |stdinbpl.1256:25|
 :skolemid |149|
 :pattern ( (MapType1Select PostHeap@0 n_4@@1 next))
 :pattern ( (MapType2Select QPMask@9 n_4@@1 next))
 :pattern ( (MapType1Select PostHeap@0 n_4@@1 next))
)))))))
(let ((anon87_Then_correct  (and (=> (= (ControlFlow 0 37) (- 0 38)) (forall ((n_9 T@U) (n_9_1 T@U) ) (!  (=> (and (= (type n_9) RefType) (= (type n_9_1) RefType)) (=> (and (and (and (and (not (= n_9 n_9_1)) (U_2_bool (MapType0Select g n_9))) (U_2_bool (MapType0Select g n_9_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_9 n_9_1))))
...
)) (=> (= (ControlFlow 0 37) (- 0 36)) (forall ((n_9@@1 T@U) ) (!  (=> (and (= (type n_9@@1) RefType) (U_2_bool (MapType0Select g n_9@@1))) (>= (U_2_real (MapType2Select QPMask@0 n_9@@1 next)) FullPerm))
 :qid |stdinbpl.1522:29|
 :skolemid |180|
 :pattern ( (MapType1Select Heap@@13 n_9@@1 next))
 :pattern ( (MapType2Select QPMask@8 n_9@@1 next))
 :pattern ( (MapType1Select Heap@@13 n_9@@1 next))
)))))))
(let ((anon85_Then_correct  (and (=> (= (ControlFlow 0 33) (- 0 34)) (forall ((n_8 T@U) (n_8_1 T@U) ) (!  (=> (and (= (type n_8) RefType) (= (type n_8_1) RefType)) (=> (and (and (and (and (not (= n_8 n_8_1)) (U_2_bool (MapType0Select g n_8))) (U_2_bool (MapType0Select g n_8_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_8 n_8_1))))
 :qid |stdinbpl.1465:27|
 :skolemid |173|
...
)) (=> (= (ControlFlow 0 33) (- 0 32)) (forall ((n_8@@1 T@U) ) (!  (=> (and (= (type n_8@@1) RefType) (U_2_bool (MapType0Select g n_8@@1))) (>= (U_2_real (MapType2Select QPMask@0 n_8@@1 next)) FullPerm))
 :qid |stdinbpl.1472:27|
 :skolemid |174|
 :pattern ( (MapType1Select Heap@@13 n_8@@1 next))
 :pattern ( (MapType2Select QPMask@7 n_8@@1 next))
 :pattern ( (MapType1Select Heap@@13 n_8@@1 next))
)))))))
(let ((anon45_correct true))
(let ((anon86_Then_correct  (=> (exists_path ($$ Heap@@13 g) v1_2 x_1@@1) (and (=> (= (ControlFlow 0 39) 37) anon87_Then_correct) (=> (= (ControlFlow 0 39) 30) anon45_correct)))))
(let ((anon86_Else_correct  (=> (and (not (exists_path ($$ Heap@@13 g) v1_2 x_1@@1)) (= (ControlFlow 0 35) 30)) anon45_correct)))
(let ((anon84_Then_correct  (=> (not (exists_path ($$ Heap@@13 g) v1_2 v2_2)) (and (and (=> (= (ControlFlow 0 40) 33) anon85_Then_correct) (=> (= (ControlFlow 0 40) 39) anon86_Then_correct)) (=> (= (ControlFlow 0 40) 35) anon86_Else_correct)))))
(let ((anon84_Else_correct  (=> (and (exists_path ($$ Heap@@13 g) v1_2 v2_2) (= (ControlFlow 0 31) 30)) anon45_correct)))
(let ((anon83_Then_correct  (and (=> (= (ControlFlow 0 28) (- 0 29)) (forall ((n_7 T@U) (n_7_1 T@U) ) (!  (=> (and (= (type n_7) RefType) (= (type n_7_1) RefType)) (=> (and (and (and (and (not (= n_7 n_7_1)) (U_2_bool (MapType0Select g n_7))) (U_2_bool (MapType0Select g n_7_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_7 n_7_1))))
 :qid |stdinbpl.1415:25|
 :skolemid |167|
...
)) (=> (= (ControlFlow 0 28) (- 0 27)) (forall ((n_7@@1 T@U) ) (!  (=> (and (= (type n_7@@1) RefType) (U_2_bool (MapType0Select g n_7@@1))) (>= (U_2_real (MapType2Select QPMask@0 n_7@@1 next)) FullPerm))
 :qid |stdinbpl.1422:25|
 :skolemid |168|
 :pattern ( (MapType1Select Heap@@13 n_7@@1 next))
 :pattern ( (MapType2Select QPMask@6 n_7@@1 next))
 :pattern ( (MapType1Select Heap@@13 n_7@@1 next))
)))))))
(let ((anon82_Then_correct  (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((n_6 T@U) (n_6_1 T@U) ) (!  (=> (and (= (type n_6) RefType) (= (type n_6_1) RefType)) (=> (and (and (and (and (not (= n_6 n_6_1)) (U_2_bool (MapType0Select g n_6))) (U_2_bool (MapType0Select g n_6_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_6 n_6_1))))
...
)) (=> (= (ControlFlow 0 25) (- 0 24)) (forall ((n_6@@1 T@U) ) (!  (=> (and (= (type n_6@@1) RefType) (U_2_bool (MapType0Select g n_6@@1))) (>= (U_2_real (MapType2Select QPMask@2 n_6@@1 next)) FullPerm))
 :qid |stdinbpl.1370:25|
 :skolemid |162|
 :pattern ( (MapType1Select PostHeap@0 n_6@@1 next))
 :pattern ( (MapType2Select QPMask@5 n_6@@1 next))
 :pattern ( (MapType1Select PostHeap@0 n_6@@1 next))
)))))))
(let ((anon47_correct true))
(let ((anon81_Else_correct  (=> (and (forall ((v1_3 T@U) (v2_3 T@U) ) (!  (=> (and (= (type v1_3) RefType) (= (type v2_3) RefType)) (= (exists_path ($$ PostHeap@0 g) v1_3 v2_3)  (or (exists_path ($$ Heap@@13 g) v1_3 v2_3) (and (exists_path ($$ Heap@@13 g) v1_3 x_1@@1) (exists_path ($$ Heap@@13 g) y@@7 v2_3)))))
 :qid |stdinbpl.1557:22|
 :skolemid |185|
 :pattern ( (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| PostHeap@0 g))) g) v1_3 v2_3))
)) (= (ControlFlow 0 23) 21)) anon47_correct)))
(let ((anon80_Then_correct  (=> (and (not (= y@@7 null)) (state PostHeap@0 QPMask@2)) (and (and (and (and (=> (= (ControlFlow 0 41) 23) anon81_Else_correct) (=> (= (ControlFlow 0 41) 25) anon82_Then_correct)) (=> (= (ControlFlow 0 41) 28) anon83_Then_correct)) (=> (= (ControlFlow 0 41) 40) anon84_Then_correct)) (=> (= (ControlFlow 0 41) 31) anon84_Else_correct)))))
(let ((anon80_Else_correct  (=> (and (= y@@7 null) (= (ControlFlow 0 22) 21)) anon47_correct)))
...
(let ((anon77_Else_correct  (=> (and (forall ((v1_1 T@U) (v2_1 T@U) ) (!  (=> (and (= (type v1_1) RefType) (= (type v2_1) RefType)) (= (edge ($$ PostHeap@0 g) v1_1 v2_1)  (or (edge ($$ Heap@@13 g) v1_1 v2_1) (and (= v1_1 x_1@@1) (= v2_1 y@@7)))))
...
(let ((anon76_Then_correct  (=> (and (not (= y@@7 null)) (state PostHeap@0 QPMask@2)) (and (and (and (=> (= (ControlFlow 0 52) 44) anon77_Else_correct) (=> (= (ControlFlow 0 52) 46) anon78_Then_correct)) (=> (= (ControlFlow 0 52) 49) anon79_Then_correct)) (=> (= (ControlFlow 0 52) 51) anon79_Else_correct)))))
(let ((anon76_Else_correct  (=> (and (= y@@7 null) (= (ControlFlow 0 43) 42)) anon33_correct)))
...
(let ((anon75_Else_correct  (=> (and (|Set#Equal| ($$ PostHeap@0 g) ($$ Heap@@13 g)) (= (ControlFlow 0 61) 53)) anon25_correct)))
(let ((anon73_Then_correct  (=> (and (= y@@7 null) (state PostHeap@0 QPMask@2)) (and (and (=> (= (ControlFlow 0 62) 56) anon74_Then_correct) (=> (= (ControlFlow 0 62) 59) anon75_Then_correct)) (=> (= (ControlFlow 0 62) 61) anon75_Else_correct)))))
(let ((anon73_Else_correct  (=> (and (not (= y@@7 null)) (= (ControlFlow 0 54) 53)) anon25_correct)))
(let ((anon70_Else_correct  (=> (and (forall ((n$2_1 T@U) ) (!  (=> (= (type n$2_1) RefType) (=> (and (U_2_bool (MapType0Select g n$2_1)) (not (= (MapType1Select PostHeap@0 n$2_1 next) null))) (U_2_bool (MapType0Select g (MapType1Select PostHeap@0 n$2_1 next)))))
...
)) (state PostHeap@0 QPMask@2)) (and (=> (= (ControlFlow 0 63) (- 0 64)) (HasDirectPerm QPMask@2 x_1@@1 next)) (=> (HasDirectPerm QPMask@2 x_1@@1 next) (=> (and (= (MapType1Select PostHeap@0 x_1@@1 next) y@@7) (state PostHeap@0 QPMask@2)) (and (=> (= (ControlFlow 0 63) 62) anon73_Then_correct) (=> (= (ControlFlow 0 63) 54) anon73_Else_correct))))))))
(let ((anon18_correct true))
(let ((anon72_Else_correct  (=> (and (not (and (U_2_bool (MapType0Select g n$2)) (not (= (MapType1Select PostHeap@0 n$2 next) null)))) (= (ControlFlow 0 17) 14)) anon18_correct)))
(let ((anon72_Then_correct  (=> (and (U_2_bool (MapType0Select g n$2)) (not (= (MapType1Select PostHeap@0 n$2 next) null))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm QPMask@2 n$2 next)) (=> (HasDirectPerm QPMask@2 n$2 next) (=> (= (ControlFlow 0 15) 14) anon18_correct))))))
(let ((anon71_Else_correct  (=> (not (U_2_bool (MapType0Select g n$2))) (and (=> (= (ControlFlow 0 20) 15) anon72_Then_correct) (=> (= (ControlFlow 0 20) 17) anon72_Else_correct)))))
(let ((anon71_Then_correct  (=> (U_2_bool (MapType0Select g n$2)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm QPMask@2 n$2 next)) (=> (HasDirectPerm QPMask@2 n$2 next) (and (=> (= (ControlFlow 0 18) 15) anon72_Then_correct) (=> (= (ControlFlow 0 18) 17) anon72_Else_correct)))))))
(let ((anon69_Else_correct  (and (=> (= (ControlFlow 0 65) (- 0 66)) (forall ((n$1_1 T@U) (n$1_1_1 T@U) ) (!  (=> (and (= (type n$1_1) RefType) (= (type n$1_1_1) RefType)) (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (U_2_bool (MapType0Select g n$1_1))) (U_2_bool (MapType0Select g n$1_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1))))
...
)) (=> (and (forall ((n$1_1@@1 T@U) ) (!  (=> (= (type n$1_1@@1) RefType) (=> (and (U_2_bool (MapType0Select g n$1_1@@1)) (< NoPerm FullPerm)) (and (qpRange3 n$1_1@@1) (= (invRecv3 n$1_1@@1) n$1_1@@1))))
 :qid |stdinbpl.1075:22|
 :skolemid |130|
 :pattern ( (MapType1Select PostHeap@0 n$1_1@@1 next))
 :pattern ( (MapType2Select QPMask@2 n$1_1@@1 next))
 :pattern ( (MapType1Select PostHeap@0 n$1_1@@1 next))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType0Select g (invRecv3 o_3))) (< NoPerm FullPerm)) (qpRange3 o_3)) (= (invRecv3 o_3) o_3)))
 ...
 :pattern ( (MapType2Select QPMask@2 n$1_1@@2 next))
 :pattern ( (MapType1Select PostHeap@0 n$1_1@@2 next))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType0Select g (invRecv3 o_3@@0))) (< NoPerm FullPerm)) (qpRange3 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_3@@0) o_3@@0)) (= (U_2_real (MapType2Select QPMask@2 o_3@@0 next)) (+ (U_2_real (MapType2Select ZeroMask o_3@@0 next)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select g (invRecv3 o_3@@0))) (< NoPerm FullPerm)) (qpRange3 o_3@@0))) (= (U_2_real (MapType2Select QPMask@2 o_3@@0 next)) (U_2_real (MapType2Select ZeroMask o_3@@0 next))))))
 :qid |stdinbpl.1091:22|
 :skolemid |133|
 :pattern ( (MapType2Select QPMask@2 o_3@@0 next))
))) (and (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 next))) (= (U_2_real (MapType2Select ZeroMask o_3@@1 f_5)) (U_2_real (MapType2Select QPMask@2 o_3@@1 f_5))))))
...
(let ((anon68_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (not (U_2_bool (MapType0Select g null)))) (and (=> (= (ControlFlow 0 67) 13) anon69_Then_correct) (=> (= (ControlFlow 0 67) 65) anon69_Else_correct)))))
(let ((anon68_Else_correct true))
(let ((anon65_Else_correct  (=> (and (forall ((n$0_1 T@U) ) (!  (=> (= (type n$0_1) RefType) (=> (and (U_2_bool (MapType0Select g n$0_1)) (not (= (MapType1Select Heap@@13 n$0_1 next) null))) (U_2_bool (MapType0Select g (MapType1Select Heap@@13 n$0_1 next)))))
...
)) (state Heap@@13 QPMask@0)) (and (=> (= (ControlFlow 0 68) 67) anon68_Then_correct) (=> (= (ControlFlow 0 68) 10) anon68_Else_correct)))))
(let ((anon9_correct true))
(let ((anon67_Else_correct  (=> (and (not (and (U_2_bool (MapType0Select g n$0)) (not (= (MapType1Select Heap@@13 n$0 next) null)))) (= (ControlFlow 0 5) 2)) anon9_correct)))
(let ((anon67_Then_correct  (=> (and (U_2_bool (MapType0Select g n$0)) (not (= (MapType1Select Heap@@13 n$0 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 n$0 next)) (=> (HasDirectPerm QPMask@0 n$0 next) (=> (= (ControlFlow 0 3) 2) anon9_correct))))))
(let ((anon66_Else_correct  (=> (not (U_2_bool (MapType0Select g n$0))) (and (=> (= (ControlFlow 0 8) 3) anon67_Then_correct) (=> (= (ControlFlow 0 8) 5) anon67_Else_correct)))))
(let ((anon66_Then_correct  (=> (U_2_bool (MapType0Select g n$0)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm QPMask@0 n$0 next)) (=> (HasDirectPerm QPMask@0 n$0 next) (and (=> (= (ControlFlow 0 6) 3) anon67_Then_correct) (=> (= (ControlFlow 0 6) 5) anon67_Else_correct)))))))
(let ((anon64_Else_correct  (and (=> (= (ControlFlow 0 69) (- 0 70)) (forall ((n_1 T@U) (n_1_1 T@U) ) (!  (=> (and (= (type n_1) RefType) (= (type n_1_1) RefType)) (=> (and (and (and (and (not (= n_1 n_1_1)) (U_2_bool (MapType0Select g n_1))) (U_2_bool (MapType0Select g n_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1))))
...
)) (=> (and (forall ((n_1@@1 T@U) ) (!  (=> (= (type n_1@@1) RefType) (=> (and (U_2_bool (MapType0Select g n_1@@1)) (< NoPerm FullPerm)) (and (qpRange2 n_1@@1) (= (invRecv2 n_1@@1) n_1@@1))))
 :qid |stdinbpl.1006:22|
 :skolemid |123|
 :pattern ( (MapType1Select Heap@@13 n_1@@1 next))
 :pattern ( (MapType2Select QPMask@0 n_1@@1 next))
 :pattern ( (MapType1Select Heap@@13 n_1@@1 next))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType0Select g (invRecv2 o_3@@2))) (< NoPerm FullPerm)) (qpRange2 o_3@@2)) (= (invRecv2 o_3@@2) o_3@@2)))
 ...
 :pattern ( (MapType1Select Heap@@13 n_1@@2 next))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType0Select g (invRecv2 o_3@@3))) (< NoPerm FullPerm)) (qpRange2 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@3) o_3@@3)) (= (U_2_real (MapType2Select QPMask@0 o_3@@3 next)) (+ (U_2_real (MapType2Select ZeroMask o_3@@3 next)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select g (invRecv2 o_3@@3))) (< NoPerm FullPerm)) (qpRange2 o_3@@3))) (= (U_2_real (MapType2Select QPMask@0 o_3@@3 next)) (U_2_real (MapType2Select ZeroMask o_3@@3 next))))))
 :qid |stdinbpl.1022:22|
 :skolemid |126|
 :pattern ( (MapType2Select QPMask@0 o_3@@3 next))
))) (and (forall ((o_3@@4 T@U) (f_5@@0 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_5@@0))))
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 next))) (= (U_2_real (MapType2Select ZeroMask o_3@@4 f_5@@0)) (U_2_real (MapType2Select QPMask@0 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.1026:29|
 :skolemid |127|
 :pattern ( (MapType2Select ZeroMask o_3@@4 f_5@@0))
 :pattern ( (MapType2Select QPMask@0 o_3@@4 f_5@@0))
)) (state Heap@@13 QPMask@0))) (and (and (=> (= (ControlFlow 0 69) 68) anon65_Else_correct) (=> (= (ControlFlow 0 69) 6) anon66_Then_correct)) (=> (= (ControlFlow 0 69) 8) anon66_Else_correct))))))))
(let ((anon64_Then_correct true))
(let ((anon2_correct  (=> (and (state Heap@@13 ZeroMask) (not (U_2_bool (MapType0Select g null)))) (and (=> (= (ControlFlow 0 71) 1) anon64_Then_correct) (=> (= (ControlFlow 0 71) 69) anon64_Else_correct)))))
(let ((anon63_Else_correct  (=> (and (= y@@7 null) (= (ControlFlow 0 73) 71)) anon2_correct)))
(let ((anon63_Then_correct  (=> (not (= y@@7 null)) (=> (and (U_2_bool (MapType0Select g y@@7)) (= (ControlFlow 0 72) 71)) anon2_correct))))
(let ((anon0_correct  (=> (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType1Select Heap@@13 x_1@@1 $allocated)) (U_2_bool (MapType1Select Heap@@13 y@@7 $allocated))) (and (U_2_bool (MapType0Select g x_1@@1)) (state Heap@@13 ZeroMask))) (and (=> (= (ControlFlow 0 74) 72) anon63_Then_correct) (=> (= (ControlFlow 0 74) 73) anon63_Else_correct))))))
