...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (not (= 1 0))) (=> (not (= 1 0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (not (= 1 0))) (=> (not (= 1 0)) (=> (= (ControlFlow 0 3) (- 0 2)) (not (= (div 1 1) 2)))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@75 ZeroMask) (= AssumeFunctionsAbove 2)) (and (=> (= (ControlFlow 0 6) 1) anon3_Then_correct) (=> (= (ControlFlow 0 6) 3) anon3_Else_correct)))))
