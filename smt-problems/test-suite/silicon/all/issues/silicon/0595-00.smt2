(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 19:57:39
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/issues/silicon/0595.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (forall ((s@11@01 $Snap)) (!
  (and
    (= s@11@01 $Snap.unit)
    (=
      ($PSF.lookup_P (as sm@10@01  $PSF<P>) s@11@01)
      ($PSF.lookup_P (as sm@1@01  $PSF<P>) s@11@01)))
  :pattern (($PSF.lookup_P (as sm@10@01  $PSF<P>) s@11@01))
  :pattern (($PSF.lookup_P (as sm@1@01  $PSF<P>) s@11@01))
  :qid |qp.psmValDef0|)))
(pop) ; 2
(pop) ; 1
; ---------- test2 ----------
...
(assert (not (forall ((i1@14@01 Int) (i2@14@01 Int)) (!
  (=> (and (= i1@14@01 0) (= i2@14@01 0)) (= i1@14@01 i2@14@01))
...
(assert (forall ((i@14@01 Int)) (!
  (=> (= i@14@01 0) (and (= (inv@16@01 x@13@01) i@14@01) (img@17@01 x@13@01)))
  
  :qid |quant-u-8|)))
(assert (forall ((r $Ref)) (!
  (=> (and (img@17@01 r) (= (inv@16@01 r) 0)) (= x@13@01 r))
  :pattern ((inv@16@01 r))
  :qid |f-fctOfInv|)))
; Permissions are non-negative
...
(assert (forall ((i@14@01 Int)) (!
  (=> (= i@14@01 0) (not (= x@13@01 $Ref.null)))
...
(assert (= i@20@01 0))
(pop) ; 3
(declare-const $t@21@01 $PSF<wand@0>)
(declare-fun inv@22@01 (Bool Bool) Int)
(declare-fun img@23@01 (Bool Bool) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((i1@20@01 Int) (i2@20@01 Int)) (!
  (=> (and (= i1@20@01 0) (= i2@20@01 0)) (= i1@20@01 i2@20@01))
...
(assert (forall ((i@20@01 Int)) (!
  (=>
    (= i@20@01 0)
    (and (= (inv@22@01 true true) i@20@01) (img@23@01 true true)))
  
  :qid |quant-u-10|)))
(assert (forall ((x0 Bool) (x1 Bool)) (!
  (=>
    (and (img@23@01 x0 x1) (= (inv@22@01 x0 x1) 0))
    (and (= true x0) (= true x1)))
  :pattern ((inv@22@01 x0 x1))
  :qid |wand@0-fctOfInv|)))
