...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@3) (MapType0Type RefType)) (= (type ys) (MapType2Type RefType boolType))) (= (type z@@0) RefType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type y@@7) RefType)) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (forall ((arg0@@57 T@U) ) (! (= (type (FrameFragment arg0@@57)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@57))
))) (= (type xs) (MapType2Type RefType boolType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@58 T@U) ) (! (= (type (invRecv8 arg0@@58)) RefType)
 :qid |funType:invRecv8|
 :pattern ( (invRecv8 arg0@@58))
))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@59 T@U) ) (! (= (type (invRecv7 arg0@@59)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon15_Else_correct  (=> (and (and (forall ((x_7 T@U) ) (!  (=> (and (= (type x_7) RefType) (U_2_bool (MapType2Select ys x_7))) (not (= x_7 z@@0)))
 :qid |stdinbpl.1834:20|
 :skolemid |182|
 :pattern ( (MapType0Select Heap@3 null (p1 x_7)))
)) (state Heap@3 Mask@2)) (and (state Heap@3 Mask@2) (= (ControlFlow 0 5) (- 0 4)))) (not (= y@@7 z@@0)))))
(let ((anon15_Then_correct true))
(let ((anon8_correct  (=> (= Heap@3 (MapType0Store Heap@2 null (|p1#sm| y@@7) (MapType1Store (MapType0Select Heap@2 null (|p1#sm| y@@7)) y@@7 f_7 (bool_2_U true)))) (=> (and (state Heap@3 Mask@2) (state Heap@3 Mask@2)) (and (=> (= (ControlFlow 0 6) 3) anon15_Then_correct) (=> (= (ControlFlow 0 6) 5) anon15_Else_correct))))))
(let ((anon14_Else_correct  (=> (HasDirectPerm Mask@2 null (p1 y@@7)) (=> (and (= Heap@2 Heap@@10) (= (ControlFlow 0 8) 6)) anon8_correct))))
(let ((anon14_Then_correct  (=> (not (HasDirectPerm Mask@2 null (p1 y@@7))) (=> (and (and (= Heap@0 (MapType0Store Heap@@10 null (|p1#sm| y@@7) ZeroPMask)) (= Heap@1 (MapType0Store Heap@0 null (p1 y@@7) freshVersion@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 7) 6))) anon8_correct))))
(let ((anon6_correct  (=> (= Mask@1 (MapType1Store Mask@0 y@@7 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 y@@7 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (= (U_2_int (MapType0Select Heap@@10 y@@7 f_7)) 0)) (=> (= (U_2_int (MapType0Select Heap@@10 y@@7 f_7)) 0) (=> (= Mask@2 (MapType1Store Mask@1 null (p1 y@@7) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (p1 y@@7))) FullPerm)))) (=> (and (and (state Heap@@10 Mask@2) (state Heap@@10 Mask@2)) (and (|p1#trigger| Heap@@10 (p1 y@@7)) (= (MapType0Select Heap@@10 null (p1 y@@7)) (FrameFragment (MapType0Select Heap@@10 y@@7 f_7))))) (and (=> (= (ControlFlow 0 9) 7) anon14_Then_correct) (=> (= (ControlFlow 0 9) 8) anon14_Else_correct)))))))))
(let ((anon13_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 9)) anon6_correct)))
(let ((anon13_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType1Select Mask@0 y@@7 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 y@@7 f_7))) (=> (= (ControlFlow 0 11) 9) anon6_correct))))))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 16)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (U_2_bool (MapType2Select xs x_3))) (U_2_bool (MapType2Select xs x_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1))))
 :qid |stdinbpl.1740:17|
 :skolemid |176|
...
)) (=> (forall ((x_3@@1 T@U) ) (!  (=> (= (type x_3@@1) RefType) (=> (and (U_2_bool (MapType2Select xs x_3@@1)) (< NoPerm FullPerm)) (and (= (invRecv8 x_3@@1) x_3@@1) (qpRange8 x_3@@1))))
 :qid |stdinbpl.1746:22|
 :skolemid |177|
 :pattern ( (MapType0Select Heap@@10 null (p1 x_3@@1)))
 :pattern ( (MapType1Select QPMask@0 null (p1 x_3@@1)))
 :pattern ( (MapType0Select Heap@@10 null (p1 x_3@@1)))
)) (=> (and (forall ((x_4_1 T@U) ) (!  (=> (= (type x_4_1) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv8 x_4_1))) (< NoPerm FullPerm)) (qpRange8 x_4_1)) (= (invRecv8 x_4_1) x_4_1)))
 :qid |stdinbpl.1750:22|
 :skolemid |178|
 :pattern ( (invRecv8 x_4_1))
)) (forall ((x_4_1@@0 T@U) ) (!  (=> (= (type x_4_1@@0) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv8 x_4_1@@0))) (< NoPerm FullPerm)) (qpRange8 x_4_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv8 x_4_1@@0) x_4_1@@0)) (= (U_2_real (MapType1Select QPMask@1 null (p1 x_4_1@@0))) (+ (U_2_real (MapType1Select QPMask@0 null (p1 x_4_1@@0))) FullPerm)))))
 :qid |stdinbpl.1756:22|
 :skolemid |179|
 :pattern ( (MapType1Select QPMask@1 null (p1 x_4_1@@0)))
))) (=> (and (and (and (and (forall ((o_3 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
...
)) (=> (and (and (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (= x_1@@1 z@@0) (< NoPerm FullPerm)) (and (qpRange7 x_1@@1) (= (invRecv7 x_1@@1) x_1@@1))))
 :qid |stdinbpl.1701:22|
 :skolemid |171|
 :pattern ( (MapType0Select Heap@@10 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (=> (and (and (= (invRecv7 o_3@@0) z@@0) (< NoPerm FullPerm)) (qpRange7 o_3@@0)) (= (invRecv7 o_3@@0) o_3@@0)))
...
)) (forall ((o_3@@1 T@U) ) (!  (=> (= (type o_3@@1) RefType) (and (=> (and (and (= (invRecv7 o_3@@1) z@@0) (< NoPerm FullPerm)) (qpRange7 o_3@@1)) (and (=> (< NoPerm FullPerm) (= (invRecv7 o_3@@1) o_3@@1)) (= (U_2_real (MapType1Select QPMask@0 o_3@@1 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@1 f_7)) FullPerm)))) (=> (not (and (and (= (invRecv7 o_3@@1) z@@0) (< NoPerm FullPerm)) (qpRange7 o_3@@1))) (= (U_2_real (MapType1Select QPMask@0 o_3@@1 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@1 f_7))))))
...
)) (state Heap@@10 QPMask@0)) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0)))) (and (=> (= (ControlFlow 0 17) 2) anon12_Then_correct) (=> (= (ControlFlow 0 17) 14) anon12_Else_correct)))))))
