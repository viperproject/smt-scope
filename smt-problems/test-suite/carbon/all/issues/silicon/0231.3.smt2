...
(assert  (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type Heap@@10) (MapType0Type RefType))) (= (type r_4) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type this) RefType)))
(set-info :boogie-vc-id test02b)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon5_correct true))
(let ((anon9_Else_correct  (=> (and (not (HasDirectPerm Mask@1 null (P r_4))) (= (ControlFlow 0 6) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (HasDirectPerm Mask@1 null (P r_4)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@0 null (P r_4))) (=> (HasDirectPerm Mask@0 null (P r_4)) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
(let ((anon8_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((r_1_1 T@U) ) (!  (=> (and (= (type r_1_1) RefType) (HasDirectPerm Mask@1 null (P r_1_1))) false)
 :qid |stdinbpl.397:15|
 :skolemid |30|
 :pattern ( (MapType1Select Mask@1 null (P r_1_1)))
 :pattern ( (MapType0Select Heap@@10 null (P r_1_1)))
)))))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (P this) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P this))) FullPerm)))) (and (and (=> (= (ControlFlow 0 7) 2) anon8_Else_correct) (=> (= (ControlFlow 0 7) 4) anon9_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 7)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P this))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P this)))) (=> (= (ControlFlow 0 8) 7) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@10 this $allocated)) (= Mask@0 (MapType1Store ZeroMask null (P this) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P this))) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 11) 8) anon7_Then_correct) (=> (= (ControlFlow 0 11) 10) anon7_Else_correct))))))
