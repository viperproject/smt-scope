...
(assert  (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type arr) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test04)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 arr $allocated)) (= Mask@0 (MapType1Store ZeroMask arr val (real_2_U (+ (U_2_real (MapType1Select ZeroMask arr val)) NoPerm))))) (=> (and (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (not (= arr null)))))))
