...
(declare-fun DDomainTypeType () T@T)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |f#triggerStateless| (T@U) Int)
(declare-fun |g'| (T@U T@U) Int)
(declare-fun |g#triggerStateless| (T@U) Int)
...
(declare-fun |g#frame| (T@U T@U) Int)
...
(assert (= (Ctor DDomainTypeType) 11))
(assert (forall ((Heap@@2 T@U) (x@@8 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type x@@8) DDomainTypeType)) (dummyFunction (int_2_U (|f#triggerStateless| x@@8))))
 :qid |stdinbpl.197:15|
 :skolemid |23|
 :pattern ( (|f'| Heap@@2 x@@8))
)))
(assert (forall ((Heap@@3 T@U) (y@@1 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type y@@1) DDomainTypeType)) (dummyFunction (int_2_U (|g#triggerStateless| y@@1))))
 :qid |stdinbpl.254:15|
 :skolemid |27|
...
(assert (forall ((Heap@@5 T@U) (x@@9 T@U) ) (!  (=> (and (= (type Heap@@5) (MapType0Type RefType)) (= (type x@@9) DDomainTypeType)) (and (= (f_6 Heap@@5 x@@9) (|f'| Heap@@5 x@@9)) (dummyFunction (int_2_U (|f#triggerStateless| x@@9)))))
 :qid |stdinbpl.193:15|
 :skolemid |22|
 :pattern ( (f_6 Heap@@5 x@@9))
)))
(assert (forall ((Heap@@6 T@U) (y@@2 T@U) ) (!  (=> (and (= (type Heap@@6) (MapType0Type RefType)) (= (type y@@2) DDomainTypeType)) (and (= (g Heap@@6 y@@2) (|g'| Heap@@6 y@@2)) (dummyFunction (int_2_U (|g#triggerStateless| y@@2)))))
 :qid |stdinbpl.250:15|
 :skolemid |26|
 :pattern ( (g Heap@@6 y@@2))
)))
...
(assert (forall ((Heap@@11 T@U) (Mask@@9 T@U) (x@@10 T@U) ) (!  (=> (and (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (= (type x@@10) DDomainTypeType)) (state Heap@@11 Mask@@9)) (= (|f'| Heap@@11 x@@10) (|f#frame| EmptyFrame x@@10)))
 :qid |stdinbpl.210:15|
 :skolemid |25|
 :pattern ( (state Heap@@11 Mask@@9) (|f'| Heap@@11 x@@10))
)))
(assert (forall ((Heap@@12 T@U) (Mask@@10 T@U) (y@@3 T@U) ) (!  (=> (and (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type y@@3) DDomainTypeType)) (state Heap@@12 Mask@@10)) (= (|g'| Heap@@12 y@@3) (|g#frame| EmptyFrame y@@3)))
 :qid |stdinbpl.267:15|
 :skolemid |29|
 :pattern ( (state Heap@@12 Mask@@10) (|g'| Heap@@12 y@@3))
)))
...
(assert (forall ((Heap@@15 T@U) (Mask@@11 T@U) (y@@4 T@U) ) (!  (=> (and (and (and (= (type Heap@@15) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (= (type y@@4) DDomainTypeType)) (and (state Heap@@15 Mask@@11) (< AssumeFunctionsAbove 1))) (= (g Heap@@15 y@@4) 5))
 :qid |stdinbpl.260:15|
 :skolemid |28|
 :pattern ( (state Heap@@15 Mask@@11) (g Heap@@15 y@@4))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@16 T@U) (Mask@@12 T@U) (x@@11 T@U) ) (!  (=> (and (and (and (= (type Heap@@16) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (= (type x@@11) DDomainTypeType)) (and (state Heap@@16 Mask@@12) (< AssumeFunctionsAbove 0))) (= (f_6 Heap@@16 x@@11) (g Heap@@16 x@@11)))
 :qid |stdinbpl.203:15|
 :skolemid |24|
 :pattern ( (state Heap@@16 Mask@@12) (f_6 Heap@@16 x@@11))
)))
(push 1)
