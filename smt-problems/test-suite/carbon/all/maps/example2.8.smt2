...
(declare-fun i () Int)
(assert  (and (and (= (type m1) (MapType intType boolType)) (= (type m2) (MapType intType boolType))) (= (type Heap@@9) (MapType1Type RefType))))
(set-info :boogie-vc-id test3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon14_correct true))
(let ((anon24_Else_correct  (=> (and (not (and (<= 0 i_3) (< i_3 100))) (= (ControlFlow 0 21) 18)) anon14_correct)))
(let ((anon24_Then_correct  (=> (and (<= 0 i_3) (< i_3 100)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (or (U_2_bool (MapType0Select (|Map#Elements| m1) (int_2_U i_3))) (U_2_bool (MapType0Select (|Map#Elements| m2) (int_2_U i_3))))) (=> (or (U_2_bool (MapType0Select (|Map#Elements| m1) (int_2_U i_3))) (U_2_bool (MapType0Select (|Map#Elements| m2) (int_2_U i_3)))) (=> (= (ControlFlow 0 19) 18) anon14_correct))))))
(let ((anon10_correct true))
(let ((anon22_Else_correct  (=> (and (U_2_bool (MapType0Select (|Map#Elements| m1) (int_2_U i_2))) (= (ControlFlow 0 15) 11)) anon10_correct)))
(let ((anon22_Then_correct  (=> (not (U_2_bool (MapType0Select (|Map#Elements| m1) (int_2_U i_2)))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (U_2_bool (MapType0Select (|Map#Domain| m2) (int_2_U i_2)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m2) (int_2_U i_2))) (=> (= (ControlFlow 0 13) 11) anon10_correct))))))
(let ((anon21_Then_correct  (=> (and (<= 0 i_2) (< i_2 100)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (U_2_bool (MapType0Select (|Map#Domain| m1) (int_2_U i_2)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m1) (int_2_U i_2))) (and (=> (= (ControlFlow 0 16) 13) anon22_Then_correct) (=> (= (ControlFlow 0 16) 15) anon22_Else_correct)))))))
(let ((anon21_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 100))) (= (ControlFlow 0 12) 11)) anon10_correct)))
(let ((anon23_Else_correct true))
(let ((anon16_Else_correct  (=> (and (forall ((i_1 T@U) ) (!  (=> (= (type i_1) intType) (=> (and (<= 0 (U_2_int i_1)) (< (U_2_int i_1) 100)) (and (U_2_bool (MapType0Select (|Map#Domain| m1) i_1)) (and (U_2_bool (MapType0Select (|Map#Domain| m2) i_1)) (= (U_2_bool (MapType0Select (|Map#Elements| m1) i_1))  (not (U_2_bool (MapType0Select (|Map#Elements| m2) i_1))))))))
 :qid |stdinbpl.624:20|
 :skolemid |103|
 :pattern ( (MapType0Select (|Map#Domain| m1) i_1))
 :pattern ( (MapType0Select (|Map#Domain| m2) i_1))
 :pattern ( (MapType0Select (|Map#Elements| m1) i_1))
 :pattern ( (MapType0Select (|Map#Elements| m2) i_1))
)) (state Heap@@9 ZeroMask)) (and (and (and (and (=> (= (ControlFlow 0 22) 10) anon23_Else_correct) (=> (= (ControlFlow 0 22) 19) anon24_Then_correct)) (=> (= (ControlFlow 0 22) 21) anon24_Else_correct)) (=> (= (ControlFlow 0 22) 16) anon21_Then_correct)) (=> (= (ControlFlow 0 22) 12) anon21_Else_correct)))))
(let ((anon5_correct true))
(let ((anon19_Else_correct  (=> (and (not (U_2_bool (MapType0Select (|Map#Domain| m2) (int_2_U i)))) (= (ControlFlow 0 7) 1)) anon5_correct)))
(let ((anon19_Then_correct  (=> (U_2_bool (MapType0Select (|Map#Domain| m2) (int_2_U i))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (U_2_bool (MapType0Select (|Map#Domain| m1) (int_2_U i)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m1) (int_2_U i))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (U_2_bool (MapType0Select (|Map#Domain| m2) (int_2_U i)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m2) (int_2_U i))) (=> (= (ControlFlow 0 4) 1) anon5_correct))))))))
(let ((anon18_Then_correct  (=> (U_2_bool (MapType0Select (|Map#Domain| m1) (int_2_U i))) (and (=> (= (ControlFlow 0 8) 4) anon19_Then_correct) (=> (= (ControlFlow 0 8) 7) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (and (not (U_2_bool (MapType0Select (|Map#Domain| m1) (int_2_U i)))) (= (ControlFlow 0 3) 1)) anon5_correct)))
(let ((anon17_Then_correct  (=> (and (<= 0 i) (< i 100)) (and (=> (= (ControlFlow 0 9) 8) anon18_Then_correct) (=> (= (ControlFlow 0 9) 3) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (not (and (<= 0 i) (< i 100))) (= (ControlFlow 0 2) 1)) anon5_correct)))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (and (=> (= (ControlFlow 0 23) 22) anon16_Else_correct) (=> (= (ControlFlow 0 23) 9) anon17_Then_correct)) (=> (= (ControlFlow 0 23) 2) anon17_Else_correct)))))
