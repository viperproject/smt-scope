...
(declare-fun B@0 () T@U)
(assert  (and (= (type Heap@@9) (MapType0Type RefType)) (= (type B@0) (MultiSetType intType))))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= B@0 (|MultiSet#UnionOne| (|MultiSet#UnionOne| (|MultiSet#UnionOne| (|MultiSet#UnionOne| (|MultiSet#Singleton| (int_2_U 1)) (int_2_U 3)) (int_2_U 3)) (int_2_U 2)) (int_2_U 1))) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (|MultiSet#Card| B@0) 5)) (=> (= (|MultiSet#Card| B@0) 5) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (|MultiSet#Card| (|MultiSet#Empty| intType)) 0))))))))
