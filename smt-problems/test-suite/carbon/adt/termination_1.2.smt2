...
(set-info :boogie-vc-id |dlen#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_correct  (=> (and (= Result@0 (ite (= (DList_tag l@@44) 1) 0 (+ 1 (dlen Heap@@58 (get_DList_dtail l@@44))))) (= (ControlFlow 0 3) (- 0 2))) (>= Result@0 0))))
(let ((anon7_Else_correct  (=> (and (|dlen#trigger| EmptyFrame (get_DList_dtail l@@44)) (= (ControlFlow 0 5) 3)) anon5_correct)))
...
(let ((anon0_correct  (=> (and (state Heap@@58 ZeroMask) (= AssumeFunctionsAbove 4)) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))
...
(assert  (and (= (type Heap@@58) (MapType0Type RefType)) (= (type p_1@@3) (PairDomainTypeType intType ValDomainTypeType))))
(set-info :boogie-vc-id stupidFunc_termination_proof)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@58 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (decreasing p_1@@3 p_1@@3)) (=> (decreasing p_1@@3 p_1@@3) (=> (= (ControlFlow 0 2) (- 0 1)) (bounded p_1@@3)))))))
