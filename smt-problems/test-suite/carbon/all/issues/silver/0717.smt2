...
(assert  (and (= (Ctor PredicateType_pType) 11) (= (type p_1) (FieldType PredicateType_pType FrameTypeType))))
(assert (IsPredicateField p_1))
(assert (= (getPredWandId p_1) 0))
...
(assert (forall ((Heap@@7 T@U) ) (!  (=> (= (type Heap@@7) (MapType0Type RefType)) (|p#everUsed| p_1))
 :qid |stdinbpl.188:15|
 :skolemid |22|
 :pattern ( (|p#trigger| Heap@@7 p_1))
)))
...
(assert (= (PredicateMaskField p_1) |p#sm|))
