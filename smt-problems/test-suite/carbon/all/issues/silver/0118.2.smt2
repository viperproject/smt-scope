...
(declare-fun |zip#triggerStateless| (T@U T@U) T@U)
...
(declare-fun |zip#frame| (T@U T@U T@U) T@U)
...
(assert  (and (forall ((arg0@@26 T@U) (arg1@@10 T@U) (arg2@@3 T@U) ) (! (= (type (|zip'| arg0@@26 arg1@@10 arg2@@3)) (SeqType RefType))
 :qid |funType:zip'|
 :pattern ( (|zip'| arg0@@26 arg1@@10 arg2@@3))
)) (forall ((arg0@@27 T@U) (arg1@@11 T@U) ) (! (= (type (|zip#triggerStateless| arg0@@27 arg1@@11)) (SeqType RefType))
 :qid |funType:zip#triggerStateless|
 :pattern ( (|zip#triggerStateless| arg0@@27 arg1@@11))
))))
(assert (forall ((Heap@@0 T@U) (xs T@U) (ys T@U) ) (!  (=> (and (and (= (type Heap@@0) (MapType0Type RefType)) (= (type xs) (SeqType RefType))) (= (type ys) (SeqType RefType))) (dummyFunction (|zip#triggerStateless| xs ys)))
 :qid |stdinbpl.551:15|
 :skolemid |59|
...
(assert  (and (and (= (Ctor FrameTypeType) 11) (= (type null) RefType)) (forall ((arg0@@29 T@U) ) (! (let ((A (FieldTypeInv0 (type arg0@@29))))
...
(assert  (and (forall ((arg0@@31 T@U) (arg1@@13 T@U) (arg2@@4 T@U) ) (! (= (type (|zip#frame| arg0@@31 arg1@@13 arg2@@4)) (SeqType RefType))
 :qid |funType:zip#frame|
 :pattern ( (|zip#frame| arg0@@31 arg1@@13 arg2@@4))
)) (= (type EmptyFrame) FrameTypeType)))
(assert (forall ((Heap@@3 T@U) (Mask@@2 T@U) (xs@@0 T@U) (ys@@0 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@3) (MapType0Type RefType)) (= (type Mask@@2) (MapType1Type RefType realType))) (= (type xs@@0) (SeqType RefType))) (= (type ys@@0) (SeqType RefType))) (state Heap@@3 Mask@@2)) (= (|zip'| Heap@@3 xs@@0 ys@@0) (|zip#frame| EmptyFrame xs@@0 ys@@0)))
 :qid |stdinbpl.564:15|
 :skolemid |61|
 :pattern ( (state Heap@@3 Mask@@2) (|zip'| Heap@@3 xs@@0 ys@@0))
)))
...
(assert (forall ((arg0@@38 T@U) (arg1@@19 T@U) (arg2@@6 T@U) ) (! (= (type (zip arg0@@38 arg1@@19 arg2@@6)) (SeqType RefType))
 :qid |funType:zip|
 :pattern ( (zip arg0@@38 arg1@@19 arg2@@6))
)))
(assert (forall ((Heap@@7 T@U) (xs@@1 T@U) (ys@@1 T@U) ) (!  (=> (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type xs@@1) (SeqType RefType))) (= (type ys@@1) (SeqType RefType))) (and (= (zip Heap@@7 xs@@1 ys@@1) (|zip'| Heap@@7 xs@@1 ys@@1)) (dummyFunction (|zip#triggerStateless| xs@@1 ys@@1))))
 :qid |stdinbpl.547:15|
 :skolemid |58|
 :pattern ( (zip Heap@@7 xs@@1 ys@@1))
)))
...
(assert (forall ((Heap@@8 T@U) (Mask@@7 T@U) (xs@@2 T@U) (ys@@2 T@U) ) (!  (=> (and (and (and (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (= (type xs@@2) (SeqType RefType))) (= (type ys@@2) (SeqType RefType))) (and (state Heap@@8 Mask@@7) (< AssumeFunctionsAbove 0))) (or (= (|Seq#Length| xs@@2) (|Seq#Length| ys@@2)) (= (|Seq#Length| xs@@2) (+ (|Seq#Length| ys@@2) 1)))) (= (zip Heap@@8 xs@@2 ys@@2) (ite (|Seq#Equal| ys@@2 (|Seq#Empty| RefType)) xs@@2 (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (|Seq#Index| xs@@2 0)) (|Seq#Singleton| (|Seq#Index| ys@@2 0))) (|zip'| Heap@@8 (|Seq#Drop| xs@@2 1) (|Seq#Drop| ys@@2 1))))))
 :qid |stdinbpl.557:15|
 :skolemid |60|
 :pattern ( (state Heap@@8 Mask@@7) (zip Heap@@8 xs@@2 ys@@2))
)))
...
(assert  (and (and (= (type xs@@3) (SeqType RefType)) (= (type ys@@3) (SeqType RefType))) (= (type Heap@@13) (MapType0Type RefType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon6_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (|Seq#Equal| (zip Heap@@13 xs@@3 ys@@3) (ite (|Seq#Equal| ys@@3 (|Seq#Empty| RefType)) xs@@3 (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (|Seq#Index| xs@@3 0)) (|Seq#Singleton| (|Seq#Index| ys@@3 0))) (zip Heap@@13 (|Seq#Drop| xs@@3 1) (|Seq#Drop| ys@@3 1))))))))
(let ((anon8_Then_correct  (=> (and (|Seq#Equal| ys@@3 (|Seq#Empty| RefType)) (= (ControlFlow 0 7) 6)) anon6_correct)))
(let ((anon9_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (or (= (|Seq#Length| (|Seq#Drop| xs@@3 1)) (|Seq#Length| (|Seq#Drop| ys@@3 1))) (= (|Seq#Length| (|Seq#Drop| xs@@3 1)) (+ (|Seq#Length| (|Seq#Drop| ys@@3 1)) 1))))))
(let ((anon8_Else_correct  (=> (not (|Seq#Equal| ys@@3 (|Seq#Empty| RefType))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (< 0 (|Seq#Length| xs@@3))) (=> (< 0 (|Seq#Length| xs@@3)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (< 0 (|Seq#Length| ys@@3))) (=> (< 0 (|Seq#Length| ys@@3)) (and (=> (= (ControlFlow 0 8) 4) anon9_Then_correct) (=> (= (ControlFlow 0 8) 6) anon6_correct)))))))))
(let ((anon7_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (= (|Seq#Length| xs@@3) (|Seq#Length| ys@@3)) (= (|Seq#Length| xs@@3) (+ (|Seq#Length| ys@@3) 1))))))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (or (= (|Seq#Length| xs@@3) (|Seq#Length| ys@@3)) (= (|Seq#Length| xs@@3) (+ (|Seq#Length| ys@@3) 1))) (state Heap@@13 ZeroMask))) (and (and (=> (= (ControlFlow 0 11) 2) anon7_Then_correct) (=> (= (ControlFlow 0 11) 7) anon8_Then_correct)) (=> (= (ControlFlow 0 11) 8) anon8_Else_correct)))))
