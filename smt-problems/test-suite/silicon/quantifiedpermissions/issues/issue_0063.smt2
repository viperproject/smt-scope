(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:16:38
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0063.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (forall ((i@3@01 Int) (j@4@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0063.vpr@7@12@7@80-aux|)))
(assert (forall ((i@3@01 Int) (j@4@01 Int)) (!
  (=>
    (and (<= 0 i@3@01) (and (< i@3@01 j@4@01) (< j@4@01 (Seq_length S@1@01))))
    (not (= (Seq_index S@1@01 i@3@01) (Seq_index S@1@01 j@4@01))))
  :pattern ((Seq_index S@1@01 i@3@01) (Seq_index S@1@01 j@4@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0063.vpr@7@12@7@80|)))
...
; [eval] |S|
(push) ; 4
; [then-branch: 4 | !(i@13@01 in [0..|S@1@01|]) | live]
; [else-branch: 4 | i@13@01 in [0..|S@1@01|] | live]
(push) ; 5
; [then-branch: 4 | !(i@13@01 in [0..|S@1@01|])]
(assert (not (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i@13@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 4 | i@13@01 in [0..|S@1@01|]]
(assert (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i@13@01))
; [eval] i % 2 == 1
; [eval] i % 2
(pop) ; 5
(pop) ; 4
...
; Joined path conditions
(assert (or
  (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i@13@01)
  (not (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i@13@01))))
(assert (and
  (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i@13@01)
  (= (mod i@13@01 2) 1)))
; [eval] S[i]
...
; (get-info :all-statistics)
(push) ; 4
(assert (not (< i@13@01 (Seq_length S@1@01))))
(check-sat)
; unsat
(pop) ; 4
; 0,00s
...
(assert (forall ((i@13@01 Int)) (!
  (=>
    ...
    (or
      (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i@13@01)
      (not (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i@13@01))))
  :pattern ((Seq_index S@1@01 i@13@01))
  :qid |f-aux|)))
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((i1@13@01 Int) (i2@13@01 Int)) (!
  (=>
    (and
      (and
        (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i1@13@01)
        (= (mod i1@13@01 2) 1))
      (and
        (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i2@13@01)
        (= (mod i2@13@01 2) 1))
      (= (Seq_index S@1@01 i1@13@01) (Seq_index S@1@01 i2@13@01)))
    (= i1@13@01 i2@13@01))
...
(assert (forall ((i@13@01 Int)) (!
  (=>
    (and
      ...
      (= (mod i@13@01 2) 1))
    (and
      (= (inv@14@01 (Seq_index S@1@01 i@13@01)) i@13@01)
      (img@15@01 (Seq_index S@1@01 i@13@01))))
  :pattern ((Seq_index S@1@01 i@13@01))
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@15@01 r)
      (and
        (Seq_contains (Seq_range 0 (Seq_length S@1@01)) (inv@14@01 r))
        (= (mod (inv@14@01 r) 2) 1)))
    (= (Seq_index S@1@01 (inv@14@01 r)) r))
  :pattern ((inv@14@01 r))
  :qid |f-fctOfInv|)))
; Precomputing data for removing quantified permissions
  ...
  (ite
    (and
      (and
        ...
        (= (mod (inv@14@01 r) 2) 1))
      (img@15@01 r)
      (= r (Seq_index S@1@01 (inv@14@01 r))))
    ($Perm.min
      (ite
        (and
          (img@7@01 r)
  ...
  (=>
    (ite
      (and
        (img@7@01 r)
        (Seq_contains (Seq_range 0 (Seq_length S@1@01)) (inv@6@01 r)))
      (< $Perm.No (- $Perm.Write (pTaken@11@01 r)))
      false)
    (=
