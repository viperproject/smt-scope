...
(set-info :boogie-vc-id |arrR#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct true))
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= 0 x@@14)) (=> (<= 0 x@@14) (=> (= (ControlFlow 0 2) (- 0 1)) (< x@@14 (alen a_1@@20)))))))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (= (alen a_1@@20) n@@12) (<= 0 x@@14)) (and (< x@@14 n@@12) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
