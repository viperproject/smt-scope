...
(declare-fun r_19 () T@U)
(declare-fun r_18 () T@U)
(declare-fun r1 () T@U)
(declare-fun r2 () T@U)
(assert  (and (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type r_18) RefType)) (= (type r_19) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type r_20) RefType)) (= (type r1) RefType)) (= (type r2) RefType)))
(set-info :boogie-vc-id permOnlyOneField)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon11_correct true))
(let ((anon18_Else_correct  (=> (and (not (HasDirectPerm Mask@0 r_20 f2)) (= (ControlFlow 0 17) 13)) anon11_correct)))
(let ((anon18_Then_correct  (=> (HasDirectPerm Mask@0 r_20 f2) (and (=> (= (ControlFlow 0 14) (- 0 16)) (HasDirectPerm Mask@0 r_20 f2)) (=> (HasDirectPerm Mask@0 r_20 f2) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm Mask@0 r_20 f1)) (=> (HasDirectPerm Mask@0 r_20 f1) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))
(let ((anon17_Else_correct  (=> (= (ControlFlow 0 12) (- 0 11)) (forall ((r_5 T@U) ) (!  (=> (and (= (type r_5) RefType) (HasDirectPerm Mask@0 r_5 f2)) (> (U_2_int (MapType0Select Heap@@9 r_5 f1)) 0))
 :qid |stdinbpl.638:15|
 :skolemid |36|
 :pattern ( (MapType1Select Mask@0 r_5 f2))
 :pattern ( (MapType0Select Heap@@9 r_5 f2))
)))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((r_3 T@U) ) (!  (=> (and (= (type r_3) RefType) (HasDirectPerm Mask@0 r_3 f2)) (> (U_2_int (MapType0Select Heap@@9 r_3 f2)) 0))
 :qid |stdinbpl.617:15|
 :skolemid |35|
 :pattern ( (MapType1Select Mask@0 r_3 f2))
 :pattern ( (MapType0Select Heap@@9 r_3 f2))
))) (=> (forall ((r_3@@0 T@U) ) (!  (=> (and (= (type r_3@@0) RefType) (HasDirectPerm Mask@0 r_3@@0 f2)) (> (U_2_int (MapType0Select Heap@@9 r_3@@0 f2)) 0))
 :qid |stdinbpl.617:15|
 :skolemid |35|
 :pattern ( (MapType1Select Mask@0 r_3@@0 f2))
 :pattern ( (MapType0Select Heap@@9 r_3@@0 f2))
)) (=> (state Heap@@9 Mask@0) (and (and (=> (= (ControlFlow 0 18) 12) anon17_Else_correct) (=> (= (ControlFlow 0 18) 14) anon18_Then_correct)) (=> (= (ControlFlow 0 18) 17) anon18_Else_correct)))))))
(let ((anon7_correct true))
(let ((anon16_Else_correct  (=> (and (not (HasDirectPerm Mask@0 r_19 f2)) (= (ControlFlow 0 10) 6)) anon7_correct)))
(let ((anon16_Then_correct  (=> (HasDirectPerm Mask@0 r_19 f2) (and (=> (= (ControlFlow 0 7) (- 0 9)) (HasDirectPerm Mask@0 r_19 f2)) (=> (HasDirectPerm Mask@0 r_19 f2) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm Mask@0 r_19 f2)) (=> (HasDirectPerm Mask@0 r_19 f2) (=> (= (ControlFlow 0 7) 6) anon7_correct))))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((r_1_1 T@U) ) (!  (=> (and (= (type r_1_1) RefType) (HasDirectPerm Mask@0 r_1_1 f1)) (> (U_2_int (MapType0Select Heap@@9 r_1_1 f1)) 0))
 :qid |stdinbpl.596:15|
 :skolemid |34|
...
)) (=> (state Heap@@9 Mask@0) (and (and (=> (= (ControlFlow 0 20) 18) anon15_Else_correct) (=> (= (ControlFlow 0 20) 7) anon16_Then_correct)) (=> (= (ControlFlow 0 20) 10) anon16_Else_correct)))))))
(let ((anon3_correct true))
(let ((anon14_Else_correct  (=> (and (not (HasDirectPerm Mask@0 r_18 f1)) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon14_Then_correct  (=> (HasDirectPerm Mask@0 r_18 f1) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@0 r_18 f1)) (=> (HasDirectPerm Mask@0 r_18 f1) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 r_18 f1)) (=> (HasDirectPerm Mask@0 r_18 f1) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 r1 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@9 r2 $allocated)) (not (= r1 null))) (and (= Mask@0 (MapType1Store ZeroMask r1 f1 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r1 f1)) FullPerm)))) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (HasDirectPerm Mask@0 r1 f1)) (=> (HasDirectPerm Mask@0 r1 f1) (=> (> (U_2_int (MapType0Select Heap@@9 r1 f1)) 0) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (and (=> (= (ControlFlow 0 22) 20) anon13_Else_correct) (=> (= (ControlFlow 0 22) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 22) 5) anon14_Else_correct))))))))))
