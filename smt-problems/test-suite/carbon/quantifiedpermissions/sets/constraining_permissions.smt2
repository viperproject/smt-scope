...
(assert  (and (and (and (and (and (and (and (and (= (type xs) (MapType2Type RefType boolType)) (= (type ys) (MapType2Type RefType boolType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv5 arg0@@43)) RefType)
 :qid |funType:invRecv5|
 :pattern ( (invRecv5 arg0@@43))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv4 arg0@@44)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon12_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((x_5 T@U) (x_5_1 T@U) ) (!  (=> (and (= (type x_5) RefType) (= (type x_5_1) RefType)) (=> (and (and (and (and (not (= x_5 x_5_1)) (U_2_bool (MapType2Select (|Set#Union| xs ys) x_5))) (U_2_bool (MapType2Select (|Set#Union| xs ys) x_5_1))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_5 x_5_1))))
 :qid |stdinbpl.737:15|
 :skolemid |116|
 :no-pattern (type x_5)
...
(let ((anon11_Else_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 4) (- 0 7)) (forall ((x_6 T@U) ) (!  (=> (and (= (type x_6) RefType) (U_2_bool (MapType2Select (|Set#Union| xs ys) x_6))) (> (U_2_real (MapType1Select QPMask@1 x_6 f_7)) NoPerm))
 :qid |stdinbpl.781:15|
 :skolemid |122|
 :no-pattern (type x_6)
 :no-pattern (U_2_int x_6)
 :no-pattern (U_2_bool x_6)
))) (=> (forall ((x_6@@0 T@U) ) (!  (=> (and (= (type x_6@@0) RefType) (U_2_bool (MapType2Select (|Set#Union| xs ys) x_6@@0))) (> (U_2_real (MapType1Select QPMask@1 x_6@@0 f_7)) NoPerm))
 :qid |stdinbpl.781:15|
 :skolemid |122|
 :no-pattern (type x_6@@0)
 :no-pattern (U_2_int x_6@@0)
 :no-pattern (U_2_bool x_6@@0)
)) (=> (forall ((x_6@@1 T@U) ) (!  (=> (and (= (type x_6@@1) RefType) (U_2_bool (MapType2Select (|Set#Union| xs ys) x_6@@1))) (< wildcard@0 (U_2_real (MapType1Select QPMask@1 x_6@@1 f_7))))
 :qid |stdinbpl.785:20|
 :skolemid |123|
 :no-pattern (type x_6@@1)
 :no-pattern (U_2_int x_6@@1)
 :no-pattern (U_2_bool x_6@@1)
)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((x_6@@2 T@U) ) (!  (=> (= (type x_6@@2) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Union| xs ys) x_6@@2)) (dummyFunction (MapType0Select Heap@@9 x_6@@2 f_7))) (>= wildcard@0 NoPerm)))
 :qid |stdinbpl.792:17|
 :skolemid |124|
 :pattern ( (MapType0Select Heap@@9 x_6@@2 f_7))
 :pattern ( (MapType1Select QPMask@2 x_6@@2 f_7))
 :pattern ( (MapType2Select (|Set#Union| xs ys) x_6@@2))
))) (=> (forall ((x_6@@3 T@U) ) (!  (=> (= (type x_6@@3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Union| xs ys) x_6@@3)) (dummyFunction (MapType0Select Heap@@9 x_6@@3 f_7))) (>= wildcard@0 NoPerm)))
 :qid |stdinbpl.792:17|
 :skolemid |124|
 :pattern ( (MapType0Select Heap@@9 x_6@@3 f_7))
 :pattern ( (MapType1Select QPMask@2 x_6@@3 f_7))
 :pattern ( (MapType2Select (|Set#Union| xs ys) x_6@@3))
)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((x_6@@4 T@U) (x_6_1 T@U) ) (!  (=> (and (= (type x_6@@4) RefType) (= (type x_6_1) RefType)) (=> (and (and (and (and (not (= x_6@@4 x_6_1)) (U_2_bool (MapType2Select (|Set#Union| xs ys) x_6@@4))) (U_2_bool (MapType2Select (|Set#Union| xs ys) x_6_1))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_6@@4 x_6_1))))
 :qid |stdinbpl.799:17|
 :skolemid |125|
 :pattern ( (neverTriggered7 x_6@@4) (neverTriggered7 x_6_1))
))) (=> (forall ((x_6@@5 T@U) (x_6_1@@0 T@U) ) (!  (=> (and (= (type x_6@@5) RefType) (= (type x_6_1@@0) RefType)) (=> (and (and (and (and (not (= x_6@@5 x_6_1@@0)) (U_2_bool (MapType2Select (|Set#Union| xs ys) x_6@@5))) (U_2_bool (MapType2Select (|Set#Union| xs ys) x_6_1@@0))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_6@@5 x_6_1@@0))))
 :qid |stdinbpl.799:17|
 :skolemid |125|
 :pattern ( (neverTriggered7 x_6@@5) (neverTriggered7 x_6_1@@0))
)) (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((x_6@@6 T@U) ) (!  (=> (and (= (type x_6@@6) RefType) (U_2_bool (MapType2Select (|Set#Union| xs ys) x_6@@6))) (> (U_2_real (MapType1Select QPMask@1 x_6@@6 f_7)) NoPerm))
 :qid |stdinbpl.806:17|
 :skolemid |126|
 :pattern ( (MapType0Select Heap@@9 x_6@@6 f_7))
 :pattern ( (MapType1Select QPMask@2 x_6@@6 f_7))
 :pattern ( (MapType2Select (|Set#Union| xs ys) x_6@@6))
)))))))))))))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (U_2_bool (MapType2Select ys x_3))) (U_2_bool (MapType2Select ys x_3_1))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_3 x_3_1))))
 :qid |stdinbpl.686:15|
 :skolemid |110|
 :no-pattern (type x_3)
...
))) (=> (forall ((x_3@@0 T@U) (x_3_1@@0 T@U) ) (!  (=> (and (= (type x_3@@0) RefType) (= (type x_3_1@@0) RefType)) (=> (and (and (and (and (not (= x_3@@0 x_3_1@@0)) (U_2_bool (MapType2Select ys x_3@@0))) (U_2_bool (MapType2Select ys x_3_1@@0))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_3@@0 x_3_1@@0))))
 :qid |stdinbpl.686:15|
 :skolemid |110|
...
)) (=> (forall ((x_3@@1 T@U) ) (!  (=> (and (= (type x_3@@1) RefType) (U_2_bool (MapType2Select ys x_3@@1))) (and (qpRange5 x_3@@1) (= (invRecv5 x_3@@1) x_3@@1)))
 :qid |stdinbpl.692:22|
 :skolemid |111|
 :pattern ( (MapType0Select Heap@@9 x_3@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 x_3@@1 f_7))
 :pattern ( (MapType2Select ys x_3@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType2Select ys (invRecv5 o_3))) (qpRange5 o_3)) (= (invRecv5 o_3) o_3)))
 :qid |stdinbpl.696:22|
 :skolemid |112|
 :pattern ( (invRecv5 o_3))
)) (forall ((x_3@@2 T@U) ) (!  (=> (and (= (type x_3@@2) RefType) (U_2_bool (MapType2Select ys x_3@@2))) (not (= x_3@@2 null)))
 :qid |stdinbpl.702:22|
 :skolemid |113|
 :pattern ( (MapType0Select Heap@@9 x_3@@2 f_7))
 :pattern ( (MapType1Select QPMask@1 x_3@@2 f_7))
 :pattern ( (MapType2Select ys x_3@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType2Select ys (invRecv5 o_3@@0))) (qpRange5 o_3@@0)) (and (= (invRecv5 o_3@@0) o_3@@0) (< (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7))))) (=> (not (and (U_2_bool (MapType2Select ys (invRecv5 o_3@@0))) (qpRange5 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7))))))
 :qid |stdinbpl.708:22|
 :skolemid |114|
...
))) (and (state Heap@@9 QPMask@1) (state Heap@@9 QPMask@1))) (and (=> (= (ControlFlow 0 12) 11) anon11_Then_correct) (=> (= (ControlFlow 0 12) 4) anon11_Else_correct)))))))))
(let ((anon10_Then_correct true))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select xs x_1))) (U_2_bool (MapType2Select xs x_1_1))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.646:15|
 :skolemid |104|
 :no-pattern (type x_1)
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (and (= (type x_1@@1) RefType) (U_2_bool (MapType2Select xs x_1@@1))) (and (qpRange4 x_1@@1) (= (invRecv4 x_1@@1) x_1@@1)))
 :qid |stdinbpl.652:22|
 :skolemid |105|
 :pattern ( (MapType0Select Heap@@9 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
 :pattern ( (MapType2Select xs x_1@@1))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType2Select xs (invRecv4 o_3@@2))) (qpRange4 o_3@@2)) (= (invRecv4 o_3@@2) o_3@@2)))
 :qid |stdinbpl.656:22|
 :skolemid |106|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 14) 2) anon10_Then_correct) (=> (= (ControlFlow 0 14) 12) anon10_Else_correct)))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 16) 1) anon9_Then_correct) (=> (= (ControlFlow 0 16) 14) anon9_Else_correct)))))
