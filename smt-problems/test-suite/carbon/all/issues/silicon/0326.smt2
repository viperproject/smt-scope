...
(assert (forall ((Heap@@5 T@U) (Mask@@6 T@U) ) (!  (=> (and (and (= (type Heap@@5) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (state Heap@@5 Mask@@6)) (= (|foo'| Heap@@5) (|foo#frame| EmptyFrame)))
 :qid |stdinbpl.204:15|
 :skolemid |24|
 :pattern ( (state Heap@@5 Mask@@6) (|foo'| Heap@@5))
)))
...
(assert (forall ((Heap@@8 T@U) ) (!  (=> (= (type Heap@@8) (MapType0Type RefType)) (dummyFunction (bool_2_U |foo#triggerStateless|)))
 :qid |stdinbpl.197:15|
 :skolemid |23|
 :pattern ( (|foo'| Heap@@8))
)))
...
(assert (forall ((Heap@@11 T@U) ) (!  (=> (= (type Heap@@11) (MapType0Type RefType)) (and (= (foo Heap@@11) (|foo'| Heap@@11)) (dummyFunction (bool_2_U |foo#triggerStateless|))))
 :qid |stdinbpl.193:15|
 :skolemid |22|
 :pattern ( (foo Heap@@11))
)))
...
(declare-fun x@@8 () T@U)
(assert  (and (= (type Heap@@12) (MapType0Type RefType)) (= (type x@@8) RefType)))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@12 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@12 x@@8 $allocated)) (= (ControlFlow 0 2) (- 0 1)))) false)))
