...
(assert  (and (and (= (Ctor PredicateType_pType) 10) (= (Ctor FrameTypeType) 11)) (forall ((arg0@@23 T@U) (arg1@@9 Int) ) (! (= (type (p_1 arg0@@23 arg1@@9)) (FieldType PredicateType_pType FrameTypeType))
 :qid |funType:p_1|
 :pattern ( (p_1 arg0@@23 arg1@@9))
))))
(assert (forall ((x@@8 T@U) (idx Int) ) (!  (=> (= (type x@@8) RefType) (IsPredicateField (p_1 x@@8 idx)))
 :qid |stdinbpl.201:15|
 :skolemid |23|
 :pattern ( (p_1 x@@8 idx))
)))
(assert (forall ((Heap@@0 T@U) (x@@9 T@U) (idx@@0 Int) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type x@@9) RefType)) (|p#everUsed| (p_1 x@@9 idx@@0)))
 :qid |stdinbpl.220:15|
 :skolemid |27|
 :pattern ( (|p#trigger| Heap@@0 (p_1 x@@9 idx@@0)))
)))
...
(assert (forall ((x@@10 T@U) (idx@@1 Int) (x2 T@U) (idx2 Int) ) (!  (=> (and (and (= (type x@@10) RefType) (= (type x2) RefType)) (= (p_1 x@@10 idx@@1) (p_1 x2 idx2))) (and (= x@@10 x2) (= idx@@1 idx2)))
 :qid |stdinbpl.211:15|
 :skolemid |25|
 :pattern ( (p_1 x@@10 idx@@1) (p_1 x2 idx2))
)))
...
(assert (forall ((x@@12 T@U) (idx@@3 Int) ) (!  (=> (= (type x@@12) RefType) (= (getPredWandId (p_1 x@@12 idx@@3)) 0))
 :qid |stdinbpl.205:15|
 :skolemid |24|
 :pattern ( (p_1 x@@12 idx@@3))
)))
...
(assert (forall ((x@@13 T@U) (idx@@4 Int) ) (!  (=> (= (type x@@13) RefType) (= (PredicateMaskField (p_1 x@@13 idx@@4)) (|p#sm| x@@13 idx@@4)))
 :qid |stdinbpl.197:15|
 :skolemid |22|
 :pattern ( (PredicateMaskField (p_1 x@@13 idx@@4)))
)))
...
(assert  (and (= (type Heap@@10) (MapType0Type RefType)) (forall ((arg0@@28 T@U) (arg1@@12 Int) ) (! (= (type (invRecv1 arg0@@28 arg1@@12)) RefType)
 :qid |funType:invRecv1|
 :pattern ( (invRecv1 arg0@@28 arg1@@12))
))))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (not (= r_1 r_1_1)) (< NoPerm (U_2_real (MapType1Select ZeroMask null (p_1 r_1 0))))) (< NoPerm (U_2_real (MapType1Select ZeroMask null (p_1 r_1_1 0))))) (not (= r_1 r_1_1))))
 :qid |stdinbpl.256:17|
 :skolemid |28|
 :pattern ( (neverTriggered1 r_1) (neverTriggered1 r_1_1))
))) (=> (forall ((r_1@@0 T@U) (r_1_1@@0 T@U) ) (!  (=> (and (= (type r_1@@0) RefType) (= (type r_1_1@@0) RefType)) (=> (and (and (not (= r_1@@0 r_1_1@@0)) (< NoPerm (U_2_real (MapType1Select ZeroMask null (p_1 r_1@@0 0))))) (< NoPerm (U_2_real (MapType1Select ZeroMask null (p_1 r_1_1@@0 0))))) (not (= r_1@@0 r_1_1@@0))))
 :qid |stdinbpl.256:17|
 :skolemid |28|
 :pattern ( (neverTriggered1 r_1@@0) (neverTriggered1 r_1_1@@0))
)) (=> (forall ((r_1@@1 T@U) ) (!  (=> (and (= (type r_1@@1) RefType) (< NoPerm (U_2_real (MapType1Select ZeroMask null (p_1 r_1@@1 0))))) (and (= (invRecv1 r_1@@1 0) r_1@@1) (qpRange1 r_1@@1 0)))
 :qid |stdinbpl.262:22|
 :skolemid |29|
 :pattern ( (MapType0Select Heap@@10 null (p_1 r_1@@1 0)))
 :pattern ( (MapType1Select ZeroMask null (p_1 r_1@@1 0)))
)) (=> (and (forall ((x@@14 T@U) (idx@@5 Int) ) (!  (=> (= (type x@@14) RefType) (=> (and (< NoPerm (U_2_real (MapType1Select ZeroMask null (p_1 (invRecv1 x@@14 idx@@5) 0)))) (qpRange1 x@@14 idx@@5)) (and (= (invRecv1 x@@14 idx@@5) x@@14) (= 0 idx@@5))))
 :qid |stdinbpl.266:22|
 :skolemid |30|
 :pattern ( (invRecv1 x@@14 idx@@5))
)) (= (ControlFlow 0 3) (- 0 2))) (forall ((r_1@@2 T@U) ) (!  (=> (= (type r_1@@2) RefType) (>= (U_2_real (MapType1Select ZeroMask null (p_1 r_1@@2 0))) NoPerm))
 :qid |stdinbpl.272:15|
 :skolemid |31|
 :pattern ( (MapType0Select Heap@@10 null (p_1 r_1@@2 0)))
 :pattern ( (MapType1Select ZeroMask null (p_1 r_1@@2 0)))
))))))))
