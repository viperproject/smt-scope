...
(assert  (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type this@@3) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |fun#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (U_2_bool (MapType0Select Heap@@13 this@@3 $allocated))) (and (= AssumeFunctionsAbove 0) (= perm@0 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= this@@3 null))) (= Mask@0 (MapType1Store ZeroMask this@@3 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@3 f_7)) perm@0))))) (and (state Heap@@13 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@0 this@@3 f_7)))))))
