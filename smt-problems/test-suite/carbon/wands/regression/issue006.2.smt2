...
(assert  (and (and (and (and (and (= (type Ops_19Heap@0) (MapType0Type RefType)) (= (type Used_19Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@13) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Used_18Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test08b)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon2_correct  (=> (= b_30@3  (and b_30@2 (state Ops_19Heap@0 ZeroMask))) (=> (and (= b_30@4  (and b_30@3 (state Ops_19Heap@0 ZeroMask))) (= b_31@0  (and b_31 (state Used_19Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (and (and b_30@4 b_30@4) b_31@0) (atMost x_1@@0 y_1@@0))) (=> (=> (and (and b_30@4 b_30@4) b_31@0) (atMost x_1@@0 y_1@@0)) (=> (= Mask@0 (MapType1Store ZeroMask null (wand (<= x_1@@0 y_1@@0) (atMost x_1@@0 y_1@@0)) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (wand (<= x_1@@0 y_1@@0) (atMost x_1@@0 y_1@@0)))) FullPerm)))) (=> (and (and (and (state Heap@@13 Mask@0) (state Heap@@13 Mask@0)) (and (state Heap@@13 Mask@0) (< x_1@@0 y_1@@0))) (and (and (state Heap@@13 Mask@0) (state Heap@@13 Mask@0)) (and (= x_1@0 (+ x_1@@0 1)) (state Heap@@13 Mask@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (wand (<= x_1@0 y_1@@0) (atMost x_1@0 y_1@@0)))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (wand (<= x_1@0 y_1@@0) (atMost x_1@0 y_1@@0))))) (=> (= Mask@1 (MapType1Store Mask@0 null (wand (<= x_1@0 y_1@@0) (atMost x_1@0 y_1@@0)) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (wand (<= x_1@0 y_1@@0) (atMost x_1@0 y_1@@0)))) FullPerm)))) (=> (and (state Heap@@13 Mask@1) (= (ControlFlow 0 2) (- 0 1))) (<= x_1@0 y_1@@0)))))))))))))
(let ((anon3_Else_correct  (=> (not b_30@0) (=> (and (= b_30@2 b_30@0) (= (ControlFlow 0 6) 2)) anon2_correct))))
(let ((anon3_Then_correct  (=> (and (and b_30@0 (= b_30@1  (and b_30@0 (<= x_1@@0 y_1@@0)))) (and (= b_30@2 b_30@1) (= (ControlFlow 0 5) 2))) anon2_correct)))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (= b_30@0  (and b_30 (state Ops_19Heap@0 ZeroMask))) (= b_29@0  (and b_29 (state Used_18Heap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 7) 5) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct)))))
