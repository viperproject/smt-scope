...
(assert  (and (and (and (and (= (type QPMask@0) (MapType1Type RefType realType)) (= (type x@@11) RefType)) (= (type xs) (SeqType RefType))) (= (type Heap@@14) (MapType0Type RefType))) (forall ((arg0@@43 T@U) (arg1@@20 Int) ) (! (= (type (invRecv6 arg0@@43 arg1@@20)) RefType)
...
)) (=> (and (forall ((r_2_1 T@U) (i_1_1 Int) ) (!  (=> (= (type r_2_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv6 r_2_1 i_1_1)) (< NoPerm FullPerm)) (qpRange6 r_2_1 i_1_1)) (and (= (invRecv6 r_2_1 i_1_1) r_2_1) (= i@@18 i_1_1))))
