...
(declare-fun i@@6 () Int)
(declare-fun j@@5 () Int)
(assert  (and (and (and (and (= (type x@@11) (SeqType RefType)) (= (type y@0) RefType)) (= (type y_3@0) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id bar)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((anon13_correct true))
(let ((anon21_Else_correct  (=> (and (not (and (<= 0 i_4) (< i_4 (|Seq#Length| x@@11)))) (= (ControlFlow 0 23) 18)) anon13_correct)))
(let ((anon21_Then_correct  (=> (and (<= 0 i_4) (< i_4 (|Seq#Length| x@@11))) (and (=> (= (ControlFlow 0 19) (- 0 22)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 19) (- 0 21)) (< i_4 (|Seq#Length| x@@11))) (=> (< i_4 (|Seq#Length| x@@11)) (=> (= y_3@0 (|Seq#Index| x@@11 i_4)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (HasDirectPerm QPMask@0 y_3@0 f_7)) (=> (HasDirectPerm QPMask@0 y_3@0 f_7) (=> (= (ControlFlow 0 19) 18) anon13_correct)))))))))))
(let ((anon20_Else_correct true))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 24) (- 0 25)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 (|Seq#Length| x@@11)))) (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length| x@@11)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| x@@11 i_3) (|Seq#Index| x@@11 i_3_1))))
 :qid |stdinbpl.622:15|
 :skolemid |59|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (and (<= 0 i_3@@0) (< i_3@@0 (|Seq#Length| x@@11)))) (and (<= 0 i_3_1@@0) (< i_3_1@@0 (|Seq#Length| x@@11)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| x@@11 i_3@@0) (|Seq#Index| x@@11 i_3_1@@0))))
 :qid |stdinbpl.622:15|
 :skolemid |59|
)) (=> (and (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 (|Seq#Length| x@@11))) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index| x@@11 i_3@@1)) (= (invRecv1 (|Seq#Index| x@@11 i_3@@1)) i_3@@1)))
 :qid |stdinbpl.628:22|
 :skolemid |60|
 :pattern ( (|Seq#Index| x@@11 i_3@@1))
 :pattern ( (|Seq#Index| x@@11 i_3@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv1 o_3)) (< (invRecv1 o_3) (|Seq#Length| x@@11))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (|Seq#Index| x@@11 (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.632:22|
 :skolemid |61|
 :pattern ( (invRecv1 o_3))
))) (=> (and (and (forall ((i_3@@2 Int) ) (!  (=> (and (<= 0 i_3@@2) (< i_3@@2 (|Seq#Length| x@@11))) (not (= (|Seq#Index| x@@11 i_3@@2) null)))
 :qid |stdinbpl.638:22|
 :skolemid |62|
 :pattern ( (|Seq#Index| x@@11 i_3@@2))
 :pattern ( (|Seq#Index| x@@11 i_3@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (|Seq#Length| x@@11))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| x@@11 (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (|Seq#Length| x@@11))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.644:22|
 :skolemid |63|
...
)) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 24) 17) anon20_Else_correct) (=> (= (ControlFlow 0 24) 19) anon21_Then_correct)) (=> (= (ControlFlow 0 24) 23) anon21_Else_correct))))))))
(let ((anon9_correct true))
(let ((anon19_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 (|Seq#Length| x@@11)))) (= (ControlFlow 0 12) 8)) anon9_correct)))
(let ((anon19_Then_correct  (=> (and (<= 0 i_2) (< i_2 (|Seq#Length| x@@11))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_2 (|Seq#Length| x@@11))) (=> (< i_2 (|Seq#Length| x@@11)) (=> (= (ControlFlow 0 9) 8) anon9_correct))))))))
(let ((anon18_Else_correct  (=> (not (and (<= 0 i_2) (< i_2 (|Seq#Length| x@@11)))) (and (=> (= (ControlFlow 0 16) 9) anon19_Then_correct) (=> (= (ControlFlow 0 16) 12) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (and (<= 0 i_2) (< i_2 (|Seq#Length| x@@11))) (and (=> (= (ControlFlow 0 13) (- 0 15)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 13) (- 0 14)) (< i_2 (|Seq#Length| x@@11))) (=> (< i_2 (|Seq#Length| x@@11)) (=> (= y@0 (|Seq#Index| x@@11 i_2)) (and (=> (= (ControlFlow 0 13) 9) anon19_Then_correct) (=> (= (ControlFlow 0 13) 12) anon19_Else_correct))))))))))
(let ((anon15_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (<= 0 i_1) (and (< i_1 (|Seq#Length| x@@11)) (and (<= 0 j_1) (and (< j_1 (|Seq#Length| x@@11)) (not (= i_1 j_1)))))) (not (= (|Seq#Index| x@@11 i_1) (|Seq#Index| x@@11 j_1))))
 :qid |stdinbpl.597:20|
 :skolemid |58|
 :pattern ( (|Seq#Index| x@@11 i_1) (|Seq#Index| x@@11 j_1))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 26) 24) anon17_Else_correct) (=> (= (ControlFlow 0 26) 13) anon18_Then_correct)) (=> (= (ControlFlow 0 26) 16) anon18_Else_correct)))))
(let ((anon3_correct true))
(let ((anon16_Else_correct  (=> (and (not (and (<= 0 i@@6) (and (< i@@6 (|Seq#Length| x@@11)) (and (<= 0 j@@5) (and (< j@@5 (|Seq#Length| x@@11)) (not (= i@@6 j@@5))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon16_Then_correct  (=> (and (<= 0 i@@6) (and (< i@@6 (|Seq#Length| x@@11)) (and (<= 0 j@@5) (and (< j@@5 (|Seq#Length| x@@11)) (not (= i@@6 j@@5)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i@@6 (|Seq#Length| x@@11))) (=> (< i@@6 (|Seq#Length| x@@11)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j@@5 (|Seq#Length| x@@11))) (=> (< j@@5 (|Seq#Length| x@@11)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (and (=> (= (ControlFlow 0 27) 26) anon15_Else_correct) (=> (= (ControlFlow 0 27) 2) anon16_Then_correct)) (=> (= (ControlFlow 0 27) 7) anon16_Else_correct)))))
