...
(assert  (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type a_2@0) (MapType2Type intType boolType))) (= (type b_2@0) (MapType2Type intType boolType))))
(set-info :boogie-vc-id t2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 5)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#UnionOne| (|Set#Singleton| (int_2_U 3)) (int_2_U 2)) (int_2_U 1)) (int_2_U 1)))) (=> (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#UnionOne| (|Set#Singleton| (int_2_U 3)) (int_2_U 2)) (int_2_U 1)) (int_2_U 1))) (=> (state Heap@@9 ZeroMask) (=> (and (and (= a_2@0 (|Set#Singleton| (int_2_U 1))) (state Heap@@9 ZeroMask)) (and (= b_2@0 (|Set#Singleton| (int_2_U 2))) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#Equal| (|Set#Union| a_2@0 b_2@0) (|Set#UnionOne| (|Set#Singleton| (int_2_U 2)) (int_2_U 1)))) (=> (|Set#Equal| (|Set#Union| a_2@0 b_2@0) (|Set#UnionOne| (|Set#Singleton| (int_2_U 2)) (int_2_U 1))) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Equal| (|Set#Union| (|Set#Singleton| (int_2_U 1)) (|Set#Singleton| (int_2_U 1))) (|Set#Singleton| (int_2_U 1)))) (=> (|Set#Equal| (|Set#Union| (|Set#Singleton| (int_2_U 1)) (|Set#Singleton| (int_2_U 1))) (|Set#Singleton| (int_2_U 1))) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (MapType2Select (|Set#Intersection| (|Set#UnionOne| (|Set#Singleton| (int_2_U 2)) (int_2_U 1)) (|Set#UnionOne| (|Set#Singleton| (int_2_U 1)) (int_2_U 100))) (int_2_U 1))))))))))))))))
