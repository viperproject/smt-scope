...
(assert  (and (and (and (and (and (= (type start@@9) RefType) (= (type end@@9) RefType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@@14) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |P#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon4_correct true))
(let ((anon6_Else_correct  (=> (not (= (MapType0Select Heap@@14 start@@9 next) null)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@0 start@@9 next)) (=> (HasDirectPerm Mask@0 start@@9 next) (=> (and (and (= Mask@1 (MapType1Store Mask@0 null (P (MapType0Select Heap@@14 start@@9 next) end@@9) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (P (MapType0Select Heap@@14 start@@9 next) end@@9))) FullPerm)))) (state Heap@@14 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 4) 1))) anon4_correct))))))
(let ((anon6_Then_correct  (=> (and (and (= (MapType0Select Heap@@14 start@@9 next) null) (= end@@9 null)) (and (= Mask@2 Mask@0) (= (ControlFlow 0 3) 1))) anon4_correct)))
(let ((anon5_Then_correct  (=> (and (and (not (= start@@9 end@@9)) (not (= start@@9 null))) (and (= Mask@0 (MapType1Store ZeroMask start@@9 next (real_2_U (+ (U_2_real (MapType1Select ZeroMask start@@9 next)) FullPerm)))) (state Heap@@14 Mask@0))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm Mask@0 start@@9 next)) (=> (HasDirectPerm Mask@0 start@@9 next) (and (=> (= (ControlFlow 0 6) 3) anon6_Then_correct) (=> (= (ControlFlow 0 6) 4) anon6_Else_correct)))))))
(let ((anon5_Else_correct  (=> (= start@@9 end@@9) (=> (and (= Mask@2 ZeroMask) (= (ControlFlow 0 2) 1)) anon4_correct))))
(let ((anon0_correct  (=> (and (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@14 start@@9 $allocated)) (U_2_bool (MapType0Select Heap@@14 end@@9 $allocated)))) (and (=> (= (ControlFlow 0 8) 6) anon5_Then_correct) (=> (= (ControlFlow 0 8) 2) anon5_Else_correct)))))
