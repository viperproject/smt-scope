...
(let ((anon6_Else_correct  (=> (and (not (and (<= 0 i_3) (< i_3 (|Seq#Length| xs)))) (= (ControlFlow 0 7) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (<= 0 i_3) (< i_3 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (>= i_3 0)) (=> (>= i_3 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< i_3 (|Seq#Length| xs))) (=> (< i_3 (|Seq#Length| xs)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))))
...
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (and (=> (= (ControlFlow 0 8) 2) anon5_Else_correct) (=> (= (ControlFlow 0 8) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))
