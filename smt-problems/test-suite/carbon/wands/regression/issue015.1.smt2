...
(assert  (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type x@@20) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |Q#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@11 x@@20 $allocated)) (not (= x@@20 null))) (and (= Mask@0 (MapType1Store ZeroMask x@@20 next (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@20 next)) FullPerm)))) (state Heap@@11 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@0 x@@20 next)) (=> (HasDirectPerm Mask@0 x@@20 next) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 x@@20 next)) (=> (HasDirectPerm Mask@0 x@@20 next) (=> (and (= perm@0 (ite (not (= (MapType0Select Heap@@11 x@@20 next) null)) FullPerm NoPerm)) (= (ControlFlow 0 2) (- 0 1))) (>= perm@0 NoPerm))))))))))
