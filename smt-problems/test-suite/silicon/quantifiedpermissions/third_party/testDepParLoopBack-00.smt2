(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:21:46
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quantifiedpermissions/third_party/testDepParLoopBack.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (forall ((j@13@01 Int) (k@14@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testDepParLoopBack.vpr@62@12@62@106-aux|)))
(assert (forall ((j@13@01 Int) (k@14@01 Int)) (!
  (=>
    (and
      (<= 0 j@13@01)
  ...
  :pattern ((Seq_index ar@9@01 j@13@01) (Seq_index ar@9@01 k@14@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testDepParLoopBack.vpr@62@12@62@106|)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@01))))
  ($Snap.combine
...
(assert (forall ((j@22@01 Int) (k@23@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testDepParLoopBack.vpr@67@12@67@106-aux|)))
(assert (forall ((j@22@01 Int) (k@23@01 Int)) (!
  (=>
    (and
      (<= 0 j@22@01)
  ...
  :pattern ((Seq_index br@10@01 j@22@01) (Seq_index br@10@01 k@23@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testDepParLoopBack.vpr@67@12@67@106|)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@01)))))))))
  ($Snap.combine
...
(assert (forall ((j@27@01 Int) (k@28@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testDepParLoopBack.vpr@70@12@70@106-aux|)))
(assert (forall ((j@27@01 Int) (k@28@01 Int)) (!
  (=>
    (and
      (<= 0 j@27@01)
  ...
  :pattern ((Seq_index cr@11@01 j@27@01) (Seq_index cr@11@01 k@28@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testDepParLoopBack.vpr@70@12@70@106|)))
...
(assert (forall ((j@192@01 Int) (k@193@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testDepParLoopBack.vpr@169@12@169@106-aux|)))
(assert (forall ((j@192@01 Int) (k@193@01 Int)) (!
  (=>
    (and
      (<= 0 j@192@01)
  ...
  :pattern ((Seq_index ar@187@01 j@192@01) (Seq_index ar@187@01 k@193@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testDepParLoopBack.vpr@169@12@169@106|)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@191@01))))
  ($Snap.combine
...
(assert (forall ((j@197@01 Int) (k@198@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testDepParLoopBack.vpr@172@12@172@106-aux|)))
(assert (forall ((j@197@01 Int) (k@198@01 Int)) (!
  (=>
    (and
      (<= 0 j@197@01)
  ...
  :pattern ((Seq_index br@188@01 j@197@01) (Seq_index br@188@01 k@198@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testDepParLoopBack.vpr@172@12@172@106|)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@191@01)))))))
  ($Snap.combine
...
(assert (forall ((j@202@01 Int) (k@203@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testDepParLoopBack.vpr@175@12@175@106-aux|)))
(assert (forall ((j@202@01 Int) (k@203@01 Int)) (!
  (=>
    (and
      (<= 0 j@202@01)
  ...
  :pattern ((Seq_index cr@189@01 j@202@01) (Seq_index cr@189@01 k@203@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testDepParLoopBack.vpr@175@12@175@106|)))
...
(assert (forall ((r $Ref)) (!
  (=>
    ...
    (=
      ...
      ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@191@01)))))) r)))
  :pattern (($FVF.lookup_Ref__Integer_value (as sm@225@01  $FVF<Ref__Integer_value>) r))
  :pattern (($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@191@01)))))) r))
  :qid |qp.fvfValDef0|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
    ...
    (=
      ($FVF.lookup_Ref__Integer_value (as sm@225@01  $FVF<Ref__Integer_value>) r)
      ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@191@01))))))))) r)))
  :pattern (($FVF.lookup_Ref__Integer_value (as sm@225@01  $FVF<Ref__Integer_value>) r))
  :pattern (($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@191@01))))))))) r))
  :qid |qp.fvfValDef1|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
    ...
    (=
      ($FVF.lookup_Ref__Integer_value (as sm@225@01  $FVF<Ref__Integer_value>) r)
      ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@191@01))))))))))) r)))
  :pattern (($FVF.lookup_Ref__Integer_value (as sm@225@01  $FVF<Ref__Integer_value>) r))
  :pattern (($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@191@01))))))))))) r))
  :qid |qp.fvfValDef2|)))
; [eval] 0 <= 0 && 0 < len
; [eval] 0 <= 0
(set-option :timeout 0)
  ...
  (ite
    ...
    ($Perm.min
      (ite
        ...
        (/ (to_real 1) (to_real 2))
        $Perm.No)
      (- (- (/ (to_real 1) (to_real 2)) (pTaken@226@01 r)) (pTaken@227@01 r)))
    $Perm.No))
; Done precomputing, updating quantified chunks
; State saturation: before repetition
(set-option :timeout 10)
...
(assert (not (forall ((r $Ref)) (!
  (=>
    (= r (Seq_index ar@187@01 0))
    (= (- (/ (to_real 1) (to_real 2)) (pTaken@226@01 r)) $Perm.No))
...
(assert (=>
  (and
    (img@206@01 (Seq_index ar@187@01 0))
    (and
      (<= 0 (inv@205@01 (Seq_index ar@187@01 0)))
      (< (inv@205@01 (Seq_index ar@187@01 0)) len@190@01)))
  (=
    ($FVF.lookup_Ref__Integer_value (as sm@229@01  $FVF<Ref__Integer_value>) (Seq_index
      ar@187@01
      0))
    ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@191@01))))))))))) (Seq_index
      ar@187@01
      0)))))
(assert (=>
  (and
    (img@201@01 (Seq_index ar@187@01 0))
    (and
      (<= 0 (inv@200@01 (Seq_index ar@187@01 0)))
      (< (inv@200@01 (Seq_index ar@187@01 0)) len@190@01)))
  (=
    ($FVF.lookup_Ref__Integer_value (as sm@229@01  $FVF<Ref__Integer_value>) (Seq_index
      ar@187@01
      0))
    ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@191@01))))))))) (Seq_index
      ar@187@01
      0)))))
(assert (=>
  (ite
    (and
      (img@196@01 (Seq_index ar@187@01 0))
      (and
        (<= 0 (inv@195@01 (Seq_index ar@187@01 0)))
        (< (inv@195@01 (Seq_index ar@187@01 0)) len@190@01)))
    (< $Perm.No (- $Perm.Write (pTaken@222@01 (Seq_index ar@187@01 0))))
    false)
  (=
    ($FVF.lookup_Ref__Integer_value (as sm@229@01  $FVF<Ref__Integer_value>) (Seq_index
      ar@187@01
      0))
    ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@191@01)))))) (Seq_index
      ar@187@01
      0)))))
...
; [eval] 1 <= i
(push) ; 5
; [then-branch: 102 | !(1 <= i@230@01) | live]
; [else-branch: 102 | 1 <= i@230@01 | live]
(push) ; 6
; [then-branch: 102 | !(1 <= i@230@01)]
(assert (not (<= 1 i@230@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 102 | 1 <= i@230@01]
(assert (<= 1 i@230@01))
; [eval] i < (|ar| - 1 < len ? |ar| - 1 : len) + 1
; [eval] (|ar| - 1 < len ? |ar| - 1 : len) + 1
; [eval] (|ar| - 1 < len ? |ar| - 1 : len)
...
(assert (=>
  (<= 1 i@230@01)
  (and (<= 1 i@230@01) (< (- (Seq_length ar@187@01) 1) len@190@01))))
(assert (or (<= 1 i@230@01) (not (<= 1 i@230@01))))
(assert (and (<= 1 i@230@01) (< i@230@01 (+ (- (Seq_length ar@187@01) 1) 1))))
; [eval] ar[i]
(push) ; 5
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i@230@01 (Seq_length ar@187@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
(assert (forall ((i@230@01 Int)) (!
  (=>
    (and (<= 1 i@230@01) (< i@230@01 (+ (- (Seq_length ar@187@01) 1) 1)))
    (and
      (=>
        (<= 1 i@230@01)
        (and (<= 1 i@230@01) (< (- (Seq_length ar@187@01) 1) len@190@01)))
      (or (<= 1 i@230@01) (not (<= 1 i@230@01)))))
  :pattern ((Seq_index ar@187@01 i@230@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i1@230@01 Int) (i2@230@01 Int)) (!
  (=>
    (and
      (and (<= 1 i1@230@01) (< i1@230@01 (+ (- (Seq_length ar@187@01) 1) 1)))
      (and (<= 1 i2@230@01) (< i2@230@01 (+ (- (Seq_length ar@187@01) 1) 1)))
      (= (Seq_index ar@187@01 i1@230@01) (Seq_index ar@187@01 i2@230@01)))
    (= i1@230@01 i2@230@01))
...
(assert (forall ((i@230@01 Int)) (!
  (=>
    (and (<= 1 i@230@01) (< i@230@01 (+ (- (Seq_length ar@187@01) 1) 1)))
    (and
      (= (inv@231@01 (Seq_index ar@187@01 i@230@01)) i@230@01)
      (img@232@01 (Seq_index ar@187@01 i@230@01))))
  :pattern ((Seq_index ar@187@01 i@230@01))
  :qid |Ref__Integer_value-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (and
        (<= 1 (inv@231@01 r))
        (< (inv@231@01 r) (+ (- (Seq_length ar@187@01) 1) 1))))
    (= (Seq_index ar@187@01 (inv@231@01 r)) r))
  :pattern ((inv@231@01 r))
  :qid |Ref__Integer_value-fctOfInv|)))
(push) ; 4
(set-option :timeout 10)
(assert (not (forall ((i@230@01 Int)) (!
  (= (Seq_index ar@187@01 i@230@01) (Seq_index br@188@01 i@230@01))
...
(set-option :timeout 10)
(assert (not (forall ((i@230@01 Int)) (!
  (= (Seq_index ar@187@01 i@230@01) (Seq_index cr@189@01 i@230@01))
  ...
  (ite
    (and
      (and
        ...
        (< (inv@231@01 r) (+ (- (Seq_length ar@187@01) 1) 1)))
      (img@232@01 r)
      (= r (Seq_index ar@187@01 (inv@231@01 r))))
    ($Perm.min
      (ite
        (and
          (img@196@01 r)
          (and (<= 0 (inv@195@01 r)) (< (inv@195@01 r) len@190@01)))
        (- (- $Perm.Write (pTaken@222@01 r)) (pTaken@226@01 r))
        $Perm.No)
      (/ (to_real 1) (to_real 2)))
    $Perm.No))
  ...
  (=>
    (ite
      (and
        (img@196@01 r)
        (and (<= 0 (inv@195@01 r)) (< (inv@195@01 r) len@190@01)))
      (< $Perm.No (- (- $Perm.Write (pTaken@222@01 r)) (pTaken@226@01 r)))
      false)
    (=
      ($FVF.lookup_Ref__Integer_value (as sm@236@01  $FVF<Ref__Integer_value>) r)
      ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@191@01)))))) r)))
...
; [eval] 0 <= j
(push) ; 5
; [then-branch: 105 | !(0 <= j@237@01) | live]
; [else-branch: 105 | 0 <= j@237@01 | live]
(push) ; 6
; [then-branch: 105 | !(0 <= j@237@01)]
(assert (not (<= 0 j@237@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 105 | 0 <= j@237@01]
(assert (<= 0 j@237@01))
; [eval] j < |br|
; [eval] |br|
(push) ; 7
; [then-branch: 106 | !(j@237@01 < |br@188@01|) | live]
; [else-branch: 106 | j@237@01 < |br@188@01| | live]
(push) ; 8
; [then-branch: 106 | !(j@237@01 < |br@188@01|)]
(assert (not (< j@237@01 (Seq_length br@188@01))))
(pop) ; 8
(push) ; 8
; [else-branch: 106 | j@237@01 < |br@188@01|]
(assert (< j@237@01 (Seq_length br@188@01)))
; [eval] 0 <= k
(push) ; 9
; [then-branch: 107 | !(0 <= k@238@01) | live]
; [else-branch: 107 | 0 <= k@238@01 | live]
(push) ; 10
; [then-branch: 107 | !(0 <= k@238@01)]
(assert (not (<= 0 k@238@01)))
(pop) ; 10
(push) ; 10
; [else-branch: 107 | 0 <= k@238@01]
(assert (<= 0 k@238@01))
; [eval] k < |br|
; [eval] |br|
(push) ; 11
; [then-branch: 108 | !(k@238@01 < |br@188@01|) | live]
; [else-branch: 108 | k@238@01 < |br@188@01| | live]
(push) ; 12
; [then-branch: 108 | !(k@238@01 < |br@188@01|)]
(assert (not (< k@238@01 (Seq_length br@188@01))))
(pop) ; 12
(push) ; 12
; [else-branch: 108 | k@238@01 < |br@188@01|]
(assert (< k@238@01 (Seq_length br@188@01)))
; [eval] j != k
(pop) ; 12
(pop) ; 11
; Joined path conditions
; Joined path conditions
(assert (or
  (< k@238@01 (Seq_length br@188@01))
  (not (< k@238@01 (Seq_length br@188@01)))))
(pop) ; 10
(pop) ; 9
; Joined path conditions
; Joined path conditions
...
(assert (or
  (< j@237@01 (Seq_length br@188@01))
  (not (< j@237@01 (Seq_length br@188@01)))))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (and
    ...
    (or
      (< j@237@01 (Seq_length br@188@01))
      (not (< j@237@01 (Seq_length br@188@01)))))))
(assert (or (<= 0 j@237@01) (not (<= 0 j@237@01))))
(push) ; 5
; [then-branch: 109 | 0 <= j@237@01 && j@237@01 < |br@188@01| && 0 <= k@238@01 && k@238@01 < |br@188@01| && j@237@01 != k@238@01 | live]
; [else-branch: 109 | !(0 <= j@237@01 && j@237@01 < |br@188@01| && 0 <= k@238@01 && k@238@01 < |br@188@01| && j@237@01 != k@238@01) | live]
(push) ; 6
; [then-branch: 109 | 0 <= j@237@01 && j@237@01 < |br@188@01| && 0 <= k@238@01 && k@238@01 < |br@188@01| && j@237@01 != k@238@01]
(assert (and
  (<= 0 j@237@01)
  (and
    (< j@237@01 (Seq_length br@188@01))
    (and
      (<= 0 k@238@01)
      (and (< k@238@01 (Seq_length br@188@01)) (not (= j@237@01 k@238@01)))))))
; [eval] br[j] != br[k]
; [eval] br[j]
(push) ; 7
(assert (not (>= j@237@01 0)))
(check-sat)
; unsat
(pop) ; 7
; 0,00s
...
(pop) ; 6
(push) ; 6
; [else-branch: 109 | !(0 <= j@237@01 && j@237@01 < |br@188@01| && 0 <= k@238@01 && k@238@01 < |br@188@01| && j@237@01 != k@238@01)]
(assert (not
  (and
    (<= 0 j@237@01)
    (and
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((j@237@01 Int) (k@238@01 Int)) (!
  (and
    (=>
      (<= 0 j@237@01)
      (and
      ...
      (and
        ...
        (and
          ...
          (and
            (<= 0 k@238@01)
            (and (< k@238@01 (Seq_length br@188@01)) (not (= j@237@01 k@238@01))))))))
  :pattern ((Seq_index br@188@01 j@237@01) (Seq_index br@188@01 k@238@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testDepParLoopBack.vpr@67@12@67@106-aux|)))
(push) ; 4
(assert (not (forall ((j@237@01 Int) (k@238@01 Int)) (!
  (=>
    (and
      (<= 0 j@237@01)
      (and
        ...
        (and
          (<= 0 k@238@01)
          (and (< k@238@01 (Seq_length br@188@01)) (not (= j@237@01 k@238@01))))))
    (not (= (Seq_index br@188@01 j@237@01) (Seq_index br@188@01 k@238@01))))
  :pattern ((Seq_index br@188@01 j@237@01) (Seq_index br@188@01 k@238@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testDepParLoopBack.vpr@67@12@67@106|))))
(check-sat)
; unsat
...
; [eval] 0 <= i
(push) ; 5
; [then-branch: 110 | !(0 <= i@239@01) | live]
; [else-branch: 110 | 0 <= i@239@01 | live]
(push) ; 6
; [then-branch: 110 | !(0 <= i@239@01)]
(assert (not (<= 0 i@239@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 110 | 0 <= i@239@01]
(assert (<= 0 i@239@01))
; [eval] i < len
(pop) ; 6
(pop) ; 5
...
(assert (and (<= 0 i@239@01) (< i@239@01 len@190@01)))
; [eval] br[i]
(push) ; 5
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i@239@01 (Seq_length br@188@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
(assert (forall ((i@239@01 Int)) (!
  (=>
    (and (<= 0 i@239@01) (< i@239@01 len@190@01))
    (or (<= 0 i@239@01) (not (<= 0 i@239@01))))
  :pattern ((Seq_index br@188@01 i@239@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i1@239@01 Int) (i2@239@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@239@01) (< i1@239@01 len@190@01))
      (and (<= 0 i2@239@01) (< i2@239@01 len@190@01))
      (= (Seq_index br@188@01 i1@239@01) (Seq_index br@188@01 i2@239@01)))
    (= i1@239@01 i2@239@01))
...
(assert (forall ((i@239@01 Int)) (!
  (=>
    (and (<= 0 i@239@01) (< i@239@01 len@190@01))
    (and
      (= (inv@240@01 (Seq_index br@188@01 i@239@01)) i@239@01)
      (img@241@01 (Seq_index br@188@01 i@239@01))))
  :pattern ((Seq_index br@188@01 i@239@01))
  :qid |Ref__Integer_value-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@241@01 r)
      (and (<= 0 (inv@240@01 r)) (< (inv@240@01 r) len@190@01)))
    (= (Seq_index br@188@01 (inv@240@01 r)) r))
  :pattern ((inv@240@01 r))
  :qid |Ref__Integer_value-fctOfInv|)))
(push) ; 4
(set-option :timeout 10)
(assert (not (forall ((i@239@01 Int)) (!
  (= (Seq_index br@188@01 i@239@01) (Seq_index cr@189@01 i@239@01))
...
(define-fun pTaken@242@01 ((r $Ref)) $Perm
  (ite
    (and
      (and (<= 0 (inv@240@01 r)) (< (inv@240@01 r) len@190@01))
      (img@241@01 r)
      (= r (Seq_index br@188@01 (inv@240@01 r))))
    ($Perm.min
      (ite
        (and
          (img@201@01 r)
...
(declare-const k@246@01 Int)
(push) ; 4
; [eval] 0 <= j && (j < |cr| && (0 <= k && (k < |cr| && j != k))) ==> cr[j] != cr[k]
; [eval] 0 <= j && (j < |cr| && (0 <= k && (k < |cr| && j != k)))
; [eval] 0 <= j
(push) ; 5
; [then-branch: 112 | !(0 <= j@245@01) | live]
; [else-branch: 112 | 0 <= j@245@01 | live]
(push) ; 6
; [then-branch: 112 | !(0 <= j@245@01)]
(assert (not (<= 0 j@245@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 112 | 0 <= j@245@01]
(assert (<= 0 j@245@01))
; [eval] j < |cr|
; [eval] |cr|
(push) ; 7
; [then-branch: 113 | !(j@245@01 < |cr@189@01|) | live]
; [else-branch: 113 | j@245@01 < |cr@189@01| | live]
(push) ; 8
; [then-branch: 113 | !(j@245@01 < |cr@189@01|)]
(assert (not (< j@245@01 (Seq_length cr@189@01))))
(pop) ; 8
(push) ; 8
; [else-branch: 113 | j@245@01 < |cr@189@01|]
(assert (< j@245@01 (Seq_length cr@189@01)))
; [eval] 0 <= k
(push) ; 9
; [then-branch: 114 | !(0 <= k@246@01) | live]
; [else-branch: 114 | 0 <= k@246@01 | live]
(push) ; 10
; [then-branch: 114 | !(0 <= k@246@01)]
(assert (not (<= 0 k@246@01)))
(pop) ; 10
(push) ; 10
; [else-branch: 114 | 0 <= k@246@01]
(assert (<= 0 k@246@01))
; [eval] k < |cr|
; [eval] |cr|
(push) ; 11
; [then-branch: 115 | !(k@246@01 < |cr@189@01|) | live]
; [else-branch: 115 | k@246@01 < |cr@189@01| | live]
(push) ; 12
; [then-branch: 115 | !(k@246@01 < |cr@189@01|)]
(assert (not (< k@246@01 (Seq_length cr@189@01))))
(pop) ; 12
(push) ; 12
; [else-branch: 115 | k@246@01 < |cr@189@01|]
(assert (< k@246@01 (Seq_length cr@189@01)))
; [eval] j != k
(pop) ; 12
(pop) ; 11
; Joined path conditions
; Joined path conditions
(assert (or
  (< k@246@01 (Seq_length cr@189@01))
  (not (< k@246@01 (Seq_length cr@189@01)))))
(pop) ; 10
(pop) ; 9
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (and
    ...
    (or
      (< k@246@01 (Seq_length cr@189@01))
      (not (< k@246@01 (Seq_length cr@189@01)))))))
(assert (or (<= 0 k@246@01) (not (<= 0 k@246@01))))
(pop) ; 8
(pop) ; 7
; Joined path conditions
; Joined path conditions
(assert (=>
  (< j@245@01 (Seq_length cr@189@01))
  (and
    (< j@245@01 (Seq_length cr@189@01))
    (=>
      (<= 0 k@246@01)
      (and
        ...
        (or
          (< k@246@01 (Seq_length cr@189@01))
          (not (< k@246@01 (Seq_length cr@189@01))))))
    (or (<= 0 k@246@01) (not (<= 0 k@246@01))))))
(assert (or
  (< j@245@01 (Seq_length cr@189@01))
  (not (< j@245@01 (Seq_length cr@189@01)))))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (and
    ...
    (or
      (< j@245@01 (Seq_length cr@189@01))
      (not (< j@245@01 (Seq_length cr@189@01)))))))
(assert (or (<= 0 j@245@01) (not (<= 0 j@245@01))))
(push) ; 5
; [then-branch: 116 | 0 <= j@245@01 && j@245@01 < |cr@189@01| && 0 <= k@246@01 && k@246@01 < |cr@189@01| && j@245@01 != k@246@01 | live]
; [else-branch: 116 | !(0 <= j@245@01 && j@245@01 < |cr@189@01| && 0 <= k@246@01 && k@246@01 < |cr@189@01| && j@245@01 != k@246@01) | live]
(push) ; 6
; [then-branch: 116 | 0 <= j@245@01 && j@245@01 < |cr@189@01| && 0 <= k@246@01 && k@246@01 < |cr@189@01| && j@245@01 != k@246@01]
(assert (and
  (<= 0 j@245@01)
  (and
    (< j@245@01 (Seq_length cr@189@01))
    (and
      (<= 0 k@246@01)
      (and (< k@246@01 (Seq_length cr@189@01)) (not (= j@245@01 k@246@01)))))))
; [eval] cr[j] != cr[k]
; [eval] cr[j]
(push) ; 7
...
(pop) ; 6
(push) ; 6
; [else-branch: 116 | !(0 <= j@245@01 && j@245@01 < |cr@189@01| && 0 <= k@246@01 && k@246@01 < |cr@189@01| && j@245@01 != k@246@01)]
(assert (not
  (and
    (<= 0 j@245@01)
    (and
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((j@245@01 Int) (k@246@01 Int)) (!
  (and
    (=>
      (<= 0 j@245@01)
      (and
      ...
      (and
        ...
        (and
          ...
          (and
            (<= 0 k@246@01)
            (and (< k@246@01 (Seq_length cr@189@01)) (not (= j@245@01 k@246@01))))))))
  :pattern ((Seq_index cr@189@01 j@245@01) (Seq_index cr@189@01 k@246@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testDepParLoopBack.vpr@70@12@70@106-aux|)))
(push) ; 4
(assert (not (forall ((j@245@01 Int) (k@246@01 Int)) (!
  (=>
    (and
      (<= 0 j@245@01)
      (and
        ...
        (and
          (<= 0 k@246@01)
          (and (< k@246@01 (Seq_length cr@189@01)) (not (= j@245@01 k@246@01))))))
    (not (= (Seq_index cr@189@01 j@245@01) (Seq_index cr@189@01 k@246@01))))
  :pattern ((Seq_index cr@189@01 j@245@01) (Seq_index cr@189@01 k@246@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testDepParLoopBack.vpr@70@12@70@106|))))
(check-sat)
; unsat
...
; [eval] 0 <= i
(push) ; 5
; [then-branch: 117 | !(0 <= i@247@01) | live]
; [else-branch: 117 | 0 <= i@247@01 | live]
(push) ; 6
; [then-branch: 117 | !(0 <= i@247@01)]
(assert (not (<= 0 i@247@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 117 | 0 <= i@247@01]
(assert (<= 0 i@247@01))
; [eval] i < len
(pop) ; 6
(pop) ; 5
...
(assert (and (<= 0 i@247@01) (< i@247@01 len@190@01)))
; [eval] cr[i]
(push) ; 5
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i@247@01 (Seq_length cr@189@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
(assert (forall ((i@247@01 Int)) (!
  (=>
    (and (<= 0 i@247@01) (< i@247@01 len@190@01))
    (or (<= 0 i@247@01) (not (<= 0 i@247@01))))
  :pattern ((Seq_index cr@189@01 i@247@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i1@247@01 Int) (i2@247@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@247@01) (< i1@247@01 len@190@01))
      (and (<= 0 i2@247@01) (< i2@247@01 len@190@01))
      (= (Seq_index cr@189@01 i1@247@01) (Seq_index cr@189@01 i2@247@01)))
    (= i1@247@01 i2@247@01))
...
(assert (forall ((i@247@01 Int)) (!
  (=>
    (and (<= 0 i@247@01) (< i@247@01 len@190@01))
    (and
      (= (inv@248@01 (Seq_index cr@189@01 i@247@01)) i@247@01)
      (img@249@01 (Seq_index cr@189@01 i@247@01))))
  :pattern ((Seq_index cr@189@01 i@247@01))
  :qid |Ref__Integer_value-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@249@01 r)
      (and (<= 0 (inv@248@01 r)) (< (inv@248@01 r) len@190@01)))
    (= (Seq_index cr@189@01 (inv@248@01 r)) r))
...
(define-fun pTaken@250@01 ((r $Ref)) $Perm
  (ite
    (and
      (and (<= 0 (inv@248@01 r)) (< (inv@248@01 r) len@190@01))
      (img@249@01 r)
      (= r (Seq_index cr@189@01 (inv@248@01 r))))
    ($Perm.min
      (ite
        (and
          (img@206@01 r)
...
; [eval] 0 <= i
(push) ; 5
; [then-branch: 119 | !(0 <= i@253@01) | live]
; [else-branch: 119 | 0 <= i@253@01 | live]
(push) ; 6
; [then-branch: 119 | !(0 <= i@253@01)]
(assert (not (<= 0 i@253@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 119 | 0 <= i@253@01]
(assert (<= 0 i@253@01))
; [eval] i < len
(pop) ; 6
(pop) ; 5
...
(assert (and (<= 0 i@253@01) (< i@253@01 len@190@01)))
; [eval] ar[i]
(push) ; 5
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i@253@01 (Seq_length ar@187@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
(assert (forall ((i@253@01 Int)) (!
  (=>
    (and (<= 0 i@253@01) (< i@253@01 len@190@01))
    (or (<= 0 i@253@01) (not (<= 0 i@253@01))))
  :pattern ((Seq_index ar@187@01 i@253@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i1@253@01 Int) (i2@253@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@253@01) (< i1@253@01 len@190@01))
      (and (<= 0 i2@253@01) (< i2@253@01 len@190@01))
      (= (Seq_index ar@187@01 i1@253@01) (Seq_index ar@187@01 i2@253@01)))
    (= i1@253@01 i2@253@01))
...
(assert (forall ((i@253@01 Int)) (!
  (=>
    (and (<= 0 i@253@01) (< i@253@01 len@190@01))
    (and
      (= (inv@254@01 (Seq_index ar@187@01 i@253@01)) i@253@01)
      (img@255@01 (Seq_index ar@187@01 i@253@01))))
  :pattern ((Seq_index ar@187@01 i@253@01))
  :qid |quant-u-137|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@255@01 r)
      (and (<= 0 (inv@254@01 r)) (< (inv@254@01 r) len@190@01)))
    (= (Seq_index ar@187@01 (inv@254@01 r)) r))
...
(assert (forall ((i@253@01 Int)) (!
  (=>
    (and (<= 0 i@253@01) (< i@253@01 len@190@01))
    (not (= (Seq_index ar@187@01 i@253@01) $Ref.null)))
  :pattern ((Seq_index ar@187@01 i@253@01))
  :qid |Ref__Integer_value-permImpliesNonNull|)))
(assert (=
  ($Snap.second ($Snap.second $t@252@01))
...
; [eval] 0 <= i
(push) ; 5
; [then-branch: 121 | !(0 <= i@256@01) | live]
; [else-branch: 121 | 0 <= i@256@01 | live]
(push) ; 6
; [then-branch: 121 | !(0 <= i@256@01)]
(assert (not (<= 0 i@256@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 121 | 0 <= i@256@01]
(assert (<= 0 i@256@01))
; [eval] i < len
(pop) ; 6
(pop) ; 5
...
(assert (and (<= 0 i@256@01) (< i@256@01 len@190@01)))
; [eval] br[i]
(push) ; 5
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i@256@01 (Seq_length br@188@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
(assert (forall ((i@256@01 Int)) (!
  (=>
    (and (<= 0 i@256@01) (< i@256@01 len@190@01))
    (or (<= 0 i@256@01) (not (<= 0 i@256@01))))
  :pattern ((Seq_index br@188@01 i@256@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i1@256@01 Int) (i2@256@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@256@01) (< i1@256@01 len@190@01))
      (and (<= 0 i2@256@01) (< i2@256@01 len@190@01))
      (= (Seq_index br@188@01 i1@256@01) (Seq_index br@188@01 i2@256@01)))
    (= i1@256@01 i2@256@01))
...
(assert (forall ((i@256@01 Int)) (!
  (=>
    (and (<= 0 i@256@01) (< i@256@01 len@190@01))
    (and
      (= (inv@257@01 (Seq_index br@188@01 i@256@01)) i@256@01)
      (img@258@01 (Seq_index br@188@01 i@256@01))))
  :pattern ((Seq_index br@188@01 i@256@01))
  :qid |quant-u-139|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@258@01 r)
      (and (<= 0 (inv@257@01 r)) (< (inv@257@01 r) len@190@01)))
    (= (Seq_index br@188@01 (inv@257@01 r)) r))
...
(assert (forall ((i@256@01 Int)) (!
  (=>
    (and (<= 0 i@256@01) (< i@256@01 len@190@01))
    (not (= (Seq_index br@188@01 i@256@01) $Ref.null)))
  :pattern ((Seq_index br@188@01 i@256@01))
  :qid |Ref__Integer_value-permImpliesNonNull|)))
(push) ; 4
(set-option :timeout 10)
(assert (not (forall ((r $Ref)) (!
  (and
    (= (Seq_index br@188@01 i@256@01) (Seq_index ar@187@01 i@253@01))
    (=
      (and
        (img@258@01 r)
        (and (<= 0 (inv@257@01 r)) (< (inv@257@01 r) len@190@01)))
...
; [eval] 0 <= i
(push) ; 5
; [then-branch: 123 | !(0 <= i@259@01) | live]
; [else-branch: 123 | 0 <= i@259@01 | live]
(push) ; 6
; [then-branch: 123 | !(0 <= i@259@01)]
(assert (not (<= 0 i@259@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 123 | 0 <= i@259@01]
(assert (<= 0 i@259@01))
; [eval] i < len
(pop) ; 6
(pop) ; 5
...
(assert (and (<= 0 i@259@01) (< i@259@01 len@190@01)))
; [eval] cr[i]
(push) ; 5
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i@259@01 (Seq_length cr@189@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
(assert (forall ((i@259@01 Int)) (!
  (=>
    (and (<= 0 i@259@01) (< i@259@01 len@190@01))
    (or (<= 0 i@259@01) (not (<= 0 i@259@01))))
  :pattern ((Seq_index cr@189@01 i@259@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i1@259@01 Int) (i2@259@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@259@01) (< i1@259@01 len@190@01))
      (and (<= 0 i2@259@01) (< i2@259@01 len@190@01))
      (= (Seq_index cr@189@01 i1@259@01) (Seq_index cr@189@01 i2@259@01)))
    (= i1@259@01 i2@259@01))
...
(assert (forall ((i@259@01 Int)) (!
  (=>
    (and (<= 0 i@259@01) (< i@259@01 len@190@01))
    (and
      (= (inv@260@01 (Seq_index cr@189@01 i@259@01)) i@259@01)
      (img@261@01 (Seq_index cr@189@01 i@259@01))))
  :pattern ((Seq_index cr@189@01 i@259@01))
  :qid |quant-u-142|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@261@01 r)
      (and (<= 0 (inv@260@01 r)) (< (inv@260@01 r) len@190@01)))
    (= (Seq_index cr@189@01 (inv@260@01 r)) r))
...
(assert (forall ((i@259@01 Int)) (!
  (=>
    (and (<= 0 i@259@01) (< i@259@01 len@190@01))
    (not (= (Seq_index cr@189@01 i@259@01) $Ref.null)))
  :pattern ((Seq_index cr@189@01 i@259@01))
  :qid |Ref__Integer_value-permImpliesNonNull|)))
(push) ; 4
(set-option :timeout 10)
(assert (not (forall ((r $Ref)) (!
  (and
    (= (Seq_index cr@189@01 i@259@01) (Seq_index br@188@01 i@256@01))
    (=
      (and
        (img@261@01 r)
        (and (<= 0 (inv@260@01 r)) (< (inv@260@01 r) len@190@01)))
...
(assert (not (forall ((r $Ref)) (!
  (and
    (= (Seq_index cr@189@01 i@259@01) (Seq_index ar@187@01 i@253@01))
    (=
      (and
        (img@261@01 r)
        (and (<= 0 (inv@260@01 r)) (< (inv@260@01 r) len@190@01)))
...
; [eval] 0 <= i
(push) ; 5
; [then-branch: 124 | !(0 <= i@262@01) | live]
; [else-branch: 124 | 0 <= i@262@01 | live]
(push) ; 6
; [then-branch: 124 | !(0 <= i@262@01)]
(assert (not (<= 0 i@262@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 124 | 0 <= i@262@01]
(assert (<= 0 i@262@01))
; [eval] i < len
(pop) ; 6
(pop) ; 5
...
(assert (and (<= 0 i@262@01) (< i@262@01 len@190@01)))
; [eval] ar[i]
(push) ; 5
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i@262@01 (Seq_length ar@187@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
(assert (forall ((i@262@01 Int)) (!
  (=>
    (and (<= 0 i@262@01) (< i@262@01 len@190@01))
    (or (<= 0 i@262@01) (not (<= 0 i@262@01))))
  :pattern ((Seq_index ar@187@01 i@262@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i1@262@01 Int) (i2@262@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@262@01) (< i1@262@01 len@190@01))
      (and (<= 0 i2@262@01) (< i2@262@01 len@190@01))
      (= (Seq_index ar@187@01 i1@262@01) (Seq_index ar@187@01 i2@262@01)))
    (= i1@262@01 i2@262@01))
...
(assert (forall ((i@262@01 Int)) (!
  (=>
    (and (<= 0 i@262@01) (< i@262@01 len@190@01))
    (and
      (= (inv@263@01 (Seq_index ar@187@01 i@262@01)) i@262@01)
      (img@264@01 (Seq_index ar@187@01 i@262@01))))
  :pattern ((Seq_index ar@187@01 i@262@01))
  :qid |Ref__Integer_value-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@264@01 r)
      (and (<= 0 (inv@263@01 r)) (< (inv@263@01 r) len@190@01)))
    (= (Seq_index ar@187@01 (inv@263@01 r)) r))
  :pattern ((inv@263@01 r))
  :qid |Ref__Integer_value-fctOfInv|)))
(push) ; 4
(set-option :timeout 10)
(assert (not (forall ((i@262@01 Int)) (!
  (= (Seq_index ar@187@01 i@262@01) (Seq_index br@188@01 i@262@01))
...
(set-option :timeout 10)
(assert (not (forall ((i@262@01 Int)) (!
  (= (Seq_index ar@187@01 i@262@01) (Seq_index cr@189@01 i@262@01))
...
(define-fun pTaken@265@01 ((r $Ref)) $Perm
  (ite
    (and
      (and (<= 0 (inv@263@01 r)) (< (inv@263@01 r) len@190@01))
      (img@264@01 r)
      (= r (Seq_index ar@187@01 (inv@263@01 r))))
    ($Perm.min
      (ite
        (and
          (img@255@01 r)
  ...
  (ite
    ...
    ($Perm.min
      (ite
        ...
        $Perm.Write
        $Perm.No)
      (- (- $Perm.Write (pTaken@265@01 r)) (pTaken@266@01 r)))
    $Perm.No))
; Done precomputing, updating quantified chunks
; State saturation: before repetition
(check-sat)
...
; Final check if taken enough permissions
; Done removing quantified permissions
(declare-const sm@268@01 $FVF<Ref__Integer_value>)
; Definitional axioms for snapshot map values
(assert (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (and (<= 0 (inv@254@01 r)) (< (inv@254@01 r) len@190@01)))
    (=
      ($FVF.lookup_Ref__Integer_value (as sm@268@01  $FVF<Ref__Integer_value>) r)
      ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first ($Snap.second $t@252@01))) r)))
  :pattern (($FVF.lookup_Ref__Integer_value (as sm@268@01  $FVF<Ref__Integer_value>) r))
  :pattern (($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first ($Snap.second $t@252@01))) r))
  :qid |qp.fvfValDef12|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
    ...
    (=
      ($FVF.lookup_Ref__Integer_value (as sm@268@01  $FVF<Ref__Integer_value>) r)
      ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@252@01))))) r)))
  :pattern (($FVF.lookup_Ref__Integer_value (as sm@268@01  $FVF<Ref__Integer_value>) r))
  :pattern (($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@252@01))))) r))
  :qid |qp.fvfValDef13|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
    ...
    (=
      ($FVF.lookup_Ref__Integer_value (as sm@268@01  $FVF<Ref__Integer_value>) r)
      ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@252@01)))))) r)))
  :pattern (($FVF.lookup_Ref__Integer_value (as sm@268@01  $FVF<Ref__Integer_value>) r))
  :pattern (($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@252@01)))))) r))
  :qid |qp.fvfValDef14|)))
; [eval] |br| == len
; [eval] |br|
...
; [eval] 0 <= i
(push) ; 5
; [then-branch: 125 | !(0 <= i@269@01) | live]
; [else-branch: 125 | 0 <= i@269@01 | live]
(push) ; 6
; [then-branch: 125 | !(0 <= i@269@01)]
(assert (not (<= 0 i@269@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 125 | 0 <= i@269@01]
(assert (<= 0 i@269@01))
; [eval] i < len
(pop) ; 6
(pop) ; 5
...
(assert (and (<= 0 i@269@01) (< i@269@01 len@190@01)))
; [eval] br[i]
(push) ; 5
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i@269@01 (Seq_length br@188@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
(assert (forall ((i@269@01 Int)) (!
  (=>
    (and (<= 0 i@269@01) (< i@269@01 len@190@01))
    (or (<= 0 i@269@01) (not (<= 0 i@269@01))))
  :pattern ((Seq_index br@188@01 i@269@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i1@269@01 Int) (i2@269@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@269@01) (< i1@269@01 len@190@01))
      (and (<= 0 i2@269@01) (< i2@269@01 len@190@01))
      (= (Seq_index br@188@01 i1@269@01) (Seq_index br@188@01 i2@269@01)))
    (= i1@269@01 i2@269@01))
...
(assert (forall ((i@269@01 Int)) (!
  (=>
    (and (<= 0 i@269@01) (< i@269@01 len@190@01))
    (and
      (= (inv@270@01 (Seq_index br@188@01 i@269@01)) i@269@01)
      (img@271@01 (Seq_index br@188@01 i@269@01))))
  :pattern ((Seq_index br@188@01 i@269@01))
  :qid |Ref__Integer_value-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@271@01 r)
      (and (<= 0 (inv@270@01 r)) (< (inv@270@01 r) len@190@01)))
    (= (Seq_index br@188@01 (inv@270@01 r)) r))
  :pattern ((inv@270@01 r))
  :qid |Ref__Integer_value-fctOfInv|)))
(push) ; 4
(set-option :timeout 10)
(assert (not (forall ((i@269@01 Int)) (!
  (= (Seq_index br@188@01 i@269@01) (Seq_index cr@189@01 i@269@01))
...
(define-fun pTaken@272@01 ((r $Ref)) $Perm
  (ite
    (and
      (and (<= 0 (inv@270@01 r)) (< (inv@270@01 r) len@190@01))
      (img@271@01 r)
      (= r (Seq_index br@188@01 (inv@270@01 r))))
    ($Perm.min
      (ite
        (and
          (img@258@01 r)
  ...
  (ite
    ...
    ($Perm.min
      (ite
        ...
        $Perm.Write
        $Perm.No)
      (- (/ (to_real 1) (to_real 2)) (pTaken@272@01 r)))
    $Perm.No))
; Done precomputing, updating quantified chunks
; State saturation: before repetition
(check-sat)
...
; [eval] 0 <= i
(push) ; 5
; [then-branch: 126 | !(0 <= i@275@01) | live]
; [else-branch: 126 | 0 <= i@275@01 | live]
(push) ; 6
; [then-branch: 126 | !(0 <= i@275@01)]
(assert (not (<= 0 i@275@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 126 | 0 <= i@275@01]
(assert (<= 0 i@275@01))
; [eval] i < len
(pop) ; 6
(pop) ; 5
...
(assert (and (<= 0 i@275@01) (< i@275@01 len@190@01)))
; [eval] cr[i]
(push) ; 5
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i@275@01 (Seq_length cr@189@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
(assert (forall ((i@275@01 Int)) (!
  (=>
    (and (<= 0 i@275@01) (< i@275@01 len@190@01))
    (or (<= 0 i@275@01) (not (<= 0 i@275@01))))
  :pattern ((Seq_index cr@189@01 i@275@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i1@275@01 Int) (i2@275@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@275@01) (< i1@275@01 len@190@01))
      (and (<= 0 i2@275@01) (< i2@275@01 len@190@01))
      (= (Seq_index cr@189@01 i1@275@01) (Seq_index cr@189@01 i2@275@01)))
    (= i1@275@01 i2@275@01))
...
(assert (forall ((i@275@01 Int)) (!
  (=>
    (and (<= 0 i@275@01) (< i@275@01 len@190@01))
    (and
      (= (inv@276@01 (Seq_index cr@189@01 i@275@01)) i@275@01)
      (img@277@01 (Seq_index cr@189@01 i@275@01))))
  :pattern ((Seq_index cr@189@01 i@275@01))
  :qid |Ref__Integer_value-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@277@01 r)
      (and (<= 0 (inv@276@01 r)) (< (inv@276@01 r) len@190@01)))
    (= (Seq_index cr@189@01 (inv@276@01 r)) r))
...
(define-fun pTaken@278@01 ((r $Ref)) $Perm
  (ite
    (and
      (and (<= 0 (inv@276@01 r)) (< (inv@276@01 r) len@190@01))
      (img@277@01 r)
      (= r (Seq_index cr@189@01 (inv@276@01 r))))
    ($Perm.min
      (ite
        (and
          (img@261@01 r)
...
; [eval] 1 <= i
(push) ; 5
; [then-branch: 127 | !(1 <= i@280@01) | live]
; [else-branch: 127 | 1 <= i@280@01 | live]
(push) ; 6
; [then-branch: 127 | !(1 <= i@280@01)]
(assert (not (<= 1 i@280@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 127 | 1 <= i@280@01]
(assert (<= 1 i@280@01))
; [eval] i < (|ar| - 1 < len ? |ar| - 1 : len) + 1
; [eval] (|ar| - 1 < len ? |ar| - 1 : len) + 1
; [eval] (|ar| - 1 < len ? |ar| - 1 : len)
...
(assert (=>
  (<= 1 i@280@01)
  (and (<= 1 i@280@01) (< (- (Seq_length ar@187@01) 1) len@190@01))))
(assert (or (<= 1 i@280@01) (not (<= 1 i@280@01))))
(assert (and (<= 1 i@280@01) (< i@280@01 (+ (- (Seq_length ar@187@01) 1) 1))))
; [eval] ar[i]
(push) ; 5
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i@280@01 (Seq_length ar@187@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
(assert (forall ((i@280@01 Int)) (!
  (=>
    (and (<= 1 i@280@01) (< i@280@01 (+ (- (Seq_length ar@187@01) 1) 1)))
    (and
      (=>
        (<= 1 i@280@01)
        (and (<= 1 i@280@01) (< (- (Seq_length ar@187@01) 1) len@190@01)))
      (or (<= 1 i@280@01) (not (<= 1 i@280@01)))))
  :pattern ((Seq_index ar@187@01 i@280@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i1@280@01 Int) (i2@280@01 Int)) (!
  (=>
    (and
      (and (<= 1 i1@280@01) (< i1@280@01 (+ (- (Seq_length ar@187@01) 1) 1)))
      (and (<= 1 i2@280@01) (< i2@280@01 (+ (- (Seq_length ar@187@01) 1) 1)))
      (= (Seq_index ar@187@01 i1@280@01) (Seq_index ar@187@01 i2@280@01)))
    (= i1@280@01 i2@280@01))
...
(assert (forall ((i@280@01 Int)) (!
  (=>
    (and (<= 1 i@280@01) (< i@280@01 (+ (- (Seq_length ar@187@01) 1) 1)))
    (and
      (= (inv@281@01 (Seq_index ar@187@01 i@280@01)) i@280@01)
      (img@282@01 (Seq_index ar@187@01 i@280@01))))
  :pattern ((Seq_index ar@187@01 i@280@01))
  :qid |Ref__Integer_value-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (and
        (<= 1 (inv@281@01 r))
        (< (inv@281@01 r) (+ (- (Seq_length ar@187@01) 1) 1))))
    (= (Seq_index ar@187@01 (inv@281@01 r)) r))
  :pattern ((inv@281@01 r))
  :qid |Ref__Integer_value-fctOfInv|)))
(push) ; 4
(set-option :timeout 10)
(assert (not (forall ((i@280@01 Int)) (!
  (= (Seq_index ar@187@01 i@280@01) (Seq_index cr@189@01 i@280@01))
...
(set-option :timeout 10)
(assert (not (forall ((i@280@01 Int)) (!
  (= (Seq_index ar@187@01 i@280@01) (Seq_index br@188@01 i@280@01))
  ...
  (ite
    (and
      (and
        ...
        (< (inv@281@01 r) (+ (- (Seq_length ar@187@01) 1) 1)))
      (img@282@01 r)
      (= r (Seq_index ar@187@01 (inv@281@01 r))))
    ($Perm.min
      (ite
        (and
          (img@206@01 r)
  ...
  (ite
    ...
    ($Perm.min
      (ite
        ...
        (- $Perm.Write (pTaken@222@01 r))
        $Perm.No)
      (- (- (/ (to_real 1) (to_real 2)) (pTaken@283@01 r)) (pTaken@284@01 r)))
    $Perm.No))
; Done precomputing, updating quantified chunks
; State saturation: before repetition
(check-sat)
...
; Joined path conditions
; [eval] (forall j: Int, k: Int :: { br[j], br[k] } 0 <= j && (j < |br| && (0 <= k && (k < |br| && j != k))) ==> br[j] != br[k])
(declare-const j@287@01 Int)
(declare-const k@288@01 Int)
(push) ; 4
; [eval] 0 <= j && (j < |br| && (0 <= k && (k < |br| && j != k))) ==> br[j] != br[k]
; [eval] 0 <= j && (j < |br| && (0 <= k && (k < |br| && j != k)))
; [eval] 0 <= j
(push) ; 5
; [then-branch: 130 | !(0 <= j@287@01) | live]
; [else-branch: 130 | 0 <= j@287@01 | live]
(push) ; 6
; [then-branch: 130 | !(0 <= j@287@01)]
(assert (not (<= 0 j@287@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 130 | 0 <= j@287@01]
(assert (<= 0 j@287@01))
; [eval] j < |br|
; [eval] |br|
(push) ; 7
; [then-branch: 131 | !(j@287@01 < |br@188@01|) | live]
; [else-branch: 131 | j@287@01 < |br@188@01| | live]
(push) ; 8
; [then-branch: 131 | !(j@287@01 < |br@188@01|)]
(assert (not (< j@287@01 (Seq_length br@188@01))))
(pop) ; 8
(push) ; 8
; [else-branch: 131 | j@287@01 < |br@188@01|]
(assert (< j@287@01 (Seq_length br@188@01)))
; [eval] 0 <= k
(push) ; 9
; [then-branch: 132 | !(0 <= k@288@01) | live]
; [else-branch: 132 | 0 <= k@288@01 | live]
(push) ; 10
; [then-branch: 132 | !(0 <= k@288@01)]
(assert (not (<= 0 k@288@01)))
(pop) ; 10
(push) ; 10
; [else-branch: 132 | 0 <= k@288@01]
(assert (<= 0 k@288@01))
; [eval] k < |br|
; [eval] |br|
(push) ; 11
; [then-branch: 133 | !(k@288@01 < |br@188@01|) | live]
; [else-branch: 133 | k@288@01 < |br@188@01| | live]
(push) ; 12
; [then-branch: 133 | !(k@288@01 < |br@188@01|)]
(assert (not (< k@288@01 (Seq_length br@188@01))))
(pop) ; 12
(push) ; 12
; [else-branch: 133 | k@288@01 < |br@188@01|]
(assert (< k@288@01 (Seq_length br@188@01)))
; [eval] j != k
(pop) ; 12
(pop) ; 11
; Joined path conditions
; Joined path conditions
(assert (or
  (< k@288@01 (Seq_length br@188@01))
  (not (< k@288@01 (Seq_length br@188@01)))))
(pop) ; 10
(pop) ; 9
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (and
    ...
    (or
      (< k@288@01 (Seq_length br@188@01))
      (not (< k@288@01 (Seq_length br@188@01)))))))
(assert (or (<= 0 k@288@01) (not (<= 0 k@288@01))))
(pop) ; 8
(pop) ; 7
; Joined path conditions
; Joined path conditions
(assert (=>
  (< j@287@01 (Seq_length br@188@01))
  (and
    (< j@287@01 (Seq_length br@188@01))
    (=>
      (<= 0 k@288@01)
      (and
        ...
        (or
          (< k@288@01 (Seq_length br@188@01))
          (not (< k@288@01 (Seq_length br@188@01))))))
    (or (<= 0 k@288@01) (not (<= 0 k@288@01))))))
(assert (or
  (< j@287@01 (Seq_length br@188@01))
  (not (< j@287@01 (Seq_length br@188@01)))))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (and
    ...
    (or
      (< j@287@01 (Seq_length br@188@01))
      (not (< j@287@01 (Seq_length br@188@01)))))))
(assert (or (<= 0 j@287@01) (not (<= 0 j@287@01))))
(push) ; 5
; [then-branch: 134 | 0 <= j@287@01 && j@287@01 < |br@188@01| && 0 <= k@288@01 && k@288@01 < |br@188@01| && j@287@01 != k@288@01 | live]
; [else-branch: 134 | !(0 <= j@287@01 && j@287@01 < |br@188@01| && 0 <= k@288@01 && k@288@01 < |br@188@01| && j@287@01 != k@288@01) | live]
(push) ; 6
; [then-branch: 134 | 0 <= j@287@01 && j@287@01 < |br@188@01| && 0 <= k@288@01 && k@288@01 < |br@188@01| && j@287@01 != k@288@01]
(assert (and
  (<= 0 j@287@01)
  (and
    (< j@287@01 (Seq_length br@188@01))
    (and
      (<= 0 k@288@01)
      (and (< k@288@01 (Seq_length br@188@01)) (not (= j@287@01 k@288@01)))))))
; [eval] br[j] != br[k]
; [eval] br[j]
(push) ; 7
(assert (not (>= j@287@01 0)))
(check-sat)
; unsat
(pop) ; 7
; 0,00s
...
(pop) ; 6
(push) ; 6
; [else-branch: 134 | !(0 <= j@287@01 && j@287@01 < |br@188@01| && 0 <= k@288@01 && k@288@01 < |br@188@01| && j@287@01 != k@288@01)]
(assert (not
  (and
    (<= 0 j@287@01)
    (and
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((j@287@01 Int) (k@288@01 Int)) (!
  (and
    (=>
      (<= 0 j@287@01)
      (and
      ...
      (and
        ...
        (and
          ...
          (and
            (<= 0 k@288@01)
            (and (< k@288@01 (Seq_length br@188@01)) (not (= j@287@01 k@288@01))))))))
  :pattern ((Seq_index br@188@01 j@287@01) (Seq_index br@188@01 k@288@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testDepParLoopBack.vpr@67@12@67@106-aux|)))
(push) ; 4
(assert (not (forall ((j@287@01 Int) (k@288@01 Int)) (!
  (=>
    (and
      (<= 0 j@287@01)
      (and
        ...
        (and
          (<= 0 k@288@01)
          (and (< k@288@01 (Seq_length br@188@01)) (not (= j@287@01 k@288@01))))))
    (not (= (Seq_index br@188@01 j@287@01) (Seq_index br@188@01 k@288@01))))
  :pattern ((Seq_index br@188@01 j@287@01) (Seq_index br@188@01 k@288@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testDepParLoopBack.vpr@67@12@67@106|))))
(check-sat)
; unsat
...
; [eval] 0 <= i
(push) ; 5
; [then-branch: 135 | !(0 <= i@289@01) | live]
; [else-branch: 135 | 0 <= i@289@01 | live]
(push) ; 6
; [then-branch: 135 | !(0 <= i@289@01)]
(assert (not (<= 0 i@289@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 135 | 0 <= i@289@01]
(assert (<= 0 i@289@01))
; [eval] i < len
(pop) ; 6
(pop) ; 5
...
(assert (and (<= 0 i@289@01) (< i@289@01 len@190@01)))
; [eval] br[i]
(push) ; 5
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i@289@01 (Seq_length br@188@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
(assert (forall ((i@289@01 Int)) (!
  (=>
    (and (<= 0 i@289@01) (< i@289@01 len@190@01))
    (or (<= 0 i@289@01) (not (<= 0 i@289@01))))
  :pattern ((Seq_index br@188@01 i@289@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i1@289@01 Int) (i2@289@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@289@01) (< i1@289@01 len@190@01))
      (and (<= 0 i2@289@01) (< i2@289@01 len@190@01))
      (= (Seq_index br@188@01 i1@289@01) (Seq_index br@188@01 i2@289@01)))
    (= i1@289@01 i2@289@01))
...
(assert (forall ((i@289@01 Int)) (!
  (=>
    (and (<= 0 i@289@01) (< i@289@01 len@190@01))
    (and
      (= (inv@290@01 (Seq_index br@188@01 i@289@01)) i@289@01)
      (img@291@01 (Seq_index br@188@01 i@289@01))))
  :pattern ((Seq_index br@188@01 i@289@01))
  :qid |Ref__Integer_value-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@291@01 r)
      (and (<= 0 (inv@290@01 r)) (< (inv@290@01 r) len@190@01)))
    (= (Seq_index br@188@01 (inv@290@01 r)) r))
  :pattern ((inv@290@01 r))
  :qid |Ref__Integer_value-fctOfInv|)))
(push) ; 4
(set-option :timeout 10)
(assert (not (forall ((i@289@01 Int)) (!
  (= (Seq_index br@188@01 i@289@01) (Seq_index ar@187@01 i@289@01))
...
(define-fun pTaken@292@01 ((r $Ref)) $Perm
  (ite
    (and
      (and (<= 0 (inv@290@01 r)) (< (inv@290@01 r) len@190@01))
      (img@291@01 r)
      (= r (Seq_index br@188@01 (inv@290@01 r))))
    ($Perm.min
      (ite
        (and
          (img@196@01 r)
  ...
  (ite
    ...
    ($Perm.min
      (ite
        ...
        (/ (to_real 1) (to_real 2))
        $Perm.No)
      (- (/ (to_real 1) (to_real 2)) (pTaken@292@01 r)))
    $Perm.No))
; Done precomputing, updating quantified chunks
; State saturation: before repetition
(check-sat)
...
; Final check if taken enough permissions
; Done removing quantified permissions
(declare-const sm@294@01 $FVF<Ref__Integer_value>)
; Definitional axioms for snapshot map values
(assert (forall ((r $Ref)) (!
  (=>
    (ite
      ...
      false)
    (=
      ($FVF.lookup_Ref__Integer_value (as sm@294@01  $FVF<Ref__Integer_value>) r)
      ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@191@01)))))) r)))
  :pattern (($FVF.lookup_Ref__Integer_value (as sm@294@01  $FVF<Ref__Integer_value>) r))
  :pattern (($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@191@01)))))) r))
  :qid |qp.fvfValDef21|)))
(assert (forall ((r $Ref)) (!
  (=>
...
(declare-const k@296@01 Int)
(push) ; 4
; [eval] 0 <= j && (j < |cr| && (0 <= k && (k < |cr| && j != k))) ==> cr[j] != cr[k]
; [eval] 0 <= j && (j < |cr| && (0 <= k && (k < |cr| && j != k)))
; [eval] 0 <= j
(push) ; 5
; [then-branch: 137 | !(0 <= j@295@01) | live]
; [else-branch: 137 | 0 <= j@295@01 | live]
(push) ; 6
; [then-branch: 137 | !(0 <= j@295@01)]
(assert (not (<= 0 j@295@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 137 | 0 <= j@295@01]
(assert (<= 0 j@295@01))
; [eval] j < |cr|
; [eval] |cr|
(push) ; 7
; [then-branch: 138 | !(j@295@01 < |cr@189@01|) | live]
; [else-branch: 138 | j@295@01 < |cr@189@01| | live]
(push) ; 8
; [then-branch: 138 | !(j@295@01 < |cr@189@01|)]
(assert (not (< j@295@01 (Seq_length cr@189@01))))
(pop) ; 8
(push) ; 8
; [else-branch: 138 | j@295@01 < |cr@189@01|]
(assert (< j@295@01 (Seq_length cr@189@01)))
; [eval] 0 <= k
(push) ; 9
; [then-branch: 139 | !(0 <= k@296@01) | live]
; [else-branch: 139 | 0 <= k@296@01 | live]
(push) ; 10
; [then-branch: 139 | !(0 <= k@296@01)]
(assert (not (<= 0 k@296@01)))
(pop) ; 10
(push) ; 10
; [else-branch: 139 | 0 <= k@296@01]
(assert (<= 0 k@296@01))
; [eval] k < |cr|
; [eval] |cr|
(push) ; 11
; [then-branch: 140 | !(k@296@01 < |cr@189@01|) | live]
; [else-branch: 140 | k@296@01 < |cr@189@01| | live]
(push) ; 12
; [then-branch: 140 | !(k@296@01 < |cr@189@01|)]
(assert (not (< k@296@01 (Seq_length cr@189@01))))
(pop) ; 12
(push) ; 12
; [else-branch: 140 | k@296@01 < |cr@189@01|]
(assert (< k@296@01 (Seq_length cr@189@01)))
; [eval] j != k
(pop) ; 12
(pop) ; 11
; Joined path conditions
; Joined path conditions
(assert (or
  (< k@296@01 (Seq_length cr@189@01))
  (not (< k@296@01 (Seq_length cr@189@01)))))
(pop) ; 10
(pop) ; 9
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (and
    ...
    (or
      (< k@296@01 (Seq_length cr@189@01))
      (not (< k@296@01 (Seq_length cr@189@01)))))))
(assert (or (<= 0 k@296@01) (not (<= 0 k@296@01))))
(pop) ; 8
(pop) ; 7
; Joined path conditions
; Joined path conditions
(assert (=>
  (< j@295@01 (Seq_length cr@189@01))
  (and
    (< j@295@01 (Seq_length cr@189@01))
    (=>
      (<= 0 k@296@01)
      (and
        ...
        (or
          (< k@296@01 (Seq_length cr@189@01))
          (not (< k@296@01 (Seq_length cr@189@01))))))
    (or (<= 0 k@296@01) (not (<= 0 k@296@01))))))
(assert (or
  (< j@295@01 (Seq_length cr@189@01))
  (not (< j@295@01 (Seq_length cr@189@01)))))
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (=>
  ...
  (and
    ...
    (or
      (< j@295@01 (Seq_length cr@189@01))
      (not (< j@295@01 (Seq_length cr@189@01)))))))
(assert (or (<= 0 j@295@01) (not (<= 0 j@295@01))))
(push) ; 5
; [then-branch: 141 | 0 <= j@295@01 && j@295@01 < |cr@189@01| && 0 <= k@296@01 && k@296@01 < |cr@189@01| && j@295@01 != k@296@01 | live]
; [else-branch: 141 | !(0 <= j@295@01 && j@295@01 < |cr@189@01| && 0 <= k@296@01 && k@296@01 < |cr@189@01| && j@295@01 != k@296@01) | live]
(push) ; 6
; [then-branch: 141 | 0 <= j@295@01 && j@295@01 < |cr@189@01| && 0 <= k@296@01 && k@296@01 < |cr@189@01| && j@295@01 != k@296@01]
(assert (and
  (<= 0 j@295@01)
  (and
    (< j@295@01 (Seq_length cr@189@01))
    (and
      (<= 0 k@296@01)
      (and (< k@296@01 (Seq_length cr@189@01)) (not (= j@295@01 k@296@01)))))))
; [eval] cr[j] != cr[k]
; [eval] cr[j]
(push) ; 7
...
(pop) ; 6
(push) ; 6
; [else-branch: 141 | !(0 <= j@295@01 && j@295@01 < |cr@189@01| && 0 <= k@296@01 && k@296@01 < |cr@189@01| && j@295@01 != k@296@01)]
(assert (not
  (and
    (<= 0 j@295@01)
    (and
...
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((j@295@01 Int) (k@296@01 Int)) (!
  (and
    (=>
      (<= 0 j@295@01)
      (and
      ...
      (and
        ...
        (and
          ...
          (and
            (<= 0 k@296@01)
            (and (< k@296@01 (Seq_length cr@189@01)) (not (= j@295@01 k@296@01))))))))
  :pattern ((Seq_index cr@189@01 j@295@01) (Seq_index cr@189@01 k@296@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testDepParLoopBack.vpr@70@12@70@106-aux|)))
(push) ; 4
(assert (not (forall ((j@295@01 Int) (k@296@01 Int)) (!
  (=>
    (and
      (<= 0 j@295@01)
      (and
        ...
        (and
          (<= 0 k@296@01)
          (and (< k@296@01 (Seq_length cr@189@01)) (not (= j@295@01 k@296@01))))))
    (not (= (Seq_index cr@189@01 j@295@01) (Seq_index cr@189@01 k@296@01))))
  :pattern ((Seq_index cr@189@01 j@295@01) (Seq_index cr@189@01 k@296@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testDepParLoopBack.vpr@70@12@70@106|))))
(check-sat)
; unsat
...
; [eval] 0 <= i
(push) ; 5
; [then-branch: 142 | !(0 <= i@297@01) | live]
; [else-branch: 142 | 0 <= i@297@01 | live]
(push) ; 6
; [then-branch: 142 | !(0 <= i@297@01)]
(assert (not (<= 0 i@297@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 142 | 0 <= i@297@01]
(assert (<= 0 i@297@01))
; [eval] i < len
(pop) ; 6
(pop) ; 5
...
(assert (and (<= 0 i@297@01) (< i@297@01 len@190@01)))
; [eval] cr[i]
(push) ; 5
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i@297@01 (Seq_length cr@189@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
(assert (forall ((i@297@01 Int)) (!
  (=>
    (and (<= 0 i@297@01) (< i@297@01 len@190@01))
    (or (<= 0 i@297@01) (not (<= 0 i@297@01))))
  :pattern ((Seq_index cr@189@01 i@297@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i1@297@01 Int) (i2@297@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@297@01) (< i1@297@01 len@190@01))
      (and (<= 0 i2@297@01) (< i2@297@01 len@190@01))
      (= (Seq_index cr@189@01 i1@297@01) (Seq_index cr@189@01 i2@297@01)))
    (= i1@297@01 i2@297@01))
...
(assert (forall ((i@297@01 Int)) (!
  (=>
    (and (<= 0 i@297@01) (< i@297@01 len@190@01))
    (and
      (= (inv@298@01 (Seq_index cr@189@01 i@297@01)) i@297@01)
      (img@299@01 (Seq_index cr@189@01 i@297@01))))
  :pattern ((Seq_index cr@189@01 i@297@01))
  :qid |Ref__Integer_value-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@299@01 r)
      (and (<= 0 (inv@298@01 r)) (< (inv@298@01 r) len@190@01)))
    (= (Seq_index cr@189@01 (inv@298@01 r)) r))
  :pattern ((inv@298@01 r))
  :qid |Ref__Integer_value-fctOfInv|)))
(push) ; 4
(set-option :timeout 10)
(assert (not (forall ((i@297@01 Int)) (!
  (= (Seq_index cr@189@01 i@297@01) (Seq_index br@188@01 i@297@01))
...
(define-fun pTaken@300@01 ((r $Ref)) $Perm
  (ite
    (and
      (and (<= 0 (inv@298@01 r)) (< (inv@298@01 r) len@190@01))
      (img@299@01 r)
      (= r (Seq_index cr@189@01 (inv@298@01 r))))
    ($Perm.min
      (ite
        (and
          (img@201@01 r)
...
(declare-const i@303@01 Int)
(push) ; 4
; [eval] 0 <= i && i < len
; [eval] 0 <= i
(push) ; 5
; [then-branch: 144 | !(0 <= i@303@01) | live]
; [else-branch: 144 | 0 <= i@303@01 | live]
(push) ; 6
; [then-branch: 144 | !(0 <= i@303@01)]
(assert (not (<= 0 i@303@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 144 | 0 <= i@303@01]
(assert (<= 0 i@303@01))
; [eval] i < len
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 i@303@01) (not (<= 0 i@303@01))))
(assert (and (<= 0 i@303@01) (< i@303@01 len@190@01)))
; [eval] ar[i]
(push) ; 5
(assert (not (>= i@303@01 0)))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i@303@01 (Seq_length ar@187@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((i@303@01 Int)) (!
  (=>
    (and (<= 0 i@303@01) (< i@303@01 len@190@01))
    (or (<= 0 i@303@01) (not (<= 0 i@303@01))))
  :pattern ((Seq_index ar@187@01 i@303@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i1@303@01 Int) (i2@303@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@303@01) (< i1@303@01 len@190@01))
      (and (<= 0 i2@303@01) (< i2@303@01 len@190@01))
      (= (Seq_index ar@187@01 i1@303@01) (Seq_index ar@187@01 i2@303@01)))
    (= i1@303@01 i2@303@01))
...
(assert (forall ((i@303@01 Int)) (!
  (=>
    (and (<= 0 i@303@01) (< i@303@01 len@190@01))
    (and
      (= (inv@304@01 (Seq_index ar@187@01 i@303@01)) i@303@01)
      (img@305@01 (Seq_index ar@187@01 i@303@01))))
  :pattern ((Seq_index ar@187@01 i@303@01))
  :qid |quant-u-177|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@305@01 r)
      (and (<= 0 (inv@304@01 r)) (< (inv@304@01 r) len@190@01)))
    (= (Seq_index ar@187@01 (inv@304@01 r)) r))
...
(assert (forall ((i@303@01 Int)) (!
  (=>
    (and (<= 0 i@303@01) (< i@303@01 len@190@01))
    (not (= (Seq_index ar@187@01 i@303@01) $Ref.null)))
  :pattern ((Seq_index ar@187@01 i@303@01))
  :qid |Ref__Integer_value-permImpliesNonNull|)))
(assert (=
  ($Snap.second ($Snap.second $t@302@01))
...
; [eval] 0 <= i
(push) ; 5
; [then-branch: 146 | !(0 <= i@306@01) | live]
; [else-branch: 146 | 0 <= i@306@01 | live]
(push) ; 6
; [then-branch: 146 | !(0 <= i@306@01)]
(assert (not (<= 0 i@306@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 146 | 0 <= i@306@01]
(assert (<= 0 i@306@01))
; [eval] i < len
(pop) ; 6
(pop) ; 5
...
(assert (and (<= 0 i@306@01) (< i@306@01 len@190@01)))
; [eval] br[i]
(push) ; 5
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i@306@01 (Seq_length br@188@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
(assert (forall ((i@306@01 Int)) (!
  (=>
    (and (<= 0 i@306@01) (< i@306@01 len@190@01))
    (or (<= 0 i@306@01) (not (<= 0 i@306@01))))
  :pattern ((Seq_index br@188@01 i@306@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i1@306@01 Int) (i2@306@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@306@01) (< i1@306@01 len@190@01))
      (and (<= 0 i2@306@01) (< i2@306@01 len@190@01))
      (= (Seq_index br@188@01 i1@306@01) (Seq_index br@188@01 i2@306@01)))
    (= i1@306@01 i2@306@01))
...
(assert (forall ((i@306@01 Int)) (!
  (=>
    (and (<= 0 i@306@01) (< i@306@01 len@190@01))
    (and
      (= (inv@307@01 (Seq_index br@188@01 i@306@01)) i@306@01)
      (img@308@01 (Seq_index br@188@01 i@306@01))))
  :pattern ((Seq_index br@188@01 i@306@01))
  :qid |quant-u-179|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@308@01 r)
      (and (<= 0 (inv@307@01 r)) (< (inv@307@01 r) len@190@01)))
    (= (Seq_index br@188@01 (inv@307@01 r)) r))
...
(assert (forall ((i@306@01 Int)) (!
  (=>
    (and (<= 0 i@306@01) (< i@306@01 len@190@01))
    (not (= (Seq_index br@188@01 i@306@01) $Ref.null)))
  :pattern ((Seq_index br@188@01 i@306@01))
  :qid |Ref__Integer_value-permImpliesNonNull|)))
(push) ; 4
(set-option :timeout 10)
(assert (not (forall ((r $Ref)) (!
  (and
    (= (Seq_index br@188@01 i@306@01) (Seq_index ar@187@01 i@303@01))
    (=
      (and
        (img@308@01 r)
        (and (<= 0 (inv@307@01 r)) (< (inv@307@01 r) len@190@01)))
...
; [eval] 0 <= i
(push) ; 5
; [then-branch: 148 | !(0 <= i@309@01) | live]
; [else-branch: 148 | 0 <= i@309@01 | live]
(push) ; 6
; [then-branch: 148 | !(0 <= i@309@01)]
(assert (not (<= 0 i@309@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 148 | 0 <= i@309@01]
(assert (<= 0 i@309@01))
; [eval] i < len
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 i@309@01) (not (<= 0 i@309@01))))
(assert (and (<= 0 i@309@01) (< i@309@01 len@190@01)))
; [eval] cr[i]
(push) ; 5
(assert (not (>= i@309@01 0)))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i@309@01 (Seq_length cr@189@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
; (get-info :all-statistics)
(pop) ; 4
(declare-fun inv@310@01 ($Ref) Int)
(declare-fun img@311@01 ($Ref) Bool)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((i@309@01 Int)) (!
  (=>
    (and (<= 0 i@309@01) (< i@309@01 len@190@01))
    (or (<= 0 i@309@01) (not (<= 0 i@309@01))))
  :pattern ((Seq_index cr@189@01 i@309@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i1@309@01 Int) (i2@309@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@309@01) (< i1@309@01 len@190@01))
      (and (<= 0 i2@309@01) (< i2@309@01 len@190@01))
      (= (Seq_index cr@189@01 i1@309@01) (Seq_index cr@189@01 i2@309@01)))
    (= i1@309@01 i2@309@01))
...
(assert (forall ((i@309@01 Int)) (!
  (=>
    (and (<= 0 i@309@01) (< i@309@01 len@190@01))
    (and
      (= (inv@310@01 (Seq_index cr@189@01 i@309@01)) i@309@01)
      (img@311@01 (Seq_index cr@189@01 i@309@01))))
  :pattern ((Seq_index cr@189@01 i@309@01))
  :qid |quant-u-182|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@311@01 r)
      (and (<= 0 (inv@310@01 r)) (< (inv@310@01 r) len@190@01)))
    (= (Seq_index cr@189@01 (inv@310@01 r)) r))
...
(assert (forall ((i@309@01 Int)) (!
  (=>
    (and (<= 0 i@309@01) (< i@309@01 len@190@01))
    (not (= (Seq_index cr@189@01 i@309@01) $Ref.null)))
  :pattern ((Seq_index cr@189@01 i@309@01))
  :qid |Ref__Integer_value-permImpliesNonNull|)))
(push) ; 4
(set-option :timeout 10)
(assert (not (forall ((r $Ref)) (!
  (and
    (= (Seq_index cr@189@01 i@309@01) (Seq_index br@188@01 i@306@01))
    (=
      (and
        (img@311@01 r)
        (and (<= 0 (inv@310@01 r)) (< (inv@310@01 r) len@190@01)))
...
(assert (not (forall ((r $Ref)) (!
  (and
    (= (Seq_index cr@189@01 i@309@01) (Seq_index ar@187@01 i@303@01))
    (=
      (and
        (img@311@01 r)
        (and (<= 0 (inv@310@01 r)) (< (inv@310@01 r) len@190@01)))
...
; [eval] 0 <= i
(push) ; 5
; [then-branch: 149 | !(0 <= i@312@01) | live]
; [else-branch: 149 | 0 <= i@312@01 | live]
(push) ; 6
; [then-branch: 149 | !(0 <= i@312@01)]
(assert (not (<= 0 i@312@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 149 | 0 <= i@312@01]
(assert (<= 0 i@312@01))
; [eval] i < len
(pop) ; 6
(pop) ; 5
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i@312@01 (Seq_length ar@187@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
(assert (forall ((i@312@01 Int)) (!
  ...
  :pattern ((Seq_index ar@187@01 i@312@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i1@312@01 Int) (i2@312@01 Int)) (!
  (=>
    (and
      ...
      (= (Seq_index ar@187@01 i1@312@01) (Seq_index ar@187@01 i2@312@01)))
    (= i1@312@01 i2@312@01))
...
(assert (forall ((i@312@01 Int)) (!
  (=>
    (and (<= 0 i@312@01) (< i@312@01 len@190@01))
    (and
      (= (inv@313@01 (Seq_index ar@187@01 i@312@01)) i@312@01)
      (img@314@01 (Seq_index ar@187@01 i@312@01))))
  :pattern ((Seq_index ar@187@01 i@312@01))
  :qid |Ref__Integer_value-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    ...
    (= (Seq_index ar@187@01 (inv@313@01 r)) r))
  :pattern ((inv@313@01 r))
  :qid |Ref__Integer_value-fctOfInv|)))
(push) ; 4
(set-option :timeout 10)
(assert (not (forall ((i@312@01 Int)) (!
  (= (Seq_index ar@187@01 i@312@01) (Seq_index br@188@01 i@312@01))
...
(set-option :timeout 10)
(assert (not (forall ((i@312@01 Int)) (!
  (= (Seq_index ar@187@01 i@312@01) (Seq_index cr@189@01 i@312@01))
...
(define-fun pTaken@315@01 ((r $Ref)) $Perm
  (ite
    (and
      (and (<= 0 (inv@313@01 r)) (< (inv@313@01 r) len@190@01))
      (img@314@01 r)
      (= r (Seq_index ar@187@01 (inv@313@01 r))))
    ($Perm.min
      (ite
        (and
          (img@305@01 r)
  ...
  (ite
    ...
    ($Perm.min
      (ite
        ...
        $Perm.Write
        $Perm.No)
      (- (- $Perm.Write (pTaken@315@01 r)) (pTaken@316@01 r)))
    $Perm.No))
; Done precomputing, updating quantified chunks
; State saturation: before repetition
(check-sat)
...
; Final check if taken enough permissions
; Done removing quantified permissions
(declare-const sm@318@01 $FVF<Ref__Integer_value>)
; Definitional axioms for snapshot map values
(assert (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (and (<= 0 (inv@304@01 r)) (< (inv@304@01 r) len@190@01)))
    (=
      ($FVF.lookup_Ref__Integer_value (as sm@318@01  $FVF<Ref__Integer_value>) r)
      ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first ($Snap.second $t@302@01))) r)))
  :pattern (($FVF.lookup_Ref__Integer_value (as sm@318@01  $FVF<Ref__Integer_value>) r))
  :pattern (($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first ($Snap.second $t@302@01))) r))
  :qid |qp.fvfValDef24|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
    ...
    (=
      ($FVF.lookup_Ref__Integer_value (as sm@318@01  $FVF<Ref__Integer_value>) r)
      ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@302@01))))) r)))
  :pattern (($FVF.lookup_Ref__Integer_value (as sm@318@01  $FVF<Ref__Integer_value>) r))
  :pattern (($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@302@01))))) r))
  :qid |qp.fvfValDef25|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
    ...
    (=
      ($FVF.lookup_Ref__Integer_value (as sm@318@01  $FVF<Ref__Integer_value>) r)
      ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@302@01)))))) r)))
  :pattern (($FVF.lookup_Ref__Integer_value (as sm@318@01  $FVF<Ref__Integer_value>) r))
  :pattern (($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@302@01)))))) r))
  :qid |qp.fvfValDef26|)))
; [eval] |br| == len
; [eval] |br|
(declare-const i@319@01 Int)
(set-option :timeout 0)
(push) ; 4
; [eval] 0 <= i && i < len
; [eval] 0 <= i
(push) ; 5
; [then-branch: 150 | !(0 <= i@319@01) | live]
; [else-branch: 150 | 0 <= i@319@01 | live]
(push) ; 6
; [then-branch: 150 | !(0 <= i@319@01)]
(assert (not (<= 0 i@319@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 150 | 0 <= i@319@01]
(assert (<= 0 i@319@01))
; [eval] i < len
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 i@319@01) (not (<= 0 i@319@01))))
(assert (and (<= 0 i@319@01) (< i@319@01 len@190@01)))
; [eval] br[i]
(push) ; 5
(assert (not (>= i@319@01 0)))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i@319@01 (Seq_length br@188@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((i@319@01 Int)) (!
  (=>
    (and (<= 0 i@319@01) (< i@319@01 len@190@01))
    (or (<= 0 i@319@01) (not (<= 0 i@319@01))))
  :pattern ((Seq_index br@188@01 i@319@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i1@319@01 Int) (i2@319@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@319@01) (< i1@319@01 len@190@01))
      (and (<= 0 i2@319@01) (< i2@319@01 len@190@01))
      (= (Seq_index br@188@01 i1@319@01) (Seq_index br@188@01 i2@319@01)))
    (= i1@319@01 i2@319@01))
...
(assert (forall ((i@319@01 Int)) (!
  (=>
    (and (<= 0 i@319@01) (< i@319@01 len@190@01))
    (and
      (= (inv@320@01 (Seq_index br@188@01 i@319@01)) i@319@01)
      (img@321@01 (Seq_index br@188@01 i@319@01))))
  :pattern ((Seq_index br@188@01 i@319@01))
  :qid |Ref__Integer_value-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@321@01 r)
      (and (<= 0 (inv@320@01 r)) (< (inv@320@01 r) len@190@01)))
    (= (Seq_index br@188@01 (inv@320@01 r)) r))
  :pattern ((inv@320@01 r))
  :qid |Ref__Integer_value-fctOfInv|)))
(push) ; 4
(set-option :timeout 10)
(assert (not (forall ((i@319@01 Int)) (!
  (= (Seq_index br@188@01 i@319@01) (Seq_index cr@189@01 i@319@01))
...
(define-fun pTaken@322@01 ((r $Ref)) $Perm
  (ite
    (and
      (and (<= 0 (inv@320@01 r)) (< (inv@320@01 r) len@190@01))
      (img@321@01 r)
      (= r (Seq_index br@188@01 (inv@320@01 r))))
    ($Perm.min
      (ite
        (and
          (img@311@01 r)
...
; Final check if taken enough permissions
; Done removing quantified permissions
(declare-const sm@324@01 $FVF<Ref__Integer_value>)
; Definitional axioms for snapshot map values
(assert (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (and (<= 0 (inv@310@01 r)) (< (inv@310@01 r) len@190@01)))
    (=
      ($FVF.lookup_Ref__Integer_value (as sm@324@01  $FVF<Ref__Integer_value>) r)
      ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@302@01)))))) r)))
  :pattern (($FVF.lookup_Ref__Integer_value (as sm@324@01  $FVF<Ref__Integer_value>) r))
  :pattern (($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@302@01)))))) r))
  :qid |qp.fvfValDef27|)))
(assert (forall ((r $Ref)) (!
  (=>
...
; [eval] |cr| == len
; [eval] |cr|
(declare-const i@325@01 Int)
(set-option :timeout 0)
(push) ; 4
; [eval] 0 <= i && i < len
; [eval] 0 <= i
(push) ; 5
; [then-branch: 151 | !(0 <= i@325@01) | live]
; [else-branch: 151 | 0 <= i@325@01 | live]
(push) ; 6
; [then-branch: 151 | !(0 <= i@325@01)]
(assert (not (<= 0 i@325@01)))
(pop) ; 6
(push) ; 6
; [else-branch: 151 | 0 <= i@325@01]
(assert (<= 0 i@325@01))
; [eval] i < len
(pop) ; 6
(pop) ; 5
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 i@325@01) (not (<= 0 i@325@01))))
(assert (and (<= 0 i@325@01) (< i@325@01 len@190@01)))
; [eval] cr[i]
(push) ; 5
(assert (not (>= i@325@01 0)))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i@325@01 (Seq_length cr@189@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((i@325@01 Int)) (!
  (=>
    (and (<= 0 i@325@01) (< i@325@01 len@190@01))
    (or (<= 0 i@325@01) (not (<= 0 i@325@01))))
  :pattern ((Seq_index cr@189@01 i@325@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i1@325@01 Int) (i2@325@01 Int)) (!
  (=>
    (and
      (and (<= 0 i1@325@01) (< i1@325@01 len@190@01))
      (and (<= 0 i2@325@01) (< i2@325@01 len@190@01))
      (= (Seq_index cr@189@01 i1@325@01) (Seq_index cr@189@01 i2@325@01)))
    (= i1@325@01 i2@325@01))
...
(assert (forall ((i@325@01 Int)) (!
  (=>
    (and (<= 0 i@325@01) (< i@325@01 len@190@01))
    (and
      (= (inv@326@01 (Seq_index cr@189@01 i@325@01)) i@325@01)
      (img@327@01 (Seq_index cr@189@01 i@325@01))))
  :pattern ((Seq_index cr@189@01 i@325@01))
  :qid |Ref__Integer_value-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@327@01 r)
      (and (<= 0 (inv@326@01 r)) (< (inv@326@01 r) len@190@01)))
    (= (Seq_index cr@189@01 (inv@326@01 r)) r))
  :pattern ((inv@326@01 r))
  :qid |Ref__Integer_value-fctOfInv|)))
(push) ; 4
(set-option :timeout 10)
(assert (not (forall ((i@325@01 Int)) (!
  (= (Seq_index cr@189@01 i@325@01) (Seq_index br@188@01 i@325@01))
...
(define-fun pTaken@328@01 ((r $Ref)) $Perm
  (ite
    (and
      (and (<= 0 (inv@326@01 r)) (< (inv@326@01 r) len@190@01))
      (img@327@01 r)
      (= r (Seq_index cr@189@01 (inv@326@01 r))))
    ($Perm.min
      (ite
        (and
          (img@308@01 r)
...
(assert (not (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (img@327@01 r)
      (= r (Seq_index cr@189@01 (inv@326@01 r))))
    (= (- $Perm.Write (pTaken@328@01 r)) $Perm.No))
...
; Final check if taken enough permissions
; Done removing quantified permissions
(declare-const sm@329@01 $FVF<Ref__Integer_value>)
; Definitional axioms for snapshot map values
(assert (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (and (<= 0 (inv@307@01 r)) (< (inv@307@01 r) len@190@01)))
    (=
      ($FVF.lookup_Ref__Integer_value (as sm@329@01  $FVF<Ref__Integer_value>) r)
      ($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@302@01))))) r)))
  :pattern (($FVF.lookup_Ref__Integer_value (as sm@329@01  $FVF<Ref__Integer_value>) r))
  :pattern (($FVF.lookup_Ref__Integer_value ($SortWrappers.$SnapTo$FVF<Ref__Integer_value> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@302@01))))) r))
  :qid |qp.fvfValDef29|)))
(pop) ; 3
(pop) ; 2
