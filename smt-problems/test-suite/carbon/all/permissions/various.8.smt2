...
(assert  (and (and (and (and (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type r_1) RefType)) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type ExhaleHeap@1) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type AssertMask@0) (MapType1Type RefType realType))) (= (type AssertMask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id t5)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon4_correct  (=> (and (and (= Mask@2 (MapType1Store Mask@1 r_1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 r_1 f_7)) perm@1)))) (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@1 Mask@2)) (and (state ExhaleHeap@1 Mask@2) (= (ControlFlow 0 2) (- 0 1)))) (> (U_2_real (MapType1Select Mask@2 r_1 f_7)) NoPerm))))
(let ((anon6_Else_correct  (=> (and (= perm@1 NoPerm) (= (ControlFlow 0 5) 2)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= perm@1 NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= perm@1 (U_2_real (MapType1Select Mask@1 r_1 f_7)))) (=> (<= perm@1 (U_2_real (MapType1Select Mask@1 r_1 f_7))) (=> (= (ControlFlow 0 3) 2) anon4_correct))))))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 r_1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 r_1 f_7)) perm@0)))) (=> (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1)) (and (=> (= (ControlFlow 0 6) (- 0 10)) (= (U_2_real (MapType1Select Mask@1 r_1 f_7)) (/ (to_real 2) (to_real 3)))) (=> (= (U_2_real (MapType1Select Mask@1 r_1 f_7)) (/ (to_real 2) (to_real 3))) (=> (state ExhaleHeap@0 Mask@1) (and (=> (= (ControlFlow 0 6) (- 0 9)) (> (U_2_real (MapType1Select Mask@1 r_1 f_7)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@1 r_1 f_7)) NoPerm) (=> (and (and (> wildcard@0 NoPerm) (< wildcard@0 (U_2_real (MapType1Select Mask@1 r_1 f_7)))) (and (= AssertMask@0 (MapType1Store Mask@1 r_1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 r_1 f_7)) wildcard@0)))) (state ExhaleHeap@0 Mask@1))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (> (U_2_real (MapType1Select Mask@1 r_1 f_7)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@1 r_1 f_7)) NoPerm) (=> (> wildcard@1 NoPerm) (=> (and (and (< wildcard@1 (U_2_real (MapType1Select Mask@1 r_1 f_7))) (= AssertMask@1 (MapType1Store Mask@1 r_1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 r_1 f_7)) wildcard@1))))) (and (state ExhaleHeap@0 Mask@1) (= perm@1 (U_2_real (MapType1Select Mask@1 r_1 f_7))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (and (=> (= (ControlFlow 0 6) 3) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct))))))))))))))))))
(let ((anon5_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 13) 6)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= perm@0 (U_2_real (MapType1Select Mask@0 r_1 f_7)))) (=> (<= perm@0 (U_2_real (MapType1Select Mask@0 r_1 f_7))) (=> (= (ControlFlow 0 11) 6) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 r_1 $allocated)) (not (= r_1 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask r_1 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1 f_7)) FullPerm)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (= perm@0 (/ (to_real 1) (to_real 3))))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 14) 11) anon5_Then_correct) (=> (= (ControlFlow 0 14) 13) anon5_Else_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (> wildcard NoPerm) true) (= (ControlFlow 0 16) 14)) anon0_correct)))
