...
(let ((anon21_Else_correct  (=> (and (not (and (>= j 0) (and (< j (len a_3@@7)) (< j i_1@@6)))) (= (ControlFlow 0 27) 23)) anon8_correct)))
(let ((anon21_Then_correct  (=> (and (>= j 0) (and (< j (len a_3@@7)) (< j i_1@@6))) (and (=> (= (ControlFlow 0 24) (- 0 26)) (HasDirectPerm QPMask@0 (loc a_3@@7 j) val)) (=> (HasDirectPerm QPMask@0 (loc a_3@@7 j) val) (and (=> (= (ControlFlow 0 24) (- 0 25)) (HasDirectPerm QPMask@4 (loc a_3@@7 j) val)) (=> (HasDirectPerm QPMask@4 (loc a_3@@7 j) val) (=> (= (ControlFlow 0 24) 23) anon8_correct))))))))
...
(let ((A@@15 (FieldTypeInv0 (type f_5@@2))))
 ...
 :qid |stdinbpl.1603:35|
 :skolemid |118|
 :pattern ( (MapType1Select QPMask@1 o_3@@10 f_5@@2))
 :pattern ( (MapType1Select QPMask@2 o_3@@10 f_5@@2))
)) (state ExhaleHeap@0 QPMask@2)) (and (forall ((j_11 Int) ) (!  (=> (and (>= j_11 0) (and (< j_11 (len a_3@@7)) (< j_11 arg_i@0))) (= (U_2_int (MapType0Select Heap@0 (loc a_3@@7 j_11) val)) (U_2_int (MapType0Select ExhaleHeap@0 (loc a_3@@7 j_11) val))))
 :qid |stdinbpl.1609:26|
 :skolemid |119|
 :pattern ( (loc a_3@@7 j_11))
