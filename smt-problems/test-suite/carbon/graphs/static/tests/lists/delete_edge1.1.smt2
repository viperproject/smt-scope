...
(let ((anon86_Else_correct  (=> (and (forall ((v1_3 T@U) (v2_3 T@U) ) (!  (=> (and (and (= (type v1_3) RefType) (= (type v2_3) RefType)) (not (= v1_3 v2_3))) (= (exists_path ($$ PostHeap@0 g) v1_3 v2_3)  (or (exists_path ($$ Heap@@23 g) v1_3 v2_3) (and (exists_path ($$ Heap@@23 g) v1_3 x_1@@0) (exists_path ($$ Heap@@23 g) y@@6 v2_3)))))
...
(let ((anon82_Else_correct  (=> (and (forall ((v1_1 T@U) (v2_1 T@U) ) (!  (=> (and (= (type v1_1) RefType) (= (type v2_1) RefType)) (= (edge ($$ PostHeap@0 g) v1_1 v2_1)  (or (edge ($$ Heap@@23 g) v1_1 v2_1) (and (= v1_1 x_1@@0) (= v2_1 y@@6)))))
