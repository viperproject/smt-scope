...
(assert  (and (and (and (and (and (and (and (and (and (= (type xs) (MapType2Type RefType boolType)) (= (type x@@19) RefType)) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test0)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon6_correct true))
(let ((anon9_Else_correct  (=> (not (U_2_bool (MapType2Select xs x@@19))) (=> (and (= Mask@5 Mask@3) (= (ControlFlow 0 4) 1)) anon6_correct))))
(let ((anon9_Then_correct  (=> (U_2_bool (MapType2Select xs x@@19)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> (U_2_real (MapType1Select Mask@3 x@@19 f_7)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@3 x@@19 f_7)) NoPerm) (=> (> wildcard@2 NoPerm) (=> (and (and (< wildcard@2 (U_2_real (MapType1Select Mask@3 x@@19 f_7))) (= Mask@4 (MapType1Store Mask@3 x@@19 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@3 x@@19 f_7)) wildcard@2))))) (and (= Mask@5 Mask@4) (= (ControlFlow 0 2) 1))) anon6_correct)))))))
(let ((anon4_correct  (=> (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3)) (and (=> (= (ControlFlow 0 5) 2) anon9_Then_correct) (=> (= (ControlFlow 0 5) 4) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (not (U_2_bool (MapType2Select xs x@@19))) (=> (and (= Mask@3 Mask@1) (= (ControlFlow 0 8) 5)) anon4_correct))))
(let ((anon8_Then_correct  (=> (U_2_bool (MapType2Select xs x@@19)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (> (U_2_real (MapType1Select Mask@1 x@@19 f_7)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@1 x@@19 f_7)) NoPerm) (=> (> wildcard@1 NoPerm) (=> (and (and (< wildcard@1 (U_2_real (MapType1Select Mask@1 x@@19 f_7))) (= Mask@2 (MapType1Store Mask@1 x@@19 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 x@@19 f_7)) wildcard@1))))) (and (= Mask@3 Mask@2) (= (ControlFlow 0 6) 5))) anon4_correct)))))))
(let ((anon2_correct  (=> (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1)) (and (=> (= (ControlFlow 0 9) 6) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (not (U_2_bool (MapType2Select xs x@@19))) (=> (and (= Mask@1 ZeroMask) (= (ControlFlow 0 11) 9)) anon2_correct))))
(let ((anon7_Then_correct  (=> (U_2_bool (MapType2Select xs x@@19)) (=> (and (> wildcard@0 NoPerm) (not (= x@@19 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask x@@19 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@19 f_7)) wildcard@0)))) (state Heap@@9 Mask@0)) (and (= Mask@1 Mask@0) (= (ControlFlow 0 10) 9))) anon2_correct)))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@19 $allocated))) (and (=> (= (ControlFlow 0 12) 10) anon7_Then_correct) (=> (= (ControlFlow 0 12) 11) anon7_Else_correct)))))
