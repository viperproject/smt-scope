...
(assert (forall ((Heap@@18 T@U) (Mask@@4 T@U) (s@@6 T@U) ) (!  (=> (and (and (and (= (type Heap@@18) (MapType0Type RefType)) (= (type Mask@@4) (MapType1Type RefType realType))) (= (type s@@6) (SeqType intType))) (and (state Heap@@18 Mask@@4) (< AssumeFunctionsAbove 5))) (Tree__sorted_list Heap@@18 s@@6))
 :qid |stdinbpl.1874:15|
 :skolemid |92|
 :pattern ( (state Heap@@18 Mask@@4) (Tree__sorted_list Heap@@18 s@@6))
)))
(assert (forall ((s@@7 T@U) (n@@4 Int) (j@@2 Int) ) (! (let ((T@@13 (SeqTypeInv0 (type s@@7))))
 (=> (= (type s@@7) (SeqType T@@13)) (=> (and (and (<= 0 j@@2) (< j@@2 n@@4)) (< j@@2 (|Seq#Length| s@@7))) (= (|Seq#Index| (|Seq#Take| s@@7 n@@4) j@@2) (|Seq#Index| s@@7 j@@2)))))
 :qid |stdinbpl.275:18|
 :skolemid |37|
 :pattern ( (|Seq#Index| (|Seq#Take| s@@7 n@@4) j@@2))
 :pattern ( (|Seq#Index| s@@7 j@@2) (|Seq#Take| s@@7 n@@4))
)))
...
(assert (forall ((diz@@14 T@U) (diz2@@2 T@U) ) (!  (=> (and (and (= (type diz@@14) RefType) (= (type diz2@@2) RefType)) (= (|Tree__state#sm| diz@@14) (|Tree__state#sm| diz2@@2))) (= diz@@14 diz2@@2))
 :qid |stdinbpl.2467:15|
 :skolemid |108|
 :pattern ( (|Tree__state#sm| diz@@14) (|Tree__state#sm| diz2@@2))
)))
(assert (forall ((Heap@@19 T@U) (ExhaleHeap@@2 T@U) (Mask@@5 T@U) (o_1@@0 T@U) (f_2 T@U) ) (! (let ((B@@1 (FieldTypeInv1 (type f_2))))
(let ((A@@1 (FieldTypeInv0 (type f_2))))
 (=> (and (and (and (and (and (and (= (type Heap@@19) (MapType0Type RefType)) (= (type ExhaleHeap@@2) (MapType0Type RefType))) (= (type Mask@@5) (MapType1Type RefType realType))) (= (type o_1@@0) RefType)) (= (type f_2) (FieldType A@@1 B@@1))) (IdenticalOnKnownLocations Heap@@19 ExhaleHeap@@2 Mask@@5)) (HasDirectPerm Mask@@5 o_1@@0 f_2)) (= (MapType0Select Heap@@19 o_1@@0 f_2) (MapType0Select ExhaleHeap@@2 o_1@@0 f_2)))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@19 ExhaleHeap@@2 Mask@@5) (MapType0Select ExhaleHeap@@2 o_1@@0 f_2))
)))
...
(assert (forall ((Heap@@20 T@U) (Mask@@6 T@U) (t_1@@3 T@U) ) (!  (=> (and (and (and (= (type Heap@@20) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (= (type t_1@@3) RefType)) (state Heap@@20 Mask@@6)) (= (|Tree__sorted'| Heap@@20 t_1@@3) (|Tree__sorted#frame| (FrameFragment (ite (not (= t_1@@3 null)) (MapType0Select Heap@@20 null (Tree__state t_1@@3)) EmptyFrame)) t_1@@3)))
 :qid |stdinbpl.1930:15|
 :skolemid |97|
 :pattern ( (state Heap@@20 Mask@@6) (|Tree__sorted'| Heap@@20 t_1@@3))
)))
...
(assert (forall ((Heap@@21 T@U) (ExhaleHeap@@3 T@U) (Mask@@7 T@U) ) (!  (=> (and (and (and (= (type Heap@@21) (MapType0Type RefType)) (= (type ExhaleHeap@@3) (MapType0Type RefType))) (= (type Mask@@7) (MapType1Type RefType realType))) (IdenticalOnKnownLocations Heap@@21 ExhaleHeap@@3 Mask@@7)) (succHeap Heap@@21 ExhaleHeap@@3))
 :qid |stdinbpl.83:15|
 :skolemid |10|
 :pattern ( (IdenticalOnKnownLocations Heap@@21 ExhaleHeap@@3 Mask@@7))
)))
(assert (forall ((Heap@@22 T@U) (Mask@@8 T@U) (diz@@15 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@22) (MapType0Type RefType)) (= (type Mask@@8) (MapType1Type RefType realType))) (= (type diz@@15) RefType)) (and (state Heap@@22 Mask@@8) (< AssumeFunctionsAbove 1))) (not (= diz@@15 null))) (= (Wand_state_contains_for_state_contains__get_in_1 Heap@@22 diz@@15) (MapType0Select Heap@@22 diz@@15 Wand_state_contains_for_state_contains__in_1)))
 :qid |stdinbpl.625:15|
 :skolemid |60|
 :pattern ( (state Heap@@22 Mask@@8) (Wand_state_contains_for_state_contains__get_in_1 Heap@@22 diz@@15))
 :pattern ( (state Heap@@22 Mask@@8) (|Wand_state_contains_for_state_contains__get_in_1#triggerStateless| diz@@15) (|Wand_state_contains_for_state_contains__valid_wand#trigger| Heap@@22 (Wand_state_contains_for_state_contains__valid_wand diz@@15)))
)))
(assert (forall ((Heap@@23 T@U) (Mask@@9 T@U) (diz@@16 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@23) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (= (type diz@@16) RefType)) (and (state Heap@@23 Mask@@9) (< AssumeFunctionsAbove 2))) (not (= diz@@16 null))) (= (Wand_state_contains_for_state_contains__get_in_1_0 Heap@@23 diz@@16) (MapType0Select Heap@@23 diz@@16 Wand_state_contains_for_state_contains__in_1_0)))
 :qid |stdinbpl.897:15|
 :skolemid |67|
 :pattern ( (state Heap@@23 Mask@@9) (Wand_state_contains_for_state_contains__get_in_1_0 Heap@@23 diz@@16))
 :pattern ( (state Heap@@23 Mask@@9) (|Wand_state_contains_for_state_contains__get_in_1_0#triggerStateless| diz@@16) (|Wand_state_contains_for_state_contains__valid_wand#trigger| Heap@@23 (Wand_state_contains_for_state_contains__valid_wand diz@@16)))
)))
(assert (forall ((Heap@@24 T@U) (Mask@@10 T@U) (diz@@17 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@24) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type diz@@17) RefType)) (and (state Heap@@24 Mask@@10) (< AssumeFunctionsAbove 3))) (not (= diz@@17 null))) (= (Wand_state_contains_for_state_contains__get_out_1_0 Heap@@24 diz@@17) (MapType0Select Heap@@24 diz@@17 Wand_state_contains_for_state_contains__out_1_0)))
 :qid |stdinbpl.1429:15|
 :skolemid |80|
 :pattern ( (state Heap@@24 Mask@@10) (Wand_state_contains_for_state_contains__get_out_1_0 Heap@@24 diz@@17))
 :pattern ( (state Heap@@24 Mask@@10) (|Wand_state_contains_for_state_contains__get_out_1_0#triggerStateless| diz@@17) (|Wand_state_contains_for_state_contains__valid_wand#trigger| Heap@@24 (Wand_state_contains_for_state_contains__valid_wand diz@@17)))
)))
(assert (forall ((Heap@@25 T@U) (Mask@@11 T@U) (diz@@18 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@25) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (= (type diz@@18) RefType)) (and (state Heap@@25 Mask@@11) (< AssumeFunctionsAbove 4))) (not (= diz@@18 null))) (= (Wand_state_contains_for_state_contains__get_out_1 Heap@@25 diz@@18) (MapType0Select Heap@@25 diz@@18 Wand_state_contains_for_state_contains__out_1)))
 :qid |stdinbpl.1157:15|
 :skolemid |73|
 :pattern ( (state Heap@@25 Mask@@11) (Wand_state_contains_for_state_contains__get_out_1 Heap@@25 diz@@18))
 :pattern ( (state Heap@@25 Mask@@11) (|Wand_state_contains_for_state_contains__get_out_1#triggerStateless| diz@@18) (|Wand_state_contains_for_state_contains__valid_wand#trigger| Heap@@25 (Wand_state_contains_for_state_contains__valid_wand diz@@18)))
)))
...
(assert (forall ((Heap@@26 T@U) (Mask@@12 T@U) (t_1@@4 T@U) ) (!  (=> (and (and (and (= (type Heap@@26) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (= (type t_1@@4) RefType)) (state Heap@@26 Mask@@12)) (= (|Tree__tolist'| Heap@@26 t_1@@4) (|Tree__tolist#frame| (FrameFragment (ite (not (= t_1@@4 null)) (MapType0Select Heap@@26 null (Tree__state t_1@@4)) EmptyFrame)) t_1@@4)))
 :qid |stdinbpl.1696:15|
 :skolemid |87|
 :pattern ( (state Heap@@26 Mask@@12) (|Tree__tolist'| Heap@@26 t_1@@4))
 :pattern ( (state Heap@@26 Mask@@12) (|Tree__tolist#triggerStateless| t_1@@4) (|Tree__state#trigger| Heap@@26 (Tree__state t_1@@4)) (|Tree__state#trigger| Heap@@26 (Tree__state t_1@@4)))
)))
...
(assert (forall ((s@@8 T@U) (t T@U) (n@@6 Int) ) (! (let ((T@@17 (SeqTypeInv0 (type s@@8))))
 (=> (and (and (= (type s@@8) (SeqType T@@17)) (= (type t) (SeqType T@@17))) (and (> n@@6 0) (> n@@6 (|Seq#Length| s@@8)))) (and (= (|Seq#Add| (|Seq#Sub| n@@6 (|Seq#Length| s@@8)) (|Seq#Length| s@@8)) n@@6) (= (|Seq#Drop| (|Seq#Append| s@@8 t) n@@6) (|Seq#Drop| t (|Seq#Sub| n@@6 (|Seq#Length| s@@8)))))))
 :qid |stdinbpl.372:18|
 :skolemid |44|
 :pattern ( (|Seq#Drop| (|Seq#Append| s@@8 t) n@@6))
)))
...
(assert (forall ((s@@9 T@U) (t@@0 T@U) (n@@7 Int) ) (! (let ((T@@18 (SeqTypeInv0 (type s@@9))))
 (=> (and (and (= (type s@@9) (SeqType T@@18)) (= (type t@@0) (SeqType T@@18))) (and (> n@@7 0) (> n@@7 (|Seq#Length| s@@9)))) (and (= (|Seq#Add| (|Seq#Sub| n@@7 (|Seq#Length| s@@9)) (|Seq#Length| s@@9)) n@@7) (= (|Seq#Take| (|Seq#Append| s@@9 t@@0) n@@7) (|Seq#Append| s@@9 (|Seq#Take| t@@0 (|Seq#Sub| n@@7 (|Seq#Length| s@@9))))))))
 :qid |stdinbpl.359:18|
 :skolemid |42|
 :pattern ( (|Seq#Take| (|Seq#Append| s@@9 t@@0) n@@7))
)))
...
(assert (forall ((Heap@@27 T@U) (Mask@@14 T@U) (diz@@19 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@27) (MapType0Type RefType)) (= (type Mask@@14) (MapType1Type RefType realType))) (= (type diz@@19) RefType)) (and (state Heap@@27 Mask@@14) (or (< AssumeFunctionsAbove 1) (|Wand_state_contains_for_state_contains__get_in_1#trigger| (MapType0Select Heap@@27 null (Wand_state_contains_for_state_contains__valid_wand diz@@19)) diz@@19)))) (not (= diz@@19 null))) (not (= (|Wand_state_contains_for_state_contains__get_in_1'| Heap@@27 diz@@19) null)))
 :qid |stdinbpl.638:15|
 :skolemid |62|
 :pattern ( (state Heap@@27 Mask@@14) (|Wand_state_contains_for_state_contains__get_in_1'| Heap@@27 diz@@19))
)))
(assert (forall ((Heap@@28 T@U) (Mask@@15 T@U) (diz@@20 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@28) (MapType0Type RefType)) (= (type Mask@@15) (MapType1Type RefType realType))) (= (type diz@@20) RefType)) (and (state Heap@@28 Mask@@15) (or (< AssumeFunctionsAbove 4) (|Wand_state_contains_for_state_contains__get_out_1#trigger| (MapType0Select Heap@@28 null (Wand_state_contains_for_state_contains__valid_wand diz@@20)) diz@@20)))) (not (= diz@@20 null))) (not (= (|Wand_state_contains_for_state_contains__get_out_1'| Heap@@28 diz@@20) null)))
 :qid |stdinbpl.1170:15|
 :skolemid |75|
 :pattern ( (state Heap@@28 Mask@@15) (|Wand_state_contains_for_state_contains__get_out_1'| Heap@@28 diz@@20))
)))
...
(assert (forall ((Heap@@29 T@U) (Mask@@16 T@U) (s@@10 T@U) ) (!  (=> (and (and (and (= (type Heap@@29) (MapType0Type RefType)) (= (type Mask@@16) (MapType1Type RefType realType))) (= (type s@@10) (SeqType intType))) (state Heap@@29 Mask@@16)) (= (|Tree__sorted_list'| Heap@@29 s@@10) (|Tree__sorted_list#frame| EmptyFrame s@@10)))
 :qid |stdinbpl.1881:15|
 :skolemid |93|
 :pattern ( (state Heap@@29 Mask@@16) (|Tree__sorted_list'| Heap@@29 s@@10))
)))
(assert (forall ((s@@11 T@U) (i@@2 Int) ) (! (let ((T@@20 (SeqTypeInv0 (type s@@11))))
 (=> (= (type s@@11) (SeqType T@@20)) (=> (and (<= 0 i@@2) (< i@@2 (|Seq#Length| s@@11))) (|Seq#ContainsTrigger| s@@11 (|Seq#Index| s@@11 i@@2)))))
 :qid |stdinbpl.403:18|
 :skolemid |49|
...
(assert (forall ((Heap@@30 T@U) (s@@13 T@U) ) (!  (=> (and (= (type Heap@@30) (MapType0Type RefType)) (= (type s@@13) (SeqType intType))) (and (= (Tree__sorted_list Heap@@30 s@@13) (|Tree__sorted_list'| Heap@@30 s@@13)) (dummyFunction (bool_2_U (|Tree__sorted_list#triggerStateless| s@@13)))))
 :qid |stdinbpl.1864:15|
 :skolemid |90|
 :pattern ( (Tree__sorted_list Heap@@30 s@@13))
)))
(assert (forall ((Heap@@31 T@U) (t_1@@5 T@U) ) (!  (=> (and (= (type Heap@@31) (MapType0Type RefType)) (= (type t_1@@5) RefType)) (and (= (Tree__sorted Heap@@31 t_1@@5) (|Tree__sorted'| Heap@@31 t_1@@5)) (dummyFunction (bool_2_U (|Tree__sorted#triggerStateless| t_1@@5)))))
 :qid |stdinbpl.1913:15|
 :skolemid |94|
 :pattern ( (Tree__sorted Heap@@31 t_1@@5))
)))
...
(assert (forall ((Heap@@32 T@U) (ExhaleHeap@@4 T@U) (Mask@@17 T@U) (pm_f@@1 T@U) ) (! (let ((C@@1 (FieldTypeInv0 (type pm_f@@1))))
 (=> (and (and (and (and (and (= (type Heap@@32) (MapType0Type RefType)) (= (type ExhaleHeap@@4) (MapType0Type RefType))) (= (type Mask@@17) (MapType1Type RefType realType))) (= (type pm_f@@1) (FieldType C@@1 FrameTypeType))) (IdenticalOnKnownLocations Heap@@32 ExhaleHeap@@4 Mask@@17)) (and (HasDirectPerm Mask@@17 null pm_f@@1) (IsPredicateField pm_f@@1))) (forall ((o2 T@U) (f_2@@0 T@U) ) (! (let ((B@@5 (FieldTypeInv1 (type f_2@@0))))
(let ((A@@6 (FieldTypeInv0 (type f_2@@0))))
 ...
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@32 ExhaleHeap@@4 Mask@@17) (IsPredicateField pm_f@@1))
)))
(assert (forall ((Heap@@33 T@U) (ExhaleHeap@@5 T@U) (Mask@@18 T@U) (pm_f@@2 T@U) ) (! (let ((C@@2 (FieldTypeInv0 (type pm_f@@2))))
 (=> (and (and (and (and (and (= (type Heap@@33) (MapType0Type RefType)) (= (type ExhaleHeap@@5) (MapType0Type RefType))) (= (type Mask@@18) (MapType1Type RefType realType))) (= (type pm_f@@2) (FieldType C@@2 FrameTypeType))) (IdenticalOnKnownLocations Heap@@33 ExhaleHeap@@5 Mask@@18)) (and (HasDirectPerm Mask@@18 null pm_f@@2) (IsWandField pm_f@@2))) (forall ((o2@@0 T@U) (f_2@@1 T@U) ) (! (let ((B@@6 (FieldTypeInv1 (type f_2@@1))))
(let ((A@@7 (FieldTypeInv0 (type f_2@@1))))
 ...
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@33 ExhaleHeap@@5 Mask@@18) (IsWandField pm_f@@2))
)))
...
(assert (forall ((Heap@@34 T@U) (Mask@@20 T@U) (diz@@23 T@U) ) (!  (=> (and (and (and (= (type Heap@@34) (MapType0Type RefType)) (= (type Mask@@20) (MapType1Type RefType realType))) (= (type diz@@23) RefType)) (state Heap@@34 Mask@@20)) (= (|Wand_state_contains_for_state_contains__get_in_1'| Heap@@34 diz@@23) (|Wand_state_contains_for_state_contains__get_in_1#frame| (MapType0Select Heap@@34 null (Wand_state_contains_for_state_contains__valid_wand diz@@23)) diz@@23)))
 :qid |stdinbpl.632:15|
 :skolemid |61|
 :pattern ( (state Heap@@34 Mask@@20) (|Wand_state_contains_for_state_contains__get_in_1'| Heap@@34 diz@@23))
)))
...
(assert (forall ((Heap@@35 T@U) (Mask@@21 T@U) (diz@@24 T@U) ) (!  (=> (and (and (and (= (type Heap@@35) (MapType0Type RefType)) (= (type Mask@@21) (MapType1Type RefType realType))) (= (type diz@@24) RefType)) (state Heap@@35 Mask@@21)) (= (|Wand_state_contains_for_state_contains__get_in_1_0'| Heap@@35 diz@@24) (|Wand_state_contains_for_state_contains__get_in_1_0#frame| (MapType0Select Heap@@35 null (Wand_state_contains_for_state_contains__valid_wand diz@@24)) diz@@24)))
 :qid |stdinbpl.904:15|
 :skolemid |68|
 :pattern ( (state Heap@@35 Mask@@21) (|Wand_state_contains_for_state_contains__get_in_1_0'| Heap@@35 diz@@24))
)))
...
(assert (forall ((Heap@@36 T@U) (Mask@@22 T@U) (diz@@25 T@U) ) (!  (=> (and (and (and (= (type Heap@@36) (MapType0Type RefType)) (= (type Mask@@22) (MapType1Type RefType realType))) (= (type diz@@25) RefType)) (state Heap@@36 Mask@@22)) (= (|Wand_state_contains_for_state_contains__get_out_1'| Heap@@36 diz@@25) (|Wand_state_contains_for_state_contains__get_out_1#frame| (MapType0Select Heap@@36 null (Wand_state_contains_for_state_contains__valid_wand diz@@25)) diz@@25)))
 :qid |stdinbpl.1164:15|
 :skolemid |74|
 :pattern ( (state Heap@@36 Mask@@22) (|Wand_state_contains_for_state_contains__get_out_1'| Heap@@36 diz@@25))
)))
...
(assert (forall ((Heap@@37 T@U) (Mask@@23 T@U) (diz@@26 T@U) ) (!  (=> (and (and (and (= (type Heap@@37) (MapType0Type RefType)) (= (type Mask@@23) (MapType1Type RefType realType))) (= (type diz@@26) RefType)) (state Heap@@37 Mask@@23)) (= (|Wand_state_contains_for_state_contains__get_out_1_0'| Heap@@37 diz@@26) (|Wand_state_contains_for_state_contains__get_out_1_0#frame| (MapType0Select Heap@@37 null (Wand_state_contains_for_state_contains__valid_wand diz@@26)) diz@@26)))
 :qid |stdinbpl.1436:15|
 :skolemid |81|
 :pattern ( (state Heap@@37 Mask@@23) (|Wand_state_contains_for_state_contains__get_out_1_0'| Heap@@37 diz@@26))
)))
(assert (forall ((o T@U) (f T@U) (Heap@@38 T@U) ) (!  (=> (and (and (and (= (type o) RefType) (= (type f) (FieldType NormalFieldType RefType))) (= (type Heap@@38) (MapType0Type RefType))) (U_2_bool (MapType0Select Heap@@38 o $allocated))) (U_2_bool (MapType0Select Heap@@38 (MapType0Select Heap@@38 o f) $allocated)))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (MapType0Select Heap@@38 o f))
)))
...
(assert (forall ((Heap@@39 T@U) (o@@0 T@U) (f_3 T@U) (v@@2 T@U) ) (! (let ((B@@8 (type v@@2)))
(let ((A@@9 (FieldTypeInv0 (type f_3))))
 (=> (and (and (= (type Heap@@39) (MapType0Type RefType)) (= (type o@@0) RefType)) (= (type f_3) (FieldType A@@9 B@@8))) (succHeap Heap@@39 (MapType0Store Heap@@39 o@@0 f_3 v@@2)))))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (MapType0Store Heap@@39 o@@0 f_3 v@@2))
)))
...
(declare-fun __flatten_24@0 () T@U)
...
(declare-fun __flatten_29 () T@U)
(declare-fun __flatten_31 () T@U)
(declare-fun __flatten_33 () T@U)
(declare-fun __flatten_69 () T@U)
(declare-fun __flatten_71 () T@U)
(declare-fun __flatten_72 () T@U)
(declare-fun __flatten_74 () T@U)
...
(declare-fun Heap@0 () T@U)
(declare-fun Heap@1 () T@U)
(declare-fun this_2 () T@U)
(declare-fun Heap@2 () T@U)
(declare-fun target_contents_2 () T@U)
(declare-fun Heap@3 () T@U)
(declare-fun top_2 () T@U)
(declare-fun Heap@4 () T@U)
(declare-fun Heap@5 () T@U)
(declare-fun Heap@6 () T@U)
(declare-fun wildcard@0 () Real)
...
(declare-fun diz@@29 () T@U)
(declare-fun wildcard () Real)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@33) (MapType0Type RefType)) (= (type __flatten_24@0) RefType)) (= (type out_1_0) (SeqType intType))) (= (type Mask@39) (MapType1Type RefType realType))) (= (type out_1) RefType)) (= (type in_1_0) (SeqType intType))) (= (type in_1) RefType)) (= (type AssertMask@0) (MapType1Type RefType realType))) (= (type Heap@31) (MapType0Type RefType))) (= (type Heap@30) (MapType0Type RefType))) (= (type Heap@32) (MapType0Type RefType))) (= (type Heap@23) (MapType0Type RefType))) (= (type newPMask@1) (MapType1Type RefType boolType))) (= (type Heap@28) (MapType0Type RefType))) (= (type Heap@29) (MapType0Type RefType))) (= (type Heap@26) (MapType0Type RefType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@27) (MapType0Type RefType))) (= (type Heap@24) (MapType0Type RefType))) (= (type Heap@25) (MapType0Type RefType))) (= (type Heap@11) (MapType0Type RefType))) (= (type Heap@10) (MapType0Type RefType))) (= (type Heap@12) (MapType0Type RefType))) (= (type Heap@13) (MapType0Type RefType))) (= (type Heap@14) (MapType0Type RefType))) (= (type Heap@15) (MapType0Type RefType))) (= (type Heap@16) (MapType0Type RefType))) (= (type Heap@17) (MapType0Type RefType))) (= (type Heap@18) (MapType0Type RefType))) (= (type Heap@19) (MapType0Type RefType))) (= (type Heap@20) (MapType0Type RefType))) (= (type Heap@21) (MapType0Type RefType))) (= (type Heap@22) (MapType0Type RefType))) (= (type Heap@8) (MapType0Type RefType))) (= (type Heap@7) (MapType0Type RefType))) (= (type Heap@9) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@38) (MapType1Type RefType realType))) (forall ((arg0@@60 T@U) (arg1@@31 T@U) ) (! (= (type (CombineFrames arg0@@60 arg1@@31)) FrameTypeType)
 :qid |funType:CombineFrames|
 :pattern ( (CombineFrames arg0@@60 arg1@@31))
))) (= (type Mask@35) (MapType1Type RefType realType))) (= (type Mask@36) (MapType1Type RefType realType))) (= (type Mask@37) (MapType1Type RefType realType))) (= (type Mask@28) (MapType1Type RefType realType))) (= (type Mask@34) (MapType1Type RefType realType))) (= (type Mask@33) (MapType1Type RefType realType))) (= (type Mask@31) (MapType1Type RefType realType))) (= (type Mask@32) (MapType1Type RefType realType))) (= (type Mask@30) (MapType1Type RefType realType))) (= (type Mask@29) (MapType1Type RefType realType))) (= (type Heap@@41) (MapType0Type RefType))) (= (type vwand) RefType)) (= (type __flatten_24) RefType)) (= (type __flatten_26) RefType)) (= (type __flatten_28) RefType)) (= (type __flatten_29) RefType)) (= (type __flatten_31) RefType)) (= (type __flatten_33) RefType)) (= (type __flatten_69) RefType)) (= (type __flatten_71) RefType)) (= (type __flatten_72) RefType)) (= (type __flatten_74) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type Mask@7) (MapType1Type RefType realType))) (= (type Mask@8) (MapType1Type RefType realType))) (= (type Mask@9) (MapType1Type RefType realType))) (= (type Mask@10) (MapType1Type RefType realType))) (= (type Mask@11) (MapType1Type RefType realType))) (= (type Mask@12) (MapType1Type RefType realType))) (= (type Mask@13) (MapType1Type RefType realType))) (= (type Mask@14) (MapType1Type RefType realType))) (= (type Mask@15) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type this_2) RefType)) (= (type Heap@2) (MapType0Type RefType))) (= (type target_contents_2) (SeqType intType))) (= (type Heap@3) (MapType0Type RefType))) (= (type top_2) RefType)) (= (type Heap@4) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@6) (MapType0Type RefType))) (= (type Mask@16) (MapType1Type RefType realType))) (= (type Mask@17) (MapType1Type RefType realType))) (= (type Mask@18) (MapType1Type RefType realType))) (= (type Mask@19) (MapType1Type RefType realType))) (= (type Mask@20) (MapType1Type RefType realType))) (= (type Mask@21) (MapType1Type RefType realType))) (= (type Mask@22) (MapType1Type RefType realType))) (= (type Mask@23) (MapType1Type RefType realType))) (= (type Mask@24) (MapType1Type RefType realType))) (= (type Mask@25) (MapType1Type RefType realType))) (= (type Mask@26) (MapType1Type RefType realType))) (= (type Mask@27) (MapType1Type RefType realType))) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type sys__result) RefType)) (= (type PostHeap@0) (MapType0Type RefType))) (= (type diz@@29) RefType)))
(set-info :boogie-vc-id Tree__Wand_state_contains_for_state_contains_lemma_2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 156) (let ((anon4_correct true))
(let ((anon63_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 151) 148)) anon4_correct)))
(let ((anon63_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 149) (- 0 150)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (Wand_state_contains_for_state_contains__valid_wand sys__result))))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (Wand_state_contains_for_state_contains__valid_wand sys__result)))) (=> (= (ControlFlow 0 149) 148) anon4_correct))))))
(let ((anon62_Then_correct  (and (=> (= (ControlFlow 0 152) (- 0 153)) (not (= sys__result null))) (=> (not (= sys__result null)) (and (=> (= (ControlFlow 0 152) 149) anon63_Then_correct) (=> (= (ControlFlow 0 152) 151) anon63_Else_correct))))))
(let ((anon8_correct true))
(let ((anon65_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 144) 141)) anon8_correct)))
(let ((anon65_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 142) (- 0 143)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (Wand_state_contains_for_state_contains__valid_wand sys__result))))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (Wand_state_contains_for_state_contains__valid_wand sys__result)))) (=> (= (ControlFlow 0 142) 141) anon8_correct))))))
(let ((anon64_Then_correct  (and (=> (= (ControlFlow 0 145) (- 0 146)) (not (= sys__result null))) (=> (not (= sys__result null)) (and (=> (= (ControlFlow 0 145) 142) anon65_Then_correct) (=> (= (ControlFlow 0 145) 144) anon65_Else_correct))))))
(let ((anon12_correct true))
(let ((anon67_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 137) 134)) anon12_correct)))
(let ((anon67_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 135) (- 0 136)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (Wand_state_contains_for_state_contains__valid_wand sys__result))))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (Wand_state_contains_for_state_contains__valid_wand sys__result)))) (=> (= (ControlFlow 0 135) 134) anon12_correct))))))
(let ((anon66_Then_correct  (and (=> (= (ControlFlow 0 138) (- 0 139)) (not (= sys__result null))) (=> (not (= sys__result null)) (and (=> (= (ControlFlow 0 138) 135) anon67_Then_correct) (=> (= (ControlFlow 0 138) 137) anon67_Else_correct))))))
(let ((anon16_correct true))
(let ((anon69_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 130) 127)) anon16_correct)))
(let ((anon69_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 128) (- 0 129)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (Wand_state_contains_for_state_contains__valid_wand sys__result))))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (Wand_state_contains_for_state_contains__valid_wand sys__result)))) (=> (= (ControlFlow 0 128) 127) anon16_correct))))))
(let ((anon68_Then_correct  (and (=> (= (ControlFlow 0 131) (- 0 132)) (not (= sys__result null))) (=> (not (= sys__result null)) (and (=> (= (ControlFlow 0 131) 128) anon69_Then_correct) (=> (= (ControlFlow 0 131) 130) anon69_Else_correct))))))
(let ((anon68_Else_correct true))
(let ((anon66_Else_correct  (=> (= (Wand_state_contains_for_state_contains__get_out_1 PostHeap@0 sys__result) out_1) (=> (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)) (and (=> (= (ControlFlow 0 133) 131) anon68_Then_correct) (=> (= (ControlFlow 0 133) 126) anon68_Else_correct))))))
(let ((anon64_Else_correct  (=> (|Seq#Equal| (Wand_state_contains_for_state_contains__get_in_1_0 PostHeap@0 sys__result) in_1_0) (=> (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)) (and (=> (= (ControlFlow 0 140) 138) anon66_Then_correct) (=> (= (ControlFlow 0 140) 133) anon66_Else_correct))))))
(let ((anon62_Else_correct  (=> (= (Wand_state_contains_for_state_contains__get_in_1 PostHeap@0 sys__result) in_1) (=> (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)) (and (=> (= (ControlFlow 0 147) 145) anon64_Then_correct) (=> (= (ControlFlow 0 147) 140) anon64_Else_correct))))))
(let ((anon61_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (not (= sys__result null)) (state PostHeap@0 ZeroMask)) (=> (and (and (= PostMask@0 (MapType1Store ZeroMask null (Wand_state_contains_for_state_contains__valid_wand sys__result) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Wand_state_contains_for_state_contains__valid_wand sys__result))) FullPerm)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 154) 152) anon62_Then_correct) (=> (= (ControlFlow 0 154) 147) anon62_Else_correct)))))))
(let ((anon45_correct true))
(let ((anon83_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 31) 28)) anon45_correct)))
(let ((anon83_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (<= FullPerm (U_2_real (MapType1Select Mask@39 null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@39 null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0)))) (=> (= (ControlFlow 0 29) 28) anon45_correct))))))
(let ((anon82_Then_correct  (and (=> (= (ControlFlow 0 32) (- 0 33)) (not (= __flatten_24@0 null))) (=> (not (= __flatten_24@0 null)) (and (=> (= (ControlFlow 0 32) 29) anon83_Then_correct) (=> (= (ControlFlow 0 32) 31) anon83_Else_correct))))))
(let ((anon49_correct true))
(let ((anon85_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 23) 20)) anon49_correct)))
(let ((anon85_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (<= FullPerm (U_2_real (MapType1Select Mask@39 null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@39 null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0)))) (=> (= (ControlFlow 0 21) 20) anon49_correct))))))
(let ((anon84_Then_correct  (and (=> (= (ControlFlow 0 24) (- 0 25)) (not (= __flatten_24@0 null))) (=> (not (= __flatten_24@0 null)) (and (=> (= (ControlFlow 0 24) 21) anon85_Then_correct) (=> (= (ControlFlow 0 24) 23) anon85_Else_correct))))))
(let ((anon53_correct true))
(let ((anon87_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 15) 12)) anon53_correct)))
(let ((anon87_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= FullPerm (U_2_real (MapType1Select Mask@39 null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@39 null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0)))) (=> (= (ControlFlow 0 13) 12) anon53_correct))))))
(let ((anon86_Then_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (not (= __flatten_24@0 null))) (=> (not (= __flatten_24@0 null)) (and (=> (= (ControlFlow 0 16) 13) anon87_Then_correct) (=> (= (ControlFlow 0 16) 15) anon87_Else_correct))))))
(let ((anon57_correct true))
(let ((anon89_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 4)) anon57_correct)))
(let ((anon89_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@39 null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@39 null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0)))) (=> (= (ControlFlow 0 5) 4) anon57_correct))))))
(let ((anon88_Then_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (not (= __flatten_24@0 null))) (=> (not (= __flatten_24@0 null)) (and (=> (= (ControlFlow 0 8) 5) anon89_Then_correct) (=> (= (ControlFlow 0 8) 7) anon89_Else_correct))))))
(let ((anon88_Else_correct  (=> (= (ControlFlow 0 2) (- 0 3)) (|Seq#Equal| (Wand_state_contains_for_state_contains__get_out_1_0 Heap@33 __flatten_24@0) out_1_0))))
(let ((anon86_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (= (Wand_state_contains_for_state_contains__get_out_1 Heap@33 __flatten_24@0) out_1)) (=> (= (Wand_state_contains_for_state_contains__get_out_1 Heap@33 __flatten_24@0) out_1) (and (=> (= (ControlFlow 0 10) 8) anon88_Then_correct) (=> (= (ControlFlow 0 10) 2) anon88_Else_correct))))))
(let ((anon84_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (|Seq#Equal| (Wand_state_contains_for_state_contains__get_in_1_0 Heap@33 __flatten_24@0) in_1_0)) (=> (|Seq#Equal| (Wand_state_contains_for_state_contains__get_in_1_0 Heap@33 __flatten_24@0) in_1_0) (and (=> (= (ControlFlow 0 18) 16) anon86_Then_correct) (=> (= (ControlFlow 0 18) 10) anon86_Else_correct))))))
(let ((anon82_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (= (Wand_state_contains_for_state_contains__get_in_1 Heap@33 __flatten_24@0) in_1)) (=> (= (Wand_state_contains_for_state_contains__get_in_1 Heap@33 __flatten_24@0) in_1) (and (=> (= (ControlFlow 0 26) 24) anon84_Then_correct) (=> (= (ControlFlow 0 26) 18) anon84_Else_correct))))))
(let ((anon42_correct  (=> (= AssertMask@0 (MapType1Store Mask@39 null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0) (real_2_U (- (U_2_real (MapType1Select Mask@39 null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0))) FullPerm)))) (and (=> (= (ControlFlow 0 34) 32) anon82_Then_correct) (=> (= (ControlFlow 0 34) 26) anon82_Else_correct)))))
(let ((anon81_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 37) 34)) anon42_correct)))
(let ((anon81_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 35) (- 0 36)) (<= FullPerm (U_2_real (MapType1Select Mask@39 null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@39 null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0)))) (=> (= (ControlFlow 0 35) 34) anon42_correct))))))
(let ((anon40_correct  (=> (= Heap@31 (MapType0Store Heap@30 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (MapType1Store (MapType0Select Heap@30 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0)) __flatten_24@0 Wand_state_contains_for_state_contains__this_2 (bool_2_U true)))) (=> (and (= Heap@32 (MapType0Store Heap@31 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (MapType1Store (MapType0Select Heap@31 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0)) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2 (bool_2_U true)))) (= Heap@33 (MapType0Store Heap@32 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (MapType1Store (MapType0Select Heap@32 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0)) __flatten_24@0 Wand_state_contains_for_state_contains__top_2 (bool_2_U true))))) (=> (and (and (state Heap@33 Mask@39) (state Heap@33 Mask@39)) (and (state Heap@33 Mask@39) (state Heap@33 Mask@39))) (and (=> (= (ControlFlow 0 38) (- 0 39)) (not (= __flatten_24@0 null))) (=> (not (= __flatten_24@0 null)) (and (=> (= (ControlFlow 0 38) 35) anon81_Then_correct) (=> (= (ControlFlow 0 38) 37) anon81_Else_correct)))))))))
(let ((anon39_correct  (=> (and (and (forall ((o_18 T@U) (f_22 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_22))))
(let ((A@@12 (FieldTypeInv0 (type f_22))))
 (=> (and (and (= (type o_18) RefType) (= (type f_22) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@28 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0)) o_18 f_22)) (U_2_bool (MapType1Select (MapType0Select Heap@28 null (|Wand_state_contains_for_state_contains__valid_wand#sm| (MapType0Select Heap@28 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1))) o_18 f_22)))) (U_2_bool (MapType1Select newPMask@1 o_18 f_22)))))
 :qid |stdinbpl.5785:29|
 :skolemid |115|
 :pattern ( (MapType1Select newPMask@1 o_18 f_22))
)) (= Heap@29 (MapType0Store Heap@28 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) newPMask@1))) (and (= Heap@30 Heap@29) (= (ControlFlow 0 41) 38))) anon40_correct)))
(let ((anon80_Else_correct  (=> (= (MapType0Select Heap@26 (MapType0Select Heap@26 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right) null) (=> (and (= Heap@28 Heap@26) (= (ControlFlow 0 43) 41)) anon39_correct))))
(let ((anon80_Then_correct  (=> (not (= (MapType0Select Heap@26 (MapType0Select Heap@26 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right) null)) (=> (and (and (forall ((o_17 T@U) (f_21 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_21))))
(let ((A@@13 (FieldTypeInv0 (type f_21))))
 (=> (and (and (= (type o_17) RefType) (= (type f_21) (FieldType A@@13 B@@12))) (or (U_2_bool (MapType1Select (MapType0Select Heap@26 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0)) o_17 f_21)) (U_2_bool (MapType1Select (MapType0Select Heap@26 null (|Tree__state#sm| (MapType0Select Heap@26 (MapType0Select Heap@26 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right))) o_17 f_21)))) (U_2_bool (MapType1Select newPMask@0 o_17 f_21)))))
 :qid |stdinbpl.5778:31|
 :skolemid |114|
 :pattern ( (MapType1Select newPMask@0 o_17 f_21))
)) (= Heap@27 (MapType0Store Heap@26 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) newPMask@0))) (and (= Heap@28 Heap@27) (= (ControlFlow 0 42) 41))) anon39_correct))))
(let ((anon79_Then_correct  (=> (and (and (= (U_2_int (MapType0Select Heap@23 __flatten_24@0 Wand_state_contains_for_state_contains__lemma)) 1) (= Heap@24 (MapType0Store Heap@23 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (MapType1Store (MapType0Select Heap@23 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0)) (MapType0Select Heap@23 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__left (bool_2_U true))))) (and (= Heap@25 (MapType0Store Heap@24 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (MapType1Store (MapType0Select Heap@24 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0)) (MapType0Select Heap@24 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__data (bool_2_U true)))) (= Heap@26 (MapType0Store Heap@25 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (MapType1Store (MapType0Select Heap@25 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0)) (MapType0Select Heap@25 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right (bool_2_U true)))))) (and (=> (= (ControlFlow 0 44) 42) anon80_Then_correct) (=> (= (ControlFlow 0 44) 43) anon80_Else_correct)))))
(let ((anon79_Else_correct  (=> (not (= (U_2_int (MapType0Select Heap@23 __flatten_24@0 Wand_state_contains_for_state_contains__lemma)) 1)) (=> (and (= Heap@30 Heap@23) (= (ControlFlow 0 40) 38)) anon40_correct))))
(let ((anon36_correct  (=> (= Heap@11 (MapType0Store Heap@10 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (MapType1Store (MapType0Select Heap@10 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0)) __flatten_24@0 Wand_state_contains_for_state_contains__lemma (bool_2_U true)))) (=> (and (and (= Heap@12 (MapType0Store Heap@11 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (MapType1Store (MapType0Select Heap@11 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0)) __flatten_24@0 Wand_state_contains_for_state_contains__in_1 (bool_2_U true)))) (= Heap@13 (MapType0Store Heap@12 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (MapType1Store (MapType0Select Heap@12 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0)) __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0 (bool_2_U true))))) (and (= Heap@14 (MapType0Store Heap@13 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (MapType1Store (MapType0Select Heap@13 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0)) __flatten_24@0 Wand_state_contains_for_state_contains__out_1 (bool_2_U true)))) (= Heap@15 (MapType0Store Heap@14 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (MapType1Store (MapType0Select Heap@14 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0)) __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0 (bool_2_U true)))))) (=> (and (and (and (= Heap@16 (MapType0Store Heap@15 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (MapType1Store (MapType0Select Heap@15 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0)) __flatten_24@0 Wand_state_contains_for_state_contains__this_1 (bool_2_U true)))) (= Heap@17 (MapType0Store Heap@16 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (MapType1Store (MapType0Select Heap@16 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0)) __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1 (bool_2_U true))))) (and (= Heap@18 (MapType0Store Heap@17 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (MapType1Store (MapType0Select Heap@17 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0)) __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1 (bool_2_U true)))) (= Heap@19 (MapType0Store Heap@18 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (MapType1Store (MapType0Select Heap@18 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0)) __flatten_24@0 Wand_state_contains_for_state_contains__prev_1 (bool_2_U true)))))) (and (and (= Heap@20 (MapType0Store Heap@19 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (MapType1Store (MapType0Select Heap@19 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0)) __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1 (bool_2_U true)))) (= Heap@21 (MapType0Store Heap@20 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (MapType1Store (MapType0Select Heap@20 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0)) __flatten_24@0 Wand_state_contains_for_state_contains__top_1 (bool_2_U true))))) (and (= Heap@22 (MapType0Store Heap@21 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (MapType1Store (MapType0Select Heap@21 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0)) __flatten_24@0 Wand_state_contains_for_state_contains__cur_1 (bool_2_U true)))) (= Heap@23 (MapType0Store Heap@22 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) (MapType1Store (MapType0Select Heap@22 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0)) __flatten_24@0 Wand_state_contains_for_state_contains__wand_1 (bool_2_U true))))))) (and (=> (= (ControlFlow 0 45) 44) anon79_Then_correct) (=> (= (ControlFlow 0 45) 40) anon79_Else_correct)))))))
(let ((anon78_Else_correct  (=> (HasDirectPerm Mask@39 null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0)) (=> (and (= Heap@10 Heap@7) (= (ControlFlow 0 47) 45)) anon36_correct))))
(let ((anon78_Then_correct  (=> (not (HasDirectPerm Mask@39 null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0))) (=> (and (and (= Heap@8 (MapType0Store Heap@7 null (|Wand_state_contains_for_state_contains__valid_wand#sm| __flatten_24@0) ZeroPMask)) (= Heap@9 (MapType0Store Heap@8 null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0) freshVersion@0))) (and (= Heap@10 Heap@9) (= (ControlFlow 0 46) 45))) anon36_correct))))
(let ((anon34_correct  (and (=> (= (ControlFlow 0 48) (- 0 49)) (<= (U_2_int (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__lemma)) 2)) (=> (<= (U_2_int (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__lemma)) 2) (=> (= Mask@39 (MapType1Store Mask@38 null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0) (real_2_U (+ (U_2_real (MapType1Select Mask@38 null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0))) FullPerm)))) (=> (and (and (state Heap@7 Mask@39) (state Heap@7 Mask@39)) (and (|Wand_state_contains_for_state_contains__valid_wand#trigger| Heap@7 (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0)) (= (MapType0Select Heap@7 null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0)) (CombineFrames (FrameFragment (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__lemma)) (CombineFrames (FrameFragment (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__in_1)) (CombineFrames (FrameFragment (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0)) (CombineFrames (FrameFragment (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__out_1)) (CombineFrames (FrameFragment (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0)) (CombineFrames (FrameFragment (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__this_1)) (CombineFrames (FrameFragment (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1)) (CombineFrames (FrameFragment (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1)) (CombineFrames (FrameFragment (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1)) (CombineFrames (FrameFragment (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1)) (CombineFrames (FrameFragment (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__top_1)) (CombineFrames (FrameFragment (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__cur_1)) (CombineFrames (FrameFragment (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) (CombineFrames (FrameFragment (ite (= (U_2_int (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__lemma)) 1) (CombineFrames (CombineFrames (FrameFragment (MapType0Select Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__left)) (FrameFragment (MapType0Select Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__data))) (CombineFrames (CombineFrames (FrameFragment (MapType0Select Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)) (FrameFragment (ite (not (= (MapType0Select Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right) null)) (MapType0Select Heap@7 null (Tree__state (MapType0Select Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right))) EmptyFrame))) (MapType0Select Heap@7 null (Wand_state_contains_for_state_contains__valid_wand (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1))))) EmptyFrame)) (CombineFrames (FrameFragment (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__this_2)) (CombineFrames (FrameFragment (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2)) (CombineFrames (FrameFragment (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__top_2)) (FrameFragment (ite (= (U_2_int (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__lemma)) 2) EmptyFrame EmptyFrame)))))))))))))))))))))) (and (=> (= (ControlFlow 0 48) 46) anon78_Then_correct) (=> (= (ControlFlow 0 48) 47) anon78_Else_correct))))))))
(let ((anon77_Else_correct  (=> (and (not (= (U_2_int (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__lemma)) 2)) (= (ControlFlow 0 56) 48)) anon34_correct)))
(let ((anon77_Then_correct  (=> (= (U_2_int (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__lemma)) 2) (and (=> (= (ControlFlow 0 50) (- 0 55)) (not (= (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__this_2) null))) (=> (not (= (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__this_2) null)) (and (=> (= (ControlFlow 0 50) (- 0 54)) (= (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__in_1) (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__top_2))) (=> (= (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__in_1) (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__top_2)) (and (=> (= (ControlFlow 0 50) (- 0 53)) (|Seq#Equal| (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0) (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2))) (=> (|Seq#Equal| (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0) (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2)) (and (=> (= (ControlFlow 0 50) (- 0 52)) (= (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__out_1) (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__top_2))) (=> (= (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__out_1) (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__top_2)) (and (=> (= (ControlFlow 0 50) (- 0 51)) (|Seq#Equal| (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0) (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2))) (=> (|Seq#Equal| (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0) (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2)) (=> (= (ControlFlow 0 50) 48) anon34_correct))))))))))))))
(let ((anon32_correct  (and (=> (= (ControlFlow 0 57) (- 0 60)) (> (U_2_real (MapType1Select Mask@35 __flatten_24@0 Wand_state_contains_for_state_contains__this_2)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@35 __flatten_24@0 Wand_state_contains_for_state_contains__this_2)) NoPerm) (=> (> wildcard@13 NoPerm) (=> (and (< wildcard@13 (U_2_real (MapType1Select Mask@35 __flatten_24@0 Wand_state_contains_for_state_contains__this_2))) (= Mask@36 (MapType1Store Mask@35 __flatten_24@0 Wand_state_contains_for_state_contains__this_2 (real_2_U (- (U_2_real (MapType1Select Mask@35 __flatten_24@0 Wand_state_contains_for_state_contains__this_2)) wildcard@13))))) (and (=> (= (ControlFlow 0 57) (- 0 59)) (> (U_2_real (MapType1Select Mask@36 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@36 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2)) NoPerm) (=> (> wildcard@14 NoPerm) (=> (and (< wildcard@14 (U_2_real (MapType1Select Mask@36 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2))) (= Mask@37 (MapType1Store Mask@36 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2 (real_2_U (- (U_2_real (MapType1Select Mask@36 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2)) wildcard@14))))) (and (=> (= (ControlFlow 0 57) (- 0 58)) (> (U_2_real (MapType1Select Mask@37 __flatten_24@0 Wand_state_contains_for_state_contains__top_2)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@37 __flatten_24@0 Wand_state_contains_for_state_contains__top_2)) NoPerm) (=> (> wildcard@15 NoPerm) (=> (and (< wildcard@15 (U_2_real (MapType1Select Mask@37 __flatten_24@0 Wand_state_contains_for_state_contains__top_2))) (= Mask@38 (MapType1Store Mask@37 __flatten_24@0 Wand_state_contains_for_state_contains__top_2 (real_2_U (- (U_2_real (MapType1Select Mask@37 __flatten_24@0 Wand_state_contains_for_state_contains__top_2)) wildcard@15))))) (and (=> (= (ControlFlow 0 57) 50) anon77_Then_correct) (=> (= (ControlFlow 0 57) 56) anon77_Else_correct))))))))))))))))
(let ((anon31_correct  (=> (and (= Mask@34 (MapType1Store Mask@33 null (Wand_state_contains_for_state_contains__valid_wand (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) (real_2_U (- (U_2_real (MapType1Select Mask@33 null (Wand_state_contains_for_state_contains__valid_wand (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)))) FullPerm)))) (InsidePredicate (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0) (MapType0Select Heap@7 null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0)) (Wand_state_contains_for_state_contains__valid_wand (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) (MapType0Select Heap@7 null (Wand_state_contains_for_state_contains__valid_wand (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1))))) (and (=> (= (ControlFlow 0 62) (- 0 70)) (= (Wand_state_contains_for_state_contains__get_in_1 Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1))) (=> (= (Wand_state_contains_for_state_contains__get_in_1 Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1)) (and (=> (= (ControlFlow 0 62) (- 0 69)) (|Seq#Equal| (Wand_state_contains_for_state_contains__get_in_1_0 Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) (|Seq#Drop| (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1) 1))) (=> (|Seq#Equal| (Wand_state_contains_for_state_contains__get_in_1_0 Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) (|Seq#Drop| (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1) 1)) (and (=> (= (ControlFlow 0 62) (- 0 68)) (= (Wand_state_contains_for_state_contains__get_out_1 Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__top_1))) (=> (= (Wand_state_contains_for_state_contains__get_out_1 Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__top_1)) (and (=> (= (ControlFlow 0 62) (- 0 67)) (|Seq#Equal| (Wand_state_contains_for_state_contains__get_out_1_0 Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1))) (=> (|Seq#Equal| (Wand_state_contains_for_state_contains__get_out_1_0 Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1)) (and (=> (= (ControlFlow 0 62) (- 0 66)) (= (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__in_1) (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__cur_1))) (=> (= (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__in_1) (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__cur_1)) (and (=> (= (ControlFlow 0 62) (- 0 65)) (|Seq#Equal| (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0) (|Seq#Drop| (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1) 1))) (=> (|Seq#Equal| (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0) (|Seq#Drop| (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1) 1)) (and (=> (= (ControlFlow 0 62) (- 0 64)) (= (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__out_1) (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__top_1))) (=> (= (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__out_1) (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__top_1)) (and (=> (= (ControlFlow 0 62) (- 0 63)) (|Seq#Equal| (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0) (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1))) (=> (|Seq#Equal| (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0) (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1)) (=> (and (= Mask@35 Mask@34) (= (ControlFlow 0 62) 57)) anon32_correct))))))))))))))))))))
(let ((anon76_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 73) 62)) anon31_correct)))
(let ((anon76_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 71) (- 0 72)) (<= FullPerm (U_2_real (MapType1Select Mask@33 null (Wand_state_contains_for_state_contains__valid_wand (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@33 null (Wand_state_contains_for_state_contains__valid_wand (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1))))) (=> (= (ControlFlow 0 71) 62) anon31_correct))))))
(let ((anon29_correct  (and (=> (= (ControlFlow 0 74) (- 0 77)) (= (MapType0Select Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__left) (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__cur_1))) (=> (= (MapType0Select Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__left) (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__cur_1)) (and (=> (= (ControlFlow 0 74) (- 0 76)) (|Seq#Equal| (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1) (|Seq#Append| (|Seq#Append| (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1) (|Seq#Singleton| (MapType0Select Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__data))) (Tree__tolist Heap@7 (MapType0Select Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right))))) (=> (|Seq#Equal| (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1) (|Seq#Append| (|Seq#Append| (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1) (|Seq#Singleton| (MapType0Select Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__data))) (Tree__tolist Heap@7 (MapType0Select Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))) (and (=> (= (ControlFlow 0 74) (- 0 75)) (not (= (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1) null))) (=> (not (= (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1) null)) (and (=> (= (ControlFlow 0 74) 71) anon76_Then_correct) (=> (= (ControlFlow 0 74) 73) anon76_Else_correct))))))))))
(let ((anon28_correct  (=> (and (and (= Mask@32 (MapType1Store Mask@31 null (Tree__state (MapType0Select Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)) (real_2_U (- (U_2_real (MapType1Select Mask@31 null (Tree__state (MapType0Select Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))) FullPerm)))) (InsidePredicate (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0) (MapType0Select Heap@7 null (Wand_state_contains_for_state_contains__valid_wand __flatten_24@0)) (Tree__state (MapType0Select Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)) (MapType0Select Heap@7 null (Tree__state (MapType0Select Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right))))) (and (= Mask@33 Mask@32) (= (ControlFlow 0 79) 74))) anon29_correct)))
(let ((anon75_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 82) 79)) anon28_correct)))
(let ((anon75_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 80) (- 0 81)) (<= FullPerm (U_2_real (MapType1Select Mask@31 null (Tree__state (MapType0Select Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@31 null (Tree__state (MapType0Select Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right))))) (=> (= (ControlFlow 0 80) 79) anon28_correct))))))
(let ((anon74_Then_correct  (=> (not (= (MapType0Select Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right) null)) (and (=> (= (ControlFlow 0 83) 80) anon75_Then_correct) (=> (= (ControlFlow 0 83) 82) anon75_Else_correct)))))
(let ((anon74_Else_correct  (=> (= (MapType0Select Heap@7 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right) null) (=> (and (= Mask@33 Mask@31) (= (ControlFlow 0 78) 74)) anon29_correct))))
(let ((anon25_correct  (=> (= Mask@31 (MapType1Store Mask@30 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right (real_2_U (- (U_2_real (MapType1Select Mask@30 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)) FullPerm)))) (and (=> (= (ControlFlow 0 84) 83) anon74_Then_correct) (=> (= (ControlFlow 0 84) 78) anon74_Else_correct)))))
(let ((anon73_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 87) 84)) anon25_correct)))
(let ((anon73_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 85) (- 0 86)) (<= FullPerm (U_2_real (MapType1Select Mask@30 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@30 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__right))) (=> (= (ControlFlow 0 85) 84) anon25_correct))))))
(let ((anon23_correct  (=> (= Mask@30 (MapType1Store Mask@29 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__data (real_2_U (- (U_2_real (MapType1Select Mask@29 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__data)) FullPerm)))) (and (=> (= (ControlFlow 0 88) 85) anon73_Then_correct) (=> (= (ControlFlow 0 88) 87) anon73_Else_correct)))))
(let ((anon72_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 91) 88)) anon23_correct)))
(let ((anon72_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 89) (- 0 90)) (<= FullPerm (U_2_real (MapType1Select Mask@29 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__data)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@29 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__data))) (=> (= (ControlFlow 0 89) 88) anon23_correct))))))
(let ((anon21_correct  (=> (= Mask@29 (MapType1Store Mask@28 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__left (real_2_U (- (U_2_real (MapType1Select Mask@28 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__left)) FullPerm)))) (and (=> (= (ControlFlow 0 92) 89) anon72_Then_correct) (=> (= (ControlFlow 0 92) 91) anon72_Else_correct)))))
(let ((anon71_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 95) 92)) anon21_correct)))
(let ((anon71_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 93) (- 0 94)) (<= FullPerm (U_2_real (MapType1Select Mask@28 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__left)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@28 (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) Tree__left))) (=> (= (ControlFlow 0 93) 92) anon21_correct))))))
(let ((anon70_Then_correct  (=> (= (U_2_int (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__lemma)) 1) (and (=> (= (ControlFlow 0 96) (- 0 99)) (not (= (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__this_1) null))) (=> (not (= (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__this_1) null)) (and (=> (= (ControlFlow 0 96) (- 0 98)) (> (|Seq#Length| (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1)) 0)) (=> (> (|Seq#Length| (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1)) 0) (and (=> (= (ControlFlow 0 96) (- 0 97)) (> (|Seq#Length| (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1)) 0)) (=> (> (|Seq#Length| (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1)) 0) (and (=> (= (ControlFlow 0 96) 93) anon71_Then_correct) (=> (= (ControlFlow 0 96) 95) anon71_Else_correct)))))))))))
(let ((anon70_Else_correct  (=> (not (= (U_2_int (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__lemma)) 1)) (=> (and (= Mask@35 Mask@28) (= (ControlFlow 0 61) 57)) anon32_correct))))
(let ((anon61_Else_correct  (=> (U_2_bool (MapType0Select Heap@@41 vwand $allocated)) (=> (and (U_2_bool (MapType0Select Heap@@41 __flatten_24 $allocated)) (U_2_bool (MapType0Select Heap@@41 __flatten_26 $allocated))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@41 __flatten_28 $allocated)) (U_2_bool (MapType0Select Heap@@41 __flatten_29 $allocated))) (and (U_2_bool (MapType0Select Heap@@41 __flatten_31 $allocated)) (U_2_bool (MapType0Select Heap@@41 __flatten_33 $allocated)))) (and (and (U_2_bool (MapType0Select Heap@@41 __flatten_69 $allocated)) (U_2_bool (MapType0Select Heap@@41 __flatten_71 $allocated))) (and (U_2_bool (MapType0Select Heap@@41 __flatten_72 $allocated)) (U_2_bool (MapType0Select Heap@@41 __flatten_74 $allocated))))) (and (=> (= (ControlFlow 0 100) (- 0 125)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (=> (not (= __flatten_24@0 null)) (=> (and (not (= __flatten_24@0 null)) (= Mask@0 (MapType1Store ZeroMask __flatten_24@0 Wand_state_contains_for_state_contains__lemma (real_2_U (+ (U_2_real (MapType1Select ZeroMask __flatten_24@0 Wand_state_contains_for_state_contains__lemma)) FullPerm))))) (=> (and (and (state Heap@@41 Mask@0) (= (U_2_int (MapType0Select Heap@@41 __flatten_24@0 Wand_state_contains_for_state_contains__lemma)) 0)) (and (not (= __flatten_24@0 null)) (= Mask@1 (MapType1Store Mask@0 __flatten_24@0 Wand_state_contains_for_state_contains__in_1 (real_2_U (+ (U_2_real (MapType1Select Mask@0 __flatten_24@0 Wand_state_contains_for_state_contains__in_1)) FullPerm)))))) (=> (and (and (and (and (and (and (state Heap@@41 Mask@1) (= (MapType0Select Heap@@41 __flatten_24@0 Wand_state_contains_for_state_contains__in_1) null)) (and (not (= __flatten_24@0 null)) (= Mask@2 (MapType1Store Mask@1 __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0 (real_2_U (+ (U_2_real (MapType1Select Mask@1 __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0)) FullPerm)))))) (and (and (state Heap@@41 Mask@2) (|Seq#Equal| (MapType0Select Heap@@41 __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0) (|Seq#Empty| intType))) (and (not (= __flatten_24@0 null)) (= Mask@3 (MapType1Store Mask@2 __flatten_24@0 Wand_state_contains_for_state_contains__out_1 (real_2_U (+ (U_2_real (MapType1Select Mask@2 __flatten_24@0 Wand_state_contains_for_state_contains__out_1)) FullPerm))))))) (and (and (and (state Heap@@41 Mask@3) (= (MapType0Select Heap@@41 __flatten_24@0 Wand_state_contains_for_state_contains__out_1) null)) (and (not (= __flatten_24@0 null)) (= Mask@4 (MapType1Store Mask@3 __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0 (real_2_U (+ (U_2_real (MapType1Select Mask@3 __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0)) FullPerm)))))) (and (and (state Heap@@41 Mask@4) (|Seq#Equal| (MapType0Select Heap@@41 __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0) (|Seq#Empty| intType))) (and (not (= __flatten_24@0 null)) (= Mask@5 (MapType1Store Mask@4 __flatten_24@0 Wand_state_contains_for_state_contains__this_1 (real_2_U (+ (U_2_real (MapType1Select Mask@4 __flatten_24@0 Wand_state_contains_for_state_contains__this_1)) FullPerm)))))))) (and (and (and (and (state Heap@@41 Mask@5) (= (MapType0Select Heap@@41 __flatten_24@0 Wand_state_contains_for_state_contains__this_1) null)) (and (not (= __flatten_24@0 null)) (= Mask@6 (MapType1Store Mask@5 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1 (real_2_U (+ (U_2_real (MapType1Select Mask@5 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1)) FullPerm)))))) (and (and (state Heap@@41 Mask@6) (|Seq#Equal| (MapType0Select Heap@@41 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1) (|Seq#Empty| intType))) (and (not (= __flatten_24@0 null)) (= Mask@7 (MapType1Store Mask@6 __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1 (real_2_U (+ (U_2_real (MapType1Select Mask@6 __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1)) FullPerm))))))) (and (and (and (state Heap@@41 Mask@7) (|Seq#Equal| (MapType0Select Heap@@41 __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1) (|Seq#Empty| intType))) (and (not (= __flatten_24@0 null)) (= Mask@8 (MapType1Store Mask@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1 (real_2_U (+ (U_2_real (MapType1Select Mask@7 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1)) FullPerm)))))) (and (and (state Heap@@41 Mask@8) (= (MapType0Select Heap@@41 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1) null)) (and (not (= __flatten_24@0 null)) (= Mask@9 (MapType1Store Mask@8 __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1 (real_2_U (+ (U_2_real (MapType1Select Mask@8 __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1)) FullPerm))))))))) (and (and (and (and (and (state Heap@@41 Mask@9) (|Seq#Equal| (MapType0Select Heap@@41 __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1) (|Seq#Empty| intType))) (and (not (= __flatten_24@0 null)) (= Mask@10 (MapType1Store Mask@9 __flatten_24@0 Wand_state_contains_for_state_contains__top_1 (real_2_U (+ (U_2_real (MapType1Select Mask@9 __flatten_24@0 Wand_state_contains_for_state_contains__top_1)) FullPerm)))))) (and (and (state Heap@@41 Mask@10) (= (MapType0Select Heap@@41 __flatten_24@0 Wand_state_contains_for_state_contains__top_1) null)) (and (not (= __flatten_24@0 null)) (= Mask@11 (MapType1Store Mask@10 __flatten_24@0 Wand_state_contains_for_state_contains__cur_1 (real_2_U (+ (U_2_real (MapType1Select Mask@10 __flatten_24@0 Wand_state_contains_for_state_contains__cur_1)) FullPerm))))))) (and (and (and (state Heap@@41 Mask@11) (= (MapType0Select Heap@@41 __flatten_24@0 Wand_state_contains_for_state_contains__cur_1) null)) (and (not (= __flatten_24@0 null)) (= Mask@12 (MapType1Store Mask@11 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1 (real_2_U (+ (U_2_real (MapType1Select Mask@11 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) FullPerm)))))) (and (and (state Heap@@41 Mask@12) (= (MapType0Select Heap@@41 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1) null)) (and (not (= __flatten_24@0 null)) (= Mask@13 (MapType1Store Mask@12 __flatten_24@0 Wand_state_contains_for_state_contains__this_2 (real_2_U (+ (U_2_real (MapType1Select Mask@12 __flatten_24@0 Wand_state_contains_for_state_contains__this_2)) FullPerm)))))))) (and (and (and (and (state Heap@@41 Mask@13) (= (MapType0Select Heap@@41 __flatten_24@0 Wand_state_contains_for_state_contains__this_2) null)) (and (not (= __flatten_24@0 null)) (= Mask@14 (MapType1Store Mask@13 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2 (real_2_U (+ (U_2_real (MapType1Select Mask@13 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2)) FullPerm)))))) (and (and (state Heap@@41 Mask@14) (|Seq#Equal| (MapType0Select Heap@@41 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2) (|Seq#Empty| intType))) (and (not (= __flatten_24@0 null)) (= Mask@15 (MapType1Store Mask@14 __flatten_24@0 Wand_state_contains_for_state_contains__top_2 (real_2_U (+ (U_2_real (MapType1Select Mask@14 __flatten_24@0 Wand_state_contains_for_state_contains__top_2)) FullPerm))))))) (and (and (and (state Heap@@41 Mask@15) (= (MapType0Select Heap@@41 __flatten_24@0 Wand_state_contains_for_state_contains__top_2) null)) (and (state Heap@@41 Mask@15) (U_2_bool (MapType0Select Heap@@41 __flatten_24@0 $allocated)))) (and (and (state Heap@@41 Mask@15) (state Heap@@41 Mask@15)) (and (state Heap@@41 Mask@15) (state Heap@@41 Mask@15))))))) (and (=> (= (ControlFlow 0 100) (- 0 124)) (= FullPerm (U_2_real (MapType1Select Mask@15 __flatten_24@0 Wand_state_contains_for_state_contains__lemma)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@15 __flatten_24@0 Wand_state_contains_for_state_contains__lemma))) (=> (and (and (= Heap@0 (MapType0Store Heap@@41 __flatten_24@0 Wand_state_contains_for_state_contains__lemma (int_2_U 2))) (state Heap@0 Mask@15)) (and (state Heap@0 Mask@15) (state Heap@0 Mask@15))) (and (=> (= (ControlFlow 0 100) (- 0 123)) (= FullPerm (U_2_real (MapType1Select Mask@15 __flatten_24@0 Wand_state_contains_for_state_contains__this_2)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@15 __flatten_24@0 Wand_state_contains_for_state_contains__this_2))) (=> (and (and (= Heap@1 (MapType0Store Heap@0 __flatten_24@0 Wand_state_contains_for_state_contains__this_2 this_2)) (state Heap@1 Mask@15)) (and (state Heap@1 Mask@15) (state Heap@1 Mask@15))) (and (=> (= (ControlFlow 0 100) (- 0 122)) (= FullPerm (U_2_real (MapType1Select Mask@15 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@15 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2))) (=> (and (and (= Heap@2 (MapType0Store Heap@1 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_2 target_contents_2)) (state Heap@2 Mask@15)) (and (state Heap@2 Mask@15) (state Heap@2 Mask@15))) (and (=> (= (ControlFlow 0 100) (- 0 121)) (= FullPerm (U_2_real (MapType1Select Mask@15 __flatten_24@0 Wand_state_contains_for_state_contains__top_2)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@15 __flatten_24@0 Wand_state_contains_for_state_contains__top_2))) (=> (and (and (= Heap@3 (MapType0Store Heap@2 __flatten_24@0 Wand_state_contains_for_state_contains__top_2 top_2)) (state Heap@3 Mask@15)) (and (state Heap@3 Mask@15) (state Heap@3 Mask@15))) (and (=> (= (ControlFlow 0 100) (- 0 120)) (= FullPerm (U_2_real (MapType1Select Mask@15 __flatten_24@0 Wand_state_contains_for_state_contains__in_1)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@15 __flatten_24@0 Wand_state_contains_for_state_contains__in_1))) (=> (and (and (= Heap@4 (MapType0Store Heap@3 __flatten_24@0 Wand_state_contains_for_state_contains__in_1 in_1)) (state Heap@4 Mask@15)) (and (state Heap@4 Mask@15) (state Heap@4 Mask@15))) (and (=> (= (ControlFlow 0 100) (- 0 119)) (= FullPerm (U_2_real (MapType1Select Mask@15 __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@15 __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0))) (=> (and (and (= Heap@5 (MapType0Store Heap@4 __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0 in_1_0)) (state Heap@5 Mask@15)) (and (state Heap@5 Mask@15) (state Heap@5 Mask@15))) (and (=> (= (ControlFlow 0 100) (- 0 118)) (= FullPerm (U_2_real (MapType1Select Mask@15 __flatten_24@0 Wand_state_contains_for_state_contains__out_1)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@15 __flatten_24@0 Wand_state_contains_for_state_contains__out_1))) (=> (and (and (= Heap@6 (MapType0Store Heap@5 __flatten_24@0 Wand_state_contains_for_state_contains__out_1 out_1)) (state Heap@6 Mask@15)) (and (state Heap@6 Mask@15) (state Heap@6 Mask@15))) (and (=> (= (ControlFlow 0 100) (- 0 117)) (= FullPerm (U_2_real (MapType1Select Mask@15 __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@15 __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0))) (=> (and (= Heap@7 (MapType0Store Heap@6 __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0 out_1_0)) (state Heap@7 Mask@15)) (and (=> (= (ControlFlow 0 100) (- 0 116)) (> (U_2_real (MapType1Select Mask@15 __flatten_24@0 Wand_state_contains_for_state_contains__lemma)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@15 __flatten_24@0 Wand_state_contains_for_state_contains__lemma)) NoPerm) (=> (> wildcard@0 NoPerm) (=> (and (< wildcard@0 (U_2_real (MapType1Select Mask@15 __flatten_24@0 Wand_state_contains_for_state_contains__lemma))) (= Mask@16 (MapType1Store Mask@15 __flatten_24@0 Wand_state_contains_for_state_contains__lemma (real_2_U (- (U_2_real (MapType1Select Mask@15 __flatten_24@0 Wand_state_contains_for_state_contains__lemma)) wildcard@0))))) (and (=> (= (ControlFlow 0 100) (- 0 115)) (<= 1 (U_2_int (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__lemma)))) (=> (<= 1 (U_2_int (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__lemma))) (and (=> (= (ControlFlow 0 100) (- 0 114)) (> (U_2_real (MapType1Select Mask@16 __flatten_24@0 Wand_state_contains_for_state_contains__in_1)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@16 __flatten_24@0 Wand_state_contains_for_state_contains__in_1)) NoPerm) (=> (> wildcard@1 NoPerm) (=> (and (< wildcard@1 (U_2_real (MapType1Select Mask@16 __flatten_24@0 Wand_state_contains_for_state_contains__in_1))) (= Mask@17 (MapType1Store Mask@16 __flatten_24@0 Wand_state_contains_for_state_contains__in_1 (real_2_U (- (U_2_real (MapType1Select Mask@16 __flatten_24@0 Wand_state_contains_for_state_contains__in_1)) wildcard@1))))) (and (=> (= (ControlFlow 0 100) (- 0 113)) (not (= (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__in_1) null))) (=> (not (= (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__in_1) null)) (and (=> (= (ControlFlow 0 100) (- 0 112)) (> (U_2_real (MapType1Select Mask@17 __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@17 __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0)) NoPerm) (=> (> wildcard@2 NoPerm) (=> (and (< wildcard@2 (U_2_real (MapType1Select Mask@17 __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0))) (= Mask@18 (MapType1Store Mask@17 __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0 (real_2_U (- (U_2_real (MapType1Select Mask@17 __flatten_24@0 Wand_state_contains_for_state_contains__in_1_0)) wildcard@2))))) (and (=> (= (ControlFlow 0 100) (- 0 111)) (> (U_2_real (MapType1Select Mask@18 __flatten_24@0 Wand_state_contains_for_state_contains__out_1)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@18 __flatten_24@0 Wand_state_contains_for_state_contains__out_1)) NoPerm) (=> (> wildcard@3 NoPerm) (=> (and (< wildcard@3 (U_2_real (MapType1Select Mask@18 __flatten_24@0 Wand_state_contains_for_state_contains__out_1))) (= Mask@19 (MapType1Store Mask@18 __flatten_24@0 Wand_state_contains_for_state_contains__out_1 (real_2_U (- (U_2_real (MapType1Select Mask@18 __flatten_24@0 Wand_state_contains_for_state_contains__out_1)) wildcard@3))))) (and (=> (= (ControlFlow 0 100) (- 0 110)) (not (= (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__out_1) null))) (=> (not (= (MapType0Select Heap@7 __flatten_24@0 Wand_state_contains_for_state_contains__out_1) null)) (and (=> (= (ControlFlow 0 100) (- 0 109)) (> (U_2_real (MapType1Select Mask@19 __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@19 __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0)) NoPerm) (=> (> wildcard@4 NoPerm) (=> (and (< wildcard@4 (U_2_real (MapType1Select Mask@19 __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0))) (= Mask@20 (MapType1Store Mask@19 __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0 (real_2_U (- (U_2_real (MapType1Select Mask@19 __flatten_24@0 Wand_state_contains_for_state_contains__out_1_0)) wildcard@4))))) (and (=> (= (ControlFlow 0 100) (- 0 108)) (> (U_2_real (MapType1Select Mask@20 __flatten_24@0 Wand_state_contains_for_state_contains__this_1)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@20 __flatten_24@0 Wand_state_contains_for_state_contains__this_1)) NoPerm) (=> (> wildcard@5 NoPerm) (=> (and (< wildcard@5 (U_2_real (MapType1Select Mask@20 __flatten_24@0 Wand_state_contains_for_state_contains__this_1))) (= Mask@21 (MapType1Store Mask@20 __flatten_24@0 Wand_state_contains_for_state_contains__this_1 (real_2_U (- (U_2_real (MapType1Select Mask@20 __flatten_24@0 Wand_state_contains_for_state_contains__this_1)) wildcard@5))))) (and (=> (= (ControlFlow 0 100) (- 0 107)) (> (U_2_real (MapType1Select Mask@21 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@21 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1)) NoPerm) (=> (> wildcard@6 NoPerm) (=> (and (< wildcard@6 (U_2_real (MapType1Select Mask@21 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1))) (= Mask@22 (MapType1Store Mask@21 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1 (real_2_U (- (U_2_real (MapType1Select Mask@21 __flatten_24@0 Wand_state_contains_for_state_contains__target_contents_1)) wildcard@6))))) (and (=> (= (ControlFlow 0 100) (- 0 106)) (> (U_2_real (MapType1Select Mask@22 __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@22 __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1)) NoPerm) (=> (> wildcard@7 NoPerm) (=> (and (< wildcard@7 (U_2_real (MapType1Select Mask@22 __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1))) (= Mask@23 (MapType1Store Mask@22 __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1 (real_2_U (- (U_2_real (MapType1Select Mask@22 __flatten_24@0 Wand_state_contains_for_state_contains__prev_contents_1)) wildcard@7))))) (and (=> (= (ControlFlow 0 100) (- 0 105)) (> (U_2_real (MapType1Select Mask@23 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@23 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1)) NoPerm) (=> (> wildcard@8 NoPerm) (=> (and (< wildcard@8 (U_2_real (MapType1Select Mask@23 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1))) (= Mask@24 (MapType1Store Mask@23 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1 (real_2_U (- (U_2_real (MapType1Select Mask@23 __flatten_24@0 Wand_state_contains_for_state_contains__prev_1)) wildcard@8))))) (and (=> (= (ControlFlow 0 100) (- 0 104)) (> (U_2_real (MapType1Select Mask@24 __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@24 __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1)) NoPerm) (=> (> wildcard@9 NoPerm) (=> (and (< wildcard@9 (U_2_real (MapType1Select Mask@24 __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1))) (= Mask@25 (MapType1Store Mask@24 __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1 (real_2_U (- (U_2_real (MapType1Select Mask@24 __flatten_24@0 Wand_state_contains_for_state_contains__cur_contents_1)) wildcard@9))))) (and (=> (= (ControlFlow 0 100) (- 0 103)) (> (U_2_real (MapType1Select Mask@25 __flatten_24@0 Wand_state_contains_for_state_contains__top_1)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@25 __flatten_24@0 Wand_state_contains_for_state_contains__top_1)) NoPerm) (=> (> wildcard@10 NoPerm) (=> (and (< wildcard@10 (U_2_real (MapType1Select Mask@25 __flatten_24@0 Wand_state_contains_for_state_contains__top_1))) (= Mask@26 (MapType1Store Mask@25 __flatten_24@0 Wand_state_contains_for_state_contains__top_1 (real_2_U (- (U_2_real (MapType1Select Mask@25 __flatten_24@0 Wand_state_contains_for_state_contains__top_1)) wildcard@10))))) (and (=> (= (ControlFlow 0 100) (- 0 102)) (> (U_2_real (MapType1Select Mask@26 __flatten_24@0 Wand_state_contains_for_state_contains__cur_1)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@26 __flatten_24@0 Wand_state_contains_for_state_contains__cur_1)) NoPerm) (=> (> wildcard@11 NoPerm) (=> (and (< wildcard@11 (U_2_real (MapType1Select Mask@26 __flatten_24@0 Wand_state_contains_for_state_contains__cur_1))) (= Mask@27 (MapType1Store Mask@26 __flatten_24@0 Wand_state_contains_for_state_contains__cur_1 (real_2_U (- (U_2_real (MapType1Select Mask@26 __flatten_24@0 Wand_state_contains_for_state_contains__cur_1)) wildcard@11))))) (and (=> (= (ControlFlow 0 100) (- 0 101)) (> (U_2_real (MapType1Select Mask@27 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@27 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) NoPerm) (=> (> wildcard@12 NoPerm) (=> (and (< wildcard@12 (U_2_real (MapType1Select Mask@27 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1))) (= Mask@28 (MapType1Store Mask@27 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1 (real_2_U (- (U_2_real (MapType1Select Mask@27 __flatten_24@0 Wand_state_contains_for_state_contains__wand_1)) wildcard@12))))) (and (=> (= (ControlFlow 0 100) 96) anon70_Then_correct) (=> (= (ControlFlow 0 100) 61) anon70_Else_correct)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@41 diz@@29 $allocated))) (and (U_2_bool (MapType0Select Heap@@41 this_2 $allocated)) (U_2_bool (MapType0Select Heap@@41 top_2 $allocated)))) (and (and (U_2_bool (MapType0Select Heap@@41 in_1 $allocated)) (U_2_bool (MapType0Select Heap@@41 out_1 $allocated))) (and (not (= diz@@29 null)) (state Heap@@41 ZeroMask)))) (=> (and (and (and (and (>= current_thread_id 0) (state Heap@@41 ZeroMask)) (and (not (= this_2 null)) (state Heap@@41 ZeroMask))) (and (and (not (= in_1 null)) (state Heap@@41 ZeroMask)) (and (= in_1 top_2) (state Heap@@41 ZeroMask)))) (and (and (and (|Seq#Equal| in_1_0 target_contents_2) (state Heap@@41 ZeroMask)) (and (not (= out_1 null)) (state Heap@@41 ZeroMask))) (and (and (= out_1 top_2) (state Heap@@41 ZeroMask)) (and (|Seq#Equal| out_1_0 target_contents_2) (state Heap@@41 ZeroMask))))) (and (=> (= (ControlFlow 0 155) 154) anon61_Then_correct) (=> (= (ControlFlow 0 155) 100) anon61_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (> wildcard NoPerm) true) (= (ControlFlow 0 156) 155)) anon0_correct)))
PreconditionGeneratedEntry_correct)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
