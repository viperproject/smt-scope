...
(let ((anon8_Then_correct  (=> (and (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 8) (- 0 9)) true) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 8) 4) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct)))))))
(let ((anon8_Else_correct true))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 10) 1) anon7_Then_correct) (=> (= (ControlFlow 0 10) 8) anon8_Then_correct)) (=> (= (ControlFlow 0 10) 2) anon8_Else_correct))))))
