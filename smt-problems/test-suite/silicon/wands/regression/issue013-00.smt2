(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:35:54
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/wands/regression/issue013.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
; fold acc(Q(l), write)
; [eval] x != null
(assert (Q%trigger $Snap.unit l@1@01))
; Create MagicWandSnapFunction for wand acc(P(l), write) --* true
