...
(assert  (and (and (and (and (= (type Ops_5Heap@0) (MapType0Type RefType)) (= (type Used_5Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type Used_4Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id t03)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (= b_7@3  (and b_7@2 (state Ops_5Heap@0 ZeroMask))) (=> (and (= b_7@4  (and b_7@3 (state Ops_5Heap@0 ZeroMask))) (= b_8@0  (and b_8 (state Used_5Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (and (and b_7@4 b_7@4) b_8@0) false)) (=> (=> (and (and b_7@4 b_7@4) b_8@0) false) (=> (= Mask@0 (MapType1Store ZeroMask null (wand (= x@@8 1) false) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (wand (= x@@8 1) false))) FullPerm)))) (=> (and (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) false))))))))
(let ((anon3_Else_correct  (=> (not b_7@0) (=> (and (= b_7@2 b_7@0) (= (ControlFlow 0 5) 2)) anon2_correct))))
(let ((anon3_Then_correct  (=> (and (and b_7@0 (= b_7@1  (and b_7@0 (= x@@8 1)))) (and (= b_7@2 b_7@1) (= (ControlFlow 0 4) 2))) anon2_correct)))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (= x@@8 0) (state Heap@@9 ZeroMask)) (and (= b_7@0  (and b_7 (state Ops_5Heap@0 ZeroMask))) (= b_6@0  (and b_6 (state Used_4Heap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 6) 4) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))
