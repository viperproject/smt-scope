...
(declare-fun fun3 (Int) Bool)
(declare-fun Mask@0 () T@U)
(assert  (and (and (and (and (and (and (and (= (type Heap@@18) (MapType0Type RefType)) (= (type x@@18) RefType)) (= (type y@@5) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test05)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon10_correct true))
(let ((anon6_correct  (=> (= Mask@3 (MapType1Store Mask@1 x@@18 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 x@@18 f_7)) FullPerm)))) (=> (and (= Mask@4 Mask@3) (= (ControlFlow 0 10) 4)) anon10_correct))))
(let ((anon15_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 10)) anon6_correct)))
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@18 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@18 f_7))) (=> (= (ControlFlow 0 11) 10) anon6_correct))))))
(let ((anon14_Then_correct  (=> b_2@@9 (and (=> (= (ControlFlow 0 14) 11) anon15_Then_correct) (=> (= (ControlFlow 0 14) 13) anon15_Else_correct)))))
(let ((anon9_correct  (=> (= Mask@2 (MapType1Store Mask@1 y@@5 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 y@@5 f_7)) FullPerm)))) (=> (and (= Mask@4 Mask@2) (= (ControlFlow 0 5) 4)) anon10_correct))))
(let ((anon16_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon9_correct)))
(let ((anon16_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@1 y@@5 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 y@@5 f_7))) (=> (= (ControlFlow 0 6) 5) anon9_correct))))))
(let ((anon14_Else_correct  (=> (not b_2@@9) (and (=> (= (ControlFlow 0 9) 6) anon16_Then_correct) (=> (= (ControlFlow 0 9) 8) anon16_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (and (> (fun2 Heap@@18 b_2@@9 x@@18 y@@5 5) 0) (state Heap@@18 Mask@1)) (and (state Heap@@18 Mask@1) (= (ControlFlow 0 3) (- 0 2)))) (fun3 5))))
(let ((anon12_Else_correct  (=> (and (and (forall ((j_1 Int) ) (!  (=> (and (< 0 j_1) (< j_1 10)) (fun3 j_1))
 :qid |stdinbpl.680:20|
 :skolemid |39|
 :pattern ( (|fun2#frame| (FrameFragment (FrameFragment (MapType0Select Heap@@18 x@@18 f_7))) b_2@@9 x@@18 y@@5 j_1))
 :pattern ( (|fun2#frame| (FrameFragment (FrameFragment (MapType0Select Heap@@18 y@@5 f_7))) b_2@@9 x@@18 y@@5 j_1))
)) (state Heap@@18 Mask@1)) (and (state Heap@@18 Mask@1) (state Heap@@18 Mask@1))) (and (and (=> (= (ControlFlow 0 15) 3) anon13_Else_correct) (=> (= (ControlFlow 0 15) 14) anon14_Then_correct)) (=> (= (ControlFlow 0 15) 9) anon14_Else_correct)))))
(let ((anon12_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@18 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@18 x@@18 $allocated))) (and (U_2_bool (MapType0Select Heap@@18 y@@5 $allocated)) (not (= x@@18 null)))) (=> (and (and (and (= Mask@0 (MapType1Store ZeroMask x@@18 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@18 f_7)) FullPerm)))) (state Heap@@18 Mask@0)) (and (not (= y@@5 null)) (= Mask@1 (MapType1Store Mask@0 y@@5 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@5 f_7)) FullPerm)))))) (and (and (state Heap@@18 Mask@1) (state Heap@@18 Mask@1)) (and (state Heap@@18 Mask@1) (state Heap@@18 Mask@1)))) (and (=> (= (ControlFlow 0 16) 1) anon12_Then_correct) (=> (= (ControlFlow 0 16) 15) anon12_Else_correct)))))))
