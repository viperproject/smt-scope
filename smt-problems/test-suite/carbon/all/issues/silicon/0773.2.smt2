...
(let ((anon7_correct  (=> (state Heap@@23 ZeroMask) (and (=> (= (ControlFlow 0 6) 4) anon13_Then_correct) (=> (= (ControlFlow 0 6) 5) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (not (needsPre Heap@@23)) (=> (and (state Heap@@23 ZeroMask) (= (ControlFlow 0 8) 6)) anon7_correct))))
(let ((anon12_Then_correct  (=> (needsPre Heap@@23) (=> (and (state Heap@@23 ZeroMask) (= (ControlFlow 0 7) 6)) anon7_correct))))
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (pre Heap@@23))))
(let ((anon10_Else_correct  (=> (state Heap@@23 ZeroMask) (=> (and (state Heap@@23 ZeroMask) (state Heap@@23 ZeroMask)) (and (and (=> (= (ControlFlow 0 9) 3) anon11_Then_correct) (=> (= (ControlFlow 0 9) 7) anon12_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon12_Else_correct))))))
(let ((anon10_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@23 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (state Heap@@23 ZeroMask)) (and (=> (= (ControlFlow 0 10) 1) anon10_Then_correct) (=> (= (ControlFlow 0 10) 9) anon10_Else_correct))))))
