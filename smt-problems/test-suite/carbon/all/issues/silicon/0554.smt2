...
(assert  (and (and (and (and (and (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type this@@5) RefType)) (= (type Mask@6) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |tree#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon9_correct true))
(let ((anon14_Else_correct  (=> (and (= (MapType0Select Heap@@10 this@@5 next_child) null) (= (ControlFlow 0 5) 1)) anon9_correct)))
(let ((anon14_Then_correct  (=> (not (= (MapType0Select Heap@@10 this@@5 next_child) null)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm Mask@6 this@@5 next_sibling)) (=> (HasDirectPerm Mask@6 this@@5 next_sibling) (=> (= (ControlFlow 0 3) 1) anon9_correct))))))
(let ((anon13_Then_correct  (=> (not (and (= (MapType0Select Heap@@10 this@@5 next_child) null) (= (MapType0Select Heap@@10 this@@5 next_sibling) null))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm Mask@6 this@@5 next_child)) (=> (HasDirectPerm Mask@6 this@@5 next_child) (and (=> (= (ControlFlow 0 6) 3) anon14_Then_correct) (=> (= (ControlFlow 0 6) 5) anon14_Else_correct)))))))
(let ((anon13_Else_correct  (=> (and (and (= (MapType0Select Heap@@10 this@@5 next_child) null) (= (MapType0Select Heap@@10 this@@5 next_sibling) null)) (= (ControlFlow 0 2) 1)) anon9_correct)))
(let ((anon12_Else_correct  (=> (not (= (MapType0Select Heap@@10 this@@5 next_child) null)) (and (=> (= (ControlFlow 0 10) 6) anon13_Then_correct) (=> (= (ControlFlow 0 10) 2) anon13_Else_correct)))))
(let ((anon12_Then_correct  (=> (= (MapType0Select Heap@@10 this@@5 next_child) null) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm Mask@6 this@@5 next_sibling)) (=> (HasDirectPerm Mask@6 this@@5 next_sibling) (and (=> (= (ControlFlow 0 8) 6) anon13_Then_correct) (=> (= (ControlFlow 0 8) 2) anon13_Else_correct)))))))
(let ((anon4_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm Mask@6 this@@5 next_child)) (=> (HasDirectPerm Mask@6 this@@5 next_child) (and (=> (= (ControlFlow 0 11) 8) anon12_Then_correct) (=> (= (ControlFlow 0 11) 10) anon12_Else_correct))))))
(let ((anon11_Else_correct  (=> (= (MapType0Select Heap@@10 this@@5 next_sibling) null) (=> (and (= Mask@6 Mask@4) (= (ControlFlow 0 15) 11)) anon4_correct))))
(let ((anon11_Then_correct  (=> (not (= (MapType0Select Heap@@10 this@@5 next_sibling) null)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm Mask@4 this@@5 next_sibling)) (=> (HasDirectPerm Mask@4 this@@5 next_sibling) (=> (and (and (= Mask@5 (MapType1Store Mask@4 null (tree (MapType0Select Heap@@10 this@@5 next_sibling)) (real_2_U (+ (U_2_real (MapType1Select Mask@4 null (tree (MapType0Select Heap@@10 this@@5 next_sibling)))) FullPerm)))) (state Heap@@10 Mask@5)) (and (= Mask@6 Mask@5) (= (ControlFlow 0 13) 11))) anon4_correct))))))
(let ((anon2_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm Mask@4 this@@5 next_sibling)) (=> (HasDirectPerm Mask@4 this@@5 next_sibling) (and (=> (= (ControlFlow 0 16) 13) anon11_Then_correct) (=> (= (ControlFlow 0 16) 15) anon11_Else_correct))))))
(let ((anon10_Else_correct  (=> (= (MapType0Select Heap@@10 this@@5 next_child) null) (=> (and (= Mask@4 Mask@2) (= (ControlFlow 0 20) 16)) anon2_correct))))
(let ((anon10_Then_correct  (=> (not (= (MapType0Select Heap@@10 this@@5 next_child) null)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm Mask@2 this@@5 next_child)) (=> (HasDirectPerm Mask@2 this@@5 next_child) (=> (and (and (= Mask@3 (MapType1Store Mask@2 null (tree (MapType0Select Heap@@10 this@@5 next_child)) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (tree (MapType0Select Heap@@10 this@@5 next_child)))) FullPerm)))) (state Heap@@10 Mask@3)) (and (= Mask@4 Mask@3) (= (ControlFlow 0 18) 16))) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 this@@5 $allocated)) (not (= this@@5 null))) (=> (and (and (and (= Mask@0 (MapType1Store ZeroMask this@@5 data (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@5 data)) FullPerm)))) (state Heap@@10 Mask@0)) (and (not (= this@@5 null)) (= Mask@1 (MapType1Store Mask@0 this@@5 next_child (real_2_U (+ (U_2_real (MapType1Select Mask@0 this@@5 next_child)) FullPerm)))))) (and (and (state Heap@@10 Mask@1) (not (= this@@5 null))) (and (= Mask@2 (MapType1Store Mask@1 this@@5 next_sibling (real_2_U (+ (U_2_real (MapType1Select Mask@1 this@@5 next_sibling)) FullPerm)))) (state Heap@@10 Mask@2)))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (HasDirectPerm Mask@2 this@@5 next_child)) (=> (HasDirectPerm Mask@2 this@@5 next_child) (and (=> (= (ControlFlow 0 21) 18) anon10_Then_correct) (=> (= (ControlFlow 0 21) 20) anon10_Else_correct)))))))))
