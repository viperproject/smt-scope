...
(assert  (and (and (and (and (= (type xs) (MapType2Type RefType boolType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv3 arg0@@43)) RefType)
...
)) (=> (and (forall ((z_1@@1 T@U) ) (!  (=> (= (type z_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs z_1@@1)) (< NoPerm FullPerm)) (and (qpRange3 z_1@@1) (= (invRecv3 z_1@@1) z_1@@1))))
 :qid |stdinbpl.607:22|
 :skolemid |96|
...
)) (state Heap@@9 QPMask@0))) (and (and (state Heap@@9 QPMask@0) (|Set#Equal| xs (|Set#Singleton| x@@19))) (and (state Heap@@9 QPMask@0) (= (ControlFlow 0 3) (- 0 2))))) (not (= x@@19 null))))))))
