...
(declare-fun refs@@3 () T@U)
(declare-fun Heap@@12 () T@U)
(declare-fun AssumeFunctionsAbove () Int)
(assert  (and (= (type refs@@3) (MapType2Type RefType boolType)) (= (type Heap@@12) (MapType0Type RefType))))
(set-info :boogie-vc-id |$$#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((n_3 T@U) (n_3_1 T@U) ) (!  (=> (and (= (type n_3) RefType) (= (type n_3_1) RefType)) (=> (and (and (and (and (not (= n_3 n_3_1)) (U_2_bool (MapType2Select refs@@3 n_3))) (U_2_bool (MapType2Select refs@@3 n_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3 n_3_1))))
 :qid |stdinbpl.493:15|
 :skolemid |86|
 :no-pattern (type n_3)
...
(let ((anon0_correct  (=> (and (state Heap@@12 ZeroMask) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
