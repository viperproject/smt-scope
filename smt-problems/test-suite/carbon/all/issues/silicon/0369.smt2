...
(declare-fun test (T@U) Int)
(declare-fun |test'| (T@U) Int)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |test#triggerStateless| () Int)
(declare-fun NoPerm () Real)
(declare-fun AssumeFunctionsAbove () Int)
(declare-fun |test#trigger| (T@U) Bool)
(declare-fun FullPerm () Real)
(declare-fun |test#frame| (T@U) Int)
...
(assert (forall ((Heap@@5 T@U) ) (!  (=> (= (type Heap@@5) (MapType0Type RefType)) (and (= (test Heap@@5) (|test'| Heap@@5)) (dummyFunction (int_2_U |test#triggerStateless|))))
 :qid |stdinbpl.185:15|
 :skolemid |22|
 :pattern ( (test Heap@@5))
)))
...
(assert (forall ((Heap@@6 T@U) (Mask@@6 T@U) ) (!  (=> (and (and (= (type Heap@@6) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (and (state Heap@@6 Mask@@6) (or (< AssumeFunctionsAbove 0) (|test#trigger| EmptyFrame)))) false)
 :qid |stdinbpl.208:15|
 :skolemid |26|
 :pattern ( (state Heap@@6 Mask@@6) (|test'| Heap@@6))
)))
...
(assert (forall ((Heap@@9 T@U) ) (!  (=> (= (type Heap@@9) (MapType0Type RefType)) (dummyFunction (int_2_U |test#triggerStateless|)))
 :qid |stdinbpl.189:15|
 :skolemid |23|
 :pattern ( (|test'| Heap@@9))
)))
...
(assert (forall ((Heap@@11 T@U) (Mask@@10 T@U) ) (!  (=> (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (state Heap@@11 Mask@@10)) (= (|test'| Heap@@11) (|test#frame| EmptyFrame)))
 :qid |stdinbpl.202:15|
 :skolemid |25|
 :pattern ( (state Heap@@11 Mask@@10) (|test'| Heap@@11))
)))
...
(assert (forall ((Heap@@13 T@U) (Mask@@11 T@U) ) (!  (=> (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (and (state Heap@@13 Mask@@11) (< AssumeFunctionsAbove 0))) (= (test Heap@@13) 42))
 :qid |stdinbpl.195:15|
 :skolemid |24|
 :pattern ( (state Heap@@13 Mask@@11) (test Heap@@13))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (= AssumeFunctionsAbove 0) (= (ControlFlow 0 2) (- 0 1))) false))))
