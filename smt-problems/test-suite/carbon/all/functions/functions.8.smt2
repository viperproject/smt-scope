...
(assert  (and (and (and (and (and (= (type Heap@@47) (MapType0Type RefType)) (= (type x@@56) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |Q#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (= (MapType0Select Heap@@47 x@@56 h) null) (=> (and (= Mask@3 Mask@1) (= (ControlFlow 0 4) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (not (= (MapType0Select Heap@@47 x@@56 h) null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 x@@56 h)) (=> (HasDirectPerm Mask@1 x@@56 h) (=> (not (= (MapType0Select Heap@@47 x@@56 h) null)) (=> (and (and (= Mask@2 (MapType1Store Mask@1 (MapType0Select Heap@@47 x@@56 h) g (real_2_U (+ (U_2_real (MapType1Select Mask@1 (MapType0Select Heap@@47 x@@56 h) g)) FullPerm)))) (state Heap@@47 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 2) 1))) anon2_correct)))))))
(let ((anon0_correct  (=> (state Heap@@47 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@47 x@@56 $allocated))) (and (not (= x@@56 null)) (= Mask@0 (MapType1Store ZeroMask x@@56 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@56 f_7)) FullPerm)))))) (and (and (state Heap@@47 Mask@0) (not (= x@@56 null))) (and (= Mask@1 (MapType1Store Mask@0 x@@56 h (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@56 h)) FullPerm)))) (state Heap@@47 Mask@1)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@1 x@@56 h)) (=> (HasDirectPerm Mask@1 x@@56 h) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))))
