...
(assert  (and (and (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type this@@5) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |Node_P#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (= (MapType0Select Heap@@10 this@@5 Node_n) null) (=> (and (= Mask@3 Mask@1) (= (ControlFlow 0 4) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (not (= (MapType0Select Heap@@10 this@@5 Node_n) null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 this@@5 Node_n)) (=> (HasDirectPerm Mask@1 this@@5 Node_n) (=> (and (and (= Mask@2 (MapType1Store Mask@1 null (Node_P (MapType0Select Heap@@10 this@@5 Node_n)) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (Node_P (MapType0Select Heap@@10 this@@5 Node_n)))) FullPerm)))) (state Heap@@10 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 2) 1))) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 this@@5 $allocated))) (and (not (= this@@5 null)) (= Mask@0 (MapType1Store ZeroMask this@@5 Node_v (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@5 Node_v)) FullPerm)))))) (and (and (state Heap@@10 Mask@0) (not (= this@@5 null))) (and (= Mask@1 (MapType1Store Mask@0 this@@5 Node_n (real_2_U (+ (U_2_real (MapType1Select Mask@0 this@@5 Node_n)) FullPerm)))) (state Heap@@10 Mask@1)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@1 this@@5 Node_n)) (=> (HasDirectPerm Mask@1 this@@5 Node_n) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))))
