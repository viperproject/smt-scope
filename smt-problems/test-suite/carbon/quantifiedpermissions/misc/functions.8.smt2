...
(assert  (and (and (= (type xs@@39) (SeqType RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@41) (MapType0Type RefType))))
(set-info :boogie-vc-id |fun08#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 j_22) (< j_22 (|Seq#Length| xs@@39)))) (= (ControlFlow 0 21) 17)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (<= 0 j_22) (< j_22 (|Seq#Length| xs@@39))) (and (=> (= (ControlFlow 0 18) (- 0 20)) (>= j_22 0)) (=> (>= j_22 0) (and (=> (= (ControlFlow 0 18) (- 0 19)) (< j_22 (|Seq#Length| xs@@39))) (=> (< j_22 (|Seq#Length| xs@@39)) (=> (= (ControlFlow 0 18) 17) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 16)) (forall ((j_8 Int) (j_8_1 Int) ) (!  (=> (and (and (and (and (not (= j_8 j_8_1)) (and (<= 0 j_8) (< j_8 (|Seq#Length| xs@@39)))) (and (<= 0 j_8_1) (< j_8_1 (|Seq#Length| xs@@39)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@39 j_8) (|Seq#Index| xs@@39 j_8_1))))
 :qid |stdinbpl.2049:15|
 :skolemid |184|
))) (=> (forall ((j_8@@0 Int) (j_8_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_8@@0 j_8_1@@0)) (and (<= 0 j_8@@0) (< j_8@@0 (|Seq#Length| xs@@39)))) (and (<= 0 j_8_1@@0) (< j_8_1@@0 (|Seq#Length| xs@@39)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@39 j_8@@0) (|Seq#Index| xs@@39 j_8_1@@0))))
 :qid |stdinbpl.2049:15|
 :skolemid |184|
)) (=> (and (forall ((j_8@@1 Int) ) (!  (=> (and (and (<= 0 j_8@@1) (< j_8@@1 (|Seq#Length| xs@@39))) (< NoPerm FullPerm)) (and (qpRange12 (|Seq#Index| xs@@39 j_8@@1)) (= (invRecv12 (|Seq#Index| xs@@39 j_8@@1)) j_8@@1)))
 :qid |stdinbpl.2055:22|
 :skolemid |185|
 :pattern ( (|Seq#Index| xs@@39 j_8@@1))
 :pattern ( (|Seq#Index| xs@@39 j_8@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv12 o_3)) (< (invRecv12 o_3) (|Seq#Length| xs@@39))) (< NoPerm FullPerm)) (qpRange12 o_3)) (= (|Seq#Index| xs@@39 (invRecv12 o_3)) o_3)))
 :qid |stdinbpl.2059:22|
 :skolemid |186|
 :pattern ( (invRecv12 o_3))
))) (=> (and (and (and (forall ((j_8@@2 Int) ) (!  (=> (and (<= 0 j_8@@2) (< j_8@@2 (|Seq#Length| xs@@39))) (not (= (|Seq#Index| xs@@39 j_8@@2) null)))
 :qid |stdinbpl.2065:22|
 :skolemid |187|
 :pattern ( (|Seq#Index| xs@@39 j_8@@2))
 :pattern ( (|Seq#Index| xs@@39 j_8@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv12 o_3@@0)) (< (invRecv12 o_3@@0) (|Seq#Length| xs@@39))) (< NoPerm FullPerm)) (qpRange12 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| xs@@39 (invRecv12 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv12 o_3@@0)) (< (invRecv12 o_3@@0) (|Seq#Length| xs@@39))) (< NoPerm FullPerm)) (qpRange12 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
)) (state Heap@@41 QPMask@0))) (and (and (state Heap@@41 QPMask@0) (<= 0 i@@29)) (and (< i@@29 (|Seq#Length| xs@@39)) (state Heap@@41 QPMask@0)))) (and (=> (= (ControlFlow 0 9) (- 0 15)) (>= i@@29 0)) (=> (>= i@@29 0) (and (=> (= (ControlFlow 0 9) (- 0 14)) (< i@@29 (|Seq#Length| xs@@39))) (=> (< i@@29 (|Seq#Length| xs@@39)) (and (=> (= (ControlFlow 0 9) (- 0 13)) (HasDirectPerm QPMask@0 (|Seq#Index| xs@@39 i@@29) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs@@39 i@@29) f_7) (=> (= Result@0 (+ (U_2_int (MapType0Select Heap@@41 (|Seq#Index| xs@@39 i@@29) f_7)) 1)) (and (=> (= (ControlFlow 0 9) (- 0 12)) (>= i@@29 0)) (=> (>= i@@29 0) (and (=> (= (ControlFlow 0 9) (- 0 11)) (< i@@29 (|Seq#Length| xs@@39))) (=> (< i@@29 (|Seq#Length| xs@@39)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm QPMask@0 (|Seq#Index| xs@@39 i@@29) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs@@39 i@@29) f_7) (=> (= (ControlFlow 0 9) (- 0 8)) (> Result@0 (U_2_int (MapType0Select Heap@@41 (|Seq#Index| xs@@39 i@@29) f_7)))))))))))))))))))))))
(let ((anon9_Else_correct  (=> (and (forall ((k_3 Int) (j_6 Int) ) (!  (=> (and (>= k_3 0) (and (< k_3 (|Seq#Length| xs@@39)) (and (>= j_6 0) (and (< j_6 (|Seq#Length| xs@@39)) (not (= k_3 j_6)))))) (not (= (|Seq#Index| xs@@39 k_3) (|Seq#Index| xs@@39 j_6))))
 :qid |stdinbpl.2031:20|
 :skolemid |183|
 :pattern ( (|Seq#Index| xs@@39 k_3) (|Seq#Index| xs@@39 j_6))
)) (state Heap@@41 ZeroMask)) (and (and (=> (= (ControlFlow 0 22) 9) anon11_Else_correct) (=> (= (ControlFlow 0 22) 18) anon12_Then_correct)) (=> (= (ControlFlow 0 22) 21) anon12_Else_correct)))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (and (>= k_5 0) (and (< k_5 (|Seq#Length| xs@@39)) (and (>= j_21 0) (and (< j_21 (|Seq#Length| xs@@39)) (not (= k_5 j_21))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (>= k_5 0) (and (< k_5 (|Seq#Length| xs@@39)) (and (>= j_21 0) (and (< j_21 (|Seq#Length| xs@@39)) (not (= k_5 j_21)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= k_5 0)) (=> (>= k_5 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< k_5 (|Seq#Length| xs@@39))) (=> (< k_5 (|Seq#Length| xs@@39)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_21 0)) (=> (>= j_21 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_21 (|Seq#Length| xs@@39))) (=> (< j_21 (|Seq#Length| xs@@39)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove 0)) (and (and (=> (= (ControlFlow 0 23) 22) anon9_Else_correct) (=> (= (ControlFlow 0 23) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 23) 7) anon10_Else_correct)))))
