...
(let ((anon4_Else_correct  (=> (not (= (IntList_tag l@@44) 1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing (get_IntList_itail l@@44) l@@44)) (=> (decreasing (get_IntList_itail l@@44) l@@44) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded l@@44)) (=> (bounded l@@44) (=> (and (state Heap@@58 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (and (= (IntList_tag l@@44) 1) (= (ControlFlow 0 2) 1)) anon3_correct)))
