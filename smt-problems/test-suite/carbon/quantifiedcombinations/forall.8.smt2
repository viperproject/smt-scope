...
(assert  (and (and (and (and (= (type xs) (SeqType RefType)) (= (type ys) (SeqType RefType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@37 T@U) ) (! (= (type (invRecv40 arg0@@37)) RefType)
 :qid |funType:invRecv40|
 :pattern ( (invRecv40 arg0@@37))
))))
(set-info :boogie-vc-id m8)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (and (|Seq#Contains| xs x_3) (|Seq#Contains| ys x_3))) (and (|Seq#Contains| xs x_3_1) (|Seq#Contains| ys x_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1))))
 :qid |stdinbpl.2791:15|
 :skolemid |313|
 :no-pattern (type x_3)
...
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (and (|Seq#Contains| xs x_1) (|Seq#Contains| ys x_1))) (and (|Seq#Contains| xs x_1_1) (|Seq#Contains| ys x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.2752:15|
 :skolemid |307|
 :no-pattern (type x_1)
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (and (|Seq#Contains| xs x_1@@0) (|Seq#Contains| ys x_1@@0))) (and (|Seq#Contains| xs x_1_1@@0) (|Seq#Contains| ys x_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.2752:15|
 :skolemid |307|
...
)) (=> (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (and (|Seq#Contains| xs x_1@@1) (|Seq#Contains| ys x_1@@1)) (< NoPerm FullPerm)) (and (qpRange40 x_1@@1) (= (invRecv40 x_1@@1) x_1@@1))))
 ...
 :pattern ( (|Seq#ContainsTrigger| ys x_1@@1))
 :pattern ( (|Seq#Contains| ys x_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (|Seq#Contains| xs (invRecv40 o_3)) (|Seq#Contains| ys (invRecv40 o_3))) (< NoPerm FullPerm)) (qpRange40 o_3)) (= (invRecv40 o_3) o_3)))
 :qid |stdinbpl.2762:22|
 :skolemid |309|
 :pattern ( (invRecv40 o_3))
))) (=> (and (and (forall ((x_1@@2 T@U) ) (!  (=> (= (type x_1@@2) RefType) (=> (and (|Seq#Contains| xs x_1@@2) (|Seq#Contains| ys x_1@@2)) (not (= x_1@@2 null))))
 ...
 :pattern ( (|Seq#ContainsTrigger| ys x_1@@2))
 :pattern ( (|Seq#Contains| ys x_1@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (|Seq#Contains| xs (invRecv40 o_3@@0)) (|Seq#Contains| ys (invRecv40 o_3@@0))) (< NoPerm FullPerm)) (qpRange40 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv40 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (and (|Seq#Contains| xs (invRecv40 o_3@@0)) (|Seq#Contains| ys (invRecv40 o_3@@0))) (< NoPerm FullPerm)) (qpRange40 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (and (=> (= (ControlFlow 0 7) 1) anon5_Then_correct) (=> (= (ControlFlow 0 7) 5) anon5_Else_correct)))))
