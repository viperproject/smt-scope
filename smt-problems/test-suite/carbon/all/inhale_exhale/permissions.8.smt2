...
(assert  (and (and (and (= (type this) RefType) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id exhaleTrue1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Else_correct true))
(let ((anon6_Then_correct  (=> (and (and (not (= this null)) (= PostMask@0 (MapType1Store ZeroMask this x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this x@@8)) FullPerm))))) (and (state PostHeap@0 PostMask@0) (= (ControlFlow 0 3) (- 0 2)))) (HasDirectPerm PostMask@0 this x@@8))))
...
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 this $allocated))) (and (=> (= (ControlFlow 0 6) 5) anon5_Then_correct) (=> (= (ControlFlow 0 6) 1) anon5_Else_correct)))))
...
(set-info :boogie-vc-id exhaleExpression2WithInhale)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon8_Else_correct  (=> (and (and (not (= this null)) (= PostMask@0 (MapType1Store ZeroMask this x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this x@@8)) FullPerm))))) (and (state PostHeap@0 PostMask@0) (= (ControlFlow 0 10) (- 0 9)))) (HasDirectPerm PostMask@0 this x@@8))))
...
(let ((anon7_Else_correct  (=> (not (= this null)) (=> (and (= Mask@0 (MapType1Store ZeroMask this x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this x@@8)) FullPerm)))) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm Mask@0 this x@@8)) (=> (HasDirectPerm Mask@0 this x@@8) (=> (= (U_2_int (MapType0Select Heap@@9 this x@@8)) 1) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 6) 3) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct))))))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 this $allocated))) (and (=> (= (ControlFlow 0 12) 11) anon7_Then_correct) (=> (= (ControlFlow 0 12) 6) anon7_Else_correct)))))
