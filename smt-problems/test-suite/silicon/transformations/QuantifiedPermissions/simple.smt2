(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:32:54
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/transformations/QuantifiedPermissions/simple.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (forall ((x@6@01 $Ref)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/transformations/QuantifiedPermissions/simple.vpr@7@12@7@59-aux|)))
(assert (forall ((x@6@01 $Ref)) (!
  (or (not (Seq_contains xs@1@01 x@6@01)) (Seq_contains xs@1@01 x@6@01))
  :pattern ((Seq_contains_trigger xs@1@01 x@6@01))
  :qid |prog./silicon/silver/src/test/resources/transformations/QuantifiedPermissions/simple.vpr@7@12@7@59-aux|)))
(assert (forall ((x@6@01 $Ref)) (!
  ...
  :pattern ((Seq_contains xs@1@01 x@6@01))
  :pattern ((Seq_contains_trigger xs@1@01 x@6@01))
  :qid |prog./silicon/silver/src/test/resources/transformations/QuantifiedPermissions/simple.vpr@7@12@7@59|)))
...
(assert (forall ((x@11@01 $Ref)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/transformations/QuantifiedPermissions/simple.vpr@8@11@8@58-aux|)))
(assert (forall ((x@11@01 $Ref)) (!
  (or (not (Seq_contains xs@1@01 x@11@01)) (Seq_contains xs@1@01 x@11@01))
  :pattern ((Seq_contains_trigger xs@1@01 x@11@01))
  :qid |prog./silicon/silver/src/test/resources/transformations/QuantifiedPermissions/simple.vpr@8@11@8@58-aux|)))
(assert (forall ((x@11@01 $Ref)) (!
  ...
  :pattern ((Seq_contains xs@1@01 x@11@01))
  :pattern ((Seq_contains_trigger xs@1@01 x@11@01))
  :qid |prog./silicon/silver/src/test/resources/transformations/QuantifiedPermissions/simple.vpr@8@11@8@58|)))
(pop) ; 2
(push) ; 2
