...
(assert  (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type this) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id s3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_Else_correct  (=> (not (= this null)) (=> (and (= Mask@0 (MapType1Store ZeroMask this x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this x@@8)) FullPerm)))) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (HasDirectPerm Mask@0 this x@@8)) (=> (HasDirectPerm Mask@0 this x@@8) (=> (= (U_2_int (MapType0Select Heap@@9 this x@@8)) 0) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= this null))) (=> (not (= this null)) (=> (= (ControlFlow 0 4) (- 0 3)) (= (U_2_int (MapType0Select Heap@@9 this x@@8)) 0))))))))))))
(let ((anon3_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (not (= this null)) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm ZeroMask this x@@8)))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 this $allocated))) (and (=> (= (ControlFlow 0 7) 2) anon3_Then_correct) (=> (= (ControlFlow 0 7) 4) anon3_Else_correct)))))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (HasDirectPerm ZeroMask this x@@8))))
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm ZeroMask this x@@8))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 this $allocated))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))
