...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 freshObj@0 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 freshObj@0 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (U_2_int (MapType0Select Heap@1 freshObj@0 f_7)) 5)) (=> (= (U_2_int (MapType0Select Heap@1 freshObj@0 f_7)) 5) (=> (IdenticalOnKnownLocations Heap@1 ExhaleHeap@0 Mask@1) (=> (and (and (and (= res@0 4) (> wildcard@0 NoPerm)) (and (not (= freshObj@0 null)) (= Mask@2 (MapType1Store Mask@1 freshObj@0 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@1 freshObj@0 f_7)) wildcard@0)))))) (and (and (state ExhaleHeap@0 Mask@2) (= (U_2_int (MapType0Select ExhaleHeap@0 freshObj@0 f_7)) res@0)) (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@2 freshObj@0 f_7)) (=> (HasDirectPerm Mask@2 freshObj@0 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (MapType0Select ExhaleHeap@0 freshObj@0 f_7)) res@0)))))))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7))) (=> (= (ControlFlow 0 5) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 a_2 $allocated))) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@9 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@9 freshObj@0 $allocated (bool_2_U true)))) (and (= Mask@0 (MapType1Store ZeroMask freshObj@0 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 f_7)) FullPerm)))) (state Heap@0 Mask@0))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7))) (=> (and (= Heap@1 (MapType0Store Heap@0 freshObj@0 f_7 (int_2_U 5))) (state Heap@1 Mask@0)) (and (=> (= (ControlFlow 0 8) 5) anon3_Then_correct) (=> (= (ControlFlow 0 8) 7) anon3_Else_correct)))))))))
