...
(let ((anon22_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select Mask@3 x@@8 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 x@@8 f_7))) (=> (= (ControlFlow 0 8) 7) anon14_correct))))))
(let ((anon12_correct  (=> (state Heap@@9 Mask@3) (and (=> (= (ControlFlow 0 11) 8) anon22_Then_correct) (=> (= (ControlFlow 0 11) 10) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (not (or (not b1) (not b2))) (=> (and (= Mask@3 Mask@1) (= (ControlFlow 0 13) 11)) anon12_correct))))
(let ((anon21_Then_correct  (=> (and (and (and (or (not b1) (not b2)) (not (= x@@8 null))) (and (= Mask@2 (MapType1Store Mask@1 x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@1 x@@8 f_7)) FullPerm)))) (state Heap@@9 Mask@2))) (and (and (state Heap@@9 Mask@2) (state Heap@@9 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 12) 11)))) anon12_correct)))
(let ((anon20_Then_correct true))
(let ((anon8_correct  (=> (state Heap@@9 Mask@1) (and (and (=> (= (ControlFlow 0 14) 6) anon20_Then_correct) (=> (= (ControlFlow 0 14) 12) anon21_Then_correct)) (=> (= (ControlFlow 0 14) 13) anon21_Else_correct)))))
(let ((anon19_Else_correct  (=> (not b2) (=> (and (= Mask@1 ZeroMask) (= (ControlFlow 0 17) 14)) anon8_correct))))
(let ((anon19_Then_correct  (=> (and b2 (not (= x@@8 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm)))) (state Heap@@9 Mask@0)) (and (= Mask@1 Mask@0) (= (ControlFlow 0 16) 14))) anon8_correct))))
...
(let ((anon17_Then_correct  (=> (and b2 (not (= x@@8 null))) (=> (and (and (= Mask@5 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm)))) (state Heap@@9 Mask@5)) (and (= Mask@6 Mask@5) (= (ControlFlow 0 3) 1))) anon4_correct))))
...
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (and (and (and (=> (= (ControlFlow 0 19) 18) anon18_Then_correct) (=> (= (ControlFlow 0 19) 15) anon18_Else_correct)) (=> (= (ControlFlow 0 19) 5) anon16_Then_correct)) (=> (= (ControlFlow 0 19) 2) anon16_Else_correct)))))
