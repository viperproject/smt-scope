...
(assert  (and (= (type v_2@@9) ValDomainTypeType) (= (type Heap@@58) (MapType0Type RefType))))
(set-info :boogie-vc-id |lenBad#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon4_Else_correct  (=> (|lenBad#trigger| EmptyFrame (Cons v_2@@9 (Nil ValDomainTypeType)) v_2@@9) (=> (and (= Result@0 (lenBad Heap@@58 (Cons v_2@@9 (Nil ValDomainTypeType)) v_2@@9)) (= (ControlFlow 0 3) (- 0 2))) (>= Result@0 0)))))
(let ((anon4_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@58 ZeroMask) (= AssumeFunctionsAbove 9)) (and (=> (= (ControlFlow 0 4) 1) anon4_Then_correct) (=> (= (ControlFlow 0 4) 3) anon4_Else_correct)))))
...
(let ((anon4_Else_correct  (=> (not (= (DList_tag l@@44) 1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing l@@44 l@@44)) (=> (decreasing l@@44 l@@44) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded l@@44)) (=> (bounded l@@44) (=> (and (state Heap@@58 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
