...
(declare-fun vhavoc (T@U) T@U)
(declare-fun |havoc'| (T@U) T@U)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |havoc#triggerStateless| () T@U)
...
(declare-fun |havoc#frame| (T@U) T@U)
...
(assert  (and (and (forall ((arg0@@41 T@U) ) (! (= (type (vhavoc arg0@@41)) (MapType2Type RefType boolType))
 :qid |funType:vhavoc|
 :pattern ( (vhavoc arg0@@41))
)) (forall ((arg0@@42 T@U) ) (! (= (type (|havoc'| arg0@@42)) (MapType2Type RefType boolType))
 :qid |funType:havoc'|
 :pattern ( (|havoc'| arg0@@42))
))) (= (type |havoc#triggerStateless|) (MapType2Type RefType boolType))))
(assert (forall ((Heap@@5 T@U) ) (!  (=> (= (type Heap@@5) (MapType0Type RefType)) (and (= (vhavoc Heap@@5) (|havoc'| Heap@@5)) (dummyFunction |havoc#triggerStateless|)))
 :qid |stdinbpl.402:15|
 :skolemid |82|
 :pattern ( (vhavoc Heap@@5))
)))
...
(assert (forall ((Heap@@8 T@U) ) (!  (=> (= (type Heap@@8) (MapType0Type RefType)) (dummyFunction |havoc#triggerStateless|))
 :qid |stdinbpl.406:15|
 :skolemid |83|
 :pattern ( (|havoc'| Heap@@8))
)))
...
(assert (forall ((arg0@@45 T@U) ) (! (= (type (|havoc#frame| arg0@@45)) (MapType2Type RefType boolType))
 :qid |funType:havoc#frame|
 :pattern ( (|havoc#frame| arg0@@45))
)))
(assert (forall ((Heap@@10 T@U) (Mask@@9 T@U) ) (!  (=> (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (state Heap@@10 Mask@@9)) (= (|havoc'| Heap@@10) (|havoc#frame| EmptyFrame)))
 :qid |stdinbpl.413:15|
 :skolemid |84|
 :pattern ( (state Heap@@10 Mask@@9) (|havoc'| Heap@@10))
)))
...
(assert  (and (and (and (and (and (and (and (= (type Heap@0) (MapType0Type RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type refSet_b1@0) (MapType2Type RefType boolType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@12) (MapType0Type RefType))) (= (type a_2) RefType)) (= (type freshObj@0) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id clientB)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (forall ((r_3 T@U) ) (!  (=> (= (type r_3) RefType) (=> (and (U_2_bool (MapType2Select refSet_b1@0 r_3)) (dummyFunction (MapType0Select Heap@0 r_3 val))) (>= (U_2_real (MapType1Select Mask@1 r_3 val)) NoPerm)))
 :qid |stdinbpl.609:17|
 :skolemid |87|
 :pattern ( (MapType0Select Heap@0 r_3 val))
 :pattern ( (MapType1Select QPMask@0 r_3 val))
 :pattern ( (MapType2Select refSet_b1@0 r_3))
))) (=> (forall ((r_3@@0 T@U) ) (!  (=> (= (type r_3@@0) RefType) (=> (and (U_2_bool (MapType2Select refSet_b1@0 r_3@@0)) (dummyFunction (MapType0Select Heap@0 r_3@@0 val))) (>= (U_2_real (MapType1Select Mask@1 r_3@@0 val)) NoPerm)))
 :qid |stdinbpl.609:17|
 :skolemid |87|
 :pattern ( (MapType0Select Heap@0 r_3@@0 val))
 :pattern ( (MapType1Select QPMask@0 r_3@@0 val))
 :pattern ( (MapType2Select refSet_b1@0 r_3@@0))
)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((r_3@@1 T@U) (r_3_1 T@U) ) (!  (=> (and (= (type r_3@@1) RefType) (= (type r_3_1) RefType)) (=> (and (and (and (and (not (= r_3@@1 r_3_1)) (U_2_bool (MapType2Select refSet_b1@0 r_3@@1))) (U_2_bool (MapType2Select refSet_b1@0 r_3_1))) (< NoPerm (U_2_real (MapType1Select Mask@1 r_3@@1 val)))) (< NoPerm (U_2_real (MapType1Select Mask@1 r_3_1 val)))) (not (= r_3@@1 r_3_1))))
 :qid |stdinbpl.616:17|
 :skolemid |88|
 :pattern ( (neverTriggered1 r_3@@1) (neverTriggered1 r_3_1))
))) (=> (forall ((r_3@@2 T@U) (r_3_1@@0 T@U) ) (!  (=> (and (= (type r_3@@2) RefType) (= (type r_3_1@@0) RefType)) (=> (and (and (and (and (not (= r_3@@2 r_3_1@@0)) (U_2_bool (MapType2Select refSet_b1@0 r_3@@2))) (U_2_bool (MapType2Select refSet_b1@0 r_3_1@@0))) (< NoPerm (U_2_real (MapType1Select Mask@1 r_3@@2 val)))) (< NoPerm (U_2_real (MapType1Select Mask@1 r_3_1@@0 val)))) (not (= r_3@@2 r_3_1@@0))))
 :qid |stdinbpl.616:17|
 :skolemid |88|
 :pattern ( (neverTriggered1 r_3@@2) (neverTriggered1 r_3_1@@0))
)) (=> (= (ControlFlow 0 5) (- 0 4)) (forall ((r_3@@3 T@U) ) (!  (=> (and (= (type r_3@@3) RefType) (U_2_bool (MapType2Select refSet_b1@0 r_3@@3))) (>= (U_2_real (MapType1Select Mask@1 r_3@@3 val)) (U_2_real (MapType1Select Mask@1 r_3@@3 val))))
 :qid |stdinbpl.623:17|
 :skolemid |89|
 :pattern ( (MapType0Select Heap@0 r_3@@3 val))
 :pattern ( (MapType1Select QPMask@0 r_3@@3 val))
 :pattern ( (MapType2Select refSet_b1@0 r_3@@3))
)))))))))
(let ((anon9_Then_correct true))
(let ((anon8_Else_correct  (=> (forall ((r_1 T@U) ) (!  (=> (= (type r_1) RefType) (= (U_2_bool (MapType2Select refSet_b1@0 r_1)) (< NoPerm (U_2_real (MapType1Select Mask@1 r_1 val)))))
 :qid |stdinbpl.588:20|
 :skolemid |86|
 :pattern ( (MapType2Select refSet_b1@0 r_1))
 :pattern ( (MapType0Select Heap@0 r_1 val))
)) (=> (and (state Heap@0 Mask@1) (state Heap@0 Mask@1)) (and (=> (= (ControlFlow 0 8) 3) anon9_Then_correct) (=> (= (ControlFlow 0 8) 5) anon9_Else_correct))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (=> (and (= refSet_b1@0 (vhavoc Heap@0)) (state Heap@0 Mask@1)) (and (=> (= (ControlFlow 0 9) 2) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct)))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@12 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@12 a_2 $allocated))) (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@12 freshObj@0 $allocated))))) (and (and (= Heap@0 (MapType0Store Heap@@12 freshObj@0 $allocated (bool_2_U true))) (= Mask@0 (MapType1Store ZeroMask freshObj@0 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 f_7)) FullPerm))))) (and (= Mask@1 (MapType1Store Mask@0 freshObj@0 val (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@0 val)) FullPerm)))) (state Heap@0 Mask@1)))) (and (=> (= (ControlFlow 0 10) 1) anon7_Then_correct) (=> (= (ControlFlow 0 10) 9) anon7_Else_correct))))))
