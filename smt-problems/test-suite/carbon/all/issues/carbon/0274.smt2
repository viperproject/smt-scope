...
(declare-fun access_fields (T@U) T@U)
(declare-fun PredicateType_access_fieldsType () T@T)
(declare-fun |access_fields#trigger| (T@U T@U) Bool)
(declare-fun |access_fields#everUsed| (T@U) Bool)
...
(declare-fun |access_fields#sm| (T@U) T@U)
...
(= (type (MapType0Store arg0@@18 arg1@@6 arg2)) (MapType0Type aVar0 aVar1@@0))))
 ...
 :weight 0
)))) (= (Ctor RefType) 9)) (= (type neighbour) (FieldType NormalFieldType (MapType0Type RefType boolType)))) (= (type visited) (FieldType NormalFieldType boolType))))
(assert (distinct $allocated neighbour visited)
)
...
(assert  (and (= (Ctor PredicateType_access_fieldsType) 14) (forall ((arg0@@35 T@U) ) (! (= (type (access_fields arg0@@35)) (FieldType PredicateType_access_fieldsType FrameTypeType))
 :qid |funType:access_fields|
 :pattern ( (access_fields arg0@@35))
))))
(assert (forall ((node T@U) ) (!  (=> (= (type node) RefType) (IsPredicateField (access_fields node)))
 :qid |stdinbpl.403:15|
 :skolemid |83|
 :pattern ( (access_fields node))
)))
(assert (forall ((Heap@@2 T@U) (node@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType1Type RefType)) (= (type node@@0) RefType)) (|access_fields#everUsed| (access_fields node@@0)))
 :qid |stdinbpl.422:15|
 :skolemid |87|
 :pattern ( (|access_fields#trigger| Heap@@2 (access_fields node@@0)))
)))
...
(assert (forall ((node@@1 T@U) (node2 T@U) ) (!  (=> (and (and (= (type node@@1) RefType) (= (type node2) RefType)) (= (access_fields node@@1) (access_fields node2))) (= node@@1 node2))
 :qid |stdinbpl.413:15|
 :skolemid |85|
 :pattern ( (access_fields node@@1) (access_fields node2))
)))
(assert (forall ((arg0@@39 T@U) ) (! (= (type (|access_fields#sm| arg0@@39)) (FieldType PredicateType_access_fieldsType (MapType2Type RefType boolType)))
 :qid |funType:access_fields#sm|
 :pattern ( (|access_fields#sm| arg0@@39))
)))
(assert (forall ((node@@2 T@U) (node2@@0 T@U) ) (!  (=> (and (and (= (type node@@2) RefType) (= (type node2@@0) RefType)) (= (|access_fields#sm| node@@2) (|access_fields#sm| node2@@0))) (= node@@2 node2@@0))
 :qid |stdinbpl.417:15|
 :skolemid |86|
...
(assert  (not (IsPredicateField neighbour)))
(assert  (not (IsWandField neighbour)))
...
(assert (forall ((arg0@@43 T@U) (arg1@@21 T@U) ) (! (let ((T@@20 (MapType0TypeInv0 (type arg0@@43))))
(= (type (|Set#Difference| arg0@@43 arg1@@21)) (MapType0Type T@@20 boolType)))
...
(= (type (|Set#UnionOne| arg0@@44 arg1@@22)) (MapType0Type T@@24 boolType)))
...
(assert (forall ((node@@3 T@U) ) (!  (=> (= (type node@@3) RefType) (= (getPredWandId (access_fields node@@3)) 0))
 :qid |stdinbpl.407:15|
 :skolemid |84|
...
(assert (forall ((node@@4 T@U) ) (!  (=> (= (type node@@4) RefType) (= (PredicateMaskField (access_fields node@@4)) (|access_fields#sm| node@@4)))
 :qid |stdinbpl.399:15|
 :skolemid |82|
 :pattern ( (PredicateMaskField (access_fields node@@4)))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type all_nodes) (MapType0Type RefType boolType)) (= (type n) RefType)) (= (type UnfoldingMask@3) (MapType2Type RefType realType))) (= (type QPMask@0) (MapType2Type RefType realType))) (= (type UnfoldingMask@4) (MapType2Type RefType realType))) (= (type Heap@@10) (MapType1Type RefType))) (= (type UnfoldingMask@5) (MapType2Type RefType realType))) (= (type Heap@2) (MapType1Type RefType))) (= (type Heap@3) (MapType1Type RefType))) (forall ((arg0@@45 T@U) (arg1@@23 T@U) ) (! (= (type (CombineFrames arg0@@45 arg1@@23)) FrameTypeType)
...
))) (= (type nn) RefType)) (= (type curr_node) RefType)) (= (type UnfoldingMask@0) (MapType2Type RefType realType))) (= (type UnfoldingMask@1) (MapType2Type RefType realType))) (= (type UnfoldingMask@2) (MapType2Type RefType realType))) (= (type Heap@0) (MapType1Type RefType))) (= (type Heap@1) (MapType1Type RefType))) (forall ((arg0@@47 T@U) ) (! (= (type (invRecv1 arg0@@47)) RefType)
...
(let ((anon13_correct  (=> (and (= UnfoldingMask@0 (MapType2Store QPMask@0 null (access_fields nn) (real_2_U (- (U_2_real (MapType2Select QPMask@0 null (access_fields nn))) FullPerm)))) (= perm@0 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 15) (- 0 17)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= nn null))) (=> (and (= UnfoldingMask@1 (MapType2Store UnfoldingMask@0 nn neighbour (real_2_U (+ (U_2_real (MapType2Select UnfoldingMask@0 nn neighbour)) perm@0)))) (state Heap@@10 UnfoldingMask@1)) (=> (and (and (not (= nn null)) (= UnfoldingMask@2 (MapType2Store UnfoldingMask@1 nn visited (real_2_U (+ (U_2_real (MapType2Select UnfoldingMask@1 nn visited)) FullPerm))))) (and (state Heap@@10 UnfoldingMask@2) (state Heap@@10 UnfoldingMask@2))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm UnfoldingMask@2 nn visited)) (=> (HasDirectPerm UnfoldingMask@2 nn visited) (=> (and (and (= Heap@0 (MapType1Store Heap@@10 null (|access_fields#sm| nn) (MapType2Store (MapType1Select Heap@@10 null (|access_fields#sm| nn)) nn neighbour (bool_2_U true)))) (= Heap@1 (MapType1Store Heap@0 null (|access_fields#sm| nn) (MapType2Store (MapType1Select Heap@0 null (|access_fields#sm| nn)) nn visited (bool_2_U true))))) (and (state Heap@1 QPMask@0) (= (ControlFlow 0 15) 12))) anon14_correct)))))))))))
(let ((anon23_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 20) 15)) anon13_correct)))
(let ((anon23_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (<= FullPerm (U_2_real (MapType2Select QPMask@0 null (access_fields nn))))) (=> (<= FullPerm (U_2_real (MapType2Select QPMask@0 null (access_fields nn)))) (=> (= (ControlFlow 0 18) 15) anon13_correct))))))
(let ((anon22_Then_correct  (=> (not (= nn curr_node)) (=> (and (|access_fields#trigger| Heap@@10 (access_fields nn)) (= (MapType1Select Heap@@10 null (access_fields nn)) (CombineFrames (FrameFragment (MapType1Select Heap@@10 nn neighbour)) (FrameFragment (MapType1Select Heap@@10 nn visited))))) (and (=> (= (ControlFlow 0 21) 18) anon23_Then_correct) (=> (= (ControlFlow 0 21) 20) anon23_Else_correct))))))
(let ((anon22_Else_correct  (=> (and (= nn curr_node) (= (ControlFlow 0 14) 12)) anon14_correct)))
(let ((anon21_Then_correct  (=> (U_2_bool (MapType0Select all_nodes nn)) (and (=> (= (ControlFlow 0 22) 21) anon22_Then_correct) (=> (= (ControlFlow 0 22) 14) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (and (not (U_2_bool (MapType0Select all_nodes nn))) (= (ControlFlow 0 13) 12)) anon14_correct)))
(let ((anon20_Else_correct true))
(let ((anon17_Else_correct  (=> (and (and (forall ((n_4 T@U) ) (!  (=> (and (= (type n_4) RefType) (U_2_bool (MapType0Select all_nodes n_4))) (|Set#Subset| (MapType1Select Heap@@10 n_4 neighbour) all_nodes))
 :qid |stdinbpl.555:20|
 :skolemid |94|
 :pattern ( (MapType0Select all_nodes n_4))
)) (state Heap@@10 QPMask@0)) (and (U_2_bool (MapType0Select all_nodes curr_node)) (state Heap@@10 QPMask@0))) (and (and (=> (= (ControlFlow 0 23) 11) anon20_Else_correct) (=> (= (ControlFlow 0 23) 22) anon21_Then_correct)) (=> (= (ControlFlow 0 23) 13) anon21_Else_correct)))))
(let ((anon7_correct true))
(let ((anon6_correct  (=> (and (= UnfoldingMask@3 (MapType2Store QPMask@0 null (access_fields n) (real_2_U (- (U_2_real (MapType2Select QPMask@0 null (access_fields n))) FullPerm)))) (= perm@1 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (=> (> perm@1 NoPerm) (not (= n null))) (=> (and (= UnfoldingMask@4 (MapType2Store UnfoldingMask@3 n neighbour (real_2_U (+ (U_2_real (MapType2Select UnfoldingMask@3 n neighbour)) perm@1)))) (state Heap@@10 UnfoldingMask@4)) (=> (and (and (not (= n null)) (= UnfoldingMask@5 (MapType2Store UnfoldingMask@4 n visited (real_2_U (+ (U_2_real (MapType2Select UnfoldingMask@4 n visited)) FullPerm))))) (and (state Heap@@10 UnfoldingMask@5) (state Heap@@10 UnfoldingMask@5))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm UnfoldingMask@5 n neighbour)) (=> (HasDirectPerm UnfoldingMask@5 n neighbour) (=> (and (and (= Heap@2 (MapType1Store Heap@@10 null (|access_fields#sm| n) (MapType2Store (MapType1Select Heap@@10 null (|access_fields#sm| n)) n neighbour (bool_2_U true)))) (= Heap@3 (MapType1Store Heap@2 null (|access_fields#sm| n) (MapType2Store (MapType1Select Heap@2 null (|access_fields#sm| n)) n visited (bool_2_U true))))) (and (state Heap@3 QPMask@0) (= (ControlFlow 0 4) 2))) anon7_correct)))))))))))
(let ((anon19_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 4)) anon6_correct)))
(let ((anon19_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType2Select QPMask@0 null (access_fields n))))) (=> (<= FullPerm (U_2_real (MapType2Select QPMask@0 null (access_fields n)))) (=> (= (ControlFlow 0 7) 4) anon6_correct))))))
(let ((anon18_Then_correct  (=> (U_2_bool (MapType0Select all_nodes n)) (=> (and (|access_fields#trigger| Heap@@10 (access_fields n)) (= (MapType1Select Heap@@10 null (access_fields n)) (CombineFrames (FrameFragment (MapType1Select Heap@@10 n neighbour)) (FrameFragment (MapType1Select Heap@@10 n visited))))) (and (=> (= (ControlFlow 0 10) 7) anon19_Then_correct) (=> (= (ControlFlow 0 10) 9) anon19_Else_correct))))))
(let ((anon18_Else_correct  (=> (and (not (U_2_bool (MapType0Select all_nodes n))) (= (ControlFlow 0 3) 2)) anon7_correct)))
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 24) (- 0 25)) (forall ((n_1 T@U) (n_1_1 T@U) ) (!  (=> (and (= (type n_1) RefType) (= (type n_1_1) RefType)) (=> (and (and (and (and (not (= n_1 n_1_1)) (U_2_bool (MapType0Select all_nodes n_1))) (U_2_bool (MapType0Select all_nodes n_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1))))
 :qid |stdinbpl.486:17|
 :skolemid |88|
 :pattern ( (neverTriggered1 n_1) (neverTriggered1 n_1_1))
))) (=> (forall ((n_1@@0 T@U) (n_1_1@@0 T@U) ) (!  (=> (and (= (type n_1@@0) RefType) (= (type n_1_1@@0) RefType)) (=> (and (and (and (and (not (= n_1@@0 n_1_1@@0)) (U_2_bool (MapType0Select all_nodes n_1@@0))) (U_2_bool (MapType0Select all_nodes n_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1@@0 n_1_1@@0))))
 :qid |stdinbpl.486:17|
 :skolemid |88|
 :pattern ( (neverTriggered1 n_1@@0) (neverTriggered1 n_1_1@@0))
)) (=> (and (forall ((n_1@@1 T@U) ) (!  (=> (= (type n_1@@1) RefType) (=> (and (U_2_bool (MapType0Select all_nodes n_1@@1)) (< NoPerm FullPerm)) (and (= (invRecv1 n_1@@1) n_1@@1) (qpRange1 n_1@@1))))
 :qid |stdinbpl.492:22|
 :skolemid |89|
 :pattern ( (MapType1Select Heap@@10 null (access_fields n_1@@1)))
 :pattern ( (MapType2Select ZeroMask null (access_fields n_1@@1)))
 :pattern ( (MapType0Select all_nodes n_1@@1))
)) (forall ((node@@5 T@U) ) (!  (=> (= (type node@@5) RefType) (=> (and (and (U_2_bool (MapType0Select all_nodes (invRecv1 node@@5))) (< NoPerm FullPerm)) (qpRange1 node@@5)) (= (invRecv1 node@@5) node@@5)))
 :qid |stdinbpl.496:22|
 :skolemid |90|
 :pattern ( (invRecv1 node@@5))
))) (=> (and (and (forall ((node@@6 T@U) ) (!  (=> (= (type node@@6) RefType) (=> (and (and (U_2_bool (MapType0Select all_nodes (invRecv1 node@@6))) (< NoPerm FullPerm)) (qpRange1 node@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv1 node@@6) node@@6)) (= (U_2_real (MapType2Select QPMask@0 null (access_fields node@@6))) (+ (U_2_real (MapType2Select ZeroMask null (access_fields node@@6))) FullPerm)))))
 :qid |stdinbpl.502:22|
 :skolemid |91|
 :pattern ( (MapType2Select QPMask@0 null (access_fields node@@6)))
...
))) (and (forall ((node@@7 T@U) ) (!  (=> (and (= (type node@@7) RefType) (not (and (and (U_2_bool (MapType0Select all_nodes (invRecv1 node@@7))) (< NoPerm FullPerm)) (qpRange1 node@@7)))) (= (U_2_real (MapType2Select QPMask@0 null (access_fields node@@7))) (U_2_real (MapType2Select ZeroMask null (access_fields node@@7)))))
 :qid |stdinbpl.512:22|
 :skolemid |93|
 :pattern ( (MapType2Select QPMask@0 null (access_fields node@@7)))
)) (state Heap@@10 QPMask@0))) (and (and (=> (= (ControlFlow 0 24) 23) anon17_Else_correct) (=> (= (ControlFlow 0 24) 10) anon18_Then_correct)) (=> (= (ControlFlow 0 24) 3) anon18_Else_correct))))))))
(let ((anon16_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType1Select Heap@@10 curr_node $allocated))) (and (=> (= (ControlFlow 0 26) 1) anon16_Then_correct) (=> (= (ControlFlow 0 26) 24) anon16_Else_correct)))))
