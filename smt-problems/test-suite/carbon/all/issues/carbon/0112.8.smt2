...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@75 ZeroMask) (=> (and (and (= AssumeFunctionsAbove 8) (not (= x@@36 0))) (and (state Heap@@75 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (not (= x@@36 0))))))
