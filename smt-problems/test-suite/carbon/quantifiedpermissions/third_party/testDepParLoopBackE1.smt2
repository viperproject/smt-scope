...
(assert  (and (and (= (type Heap@@33) (MapType0Type RefType)) (= (type diz) RefType)) (= (type ar@@27) (SeqType RefType))))
(set-info :boogie-vc-id Ref__send_body_152)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@33 diz $allocated)) (not (= diz null))) (and (state Heap@@33 ZeroMask) (>= current_thread_id 0))) (and (and (state Heap@@33 ZeroMask) (<= (- 0 1) i@@34)) (and (< (+ i@@34 1) (|Seq#Length| ar@@27)) (state Heap@@33 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= (+ i@@34 1) 0)) (=> (>= (+ i@@34 1) 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< (+ i@@34 1) (|Seq#Length| ar@@27))) (=> (< (+ i@@34 1) (|Seq#Length| ar@@27)) (=> (and (= perm@0 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@0 NoPerm))))))))))
