...
(assert  (and (and (and (and (and (and (and (= (type x@@25) RefType) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@18) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |Tree#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_correct true))
(let ((anon4_Else_correct  (=> (not (= x@@25 null)) (=> (and (not (= x@@25 null)) (= Mask@0 (MapType1Store ZeroMask x@@25 v_2 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@25 v_2)) FullPerm))))) (=> (and (and (state Heap@@18 Mask@0) (not (= x@@25 null))) (and (= Mask@1 (MapType1Store Mask@0 x@@25 l (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@25 l)) FullPerm)))) (state Heap@@18 Mask@1))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm Mask@1 x@@25 l)) (=> (HasDirectPerm Mask@1 x@@25 l) (=> (= Mask@2 (MapType1Store Mask@1 null (Tree (MapType0Select Heap@@18 x@@25 l)) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (Tree (MapType0Select Heap@@18 x@@25 l)))) FullPerm)))) (=> (and (and (state Heap@@18 Mask@2) (not (= x@@25 null))) (and (= Mask@3 (MapType1Store Mask@2 x@@25 r_1 (real_2_U (+ (U_2_real (MapType1Select Mask@2 x@@25 r_1)) FullPerm)))) (state Heap@@18 Mask@3))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm Mask@3 x@@25 r_1)) (=> (HasDirectPerm Mask@3 x@@25 r_1) (=> (and (and (= Mask@4 (MapType1Store Mask@3 null (Tree (MapType0Select Heap@@18 x@@25 r_1)) (real_2_U (+ (U_2_real (MapType1Select Mask@3 null (Tree (MapType0Select Heap@@18 x@@25 r_1)))) FullPerm)))) (state Heap@@18 Mask@4)) (and (= Mask@5 Mask@4) (= (ControlFlow 0 3) 1))) anon3_correct))))))))))))
(let ((anon4_Then_correct  (=> (= x@@25 null) (=> (and (= Mask@5 ZeroMask) (= (ControlFlow 0 2) 1)) anon3_correct))))
(let ((anon0_correct  (=> (state Heap@@18 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@18 x@@25 $allocated))) (and (=> (= (ControlFlow 0 6) 2) anon4_Then_correct) (=> (= (ControlFlow 0 6) 3) anon4_Else_correct))))))
