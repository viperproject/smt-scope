...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon4_Else_correct  (=> (|f#trigger| EmptyFrame x@@28) (=> (and (= Result@0 (f_6 Heap@@29 x@@28)) (= (ControlFlow 0 3) (- 0 2))) (= Result@0 x@@28)))))
(let ((anon4_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@29 ZeroMask) (= AssumeFunctionsAbove 2)) (and (=> (= (ControlFlow 0 4) 1) anon4_Then_correct) (=> (= (ControlFlow 0 4) 3) anon4_Else_correct)))))
