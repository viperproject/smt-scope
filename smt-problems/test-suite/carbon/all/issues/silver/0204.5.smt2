...
(declare-fun wand_1 (T@U Bool Bool) T@U)
...
(declare-fun |wand_1#ft| (T@U Bool Bool) T@U)
(declare-fun FrameTypeType () T@T)
(declare-fun getPredWandId (T@U) Int)
(declare-fun IsPredicateField (T@U) Bool)
(declare-fun wand (Real Bool) T@U)
(declare-fun WandType_wandType () T@T)
(declare-fun |wand#ft| (Real Bool) T@U)
...
(declare-fun wand_2 () T@U)
(declare-fun WandType_wand_2Type () T@T)
(declare-fun |wand_2#ft| () T@U)
(declare-fun wand_3 () T@U)
(declare-fun WandType_wand_3Type () T@T)
(declare-fun |wand_3#ft| () T@U)
(declare-fun wand_6 (Bool) T@U)
(declare-fun WandType_wand_6Type () T@T)
(declare-fun |wand_6#ft| (Bool) T@U)
(declare-fun wand_7 (Bool) T@U)
(declare-fun WandType_wand_7Type () T@T)
(declare-fun |wand_7#ft| (Bool) T@U)
(declare-fun wand_4 (Bool) T@U)
(declare-fun WandType_wand_4Type () T@T)
(declare-fun |wand_4#ft| (Bool) T@U)
(declare-fun wand_5 (Bool) T@U)
(declare-fun WandType_wand_5Type () T@T)
(declare-fun |wand_5#ft| (Bool) T@U)
(declare-fun |MultiSet#Select| (T@U T@U) Int)
(declare-fun |Set#Union| (T@U T@U) T@U)
(declare-fun |Set#Intersection| (T@U T@U) T@U)
(declare-fun |Set#Singleton| (T@U) T@U)
(declare-fun |wand_1#sm| (T@U Bool Bool) T@U)
...
(declare-fun |wand#sm| (Real Bool) T@U)
(declare-fun |Set#Subset| (T@U T@U) Bool)
(declare-fun |wand_6#sm| (Bool) T@U)
(declare-fun |wand_7#sm| (Bool) T@U)
(declare-fun |wand_4#sm| (Bool) T@U)
(declare-fun |wand_5#sm| (Bool) T@U)
(declare-fun |wand_2#sm| () T@U)
(declare-fun |wand_3#sm| () T@U)
...
(assert  (and (and (and (and (and (and (and (and (forall ((arg0@@28 T@T) (arg1@@12 T@T) ) (! (= (Ctor (MapType2Type arg0@@28 arg1@@12)) 12)
...
(= (type (MapType2Store arg0@@32 arg1@@16 arg2@@3)) (MapType2Type aVar0@@1 aVar1@@3))))
 ...
 :weight 0
)))) (= (Ctor WandType_wand_1Type) 13)) (forall ((arg0@@33 T@U) (arg1@@17 Bool) (arg2@@4 Bool) ) (! (= (type (wand_1 arg0@@33 arg1@@17 arg2@@4)) (FieldType WandType_wand_1Type intType))
 :qid |funType:wand_1|
 :pattern ( (wand_1 arg0@@33 arg1@@17 arg2@@4))
))))
(assert (forall ((arg1@@18 T@U) (arg2@@5 Bool) (arg3@@1 Bool) ) (!  (=> (= (type arg1@@18) (MapType2Type boolType boolType)) (IsWandField (wand_1 arg1@@18 arg2@@5 arg3@@1)))
 :qid |stdinbpl.586:15|
 :skolemid |117|
 :pattern ( (wand_1 arg1@@18 arg2@@5 arg3@@1))
)))
(assert  (and (= (Ctor FrameTypeType) 14) (forall ((arg0@@34 T@U) (arg1@@19 Bool) (arg2@@6 Bool) ) (! (= (type (|wand_1#ft| arg0@@34 arg1@@19 arg2@@6)) (FieldType WandType_wand_1Type FrameTypeType))
 :qid |funType:wand_1#ft|
 :pattern ( (|wand_1#ft| arg0@@34 arg1@@19 arg2@@6))
))))
(assert (forall ((arg1@@20 T@U) (arg2@@7 Bool) (arg3@@2 Bool) ) (!  (=> (= (type arg1@@20) (MapType2Type boolType boolType)) (IsWandField (|wand_1#ft| arg1@@20 arg2@@7 arg3@@2)))
 :qid |stdinbpl.590:15|
 :skolemid |118|
 :pattern ( (|wand_1#ft| arg1@@20 arg2@@7 arg3@@2))
)))
(assert (forall ((arg1@@21 T@U) (arg2@@8 Bool) (arg3@@3 Bool) ) (!  (=> (= (type arg1@@21) (MapType2Type boolType boolType)) (= (getPredWandId (wand_1 arg1@@21 arg2@@8 arg3@@3)) 7))
 :qid |stdinbpl.606:15|
 :skolemid |122|
 :pattern ( (wand_1 arg1@@21 arg2@@8 arg3@@3))
)))
(assert (forall ((arg1@@22 T@U) (arg2@@9 Bool) (arg3@@4 Bool) ) (!  (=> (= (type arg1@@22) (MapType2Type boolType boolType)) (not (IsPredicateField (wand_1 arg1@@22 arg2@@9 arg3@@4))))
 :qid |stdinbpl.594:15|
 :skolemid |119|
 :pattern ( (wand_1 arg1@@22 arg2@@9 arg3@@4))
)))
(assert (forall ((arg1@@23 T@U) (arg2@@10 Bool) (arg3@@5 Bool) ) (!  (=> (= (type arg1@@23) (MapType2Type boolType boolType)) (not (IsPredicateField (|wand_1#ft| arg1@@23 arg2@@10 arg3@@5))))
 :qid |stdinbpl.598:15|
 :skolemid |120|
 :pattern ( (|wand_1#ft| arg1@@23 arg2@@10 arg3@@5))
)))
(assert  (and (= (Ctor WandType_wandType) 15) (forall ((arg0@@35 Real) (arg1@@24 Bool) ) (! (= (type (wand arg0@@35 arg1@@24)) (FieldType WandType_wandType intType))
 :qid |funType:wand|
 :pattern ( (wand arg0@@35 arg1@@24))
))))
(assert (forall ((arg1@@25 Real) (arg2@@11 Bool) ) (! (IsWandField (wand arg1@@25 arg2@@11))
 :qid |stdinbpl.447:15|
 :skolemid |89|
 :pattern ( (wand arg1@@25 arg2@@11))
)))
(assert (forall ((arg0@@36 Real) (arg1@@26 Bool) ) (! (= (type (|wand#ft| arg0@@36 arg1@@26)) (FieldType WandType_wandType FrameTypeType))
 :qid |funType:wand#ft|
 :pattern ( (|wand#ft| arg0@@36 arg1@@26))
)))
(assert (forall ((arg1@@27 Real) (arg2@@12 Bool) ) (! (IsWandField (|wand#ft| arg1@@27 arg2@@12))
 :qid |stdinbpl.451:15|
 :skolemid |90|
 :pattern ( (|wand#ft| arg1@@27 arg2@@12))
)))
...
(assert  (and (= (Ctor WandType_wand_2Type) 16) (= (type wand_2) (FieldType WandType_wand_2Type intType))))
(assert (IsWandField wand_2))
(assert (= (type |wand_2#ft|) (FieldType WandType_wand_2Type FrameTypeType)))
(assert (IsWandField |wand_2#ft|))
(assert  (and (= (Ctor WandType_wand_3Type) 17) (= (type wand_3) (FieldType WandType_wand_3Type intType))))
(assert (IsWandField wand_3))
(assert (= (type |wand_3#ft|) (FieldType WandType_wand_3Type FrameTypeType)))
(assert (IsWandField |wand_3#ft|))
(assert (forall ((arg1@@28 Real) (arg2@@13 Bool) ) (!  (not (IsPredicateField (wand arg1@@28 arg2@@13)))
 :qid |stdinbpl.455:15|
 :skolemid |91|
 :pattern ( (wand arg1@@28 arg2@@13))
)))
(assert (forall ((arg1@@29 Real) (arg2@@14 Bool) ) (!  (not (IsPredicateField (|wand#ft| arg1@@29 arg2@@14)))
 :qid |stdinbpl.459:15|
 :skolemid |92|
 :pattern ( (|wand#ft| arg1@@29 arg2@@14))
)))
(assert (= (getPredWandId wand_2) 1))
(assert (= (getPredWandId wand_3) 6))
(assert  (not (IsPredicateField wand_2)))
(assert  (not (IsPredicateField |wand_2#ft|)))
(assert  (not (IsPredicateField wand_3)))
(assert  (not (IsPredicateField |wand_3#ft|)))
(assert  (and (= (Ctor WandType_wand_6Type) 18) (forall ((arg0@@39 Bool) ) (! (= (type (wand_6 arg0@@39)) (FieldType WandType_wand_6Type intType))
 :qid |funType:wand_6|
 :pattern ( (wand_6 arg0@@39))
))))
(assert (forall ((arg1@@30 Bool) ) (! (IsWandField (wand_6 arg1@@30))
 :qid |stdinbpl.404:15|
 :skolemid |82|
 :pattern ( (wand_6 arg1@@30))
)))
(assert (forall ((arg0@@40 Bool) ) (! (= (type (|wand_6#ft| arg0@@40)) (FieldType WandType_wand_6Type FrameTypeType))
 :qid |funType:wand_6#ft|
 :pattern ( (|wand_6#ft| arg0@@40))
)))
(assert (forall ((arg1@@31 Bool) ) (! (IsWandField (|wand_6#ft| arg1@@31))
 :qid |stdinbpl.408:15|
 :skolemid |83|
 :pattern ( (|wand_6#ft| arg1@@31))
)))
(assert  (and (= (Ctor WandType_wand_7Type) 19) (forall ((arg0@@41 Bool) ) (! (= (type (wand_7 arg0@@41)) (FieldType WandType_wand_7Type intType))
 :qid |funType:wand_7|
 :pattern ( (wand_7 arg0@@41))
))))
(assert (forall ((arg1@@32 Bool) ) (! (IsWandField (wand_7 arg1@@32))
 :qid |stdinbpl.479:15|
 :skolemid |96|
 :pattern ( (wand_7 arg1@@32))
)))
(assert (forall ((arg0@@42 Bool) ) (! (= (type (|wand_7#ft| arg0@@42)) (FieldType WandType_wand_7Type FrameTypeType))
 :qid |funType:wand_7#ft|
 :pattern ( (|wand_7#ft| arg0@@42))
)))
(assert (forall ((arg1@@33 Bool) ) (! (IsWandField (|wand_7#ft| arg1@@33))
 :qid |stdinbpl.483:15|
 :skolemid |97|
 :pattern ( (|wand_7#ft| arg1@@33))
)))
(assert  (and (= (Ctor WandType_wand_4Type) 20) (forall ((arg0@@43 Bool) ) (! (= (type (wand_4 arg0@@43)) (FieldType WandType_wand_4Type intType))
 :qid |funType:wand_4|
 :pattern ( (wand_4 arg0@@43))
))))
(assert (forall ((arg1@@34 Bool) ) (! (IsWandField (wand_4 arg1@@34))
 :qid |stdinbpl.511:15|
 :skolemid |103|
 :pattern ( (wand_4 arg1@@34))
)))
(assert (forall ((arg0@@44 Bool) ) (! (= (type (|wand_4#ft| arg0@@44)) (FieldType WandType_wand_4Type FrameTypeType))
 :qid |funType:wand_4#ft|
 :pattern ( (|wand_4#ft| arg0@@44))
)))
(assert (forall ((arg1@@35 Bool) ) (! (IsWandField (|wand_4#ft| arg1@@35))
 :qid |stdinbpl.515:15|
 :skolemid |104|
 :pattern ( (|wand_4#ft| arg1@@35))
)))
(assert  (and (= (Ctor WandType_wand_5Type) 21) (forall ((arg0@@45 Bool) ) (! (= (type (wand_5 arg0@@45)) (FieldType WandType_wand_5Type intType))
 :qid |funType:wand_5|
 :pattern ( (wand_5 arg0@@45))
))))
(assert (forall ((arg1@@36 Bool) ) (! (IsWandField (wand_5 arg1@@36))
 :qid |stdinbpl.543:15|
 :skolemid |110|
 :pattern ( (wand_5 arg1@@36))
)))
(assert (forall ((arg0@@46 Bool) ) (! (= (type (|wand_5#ft| arg0@@46)) (FieldType WandType_wand_5Type FrameTypeType))
 :qid |funType:wand_5#ft|
 :pattern ( (|wand_5#ft| arg0@@46))
)))
(assert (forall ((arg1@@37 Bool) ) (! (IsWandField (|wand_5#ft| arg1@@37))
 :qid |stdinbpl.547:15|
 :skolemid |111|
 :pattern ( (|wand_5#ft| arg1@@37))
)))
...
(assert (forall ((arg0@@47 T@U) (arg1@@38 T@U) ) (! (let ((T@@4 (MapType2TypeInv0 (type arg0@@47))))
(= (type (|Set#Union| arg0@@47 arg1@@38)) (MapType2Type T@@4 boolType)))
 :qid |funType:Set#Union|
 :pattern ( (|Set#Union| arg0@@47 arg1@@38))
)))
...
(assert (forall ((arg0@@48 T@U) (arg1@@39 T@U) ) (! (let ((T@@6 (MapType2TypeInv0 (type arg0@@48))))
(= (type (|Set#Intersection| arg0@@48 arg1@@39)) (MapType2Type T@@6 boolType)))
 :qid |funType:Set#Intersection|
 :pattern ( (|Set#Intersection| arg0@@48 arg1@@39))
)))
...
(assert (forall ((arg1@@40 Bool) ) (!  (not (IsPredicateField (wand_6 arg1@@40)))
 :qid |stdinbpl.412:15|
 :skolemid |84|
 :pattern ( (wand_6 arg1@@40))
)))
(assert (forall ((arg1@@41 Bool) ) (!  (not (IsPredicateField (|wand_6#ft| arg1@@41)))
 :qid |stdinbpl.416:15|
 :skolemid |85|
 :pattern ( (|wand_6#ft| arg1@@41))
)))
(assert (forall ((arg1@@42 Bool) ) (!  (not (IsPredicateField (wand_7 arg1@@42)))
 :qid |stdinbpl.487:15|
 :skolemid |98|
 :pattern ( (wand_7 arg1@@42))
)))
(assert (forall ((arg1@@43 Bool) ) (!  (not (IsPredicateField (|wand_7#ft| arg1@@43)))
 :qid |stdinbpl.491:15|
 :skolemid |99|
 :pattern ( (|wand_7#ft| arg1@@43))
)))
(assert (forall ((arg1@@44 Bool) ) (!  (not (IsPredicateField (wand_4 arg1@@44)))
 :qid |stdinbpl.519:15|
 :skolemid |105|
 :pattern ( (wand_4 arg1@@44))
)))
(assert (forall ((arg1@@45 Bool) ) (!  (not (IsPredicateField (|wand_4#ft| arg1@@45)))
 :qid |stdinbpl.523:15|
 :skolemid |106|
 :pattern ( (|wand_4#ft| arg1@@45))
)))
(assert (forall ((arg1@@46 Bool) ) (!  (not (IsPredicateField (wand_5 arg1@@46)))
 :qid |stdinbpl.551:15|
 :skolemid |112|
 :pattern ( (wand_5 arg1@@46))
)))
(assert (forall ((arg1@@47 Bool) ) (!  (not (IsPredicateField (|wand_5#ft| arg1@@47)))
 :qid |stdinbpl.555:15|
 :skolemid |113|
 :pattern ( (|wand_5#ft| arg1@@47))
)))
(assert (forall ((arg0@@49 T@U) ) (! (let ((T@@9 (type arg0@@49)))
(= (type (|Set#Singleton| arg0@@49)) (MapType2Type T@@9 boolType)))
...
(assert (forall ((arg0@@50 T@U) (arg1@@48 Bool) (arg2@@15 Bool) ) (! (= (type (|wand_1#sm| arg0@@50 arg1@@48 arg2@@15)) (FieldType WandType_wand_1Type (MapType1Type RefType boolType)))
 :qid |funType:wand_1#sm|
 :pattern ( (|wand_1#sm| arg0@@50 arg1@@48 arg2@@15))
)))
(assert (forall ((arg1@@49 T@U) (arg2@@16 Bool) (arg3@@6 Bool) ) (!  (=> (= (type arg1@@49) (MapType2Type boolType boolType)) (= (|wand_1#sm| arg1@@49 arg2@@16 arg3@@6) (WandMaskField (|wand_1#ft| arg1@@49 arg2@@16 arg3@@6))))
 :qid |stdinbpl.602:15|
 :skolemid |121|
 :pattern ( (WandMaskField (|wand_1#ft| arg1@@49 arg2@@16 arg3@@6)))
)))
(assert (forall ((arg1@@50 Real) (arg2@@17 Bool) (arg1_2 Real) (arg2_2 Bool) ) (!  (=> (= (wand arg1@@50 arg2@@17) (wand arg1_2 arg2_2)) (and (= arg1@@50 arg1_2) (= arg2@@17 arg2_2)))
 :qid |stdinbpl.471:15|
 :skolemid |95|
 :pattern ( (wand arg1@@50 arg2@@17) (wand arg1_2 arg2_2))
)))
...
(assert (forall ((arg1@@51 Bool) (arg1_2@@0 Bool) ) (!  (=> (= (wand_6 arg1@@51) (wand_6 arg1_2@@0)) (= arg1@@51 arg1_2@@0))
 :qid |stdinbpl.428:15|
 :skolemid |88|
 :pattern ( (wand_6 arg1@@51) (wand_6 arg1_2@@0))
)))
(assert (forall ((arg1@@52 Bool) (arg1_2@@1 Bool) ) (!  (=> (= (wand_7 arg1@@52) (wand_7 arg1_2@@1)) (= arg1@@52 arg1_2@@1))
 :qid |stdinbpl.503:15|
 :skolemid |102|
 :pattern ( (wand_7 arg1@@52) (wand_7 arg1_2@@1))
)))
(assert (forall ((arg1@@53 Bool) (arg1_2@@2 Bool) ) (!  (=> (= (wand_4 arg1@@53) (wand_4 arg1_2@@2)) (= arg1@@53 arg1_2@@2))
 :qid |stdinbpl.535:15|
 :skolemid |109|
 :pattern ( (wand_4 arg1@@53) (wand_4 arg1_2@@2))
)))
(assert (forall ((arg1@@54 Bool) (arg1_2@@3 Bool) ) (!  (=> (= (wand_5 arg1@@54) (wand_5 arg1_2@@3)) (= arg1@@54 arg1_2@@3))
 :qid |stdinbpl.567:15|
 :skolemid |116|
 :pattern ( (wand_5 arg1@@54) (wand_5 arg1_2@@3))
)))
...
(assert (forall ((arg0@@51 T@U) (arg1@@55 T@U) ) (! (let ((T@@13 (type arg1@@55)))
(= (type (|MultiSet#UnionOne| arg0@@51 arg1@@55)) (MultiSetType T@@13)))
 :qid |funType:MultiSet#UnionOne|
 :pattern ( (|MultiSet#UnionOne| arg0@@51 arg1@@55))
)))
...
(assert  (and (forall ((arg0@@53 Real) (arg1@@56 T@U) ) (! (= (type (ConditionalFrame arg0@@53 arg1@@56)) FrameTypeType)
 :qid |funType:ConditionalFrame|
 :pattern ( (ConditionalFrame arg0@@53 arg1@@56))
...
(assert (forall ((arg0@@54 T@U) (arg1@@57 T@U) ) (! (let ((T@@20 (MapType2TypeInv0 (type arg0@@54))))
(= (type (|Set#Difference| arg0@@54 arg1@@57)) (MapType2Type T@@20 boolType)))
 :qid |funType:Set#Difference|
 :pattern ( (|Set#Difference| arg0@@54 arg1@@57))
)))
...
(assert (forall ((arg1@@58 T@U) (arg2@@18 Bool) (arg3@@7 Bool) (arg1_2@@4 T@U) (arg2_2@@0 Bool) (arg3_2 Bool) ) (!  (=> (and (and (= (type arg1@@58) (MapType2Type boolType boolType)) (= (type arg1_2@@4) (MapType2Type boolType boolType))) (= (wand_1 arg1@@58 arg2@@18 arg3@@7) (wand_1 arg1_2@@4 arg2_2@@0 arg3_2))) (and (= arg1@@58 arg1_2@@4) (and (= arg2@@18 arg2_2@@0) (= arg3@@7 arg3_2))))
 :qid |stdinbpl.610:15|
 :skolemid |123|
 :pattern ( (wand_1 arg1@@58 arg2@@18 arg3@@7) (wand_1 arg1_2@@4 arg2_2@@0 arg3_2))
)))
...
(assert (forall ((arg0@@55 T@U) (arg1@@59 T@U) ) (! (let ((T@@24 (type arg1@@59)))
(= (type (|Set#UnionOne| arg0@@55 arg1@@59)) (MapType2Type T@@24 boolType)))
 :qid |funType:Set#UnionOne|
 :pattern ( (|Set#UnionOne| arg0@@55 arg1@@59))
)))
...
(assert (forall ((arg1@@60 Real) (arg2@@19 Bool) ) (! (= (getPredWandId (wand arg1@@60 arg2@@19)) 2)
 :qid |stdinbpl.467:15|
 :skolemid |94|
 :pattern ( (wand arg1@@60 arg2@@19))
)))
...
(assert (forall ((arg1@@61 Bool) ) (! (= (getPredWandId (wand_6 arg1@@61)) 0)
 :qid |stdinbpl.424:15|
 :skolemid |87|
 :pattern ( (wand_6 arg1@@61))
)))
(assert (forall ((arg1@@62 Bool) ) (! (= (getPredWandId (wand_7 arg1@@62)) 3)
 :qid |stdinbpl.499:15|
 :skolemid |101|
 :pattern ( (wand_7 arg1@@62))
)))
(assert (forall ((arg1@@63 Bool) ) (! (= (getPredWandId (wand_4 arg1@@63)) 4)
 :qid |stdinbpl.531:15|
 :skolemid |108|
 :pattern ( (wand_4 arg1@@63))
)))
(assert (forall ((arg1@@64 Bool) ) (! (= (getPredWandId (wand_5 arg1@@64)) 5)
 :qid |stdinbpl.563:15|
 :skolemid |115|
 :pattern ( (wand_5 arg1@@64))
)))
...
(assert (forall ((arg0@@56 Real) (arg1@@65 Bool) ) (! (= (type (|wand#sm| arg0@@56 arg1@@65)) (FieldType WandType_wandType (MapType1Type RefType boolType)))
 :qid |funType:wand#sm|
 :pattern ( (|wand#sm| arg0@@56 arg1@@65))
)))
(assert (forall ((arg1@@66 Real) (arg2@@20 Bool) ) (! (= (|wand#sm| arg1@@66 arg2@@20) (WandMaskField (|wand#ft| arg1@@66 arg2@@20)))
 :qid |stdinbpl.463:15|
 :skolemid |93|
 :pattern ( (WandMaskField (|wand#ft| arg1@@66 arg2@@20)))
)))
...
(assert (forall ((arg0@@57 Bool) ) (! (= (type (|wand_6#sm| arg0@@57)) (FieldType WandType_wand_6Type (MapType1Type RefType boolType)))
 :qid |funType:wand_6#sm|
 :pattern ( (|wand_6#sm| arg0@@57))
)))
(assert (forall ((arg1@@67 Bool) ) (! (= (|wand_6#sm| arg1@@67) (WandMaskField (|wand_6#ft| arg1@@67)))
 :qid |stdinbpl.420:15|
 :skolemid |86|
 :pattern ( (WandMaskField (|wand_6#ft| arg1@@67)))
)))
(assert (forall ((arg0@@58 Bool) ) (! (= (type (|wand_7#sm| arg0@@58)) (FieldType WandType_wand_7Type (MapType1Type RefType boolType)))
 :qid |funType:wand_7#sm|
 :pattern ( (|wand_7#sm| arg0@@58))
)))
(assert (forall ((arg1@@68 Bool) ) (! (= (|wand_7#sm| arg1@@68) (WandMaskField (|wand_7#ft| arg1@@68)))
 :qid |stdinbpl.495:15|
 :skolemid |100|
 :pattern ( (WandMaskField (|wand_7#ft| arg1@@68)))
)))
(assert (forall ((arg0@@59 Bool) ) (! (= (type (|wand_4#sm| arg0@@59)) (FieldType WandType_wand_4Type (MapType1Type RefType boolType)))
 :qid |funType:wand_4#sm|
 :pattern ( (|wand_4#sm| arg0@@59))
)))
(assert (forall ((arg1@@69 Bool) ) (! (= (|wand_4#sm| arg1@@69) (WandMaskField (|wand_4#ft| arg1@@69)))
 :qid |stdinbpl.527:15|
 :skolemid |107|
 :pattern ( (WandMaskField (|wand_4#ft| arg1@@69)))
)))
(assert (forall ((arg0@@60 Bool) ) (! (= (type (|wand_5#sm| arg0@@60)) (FieldType WandType_wand_5Type (MapType1Type RefType boolType)))
 :qid |funType:wand_5#sm|
 :pattern ( (|wand_5#sm| arg0@@60))
)))
(assert (forall ((arg1@@70 Bool) ) (! (= (|wand_5#sm| arg1@@70) (WandMaskField (|wand_5#ft| arg1@@70)))
 :qid |stdinbpl.559:15|
 :skolemid |114|
 :pattern ( (WandMaskField (|wand_5#ft| arg1@@70)))
)))
(assert (= (type |wand_2#sm|) (FieldType WandType_wand_2Type (MapType1Type RefType boolType))))
(assert (= |wand_2#sm| (WandMaskField |wand_2#ft|)))
(assert (= (type |wand_3#sm|) (FieldType WandType_wand_3Type (MapType1Type RefType boolType))))
(assert (= |wand_3#sm| (WandMaskField |wand_3#ft|)))
...
(declare-fun b_12_1@0 () Bool)
(declare-fun b_12_1 () Bool)
(declare-fun Used_8Heap@0 () T@U)
(assert  (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type WandDefLHSHeap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type Ops_9Heap@0) (MapType0Type RefType))) (= (type Used_9Heap@0) (MapType0Type RefType))) (= (type Used_8Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test5)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((anon29_Then_correct true))
(let ((anon34_Else_correct true))
(let ((anon34_Then_correct true))
(let ((anon31_Else_correct  (=> (forall ((x_5_1 Int) (y_5 Int) ) (!  (=> (f2 y_5 x_5_1) (forall ((z_5 Int) ) (! (f3 x_5_1 y_5 z_5)
 :qid |stdinbpl.1430:46|
 :skolemid |158|
 :pattern ( (f3 x_5_1 y_5 z_5))
)))
 :qid |stdinbpl.1428:24|
 :skolemid |159|
 :pattern ( (f2 y_5 x_5_1))
)) (=> (and (state WandDefLHSHeap@0 ZeroMask) (state WandDefLHSHeap@0 ZeroMask)) (and (=> (= (ControlFlow 0 9) 7) anon34_Then_correct) (=> (= (ControlFlow 0 9) 8) anon34_Else_correct))))))
(let ((anon33_Then_correct true))
(let ((anon17_correct true))
(let ((anon32_Then_correct  (=> (f2 y_4 x_5) (and (=> (= (ControlFlow 0 6) 5) anon33_Then_correct) (=> (= (ControlFlow 0 6) 3) anon17_correct)))))
(let ((anon32_Else_correct  (=> (and (not (f2 y_4 x_5)) (= (ControlFlow 0 4) 3)) anon17_correct)))
(let ((anon30_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null wand_3))))))
(let ((anon12_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (=> (and (and b_13@5 b_13@5) b_14@0) (forall ((q_3 Int) ) (! (f1 q_3)
 :qid |stdinbpl.1398:42|
 :skolemid |157|
 :pattern ( (f1 q_3))
)))) (=> (=> (and (and b_13@5 b_13@5) b_14@0) (forall ((q_3@@0 Int) ) (! (f1 q_3@@0)
 :qid |stdinbpl.1398:42|
 :skolemid |157|
 :pattern ( (f1 q_3@@0))
))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null wand_2 (real_2_U (+ (U_2_real (MapType1Select ZeroMask null wand_2)) FullPerm)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (and (and (=> (= (ControlFlow 0 10) 2) anon30_Else_correct) (=> (= (ControlFlow 0 10) 9) anon31_Else_correct)) (=> (= (ControlFlow 0 10) 6) anon32_Then_correct)) (=> (= (ControlFlow 0 10) 4) anon32_Else_correct)))))))
(let ((anon28_Then_correct  (=> b_13@5 (and (=> (= (ControlFlow 0 15) 14) anon29_Then_correct) (=> (= (ControlFlow 0 15) 10) anon12_correct)))))
(let ((anon28_Else_correct  (=> (and (not b_13@5) (= (ControlFlow 0 13) 10)) anon12_correct)))
(let ((anon27_Then_correct  (=> (and (and b_13@5 b_13@5) b_14@0) (and (=> (= (ControlFlow 0 16) 15) anon28_Then_correct) (=> (= (ControlFlow 0 16) 13) anon28_Else_correct)))))
(let ((anon27_Else_correct  (=> (and (not (and (and b_13@5 b_13@5) b_14@0)) (= (ControlFlow 0 12) 10)) anon12_correct)))
(let ((anon8_correct  (=> (= b_13@4  (and b_13@3 (state Ops_9Heap@0 ZeroMask))) (=> (and (= b_13@5  (and b_13@4 (state Ops_9Heap@0 ZeroMask))) (= b_14@0  (and b_14 (state Used_9Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 17) 16) anon27_Then_correct) (=> (= (ControlFlow 0 17) 12) anon27_Else_correct))))))
(let ((anon7_correct  (=> (= b_13@2  (and b_13@1 (forall ((x_3 Int) (y_3 Int) ) (!  (=> (f2 x_3 y_3) (forall ((z_3 Int) ) (! (f3 x_3 y_3 z_3)
 :qid |stdinbpl.1370:42|
 :skolemid |155|
 :pattern ( (f3 x_3 y_3 z_3))
)))
 :qid |stdinbpl.1368:31|
 :skolemid |156|
 :pattern ( (f2 x_3 y_3))
)))) (=> (and (= b_13@3 b_13@2) (= (ControlFlow 0 19) 17)) anon8_correct))))
(let ((anon6_correct  (=> (and (= b_13@1 false) (= (ControlFlow 0 22) 19)) anon7_correct)))
(let ((anon25_Else_correct  (=> (and (not (f2 x_4 y_2)) (= (ControlFlow 0 24) 22)) anon6_correct)))
(let ((anon25_Then_correct  (=> (and (f2 x_4 y_2) (= (ControlFlow 0 23) 22)) anon6_correct)))
(let ((anon24_Else_correct  (=> (and (= b_13@1 b_13@0) (= (ControlFlow 0 21) 19)) anon7_correct)))
(let ((anon23_Then_correct  (=> b_13@0 (and (and (=> (= (ControlFlow 0 25) 21) anon24_Else_correct) (=> (= (ControlFlow 0 25) 23) anon25_Then_correct)) (=> (= (ControlFlow 0 25) 24) anon25_Else_correct)))))
(let ((anon23_Else_correct  (=> (not b_13@0) (=> (and (= b_13@1 b_13@0) (= (ControlFlow 0 20) 19)) anon7_correct))))
(let ((anon22_Then_correct  (=> b_13@0 (and (=> (= (ControlFlow 0 26) 25) anon23_Then_correct) (=> (= (ControlFlow 0 26) 20) anon23_Else_correct)))))
(let ((anon22_Else_correct  (=> (not b_13@0) (=> (and (= b_13@3 b_13@0) (= (ControlFlow 0 18) 17)) anon8_correct))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= b_13@0  (and b_13 (state Ops_9Heap@0 ZeroMask))) (= b_12_1@0  (and b_12_1 (state Used_8Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 27) 26) anon22_Then_correct) (=> (= (ControlFlow 0 27) 18) anon22_Else_correct))))))
