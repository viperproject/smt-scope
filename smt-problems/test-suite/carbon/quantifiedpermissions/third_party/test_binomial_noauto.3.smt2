...
(declare-fun |demo__bin#trigger| (T@U Int Int) Bool)
(declare-fun N@@3 () Int)
(declare-fun k@@3 () Int)
...
(let ((anon0_correct  (=> (and (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove 0)) (and (>= N@@3 0) (state Heap@@13 ZeroMask))) (and (and (<= 0 k@@3) (state Heap@@13 ZeroMask)) (and (<= k@@3 N@@3) (state Heap@@13 ZeroMask)))) (and (=> (= (ControlFlow 0 14) 10) anon9_Then_correct) (=> (= (ControlFlow 0 14) 13) anon9_Else_correct)))))
