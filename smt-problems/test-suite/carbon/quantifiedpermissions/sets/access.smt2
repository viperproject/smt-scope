...
(= (type (MapType0Store arg0@@18 arg1@@6 arg2)) (MapType0Type aVar0 aVar1@@0))))
 ...
 :weight 0
)))) (= (Ctor RefType) 9)) (= (type g) (FieldType NormalFieldType (MapType0Type RefType boolType)))))
...
(assert (forall ((arg0@@35 T@U) (arg1@@17 T@U) ) (! (let ((T@@4 (MapType0TypeInv0 (type arg0@@35))))
(= (type (|Set#Union| arg0@@35 arg1@@17)) (MapType0Type T@@4 boolType)))
...
(assert (forall ((arg0@@36 T@U) (arg1@@18 T@U) ) (! (let ((T@@6 (MapType0TypeInv0 (type arg0@@36))))
(= (type (|Set#Intersection| arg0@@36 arg1@@18)) (MapType0Type T@@6 boolType)))
...
(= (type (|Set#Singleton| arg0@@37)) (MapType0Type T@@9 boolType)))
...
(assert (forall ((arg0@@41 T@U) (arg1@@21 T@U) ) (! (let ((T@@20 (MapType0TypeInv0 (type arg0@@41))))
(= (type (|Set#Difference| arg0@@41 arg1@@21)) (MapType0Type T@@20 boolType)))
...
(= (type (|Set#UnionOne| arg0@@42 arg1@@22)) (MapType0Type T@@24 boolType)))
...
(assert (forall ((o@@8 T@U) (f T@U) (Heap@@7 T@U) ) (!  (=> (and (and (and (= (type o@@8) RefType) (= (type f) (FieldType NormalFieldType RefType))) (= (type Heap@@7) (MapType1Type RefType))) (U_2_bool (MapType1Select Heap@@7 o@@8 $allocated))) (U_2_bool (MapType1Select Heap@@7 (MapType1Select Heap@@7 o@@8 f) $allocated)))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (MapType1Select Heap@@7 o@@8 f))
)))
...
(let ((A@@9 (FieldTypeInv0 (type f_3))))
 (=> (and (and (= (type Heap@@8) (MapType1Type RefType)) (= (type o@@11) RefType)) (= (type f_3) (FieldType A@@9 B@@8))) (succHeap Heap@@8 (MapType1Store Heap@@8 o@@11 f_3 v)))))
 :qid |stdinbpl.78:22|
 :skolemid |9|
 :pattern ( (MapType1Store Heap@@8 o@@11 f_3 v))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (= (type Mask@0) (MapType2Type RefType realType)) (= (type this) RefType)) (= (type Mask@1) (MapType2Type RefType realType))) (= (type ExhaleHeap@0) (MapType1Type RefType))) (= (type QPMask@1) (MapType2Type RefType realType))) (= (type QPMask@0) (MapType2Type RefType realType))) (= (type Heap@@9) (MapType1Type RefType))) (= (type b_2) RefType)) (= (type y_2) RefType)) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv2 arg0@@43)) RefType)
...
(let ((anon13_Else_correct  (=> (and (not (U_2_bool (MapType0Select (MapType1Select Heap@@9 this g) y_2))) (= (ControlFlow 0 19) 16)) anon5_correct)))
(let ((anon13_Then_correct  (=> (U_2_bool (MapType0Select (MapType1Select Heap@@9 this g) y_2)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm QPMask@0 y_2 f_7)) (=> (HasDirectPerm QPMask@0 y_2 f_7) (=> (= (ControlFlow 0 17) 16) anon5_correct))))))
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (HasDirectPerm QPMask@0 this g)) (=> (HasDirectPerm QPMask@0 this g) (and (=> (= (ControlFlow 0 20) 17) anon13_Then_correct) (=> (= (ControlFlow 0 20) 19) anon13_Else_correct))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (U_2_bool (MapType0Select (MapType1Select ExhaleHeap@0 this g) z_1))) (U_2_bool (MapType0Select (MapType1Select ExhaleHeap@0 this g) z_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1))))
 :qid |stdinbpl.656:17|
 :skolemid |96|
 :pattern ( (neverTriggered3 z_1) (neverTriggered3 z_1_1))
))) (=> (forall ((z_1@@0 T@U) (z_1_1@@0 T@U) ) (!  (=> (and (= (type z_1@@0) RefType) (= (type z_1_1@@0) RefType)) (=> (and (and (and (and (not (= z_1@@0 z_1_1@@0)) (U_2_bool (MapType0Select (MapType1Select ExhaleHeap@0 this g) z_1@@0))) (U_2_bool (MapType0Select (MapType1Select ExhaleHeap@0 this g) z_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1@@0 z_1_1@@0))))
 :qid |stdinbpl.656:17|
 :skolemid |96|
 :pattern ( (neverTriggered3 z_1@@0) (neverTriggered3 z_1_1@@0))
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((z_1@@1 T@U) ) (!  (=> (and (= (type z_1@@1) RefType) (U_2_bool (MapType0Select (MapType1Select ExhaleHeap@0 this g) z_1@@1))) (>= (U_2_real (MapType2Select Mask@1 z_1@@1 f_7)) FullPerm))
 :qid |stdinbpl.663:17|
 :skolemid |97|
 :pattern ( (MapType1Select ExhaleHeap@0 z_1@@1 f_7))
 :pattern ( (MapType2Select QPMask@1 z_1@@1 f_7))
 :pattern ( (MapType0Select (MapType1Select ExhaleHeap@0 this g) z_1@@1))
)))))))
(let ((anon15_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (HasDirectPerm Mask@1 this g))))
(let ((anon8_correct  (=> (= Mask@1 (MapType2Store QPMask@0 this g (real_2_U (- (U_2_real (MapType2Select QPMask@0 this g)) FullPerm)))) (=> (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (HasDirectPerm Mask@1 b_2 f_7)) (=> (HasDirectPerm Mask@1 b_2 f_7) (and (=> (= (ControlFlow 0 8) (- 0 9)) (>= (U_2_int (MapType1Select ExhaleHeap@0 b_2 f_7)) 0)) (=> (>= (U_2_int (MapType1Select ExhaleHeap@0 b_2 f_7)) 0) (=> (state ExhaleHeap@0 Mask@1) (and (=> (= (ControlFlow 0 8) 4) anon15_Then_correct) (=> (= (ControlFlow 0 8) 6) anon15_Else_correct)))))))))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 8)) anon8_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType2Select QPMask@0 this g)))) (=> (<= FullPerm (U_2_real (MapType2Select QPMask@0 this g))) (=> (= (ControlFlow 0 11) 8) anon8_correct))))))
(let ((anon12_Else_correct  (=> (and (forall ((y_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@@9 this g) y_1))) (>= (U_2_int (MapType1Select Heap@@9 y_1 f_7)) 0))
 :qid |stdinbpl.593:20|
 :skolemid |95|
 :pattern ( (MapType0Select (MapType1Select Heap@@9 this g) y_1))
)) (state Heap@@9 QPMask@0)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm QPMask@0 this g)) (=> (HasDirectPerm QPMask@0 this g) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@9 this g) b_2)) (state Heap@@9 QPMask@0)) (and (=> (= (ControlFlow 0 14) 11) anon14_Then_correct) (=> (= (ControlFlow 0 14) 13) anon14_Else_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 22) (- 0 23)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType0Select (MapType1Select Heap@@9 this g) x_1))) (U_2_bool (MapType0Select (MapType1Select Heap@@9 this g) x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.549:15|
 :skolemid |89|
 :no-pattern (type x_1)
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@@9 this g) x_1@@0))) (U_2_bool (MapType0Select (MapType1Select Heap@@9 this g) x_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.549:15|
 :skolemid |89|
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@9 this g) x_1@@1)) (< NoPerm FullPerm)) (and (qpRange2 x_1@@1) (= (invRecv2 x_1@@1) x_1@@1))))
 :qid |stdinbpl.555:22|
 :skolemid |90|
 :pattern ( (MapType1Select Heap@@9 x_1@@1 f_7))
 :pattern ( (MapType2Select QPMask@0 x_1@@1 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@@9 this g) x_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@9 this g) (invRecv2 o_3))) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.559:22|
 :skolemid |91|
 :pattern ( (invRecv2 o_3))
)) (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@@9 this g) x_1@@2))) (not (= x_1@@2 null)))
 :qid |stdinbpl.565:22|
 :skolemid |92|
 :pattern ( (MapType1Select Heap@@9 x_1@@2 f_7))
 :pattern ( (MapType2Select QPMask@0 x_1@@2 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@@9 this g) x_1@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@9 this g) (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@0) o_3@@0)) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType2Select Mask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@9 this g) (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType2Select Mask@0 o_3@@0 f_7))))))
 :qid |stdinbpl.571:22|
 :skolemid |93|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 22) 20) anon12_Then_correct) (=> (= (ControlFlow 0 22) 14) anon12_Else_correct)))))))))
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@0 this g))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType1Select Heap@@9 this $allocated)) (U_2_bool (MapType1Select Heap@@9 b_2 $allocated))) (=> (and (and (not (= this null)) (= Mask@0 (MapType2Store ZeroMask this g (real_2_U (+ (U_2_real (MapType2Select ZeroMask this g)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 24) 2) anon11_Then_correct) (=> (= (ControlFlow 0 24) 22) anon11_Else_correct)))))))
