...
(let ((anon5_correct  (=> (and (state Heap@@29 ZeroMask) (= (ControlFlow 0 3) 1)) anon6_correct)))
(let ((anon8_Else_correct  (=> (not (= (List_tag (get_List_tail l@@19)) 1)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (decreasing (get_List_tail (get_List_tail l@@19)) l@@19)) (=> (decreasing (get_List_tail (get_List_tail l@@19)) l@@19) (and (=> (= (ControlFlow 0 5) (- 0 6)) (bounded l@@19)) (=> (bounded l@@19) (=> (and (state Heap@@29 ZeroMask) (= (ControlFlow 0 5) 3)) anon5_correct))))))))
(let ((anon8_Then_correct  (=> (and (= (List_tag (get_List_tail l@@19)) 1) (= (ControlFlow 0 4) 3)) anon5_correct)))
(let ((anon7_Else_correct  (=> (not (= (List_tag l@@19) 1)) (and (=> (= (ControlFlow 0 8) 4) anon8_Then_correct) (=> (= (ControlFlow 0 8) 5) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (and (= (List_tag l@@19) 1) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (and (state Heap@@29 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 9) 2) anon7_Then_correct) (=> (= (ControlFlow 0 9) 8) anon7_Else_correct)))))
