...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@6) (MapType0Type RefType)) (= (type freshObj@0) RefType)) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@7) (MapType0Type RefType))) (= (type Heap@8) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@5) (MapType1Type RefType realType))) (forall ((arg0@@28 T@U) (arg1@@10 T@U) ) (! (= (type (CombineFrames arg0@@28 arg1@@10)) FrameTypeType)
...
))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@19) (MapType0Type RefType))) (= (type this@@14) RefType)) (= (type x@@8) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon12_correct true))
(let ((anon18_Else_correct  (=> (= (MapType0Select Heap@6 freshObj@0 next) null) (=> (and (= Heap@8 Heap@6) (= (ControlFlow 0 3) 1)) anon12_correct))))
(let ((anon18_Then_correct  (=> (not (= (MapType0Select Heap@6 freshObj@0 next) null)) (=> (and (and (forall ((o_5 T@U) (f_9 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_9))))
(let ((A@@12 (FieldTypeInv0 (type f_9))))
 (=> (and (and (= (type o_5) RefType) (= (type f_9) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@6 null (|valid#sm| freshObj@0)) o_5 f_9)) (U_2_bool (MapType1Select (MapType0Select Heap@6 null (|valid#sm| (MapType0Select Heap@6 freshObj@0 next))) o_5 f_9)))) (U_2_bool (MapType1Select newPMask@0 o_5 f_9)))))
 :qid |stdinbpl.667:29|
 :skolemid |39|
 :pattern ( (MapType1Select newPMask@0 o_5 f_9))
)) (= Heap@7 (MapType0Store Heap@6 null (|valid#sm| freshObj@0) newPMask@0))) (and (= Heap@8 Heap@7) (= (ControlFlow 0 2) 1))) anon12_correct))))
(let ((anon10_correct  (=> (and (= Heap@5 (MapType0Store Heap@4 null (|valid#sm| freshObj@0) (MapType1Store (MapType0Select Heap@4 null (|valid#sm| freshObj@0)) freshObj@0 value (bool_2_U true)))) (= Heap@6 (MapType0Store Heap@5 null (|valid#sm| freshObj@0) (MapType1Store (MapType0Select Heap@5 null (|valid#sm| freshObj@0)) freshObj@0 next (bool_2_U true))))) (and (=> (= (ControlFlow 0 4) 2) anon18_Then_correct) (=> (= (ControlFlow 0 4) 3) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (HasDirectPerm Mask@6 null (valid freshObj@0)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 6) 4)) anon10_correct))))
(let ((anon17_Then_correct  (=> (not (HasDirectPerm Mask@6 null (valid freshObj@0))) (=> (and (and (= Heap@2 (MapType0Store Heap@1 null (|valid#sm| freshObj@0) ZeroPMask)) (= Heap@3 (MapType0Store Heap@2 null (valid freshObj@0) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 5) 4))) anon10_correct))))
(let ((anon8_correct  (=> (= Mask@6 (MapType1Store Mask@5 null (valid freshObj@0) (real_2_U (+ (U_2_real (MapType1Select Mask@5 null (valid freshObj@0))) FullPerm)))) (=> (and (and (state Heap@1 Mask@6) (state Heap@1 Mask@6)) (and (|valid#trigger| Heap@1 (valid freshObj@0)) (= (MapType0Select Heap@1 null (valid freshObj@0)) (CombineFrames (FrameFragment (MapType0Select Heap@1 freshObj@0 value)) (CombineFrames (FrameFragment (MapType0Select Heap@1 freshObj@0 next)) (FrameFragment (ite (not (= (MapType0Select Heap@1 freshObj@0 next) null)) (MapType0Select Heap@1 null (valid (MapType0Select Heap@1 freshObj@0 next))) EmptyFrame))))))) (and (=> (= (ControlFlow 0 7) 5) anon17_Then_correct) (=> (= (ControlFlow 0 7) 6) anon17_Else_correct))))))
(let ((anon7_correct  (=> (and (and (= Mask@4 (MapType1Store Mask@3 null (valid (MapType0Select Heap@1 freshObj@0 next)) (real_2_U (- (U_2_real (MapType1Select Mask@3 null (valid (MapType0Select Heap@1 freshObj@0 next)))) FullPerm)))) (InsidePredicate (valid freshObj@0) (MapType0Select Heap@1 null (valid freshObj@0)) (valid (MapType0Select Heap@1 freshObj@0 next)) (MapType0Select Heap@1 null (valid (MapType0Select Heap@1 freshObj@0 next))))) (and (= Mask@5 Mask@4) (= (ControlFlow 0 9) 7))) anon8_correct)))
(let ((anon16_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon7_correct)))
(let ((anon16_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@3 null (valid (MapType0Select Heap@1 freshObj@0 next)))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 null (valid (MapType0Select Heap@1 freshObj@0 next))))) (=> (= (ControlFlow 0 10) 9) anon7_correct))))))
(let ((anon15_Then_correct  (=> (not (= (MapType0Select Heap@1 freshObj@0 next) null)) (and (=> (= (ControlFlow 0 13) 10) anon16_Then_correct) (=> (= (ControlFlow 0 13) 12) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (= (MapType0Select Heap@1 freshObj@0 next) null) (=> (and (= Mask@5 Mask@3) (= (ControlFlow 0 8) 7)) anon8_correct))))
(let ((anon4_correct  (=> (= Mask@3 (MapType1Store Mask@2 freshObj@0 next (real_2_U (- (U_2_real (MapType1Select Mask@2 freshObj@0 next)) FullPerm)))) (and (=> (= (ControlFlow 0 14) 13) anon15_Then_correct) (=> (= (ControlFlow 0 14) 8) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 17) 14)) anon4_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 next)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 next))) (=> (= (ControlFlow 0 15) 14) anon4_correct))))))
(let ((anon2_correct  (=> (= Mask@2 (MapType1Store Mask@1 freshObj@0 value (real_2_U (- (U_2_real (MapType1Select Mask@1 freshObj@0 value)) FullPerm)))) (and (=> (= (ControlFlow 0 18) 15) anon14_Then_correct) (=> (= (ControlFlow 0 18) 17) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 21) 18)) anon2_correct)))
(let ((anon13_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (<= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 value)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 value))) (=> (= (ControlFlow 0 19) 18) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@19 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@19 this@@14 $allocated)) (U_2_bool (MapType0Select Heap@@19 x@@8 $allocated))) (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@19 freshObj@0 $allocated))))) (and (and (= Heap@0 (MapType0Store Heap@@19 freshObj@0 $allocated (bool_2_U true))) (= Mask@0 (MapType1Store ZeroMask freshObj@0 value (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 value)) FullPerm))))) (and (= Mask@1 (MapType1Store Mask@0 freshObj@0 next (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@0 next)) FullPerm)))) (state Heap@0 Mask@1)))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 next)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 next))) (=> (and (= Heap@1 (MapType0Store Heap@0 freshObj@0 next freshObj@0)) (state Heap@1 Mask@1)) (and (=> (= (ControlFlow 0 22) 19) anon13_Then_correct) (=> (= (ControlFlow 0 22) 21) anon13_Else_correct)))))))))
