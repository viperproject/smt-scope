...
(declare-fun ref2Bool (T@U) Bool)
(declare-fun bool2Ref (Bool) T@U)
(declare-fun ZeroPMask () T@U)
(declare-fun ref2Int (T@U) Int)
(declare-fun int2Ref (Int) T@U)
...
(assert (forall ((arg0@@26 Bool) ) (! (= (type (bool2Ref arg0@@26)) RefType)
 :qid |funType:bool2Ref|
 :pattern ( (bool2Ref arg0@@26))
)))
(assert (forall ((x@@8 Bool) ) (! (= (ref2Bool (bool2Ref x@@8)) x@@8)
 :qid |stdinbpl.227:15|
 :skolemid |23|
 :pattern ( (ref2Bool (bool2Ref x@@8)))
)))
...
(assert (forall ((arg0@@27 Int) ) (! (= (type (int2Ref arg0@@27)) RefType)
 :qid |funType:int2Ref|
 :pattern ( (int2Ref arg0@@27))
)))
(assert (forall ((x@@9 Int) ) (! (= (ref2Int (int2Ref x@@9)) x@@9)
 :qid |stdinbpl.221:15|
 :skolemid |22|
 :pattern ( (ref2Int (int2Ref x@@9)))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
...
(set-info :boogie-vc-id Simple_test2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 3) (- 0 2))) (= x@@10 (* x@@10 x@@10)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 this $allocated))) (and (< NoPerm rd) (state Heap@@9 ZeroMask))) (and (and (not (= this null)) (state Heap@@9 ZeroMask)) (and (> x@@10 0) (state Heap@@9 ZeroMask)))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
