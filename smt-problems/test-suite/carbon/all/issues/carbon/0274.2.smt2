...
(assert  (and (and (and (and (and (and (and (and (= (type nn_2) RefType) (= (type UnfoldingMask@0) (MapType2Type RefType realType))) (= (type UnfoldingMask@1) (MapType2Type RefType realType))) (= (type Heap@@10) (MapType1Type RefType))) (= (type UnfoldingMask@2) (MapType2Type RefType realType))) (= (type Heap@0) (MapType1Type RefType))) (= (type Heap@1) (MapType1Type RefType))) (forall ((arg0@@45 T@U) (arg1@@23 T@U) ) (! (= (type (CombineFrames arg0@@45 arg1@@23)) FrameTypeType)
...
(let ((anon4_correct  (=> (and (= UnfoldingMask@0 (MapType2Store ZeroMask null (access_fields nn_2) (real_2_U (- (U_2_real (MapType2Select ZeroMask null (access_fields nn_2))) FullPerm)))) (= perm@0 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= nn_2 null))) (=> (and (= UnfoldingMask@1 (MapType2Store UnfoldingMask@0 nn_2 neighbour (real_2_U (+ (U_2_real (MapType2Select UnfoldingMask@0 nn_2 neighbour)) perm@0)))) (state Heap@@10 UnfoldingMask@1)) (=> (and (and (and (not (= nn_2 null)) (= UnfoldingMask@2 (MapType2Store UnfoldingMask@1 nn_2 visited (real_2_U (+ (U_2_real (MapType2Select UnfoldingMask@1 nn_2 visited)) FullPerm))))) (and (state Heap@@10 UnfoldingMask@2) (state Heap@@10 UnfoldingMask@2))) (and (and (= Heap@0 (MapType1Store Heap@@10 null (|access_fields#sm| nn_2) (MapType2Store (MapType1Select Heap@@10 null (|access_fields#sm| nn_2)) nn_2 neighbour (bool_2_U true)))) (= Heap@1 (MapType1Store Heap@0 null (|access_fields#sm| nn_2) (MapType2Store (MapType1Select Heap@0 null (|access_fields#sm| nn_2)) nn_2 visited (bool_2_U true))))) (and (state Heap@1 ZeroMask) (= (ControlFlow 0 4) 2)))) anon5_correct))))))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 4)) anon4_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType2Select ZeroMask null (access_fields nn_2))))) (=> (<= FullPerm (U_2_real (MapType2Select ZeroMask null (access_fields nn_2)))) (=> (= (ControlFlow 0 6) 4) anon4_correct))))))
(let ((anon8_Then_correct  (=> (not (= nn_2 null)) (=> (and (|access_fields#trigger| Heap@@10 (access_fields nn_2)) (= (MapType1Select Heap@@10 null (access_fields nn_2)) (CombineFrames (FrameFragment (MapType1Select Heap@@10 nn_2 neighbour)) (FrameFragment (MapType1Select Heap@@10 nn_2 visited))))) (and (=> (= (ControlFlow 0 9) 6) anon9_Then_correct) (=> (= (ControlFlow 0 9) 8) anon9_Else_correct))))))
(let ((anon8_Else_correct  (=> (and (= nn_2 null) (= (ControlFlow 0 3) 2)) anon5_correct)))
(let ((anon7_Else_correct true))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (and (and (=> (= (ControlFlow 0 10) 1) anon7_Else_correct) (=> (= (ControlFlow 0 10) 9) anon8_Then_correct)) (=> (= (ControlFlow 0 10) 3) anon8_Else_correct)))))
