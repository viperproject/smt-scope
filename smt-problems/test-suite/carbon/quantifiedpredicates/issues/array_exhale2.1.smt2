...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (> i_1 0) (< i_1 n))) (and (> i_1_1 0) (< i_1_1 n))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_3@@8 a_3@@8)) (not (= (+ i_1 1) (+ i_1_1 1)))))
 :qid |stdinbpl.754:17|
 :skolemid |68|
...
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (and (> i_1@@1 0) (< i_1@@1 n)) (< NoPerm FullPerm)) (and (= (invRecv7 a_3@@8 (+ i_1@@1 1)) i_1@@1) (qpRange7 a_3@@8 (+ i_1@@1 1))))
 :qid |stdinbpl.760:22|
 :skolemid |69|
)) (=> (and (forall ((a_1_1 T@U) (i_2_1 Int) ) (!  (=> (= (type a_1_1) IArrayDomainTypeType) (=> (and (and (and (> (invRecv7 a_1_1 i_2_1) 0) (< (invRecv7 a_1_1 i_2_1) n)) (< NoPerm FullPerm)) (qpRange7 a_1_1 i_2_1)) (and (= a_3@@8 a_1_1) (= (+ (invRecv7 a_1_1 i_2_1) 1) i_2_1))))
 :qid |stdinbpl.764:22|
 :skolemid |70|
 :pattern ( (invRecv7 a_1_1 i_2_1))
)) (forall ((a_1_1@@0 T@U) (i_2_1@@0 Int) ) (!  (=> (= (type a_1_1@@0) IArrayDomainTypeType) (=> (and (and (and (> (invRecv7 a_1_1@@0 i_2_1@@0) 0) (< (invRecv7 a_1_1@@0 i_2_1@@0) n)) (< NoPerm FullPerm)) (qpRange7 a_1_1@@0 i_2_1@@0)) (and (=> (< NoPerm FullPerm) (and (= a_3@@8 a_1_1@@0) (= (+ (invRecv7 a_1_1@@0 i_2_1@@0) 1) i_2_1@@0))) (= (U_2_real (MapType1Select QPMask@0 null (p_1 a_1_1@@0 i_2_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (p_1 a_1_1@@0 i_2_1@@0))) FullPerm)))))
 :qid |stdinbpl.770:22|
 :skolemid |71|
...
)) (forall ((a_1_1@@1 T@U) (i_2_1@@1 Int) ) (!  (=> (and (= (type a_1_1@@1) IArrayDomainTypeType) (not (and (and (and (> (invRecv7 a_1_1@@1 i_2_1@@1) 0) (< (invRecv7 a_1_1@@1 i_2_1@@1) n)) (< NoPerm FullPerm)) (qpRange7 a_1_1@@1 i_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (p_1 a_1_1@@1 i_2_1@@1))) (U_2_real (MapType1Select ZeroMask null (p_1 a_1_1@@1 i_2_1@@1)))))
 :qid |stdinbpl.780:22|
 :skolemid |73|
...
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (> n 3) (state Heap@@10 ZeroMask)) (and (=> (= (ControlFlow 0 9) 1) anon7_Then_correct) (=> (= (ControlFlow 0 9) 7) anon7_Else_correct))))))
