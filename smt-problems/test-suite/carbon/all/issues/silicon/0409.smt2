...
(assert  (and (and (and (and (and (and (and (= (type xs) (MapType2Type RefType boolType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv2 arg0@@43)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon9_Else_correct  (=> (> wildcard@1 0.0) (and (=> (= (ControlFlow 0 5) (- 0 8)) (forall ((x_5 T@U) ) (!  (=> (and (= (type x_5) RefType) (U_2_bool (MapType2Select xs x_5))) (> (U_2_real (MapType1Select QPMask@1 x_5 f_7)) NoPerm))
 :qid |stdinbpl.617:15|
 :skolemid |97|
 :no-pattern (type x_5)
...
)) (=> (forall ((x_5@@1 T@U) ) (!  (=> (and (= (type x_5@@1) RefType) (U_2_bool (MapType2Select xs x_5@@1))) (< wildcard@1 (U_2_real (MapType1Select QPMask@1 x_5@@1 f_7))))
 :qid |stdinbpl.621:20|
 :skolemid |98|
 :no-pattern (type x_5@@1)
 :no-pattern (U_2_int x_5@@1)
 :no-pattern (U_2_bool x_5@@1)
)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (forall ((x_5@@2 T@U) ) (!  (=> (= (type x_5@@2) RefType) (=> (and (U_2_bool (MapType2Select xs x_5@@2)) (dummyFunction (MapType0Select ExhaleHeap@0 x_5@@2 f_7))) (>= wildcard@1 NoPerm)))
 :qid |stdinbpl.628:17|
 :skolemid |99|
 :pattern ( (MapType0Select ExhaleHeap@0 x_5@@2 f_7))
 :pattern ( (MapType1Select QPMask@2 x_5@@2 f_7))
 :pattern ( (MapType0Select ExhaleHeap@0 x_5@@2 f_7))
))) (=> (forall ((x_5@@3 T@U) ) (!  (=> (= (type x_5@@3) RefType) (=> (and (U_2_bool (MapType2Select xs x_5@@3)) (dummyFunction (MapType0Select ExhaleHeap@0 x_5@@3 f_7))) (>= wildcard@1 NoPerm)))
 :qid |stdinbpl.628:17|
 :skolemid |99|
 :pattern ( (MapType0Select ExhaleHeap@0 x_5@@3 f_7))
 :pattern ( (MapType1Select QPMask@2 x_5@@3 f_7))
 :pattern ( (MapType0Select ExhaleHeap@0 x_5@@3 f_7))
)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((x_5@@4 T@U) (x_5_1 T@U) ) (!  (=> (and (= (type x_5@@4) RefType) (= (type x_5_1) RefType)) (=> (and (and (and (and (not (= x_5@@4 x_5_1)) (U_2_bool (MapType2Select xs x_5@@4))) (U_2_bool (MapType2Select xs x_5_1))) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= x_5@@4 x_5_1))))
 :qid |stdinbpl.635:17|
 :skolemid |100|
 :pattern ( (neverTriggered3 x_5@@4) (neverTriggered3 x_5_1))
))) (=> (forall ((x_5@@5 T@U) (x_5_1@@0 T@U) ) (!  (=> (and (= (type x_5@@5) RefType) (= (type x_5_1@@0) RefType)) (=> (and (and (and (and (not (= x_5@@5 x_5_1@@0)) (U_2_bool (MapType2Select xs x_5@@5))) (U_2_bool (MapType2Select xs x_5_1@@0))) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= x_5@@5 x_5_1@@0))))
 :qid |stdinbpl.635:17|
 :skolemid |100|
 :pattern ( (neverTriggered3 x_5@@5) (neverTriggered3 x_5_1@@0))
)) (=> (= (ControlFlow 0 5) (- 0 4)) (forall ((x_5@@6 T@U) ) (!  (=> (and (= (type x_5@@6) RefType) (U_2_bool (MapType2Select xs x_5@@6))) (> (U_2_real (MapType1Select QPMask@1 x_5@@6 f_7)) NoPerm))
 :qid |stdinbpl.642:17|
 :skolemid |101|
 :pattern ( (MapType0Select ExhaleHeap@0 x_5@@6 f_7))
 :pattern ( (MapType1Select QPMask@2 x_5@@6 f_7))
 :pattern ( (MapType0Select ExhaleHeap@0 x_5@@6 f_7))
)))))))))))))
(let ((anon9_Then_correct true))
(let ((anon8_Else_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 9) (- 0 13)) (forall ((x_3 T@U) ) (!  (=> (and (= (type x_3) RefType) (U_2_bool (MapType2Select xs x_3))) (> (U_2_real (MapType1Select QPMask@0 x_3 f_7)) NoPerm))
 :qid |stdinbpl.547:15|
 :skolemid |88|
 :no-pattern (type x_3)
 :no-pattern (U_2_int x_3)
 :no-pattern (U_2_bool x_3)
))) (=> (forall ((x_3@@0 T@U) ) (!  (=> (and (= (type x_3@@0) RefType) (U_2_bool (MapType2Select xs x_3@@0))) (> (U_2_real (MapType1Select QPMask@0 x_3@@0 f_7)) NoPerm))
 :qid |stdinbpl.547:15|
 :skolemid |88|
 :no-pattern (type x_3@@0)
 :no-pattern (U_2_int x_3@@0)
 :no-pattern (U_2_bool x_3@@0)
)) (=> (forall ((x_3@@1 T@U) ) (!  (=> (and (= (type x_3@@1) RefType) (U_2_bool (MapType2Select xs x_3@@1))) (< wildcard@0 (U_2_real (MapType1Select QPMask@0 x_3@@1 f_7))))
 :qid |stdinbpl.551:20|
 :skolemid |89|
 :no-pattern (type x_3@@1)
 :no-pattern (U_2_int x_3@@1)
 :no-pattern (U_2_bool x_3@@1)
)) (and (=> (= (ControlFlow 0 9) (- 0 12)) (forall ((x_3@@2 T@U) ) (!  (=> (= (type x_3@@2) RefType) (=> (and (U_2_bool (MapType2Select xs x_3@@2)) (dummyFunction (MapType0Select Heap@@9 x_3@@2 f_7))) (>= wildcard@0 NoPerm)))
 :qid |stdinbpl.558:17|
 :skolemid |90|
 :pattern ( (MapType0Select Heap@@9 x_3@@2 f_7))
 :pattern ( (MapType1Select QPMask@1 x_3@@2 f_7))
 :pattern ( (MapType0Select Heap@@9 x_3@@2 f_7))
))) (=> (forall ((x_3@@3 T@U) ) (!  (=> (= (type x_3@@3) RefType) (=> (and (U_2_bool (MapType2Select xs x_3@@3)) (dummyFunction (MapType0Select Heap@@9 x_3@@3 f_7))) (>= wildcard@0 NoPerm)))
 :qid |stdinbpl.558:17|
 :skolemid |90|
 :pattern ( (MapType0Select Heap@@9 x_3@@3 f_7))
 :pattern ( (MapType1Select QPMask@1 x_3@@3 f_7))
 :pattern ( (MapType0Select Heap@@9 x_3@@3 f_7))
)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (forall ((x_3@@4 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3@@4) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3@@4 x_3_1)) (U_2_bool (MapType2Select xs x_3@@4))) (U_2_bool (MapType2Select xs x_3_1))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_3@@4 x_3_1))))
 :qid |stdinbpl.565:17|
 :skolemid |91|
 :pattern ( (neverTriggered2 x_3@@4) (neverTriggered2 x_3_1))
))) (=> (forall ((x_3@@5 T@U) (x_3_1@@0 T@U) ) (!  (=> (and (= (type x_3@@5) RefType) (= (type x_3_1@@0) RefType)) (=> (and (and (and (and (not (= x_3@@5 x_3_1@@0)) (U_2_bool (MapType2Select xs x_3@@5))) (U_2_bool (MapType2Select xs x_3_1@@0))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_3@@5 x_3_1@@0))))
 :qid |stdinbpl.565:17|
 :skolemid |91|
 :pattern ( (neverTriggered2 x_3@@5) (neverTriggered2 x_3_1@@0))
)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((x_3@@6 T@U) ) (!  (=> (and (= (type x_3@@6) RefType) (U_2_bool (MapType2Select xs x_3@@6))) (> (U_2_real (MapType1Select QPMask@0 x_3@@6 f_7)) NoPerm))
 :qid |stdinbpl.572:17|
 :skolemid |92|
 :pattern ( (MapType0Select Heap@@9 x_3@@6 f_7))
 :pattern ( (MapType1Select QPMask@1 x_3@@6 f_7))
 :pattern ( (MapType0Select Heap@@9 x_3@@6 f_7))
))) (=> (forall ((x_3@@7 T@U) ) (!  (=> (and (= (type x_3@@7) RefType) (U_2_bool (MapType2Select xs x_3@@7))) (> (U_2_real (MapType1Select QPMask@0 x_3@@7 f_7)) NoPerm))
 :qid |stdinbpl.572:17|
 :skolemid |92|
 :pattern ( (MapType0Select Heap@@9 x_3@@7 f_7))
 :pattern ( (MapType1Select QPMask@1 x_3@@7 f_7))
 :pattern ( (MapType0Select Heap@@9 x_3@@7 f_7))
)) (=> (and (forall ((x_3@@8 T@U) ) (!  (=> (= (type x_3@@8) RefType) (=> (and (U_2_bool (MapType2Select xs x_3@@8)) (< NoPerm wildcard@0)) (and (qpRange2 x_3@@8) (= (invRecv2 x_3@@8) x_3@@8))))
 :qid |stdinbpl.578:22|
 :skolemid |93|
 :pattern ( (MapType0Select Heap@@9 x_3@@8 f_7))
 :pattern ( (MapType1Select QPMask@1 x_3@@8 f_7))
 :pattern ( (MapType0Select Heap@@9 x_3@@8 f_7))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType2Select xs (invRecv2 o_3))) (and (< NoPerm wildcard@0) (qpRange2 o_3))) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.582:22|
 :skolemid |94|
 :pattern ( (invRecv2 o_3))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType2Select xs (invRecv2 o_3@@0))) (and (< NoPerm wildcard@0) (qpRange2 o_3@@0))) (and (= (invRecv2 o_3@@0) o_3@@0) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (- (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) wildcard@0)))) (=> (not (and (U_2_bool (MapType2Select xs (invRecv2 o_3@@0))) (and (< NoPerm wildcard@0) (qpRange2 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7))))))
 :qid |stdinbpl.588:22|
 :skolemid |95|
...
))) (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 QPMask@1) (state ExhaleHeap@0 QPMask@1))) (and (=> (= (ControlFlow 0 9) 3) anon9_Then_correct) (=> (= (ControlFlow 0 9) 5) anon9_Else_correct))))))))))))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select xs x_1))) (U_2_bool (MapType2Select xs x_1_1))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.500:15|
 :skolemid |82|
 :no-pattern (type x_1)
...
)) (=> (and (and (and (forall ((x_1@@1 T@U) ) (!  (=> (and (= (type x_1@@1) RefType) (U_2_bool (MapType2Select xs x_1@@1))) (and (qpRange1 x_1@@1) (= (invRecv1 x_1@@1) x_1@@1)))
 :qid |stdinbpl.506:22|
 :skolemid |83|
 :pattern ( (MapType0Select Heap@@9 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
 :pattern ( (MapType0Select Heap@@9 x_1@@1 f_7))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType2Select xs (invRecv1 o_3@@2))) (qpRange1 o_3@@2)) (= (invRecv1 o_3@@2) o_3@@2)))
 :qid |stdinbpl.510:22|
 :skolemid |84|
 ...
 :pattern ( (MapType0Select Heap@@9 x_1@@2 f_7))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType2Select xs (invRecv1 o_3@@3))) (qpRange1 o_3@@3)) (and (= (invRecv1 o_3@@3) o_3@@3) (< (U_2_real (MapType1Select ZeroMask o_3@@3 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7))))) (=> (not (and (U_2_bool (MapType2Select xs (invRecv1 o_3@@3))) (qpRange1 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@3 f_7))))))
 :qid |stdinbpl.522:22|
 :skolemid |86|
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (=> (= (ControlFlow 0 14) 2) anon8_Then_correct) (=> (= (ControlFlow 0 14) 9) anon8_Else_correct)))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 16) 1) anon7_Then_correct) (=> (= (ControlFlow 0 16) 14) anon7_Else_correct)))))
