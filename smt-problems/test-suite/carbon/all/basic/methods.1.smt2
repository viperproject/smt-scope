...
(assert  (and (and (and (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type a_2) RefType)) (= (type b_2) RefType)) (= (type c) RefType)) (= (type a_2@0) RefType)) (= (type b_2@0) RefType)) (= (type freshObj@0) RefType)) (= (type Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id t4)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 a_2 $allocated))) (and (U_2_bool (MapType0Select Heap@@9 b_2 $allocated)) (U_2_bool (MapType0Select Heap@@9 c $allocated)))) (=> (and (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 a_2@0 $allocated))) (and (U_2_bool (MapType0Select Heap@@9 b_2@0 $allocated)) (state Heap@@9 ZeroMask))) (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@9 freshObj@0 $allocated)))) (and (= Heap@0 (MapType0Store Heap@@9 freshObj@0 $allocated (bool_2_U true))) (state Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (= a_2@0 freshObj@0))) (=> (not (= a_2@0 freshObj@0)) (=> (and (state Heap@0 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (not (= a_2@0 b_2@0)))))))))
