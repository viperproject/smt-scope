...
(= (type (MapType0Store arg0@@18 arg1@@6 arg2)) (MapType0Type aVar0 aVar1@@0))))
 ...
 :weight 0
)))) (= (Ctor RefType) 9)) (= (type all) (FieldType NormalFieldType (MapType0Type RefType boolType)))) (= (type f_7) (FieldType NormalFieldType intType))))
...
(declare-fun y@@6 () T@U)
(assert  (and (and (and (and (and (and (and (= (type Mask@0) (MapType2Type RefType realType)) (= (type this) RefType)) (= (type Heap@@9) (MapType1Type RefType))) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv2 arg0@@43)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@43))
))) (= (type x@@19) RefType)) (= (type Heap@0) (MapType1Type RefType))) (= (type y@@6) RefType)))
(set-info :boogie-vc-id m2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 13)) (forall ((o_1_1 T@U) (o_1_2 T@U) ) (!  (=> (and (= (type o_1_1) RefType) (= (type o_1_2) RefType)) (=> (and (and (and (and (not (= o_1_1 o_1_2)) (U_2_bool (MapType0Select (MapType1Select Heap@@9 this all) o_1_1))) (U_2_bool (MapType0Select (MapType1Select Heap@@9 this all) o_1_2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= o_1_1 o_1_2))))
 :qid |stdinbpl.570:15|
 :skolemid |88|
 :no-pattern (type o_1_1)
 :no-pattern (type o_1_2)
 :no-pattern (U_2_int o_1_1)
 :no-pattern (U_2_bool o_1_1)
 :no-pattern (U_2_int o_1_2)
 :no-pattern (U_2_bool o_1_2)
))) (=> (forall ((o_1_1@@0 T@U) (o_1_2@@0 T@U) ) (!  (=> (and (= (type o_1_1@@0) RefType) (= (type o_1_2@@0) RefType)) (=> (and (and (and (and (not (= o_1_1@@0 o_1_2@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@@9 this all) o_1_1@@0))) (U_2_bool (MapType0Select (MapType1Select Heap@@9 this all) o_1_2@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= o_1_1@@0 o_1_2@@0))))
 :qid |stdinbpl.570:15|
 :skolemid |88|
 :no-pattern (type o_1_1@@0)
 :no-pattern (type o_1_2@@0)
 :no-pattern (U_2_int o_1_1@@0)
 :no-pattern (U_2_bool o_1_1@@0)
 :no-pattern (U_2_int o_1_2@@0)
 :no-pattern (U_2_bool o_1_2@@0)
)) (=> (forall ((o_1_1@@1 T@U) ) (!  (=> (= (type o_1_1@@1) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@9 this all) o_1_1@@1)) (< NoPerm FullPerm)) (and (qpRange2 o_1_1@@1) (= (invRecv2 o_1_1@@1) o_1_1@@1))))
 :qid |stdinbpl.576:22|
 :skolemid |89|
 :pattern ( (MapType1Select Heap@@9 o_1_1@@1 f_7))
 :pattern ( (MapType2Select QPMask@0 o_1_1@@1 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@@9 this all) o_1_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@9 this all) (invRecv2 o_3))) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.580:22|
 :skolemid |90|
 :pattern ( (invRecv2 o_3))
)) (forall ((o_1_1@@2 T@U) ) (!  (=> (and (= (type o_1_1@@2) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@@9 this all) o_1_1@@2))) (not (= o_1_1@@2 null)))
 :qid |stdinbpl.586:22|
 :skolemid |91|
 :pattern ( (MapType1Select Heap@@9 o_1_1@@2 f_7))
 :pattern ( (MapType2Select QPMask@0 o_1_1@@2 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@@9 this all) o_1_1@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@9 this all) (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@0) o_3@@0)) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType2Select Mask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@9 this all) (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType2Select Mask@0 o_3@@0 f_7))))))
 :qid |stdinbpl.592:22|
 :skolemid |92|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 4) (- 0 12)) (= FullPerm (U_2_real (MapType2Select QPMask@0 x@@19 f_7)))) (=> (= FullPerm (U_2_real (MapType2Select QPMask@0 x@@19 f_7))) (=> (and (= Heap@0 (MapType1Store Heap@@9 x@@19 f_7 (int_2_U 3))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 4) (- 0 11)) (HasDirectPerm QPMask@0 y@@6 f_7)) (=> (HasDirectPerm QPMask@0 y@@6 f_7) (and (=> (= (ControlFlow 0 4) (- 0 10)) (HasDirectPerm QPMask@0 y@@6 f_7)) (=> (HasDirectPerm QPMask@0 y@@6 f_7) (and (=> (= (ControlFlow 0 4) (- 0 9)) (= (U_2_int (MapType1Select Heap@0 y@@6 f_7)) (U_2_int (MapType1Select Heap@@9 y@@6 f_7)))) (=> (= (U_2_int (MapType1Select Heap@0 y@@6 f_7)) (U_2_int (MapType1Select Heap@@9 y@@6 f_7))) (=> (state Heap@0 QPMask@0) (and (=> (= (ControlFlow 0 4) (- 0 8)) (HasDirectPerm QPMask@0 x@@19 f_7)) (=> (HasDirectPerm QPMask@0 x@@19 f_7) (and (=> (= (ControlFlow 0 4) (- 0 7)) (= (U_2_int (MapType1Select Heap@0 x@@19 f_7)) 3)) (=> (= (U_2_int (MapType1Select Heap@0 x@@19 f_7)) 3) (=> (state Heap@0 QPMask@0) (and (=> (= (ControlFlow 0 4) (- 0 6)) (HasDirectPerm QPMask@0 x@@19 f_7)) (=> (HasDirectPerm QPMask@0 x@@19 f_7) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm QPMask@0 x@@19 f_7)) (=> (HasDirectPerm QPMask@0 x@@19 f_7) (=> (= (ControlFlow 0 4) (- 0 3)) (= (U_2_int (MapType1Select Heap@0 x@@19 f_7)) (U_2_int (MapType1Select Heap@@9 x@@19 f_7))))))))))))))))))))))))))))))
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@0 this all))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType1Select Heap@@9 this $allocated)) (U_2_bool (MapType1Select Heap@@9 x@@19 $allocated))) (=> (and (and (U_2_bool (MapType1Select Heap@@9 y@@6 $allocated)) (not (= this null))) (and (= Mask@0 (MapType2Store ZeroMask this all (real_2_U (+ (U_2_real (MapType2Select ZeroMask this all)) FullPerm)))) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 14) (- 0 17)) (HasDirectPerm Mask@0 this all)) (=> (HasDirectPerm Mask@0 this all) (=> (U_2_bool (MapType0Select (MapType1Select Heap@@9 this all) x@@19)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (HasDirectPerm Mask@0 this all)) (=> (HasDirectPerm Mask@0 this all) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@9 this all) y@@6)) (not (= x@@19 y@@6))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm Mask@0 this all)) (=> (HasDirectPerm Mask@0 this all) (=> (and (not (U_2_bool (MapType0Select (MapType1Select Heap@@9 this all) null))) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 14) 2) anon3_Then_correct) (=> (= (ControlFlow 0 14) 4) anon3_Else_correct))))))))))))))))
