...
(declare-fun TK (Int) T@U)
(declare-fun PredicateType_TKType () T@T)
(declare-fun |TK#trigger| (T@U T@U) Bool)
(declare-fun |TK#everUsed| (T@U) Bool)
...
(assert  (and (= (Ctor PredicateType_TKType) 13) (forall ((arg0@@30 Int) ) (! (= (type (TK arg0@@30)) (FieldType PredicateType_TKType FrameTypeType))
 :qid |funType:TK|
 :pattern ( (TK arg0@@30))
))))
(assert (forall ((n Int) ) (! (IsPredicateField (TK n))
 :qid |stdinbpl.385:15|
 :skolemid |83|
 :pattern ( (TK n))
)))
(assert (forall ((Heap@@2 T@U) (n@@0 Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (|TK#everUsed| (TK n@@0)))
 :qid |stdinbpl.404:15|
 :skolemid |87|
 :pattern ( (|TK#trigger| Heap@@2 (TK n@@0)))
)))
...
(assert (forall ((n@@1 Int) (n2 Int) ) (!  (=> (= (TK n@@1) (TK n2)) (= n@@1 n2))
 :qid |stdinbpl.395:15|
 :skolemid |85|
 :pattern ( (TK n@@1) (TK n2))
)))
(assert (forall ((arg0@@39 Int) ) (! (= (type (|TK#sm| arg0@@39)) (FieldType PredicateType_TKType (MapType1Type RefType boolType)))
 :qid |funType:TK#sm|
 :pattern ( (|TK#sm| arg0@@39))
)))
(assert (forall ((n@@2 Int) (n2@@0 Int) ) (!  (=> (= (|TK#sm| n@@2) (|TK#sm| n2@@0)) (= n@@2 n2@@0))
 :qid |stdinbpl.399:15|
 :skolemid |86|
 :pattern ( (|TK#sm| n@@2) (|TK#sm| n2@@0))
)))
...
(assert (forall ((n@@3 Int) ) (! (= (getPredWandId (TK n@@3)) 0)
 :qid |stdinbpl.389:15|
 :skolemid |84|
 :pattern ( (TK n@@3))
)))
...
(assert (forall ((n@@4 Int) ) (! (= (PredicateMaskField (TK n@@4)) (|TK#sm| n@@4))
 :qid |stdinbpl.381:15|
 :skolemid |82|
 :pattern ( (PredicateMaskField (TK n@@4)))
)))
...
(declare-fun m@@10 () Int)
(declare-fun Mask@2 () T@U)
(declare-fun Mask@1 () T@U)
(declare-fun Heap@@10 () T@U)
(declare-fun Mask@0 () T@U)
(assert  (and (and (and (and (and (and (and (= (type Mask@3) (MapType1Type RefType realType)) (= (type x@@19) RefType)) (= (type S1) (MapType2Type intType boolType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon13_correct true))
(let ((anon12_correct  (=> (and (state ExhaleHeap@0 Mask@3) (= (ControlFlow 0 12) 7)) anon13_correct)))
(let ((anon20_Else_correct  (=> (and (not (= rnd 1)) (= (ControlFlow 0 15) 12)) anon12_correct)))
(let ((anon20_Then_correct  (=> (and (and (= rnd 1) (U_2_bool (MapType2Select S1 (int_2_U n1)))) (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (= n1 n0)) (=> (= n1 n0) (=> (and (state ExhaleHeap@0 Mask@3) (= (ControlFlow 0 13) 12)) anon12_correct))))))
(let ((anon19_Else_correct  (=> (not (= rnd 0)) (and (=> (= (ControlFlow 0 16) 13) anon20_Then_correct) (=> (= (ControlFlow 0 16) 15) anon20_Else_correct)))))
(let ((anon19_Then_correct  (=> (= rnd 0) (and (=> (= (ControlFlow 0 8) (- 0 11)) (HasDirectPerm Mask@3 x@@19 f_7)) (=> (HasDirectPerm Mask@3 x@@19 f_7) (=> (U_2_bool (MapType2Select S1 (MapType0Select ExhaleHeap@0 x@@19 f_7))) (=> (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (HasDirectPerm Mask@3 x@@19 f_7)) (=> (HasDirectPerm Mask@3 x@@19 f_7) (and (=> (= (ControlFlow 0 8) (- 0 9)) (= (U_2_int (MapType0Select ExhaleHeap@0 x@@19 f_7)) n0)) (=> (= (U_2_int (MapType0Select ExhaleHeap@0 x@@19 f_7)) n0) (=> (and (state ExhaleHeap@0 Mask@3) (= (ControlFlow 0 8) 7)) anon13_correct))))))))))))
(let ((anon15_Else_correct  (=> (forall ((m_1 T@U) ) (!  (=> (= (type m_1) intType) (= (U_2_bool (MapType2Select S1 m_1))  (and (<= n0 (U_2_int m_1)) (or (= (U_2_int m_1) n0) (forall ((k_1 Int) ) (!  (=> (and (<= n0 k_1) (< k_1 (U_2_int m_1))) (= (U_2_real (MapType1Select Mask@3 null (TK k_1))) NoPerm))
 :qid |stdinbpl.504:54|
 :skolemid |88|
 :pattern ( (MapType0Select ExhaleHeap@0 null (TK k_1)))
))))))
 :qid |stdinbpl.502:20|
 :skolemid |89|
 :pattern ( (MapType2Select S1 m_1))
)) (=> (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3)) (and (=> (= (ControlFlow 0 17) 8) anon19_Then_correct) (=> (= (ControlFlow 0 17) 16) anon19_Else_correct))))))
(let ((anon18_Then_correct true))
(let ((anon7_correct true))
(let ((anon17_Then_correct  (=> (not (= m@@10 n0)) (and (=> (= (ControlFlow 0 5) 4) anon18_Then_correct) (=> (= (ControlFlow 0 5) 1) anon7_correct)))))
(let ((anon17_Else_correct  (=> (and (= m@@10 n0) (= (ControlFlow 0 3) 1)) anon7_correct)))
(let ((anon16_Then_correct  (=> (<= n0 m@@10) (and (=> (= (ControlFlow 0 6) 5) anon17_Then_correct) (=> (= (ControlFlow 0 6) 3) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (< m@@10 n0) (= (ControlFlow 0 2) 1)) anon7_correct)))
(let ((anon2_correct  (=> (and (and (and (= Mask@2 (MapType1Store Mask@1 x@@19 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 x@@19 f_7)) FullPerm)))) (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@0 Mask@2)) (and (state ExhaleHeap@0 Mask@2) (not (= x@@19 null)))) (and (and (= Mask@3 (MapType1Store Mask@2 x@@19 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@2 x@@19 f_7)) FullPerm)))) (state ExhaleHeap@0 Mask@3)) (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3)))) (and (and (=> (= (ControlFlow 0 18) 17) anon15_Else_correct) (=> (= (ControlFlow 0 18) 6) anon16_Then_correct)) (=> (= (ControlFlow 0 18) 2) anon16_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 21) 18)) anon2_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@19 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@19 f_7))) (=> (= (ControlFlow 0 19) 18) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@10 x@@19 $allocated)) (not (= x@@19 null))) (and (= Mask@0 (MapType1Store ZeroMask x@@19 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@19 f_7)) FullPerm)))) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (HasDirectPerm Mask@0 x@@19 f_7)) (=> (HasDirectPerm Mask@0 x@@19 f_7) (=> (= (U_2_int (MapType0Select Heap@@10 x@@19 f_7)) n0) (=> (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (=> (and (and (= Mask@1 (MapType1Store Mask@0 null (TK n0) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (TK n0))) FullPerm)))) (state Heap@@10 Mask@1)) (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1))) (and (=> (= (ControlFlow 0 22) 19) anon14_Then_correct) (=> (= (ControlFlow 0 22) 21) anon14_Else_correct)))))))))))
