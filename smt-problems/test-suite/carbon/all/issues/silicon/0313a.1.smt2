...
(declare-fun wand (Int Bool) T@U)
(declare-fun IsWandField (T@U) Bool)
(declare-fun WandType_wandType () T@T)
(declare-fun |wand#ft| (Int Bool) T@U)
...
(declare-fun |wand#sm| (Int Bool) T@U)
...
(assert  (and (= (Ctor WandType_wandType) 11) (forall ((arg0@@23 Int) (arg1@@9 Bool) ) (! (= (type (wand arg0@@23 arg1@@9)) (FieldType WandType_wandType intType))
 :qid |funType:wand|
 :pattern ( (wand arg0@@23 arg1@@9))
))))
(assert (forall ((arg1@@10 Int) (arg2@@3 Bool) ) (! (IsWandField (wand arg1@@10 arg2@@3))
 :qid |stdinbpl.186:15|
 :skolemid |22|
 :pattern ( (wand arg1@@10 arg2@@3))
)))
(assert  (and (= (Ctor FrameTypeType) 12) (forall ((arg0@@24 Int) (arg1@@11 Bool) ) (! (= (type (|wand#ft| arg0@@24 arg1@@11)) (FieldType WandType_wandType FrameTypeType))
 :qid |funType:wand#ft|
 :pattern ( (|wand#ft| arg0@@24 arg1@@11))
))))
(assert (forall ((arg1@@12 Int) (arg2@@4 Bool) ) (! (IsWandField (|wand#ft| arg1@@12 arg2@@4))
 :qid |stdinbpl.190:15|
 :skolemid |23|
...
(assert (forall ((arg1@@13 Int) (arg2@@5 Bool) ) (!  (not (IsPredicateField (wand arg1@@13 arg2@@5)))
 :qid |stdinbpl.194:15|
 :skolemid |24|
 :pattern ( (wand arg1@@13 arg2@@5))
)))
(assert (forall ((arg1@@14 Int) (arg2@@6 Bool) ) (!  (not (IsPredicateField (|wand#ft| arg1@@14 arg2@@6)))
 :qid |stdinbpl.198:15|
 :skolemid |25|
 :pattern ( (|wand#ft| arg1@@14 arg2@@6))
)))
(assert (forall ((Heap@@2 T@U) (count Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (int_2_U (|foo#triggerStateless| count))))
 :qid |stdinbpl.237:15|
 :skolemid |30|
 :pattern ( (|foo'| Heap@@2 count))
)))
(assert (forall ((arg1@@15 Int) (arg2@@7 Bool) (arg1_2 Int) (arg2_2 Bool) ) (!  (=> (= (wand arg1@@15 arg2@@7) (wand arg1_2 arg2_2)) (and (= arg1@@15 arg1_2) (= arg2@@7 arg2_2)))
 :qid |stdinbpl.210:15|
 :skolemid |28|
 :pattern ( (wand arg1@@15 arg2@@7) (wand arg1_2 arg2_2))
)))
...
(assert (forall ((Heap@@4 T@U) (count@@0 Int) ) (!  (=> (= (type Heap@@4) (MapType0Type RefType)) (and (= (foo Heap@@4 count@@0) (|foo'| Heap@@4 count@@0)) (dummyFunction (int_2_U (|foo#triggerStateless| count@@0)))))
 :qid |stdinbpl.233:15|
 :skolemid |29|
 :pattern ( (foo Heap@@4 count@@0))
)))
...
(assert  (and (forall ((arg0@@27 Real) (arg1@@16 T@U) ) (! (= (type (ConditionalFrame arg0@@27 arg1@@16)) FrameTypeType)
 :qid |funType:ConditionalFrame|
 :pattern ( (ConditionalFrame arg0@@27 arg1@@16))
...
(assert (forall ((arg1@@17 Int) (arg2@@8 Bool) ) (! (= (getPredWandId (wand arg1@@17 arg2@@8)) 0)
 :qid |stdinbpl.206:15|
 :skolemid |27|
...
(assert (forall ((Heap@@9 T@U) (Mask@@9 T@U) (count@@1 Int) ) (!  (=> (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (state Heap@@9 Mask@@9)) (= (|foo'| Heap@@9 count@@1) (|foo#frame| EmptyFrame count@@1)))
 :qid |stdinbpl.244:15|
 :skolemid |31|
 :pattern ( (state Heap@@9 Mask@@9) (|foo'| Heap@@9 count@@1))
)))
...
(assert (forall ((arg0@@28 Int) (arg1@@18 Bool) ) (! (= (type (|wand#sm| arg0@@28 arg1@@18)) (FieldType WandType_wandType (MapType1Type RefType boolType)))
 :qid |funType:wand#sm|
 :pattern ( (|wand#sm| arg0@@28 arg1@@18))
)))
(assert (forall ((arg1@@19 Int) (arg2@@9 Bool) ) (! (= (|wand#sm| arg1@@19 arg2@@9) (WandMaskField (|wand#ft| arg1@@19 arg2@@9)))
 :qid |stdinbpl.202:15|
 :skolemid |26|
