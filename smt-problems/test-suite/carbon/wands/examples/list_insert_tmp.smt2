...
(assert  (and (and (and (and (and (= (type Heap@@18) (MapType1Type RefType)) (= (type xs@@13) RefType)) (= (type Mask@1) (MapType0Type RefType realType))) (= (type Mask@2) (MapType0Type RefType realType))) (= (type Mask@3) (MapType0Type RefType realType))) (= (type Mask@0) (MapType0Type RefType realType))))
(set-info :boogie-vc-id |List#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (= (MapType1Select Heap@@18 xs@@13 next) null) (=> (and (= Mask@3 Mask@1) (= (ControlFlow 0 4) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (not (= (MapType1Select Heap@@18 xs@@13 next) null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 xs@@13 next)) (=> (HasDirectPerm Mask@1 xs@@13 next) (=> (and (and (= Mask@2 (MapType0Store Mask@1 null (List (MapType1Select Heap@@18 xs@@13 next)) (real_2_U (+ (U_2_real (MapType0Select Mask@1 null (List (MapType1Select Heap@@18 xs@@13 next)))) FullPerm)))) (state Heap@@18 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 2) 1))) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@18 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType1Select Heap@@18 xs@@13 $allocated))) (and (not (= xs@@13 null)) (= Mask@0 (MapType0Store ZeroMask xs@@13 val (real_2_U (+ (U_2_real (MapType0Select ZeroMask xs@@13 val)) FullPerm)))))) (and (and (state Heap@@18 Mask@0) (not (= xs@@13 null))) (and (= Mask@1 (MapType0Store Mask@0 xs@@13 next (real_2_U (+ (U_2_real (MapType0Select Mask@0 xs@@13 next)) FullPerm)))) (state Heap@@18 Mask@1)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@1 xs@@13 next)) (=> (HasDirectPerm Mask@1 xs@@13 next) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))))
