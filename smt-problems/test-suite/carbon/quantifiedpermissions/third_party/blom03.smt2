...
(declare-fun i_8 () Int)
(declare-fun j_3 () Int)
(assert  (and (and (and (and (= (type ar@@5) (SeqType RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type res) (SeqType intType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type Heap@@14) (MapType0Type RefType))))
(set-info :boogie-vc-id vals_meth)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 30) (let ((anon12_correct true))
(let ((anon25_Else_correct  (=> (and (not (and (<= 0 i_11) (< i_11 (|Seq#Length| ar@@5)))) (= (ControlFlow 0 23) 16)) anon12_correct)))
(let ((anon25_Then_correct  (=> (and (<= 0 i_11) (< i_11 (|Seq#Length| ar@@5))) (and (=> (= (ControlFlow 0 17) (- 0 22)) (>= i_11 0)) (=> (>= i_11 0) (and (=> (= (ControlFlow 0 17) (- 0 21)) (< i_11 (|Seq#Length| ar@@5))) (=> (< i_11 (|Seq#Length| ar@@5)) (and (=> (= (ControlFlow 0 17) (- 0 20)) (HasDirectPerm QPMask@0 (|Seq#Index| ar@@5 i_11) val)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| ar@@5 i_11) val) (and (=> (= (ControlFlow 0 17) (- 0 19)) (>= i_11 0)) (=> (>= i_11 0) (and (=> (= (ControlFlow 0 17) (- 0 18)) (< i_11 (|Seq#Length| res))) (=> (< i_11 (|Seq#Length| res)) (=> (= (ControlFlow 0 17) 16) anon12_correct))))))))))))))
(let ((anon24_Else_correct true))
(let ((anon23_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (= (|Seq#Length| res) (|Seq#Length| ar@@5)) (state PostHeap@0 ZeroMask)) (and (and (=> (= (ControlFlow 0 24) 15) anon24_Else_correct) (=> (= (ControlFlow 0 24) 17) anon25_Then_correct)) (=> (= (ControlFlow 0 24) 23) anon25_Else_correct))))))
(let ((anon23_Else_correct true))
(let ((anon21_Else_correct  (and (=> (= (ControlFlow 0 25) (- 0 27)) (forall ((i_3@@0 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1)) (and (<= 0 i_3@@0) (< i_3@@0 (|Seq#Length| ar@@5)))) (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length| ar@@5)))) (< NoPerm p_1@@5)) (< NoPerm p_1@@5)) (not (= (|Seq#Index| ar@@5 i_3@@0) (|Seq#Index| ar@@5 i_3_1))))
 :qid |stdinbpl.809:15|
 :skolemid |77|
))) (=> (forall ((i_3@@1 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@1 i_3_1@@0)) (and (<= 0 i_3@@1) (< i_3@@1 (|Seq#Length| ar@@5)))) (and (<= 0 i_3_1@@0) (< i_3_1@@0 (|Seq#Length| ar@@5)))) (< NoPerm p_1@@5)) (< NoPerm p_1@@5)) (not (= (|Seq#Index| ar@@5 i_3@@1) (|Seq#Index| ar@@5 i_3_1@@0))))
 :qid |stdinbpl.809:15|
 :skolemid |77|
)) (=> (and (forall ((i_3@@2 Int) ) (!  (=> (and (and (<= 0 i_3@@2) (< i_3@@2 (|Seq#Length| ar@@5))) (< NoPerm p_1@@5)) (and (qpRange2 (|Seq#Index| ar@@5 i_3@@2)) (= (invRecv2 (|Seq#Index| ar@@5 i_3@@2)) i_3@@2)))
 :qid |stdinbpl.815:22|
 :skolemid |78|
 :pattern ( (|Seq#Index| ar@@5 i_3@@2))
 :pattern ( (|Seq#Index| ar@@5 i_3@@2))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv2 o_3)) (< (invRecv2 o_3) (|Seq#Length| ar@@5))) (< NoPerm p_1@@5)) (qpRange2 o_3)) (= (|Seq#Index| ar@@5 (invRecv2 o_3)) o_3)))
 :qid |stdinbpl.819:22|
 :skolemid |79|
 :pattern ( (invRecv2 o_3))
))) (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((i_3@@3 Int) ) (!  (=> (and (<= 0 i_3@@3) (< i_3@@3 (|Seq#Length| ar@@5))) (>= p_1@@5 NoPerm))
 :qid |stdinbpl.825:15|
 :skolemid |80|
 :pattern ( (|Seq#Index| ar@@5 i_3@@3))
 :pattern ( (|Seq#Index| ar@@5 i_3@@3))
))) (=> (forall ((i_3@@4 Int) ) (!  (=> (and (<= 0 i_3@@4) (< i_3@@4 (|Seq#Length| ar@@5))) (>= p_1@@5 NoPerm))
 :qid |stdinbpl.825:15|
 :skolemid |80|
 :pattern ( (|Seq#Index| ar@@5 i_3@@4))
 :pattern ( (|Seq#Index| ar@@5 i_3@@4))
)) (=> (forall ((i_3@@5 Int) ) (!  (=> (and (and (<= 0 i_3@@5) (< i_3@@5 (|Seq#Length| ar@@5))) (> p_1@@5 NoPerm)) (not (= (|Seq#Index| ar@@5 i_3@@5) null)))
 :qid |stdinbpl.831:22|
 :skolemid |81|
 :pattern ( (|Seq#Index| ar@@5 i_3@@5))
 :pattern ( (|Seq#Index| ar@@5 i_3@@5))
)) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv2 o_3@@0)) (< (invRecv2 o_3@@0) (|Seq#Length| ar@@5))) (< NoPerm p_1@@5)) (qpRange2 o_3@@0)) (and (=> (< NoPerm p_1@@5) (= (|Seq#Index| ar@@5 (invRecv2 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) p_1@@5)))) (=> (not (and (and (and (<= 0 (invRecv2 o_3@@0)) (< (invRecv2 o_3@@0) (|Seq#Length| ar@@5))) (< NoPerm p_1@@5)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.837:22|
 :skolemid |82|
...
))) (and (state Heap@@14 QPMask@0) (state Heap@@14 QPMask@0))) (and (=> (= (ControlFlow 0 25) 24) anon23_Then_correct) (=> (= (ControlFlow 0 25) 14) anon23_Else_correct)))))))))))
(let ((anon7_correct true))
(let ((anon22_Else_correct  (=> (and (not (and (<= 0 i_10) (< i_10 (|Seq#Length| ar@@5)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon22_Then_correct  (=> (and (<= 0 i_10) (< i_10 (|Seq#Length| ar@@5))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_10 0)) (=> (>= i_10 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_10 (|Seq#Length| ar@@5))) (=> (< i_10 (|Seq#Length| ar@@5)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon19_Else_correct  (=> (and (forall ((i_1@@1 Int) (j_1_1 Int) ) (!  (=> (and (<= 0 i_1@@1) (and (< i_1@@1 (|Seq#Length| ar@@5)) (and (<= 0 j_1_1) (and (< j_1_1 (|Seq#Length| ar@@5)) (not (= i_1@@1 j_1_1)))))) (not (= (|Seq#Index| ar@@5 i_1@@1) (|Seq#Index| ar@@5 j_1_1))))
 :qid |stdinbpl.791:20|
 :skolemid |76|
 :pattern ( (|Seq#Index| ar@@5 i_1@@1) (|Seq#Index| ar@@5 j_1_1))
)) (state Heap@@14 ZeroMask)) (and (and (=> (= (ControlFlow 0 28) 25) anon21_Else_correct) (=> (= (ControlFlow 0 28) 9) anon22_Then_correct)) (=> (= (ControlFlow 0 28) 12) anon22_Else_correct)))))
(let ((anon3_correct true))
(let ((anon20_Else_correct  (=> (and (not (and (<= 0 i_8) (and (< i_8 (|Seq#Length| ar@@5)) (and (<= 0 j_3) (and (< j_3 (|Seq#Length| ar@@5)) (not (= i_8 j_3))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon20_Then_correct  (=> (and (<= 0 i_8) (and (< i_8 (|Seq#Length| ar@@5)) (and (<= 0 j_3) (and (< j_3 (|Seq#Length| ar@@5)) (not (= i_8 j_3)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_8 0)) (=> (>= i_8 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_8 (|Seq#Length| ar@@5))) (=> (< i_8 (|Seq#Length| ar@@5)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_3 0)) (=> (>= j_3 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_3 (|Seq#Length| ar@@5))) (=> (< j_3 (|Seq#Length| ar@@5)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (< NoPerm p_1@@5) (state Heap@@14 ZeroMask))) (and (and (=> (= (ControlFlow 0 29) 28) anon19_Else_correct) (=> (= (ControlFlow 0 29) 2) anon20_Then_correct)) (=> (= (ControlFlow 0 29) 7) anon20_Else_correct)))))
