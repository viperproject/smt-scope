...
(assert  (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type this) RefType)))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_Else_correct true))
(let ((anon6_Then_correct  (=> (state Heap@@9 ZeroMask) (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm Mask@0 this f_7)) (=> (HasDirectPerm Mask@0 this f_7) (=> (= (ControlFlow 0 3) (- 0 2)) (= (U_2_int (MapType0Select Heap@@9 this f_7)) 0))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 this $allocated)) (not (= this null))) (and (= Mask@0 (MapType1Store ZeroMask this f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this f_7)) FullPerm)))) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm Mask@0 this f_7)) (=> (HasDirectPerm Mask@0 this f_7) (=> (and (= (U_2_int (MapType0Select Heap@@9 this f_7)) 0) (state Heap@@9 Mask@0)) (and (and (=> (= (ControlFlow 0 8) 1) anon5_Then_correct) (=> (= (ControlFlow 0 8) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 8) 6) anon6_Else_correct)))))))))
