...
(let ((anon41_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 30) 27)) anon21_correct)))
(let ((anon41_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 28) (- 0 29)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null P)))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null P))) (=> (= (ControlFlow 0 28) 27) anon21_correct))))))
(let ((anon22_correct true))
(let ((anon39_Then_correct  (=> (trigG PostHeap@0 a_3 flag) (and (and (=> (= (ControlFlow 0 31) 25) anon22_correct) (=> (= (ControlFlow 0 31) 28) anon41_Then_correct)) (=> (= (ControlFlow 0 31) 30) anon41_Else_correct)))))
(let ((anon39_Else_correct  (=> (and (not (trigG PostHeap@0 a_3 flag)) (= (ControlFlow 0 26) 25)) anon22_correct)))
(let ((anon16_correct true))
(let ((anon38_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 24) 21)) anon16_correct)))
(let ((anon38_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null P)))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null P))) (=> (= (ControlFlow 0 22) 21) anon16_correct))))))
(let ((anon36_Else_correct true))
(let ((anon35_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (= PostMask@0 (MapType1Store ZeroMask null P (real_2_U (+ (U_2_real (MapType1Select ZeroMask null P)) FullPerm)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (and (and (and (=> (= (ControlFlow 0 32) 20) anon36_Else_correct) (=> (= (ControlFlow 0 32) 31) anon39_Then_correct)) (=> (= (ControlFlow 0 32) 26) anon39_Else_correct)) (=> (= (ControlFlow 0 32) 22) anon38_Then_correct)) (=> (= (ControlFlow 0 32) 24) anon38_Else_correct))))))
(let ((anon43_Else_correct true))
(let ((anon43_Then_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (trigG Heap@@18 a_4 flag)) (=> (trigG Heap@@18 a_4 flag) (=> (= (ControlFlow 0 13) (- 0 12)) (trigF Heap@@18 a_4 b_4))))))
(let ((anon26_correct  (=> (= Mask@1 (MapType1Store Mask@0 null P (real_2_U (- (U_2_real (MapType1Select Mask@0 null P)) FullPerm)))) (and (=> (= (ControlFlow 0 16) 13) anon43_Then_correct) (=> (= (ControlFlow 0 16) 15) anon43_Else_correct)))))
(let ((anon42_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 19) 16)) anon26_correct)))
(let ((anon42_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null P)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null P))) (=> (= (ControlFlow 0 17) 16) anon26_correct))))))
(let ((anon29_Else_correct  (=> (and (forall ((a_1_1 Int) (b_1_1 Int) ) (!  (and (trigG Heap@@18 a_1_1 flag) (trigF Heap@@18 a_1_1 b_1_1))
 :qid |stdinbpl.394:20|
 :skolemid |31|
...
)) (state Heap@@18 Mask@0)) (and (and (=> (= (ControlFlow 0 33) 32) anon35_Then_correct) (=> (= (ControlFlow 0 33) 17) anon42_Then_correct)) (=> (= (ControlFlow 0 33) 19) anon42_Else_correct)))))
(let ((anon9_correct true))
(let ((anon34_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 7)) anon9_correct)))
(let ((anon34_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null P)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null P))) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
(let ((anon10_correct true))
(let ((anon32_Then_correct  (=> (trigG Heap@@18 a_2 flag) (and (and (=> (= (ControlFlow 0 11) 5) anon10_correct) (=> (= (ControlFlow 0 11) 8) anon34_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon34_Else_correct)))))
(let ((anon32_Else_correct  (=> (and (not (trigG Heap@@18 a_2 flag)) (= (ControlFlow 0 6) 5)) anon10_correct)))
(let ((anon4_correct true))
(let ((anon31_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon4_correct)))
(let ((anon31_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null P)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null P))) (=> (= (ControlFlow 0 2) 1) anon4_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@18 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null P (real_2_U (+ (U_2_real (MapType1Select ZeroMask null P)) FullPerm)))) (state Heap@@18 Mask@0)) (and (state Heap@@18 Mask@0) (state Heap@@18 Mask@0))) (and (and (and (and (=> (= (ControlFlow 0 34) 33) anon29_Else_correct) (=> (= (ControlFlow 0 34) 11) anon32_Then_correct)) (=> (= (ControlFlow 0 34) 6) anon32_Else_correct)) (=> (= (ControlFlow 0 34) 2) anon31_Then_correct)) (=> (= (ControlFlow 0 34) 4) anon31_Else_correct))))))
