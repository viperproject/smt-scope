...
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_2))) (= (ControlFlow 0 15) 11)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_2)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< i_2 (|Seq#Length| xs))) (=> (< i_2 (|Seq#Length| xs)) (=> (= (ControlFlow 0 12) 11) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_1) (|Seq#Index| xs i_1_1))))
 :qid |stdinbpl.714:15|
 :skolemid |63|
 ...
 :qid |stdinbpl.714:15|
 :skolemid |63|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index| xs i_1@@1)) (= (invRecv1 (|Seq#Index| xs i_1@@1)) i_1@@1)))
 :qid |stdinbpl.720:22|
 :skolemid |64|
 ...
 :pattern ( (|Seq#Index| xs i_1@@1))
)) (=> (and (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (|Seq#Index| xs (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.724:22|
 :skolemid |65|
...
)))) (and (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)) (and (state Heap@@13 QPMask@0) (= (ControlFlow 0 9) (- 0 8))))) (> n@@13 0)))))))
(let ((anon9_Else_correct  (=> (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i1_1)) (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i2_1)) (not (= i1_1 i2_1)))) (not (= (|Seq#Index| xs i1_1) (|Seq#Index| xs i2_1))))
 :qid |stdinbpl.690:20|
 :skolemid |62|
...
)) (=> (and (state Heap@@13 ZeroMask) (state Heap@@13 ZeroMask)) (and (and (=> (= (ControlFlow 0 16) 9) anon11_Else_correct) (=> (= (ControlFlow 0 16) 12) anon12_Then_correct)) (=> (= (ControlFlow 0 16) 15) anon12_Else_correct))))))
...
(let ((anon10_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i1)) (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i2)) (not (= i1 i2)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1 0)) (=> (>= i1 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1 (|Seq#Length| xs))) (=> (< i1 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2 0)) (=> (>= i2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2 (|Seq#Length| xs))) (=> (< i2 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (= (|Seq#Length| xs) n@@13)) (and (state Heap@@13 ZeroMask) (state Heap@@13 ZeroMask))) (and (and (=> (= (ControlFlow 0 17) 16) anon9_Else_correct) (=> (= (ControlFlow 0 17) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 17) 7) anon10_Else_correct))))))
