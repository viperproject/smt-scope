...
(set-info :boogie-vc-id shouldTrigger)
...
(let ((anon15_Else_correct  (=> (and (not (exists ((i_1_1 Int) ) (!  (not (=> (> i_1_1 0) (otherDummy Heap@@15 i_1_1)))
 :qid |stdinbpl.352:17|
 :skolemid |29|
 :pattern ( (|otherDummy#frame| EmptyFrame i_1_1))
))) (= (ControlFlow 0 13) 11)) anon7_correct)))
(let ((anon15_Then_correct  (=> (exists ((i_1_1@@0 Int) ) (!  (not (=> (> i_1_1@@0 0) (otherDummy Heap@@15 i_1_1@@0)))
 :qid |stdinbpl.352:17|
 :skolemid |29|
 :pattern ( (|otherDummy#frame| EmptyFrame i_1_1@@0))
)) (=> (and (not b_2) (= (ControlFlow 0 12) 11)) anon7_correct))))
(let ((anon14_Then_correct true))
(let ((anon4_correct true))
(let ((anon13_Then_correct  (=> (> i_2 0) (and (=> (= (ControlFlow 0 4) 3) anon14_Then_correct) (=> (= (ControlFlow 0 4) 1) anon4_correct)))))
(let ((anon13_Else_correct  (=> (and (>= 0 i_2) (= (ControlFlow 0 2) 1)) anon4_correct)))
