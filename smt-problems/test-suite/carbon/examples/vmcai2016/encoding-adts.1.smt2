...
(declare-fun x@@8 () T@U)
(assert  (and (= (type Heap@@9) (MapType0Type RefType)) (= (type x@@8) listDomainTypeType)))
(set-info :boogie-vc-id test_types)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (is_Nil x@@8)  (not (is_Cons x@@8))))))
