...
(declare-fun list1@0 () T@U)
(declare-fun list2@0 () T@U)
(assert  (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type list1@0) (ListDomainTypeType intType))) (= (type list2@0) (ListDomainTypeType intType))))
(set-info :boogie-vc-id equality_2c)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (= list1@0 (Nil intType))) (=> (and (and (state Heap@@9 ZeroMask) (= list2@0 (Nil intType))) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (= list1@0 list2@0)))))
