...
(assert  (and (and (and (and (and (and (and (= (type UnfoldingMask@0) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type this@@11) RefType)) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Heap@@11) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (forall ((arg0@@30 T@U) ) (! (= (type (FrameFragment arg0@@30)) FrameTypeType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon2_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (V this@@11) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (V this@@11))) FullPerm)))) (not (= this@@11 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this@@11 y@@1 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this@@11 y@@1)) FullPerm)))) (state Heap@@11 UnfoldingMask@1)) (and (= (U_2_int (MapType0Select Heap@@11 this@@11 y@@1)) 1) (state Heap@@11 UnfoldingMask@1))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm UnfoldingMask@1 this@@11 y@@1)) (=> (HasDirectPerm UnfoldingMask@1 this@@11 y@@1) (=> (and (and (= Heap@0 (MapType0Store Heap@@11 null (|V#sm| this@@11) (MapType1Store (MapType0Select Heap@@11 null (|V#sm| this@@11)) this@@11 y@@1 (bool_2_U true)))) (state Heap@0 Mask@0)) (and (= Heap@1 (MapType0Store Heap@0 null (|V#sm| this@@11) (MapType1Store (MapType0Select Heap@0 null (|V#sm| this@@11)) this@@11 y@@1 (bool_2_U true)))) (state Heap@1 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (U_2_int (MapType0Select Heap@1 this@@11 y@@1)) 2)) (=> (= (U_2_int (MapType0Select Heap@1 this@@11 y@@1)) 2) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 this@@11 x@@8)) (=> (HasDirectPerm Mask@0 this@@11 x@@8) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (MapType0Select Heap@1 this@@11 x@@8)) 0)))))))))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (V this@@11))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (V this@@11)))) (=> (= (ControlFlow 0 6) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 this@@11 $allocated))) (and (= Mask@0 (MapType1Store ZeroMask null (V this@@11) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (V this@@11))) FullPerm)))) (state Heap@@11 Mask@0))) (and (and (state Heap@@11 Mask@0) (state Heap@@11 Mask@0)) (and (|V#trigger| Heap@@11 (V this@@11)) (= (MapType0Select Heap@@11 null (V this@@11)) (FrameFragment (MapType0Select Heap@@11 this@@11 y@@1)))))) (and (=> (= (ControlFlow 0 9) 6) anon3_Then_correct) (=> (= (ControlFlow 0 9) 8) anon3_Else_correct)))))
