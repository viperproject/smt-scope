...
(assert  (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type z@@6) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |Pred#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 z@@6 $allocated))) (=> (and (and (not (= z@@6 null)) (= Mask@0 (MapType1Store ZeroMask z@@6 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask z@@6 f_7)) FullPerm))))) (and (state Heap@@10 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@0 z@@6 f_7)))))
