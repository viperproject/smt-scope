...
(let ((anon18_Else_correct  (=> (and (not (and (>= k_10 0) (and (< k_10 (|Seq#Length| ar@@27)) (and (>= j_6 0) (and (< j_6 (|Seq#Length| ar@@27)) (not (= k_10 j_6))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon18_Then_correct  (=> (and (>= k_10 0) (and (< k_10 (|Seq#Length| ar@@27)) (and (>= j_6 0) (and (< j_6 (|Seq#Length| ar@@27)) (not (= k_10 j_6)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= k_10 0)) (=> (>= k_10 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< k_10 (|Seq#Length| ar@@27))) (=> (< k_10 (|Seq#Length| ar@@27)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_6 0)) (=> (>= j_6 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_6 (|Seq#Length| ar@@27))) (=> (< j_6 (|Seq#Length| ar@@27)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
