...
(assert  (and (and (and (= (type Heap@0) (MapType1Type RefType)) (= (type x_1) RefType)) (= (type Mask@0) (MapType2Type RefType realType))) (= (type Heap@@9) (MapType1Type RefType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_Else_correct  (=> (forall ((i_1 Int) ) (!  (=> (< 0 i_1) (bar i_1))
 :qid |stdinbpl.442:20|
 :skolemid |82|
 :pattern ( (foo i_1 (U_2_int (MapType1Select Heap@0 x_1 f_7))))
)) (=> (and (state Heap@0 Mask@0) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm Mask@0 x_1 f_7)) (=> (HasDirectPerm Mask@0 x_1 f_7) (=> (foo (U_2_int (MapType1Select Heap@0 x_1 f_7)) 5) (=> (and (state Heap@0 Mask@0) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm Mask@0 x_1 f_7)) (=> (HasDirectPerm Mask@0 x_1 f_7) (=> (= (ControlFlow 0 3) (- 0 2)) (bar (U_2_int (MapType1Select Heap@0 x_1 f_7))))))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType1Select Heap@@9 x_1 $allocated)) (not (= x_1 null))) (=> (and (and (= Mask@0 (MapType2Store ZeroMask x_1 f_7 (real_2_U (+ (U_2_real (MapType2Select ZeroMask x_1 f_7)) FullPerm)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (= FullPerm (U_2_real (MapType2Select Mask@0 x_1 f_7)))) (=> (= FullPerm (U_2_real (MapType2Select Mask@0 x_1 f_7))) (=> (and (= Heap@0 (MapType1Store Heap@@9 x_1 f_7 (int_2_U 5))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 6) 1) anon3_Then_correct) (=> (= (ControlFlow 0 6) 3) anon3_Else_correct))))))))))
