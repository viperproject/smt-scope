...
(declare-fun j () Int)
(declare-fun k () Int)
(assert  (and (and (and (and (and (= (type x@@14) RefType) (= (type y@@1) RefType)) (= (type Heap@@10) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type z@@0) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test03)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon3_correct true))
(let ((anon4_Else_correct  (=> (= x@@14 y@@1) (and (=> (= (ControlFlow 0 5) (- 0 7)) (<= px (/ (to_real 3) (to_real 10)))) (=> (<= px (/ (to_real 3) (to_real 10))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= py (/ (to_real 3) (to_real 10)))) (=> (<= py (/ (to_real 3) (to_real 10))) (=> (and (state Heap@@10 Mask@1) (= (ControlFlow 0 5) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (not (= x@@14 y@@1)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= px (/ (to_real 1) (to_real 5)))) (=> (<= px (/ (to_real 1) (to_real 5))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= py (/ (to_real 1) (to_real 10)))) (=> (<= py (/ (to_real 1) (to_real 10))) (=> (and (state Heap@@10 Mask@1) (= (ControlFlow 0 2) 1)) anon3_correct))))))))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x@@14 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@10 y@@1 $allocated)) (U_2_bool (MapType0Select Heap@@10 z@@0 $allocated))) (and (< NoPerm px) (state Heap@@10 ZeroMask))) (=> (and (and (and (state Heap@@10 ZeroMask) (< NoPerm py)) (and (state Heap@@10 ZeroMask) (state Heap@@10 ZeroMask))) (and (and (< NoPerm pz) (state Heap@@10 ZeroMask)) (and (state Heap@@10 ZeroMask) (= perm@0 (/ (to_real 1) (to_real 5)))))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (= Mask@0 (MapType1Store ZeroMask null (P x@@14 i@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@14 i@@5))) perm@0)))) (=> (and (state Heap@@10 Mask@0) (= perm@1 (/ (to_real 1) (to_real 10)))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (= Mask@1 (MapType1Store Mask@0 null (P y@@1 j) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (P y@@1 j))) perm@1)))) (=> (and (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1)) (and (state Heap@@10 Mask@1) (<= px (U_2_real (MapType1Select Mask@1 null (P x@@14 i@@5)))))) (=> (and (and (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1)) (and (<= (__iar__assume_helper_1  (and (= x@@14 y@@1) (= i@@5 j)) px py) (U_2_real (MapType1Select Mask@1 null (P y@@1 j)))) (state Heap@@10 Mask@1))) (and (and (state Heap@@10 Mask@1) (<= (__iar__assume_helper_2  (and (= x@@14 z@@0) (= i@@5 k))  (and (= y@@1 z@@0) (= j k)) px py pz) (U_2_real (MapType1Select Mask@1 null (P z@@0 k))))) (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1)))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (and (= z@@0 x@@14) (= k i@@5)) (and (= z@@0 y@@1) (= k j)))) (=> (or (and (= z@@0 x@@14) (= k i@@5)) (and (= z@@0 y@@1) (= k j))) (=> (state Heap@@10 Mask@1) (and (=> (= (ControlFlow 0 8) 2) anon4_Then_correct) (=> (= (ControlFlow 0 8) 5) anon4_Else_correct)))))))))))))))))))
