...
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 i_3) (< i_3 (|Seq#Length| xs@@9)))) (= (ControlFlow 0 16) 12)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (<= 0 i_3) (< i_3 (|Seq#Length| xs@@9))) (and (=> (= (ControlFlow 0 13) (- 0 15)) (>= i_3 0)) (=> (>= i_3 0) (and (=> (= (ControlFlow 0 13) (- 0 14)) (< i_3 (|Seq#Length| xs@@9))) (=> (< i_3 (|Seq#Length| xs@@9)) (=> (= (ControlFlow 0 13) 12) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (forall ((i_4 Int) (i_4_1 Int) ) (!  (=> (and (and (and (and (not (= i_4 i_4_1)) (and (<= 0 i_4) (< i_4 (|Seq#Length| xs@@9)))) (and (<= 0 i_4_1) (< i_4_1 (|Seq#Length| xs@@9)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@9 i_4) (|Seq#Index| xs@@9 i_4_1))))
 :qid |stdinbpl.893:15|
 :skolemid |85|
 ...
 :qid |stdinbpl.893:15|
 :skolemid |85|
)) (=> (forall ((i_4@@1 Int) ) (!  (=> (and (and (<= 0 i_4@@1) (< i_4@@1 (|Seq#Length| xs@@9))) (< NoPerm FullPerm)) (and (qpRange3 (|Seq#Index| xs@@9 i_4@@1)) (= (invRecv3 (|Seq#Index| xs@@9 i_4@@1)) i_4@@1)))
 :qid |stdinbpl.899:22|
 :skolemid |86|
 :pattern ( (|Seq#Index| xs@@9 i_4@@1))
 :pattern ( (|Seq#Index| xs@@9 i_4@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv3 o_3)) (< (invRecv3 o_3) (|Seq#Length| xs@@9))) (< NoPerm FullPerm)) (qpRange3 o_3)) (= (|Seq#Index| xs@@9 (invRecv3 o_3)) o_3)))
 :qid |stdinbpl.903:22|
 :skolemid |87|
 ...
 :pattern ( (|Seq#Index| xs@@9 i_4@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv3 o_3@@0)) (< (invRecv3 o_3@@0) (|Seq#Length| xs@@9))) (< NoPerm FullPerm)) (qpRange3 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| xs@@9 (invRecv3 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv3 o_3@@0)) (< (invRecv3 o_3@@0) (|Seq#Length| xs@@9))) (< NoPerm FullPerm)) (qpRange3 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.915:22|
 :skolemid |89|
...
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< 0 (|Seq#Length| xs@@9))) (=> (< 0 (|Seq#Length| xs@@9)) (=> (= (ControlFlow 0 9) (- 0 8)) (HasDirectPerm QPMask@0 (|Seq#Index| xs@@9 0) f_7)))))))))))
(let ((anon9_Else_correct  (=> (and (forall ((i1_3 Int) (i2_3 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i1_3)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i2_3)) (not (= i1_3 i2_3)))) (not (= (|Seq#Index| xs@@9 i1_3) (|Seq#Index| xs@@9 i2_3))))
 :qid |stdinbpl.875:20|
 :skolemid |84|
...
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i1_2)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i2_2)) (not (= i1_2 i2_2))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i1_2)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@9)) (int_2_U i2_2)) (not (= i1_2 i2_2)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_2 0)) (=> (>= i1_2 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_2 (|Seq#Length| xs@@9))) (=> (< i1_2 (|Seq#Length| xs@@9)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_2 0)) (=> (>= i2_2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_2 (|Seq#Length| xs@@9))) (=> (< i2_2 (|Seq#Length| xs@@9)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) (= AssumeFunctionsAbove 1)) (and (< 0 (|Seq#Length| xs@@9)) (state Heap@@17 ZeroMask))) (and (and (=> (= (ControlFlow 0 18) 17) anon9_Else_correct) (=> (= (ControlFlow 0 18) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 18) 7) anon10_Else_correct)))))
