...
(assert  (and (and (and (and (and (and (and (and (and (= (type y@@2) RefType) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@11) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type xs) (SeqType RefType))) (forall ((arg0@@39 T@U) ) (! (= (type (FrameFragment arg0@@39)) FrameTypeType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon4_correct  (=> (<= NoPerm p_1@@5) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= p_1@@5 NoPerm)) (=> (>= p_1@@5 NoPerm) (=> (and (=> (> p_1@@5 NoPerm) (not (= y@@2 null))) (= Mask@2 (MapType1Store Mask@1 y@@2 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@1 y@@2 f_7)) p_1@@5))))) (=> (and (and (state Heap@1 Mask@2) (state Heap@1 Mask@2)) (and (state Heap@1 Mask@2) (= (ControlFlow 0 2) (- 0 1)))) (not (= y@@2 null)))))))))
(let ((anon6_Else_correct  (=> (HasDirectPerm Mask@1 null (pred2 y@@2 p_1@@5)) (=> (and (= Heap@1 Heap@@11) (= (ControlFlow 0 5) 2)) anon4_correct))))
(let ((anon6_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (pred2 y@@2 p_1@@5))) (= Heap@0 (MapType0Store Heap@@11 null (pred2 y@@2 p_1@@5) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 4) 2))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (pred2 y@@2 p_1@@5) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (pred2 y@@2 p_1@@5))) FullPerm)))) (and (=> (= (ControlFlow 0 6) 4) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pred2 y@@2 p_1@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pred2 y@@2 p_1@@5)))) (=> (= (ControlFlow 0 7) 6) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@11 y@@2 $allocated)) (|Seq#Contains| xs y@@2)) (=> (and (and (and (state Heap@@11 ZeroMask) (<= NoPerm p_1@@5)) (and (state Heap@@11 ZeroMask) (= Mask@0 (MapType1Store ZeroMask null (pred2 y@@2 p_1@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (pred2 y@@2 p_1@@5))) FullPerm)))))) (and (and (state Heap@@11 Mask@0) (state Heap@@11 Mask@0)) (and (|pred2#trigger| Heap@@11 (pred2 y@@2 p_1@@5)) (= (MapType0Select Heap@@11 null (pred2 y@@2 p_1@@5)) (ConditionalFrame p_1@@5 (FrameFragment (MapType0Select Heap@@11 y@@2 f_7))))))) (and (=> (= (ControlFlow 0 10) 7) anon5_Then_correct) (=> (= (ControlFlow 0 10) 9) anon5_Else_correct)))))))
