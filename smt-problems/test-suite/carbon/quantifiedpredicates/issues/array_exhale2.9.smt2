...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon12_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((i_5 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5 i_5_1)) (and (> i_5 0) (< i_5 4))) (and (> i_5_1 0) (< i_5_1 4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@8 i_5) (loc a_3@@8 i_5_1))))
 :qid |stdinbpl.1992:15|
 :skolemid |198|
)))))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (> i_3 4) (< i_3 n))) (and (> i_3_1 4) (< i_3_1 n))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@8 i_3) (loc a_3@@8 i_3_1))))
 :qid |stdinbpl.1952:15|
 :skolemid |192|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (and (> i_3@@0 4) (< i_3@@0 n))) (and (> i_3_1@@0 4) (< i_3_1@@0 n))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@8 i_3@@0) (loc a_3@@8 i_3_1@@0))))
 :qid |stdinbpl.1952:15|
 :skolemid |192|
)) (=> (forall ((i_3@@1 Int) ) (!  (=> (and (and (> i_3@@1 4) (< i_3@@1 n)) (< NoPerm FullPerm)) (and (qpRange27 (loc a_3@@8 i_3@@1)) (= (invRecv27 (loc a_3@@8 i_3@@1)) i_3@@1)))
 :qid |stdinbpl.1958:22|
 :skolemid |193|
 :pattern ( (loc a_3@@8 i_3@@1))
 :pattern ( (loc a_3@@8 i_3@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (> (invRecv27 o_3) 4) (< (invRecv27 o_3) n)) (< NoPerm FullPerm)) (qpRange27 o_3)) (= (loc a_3@@8 (invRecv27 o_3)) o_3)))
 :qid |stdinbpl.1962:22|
 :skolemid |194|
 :pattern ( (invRecv27 o_3))
)) (forall ((i_3@@2 Int) ) (!  (=> (and (> i_3@@2 4) (< i_3@@2 n)) (not (= (loc a_3@@8 i_3@@2) null)))
 :qid |stdinbpl.1968:22|
 :skolemid |195|
 :pattern ( (loc a_3@@8 i_3@@2))
 :pattern ( (loc a_3@@8 i_3@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (> (invRecv27 o_3@@0) 4) (< (invRecv27 o_3@@0) n)) (< NoPerm FullPerm)) (qpRange27 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@8 (invRecv27 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@3 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (and (and (> (invRecv27 o_3@@0) 4) (< (invRecv27 o_3@@0) n)) (< NoPerm FullPerm)) (qpRange27 o_3@@0))) (= (U_2_real (MapType1Select QPMask@3 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
...
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((i_6 Int) (i_6_2 Int) ) (!  (=> (and (and (and (and (not (= i_6 i_6_2)) (and (> i_6 4) (< i_6 n))) (and (> i_6_2 4) (< i_6_2 n))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@8 i_6) (loc a_3@@8 i_6_2))))
 :qid |stdinbpl.2039:17|
 :skolemid |204|
 :pattern ( (neverTriggered29 i_6) (neverTriggered29 i_6_2))
))) (=> (forall ((i_6@@0 Int) (i_6_2@@0 Int) ) (!  (=> (and (and (and (and (not (= i_6@@0 i_6_2@@0)) (and (> i_6@@0 4) (< i_6@@0 n))) (and (> i_6_2@@0 4) (< i_6_2@@0 n))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@8 i_6@@0) (loc a_3@@8 i_6_2@@0))))
 :qid |stdinbpl.2039:17|
 :skolemid |204|
 :pattern ( (neverTriggered29 i_6@@0) (neverTriggered29 i_6_2@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((i_6@@1 Int) ) (!  (=> (and (> i_6@@1 4) (< i_6@@1 n)) (>= (U_2_real (MapType1Select QPMask@0 (loc a_3@@8 i_6@@1) val)) FullPerm))
 :qid |stdinbpl.2046:17|
 :skolemid |205|
 :pattern ( (loc a_3@@8 i_6@@1))
 :pattern ( (loc a_3@@8 i_6@@1))
))) (=> (forall ((i_6@@2 Int) ) (!  (=> (and (> i_6@@2 4) (< i_6@@2 n)) (>= (U_2_real (MapType1Select QPMask@0 (loc a_3@@8 i_6@@2) val)) FullPerm))
 :qid |stdinbpl.2046:17|
 :skolemid |205|
 :pattern ( (loc a_3@@8 i_6@@2))
 :pattern ( (loc a_3@@8 i_6@@2))
)) (=> (and (and (forall ((i_6@@3 Int) ) (!  (=> (and (and (> i_6@@3 4) (< i_6@@3 n)) (< NoPerm FullPerm)) (and (qpRange29 (loc a_3@@8 i_6@@3)) (= (invRecv29 (loc a_3@@8 i_6@@3)) i_6@@3)))
 :qid |stdinbpl.2052:22|
 :skolemid |206|
 :pattern ( (loc a_3@@8 i_6@@3))
 :pattern ( (loc a_3@@8 i_6@@3))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (> (invRecv29 o_3@@2) 4) (< (invRecv29 o_3@@2) n)) (and (< NoPerm FullPerm) (qpRange29 o_3@@2))) (= (loc a_3@@8 (invRecv29 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.2056:22|
 :skolemid |207|
 :pattern ( (invRecv29 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (> (invRecv29 o_3@@3) 4) (< (invRecv29 o_3@@3) n)) (and (< NoPerm FullPerm) (qpRange29 o_3@@3))) (and (= (loc a_3@@8 (invRecv29 o_3@@3)) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 val)) (- (U_2_real (MapType1Select QPMask@0 o_3@@3 val)) FullPerm)))) (=> (not (and (and (> (invRecv29 o_3@@3) 4) (< (invRecv29 o_3@@3) n)) (and (< NoPerm FullPerm) (qpRange29 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 val)) (U_2_real (MapType1Select QPMask@0 o_3@@3 val))))))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 ...
 :qid |stdinbpl.2068:29|
 :skolemid |209|
 :pattern ( (MapType1Select QPMask@1 o_3@@4 f_5@@0))
)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((i_7 Int) (i_7_1 Int) ) (!  (=> (and (and (and (and (not (= i_7 i_7_1)) (and (> i_7 0) (< i_7 4))) (and (> i_7_1 0) (< i_7_1 4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@8 i_7) (loc a_3@@8 i_7_1))))
 :qid |stdinbpl.2080:17|
 :skolemid |210|
 :pattern ( (neverTriggered30 i_7) (neverTriggered30 i_7_1))
))) (=> (forall ((i_7@@0 Int) (i_7_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_7@@0 i_7_1@@0)) (and (> i_7@@0 0) (< i_7@@0 4))) (and (> i_7_1@@0 0) (< i_7_1@@0 4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@8 i_7@@0) (loc a_3@@8 i_7_1@@0))))
 :qid |stdinbpl.2080:17|
 :skolemid |210|
 :pattern ( (neverTriggered30 i_7@@0) (neverTriggered30 i_7_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((i_7@@1 Int) ) (!  (=> (and (> i_7@@1 0) (< i_7@@1 4)) (>= (U_2_real (MapType1Select QPMask@1 (loc a_3@@8 i_7@@1) val)) FullPerm))
 :qid |stdinbpl.2087:17|
 :skolemid |211|
 :pattern ( (loc a_3@@8 i_7@@1))
 :pattern ( (loc a_3@@8 i_7@@1))
))))))))))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (> i_1 0) (< i_1 n))) (and (> i_1_1 0) (< i_1_1 n))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@8 i_1) (loc a_3@@8 i_1_1))))
 :qid |stdinbpl.1901:15|
 :skolemid |186|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (> i_1@@0 0) (< i_1@@0 n))) (and (> i_1_1@@0 0) (< i_1_1@@0 n))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@8 i_1@@0) (loc a_3@@8 i_1_1@@0))))
 :qid |stdinbpl.1901:15|
 :skolemid |186|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (and (> i_1@@1 0) (< i_1@@1 n)) (< NoPerm FullPerm)) (and (qpRange26 (loc a_3@@8 i_1@@1)) (= (invRecv26 (loc a_3@@8 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.1907:22|
 :skolemid |187|
 :pattern ( (loc a_3@@8 i_1@@1))
 :pattern ( (loc a_3@@8 i_1@@1))
)) (=> (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (and (> (invRecv26 o_3@@5) 0) (< (invRecv26 o_3@@5) n)) (< NoPerm FullPerm)) (qpRange26 o_3@@5)) (= (loc a_3@@8 (invRecv26 o_3@@5)) o_3@@5)))
 :qid |stdinbpl.1911:22|
 :skolemid |188|
 :pattern ( (invRecv26 o_3@@5))
)) (forall ((i_1@@2 Int) ) (!  (=> (and (> i_1@@2 0) (< i_1@@2 n)) (not (= (loc a_3@@8 i_1@@2) null)))
 :qid |stdinbpl.1917:22|
 :skolemid |189|
 :pattern ( (loc a_3@@8 i_1@@2))
 :pattern ( (loc a_3@@8 i_1@@2))
))) (=> (and (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (and (> (invRecv26 o_3@@6) 0) (< (invRecv26 o_3@@6) n)) (< NoPerm FullPerm)) (qpRange26 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@8 (invRecv26 o_3@@6)) o_3@@6)) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@6 val)) FullPerm)))) (=> (not (and (and (and (> (invRecv26 o_3@@6) 0) (< (invRecv26 o_3@@6) n)) (< NoPerm FullPerm)) (qpRange26 o_3@@6))) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 val)) (U_2_real (MapType1Select ZeroMask o_3@@6 val))))))
