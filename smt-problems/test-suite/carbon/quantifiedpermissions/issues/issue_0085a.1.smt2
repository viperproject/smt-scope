...
(assert  (and (and (= (type Heap@@11) (MapType1Type RefType)) (= (type this@@12) RefType)) (= (type Mask@0) (MapType2Type RefType realType))))
(set-info :boogie-vc-id m0)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (U_2_bool (MapType1Select Heap@@11 this@@12 $allocated)) (not (= this@@12 null))) (=> (and (and (state Heap@@11 ZeroMask) (= Mask@0 (MapType2Store ZeroMask null (P this@@12) (real_2_U (+ (U_2_real (MapType2Select ZeroMask null (P this@@12))) FullPerm))))) (and (state Heap@@11 Mask@0) (state Heap@@11 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 this@@12 n)) (=> (HasDirectPerm Mask@0 this@@12 n) (=> (= (ControlFlow 0 2) (- 0 1)) (= FullPerm (U_2_real (MapType2Select Mask@0 this@@12 n)))))))))))
