...
mono "$EXE" /headless /timing /loops:2147483647 /loopsMs:10000 /showNumChecks /showQuantStatistics /findHighBranching:6 /l:$1 | sed "/^wrong line: '  /d" || (echo "[crash]" && echo "!!! AxiomProfiler crashed" 2>&1)
