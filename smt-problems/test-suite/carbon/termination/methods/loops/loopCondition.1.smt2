...
(declare-fun i@2 () Int)
(declare-fun n () Int)
(declare-fun vbreak@1 () Bool)
(declare-fun old_W1_T0@0 () Int)
(declare-fun i@0 () Int)
(declare-fun i@1 () Int)
(declare-fun vbreak@0 () Bool)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon8_correct  (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 4) (- 0 3))) (<= i@2 n))))
(let ((anon13_Else_correct  (=> (and vbreak@1 (= (ControlFlow 0 7) 4)) anon8_correct)))
(let ((anon13_Then_correct  (=> (not vbreak@1) (and (=> (= (ControlFlow 0 5) (- 0 6)) (and (decreasing (int_2_U (- n i@2)) (int_2_U old_W1_T0@0)) (bounded (int_2_U old_W1_T0@0)))) (=> (and (decreasing (int_2_U (- n i@2)) (int_2_U old_W1_T0@0)) (bounded (int_2_U old_W1_T0@0))) (=> (= (ControlFlow 0 5) 4) anon8_correct))))))
(let ((anon6_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 8) 5) anon13_Then_correct) (=> (= (ControlFlow 0 8) 7) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (< n (+ i@0 1)) (=> (and (and (state Heap@@9 ZeroMask) (= i@2 i@0)) (and (= vbreak@1 true) (= (ControlFlow 0 10) 8))) anon6_correct))))
(let ((anon12_Then_correct  (=> (and (<= (+ i@0 1) n) (= i@1 (+ i@0 1))) (=> (and (and (state Heap@@9 ZeroMask) (= i@2 i@1)) (and (= vbreak@1 vbreak@0) (= (ControlFlow 0 9) 8))) anon6_correct))))
(let ((anon11_Then_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (and (<= i@0 n) (state Heap@@9 ZeroMask)) (and (not vbreak@0) (state Heap@@9 ZeroMask))) (and (and (= old_W1_T0@0 (- n i@0)) (state Heap@@9 ZeroMask)) (and (= res@1 (+ res@0 i@0)) (state Heap@@9 ZeroMask)))) (and (=> (= (ControlFlow 0 11) 9) anon12_Then_correct) (=> (= (ControlFlow 0 11) 10) anon12_Else_correct))))))
(let ((anon11_Else_correct true))
(let ((anon10_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (<= 0 n)) (=> (and (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= 0 n)) (=> (<= 0 n) (and (and (=> (= (ControlFlow 0 12) 1) anon10_Then_correct) (=> (= (ControlFlow 0 12) 11) anon11_Then_correct)) (=> (= (ControlFlow 0 12) 2) anon11_Else_correct))))))))
