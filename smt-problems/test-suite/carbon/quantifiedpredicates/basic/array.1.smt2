...
(declare-fun invRecv18 (T@U Int) Int)
(declare-fun qpRange18 (T@U Int) Bool)
(declare-fun neverTriggered16 (Int) Bool)
(declare-fun invRecv16 (T@U Int) Int)
(declare-fun qpRange16 (T@U Int) Bool)
(assert  (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type a_3@@8) IArrayDomainTypeType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id t4)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon13_Else_correct  (=> (= (ControlFlow 0 15) (- 0 14)) (forall ((i_5 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5 i_5_1)) (|Seq#Contains| (|Seq#Range| 1 n@@13) (int_2_U i_5))) (|Seq#Contains| (|Seq#Range| 1 n@@13) (int_2_U i_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_3@@8 a_3@@8)) (not (= i_5 i_5_1))))
...
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (p_1 a_3@@8 1))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (p_1 a_3@@8 1)))) (=> (= (ControlFlow 0 3) 2) anon10_correct))))))
(let ((anon8_correct  (=> (= Mask@0 (MapType1Store QPMask@1 null (p_1 a_3@@8 0) (real_2_U (- (U_2_real (MapType1Select QPMask@1 null (p_1 a_3@@8 0))) FullPerm)))) (and (=> (= (ControlFlow 0 6) 3) anon15_Then_correct) (=> (= (ControlFlow 0 6) 5) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon8_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select QPMask@1 null (p_1 a_3@@8 0))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@1 null (p_1 a_3@@8 0)))) (=> (= (ControlFlow 0 7) 6) anon8_correct))))))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 12)) (forall ((i_8 Int) (i_8_1 Int) ) (!  (=> (and (and (and (and (not (= i_8 i_8_1)) (|Seq#Contains| (|Seq#Range| 1 n@@13) (int_2_U i_8))) (|Seq#Contains| (|Seq#Range| 1 n@@13) (int_2_U i_8_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_3@@8 a_3@@8)) (not (= i_8 i_8_1))))
 :qid |stdinbpl.1633:17|
 :skolemid |175|
 :pattern ( (neverTriggered18 i_8) (neverTriggered18 i_8_1))
))) (=> (forall ((i_8@@0 Int) (i_8_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_8@@0 i_8_1@@0)) (|Seq#Contains| (|Seq#Range| 1 n@@13) (int_2_U i_8@@0))) (|Seq#Contains| (|Seq#Range| 1 n@@13) (int_2_U i_8_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_3@@8 a_3@@8)) (not (= i_8@@0 i_8_1@@0))))
 :qid |stdinbpl.1633:17|
 :skolemid |175|
 :pattern ( (neverTriggered18 i_8@@0) (neverTriggered18 i_8_1@@0))
)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((i_8@@1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 1 n@@13) (int_2_U i_8@@1)) (>= (U_2_real (MapType1Select QPMask@0 null (p_1 a_3@@8 i_8@@1))) FullPerm))
 :qid |stdinbpl.1640:17|
 :skolemid |176|
 :pattern ( (MapType0Select Heap@@10 null (p_1 a_3@@8 i_8@@1)))
 :pattern ( (MapType1Select QPMask@0 null (p_1 a_3@@8 i_8@@1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 1 n@@13) (int_2_U i_8@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 1 n@@13) (int_2_U i_8@@1)))
))) (=> (forall ((i_8@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 1 n@@13) (int_2_U i_8@@2)) (>= (U_2_real (MapType1Select QPMask@0 null (p_1 a_3@@8 i_8@@2))) FullPerm))
 :qid |stdinbpl.1640:17|
 :skolemid |176|
 :pattern ( (MapType0Select Heap@@10 null (p_1 a_3@@8 i_8@@2)))
 :pattern ( (MapType1Select QPMask@0 null (p_1 a_3@@8 i_8@@2)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 1 n@@13) (int_2_U i_8@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 1 n@@13) (int_2_U i_8@@2)))
)) (=> (forall ((i_8@@3 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 1 n@@13) (int_2_U i_8@@3)) (< NoPerm FullPerm)) (and (= (invRecv18 a_3@@8 i_8@@3) i_8@@3) (qpRange18 a_3@@8 i_8@@3)))
 :qid |stdinbpl.1646:22|
 :skolemid |177|
 :pattern ( (MapType0Select Heap@@10 null (p_1 a_3@@8 i_8@@3)))
 :pattern ( (MapType1Select QPMask@0 null (p_1 a_3@@8 i_8@@3)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 1 n@@13) (int_2_U i_8@@3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 1 n@@13) (int_2_U i_8@@3)))
)) (=> (and (and (forall ((a_3_1 T@U) (i_9_1 Int) ) (!  (=> (= (type a_3_1) IArrayDomainTypeType) (=> (and (and (|Seq#Contains| (|Seq#Range| 1 n@@13) (int_2_U (invRecv18 a_3_1 i_9_1))) (< NoPerm FullPerm)) (qpRange18 a_3_1 i_9_1)) (and (= a_3@@8 a_3_1) (= (invRecv18 a_3_1 i_9_1) i_9_1))))
 :qid |stdinbpl.1650:22|
 :skolemid |178|
 :pattern ( (invRecv18 a_3_1 i_9_1))
)) (forall ((a_3_1@@0 T@U) (i_9_1@@0 Int) ) (!  (=> (= (type a_3_1@@0) IArrayDomainTypeType) (=> (and (and (|Seq#Contains| (|Seq#Range| 1 n@@13) (int_2_U (invRecv18 a_3_1@@0 i_9_1@@0))) (< NoPerm FullPerm)) (qpRange18 a_3_1@@0 i_9_1@@0)) (and (and (= a_3@@8 a_3_1@@0) (= (invRecv18 a_3_1@@0 i_9_1@@0) i_9_1@@0)) (= (U_2_real (MapType1Select QPMask@1 null (p_1 a_3_1@@0 i_9_1@@0))) (- (U_2_real (MapType1Select QPMask@0 null (p_1 a_3_1@@0 i_9_1@@0))) FullPerm)))))
 :qid |stdinbpl.1656:22|
 :skolemid |179|
 :pattern ( (MapType1Select QPMask@1 null (p_1 a_3_1@@0 i_9_1@@0)))
))) (and (forall ((a_3_1@@1 T@U) (i_9_1@@1 Int) ) (!  (=> (and (= (type a_3_1@@1) IArrayDomainTypeType) (not (and (and (|Seq#Contains| (|Seq#Range| 1 n@@13) (int_2_U (invRecv18 a_3_1@@1 i_9_1@@1))) (< NoPerm FullPerm)) (qpRange18 a_3_1@@1 i_9_1@@1)))) (= (U_2_real (MapType1Select QPMask@1 null (p_1 a_3_1@@1 i_9_1@@1))) (U_2_real (MapType1Select QPMask@0 null (p_1 a_3_1@@1 i_9_1@@1)))))
 :qid |stdinbpl.1660:22|
 :skolemid |180|
 :pattern ( (MapType1Select QPMask@1 null (p_1 a_3_1@@1 i_9_1@@1)))
...
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_3@@8 a_3@@8)) (not (= i_1 i_1_1))))
...
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@1)) (< NoPerm FullPerm)) (and (= (invRecv16 a_3@@8 i_1@@1) i_1@@1) (qpRange16 a_3@@8 i_1@@1)))
 :qid |stdinbpl.1531:22|
 :skolemid |164|
...
)) (=> (and (forall ((a_1_1 T@U) (i_2_1 Int) ) (!  (=> (= (type a_1_1) IArrayDomainTypeType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv16 a_1_1 i_2_1))) (< NoPerm FullPerm)) (qpRange16 a_1_1 i_2_1)) (and (= a_3@@8 a_1_1) (= (invRecv16 a_1_1 i_2_1) i_2_1))))
 :qid |stdinbpl.1535:22|
 :skolemid |165|
 :pattern ( (invRecv16 a_1_1 i_2_1))
)) (forall ((a_1_1@@0 T@U) (i_2_1@@0 Int) ) (!  (=> (= (type a_1_1@@0) IArrayDomainTypeType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv16 a_1_1@@0 i_2_1@@0))) (< NoPerm FullPerm)) (qpRange16 a_1_1@@0 i_2_1@@0)) (and (=> (< NoPerm FullPerm) (and (= a_3@@8 a_1_1@@0) (= (invRecv16 a_1_1@@0 i_2_1@@0) i_2_1@@0))) (= (U_2_real (MapType1Select QPMask@0 null (p_1 a_1_1@@0 i_2_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (p_1 a_1_1@@0 i_2_1@@0))) FullPerm)))))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 ...
 :qid |stdinbpl.1547:29|
 :skolemid |167|
 :pattern ( (MapType1Select ZeroMask o_3@@0 f_5@@0))
 :pattern ( (MapType1Select QPMask@0 o_3@@0 f_5@@0))
)) (forall ((a_1_1@@1 T@U) (i_2_1@@1 Int) ) (!  (=> (and (= (type a_1_1@@1) IArrayDomainTypeType) (not (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv16 a_1_1@@1 i_2_1@@1))) (< NoPerm FullPerm)) (qpRange16 a_1_1@@1 i_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (p_1 a_1_1@@1 i_2_1@@1))) (U_2_real (MapType1Select ZeroMask null (p_1 a_1_1@@1 i_2_1@@1)))))
 :qid |stdinbpl.1551:22|
 :skolemid |168|
 :pattern ( (MapType1Select QPMask@0 null (p_1 a_1_1@@1 i_2_1@@1)))
))) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0))) (and (=> (= (ControlFlow 0 17) 16) anon12_Then_correct) (=> (= (ControlFlow 0 17) 10) anon12_Else_correct)))))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (> n@@13 5) (state Heap@@10 ZeroMask)) (and (=> (= (ControlFlow 0 19) 1) anon11_Then_correct) (=> (= (ControlFlow 0 19) 17) anon11_Else_correct))))))
