...
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 6)) (= (id Heap@@13 0) 0)) (=> (= (id Heap@@13 0) 0) (and (=> (= (ControlFlow 0 4) (- 0 5)) (= (id Heap@@13 1) 1)) (=> (= (id Heap@@13 1) 1) (=> (= (ControlFlow 0 4) (- 0 3)) false)))))))
(let ((anon11_Else_correct  (=> (and (forall ((y_1 Int) ) (! (= (id Heap@@13 y_1) i@@3)
 :qid |stdinbpl.257:20|
 :skolemid |26|
 :pattern ( (|id#frame| EmptyFrame y_1))
)) (state Heap@@13 ZeroMask)) (and (=> (= (ControlFlow 0 12) 11) anon13_Then_correct) (=> (= (ControlFlow 0 12) 4) anon13_Else_correct)))))
(let ((anon12_Else_correct true))
(let ((anon12_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (state Heap@@13 ZeroMask)) (and (and (=> (= (ControlFlow 0 13) 12) anon11_Else_correct) (=> (= (ControlFlow 0 13) 1) anon12_Then_correct)) (=> (= (ControlFlow 0 13) 2) anon12_Else_correct))))))
