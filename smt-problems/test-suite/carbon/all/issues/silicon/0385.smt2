...
(let ((anon36_correct  (=> (= ExhaleWellDef0Mask@2 (MapType1Store ExhaleWellDef0Mask@1 s flag (real_2_U (- (U_2_real (MapType1Select ExhaleWellDef0Mask@1 s flag)) FullPerm)))) (=> (and (= ExhaleWellDef0Mask@3 ExhaleWellDef0Mask@2) (= (ControlFlow 0 49) 43)) anon40_correct))))
(let ((anon61_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 52) 49)) anon36_correct)))
(let ((anon61_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 50) (- 0 51)) (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@1 s flag)))) (=> (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@1 s flag))) (=> (= (ControlFlow 0 50) 49) anon36_correct))))))
(let ((anon34_correct  (=> (= ExhaleWellDef0Mask@1 (MapType1Store Mask@1 r_1 flag (real_2_U (- (U_2_real (MapType1Select Mask@1 r_1 flag)) FullPerm)))) (and (=> (= (ControlFlow 0 53) 50) anon61_Then_correct) (=> (= (ControlFlow 0 53) 52) anon61_Else_correct)))))
(let ((anon60_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 56) 53)) anon34_correct)))
(let ((anon60_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 54) (- 0 55)) (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag))) (=> (= (ControlFlow 0 54) 53) anon34_correct))))))
(let ((anon59_Then_correct  (=> (guard s) (and (=> (= (ControlFlow 0 57) 54) anon60_Then_correct) (=> (= (ControlFlow 0 57) 56) anon60_Else_correct)))))
(let ((anon39_correct  (=> (= ExhaleWellDef0Mask@0 (MapType1Store Mask@1 r_1 flag (real_2_U (- (U_2_real (MapType1Select Mask@1 r_1 flag)) FullPerm)))) (=> (and (= ExhaleWellDef0Mask@3 ExhaleWellDef0Mask@0) (= (ControlFlow 0 44) 43)) anon40_correct))))
(let ((anon62_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 47) 44)) anon39_correct)))
(let ((anon62_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 45) (- 0 46)) (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag))) (=> (= (ControlFlow 0 45) 44) anon39_correct))))))
(let ((anon59_Else_correct  (=> (not (guard s)) (and (=> (= (ControlFlow 0 48) 45) anon62_Then_correct) (=> (= (ControlFlow 0 48) 47) anon62_Else_correct)))))
(let ((anon28_correct true))
(let ((anon24_correct  (=> (= ExhaleWellDef0Mask@6 (MapType1Store ExhaleWellDef0Mask@5 s flag (real_2_U (- (U_2_real (MapType1Select ExhaleWellDef0Mask@5 s flag)) FullPerm)))) (=> (and (= ExhaleWellDef0Mask@7 ExhaleWellDef0Mask@6) (= (ControlFlow 0 34) 28)) anon28_correct))))
(let ((anon55_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 37) 34)) anon24_correct)))
(let ((anon55_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 35) (- 0 36)) (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@5 s flag)))) (=> (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@5 s flag))) (=> (= (ControlFlow 0 35) 34) anon24_correct))))))
(let ((anon22_correct  (=> (= ExhaleWellDef0Mask@5 (MapType1Store Mask@1 r_1 flag (real_2_U (- (U_2_real (MapType1Select Mask@1 r_1 flag)) FullPerm)))) (and (=> (= (ControlFlow 0 38) 35) anon55_Then_correct) (=> (= (ControlFlow 0 38) 37) anon55_Else_correct)))))
(let ((anon54_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 41) 38)) anon22_correct)))
(let ((anon54_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 39) (- 0 40)) (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag))) (=> (= (ControlFlow 0 39) 38) anon22_correct))))))
(let ((anon53_Then_correct  (=> (guard s) (and (=> (= (ControlFlow 0 42) 39) anon54_Then_correct) (=> (= (ControlFlow 0 42) 41) anon54_Else_correct)))))
(let ((anon27_correct  (=> (= ExhaleWellDef0Mask@4 (MapType1Store Mask@1 r_1 flag (real_2_U (- (U_2_real (MapType1Select Mask@1 r_1 flag)) FullPerm)))) (=> (and (= ExhaleWellDef0Mask@7 ExhaleWellDef0Mask@4) (= (ControlFlow 0 29) 28)) anon28_correct))))
(let ((anon56_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 32) 29)) anon27_correct)))
(let ((anon56_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 30) (- 0 31)) (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag))) (=> (= (ControlFlow 0 30) 29) anon27_correct))))))
(let ((anon53_Else_correct  (=> (not (guard s)) (and (=> (= (ControlFlow 0 33) 30) anon56_Then_correct) (=> (= (ControlFlow 0 33) 32) anon56_Else_correct)))))
(let ((anon16_correct true))
(let ((anon15_correct  (=> (= ExhaleWellDef0Mask@9 (MapType1Store ExhaleWellDef0Mask@8 s flag (real_2_U (- (U_2_real (MapType1Select ExhaleWellDef0Mask@8 s flag)) FullPerm)))) (=> (and (= ExhaleWellDef0Mask@10 ExhaleWellDef0Mask@9) (= (ControlFlow 0 18) 16)) anon16_correct))))
(let ((anon50_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 21) 18)) anon15_correct)))
(let ((anon50_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@8 s flag)))) (=> (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@8 s flag))) (=> (= (ControlFlow 0 19) 18) anon15_correct))))))
(let ((anon49_Then_correct  (=> (guard s) (and (=> (= (ControlFlow 0 22) 19) anon50_Then_correct) (=> (= (ControlFlow 0 22) 21) anon50_Else_correct)))))
(let ((anon49_Else_correct  (=> (not (guard s)) (=> (and (= ExhaleWellDef0Mask@10 ExhaleWellDef0Mask@8) (= (ControlFlow 0 17) 16)) anon16_correct))))
(let ((anon12_correct  (=> (= ExhaleWellDef0Mask@8 (MapType1Store Mask@1 r_1 flag (real_2_U (- (U_2_real (MapType1Select Mask@1 r_1 flag)) FullPerm)))) (and (=> (= (ControlFlow 0 23) 22) anon49_Then_correct) (=> (= (ControlFlow 0 23) 17) anon49_Else_correct)))))
(let ((anon48_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 26) 23)) anon12_correct)))
(let ((anon48_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag))) (=> (= (ControlFlow 0 24) 23) anon12_correct))))))
(let ((anon41_correct  (=> (= (ControlFlow 0 13) (- 0 12)) (or (foo_1_1 Heap@@25 s r_1) (or (foo_1_2 Heap@@25 s r_1) (or (foo_2_1 Heap@@25 s r_1) (foo_2_2 Heap@@25 s r_1)))))))
(let ((anon57_Then_correct  (=> (not (foo_2_1 Heap@@25 s r_1)) (and (and (=> (= (ControlFlow 0 58) 13) anon41_correct) (=> (= (ControlFlow 0 58) 57) anon59_Then_correct)) (=> (= (ControlFlow 0 58) 48) anon59_Else_correct)))))
(let ((anon57_Else_correct  (=> (and (foo_2_1 Heap@@25 s r_1) (= (ControlFlow 0 27) 13)) anon41_correct)))
(let ((anon51_Then_correct  (=> (not (foo_1_2 Heap@@25 s r_1)) (and (and (and (=> (= (ControlFlow 0 59) 58) anon57_Then_correct) (=> (= (ControlFlow 0 59) 27) anon57_Else_correct)) (=> (= (ControlFlow 0 59) 42) anon53_Then_correct)) (=> (= (ControlFlow 0 59) 33) anon53_Else_correct)))))
(let ((anon51_Else_correct  (=> (and (foo_1_2 Heap@@25 s r_1) (= (ControlFlow 0 15) 13)) anon41_correct)))
(let ((anon46_Then_correct  (=> (not (foo_1_1 Heap@@25 s r_1)) (and (and (and (=> (= (ControlFlow 0 60) 59) anon51_Then_correct) (=> (= (ControlFlow 0 60) 15) anon51_Else_correct)) (=> (= (ControlFlow 0 60) 24) anon48_Then_correct)) (=> (= (ControlFlow 0 60) 26) anon48_Else_correct)))))
(let ((anon46_Else_correct  (=> (and (foo_1_1 Heap@@25 s r_1) (= (ControlFlow 0 14) 13)) anon41_correct)))
...
(let ((anon45_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon6_correct)))
(let ((anon45_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@11 s flag)))) (=> (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@11 s flag))) (=> (= (ControlFlow 0 4) 3) anon6_correct))))))
(let ((anon44_Then_correct  (=> (guard s) (and (=> (= (ControlFlow 0 7) 4) anon45_Then_correct) (=> (= (ControlFlow 0 7) 6) anon45_Else_correct)))))
(let ((anon44_Else_correct  (=> (not (guard s)) (=> (and (= ExhaleWellDef0Mask@13 ExhaleWellDef0Mask@11) (= (ControlFlow 0 2) 1)) anon7_correct))))
(let ((anon3_correct  (=> (= ExhaleWellDef0Mask@11 (MapType1Store Mask@1 r_1 flag (real_2_U (- (U_2_real (MapType1Select Mask@1 r_1 flag)) FullPerm)))) (and (=> (= (ControlFlow 0 8) 7) anon44_Then_correct) (=> (= (ControlFlow 0 8) 2) anon44_Else_correct)))))
(let ((anon43_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon3_correct)))
(let ((anon43_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 r_1 flag))) (=> (= (ControlFlow 0 9) 8) anon3_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@25 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@25 s $allocated)) (U_2_bool (MapType0Select Heap@@25 r_1 $allocated)))) (=> (and (and (and (not (= r_1 null)) (= Mask@0 (MapType1Store ZeroMask r_1 flag (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1 flag)) FullPerm))))) (and (state Heap@@25 Mask@0) (state Heap@@25 Mask@0))) (and (and (not (= s null)) (= Mask@1 (MapType1Store Mask@0 s flag (real_2_U (+ (U_2_real (MapType1Select Mask@0 s flag)) FullPerm))))) (and (state Heap@@25 Mask@1) (state Heap@@25 Mask@1)))) (and (=> (= (ControlFlow 0 61) (- 0 62)) (HasDirectPerm Mask@1 r_1 flag)) (=> (HasDirectPerm Mask@1 r_1 flag) (=> (and (U_2_bool (MapType0Select Heap@@25 r_1 flag)) (state Heap@@25 Mask@1)) (and (and (and (=> (= (ControlFlow 0 61) 60) anon46_Then_correct) (=> (= (ControlFlow 0 61) 14) anon46_Else_correct)) (=> (= (ControlFlow 0 61) 9) anon43_Then_correct)) (=> (= (ControlFlow 0 61) 11) anon43_Else_correct)))))))))
