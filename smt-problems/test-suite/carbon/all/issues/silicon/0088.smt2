...
(declare-fun |fib#trigger| (T@U Int) Bool)
...
(declare-fun |fib#frame| (T@U Int) Int)
...
(assert (forall ((Heap@@2 T@U) (n Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (int_2_U (|fib#triggerStateless| n))))
 :qid |stdinbpl.197:15|
 :skolemid |23|
 :pattern ( (|fib'| Heap@@2 n))
)))
(assert (forall ((Heap@@3 T@U) (x@@9 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type x@@9) RefType)) (|P#everUsed| (P x@@9)))
 :qid |stdinbpl.320:15|
 :skolemid |33|
 :pattern ( (|P#trigger| Heap@@3 (P x@@9)))
)))
(assert (forall ((Heap@@4 T@U) (Mask@@2 T@U) (n@@0 Int) ) (!  (=> (and (and (and (= (type Heap@@4) (MapType0Type RefType)) (= (type Mask@@2) (MapType1Type RefType realType))) (and (state Heap@@4 Mask@@2) (< AssumeFunctionsAbove 0))) (>= n@@0 0)) (= (fib Heap@@4 n@@0) (ite (<= n@@0 1) n@@0 (+ (|fib'| Heap@@4 (- n@@0 1)) (|fib'| Heap@@4 (- n@@0 2))))))
 :qid |stdinbpl.203:15|
 :skolemid |24|
 :pattern ( (state Heap@@4 Mask@@2) (fib Heap@@4 n@@0))
)))
...
(assert (forall ((Heap@@6 T@U) (n@@1 Int) ) (!  (=> (= (type Heap@@6) (MapType0Type RefType)) (and (= (fib Heap@@6 n@@1) (|fib'| Heap@@6 n@@1)) (dummyFunction (int_2_U (|fib#triggerStateless| n@@1)))))
 :qid |stdinbpl.193:15|
 :skolemid |22|
 :pattern ( (fib Heap@@6 n@@1))
)))
...
(assert (forall ((Heap@@8 T@U) (Mask@@5 T@U) (n@@2 Int) ) (!  (=> (and (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@5) (MapType1Type RefType realType))) (and (state Heap@@8 Mask@@5) (or (< AssumeFunctionsAbove 0) (|fib#trigger| EmptyFrame n@@2)))) (>= n@@2 0)) (= (= (|fib'| Heap@@8 n@@2) 0) (= n@@2 0)))
 :qid |stdinbpl.216:15|
 :skolemid |26|
 :pattern ( (state Heap@@8 Mask@@5) (|fib'| Heap@@8 n@@2))
)))
...
(assert (forall ((Heap@@12 T@U) (Mask@@11 T@U) (n@@3 Int) ) (!  (=> (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (state Heap@@12 Mask@@11)) (= (|fib'| Heap@@12 n@@3) (|fib#frame| EmptyFrame n@@3)))
 :qid |stdinbpl.210:15|
 :skolemid |25|
 :pattern ( (state Heap@@12 Mask@@11) (|fib'| Heap@@12 n@@3))
)))
...
(assert (forall ((Heap@@14 T@U) (Mask@@12 T@U) (n@@4 Int) ) (!  (=> (and (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (and (state Heap@@14 Mask@@12) (or (< AssumeFunctionsAbove 0) (|fib#trigger| EmptyFrame n@@4)))) (>= n@@4 0)) (>= (|fib'| Heap@@14 n@@4) 0))
 :qid |stdinbpl.220:15|
 :skolemid |27|
 :pattern ( (state Heap@@14 Mask@@12) (|fib'| Heap@@14 n@@4))
)))
...
(declare-fun n_1_1 () Int)
(declare-fun UnfoldingMask@1 () T@U)
(declare-fun n_2 () Int)
(assert  (and (and (and (and (= (type UnfoldingMask@1) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type x@@14) RefType)) (= (type Heap@@16) (MapType0Type RefType))) (= (type UnfoldingMask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon11_correct true))
(let ((anon10_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (P x@@14) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P x@@14))) FullPerm)))) (state Heap@@16 UnfoldingMask@0)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< n_1_1 (+ n_1_1 1))) (=> (< n_1_1 (+ n_1_1 1)) (=> (= (ControlFlow 0 11) 9) anon11_correct))))))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 15) 11)) anon10_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P x@@14))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P x@@14)))) (=> (= (ControlFlow 0 13) 11) anon10_correct))))))
(let ((anon17_Then_correct  (=> (>= n_1_1 1) (=> (and (|P#trigger| Heap@@16 (P x@@14)) (= (MapType0Select Heap@@16 null (P x@@14)) EmptyFrame)) (and (=> (= (ControlFlow 0 16) 13) anon18_Then_correct) (=> (= (ControlFlow 0 16) 15) anon18_Else_correct))))))
(let ((anon17_Else_correct  (=> (and (> 1 n_1_1) (= (ControlFlow 0 10) 9)) anon11_correct)))
(let ((anon5_correct true))
(let ((anon4_correct  (=> (and (and (= UnfoldingMask@1 (MapType1Store Mask@0 null (P x@@14) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P x@@14))) FullPerm)))) (state Heap@@16 UnfoldingMask@1)) (and (state Heap@@16 Mask@0) (= (ControlFlow 0 4) 2))) anon5_correct)))
(let ((anon15_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 4)) anon4_correct)))
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P x@@14))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P x@@14)))) (=> (= (ControlFlow 0 5) 4) anon4_correct))))))
(let ((anon14_Then_correct  (=> (>= n_2 1) (=> (and (|P#trigger| Heap@@16 (P x@@14)) (= (MapType0Select Heap@@16 null (P x@@14)) EmptyFrame)) (and (=> (= (ControlFlow 0 8) 5) anon15_Then_correct) (=> (= (ControlFlow 0 8) 7) anon15_Else_correct))))))
(let ((anon14_Else_correct  (=> (and (> 1 n_2) (= (ControlFlow 0 3) 2)) anon5_correct)))
(let ((anon16_Else_correct true))
(let ((anon0_correct  (=> (and (state Heap@@16 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@16 x@@14 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (P x@@14) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@14))) FullPerm))))) (and (state Heap@@16 Mask@0) (state Heap@@16 Mask@0))) (and (and (and (and (=> (= (ControlFlow 0 17) 1) anon16_Else_correct) (=> (= (ControlFlow 0 17) 16) anon17_Then_correct)) (=> (= (ControlFlow 0 17) 10) anon17_Else_correct)) (=> (= (ControlFlow 0 17) 8) anon14_Then_correct)) (=> (= (ControlFlow 0 17) 3) anon14_Else_correct))))))
