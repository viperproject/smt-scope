...
(declare-fun u_1@@3 () T@U)
(declare-fun v_2@@6 () T@U)
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type g) (MapType0Type RefType boolType)) (= (type n$0_12) RefType)) (= (type Heap@@13) (MapType1Type RefType))) (= (type QPMask@0) (MapType2Type RefType realType))) (= (type QPMask@1) (MapType2Type RefType realType))) (= (type QPMask@2) (MapType2Type RefType realType))) (= (type QPMask@3) (MapType2Type RefType realType))) (= (type QPMask@4) (MapType2Type RefType realType))) (= (type QPMask@5) (MapType2Type RefType realType))) (= (type QPMask@6) (MapType2Type RefType realType))) (= (type u_1@@3) RefType)) (= (type v_2@@6) RefType)) (= (type n$2_2) RefType)) (= (type QPMask@7) (MapType2Type RefType realType))) (forall ((arg0@@55 T@U) ) (! (= (type (invRecv32 arg0@@55)) RefType)
 :qid |funType:invRecv32|
 :pattern ( (invRecv32 arg0@@55))
))) (= (type w_2@@2) RefType)) (= (type n$2_5) RefType)) (= (type PostHeap@0) (MapType1Type RefType))) (= (type QPMask@8) (MapType2Type RefType realType))) (= (type QPMask@9) (MapType2Type RefType realType))) (forall ((arg0@@56 T@U) ) (! (= (type (invRecv30 arg0@@56)) RefType)
 :qid |funType:invRecv30|
 :pattern ( (invRecv30 arg0@@56))
))) (forall ((arg0@@57 T@U) ) (! (= (type (invRecv27 arg0@@57)) RefType)
 :qid |funType:invRecv27|
 :pattern ( (invRecv27 arg0@@57))
))))
...
(let ((anon48_Then_correct  (and (=> (= (ControlFlow 0 48) (- 0 49)) (forall ((n_4 T@U) (n_4_1 T@U) ) (!  (=> (and (= (type n_4) RefType) (= (type n_4_1) RefType)) (=> (and (and (and (and (not (= n_4 n_4_1)) (U_2_bool (MapType0Select g n_4))) (U_2_bool (MapType0Select g n_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4 n_4_1))))
 :qid |stdinbpl.2859:21|
 :skolemid |311|
 :pattern ( (neverTriggered31 n_4) (neverTriggered31 n_4_1))
))) (=> (forall ((n_4@@0 T@U) (n_4_1@@0 T@U) ) (!  (=> (and (= (type n_4@@0) RefType) (= (type n_4_1@@0) RefType)) (=> (and (and (and (and (not (= n_4@@0 n_4_1@@0)) (U_2_bool (MapType0Select g n_4@@0))) (U_2_bool (MapType0Select g n_4_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4@@0 n_4_1@@0))))
 :qid |stdinbpl.2859:21|
 :skolemid |311|
 :pattern ( (neverTriggered31 n_4@@0) (neverTriggered31 n_4_1@@0))
)) (=> (= (ControlFlow 0 48) (- 0 47)) (forall ((n_4@@1 T@U) ) (!  (=> (and (= (type n_4@@1) RefType) (U_2_bool (MapType0Select g n_4@@1))) (>= (U_2_real (MapType2Select QPMask@8 n_4@@1 next)) FullPerm))
 :qid |stdinbpl.2866:21|
 :skolemid |312|
 :pattern ( (MapType1Select PostHeap@0 n_4@@1 next))
 :pattern ( (MapType2Select QPMask@9 n_4@@1 next))
 :pattern ( (MapType1Select PostHeap@0 n_4@@1 next))
)))))))
(let ((anon45_Else_correct  (=> (forall ((n$2_1 T@U) ) (!  (=> (= (type n$2_1) RefType) (=> (and (U_2_bool (MapType0Select g n$2_1)) (not (= (MapType1Select PostHeap@0 n$2_1 next) null))) (U_2_bool (MapType0Select g (MapType1Select PostHeap@0 n$2_1 next)))))
 :qid |stdinbpl.2840:20|
 :skolemid |310|
 :pattern ( (MapType0Select g (MapType1Select PostHeap@0 n$2_1 next)))
 :pattern ( (MapType0Select g n$2_1) (MapType1Select PostHeap@0 n$2_1 next))
...
(let ((anon47_Else_correct  (=> (and (not (and (U_2_bool (MapType0Select g n$2_5)) (not (= (MapType1Select PostHeap@0 n$2_5 next) null)))) (= (ControlFlow 0 43) 40)) anon20_correct)))
(let ((anon47_Then_correct  (=> (and (U_2_bool (MapType0Select g n$2_5)) (not (= (MapType1Select PostHeap@0 n$2_5 next) null))) (and (=> (= (ControlFlow 0 41) (- 0 42)) (HasDirectPerm QPMask@8 n$2_5 next)) (=> (HasDirectPerm QPMask@8 n$2_5 next) (=> (= (ControlFlow 0 41) 40) anon20_correct))))))
(let ((anon46_Else_correct  (=> (not (U_2_bool (MapType0Select g n$2_5))) (and (=> (= (ControlFlow 0 46) 41) anon47_Then_correct) (=> (= (ControlFlow 0 46) 43) anon47_Else_correct)))))
(let ((anon46_Then_correct  (=> (U_2_bool (MapType0Select g n$2_5)) (and (=> (= (ControlFlow 0 44) (- 0 45)) (HasDirectPerm QPMask@8 n$2_5 next)) (=> (HasDirectPerm QPMask@8 n$2_5 next) (and (=> (= (ControlFlow 0 44) 41) anon47_Then_correct) (=> (= (ControlFlow 0 44) 43) anon47_Else_correct)))))))
(let ((anon44_Else_correct  (and (=> (= (ControlFlow 0 52) (- 0 53)) (forall ((n$1_1 T@U) (n$1_1_1 T@U) ) (!  (=> (and (= (type n$1_1) RefType) (= (type n$1_1_1) RefType)) (=> (and (and (and (and (not (= n$1_1 n$1_1_1)) (U_2_bool (MapType0Select g n$1_1))) (U_2_bool (MapType0Select g n$1_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1 n$1_1_1))))
 :qid |stdinbpl.2795:15|
 :skolemid |304|
...
))) (=> (forall ((n$1_1@@0 T@U) (n$1_1_1@@0 T@U) ) (!  (=> (and (= (type n$1_1@@0) RefType) (= (type n$1_1_1@@0) RefType)) (=> (and (and (and (and (not (= n$1_1@@0 n$1_1_1@@0)) (U_2_bool (MapType0Select g n$1_1@@0))) (U_2_bool (MapType0Select g n$1_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_1@@0 n$1_1_1@@0))))
 :qid |stdinbpl.2795:15|
 :skolemid |304|
...
)) (=> (and (forall ((n$1_1@@1 T@U) ) (!  (=> (= (type n$1_1@@1) RefType) (=> (and (U_2_bool (MapType0Select g n$1_1@@1)) (< NoPerm FullPerm)) (and (qpRange30 n$1_1@@1) (= (invRecv30 n$1_1@@1) n$1_1@@1))))
 :qid |stdinbpl.2801:22|
 :skolemid |305|
 :pattern ( (MapType1Select PostHeap@0 n$1_1@@1 next))
 :pattern ( (MapType2Select QPMask@8 n$1_1@@1 next))
 :pattern ( (MapType1Select PostHeap@0 n$1_1@@1 next))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType0Select g (invRecv30 o_3))) (< NoPerm FullPerm)) (qpRange30 o_3)) (= (invRecv30 o_3) o_3)))
 :qid |stdinbpl.2805:22|
 :skolemid |306|
 :pattern ( (invRecv30 o_3))
))) (=> (and (and (forall ((n$1_1@@2 T@U) ) (!  (=> (and (= (type n$1_1@@2) RefType) (U_2_bool (MapType0Select g n$1_1@@2))) (not (= n$1_1@@2 null)))
 :qid |stdinbpl.2811:22|
 :skolemid |307|
 :pattern ( (MapType1Select PostHeap@0 n$1_1@@2 next))
 :pattern ( (MapType2Select QPMask@8 n$1_1@@2 next))
 :pattern ( (MapType1Select PostHeap@0 n$1_1@@2 next))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType0Select g (invRecv30 o_3@@0))) (< NoPerm FullPerm)) (qpRange30 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv30 o_3@@0) o_3@@0)) (= (U_2_real (MapType2Select QPMask@8 o_3@@0 next)) (+ (U_2_real (MapType2Select ZeroMask o_3@@0 next)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select g (invRecv30 o_3@@0))) (< NoPerm FullPerm)) (qpRange30 o_3@@0))) (= (U_2_real (MapType2Select QPMask@8 o_3@@0 next)) (U_2_real (MapType2Select ZeroMask o_3@@0 next))))))
 :qid |stdinbpl.2817:22|
 :skolemid |308|
 :pattern ( (MapType2Select QPMask@8 o_3@@0 next))
))) (and (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 next))) (= (U_2_real (MapType2Select ZeroMask o_3@@1 f_5)) (U_2_real (MapType2Select QPMask@8 o_3@@1 f_5))))))
 :qid |stdinbpl.2821:29|
 :skolemid |309|
 :pattern ( (MapType2Select ZeroMask o_3@@1 f_5))
 :pattern ( (MapType2Select QPMask@8 o_3@@1 f_5))
...
(let ((anon43_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (not (U_2_bool (MapType0Select g null)))) (and (=> (= (ControlFlow 0 54) 39) anon44_Then_correct) (=> (= (ControlFlow 0 54) 52) anon44_Else_correct)))))
(let ((anon35_correct true))
(let ((anon54_Else_correct  (=> (and (not (and (U_2_bool (MapType0Select g n$2_2)) (not (= (MapType1Select Heap@@13 n$2_2 next) null)))) (= (ControlFlow 0 32) 29)) anon35_correct)))
(let ((anon54_Then_correct  (=> (and (U_2_bool (MapType0Select g n$2_2)) (not (= (MapType1Select Heap@@13 n$2_2 next) null))) (and (=> (= (ControlFlow 0 30) (- 0 31)) (U_2_bool (MapType0Select g (MapType1Select Heap@@13 n$2_2 next)))) (=> (U_2_bool (MapType0Select g (MapType1Select Heap@@13 n$2_2 next))) (=> (= (ControlFlow 0 30) 29) anon35_correct))))))
(let ((anon53_Else_correct  (=> (and (forall ((n$2_3_1 T@U) ) (!  (=> (= (type n$2_3_1) RefType) (=> (and (U_2_bool (MapType0Select g n$2_3_1)) (not (= (MapType1Select Heap@@13 n$2_3_1 next) null))) (U_2_bool (MapType0Select g (MapType1Select Heap@@13 n$2_3_1 next)))))
 :qid |stdinbpl.3183:20|
 :skolemid |347|
 :pattern ( (MapType0Select g (MapType1Select Heap@@13 n$2_3_1 next)))
 :pattern ( (MapType0Select g n$2_3_1) (MapType1Select Heap@@13 n$2_3_1 next))
)) (= (ControlFlow 0 28) (- 0 27))) (exists_path ($$ Heap@@13 g) u_1@@3 v_2@@6))))
(let ((anon52_Else_correct  (=> (apply_IND ($$ Heap@@13 g) (|Set#Singleton| u_1@@3) (inst_uReach_2 ($$ Heap@@13 g) u_1@@3)) (=> (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)) (and (=> (= (ControlFlow 0 33) (- 0 36)) (not (U_2_bool (MapType0Select g null)))) (=> (not (U_2_bool (MapType0Select g null))) (and (=> (= (ControlFlow 0 33) (- 0 35)) (forall ((n$1_2 T@U) (n$1_2_1 T@U) ) (!  (=> (and (= (type n$1_2) RefType) (= (type n$1_2_1) RefType)) (=> (and (and (and (and (not (= n$1_2 n$1_2_1)) (U_2_bool (MapType0Select g n$1_2))) (U_2_bool (MapType0Select g n$1_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_2 n$1_2_1))))
 :qid |stdinbpl.3142:17|
 :skolemid |341|
...
)) (and (=> (= (ControlFlow 0 33) (- 0 34)) (forall ((n$1_2@@1 T@U) ) (!  (=> (and (= (type n$1_2@@1) RefType) (U_2_bool (MapType0Select g n$1_2@@1))) (>= (U_2_real (MapType2Select QPMask@0 n$1_2@@1 next)) FullPerm))
 :qid |stdinbpl.3149:17|
 :skolemid |342|
 :pattern ( (MapType1Select Heap@@13 n$1_2@@1 next))
 :pattern ( (MapType2Select QPMask@7 n$1_2@@1 next))
 :pattern ( (MapType1Select Heap@@13 n$1_2@@1 next))
))) (=> (forall ((n$1_2@@2 T@U) ) (!  (=> (and (= (type n$1_2@@2) RefType) (U_2_bool (MapType0Select g n$1_2@@2))) (>= (U_2_real (MapType2Select QPMask@0 n$1_2@@2 next)) FullPerm))
 :qid |stdinbpl.3149:17|
 :skolemid |342|
 :pattern ( (MapType1Select Heap@@13 n$1_2@@2 next))
 :pattern ( (MapType2Select QPMask@7 n$1_2@@2 next))
 :pattern ( (MapType1Select Heap@@13 n$1_2@@2 next))
)) (=> (and (and (forall ((n$1_2@@3 T@U) ) (!  (=> (= (type n$1_2@@3) RefType) (=> (and (U_2_bool (MapType0Select g n$1_2@@3)) (< NoPerm FullPerm)) (and (qpRange32 n$1_2@@3) (= (invRecv32 n$1_2@@3) n$1_2@@3))))
 :qid |stdinbpl.3155:22|
 :skolemid |343|
 :pattern ( (MapType1Select Heap@@13 n$1_2@@3 next))
 :pattern ( (MapType2Select QPMask@7 n$1_2@@3 next))
 :pattern ( (MapType1Select Heap@@13 n$1_2@@3 next))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType0Select g (invRecv32 o_3@@2))) (and (< NoPerm FullPerm) (qpRange32 o_3@@2))) (= (invRecv32 o_3@@2) o_3@@2)))
 :qid |stdinbpl.3159:22|
 :skolemid |344|
 :pattern ( (invRecv32 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType0Select g (invRecv32 o_3@@3))) (and (< NoPerm FullPerm) (qpRange32 o_3@@3))) (and (= (invRecv32 o_3@@3) o_3@@3) (= (U_2_real (MapType2Select QPMask@7 o_3@@3 next)) (- (U_2_real (MapType2Select QPMask@0 o_3@@3 next)) FullPerm)))) (=> (not (and (U_2_bool (MapType0Select g (invRecv32 o_3@@3))) (and (< NoPerm FullPerm) (qpRange32 o_3@@3)))) (= (U_2_real (MapType2Select QPMask@7 o_3@@3 next)) (U_2_real (MapType2Select QPMask@0 o_3@@3 next))))))
 :qid |stdinbpl.3165:22|
 :skolemid |345|
 :pattern ( (MapType2Select QPMask@7 o_3@@3 next))
)) (forall ((o_3@@4 T@U) (f_5@@0 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_5@@0))))
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 next))) (= (U_2_real (MapType2Select QPMask@0 o_3@@4 f_5@@0)) (U_2_real (MapType2Select QPMask@7 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.3171:29|
 :skolemid |346|
 :pattern ( (MapType2Select QPMask@7 o_3@@4 f_5@@0))
...
(let ((anon52_Then_correct  (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((n_8 T@U) (n_8_1 T@U) ) (!  (=> (and (= (type n_8) RefType) (= (type n_8_1) RefType)) (=> (and (and (and (and (not (= n_8 n_8_1)) (U_2_bool (MapType0Select g n_8))) (U_2_bool (MapType0Select g n_8_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_8 n_8_1))))
 :qid |stdinbpl.3085:21|
 :skolemid |335|
...
)) (=> (= (ControlFlow 0 25) (- 0 24)) (forall ((n_8@@1 T@U) ) (!  (=> (and (= (type n_8@@1) RefType) (U_2_bool (MapType0Select g n_8@@1))) (>= (U_2_real (MapType2Select QPMask@0 n_8@@1 next)) FullPerm))
 :qid |stdinbpl.3092:21|
 :skolemid |336|
 :pattern ( (MapType1Select Heap@@13 n_8@@1 next))
 :pattern ( (MapType2Select QPMask@6 n_8@@1 next))
 :pattern ( (MapType1Select Heap@@13 n_8@@1 next))
)))))))
(let ((anon51_Then_correct  (and (=> (= (ControlFlow 0 22) (- 0 23)) (forall ((n_7 T@U) (n_7_1 T@U) ) (!  (=> (and (= (type n_7) RefType) (= (type n_7_1) RefType)) (=> (and (and (and (and (not (= n_7 n_7_1)) (U_2_bool (MapType0Select g n_7))) (U_2_bool (MapType0Select g n_7_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_7 n_7_1))))
 :qid |stdinbpl.3033:21|
 :skolemid |329|
...
)) (=> (= (ControlFlow 0 22) (- 0 21)) (forall ((n_7@@1 T@U) ) (!  (=> (and (= (type n_7@@1) RefType) (U_2_bool (MapType0Select g n_7@@1))) (>= (U_2_real (MapType2Select QPMask@0 n_7@@1 next)) FullPerm))
 :qid |stdinbpl.3040:21|
 :skolemid |330|
 :pattern ( (MapType1Select Heap@@13 n_7@@1 next))
 :pattern ( (MapType2Select QPMask@5 n_7@@1 next))
 :pattern ( (MapType1Select Heap@@13 n_7@@1 next))
)))))))
(let ((anon50_Else_correct  (=> (and (and (apply_IND_2 ($$ Heap@@13 g) (|Set#Singleton| w_2@@2) (inst_uReach_rev ($$ Heap@@13 g) v_2@@6)) (state Heap@@13 QPMask@0)) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0))) (and (and (=> (= (ControlFlow 0 37) 22) anon51_Then_correct) (=> (= (ControlFlow 0 37) 25) anon52_Then_correct)) (=> (= (ControlFlow 0 37) 33) anon52_Else_correct)))))
(let ((anon50_Then_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((n_6 T@U) (n_6_1 T@U) ) (!  (=> (and (= (type n_6) RefType) (= (type n_6_1) RefType)) (=> (and (and (and (and (not (= n_6 n_6_1)) (U_2_bool (MapType0Select g n_6))) (U_2_bool (MapType0Select g n_6_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_6 n_6_1))))
...
)) (=> (= (ControlFlow 0 19) (- 0 18)) (forall ((n_6@@1 T@U) ) (!  (=> (and (= (type n_6@@1) RefType) (U_2_bool (MapType0Select g n_6@@1))) (>= (U_2_real (MapType2Select QPMask@0 n_6@@1 next)) FullPerm))
 :qid |stdinbpl.2980:21|
 :skolemid |324|
 :pattern ( (MapType1Select Heap@@13 n_6@@1 next))
 :pattern ( (MapType2Select QPMask@4 n_6@@1 next))
 :pattern ( (MapType1Select Heap@@13 n_6@@1 next))
)))))))
(let ((anon49_Then_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((n_5 T@U) (n_5_1 T@U) ) (!  (=> (and (= (type n_5) RefType) (= (type n_5_1) RefType)) (=> (and (and (and (and (not (= n_5 n_5_1)) (U_2_bool (MapType0Select g n_5))) (U_2_bool (MapType0Select g n_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_5 n_5_1))))
 :qid |stdinbpl.2921:21|
 :skolemid |317|
 :pattern ( (neverTriggered33 n_5) (neverTriggered33 n_5_1))
))) (=> (forall ((n_5@@0 T@U) (n_5_1@@0 T@U) ) (!  (=> (and (= (type n_5@@0) RefType) (= (type n_5_1@@0) RefType)) (=> (and (and (and (and (not (= n_5@@0 n_5_1@@0)) (U_2_bool (MapType0Select g n_5@@0))) (U_2_bool (MapType0Select g n_5_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_5@@0 n_5_1@@0))))
 :qid |stdinbpl.2921:21|
 :skolemid |317|
 :pattern ( (neverTriggered33 n_5@@0) (neverTriggered33 n_5_1@@0))
)) (=> (= (ControlFlow 0 16) (- 0 15)) (forall ((n_5@@1 T@U) ) (!  (=> (and (= (type n_5@@1) RefType) (U_2_bool (MapType0Select g n_5@@1))) (>= (U_2_real (MapType2Select QPMask@0 n_5@@1 next)) FullPerm))
 :qid |stdinbpl.2928:21|
 :skolemid |318|
 :pattern ( (MapType1Select Heap@@13 n_5@@1 next))
 :pattern ( (MapType2Select QPMask@3 n_5@@1 next))
 :pattern ( (MapType1Select Heap@@13 n_5@@1 next))
)))))))
(let ((anon43_Else_correct  (=> (state Heap@@13 QPMask@0) (and (and (=> (= (ControlFlow 0 38) 16) anon49_Then_correct) (=> (= (ControlFlow 0 38) 19) anon50_Then_correct)) (=> (= (ControlFlow 0 38) 37) anon50_Else_correct)))))
(let ((anon42_Else_correct  (=> (and (exists_path ($$ Heap@@13 g) w_2@@2 v_2@@6) (state Heap@@13 QPMask@0)) (and (=> (= (ControlFlow 0 55) 54) anon43_Then_correct) (=> (= (ControlFlow 0 55) 38) anon43_Else_correct)))))
(let ((anon42_Then_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((n_3 T@U) (n_3_1 T@U) ) (!  (=> (and (= (type n_3) RefType) (= (type n_3_1) RefType)) (=> (and (and (and (and (not (= n_3 n_3_1)) (U_2_bool (MapType0Select g n_3))) (U_2_bool (MapType0Select g n_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3 n_3_1))))
 :qid |stdinbpl.2733:21|
 :skolemid |298|
 :pattern ( (neverTriggered29 n_3) (neverTriggered29 n_3_1))
))) (=> (forall ((n_3@@0 T@U) (n_3_1@@0 T@U) ) (!  (=> (and (= (type n_3@@0) RefType) (= (type n_3_1@@0) RefType)) (=> (and (and (and (and (not (= n_3@@0 n_3_1@@0)) (U_2_bool (MapType0Select g n_3@@0))) (U_2_bool (MapType0Select g n_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3@@0 n_3_1@@0))))
 :qid |stdinbpl.2733:21|
 :skolemid |298|
 :pattern ( (neverTriggered29 n_3@@0) (neverTriggered29 n_3_1@@0))
)) (=> (= (ControlFlow 0 13) (- 0 12)) (forall ((n_3@@1 T@U) ) (!  (=> (and (= (type n_3@@1) RefType) (U_2_bool (MapType0Select g n_3@@1))) (>= (U_2_real (MapType2Select QPMask@0 n_3@@1 next)) FullPerm))
 :qid |stdinbpl.2740:21|
 :skolemid |299|
 :pattern ( (MapType1Select Heap@@13 n_3@@1 next))
 :pattern ( (MapType2Select QPMask@2 n_3@@1 next))
 :pattern ( (MapType1Select Heap@@13 n_3@@1 next))
)))))))
(let ((anon41_Else_correct  (=> (and (exists_path ($$ Heap@@13 g) u_1@@3 w_2@@2) (state Heap@@13 QPMask@0)) (and (=> (= (ControlFlow 0 56) 13) anon42_Then_correct) (=> (= (ControlFlow 0 56) 55) anon42_Else_correct)))))
(let ((anon41_Then_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((n_2 T@U) (n_2_1 T@U) ) (!  (=> (and (= (type n_2) RefType) (= (type n_2_1) RefType)) (=> (and (and (and (and (not (= n_2 n_2_1)) (U_2_bool (MapType0Select g n_2))) (U_2_bool (MapType0Select g n_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_2 n_2_1))))
 :qid |stdinbpl.2677:21|
 :skolemid |292|
 :pattern ( (neverTriggered28 n_2) (neverTriggered28 n_2_1))
))) (=> (forall ((n_2@@0 T@U) (n_2_1@@0 T@U) ) (!  (=> (and (= (type n_2@@0) RefType) (= (type n_2_1@@0) RefType)) (=> (and (and (and (and (not (= n_2@@0 n_2_1@@0)) (U_2_bool (MapType0Select g n_2@@0))) (U_2_bool (MapType0Select g n_2_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_2@@0 n_2_1@@0))))
 :qid |stdinbpl.2677:21|
 :skolemid |292|
 :pattern ( (neverTriggered28 n_2@@0) (neverTriggered28 n_2_1@@0))
)) (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((n_2@@1 T@U) ) (!  (=> (and (= (type n_2@@1) RefType) (U_2_bool (MapType0Select g n_2@@1))) (>= (U_2_real (MapType2Select QPMask@0 n_2@@1 next)) FullPerm))
 :qid |stdinbpl.2684:21|
 :skolemid |293|
 :pattern ( (MapType1Select Heap@@13 n_2@@1 next))
 :pattern ( (MapType2Select QPMask@1 n_2@@1 next))
 :pattern ( (MapType1Select Heap@@13 n_2@@1 next))
)))))))
(let ((anon38_Else_correct  (=> (forall ((n$0_1 T@U) ) (!  (=> (= (type n$0_1) RefType) (=> (and (U_2_bool (MapType0Select g n$0_1)) (not (= (MapType1Select Heap@@13 n$0_1 next) null))) (U_2_bool (MapType0Select g (MapType1Select Heap@@13 n$0_1 next)))))
...
)) (=> (and (state Heap@@13 QPMask@0) (U_2_bool (MapType0Select g u_1@@3))) (=> (and (and (U_2_bool (MapType0Select g w_2@@2)) (U_2_bool (MapType0Select g v_2@@6))) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0))) (and (=> (= (ControlFlow 0 57) 10) anon41_Then_correct) (=> (= (ControlFlow 0 57) 56) anon41_Else_correct)))))))
(let ((anon7_correct true))
(let ((anon40_Else_correct  (=> (and (not (and (U_2_bool (MapType0Select g n$0_12)) (not (= (MapType1Select Heap@@13 n$0_12 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon40_Then_correct  (=> (and (U_2_bool (MapType0Select g n$0_12)) (not (= (MapType1Select Heap@@13 n$0_12 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 n$0_12 next)) (=> (HasDirectPerm QPMask@0 n$0_12 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon39_Else_correct  (=> (not (U_2_bool (MapType0Select g n$0_12))) (and (=> (= (ControlFlow 0 8) 3) anon40_Then_correct) (=> (= (ControlFlow 0 8) 5) anon40_Else_correct)))))
(let ((anon39_Then_correct  (=> (U_2_bool (MapType0Select g n$0_12)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm QPMask@0 n$0_12 next)) (=> (HasDirectPerm QPMask@0 n$0_12 next) (and (=> (= (ControlFlow 0 6) 3) anon40_Then_correct) (=> (= (ControlFlow 0 6) 5) anon40_Else_correct)))))))
(let ((anon37_Else_correct  (and (=> (= (ControlFlow 0 58) (- 0 59)) (forall ((n_1 T@U) (n_1_1 T@U) ) (!  (=> (and (= (type n_1) RefType) (= (type n_1_1) RefType)) (=> (and (and (and (and (not (= n_1 n_1_1)) (U_2_bool (MapType0Select g n_1))) (U_2_bool (MapType0Select g n_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1))))
 :qid |stdinbpl.2609:15|
 :skolemid |285|
 :no-pattern (type n_1)
...
)) (=> (and (forall ((n_1@@1 T@U) ) (!  (=> (= (type n_1@@1) RefType) (=> (and (U_2_bool (MapType0Select g n_1@@1)) (< NoPerm FullPerm)) (and (qpRange27 n_1@@1) (= (invRecv27 n_1@@1) n_1@@1))))
 :qid |stdinbpl.2615:22|
 :skolemid |286|
 :pattern ( (MapType1Select Heap@@13 n_1@@1 next))
 :pattern ( (MapType2Select QPMask@0 n_1@@1 next))
 :pattern ( (MapType1Select Heap@@13 n_1@@1 next))
)) (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (U_2_bool (MapType0Select g (invRecv27 o_3@@5))) (< NoPerm FullPerm)) (qpRange27 o_3@@5)) (= (invRecv27 o_3@@5) o_3@@5)))
 ...
 :pattern ( (MapType1Select Heap@@13 n_1@@2 next))
)) (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (U_2_bool (MapType0Select g (invRecv27 o_3@@6))) (< NoPerm FullPerm)) (qpRange27 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv27 o_3@@6) o_3@@6)) (= (U_2_real (MapType2Select QPMask@0 o_3@@6 next)) (+ (U_2_real (MapType2Select ZeroMask o_3@@6 next)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select g (invRecv27 o_3@@6))) (< NoPerm FullPerm)) (qpRange27 o_3@@6))) (= (U_2_real (MapType2Select QPMask@0 o_3@@6 next)) (U_2_real (MapType2Select ZeroMask o_3@@6 next))))))
 :qid |stdinbpl.2631:22|
 :skolemid |289|
 :pattern ( (MapType2Select QPMask@0 o_3@@6 next))
))) (and (forall ((o_3@@7 T@U) (f_5@@1 T@U) ) (! (let ((B@@13 (FieldTypeInv1 (type f_5@@1))))
(let ((A@@14 (FieldTypeInv0 (type f_5@@1))))
 (=> (and (and (= (type o_3@@7) RefType) (= (type f_5@@1) (FieldType A@@14 B@@13))) (not (= f_5@@1 next))) (= (U_2_real (MapType2Select ZeroMask o_3@@7 f_5@@1)) (U_2_real (MapType2Select QPMask@0 o_3@@7 f_5@@1))))))
 :qid |stdinbpl.2635:29|
 :skolemid |290|
 :pattern ( (MapType2Select ZeroMask o_3@@7 f_5@@1))
 :pattern ( (MapType2Select QPMask@0 o_3@@7 f_5@@1))
)) (state Heap@@13 QPMask@0))) (and (and (=> (= (ControlFlow 0 58) 57) anon38_Else_correct) (=> (= (ControlFlow 0 58) 6) anon39_Then_correct)) (=> (= (ControlFlow 0 58) 8) anon39_Else_correct))))))))
(let ((anon37_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType1Select Heap@@13 u_1@@3 $allocated)) (U_2_bool (MapType1Select Heap@@13 w_2@@2 $allocated))) (and (U_2_bool (MapType1Select Heap@@13 v_2@@6 $allocated)) (not (U_2_bool (MapType0Select g null))))) (and (=> (= (ControlFlow 0 60) 1) anon37_Then_correct) (=> (= (ControlFlow 0 60) 58) anon37_Else_correct))))))
