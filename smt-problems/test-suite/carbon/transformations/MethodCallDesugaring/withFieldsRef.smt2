...
(assert  (and (and (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type freshObj@0) RefType)) (= (type Heap@1) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type a_2) RefType)) (= (type Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id main)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 freshObj@0 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 freshObj@0 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (HasDirectPerm Mask@0 freshObj@0 f_7)) (=> (HasDirectPerm Mask@0 freshObj@0 f_7) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (U_2_int (MapType0Select Heap@1 freshObj@0 f_7)) 5)) (=> (= (U_2_int (MapType0Select Heap@1 freshObj@0 f_7)) 5) (=> (IdenticalOnKnownLocations Heap@1 ExhaleHeap@0 Mask@1) (=> (and (and (and (state ExhaleHeap@0 Mask@1) (= res 4)) (and (state ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1))) (and (and (> wildcard@0 NoPerm) (not (= freshObj@0 null))) (and (= Mask@2 (MapType1Store Mask@1 freshObj@0 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@1 freshObj@0 f_7)) wildcard@0)))) (state ExhaleHeap@0 Mask@2)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@2 freshObj@0 f_7)) (=> (HasDirectPerm Mask@2 freshObj@0 f_7) (=> (= (U_2_int (MapType0Select ExhaleHeap@0 freshObj@0 f_7)) res) (=> (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@2 freshObj@0 f_7)) (=> (HasDirectPerm Mask@2 freshObj@0 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (MapType0Select ExhaleHeap@0 freshObj@0 f_7)) res)))))))))))))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7))) (=> (= (ControlFlow 0 7) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 a_2 $allocated))) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@9 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@9 freshObj@0 $allocated (bool_2_U true)))) (and (= Mask@0 (MapType1Store ZeroMask freshObj@0 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 f_7)) FullPerm)))) (state Heap@0 Mask@0))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7))) (=> (and (= Heap@1 (MapType0Store Heap@0 freshObj@0 f_7 (int_2_U 5))) (state Heap@1 Mask@0)) (and (=> (= (ControlFlow 0 10) 7) anon3_Then_correct) (=> (= (ControlFlow 0 10) 9) anon3_Else_correct)))))))))
