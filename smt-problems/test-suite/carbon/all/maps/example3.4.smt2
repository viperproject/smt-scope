...
(declare-fun k () Int)
(assert  (and (= (type Heap@@9) (MapType1Type RefType)) (= (type m@@23) (MapType intType boolType))))
(set-info :boogie-vc-id test5)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U k))) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (not (|Set#Equal| (|Map#Values| m@@23) (|Set#Empty| boolType)))))))
