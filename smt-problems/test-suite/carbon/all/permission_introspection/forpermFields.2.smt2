...
(declare-fun r_24 () T@U)
(declare-fun Mask@0 () T@U)
(declare-fun r_23 () T@U)
(declare-fun r1 () T@U)
(declare-fun r2 () T@U)
(assert  (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type r_23) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type r_24) RefType)) (= (type r1) RefType)) (= (type r2) RefType)))
(set-info :boogie-vc-id permOnlyOneField2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 25) (let ((anon9_correct true))
(let ((anon16_Else_correct  (=> (and (>= 0 (U_2_int (MapType0Select Heap@@9 r_24 f1))) (= (ControlFlow 0 17) 12)) anon9_correct)))
(let ((anon16_Then_correct  (=> (> (U_2_int (MapType0Select Heap@@9 r_24 f1)) 0) (and (=> (= (ControlFlow 0 14) (- 0 16)) (HasDirectPerm Mask@0 r_24 f2)) (=> (HasDirectPerm Mask@0 r_24 f2) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm Mask@0 r_24 f2)) (=> (HasDirectPerm Mask@0 r_24 f2) (=> (= (ControlFlow 0 14) 12) anon9_correct))))))))
(let ((anon15_Then_correct  (=> (HasDirectPerm Mask@0 r_24 f2) (and (=> (= (ControlFlow 0 18) (- 0 20)) (HasDirectPerm Mask@0 r_24 f2)) (=> (HasDirectPerm Mask@0 r_24 f2) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm Mask@0 r_24 f1)) (=> (HasDirectPerm Mask@0 r_24 f1) (and (=> (= (ControlFlow 0 18) 14) anon16_Then_correct) (=> (= (ControlFlow 0 18) 17) anon16_Else_correct)))))))))
(let ((anon15_Else_correct  (=> (and (not (HasDirectPerm Mask@0 r_24 f2)) (= (ControlFlow 0 13) 12)) anon9_correct)))
(let ((anon14_Else_correct  (=> (= (ControlFlow 0 11) (- 0 10)) (forall ((r_3 T@U) ) (!  (=> (and (= (type r_3) RefType) (HasDirectPerm Mask@0 r_3 f2)) (and (> (U_2_int (MapType0Select Heap@@9 r_3 f1)) 0) (>= (U_2_int (MapType0Select Heap@@9 r_3 f2)) (U_2_int (MapType0Select Heap@@9 r_3 f2)))))
 :qid |stdinbpl.828:15|
 :skolemid |40|
 :pattern ( (MapType1Select Mask@0 r_3 f2))
 :pattern ( (MapType0Select Heap@@9 r_3 f2))
)))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((r_1_1 T@U) ) (!  (=> (and (= (type r_1_1) RefType) (HasDirectPerm Mask@0 r_1_1 f1)) (and (> (U_2_int (MapType0Select Heap@@9 r_1_1 f1)) 0) (>= (U_2_int (MapType0Select Heap@@9 r_1_1 f2)) (U_2_int (MapType0Select Heap@@9 r_1_1 f2)))))
 :qid |stdinbpl.801:15|
 :skolemid |39|
 :pattern ( (MapType1Select Mask@0 r_1_1 f1))
 :pattern ( (MapType0Select Heap@@9 r_1_1 f1))
))) (=> (forall ((r_1_1@@0 T@U) ) (!  (=> (and (= (type r_1_1@@0) RefType) (HasDirectPerm Mask@0 r_1_1@@0 f1)) (and (> (U_2_int (MapType0Select Heap@@9 r_1_1@@0 f1)) 0) (>= (U_2_int (MapType0Select Heap@@9 r_1_1@@0 f2)) (U_2_int (MapType0Select Heap@@9 r_1_1@@0 f2)))))
 :qid |stdinbpl.801:15|
 :skolemid |39|
 :pattern ( (MapType1Select Mask@0 r_1_1@@0 f1))
 :pattern ( (MapType0Select Heap@@9 r_1_1@@0 f1))
)) (=> (state Heap@@9 Mask@0) (and (and (=> (= (ControlFlow 0 21) 11) anon14_Else_correct) (=> (= (ControlFlow 0 21) 18) anon15_Then_correct)) (=> (= (ControlFlow 0 21) 13) anon15_Else_correct)))))))
(let ((anon4_correct true))
(let ((anon13_Else_correct  (=> (and (>= 0 (U_2_int (MapType0Select Heap@@9 r_23 f1))) (= (ControlFlow 0 6) 1)) anon4_correct)))
(let ((anon13_Then_correct  (=> (> (U_2_int (MapType0Select Heap@@9 r_23 f1)) 0) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm Mask@0 r_23 f2)) (=> (HasDirectPerm Mask@0 r_23 f2) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm Mask@0 r_23 f2)) (=> (HasDirectPerm Mask@0 r_23 f2) (=> (= (ControlFlow 0 3) 1) anon4_correct))))))))
(let ((anon12_Then_correct  (=> (HasDirectPerm Mask@0 r_23 f1) (and (=> (= (ControlFlow 0 7) (- 0 9)) (HasDirectPerm Mask@0 r_23 f1)) (=> (HasDirectPerm Mask@0 r_23 f1) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm Mask@0 r_23 f1)) (=> (HasDirectPerm Mask@0 r_23 f1) (and (=> (= (ControlFlow 0 7) 3) anon13_Then_correct) (=> (= (ControlFlow 0 7) 6) anon13_Else_correct)))))))))
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm Mask@0 r_23 f1)) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 r1 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@9 r2 $allocated)) (not (= r1 null))) (and (= Mask@0 (MapType1Store ZeroMask r1 f1 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r1 f1)) FullPerm)))) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (HasDirectPerm Mask@0 r1 f1)) (=> (HasDirectPerm Mask@0 r1 f1) (=> (> (U_2_int (MapType0Select Heap@@9 r1 f1)) 0) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (and (=> (= (ControlFlow 0 23) 21) anon11_Else_correct) (=> (= (ControlFlow 0 23) 7) anon12_Then_correct)) (=> (= (ControlFlow 0 23) 2) anon12_Else_correct))))))))))
