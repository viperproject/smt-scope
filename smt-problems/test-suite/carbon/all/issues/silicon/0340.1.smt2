...
(assert  (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@26 T@U) ) (! (= (type (invRecv2 arg0@@26)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (not (= r_1 r_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1 r_1_1))))
 :qid |stdinbpl.318:15|
 :skolemid |28|
 :no-pattern (type r_1)
...
)) (=> (forall ((r_1@@1 T@U) ) (!  (=> (and (= (type r_1@@1) RefType) (< NoPerm FullPerm)) (and (qpRange2 r_1@@1) (= (invRecv2 r_1@@1) r_1@@1)))
 :qid |stdinbpl.324:22|
 :skolemid |29|
 :pattern ( (MapType0Select Heap@@9 r_1@@1 next))
 :pattern ( (MapType1Select QPMask@0 r_1@@1 next))
 :pattern ( (MapType0Select Heap@@9 r_1@@1 next))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (< NoPerm FullPerm) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.328:22|
 :skolemid |30|
 ...
 :pattern ( (MapType0Select Heap@@9 r_1@@2 next))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (< NoPerm FullPerm) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 next)) FullPerm)))) (=> (not (and (< NoPerm FullPerm) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (U_2_real (MapType1Select ZeroMask o_3@@0 next))))))
 :qid |stdinbpl.340:22|
 :skolemid |32|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 null next)) (=> (HasDirectPerm QPMask@0 null next) (=> (and (and (= (MapType0Select Heap@@9 null next) null) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (= (ControlFlow 0 3) (- 0 2)))) false))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 6) 1) anon3_Then_correct) (=> (= (ControlFlow 0 6) 3) anon3_Else_correct)))))
