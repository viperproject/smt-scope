...
(declare-fun S@0 () T@U)
(declare-fun B@0 () T@U)
(assert  (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type diz) RefType)) (= (type L@0) (SeqType intType))) (= (type S@0) (MapType2Type intType boolType))) (= (type B@0) (MultiSetType intType))))
(set-info :boogie-vc-id Ref__types)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (and (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 diz $allocated))) (and (not (= diz null)) (state Heap@@9 ZeroMask))) (and (and (>= current_thread_id 0) (state Heap@@9 ZeroMask)) (and (= L@0 (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 1)) (|Seq#Singleton| (int_2_U 2))) (|Seq#Singleton| (int_2_U 3)))) (state Heap@@9 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (|Seq#Equal| L@0 (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 1)) (|Seq#Singleton| (int_2_U 2))) (|Seq#Singleton| (int_2_U 3))))) (=> (|Seq#Equal| L@0 (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 1)) (|Seq#Singleton| (int_2_U 2))) (|Seq#Singleton| (int_2_U 3)))) (=> (state Heap@@9 ZeroMask) (=> (and (= S@0 (|Set#UnionOne| (|Set#UnionOne| (|Set#Singleton| (int_2_U 3)) (int_2_U 2)) (int_2_U 1))) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#Equal| S@0 (|Set#UnionOne| (|Set#UnionOne| (|Set#Singleton| (int_2_U 3)) (int_2_U 1)) (int_2_U 2)))) (=> (|Set#Equal| S@0 (|Set#UnionOne| (|Set#UnionOne| (|Set#Singleton| (int_2_U 3)) (int_2_U 1)) (int_2_U 2))) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#Equal| S@0 (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| (|Set#Singleton| (int_2_U 3)) (int_2_U 3)) (int_2_U 2)) (int_2_U 1)) (int_2_U 1)))) (=> (|Set#Equal| S@0 (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| (|Set#Singleton| (int_2_U 3)) (int_2_U 3)) (int_2_U 2)) (int_2_U 1)) (int_2_U 1))) (=> (state Heap@@9 ZeroMask) (=> (and (= B@0 (|MultiSet#UnionOne| (|MultiSet#UnionOne| (|MultiSet#UnionOne| (|MultiSet#Singleton| (int_2_U 3)) (int_2_U 2)) (int_2_U 1)) (int_2_U 1))) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|MultiSet#Equal| B@0 (|MultiSet#UnionOne| (|MultiSet#UnionOne| (|MultiSet#UnionOne| (|MultiSet#Singleton| (int_2_U 3)) (int_2_U 2)) (int_2_U 1)) (int_2_U 1)))) (=> (|MultiSet#Equal| B@0 (|MultiSet#UnionOne| (|MultiSet#UnionOne| (|MultiSet#UnionOne| (|MultiSet#Singleton| (int_2_U 3)) (int_2_U 2)) (int_2_U 1)) (int_2_U 1))) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (|MultiSet#Select| B@0 (int_2_U 1)) 2))))))))))))))))))
