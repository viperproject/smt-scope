...
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 i_13) (< i_13 (len a_3@@1)))) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon12_Then_correct  (=> (and (<= 0 i_13) (< i_13 (len a_3@@1))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 (loc a_3@@1 i_13) val)) (=> (HasDirectPerm QPMask@0 (loc a_3@@1 i_13) val) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
