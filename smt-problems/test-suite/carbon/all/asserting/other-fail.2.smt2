...
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select ZeroMask r_1 x@@8)))) (=> (<= FullPerm (U_2_real (MapType1Select ZeroMask r_1 x@@8))) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))
