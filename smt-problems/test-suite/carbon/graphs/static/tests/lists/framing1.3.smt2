...
(assert  (and (and (and (and (and (and (and (= (type g@@15) (MapType2Type RefType boolType)) (= (type n$0_1) RefType)) (= (type Heap@@35) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type QPMask@3) (MapType1Type RefType realType))) (forall ((arg0@@59 T@U) ) (! (= (type (invRecv16 arg0@@59)) RefType)
 :qid |funType:invRecv16|
 :pattern ( (invRecv16 arg0@@59))
))))
(set-info :boogie-vc-id |acyclic_list_segment#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon25_Then_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((n_7 T@U) (n_7_1 T@U) ) (!  (=> (and (= (type n_7) RefType) (= (type n_7_1) RefType)) (=> (and (and (and (and (not (= n_7 n_7_1)) (U_2_bool (MapType2Select g@@15 n_7))) (U_2_bool (MapType2Select g@@15 n_7_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_7 n_7_1))))
 :qid |stdinbpl.2303:25|
 :skolemid |268|
 :pattern ( (neverTriggered19 n_7) (neverTriggered19 n_7_1))
))) (=> (forall ((n_7@@0 T@U) (n_7_1@@0 T@U) ) (!  (=> (and (= (type n_7@@0) RefType) (= (type n_7_1@@0) RefType)) (=> (and (and (and (and (not (= n_7@@0 n_7_1@@0)) (U_2_bool (MapType2Select g@@15 n_7@@0))) (U_2_bool (MapType2Select g@@15 n_7_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_7@@0 n_7_1@@0))))
 :qid |stdinbpl.2303:25|
 :skolemid |268|
 :pattern ( (neverTriggered19 n_7@@0) (neverTriggered19 n_7_1@@0))
)) (=> (= (ControlFlow 0 19) (- 0 18)) (forall ((n_7@@1 T@U) ) (!  (=> (and (= (type n_7@@1) RefType) (U_2_bool (MapType2Select g@@15 n_7@@1))) (>= (U_2_real (MapType1Select QPMask@0 n_7@@1 next)) FullPerm))
 :qid |stdinbpl.2310:25|
 :skolemid |269|
 :pattern ( (MapType0Select Heap@@35 n_7@@1 next))
 :pattern ( (MapType1Select QPMask@3 n_7@@1 next))
 :pattern ( (MapType0Select Heap@@35 n_7@@1 next))
)))))))
(let ((anon23_Then_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((n_6 T@U) (n_6_1 T@U) ) (!  (=> (and (= (type n_6) RefType) (= (type n_6_1) RefType)) (=> (and (and (and (and (not (= n_6 n_6_1)) (U_2_bool (MapType2Select g@@15 n_6))) (U_2_bool (MapType2Select g@@15 n_6_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_6 n_6_1))))
 :qid |stdinbpl.2250:23|
 :skolemid |262|
 :pattern ( (neverTriggered18 n_6) (neverTriggered18 n_6_1))
))) (=> (forall ((n_6@@0 T@U) (n_6_1@@0 T@U) ) (!  (=> (and (= (type n_6@@0) RefType) (= (type n_6_1@@0) RefType)) (=> (and (and (and (and (not (= n_6@@0 n_6_1@@0)) (U_2_bool (MapType2Select g@@15 n_6@@0))) (U_2_bool (MapType2Select g@@15 n_6_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_6@@0 n_6_1@@0))))
 :qid |stdinbpl.2250:23|
 :skolemid |262|
 :pattern ( (neverTriggered18 n_6@@0) (neverTriggered18 n_6_1@@0))
)) (=> (= (ControlFlow 0 15) (- 0 14)) (forall ((n_6@@1 T@U) ) (!  (=> (and (= (type n_6@@1) RefType) (U_2_bool (MapType2Select g@@15 n_6@@1))) (>= (U_2_real (MapType1Select QPMask@0 n_6@@1 next)) FullPerm))
 :qid |stdinbpl.2257:23|
 :skolemid |263|
 :pattern ( (MapType0Select Heap@@35 n_6@@1 next))
 :pattern ( (MapType1Select QPMask@2 n_6@@1 next))
 :pattern ( (MapType0Select Heap@@35 n_6@@1 next))
)))))))
(let ((anon16_correct true))
(let ((anon24_Then_correct  (=> (func_graph ($$ Heap@@35 g@@15)) (and (=> (= (ControlFlow 0 21) 19) anon25_Then_correct) (=> (= (ControlFlow 0 21) 12) anon16_correct)))))
(let ((anon24_Else_correct  (=> (and (not (func_graph ($$ Heap@@35 g@@15))) (= (ControlFlow 0 17) 12)) anon16_correct)))
(let ((anon22_Then_correct  (=> (acyclic_graph ($$ Heap@@35 g@@15)) (and (and (=> (= (ControlFlow 0 22) 15) anon23_Then_correct) (=> (= (ControlFlow 0 22) 21) anon24_Then_correct)) (=> (= (ControlFlow 0 22) 17) anon24_Else_correct)))))
(let ((anon22_Else_correct  (=> (and (not (acyclic_graph ($$ Heap@@35 g@@15))) (= (ControlFlow 0 13) 12)) anon16_correct)))
(let ((anon21_Then_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((n_5 T@U) (n_5_1 T@U) ) (!  (=> (and (= (type n_5) RefType) (= (type n_5_1) RefType)) (=> (and (and (and (and (not (= n_5 n_5_1)) (U_2_bool (MapType2Select g@@15 n_5))) (U_2_bool (MapType2Select g@@15 n_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_5 n_5_1))))
 :qid |stdinbpl.2197:21|
 :skolemid |256|
 :pattern ( (neverTriggered17 n_5) (neverTriggered17 n_5_1))
))) (=> (forall ((n_5@@0 T@U) (n_5_1@@0 T@U) ) (!  (=> (and (= (type n_5@@0) RefType) (= (type n_5_1@@0) RefType)) (=> (and (and (and (and (not (= n_5@@0 n_5_1@@0)) (U_2_bool (MapType2Select g@@15 n_5@@0))) (U_2_bool (MapType2Select g@@15 n_5_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_5@@0 n_5_1@@0))))
 :qid |stdinbpl.2197:21|
 :skolemid |256|
 :pattern ( (neverTriggered17 n_5@@0) (neverTriggered17 n_5_1@@0))
)) (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((n_5@@1 T@U) ) (!  (=> (and (= (type n_5@@1) RefType) (U_2_bool (MapType2Select g@@15 n_5@@1))) (>= (U_2_real (MapType1Select QPMask@0 n_5@@1 next)) FullPerm))
 :qid |stdinbpl.2204:21|
 :skolemid |257|
 :pattern ( (MapType0Select Heap@@35 n_5@@1 next))
 :pattern ( (MapType1Select QPMask@1 n_5@@1 next))
 :pattern ( (MapType0Select Heap@@35 n_5@@1 next))
)))))))
(let ((anon18_Else_correct  (=> (and (forall ((n$0_3 T@U) ) (!  (=> (= (type n$0_3) RefType) (=> (and (U_2_bool (MapType2Select g@@15 n$0_3)) (not (= (MapType0Select Heap@@35 n$0_3 next) null))) (U_2_bool (MapType2Select g@@15 (MapType0Select Heap@@35 n$0_3 next)))))
 :qid |stdinbpl.2177:20|
 :skolemid |255|
 :pattern ( (MapType2Select g@@15 (MapType0Select Heap@@35 n$0_3 next)))
 :pattern ( (MapType2Select g@@15 n$0_3) (MapType0Select Heap@@35 n$0_3 next))
)) (state Heap@@35 QPMask@0)) (and (and (=> (= (ControlFlow 0 23) 10) anon21_Then_correct) (=> (= (ControlFlow 0 23) 22) anon22_Then_correct)) (=> (= (ControlFlow 0 23) 13) anon22_Else_correct)))))
(let ((anon7_correct true))
(let ((anon20_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g@@15 n$0_1)) (not (= (MapType0Select Heap@@35 n$0_1 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon20_Then_correct  (=> (and (U_2_bool (MapType2Select g@@15 n$0_1)) (not (= (MapType0Select Heap@@35 n$0_1 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 n$0_1 next)) (=> (HasDirectPerm QPMask@0 n$0_1 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon19_Else_correct  (=> (not (U_2_bool (MapType2Select g@@15 n$0_1))) (and (=> (= (ControlFlow 0 8) 3) anon20_Then_correct) (=> (= (ControlFlow 0 8) 5) anon20_Else_correct)))))
(let ((anon19_Then_correct  (=> (U_2_bool (MapType2Select g@@15 n$0_1)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm QPMask@0 n$0_1 next)) (=> (HasDirectPerm QPMask@0 n$0_1 next) (and (=> (= (ControlFlow 0 6) 3) anon20_Then_correct) (=> (= (ControlFlow 0 6) 5) anon20_Else_correct)))))))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 24) (- 0 25)) (forall ((n_4 T@U) (n_4_1 T@U) ) (!  (=> (and (= (type n_4) RefType) (= (type n_4_1) RefType)) (=> (and (and (and (and (not (= n_4 n_4_1)) (U_2_bool (MapType2Select g@@15 n_4))) (U_2_bool (MapType2Select g@@15 n_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4 n_4_1))))
 :qid |stdinbpl.2132:15|
 :skolemid |249|
 :no-pattern (type n_4)
...
))) (=> (forall ((n_4@@0 T@U) (n_4_1@@0 T@U) ) (!  (=> (and (= (type n_4@@0) RefType) (= (type n_4_1@@0) RefType)) (=> (and (and (and (and (not (= n_4@@0 n_4_1@@0)) (U_2_bool (MapType2Select g@@15 n_4@@0))) (U_2_bool (MapType2Select g@@15 n_4_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_4@@0 n_4_1@@0))))
 :qid |stdinbpl.2132:15|
 :skolemid |249|
...
)) (=> (and (forall ((n_4@@1 T@U) ) (!  (=> (= (type n_4@@1) RefType) (=> (and (U_2_bool (MapType2Select g@@15 n_4@@1)) (< NoPerm FullPerm)) (and (qpRange16 n_4@@1) (= (invRecv16 n_4@@1) n_4@@1))))
 :qid |stdinbpl.2138:22|
 :skolemid |250|
 :pattern ( (MapType0Select Heap@@35 n_4@@1 next))
 :pattern ( (MapType1Select QPMask@0 n_4@@1 next))
 :pattern ( (MapType0Select Heap@@35 n_4@@1 next))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select g@@15 (invRecv16 o_3))) (< NoPerm FullPerm)) (qpRange16 o_3)) (= (invRecv16 o_3) o_3)))
 :qid |stdinbpl.2142:22|
 :skolemid |251|
 :pattern ( (invRecv16 o_3))
))) (=> (and (and (forall ((n_4@@2 T@U) ) (!  (=> (and (= (type n_4@@2) RefType) (U_2_bool (MapType2Select g@@15 n_4@@2))) (not (= n_4@@2 null)))
 :qid |stdinbpl.2148:22|
 :skolemid |252|
 :pattern ( (MapType0Select Heap@@35 n_4@@2 next))
 :pattern ( (MapType1Select QPMask@0 n_4@@2 next))
 :pattern ( (MapType0Select Heap@@35 n_4@@2 next))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select g@@15 (invRecv16 o_3@@0))) (< NoPerm FullPerm)) (qpRange16 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv16 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 next)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select g@@15 (invRecv16 o_3@@0))) (< NoPerm FullPerm)) (qpRange16 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (U_2_real (MapType1Select ZeroMask o_3@@0 next))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.2158:29|
 :skolemid |254|
 :pattern ( (MapType1Select ZeroMask o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
)) (state Heap@@35 QPMask@0))) (and (and (=> (= (ControlFlow 0 24) 23) anon18_Else_correct) (=> (= (ControlFlow 0 24) 6) anon19_Then_correct)) (=> (= (ControlFlow 0 24) 8) anon19_Else_correct))))))))
(let ((anon17_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@35 ZeroMask) (=> (and (= AssumeFunctionsAbove 3) (not (U_2_bool (MapType2Select g@@15 null)))) (and (=> (= (ControlFlow 0 26) 1) anon17_Then_correct) (=> (= (ControlFlow 0 26) 24) anon17_Else_correct))))))
