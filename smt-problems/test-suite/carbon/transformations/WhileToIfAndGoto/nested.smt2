...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon12_Else_correct  (=> (and (and (and (not j@1) (state Heap@@9 ZeroMask)) (and (<= i@0 5) (state Heap@@9 ZeroMask))) (and (and (state Heap@@9 ZeroMask) (= i@1 (+ i@0 1))) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 8) (- 0 7))))) (<= i@1 5))))
(let ((anon12_Then_correct  (=> (state Heap@@9 ZeroMask) (=> (and (<= i@0 5) (state Heap@@9 ZeroMask)) (=> (and (and j@1 (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 6) (- 0 5)))) (<= i@0 5))))))
(let ((anon11_Then_correct true))
(let ((anon10_Then_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (<= i@0 5) (state Heap@@9 ZeroMask)) (and (< i@0 5) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= i@0 5)) (=> (<= i@0 5) (and (and (=> (= (ControlFlow 0 9) 4) anon11_Then_correct) (=> (= (ControlFlow 0 9) 6) anon12_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon12_Else_correct))))))))
(let ((anon10_Else_correct  (=> (and (not (< i@0 5)) (state Heap@@9 ZeroMask)) (=> (and (and (<= i@0 5) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 3) (- 0 2)))) (= i@0 5)))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= 1 5)) (=> (<= 1 5) (and (and (=> (= (ControlFlow 0 11) 1) anon9_Then_correct) (=> (= (ControlFlow 0 11) 9) anon10_Then_correct)) (=> (= (ControlFlow 0 11) 3) anon10_Else_correct))))))))
