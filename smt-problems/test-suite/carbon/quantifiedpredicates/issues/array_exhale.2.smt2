...
(assert  (and (and (= (type QPMask@0) (MapType1Type RefType realType)) (= (type a_3@@8) IArrayDomainTypeType)) (= (type Heap@@10) (MapType0Type RefType))))
...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p_1 a_3@@8 1))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p_1 a_3@@8 1)))) (=> (= (ControlFlow 0 4) 3) anon6_correct))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_3@@8 a_3@@8)) (not (= (+ i_1 1) (+ i_1_1 1)))))
...
)) (=> (forall ((i_1@@1 T@U) ) (!  (=> (= (type i_1@@1) intType) (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) i_1@@1) (< NoPerm FullPerm)) (and (= (invRecv7 a_3@@8 (+ (U_2_int i_1@@1) 1)) (U_2_int i_1@@1)) (qpRange7 a_3@@8 (+ (U_2_int i_1@@1) 1)))))
 :qid |stdinbpl.1122:22|
 :skolemid |105|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) i_1@@1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) i_1@@1))
)) (=> (and (forall ((a_1_1 T@U) (i_2_1 Int) ) (!  (=> (= (type a_1_1) IArrayDomainTypeType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv7 a_1_1 i_2_1))) (< NoPerm FullPerm)) (qpRange7 a_1_1 i_2_1)) (and (= a_3@@8 a_1_1) (= (+ (invRecv7 a_1_1 i_2_1) 1) i_2_1))))
 :qid |stdinbpl.1126:22|
 :skolemid |106|
 :pattern ( (invRecv7 a_1_1 i_2_1))
)) (forall ((a_1_1@@0 T@U) (i_2_1@@0 Int) ) (!  (=> (= (type a_1_1@@0) IArrayDomainTypeType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv7 a_1_1@@0 i_2_1@@0))) (< NoPerm FullPerm)) (qpRange7 a_1_1@@0 i_2_1@@0)) (and (=> (< NoPerm FullPerm) (and (= a_3@@8 a_1_1@@0) (= (+ (invRecv7 a_1_1@@0 i_2_1@@0) 1) i_2_1@@0))) (= (U_2_real (MapType1Select QPMask@0 null (p_1 a_1_1@@0 i_2_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (p_1 a_1_1@@0 i_2_1@@0))) FullPerm)))))
...
)) (forall ((a_1_1@@1 T@U) (i_2_1@@1 Int) ) (!  (=> (and (= (type a_1_1@@1) IArrayDomainTypeType) (not (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv7 a_1_1@@1 i_2_1@@1))) (< NoPerm FullPerm)) (qpRange7 a_1_1@@1 i_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (p_1 a_1_1@@1 i_2_1@@1))) (U_2_real (MapType1Select ZeroMask null (p_1 a_1_1@@1 i_2_1@@1)))))
 :qid |stdinbpl.1142:22|
 :skolemid |109|
 :pattern ( (MapType1Select QPMask@0 null (p_1 a_1_1@@1 i_2_1@@1)))
))) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0))) (and (and (=> (= (ControlFlow 0 7) 2) anon8_Then_correct) (=> (= (ControlFlow 0 7) 4) anon9_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (> n@@13 3) (state Heap@@10 ZeroMask)) (and (=> (= (ControlFlow 0 9) 1) anon7_Then_correct) (=> (= (ControlFlow 0 9) 7) anon7_Else_correct))))))
