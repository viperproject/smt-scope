...
(assert (exists ((k@1@01 Bool)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/transformations/DisjunctionToInhaleExhale/functionsRef.vpr@23@13@23@65-aux|)))
(assert (forall ((k@1@01 Bool)) (!
  (NonDet1%precondition $Snap.unit k@1@01)
  :pattern ((NonDet1%limited $Snap.unit k@1@01))
  :qid |prog./silicon/silver/src/test/resources/transformations/DisjunctionToInhaleExhale/functionsRef.vpr@23@13@23@65|)))
(assert (exists ((k@1@01 Bool)) (!
