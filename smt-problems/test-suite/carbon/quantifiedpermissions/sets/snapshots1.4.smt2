...
(assert  (and (and (= (type xs@@15) (MapType2Type RefType boolType)) (= (type Heap@@18) (MapType0Type RefType))) (= (type x@@35) RefType)))
(set-info :boogie-vc-id |P#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((z_2 T@U) (z_2_1 T@U) ) (!  (=> (and (= (type z_2) RefType) (= (type z_2_1) RefType)) (=> (and (and (and (and (not (= z_2 z_2_1)) (U_2_bool (MapType2Select xs@@15 z_2))) (U_2_bool (MapType2Select xs@@15 z_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_2 z_2_1))))
 :qid |stdinbpl.767:15|
 :skolemid |112|
 :no-pattern (type z_2)
 :no-pattern (type z_2_1)
 :no-pattern (U_2_int z_2)
 :no-pattern (U_2_bool z_2)
 :no-pattern (U_2_int z_2_1)
 :no-pattern (U_2_bool z_2_1)
)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@18 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@18 x@@35 $allocated)) (U_2_bool (MapType2Select xs@@15 x@@35)))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
