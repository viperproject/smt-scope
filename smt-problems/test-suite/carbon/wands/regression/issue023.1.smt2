...
(assert  (and (= (type Heap@@11) (MapType0Type RefType)) (= (type x@@20) RefType)))
(set-info :boogie-vc-id |Q#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 x@@20 $allocated))) (and (= perm@0 (/ (to_real 2) (to_real 3))) (= (ControlFlow 0 2) (- 0 1)))) (>= perm@0 NoPerm))))
