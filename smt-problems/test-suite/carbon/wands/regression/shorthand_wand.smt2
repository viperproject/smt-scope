...
(declare-fun xs () T@U)
(assert  (and (= (type Heap@@10) (MapType0Type RefType)) (= (type xs) RefType)))
(set-info :boogie-vc-id test04)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 xs $allocated)) (= (ControlFlow 0 2) (- 0 1))) (<= FullPerm (U_2_real (MapType1Select ZeroMask null (wand_1 true true))))))))
