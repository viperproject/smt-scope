...
(let ((anon17_Else_correct  (=> (and (> 1 n_1_1) (= (ControlFlow 0 12) 9)) anon10_correct)))
(let ((anon17_Then_correct  (=> (>= n_1_1 1) (and (=> (= (ControlFlow 0 10) (- 0 11)) (>= (fib Heap@@16 n_1_1) (fib Heap@@16 (+ n_1_1 1)))) (=> (>= (fib Heap@@16 n_1_1) (fib Heap@@16 (+ n_1_1 1))) (=> (= (ControlFlow 0 10) 9) anon10_correct))))))
(let ((anon15_Then_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (>= (+ n_1 1) 0))))
(let ((anon14_Then_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (>= n_1 0))))
(let ((anon6_correct true))
(let ((anon13_Then_correct  (=> (>= n_1 1) (and (and (=> (= (ControlFlow 0 8) 5) anon14_Then_correct) (=> (= (ControlFlow 0 8) 7) anon15_Then_correct)) (=> (= (ControlFlow 0 8) 2) anon6_correct)))))
(let ((anon13_Else_correct  (=> (and (> 1 n_1) (= (ControlFlow 0 3) 2)) anon6_correct)))
(let ((anon16_Else_correct true))
(let ((anon0_correct  (=> (and (state Heap@@16 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (and (and (and (=> (= (ControlFlow 0 13) 1) anon16_Else_correct) (=> (= (ControlFlow 0 13) 10) anon17_Then_correct)) (=> (= (ControlFlow 0 13) 12) anon17_Else_correct)) (=> (= (ControlFlow 0 13) 8) anon13_Then_correct)) (=> (= (ControlFlow 0 13) 3) anon13_Else_correct)))))
