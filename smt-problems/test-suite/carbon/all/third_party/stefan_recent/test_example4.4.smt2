...
(assert  (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type c) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type diz) RefType)))
(set-info :boogie-vc-id parameters__drop)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon4_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 c Counter__x (real_2_U (- (U_2_real (MapType1Select Mask@0 c Counter__x)) p_1)))) (= (ControlFlow 0 4) (- 0 3))) (<= p_1 p_1))))
(let ((anon6_Else_correct  (=> (and (= p_1 NoPerm) (= (ControlFlow 0 7) 4)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= p_1 NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= p_1 (U_2_real (MapType1Select Mask@0 c Counter__x)))) (=> (<= p_1 (U_2_real (MapType1Select Mask@0 c Counter__x))) (=> (= (ControlFlow 0 5) 4) anon4_correct))))))
(let ((anon5_Else_correct  (=> (state Heap@@9 Mask@0) (and (=> (= (ControlFlow 0 8) (- 0 11)) (not (= c null))) (=> (not (= c null)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (<= NoPerm p_1)) (=> (<= NoPerm p_1) (and (=> (= (ControlFlow 0 8) (- 0 9)) (>= p_1 NoPerm)) (=> (>= p_1 NoPerm) (and (=> (= (ControlFlow 0 8) 5) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))))))))
...
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 diz $allocated)) (U_2_bool (MapType0Select Heap@@9 c $allocated))) (=> (and (and (and (not (= diz null)) (state Heap@@9 ZeroMask)) (and (>= current_thread_id 0) (state Heap@@9 ZeroMask))) (and (and (not (= c null)) (state Heap@@9 ZeroMask)) (and (<= NoPerm p_1) (state Heap@@9 ZeroMask)))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (>= p_1 NoPerm)) (=> (>= p_1 NoPerm) (=> (and (and (=> (> p_1 NoPerm) (not (= c null))) (= Mask@0 (MapType1Store ZeroMask c Counter__x (real_2_U (+ (U_2_real (MapType1Select ZeroMask c Counter__x)) p_1))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 12) 2) anon5_Then_correct) (=> (= (ControlFlow 0 12) 8) anon5_Else_correct))))))))))
