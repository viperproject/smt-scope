...
(assert  (and (and (and (and (and (and (and (= (type WandDefLHSHeap@0) (MapType0Type RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type x@@8) RefType)) (= (type y@@1) RefType)) (= (type WandDefLHSHeap@1) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id n)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null (wand true (= (+ (U_2_int (MapType0Select Heap@@9 x@@8 f_7)) (U_2_int (MapType0Select Heap@@9 y@@1 f_7))) 4))))))))
(let ((anon6_Then_correct  (=> (and (state WandDefLHSHeap@1 ZeroMask) (state WandDefLHSHeap@1 ZeroMask)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@1 x@@8 f_7)) (=> (HasDirectPerm Mask@1 x@@8 f_7) (=> (= (ControlFlow 0 5) (- 0 4)) (HasDirectPerm Mask@1 y@@1 f_7)))))))
(let ((anon5_Else_correct  (=> (and (and (= Mask@2 (MapType1Store Mask@1 null (wand true (= (+ (U_2_int (MapType0Select Heap@@9 x@@8 f_7)) (U_2_int (MapType0Select Heap@@9 y@@1 f_7))) 4)) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (wand true (= (+ (U_2_int (MapType0Select Heap@@9 x@@8 f_7)) (U_2_int (MapType0Select Heap@@9 y@@1 f_7))) 4)))) FullPerm)))) (state Heap@@9 Mask@2)) (and (state Heap@@9 Mask@2) (state Heap@@9 Mask@2))) (and (=> (= (ControlFlow 0 9) 5) anon6_Then_correct) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct)))))
(let ((anon5_Then_correct  (=> (and (state WandDefLHSHeap@0 ZeroMask) (state WandDefLHSHeap@0 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 x@@8 f_7)) (=> (HasDirectPerm Mask@1 x@@8 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@1 y@@1 f_7)))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@9 y@@1 $allocated)) (not (= x@@8 null))) (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm)))) (state Heap@@9 Mask@0))) (and (and (not (= y@@1 null)) (= Mask@1 (MapType1Store Mask@0 y@@1 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@1 f_7)) FullPerm))))) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1)))) (and (=> (= (ControlFlow 0 10) 2) anon5_Then_correct) (=> (= (ControlFlow 0 10) 9) anon5_Else_correct))))))
