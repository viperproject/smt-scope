...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@13) (MapType1Type RefType realType)) (= (type Mask@12) (MapType1Type RefType realType))) (= (type freshObj@0) RefType)) (= (type Heap@17) (MapType0Type RefType))) (= (type Heap@16) (MapType0Type RefType))) (= (type Heap@15) (MapType0Type RefType))) (= (type newPMask@3) (MapType1Type RefType boolType))) (= (type Heap@13) (MapType0Type RefType))) (= (type Heap@12) (MapType0Type RefType))) (= (type Heap@14) (MapType0Type RefType))) (= (type freshVersion@1) FrameTypeType)) (= (type Mask@11) (MapType1Type RefType realType))) (= (type Mask@10) (MapType1Type RefType realType))) (forall ((arg0@@47 T@U) (arg1@@25 T@U) ) (! (= (type (CombineFrames arg0@@47 arg1@@25)) FrameTypeType)
...
))) (= (type Mask@9) (MapType1Type RefType realType))) (= (type Heap@8) (MapType0Type RefType))) (= (type Heap@9) (MapType0Type RefType))) (= (type Heap@10) (MapType0Type RefType))) (= (type newPMask@2) (MapType1Type RefType boolType))) (= (type Heap@11) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@6) (MapType0Type RefType))) (= (type Heap@7) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@8) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type newPMask@1) (MapType1Type RefType boolType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@7) (MapType1Type RefType realType))) (= (type UnfoldingHeap@4) (MapType0Type RefType))) (= (type UnfoldingMask@4) (MapType1Type RefType realType))) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type UnfoldingHeap@3) (MapType0Type RefType))) (= (type UnfoldingMask@3) (MapType1Type RefType realType))) (= (type UnfoldingHeap@0) (MapType0Type RefType))) (= (type UnfoldingHeap@1) (MapType0Type RefType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type UnfoldingHeap@2) (MapType0Type RefType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Heap@@38) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type this@@38) RefType)) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id create)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 62) (let ((anon4_correct true))
(let ((anon38_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 59) 56)) anon4_correct)))
(let ((anon38_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 57) (- 0 58)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (List this@@38))))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (List this@@38)))) (=> (= (ControlFlow 0 57) 56) anon4_correct))))))
(let ((anon37_Else_correct true))
(let ((anon36_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (= PostMask@0 (MapType1Store ZeroMask null (List this@@38) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (List this@@38))) FullPerm)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (and (=> (= (ControlFlow 0 60) 55) anon37_Else_correct) (=> (= (ControlFlow 0 60) 57) anon38_Then_correct)) (=> (= (ControlFlow 0 60) 59) anon38_Else_correct))))))
(let ((anon35_correct  (=> (and (= Mask@13 (MapType1Store Mask@12 null (List freshObj@0) (real_2_U (- (U_2_real (MapType1Select Mask@12 null (List freshObj@0))) FullPerm)))) (= (ControlFlow 0 2) (- 0 1))) (|Seq#Equal| (content Heap@17 freshObj@0) (|Seq#Empty| intType)))))
(let ((anon53_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon35_correct)))
(let ((anon53_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@12 null (List freshObj@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@12 null (List freshObj@0)))) (=> (= (ControlFlow 0 3) 2) anon35_correct))))))
(let ((anon33_correct  (=> (= Heap@16 (MapType0Store Heap@15 null (|List#sm| freshObj@0) (MapType1Store (MapType0Select Heap@15 null (|List#sm| freshObj@0)) freshObj@0 head (bool_2_U true)))) (=> (and (and (forall ((o_28 T@U) (f_32 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_32))))
(let ((A@@12 (FieldTypeInv0 (type f_32))))
 (=> (and (and (= (type o_28) RefType) (= (type f_32) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@16 null (|List#sm| freshObj@0)) o_28 f_32)) (U_2_bool (MapType1Select (MapType0Select Heap@16 null (|lseg#sm| (MapType0Select Heap@16 freshObj@0 head) null)) o_28 f_32)))) (U_2_bool (MapType1Select newPMask@3 o_28 f_32)))))
 :qid |stdinbpl.2286:27|
 :skolemid |126|
 :pattern ( (MapType1Select newPMask@3 o_28 f_32))
)) (= Heap@17 (MapType0Store Heap@16 null (|List#sm| freshObj@0) newPMask@3))) (and (state Heap@17 Mask@12) (state Heap@17 Mask@12))) (and (=> (= (ControlFlow 0 6) 3) anon53_Then_correct) (=> (= (ControlFlow 0 6) 5) anon53_Else_correct))))))
(let ((anon52_Else_correct  (=> (HasDirectPerm Mask@12 null (List freshObj@0)) (=> (and (= Heap@15 Heap@12) (= (ControlFlow 0 8) 6)) anon33_correct))))
(let ((anon52_Then_correct  (=> (not (HasDirectPerm Mask@12 null (List freshObj@0))) (=> (and (and (= Heap@13 (MapType0Store Heap@12 null (|List#sm| freshObj@0) ZeroPMask)) (= Heap@14 (MapType0Store Heap@13 null (List freshObj@0) freshVersion@1))) (and (= Heap@15 Heap@14) (= (ControlFlow 0 7) 6))) anon33_correct))))
(let ((anon31_correct  (=> (= Mask@11 (MapType1Store Mask@10 null (lseg (MapType0Select Heap@12 freshObj@0 head) null) (real_2_U (- (U_2_real (MapType1Select Mask@10 null (lseg (MapType0Select Heap@12 freshObj@0 head) null))) FullPerm)))) (=> (and (InsidePredicate (List freshObj@0) (MapType0Select Heap@12 null (List freshObj@0)) (lseg (MapType0Select Heap@12 freshObj@0 head) null) (MapType0Select Heap@12 null (lseg (MapType0Select Heap@12 freshObj@0 head) null))) (= Mask@12 (MapType1Store Mask@11 null (List freshObj@0) (real_2_U (+ (U_2_real (MapType1Select Mask@11 null (List freshObj@0))) FullPerm))))) (=> (and (and (state Heap@12 Mask@12) (state Heap@12 Mask@12)) (and (|List#trigger| Heap@12 (List freshObj@0)) (= (MapType0Select Heap@12 null (List freshObj@0)) (CombineFrames (FrameFragment (MapType0Select Heap@12 freshObj@0 head)) (MapType0Select Heap@12 null (lseg (MapType0Select Heap@12 freshObj@0 head) null)))))) (and (=> (= (ControlFlow 0 9) 7) anon52_Then_correct) (=> (= (ControlFlow 0 9) 8) anon52_Else_correct)))))))
(let ((anon51_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon31_correct)))
(let ((anon51_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@10 null (lseg (MapType0Select Heap@12 freshObj@0 head) null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@10 null (lseg (MapType0Select Heap@12 freshObj@0 head) null)))) (=> (= (ControlFlow 0 10) 9) anon31_correct))))))
(let ((anon29_correct  (=> (= Mask@10 (MapType1Store Mask@9 freshObj@0 head (real_2_U (- (U_2_real (MapType1Select Mask@9 freshObj@0 head)) FullPerm)))) (and (=> (= (ControlFlow 0 13) 10) anon51_Then_correct) (=> (= (ControlFlow 0 13) 12) anon51_Else_correct)))))
(let ((anon50_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 13)) anon29_correct)))
(let ((anon50_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (U_2_real (MapType1Select Mask@9 freshObj@0 head)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@9 freshObj@0 head))) (=> (= (ControlFlow 0 14) 13) anon29_correct))))))
(let ((anon27_correct  (=> (and (state Heap@12 Mask@9) (state Heap@12 Mask@9)) (and (=> (= (ControlFlow 0 17) 14) anon50_Then_correct) (=> (= (ControlFlow 0 17) 16) anon50_Else_correct)))))
(let ((anon49_Else_correct  (=> (= (MapType0Select Heap@8 freshObj@0 head) null) (=> (and (= Heap@12 Heap@8) (= (ControlFlow 0 19) 17)) anon27_correct))))
(let ((anon49_Then_correct  (=> (not (= (MapType0Select Heap@8 freshObj@0 head) null)) (=> (and (= Heap@9 (MapType0Store Heap@8 null (|lseg#sm| (MapType0Select Heap@8 freshObj@0 head) null) (MapType1Store (MapType0Select Heap@8 null (|lseg#sm| (MapType0Select Heap@8 freshObj@0 head) null)) (MapType0Select Heap@8 freshObj@0 head) data (bool_2_U true)))) (= Heap@10 (MapType0Store Heap@9 null (|lseg#sm| (MapType0Select Heap@9 freshObj@0 head) null) (MapType1Store (MapType0Select Heap@9 null (|lseg#sm| (MapType0Select Heap@9 freshObj@0 head) null)) (MapType0Select Heap@9 freshObj@0 head) next (bool_2_U true))))) (=> (and (and (forall ((o_27 T@U) (f_31 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_31))))
(let ((A@@13 (FieldTypeInv0 (type f_31))))
 (=> (and (and (= (type o_27) RefType) (= (type f_31) (FieldType A@@13 B@@12))) (or (U_2_bool (MapType1Select (MapType0Select Heap@10 null (|lseg#sm| (MapType0Select Heap@10 freshObj@0 head) null)) o_27 f_31)) (U_2_bool (MapType1Select (MapType0Select Heap@10 null (|lseg#sm| (MapType0Select Heap@10 (MapType0Select Heap@10 freshObj@0 head) next) null)) o_27 f_31)))) (U_2_bool (MapType1Select newPMask@2 o_27 f_31)))))
 :qid |stdinbpl.2246:29|
 :skolemid |125|
 :pattern ( (MapType1Select newPMask@2 o_27 f_31))
)) (= Heap@11 (MapType0Store Heap@10 null (|lseg#sm| (MapType0Select Heap@10 freshObj@0 head) null) newPMask@2))) (and (= Heap@12 Heap@11) (= (ControlFlow 0 18) 17))) anon27_correct)))))
(let ((anon48_Else_correct  (=> (and (HasDirectPerm Mask@9 null (lseg (MapType0Select Heap@5 freshObj@0 head) null)) (= Heap@8 Heap@5)) (and (=> (= (ControlFlow 0 21) 18) anon49_Then_correct) (=> (= (ControlFlow 0 21) 19) anon49_Else_correct)))))
(let ((anon48_Then_correct  (=> (and (and (not (HasDirectPerm Mask@9 null (lseg (MapType0Select Heap@5 freshObj@0 head) null))) (= Heap@6 (MapType0Store Heap@5 null (|lseg#sm| (MapType0Select Heap@5 freshObj@0 head) null) ZeroPMask))) (and (= Heap@7 (MapType0Store Heap@6 null (lseg (MapType0Select Heap@6 freshObj@0 head) null) freshVersion@0)) (= Heap@8 Heap@7))) (and (=> (= (ControlFlow 0 20) 18) anon49_Then_correct) (=> (= (ControlFlow 0 20) 19) anon49_Else_correct)))))
(let ((anon23_correct  (=> (and (state Heap@5 Mask@8) (= Mask@9 (MapType1Store Mask@8 null (lseg (MapType0Select Heap@5 freshObj@0 head) null) (real_2_U (+ (U_2_real (MapType1Select Mask@8 null (lseg (MapType0Select Heap@5 freshObj@0 head) null))) FullPerm))))) (=> (and (and (state Heap@5 Mask@9) (state Heap@5 Mask@9)) (and (|lseg#trigger| Heap@5 (lseg (MapType0Select Heap@5 freshObj@0 head) null)) (= (MapType0Select Heap@5 null (lseg (MapType0Select Heap@5 freshObj@0 head) null)) (FrameFragment (ite (not (= (MapType0Select Heap@5 freshObj@0 head) null)) (CombineFrames (FrameFragment (MapType0Select Heap@5 (MapType0Select Heap@5 freshObj@0 head) data)) (CombineFrames (FrameFragment (MapType0Select Heap@5 (MapType0Select Heap@5 freshObj@0 head) next)) (MapType0Select Heap@5 null (lseg (MapType0Select Heap@5 (MapType0Select Heap@5 freshObj@0 head) next) null)))) EmptyFrame))))) (and (=> (= (ControlFlow 0 22) 20) anon48_Then_correct) (=> (= (ControlFlow 0 22) 21) anon48_Else_correct))))))
(let ((anon47_Else_correct  (=> (= (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null) (=> (and (= Heap@5 Heap@1) (= (ControlFlow 0 24) 22)) anon23_correct))))
(let ((anon47_Then_correct  (=> (not (= (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null)) (=> (and (= Heap@2 (MapType0Store Heap@1 null (|lseg#sm| (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null) (MapType1Store (MapType0Select Heap@1 null (|lseg#sm| (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null)) (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) data (bool_2_U true)))) (= Heap@3 (MapType0Store Heap@2 null (|lseg#sm| (MapType0Select Heap@2 (MapType0Select Heap@2 freshObj@0 head) next) null) (MapType1Store (MapType0Select Heap@2 null (|lseg#sm| (MapType0Select Heap@2 (MapType0Select Heap@2 freshObj@0 head) next) null)) (MapType0Select Heap@2 (MapType0Select Heap@2 freshObj@0 head) next) next (bool_2_U true))))) (=> (and (and (forall ((o_26 T@U) (f_30 T@U) ) (! (let ((B@@13 (FieldTypeInv1 (type f_30))))
(let ((A@@14 (FieldTypeInv0 (type f_30))))
 (=> (and (and (= (type o_26) RefType) (= (type f_30) (FieldType A@@14 B@@13))) (or (U_2_bool (MapType1Select (MapType0Select Heap@3 null (|lseg#sm| (MapType0Select Heap@3 (MapType0Select Heap@3 freshObj@0 head) next) null)) o_26 f_30)) (U_2_bool (MapType1Select (MapType0Select Heap@3 null (|lseg#sm| (MapType0Select Heap@3 (MapType0Select Heap@3 (MapType0Select Heap@3 freshObj@0 head) next) next) null)) o_26 f_30)))) (U_2_bool (MapType1Select newPMask@1 o_26 f_30)))))
 :qid |stdinbpl.2224:31|
 :skolemid |124|
 :pattern ( (MapType1Select newPMask@1 o_26 f_30))
)) (= Heap@4 (MapType0Store Heap@3 null (|lseg#sm| (MapType0Select Heap@3 (MapType0Select Heap@3 freshObj@0 head) next) null) newPMask@1))) (and (= Heap@5 Heap@4) (= (ControlFlow 0 23) 22))) anon23_correct)))))
(let ((anon46_Else_correct  (=> (and (= (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null) (= Mask@8 Mask@7)) (and (=> (= (ControlFlow 0 28) 23) anon47_Then_correct) (=> (= (ControlFlow 0 28) 24) anon47_Else_correct)))))
(let ((anon46_Then_correct  (=> (not (= (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (<= (U_2_int (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) data)) (U_2_int (MapType0Select Heap@1 (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) data)))) (=> (<= (U_2_int (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) data)) (U_2_int (MapType0Select Heap@1 (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) data))) (=> (= Mask@8 Mask@7) (and (=> (= (ControlFlow 0 26) 23) anon47_Then_correct) (=> (= (ControlFlow 0 26) 24) anon47_Else_correct))))))))
(let ((anon19_correct  (=> (state UnfoldingHeap@4 UnfoldingMask@4) (and (=> (= (ControlFlow 0 29) 26) anon46_Then_correct) (=> (= (ControlFlow 0 29) 28) anon46_Else_correct)))))
(let ((anon18_correct  (=> (and (and (state UnfoldingHeap@3 UnfoldingMask@3) (= UnfoldingHeap@4 UnfoldingHeap@3)) (and (= UnfoldingMask@4 UnfoldingMask@3) (= (ControlFlow 0 31) 29))) anon19_correct)))
(let ((anon45_Else_correct  (=> (= (MapType0Select Heap@1 (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) next) null) (=> (and (= UnfoldingHeap@3 Heap@1) (= (ControlFlow 0 33) 31)) anon18_correct))))
(let ((anon45_Then_correct  (=> (not (= (MapType0Select Heap@1 (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) next) null)) (=> (and (= UnfoldingHeap@0 (MapType0Store Heap@1 null (|lseg#sm| (MapType0Select Heap@1 (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) next) null) (MapType1Store (MapType0Select Heap@1 null (|lseg#sm| (MapType0Select Heap@1 (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) next) null)) (MapType0Select Heap@1 (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) next) data (bool_2_U true)))) (= UnfoldingHeap@1 (MapType0Store UnfoldingHeap@0 null (|lseg#sm| (MapType0Select UnfoldingHeap@0 (MapType0Select UnfoldingHeap@0 (MapType0Select UnfoldingHeap@0 freshObj@0 head) next) next) null) (MapType1Store (MapType0Select UnfoldingHeap@0 null (|lseg#sm| (MapType0Select UnfoldingHeap@0 (MapType0Select UnfoldingHeap@0 (MapType0Select UnfoldingHeap@0 freshObj@0 head) next) next) null)) (MapType0Select UnfoldingHeap@0 (MapType0Select UnfoldingHeap@0 (MapType0Select UnfoldingHeap@0 freshObj@0 head) next) next) next (bool_2_U true))))) (=> (and (and (forall ((o_25 T@U) (f_29 T@U) ) (! (let ((B@@14 (FieldTypeInv1 (type f_29))))
(let ((A@@15 (FieldTypeInv0 (type f_29))))
 (=> (and (and (= (type o_25) RefType) (= (type f_29) (FieldType A@@15 B@@14))) (or (U_2_bool (MapType1Select (MapType0Select UnfoldingHeap@1 null (|lseg#sm| (MapType0Select UnfoldingHeap@1 (MapType0Select UnfoldingHeap@1 (MapType0Select UnfoldingHeap@1 freshObj@0 head) next) next) null)) o_25 f_29)) (U_2_bool (MapType1Select (MapType0Select UnfoldingHeap@1 null (|lseg#sm| (MapType0Select UnfoldingHeap@1 (MapType0Select UnfoldingHeap@1 (MapType0Select UnfoldingHeap@1 (MapType0Select UnfoldingHeap@1 freshObj@0 head) next) next) next) null)) o_25 f_29)))) (U_2_bool (MapType1Select newPMask@0 o_25 f_29)))))
 :qid |stdinbpl.2204:37|
 :skolemid |123|
 :pattern ( (MapType1Select newPMask@0 o_25 f_29))
)) (= UnfoldingHeap@2 (MapType0Store UnfoldingHeap@1 null (|lseg#sm| (MapType0Select UnfoldingHeap@1 (MapType0Select UnfoldingHeap@1 (MapType0Select UnfoldingHeap@1 freshObj@0 head) next) next) null) newPMask@0))) (and (= UnfoldingHeap@3 UnfoldingHeap@2) (= (ControlFlow 0 32) 31))) anon18_correct)))))
(let ((anon44_Then_correct  (=> (not (= (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null)) (=> (and (not (= (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) data (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) data)) FullPerm))))) (=> (and (and (and (state Heap@1 UnfoldingMask@1) (not (= (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null))) (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) next)) FullPerm)))) (state Heap@1 UnfoldingMask@2))) (and (and (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 null (lseg (MapType0Select Heap@1 (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) next) null) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 null (lseg (MapType0Select Heap@1 (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) next) null))) FullPerm)))) (InsidePredicate (lseg (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null) (MapType0Select Heap@1 null (lseg (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null)) (lseg (MapType0Select Heap@1 (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) next) null) (MapType0Select Heap@1 null (lseg (MapType0Select Heap@1 (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) next) null)))) (and (state Heap@1 UnfoldingMask@3) (=> (not (= (MapType0Select Heap@1 (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) next) null)) (<= (U_2_int (MapType0Select Heap@1 (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) data)) (U_2_int (MapType0Select Heap@1 (MapType0Select Heap@1 (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) next) data))))))) (and (=> (= (ControlFlow 0 34) 32) anon45_Then_correct) (=> (= (ControlFlow 0 34) 33) anon45_Else_correct)))))))
(let ((anon44_Else_correct  (=> (and (and (= (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null) (= UnfoldingHeap@4 Heap@1)) (and (= UnfoldingMask@4 UnfoldingMask@0) (= (ControlFlow 0 30) 29))) anon19_correct)))
(let ((anon15_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@4 null (lseg (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null) (real_2_U (- (U_2_real (MapType1Select Mask@4 null (lseg (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null))) FullPerm)))) (and (=> (= (ControlFlow 0 35) 34) anon44_Then_correct) (=> (= (ControlFlow 0 35) 30) anon44_Else_correct)))))
(let ((anon43_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 38) 35)) anon15_correct)))
(let ((anon43_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 36) (- 0 37)) (<= FullPerm (U_2_real (MapType1Select Mask@4 null (lseg (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 null (lseg (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null)))) (=> (= (ControlFlow 0 36) 35) anon15_correct))))))
(let ((anon13_correct  (=> (and (and (= Mask@7 (MapType1Store Mask@6 null (lseg (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null) (real_2_U (- (U_2_real (MapType1Select Mask@6 null (lseg (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null))) FullPerm)))) (InsidePredicate (lseg (MapType0Select Heap@1 freshObj@0 head) null) (MapType0Select Heap@1 null (lseg (MapType0Select Heap@1 freshObj@0 head) null)) (lseg (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null) (MapType0Select Heap@1 null (lseg (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null)))) (and (|lseg#trigger| Heap@1 (lseg (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null)) (= (MapType0Select Heap@1 null (lseg (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null)) (FrameFragment (ite (not (= (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null)) (CombineFrames (FrameFragment (MapType0Select Heap@1 (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) data)) (CombineFrames (FrameFragment (MapType0Select Heap@1 (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) next)) (MapType0Select Heap@1 null (lseg (MapType0Select Heap@1 (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) next) null)))) EmptyFrame))))) (and (=> (= (ControlFlow 0 39) 36) anon43_Then_correct) (=> (= (ControlFlow 0 39) 38) anon43_Else_correct)))))
(let ((anon42_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 42) 39)) anon13_correct)))
(let ((anon42_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 40) (- 0 41)) (<= FullPerm (U_2_real (MapType1Select Mask@6 null (lseg (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@6 null (lseg (MapType0Select Heap@1 (MapType0Select Heap@1 freshObj@0 head) next) null)))) (=> (= (ControlFlow 0 40) 39) anon13_correct))))))
(let ((anon11_correct  (=> (= Mask@6 (MapType1Store Mask@5 (MapType0Select Heap@1 freshObj@0 head) next (real_2_U (- (U_2_real (MapType1Select Mask@5 (MapType0Select Heap@1 freshObj@0 head) next)) FullPerm)))) (and (=> (= (ControlFlow 0 43) 40) anon42_Then_correct) (=> (= (ControlFlow 0 43) 42) anon42_Else_correct)))))
(let ((anon41_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 46) 43)) anon11_correct)))
(let ((anon41_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 44) (- 0 45)) (<= FullPerm (U_2_real (MapType1Select Mask@5 (MapType0Select Heap@1 freshObj@0 head) next)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@5 (MapType0Select Heap@1 freshObj@0 head) next))) (=> (= (ControlFlow 0 44) 43) anon11_correct))))))
(let ((anon9_correct  (=> (= Mask@5 (MapType1Store Mask@4 (MapType0Select Heap@1 freshObj@0 head) data (real_2_U (- (U_2_real (MapType1Select Mask@4 (MapType0Select Heap@1 freshObj@0 head) data)) FullPerm)))) (and (=> (= (ControlFlow 0 47) 44) anon41_Then_correct) (=> (= (ControlFlow 0 47) 46) anon41_Else_correct)))))
(let ((anon40_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 50) 47)) anon9_correct)))
(let ((anon40_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 48) (- 0 49)) (<= FullPerm (U_2_real (MapType1Select Mask@4 (MapType0Select Heap@1 freshObj@0 head) data)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 (MapType0Select Heap@1 freshObj@0 head) data))) (=> (= (ControlFlow 0 48) 47) anon9_correct))))))
(let ((anon39_Then_correct  (=> (not (= (MapType0Select Heap@1 freshObj@0 head) null)) (and (=> (= (ControlFlow 0 51) 48) anon40_Then_correct) (=> (= (ControlFlow 0 51) 50) anon40_Else_correct)))))
(let ((anon39_Else_correct  (=> (and (= (MapType0Select Heap@1 freshObj@0 head) null) (= Mask@8 Mask@4)) (and (=> (= (ControlFlow 0 25) 23) anon47_Then_correct) (=> (= (ControlFlow 0 25) 24) anon47_Else_correct)))))
(let ((anon36_Else_correct  (=> (and (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@38 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@38 freshObj@0 $allocated (bool_2_U true)))) (and (= Mask@0 (MapType1Store ZeroMask freshObj@0 data (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 data)) FullPerm)))) (= Mask@1 (MapType1Store Mask@0 freshObj@0 next (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@0 next)) FullPerm)))))) (and (and (= Mask@2 (MapType1Store Mask@1 freshObj@0 head (real_2_U (+ (U_2_real (MapType1Select Mask@1 freshObj@0 head)) FullPerm)))) (= Mask@3 (MapType1Store Mask@2 freshObj@0 held (real_2_U (+ (U_2_real (MapType1Select Mask@2 freshObj@0 held)) FullPerm))))) (and (= Mask@4 (MapType1Store Mask@3 freshObj@0 changed (real_2_U (+ (U_2_real (MapType1Select Mask@3 freshObj@0 changed)) FullPerm)))) (state Heap@0 Mask@4)))) (and (=> (= (ControlFlow 0 52) (- 0 54)) (= FullPerm (U_2_real (MapType1Select Mask@4 freshObj@0 head)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@4 freshObj@0 head))) (=> (and (= Heap@1 (MapType0Store Heap@0 freshObj@0 head null)) (state Heap@1 Mask@4)) (and (=> (= (ControlFlow 0 52) (- 0 53)) (HasDirectPerm Mask@4 freshObj@0 head)) (=> (HasDirectPerm Mask@4 freshObj@0 head) (and (=> (= (ControlFlow 0 52) 51) anon39_Then_correct) (=> (= (ControlFlow 0 52) 25) anon39_Else_correct))))))))))
(let ((anon0_correct  (=> (and (state Heap@@38 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 61) 60) anon36_Then_correct) (=> (= (ControlFlow 0 61) 52) anon36_Else_correct)))))
