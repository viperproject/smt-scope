...
(let ((anon3_Then_correct  (=> (not (= 1 0)) (=> (and (state Heap@@75 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (not (= 1 0))))))
(let ((anon0_correct  (=> (and (state Heap@@75 ZeroMask) (= AssumeFunctionsAbove 15)) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 4) anon3_Else_correct)))))
