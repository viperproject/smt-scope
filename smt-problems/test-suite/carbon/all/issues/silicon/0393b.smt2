...
(assert  (and (= (Ctor PredicateType_PType) 11) (forall ((arg0@@25 Int) ) (! (= (type (P arg0@@25)) (FieldType PredicateType_PType FrameTypeType))
 :qid |funType:P|
 :pattern ( (P arg0@@25))
))))
(assert (forall ((idx_1 Int) ) (! (IsPredicateField (P idx_1))
 :qid |stdinbpl.196:15|
 :skolemid |23|
 :pattern ( (P idx_1))
)))
(assert (forall ((Heap@@2 T@U) (idx_1@@0 Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (|P#everUsed| (P idx_1@@0)))
 :qid |stdinbpl.215:15|
 :skolemid |27|
 :pattern ( (|P#trigger| Heap@@2 (P idx_1@@0)))
)))
...
(assert (forall ((arg0@@26 Int) ) (! (= (type (|P#sm| arg0@@26)) (FieldType PredicateType_PType (MapType1Type RefType boolType)))
 :qid |funType:P#sm|
...
(assert (forall ((idx_1@@3 Int) ) (! (= (getPredWandId (P idx_1@@3)) 0)
 :qid |stdinbpl.200:15|
 :skolemid |24|
 :pattern ( (P idx_1@@3))
)))
...
(assert (forall ((idx_1@@4 Int) ) (! (= (PredicateMaskField (P idx_1@@4)) (|P#sm| idx_1@@4))
 :qid |stdinbpl.192:15|
 :skolemid |22|
 :pattern ( (PredicateMaskField (P idx_1@@4)))
)))
...
(assert  (and (and (= (type UnfoldingMask@0) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (P i_2) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P i_2))) FullPerm)))) (forall ((i$0 Int) ) (!  (=> (and (<= 0 i$0) (< i$0 10)) (foo i$0 i_2))
 :qid |stdinbpl.290:22|
 :skolemid |29|
 :pattern ( (foo i$0 i_2))
))) (=> (and (and (state Heap@@10 UnfoldingMask@0) (state Heap@@10 Mask@0)) (and (state Heap@@10 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (foo 0 i_2)))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P i_2))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P i_2)))) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (= Mask@0 (MapType1Store ZeroMask null (P i_2) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P i_2))) FullPerm)))) (state Heap@@10 Mask@0)) (=> (and (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (|P#trigger| Heap@@10 (P i_2)) (= (MapType0Select Heap@@10 null (P i_2)) EmptyFrame))) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))))
