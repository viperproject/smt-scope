...
(declare-fun |validList'| (T@U T@U T@U) Bool)
(declare-fun MapType2Type (T@T T@T) T@T)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |validList#triggerStateless| (T@U T@U) Bool)
(declare-fun MapType2TypeInv0 (T@T) T@T)
(declare-fun MapType2TypeInv1 (T@T) T@T)
(declare-fun MapType2Select (T@U T@U) T@U)
(declare-fun MapType2Store (T@U T@U T@U) T@U)
(declare-fun |validList_abstract'| (T@U T@U T@U) Bool)
(declare-fun |validList_abstract#triggerStateless| (T@U T@U) Bool)
...
(declare-fun RefGuard (T@U) T@U)
(declare-fun PredicateType_RefGuardType () T@T)
(declare-fun |getWSet'| (T@U T@U) T@U)
(declare-fun |getWSet#triggerStateless| (T@U) T@U)
(declare-fun |RefGuard#trigger| (T@U T@U) Bool)
(declare-fun |RefGuard#everUsed| (T@U) Bool)
...
(declare-fun |RefGuard#sm| (T@U) T@U)
(declare-fun validList (T@U T@U T@U) Bool)
...
(declare-fun |getWSet#frame| (T@U T@U) T@U)
(declare-fun |Set#Empty| (T@T) T@U)
(declare-fun |validList#frame| (T@U T@U T@U) Bool)
(declare-fun |validList_abstract#frame| (T@U T@U T@U) Bool)
...
(assert  (and (and (and (and (forall ((arg0@@18 T@T) ) (! (= (Ctor (MultiSetType arg0@@18)) 9)
...
(assert  (and (and (and (and (and (and (forall ((arg0@@23 T@T) (arg1@@7 T@T) ) (! (= (Ctor (MapType1Type arg0@@23 arg1@@7)) 10)
...
(assert  (and (and (and (and (and (and (forall ((arg0@@28 T@T) (arg1@@12 T@T) ) (! (= (Ctor (MapType2Type arg0@@28 arg1@@12)) 11)
...
(assert (forall ((Heap@@0 T@U) (root T@U) (nodes T@U) ) (!  (=> (and (and (= (type Heap@@0) (MapType0Type RefType)) (= (type root) RefType)) (= (type nodes) (MapType2Type RefType boolType))) (dummyFunction (bool_2_U (|validList#triggerStateless| root nodes))))
 :qid |stdinbpl.430:15|
 :skolemid |86|
 :pattern ( (|validList'| Heap@@0 root nodes))
)))
(assert (forall ((Heap@@1 T@U) (root@@0 T@U) (nodes@@0 T@U) ) (!  (=> (and (and (= (type Heap@@1) (MapType0Type RefType)) (= (type root@@0) RefType)) (= (type nodes@@0) (MapType2Type RefType boolType))) (dummyFunction (bool_2_U (|validList_abstract#triggerStateless| root@@0 nodes@@0))))
 :qid |stdinbpl.512:15|
 :skolemid |90|
 :pattern ( (|validList_abstract'| Heap@@1 root@@0 nodes@@0))
)))
...
(assert  (and (= (Ctor PredicateType_RefGuardType) 13) (forall ((arg0@@35 T@U) ) (! (= (type (RefGuard arg0@@35)) (FieldType PredicateType_RefGuardType FrameTypeType))
 :qid |funType:RefGuard|
 :pattern ( (RefGuard arg0@@35))
))))
(assert (forall ((ref T@U) ) (!  (=> (= (type ref) RefType) (IsPredicateField (RefGuard ref)))
 :qid |stdinbpl.585:15|
 :skolemid |93|
 :pattern ( (RefGuard ref))
)))
(assert  (and (forall ((arg0@@36 T@U) (arg1@@17 T@U) ) (! (= (type (|getWSet'| arg0@@36 arg1@@17)) (MapType2Type RefType boolType))
 :qid |funType:getWSet'|
 :pattern ( (|getWSet'| arg0@@36 arg1@@17))
)) (forall ((arg0@@37 T@U) ) (! (= (type (|getWSet#triggerStateless| arg0@@37)) (MapType2Type RefType boolType))
 :qid |funType:getWSet#triggerStateless|
 :pattern ( (|getWSet#triggerStateless| arg0@@37))
))))
(assert (forall ((Heap@@4 T@U) (ref@@0 T@U) ) (!  (=> (and (= (type Heap@@4) (MapType0Type RefType)) (= (type ref@@0) RefType)) (dummyFunction (|getWSet#triggerStateless| ref@@0)))
 :qid |stdinbpl.382:15|
 :skolemid |83|
 :pattern ( (|getWSet'| Heap@@4 ref@@0))
)))
(assert (forall ((Heap@@5 T@U) (ref@@1 T@U) ) (!  (=> (and (= (type Heap@@5) (MapType0Type RefType)) (= (type ref@@1) RefType)) (|RefGuard#everUsed| (RefGuard ref@@1)))
 :qid |stdinbpl.604:15|
 :skolemid |97|
 :pattern ( (|RefGuard#trigger| Heap@@5 (RefGuard ref@@1)))
)))
...
(assert (forall ((arg0@@38 T@U) (arg1@@18 T@U) ) (! (let ((T@@4 (MapType2TypeInv0 (type arg0@@38))))
...
(assert (forall ((arg0@@41 T@U) (arg1@@20 T@U) ) (! (= (type (getWSet arg0@@41 arg1@@20)) (MapType2Type RefType boolType))
 :qid |funType:getWSet|
 :pattern ( (getWSet arg0@@41 arg1@@20))
)))
(assert (forall ((Heap@@7 T@U) (ref@@2 T@U) ) (!  (=> (and (= (type Heap@@7) (MapType0Type RefType)) (= (type ref@@2) RefType)) (and (= (getWSet Heap@@7 ref@@2) (|getWSet'| Heap@@7 ref@@2)) (dummyFunction (|getWSet#triggerStateless| ref@@2))))
 :qid |stdinbpl.378:15|
 :skolemid |82|
 :pattern ( (getWSet Heap@@7 ref@@2))
)))
...
(assert (forall ((ref@@3 T@U) (ref2 T@U) ) (!  (=> (and (and (= (type ref@@3) RefType) (= (type ref2) RefType)) (= (RefGuard ref@@3) (RefGuard ref2))) (= ref@@3 ref2))
 :qid |stdinbpl.595:15|
 :skolemid |95|
 :pattern ( (RefGuard ref@@3) (RefGuard ref2))
)))
(assert (forall ((arg0@@42 T@U) ) (! (= (type (|RefGuard#sm| arg0@@42)) (FieldType PredicateType_RefGuardType (MapType1Type RefType boolType)))
 :qid |funType:RefGuard#sm|
 :pattern ( (|RefGuard#sm| arg0@@42))
)))
(assert (forall ((ref@@4 T@U) (ref2@@0 T@U) ) (!  (=> (and (and (= (type ref@@4) RefType) (= (type ref2@@0) RefType)) (= (|RefGuard#sm| ref@@4) (|RefGuard#sm| ref2@@0))) (= ref@@4 ref2@@0))
 :qid |stdinbpl.599:15|
 :skolemid |96|
...
(assert (forall ((Heap@@9 T@U) (Mask@@4 T@U) (root@@1 T@U) (nodes@@1 T@U) ) (!  (=> (and (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@4) (MapType1Type RefType realType))) (= (type root@@1) RefType)) (= (type nodes@@1) (MapType2Type RefType boolType))) (and (state Heap@@9 Mask@@4) (< AssumeFunctionsAbove 1))) (|Set#Subset| nodes@@1 (getWSet Heap@@9 root@@1))) (validList Heap@@9 root@@1 nodes@@1))
 :qid |stdinbpl.436:15|
 :skolemid |87|
 :pattern ( (state Heap@@9 Mask@@4) (validList Heap@@9 root@@1 nodes@@1))
 :pattern ( (state Heap@@9 Mask@@4) (|validList#triggerStateless| root@@1 nodes@@1) (|RefGuard#trigger| Heap@@9 (RefGuard root@@1)))
)))
(assert  (and (= (type dummyHeap) (MapType0Type RefType)) (= (type ZeroMask) (MapType1Type RefType realType))))
(assert (state dummyHeap ZeroMask))
(assert (forall ((arg0@@43 T@U) (arg1@@21 T@U) ) (! (let ((T@@13 (type arg1@@21)))
(= (type (|MultiSet#UnionOne| arg0@@43 arg1@@21)) (MultiSetType T@@13)))
 :qid |funType:MultiSet#UnionOne|
 :pattern ( (|MultiSet#UnionOne| arg0@@43 arg1@@21))
)))
...
(assert  (and (forall ((arg0@@45 Real) (arg1@@22 T@U) ) (! (= (type (ConditionalFrame arg0@@45 arg1@@22)) FrameTypeType)
...
(assert (forall ((ref@@5 T@U) ) (!  (=> (= (type ref@@5) RefType) (= (getPredWandId (RefGuard ref@@5)) 0))
 :qid |stdinbpl.589:15|
 :skolemid |94|
 :pattern ( (RefGuard ref@@5))
)))
...
(assert (forall ((arg0@@48 T@U) (arg1@@25 T@U) ) (! (= (type (|getWSet#frame| arg0@@48 arg1@@25)) (MapType2Type RefType boolType))
 :qid |funType:getWSet#frame|
 :pattern ( (|getWSet#frame| arg0@@48 arg1@@25))
)))
(assert (forall ((Heap@@13 T@U) (Mask@@10 T@U) (ref@@6 T@U) ) (!  (=> (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type ref@@6) RefType)) (state Heap@@13 Mask@@10)) (= (|getWSet'| Heap@@13 ref@@6) (|getWSet#frame| (MapType0Select Heap@@13 null (RefGuard ref@@6)) ref@@6)))
 :qid |stdinbpl.389:15|
 :skolemid |84|
 :pattern ( (state Heap@@13 Mask@@10) (|getWSet'| Heap@@13 ref@@6))
)))
...
(assert (forall ((o@@8 T@U) (f T@U) (Heap@@14 T@U) ) (!  (=> (and (and (and (= (type o@@8) RefType) (= (type f) (FieldType NormalFieldType RefType))) (= (type Heap@@14) (MapType0Type RefType))) (U_2_bool (MapType0Select Heap@@14 o@@8 $allocated))) (U_2_bool (MapType0Select Heap@@14 (MapType0Select Heap@@14 o@@8 f) $allocated)))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (MapType0Select Heap@@14 o@@8 f))
)))
...
(assert (forall ((ref@@7 T@U) ) (!  (=> (= (type ref@@7) RefType) (= (PredicateMaskField (RefGuard ref@@7)) (|RefGuard#sm| ref@@7)))
 :qid |stdinbpl.581:15|
 :skolemid |92|
 :pattern ( (PredicateMaskField (RefGuard ref@@7)))
)))
...
(assert (forall ((Heap@@15 T@U) (Mask@@11 T@U) (root@@2 T@U) (nodes@@2 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@15) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (= (type root@@2) RefType)) (= (type nodes@@2) (MapType2Type RefType boolType))) (state Heap@@15 Mask@@11)) (= (|validList'| Heap@@15 root@@2 nodes@@2) (|validList#frame| (MapType0Select Heap@@15 null (RefGuard root@@2)) root@@2 nodes@@2)))
 :qid |stdinbpl.443:15|
 :skolemid |88|
 :pattern ( (state Heap@@15 Mask@@11) (|validList'| Heap@@15 root@@2 nodes@@2))
)))
(assert (forall ((Heap@@16 T@U) (Mask@@12 T@U) (root@@3 T@U) (nodes@@3 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@16) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (= (type root@@3) RefType)) (= (type nodes@@3) (MapType2Type RefType boolType))) (state Heap@@16 Mask@@12)) (= (|validList_abstract'| Heap@@16 root@@3 nodes@@3) (|validList_abstract#frame| (MapType0Select Heap@@16 null (RefGuard root@@3)) root@@3 nodes@@3)))
 :qid |stdinbpl.519:15|
 :skolemid |91|
 :pattern ( (state Heap@@16 Mask@@12) (|validList_abstract'| Heap@@16 root@@3 nodes@@3))
)))
...
(assert (forall ((Heap@@18 T@U) (root@@4 T@U) (nodes@@4 T@U) ) (!  (=> (and (and (= (type Heap@@18) (MapType0Type RefType)) (= (type root@@4) RefType)) (= (type nodes@@4) (MapType2Type RefType boolType))) (and (= (validList Heap@@18 root@@4 nodes@@4) (|validList'| Heap@@18 root@@4 nodes@@4)) (dummyFunction (bool_2_U (|validList#triggerStateless| root@@4 nodes@@4)))))
 :qid |stdinbpl.426:15|
 :skolemid |85|
 :pattern ( (validList Heap@@18 root@@4 nodes@@4))
)))
(assert (forall ((Heap@@19 T@U) (root@@5 T@U) (nodes@@5 T@U) ) (!  (=> (and (and (= (type Heap@@19) (MapType0Type RefType)) (= (type root@@5) RefType)) (= (type nodes@@5) (MapType2Type RefType boolType))) (and (= (validList_abstract Heap@@19 root@@5 nodes@@5) (|validList_abstract'| Heap@@19 root@@5 nodes@@5)) (dummyFunction (bool_2_U (|validList_abstract#triggerStateless| root@@5 nodes@@5)))))
 :qid |stdinbpl.508:15|
 :skolemid |89|
 :pattern ( (validList_abstract Heap@@19 root@@5 nodes@@5))
)))
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(declare-fun Mask@0 () T@U)
(declare-fun root@@6 () T@U)
(declare-fun Heap@@20 () T@U)
(assert  (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type root@@6) RefType)) (= (type Heap@@20) (MapType0Type RefType))))
(set-info :boogie-vc-id validList_method)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon3_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (RefGuard root@@6))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (RefGuard root@@6)))) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (state Heap@@20 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@20 root@@6 $allocated))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (RefGuard root@@6) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (RefGuard root@@6))) FullPerm)))) (state Heap@@20 Mask@0)) (and (state Heap@@20 Mask@0) (state Heap@@20 Mask@0))) (and (and (=> (= (ControlFlow 0 6) 1) anon5_Else_correct) (=> (= (ControlFlow 0 6) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))))
