...
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type x_2) RefType)) (= (type y@@2) RefType)) (= (type QPMask@3) (MapType1Type RefType realType))) (= (type z_10) RefType)) (forall ((arg0@@35 T@U) ) (! (= (type (invRecv16 arg0@@35)) RefType)
 :qid |funType:invRecv16|
 :pattern ( (invRecv16 arg0@@35))
))) (= (type QPMask@2) (MapType1Type RefType realType))) (forall ((arg0@@36 T@U) ) (! (= (type (invRecv15 arg0@@36)) RefType)
 :qid |funType:invRecv15|
 :pattern ( (invRecv15 arg0@@36))
))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@37 T@U) ) (! (= (type (invRecv14 arg0@@37)) RefType)
 :qid |funType:invRecv14|
 :pattern ( (invRecv14 arg0@@37))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@38 T@U) ) (! (= (type (invRecv13 arg0@@38)) RefType)
 :qid |funType:invRecv13|
 :pattern ( (invRecv13 arg0@@38))
))))
...
(let ((anon18_Else_correct  (=> (and (not (or (= z_10 x_2) (= z_10 y@@2))) (= (ControlFlow 0 14) 9)) anon11_correct)))
(let ((anon18_Then_correct  (=> (or (= z_10 x_2) (= z_10 y@@2)) (and (=> (= (ControlFlow 0 10) (- 0 13)) (HasDirectPerm QPMask@3 z_10 f_7)) (=> (HasDirectPerm QPMask@3 z_10 f_7) (and (=> (= (ControlFlow 0 10) (- 0 12)) (HasDirectPerm QPMask@3 z_10 g)) (=> (HasDirectPerm QPMask@3 z_10 g) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm QPMask@3 z_10 f_7)) (=> (HasDirectPerm QPMask@3 z_10 f_7) (=> (= (ControlFlow 0 10) 9) anon11_correct))))))))))
...
)) (=> (and (and (forall ((z_7@@1 T@U) ) (!  (=> (= (type z_7@@1) RefType) (=> (and (= z_7@@1 y@@2) (< NoPerm FullPerm)) (and (qpRange16 z_7@@1) (= (invRecv16 z_7@@1) z_7@@1))))
 :qid |stdinbpl.1771:22|
 :skolemid |158|
 :pattern ( (MapType0Select Heap@@13 z_7@@1 g))
 :pattern ( (MapType1Select QPMask@3 z_7@@1 g))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (= (invRecv16 o_3) y@@2) (< NoPerm FullPerm)) (qpRange16 o_3)) (= (invRecv16 o_3) o_3)))
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (= (invRecv16 o_3@@0) y@@2) (< NoPerm FullPerm)) (qpRange16 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv16 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@3 o_3@@0 g)) (+ (U_2_real (MapType1Select QPMask@2 o_3@@0 g)) FullPerm)))) (=> (not (and (and (= (invRecv16 o_3@@0) y@@2) (< NoPerm FullPerm)) (qpRange16 o_3@@0))) (= (U_2_real (MapType1Select QPMask@3 o_3@@0 g)) (U_2_real (MapType1Select QPMask@2 o_3@@0 g))))))
...
)) (=> (and (and (and (forall ((z_5@@1 T@U) ) (!  (=> (= (type z_5@@1) RefType) (=> (and (= z_5@@1 x_2) (< NoPerm FullPerm)) (and (qpRange15 z_5@@1) (= (invRecv15 z_5@@1) z_5@@1))))
 :qid |stdinbpl.1728:22|
 :skolemid |152|
 :pattern ( (MapType0Select Heap@@13 z_5@@1 g))
 :pattern ( (MapType1Select QPMask@2 z_5@@1 g))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (= (invRecv15 o_3@@2) x_2) (< NoPerm FullPerm)) (qpRange15 o_3@@2)) (= (invRecv15 o_3@@2) o_3@@2)))
...
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (= (invRecv15 o_3@@3) x_2) (< NoPerm FullPerm)) (qpRange15 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv15 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@2 o_3@@3 g)) (+ (U_2_real (MapType1Select QPMask@1 o_3@@3 g)) FullPerm)))) (=> (not (and (and (= (invRecv15 o_3@@3) x_2) (< NoPerm FullPerm)) (qpRange15 o_3@@3))) (= (U_2_real (MapType1Select QPMask@2 o_3@@3 g)) (U_2_real (MapType1Select QPMask@1 o_3@@3 g))))))
...
)) (=> (and (and (and (forall ((z_3@@1 T@U) ) (!  (=> (= (type z_3@@1) RefType) (=> (and (= z_3@@1 y@@2) (< NoPerm FullPerm)) (and (qpRange14 z_3@@1) (= (invRecv14 z_3@@1) z_3@@1))))
 :qid |stdinbpl.1685:22|
 :skolemid |146|
 :pattern ( (MapType0Select Heap@@13 z_3@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 z_3@@1 f_7))
)) (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (= (invRecv14 o_3@@5) y@@2) (< NoPerm FullPerm)) (qpRange14 o_3@@5)) (= (invRecv14 o_3@@5) o_3@@5)))
...
)) (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (= (invRecv14 o_3@@6) y@@2) (< NoPerm FullPerm)) (qpRange14 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv14 o_3@@6) o_3@@6)) (= (U_2_real (MapType1Select QPMask@1 o_3@@6 f_7)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) FullPerm)))) (=> (not (and (and (= (invRecv14 o_3@@6) y@@2) (< NoPerm FullPerm)) (qpRange14 o_3@@6))) (= (U_2_real (MapType1Select QPMask@1 o_3@@6 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7))))))
...
)) (=> (and (and (and (forall ((z_1@@1 T@U) ) (!  (=> (= (type z_1@@1) RefType) (=> (and (= z_1@@1 x_2) (< NoPerm FullPerm)) (and (qpRange13 z_1@@1) (= (invRecv13 z_1@@1) z_1@@1))))
 :qid |stdinbpl.1642:22|
 :skolemid |140|
 :pattern ( (MapType0Select Heap@@13 z_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@1 f_7))
)) (forall ((o_3@@8 T@U) ) (!  (=> (= (type o_3@@8) RefType) (=> (and (and (= (invRecv13 o_3@@8) x_2) (< NoPerm FullPerm)) (qpRange13 o_3@@8)) (= (invRecv13 o_3@@8) o_3@@8)))
...
)) (forall ((o_3@@9 T@U) ) (!  (=> (= (type o_3@@9) RefType) (and (=> (and (and (= (invRecv13 o_3@@9) x_2) (< NoPerm FullPerm)) (qpRange13 o_3@@9)) (and (=> (< NoPerm FullPerm) (= (invRecv13 o_3@@9) o_3@@9)) (= (U_2_real (MapType1Select QPMask@0 o_3@@9 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@9 f_7)) FullPerm)))) (=> (not (and (and (= (invRecv13 o_3@@9) x_2) (< NoPerm FullPerm)) (qpRange13 o_3@@9))) (= (U_2_real (MapType1Select QPMask@0 o_3@@9 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@9 f_7))))))
