...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon4_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 this f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 this f_7)) FullPerm)))) (= (ControlFlow 0 5) (- 0 4))) (= (U_2_int (MapType0Select Heap@0 this f_7)) (+ (U_2_int (MapType0Select Heap@@9 this f_7)) 1)))))
