...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon7_Else_correct  (=> (= (f_6 Heap@@29 x@@28) 0) (=> (and (and (state Heap@@29 ZeroMask) (state Heap@@29 ZeroMask)) (and (state Heap@@29 ZeroMask) (= (ControlFlow 0 4) (- 0 3)))) (>= x@@28 0)))))
(let ((anon7_Then_correct true))
(let ((anon6_Else_correct  (=> (and (not b_2) (state Heap@@29 ZeroMask)) (and (=> (= (ControlFlow 0 5) 2) anon7_Then_correct) (=> (= (ControlFlow 0 5) 4) anon7_Else_correct)))))
(let ((anon6_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@29 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 6) 1) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))
