...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated)) (not (= x@@8 null))) (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm)))) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@0 x@@8 f_7)) (=> (HasDirectPerm Mask@0 x@@8 f_7) (=> (not (= (MapType0Select Heap@@9 x@@8 f_7) null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 x@@8 f_7)) (=> (HasDirectPerm Mask@0 x@@8 f_7) (=> (not (= (MapType0Select Heap@@9 x@@8 f_7) null)) (=> (and (and (= Mask@1 (MapType1Store Mask@0 (MapType0Select Heap@@9 x@@8 f_7) g (real_2_U (+ (U_2_real (MapType1Select Mask@0 (MapType0Select Heap@@9 x@@8 f_7) g)) FullPerm)))) (state Heap@@9 Mask@1)) (and (state Heap@@9 Mask@1) (= (ControlFlow 0 2) (- 0 1)))) false)))))))))))
