...
(assert  (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type r_1) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id testJoin5)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon5_correct true))
(let ((anon7_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon5_correct)))
(let ((anon7_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@2 r_1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 r_1 f_7))) (=> (= (ControlFlow 0 2) 1) anon5_correct))))))
(let ((anon3_correct  (=> (state Heap@@9 Mask@2) (and (=> (= (ControlFlow 0 5) 2) anon7_Then_correct) (=> (= (ControlFlow 0 5) 4) anon7_Else_correct)))))
(let ((anon6_Else_correct  (=> (and (and (and (not b_2) (not (= r_1 null))) (and (= Mask@1 (MapType1Store ZeroMask r_1 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1 f_7)) FullPerm)))) (state Heap@@9 Mask@1))) (and (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 7) 5)))) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (and (and b_2 (not (= r_1 null))) (and (= Mask@0 (MapType1Store ZeroMask r_1 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1 f_7)) FullPerm)))) (state Heap@@9 Mask@0))) (and (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (= Mask@2 Mask@0) (= (ControlFlow 0 6) 5)))) anon3_correct)))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 r_1 $allocated))) (and (=> (= (ControlFlow 0 8) 6) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))
