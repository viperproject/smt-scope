...
(let ((anon4_Else_correct  (=> (>= (- 0 10) x@@8) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 4) 1)) anon3_correct))))
(let ((anon4_Then_correct  (=> (> x@@8 (- 0 10)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (decreasing (int_2_U (+ (- x@@8 1) 10)) (int_2_U (+ x@@8 10))) (bounded (int_2_U (+ x@@8 10))))) (=> (and (decreasing (int_2_U (+ (- x@@8 1) 10)) (int_2_U (+ x@@8 10))) (bounded (int_2_U (+ x@@8 10)))) (=> (state Heap@@9 ZeroMask) (=> (and (and (= arg_x@0 (- x@@8 1)) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) 1))) anon3_correct)))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 5) 2) anon4_Then_correct) (=> (= (ControlFlow 0 5) 4) anon4_Else_correct)))))
