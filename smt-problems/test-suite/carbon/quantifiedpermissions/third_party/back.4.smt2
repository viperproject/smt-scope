...
(assert  (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type this) RefType)) (= (type ar) (SeqType RefType))))
(set-info :boogie-vc-id send_body_106)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 this $allocated)) (<= (- 0 1) i_26)) (and (< (+ i_26 1) (|Seq#Length| ar)) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= (+ i_26 1) 0)) (=> (>= (+ i_26 1) 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< (+ i_26 1) (|Seq#Length| ar))) (=> (< (+ i_26 1) (|Seq#Length| ar)) (=> (and (= perm@0 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@0 NoPerm))))))))))
