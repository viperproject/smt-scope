...
(assert  (and (and (and (and (and (and (= (type Heap@@23) (MapType0Type RefType)) (= (type Mask@4) (MapType1Type RefType realType))) (= (type x@@35) RefType)) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |fun01#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon4_correct  (=> (and (state Heap@@23 Mask@4) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm Mask@4 x@@35 v_2))))
(let ((anon6_Else_correct  (=> (not b2@@5) (=> (and (= Mask@4 Mask@2) (= (ControlFlow 0 5) 2)) anon4_correct))))
(let ((anon6_Then_correct  (=> (and b2@@5 (= perm@2 (/ (to_real 1) (to_real 3)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (=> (> perm@2 NoPerm) (not (= x@@35 null))) (=> (and (and (= Mask@3 (MapType1Store Mask@2 x@@35 v_2 (real_2_U (+ (U_2_real (MapType1Select Mask@2 x@@35 v_2)) perm@2)))) (state Heap@@23 Mask@3)) (and (= Mask@4 Mask@3) (= (ControlFlow 0 3) 2))) anon4_correct)))))))
(let ((anon2_correct  (=> (state Heap@@23 Mask@2) (and (=> (= (ControlFlow 0 6) 3) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (not b1@@3) (=> (and (= Mask@2 Mask@0) (= (ControlFlow 0 9) 6)) anon2_correct))))
(let ((anon5_Then_correct  (=> (and b1@@3 (= perm@1 (/ (to_real 1) (to_real 3)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (=> (> perm@1 NoPerm) (not (= x@@35 null))) (=> (and (and (= Mask@1 (MapType1Store Mask@0 x@@35 v_2 (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@35 v_2)) perm@1)))) (state Heap@@23 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 7) 6))) anon2_correct)))))))
(let ((anon0_correct  (=> (and (and (state Heap@@23 ZeroMask) (U_2_bool (MapType0Select Heap@@23 x@@35 $allocated))) (and (= AssumeFunctionsAbove 1) (= perm@0 (/ (to_real 1) (to_real 3))))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= x@@35 null))) (= Mask@0 (MapType1Store ZeroMask x@@35 v_2 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@35 v_2)) perm@0))))) (and (state Heap@@23 Mask@0) (state Heap@@23 Mask@0))) (and (=> (= (ControlFlow 0 10) 7) anon5_Then_correct) (=> (= (ControlFlow 0 10) 9) anon5_Else_correct))))))))
