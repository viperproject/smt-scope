...
(assert  (and (= (type s@@8) (MapType2Type RefType boolType)) (= (type Heap@@46) (MapType0Type RefType))))
(set-info :boogie-vc-id |function11#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((e_4 T@U) (e_4_1 T@U) ) (!  (=> (and (= (type e_4) RefType) (= (type e_4_1) RefType)) (=> (and (and (and (and (not (= e_4 e_4_1)) (U_2_bool (MapType2Select s@@8 e_4))) (U_2_bool (MapType2Select s@@8 e_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= e_4 e_4_1))))
 :qid |stdinbpl.1036:15|
 :skolemid |130|
 :no-pattern (type e_4)
 :no-pattern (type e_4_1)
 :no-pattern (U_2_int e_4)
 :no-pattern (U_2_bool e_4)
 :no-pattern (U_2_int e_4_1)
 :no-pattern (U_2_bool e_4_1)
)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@46 ZeroMask) (= AssumeFunctionsAbove 6)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
