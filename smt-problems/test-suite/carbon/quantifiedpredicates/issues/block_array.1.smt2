...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon6_correct  (=> (and (state Heap@1 Mask@4) (state Heap@1 Mask@4)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@4 (loc a_3@@7 i_1@@6) val)) (=> (HasDirectPerm Mask@4 (loc a_3@@7 i_1@@6) val) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@4 (loc a_3@@7 (+ i_1@@6 1)) val)))))))
(let ((anon9_Else_correct  (=> (not (= (mod i_1@@6 2) 0)) (=> (and (= Mask@4 Mask@1) (= (ControlFlow 0 5) 2)) anon6_correct))))
(let ((anon9_Then_correct  (=> (= (mod i_1@@6 2) 0) (=> (and (and (and (not (= (loc a_3@@7 i_1@@6) null)) (= Mask@2 (MapType1Store Mask@1 (loc a_3@@7 i_1@@6) val (real_2_U (+ (U_2_real (MapType1Select Mask@1 (loc a_3@@7 i_1@@6) val)) FullPerm))))) (and (state Heap@1 Mask@2) (not (= (loc a_3@@7 (+ i_1@@6 1)) null)))) (and (and (= Mask@3 (MapType1Store Mask@2 (loc a_3@@7 (+ i_1@@6 1)) val (real_2_U (+ (U_2_real (MapType1Select Mask@2 (loc a_3@@7 (+ i_1@@6 1)) val)) FullPerm)))) (state Heap@1 Mask@3)) (and (= Mask@4 Mask@3) (= (ControlFlow 0 4) 2)))) anon6_correct))))
(let ((anon8_Else_correct  (=> (and (HasDirectPerm Mask@1 null (access a_3@@7 i_1@@6)) (= Heap@1 Heap@@10)) (and (=> (= (ControlFlow 0 7) 4) anon9_Then_correct) (=> (= (ControlFlow 0 7) 5) anon9_Else_correct)))))
(let ((anon8_Then_correct  (=> (not (HasDirectPerm Mask@1 null (access a_3@@7 i_1@@6))) (=> (and (= Heap@0 (MapType0Store Heap@@10 null (access a_3@@7 i_1@@6) newVersion@0)) (= Heap@1 Heap@0)) (and (=> (= (ControlFlow 0 6) 4) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct))))))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (access a_3@@7 i_1@@6) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (access a_3@@7 i_1@@6))) FullPerm)))) (and (=> (= (ControlFlow 0 8) 6) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (access a_3@@7 i_1@@6))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (access a_3@@7 i_1@@6)))) (=> (= (ControlFlow 0 9) 8) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (= Mask@0 (MapType1Store ZeroMask null (access a_3@@7 i_1@@6) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (access a_3@@7 i_1@@6))) FullPerm)))) (state Heap@@10 Mask@0)) (=> (and (and (= (mod i_1@@6 2) 0) (state Heap@@10 Mask@0)) (and (|access#trigger| Heap@@10 (access a_3@@7 i_1@@6)) (= (MapType0Select Heap@@10 null (access a_3@@7 i_1@@6)) (FrameFragment (ite (= (mod i_1@@6 2) 0) (CombineFrames (FrameFragment (MapType0Select Heap@@10 (loc a_3@@7 i_1@@6) val)) (FrameFragment (MapType0Select Heap@@10 (loc a_3@@7 (+ i_1@@6 1)) val))) EmptyFrame))))) (and (=> (= (ControlFlow 0 12) 9) anon7_Then_correct) (=> (= (ControlFlow 0 12) 11) anon7_Else_correct)))))))
