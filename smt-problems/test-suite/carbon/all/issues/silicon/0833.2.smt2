...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@1) (MapType0Type RefType)) (= (type Mask@3) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@17) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type fn$$0@0) (ShStruct2DomainTypeType RefType RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (forall ((arg0@@37 T@U) (arg1@@16 T@U) ) (! (= (type (CombineFrames arg0@@37 arg1@@16)) FrameTypeType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon6_correct  (=> (state Heap@1 Mask@3) (and (=> (= (ControlFlow 0 3) (- 0 7)) (forall ((i_V0 Int) (i_V0_6 Int) ) (!  (=> (and (and (not (= i_V0 i_V0_6)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (ShStructget0of2 (witness_4e2a3fe_F Heap@1 i_V0)) (ShStructget0of2 (witness_4e2a3fe_F Heap@1 i_V0_6)))))
 :qid |stdinbpl.594:15|
 :skolemid |48|
))) (=> (forall ((i_V0@@0 Int) (i_V0_6@@0 Int) ) (!  (=> (and (and (not (= i_V0@@0 i_V0_6@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (ShStructget0of2 (witness_4e2a3fe_F Heap@1 i_V0@@0)) (ShStructget0of2 (witness_4e2a3fe_F Heap@1 i_V0_6@@0)))))
 :qid |stdinbpl.594:15|
 :skolemid |48|
)) (=> (and (forall ((i_V0@@1 Int) ) (!  (=> (< NoPerm (/ (to_real 1) (to_real 2))) (and (qpRange3 (ShStructget0of2 (witness_4e2a3fe_F Heap@1 i_V0@@1))) (= (invRecv3 (ShStructget0of2 (witness_4e2a3fe_F Heap@1 i_V0@@1))) i_V0@@1)))
 :qid |stdinbpl.600:22|
 :skolemid |49|
 :pattern ( (ShStructget0of2 (|witness_4e2a3fe_F#frame| EmptyFrame i_V0@@1)))
 :pattern ( (ShStructget0of2 (|witness_4e2a3fe_F#frame| EmptyFrame i_V0@@1)))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange3 o_3)) (= (ShStructget0of2 (witness_4e2a3fe_F Heap@1 (invRecv3 o_3))) o_3)))
 :qid |stdinbpl.604:22|
 :skolemid |50|
 ...
 :qid |stdinbpl.610:15|
 :skolemid |51|
 :pattern ( (ShStructget0of2 (|witness_4e2a3fe_F#frame| EmptyFrame i_V0@@2)))
 :pattern ( (ShStructget0of2 (|witness_4e2a3fe_F#frame| EmptyFrame i_V0@@2)))
))) (=> (forall ((i_V0@@3 Int) ) (! (>= (/ (to_real 1) (to_real 2)) NoPerm)
 :qid |stdinbpl.610:15|
 :skolemid |51|
 :pattern ( (ShStructget0of2 (|witness_4e2a3fe_F#frame| EmptyFrame i_V0@@3)))
 :pattern ( (ShStructget0of2 (|witness_4e2a3fe_F#frame| EmptyFrame i_V0@@3)))
)) (=> (forall ((i_V0@@4 Int) ) (!  (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (not (= (ShStructget0of2 (witness_4e2a3fe_F Heap@1 i_V0@@4)) null)))
 :qid |stdinbpl.616:22|
 :skolemid |52|
 :pattern ( (ShStructget0of2 (|witness_4e2a3fe_F#frame| EmptyFrame i_V0@@4)))
 :pattern ( (ShStructget0of2 (|witness_4e2a3fe_F#frame| EmptyFrame i_V0@@4)))
)) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange3 o_3@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (ShStructget0of2 (witness_4e2a3fe_F Heap@1 (invRecv3 o_3@@0))) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 Intint$$$$_E_$$$)) (+ (U_2_real (MapType1Select Mask@3 o_3@@0 Intint$$$$_E_$$$)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange3 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 Intint$$$$_E_$$$)) (U_2_real (MapType1Select Mask@3 o_3@@0 Intint$$$$_E_$$$))))))
 :qid |stdinbpl.622:22|
 :skolemid |53|
 :pattern ( (MapType1Select QPMask@0 o_3@@0 Intint$$$$_E_$$$))
)) (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 Intint$$$$_E_$$$))) (= (U_2_real (MapType1Select Mask@3 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.626:29|
 :skolemid |54|
 :pattern ( (MapType1Select Mask@3 o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
))) (and (state Heap@1 QPMask@0) (state Heap@1 QPMask@0))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((i_V0_1 Int) (i_V0_1_1 Int) ) (!  (=> (and (and (not (= i_V0_1 i_V0_1_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (ShStructget1of2 (witness_4e2a3fe_F Heap@1 i_V0_1)) (ShStructget1of2 (witness_4e2a3fe_F Heap@1 i_V0_1_1)))))
 :qid |stdinbpl.635:15|
 :skolemid |55|
))) (=> (forall ((i_V0_1@@0 Int) (i_V0_1_1@@0 Int) ) (!  (=> (and (and (not (= i_V0_1@@0 i_V0_1_1@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (ShStructget1of2 (witness_4e2a3fe_F Heap@1 i_V0_1@@0)) (ShStructget1of2 (witness_4e2a3fe_F Heap@1 i_V0_1_1@@0)))))
 :qid |stdinbpl.635:15|
 :skolemid |55|
)) (=> (and (forall ((i_V0_1@@1 Int) ) (!  (=> (< NoPerm (/ (to_real 1) (to_real 2))) (and (qpRange4 (ShStructget1of2 (witness_4e2a3fe_F Heap@1 i_V0_1@@1))) (= (invRecv4 (ShStructget1of2 (witness_4e2a3fe_F Heap@1 i_V0_1@@1))) i_V0_1@@1)))
 :qid |stdinbpl.641:22|
 :skolemid |56|
 :pattern ( (ShStructget1of2 (|witness_4e2a3fe_F#frame| EmptyFrame i_V0_1@@1)))
 :pattern ( (ShStructget1of2 (|witness_4e2a3fe_F#frame| EmptyFrame i_V0_1@@1)))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange4 o_3@@2)) (= (ShStructget1of2 (witness_4e2a3fe_F Heap@1 (invRecv4 o_3@@2))) o_3@@2)))
 :qid |stdinbpl.645:22|
 :skolemid |57|
 ...
 :qid |stdinbpl.651:15|
 :skolemid |58|
 :pattern ( (ShStructget1of2 (|witness_4e2a3fe_F#frame| EmptyFrame i_V0_1@@2)))
 :pattern ( (ShStructget1of2 (|witness_4e2a3fe_F#frame| EmptyFrame i_V0_1@@2)))
))) (=> (forall ((i_V0_1@@3 Int) ) (! (>= (/ (to_real 1) (to_real 2)) NoPerm)
 :qid |stdinbpl.651:15|
 :skolemid |58|
 :pattern ( (ShStructget1of2 (|witness_4e2a3fe_F#frame| EmptyFrame i_V0_1@@3)))
 :pattern ( (ShStructget1of2 (|witness_4e2a3fe_F#frame| EmptyFrame i_V0_1@@3)))
)) (=> (forall ((i_V0_1@@4 Int) ) (!  (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (not (= (ShStructget1of2 (witness_4e2a3fe_F Heap@1 i_V0_1@@4)) null)))
 :qid |stdinbpl.657:22|
 :skolemid |59|
 :pattern ( (ShStructget1of2 (|witness_4e2a3fe_F#frame| EmptyFrame i_V0_1@@4)))
 :pattern ( (ShStructget1of2 (|witness_4e2a3fe_F#frame| EmptyFrame i_V0_1@@4)))
)) (=> (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange4 o_3@@3)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (ShStructget1of2 (witness_4e2a3fe_F Heap@1 (invRecv4 o_3@@3))) o_3@@3)) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 Intint$$$$_E_$$$)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@3 Intint$$$$_E_$$$)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange4 o_3@@3))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 Intint$$$$_E_$$$)) (U_2_real (MapType1Select QPMask@0 o_3@@3 Intint$$$$_E_$$$))))))
 :qid |stdinbpl.663:22|
 :skolemid |60|
 :pattern ( (MapType1Select QPMask@1 o_3@@3 Intint$$$$_E_$$$))
)) (forall ((o_3@@4 T@U) (f_5@@0 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_5@@0))))
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 Intint$$$$_E_$$$))) (= (U_2_real (MapType1Select QPMask@0 o_3@@4 f_5@@0)) (U_2_real (MapType1Select QPMask@1 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.667:29|
 :skolemid |61|
...
(let ((anon9_Else_correct  (=> (HasDirectPerm Mask@3 null SharedInv_4e2a3fe_F) (=> (and (= Heap@1 Heap@@17) (= (ControlFlow 0 9) 3)) anon6_correct))))
(let ((anon9_Then_correct  (=> (and (and (not (HasDirectPerm Mask@3 null SharedInv_4e2a3fe_F)) (= Heap@0 (MapType0Store Heap@@17 null SharedInv_4e2a3fe_F newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 8) 3))) anon6_correct)))
(let ((anon4_correct  (=> (= Mask@3 (MapType1Store Mask@2 null SharedInv_4e2a3fe_F (real_2_U (- (U_2_real (MapType1Select Mask@2 null SharedInv_4e2a3fe_F)) FullPerm)))) (and (=> (= (ControlFlow 0 10) 8) anon9_Then_correct) (=> (= (ControlFlow 0 10) 9) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 10)) anon4_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null SharedInv_4e2a3fe_F)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 null SharedInv_4e2a3fe_F))) (=> (= (ControlFlow 0 11) 10) anon4_correct))))))
(let ((anon7_Else_correct  (=> (and (= fn$$0@0 (witness_4e2a3fe_F Heap@@17 id_V0)) (= perm@0 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= (ShStructget0of2 fn$$0@0) null))) (= Mask@0 (MapType1Store ZeroMask (ShStructget0of2 fn$$0@0) Intint$$$$_E_$$$ (real_2_U (+ (U_2_real (MapType1Select ZeroMask (ShStructget0of2 fn$$0@0) Intint$$$$_E_$$$)) perm@0))))) (and (state Heap@@17 Mask@0) (= perm@1 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (=> (> perm@1 NoPerm) (not (= (ShStructget1of2 fn$$0@0) null))) (=> (and (and (= Mask@1 (MapType1Store Mask@0 (ShStructget1of2 fn$$0@0) Intint$$$$_E_$$$ (real_2_U (+ (U_2_real (MapType1Select Mask@0 (ShStructget1of2 fn$$0@0) Intint$$$$_E_$$$)) perm@1)))) (state Heap@@17 Mask@1)) (and (state Heap@@17 Mask@1) (= Mask@2 (MapType1Store Mask@1 null SharedInv_4e2a3fe_F (real_2_U (+ (U_2_real (MapType1Select Mask@1 null SharedInv_4e2a3fe_F)) FullPerm)))))) (=> (and (and (and (state Heap@@17 Mask@2) (state Heap@@17 Mask@2)) (and (= id_V0_CN0 0) (state Heap@@17 Mask@2))) (and (and (state Heap@@17 Mask@2) (state Heap@@17 Mask@2)) (and (|SharedInv_4e2a3fe_F#trigger| Heap@@17 SharedInv_4e2a3fe_F) (= (MapType0Select Heap@@17 null SharedInv_4e2a3fe_F) (CombineFrames (FrameFragment (int_2_U (|SharedInv_4e2a3fe_F#condqp1| Heap@@17))) (FrameFragment (int_2_U (|SharedInv_4e2a3fe_F#condqp2| Heap@@17)))))))) (and (=> (= (ControlFlow 0 14) 11) anon8_Then_correct) (=> (= (ControlFlow 0 14) 13) anon8_Else_correct)))))))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 17) 1) anon7_Then_correct) (=> (= (ControlFlow 0 17) 14) anon7_Else_correct)))))
