...
(assert  (and (and (= (type Heap@@17) (MapType0Type RefType)) (= (type x@@11) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon4_correct true))
(let ((anon9_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i1@@1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i2@@1)) (not (= i1@@1 i2@@1))))) (= (ControlFlow 0 9) 6)) anon4_correct)))
(let ((anon9_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i1@@1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i2@@1)) (not (= i1@@1 i2@@1)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (not (= (|Seq#Index| (|Seq#Singleton| x@@11) i1@@1) (|Seq#Index| (|Seq#Singleton| x@@11) i2@@1)))) (=> (not (= (|Seq#Index| (|Seq#Singleton| x@@11) i1@@1) (|Seq#Index| (|Seq#Singleton| x@@11) i2@@1))) (=> (= (ControlFlow 0 7) 6) anon4_correct))))))
(let ((anon8_Else_correct  (=> (forall ((i1_1_1 Int) (i2_1_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i1_1_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i2_1_1)) (not (= i1_1_1 i2_1_1)))) (not (= (|Seq#Index| (|Seq#Singleton| x@@11) i1_1_1) (|Seq#Index| (|Seq#Singleton| x@@11) i2_1_1))))
...
)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((i@@6 Int) (i_6 Int) ) (!  (=> (and (and (and (and (not (= i@@6 i_6)) (and (<= 0 i@@6) (< i@@6 (|Seq#Length| (|Seq#Singleton| x@@11))))) (and (<= 0 i_6) (< i_6 (|Seq#Length| (|Seq#Singleton| x@@11))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (|Seq#Singleton| x@@11) i@@6) (|Seq#Index| (|Seq#Singleton| x@@11) i_6))))
 :qid |stdinbpl.1013:21|
 :skolemid |92|
 :pattern ( (neverTriggered4 i@@6) (neverTriggered4 i_6))
 ...
 :qid |stdinbpl.1013:21|
 :skolemid |92|
 :pattern ( (neverTriggered4 i@@7) (neverTriggered4 i_6@@0))
)) (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((i@@8 Int) ) (!  (=> (and (<= 0 i@@8) (< i@@8 (|Seq#Length| (|Seq#Singleton| x@@11)))) (>= (U_2_real (MapType1Select Mask@0 (|Seq#Index| (|Seq#Singleton| x@@11) i@@8) f_7)) FullPerm))
 :qid |stdinbpl.1020:21|
 :skolemid |93|
 :pattern ( (|Seq#Index| (|Seq#Singleton| x@@11) i@@8))
 :pattern ( (|Seq#Index| (|Seq#Singleton| x@@11) i@@8))
))))))))
(let ((anon7_Then_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (< 0 (|Seq#Length| (|Seq#Singleton| x@@11)))) (=> (< 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (and (and (=> (= (ControlFlow 0 10) 4) anon8_Else_correct) (=> (= (ControlFlow 0 10) 7) anon9_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon9_Else_correct))))))
(let ((anon7_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= (fun Heap@@17 (|Seq#Singleton| x@@11)) 1))))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@17 x@@11 $allocated)) (not (= x@@11 null))) (and (= Mask@0 (MapType1Store ZeroMask x@@11 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@11 f_7)) FullPerm)))) (state Heap@@17 Mask@0))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm Mask@0 x@@11 f_7)) (=> (HasDirectPerm Mask@0 x@@11 f_7) (=> (and (= (U_2_int (MapType0Select Heap@@17 x@@11 f_7)) 1) (state Heap@@17 Mask@0)) (and (=> (= (ControlFlow 0 12) 10) anon7_Then_correct) (=> (= (ControlFlow 0 12) 2) anon7_Else_correct)))))))))
