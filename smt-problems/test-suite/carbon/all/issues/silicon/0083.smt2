...
(assert (= (type Heap@@12) (MapType0Type RefType)))
(set-info :boogie-vc-id test1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@12 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (= (ControlFlow 0 2) (- 0 3))) false))))
