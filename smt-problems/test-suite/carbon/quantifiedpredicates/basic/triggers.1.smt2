...
(assert  (and (and (and (and (and (and (= (type xs) (SeqType RefType)) (= (type x_3) RefType)) (= (type Heap@@18) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type y@@2) RefType)) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv4 arg0@@45)) RefType)
 :qid |funType:invRecv4|
 :pattern ( (invRecv4 arg0@@45))
))) (= (type r_1@@13) RefType)))
(set-info :boogie-vc-id t4a)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon16_Then_correct true))
(let ((anon9_correct true))
(let ((anon15_Then_correct  (=> (|Seq#Contains| xs y@@2) (and (=> (= (ControlFlow 0 11) 10) anon16_Then_correct) (=> (= (ControlFlow 0 11) 8) anon9_correct)))))
(let ((anon15_Else_correct  (=> (and (not (|Seq#Contains| xs y@@2)) (= (ControlFlow 0 9) 8)) anon9_correct)))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((y_1 T@U) (y_1_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (= (type y_1_1) RefType)) (=> (and (and (and (and (not (= y_1 y_1_1)) (|Seq#Contains| xs y_1)) (|Seq#Contains| xs y_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (fun2 Heap@@18 y_1) (fun2 Heap@@18 y_1_1)))))
 :qid |stdinbpl.1080:17|
 :skolemid |98|
 :pattern ( (neverTriggered5 y_1) (neverTriggered5 y_1_1))
))) (=> (forall ((y_1@@0 T@U) (y_1_1@@0 T@U) ) (!  (=> (and (= (type y_1@@0) RefType) (= (type y_1_1@@0) RefType)) (=> (and (and (and (and (not (= y_1@@0 y_1_1@@0)) (|Seq#Contains| xs y_1@@0)) (|Seq#Contains| xs y_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (fun2 Heap@@18 y_1@@0) (fun2 Heap@@18 y_1_1@@0)))))
 :qid |stdinbpl.1080:17|
 :skolemid |98|
 :pattern ( (neverTriggered5 y_1@@0) (neverTriggered5 y_1_1@@0))
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((y_1@@1 T@U) ) (!  (=> (and (= (type y_1@@1) RefType) (|Seq#Contains| xs y_1@@1)) (>= (U_2_real (MapType1Select QPMask@0 null (pred (fun2 Heap@@18 y_1@@1)))) FullPerm))
 :qid |stdinbpl.1087:17|
 :skolemid |99|
 :pattern ( (MapType0Select Heap@@18 null (pred (|fun2#frame| EmptyFrame y_1@@1))))
 :pattern ( (MapType1Select QPMask@0 null (pred (|fun2#frame| EmptyFrame y_1@@1))))
 :pattern ( (|fun#frame| EmptyFrame y_1@@1 i@@10))
)))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| xs x_1)) (|Seq#Contains| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (fun Heap@@18 x_1 i@@10) (fun Heap@@18 x_1_1 i@@10)))))
 :qid |stdinbpl.1022:17|
 :skolemid |92|
...
)) (=> (and (and (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| xs x_1@@1) (< NoPerm FullPerm)) (and (= (invRecv4 (fun Heap@@18 x_1@@1 i@@10)) x_1@@1) (qpRange4 (fun Heap@@18 x_1@@1 i@@10)))))
...
)) (forall ((r_1_1 T@U) ) (!  (=> (= (type r_1_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv4 r_1_1)) (< NoPerm FullPerm)) (qpRange4 r_1_1)) (= (fun Heap@@18 (invRecv4 r_1_1) i@@10) r_1_1)))
 :qid |stdinbpl.1032:22|
 :skolemid |94|
 :pattern ( (invRecv4 r_1_1))
))) (and (forall ((r_1_1@@0 T@U) ) (!  (=> (= (type r_1_1@@0) RefType) (=> (and (and (|Seq#Contains| xs (invRecv4 r_1_1@@0)) (< NoPerm FullPerm)) (qpRange4 r_1_1@@0)) (and (=> (< NoPerm FullPerm) (= (fun Heap@@18 (invRecv4 r_1_1@@0) i@@10) r_1_1@@0)) (= (U_2_real (MapType1Select QPMask@0 null (pred r_1_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (pred r_1_1@@0))) FullPerm)))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.1044:29|
 :skolemid |96|
 :pattern ( (MapType1Select ZeroMask o_3 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3 f_5))
)))) (and (and (forall ((r_1_1@@1 T@U) ) (!  (=> (and (= (type r_1_1@@1) RefType) (not (and (and (|Seq#Contains| xs (invRecv4 r_1_1@@1)) (< NoPerm FullPerm)) (qpRange4 r_1_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (pred r_1_1@@1))) (U_2_real (MapType1Select ZeroMask null (pred r_1_1@@1)))))
 :qid |stdinbpl.1048:22|
 :skolemid |97|
 :pattern ( (MapType1Select QPMask@0 null (pred r_1_1@@1)))
)) (state Heap@@18 QPMask@0)) (and (state Heap@@18 QPMask@0) (state Heap@@18 QPMask@0)))) (and (and (=> (= (ControlFlow 0 12) 6) anon14_Else_correct) (=> (= (ControlFlow 0 12) 11) anon15_Then_correct)) (=> (= (ControlFlow 0 12) 9) anon15_Else_correct)))))))
(let ((anon13_Then_correct true))
(let ((anon4_correct true))
(let ((anon12_Then_correct  (=> (|Seq#Contains| xs x_3) (and (=> (= (ControlFlow 0 4) 3) anon13_Then_correct) (=> (= (ControlFlow 0 4) 1) anon4_correct)))))
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains| xs x_3)) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (and (and (state Heap@@18 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@18 r_1@@13 $allocated)) (state Heap@@18 ZeroMask))) (and (and (=> (= (ControlFlow 0 14) 12) anon11_Else_correct) (=> (= (ControlFlow 0 14) 4) anon12_Then_correct)) (=> (= (ControlFlow 0 14) 2) anon12_Else_correct)))))
