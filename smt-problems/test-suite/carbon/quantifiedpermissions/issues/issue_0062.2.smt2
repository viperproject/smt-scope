...
(declare-fun y@@7 () T@U)
(declare-fun z@@0 () T@U)
(assert  (and (and (and (and (and (and (= (type xs) (MapType2Type RefType boolType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@52 T@U) ) (! (= (type (invRecv1 arg0@@52)) RefType)
 :qid |funType:invRecv1|
 :pattern ( (invRecv1 arg0@@52))
))) (= (type x@@22) RefType)) (= (type y@@7) RefType)) (= (type z@@0) RefType)))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((q_1 T@U) (q_1_1 T@U) ) (!  (=> (and (= (type q_1) RefType) (= (type q_1_1) RefType)) (=> (and (and (and (and (not (= q_1 q_1_1)) (U_2_bool (MapType2Select xs q_1))) (U_2_bool (MapType2Select xs q_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= q_1 q_1_1))))
 :qid |stdinbpl.839:15|
 :skolemid |118|
 :no-pattern (type q_1)
 :no-pattern (type q_1_1)
 :no-pattern (U_2_int q_1)
 :no-pattern (U_2_bool q_1)
 :no-pattern (U_2_int q_1_1)
 :no-pattern (U_2_bool q_1_1)
))) (=> (forall ((q_1@@0 T@U) (q_1_1@@0 T@U) ) (!  (=> (and (= (type q_1@@0) RefType) (= (type q_1_1@@0) RefType)) (=> (and (and (and (and (not (= q_1@@0 q_1_1@@0)) (U_2_bool (MapType2Select xs q_1@@0))) (U_2_bool (MapType2Select xs q_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= q_1@@0 q_1_1@@0))))
 :qid |stdinbpl.839:15|
 :skolemid |118|
 :no-pattern (type q_1@@0)
 :no-pattern (type q_1_1@@0)
 :no-pattern (U_2_int q_1@@0)
 :no-pattern (U_2_bool q_1@@0)
 :no-pattern (U_2_int q_1_1@@0)
 :no-pattern (U_2_bool q_1_1@@0)
)) (=> (and (and (and (forall ((q_1@@1 T@U) ) (!  (=> (= (type q_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs q_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 q_1@@1) (= (invRecv1 q_1@@1) q_1@@1))))
 :qid |stdinbpl.845:22|
 :skolemid |119|
 :pattern ( (MapType0Select Heap@@9 q_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 q_1@@1 f_7))
 :pattern ( (MapType2Select xs q_1@@1))
...
))) (and (forall ((q_1@@2 T@U) ) (!  (=> (and (= (type q_1@@2) RefType) (U_2_bool (MapType2Select xs q_1@@2))) (not (= q_1@@2 null)))
 :qid |stdinbpl.855:22|
 :skolemid |121|
 :pattern ( (MapType0Select Heap@@9 q_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 q_1@@2 f_7))
 :pattern ( (MapType2Select xs q_1@@2))
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (= (ControlFlow 0 3) (- 0 2))))) (not (= x@@22 y@@7)))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@22 $allocated))) (and (U_2_bool (MapType0Select Heap@@9 y@@7 $allocated)) (U_2_bool (MapType0Select Heap@@9 z@@0 $allocated)))) (and (and (U_2_bool (MapType2Select xs x@@22)) (U_2_bool (MapType2Select xs y@@7))) (and (U_2_bool (MapType2Select xs z@@0)) (state Heap@@9 ZeroMask)))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct)))))
