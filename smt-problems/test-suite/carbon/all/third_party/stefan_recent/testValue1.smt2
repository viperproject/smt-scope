...
(assert  (and (and (and (and (and (= (type t1) RefType) (= (type t2) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type diz) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id Test__main1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct true))
(let ((anon3_Then_correct  (=> (and (= t1 t2) (= (ControlFlow 0 2) (- 0 1))) false)))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 diz $allocated))) (=> (and (and (and (and (U_2_bool (MapType0Select Heap@@9 t1 $allocated)) (U_2_bool (MapType0Select Heap@@9 t2 $allocated))) (and (not (= diz null)) (state Heap@@9 ZeroMask))) (and (and (>= current_thread_id 0) (state Heap@@9 ZeroMask)) (and (> wildcard@0 NoPerm) (not (= t1 null))))) (and (and (and (= Mask@0 (MapType1Store ZeroMask t1 Test__next (real_2_U (+ (U_2_real (MapType1Select ZeroMask t1 Test__next)) wildcard@0)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (> wildcard@1 NoPerm))) (and (and (not (= t2 null)) (= Mask@1 (MapType1Store Mask@0 t2 Test__next (real_2_U (+ (U_2_real (MapType1Select Mask@0 t2 Test__next)) wildcard@1))))) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1))))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (HasDirectPerm Mask@1 t1 Test__next)) (=> (HasDirectPerm Mask@1 t1 Test__next) (=> (and (not (= (MapType0Select Heap@@9 t1 Test__next) null)) (state Heap@@9 Mask@1)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@1 t2 Test__next)) (=> (HasDirectPerm Mask@1 t2 Test__next) (=> (and (not (= (MapType0Select Heap@@9 t2 Test__next) null)) (state Heap@@9 Mask@1)) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (> wildcard NoPerm) true) (= (ControlFlow 0 7) 4)) anon0_correct)))
