...
(assert  (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type r_1) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id t10)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon6_Else_correct  (=> (and (and (not (< j@0 (U_2_int (MapType0Select Heap@@9 r_1 f_7)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@0 r_1 f_7)) (=> (HasDirectPerm Mask@0 r_1 f_7) (=> (= (ControlFlow 0 5) (- 0 4)) (>= j@0 (U_2_int (MapType0Select Heap@@9 r_1 f_7)))))))))
(let ((anon6_Then_correct  (=> (state Heap@@9 ZeroMask) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 3) (- 0 2))) (HasDirectPerm ZeroMask r_1 f_7)))))
