...
(assert  (and (and (and (and (and (and (and (forall ((arg0@@30 T@T) (arg1@@12 T@T) ) (! (= (Ctor (MapType2Type arg0@@30 arg1@@12)) 12)
...
(assert  (and (= (type S) (MapType2Type intType boolType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id test)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon6_correct true))
(let ((anon9_Else_correct  (=> (and (< 0 x@@19) (= (ControlFlow 0 4) 1)) anon6_correct)))
(let ((anon9_Then_correct  (=> (<= x@@19 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (U_2_bool (MapType2Select S (int_2_U x@@19))))) (=> (not (U_2_bool (MapType2Select S (int_2_U x@@19)))) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) 1)) anon6_correct))))))
(let ((anon4_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 5) 2) anon9_Then_correct) (=> (= (ControlFlow 0 5) 4) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (not (U_2_bool (MapType2Select S (int_2_U x@@19)))) (= (ControlFlow 0 8) 5)) anon4_correct)))
(let ((anon8_Then_correct  (=> (U_2_bool (MapType2Select S (int_2_U x@@19))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (> x@@19 0)) (=> (> x@@19 0) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 6) 5)) anon4_correct))))))
(let ((anon2_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 9) 6) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (not (U_2_bool (MapType2Select S (int_2_U x@@19)))) (= (ControlFlow 0 11) 9)) anon2_correct)))
(let ((anon7_Then_correct  (=> (U_2_bool (MapType2Select S (int_2_U x@@19))) (=> (and (> x@@19 0) (= (ControlFlow 0 10) 9)) anon2_correct))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 12) 10) anon7_Then_correct) (=> (= (ControlFlow 0 12) 11) anon7_Else_correct)))))
