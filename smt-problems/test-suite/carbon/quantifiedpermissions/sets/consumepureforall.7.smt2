...
(declare-fun b_2 () T@U)
(assert  (and (and (and (and (= (type S) (MapType2Type RefType boolType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv18 arg0@@43)) RefType)
 :qid |funType:invRecv18|
 :pattern ( (invRecv18 arg0@@43))
))) (= (type b_2) RefType)))
(set-info :boogie-vc-id m5)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((s_1 T@U) (s_1_1 T@U) ) (!  (=> (and (= (type s_1) RefType) (= (type s_1_1) RefType)) (=> (and (and (and (and (not (= s_1 s_1_1)) (U_2_bool (MapType2Select S s_1))) (U_2_bool (MapType2Select S s_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1 s_1_1))))
...
)) (=> (and (forall ((s_1@@1 T@U) ) (!  (=> (= (type s_1@@1) RefType) (=> (and (U_2_bool (MapType2Select S s_1@@1)) (< NoPerm FullPerm)) (and (qpRange18 s_1@@1) (= (invRecv18 s_1@@1) s_1@@1))))
...
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select S (invRecv18 o_3))) (< NoPerm FullPerm)) (qpRange18 o_3)) (= (invRecv18 o_3) o_3)))
 :qid |stdinbpl.1740:22|
 :skolemid |199|
 :pattern ( (invRecv18 o_3))
))) (=> (and (and (and (forall ((s_1@@2 T@U) ) (!  (=> (and (= (type s_1@@2) RefType) (U_2_bool (MapType2Select S s_1@@2))) (not (= s_1@@2 null)))
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select S (invRecv18 o_3@@0))) (< NoPerm FullPerm)) (qpRange18 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv18 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select S (invRecv18 o_3@@0))) (< NoPerm FullPerm)) (qpRange18 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
)) (state Heap@@9 QPMask@0))) (and (and (state Heap@@9 QPMask@0) (U_2_bool (MapType2Select S b_2))) (and (state Heap@@9 QPMask@0) (= (ControlFlow 0 3) (- 0 2))))) (HasDirectPerm QPMask@0 b_2 f_7)))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 b_2 $allocated))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct)))))
