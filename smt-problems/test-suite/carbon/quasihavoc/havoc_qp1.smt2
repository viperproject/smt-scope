...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type s@@3) (MapType2Type RefType boolType)) (= (type a_3) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type a_4) RefType)) (= (type x@@19) RefType)) (= (type Mask@3) (MapType1Type RefType realType))) (= (type a_5) RefType)) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type y@@6) RefType)) (= (type z@@0) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv1 arg0@@43)) RefType)
...
(let ((anon24_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select s@@3 a_5)) (not (= a_5 x@@19)))) (= (ControlFlow 0 14) 11)) anon15_correct)))
(let ((anon24_Then_correct  (=> (and (U_2_bool (MapType2Select s@@3 a_5)) (not (= a_5 x@@19))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (= (U_2_int (MapType0Select ExhaleHeap@0 a_5 f_7)) 3)) (=> (= (U_2_int (MapType0Select ExhaleHeap@0 a_5 f_7)) 3) (=> (= (ControlFlow 0 12) 11) anon15_correct))))))
(let ((anon11_correct true))
(let ((anon22_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select s@@3 a_4)) (not (= a_4 x@@19)))) (= (ControlFlow 0 10) 7)) anon11_correct)))
(let ((anon22_Then_correct  (=> (and (U_2_bool (MapType2Select s@@3 a_4)) (not (= a_4 x@@19))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm Mask@3 a_4 f_7)) (=> (HasDirectPerm Mask@3 a_4 f_7) (=> (= (ControlFlow 0 8) 7) anon11_correct))))))
(let ((anon23_Else_correct true))
(let ((anon8_correct  (=> (= Mask@2 (MapType1Store Mask@1 x@@19 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 x@@19 f_7)) perm_temp_quasihavoc_@0)))) (=> (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)) (and (=> (= (ControlFlow 0 15) (- 0 22)) (>= perm_temp_quasihavoc_@0 NoPerm)) (=> (>= perm_temp_quasihavoc_@0 NoPerm) (=> (=> (> perm_temp_quasihavoc_@0 NoPerm) (not (= x@@19 null))) (=> (and (and (= Mask@3 (MapType1Store Mask@2 x@@19 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@2 x@@19 f_7)) perm_temp_quasihavoc_@0)))) (state ExhaleHeap@0 Mask@3)) (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3))) (and (=> (= (ControlFlow 0 15) (- 0 21)) (HasDirectPerm Mask@3 y@@6 f_7)) (=> (HasDirectPerm Mask@3 y@@6 f_7) (and (=> (= (ControlFlow 0 15) (- 0 20)) (= (U_2_int (MapType0Select ExhaleHeap@0 y@@6 f_7)) 3)) (=> (= (U_2_int (MapType0Select ExhaleHeap@0 y@@6 f_7)) 3) (=> (state ExhaleHeap@0 Mask@3) (and (=> (= (ControlFlow 0 15) (- 0 19)) (HasDirectPerm Mask@3 z@@0 f_7)) (=> (HasDirectPerm Mask@3 z@@0 f_7) (and (=> (= (ControlFlow 0 15) (- 0 18)) (= (U_2_int (MapType0Select ExhaleHeap@0 z@@0 f_7)) 3)) (=> (= (U_2_int (MapType0Select ExhaleHeap@0 z@@0 f_7)) 3) (=> (state ExhaleHeap@0 Mask@3) (and (=> (= (ControlFlow 0 15) (- 0 17)) (HasDirectPerm Mask@3 x@@19 g)) (=> (HasDirectPerm Mask@3 x@@19 g) (and (=> (= (ControlFlow 0 15) (- 0 16)) (= (U_2_int (MapType0Select ExhaleHeap@0 x@@19 g)) 3)) (=> (= (U_2_int (MapType0Select ExhaleHeap@0 x@@19 g)) 3) (=> (state ExhaleHeap@0 Mask@3) (and (and (and (and (=> (= (ControlFlow 0 15) 6) anon23_Else_correct) (=> (= (ControlFlow 0 15) 12) anon24_Then_correct)) (=> (= (ControlFlow 0 15) 14) anon24_Else_correct)) (=> (= (ControlFlow 0 15) 8) anon22_Then_correct)) (=> (= (ControlFlow 0 15) 10) anon22_Else_correct)))))))))))))))))))))))))
(let ((anon20_Else_correct  (=> (and (= perm_temp_quasihavoc_@0 NoPerm) (= (ControlFlow 0 25) 15)) anon8_correct)))
(let ((anon20_Then_correct  (=> (not (= perm_temp_quasihavoc_@0 NoPerm)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (<= perm_temp_quasihavoc_@0 (U_2_real (MapType1Select Mask@1 x@@19 f_7)))) (=> (<= perm_temp_quasihavoc_@0 (U_2_real (MapType1Select Mask@1 x@@19 f_7))) (=> (= (ControlFlow 0 23) 15) anon8_correct))))))
(let ((anon18_Else_correct  (=> (forall ((a_3_1 T@U) ) (!  (=> (and (= (type a_3_1) RefType) (U_2_bool (MapType2Select s@@3 a_3_1))) (= (U_2_int (MapType0Select Heap@@9 a_3_1 f_7)) 3))
 :qid |stdinbpl.469:20|
 :skolemid |88|
 :pattern ( (MapType2Select s@@3 a_3_1))
)) (=> (and (state Heap@@9 QPMask@0) (U_2_bool (MapType2Select s@@3 x@@19))) (=> (and (and (state Heap@@9 QPMask@0) (not (= y@@6 null))) (and (= Mask@0 (MapType1Store QPMask@0 y@@6 f_7 (real_2_U (+ (U_2_real (MapType1Select QPMask@0 y@@6 f_7)) FullPerm)))) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 26) (- 0 29)) (HasDirectPerm Mask@0 y@@6 f_7)) (=> (HasDirectPerm Mask@0 y@@6 f_7) (=> (and (and (and (= (U_2_int (MapType0Select Heap@@9 y@@6 f_7)) 3) (state Heap@@9 Mask@0)) (and (U_2_bool (MapType2Select s@@3 z@@0)) (not (= z@@0 x@@19)))) (and (and (state Heap@@9 Mask@0) (not (= x@@19 null))) (and (= Mask@1 (MapType1Store Mask@0 x@@19 g (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@19 g)) FullPerm)))) (state Heap@@9 Mask@1)))) (and (=> (= (ControlFlow 0 26) (- 0 28)) (HasDirectPerm Mask@1 x@@19 g)) (=> (HasDirectPerm Mask@1 x@@19 g) (=> (and (and (= (U_2_int (MapType0Select Heap@@9 x@@19 g)) 3) (state Heap@@9 Mask@1)) (and (= perm_temp_quasihavoc_@0 (U_2_real (MapType1Select Mask@1 x@@19 f_7))) (state Heap@@9 Mask@1))) (and (=> (= (ControlFlow 0 26) (- 0 27)) (>= perm_temp_quasihavoc_@0 NoPerm)) (=> (>= perm_temp_quasihavoc_@0 NoPerm) (and (=> (= (ControlFlow 0 26) 23) anon20_Then_correct) (=> (= (ControlFlow 0 26) 25) anon20_Else_correct)))))))))))))))
(let ((anon5_correct true))
(let ((anon19_Else_correct  (=> (and (not (U_2_bool (MapType2Select s@@3 a_3))) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon19_Then_correct  (=> (U_2_bool (MapType2Select s@@3 a_3)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 a_3 f_7)) (=> (HasDirectPerm QPMask@0 a_3 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 30) (- 0 31)) (forall ((a_1 T@U) (a_1_1 T@U) ) (!  (=> (and (= (type a_1) RefType) (= (type a_1_1) RefType)) (=> (and (and (and (and (not (= a_1 a_1_1)) (U_2_bool (MapType2Select s@@3 a_1))) (U_2_bool (MapType2Select s@@3 a_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1 a_1_1))))
 :qid |stdinbpl.428:15|
 :skolemid |82|
 :no-pattern (type a_1)
...
)) (=> (and (forall ((a_1@@1 T@U) ) (!  (=> (= (type a_1@@1) RefType) (=> (and (U_2_bool (MapType2Select s@@3 a_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 a_1@@1) (= (invRecv1 a_1@@1) a_1@@1))))
 :qid |stdinbpl.434:22|
 :skolemid |83|
 :pattern ( (MapType0Select Heap@@9 a_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 a_1@@1 f_7))
 :pattern ( (MapType2Select s@@3 a_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select s@@3 (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.438:22|
 :skolemid |84|
 :pattern ( (invRecv1 o_3))
))) (=> (and (and (forall ((a_1@@2 T@U) ) (!  (=> (and (= (type a_1@@2) RefType) (U_2_bool (MapType2Select s@@3 a_1@@2))) (not (= a_1@@2 null)))
 :qid |stdinbpl.444:22|
 :skolemid |85|
 :pattern ( (MapType0Select Heap@@9 a_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 a_1@@2 f_7))
 :pattern ( (MapType2Select s@@3 a_1@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select s@@3 (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select s@@3 (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.450:22|
 :skolemid |86|
...
)) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 30) 26) anon18_Else_correct) (=> (= (ControlFlow 0 30) 3) anon19_Then_correct)) (=> (= (ControlFlow 0 30) 5) anon19_Else_correct))))))))
(let ((anon17_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@19 $allocated))) (and (U_2_bool (MapType0Select Heap@@9 y@@6 $allocated)) (U_2_bool (MapType0Select Heap@@9 z@@0 $allocated)))) (and (=> (= (ControlFlow 0 32) 1) anon17_Then_correct) (=> (= (ControlFlow 0 32) 30) anon17_Else_correct)))))
