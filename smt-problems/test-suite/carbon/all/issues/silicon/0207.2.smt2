...
(declare-fun |set#trigger| (T@U) Bool)
...
(declare-fun |sk_List#condqp1| (Int Int) T@U)
(declare-fun NoPerm () Real)
(declare-fun FullPerm () Real)
(declare-fun |List#condqp2| (T@U T@U) Int)
(declare-fun |sk_List#condqp2| (Int Int) T@U)
...
(declare-fun set (T@U) T@U)
(declare-fun |set#triggerStateless| () T@U)
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((arg0@@11 T@T) (arg1 T@T) ) (! (= (Ctor (FieldType arg0@@11 arg1)) 6)
 :qid |ctor:FieldType|
...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (Ctor RefType) 8)) (= (type next) (FieldType NormalFieldType RefType))) (= (type val) (FieldType NormalFieldType intType))) (forall ((arg0@@14 T@T) (arg1@@2 T@T) ) (! (= (Ctor (MapType0Type arg0@@14 arg1@@2)) 9)
...
))) (forall ((m T@U) (x0 T@U) (val@@0 T@U) ) (! (let ((aVar1@@1 (MapType0TypeInv1 (type m))))
 (=> (= (type val@@0) aVar1@@1) (= (MapType0Select (MapType0Store m x0 val@@0) x0) val@@0)))
 :qid |mapAx0:MapType0Select|
 :weight 0
))) (and (forall ((val@@1 T@U) (m@@0 T@U) (x0@@0 T@U) (y0 T@U) ) (!  (or (= x0@@0 y0) (= (MapType0Select (MapType0Store m@@0 x0@@0 val@@1) y0) (MapType0Select m@@0 y0)))
 :qid |mapAx1:MapType0Select:0|
 :weight 0
)) (forall ((val@@2 T@U) (m@@1 T@U) (x0@@1 T@U) (y0@@0 T@U) ) (!  (or true (= (MapType0Select (MapType0Store m@@1 x0@@1 val@@2) y0@@0) (MapType0Select m@@1 y0@@0)))
...
))) (forall ((m@@2 T@U) (x0@@2 T@U) (x1 T@U) (val@@3 T@U) ) (! (let ((B@@0 (FieldTypeInv1 (type x1))))
 (=> (= (type val@@3) B@@0) (= (MapType1Select (MapType1Store m@@2 x0@@2 x1 val@@3) x0@@2 x1) val@@3)))
 :qid |mapAx0:MapType1Select|
 :weight 0
))) (and (and (forall ((val@@4 T@U) (m@@3 T@U) (x0@@3 T@U) (x1@@0 T@U) (y0@@1 T@U) (y1 T@U) ) (!  (or (= x0@@3 y0@@1) (= (MapType1Select (MapType1Store m@@3 x0@@3 x1@@0 val@@4) y0@@1 y1) (MapType1Select m@@3 y0@@1 y1)))
 :qid |mapAx1:MapType1Select:0|
 :weight 0
)) (forall ((val@@5 T@U) (m@@4 T@U) (x0@@4 T@U) (x1@@1 T@U) (y0@@2 T@U) (y1@@0 T@U) ) (!  (or (= x1@@1 y1@@0) (= (MapType1Select (MapType1Store m@@4 x0@@4 x1@@1 val@@5) y0@@2 y1@@0) (MapType1Select m@@4 y0@@2 y1@@0)))
 :qid |mapAx1:MapType1Select:1|
 :weight 0
))) (forall ((val@@6 T@U) (m@@5 T@U) (x0@@5 T@U) (x1@@2 T@U) (y0@@3 T@U) (y1@@1 T@U) ) (!  (or true (= (MapType1Select (MapType1Store m@@5 x0@@5 x1@@2 val@@6) y0@@3 y1@@1) (MapType1Select m@@5 y0@@3 y1@@1)))
...
))) (forall ((m@@6 T@U) (x0@@6 T@U) (x1@@3 T@U) (val@@7 T@U) ) (! (let ((aVar1@@4 (MapType2TypeInv1 (type m@@6))))
 (=> (= (type val@@7) aVar1@@4) (= (MapType2Select (MapType2Store m@@6 x0@@6 x1@@3 val@@7) x0@@6 x1@@3) val@@7)))
 :qid |mapAx0:MapType2Select|
 :weight 0
))) (and (and (forall ((val@@8 T@U) (m@@7 T@U) (x0@@7 T@U) (x1@@4 T@U) (y0@@4 T@U) (y1@@2 T@U) ) (!  (or (= x0@@7 y0@@4) (= (MapType2Select (MapType2Store m@@7 x0@@7 x1@@4 val@@8) y0@@4 y1@@2) (MapType2Select m@@7 y0@@4 y1@@2)))
 :qid |mapAx1:MapType2Select:0|
 :weight 0
)) (forall ((val@@9 T@U) (m@@8 T@U) (x0@@8 T@U) (x1@@5 T@U) (y0@@5 T@U) (y1@@3 T@U) ) (!  (or (= x1@@5 y1@@3) (= (MapType2Select (MapType2Store m@@8 x0@@8 x1@@5 val@@9) y0@@5 y1@@3) (MapType2Select m@@8 y0@@5 y1@@3)))
 :qid |mapAx1:MapType2Select:1|
 :weight 0
))) (forall ((val@@10 T@U) (m@@9 T@U) (x0@@9 T@U) (x1@@6 T@U) (y0@@6 T@U) (y1@@4 T@U) ) (!  (or true (= (MapType2Select (MapType2Store m@@9 x0@@9 x1@@6 val@@10) y0@@6 y1@@4) (MapType2Select m@@9 y0@@6 y1@@4)))
...
(assert  (and (= (Ctor PredicateType_ListType) 14) (forall ((arg0@@35 T@U) ) (! (= (type (List arg0@@35)) (FieldType PredicateType_ListType FrameTypeType))
 :qid |funType:List|
 :pattern ( (List arg0@@35))
))))
...
(assert (forall ((Heap@@2 T@U) (this@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType1Type RefType)) (= (type this@@0) RefType)) (dummyFunction (int_2_U (|length#triggerStateless| this@@0))))
 :qid |stdinbpl.469:15|
 :skolemid |87|
 :pattern ( (|length'| Heap@@2 this@@0))
)))
(assert (forall ((Heap@@3 T@U) (this@@1 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType1Type RefType)) (= (type this@@1) RefType)) (|List#everUsed| (List this@@1)))
 :qid |stdinbpl.672:15|
 :skolemid |112|
 :pattern ( (|List#trigger| Heap@@3 (List this@@1)))
)))
...
(assert (forall ((arg0@@36 T@U) (arg1@@17 T@U) ) (! (let ((T@@4 (MapType0TypeInv0 (type arg0@@36))))
(= (type (|Set#Union| arg0@@36 arg1@@17)) (MapType0Type T@@4 boolType)))
 :qid |funType:Set#Union|
 :pattern ( (|Set#Union| arg0@@36 arg1@@17))
)))
...
(assert (forall ((arg0@@37 T@U) (arg1@@18 T@U) ) (! (let ((T@@6 (MapType0TypeInv0 (type arg0@@37))))
(= (type (|Set#Intersection| arg0@@37 arg1@@18)) (MapType0Type T@@6 boolType)))
 :qid |funType:Set#Intersection|
 :pattern ( (|Set#Intersection| arg0@@37 arg1@@18))
)))
...
(= (type (|Set#Singleton| arg0@@38)) (MapType0Type T@@9 boolType)))
...
(assert (forall ((Heap@@5 T@U) (this@@2 T@U) ) (!  (=> (and (= (type Heap@@5) (MapType1Type RefType)) (= (type this@@2) RefType)) (and (= (length Heap@@5 this@@2) (|length'| Heap@@5 this@@2)) (dummyFunction (int_2_U (|length#triggerStateless| this@@2)))))
 :qid |stdinbpl.465:15|
 :skolemid |86|
...
(assert (forall ((this@@3 T@U) (this2 T@U) ) (!  (=> (and (and (= (type this@@3) RefType) (= (type this2) RefType)) (= (List this@@3) (List this2))) (= this@@3 this2))
 :qid |stdinbpl.663:15|
 :skolemid |110|
 :pattern ( (List this@@3) (List this2))
)))
(assert (forall ((arg0@@39 T@U) ) (! (= (type (|List#sm| arg0@@39)) (FieldType PredicateType_ListType (MapType2Type RefType boolType)))
 :qid |funType:List#sm|
 :pattern ( (|List#sm| arg0@@39))
)))
(assert (forall ((this@@4 T@U) (this2@@0 T@U) ) (!  (=> (and (and (= (type this@@4) RefType) (= (type this2@@0) RefType)) (= (|List#sm| this@@4) (|List#sm| this2@@0))) (= this@@4 this2@@0))
 :qid |stdinbpl.667:15|
 :skolemid |111|
 :pattern ( (|List#sm| this@@4) (|List#sm| this2@@0))
)))
(assert  (and (forall ((arg0@@40 T@U) ) (! (= (type (|set'| arg0@@40)) (MapType0Type RefType boolType))
 :qid |funType:set'|
 :pattern ( (|set'| arg0@@40))
)) (= (type EmptyFrame) FrameTypeType)))
(assert (forall ((Heap@@6 T@U) (Mask@@3 T@U) ) (!  (=> (and (and (= (type Heap@@6) (MapType1Type RefType)) (= (type Mask@@3) (MapType2Type RefType realType))) (and (state Heap@@6 Mask@@3) (or (< AssumeFunctionsAbove 0) (|set#trigger| EmptyFrame)))) (= (|Set#Card| (|set'| Heap@@6)) 0))
 :qid |stdinbpl.432:15|
 :skolemid |85|
 :pattern ( (state Heap@@6 Mask@@3) (|set'| Heap@@6))
)))
(assert (forall ((Heap@@7 T@U) (ExhaleHeap@@2 T@U) (Mask@@4 T@U) (o_1@@0 T@U) (f_2 T@U) ) (! (let ((B@@1 (FieldTypeInv1 (type f_2))))
(let ((A@@1 (FieldTypeInv0 (type f_2))))
 (=> (and (and (and (and (and (and (= (type Heap@@7) (MapType1Type RefType)) (= (type ExhaleHeap@@2) (MapType1Type RefType))) (= (type Mask@@4) (MapType2Type RefType realType))) (= (type o_1@@0) RefType)) (= (type f_2) (FieldType A@@1 B@@1))) (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@2 Mask@@4)) (HasDirectPerm Mask@@4 o_1@@0 f_2)) (= (MapType1Select Heap@@7 o_1@@0 f_2) (MapType1Select ExhaleHeap@@2 o_1@@0 f_2)))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@2 Mask@@4) (MapType1Select ExhaleHeap@@2 o_1@@0 f_2))
)))
(assert  (and (= (type dummyHeap) (MapType1Type RefType)) (= (type ZeroMask) (MapType2Type RefType realType))))
(assert (state dummyHeap ZeroMask))
(assert (forall ((arg0@@41 T@U) (arg1@@19 T@U) ) (! (let ((T@@13 (type arg1@@19)))
(= (type (|MultiSet#UnionOne| arg0@@41 arg1@@19)) (MultiSetType T@@13)))
 :qid |funType:MultiSet#UnionOne|
 :pattern ( (|MultiSet#UnionOne| arg0@@41 arg1@@19))
)))
...
(assert (forall ((arg0@@42 Int) (arg1@@20 Int) ) (! (= (type (|sk_List#condqp1| arg0@@42 arg1@@20)) RefType)
 :qid |funType:sk_List#condqp1|
 :pattern ( (|sk_List#condqp1| arg0@@42 arg1@@20))
)))
(assert (forall ((Heap2Heap T@U) (Heap1Heap T@U) (this@@5 T@U) ) (!  (=> (and (and (and (= (type Heap2Heap) (MapType1Type RefType)) (= (type Heap1Heap) (MapType1Type RefType))) (= (type this@@5) RefType)) (and (=  (and (U_2_bool (MapType0Select (MapType1Select Heap2Heap this@@5 nodes) (|sk_List#condqp1| (|List#condqp1| Heap2Heap this@@5) (|List#condqp1| Heap1Heap this@@5)))) (< NoPerm FullPerm))  (and (U_2_bool (MapType0Select (MapType1Select Heap1Heap this@@5 nodes) (|sk_List#condqp1| (|List#condqp1| Heap2Heap this@@5) (|List#condqp1| Heap1Heap this@@5)))) (< NoPerm FullPerm))) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap2Heap this@@5 nodes) (|sk_List#condqp1| (|List#condqp1| Heap2Heap this@@5) (|List#condqp1| Heap1Heap this@@5)))) (< NoPerm FullPerm)) (= (U_2_int (MapType1Select Heap2Heap (|sk_List#condqp1| (|List#condqp1| Heap2Heap this@@5) (|List#condqp1| Heap1Heap this@@5)) val)) (U_2_int (MapType1Select Heap1Heap (|sk_List#condqp1| (|List#condqp1| Heap2Heap this@@5) (|List#condqp1| Heap1Heap this@@5)) val)))))) (= (|List#condqp1| Heap2Heap this@@5) (|List#condqp1| Heap1Heap this@@5)))
 :qid |stdinbpl.683:15|
 :skolemid |113|
 :pattern ( (|List#condqp1| Heap2Heap this@@5) (|List#condqp1| Heap1Heap this@@5) (succHeapTrans Heap2Heap Heap1Heap))
)))
(assert (forall ((arg0@@43 Int) (arg1@@21 Int) ) (! (= (type (|sk_List#condqp2| arg0@@43 arg1@@21)) RefType)
 :qid |funType:sk_List#condqp2|
 :pattern ( (|sk_List#condqp2| arg0@@43 arg1@@21))
)))
(assert (forall ((Heap2Heap@@0 T@U) (Heap1Heap@@0 T@U) (this@@6 T@U) ) (!  (=> (and (and (and (= (type Heap2Heap@@0) (MapType1Type RefType)) (= (type Heap1Heap@@0) (MapType1Type RefType))) (= (type this@@6) RefType)) (and (=  (and (U_2_bool (MapType0Select (MapType1Select Heap2Heap@@0 this@@6 nodes) (|sk_List#condqp2| (|List#condqp2| Heap2Heap@@0 this@@6) (|List#condqp2| Heap1Heap@@0 this@@6)))) (< NoPerm FullPerm))  (and (U_2_bool (MapType0Select (MapType1Select Heap1Heap@@0 this@@6 nodes) (|sk_List#condqp2| (|List#condqp2| Heap2Heap@@0 this@@6) (|List#condqp2| Heap1Heap@@0 this@@6)))) (< NoPerm FullPerm))) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap2Heap@@0 this@@6 nodes) (|sk_List#condqp2| (|List#condqp2| Heap2Heap@@0 this@@6) (|List#condqp2| Heap1Heap@@0 this@@6)))) (< NoPerm FullPerm)) (= (MapType1Select Heap2Heap@@0 (|sk_List#condqp2| (|List#condqp2| Heap2Heap@@0 this@@6) (|List#condqp2| Heap1Heap@@0 this@@6)) next) (MapType1Select Heap1Heap@@0 (|sk_List#condqp2| (|List#condqp2| Heap2Heap@@0 this@@6) (|List#condqp2| Heap1Heap@@0 this@@6)) next))))) (= (|List#condqp2| Heap2Heap@@0 this@@6) (|List#condqp2| Heap1Heap@@0 this@@6)))
 :qid |stdinbpl.694:15|
 :skolemid |114|
 :pattern ( (|List#condqp2| Heap2Heap@@0 this@@6) (|List#condqp2| Heap1Heap@@0 this@@6) (succHeapTrans Heap2Heap@@0 Heap1Heap@@0))
)))
...
(assert (forall ((Heap@@8 T@U) (ExhaleHeap@@3 T@U) (Mask@@5 T@U) ) (!  (=> (and (and (and (= (type Heap@@8) (MapType1Type RefType)) (= (type ExhaleHeap@@3) (MapType1Type RefType))) (= (type Mask@@5) (MapType2Type RefType realType))) (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@3 Mask@@5)) (succHeap Heap@@8 ExhaleHeap@@3))
 :qid |stdinbpl.83:15|
 :skolemid |10|
...
(assert (forall ((arg0@@45 Real) (arg1@@22 T@U) ) (! (= (type (ConditionalFrame arg0@@45 arg1@@22)) FrameTypeType)
 :qid |funType:ConditionalFrame|
 :pattern ( (ConditionalFrame arg0@@45 arg1@@22))
)))
...
(assert  (and (forall ((arg0@@46 T@U) ) (! (= (type (set arg0@@46)) (MapType0Type RefType boolType))
 :qid |funType:set|
 :pattern ( (set arg0@@46))
)) (= (type |set#triggerStateless|) (MapType0Type RefType boolType))))
(assert (forall ((Heap@@9 T@U) ) (!  (=> (= (type Heap@@9) (MapType1Type RefType)) (and (= (set Heap@@9) (|set'| Heap@@9)) (dummyFunction |set#triggerStateless|)))
 :qid |stdinbpl.415:15|
 :skolemid |82|
 :pattern ( (set Heap@@9))
)))
...
(assert (forall ((Heap@@10 T@U) (ExhaleHeap@@4 T@U) (Mask@@7 T@U) (pm_f@@1 T@U) ) (! (let ((C@@1 (FieldTypeInv0 (type pm_f@@1))))
 (=> (and (and (and (and (and (= (type Heap@@10) (MapType1Type RefType)) (= (type ExhaleHeap@@4) (MapType1Type RefType))) (= (type Mask@@7) (MapType2Type RefType realType))) (= (type pm_f@@1) (FieldType C@@1 FrameTypeType))) (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@4 Mask@@7)) (and (HasDirectPerm Mask@@7 null pm_f@@1) (IsPredicateField pm_f@@1))) (forall ((o2 T@U) (f_2@@0 T@U) ) (! (let ((B@@5 (FieldTypeInv1 (type f_2@@0))))
(let ((A@@6 (FieldTypeInv0 (type f_2@@0))))
 (=> (and (and (= (type o2) RefType) (= (type f_2@@0) (FieldType A@@6 B@@5))) (U_2_bool (MapType2Select (MapType1Select Heap@@10 null (PredicateMaskField pm_f@@1)) o2 f_2@@0))) (= (MapType1Select Heap@@10 o2 f_2@@0) (MapType1Select ExhaleHeap@@4 o2 f_2@@0)))))
 :qid |stdinbpl.54:134|
 :skolemid |3|
...
(assert (forall ((Heap@@11 T@U) (ExhaleHeap@@5 T@U) (Mask@@8 T@U) (pm_f@@2 T@U) ) (! (let ((C@@2 (FieldTypeInv0 (type pm_f@@2))))
 (=> (and (and (and (and (and (= (type Heap@@11) (MapType1Type RefType)) (= (type ExhaleHeap@@5) (MapType1Type RefType))) (= (type Mask@@8) (MapType2Type RefType realType))) (= (type pm_f@@2) (FieldType C@@2 FrameTypeType))) (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@@5 Mask@@8)) (and (HasDirectPerm Mask@@8 null pm_f@@2) (IsWandField pm_f@@2))) (forall ((o2@@0 T@U) (f_2@@1 T@U) ) (! (let ((B@@6 (FieldTypeInv1 (type f_2@@1))))
(let ((A@@7 (FieldTypeInv0 (type f_2@@1))))
 (=> (and (and (= (type o2@@0) RefType) (= (type f_2@@1) (FieldType A@@7 B@@6))) (U_2_bool (MapType2Select (MapType1Select Heap@@11 null (WandMaskField pm_f@@2)) o2@@0 f_2@@1))) (= (MapType1Select Heap@@11 o2@@0 f_2@@1) (MapType1Select ExhaleHeap@@5 o2@@0 f_2@@1)))))
 :qid |stdinbpl.67:129|
 :skolemid |6|
...
(assert (forall ((this@@7 T@U) ) (!  (=> (= (type this@@7) RefType) (= (getPredWandId (List this@@7)) 0))
 :qid |stdinbpl.657:15|
 :skolemid |109|
 :pattern ( (List this@@7))
)))
...
(assert (forall ((Heap@@12 T@U) ) (!  (=> (= (type Heap@@12) (MapType1Type RefType)) (dummyFunction |set#triggerStateless|))
 :qid |stdinbpl.419:15|
 :skolemid |83|
 :pattern ( (|set'| Heap@@12))
)))
...
(assert (forall ((Heap@@13 T@U) (Mask@@10 T@U) (this@@8 T@U) ) (!  (=> (and (and (and (= (type Heap@@13) (MapType1Type RefType)) (= (type Mask@@10) (MapType2Type RefType realType))) (= (type this@@8) RefType)) (state Heap@@13 Mask@@10)) (= (|length'| Heap@@13 this@@8) (|length#frame| (MapType1Select Heap@@13 null (List this@@8)) this@@8)))
 :qid |stdinbpl.482:15|
 :skolemid |89|
 :pattern ( (state Heap@@13 Mask@@10) (|length'| Heap@@13 this@@8))
)))
...
(assert (forall ((o@@8 T@U) (f T@U) (Heap@@14 T@U) ) (!  (=> (and (and (and (= (type o@@8) RefType) (= (type f) (FieldType NormalFieldType RefType))) (= (type Heap@@14) (MapType1Type RefType))) (U_2_bool (MapType1Select Heap@@14 o@@8 $allocated))) (U_2_bool (MapType1Select Heap@@14 (MapType1Select Heap@@14 o@@8 f) $allocated)))
 :qid |stdinbpl.31:15|
 :skolemid |0|
 :pattern ( (MapType1Select Heap@@14 o@@8 f))
)))
...
(assert (forall ((arg0@@49 T@U) ) (! (= (type (|set#frame| arg0@@49)) (MapType0Type RefType boolType))
 :qid |funType:set#frame|
 :pattern ( (|set#frame| arg0@@49))
)))
(assert (forall ((Heap@@15 T@U) (Mask@@11 T@U) ) (!  (=> (and (and (= (type Heap@@15) (MapType1Type RefType)) (= (type Mask@@11) (MapType2Type RefType realType))) (state Heap@@15 Mask@@11)) (= (|set'| Heap@@15) (|set#frame| EmptyFrame)))
 :qid |stdinbpl.426:15|
 :skolemid |84|
 :pattern ( (state Heap@@15 Mask@@11) (|set'| Heap@@15))
)))
(assert (forall ((this@@9 T@U) ) (!  (=> (= (type this@@9) RefType) (= (PredicateMaskField (List this@@9)) (|List#sm| this@@9)))
 :qid |stdinbpl.649:15|
 :skolemid |107|
 :pattern ( (PredicateMaskField (List this@@9)))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@17 T@U) (Mask@@12 T@U) (this@@10 T@U) ) (!  (=> (and (and (and (= (type Heap@@17) (MapType1Type RefType)) (= (type Mask@@12) (MapType2Type RefType realType))) (= (type this@@10) RefType)) (and (state Heap@@17 Mask@@12) (< AssumeFunctionsAbove 1))) (= (length Heap@@17 this@@10) (|Set#Card| (MapType1Select Heap@@17 this@@10 nodes))))
 :qid |stdinbpl.475:15|
 :skolemid |88|
 :pattern ( (state Heap@@17 Mask@@12) (length Heap@@17 this@@10))
 :pattern ( (state Heap@@17 Mask@@12) (|length#triggerStateless| this@@10) (|List#trigger| Heap@@17 (List this@@10)))
)))
...
(assert  (and (and (and (and (and (and (and (= (type Mask@0) (MapType2Type RefType realType)) (= (type this@@11) RefType)) (= (type QPMask@0) (MapType2Type RefType realType))) (= (type Heap@@18) (MapType1Type RefType))) (= (type r_6) RefType)) (= (type QPMask@1) (MapType2Type RefType realType))) (forall ((arg0@@50 T@U) ) (! (= (type (invRecv4 arg0@@50)) RefType)
 :qid |funType:invRecv4|
 :pattern ( (invRecv4 arg0@@50))
))) (forall ((arg0@@51 T@U) ) (! (= (type (invRecv3 arg0@@51)) RefType)
...
(let ((anon15_Else_correct  (=> (and (not (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_6)) (not (= (MapType1Select Heap@@18 r_6 next) null)))) (= (ControlFlow 0 10) 6)) anon9_correct)))
(let ((anon15_Then_correct  (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_6)) (not (= (MapType1Select Heap@@18 r_6 next) null))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (HasDirectPerm QPMask@1 r_6 next)) (=> (HasDirectPerm QPMask@1 r_6 next) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm QPMask@1 this@@11 nodes)) (=> (HasDirectPerm QPMask@1 this@@11 nodes) (=> (= (ControlFlow 0 7) 6) anon9_correct))))))))
(let ((anon14_Else_correct  (=> (not (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_6))) (and (=> (= (ControlFlow 0 13) 7) anon15_Then_correct) (=> (= (ControlFlow 0 13) 10) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_6)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm QPMask@1 r_6 next)) (=> (HasDirectPerm QPMask@1 r_6 next) (and (=> (= (ControlFlow 0 11) 7) anon15_Then_correct) (=> (= (ControlFlow 0 11) 10) anon15_Else_correct)))))))
(let ((anon13_Then_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm QPMask@1 this@@11 nodes)) (=> (HasDirectPerm QPMask@1 this@@11 nodes) (and (=> (= (ControlFlow 0 14) 11) anon14_Then_correct) (=> (= (ControlFlow 0 14) 13) anon14_Else_correct))))))
(let ((anon13_Else_correct true))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((r_5 T@U) (r_5_1 T@U) ) (!  (=> (and (= (type r_5) RefType) (= (type r_5_1) RefType)) (=> (and (and (and (and (not (= r_5 r_5_1)) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_5))) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_5 r_5_1))))
 :qid |stdinbpl.767:15|
 :skolemid |121|
 :no-pattern (type r_5)
 :no-pattern (type r_5_1)
 :no-pattern (U_2_int r_5)
 :no-pattern (U_2_bool r_5)
 :no-pattern (U_2_int r_5_1)
 :no-pattern (U_2_bool r_5_1)
))) (=> (forall ((r_5@@0 T@U) (r_5_1@@0 T@U) ) (!  (=> (and (= (type r_5@@0) RefType) (= (type r_5_1@@0) RefType)) (=> (and (and (and (and (not (= r_5@@0 r_5_1@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_5@@0))) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_5_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_5@@0 r_5_1@@0))))
 :qid |stdinbpl.767:15|
 :skolemid |121|
 :no-pattern (type r_5@@0)
 :no-pattern (type r_5_1@@0)
 :no-pattern (U_2_int r_5@@0)
 :no-pattern (U_2_bool r_5@@0)
 :no-pattern (U_2_int r_5_1@@0)
 :no-pattern (U_2_bool r_5_1@@0)
)) (=> (and (forall ((r_5@@1 T@U) ) (!  (=> (= (type r_5@@1) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_5@@1)) (< NoPerm FullPerm)) (and (qpRange4 r_5@@1) (= (invRecv4 r_5@@1) r_5@@1))))
 :qid |stdinbpl.773:22|
 :skolemid |122|
 :pattern ( (MapType1Select Heap@@18 r_5@@1 next))
 :pattern ( (MapType2Select QPMask@1 r_5@@1 next))
 :pattern ( (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_5@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) (invRecv4 o_3))) (< NoPerm FullPerm)) (qpRange4 o_3)) (= (invRecv4 o_3) o_3)))
 :qid |stdinbpl.777:22|
 :skolemid |123|
 :pattern ( (invRecv4 o_3))
))) (=> (and (and (forall ((r_5@@2 T@U) ) (!  (=> (and (= (type r_5@@2) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_5@@2))) (not (= r_5@@2 null)))
 :qid |stdinbpl.783:22|
 :skolemid |124|
 :pattern ( (MapType1Select Heap@@18 r_5@@2 next))
 :pattern ( (MapType2Select QPMask@1 r_5@@2 next))
 :pattern ( (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_5@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) (invRecv4 o_3@@0))) (< NoPerm FullPerm)) (qpRange4 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_3@@0) o_3@@0)) (= (U_2_real (MapType2Select QPMask@1 o_3@@0 next)) (+ (U_2_real (MapType2Select QPMask@0 o_3@@0 next)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) (invRecv4 o_3@@0))) (< NoPerm FullPerm)) (qpRange4 o_3@@0))) (= (U_2_real (MapType2Select QPMask@1 o_3@@0 next)) (U_2_real (MapType2Select QPMask@0 o_3@@0 next))))))
 :qid |stdinbpl.789:22|
 :skolemid |125|
 :pattern ( (MapType2Select QPMask@1 o_3@@0 next))
))) (and (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 next))) (= (U_2_real (MapType2Select QPMask@0 o_3@@1 f_5)) (U_2_real (MapType2Select QPMask@1 o_3@@1 f_5))))))
 :qid |stdinbpl.793:29|
 :skolemid |126|
 :pattern ( (MapType2Select QPMask@0 o_3@@1 f_5))
 :pattern ( (MapType2Select QPMask@1 o_3@@1 f_5))
)) (state Heap@@18 QPMask@1))) (and (=> (= (ControlFlow 0 16) 14) anon13_Then_correct) (=> (= (ControlFlow 0 16) 5) anon13_Else_correct))))))))
(let ((anon12_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (HasDirectPerm QPMask@0 this@@11 nodes))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((r_3 T@U) (r_3_1 T@U) ) (!  (=> (and (= (type r_3) RefType) (= (type r_3_1) RefType)) (=> (and (and (and (and (not (= r_3 r_3_1)) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_3))) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_3 r_3_1))))
 :qid |stdinbpl.726:15|
 :skolemid |115|
 :no-pattern (type r_3)
...
))) (=> (forall ((r_3@@0 T@U) (r_3_1@@0 T@U) ) (!  (=> (and (= (type r_3@@0) RefType) (= (type r_3_1@@0) RefType)) (=> (and (and (and (and (not (= r_3@@0 r_3_1@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_3@@0))) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_3@@0 r_3_1@@0))))
 :qid |stdinbpl.726:15|
 :skolemid |115|
...
)) (=> (and (forall ((r_3@@1 T@U) ) (!  (=> (= (type r_3@@1) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_3@@1)) (< NoPerm FullPerm)) (and (qpRange3 r_3@@1) (= (invRecv3 r_3@@1) r_3@@1))))
 :qid |stdinbpl.732:22|
 :skolemid |116|
 :pattern ( (MapType1Select Heap@@18 r_3@@1 val))
 :pattern ( (MapType2Select QPMask@0 r_3@@1 val))
 :pattern ( (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_3@@1))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) (invRecv3 o_3@@2))) (< NoPerm FullPerm)) (qpRange3 o_3@@2)) (= (invRecv3 o_3@@2) o_3@@2)))
 :qid |stdinbpl.736:22|
 :skolemid |117|
 :pattern ( (invRecv3 o_3@@2))
))) (=> (and (and (forall ((r_3@@2 T@U) ) (!  (=> (and (= (type r_3@@2) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_3@@2))) (not (= r_3@@2 null)))
 :qid |stdinbpl.742:22|
 :skolemid |118|
 :pattern ( (MapType1Select Heap@@18 r_3@@2 val))
 :pattern ( (MapType2Select QPMask@0 r_3@@2 val))
 :pattern ( (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) r_3@@2))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) (invRecv3 o_3@@3))) (< NoPerm FullPerm)) (qpRange3 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_3@@3) o_3@@3)) (= (U_2_real (MapType2Select QPMask@0 o_3@@3 val)) (+ (U_2_real (MapType2Select Mask@0 o_3@@3 val)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@18 this@@11 nodes) (invRecv3 o_3@@3))) (< NoPerm FullPerm)) (qpRange3 o_3@@3))) (= (U_2_real (MapType2Select QPMask@0 o_3@@3 val)) (U_2_real (MapType2Select Mask@0 o_3@@3 val))))))
 :qid |stdinbpl.748:22|
 :skolemid |119|
 :pattern ( (MapType2Select QPMask@0 o_3@@3 val))
))) (and (forall ((o_3@@4 T@U) (f_5@@0 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_5@@0))))
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 val))) (= (U_2_real (MapType2Select Mask@0 o_3@@4 f_5@@0)) (U_2_real (MapType2Select QPMask@0 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.752:29|
 :skolemid |120|
 :pattern ( (MapType2Select Mask@0 o_3@@4 f_5@@0))
 :pattern ( (MapType2Select QPMask@0 o_3@@4 f_5@@0))
)) (state Heap@@18 QPMask@0))) (and (=> (= (ControlFlow 0 18) 4) anon12_Then_correct) (=> (= (ControlFlow 0 18) 16) anon12_Else_correct))))))))
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@0 this@@11 nodes))))
(let ((anon0_correct  (=> (and (state Heap@@18 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType1Select Heap@@18 this@@11 $allocated)) (not (= this@@11 null))) (and (= Mask@0 (MapType2Store ZeroMask this@@11 nodes (real_2_U (+ (U_2_real (MapType2Select ZeroMask this@@11 nodes)) FullPerm)))) (state Heap@@18 Mask@0))) (and (=> (= (ControlFlow 0 20) 2) anon11_Then_correct) (=> (= (ControlFlow 0 20) 18) anon11_Else_correct))))))
