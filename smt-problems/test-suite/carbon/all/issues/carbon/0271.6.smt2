...
(let ((anon3_Else_correct  (=> (= (MapType0Select Heap@@27 this@@23 next) null) (=> (and (= Mask@3 Mask@1) (= (ControlFlow 0 4) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (not (= (MapType0Select Heap@@27 this@@23 next) null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 this@@23 next)) (=> (HasDirectPerm Mask@1 this@@23 next) (=> (and (and (= Mask@2 (MapType1Store Mask@1 null (list (MapType0Select Heap@@27 this@@23 next)) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (list (MapType0Select Heap@@27 this@@23 next)))) FullPerm)))) (state Heap@@27 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 2) 1))) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@27 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@27 this@@23 $allocated))) (and (not (= this@@23 null)) (= Mask@0 (MapType1Store ZeroMask this@@23 elem (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@23 elem)) FullPerm)))))) (and (and (state Heap@@27 Mask@0) (not (= this@@23 null))) (and (= Mask@1 (MapType1Store Mask@0 this@@23 next (real_2_U (+ (U_2_real (MapType1Select Mask@0 this@@23 next)) FullPerm)))) (state Heap@@27 Mask@1)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@1 this@@23 next)) (=> (HasDirectPerm Mask@1 this@@23 next) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))))
