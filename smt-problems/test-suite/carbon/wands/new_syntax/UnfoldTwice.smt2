...
(assert (forall ((Heap@@2 T@U) (x@@9 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType1Type RefType)) (= (type x@@9) RefType)) (|Cell#everUsed| (Cell x@@9)))
 :qid |stdinbpl.253:15|
 :skolemid |34|
...
(assert (forall ((arg0@@28 T@U) ) (! (= (type (|Cell#sm| arg0@@28)) (FieldType PredicateType_CellType (MapType0Type RefType boolType)))
 :qid |funType:Cell#sm|
 :pattern ( (|Cell#sm| arg0@@28))
)))
...
(assert (forall ((arg0@@29 T@U) (arg1@@12 Real) (arg2@@6 T@U) (arg3@@4 Real) (arg4@@2 T@U) (arg5@@2 Real) (arg6@@2 T@U) (arg7@@2 Real) ) (! (= (type (wand arg0@@29 arg1@@12 arg2@@6 arg3@@4 arg4@@2 arg5@@2 arg6@@2 arg7@@2)) (FieldType WandType_wandType intType))
 :qid |funType:wand|
 :pattern ( (wand arg0@@29 arg1@@12 arg2@@6 arg3@@4 arg4@@2 arg5@@2 arg6@@2 arg7@@2))
)))
...
(assert (forall ((arg1@@19 T@U) (arg2@@12 Real) (arg3@@10 T@U) (arg4@@8 Real) (arg5@@8 T@U) (arg6@@8 Real) (arg7@@8 T@U) (arg8@@5 Real) ) (!  (=> (and (and (and (= (type arg1@@19) RefType) (= (type arg3@@10) RefType)) (= (type arg5@@8) RefType)) (= (type arg7@@8) RefType)) (= (getPredWandId (wand arg1@@19 arg2@@12 arg3@@10 arg4@@8 arg5@@8 arg6@@8 arg7@@8 arg8@@5)) 1))
 :qid |stdinbpl.203:15|
 :skolemid |27|
...
(assert  (and (and (and (and (and (= (type Heap@@10) (MapType1Type RefType)) (= (type x@@14) RefType)) (= (type Mask@1) (MapType0Type RefType realType))) (= (type Mask@2) (MapType0Type RefType realType))) (= (type Mask@3) (MapType0Type RefType realType))) (= (type Mask@0) (MapType0Type RefType realType))))
(set-info :boogie-vc-id |Cell#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (not (U_2_bool (MapType1Select Heap@@10 x@@14 b_2))) (=> (and (= Mask@3 Mask@1) (= (ControlFlow 0 4) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (U_2_bool (MapType1Select Heap@@10 x@@14 b_2)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 x@@14 f_7)) (=> (HasDirectPerm Mask@1 x@@14 f_7) (=> (and (and (= Mask@2 (MapType0Store Mask@1 null (Cell (MapType1Select Heap@@10 x@@14 f_7)) (real_2_U (+ (U_2_real (MapType0Select Mask@1 null (Cell (MapType1Select Heap@@10 x@@14 f_7)))) FullPerm)))) (state Heap@@10 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 2) 1))) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType1Select Heap@@10 x@@14 $allocated))) (and (not (= x@@14 null)) (= Mask@0 (MapType0Store ZeroMask x@@14 b_2 (real_2_U (+ (U_2_real (MapType0Select ZeroMask x@@14 b_2)) FullPerm)))))) (and (and (state Heap@@10 Mask@0) (not (= x@@14 null))) (and (= Mask@1 (MapType0Store Mask@0 x@@14 f_7 (real_2_U (+ (U_2_real (MapType0Select Mask@0 x@@14 f_7)) FullPerm)))) (state Heap@@10 Mask@1)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@1 x@@14 b_2)) (=> (HasDirectPerm Mask@1 x@@14 b_2) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))))
