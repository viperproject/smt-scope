...
(declare-fun i@0 () Int)
(assert  (and (and (and (and (= (type Heap@0) (MapType0Type RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@17) (MapType0Type RefType))) (= (type LoopSumHeap@0) (MapType0Type RefType))) (= (type LoopSumMask@0) (MapType1Type RefType realType))))
...
(let ((anon14_Then_correct  (=> (< i@1 5) (and (=> (= (ControlFlow 0 8) 6) anon15_Then_correct) (=> (= (ControlFlow 0 8) 7) anon15_Else_correct)))))
(let ((skiploop1_correct  (=> (and (state Heap@0 Mask@0) (= (ControlFlow 0 3) (- 0 2))) (= i@2 5))))
(let ((anon14_Else_correct  (=> (and (<= 5 i@1) (SumHeap LoopSumHeap@0 Heap@@17 ZeroMask Heap@@17 ZeroMask)) (=> (and (and (and (sumMask LoopSumMask@0 ZeroMask ZeroMask) (state LoopSumHeap@0 LoopSumMask@0)) (and (state LoopSumHeap@0 LoopSumMask@0) (state LoopSumHeap@0 LoopSumMask@0))) (and (and (= Heap@0 LoopSumHeap@0) (= Mask@0 LoopSumMask@0)) (and (= i@2 i@1) (= (ControlFlow 0 5) 3)))) skiploop1_correct))))
(let ((anon13_Else_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask)) (and (= i@1 (+ i@0 1)) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= i@1 5)) (=> (<= i@1 5) (=> (state Heap@@17 ZeroMask) (and (=> (= (ControlFlow 0 9) 8) anon14_Then_correct) (=> (= (ControlFlow 0 9) 5) anon14_Else_correct)))))))))
(let ((anon12_Then_correct  (=> (not (< 1 5)) (=> (and (and (= Heap@0 Heap@@17) (= Mask@0 ZeroMask)) (and (= i@2 1) (= (ControlFlow 0 4) 3))) skiploop1_correct))))
(let ((anon13_Then_correct true))
(let ((anon12_Else_correct  (=> (< 1 5) (=> (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask)) (and (=> (= (ControlFlow 0 11) 1) anon13_Then_correct) (=> (= (ControlFlow 0 11) 9) anon13_Else_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= 1 5)) (=> (<= 1 5) (=> (state Heap@@17 ZeroMask) (and (=> (= (ControlFlow 0 12) 4) anon12_Then_correct) (=> (= (ControlFlow 0 12) 11) anon12_Else_correct))))))))
