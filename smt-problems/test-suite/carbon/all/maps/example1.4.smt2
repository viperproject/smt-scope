...
(assert  (and (and (= (type Heap@@9) (MapType1Type RefType)) (= (type m1@0) (MapType intType boolType))) (= (type m2@0) (MapType intType boolType))))
(set-info :boogie-vc-id test4)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (= m1@0 (|Map#Build| (|Map#Build| (|Map#Build| (|Map#Empty| intType boolType) (int_2_U 2) (bool_2_U false)) (int_2_U 4) (bool_2_U true)) (int_2_U 6) (bool_2_U false))) (state Heap@@9 ZeroMask)) (and (= m2@0 (|Map#Build| (|Map#Build| (|Map#Empty| intType boolType) (int_2_U 6) (bool_2_U false)) (int_2_U 2) (bool_2_U false))) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (not (U_2_bool (MapType0Select (|Map#Domain| m2@0) (int_2_U 4))))) (=> (not (U_2_bool (MapType0Select (|Map#Domain| m2@0) (int_2_U 4)))) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 6)) (not (|Map#Equal| m1@0 m2@0))) (=> (not (|Map#Equal| m1@0 m2@0)) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 5)) (U_2_bool (MapType0Select (|Map#Domain| (|Map#Build| m2@0 (int_2_U 4) (bool_2_U true))) (int_2_U 4)))) (=> (U_2_bool (MapType0Select (|Map#Domain| (|Map#Build| m2@0 (int_2_U 4) (bool_2_U true))) (int_2_U 4))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (U_2_bool (MapType0Select (|Map#Elements| (|Map#Build| m2@0 (int_2_U 4) (bool_2_U true))) (int_2_U 4)))) (=> (U_2_bool (MapType0Select (|Map#Elements| (|Map#Build| m2@0 (int_2_U 4) (bool_2_U true))) (int_2_U 4))) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Map#Equal| m1@0 (|Map#Build| m1@0 (int_2_U 4) (bool_2_U true)))) (=> (|Map#Equal| m1@0 (|Map#Build| m1@0 (int_2_U 4) (bool_2_U true))) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (|Map#Equal| m1@0 (|Map#Build| m2@0 (int_2_U 4) (bool_2_U true)))))))))))))))))))))
