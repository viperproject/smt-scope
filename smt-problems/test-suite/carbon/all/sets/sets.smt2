...
(assert  (and (= (type Heap@@9) (MapType0Type RefType)) (= (type n@0) (MapType2Type intType boolType))))
(set-info :boogie-vc-id t1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= n@0 (|Set#Empty| intType)) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (|Set#Card| n@0) 0)) (=> (= (|Set#Card| n@0) 0) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (|Set#Equal| n@0 (|Set#Singleton| (int_2_U x@@19))))) (=> (not (|Set#Equal| n@0 (|Set#Singleton| (int_2_U x@@19)))) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (|Set#Card| (|Set#Singleton| (int_2_U 1))) 1)))))))))))
