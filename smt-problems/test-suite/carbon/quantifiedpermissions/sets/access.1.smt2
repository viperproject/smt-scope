...
(assert  (and (and (and (and (and (and (= (type Mask@0) (MapType2Type RefType realType)) (= (type this) RefType)) (= (type Heap@@9) (MapType1Type RefType))) (= (type QPMask@0) (MapType2Type RefType realType))) (= (type b_2) RefType)) (= (type y@@6) RefType)) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv1 arg0@@43)) RefType)
...
(let ((anon9_Else_correct  (=> (and (not (U_2_bool (MapType0Select (MapType1Select Heap@@9 this g) y@@6))) (= (ControlFlow 0 10) 7)) anon5_correct)))
(let ((anon9_Then_correct  (=> (U_2_bool (MapType0Select (MapType1Select Heap@@9 this g) y@@6)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm QPMask@0 y@@6 f_7)) (=> (HasDirectPerm QPMask@0 y@@6 f_7) (=> (= (ControlFlow 0 8) 7) anon5_correct))))))
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm QPMask@0 this g)) (=> (HasDirectPerm QPMask@0 this g) (and (=> (= (ControlFlow 0 11) 8) anon9_Then_correct) (=> (= (ControlFlow 0 11) 10) anon9_Else_correct))))))
(let ((anon8_Else_correct  (=> (and (forall ((y_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@@9 this g) y_1))) (>= (U_2_int (MapType1Select Heap@@9 y_1 f_7)) 0))
 :qid |stdinbpl.480:20|
 :skolemid |88|
 :pattern ( (MapType0Select (MapType1Select Heap@@9 this g) y_1))
)) (state Heap@@9 QPMask@0)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (HasDirectPerm QPMask@0 this g)) (=> (HasDirectPerm QPMask@0 this g) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@9 this g) b_2)) (state Heap@@9 QPMask@0)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm QPMask@0 b_2 f_7)) (=> (HasDirectPerm QPMask@0 b_2 f_7) (=> (= (ControlFlow 0 4) (- 0 3)) (>= (U_2_int (MapType1Select Heap@@9 b_2 f_7)) 0))))))))))
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@9 this g) x_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 x_1@@1) (= (invRecv1 x_1@@1) x_1@@1))))
 :qid |stdinbpl.442:22|
 :skolemid |83|
...
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@9 this g) (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.446:22|
 :skolemid |84|
...
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@9 this g) (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@0) o_3@@0)) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType2Select Mask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@9 this g) (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType2Select Mask@0 o_3@@0 f_7))))))
 :qid |stdinbpl.458:22|
 :skolemid |86|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 13) 11) anon8_Then_correct) (=> (= (ControlFlow 0 13) 4) anon8_Else_correct)))))))))
(let ((anon7_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@0 this g))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType1Select Heap@@9 this $allocated)) (U_2_bool (MapType1Select Heap@@9 b_2 $allocated))) (=> (and (and (not (= this null)) (= Mask@0 (MapType2Store ZeroMask this g (real_2_U (+ (U_2_real (MapType2Select ZeroMask this g)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 15) 2) anon7_Then_correct) (=> (= (ControlFlow 0 15) 13) anon7_Else_correct)))))))
