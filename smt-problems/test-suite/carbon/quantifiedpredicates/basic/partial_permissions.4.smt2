...
(assert  (and (and (and (= (type xs) (SeqType RefType)) (forall ((arg0@@37 T@U) ) (! (= (type (invRecv24 arg0@@37)) RefType)
 :qid |funType:invRecv24|
 :pattern ( (invRecv24 arg0@@37))
))) (= (type Heap@@10) (MapType0Type RefType))) (= (type r_1@@5) RefType)))
(set-info :boogie-vc-id t7)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_Else_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((x_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (|Seq#Contains| xs x_1)) (> (U_2_real (MapType1Select ZeroMask null (pred x_1))) NoPerm))
 :qid |stdinbpl.2305:15|
 :skolemid |247|
 :no-pattern (type x_1)
 :no-pattern (U_2_int x_1)
 :no-pattern (U_2_bool x_1)
))) (=> (forall ((x_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (|Seq#Contains| xs x_1@@0)) (> (U_2_real (MapType1Select ZeroMask null (pred x_1@@0))) NoPerm))
 :qid |stdinbpl.2305:15|
 :skolemid |247|
 :no-pattern (type x_1@@0)
 :no-pattern (U_2_int x_1@@0)
 :no-pattern (U_2_bool x_1@@0)
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (and (= (type x_1@@1) RefType) (|Seq#Contains| xs x_1@@1)) (< wildcard@0 (U_2_real (MapType1Select ZeroMask null (pred x_1@@1)))))
 :qid |stdinbpl.2309:20|
 :skolemid |248|
 :no-pattern (type x_1@@1)
 :no-pattern (U_2_int x_1@@1)
 :no-pattern (U_2_bool x_1@@1)
)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((r_1_1 T@U) ) (!  (=> (= (type r_1_1) RefType) (=> (and (|Seq#Contains| xs (invRecv24 r_1_1)) (qpRange24 r_1_1)) (>= wildcard@0 NoPerm)))
 :qid |stdinbpl.2316:17|
 :skolemid |249|
 :pattern ( (invRecv24 r_1_1))
))) (=> (forall ((r_1_1@@0 T@U) ) (!  (=> (= (type r_1_1@@0) RefType) (=> (and (|Seq#Contains| xs (invRecv24 r_1_1@@0)) (qpRange24 r_1_1@@0)) (>= wildcard@0 NoPerm)))
 :qid |stdinbpl.2316:17|
 :skolemid |249|
 :pattern ( (invRecv24 r_1_1@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_1@@2 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1@@2 x_1_1)) (|Seq#Contains| xs x_1@@2)) (|Seq#Contains| xs x_1_1)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_1@@2 x_1_1))))
 :qid |stdinbpl.2323:17|
 :skolemid |250|
 :pattern ( (neverTriggered24 x_1@@2) (neverTriggered24 x_1_1))
))) (=> (forall ((x_1@@3 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@3) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@3 x_1_1@@0)) (|Seq#Contains| xs x_1@@3)) (|Seq#Contains| xs x_1_1@@0)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_1@@3 x_1_1@@0))))
 :qid |stdinbpl.2323:17|
 :skolemid |250|
 :pattern ( (neverTriggered24 x_1@@3) (neverTriggered24 x_1_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_1@@4 T@U) ) (!  (=> (and (= (type x_1@@4) RefType) (|Seq#Contains| xs x_1@@4)) (> (U_2_real (MapType1Select ZeroMask null (pred x_1@@4))) 0.0))
 :qid |stdinbpl.2330:17|
 :skolemid |251|
 :pattern ( (MapType0Select Heap@@10 null (pred x_1@@4)))
 :pattern ( (MapType1Select ZeroMask null (pred x_1@@4)))
 :pattern ( (MapType0Select Heap@@10 null (pred x_1@@4)))
)))))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 r_1@@5 $allocated))) (and (|Seq#Contains| xs r_1@@5) (state Heap@@10 ZeroMask))) (and (=> (= (ControlFlow 0 7) 1) anon3_Then_correct) (=> (= (ControlFlow 0 7) 3) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (> wildcard 0.0) true) (= (ControlFlow 0 8) 7)) anon0_correct)))
