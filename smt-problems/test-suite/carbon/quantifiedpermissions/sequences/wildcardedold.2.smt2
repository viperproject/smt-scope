...
(assert  (and (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type a_2) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))))
...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@2 a_2 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 a_2 f_7))) (=> (= (ControlFlow 0 3) 2) anon6_correct))))))
(let ((anon4_correct  (=> (= Mask@1 (MapType1Store Mask@0 a_2 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 a_2 f_7)) FullPerm)))) (=> (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@1) (not (= a_2 null))) (=> (and (and (= Mask@2 (MapType1Store Mask@1 a_2 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@1 a_2 f_7)) FullPerm)))) (state ExhaleHeap@0 Mask@2)) (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2))) (and (=> (= (ControlFlow 0 6) (- 0 9)) (HasDirectPerm Mask@2 a_2 f_7)) (=> (HasDirectPerm Mask@2 a_2 f_7) (and (=> (= (ControlFlow 0 6) (- 0 8)) (HasDirectPerm Mask@0 a_2 f_7)) (=> (HasDirectPerm Mask@0 a_2 f_7) (and (=> (= (ControlFlow 0 6) (- 0 7)) (= (U_2_int (MapType0Select ExhaleHeap@0 a_2 f_7)) (U_2_int (MapType0Select Heap@@9 a_2 f_7)))) (=> (= (U_2_int (MapType0Select ExhaleHeap@0 a_2 f_7)) (U_2_int (MapType0Select Heap@@9 a_2 f_7))) (=> (state ExhaleHeap@0 Mask@2) (and (=> (= (ControlFlow 0 6) 3) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct))))))))))))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 6)) anon4_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@0 a_2 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 a_2 f_7))) (=> (= (ControlFlow 0 10) 6) anon4_correct))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 a_2 $allocated))) (=> (and (and (not (= a_2 null)) (= Mask@0 (MapType1Store ZeroMask a_2 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask a_2 f_7)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (and (=> (= (ControlFlow 0 13) 1) anon7_Then_correct) (=> (= (ControlFlow 0 13) 10) anon8_Then_correct)) (=> (= (ControlFlow 0 13) 12) anon8_Else_correct))))))
