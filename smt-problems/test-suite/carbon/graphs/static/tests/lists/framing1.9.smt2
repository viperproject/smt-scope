...
(declare-fun root@@4 () T@U)
(declare-fun n$1_2 () T@U)
(declare-fun qpRange12 (T@U) Bool)
(declare-fun invRecv12 (T@U) T@U)
(assert  (and (and (and (and (and (and (and (= (type g@@15) (MapType2Type RefType boolType)) (= (type n$1_2) RefType)) (= (type Heap@@35) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type n_17) RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type root@@4) RefType)) (forall ((arg0@@59 T@U) ) (! (= (type (invRecv12 arg0@@59)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon20_Then_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((n$0_5 T@U) (n$0_5_1 T@U) ) (!  (=> (and (= (type n$0_5) RefType) (= (type n$0_5_1) RefType)) (=> (and (and (and (and (not (= n$0_5 n$0_5_1)) (U_2_bool (MapType2Select g@@15 n$0_5))) (U_2_bool (MapType2Select g@@15 n$0_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_5 n$0_5_1))))
 :qid |stdinbpl.1811:25|
 :skolemid |215|
 :pattern ( (neverTriggered13 n$0_5) (neverTriggered13 n$0_5_1))
))) (=> (forall ((n$0_5@@0 T@U) (n$0_5_1@@0 T@U) ) (!  (=> (and (= (type n$0_5@@0) RefType) (= (type n$0_5_1@@0) RefType)) (=> (and (and (and (and (not (= n$0_5@@0 n$0_5_1@@0)) (U_2_bool (MapType2Select g@@15 n$0_5@@0))) (U_2_bool (MapType2Select g@@15 n$0_5_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_5@@0 n$0_5_1@@0))))
 :qid |stdinbpl.1811:25|
 :skolemid |215|
 :pattern ( (neverTriggered13 n$0_5@@0) (neverTriggered13 n$0_5_1@@0))
)) (=> (= (ControlFlow 0 13) (- 0 12)) (forall ((n$0_5@@1 T@U) ) (!  (=> (and (= (type n$0_5@@1) RefType) (U_2_bool (MapType2Select g@@15 n$0_5@@1))) (>= (U_2_real (MapType1Select QPMask@0 n$0_5@@1 next)) FullPerm))
 :qid |stdinbpl.1818:25|
 :skolemid |216|
 :pattern ( (MapType0Select Heap@@35 n$0_5@@1 next))
 :pattern ( (MapType1Select QPMask@1 n$0_5@@1 next))
 :pattern ( (MapType0Select Heap@@35 n$0_5@@1 next))
)))))))
(let ((anon12_correct true))
(let ((anon19_Then_correct  (=> (U_2_bool (MapType2Select g@@15 n_17)) (and (=> (= (ControlFlow 0 15) 13) anon20_Then_correct) (=> (= (ControlFlow 0 15) 10) anon12_correct)))))
(let ((anon19_Else_correct  (=> (and (not (U_2_bool (MapType2Select g@@15 n_17))) (= (ControlFlow 0 11) 10)) anon12_correct)))
(let ((anon18_Else_correct true))
(let ((anon15_Else_correct  (=> (and (and (forall ((n$1_3 T@U) ) (!  (=> (= (type n$1_3) RefType) (=> (and (U_2_bool (MapType2Select g@@15 n$1_3)) (not (= (MapType0Select Heap@@35 n$1_3 next) null))) (U_2_bool (MapType2Select g@@15 (MapType0Select Heap@@35 n$1_3 next)))))
 :qid |stdinbpl.1787:20|
 :skolemid |214|
 :pattern ( (MapType2Select g@@15 (MapType0Select Heap@@35 n$1_3 next)))
 :pattern ( (MapType2Select g@@15 n$1_3) (MapType0Select Heap@@35 n$1_3 next))
)) (state Heap@@35 QPMask@0)) (and (U_2_bool (MapType2Select g@@15 root@@4)) (state Heap@@35 QPMask@0))) (and (and (=> (= (ControlFlow 0 16) 9) anon18_Else_correct) (=> (= (ControlFlow 0 16) 15) anon19_Then_correct)) (=> (= (ControlFlow 0 16) 11) anon19_Else_correct)))))
(let ((anon7_correct true))
(let ((anon17_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g@@15 n$1_2)) (not (= (MapType0Select Heap@@35 n$1_2 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon17_Then_correct  (=> (and (U_2_bool (MapType2Select g@@15 n$1_2)) (not (= (MapType0Select Heap@@35 n$1_2 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 n$1_2 next)) (=> (HasDirectPerm QPMask@0 n$1_2 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon16_Else_correct  (=> (not (U_2_bool (MapType2Select g@@15 n$1_2))) (and (=> (= (ControlFlow 0 8) 3) anon17_Then_correct) (=> (= (ControlFlow 0 8) 5) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (U_2_bool (MapType2Select g@@15 n$1_2)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm QPMask@0 n$1_2 next)) (=> (HasDirectPerm QPMask@0 n$1_2 next) (and (=> (= (ControlFlow 0 6) 3) anon17_Then_correct) (=> (= (ControlFlow 0 6) 5) anon17_Else_correct)))))))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((n$0_4 T@U) (n$0_4_1 T@U) ) (!  (=> (and (= (type n$0_4) RefType) (= (type n$0_4_1) RefType)) (=> (and (and (and (and (not (= n$0_4 n$0_4_1)) (U_2_bool (MapType2Select g@@15 n$0_4))) (U_2_bool (MapType2Select g@@15 n$0_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_4 n$0_4_1))))
...
))) (=> (forall ((n$0_4@@0 T@U) (n$0_4_1@@0 T@U) ) (!  (=> (and (= (type n$0_4@@0) RefType) (= (type n$0_4_1@@0) RefType)) (=> (and (and (and (and (not (= n$0_4@@0 n$0_4_1@@0)) (U_2_bool (MapType2Select g@@15 n$0_4@@0))) (U_2_bool (MapType2Select g@@15 n$0_4_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_4@@0 n$0_4_1@@0))))
 :qid |stdinbpl.1742:15|
 :skolemid |208|
...
)) (=> (and (forall ((n$0_4@@1 T@U) ) (!  (=> (= (type n$0_4@@1) RefType) (=> (and (U_2_bool (MapType2Select g@@15 n$0_4@@1)) (< NoPerm FullPerm)) (and (qpRange12 n$0_4@@1) (= (invRecv12 n$0_4@@1) n$0_4@@1))))
 :qid |stdinbpl.1748:22|
 :skolemid |209|
 :pattern ( (MapType0Select Heap@@35 n$0_4@@1 next))
 :pattern ( (MapType1Select QPMask@0 n$0_4@@1 next))
 :pattern ( (MapType0Select Heap@@35 n$0_4@@1 next))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select g@@15 (invRecv12 o_3))) (< NoPerm FullPerm)) (qpRange12 o_3)) (= (invRecv12 o_3) o_3)))
 :qid |stdinbpl.1752:22|
 :skolemid |210|
 :pattern ( (invRecv12 o_3))
))) (=> (and (and (forall ((n$0_4@@2 T@U) ) (!  (=> (and (= (type n$0_4@@2) RefType) (U_2_bool (MapType2Select g@@15 n$0_4@@2))) (not (= n$0_4@@2 null)))
 :qid |stdinbpl.1758:22|
 :skolemid |211|
 :pattern ( (MapType0Select Heap@@35 n$0_4@@2 next))
 :pattern ( (MapType1Select QPMask@0 n$0_4@@2 next))
 :pattern ( (MapType0Select Heap@@35 n$0_4@@2 next))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select g@@15 (invRecv12 o_3@@0))) (< NoPerm FullPerm)) (qpRange12 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv12 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 next)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select g@@15 (invRecv12 o_3@@0))) (< NoPerm FullPerm)) (qpRange12 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (U_2_real (MapType1Select ZeroMask o_3@@0 next))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.1768:29|
 :skolemid |213|
 :pattern ( (MapType1Select ZeroMask o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
)) (state Heap@@35 QPMask@0))) (and (and (=> (= (ControlFlow 0 17) 16) anon15_Else_correct) (=> (= (ControlFlow 0 17) 6) anon16_Then_correct)) (=> (= (ControlFlow 0 17) 8) anon16_Else_correct))))))))
(let ((anon14_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@35 ZeroMask) (U_2_bool (MapType0Select Heap@@35 root@@4 $allocated))) (and (= AssumeFunctionsAbove 0) (not (U_2_bool (MapType2Select g@@15 null))))) (and (=> (= (ControlFlow 0 19) 1) anon14_Then_correct) (=> (= (ControlFlow 0 19) 17) anon14_Else_correct)))))
