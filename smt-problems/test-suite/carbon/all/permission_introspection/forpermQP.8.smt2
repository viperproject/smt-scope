...
(assert  (and (and (and (and (and (and (and (= (type QPMask@1) (MapType2Type RefType realType)) (= (type Heap@@11) (MapType0Type RefType))) (= (type x@@31) RefType)) (= (type a_19) RefType)) (= (type y@@12) RefType)) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@53 T@U) (arg1@@47 Int) ) (! (= (type (invRecv10 arg0@@53 arg1@@47)) RefType)
 :qid |funType:invRecv10|
 :pattern ( (invRecv10 arg0@@53 arg1@@47))
))) (forall ((arg0@@54 T@U) (arg1@@48 Int) ) (! (= (type (invRecv9 arg0@@54 arg1@@48)) RefType)
 :qid |funType:invRecv9|
 :pattern ( (invRecv9 arg0@@54 arg1@@48))
))))
...
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm QPMask@1 null (P a_19 10))) (= (ControlFlow 0 8) 5)) anon7_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm QPMask@1 null (P a_19 10)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm QPMask@1 null (P a_19 10))) (=> (HasDirectPerm QPMask@1 null (P a_19 10)) (=> (= (ControlFlow 0 6) 5) anon7_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((a_7 T@U) ) (!  (=> (and (= (type a_7) RefType) (HasDirectPerm QPMask@1 null (P a_7 10))) (= a_7 x@@31))
 :qid |stdinbpl.1680:15|
 :skolemid |180|
 :pattern ( (MapType2Select QPMask@1 null (P a_7 10)))
 :pattern ( (MapType0Select Heap@@11 null (P a_7 10)))
)))))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((a_4 T@U) (a_4_1 T@U) ) (!  (=> (and (= (type a_4) RefType) (= (type a_4_1) RefType)) (=> (and (and (and (and (not (= a_4 a_4_1)) (= a_4 y@@12)) (= a_4_1 y@@12)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_4 a_4_1))))
 :qid |stdinbpl.1627:17|
 :skolemid |174|
 :pattern ( (neverTriggered10 a_4) (neverTriggered10 a_4_1))
 ...
 :qid |stdinbpl.1627:17|
 :skolemid |174|
 :pattern ( (neverTriggered10 a_4@@0) (neverTriggered10 a_4_1@@0))
)) (=> (forall ((a_4@@1 T@U) ) (!  (=> (= (type a_4@@1) RefType) (=> (and (= a_4@@1 y@@12) (< NoPerm FullPerm)) (and (= (invRecv10 a_4@@1 5) a_4@@1) (qpRange10 a_4@@1 5))))
 :qid |stdinbpl.1633:22|
 :skolemid |175|
 :pattern ( (MapType0Select Heap@@11 null (P a_4@@1 5)))
 :pattern ( (MapType2Select QPMask@0 null (P a_4@@1 5)))
)) (=> (and (forall ((x_2_1 T@U) (i_1 Int) ) (!  (=> (= (type x_2_1) RefType) (=> (and (and (= (invRecv10 x_2_1 i_1) y@@12) (< NoPerm FullPerm)) (qpRange10 x_2_1 i_1)) (and (= (invRecv10 x_2_1 i_1) x_2_1) (= 5 i_1))))
 :qid |stdinbpl.1637:22|
 :skolemid |176|
 :pattern ( (invRecv10 x_2_1 i_1))
)) (forall ((x_2_1@@0 T@U) (i_1@@0 Int) ) (!  (=> (= (type x_2_1@@0) RefType) (=> (and (and (= (invRecv10 x_2_1@@0 i_1@@0) y@@12) (< NoPerm FullPerm)) (qpRange10 x_2_1@@0 i_1@@0)) (and (=> (< NoPerm FullPerm) (and (= (invRecv10 x_2_1@@0 i_1@@0) x_2_1@@0) (= 5 i_1@@0))) (= (U_2_real (MapType2Select QPMask@1 null (P x_2_1@@0 i_1@@0))) (+ (U_2_real (MapType2Select QPMask@0 null (P x_2_1@@0 i_1@@0))) FullPerm)))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (or (or (not (= o_3 null)) (not (IsPredicateField f_5))) (not (= (getPredWandId f_5) 0)))) (= (U_2_real (MapType2Select QPMask@0 o_3 f_5)) (U_2_real (MapType2Select QPMask@1 o_3 f_5))))))
 :qid |stdinbpl.1649:29|
 :skolemid |178|
 :pattern ( (MapType2Select QPMask@0 o_3 f_5))
 :pattern ( (MapType2Select QPMask@1 o_3 f_5))
)) (forall ((x_2_1@@1 T@U) (i_1@@1 Int) ) (!  (=> (and (= (type x_2_1@@1) RefType) (not (and (and (= (invRecv10 x_2_1@@1 i_1@@1) y@@12) (< NoPerm FullPerm)) (qpRange10 x_2_1@@1 i_1@@1)))) (= (U_2_real (MapType2Select QPMask@1 null (P x_2_1@@1 i_1@@1))) (U_2_real (MapType2Select QPMask@0 null (P x_2_1@@1 i_1@@1)))))
 :qid |stdinbpl.1653:22|
 :skolemid |179|
 :pattern ( (MapType2Select QPMask@1 null (P x_2_1@@1 i_1@@1)))
))) (and (state Heap@@11 QPMask@1) (state Heap@@11 QPMask@1))) (and (and (state Heap@@11 QPMask@1) (not (= x@@31 y@@12))) (and (state Heap@@11 QPMask@1) (state Heap@@11 QPMask@1)))) (and (and (=> (= (ControlFlow 0 9) 4) anon11_Else_correct) (=> (= (ControlFlow 0 9) 6) anon12_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon12_Else_correct)))))))))
(let ((anon10_Then_correct true))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((a_1 T@U) (a_1_1 T@U) ) (!  (=> (and (= (type a_1) RefType) (= (type a_1_1) RefType)) (=> (and (and (and (and (not (= a_1 a_1_1)) (= a_1 x@@31)) (= a_1_1 x@@31)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1 a_1_1))))
 :qid |stdinbpl.1582:17|
 :skolemid |168|
 :pattern ( (neverTriggered9 a_1) (neverTriggered9 a_1_1))
 ...
 :qid |stdinbpl.1582:17|
 :skolemid |168|
 :pattern ( (neverTriggered9 a_1@@0) (neverTriggered9 a_1_1@@0))
)) (=> (and (and (and (forall ((a_1@@1 T@U) ) (!  (=> (= (type a_1@@1) RefType) (=> (and (= a_1@@1 x@@31) (< NoPerm FullPerm)) (and (= (invRecv9 a_1@@1 10) a_1@@1) (qpRange9 a_1@@1 10))))
 :qid |stdinbpl.1588:22|
 :skolemid |169|
 :pattern ( (MapType0Select Heap@@11 null (P a_1@@1 10)))
 :pattern ( (MapType2Select ZeroMask null (P a_1@@1 10)))
)) (forall ((x_1_1 T@U) (i@@5 Int) ) (!  (=> (= (type x_1_1) RefType) (=> (and (and (= (invRecv9 x_1_1 i@@5) x@@31) (< NoPerm FullPerm)) (qpRange9 x_1_1 i@@5)) (and (= (invRecv9 x_1_1 i@@5) x_1_1) (= 10 i@@5))))
 :qid |stdinbpl.1592:22|
 :skolemid |170|
 :pattern ( (invRecv9 x_1_1 i@@5))
))) (and (forall ((x_1_1@@0 T@U) (i@@6 Int) ) (!  (=> (= (type x_1_1@@0) RefType) (=> (and (and (= (invRecv9 x_1_1@@0 i@@6) x@@31) (< NoPerm FullPerm)) (qpRange9 x_1_1@@0 i@@6)) (and (=> (< NoPerm FullPerm) (and (= (invRecv9 x_1_1@@0 i@@6) x_1_1@@0) (= 10 i@@6))) (= (U_2_real (MapType2Select QPMask@0 null (P x_1_1@@0 i@@6))) (+ (U_2_real (MapType2Select ZeroMask null (P x_1_1@@0 i@@6))) FullPerm)))))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@0) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (or (or (not (= o_3@@0 null)) (not (IsPredicateField f_5@@0))) (not (= (getPredWandId f_5@@0) 0)))) (= (U_2_real (MapType2Select ZeroMask o_3@@0 f_5@@0)) (U_2_real (MapType2Select QPMask@0 o_3@@0 f_5@@0))))))
 :qid |stdinbpl.1604:29|
 :skolemid |172|
 :pattern ( (MapType2Select ZeroMask o_3@@0 f_5@@0))
 :pattern ( (MapType2Select QPMask@0 o_3@@0 f_5@@0))
)))) (and (and (forall ((x_1_1@@1 T@U) (i@@7 Int) ) (!  (=> (and (= (type x_1_1@@1) RefType) (not (and (and (= (invRecv9 x_1_1@@1 i@@7) x@@31) (< NoPerm FullPerm)) (qpRange9 x_1_1@@1 i@@7)))) (= (U_2_real (MapType2Select QPMask@0 null (P x_1_1@@1 i@@7))) (U_2_real (MapType2Select ZeroMask null (P x_1_1@@1 i@@7)))))
 :qid |stdinbpl.1608:22|
 :skolemid |173|
 :pattern ( (MapType2Select QPMask@0 null (P x_1_1@@1 i@@7)))
)) (state Heap@@11 QPMask@0)) (and (state Heap@@11 QPMask@0) (state Heap@@11 QPMask@0)))) (and (=> (= (ControlFlow 0 11) 2) anon10_Then_correct) (=> (= (ControlFlow 0 11) 9) anon10_Else_correct)))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@11 x@@31 $allocated)) (U_2_bool (MapType0Select Heap@@11 y@@12 $allocated))) (and (=> (= (ControlFlow 0 13) 1) anon9_Then_correct) (=> (= (ControlFlow 0 13) 11) anon9_Else_correct))))))
