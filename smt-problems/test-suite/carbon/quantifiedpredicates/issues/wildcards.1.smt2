...
(assert  (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type x@@25) RefType)))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (and (forall ((o_3 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
...
)) (forall ((x_1_1 T@U) (idx@@5 Int) ) (!  (=> (= (type x_1_1) RefType) (= (U_2_real (MapType1Select QPMask@0 null (P x_1_1 idx@@5))) (U_2_real (MapType1Select Mask@0 null (P x_1_1 idx@@5)))))
 :qid |stdinbpl.481:22|
 :skolemid |89|
 :pattern ( (MapType1Select QPMask@0 null (P x_1_1 idx@@5)))
))) (=> (and (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0)) (and (state Heap@@10 QPMask@0) (= (ControlFlow 0 3) (- 0 2)))) (> (U_2_real (MapType1Select QPMask@0 null (P x@@25 0))) NoPerm)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x@@25 $allocated))) (=> (and (and (> wildcard@0 NoPerm) (= Mask@0 (MapType1Store ZeroMask null (P x@@25 0) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@25 0))) wildcard@0))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (> wildcard NoPerm) true) (= (ControlFlow 0 5) 4)) anon0_correct)))
