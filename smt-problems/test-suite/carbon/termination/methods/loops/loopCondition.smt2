...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon7_correct  (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 5) (- 0 4))) (<= i@2 n))))
(let ((anon12_Then_correct  (=> (not false) (and (=> (= (ControlFlow 0 6) (- 0 7)) (and (decreasing (int_2_U (- n i@2)) (int_2_U old_W2_T0@0)) (bounded (int_2_U old_W2_T0@0)))) (=> (and (decreasing (int_2_U (- n i@2)) (int_2_U old_W2_T0@0)) (bounded (int_2_U old_W2_T0@0))) (=> (= (ControlFlow 0 6) 5) anon7_correct))))))
(let ((anon12_Else_correct true))
(let ((anon5_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 8) 6) anon12_Then_correct) (=> (= (ControlFlow 0 8) 3) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (< n (+ i@0 1)) (=> (and (= i@2 i@0) (= (ControlFlow 0 10) 8)) anon5_correct))))
(let ((anon11_Then_correct  (=> (<= (+ i@0 1) n) (=> (and (and (= i@1 (+ i@0 1)) (state Heap@@9 ZeroMask)) (and (= i@2 i@1) (= (ControlFlow 0 9) 8))) anon5_correct))))
(let ((anon10_Then_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (and (<= i@0 n) (state Heap@@9 ZeroMask)) (and (not false) (state Heap@@9 ZeroMask))) (and (and (= old_W2_T0@0 (- n i@0)) (state Heap@@9 ZeroMask)) (and (= res@1 (+ res@0 i@0)) (state Heap@@9 ZeroMask)))) (and (=> (= (ControlFlow 0 11) 9) anon11_Then_correct) (=> (= (ControlFlow 0 11) 10) anon11_Else_correct))))))
(let ((anon10_Else_correct true))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (<= 0 n)) (=> (and (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= 0 n)) (=> (<= 0 n) (and (and (=> (= (ControlFlow 0 12) 1) anon9_Then_correct) (=> (= (ControlFlow 0 12) 11) anon10_Then_correct)) (=> (= (ControlFlow 0 12) 2) anon10_Else_correct))))))))
