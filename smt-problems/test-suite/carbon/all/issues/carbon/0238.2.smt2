...
(assert  (and (and (and (and (and (= (type UnfoldingMask@0) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type x@@18) RefType)) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Heap@@14) (MapType0Type RefType))) (forall ((arg0@@28 T@U) ) (! (= (type (FrameFragment arg0@@28)) FrameTypeType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (cell x@@18) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (cell x@@18))) FullPerm)))) (not (= x@@18 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x@@18 val (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@18 val)) FullPerm)))) (state Heap@@14 UnfoldingMask@1)) (and (state Heap@@14 UnfoldingMask@1) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm UnfoldingMask@1 x@@18 val)))))
