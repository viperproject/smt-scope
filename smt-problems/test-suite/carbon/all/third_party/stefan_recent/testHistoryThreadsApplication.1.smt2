...
(assert  (and (and (= (type Heap@@44) (MapType0Type RefType)) (= (type diz@@169) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |History__free_get_x#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@44 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@44 diz@@169 $allocated)) (= AssumeFunctionsAbove 0)) (=> (and (and (and (not (= diz@@169 null)) (state Heap@@44 ZeroMask)) (and (> wildcard@0 NoPerm) (not (= diz@@169 null)))) (and (and (= Mask@0 (MapType1Store ZeroMask diz@@169 History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz@@169 History__x_hist_value)) wildcard@0)))) (state Heap@@44 Mask@0)) (and (state Heap@@44 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm Mask@0 diz@@169 History__x_hist_value))))))
...
(let ((anon11_Then_correct  (=> (and (and (and (state PostHeap@0 ZeroMask) (not (= diz@@169 null))) (and (= PostMask@0 (MapType1Store ZeroMask diz@@169 History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz@@169 History__x_hist_value)) FullPerm)))) (state PostHeap@0 PostMask@0))) (and (and (state PostHeap@0 PostMask@0) (not (= diz@@169 null))) (and (= PostMask@1 (MapType1Store PostMask@0 diz@@169 History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select PostMask@0 diz@@169 History__x_hist_mode)) FullPerm)))) (state PostHeap@0 PostMask@1)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (HasDirectPerm PostMask@1 diz@@169 History__x_hist_mode)) (=> (HasDirectPerm PostMask@1 diz@@169 History__x_hist_mode) (=> (and (= (U_2_int (MapType0Select PostHeap@0 diz@@169 History__x_hist_mode)) 1) (state PostHeap@0 PostMask@1)) (=> (and (and (not (= diz@@169 null)) (= PostMask@2 (MapType1Store PostMask@1 diz@@169 History__x_hist_init (real_2_U (+ (U_2_real (MapType1Select PostMask@1 diz@@169 History__x_hist_init)) FullPerm))))) (and (state PostHeap@0 PostMask@2) (state PostHeap@0 PostMask@2))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm PostMask@2 diz@@169 History__x_hist_value)) (=> (HasDirectPerm PostMask@2 diz@@169 History__x_hist_value) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@3 diz@@169 History__x_hist_value)) (=> (HasDirectPerm Mask@3 diz@@169 History__x_hist_value) (=> (and (= (U_2_int (MapType0Select PostHeap@0 diz@@169 History__x_hist_value)) (U_2_int (MapType0Select Heap@@44 diz@@169 History__x_hist_value))) (state PostHeap@0 PostMask@2)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm PostMask@2 diz@@169 History__x_hist_init)) (=> (HasDirectPerm PostMask@2 diz@@169 History__x_hist_init) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@3 diz@@169 History__x_hist_value))))))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@44 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@44 diz@@169 $allocated)) (not (= diz@@169 null))) (and (state Heap@@44 ZeroMask) (>= current_thread_id 0))) (=> (and (and (and (state Heap@@44 ZeroMask) (not (= diz@@169 null))) (and (= Mask@0 (MapType1Store ZeroMask diz@@169 History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz@@169 History__x_hist_value)) FullPerm)))) (state Heap@@44 Mask@0))) (and (and (state Heap@@44 Mask@0) (not (= diz@@169 null))) (and (= Mask@1 (MapType1Store Mask@0 diz@@169 History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select Mask@0 diz@@169 History__x_hist_mode)) FullPerm)))) (state Heap@@44 Mask@1)))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm Mask@1 diz@@169 History__x_hist_mode)) (=> (HasDirectPerm Mask@1 diz@@169 History__x_hist_mode) (=> (and (= (U_2_int (MapType0Select Heap@@44 diz@@169 History__x_hist_mode)) 0) (state Heap@@44 Mask@1)) (=> (and (and (and (not (= diz@@169 null)) (= Mask@2 (MapType1Store Mask@1 diz@@169 History__x_hist_init (real_2_U (+ (U_2_real (MapType1Select Mask@1 diz@@169 History__x_hist_init)) FullPerm))))) (and (state Heap@@44 Mask@2) (state Heap@@44 Mask@2))) (and (and (not (= diz@@169 null)) (= Mask@3 (MapType1Store Mask@2 diz@@169 History__x_hist_act (real_2_U (+ (U_2_real (MapType1Select Mask@2 diz@@169 History__x_hist_act)) FullPerm))))) (and (state Heap@@44 Mask@3) (state Heap@@44 Mask@3)))) (and (=> (= (ControlFlow 0 8) 2) anon11_Then_correct) (=> (= (ControlFlow 0 8) 7) anon11_Else_correct)))))))))))
...
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(set-info :boogie-vc-id Main__if_any_random)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
