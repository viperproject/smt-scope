...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (and (= perm@0 (ite (< (/ (to_real 1) (to_real 2)) FullPerm) (/ (to_real 1) (to_real 2)) FullPerm)) (= (ControlFlow 0 2) (- 0 1)))) (>= perm@0 NoPerm))))
