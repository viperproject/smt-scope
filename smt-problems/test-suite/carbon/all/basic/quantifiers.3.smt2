...
(assert  (and (= (type Heap@@33) (MapType0Type RefType)) (= (type c) RefType)))
(set-info :boogie-vc-id fail10ForallCellGet10)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon5_correct true))
(let ((anon16_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 10)) anon5_correct)))
(let ((anon16_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType1Select ZeroMask c Cell_x)))) (=> (<= FullPerm (U_2_real (MapType1Select ZeroMask c Cell_x))) (=> (= (ControlFlow 0 11) 10) anon5_correct))))))
(let ((anon10_correct true))
(let ((anon19_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 4)) anon10_correct)))
(let ((anon19_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select ZeroMask c Cell_x)))) (=> (<= FullPerm (U_2_real (MapType1Select ZeroMask c Cell_x))) (=> (= (ControlFlow 0 5) 4) anon10_correct))))))
(let ((anon11_correct true))
(let ((anon17_Then_correct  (=> (and (<= 0 i_1) (< i_1 (Cell_get Heap@@33 c))) (and (and (=> (= (ControlFlow 0 8) 2) anon11_correct) (=> (= (ControlFlow 0 8) 5) anon19_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon19_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (not (and (<= 0 i_1) (< i_1 (Cell_get Heap@@33 c)))) (= (ControlFlow 0 3) 2)) anon11_correct)))
(let ((anon14_Then_correct  (=> (<= 0 i_1) (and (and (and (=> (= (ControlFlow 0 14) 8) anon17_Then_correct) (=> (= (ControlFlow 0 14) 3) anon17_Else_correct)) (=> (= (ControlFlow 0 14) 11) anon16_Then_correct)) (=> (= (ControlFlow 0 14) 13) anon16_Else_correct)))))
(let ((anon14_Else_correct  (=> (< i_1 0) (and (=> (= (ControlFlow 0 9) 8) anon17_Then_correct) (=> (= (ControlFlow 0 9) 3) anon17_Else_correct)))))
(let ((anon13_Else_correct true))
(let ((anon0_correct  (=> (and (state Heap@@33 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@33 c $allocated)) (not (= c null))) (and (state Heap@@33 ZeroMask) (state Heap@@33 ZeroMask))) (and (and (=> (= (ControlFlow 0 15) 1) anon13_Else_correct) (=> (= (ControlFlow 0 15) 14) anon14_Then_correct)) (=> (= (ControlFlow 0 15) 9) anon14_Else_correct))))))
...
(assert  (and (= (type A@@12) (SeqType RefType)) (= (type Heap@@33) (MapType0Type RefType))))
(set-info :boogie-vc-id test6)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon9_correct true))
(let ((anon16_Else_correct  (=> (and (<= 3 j2_5) (= (ControlFlow 0 15) 10)) anon9_correct)))
(let ((anon16_Then_correct  (=> (< j2_5 3) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= j2_5 0)) (=> (>= j2_5 0) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< j2_5 (|Seq#Length| A@@12))) (=> (< j2_5 (|Seq#Length| A@@12)) (=> (= (ControlFlow 0 12) 10) anon9_correct))))))))
(let ((anon15_Then_correct  (=> (<= 0 j2_5) (and (=> (= (ControlFlow 0 16) 12) anon16_Then_correct) (=> (= (ControlFlow 0 16) 15) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (< j2_5 0) (= (ControlFlow 0 11) 10)) anon9_correct)))
(let ((anon14_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (exists ((j2_1 Int) ) (!  (and (<= 0 j2_1) (and (< j2_1 3) (not (= (|Seq#Index| A@@12 j2_1) null))))
 :qid |stdinbpl.2711:15|
 :skolemid |182|
 :pattern ( (|Seq#Index| A@@12 j2_1))
)))))
(let ((anon11_Else_correct  (=> (exists ((j1_1 Int) ) (!  (and (<= 0 j1_1) (and (< j1_1 3) (not (= (|Seq#Index| A@@12 j1_1) null))))
 :qid |stdinbpl.2687:20|
 :skolemid |181|
 :pattern ( (|Seq#Index| A@@12 j1_1))
)) (=> (and (state Heap@@33 ZeroMask) (state Heap@@33 ZeroMask)) (and (and (=> (= (ControlFlow 0 17) 9) anon14_Else_correct) (=> (= (ControlFlow 0 17) 16) anon15_Then_correct)) (=> (= (ControlFlow 0 17) 11) anon15_Else_correct))))))
(let ((anon4_correct true))
(let ((anon13_Else_correct  (=> (and (<= 3 j1_4) (= (ControlFlow 0 6) 1)) anon4_correct)))
(let ((anon13_Then_correct  (=> (< j1_4 3) (and (=> (= (ControlFlow 0 3) (- 0 5)) (>= j1_4 0)) (=> (>= j1_4 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< j1_4 (|Seq#Length| A@@12))) (=> (< j1_4 (|Seq#Length| A@@12)) (=> (= (ControlFlow 0 3) 1) anon4_correct))))))))
(let ((anon12_Then_correct  (=> (<= 0 j1_4) (and (=> (= (ControlFlow 0 7) 3) anon13_Then_correct) (=> (= (ControlFlow 0 7) 6) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (< j1_4 0) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (> (|Seq#Length| A@@12) 10)) (and (state Heap@@33 ZeroMask) (state Heap@@33 ZeroMask))) (and (and (=> (= (ControlFlow 0 18) 17) anon11_Else_correct) (=> (= (ControlFlow 0 18) 7) anon12_Then_correct)) (=> (= (ControlFlow 0 18) 2) anon12_Else_correct))))))
