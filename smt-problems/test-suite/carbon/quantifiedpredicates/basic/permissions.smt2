...
(assert  (and (= (type x@@11) RefType) (= (type Heap@@11) (MapType0Type RefType))))
...
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select ZeroMask null (pred1 x@@11))))) (=> (<= FullPerm (U_2_real (MapType1Select ZeroMask null (pred1 x@@11)))) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 x@@11 $allocated))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))
