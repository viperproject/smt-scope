...
(assert  (and (and (and (and (= (type ys) (SeqType RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type xs) (MapType2Type RefType boolType))) (forall ((arg0@@52 T@U) ) (! (= (type (invRecv1 arg0@@52)) RefType)
...
(let ((anon15_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| ys)) (int_2_U i_2))) (= (ControlFlow 0 15) 11)) anon9_correct)))
(let ((anon15_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| ys)) (int_2_U i_2)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< i_2 (|Seq#Length| ys))) (=> (< i_2 (|Seq#Length| ys)) (=> (= (ControlFlow 0 12) 11) anon9_correct))))))))
(let ((anon14_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| ys)) (int_2_U i_3))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| ys)) (int_2_U i_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ys i_3) (|Seq#Index| ys i_3_1))))
 :qid |stdinbpl.861:15|
 :skolemid |125|
)))))
(let ((anon12_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (<= 0 i_1) (and (< i_1 j_1) (< j_1 (|Seq#Length| ys)))) (not (= (|Seq#Index| ys i_1) (|Seq#Index| ys j_1))))
 :qid |stdinbpl.843:20|
 :skolemid |124|
 :pattern ( (|Seq#Index| ys i_1) (|Seq#Index| ys j_1))
)) (state Heap@@9 QPMask@0)) (and (and (=> (= (ControlFlow 0 16) 10) anon14_Else_correct) (=> (= (ControlFlow 0 16) 12) anon15_Then_correct)) (=> (= (ControlFlow 0 16) 15) anon15_Else_correct)))))
(let ((anon5_correct true))
(let ((anon13_Else_correct  (=> (and (not (and (<= 0 i@@6) (and (< i@@6 j@@5) (< j@@5 (|Seq#Length| ys))))) (= (ControlFlow 0 8) 2)) anon5_correct)))
(let ((anon13_Then_correct  (=> (and (<= 0 i@@6) (and (< i@@6 j@@5) (< j@@5 (|Seq#Length| ys)))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 3) (- 0 6)) (< i@@6 (|Seq#Length| ys))) (=> (< i@@6 (|Seq#Length| ys)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< j@@5 (|Seq#Length| ys))) (=> (< j@@5 (|Seq#Length| ys)) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))))))))
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs x_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 x_1@@1) (= (invRecv1 x_1@@1) x_1@@1))))
 :qid |stdinbpl.801:22|
 :skolemid |119|
 :pattern ( (MapType0Select Heap@@9 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
 :pattern ( (MapType2Select xs x_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.805:22|
 :skolemid |120|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 17) 16) anon12_Else_correct) (=> (= (ControlFlow 0 17) 3) anon13_Then_correct)) (=> (= (ControlFlow 0 17) 8) anon13_Else_correct)))))))))
