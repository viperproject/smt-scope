...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon10_Then_correct true))
(let ((anon9_Then_correct true))
(let ((anon7_correct  (=> (and (= Result@0 (ite (> x@@13 0) (+ (f_6 Heap@@18 (f_6 Heap@@18 (- x@@13 1))) 1) x@@13)) (= (ControlFlow 0 2) (- 0 1))) (= Result@0 x@@13))))
(let ((anon10_Else_correct  (=> (and (|f#trigger| EmptyFrame y_1@0) (= (ControlFlow 0 6) 2)) anon7_correct)))
(let ((anon9_Else_correct  (=> (and (|f#trigger| EmptyFrame (- x@@13 1)) (= y_1@0 (f_6 Heap@@18 (- x@@13 1)))) (and (=> (= (ControlFlow 0 7) 5) anon10_Then_correct) (=> (= (ControlFlow 0 7) 6) anon10_Else_correct)))))
(let ((anon8_Then_correct  (=> (> x@@13 0) (and (=> (= (ControlFlow 0 8) 4) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (>= 0 x@@13) (= (ControlFlow 0 3) 2)) anon7_correct)))
(let ((anon0_correct  (=> (and (state Heap@@18 ZeroMask) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 9) 8) anon8_Then_correct) (=> (= (ControlFlow 0 9) 3) anon8_Else_correct)))))
