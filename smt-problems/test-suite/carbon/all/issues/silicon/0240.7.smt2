...
(assert  (and (and (and (and (and (and (= (type newPMask@0) (MapType1Type RefType boolType)) (= (type Heap@@21) (MapType0Type RefType))) (= (type this@@21) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type UnfoldingMask@0) (MapType1Type RefType realType))))
...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@1 null (list this@@21))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@1 null (list this@@21)))) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
(let ((anon8_Else_correct  (=> (and (and (forall ((o_13 T@U) (f_16 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_16))))
(let ((A@@12 (FieldTypeInv0 (type f_16))))
 (=> (and (and (= (type o_13) RefType) (= (type f_16) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@@21 null (|bla#sm| this@@21)) o_13 f_16)) (U_2_bool (MapType1Select (MapType0Select Heap@@21 null (|list#sm| this@@21)) o_13 f_16)))) (U_2_bool (MapType1Select newPMask@0 o_13 f_16)))))
 :qid |stdinbpl.1558:31|
 :skolemid |143|
 :pattern ( (MapType1Select newPMask@0 o_13 f_16))
)) (= Heap@0 (MapType0Store Heap@@21 null (|bla#sm| this@@21) newPMask@0))) (and (state Heap@0 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (foo Heap@0 this@@21))))
(let ((anon2_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (bla this@@21) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (bla this@@21))) perm@1)))) (= perm@2 (* FullPerm (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 null (list this@@21) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 null (list this@@21))) perm@2)))) (InsidePredicate (bla this@@21) (MapType0Select Heap@@21 null (bla this@@21)) (list this@@21) (MapType0Select Heap@@21 null (list this@@21)))) (=> (and (and (state Heap@@21 UnfoldingMask@1) (state Heap@@21 UnfoldingMask@1)) (and (foo Heap@@21 this@@21) (state Heap@@21 UnfoldingMask@1))) (and (and (=> (= (ControlFlow 0 7) 2) anon8_Else_correct) (=> (= (ControlFlow 0 7) 4) anon9_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))))))
(let ((anon7_Else_correct  (=> (and (= perm@1 NoPerm) (= (ControlFlow 0 11) 7)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= perm@1 NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= perm@1 (U_2_real (MapType1Select Mask@0 null (bla this@@21))))) (=> (<= perm@1 (U_2_real (MapType1Select Mask@0 null (bla this@@21)))) (=> (= (ControlFlow 0 9) 7) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@21 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@21 this@@21 $allocated)) (= perm@0 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (= Mask@0 (MapType1Store ZeroMask null (bla this@@21) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (bla this@@21))) perm@0)))) (state Heap@@21 Mask@0)) (=> (and (and (state Heap@@21 Mask@0) (|bla#trigger| Heap@@21 (bla this@@21))) (and (= (MapType0Select Heap@@21 null (bla this@@21)) (MapType0Select Heap@@21 null (list this@@21))) (= perm@1 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (and (=> (= (ControlFlow 0 12) 9) anon7_Then_correct) (=> (= (ControlFlow 0 12) 11) anon7_Else_correct)))))))))))
