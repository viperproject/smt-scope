...
(declare-fun x@@8 () T@U)
(assert  (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type y@@1) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type x@@8) RefType)))
(set-info :boogie-vc-id m)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Else_correct  (=> (and (and (= (U_2_real (MapType1Select Mask@0 null (wand y@@1 FullPerm y@@1 FullPerm))) FullPerm) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (= (ControlFlow 0 4) (- 0 3)))) (= x@@8 y@@1))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (wand x@@8 FullPerm x@@8 FullPerm) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (wand x@@8 FullPerm x@@8 FullPerm))) FullPerm)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated)) (U_2_bool (MapType0Select Heap@@9 y@@1 $allocated))) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct))))))
