...
(declare-fun i1 () Int)
(declare-fun i2 () Int)
(assert  (and (and (and (and (and (and (and (= (type s@@17) (SeqType RefType)) (= (type t_1) (SeqType RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type QPMask@4) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 52) (let ((anon24_correct true))
(let ((anon39_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i_6))) (= (ControlFlow 0 41) 37)) anon24_correct)))
(let ((anon39_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i_6)) (and (=> (= (ControlFlow 0 38) (- 0 40)) (>= i_6 0)) (=> (>= i_6 0) (and (=> (= (ControlFlow 0 38) (- 0 39)) (< i_6 (|Seq#Length| s@@17))) (=> (< i_6 (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 38) 37) anon24_correct))))))))
(let ((anon38_Else_correct  (=> (= (ControlFlow 0 36) (- 0 35)) (forall ((i_7 Int) (i_7_1 Int) ) (!  (=> (and (and (and (and (not (= i_7 i_7_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i_7))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i_7_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| s@@17 i_7) (|Seq#Index| s@@17 i_7_1))))
 :qid |stdinbpl.824:15|
 :skolemid |78|
)))))
(let ((anon36_Else_correct  (and (=> (= (ControlFlow 0 42) (- 0 43)) (forall ((i_5 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5 i_5_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_5))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| t_1 i_5) (|Seq#Index| t_1 i_5_1))))
 :qid |stdinbpl.778:15|
 :skolemid |72|
))) (=> (forall ((i_5@@0 Int) (i_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_5@@0 i_5_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_5@@0))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_5_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| t_1 i_5@@0) (|Seq#Index| t_1 i_5_1@@0))))
 :qid |stdinbpl.778:15|
 :skolemid |72|
)) (=> (forall ((i_5@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_5@@1)) (< NoPerm FullPerm)) (and (qpRange3 (|Seq#Index| t_1 i_5@@1)) (= (invRecv3 (|Seq#Index| t_1 i_5@@1)) i_5@@1)))
 :qid |stdinbpl.784:22|
 :skolemid |73|
 :pattern ( (|Seq#Index| t_1 i_5@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_5@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_5@@1)))
 :pattern ( (|Seq#Index| t_1 i_5@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U (invRecv3 o_3))) (< NoPerm FullPerm)) (qpRange3 o_3)) (= (|Seq#Index| t_1 (invRecv3 o_3)) o_3)))
 :qid |stdinbpl.788:22|
 :skolemid |74|
 :pattern ( (invRecv3 o_3))
)) (forall ((i_5@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_5@@2)) (not (= (|Seq#Index| t_1 i_5@@2) null)))
 :qid |stdinbpl.794:22|
 :skolemid |75|
 :pattern ( (|Seq#Index| t_1 i_5@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_5@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_5@@2)))
 :pattern ( (|Seq#Index| t_1 i_5@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U (invRecv3 o_3@@0))) (< NoPerm FullPerm)) (qpRange3 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| t_1 (invRecv3 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@4 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U (invRecv3 o_3@@0))) (< NoPerm FullPerm)) (qpRange3 o_3@@0))) (= (U_2_real (MapType1Select QPMask@4 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.800:22|
 :skolemid |76|
...
(let ((anon37_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_4))) (= (ControlFlow 0 34) 30)) anon20_correct)))
(let ((anon37_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_4)) (and (=> (= (ControlFlow 0 31) (- 0 33)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 31) (- 0 32)) (< i_4 (|Seq#Length| t_1))) (=> (< i_4 (|Seq#Length| t_1)) (=> (= (ControlFlow 0 31) 30) anon20_correct))))))))
...
(let ((anon35_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 29)) (forall ((i_8 Int) (i_8_1 Int) ) (!  (=> (and (and (and (and (not (= i_8 i_8_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_8))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_8_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| t_1 i_8) (|Seq#Index| t_1 i_8_1))))
 :qid |stdinbpl.871:17|
 :skolemid |84|
 :pattern ( (neverTriggered5 i_8) (neverTriggered5 i_8_1))
))) (=> (forall ((i_8@@0 Int) (i_8_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_8@@0 i_8_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_8@@0))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_8_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| t_1 i_8@@0) (|Seq#Index| t_1 i_8_1@@0))))
 :qid |stdinbpl.871:17|
 :skolemid |84|
 :pattern ( (neverTriggered5 i_8@@0) (neverTriggered5 i_8_1@@0))
)) (and (=> (= (ControlFlow 0 26) (- 0 28)) (forall ((i_8@@1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_8@@1)) (>= (U_2_real (MapType1Select QPMask@1 (|Seq#Index| t_1 i_8@@1) f_7)) FullPerm))
 :qid |stdinbpl.878:17|
 :skolemid |85|
 :pattern ( (|Seq#Index| t_1 i_8@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_8@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_8@@1)))
 :pattern ( (|Seq#Index| t_1 i_8@@1))
))) (=> (forall ((i_8@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_8@@2)) (>= (U_2_real (MapType1Select QPMask@1 (|Seq#Index| t_1 i_8@@2) f_7)) FullPerm))
 :qid |stdinbpl.878:17|
 :skolemid |85|
 :pattern ( (|Seq#Index| t_1 i_8@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_8@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_8@@2)))
 :pattern ( (|Seq#Index| t_1 i_8@@2))
)) (=> (and (and (forall ((i_8@@3 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_8@@3)) (< NoPerm FullPerm)) (and (qpRange5 (|Seq#Index| t_1 i_8@@3)) (= (invRecv5 (|Seq#Index| t_1 i_8@@3)) i_8@@3)))
 :qid |stdinbpl.884:22|
 :skolemid |86|
 :pattern ( (|Seq#Index| t_1 i_8@@3))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_8@@3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_8@@3)))
 :pattern ( (|Seq#Index| t_1 i_8@@3))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U (invRecv5 o_3@@2))) (and (< NoPerm FullPerm) (qpRange5 o_3@@2))) (= (|Seq#Index| t_1 (invRecv5 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.888:22|
 :skolemid |87|
 :pattern ( (invRecv5 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U (invRecv5 o_3@@3))) (and (< NoPerm FullPerm) (qpRange5 o_3@@3))) (and (= (|Seq#Index| t_1 (invRecv5 o_3@@3)) o_3@@3) (= (U_2_real (MapType1Select QPMask@2 o_3@@3 f_7)) (- (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) FullPerm)))) (=> (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U (invRecv5 o_3@@3))) (and (< NoPerm FullPerm) (qpRange5 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@2 o_3@@3 f_7)) (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7))))))
 :qid |stdinbpl.894:22|
 :skolemid |88|
...
)))) (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((i_9 Int) (i_9_1 Int) ) (!  (=> (and (and (and (and (not (= i_9 i_9_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i_9))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i_9_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| s@@17 i_9) (|Seq#Index| s@@17 i_9_1))))
 :qid |stdinbpl.912:17|
 :skolemid |90|
 :pattern ( (neverTriggered6 i_9) (neverTriggered6 i_9_1))
))) (=> (forall ((i_9@@0 Int) (i_9_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_9@@0 i_9_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i_9@@0))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i_9_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| s@@17 i_9@@0) (|Seq#Index| s@@17 i_9_1@@0))))
 :qid |stdinbpl.912:17|
 :skolemid |90|
 :pattern ( (neverTriggered6 i_9@@0) (neverTriggered6 i_9_1@@0))
)) (=> (= (ControlFlow 0 26) (- 0 25)) (forall ((i_9@@1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i_9@@1)) (>= (U_2_real (MapType1Select QPMask@2 (|Seq#Index| s@@17 i_9@@1) f_7)) FullPerm))
 :qid |stdinbpl.919:17|
 :skolemid |91|
 :pattern ( (|Seq#Index| s@@17 i_9@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i_9@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i_9@@1)))
 :pattern ( (|Seq#Index| s@@17 i_9@@1))
))))))))))))
(let ((anon33_Else_correct  (and (=> (= (ControlFlow 0 45) (- 0 46)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_3))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| t_1 i_3) (|Seq#Index| t_1 i_3_1))))
 :qid |stdinbpl.721:15|
 :skolemid |66|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_3@@0))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| t_1 i_3@@0) (|Seq#Index| t_1 i_3_1@@0))))
 :qid |stdinbpl.721:15|
 :skolemid |66|
)) (=> (forall ((i_3@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_3@@1)) (< NoPerm FullPerm)) (and (qpRange2 (|Seq#Index| t_1 i_3@@1)) (= (invRecv2 (|Seq#Index| t_1 i_3@@1)) i_3@@1)))
 :qid |stdinbpl.727:22|
 :skolemid |67|
 :pattern ( (|Seq#Index| t_1 i_3@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_3@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_3@@1)))
 :pattern ( (|Seq#Index| t_1 i_3@@1))
)) (=> (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U (invRecv2 o_3@@5))) (< NoPerm FullPerm)) (qpRange2 o_3@@5)) (= (|Seq#Index| t_1 (invRecv2 o_3@@5)) o_3@@5)))
 :qid |stdinbpl.731:22|
 :skolemid |68|
 :pattern ( (invRecv2 o_3@@5))
)) (forall ((i_3@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_3@@2)) (not (= (|Seq#Index| t_1 i_3@@2) null)))
 :qid |stdinbpl.737:22|
 :skolemid |69|
 :pattern ( (|Seq#Index| t_1 i_3@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_3@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_3@@2)))
 :pattern ( (|Seq#Index| t_1 i_3@@2))
))) (=> (and (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U (invRecv2 o_3@@6))) (< NoPerm FullPerm)) (qpRange2 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| t_1 (invRecv2 o_3@@6)) o_3@@6)) (= (U_2_real (MapType1Select QPMask@1 o_3@@6 f_7)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U (invRecv2 o_3@@6))) (< NoPerm FullPerm)) (qpRange2 o_3@@6))) (= (U_2_real (MapType1Select QPMask@1 o_3@@6 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7))))))
 :qid |stdinbpl.743:22|
 :skolemid |70|
...
))) (and (state Heap@@9 QPMask@1) (state Heap@@9 QPMask@1))) (and (=> (= (ControlFlow 0 45) 44) anon35_Then_correct) (=> (= (ControlFlow 0 45) 26) anon35_Else_correct)))))))))
(let ((anon15_correct true))
(let ((anon34_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_2))) (= (ControlFlow 0 24) 20)) anon15_correct)))
(let ((anon34_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i_2)) (and (=> (= (ControlFlow 0 21) (- 0 23)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 21) (- 0 22)) (< i_2 (|Seq#Length| t_1))) (=> (< i_2 (|Seq#Length| t_1)) (=> (= (ControlFlow 0 21) 20) anon15_correct))))))))
(let ((anon31_Else_correct  (=> (and (forall ((i1_3 Int) (i2_3 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i1_3)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i2_3)) (not (= i1_3 i2_3)))) (not (= (|Seq#Index| t_1 i1_3) (|Seq#Index| t_1 i2_3))))
 :qid |stdinbpl.703:20|
 :skolemid |65|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i1_3)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i2_3)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i1_3)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i2_3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i1_3)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i2_3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i1_3)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i2_3)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i1_3)) (|Seq#Index| t_1 i2_3))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i1_3)) (|Seq#Index| t_1 i2_3))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i2_3)) (|Seq#Index| t_1 i1_3))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i2_3)) (|Seq#Index| t_1 i1_3))
 :pattern ( (|Seq#Index| t_1 i1_3) (|Seq#Index| t_1 i2_3))
)) (state Heap@@9 QPMask@0)) (and (and (=> (= (ControlFlow 0 47) 45) anon33_Else_correct) (=> (= (ControlFlow 0 47) 21) anon34_Then_correct)) (=> (= (ControlFlow 0 47) 24) anon34_Else_correct)))))
(let ((anon11_correct true))
(let ((anon32_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i1_2)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i2_2)) (not (= i1_2 i2_2))))) (= (ControlFlow 0 19) 13)) anon11_correct)))
(let ((anon32_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i1_2)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| t_1)) (int_2_U i2_2)) (not (= i1_2 i2_2)))) (and (=> (= (ControlFlow 0 14) (- 0 18)) (>= i1_2 0)) (=> (>= i1_2 0) (and (=> (= (ControlFlow 0 14) (- 0 17)) (< i1_2 (|Seq#Length| t_1))) (=> (< i1_2 (|Seq#Length| t_1)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= i2_2 0)) (=> (>= i2_2 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< i2_2 (|Seq#Length| t_1))) (=> (< i2_2 (|Seq#Length| t_1)) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))))))
(let ((anon29_Else_correct  (and (=> (= (ControlFlow 0 48) (- 0 49)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| s@@17 i_1) (|Seq#Index| s@@17 i_1_1))))
 :qid |stdinbpl.655:15|
 :skolemid |59|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i_1@@0))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| s@@17 i_1@@0) (|Seq#Index| s@@17 i_1_1@@0))))
 :qid |stdinbpl.655:15|
 :skolemid |59|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index| s@@17 i_1@@1)) (= (invRecv1 (|Seq#Index| s@@17 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.661:22|
 :skolemid |60|
 :pattern ( (|Seq#Index| s@@17 i_1@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i_1@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i_1@@1)))
 :pattern ( (|Seq#Index| s@@17 i_1@@1))
)) (=> (and (forall ((o_3@@8 T@U) ) (!  (=> (= (type o_3@@8) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U (invRecv1 o_3@@8))) (< NoPerm FullPerm)) (qpRange1 o_3@@8)) (= (|Seq#Index| s@@17 (invRecv1 o_3@@8)) o_3@@8)))
 :qid |stdinbpl.665:22|
 :skolemid |61|
 :pattern ( (invRecv1 o_3@@8))
)) (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i_1@@2)) (not (= (|Seq#Index| s@@17 i_1@@2) null)))
 :qid |stdinbpl.671:22|
 :skolemid |62|
 :pattern ( (|Seq#Index| s@@17 i_1@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i_1@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i_1@@2)))
 :pattern ( (|Seq#Index| s@@17 i_1@@2))
))) (=> (and (and (forall ((o_3@@9 T@U) ) (!  (=> (= (type o_3@@9) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U (invRecv1 o_3@@9))) (< NoPerm FullPerm)) (qpRange1 o_3@@9)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| s@@17 (invRecv1 o_3@@9)) o_3@@9)) (= (U_2_real (MapType1Select QPMask@0 o_3@@9 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@9 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U (invRecv1 o_3@@9))) (< NoPerm FullPerm)) (qpRange1 o_3@@9))) (= (U_2_real (MapType1Select QPMask@0 o_3@@9 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@9 f_7))))))
 :qid |stdinbpl.677:22|
 :skolemid |63|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 48) 47) anon31_Else_correct) (=> (= (ControlFlow 0 48) 14) anon32_Then_correct)) (=> (= (ControlFlow 0 48) 19) anon32_Else_correct)))))))))
(let ((anon7_correct true))
(let ((anon30_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i@@6))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon30_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i@@6)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i@@6 (|Seq#Length| s@@17))) (=> (< i@@6 (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon27_Else_correct  (=> (and (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i1_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i2_1)) (not (= i1_1 i2_1)))) (not (= (|Seq#Index| s@@17 i1_1) (|Seq#Index| s@@17 i2_1))))
 :qid |stdinbpl.637:20|
 :skolemid |58|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i1_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i2_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i1_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i2_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i1_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i2_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i1_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i2_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i1_1)) (|Seq#Index| s@@17 i2_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i1_1)) (|Seq#Index| s@@17 i2_1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i2_1)) (|Seq#Index| s@@17 i1_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i2_1)) (|Seq#Index| s@@17 i1_1))
 :pattern ( (|Seq#Index| s@@17 i1_1) (|Seq#Index| s@@17 i2_1))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 50) 48) anon29_Else_correct) (=> (= (ControlFlow 0 50) 9) anon30_Then_correct)) (=> (= (ControlFlow 0 50) 12) anon30_Else_correct)))))
(let ((anon3_correct true))
(let ((anon28_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i2)) (not (= i1 i2))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon28_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@17)) (int_2_U i2)) (not (= i1 i2)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1 0)) (=> (>= i1 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1 (|Seq#Length| s@@17))) (=> (< i1 (|Seq#Length| s@@17)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2 0)) (=> (>= i2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2 (|Seq#Length| s@@17))) (=> (< i2 (|Seq#Length| s@@17)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (and (=> (= (ControlFlow 0 51) 50) anon27_Else_correct) (=> (= (ControlFlow 0 51) 2) anon28_Then_correct)) (=> (= (ControlFlow 0 51) 7) anon28_Else_correct)))))
