...
(declare-fun node_1 () T@U)
(declare-fun UnfoldingMask@1 () T@U)
(declare-fun Heap@@11 () T@U)
(declare-fun Heap@0 () T@U)
(declare-fun all_nodes@@6 () T@U)
(declare-fun FrameFragment (T@U) T@U)
(declare-fun neverTriggered1 (T@U) Bool)
(declare-fun invRecv1 (T@U) T@U)
(declare-fun qpRange1 (T@U) Bool)
(assert  (and (and (and (and (and (and (and (and (= (type all_nodes@@6) (MapType2Type RefType boolType)) (= (type node_1) RefType)) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Heap@@11) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (forall ((arg0@@48 T@U) ) (! (= (type (FrameFragment arg0@@48)) FrameTypeType)
...
(set-info :boogie-vc-id |acc_graph#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon7_correct true))
(let ((anon6_correct  (=> (and (and (and (= UnfoldingMask@0 (MapType1Store QPMask@0 null (read_fields node_1) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (read_fields node_1))) FullPerm)))) (not (= node_1 null))) (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 node_1 visited (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 node_1 visited)) FullPerm)))) (state Heap@@11 UnfoldingMask@1))) (and (and (state Heap@@11 UnfoldingMask@1) (= Heap@0 (MapType0Store Heap@@11 null (|read_fields#sm| node_1) (MapType1Store (MapType0Select Heap@@11 null (|read_fields#sm| node_1)) node_1 visited (bool_2_U true))))) (and (state Heap@0 QPMask@0) (= (ControlFlow 0 5) 3)))) anon7_correct)))
(let ((anon12_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon6_correct)))
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (read_fields node_1))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (read_fields node_1)))) (=> (= (ControlFlow 0 6) 5) anon6_correct))))))
(let ((anon11_Then_correct  (=> (U_2_bool (MapType2Select all_nodes@@6 node_1)) (=> (and (|read_fields#trigger| Heap@@11 (read_fields node_1)) (= (MapType0Select Heap@@11 null (read_fields node_1)) (FrameFragment (MapType0Select Heap@@11 node_1 visited)))) (and (=> (= (ControlFlow 0 9) 6) anon12_Then_correct) (=> (= (ControlFlow 0 9) 8) anon12_Else_correct))))))
(let ((anon11_Else_correct  (=> (and (not (U_2_bool (MapType2Select all_nodes@@6 node_1))) (= (ControlFlow 0 4) 3)) anon7_correct)))
(let ((anon10_Else_correct true))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((node_2 T@U) (node_2_1 T@U) ) (!  (=> (and (= (type node_2) RefType) (= (type node_2_1) RefType)) (=> (and (and (and (and (not (= node_2 node_2_1)) (U_2_bool (MapType2Select all_nodes@@6 node_2))) (U_2_bool (MapType2Select all_nodes@@6 node_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= node_2 node_2_1))))
 :qid |stdinbpl.516:17|
 :skolemid |95|
 :pattern ( (neverTriggered1 node_2) (neverTriggered1 node_2_1))
))) (=> (forall ((node_2@@0 T@U) (node_2_1@@0 T@U) ) (!  (=> (and (= (type node_2@@0) RefType) (= (type node_2_1@@0) RefType)) (=> (and (and (and (and (not (= node_2@@0 node_2_1@@0)) (U_2_bool (MapType2Select all_nodes@@6 node_2@@0))) (U_2_bool (MapType2Select all_nodes@@6 node_2_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= node_2@@0 node_2_1@@0))))
 :qid |stdinbpl.516:17|
 :skolemid |95|
 :pattern ( (neverTriggered1 node_2@@0) (neverTriggered1 node_2_1@@0))
)) (=> (and (forall ((node_2@@1 T@U) ) (!  (=> (= (type node_2@@1) RefType) (=> (and (U_2_bool (MapType2Select all_nodes@@6 node_2@@1)) (< NoPerm FullPerm)) (and (= (invRecv1 node_2@@1) node_2@@1) (qpRange1 node_2@@1))))
 :qid |stdinbpl.522:22|
 :skolemid |96|
 :pattern ( (MapType0Select Heap@@11 null (read_fields node_2@@1)))
 :pattern ( (MapType1Select ZeroMask null (read_fields node_2@@1)))
 :pattern ( (MapType2Select all_nodes@@6 node_2@@1))
)) (forall ((node_3_1 T@U) ) (!  (=> (= (type node_3_1) RefType) (=> (and (and (U_2_bool (MapType2Select all_nodes@@6 (invRecv1 node_3_1))) (< NoPerm FullPerm)) (qpRange1 node_3_1)) (= (invRecv1 node_3_1) node_3_1)))
 :qid |stdinbpl.526:22|
 :skolemid |97|
 :pattern ( (invRecv1 node_3_1))
))) (=> (and (and (forall ((node_3_1@@0 T@U) ) (!  (=> (= (type node_3_1@@0) RefType) (=> (and (and (U_2_bool (MapType2Select all_nodes@@6 (invRecv1 node_3_1@@0))) (< NoPerm FullPerm)) (qpRange1 node_3_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 node_3_1@@0) node_3_1@@0)) (= (U_2_real (MapType1Select QPMask@0 null (read_fields node_3_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (read_fields node_3_1@@0))) FullPerm)))))
 :qid |stdinbpl.532:22|
 :skolemid |98|
 :pattern ( (MapType1Select QPMask@0 null (read_fields node_3_1@@0)))
...
))) (and (forall ((node_3_1@@1 T@U) ) (!  (=> (and (= (type node_3_1@@1) RefType) (not (and (and (U_2_bool (MapType2Select all_nodes@@6 (invRecv1 node_3_1@@1))) (< NoPerm FullPerm)) (qpRange1 node_3_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (read_fields node_3_1@@1))) (U_2_real (MapType1Select ZeroMask null (read_fields node_3_1@@1)))))
 :qid |stdinbpl.542:22|
 :skolemid |100|
 :pattern ( (MapType1Select QPMask@0 null (read_fields node_3_1@@1)))
)) (state Heap@@11 QPMask@0))) (and (and (=> (= (ControlFlow 0 10) 2) anon10_Else_correct) (=> (= (ControlFlow 0 10) 9) anon11_Then_correct)) (=> (= (ControlFlow 0 10) 4) anon11_Else_correct))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (and (=> (= (ControlFlow 0 12) 1) anon9_Then_correct) (=> (= (ControlFlow 0 12) 10) anon9_Else_correct)))))
