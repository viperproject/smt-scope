...
(assert  (and (and (and (and (and (and (and (and (= (type Mask@1) (MapType2Type RefType realType)) (= (type z@@0) RefType)) (= (type Heap@2) (MapType1Type RefType))) (= (type y@@6) RefType)) (= (type Heap@0) (MapType1Type RefType))) (= (type Heap@@25) (MapType1Type RefType))) (= (type Heap@1) (MapType1Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@0) (MapType2Type RefType realType))))
(set-info :boogie-vc-id simple)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon4_correct true))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon4_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType2Select Mask@1 z@@0 f_7)))) (=> (<= FullPerm (U_2_real (MapType2Select Mask@1 z@@0 f_7))) (=> (= (ControlFlow 0 2) 1) anon4_correct))))))
(let ((anon2_correct  (=> (and (state Heap@2 Mask@1) (state Heap@2 Mask@1)) (and (=> (= (ControlFlow 0 5) 2) anon8_Then_correct) (=> (= (ControlFlow 0 5) 4) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (HasDirectPerm Mask@1 null (P y@@6)) (=> (and (= Heap@2 Heap@@25) (= (ControlFlow 0 7) 5)) anon2_correct))))
(let ((anon7_Then_correct  (=> (not (HasDirectPerm Mask@1 null (P y@@6))) (=> (and (and (= Heap@0 (MapType1Store Heap@@25 null (|P#sm| y@@6) ZeroPMask)) (= Heap@1 (MapType1Store Heap@0 null (P y@@6) freshVersion@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 6) 5))) anon2_correct))))
(let ((anon0_correct  (=> (state Heap@@25 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType1Select Heap@@25 y@@6 $allocated))) (and (U_2_bool (MapType1Select Heap@@25 z@@0 $allocated)) (= perm@0 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (=> (> perm@0 NoPerm) (not (= z@@0 null))) (= Mask@0 (MapType2Store ZeroMask z@@0 f_7 (real_2_U (+ (U_2_real (MapType2Select ZeroMask z@@0 f_7)) perm@0))))) (=> (and (and (state Heap@@25 Mask@0) (state Heap@@25 Mask@0)) (and (state Heap@@25 Mask@0) (= perm@1 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (= Mask@1 (MapType2Store Mask@0 null (P y@@6) (real_2_U (+ (U_2_real (MapType2Select Mask@0 null (P y@@6))) perm@1)))) (=> (and (and (state Heap@@25 Mask@1) (state Heap@@25 Mask@1)) (and (|P#trigger| Heap@@25 (P y@@6)) (= (MapType1Select Heap@@25 null (P y@@6)) EmptyFrame))) (and (=> (= (ControlFlow 0 8) 6) anon7_Then_correct) (=> (= (ControlFlow 0 8) 7) anon7_Else_correct))))))))))))))
