...
(set-info :boogie-vc-id h_e_termination_proof)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon5_correct true))
(let ((anon7_Else_correct  (=> (< 0 x@@28) (and (=> (= (ControlFlow 0 4) (- 0 6)) (decreasing (int_2_U (- x@@28 1)) (int_2_U x@@28))) (=> (decreasing (int_2_U (- x@@28 1)) (int_2_U x@@28)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (bounded (int_2_U x@@28))) (=> (bounded (int_2_U x@@28)) (=> (and (state Heap@@29 ZeroMask) (= (ControlFlow 0 4) 2)) anon5_correct))))))))
(let ((anon7_Then_correct  (=> (and (<= x@@28 0) (= (ControlFlow 0 3) 2)) anon5_correct)))
(let ((anon6_Else_correct  (=> (and (= (f1 Heap@@29 x@@28) x@@28) (state Heap@@29 ZeroMask)) (and (=> (= (ControlFlow 0 7) 3) anon7_Then_correct) (=> (= (ControlFlow 0 7) 4) anon7_Else_correct)))))
(let ((anon6_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@29 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (state Heap@@29 ZeroMask)) (and (=> (= (ControlFlow 0 8) 1) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct))))))
