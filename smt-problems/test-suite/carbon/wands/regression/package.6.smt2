...
(assert  (and (and (and (and (and (and (and (and (= (type Ops_17Heap@0) (MapType1Type RefType)) (= (type Ops_17Mask@2) (MapType0Type RefType realType))) (= (type Used_17Heap@0) (MapType1Type RefType))) (= (type Ops_17Mask@1) (MapType0Type RefType realType))) (= (type x@@8) RefType)) (= (type Ops_17Mask@0) (MapType0Type RefType realType))) (= (type Heap@@9) (MapType1Type RefType))) (= (type Mask@0) (MapType0Type RefType realType))) (= (type Used_16Heap@0) (MapType1Type RefType))))
(set-info :boogie-vc-id test05)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon7_correct  (=> (and (and (and (= b_33@6  (and b_33@5 (state Ops_17Heap@0 Ops_17Mask@2))) (= b_33@7  (and b_33@6 (state Ops_17Heap@0 Ops_17Mask@2)))) (and (= b_34@0  (and b_34 (state Used_17Heap@0 ZeroMask))) (= (ControlFlow 0 2) (- 0 1)))) (and (and b_33@7 b_33@7) b_34@0)) false)))
(let ((anon6_correct  (=> (and (and (= b_33@4  (and b_33@3 (= (U_2_int (MapType1Select Ops_17Heap@0 x@@8 f_7)) 0))) (= b_33@5 b_33@4)) (and (= Ops_17Mask@2 Ops_17Mask@1) (= (ControlFlow 0 5) 2))) anon7_correct)))
(let ((anon11_Else_correct  (=> (and (not b_33@3) (= (ControlFlow 0 8) 5)) anon6_correct)))
(let ((anon11_Then_correct  (=> b_33@3 (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm Ops_17Mask@1 x@@8 f_7)) (=> (HasDirectPerm Ops_17Mask@1 x@@8 f_7) (=> (= (ControlFlow 0 6) 5) anon6_correct))))))
(let ((anon10_Then_correct  (=> b_33@3 (and (=> (= (ControlFlow 0 9) 6) anon11_Then_correct) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (and (not b_33@3) (= b_33@5 b_33@3)) (and (= Ops_17Mask@2 Ops_17Mask@1) (= (ControlFlow 0 4) 2))) anon7_correct)))
(let ((anon9_Else_correct  (=> (not b_33@0) (=> (and (= Ops_17Mask@1 ZeroMask) (= b_33@3 b_33@0)) (and (=> (= (ControlFlow 0 12) 9) anon10_Then_correct) (=> (= (ControlFlow 0 12) 4) anon10_Else_correct))))))
(let ((anon9_Then_correct  (=> (and b_33@0 (= perm@1 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (= b_33@1  (and b_33@0 (=> (> perm@1 NoPerm) (not (= x@@8 null))))) (=> (and (and (= Ops_17Mask@0 (MapType0Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType0Select ZeroMask x@@8 f_7)) perm@1)))) (= b_33@2  (and b_33@1 (state Ops_17Heap@0 Ops_17Mask@0)))) (and (= Ops_17Mask@1 Ops_17Mask@0) (= b_33@3 b_33@2))) (and (=> (= (ControlFlow 0 10) 9) anon10_Then_correct) (=> (= (ControlFlow 0 10) 4) anon10_Else_correct)))))))))
(let ((anon8_Then_correct  (=> b_33@0 (and (=> (= (ControlFlow 0 13) 10) anon9_Then_correct) (=> (= (ControlFlow 0 13) 12) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (and (not b_33@0) (= b_33@5 b_33@0)) (and (= Ops_17Mask@2 ZeroMask) (= (ControlFlow 0 3) 2))) anon7_correct)))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType1Select Heap@@9 x@@8 $allocated)) (= perm@0 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= x@@8 null))) (=> (and (= Mask@0 (MapType0Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType0Select ZeroMask x@@8 f_7)) perm@0)))) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm Mask@0 x@@8 f_7)) (=> (HasDirectPerm Mask@0 x@@8 f_7) (=> (and (and (= (U_2_int (MapType1Select Heap@@9 x@@8 f_7)) 1) (state Heap@@9 Mask@0)) (and (= b_33@0  (and b_33 (state Ops_17Heap@0 ZeroMask))) (= b_32@0  (and b_32 (state Used_16Heap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 14) 13) anon8_Then_correct) (=> (= (ControlFlow 0 14) 3) anon8_Else_correct)))))))))))))
...
(assert  (and (and (and (and (and (and (and (and (and (= (type Ops_31Heap@0) (MapType1Type RefType)) (= (type Ops_31Mask@3) (MapType0Type RefType realType))) (= (type Used_31Heap@0) (MapType1Type RefType))) (= (type Mask@0) (MapType0Type RefType realType))) (= (type x@@8) RefType)) (= (type Heap@@9) (MapType1Type RefType))) (= (type Ops_31Mask@2) (MapType0Type RefType realType))) (= (type Ops_31Mask@1) (MapType0Type RefType realType))) (= (type Ops_31Mask@0) (MapType0Type RefType realType))) (= (type Used_30Heap@0) (MapType1Type RefType))))
(set-info :boogie-vc-id test14)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon5_correct  (=> (= b_60@7  (and b_60@6 (state Ops_31Heap@0 Ops_31Mask@3))) (=> (and (= b_60@8  (and b_60@7 (state Ops_31Heap@0 Ops_31Mask@3))) (= b_61@0  (and b_61 (state Used_31Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (and (and b_60@8 b_60@8) b_61@0) false)) (=> (=> (and (and b_60@8 b_60@8) b_61@0) false) (=> (= Mask@0 (MapType0Store ZeroMask null (wand_10 x@@8 FullPerm x@@8 FullPerm false) (real_2_U (+ (U_2_real (MapType0Select ZeroMask null (wand_10 x@@8 FullPerm x@@8 FullPerm false))) FullPerm)))) (=> (and (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) false))))))))
(let ((anon8_Else_correct  (=> (and (and (not b_60@3) (= b_60@6 b_60@3)) (and (= Ops_31Mask@3 Ops_31Mask@1) (= (ControlFlow 0 6) 2))) anon5_correct)))
(let ((anon8_Then_correct  (=> b_60@3 (=> (and (= b_60@4  (and b_60@3 (not (= x@@8 null)))) (= Ops_31Mask@2 (MapType0Store Ops_31Mask@1 x@@8 f_7 (real_2_U (+ (U_2_real (MapType0Select Ops_31Mask@1 x@@8 f_7)) FullPerm))))) (=> (and (and (= b_60@5  (and b_60@4 (state Ops_31Heap@0 Ops_31Mask@2))) (= b_60@6 b_60@5)) (and (= Ops_31Mask@3 Ops_31Mask@2) (= (ControlFlow 0 5) 2))) anon5_correct)))))
(let ((anon7_Else_correct  (=> (not b_60@0) (=> (and (= Ops_31Mask@1 ZeroMask) (= b_60@3 b_60@0)) (and (=> (= (ControlFlow 0 8) 5) anon8_Then_correct) (=> (= (ControlFlow 0 8) 6) anon8_Else_correct))))))
(let ((anon7_Then_correct  (=> (and b_60@0 (= b_60@1  (and b_60@0 (not (= x@@8 null))))) (=> (and (and (= Ops_31Mask@0 (MapType0Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType0Select ZeroMask x@@8 f_7)) FullPerm)))) (= b_60@2  (and b_60@1 (state Ops_31Heap@0 Ops_31Mask@0)))) (and (= Ops_31Mask@1 Ops_31Mask@0) (= b_60@3 b_60@2))) (and (=> (= (ControlFlow 0 7) 5) anon8_Then_correct) (=> (= (ControlFlow 0 7) 6) anon8_Else_correct))))))
(let ((anon6_Then_correct  (=> b_60@0 (and (=> (= (ControlFlow 0 9) 7) anon7_Then_correct) (=> (= (ControlFlow 0 9) 8) anon7_Else_correct)))))
(let ((anon6_Else_correct  (=> (and (and (not b_60@0) (= b_60@6 b_60@0)) (and (= Ops_31Mask@3 ZeroMask) (= (ControlFlow 0 4) 2))) anon5_correct)))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType1Select Heap@@9 x@@8 $allocated))) (and (= b_60@0  (and b_60 (state Ops_31Heap@0 ZeroMask))) (= b_59@0  (and b_59 (state Used_30Heap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 10) 9) anon6_Then_correct) (=> (= (ControlFlow 0 10) 4) anon6_Else_correct)))))
