...
(declare-fun Result_6Heap@8 () T@U)
(declare-fun Mask@2 () T@U)
(declare-fun Mask@1 () T@U)
(declare-fun Mask@3 () T@U)
(declare-fun Result_6Heap@7 () T@U)
(declare-fun Result_6Mask () T@U)
(declare-fun Result_6Heap@5 () T@U)
(declare-fun newPMask@3 () T@U)
(declare-fun Result_6Heap@6 () T@U)
(declare-fun Result_6Heap@3 () T@U)
(declare-fun Result_6Heap@4 () T@U)
(declare-fun Result_6Heap@1 () T@U)
(declare-fun newPMask@2 () T@U)
(declare-fun Result_6Heap@2 () T@U)
(declare-fun Result_6Heap@0 () T@U)
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type AssertMask@0) (MapType1Type RefType realType)) (= (type Mask@6) (MapType1Type RefType realType))) (= (type x@@20) RefType)) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Heap@9) (MapType0Type RefType))) (= (type Heap@7) (MapType0Type RefType))) (= (type newPMask@5) (MapType1Type RefType boolType))) (= (type Heap@8) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@6) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type newPMask@4) (MapType1Type RefType boolType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type UnfoldingMask@9) (MapType1Type RefType realType))) (= (type Heap@2) (MapType0Type RefType))) (= (type UnfoldingMask@8) (MapType1Type RefType realType))) (= (type UnfoldingMask@7) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (forall ((arg0@@47 T@U) (arg1@@62 T@U) ) (! (= (type (CombineFrames arg0@@47 arg1@@62)) FrameTypeType)
...
))) (= (type UnfoldingMask@5) (MapType1Type RefType realType))) (= (type UnfoldingMask@6) (MapType1Type RefType realType))) (= (type Result_6Heap@8) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Result_6Heap) (MapType0Type RefType))) (= (type Result_6Heap@7) (MapType0Type RefType))) (= (type Result_6Mask) (MapType1Type RefType realType))) (= (type Result_6Heap@5) (MapType0Type RefType))) (= (type newPMask@3) (MapType1Type RefType boolType))) (= (type Result_6Heap@6) (MapType0Type RefType))) (= (type Result_6Heap@3) (MapType0Type RefType))) (= (type Result_6Heap@4) (MapType0Type RefType))) (= (type Result_6Heap@1) (MapType0Type RefType))) (= (type newPMask@2) (MapType1Type RefType boolType))) (= (type Result_6Heap@2) (MapType0Type RefType))) (= (type Result_6Heap@0) (MapType0Type RefType))) (= (type UnfoldingHeap@3) (MapType0Type RefType))) (= (type UnfoldingMask@4) (MapType1Type RefType realType))) (= (type UnfoldingHeap@1) (MapType0Type RefType))) (= (type newPMask@1) (MapType1Type RefType boolType))) (= (type UnfoldingHeap@2) (MapType0Type RefType))) (= (type Unfolding1Mask@4) (MapType1Type RefType realType))) (= (type UnfoldingHeap@0) (MapType0Type RefType))) (= (type Unfolding1Mask@3) (MapType1Type RefType realType))) (= (type Unfolding1Mask@2) (MapType1Type RefType realType))) (= (type Unfolding1Mask@0) (MapType1Type RefType realType))) (= (type Unfolding1Mask@1) (MapType1Type RefType realType))) (= (type UnfoldingMask@3) (MapType1Type RefType realType))) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Used_12Mask@3) (MapType1Type RefType realType))) (= (type Ops_11Mask@3) (MapType1Type RefType realType))) (= (type Ops_11Heap@0) (MapType0Type RefType))) (= (type Used_12Heap@0) (MapType0Type RefType))) (= (type Used_12Mask@1) (MapType1Type RefType realType))) (= (type Heap@@13) (MapType0Type RefType))) (= (type Used_12Mask@2) (MapType1Type RefType realType))) (= (type TempMask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Ops_11Mask@1) (MapType1Type RefType realType))) (= (type Used_12Mask@0) (MapType1Type RefType realType))) (= (type TempMask@0) (MapType1Type RefType realType))) (= (type Ops_11Mask@2) (MapType1Type RefType realType))) (= (type Ops_11Mask@0) (MapType1Type RefType realType))) (= (type Used_11Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test03)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 75) (let ((anon43_correct  (=> (= AssertMask@0 (MapType1Store Mask@6 null (LLC x@@20 0) (real_2_U (- (U_2_real (MapType1Select Mask@6 null (LLC x@@20 0))) FullPerm)))) (=> (and (state ExhaleHeap@0 Mask@6) (= (ControlFlow 0 2) (- 0 1))) false))))
(let ((anon65_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon43_correct)))
(let ((anon65_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@6 null (LLC x@@20 0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@6 null (LLC x@@20 0)))) (=> (= (ControlFlow 0 3) 2) anon43_correct))))))
(let ((anon41_correct  (=> (state Heap@9 Mask@6) (=> (and (and (state Heap@9 Mask@6) (IdenticalOnKnownLocations Heap@9 ExhaleHeap@0 Mask@6)) (and (state ExhaleHeap@0 Mask@6) (state ExhaleHeap@0 Mask@6))) (and (=> (= (ControlFlow 0 6) 3) anon65_Then_correct) (=> (= (ControlFlow 0 6) 5) anon65_Else_correct))))))
(let ((anon64_Else_correct  (=> (= (MapType0Select Heap@7 (MapType0Select Heap@7 x@@20 next) next) null) (=> (and (= Heap@9 Heap@7) (= (ControlFlow 0 8) 6)) anon41_correct))))
(let ((anon64_Then_correct  (=> (not (= (MapType0Select Heap@7 (MapType0Select Heap@7 x@@20 next) next) null)) (=> (and (and (forall ((o_85 T@U) (f_89 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_89))))
(let ((A@@12 (FieldTypeInv0 (type f_89))))
 (=> (and (and (= (type o_85) RefType) (= (type f_89) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@7 null (|LLC#sm| (MapType0Select Heap@7 x@@20 next) 1)) o_85 f_89)) (U_2_bool (MapType1Select (MapType0Select Heap@7 null (|LLC#sm| (MapType0Select Heap@7 (MapType0Select Heap@7 x@@20 next) next) 2)) o_85 f_89)))) (U_2_bool (MapType1Select newPMask@5 o_85 f_89)))))
 :qid |stdinbpl.5118:33|
 :skolemid |158|
 :pattern ( (MapType1Select newPMask@5 o_85 f_89))
)) (= Heap@8 (MapType0Store Heap@7 null (|LLC#sm| (MapType0Select Heap@7 x@@20 next) 1) newPMask@5))) (and (= Heap@9 Heap@8) (= (ControlFlow 0 7) 6))) anon41_correct))))
(let ((anon39_correct  (=> (state Heap@5 Mask@6) (=> (and (= Heap@6 (MapType0Store Heap@5 null (|LLC#sm| (MapType0Select Heap@5 x@@20 next) 1) (MapType1Store (MapType0Select Heap@5 null (|LLC#sm| (MapType0Select Heap@5 x@@20 next) 1)) (MapType0Select Heap@5 x@@20 next) val (bool_2_U true)))) (= Heap@7 (MapType0Store Heap@6 null (|LLC#sm| (MapType0Select Heap@6 x@@20 next) 1) (MapType1Store (MapType0Select Heap@6 null (|LLC#sm| (MapType0Select Heap@6 x@@20 next) 1)) (MapType0Select Heap@6 x@@20 next) next (bool_2_U true))))) (and (=> (= (ControlFlow 0 9) 7) anon64_Then_correct) (=> (= (ControlFlow 0 9) 8) anon64_Else_correct))))))
(let ((anon63_Else_correct  (=> (= (MapType0Select Heap@3 x@@20 next) null) (=> (and (= Heap@5 Heap@3) (= (ControlFlow 0 11) 9)) anon39_correct))))
(let ((anon63_Then_correct  (=> (not (= (MapType0Select Heap@3 x@@20 next) null)) (=> (and (and (forall ((o_84 T@U) (f_88 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_88))))
(let ((A@@13 (FieldTypeInv0 (type f_88))))
 (=> (and (and (= (type o_84) RefType) (= (type f_88) (FieldType A@@13 B@@12))) (or (U_2_bool (MapType1Select (MapType0Select Heap@3 null (|LLC#sm| x@@20 0)) o_84 f_88)) (U_2_bool (MapType1Select (MapType0Select Heap@3 null (|LLC#sm| (MapType0Select Heap@3 x@@20 next) 1)) o_84 f_88)))) (U_2_bool (MapType1Select newPMask@4 o_84 f_88)))))
 :qid |stdinbpl.5107:33|
 :skolemid |157|
 :pattern ( (MapType1Select newPMask@4 o_84 f_88))
)) (= Heap@4 (MapType0Store Heap@3 null (|LLC#sm| x@@20 0) newPMask@4))) (and (= Heap@5 Heap@4) (= (ControlFlow 0 10) 9))) anon39_correct))))
(let ((anon37_correct  (=> (and (and (state Heap@1 UnfoldingMask@9) (=> (not (= (MapType0Select Heap@1 x@@20 next) null)) (= (U_2_int (MapType0Select Heap@1 (MapType0Select Heap@1 x@@20 next) val)) 1))) (and (= Heap@2 (MapType0Store Heap@1 null (|LLC#sm| x@@20 0) (MapType1Store (MapType0Select Heap@1 null (|LLC#sm| x@@20 0)) x@@20 val (bool_2_U true)))) (= Heap@3 (MapType0Store Heap@2 null (|LLC#sm| x@@20 0) (MapType1Store (MapType0Select Heap@2 null (|LLC#sm| x@@20 0)) x@@20 next (bool_2_U true)))))) (and (=> (= (ControlFlow 0 12) 10) anon63_Then_correct) (=> (= (ControlFlow 0 12) 11) anon63_Else_correct)))))
(let ((anon62_Else_correct  (=> (= (MapType0Select Heap@1 x@@20 next) null) (=> (and (= UnfoldingMask@9 UnfoldingMask@7) (= (ControlFlow 0 14) 12)) anon37_correct))))
(let ((anon62_Then_correct  (=> (and (not (= (MapType0Select Heap@1 x@@20 next) null)) (= UnfoldingMask@8 (MapType1Store UnfoldingMask@7 null (LLC (MapType0Select Heap@1 x@@20 next) 1) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@7 null (LLC (MapType0Select Heap@1 x@@20 next) 1))) FullPerm))))) (=> (and (and (InsidePredicate (LLC x@@20 0) (MapType0Select Heap@1 null (LLC x@@20 0)) (LLC (MapType0Select Heap@1 x@@20 next) 1) (MapType0Select Heap@1 null (LLC (MapType0Select Heap@1 x@@20 next) 1))) (state Heap@1 UnfoldingMask@8)) (and (= UnfoldingMask@9 UnfoldingMask@8) (= (ControlFlow 0 13) 12))) anon37_correct))))
(let ((anon35_correct  (=> (and (= Mask@5 (MapType1Store Mask@4 null (LLC x@@20 0) (real_2_U (- (U_2_real (MapType1Select Mask@4 null (LLC x@@20 0))) FullPerm)))) (state Heap@1 Mask@5)) (=> (and (and (= Mask@6 (MapType1Store Mask@5 null (LLC x@@20 0) (real_2_U (+ (U_2_real (MapType1Select Mask@5 null (LLC x@@20 0))) FullPerm)))) (state Heap@1 Mask@6)) (and (|LLC#trigger| Heap@1 (LLC x@@20 0)) (= (MapType0Select Heap@1 null (LLC x@@20 0)) (CombineFrames (FrameFragment (MapType0Select Heap@1 x@@20 val)) (CombineFrames (FrameFragment (MapType0Select Heap@1 x@@20 next)) (FrameFragment (ite (not (= (MapType0Select Heap@1 x@@20 next) null)) (MapType0Select Heap@1 null (LLC (MapType0Select Heap@1 x@@20 next) 1)) EmptyFrame))))))) (=> (and (and (and (= UnfoldingMask@5 (MapType1Store Mask@6 null (LLC x@@20 0) (real_2_U (- (U_2_real (MapType1Select Mask@6 null (LLC x@@20 0))) FullPerm)))) (not (= x@@20 null))) (and (= UnfoldingMask@6 (MapType1Store UnfoldingMask@5 x@@20 val (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@5 x@@20 val)) FullPerm)))) (state Heap@1 UnfoldingMask@6))) (and (and (= (U_2_int (MapType0Select Heap@1 x@@20 val)) 0) (not (= x@@20 null))) (and (= UnfoldingMask@7 (MapType1Store UnfoldingMask@6 x@@20 next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@6 x@@20 next)) FullPerm)))) (state Heap@1 UnfoldingMask@7)))) (and (=> (= (ControlFlow 0 15) 13) anon62_Then_correct) (=> (= (ControlFlow 0 15) 14) anon62_Else_correct)))))))
(let ((anon61_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 18) 15)) anon35_correct)))
(let ((anon61_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= FullPerm (U_2_real (MapType1Select Mask@4 null (LLC x@@20 0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 null (LLC x@@20 0)))) (=> (= (ControlFlow 0 16) 15) anon35_correct))))))
(let ((anon33_correct  (and (=> (= (ControlFlow 0 19) (- 0 21)) (=> (and (and b_23@5 b_23@5) b_24@6) (=> (not (= (MapType0Select Result_6Heap@8 x@@20 next) null)) (= (U_2_int (MapType0Select Result_6Heap@8 (MapType0Select Result_6Heap@8 x@@20 next) val)) 1)))) (=> (=> (and (and b_23@5 b_23@5) b_24@6) (=> (not (= (MapType0Select Result_6Heap@8 x@@20 next) null)) (= (U_2_int (MapType0Select Result_6Heap@8 (MapType0Select Result_6Heap@8 x@@20 next) val)) 1))) (=> (and (and (and (= Mask@2 (MapType1Store Mask@1 null (wand_4 x@@20 0 FullPerm x@@20 0 FullPerm x@@20 0 FullPerm x@@20 null x@@20 1 FullPerm x@@20 1) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (wand_4 x@@20 0 FullPerm x@@20 0 FullPerm x@@20 0 FullPerm x@@20 null x@@20 1 FullPerm x@@20 1))) FullPerm)))) (state Heap@1 Mask@2)) (and (state Heap@1 Mask@2) (state Heap@1 Mask@2))) (and (and (= Mask@3 (MapType1Store Mask@2 null (LLC x@@20 0) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (LLC x@@20 0))) FullPerm)))) (state Heap@1 Mask@3)) (and (state Heap@1 Mask@3) (state Heap@1 Mask@3)))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (<= FullPerm (U_2_real (MapType1Select Mask@3 null (wand_4 x@@20 0 FullPerm x@@20 0 FullPerm x@@20 0 FullPerm x@@20 null x@@20 1 FullPerm x@@20 1))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 null (wand_4 x@@20 0 FullPerm x@@20 0 FullPerm x@@20 0 FullPerm x@@20 null x@@20 1 FullPerm x@@20 1)))) (=> (and (= Mask@4 (MapType1Store Mask@3 null (wand_4 x@@20 0 FullPerm x@@20 0 FullPerm x@@20 0 FullPerm x@@20 null x@@20 1 FullPerm x@@20 1) (real_2_U (- (U_2_real (MapType1Select Mask@3 null (wand_4 x@@20 0 FullPerm x@@20 0 FullPerm x@@20 0 FullPerm x@@20 null x@@20 1 FullPerm x@@20 1))) FullPerm)))) (state Heap@1 Mask@4)) (and (=> (= (ControlFlow 0 19) 16) anon61_Then_correct) (=> (= (ControlFlow 0 19) 18) anon61_Else_correct))))))))))
(let ((anon32_correct  (=> (state Result_6Heap@7 Result_6Mask) (=> (and (= Result_6Heap@8 Result_6Heap@7) (= (ControlFlow 0 24) 19)) anon33_correct))))
(let ((anon60_Else_correct  (=> (= (MapType0Select Result_6Heap@5 (MapType0Select Result_6Heap@5 x@@20 next) next) null) (=> (and (= Result_6Heap@7 Result_6Heap@5) (= (ControlFlow 0 26) 24)) anon32_correct))))
(let ((anon60_Then_correct  (=> (not (= (MapType0Select Result_6Heap@5 (MapType0Select Result_6Heap@5 x@@20 next) next) null)) (=> (and (and (forall ((o_83 T@U) (f_87 T@U) ) (! (let ((B@@13 (FieldTypeInv1 (type f_87))))
(let ((A@@14 (FieldTypeInv0 (type f_87))))
 (=> (and (and (= (type o_83) RefType) (= (type f_87) (FieldType A@@14 B@@13))) (or (U_2_bool (MapType1Select (MapType0Select Result_6Heap@5 null (|LLC#sm| (MapType0Select Result_6Heap@5 x@@20 next) 1)) o_83 f_87)) (U_2_bool (MapType1Select (MapType0Select Result_6Heap@5 null (|LLC#sm| (MapType0Select Result_6Heap@5 (MapType0Select Result_6Heap@5 x@@20 next) next) 2)) o_83 f_87)))) (U_2_bool (MapType1Select newPMask@3 o_83 f_87)))))
 :qid |stdinbpl.5019:37|
 :skolemid |156|
 :pattern ( (MapType1Select newPMask@3 o_83 f_87))
)) (= Result_6Heap@6 (MapType0Store Result_6Heap@5 null (|LLC#sm| (MapType0Select Result_6Heap@5 x@@20 next) 1) newPMask@3))) (and (= Result_6Heap@7 Result_6Heap@6) (= (ControlFlow 0 25) 24))) anon32_correct))))
(let ((anon30_correct  (=> (state Result_6Heap@3 Result_6Mask) (=> (and (= Result_6Heap@4 (MapType0Store Result_6Heap@3 null (|LLC#sm| (MapType0Select Result_6Heap@3 x@@20 next) 1) (MapType1Store (MapType0Select Result_6Heap@3 null (|LLC#sm| (MapType0Select Result_6Heap@3 x@@20 next) 1)) (MapType0Select Result_6Heap@3 x@@20 next) val (bool_2_U true)))) (= Result_6Heap@5 (MapType0Store Result_6Heap@4 null (|LLC#sm| (MapType0Select Result_6Heap@4 x@@20 next) 1) (MapType1Store (MapType0Select Result_6Heap@4 null (|LLC#sm| (MapType0Select Result_6Heap@4 x@@20 next) 1)) (MapType0Select Result_6Heap@4 x@@20 next) next (bool_2_U true))))) (and (=> (= (ControlFlow 0 27) 25) anon60_Then_correct) (=> (= (ControlFlow 0 27) 26) anon60_Else_correct))))))
(let ((anon59_Else_correct  (=> (= (MapType0Select Result_6Heap@1 x@@20 next) null) (=> (and (= Result_6Heap@3 Result_6Heap@1) (= (ControlFlow 0 29) 27)) anon30_correct))))
(let ((anon59_Then_correct  (=> (not (= (MapType0Select Result_6Heap@1 x@@20 next) null)) (=> (and (and (forall ((o_82 T@U) (f_86 T@U) ) (! (let ((B@@14 (FieldTypeInv1 (type f_86))))
(let ((A@@15 (FieldTypeInv0 (type f_86))))
 (=> (and (and (= (type o_82) RefType) (= (type f_86) (FieldType A@@15 B@@14))) (or (U_2_bool (MapType1Select (MapType0Select Result_6Heap@1 null (|LLC#sm| x@@20 0)) o_82 f_86)) (U_2_bool (MapType1Select (MapType0Select Result_6Heap@1 null (|LLC#sm| (MapType0Select Result_6Heap@1 x@@20 next) 1)) o_82 f_86)))) (U_2_bool (MapType1Select newPMask@2 o_82 f_86)))))
 :qid |stdinbpl.5008:37|
 :skolemid |155|
 :pattern ( (MapType1Select newPMask@2 o_82 f_86))
)) (= Result_6Heap@2 (MapType0Store Result_6Heap@1 null (|LLC#sm| x@@20 0) newPMask@2))) (and (= Result_6Heap@3 Result_6Heap@2) (= (ControlFlow 0 28) 27))) anon30_correct))))
(let ((anon28_correct  (=> (and (= Result_6Heap@0 (MapType0Store Result_6Heap null (|LLC#sm| x@@20 0) (MapType1Store (MapType0Select Result_6Heap null (|LLC#sm| x@@20 0)) x@@20 val (bool_2_U true)))) (= Result_6Heap@1 (MapType0Store Result_6Heap@0 null (|LLC#sm| x@@20 0) (MapType1Store (MapType0Select Result_6Heap@0 null (|LLC#sm| x@@20 0)) x@@20 next (bool_2_U true))))) (and (=> (= (ControlFlow 0 30) 28) anon59_Then_correct) (=> (= (ControlFlow 0 30) 29) anon59_Else_correct)))))
(let ((anon27_correct  (=> (and (state UnfoldingHeap@3 UnfoldingMask@4) (= (ControlFlow 0 32) 30)) anon28_correct)))
(let ((anon58_Else_correct  (=> (= (MapType0Select UnfoldingHeap@1 (MapType0Select UnfoldingHeap@1 x@@20 next) next) null) (=> (and (= UnfoldingHeap@3 UnfoldingHeap@1) (= (ControlFlow 0 34) 32)) anon27_correct))))
(let ((anon58_Then_correct  (=> (not (= (MapType0Select UnfoldingHeap@1 (MapType0Select UnfoldingHeap@1 x@@20 next) next) null)) (=> (and (and (forall ((o_81 T@U) (f_85 T@U) ) (! (let ((B@@15 (FieldTypeInv1 (type f_85))))
(let ((A@@16 (FieldTypeInv0 (type f_85))))
 (=> (and (and (= (type o_81) RefType) (= (type f_85) (FieldType A@@16 B@@15))) (or (U_2_bool (MapType1Select (MapType0Select UnfoldingHeap@1 null (|LLC#sm| (MapType0Select UnfoldingHeap@1 x@@20 next) 1)) o_81 f_85)) (U_2_bool (MapType1Select (MapType0Select UnfoldingHeap@1 null (|LLC#sm| (MapType0Select UnfoldingHeap@1 (MapType0Select UnfoldingHeap@1 x@@20 next) next) 2)) o_81 f_85)))) (U_2_bool (MapType1Select newPMask@1 o_81 f_85)))))
 :qid |stdinbpl.4994:39|
 :skolemid |154|
 :pattern ( (MapType1Select newPMask@1 o_81 f_85))
)) (= UnfoldingHeap@2 (MapType0Store UnfoldingHeap@1 null (|LLC#sm| (MapType0Select UnfoldingHeap@1 x@@20 next) 1) newPMask@1))) (and (= UnfoldingHeap@3 UnfoldingHeap@2) (= (ControlFlow 0 33) 32))) anon27_correct))))
(let ((anon25_correct  (=> (state Result_6Heap Unfolding1Mask@4) (and (=> (= (ControlFlow 0 35) (- 0 38)) (HasDirectPerm Unfolding1Mask@4 x@@20 next)) (=> (HasDirectPerm Unfolding1Mask@4 x@@20 next) (and (=> (= (ControlFlow 0 35) (- 0 37)) (HasDirectPerm Unfolding1Mask@4 x@@20 next)) (=> (HasDirectPerm Unfolding1Mask@4 x@@20 next) (and (=> (= (ControlFlow 0 35) (- 0 36)) (HasDirectPerm Unfolding1Mask@4 (MapType0Select Result_6Heap x@@20 next) val)) (=> (HasDirectPerm Unfolding1Mask@4 (MapType0Select Result_6Heap x@@20 next) val) (=> (and (= UnfoldingHeap@0 (MapType0Store Result_6Heap null (|LLC#sm| (MapType0Select Result_6Heap x@@20 next) 1) (MapType1Store (MapType0Select Result_6Heap null (|LLC#sm| (MapType0Select Result_6Heap x@@20 next) 1)) (MapType0Select Result_6Heap x@@20 next) val (bool_2_U true)))) (= UnfoldingHeap@1 (MapType0Store UnfoldingHeap@0 null (|LLC#sm| (MapType0Select UnfoldingHeap@0 x@@20 next) 1) (MapType1Store (MapType0Select UnfoldingHeap@0 null (|LLC#sm| (MapType0Select UnfoldingHeap@0 x@@20 next) 1)) (MapType0Select UnfoldingHeap@0 x@@20 next) next (bool_2_U true))))) (and (=> (= (ControlFlow 0 35) 33) anon58_Then_correct) (=> (= (ControlFlow 0 35) 34) anon58_Else_correct))))))))))))
(let ((anon57_Else_correct  (=> (= (MapType0Select Result_6Heap (MapType0Select Result_6Heap x@@20 next) next) null) (=> (and (= Unfolding1Mask@4 Unfolding1Mask@2) (= (ControlFlow 0 40) 35)) anon25_correct))))
(let ((anon57_Then_correct  (=> (and (not (= (MapType0Select Result_6Heap (MapType0Select Result_6Heap x@@20 next) next) null)) (= Unfolding1Mask@3 (MapType1Store Unfolding1Mask@2 null (LLC (MapType0Select Result_6Heap (MapType0Select Result_6Heap x@@20 next) next) 2) (real_2_U (+ (U_2_real (MapType1Select Unfolding1Mask@2 null (LLC (MapType0Select Result_6Heap (MapType0Select Result_6Heap x@@20 next) next) 2))) FullPerm))))) (=> (and (and (InsidePredicate (LLC (MapType0Select Result_6Heap x@@20 next) 1) (MapType0Select Result_6Heap null (LLC (MapType0Select Result_6Heap x@@20 next) 1)) (LLC (MapType0Select Result_6Heap (MapType0Select Result_6Heap x@@20 next) next) 2) (MapType0Select Result_6Heap null (LLC (MapType0Select Result_6Heap (MapType0Select Result_6Heap x@@20 next) next) 2))) (state Result_6Heap Unfolding1Mask@3)) (and (= Unfolding1Mask@4 Unfolding1Mask@3) (= (ControlFlow 0 39) 35))) anon25_correct))))
(let ((anon23_correct  (=> (and (and (and (= Unfolding1Mask@0 (MapType1Store UnfoldingMask@4 null (LLC (MapType0Select Result_6Heap x@@20 next) 1) (real_2_U (- (U_2_real (MapType1Select UnfoldingMask@4 null (LLC (MapType0Select Result_6Heap x@@20 next) 1))) FullPerm)))) (not (= (MapType0Select Result_6Heap x@@20 next) null))) (and (= Unfolding1Mask@1 (MapType1Store Unfolding1Mask@0 (MapType0Select Result_6Heap x@@20 next) val (real_2_U (+ (U_2_real (MapType1Select Unfolding1Mask@0 (MapType0Select Result_6Heap x@@20 next) val)) FullPerm)))) (state Result_6Heap Unfolding1Mask@1))) (and (and (= (U_2_int (MapType0Select Result_6Heap (MapType0Select Result_6Heap x@@20 next) val)) 1) (not (= (MapType0Select Result_6Heap x@@20 next) null))) (and (= Unfolding1Mask@2 (MapType1Store Unfolding1Mask@1 (MapType0Select Result_6Heap x@@20 next) next (real_2_U (+ (U_2_real (MapType1Select Unfolding1Mask@1 (MapType0Select Result_6Heap x@@20 next) next)) FullPerm)))) (state Result_6Heap Unfolding1Mask@2)))) (and (=> (= (ControlFlow 0 41) 39) anon57_Then_correct) (=> (= (ControlFlow 0 41) 40) anon57_Else_correct)))))
(let ((anon56_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 44) 41)) anon23_correct)))
(let ((anon56_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 42) (- 0 43)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (LLC (MapType0Select Result_6Heap x@@20 next) 1))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (LLC (MapType0Select Result_6Heap x@@20 next) 1)))) (=> (= (ControlFlow 0 42) 41) anon23_correct))))))
(let ((anon55_Then_correct  (=> (not (= (MapType0Select Result_6Heap x@@20 next) null)) (=> (and (|LLC#trigger| Result_6Heap (LLC (MapType0Select Result_6Heap x@@20 next) 1)) (= (MapType0Select Result_6Heap null (LLC (MapType0Select Result_6Heap x@@20 next) 1)) (CombineFrames (FrameFragment (MapType0Select Result_6Heap (MapType0Select Result_6Heap x@@20 next) val)) (CombineFrames (FrameFragment (MapType0Select Result_6Heap (MapType0Select Result_6Heap x@@20 next) next)) (FrameFragment (ite (not (= (MapType0Select Result_6Heap (MapType0Select Result_6Heap x@@20 next) next) null)) (MapType0Select Result_6Heap null (LLC (MapType0Select Result_6Heap (MapType0Select Result_6Heap x@@20 next) next) 2)) EmptyFrame)))))) (and (=> (= (ControlFlow 0 45) 42) anon56_Then_correct) (=> (= (ControlFlow 0 45) 44) anon56_Else_correct))))))
(let ((anon55_Else_correct  (=> (and (= (MapType0Select Result_6Heap x@@20 next) null) (= (ControlFlow 0 31) 30)) anon28_correct)))
(let ((anon20_correct  (=> (state Result_6Heap UnfoldingMask@4) (and (=> (= (ControlFlow 0 46) (- 0 47)) (HasDirectPerm UnfoldingMask@4 x@@20 next)) (=> (HasDirectPerm UnfoldingMask@4 x@@20 next) (and (=> (= (ControlFlow 0 46) 45) anon55_Then_correct) (=> (= (ControlFlow 0 46) 31) anon55_Else_correct)))))))
(let ((anon54_Else_correct  (=> (= (MapType0Select Result_6Heap x@@20 next) null) (=> (and (= UnfoldingMask@4 UnfoldingMask@2) (= (ControlFlow 0 49) 46)) anon20_correct))))
(let ((anon54_Then_correct  (=> (and (not (= (MapType0Select Result_6Heap x@@20 next) null)) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 null (LLC (MapType0Select Result_6Heap x@@20 next) 1) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 null (LLC (MapType0Select Result_6Heap x@@20 next) 1))) FullPerm))))) (=> (and (and (InsidePredicate (LLC x@@20 0) (MapType0Select Result_6Heap null (LLC x@@20 0)) (LLC (MapType0Select Result_6Heap x@@20 next) 1) (MapType0Select Result_6Heap null (LLC (MapType0Select Result_6Heap x@@20 next) 1))) (state Result_6Heap UnfoldingMask@3)) (and (= UnfoldingMask@4 UnfoldingMask@3) (= (ControlFlow 0 48) 46))) anon20_correct))))
(let ((anon18_correct  (=> (and (and (and (= UnfoldingMask@0 (MapType1Store Result_6Mask null (LLC x@@20 0) (real_2_U (- (U_2_real (MapType1Select Result_6Mask null (LLC x@@20 0))) FullPerm)))) (not (= x@@20 null))) (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x@@20 val (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@20 val)) FullPerm)))) (state Result_6Heap UnfoldingMask@1))) (and (and (= (U_2_int (MapType0Select Result_6Heap x@@20 val)) 0) (not (= x@@20 null))) (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 x@@20 next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 x@@20 next)) FullPerm)))) (state Result_6Heap UnfoldingMask@2)))) (and (=> (= (ControlFlow 0 50) 48) anon54_Then_correct) (=> (= (ControlFlow 0 50) 49) anon54_Else_correct)))))
(let ((anon53_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 53) 50)) anon18_correct)))
(let ((anon53_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 51) (- 0 52)) (<= FullPerm (U_2_real (MapType1Select Result_6Mask null (LLC x@@20 0))))) (=> (<= FullPerm (U_2_real (MapType1Select Result_6Mask null (LLC x@@20 0)))) (=> (= (ControlFlow 0 51) 50) anon18_correct))))))
(let ((anon52_Then_correct  (=> b_23@5 (=> (and (|LLC#trigger| Result_6Heap (LLC x@@20 0)) (= (MapType0Select Result_6Heap null (LLC x@@20 0)) (CombineFrames (FrameFragment (MapType0Select Result_6Heap x@@20 val)) (CombineFrames (FrameFragment (MapType0Select Result_6Heap x@@20 next)) (FrameFragment (ite (not (= (MapType0Select Result_6Heap x@@20 next) null)) (MapType0Select Result_6Heap null (LLC (MapType0Select Result_6Heap x@@20 next) 1)) EmptyFrame)))))) (and (=> (= (ControlFlow 0 54) 51) anon53_Then_correct) (=> (= (ControlFlow 0 54) 53) anon53_Else_correct))))))
(let ((anon52_Else_correct  (=> (not b_23@5) (=> (and (= Result_6Heap@8 Result_6Heap) (= (ControlFlow 0 23) 19)) anon33_correct))))
(let ((anon51_Then_correct  (=> (and (and b_23@5 b_23@5) b_24@6) (and (=> (= (ControlFlow 0 55) 54) anon52_Then_correct) (=> (= (ControlFlow 0 55) 23) anon52_Else_correct)))))
(let ((anon51_Else_correct  (=> (not (and (and b_23@5 b_23@5) b_24@6)) (=> (and (= Result_6Heap@8 Result_6Heap) (= (ControlFlow 0 22) 19)) anon33_correct))))
(let ((anon14_correct  (and (=> (= (ControlFlow 0 56) (- 0 57)) (=> (and (and b_23@4 b_23@4) b_24@6) (and (= neededTransfer@3 0.0) (= (U_2_real (MapType1Select Used_12Mask@3 null (LLC x@@20 0))) initNeededTransfer@0)))) (=> (=> (and (and b_23@4 b_23@4) b_24@6) (and (= neededTransfer@3 0.0) (= (U_2_real (MapType1Select Used_12Mask@3 null (LLC x@@20 0))) initNeededTransfer@0))) (=> (and (= b_25@0  (and b_23@4 b_24@6)) (= b_25@1  (and b_25@0 (state Result_6Heap Result_6Mask)))) (=> (and (and (= b_25@2  (and b_25@1 (sumMask Result_6Mask Ops_11Mask@3 Used_12Mask@3))) (= b_25@3  (and (and b_25@2 (IdenticalOnKnownLocations Ops_11Heap@0 Result_6Heap Ops_11Mask@3)) (IdenticalOnKnownLocations Used_12Heap@0 Result_6Heap Used_12Mask@3)))) (and (= b_25@4  (and b_25@3 (state Result_6Heap Result_6Mask))) (= b_23@5  (and b_23@4 b_25@4)))) (and (=> (= (ControlFlow 0 56) 55) anon51_Then_correct) (=> (= (ControlFlow 0 56) 22) anon51_Else_correct))))))))
(let ((anon50_Else_correct  (=> (>= 0.0 takeTransfer@1) (=> (and (= Mask@1 ZeroMask) (= neededTransfer@3 neededTransfer@1)) (=> (and (and (= b_24@6 b_24@3) (= Used_12Mask@3 Used_12Mask@1)) (and (= Heap@1 Heap@@13) (= (ControlFlow 0 60) 56))) anon14_correct)))))
(let ((anon50_Then_correct  (=> (> takeTransfer@1 0.0) (=> (and (= neededTransfer@2 (- neededTransfer@1 takeTransfer@1)) (= Used_12Mask@2 (MapType1Store Used_12Mask@1 null (LLC x@@20 0) (real_2_U (+ (U_2_real (MapType1Select Used_12Mask@1 null (LLC x@@20 0))) takeTransfer@1))))) (=> (and (and (= b_24@4  (and b_24@3 (state Used_12Heap@0 Used_12Mask@2))) (= TempMask@1 (MapType1Store ZeroMask null (LLC x@@20 0) (real_2_U FullPerm)))) (and (= b_24@5  (and b_24@4 (IdenticalOnKnownLocations Heap@@13 Used_12Heap@0 TempMask@1))) (= Mask@0 (MapType1Store ZeroMask null (LLC x@@20 0) (real_2_U (- (U_2_real (MapType1Select ZeroMask null (LLC x@@20 0))) takeTransfer@1)))))) (=> (and (and (and (forall ((o_80 T@U) (f_84 T@U) ) (! (let ((B@@16 (FieldTypeInv1 (type f_84))))
(let ((A@@17 (FieldTypeInv0 (type f_84))))
 (=> (and (and (= (type o_80) RefType) (= (type f_84) (FieldType A@@17 B@@16))) (or (U_2_bool (MapType1Select (MapType0Select Heap@@13 null (|wand_4#sm| x@@20 0 FullPerm x@@20 0 FullPerm x@@20 0 FullPerm x@@20 null x@@20 1 FullPerm x@@20 1)) o_80 f_84)) (U_2_bool (MapType1Select (MapType0Select Heap@@13 null (|LLC#sm| x@@20 0)) o_80 f_84)))) (U_2_bool (MapType1Select newPMask@0 o_80 f_84)))))
 :qid |stdinbpl.4898:35|
 :skolemid |153|
 :pattern ( (MapType1Select newPMask@0 o_80 f_84))
)) (= Heap@0 (MapType0Store Heap@@13 null (|wand_4#sm| x@@20 0 FullPerm x@@20 0 FullPerm x@@20 0 FullPerm x@@20 null x@@20 1 FullPerm x@@20 1) newPMask@0))) (and (= Mask@1 Mask@0) (= neededTransfer@3 neededTransfer@2))) (and (and (= b_24@6 b_24@5) (= Used_12Mask@3 Used_12Mask@2)) (and (= Heap@1 Heap@0) (= (ControlFlow 0 59) 56)))) anon14_correct))))))
(let ((anon49_Else_correct  (=> (and (< maskTransfer@1 neededTransfer@1) (= takeTransfer@1 maskTransfer@1)) (and (=> (= (ControlFlow 0 62) 59) anon50_Then_correct) (=> (= (ControlFlow 0 62) 60) anon50_Else_correct)))))
(let ((anon49_Then_correct  (=> (and (<= neededTransfer@1 maskTransfer@1) (= takeTransfer@1 neededTransfer@1)) (and (=> (= (ControlFlow 0 61) 59) anon50_Then_correct) (=> (= (ControlFlow 0 61) 60) anon50_Else_correct)))))
(let ((anon48_Then_correct  (=> (and (and (and (and (and b_23@4 b_23@4) b_24@3) true) (> neededTransfer@1 0.0)) (= maskTransfer@1 (U_2_real (MapType1Select ZeroMask null (LLC x@@20 0))))) (and (=> (= (ControlFlow 0 63) 61) anon49_Then_correct) (=> (= (ControlFlow 0 63) 62) anon49_Else_correct)))))
(let ((anon48_Else_correct  (=> (not (and (and (and (and b_23@4 b_23@4) b_24@3) true) (> neededTransfer@1 0.0))) (=> (and (= Mask@1 ZeroMask) (= neededTransfer@3 neededTransfer@1)) (=> (and (and (= b_24@6 b_24@3) (= Used_12Mask@3 Used_12Mask@1)) (and (= Heap@1 Heap@@13) (= (ControlFlow 0 58) 56))) anon14_correct)))))
(let ((anon47_Else_correct  (=> (>= 0.0 takeTransfer@0) (=> (and (and (= Ops_11Mask@3 Ops_11Mask@1) (= Used_12Mask@1 ZeroMask)) (and (= b_24@3 b_24@0) (= neededTransfer@1 FullPerm))) (and (=> (= (ControlFlow 0 66) 63) anon48_Then_correct) (=> (= (ControlFlow 0 66) 58) anon48_Else_correct))))))
(let ((anon47_Then_correct  (=> (> takeTransfer@0 0.0) (=> (and (= neededTransfer@0 (- FullPerm takeTransfer@0)) (= Used_12Mask@0 (MapType1Store ZeroMask null (LLC x@@20 0) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (LLC x@@20 0))) takeTransfer@0))))) (=> (and (and (and (= b_24@1  (and b_24@0 (state Used_12Heap@0 Used_12Mask@0))) (= TempMask@0 (MapType1Store ZeroMask null (LLC x@@20 0) (real_2_U FullPerm)))) (and (= b_24@2  (and b_24@1 (IdenticalOnKnownLocations Ops_11Heap@0 Used_12Heap@0 TempMask@0))) (= Ops_11Mask@2 (MapType1Store Ops_11Mask@1 null (LLC x@@20 0) (real_2_U (- (U_2_real (MapType1Select Ops_11Mask@1 null (LLC x@@20 0))) takeTransfer@0)))))) (and (and (= Ops_11Mask@3 Ops_11Mask@2) (= Used_12Mask@1 Used_12Mask@0)) (and (= b_24@3 b_24@2) (= neededTransfer@1 neededTransfer@0)))) (and (=> (= (ControlFlow 0 65) 63) anon48_Then_correct) (=> (= (ControlFlow 0 65) 58) anon48_Else_correct)))))))
(let ((anon46_Else_correct  (=> (and (< maskTransfer@0 FullPerm) (= takeTransfer@0 maskTransfer@0)) (and (=> (= (ControlFlow 0 68) 65) anon47_Then_correct) (=> (= (ControlFlow 0 68) 66) anon47_Else_correct)))))
(let ((anon46_Then_correct  (=> (and (<= FullPerm maskTransfer@0) (= takeTransfer@0 FullPerm)) (and (=> (= (ControlFlow 0 67) 65) anon47_Then_correct) (=> (= (ControlFlow 0 67) 66) anon47_Else_correct)))))
(let ((anon45_Then_correct  (=> (and (and (and (and (and b_23@4 b_23@4) b_24@0) true) (> FullPerm 0.0)) (= maskTransfer@0 (U_2_real (MapType1Select Ops_11Mask@1 null (LLC x@@20 0))))) (and (=> (= (ControlFlow 0 69) 67) anon46_Then_correct) (=> (= (ControlFlow 0 69) 68) anon46_Else_correct)))))
(let ((anon45_Else_correct  (=> (not (and (and (and (and b_23@4 b_23@4) b_24@0) true) (> FullPerm 0.0))) (=> (and (and (= Ops_11Mask@3 Ops_11Mask@1) (= Used_12Mask@1 ZeroMask)) (and (= b_24@3 b_24@0) (= neededTransfer@1 FullPerm))) (and (=> (= (ControlFlow 0 64) 63) anon48_Then_correct) (=> (= (ControlFlow 0 64) 58) anon48_Else_correct))))))
(let ((anon2_correct  (=> (and (and (= b_23@3  (and b_23@2 (state Ops_11Heap@0 Ops_11Mask@1))) (= b_23@4  (and b_23@3 (state Ops_11Heap@0 Ops_11Mask@1)))) (and (= b_24@0  (and b_24 (state Used_12Heap@0 ZeroMask))) (= initNeededTransfer@0 (+ (U_2_real (MapType1Select ZeroMask null (LLC x@@20 0))) FullPerm)))) (and (=> (= (ControlFlow 0 70) (- 0 71)) (>= FullPerm 0.0)) (=> (>= FullPerm 0.0) (and (=> (= (ControlFlow 0 70) 69) anon45_Then_correct) (=> (= (ControlFlow 0 70) 64) anon45_Else_correct)))))))
(let ((anon44_Else_correct  (=> (and (and (not b_23@0) (= Ops_11Mask@1 ZeroMask)) (and (= b_23@2 b_23@0) (= (ControlFlow 0 73) 70))) anon2_correct)))
(let ((anon44_Then_correct  (=> (and b_23@0 (= Ops_11Mask@0 (MapType1Store ZeroMask null (LLC x@@20 0) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (LLC x@@20 0))) FullPerm))))) (=> (and (and (= b_23@1  (and b_23@0 (state Ops_11Heap@0 Ops_11Mask@0))) (= Ops_11Mask@1 Ops_11Mask@0)) (and (= b_23@2 b_23@1) (= (ControlFlow 0 72) 70))) anon2_correct))))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (U_2_bool (MapType0Select Heap@@13 x@@20 $allocated))) (and (= b_23@0  (and b_23 (state Ops_11Heap@0 ZeroMask))) (= b_22@0  (and b_22 (state Used_11Heap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 74) 72) anon44_Then_correct) (=> (= (ControlFlow 0 74) 73) anon44_Else_correct)))))
