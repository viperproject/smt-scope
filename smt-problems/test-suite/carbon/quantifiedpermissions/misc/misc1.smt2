...
(assert (forall ((i_1 Int) ) (!  (and (= (rds 0) NoPerm) (and (= (rds i_1) (* (to_real i_1) rd)) (=> (>= i_1 0) (< (rds i_1) FullPerm))))
 :qid |stdinbpl.241:15|
 :skolemid |23|
 :pattern ( (rds i_1))
)))
...
(assert  (and (forall ((arg0@@26 T@U) ) (! (= (type (temp arg0@@26)) RefType)
 :qid |funType:temp|
 :pattern ( (temp arg0@@26))
)) (forall ((arg0@@27 T@U) ) (! (= (type (temp_inv arg0@@27)) RefType)
 :qid |funType:temp_inv|
 :pattern ( (temp_inv arg0@@27))
))))
(assert (forall ((r_1 T@U) ) (!  (=> (= (type r_1) RefType) (and (= (temp_inv (temp r_1)) r_1) (ite (is_ghost r_1) (= (temp r_1) r_1) (= (heap (temp r_1)) (- 0 3)))))
 :qid |stdinbpl.222:15|
 :skolemid |22|
 :pattern ( (temp r_1))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@4) (MapType1Type RefType realType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type Mask@3) (MapType1Type RefType realType))) (forall ((arg0@@28 T@U) ) (! (= (type (up arg0@@28)) RefType)
 :qid |funType:up|
 :pattern ( (up arg0@@28))
))) (= (type data) RefType)) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type ghost) RefType)) (= (type count) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id clone)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon6_correct true))
(let ((anon5_correct  (=> (and (= Mask@3 (MapType1Store Mask@2 (up data) val (real_2_U (- (U_2_real (MapType1Select Mask@2 (up data) val)) perm@3)))) (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@3)) (=> (and (and (state ExhaleHeap@0 Mask@3) (= Mask@4 Mask@3)) (and (= Heap@0 ExhaleHeap@0) (= (ControlFlow 0 4) 2))) anon6_correct))))
(let ((anon9_Else_correct  (=> (and (= perm@3 NoPerm) (= (ControlFlow 0 7) 4)) anon5_correct)))
(let ((anon9_Then_correct  (=> (not (= perm@3 NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= perm@3 (U_2_real (MapType1Select Mask@2 (up data) val)))) (=> (<= perm@3 (U_2_real (MapType1Select Mask@2 (up data) val))) (=> (= (ControlFlow 0 5) 4) anon5_correct))))))
(let ((anon8_Then_correct  (=> (and (>= t_1 0) (= perm@3 (- (- FullPerm (rds (+ t_1 1))) (ite (< (- FullPerm (rds (+ t_1 1))) (U_2_real (MapType1Select Mask@2 (temp data) val))) (- FullPerm (rds (+ t_1 1))) (U_2_real (MapType1Select Mask@2 (temp data) val)))))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (>= perm@3 NoPerm)) (=> (>= perm@3 NoPerm) (and (=> (= (ControlFlow 0 8) 5) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct)))))))
(let ((anon8_Else_correct  (=> (and (and (> 0 t_1) (= Mask@4 Mask@2)) (and (= Heap@0 Heap@@9) (= (ControlFlow 0 3) 2))) anon6_correct)))
(let ((anon7_Else_correct  (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (= (U_2_real (MapType1Select QPMask@0 o_3 val)) (U_2_real (MapType1Select Mask@1 o_3 val))))
 :qid |stdinbpl.322:22|
 :skolemid |24|
 :pattern ( (MapType1Select QPMask@0 o_3 val))
)) (forall ((o_3@@0 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@0) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 val))) (= (U_2_real (MapType1Select Mask@1 o_3@@0 f_5)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_5))))))
 :qid |stdinbpl.326:29|
 :skolemid |25|
 :pattern ( (MapType1Select Mask@1 o_3@@0 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@0 f_5))
))) (=> (and (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (= perm@2 (- FullPerm (rds t_1))))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (=> (and (and (and (=> (> perm@2 NoPerm) (not (= (temp ghost) null))) (= Mask@2 (MapType1Store QPMask@0 (temp ghost) val (real_2_U (+ (U_2_real (MapType1Select QPMask@0 (temp ghost) val)) perm@2))))) (and (state Heap@@9 Mask@2) (state Heap@@9 Mask@2))) (and (and (state Heap@@9 Mask@2) (< t_1 1)) (and (state Heap@@9 Mask@2) (state Heap@@9 Mask@2)))) (and (=> (= (ControlFlow 0 10) 8) anon8_Then_correct) (=> (= (ControlFlow 0 10) 3) anon8_Else_correct)))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@9 data $allocated)) (U_2_bool (MapType0Select Heap@@9 count $allocated))) (and (U_2_bool (MapType0Select Heap@@9 ghost $allocated)) (= (heap data) 0))) (and (and (= (heap count) 0) (= (heap ghost) 0)) (and (is_ghost ghost) (= perm@0 rd)))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= data null))) (= Mask@0 (MapType1Store ZeroMask data val (real_2_U (+ (U_2_real (MapType1Select ZeroMask data val)) perm@0))))) (and (state Heap@@9 Mask@0) (= perm@1 rd))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (and (=> (> perm@1 NoPerm) (not (= ghost null))) (= Mask@1 (MapType1Store Mask@0 ghost val (real_2_U (+ (U_2_real (MapType1Select Mask@0 ghost val)) perm@1))))) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1))) (and (=> (= (ControlFlow 0 12) 1) anon7_Then_correct) (=> (= (ControlFlow 0 12) 10) anon7_Else_correct))))))))))))
