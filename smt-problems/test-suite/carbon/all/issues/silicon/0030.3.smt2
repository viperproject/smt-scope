...
(declare-fun C__P (T@U) T@U)
(declare-fun PredicateType_C__PType () T@T)
(declare-fun |C__g'| (T@U T@U) Int)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |C__g#triggerStateless| (T@U) Int)
(declare-fun |C__P#trigger| (T@U T@U) Bool)
(declare-fun |C__P#everUsed| (T@U) Bool)
(declare-fun $allocated () T@U)
(declare-fun NormalFieldType () T@T)
(declare-fun C__g (T@U T@U) Int)
(declare-fun |C__P#sm| (T@U) T@U)
...
(declare-fun |C__g#frame| (T@U T@U) Int)
...
(assert  (and (= (Ctor PredicateType_C__PType) 11) (forall ((arg0@@25 T@U) ) (! (= (type (C__P arg0@@25)) (FieldType PredicateType_C__PType FrameTypeType))
 :qid |funType:C__P|
 :pattern ( (C__P arg0@@25))
))))
(assert (forall ((diz T@U) ) (!  (=> (= (type diz) RefType) (IsPredicateField (C__P diz)))
 :qid |stdinbpl.247:15|
 :skolemid |26|
 :pattern ( (C__P diz))
)))
(assert (forall ((Heap@@2 T@U) (diz@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type diz@@0) RefType)) (dummyFunction (int_2_U (|C__g#triggerStateless| diz@@0))))
 :qid |stdinbpl.189:15|
 :skolemid |23|
 :pattern ( (|C__g'| Heap@@2 diz@@0))
)))
(assert (forall ((Heap@@3 T@U) (diz@@1 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type diz@@1) RefType)) (|C__P#everUsed| (C__P diz@@1)))
 :qid |stdinbpl.266:15|
 :skolemid |30|
 :pattern ( (|C__P#trigger| Heap@@3 (C__P diz@@1)))
)))
...
(assert (forall ((Heap@@5 T@U) (diz@@2 T@U) ) (!  (=> (and (= (type Heap@@5) (MapType0Type RefType)) (= (type diz@@2) RefType)) (and (= (C__g Heap@@5 diz@@2) (|C__g'| Heap@@5 diz@@2)) (dummyFunction (int_2_U (|C__g#triggerStateless| diz@@2)))))
 :qid |stdinbpl.185:15|
 :skolemid |22|
 :pattern ( (C__g Heap@@5 diz@@2))
)))
(assert (forall ((diz@@3 T@U) (diz2 T@U) ) (!  (=> (and (and (= (type diz@@3) RefType) (= (type diz2) RefType)) (= (C__P diz@@3) (C__P diz2))) (= diz@@3 diz2))
 :qid |stdinbpl.257:15|
 :skolemid |28|
 :pattern ( (C__P diz@@3) (C__P diz2))
)))
(assert (forall ((arg0@@26 T@U) ) (! (= (type (|C__P#sm| arg0@@26)) (FieldType PredicateType_C__PType (MapType1Type RefType boolType)))
 :qid |funType:C__P#sm|
 :pattern ( (|C__P#sm| arg0@@26))
)))
(assert (forall ((diz@@4 T@U) (diz2@@0 T@U) ) (!  (=> (and (and (= (type diz@@4) RefType) (= (type diz2@@0) RefType)) (= (|C__P#sm| diz@@4) (|C__P#sm| diz2@@0))) (= diz@@4 diz2@@0))
 :qid |stdinbpl.261:15|
 :skolemid |29|
 :pattern ( (|C__P#sm| diz@@4) (|C__P#sm| diz2@@0))
)))
...
(assert (forall ((arg0@@28 T@U) (arg1@@10 T@U) ) (! (= (type (CombineFrames arg0@@28 arg1@@10)) FrameTypeType)
 :qid |funType:CombineFrames|
 :pattern ( (CombineFrames arg0@@28 arg1@@10))
)))
(assert (forall ((Heap@@8 T@U) (Mask@@6 T@U) (diz@@5 T@U) ) (!  (=> (and (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (= (type diz@@5) RefType)) (state Heap@@8 Mask@@6)) (= (|C__g'| Heap@@8 diz@@5) (|C__g#frame| (CombineFrames (MapType0Select Heap@@8 null (C__P diz@@5)) (MapType0Select Heap@@8 null (C__P diz@@5))) diz@@5)))
 :qid |stdinbpl.196:15|
 :skolemid |24|
 :pattern ( (state Heap@@8 Mask@@6) (|C__g'| Heap@@8 diz@@5))
)))
...
(assert (forall ((diz@@6 T@U) ) (!  (=> (= (type diz@@6) RefType) (= (getPredWandId (C__P diz@@6)) 0))
 :qid |stdinbpl.251:15|
 :skolemid |27|
 :pattern ( (C__P diz@@6))
)))
...
(assert (forall ((diz@@7 T@U) ) (!  (=> (= (type diz@@7) RefType) (= (PredicateMaskField (C__P diz@@7)) (|C__P#sm| diz@@7)))
 :qid |stdinbpl.243:15|
 :skolemid |25|
 :pattern ( (PredicateMaskField (C__P diz@@7)))
)))
...
(declare-fun diz@@8 () T@U)
(declare-fun Mask@0 () T@U)
(declare-fun wildcard@0 () Real)
(declare-fun Heap@@13 () T@U)
(declare-fun AssumeFunctionsAbove () Int)
(declare-fun wildcard () Real)
(assert  (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type diz@@8) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@13) (MapType0Type RefType))))
(set-info :boogie-vc-id C__main)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 5) 2)) anon3_correct)))
(let ((anon6_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= perm@0 (U_2_real (MapType1Select Mask@1 null (C__P diz@@8))))) (=> (<= perm@0 (U_2_real (MapType1Select Mask@1 null (C__P diz@@8)))) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))
(let ((anon5_Then_correct  (and (=> (= (ControlFlow 0 6) (- 0 9)) (not (= diz@@8 null))) (=> (not (= diz@@8 null)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (> (U_2_real (MapType1Select Mask@0 null (C__P diz@@8))) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@0 null (C__P diz@@8))) NoPerm) (=> (and (and (> wildcard@0 NoPerm) (< wildcard@0 (U_2_real (MapType1Select Mask@0 null (C__P diz@@8))))) (and (= Mask@1 (MapType1Store Mask@0 null (C__P diz@@8) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (C__P diz@@8))) wildcard@0)))) (= perm@0 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 6) 3) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))))))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@13 diz@@8 $allocated))) (and (not (= diz@@8 null)) (state Heap@@13 ZeroMask))) (and (and (= Mask@0 (MapType1Store ZeroMask null (C__P diz@@8) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (C__P diz@@8))) FullPerm)))) (state Heap@@13 Mask@0)) (and (state Heap@@13 Mask@0) (state Heap@@13 Mask@0)))) (and (=> (= (ControlFlow 0 10) 6) anon5_Then_correct) (=> (= (ControlFlow 0 10) 1) anon5_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (> wildcard NoPerm) true) (= (ControlFlow 0 11) 10)) anon0_correct)))
