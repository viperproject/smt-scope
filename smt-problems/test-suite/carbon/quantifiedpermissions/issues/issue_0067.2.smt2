...
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type S) (MapType2Type RefType boolType)) (= (type s_4) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type s_6) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type b_2) RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type a_2) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv4 arg0@@43)) RefType)
 :qid |funType:invRecv4|
 :pattern ( (invRecv4 arg0@@43))
))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv3 arg0@@44)) RefType)
...
)) (=> (and (forall ((s_5@@1 T@U) ) (!  (=> (= (type s_5@@1) RefType) (=> (and (and (U_2_bool (MapType2Select S s_5@@1)) (not (= s_5@@1 null))) (< NoPerm (U_2_real (MapType0Select Heap@@9 s_5@@1 k)))) (and (qpRange4 s_5@@1) (= (invRecv4 s_5@@1) s_5@@1))))
 :qid |stdinbpl.691:22|
 :skolemid |104|
 :pattern ( (MapType0Select Heap@@9 s_5@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 s_5@@1 f_7))
 :pattern ( (MapType2Select S s_5@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (U_2_bool (MapType2Select S (invRecv4 o_3))) (not (= (invRecv4 o_3) null))) (< NoPerm (U_2_real (MapType0Select Heap@@9 (invRecv4 o_3) k)))) (qpRange4 o_3)) (= (invRecv4 o_3) o_3)))
 :qid |stdinbpl.695:22|
 :skolemid |105|
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (U_2_bool (MapType2Select S (invRecv4 o_3@@0))) (not (= (invRecv4 o_3@@0) null))) (< NoPerm (U_2_real (MapType0Select Heap@@9 (invRecv4 o_3@@0) k)))) (qpRange4 o_3@@0)) (and (=> (< NoPerm (U_2_real (MapType0Select Heap@@9 (invRecv4 o_3@@0) k))) (= (invRecv4 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType0Select Heap@@9 (invRecv4 o_3@@0) k)))))) (=> (not (and (and (and (U_2_bool (MapType2Select S (invRecv4 o_3@@0))) (not (= (invRecv4 o_3@@0) null))) (< NoPerm (U_2_real (MapType0Select Heap@@9 (invRecv4 o_3@@0) k)))) (qpRange4 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7))))))
 :qid |stdinbpl.713:22|
 :skolemid |108|
...
(let ((anon19_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select S s_6)) (not (= s_6 null)))) (= (ControlFlow 0 9) 6)) anon9_correct)))
(let ((anon19_Then_correct  (=> (and (U_2_bool (MapType2Select S s_6)) (not (= s_6 null))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm QPMask@0 s_6 k)) (=> (HasDirectPerm QPMask@0 s_6 k) (=> (= (ControlFlow 0 7) 6) anon9_correct))))))
...
(let ((anon17_Else_correct  (=> (and (not (U_2_bool (MapType2Select S s_4))) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon17_Then_correct  (=> (U_2_bool (MapType2Select S s_4)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 s_4 k)) (=> (HasDirectPerm QPMask@0 s_4 k) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
...
)) (=> (forall ((s_1@@1 T@U) ) (!  (=> (= (type s_1@@1) RefType) (=> (and (U_2_bool (MapType2Select S s_1@@1)) (< NoPerm FullPerm)) (and (qpRange3 s_1@@1) (= (invRecv3 s_1@@1) s_1@@1))))
 :qid |stdinbpl.633:22|
 :skolemid |97|
 :pattern ( (MapType0Select Heap@@9 s_1@@1 k))
 :pattern ( (MapType1Select QPMask@0 s_1@@1 k))
 :pattern ( (MapType2Select S s_1@@1))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType2Select S (invRecv3 o_3@@2))) (< NoPerm FullPerm)) (qpRange3 o_3@@2)) (= (invRecv3 o_3@@2) o_3@@2)))
 :qid |stdinbpl.637:22|
 :skolemid |98|
...
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType2Select S (invRecv3 o_3@@3))) (< NoPerm FullPerm)) (qpRange3 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 k)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 k)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select S (invRecv3 o_3@@3))) (< NoPerm FullPerm)) (qpRange3 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 k)) (U_2_real (MapType1Select ZeroMask o_3@@3 k))))))
 :qid |stdinbpl.649:22|
 :skolemid |100|
