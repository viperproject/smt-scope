...
(assert  (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (forall ((arg0@@37 T@U) ) (! (= (type (invRecv4 arg0@@37)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((x_4 T@U) (x_4_1 T@U) ) (!  (=> (and (= (type x_4) RefType) (= (type x_4_1) RefType)) (=> (and (and (not (= x_4 x_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4 x_4_1))))
 :qid |stdinbpl.913:17|
 :skolemid |88|
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_6 T@U) (x_6_1 T@U) ) (!  (=> (and (= (type x_6) RefType) (= (type x_6_1) RefType)) (=> (and (and (not (= x_6 x_6_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_6 x_6_1))))
 :qid |stdinbpl.960:17|
 :skolemid |94|
 :pattern ( (neverTriggered6 x_6) (neverTriggered6 x_6_1))
))) (=> (forall ((x_6@@0 T@U) (x_6_1@@0 T@U) ) (!  (=> (and (= (type x_6@@0) RefType) (= (type x_6_1@@0) RefType)) (=> (and (and (not (= x_6@@0 x_6_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_6@@0 x_6_1@@0))))
 :qid |stdinbpl.960:17|
 :skolemid |94|
 :pattern ( (neverTriggered6 x_6@@0) (neverTriggered6 x_6_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_6@@1 T@U) ) (!  (=> (= (type x_6@@1) RefType) (>= (U_2_real (MapType1Select QPMask@0 null (p_1 x_6@@1))) FullPerm))
 :qid |stdinbpl.967:17|
 :skolemid |95|
 :pattern ( (MapType0Select Heap@@10 null (p_1 x_6@@1)))
 :pattern ( (MapType1Select QPMask@0 null (p_1 x_6@@1)))
)))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (not (= x_1 x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.860:17|
 :skolemid |82|
 :pattern ( (neverTriggered4 x_1) (neverTriggered4 x_1_1))
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (not (= x_1@@0 x_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.860:17|
 :skolemid |82|
 :pattern ( (neverTriggered4 x_1@@0) (neverTriggered4 x_1_1@@0))
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (and (= (type x_1@@1) RefType) (< NoPerm FullPerm)) (and (= (invRecv4 x_1@@1) x_1@@1) (qpRange4 x_1@@1)))
 :qid |stdinbpl.866:22|
 :skolemid |83|
 :pattern ( (MapType0Select Heap@@10 null (p_1 x_1@@1)))
 :pattern ( (MapType1Select ZeroMask null (p_1 x_1@@1)))
)) (=> (and (forall ((r@@5 T@U) ) (!  (=> (= (type r@@5) RefType) (=> (and (< NoPerm FullPerm) (qpRange4 r@@5)) (= (invRecv4 r@@5) r@@5)))
 :qid |stdinbpl.870:22|
 :skolemid |84|
 :pattern ( (invRecv4 r@@5))
)) (forall ((r@@6 T@U) ) (!  (=> (= (type r@@6) RefType) (=> (and (< NoPerm FullPerm) (qpRange4 r@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv4 r@@6) r@@6)) (= (U_2_real (MapType1Select QPMask@0 null (p_1 r@@6))) (+ (U_2_real (MapType1Select ZeroMask null (p_1 r@@6))) FullPerm)))))
 :qid |stdinbpl.876:22|
 :skolemid |85|
 :pattern ( (MapType1Select QPMask@0 null (p_1 r@@6)))
...
)) (forall ((r@@7 T@U) ) (!  (=> (and (= (type r@@7) RefType) (not (and (< NoPerm FullPerm) (qpRange4 r@@7)))) (= (U_2_real (MapType1Select QPMask@0 null (p_1 r@@7))) (U_2_real (MapType1Select ZeroMask null (p_1 r@@7)))))
 :qid |stdinbpl.886:22|
 :skolemid |87|
 :pattern ( (MapType1Select QPMask@0 null (p_1 r@@7)))
