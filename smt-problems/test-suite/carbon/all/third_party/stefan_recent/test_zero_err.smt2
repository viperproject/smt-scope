...
))) (= (Ctor RefType) 9)) (= (type zero__x) (FieldType NormalFieldType (SeqType RefType)))) (= (type Ref__Integer_value) (FieldType NormalFieldType intType))))
(assert (distinct $allocated zero__x Ref__Integer_value)
)
...
(assert  (not (IsPredicateField zero__x)))
(assert  (not (IsWandField zero__x)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type diz) RefType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type PostMask@1) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type __flatten_1) RefType)) (= (type __flatten_1@0) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id zero__main_main)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 36) (let ((anon4_correct  (=> (and (= Mask@3 (MapType1Store Mask@2 (|Seq#Index| (MapType0Select Heap@0 diz zero__x) tid) Ref__Integer_value (real_2_U (- (U_2_real (MapType1Select Mask@2 (|Seq#Index| (MapType0Select Heap@0 diz zero__x) tid) Ref__Integer_value)) FullPerm)))) (= (ControlFlow 0 13) (- 0 12))) (= (U_2_int (MapType0Select Heap@0 (|Seq#Index| (MapType0Select Heap@0 diz zero__x) tid) Ref__Integer_value)) 0))))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 13)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (U_2_real (MapType1Select Mask@2 (|Seq#Index| (MapType0Select Heap@0 diz zero__x) tid) Ref__Integer_value)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 (|Seq#Index| (MapType0Select Heap@0 diz zero__x) tid) Ref__Integer_value))) (=> (= (ControlFlow 0 14) 13) anon4_correct))))))
(let ((anon5_Else_correct  (=> (and (U_2_bool (MapType0Select Heap@@9 __flatten_1 $allocated)) (state Heap@@9 Mask@1)) (and (=> (= (ControlFlow 0 17) (- 0 30)) (HasDirectPerm Mask@1 diz zero__x)) (=> (HasDirectPerm Mask@1 diz zero__x) (and (=> (= (ControlFlow 0 17) (- 0 29)) (>= tid 0)) (=> (>= tid 0) (and (=> (= (ControlFlow 0 17) (- 0 28)) (< tid (|Seq#Length| (MapType0Select Heap@@9 diz zero__x)))) (=> (< tid (|Seq#Length| (MapType0Select Heap@@9 diz zero__x))) (=> (= __flatten_1@0 (|Seq#Index| (MapType0Select Heap@@9 diz zero__x) tid)) (=> (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1)) (and (=> (= (ControlFlow 0 17) (- 0 27)) (= FullPerm (U_2_real (MapType1Select Mask@1 __flatten_1@0 Ref__Integer_value)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 __flatten_1@0 Ref__Integer_value))) (=> (and (= Heap@0 (MapType0Store Heap@@9 __flatten_1@0 Ref__Integer_value (int_2_U 1))) (state Heap@0 Mask@1)) (and (=> (= (ControlFlow 0 17) (- 0 26)) (<= 0 tid)) (=> (<= 0 tid) (and (=> (= (ControlFlow 0 17) (- 0 25)) (< tid tcount)) (=> (< tid tcount) (and (=> (= (ControlFlow 0 17) (- 0 24)) (<= 0 lid)) (=> (<= 0 lid) (and (=> (= (ControlFlow 0 17) (- 0 23)) (< lid gsize)) (=> (< lid gsize) (and (=> (= (ControlFlow 0 17) (- 0 22)) (<= 0 gid)) (=> (<= 0 gid) (and (=> (= (ControlFlow 0 17) (- 0 21)) (= tid (+ lid (* gid gsize)))) (=> (= tid (+ lid (* gid gsize))) (and (=> (= (ControlFlow 0 17) (- 0 20)) (> (U_2_real (MapType1Select Mask@1 diz zero__x)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@1 diz zero__x)) NoPerm) (=> (> wildcard@2 NoPerm) (=> (and (< wildcard@2 (U_2_real (MapType1Select Mask@1 diz zero__x))) (= Mask@2 (MapType1Store Mask@1 diz zero__x (real_2_U (- (U_2_real (MapType1Select Mask@1 diz zero__x)) wildcard@2))))) (and (=> (= (ControlFlow 0 17) (- 0 19)) (= (|Seq#Length| (MapType0Select Heap@0 diz zero__x)) tcount)) (=> (= (|Seq#Length| (MapType0Select Heap@0 diz zero__x)) tcount) (and (=> (= (ControlFlow 0 17) (- 0 18)) (|Seq#Equal| (MapType0Select Heap@0 diz zero__x) (MapType0Select Heap@@9 diz zero__x))) (=> (|Seq#Equal| (MapType0Select Heap@0 diz zero__x) (MapType0Select Heap@@9 diz zero__x)) (and (=> (= (ControlFlow 0 17) 14) anon6_Then_correct) (=> (= (ControlFlow 0 17) 16) anon6_Else_correct))))))))))))))))))))))))))))))))))))
(let ((anon5_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (<= 0 tid)) (=> (and (and (and (and (state PostHeap@0 ZeroMask) (< tid tcount)) (and (state PostHeap@0 ZeroMask) (<= 0 lid))) (and (and (state PostHeap@0 ZeroMask) (< lid gsize)) (and (state PostHeap@0 ZeroMask) (<= 0 gid)))) (and (and (and (state PostHeap@0 ZeroMask) (= tid (+ lid (* gid gsize)))) (and (state PostHeap@0 ZeroMask) (> wildcard@1 NoPerm))) (and (and (not (= diz null)) (= PostMask@0 (MapType1Store ZeroMask diz zero__x (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz zero__x)) wildcard@1))))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (HasDirectPerm PostMask@0 diz zero__x)) (=> (HasDirectPerm PostMask@0 diz zero__x) (=> (and (= (|Seq#Length| (MapType0Select PostHeap@0 diz zero__x)) tcount) (state PostHeap@0 PostMask@0)) (and (=> (= (ControlFlow 0 2) (- 0 10)) (HasDirectPerm PostMask@0 diz zero__x)) (=> (HasDirectPerm PostMask@0 diz zero__x) (and (=> (= (ControlFlow 0 2) (- 0 9)) (HasDirectPerm Mask@1 diz zero__x)) (=> (HasDirectPerm Mask@1 diz zero__x) (=> (and (|Seq#Equal| (MapType0Select PostHeap@0 diz zero__x) (MapType0Select Heap@@9 diz zero__x)) (state PostHeap@0 PostMask@0)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (HasDirectPerm PostMask@0 diz zero__x)) (=> (HasDirectPerm PostMask@0 diz zero__x) (and (=> (= (ControlFlow 0 2) (- 0 7)) (>= tid 0)) (=> (>= tid 0) (and (=> (= (ControlFlow 0 2) (- 0 6)) (< tid (|Seq#Length| (MapType0Select PostHeap@0 diz zero__x)))) (=> (< tid (|Seq#Length| (MapType0Select PostHeap@0 diz zero__x))) (=> (and (and (not (= (|Seq#Index| (MapType0Select PostHeap@0 diz zero__x) tid) null)) (= PostMask@1 (MapType1Store PostMask@0 (|Seq#Index| (MapType0Select PostHeap@0 diz zero__x) tid) Ref__Integer_value (real_2_U (+ (U_2_real (MapType1Select PostMask@0 (|Seq#Index| (MapType0Select PostHeap@0 diz zero__x) tid) Ref__Integer_value)) FullPerm))))) (and (state PostHeap@0 PostMask@1) (state PostHeap@0 PostMask@1))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm PostMask@1 diz zero__x)) (=> (HasDirectPerm PostMask@1 diz zero__x) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= tid 0)) (=> (>= tid 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< tid (|Seq#Length| (MapType0Select PostHeap@0 diz zero__x)))) (=> (< tid (|Seq#Length| (MapType0Select PostHeap@0 diz zero__x))) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm PostMask@1 (|Seq#Index| (MapType0Select PostHeap@0 diz zero__x) tid) Ref__Integer_value)))))))))))))))))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 diz $allocated)) (not (= diz null))) (=> (and (and (state Heap@@9 ZeroMask) (>= current_thread_id 0)) (and (state Heap@@9 ZeroMask) (<= 0 tid))) (=> (and (and (and (and (state Heap@@9 ZeroMask) (< tid tcount)) (and (state Heap@@9 ZeroMask) (<= 0 lid))) (and (and (state Heap@@9 ZeroMask) (< lid gsize)) (and (state Heap@@9 ZeroMask) (<= 0 gid)))) (and (and (and (state Heap@@9 ZeroMask) (= tid (+ lid (* gid gsize)))) (and (state Heap@@9 ZeroMask) (> wildcard@0 NoPerm))) (and (and (not (= diz null)) (= Mask@0 (MapType1Store ZeroMask diz zero__x (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz zero__x)) wildcard@0))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))))) (and (=> (= (ControlFlow 0 31) (- 0 35)) (HasDirectPerm Mask@0 diz zero__x)) (=> (HasDirectPerm Mask@0 diz zero__x) (=> (and (= (|Seq#Length| (MapType0Select Heap@@9 diz zero__x)) tcount) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 31) (- 0 34)) (HasDirectPerm Mask@0 diz zero__x)) (=> (HasDirectPerm Mask@0 diz zero__x) (and (=> (= (ControlFlow 0 31) (- 0 33)) (>= tid 0)) (=> (>= tid 0) (and (=> (= (ControlFlow 0 31) (- 0 32)) (< tid (|Seq#Length| (MapType0Select Heap@@9 diz zero__x)))) (=> (< tid (|Seq#Length| (MapType0Select Heap@@9 diz zero__x))) (=> (and (and (not (= (|Seq#Index| (MapType0Select Heap@@9 diz zero__x) tid) null)) (= Mask@1 (MapType1Store Mask@0 (|Seq#Index| (MapType0Select Heap@@9 diz zero__x) tid) Ref__Integer_value (real_2_U (+ (U_2_real (MapType1Select Mask@0 (|Seq#Index| (MapType0Select Heap@@9 diz zero__x) tid) Ref__Integer_value)) FullPerm))))) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1))) (and (=> (= (ControlFlow 0 31) 2) anon5_Then_correct) (=> (= (ControlFlow 0 31) 17) anon5_Else_correct))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (> wildcard NoPerm) true) (= (ControlFlow 0 36) 31)) anon0_correct)))
