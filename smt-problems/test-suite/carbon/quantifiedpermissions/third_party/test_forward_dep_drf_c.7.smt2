...
(let ((anon5_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (< (- i@@34 1) (- N 1)) (state PostHeap@0 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= (- i@@34 1) 0)) (=> (>= (- i@@34 1) 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< (- i@@34 1) (|Seq#Length| a_2))) (=> (< (- i@@34 1) (|Seq#Length| a_2)) (=> (and (= perm@1 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@1 NoPerm))))))))))
