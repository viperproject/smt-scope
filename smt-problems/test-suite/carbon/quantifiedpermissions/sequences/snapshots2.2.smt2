...
(declare-fun |get02'| (T@U T@U Int) Int)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |get02#triggerStateless| (T@U Int) Int)
...
(declare-fun |id'| (T@U T@U) T@U)
(declare-fun |id#triggerStateless| (T@U) T@U)
(declare-fun |get01'| (T@U T@U) Int)
(declare-fun |get01#triggerStateless| (T@U) Int)
(declare-fun |Seq#Update| (T@U Int T@U) T@U)
(declare-fun |Seq#Take| (T@U Int) T@U)
(declare-fun |get01#frame| (T@U T@U) Int)
...
(declare-fun |get02#frame| (T@U T@U Int) Int)
...
(declare-fun |id#frame| (T@U T@U) T@U)
...
(assert (forall ((Heap@@0 T@U) (xs T@U) (i Int) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type xs) (SeqType RefType))) (dummyFunction (int_2_U (|get02#triggerStateless| xs i))))
 :qid |stdinbpl.701:15|
 :skolemid |67|
 :pattern ( (|get02'| Heap@@0 xs i))
)))
...
(assert  (and (forall ((arg0@@29 T@U) (arg1@@11 T@U) ) (! (= (type (|id'| arg0@@29 arg1@@11)) RefType)
 :qid |funType:id'|
 :pattern ( (|id'| arg0@@29 arg1@@11))
)) (forall ((arg0@@30 T@U) ) (! (= (type (|id#triggerStateless| arg0@@30)) RefType)
 :qid |funType:id#triggerStateless|
 :pattern ( (|id#triggerStateless| arg0@@30))
))))
(assert (forall ((Heap@@3 T@U) (x@@8 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type x@@8) RefType)) (dummyFunction (|id#triggerStateless| x@@8)))
 :qid |stdinbpl.576:15|
 :skolemid |59|
 :pattern ( (|id'| Heap@@3 x@@8))
)))
(assert (forall ((Heap@@4 T@U) (x@@9 T@U) ) (!  (=> (and (= (type Heap@@4) (MapType0Type RefType)) (= (type x@@9) RefType)) (dummyFunction (int_2_U (|get01#triggerStateless| x@@9))))
 :qid |stdinbpl.626:15|
 :skolemid |63|
 :pattern ( (|get01'| Heap@@4 x@@9))
)))
...
)) (forall ((arg0@@34 T@U) (arg1@@14 T@U) ) (! (= (type (id arg0@@34 arg1@@14)) RefType)
 :qid |funType:id|
 :pattern ( (id arg0@@34 arg1@@14))
))))
(assert (forall ((Heap@@5 T@U) (Mask@@2 T@U) (x@@10 T@U) ) (!  (=> (and (and (and (= (type Heap@@5) (MapType0Type RefType)) (= (type Mask@@2) (MapType1Type RefType realType))) (= (type x@@10) RefType)) (state Heap@@5 Mask@@2)) (= (|get01'| Heap@@5 x@@10) (|get01#frame| (FrameFragment (MapType0Select Heap@@5 (id Heap@@5 x@@10) f_7)) x@@10)))
 :qid |stdinbpl.639:15|
 :skolemid |65|
 :pattern ( (state Heap@@5 Mask@@2) (|get01'| Heap@@5 x@@10))
)))
...
(assert (forall ((Heap@@7 T@U) (x@@12 T@U) ) (!  (=> (and (= (type Heap@@7) (MapType0Type RefType)) (= (type x@@12) RefType)) (and (= (id Heap@@7 x@@12) (|id'| Heap@@7 x@@12)) (dummyFunction (|id#triggerStateless| x@@12))))
 :qid |stdinbpl.572:15|
 :skolemid |58|
 :pattern ( (id Heap@@7 x@@12))
)))
(assert (forall ((Heap@@8 T@U) (x@@13 T@U) ) (!  (=> (and (= (type Heap@@8) (MapType0Type RefType)) (= (type x@@13) RefType)) (and (= (get01 Heap@@8 x@@13) (|get01'| Heap@@8 x@@13)) (dummyFunction (int_2_U (|get01#triggerStateless| x@@13)))))
 :qid |stdinbpl.622:15|
 :skolemid |62|
 :pattern ( (get01 Heap@@8 x@@13))
)))
...
(assert (forall ((x@@14 T@U) (y@@1 T@U) ) (! (let ((T@@10 (type x@@14)))
 (=> (= (type y@@1) T@@10) (= (|Seq#Contains| (|Seq#Singleton| x@@14) y@@1) (= x@@14 y@@1))))
 :qid |stdinbpl.534:18|
 :skolemid |54|
 :pattern ( (|Seq#Contains| (|Seq#Singleton| x@@14) y@@1))
)))
(assert (forall ((Heap@@9 T@U) (Mask@@4 T@U) (xs@@0 T@U) (i@@3 Int) ) (!  (=> (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@4) (MapType1Type RefType realType))) (= (type xs@@0) (SeqType RefType))) (state Heap@@9 Mask@@4)) (= (|get02'| Heap@@9 xs@@0 i@@3) (|get02#frame| (FrameFragment (MapType0Select Heap@@9 (|Seq#Index| xs@@0 i@@3) f_7)) xs@@0 i@@3)))
 :qid |stdinbpl.714:15|
 :skolemid |69|
 :pattern ( (state Heap@@9 Mask@@4) (|get02'| Heap@@9 xs@@0 i@@3))
)))
...
(assert (forall ((Heap@@10 T@U) (ExhaleHeap@@2 T@U) (Mask@@5 T@U) (o_1@@0 T@U) (f_2 T@U) ) (! (let ((B@@1 (FieldTypeInv1 (type f_2))))
(let ((A@@1 (FieldTypeInv0 (type f_2))))
 (=> (and (and (and (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type ExhaleHeap@@2) (MapType0Type RefType))) (= (type Mask@@5) (MapType1Type RefType realType))) (= (type o_1@@0) RefType)) (= (type f_2) (FieldType A@@1 B@@1))) (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@2 Mask@@5)) (HasDirectPerm Mask@@5 o_1@@0 f_2)) (= (MapType0Select Heap@@10 o_1@@0 f_2) (MapType0Select ExhaleHeap@@2 o_1@@0 f_2)))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@@2 Mask@@5) (MapType0Select ExhaleHeap@@2 o_1@@0 f_2))
)))
...
(assert (forall ((Heap@@12 T@U) (xs@@1 T@U) (i@@4 Int) ) (!  (=> (and (= (type Heap@@12) (MapType0Type RefType)) (= (type xs@@1) (SeqType RefType))) (and (= (get02 Heap@@12 xs@@1 i@@4) (|get02'| Heap@@12 xs@@1 i@@4)) (dummyFunction (int_2_U (|get02#triggerStateless| xs@@1 i@@4)))))
 :qid |stdinbpl.697:15|
 :skolemid |66|
 :pattern ( (get02 Heap@@12 xs@@1 i@@4))
)))
...
(assert (forall ((arg0@@39 T@U) (arg1@@18 T@U) ) (! (= (type (|id#frame| arg0@@39 arg1@@18)) RefType)
 :qid |funType:id#frame|
 :pattern ( (|id#frame| arg0@@39 arg1@@18))
)))
(assert (forall ((Heap@@15 T@U) (Mask@@11 T@U) (x@@15 T@U) ) (!  (=> (and (and (and (= (type Heap@@15) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (= (type x@@15) RefType)) (state Heap@@15 Mask@@11)) (= (|id'| Heap@@15 x@@15) (|id#frame| EmptyFrame x@@15)))
 :qid |stdinbpl.589:15|
 :skolemid |61|
 :pattern ( (state Heap@@15 Mask@@11) (|id'| Heap@@15 x@@15))
)))
...
(assert (forall ((s@@14 T@U) (x@@16 T@U) (i@@8 Int) ) (! (let ((T@@30 (type x@@16)))
 (=> (= (type s@@14) (SeqType T@@30)) (=> (and (and (<= 0 i@@8) (< i@@8 (|Seq#Length| s@@14))) (= (|Seq#Index| s@@14 i@@8) x@@16)) (|Seq#Contains| s@@14 x@@16))))
 :qid |stdinbpl.412:18|
 :skolemid |48|
 :pattern ( (|Seq#Contains| s@@14 x@@16) (|Seq#Index| s@@14 i@@8))
)))
...
(assert (forall ((Heap@@18 T@U) (Mask@@12 T@U) (xs@@2 T@U) (i@@9 Int) ) (!  (=> (and (and (and (and (= (type Heap@@18) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (= (type xs@@2) (SeqType RefType))) (and (state Heap@@18 Mask@@12) (< AssumeFunctionsAbove 0))) (and (<= 0 i@@9) (< i@@9 (|Seq#Length| xs@@2)))) (= (get02 Heap@@18 xs@@2 i@@9) (U_2_int (MapType0Select Heap@@18 (|Seq#Index| xs@@2 i@@9) f_7))))
 :qid |stdinbpl.707:15|
 :skolemid |68|
 :pattern ( (state Heap@@18 Mask@@12) (get02 Heap@@18 xs@@2 i@@9))
)))
(assert (forall ((Heap@@19 T@U) (Mask@@13 T@U) (x@@17 T@U) ) (!  (=> (and (and (and (= (type Heap@@19) (MapType0Type RefType)) (= (type Mask@@13) (MapType1Type RefType realType))) (= (type x@@17) RefType)) (and (state Heap@@19 Mask@@13) (< AssumeFunctionsAbove 1))) (= (get01 Heap@@19 x@@17) (U_2_int (MapType0Select Heap@@19 (id Heap@@19 x@@17) f_7))))
 :qid |stdinbpl.632:15|
 :skolemid |64|
 :pattern ( (state Heap@@19 Mask@@13) (get01 Heap@@19 x@@17))
)))
(assert (forall ((Heap@@20 T@U) (Mask@@14 T@U) (x@@18 T@U) ) (!  (=> (and (and (and (= (type Heap@@20) (MapType0Type RefType)) (= (type Mask@@14) (MapType1Type RefType realType))) (= (type x@@18) RefType)) (and (state Heap@@20 Mask@@14) (< AssumeFunctionsAbove 2))) (= (id Heap@@20 x@@18) x@@18))
 :qid |stdinbpl.582:15|
 :skolemid |60|
 :pattern ( (state Heap@@20 Mask@@14) (id Heap@@20 x@@18))
)))
...
(declare-fun i1 () Int)
(declare-fun i2 () Int)
(assert  (and (and (= (type xs@@3) (SeqType RefType)) (= (type Heap@@21) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test03)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon11_correct true))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 18) 15)) anon11_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs@@3 0) f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs@@3 0) f_7))) (=> (= (ControlFlow 0 16) 15) anon11_correct))))))
(let ((anon17_Then_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (< 0 (|Seq#Length| xs@@3))) (=> (< 0 (|Seq#Length| xs@@3)) (and (=> (= (ControlFlow 0 19) 16) anon18_Then_correct) (=> (= (ControlFlow 0 19) 18) anon18_Else_correct))))))
(let ((anon17_Else_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (= (get02 Heap@@21 xs@@3 0) 5))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 24)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@3 i_1) (|Seq#Index| xs@@3 i_1_1))))
 :qid |stdinbpl.974:15|
 :skolemid |71|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i_1@@0))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@3 i_1@@0) (|Seq#Index| xs@@3 i_1_1@@0))))
 :qid |stdinbpl.974:15|
 :skolemid |71|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index| xs@@3 i_1@@1)) (= (invRecv1 (|Seq#Index| xs@@3 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.980:22|
 :skolemid |72|
 :pattern ( (|Seq#Index| xs@@3 i_1@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i_1@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i_1@@1)))
 :pattern ( (|Seq#Index| xs@@3 i_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (|Seq#Index| xs@@3 (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.984:22|
 :skolemid |73|
 :pattern ( (invRecv1 o_3))
)) (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i_1@@2)) (not (= (|Seq#Index| xs@@3 i_1@@2) null)))
 :qid |stdinbpl.990:22|
 :skolemid |74|
 :pattern ( (|Seq#Index| xs@@3 i_1@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i_1@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i_1@@2)))
 :pattern ( (|Seq#Index| xs@@3 i_1@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| xs@@3 (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.996:22|
 :skolemid |75|
...
))) (and (state Heap@@21 QPMask@0) (state Heap@@21 QPMask@0))) (and (=> (= (ControlFlow 0 21) (- 0 23)) (< 0 (|Seq#Length| xs@@3))) (=> (< 0 (|Seq#Length| xs@@3)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (HasDirectPerm QPMask@0 (|Seq#Index| xs@@3 0) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs@@3 0) f_7) (=> (and (= (U_2_int (MapType0Select Heap@@21 (|Seq#Index| xs@@3 0) f_7)) 5) (state Heap@@21 QPMask@0)) (and (=> (= (ControlFlow 0 21) 19) anon17_Then_correct) (=> (= (ControlFlow 0 21) 14) anon17_Else_correct))))))))))))))
(let ((anon7_correct true))
(let ((anon16_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i_2))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon16_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i_2)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_2 (|Seq#Length| xs@@3))) (=> (< i_2 (|Seq#Length| xs@@3)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon13_Else_correct  (=> (and (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i1_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i2_1)) (not (= i1_1 i2_1)))) (not (= (|Seq#Index| xs@@3 i1_1) (|Seq#Index| xs@@3 i2_1))))
 :qid |stdinbpl.956:20|
 :skolemid |70|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i1_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i2_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i1_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i2_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i1_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i2_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i1_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i2_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i1_1)) (|Seq#Index| xs@@3 i2_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i1_1)) (|Seq#Index| xs@@3 i2_1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i2_1)) (|Seq#Index| xs@@3 i1_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i2_1)) (|Seq#Index| xs@@3 i1_1))
 :pattern ( (|Seq#Index| xs@@3 i1_1) (|Seq#Index| xs@@3 i2_1))
)) (state Heap@@21 ZeroMask)) (and (and (=> (= (ControlFlow 0 25) 21) anon15_Else_correct) (=> (= (ControlFlow 0 25) 9) anon16_Then_correct)) (=> (= (ControlFlow 0 25) 12) anon16_Else_correct)))))
(let ((anon3_correct true))
(let ((anon14_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i2)) (not (= i1 i2))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon14_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@3)) (int_2_U i2)) (not (= i1 i2)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1 0)) (=> (>= i1 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1 (|Seq#Length| xs@@3))) (=> (< i1 (|Seq#Length| xs@@3)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2 0)) (=> (>= i2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2 (|Seq#Length| xs@@3))) (=> (< i2 (|Seq#Length| xs@@3)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@21 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (< 0 (|Seq#Length| xs@@3)) (state Heap@@21 ZeroMask))) (and (and (=> (= (ControlFlow 0 26) 25) anon13_Else_correct) (=> (= (ControlFlow 0 26) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 26) 7) anon14_Else_correct)))))
