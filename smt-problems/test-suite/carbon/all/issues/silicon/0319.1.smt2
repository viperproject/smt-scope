...
(declare-fun globalRd (T@U) Real)
(declare-fun |globalRd'| (T@U) Real)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |globalRd#triggerStateless| () Real)
(declare-fun NoPerm () Real)
(declare-fun AssumeFunctionsAbove () Int)
(declare-fun |globalRd#trigger| (T@U) Bool)
(declare-fun FullPerm () Real)
(declare-fun |globalRd#frame| (T@U) Real)
...
(assert (forall ((Heap@@5 T@U) ) (!  (=> (= (type Heap@@5) (MapType0Type RefType)) (and (= (globalRd Heap@@5) (|globalRd'| Heap@@5)) (dummyFunction (real_2_U |globalRd#triggerStateless|))))
 :qid |stdinbpl.185:15|
 :skolemid |22|
 :pattern ( (globalRd Heap@@5))
)))
...
(assert (forall ((Heap@@6 T@U) (Mask@@6 T@U) ) (!  (=> (and (and (= (type Heap@@6) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (and (state Heap@@6 Mask@@6) (or (< AssumeFunctionsAbove 0) (|globalRd#trigger| EmptyFrame)))) (and (< NoPerm (|globalRd'| Heap@@6)) (< (|globalRd'| Heap@@6) FullPerm)))
 :qid |stdinbpl.202:15|
 :skolemid |25|
 :pattern ( (state Heap@@6 Mask@@6) (|globalRd'| Heap@@6))
)))
...
(assert (forall ((Heap@@9 T@U) ) (!  (=> (= (type Heap@@9) (MapType0Type RefType)) (dummyFunction (real_2_U |globalRd#triggerStateless|)))
 :qid |stdinbpl.189:15|
 :skolemid |23|
 :pattern ( (|globalRd'| Heap@@9))
)))
...
(assert (forall ((Heap@@11 T@U) (Mask@@10 T@U) ) (!  (=> (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (state Heap@@11 Mask@@10)) (= (|globalRd'| Heap@@11) (|globalRd#frame| EmptyFrame)))
 :qid |stdinbpl.196:15|
 :skolemid |24|
 :pattern ( (state Heap@@11 Mask@@10) (|globalRd'| Heap@@11))
)))
...
(declare-fun x@@8 () T@U)
(assert  (and (= (type Heap@@13) (MapType0Type RefType)) (= (type x@@8) RefType)))
(set-info :boogie-vc-id client)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (< (* (to_real (ite (< (- 0 n) 0) n (- 0 n))) (globalRd Heap@@13)) FullPerm))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (< (* (to_real (ite (< (- 0 n) 0) n (- 0 n))) (globalRd Heap@@13)) FullPerm) (=> (and (state Heap@@13 ZeroMask) (state Heap@@13 ZeroMask)) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@13 x@@8 $allocated))) (=> (and (and (> n 0) (state Heap@@13 ZeroMask)) (and (state Heap@@13 ZeroMask) (state Heap@@13 ZeroMask))) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct)))))))
