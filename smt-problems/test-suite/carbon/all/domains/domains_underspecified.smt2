...
(declare-fun f2 (T@U) T@U)
(declare-fun f5 (T@T T@U) T@U)
(declare-fun f6 (T@T T@T) T@U)
(declare-fun DDomainTypeType (T@T T@T) T@T)
(declare-fun DDomainTypeTypeInv0 (T@T) T@T)
(declare-fun DDomainTypeTypeInv1 (T@T) T@T)
(declare-fun FullPerm () Real)
(declare-fun ZeroPMask () T@U)
(declare-fun f3 (T@U) T@U)
(declare-fun f4 (T@T T@U) T@U)
...
(assert  (and (and (and (and (and (forall ((arg0@@26 T@T) (arg1@@10 T@T) ) (! (= (Ctor (DDomainTypeType arg0@@26 arg1@@10)) 12)
 :qid |ctor:DDomainTypeType|
)) (forall ((arg0@@27 T@T) (arg1@@11 T@T) ) (! (= (DDomainTypeTypeInv0 (DDomainTypeType arg0@@27 arg1@@11)) arg0@@27)
 :qid |typeInv:DDomainTypeTypeInv0|
 :pattern ( (DDomainTypeType arg0@@27 arg1@@11))
))) (forall ((arg0@@28 T@T) (arg1@@12 T@T) ) (! (= (DDomainTypeTypeInv1 (DDomainTypeType arg0@@28 arg1@@12)) arg1@@12)
 :qid |typeInv:DDomainTypeTypeInv1|
 :pattern ( (DDomainTypeType arg0@@28 arg1@@12))
))) (forall ((arg0@@29 T@U) ) (! (let ((S (DDomainTypeTypeInv1 (type arg0@@29))))
(= (type (f2 arg0@@29)) (DDomainTypeType S S)))
 :qid |funType:f2|
 :pattern ( (f2 arg0@@29))
))) (forall ((T T@T) (arg0@@30 T@U) ) (! (let ((S@@0 (type arg0@@30)))
(= (type (f5 T arg0@@30)) (DDomainTypeType T S@@0)))
 :qid |funType:f5|
 :pattern ( (f5 T arg0@@30))
))) (forall ((T@@0 T@T) (S@@1 T@T) ) (! (= (type (f6 T@@0 S@@1)) (DDomainTypeType T@@0 S@@1))
 :qid |funType:f6|
 :pattern ( (f6 T@@0 S@@1))
))))
(assert (forall ((x@@8 T@U) (T@@1 T@T) ) (! (let ((S@@2 (type x@@8)))
(= (f2 (f5 T@@1 x@@8)) (f6 S@@2 S@@2)))
 :qid |stdinbpl.207:22|
 :skolemid |23|
 :pattern ( (f2 (f5 T@@1 x@@8)))
)))
...
(assert  (and (forall ((arg0@@31 T@U) ) (! (let ((T@@2 (DDomainTypeTypeInv0 (type arg0@@31))))
(= (type (f3 arg0@@31)) T@@2))
 :qid |funType:f3|
 :pattern ( (f3 arg0@@31))
)) (forall ((S@@3 T@T) (arg0@@32 T@U) ) (! (let ((T@@3 (type arg0@@32)))
(= (type (f4 S@@3 arg0@@32)) (DDomainTypeType T@@3 S@@3)))
 :qid |funType:f4|
 :pattern ( (f4 S@@3 arg0@@32))
))))
(assert (forall ((x@@9 T@U) (S@@4 T@T) ) (! (= (f3 (f4 S@@4 x@@9)) x@@9)
 :qid |stdinbpl.201:22|
 :skolemid |22|
 :pattern ( (f3 (f4 S@@4 x@@9)))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
