...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (Ctor RefType) 8)) (= (type f_7) (FieldType NormalFieldType RefType))) (= (type g) (FieldType NormalFieldType boolType))) (= (type Testtk) (FieldType NormalFieldType RefType))) (= (type joinable) (FieldType NormalFieldType boolType))))
(assert (distinct $allocated f_7 g Testtk joinable)
)
...
(assert  (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type x@@8) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test05)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated)) (not (= x@@8 null))) (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm)))) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (HasDirectPerm Mask@0 x@@8 f_7)) (=> (HasDirectPerm Mask@0 x@@8 f_7) (=> (not (= (MapType0Select Heap@@9 x@@8 f_7) null)) (=> (and (= Mask@1 (MapType1Store Mask@0 (MapType0Select Heap@@9 x@@8 f_7) g (real_2_U (+ (U_2_real (MapType1Select Mask@0 (MapType0Select Heap@@9 x@@8 f_7) g)) FullPerm)))) (state Heap@@9 Mask@1)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (HasDirectPerm Mask@1 x@@8 f_7)) (=> (HasDirectPerm Mask@1 x@@8 f_7) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm Mask@1 (MapType0Select Heap@@9 x@@8 f_7) g)) (=> (HasDirectPerm Mask@1 (MapType0Select Heap@@9 x@@8 f_7) g) (=> (and (U_2_bool (MapType0Select Heap@@9 (MapType0Select Heap@@9 x@@8 f_7) g)) (state Heap@@9 Mask@1)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@1 x@@8 f_7)) (=> (HasDirectPerm Mask@1 x@@8 f_7) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (= (MapType0Select Heap@@9 x@@8 f_7) null))) (=> (not (= (MapType0Select Heap@@9 x@@8 f_7) null)) (=> (and (state Heap@@9 Mask@1) (= (ControlFlow 0 2) (- 0 1))) false))))))))))))))))))
