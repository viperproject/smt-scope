...
(assert (forall ((Heap@@2 T@U) (i Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (int_2_U (|f#triggerStateless| i))))
 :qid |stdinbpl.197:15|
 :skolemid |23|
 :pattern ( (|f'| Heap@@2 i))
)))
...
(assert (forall ((Heap@@4 T@U) (i@@0 Int) ) (!  (=> (= (type Heap@@4) (MapType0Type RefType)) (and (= (f_6 Heap@@4 i@@0) (|f'| Heap@@4 i@@0)) (dummyFunction (int_2_U (|f#triggerStateless| i@@0)))))
 :qid |stdinbpl.193:15|
 :skolemid |22|
 :pattern ( (f_6 Heap@@4 i@@0))
)))
...
(assert (forall ((Heap@@9 T@U) (Mask@@9 T@U) (i@@1 Int) ) (!  (=> (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (state Heap@@9 Mask@@9)) (= (|f'| Heap@@9 i@@1) (|f#frame| EmptyFrame i@@1)))
 :qid |stdinbpl.210:15|
 :skolemid |25|
 :pattern ( (state Heap@@9 Mask@@9) (|f'| Heap@@9 i@@1))
)))
...
(assert (forall ((Heap@@12 T@U) (Mask@@10 T@U) (i@@2 Int) ) (!  (=> (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (and (state Heap@@12 Mask@@10) (< AssumeFunctionsAbove 0))) (= (f_6 Heap@@12 i@@2) i@@2))
 :qid |stdinbpl.203:15|
 :skolemid |24|
 :pattern ( (state Heap@@12 Mask@@10) (f_6 Heap@@12 i@@2))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
...
(assert  (and (and (and (and (= (type PostMask@0) (MapType1Type RefType realType)) (= (type x@@8) RefType)) (= (type PostHeap@0) (MapType0Type RefType))) (= (type Heap@@13) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id unlink_DAG_next)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon10_Else_correct true))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (HasDirectPerm PostMask@0 x@@8 next))))
(let ((anon9_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (not (= x@@8 null)) (= PostMask@0 (MapType1Store ZeroMask x@@8 next (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 next)) FullPerm))))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 5) 3) anon10_Then_correct) (=> (= (ControlFlow 0 5) 4) anon10_Else_correct))))))
(let ((anon9_Else_correct true))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@13 x@@8 $allocated))) (=> (and (and (not (= x@@8 null)) (= Mask@0 (MapType1Store ZeroMask x@@8 next (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 next)) FullPerm))))) (and (state Heap@@13 Mask@0) (state Heap@@13 Mask@0))) (and (=> (= (ControlFlow 0 6) 5) anon9_Then_correct) (=> (= (ControlFlow 0 6) 1) anon9_Else_correct)))))))
