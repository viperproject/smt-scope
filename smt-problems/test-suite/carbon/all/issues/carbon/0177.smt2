...
(assert (forall ((r_2 T@U) ) (!  (=> (= (type r_2) RefType) (IsPredicateField (p_1 r_2)))
 :qid |stdinbpl.201:15|
 :skolemid |23|
 :pattern ( (p_1 r_2))
)))
(assert (forall ((Heap@@2 T@U) (r_2@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type r_2@@0) RefType)) (|p#everUsed| (p_1 r_2@@0)))
 :qid |stdinbpl.220:15|
 :skolemid |27|
 :pattern ( (|p#trigger| Heap@@2 (p_1 r_2@@0)))
)))
...
(assert (forall ((r_2@@1 T@U) (r2 T@U) ) (!  (=> (and (and (= (type r_2@@1) RefType) (= (type r2) RefType)) (= (p_1 r_2@@1) (p_1 r2))) (= r_2@@1 r2))
 :qid |stdinbpl.211:15|
 :skolemid |25|
 :pattern ( (p_1 r_2@@1) (p_1 r2))
)))
...
(assert (forall ((r_2@@2 T@U) (r2@@0 T@U) ) (!  (=> (and (and (= (type r_2@@2) RefType) (= (type r2@@0) RefType)) (= (|p#sm| r_2@@2) (|p#sm| r2@@0))) (= r_2@@2 r2@@0))
 :qid |stdinbpl.215:15|
 :skolemid |26|
 :pattern ( (|p#sm| r_2@@2) (|p#sm| r2@@0))
)))
...
(assert (forall ((r_2@@3 T@U) ) (!  (=> (= (type r_2@@3) RefType) (= (getPredWandId (p_1 r_2@@3)) 0))
 :qid |stdinbpl.205:15|
 :skolemid |24|
 :pattern ( (p_1 r_2@@3))
)))
...
(assert (forall ((r_2@@4 T@U) ) (!  (=> (= (type r_2@@4) RefType) (= (PredicateMaskField (p_1 r_2@@4)) (|p#sm| r_2@@4)))
 :qid |stdinbpl.197:15|
 :skolemid |22|
 :pattern ( (PredicateMaskField (p_1 r_2@@4)))
)))
...
(assert  (and (forall ((arg0@@28 T@U) ) (! (= (type (invRecv1 arg0@@28)) RefType)
 :qid |funType:invRecv1|
 :pattern ( (invRecv1 arg0@@28))
)) (= (type Heap@@10) (MapType0Type RefType))))
(set-info :boogie-vc-id m)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((r_2_1 T@U) ) (!  (=> (= (type r_2_1) RefType) (=> (and (not (= (invRecv1 r_2_1) null)) (qpRange1 r_2_1)) (>= (U_2_real (MapType1Select ZeroMask null (p_1 (invRecv1 r_2_1)))) NoPerm)))
 :qid |stdinbpl.261:17|
 :skolemid |28|
 :pattern ( (invRecv1 r_2_1))
))) (=> (forall ((r_2_1@@0 T@U) ) (!  (=> (= (type r_2_1@@0) RefType) (=> (and (not (= (invRecv1 r_2_1@@0) null)) (qpRange1 r_2_1@@0)) (>= (U_2_real (MapType1Select ZeroMask null (p_1 (invRecv1 r_2_1@@0)))) NoPerm)))
 :qid |stdinbpl.261:17|
 :skolemid |28|
 :pattern ( (invRecv1 r_2_1@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (not (= r_1 null))) (not (= r_1_1 null))) (< NoPerm (U_2_real (MapType1Select ZeroMask null (p_1 r_1))))) (< NoPerm (U_2_real (MapType1Select ZeroMask null (p_1 r_1_1))))) (not (= r_1 r_1_1))))
 :qid |stdinbpl.268:17|
 :skolemid |29|
 :pattern ( (neverTriggered1 r_1) (neverTriggered1 r_1_1))
))) (=> (forall ((r_1@@0 T@U) (r_1_1@@0 T@U) ) (!  (=> (and (= (type r_1@@0) RefType) (= (type r_1_1@@0) RefType)) (=> (and (and (and (and (not (= r_1@@0 r_1_1@@0)) (not (= r_1@@0 null))) (not (= r_1_1@@0 null))) (< NoPerm (U_2_real (MapType1Select ZeroMask null (p_1 r_1@@0))))) (< NoPerm (U_2_real (MapType1Select ZeroMask null (p_1 r_1_1@@0))))) (not (= r_1@@0 r_1_1@@0))))
 :qid |stdinbpl.268:17|
 :skolemid |29|
 :pattern ( (neverTriggered1 r_1@@0) (neverTriggered1 r_1_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((r_1@@1 T@U) ) (!  (=> (and (= (type r_1@@1) RefType) (not (= r_1@@1 null))) (>= (U_2_real (MapType1Select ZeroMask null (p_1 r_1@@1))) (U_2_real (MapType1Select ZeroMask null (p_1 r_1@@1)))))
 :qid |stdinbpl.275:17|
 :skolemid |30|
 :pattern ( (MapType0Select Heap@@10 null (p_1 r_1@@1)))
 :pattern ( (MapType1Select ZeroMask null (p_1 r_1@@1)))
)))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (and (=> (= (ControlFlow 0 6) 1) anon3_Then_correct) (=> (= (ControlFlow 0 6) 3) anon3_Else_correct)))))
