...
(assert (forall ((Heap@@2 T@U) (i Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (int_2_U (|id#triggerStateless| i))))
 :qid |stdinbpl.189:15|
 :skolemid |23|
 :pattern ( (|id'| Heap@@2 i))
)))
...
(assert (forall ((Heap@@4 T@U) (i@@0 Int) ) (!  (=> (= (type Heap@@4) (MapType0Type RefType)) (and (= (id Heap@@4 i@@0) (|id'| Heap@@4 i@@0)) (dummyFunction (int_2_U (|id#triggerStateless| i@@0)))))
 :qid |stdinbpl.185:15|
 :skolemid |22|
 :pattern ( (id Heap@@4 i@@0))
)))
...
(assert (forall ((Heap@@9 T@U) (Mask@@9 T@U) (i@@1 Int) ) (!  (=> (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (state Heap@@9 Mask@@9)) (= (|id'| Heap@@9 i@@1) (|id#frame| EmptyFrame i@@1)))
 :qid |stdinbpl.202:15|
 :skolemid |25|
 :pattern ( (state Heap@@9 Mask@@9) (|id'| Heap@@9 i@@1))
)))
...
(assert (forall ((Heap@@12 T@U) (Mask@@10 T@U) (i@@2 Int) ) (!  (=> (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (and (state Heap@@12 Mask@@10) (< AssumeFunctionsAbove 0))) (= (id Heap@@12 i@@2) i@@2))
 :qid |stdinbpl.195:15|
 :skolemid |24|
 :pattern ( (state Heap@@12 Mask@@10) (id Heap@@12 i@@2))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
...
(declare-fun y_8 () Int)
(declare-fun y_6 () Int)
(assert  (and (= (type Heap@@13) (MapType0Type RefType)) (= (type PostHeap@0) (MapType0Type RefType))))
...
(let ((anon25_Else_correct  (=> (forall ((y_3 Int) ) (!  (and (= (id PostHeap@0 y_3) y_3) (= (id PostHeap@0 y_3) i@@3))
 :qid |stdinbpl.372:20|
 :skolemid |28|
 :pattern ( (|id#frame| EmptyFrame y_3))
...
(let ((anon27_Then_correct  (=> (= (id PostHeap@0 y@@1) y@@1) (and (=> (= (ControlFlow 0 15) 14) anon28_Then_correct) (=> (= (ControlFlow 0 15) 12) anon11_correct)))))
(let ((anon27_Else_correct  (=> (and (not (= (id PostHeap@0 y@@1) y@@1)) (= (ControlFlow 0 13) 12)) anon11_correct)))
...
(let ((anon32_Then_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (= (id Heap@@13 y_8) y_8)) (=> (= (id Heap@@13 y_8) y_8) (=> (= (ControlFlow 0 7) (- 0 6)) (= y_8 i@@3))))))
(let ((anon31_Else_correct  (=> (forall ((y_7_1 Int) ) (!  (and (= (id Heap@@13 y_7_1) y_7_1) (= (id Heap@@13 y_7_1) i@@3))
 :qid |stdinbpl.406:20|
 :skolemid |30|
 :pattern ( (|id#frame| EmptyFrame y_7_1))
)) (and (=> (= (ControlFlow 0 10) 7) anon32_Then_correct) (=> (= (ControlFlow 0 10) 9) anon32_Else_correct)))))
(let ((anon31_Then_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (= (id Heap@@13 y_6) y_6)) (=> (= (id Heap@@13 y_6) y_6) (=> (= (ControlFlow 0 4) (- 0 3)) (= (id Heap@@13 y_6) i@@3))))))
(let ((anon22_Else_correct  (=> (and (forall ((y_1 Int) ) (! (= (id Heap@@13 y_1) i@@3)
 :qid |stdinbpl.340:20|
 :skolemid |27|
 :pattern ( (|id#frame| EmptyFrame y_1))
)) (state Heap@@13 ZeroMask)) (and (and (=> (= (ControlFlow 0 21) 20) anon24_Then_correct) (=> (= (ControlFlow 0 21) 4) anon31_Then_correct)) (=> (= (ControlFlow 0 21) 10) anon31_Else_correct)))))
(let ((anon23_Else_correct true))
(let ((anon23_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (state Heap@@13 ZeroMask)) (and (and (=> (= (ControlFlow 0 22) 21) anon22_Else_correct) (=> (= (ControlFlow 0 22) 1) anon23_Then_correct)) (=> (= (ControlFlow 0 22) 2) anon23_Else_correct))))))
