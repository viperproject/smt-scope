...
(let ((anon12_Else_correct  (=> (and (not (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_4))) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_4)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm Mask@1 x_4 p_1)) (=> (HasDirectPerm Mask@1 x_4 p_1) (=> (= (ControlFlow 0 8) 7) anon7_correct))))))
...
)) (=> (and (and (forall ((x_1@@5 T@U) ) (!  (=> (= (type x_1@@5) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) x_1@@5)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange3 x_1@@5) (= (invRecv3 x_1@@5) x_1@@5))))
 :qid |stdinbpl.696:22|
 :skolemid |107|
...
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) (invRecv3 o_3))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange3 o_3))) (= (invRecv3 o_3) o_3)))
 :qid |stdinbpl.700:22|
 :skolemid |108|
 :pattern ( (invRecv3 o_3))
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) (invRecv3 o_3@@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange3 o_3@@0))) (and (= (invRecv3 o_3@@0) o_3@@0) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 p_1)) (- (U_2_real (MapType2Select Mask@2 o_3@@0 p_1)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@7 s) (invRecv3 o_3@@0))) (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange3 o_3@@0)))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 p_1)) (U_2_real (MapType2Select Mask@2 o_3@@0 p_1))))))
 :qid |stdinbpl.706:22|
 :skolemid |109|
...
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (and (U_2_bool (MapType1Select Heap@@10 this@@7 $allocated)) (not (= this@@7 null))) (and (= Mask@0 (MapType2Store ZeroMask this@@7 p_1 (real_2_U (+ (U_2_real (MapType2Select ZeroMask this@@7 p_1)) FullPerm)))) (state Heap@@10 Mask@0))) (and (and (not (= this@@7 null)) (= Mask@1 (MapType2Store Mask@0 this@@7 s (real_2_U (+ (U_2_real (MapType2Select Mask@0 this@@7 s)) FullPerm))))) (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1)))) (and (=> (= (ControlFlow 0 21) (- 0 23)) (HasDirectPerm Mask@1 this@@7 s)) (=> (HasDirectPerm Mask@1 this@@7 s) (=> (and (|Set#Equal| (MapType1Select Heap@@10 this@@7 s) (|Set#Singleton| this@@7)) (state Heap@@10 Mask@1)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (HasDirectPerm Mask@1 this@@7 p_1)) (=> (HasDirectPerm Mask@1 this@@7 p_1) (=> (and (= (MapType1Select Heap@@10 this@@7 p_1) null) (state Heap@@10 Mask@1)) (and (=> (= (ControlFlow 0 21) 18) anon9_Then_correct) (=> (= (ControlFlow 0 21) 20) anon9_Else_correct))))))))))))
