...
(assert  (and (= (type x@@18) RefType) (= (type Heap@@18) (MapType0Type RefType))))
(set-info :boogie-vc-id |gg#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((z_3 T@U) (z_3_1 T@U) ) (!  (=> (and (= (type z_3) RefType) (= (type z_3_1) RefType)) (=> (and (and (and (and (not (= z_3 z_3_1)) (= z_3 x@@18)) (= z_3_1 x@@18)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_3 z_3_1))))
 :qid |stdinbpl.358:15|
 :skolemid |32|
 :no-pattern (type z_3)
...
(let ((anon0_correct  (=> (state Heap@@18 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@18 x@@18 $allocated)) (= AssumeFunctionsAbove 2)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
