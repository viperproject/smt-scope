...
(declare-fun S2 () T@U)
(assert  (and (and (and (and (and (and (= (type S1) (SeqType RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type x@@22) RefType)) (= (type S2) (MapType2Type RefType boolType))))
(set-info :boogie-vc-id m02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon12_Else_correct  (=> (= (ControlFlow 0 11) (- 0 10)) (forall ((y_1 T@U) (y_1_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (= (type y_1_1) RefType)) (=> (and (and (and (and (not (= y_1 y_1_1)) (|Seq#Contains| S1 y_1)) (|Seq#Contains| S1 y_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_1 y_1_1))))
...
(let ((anon11_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 12) 9) anon12_Then_correct) (=> (= (ControlFlow 0 12) 11) anon12_Else_correct)))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((y_2 T@U) (y_2_1 T@U) ) (!  (=> (and (= (type y_2) RefType) (= (type y_2_1) RefType)) (=> (and (and (and (and (not (= y_2 y_2_1)) (|Seq#Contains| S1 y_2)) (|Seq#Contains| S1 y_2_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_2 y_2_1))))
 :qid |stdinbpl.1099:17|
 :skolemid |148|
 :pattern ( (neverTriggered6 y_2) (neverTriggered6 y_2_1))
))) (=> (forall ((y_2@@0 T@U) (y_2_1@@0 T@U) ) (!  (=> (and (= (type y_2@@0) RefType) (= (type y_2_1@@0) RefType)) (=> (and (and (and (and (not (= y_2@@0 y_2_1@@0)) (|Seq#Contains| S1 y_2@@0)) (|Seq#Contains| S1 y_2_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_2@@0 y_2_1@@0))))
 :qid |stdinbpl.1099:17|
 :skolemid |148|
 :pattern ( (neverTriggered6 y_2@@0) (neverTriggered6 y_2_1@@0))
)) (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((y_2@@1 T@U) ) (!  (=> (and (= (type y_2@@1) RefType) (|Seq#Contains| S1 y_2@@1)) (>= (U_2_real (MapType1Select QPMask@0 y_2@@1 f_7)) FullPerm))
 :qid |stdinbpl.1106:17|
 :skolemid |149|
 :pattern ( (MapType0Select Heap@@9 y_2@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 y_2@@1 f_7))
 :pattern ( (|Seq#ContainsTrigger| S1 y_2@@1))
 :pattern ( (|Seq#Contains| S1 y_2@@1))
)))))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U i_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| S1 i_1) (|Seq#Index| S1 i_1_1))))
 :qid |stdinbpl.1001:15|
 :skolemid |136|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U i_1@@0))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U i_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| S1 i_1@@0) (|Seq#Index| S1 i_1_1@@0))))
 :qid |stdinbpl.1001:15|
 :skolemid |136|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U i_1@@1)) (< NoPerm FullPerm)) (and (qpRange4 (|Seq#Index| S1 i_1@@1)) (= (invRecv4 (|Seq#Index| S1 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.1007:22|
 :skolemid |137|
 :pattern ( (|Seq#Index| S1 i_1@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U i_1@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U i_1@@1)))
 :pattern ( (|Seq#Index| S1 i_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U (invRecv4 o_3))) (< NoPerm FullPerm)) (qpRange4 o_3)) (= (|Seq#Index| S1 (invRecv4 o_3)) o_3)))
 :qid |stdinbpl.1011:22|
 :skolemid |138|
 :pattern ( (invRecv4 o_3))
)) (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U i_1@@2)) (not (= (|Seq#Index| S1 i_1@@2) null)))
 :qid |stdinbpl.1017:22|
 :skolemid |139|
 :pattern ( (|Seq#Index| S1 i_1@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U i_1@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U i_1@@2)))
 :pattern ( (|Seq#Index| S1 i_1@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U (invRecv4 o_3@@0))) (< NoPerm FullPerm)) (qpRange4 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| S1 (invRecv4 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U (invRecv4 o_3@@0))) (< NoPerm FullPerm)) (qpRange4 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.1023:22|
 :skolemid |140|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 13) 12) anon11_Then_correct) (=> (= (ControlFlow 0 13) 7) anon11_Else_correct)))))))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U i_2))) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U i_2)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i_2 (|Seq#Length| S1))) (=> (< i_2 (|Seq#Length| S1)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 x@@22 $allocated)) (|Seq#Equal| S1 (|Seq#Singleton| x@@22))) (and (|Set#Equal| S2 (|Set#Singleton| x@@22)) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 15) 13) anon9_Else_correct) (=> (= (ControlFlow 0 15) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 15) 5) anon10_Else_correct))))))
