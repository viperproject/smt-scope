...
(assert  (and (and (and (and (and (= (type x@@8) RefType) (= (type y@@1) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type z@@0) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test03)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon3_correct true))
(let ((anon4_Else_correct  (=> (= x@@8 y@@1) (and (=> (= (ControlFlow 0 5) (- 0 7)) (<= px (/ (to_real 3) (to_real 10)))) (=> (<= px (/ (to_real 3) (to_real 10))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= py (/ (to_real 3) (to_real 10)))) (=> (<= py (/ (to_real 3) (to_real 10))) (=> (and (state Heap@@9 Mask@1) (= (ControlFlow 0 5) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (not (= x@@8 y@@1)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= px (/ (to_real 1) (to_real 5)))) (=> (<= px (/ (to_real 1) (to_real 5))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= py (/ (to_real 1) (to_real 10)))) (=> (<= py (/ (to_real 1) (to_real 10))) (=> (and (state Heap@@9 Mask@1) (= (ControlFlow 0 2) 1)) anon3_correct))))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@9 y@@1 $allocated)) (U_2_bool (MapType0Select Heap@@9 z@@0 $allocated))) (and (< NoPerm px) (state Heap@@9 ZeroMask))) (=> (and (and (and (state Heap@@9 ZeroMask) (< NoPerm py)) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (and (< NoPerm pz) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (= perm@0 (/ (to_real 1) (to_real 5)))))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= x@@8 null))) (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) perm@0))))) (and (state Heap@@9 Mask@0) (= perm@1 (/ (to_real 1) (to_real 10))))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (=> (> perm@1 NoPerm) (not (= y@@1 null))) (= Mask@1 (MapType1Store Mask@0 y@@1 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@1 f_7)) perm@1))))) (=> (and (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1)) (and (state Heap@@9 Mask@1) (<= px (U_2_real (MapType1Select Mask@1 x@@8 f_7))))) (=> (and (and (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1)) (and (<= (__iar__assume_helper_1 (= x@@8 y@@1) px py) (U_2_real (MapType1Select Mask@1 y@@1 f_7))) (state Heap@@9 Mask@1))) (and (and (state Heap@@9 Mask@1) (<= (__iar__assume_helper_2 (= x@@8 z@@0) (= y@@1 z@@0) px py pz) (U_2_real (MapType1Select Mask@1 z@@0 f_7)))) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1)))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (= z@@0 x@@8) (= z@@0 y@@1))) (=> (or (= z@@0 x@@8) (= z@@0 y@@1)) (=> (state Heap@@9 Mask@1) (and (=> (= (ControlFlow 0 8) 2) anon4_Then_correct) (=> (= (ControlFlow 0 8) 5) anon4_Else_correct))))))))))))))))))
