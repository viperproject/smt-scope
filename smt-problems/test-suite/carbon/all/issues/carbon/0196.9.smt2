...
(assert  (and (and (= (type Heap@@33) (MapType0Type RefType)) (= (type r_1@@52) RefType)) (forall ((arg0@@82 T@U) ) (! (= (type (invRecv2 arg0@@82)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@82))
))))
...
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((e_2 T@U) (e_2_1 T@U) ) (!  (=> (and (= (type e_2) RefType) (= (type e_2_1) RefType)) (=> (and (and (and (and (not (= e_2 e_2_1)) (U_2_bool (MapType2Select (refs Heap@@33 r_1@@52) e_2))) (U_2_bool (MapType2Select (refs Heap@@33 r_1@@52) e_2_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= e_2 e_2_1))))
 :qid |stdinbpl.956:17|
 :skolemid |121|
 :pattern ( (neverTriggered2 e_2) (neverTriggered2 e_2_1))
 ...
 :qid |stdinbpl.956:17|
 :skolemid |121|
 :pattern ( (neverTriggered2 e_2@@0) (neverTriggered2 e_2_1@@0))
)) (=> (forall ((e_2@@1 T@U) ) (!  (=> (= (type e_2@@1) RefType) (=> (and (U_2_bool (MapType2Select (refs Heap@@33 r_1@@52) e_2@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (= (invRecv2 e_2@@1) e_2@@1) (qpRange2 e_2@@1))))
 :qid |stdinbpl.962:22|
 :skolemid |122|
 :pattern ( (MapType0Select Heap@@33 null (Q e_2@@1)))
 :pattern ( (MapType1Select ZeroMask null (Q e_2@@1)))
 :pattern ( (MapType2Select (|refs#frame| EmptyFrame r_1@@52) e_2@@1))
)) (=> (and (forall ((r_2_1 T@U) ) (!  (=> (= (type r_2_1) RefType) (=> (and (and (U_2_bool (MapType2Select (refs Heap@@33 r_1@@52) (invRecv2 r_2_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 r_2_1)) (= (invRecv2 r_2_1) r_2_1)))
 :qid |stdinbpl.966:22|
 :skolemid |123|
 ...
 :qid |stdinbpl.972:15|
 :skolemid |124|
 :pattern ( (MapType0Select Heap@@33 null (Q e_2@@2)))
 :pattern ( (MapType1Select ZeroMask null (Q e_2@@2)))
