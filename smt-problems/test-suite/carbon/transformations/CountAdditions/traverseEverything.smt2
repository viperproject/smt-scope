...
(assert  (and (= (Ctor PredicateType_predType) 11) (= (type pred) (FieldType PredicateType_predType FrameTypeType))))
(assert (IsPredicateField pred))
(assert (= (getPredWandId pred) 0))
...
(assert (forall ((Heap@@3 T@U) (Mask@@3 T@U) ) (!  (=> (and (and (= (type Heap@@3) (MapType0Type RefType)) (= (type Mask@@3) (MapType1Type RefType realType))) (and (state Heap@@3 Mask@@3) (< AssumeFunctionsAbove 0))) (fun Heap@@3))
 :qid |stdinbpl.205:15|
 :skolemid |24|
 :pattern ( (state Heap@@3 Mask@@3) (fun Heap@@3))
)))
(assert (forall ((Heap@@4 T@U) (ExhaleHeap@@2 T@U) (Mask@@4 T@U) (o_1@@0 T@U) (f_2 T@U) ) (! (let ((B@@1 (FieldTypeInv1 (type f_2))))
(let ((A@@1 (FieldTypeInv0 (type f_2))))
 (=> (and (and (and (and (and (and (= (type Heap@@4) (MapType0Type RefType)) (= (type ExhaleHeap@@2) (MapType0Type RefType))) (= (type Mask@@4) (MapType1Type RefType realType))) (= (type o_1@@0) RefType)) (= (type f_2) (FieldType A@@1 B@@1))) (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@2 Mask@@4)) (HasDirectPerm Mask@@4 o_1@@0 f_2)) (= (MapType0Select Heap@@4 o_1@@0 f_2) (MapType0Select ExhaleHeap@@2 o_1@@0 f_2)))))
 :qid |stdinbpl.42:22|
 :skolemid |1|
 :pattern ( (IdenticalOnKnownLocations Heap@@4 ExhaleHeap@@2 Mask@@4) (MapType0Select ExhaleHeap@@2 o_1@@0 f_2))
)))
...
(assert (forall ((Heap@@6 T@U) (Mask@@7 T@U) ) (!  (=> (and (and (= (type Heap@@6) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (state Heap@@6 Mask@@7)) (= (|fun'| Heap@@6) (|fun#frame| EmptyFrame)))
 :qid |stdinbpl.212:15|
 :skolemid |25|
 :pattern ( (state Heap@@6 Mask@@7) (|fun'| Heap@@6))
)))
(assert (forall ((Heap@@7 T@U) (ExhaleHeap@@4 T@U) (Mask@@8 T@U) (pm_f@@1 T@U) ) (! (let ((C@@1 (FieldTypeInv0 (type pm_f@@1))))
 (=> (and (and (and (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type ExhaleHeap@@4) (MapType0Type RefType))) (= (type Mask@@8) (MapType1Type RefType realType))) (= (type pm_f@@1) (FieldType C@@1 FrameTypeType))) (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@4 Mask@@8)) (and (HasDirectPerm Mask@@8 null pm_f@@1) (IsPredicateField pm_f@@1))) (forall ((o2 T@U) (f_2@@0 T@U) ) (! (let ((B@@5 (FieldTypeInv1 (type f_2@@0))))
(let ((A@@6 (FieldTypeInv0 (type f_2@@0))))
 ...
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@7 ExhaleHeap@@4 Mask@@8) (IsPredicateField pm_f@@1))
)))
(assert (forall ((Heap@@8 T@U) (ExhaleHeap@@5 T@U) (Mask@@9 T@U) (pm_f@@2 T@U) ) (! (let ((C@@2 (FieldTypeInv0 (type pm_f@@2))))
 (=> (and (and (and (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type ExhaleHeap@@5) (MapType0Type RefType))) (= (type Mask@@9) (MapType1Type RefType realType))) (= (type pm_f@@2) (FieldType C@@2 FrameTypeType))) (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@5 Mask@@9)) (and (HasDirectPerm Mask@@9 null pm_f@@2) (IsWandField pm_f@@2))) (forall ((o2@@0 T@U) (f_2@@1 T@U) ) (! (let ((B@@6 (FieldTypeInv1 (type f_2@@1))))
(let ((A@@7 (FieldTypeInv0 (type f_2@@1))))
 ...
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@5 Mask@@9) (IsWandField pm_f@@2))
)))
...
(assert (forall ((Heap@@9 T@U) ) (!  (=> (= (type Heap@@9) (MapType0Type RefType)) (dummyFunction (bool_2_U |fun#triggerStateless|)))
 :qid |stdinbpl.199:15|
 :skolemid |23|
 :pattern ( (|fun'| Heap@@9))
)))
(assert (forall ((Heap@@10 T@U) ) (!  (=> (= (type Heap@@10) (MapType0Type RefType)) (|pred#everUsed| pred))
 :qid |stdinbpl.262:15|
 :skolemid |26|
 :pattern ( (|pred#trigger| Heap@@10 pred))
)))
...
(assert (= (type |pred#sm|) (FieldType PredicateType_predType (MapType1Type RefType boolType))))
(assert (= (PredicateMaskField pred) |pred#sm|))
...
(assert (forall ((Heap@@13 T@U) ) (!  (=> (= (type Heap@@13) (MapType0Type RefType)) (and (= (fun Heap@@13) (|fun'| Heap@@13)) (dummyFunction (bool_2_U |fun#triggerStateless|))))
 :qid |stdinbpl.195:15|
 :skolemid |22|
 :pattern ( (fun Heap@@13))
)))
...
(let ((anon9_Then_correct  (=> (and (state Heap@@14 ZeroMask) (= b_2@0 6)) (=> (and (and (state Heap@@14 ZeroMask) (state Heap@@14 ZeroMask)) (and (state Heap@@14 ZeroMask) (= (ControlFlow 0 4) (- 0 3)))) (= 6 6)))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (=> (state Heap@@14 ZeroMask) (and (=> (= (ControlFlow 0 6) (- 0 8)) (= (+ 6 4) 10)) (=> (= (+ 6 4) 10) (=> (state Heap@@14 ZeroMask) (and (=> (= (ControlFlow 0 6) (- 0 7)) (= 6 6)) (=> (= 6 6) (and (and (=> (= (ControlFlow 0 6) 2) anon8_Then_correct) (=> (= (ControlFlow 0 6) 4) anon9_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct))))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (state Heap@@14 ZeroMask)) (and (=> (= (ControlFlow 0 9) 1) anon7_Then_correct) (=> (= (ControlFlow 0 9) 6) anon7_Else_correct))))))
