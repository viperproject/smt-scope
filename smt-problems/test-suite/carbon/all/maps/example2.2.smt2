...
(declare-fun k_3 () Int)
(declare-fun k_1 () Int)
(assert  (and (and (and (= (type m@0) (MapType intType intType)) (= (type m@1) (MapType intType intType))) (= (type Heap@@9) (MapType1Type RefType))) (= (type m@2) (MapType intType intType))))
(set-info :boogie-vc-id test9)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 44) (let ((anon16_correct true))
(let ((anon39_Else_correct  (=> (and (not (U_2_bool (MapType0Select (|Map#Domain| m@1) (int_2_U k)))) (= (ControlFlow 0 34) 31)) anon16_correct)))
(let ((anon39_Then_correct  (=> (U_2_bool (MapType0Select (|Map#Domain| m@1) (int_2_U k))) (and (=> (= (ControlFlow 0 32) (- 0 33)) (U_2_bool (MapType0Select (|Map#Domain| m@1) (int_2_U k)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@1) (int_2_U k))) (=> (= (ControlFlow 0 32) 31) anon16_correct))))))
(let ((anon38_Else_correct true))
(let ((anon37_Else_correct  (=> (and (forall ((k_8 T@U) ) (!  (=> (= (type k_8) intType) (=  (and (<= 0 (U_2_int k_8)) (< (U_2_int k_8) i_6@0)) (U_2_bool (MapType0Select (|Map#Domain| m@1) k_8))))
 :qid |stdinbpl.1059:24|
 :skolemid |111|
 :pattern ( (MapType0Select (|Map#Domain| m@1) k_8))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 35) 30) anon38_Else_correct) (=> (= (ControlFlow 0 35) 32) anon39_Then_correct)) (=> (= (ControlFlow 0 35) 34) anon39_Else_correct)))))
(let ((anon37_Then_correct true))
(let ((anon36_Then_correct  (=> (and (and (<= 0 i_6@0) (<= i_6@0 100)) (and (= 100 100) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 36) 29) anon37_Then_correct) (=> (= (ControlFlow 0 36) 35) anon37_Else_correct)))))
(let ((anon24_correct true))
(let ((anon43_Else_correct  (=> (and (not (U_2_bool (MapType0Select (|Map#Domain| m@2) (int_2_U k_15)))) (= (ControlFlow 0 23) 20)) anon24_correct)))
(let ((anon43_Then_correct  (=> (U_2_bool (MapType0Select (|Map#Domain| m@2) (int_2_U k_15))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (= (U_2_int (MapType0Select (|Map#Elements| m@2) (int_2_U k_15))) (* k_15 k_15))) (=> (= (U_2_int (MapType0Select (|Map#Elements| m@2) (int_2_U k_15))) (* k_15 k_15)) (=> (= (ControlFlow 0 21) 20) anon24_correct))))))
(let ((anon42_Else_correct true))
(let ((anon41_Else_correct  (=> (forall ((k_14_1 T@U) ) (!  (=> (= (type k_14_1) intType) (=  (and (<= 0 (U_2_int k_14_1)) (< (U_2_int k_14_1) i_6@1)) (U_2_bool (MapType0Select (|Map#Domain| m@2) k_14_1))))
 :qid |stdinbpl.1128:24|
 :skolemid |115|
 :pattern ( (MapType0Select (|Map#Domain| m@2) k_14_1))
...
(let ((anon41_Then_correct  (=> (= (ControlFlow 0 18) (- 0 17)) (=  (and (<= 0 k_13) (< k_13 i_6@1)) (U_2_bool (MapType0Select (|Map#Domain| m@2) (int_2_U k_13)))))))
(let ((anon40_Then_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (<= 0 i_6@0) (<= i_6@0 100)) (and (= 100 100) (forall ((k_11 T@U) ) (!  (=> (= (type k_11) intType) (=  (and (<= 0 (U_2_int k_11)) (< (U_2_int k_11) i_6@0)) (U_2_bool (MapType0Select (|Map#Domain| m@1) k_11))))
 :qid |stdinbpl.1092:24|
 :skolemid |113|
 :pattern ( (MapType0Select (|Map#Domain| m@1) k_11))
)))) (=> (and (and (and (forall ((k_12 T@U) ) (!  (=> (and (= (type k_12) intType) (U_2_bool (MapType0Select (|Map#Domain| m@1) k_12))) (= (U_2_int (MapType0Select (|Map#Elements| m@1) k_12)) (* (U_2_int k_12) (U_2_int k_12))))
 :qid |stdinbpl.1096:24|
 :skolemid |114|
 :pattern ( (MapType0Select (|Map#Domain| m@1) k_12))
 :pattern ( (MapType0Select (|Map#Elements| m@1) k_12))
)) (state Heap@@9 ZeroMask)) (and (< i_6@0 100) (state Heap@@9 ZeroMask))) (and (and (= m@2 (|Map#Build| m@1 (int_2_U i_6@0) (int_2_U (* i_6@0 i_6@0)))) (state Heap@@9 ZeroMask)) (and (= i_6@1 (+ i_6@0 1)) (state Heap@@9 ZeroMask)))) (and (=> (= (ControlFlow 0 25) (- 0 28)) (<= 0 i_6@1)) (=> (<= 0 i_6@1) (and (=> (= (ControlFlow 0 25) (- 0 27)) (<= i_6@1 100)) (=> (<= i_6@1 100) (and (=> (= (ControlFlow 0 25) (- 0 26)) (= 100 100)) (=> (= 100 100) (and (=> (= (ControlFlow 0 25) 18) anon41_Then_correct) (=> (= (ControlFlow 0 25) 24) anon41_Else_correct)))))))))))))
(let ((anon29_correct true))
(let ((anon45_Else_correct  (=> (and (not (and (<= 0 i$0) (< i$0 100))) (= (ControlFlow 0 15) 11)) anon29_correct)))
(let ((anon45_Then_correct  (=> (and (<= 0 i$0) (< i$0 100)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (U_2_bool (MapType0Select (|Map#Domain| m@1) (int_2_U i$0)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@1) (int_2_U i$0))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (= (U_2_int (MapType0Select (|Map#Elements| m@1) (int_2_U i$0))) (* i$0 i$0))) (=> (= (U_2_int (MapType0Select (|Map#Elements| m@1) (int_2_U i$0))) (* i$0 i$0)) (=> (= (ControlFlow 0 12) 11) anon29_correct))))))))
(let ((anon44_Else_correct true))
(let ((anon40_Else_correct  (=> (not (< i_6@0 100)) (=> (and (and (and (state Heap@@9 ZeroMask) (<= 0 i_6@0)) (and (<= i_6@0 100) (= 100 100))) (and (and (forall ((k_17 T@U) ) (!  (=> (= (type k_17) intType) (=  (and (<= 0 (U_2_int k_17)) (< (U_2_int k_17) i_6@0)) (U_2_bool (MapType0Select (|Map#Domain| m@1) k_17))))
 :qid |stdinbpl.1153:22|
 :skolemid |117|
 :pattern ( (MapType0Select (|Map#Domain| m@1) k_17))
)) (forall ((k_18 T@U) ) (!  (=> (and (= (type k_18) intType) (U_2_bool (MapType0Select (|Map#Domain| m@1) k_18))) (= (U_2_int (MapType0Select (|Map#Elements| m@1) k_18)) (* (U_2_int k_18) (U_2_int k_18))))
 :qid |stdinbpl.1157:22|
 :skolemid |118|
 :pattern ( (MapType0Select (|Map#Domain| m@1) k_18))
 :pattern ( (MapType0Select (|Map#Elements| m@1) k_18))
))) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)))) (and (and (=> (= (ControlFlow 0 16) 10) anon44_Else_correct) (=> (= (ControlFlow 0 16) 12) anon45_Then_correct)) (=> (= (ControlFlow 0 16) 15) anon45_Else_correct))))))
(let ((anon34_Else_correct  (=> (forall ((k_6_1 T@U) ) (!  (=> (and (= (type k_6_1) intType) (U_2_bool (MapType0Select (|Map#Domain| m@0) k_6_1))) (= (U_2_int (MapType0Select (|Map#Elements| m@0) k_6_1)) (* (U_2_int k_6_1) (U_2_int k_6_1))))
 :qid |stdinbpl.1040:24|
 :skolemid |110|
 :pattern ( (MapType0Select (|Map#Domain| m@0) k_6_1))
 :pattern ( (MapType0Select (|Map#Elements| m@0) k_6_1))
...
(let ((anon35_Else_correct  (=> (and (not (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U k_5)))) (= (ControlFlow 0 9) 6)) anon9_correct)))
(let ((anon35_Then_correct  (=> (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U k_5))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (= (U_2_int (MapType0Select (|Map#Elements| m@0) (int_2_U k_5))) (* k_5 k_5))) (=> (= (U_2_int (MapType0Select (|Map#Elements| m@0) (int_2_U k_5))) (* k_5 k_5)) (=> (= (ControlFlow 0 7) 6) anon9_correct))))))
(let ((anon33_Else_correct  (=> (forall ((k_4_1 T@U) ) (!  (=> (= (type k_4_1) intType) (=  (and (<= 0 (U_2_int k_4_1)) (< (U_2_int k_4_1) 0)) (U_2_bool (MapType0Select (|Map#Domain| m@0) k_4_1))))
 :qid |stdinbpl.1029:24|
 :skolemid |109|
 :pattern ( (MapType0Select (|Map#Domain| m@0) k_4_1))
...
(let ((anon33_Then_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (=  (and (<= 0 k_3) (< k_3 0)) (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U k_3)))))))
(let ((anon32_Else_correct  (=> (and (and (forall ((k_2_1 T@U) ) (!  (=> (= (type k_2_1) intType) (not (U_2_bool (MapType0Select (|Map#Domain| m@0) k_2_1))))
 :qid |stdinbpl.997:20|
 :skolemid |108|
 :pattern ( (MapType0Select (|Map#Domain| m@0) k_2_1))
)) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 39) (- 0 42)) (<= 0 0)) (=> (<= 0 0) (and (=> (= (ControlFlow 0 39) (- 0 41)) (<= 0 100)) (=> (<= 0 100) (and (=> (= (ControlFlow 0 39) (- 0 40)) (= 100 100)) (=> (= 100 100) (and (=> (= (ControlFlow 0 39) 5) anon33_Then_correct) (=> (= (ControlFlow 0 39) 38) anon33_Else_correct)))))))))))
(let ((anon32_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (not (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U k_1)))))))
(let ((anon31_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= m@0 (|Map#Empty| intType intType)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 43) 1) anon31_Then_correct) (=> (= (ControlFlow 0 43) 3) anon32_Then_correct)) (=> (= (ControlFlow 0 43) 39) anon32_Else_correct))))))
