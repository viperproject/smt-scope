...
(let ((anon19_Else_correct  (=> (= (MapType0Select Heap@1 start@@19 next) null) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 7) 5)) anon13_correct))))
(let ((anon19_Then_correct  (=> (not (= (MapType0Select Heap@1 start@@19 next) null)) (=> (and (and (forall ((o_3 T@U) (f_7 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_7))))
(let ((A@@12 (FieldTypeInv0 (type f_7))))
 (=> (and (and (= (type o_3) RefType) (= (type f_7) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|list#sm| start@@19)) o_3 f_7)) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|list#sm| (MapType0Select Heap@1 start@@19 next))) o_3 f_7)))) (U_2_bool (MapType1Select newPMask@0 o_3 f_7)))))
 :qid |stdinbpl.680:33|
 :skolemid |62|
 :pattern ( (MapType1Select newPMask@0 o_3 f_7))
)) (= Heap@2 (MapType0Store Heap@1 null (|list#sm| start@@19) newPMask@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 6) 5))) anon13_correct))))
(let ((anon11_correct  (=> (and (= Heap@0 (MapType0Store Heap@@19 null (|list#sm| start@@19) (MapType1Store (MapType0Select Heap@@19 null (|list#sm| start@@19)) start@@19 val (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|list#sm| start@@19) (MapType1Store (MapType0Select Heap@0 null (|list#sm| start@@19)) start@@19 next (bool_2_U true))))) (and (=> (= (ControlFlow 0 8) 6) anon19_Then_correct) (=> (= (ControlFlow 0 8) 7) anon19_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (|elems#trigger| (MapType0Select Heap@@19 null (list (MapType0Select Heap@@19 start@@19 next))) (MapType0Select Heap@@19 start@@19 next)) (= (ControlFlow 0 11) 8)) anon11_correct)))
(let ((anon16_Then_correct  (=> (= (MapType0Select Heap@@19 start@@19 next) null) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm UnfoldingMask@4 start@@19 val)) (=> (HasDirectPerm UnfoldingMask@4 start@@19 val) (=> (= (ControlFlow 0 9) 8) anon11_correct))))))
(let ((anon9_correct true))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon9_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (list (MapType0Select Heap@@19 start@@19 next)))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (list (MapType0Select Heap@@19 start@@19 next))))) (=> (= (ControlFlow 0 2) 1) anon9_correct))))))
(let ((anon16_Else_correct  (=> (not (= (MapType0Select Heap@@19 start@@19 next) null)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (HasDirectPerm UnfoldingMask@4 start@@19 val)) (=> (HasDirectPerm UnfoldingMask@4 start@@19 val) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm UnfoldingMask@4 start@@19 next)) (=> (HasDirectPerm UnfoldingMask@4 start@@19 next) (and (and (=> (= (ControlFlow 0 12) 11) anon17_Else_correct) (=> (= (ControlFlow 0 12) 2) anon18_Then_correct)) (=> (= (ControlFlow 0 12) 4) anon18_Else_correct)))))))))
...
(let ((anon15_Else_correct  (=> (= (MapType0Select Heap@@19 start@@19 next) null) (=> (and (= UnfoldingMask@4 UnfoldingMask@2) (= (ControlFlow 0 18) 15)) anon4_correct))))
(let ((anon15_Then_correct  (=> (and (not (= (MapType0Select Heap@@19 start@@19 next) null)) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 null (list (MapType0Select Heap@@19 start@@19 next)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 null (list (MapType0Select Heap@@19 start@@19 next)))) FullPerm))))) (=> (and (and (InsidePredicate (list start@@19) (MapType0Select Heap@@19 null (list start@@19)) (list (MapType0Select Heap@@19 start@@19 next)) (MapType0Select Heap@@19 null (list (MapType0Select Heap@@19 start@@19 next)))) (state Heap@@19 UnfoldingMask@3)) (and (= UnfoldingMask@4 UnfoldingMask@3) (= (ControlFlow 0 17) 15))) anon4_correct))))
(let ((anon2_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (list start@@19) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (list start@@19))) FullPerm)))) (=> (and (not (= start@@19 null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 start@@19 val (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 start@@19 val)) FullPerm))))) (=> (and (and (state Heap@@19 UnfoldingMask@1) (not (= start@@19 null))) (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 start@@19 next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 start@@19 next)) FullPerm)))) (state Heap@@19 UnfoldingMask@2))) (and (=> (= (ControlFlow 0 19) 17) anon15_Then_correct) (=> (= (ControlFlow 0 19) 18) anon15_Else_correct)))))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 22) 19)) anon2_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list start@@19))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list start@@19)))) (=> (= (ControlFlow 0 20) 19) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@19 ZeroMask) (U_2_bool (MapType0Select Heap@@19 start@@19 $allocated))) (and (= AssumeFunctionsAbove 0) (= Mask@0 (MapType1Store ZeroMask null (list start@@19) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (list start@@19))) FullPerm)))))) (and (and (state Heap@@19 Mask@0) (state Heap@@19 Mask@0)) (and (|list#trigger| Heap@@19 (list start@@19)) (= (MapType0Select Heap@@19 null (list start@@19)) (CombineFrames (FrameFragment (MapType0Select Heap@@19 start@@19 val)) (CombineFrames (FrameFragment (MapType0Select Heap@@19 start@@19 next)) (FrameFragment (ite (not (= (MapType0Select Heap@@19 start@@19 next) null)) (MapType0Select Heap@@19 null (list (MapType0Select Heap@@19 start@@19 next))) EmptyFrame)))))))) (and (=> (= (ControlFlow 0 23) 20) anon14_Then_correct) (=> (= (ControlFlow 0 23) 22) anon14_Else_correct)))))
