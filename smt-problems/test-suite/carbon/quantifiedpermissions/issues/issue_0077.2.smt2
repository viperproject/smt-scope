...
(assert  (and (and (= (type S) (SeqType RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id test2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_7))) (= (ControlFlow 0 16) 12)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_7)) (and (=> (= (ControlFlow 0 13) (- 0 15)) (>= i_7 0)) (=> (>= i_7 0) (and (=> (= (ControlFlow 0 13) (- 0 14)) (< i_7 (|Seq#Length| S))) (=> (< i_7 (|Seq#Length| S)) (=> (= (ControlFlow 0 13) 12) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_1_1))) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index| S i_1) (|Seq#Index| S i_1_1))))
 ...
 :qid |stdinbpl.1240:15|
 :skolemid |117|
)) (=> (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_1@@1)) (< NoPerm p_1)) (and (qpRange9 (|Seq#Index| S i_1@@1)) (= (invRecv9 (|Seq#Index| S i_1@@1)) i_1@@1)))
 ...
 :pattern ( (|Seq#Index| S i_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U (invRecv9 o_3))) (< NoPerm p_1)) (qpRange9 o_3)) (= (|Seq#Index| S (invRecv9 o_3)) o_3)))
 :qid |stdinbpl.1250:22|
 :skolemid |119|
 :pattern ( (invRecv9 o_3))
))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_1@@2)) (>= p_1 NoPerm))
 ...
 :pattern ( (|Seq#Index| S i_1@@4))
)) (=> (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U (invRecv9 o_3@@0))) (< NoPerm p_1)) (qpRange9 o_3@@0)) (and (=> (< NoPerm p_1) (= (|Seq#Index| S (invRecv9 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) p_1)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U (invRecv9 o_3@@0))) (< NoPerm p_1)) (qpRange9 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
))) (=> (and (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (= (ControlFlow 0 9) (- 0 8)))) (not (= p_1 NoPerm))))))))))))
(let ((anon9_Else_correct  (=> (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_1)) (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U i2_1)) (not (= i1_1 i2_1)))) (not (= (|Seq#Index| S i1_1) (|Seq#Index| S i2_1))))
 :qid |stdinbpl.1216:20|
 :skolemid |116|
...
)) (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 17) 9) anon11_Else_correct) (=> (= (ControlFlow 0 17) 13) anon12_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon12_Else_correct))))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_7)) (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U i2_3)) (not (= i1_7 i2_3))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_7)) (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U i2_3)) (not (= i1_7 i2_3)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_7 0)) (=> (>= i1_7 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_7 (|Seq#Length| S))) (=> (< i1_7 (|Seq#Length| S)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_3 0)) (=> (>= i2_3 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_3 (|Seq#Length| S))) (=> (< i2_3 (|Seq#Length| S)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (<= 0 start) (< start end)) (=> (and (and (<= end (|Seq#Length| S)) (state Heap@@9 ZeroMask)) (and (<= NoPerm p_1) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 18) 17) anon9_Else_correct) (=> (= (ControlFlow 0 18) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 18) 7) anon10_Else_correct)))))))
