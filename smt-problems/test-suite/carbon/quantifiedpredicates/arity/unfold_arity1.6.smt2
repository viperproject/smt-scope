...
)) (=> (and (and (and (forall ((r_2_1 T@U) ) (!  (=> (= (type r_2_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv1 r_2_1)) (< NoPerm FullPerm)) (qpRange1 r_2_1)) (= (invRecv1 r_2_1) r_2_1)))
 :qid |stdinbpl.883:22|
 :skolemid |85|
