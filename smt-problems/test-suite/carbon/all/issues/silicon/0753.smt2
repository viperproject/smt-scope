...
(assert  (and (and (and (and (and (forall ((arg0@@23 T@T) ) (! (= (Ctor (ListDomainTypeType arg0@@23)) 10)
...
))) (forall ((arg0@@25 T@U) ) (! (let ((V (ListDomainTypeTypeInv0 (type arg0@@25))))
(= (type (get_List_value arg0@@25)) V))
 :qid |funType:get_List_value|
 :pattern ( (get_List_value arg0@@25))
))) (forall ((arg0@@26 T@U) ) (! (let ((V@@0 (ListDomainTypeTypeInv0 (type arg0@@26))))
(= (type (get_List_tail arg0@@26)) (ListDomainTypeType V@@0)))
 :qid |funType:get_List_tail|
 :pattern ( (get_List_tail arg0@@26))
))) (forall ((V@@1 T@T) ) (! (= (type (Nil V@@1)) (ListDomainTypeType V@@1))
 :qid |funType:Nil|
 :pattern ( (Nil V@@1))
))) (forall ((arg0@@27 T@U) (arg1@@9 T@U) ) (! (let ((V@@2 (type arg0@@27)))
(= (type (Cons arg0@@27 arg1@@9)) (ListDomainTypeType V@@2)))
 :qid |funType:Cons|
 :pattern ( (Cons arg0@@27 arg1@@9))
))))
(assert (forall ((t_2 T@U) ) (! (let ((V@@3 (ListDomainTypeTypeInv0 (type t_2))))
 (=> (= (type t_2) (ListDomainTypeType V@@3)) (or (and (= (List_tag t_2) 1) (= t_2 (Nil V@@3))) (and (= (List_tag t_2) 0) (exists ((v_2 T@U) (l T@U) ) (!  (and (and (= (type v_2) V@@3) (= (type l) (ListDomainTypeType V@@3))) (= t_2 (Cons v_2 l)))
 :qid |stdinbpl.247:108|
 :skolemid |26|
 :pattern ( (Cons v_2 l))
))))))
 :qid |stdinbpl.245:19|
...
(assert  (and (and (= (Ctor FrameTypeType) 11) (= (type null) RefType)) (forall ((arg0@@28 T@U) ) (! (let ((A (FieldTypeInv0 (type arg0@@28))))
...
(assert (= (Ctor ValDomainTypeType) 12))
(assert (forall ((Heap@@2 T@U) (l@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type l@@0) (ListDomainTypeType ValDomainTypeType))) (dummyFunction (int_2_U (|len#triggerStateless| l@@0))))
 :qid |stdinbpl.283:15|
 :skolemid |31|
 :pattern ( (|len'| Heap@@2 l@@0))
)))
(assert (= (type EmptyFrame) FrameTypeType))
(assert (forall ((Heap@@3 T@U) (Mask@@2 T@U) (l@@1 T@U) ) (!  (=> (and (and (and (= (type Heap@@3) (MapType0Type RefType)) (= (type Mask@@2) (MapType1Type RefType realType))) (= (type l@@1) (ListDomainTypeType ValDomainTypeType))) (and (state Heap@@3 Mask@@2) (or (< AssumeFunctionsAbove 0) (|len#trigger| EmptyFrame l@@1)))) (>= (|len'| Heap@@3 l@@1) 0))
 :qid |stdinbpl.302:15|
 :skolemid |34|
 :pattern ( (state Heap@@3 Mask@@2) (|len'| Heap@@3 l@@1))
)))
...
(assert (forall ((Heap@@5 T@U) (l@@2 T@U) ) (!  (=> (and (= (type Heap@@5) (MapType0Type RefType)) (= (type l@@2) (ListDomainTypeType ValDomainTypeType))) (and (= (len Heap@@5 l@@2) (|len'| Heap@@5 l@@2)) (dummyFunction (int_2_U (|len#triggerStateless| l@@2)))))
 :qid |stdinbpl.279:15|
 :skolemid |30|
 :pattern ( (len Heap@@5 l@@2))
)))
...
(assert (forall ((value_1 T@U) (tail_1 T@U) ) (! (let ((V@@4 (type value_1)))
 (=> (= (type tail_1) (ListDomainTypeType V@@4)) (and (bounded (Cons value_1 tail_1)) (decreasing tail_1 (Cons value_1 tail_1)))))
 :qid |stdinbpl.267:19|
 :skolemid |29|
...
(assert (forall ((Heap@@8 T@U) (Mask@@7 T@U) (l@@3 T@U) ) (!  (=> (and (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (= (type l@@3) (ListDomainTypeType ValDomainTypeType))) (and (state Heap@@8 Mask@@7) (< AssumeFunctionsAbove 0))) (= (len Heap@@8 l@@3) (ite (= (List_tag l@@3) 1) 0 (+ 1 (|len'| Heap@@8 (get_List_tail l@@3))))))
 :qid |stdinbpl.289:15|
 :skolemid |32|
 :pattern ( (state Heap@@8 Mask@@7) (len Heap@@8 l@@3))
)))
...
(assert (forall ((Heap@@11 T@U) (Mask@@11 T@U) (l@@4 T@U) ) (!  (=> (and (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (= (type l@@4) (ListDomainTypeType ValDomainTypeType))) (state Heap@@11 Mask@@11)) (= (|len'| Heap@@11 l@@4) (|len#frame| EmptyFrame l@@4)))
 :qid |stdinbpl.296:15|
 :skolemid |33|
 :pattern ( (state Heap@@11 Mask@@11) (|len'| Heap@@11 l@@4))
)))
...
(assert (forall ((V@@5 T@T) ) (! (bounded (Nil V@@5))
 :skolemid |28|
)))
(assert (forall ((value_1@@0 T@U) (tail_1@@0 T@U) ) (! (let ((V@@6 (type value_1@@0)))
 (=> (= (type tail_1@@0) (ListDomainTypeType V@@6)) (= value_1@@0 (get_List_value (Cons value_1@@0 tail_1@@0)))))
 :qid |stdinbpl.221:19|
 :skolemid |22|
 :pattern ( (Cons value_1@@0 tail_1@@0))
)))
(assert (forall ((value_1@@1 T@U) (tail_1@@1 T@U) ) (! (let ((V@@7 (type value_1@@1)))
 (=> (= (type tail_1@@1) (ListDomainTypeType V@@7)) (= tail_1@@1 (get_List_tail (Cons value_1@@1 tail_1@@1)))))
 :qid |stdinbpl.227:19|
 :skolemid |23|
...
(assert (forall ((value_1@@2 T@U) (tail_1@@2 T@U) ) (! (let ((V@@8 (type value_1@@2)))
 (=> (= (type tail_1@@2) (ListDomainTypeType V@@8)) (= (List_tag (Cons value_1@@2 tail_1@@2)) 0)))
 :qid |stdinbpl.239:19|
 :skolemid |25|
 :pattern ( (Cons value_1@@2 tail_1@@2))
)))
...
(assert (forall ((V@@9 T@T) ) (! (= (List_tag (Nil V@@9)) 1)
 :skolemid |24|
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
...
(assert  (and (= (type l@@5) (ListDomainTypeType ValDomainTypeType)) (= (type Heap@@14) (MapType0Type RefType))))
(set-info :boogie-vc-id |len#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_correct  (=> (and (= Result@0 (ite (= (List_tag l@@5) 1) 0 (+ 1 (len Heap@@14 (get_List_tail l@@5))))) (= (ControlFlow 0 3) (- 0 2))) (>= Result@0 0))))
(let ((anon7_Else_correct  (=> (and (|len#trigger| EmptyFrame (get_List_tail l@@5)) (= (ControlFlow 0 5) 3)) anon5_correct)))
(let ((anon6_Then_correct  (=> (and (= (List_tag l@@5) 1) (= (ControlFlow 0 4) 3)) anon5_correct)))
(let ((anon7_Then_correct true))
(let ((anon6_Else_correct  (=> (not (= (List_tag l@@5) 1)) (and (=> (= (ControlFlow 0 6) 1) anon7_Then_correct) (=> (= (ControlFlow 0 6) 5) anon7_Else_correct)))))
(let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))
