...
(declare-fun i1 () Int)
(declare-fun i2 () Int)
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type S) (SeqType RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type ExhaleHeap@1) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type ExhaleHeap@2) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 54) (let ((anon12_correct true))
(let ((anon31_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_2))) (= (ControlFlow 0 48) 44)) anon12_correct)))
(let ((anon31_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_2)) (and (=> (= (ControlFlow 0 45) (- 0 47)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 45) (- 0 46)) (< i_2 (|Seq#Length| S))) (=> (< i_2 (|Seq#Length| S)) (=> (= (ControlFlow 0 45) 44) anon12_correct))))))))
(let ((anon30_Else_correct  (=> (= (ControlFlow 0 43) (- 0 42)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_3))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_3_1))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index| S i_3) (|Seq#Index| S i_3_1))))
 :qid |stdinbpl.690:15|
 :skolemid |65|
)))))
...
(let ((anon36_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_2))) (= (ControlFlow 0 31) 27)) anon23_correct)))
(let ((anon36_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_2)) (and (=> (= (ControlFlow 0 28) (- 0 30)) (>= i2_2 0)) (=> (>= i2_2 0) (and (=> (= (ControlFlow 0 28) (- 0 29)) (< i2_2 (|Seq#Length| S))) (=> (< i2_2 (|Seq#Length| S)) (=> (= (ControlFlow 0 28) 27) anon23_correct))))))))
(let ((anon35_Else_correct  (=> (> wildcard@2 0.0) (and (=> (= (ControlFlow 0 19) (- 0 26)) (forall ((i2_3 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_3)) (> (U_2_real (MapType1Select QPMask@1 (|Seq#Index| S i2_3) f_7)) NoPerm))
 :qid |stdinbpl.849:15|
 :skolemid |80|
))) (=> (forall ((i2_3@@0 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_3@@0)) (> (U_2_real (MapType1Select QPMask@1 (|Seq#Index| S i2_3@@0) f_7)) NoPerm))
 :qid |stdinbpl.849:15|
 :skolemid |80|
)) (=> (forall ((i2_3@@1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_3@@1)) (< wildcard@2 (U_2_real (MapType1Select QPMask@1 (|Seq#Index| S i2_3@@1) f_7))))
 :qid |stdinbpl.853:20|
 :skolemid |81|
)) (and (=> (= (ControlFlow 0 19) (- 0 25)) (forall ((i2_3@@2 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_3@@2)) (dummyFunction (MapType0Select ExhaleHeap@1 (|Seq#Index| S i2_3@@2) f_7))) (>= wildcard@2 NoPerm))
 :qid |stdinbpl.860:17|
 :skolemid |82|
 :pattern ( (|Seq#Index| S i2_3@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_3@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_3@@2)))
 :pattern ( (|Seq#Index| S i2_3@@2))
))) (=> (forall ((i2_3@@3 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_3@@3)) (dummyFunction (MapType0Select ExhaleHeap@1 (|Seq#Index| S i2_3@@3) f_7))) (>= wildcard@2 NoPerm))
 :qid |stdinbpl.860:17|
 :skolemid |82|
 :pattern ( (|Seq#Index| S i2_3@@3))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_3@@3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_3@@3)))
 :pattern ( (|Seq#Index| S i2_3@@3))
)) (and (=> (= (ControlFlow 0 19) (- 0 24)) (forall ((i2_3@@4 Int) (i2_3_1 Int) ) (!  (=> (and (and (and (and (not (= i2_3@@4 i2_3_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_3@@4))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_3_1))) (< NoPerm wildcard@2)) (< NoPerm wildcard@2)) (not (= (|Seq#Index| S i2_3@@4) (|Seq#Index| S i2_3_1))))
 :qid |stdinbpl.867:17|
 :skolemid |83|
 :pattern ( (neverTriggered5 i2_3@@4) (neverTriggered5 i2_3_1))
))) (=> (forall ((i2_3@@5 Int) (i2_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i2_3@@5 i2_3_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_3@@5))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_3_1@@0))) (< NoPerm wildcard@2)) (< NoPerm wildcard@2)) (not (= (|Seq#Index| S i2_3@@5) (|Seq#Index| S i2_3_1@@0))))
 :qid |stdinbpl.867:17|
 :skolemid |83|
 :pattern ( (neverTriggered5 i2_3@@5) (neverTriggered5 i2_3_1@@0))
)) (and (=> (= (ControlFlow 0 19) (- 0 23)) (forall ((i2_3@@6 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_3@@6)) (> (U_2_real (MapType1Select QPMask@1 (|Seq#Index| S i2_3@@6) f_7)) NoPerm))
 :qid |stdinbpl.874:17|
 :skolemid |84|
 :pattern ( (|Seq#Index| S i2_3@@6))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_3@@6)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_3@@6)))
 :pattern ( (|Seq#Index| S i2_3@@6))
))) (=> (forall ((i2_3@@7 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_3@@7)) (> (U_2_real (MapType1Select QPMask@1 (|Seq#Index| S i2_3@@7) f_7)) NoPerm))
 :qid |stdinbpl.874:17|
 :skolemid |84|
 :pattern ( (|Seq#Index| S i2_3@@7))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_3@@7)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_3@@7)))
 :pattern ( (|Seq#Index| S i2_3@@7))
)) (=> (forall ((i2_3@@8 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_3@@8)) (< NoPerm wildcard@2)) (and (qpRange5 (|Seq#Index| S i2_3@@8)) (= (invRecv5 (|Seq#Index| S i2_3@@8)) i2_3@@8)))
 :qid |stdinbpl.880:22|
 :skolemid |85|
 :pattern ( (|Seq#Index| S i2_3@@8))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_3@@8)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_3@@8)))
 :pattern ( (|Seq#Index| S i2_3@@8))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U (invRecv5 o_3))) (and (< NoPerm wildcard@2) (qpRange5 o_3))) (= (|Seq#Index| S (invRecv5 o_3)) o_3)))
 :qid |stdinbpl.884:22|
 :skolemid |86|
 :pattern ( (invRecv5 o_3))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U (invRecv5 o_3@@0))) (and (< NoPerm wildcard@2) (qpRange5 o_3@@0))) (and (= (|Seq#Index| S (invRecv5 o_3@@0)) o_3@@0) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (- (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) wildcard@2)))) (=> (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U (invRecv5 o_3@@0))) (and (< NoPerm wildcard@2) (qpRange5 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7))))))
 :qid |stdinbpl.890:22|
 :skolemid |87|
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 f_7))) (= (U_2_real (MapType1Select QPMask@1 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@2 o_3@@1 f_5))))))
 :qid |stdinbpl.896:29|
 :skolemid |88|
 :pattern ( (MapType1Select QPMask@2 o_3@@1 f_5))
)) (IdenticalOnKnownLocations ExhaleHeap@1 ExhaleHeap@2 QPMask@2)) (and (state ExhaleHeap@2 QPMask@2) (> wildcard@3 0.0))) (and (=> (= (ControlFlow 0 19) (- 0 22)) (forall ((i_4 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_4)) (> (U_2_real (MapType1Select QPMask@2 (|Seq#Index| S i_4) f_7)) NoPerm))
 :qid |stdinbpl.914:15|
 :skolemid |89|
))) (=> (forall ((i_4@@0 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_4@@0)) (> (U_2_real (MapType1Select QPMask@2 (|Seq#Index| S i_4@@0) f_7)) NoPerm))
 :qid |stdinbpl.914:15|
 :skolemid |89|
)) (=> (forall ((i_4@@1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_4@@1)) (< wildcard@3 (U_2_real (MapType1Select QPMask@2 (|Seq#Index| S i_4@@1) f_7))))
 :qid |stdinbpl.918:20|
 :skolemid |90|
)) (and (=> (= (ControlFlow 0 19) (- 0 21)) (forall ((i_4@@2 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_4@@2)) (dummyFunction (MapType0Select ExhaleHeap@2 (|Seq#Index| S i_4@@2) f_7))) (>= wildcard@3 NoPerm))
 :qid |stdinbpl.925:17|
 :skolemid |91|
 :pattern ( (|Seq#Index| S i_4@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_4@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_4@@2)))
 :pattern ( (|Seq#Index| S i_4@@2))
))) (=> (forall ((i_4@@3 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_4@@3)) (dummyFunction (MapType0Select ExhaleHeap@2 (|Seq#Index| S i_4@@3) f_7))) (>= wildcard@3 NoPerm))
 :qid |stdinbpl.925:17|
 :skolemid |91|
 :pattern ( (|Seq#Index| S i_4@@3))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_4@@3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_4@@3)))
 :pattern ( (|Seq#Index| S i_4@@3))
)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((i_4@@4 Int) (i_4_1 Int) ) (!  (=> (and (and (and (and (not (= i_4@@4 i_4_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_4@@4))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_4_1))) (< NoPerm wildcard@3)) (< NoPerm wildcard@3)) (not (= (|Seq#Index| S i_4@@4) (|Seq#Index| S i_4_1))))
 :qid |stdinbpl.932:17|
 :skolemid |92|
 :pattern ( (neverTriggered3 i_4@@4) (neverTriggered3 i_4_1))
))) (=> (forall ((i_4@@5 Int) (i_4_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_4@@5 i_4_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_4@@5))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_4_1@@0))) (< NoPerm wildcard@3)) (< NoPerm wildcard@3)) (not (= (|Seq#Index| S i_4@@5) (|Seq#Index| S i_4_1@@0))))
 :qid |stdinbpl.932:17|
 :skolemid |92|
 :pattern ( (neverTriggered3 i_4@@5) (neverTriggered3 i_4_1@@0))
)) (=> (= (ControlFlow 0 19) (- 0 18)) (forall ((i_4@@6 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_4@@6)) (> (U_2_real (MapType1Select QPMask@2 (|Seq#Index| S i_4@@6) f_7)) NoPerm))
 :qid |stdinbpl.939:17|
 :skolemid |93|
 :pattern ( (|Seq#Index| S i_4@@6))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_4@@6)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_4@@6)))
 :pattern ( (|Seq#Index| S i_4@@6))
)))))))))))))))))))))))))
(let ((anon33_Else_correct  (=> (> wildcard@1 0.0) (and (=> (= (ControlFlow 0 32) (- 0 36)) (forall ((i1_3 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 2)) (int_2_U i1_3)) (> (U_2_real (MapType1Select Mask@1 (|Seq#Index| S i1_3) f_7)) NoPerm))
 :qid |stdinbpl.770:15|
 :skolemid |71|
))) (=> (forall ((i1_3@@0 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 2)) (int_2_U i1_3@@0)) (> (U_2_real (MapType1Select Mask@1 (|Seq#Index| S i1_3@@0) f_7)) NoPerm))
 :qid |stdinbpl.770:15|
 :skolemid |71|
)) (=> (forall ((i1_3@@1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 2)) (int_2_U i1_3@@1)) (< wildcard@1 (U_2_real (MapType1Select Mask@1 (|Seq#Index| S i1_3@@1) f_7))))
 :qid |stdinbpl.774:20|
 :skolemid |72|
)) (and (=> (= (ControlFlow 0 32) (- 0 35)) (forall ((i1_3@@2 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 2)) (int_2_U i1_3@@2)) (dummyFunction (MapType0Select Heap@0 (|Seq#Index| S i1_3@@2) f_7))) (>= wildcard@1 NoPerm))
 :qid |stdinbpl.781:17|
 :skolemid |73|
 :pattern ( (|Seq#Index| S i1_3@@2))
 :pattern ( (|Seq#Index| S i1_3@@2))
))) (=> (forall ((i1_3@@3 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 2)) (int_2_U i1_3@@3)) (dummyFunction (MapType0Select Heap@0 (|Seq#Index| S i1_3@@3) f_7))) (>= wildcard@1 NoPerm))
 :qid |stdinbpl.781:17|
 :skolemid |73|
 :pattern ( (|Seq#Index| S i1_3@@3))
 :pattern ( (|Seq#Index| S i1_3@@3))
)) (and (=> (= (ControlFlow 0 32) (- 0 34)) (forall ((i1_3@@4 Int) (i1_3_1 Int) ) (!  (=> (and (and (and (and (not (= i1_3@@4 i1_3_1)) (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 2)) (int_2_U i1_3@@4))) (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 2)) (int_2_U i1_3_1))) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= (|Seq#Index| S i1_3@@4) (|Seq#Index| S i1_3_1))))
 :qid |stdinbpl.788:17|
 :skolemid |74|
 :pattern ( (neverTriggered4 i1_3@@4) (neverTriggered4 i1_3_1))
))) (=> (forall ((i1_3@@5 Int) (i1_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i1_3@@5 i1_3_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 2)) (int_2_U i1_3@@5))) (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 2)) (int_2_U i1_3_1@@0))) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= (|Seq#Index| S i1_3@@5) (|Seq#Index| S i1_3_1@@0))))
 :qid |stdinbpl.788:17|
 :skolemid |74|
 :pattern ( (neverTriggered4 i1_3@@5) (neverTriggered4 i1_3_1@@0))
)) (and (=> (= (ControlFlow 0 32) (- 0 33)) (forall ((i1_3@@6 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 2)) (int_2_U i1_3@@6)) (> (U_2_real (MapType1Select Mask@1 (|Seq#Index| S i1_3@@6) f_7)) NoPerm))
 :qid |stdinbpl.795:17|
 :skolemid |75|
 :pattern ( (|Seq#Index| S i1_3@@6))
 :pattern ( (|Seq#Index| S i1_3@@6))
))) (=> (forall ((i1_3@@7 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 2)) (int_2_U i1_3@@7)) (> (U_2_real (MapType1Select Mask@1 (|Seq#Index| S i1_3@@7) f_7)) NoPerm))
 :qid |stdinbpl.795:17|
 :skolemid |75|
 :pattern ( (|Seq#Index| S i1_3@@7))
 :pattern ( (|Seq#Index| S i1_3@@7))
)) (=> (and (forall ((i1_3@@8 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 2)) (int_2_U i1_3@@8)) (< NoPerm wildcard@1)) (and (qpRange4 (|Seq#Index| S i1_3@@8)) (= (invRecv4 (|Seq#Index| S i1_3@@8)) i1_3@@8)))
 :qid |stdinbpl.801:22|
 :skolemid |76|
 :pattern ( (|Seq#Index| S i1_3@@8))
 :pattern ( (|Seq#Index| S i1_3@@8))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 2)) (int_2_U (invRecv4 o_3@@2))) (and (< NoPerm wildcard@1) (qpRange4 o_3@@2))) (= (|Seq#Index| S (invRecv4 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.805:22|
 :skolemid |77|
 :pattern ( (invRecv4 o_3@@2))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 2)) (int_2_U (invRecv4 o_3@@3))) (and (< NoPerm wildcard@1) (qpRange4 o_3@@3))) (and (= (|Seq#Index| S (invRecv4 o_3@@3)) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (- (U_2_real (MapType1Select Mask@1 o_3@@3 f_7)) wildcard@1)))) (=> (not (and (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 2)) (int_2_U (invRecv4 o_3@@3))) (and (< NoPerm wildcard@1) (qpRange4 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (U_2_real (MapType1Select Mask@1 o_3@@3 f_7))))))
 :qid |stdinbpl.811:22|
 :skolemid |78|
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 f_7))) (= (U_2_real (MapType1Select Mask@1 o_3@@4 f_5@@0)) (U_2_real (MapType1Select QPMask@1 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.817:29|
 :skolemid |79|
...
(let ((anon34_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 2)) (int_2_U i1_2))) (= (ControlFlow 0 17) 13)) anon19_correct)))
(let ((anon34_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (- (|Seq#Length| S) 2)) (int_2_U i1_2)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= i1_2 0)) (=> (>= i1_2 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< i1_2 (|Seq#Length| S))) (=> (< i1_2 (|Seq#Length| S)) (=> (= (ControlFlow 0 14) 13) anon19_correct))))))))
...
(let ((anon32_Else_correct  (=> (and (and (>= 1 (|Seq#Length| S)) (= Mask@1 QPMask@0)) (and (= Heap@0 Heap@@9) (= (ControlFlow 0 41) 37))) anon16_correct)))
(let ((anon32_Then_correct  (=> (> (|Seq#Length| S) 1) (and (=> (= (ControlFlow 0 38) (- 0 40)) (< 0 (|Seq#Length| S))) (=> (< 0 (|Seq#Length| S)) (and (=> (= (ControlFlow 0 38) (- 0 39)) (> (U_2_real (MapType1Select QPMask@0 (|Seq#Index| S 0) f_7)) NoPerm)) (=> (> (U_2_real (MapType1Select QPMask@0 (|Seq#Index| S 0) f_7)) NoPerm) (=> (and (and (and (> wildcard@0 0.0) (< wildcard@0 (U_2_real (MapType1Select QPMask@0 (|Seq#Index| S 0) f_7)))) (and (= Mask@0 (MapType1Store QPMask@0 (|Seq#Index| S 0) f_7 (real_2_U (- (U_2_real (MapType1Select QPMask@0 (|Seq#Index| S 0) f_7)) wildcard@0)))) (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@0))) (and (and (state ExhaleHeap@0 Mask@0) (= Mask@1 Mask@0)) (and (= Heap@0 ExhaleHeap@0) (= (ControlFlow 0 38) 37)))) anon16_correct))))))))
(let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 50) (- 0 51)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_1_1))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index| S i_1) (|Seq#Index| S i_1_1))))
 :qid |stdinbpl.633:15|
 :skolemid |59|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_1@@0))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_1_1@@0))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index| S i_1@@0) (|Seq#Index| S i_1_1@@0))))
 :qid |stdinbpl.633:15|
 :skolemid |59|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_1@@1)) (and (qpRange1 (|Seq#Index| S i_1@@1)) (= (invRecv1 (|Seq#Index| S i_1@@1)) i_1@@1)))
 :qid |stdinbpl.639:22|
 :skolemid |60|
 :pattern ( (|Seq#Index| S i_1@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_1@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_1@@1)))
 :pattern ( (|Seq#Index| S i_1@@1))
)) (=> (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U (invRecv1 o_3@@5))) (qpRange1 o_3@@5)) (= (|Seq#Index| S (invRecv1 o_3@@5)) o_3@@5)))
 :qid |stdinbpl.643:22|
 :skolemid |61|
 :pattern ( (invRecv1 o_3@@5))
)) (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_1@@2)) (not (= (|Seq#Index| S i_1@@2) null)))
 :qid |stdinbpl.649:22|
 :skolemid |62|
 :pattern ( (|Seq#Index| S i_1@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_1@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i_1@@2)))
 :pattern ( (|Seq#Index| S i_1@@2))
))) (=> (and (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U (invRecv1 o_3@@6))) (qpRange1 o_3@@6)) (and (= (|Seq#Index| S (invRecv1 o_3@@6)) o_3@@6) (< (U_2_real (MapType1Select ZeroMask o_3@@6 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7))))) (=> (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U (invRecv1 o_3@@6))) (qpRange1 o_3@@6))) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@6 f_7))))))
 :qid |stdinbpl.655:22|
 :skolemid |63|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 50) 49) anon29_Then_correct) (=> (= (ControlFlow 0 50) 38) anon32_Then_correct)) (=> (= (ControlFlow 0 50) 41) anon32_Else_correct)))))))))
(let ((anon7_correct true))
(let ((anon28_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i@@6))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon28_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i@@6)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i@@6 (|Seq#Length| S))) (=> (< i@@6 (|Seq#Length| S)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon25_Else_correct  (=> (and (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i1_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_1)) (not (= i1_1 i2_1)))) (not (= (|Seq#Index| S i1_1) (|Seq#Index| S i2_1))))
 :qid |stdinbpl.615:20|
 :skolemid |58|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i1_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i1_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i1_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i1_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i1_1)) (|Seq#Index| S i2_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i1_1)) (|Seq#Index| S i2_1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_1)) (|Seq#Index| S i1_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2_1)) (|Seq#Index| S i1_1))
 :pattern ( (|Seq#Index| S i1_1) (|Seq#Index| S i2_1))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 52) 50) anon27_Else_correct) (=> (= (ControlFlow 0 52) 9) anon28_Then_correct)) (=> (= (ControlFlow 0 52) 12) anon28_Else_correct)))))
(let ((anon3_correct true))
(let ((anon26_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2)) (not (= i1 i2))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon26_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S)) (int_2_U i2)) (not (= i1 i2)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1 0)) (=> (>= i1 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1 (|Seq#Length| S))) (=> (< i1 (|Seq#Length| S)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2 0)) (=> (>= i2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2 (|Seq#Length| S))) (=> (< i2 (|Seq#Length| S)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (and (=> (= (ControlFlow 0 53) 52) anon25_Else_correct) (=> (= (ControlFlow 0 53) 2) anon26_Then_correct)) (=> (= (ControlFlow 0 53) 7) anon26_Else_correct)))))
