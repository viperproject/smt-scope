...
(declare-fun ts@@7 () T@U)
(declare-fun |children_seq#trigger| (T@U T@U) Bool)
(declare-fun Heap@@25 () T@U)
(assert  (and (= (type ts@@7) (SeqType TreeDomainTypeType)) (= (type Heap@@25) (MapType0Type RefType))))
(set-info :boogie-vc-id |children_seq#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon13_Then_correct true))
(let ((anon10_correct true))
(let ((anon12_Then_correct  (=> (= (|Seq#Length| ts@@7) 1) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< 0 (|Seq#Length| ts@@7))) (=> (< 0 (|Seq#Length| ts@@7)) (and (=> (= (ControlFlow 0 9) 8) anon13_Then_correct) (=> (= (ControlFlow 0 9) 3) anon10_correct)))))))
(let ((anon11_Then_correct  (=> (and (= (|Seq#Length| ts@@7) 0) (= (ControlFlow 0 4) 3)) anon10_correct)))
(let ((anon15_Then_correct true))
(let ((anon14_Else_correct  (=> (|children_seq#trigger| EmptyFrame (|Seq#Drop| ts@@7 1)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< 0 (|Seq#Length| ts@@7))) (=> (< 0 (|Seq#Length| ts@@7)) (and (=> (= (ControlFlow 0 5) 2) anon15_Then_correct) (=> (= (ControlFlow 0 5) 3) anon10_correct)))))))
(let ((anon14_Then_correct true))
(let ((anon12_Else_correct  (=> (not (= (|Seq#Length| ts@@7) 1)) (and (=> (= (ControlFlow 0 7) 1) anon14_Then_correct) (=> (= (ControlFlow 0 7) 5) anon14_Else_correct)))))
(let ((anon11_Else_correct  (=> (not (= (|Seq#Length| ts@@7) 0)) (and (=> (= (ControlFlow 0 11) 9) anon12_Then_correct) (=> (= (ControlFlow 0 11) 7) anon12_Else_correct)))))
(let ((anon0_correct  (=> (and (state Heap@@25 ZeroMask) (= AssumeFunctionsAbove 2)) (and (=> (= (ControlFlow 0 12) 4) anon11_Then_correct) (=> (= (ControlFlow 0 12) 11) anon11_Else_correct)))))
