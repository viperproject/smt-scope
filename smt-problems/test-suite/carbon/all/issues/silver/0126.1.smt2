...
(declare-fun |g'| (T@U T@U) T@U)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |g#triggerStateless| (T@U) T@U)
...
(declare-fun |g#frame| (T@U T@U) T@U)
...
(assert  (and (forall ((arg0@@29 T@U) (arg1@@11 T@U) ) (! (= (type (|g'| arg0@@29 arg1@@11)) (SeqType RefType))
 :qid |funType:g'|
 :pattern ( (|g'| arg0@@29 arg1@@11))
)) (forall ((arg0@@30 T@U) ) (! (= (type (|g#triggerStateless| arg0@@30)) (SeqType RefType))
 :qid |funType:g#triggerStateless|
 :pattern ( (|g#triggerStateless| arg0@@30))
))))
(assert (forall ((Heap@@2 T@U) (xs T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type xs) (SeqType RefType))) (dummyFunction (|g#triggerStateless| xs)))
 :qid |stdinbpl.551:15|
 :skolemid |59|
 :pattern ( (|g'| Heap@@2 xs))
)))
...
(assert (forall ((arg0@@34 T@U) (arg1@@15 T@U) ) (! (= (type (g arg0@@34 arg1@@15)) (SeqType RefType))
 :qid |funType:g|
 :pattern ( (g arg0@@34 arg1@@15))
)))
(assert (forall ((Heap@@4 T@U) (xs@@0 T@U) ) (!  (=> (and (= (type Heap@@4) (MapType0Type RefType)) (= (type xs@@0) (SeqType RefType))) (and (= (g Heap@@4 xs@@0) (|g'| Heap@@4 xs@@0)) (dummyFunction (|g#triggerStateless| xs@@0))))
 :qid |stdinbpl.547:15|
 :skolemid |58|
 :pattern ( (g Heap@@4 xs@@0))
)))
...
(assert (forall ((arg0@@36 T@U) (arg1@@16 T@U) ) (! (let ((T@@14 (SeqTypeInv0 (type arg0@@36))))
(= (type (|Seq#Append| arg0@@36 arg1@@16)) (SeqType T@@14)))
 :qid |funType:Seq#Append|
 :pattern ( (|Seq#Append| arg0@@36 arg1@@16))
)))
...
(assert (forall ((arg0@@38 T@U) (arg1@@18 T@U) ) (! (= (type (|g#frame| arg0@@38 arg1@@18)) (SeqType RefType))
 :qid |funType:g#frame|
 :pattern ( (|g#frame| arg0@@38 arg1@@18))
)))
(assert (forall ((Heap@@9 T@U) (Mask@@9 T@U) (xs@@1 T@U) ) (!  (=> (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (= (type xs@@1) (SeqType RefType))) (state Heap@@9 Mask@@9)) (= (|g'| Heap@@9 xs@@1) (|g#frame| EmptyFrame xs@@1)))
 :qid |stdinbpl.558:15|
 :skolemid |60|
 :pattern ( (state Heap@@9 Mask@@9) (|g'| Heap@@9 xs@@1))
)))
...
(declare-fun a_2 () T@U)
(assert  (and (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type b_2) RefType)) (= (type s@@17) (SeqType RefType))) (= (type a_2) RefType)))
(set-info :boogie-vc-id f_7)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (|Seq#Equal| (g Heap@@12 (|Seq#Singleton| b_2)) s@@17))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (|Seq#Equal| (g Heap@@12 (|Seq#Append| (|Seq#Singleton| b_2) (|Seq#Empty| RefType))) s@@17) (=> (and (state Heap@@12 ZeroMask) (state Heap@@12 ZeroMask)) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@12 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@12 a_2 $allocated))) (and (U_2_bool (MapType0Select Heap@@12 b_2 $allocated)) (state Heap@@12 ZeroMask))) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct))))))
