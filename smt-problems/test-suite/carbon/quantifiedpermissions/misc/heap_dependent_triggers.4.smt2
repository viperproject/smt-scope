...
(assert  (and (= (type xs@@19) (MapType2Type RefType boolType)) (= (type Heap@@28) (MapType0Type RefType))))
(set-info :boogie-vc-id |bar02#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (U_2_bool (MapType2Select xs@@19 x_3))) (U_2_bool (MapType2Select xs@@19 x_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1))))
 :qid |stdinbpl.976:15|
 :skolemid |131|
 :no-pattern (type x_3)
...
(let ((anon0_correct  (=> (and (state Heap@@28 ZeroMask) (= AssumeFunctionsAbove 3)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
