...
(declare-fun f_7 () T@U)
(declare-fun g () T@U)
(declare-fun unrelatedField () T@U)
...
(declare-fun valid (T@U Bool) T@U)
...
(declare-fun |valid#sm| (T@U Bool) T@U)
...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type f_7) (FieldType NormalFieldType intType))) (= (type g) (FieldType NormalFieldType intType))) (= (type unrelatedField) (FieldType NormalFieldType intType))))
(assert (distinct $allocated f_7 g unrelatedField)
)
...
(assert  (and (and (= (Ctor PredicateType_validType) 13) (= (Ctor FrameTypeType) 14)) (forall ((arg0@@31 T@U) (arg1@@13 Bool) ) (! (= (type (valid arg0@@31 arg1@@13)) (FieldType PredicateType_validType FrameTypeType))
 :qid |funType:valid|
 :pattern ( (valid arg0@@31 arg1@@13))
))))
(assert (forall ((this T@U) (b_1 Bool) ) (!  (=> (= (type this) RefType) (IsPredicateField (valid this b_1)))
 :qid |stdinbpl.825:15|
 :skolemid |119|
 :pattern ( (valid this b_1))
)))
(assert (forall ((Heap@@0 T@U) (this@@0 T@U) (b_1@@0 Bool) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type this@@0) RefType)) (|valid#everUsed| (valid this@@0 b_1@@0)))
 :qid |stdinbpl.844:15|
 :skolemid |123|
 :pattern ( (|valid#trigger| Heap@@0 (valid this@@0 b_1@@0)))
)))
...
(= (type (|Seq#Index| arg0@@32 arg1@@14)) T@@5))
 :qid |funType:Seq#Index|
 :pattern ( (|Seq#Index| arg0@@32 arg1@@14))
)))
...
(assert (forall ((arg0@@35 T@U) (arg1@@15 Int) (arg2@@3 T@U) ) (! (let ((T@@7 (type arg2@@3)))
(= (type (|Seq#Update| arg0@@35 arg1@@15 arg2@@3)) (SeqType T@@7)))
 :qid |funType:Seq#Update|
 :pattern ( (|Seq#Update| arg0@@35 arg1@@15 arg2@@3))
)))
...
(assert  (and (and (and (and (and (and (and (forall ((arg0@@36 T@T) (arg1@@16 T@T) ) (! (= (Ctor (MapType2Type arg0@@36 arg1@@16)) 15)
 :qid |ctor:MapType2Type|
)) (forall ((arg0@@37 T@T) (arg1@@17 T@T) ) (! (= (MapType2TypeInv0 (MapType2Type arg0@@37 arg1@@17)) arg0@@37)
 :qid |typeInv:MapType2TypeInv0|
 :pattern ( (MapType2Type arg0@@37 arg1@@17))
))) (forall ((arg0@@38 T@T) (arg1@@18 T@T) ) (! (= (MapType2TypeInv1 (MapType2Type arg0@@38 arg1@@18)) arg1@@18)
 :qid |typeInv:MapType2TypeInv1|
 :pattern ( (MapType2Type arg0@@38 arg1@@18))
))) (forall ((arg0@@39 T@U) (arg1@@19 T@U) ) (! (let ((aVar1@@2 (MapType2TypeInv1 (type arg0@@39))))
(= (type (MapType2Select arg0@@39 arg1@@19)) aVar1@@2))
 :qid |funType:MapType2Select|
 :pattern ( (MapType2Select arg0@@39 arg1@@19))
))) (forall ((arg0@@40 T@U) (arg1@@20 T@U) (arg2@@4 T@U) ) (! (let ((aVar1@@3 (type arg2@@4)))
(let ((aVar0@@1 (type arg1@@20)))
(= (type (MapType2Store arg0@@40 arg1@@20 arg2@@4)) (MapType2Type aVar0@@1 aVar1@@3))))
 :qid |funType:MapType2Store|
 :pattern ( (MapType2Store arg0@@40 arg1@@20 arg2@@4))
 ...
 :weight 0
)))) (forall ((arg0@@41 T@U) (arg1@@21 T@U) ) (! (let ((T@@10 (MapType2TypeInv0 (type arg0@@41))))
(= (type (|Set#Union| arg0@@41 arg1@@21)) (MapType2Type T@@10 boolType)))
 :qid |funType:Set#Union|
 :pattern ( (|Set#Union| arg0@@41 arg1@@21))
))))
...
(assert (forall ((arg0@@42 T@U) (arg1@@22 T@U) ) (! (let ((T@@12 (MapType2TypeInv0 (type arg0@@42))))
(= (type (|Set#Intersection| arg0@@42 arg1@@22)) (MapType2Type T@@12 boolType)))
 :qid |funType:Set#Intersection|
 :pattern ( (|Set#Intersection| arg0@@42 arg1@@22))
)))
...
(assert (forall ((arg0@@44 T@U) (arg1@@23 Int) ) (! (let ((T@@17 (SeqTypeInv0 (type arg0@@44))))
(= (type (|Seq#Take| arg0@@44 arg1@@23)) (SeqType T@@17)))
 :qid |funType:Seq#Take|
 :pattern ( (|Seq#Take| arg0@@44 arg1@@23))
)))
...
(assert (forall ((this@@1 T@U) (b_1@@1 Bool) (this2 T@U) (b2 Bool) ) (!  (=> (and (and (= (type this@@1) RefType) (= (type this2) RefType)) (= (valid this@@1 b_1@@1) (valid this2 b2))) (and (= this@@1 this2) (= b_1@@1 b2)))
 :qid |stdinbpl.835:15|
 :skolemid |121|
 :pattern ( (valid this@@1 b_1@@1) (valid this2 b2))
)))
(assert (forall ((arg0@@45 T@U) (arg1@@24 Bool) ) (! (= (type (|valid#sm| arg0@@45 arg1@@24)) (FieldType PredicateType_validType (MapType1Type RefType boolType)))
 :qid |funType:valid#sm|
 :pattern ( (|valid#sm| arg0@@45 arg1@@24))
)))
(assert (forall ((this@@2 T@U) (b_1@@2 Bool) (this2@@0 T@U) (b2@@0 Bool) ) (!  (=> (and (and (= (type this@@2) RefType) (= (type this2@@0) RefType)) (= (|valid#sm| this@@2 b_1@@2) (|valid#sm| this2@@0 b2@@0))) (and (= this@@2 this2@@0) (= b_1@@2 b2@@0)))
 :qid |stdinbpl.839:15|
 :skolemid |122|
 :pattern ( (|valid#sm| this@@2 b_1@@2) (|valid#sm| this2@@0 b2@@0))
)))
...
(assert  (not (IsPredicateField unrelatedField)))
(assert  (not (IsWandField unrelatedField)))
...
(assert  (and (forall ((arg0@@51 Real) (arg1@@28 T@U) ) (! (= (type (ConditionalFrame arg0@@51 arg1@@28)) FrameTypeType)
 :qid |funType:ConditionalFrame|
 :pattern ( (ConditionalFrame arg0@@51 arg1@@28))
...
(assert (forall ((arg0@@52 T@U) (arg1@@29 T@U) ) (! (let ((T@@40 (MapType2TypeInv0 (type arg0@@52))))
(= (type (|Set#Difference| arg0@@52 arg1@@29)) (MapType2Type T@@40 boolType)))
 :qid |funType:Set#Difference|
 :pattern ( (|Set#Difference| arg0@@52 arg1@@29))
)))
...
(assert (forall ((arg0@@53 T@U) (arg1@@30 T@U) ) (! (let ((T@@45 (type arg1@@30)))
(= (type (|Set#UnionOne| arg0@@53 arg1@@30)) (MapType2Type T@@45 boolType)))
 :qid |funType:Set#UnionOne|
 :pattern ( (|Set#UnionOne| arg0@@53 arg1@@30))
)))
...
(assert (forall ((this@@3 T@U) (b_1@@3 Bool) ) (!  (=> (= (type this@@3) RefType) (= (getPredWandId (valid this@@3 b_1@@3)) 0))
 :qid |stdinbpl.829:15|
 :skolemid |120|
 :pattern ( (valid this@@3 b_1@@3))
)))
...
(assert (forall ((this@@4 T@U) (b_1@@4 Bool) ) (!  (=> (= (type this@@4) RefType) (= (PredicateMaskField (valid this@@4 b_1@@4)) (|valid#sm| this@@4 b_1@@4)))
 :qid |stdinbpl.821:15|
 :skolemid |118|
 :pattern ( (PredicateMaskField (valid this@@4 b_1@@4)))
)))
...
(declare-fun xs () T@U)
(declare-fun invRecv18 (T@U Bool) T@U)
(declare-fun qpRange18 (T@U Bool) Bool)
(declare-fun QPMask@0 () T@U)
(declare-fun neverTriggered17 (T@U) Bool)
(declare-fun Mask@0 () T@U)
(declare-fun invRecv17 (T@U Bool) T@U)
(declare-fun qpRange17 (T@U Bool) Bool)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type UnfoldingMask@4) (MapType1Type RefType realType)) (= (type Mask@6) (MapType1Type RefType realType))) (= (type this@@5) RefType)) (= (type UnfoldingMask@5) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@8) (MapType1Type RefType realType))) (= (type Mask@7) (MapType1Type RefType realType))) (forall ((arg0@@54 T@U) ) (! (= (type (FrameFragment arg0@@54)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@54))
))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Heap@7) (MapType0Type RefType))) (= (type Heap@6) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type UnfoldingMask@6) (MapType1Type RefType realType))) (= (type PostMask@1) (MapType1Type RefType realType))) (= (type UnfoldingMask@7) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (= (type UnfoldingMask@3) (MapType1Type RefType realType))) (= (type xs) (SeqType RefType))) (forall ((arg0@@55 T@U) (arg1@@31 Bool) ) (! (= (type (invRecv18 arg0@@55 arg1@@31)) RefType)
 :qid |funType:invRecv18|
 :pattern ( (invRecv18 arg0@@55 arg1@@31))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (forall ((arg0@@56 T@U) (arg1@@32 Bool) ) (! (= (type (invRecv17 arg0@@56 arg1@@32)) RefType)
 :qid |funType:invRecv17|
 :pattern ( (invRecv17 arg0@@56 arg1@@32))
))))
(set-info :boogie-vc-id t3a)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 52) (let ((anon9_correct  (=> (and (= UnfoldingMask@6 (MapType1Store PostMask@1 null (valid this@@5 false) (real_2_U (- (U_2_real (MapType1Select PostMask@1 null (valid this@@5 false))) FullPerm)))) (not (= this@@5 null))) (=> (and (and (= UnfoldingMask@7 (MapType1Store UnfoldingMask@6 this@@5 g (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@6 this@@5 g)) FullPerm)))) (state PostHeap@0 UnfoldingMask@7)) (and (state PostHeap@0 UnfoldingMask@7) (= (ControlFlow 0 37) (- 0 36)))) (HasDirectPerm UnfoldingMask@7 this@@5 g)))))
(let ((anon31_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 40) 37)) anon9_correct)))
(let ((anon31_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 38) (- 0 39)) (<= FullPerm (U_2_real (MapType1Select PostMask@1 null (valid this@@5 false))))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@1 null (valid this@@5 false)))) (=> (= (ControlFlow 0 38) 37) anon9_correct))))))
(let ((anon30_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (and (= PostMask@0 (MapType1Store ZeroMask null (valid this@@5 b_1@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid this@@5 b_1@@5))) FullPerm)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (= PostMask@1 (MapType1Store PostMask@0 null (valid this@@5  (not b_1@@5)) (real_2_U (+ (U_2_real (MapType1Select PostMask@0 null (valid this@@5  (not b_1@@5)))) FullPerm)))))) (and (and (state PostHeap@0 PostMask@1) (state PostHeap@0 PostMask@1)) (and (|valid#trigger| PostHeap@0 (valid this@@5 false)) (= (MapType0Select PostHeap@0 null (valid this@@5 false)) (FrameFragment (FrameFragment (MapType0Select PostHeap@0 this@@5 g))))))) (and (=> (= (ControlFlow 0 41) 38) anon31_Then_correct) (=> (= (ControlFlow 0 41) 40) anon31_Else_correct))))))
(let ((anon26_correct  (=> (and (= UnfoldingMask@4 (MapType1Store Mask@6 null (valid this@@5 false) (real_2_U (- (U_2_real (MapType1Select Mask@6 null (valid this@@5 false))) FullPerm)))) (not (= this@@5 null))) (=> (and (and (= UnfoldingMask@5 (MapType1Store UnfoldingMask@4 this@@5 g (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@4 this@@5 g)) FullPerm)))) (state ExhaleHeap@0 UnfoldingMask@5)) (and (state ExhaleHeap@0 UnfoldingMask@5) (= (ControlFlow 0 4) (- 0 3)))) (= (U_2_int (MapType0Select ExhaleHeap@0 this@@5 g)) 2)))))
(let ((anon39_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 4)) anon26_correct)))
(let ((anon39_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@6 null (valid this@@5 false))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@6 null (valid this@@5 false)))) (=> (= (ControlFlow 0 5) 4) anon26_correct))))))
(let ((anon24_correct  (=> (= Mask@8 (MapType1Store Mask@7 null (valid this@@5  (not b_1@@5)) (real_2_U (- (U_2_real (MapType1Select Mask@7 null (valid this@@5  (not b_1@@5)))) FullPerm)))) (=> (and (|valid#trigger| ExhaleHeap@0 (valid this@@5 false)) (= (MapType0Select ExhaleHeap@0 null (valid this@@5 false)) (FrameFragment (FrameFragment (MapType0Select ExhaleHeap@0 this@@5 g))))) (and (=> (= (ControlFlow 0 8) 5) anon39_Then_correct) (=> (= (ControlFlow 0 8) 7) anon39_Else_correct))))))
(let ((anon38_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon24_correct)))
(let ((anon38_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@7 null (valid this@@5  (not b_1@@5)))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@7 null (valid this@@5  (not b_1@@5))))) (=> (= (ControlFlow 0 9) 8) anon24_correct))))))
(let ((anon22_correct  (=> (= Mask@7 (MapType1Store Mask@6 null (valid this@@5 b_1@@5) (real_2_U (- (U_2_real (MapType1Select Mask@6 null (valid this@@5 b_1@@5))) FullPerm)))) (and (=> (= (ControlFlow 0 12) 9) anon38_Then_correct) (=> (= (ControlFlow 0 12) 11) anon38_Else_correct)))))
(let ((anon37_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 15) 12)) anon22_correct)))
(let ((anon37_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= FullPerm (U_2_real (MapType1Select Mask@6 null (valid this@@5 b_1@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@6 null (valid this@@5 b_1@@5)))) (=> (= (ControlFlow 0 13) 12) anon22_correct))))))
(let ((anon20_correct  (=> (= Mask@5 (MapType1Store Mask@4 this@@5 unrelatedField (real_2_U (- (U_2_real (MapType1Select Mask@4 this@@5 unrelatedField)) FullPerm)))) (=> (and (IdenticalOnKnownLocations Heap@7 ExhaleHeap@0 Mask@5) (not (= this@@5 null))) (=> (and (and (= Mask@6 (MapType1Store Mask@5 this@@5 unrelatedField (real_2_U (+ (U_2_real (MapType1Select Mask@5 this@@5 unrelatedField)) FullPerm)))) (state ExhaleHeap@0 Mask@6)) (and (state ExhaleHeap@0 Mask@6) (state ExhaleHeap@0 Mask@6))) (and (=> (= (ControlFlow 0 16) 13) anon37_Then_correct) (=> (= (ControlFlow 0 16) 15) anon37_Else_correct)))))))
(let ((anon36_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 19) 16)) anon20_correct)))
(let ((anon36_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (<= FullPerm (U_2_real (MapType1Select Mask@4 this@@5 unrelatedField)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 this@@5 unrelatedField))) (=> (= (ControlFlow 0 17) 16) anon20_correct))))))
(let ((anon18_correct  (=> (= Heap@7 (MapType0Store Heap@6 null (|valid#sm| this@@5 true) (MapType1Store (MapType0Select Heap@6 null (|valid#sm| this@@5 true)) this@@5 f_7 (bool_2_U true)))) (=> (and (state Heap@7 Mask@4) (state Heap@7 Mask@4)) (and (=> (= (ControlFlow 0 20) 17) anon36_Then_correct) (=> (= (ControlFlow 0 20) 19) anon36_Else_correct))))))
(let ((anon35_Else_correct  (=> (HasDirectPerm Mask@4 null (valid this@@5 true)) (=> (and (= Heap@6 Heap@3) (= (ControlFlow 0 22) 20)) anon18_correct))))
(let ((anon35_Then_correct  (=> (not (HasDirectPerm Mask@4 null (valid this@@5 true))) (=> (and (and (= Heap@4 (MapType0Store Heap@3 null (|valid#sm| this@@5 true) ZeroPMask)) (= Heap@5 (MapType0Store Heap@4 null (valid this@@5 true) freshVersion@0))) (and (= Heap@6 Heap@5) (= (ControlFlow 0 21) 20))) anon18_correct))))
(let ((anon16_correct  (=> (and (= Mask@3 (MapType1Store Mask@2 this@@5 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@2 this@@5 f_7)) FullPerm)))) (= Mask@4 (MapType1Store Mask@3 null (valid this@@5 true) (real_2_U (+ (U_2_real (MapType1Select Mask@3 null (valid this@@5 true))) FullPerm))))) (=> (and (and (state Heap@3 Mask@4) (state Heap@3 Mask@4)) (and (|valid#trigger| Heap@3 (valid this@@5 true)) (= (MapType0Select Heap@3 null (valid this@@5 true)) (FrameFragment (FrameFragment (MapType0Select Heap@3 this@@5 f_7)))))) (and (=> (= (ControlFlow 0 23) 21) anon35_Then_correct) (=> (= (ControlFlow 0 23) 22) anon35_Else_correct))))))
(let ((anon34_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 26) 23)) anon16_correct)))
(let ((anon34_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (<= FullPerm (U_2_real (MapType1Select Mask@2 this@@5 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 this@@5 f_7))) (=> (= (ControlFlow 0 24) 23) anon16_correct))))))
(let ((anon14_correct  (=> (not (= this@@5 null)) (=> (and (and (= Mask@2 (MapType1Store Mask@1 this@@5 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@1 this@@5 f_7)) FullPerm)))) (state Heap@2 Mask@2)) (and (state Heap@2 Mask@2) (state Heap@2 Mask@2))) (and (=> (= (ControlFlow 0 27) (- 0 28)) (= FullPerm (U_2_real (MapType1Select Mask@2 this@@5 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@2 this@@5 f_7))) (=> (and (= Heap@3 (MapType0Store Heap@2 this@@5 f_7 (int_2_U 1))) (state Heap@3 Mask@2)) (and (=> (= (ControlFlow 0 27) 24) anon34_Then_correct) (=> (= (ControlFlow 0 27) 26) anon34_Else_correct)))))))))
(let ((anon33_Else_correct  (=> (HasDirectPerm Mask@1 null (valid this@@5 true)) (=> (and (= Heap@2 Heap@0) (= (ControlFlow 0 30) 27)) anon14_correct))))
(let ((anon33_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (valid this@@5 true))) (= Heap@1 (MapType0Store Heap@0 null (valid this@@5 true) newVersion@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 29) 27))) anon14_correct)))
(let ((anon12_correct  (=> (= Mask@1 (MapType1Store QPMask@1 null (valid this@@5 true) (real_2_U (- (U_2_real (MapType1Select QPMask@1 null (valid this@@5 true))) FullPerm)))) (and (=> (= (ControlFlow 0 31) 29) anon33_Then_correct) (=> (= (ControlFlow 0 31) 30) anon33_Else_correct)))))
(let ((anon32_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 34) 31)) anon12_correct)))
(let ((anon32_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 32) (- 0 33)) (<= FullPerm (U_2_real (MapType1Select QPMask@1 null (valid this@@5 true))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@1 null (valid this@@5 true)))) (=> (= (ControlFlow 0 32) 31) anon12_correct))))))
(let ((anon30_Else_correct  (=> (and (|valid#trigger| Heap@0 (valid this@@5 true)) (= (MapType0Select Heap@0 null (valid this@@5 true)) (FrameFragment (FrameFragment (MapType0Select Heap@0 this@@5 f_7))))) (and (=> (= (ControlFlow 0 35) 32) anon32_Then_correct) (=> (= (ControlFlow 0 35) 34) anon32_Else_correct)))))
(let ((anon6_correct  (=> (= UnfoldingMask@0 (MapType1Store QPMask@1 null (valid this@@5 false) (real_2_U (- (U_2_real (MapType1Select QPMask@1 null (valid this@@5 false))) FullPerm)))) (=> (and (and (not (= this@@5 null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this@@5 g (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this@@5 g)) FullPerm))))) (and (state Heap@@10 UnfoldingMask@1) (state Heap@@10 UnfoldingMask@1))) (and (=> (= (ControlFlow 0 42) (- 0 43)) (HasDirectPerm UnfoldingMask@1 this@@5 g)) (=> (HasDirectPerm UnfoldingMask@1 this@@5 g) (=> (= Heap@0 (MapType0Store Heap@@10 null (|valid#sm| this@@5 false) (MapType1Store (MapType0Select Heap@@10 null (|valid#sm| this@@5 false)) this@@5 g (bool_2_U true)))) (=> (and (state Heap@0 QPMask@1) (|valid#trigger| Heap@0 (valid this@@5 false))) (=> (and (and (and (= (MapType0Select Heap@0 null (valid this@@5 false)) (FrameFragment (FrameFragment (MapType0Select Heap@0 this@@5 g)))) (= UnfoldingMask@2 (MapType1Store QPMask@1 null (valid this@@5 false) (real_2_U (- (U_2_real (MapType1Select QPMask@1 null (valid this@@5 false))) FullPerm))))) (and (not (= this@@5 null)) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 this@@5 g (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 this@@5 g)) FullPerm)))))) (and (and (state Heap@0 UnfoldingMask@3) (state Heap@0 UnfoldingMask@3)) (and (= (U_2_int (MapType0Select Heap@0 this@@5 g)) 2) (state Heap@0 QPMask@1)))) (and (=> (= (ControlFlow 0 42) 41) anon30_Then_correct) (=> (= (ControlFlow 0 42) 35) anon30_Else_correct)))))))))))
(let ((anon29_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 46) 42)) anon6_correct)))
(let ((anon29_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 44) (- 0 45)) (<= FullPerm (U_2_real (MapType1Select QPMask@1 null (valid this@@5 false))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@1 null (valid this@@5 false)))) (=> (= (ControlFlow 0 44) 42) anon6_correct))))))
(let ((anon28_Else_correct  (and (=> (= (ControlFlow 0 47) (- 0 48)) (forall ((x_4 T@U) (x_4_1 T@U) ) (!  (=> (and (= (type x_4) RefType) (= (type x_4_1) RefType)) (=> (and (and (and (and (not (= x_4 x_4_1)) (|Seq#Contains| xs x_4)) (|Seq#Contains| xs x_4_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= x_4 x_4_1)) (=  (not b_1@@5)  (not (not b_1@@5))))))
 :qid |stdinbpl.2866:17|
 :skolemid |229|
 :pattern ( (neverTriggered18 x_4) (neverTriggered18 x_4_1))
))) (=> (forall ((x_4@@0 T@U) (x_4_1@@0 T@U) ) (!  (=> (and (= (type x_4@@0) RefType) (= (type x_4_1@@0) RefType)) (=> (and (and (and (and (not (= x_4@@0 x_4_1@@0)) (|Seq#Contains| xs x_4@@0)) (|Seq#Contains| xs x_4_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= x_4@@0 x_4_1@@0)) (=  (not b_1@@5)  (not (not b_1@@5))))))
 :qid |stdinbpl.2866:17|
 :skolemid |229|
 :pattern ( (neverTriggered18 x_4@@0) (neverTriggered18 x_4_1@@0))
)) (=> (forall ((x_4@@1 T@U) ) (!  (=> (= (type x_4@@1) RefType) (=> (and (|Seq#Contains| xs x_4@@1) (< NoPerm FullPerm)) (and (= (invRecv18 x_4@@1  (not b_1@@5)) x_4@@1) (qpRange18 x_4@@1  (not b_1@@5)))))
 :qid |stdinbpl.2872:22|
 :skolemid |230|
 :pattern ( (|Seq#ContainsTrigger| xs x_4@@1))
 :pattern ( (|Seq#Contains| xs x_4@@1))
)) (=> (and (and (and (forall ((this_2_1 T@U) (b_2_1 Bool) ) (!  (=> (= (type this_2_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv18 this_2_1 b_2_1)) (< NoPerm FullPerm)) (qpRange18 this_2_1 b_2_1)) (and (= (invRecv18 this_2_1 b_2_1) this_2_1) (=  (not b_1@@5) b_2_1))))
 :qid |stdinbpl.2876:22|
 :skolemid |231|
 :pattern ( (invRecv18 this_2_1 b_2_1))
)) (forall ((this_2_1@@0 T@U) (b_2_1@@0 Bool) ) (!  (=> (= (type this_2_1@@0) RefType) (=> (and (and (|Seq#Contains| xs (invRecv18 this_2_1@@0 b_2_1@@0)) (< NoPerm FullPerm)) (qpRange18 this_2_1@@0 b_2_1@@0)) (and (=> (< NoPerm FullPerm) (and (= (invRecv18 this_2_1@@0 b_2_1@@0) this_2_1@@0) (=  (not b_1@@5) b_2_1@@0))) (= (U_2_real (MapType1Select QPMask@1 null (valid this_2_1@@0 b_2_1@@0))) (+ (U_2_real (MapType1Select QPMask@0 null (valid this_2_1@@0 b_2_1@@0))) FullPerm)))))
 :qid |stdinbpl.2882:22|
 :skolemid |232|
 :pattern ( (MapType1Select QPMask@1 null (valid this_2_1@@0 b_2_1@@0)))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.2888:29|
 :skolemid |233|
 :pattern ( (MapType1Select QPMask@0 o_3 f_5))
 :pattern ( (MapType1Select QPMask@1 o_3 f_5))
)) (forall ((this_2_1@@1 T@U) (b_2_1@@1 Bool) ) (!  (=> (and (= (type this_2_1@@1) RefType) (not (and (and (|Seq#Contains| xs (invRecv18 this_2_1@@1 b_2_1@@1)) (< NoPerm FullPerm)) (qpRange18 this_2_1@@1 b_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@1 null (valid this_2_1@@1 b_2_1@@1))) (U_2_real (MapType1Select QPMask@0 null (valid this_2_1@@1 b_2_1@@1)))))
 :qid |stdinbpl.2892:22|
 :skolemid |234|
 :pattern ( (MapType1Select QPMask@1 null (valid this_2_1@@1 b_2_1@@1)))
)))) (and (and (state Heap@@10 QPMask@1) (state Heap@@10 QPMask@1)) (and (|valid#trigger| Heap@@10 (valid this@@5 false)) (= (MapType0Select Heap@@10 null (valid this@@5 false)) (FrameFragment (FrameFragment (MapType0Select Heap@@10 this@@5 g))))))) (and (=> (= (ControlFlow 0 47) 44) anon29_Then_correct) (=> (= (ControlFlow 0 47) 46) anon29_Else_correct))))))))
(let ((anon28_Then_correct true))
(let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 49) (- 0 50)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| xs x_1)) (|Seq#Contains| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= x_1 x_1_1)) (= b_1@@5  (not b_1@@5)))))
 :qid |stdinbpl.2824:17|
 :skolemid |223|
 :pattern ( (neverTriggered17 x_1) (neverTriggered17 x_1_1))
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (|Seq#Contains| xs x_1@@0)) (|Seq#Contains| xs x_1_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= x_1@@0 x_1_1@@0)) (= b_1@@5  (not b_1@@5)))))
 :qid |stdinbpl.2824:17|
 :skolemid |223|
 :pattern ( (neverTriggered17 x_1@@0) (neverTriggered17 x_1_1@@0))
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| xs x_1@@1) (< NoPerm FullPerm)) (and (= (invRecv17 x_1@@1 b_1@@5) x_1@@1) (qpRange17 x_1@@1 b_1@@5))))
 :qid |stdinbpl.2830:22|
 :skolemid |224|
 :pattern ( (MapType0Select Heap@@10 null (valid x_1@@1 b_1@@5)))
 :pattern ( (MapType1Select Mask@0 null (valid x_1@@1 b_1@@5)))
 :pattern ( (|Seq#ContainsTrigger| xs x_1@@1))
 :pattern ( (|Seq#Contains| xs x_1@@1))
)) (=> (and (forall ((this_1_1 T@U) (b_1_1 Bool) ) (!  (=> (= (type this_1_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv17 this_1_1 b_1_1)) (< NoPerm FullPerm)) (qpRange17 this_1_1 b_1_1)) (and (= (invRecv17 this_1_1 b_1_1) this_1_1) (= b_1@@5 b_1_1))))
 :qid |stdinbpl.2834:22|
 :skolemid |225|
 :pattern ( (invRecv17 this_1_1 b_1_1))
)) (forall ((this_1_1@@0 T@U) (b_1_1@@0 Bool) ) (!  (=> (= (type this_1_1@@0) RefType) (=> (and (and (|Seq#Contains| xs (invRecv17 this_1_1@@0 b_1_1@@0)) (< NoPerm FullPerm)) (qpRange17 this_1_1@@0 b_1_1@@0)) (and (=> (< NoPerm FullPerm) (and (= (invRecv17 this_1_1@@0 b_1_1@@0) this_1_1@@0) (= b_1@@5 b_1_1@@0))) (= (U_2_real (MapType1Select QPMask@0 null (valid this_1_1@@0 b_1_1@@0))) (+ (U_2_real (MapType1Select Mask@0 null (valid this_1_1@@0 b_1_1@@0))) FullPerm)))))
 :qid |stdinbpl.2840:22|
 :skolemid |226|
 :pattern ( (MapType1Select QPMask@0 null (valid this_1_1@@0 b_1_1@@0)))
))) (=> (and (and (forall ((o_3@@0 T@U) (f_5@@0 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_5@@0))))
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@0) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (or (or (not (= o_3@@0 null)) (not (IsPredicateField f_5@@0))) (not (= (getPredWandId f_5@@0) 0)))) (= (U_2_real (MapType1Select Mask@0 o_3@@0 f_5@@0)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_5@@0))))))
 :qid |stdinbpl.2846:29|
 :skolemid |227|
 :pattern ( (MapType1Select Mask@0 o_3@@0 f_5@@0))
 :pattern ( (MapType1Select QPMask@0 o_3@@0 f_5@@0))
)) (forall ((this_1_1@@1 T@U) (b_1_1@@1 Bool) ) (!  (=> (and (= (type this_1_1@@1) RefType) (not (and (and (|Seq#Contains| xs (invRecv17 this_1_1@@1 b_1_1@@1)) (< NoPerm FullPerm)) (qpRange17 this_1_1@@1 b_1_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (valid this_1_1@@1 b_1_1@@1))) (U_2_real (MapType1Select Mask@0 null (valid this_1_1@@1 b_1_1@@1)))))
 :qid |stdinbpl.2850:22|
 :skolemid |228|
 :pattern ( (MapType1Select QPMask@0 null (valid this_1_1@@1 b_1_1@@1)))
))) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0))) (and (=> (= (ControlFlow 0 49) 2) anon28_Then_correct) (=> (= (ControlFlow 0 49) 47) anon28_Else_correct)))))))))
(let ((anon27_Then_correct true))
(let ((anon0_correct  (=> (and (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 this@@5 $allocated))) (and (|Seq#Contains| xs this@@5) (state Heap@@10 ZeroMask))) (and (and (not (= this@@5 null)) (= Mask@0 (MapType1Store ZeroMask this@@5 unrelatedField (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@5 unrelatedField)) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)))) (and (=> (= (ControlFlow 0 51) 1) anon27_Then_correct) (=> (= (ControlFlow 0 51) 49) anon27_Else_correct)))))
