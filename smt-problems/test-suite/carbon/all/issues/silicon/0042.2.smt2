...
(assert  (and (= (type Heap@@15) (MapType0Type RefType)) (= (type list@@10) RefType)))
(set-info :boogie-vc-id testFails1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@15 list@@10 $allocated)) (= (ControlFlow 0 2) (- 0 1)))) (not (= list@@10 null)))))
