...
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (> n 0)) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= 2 n)) (=> (<= 2 n) (and (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))))
