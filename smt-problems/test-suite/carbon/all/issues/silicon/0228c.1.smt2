...
(assert  (and (and (and (and (and (and (and (and (and (= (type Heap@1) (MapType0Type RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type x@@18) RefType)) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Heap@@17) (MapType0Type RefType))) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (forall ((arg0@@28 T@U) (arg1@@10 T@U) ) (! (= (type (CombineFrames arg0@@28 arg1@@10)) FrameTypeType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon15_correct true))
(let ((anon25_Else_correct  (=> (and (not (and (<= 0 i_3) (< i_3 10))) (= (ControlFlow 0 13) 10)) anon15_correct)))
(let ((anon25_Then_correct  (=> (and (<= 0 i_3) (< i_3 10)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (fun Heap@1 v_2@0 i_3)) (=> (fun Heap@1 v_2@0 i_3) (=> (= (ControlFlow 0 11) 10) anon15_correct))))))
(let ((anon23_Then_correct true))
(let ((anon11_correct true))
(let ((anon22_Then_correct  (=> (and (<= 0 i_7) (< i_7 10)) (and (=> (= (ControlFlow 0 9) 8) anon23_Then_correct) (=> (= (ControlFlow 0 9) 6) anon11_correct)))))
(let ((anon22_Else_correct  (=> (and (not (and (<= 0 i_7) (< i_7 10))) (= (ControlFlow 0 7) 6)) anon11_correct)))
(let ((anon24_Else_correct true))
(let ((anon18_Else_correct  (=> (forall ((i_1_1 Int) ) (!  (=> (and (<= 0 i_1_1) (< i_1_1 10)) (fun Heap@1 v_2@0 i_1_1))
 :qid |stdinbpl.770:20|
 :skolemid |39|
 :pattern ( (|fun#frame| EmptyFrame v_2@0 i_1_1))
)) (=> (and (state Heap@1 Mask@0) (state Heap@1 Mask@0)) (and (and (and (and (=> (= (ControlFlow 0 14) 5) anon24_Else_correct) (=> (= (ControlFlow 0 14) 11) anon25_Then_correct)) (=> (= (ControlFlow 0 14) 13) anon25_Else_correct)) (=> (= (ControlFlow 0 14) 9) anon22_Then_correct)) (=> (= (ControlFlow 0 14) 7) anon22_Else_correct))))))
(let ((anon20_Then_correct true))
(let ((anon6_correct true))
(let ((anon19_Then_correct  (=> (and (<= 0 i_6) (< i_6 10)) (and (=> (= (ControlFlow 0 4) 3) anon20_Then_correct) (=> (= (ControlFlow 0 4) 1) anon6_correct)))))
(let ((anon19_Else_correct  (=> (and (not (and (<= 0 i_6) (< i_6 10))) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon2_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (pred x@@18) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (pred x@@18))) FullPerm)))) (= perm@0 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 15) (- 0 18)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= x@@18 null))) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x@@18 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@18 f_7)) perm@0))))) (and (state Heap@@17 UnfoldingMask@1) (= perm@1 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 15) (- 0 17)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (and (=> (> perm@1 NoPerm) (not (= x@@18 null))) (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 x@@18 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 x@@18 f_7)) perm@1))))) (and (state Heap@@17 UnfoldingMask@2) (state Heap@@17 UnfoldingMask@2))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm UnfoldingMask@2 x@@18 f_7)) (=> (HasDirectPerm UnfoldingMask@2 x@@18 f_7) (=> (and (= Heap@0 (MapType0Store Heap@@17 null (|pred#sm| x@@18) (MapType1Store (MapType0Select Heap@@17 null (|pred#sm| x@@18)) x@@18 f_7 (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|pred#sm| x@@18) (MapType1Store (MapType0Select Heap@0 null (|pred#sm| x@@18)) x@@18 f_7 (bool_2_U true))))) (=> (and (and (state Heap@1 Mask@0) (= v_2@0 (U_2_int (MapType0Select Heap@1 x@@18 f_7)))) (and (state Heap@1 Mask@0) (state Heap@1 Mask@0))) (and (and (=> (= (ControlFlow 0 15) 14) anon18_Else_correct) (=> (= (ControlFlow 0 15) 4) anon19_Then_correct)) (=> (= (ControlFlow 0 15) 2) anon19_Else_correct)))))))))))))))
(let ((anon17_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 21) 15)) anon2_correct)))
(let ((anon17_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pred x@@18))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pred x@@18)))) (=> (= (ControlFlow 0 19) 15) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@17 x@@18 $allocated))) (and (= Mask@0 (MapType1Store ZeroMask null (pred x@@18) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (pred x@@18))) FullPerm)))) (state Heap@@17 Mask@0))) (and (and (state Heap@@17 Mask@0) (state Heap@@17 Mask@0)) (and (|pred#trigger| Heap@@17 (pred x@@18)) (= (MapType0Select Heap@@17 null (pred x@@18)) (CombineFrames (FrameFragment (MapType0Select Heap@@17 x@@18 f_7)) (FrameFragment (MapType0Select Heap@@17 x@@18 f_7))))))) (and (=> (= (ControlFlow 0 22) 19) anon17_Then_correct) (=> (= (ControlFlow 0 22) 21) anon17_Else_correct))))))
