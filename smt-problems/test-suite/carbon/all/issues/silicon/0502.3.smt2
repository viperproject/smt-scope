...
(assert  (and (and (and (and (and (and (and (= (type s@@3) (MapType2Type RefType boolType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv1 arg0@@43)) RefType)
 :qid |funType:invRecv1|
 :pattern ( (invRecv1 arg0@@43))
))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type r1) RefType)) (= (type r2) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id foo0)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select s@@3 x_1))) (U_2_bool (MapType2Select s@@3 x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.446:15|
 :skolemid |82|
 :no-pattern (type x_1)
...
)) (=> (and (and (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select s@@3 x_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 x_1@@1) (= (invRecv1 x_1@@1) x_1@@1))))
 :qid |stdinbpl.452:22|
 :skolemid |83|
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select s@@3 (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select Mask@1 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select s@@3 (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select Mask@1 o_3@@0 f_7))))))
 :qid |stdinbpl.468:22|
 :skolemid |86|
