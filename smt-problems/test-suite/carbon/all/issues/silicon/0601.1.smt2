...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (|Seq#Equal| (|Seq#Singleton| (int_2_U 555)) (|Seq#Singleton| (int_2_U 666))))) (=> (not (|Seq#Equal| (|Seq#Singleton| (int_2_U 555)) (|Seq#Singleton| (int_2_U 666)))) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) false))))))
