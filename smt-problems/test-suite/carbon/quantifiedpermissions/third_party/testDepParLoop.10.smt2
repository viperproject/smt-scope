...
(let ((anon12_correct  (=> (state Heap@3 Mask@6) (and (=> (= (ControlFlow 0 31) (- 0 35)) (<= 0 i@@34)) (=> (<= 0 i@@34) (and (=> (= (ControlFlow 0 31) (- 0 34)) (< i@@34 len)) (=> (< i@@34 len) (and (=> (= (ControlFlow 0 31) (- 0 33)) (= (|Seq#Length| ar@@27) len)) (=> (= (|Seq#Length| ar@@27) len) (=> (= perm@5 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 31) (- 0 32)) (>= perm@5 NoPerm)) (=> (>= perm@5 NoPerm) (and (=> (= (ControlFlow 0 31) 28) anon33_Then_correct) (=> (= (ControlFlow 0 31) 30) anon33_Else_correct))))))))))))))
