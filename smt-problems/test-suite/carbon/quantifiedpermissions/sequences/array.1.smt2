...
(declare-fun mutableArray () T@U)
(declare-fun wildcard () Real)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@6) (MapType1Type RefType realType)) (= (type freshObj@0) RefType)) (= (type ExhaleWellDef0Mask@0) (MapType1Type RefType realType))) (= (type ExhaleHeap@1) (MapType0Type RefType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@13) (MapType0Type RefType))) (= (type mutableArray) RefType)))
(set-info :boogie-vc-id caller)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (= (get ExhaleHeap@1 freshObj@0 0) 2))))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (> (U_2_real (MapType1Select Mask@6 freshObj@0 array)) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@6 freshObj@0 array)) NoPerm) (=> (> wildcard@3 NoPerm) (=> (and (< wildcard@3 (U_2_real (MapType1Select Mask@6 freshObj@0 array))) (= ExhaleWellDef0Mask@0 (MapType1Store Mask@6 freshObj@0 array (real_2_U (- (U_2_real (MapType1Select Mask@6 freshObj@0 array)) wildcard@3))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< 0 (|Seq#Length| (MapType0Select ExhaleHeap@1 freshObj@0 array)))) (=> (< 0 (|Seq#Length| (MapType0Select ExhaleHeap@1 freshObj@0 array))) (=> (= (ControlFlow 0 2) (- 0 1)) (> (U_2_real (MapType1Select ExhaleWellDef0Mask@0 (|Seq#Index| (MapType0Select ExhaleHeap@1 freshObj@0 array) 0) value)) NoPerm))))))))))
(let ((anon4_correct  (=> (and (= Mask@4 (MapType1Store Mask@3 (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) 0) value (real_2_U (- (U_2_real (MapType1Select Mask@3 (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) 0) value)) FullPerm)))) (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@1 Mask@4)) (=> (and (and (> wildcard@2 NoPerm) (not (= freshObj@0 null))) (and (= Mask@5 (MapType1Store Mask@4 freshObj@0 array (real_2_U (+ (U_2_real (MapType1Select Mask@4 freshObj@0 array)) wildcard@2)))) (state ExhaleHeap@1 Mask@5))) (=> (and (and (and (< 0 (|Seq#Length| (MapType0Select ExhaleHeap@1 freshObj@0 array))) (not (= (|Seq#Index| (MapType0Select ExhaleHeap@1 freshObj@0 array) 0) null))) (and (= Mask@6 (MapType1Store Mask@5 (|Seq#Index| (MapType0Select ExhaleHeap@1 freshObj@0 array) 0) value (real_2_U (+ (U_2_real (MapType1Select Mask@5 (|Seq#Index| (MapType0Select ExhaleHeap@1 freshObj@0 array) 0) value)) FullPerm)))) (state ExhaleHeap@1 Mask@6))) (and (and (< 0 (|Seq#Length| (MapType0Select ExhaleHeap@1 freshObj@0 array))) (= (U_2_int (MapType0Select ExhaleHeap@1 (|Seq#Index| (MapType0Select ExhaleHeap@1 freshObj@0 array) 0) value)) 2)) (and (state ExhaleHeap@1 Mask@6) (state ExhaleHeap@1 Mask@6)))) (and (=> (= (ControlFlow 0 7) 2) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 7)) anon4_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select Mask@3 (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) 0) value)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) 0) value))) (=> (= (ControlFlow 0 8) 7) anon4_correct))))))
(let ((anon2_correct  (=> (and (and (and (= Mask@1 (MapType1Store Mask@0 freshObj@0 array (real_2_U (- (U_2_real (MapType1Select Mask@0 freshObj@0 array)) FullPerm)))) (IdenticalOnKnownLocations Heap@0 ExhaleHeap@0 Mask@1)) (and (> wildcard@0 NoPerm) (not (= freshObj@0 null)))) (and (and (= Mask@2 (MapType1Store Mask@1 freshObj@0 array (real_2_U (+ (U_2_real (MapType1Select Mask@1 freshObj@0 array)) wildcard@0)))) (state ExhaleHeap@0 Mask@2)) (and (= (|Seq#Length| (MapType0Select ExhaleHeap@0 freshObj@0 array)) 5) (forall ((k_7 Int) (j_3 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 5) (int_2_U k_7)) (and (|Seq#Contains| (|Seq#Range| 0 5) (int_2_U j_3)) (not (= k_7 j_3)))) (not (= (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) k_7) (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) j_3))))
 :qid |stdinbpl.1190:22|
 :skolemid |83|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 5) (int_2_U k_7)) (|Seq#ContainsTrigger| (|Seq#Range| 0 5) (int_2_U j_3)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 5) (int_2_U k_7)) (|Seq#Contains| (|Seq#Range| 0 5) (int_2_U j_3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 5) (int_2_U k_7)) (|Seq#ContainsTrigger| (|Seq#Range| 0 5) (int_2_U j_3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 5) (int_2_U k_7)) (|Seq#Contains| (|Seq#Range| 0 5) (int_2_U j_3)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 5) (int_2_U k_7)) (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) j_3))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 5) (int_2_U k_7)) (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) j_3))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 5) (int_2_U j_3)) (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) k_7))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 5) (int_2_U j_3)) (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) k_7))
 :pattern ( (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) k_7) (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) j_3))
))))) (and (=> (= (ControlFlow 0 11) (- 0 14)) (forall ((k_1 Int) (k_1_1 Int) ) (!  (=> (and (and (and (and (not (= k_1 k_1_1)) (|Seq#Contains| (|Seq#Range| 0 5) (int_2_U k_1))) (|Seq#Contains| (|Seq#Range| 0 5) (int_2_U k_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) k_1) (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) k_1_1))))
 :qid |stdinbpl.1196:17|
 :skolemid |84|
))) (=> (forall ((k_1@@0 Int) (k_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_1@@0 k_1_1@@0)) (|Seq#Contains| (|Seq#Range| 0 5) (int_2_U k_1@@0))) (|Seq#Contains| (|Seq#Range| 0 5) (int_2_U k_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) k_1@@0) (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) k_1_1@@0))))
 :qid |stdinbpl.1196:17|
 :skolemid |84|
)) (=> (and (and (and (forall ((k_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 5) (int_2_U k_1@@1)) (< NoPerm FullPerm)) (and (qpRange4 (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) k_1@@1)) (= (invRecv4 (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) k_1@@1)) k_1@@1)))
 :qid |stdinbpl.1202:24|
 :skolemid |85|
 :pattern ( (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) k_1@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 5) (int_2_U k_1@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 5) (int_2_U k_1@@1)))
 :pattern ( (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) k_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 5) (int_2_U (invRecv4 o_3))) (< NoPerm FullPerm)) (qpRange4 o_3)) (= (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) (invRecv4 o_3)) o_3)))
 :qid |stdinbpl.1206:24|
 :skolemid |86|
 :pattern ( (invRecv4 o_3))
))) (and (forall ((k_1@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 5) (int_2_U k_1@@2)) (not (= (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) k_1@@2) null)))
 :qid |stdinbpl.1212:24|
 :skolemid |87|
 :pattern ( (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) k_1@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 5) (int_2_U k_1@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 5) (int_2_U k_1@@2)))
 :pattern ( (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) k_1@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 5) (int_2_U (invRecv4 o_3@@0))) (< NoPerm FullPerm)) (qpRange4 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| (MapType0Select ExhaleHeap@0 freshObj@0 array) (invRecv4 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 value)) (+ (U_2_real (MapType1Select Mask@2 o_3@@0 value)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 5) (int_2_U (invRecv4 o_3@@0))) (< NoPerm FullPerm)) (qpRange4 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 value)) (U_2_real (MapType1Select Mask@2 o_3@@0 value))))))
 :qid |stdinbpl.1218:24|
 :skolemid |88|
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 value))) (= (U_2_real (MapType1Select Mask@2 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.1222:31|
 :skolemid |89|
 :pattern ( (MapType1Select Mask@2 o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
)) (state ExhaleHeap@0 QPMask@0)) (and (state ExhaleHeap@0 QPMask@0) (state ExhaleHeap@0 QPMask@0)))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (> (U_2_real (MapType1Select QPMask@0 freshObj@0 array)) NoPerm)) (=> (> (U_2_real (MapType1Select QPMask@0 freshObj@0 array)) NoPerm) (=> (> wildcard@1 NoPerm) (=> (and (< wildcard@1 (U_2_real (MapType1Select QPMask@0 freshObj@0 array))) (= Mask@3 (MapType1Store QPMask@0 freshObj@0 array (real_2_U (- (U_2_real (MapType1Select QPMask@0 freshObj@0 array)) wildcard@1))))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< 0 (|Seq#Length| (MapType0Select ExhaleHeap@0 freshObj@0 array)))) (=> (< 0 (|Seq#Length| (MapType0Select ExhaleHeap@0 freshObj@0 array))) (and (=> (= (ControlFlow 0 11) 8) anon8_Then_correct) (=> (= (ControlFlow 0 11) 10) anon8_Else_correct))))))))))))))
(let ((anon7_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 17) 11)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 array)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 array))) (=> (= (ControlFlow 0 15) 11) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@13 mutableArray $allocated))) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@13 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@13 freshObj@0 $allocated (bool_2_U true)))) (and (= Mask@0 (MapType1Store ZeroMask freshObj@0 array (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 array)) FullPerm)))) (state Heap@0 Mask@0))) (and (=> (= (ControlFlow 0 18) 15) anon7_Then_correct) (=> (= (ControlFlow 0 18) 17) anon7_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (> wildcard NoPerm) true) (= (ControlFlow 0 19) 18)) anon0_correct)))
