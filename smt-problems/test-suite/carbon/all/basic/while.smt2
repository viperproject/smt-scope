...
(declare-fun r_1 () T@U)
(assert  (and (= (type Heap@@9) (MapType0Type RefType)) (= (type r_1) RefType)))
(set-info :boogie-vc-id t8)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Else_correct  (=> (and (and (not (< j@0 10)) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (>= j@0 10)) (=> (>= j@0 10) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 4) (- 0 3))) false))))))
(let ((anon6_Then_correct true))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 r_1 $allocated)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 2) anon6_Then_correct)) (=> (= (ControlFlow 0 6) 4) anon6_Else_correct))))))
