...
(assert  (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type y@@2) RefType)) (= (type xs) (SeqType RefType))) (= (type QPMask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test01_qp_client)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 y@@2 $allocated))) (and (|Seq#Contains| xs y@@2) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Seq#Contains| xs y@@2)) (=> (|Seq#Contains| xs y@@2) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((x@@11 T@U) (x_3 T@U) ) (!  (=> (and (= (type x@@11) RefType) (= (type x_3) RefType)) (=> (and (and (and (and (not (= x@@11 x_3)) (|Seq#Contains| xs x@@11)) (|Seq#Contains| xs x_3)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@11 x_3))))
 :qid |stdinbpl.789:19|
 :skolemid |64|
 :pattern ( (neverTriggered2 x@@11) (neverTriggered2 x_3))
))) (=> (forall ((x@@12 T@U) (x_3@@0 T@U) ) (!  (=> (and (= (type x@@12) RefType) (= (type x_3@@0) RefType)) (=> (and (and (and (and (not (= x@@12 x_3@@0)) (|Seq#Contains| xs x@@12)) (|Seq#Contains| xs x_3@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@12 x_3@@0))))
 :qid |stdinbpl.789:19|
 :skolemid |64|
 :pattern ( (neverTriggered2 x@@12) (neverTriggered2 x_3@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((x@@13 T@U) ) (!  (=> (and (= (type x@@13) RefType) (|Seq#Contains| xs x@@13)) (>= (U_2_real (MapType1Select ZeroMask x@@13 f_7)) FullPerm))
 :qid |stdinbpl.796:19|
 :skolemid |65|
 :pattern ( (MapType0Select Heap@@9 x@@13 f_7))
 :pattern ( (MapType1Select QPMask@0 x@@13 f_7))
