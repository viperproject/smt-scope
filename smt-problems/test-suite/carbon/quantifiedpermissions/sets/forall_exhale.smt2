...
(assert  (and (and (and (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type xs) (MapType2Type RefType boolType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv25 arg0@@43)) RefType)
 :qid |funType:invRecv25|
 :pattern ( (invRecv25 arg0@@43))
))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv24 arg0@@44)) RefType)
 :qid |funType:invRecv24|
 :pattern ( (invRecv24 arg0@@44))
))))
(set-info :boogie-vc-id t7)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (forall ((y_1 T@U) (y_1_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (= (type y_1_1) RefType)) (=> (and (and (and (and (not (= y_1 y_1_1)) (U_2_bool (MapType2Select xs y_1))) (U_2_bool (MapType2Select xs y_1_1))) (< NoPerm (/ (to_real 1) (to_real 3)))) (< NoPerm (/ (to_real 1) (to_real 3)))) (not (= y_1 y_1_1))))
...
))) (=> (forall ((y_1@@0 T@U) (y_1_1@@0 T@U) ) (!  (=> (and (= (type y_1@@0) RefType) (= (type y_1_1@@0) RefType)) (=> (and (and (and (and (not (= y_1@@0 y_1_1@@0)) (U_2_bool (MapType2Select xs y_1@@0))) (U_2_bool (MapType2Select xs y_1_1@@0))) (< NoPerm (/ (to_real 1) (to_real 3)))) (< NoPerm (/ (to_real 1) (to_real 3)))) (not (= y_1@@0 y_1_1@@0))))
 :qid |stdinbpl.1856:15|
 :skolemid |229|
...
)) (=> (forall ((y_1@@1 T@U) ) (!  (=> (= (type y_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs y_1@@1)) (< NoPerm (/ (to_real 1) (to_real 3)))) (and (qpRange25 y_1@@1) (= (invRecv25 y_1@@1) y_1@@1))))
 :qid |stdinbpl.1862:22|
 :skolemid |230|
 :pattern ( (MapType0Select PostHeap@0 y_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@2 y_1@@1 f_7))
 :pattern ( (MapType2Select xs y_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv25 o_3))) (< NoPerm (/ (to_real 1) (to_real 3)))) (qpRange25 o_3)) (= (invRecv25 o_3) o_3)))
 :qid |stdinbpl.1866:22|
 :skolemid |231|
 :pattern ( (invRecv25 o_3))
)) (= (ControlFlow 0 8) (- 0 7))) (forall ((y_1@@2 T@U) ) (!  (=> (and (= (type y_1@@2) RefType) (U_2_bool (MapType2Select xs y_1@@2))) (>= (/ (to_real 1) (to_real 3)) NoPerm))
 :qid |stdinbpl.1872:15|
 :skolemid |232|
 :pattern ( (MapType0Select PostHeap@0 y_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@2 y_1@@2 f_7))
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((y_2 T@U) ) (!  (=> (= (type y_2) RefType) (=> (and (U_2_bool (MapType2Select xs y_2)) (dummyFunction (MapType0Select Heap@@9 y_2 f_7))) (>= (/ (to_real 1) (to_real 3)) NoPerm)))
 :qid |stdinbpl.1906:17|
 :skolemid |236|
 :pattern ( (MapType0Select Heap@@9 y_2 f_7))
 :pattern ( (MapType1Select QPMask@1 y_2 f_7))
 :pattern ( (MapType2Select xs y_2))
))) (=> (forall ((y_2@@0 T@U) ) (!  (=> (= (type y_2@@0) RefType) (=> (and (U_2_bool (MapType2Select xs y_2@@0)) (dummyFunction (MapType0Select Heap@@9 y_2@@0 f_7))) (>= (/ (to_real 1) (to_real 3)) NoPerm)))
 :qid |stdinbpl.1906:17|
 :skolemid |236|
 :pattern ( (MapType0Select Heap@@9 y_2@@0 f_7))
 :pattern ( (MapType1Select QPMask@1 y_2@@0 f_7))
 :pattern ( (MapType2Select xs y_2@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((y_2@@1 T@U) (y_2_1 T@U) ) (!  (=> (and (= (type y_2@@1) RefType) (= (type y_2_1) RefType)) (=> (and (and (and (and (not (= y_2@@1 y_2_1)) (U_2_bool (MapType2Select xs y_2@@1))) (U_2_bool (MapType2Select xs y_2_1))) (< NoPerm (/ (to_real 1) (to_real 3)))) (< NoPerm (/ (to_real 1) (to_real 3)))) (not (= y_2@@1 y_2_1))))
 :qid |stdinbpl.1913:17|
 :skolemid |237|
 :pattern ( (neverTriggered26 y_2@@1) (neverTriggered26 y_2_1))
))) (=> (forall ((y_2@@2 T@U) (y_2_1@@0 T@U) ) (!  (=> (and (= (type y_2@@2) RefType) (= (type y_2_1@@0) RefType)) (=> (and (and (and (and (not (= y_2@@2 y_2_1@@0)) (U_2_bool (MapType2Select xs y_2@@2))) (U_2_bool (MapType2Select xs y_2_1@@0))) (< NoPerm (/ (to_real 1) (to_real 3)))) (< NoPerm (/ (to_real 1) (to_real 3)))) (not (= y_2@@2 y_2_1@@0))))
 :qid |stdinbpl.1913:17|
 :skolemid |237|
 :pattern ( (neverTriggered26 y_2@@2) (neverTriggered26 y_2_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((y_2@@3 T@U) ) (!  (=> (and (= (type y_2@@3) RefType) (U_2_bool (MapType2Select xs y_2@@3))) (>= (U_2_real (MapType1Select QPMask@0 y_2@@3 f_7)) (/ (to_real 1) (to_real 3))))
 :qid |stdinbpl.1920:17|
 :skolemid |238|
 :pattern ( (MapType0Select Heap@@9 y_2@@3 f_7))
 :pattern ( (MapType1Select QPMask@1 y_2@@3 f_7))
 :pattern ( (MapType2Select xs y_2@@3))
)))))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 13)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select xs x_1))) (U_2_bool (MapType2Select xs x_1_1))) (< NoPerm (/ (to_real 1) (to_real 3)))) (< NoPerm (/ (to_real 1) (to_real 3)))) (not (= x_1 x_1_1))))
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (U_2_bool (MapType2Select xs x_1@@0))) (U_2_bool (MapType2Select xs x_1_1@@0))) (< NoPerm (/ (to_real 1) (to_real 3)))) (< NoPerm (/ (to_real 1) (to_real 3)))) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.1799:15|
 :skolemid |222|
...
)) (=> (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs x_1@@1)) (< NoPerm (/ (to_real 1) (to_real 3)))) (and (qpRange24 x_1@@1) (= (invRecv24 x_1@@1) x_1@@1))))
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv24 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 3)))) (qpRange24 o_3@@0)) (= (invRecv24 o_3@@0) o_3@@0)))
 :qid |stdinbpl.1809:22|
 :skolemid |224|
 :pattern ( (invRecv24 o_3@@0))
))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (U_2_bool (MapType2Select xs x_1@@2))) (>= (/ (to_real 1) (to_real 3)) NoPerm))
...
))) (=> (forall ((x_1@@3 T@U) ) (!  (=> (and (= (type x_1@@3) RefType) (U_2_bool (MapType2Select xs x_1@@3))) (>= (/ (to_real 1) (to_real 3)) NoPerm))
 :qid |stdinbpl.1815:15|
 :skolemid |225|
 :pattern ( (MapType0Select Heap@@9 x_1@@3 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@3 f_7))
 :pattern ( (MapType2Select xs x_1@@3))
)) (=> (forall ((x_1@@4 T@U) ) (!  (=> (= (type x_1@@4) RefType) (=> (and (U_2_bool (MapType2Select xs x_1@@4)) (> (/ (to_real 1) (to_real 3)) NoPerm)) (not (= x_1@@4 null))))
...
)) (=> (and (and (forall ((o_3@@1 T@U) ) (!  (=> (= (type o_3@@1) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs (invRecv24 o_3@@1))) (< NoPerm (/ (to_real 1) (to_real 3)))) (qpRange24 o_3@@1)) (and (=> (< NoPerm (/ (to_real 1) (to_real 3))) (= (invRecv24 o_3@@1) o_3@@1)) (= (U_2_real (MapType1Select QPMask@0 o_3@@1 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@1 f_7)) (/ (to_real 1) (to_real 3)))))) (=> (not (and (and (U_2_bool (MapType2Select xs (invRecv24 o_3@@1))) (< NoPerm (/ (to_real 1) (to_real 3)))) (qpRange24 o_3@@1))) (= (U_2_real (MapType1Select QPMask@0 o_3@@1 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@1 f_7))))))
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 11) 10) anon8_Then_correct) (=> (= (ControlFlow 0 11) 3) anon8_Else_correct)))))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 14) 1) anon7_Then_correct) (=> (= (ControlFlow 0 14) 11) anon7_Else_correct)))))
