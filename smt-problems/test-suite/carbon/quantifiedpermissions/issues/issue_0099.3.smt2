...
(let ((anon19_Else_correct  (=> (and (not (and (<= 0 i_9) (and (< i_9 (|Seq#Length| xs)) (fun01 Heap@@13 i_9 b_2@@3)))) (= (ControlFlow 0 15) 11)) anon11_correct)))
(let ((anon19_Then_correct  (=> (and (<= 0 i_9) (and (< i_9 (|Seq#Length| xs)) (fun01 Heap@@13 i_9 b_2@@3))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= i_9 0)) (=> (>= i_9 0) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< i_9 (|Seq#Length| xs))) (=> (< i_9 (|Seq#Length| xs)) (=> (= (ControlFlow 0 12) 11) anon11_correct))))))))
(let ((anon17_Then_correct  (=> (< i_9 (|Seq#Length| xs)) (and (and (=> (= (ControlFlow 0 19) 18) anon18_Then_correct) (=> (= (ControlFlow 0 19) 12) anon19_Then_correct)) (=> (= (ControlFlow 0 19) 15) anon19_Else_correct)))))
(let ((anon17_Else_correct  (=> (<= (|Seq#Length| xs) i_9) (and (=> (= (ControlFlow 0 17) 12) anon19_Then_correct) (=> (= (ControlFlow 0 17) 15) anon19_Else_correct)))))
(let ((anon16_Then_correct  (=> (<= 0 i_9) (and (=> (= (ControlFlow 0 20) 19) anon17_Then_correct) (=> (= (ControlFlow 0 20) 17) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (< i_9 0) (and (=> (= (ControlFlow 0 16) 12) anon19_Then_correct) (=> (= (ControlFlow 0 16) 15) anon19_Else_correct)))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (and (< i_1 (|Seq#Length| xs)) (fun01 Heap@@13 i_1 b_2@@3)))) (and (<= 0 i_1_1) (and (< i_1_1 (|Seq#Length| xs)) (fun01 Heap@@13 i_1_1 b_2@@3)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_1) (|Seq#Index| xs i_1_1))))
 :qid |stdinbpl.1236:15|
 :skolemid |102|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= 0 i_1@@0) (and (< i_1@@0 (|Seq#Length| xs)) (fun01 Heap@@13 i_1@@0 b_2@@3)))) (and (<= 0 i_1_1@@0) (and (< i_1_1@@0 (|Seq#Length| xs)) (fun01 Heap@@13 i_1_1@@0 b_2@@3)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_1@@0) (|Seq#Index| xs i_1_1@@0))))
 :qid |stdinbpl.1236:15|
 :skolemid |102|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (and (< i_1@@1 (|Seq#Length| xs)) (fun01 Heap@@13 i_1@@1 b_2@@3))) (< NoPerm FullPerm)) (and (qpRange7 (|Seq#Index| xs i_1@@1)) (= (invRecv7 (|Seq#Index| xs i_1@@1)) i_1@@1)))
 :qid |stdinbpl.1242:22|
 :skolemid |103|
 :pattern ( (|Seq#Index| xs i_1@@1))
 :pattern ( (|fun01#frame| EmptyFrame i_1@@1 b_2@@3))
 :pattern ( (|Seq#Index| xs i_1@@1))
)) (=> (and (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv7 o_3)) (and (< (invRecv7 o_3) (|Seq#Length| xs)) (fun01 Heap@@13 (invRecv7 o_3) b_2@@3))) (< NoPerm FullPerm)) (qpRange7 o_3)) (= (|Seq#Index| xs (invRecv7 o_3)) o_3)))
 :qid |stdinbpl.1246:22|
 :skolemid |104|
 :pattern ( (invRecv7 o_3))
)) (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (and (< i_1@@2 (|Seq#Length| xs)) (fun01 Heap@@13 i_1@@2 b_2@@3))) (not (= (|Seq#Index| xs i_1@@2) null)))
 :qid |stdinbpl.1252:22|
 :skolemid |105|
 :pattern ( (|Seq#Index| xs i_1@@2))
 :pattern ( (|fun01#frame| EmptyFrame i_1@@2 b_2@@3))
 :pattern ( (|Seq#Index| xs i_1@@2))
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv7 o_3@@0)) (and (< (invRecv7 o_3@@0) (|Seq#Length| xs)) (fun01 Heap@@13 (invRecv7 o_3@@0) b_2@@3))) (< NoPerm FullPerm)) (qpRange7 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| xs (invRecv7 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv7 o_3@@0)) (and (< (invRecv7 o_3@@0) (|Seq#Length| xs)) (fun01 Heap@@13 (invRecv7 o_3@@0) b_2@@3))) (< NoPerm FullPerm)) (qpRange7 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
)))) (and (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)) (and (state Heap@@13 QPMask@0) (= (ControlFlow 0 9) (- 0 8))))) b_2@@3))))))
(let ((anon13_Else_correct  (=> (and (and (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (<= 0 i1_1) (and (< i1_1 (|Seq#Length| xs)) (and (<= 0 i2_1) (and (< i2_1 (|Seq#Length| xs)) (not (= i1_1 i2_1)))))) (not (= (|Seq#Index| xs i1_1) (|Seq#Index| xs i2_1))))
 :qid |stdinbpl.1203:20|
 :skolemid |101|
 :pattern ( (|Seq#Index| xs i1_1) (|Seq#Index| xs i2_1))
)) (state Heap@@13 ZeroMask)) (and (state Heap@@13 ZeroMask) (state Heap@@13 ZeroMask))) (and (and (=> (= (ControlFlow 0 21) 9) anon15_Else_correct) (=> (= (ControlFlow 0 21) 20) anon16_Then_correct)) (=> (= (ControlFlow 0 21) 16) anon16_Else_correct)))))
(let ((anon3_correct true))
(let ((anon14_Else_correct  (=> (and (not (and (<= 0 i1_4) (and (< i1_4 (|Seq#Length| xs)) (and (<= 0 i2_4) (and (< i2_4 (|Seq#Length| xs)) (not (= i1_4 i2_4))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon14_Then_correct  (=> (and (<= 0 i1_4) (and (< i1_4 (|Seq#Length| xs)) (and (<= 0 i2_4) (and (< i2_4 (|Seq#Length| xs)) (not (= i1_4 i2_4)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_4 0)) (=> (>= i1_4 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_4 (|Seq#Length| xs))) (=> (< i1_4 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_4 0)) (=> (>= i2_4 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_4 (|Seq#Length| xs))) (=> (< i2_4 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (< 10 (|Seq#Length| xs))) (and (state Heap@@13 ZeroMask) (state Heap@@13 ZeroMask))) (and (and (=> (= (ControlFlow 0 22) 21) anon13_Else_correct) (=> (= (ControlFlow 0 22) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 22) 7) anon14_Else_correct))))))
