...
(assert  (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type x2) RefType)) (= (type x@@16) RefType)) (= (type Heap@@20) (MapType0Type RefType))))
...
(let ((anon10_Then_correct  (=> (HasDirectPerm Mask@1 x2 f_7) (and (=> (= (ControlFlow 0 6) (- 0 8)) (HasDirectPerm Mask@1 x2 f_7)) (=> (HasDirectPerm Mask@1 x2 f_7) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm Mask@1 x2 f_7)) (=> (HasDirectPerm Mask@1 x2 f_7) (and (=> (= (ControlFlow 0 6) 5) anon11_Then_correct) (=> (= (ControlFlow 0 6) 3) anon6_correct)))))))))
(let ((anon10_Else_correct  (=> (and (not (HasDirectPerm Mask@1 x2 f_7)) (= (ControlFlow 0 4) 3)) anon6_correct)))
(let ((anon9_Else_correct true))
(let ((anon8_Else_correct  (=> (not (= x@@16 null)) (=> (and (and (= Mask@1 (MapType1Store ZeroMask x@@16 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@16 f_7)) FullPerm)))) (state Heap@@20 Mask@1)) (and (state Heap@@20 Mask@1) (state Heap@@20 Mask@1))) (and (and (=> (= (ControlFlow 0 9) 2) anon9_Else_correct) (=> (= (ControlFlow 0 9) 6) anon10_Then_correct)) (=> (= (ControlFlow 0 9) 4) anon10_Else_correct))))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@20 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@20 x@@16 $allocated)) (= AssumeFunctionsAbove 1)) (and (=> (= (ControlFlow 0 10) 1) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct))))))
