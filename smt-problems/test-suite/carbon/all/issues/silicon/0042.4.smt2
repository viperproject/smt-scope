...
(assert  (and (and (= (type Heap@@15) (MapType0Type RefType)) (= (type list@@10) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id testSuccess1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@15 list@@10 $allocated))) (and (> wildcard@0 NoPerm) (not (= list@@10 null)))) (and (and (= Mask@0 (MapType1Store ZeroMask list@@10 next (real_2_U (+ (U_2_real (MapType1Select ZeroMask list@@10 next)) wildcard@0)))) (state Heap@@15 Mask@0)) (and (state Heap@@15 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (not (= list@@10 null))))))
