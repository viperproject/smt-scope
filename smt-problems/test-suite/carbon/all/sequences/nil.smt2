...
(declare-fun bs1@0 () T@U)
(declare-fun bs2@0 () T@U)
(assert  (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type bs1@0) (SeqType boolType))) (= (type bs2@0) (SeqType boolType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (= bs1@0 (|Seq#Empty| boolType)) (state Heap@@9 ZeroMask)) (and (= bs2@0 (|Seq#Empty| boolType)) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Seq#Equal| bs1@0 bs2@0)) (=> (|Seq#Equal| bs1@0 bs2@0) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (|Seq#Length| bs1@0) 0))))))))
