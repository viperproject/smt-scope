...
(assert  (and (and (and (= (type hm_1@@9) HeapMatrixDomainTypeType) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@28) (MapType0Type RefType))) (forall ((arg0@@57 T@U) ) (! (= (type (invRecv6 arg0@@57)) RefType)
 :qid |funType:invRecv6|
 :pattern ( (invRecv6 arg0@@57))
))))
(set-info :boogie-vc-id |hm2m#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon5_correct true))
(let ((anon9_Else_correct  (=> (and (not (hm_in_range hm_1@@9 i_2 j_2)) (= (ControlFlow 0 6) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (hm_in_range hm_1@@9 i_2 j_2) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm QPMask@0 (loc hm_1@@9 i_2 j_2) cell_value)) (=> (HasDirectPerm QPMask@0 (loc hm_1@@9 i_2 j_2) cell_value) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
(let ((anon8_Else_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((cell_3 T@U) (cell_3_1 T@U) ) (!  (=> (and (= (type cell_3) RefType) (= (type cell_3_1) RefType)) (=> (and (and (and (and (not (= cell_3 cell_3_1)) (U_2_bool (MapType2Select (hm2set hm_1@@9) cell_3))) (U_2_bool (MapType2Select (hm2set hm_1@@9) cell_3_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= cell_3 cell_3_1))))
 :qid |stdinbpl.1080:15|
 :skolemid |143|
 :no-pattern (type cell_3)
 :no-pattern (type cell_3_1)
 :no-pattern (U_2_int cell_3)
 :no-pattern (U_2_bool cell_3)
 :no-pattern (U_2_int cell_3_1)
 :no-pattern (U_2_bool cell_3_1)
))) (=> (forall ((cell_3@@0 T@U) (cell_3_1@@0 T@U) ) (!  (=> (and (= (type cell_3@@0) RefType) (= (type cell_3_1@@0) RefType)) (=> (and (and (and (and (not (= cell_3@@0 cell_3_1@@0)) (U_2_bool (MapType2Select (hm2set hm_1@@9) cell_3@@0))) (U_2_bool (MapType2Select (hm2set hm_1@@9) cell_3_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= cell_3@@0 cell_3_1@@0))))
 :qid |stdinbpl.1080:15|
 :skolemid |143|
 :no-pattern (type cell_3@@0)
 :no-pattern (type cell_3_1@@0)
 :no-pattern (U_2_int cell_3@@0)
 :no-pattern (U_2_bool cell_3@@0)
 :no-pattern (U_2_int cell_3_1@@0)
 :no-pattern (U_2_bool cell_3_1@@0)
)) (=> (and (forall ((cell_3@@1 T@U) ) (!  (=> (= (type cell_3@@1) RefType) (=> (and (U_2_bool (MapType2Select (hm2set hm_1@@9) cell_3@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange6 cell_3@@1) (= (invRecv6 cell_3@@1) cell_3@@1))))
 :qid |stdinbpl.1086:22|
 :skolemid |144|
 :pattern ( (MapType0Select Heap@@28 cell_3@@1 cell_value))
 :pattern ( (MapType1Select QPMask@0 cell_3@@1 cell_value))
 :pattern ( (MapType2Select (hm2set hm_1@@9) cell_3@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select (hm2set hm_1@@9) (invRecv6 o_3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange6 o_3)) (= (invRecv6 o_3) o_3)))
 :qid |stdinbpl.1090:22|
 :skolemid |145|
 :pattern ( (invRecv6 o_3))
))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((cell_3@@2 T@U) ) (!  (=> (and (= (type cell_3@@2) RefType) (U_2_bool (MapType2Select (hm2set hm_1@@9) cell_3@@2))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1096:15|
 :skolemid |146|
 :pattern ( (MapType0Select Heap@@28 cell_3@@2 cell_value))
 :pattern ( (MapType1Select QPMask@0 cell_3@@2 cell_value))
 :pattern ( (MapType2Select (hm2set hm_1@@9) cell_3@@2))
))) (=> (forall ((cell_3@@3 T@U) ) (!  (=> (and (= (type cell_3@@3) RefType) (U_2_bool (MapType2Select (hm2set hm_1@@9) cell_3@@3))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.1096:15|
 :skolemid |146|
 :pattern ( (MapType0Select Heap@@28 cell_3@@3 cell_value))
 :pattern ( (MapType1Select QPMask@0 cell_3@@3 cell_value))
 :pattern ( (MapType2Select (hm2set hm_1@@9) cell_3@@3))
)) (=> (forall ((cell_3@@4 T@U) ) (!  (=> (= (type cell_3@@4) RefType) (=> (and (U_2_bool (MapType2Select (hm2set hm_1@@9) cell_3@@4)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= cell_3@@4 null))))
 :qid |stdinbpl.1102:22|
 :skolemid |147|
 :pattern ( (MapType0Select Heap@@28 cell_3@@4 cell_value))
 :pattern ( (MapType1Select QPMask@0 cell_3@@4 cell_value))
 :pattern ( (MapType2Select (hm2set hm_1@@9) cell_3@@4))
)) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select (hm2set hm_1@@9) (invRecv6 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange6 o_3@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv6 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 cell_value)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 cell_value)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (U_2_bool (MapType2Select (hm2set hm_1@@9) (invRecv6 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange6 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 cell_value)) (U_2_real (MapType1Select ZeroMask o_3@@0 cell_value))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.1112:29|
 :skolemid |149|
 :pattern ( (MapType1Select ZeroMask o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
))) (and (state Heap@@28 QPMask@0) (state Heap@@28 QPMask@0))) (and (and (=> (= (ControlFlow 0 7) 2) anon8_Else_correct) (=> (= (ControlFlow 0 7) 4) anon9_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@28 ZeroMask) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 10) 1) anon7_Then_correct) (=> (= (ControlFlow 0 10) 7) anon7_Else_correct)))))
