...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@3) (MapType0Type RefType)) (= (type Heap@2) (MapType0Type RefType))) (= (type x2) RefType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type x1@@7) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@54 T@U) ) (! (= (type (FrameFragment arg0@@54)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@54))
))) (= (type PostHeap@0) (MapType0Type RefType))) (forall ((arg0@@55 T@U) ) (! (= (type (invRecv12 arg0@@55)) RefType)
 :qid |funType:invRecv12|
 :pattern ( (invRecv12 arg0@@55))
))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id t2_b)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon13_Else_correct  (=> (= (ControlFlow 0 13) (- 0 12)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_3))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1))))
 :qid |stdinbpl.2331:17|
 :skolemid |198|
 :pattern ( (neverTriggered13 x_3) (neverTriggered13 x_3_1))
)))))
(let ((anon13_Then_correct true))
(let ((anon12_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 14) 11) anon13_Then_correct) (=> (= (ControlFlow 0 14) 13) anon13_Else_correct)))))
(let ((anon10_correct  (=> (= Heap@3 (MapType0Store Heap@2 null (|valid#sm| x2 false) (MapType1Store (MapType0Select Heap@2 null (|valid#sm| x2 false)) x2 g (bool_2_U true)))) (=> (and (state Heap@3 Mask@2) (state Heap@3 Mask@2)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_5 T@U) (x_5_1 T@U) ) (!  (=> (and (= (type x_5) RefType) (= (type x_5_1) RefType)) (=> (and (and (and (and (not (= x_5 x_5_1)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_5))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_5 x_5_1))))
 :qid |stdinbpl.2402:17|
 :skolemid |204|
 :pattern ( (neverTriggered14 x_5) (neverTriggered14 x_5_1))
 ...
 :qid |stdinbpl.2402:17|
 :skolemid |204|
 :pattern ( (neverTriggered14 x_5@@0) (neverTriggered14 x_5_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_5@@1 T@U) ) (!  (=> (and (= (type x_5@@1) RefType) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_5@@1))) (>= (U_2_real (MapType1Select Mask@2 null (valid x_5@@1 true))) FullPerm))
 :qid |stdinbpl.2409:17|
 :skolemid |205|
 :pattern ( (MapType0Select Heap@3 null (valid x_5@@1 true)))
 :pattern ( (MapType1Select Mask@2 null (valid x_5@@1 true)))
 :pattern ( (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_5@@1))
)))))))))
(let ((anon15_Else_correct  (=> (HasDirectPerm Mask@2 null (valid x2 false)) (=> (and (= Heap@2 Heap@@10) (= (ControlFlow 0 6) 3)) anon10_correct))))
(let ((anon15_Then_correct  (=> (not (HasDirectPerm Mask@2 null (valid x2 false))) (=> (and (and (= Heap@0 (MapType0Store Heap@@10 null (|valid#sm| x2 false) ZeroPMask)) (= Heap@1 (MapType0Store Heap@0 null (valid x2 false) freshVersion@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 5) 3))) anon10_correct))))
(let ((anon8_correct  (=> (and (= Mask@1 (MapType1Store QPMask@0 x2 g (real_2_U (- (U_2_real (MapType1Select QPMask@0 x2 g)) FullPerm)))) (= Mask@2 (MapType1Store Mask@1 null (valid x2 false) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (valid x2 false))) FullPerm))))) (=> (and (and (state Heap@@10 Mask@2) (state Heap@@10 Mask@2)) (and (|valid#trigger| Heap@@10 (valid x2 false)) (= (MapType0Select Heap@@10 null (valid x2 false)) (FrameFragment (FrameFragment (MapType0Select Heap@@10 x2 g)))))) (and (=> (= (ControlFlow 0 7) 5) anon15_Then_correct) (=> (= (ControlFlow 0 7) 6) anon15_Else_correct))))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 7)) anon8_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 x2 g)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 x2 g))) (=> (= (ControlFlow 0 8) 7) anon8_correct))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_1))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.2278:15|
 :skolemid |192|
 :no-pattern (type x_1)
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) x_1@@1)) (< NoPerm FullPerm)) (and (qpRange12 x_1@@1) (= (invRecv12 x_1@@1) x_1@@1))))
...
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) (invRecv12 o_3))) (< NoPerm FullPerm)) (qpRange12 o_3)) (= (invRecv12 o_3) o_3)))
...
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) (invRecv12 o_3@@0))) (< NoPerm FullPerm)) (qpRange12 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv12 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select Mask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2) x1@@7) (invRecv12 o_3@@0))) (< NoPerm FullPerm)) (qpRange12 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select Mask@0 o_3@@0 f_7))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.2304:29|
 :skolemid |197|
 :pattern ( (MapType1Select Mask@0 o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
))) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0))) (and (and (=> (= (ControlFlow 0 15) 14) anon12_Then_correct) (=> (= (ControlFlow 0 15) 8) anon14_Then_correct)) (=> (= (ControlFlow 0 15) 10) anon14_Else_correct)))))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 x1@@7 $allocated)) (U_2_bool (MapType0Select Heap@@10 x2 $allocated))) (=> (and (and (not (= x1@@7 null)) (= Mask@0 (MapType1Store ZeroMask x1@@7 unrelatedField (real_2_U (+ (U_2_real (MapType1Select ZeroMask x1@@7 unrelatedField)) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 17) 1) anon11_Then_correct) (=> (= (ControlFlow 0 17) 15) anon11_Else_correct)))))))
