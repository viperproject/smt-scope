...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (X this@@19) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (X this@@19))) FullPerm)))) (not (= this@@19 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this@@19 x@@8 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this@@19 x@@8)) FullPerm)))) (state Heap@@19 UnfoldingMask@1)) (and (state Heap@@19 UnfoldingMask@1) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm UnfoldingMask@1 this@@19 x@@8)))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (X this@@19))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (X this@@19)))) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@19 ZeroMask) (U_2_bool (MapType0Select Heap@@19 this@@19 $allocated))) (and (= AssumeFunctionsAbove 0) (= Mask@0 (MapType1Store ZeroMask null (X this@@19) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (X this@@19))) FullPerm)))))) (and (and (state Heap@@19 Mask@0) (state Heap@@19 Mask@0)) (and (|X#trigger| Heap@@19 (X this@@19)) (= (MapType0Select Heap@@19 null (X this@@19)) (FrameFragment (MapType0Select Heap@@19 this@@19 x@@8)))))) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))
