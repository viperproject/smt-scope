...
(assert  (and (and (and (and (and (and (and (and (= (type xs@@4) (MapType1Type RefType boolType)) (= (type Heap@@13) (MapType0Type RefType))) (= (type QPMask@1) (MapType2Type RefType realType))) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv4 arg0@@45)) RefType)
 :qid |funType:invRecv4|
 :pattern ( (invRecv4 arg0@@45))
))) (= (type x@@24) RefType)) (= (type QPMask@2) (MapType2Type RefType realType))) (forall ((arg0@@46 T@U) ) (! (= (type (invRecv5 arg0@@46)) RefType)
 :qid |funType:invRecv5|
 :pattern ( (invRecv5 arg0@@46))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 13) (- 0 12)) (= v_2@0 (fun Heap@@13 xs@@4 x@@24 n@@4)))))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 8) (- 0 11)) (forall ((z_3 T@U) (z_3_1 T@U) ) (!  (=> (and (= (type z_3) RefType) (= (type z_3_1) RefType)) (=> (and (and (and (and (not (= z_3 z_3_1)) (U_2_bool (MapType1Select xs@@4 z_3))) (U_2_bool (MapType1Select xs@@4 z_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_3 z_3_1))))
 ...
 :qid |stdinbpl.795:21|
 :skolemid |112|
 :pattern ( (MapType0Select Heap@@13 z_3@@1 f_7))
 ...
 :qid |stdinbpl.795:21|
 :skolemid |112|
 :pattern ( (MapType0Select Heap@@13 z_3@@2 f_7))
 :pattern ( (MapType2Select QPMask@2 z_3@@2 f_7))
 :pattern ( (MapType1Select xs@@4 z_3@@2))
)) (=> (and (and (forall ((z_3@@3 T@U) ) (!  (=> (= (type z_3@@3) RefType) (=> (and (U_2_bool (MapType1Select xs@@4 z_3@@3)) (< NoPerm FullPerm)) (and (qpRange5 z_3@@3) (= (invRecv5 z_3@@3) z_3@@3))))
 :qid |stdinbpl.801:26|
 :skolemid |113|
 :pattern ( (MapType0Select Heap@@13 z_3@@3 f_7))
 :pattern ( (MapType2Select QPMask@2 z_3@@3 f_7))
 :pattern ( (MapType1Select xs@@4 z_3@@3))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType1Select xs@@4 (invRecv5 o_3))) (and (< NoPerm FullPerm) (qpRange5 o_3))) (= (invRecv5 o_3) o_3)))
 :qid |stdinbpl.805:26|
 :skolemid |114|
 :pattern ( (invRecv5 o_3))
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType1Select xs@@4 (invRecv5 o_3@@0))) (and (< NoPerm FullPerm) (qpRange5 o_3@@0))) (and (= (invRecv5 o_3@@0) o_3@@0) (= (U_2_real (MapType2Select QPMask@2 o_3@@0 f_7)) (- (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType1Select xs@@4 (invRecv5 o_3@@0))) (and (< NoPerm FullPerm) (qpRange5 o_3@@0)))) (= (U_2_real (MapType2Select QPMask@2 o_3@@0 f_7)) (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7))))))
 :qid |stdinbpl.811:26|
 :skolemid |115|
...
(let ((anon8_Else_correct  (=> (and (= v_2@0 (fun Heap@@13 xs@@4 x@@24 n@@4)) (state Heap@@13 QPMask@0)) (and (=> (= (ControlFlow 0 14) 8) anon9_Then_correct) (=> (= (ControlFlow 0 14) 13) anon9_Else_correct)))))
...
)) (=> (and (and (forall ((z_2@@3 T@U) ) (!  (=> (= (type z_2@@3) RefType) (=> (and (U_2_bool (MapType1Select xs@@4 z_2@@3)) (< NoPerm FullPerm)) (and (qpRange4 z_2@@3) (= (invRecv4 z_2@@3) z_2@@3))))
 :qid |stdinbpl.737:26|
 :skolemid |107|
 :pattern ( (MapType0Select Heap@@13 z_2@@3 f_7))
 :pattern ( (MapType2Select QPMask@1 z_2@@3 f_7))
 :pattern ( (MapType1Select xs@@4 z_2@@3))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType1Select xs@@4 (invRecv4 o_3@@2))) (and (< NoPerm FullPerm) (qpRange4 o_3@@2))) (= (invRecv4 o_3@@2) o_3@@2)))
 :qid |stdinbpl.741:26|
 :skolemid |108|
 :pattern ( (invRecv4 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType1Select xs@@4 (invRecv4 o_3@@3))) (and (< NoPerm FullPerm) (qpRange4 o_3@@3))) (and (= (invRecv4 o_3@@3) o_3@@3) (= (U_2_real (MapType2Select QPMask@1 o_3@@3 f_7)) (- (U_2_real (MapType2Select QPMask@0 o_3@@3 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType1Select xs@@4 (invRecv4 o_3@@3))) (and (< NoPerm FullPerm) (qpRange4 o_3@@3)))) (= (U_2_real (MapType2Select QPMask@1 o_3@@3 f_7)) (U_2_real (MapType2Select QPMask@0 o_3@@3 f_7))))))
 :qid |stdinbpl.747:26|
 :skolemid |109|
...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (U_2_bool (MapType1Select xs@@4 z_1))) (U_2_bool (MapType1Select xs@@4 z_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1))))
 :qid |stdinbpl.666:15|
 :skolemid |99|
 :no-pattern (type z_1)
...
)) (=> (forall ((z_1@@1 T@U) ) (!  (=> (= (type z_1@@1) RefType) (=> (and (U_2_bool (MapType1Select xs@@4 z_1@@1)) (< NoPerm FullPerm)) (and (qpRange3 z_1@@1) (= (invRecv3 z_1@@1) z_1@@1))))
 :qid |stdinbpl.672:22|
 :skolemid |100|
 :pattern ( (MapType0Select Heap@@13 z_1@@1 f_7))
 :pattern ( (MapType2Select QPMask@0 z_1@@1 f_7))
 :pattern ( (MapType1Select xs@@4 z_1@@1))
)) (=> (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (U_2_bool (MapType1Select xs@@4 (invRecv3 o_3@@5))) (< NoPerm FullPerm)) (qpRange3 o_3@@5)) (= (invRecv3 o_3@@5) o_3@@5)))
 :qid |stdinbpl.676:22|
 :skolemid |101|
 :pattern ( (invRecv3 o_3@@5))
)) (forall ((z_1@@2 T@U) ) (!  (=> (and (= (type z_1@@2) RefType) (U_2_bool (MapType1Select xs@@4 z_1@@2))) (not (= z_1@@2 null)))
 :qid |stdinbpl.682:22|
 :skolemid |102|
 :pattern ( (MapType0Select Heap@@13 z_1@@2 f_7))
 :pattern ( (MapType2Select QPMask@0 z_1@@2 f_7))
 :pattern ( (MapType1Select xs@@4 z_1@@2))
))) (=> (and (and (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (U_2_bool (MapType1Select xs@@4 (invRecv3 o_3@@6))) (< NoPerm FullPerm)) (qpRange3 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_3@@6) o_3@@6)) (= (U_2_real (MapType2Select QPMask@0 o_3@@6 f_7)) (+ (U_2_real (MapType2Select ZeroMask o_3@@6 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType1Select xs@@4 (invRecv3 o_3@@6))) (< NoPerm FullPerm)) (qpRange3 o_3@@6))) (= (U_2_real (MapType2Select QPMask@0 o_3@@6 f_7)) (U_2_real (MapType2Select ZeroMask o_3@@6 f_7))))))
 :qid |stdinbpl.688:22|
 :skolemid |103|
...
))) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0))) (and (and (U_2_bool (MapType1Select xs@@4 x@@24)) (state Heap@@13 QPMask@0)) (and (>= n@@4 0) (state Heap@@13 QPMask@0)))) (and (=> (= (ControlFlow 0 15) 3) anon8_Then_correct) (=> (= (ControlFlow 0 15) 14) anon8_Else_correct)))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@13 x@@24 $allocated))) (and (=> (= (ControlFlow 0 17) 1) anon7_Then_correct) (=> (= (ControlFlow 0 17) 15) anon7_Else_correct))))))
