...
(assert  (and (and (and (and (and (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type a_2) RefType)) (= (type b_2) RefType)) (= (type l1) RefType)) (= (type l2) RefType)) (= (type freshObj@0) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type freshObj@1) RefType)) (= (type Heap@1) (MapType0Type RefType))))
(set-info :boogie-vc-id t2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@10 a_2 $allocated)) (U_2_bool (MapType0Select Heap@@10 b_2 $allocated))) (and (U_2_bool (MapType0Select Heap@@10 l1 $allocated)) (U_2_bool (MapType0Select Heap@@10 l2 $allocated)))) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@10 freshObj@0 $allocated)))) (and (= Heap@0 (MapType0Store Heap@@10 freshObj@0 $allocated (bool_2_U true))) (state Heap@0 ZeroMask))) (and (and (not (= freshObj@1 null)) (not (U_2_bool (MapType0Select Heap@0 freshObj@1 $allocated)))) (and (= Heap@1 (MapType0Store Heap@0 freshObj@1 $allocated (bool_2_U true))) (state Heap@1 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (not (= a_2 freshObj@0))) (=> (not (= a_2 freshObj@0)) (=> (state Heap@1 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (= freshObj@0 freshObj@1))) (=> (not (= freshObj@0 freshObj@1)) (=> (and (state Heap@1 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (not (= a_2 b_2)))))))))))))
