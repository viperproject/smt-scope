...
(assert  (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type r_1@@13) RefType)) (= (type Heap@@18) (MapType0Type RefType))))
...
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Peano r_1@@13))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Peano r_1@@13)))) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (and (state Heap@@18 ZeroMask) (U_2_bool (MapType0Select Heap@@18 r_1@@13 $allocated))) (=> (and (and (= AssumeFunctionsAbove 0) (= Mask@0 (MapType1Store ZeroMask null (Peano r_1@@13) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Peano r_1@@13))) FullPerm))))) (and (state Heap@@18 Mask@0) (state Heap@@18 Mask@0))) (and (and (=> (= (ControlFlow 0 6) 1) anon5_Else_correct) (=> (= (ControlFlow 0 6) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct))))))
