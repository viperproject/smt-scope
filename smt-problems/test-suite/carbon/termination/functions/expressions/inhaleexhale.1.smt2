...
(declare-fun |g#frame| (T@U Bool) Bool)
...
(assert (forall ((Heap@@2 T@U) (x@@8 Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (bool_2_U (|f#triggerStateless| x@@8))))
 :qid |stdinbpl.222:15|
 :skolemid |25|
 :pattern ( (|f'| Heap@@2 x@@8))
)))
(assert (forall ((Heap@@3 T@U) (b_2 Bool) ) (!  (=> (= (type Heap@@3) (MapType0Type RefType)) (dummyFunction (bool_2_U (|g#triggerStateless| b_2))))
 :qid |stdinbpl.302:15|
 :skolemid |29|
 :pattern ( (|g'| Heap@@3 b_2))
)))
...
(assert (forall ((Heap@@5 T@U) (Mask@@3 T@U) (x@@9 Int) ) (!  (=> (and (and (and (= (type Heap@@5) (MapType0Type RefType)) (= (type Mask@@3) (MapType1Type RefType realType))) (and (state Heap@@5 Mask@@3) (< AssumeFunctionsAbove 0))) (and (< x@@9 0) (g Heap@@5 false))) (f_6 Heap@@5 x@@9))
 :qid |stdinbpl.228:15|
 :skolemid |26|
 :pattern ( (state Heap@@5 Mask@@3) (f_6 Heap@@5 x@@9))
)))
...
(assert (forall ((Heap@@8 T@U) (Mask@@7 T@U) (x@@10 Int) ) (!  (=> (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (state Heap@@8 Mask@@7)) (= (|f'| Heap@@8 x@@10) (|f#frame| EmptyFrame x@@10)))
 :qid |stdinbpl.235:15|
 :skolemid |27|
 :pattern ( (state Heap@@8 Mask@@7) (|f'| Heap@@8 x@@10))
)))
(assert (forall ((Heap@@9 T@U) (Mask@@8 T@U) (b_2@@0 Bool) ) (!  (=> (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@8) (MapType1Type RefType realType))) (state Heap@@9 Mask@@8)) (= (|g'| Heap@@9 b_2@@0) (|g#frame| EmptyFrame b_2@@0)))
 :qid |stdinbpl.309:15|
 :skolemid |30|
 :pattern ( (state Heap@@9 Mask@@8) (|g'| Heap@@9 b_2@@0))
)))
(assert (forall ((Heap@@10 T@U) (x@@11 Int) ) (!  (=> (= (type Heap@@10) (MapType0Type RefType)) (and (= (f_6 Heap@@10 x@@11) (|f'| Heap@@10 x@@11)) (dummyFunction (bool_2_U (|f#triggerStateless| x@@11)))))
 :qid |stdinbpl.218:15|
 :skolemid |24|
 :pattern ( (f_6 Heap@@10 x@@11))
)))
(assert (forall ((Heap@@11 T@U) (b_2@@1 Bool) ) (!  (=> (= (type Heap@@11) (MapType0Type RefType)) (and (= (g Heap@@11 b_2@@1) (|g'| Heap@@11 b_2@@1)) (dummyFunction (bool_2_U (|g#triggerStateless| b_2@@1)))))
 :qid |stdinbpl.298:15|
 :skolemid |28|
 :pattern ( (g Heap@@11 b_2@@1))
)))
...
(let ((anon12_Else_correct  (=> (not $condInEx) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (>= x@@12 0))) (=> (not (>= x@@12 0)) (=> (and (state Heap@@16 ZeroMask) (= (ControlFlow 0 4) 2)) anon9_correct))))))
(let ((anon12_Then_correct  (=> (and $condInEx (= (ControlFlow 0 3) 2)) anon9_correct)))
(let ((anon5_correct  (=> (and (state Heap@@16 ZeroMask) (state Heap@@16 ZeroMask)) (and (=> (= (ControlFlow 0 6) 3) anon12_Then_correct) (=> (= (ControlFlow 0 6) 4) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (not $condInEx) (=> (and (and (< x@@12 0) (state Heap@@16 ZeroMask)) (and (state Heap@@16 ZeroMask) (= (ControlFlow 0 8) 6))) anon5_correct))))
(let ((anon11_Then_correct  (=> $condInEx (=> (and (and (>= x@@12 0) (state Heap@@16 ZeroMask)) (and (state Heap@@16 ZeroMask) (= (ControlFlow 0 7) 6))) anon5_correct))))
(let ((anon10_Else_correct  (=> (not b1) (and (=> (= (ControlFlow 0 9) 7) anon11_Then_correct) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct)))))
(let ((anon10_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@16 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 10) 1) anon10_Then_correct) (=> (= (ControlFlow 0 10) 9) anon10_Else_correct)))))
