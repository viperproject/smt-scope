...
(assert  (and (and (and (and (= (type ys) (SeqType RefType)) (= (type Heap@@10) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type xs) (MapType2Type RefType boolType))) (forall ((arg0@@54 T@U) ) (! (= (type (invRecv1 arg0@@54)) RefType)
...
(let ((anon15_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| ys)) (int_2_U i@@6))) (= (ControlFlow 0 15) 11)) anon9_correct)))
(let ((anon15_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| ys)) (int_2_U i@@6)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< i@@6 (|Seq#Length| ys))) (=> (< i@@6 (|Seq#Length| ys)) (=> (= (ControlFlow 0 12) 11) anon9_correct))))))))
(let ((anon14_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| ys)) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| ys)) (int_2_U i_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ys i_1) (|Seq#Index| ys i_1_1))))
 :qid |stdinbpl.918:17|
 :skolemid |131|
 :pattern ( (neverTriggered2 i_1) (neverTriggered2 i_1_1))
)))))
(let ((anon12_Else_correct  (=> (and (forall ((ix_1 Int) (jx_1 Int) ) (!  (=> (and (>= ix_1 0) (and (< ix_1 (|Seq#Length| ys)) (and (>= jx_1 0) (and (< jx_1 (|Seq#Length| ys)) (not (= ix_1 jx_1)))))) (not (= (|Seq#Index| ys ix_1) (|Seq#Index| ys jx_1))))
 :qid |stdinbpl.898:20|
 :skolemid |130|
 :pattern ( (|Seq#Index| ys ix_1) (|Seq#Index| ys jx_1))
)) (state Heap@@10 QPMask@0)) (and (and (=> (= (ControlFlow 0 16) 10) anon14_Else_correct) (=> (= (ControlFlow 0 16) 12) anon15_Then_correct)) (=> (= (ControlFlow 0 16) 15) anon15_Else_correct)))))
(let ((anon5_correct true))
(let ((anon13_Else_correct  (=> (and (not (and (>= ix 0) (and (< ix (|Seq#Length| ys)) (and (>= jx 0) (and (< jx (|Seq#Length| ys)) (not (= ix jx))))))) (= (ControlFlow 0 8) 2)) anon5_correct)))
(let ((anon13_Then_correct  (=> (and (>= ix 0) (and (< ix (|Seq#Length| ys)) (and (>= jx 0) (and (< jx (|Seq#Length| ys)) (not (= ix jx)))))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (>= ix 0)) (=> (>= ix 0) (and (=> (= (ControlFlow 0 3) (- 0 6)) (< ix (|Seq#Length| ys))) (=> (< ix (|Seq#Length| ys)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (>= jx 0)) (=> (>= jx 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< jx (|Seq#Length| ys))) (=> (< jx (|Seq#Length| ys)) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select xs x_1))) (U_2_bool (MapType2Select xs x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 ...
 :qid |stdinbpl.856:22|
 :skolemid |125|
 :pattern ( (MapType0Select Heap@@10 null (h x_1@@1)))
 :pattern ( (MapType1Select ZeroMask null (h x_1@@1)))
 :pattern ( (MapType2Select xs x_1@@1))
)) (=> (and (forall ((a_1@@5 T@U) ) (!  (=> (= (type a_1@@5) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv1 a_1@@5))) (< NoPerm FullPerm)) (qpRange1 a_1@@5)) (= (invRecv1 a_1@@5) a_1@@5)))
 :qid |stdinbpl.860:22|
 :skolemid |126|
 :pattern ( (invRecv1 a_1@@5))
)) (forall ((a_1@@6 T@U) ) (!  (=> (= (type a_1@@6) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv1 a_1@@6))) (< NoPerm FullPerm)) (qpRange1 a_1@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv1 a_1@@6) a_1@@6)) (= (U_2_real (MapType1Select QPMask@0 null (h a_1@@6))) (+ (U_2_real (MapType1Select ZeroMask null (h a_1@@6))) FullPerm)))))
 :qid |stdinbpl.866:22|
 :skolemid |127|
 :pattern ( (MapType1Select QPMask@0 null (h a_1@@6)))
...
)) (forall ((a_1@@7 T@U) ) (!  (=> (and (= (type a_1@@7) RefType) (not (and (and (U_2_bool (MapType2Select xs (invRecv1 a_1@@7))) (< NoPerm FullPerm)) (qpRange1 a_1@@7)))) (= (U_2_real (MapType1Select QPMask@0 null (h a_1@@7))) (U_2_real (MapType1Select ZeroMask null (h a_1@@7)))))
 :qid |stdinbpl.876:22|
 :skolemid |129|
 :pattern ( (MapType1Select QPMask@0 null (h a_1@@7)))
))) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0))) (and (and (=> (= (ControlFlow 0 17) 16) anon12_Else_correct) (=> (= (ControlFlow 0 17) 3) anon13_Then_correct)) (=> (= (ControlFlow 0 17) 8) anon13_Else_correct)))))))))
