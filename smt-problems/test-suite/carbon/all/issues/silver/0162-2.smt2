...
(assert  (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type x@@8) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id testAcc4)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x@@8 $allocated))) (and (not (= x@@8 null)) (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm)))))) (=> (and (and (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (not (= x@@8 null)) (= Mask@1 (MapType1Store Mask@0 x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@8 f_7)) FullPerm)))))) (and (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1)) (and (state Heap@@10 Mask@1) (= (ControlFlow 0 2) (- 0 1))))) false))))
