...
(assert  (and (and (and (and (and (and (and (and (and (= (type S) (MapType2Type RefType boolType)) (= (type Heap@0) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type t_4) RefType)) (= (type t_1) RefType)) (= (type b_2) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type PostHeap@0) (MapType0Type RefType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv15 arg0@@43)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon17_Else_correct  (=> (= (ControlFlow 0 17) (- 0 16)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (U_2_bool (MapType2Select S r_1))) (U_2_bool (MapType2Select S r_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1 r_1_1))))
...
(let ((anon16_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 18) 15) anon17_Then_correct) (=> (= (ControlFlow 0 18) 17) anon17_Else_correct)))))
(let ((anon13_correct true))
(let ((anon21_Else_correct  (=> (and (not (U_2_bool (MapType2Select S t_1))) (= (ControlFlow 0 12) 9)) anon13_correct)))
(let ((anon21_Then_correct  (=> (U_2_bool (MapType2Select S t_1)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (> (U_2_int (MapType0Select Heap@0 t_1 f_7)) (* 2 a_2))) (=> (> (U_2_int (MapType0Select Heap@0 t_1 f_7)) (* 2 a_2)) (=> (= (ControlFlow 0 10) 9) anon13_correct))))))
(let ((anon9_correct true))
(let ((anon19_Else_correct  (=> (and (not (U_2_bool (MapType2Select S t_4))) (= (ControlFlow 0 8) 5)) anon9_correct)))
(let ((anon19_Then_correct  (=> (U_2_bool (MapType2Select S t_4)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm QPMask@0 t_4 f_7)) (=> (HasDirectPerm QPMask@0 t_4 f_7) (=> (= (ControlFlow 0 6) 5) anon9_correct))))))
(let ((anon20_Else_correct  (=> (and (forall ((t_2_1_1 T@U) ) (!  (=> (and (= (type t_2_1_1) RefType) (U_2_bool (MapType2Select S t_2_1_1))) (> (U_2_int (MapType0Select Heap@0 t_2_1_1 f_7)) (* 2 a_2)))
 :qid |stdinbpl.1648:20|
 :skolemid |190|
 :pattern ( (MapType2Select S t_2_1_1))
)) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((r_2 T@U) (r_2_1 T@U) ) (!  (=> (and (= (type r_2) RefType) (= (type r_2_1) RefType)) (=> (and (and (and (and (not (= r_2 r_2_1)) (U_2_bool (MapType2Select S r_2))) (U_2_bool (MapType2Select S r_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_2 r_2_1))))
 :qid |stdinbpl.1664:17|
 :skolemid |191|
 :pattern ( (neverTriggered17 r_2) (neverTriggered17 r_2_1))
 ...
 :qid |stdinbpl.1664:17|
 :skolemid |191|
 :pattern ( (neverTriggered17 r_2@@0) (neverTriggered17 r_2_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((r_2@@1 T@U) ) (!  (=> (and (= (type r_2@@1) RefType) (U_2_bool (MapType2Select S r_2@@1))) (>= (U_2_real (MapType1Select QPMask@0 r_2@@1 f_7)) FullPerm))
 :qid |stdinbpl.1671:17|
 :skolemid |192|
 :pattern ( (MapType0Select Heap@0 r_2@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 r_2@@1 f_7))
 :pattern ( (MapType2Select S r_2@@1))
))))))))
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (= FullPerm (U_2_real (MapType1Select QPMask@0 b_2 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 b_2 f_7))) (=> (and (= Heap@0 (MapType0Store Heap@@9 b_2 f_7 (int_2_U (* 2 a_2)))) (state Heap@0 QPMask@0)) (and (and (and (and (=> (= (ControlFlow 0 13) 3) anon20_Else_correct) (=> (= (ControlFlow 0 13) 10) anon21_Then_correct)) (=> (= (ControlFlow 0 13) 12) anon21_Else_correct)) (=> (= (ControlFlow 0 13) 6) anon19_Then_correct)) (=> (= (ControlFlow 0 13) 8) anon19_Else_correct)))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 21)) (forall ((s_1 T@U) (s_1_1 T@U) ) (!  (=> (and (= (type s_1) RefType) (= (type s_1_1) RefType)) (=> (and (and (and (and (not (= s_1 s_1_1)) (U_2_bool (MapType2Select S s_1))) (U_2_bool (MapType2Select S s_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1 s_1_1))))
...
)) (=> (forall ((s_1@@1 T@U) ) (!  (=> (= (type s_1@@1) RefType) (=> (and (U_2_bool (MapType2Select S s_1@@1)) (< NoPerm FullPerm)) (and (qpRange15 s_1@@1) (= (invRecv15 s_1@@1) s_1@@1))))
...
)) (=> (and (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select S (invRecv15 o_3))) (< NoPerm FullPerm)) (qpRange15 o_3)) (= (invRecv15 o_3) o_3)))
...
)))) (and (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)) (and (|Set#Equal| S (|Set#Singleton| b_2)) (state Heap@@9 QPMask@0)))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (HasDirectPerm QPMask@0 b_2 f_7)) (=> (HasDirectPerm QPMask@0 b_2 f_7) (=> (and (= (U_2_int (MapType0Select Heap@@9 b_2 f_7)) a_2) (state Heap@@9 QPMask@0)) (and (=> (= (ControlFlow 0 19) 18) anon16_Then_correct) (=> (= (ControlFlow 0 19) 13) anon16_Else_correct)))))))))))
(let ((anon15_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 b_2 $allocated))) (and (=> (= (ControlFlow 0 22) 1) anon15_Then_correct) (=> (= (ControlFlow 0 22) 19) anon15_Else_correct)))))
