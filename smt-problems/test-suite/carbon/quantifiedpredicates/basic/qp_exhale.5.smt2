...
(assert  (and (and (and (and (and (and (and (= (type z@@0) RefType) (= (type y@@6) RefType)) (= (type x@@19) RefType)) (= (type Heap@@14) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id m1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#UnionOne| (|Set#Singleton| z@@0) y@@6) x@@19) r_1))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#UnionOne| (|Set#Singleton| z@@0) y@@6) x@@19) r_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1 r_1_1))))
 :qid |stdinbpl.730:17|
 :skolemid |107|
