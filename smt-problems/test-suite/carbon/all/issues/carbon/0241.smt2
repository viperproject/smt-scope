...
(assert (forall ((a_3 T@U) (i Int) (j Int) ) (!  (=> (= (type a_3) ArrayDomainTypeType) (=> (and (>= i 0) (and (>= j 0) (and (< i (len a_3)) (and (< j (len a_3)) (not (= i j)))))) (not (= (loc a_3 i) (loc a_3 j)))))
 :qid |stdinbpl.210:15|
 :skolemid |22|
 :pattern ( (loc a_3 i) (loc a_3 j))
)))
...
(assert (forall ((arg0@@27 T@U) ) (! (= (type (|array#sm| arg0@@27)) (FieldType PredicateType_arrayType (MapType1Type RefType boolType)))
 :qid |funType:array#sm|
 :pattern ( (|array#sm| arg0@@27))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type a_3@@7) ArrayDomainTypeType)) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Heap@4) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@29 T@U) ) (! (= (type (FrameFragment arg0@@29)) FrameTypeType)
...
(let ((anon9_Else_correct  (=> (HasDirectPerm Mask@2 null (array a_3@@7)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 3) 1)) anon6_correct))))
(let ((anon9_Then_correct  (=> (not (HasDirectPerm Mask@2 null (array a_3@@7))) (=> (and (and (= Heap@2 (MapType0Store Heap@1 null (|array#sm| a_3@@7) ZeroPMask)) (= Heap@3 (MapType0Store Heap@2 null (array a_3@@7) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 2) 1))) anon6_correct))))
(let ((anon4_correct  (and (=> (= (ControlFlow 0 4) (- 0 7)) (forall ((i@@0 Int) (i_4 Int) ) (!  (=> (and (and (and (and (not (= i@@0 i_4)) (and (<= 0 i@@0) (< i@@0 (len a_3@@7)))) (and (<= 0 i_4) (< i_4 (len a_3@@7)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@7 i@@0) (loc a_3@@7 i_4))))
 :qid |stdinbpl.373:15|
 :skolemid |36|
))) (=> (forall ((i@@1 Int) (i_4@@0 Int) ) (!  (=> (and (and (and (and (not (= i@@1 i_4@@0)) (and (<= 0 i@@1) (< i@@1 (len a_3@@7)))) (and (<= 0 i_4@@0) (< i_4@@0 (len a_3@@7)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@7 i@@1) (loc a_3@@7 i_4@@0))))
 :qid |stdinbpl.373:15|
 :skolemid |36|
)) (=> (and (and (and (forall ((i@@2 Int) ) (!  (=> (and (and (<= 0 i@@2) (< i@@2 (len a_3@@7))) (< NoPerm FullPerm)) (and (qpRange2 (loc a_3@@7 i@@2)) (= (invRecv2 (loc a_3@@7 i@@2)) i@@2)))
 :qid |stdinbpl.379:22|
 :skolemid |37|
 :pattern ( (loc a_3@@7 i@@2))
 :pattern ( (MapType0Select Heap@1 (loc a_3@@7 i@@2) val))
...
))) (and (forall ((i@@3 Int) ) (!  (=> (and (<= 0 i@@3) (< i@@3 (len a_3@@7))) (not (= (loc a_3@@7 i@@3) null)))
 :qid |stdinbpl.389:22|
 :skolemid |39|
 :pattern ( (loc a_3@@7 i@@3))
 :pattern ( (MapType0Select Heap@1 (loc a_3@@7 i@@3) val))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv2 o_3@@0)) (< (invRecv2 o_3@@0) (len a_3@@7))) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@7 (invRecv2 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select Mask@1 o_3@@0 val)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv2 o_3@@0)) (< (invRecv2 o_3@@0) (len a_3@@7))) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select Mask@1 o_3@@0 val))))))
 :qid |stdinbpl.395:22|
 :skolemid |40|
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 val))) (= (U_2_real (MapType1Select Mask@1 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.399:29|
 :skolemid |41|
 :pattern ( (MapType1Select Mask@1 o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
)) (state Heap@1 QPMask@0)) (and (state Heap@1 QPMask@0) (state Heap@1 QPMask@0)))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (len a_3@@7)))) (and (<= 0 i_1_1) (< i_1_1 (len a_3@@7)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@7 i_1) (loc a_3@@7 i_1_1))))
 :qid |stdinbpl.418:17|
 :skolemid |42|
 :pattern ( (neverTriggered3 i_1) (neverTriggered3 i_1_1))
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= 0 i_1@@0) (< i_1@@0 (len a_3@@7)))) (and (<= 0 i_1_1@@0) (< i_1_1@@0 (len a_3@@7)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@7 i_1@@0) (loc a_3@@7 i_1_1@@0))))
 :qid |stdinbpl.418:17|
 :skolemid |42|
 :pattern ( (neverTriggered3 i_1@@0) (neverTriggered3 i_1_1@@0))
)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((i_1@@1 Int) ) (!  (=> (and (<= 0 i_1@@1) (< i_1@@1 (len a_3@@7))) (>= (U_2_real (MapType1Select QPMask@0 (loc a_3@@7 i_1@@1) val)) FullPerm))
 :qid |stdinbpl.425:17|
 :skolemid |43|
 :pattern ( (loc a_3@@7 i_1@@1))
 :pattern ( (MapType0Select Heap@1 (loc a_3@@7 i_1@@1) val))
))) (=> (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (< i_1@@2 (len a_3@@7))) (>= (U_2_real (MapType1Select QPMask@0 (loc a_3@@7 i_1@@2) val)) FullPerm))
 :qid |stdinbpl.425:17|
 :skolemid |43|
 :pattern ( (loc a_3@@7 i_1@@2))
 :pattern ( (MapType0Select Heap@1 (loc a_3@@7 i_1@@2) val))
)) (=> (forall ((i_1@@3 Int) ) (!  (=> (and (and (<= 0 i_1@@3) (< i_1@@3 (len a_3@@7))) (< NoPerm FullPerm)) (and (qpRange3 (loc a_3@@7 i_1@@3)) (= (invRecv3 (loc a_3@@7 i_1@@3)) i_1@@3)))
 :qid |stdinbpl.431:22|
 :skolemid |44|
 :pattern ( (loc a_3@@7 i_1@@3))
 :pattern ( (MapType0Select Heap@1 (loc a_3@@7 i_1@@3) val))
...
)) (= Mask@2 (MapType1Store QPMask@1 null (array a_3@@7) (real_2_U (+ (U_2_real (MapType1Select QPMask@1 null (array a_3@@7))) FullPerm)))))) (and (and (state Heap@1 Mask@2) (state Heap@1 Mask@2)) (and (|array#trigger| Heap@1 (array a_3@@7)) (= (MapType0Select Heap@1 null (array a_3@@7)) (FrameFragment (int_2_U (|array#condqp1| Heap@1 a_3@@7))))))) (and (=> (= (ControlFlow 0 4) 2) anon9_Then_correct) (=> (= (ControlFlow 0 4) 3) anon9_Else_correct)))))))))))))
(let ((anon8_Else_correct  (=> (HasDirectPerm Mask@1 null (array a_3@@7)) (=> (and (= Heap@1 Heap@@10) (= (ControlFlow 0 9) 4)) anon4_correct))))
(let ((anon8_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (array a_3@@7))) (= Heap@0 (MapType0Store Heap@@10 null (array a_3@@7) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 8) 4))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (array a_3@@7) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (array a_3@@7))) FullPerm)))) (and (=> (= (ControlFlow 0 10) 8) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 10)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (array a_3@@7))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (array a_3@@7)))) (=> (= (ControlFlow 0 11) 10) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (= Mask@0 (MapType1Store ZeroMask null (array a_3@@7) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (array a_3@@7))) FullPerm))))) (=> (and (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (|array#trigger| Heap@@10 (array a_3@@7)) (= (MapType0Select Heap@@10 null (array a_3@@7)) (FrameFragment (int_2_U (|array#condqp1| Heap@@10 a_3@@7)))))) (and (=> (= (ControlFlow 0 14) 11) anon7_Then_correct) (=> (= (ControlFlow 0 14) 13) anon7_Else_correct))))))
