...
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask)) (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 24) (- 0 26)) (< 0 5)) (=> (< 0 5) (and (=> (= (ControlFlow 0 24) (- 0 25)) (= 0 (+ 0 0))) (=> (= 0 (+ 0 0)) (and (=> (= (ControlFlow 0 24) 1) anon15_Then_correct) (=> (= (ControlFlow 0 24) 23) anon15_Else_correct)))))))))
