...
(declare-fun i_2 () Int)
(assert  (and (= (type l) (SeqType boolType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id n)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 10)) (>= (ite (forall ((i_4 Int) ) (! (= i_4 i_4)
 :qid |stdinbpl.656:21|
 :skolemid |63|
)) 1 2) 0)) (=> (>= (ite (forall ((i_4@@0 Int) ) (! (= i_4@@0 i_4@@0)
 :qid |stdinbpl.656:21|
 :skolemid |63|
)) 1 2) 0) (and (=> (= (ControlFlow 0 8) (- 0 9)) (< (ite (forall ((i_4@@1 Int) ) (! (= i_4@@1 i_4@@1)
 :qid |stdinbpl.661:21|
 :skolemid |64|
)) 1 2) (|Seq#Length| l))) (=> (< (ite (forall ((i_4@@2 Int) ) (! (= i_4@@2 i_4@@2)
 :qid |stdinbpl.661:21|
 :skolemid |64|
)) 1 2) (|Seq#Length| l)) (=> (= (ControlFlow 0 8) (- 0 7)) (U_2_bool (|Seq#Index| l (ite (forall ((i_5 Int) ) (! (= i_5 i_5)
 :qid |stdinbpl.666:32|
 :skolemid |65|
)) 1 2))))))))))
(let ((anon9_Then_correct true))
(let ((anon7_Else_correct  (=> (and (forall ((i_1 Int) ) (!  (=> (and (<= 0 i_1) (< i_1 (|Seq#Length| l))) (U_2_bool (|Seq#Index| l i_1)))
 :qid |stdinbpl.635:20|
 :skolemid |62|
