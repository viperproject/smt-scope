...
(declare-fun i3@@4 () Int)
(assert (= (type Heap@@52) (MapType0Type RefType)))
(set-info :boogie-vc-id |main2#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (and (= Result@0 (onlyWorksWithInhale Heap@@52 i3@@4)) (= (ControlFlow 0 3) (- 0 2))) (> Result@0 17))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@52 ZeroMask) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
