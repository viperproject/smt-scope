...
(assert  (and (and (and (= (type a_3@@8) IArrayDomainTypeType) (= (type Heap@@10) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id m5)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((i_5 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5 i_5_1)) (|Seq#Contains| (|Seq#Range| 1 (+ n@@13 1)) (int_2_U i_5))) (|Seq#Contains| (|Seq#Range| 1 (+ n@@13 1)) (int_2_U i_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_3@@8 a_3@@8)) (not (= i_5 i_5_1))))
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((i_8 Int) (i_8_1 Int) ) (!  (=> (and (and (and (and (not (= i_8 i_8_1)) (|Seq#Contains| (|Seq#Range| 1 (+ n@@13 1)) (int_2_U i_8))) (|Seq#Contains| (|Seq#Range| 1 (+ n@@13 1)) (int_2_U i_8_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_3@@8 a_3@@8)) (not (= i_8 i_8_1))))
 :qid |stdinbpl.1414:17|
 :skolemid |128|
 :pattern ( (neverTriggered11 i_8) (neverTriggered11 i_8_1))
))) (=> (forall ((i_8@@0 Int) (i_8_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_8@@0 i_8_1@@0)) (|Seq#Contains| (|Seq#Range| 1 (+ n@@13 1)) (int_2_U i_8@@0))) (|Seq#Contains| (|Seq#Range| 1 (+ n@@13 1)) (int_2_U i_8_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_3@@8 a_3@@8)) (not (= i_8@@0 i_8_1@@0))))
 :qid |stdinbpl.1414:17|
 :skolemid |128|
 :pattern ( (neverTriggered11 i_8@@0) (neverTriggered11 i_8_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((i_8@@1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 1 (+ n@@13 1)) (int_2_U i_8@@1)) (>= (U_2_real (MapType1Select QPMask@0 null (p_1 a_3@@8 i_8@@1))) FullPerm))
...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_3@@8 a_3@@8)) (not (= (+ i_1 1) (+ i_1_1 1)))))
 :qid |stdinbpl.1314:17|
 :skolemid |116|
 :pattern ( (neverTriggered9 i_1) (neverTriggered9 i_1_1))
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@0))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= a_3@@8 a_3@@8)) (not (= (+ i_1@@0 1) (+ i_1_1@@0 1)))))
 :qid |stdinbpl.1314:17|
 :skolemid |116|
 :pattern ( (neverTriggered9 i_1@@0) (neverTriggered9 i_1_1@@0))
)) (=> (forall ((i_1@@1 T@U) ) (!  (=> (= (type i_1@@1) intType) (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) i_1@@1) (< NoPerm FullPerm)) (and (= (invRecv9 a_3@@8 (+ (U_2_int i_1@@1) 1)) (U_2_int i_1@@1)) (qpRange9 a_3@@8 (+ (U_2_int i_1@@1) 1)))))
 :qid |stdinbpl.1320:22|
 :skolemid |117|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) i_1@@1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) i_1@@1))
)) (=> (and (forall ((a_1_1 T@U) (i_2_1 Int) ) (!  (=> (= (type a_1_1) IArrayDomainTypeType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv9 a_1_1 i_2_1))) (< NoPerm FullPerm)) (qpRange9 a_1_1 i_2_1)) (and (= a_3@@8 a_1_1) (= (+ (invRecv9 a_1_1 i_2_1) 1) i_2_1))))
 :qid |stdinbpl.1324:22|
 :skolemid |118|
 :pattern ( (invRecv9 a_1_1 i_2_1))
)) (forall ((a_1_1@@0 T@U) (i_2_1@@0 Int) ) (!  (=> (= (type a_1_1@@0) IArrayDomainTypeType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv9 a_1_1@@0 i_2_1@@0))) (< NoPerm FullPerm)) (qpRange9 a_1_1@@0 i_2_1@@0)) (and (=> (< NoPerm FullPerm) (and (= a_3@@8 a_1_1@@0) (= (+ (invRecv9 a_1_1@@0 i_2_1@@0) 1) i_2_1@@0))) (= (U_2_real (MapType1Select QPMask@0 null (p_1 a_1_1@@0 i_2_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (p_1 a_1_1@@0 i_2_1@@0))) FullPerm)))))
...
)) (forall ((a_1_1@@1 T@U) (i_2_1@@1 Int) ) (!  (=> (and (= (type a_1_1@@1) IArrayDomainTypeType) (not (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv9 a_1_1@@1 i_2_1@@1))) (< NoPerm FullPerm)) (qpRange9 a_1_1@@1 i_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (p_1 a_1_1@@1 i_2_1@@1))) (U_2_real (MapType1Select ZeroMask null (p_1 a_1_1@@1 i_2_1@@1)))))
