...
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 i_5) (< i_5 (|Seq#Length| xs@@39)))) (= (ControlFlow 0 16) 12)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (<= 0 i_5) (< i_5 (|Seq#Length| xs@@39))) (and (=> (= (ControlFlow 0 13) (- 0 15)) (>= i_5 0)) (=> (>= i_5 0) (and (=> (= (ControlFlow 0 13) (- 0 14)) (< i_5 (|Seq#Length| xs@@39))) (=> (< i_5 (|Seq#Length| xs@@39)) (=> (= (ControlFlow 0 13) 12) anon7_correct))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (forall ((i_8 Int) (i_8_1 Int) ) (!  (=> (and (and (and (and (not (= i_8 i_8_1)) (and (<= 0 i_8) (< i_8 (|Seq#Length| xs@@39)))) (and (<= 0 i_8_1) (< i_8_1 (|Seq#Length| xs@@39)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@39 i_8) (|Seq#Index| xs@@39 i_8_1))))
 :qid |stdinbpl.848:15|
 :skolemid |65|
 ...
 :qid |stdinbpl.848:15|
 :skolemid |65|
)) (=> (forall ((i_8@@1 Int) ) (!  (=> (and (and (<= 0 i_8@@1) (< i_8@@1 (|Seq#Length| xs@@39))) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index| xs@@39 i_8@@1)) (= (invRecv1 (|Seq#Index| xs@@39 i_8@@1)) i_8@@1)))
 :qid |stdinbpl.854:22|
 :skolemid |66|
 :pattern ( (|Seq#Index| xs@@39 i_8@@1))
 :pattern ( (|Seq#Index| xs@@39 i_8@@1))
)) (=> (and (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv1 o_3)) (< (invRecv1 o_3) (|Seq#Length| xs@@39))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (|Seq#Index| xs@@39 (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.858:22|
 :skolemid |67|
 ...
 :pattern ( (|Seq#Index| xs@@39 i_8@@2))
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (|Seq#Length| xs@@39))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| xs@@39 (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (|Seq#Length| xs@@39))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.870:22|
 :skolemid |69|
...
)))) (and (and (state Heap@@41 QPMask@0) (state Heap@@41 QPMask@0)) (and (> (|Seq#Length| xs@@39) 3) (state Heap@@41 QPMask@0)))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< 0 (|Seq#Length| xs@@39))) (=> (< 0 (|Seq#Length| xs@@39)) (=> (= (ControlFlow 0 9) (- 0 8)) (HasDirectPerm QPMask@0 (|Seq#Index| xs@@39 0) f_7))))))))))
...
)) (state Heap@@41 ZeroMask)) (and (and (=> (= (ControlFlow 0 17) 9) anon11_Else_correct) (=> (= (ControlFlow 0 17) 13) anon12_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon12_Else_correct)))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (and (>= i_2 0) (and (< i_2 (|Seq#Length| xs@@39)) (and (>= j_16 0) (and (< j_16 (|Seq#Length| xs@@39)) (not (= i_2 j_16))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (>= i_2 0) (and (< i_2 (|Seq#Length| xs@@39)) (and (>= j_16 0) (and (< j_16 (|Seq#Length| xs@@39)) (not (= i_2 j_16)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_2 (|Seq#Length| xs@@39))) (=> (< i_2 (|Seq#Length| xs@@39)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_16 0)) (=> (>= j_16 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_16 (|Seq#Length| xs@@39))) (=> (< j_16 (|Seq#Length| xs@@39)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove 4)) (and (and (=> (= (ControlFlow 0 18) 17) anon9_Else_correct) (=> (= (ControlFlow 0 18) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 18) 7) anon10_Else_correct)))))
