...
(assert  (and (and (and (and (and (and (= (type refs@@6) (MapType2Type RefType boolType)) (= (type p_3) RefType)) (= (type s_3) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Result) (MapType2Type EdgeDomainTypeType boolType))) (= (type Heap@@35) (MapType0Type RefType))) (forall ((arg0@@59 T@U) ) (! (= (type (invRecv11 arg0@@59)) RefType)
 :qid |funType:invRecv11|
 :pattern ( (invRecv11 arg0@@59))
))))
...
)) (state Heap@@35 QPMask@0)) (and (=> (= (ControlFlow 0 11) 9) anon17_Then_correct) (=> (= (ControlFlow 0 11) 10) anon17_Else_correct)))))
(let ((anon16_Then_correct true))
(let ((anon13_Else_correct  (=> (and (forall ((p_4 T@U) (s_4 T@U) ) (!  (=> (and (= (type p_4) RefType) (= (type s_4) RefType)) (=  (and (U_2_bool (MapType2Select refs@@6 p_4)) (and (U_2_bool (MapType2Select refs@@6 s_4)) (= (MapType0Select Heap@@35 p_4 next) s_4))) (U_2_bool (MapType2Select Result (create_edge p_4 s_4)))))
 :qid |stdinbpl.1638:20|
 :skolemid |198|
 :pattern ( (create_edge p_4 s_4))
)) (state Heap@@35 QPMask@0)) (and (=> (= (ControlFlow 0 12) 8) anon16_Then_correct) (=> (= (ControlFlow 0 12) 11) anon16_Else_correct)))))
...
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((n_3 T@U) (n_3_1 T@U) ) (!  (=> (and (= (type n_3) RefType) (= (type n_3_1) RefType)) (=> (and (and (and (and (not (= n_3 n_3_1)) (U_2_bool (MapType2Select refs@@6 n_3))) (U_2_bool (MapType2Select refs@@6 n_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3 n_3_1))))
...
))) (=> (forall ((n_3@@0 T@U) (n_3_1@@0 T@U) ) (!  (=> (and (= (type n_3@@0) RefType) (= (type n_3_1@@0) RefType)) (=> (and (and (and (and (not (= n_3@@0 n_3_1@@0)) (U_2_bool (MapType2Select refs@@6 n_3@@0))) (U_2_bool (MapType2Select refs@@6 n_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3@@0 n_3_1@@0))))
 :qid |stdinbpl.1592:15|
 :skolemid |192|
...
)) (=> (forall ((n_3@@1 T@U) ) (!  (=> (= (type n_3@@1) RefType) (=> (and (U_2_bool (MapType2Select refs@@6 n_3@@1)) (< NoPerm FullPerm)) (and (qpRange11 n_3@@1) (= (invRecv11 n_3@@1) n_3@@1))))
 :qid |stdinbpl.1598:22|
 :skolemid |193|
 :pattern ( (MapType0Select Heap@@35 n_3@@1 next))
 :pattern ( (MapType1Select QPMask@0 n_3@@1 next))
 :pattern ( (MapType0Select Heap@@35 n_3@@1 next))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select refs@@6 (invRecv11 o_3))) (< NoPerm FullPerm)) (qpRange11 o_3)) (= (invRecv11 o_3) o_3)))
 :qid |stdinbpl.1602:22|
 :skolemid |194|
 :pattern ( (invRecv11 o_3))
)) (forall ((n_3@@2 T@U) ) (!  (=> (and (= (type n_3@@2) RefType) (U_2_bool (MapType2Select refs@@6 n_3@@2))) (not (= n_3@@2 null)))
 :qid |stdinbpl.1608:22|
 :skolemid |195|
 :pattern ( (MapType0Select Heap@@35 n_3@@2 next))
 :pattern ( (MapType1Select QPMask@0 n_3@@2 next))
 :pattern ( (MapType0Select Heap@@35 n_3@@2 next))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select refs@@6 (invRecv11 o_3@@0))) (< NoPerm FullPerm)) (qpRange11 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv11 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 next)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select refs@@6 (invRecv11 o_3@@0))) (< NoPerm FullPerm)) (qpRange11 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (U_2_real (MapType1Select ZeroMask o_3@@0 next))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.1618:29|
 :skolemid |197|
 :pattern ( (MapType1Select ZeroMask o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
))) (and (state Heap@@35 QPMask@0) (state Heap@@35 QPMask@0))) (and (and (=> (= (ControlFlow 0 13) 12) anon13_Else_correct) (=> (= (ControlFlow 0 13) 7) anon14_Then_correct)) (=> (= (ControlFlow 0 13) 3) anon14_Else_correct)))))))))
(let ((anon12_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@35 ZeroMask) (= AssumeFunctionsAbove 4)) (and (=> (= (ControlFlow 0 15) 1) anon12_Then_correct) (=> (= (ControlFlow 0 15) 13) anon12_Else_correct)))))
