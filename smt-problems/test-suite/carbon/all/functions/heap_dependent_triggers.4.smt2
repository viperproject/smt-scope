...
(assert  (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type x@@11) RefType)) (= (type Heap@@15) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon18_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (> (bar01 Heap@@15 5) 0))))
(let ((anon18_Then_correct true))
(let ((anon16_Else_correct  (=> (fun01 Heap@@15 x@@11 5) (=> (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)) (and (=> (= (ControlFlow 0 10) 7) anon18_Then_correct) (=> (= (ControlFlow 0 10) 9) anon18_Else_correct))))))
(let ((anon9_correct true))
(let ((anon17_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon9_correct)))
(let ((anon17_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@11 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@11 f_7))) (=> (= (ControlFlow 0 4) 3) anon9_correct))))))
