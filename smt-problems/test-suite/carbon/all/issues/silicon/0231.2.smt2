...
(assert  (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type this) RefType)) (= (type Heap@@10) (MapType0Type RefType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon2_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 null (P this) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P this))) FullPerm)))) (= (ControlFlow 0 2) (- 0 1))) (= (U_2_real (MapType1Select Mask@1 null (P this))) NoPerm))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P this))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P this)))) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@10 this $allocated)) (= Mask@0 (MapType1Store ZeroMask null (P this) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P this))) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (= (U_2_real (MapType1Select Mask@0 null (P this))) FullPerm)) (=> (= (U_2_real (MapType1Select Mask@0 null (P this))) FullPerm) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))))
