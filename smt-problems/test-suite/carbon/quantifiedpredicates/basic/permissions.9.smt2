...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon4_correct  (=> (and (not (= x@@11 null)) (= Mask@2 (MapType1Store Mask@1 x@@11 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@1 x@@11 f_7)) FullPerm))))) (=> (and (and (state Heap@1 Mask@2) (state Heap@1 Mask@2)) (and (state Heap@1 Mask@2) (= (ControlFlow 0 2) (- 0 1)))) (not (= x@@11 null))))))
(let ((anon6_Else_correct  (=> (HasDirectPerm Mask@1 null (pred1 x@@11)) (=> (and (= Heap@1 Heap@@11) (= (ControlFlow 0 4) 2)) anon4_correct))))
(let ((anon6_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (pred1 x@@11))) (= Heap@0 (MapType0Store Heap@@11 null (pred1 x@@11) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 3) 2))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (pred1 x@@11) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (pred1 x@@11))) FullPerm)))) (and (=> (= (ControlFlow 0 5) 3) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pred1 x@@11))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (pred1 x@@11)))) (=> (= (ControlFlow 0 6) 5) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@11 x@@11 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (pred1 x@@11) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (pred1 x@@11))) FullPerm))))) (=> (and (and (state Heap@@11 Mask@0) (state Heap@@11 Mask@0)) (and (|pred1#trigger| Heap@@11 (pred1 x@@11)) (= (MapType0Select Heap@@11 null (pred1 x@@11)) (FrameFragment (MapType0Select Heap@@11 x@@11 f_7))))) (and (=> (= (ControlFlow 0 9) 6) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct)))))))
