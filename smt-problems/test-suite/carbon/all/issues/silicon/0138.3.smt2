...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type Ref__y) (FieldType NormalFieldType intType))))
(assert (distinct $allocated Ref__y)
)
...
(assert (forall ((Heap@@0 T@U) (diz@@0 T@U) (ref@@0 T@U) (p_1@@0 T@U) ) (!  (=> (and (and (and (= (type Heap@@0) (MapType0Type RefType)) (= (type diz@@0) RefType)) (= (type ref@@0) RefType)) (= (type p_1@@0) ProcessDomainTypeType)) (|Ref__hist_idle#everUsed| (Ref__hist_idle diz@@0 ref@@0 p_1@@0)))
 :qid |stdinbpl.253:15|
 :skolemid |28|
 :pattern ( (|Ref__hist_idle#trigger| Heap@@0 (Ref__hist_idle diz@@0 ref@@0 p_1@@0)))
)))
(assert (forall ((diz@@1 T@U) (ref@@1 T@U) (p_1@@1 T@U) ) (!  (=> (and (and (= (type diz@@1) RefType) (= (type ref@@1) RefType)) (= (type p_1@@1) ProcessDomainTypeType)) (= (getPredWandId (Ref__hist_idle diz@@1 ref@@1 p_1@@1)) 1))
 :qid |stdinbpl.238:15|
 :skolemid |25|
...
(assert (forall ((arg0@@26 T@U) (arg1@@10 T@U) (arg2@@4 T@U) ) (! (= (type (|Ref__hist_idle#sm| arg0@@26 arg1@@10 arg2@@4)) (FieldType PredicateType_Ref__hist_idleType (MapType1Type RefType boolType)))
 :qid |funType:Ref__hist_idle#sm|
 :pattern ( (|Ref__hist_idle#sm| arg0@@26 arg1@@10 arg2@@4))
)))
(assert (forall ((diz@@2 T@U) (ref@@2 T@U) (p_1@@2 T@U) ) (!  (=> (and (and (= (type diz@@2) RefType) (= (type ref@@2) RefType)) (= (type p_1@@2) ProcessDomainTypeType)) (= (PredicateMaskField (Ref__hist_idle diz@@2 ref@@2 p_1@@2)) (|Ref__hist_idle#sm| diz@@2 ref@@2 p_1@@2)))
 :qid |stdinbpl.230:15|
 :skolemid |23|
 :pattern ( (PredicateMaskField (Ref__hist_idle diz@@2 ref@@2 p_1@@2)))
)))
...
(assert (forall ((diz@@3 T@U) (ref@@3 T@U) (p_1@@3 T@U) (diz2 T@U) (ref2 T@U) (p2 T@U) ) (!  (=> (and (and (and (and (and (and (= (type diz@@3) RefType) (= (type ref@@3) RefType)) (= (type p_1@@3) ProcessDomainTypeType)) (= (type diz2) RefType)) (= (type ref2) RefType)) (= (type p2) ProcessDomainTypeType)) (= (Ref__hist_idle diz@@3 ref@@3 p_1@@3) (Ref__hist_idle diz2 ref2 p2))) (and (= diz@@3 diz2) (and (= ref@@3 ref2) (= p_1@@3 p2))))
 :qid |stdinbpl.244:15|
 :skolemid |26|
 :pattern ( (Ref__hist_idle diz@@3 ref@@3 p_1@@3) (Ref__hist_idle diz2 ref2 p2))
)))
(assert (forall ((diz@@4 T@U) (ref@@4 T@U) (p_1@@4 T@U) (diz2@@0 T@U) (ref2@@0 T@U) (p2@@0 T@U) ) (!  (=> (and (and (and (and (and (and (= (type diz@@4) RefType) (= (type ref@@4) RefType)) (= (type p_1@@4) ProcessDomainTypeType)) (= (type diz2@@0) RefType)) (= (type ref2@@0) RefType)) (= (type p2@@0) ProcessDomainTypeType)) (= (|Ref__hist_idle#sm| diz@@4 ref@@4 p_1@@4) (|Ref__hist_idle#sm| diz2@@0 ref2@@0 p2@@0))) (and (= diz@@4 diz2@@0) (and (= ref@@4 ref2@@0) (= p_1@@4 p2@@0))))
 :qid |stdinbpl.248:15|
 :skolemid |27|
 :pattern ( (|Ref__hist_idle#sm| diz@@4 ref@@4 p_1@@4) (|Ref__hist_idle#sm| diz2@@0 ref2@@0 p2@@0))
)))
...
(assert  (not (IsPredicateField Ref__y)))
(assert  (not (IsWandField Ref__y)))
...
(assert (forall ((Heap@@8 T@U) ) (!  (=> (= (type Heap@@8) (MapType0Type RefType)) (|P#everUsed| P))
 :qid |stdinbpl.206:15|
 :skolemid |22|
 :pattern ( (|P#trigger| Heap@@8 P))
)))
...
(assert  (and (and (and (and (and (and (and (= (type ExhaleHeap@0) (MapType0Type RefType)) (= (type h) RefType)) (= (type Mask@3) (MapType1Type RefType realType))) (= (type diz@@5) RefType)) (forall ((arg0@@28 Int) ) (! (= (type (p_single arg0@@28)) ProcessDomainTypeType)
 :qid |funType:p_single|
 :pattern ( (p_single arg0@@28))
))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@11) (MapType0Type RefType))))
(set-info :boogie-vc-id Ref__do_incr_loop)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon11_Else_correct true))
(let ((anon11_Then_correct  (=> (state ExhaleHeap@0 ZeroMask) (=> (and (>= k 0) (<= 0 0)) (=> (and (and (and (<= 0 n_1) (not (= h null))) (and (= Mask@3 (MapType1Store ZeroMask null (Ref__hist_idle h diz@@5 (p_single (+ k 0))) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Ref__hist_idle h diz@@5 (p_single (+ k 0))))) FullPerm)))) (state ExhaleHeap@0 Mask@3))) (and (and (state ExhaleHeap@0 Mask@3) (< 0 n_1)) (and (state ExhaleHeap@0 Mask@3) (= (ControlFlow 0 3) (- 0 7))))) false)))))
(let ((anon10_Then_correct true))
(let ((anon2_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 null (Ref__hist_idle h diz@@5 (p_single (+ k 0))) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (Ref__hist_idle h diz@@5 (p_single (+ k 0))))) FullPerm)))) (IdenticalOnKnownLocations Heap@@11 ExhaleHeap@0 Mask@1)) (and (and (=> (= (ControlFlow 0 9) 1) anon10_Then_correct) (=> (= (ControlFlow 0 9) 3) anon11_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon2_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Ref__hist_idle h diz@@5 (p_single (+ k 0))))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Ref__hist_idle h diz@@5 (p_single (+ k 0)))))) (=> (= (ControlFlow 0 10) 9) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@11 diz@@5 $allocated)) (U_2_bool (MapType0Select Heap@@11 h $allocated))) (=> (and (and (not (= diz@@5 null)) (state Heap@@11 ZeroMask)) (and (>= n_1 0) (state Heap@@11 ZeroMask))) (=> (and (and (and (>= k 0) (state Heap@@11 ZeroMask)) (and (not (= h null)) (state Heap@@11 ZeroMask))) (and (and (= Mask@0 (MapType1Store ZeroMask null (Ref__hist_idle h diz@@5 (p_single k)) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Ref__hist_idle h diz@@5 (p_single k)))) FullPerm)))) (state Heap@@11 Mask@0)) (and (state Heap@@11 Mask@0) (state Heap@@11 Mask@0)))) (and (=> (= (ControlFlow 0 13) (- 0 17)) (>= k 0)) (=> (>= k 0) (and (=> (= (ControlFlow 0 13) (- 0 16)) (<= 0 0)) (=> (<= 0 0) (and (=> (= (ControlFlow 0 13) (- 0 15)) (<= 0 n_1)) (=> (<= 0 n_1) (and (=> (= (ControlFlow 0 13) (- 0 14)) (not (= h null))) (=> (not (= h null)) (and (=> (= (ControlFlow 0 13) 10) anon9_Then_correct) (=> (= (ControlFlow 0 13) 12) anon9_Else_correct))))))))))))))))
