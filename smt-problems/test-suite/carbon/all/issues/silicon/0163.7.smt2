...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (> i@@9 17) (=> (and (state Heap@@52 ZeroMask) (= (ControlFlow 0 3) (- 0 2))) (> i@@9 17)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@52 ZeroMask) (= AssumeFunctionsAbove 6)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
