(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:22:30
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quantifiedpermissions/third_party/testZeroArrayC.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (forall ((j@9@01 Int) (k@10@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testZeroArrayC.vpr@62@12@62@104-aux|)))
(assert (forall ((j@9@01 Int) (k@10@01 Int)) (!
  (=>
    (and
      (<= 0 j@9@01)
  ...
  :pattern ((Seq_index ar@7@01 j@9@01) (Seq_index ar@7@01 k@10@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testZeroArrayC.vpr@62@12@62@104|)))
...
(assert (forall ((i@18@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testZeroArrayC.vpr@66@12@66@86-aux|)))
(assert (forall ((i@18@01 Int)) (!
  (=>
    (and (<= 0 i@18@01) (< i@18@01 len@6@01))
    (=
      ...
      0))
  :pattern ((Seq_index ar@7@01 i@18@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testZeroArrayC.vpr@66@12@66@86|)))
(pop) ; 2
(push) ; 2
; [exec]
; inhale false
...
(assert (forall ((j@43@01 Int) (k@44@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testZeroArrayC.vpr@93@12@93@104-aux|)))
(assert (forall ((j@43@01 Int) (k@44@01 Int)) (!
  (=>
    (and
      (<= 0 j@43@01)
  ...
  :pattern ((Seq_index ar@40@01 j@43@01) (Seq_index ar@40@01 k@44@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testZeroArrayC.vpr@93@12@93@104|)))
...
(assert (forall ((k@52@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testZeroArrayC.vpr@97@12@97@86-aux|)))
(assert (forall ((k@52@01 Int)) (!
  (=>
    (and (<= 0 k@52@01) (< k@52@01 len@41@01))
    (=
      ...
      0))
  :pattern ((Seq_index ar@40@01 k@52@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/third_party/testZeroArrayC.vpr@97@12@97@86|)))
(pop) ; 2
(push) ; 2
; [exec]
; assert |ar| == len
...
; [eval] |ar| == len
; [eval] |ar|
(declare-const i_fresh_rw_0@65@01 Int)
(set-option :timeout 0)
(push) ; 3
; [eval] 0 <= i_fresh_rw_0 && i_fresh_rw_0 < len
; [eval] 0 <= i_fresh_rw_0
(push) ; 4
; [then-branch: 31 | !(0 <= i_fresh_rw_0@65@01) | live]
; [else-branch: 31 | 0 <= i_fresh_rw_0@65@01 | live]
(push) ; 5
; [then-branch: 31 | !(0 <= i_fresh_rw_0@65@01)]
(assert (not (<= 0 i_fresh_rw_0@65@01)))
(pop) ; 5
(push) ; 5
; [else-branch: 31 | 0 <= i_fresh_rw_0@65@01]
(assert (<= 0 i_fresh_rw_0@65@01))
; [eval] i_fresh_rw_0 < len
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 i_fresh_rw_0@65@01) (not (<= 0 i_fresh_rw_0@65@01))))
(assert (and (<= 0 i_fresh_rw_0@65@01) (< i_fresh_rw_0@65@01 len@41@01)))
; [eval] ar[i_fresh_rw_0]
(push) ; 4
(assert (not (>= i_fresh_rw_0@65@01 0)))
(check-sat)
; unsat
(pop) ; 4
; 0,00s
; (get-info :all-statistics)
(push) ; 4
(assert (not (< i_fresh_rw_0@65@01 (Seq_length ar@40@01))))
(check-sat)
; unsat
(pop) ; 4
; 0,00s
...
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((i_fresh_rw_0@65@01 Int)) (!
  (=>
    (and (<= 0 i_fresh_rw_0@65@01) (< i_fresh_rw_0@65@01 len@41@01))
    (or (<= 0 i_fresh_rw_0@65@01) (not (<= 0 i_fresh_rw_0@65@01))))
  :pattern ((Seq_index ar@40@01 i_fresh_rw_0@65@01))
  :qid |Ref__Integer_value-aux|)))
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((i_fresh_rw_01@65@01 Int) (i_fresh_rw_02@65@01 Int)) (!
  (=>
    (and
      (and (<= 0 i_fresh_rw_01@65@01) (< i_fresh_rw_01@65@01 len@41@01))
      (and (<= 0 i_fresh_rw_02@65@01) (< i_fresh_rw_02@65@01 len@41@01))
      (=
        (Seq_index ar@40@01 i_fresh_rw_01@65@01)
        (Seq_index ar@40@01 i_fresh_rw_02@65@01)))
    (= i_fresh_rw_01@65@01 i_fresh_rw_02@65@01))
...
(assert (forall ((i_fresh_rw_0@65@01 Int)) (!
  (=>
    (and (<= 0 i_fresh_rw_0@65@01) (< i_fresh_rw_0@65@01 len@41@01))
    (and
      (= (inv@66@01 (Seq_index ar@40@01 i_fresh_rw_0@65@01)) i_fresh_rw_0@65@01)
      (img@67@01 (Seq_index ar@40@01 i_fresh_rw_0@65@01))))
  :pattern ((Seq_index ar@40@01 i_fresh_rw_0@65@01))
  :qid |Ref__Integer_value-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
