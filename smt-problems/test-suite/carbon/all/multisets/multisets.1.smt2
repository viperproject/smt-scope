...
(declare-fun C@@4 () T@U)
(assert  (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type A@@12) (MultiSetType intType))) (= (type B@@11) (MultiSetType intType))) (= (type C@@4) (MultiSetType intType))))
(set-info :boogie-vc-id test09)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (|MultiSet#Equal| (|MultiSet#Union| A@@12 B@@11) C@@4) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|MultiSet#Subset| A@@12 C@@4)) (=> (|MultiSet#Subset| A@@12 C@@4) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|MultiSet#Subset| B@@11 C@@4)) (=> (|MultiSet#Subset| B@@11 C@@4) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (|MultiSet#Subset| A@@12 B@@11)))))))))))
