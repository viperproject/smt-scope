...
(assert  (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type B1@0) (MultiSetType intType))) (= (type B2@0) (MultiSetType intType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (= B1@0 (|MultiSet#Singleton| (int_2_U 1)))) (=> (and (and (state Heap@@9 ZeroMask) (= B2@0 (|MultiSet#UnionOne| (|MultiSet#Singleton| (int_2_U 1)) (int_2_U 1)))) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (|MultiSet#Equal| B1@0 B2@0)))))
