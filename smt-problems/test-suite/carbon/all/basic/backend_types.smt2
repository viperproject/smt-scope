...
(declare-fun first@0 () (_ FloatingPoint 8 24))
(declare-fun second@0 () (_ FloatingPoint 8 24))
(declare-fun res@0 () (_ FloatingPoint 8 24))
(declare-fun zero@0 () (_ FloatingPoint 8 24))
(declare-fun addition@0 () (_ FloatingPoint 8 24))
(declare-fun result_addition@0 () (_ FloatingPoint 8 24))
(assert (= (type Heap@@9) (MapType0Type RefType)))
(set-info :boogie-vc-id testOp)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (= first@0 ((_ to_fp 8 24) ((_ int2bv 32) 1081081856))) (state Heap@@9 ZeroMask)) (and (= second@0 ((_ to_fp 8 24) ((_ int2bv 32) 1103888384))) (state Heap@@9 ZeroMask))) (=> (and (and (and (= res@0 ((_ to_fp 8 24) ((_ int2bv 32) 1105854464))) (state Heap@@9 ZeroMask)) (and (= zero@0 ((_ to_fp 8 24) ((_ int2bv 32) 0))) (state Heap@@9 ZeroMask))) (and (and (= addition@0 (fp.add RNE first@0 second@0)) (state Heap@@9 ZeroMask)) (and (= result_addition@0 (fp.add RNE res@0 zero@0)) (state Heap@@9 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= addition@0 result_addition@0)) (=> (= addition@0 result_addition@0) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (fp.gt addition@0 result_addition@0)))))))))
