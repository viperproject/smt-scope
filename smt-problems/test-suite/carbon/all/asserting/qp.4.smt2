...
(assert  (and (and (= (type s@@3) (MapType2Type RefType boolType)) (= (type x_3) RefType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id m3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (not (U_2_bool (MapType2Select s@@3 x_3))) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (U_2_bool (MapType2Select s@@3 x_3)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= x_3 null))) (=> (not (= x_3 null)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
