...
(declare-fun r_30 () T@U)
(declare-fun ExhaleHeap@0 () T@U)
(declare-fun r_29 () T@U)
(declare-fun Mask@0 () T@U)
(declare-fun r1 () T@U)
(declare-fun Heap@@9 () T@U)
(declare-fun r2 () T@U)
(assert  (and (and (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type r_29) RefType)) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type r_30) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type r1) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type r2) RefType)))
(set-info :boogie-vc-id permCheck3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon9_correct true))
(let ((anon15_Else_correct  (=> (and (not (HasDirectPerm Mask@1 r_30 f2)) (= (ControlFlow 0 10) 7)) anon9_correct)))
(let ((anon15_Then_correct  (=> (HasDirectPerm Mask@1 r_30 f2) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm Mask@1 r_30 f2)) (=> (HasDirectPerm Mask@1 r_30 f2) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
(let ((anon14_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((r_3 T@U) ) (!  (=> (and (= (type r_3) RefType) (HasDirectPerm Mask@1 r_3 f2)) false)
 :qid |stdinbpl.1069:15|
 :skolemid |46|
 :pattern ( (MapType1Select Mask@1 r_3 f2))
 :pattern ( (MapType0Select ExhaleHeap@0 r_3 f2))
)))))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((r_1_1 T@U) ) (!  (=> (and (= (type r_1_1) RefType) (HasDirectPerm Mask@1 r_1_1 f1)) false)
 :qid |stdinbpl.1050:15|
 :skolemid |45|
 :pattern ( (MapType1Select Mask@1 r_1_1 f1))
 :pattern ( (MapType0Select ExhaleHeap@0 r_1_1 f1))
))) (=> (forall ((r_1_1@@0 T@U) ) (!  (=> (and (= (type r_1_1@@0) RefType) (HasDirectPerm Mask@1 r_1_1@@0 f1)) false)
 :qid |stdinbpl.1050:15|
 :skolemid |45|
 :pattern ( (MapType1Select Mask@1 r_1_1@@0 f1))
 :pattern ( (MapType0Select ExhaleHeap@0 r_1_1@@0 f1))
...
(let ((anon13_Else_correct  (=> (and (not (HasDirectPerm Mask@1 r_29 f1)) (= (ControlFlow 0 4) 1)) anon5_correct)))
(let ((anon13_Then_correct  (=> (HasDirectPerm Mask@1 r_29 f1) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 r_29 f1)) (=> (HasDirectPerm Mask@1 r_29 f1) (=> (= (ControlFlow 0 2) 1) anon5_correct))))))
(let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 r1 f1 (real_2_U (- (U_2_real (MapType1Select Mask@0 r1 f1)) FullPerm)))) (=> (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1)) (and (and (=> (= (ControlFlow 0 13) 11) anon12_Else_correct) (=> (= (ControlFlow 0 13) 2) anon13_Then_correct)) (=> (= (ControlFlow 0 13) 4) anon13_Else_correct))))))
(let ((anon11_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 13)) anon2_correct)))
(let ((anon11_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (U_2_real (MapType1Select Mask@0 r1 f1)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 r1 f1))) (=> (= (ControlFlow 0 14) 13) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 r1 $allocated))) (and (U_2_bool (MapType0Select Heap@@9 r2 $allocated)) (not (= r1 null)))) (and (and (= Mask@0 (MapType1Store ZeroMask r1 f1 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r1 f1)) FullPerm)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)))) (and (=> (= (ControlFlow 0 17) 14) anon11_Then_correct) (=> (= (ControlFlow 0 17) 16) anon11_Else_correct)))))
