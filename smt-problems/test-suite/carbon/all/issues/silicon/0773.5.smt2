...
(let ((anon8_Else_correct  (=> (state Heap@@23 ZeroMask) (=> (and (state Heap@@23 ZeroMask) (state Heap@@23 ZeroMask)) (and (=> (= (ControlFlow 0 7) 3) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct))))))
