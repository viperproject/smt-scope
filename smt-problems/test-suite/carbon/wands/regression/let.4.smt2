...
(declare-fun |fun#trigger| (T@U T@U) Bool)
...
(assert (forall ((Heap@@13 T@U) (Mask@@10 T@U) (x@@17 T@U) ) (!  (=> (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type x@@17) RefType)) (and (state Heap@@13 Mask@@10) (< AssumeFunctionsAbove 0))) (= (fun Heap@@13 x@@17) (U_2_int (MapType0Select Heap@@13 x@@17 g))))
 :qid |stdinbpl.206:15|
 :skolemid |24|
 :pattern ( (state Heap@@13 Mask@@10) (fun Heap@@13 x@@17))
 :pattern ( (state Heap@@13 Mask@@10) (|fun#triggerStateless| x@@17) (|P#trigger| Heap@@13 (P x@@17)))
)))
...
(assert (forall ((Heap@@14 T@U) (Mask@@11 T@U) (x@@18 T@U) ) (!  (=> (and (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (= (type x@@18) RefType)) (and (state Heap@@14 Mask@@11) (or (< AssumeFunctionsAbove 0) (|fun#trigger| (MapType0Select Heap@@14 null (P x@@18)) x@@18)))) (> (|fun'| Heap@@14 x@@18) 0))
 :qid |stdinbpl.219:15|
 :skolemid |26|
 :pattern ( (state Heap@@14 Mask@@11) (|fun'| Heap@@14 x@@18))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
...
(assert  (and (and (and (and (and (and (= (type Heap@@15) (MapType0Type RefType)) (= (type x@@19) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (forall ((arg0@@28 T@U) ) (! (= (type (FrameFragment arg0@@28)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@28))
))) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id |fun#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@15 x@@19 $allocated)) (= AssumeFunctionsAbove 0)) (and (> wildcard@0 NoPerm) (= Mask@0 (MapType1Store ZeroMask null (P x@@19) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@19))) wildcard@0)))))) (and (and (state Heap@@15 Mask@0) (state Heap@@15 Mask@0)) (and (|P#trigger| Heap@@15 (P x@@19)) (= (MapType0Select Heap@@15 null (P x@@19)) (FrameFragment (MapType0Select Heap@@15 x@@19 g)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (> (U_2_real (MapType1Select Mask@0 null (P x@@19))) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@0 null (P x@@19))) NoPerm) (=> (> wildcard@1 NoPerm) (=> (and (and (and (< wildcard@1 (U_2_real (MapType1Select Mask@0 null (P x@@19)))) (= UnfoldingMask@0 (MapType1Store Mask@0 null (P x@@19) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P x@@19))) wildcard@1))))) (and (> wildcard@2 NoPerm) (not (= x@@19 null)))) (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x@@19 g (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@19 g)) wildcard@2)))) (state Heap@@15 UnfoldingMask@1)) (and (= (U_2_int (MapType0Select Heap@@15 x@@19 g)) 1) (state Heap@@15 UnfoldingMask@1)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm UnfoldingMask@1 x@@19 g)) (=> (HasDirectPerm UnfoldingMask@1 x@@19 g) (=> (and (and (= Heap@0 (MapType0Store Heap@@15 null (|P#sm| x@@19) (MapType1Store (MapType0Select Heap@@15 null (|P#sm| x@@19)) x@@19 g (bool_2_U true)))) (state Heap@0 Mask@0)) (and (= Result@0 (U_2_int (MapType0Select Heap@0 x@@19 g))) (= (ControlFlow 0 2) (- 0 1)))) (> Result@0 0))))))))))))
