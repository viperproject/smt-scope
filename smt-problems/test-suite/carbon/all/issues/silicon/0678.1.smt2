...
(assert  (and (= (Ctor PredicateType_PType) 12) (forall ((arg0@@25 Int) ) (! (= (type (P arg0@@25)) (FieldType PredicateType_PType FrameTypeType))
 :qid |funType:P|
 :pattern ( (P arg0@@25))
))))
(assert (forall ((x@@8 Int) ) (! (IsPredicateField (P x@@8))
 :qid |stdinbpl.194:15|
 :skolemid |23|
 :pattern ( (P x@@8))
)))
(assert (forall ((Heap@@2 T@U) (x@@9 Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (|P#everUsed| (P x@@9)))
 :qid |stdinbpl.213:15|
 :skolemid |27|
...
(assert (forall ((x@@10 Int) (x2 Int) ) (!  (=> (= (P x@@10) (P x2)) (= x@@10 x2))
 :qid |stdinbpl.204:15|
 :skolemid |25|
 :pattern ( (P x@@10) (P x2))
)))
...
(assert (forall ((x@@11 Int) (x2@@0 Int) ) (!  (=> (= (|P#sm| x@@11) (|P#sm| x2@@0)) (= x@@11 x2@@0))
 :qid |stdinbpl.208:15|
 :skolemid |26|
...
(assert (forall ((x@@12 Int) ) (! (= (getPredWandId (P x@@12)) 0)
 :qid |stdinbpl.198:15|
 :skolemid |24|
 :pattern ( (P x@@12))
)))
...
(assert (forall ((x@@13 Int) ) (! (= (PredicateMaskField (P x@@13)) (|P#sm| x@@13))
 :qid |stdinbpl.190:15|
 :skolemid |22|
