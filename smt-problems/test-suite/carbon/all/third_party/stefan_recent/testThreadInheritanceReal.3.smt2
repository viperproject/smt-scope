...
(assert  (and (and (and (and (and (= (type Heap@@30) (MapType0Type RefType)) (= (type diz@@125) RefType)) (= (type freshObj@0) RefType)) (= (type Heap@0) (MapType0Type RefType))) (forall ((arg0@@77 T@U) ) (! (= (type (type_of arg0@@77)) TYPEDomainTypeType)
 :qid |funType:type_of|
