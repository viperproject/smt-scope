...
(declare-fun b_2@@6 () T@U)
(declare-fun Heap@@10 () T@U)
(assert  (and (= (type b_2@@6) (MapType2Type RefType boolType)) (= (type Heap@@10) (MapType0Type RefType))))
(set-info :boogie-vc-id |P#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((l_2 T@U) (l_2_1 T@U) ) (!  (=> (and (= (type l_2) RefType) (= (type l_2_1) RefType)) (=> (and (and (and (and (not (= l_2 l_2_1)) (U_2_bool (MapType2Select b_2@@6 l_2))) (U_2_bool (MapType2Select b_2@@6 l_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= l_2 l_2_1))))
 :qid |stdinbpl.455:15|
 :skolemid |89|
 :no-pattern (type l_2)
 :no-pattern (type l_2_1)
 :no-pattern (U_2_int l_2)
 :no-pattern (U_2_bool l_2)
 :no-pattern (U_2_int l_2_1)
 :no-pattern (U_2_bool l_2_1)
)))))
