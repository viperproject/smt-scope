...
(assert  (and (and (and (= (type Heap@@30) (MapType0Type RefType)) (= (type diz@@125) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |Worker__preFork_at_Worker#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@30 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@30 diz@@125 $allocated)) (<= NoPerm p_1@@89)) (=> (and (and (and (= Mask@0 (MapType1Store ZeroMask null (Worker__preFork_at_Thread diz@@125 p_1@@89) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Worker__preFork_at_Thread diz@@125 p_1@@89))) FullPerm)))) (state Heap@@30 Mask@0)) (and (> wildcard@0 NoPerm) (not (= diz@@125 null)))) (and (and (= Mask@1 (MapType1Store Mask@0 diz@@125 Worker__input (real_2_U (+ (U_2_real (MapType1Select Mask@0 diz@@125 Worker__input)) wildcard@0)))) (state Heap@@30 Mask@1)) (and (not (= p_1@@89 NoPerm)) (= (ControlFlow 0 2) (- 0 1))))) (>= p_1@@89 NoPerm))))))
...
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(set-info :boogie-vc-id Thread__start_at_Thread)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
...
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(set-info :boogie-vc-id Worker__join_at_Thread)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) true)
