...
(assert  (and (and (and (and (and (= (type UnfoldingMask@0) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type x@@48) RefType)) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Heap@@37) (MapType0Type RefType))) (forall ((arg0@@35 T@U) ) (! (= (type (FrameFragment arg0@@35)) FrameTypeType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (F x@@48) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (F x@@48))) FullPerm)))) (not (= x@@48 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x@@48 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@48 f_7)) FullPerm)))) (state Heap@@37 UnfoldingMask@1)) (and (state Heap@@37 UnfoldingMask@1) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm UnfoldingMask@1 x@@48 f_7)))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (F x@@48))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (F x@@48)))) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@37 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@37 x@@48 $allocated)) (= AssumeFunctionsAbove 1)) (and (= Mask@0 (MapType1Store ZeroMask null (F x@@48) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (F x@@48))) FullPerm)))) (state Heap@@37 Mask@0))) (and (and (not (= x@@48 null)) (state Heap@@37 Mask@0)) (and (|F#trigger| Heap@@37 (F x@@48)) (= (MapType0Select Heap@@37 null (F x@@48)) (FrameFragment (MapType0Select Heap@@37 x@@48 f_7)))))) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))
