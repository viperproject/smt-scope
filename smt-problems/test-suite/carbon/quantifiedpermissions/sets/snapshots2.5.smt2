...
(assert  (and (and (and (and (and (and (and (and (and (and (and (= (type xs@@4) (MapType1Type RefType boolType)) (= (type Heap@@13) (MapType0Type RefType))) (= (type QPMask@1) (MapType2Type RefType realType))) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv13 arg0@@45)) RefType)
 :qid |funType:invRecv13|
 :pattern ( (invRecv13 arg0@@45))
))) (= (type x@@24) RefType)) (= (type Heap@1) (MapType0Type RefType))) (= (type QPMask@2) (MapType2Type RefType realType))) (forall ((arg0@@46 T@U) ) (! (= (type (invRecv14 arg0@@46)) RefType)
 :qid |funType:invRecv14|
 :pattern ( (invRecv14 arg0@@46))
))) (= (type y@@6) RefType)) (= (type Heap@0) (MapType0Type RefType))) (forall ((arg0@@47 T@U) ) (! (= (type (invRecv12 arg0@@47)) RefType)
 :qid |funType:invRecv12|
 :pattern ( (invRecv12 arg0@@47))
))))
...
)) (=> (and (and (forall ((z_3@@3 T@U) ) (!  (=> (= (type z_3@@3) RefType) (=> (and (U_2_bool (MapType1Select xs@@4 z_3@@3)) (< NoPerm FullPerm)) (and (qpRange14 z_3@@3) (= (invRecv14 z_3@@3) z_3@@3))))
 :qid |stdinbpl.1463:26|
 :skolemid |167|
 :pattern ( (MapType0Select Heap@1 z_3@@3 f_7))
 :pattern ( (MapType2Select QPMask@2 z_3@@3 f_7))
 :pattern ( (MapType1Select xs@@4 z_3@@3))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType1Select xs@@4 (invRecv14 o_3))) (and (< NoPerm FullPerm) (qpRange14 o_3))) (= (invRecv14 o_3) o_3)))
 :qid |stdinbpl.1467:26|
 :skolemid |168|
 :pattern ( (invRecv14 o_3))
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType1Select xs@@4 (invRecv14 o_3@@0))) (and (< NoPerm FullPerm) (qpRange14 o_3@@0))) (and (= (invRecv14 o_3@@0) o_3@@0) (= (U_2_real (MapType2Select QPMask@2 o_3@@0 f_7)) (- (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType1Select xs@@4 (invRecv14 o_3@@0))) (and (< NoPerm FullPerm) (qpRange14 o_3@@0)))) (= (U_2_real (MapType2Select QPMask@2 o_3@@0 f_7)) (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7))))))
...
)) (=> (and (and (forall ((z_2@@3 T@U) ) (!  (=> (= (type z_2@@3) RefType) (=> (and (U_2_bool (MapType1Select xs@@4 z_2@@3)) (< NoPerm FullPerm)) (and (qpRange13 z_2@@3) (= (invRecv13 z_2@@3) z_2@@3))))
...
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType1Select xs@@4 (invRecv13 o_3@@2))) (and (< NoPerm FullPerm) (qpRange13 o_3@@2))) (= (invRecv13 o_3@@2) o_3@@2)))
 :qid |stdinbpl.1383:26|
 :skolemid |162|
 :pattern ( (invRecv13 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType1Select xs@@4 (invRecv13 o_3@@3))) (and (< NoPerm FullPerm) (qpRange13 o_3@@3))) (and (= (invRecv13 o_3@@3) o_3@@3) (= (U_2_real (MapType2Select QPMask@1 o_3@@3 f_7)) (- (U_2_real (MapType2Select QPMask@0 o_3@@3 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType1Select xs@@4 (invRecv13 o_3@@3))) (and (< NoPerm FullPerm) (qpRange13 o_3@@3)))) (= (U_2_real (MapType2Select QPMask@1 o_3@@3 f_7)) (U_2_real (MapType2Select QPMask@0 o_3@@3 f_7))))))
...
)) (=> (and (forall ((z_1@@1 T@U) ) (!  (=> (= (type z_1@@1) RefType) (=> (and (U_2_bool (MapType1Select xs@@4 z_1@@1)) (< NoPerm FullPerm)) (and (qpRange12 z_1@@1) (= (invRecv12 z_1@@1) z_1@@1))))
...
)) (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (U_2_bool (MapType1Select xs@@4 (invRecv12 o_3@@5))) (< NoPerm FullPerm)) (qpRange12 o_3@@5)) (= (invRecv12 o_3@@5) o_3@@5)))
...
)) (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (U_2_bool (MapType1Select xs@@4 (invRecv12 o_3@@6))) (< NoPerm FullPerm)) (qpRange12 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv12 o_3@@6) o_3@@6)) (= (U_2_real (MapType2Select QPMask@0 o_3@@6 f_7)) (+ (U_2_real (MapType2Select ZeroMask o_3@@6 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType1Select xs@@4 (invRecv12 o_3@@6))) (< NoPerm FullPerm)) (qpRange12 o_3@@6))) (= (U_2_real (MapType2Select QPMask@0 o_3@@6 f_7)) (U_2_real (MapType2Select ZeroMask o_3@@6 f_7))))))
