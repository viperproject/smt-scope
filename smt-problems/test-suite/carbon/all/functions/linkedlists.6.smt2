...
(let ((anon19_Then_correct  (=> (not (= (MapType0Select Heap@1 xs@@42 next) null)) (=> (and (and (forall ((o_9 T@U) (f_13 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_13))))
(let ((A@@12 (FieldTypeInv0 (type f_13))))
 (=> (and (and (= (type o_9) RefType) (= (type f_13) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|list#sm| xs@@42)) o_9 f_13)) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|list#sm| (MapType0Select Heap@1 xs@@42 next))) o_9 f_13)))) (U_2_bool (MapType1Select newPMask@0 o_9 f_13)))))
...
(let ((anon17_Else_correct  (=> (and (|elems#trigger| (MapType0Select Heap@@47 null (list (MapType0Select Heap@@47 xs@@42 next))) (MapType0Select Heap@@47 xs@@42 next)) (= (ControlFlow 0 11) 9)) anon11_correct)))
(let ((anon16_Then_correct  (=> (and (= (MapType0Select Heap@@47 xs@@42 next) null) (= (ControlFlow 0 10) 9)) anon11_correct)))
...
(let ((anon16_Else_correct  (=> (not (= (MapType0Select Heap@@47 xs@@42 next) null)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm UnfoldingMask@4 xs@@42 next)) (=> (HasDirectPerm UnfoldingMask@4 xs@@42 next) (and (and (=> (= (ControlFlow 0 12) 11) anon17_Else_correct) (=> (= (ControlFlow 0 12) 3) anon18_Then_correct)) (=> (= (ControlFlow 0 12) 5) anon18_Else_correct)))))))
(let ((anon4_correct  (=> (state Heap@@47 UnfoldingMask@4) (and (=> (= (ControlFlow 0 14) (- 0 16)) (HasDirectPerm UnfoldingMask@4 xs@@42 val)) (=> (HasDirectPerm UnfoldingMask@4 xs@@42 val) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm UnfoldingMask@4 xs@@42 next)) (=> (HasDirectPerm UnfoldingMask@4 xs@@42 next) (and (=> (= (ControlFlow 0 14) 10) anon16_Then_correct) (=> (= (ControlFlow 0 14) 12) anon16_Else_correct)))))))))
(let ((anon15_Else_correct  (=> (= (MapType0Select Heap@@47 xs@@42 next) null) (=> (and (= UnfoldingMask@4 UnfoldingMask@2) (= (ControlFlow 0 18) 14)) anon4_correct))))
