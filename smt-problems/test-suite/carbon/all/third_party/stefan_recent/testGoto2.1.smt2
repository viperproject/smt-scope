...
(assert  (and (= (type Heap@@17) (MapType0Type RefType)) (= (type diz) RefType)))
(set-info :boogie-vc-id Ref__t2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon6_Else_correct  (=> (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask)) (=> (and (and (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask)) (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask))) (and (and (state Heap@@17 ZeroMask) (state Heap@@17 ZeroMask)) (and (state Heap@@17 ZeroMask) (= (ControlFlow 0 3) (- 0 4))))) (> n 0)))))
(let ((anon6_Then_correct true))
(let ((anon0_correct  (=> (and (and (and (state Heap@@17 ZeroMask) (U_2_bool (MapType0Select Heap@@17 diz $allocated))) (and (not (= diz null)) (state Heap@@17 ZeroMask))) (and (and (>= current_thread_id 0) (state Heap@@17 ZeroMask)) (and (> n 0) (state Heap@@17 ZeroMask)))) (and (=> (= (ControlFlow 0 5) 1) anon6_Then_correct) (=> (= (ControlFlow 0 5) 3) anon6_Else_correct)))))
