...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@@61) (MapType0Type RefType)) (= (type UnfoldingMask@5) (MapType1Type RefType realType))) (= (type this@@66) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (= (type UnfoldingMask@3) (MapType1Type RefType realType))) (= (type UnfoldingMask@4) (MapType1Type RefType realType))) (forall ((arg0@@40 T@U) (arg1@@19 T@U) ) (! (= (type (CombineFrames arg0@@40 arg1@@19)) FrameTypeType)
...
(set-info :boogie-vc-id |treeDegree#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon6_correct  (=> (state Heap@@61 UnfoldingMask@5) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm UnfoldingMask@5 this@@66 degree)) (=> (HasDirectPerm UnfoldingMask@5 this@@66 degree) (=> (= Heap@0 (MapType0Store Heap@@61 null (|tree#sm| this@@66) (MapType1Store (MapType0Select Heap@@61 null (|tree#sm| this@@66)) this@@66 key (bool_2_U true)))) (=> (and (and (and (= Heap@1 (MapType0Store Heap@0 null (|tree#sm| this@@66) (MapType1Store (MapType0Select Heap@0 null (|tree#sm| this@@66)) this@@66 degree (bool_2_U true)))) (= Heap@2 (MapType0Store Heap@1 null (|tree#sm| this@@66) (MapType1Store (MapType0Select Heap@1 null (|tree#sm| this@@66)) this@@66 child (bool_2_U true))))) (and (= Heap@3 (MapType0Store Heap@2 null (|tree#sm| this@@66) (MapType1Store (MapType0Select Heap@2 null (|tree#sm| this@@66)) this@@66 parent (bool_2_U true)))) (forall ((o_4 T@U) (f_8 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_8))))
(let ((A@@12 (FieldTypeInv0 (type f_8))))
 (=> (and (and (= (type o_4) RefType) (= (type f_8) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@3 null (|tree#sm| this@@66)) o_4 f_8)) (U_2_bool (MapType1Select (MapType0Select Heap@3 null (|heapseg#sm| (MapType0Select Heap@3 this@@66 child) null)) o_4 f_8)))) (U_2_bool (MapType1Select newPMask@0 o_4 f_8)))))
 :qid |stdinbpl.466:31|
 :skolemid |32|
 :pattern ( (MapType1Select newPMask@0 o_4 f_8))
)))) (and (and (= Heap@4 (MapType0Store Heap@3 null (|tree#sm| this@@66) newPMask@0)) (state Heap@4 Mask@0)) (and (= Result@0 (U_2_int (MapType0Select Heap@4 this@@66 degree))) (= (ControlFlow 0 2) (- 0 1))))) (<= 0 Result@0))))))))
(let ((anon9_Else_correct  (=> (and (= (MapType0Select Heap@@61 this@@66 child) null) (= (ControlFlow 0 5) 2)) anon6_correct)))
(let ((anon9_Then_correct  (=> (and (and (not (= (MapType0Select Heap@@61 this@@66 child) null)) (state Heap@@61 UnfoldingMask@5)) (and (= (segParent Heap@@61 (MapType0Select Heap@@61 this@@66 child) null) this@@66) (= (ControlFlow 0 4) 2))) anon6_correct)))
(let ((anon4_correct  (=> (and (state Heap@@61 UnfoldingMask@5) (validChildren Heap@@61 (MapType0Select Heap@@61 this@@66 child) null)) (and (=> (= (ControlFlow 0 6) 4) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (<= (U_2_int (MapType0Select Heap@@61 this@@66 degree)) 0) (= (ControlFlow 0 8) 6)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (and (< 0 (U_2_int (MapType0Select Heap@@61 this@@66 degree))) (state Heap@@61 UnfoldingMask@5)) (and (= (segDegree Heap@@61 (MapType0Select Heap@@61 this@@66 child) null 0) (- (U_2_int (MapType0Select Heap@@61 this@@66 degree)) 1)) (= (ControlFlow 0 7) 6))) anon4_correct)))
(let ((anon2_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (tree this@@66) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (tree this@@66))) FullPerm)))) (=> (and (not (= this@@66 null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this@@66 key (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this@@66 key)) FullPerm))))) (=> (and (and (and (and (state Heap@@61 UnfoldingMask@1) (not (= this@@66 null))) (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 this@@66 degree (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 this@@66 degree)) FullPerm)))) (state Heap@@61 UnfoldingMask@2))) (and (and (not (= this@@66 null)) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 this@@66 child (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 this@@66 child)) FullPerm))))) (and (state Heap@@61 UnfoldingMask@3) (not (= this@@66 null))))) (and (and (and (= UnfoldingMask@4 (MapType1Store UnfoldingMask@3 this@@66 parent (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@3 this@@66 parent)) FullPerm)))) (state Heap@@61 UnfoldingMask@4)) (and (<= 0 (U_2_int (MapType0Select Heap@@61 this@@66 degree))) (= UnfoldingMask@5 (MapType1Store UnfoldingMask@4 null (heapseg (MapType0Select Heap@@61 this@@66 child) null) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@4 null (heapseg (MapType0Select Heap@@61 this@@66 child) null))) FullPerm)))))) (and (and (InsidePredicate (tree this@@66) (MapType0Select Heap@@61 null (tree this@@66)) (heapseg (MapType0Select Heap@@61 this@@66 child) null) (MapType0Select Heap@@61 null (heapseg (MapType0Select Heap@@61 this@@66 child) null))) (state Heap@@61 UnfoldingMask@5)) (and (state Heap@@61 UnfoldingMask@5) (= (U_2_int (MapType0Select Heap@@61 this@@66 degree)) (segLength Heap@@61 (MapType0Select Heap@@61 this@@66 child) null)))))) (and (=> (= (ControlFlow 0 9) 7) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct)))))))
(let ((anon7_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (tree this@@66))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (tree this@@66)))) (=> (= (ControlFlow 0 10) 9) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@61 ZeroMask) (U_2_bool (MapType0Select Heap@@61 this@@66 $allocated))) (and (= AssumeFunctionsAbove 9) (= Mask@0 (MapType1Store ZeroMask null (tree this@@66) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (tree this@@66))) FullPerm)))))) (and (and (state Heap@@61 Mask@0) (state Heap@@61 Mask@0)) (and (|tree#trigger| Heap@@61 (tree this@@66)) (= (MapType0Select Heap@@61 null (tree this@@66)) (CombineFrames (FrameFragment (MapType0Select Heap@@61 this@@66 key)) (CombineFrames (FrameFragment (MapType0Select Heap@@61 this@@66 degree)) (CombineFrames (FrameFragment (MapType0Select Heap@@61 this@@66 child)) (CombineFrames (FrameFragment (MapType0Select Heap@@61 this@@66 parent)) (CombineFrames (MapType0Select Heap@@61 null (heapseg (MapType0Select Heap@@61 this@@66 child) null)) (CombineFrames (FrameFragment (ite (< 0 (U_2_int (MapType0Select Heap@@61 this@@66 degree))) EmptyFrame EmptyFrame)) (FrameFragment (ite (not (= (MapType0Select Heap@@61 this@@66 child) null)) EmptyFrame EmptyFrame)))))))))))) (and (=> (= (ControlFlow 0 13) 10) anon7_Then_correct) (=> (= (ControlFlow 0 13) 12) anon7_Else_correct)))))
...
(declare-fun Mask@0 () T@U)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type this@@66) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type sibl) RefType)) (= (type Mask@21) (MapType1Type RefType realType))) (= (type Mask@20) (MapType1Type RefType realType))) (= (type res@1) RefType)) (= (type Heap@18) (MapType0Type RefType))) (= (type Heap@@61) (MapType0Type RefType))) (= (type Heap@10) (MapType0Type RefType))) (= (type Mask@11) (MapType1Type RefType realType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@6) (MapType0Type RefType))) (= (type Heap@7) (MapType0Type RefType))) (= (type Heap@8) (MapType0Type RefType))) (= (type newPMask@1) (MapType1Type RefType boolType))) (= (type Heap@9) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@10) (MapType1Type RefType realType))) (forall ((arg0@@40 T@U) ) (! (= (type (FrameFragment arg0@@40)) FrameTypeType)
 :qid |funType:FrameFragment|
...
))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type Mask@9) (MapType1Type RefType realType))) (= (type Mask@8) (MapType1Type RefType realType))) (= (type Mask@7) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@17) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@18) (MapType1Type RefType realType))) (= (type res@0) RefType)) (= (type Mask@19) (MapType1Type RefType realType))) (= (type ss@0) RefType)) (= (type Mask@17) (MapType1Type RefType realType))) (= (type Mask@16) (MapType1Type RefType realType))) (= (type newPMask@2) (MapType1Type RefType boolType))) (= (type Heap@13) (MapType0Type RefType))) (= (type Heap@14) (MapType0Type RefType))) (= (type Heap@15) (MapType0Type RefType))) (= (type newPMask@3) (MapType1Type RefType boolType))) (= (type Heap@16) (MapType0Type RefType))) (= (type Heap@11) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@12) (MapType0Type RefType))) (= (type freshVersion@1) FrameTypeType)) (= (type Mask@15) (MapType1Type RefType realType))) (= (type Mask@14) (MapType1Type RefType realType))) (= (type Mask@13) (MapType1Type RefType realType))) (= (type Mask@12) (MapType1Type RefType realType))) (= (type ss) RefType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type res) RefType)) (= (type PostMask@1) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type Mask@23) (MapType1Type RefType realType))) (= (type Mask@22) (MapType1Type RefType realType))) (= (type Mask@25) (MapType1Type RefType realType))) (= (type Mask@24) (MapType1Type RefType realType))))
(set-info :boogie-vc-id reverse2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 166) (let ((anon20_correct  (=> (and (= Mask@24 (MapType1Store Mask@1 null (heapseg sibl null) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (heapseg sibl null))) FullPerm)))) (= (ControlFlow 0 157) (- 0 156))) (< 0 (segLength Heap@@61 sibl null)))))
(let ((anon115_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 160) 157)) anon20_correct)))
(let ((anon115_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 158) (- 0 159)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (heapseg sibl null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (heapseg sibl null)))) (=> (= (ControlFlow 0 158) 157) anon20_correct))))))
(let ((anon16_correct  (=> (and (= Mask@25 (MapType1Store Mask@1 null (heapseg this@@66 null) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (heapseg this@@66 null))) FullPerm)))) (= (ControlFlow 0 152) (- 0 151))) (< 0 (segLength Heap@@61 this@@66 null)))))
(let ((anon113_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 155) 152)) anon16_correct)))
(let ((anon113_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 153) (- 0 154)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (heapseg this@@66 null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (heapseg this@@66 null)))) (=> (= (ControlFlow 0 153) 152) anon16_correct))))))
(let ((anon30_correct  (=> (and (= Mask@22 (MapType1Store Mask@1 null (heapseg sibl null) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (heapseg sibl null))) FullPerm)))) (= (ControlFlow 0 143) (- 0 142))) (not (= sibl null)))))
(let ((anon120_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 146) 143)) anon30_correct)))
(let ((anon120_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 144) (- 0 145)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (heapseg sibl null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (heapseg sibl null)))) (=> (= (ControlFlow 0 144) 143) anon30_correct))))))
(let ((anon26_correct  (=> (and (= Mask@23 (MapType1Store Mask@1 null (heapseg this@@66 null) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (heapseg this@@66 null))) FullPerm)))) (= (ControlFlow 0 138) (- 0 137))) (not (= this@@66 null)))))
(let ((anon118_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 141) 138)) anon26_correct)))
(let ((anon118_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 139) (- 0 140)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (heapseg this@@66 null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (heapseg this@@66 null)))) (=> (= (ControlFlow 0 139) 138) anon26_correct))))))
(let ((anon56_correct  (=> (= (ControlFlow 0 127) (- 0 126)) (not (= this@@66 null)))))
(let ((anon133_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 130) 127)) anon56_correct)))
(let ((anon133_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 128) (- 0 129)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (heapseg this@@66 null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (heapseg this@@66 null)))) (=> (= (ControlFlow 0 128) 127) anon56_correct))))))
(let ((anon52_correct  (=> (and (= PostMask@1 (MapType1Store PostMask@0 null (heapseg res null) (real_2_U (- (U_2_real (MapType1Select PostMask@0 null (heapseg res null))) FullPerm)))) (= (ControlFlow 0 122) (- 0 121))) (not (= res null)))))
(let ((anon131_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 125) 122)) anon52_correct)))
(let ((anon131_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 123) (- 0 124)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (heapseg res null))))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (heapseg res null)))) (=> (= (ControlFlow 0 123) 122) anon52_correct))))))
(let ((anon132_Else_correct true))
(let ((anon128_Else_correct  (=> (= (segSize PostHeap@0 res null) (+ (segSize Heap@@61 this@@66 null) (segSize Heap@@61 sibl null))) (=> (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)) (and (and (and (and (=> (= (ControlFlow 0 131) 120) anon132_Else_correct) (=> (= (ControlFlow 0 131) 128) anon133_Then_correct)) (=> (= (ControlFlow 0 131) 130) anon133_Else_correct)) (=> (= (ControlFlow 0 131) 123) anon131_Then_correct)) (=> (= (ControlFlow 0 131) 125) anon131_Else_correct))))))
(let ((anon48_correct true))
(let ((anon129_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 119) 116)) anon48_correct)))
(let ((anon129_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 117) (- 0 118)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (heapseg sibl null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (heapseg sibl null)))) (=> (= (ControlFlow 0 117) 116) anon48_correct))))))
(let ((anon44_correct true))
(let ((anon127_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 115) 112)) anon44_correct)))
(let ((anon127_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 113) (- 0 114)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (heapseg this@@66 null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (heapseg this@@66 null)))) (=> (= (ControlFlow 0 113) 112) anon44_correct))))))
(let ((anon40_correct true))
(let ((anon125_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 111) 108)) anon40_correct)))
(let ((anon125_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 109) (- 0 110)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (heapseg res null))))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (heapseg res null)))) (=> (= (ControlFlow 0 109) 108) anon40_correct))))))
(let ((anon122_Else_correct  (=> (sorted PostHeap@0 res null) (=> (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)) (and (and (and (and (and (and (=> (= (ControlFlow 0 132) 131) anon128_Else_correct) (=> (= (ControlFlow 0 132) 117) anon129_Then_correct)) (=> (= (ControlFlow 0 132) 119) anon129_Else_correct)) (=> (= (ControlFlow 0 132) 113) anon127_Then_correct)) (=> (= (ControlFlow 0 132) 115) anon127_Else_correct)) (=> (= (ControlFlow 0 132) 109) anon125_Then_correct)) (=> (= (ControlFlow 0 132) 111) anon125_Else_correct))))))
(let ((anon36_correct true))
(let ((anon123_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 107) 104)) anon36_correct)))
(let ((anon123_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 105) (- 0 106)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (heapseg res null))))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (heapseg res null)))) (=> (= (ControlFlow 0 105) 104) anon36_correct))))))
(let ((anon121_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (not (= res null)) (state PostHeap@0 ZeroMask)) (=> (and (and (= PostMask@0 (MapType1Store ZeroMask null (heapseg res null) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (heapseg res null))) FullPerm)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (and (=> (= (ControlFlow 0 133) 132) anon122_Else_correct) (=> (= (ControlFlow 0 133) 105) anon123_Then_correct)) (=> (= (ControlFlow 0 133) 107) anon123_Else_correct)))))))
(let ((anon104_correct  (=> (= Mask@21 (MapType1Store Mask@20 null (heapseg res@1 null) (real_2_U (- (U_2_real (MapType1Select Mask@20 null (heapseg res@1 null))) FullPerm)))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (sorted Heap@18 res@1 null)) (=> (sorted Heap@18 res@1 null) (and (=> (= (ControlFlow 0 14) (- 0 15)) (= (segSize Heap@18 res@1 null) (+ (segSize Heap@@61 this@@66 null) (segSize Heap@@61 sibl null)))) (=> (= (segSize Heap@18 res@1 null) (+ (segSize Heap@@61 this@@66 null) (segSize Heap@@61 sibl null))) (=> (= (ControlFlow 0 14) (- 0 13)) (= (segParent Heap@18 res@1 null) (segParent Heap@@61 this@@66 null))))))))))
(let ((anon157_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 19) 14)) anon104_correct)))
(let ((anon157_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (<= FullPerm (U_2_real (MapType1Select Mask@20 null (heapseg res@1 null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@20 null (heapseg res@1 null)))) (=> (= (ControlFlow 0 17) 14) anon104_correct))))))
(let ((anon102_correct  (=> (state Heap@18 Mask@20) (and (=> (= (ControlFlow 0 20) (- 0 21)) (not (= res@1 null))) (=> (not (= res@1 null)) (and (=> (= (ControlFlow 0 20) 17) anon157_Then_correct) (=> (= (ControlFlow 0 20) 19) anon157_Else_correct)))))))
(let ((anon87_correct  (=> (IdenticalOnKnownLocations Heap@17 ExhaleHeap@0 Mask@18) (=> (and (and (and (and (not (= res@0 null)) (= Mask@19 (MapType1Store Mask@18 null (heapseg res@0 null) (real_2_U (+ (U_2_real (MapType1Select Mask@18 null (heapseg res@0 null))) FullPerm))))) (and (state ExhaleHeap@0 Mask@19) (state ExhaleHeap@0 Mask@19))) (and (and (sorted ExhaleHeap@0 res@0 null) (state ExhaleHeap@0 Mask@19)) (and (= (segSize ExhaleHeap@0 res@0 null) (+ (segSize Heap@17 ss@0 null) (segSize Heap@17 this@@66 null))) (state ExhaleHeap@0 Mask@19)))) (and (and (and (= (segParent ExhaleHeap@0 res@0 null) (segParent Heap@17 ss@0 null)) (state ExhaleHeap@0 Mask@19)) (and (U_2_bool (MapType0Select ExhaleHeap@0 res@0 $allocated)) (state ExhaleHeap@0 Mask@19))) (and (and (= Mask@20 Mask@19) (= Heap@18 ExhaleHeap@0)) (and (= res@1 res@0) (= (ControlFlow 0 47) 20))))) anon102_correct))))
(let ((anon149_Else_correct  (=> (and (= this@@66 null) (= (ControlFlow 0 50) 47)) anon87_correct)))
(let ((anon149_Then_correct  (=> (not (= this@@66 null)) (and (=> (= (ControlFlow 0 48) (- 0 49)) (= (segParent Heap@17 ss@0 null) (segParent Heap@17 this@@66 null))) (=> (= (segParent Heap@17 ss@0 null) (segParent Heap@17 this@@66 null)) (=> (= (ControlFlow 0 48) 47) anon87_correct))))))
(let ((anon148_Else_correct  (=> (= this@@66 null) (and (=> (= (ControlFlow 0 53) 48) anon149_Then_correct) (=> (= (ControlFlow 0 53) 50) anon149_Else_correct)))))
(let ((anon148_Then_correct  (=> (not (= this@@66 null)) (and (=> (= (ControlFlow 0 51) (- 0 52)) (< (segDegree Heap@17 ss@0 null 0) (segDegree Heap@17 this@@66 null 0))) (=> (< (segDegree Heap@17 ss@0 null 0) (segDegree Heap@17 this@@66 null 0)) (and (=> (= (ControlFlow 0 51) 48) anon149_Then_correct) (=> (= (ControlFlow 0 51) 50) anon149_Else_correct)))))))
(let ((anon83_correct  (=> (= Mask@18 (MapType1Store Mask@17 null (heapseg this@@66 null) (real_2_U (- (U_2_real (MapType1Select Mask@17 null (heapseg this@@66 null))) FullPerm)))) (and (=> (= (ControlFlow 0 54) (- 0 55)) (sorted Heap@17 this@@66 null)) (=> (sorted Heap@17 this@@66 null) (and (=> (= (ControlFlow 0 54) 51) anon148_Then_correct) (=> (= (ControlFlow 0 54) 53) anon148_Else_correct)))))))
(let ((anon147_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 58) 54)) anon83_correct)))
(let ((anon147_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 56) (- 0 57)) (<= FullPerm (U_2_real (MapType1Select Mask@17 null (heapseg this@@66 null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@17 null (heapseg this@@66 null)))) (=> (= (ControlFlow 0 56) 54) anon83_correct))))))
(let ((anon81_correct  (=> (= Mask@17 (MapType1Store Mask@16 null (heapseg ss@0 null) (real_2_U (- (U_2_real (MapType1Select Mask@16 null (heapseg ss@0 null))) FullPerm)))) (and (=> (= (ControlFlow 0 59) (- 0 61)) (validChildren Heap@17 ss@0 null)) (=> (validChildren Heap@17 ss@0 null) (and (=> (= (ControlFlow 0 59) (- 0 60)) (< 0 (segLength Heap@17 ss@0 null))) (=> (< 0 (segLength Heap@17 ss@0 null)) (and (=> (= (ControlFlow 0 59) 56) anon147_Then_correct) (=> (= (ControlFlow 0 59) 58) anon147_Else_correct)))))))))
(let ((anon146_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 64) 59)) anon81_correct)))
(let ((anon146_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 62) (- 0 63)) (<= FullPerm (U_2_real (MapType1Select Mask@16 null (heapseg ss@0 null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@16 null (heapseg ss@0 null)))) (=> (= (ControlFlow 0 62) 59) anon81_correct))))))
(let ((anon79_correct  (=> (and (state Heap@17 Mask@16) (state Heap@17 Mask@16)) (and (=> (= (ControlFlow 0 65) 62) anon146_Then_correct) (=> (= (ControlFlow 0 65) 64) anon146_Else_correct)))))
(let ((anon145_Else_correct  (=> (= this@@66 null) (=> (and (= Heap@17 Heap@13) (= (ControlFlow 0 67) 65)) anon79_correct))))
(let ((anon145_Then_correct  (=> (and (and (and (not (= this@@66 null)) (forall ((o_23 T@U) (f_27 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_27))))
(let ((A@@12 (FieldTypeInv0 (type f_27))))
 (=> (and (and (= (type o_23) RefType) (= (type f_27) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@13 null (|heapseg#sm| this@@66 null)) o_23 f_27)) (U_2_bool (MapType1Select (MapType0Select Heap@13 null (|tree#sm| this@@66)) o_23 f_27)))) (U_2_bool (MapType1Select newPMask@2 o_23 f_27)))))
 :qid |stdinbpl.3091:33|
 :skolemid |109|
 :pattern ( (MapType1Select newPMask@2 o_23 f_27))
))) (and (= Heap@14 (MapType0Store Heap@13 null (|heapseg#sm| this@@66 null) newPMask@2)) (= Heap@15 (MapType0Store Heap@14 null (|heapseg#sm| this@@66 null) (MapType1Store (MapType0Select Heap@14 null (|heapseg#sm| this@@66 null)) this@@66 sibling (bool_2_U true)))))) (and (and (forall ((o_24 T@U) (f_28 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_28))))
(let ((A@@13 (FieldTypeInv0 (type f_28))))
 (=> (and (and (= (type o_24) RefType) (= (type f_28) (FieldType A@@13 B@@12))) (or (U_2_bool (MapType1Select (MapType0Select Heap@15 null (|heapseg#sm| this@@66 null)) o_24 f_28)) (U_2_bool (MapType1Select (MapType0Select Heap@15 null (|heapseg#sm| (MapType0Select Heap@15 this@@66 sibling) null)) o_24 f_28)))) (U_2_bool (MapType1Select newPMask@3 o_24 f_28)))))
 :qid |stdinbpl.3098:33|
 :skolemid |110|
 :pattern ( (MapType1Select newPMask@3 o_24 f_28))
)) (= Heap@16 (MapType0Store Heap@15 null (|heapseg#sm| this@@66 null) newPMask@3))) (and (= Heap@17 Heap@16) (= (ControlFlow 0 66) 65)))) anon79_correct)))
(let ((anon144_Else_correct  (=> (and (HasDirectPerm Mask@16 null (heapseg this@@66 null)) (= Heap@13 Heap@2)) (and (=> (= (ControlFlow 0 69) 66) anon145_Then_correct) (=> (= (ControlFlow 0 69) 67) anon145_Else_correct)))))
(let ((anon144_Then_correct  (=> (and (and (not (HasDirectPerm Mask@16 null (heapseg this@@66 null))) (= Heap@11 (MapType0Store Heap@2 null (|heapseg#sm| this@@66 null) ZeroPMask))) (and (= Heap@12 (MapType0Store Heap@11 null (heapseg this@@66 null) freshVersion@1)) (= Heap@13 Heap@12))) (and (=> (= (ControlFlow 0 68) 66) anon145_Then_correct) (=> (= (ControlFlow 0 68) 67) anon145_Else_correct)))))
(let ((anon75_correct  (=> (= Mask@16 (MapType1Store Mask@15 null (heapseg this@@66 null) (real_2_U (+ (U_2_real (MapType1Select Mask@15 null (heapseg this@@66 null))) FullPerm)))) (=> (and (and (state Heap@2 Mask@16) (state Heap@2 Mask@16)) (and (|heapseg#trigger| Heap@2 (heapseg this@@66 null)) (= (MapType0Select Heap@2 null (heapseg this@@66 null)) (FrameFragment (ite (not (= this@@66 null)) (CombineFrames (MapType0Select Heap@2 null (tree this@@66)) (CombineFrames (FrameFragment (MapType0Select Heap@2 this@@66 sibling)) (CombineFrames (MapType0Select Heap@2 null (heapseg (MapType0Select Heap@2 this@@66 sibling) null)) (FrameFragment (ite (not (= (MapType0Select Heap@2 this@@66 sibling) null)) EmptyFrame EmptyFrame))))) EmptyFrame))))) (and (=> (= (ControlFlow 0 70) 68) anon144_Then_correct) (=> (= (ControlFlow 0 70) 69) anon144_Else_correct))))))
(let ((anon143_Else_correct  (=> (= (MapType0Select Heap@2 this@@66 sibling) null) (=> (and (= Mask@15 Mask@14) (= (ControlFlow 0 74) 70)) anon75_correct))))
(let ((anon143_Then_correct  (=> (not (= (MapType0Select Heap@2 this@@66 sibling) null)) (and (=> (= (ControlFlow 0 72) (- 0 73)) (= (treeParent Heap@2 this@@66) (segParent Heap@2 (MapType0Select Heap@2 this@@66 sibling) null))) (=> (= (treeParent Heap@2 this@@66) (segParent Heap@2 (MapType0Select Heap@2 this@@66 sibling) null)) (=> (and (= Mask@15 Mask@14) (= (ControlFlow 0 72) 70)) anon75_correct))))))
(let ((anon73_correct  (=> (and (= Mask@14 (MapType1Store Mask@13 null (heapseg (MapType0Select Heap@2 this@@66 sibling) null) (real_2_U (- (U_2_real (MapType1Select Mask@13 null (heapseg (MapType0Select Heap@2 this@@66 sibling) null))) FullPerm)))) (InsidePredicate (heapseg this@@66 null) (MapType0Select Heap@2 null (heapseg this@@66 null)) (heapseg (MapType0Select Heap@2 this@@66 sibling) null) (MapType0Select Heap@2 null (heapseg (MapType0Select Heap@2 this@@66 sibling) null)))) (and (=> (= (ControlFlow 0 75) 72) anon143_Then_correct) (=> (= (ControlFlow 0 75) 74) anon143_Else_correct)))))
(let ((anon142_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 78) 75)) anon73_correct)))
(let ((anon142_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 76) (- 0 77)) (<= FullPerm (U_2_real (MapType1Select Mask@13 null (heapseg (MapType0Select Heap@2 this@@66 sibling) null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@13 null (heapseg (MapType0Select Heap@2 this@@66 sibling) null)))) (=> (= (ControlFlow 0 76) 75) anon73_correct))))))
(let ((anon71_correct  (=> (= Mask@13 (MapType1Store Mask@12 this@@66 sibling (real_2_U (- (U_2_real (MapType1Select Mask@12 this@@66 sibling)) FullPerm)))) (and (=> (= (ControlFlow 0 79) 76) anon142_Then_correct) (=> (= (ControlFlow 0 79) 78) anon142_Else_correct)))))
(let ((anon141_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 82) 79)) anon71_correct)))
(let ((anon141_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 80) (- 0 81)) (<= FullPerm (U_2_real (MapType1Select Mask@12 this@@66 sibling)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@12 this@@66 sibling))) (=> (= (ControlFlow 0 80) 79) anon71_correct))))))
(let ((anon69_correct  (=> (and (= Mask@12 (MapType1Store Mask@6 null (tree this@@66) (real_2_U (- (U_2_real (MapType1Select Mask@6 null (tree this@@66))) FullPerm)))) (InsidePredicate (heapseg this@@66 null) (MapType0Select Heap@2 null (heapseg this@@66 null)) (tree this@@66) (MapType0Select Heap@2 null (tree this@@66)))) (and (=> (= (ControlFlow 0 83) 80) anon141_Then_correct) (=> (= (ControlFlow 0 83) 82) anon141_Else_correct)))))
(let ((anon140_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 86) 83)) anon69_correct)))
(let ((anon140_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 84) (- 0 85)) (<= FullPerm (U_2_real (MapType1Select Mask@6 null (tree this@@66))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@6 null (tree this@@66)))) (=> (= (ControlFlow 0 84) 83) anon69_correct))))))
(let ((anon139_Then_correct  (=> (not (= this@@66 null)) (and (=> (= (ControlFlow 0 87) 84) anon140_Then_correct) (=> (= (ControlFlow 0 87) 86) anon140_Else_correct)))))
(let ((anon139_Else_correct  (=> (= this@@66 null) (=> (and (= Mask@15 Mask@6) (= (ControlFlow 0 71) 70)) anon75_correct))))
(let ((anon138_Then_correct  (=> (and (not (= (MapType0Select Heap@1 this@@66 sibling) null)) (U_2_bool (MapType0Select Heap@1 ss $allocated))) (and (=> (= (ControlFlow 0 88) (- 0 90)) (HasDirectPerm Mask@6 this@@66 sibling)) (=> (HasDirectPerm Mask@6 this@@66 sibling) (=> (and (= ss@0 (MapType0Select Heap@1 this@@66 sibling)) (state Heap@1 Mask@6)) (and (=> (= (ControlFlow 0 88) (- 0 89)) (= FullPerm (U_2_real (MapType1Select Mask@6 this@@66 sibling)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@6 this@@66 sibling))) (=> (and (= Heap@2 (MapType0Store Heap@1 this@@66 sibling sibl)) (state Heap@2 Mask@6)) (and (=> (= (ControlFlow 0 88) 87) anon139_Then_correct) (=> (= (ControlFlow 0 88) 71) anon139_Else_correct)))))))))))
(let ((anon101_correct  (=> (and (state Heap@10 Mask@11) (state Heap@10 Mask@11)) (=> (and (and (= Mask@20 Mask@11) (= Heap@18 Heap@10)) (and (= res@1 this@@66) (= (ControlFlow 0 22) 20))) anon102_correct))))
(let ((anon156_Else_correct  (=> (= this@@66 null) (=> (and (= Heap@10 Heap@6) (= (ControlFlow 0 24) 22)) anon101_correct))))
(let ((anon156_Then_correct  (=> (and (and (and (not (= this@@66 null)) (forall ((o_25 T@U) (f_29 T@U) ) (! (let ((B@@13 (FieldTypeInv1 (type f_29))))
(let ((A@@14 (FieldTypeInv0 (type f_29))))
 (=> (and (and (= (type o_25) RefType) (= (type f_29) (FieldType A@@14 B@@13))) (or (U_2_bool (MapType1Select (MapType0Select Heap@6 null (|heapseg#sm| this@@66 null)) o_25 f_29)) (U_2_bool (MapType1Select (MapType0Select Heap@6 null (|tree#sm| this@@66)) o_25 f_29)))) (U_2_bool (MapType1Select newPMask@0 o_25 f_29)))))
 :qid |stdinbpl.3220:33|
 :skolemid |111|
 :pattern ( (MapType1Select newPMask@0 o_25 f_29))
))) (and (= Heap@7 (MapType0Store Heap@6 null (|heapseg#sm| this@@66 null) newPMask@0)) (= Heap@8 (MapType0Store Heap@7 null (|heapseg#sm| this@@66 null) (MapType1Store (MapType0Select Heap@7 null (|heapseg#sm| this@@66 null)) this@@66 sibling (bool_2_U true)))))) (and (and (forall ((o_26 T@U) (f_30 T@U) ) (! (let ((B@@14 (FieldTypeInv1 (type f_30))))
(let ((A@@15 (FieldTypeInv0 (type f_30))))
 (=> (and (and (= (type o_26) RefType) (= (type f_30) (FieldType A@@15 B@@14))) (or (U_2_bool (MapType1Select (MapType0Select Heap@8 null (|heapseg#sm| this@@66 null)) o_26 f_30)) (U_2_bool (MapType1Select (MapType0Select Heap@8 null (|heapseg#sm| (MapType0Select Heap@8 this@@66 sibling) null)) o_26 f_30)))) (U_2_bool (MapType1Select newPMask@1 o_26 f_30)))))
 :qid |stdinbpl.3227:33|
 :skolemid |112|
 :pattern ( (MapType1Select newPMask@1 o_26 f_30))
)) (= Heap@9 (MapType0Store Heap@8 null (|heapseg#sm| this@@66 null) newPMask@1))) (and (= Heap@10 Heap@9) (= (ControlFlow 0 23) 22)))) anon101_correct)))
(let ((anon155_Else_correct  (=> (and (HasDirectPerm Mask@11 null (heapseg this@@66 null)) (= Heap@6 Heap@3)) (and (=> (= (ControlFlow 0 26) 23) anon156_Then_correct) (=> (= (ControlFlow 0 26) 24) anon156_Else_correct)))))
(let ((anon155_Then_correct  (=> (and (and (not (HasDirectPerm Mask@11 null (heapseg this@@66 null))) (= Heap@4 (MapType0Store Heap@3 null (|heapseg#sm| this@@66 null) ZeroPMask))) (and (= Heap@5 (MapType0Store Heap@4 null (heapseg this@@66 null) freshVersion@0)) (= Heap@6 Heap@5))) (and (=> (= (ControlFlow 0 25) 23) anon156_Then_correct) (=> (= (ControlFlow 0 25) 24) anon156_Else_correct)))))
(let ((anon97_correct  (=> (= Mask@11 (MapType1Store Mask@10 null (heapseg this@@66 null) (real_2_U (+ (U_2_real (MapType1Select Mask@10 null (heapseg this@@66 null))) FullPerm)))) (=> (and (and (state Heap@3 Mask@11) (state Heap@3 Mask@11)) (and (|heapseg#trigger| Heap@3 (heapseg this@@66 null)) (= (MapType0Select Heap@3 null (heapseg this@@66 null)) (FrameFragment (ite (not (= this@@66 null)) (CombineFrames (MapType0Select Heap@3 null (tree this@@66)) (CombineFrames (FrameFragment (MapType0Select Heap@3 this@@66 sibling)) (CombineFrames (MapType0Select Heap@3 null (heapseg (MapType0Select Heap@3 this@@66 sibling) null)) (FrameFragment (ite (not (= (MapType0Select Heap@3 this@@66 sibling) null)) EmptyFrame EmptyFrame))))) EmptyFrame))))) (and (=> (= (ControlFlow 0 27) 25) anon155_Then_correct) (=> (= (ControlFlow 0 27) 26) anon155_Else_correct))))))
(let ((anon154_Else_correct  (=> (= (MapType0Select Heap@3 this@@66 sibling) null) (=> (and (= Mask@10 Mask@9) (= (ControlFlow 0 31) 27)) anon97_correct))))
(let ((anon154_Then_correct  (=> (not (= (MapType0Select Heap@3 this@@66 sibling) null)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (= (treeParent Heap@3 this@@66) (segParent Heap@3 (MapType0Select Heap@3 this@@66 sibling) null))) (=> (= (treeParent Heap@3 this@@66) (segParent Heap@3 (MapType0Select Heap@3 this@@66 sibling) null)) (=> (and (= Mask@10 Mask@9) (= (ControlFlow 0 29) 27)) anon97_correct))))))
(let ((anon95_correct  (=> (and (= Mask@9 (MapType1Store Mask@8 null (heapseg (MapType0Select Heap@3 this@@66 sibling) null) (real_2_U (- (U_2_real (MapType1Select Mask@8 null (heapseg (MapType0Select Heap@3 this@@66 sibling) null))) FullPerm)))) (InsidePredicate (heapseg this@@66 null) (MapType0Select Heap@3 null (heapseg this@@66 null)) (heapseg (MapType0Select Heap@3 this@@66 sibling) null) (MapType0Select Heap@3 null (heapseg (MapType0Select Heap@3 this@@66 sibling) null)))) (and (=> (= (ControlFlow 0 32) 29) anon154_Then_correct) (=> (= (ControlFlow 0 32) 31) anon154_Else_correct)))))
(let ((anon153_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 35) 32)) anon95_correct)))
(let ((anon153_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 33) (- 0 34)) (<= FullPerm (U_2_real (MapType1Select Mask@8 null (heapseg (MapType0Select Heap@3 this@@66 sibling) null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@8 null (heapseg (MapType0Select Heap@3 this@@66 sibling) null)))) (=> (= (ControlFlow 0 33) 32) anon95_correct))))))
(let ((anon93_correct  (=> (= Mask@8 (MapType1Store Mask@7 this@@66 sibling (real_2_U (- (U_2_real (MapType1Select Mask@7 this@@66 sibling)) FullPerm)))) (and (=> (= (ControlFlow 0 36) 33) anon153_Then_correct) (=> (= (ControlFlow 0 36) 35) anon153_Else_correct)))))
(let ((anon152_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 39) 36)) anon93_correct)))
(let ((anon152_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 37) (- 0 38)) (<= FullPerm (U_2_real (MapType1Select Mask@7 this@@66 sibling)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@7 this@@66 sibling))) (=> (= (ControlFlow 0 37) 36) anon93_correct))))))
(let ((anon91_correct  (=> (and (= Mask@7 (MapType1Store Mask@6 null (tree this@@66) (real_2_U (- (U_2_real (MapType1Select Mask@6 null (tree this@@66))) FullPerm)))) (InsidePredicate (heapseg this@@66 null) (MapType0Select Heap@3 null (heapseg this@@66 null)) (tree this@@66) (MapType0Select Heap@3 null (tree this@@66)))) (and (=> (= (ControlFlow 0 40) 37) anon152_Then_correct) (=> (= (ControlFlow 0 40) 39) anon152_Else_correct)))))
(let ((anon151_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 43) 40)) anon91_correct)))
(let ((anon151_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 41) (- 0 42)) (<= FullPerm (U_2_real (MapType1Select Mask@6 null (tree this@@66))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@6 null (tree this@@66)))) (=> (= (ControlFlow 0 41) 40) anon91_correct))))))
(let ((anon150_Then_correct  (=> (not (= this@@66 null)) (and (=> (= (ControlFlow 0 44) 41) anon151_Then_correct) (=> (= (ControlFlow 0 44) 43) anon151_Else_correct)))))
(let ((anon150_Else_correct  (=> (= this@@66 null) (=> (and (= Mask@10 Mask@6) (= (ControlFlow 0 28) 27)) anon97_correct))))
(let ((anon138_Else_correct  (=> (and (= (MapType0Select Heap@1 this@@66 sibling) null) (state Heap@1 Mask@6)) (and (=> (= (ControlFlow 0 45) (- 0 46)) (= FullPerm (U_2_real (MapType1Select Mask@6 this@@66 sibling)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@6 this@@66 sibling))) (=> (and (= Heap@3 (MapType0Store Heap@1 this@@66 sibling sibl)) (state Heap@3 Mask@6)) (and (=> (= (ControlFlow 0 45) 44) anon150_Then_correct) (=> (= (ControlFlow 0 45) 28) anon150_Else_correct))))))))
(let ((anon65_correct  (=> (and (state Heap@1 Mask@6) (state Heap@1 Mask@6)) (and (=> (= (ControlFlow 0 91) (- 0 92)) (HasDirectPerm Mask@6 this@@66 sibling)) (=> (HasDirectPerm Mask@6 this@@66 sibling) (and (=> (= (ControlFlow 0 91) 88) anon138_Then_correct) (=> (= (ControlFlow 0 91) 45) anon138_Else_correct)))))))
(let ((anon137_Else_correct  (=> (= (MapType0Select Heap@1 this@@66 sibling) null) (=> (and (= Mask@6 Mask@5) (= (ControlFlow 0 95) 91)) anon65_correct))))
(let ((anon137_Then_correct  (=> (not (= (MapType0Select Heap@1 this@@66 sibling) null)) (=> (and (and (state Heap@1 Mask@5) (= (treeParent Heap@1 this@@66) (segParent Heap@1 (MapType0Select Heap@1 this@@66 sibling) null))) (and (= Mask@6 Mask@5) (= (ControlFlow 0 94) 91))) anon65_correct))))
(let ((anon136_Then_correct  (=> (and (not (= this@@66 null)) (= Mask@3 (MapType1Store Mask@2 null (tree this@@66) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (tree this@@66))) FullPerm))))) (=> (and (and (and (InsidePredicate (heapseg this@@66 null) (MapType0Select Heap@1 null (heapseg this@@66 null)) (tree this@@66) (MapType0Select Heap@1 null (tree this@@66))) (state Heap@1 Mask@3)) (and (not (= this@@66 null)) (= Mask@4 (MapType1Store Mask@3 this@@66 sibling (real_2_U (+ (U_2_real (MapType1Select Mask@3 this@@66 sibling)) FullPerm)))))) (and (and (state Heap@1 Mask@4) (= Mask@5 (MapType1Store Mask@4 null (heapseg (MapType0Select Heap@1 this@@66 sibling) null) (real_2_U (+ (U_2_real (MapType1Select Mask@4 null (heapseg (MapType0Select Heap@1 this@@66 sibling) null))) FullPerm))))) (and (InsidePredicate (heapseg this@@66 null) (MapType0Select Heap@1 null (heapseg this@@66 null)) (heapseg (MapType0Select Heap@1 this@@66 sibling) null) (MapType0Select Heap@1 null (heapseg (MapType0Select Heap@1 this@@66 sibling) null))) (state Heap@1 Mask@5)))) (and (=> (= (ControlFlow 0 96) 94) anon137_Then_correct) (=> (= (ControlFlow 0 96) 95) anon137_Else_correct))))))
(let ((anon136_Else_correct  (=> (= this@@66 null) (=> (and (= Mask@6 Mask@2) (= (ControlFlow 0 93) 91)) anon65_correct))))
(let ((anon135_Else_correct  (=> (and (HasDirectPerm Mask@2 null (heapseg this@@66 null)) (= Heap@1 Heap@@61)) (and (=> (= (ControlFlow 0 98) 96) anon136_Then_correct) (=> (= (ControlFlow 0 98) 93) anon136_Else_correct)))))
(let ((anon135_Then_correct  (=> (not (HasDirectPerm Mask@2 null (heapseg this@@66 null))) (=> (and (= Heap@0 (MapType0Store Heap@@61 null (heapseg this@@66 null) newVersion@0)) (= Heap@1 Heap@0)) (and (=> (= (ControlFlow 0 97) 96) anon136_Then_correct) (=> (= (ControlFlow 0 97) 93) anon136_Else_correct))))))
(let ((anon60_correct  (=> (= Mask@2 (MapType1Store Mask@1 null (heapseg this@@66 null) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (heapseg this@@66 null))) FullPerm)))) (and (=> (= (ControlFlow 0 99) 97) anon135_Then_correct) (=> (= (ControlFlow 0 99) 98) anon135_Else_correct)))))
(let ((anon134_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 102) 99)) anon60_correct)))
(let ((anon134_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 100) (- 0 101)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (heapseg this@@66 null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (heapseg this@@66 null)))) (=> (= (ControlFlow 0 100) 99) anon60_correct))))))
(let ((anon121_Else_correct  (=> (and (|heapseg#trigger| Heap@@61 (heapseg this@@66 null)) (= (MapType0Select Heap@@61 null (heapseg this@@66 null)) (FrameFragment (ite (not (= this@@66 null)) (CombineFrames (MapType0Select Heap@@61 null (tree this@@66)) (CombineFrames (FrameFragment (MapType0Select Heap@@61 this@@66 sibling)) (CombineFrames (MapType0Select Heap@@61 null (heapseg (MapType0Select Heap@@61 this@@66 sibling) null)) (FrameFragment (ite (not (= (MapType0Select Heap@@61 this@@66 sibling) null)) EmptyFrame EmptyFrame))))) EmptyFrame)))) (and (=> (= (ControlFlow 0 103) 100) anon134_Then_correct) (=> (= (ControlFlow 0 103) 102) anon134_Else_correct)))))
(let ((anon32_correct  (=> (state Heap@@61 Mask@1) (and (=> (= (ControlFlow 0 134) 133) anon121_Then_correct) (=> (= (ControlFlow 0 134) 103) anon121_Else_correct)))))
(let ((anon119_Else_correct  (=> (and (= (segParent Heap@@61 this@@66 null) (segParent Heap@@61 sibl null)) (= (ControlFlow 0 136) 134)) anon32_correct)))
(let ((anon116_Then_correct  (=> (and (not (= sibl null)) (state Heap@@61 Mask@1)) (and (and (and (and (=> (= (ControlFlow 0 147) 136) anon119_Else_correct) (=> (= (ControlFlow 0 147) 144) anon120_Then_correct)) (=> (= (ControlFlow 0 147) 146) anon120_Else_correct)) (=> (= (ControlFlow 0 147) 139) anon118_Then_correct)) (=> (= (ControlFlow 0 147) 141) anon118_Else_correct)))))
(let ((anon116_Else_correct  (=> (and (= sibl null) (= (ControlFlow 0 135) 134)) anon32_correct)))
(let ((anon22_correct  (=> (state Heap@@61 Mask@1) (and (=> (= (ControlFlow 0 148) 147) anon116_Then_correct) (=> (= (ControlFlow 0 148) 135) anon116_Else_correct)))))
(let ((anon114_Else_correct  (=> (and (< (segDegree Heap@@61 this@@66 null 0) (segDegree Heap@@61 sibl null 0)) (= (ControlFlow 0 150) 148)) anon22_correct)))
(let ((anon111_Then_correct  (=> (and (not (= sibl null)) (state Heap@@61 Mask@1)) (and (and (and (and (=> (= (ControlFlow 0 161) 150) anon114_Else_correct) (=> (= (ControlFlow 0 161) 158) anon115_Then_correct)) (=> (= (ControlFlow 0 161) 160) anon115_Else_correct)) (=> (= (ControlFlow 0 161) 153) anon113_Then_correct)) (=> (= (ControlFlow 0 161) 155) anon113_Else_correct)))))
(let ((anon111_Else_correct  (=> (and (= sibl null) (= (ControlFlow 0 149) 148)) anon22_correct)))
(let ((anon109_Else_correct  (=> (and (sorted Heap@@61 sibl null) (state Heap@@61 Mask@1)) (and (=> (= (ControlFlow 0 162) 161) anon111_Then_correct) (=> (= (ControlFlow 0 162) 149) anon111_Else_correct)))))
(let ((anon11_correct true))
(let ((anon110_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon11_correct)))
(let ((anon110_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (heapseg sibl null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (heapseg sibl null)))) (=> (= (ControlFlow 0 10) 9) anon11_correct))))))
(let ((anon107_Else_correct  (=> (< 0 (segLength Heap@@61 this@@66 null)) (=> (and (and (state Heap@@61 Mask@0) (= Mask@1 (MapType1Store Mask@0 null (heapseg sibl null) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (heapseg sibl null))) FullPerm))))) (and (state Heap@@61 Mask@1) (state Heap@@61 Mask@1))) (and (and (=> (= (ControlFlow 0 163) 162) anon109_Else_correct) (=> (= (ControlFlow 0 163) 10) anon110_Then_correct)) (=> (= (ControlFlow 0 163) 12) anon110_Else_correct))))))
(let ((anon7_correct true))
(let ((anon108_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon7_correct)))
(let ((anon108_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (heapseg this@@66 null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (heapseg this@@66 null)))) (=> (= (ControlFlow 0 6) 5) anon7_correct))))))
(let ((anon105_Else_correct  (=> (and (validChildren Heap@@61 this@@66 null) (state Heap@@61 Mask@0)) (and (and (=> (= (ControlFlow 0 164) 163) anon107_Else_correct) (=> (= (ControlFlow 0 164) 6) anon108_Then_correct)) (=> (= (ControlFlow 0 164) 8) anon108_Else_correct)))))
(let ((anon3_correct true))
(let ((anon106_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon106_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (heapseg this@@66 null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (heapseg this@@66 null)))) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (state Heap@@61 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@61 this@@66 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@61 sibl $allocated)) (= Mask@0 (MapType1Store ZeroMask null (heapseg this@@66 null) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (heapseg this@@66 null))) FullPerm))))) (and (state Heap@@61 Mask@0) (state Heap@@61 Mask@0))) (and (and (=> (= (ControlFlow 0 165) 164) anon105_Else_correct) (=> (= (ControlFlow 0 165) 2) anon106_Then_correct)) (=> (= (ControlFlow 0 165) 4) anon106_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 166) 165) anon0_correct)))
PreconditionGeneratedEntry_correct)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
