...
(assert  (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type x@@8) RefType)) (= (type y@@1) RefType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id o_3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null (wand (= (+ (U_2_int (MapType0Select Heap@@9 x@@8 f_7)) (U_2_int (MapType0Select Heap@@9 y@@1 f_7))) 4) true)))))))
(let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@1 x@@8 f_7)) (=> (HasDirectPerm Mask@1 x@@8 f_7) (=> (= (ControlFlow 0 5) (- 0 4)) (HasDirectPerm Mask@1 y@@1 f_7))))))
(let ((anon5_Else_correct  (=> (and (and (= Mask@2 (MapType1Store Mask@1 null (wand (= (+ (U_2_int (MapType0Select Heap@@9 x@@8 f_7)) (U_2_int (MapType0Select Heap@@9 y@@1 f_7))) 4) true) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (wand (= (+ (U_2_int (MapType0Select Heap@@9 x@@8 f_7)) (U_2_int (MapType0Select Heap@@9 y@@1 f_7))) 4) true))) FullPerm)))) (state Heap@@9 Mask@2)) (and (state Heap@@9 Mask@2) (state Heap@@9 Mask@2))) (and (=> (= (ControlFlow 0 9) 5) anon6_Then_correct) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct)))))
(let ((anon5_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 x@@8 f_7)) (=> (HasDirectPerm Mask@1 x@@8 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@1 y@@1 f_7))))))
