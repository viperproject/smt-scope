...
(assert  (and (and (= (type this@@4) ArrayDomainTypeType) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@13) (MapType0Type RefType))))
(set-info :boogie-vc-id |elements#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon5_correct true))
(let ((anon9_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (length this@@4)) (int_2_U i_8))) (= (ControlFlow 0 6) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (length this@@4)) (int_2_U i_8)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm QPMask@0 (loc this@@4 i_8) val)) (=> (HasDirectPerm QPMask@0 (loc this@@4 i_8) val) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
(let ((anon8_Else_correct true))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((i_4 Int) (i_4_1 Int) ) (!  (=> (and (and (and (and (not (= i_4 i_4_1)) (|Seq#Contains| (|Seq#Range| 0 (length this@@4)) (int_2_U i_4))) (|Seq#Contains| (|Seq#Range| 0 (length this@@4)) (int_2_U i_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc this@@4 i_4) (loc this@@4 i_4_1))))
 :qid |stdinbpl.883:15|
 :skolemid |126|
))) (=> (forall ((i_4@@0 Int) (i_4_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_4@@0 i_4_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (length this@@4)) (int_2_U i_4@@0))) (|Seq#Contains| (|Seq#Range| 0 (length this@@4)) (int_2_U i_4_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc this@@4 i_4@@0) (loc this@@4 i_4_1@@0))))
 :qid |stdinbpl.883:15|
 :skolemid |126|
)) (=> (forall ((i_4@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (length this@@4)) (int_2_U i_4@@1)) (< NoPerm FullPerm)) (and (qpRange1 (loc this@@4 i_4@@1)) (= (invRecv1 (loc this@@4 i_4@@1)) i_4@@1)))
 :qid |stdinbpl.889:22|
 :skolemid |127|
 :pattern ( (loc this@@4 i_4@@1))
 :pattern ( (MapType0Select Heap@@13 (loc this@@4 i_4@@1) val))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (length this@@4)) (int_2_U i_4@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (length this@@4)) (int_2_U i_4@@1)))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (length this@@4)) (int_2_U (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (loc this@@4 (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.893:22|
 :skolemid |128|
 :pattern ( (invRecv1 o_3))
)) (forall ((i_4@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (length this@@4)) (int_2_U i_4@@2)) (not (= (loc this@@4 i_4@@2) null)))
 :qid |stdinbpl.899:22|
 :skolemid |129|
 :pattern ( (loc this@@4 i_4@@2))
 :pattern ( (MapType0Select Heap@@13 (loc this@@4 i_4@@2) val))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (length this@@4)) (int_2_U i_4@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (length this@@4)) (int_2_U i_4@@2)))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (length this@@4)) (int_2_U (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (loc this@@4 (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 (length this@@4)) (int_2_U (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.905:22|
 :skolemid |130|
...
))) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0))) (and (and (=> (= (ControlFlow 0 7) 2) anon8_Else_correct) (=> (= (ControlFlow 0 7) 4) anon9_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 9) 1) anon7_Then_correct) (=> (= (ControlFlow 0 9) 7) anon7_Else_correct)))))
