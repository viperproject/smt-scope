...
(declare-fun |LibB'| (T@U Int Bool) Bool)
(declare-fun MapType0Type (T@T) T@T)
(declare-fun RefType () T@T)
(declare-fun MapType1Type (T@T T@T) T@T)
(declare-fun |LibB#frame| (T@U Int Bool) Bool)
...
(declare-fun |LibB#trigger| (T@U Int Bool) Bool)
...
(assert (forall ((Heap T@U) (Mask T@U) (a_2 Int) (b_2 Bool) ) (!  (=> (and (and (= (type Heap) (MapType0Type RefType)) (= (type Mask) (MapType1Type RefType realType))) (state Heap Mask)) (= (|LibB'| Heap a_2 b_2) (|LibB#frame| EmptyFrame a_2 b_2)))
 :qid |stdinbpl.212:15|
 :skolemid |25|
 :pattern ( (state Heap Mask) (|LibB'| Heap a_2 b_2))
)))
...
(assert (forall ((Heap@@1 T@U) (Mask@@1 T@U) (a_2@@0 Int) (b_2@@0 Bool) ) (!  (=> (and (and (and (= (type Heap@@1) (MapType0Type RefType)) (= (type Mask@@1) (MapType1Type RefType realType))) (and (state Heap@@1 Mask@@1) (or (< AssumeFunctionsAbove 0) (|LibB#trigger| EmptyFrame a_2@@0 b_2@@0)))) (foo 1)) (= (|LibB'| Heap@@1 a_2@@0 b_2@@0)  (or b_2@@0 (foo a_2@@0))))
 :qid |stdinbpl.218:15|
 :skolemid |26|
 :pattern ( (state Heap@@1 Mask@@1) (|LibB'| Heap@@1 a_2@@0 b_2@@0))
)))
(assert (forall ((Heap@@2 T@U) (a_2@@1 Int) (b_2@@1 Bool) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (bool_2_U (|LibB#triggerStateless| a_2@@1 b_2@@1))))
 :qid |stdinbpl.205:15|
 :skolemid |24|
 :pattern ( (|LibB'| Heap@@2 a_2@@1 b_2@@1))
)))
...
(assert (forall ((Heap@@8 T@U) (ExhaleHeap@@4 T@U) (Mask@@8 T@U) (pm_f@@1 T@U) ) (! (let ((C@@1 (FieldTypeInv0 (type pm_f@@1))))
 (=> (and (and (and (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type ExhaleHeap@@4) (MapType0Type RefType))) (= (type Mask@@8) (MapType1Type RefType realType))) (= (type pm_f@@1) (FieldType C@@1 FrameTypeType))) (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@4 Mask@@8)) (and (HasDirectPerm Mask@@8 null pm_f@@1) (IsPredicateField pm_f@@1))) (forall ((o2 T@U) (f_2@@0 T@U) ) (! (let ((B@@5 (FieldTypeInv1 (type f_2@@0))))
(let ((A@@6 (FieldTypeInv0 (type f_2@@0))))
 ...
 :qid |stdinbpl.52:19|
 :skolemid |4|
 :pattern ( (IdenticalOnKnownLocations Heap@@8 ExhaleHeap@@4 Mask@@8) (IsPredicateField pm_f@@1))
)))
(assert (forall ((Heap@@9 T@U) (ExhaleHeap@@5 T@U) (Mask@@9 T@U) (pm_f@@2 T@U) ) (! (let ((C@@2 (FieldTypeInv0 (type pm_f@@2))))
 (=> (and (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type ExhaleHeap@@5) (MapType0Type RefType))) (= (type Mask@@9) (MapType1Type RefType realType))) (= (type pm_f@@2) (FieldType C@@2 FrameTypeType))) (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@5 Mask@@9)) (and (HasDirectPerm Mask@@9 null pm_f@@2) (IsWandField pm_f@@2))) (forall ((o2@@0 T@U) (f_2@@1 T@U) ) (! (let ((B@@6 (FieldTypeInv1 (type f_2@@1))))
(let ((A@@7 (FieldTypeInv0 (type f_2@@1))))
 ...
 :qid |stdinbpl.65:19|
 :skolemid |7|
 :pattern ( (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@@5 Mask@@9) (IsWandField pm_f@@2))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@12 T@U) (a_2@@2 Int) (b_2@@2 Bool) ) (!  (=> (= (type Heap@@12) (MapType0Type RefType)) (and (= (LibB Heap@@12 a_2@@2 b_2@@2) (|LibB'| Heap@@12 a_2@@2 b_2@@2)) (dummyFunction (bool_2_U (|LibB#triggerStateless| a_2@@2 b_2@@2)))))
 :qid |stdinbpl.201:15|
 :skolemid |23|
 :pattern ( (LibB Heap@@12 a_2@@2 b_2@@2))
)))
(push 1)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (LibB Heap@@13 77 false))))
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (foo 1))))
(let ((anon0_correct  (=> (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))
