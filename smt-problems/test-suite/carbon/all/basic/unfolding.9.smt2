...
(let ((anon9_Else_correct  (=> (= (MapType0Select Heap@1 r_1@@23 next) null) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 3) 1)) anon6_correct))))
(let ((anon9_Then_correct  (=> (not (= (MapType0Select Heap@1 r_1@@23 next) null)) (=> (and (and (forall ((o_13 T@U) (f_18 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_18))))
(let ((A@@12 (FieldTypeInv0 (type f_18))))
 (=> (and (and (= (type o_13) RefType) (= (type f_18) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|valid#sm| r_1@@23)) o_13 f_18)) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|valid#sm| (MapType0Select Heap@1 r_1@@23 next))) o_13 f_18)))) (U_2_bool (MapType1Select newPMask@0 o_13 f_18)))))
 :qid |stdinbpl.1035:33|
 :skolemid |56|
 :pattern ( (MapType1Select newPMask@0 o_13 f_18))
)) (= Heap@2 (MapType0Store Heap@1 null (|valid#sm| r_1@@23) newPMask@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 2) 1))) anon6_correct))))
(let ((anon4_correct  (=> (state Heap@@13 UnfoldingMask@4) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm UnfoldingMask@4 r_1@@23 f_7)) (=> (HasDirectPerm UnfoldingMask@4 r_1@@23 f_7) (=> (and (= Heap@0 (MapType0Store Heap@@13 null (|valid#sm| r_1@@23) (MapType1Store (MapType0Select Heap@@13 null (|valid#sm| r_1@@23)) r_1@@23 f_7 (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|valid#sm| r_1@@23) (MapType1Store (MapType0Select Heap@0 null (|valid#sm| r_1@@23)) r_1@@23 next (bool_2_U true))))) (and (=> (= (ControlFlow 0 4) 2) anon9_Then_correct) (=> (= (ControlFlow 0 4) 3) anon9_Else_correct))))))))
(let ((anon8_Else_correct  (=> (= (MapType0Select Heap@@13 r_1@@23 next) null) (=> (and (= UnfoldingMask@4 UnfoldingMask@2) (= (ControlFlow 0 7) 4)) anon4_correct))))
...
(let ((anon2_correct  (=> (= UnfoldingMask@0 (MapType1Store ZeroMask null (valid r_1@@23) (real_2_U (- (U_2_real (MapType1Select ZeroMask null (valid r_1@@23))) FullPerm)))) (=> (and (not (= r_1@@23 null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 r_1@@23 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 r_1@@23 f_7)) FullPerm))))) (=> (and (and (state Heap@@13 UnfoldingMask@1) (not (= r_1@@23 null))) (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 r_1@@23 next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 r_1@@23 next)) FullPerm)))) (state Heap@@13 UnfoldingMask@2))) (and (=> (= (ControlFlow 0 8) 6) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct)))))))
(let ((anon7_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select ZeroMask null (valid r_1@@23))))) (=> (<= FullPerm (U_2_real (MapType1Select ZeroMask null (valid r_1@@23)))) (=> (= (ControlFlow 0 9) 8) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@13 ZeroMask) (U_2_bool (MapType0Select Heap@@13 r_1@@23 $allocated))) (=> (and (and (not (= r_1@@23 null)) (state Heap@@13 ZeroMask)) (and (|valid#trigger| Heap@@13 (valid r_1@@23)) (= (MapType0Select Heap@@13 null (valid r_1@@23)) (CombineFrames (FrameFragment (MapType0Select Heap@@13 r_1@@23 f_7)) (CombineFrames (FrameFragment (MapType0Select Heap@@13 r_1@@23 next)) (FrameFragment (ite (not (= (MapType0Select Heap@@13 r_1@@23 next) null)) (MapType0Select Heap@@13 null (valid (MapType0Select Heap@@13 r_1@@23 next))) EmptyFrame))))))) (and (=> (= (ControlFlow 0 12) 9) anon7_Then_correct) (=> (= (ControlFlow 0 12) 11) anon7_Else_correct))))))
