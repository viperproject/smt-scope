...
(assert  (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type x@@19) RefType)) (= (type Heap@@15) (MapType0Type RefType))))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (and (= y@0 (fun Heap@@15 x@@19)) (= (ControlFlow 0 4) (- 0 3))) (> (+ (* (fun Heap@@15 x@@19) (fun Heap@@15 x@@19)) (fun Heap@@15 x@@19)) 0))))
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (> (U_2_real (MapType1Select Mask@0 null (P x@@19))) NoPerm))))
(let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@15 x@@19 $allocated))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask null (P x@@19) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@19))) FullPerm)))) (state Heap@@15 Mask@0)) (and (state Heap@@15 Mask@0) (state Heap@@15 Mask@0))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))))
