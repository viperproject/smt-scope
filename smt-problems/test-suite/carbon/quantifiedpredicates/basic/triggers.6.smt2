...
(assert  (and (and (and (and (and (and (and (= (type xs) (SeqType RefType)) (= (type x_5) RefType)) (= (type Heap@@18) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type y_4) RefType)) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv6 arg0@@45)) RefType)
...
(let ((anon18_Then_correct  (=> (|Seq#Contains| xs y_4) (and (=> (= (ControlFlow 0 13) 12) anon19_Then_correct) (=> (= (ControlFlow 0 13) 10) anon10_correct)))))
(let ((anon18_Else_correct  (=> (and (not (|Seq#Contains| xs y_4)) (= (ControlFlow 0 11) 10)) anon10_correct)))
(let ((anon17_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((y_1 T@U) (y_1_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (= (type y_1_1) RefType)) (=> (and (and (and (and (not (= y_1 y_1_1)) (|Seq#Contains| xs y_1)) (|Seq#Contains| xs y_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (fun2 PostHeap@0 y_1) (fun2 PostHeap@0 y_1_1)))))
...
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((y_3 T@U) (y_3_1 T@U) ) (!  (=> (and (= (type y_3) RefType) (= (type y_3_1) RefType)) (=> (and (and (and (and (not (= y_3 y_3_1)) (|Seq#Contains| xs y_3)) (|Seq#Contains| xs y_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (fun2 Heap@@18 y_3) (fun2 Heap@@18 y_3_1)))))
 :qid |stdinbpl.1275:17|
 :skolemid |117|
 :pattern ( (neverTriggered8 y_3) (neverTriggered8 y_3_1))
))) (=> (forall ((y_3@@0 T@U) (y_3_1@@0 T@U) ) (!  (=> (and (= (type y_3@@0) RefType) (= (type y_3_1@@0) RefType)) (=> (and (and (and (and (not (= y_3@@0 y_3_1@@0)) (|Seq#Contains| xs y_3@@0)) (|Seq#Contains| xs y_3_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (fun2 Heap@@18 y_3@@0) (fun2 Heap@@18 y_3_1@@0)))))
 :qid |stdinbpl.1275:17|
 :skolemid |117|
 :pattern ( (neverTriggered8 y_3@@0) (neverTriggered8 y_3_1@@0))
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((y_3@@1 T@U) ) (!  (=> (and (= (type y_3@@1) RefType) (|Seq#Contains| xs y_3@@1)) (>= (U_2_real (MapType1Select QPMask@0 null (pred (fun2 Heap@@18 y_3@@1)))) FullPerm))
 :qid |stdinbpl.1282:17|
 :skolemid |118|
 :pattern ( (MapType0Select Heap@@18 null (pred (|fun2#frame| EmptyFrame y_3@@1))))
 :pattern ( (MapType1Select QPMask@0 null (pred (|fun2#frame| EmptyFrame y_3@@1))))
 :pattern ( (|fun#frame| EmptyFrame y_3@@1 i@@10))
)))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| xs x_1)) (|Seq#Contains| xs x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (fun Heap@@18 x_1 i@@10) (fun Heap@@18 x_1_1 i@@10)))))
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| xs x_1@@1) (< NoPerm FullPerm)) (and (= (invRecv6 (fun Heap@@18 x_1@@1 i@@10)) x_1@@1) (qpRange6 (fun Heap@@18 x_1@@1 i@@10)))))
...
)) (=> (and (forall ((r_1_1 T@U) ) (!  (=> (= (type r_1_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv6 r_1_1)) (< NoPerm FullPerm)) (qpRange6 r_1_1)) (= (fun Heap@@18 (invRecv6 r_1_1) i@@10) r_1_1)))
 :qid |stdinbpl.1178:22|
 :skolemid |107|
 :pattern ( (invRecv6 r_1_1))
)) (forall ((r_1_1@@0 T@U) ) (!  (=> (= (type r_1_1@@0) RefType) (=> (and (and (|Seq#Contains| xs (invRecv6 r_1_1@@0)) (< NoPerm FullPerm)) (qpRange6 r_1_1@@0)) (and (=> (< NoPerm FullPerm) (= (fun Heap@@18 (invRecv6 r_1_1@@0) i@@10) r_1_1@@0)) (= (U_2_real (MapType1Select QPMask@0 null (pred r_1_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (pred r_1_1@@0))) FullPerm)))))
...
)) (forall ((r_1_1@@1 T@U) ) (!  (=> (and (= (type r_1_1@@1) RefType) (not (and (and (|Seq#Contains| xs (invRecv6 r_1_1@@1)) (< NoPerm FullPerm)) (qpRange6 r_1_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (pred r_1_1@@1))) (U_2_real (MapType1Select ZeroMask null (pred r_1_1@@1)))))
 :qid |stdinbpl.1194:22|
 :skolemid |110|
 :pattern ( (MapType1Select QPMask@0 null (pred r_1_1@@1)))
))) (and (state Heap@@18 QPMask@0) (state Heap@@18 QPMask@0))) (and (=> (= (ControlFlow 0 15) 14) anon16_Then_correct) (=> (= (ControlFlow 0 15) 6) anon16_Else_correct)))))))))
(let ((anon15_Then_correct true))
(let ((anon4_correct true))
(let ((anon14_Then_correct  (=> (|Seq#Contains| xs x_5) (and (=> (= (ControlFlow 0 4) 3) anon15_Then_correct) (=> (= (ControlFlow 0 4) 1) anon4_correct)))))
(let ((anon14_Else_correct  (=> (and (not (|Seq#Contains| xs x_5)) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (and (and (state Heap@@18 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@18 r_1@@13 $allocated)) (state Heap@@18 ZeroMask))) (and (and (=> (= (ControlFlow 0 17) 15) anon13_Else_correct) (=> (= (ControlFlow 0 17) 4) anon14_Then_correct)) (=> (= (ControlFlow 0 17) 2) anon14_Else_correct)))))
