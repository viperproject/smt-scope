...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type S) (MapType2Type RefType boolType)) (= (type q_3) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type t_2_1) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type b_2) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv24 arg0@@43)) RefType)
 :qid |funType:invRecv24|
 :pattern ( (invRecv24 arg0@@43))
))) (= (type t_6) RefType)) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv23 arg0@@44)) RefType)
...
(let ((anon25_Else_correct  (=> (and (not (U_2_bool (MapType2Select S t_6))) (= (ControlFlow 0 20) 17)) anon12_correct)))
(let ((anon25_Then_correct  (=> (U_2_bool (MapType2Select S t_6)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm QPMask@2 t_6 f_7)) (=> (HasDirectPerm QPMask@2 t_6 f_7) (=> (= (ControlFlow 0 18) 17) anon12_correct))))))
...
)) (=> (forall ((r_1@@1 T@U) ) (!  (=> (= (type r_1@@1) RefType) (=> (and (U_2_bool (MapType2Select S r_1@@1)) (< NoPerm FullPerm)) (and (qpRange23 r_1@@1) (= (invRecv23 r_1@@1) r_1@@1))))
...
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select S (invRecv23 o_3))) (< NoPerm FullPerm)) (qpRange23 o_3)) (= (invRecv23 o_3) o_3)))
...
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select S (invRecv23 o_3@@0))) (< NoPerm FullPerm)) (qpRange23 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv23 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select S (invRecv23 o_3@@0))) (< NoPerm FullPerm)) (qpRange23 o_3@@0))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
(let ((anon27_Then_correct  (=> (U_2_bool (MapType2Select S t_2_1)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (> (U_2_int (MapType0Select Heap@0 t_2_1 f_7)) a_2)) (=> (> (U_2_int (MapType0Select Heap@0 t_2_1 f_7)) a_2) (=> (= (ControlFlow 0 8) 7) anon17_correct))))))
(let ((anon26_Else_correct true))
(let ((anon22_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 14)) (= FullPerm (U_2_real (MapType1Select QPMask@0 b_2 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 b_2 f_7))) (=> (and (= Heap@0 (MapType0Store Heap@@9 b_2 f_7 (int_2_U (+ (* 2 a_2) 1)))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (forall ((r_2 T@U) (r_2_1 T@U) ) (!  (=> (and (= (type r_2) RefType) (= (type r_2_1) RefType)) (=> (and (and (and (and (not (= r_2 r_2_1)) (U_2_bool (MapType2Select S r_2))) (U_2_bool (MapType2Select S r_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_2 r_2_1))))
 :qid |stdinbpl.2186:17|
 :skolemid |238|
 :pattern ( (neverTriggered24 r_2) (neverTriggered24 r_2_1))
 ...
 :qid |stdinbpl.2186:17|
 :skolemid |238|
 :pattern ( (neverTriggered24 r_2@@0) (neverTriggered24 r_2_1@@0))
...
)) (=> (and (and (forall ((r_2@@3 T@U) ) (!  (=> (= (type r_2@@3) RefType) (=> (and (U_2_bool (MapType2Select S r_2@@3)) (< NoPerm FullPerm)) (and (qpRange24 r_2@@3) (= (invRecv24 r_2@@3) r_2@@3))))
...
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType2Select S (invRecv24 o_3@@2))) (and (< NoPerm FullPerm) (qpRange24 o_3@@2))) (= (invRecv24 o_3@@2) o_3@@2)))
 :qid |stdinbpl.2203:22|
 :skolemid |241|
 :pattern ( (invRecv24 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType2Select S (invRecv24 o_3@@3))) (and (< NoPerm FullPerm) (qpRange24 o_3@@3))) (and (= (invRecv24 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (- (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select S (invRecv24 o_3@@3))) (and (< NoPerm FullPerm) (qpRange24 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7))))))
...
(let ((anon20_Else_correct  (=> (and (forall ((q_1_1 T@U) ) (!  (=> (and (= (type q_1_1) RefType) (U_2_bool (MapType2Select S q_1_1))) (> (U_2_int (MapType0Select Heap@@9 q_1_1 f_7)) a_2))
 :qid |stdinbpl.2092:20|
 :skolemid |230|
 :pattern ( (MapType2Select S q_1_1))
)) (state Heap@@9 QPMask@0)) (=> (and (and (U_2_bool (MapType2Select S b_2)) (state Heap@@9 QPMask@0)) (and (> a_2 0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 24) 23) anon22_Then_correct) (=> (= (ControlFlow 0 24) 11) anon22_Else_correct))))))
(let ((anon5_correct true))
(let ((anon21_Else_correct  (=> (and (not (U_2_bool (MapType2Select S q_3))) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon21_Then_correct  (=> (U_2_bool (MapType2Select S q_3)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 q_3 f_7)) (=> (HasDirectPerm QPMask@0 q_3 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((s_1 T@U) (s_1_1 T@U) ) (!  (=> (and (= (type s_1) RefType) (= (type s_1_1) RefType)) (=> (and (and (and (and (not (= s_1 s_1_1)) (U_2_bool (MapType2Select S s_1))) (U_2_bool (MapType2Select S s_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1 s_1_1))))
...
)) (=> (forall ((s_1@@1 T@U) ) (!  (=> (= (type s_1@@1) RefType) (=> (and (U_2_bool (MapType2Select S s_1@@1)) (< NoPerm FullPerm)) (and (qpRange22 s_1@@1) (= (invRecv22 s_1@@1) s_1@@1))))
...
)) (=> (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (U_2_bool (MapType2Select S (invRecv22 o_3@@5))) (< NoPerm FullPerm)) (qpRange22 o_3@@5)) (= (invRecv22 o_3@@5) o_3@@5)))
...
))) (=> (and (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (U_2_bool (MapType2Select S (invRecv22 o_3@@6))) (< NoPerm FullPerm)) (qpRange22 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv22 o_3@@6) o_3@@6)) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@6 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select S (invRecv22 o_3@@6))) (< NoPerm FullPerm)) (qpRange22 o_3@@6))) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@6 f_7))))))
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 25) 24) anon20_Else_correct) (=> (= (ControlFlow 0 25) 3) anon21_Then_correct)) (=> (= (ControlFlow 0 25) 5) anon21_Else_correct)))))))))
(let ((anon19_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 b_2 $allocated))) (and (=> (= (ControlFlow 0 27) 1) anon19_Then_correct) (=> (= (ControlFlow 0 27) 25) anon19_Else_correct)))))
