...
(assert  (and (and (and (and (and (and (and (= (type QPMask@1) (MapType2Type RefType realType)) (= (type Heap@@11) (MapType0Type RefType))) (= (type a_12) RefType)) (= (type y@@12) RefType)) (forall ((arg0@@53 T@U) (arg1@@47 Int) ) (! (= (type (invRecv3 arg0@@53 arg1@@47)) RefType)
 :qid |funType:invRecv3|
 :pattern ( (invRecv3 arg0@@53 arg1@@47))
))) (= (type QPMask@0) (MapType2Type RefType realType))) (= (type x@@31) RefType)) (forall ((arg0@@54 T@U) (arg1@@48 Int) ) (! (= (type (invRecv2 arg0@@54 arg1@@48)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@54 arg1@@48))
))))
...
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm QPMask@1 null (P a_12 i_3))) (= (ControlFlow 0 8) 5)) anon7_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm QPMask@1 null (P a_12 i_3)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm QPMask@1 null (P a_12 i_3))) (=> (HasDirectPerm QPMask@1 null (P a_12 i_3)) (=> (= (ControlFlow 0 6) 5) anon7_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((a_7 T@U) (i_3_1 Int) ) (!  (=> (and (= (type a_7) RefType) (HasDirectPerm QPMask@1 null (P a_7 i_3_1))) (>= i_3_1 0))
 :qid |stdinbpl.963:15|
 :skolemid |131|
 :pattern ( (MapType2Select QPMask@1 null (P a_7 i_3_1)))
 :pattern ( (MapType0Select Heap@@11 null (P a_7 i_3_1)))
)))))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((a_4 T@U) (a_4_1 T@U) ) (!  (=> (and (= (type a_4) RefType) (= (type a_4_1) RefType)) (=> (and (and (and (and (not (= a_4 a_4_1)) (= a_4 y@@12)) (= a_4_1 y@@12)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y@@12 y@@12))))
 :qid |stdinbpl.915:17|
 :skolemid |125|
 :pattern ( (neverTriggered3 a_4) (neverTriggered3 a_4_1))
))) (=> (forall ((a_4@@0 T@U) (a_4_1@@0 T@U) ) (!  (=> (and (= (type a_4@@0) RefType) (= (type a_4_1@@0) RefType)) (=> (and (and (and (and (not (= a_4@@0 a_4_1@@0)) (= a_4@@0 y@@12)) (= a_4_1@@0 y@@12)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y@@12 y@@12))))
 :qid |stdinbpl.915:17|
 :skolemid |125|
 :pattern ( (neverTriggered3 a_4@@0) (neverTriggered3 a_4_1@@0))
)) (=> (and (and (and (forall ((a_4@@1 T@U) ) (!  (=> (= (type a_4@@1) RefType) (=> (and (= a_4@@1 y@@12) (< NoPerm FullPerm)) (and (= (invRecv3 y@@12 0) a_4@@1) (qpRange3 y@@12 0))))
 :qid |stdinbpl.921:22|
 :skolemid |126|
 :no-pattern (type a_4@@1)
 :no-pattern (U_2_int a_4@@1)
 :no-pattern (U_2_bool a_4@@1)
)) (forall ((x_2_1 T@U) (i_1 Int) ) (!  (=> (= (type x_2_1) RefType) (=> (and (and (= (invRecv3 x_2_1 i_1) y@@12) (< NoPerm FullPerm)) (qpRange3 x_2_1 i_1)) (and (= y@@12 x_2_1) (= 0 i_1))))
 :qid |stdinbpl.925:22|
 :skolemid |127|
 :pattern ( (invRecv3 x_2_1 i_1))
))) (and (forall ((x_2_1@@0 T@U) (i_1@@0 Int) ) (!  (=> (= (type x_2_1@@0) RefType) (=> (and (and (= (invRecv3 x_2_1@@0 i_1@@0) y@@12) (< NoPerm FullPerm)) (qpRange3 x_2_1@@0 i_1@@0)) (and (=> (< NoPerm FullPerm) (and (= y@@12 x_2_1@@0) (= 0 i_1@@0))) (= (U_2_real (MapType2Select QPMask@1 null (P x_2_1@@0 i_1@@0))) (+ (U_2_real (MapType2Select QPMask@0 null (P x_2_1@@0 i_1@@0))) FullPerm)))))
 :qid |stdinbpl.931:22|
 :skolemid |128|
...
)))) (and (and (forall ((x_2_1@@1 T@U) (i_1@@1 Int) ) (!  (=> (and (= (type x_2_1@@1) RefType) (not (and (and (= (invRecv3 x_2_1@@1 i_1@@1) y@@12) (< NoPerm FullPerm)) (qpRange3 x_2_1@@1 i_1@@1)))) (= (U_2_real (MapType2Select QPMask@1 null (P x_2_1@@1 i_1@@1))) (U_2_real (MapType2Select QPMask@0 null (P x_2_1@@1 i_1@@1)))))
 :qid |stdinbpl.941:22|
 :skolemid |130|
 :pattern ( (MapType2Select QPMask@1 null (P x_2_1@@1 i_1@@1)))
)) (state Heap@@11 QPMask@1)) (and (state Heap@@11 QPMask@1) (state Heap@@11 QPMask@1)))) (and (and (=> (= (ControlFlow 0 9) 4) anon11_Else_correct) (=> (= (ControlFlow 0 9) 6) anon12_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon12_Else_correct)))))))
(let ((anon10_Then_correct true))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((a_1 T@U) (a_1_1 T@U) ) (!  (=> (and (= (type a_1) RefType) (= (type a_1_1) RefType)) (=> (and (and (and (and (not (= a_1 a_1_1)) (= a_1 x@@31)) (= a_1_1 x@@31)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@31 x@@31))))
 :qid |stdinbpl.870:17|
 :skolemid |119|
 :pattern ( (neverTriggered2 a_1) (neverTriggered2 a_1_1))
))) (=> (forall ((a_1@@0 T@U) (a_1_1@@0 T@U) ) (!  (=> (and (= (type a_1@@0) RefType) (= (type a_1_1@@0) RefType)) (=> (and (and (and (and (not (= a_1@@0 a_1_1@@0)) (= a_1@@0 x@@31)) (= a_1_1@@0 x@@31)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@31 x@@31))))
 :qid |stdinbpl.870:17|
 :skolemid |119|
 :pattern ( (neverTriggered2 a_1@@0) (neverTriggered2 a_1_1@@0))
)) (=> (and (and (and (forall ((a_1@@1 T@U) ) (!  (=> (= (type a_1@@1) RefType) (=> (and (= a_1@@1 x@@31) (< NoPerm FullPerm)) (and (= (invRecv2 x@@31 3) a_1@@1) (qpRange2 x@@31 3))))
 :qid |stdinbpl.876:22|
 :skolemid |120|
 :no-pattern (type a_1@@1)
 :no-pattern (U_2_int a_1@@1)
 :no-pattern (U_2_bool a_1@@1)
)) (forall ((x_1_1 T@U) (i@@5 Int) ) (!  (=> (= (type x_1_1) RefType) (=> (and (and (= (invRecv2 x_1_1 i@@5) x@@31) (< NoPerm FullPerm)) (qpRange2 x_1_1 i@@5)) (and (= x@@31 x_1_1) (= 3 i@@5))))
 :qid |stdinbpl.880:22|
 :skolemid |121|
 :pattern ( (invRecv2 x_1_1 i@@5))
))) (and (forall ((x_1_1@@0 T@U) (i@@6 Int) ) (!  (=> (= (type x_1_1@@0) RefType) (=> (and (and (= (invRecv2 x_1_1@@0 i@@6) x@@31) (< NoPerm FullPerm)) (qpRange2 x_1_1@@0 i@@6)) (and (=> (< NoPerm FullPerm) (and (= x@@31 x_1_1@@0) (= 3 i@@6))) (= (U_2_real (MapType2Select QPMask@0 null (P x_1_1@@0 i@@6))) (+ (U_2_real (MapType2Select ZeroMask null (P x_1_1@@0 i@@6))) FullPerm)))))
 :qid |stdinbpl.886:22|
 :skolemid |122|
...
)))) (and (and (forall ((x_1_1@@1 T@U) (i@@7 Int) ) (!  (=> (and (= (type x_1_1@@1) RefType) (not (and (and (= (invRecv2 x_1_1@@1 i@@7) x@@31) (< NoPerm FullPerm)) (qpRange2 x_1_1@@1 i@@7)))) (= (U_2_real (MapType2Select QPMask@0 null (P x_1_1@@1 i@@7))) (U_2_real (MapType2Select ZeroMask null (P x_1_1@@1 i@@7)))))
 :qid |stdinbpl.896:22|
 :skolemid |124|
