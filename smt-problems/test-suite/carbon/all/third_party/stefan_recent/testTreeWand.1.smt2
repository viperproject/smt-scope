...
(assert  (and (= (type s@@21) (SeqType intType)) (= (type Heap@@41) (MapType0Type RefType))))
(set-info :boogie-vc-id |Tree__sorted_list#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (not (and (<= 0 i_1) (and (< i_1 j_1) (< j_1 (|Seq#Length| s@@21))))) (= (ControlFlow 0 8) 2)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (<= 0 i_1) (and (< i_1 j_1) (< j_1 (|Seq#Length| s@@21)))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (>= i_1 0)) (=> (>= i_1 0) (and (=> (= (ControlFlow 0 3) (- 0 6)) (< i_1 (|Seq#Length| s@@21))) (=> (< i_1 (|Seq#Length| s@@21)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (>= j_1 0)) (=> (>= j_1 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< j_1 (|Seq#Length| s@@21))) (=> (< j_1 (|Seq#Length| s@@21)) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))))))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (and (state Heap@@41 ZeroMask) (= AssumeFunctionsAbove 5)) (and (and (=> (= (ControlFlow 0 9) 1) anon5_Else_correct) (=> (= (ControlFlow 0 9) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct)))))
