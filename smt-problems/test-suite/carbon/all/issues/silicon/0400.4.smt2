...
(set-info :boogie-vc-id test_take_length_01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= a_2@0 (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 1)) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 5))) (|Seq#Singleton| (int_2_U 7))) (|Seq#Singleton| (int_2_U 8)))) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (|Seq#Length| (|Seq#Take| a_2@0 0)) 0)) (=> (= (|Seq#Length| (|Seq#Take| a_2@0 0)) 0) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (|Seq#Length| (|Seq#Take| a_2@0 1)) 1)) (=> (= (|Seq#Length| (|Seq#Take| a_2@0 1)) 1) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (|Seq#Length| (|Seq#Take| a_2@0 2)) 2)) (=> (= (|Seq#Length| (|Seq#Take| a_2@0 2)) 2) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (|Seq#Length| (|Seq#Take| a_2@0 5)) (|Seq#Length| a_2@0)))))))))))))))
