...
(assert  (and (= (type xs@@6) (SeqType RefType)) (= (type Heap@@10) (MapType0Type RefType))))
(set-info :boogie-vc-id |P#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 i_1) (< i_1 3))) (= (ControlFlow 0 14) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (<= 0 i_1) (< i_1 3)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= i_1 0)) (=> (>= i_1 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< i_1 (|Seq#Length| xs@@6))) (=> (< i_1 (|Seq#Length| xs@@6)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((i_4 Int) (i_4_1 Int) ) (!  (=> (and (and (and (and (not (= i_4 i_4_1)) (and (<= 0 i_4) (< i_4 3))) (and (<= 0 i_4_1) (< i_4_1 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@6 i_4) (|Seq#Index| xs@@6 i_4_1))))
 :qid |stdinbpl.670:15|
 :skolemid |66|
)))))
(let ((anon9_Else_correct  (=> (forall ((i_2 Int) (j_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@6)) (int_2_U i_2)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@6)) (int_2_U j_1)) (not (= i_2 j_1)))) (not (= (|Seq#Index| xs@@6 i_2) (|Seq#Index| xs@@6 j_1))))
 :qid |stdinbpl.653:20|
 :skolemid |65|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@6)) (int_2_U i_2)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@6)) (int_2_U j_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@6)) (int_2_U i_2)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@6)) (int_2_U j_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@6)) (int_2_U i_2)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@6)) (int_2_U j_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@6)) (int_2_U i_2)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@6)) (int_2_U j_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@6)) (int_2_U i_2)) (|Seq#Index| xs@@6 j_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@6)) (int_2_U i_2)) (|Seq#Index| xs@@6 j_1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@6)) (int_2_U j_1)) (|Seq#Index| xs@@6 i_2))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@6)) (int_2_U j_1)) (|Seq#Index| xs@@6 i_2))
 :pattern ( (|Seq#Index| xs@@6 i_2) (|Seq#Index| xs@@6 j_1))
...
(let ((anon10_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@6)) (int_2_U i@@6)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@6)) (int_2_U j@@5)) (not (= i@@6 j@@5))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@6)) (int_2_U i@@6)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@6)) (int_2_U j@@5)) (not (= i@@6 j@@5)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i@@6 (|Seq#Length| xs@@6))) (=> (< i@@6 (|Seq#Length| xs@@6)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j@@5 (|Seq#Length| xs@@6))) (=> (< j@@5 (|Seq#Length| xs@@6)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (< 3 (|Seq#Length| xs@@6))) (and (and (=> (= (ControlFlow 0 16) 15) anon9_Else_correct) (=> (= (ControlFlow 0 16) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 16) 7) anon10_Else_correct)))))
