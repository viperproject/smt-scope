...
(declare-fun i_4 () Int)
(declare-fun j_2 () Int)
(assert  (and (and (= (type xs) (SeqType RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 53) (let ((anon31_correct true))
(let ((anon48_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_12))) (= (ControlFlow 0 45) 42)) anon31_correct)))
(let ((anon48_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_12)) (and (=> (= (ControlFlow 0 43) (- 0 44)) (> (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs i_12) f_7)) 1)) (=> (> (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs i_12) f_7)) 1) (=> (= (ControlFlow 0 43) 42) anon31_correct))))))
(let ((anon27_correct true))
(let ((anon46_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_9))) (= (ControlFlow 0 41) 36)) anon27_correct)))
(let ((anon46_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_9)) (and (=> (= (ControlFlow 0 37) (- 0 40)) (>= i_9 0)) (=> (>= i_9 0) (and (=> (= (ControlFlow 0 37) (- 0 39)) (< i_9 (|Seq#Length| xs))) (=> (< i_9 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 37) (- 0 38)) (HasDirectPerm QPMask@0 (|Seq#Index| xs i_9) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs i_9) f_7) (=> (= (ControlFlow 0 37) 36) anon27_correct))))))))))
(let ((anon47_Else_correct true))
(let ((anon43_Else_correct  (=> (forall ((i_10 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_10)) (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs i_10) f_7)) 2))
 :qid |stdinbpl.1073:20|
 :skolemid |134|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_10)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_10)))
 :pattern ( (|Seq#Index| xs i_10))
)) (=> (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)) (and (and (and (and (=> (= (ControlFlow 0 46) 35) anon47_Else_correct) (=> (= (ControlFlow 0 46) 43) anon48_Then_correct)) (=> (= (ControlFlow 0 46) 45) anon48_Else_correct)) (=> (= (ControlFlow 0 46) 37) anon46_Then_correct)) (=> (= (ControlFlow 0 46) 41) anon46_Else_correct))))))
(let ((anon23_correct true))
(let ((anon44_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_8))) (= (ControlFlow 0 34) 29)) anon23_correct)))
(let ((anon44_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_8)) (and (=> (= (ControlFlow 0 30) (- 0 33)) (>= i_8 0)) (=> (>= i_8 0) (and (=> (= (ControlFlow 0 30) (- 0 32)) (< i_8 (|Seq#Length| xs))) (=> (< i_8 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 30) (- 0 31)) (HasDirectPerm QPMask@0 (|Seq#Index| xs i_8) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs i_8) f_7) (=> (= (ControlFlow 0 30) 29) anon23_correct))))))))))
(let ((anon41_Else_correct  (=> (and (forall ((i_8_1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_8_1)) (>= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs i_8_1) f_7)) 1))
 :qid |stdinbpl.1050:20|
 :skolemid |133|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_8_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_8_1)))
 :pattern ( (|Seq#Index| xs i_8_1))
)) (state Heap@@9 QPMask@0)) (and (and (=> (= (ControlFlow 0 47) 46) anon43_Else_correct) (=> (= (ControlFlow 0 47) 30) anon44_Then_correct)) (=> (= (ControlFlow 0 47) 34) anon44_Else_correct)))))
(let ((anon19_correct true))
(let ((anon42_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_7_1))) (= (ControlFlow 0 28) 25)) anon19_correct)))
(let ((anon42_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_7_1)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (>= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs i_7_1) f_7)) 1)) (=> (>= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs i_7_1) f_7)) 1) (=> (= (ControlFlow 0 26) 25) anon19_correct))))))
(let ((anon15_correct true))
(let ((anon40_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_7))) (= (ControlFlow 0 24) 19)) anon15_correct)))
(let ((anon40_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_7)) (and (=> (= (ControlFlow 0 20) (- 0 23)) (>= i_7 0)) (=> (>= i_7 0) (and (=> (= (ControlFlow 0 20) (- 0 22)) (< i_7 (|Seq#Length| xs))) (=> (< i_7 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (HasDirectPerm QPMask@0 (|Seq#Index| xs i_7) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs i_7) f_7) (=> (= (ControlFlow 0 20) 19) anon15_correct))))))))))
(let ((anon37_Else_correct  (=> (forall ((i_5_1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_5_1)) (> (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs i_5_1) f_7)) 0))
 :qid |stdinbpl.1017:20|
 :skolemid |132|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_5_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_5_1)))
 :pattern ( (|Seq#Index| xs i_5_1))
)) (=> (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)) (and (and (and (and (=> (= (ControlFlow 0 48) 47) anon41_Else_correct) (=> (= (ControlFlow 0 48) 26) anon42_Then_correct)) (=> (= (ControlFlow 0 48) 28) anon42_Else_correct)) (=> (= (ControlFlow 0 48) 20) anon40_Then_correct)) (=> (= (ControlFlow 0 48) 24) anon40_Else_correct))))))
(let ((anon11_correct true))
(let ((anon38_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_6))) (= (ControlFlow 0 18) 13)) anon11_correct)))
(let ((anon38_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_6)) (and (=> (= (ControlFlow 0 14) (- 0 17)) (>= i_6 0)) (=> (>= i_6 0) (and (=> (= (ControlFlow 0 14) (- 0 16)) (< i_6 (|Seq#Length| xs))) (=> (< i_6 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm QPMask@0 (|Seq#Index| xs i_6) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs i_6) f_7) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))))
(let ((anon35_Else_correct  (and (=> (= (ControlFlow 0 49) (- 0 50)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_3))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_3) (|Seq#Index| xs i_3_1))))
 :qid |stdinbpl.965:15|
 :skolemid |126|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_3@@0))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_3@@0) (|Seq#Index| xs i_3_1@@0))))
 :qid |stdinbpl.965:15|
 :skolemid |126|
)) (=> (and (and (and (forall ((i_3@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_3@@1)) (< NoPerm FullPerm)) (and (qpRange2 (|Seq#Index| xs i_3@@1)) (= (invRecv2 (|Seq#Index| xs i_3@@1)) i_3@@1)))
 :qid |stdinbpl.971:22|
 :skolemid |127|
 ...
 :pattern ( (|Seq#Index| xs i_3@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U (invRecv2 o_3))) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (|Seq#Index| xs (invRecv2 o_3)) o_3)))
 :qid |stdinbpl.975:22|
 :skolemid |128|
 :pattern ( (invRecv2 o_3))
))) (and (forall ((i_3@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_3@@2)) (not (= (|Seq#Index| xs i_3@@2) null)))
 :qid |stdinbpl.981:22|
 :skolemid |129|
 ...
 :pattern ( (|Seq#Index| xs i_3@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| xs (invRecv2 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.987:22|
 :skolemid |130|
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (and (=> (= (ControlFlow 0 49) 48) anon37_Else_correct) (=> (= (ControlFlow 0 49) 14) anon38_Then_correct)) (=> (= (ControlFlow 0 49) 18) anon38_Else_correct)))))))
(let ((anon7_correct true))
(let ((anon36_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_5))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon36_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_5)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_5 0)) (=> (>= i_5 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_5 (|Seq#Length| xs))) (=> (< i_5 (|Seq#Length| xs)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon33_Else_correct  (=> (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_1)) (not (= i_1 j_1)))) (not (= (|Seq#Index| xs i_1) (|Seq#Index| xs j_1))))
 :qid |stdinbpl.941:20|
 :skolemid |125|
...
)) (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 51) 49) anon35_Else_correct) (=> (= (ControlFlow 0 51) 9) anon36_Then_correct)) (=> (= (ControlFlow 0 51) 12) anon36_Else_correct))))))
(let ((anon3_correct true))
(let ((anon34_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_4)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_2)) (not (= i_4 j_2))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon34_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i_4)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U j_2)) (not (= i_4 j_2)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_4 (|Seq#Length| xs))) (=> (< i_4 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_2 0)) (=> (>= j_2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_2 (|Seq#Length| xs))) (=> (< j_2 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (> (|Seq#Length| xs) 3)) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 52) 51) anon33_Else_correct) (=> (= (ControlFlow 0 52) 2) anon34_Then_correct)) (=> (= (ControlFlow 0 52) 7) anon34_Else_correct)))))
