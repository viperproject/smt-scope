...
(assert (forall ((p@8@00 $Ref) (s@9@00 $Ref)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/graphs/static/examples/list_reverse.vpr@249@13@253@44-aux|)))
(assert (forall ((p@8@00 $Ref) (s@9@00 $Ref)) (!
  (=
    (and
      (Set_in p@8@00 refs@0@00)
  ...
  :pattern ((create_edge<Edge> p@8@00 s@9@00))
  :qid |prog./silicon/silver/src/test/resources/graphs/static/examples/list_reverse.vpr@249@13@253@44|)))
(pop) ; 1
