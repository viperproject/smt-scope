...
(assert  (and (and (and (and (= (type xs) (SeqType RefType)) (= (type Heap@@13) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))))
...
(let ((anon25_Else_correct  (=> (and (not (and (<= 0 i_11) (and (< i_11 (|Seq#Length| xs)) (fun01 Heap@@13 i_11 b_2@@3)))) (= (ControlFlow 0 21) 17)) anon15_correct)))
(let ((anon25_Then_correct  (=> (and (<= 0 i_11) (and (< i_11 (|Seq#Length| xs)) (fun01 Heap@@13 i_11 b_2@@3))) (and (=> (= (ControlFlow 0 18) (- 0 20)) (>= i_11 0)) (=> (>= i_11 0) (and (=> (= (ControlFlow 0 18) (- 0 19)) (< i_11 (|Seq#Length| xs))) (=> (< i_11 (|Seq#Length| xs)) (=> (= (ControlFlow 0 18) 17) anon15_correct))))))))
(let ((anon23_Then_correct  (=> (< i_11 (|Seq#Length| xs)) (and (and (=> (= (ControlFlow 0 25) 24) anon24_Then_correct) (=> (= (ControlFlow 0 25) 18) anon25_Then_correct)) (=> (= (ControlFlow 0 25) 21) anon25_Else_correct)))))
(let ((anon23_Else_correct  (=> (<= (|Seq#Length| xs) i_11) (and (=> (= (ControlFlow 0 23) 18) anon25_Then_correct) (=> (= (ControlFlow 0 23) 21) anon25_Else_correct)))))
(let ((anon22_Then_correct  (=> (<= 0 i_11) (and (=> (= (ControlFlow 0 26) 25) anon23_Then_correct) (=> (= (ControlFlow 0 26) 23) anon23_Else_correct)))))
(let ((anon22_Else_correct  (=> (< i_11 0) (and (=> (= (ControlFlow 0 22) 18) anon25_Then_correct) (=> (= (ControlFlow 0 22) 21) anon25_Else_correct)))))
(let ((anon21_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 16)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (and (< i_3 (|Seq#Length| xs)) (fun01 Heap@@13 i_3 b_2@@3)))) (and (<= 0 i_3_1) (and (< i_3_1 (|Seq#Length| xs)) (fun01 Heap@@13 i_3_1 b_2@@3)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_3) (|Seq#Index| xs i_3_1))))
 :qid |stdinbpl.1422:17|
 :skolemid |115|
 :pattern ( (neverTriggered9 i_3) (neverTriggered9 i_3_1))
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (and (<= 0 i_3@@0) (and (< i_3@@0 (|Seq#Length| xs)) (fun01 Heap@@13 i_3@@0 b_2@@3)))) (and (<= 0 i_3_1@@0) (and (< i_3_1@@0 (|Seq#Length| xs)) (fun01 Heap@@13 i_3_1@@0 b_2@@3)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_3@@0) (|Seq#Index| xs i_3_1@@0))))
 :qid |stdinbpl.1422:17|
 :skolemid |115|
 :pattern ( (neverTriggered9 i_3@@0) (neverTriggered9 i_3_1@@0))
)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((i_3@@1 Int) ) (!  (=> (and (<= 0 i_3@@1) (and (< i_3@@1 (|Seq#Length| xs)) (fun01 Heap@@13 i_3@@1 b_2@@3))) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs i_3@@1) f_7)) FullPerm))
 :qid |stdinbpl.1429:17|
 :skolemid |116|
 :pattern ( (|Seq#Index| xs i_3@@1))
 :pattern ( (|fun01#frame| EmptyFrame i_3@@1 b_2@@3))
 :pattern ( (|Seq#Index| xs i_3@@1))
))) (=> (forall ((i_3@@2 Int) ) (!  (=> (and (<= 0 i_3@@2) (and (< i_3@@2 (|Seq#Length| xs)) (fun01 Heap@@13 i_3@@2 b_2@@3))) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs i_3@@2) f_7)) FullPerm))
 :qid |stdinbpl.1429:17|
 :skolemid |116|
 :pattern ( (|Seq#Index| xs i_3@@2))
 :pattern ( (|fun01#frame| EmptyFrame i_3@@2 b_2@@3))
 :pattern ( (|Seq#Index| xs i_3@@2))
)) (=> (forall ((i_3@@3 Int) ) (!  (=> (and (and (<= 0 i_3@@3) (and (< i_3@@3 (|Seq#Length| xs)) (fun01 Heap@@13 i_3@@3 b_2@@3))) (< NoPerm FullPerm)) (and (qpRange9 (|Seq#Index| xs i_3@@3)) (= (invRecv9 (|Seq#Index| xs i_3@@3)) i_3@@3)))
 :qid |stdinbpl.1435:22|
 :skolemid |117|
 :pattern ( (|Seq#Index| xs i_3@@3))
 :pattern ( (|fun01#frame| EmptyFrame i_3@@3 b_2@@3))
 :pattern ( (|Seq#Index| xs i_3@@3))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (<= 0 (invRecv9 o_3)) (and (< (invRecv9 o_3) (|Seq#Length| xs)) (fun01 Heap@@13 (invRecv9 o_3) b_2@@3))) (and (< NoPerm FullPerm) (qpRange9 o_3))) (= (|Seq#Index| xs (invRecv9 o_3)) o_3)))
 :qid |stdinbpl.1439:22|
 :skolemid |118|
 :pattern ( (invRecv9 o_3))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (<= 0 (invRecv9 o_3@@0)) (and (< (invRecv9 o_3@@0) (|Seq#Length| xs)) (fun01 Heap@@13 (invRecv9 o_3@@0) b_2@@3))) (and (< NoPerm FullPerm) (qpRange9 o_3@@0))) (and (= (|Seq#Index| xs (invRecv9 o_3@@0)) o_3@@0) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (- (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (<= 0 (invRecv9 o_3@@0)) (and (< (invRecv9 o_3@@0) (|Seq#Length| xs)) (fun01 Heap@@13 (invRecv9 o_3@@0) b_2@@3))) (and (< NoPerm FullPerm) (qpRange9 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7))))))
 :qid |stdinbpl.1445:22|
 :skolemid |119|
...
)) (IdenticalOnKnownLocations Heap@@13 ExhaleHeap@0 QPMask@1)) (and (state ExhaleHeap@0 QPMask@1) (= (ControlFlow 0 14) (- 0 13)))) b_2@@3)))))))))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (|Seq#Length| xs)))) (and (<= 0 i_1_1) (< i_1_1 (|Seq#Length| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_1) (|Seq#Index| xs i_1_1))))
 :qid |stdinbpl.1355:15|
 :skolemid |109|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= 0 i_1@@0) (< i_1@@0 (|Seq#Length| xs)))) (and (<= 0 i_1_1@@0) (< i_1_1@@0 (|Seq#Length| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_1@@0) (|Seq#Index| xs i_1_1@@0))))
 :qid |stdinbpl.1355:15|
 :skolemid |109|
)) (=> (and (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 (|Seq#Length| xs))) (< NoPerm FullPerm)) (and (qpRange8 (|Seq#Index| xs i_1@@1)) (= (invRecv8 (|Seq#Index| xs i_1@@1)) i_1@@1)))
 :qid |stdinbpl.1361:22|
 :skolemid |110|
 :pattern ( (|Seq#Index| xs i_1@@1))
 :pattern ( (|Seq#Index| xs i_1@@1))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (<= 0 (invRecv8 o_3@@2)) (< (invRecv8 o_3@@2) (|Seq#Length| xs))) (< NoPerm FullPerm)) (qpRange8 o_3@@2)) (= (|Seq#Index| xs (invRecv8 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.1365:22|
 :skolemid |111|
 :pattern ( (invRecv8 o_3@@2))
))) (and (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (< i_1@@2 (|Seq#Length| xs))) (not (= (|Seq#Index| xs i_1@@2) null)))
 :qid |stdinbpl.1371:22|
 :skolemid |112|
 :pattern ( (|Seq#Index| xs i_1@@2))
 :pattern ( (|Seq#Index| xs i_1@@2))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (and (<= 0 (invRecv8 o_3@@3)) (< (invRecv8 o_3@@3) (|Seq#Length| xs))) (< NoPerm FullPerm)) (qpRange8 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| xs (invRecv8 o_3@@3)) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv8 o_3@@3)) (< (invRecv8 o_3@@3) (|Seq#Length| xs))) (< NoPerm FullPerm)) (qpRange8 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@3 f_7))))))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 ...
 :qid |stdinbpl.1381:29|
 :skolemid |114|
 :pattern ( (MapType1Select ZeroMask o_3@@4 f_5@@0))
 :pattern ( (MapType1Select QPMask@0 o_3@@4 f_5@@0))
)) (state Heap@@13 QPMask@0)) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)))) (and (and (=> (= (ControlFlow 0 27) 14) anon21_Else_correct) (=> (= (ControlFlow 0 27) 26) anon22_Then_correct)) (=> (= (ControlFlow 0 27) 22) anon22_Else_correct)))))))
(let ((anon7_correct true))
(let ((anon20_Else_correct  (=> (and (not (and (<= 0 i_10) (< i_10 (|Seq#Length| xs)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon20_Then_correct  (=> (and (<= 0 i_10) (< i_10 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_10 0)) (=> (>= i_10 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_10 (|Seq#Length| xs))) (=> (< i_10 (|Seq#Length| xs)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon17_Else_correct  (=> (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (<= 0 i1_1) (and (< i1_1 (|Seq#Length| xs)) (and (<= 0 i2_1) (and (< i2_1 (|Seq#Length| xs)) (not (= i1_1 i2_1)))))) (not (= (|Seq#Index| xs i1_1) (|Seq#Index| xs i2_1))))
 :qid |stdinbpl.1332:20|
 :skolemid |108|
 :pattern ( (|Seq#Index| xs i1_1) (|Seq#Index| xs i2_1))
)) (=> (and (state Heap@@13 ZeroMask) (state Heap@@13 ZeroMask)) (and (and (=> (= (ControlFlow 0 29) 27) anon19_Else_correct) (=> (= (ControlFlow 0 29) 9) anon20_Then_correct)) (=> (= (ControlFlow 0 29) 12) anon20_Else_correct))))))
(let ((anon3_correct true))
(let ((anon18_Else_correct  (=> (and (not (and (<= 0 i1_5) (and (< i1_5 (|Seq#Length| xs)) (and (<= 0 i2_5) (and (< i2_5 (|Seq#Length| xs)) (not (= i1_5 i2_5))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon18_Then_correct  (=> (and (<= 0 i1_5) (and (< i1_5 (|Seq#Length| xs)) (and (<= 0 i2_5) (and (< i2_5 (|Seq#Length| xs)) (not (= i1_5 i2_5)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_5 0)) (=> (>= i1_5 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_5 (|Seq#Length| xs))) (=> (< i1_5 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_5 0)) (=> (>= i2_5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_5 (|Seq#Length| xs))) (=> (< i2_5 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (< 10 (|Seq#Length| xs))) (and (state Heap@@13 ZeroMask) (state Heap@@13 ZeroMask))) (and (and (=> (= (ControlFlow 0 30) 29) anon17_Else_correct) (=> (= (ControlFlow 0 30) 2) anon18_Then_correct)) (=> (= (ControlFlow 0 30) 7) anon18_Else_correct))))))
