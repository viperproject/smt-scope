...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon18_Then_correct  (=> (= (ControlFlow 0 12) (- 0 11)) (>= (- i@@15 3) 0))))
(let ((anon14_correct true))
(let ((anon20_Else_correct  (=> (and (|f1#trigger| EmptyFrame (- i@@15 1)) (= (ControlFlow 0 8) 5)) anon14_correct)))
(let ((anon19_Then_correct  (=> (and (or (< (f1 Heap@@34 (- i@@15 1)) 4) (< (f1 Heap@@34 (- i@@15 3)) 6)) (= (ControlFlow 0 7) 5)) anon14_correct)))
(let ((anon15_Then_correct  (=> (and (< i@@15 10) (= (ControlFlow 0 6) 5)) anon14_correct)))
(let ((anon20_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (>= (- i@@15 1) 0))))
(let ((anon19_Else_correct  (=> (not (or (< (f1 Heap@@34 (- i@@15 1)) 4) (< (f1 Heap@@34 (- i@@15 3)) 6))) (and (=> (= (ControlFlow 0 9) 4) anon20_Then_correct) (=> (= (ControlFlow 0 9) 8) anon20_Else_correct)))))
(let ((anon18_Else_correct  (=> (|f1#trigger| EmptyFrame (- i@@15 3)) (and (=> (= (ControlFlow 0 13) 7) anon19_Then_correct) (=> (= (ControlFlow 0 13) 9) anon19_Else_correct)))))
(let ((anon17_Then_correct  (=> (not (< (f1 Heap@@34 (- i@@15 1)) 4)) (and (=> (= (ControlFlow 0 14) 12) anon18_Then_correct) (=> (= (ControlFlow 0 14) 13) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (< (f1 Heap@@34 (- i@@15 1)) 4) (and (=> (= (ControlFlow 0 10) 7) anon19_Then_correct) (=> (= (ControlFlow 0 10) 9) anon19_Else_correct)))))
(let ((anon16_Else_correct  (=> (|f1#trigger| EmptyFrame (- i@@15 1)) (and (=> (= (ControlFlow 0 15) 14) anon17_Then_correct) (=> (= (ControlFlow 0 15) 10) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (>= (- i@@15 1) 0))))
(let ((anon15_Else_correct  (=> (<= 10 i@@15) (and (=> (= (ControlFlow 0 16) 2) anon16_Then_correct) (=> (= (ControlFlow 0 16) 15) anon16_Else_correct)))))
(let ((anon0_correct  (=> (and (and (state Heap@@34 ZeroMask) (= AssumeFunctionsAbove 2)) (and (>= i@@15 0) (state Heap@@34 ZeroMask))) (and (=> (= (ControlFlow 0 17) 6) anon15_Then_correct) (=> (= (ControlFlow 0 17) 16) anon15_Else_correct)))))
