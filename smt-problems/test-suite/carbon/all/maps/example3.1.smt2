...
(declare-fun s@0 () T@U)
(assert  (and (= (type Heap@@9) (MapType1Type RefType)) (= (type s@0) (MapType0Type intType boolType))))
(set-info :boogie-vc-id test2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (U_2_bool (MapType0Select (|Map#Domain| (f_7 (int_2_U 2))) (|Set#UnionOne| (|Set#UnionOne| (|Set#Singleton| (int_2_U 3)) (int_2_U 2)) (int_2_U 1))))) (=> (U_2_bool (MapType0Select (|Map#Domain| (f_7 (int_2_U 2))) (|Set#UnionOne| (|Set#UnionOne| (|Set#Singleton| (int_2_U 3)) (int_2_U 2)) (int_2_U 1)))) (=> (state Heap@@9 ZeroMask) (=> (and (= s@0 (|Set#UnionOne| (|Set#UnionOne| (|Set#Singleton| (int_2_U 3)) (int_2_U 2)) (int_2_U 1))) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (MapType0Select (|Map#Domain| (f_7 (int_2_U 2))) s@0))) (=> (U_2_bool (MapType0Select (|Map#Domain| (f_7 (int_2_U 2))) s@0)) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (MapType0Select (|Map#Elements| (f_7 (int_2_U 2))) s@0)) 2)))))))))))
