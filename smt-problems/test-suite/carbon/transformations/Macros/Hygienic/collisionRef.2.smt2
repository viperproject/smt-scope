...
(declare-fun |x$3'| (T@U) Bool)
(declare-fun |x$3#frame| (T@U) Bool)
...
(assert (forall ((Heap@@3 T@U) (Mask@@3 T@U) ) (!  (=> (and (and (= (type Heap@@3) (MapType0Type RefType)) (= (type Mask@@3) (MapType1Type RefType realType))) (and (state Heap@@3 Mask@@3) (< AssumeFunctionsAbove 0))) (x$3 Heap@@3))
 :qid |stdinbpl.195:15|
 :skolemid |24|
 :pattern ( (state Heap@@3 Mask@@3) (x$3 Heap@@3))
)))
...
(assert (forall ((Heap@@6 T@U) (Mask@@7 T@U) ) (!  (=> (and (and (= (type Heap@@6) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (state Heap@@6 Mask@@7)) (= (|x$3'| Heap@@6) (|x$3#frame| EmptyFrame)))
 :qid |stdinbpl.202:15|
 :skolemid |25|
 :pattern ( (state Heap@@6 Mask@@7) (|x$3'| Heap@@6))
)))
...
(assert (forall ((Heap@@9 T@U) ) (!  (=> (= (type Heap@@9) (MapType0Type RefType)) (dummyFunction (bool_2_U |x$3#triggerStateless|)))
 :qid |stdinbpl.189:15|
 :skolemid |23|
 :pattern ( (|x$3'| Heap@@9))
)))
...
(assert (forall ((Heap@@12 T@U) ) (!  (=> (= (type Heap@@12) (MapType0Type RefType)) (and (= (x$3 Heap@@12) (|x$3'| Heap@@12)) (dummyFunction (bool_2_U |x$3#triggerStateless|))))
 :qid |stdinbpl.185:15|
 :skolemid |22|
 :pattern ( (x$3 Heap@@12))
)))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (state Heap@@13 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (state Heap@@13 ZeroMask) (=> (and (state Heap@@13 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) true)))))))
