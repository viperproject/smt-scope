...
(declare-fun i1 () Int)
(declare-fun i2 () Int)
(assert  (and (and (and (and (= (type xs) (SeqType RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test03)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 44) (let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 32) (- 0 35)) (< 0 (|Seq#Length| xs))) (=> (< 0 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 32) (- 0 34)) (< 1 (|Seq#Length| xs))) (=> (< 1 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 32) (- 0 33)) (not (= (|Seq#Index| xs 0) (|Seq#Index| xs 1)))) (=> (not (= (|Seq#Index| xs 0) (|Seq#Index| xs 1))) (=> (and (state Heap@@9 QPMask@1) (= (ControlFlow 0 32) (- 0 31))) (not (= (|Seq#Index| xs 0) (|Seq#Index| xs 1))))))))))))
(let ((anon27_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 29) (- 0 30)) (< 0 (|Seq#Length| xs))) (=> (< 0 (|Seq#Length| xs)) (=> (= (ControlFlow 0 29) (- 0 28)) (< 1 (|Seq#Length| xs))))))))
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 36) (- 0 37)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 (|Seq#Length| xs)))) (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (MapType0Select Heap@@9 (|Seq#Index| xs i_3) g) (MapType0Select Heap@@9 (|Seq#Index| xs i_3_1) g))))
 :qid |stdinbpl.1456:15|
 :skolemid |179|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (and (<= 0 i_3@@0) (< i_3@@0 (|Seq#Length| xs)))) (and (<= 0 i_3_1@@0) (< i_3_1@@0 (|Seq#Length| xs)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (MapType0Select Heap@@9 (|Seq#Index| xs i_3@@0) g) (MapType0Select Heap@@9 (|Seq#Index| xs i_3_1@@0) g))))
 :qid |stdinbpl.1456:15|
 :skolemid |179|
)) (=> (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 (|Seq#Length| xs))) (< NoPerm FullPerm)) (and (qpRange10 (MapType0Select Heap@@9 (|Seq#Index| xs i_3@@1) g)) (= (invRecv10 (MapType0Select Heap@@9 (|Seq#Index| xs i_3@@1) g)) i_3@@1)))
 :qid |stdinbpl.1462:22|
 :skolemid |180|
 :pattern ( (MapType0Select Heap@@9 (|Seq#Index| xs i_3@@1) g))
 :pattern ( (|Seq#Index| xs i_3@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv10 o_3)) (< (invRecv10 o_3) (|Seq#Length| xs))) (< NoPerm FullPerm)) (qpRange10 o_3)) (= (MapType0Select Heap@@9 (|Seq#Index| xs (invRecv10 o_3)) g) o_3)))
 :qid |stdinbpl.1466:22|
 :skolemid |181|
 :pattern ( (invRecv10 o_3))
)) (forall ((i_3@@2 Int) ) (!  (=> (and (<= 0 i_3@@2) (< i_3@@2 (|Seq#Length| xs))) (not (= (MapType0Select Heap@@9 (|Seq#Index| xs i_3@@2) g) null)))
 :qid |stdinbpl.1472:22|
 :skolemid |182|
 :pattern ( (MapType0Select Heap@@9 (|Seq#Index| xs i_3@@2) g))
 :pattern ( (|Seq#Index| xs i_3@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv10 o_3@@0)) (< (invRecv10 o_3@@0) (|Seq#Length| xs))) (< NoPerm FullPerm)) (qpRange10 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (MapType0Select Heap@@9 (|Seq#Index| xs (invRecv10 o_3@@0)) g) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv10 o_3@@0)) (< (invRecv10 o_3@@0) (|Seq#Length| xs))) (< NoPerm FullPerm)) (qpRange10 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7))))))
...
))) (and (state Heap@@9 QPMask@1) (state Heap@@9 QPMask@1))) (and (=> (= (ControlFlow 0 36) 29) anon27_Then_correct) (=> (= (ControlFlow 0 36) 32) anon27_Else_correct)))))))))
(let ((anon15_correct true))
(let ((anon26_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 (|Seq#Length| xs)))) (= (ControlFlow 0 27) 22)) anon15_correct)))
(let ((anon26_Then_correct  (=> (and (<= 0 i_2) (< i_2 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 23) (- 0 26)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 23) (- 0 25)) (< i_2 (|Seq#Length| xs))) (=> (< i_2 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (HasDirectPerm QPMask@0 (|Seq#Index| xs i_2) g)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs i_2) g) (=> (= (ControlFlow 0 23) 22) anon15_correct))))))))))
(let ((anon23_Else_correct  (=> (and (forall ((i1_3 Int) (i2_3 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i1_3)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i2_3)) (not (= i1_3 i2_3)))) (not (= (MapType0Select Heap@@9 (|Seq#Index| xs i1_3) g) (MapType0Select Heap@@9 (|Seq#Index| xs i2_3) g))))
 :qid |stdinbpl.1436:20|
 :skolemid |178|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i1_3)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i2_3)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i1_3)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i2_3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i1_3)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i2_3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i1_3)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i2_3)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i1_3)) (|Seq#Index| xs i2_3))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i1_3)) (|Seq#Index| xs i2_3))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i2_3)) (|Seq#Index| xs i1_3))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i2_3)) (|Seq#Index| xs i1_3))
 :pattern ( (|Seq#Index| xs i1_3) (|Seq#Index| xs i2_3))
)) (state Heap@@9 QPMask@0)) (and (and (=> (= (ControlFlow 0 38) 36) anon25_Else_correct) (=> (= (ControlFlow 0 38) 23) anon26_Then_correct)) (=> (= (ControlFlow 0 38) 27) anon26_Else_correct)))))
(let ((anon11_correct true))
(let ((anon24_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i1_2)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i2_2)) (not (= i1_2 i2_2))))) (= (ControlFlow 0 21) 13)) anon11_correct)))
(let ((anon24_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i1_2)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i2_2)) (not (= i1_2 i2_2)))) (and (=> (= (ControlFlow 0 14) (- 0 20)) (>= i1_2 0)) (=> (>= i1_2 0) (and (=> (= (ControlFlow 0 14) (- 0 19)) (< i1_2 (|Seq#Length| xs))) (=> (< i1_2 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 14) (- 0 18)) (HasDirectPerm QPMask@0 (|Seq#Index| xs i1_2) g)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs i1_2) g) (and (=> (= (ControlFlow 0 14) (- 0 17)) (>= i2_2 0)) (=> (>= i2_2 0) (and (=> (= (ControlFlow 0 14) (- 0 16)) (< i2_2 (|Seq#Length| xs))) (=> (< i2_2 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm QPMask@0 (|Seq#Index| xs i2_2) g)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs i2_2) g) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))))))))))
(let ((anon21_Else_correct  (and (=> (= (ControlFlow 0 39) (- 0 41)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (|Seq#Length| xs)))) (and (<= 0 i_1_1) (< i_1_1 (|Seq#Length| xs)))) (< NoPerm (/ (to_real 2) (to_real 3)))) (< NoPerm (/ (to_real 2) (to_real 3)))) (not (= (|Seq#Index| xs i_1) (|Seq#Index| xs i_1_1))))
 :qid |stdinbpl.1378:15|
 :skolemid |171|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= 0 i_1@@0) (< i_1@@0 (|Seq#Length| xs)))) (and (<= 0 i_1_1@@0) (< i_1_1@@0 (|Seq#Length| xs)))) (< NoPerm (/ (to_real 2) (to_real 3)))) (< NoPerm (/ (to_real 2) (to_real 3)))) (not (= (|Seq#Index| xs i_1@@0) (|Seq#Index| xs i_1_1@@0))))
 :qid |stdinbpl.1378:15|
 :skolemid |171|
)) (=> (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 (|Seq#Length| xs))) (< NoPerm (/ (to_real 2) (to_real 3)))) (and (qpRange9 (|Seq#Index| xs i_1@@1)) (= (invRecv9 (|Seq#Index| xs i_1@@1)) i_1@@1)))
 :qid |stdinbpl.1384:22|
 :skolemid |172|
 :pattern ( (|Seq#Index| xs i_1@@1))
 :pattern ( (|Seq#Index| xs i_1@@1))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (<= 0 (invRecv9 o_3@@2)) (< (invRecv9 o_3@@2) (|Seq#Length| xs))) (< NoPerm (/ (to_real 2) (to_real 3)))) (qpRange9 o_3@@2)) (= (|Seq#Index| xs (invRecv9 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.1388:22|
 :skolemid |173|
 :pattern ( (invRecv9 o_3@@2))
))) (and (=> (= (ControlFlow 0 39) (- 0 40)) (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (< i_1@@2 (|Seq#Length| xs))) (>= (/ (to_real 2) (to_real 3)) NoPerm))
 :qid |stdinbpl.1394:15|
 :skolemid |174|
 :pattern ( (|Seq#Index| xs i_1@@2))
 :pattern ( (|Seq#Index| xs i_1@@2))
))) (=> (forall ((i_1@@3 Int) ) (!  (=> (and (<= 0 i_1@@3) (< i_1@@3 (|Seq#Length| xs))) (>= (/ (to_real 2) (to_real 3)) NoPerm))
 :qid |stdinbpl.1394:15|
 :skolemid |174|
 :pattern ( (|Seq#Index| xs i_1@@3))
 :pattern ( (|Seq#Index| xs i_1@@3))
)) (=> (forall ((i_1@@4 Int) ) (!  (=> (and (and (<= 0 i_1@@4) (< i_1@@4 (|Seq#Length| xs))) (> (/ (to_real 2) (to_real 3)) NoPerm)) (not (= (|Seq#Index| xs i_1@@4) null)))
 :qid |stdinbpl.1400:22|
 :skolemid |175|
 :pattern ( (|Seq#Index| xs i_1@@4))
 :pattern ( (|Seq#Index| xs i_1@@4))
)) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (and (<= 0 (invRecv9 o_3@@3)) (< (invRecv9 o_3@@3) (|Seq#Length| xs))) (< NoPerm (/ (to_real 2) (to_real 3)))) (qpRange9 o_3@@3)) (and (=> (< NoPerm (/ (to_real 2) (to_real 3))) (= (|Seq#Index| xs (invRecv9 o_3@@3)) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 g)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 g)) (/ (to_real 2) (to_real 3)))))) (=> (not (and (and (and (<= 0 (invRecv9 o_3@@3)) (< (invRecv9 o_3@@3) (|Seq#Length| xs))) (< NoPerm (/ (to_real 2) (to_real 3)))) (qpRange9 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 g)) (U_2_real (MapType1Select ZeroMask o_3@@3 g))))))
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 39) 38) anon23_Else_correct) (=> (= (ControlFlow 0 39) 14) anon24_Then_correct)) (=> (= (ControlFlow 0 39) 21) anon24_Else_correct)))))))))))
(let ((anon7_correct true))
(let ((anon22_Else_correct  (=> (and (not (and (<= 0 i@@6) (< i@@6 (|Seq#Length| xs)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon22_Then_correct  (=> (and (<= 0 i@@6) (< i@@6 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i@@6 (|Seq#Length| xs))) (=> (< i@@6 (|Seq#Length| xs)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon19_Else_correct  (=> (and (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i1_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i2_1)) (not (= i1_1 i2_1)))) (not (= (|Seq#Index| xs i1_1) (|Seq#Index| xs i2_1))))
 :qid |stdinbpl.1360:20|
 :skolemid |170|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i1_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i2_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i1_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i2_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i1_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i2_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i1_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i2_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i1_1)) (|Seq#Index| xs i2_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i1_1)) (|Seq#Index| xs i2_1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i2_1)) (|Seq#Index| xs i1_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i2_1)) (|Seq#Index| xs i1_1))
 :pattern ( (|Seq#Index| xs i1_1) (|Seq#Index| xs i2_1))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 42) 39) anon21_Else_correct) (=> (= (ControlFlow 0 42) 9) anon22_Then_correct)) (=> (= (ControlFlow 0 42) 12) anon22_Else_correct)))))
(let ((anon3_correct true))
(let ((anon20_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i2)) (not (= i1 i2))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon20_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U i2)) (not (= i1 i2)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1 0)) (=> (>= i1 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1 (|Seq#Length| xs))) (=> (< i1 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2 0)) (=> (>= i2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2 (|Seq#Length| xs))) (=> (< i2 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (> (|Seq#Length| xs) 1) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 43) 42) anon19_Else_correct) (=> (= (ControlFlow 0 43) 2) anon20_Then_correct)) (=> (= (ControlFlow 0 43) 7) anon20_Else_correct))))))
