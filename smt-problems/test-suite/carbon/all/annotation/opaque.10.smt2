...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon4_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@0 r_1@@36 f_7)) (=> (HasDirectPerm Mask@0 r_1@@36 f_7) (=> (= (ControlFlow 0 4) (- 0 3)) (= Result@0 (> (U_2_int (MapType0Select Heap@@72 r_1@@36 f_7)) 1)))))))
(let ((anon6_Else_correct  (=> (and (>= 60 (U_2_int (MapType0Select Heap@@72 r_1@@36 f_7))) (= (ControlFlow 0 8) 4)) anon4_correct)))
(let ((anon6_Then_correct  (=> (> (U_2_int (MapType0Select Heap@@72 r_1@@36 f_7)) 60) (and (=> (= (ControlFlow 0 6) (- 0 7)) Result@0) (=> Result@0 (=> (= (ControlFlow 0 6) 4) anon4_correct))))))
(let ((anon5_Else_correct  (=> (= Result@0 (|isGreaterOne'| Heap@@72 (U_2_int (MapType0Select Heap@@72 r_1@@36 f_7)))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm Mask@0 r_1@@36 f_7)) (=> (HasDirectPerm Mask@0 r_1@@36 f_7) (and (=> (= (ControlFlow 0 9) 6) anon6_Then_correct) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct)))))))
(let ((anon5_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (> (U_2_int (MapType0Select Heap@@72 r_1@@36 f_7)) (- 0 60)))))
(let ((anon0_correct  (=> (and (state Heap@@72 ZeroMask) (U_2_bool (MapType0Select Heap@@72 r_1@@36 $allocated))) (=> (and (and (= AssumeFunctionsAbove 5) (not (= r_1@@36 null))) (and (= Mask@0 (MapType1Store ZeroMask r_1@@36 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1@@36 f_7)) FullPerm)))) (state Heap@@72 Mask@0))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (HasDirectPerm Mask@0 r_1@@36 f_7)) (=> (HasDirectPerm Mask@0 r_1@@36 f_7) (=> (and (> (U_2_int (MapType0Select Heap@@72 r_1@@36 f_7)) (- 0 38)) (state Heap@@72 Mask@0)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm Mask@0 r_1@@36 f_7)) (=> (HasDirectPerm Mask@0 r_1@@36 f_7) (and (=> (= (ControlFlow 0 11) 2) anon5_Then_correct) (=> (= (ControlFlow 0 11) 9) anon5_Else_correct)))))))))))
...
(set-info :boogie-vc-id mProveRevealed)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (isGreaterOne Heap@@72 j)) (=> (isGreaterOne Heap@@72 j) (=> (and (state Heap@@72 ZeroMask) (= (ControlFlow 0 6) (- 0 5))) (> j 1))))))
...
(let ((anon5_Else_correct  (=> (isGreaterOne35 Heap@@72 r_1@@36) (=> (and (state Heap@@72 Mask@0) (state Heap@@72 Mask@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 r_1@@36 f_7)) (=> (HasDirectPerm Mask@0 r_1@@36 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (> (U_2_int (MapType0Select Heap@@72 r_1@@36 f_7)) 1))))))))
