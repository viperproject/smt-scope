...
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select ZeroMask null f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select ZeroMask null f_7))) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))
