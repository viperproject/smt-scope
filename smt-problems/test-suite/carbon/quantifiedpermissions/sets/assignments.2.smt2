...
(declare-fun y@@6 () T@U)
(assert  (and (and (and (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type x@@19) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type xs) (MapType2Type RefType boolType))) (= (type Heap@@9) (MapType0Type RefType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv5 arg0@@43)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon4_correct  (=> (= Mask@0 (MapType1Store QPMask@0 x@@19 f_7 (real_2_U (- (U_2_real (MapType1Select QPMask@0 x@@19 f_7)) FullPerm)))) (=> (and (IdenticalOnKnownLocations Heap@0 ExhaleHeap@0 Mask@0) (state ExhaleHeap@0 Mask@0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm Mask@0 x@@19 f_7)) (=> (HasDirectPerm Mask@0 x@@19 f_7) (=> (= (ControlFlow 0 3) (- 0 2)) (= (MapType0Select ExhaleHeap@0 x@@19 f_7) x@@19))))))))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 3)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 x@@19 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 x@@19 f_7))) (=> (= (ControlFlow 0 5) 3) anon4_correct))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 11)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (U_2_bool (MapType2Select xs z_1))) (U_2_bool (MapType2Select xs z_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1))))
 :qid |stdinbpl.728:15|
 :skolemid |106|
 :no-pattern (type z_1)
...
)) (=> (forall ((z_1@@1 T@U) ) (!  (=> (= (type z_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs z_1@@1)) (< NoPerm FullPerm)) (and (qpRange5 z_1@@1) (= (invRecv5 z_1@@1) z_1@@1))))
 :qid |stdinbpl.734:22|
 :skolemid |107|
 :pattern ( (MapType0Select Heap@@9 z_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@1 f_7))
 :pattern ( (MapType2Select xs z_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv5 o_3))) (< NoPerm FullPerm)) (qpRange5 o_3)) (= (invRecv5 o_3) o_3)))
 :qid |stdinbpl.738:22|
 :skolemid |108|
...
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs (invRecv5 o_3@@0))) (< NoPerm FullPerm)) (qpRange5 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv5 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select xs (invRecv5 o_3@@0))) (< NoPerm FullPerm)) (qpRange5 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.750:22|
 :skolemid |110|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (HasDirectPerm QPMask@0 y@@6 f_7)) (=> (HasDirectPerm QPMask@0 y@@6 f_7) (=> (= (MapType0Select Heap@@9 y@@6 f_7) y@@6) (=> (and (and (state Heap@@9 QPMask@0) (not (= x@@19 y@@6))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (= FullPerm (U_2_real (MapType1Select QPMask@0 x@@19 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 x@@19 f_7))) (=> (and (= Heap@0 (MapType0Store Heap@@9 x@@19 f_7 x@@19)) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 8) 5) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct))))))))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@19 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@9 y@@6 $allocated)) (U_2_bool (MapType2Select xs x@@19))) (and (U_2_bool (MapType2Select xs y@@6)) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 12) 1) anon5_Then_correct) (=> (= (ControlFlow 0 12) 8) anon5_Else_correct))))))
