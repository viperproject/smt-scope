...
(declare-fun i_1 () Int)
(declare-fun j_1 () Int)
(assert  (and (= (type s@@22) (SeqType RefType)) (= (type Heap@@27) (MapType0Type RefType))))
(set-info :boogie-vc-id |foo#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 (|Seq#Length| s@@22)))) (= (ControlFlow 0 14) 10)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (<= 0 i_2) (< i_2 (|Seq#Length| s@@22))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< i_2 (|Seq#Length| s@@22))) (=> (< i_2 (|Seq#Length| s@@22)) (=> (= (ControlFlow 0 11) 10) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (forall ((i_8 Int) (i_8_1 Int) ) (!  (=> (and (and (and (and (not (= i_8 i_8_1)) (and (<= 0 i_8) (< i_8 (|Seq#Length| s@@22)))) (and (<= 0 i_8_1) (< i_8_1 (|Seq#Length| s@@22)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| s@@22 i_8) (|Seq#Index| s@@22 i_8_1))))
 :qid |stdinbpl.681:17|
 :skolemid |65|
 :pattern ( (neverTriggered1 i_8) (neverTriggered1 i_8_1))
)))))
(let ((anon9_Else_correct  (=> (and (forall ((i_6 Int) (j_3 Int) ) (!  (=> (and (>= i_6 0) (and (< i_6 (|Seq#Length| s@@22)) (and (>= j_3 0) (and (< j_3 (|Seq#Length| s@@22)) (not (= i_6 j_3)))))) (not (= (|Seq#Index| s@@22 i_6) (|Seq#Index| s@@22 j_3))))
 :qid |stdinbpl.661:20|
 :skolemid |64|
 :pattern ( (|Seq#Index| s@@22 i_6) (|Seq#Index| s@@22 j_3))
)) (state Heap@@27 ZeroMask)) (and (and (=> (= (ControlFlow 0 15) 9) anon11_Else_correct) (=> (= (ControlFlow 0 15) 11) anon12_Then_correct)) (=> (= (ControlFlow 0 15) 14) anon12_Else_correct)))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (and (>= i_1 0) (and (< i_1 (|Seq#Length| s@@22)) (and (>= j_1 0) (and (< j_1 (|Seq#Length| s@@22)) (not (= i_1 j_1))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and (>= i_1 0) (and (< i_1 (|Seq#Length| s@@22)) (and (>= j_1 0) (and (< j_1 (|Seq#Length| s@@22)) (not (= i_1 j_1)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_1 0)) (=> (>= i_1 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_1 (|Seq#Length| s@@22))) (=> (< i_1 (|Seq#Length| s@@22)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_1 0)) (=> (>= j_1 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_1 (|Seq#Length| s@@22))) (=> (< j_1 (|Seq#Length| s@@22)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@27 ZeroMask) (= AssumeFunctionsAbove 0)) (and (and (=> (= (ControlFlow 0 16) 15) anon9_Else_correct) (=> (= (ControlFlow 0 16) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 16) 7) anon10_Else_correct)))))
