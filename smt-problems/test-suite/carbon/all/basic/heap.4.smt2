...
(assert  (and (= (type r_1) RefType) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id t2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_correct true))
(let ((anon4_Else_correct  (=> (= r_1 null) (and (=> (= (ControlFlow 0 4) (- 0 5)) (= (U_2_real (MapType1Select ZeroMask r_1 f_7)) NoPerm)) (=> (= (U_2_real (MapType1Select ZeroMask r_1 f_7)) NoPerm) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 4) 1)) anon3_correct))))))
(let ((anon4_Then_correct  (=> (not (= r_1 null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (U_2_real (MapType1Select ZeroMask r_1 f_7)) NoPerm)) (=> (= (U_2_real (MapType1Select ZeroMask r_1 f_7)) NoPerm) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) 1)) anon3_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 r_1 $allocated))) (and (=> (= (ControlFlow 0 6) 2) anon4_Then_correct) (=> (= (ControlFlow 0 6) 4) anon4_Else_correct)))))
