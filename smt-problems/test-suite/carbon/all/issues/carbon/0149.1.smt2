...
(declare-fun |range___contains__'| (T@U T@U Int) Bool)
(declare-fun MapType0Type (T@T) T@T)
(declare-fun RefType () T@T)
(declare-fun MapType1Type (T@T T@T) T@T)
(declare-fun |range___contains__#frame| (T@U T@U Int) Bool)
...
(declare-fun |range___contains__#triggerStateless| (T@U Int) Bool)
...
(declare-fun |range___create__'| (T@U) T@U)
(declare-fun AssumeFunctionsAbove () Int)
(declare-fun |range___create__#trigger| (T@U) Bool)
(declare-fun range___contains__ (T@U T@U Int) Bool)
...
(declare-fun range___create__ (T@U) T@U)
(declare-fun |range___create__#triggerStateless| () T@U)
(declare-fun NoPerm () Real)
(declare-fun FullPerm () Real)
(declare-fun |range___create__#frame| (T@U) T@U)
...
(assert (forall ((Heap T@U) (Mask T@U) (self T@U) (item Int) ) (!  (=> (and (and (and (= (type Heap) (MapType0Type RefType)) (= (type Mask) (MapType1Type RefType realType))) (= (type self) RefType)) (state Heap Mask)) (= (|range___contains__'| Heap self item) (|range___contains__#frame| EmptyFrame self item)))
 :qid |stdinbpl.263:15|
 :skolemid |30|
...
(assert (forall ((Heap@@1 T@U) (self@@0 T@U) (item@@0 Int) ) (!  (=> (and (= (type Heap@@1) (MapType0Type RefType)) (= (type self@@0) RefType)) (dummyFunction (bool_2_U (|range___contains__#triggerStateless| self@@0 item@@0))))
 :qid |stdinbpl.256:15|
 :skolemid |29|
...
(assert (forall ((arg0@@25 T@U) ) (! (= (type (|range___create__'| arg0@@25)) RefType)
 :qid |funType:range___create__'|
 :pattern ( (|range___create__'| arg0@@25))
)))
(assert (forall ((Heap@@5 T@U) (Mask@@4 T@U) ) (!  (=> (and (and (= (type Heap@@5) (MapType0Type RefType)) (= (type Mask@@4) (MapType1Type RefType realType))) (and (state Heap@@5 Mask@@4) (or (< AssumeFunctionsAbove 0) (|range___create__#trigger| EmptyFrame)))) (forall ((i Int) ) (! (range___contains__ Heap@@5 (|range___create__'| Heap@@5) i)
 :qid |stdinbpl.205:103|
 :skolemid |25|
 :pattern ( (|range___contains__#frame| EmptyFrame (|range___create__'| Heap@@5) i))
)))
 :qid |stdinbpl.203:15|
 :skolemid |26|
 :pattern ( (state Heap@@5 Mask@@4) (|range___create__'| Heap@@5))
)))
...
(assert (forall ((arg0@@26 Real) (arg1@@9 T@U) ) (! (= (type (ConditionalFrame arg0@@26 arg1@@9)) FrameTypeType)
...
(assert  (and (forall ((arg0@@27 T@U) ) (! (= (type (range___create__ arg0@@27)) RefType)
 :qid |funType:range___create__|
 :pattern ( (range___create__ arg0@@27))
)) (= (type |range___create__#triggerStateless|) RefType)))
(assert (forall ((Heap@@8 T@U) ) (!  (=> (= (type Heap@@8) (MapType0Type RefType)) (and (= (range___create__ Heap@@8) (|range___create__'| Heap@@8)) (dummyFunction |range___create__#triggerStateless|)))
 :qid |stdinbpl.186:15|
 :skolemid |22|
 :pattern ( (range___create__ Heap@@8))
)))
...
(assert (forall ((Heap@@11 T@U) ) (!  (=> (= (type Heap@@11) (MapType0Type RefType)) (dummyFunction |range___create__#triggerStateless|))
 :qid |stdinbpl.190:15|
 :skolemid |23|
 :pattern ( (|range___create__'| Heap@@11))
)))
...
(assert (forall ((arg0@@28 T@U) ) (! (= (type (|range___create__#frame| arg0@@28)) RefType)
 :qid |funType:range___create__#frame|
 :pattern ( (|range___create__#frame| arg0@@28))
)))
(assert (forall ((Heap@@13 T@U) (Mask@@11 T@U) ) (!  (=> (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (state Heap@@13 Mask@@11)) (= (|range___create__'| Heap@@13) (|range___create__#frame| EmptyFrame)))
 :qid |stdinbpl.197:15|
 :skolemid |24|
 :pattern ( (state Heap@@13 Mask@@11) (|range___create__'| Heap@@13))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@15 T@U) (self@@1 T@U) (item@@1 Int) ) (!  (=> (and (= (type Heap@@15) (MapType0Type RefType)) (= (type self@@1) RefType)) (and (= (range___contains__ Heap@@15 self@@1 item@@1) (|range___contains__'| Heap@@15 self@@1 item@@1)) (dummyFunction (bool_2_U (|range___contains__#triggerStateless| self@@1 item@@1)))))
 :qid |stdinbpl.252:15|
 :skolemid |28|
 :pattern ( (range___contains__ Heap@@15 self@@1 item@@1))
)))
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(set-info :boogie-vc-id |range___contains__#definedness|)
