...
(let ((anon6_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 (|Seq#Length| xs)))) (= (ControlFlow 0 8) 4)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (<= 0 i_2) (< i_2 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< i_2 (|Seq#Length| xs))) (=> (< i_2 (|Seq#Length| xs)) (=> (= (ControlFlow 0 5) 4) anon3_correct))))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (|Seq#Length| xs)))) (and (<= 0 i_1_1) (< i_1_1 (|Seq#Length| xs)))) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index| xs i_1) (|Seq#Index| xs i_1_1))))
 :qid |stdinbpl.988:15|
 :skolemid |130|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= 0 i_1@@0) (< i_1@@0 (|Seq#Length| xs)))) (and (<= 0 i_1_1@@0) (< i_1_1@@0 (|Seq#Length| xs)))) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index| xs i_1@@0) (|Seq#Index| xs i_1_1@@0))))
 :qid |stdinbpl.988:15|
 :skolemid |130|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 (|Seq#Length| xs))) (< NoPerm p_1)) (and (qpRange3 (|Seq#Index| xs i_1@@1)) (= (invRecv3 (|Seq#Index| xs i_1@@1)) i_1@@1)))
 :qid |stdinbpl.994:22|
 :skolemid |131|
 :pattern ( (|Seq#Index| xs i_1@@1))
 :pattern ( (|Seq#Index| xs i_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv3 o_3)) (< (invRecv3 o_3) (|Seq#Length| xs))) (< NoPerm p_1)) (qpRange3 o_3)) (= (|Seq#Index| xs (invRecv3 o_3)) o_3)))
 :qid |stdinbpl.998:22|
 :skolemid |132|
 :pattern ( (invRecv3 o_3))
)) (= (ControlFlow 0 2) (- 0 1))) (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (< i_1@@2 (|Seq#Length| xs))) (>= p_1 NoPerm))
 :qid |stdinbpl.1004:15|
 :skolemid |133|
 :pattern ( (|Seq#Index| xs i_1@@2))
 :pattern ( (|Seq#Index| xs i_1@@2))
))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (< NoPerm p_1) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 9) 2) anon5_Else_correct) (=> (= (ControlFlow 0 9) 5) anon6_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct))))))
