...
(assert  (and (and (and (and (and (and (= (type Heap@@23) (MapType0Type RefType)) (= (type x@@35) RefType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |P01#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon4_correct true))
(let ((anon6_Else_correct  (=> (= (MapType0Select Heap@@23 x@@35 r_1) null) (=> (and (= Mask@4 Mask@2) (= (ControlFlow 0 4) 1)) anon4_correct))))
(let ((anon6_Then_correct  (=> (not (= (MapType0Select Heap@@23 x@@35 r_1) null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@2 x@@35 r_1)) (=> (HasDirectPerm Mask@2 x@@35 r_1) (=> (and (and (= Mask@3 (MapType1Store Mask@2 null (P01 (MapType0Select Heap@@23 x@@35 r_1) b_2@@9) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (P01 (MapType0Select Heap@@23 x@@35 r_1) b_2@@9))) FullPerm)))) (state Heap@@23 Mask@3)) (and (= Mask@4 Mask@3) (= (ControlFlow 0 2) 1))) anon4_correct))))))
(let ((anon2_correct  (=> (not (= x@@35 null)) (=> (and (= Mask@2 (MapType1Store Mask@1 x@@35 r_1 (real_2_U (+ (U_2_real (MapType1Select Mask@1 x@@35 r_1)) FullPerm)))) (state Heap@@23 Mask@2)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@2 x@@35 r_1)) (=> (HasDirectPerm Mask@2 x@@35 r_1) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))))))
(let ((anon5_Else_correct  (=> (not b_2@@9) (=> (and (= Mask@1 ZeroMask) (= (ControlFlow 0 8) 5)) anon2_correct))))
(let ((anon5_Then_correct  (=> (and b_2@@9 (not (= x@@35 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask x@@35 v_2 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@35 v_2)) FullPerm)))) (state Heap@@23 Mask@0)) (and (= Mask@1 Mask@0) (= (ControlFlow 0 7) 5))) anon2_correct))))
(let ((anon0_correct  (=> (state Heap@@23 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@23 x@@35 $allocated))) (and (=> (= (ControlFlow 0 9) 7) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct))))))
