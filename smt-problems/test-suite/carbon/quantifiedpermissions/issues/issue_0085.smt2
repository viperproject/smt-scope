...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type f_7) (FieldType NormalFieldType intType))) (forall ((arg0@@14 T@T) (arg1@@2 T@T) ) (! (= (Ctor (MapType0Type arg0@@14 arg1@@2)) 8)
...
(= (type (MapType0Store arg0@@18 arg1@@6 arg2)) (MapType0Type aVar0 aVar1@@0))))
 ...
 :weight 0
)))) (= (Ctor RefType) 9)) (= (type n) (FieldType NormalFieldType (MapType0Type RefType boolType)))))
(assert (distinct $allocated f_7 n)
)
...
(assert (forall ((Heap@@2 T@U) (this@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType1Type RefType)) (= (type this@@0) RefType)) (|inv#everUsed| (inv this@@0)))
 :qid |stdinbpl.428:15|
 :skolemid |87|
 :pattern ( (|inv#trigger| Heap@@2 (inv this@@0)))
)))
...
(assert (forall ((arg0@@39 T@U) ) (! (= (type (|inv#sm| arg0@@39)) (FieldType PredicateType_invType (MapType2Type RefType boolType)))
 :qid |funType:inv#sm|
 :pattern ( (|inv#sm| arg0@@39))
)))
...
(assert (forall ((arg0@@41 Int) (arg1@@20 Int) ) (! (= (type (|sk_inv#condqp1| arg0@@41 arg1@@20)) RefType)
 :qid |funType:sk_inv#condqp1|
 :pattern ( (|sk_inv#condqp1| arg0@@41 arg1@@20))
)))
(assert (forall ((Heap2Heap T@U) (Heap1Heap T@U) (this@@3 T@U) ) (!  (=> (and (and (and (= (type Heap2Heap) (MapType1Type RefType)) (= (type Heap1Heap) (MapType1Type RefType))) (= (type this@@3) RefType)) (and (=  (and (U_2_bool (MapType0Select (MapType1Select Heap2Heap this@@3 n) (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap this@@3) (|inv#condqp1| Heap1Heap this@@3)))) (< NoPerm FullPerm))  (and (U_2_bool (MapType0Select (MapType1Select Heap1Heap this@@3 n) (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap this@@3) (|inv#condqp1| Heap1Heap this@@3)))) (< NoPerm FullPerm))) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap2Heap this@@3 n) (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap this@@3) (|inv#condqp1| Heap1Heap this@@3)))) (< NoPerm FullPerm)) (= (U_2_int (MapType1Select Heap2Heap (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap this@@3) (|inv#condqp1| Heap1Heap this@@3)) f_7)) (U_2_int (MapType1Select Heap1Heap (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap this@@3) (|inv#condqp1| Heap1Heap this@@3)) f_7)))))) (= (|inv#condqp1| Heap2Heap this@@3) (|inv#condqp1| Heap1Heap this@@3)))
 :qid |stdinbpl.439:15|
 :skolemid |88|
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@5) (MapType1Type RefType)) (= (type Heap@4) (MapType1Type RefType))) (= (type this@@6) RefType)) (= (type newPMask@0) (MapType2Type RefType boolType))) (= (type Heap@6) (MapType1Type RefType))) (= (type Mask@4) (MapType2Type RefType realType))) (= (type Heap@2) (MapType1Type RefType))) (= (type Heap@1) (MapType1Type RefType))) (= (type Heap@3) (MapType1Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@3) (MapType2Type RefType realType))) (= (type QPMask@0) (MapType2Type RefType realType))) (= (type QPMask@1) (MapType2Type RefType realType))) (forall ((arg0@@46 T@U) ) (! (= (type (invRecv3 arg0@@46)) RefType)
 :qid |funType:invRecv3|
 :pattern ( (invRecv3 arg0@@46))
))) (forall ((arg0@@47 T@U) (arg1@@24 T@U) ) (! (= (type (CombineFrames arg0@@47 arg1@@24)) FrameTypeType)
 :qid |funType:CombineFrames|
 :pattern ( (CombineFrames arg0@@47 arg1@@24))
))) (forall ((arg0@@48 T@U) ) (! (= (type (FrameFragment arg0@@48)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@48))
))) (= (type Mask@2) (MapType2Type RefType realType))) (= (type Mask@1) (MapType2Type RefType realType))) (forall ((arg0@@49 T@U) ) (! (= (type (invRecv2 arg0@@49)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@49))
))) (= (type Heap@0) (MapType1Type RefType))) (= (type Heap@@10) (MapType1Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@0) (MapType2Type RefType realType))))
(set-info :boogie-vc-id m2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon8_correct  (=> (= Heap@5 (MapType1Store Heap@4 null (|inv#sm| this@@6) (MapType2Store (MapType1Select Heap@4 null (|inv#sm| this@@6)) this@@6 n (bool_2_U true)))) (=> (and (forall ((o_4 T@U) (f_8 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_8))))
(let ((A@@12 (FieldTypeInv0 (type f_8))))
 (=> (and (and (= (type o_4) RefType) (= (type f_8) (FieldType A@@12 B@@11))) (U_2_bool (MapType2Select (MapType1Select Heap@5 null (|inv#sm| this@@6)) o_4 f_8))) (U_2_bool (MapType2Select newPMask@0 o_4 f_8)))))
 :qid |stdinbpl.662:27|
 :skolemid |107|
 :pattern ( (MapType2Select newPMask@0 o_4 f_8))
)) (forall ((x_2 T@U) ) (!  (=> (and (= (type x_2) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@5 this@@6 n) x_2))) (U_2_bool (MapType2Select newPMask@0 x_2 f_7)))
 :qid |stdinbpl.666:20|
 :skolemid |108|
 :no-pattern (type x_2)
 :no-pattern (U_2_int x_2)
 :no-pattern (U_2_bool x_2)
))) (=> (and (and (= Heap@6 (MapType1Store Heap@5 null (|inv#sm| this@@6) newPMask@0)) (state Heap@6 Mask@4)) (and (state Heap@6 Mask@4) (= (ControlFlow 0 2) (- 0 1)))) (= FullPerm (U_2_real (MapType2Select Mask@4 this@@6 n))))))))
(let ((anon12_Else_correct  (=> (HasDirectPerm Mask@4 null (inv this@@6)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 4) 2)) anon8_correct))))
(let ((anon12_Then_correct  (=> (not (HasDirectPerm Mask@4 null (inv this@@6))) (=> (and (and (= Heap@2 (MapType1Store Heap@1 null (|inv#sm| this@@6) ZeroPMask)) (= Heap@3 (MapType1Store Heap@2 null (inv this@@6) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 3) 2))) anon8_correct))))
(let ((anon6_correct  (=> (= Mask@3 (MapType2Store QPMask@0 this@@6 n (real_2_U (- (U_2_real (MapType2Select QPMask@0 this@@6 n)) FullPerm)))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) x_1))) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.614:17|
 :skolemid |101|
...
)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((x_1@@1 T@U) ) (!  (=> (and (= (type x_1@@1) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) x_1@@1))) (>= (U_2_real (MapType2Select Mask@3 x_1@@1 f_7)) FullPerm))
 :qid |stdinbpl.621:17|
 :skolemid |102|
...
)) (=> (forall ((x_1@@3 T@U) ) (!  (=> (= (type x_1@@3) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) x_1@@3)) (< NoPerm FullPerm)) (and (qpRange3 x_1@@3) (= (invRecv3 x_1@@3) x_1@@3))))
 :qid |stdinbpl.627:22|
 :skolemid |103|
...
)) (=> (and (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) (invRecv3 o_3))) (and (< NoPerm FullPerm) (qpRange3 o_3))) (= (invRecv3 o_3) o_3)))
 :qid |stdinbpl.631:22|
 :skolemid |104|
 :pattern ( (invRecv3 o_3))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) (invRecv3 o_3@@0))) (and (< NoPerm FullPerm) (qpRange3 o_3@@0))) (and (= (invRecv3 o_3@@0) o_3@@0) (= (U_2_real (MapType2Select QPMask@1 o_3@@0 f_7)) (- (U_2_real (MapType2Select Mask@3 o_3@@0 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) (invRecv3 o_3@@0))) (and (< NoPerm FullPerm) (qpRange3 o_3@@0)))) (= (U_2_real (MapType2Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType2Select Mask@3 o_3@@0 f_7))))))
 :qid |stdinbpl.637:22|
 :skolemid |105|
...
(let ((A@@13 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@13 B@@12))) (not (= f_5 f_7))) (= (U_2_real (MapType2Select Mask@3 o_3@@1 f_5)) (U_2_real (MapType2Select QPMask@1 o_3@@1 f_5))))))
 :qid |stdinbpl.643:29|
 :skolemid |106|
 :pattern ( (MapType2Select QPMask@1 o_3@@1 f_5))
)) (= Mask@4 (MapType2Store QPMask@1 null (inv this@@6) (real_2_U (+ (U_2_real (MapType2Select QPMask@1 null (inv this@@6))) FullPerm)))))) (and (and (state Heap@1 Mask@4) (state Heap@1 Mask@4)) (and (|inv#trigger| Heap@1 (inv this@@6)) (= (MapType1Select Heap@1 null (inv this@@6)) (CombineFrames (FrameFragment (MapType1Select Heap@1 this@@6 n)) (FrameFragment (int_2_U (|inv#condqp1| Heap@1 this@@6)))))))) (and (=> (= (ControlFlow 0 5) 3) anon12_Then_correct) (=> (= (ControlFlow 0 5) 4) anon12_Else_correct)))))))))))
(let ((anon11_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 5)) anon6_correct)))
(let ((anon11_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType2Select QPMask@0 this@@6 n)))) (=> (<= FullPerm (U_2_real (MapType2Select QPMask@0 this@@6 n))) (=> (= (ControlFlow 0 8) 5) anon6_correct))))))
(let ((anon4_correct  (=> (not (= this@@6 null)) (=> (and (= Mask@2 (MapType2Store Mask@1 this@@6 n (real_2_U (+ (U_2_real (MapType2Select Mask@1 this@@6 n)) FullPerm)))) (state Heap@1 Mask@2)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((x@@19 T@U) (x_3 T@U) ) (!  (=> (and (= (type x@@19) RefType) (= (type x_3) RefType)) (=> (and (and (and (and (not (= x@@19 x_3)) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) x@@19))) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) x_3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@19 x_3))))
 :qid |stdinbpl.563:15|
 :skolemid |95|
...
))) (=> (forall ((x@@20 T@U) (x_3@@0 T@U) ) (!  (=> (and (= (type x@@20) RefType) (= (type x_3@@0) RefType)) (=> (and (and (and (and (not (= x@@20 x_3@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) x@@20))) (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) x_3@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@20 x_3@@0))))
 :qid |stdinbpl.563:15|
 :skolemid |95|
...
)) (=> (and (and (and (forall ((x@@21 T@U) ) (!  (=> (= (type x@@21) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) x@@21)) (< NoPerm FullPerm)) (and (qpRange2 x@@21) (= (invRecv2 x@@21) x@@21))))
 :qid |stdinbpl.569:22|
 :skolemid |96|
...
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) (invRecv2 o_3@@2))) (< NoPerm FullPerm)) (qpRange2 o_3@@2)) (= (invRecv2 o_3@@2) o_3@@2)))
 :qid |stdinbpl.573:22|
 :skolemid |97|
...
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) (invRecv2 o_3@@3))) (< NoPerm FullPerm)) (qpRange2 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@3) o_3@@3)) (= (U_2_real (MapType2Select QPMask@0 o_3@@3 f_7)) (+ (U_2_real (MapType2Select Mask@2 o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType0Select (MapType1Select Heap@1 this@@6 n) (invRecv2 o_3@@3))) (< NoPerm FullPerm)) (qpRange2 o_3@@3))) (= (U_2_real (MapType2Select QPMask@0 o_3@@3 f_7)) (U_2_real (MapType2Select Mask@2 o_3@@3 f_7))))))
 :qid |stdinbpl.585:22|
 :skolemid |99|
...
(let ((A@@14 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@14 B@@13))) (not (= f_5@@0 f_7))) (= (U_2_real (MapType2Select Mask@2 o_3@@4 f_5@@0)) (U_2_real (MapType2Select QPMask@0 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.589:29|
 :skolemid |100|
 :pattern ( (MapType2Select Mask@2 o_3@@4 f_5@@0))
...
(let ((anon10_Else_correct  (=> (HasDirectPerm Mask@1 null (inv this@@6)) (=> (and (= Heap@1 Heap@@10) (= (ControlFlow 0 14) 11)) anon4_correct))))
(let ((anon10_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (inv this@@6))) (= Heap@0 (MapType1Store Heap@@10 null (inv this@@6) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 13) 11))) anon4_correct)))
(let ((anon2_correct  (=> (= Mask@1 (MapType2Store Mask@0 null (inv this@@6) (real_2_U (- (U_2_real (MapType2Select Mask@0 null (inv this@@6))) FullPerm)))) (and (=> (= (ControlFlow 0 15) 13) anon10_Then_correct) (=> (= (ControlFlow 0 15) 14) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 18) 15)) anon2_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= FullPerm (U_2_real (MapType2Select Mask@0 null (inv this@@6))))) (=> (<= FullPerm (U_2_real (MapType2Select Mask@0 null (inv this@@6)))) (=> (= (ControlFlow 0 16) 15) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType1Select Heap@@10 this@@6 $allocated)) (= Mask@0 (MapType2Store ZeroMask null (inv this@@6) (real_2_U (+ (U_2_real (MapType2Select ZeroMask null (inv this@@6))) FullPerm))))) (=> (and (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (|inv#trigger| Heap@@10 (inv this@@6)) (= (MapType1Select Heap@@10 null (inv this@@6)) (CombineFrames (FrameFragment (MapType1Select Heap@@10 this@@6 n)) (FrameFragment (int_2_U (|inv#condqp1| Heap@@10 this@@6))))))) (and (=> (= (ControlFlow 0 19) 16) anon9_Then_correct) (=> (= (ControlFlow 0 19) 18) anon9_Else_correct)))))))
