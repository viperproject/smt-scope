...
(declare-fun i_6 () Int)
(declare-fun j_4 () Int)
(assert  (and (and (and (= (type xs) (SeqType RefType)) (= (type ys) (SeqType intType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 36) (let ((anon13_correct true))
(let ((anon21_Else_correct  (=> (and (not (and (<= 0 i_8) (< i_8 (|Seq#Length| xs)))) (= (ControlFlow 0 30) 23)) anon13_correct)))
(let ((anon21_Then_correct  (=> (and (<= 0 i_8) (< i_8 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 24) (- 0 29)) (>= i_8 0)) (=> (>= i_8 0) (and (=> (= (ControlFlow 0 24) (- 0 28)) (< i_8 (|Seq#Length| ys))) (=> (< i_8 (|Seq#Length| ys)) (=> (= j_5@0 (U_2_int (|Seq#Index| ys i_8))) (and (=> (= (ControlFlow 0 24) (- 0 27)) (>= i_8 0)) (=> (>= i_8 0) (and (=> (= (ControlFlow 0 24) (- 0 26)) (< i_8 (|Seq#Length| xs))) (=> (< i_8 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (HasDirectPerm QPMask@0 (|Seq#Index| xs i_8) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs i_8) f_7) (=> (= (ControlFlow 0 24) 23) anon13_correct)))))))))))))))
(let ((anon20_Else_correct  (=> (forall ((i_5 Int) ) (!  (=> (and (<= 0 i_5) (< i_5 (|Seq#Length| xs))) (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs i_5) f_7)) (U_2_int (|Seq#Index| ys i_5))))
 :qid |stdinbpl.858:20|
 :skolemid |75|
 :pattern ( (|Seq#Index| ys i_5))
 :pattern ( (|Seq#Index| xs i_5))
)) (=> (and (and (state Heap@@9 QPMask@0) (> (|Seq#Length| xs) 3)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 18) (- 0 22)) (< 2 (|Seq#Length| xs))) (=> (< 2 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 18) (- 0 21)) (HasDirectPerm QPMask@0 (|Seq#Index| xs 2) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| xs 2) f_7) (and (=> (= (ControlFlow 0 18) (- 0 20)) (< 2 (|Seq#Length| ys))) (=> (< 2 (|Seq#Length| ys)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs 2) f_7)) (U_2_int (|Seq#Index| ys 2)))) (=> (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| xs 2) f_7)) (U_2_int (|Seq#Index| ys 2))) (=> (and (state Heap@@9 QPMask@0) (= (ControlFlow 0 18) (- 0 17))) false)))))))))))))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 33)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 (|Seq#Length| xs)))) (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length| xs)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index| xs i_3) (|Seq#Index| xs i_3_1))))
 :qid |stdinbpl.802:15|
 :skolemid |68|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (and (<= 0 i_3@@0) (< i_3@@0 (|Seq#Length| xs)))) (and (<= 0 i_3_1@@0) (< i_3_1@@0 (|Seq#Length| xs)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index| xs i_3@@0) (|Seq#Index| xs i_3_1@@0))))
 :qid |stdinbpl.802:15|
 :skolemid |68|
)) (=> (and (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 (|Seq#Length| xs))) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange2 (|Seq#Index| xs i_3@@1)) (= (invRecv2 (|Seq#Index| xs i_3@@1)) i_3@@1)))
 :qid |stdinbpl.808:22|
 :skolemid |69|
 :pattern ( (|Seq#Index| xs i_3@@1))
 :pattern ( (|Seq#Index| ys i_3@@1))
 :pattern ( (|Seq#Index| xs i_3@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv2 o_3)) (< (invRecv2 o_3) (|Seq#Length| xs))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_3)) (= (|Seq#Index| xs (invRecv2 o_3)) o_3)))
 :qid |stdinbpl.812:22|
 :skolemid |70|
 :pattern ( (invRecv2 o_3))
))) (and (=> (= (ControlFlow 0 31) (- 0 32)) (forall ((i_3@@2 Int) ) (!  (=> (and (<= 0 i_3@@2) (< i_3@@2 (|Seq#Length| xs))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.818:15|
 :skolemid |71|
 :pattern ( (|Seq#Index| xs i_3@@2))
 :pattern ( (|Seq#Index| ys i_3@@2))
 :pattern ( (|Seq#Index| xs i_3@@2))
))) (=> (forall ((i_3@@3 Int) ) (!  (=> (and (<= 0 i_3@@3) (< i_3@@3 (|Seq#Length| xs))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.818:15|
 :skolemid |71|
 :pattern ( (|Seq#Index| xs i_3@@3))
 :pattern ( (|Seq#Index| ys i_3@@3))
 :pattern ( (|Seq#Index| xs i_3@@3))
)) (=> (and (and (forall ((i_3@@4 Int) ) (!  (=> (and (and (<= 0 i_3@@4) (< i_3@@4 (|Seq#Length| xs))) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= (|Seq#Index| xs i_3@@4) null)))
 :qid |stdinbpl.824:22|
 :skolemid |72|
 :pattern ( (|Seq#Index| xs i_3@@4))
 :pattern ( (|Seq#Index| ys i_3@@4))
 :pattern ( (|Seq#Index| xs i_3@@4))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv2 o_3@@0)) (< (invRecv2 o_3@@0) (|Seq#Length| xs))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_3@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index| xs (invRecv2 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (and (<= 0 (invRecv2 o_3@@0)) (< (invRecv2 o_3@@0) (|Seq#Length| xs))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.830:22|
 :skolemid |73|
...
)) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 31) 18) anon20_Else_correct) (=> (= (ControlFlow 0 31) 24) anon21_Then_correct)) (=> (= (ControlFlow 0 31) 30) anon21_Else_correct))))))))))
(let ((anon9_correct true))
(let ((anon19_Else_correct  (=> (and (not (and (<= 0 i_7) (< i_7 (|Seq#Length| xs)))) (= (ControlFlow 0 12) 8)) anon9_correct)))
(let ((anon19_Then_correct  (=> (and (<= 0 i_7) (< i_7 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_7 0)) (=> (>= i_7 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_7 (|Seq#Length| xs))) (=> (< i_7 (|Seq#Length| xs)) (=> (= (ControlFlow 0 9) 8) anon9_correct))))))))
(let ((anon18_Else_correct  (=> (not (and (<= 0 i_7) (< i_7 (|Seq#Length| xs)))) (and (=> (= (ControlFlow 0 16) 9) anon19_Then_correct) (=> (= (ControlFlow 0 16) 12) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (and (<= 0 i_7) (< i_7 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 13) (- 0 15)) (>= i_7 0)) (=> (>= i_7 0) (and (=> (= (ControlFlow 0 13) (- 0 14)) (< i_7 (|Seq#Length| ys))) (=> (< i_7 (|Seq#Length| ys)) (=> (= j_2@0 (U_2_int (|Seq#Index| ys i_7))) (and (=> (= (ControlFlow 0 13) 9) anon19_Then_correct) (=> (= (ControlFlow 0 13) 12) anon19_Else_correct))))))))))
(let ((anon15_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (<= 0 i_1) (and (< i_1 (|Seq#Length| xs)) (and (<= 0 j_1) (< j_1 (|Seq#Length| xs))))) (=> (= (|Seq#Index| xs i_1) (|Seq#Index| xs j_1)) (= i_1 j_1)))
 :qid |stdinbpl.777:20|
 :skolemid |67|
 :pattern ( (|Seq#Index| xs i_1) (|Seq#Index| xs j_1))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 34) 31) anon17_Else_correct) (=> (= (ControlFlow 0 34) 13) anon18_Then_correct)) (=> (= (ControlFlow 0 34) 16) anon18_Else_correct)))))
(let ((anon3_correct true))
(let ((anon16_Else_correct  (=> (and (not (and (<= 0 i_6) (and (< i_6 (|Seq#Length| xs)) (and (<= 0 j_4) (< j_4 (|Seq#Length| xs)))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon16_Then_correct  (=> (and (<= 0 i_6) (and (< i_6 (|Seq#Length| xs)) (and (<= 0 j_4) (< j_4 (|Seq#Length| xs))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_6 0)) (=> (>= i_6 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_6 (|Seq#Length| xs))) (=> (< i_6 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_4 0)) (=> (>= j_4 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_4 (|Seq#Length| xs))) (=> (< j_4 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= (|Seq#Length| xs) (|Seq#Length| ys)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 35) 34) anon15_Else_correct) (=> (= (ControlFlow 0 35) 2) anon16_Then_correct)) (=> (= (ControlFlow 0 35) 7) anon16_Else_correct))))))
