...
(set-info :boogie-vc-id |inhaleExpression3#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (=> (and (and (not (= this@@54 null)) (= Mask@0 (MapType1Store ZeroMask this@@54 x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@54 x@@8)) FullPerm))))) (and (state Heap@@64 Mask@0) (state Heap@@64 Mask@0))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm Mask@0 this@@54 x@@8)) (=> (HasDirectPerm Mask@0 this@@54 x@@8) (=> (and (= (U_2_int (MapType0Select Heap@@64 this@@54 x@@8)) 1) (state Heap@@64 Mask@0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm Mask@0 this@@54 x@@8)) (=> (HasDirectPerm Mask@0 this@@54 x@@8) (=> (and (= Result@0 (U_2_int (MapType0Select Heap@@64 this@@54 x@@8))) (= (ControlFlow 0 3) (- 0 2))) (= Result@0 1))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@64 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@64 this@@54 $allocated)) (= AssumeFunctionsAbove 4)) (and (=> (= (ControlFlow 0 6) 1) anon3_Then_correct) (=> (= (ControlFlow 0 6) 3) anon3_Else_correct))))))
...
(declare-fun Heap@@64 () T@U)
(declare-fun this@@54 () T@U)
(assert  (and (= (type Heap@@64) (MapType0Type RefType)) (= (type this@@54) RefType)))
(set-info :boogie-vc-id inhaleExpression1Method)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (= (inhaleExpression1 Heap@@64 this@@54) 1))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@64 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@64 this@@54 $allocated))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
