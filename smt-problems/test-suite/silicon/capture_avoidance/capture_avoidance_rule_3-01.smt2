...
; Joined path conditions
(assert (or b@0@00 (not b@0@00)))
(pop) ; 2
; Nested auxiliary terms: globals (aux)
(assert (or b@0@00 (not b@0@00)))
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((w@12@00 Int)) (!
  (and b@0@00 (= z@1@00 0))
...
(assert (forall ((y@13@00 $Ref)) (!
  (and (= (inv@14@00 s@$ x@3@00 y@13@00) y@13@00) (img@15@00 s@$ x@3@00 y@13@00))
  :pattern ((inv@14@00 s@$ x@3@00 y@13@00))
  :pattern ((img@15@00 s@$ x@3@00 y@13@00))
  :qid |quant-u-11|)))
(assert (forall ((r $Ref)) (!
  (=> (img@15@00 s@$ x@3@00 r) (= (inv@14@00 s@$ x@3@00 r) r))
  :pattern ((inv@14@00 s@$ x@3@00 r))
  :qid |f-fctOfInv|)))
; Permissions are non-negative
; Field permissions are at most one
; Permission implies non-null receiver
(assert (forall ((y@13@00 $Ref)) (!
  (not (= y@13@00 $Ref.null))
  :pattern ((inv@14@00 s@$ x@3@00 y@13@00))
  :pattern ((img@15@00 s@$ x@3@00 y@13@00))
...
(assert (forall ((s@$ $Snap) (b@5@00 Bool)) (!
  ...
  :qid |quant-u-5|)))
; ---------- FUNCTION function0----------
(declare-fun b@7@00 () Bool)
(declare-fun c@8@00 () Bool)
...
; [eval] b && c
(push) ; 3
; [then-branch: 2 | !(b@7@00) | live]
; [else-branch: 2 | b@7@00 | live]
(push) ; 4
; [then-branch: 2 | !(b@7@00)]
(assert (not b@7@00))
(pop) ; 4
(push) ; 4
; [else-branch: 2 | b@7@00]
(assert b@7@00)
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(assert (or b@7@00 (not b@7@00)))
(pop) ; 2
; Nested auxiliary terms: globals (aux)
(assert (or b@7@00 (not b@7@00)))
; Nested auxiliary terms: non-globals (aux)
...
(assert (= s@$ $Snap.unit))
; [eval] (forall w: Int ::b)
(declare-const w@18@00 Int)
(push) ; 2
(pop) ; 2
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((w@18@00 Int)) (!
  b@10@00
