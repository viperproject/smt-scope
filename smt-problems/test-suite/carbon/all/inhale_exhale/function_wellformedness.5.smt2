...
(let ((anon0_correct  (=> (state Heap@@121 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@121 this@@111 $allocated)) (= AssumeFunctionsAbove 23)) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
...
(declare-fun Heap@@121 () T@U)
(assert  (and (= (type this@@111) RefType) (= (type Heap@@121) (MapType0Type RefType))))
(set-info :boogie-vc-id |e1Abstract#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (and (not (= this@@111 null)) (= (ControlFlow 0 3) (- 0 2))) (HasDirectPerm ZeroMask this@@111 x@@8))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@121 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@121 this@@111 $allocated)) (= AssumeFunctionsAbove 14)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 5) 4) anon0_correct)))
PreconditionGeneratedEntry_correct)))))
))
(check-sat)
...
(set-info :boogie-vc-id |t4Abstract#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon6_Else_correct  (=> (and (not (= this@@111 null)) (= (ControlFlow 0 5) (- 0 4))) (HasDirectPerm ZeroMask this@@111 x@@8))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (state Heap@@121 ZeroMask) (and (=> (= (ControlFlow 0 6) 3) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))
(let ((anon5_Then_correct  (=> (and (and (not (= this@@111 null)) (= Mask@0 (MapType1Store ZeroMask this@@111 x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@111 x@@8)) FullPerm))))) (and (state Heap@@121 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@0 this@@111 x@@8))))
(let ((anon0_correct  (=> (state Heap@@121 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@121 this@@111 $allocated)) (= AssumeFunctionsAbove 18)) (and (=> (= (ControlFlow 0 7) 2) anon5_Then_correct) (=> (= (ControlFlow 0 7) 6) anon5_Else_correct))))))
