...
(declare-fun i@@6 () Int)
(declare-fun j@@5 () Int)
(assert  (and (and (= (type ar) (SeqType RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id test1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 58) (let ((anon35_correct true))
(let ((anon54_Else_correct  (=> (and (not (and (<= 0 i_13) (< i_13 (- len 1)))) (= (ControlFlow 0 49) 46)) anon35_correct)))
(let ((anon54_Then_correct  (=> (and (<= 0 i_13) (< i_13 (- len 1))) (and (=> (= (ControlFlow 0 47) (- 0 48)) (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| ar (+ i_13 1)) Integer_value)) 0)) (=> (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| ar (+ i_13 1)) Integer_value)) 0) (=> (= (ControlFlow 0 47) 46) anon35_correct))))))
(let ((anon31_correct true))
(let ((anon52_Else_correct  (=> (and (not (and (<= 0 i_9) (< i_9 (- len 1)))) (= (ControlFlow 0 45) 40)) anon31_correct)))
(let ((anon52_Then_correct  (=> (and (<= 0 i_9) (< i_9 (- len 1))) (and (=> (= (ControlFlow 0 41) (- 0 44)) (>= (+ i_9 1) 0)) (=> (>= (+ i_9 1) 0) (and (=> (= (ControlFlow 0 41) (- 0 43)) (< (+ i_9 1) (|Seq#Length| ar))) (=> (< (+ i_9 1) (|Seq#Length| ar)) (and (=> (= (ControlFlow 0 41) (- 0 42)) (HasDirectPerm QPMask@0 (|Seq#Index| ar (+ i_9 1)) Integer_value)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| ar (+ i_9 1)) Integer_value) (=> (= (ControlFlow 0 41) 40) anon31_correct))))))))))
(let ((anon53_Else_correct true))
(let ((anon49_Else_correct  (=> (and (forall ((i_11_1 T@U) (fresh__1_2_1 Int) ) (!  (=> (and (= (type i_11_1) intType) (|Seq#Contains| (|Seq#Range| 0 (- len 1)) i_11_1)) (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| ar (+ (U_2_int i_11_1) 1)) Integer_value)) 0))
 :qid |stdinbpl.746:20|
 :skolemid |68|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 fresh__1_2_1) i_11_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 fresh__1_2_1) i_11_1))
)) (state Heap@@9 QPMask@0)) (and (and (and (and (=> (= (ControlFlow 0 50) 39) anon53_Else_correct) (=> (= (ControlFlow 0 50) 47) anon54_Then_correct)) (=> (= (ControlFlow 0 50) 49) anon54_Else_correct)) (=> (= (ControlFlow 0 50) 41) anon52_Then_correct)) (=> (= (ControlFlow 0 50) 45) anon52_Else_correct)))))
(let ((anon27_correct true))
(let ((anon50_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (- len 1)) (int_2_U i_10))) (= (ControlFlow 0 38) 35)) anon27_correct)))
(let ((anon50_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (- len 1)) (int_2_U i_10)) (and (=> (= (ControlFlow 0 36) (- 0 37)) (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| ar (+ i_10 1)) Integer_value)) 0)) (=> (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| ar (+ i_10 1)) Integer_value)) 0) (=> (= (ControlFlow 0 36) 35) anon27_correct))))))
(let ((anon23_correct true))
(let ((anon48_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (- len 1)) (int_2_U i_8))) (= (ControlFlow 0 34) 29)) anon23_correct)))
(let ((anon48_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (- len 1)) (int_2_U i_8)) (and (=> (= (ControlFlow 0 30) (- 0 33)) (>= (+ i_8 1) 0)) (=> (>= (+ i_8 1) 0) (and (=> (= (ControlFlow 0 30) (- 0 32)) (< (+ i_8 1) (|Seq#Length| ar))) (=> (< (+ i_8 1) (|Seq#Length| ar)) (and (=> (= (ControlFlow 0 30) (- 0 31)) (HasDirectPerm QPMask@0 (|Seq#Index| ar (+ i_8 1)) Integer_value)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| ar (+ i_8 1)) Integer_value) (=> (= (ControlFlow 0 30) 29) anon23_correct))))))))))
(let ((anon45_Else_correct  (=> (and (forall ((i_8_1 Int) ) (!  (=> (and (<= 1 i_8_1) (< i_8_1 len)) (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| ar i_8_1) Integer_value)) 0))
 :qid |stdinbpl.715:20|
 :skolemid |67|
 :pattern ( (|Seq#Index| ar i_8_1))
)) (state Heap@@9 QPMask@0)) (and (and (and (and (=> (= (ControlFlow 0 51) 50) anon49_Else_correct) (=> (= (ControlFlow 0 51) 36) anon50_Then_correct)) (=> (= (ControlFlow 0 51) 38) anon50_Else_correct)) (=> (= (ControlFlow 0 51) 30) anon48_Then_correct)) (=> (= (ControlFlow 0 51) 34) anon48_Else_correct)))))
(let ((anon19_correct true))
(let ((anon46_Else_correct  (=> (and (not (and (<= 1 i_7) (< i_7 len))) (= (ControlFlow 0 28) 25)) anon19_correct)))
(let ((anon46_Then_correct  (=> (and (<= 1 i_7) (< i_7 len)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| ar i_7) Integer_value)) 0)) (=> (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| ar i_7) Integer_value)) 0) (=> (= (ControlFlow 0 26) 25) anon19_correct))))))
(let ((anon15_correct true))
(let ((anon44_Else_correct  (=> (and (not (and (<= 1 i_6) (< i_6 len))) (= (ControlFlow 0 24) 19)) anon15_correct)))
(let ((anon44_Then_correct  (=> (and (<= 1 i_6) (< i_6 len)) (and (=> (= (ControlFlow 0 20) (- 0 23)) (>= i_6 0)) (=> (>= i_6 0) (and (=> (= (ControlFlow 0 20) (- 0 22)) (< i_6 (|Seq#Length| ar))) (=> (< i_6 (|Seq#Length| ar)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (HasDirectPerm QPMask@0 (|Seq#Index| ar i_6) Integer_value)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| ar i_6) Integer_value) (=> (= (ControlFlow 0 20) 19) anon15_correct))))))))))
(let ((anon41_Else_correct  (=> (and (forall ((i_5 Int) ) (!  (=> (and (<= 0 i_5) (< i_5 len)) (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| ar i_5) Integer_value)) 0))
 :qid |stdinbpl.678:20|
 :skolemid |66|
 :pattern ( (|Seq#Index| ar i_5))
)) (state Heap@@9 QPMask@0)) (and (and (and (and (=> (= (ControlFlow 0 52) 51) anon45_Else_correct) (=> (= (ControlFlow 0 52) 26) anon46_Then_correct)) (=> (= (ControlFlow 0 52) 28) anon46_Else_correct)) (=> (= (ControlFlow 0 52) 20) anon44_Then_correct)) (=> (= (ControlFlow 0 52) 24) anon44_Else_correct)))))
(let ((anon11_correct true))
(let ((anon42_Else_correct  (=> (and (not (and (<= 0 i_4) (< i_4 len))) (= (ControlFlow 0 18) 13)) anon11_correct)))
(let ((anon42_Then_correct  (=> (and (<= 0 i_4) (< i_4 len)) (and (=> (= (ControlFlow 0 14) (- 0 17)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 14) (- 0 16)) (< i_4 (|Seq#Length| ar))) (=> (< i_4 (|Seq#Length| ar)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm QPMask@0 (|Seq#Index| ar i_4) Integer_value)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| ar i_4) Integer_value) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))))
(let ((anon39_Else_correct  (and (=> (= (ControlFlow 0 53) (- 0 55)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_3))) (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_3_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index| ar i_3) (|Seq#Index| ar i_3_1))))
 :qid |stdinbpl.626:15|
 :skolemid |59|
 ...
 :pattern ( (|Seq#Index| ar i_3@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U (invRecv1 o_3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_3)) (= (|Seq#Index| ar (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.636:22|
 :skolemid |61|
 :pattern ( (invRecv1 o_3))
))) (and (=> (= (ControlFlow 0 53) (- 0 54)) (forall ((i_3@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_3@@2)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.642:15|
 :skolemid |62|
 ...
 :pattern ( (|Seq#Index| ar i_3@@4))
)) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U (invRecv1 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_3@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (|Seq#Index| ar (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 Integer_value)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 Integer_value)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U (invRecv1 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 Integer_value)) (U_2_real (MapType1Select ZeroMask o_3@@0 Integer_value))))))
 :qid |stdinbpl.654:22|
 :skolemid |64|
 :pattern ( (MapType1Select QPMask@0 o_3@@0 Integer_value))
)) (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 Integer_value))) (= (U_2_real (MapType1Select ZeroMask o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.658:29|
 :skolemid |65|
 :pattern ( (MapType1Select ZeroMask o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 53) 52) anon41_Else_correct) (=> (= (ControlFlow 0 53) 14) anon42_Then_correct)) (=> (= (ControlFlow 0 53) 18) anon42_Else_correct)))))))))))
(let ((anon7_correct true))
(let ((anon40_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_2))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon40_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 len) (int_2_U i_2)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_2 (|Seq#Length| ar))) (=> (< i_2 (|Seq#Length| ar)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon37_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (<= 0 i_1) (and (< i_1 (|Seq#Length| ar)) (and (<= 0 j_1) (and (< j_1 (|Seq#Length| ar)) (not (= i_1 j_1)))))) (not (= (|Seq#Index| ar i_1) (|Seq#Index| ar j_1))))
 :qid |stdinbpl.608:20|
 :skolemid |58|
 :pattern ( (|Seq#Index| ar i_1) (|Seq#Index| ar j_1))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 56) 53) anon39_Else_correct) (=> (= (ControlFlow 0 56) 9) anon40_Then_correct)) (=> (= (ControlFlow 0 56) 12) anon40_Else_correct)))))
(let ((anon3_correct true))
(let ((anon38_Else_correct  (=> (and (not (and (<= 0 i@@6) (and (< i@@6 (|Seq#Length| ar)) (and (<= 0 j@@5) (and (< j@@5 (|Seq#Length| ar)) (not (= i@@6 j@@5))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon38_Then_correct  (=> (and (<= 0 i@@6) (and (< i@@6 (|Seq#Length| ar)) (and (<= 0 j@@5) (and (< j@@5 (|Seq#Length| ar)) (not (= i@@6 j@@5)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i@@6 (|Seq#Length| ar))) (=> (< i@@6 (|Seq#Length| ar)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j@@5 (|Seq#Length| ar))) (=> (< j@@5 (|Seq#Length| ar)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= (|Seq#Length| ar) len) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 57) 56) anon37_Else_correct) (=> (= (ControlFlow 0 57) 2) anon38_Then_correct)) (=> (= (ControlFlow 0 57) 7) anon38_Else_correct))))))
