...
(set-info :boogie-vc-id test_unfolding_unknown)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (and (= p_1 NoPerm) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= p_1 NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= p_1 (U_2_real (MapType1Select ZeroMask null falze)))) (=> (<= p_1 (U_2_real (MapType1Select ZeroMask null falze))) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@11 ZeroMask) (<= NoPerm p_1)) (and (state Heap@@11 ZeroMask) (state Heap@@11 ZeroMask))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (> p_1 NoPerm)) (=> (> p_1 NoPerm) (=> (and (|falze#trigger| Heap@@11 falze) (= (MapType0Select Heap@@11 null falze) EmptyFrame)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (>= p_1 NoPerm)) (=> (>= p_1 NoPerm) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))))))
