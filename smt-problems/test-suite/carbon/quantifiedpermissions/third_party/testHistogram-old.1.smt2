...
(declare-fun diz () T@U)
(assert  (and (and (and (and (and (= (type hist) (SeqType RefType)) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@33) (MapType0Type RefType))) (= (type diz) RefType)))
(set-info :boogie-vc-id Ref__loop_main_84)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon12_correct true))
(let ((anon25_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 P) (int_2_U k_13))) (= (ControlFlow 0 20) 15)) anon12_correct)))
(let ((anon25_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 P) (int_2_U k_13)) (and (=> (= (ControlFlow 0 16) (- 0 19)) (>= k_13 0)) (=> (>= k_13 0) (and (=> (= (ControlFlow 0 16) (- 0 18)) (< k_13 (|Seq#Length| hist))) (=> (< k_13 (|Seq#Length| hist)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm QPMask@2 (|Seq#Index| hist k_13) Ref__Integer_value)) (=> (HasDirectPerm QPMask@2 (|Seq#Index| hist k_13) Ref__Integer_value) (=> (= (ControlFlow 0 16) 15) anon12_correct))))))))))
(let ((anon24_Else_correct true))
(let ((anon22_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((k_3 Int) (k_3_1 Int) ) (!  (=> (and (and (and (and (not (= k_3 k_3_1)) (|Seq#Contains| (|Seq#Range| 0 P) (int_2_U k_3))) (|Seq#Contains| (|Seq#Range| 0 P) (int_2_U k_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| hist k_3) (|Seq#Index| hist k_3_1))))
 :qid |stdinbpl.1815:15|
 :skolemid |152|
 ...
 :qid |stdinbpl.1815:15|
 :skolemid |152|
)) (=> (forall ((k_3@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 P) (int_2_U k_3@@1)) (< NoPerm FullPerm)) (and (qpRange10 (|Seq#Index| hist k_3@@1)) (= (invRecv10 (|Seq#Index| hist k_3@@1)) k_3@@1)))
 ...
 :pattern ( (|Seq#Index| hist k_3@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 P) (int_2_U (invRecv10 o_3))) (< NoPerm FullPerm)) (qpRange10 o_3)) (= (|Seq#Index| hist (invRecv10 o_3)) o_3)))
 :qid |stdinbpl.1825:22|
 :skolemid |154|
 ...
 :pattern ( (|Seq#Index| hist k_3@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 P) (int_2_U (invRecv10 o_3@@0))) (< NoPerm FullPerm)) (qpRange10 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| hist (invRecv10 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 Ref__Integer_value)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 Ref__Integer_value)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 P) (int_2_U (invRecv10 o_3@@0))) (< NoPerm FullPerm)) (qpRange10 o_3@@0))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 Ref__Integer_value)) (U_2_real (MapType1Select ZeroMask o_3@@0 Ref__Integer_value))))))
...
(let ((anon23_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 P) (int_2_U k_12))) (= (ControlFlow 0 13) 9)) anon8_correct)))
(let ((anon23_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 P) (int_2_U k_12)) (and (=> (= (ControlFlow 0 10) (- 0 12)) (>= k_12 0)) (=> (>= k_12 0) (and (=> (= (ControlFlow 0 10) (- 0 11)) (< k_12 (|Seq#Length| hist))) (=> (< k_12 (|Seq#Length| hist)) (=> (= (ControlFlow 0 10) 9) anon8_correct))))))))
...
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 24) (- 0 25)) (forall ((k_1 Int) (k_1_1 Int) ) (!  (=> (and (and (and (and (not (= k_1 k_1_1)) (|Seq#Contains| (|Seq#Range| 0 P) (int_2_U k_1))) (|Seq#Contains| (|Seq#Range| 0 P) (int_2_U k_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| hist k_1) (|Seq#Index| hist k_1_1))))
 :qid |stdinbpl.1758:15|
 :skolemid |146|
 ...
 :qid |stdinbpl.1758:15|
 :skolemid |146|
)) (=> (forall ((k_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 P) (int_2_U k_1@@1)) (< NoPerm FullPerm)) (and (qpRange9 (|Seq#Index| hist k_1@@1)) (= (invRecv9 (|Seq#Index| hist k_1@@1)) k_1@@1)))
 ...
 :pattern ( (|Seq#Index| hist k_1@@1))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 P) (int_2_U (invRecv9 o_3@@2))) (< NoPerm FullPerm)) (qpRange9 o_3@@2)) (= (|Seq#Index| hist (invRecv9 o_3@@2)) o_3@@2)))
 ...
 :pattern ( (|Seq#Index| hist k_1@@2))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 P) (int_2_U (invRecv9 o_3@@3))) (< NoPerm FullPerm)) (qpRange9 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| hist (invRecv9 o_3@@3)) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 Ref__Integer_value)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 Ref__Integer_value)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 P) (int_2_U (invRecv9 o_3@@3))) (< NoPerm FullPerm)) (qpRange9 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 Ref__Integer_value)) (U_2_real (MapType1Select ZeroMask o_3@@3 Ref__Integer_value))))))
 :qid |stdinbpl.1780:22|
 :skolemid |150|
...
))) (and (state Heap@@33 QPMask@0) (state Heap@@33 QPMask@0))) (and (=> (= (ControlFlow 0 24) 23) anon21_Then_correct) (=> (= (ControlFlow 0 24) 7) anon21_Else_correct)))))))))
(let ((anon3_correct true))
(let ((anon20_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 P) (int_2_U k_11))) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon20_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 P) (int_2_U k_11)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k_11 0)) (=> (>= k_11 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k_11 (|Seq#Length| hist))) (=> (< k_11 (|Seq#Length| hist)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@33 diz $allocated))) (and (not (= diz null)) (state Heap@@33 ZeroMask))) (and (and (=> (= (ControlFlow 0 26) 24) anon19_Else_correct) (=> (= (ControlFlow 0 26) 2) anon20_Then_correct)) (=> (= (ControlFlow 0 26) 5) anon20_Else_correct))))))
