...
(assert  (and (and (and (and (and (and (and (and (= (type Heap@@15) (MapType0Type RefType)) (= (type diz@@5) RefType)) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |Tree__state#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon4_correct true))
(let ((anon6_Else_correct  (=> (= (MapType0Select Heap@@15 diz@@5 Tree__right) null) (=> (and (= Mask@6 Mask@4) (= (ControlFlow 0 4) 1)) anon4_correct))))
(let ((anon6_Then_correct  (=> (not (= (MapType0Select Heap@@15 diz@@5 Tree__right) null)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@4 diz@@5 Tree__right)) (=> (HasDirectPerm Mask@4 diz@@5 Tree__right) (=> (and (and (= Mask@5 (MapType1Store Mask@4 null (Tree__state (MapType0Select Heap@@15 diz@@5 Tree__right)) (real_2_U (+ (U_2_real (MapType1Select Mask@4 null (Tree__state (MapType0Select Heap@@15 diz@@5 Tree__right)))) FullPerm)))) (state Heap@@15 Mask@5)) (and (= Mask@6 Mask@5) (= (ControlFlow 0 2) 1))) anon4_correct))))))
(let ((anon2_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@4 diz@@5 Tree__right)) (=> (HasDirectPerm Mask@4 diz@@5 Tree__right) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))))
(let ((anon5_Else_correct  (=> (= (MapType0Select Heap@@15 diz@@5 Tree__left) null) (=> (and (= Mask@4 Mask@2) (= (ControlFlow 0 9) 5)) anon2_correct))))
(let ((anon5_Then_correct  (=> (not (= (MapType0Select Heap@@15 diz@@5 Tree__left) null)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm Mask@2 diz@@5 Tree__left)) (=> (HasDirectPerm Mask@2 diz@@5 Tree__left) (=> (and (and (= Mask@3 (MapType1Store Mask@2 null (Tree__state (MapType0Select Heap@@15 diz@@5 Tree__left)) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (Tree__state (MapType0Select Heap@@15 diz@@5 Tree__left)))) FullPerm)))) (state Heap@@15 Mask@3)) (and (= Mask@4 Mask@3) (= (ControlFlow 0 7) 5))) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@15 diz@@5 $allocated)) (not (= diz@@5 null)))) (=> (and (and (and (= Mask@0 (MapType1Store ZeroMask diz@@5 Tree__data (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz@@5 Tree__data)) FullPerm)))) (state Heap@@15 Mask@0)) (and (not (= diz@@5 null)) (= Mask@1 (MapType1Store Mask@0 diz@@5 Tree__left (real_2_U (+ (U_2_real (MapType1Select Mask@0 diz@@5 Tree__left)) FullPerm)))))) (and (and (state Heap@@15 Mask@1) (not (= diz@@5 null))) (and (= Mask@2 (MapType1Store Mask@1 diz@@5 Tree__right (real_2_U (+ (U_2_real (MapType1Select Mask@1 diz@@5 Tree__right)) FullPerm)))) (state Heap@@15 Mask@2)))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm Mask@2 diz@@5 Tree__left)) (=> (HasDirectPerm Mask@2 diz@@5 Tree__left) (and (=> (= (ControlFlow 0 10) 7) anon5_Then_correct) (=> (= (ControlFlow 0 10) 9) anon5_Else_correct))))))))
