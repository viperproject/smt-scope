...
(assert (forall ((Heap2Heap T@U) (Heap1Heap T@U) (this@@3 T@U) ) (!  (=> (and (and (and (= (type Heap2Heap) (MapType0Type RefType)) (= (type Heap1Heap) (MapType0Type RefType))) (= (type this@@3) RefType)) (and (=  (and (and (<= 0 (|sk_List#condqp1| (|List#condqp1| Heap2Heap this@@3) (|List#condqp1| Heap1Heap this@@3))) (< (|sk_List#condqp1| (|List#condqp1| Heap2Heap this@@3) (|List#condqp1| Heap1Heap this@@3)) (|Seq#Length| (MapType0Select Heap2Heap this@@3 nodes)))) (< NoPerm FullPerm))  (and (and (<= 0 (|sk_List#condqp1| (|List#condqp1| Heap2Heap this@@3) (|List#condqp1| Heap1Heap this@@3))) (< (|sk_List#condqp1| (|List#condqp1| Heap2Heap this@@3) (|List#condqp1| Heap1Heap this@@3)) (|Seq#Length| (MapType0Select Heap1Heap this@@3 nodes)))) (< NoPerm FullPerm))) (=> (and (and (<= 0 (|sk_List#condqp1| (|List#condqp1| Heap2Heap this@@3) (|List#condqp1| Heap1Heap this@@3))) (< (|sk_List#condqp1| (|List#condqp1| Heap2Heap this@@3) (|List#condqp1| Heap1Heap this@@3)) (|Seq#Length| (MapType0Select Heap2Heap this@@3 nodes)))) (< NoPerm FullPerm)) (= (MapType0Select Heap2Heap (|Seq#Index| (MapType0Select Heap2Heap this@@3 nodes) (|sk_List#condqp1| (|List#condqp1| Heap2Heap this@@3) (|List#condqp1| Heap1Heap this@@3))) next) (MapType0Select Heap1Heap (|Seq#Index| (MapType0Select Heap1Heap this@@3 nodes) (|sk_List#condqp1| (|List#condqp1| Heap2Heap this@@3) (|List#condqp1| Heap1Heap this@@3))) next))))) (= (|List#condqp1| Heap2Heap this@@3) (|List#condqp1| Heap1Heap this@@3)))
 :qid |stdinbpl.665:15|
 :skolemid |68|
...
(assert (forall ((this@@4 T@U) ) (!  (=> (= (type this@@4) RefType) (= (getPredWandId (List this@@4)) 0))
 :qid |stdinbpl.639:15|
 :skolemid |64|
 :pattern ( (List this@@4))
)))
...
(assert (forall ((this@@5 T@U) ) (!  (=> (= (type this@@5) RefType) (= (PredicateMaskField (List this@@5)) (|List#sm| this@@5)))
 :qid |stdinbpl.631:15|
 :skolemid |62|
 :pattern ( (PredicateMaskField (List this@@5)))
)))
...
(declare-fun i_2 () Int)
(declare-fun j@@5 () Int)
(assert  (and (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type this@@6) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))))
...
(let ((anon40_Else_correct  (=> (not (and (trigger Heap@@14 i_5) (< i_5 (- (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes)) 1)))) (and (=> (= (ControlFlow 0 32) (- 0 36)) (HasDirectPerm QPMask@0 this@@6 nodes)) (=> (HasDirectPerm QPMask@0 this@@6 nodes) (and (=> (= (ControlFlow 0 32) (- 0 35)) (>= i_5 0)) (=> (>= i_5 0) (and (=> (= (ControlFlow 0 32) (- 0 34)) (< i_5 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes)))) (=> (< i_5 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes))) (and (=> (= (ControlFlow 0 32) (- 0 33)) (HasDirectPerm QPMask@0 (|Seq#Index| (MapType0Select Heap@@14 this@@6 nodes) i_5) next)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| (MapType0Select Heap@@14 this@@6 nodes) i_5) next) (=> (= (ControlFlow 0 32) 28) anon25_correct))))))))))))
(let ((anon40_Then_correct  (=> (and (and (trigger Heap@@14 i_5) (< i_5 (- (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes)) 1))) (= (ControlFlow 0 31) 28)) anon25_correct)))
(let ((anon39_Else_correct  (=> (not (trigger Heap@@14 i_5)) (and (=> (= (ControlFlow 0 39) 31) anon40_Then_correct) (=> (= (ControlFlow 0 39) 32) anon40_Else_correct)))))
(let ((anon39_Then_correct  (=> (trigger Heap@@14 i_5) (and (=> (= (ControlFlow 0 37) (- 0 38)) (HasDirectPerm QPMask@0 this@@6 nodes)) (=> (HasDirectPerm QPMask@0 this@@6 nodes) (and (=> (= (ControlFlow 0 37) 31) anon40_Then_correct) (=> (= (ControlFlow 0 37) 32) anon40_Else_correct)))))))
(let ((anon37_Then_correct  (=> (and (<= 0 i_5) (< i_5 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes)))) (and (and (=> (= (ControlFlow 0 40) 30) anon38_Then_correct) (=> (= (ControlFlow 0 40) 37) anon39_Then_correct)) (=> (= (ControlFlow 0 40) 39) anon39_Else_correct)))))
(let ((anon37_Else_correct  (=> (and (not (and (<= 0 i_5) (< i_5 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes))))) (= (ControlFlow 0 29) 28)) anon25_correct)))
(let ((anon36_Else_correct  (=> (< i_5 0) (and (=> (= (ControlFlow 0 43) 40) anon37_Then_correct) (=> (= (ControlFlow 0 43) 29) anon37_Else_correct)))))
(let ((anon36_Then_correct  (=> (<= 0 i_5) (and (=> (= (ControlFlow 0 41) (- 0 42)) (HasDirectPerm QPMask@0 this@@6 nodes)) (=> (HasDirectPerm QPMask@0 this@@6 nodes) (and (=> (= (ControlFlow 0 41) 40) anon37_Then_correct) (=> (= (ControlFlow 0 41) 29) anon37_Else_correct)))))))
(let ((anon35_Else_correct true))
(let ((anon32_Else_correct  (and (=> (= (ControlFlow 0 44) (- 0 45)) (forall ((i_4 Int) (i_4_1 Int) ) (!  (=> (and (and (and (and (not (= i_4 i_4_1)) (and (<= 0 i_4) (< i_4 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes))))) (and (<= 0 i_4_1) (< i_4_1 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@@14 this@@6 nodes) i_4) (|Seq#Index| (MapType0Select Heap@@14 this@@6 nodes) i_4_1))))
 :qid |stdinbpl.743:15|
 :skolemid |70|
))) (=> (forall ((i_4@@0 Int) (i_4_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_4@@0 i_4_1@@0)) (and (<= 0 i_4@@0) (< i_4@@0 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes))))) (and (<= 0 i_4_1@@0) (< i_4_1@@0 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@@14 this@@6 nodes) i_4@@0) (|Seq#Index| (MapType0Select Heap@@14 this@@6 nodes) i_4_1@@0))))
 :qid |stdinbpl.743:15|
 :skolemid |70|
)) (=> (forall ((i_4@@1 Int) ) (!  (=> (and (and (<= 0 i_4@@1) (< i_4@@1 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes)))) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index| (MapType0Select Heap@@14 this@@6 nodes) i_4@@1)) (= (invRecv1 (|Seq#Index| (MapType0Select Heap@@14 this@@6 nodes) i_4@@1)) i_4@@1)))
 :qid |stdinbpl.749:22|
 :skolemid |71|
 :pattern ( (|Seq#Index| (MapType0Select Heap@@14 this@@6 nodes) i_4@@1))
 :pattern ( (|Seq#Index| (MapType0Select Heap@@14 this@@6 nodes) i_4@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv1 o_3)) (< (invRecv1 o_3) (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes)))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (|Seq#Index| (MapType0Select Heap@@14 this@@6 nodes) (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.753:22|
 :skolemid |72|
 :pattern ( (invRecv1 o_3))
)) (forall ((i_4@@2 Int) ) (!  (=> (and (<= 0 i_4@@2) (< i_4@@2 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes)))) (not (= (|Seq#Index| (MapType0Select Heap@@14 this@@6 nodes) i_4@@2) null)))
 :qid |stdinbpl.759:22|
 :skolemid |73|
 :pattern ( (|Seq#Index| (MapType0Select Heap@@14 this@@6 nodes) i_4@@2))
 :pattern ( (|Seq#Index| (MapType0Select Heap@@14 this@@6 nodes) i_4@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes)))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| (MapType0Select Heap@@14 this@@6 nodes) (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (+ (U_2_real (MapType1Select Mask@0 o_3@@0 next)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes)))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (U_2_real (MapType1Select Mask@0 o_3@@0 next))))))
 :qid |stdinbpl.765:22|
 :skolemid |74|
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 next))) (= (U_2_real (MapType1Select Mask@0 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.769:29|
 :skolemid |75|
 :pattern ( (MapType1Select Mask@0 o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
))) (and (state Heap@@14 QPMask@0) (state Heap@@14 QPMask@0))) (and (and (=> (= (ControlFlow 0 44) 27) anon35_Else_correct) (=> (= (ControlFlow 0 44) 41) anon36_Then_correct)) (=> (= (ControlFlow 0 44) 43) anon36_Else_correct)))))))))
(let ((anon13_correct true))
(let ((anon34_Else_correct  (=> (and (not (and (<= 0 i_3) (< i_3 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes))))) (= (ControlFlow 0 23) 18)) anon13_correct)))
(let ((anon34_Then_correct  (=> (and (<= 0 i_3) (< i_3 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes)))) (and (=> (= (ControlFlow 0 19) (- 0 22)) (HasDirectPerm Mask@0 this@@6 nodes)) (=> (HasDirectPerm Mask@0 this@@6 nodes) (and (=> (= (ControlFlow 0 19) (- 0 21)) (>= i_3 0)) (=> (>= i_3 0) (and (=> (= (ControlFlow 0 19) (- 0 20)) (< i_3 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes)))) (=> (< i_3 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes))) (=> (= (ControlFlow 0 19) 18) anon13_correct))))))))))
(let ((anon33_Else_correct  (=> (< i_3 0) (and (=> (= (ControlFlow 0 26) 19) anon34_Then_correct) (=> (= (ControlFlow 0 26) 23) anon34_Else_correct)))))
(let ((anon33_Then_correct  (=> (<= 0 i_3) (and (=> (= (ControlFlow 0 24) (- 0 25)) (HasDirectPerm Mask@0 this@@6 nodes)) (=> (HasDirectPerm Mask@0 this@@6 nodes) (and (=> (= (ControlFlow 0 24) 19) anon34_Then_correct) (=> (= (ControlFlow 0 24) 23) anon34_Else_correct)))))))
(let ((anon27_Else_correct  (=> (forall ((i_2_1 Int) (j_1 Int) ) (!  (=> (and (>= i_2_1 0) (and (< i_2_1 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes))) (and (>= j_1 0) (and (< j_1 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes))) (not (= i_2_1 j_1)))))) (not (= (|Seq#Index| (MapType0Select Heap@@14 this@@6 nodes) i_2_1) (|Seq#Index| (MapType0Select Heap@@14 this@@6 nodes) j_1))))
 :qid |stdinbpl.720:20|
 :skolemid |69|
 :pattern ( (|Seq#Index| (MapType0Select Heap@@14 this@@6 nodes) i_2_1) (|Seq#Index| (MapType0Select Heap@@14 this@@6 nodes) j_1))
...
(let ((anon31_Else_correct  (=> (and (not (and (>= i_2 0) (and (< i_2 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes))) (and (>= j@@5 0) (and (< j@@5 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes))) (not (= i_2 j@@5))))))) (= (ControlFlow 0 9) 1)) anon7_correct)))
(let ((anon31_Then_correct  (=> (and (>= i_2 0) (and (< i_2 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes))) (and (>= j@@5 0) (and (< j@@5 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes))) (not (= i_2 j@@5)))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (HasDirectPerm Mask@0 this@@6 nodes)) (=> (HasDirectPerm Mask@0 this@@6 nodes) (and (=> (= (ControlFlow 0 2) (- 0 7)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 2) (- 0 6)) (< i_2 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes)))) (=> (< i_2 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm Mask@0 this@@6 nodes)) (=> (HasDirectPerm Mask@0 this@@6 nodes) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j@@5 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes)))) (=> (< j@@5 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes))) (=> (= (ControlFlow 0 2) 1) anon7_correct))))))))))))))))
(let ((anon30_Else_correct  (=> (> 0 j@@5) (and (=> (= (ControlFlow 0 14) 2) anon31_Then_correct) (=> (= (ControlFlow 0 14) 9) anon31_Else_correct)))))
(let ((anon30_Then_correct  (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm Mask@0 this@@6 nodes)) (=> (HasDirectPerm Mask@0 this@@6 nodes) (and (=> (= (ControlFlow 0 12) 2) anon31_Then_correct) (=> (= (ControlFlow 0 12) 9) anon31_Else_correct)))))))
(let ((anon29_Then_correct  (=> (< i_2 (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes))) (and (=> (= (ControlFlow 0 15) 12) anon30_Then_correct) (=> (= (ControlFlow 0 15) 14) anon30_Else_correct)))))
(let ((anon29_Else_correct  (=> (<= (|Seq#Length| (MapType0Select Heap@@14 this@@6 nodes)) i_2) (and (=> (= (ControlFlow 0 11) 2) anon31_Then_correct) (=> (= (ControlFlow 0 11) 9) anon31_Else_correct)))))
(let ((anon28_Then_correct  (=> (>= i_2 0) (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm Mask@0 this@@6 nodes)) (=> (HasDirectPerm Mask@0 this@@6 nodes) (and (=> (= (ControlFlow 0 16) 15) anon29_Then_correct) (=> (= (ControlFlow 0 16) 11) anon29_Else_correct)))))))
(let ((anon28_Else_correct  (=> (> 0 i_2) (and (=> (= (ControlFlow 0 10) 2) anon31_Then_correct) (=> (= (ControlFlow 0 10) 9) anon31_Else_correct)))))
(let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@14 this@@6 $allocated)) (not (= this@@6 null))) (and (= Mask@0 (MapType1Store ZeroMask this@@6 nodes (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@6 nodes)) FullPerm)))) (state Heap@@14 Mask@0))) (and (and (=> (= (ControlFlow 0 47) 46) anon27_Else_correct) (=> (= (ControlFlow 0 47) 16) anon28_Then_correct)) (=> (= (ControlFlow 0 47) 10) anon28_Else_correct))))))
