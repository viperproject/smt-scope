...
(declare-fun |select'| (T@U T@U) T@U)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |select#triggerStateless| (T@U) T@U)
...
(declare-fun vselect (T@U T@U) T@U)
...
(declare-fun |select#frame| (T@U T@U) T@U)
...
(assert  (and (forall ((arg0@@29 T@U) (arg1@@11 T@U) ) (! (= (type (|select'| arg0@@29 arg1@@11)) (SeqType intType))
 :qid |funType:select'|
 :pattern ( (|select'| arg0@@29 arg1@@11))
)) (forall ((arg0@@30 T@U) ) (! (= (type (|select#triggerStateless| arg0@@30)) (SeqType intType))
 :qid |funType:select#triggerStateless|
 :pattern ( (|select#triggerStateless| arg0@@30))
))))
(assert (forall ((Heap@@2 T@U) (diz T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type diz) RefType)) (dummyFunction (|select#triggerStateless| diz)))
 :qid |stdinbpl.561:15|
 :skolemid |59|
 :pattern ( (|select'| Heap@@2 diz))
)))
...
(assert (forall ((arg0@@34 T@U) (arg1@@15 T@U) ) (! (= (type (vselect arg0@@34 arg1@@15)) (SeqType intType))
 :qid |funType:vselect|
 :pattern ( (vselect arg0@@34 arg1@@15))
)))
(assert (forall ((Heap@@4 T@U) (diz@@0 T@U) ) (!  (=> (and (= (type Heap@@4) (MapType0Type RefType)) (= (type diz@@0) RefType)) (and (= (vselect Heap@@4 diz@@0) (|select'| Heap@@4 diz@@0)) (dummyFunction (|select#triggerStateless| diz@@0))))
 :qid |stdinbpl.557:15|
 :skolemid |58|
 :pattern ( (vselect Heap@@4 diz@@0))
)))
...
(assert (forall ((Heap@@7 T@U) (Mask@@6 T@U) (diz@@1 T@U) ) (!  (=> (and (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (= (type diz@@1) RefType)) (and (state Heap@@7 Mask@@6) (< AssumeFunctionsAbove 0))) (= (vselect Heap@@7 diz@@1) (|Seq#Empty| intType)))
 :qid |stdinbpl.567:15|
 :skolemid |60|
 :pattern ( (state Heap@@7 Mask@@6) (vselect Heap@@7 diz@@1))
)))
...
(assert (forall ((arg0@@38 T@U) (arg1@@18 T@U) ) (! (= (type (|select#frame| arg0@@38 arg1@@18)) (SeqType intType))
 :qid |funType:select#frame|
 :pattern ( (|select#frame| arg0@@38 arg1@@18))
)))
(assert (forall ((Heap@@10 T@U) (Mask@@10 T@U) (diz@@2 T@U) ) (!  (=> (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type diz@@2) RefType)) (state Heap@@10 Mask@@10)) (= (|select'| Heap@@10 diz@@2) (|select#frame| EmptyFrame diz@@2)))
 :qid |stdinbpl.574:15|
 :skolemid |61|
 :pattern ( (state Heap@@10 Mask@@10) (|select'| Heap@@10 diz@@2))
)))
