...
(declare-fun bar (T@U) Int)
(declare-fun |bar'| (T@U) Int)
(declare-fun |bar#triggerStateless| () Int)
(declare-fun foo2 (T@U) Int)
(declare-fun |foo2'| (T@U) Int)
(declare-fun |foo2#triggerStateless| () Int)
(declare-fun NoPerm () Real)
(declare-fun AssumeFunctionsAbove () Int)
(declare-fun FullPerm () Real)
(declare-fun |foo3#frame| (T@U Int) Int)
(declare-fun |foo#frame| (T@U) Int)
(declare-fun |bar#frame| (T@U) Int)
(declare-fun |foo2#frame| (T@U) Int)
...
(assert (forall ((Heap@@2 T@U) (i Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (int_2_U (|foo3#triggerStateless| i))))
 :qid |stdinbpl.339:15|
 :skolemid |35|
 :pattern ( (|foo3'| Heap@@2 i))
)))
...
(assert (forall ((Heap@@4 T@U) (i@@0 Int) ) (!  (=> (= (type Heap@@4) (MapType0Type RefType)) (and (= (foo3 Heap@@4 i@@0) (|foo3'| Heap@@4 i@@0)) (dummyFunction (int_2_U (|foo3#triggerStateless| i@@0)))))
 :qid |stdinbpl.335:15|
 :skolemid |34|
 :pattern ( (foo3 Heap@@4 i@@0))
)))
...
(assert (forall ((Heap@@7 T@U) ) (!  (=> (= (type Heap@@7) (MapType0Type RefType)) (and (= (foo Heap@@7) (|foo'| Heap@@7)) (dummyFunction (int_2_U |foo#triggerStateless|))))
 :qid |stdinbpl.188:15|
 :skolemid |22|
 :pattern ( (foo Heap@@7))
)))
(assert (forall ((Heap@@8 T@U) ) (!  (=> (= (type Heap@@8) (MapType0Type RefType)) (and (= (bar Heap@@8) (|bar'| Heap@@8)) (dummyFunction (int_2_U |bar#triggerStateless|))))
 :qid |stdinbpl.237:15|
 :skolemid |26|
 :pattern ( (bar Heap@@8))
)))
(assert (forall ((Heap@@9 T@U) ) (!  (=> (= (type Heap@@9) (MapType0Type RefType)) (and (= (foo2 Heap@@9) (|foo2'| Heap@@9)) (dummyFunction (int_2_U |foo2#triggerStateless|))))
 :qid |stdinbpl.286:15|
 :skolemid |30|
 :pattern ( (foo2 Heap@@9))
)))
...
(assert (forall ((Heap@@10 T@U) (Mask@@6 T@U) (i@@1 Int) ) (!  (=> (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (and (state Heap@@10 Mask@@6) (< AssumeFunctionsAbove 0))) (< 0 i@@1)) (= (foo3 Heap@@10 i@@1) (ite (< 0 i@@1) 1 (+ 1 (|foo3'| Heap@@10 i@@1)))))
 :qid |stdinbpl.345:15|
 :skolemid |36|
 :pattern ( (state Heap@@10 Mask@@6) (foo3 Heap@@10 i@@1))
)))
...
(assert (forall ((Heap@@13 T@U) (Mask@@10 T@U) (i@@2 Int) ) (!  (=> (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (state Heap@@13 Mask@@10)) (= (|foo3'| Heap@@13 i@@2) (|foo3#frame| EmptyFrame i@@2)))
 :qid |stdinbpl.352:15|
 :skolemid |37|
 :pattern ( (state Heap@@13 Mask@@10) (|foo3'| Heap@@13 i@@2))
)))
(assert (forall ((Heap@@14 T@U) ) (!  (=> (= (type Heap@@14) (MapType0Type RefType)) (dummyFunction (int_2_U |foo#triggerStateless|)))
 :qid |stdinbpl.192:15|
 :skolemid |23|
 :pattern ( (|foo'| Heap@@14))
)))
(assert (forall ((Heap@@15 T@U) ) (!  (=> (= (type Heap@@15) (MapType0Type RefType)) (dummyFunction (int_2_U |bar#triggerStateless|)))
 :qid |stdinbpl.241:15|
 :skolemid |27|
 :pattern ( (|bar'| Heap@@15))
)))
(assert (forall ((Heap@@16 T@U) ) (!  (=> (= (type Heap@@16) (MapType0Type RefType)) (dummyFunction (int_2_U |foo2#triggerStateless|)))
 :qid |stdinbpl.290:15|
 :skolemid |31|
 :pattern ( (|foo2'| Heap@@16))
)))
...
(assert (forall ((Heap@@18 T@U) (Mask@@11 T@U) ) (!  (=> (and (and (= (type Heap@@18) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (state Heap@@18 Mask@@11)) (= (|foo'| Heap@@18) (|foo#frame| EmptyFrame)))
 :qid |stdinbpl.205:15|
 :skolemid |25|
 :pattern ( (state Heap@@18 Mask@@11) (|foo'| Heap@@18))
)))
(assert (forall ((Heap@@19 T@U) (Mask@@12 T@U) ) (!  (=> (and (and (= (type Heap@@19) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (state Heap@@19 Mask@@12)) (= (|bar'| Heap@@19) (|bar#frame| EmptyFrame)))
 :qid |stdinbpl.254:15|
 :skolemid |29|
 :pattern ( (state Heap@@19 Mask@@12) (|bar'| Heap@@19))
)))
(assert (forall ((Heap@@20 T@U) (Mask@@13 T@U) ) (!  (=> (and (and (= (type Heap@@20) (MapType0Type RefType)) (= (type Mask@@13) (MapType1Type RefType realType))) (state Heap@@20 Mask@@13)) (= (|foo2'| Heap@@20) (|foo2#frame| EmptyFrame)))
 :qid |stdinbpl.303:15|
 :skolemid |33|
 :pattern ( (state Heap@@20 Mask@@13) (|foo2'| Heap@@20))
)))
...
(assert (forall ((Heap@@22 T@U) (Mask@@14 T@U) ) (!  (=> (and (and (= (type Heap@@22) (MapType0Type RefType)) (= (type Mask@@14) (MapType1Type RefType realType))) (and (state Heap@@22 Mask@@14) (< AssumeFunctionsAbove 1))) (= (foo2 Heap@@22) 1))
 :qid |stdinbpl.296:15|
 :skolemid |32|
 :pattern ( (state Heap@@22 Mask@@14) (foo2 Heap@@22))
)))
(assert (forall ((Heap@@23 T@U) (Mask@@15 T@U) ) (!  (=> (and (and (= (type Heap@@23) (MapType0Type RefType)) (= (type Mask@@15) (MapType1Type RefType realType))) (and (state Heap@@23 Mask@@15) (< AssumeFunctionsAbove 2))) (= (bar Heap@@23) 100))
 :qid |stdinbpl.247:15|
 :skolemid |28|
 :pattern ( (state Heap@@23 Mask@@15) (bar Heap@@23))
)))
(assert (forall ((Heap@@24 T@U) (Mask@@16 T@U) ) (!  (=> (and (and (= (type Heap@@24) (MapType0Type RefType)) (= (type Mask@@16) (MapType1Type RefType realType))) (and (state Heap@@24 Mask@@16) (< AssumeFunctionsAbove 3))) (= (foo Heap@@24) 100))
 :qid |stdinbpl.198:15|
 :skolemid |24|
 :pattern ( (state Heap@@24 Mask@@16) (foo Heap@@24))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (> (foo3 Heap@@25 i@@3) 0))))
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 i@@3))))
(let ((anon0_correct  (=> (state Heap@@25 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (< 0 i@@3)) (and (state Heap@@25 ZeroMask) (state Heap@@25 ZeroMask))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
