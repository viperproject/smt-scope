...
(assert  (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type x@@14) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon4_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 x@@14 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 x@@14 f_7)) FullPerm)))) (= (ControlFlow 0 3) (- 0 2))) (= (U_2_real (MapType1Select Mask@1 x@@14 f_7)) NoPerm))))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon4_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@14 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 x@@14 f_7))) (=> (= (ControlFlow 0 4) 3) anon4_correct))))))
(let ((anon5_Else_correct  (=> (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (= (U_2_real (MapType1Select QPMask@0 o_3 f_7)) (U_2_real (MapType1Select ZeroMask o_3 f_7))))
 :qid |stdinbpl.310:22|
 :skolemid |28|
 :pattern ( (MapType1Select QPMask@0 o_3 f_7))
)) (=> (and (and (and (forall ((o_3@@0 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
...
)) (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@0 QPMask@0)) (and (state ExhaleHeap@0 QPMask@0) (not (= x@@14 null)))) (and (and (= Mask@0 (MapType1Store QPMask@0 x@@14 f_7 (real_2_U (+ (U_2_real (MapType1Select QPMask@0 x@@14 f_7)) FullPerm)))) (state ExhaleHeap@0 Mask@0)) (and (state ExhaleHeap@0 Mask@0) (state ExhaleHeap@0 Mask@0)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (= (U_2_real (MapType1Select Mask@0 x@@14 f_7)) FullPerm)) (=> (= (U_2_real (MapType1Select Mask@0 x@@14 f_7)) FullPerm) (=> (state ExhaleHeap@0 Mask@0) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x@@14 $allocated))) (and (=> (= (ControlFlow 0 9) 1) anon5_Then_correct) (=> (= (ControlFlow 0 9) 7) anon5_Else_correct)))))
