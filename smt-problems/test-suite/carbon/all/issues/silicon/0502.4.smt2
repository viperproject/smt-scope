...
(assert  (and (and (and (and (and (and (and (and (= (type s@@3) (MapType2Type RefType boolType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv4 arg0@@43)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select s@@3 x_1))) (U_2_bool (MapType2Select s@@3 x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.720:15|
 :skolemid |100|
 :no-pattern (type x_1)
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select s@@3 x_1@@1)) (< NoPerm FullPerm)) (and (qpRange4 x_1@@1) (= (invRecv4 x_1@@1) x_1@@1))))
 :qid |stdinbpl.726:22|
 :skolemid |101|
 :pattern ( (MapType0Select Heap@@9 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
 :pattern ( (MapType2Select s@@3 x_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select s@@3 (invRecv4 o_3))) (< NoPerm FullPerm)) (qpRange4 o_3)) (= (invRecv4 o_3) o_3)))
 :qid |stdinbpl.730:22|
 :skolemid |102|
 :pattern ( (invRecv4 o_3))
)) (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (U_2_bool (MapType2Select s@@3 x_1@@2))) (not (= x_1@@2 null)))
 :qid |stdinbpl.736:22|
 :skolemid |103|
 :pattern ( (MapType0Select Heap@@9 x_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@2 f_7))
 :pattern ( (MapType2Select s@@3 x_1@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select s@@3 (invRecv4 o_3@@0))) (< NoPerm FullPerm)) (qpRange4 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select Mask@1 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select s@@3 (invRecv4 o_3@@0))) (< NoPerm FullPerm)) (qpRange4 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select Mask@1 o_3@@0 f_7))))))
 :qid |stdinbpl.742:22|
 :skolemid |104|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (= FullPerm (U_2_real (MapType1Select QPMask@0 r1 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 r1 f_7))) (=> (and (= Heap@0 (MapType0Store Heap@@9 r1 f_7 (int_2_U 3))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= (U_2_real (MapType1Select QPMask@0 r1 f_7)) FullPerm)) (=> (<= (U_2_real (MapType1Select QPMask@0 r1 f_7)) FullPerm) (=> (and (state Heap@0 QPMask@0) (= (ControlFlow 0 3) (- 0 2))) (not (= r1 r2)))))))))))))))
