...
(assert  (and (and (and (and (and (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type a_2) RefType)) (= (type freshObj@0) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type c) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id t1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon2_correct  (=> (= Mask@2 (MapType1Store Mask@1 a_2 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 a_2 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (not (= a_2 null))) (=> (not (= a_2 null)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (not (= freshObj@0 null))) (=> (not (= freshObj@0 null)) (=> (and (IdenticalOnKnownLocations Heap@0 ExhaleHeap@0 Mask@2) (not (= a_2 null))) (=> (and (and (= Mask@3 (MapType1Store Mask@2 a_2 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@2 a_2 f_7)) FullPerm)))) (state ExhaleHeap@0 Mask@3)) (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@3 a_2 f_7)) (=> (HasDirectPerm Mask@3 a_2 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (not (= (MapType0Select ExhaleHeap@0 a_2 f_7) freshObj@0))))))))))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@1 a_2 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 a_2 f_7))) (=> (= (ControlFlow 0 6) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 a_2 $allocated))) (and (U_2_bool (MapType0Select Heap@@9 c $allocated)) (not (= a_2 null)))) (and (and (= Mask@0 (MapType1Store ZeroMask a_2 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask a_2 f_7)) FullPerm)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)))) (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@9 freshObj@0 $allocated)))) (and (= Heap@0 (MapType0Store Heap@@9 freshObj@0 $allocated (bool_2_U true))) (= Mask@1 (MapType1Store Mask@0 freshObj@0 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@0 f_7)) FullPerm)))))) (and (and (state Heap@0 Mask@1) (not (= a_2 null))) (and (state Heap@0 Mask@1) (state Heap@0 Mask@1))))) (and (=> (= (ControlFlow 0 9) 6) anon3_Then_correct) (=> (= (ControlFlow 0 9) 8) anon3_Else_correct)))))
