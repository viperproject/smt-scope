...
(assert  (and (and (and (and (= (type xs@@15) (MapType2Type RefType boolType)) (= (type Heap@@18) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv1 arg0@@48)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((z_4 T@U) (z_4_1 T@U) ) (!  (=> (and (= (type z_4) RefType) (= (type z_4_1) RefType)) (=> (and (and (and (and (not (= z_4 z_4_1)) (U_2_bool (MapType2Select xs@@15 z_4))) (U_2_bool (MapType2Select xs@@15 z_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_4 z_4_1))))
 :qid |stdinbpl.526:15|
 :skolemid |87|
 :no-pattern (type z_4)
...
)) (=> (and (and (and (forall ((z_4@@1 T@U) ) (!  (=> (= (type z_4@@1) RefType) (=> (and (U_2_bool (MapType2Select xs@@15 z_4@@1)) (< NoPerm FullPerm)) (and (qpRange1 z_4@@1) (= (invRecv1 z_4@@1) z_4@@1))))
 :qid |stdinbpl.532:22|
 :skolemid |88|
 :pattern ( (MapType0Select Heap@@18 z_4@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 z_4@@1 f_7))
 :pattern ( (MapType2Select xs@@15 z_4@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select xs@@15 (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.536:22|
 :skolemid |89|
 ...
 :qid |stdinbpl.542:22|
 :skolemid |90|
 :pattern ( (MapType0Select Heap@@18 z_4@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 z_4@@2 f_7))
 :pattern ( (MapType2Select xs@@15 z_4@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs@@15 (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select xs@@15 (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.548:22|
 :skolemid |91|
...
)) (state Heap@@18 QPMask@0)) (and (state Heap@@18 QPMask@0) (= (ControlFlow 0 3) (- 0 2))))) (HasDirectPerm QPMask@0 x@@35 f_7))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@18 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@18 x@@35 $allocated)) (= AssumeFunctionsAbove 1)) (and (U_2_bool (MapType2Select xs@@15 x@@35)) (state Heap@@18 ZeroMask))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct))))))
