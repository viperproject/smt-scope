...
(assert  (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type x@@8) RefType)) (= (type Heap@@12) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
...
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@8 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@8 f_7))) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@12 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@12 x@@8 $allocated)) (not (= x@@8 null)))) (=> (and (and (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm)))) (state Heap@@12 Mask@0)) (and (state Heap@@12 Mask@0) (not (= x@@8 null)))) (and (and (= Mask@1 (MapType1Store Mask@0 x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@8 f_7)) FullPerm)))) (state Heap@@12 Mask@1)) (and (state Heap@@12 Mask@1) (state Heap@@12 Mask@1)))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
