...
(assert (forall ((Heap@@2 T@U) (this@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type this@@0) RefType)) (|p#everUsed| (p_1 this@@0)))
 :qid |stdinbpl.213:15|
 :skolemid |27|
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type UnfoldingMask@2) (MapType1Type RefType realType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type this@@5) RefType)) (= (type UnfoldingMask@3) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type alias) RefType)) (= (type Heap@0) (MapType0Type RefType))) (forall ((arg0@@28 T@U) ) (! (= (type (FrameFragment arg0@@28)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@28))
))) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test03)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon6_correct  (=> (and (= UnfoldingMask@2 (MapType1Store Mask@2 null (p_1 this@@5) (real_2_U (- (U_2_real (MapType1Select Mask@2 null (p_1 this@@5))) FullPerm)))) (= perm@3 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= perm@3 NoPerm)) (=> (>= perm@3 NoPerm) (=> (and (and (=> (> perm@3 NoPerm) (not (= this@@5 null))) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 this@@5 x@@8 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 this@@5 x@@8)) perm@3))))) (and (state ExhaleHeap@0 UnfoldingMask@3) (state ExhaleHeap@0 UnfoldingMask@3))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm UnfoldingMask@3 this@@5 x@@8)) (=> (HasDirectPerm UnfoldingMask@3 this@@5 x@@8) (=> (= Heap@1 (MapType0Store ExhaleHeap@0 null (|p#sm| this@@5) (MapType1Store (MapType0Select ExhaleHeap@0 null (|p#sm| this@@5)) this@@5 x@@8 (bool_2_U true)))) (=> (and (and (state Heap@1 Mask@2) (= d@0 (U_2_int (MapType0Select Heap@1 this@@5 x@@8)))) (and (state Heap@1 Mask@2) (= (ControlFlow 0 2) (- 0 1)))) (= c@0 d@0)))))))))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 2)) anon6_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null (p_1 this@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 null (p_1 this@@5)))) (=> (= (ControlFlow 0 5) 2) anon6_correct))))))
(let ((anon4_correct  (=> (= Mask@2 (MapType1Store Mask@1 alias x@@8 (real_2_U (- (U_2_real (MapType1Select Mask@1 alias x@@8)) perm@2)))) (=> (and (and (IdenticalOnKnownLocations Heap@0 ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)) (and (|p#trigger| ExhaleHeap@0 (p_1 this@@5)) (= (MapType0Select ExhaleHeap@0 null (p_1 this@@5)) (FrameFragment (MapType0Select ExhaleHeap@0 this@@5 x@@8))))) (and (=> (= (ControlFlow 0 8) 5) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct))))))
(let ((anon8_Else_correct  (=> (and (= perm@2 NoPerm) (= (ControlFlow 0 11) 8)) anon4_correct)))
(let ((anon8_Then_correct  (=> (not (= perm@2 NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= perm@2 (U_2_real (MapType1Select Mask@1 alias x@@8)))) (=> (<= perm@2 (U_2_real (MapType1Select Mask@1 alias x@@8))) (=> (= (ControlFlow 0 9) 8) anon4_correct))))))
(let ((anon2_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@1 null (p_1 alias) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (p_1 alias))) FullPerm)))) (= perm@1 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 12) (- 0 15)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (and (=> (> perm@1 NoPerm) (not (= alias null))) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 alias x@@8 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 alias x@@8)) perm@1))))) (and (state Heap@@10 UnfoldingMask@1) (state Heap@@10 UnfoldingMask@1))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (HasDirectPerm UnfoldingMask@1 alias x@@8)) (=> (HasDirectPerm UnfoldingMask@1 alias x@@8) (=> (= Heap@0 (MapType0Store Heap@@10 null (|p#sm| alias) (MapType1Store (MapType0Select Heap@@10 null (|p#sm| alias)) alias x@@8 (bool_2_U true)))) (=> (and (and (state Heap@0 Mask@1) (= c@0 (U_2_int (MapType0Select Heap@0 alias x@@8)))) (and (state Heap@0 Mask@1) (= perm@2 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (and (=> (= (ControlFlow 0 12) 9) anon8_Then_correct) (=> (= (ControlFlow 0 12) 11) anon8_Else_correct))))))))))))))
(let ((anon7_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 18) 12)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (p_1 alias))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (p_1 alias)))) (=> (= (ControlFlow 0 16) 12) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 this@@5 $allocated))) (and (U_2_bool (MapType0Select Heap@@10 alias $allocated)) (= this@@5 alias))) (and (and (state Heap@@10 ZeroMask) (= Mask@0 (MapType1Store ZeroMask null (p_1 this@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (p_1 this@@5))) FullPerm))))) (and (state Heap@@10 Mask@0) (= perm@0 (/ (to_real 1) (to_real 2)))))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (=> (> perm@0 NoPerm) (not (= alias null))) (= Mask@1 (MapType1Store Mask@0 alias x@@8 (real_2_U (+ (U_2_real (MapType1Select Mask@0 alias x@@8)) perm@0))))) (=> (and (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1)) (and (|p#trigger| Heap@@10 (p_1 alias)) (= (MapType0Select Heap@@10 null (p_1 alias)) (FrameFragment (MapType0Select Heap@@10 alias x@@8))))) (and (=> (= (ControlFlow 0 19) 16) anon7_Then_correct) (=> (= (ControlFlow 0 19) 18) anon7_Else_correct)))))))))
