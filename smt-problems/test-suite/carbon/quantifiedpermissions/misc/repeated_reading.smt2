...
(assert  (and (and (and (and (and (and (and (and (and (= (type xs) (MapType2Type RefType boolType)) (= (type x@@22) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type x_2) RefType)) (= (type x_5) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type x_4) RefType)) (= (type x_6) RefType)) (= (type x_10) RefType)) (forall ((arg0@@52 T@U) ) (! (= (type (invRecv3 arg0@@52)) RefType)
...
(let ((anon39_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs x_10))) (= (ControlFlow 0 26) 23)) anon25_correct)))
(let ((anon39_Then_correct  (=> (U_2_bool (MapType2Select xs x_10)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (> (U_2_int (MapType0Select Heap@@9 x_10 f_7)) 1)) (=> (> (U_2_int (MapType0Select Heap@@9 x_10 f_7)) 1) (=> (= (ControlFlow 0 24) 23) anon25_correct))))))
(let ((anon21_correct true))
(let ((anon37_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs x_6))) (= (ControlFlow 0 22) 19)) anon21_correct)))
(let ((anon37_Then_correct  (=> (U_2_bool (MapType2Select xs x_6)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (HasDirectPerm QPMask@0 x_6 f_7)) (=> (HasDirectPerm QPMask@0 x_6 f_7) (=> (= (ControlFlow 0 20) 19) anon21_correct))))))
(let ((anon38_Else_correct true))
(let ((anon34_Else_correct  (=> (forall ((x_8 T@U) ) (!  (=> (and (= (type x_8) RefType) (U_2_bool (MapType2Select xs x_8))) (= (U_2_int (MapType0Select Heap@@9 x_8 f_7)) 2))
 :qid |stdinbpl.1242:20|
 :skolemid |144|
 :pattern ( (MapType2Select xs x_8))
)) (=> (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)) (and (and (and (and (=> (= (ControlFlow 0 27) 18) anon38_Else_correct) (=> (= (ControlFlow 0 27) 24) anon39_Then_correct)) (=> (= (ControlFlow 0 27) 26) anon39_Else_correct)) (=> (= (ControlFlow 0 27) 20) anon37_Then_correct)) (=> (= (ControlFlow 0 27) 22) anon37_Else_correct))))))
(let ((anon17_correct true))
(let ((anon35_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs x_4))) (= (ControlFlow 0 17) 14)) anon17_correct)))
(let ((anon35_Then_correct  (=> (U_2_bool (MapType2Select xs x_4)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm QPMask@0 x_4 f_7)) (=> (HasDirectPerm QPMask@0 x_4 f_7) (=> (= (ControlFlow 0 15) 14) anon17_correct))))))
(let ((anon32_Else_correct  (=> (and (forall ((x_6_1 T@U) ) (!  (=> (and (= (type x_6_1) RefType) (U_2_bool (MapType2Select xs x_6_1))) (>= (U_2_int (MapType0Select Heap@@9 x_6_1 f_7)) 1))
 :qid |stdinbpl.1226:20|
 :skolemid |143|
 :pattern ( (MapType2Select xs x_6_1))
)) (state Heap@@9 QPMask@0)) (and (and (=> (= (ControlFlow 0 28) 27) anon34_Else_correct) (=> (= (ControlFlow 0 28) 15) anon35_Then_correct)) (=> (= (ControlFlow 0 28) 17) anon35_Else_correct)))))
(let ((anon13_correct true))
(let ((anon33_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs x_5))) (= (ControlFlow 0 13) 10)) anon13_correct)))
(let ((anon33_Then_correct  (=> (U_2_bool (MapType2Select xs x_5)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (>= (U_2_int (MapType0Select Heap@@9 x_5 f_7)) 1)) (=> (>= (U_2_int (MapType0Select Heap@@9 x_5 f_7)) 1) (=> (= (ControlFlow 0 11) 10) anon13_correct))))))
(let ((anon9_correct true))
(let ((anon31_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs x_2))) (= (ControlFlow 0 9) 6)) anon9_correct)))
(let ((anon31_Then_correct  (=> (U_2_bool (MapType2Select xs x_2)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm QPMask@0 x_2 f_7)) (=> (HasDirectPerm QPMask@0 x_2 f_7) (=> (= (ControlFlow 0 7) 6) anon9_correct))))))
(let ((anon28_Else_correct  (=> (forall ((x_3 T@U) ) (!  (=> (and (= (type x_3) RefType) (U_2_bool (MapType2Select xs x_3))) (> (U_2_int (MapType0Select Heap@@9 x_3 f_7)) 0))
 :qid |stdinbpl.1200:20|
 :skolemid |142|
 :pattern ( (MapType2Select xs x_3))
)) (=> (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)) (and (and (and (and (=> (= (ControlFlow 0 29) 28) anon32_Else_correct) (=> (= (ControlFlow 0 29) 11) anon33_Then_correct)) (=> (= (ControlFlow 0 29) 13) anon33_Else_correct)) (=> (= (ControlFlow 0 29) 7) anon31_Then_correct)) (=> (= (ControlFlow 0 29) 9) anon31_Else_correct))))))
(let ((anon5_correct true))
(let ((anon29_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs x@@22))) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon29_Then_correct  (=> (U_2_bool (MapType2Select xs x@@22)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 x@@22 f_7)) (=> (HasDirectPerm QPMask@0 x@@22 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 30) (- 0 31)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select xs x_1))) (U_2_bool (MapType2Select xs x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
...
)) (=> (and (and (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs x_1@@1)) (< NoPerm FullPerm)) (and (qpRange3 x_1@@1) (= (invRecv3 x_1@@1) x_1@@1))))
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs (invRecv3 o_3@@0))) (< NoPerm FullPerm)) (qpRange3 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select xs (invRecv3 o_3@@0))) (< NoPerm FullPerm)) (qpRange3 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.1181:29|
 :skolemid |141|
 :pattern ( (MapType1Select ZeroMask o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (and (=> (= (ControlFlow 0 30) 29) anon28_Else_correct) (=> (= (ControlFlow 0 30) 3) anon29_Then_correct)) (=> (= (ControlFlow 0 30) 5) anon29_Else_correct)))))))
(let ((anon27_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (> (|Set#Card| xs) 3)) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 32) 1) anon27_Then_correct) (=> (= (ControlFlow 0 32) 30) anon27_Else_correct)))))
