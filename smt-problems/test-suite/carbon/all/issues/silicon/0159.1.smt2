...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 this $allocated)) (not (= this null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask this x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this x@@8)) FullPerm)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) false)))))
