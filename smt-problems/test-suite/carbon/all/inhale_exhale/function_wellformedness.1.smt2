...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (state Heap@@121 ZeroMask) (U_2_bool (MapType0Select Heap@@121 this@@111 $allocated))) (=> (and (and (= AssumeFunctionsAbove 22) (not (= this@@111 null))) (and (state Heap@@121 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm ZeroMask this@@111 x@@8)))))
...
(declare-fun this@@111 () T@U)
(assert  (and (= (type Heap@@121) (MapType0Type RefType)) (= (type this@@111) RefType)))
(set-info :boogie-vc-id |t2#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
...
(let ((anon0_correct  (=> (state Heap@@121 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@121 this@@111 $allocated)) (= AssumeFunctionsAbove 27)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
