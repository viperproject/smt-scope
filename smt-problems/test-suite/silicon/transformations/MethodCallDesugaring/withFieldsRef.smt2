(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:32:39
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/transformations/MethodCallDesugaring/withFieldsRef.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (= ($SortWrappers.$SnapToInt ($Snap.first $t@5@01)) res@1@01))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
