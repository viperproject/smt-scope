...
(declare-fun i_4 () Int)
(declare-fun j@@5 () Int)
(assert  (and (and (= (type s@@21) (SeqType RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id repro)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 35) (let ((anon19_correct true))
(let ((anon30_Else_correct  (=> (and (not (and (<= 0 x_5) (< x_5 (|Seq#Length| s@@21)))) (= (ControlFlow 0 29) 26)) anon19_correct)))
(let ((anon30_Then_correct  (=> (and (<= 0 x_5) (< x_5 (|Seq#Length| s@@21))) (and (=> (= (ControlFlow 0 27) (- 0 28)) (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| s@@21 x_5) f_7)) 0)) (=> (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| s@@21 x_5) f_7)) 0) (=> (= (ControlFlow 0 27) 26) anon19_correct))))))
(let ((anon15_correct true))
(let ((anon28_Else_correct  (=> (and (not (and (<= 0 x_4) (< x_4 (|Seq#Length| s@@21)))) (= (ControlFlow 0 25) 20)) anon15_correct)))
(let ((anon28_Then_correct  (=> (and (<= 0 x_4) (< x_4 (|Seq#Length| s@@21))) (and (=> (= (ControlFlow 0 21) (- 0 24)) (>= x_4 0)) (=> (>= x_4 0) (and (=> (= (ControlFlow 0 21) (- 0 23)) (< x_4 (|Seq#Length| s@@21))) (=> (< x_4 (|Seq#Length| s@@21)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (HasDirectPerm QPMask@0 (|Seq#Index| s@@21 x_4) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| s@@21 x_4) f_7) (=> (= (ControlFlow 0 21) 20) anon15_correct))))))))))
(let ((anon29_Else_correct true))
(let ((anon25_Else_correct  (=> (forall ((x_3_1 Int) ) (!  (=> (and (<= 0 x_3_1) (< x_3_1 (|Seq#Length| s@@21))) (= (U_2_int (MapType0Select Heap@@9 (|Seq#Index| s@@21 x_3_1) f_7)) 0))
 :qid |stdinbpl.1417:20|
 :skolemid |167|
 :pattern ( (|Seq#Index| s@@21 x_3_1))
)) (=> (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)) (and (and (and (and (=> (= (ControlFlow 0 30) 19) anon29_Else_correct) (=> (= (ControlFlow 0 30) 27) anon30_Then_correct)) (=> (= (ControlFlow 0 30) 29) anon30_Else_correct)) (=> (= (ControlFlow 0 30) 21) anon28_Then_correct)) (=> (= (ControlFlow 0 30) 25) anon28_Else_correct))))))
(let ((anon11_correct true))
(let ((anon26_Else_correct  (=> (and (not (and (<= 0 x_3) (< x_3 (|Seq#Length| s@@21)))) (= (ControlFlow 0 18) 13)) anon11_correct)))
(let ((anon26_Then_correct  (=> (and (<= 0 x_3) (< x_3 (|Seq#Length| s@@21))) (and (=> (= (ControlFlow 0 14) (- 0 17)) (>= x_3 0)) (=> (>= x_3 0) (and (=> (= (ControlFlow 0 14) (- 0 16)) (< x_3 (|Seq#Length| s@@21))) (=> (< x_3 (|Seq#Length| s@@21)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm QPMask@0 (|Seq#Index| s@@21 x_3) f_7)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| s@@21 x_3) f_7) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 31) (- 0 32)) (forall ((x_1 Int) (x_1_1 Int) ) (!  (=> (and (and (and (and (not (= x_1 x_1_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@21)) (int_2_U x_1))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@21)) (int_2_U x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| s@@21 x_1) (|Seq#Index| s@@21 x_1_1))))
 :qid |stdinbpl.1368:15|
 :skolemid |161|
))) (=> (forall ((x_1@@0 Int) (x_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@21)) (int_2_U x_1@@0))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@21)) (int_2_U x_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| s@@21 x_1@@0) (|Seq#Index| s@@21 x_1_1@@0))))
 :qid |stdinbpl.1368:15|
 :skolemid |161|
)) (=> (and (and (and (forall ((x_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@21)) (int_2_U x_1@@1)) (< NoPerm FullPerm)) (and (qpRange7 (|Seq#Index| s@@21 x_1@@1)) (= (invRecv7 (|Seq#Index| s@@21 x_1@@1)) x_1@@1)))
 :qid |stdinbpl.1374:22|
 :skolemid |162|
 :pattern ( (|Seq#Index| s@@21 x_1@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| s@@21)) (int_2_U x_1@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@21)) (int_2_U x_1@@1)))
 :pattern ( (|Seq#Index| s@@21 x_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@21)) (int_2_U (invRecv7 o_3))) (< NoPerm FullPerm)) (qpRange7 o_3)) (= (|Seq#Index| s@@21 (invRecv7 o_3)) o_3)))
 :qid |stdinbpl.1378:22|
 :skolemid |163|
 :pattern ( (invRecv7 o_3))
))) (and (forall ((x_1@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@21)) (int_2_U x_1@@2)) (not (= (|Seq#Index| s@@21 x_1@@2) null)))
 :qid |stdinbpl.1384:22|
 :skolemid |164|
 :pattern ( (|Seq#Index| s@@21 x_1@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| s@@21)) (int_2_U x_1@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@21)) (int_2_U x_1@@2)))
 :pattern ( (|Seq#Index| s@@21 x_1@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@21)) (int_2_U (invRecv7 o_3@@0))) (< NoPerm FullPerm)) (qpRange7 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| s@@21 (invRecv7 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@21)) (int_2_U (invRecv7 o_3@@0))) (< NoPerm FullPerm)) (qpRange7 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (and (=> (= (ControlFlow 0 31) 30) anon25_Else_correct) (=> (= (ControlFlow 0 31) 14) anon26_Then_correct)) (=> (= (ControlFlow 0 31) 18) anon26_Else_correct)))))))
(let ((anon7_correct true))
(let ((anon24_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@21)) (int_2_U x_2))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon24_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| s@@21)) (int_2_U x_2)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= x_2 0)) (=> (>= x_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< x_2 (|Seq#Length| s@@21))) (=> (< x_2 (|Seq#Length| s@@21)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon21_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (<= 0 i_1) (and (< i_1 j_1) (< j_1 (|Seq#Length| s@@21)))) (not (= (|Seq#Index| s@@21 i_1) (|Seq#Index| s@@21 j_1))))
 :qid |stdinbpl.1339:20|
 :skolemid |160|
 :pattern ( (|Seq#Index| s@@21 i_1) (|Seq#Index| s@@21 j_1))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 33) 31) anon23_Else_correct) (=> (= (ControlFlow 0 33) 9) anon24_Then_correct)) (=> (= (ControlFlow 0 33) 12) anon24_Else_correct)))))
(let ((anon3_correct true))
(let ((anon22_Else_correct  (=> (and (not (and (<= 0 i_4) (and (< i_4 j@@5) (< j@@5 (|Seq#Length| s@@21))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon22_Then_correct  (=> (and (<= 0 i_4) (and (< i_4 j@@5) (< j@@5 (|Seq#Length| s@@21)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_4 (|Seq#Length| s@@21))) (=> (< i_4 (|Seq#Length| s@@21)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j@@5 (|Seq#Length| s@@21))) (=> (< j@@5 (|Seq#Length| s@@21)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (and (=> (= (ControlFlow 0 34) 33) anon21_Else_correct) (=> (= (ControlFlow 0 34) 2) anon22_Then_correct)) (=> (= (ControlFlow 0 34) 7) anon22_Else_correct)))))
