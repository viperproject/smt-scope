...
(let ((anon19_Else_correct  (=> (and (not (U_2_bool (MapType2Select S t_2))) (= (ControlFlow 0 16) 13)) anon8_correct)))
(let ((anon19_Then_correct  (=> (U_2_bool (MapType2Select S t_2)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm QPMask@2 t_2 f_7)) (=> (HasDirectPerm QPMask@2 t_2 f_7) (=> (= (ControlFlow 0 14) 13) anon8_correct))))))
...
)) (=> (forall ((r_1@@1 T@U) ) (!  (=> (= (type r_1@@1) RefType) (=> (and (U_2_bool (MapType2Select S r_1@@1)) (< NoPerm FullPerm)) (and (qpRange10 r_1@@1) (= (invRecv10 r_1@@1) r_1@@1))))
...
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select S (invRecv10 o_3))) (< NoPerm FullPerm)) (qpRange10 o_3)) (= (invRecv10 o_3) o_3)))
...
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select S (invRecv10 o_3@@0))) (< NoPerm FullPerm)) (qpRange10 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv10 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select S (invRecv10 o_3@@0))) (< NoPerm FullPerm)) (qpRange10 o_3@@0))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 10)) (= FullPerm (U_2_real (MapType1Select QPMask@0 b_2 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 b_2 f_7))) (=> (and (= Heap@0 (MapType0Store Heap@@9 b_2 f_7 (int_2_U (+ (* 2 a_2) 1)))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (forall ((r_2 T@U) (r_2_1 T@U) ) (!  (=> (and (= (type r_2) RefType) (= (type r_2_1) RefType)) (=> (and (and (and (and (not (= r_2 r_2_1)) (U_2_bool (MapType2Select S r_2))) (U_2_bool (MapType2Select S r_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_2 r_2_1))))
 ...
 :skolemid |151|
 :pattern ( (neverTriggered11 r_2) (neverTriggered11 r_2_1))
 ...
 :qid |stdinbpl.1233:17|
 :skolemid |151|
 :pattern ( (neverTriggered11 r_2@@0) (neverTriggered11 r_2_1@@0))
...
)) (=> (and (and (forall ((r_2@@3 T@U) ) (!  (=> (= (type r_2@@3) RefType) (=> (and (U_2_bool (MapType2Select S r_2@@3)) (< NoPerm FullPerm)) (and (qpRange11 r_2@@3) (= (invRecv11 r_2@@3) r_2@@3))))
...
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType2Select S (invRecv11 o_3@@2))) (and (< NoPerm FullPerm) (qpRange11 o_3@@2))) (= (invRecv11 o_3@@2) o_3@@2)))
 :qid |stdinbpl.1250:22|
 :skolemid |154|
 :pattern ( (invRecv11 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType2Select S (invRecv11 o_3@@3))) (and (< NoPerm FullPerm) (qpRange11 o_3@@3))) (and (= (invRecv11 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (- (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select S (invRecv11 o_3@@3))) (and (< NoPerm FullPerm) (qpRange11 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7))))))
...
)) (=> (forall ((s_1@@1 T@U) ) (!  (=> (= (type s_1@@1) RefType) (=> (and (U_2_bool (MapType2Select S s_1@@1)) (< NoPerm FullPerm)) (and (qpRange9 s_1@@1) (= (invRecv9 s_1@@1) s_1@@1))))
...
)) (=> (and (and (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (U_2_bool (MapType2Select S (invRecv9 o_3@@5))) (< NoPerm FullPerm)) (qpRange9 o_3@@5)) (= (invRecv9 o_3@@5) o_3@@5)))
...
))) (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (U_2_bool (MapType2Select S (invRecv9 o_3@@6))) (< NoPerm FullPerm)) (qpRange9 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv9 o_3@@6) o_3@@6)) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@6 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select S (invRecv9 o_3@@6))) (< NoPerm FullPerm)) (qpRange9 o_3@@6))) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@6 f_7))))))
