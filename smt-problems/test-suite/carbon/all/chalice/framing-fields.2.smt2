...
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid this@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid this@@5)))) (=> (= (ControlFlow 0 3) 2) anon4_correct))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@10 this@@5 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (valid this@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid this@@5))) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct))))))
