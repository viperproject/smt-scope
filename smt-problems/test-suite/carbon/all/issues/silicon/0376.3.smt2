...
(declare-fun Void (T@U) T@U)
(declare-fun PredicateType_VoidType () T@T)
(declare-fun |Void$discriminant'| (T@U T@U) Int)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |Void$discriminant#triggerStateless| (T@U) Int)
(declare-fun |foo'| (T@U T@U) Int)
(declare-fun |foo#triggerStateless| (T@U) Int)
(declare-fun |Void#trigger| (T@U T@U) Bool)
(declare-fun |Void#everUsed| (T@U) Bool)
(declare-fun Void$discriminant (T@U T@U) Int)
(declare-fun foo (T@U T@U) Int)
(declare-fun |Void#sm| (T@U) T@U)
(declare-fun AssumeFunctionsAbove () Int)
(declare-fun |Void$discriminant#trigger| (T@U T@U) Bool)
...
(declare-fun |Void$discriminant#frame| (T@U T@U) Int)
...
(assert  (and (= (Ctor PredicateType_VoidType) 12) (forall ((arg0@@25 T@U) ) (! (= (type (Void arg0@@25)) (FieldType PredicateType_VoidType FrameTypeType))
 :qid |funType:Void|
 :pattern ( (Void arg0@@25))
))))
(assert (forall ((self T@U) ) (!  (=> (= (type self) RefType) (IsPredicateField (Void self)))
 :qid |stdinbpl.374:15|
 :skolemid |33|
 :pattern ( (Void self))
)))
(assert (forall ((Heap@@2 T@U) (self@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type self@@0) RefType)) (dummyFunction (int_2_U (|Void$discriminant#triggerStateless| self@@0))))
 :qid |stdinbpl.198:15|
 :skolemid |23|
 :pattern ( (|Void$discriminant'| Heap@@2 self@@0))
)))
(assert (forall ((Heap@@3 T@U) (x@@8 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type x@@8) RefType)) (dummyFunction (int_2_U (|foo#triggerStateless| x@@8))))
 :qid |stdinbpl.292:15|
 :skolemid |28|
 :pattern ( (|foo'| Heap@@3 x@@8))
)))
(assert (forall ((Heap@@4 T@U) (self@@1 T@U) ) (!  (=> (and (= (type Heap@@4) (MapType0Type RefType)) (= (type self@@1) RefType)) (|Void#everUsed| (Void self@@1)))
 :qid |stdinbpl.393:15|
 :skolemid |37|
 :pattern ( (|Void#trigger| Heap@@4 (Void self@@1)))
)))
...
(assert (forall ((Heap@@6 T@U) (self@@2 T@U) ) (!  (=> (and (= (type Heap@@6) (MapType0Type RefType)) (= (type self@@2) RefType)) (and (= (Void$discriminant Heap@@6 self@@2) (|Void$discriminant'| Heap@@6 self@@2)) (dummyFunction (int_2_U (|Void$discriminant#triggerStateless| self@@2)))))
 :qid |stdinbpl.194:15|
 :skolemid |22|
 :pattern ( (Void$discriminant Heap@@6 self@@2))
)))
(assert (forall ((Heap@@7 T@U) (x@@9 T@U) ) (!  (=> (and (= (type Heap@@7) (MapType0Type RefType)) (= (type x@@9) RefType)) (and (= (foo Heap@@7 x@@9) (|foo'| Heap@@7 x@@9)) (dummyFunction (int_2_U (|foo#triggerStateless| x@@9)))))
 :qid |stdinbpl.288:15|
 :skolemid |27|
 :pattern ( (foo Heap@@7 x@@9))
)))
(assert (forall ((self@@3 T@U) (self2 T@U) ) (!  (=> (and (and (= (type self@@3) RefType) (= (type self2) RefType)) (= (Void self@@3) (Void self2))) (= self@@3 self2))
 :qid |stdinbpl.384:15|
 :skolemid |35|
 :pattern ( (Void self@@3) (Void self2))
)))
(assert (forall ((arg0@@26 T@U) ) (! (= (type (|Void#sm| arg0@@26)) (FieldType PredicateType_VoidType (MapType1Type RefType boolType)))
 :qid |funType:Void#sm|
 :pattern ( (|Void#sm| arg0@@26))
)))
(assert (forall ((self@@4 T@U) (self2@@0 T@U) ) (!  (=> (and (and (= (type self@@4) RefType) (= (type self2@@0) RefType)) (= (|Void#sm| self@@4) (|Void#sm| self2@@0))) (= self@@4 self2@@0))
 :qid |stdinbpl.388:15|
 :skolemid |36|
 :pattern ( (|Void#sm| self@@4) (|Void#sm| self2@@0))
)))
(assert (forall ((Heap@@8 T@U) (Mask@@3 T@U) (self@@5 T@U) ) (!  (=> (and (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@3) (MapType1Type RefType realType))) (= (type self@@5) RefType)) (and (state Heap@@8 Mask@@3) (or (< AssumeFunctionsAbove 0) (|Void$discriminant#trigger| (MapType0Select Heap@@8 null (Void self@@5)) self@@5)))) false)
 :qid |stdinbpl.217:15|
 :skolemid |26|
 :pattern ( (state Heap@@8 Mask@@3) (|Void$discriminant'| Heap@@8 self@@5))
)))
...
(assert (forall ((Heap@@11 T@U) (Mask@@7 T@U) (x@@10 T@U) ) (!  (=> (and (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (= (type x@@10) RefType)) (state Heap@@11 Mask@@7)) (= (|foo'| Heap@@11 x@@10) (|foo#frame| (CombineFrames (FrameFragment (MapType0Select Heap@@11 x@@10 f_7)) (FrameFragment (MapType0Select Heap@@11 x@@10 f_7))) x@@10)))
 :qid |stdinbpl.305:15|
 :skolemid |30|
 :pattern ( (state Heap@@11 Mask@@7) (|foo'| Heap@@11 x@@10))
)))
...
(assert (forall ((self@@6 T@U) ) (!  (=> (= (type self@@6) RefType) (= (getPredWandId (Void self@@6)) 0))
 :qid |stdinbpl.378:15|
 :skolemid |34|
 :pattern ( (Void self@@6))
)))
...
(assert (forall ((Heap@@14 T@U) (Mask@@11 T@U) (self@@7 T@U) ) (!  (=> (and (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (= (type self@@7) RefType)) (state Heap@@14 Mask@@11)) (= (|Void$discriminant'| Heap@@14 self@@7) (|Void$discriminant#frame| (MapType0Select Heap@@14 null (Void self@@7)) self@@7)))
 :qid |stdinbpl.211:15|
 :skolemid |25|
 :pattern ( (state Heap@@14 Mask@@11) (|Void$discriminant'| Heap@@14 self@@7))
)))
...
(assert (forall ((self@@8 T@U) ) (!  (=> (= (type self@@8) RefType) (= (PredicateMaskField (Void self@@8)) (|Void#sm| self@@8)))
 :qid |stdinbpl.370:15|
 :skolemid |32|
 :pattern ( (PredicateMaskField (Void self@@8)))
)))
...
(assert (forall ((Heap@@17 T@U) (Mask@@12 T@U) (x@@11 T@U) ) (!  (=> (and (and (and (= (type Heap@@17) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (= (type x@@11) RefType)) (and (state Heap@@17 Mask@@12) (< AssumeFunctionsAbove 1))) (= (foo Heap@@17 x@@11) (U_2_int (MapType0Select Heap@@17 x@@11 f_7))))
 :qid |stdinbpl.298:15|
 :skolemid |29|
 :pattern ( (state Heap@@17 Mask@@12) (foo Heap@@17 x@@11))
)))
...
(assert (forall ((Heap@@18 T@U) (Mask@@13 T@U) (self@@9 T@U) ) (!  (=> (and (and (and (= (type Heap@@18) (MapType0Type RefType)) (= (type Mask@@13) (MapType1Type RefType realType))) (= (type self@@9) RefType)) (and (state Heap@@18 Mask@@13) (< AssumeFunctionsAbove 0))) (= (Void$discriminant Heap@@18 self@@9) 8))
 :qid |stdinbpl.204:15|
 :skolemid |24|
 :pattern ( (state Heap@@18 Mask@@13) (Void$discriminant Heap@@18 self@@9))
 :pattern ( (state Heap@@18 Mask@@13) (|Void$discriminant#triggerStateless| self@@9) (|Void#trigger| Heap@@18 (Void self@@9)))
)))
(assert (forall ((Heap@@19 T@U) (Mask@@14 T@U) (x@@12 T@U) ) (!  (=> (and (and (and (= (type Heap@@19) (MapType0Type RefType)) (= (type Mask@@14) (MapType1Type RefType realType))) (= (type x@@12) RefType)) (and (state Heap@@19 Mask@@14) (or (< AssumeFunctionsAbove 1) (|foo#trigger| (CombineFrames (FrameFragment (MapType0Select Heap@@19 x@@12 f_7)) (FrameFragment (MapType0Select Heap@@19 x@@12 f_7))) x@@12)))) false)
 :qid |stdinbpl.311:15|
 :skolemid |31|
 :pattern ( (state Heap@@19 Mask@@14) (|foo'| Heap@@19 x@@12))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
...
(assert  (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type self@@10) RefType)) (= (type Heap@@20) (MapType0Type RefType))))
(set-info :boogie-vc-id |Void$discriminant#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Void self@@10))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Void self@@10)))) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@20 ZeroMask) (U_2_bool (MapType0Select Heap@@20 self@@10 $allocated))) (and (= AssumeFunctionsAbove 0) (= Mask@0 (MapType1Store ZeroMask null (Void self@@10) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Void self@@10))) FullPerm)))))) (and (and (state Heap@@20 Mask@0) (state Heap@@20 Mask@0)) (and (|Void#trigger| Heap@@20 (Void self@@10)) (= (MapType0Select Heap@@20 null (Void self@@10)) EmptyFrame)))) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))
