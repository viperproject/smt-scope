...
(let ((anon6_correct  (=> (and (state Heap@6 Mask@3) (> wildcard@6 NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((e_3 T@U) (e_3_1 T@U) ) (!  (=> (and (= (type e_3) RefType) (= (type e_3_1) RefType)) (=> (and (and (and (and (not (= e_3 e_3_1)) (U_2_bool (MapType2Select (refs Heap@6 r_1@@52) e_3))) (U_2_bool (MapType2Select (refs Heap@6 r_1@@52) e_3_1))) (< NoPerm wildcard@6)) (< NoPerm wildcard@6)) (not (= e_3 e_3_1))))
 :qid |stdinbpl.1451:17|
 :skolemid |177|
 :pattern ( (neverTriggered7 e_3) (neverTriggered7 e_3_1))
))) (=> (forall ((e_3@@0 T@U) (e_3_1@@0 T@U) ) (!  (=> (and (= (type e_3@@0) RefType) (= (type e_3_1@@0) RefType)) (=> (and (and (and (and (not (= e_3@@0 e_3_1@@0)) (U_2_bool (MapType2Select (refs Heap@6 r_1@@52) e_3@@0))) (U_2_bool (MapType2Select (refs Heap@6 r_1@@52) e_3_1@@0))) (< NoPerm wildcard@6)) (< NoPerm wildcard@6)) (not (= e_3@@0 e_3_1@@0))))
 :qid |stdinbpl.1451:17|
 :skolemid |177|
 :pattern ( (neverTriggered7 e_3@@0) (neverTriggered7 e_3_1@@0))
)) (=> (and (and (and (forall ((e_3@@1 T@U) ) (!  (=> (= (type e_3@@1) RefType) (=> (and (U_2_bool (MapType2Select (refs Heap@6 r_1@@52) e_3@@1)) (< NoPerm wildcard@6)) (and (= (invRecv7 e_3@@1) e_3@@1) (qpRange7 e_3@@1))))
 :qid |stdinbpl.1457:22|
 :skolemid |178|
...
)) (forall ((r_3_1 T@U) ) (!  (=> (= (type r_3_1) RefType) (=> (and (and (U_2_bool (MapType2Select (refs Heap@6 r_1@@52) (invRecv7 r_3_1))) (< NoPerm wildcard@6)) (qpRange7 r_3_1)) (= (invRecv7 r_3_1) r_3_1)))
 :qid |stdinbpl.1461:22|
 :skolemid |179|
 :pattern ( (invRecv7 r_3_1))
))) (and (forall ((r_3_1@@0 T@U) ) (!  (=> (= (type r_3_1@@0) RefType) (=> (and (and (U_2_bool (MapType2Select (refs Heap@6 r_1@@52) (invRecv7 r_3_1@@0))) (< NoPerm wildcard@6)) (qpRange7 r_3_1@@0)) (and (=> (< NoPerm wildcard@6) (= (invRecv7 r_3_1@@0) r_3_1@@0)) (= (U_2_real (MapType1Select QPMask@2 null (Q r_3_1@@0))) (+ (U_2_real (MapType1Select Mask@3 null (Q r_3_1@@0))) wildcard@6)))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.1473:29|
 :skolemid |181|
 :pattern ( (MapType1Select Mask@3 o_3 f_5))
 :pattern ( (MapType1Select QPMask@2 o_3 f_5))
)))) (and (and (forall ((r_3_1@@1 T@U) ) (!  (=> (and (= (type r_3_1@@1) RefType) (not (and (and (U_2_bool (MapType2Select (refs Heap@6 r_1@@52) (invRecv7 r_3_1@@1))) (< NoPerm wildcard@6)) (qpRange7 r_3_1@@1)))) (= (U_2_real (MapType1Select QPMask@2 null (Q r_3_1@@1))) (U_2_real (MapType1Select Mask@3 null (Q r_3_1@@1)))))
...
(let ((anon19_Else_correct  (=> (HasDirectPerm Mask@3 null (P r_1@@52)) (=> (and (= Heap@6 Heap@4) (= (ControlFlow 0 14) 11)) anon6_correct))))
(let ((anon19_Then_correct  (=> (and (and (not (HasDirectPerm Mask@3 null (P r_1@@52))) (= Heap@5 (MapType0Store Heap@4 null (P r_1@@52) newVersion@1))) (and (= Heap@6 Heap@5) (= (ControlFlow 0 13) 11))) anon6_correct)))
(let ((anon4_correct  (=> (and (and (state Heap@4 Mask@2) (state Heap@4 Mask@2)) (and (|P#trigger| Heap@4 (P r_1@@52)) (= (MapType0Select Heap@4 null (P r_1@@52)) (FrameFragment (int_2_U (|P#condqp1| Heap@4 r_1@@52)))))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (> (U_2_real (MapType1Select Mask@2 null (P r_1@@52))) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@2 null (P r_1@@52))) NoPerm) (=> (> wildcard@5 NoPerm) (=> (and (< wildcard@5 (U_2_real (MapType1Select Mask@2 null (P r_1@@52)))) (= Mask@3 (MapType1Store Mask@2 null (P r_1@@52) (real_2_U (- (U_2_real (MapType1Select Mask@2 null (P r_1@@52))) wildcard@5))))) (and (=> (= (ControlFlow 0 15) 13) anon19_Then_correct) (=> (= (ControlFlow 0 15) 14) anon19_Else_correct)))))))))
(let ((anon18_Else_correct  (=> (HasDirectPerm Mask@2 null (P r_1@@52)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 18) 15)) anon4_correct))))
(let ((anon18_Then_correct  (=> (not (HasDirectPerm Mask@2 null (P r_1@@52))) (=> (and (and (= Heap@2 (MapType0Store Heap@1 null (|P#sm| r_1@@52) ZeroPMask)) (= Heap@3 (MapType0Store Heap@2 null (P r_1@@52) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 17) 15))) anon4_correct))))
(let ((anon2_correct  (=> (and (state Heap@1 Mask@1) (> wildcard@2 NoPerm)) (and (=> (= (ControlFlow 0 19) (- 0 24)) (forall ((e T@U) (e_4 T@U) ) (!  (=> (and (= (type e) RefType) (= (type e_4) RefType)) (=> (and (and (and (and (not (= e e_4)) (U_2_bool (MapType2Select (refs Heap@1 r_1@@52) e))) (U_2_bool (MapType2Select (refs Heap@1 r_1@@52) e_4))) (< NoPerm wildcard@2)) (< NoPerm wildcard@2)) (not (= e e_4))))
 :qid |stdinbpl.1316:17|
 :skolemid |161|
 :pattern ( (neverTriggered5 e) (neverTriggered5 e_4))
))) (=> (forall ((e@@0 T@U) (e_4@@0 T@U) ) (!  (=> (and (= (type e@@0) RefType) (= (type e_4@@0) RefType)) (=> (and (and (and (and (not (= e@@0 e_4@@0)) (U_2_bool (MapType2Select (refs Heap@1 r_1@@52) e@@0))) (U_2_bool (MapType2Select (refs Heap@1 r_1@@52) e_4@@0))) (< NoPerm wildcard@2)) (< NoPerm wildcard@2)) (not (= e@@0 e_4@@0))))
 :qid |stdinbpl.1316:17|
 :skolemid |161|
 :pattern ( (neverTriggered5 e@@0) (neverTriggered5 e_4@@0))
)) (=> (forall ((e@@1 T@U) ) (!  (=> (= (type e@@1) RefType) (=> (and (U_2_bool (MapType2Select (refs Heap@1 r_1@@52) e@@1)) (< NoPerm wildcard@2)) (and (= (invRecv5 e@@1) e@@1) (qpRange5 e@@1))))
 :qid |stdinbpl.1322:22|
 :skolemid |162|
...
)) (=> (and (and (and (forall ((r_1_1 T@U) ) (!  (=> (= (type r_1_1) RefType) (=> (and (and (U_2_bool (MapType2Select (refs Heap@1 r_1@@52) (invRecv5 r_1_1))) (< NoPerm wildcard@2)) (qpRange5 r_1_1)) (= (invRecv5 r_1_1) r_1_1)))
 :qid |stdinbpl.1326:22|
 :skolemid |163|
 :pattern ( (invRecv5 r_1_1))
)) (forall ((r_1_1@@0 T@U) ) (!  (=> (= (type r_1_1@@0) RefType) (=> (and (and (U_2_bool (MapType2Select (refs Heap@1 r_1@@52) (invRecv5 r_1_1@@0))) (< NoPerm wildcard@2)) (qpRange5 r_1_1@@0)) (and (=> (< NoPerm wildcard@2) (= (invRecv5 r_1_1@@0) r_1_1@@0)) (= (U_2_real (MapType1Select QPMask@0 null (Q r_1_1@@0))) (+ (U_2_real (MapType1Select Mask@1 null (Q r_1_1@@0))) wildcard@2)))))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 ...
 :qid |stdinbpl.1338:29|
 :skolemid |165|
 :pattern ( (MapType1Select Mask@1 o_3@@0 f_5@@0))
 :pattern ( (MapType1Select QPMask@0 o_3@@0 f_5@@0))
)) (forall ((r_1_1@@1 T@U) ) (!  (=> (and (= (type r_1_1@@1) RefType) (not (and (and (U_2_bool (MapType2Select (refs Heap@1 r_1@@52) (invRecv5 r_1_1@@1))) (< NoPerm wildcard@2)) (qpRange5 r_1_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (Q r_1_1@@1))) (U_2_real (MapType1Select Mask@1 null (Q r_1_1@@1)))))
 :qid |stdinbpl.1342:22|
 :skolemid |166|
 :pattern ( (MapType1Select QPMask@0 null (Q r_1_1@@1)))
)))) (and (and (state Heap@1 QPMask@0) (state Heap@1 QPMask@0)) (and (state Heap@1 QPMask@0) (> wildcard@3 NoPerm)))) (and (=> (= (ControlFlow 0 19) (- 0 23)) (forall ((e_2 T@U) ) (!  (=> (and (= (type e_2) RefType) (U_2_bool (MapType2Select (refs Heap@1 r_1@@52) e_2))) (> (U_2_real (MapType1Select QPMask@0 null (Q e_2))) NoPerm))
...
)) (=> (forall ((e_2@@1 T@U) ) (!  (=> (and (= (type e_2@@1) RefType) (U_2_bool (MapType2Select (refs Heap@1 r_1@@52) e_2@@1))) (< wildcard@3 (U_2_real (MapType1Select QPMask@0 null (Q e_2@@1)))))
 :qid |stdinbpl.1362:20|
 :skolemid |168|
 :no-pattern (type e_2@@1)
 :no-pattern (U_2_int e_2@@1)
 :no-pattern (U_2_bool e_2@@1)
)) (and (=> (= (ControlFlow 0 19) (- 0 22)) (forall ((r_2_1 T@U) ) (!  (=> (= (type r_2_1) RefType) (=> (and (U_2_bool (MapType2Select (refs Heap@1 r_1@@52) (invRecv6 r_2_1))) (qpRange6 r_2_1)) (>= wildcard@3 NoPerm)))
 :qid |stdinbpl.1369:17|
 :skolemid |169|
 :pattern ( (invRecv6 r_2_1))
))) (=> (forall ((r_2_1@@0 T@U) ) (!  (=> (= (type r_2_1@@0) RefType) (=> (and (U_2_bool (MapType2Select (refs Heap@1 r_1@@52) (invRecv6 r_2_1@@0))) (qpRange6 r_2_1@@0)) (>= wildcard@3 NoPerm)))
 :qid |stdinbpl.1369:17|
 :skolemid |169|
 :pattern ( (invRecv6 r_2_1@@0))
)) (and (=> (= (ControlFlow 0 19) (- 0 21)) (forall ((e_2@@2 T@U) (e_2_1 T@U) ) (!  (=> (and (= (type e_2@@2) RefType) (= (type e_2_1) RefType)) (=> (and (and (and (and (not (= e_2@@2 e_2_1)) (U_2_bool (MapType2Select (refs Heap@1 r_1@@52) e_2@@2))) (U_2_bool (MapType2Select (refs Heap@1 r_1@@52) e_2_1))) (< NoPerm wildcard@3)) (< NoPerm wildcard@3)) (not (= e_2@@2 e_2_1))))
 :qid |stdinbpl.1376:17|
 :skolemid |170|
 :pattern ( (neverTriggered6 e_2@@2) (neverTriggered6 e_2_1))
))) (=> (forall ((e_2@@3 T@U) (e_2_1@@0 T@U) ) (!  (=> (and (= (type e_2@@3) RefType) (= (type e_2_1@@0) RefType)) (=> (and (and (and (and (not (= e_2@@3 e_2_1@@0)) (U_2_bool (MapType2Select (refs Heap@1 r_1@@52) e_2@@3))) (U_2_bool (MapType2Select (refs Heap@1 r_1@@52) e_2_1@@0))) (< NoPerm wildcard@3)) (< NoPerm wildcard@3)) (not (= e_2@@3 e_2_1@@0))))
 :qid |stdinbpl.1376:17|
 :skolemid |170|
 :pattern ( (neverTriggered6 e_2@@3) (neverTriggered6 e_2_1@@0))
...
)) (=> (forall ((e_2@@6 T@U) ) (!  (=> (= (type e_2@@6) RefType) (=> (and (U_2_bool (MapType2Select (refs Heap@1 r_1@@52) e_2@@6)) (< NoPerm wildcard@3)) (and (= (invRecv6 e_2@@6) e_2@@6) (qpRange6 e_2@@6))))
...
)) (=> (and (forall ((r_2_1@@1 T@U) ) (!  (=> (= (type r_2_1@@1) RefType) (=> (and (and (U_2_bool (MapType2Select (refs Heap@1 r_1@@52) (invRecv6 r_2_1@@1))) (< NoPerm wildcard@3)) (qpRange6 r_2_1@@1)) (= (invRecv6 r_2_1@@1) r_2_1@@1)))
 :qid |stdinbpl.1393:22|
 :skolemid |173|
 :pattern ( (invRecv6 r_2_1@@1))
)) (forall ((r_2_1@@2 T@U) ) (!  (=> (= (type r_2_1@@2) RefType) (=> (and (and (U_2_bool (MapType2Select (refs Heap@1 r_1@@52) (invRecv6 r_2_1@@2))) (< NoPerm wildcard@3)) (qpRange6 r_2_1@@2)) (and (= (invRecv6 r_2_1@@2) r_2_1@@2) (= (U_2_real (MapType1Select QPMask@1 null (Q r_2_1@@2))) (- (U_2_real (MapType1Select QPMask@0 null (Q r_2_1@@2))) wildcard@3)))))
 :qid |stdinbpl.1399:22|
 :skolemid |174|
 :pattern ( (MapType1Select QPMask@1 null (Q r_2_1@@2)))
))) (=> (and (and (and (forall ((r_2_1@@3 T@U) ) (!  (=> (and (= (type r_2_1@@3) RefType) (not (and (and (U_2_bool (MapType2Select (refs Heap@1 r_1@@52) (invRecv6 r_2_1@@3))) (< NoPerm wildcard@3)) (qpRange6 r_2_1@@3)))) (= (U_2_real (MapType1Select QPMask@1 null (Q r_2_1@@3))) (U_2_real (MapType1Select QPMask@0 null (Q r_2_1@@3)))))
...
))) (and (> wildcard@4 NoPerm) (= Mask@2 (MapType1Store QPMask@1 null (P r_1@@52) (real_2_U (+ (U_2_real (MapType1Select QPMask@1 null (P r_1@@52))) wildcard@4)))))) (and (and (state Heap@1 Mask@2) (state Heap@1 Mask@2)) (and (|P#trigger| Heap@1 (P r_1@@52)) (= (MapType0Select Heap@1 null (P r_1@@52)) (FrameFragment (int_2_U (|P#condqp1| Heap@1 r_1@@52))))))) (and (=> (= (ControlFlow 0 19) 17) anon18_Then_correct) (=> (= (ControlFlow 0 19) 18) anon18_Else_correct)))))))))))))))))))))
(let ((anon17_Else_correct  (=> (HasDirectPerm Mask@1 null (P r_1@@52)) (=> (and (= Heap@1 Heap@@33) (= (ControlFlow 0 26) 19)) anon2_correct))))
(let ((anon17_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (P r_1@@52))) (= Heap@0 (MapType0Store Heap@@33 null (P r_1@@52) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 25) 19))) anon2_correct)))
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@33 r_1@@52 $allocated))) (=> (and (and (and (> wildcard@0 NoPerm) (= Mask@0 (MapType1Store ZeroMask null (P r_1@@52) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P r_1@@52))) wildcard@0))))) (and (state Heap@@33 Mask@0) (state Heap@@33 Mask@0))) (and (and (U_2_bool (MapType0Select Heap@@33 r2@@9 $allocated)) (U_2_bool (MapType0Select Heap@@33 r3 $allocated))) (and (|P#trigger| Heap@@33 (P r_1@@52)) (= (MapType0Select Heap@@33 null (P r_1@@52)) (FrameFragment (int_2_U (|P#condqp1| Heap@@33 r_1@@52))))))) (and (=> (= (ControlFlow 0 27) (- 0 28)) (> (U_2_real (MapType1Select Mask@0 null (P r_1@@52))) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@0 null (P r_1@@52))) NoPerm) (=> (> wildcard@1 NoPerm) (=> (and (< wildcard@1 (U_2_real (MapType1Select Mask@0 null (P r_1@@52)))) (= Mask@1 (MapType1Store Mask@0 null (P r_1@@52) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P r_1@@52))) wildcard@1))))) (and (=> (= (ControlFlow 0 27) 25) anon17_Then_correct) (=> (= (ControlFlow 0 27) 26) anon17_Else_correct)))))))))))
