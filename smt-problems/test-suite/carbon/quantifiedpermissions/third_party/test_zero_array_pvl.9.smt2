...
(let ((anon23_Else_correct  (=> (and (forall ((ix_5_1 Int) (jx_5_1 Int) ) (!  (=> (and (>= ix_5_1 0) (and (< ix_5_1 (|Seq#Length| ar@@27)) (and (>= jx_5_1 0) (and (< jx_5_1 (|Seq#Length| ar@@27)) (not (= ix_5_1 jx_5_1)))))) (not (= (|Seq#Index| ar@@27 ix_5_1) (|Seq#Index| ar@@27 jx_5_1))))
 ...
 :qid |stdinbpl.1764:26|
 :skolemid |150|
)) (and (=> (= (ControlFlow 0 17) (- 0 19)) (forall ((k_5@@2 Int) ) (!  (=> (and (and (<= 0 k_5@@2) (< k_5@@2 hi@@27)) (dummyFunction (MapType0Select Heap@@33 (|Seq#Index| ar@@27 k_5@@2) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1771:23|
 :skolemid |151|
 :pattern ( (|Seq#Index| ar@@27 k_5@@2))
 :pattern ( (|Seq#Index| ar@@27 k_5@@2))
))) (=> (forall ((k_5@@3 Int) ) (!  (=> (and (and (<= 0 k_5@@3) (< k_5@@3 hi@@27)) (dummyFunction (MapType0Select Heap@@33 (|Seq#Index| ar@@27 k_5@@3) Ref__Integer_value))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1771:23|
 :skolemid |151|
