...
(assert  (and (= (type Heap@@9) (MapType0Type RefType)) (= (type s1@@6) (MapType2Type intType boolType))))
...
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (< 0 (|Set#Card| s1@@6)) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct))))))
