...
(assert  (and (= (type s@@3) (MapType2Type RefType boolType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id m1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select s@@3 x_1))) (U_2_bool (MapType2Select s@@3 x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.449:15|
 :skolemid |82|
 :no-pattern (type x_1)
...
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (> (|Set#Card| s@@3) 0))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (> (|Set#Card| s@@3) 0) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
