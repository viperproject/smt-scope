...
(assert  (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type r_2) RefType)) (= (type x@@8) RefType)))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (not (HasDirectPerm Mask@0 r_2 val)) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (HasDirectPerm Mask@0 r_2 val) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@0 r_2 val)) (=> (HasDirectPerm Mask@0 r_2 val) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((r_1_1 T@U) ) (!  (=> (and (= (type r_1_1) RefType) (HasDirectPerm Mask@0 r_1_1 val)) false)
 :qid |stdinbpl.303:15|
 :skolemid |23|
