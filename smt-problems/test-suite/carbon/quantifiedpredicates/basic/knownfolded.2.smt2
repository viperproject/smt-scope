...
(assert (forall ((a@@19 T@U) (x@@15 T@U) (o@@5 T@U) ) (! (let ((T@@29 (type x@@15)))
 (=> (and (= (type a@@19) (MapType2Type T@@29 boolType)) (= (type o@@5) T@@29)) (= (U_2_bool (MapType2Select (|Set#UnionOne| a@@19 x@@15) o@@5))  (or (= o@@5 x@@15) (U_2_bool (MapType2Select a@@19 o@@5))))))
 :qid |stdinbpl.215:18|
 :skolemid |29|
 :pattern ( (MapType2Select (|Set#UnionOne| a@@19 x@@15) o@@5))
)))
...
(assert (forall ((x@@16 T@U) (b_2@@3 Bool) ) (!  (=> (= (type x@@16) RefType) (= (getPredWandId (P x@@16 b_2@@3)) 0))
 :qid |stdinbpl.410:15|
 :skolemid |84|
...
(let ((anon60_Else_correct  (=> (and (not b_2@@5) (not (= x@@25 null))) (=> (and (and (= UnfoldingMask@10 (MapType1Store UnfoldingMask@8 x@@25 g (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@8 x@@25 g)) FullPerm)))) (state PostHeap@3 UnfoldingMask@10)) (and (= UnfoldingMask@11 UnfoldingMask@10) (= (ControlFlow 0 53) 51))) anon17_correct))))
(let ((anon60_Then_correct  (=> (and b_2@@5 (not (= x@@25 null))) (=> (and (and (= UnfoldingMask@9 (MapType1Store UnfoldingMask@8 x@@25 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@8 x@@25 f_7)) FullPerm)))) (state PostHeap@3 UnfoldingMask@9)) (and (= UnfoldingMask@11 UnfoldingMask@9) (= (ControlFlow 0 52) 51))) anon17_correct))))
(let ((anon14_correct  (=> (and (and (state PostHeap@3 PostMask@0) (|P#trigger| PostHeap@3 (P x@@25 b_2@@5))) (and (= (MapType0Select PostHeap@3 null (P x@@25 b_2@@5)) (FrameFragment (ite b_2@@5 (FrameFragment (MapType0Select PostHeap@3 x@@25 f_7)) (FrameFragment (MapType0Select PostHeap@3 x@@25 g))))) (= UnfoldingMask@8 (MapType1Store PostMask@0 null (P x@@25 b_2@@5) (real_2_U (- (U_2_real (MapType1Select PostMask@0 null (P x@@25 b_2@@5))) FullPerm)))))) (and (=> (= (ControlFlow 0 54) 52) anon60_Then_correct) (=> (= (ControlFlow 0 54) 53) anon60_Else_correct)))))
(let ((anon59_Else_correct  (=> (and (and (not b_2@@5) (= PostHeap@2 (MapType0Store PostHeap@0 null (|P#sm| x@@25 b_2@@5) (MapType1Store (MapType0Select PostHeap@0 null (|P#sm| x@@25 b_2@@5)) x@@25 g (bool_2_U true))))) (and (= PostHeap@3 PostHeap@2) (= (ControlFlow 0 56) 54))) anon14_correct)))
(let ((anon59_Then_correct  (=> (and (and b_2@@5 (= PostHeap@1 (MapType0Store PostHeap@0 null (|P#sm| x@@25 b_2@@5) (MapType1Store (MapType0Select PostHeap@0 null (|P#sm| x@@25 b_2@@5)) x@@25 f_7 (bool_2_U true))))) (and (= PostHeap@3 PostHeap@1) (= (ControlFlow 0 55) 54))) anon14_correct)))
(let ((anon58_Else_correct  (=> (not b_2@@5) (and (=> (= (ControlFlow 0 59) (- 0 60)) (HasDirectPerm UnfoldingMask@7 x@@25 g)) (=> (HasDirectPerm UnfoldingMask@7 x@@25 g) (and (=> (= (ControlFlow 0 59) 55) anon59_Then_correct) (=> (= (ControlFlow 0 59) 56) anon59_Else_correct)))))))
(let ((anon58_Then_correct  (=> b_2@@5 (and (=> (= (ControlFlow 0 57) (- 0 58)) (HasDirectPerm UnfoldingMask@7 x@@25 f_7)) (=> (HasDirectPerm UnfoldingMask@7 x@@25 f_7) (and (=> (= (ControlFlow 0 57) 55) anon59_Then_correct) (=> (= (ControlFlow 0 57) 56) anon59_Else_correct)))))))
...
(let ((anon57_Else_correct  (=> (and (not b_2@@5) (not (= x@@25 null))) (=> (and (and (= UnfoldingMask@6 (MapType1Store UnfoldingMask@4 x@@25 g (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@4 x@@25 g)) FullPerm)))) (state PostHeap@0 UnfoldingMask@6)) (and (= UnfoldingMask@7 UnfoldingMask@6) (= (ControlFlow 0 63) 61))) anon8_correct))))
(let ((anon57_Then_correct  (=> (and b_2@@5 (not (= x@@25 null))) (=> (and (and (= UnfoldingMask@5 (MapType1Store UnfoldingMask@4 x@@25 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@4 x@@25 f_7)) FullPerm)))) (state PostHeap@0 UnfoldingMask@5)) (and (= UnfoldingMask@7 UnfoldingMask@5) (= (ControlFlow 0 62) 61))) anon8_correct))))
(let ((anon5_correct  (=> (= UnfoldingMask@4 (MapType1Store PostMask@0 null (P x@@25 b_2@@5) (real_2_U (- (U_2_real (MapType1Select PostMask@0 null (P x@@25 b_2@@5))) FullPerm)))) (and (=> (= (ControlFlow 0 64) 62) anon57_Then_correct) (=> (= (ControlFlow 0 64) 63) anon57_Else_correct)))))
(let ((anon56_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 67) 64)) anon5_correct)))
(let ((anon56_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 65) (- 0 66)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (P x@@25 b_2@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (P x@@25 b_2@@5)))) (=> (= (ControlFlow 0 65) 64) anon5_correct))))))
(let ((anon55_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (= PostMask@0 (MapType1Store ZeroMask null (P x@@25 b_2@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@25 b_2@@5))) FullPerm))))) (=> (and (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)) (and (|P#trigger| PostHeap@0 (P x@@25 b_2@@5)) (= (MapType0Select PostHeap@0 null (P x@@25 b_2@@5)) (FrameFragment (ite b_2@@5 (FrameFragment (MapType0Select PostHeap@0 x@@25 f_7)) (FrameFragment (MapType0Select PostHeap@0 x@@25 g))))))) (and (=> (= (ControlFlow 0 68) 65) anon56_Then_correct) (=> (= (ControlFlow 0 68) 67) anon56_Else_correct))))))
(let ((anon53_correct true))
(let ((anon74_Else_correct  (=> (and (and (not b_2@@5) (= Heap@12 (MapType0Store Heap@10 null (|P#sm| x@@25 b_2@@5) (MapType1Store (MapType0Select Heap@10 null (|P#sm| x@@25 b_2@@5)) x@@25 g (bool_2_U true))))) (and (= Heap@13 Heap@12) (= (ControlFlow 0 4) 2))) anon53_correct)))
(let ((anon74_Then_correct  (=> (and (and b_2@@5 (= Heap@11 (MapType0Store Heap@10 null (|P#sm| x@@25 b_2@@5) (MapType1Store (MapType0Select Heap@10 null (|P#sm| x@@25 b_2@@5)) x@@25 f_7 (bool_2_U true))))) (and (= Heap@13 Heap@11) (= (ControlFlow 0 3) 2))) anon53_correct)))
(let ((anon73_Else_correct  (=> (not b_2@@5) (and (=> (= (ControlFlow 0 7) (- 0 8)) (U_2_bool (MapType0Select Heap@10 x@@25 g))) (=> (U_2_bool (MapType0Select Heap@10 x@@25 g)) (and (=> (= (ControlFlow 0 7) 3) anon74_Then_correct) (=> (= (ControlFlow 0 7) 4) anon74_Else_correct)))))))
(let ((anon73_Then_correct  (=> b_2@@5 (and (=> (= (ControlFlow 0 5) (- 0 6)) (= (U_2_int (MapType0Select Heap@10 x@@25 f_7)) 0)) (=> (= (U_2_int (MapType0Select Heap@10 x@@25 f_7)) 0) (and (=> (= (ControlFlow 0 5) 3) anon74_Then_correct) (=> (= (ControlFlow 0 5) 4) anon74_Else_correct)))))))
...
(let ((anon72_Else_correct  (=> (and (not b_2@@5) (not (= x@@25 null))) (=> (and (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@0 x@@25 g (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@25 g)) FullPerm)))) (state Heap@10 UnfoldingMask@2)) (and (= UnfoldingMask@3 UnfoldingMask@2) (= (ControlFlow 0 11) 9))) anon47_correct))))
(let ((anon72_Then_correct  (=> (and b_2@@5 (not (= x@@25 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x@@25 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@25 f_7)) FullPerm)))) (state Heap@10 UnfoldingMask@1)) (and (= UnfoldingMask@3 UnfoldingMask@1) (= (ControlFlow 0 10) 9))) anon47_correct))))
(let ((anon44_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@7 null (P x@@25 b_2@@5) (real_2_U (- (U_2_real (MapType1Select Mask@7 null (P x@@25 b_2@@5))) FullPerm)))) (and (=> (= (ControlFlow 0 12) 10) anon72_Then_correct) (=> (= (ControlFlow 0 12) 11) anon72_Else_correct)))))
(let ((anon71_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 15) 12)) anon44_correct)))
(let ((anon71_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= FullPerm (U_2_real (MapType1Select Mask@7 null (P x@@25 b_2@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@7 null (P x@@25 b_2@@5)))) (=> (= (ControlFlow 0 13) 12) anon44_correct))))))
(let ((anon42_correct  (=> (= Mask@8 (MapType1Store Mask@7 null (P x@@25 b_2@@5) (real_2_U (- (U_2_real (MapType1Select Mask@7 null (P x@@25 b_2@@5))) FullPerm)))) (=> (and (|P#trigger| Heap@10 (P x@@25 b_2@@5)) (= (MapType0Select Heap@10 null (P x@@25 b_2@@5)) (FrameFragment (ite b_2@@5 (FrameFragment (MapType0Select Heap@10 x@@25 f_7)) (FrameFragment (MapType0Select Heap@10 x@@25 g)))))) (and (=> (= (ControlFlow 0 16) 13) anon71_Then_correct) (=> (= (ControlFlow 0 16) 15) anon71_Else_correct))))))
(let ((anon70_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 19) 16)) anon42_correct)))
(let ((anon70_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (<= FullPerm (U_2_real (MapType1Select Mask@7 null (P x@@25 b_2@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@7 null (P x@@25 b_2@@5)))) (=> (= (ControlFlow 0 17) 16) anon42_correct))))))
...
(let ((anon69_Else_correct  (=> (and (and (not b_2@@5) (= Heap@9 (MapType0Store Heap@7 null (|P#sm| x@@25 b_2@@5) (MapType1Store (MapType0Select Heap@7 null (|P#sm| x@@25 b_2@@5)) x@@25 g (bool_2_U true))))) (and (= Heap@10 Heap@9) (= (ControlFlow 0 22) 20))) anon40_correct)))
(let ((anon69_Then_correct  (=> (and (and b_2@@5 (= Heap@8 (MapType0Store Heap@7 null (|P#sm| x@@25 b_2@@5) (MapType1Store (MapType0Select Heap@7 null (|P#sm| x@@25 b_2@@5)) x@@25 f_7 (bool_2_U true))))) (and (= Heap@10 Heap@8) (= (ControlFlow 0 21) 20))) anon40_correct)))
(let ((anon68_Else_correct  (=> (and (HasDirectPerm Mask@7 null (P x@@25 b_2@@5)) (= Heap@7 Heap@4)) (and (=> (= (ControlFlow 0 24) 21) anon69_Then_correct) (=> (= (ControlFlow 0 24) 22) anon69_Else_correct)))))
(let ((anon68_Then_correct  (=> (and (and (not (HasDirectPerm Mask@7 null (P x@@25 b_2@@5))) (= Heap@5 (MapType0Store Heap@4 null (|P#sm| x@@25 b_2@@5) ZeroPMask))) (and (= Heap@6 (MapType0Store Heap@5 null (P x@@25 b_2@@5) freshVersion@0)) (= Heap@7 Heap@6))) (and (=> (= (ControlFlow 0 23) 21) anon69_Then_correct) (=> (= (ControlFlow 0 23) 22) anon69_Else_correct)))))
(let ((anon35_correct  (=> (= Mask@7 (MapType1Store Mask@6 null (P x@@25 b_2@@5) (real_2_U (+ (U_2_real (MapType1Select Mask@6 null (P x@@25 b_2@@5))) FullPerm)))) (=> (and (and (state Heap@4 Mask@7) (state Heap@4 Mask@7)) (and (|P#trigger| Heap@4 (P x@@25 b_2@@5)) (= (MapType0Select Heap@4 null (P x@@25 b_2@@5)) (FrameFragment (ite b_2@@5 (FrameFragment (MapType0Select Heap@4 x@@25 f_7)) (FrameFragment (MapType0Select Heap@4 x@@25 g))))))) (and (=> (= (ControlFlow 0 25) 23) anon68_Then_correct) (=> (= (ControlFlow 0 25) 24) anon68_Else_correct))))))
(let ((anon31_correct  (=> (= Mask@5 (MapType1Store Mask@3 x@@25 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@3 x@@25 f_7)) FullPerm)))) (=> (and (= Mask@6 Mask@5) (= (ControlFlow 0 31) 25)) anon35_correct))))
(let ((anon66_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 34) 31)) anon31_correct)))
(let ((anon66_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 32) (- 0 33)) (<= FullPerm (U_2_real (MapType1Select Mask@3 x@@25 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 x@@25 f_7))) (=> (= (ControlFlow 0 32) 31) anon31_correct))))))
(let ((anon65_Then_correct  (=> b_2@@5 (and (=> (= (ControlFlow 0 35) 32) anon66_Then_correct) (=> (= (ControlFlow 0 35) 34) anon66_Else_correct)))))
(let ((anon34_correct  (=> (= Mask@4 (MapType1Store Mask@3 x@@25 g (real_2_U (- (U_2_real (MapType1Select Mask@3 x@@25 g)) FullPerm)))) (=> (and (= Mask@6 Mask@4) (= (ControlFlow 0 26) 25)) anon35_correct))))
(let ((anon67_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 29) 26)) anon34_correct)))
(let ((anon67_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (<= FullPerm (U_2_real (MapType1Select Mask@3 x@@25 g)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 x@@25 g))) (=> (= (ControlFlow 0 27) 26) anon34_correct))))))
(let ((anon65_Else_correct  (=> (not b_2@@5) (and (=> (= (ControlFlow 0 30) 27) anon67_Then_correct) (=> (= (ControlFlow 0 30) 29) anon67_Else_correct)))))
...
(let ((anon64_Else_correct  (=> (not b_2@@5) (and (=> (= (ControlFlow 0 39) (- 0 40)) (= FullPerm (U_2_real (MapType1Select Mask@3 x@@25 g)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@3 x@@25 g))) (=> (and (and (= Heap@3 (MapType0Store Heap@1 x@@25 g (bool_2_U true))) (state Heap@3 Mask@3)) (and (= Heap@4 Heap@3) (= (ControlFlow 0 39) 36))) anon28_correct))))))
(let ((anon64_Then_correct  (=> b_2@@5 (and (=> (= (ControlFlow 0 37) (- 0 38)) (= FullPerm (U_2_real (MapType1Select Mask@3 x@@25 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@3 x@@25 f_7))) (=> (and (and (= Heap@2 (MapType0Store Heap@1 x@@25 f_7 (int_2_U 0))) (state Heap@2 Mask@3)) (and (= Heap@4 Heap@2) (= (ControlFlow 0 37) 36))) anon28_correct))))))
...
(let ((anon63_Else_correct  (=> (and (not b_2@@5) (not (= x@@25 null))) (=> (and (and (= Mask@2 (MapType1Store Mask@0 x@@25 g (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@25 g)) FullPerm)))) (state Heap@1 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 43) 41))) anon25_correct))))
(let ((anon63_Then_correct  (=> (and b_2@@5 (not (= x@@25 null))) (=> (and (and (= Mask@1 (MapType1Store Mask@0 x@@25 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@25 f_7)) FullPerm)))) (state Heap@1 Mask@1)) (and (= Mask@3 Mask@1) (= (ControlFlow 0 42) 41))) anon25_correct))))
(let ((anon62_Else_correct  (=> (and (HasDirectPerm Mask@0 null (P x@@25 b_2@@5)) (= Heap@1 Heap@@10)) (and (=> (= (ControlFlow 0 45) 42) anon63_Then_correct) (=> (= (ControlFlow 0 45) 43) anon63_Else_correct)))))
(let ((anon62_Then_correct  (=> (not (HasDirectPerm Mask@0 null (P x@@25 b_2@@5))) (=> (and (= Heap@0 (MapType0Store Heap@@10 null (P x@@25 b_2@@5) newVersion@0)) (= Heap@1 Heap@0)) (and (=> (= (ControlFlow 0 44) 42) anon63_Then_correct) (=> (= (ControlFlow 0 44) 43) anon63_Else_correct))))))
(let ((anon20_correct  (=> (= Mask@0 (MapType1Store QPMask@0 null (P x@@25 b_2@@5) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (P x@@25 b_2@@5))) FullPerm)))) (and (=> (= (ControlFlow 0 46) 44) anon62_Then_correct) (=> (= (ControlFlow 0 46) 45) anon62_Else_correct)))))
(let ((anon61_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 49) 46)) anon20_correct)))
(let ((anon61_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 47) (- 0 48)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (P x@@25 b_2@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (P x@@25 b_2@@5)))) (=> (= (ControlFlow 0 47) 46) anon20_correct))))))
(let ((anon55_Else_correct  (=> (and (|P#trigger| Heap@@10 (P x@@25 b_2@@5)) (= (MapType0Select Heap@@10 null (P x@@25 b_2@@5)) (FrameFragment (ite b_2@@5 (FrameFragment (MapType0Select Heap@@10 x@@25 f_7)) (FrameFragment (MapType0Select Heap@@10 x@@25 g)))))) (and (=> (= (ControlFlow 0 50) 47) anon61_Then_correct) (=> (= (ControlFlow 0 50) 49) anon61_Else_correct)))))
(let ((anon54_Else_correct  (and (=> (= (ControlFlow 0 69) (- 0 70)) (forall ((y_1 T@U) (y_1_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (= (type y_1_1) RefType)) (=> (and (and (and (and (not (= y_1 y_1_1)) (U_2_bool (MapType2Select xs y_1))) (U_2_bool (MapType2Select xs y_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= y_1 y_1_1)) (= b_2@@5  (not b_2@@5)))))
 :qid |stdinbpl.679:17|
 :skolemid |94|
 :pattern ( (neverTriggered2 y_1) (neverTriggered2 y_1_1))
))) (=> (forall ((y_1@@0 T@U) (y_1_1@@0 T@U) ) (!  (=> (and (= (type y_1@@0) RefType) (= (type y_1_1@@0) RefType)) (=> (and (and (and (and (not (= y_1@@0 y_1_1@@0)) (U_2_bool (MapType2Select xs y_1@@0))) (U_2_bool (MapType2Select xs y_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= y_1@@0 y_1_1@@0)) (= b_2@@5  (not b_2@@5)))))
 :qid |stdinbpl.679:17|
 :skolemid |94|
 :pattern ( (neverTriggered2 y_1@@0) (neverTriggered2 y_1_1@@0))
)) (=> (forall ((y_1@@1 T@U) ) (!  (=> (= (type y_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs y_1@@1)) (< NoPerm FullPerm)) (and (= (invRecv2 y_1@@1 b_2@@5) y_1@@1) (qpRange2 y_1@@1 b_2@@5))))
 :qid |stdinbpl.685:22|
 :skolemid |95|
 :pattern ( (MapType0Select Heap@@10 null (P y_1@@1 b_2@@5)))
 :pattern ( (MapType1Select ZeroMask null (P y_1@@1 b_2@@5)))
 :pattern ( (MapType2Select xs y_1@@1))
)) (=> (and (and (and (forall ((x_1_1 T@U) (b_1_1 Bool) ) (!  (=> (= (type x_1_1) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv2 x_1_1 b_1_1))) (< NoPerm FullPerm)) (qpRange2 x_1_1 b_1_1)) (and (= (invRecv2 x_1_1 b_1_1) x_1_1) (= b_2@@5 b_1_1))))
 :qid |stdinbpl.689:22|
 :skolemid |96|
...
)) (forall ((x_1_1@@1 T@U) (b_1_1@@1 Bool) ) (!  (=> (and (= (type x_1_1@@1) RefType) (not (and (and (U_2_bool (MapType2Select xs (invRecv2 x_1_1@@1 b_1_1@@1))) (< NoPerm FullPerm)) (qpRange2 x_1_1@@1 b_1_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (P x_1_1@@1 b_1_1@@1))) (U_2_real (MapType1Select ZeroMask null (P x_1_1@@1 b_1_1@@1)))))
 :qid |stdinbpl.705:22|
 :skolemid |99|
 :pattern ( (MapType1Select QPMask@0 null (P x_1_1@@1 b_1_1@@1)))
)))) (and (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0)) (and (U_2_bool (MapType2Select xs x@@25)) (state Heap@@10 QPMask@0)))) (and (=> (= (ControlFlow 0 69) 68) anon55_Then_correct) (=> (= (ControlFlow 0 69) 50) anon55_Else_correct))))))))
(let ((anon54_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x@@25 $allocated))) (and (=> (= (ControlFlow 0 71) 1) anon54_Then_correct) (=> (= (ControlFlow 0 71) 69) anon54_Else_correct)))))
