...
(assert (= (Ctor ArrayDomainTypeType) 14))
...
(assert  (and (forall ((arg0@@41 T@U) (arg1@@21 Int) ) (! (= (type (loc arg0@@41 arg1@@21)) RefType)
 :qid |funType:loc|
 :pattern ( (loc arg0@@41 arg1@@21))
)) (forall ((arg0@@42 T@U) ) (! (= (type (first arg0@@42)) ArrayDomainTypeType)
 :qid |funType:first|
 :pattern ( (first arg0@@42))
))))
(assert (forall ((a_3@@0 T@U) (i_2 Int) ) (!  (=> (= (type a_3@@0) ArrayDomainTypeType) (and (= (first (loc a_3@@0 i_2)) a_3@@0) (= (second (loc a_3@@0 i_2)) i_2)))
 :qid |stdinbpl.422:15|
 :skolemid |82|
...
(assert (forall ((arg0@@43 T@U) (arg1@@22 T@U) ) (! (let ((T@@20 (MapType2TypeInv0 (type arg0@@43))))
(= (type (|Set#Difference| arg0@@43 arg1@@22)) (MapType2Type T@@20 boolType)))
 :qid |funType:Set#Difference|
 :pattern ( (|Set#Difference| arg0@@43 arg1@@22))
)))
...
(assert (forall ((arg0@@44 T@U) (arg1@@23 T@U) ) (! (let ((T@@24 (type arg1@@23)))
(= (type (|Set#UnionOne| arg0@@44 arg1@@23)) (MapType2Type T@@24 boolType)))
 :qid |funType:Set#UnionOne|
 :pattern ( (|Set#UnionOne| arg0@@44 arg1@@23))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type vals) (MapType2Type intType boolType)) (= (type a_3@0) ArrayDomainTypeType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type s@0) (MapType2Type intType boolType))) (= (type QPMask@6) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type QPMask@4) (MapType1Type RefType realType))) (= (type QPMask@5) (MapType1Type RefType realType))) (= (type s@1) (MapType2Type intType boolType))) (= (type Heap@0) (MapType0Type RefType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type QPMask@3) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type a_3@@1) ArrayDomainTypeType)) (= (type QPMask@7) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id setToArray)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 64) (let ((anon9_correct true))
(let ((anon47_Else_correct  (=> (and (<= (len a_3@@1) k) (= (ControlFlow 0 57) 53)) anon9_correct)))
(let ((anon47_Then_correct  (=> (< k (len a_3@@1)) (and (=> (= (ControlFlow 0 55) (- 0 56)) (HasDirectPerm QPMask@7 (loc a_3@@1 k) val)) (=> (HasDirectPerm QPMask@7 (loc a_3@@1 k) val) (=> (= (ControlFlow 0 55) 53) anon9_correct))))))
(let ((anon46_Then_correct  (=> (<= 0 k) (and (=> (= (ControlFlow 0 58) 55) anon47_Then_correct) (=> (= (ControlFlow 0 58) 57) anon47_Else_correct)))))
(let ((anon46_Else_correct  (=> (and (< k 0) (= (ControlFlow 0 54) 53)) anon9_correct)))
(let ((anon10_correct true))
(let ((anon44_Then_correct  (=> (U_2_bool (MapType2Select vals (int_2_U i_3))) (and (and (=> (= (ControlFlow 0 59) 51) anon10_correct) (=> (= (ControlFlow 0 59) 58) anon46_Then_correct)) (=> (= (ControlFlow 0 59) 54) anon46_Else_correct)))))
(let ((anon44_Else_correct  (=> (and (not (U_2_bool (MapType2Select vals (int_2_U i_3)))) (= (ControlFlow 0 52) 51)) anon10_correct)))
(let ((anon43_Else_correct true))
(let ((anon42_Else_correct  (and (=> (= (ControlFlow 0 60) (- 0 61)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (len a_3@@1)))) (and (<= 0 i_1_1) (< i_1_1 (len a_3@@1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_1) (loc a_3@@1 i_1_1))))
 :qid |stdinbpl.547:15|
 :skolemid |84|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= 0 i_1@@0) (< i_1@@0 (len a_3@@1)))) (and (<= 0 i_1_1@@0) (< i_1_1@@0 (len a_3@@1)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@1 i_1@@0) (loc a_3@@1 i_1_1@@0))))
 :qid |stdinbpl.547:15|
 :skolemid |84|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 (len a_3@@1))) (< NoPerm FullPerm)) (and (qpRange1 (loc a_3@@1 i_1@@1)) (= (invRecv1 (loc a_3@@1 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.553:22|
 :skolemid |85|
 :pattern ( (loc a_3@@1 i_1@@1))
 :pattern ( (loc a_3@@1 i_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv1 o_3)) (< (invRecv1 o_3) (len a_3@@1))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (loc a_3@@1 (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.557:22|
 :skolemid |86|
 :pattern ( (invRecv1 o_3))
)) (forall ((i_1@@2 Int) ) (!  (=> (and (<= 0 i_1@@2) (< i_1@@2 (len a_3@@1))) (not (= (loc a_3@@1 i_1@@2) null)))
 :qid |stdinbpl.563:22|
 :skolemid |87|
 :pattern ( (loc a_3@@1 i_1@@2))
 :pattern ( (loc a_3@@1 i_1@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (len a_3@@1))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@1 (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@7 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (len a_3@@1))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@7 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.569:22|
 :skolemid |88|
...
(let ((anon41_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (= (len a_3@@1) (|Set#Card| vals)) (state PostHeap@0 ZeroMask)) (and (=> (= (ControlFlow 0 62) 49) anon42_Then_correct) (=> (= (ControlFlow 0 62) 60) anon42_Else_correct))))))
(let ((anon34_correct true))
(let ((anon60_Else_correct  (=> (and (not (U_2_bool (MapType2Select (|Set#Difference| vals s@1) (int_2_U i_19)))) (= (ControlFlow 0 33) 30)) anon34_correct)))
(let ((anon60_Then_correct  (=> (U_2_bool (MapType2Select (|Set#Difference| vals s@1) (int_2_U i_19))) (and (=> (= (ControlFlow 0 31) (- 0 32)) (exists ((k_9 Int) ) (!  (and (<= 0 k_9) (and (< k_9 j@1) (= (U_2_int (MapType0Select Heap@0 (loc a_3@0 k_9) val)) i_19)))
 :qid |stdinbpl.969:23|
 :skolemid |129|
 :pattern ( (loc a_3@0 k_9))
))) (=> (exists ((k_9@@0 Int) ) (!  (and (<= 0 k_9@@0) (and (< k_9@@0 j@1) (= (U_2_int (MapType0Select Heap@0 (loc a_3@0 k_9@@0) val)) i_19)))
 :qid |stdinbpl.969:23|
 :skolemid |129|
 :pattern ( (loc a_3@0 k_9@@0))
)) (=> (= (ControlFlow 0 31) 30) anon34_correct))))))
(let ((anon59_Else_correct true))
(let ((anon58_Then_correct  (=> (state ExhaleHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 34) (- 0 40)) (forall ((i_16 Int) (i_16_1 Int) ) (!  (=> (and (and (and (and (not (= i_16 i_16_1)) (and (<= 0 i_16) (< i_16 (len a_3@0)))) (and (<= 0 i_16_1) (< i_16_1 (len a_3@0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@0 i_16) (loc a_3@0 i_16_1))))
 :qid |stdinbpl.837:19|
 :skolemid |115|
))) (=> (forall ((i_16@@0 Int) (i_16_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_16@@0 i_16_1@@0)) (and (<= 0 i_16@@0) (< i_16@@0 (len a_3@0)))) (and (<= 0 i_16_1@@0) (< i_16_1@@0 (len a_3@0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@0 i_16@@0) (loc a_3@0 i_16_1@@0))))
 :qid |stdinbpl.837:19|
 :skolemid |115|
)) (=> (and (forall ((i_16@@1 Int) ) (!  (=> (and (and (<= 0 i_16@@1) (< i_16@@1 (len a_3@0))) (< NoPerm FullPerm)) (and (qpRange6 (loc a_3@0 i_16@@1)) (= (invRecv6 (loc a_3@0 i_16@@1)) i_16@@1)))
 :qid |stdinbpl.843:26|
 :skolemid |116|
 :pattern ( (loc a_3@0 i_16@@1))
 :pattern ( (loc a_3@0 i_16@@1))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (<= 0 (invRecv6 o_3@@2)) (< (invRecv6 o_3@@2) (len a_3@0))) (< NoPerm FullPerm)) (qpRange6 o_3@@2)) (= (loc a_3@0 (invRecv6 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.847:26|
 :skolemid |117|
 :pattern ( (invRecv6 o_3@@2))
))) (=> (and (and (and (and (forall ((i_16@@2 Int) ) (!  (=> (and (<= 0 i_16@@2) (< i_16@@2 (len a_3@0))) (not (= (loc a_3@0 i_16@@2) null)))
 :qid |stdinbpl.853:26|
 :skolemid |118|
 :pattern ( (loc a_3@0 i_16@@2))
 :pattern ( (loc a_3@0 i_16@@2))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (and (<= 0 (invRecv6 o_3@@3)) (< (invRecv6 o_3@@3) (len a_3@0))) (< NoPerm FullPerm)) (qpRange6 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (loc a_3@0 (invRecv6 o_3@@3)) o_3@@3)) (= (U_2_real (MapType1Select QPMask@2 o_3@@3 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 val)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv6 o_3@@3)) (< (invRecv6 o_3@@3) (len a_3@0))) (< NoPerm FullPerm)) (qpRange6 o_3@@3))) (= (U_2_real (MapType1Select QPMask@2 o_3@@3 val)) (U_2_real (MapType1Select ZeroMask o_3@@3 val))))))
 :qid |stdinbpl.859:26|
 :skolemid |119|
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 val))) (= (U_2_real (MapType1Select ZeroMask o_3@@4 f_5@@0)) (U_2_real (MapType1Select QPMask@2 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.863:33|
 :skolemid |120|
 :pattern ( (MapType1Select ZeroMask o_3@@4 f_5@@0))
 :pattern ( (MapType1Select QPMask@2 o_3@@4 f_5@@0))
)) (state ExhaleHeap@0 QPMask@2))) (and (and (|Set#Subset| s@0 vals) (= j@0 (|Set#Card| (|Set#Difference| vals s@0)))) (and (forall ((i_17 T@U) ) (!  (=> (and (= (type i_17) intType) (U_2_bool (MapType2Select (|Set#Difference| vals s@0) i_17))) (exists ((k_8 Int) ) (!  (and (<= 0 k_8) (and (< k_8 j@0) (= (U_2_int (MapType0Select ExhaleHeap@0 (loc a_3@0 k_8) val)) (U_2_int i_17))))
 :qid |stdinbpl.873:53|
 :skolemid |121|
 :pattern ( (loc a_3@0 k_8))
)))
 :qid |stdinbpl.871:24|
 :skolemid |122|
 :pattern ( (MapType2Select vals i_17))
)) (state ExhaleHeap@0 QPMask@2)))) (and (and (and (> (|Set#Card| s@0) 0) (state ExhaleHeap@0 QPMask@2)) (and (state ExhaleHeap@0 QPMask@2) (state ExhaleHeap@0 QPMask@2))) (and (and (state ExhaleHeap@0 QPMask@2) (U_2_bool (MapType2Select s@0 (int_2_U element@1)))) (and (state ExhaleHeap@0 QPMask@2) (state ExhaleHeap@0 QPMask@2))))) (and (=> (= (ControlFlow 0 34) (- 0 39)) (= FullPerm (U_2_real (MapType1Select QPMask@2 (loc a_3@0 j@0) val)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@2 (loc a_3@0 j@0) val))) (=> (and (= Heap@0 (MapType0Store ExhaleHeap@0 (loc a_3@0 j@0) val (int_2_U element@1))) (state Heap@0 QPMask@2)) (=> (and (and (= s@1 (|Set#Difference| s@0 (|Set#Singleton| (int_2_U element@1)))) (state Heap@0 QPMask@2)) (and (= j@1 (+ j@0 1)) (state Heap@0 QPMask@2))) (and (=> (= (ControlFlow 0 34) (- 0 38)) (forall ((i_18 Int) (i_18_1 Int) ) (!  (=> (and (and (and (and (not (= i_18 i_18_1)) (and (<= 0 i_18) (< i_18 (len a_3@0)))) (and (<= 0 i_18_1) (< i_18_1 (len a_3@0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@0 i_18) (loc a_3@0 i_18_1))))
 :qid |stdinbpl.928:21|
 :skolemid |123|
 :pattern ( (neverTriggered7 i_18) (neverTriggered7 i_18_1))
))) (=> (forall ((i_18@@0 Int) (i_18_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_18@@0 i_18_1@@0)) (and (<= 0 i_18@@0) (< i_18@@0 (len a_3@0)))) (and (<= 0 i_18_1@@0) (< i_18_1@@0 (len a_3@0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@0 i_18@@0) (loc a_3@0 i_18_1@@0))))
 :qid |stdinbpl.928:21|
 :skolemid |123|
 :pattern ( (neverTriggered7 i_18@@0) (neverTriggered7 i_18_1@@0))
)) (and (=> (= (ControlFlow 0 34) (- 0 37)) (forall ((i_18@@1 Int) ) (!  (=> (and (<= 0 i_18@@1) (< i_18@@1 (len a_3@0))) (>= (U_2_real (MapType1Select QPMask@2 (loc a_3@0 i_18@@1) val)) FullPerm))
 :qid |stdinbpl.935:21|
 :skolemid |124|
 :pattern ( (loc a_3@0 i_18@@1))
 :pattern ( (loc a_3@0 i_18@@1))
))) (=> (forall ((i_18@@2 Int) ) (!  (=> (and (<= 0 i_18@@2) (< i_18@@2 (len a_3@0))) (>= (U_2_real (MapType1Select QPMask@2 (loc a_3@0 i_18@@2) val)) FullPerm))
 :qid |stdinbpl.935:21|
 :skolemid |124|
 :pattern ( (loc a_3@0 i_18@@2))
 :pattern ( (loc a_3@0 i_18@@2))
)) (=> (and (and (forall ((i_18@@3 Int) ) (!  (=> (and (and (<= 0 i_18@@3) (< i_18@@3 (len a_3@0))) (< NoPerm FullPerm)) (and (qpRange7 (loc a_3@0 i_18@@3)) (= (invRecv7 (loc a_3@0 i_18@@3)) i_18@@3)))
 :qid |stdinbpl.941:26|
 :skolemid |125|
 :pattern ( (loc a_3@0 i_18@@3))
 :pattern ( (loc a_3@0 i_18@@3))
)) (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (<= 0 (invRecv7 o_3@@5)) (< (invRecv7 o_3@@5) (len a_3@0))) (and (< NoPerm FullPerm) (qpRange7 o_3@@5))) (= (loc a_3@0 (invRecv7 o_3@@5)) o_3@@5)))
 :qid |stdinbpl.945:26|
 :skolemid |126|
 :pattern ( (invRecv7 o_3@@5))
))) (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (<= 0 (invRecv7 o_3@@6)) (< (invRecv7 o_3@@6) (len a_3@0))) (and (< NoPerm FullPerm) (qpRange7 o_3@@6))) (and (= (loc a_3@0 (invRecv7 o_3@@6)) o_3@@6) (= (U_2_real (MapType1Select QPMask@3 o_3@@6 val)) (- (U_2_real (MapType1Select QPMask@2 o_3@@6 val)) FullPerm)))) (=> (not (and (and (<= 0 (invRecv7 o_3@@6)) (< (invRecv7 o_3@@6) (len a_3@0))) (and (< NoPerm FullPerm) (qpRange7 o_3@@6)))) (= (U_2_real (MapType1Select QPMask@3 o_3@@6 val)) (U_2_real (MapType1Select QPMask@2 o_3@@6 val))))))
 :qid |stdinbpl.951:26|
 :skolemid |127|
...
)))) (and (=> (= (ControlFlow 0 34) (- 0 36)) (|Set#Subset| s@1 vals)) (=> (|Set#Subset| s@1 vals) (and (=> (= (ControlFlow 0 34) (- 0 35)) (= j@1 (|Set#Card| (|Set#Difference| vals s@1)))) (=> (= j@1 (|Set#Card| (|Set#Difference| vals s@1))) (and (and (=> (= (ControlFlow 0 34) 29) anon59_Else_correct) (=> (= (ControlFlow 0 34) 31) anon60_Then_correct)) (=> (= (ControlFlow 0 34) 33) anon60_Else_correct))))))))))))))))))))))
(let ((anon39_correct true))
(let ((anon62_Else_correct  (=> (and (not (U_2_bool (MapType2Select vals (int_2_U i_5_1)))) (= (ControlFlow 0 23) 20)) anon39_correct)))
(let ((anon62_Then_correct  (=> (U_2_bool (MapType2Select vals (int_2_U i_5_1))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (exists ((k_2_1 Int) ) (!  (and (<= 0 k_2_1) (and (< k_2_1 (len a_3@0)) (= (U_2_int (MapType0Select ExhaleHeap@0 (loc a_3@0 k_2_1) val)) i_5_1)))
 :qid |stdinbpl.1089:19|
 :skolemid |146|
 :pattern ( (loc a_3@0 k_2_1))
))) (=> (exists ((k_2_1@@0 Int) ) (!  (and (<= 0 k_2_1@@0) (and (< k_2_1@@0 (len a_3@0)) (= (U_2_int (MapType0Select ExhaleHeap@0 (loc a_3@0 k_2_1@@0) val)) i_5_1)))
 :qid |stdinbpl.1089:19|
 :skolemid |146|
 :pattern ( (loc a_3@0 k_2_1@@0))
)) (=> (= (ControlFlow 0 21) 20) anon39_correct))))))
(let ((anon61_Else_correct true))
(let ((anon58_Else_correct  (=> (and (not (> (|Set#Card| s@0) 0)) (state ExhaleHeap@0 QPMask@1)) (and (=> (= (ControlFlow 0 24) (- 0 28)) (forall ((i_21 Int) (i_21_1 Int) ) (!  (=> (and (and (and (and (not (= i_21 i_21_1)) (and (<= 0 i_21) (< i_21 (len a_3@0)))) (and (<= 0 i_21_1) (< i_21_1 (len a_3@0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@0 i_21) (loc a_3@0 i_21_1))))
 :qid |stdinbpl.996:17|
 :skolemid |132|
))) (=> (forall ((i_21@@0 Int) (i_21_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_21@@0 i_21_1@@0)) (and (<= 0 i_21@@0) (< i_21@@0 (len a_3@0)))) (and (<= 0 i_21_1@@0) (< i_21_1@@0 (len a_3@0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@0 i_21@@0) (loc a_3@0 i_21_1@@0))))
 :qid |stdinbpl.996:17|
 :skolemid |132|
)) (=> (forall ((i_21@@1 Int) ) (!  (=> (and (and (<= 0 i_21@@1) (< i_21@@1 (len a_3@0))) (< NoPerm FullPerm)) (and (qpRange8 (loc a_3@0 i_21@@1)) (= (invRecv8 (loc a_3@0 i_21@@1)) i_21@@1)))
 :qid |stdinbpl.1002:24|
 :skolemid |133|
 :pattern ( (loc a_3@0 i_21@@1))
 :pattern ( (loc a_3@0 i_21@@1))
)) (=> (and (forall ((o_3@@8 T@U) ) (!  (=> (= (type o_3@@8) RefType) (=> (and (and (and (<= 0 (invRecv8 o_3@@8)) (< (invRecv8 o_3@@8) (len a_3@0))) (< NoPerm FullPerm)) (qpRange8 o_3@@8)) (= (loc a_3@0 (invRecv8 o_3@@8)) o_3@@8)))
 :qid |stdinbpl.1006:24|
 :skolemid |134|
 :pattern ( (invRecv8 o_3@@8))
)) (forall ((i_21@@2 Int) ) (!  (=> (and (<= 0 i_21@@2) (< i_21@@2 (len a_3@0))) (not (= (loc a_3@0 i_21@@2) null)))
 :qid |stdinbpl.1012:24|
 :skolemid |135|
 :pattern ( (loc a_3@0 i_21@@2))
 :pattern ( (loc a_3@0 i_21@@2))
))) (=> (and (and (and (forall ((o_3@@9 T@U) ) (!  (=> (= (type o_3@@9) RefType) (and (=> (and (and (and (<= 0 (invRecv8 o_3@@9)) (< (invRecv8 o_3@@9) (len a_3@0))) (< NoPerm FullPerm)) (qpRange8 o_3@@9)) (and (=> (< NoPerm FullPerm) (= (loc a_3@0 (invRecv8 o_3@@9)) o_3@@9)) (= (U_2_real (MapType1Select QPMask@4 o_3@@9 val)) (+ (U_2_real (MapType1Select QPMask@1 o_3@@9 val)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv8 o_3@@9)) (< (invRecv8 o_3@@9) (len a_3@0))) (< NoPerm FullPerm)) (qpRange8 o_3@@9))) (= (U_2_real (MapType1Select QPMask@4 o_3@@9 val)) (U_2_real (MapType1Select QPMask@1 o_3@@9 val))))))
 :qid |stdinbpl.1018:24|
 :skolemid |136|
...
(let ((A@@15 (FieldTypeInv0 (type f_5@@2))))
 (=> (and (and (= (type o_3@@10) RefType) (= (type f_5@@2) (FieldType A@@15 B@@14))) (not (= f_5@@2 val))) (= (U_2_real (MapType1Select QPMask@1 o_3@@10 f_5@@2)) (U_2_real (MapType1Select QPMask@4 o_3@@10 f_5@@2))))))
 :qid |stdinbpl.1022:31|
 :skolemid |137|
 :pattern ( (MapType1Select QPMask@1 o_3@@10 f_5@@2))
 :pattern ( (MapType1Select QPMask@4 o_3@@10 f_5@@2))
))) (and (state ExhaleHeap@0 QPMask@4) (|Set#Subset| s@0 vals))) (and (and (= j@0 (|Set#Card| (|Set#Difference| vals s@0))) (forall ((i_22 T@U) ) (!  (=> (and (= (type i_22) intType) (U_2_bool (MapType2Select (|Set#Difference| vals s@0) i_22))) (exists ((k_11 Int) ) (!  (and (<= 0 k_11) (and (< k_11 j@0) (= (U_2_int (MapType0Select ExhaleHeap@0 (loc a_3@0 k_11) val)) (U_2_int i_22))))
 :qid |stdinbpl.1032:51|
 :skolemid |138|
 :pattern ( (loc a_3@0 k_11))
)))
 :qid |stdinbpl.1030:22|
 :skolemid |139|
 :pattern ( (MapType2Select vals i_22))
))) (and (state ExhaleHeap@0 QPMask@4) (state ExhaleHeap@0 QPMask@4)))) (and (=> (= (ControlFlow 0 24) (- 0 27)) (= (len a_3@0) (|Set#Card| vals))) (=> (= (len a_3@0) (|Set#Card| vals)) (and (=> (= (ControlFlow 0 24) (- 0 26)) (forall ((i_4 Int) (i_4_1 Int) ) (!  (=> (and (and (and (and (not (= i_4 i_4_1)) (and (<= 0 i_4) (< i_4 (len a_3@0)))) (and (<= 0 i_4_1) (< i_4_1 (len a_3@0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@0 i_4) (loc a_3@0 i_4_1))))
 :qid |stdinbpl.1052:17|
 :skolemid |140|
 :pattern ( (neverTriggered2 i_4) (neverTriggered2 i_4_1))
))) (=> (forall ((i_4@@0 Int) (i_4_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_4@@0 i_4_1@@0)) (and (<= 0 i_4@@0) (< i_4@@0 (len a_3@0)))) (and (<= 0 i_4_1@@0) (< i_4_1@@0 (len a_3@0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@0 i_4@@0) (loc a_3@0 i_4_1@@0))))
 :qid |stdinbpl.1052:17|
 :skolemid |140|
 :pattern ( (neverTriggered2 i_4@@0) (neverTriggered2 i_4_1@@0))
)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (forall ((i_4@@1 Int) ) (!  (=> (and (<= 0 i_4@@1) (< i_4@@1 (len a_3@0))) (>= (U_2_real (MapType1Select QPMask@4 (loc a_3@0 i_4@@1) val)) FullPerm))
 :qid |stdinbpl.1059:17|
 :skolemid |141|
 :pattern ( (loc a_3@0 i_4@@1))
 :pattern ( (loc a_3@0 i_4@@1))
))) (=> (forall ((i_4@@2 Int) ) (!  (=> (and (<= 0 i_4@@2) (< i_4@@2 (len a_3@0))) (>= (U_2_real (MapType1Select QPMask@4 (loc a_3@0 i_4@@2) val)) FullPerm))
 :qid |stdinbpl.1059:17|
 :skolemid |141|
 :pattern ( (loc a_3@0 i_4@@2))
 :pattern ( (loc a_3@0 i_4@@2))
)) (=> (and (and (forall ((i_4@@3 Int) ) (!  (=> (and (and (<= 0 i_4@@3) (< i_4@@3 (len a_3@0))) (< NoPerm FullPerm)) (and (qpRange2 (loc a_3@0 i_4@@3)) (= (invRecv2 (loc a_3@0 i_4@@3)) i_4@@3)))
 :qid |stdinbpl.1065:22|
 :skolemid |142|
 :pattern ( (loc a_3@0 i_4@@3))
 :pattern ( (loc a_3@0 i_4@@3))
)) (forall ((o_3@@11 T@U) ) (!  (=> (= (type o_3@@11) RefType) (=> (and (and (<= 0 (invRecv2 o_3@@11)) (< (invRecv2 o_3@@11) (len a_3@0))) (and (< NoPerm FullPerm) (qpRange2 o_3@@11))) (= (loc a_3@0 (invRecv2 o_3@@11)) o_3@@11)))
 :qid |stdinbpl.1069:22|
 :skolemid |143|
 :pattern ( (invRecv2 o_3@@11))
))) (and (forall ((o_3@@12 T@U) ) (!  (=> (= (type o_3@@12) RefType) (and (=> (and (and (<= 0 (invRecv2 o_3@@12)) (< (invRecv2 o_3@@12) (len a_3@0))) (and (< NoPerm FullPerm) (qpRange2 o_3@@12))) (and (= (loc a_3@0 (invRecv2 o_3@@12)) o_3@@12) (= (U_2_real (MapType1Select QPMask@5 o_3@@12 val)) (- (U_2_real (MapType1Select QPMask@4 o_3@@12 val)) FullPerm)))) (=> (not (and (and (<= 0 (invRecv2 o_3@@12)) (< (invRecv2 o_3@@12) (len a_3@0))) (and (< NoPerm FullPerm) (qpRange2 o_3@@12)))) (= (U_2_real (MapType1Select QPMask@5 o_3@@12 val)) (U_2_real (MapType1Select QPMask@4 o_3@@12 val))))))
...
(let ((A@@16 (FieldTypeInv0 (type f_5@@3))))
 (=> (and (and (= (type o_3@@13) RefType) (= (type f_5@@3) (FieldType A@@16 B@@15))) (not (= f_5@@3 val))) (= (U_2_real (MapType1Select QPMask@4 o_3@@13 f_5@@3)) (U_2_real (MapType1Select QPMask@5 o_3@@13 f_5@@3))))))
 :qid |stdinbpl.1081:29|
 :skolemid |145|
...
(let ((anon57_Else_correct  (=> (and (<= j@0 k_2) (= (ControlFlow 0 14) 10)) anon27_correct)))
(let ((anon57_Then_correct  (=> (< k_2 j@0) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm QPMask@6 (loc a_3@0 k_2) val)) (=> (HasDirectPerm QPMask@6 (loc a_3@0 k_2) val) (=> (= (ControlFlow 0 12) 10) anon27_correct))))))
(let ((anon56_Then_correct  (=> (<= 0 k_2) (and (=> (= (ControlFlow 0 15) 12) anon57_Then_correct) (=> (= (ControlFlow 0 15) 14) anon57_Else_correct)))))
(let ((anon56_Else_correct  (=> (and (< k_2 0) (= (ControlFlow 0 11) 10)) anon27_correct)))
(let ((anon28_correct true))
(let ((anon54_Then_correct  (=> (U_2_bool (MapType2Select (|Set#Difference| vals s@0) (int_2_U i_5))) (and (and (=> (= (ControlFlow 0 16) 8) anon28_correct) (=> (= (ControlFlow 0 16) 15) anon56_Then_correct)) (=> (= (ControlFlow 0 16) 11) anon56_Else_correct)))))
(let ((anon54_Else_correct  (=> (and (not (U_2_bool (MapType2Select (|Set#Difference| vals s@0) (int_2_U i_5)))) (= (ControlFlow 0 9) 8)) anon28_correct)))
(let ((anon53_Else_correct true))
(let ((anon52_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((i_13 Int) (i_13_1 Int) ) (!  (=> (and (and (and (and (not (= i_13 i_13_1)) (and (<= 0 i_13) (< i_13 (len a_3@0)))) (and (<= 0 i_13_1) (< i_13_1 (len a_3@0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@0 i_13) (loc a_3@0 i_13_1))))
 :qid |stdinbpl.763:19|
 :skolemid |107|
))) (=> (forall ((i_13@@0 Int) (i_13_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_13@@0 i_13_1@@0)) (and (<= 0 i_13@@0) (< i_13@@0 (len a_3@0)))) (and (<= 0 i_13_1@@0) (< i_13_1@@0 (len a_3@0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@0 i_13@@0) (loc a_3@0 i_13_1@@0))))
 :qid |stdinbpl.763:19|
 :skolemid |107|
)) (=> (forall ((i_13@@1 Int) ) (!  (=> (and (and (<= 0 i_13@@1) (< i_13@@1 (len a_3@0))) (< NoPerm FullPerm)) (and (qpRange5 (loc a_3@0 i_13@@1)) (= (invRecv5 (loc a_3@0 i_13@@1)) i_13@@1)))
 :qid |stdinbpl.769:26|
 :skolemid |108|
 :pattern ( (loc a_3@0 i_13@@1))
 :pattern ( (loc a_3@0 i_13@@1))
)) (=> (and (forall ((o_3@@14 T@U) ) (!  (=> (= (type o_3@@14) RefType) (=> (and (and (and (<= 0 (invRecv5 o_3@@14)) (< (invRecv5 o_3@@14) (len a_3@0))) (< NoPerm FullPerm)) (qpRange5 o_3@@14)) (= (loc a_3@0 (invRecv5 o_3@@14)) o_3@@14)))
 :qid |stdinbpl.773:26|
 :skolemid |109|
 :pattern ( (invRecv5 o_3@@14))
)) (forall ((i_13@@2 Int) ) (!  (=> (and (<= 0 i_13@@2) (< i_13@@2 (len a_3@0))) (not (= (loc a_3@0 i_13@@2) null)))
 :qid |stdinbpl.779:26|
 :skolemid |110|
 :pattern ( (loc a_3@0 i_13@@2))
 :pattern ( (loc a_3@0 i_13@@2))
))) (=> (and (and (and (forall ((o_3@@15 T@U) ) (!  (=> (= (type o_3@@15) RefType) (and (=> (and (and (and (<= 0 (invRecv5 o_3@@15)) (< (invRecv5 o_3@@15) (len a_3@0))) (< NoPerm FullPerm)) (qpRange5 o_3@@15)) (and (=> (< NoPerm FullPerm) (= (loc a_3@0 (invRecv5 o_3@@15)) o_3@@15)) (= (U_2_real (MapType1Select QPMask@6 o_3@@15 val)) (+ (U_2_real (MapType1Select QPMask@1 o_3@@15 val)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv5 o_3@@15)) (< (invRecv5 o_3@@15) (len a_3@0))) (< NoPerm FullPerm)) (qpRange5 o_3@@15))) (= (U_2_real (MapType1Select QPMask@6 o_3@@15 val)) (U_2_real (MapType1Select QPMask@1 o_3@@15 val))))))
 :qid |stdinbpl.785:26|
 :skolemid |111|
...
))) (and (state ExhaleHeap@0 QPMask@6) (state ExhaleHeap@0 QPMask@6))) (and (and (|Set#Subset| s@0 vals) (state ExhaleHeap@0 QPMask@6)) (and (= j@0 (|Set#Card| (|Set#Difference| vals s@0))) (state ExhaleHeap@0 QPMask@6)))) (and (and (=> (= (ControlFlow 0 17) 7) anon53_Else_correct) (=> (= (ControlFlow 0 17) 16) anon54_Then_correct)) (=> (= (ControlFlow 0 17) 9) anon54_Else_correct)))))))))
(let ((anon52_Then_correct true))
(let ((anon49_Else_correct  (=> (and (forall ((i_11_1 T@U) ) (!  (=> (and (= (type i_11_1) intType) (U_2_bool (MapType2Select (|Set#Difference| vals vals) i_11_1))) (exists ((k_5 Int) ) (!  (and (<= 0 k_5) (and (< k_5 0) (= (U_2_int (MapType0Select Heap@@9 (loc a_3@0 k_5) val)) (U_2_int i_11_1))))
 :qid |stdinbpl.741:55|
 :skolemid |105|
 :pattern ( (loc a_3@0 k_5))
)))
 :qid |stdinbpl.739:24|
 :skolemid |106|
 :pattern ( (MapType2Select vals i_11_1))
)) (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 QPMask@1)) (and (and (and (=> (= (ControlFlow 0 41) 34) anon58_Then_correct) (=> (= (ControlFlow 0 41) 24) anon58_Else_correct)) (=> (= (ControlFlow 0 41) 6) anon52_Then_correct)) (=> (= (ControlFlow 0 41) 17) anon52_Else_correct)))))
(let ((anon17_correct true))
(let ((anon50_Else_correct  (=> (and (not (U_2_bool (MapType2Select (|Set#Difference| vals vals) (int_2_U i_10)))) (= (ControlFlow 0 5) 2)) anon17_correct)))
(let ((anon50_Then_correct  (=> (U_2_bool (MapType2Select (|Set#Difference| vals vals) (int_2_U i_10))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (exists ((k_4 Int) ) (!  (and (<= 0 k_4) (and (< k_4 0) (= (U_2_int (MapType0Select Heap@@9 (loc a_3@0 k_4) val)) i_10)))
 :qid |stdinbpl.732:23|
 :skolemid |104|
 :pattern ( (loc a_3@0 k_4))
))) (=> (exists ((k_4@@0 Int) ) (!  (and (<= 0 k_4@@0) (and (< k_4@@0 0) (= (U_2_int (MapType0Select Heap@@9 (loc a_3@0 k_4@@0) val)) i_10)))
 :qid |stdinbpl.732:23|
 :skolemid |104|
 :pattern ( (loc a_3@0 k_4@@0))
)) (=> (= (ControlFlow 0 3) 2) anon17_correct))))))
(let ((anon48_Else_correct  (and (=> (= (ControlFlow 0 42) (- 0 47)) (forall ((i_8 Int) (i_8_1 Int) ) (!  (=> (and (and (and (and (not (= i_8 i_8_1)) (and (<= 0 i_8) (< i_8 (len a_3@0)))) (and (<= 0 i_8_1) (< i_8_1 (len a_3@0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@0 i_8) (loc a_3@0 i_8_1))))
 :qid |stdinbpl.634:15|
 :skolemid |92|
))) (=> (forall ((i_8@@0 Int) (i_8_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_8@@0 i_8_1@@0)) (and (<= 0 i_8@@0) (< i_8@@0 (len a_3@0)))) (and (<= 0 i_8_1@@0) (< i_8_1@@0 (len a_3@0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@0 i_8@@0) (loc a_3@0 i_8_1@@0))))
 :qid |stdinbpl.634:15|
 :skolemid |92|
)) (=> (and (forall ((i_8@@1 Int) ) (!  (=> (and (and (<= 0 i_8@@1) (< i_8@@1 (len a_3@0))) (< NoPerm FullPerm)) (and (qpRange3 (loc a_3@0 i_8@@1)) (= (invRecv3 (loc a_3@0 i_8@@1)) i_8@@1)))
 :qid |stdinbpl.640:22|
 :skolemid |93|
 :pattern ( (loc a_3@0 i_8@@1))
 :pattern ( (loc a_3@0 i_8@@1))
)) (forall ((o_3@@17 T@U) ) (!  (=> (= (type o_3@@17) RefType) (=> (and (and (and (<= 0 (invRecv3 o_3@@17)) (< (invRecv3 o_3@@17) (len a_3@0))) (< NoPerm FullPerm)) (qpRange3 o_3@@17)) (= (loc a_3@0 (invRecv3 o_3@@17)) o_3@@17)))
 :qid |stdinbpl.644:22|
 :skolemid |94|
 :pattern ( (invRecv3 o_3@@17))
))) (=> (and (and (and (forall ((i_8@@2 Int) ) (!  (=> (and (<= 0 i_8@@2) (< i_8@@2 (len a_3@0))) (not (= (loc a_3@0 i_8@@2) null)))
 :qid |stdinbpl.650:22|
 :skolemid |95|
 :pattern ( (loc a_3@0 i_8@@2))
 :pattern ( (loc a_3@0 i_8@@2))
)) (forall ((o_3@@18 T@U) ) (!  (=> (= (type o_3@@18) RefType) (and (=> (and (and (and (<= 0 (invRecv3 o_3@@18)) (< (invRecv3 o_3@@18) (len a_3@0))) (< NoPerm FullPerm)) (qpRange3 o_3@@18)) (and (=> (< NoPerm FullPerm) (= (loc a_3@0 (invRecv3 o_3@@18)) o_3@@18)) (= (U_2_real (MapType1Select QPMask@0 o_3@@18 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@18 val)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv3 o_3@@18)) (< (invRecv3 o_3@@18) (len a_3@0))) (< NoPerm FullPerm)) (qpRange3 o_3@@18))) (= (U_2_real (MapType1Select QPMask@0 o_3@@18 val)) (U_2_real (MapType1Select ZeroMask o_3@@18 val))))))
 :qid |stdinbpl.656:22|
 :skolemid |96|
...
)) (state Heap@@9 QPMask@0))) (and (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (=> (= (ControlFlow 0 42) (- 0 46)) (forall ((i_9 Int) (i_9_1 Int) ) (!  (=> (and (and (and (and (not (= i_9 i_9_1)) (and (<= 0 i_9) (< i_9 (len a_3@0)))) (and (<= 0 i_9_1) (< i_9_1 (len a_3@0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@0 i_9) (loc a_3@0 i_9_1))))
 :qid |stdinbpl.691:21|
 :skolemid |98|
 :pattern ( (neverTriggered4 i_9) (neverTriggered4 i_9_1))
))) (=> (forall ((i_9@@0 Int) (i_9_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_9@@0 i_9_1@@0)) (and (<= 0 i_9@@0) (< i_9@@0 (len a_3@0)))) (and (<= 0 i_9_1@@0) (< i_9_1@@0 (len a_3@0)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@0 i_9@@0) (loc a_3@0 i_9_1@@0))))
 :qid |stdinbpl.691:21|
 :skolemid |98|
 :pattern ( (neverTriggered4 i_9@@0) (neverTriggered4 i_9_1@@0))
)) (and (=> (= (ControlFlow 0 42) (- 0 45)) (forall ((i_9@@1 Int) ) (!  (=> (and (<= 0 i_9@@1) (< i_9@@1 (len a_3@0))) (>= (U_2_real (MapType1Select QPMask@0 (loc a_3@0 i_9@@1) val)) FullPerm))
 :qid |stdinbpl.698:21|
 :skolemid |99|
 :pattern ( (loc a_3@0 i_9@@1))
 :pattern ( (loc a_3@0 i_9@@1))
))) (=> (forall ((i_9@@2 Int) ) (!  (=> (and (<= 0 i_9@@2) (< i_9@@2 (len a_3@0))) (>= (U_2_real (MapType1Select QPMask@0 (loc a_3@0 i_9@@2) val)) FullPerm))
 :qid |stdinbpl.698:21|
 :skolemid |99|
 :pattern ( (loc a_3@0 i_9@@2))
 :pattern ( (loc a_3@0 i_9@@2))
)) (=> (and (and (forall ((i_9@@3 Int) ) (!  (=> (and (and (<= 0 i_9@@3) (< i_9@@3 (len a_3@0))) (< NoPerm FullPerm)) (and (qpRange4 (loc a_3@0 i_9@@3)) (= (invRecv4 (loc a_3@0 i_9@@3)) i_9@@3)))
 :qid |stdinbpl.704:26|
 :skolemid |100|
 :pattern ( (loc a_3@0 i_9@@3))
 :pattern ( (loc a_3@0 i_9@@3))
)) (forall ((o_3@@20 T@U) ) (!  (=> (= (type o_3@@20) RefType) (=> (and (and (<= 0 (invRecv4 o_3@@20)) (< (invRecv4 o_3@@20) (len a_3@0))) (and (< NoPerm FullPerm) (qpRange4 o_3@@20))) (= (loc a_3@0 (invRecv4 o_3@@20)) o_3@@20)))
 :qid |stdinbpl.708:26|
 :skolemid |101|
 :pattern ( (invRecv4 o_3@@20))
))) (and (forall ((o_3@@21 T@U) ) (!  (=> (= (type o_3@@21) RefType) (and (=> (and (and (<= 0 (invRecv4 o_3@@21)) (< (invRecv4 o_3@@21) (len a_3@0))) (and (< NoPerm FullPerm) (qpRange4 o_3@@21))) (and (= (loc a_3@0 (invRecv4 o_3@@21)) o_3@@21) (= (U_2_real (MapType1Select QPMask@1 o_3@@21 val)) (- (U_2_real (MapType1Select QPMask@0 o_3@@21 val)) FullPerm)))) (=> (not (and (and (<= 0 (invRecv4 o_3@@21)) (< (invRecv4 o_3@@21) (len a_3@0))) (and (< NoPerm FullPerm) (qpRange4 o_3@@21)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@21 val)) (U_2_real (MapType1Select QPMask@0 o_3@@21 val))))))
 :qid |stdinbpl.714:26|
 :skolemid |102|
 :pattern ( (MapType1Select QPMask@1 o_3@@21 val))
)) (forall ((o_3@@22 T@U) (f_5@@6 T@U) ) (! (let ((B@@18 (FieldTypeInv1 (type f_5@@6))))
(let ((A@@19 (FieldTypeInv0 (type f_5@@6))))
 (=> (and (and (= (type o_3@@22) RefType) (= (type f_5@@6) (FieldType A@@19 B@@18))) (not (= f_5@@6 val))) (= (U_2_real (MapType1Select QPMask@0 o_3@@22 f_5@@6)) (U_2_real (MapType1Select QPMask@1 o_3@@22 f_5@@6))))))
 :qid |stdinbpl.720:33|
 :skolemid |103|
 :pattern ( (MapType1Select QPMask@1 o_3@@22 f_5@@6))
)))) (and (=> (= (ControlFlow 0 42) (- 0 44)) (|Set#Subset| vals vals)) (=> (|Set#Subset| vals vals) (and (=> (= (ControlFlow 0 42) (- 0 43)) (= 0 (|Set#Card| (|Set#Difference| vals vals)))) (=> (= 0 (|Set#Card| (|Set#Difference| vals vals))) (and (and (=> (= (ControlFlow 0 42) 41) anon49_Else_correct) (=> (= (ControlFlow 0 42) 3) anon50_Then_correct)) (=> (= (ControlFlow 0 42) 5) anon50_Else_correct)))))))))))))))))
(let ((anon48_Then_correct true))
(let ((anon41_Else_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (state Heap@@9 ZeroMask) (= (len a_3@0) (|Set#Card| vals))) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 48) 1) anon48_Then_correct) (=> (= (ControlFlow 0 48) 42) anon48_Else_correct))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 63) 62) anon41_Then_correct) (=> (= (ControlFlow 0 63) 48) anon41_Else_correct)))))
