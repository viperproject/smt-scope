...
(declare-fun i_1 () Int)
(declare-fun j_2 () Int)
(assert  (and (and (and (and (= (type xs@@10) (SeqType RefType)) (= (type ys@@5) (SeqType RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@17) (MapType0Type RefType))))
(set-info :boogie-vc-id |fun02#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 36) (let ((anon15_correct true))
(let ((anon24_Else_correct  (=> (and (not (and (<= 0 i_6) (< i_6 (|Seq#Length| ys@@5)))) (= (ControlFlow 0 30) 26)) anon15_correct)))
(let ((anon24_Then_correct  (=> (and (<= 0 i_6) (< i_6 (|Seq#Length| ys@@5))) (and (=> (= (ControlFlow 0 27) (- 0 29)) (>= i_6 0)) (=> (>= i_6 0) (and (=> (= (ControlFlow 0 27) (- 0 28)) (< i_6 (|Seq#Length| ys@@5))) (=> (< i_6 (|Seq#Length| ys@@5)) (=> (= (ControlFlow 0 27) 26) anon15_correct))))))))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 25)) (forall ((i_17 Int) (i_17_1 Int) ) (!  (=> (and (and (and (and (not (= i_17 i_17_1)) (and (<= 0 i_17) (< i_17 (|Seq#Length| ys@@5)))) (and (<= 0 i_17_1) (< i_17_1 (|Seq#Length| ys@@5)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ys@@5 i_17) (|Seq#Index| ys@@5 i_17_1))))
 :qid |stdinbpl.1092:15|
 :skolemid |147|
))) (=> (forall ((i_17@@0 Int) (i_17_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_17@@0 i_17_1@@0)) (and (<= 0 i_17@@0) (< i_17@@0 (|Seq#Length| ys@@5)))) (and (<= 0 i_17_1@@0) (< i_17_1@@0 (|Seq#Length| ys@@5)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| ys@@5 i_17@@0) (|Seq#Index| ys@@5 i_17_1@@0))))
 :qid |stdinbpl.1092:15|
 :skolemid |147|
)) (=> (and (forall ((i_17@@1 Int) ) (!  (=> (and (and (<= 0 i_17@@1) (< i_17@@1 (|Seq#Length| ys@@5))) (< NoPerm FullPerm)) (and (qpRange3 (|Seq#Index| ys@@5 i_17@@1)) (= (invRecv3 (|Seq#Index| ys@@5 i_17@@1)) i_17@@1)))
 :qid |stdinbpl.1098:22|
 :skolemid |148|
 :pattern ( (|Seq#Index| ys@@5 i_17@@1))
 :pattern ( (|Seq#Index| ys@@5 i_17@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv3 o_3)) (< (invRecv3 o_3) (|Seq#Length| ys@@5))) (< NoPerm FullPerm)) (qpRange3 o_3)) (= (|Seq#Index| ys@@5 (invRecv3 o_3)) o_3)))
 :qid |stdinbpl.1102:22|
 :skolemid |149|
 :pattern ( (invRecv3 o_3))
))) (=> (and (and (and (forall ((i_17@@2 Int) ) (!  (=> (and (<= 0 i_17@@2) (< i_17@@2 (|Seq#Length| ys@@5))) (not (= (|Seq#Index| ys@@5 i_17@@2) null)))
 :qid |stdinbpl.1108:22|
 :skolemid |150|
 :pattern ( (|Seq#Index| ys@@5 i_17@@2))
 :pattern ( (|Seq#Index| ys@@5 i_17@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv3 o_3@@0)) (< (invRecv3 o_3@@0) (|Seq#Length| ys@@5))) (< NoPerm FullPerm)) (qpRange3 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| ys@@5 (invRecv3 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv3 o_3@@0)) (< (invRecv3 o_3@@0) (|Seq#Length| ys@@5))) (< NoPerm FullPerm)) (qpRange3 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7))))))
...
)) (state Heap@@17 QPMask@1))) (and (and (state Heap@@17 QPMask@1) (< 10 (|Seq#Length| xs@@10))) (and (= (|Seq#Length| xs@@10) (|Seq#Length| ys@@5)) (state Heap@@17 QPMask@1)))) (and (=> (= (ControlFlow 0 21) (- 0 24)) (< 0 (|Seq#Length| xs@@10))) (=> (< 0 (|Seq#Length| xs@@10)) (and (=> (= (ControlFlow 0 21) (- 0 23)) (HasDirectPerm QPMask@1 (|Seq#Index| xs@@10 0) f_7)) (=> (HasDirectPerm QPMask@1 (|Seq#Index| xs@@10 0) f_7) (and (=> (= (ControlFlow 0 21) (- 0 22)) (< 0 (|Seq#Length| ys@@5))) (=> (< 0 (|Seq#Length| ys@@5)) (=> (= (ControlFlow 0 21) (- 0 20)) (HasDirectPerm QPMask@1 (|Seq#Index| ys@@5 0) f_7))))))))))))))
(let ((anon21_Else_correct  (=> (and (forall ((i_15 Int) (j_7 Int) ) (!  (=> (and (>= i_15 0) (and (< i_15 (|Seq#Length| ys@@5)) (and (>= j_7 0) (and (< j_7 (|Seq#Length| ys@@5)) (not (= i_15 j_7)))))) (not (= (|Seq#Index| ys@@5 i_15) (|Seq#Index| ys@@5 j_7))))
 :qid |stdinbpl.1074:20|
 :skolemid |146|
 :pattern ( (|Seq#Index| ys@@5 i_15) (|Seq#Index| ys@@5 j_7))
...
(let ((anon22_Else_correct  (=> (and (not (and (>= i_5 0) (and (< i_5 (|Seq#Length| ys@@5)) (and (>= j_3 0) (and (< j_3 (|Seq#Length| ys@@5)) (not (= i_5 j_3))))))) (= (ControlFlow 0 19) 13)) anon11_correct)))
(let ((anon22_Then_correct  (=> (and (>= i_5 0) (and (< i_5 (|Seq#Length| ys@@5)) (and (>= j_3 0) (and (< j_3 (|Seq#Length| ys@@5)) (not (= i_5 j_3)))))) (and (=> (= (ControlFlow 0 14) (- 0 18)) (>= i_5 0)) (=> (>= i_5 0) (and (=> (= (ControlFlow 0 14) (- 0 17)) (< i_5 (|Seq#Length| ys@@5))) (=> (< i_5 (|Seq#Length| ys@@5)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= j_3 0)) (=> (>= j_3 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< j_3 (|Seq#Length| ys@@5))) (=> (< j_3 (|Seq#Length| ys@@5)) (=> (= (ControlFlow 0 14) 13) anon11_correct))))))))))))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 32) (- 0 33)) (forall ((i_13 Int) (i_13_1 Int) ) (!  (=> (and (and (and (and (not (= i_13 i_13_1)) (and (<= 0 i_13) (< i_13 (|Seq#Length| xs@@10)))) (and (<= 0 i_13_1) (< i_13_1 (|Seq#Length| xs@@10)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@10 i_13) (|Seq#Index| xs@@10 i_13_1))))
 :qid |stdinbpl.1026:15|
 :skolemid |140|
))) (=> (forall ((i_13@@0 Int) (i_13_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_13@@0 i_13_1@@0)) (and (<= 0 i_13@@0) (< i_13@@0 (|Seq#Length| xs@@10)))) (and (<= 0 i_13_1@@0) (< i_13_1@@0 (|Seq#Length| xs@@10)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs@@10 i_13@@0) (|Seq#Index| xs@@10 i_13_1@@0))))
 :qid |stdinbpl.1026:15|
 :skolemid |140|
)) (=> (forall ((i_13@@1 Int) ) (!  (=> (and (and (<= 0 i_13@@1) (< i_13@@1 (|Seq#Length| xs@@10))) (< NoPerm FullPerm)) (and (qpRange2 (|Seq#Index| xs@@10 i_13@@1)) (= (invRecv2 (|Seq#Index| xs@@10 i_13@@1)) i_13@@1)))
 :qid |stdinbpl.1032:22|
 :skolemid |141|
 :pattern ( (|Seq#Index| xs@@10 i_13@@1))
 :pattern ( (|Seq#Index| xs@@10 i_13@@1))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (<= 0 (invRecv2 o_3@@2)) (< (invRecv2 o_3@@2) (|Seq#Length| xs@@10))) (< NoPerm FullPerm)) (qpRange2 o_3@@2)) (= (|Seq#Index| xs@@10 (invRecv2 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.1036:22|
 :skolemid |142|
 :pattern ( (invRecv2 o_3@@2))
)) (forall ((i_13@@2 Int) ) (!  (=> (and (<= 0 i_13@@2) (< i_13@@2 (|Seq#Length| xs@@10))) (not (= (|Seq#Index| xs@@10 i_13@@2) null)))
 :qid |stdinbpl.1042:22|
 :skolemid |143|
 :pattern ( (|Seq#Index| xs@@10 i_13@@2))
 :pattern ( (|Seq#Index| xs@@10 i_13@@2))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (and (<= 0 (invRecv2 o_3@@3)) (< (invRecv2 o_3@@3) (|Seq#Length| xs@@10))) (< NoPerm FullPerm)) (qpRange2 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| xs@@10 (invRecv2 o_3@@3)) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv2 o_3@@3)) (< (invRecv2 o_3@@3) (|Seq#Length| xs@@10))) (< NoPerm FullPerm)) (qpRange2 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@3 f_7))))))
...
(let ((anon20_Else_correct  (=> (and (not (and (<= 0 i_4) (< i_4 (|Seq#Length| xs@@10)))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon20_Then_correct  (=> (and (<= 0 i_4) (< i_4 (|Seq#Length| xs@@10))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_4 (|Seq#Length| xs@@10))) (=> (< i_4 (|Seq#Length| xs@@10)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon17_Else_correct  (=> (and (forall ((i_11 Int) (j_5 Int) ) (!  (=> (and (>= i_11 0) (and (< i_11 (|Seq#Length| xs@@10)) (and (>= j_5 0) (and (< j_5 (|Seq#Length| xs@@10)) (not (= i_11 j_5)))))) (not (= (|Seq#Index| xs@@10 i_11) (|Seq#Index| xs@@10 j_5))))
 :qid |stdinbpl.1008:20|
 :skolemid |139|
 :pattern ( (|Seq#Index| xs@@10 i_11) (|Seq#Index| xs@@10 j_5))
)) (state Heap@@17 ZeroMask)) (and (and (=> (= (ControlFlow 0 34) 32) anon19_Else_correct) (=> (= (ControlFlow 0 34) 9) anon20_Then_correct)) (=> (= (ControlFlow 0 34) 12) anon20_Else_correct)))))
(let ((anon3_correct true))
(let ((anon18_Else_correct  (=> (and (not (and (>= i_1 0) (and (< i_1 (|Seq#Length| xs@@10)) (and (>= j_2 0) (and (< j_2 (|Seq#Length| xs@@10)) (not (= i_1 j_2))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon18_Then_correct  (=> (and (>= i_1 0) (and (< i_1 (|Seq#Length| xs@@10)) (and (>= j_2 0) (and (< j_2 (|Seq#Length| xs@@10)) (not (= i_1 j_2)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_1 0)) (=> (>= i_1 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_1 (|Seq#Length| xs@@10))) (=> (< i_1 (|Seq#Length| xs@@10)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_2 0)) (=> (>= j_2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_2 (|Seq#Length| xs@@10))) (=> (< j_2 (|Seq#Length| xs@@10)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) (= AssumeFunctionsAbove 1)) (and (and (=> (= (ControlFlow 0 35) 34) anon17_Else_correct) (=> (= (ControlFlow 0 35) 2) anon18_Then_correct)) (=> (= (ControlFlow 0 35) 7) anon18_Else_correct)))))
