...
(declare-fun |bar01#frame| (T@U Int) Int)
...
(assert (forall ((Heap@@0 T@U) (x@@8 T@U) (i Int) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type x@@8) RefType)) (dummyFunction (bool_2_U (|fun01#triggerStateless| x@@8 i))))
 :qid |stdinbpl.198:15|
 :skolemid |23|
 :pattern ( (|fun01'| Heap@@0 x@@8 i))
)))
...
(assert (forall ((Heap@@3 T@U) (i@@0 Int) ) (!  (=> (= (type Heap@@3) (MapType0Type RefType)) (dummyFunction (int_2_U (|bar01#triggerStateless| i@@0))))
 :qid |stdinbpl.247:15|
 :skolemid |26|
 :pattern ( (|bar01'| Heap@@3 i@@0))
)))
...
(assert (forall ((Heap@@5 T@U) (i@@1 Int) ) (!  (=> (= (type Heap@@5) (MapType0Type RefType)) (and (= (bar01 Heap@@5 i@@1) (|bar01'| Heap@@5 i@@1)) (dummyFunction (int_2_U (|bar01#triggerStateless| i@@1)))))
 :qid |stdinbpl.243:15|
 :skolemid |25|
 :pattern ( (bar01 Heap@@5 i@@1))
)))
...
(assert (forall ((Heap@@10 T@U) (Mask@@9 T@U) (i@@2 Int) ) (!  (=> (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (state Heap@@10 Mask@@9)) (= (|bar01'| Heap@@10 i@@2) (|bar01#frame| EmptyFrame i@@2)))
 :qid |stdinbpl.254:15|
 :skolemid |27|
 :pattern ( (state Heap@@10 Mask@@9) (|bar01'| Heap@@10 i@@2))
)))
...
(assert (forall ((Heap@@12 T@U) (Mask@@10 T@U) (x@@9 T@U) (i@@3 Int) ) (!  (=> (and (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type x@@9) RefType)) (state Heap@@12 Mask@@10)) (= (|fun01'| Heap@@12 x@@9 i@@3) (|fun01#frame| (FrameFragment (MapType0Select Heap@@12 x@@9 f_7)) x@@9 i@@3)))
 :qid |stdinbpl.205:15|
 :skolemid |24|
 :pattern ( (state Heap@@12 Mask@@10) (|fun01'| Heap@@12 x@@9 i@@3))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@14 T@U) (x@@10 T@U) (i@@4 Int) ) (!  (=> (and (= (type Heap@@14) (MapType0Type RefType)) (= (type x@@10) RefType)) (and (= (fun01 Heap@@14 x@@10 i@@4) (|fun01'| Heap@@14 x@@10 i@@4)) (dummyFunction (bool_2_U (|fun01#triggerStateless| x@@10 i@@4)))))
 :qid |stdinbpl.194:15|
 :skolemid |22|
 :pattern ( (fun01 Heap@@14 x@@10 i@@4))
)))
(push 1)
...
(assert  (and (and (and (and (and (and (and (= (type Mask@3) (MapType1Type RefType realType)) (= (type x@@11) RefType)) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type y@@1) RefType)) (= (type Heap@@15) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test01b)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon18_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (> (bar01 ExhaleHeap@0 5) 0))))
(let ((anon18_Then_correct true))
(let ((anon16_Else_correct  (=> (fun01 ExhaleHeap@0 x@@11 5) (=> (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3)) (and (=> (= (ControlFlow 0 10) 7) anon18_Then_correct) (=> (= (ControlFlow 0 10) 9) anon18_Else_correct))))))
(let ((anon9_correct true))
(let ((anon17_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 3)) anon9_correct)))
(let ((anon17_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@3 x@@11 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 x@@11 f_7))) (=> (= (ControlFlow 0 4) 3) anon9_correct))))))
(let ((anon6_correct  (=> (= Mask@2 (MapType1Store Mask@1 y@@1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 y@@1 f_7)) FullPerm)))) (=> (and (and (and (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)) (and (not (= y@@1 null)) (= Mask@3 (MapType1Store Mask@2 y@@1 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@2 y@@1 f_7)) FullPerm)))))) (and (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3)) (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3)))) (and (and (=> (= (ControlFlow 0 11) 10) anon16_Else_correct) (=> (= (ControlFlow 0 11) 4) anon17_Then_correct)) (=> (= (ControlFlow 0 11) 6) anon17_Else_correct))))))
(let ((anon15_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 14) 11)) anon6_correct)))
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (U_2_real (MapType1Select Mask@1 y@@1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 y@@1 f_7))) (=> (= (ControlFlow 0 12) 11) anon6_correct))))))
(let ((anon13_Else_correct  (=> (forall ((i_1 Int) ) (! (> (bar01 Heap@@15 i_1) 0)
 :qid |stdinbpl.451:20|
 :skolemid |29|
 :pattern ( (|fun01#frame| (FrameFragment (MapType0Select Heap@@15 x@@11 f_7)) x@@11 i_1))
)) (=> (and (state Heap@@15 Mask@1) (state Heap@@15 Mask@1)) (and (=> (= (ControlFlow 0 15) 12) anon15_Then_correct) (=> (= (ControlFlow 0 15) 14) anon15_Else_correct))))))
(let ((anon14_Else_correct true))
(let ((anon14_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@15 x@@11 $allocated)) (U_2_bool (MapType0Select Heap@@15 y@@1 $allocated)))) (=> (and (and (and (not (= x@@11 null)) (= Mask@0 (MapType1Store ZeroMask x@@11 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@11 f_7)) FullPerm))))) (and (state Heap@@15 Mask@0) (not (= y@@1 null)))) (and (and (= Mask@1 (MapType1Store Mask@0 y@@1 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@1 f_7)) FullPerm)))) (state Heap@@15 Mask@1)) (and (state Heap@@15 Mask@1) (state Heap@@15 Mask@1)))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (not (= x@@11 y@@1))) (=> (not (= x@@11 y@@1)) (=> (and (state Heap@@15 Mask@1) (state Heap@@15 Mask@1)) (and (and (=> (= (ControlFlow 0 16) 15) anon13_Else_correct) (=> (= (ControlFlow 0 16) 1) anon14_Then_correct)) (=> (= (ControlFlow 0 16) 2) anon14_Else_correct)))))))))
