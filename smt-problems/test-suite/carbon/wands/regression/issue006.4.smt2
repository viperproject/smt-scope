...
(assert  (and (and (and (and (and (and (= (type Ops_13Heap@0) (MapType0Type RefType)) (= (type Used_13Heap@0) (MapType0Type RefType))) (= (type xs@@3) (SeqType intType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@13) (MapType0Type RefType))) (= (type ys@0) (SeqType intType))) (= (type Used_12Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test06)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (= b_21@1  (and b_21@0 (state Ops_13Heap@0 ZeroMask))) (=> (and (= b_21@2  (and b_21@1 (state Ops_13Heap@0 ZeroMask))) (= b_22@0  (and b_22 (state Used_13Heap@0 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (and (and b_21@2 b_21@2) b_22@0) (= (|Seq#Length| xs@@3) n@@13))) (=> (=> (and (and b_21@2 b_21@2) b_22@0) (= (|Seq#Length| xs@@3) n@@13)) (=> (= Mask@0 (MapType1Store ZeroMask null (wand true (= (|Seq#Length| xs@@3) n@@13)) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (wand true (= (|Seq#Length| xs@@3) n@@13)))) FullPerm)))) (=> (and (state Heap@@13 Mask@0) (state Heap@@13 Mask@0)) (=> (and (and (state Heap@@13 Mask@0) (= ys@0 (|Seq#Append| xs@@3 (|Seq#Singleton| (int_2_U n@@13))))) (and (state Heap@@13 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (wand true (= (|Seq#Length| ys@0) (+ n@@13 1)))))))))))))))
(let ((anon3_Else_correct  (=> (and (not b_21@0) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and b_21@0 (= (ControlFlow 0 4) 2)) anon2_correct)))
(let ((anon0_correct  (=> (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (= (|Seq#Length| xs@@3) n@@13) (state Heap@@13 ZeroMask)) (and (= b_21@0  (and b_21 (state Ops_13Heap@0 ZeroMask))) (= b_20@0  (and b_20 (state Used_12Heap@0 ZeroMask))))) (and (=> (= (ControlFlow 0 6) 4) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))
