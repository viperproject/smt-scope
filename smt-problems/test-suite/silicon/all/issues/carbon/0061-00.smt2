(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 19:46:47
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/issues/carbon/0061.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (Producervalid$%trigger $Snap.unit this@1@01))
(pop) ; 2
(pop) ; 1
; ---------- Consumerinit$ ----------
...
(assert (Consumervalid$%trigger $Snap.unit this@5@01))
(pop) ; 2
(pop) ; 1
