...
(declare-fun TestP$ (T@U) T@U)
(declare-fun PredicateType_TestP$Type () T@T)
(declare-fun |TestP$#trigger| (T@U T@U) Bool)
(declare-fun |TestP$#everUsed| (T@U) Bool)
(declare-fun |TestP$#sm| (T@U) T@U)
...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type Testx$) (FieldType NormalFieldType intType))))
(assert (distinct $allocated Testx$)
)
...
(assert  (and (= (Ctor PredicateType_TestP$Type) 12) (forall ((arg0@@25 T@U) ) (! (= (type (TestP$ arg0@@25)) (FieldType PredicateType_TestP$Type FrameTypeType))
 :qid |funType:TestP$|
 :pattern ( (TestP$ arg0@@25))
))))
(assert (forall ((this T@U) ) (!  (=> (= (type this) RefType) (IsPredicateField (TestP$ this)))
 :qid |stdinbpl.194:15|
 :skolemid |23|
 :pattern ( (TestP$ this))
)))
(assert (forall ((Heap@@2 T@U) (this@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type this@@0) RefType)) (|TestP$#everUsed| (TestP$ this@@0)))
 :qid |stdinbpl.213:15|
 :skolemid |27|
 :pattern ( (|TestP$#trigger| Heap@@2 (TestP$ this@@0)))
)))
...
(assert (forall ((this@@1 T@U) (this2 T@U) ) (!  (=> (and (and (= (type this@@1) RefType) (= (type this2) RefType)) (= (TestP$ this@@1) (TestP$ this2))) (= this@@1 this2))
 :qid |stdinbpl.204:15|
 :skolemid |25|
 :pattern ( (TestP$ this@@1) (TestP$ this2))
)))
(assert (forall ((arg0@@26 T@U) ) (! (= (type (|TestP$#sm| arg0@@26)) (FieldType PredicateType_TestP$Type (MapType1Type RefType boolType)))
 :qid |funType:TestP$#sm|
 :pattern ( (|TestP$#sm| arg0@@26))
)))
(assert (forall ((this@@2 T@U) (this2@@0 T@U) ) (!  (=> (and (and (= (type this@@2) RefType) (= (type this2@@0) RefType)) (= (|TestP$#sm| this@@2) (|TestP$#sm| this2@@0))) (= this@@2 this2@@0))
 :qid |stdinbpl.208:15|
 :skolemid |26|
...
(assert (forall ((this@@3 T@U) ) (!  (=> (= (type this@@3) RefType) (= (getPredWandId (TestP$ this@@3)) 0))
 :qid |stdinbpl.198:15|
 :skolemid |24|
...
(assert (forall ((this@@4 T@U) ) (!  (=> (= (type this@@4) RefType) (= (PredicateMaskField (TestP$ this@@4)) (|TestP$#sm| this@@4)))
 :qid |stdinbpl.190:15|
 :skolemid |22|
 :pattern ( (PredicateMaskField (TestP$ this@@4)))
)))
...
(declare-fun k$ () Real)
(assert  (and (and (and (and (and (and (and (and (and (and (= (type UnfoldingMask@0) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type this@@5) RefType)) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (forall ((arg0@@28 T@U) ) (! (= (type (FrameFragment arg0@@28)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@28))
))) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@3) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id Testfail10$)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon3_correct  (=> (= UnfoldingMask@2 (MapType1Store PostMask@0 null (TestP$ this@@5) (real_2_U (- (U_2_real (MapType1Select PostMask@0 null (TestP$ this@@5))) FullPerm)))) (=> (and (and (not (= this@@5 null)) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 this@@5 Testx$ (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 this@@5 Testx$)) FullPerm))))) (and (state PostHeap@0 UnfoldingMask@3) (state PostHeap@0 UnfoldingMask@3))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm UnfoldingMask@3 this@@5 Testx$)) (=> (HasDirectPerm UnfoldingMask@3 this@@5 Testx$) (=> (= (ControlFlow 0 11) (- 0 10)) (HasDirectPerm Mask@0 this@@5 Testx$))))))))
(let ((anon10_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 15) 11)) anon3_correct)))
(let ((anon10_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (TestP$ this@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select PostMask@0 null (TestP$ this@@5)))) (=> (= (ControlFlow 0 13) 11) anon3_correct))))))
(let ((anon9_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (= PostMask@0 (MapType1Store ZeroMask null (TestP$ this@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (TestP$ this@@5))) FullPerm))))) (=> (and (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0)) (and (|TestP$#trigger| PostHeap@0 (TestP$ this@@5)) (= (MapType0Select PostHeap@0 null (TestP$ this@@5)) (FrameFragment (MapType0Select PostHeap@0 this@@5 Testx$))))) (and (=> (= (ControlFlow 0 16) 13) anon10_Then_correct) (=> (= (ControlFlow 0 16) 15) anon10_Else_correct))))))
(let ((anon8_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (TestP$ this@@5) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (TestP$ this@@5))) FullPerm)))) (not (= this@@5 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this@@5 Testx$ (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this@@5 Testx$)) FullPerm)))) (state Heap@@10 UnfoldingMask@1)) (and (state Heap@@10 UnfoldingMask@1) (= (ControlFlow 0 2) (- 0 1)))) (= (U_2_int (MapType0Select Heap@@10 this@@5 Testx$)) (U_2_int (MapType0Select Heap@@10 this@@5 Testx$)))))))
(let ((anon12_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon8_correct)))
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (TestP$ this@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (TestP$ this@@5)))) (=> (= (ControlFlow 0 3) 2) anon8_correct))))))
(let ((anon6_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (TestP$ this@@5) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (TestP$ this@@5))) FullPerm)))) (=> (and (|TestP$#trigger| Heap@@10 (TestP$ this@@5)) (= (MapType0Select Heap@@10 null (TestP$ this@@5)) (FrameFragment (MapType0Select Heap@@10 this@@5 Testx$)))) (and (=> (= (ControlFlow 0 6) 3) anon12_Then_correct) (=> (= (ControlFlow 0 6) 5) anon12_Else_correct))))))
(let ((anon11_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon6_correct)))
(let ((anon11_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (TestP$ this@@5))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (TestP$ this@@5)))) (=> (= (ControlFlow 0 7) 6) anon6_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 this@@5 $allocated)) (not (= this@@5 null))) (=> (and (and (and (state Heap@@10 ZeroMask) (< NoPerm k$)) (and (state Heap@@10 ZeroMask) (< k$ FullPerm))) (and (and (state Heap@@10 ZeroMask) (= Mask@0 (MapType1Store ZeroMask null (TestP$ this@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (TestP$ this@@5))) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)))) (and (and (=> (= (ControlFlow 0 17) 16) anon9_Then_correct) (=> (= (ControlFlow 0 17) 7) anon11_Then_correct)) (=> (= (ControlFlow 0 17) 9) anon11_Else_correct)))))))
