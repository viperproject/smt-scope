(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:17:12
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0081.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (forall ((i1@3@01 Int) (i2@4@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length S@1@01)) i1@3@01) (Seq_contains_trigger
    (Seq_range 0 (Seq_length S@1@01))
    i2@4@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0081.vpr@7@12@7@105-aux|)))
(assert (forall ((i1@3@01 Int) (i2@4@01 Int)) (!
  (and
    (=>
      (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i1@3@01)
...
(assert (forall ((i1@3@01 Int) (i2@4@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length S@1@01)) i2@4@01) (Seq_index
    ...
    i1@3@01))
  :pattern ((Seq_index S@1@01 i1@3@01) (Seq_index S@1@01 i2@4@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0081.vpr@7@12@7@105|)))
...
(assert (=>
  (ite
    ...
    false)
  (=
    ($FVF.lookup_f (as sm@16@01  $FVF<f>) (Seq_index S@1@01 0))
    ($FVF.lookup_f ($SortWrappers.$SnapTo$FVF<f> ($Snap.second $t@2@01)) (Seq_index
      S@1@01
      0)))))
; [exec]
...
; [eval] |S| - 2
; [eval] |S|
(assert (Seq_contains (Seq_range 0 (- (Seq_length S@1@01) 2)) i1@17@01))
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i1@17@01 (Seq_length S@1@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
; Nested auxiliary terms: non-globals
(push) ; 4
(assert (not (forall ((i1@17@01 Int)) (!
  (=>
    (Seq_contains (Seq_range 0 (- (Seq_length S@1@01) 2)) i1@17@01)
    (or (= $k@18@01 $Perm.No) (< $Perm.No $k@18@01)))
...
; Check receiver injectivity
(push) ; 4
(assert (not (forall ((i11@17@01 Int) (i12@17@01 Int)) (!
  (=>
    (and
      (and
        (Seq_contains (Seq_range 0 (- (Seq_length S@1@01) 2)) i11@17@01)
        (< $Perm.No $k@18@01))
      (and
        (Seq_contains (Seq_range 0 (- (Seq_length S@1@01) 2)) i12@17@01)
        (< $Perm.No $k@18@01))
      (= (Seq_index S@1@01 i11@17@01) (Seq_index S@1@01 i12@17@01)))
    (= i11@17@01 i12@17@01))
...
; (get-info :all-statistics)
; Definitional axioms for inverse functions
(assert (forall ((i1@17@01 Int)) (!
  (=>
    (and
      (Seq_contains (Seq_range 0 (- (Seq_length S@1@01) 2)) i1@17@01)
      (< $Perm.No $k@18@01))
    (and
      (= (inv@19@01 (Seq_index S@1@01 i1@17@01)) i1@17@01)
      (img@20@01 (Seq_index S@1@01 i1@17@01))))
  :pattern ((Seq_index S@1@01 i1@17@01))
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@20@01 r)
      (and
        (Seq_contains (Seq_range 0 (- (Seq_length S@1@01) 2)) (inv@19@01 r))
        (< $Perm.No $k@18@01)))
    (= (Seq_index S@1@01 (inv@19@01 r)) r))
  :pattern ((inv@19@01 r))
  :qid |f-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@21@01 ((r $Ref)) $Perm
  (ite
    (and
      (Seq_contains (Seq_range 0 (- (Seq_length S@1@01) 2)) (inv@19@01 r))
      (img@20@01 r)
      (= r (Seq_index S@1@01 (inv@19@01 r))))
    ($Perm.min
      (ite
        (and
          (img@8@01 r)
...
(check-sat)
; unknown
; Constrain original permissions $k@18@01
(assert (forall ((r $Ref)) (!
  (=>
    (not
      (=
  ...
  :pattern ((img@20@01 r))
  :pattern ((Seq_index S@1@01 (inv@19@01 r)))
  :qid |qp.srp2|)))
; Intermediate check if already taken enough permissions
(set-option :timeout 0)
(push) ; 4
...
(assert (not (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (img@20@01 r)
      (= r (Seq_index S@1@01 (inv@19@01 r))))
    (= (- $k@18@01 (pTaken@21@01 r)) $Perm.No))
...
; [eval] [0..|S|)
; [eval] |S|
(assert (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i2@23@01))
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i2@23@01 (Seq_length S@1@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
(assert (not (forall ((i2@23@01 Int)) (!
  (=>
    (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i2@23@01)
    (or (= $k@24@01 $Perm.No) (< $Perm.No $k@24@01)))
...
(assert (not (forall ((i21@23@01 Int) (i22@23@01 Int)) (!
  (=>
    (and
      (and
        (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i21@23@01)
        (< $Perm.No $k@24@01))
      (and
        (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i22@23@01)
        (< $Perm.No $k@24@01))
      (= (Seq_index S@1@01 i21@23@01) (Seq_index S@1@01 i22@23@01)))
    (= i21@23@01 i22@23@01))
...
(assert (forall ((i2@23@01 Int)) (!
  (=>
    (and
      ...
      (< $Perm.No $k@24@01))
    (and
      (= (inv@25@01 (Seq_index S@1@01 i2@23@01)) i2@23@01)
      (img@26@01 (Seq_index S@1@01 i2@23@01))))
  :pattern ((Seq_index S@1@01 i2@23@01))
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@26@01 r)
      (and
        (Seq_contains (Seq_range 0 (Seq_length S@1@01)) (inv@25@01 r))
        (< $Perm.No $k@24@01)))
    (= (Seq_index S@1@01 (inv@25@01 r)) r))
  :pattern ((inv@25@01 r))
  :qid |f-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@27@01 ((r $Ref)) $Perm
  (ite
    (and
      (Seq_contains (Seq_range 0 (Seq_length S@1@01)) (inv@25@01 r))
      (img@26@01 r)
      (= r (Seq_index S@1@01 (inv@25@01 r))))
    ($Perm.min
      (ite
        (and
          (img@8@01 r)
          (Seq_contains (Seq_range 0 (Seq_length S@1@01)) (inv@7@01 r)))
        (- (- $k@6@01 (pTaken@15@01 r)) (pTaken@21@01 r))
        $Perm.No)
      $k@24@01)
    $Perm.No))
; Done precomputing, updating quantified chunks
...
(assert (forall ((r $Ref)) (!
  ...
  :pattern ((Seq_contains (Seq_range 0 (Seq_length S@1@01)) (inv@7@01 r)))
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length S@1@01)) (inv@7@01 r)))
  :pattern ((Seq_contains (Seq_range 0 (Seq_length S@1@01)) (inv@25@01 r)))
  :pattern ((Seq_contains_trigger
    (Seq_range 0 (Seq_length S@1@01))
    (inv@25@01 r)))
  :pattern ((img@26@01 r))
  :pattern ((Seq_index S@1@01 (inv@25@01 r)))
  :qid |qp.srp4|)))
; Intermediate check if already taken enough permissions
(set-option :timeout 0)
(push) ; 4
...
(assert (not (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (img@26@01 r)
      (= r (Seq_index S@1@01 (inv@25@01 r))))
    (= (- $k@24@01 (pTaken@27@01 r)) $Perm.No))
  ...
  (=>
    (ite
      (and
        (img@8@01 r)
        (Seq_contains (Seq_range 0 (Seq_length S@1@01)) (inv@7@01 r)))
      (< $Perm.No (- (- $k@6@01 (pTaken@15@01 r)) (pTaken@21@01 r)))
      false)
    (=
...
; [eval] [0..|S|)
; [eval] |S|
(assert (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i@29@01))
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i@29@01 (Seq_length S@1@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
(assert (not (forall ((i@29@01 Int)) (!
  (=>
    (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i@29@01)
...
(assert (not (forall ((i1@29@01 Int) (i2@29@01 Int)) (!
  (=>
    (and
      (and
        (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i1@29@01)
        (< $Perm.No $k@30@01))
      (and
        (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i2@29@01)
        (< $Perm.No $k@30@01))
      (= (Seq_index S@1@01 i1@29@01) (Seq_index S@1@01 i2@29@01)))
    (= i1@29@01 i2@29@01))
...
(assert (forall ((i@29@01 Int)) (!
  (=>
    (and
      ...
      (< $Perm.No $k@30@01))
    (and
      (= (inv@31@01 (Seq_index S@1@01 i@29@01)) i@29@01)
      (img@32@01 (Seq_index S@1@01 i@29@01))))
  :pattern ((Seq_index S@1@01 i@29@01))
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@32@01 r)
      (and
        (Seq_contains (Seq_range 0 (Seq_length S@1@01)) (inv@31@01 r))
        (< $Perm.No $k@30@01)))
    (= (Seq_index S@1@01 (inv@31@01 r)) r))
  :pattern ((inv@31@01 r))
  :qid |f-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@33@01 ((r $Ref)) $Perm
  (ite
    (and
      (Seq_contains (Seq_range 0 (Seq_length S@1@01)) (inv@31@01 r))
      (img@32@01 r)
      (= r (Seq_index S@1@01 (inv@31@01 r))))
    ($Perm.min
      (ite
        (and
          (img@8@01 r)
          (Seq_contains (Seq_range 0 (Seq_length S@1@01)) (inv@7@01 r)))
        (- (- (- $k@6@01 (pTaken@15@01 r)) (pTaken@21@01 r)) (pTaken@27@01 r))
        $Perm.No)
      $k@30@01)
    $Perm.No))
; Done precomputing, updating quantified chunks
...
(check-sat)
; unknown
; Constrain original permissions $k@30@01
(assert (forall ((r $Ref)) (!
  (=>
    (not
      (=
  ...
  :pattern ((Seq_contains (Seq_range 0 (Seq_length S@1@01)) (inv@7@01 r)))
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length S@1@01)) (inv@7@01 r)))
  :pattern ((Seq_contains (Seq_range 0 (Seq_length S@1@01)) (inv@31@01 r)))
  :pattern ((Seq_contains_trigger
    (Seq_range 0 (Seq_length S@1@01))
    (inv@31@01 r)))
  :pattern ((img@32@01 r))
  :pattern ((Seq_index S@1@01 (inv@31@01 r)))
  :qid |qp.srp6|)))
; Intermediate check if already taken enough permissions
(set-option :timeout 0)
(push) ; 4
...
(assert (not (forall ((r $Ref)) (!
  (=>
    (and
      ...
      (img@32@01 r)
      (= r (Seq_index S@1@01 (inv@31@01 r))))
    (= (- $k@30@01 (pTaken@33@01 r)) $Perm.No))
...
; [eval] |S| - 2
; [eval] |S|
(assert (Seq_contains (Seq_range 0 (- (Seq_length S@1@01) 2)) i1@35@01))
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i1@35@01 (Seq_length S@1@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
(assert (not (forall ((i1@35@01 Int)) (!
  (=>
    (Seq_contains (Seq_range 0 (- (Seq_length S@1@01) 2)) i1@35@01)
...
(assert (not (forall ((i11@35@01 Int) (i12@35@01 Int)) (!
  (=>
    (and
      (and
        (Seq_contains (Seq_range 0 (- (Seq_length S@1@01) 2)) i11@35@01)
        (< $Perm.No $k@36@01))
      (and
        (Seq_contains (Seq_range 0 (- (Seq_length S@1@01) 2)) i12@35@01)
        (< $Perm.No $k@36@01))
      (= (Seq_index S@1@01 i11@35@01) (Seq_index S@1@01 i12@35@01)))
    (= i11@35@01 i12@35@01))
...
(assert (forall ((i1@35@01 Int)) (!
  (=>
    (and
      ...
      (< $Perm.No $k@36@01))
    (and
      (= (inv@37@01 (Seq_index S@1@01 i1@35@01)) i1@35@01)
      (img@38@01 (Seq_index S@1@01 i1@35@01))))
  :pattern ((Seq_index S@1@01 i1@35@01))
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@38@01 r)
      (and
        (Seq_contains (Seq_range 0 (- (Seq_length S@1@01) 2)) (inv@37@01 r))
        (< $Perm.No $k@36@01)))
    (= (Seq_index S@1@01 (inv@37@01 r)) r))
  :pattern ((inv@37@01 r))
  :qid |f-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@39@01 ((r $Ref)) $Perm
  (ite
    (and
      (Seq_contains (Seq_range 0 (- (Seq_length S@1@01) 2)) (inv@37@01 r))
      (img@38@01 r)
      (= r (Seq_index S@1@01 (inv@37@01 r))))
    ($Perm.min
      (ite
        (and
          (img@8@01 r)
...
(assert (forall ((r $Ref)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length S@1@01)) (inv@7@01 r)))
  :pattern ((img@38@01 r))
  :pattern ((Seq_index S@1@01 (inv@37@01 r)))
  :qid |qp.srp8|)))
; Intermediate check if already taken enough permissions
(set-option :timeout 0)
(push) ; 4
...
; [eval] [0..|S|)
; [eval] |S|
(assert (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i2@41@01))
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i2@41@01 (Seq_length S@1@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
(assert (not (forall ((i21@41@01 Int) (i22@41@01 Int)) (!
  (=>
    (and
      (and
        (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i21@41@01)
        (< $Perm.No $k@42@01))
      (and
        (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i22@41@01)
        (< $Perm.No $k@42@01))
      (= (Seq_index S@1@01 i21@41@01) (Seq_index S@1@01 i22@41@01)))
    (= i21@41@01 i22@41@01))
...
(assert (forall ((i2@41@01 Int)) (!
  (=>
    (and
      ...
      (< $Perm.No $k@42@01))
    (and
      (= (inv@43@01 (Seq_index S@1@01 i2@41@01)) i2@41@01)
      (img@44@01 (Seq_index S@1@01 i2@41@01))))
  :pattern ((Seq_index S@1@01 i2@41@01))
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
...
; [eval] [0..|S|)
; [eval] |S|
(assert (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i@47@01))
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (< i@47@01 (Seq_length S@1@01))))
(check-sat)
; unsat
(pop) ; 5
; 0,00s
...
(assert (not (forall ((i@47@01 Int)) (!
  (=>
    (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i@47@01)
...
(assert (not (forall ((i1@47@01 Int) (i2@47@01 Int)) (!
  (=>
    (and
      (and
        (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i1@47@01)
        (< $Perm.No $k@48@01))
      (and
        (Seq_contains (Seq_range 0 (Seq_length S@1@01)) i2@47@01)
        (< $Perm.No $k@48@01))
      (= (Seq_index S@1@01 i1@47@01) (Seq_index S@1@01 i2@47@01)))
    (= i1@47@01 i2@47@01))
...
(assert (forall ((i@47@01 Int)) (!
  (=>
    (and
      ...
      (< $Perm.No $k@48@01))
    (and
      (= (inv@49@01 (Seq_index S@1@01 i@47@01)) i@47@01)
      (img@50@01 (Seq_index S@1@01 i@47@01))))
  :pattern ((Seq_index S@1@01 i@47@01))
  :qid |f-invOfFct|)))
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@50@01 r)
      (and
        (Seq_contains (Seq_range 0 (Seq_length S@1@01)) (inv@49@01 r))
        (< $Perm.No $k@48@01)))
    (= (Seq_index S@1@01 (inv@49@01 r)) r))
  :pattern ((inv@49@01 r))
  :qid |f-fctOfInv|)))
; Precomputing data for removing quantified permissions
(define-fun pTaken@51@01 ((r $Ref)) $Perm
  (ite
    (and
      (Seq_contains (Seq_range 0 (Seq_length S@1@01)) (inv@49@01 r))
      (img@50@01 r)
      (= r (Seq_index S@1@01 (inv@49@01 r))))
    ($Perm.min
      (ite
        (and
          (img@8@01 r)
          (Seq_contains (Seq_range 0 (Seq_length S@1@01)) (inv@7@01 r)))
        (- (- $k@6@01 (pTaken@39@01 r)) (pTaken@45@01 r))
        $Perm.No)
      $k@48@01)
    $Perm.No))
; Done precomputing, updating quantified chunks
...
(assert (forall ((r $Ref)) (!
  ...
  :pattern ((Seq_contains (Seq_range 0 (Seq_length S@1@01)) (inv@7@01 r)))
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length S@1@01)) (inv@7@01 r)))
  :pattern ((Seq_contains (Seq_range 0 (Seq_length S@1@01)) (inv@49@01 r)))
  :pattern ((Seq_contains_trigger
    (Seq_range 0 (Seq_length S@1@01))
    (inv@49@01 r)))
  :pattern ((img@50@01 r))
  :pattern ((Seq_index S@1@01 (inv@49@01 r)))
  :qid |qp.srp12|)))
; Intermediate check if already taken enough permissions
(set-option :timeout 0)
(push) ; 4
  ...
  (=>
    (ite
      (and
        (img@8@01 r)
        (Seq_contains (Seq_range 0 (Seq_length S@1@01)) (inv@7@01 r)))
      (< $Perm.No (- (- $k@6@01 (pTaken@39@01 r)) (pTaken@45@01 r)))
      false)
    (=
