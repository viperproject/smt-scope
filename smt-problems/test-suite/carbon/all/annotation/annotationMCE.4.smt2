...
(assert  (and (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type r1) RefType)) (= (type r2) RefType)) (= (type r3) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id disjAlias3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 r1 $allocated)) (U_2_bool (MapType0Select Heap@@9 r2 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@9 r3 $allocated)) (not (= r1 null))) (and (= Mask@0 (MapType1Store ZeroMask r1 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r1 f_7)) FullPerm)))) (state Heap@@9 Mask@0))) (=> (and (and (and (state Heap@@9 Mask@0) (not (= r2 null))) (and (= Mask@1 (MapType1Store Mask@0 r2 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 r2 f_7)) FullPerm)))) (state Heap@@9 Mask@1))) (and (and (state Heap@@9 Mask@1) (or (= r3 r1) (= r3 r2))) (and (state Heap@@9 Mask@1) (= (ControlFlow 0 2) (- 0 1))))) (= FullPerm (U_2_real (MapType1Select Mask@1 r3 f_7)))))))))
