...
(declare-fun |fun#condqp1| (T@U T@U) Int)
...
(declare-fun |fun_impl#condqp2| (T@U T@U) Int)
...
(declare-fun fun_impl (T@U T@U) Int)
...
(declare-fun |fun'| (T@U T@U) Int)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |fun#triggerStateless| (T@U) Int)
(declare-fun |fun_impl'| (T@U T@U) Int)
(declare-fun |fun_impl#triggerStateless| (T@U) Int)
...
(declare-fun |fun#frame| (T@U T@U) Int)
(declare-fun FrameFragment (T@U) T@U)
(declare-fun |fun_impl#frame| (T@U T@U) Int)
...
(assert  (and (and (and (and (and (and (and (forall ((arg0@@17 T@T) ) (! (= (Ctor (MapType0Type arg0@@17)) 9)
...
(= (type (MapType0Store arg0@@20 arg1@@4 arg2@@0 arg3)) (MapType0Type aVar0)))
 ...
 :weight 0
)))) (= (Ctor RefType) 10)) (forall ((arg0@@21 T@U) (arg1@@5 Int) ) (! (let ((T@@1 (SeqTypeInv0 (type arg0@@21))))
(= (type (|Seq#Index| arg0@@21 arg1@@5)) T@@1))
 :qid |funType:Seq#Index|
 :pattern ( (|Seq#Index| arg0@@21 arg1@@5))
))))
(assert (forall ((Heap2Heap T@U) (Heap1Heap T@U) (xs T@U) ) (!  (=> (and (and (and (= (type Heap2Heap) (MapType0Type RefType)) (= (type Heap1Heap) (MapType0Type RefType))) (= (type xs) (SeqType RefType))) (and (=  (and (and (<= 0 (|sk_fun#condqp1| (|fun#condqp1| Heap2Heap xs) (|fun#condqp1| Heap1Heap xs))) (< (|sk_fun#condqp1| (|fun#condqp1| Heap2Heap xs) (|fun#condqp1| Heap1Heap xs)) (|Seq#Length| xs))) (< NoPerm FullPerm))  (and (and (<= 0 (|sk_fun#condqp1| (|fun#condqp1| Heap2Heap xs) (|fun#condqp1| Heap1Heap xs))) (< (|sk_fun#condqp1| (|fun#condqp1| Heap2Heap xs) (|fun#condqp1| Heap1Heap xs)) (|Seq#Length| xs))) (< NoPerm FullPerm))) (=> (and (and (<= 0 (|sk_fun#condqp1| (|fun#condqp1| Heap2Heap xs) (|fun#condqp1| Heap1Heap xs))) (< (|sk_fun#condqp1| (|fun#condqp1| Heap2Heap xs) (|fun#condqp1| Heap1Heap xs)) (|Seq#Length| xs))) (< NoPerm FullPerm)) (= (U_2_int (MapType0Select Heap2Heap (|Seq#Index| xs (|sk_fun#condqp1| (|fun#condqp1| Heap2Heap xs) (|fun#condqp1| Heap1Heap xs))) f_7)) (U_2_int (MapType0Select Heap1Heap (|Seq#Index| xs (|sk_fun#condqp1| (|fun#condqp1| Heap2Heap xs) (|fun#condqp1| Heap1Heap xs))) f_7)))))) (= (|fun#condqp1| Heap2Heap xs) (|fun#condqp1| Heap1Heap xs)))
 :qid |stdinbpl.622:15|
 :skolemid |63|
 :pattern ( (|fun#condqp1| Heap2Heap xs) (|fun#condqp1| Heap1Heap xs) (succHeapTrans Heap2Heap Heap1Heap))
)))
(assert (forall ((Heap2Heap@@0 T@U) (Heap1Heap@@0 T@U) (xs@@0 T@U) ) (!  (=> (and (and (and (= (type Heap2Heap@@0) (MapType0Type RefType)) (= (type Heap1Heap@@0) (MapType0Type RefType))) (= (type xs@@0) (SeqType RefType))) (and (=  (and (and (<= 0 (|sk_fun_impl#condqp2| (|fun_impl#condqp2| Heap2Heap@@0 xs@@0) (|fun_impl#condqp2| Heap1Heap@@0 xs@@0))) (< (|sk_fun_impl#condqp2| (|fun_impl#condqp2| Heap2Heap@@0 xs@@0) (|fun_impl#condqp2| Heap1Heap@@0 xs@@0)) (|Seq#Length| xs@@0))) (< NoPerm FullPerm))  (and (and (<= 0 (|sk_fun_impl#condqp2| (|fun_impl#condqp2| Heap2Heap@@0 xs@@0) (|fun_impl#condqp2| Heap1Heap@@0 xs@@0))) (< (|sk_fun_impl#condqp2| (|fun_impl#condqp2| Heap2Heap@@0 xs@@0) (|fun_impl#condqp2| Heap1Heap@@0 xs@@0)) (|Seq#Length| xs@@0))) (< NoPerm FullPerm))) (=> (and (and (<= 0 (|sk_fun_impl#condqp2| (|fun_impl#condqp2| Heap2Heap@@0 xs@@0) (|fun_impl#condqp2| Heap1Heap@@0 xs@@0))) (< (|sk_fun_impl#condqp2| (|fun_impl#condqp2| Heap2Heap@@0 xs@@0) (|fun_impl#condqp2| Heap1Heap@@0 xs@@0)) (|Seq#Length| xs@@0))) (< NoPerm FullPerm)) (= (U_2_int (MapType0Select Heap2Heap@@0 (|Seq#Index| xs@@0 (|sk_fun_impl#condqp2| (|fun_impl#condqp2| Heap2Heap@@0 xs@@0) (|fun_impl#condqp2| Heap1Heap@@0 xs@@0))) f_7)) (U_2_int (MapType0Select Heap1Heap@@0 (|Seq#Index| xs@@0 (|sk_fun_impl#condqp2| (|fun_impl#condqp2| Heap2Heap@@0 xs@@0) (|fun_impl#condqp2| Heap1Heap@@0 xs@@0))) f_7)))))) (= (|fun_impl#condqp2| Heap2Heap@@0 xs@@0) (|fun_impl#condqp2| Heap1Heap@@0 xs@@0)))
 :qid |stdinbpl.832:15|
 :skolemid |83|
 :pattern ( (|fun_impl#condqp2| Heap2Heap@@0 xs@@0) (|fun_impl#condqp2| Heap1Heap@@0 xs@@0) (succHeapTrans Heap2Heap@@0 Heap1Heap@@0))
)))
...
)))) (= (fun_impl Heap@@0 xs@@1) (U_2_int (MapType0Select Heap@@0 (|Seq#Index| xs@@1 0) f_7))))
 :qid |stdinbpl.812:15|
 :skolemid |81|
 :pattern ( (state Heap@@0 Mask@@0) (fun_impl Heap@@0 xs@@1))
)))
...
(assert (forall ((Heap@@3 T@U) (xs@@2 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type xs@@2) (SeqType RefType))) (dummyFunction (int_2_U (|fun#triggerStateless| xs@@2))))
 :qid |stdinbpl.596:15|
 :skolemid |59|
 :pattern ( (|fun'| Heap@@3 xs@@2))
)))
(assert (forall ((Heap@@4 T@U) (xs@@3 T@U) ) (!  (=> (and (= (type Heap@@4) (MapType0Type RefType)) (= (type xs@@3) (SeqType RefType))) (dummyFunction (int_2_U (|fun_impl#triggerStateless| xs@@3))))
 :qid |stdinbpl.806:15|
 :skolemid |79|
...
(assert (forall ((Heap@@5 T@U) (Mask@@3 T@U) (xs@@4 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@5) (MapType0Type RefType)) (= (type Mask@@3) (MapType1Type RefType realType))) (= (type xs@@4) (SeqType RefType))) (and (state Heap@@5 Mask@@3) (< AssumeFunctionsAbove 0))) (and (< 0 (|Seq#Length| xs@@4)) (forall ((i1@@0 Int) (i2@@0 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@4)) (int_2_U i1@@0)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@4)) (int_2_U i2@@0)) (not (= i1@@0 i2@@0)))) (not (= (|Seq#Index| xs@@4 i1@@0) (|Seq#Index| xs@@4 i2@@0))))
 :qid |stdinbpl.604:83|
 :skolemid |60|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@4)) (int_2_U i1@@0)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@4)) (int_2_U i2@@0)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@4)) (int_2_U i1@@0)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@4)) (int_2_U i2@@0)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@4)) (int_2_U i1@@0)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@4)) (int_2_U i2@@0)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@4)) (int_2_U i1@@0)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@4)) (int_2_U i2@@0)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@4)) (int_2_U i1@@0)) (|Seq#Index| xs@@4 i2@@0))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@4)) (int_2_U i1@@0)) (|Seq#Index| xs@@4 i2@@0))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| xs@@4)) (int_2_U i2@@0)) (|Seq#Index| xs@@4 i1@@0))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs@@4)) (int_2_U i2@@0)) (|Seq#Index| xs@@4 i1@@0))
 :pattern ( (|Seq#Index| xs@@4 i1@@0) (|Seq#Index| xs@@4 i2@@0))
)))) (= (fun Heap@@5 xs@@4) (fun_impl Heap@@5 xs@@4)))
 :qid |stdinbpl.602:15|
 :skolemid |61|
 :pattern ( (state Heap@@5 Mask@@3) (fun Heap@@5 xs@@4))
)))
...
(assert (forall ((Heap@@7 T@U) (xs@@5 T@U) ) (!  (=> (and (= (type Heap@@7) (MapType0Type RefType)) (= (type xs@@5) (SeqType RefType))) (and (= (fun Heap@@7 xs@@5) (|fun'| Heap@@7 xs@@5)) (dummyFunction (int_2_U (|fun#triggerStateless| xs@@5)))))
 :qid |stdinbpl.592:15|
 :skolemid |58|
 :pattern ( (fun Heap@@7 xs@@5))
)))
(assert (forall ((Heap@@8 T@U) (xs@@6 T@U) ) (!  (=> (and (= (type Heap@@8) (MapType0Type RefType)) (= (type xs@@6) (SeqType RefType))) (and (= (fun_impl Heap@@8 xs@@6) (|fun_impl'| Heap@@8 xs@@6)) (dummyFunction (int_2_U (|fun_impl#triggerStateless| xs@@6)))))
 :qid |stdinbpl.802:15|
 :skolemid |78|
 :pattern ( (fun_impl Heap@@8 xs@@6))
)))
...
(assert (forall ((Heap@@14 T@U) (Mask@@11 T@U) (xs@@7 T@U) ) (!  (=> (and (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (= (type xs@@7) (SeqType RefType))) (state Heap@@14 Mask@@11)) (= (|fun'| Heap@@14 xs@@7) (|fun#frame| (FrameFragment (int_2_U (|fun#condqp1| Heap@@14 xs@@7))) xs@@7)))
 :qid |stdinbpl.612:15|
 :skolemid |62|
 :pattern ( (state Heap@@14 Mask@@11) (|fun'| Heap@@14 xs@@7))
)))
(assert (forall ((Heap@@15 T@U) (Mask@@12 T@U) (xs@@8 T@U) ) (!  (=> (and (and (and (= (type Heap@@15) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (= (type xs@@8) (SeqType RefType))) (state Heap@@15 Mask@@12)) (= (|fun_impl'| Heap@@15 xs@@8) (|fun_impl#frame| (FrameFragment (int_2_U (|fun_impl#condqp2| Heap@@15 xs@@8))) xs@@8)))
 :qid |stdinbpl.822:15|
 :skolemid |82|
 :pattern ( (state Heap@@15 Mask@@12) (|fun_impl'| Heap@@15 xs@@8))
)))
...
(assert  (and (and (and (and (= (type Heap@@17) (MapType0Type RefType)) (= (type y@@2) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type x@@11) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test03)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon4_correct true))
(let ((anon15_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i1@@1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i2@@1)) (not (= i1@@1 i2@@1))))) (= (ControlFlow 0 19) 16)) anon4_correct)))
(let ((anon15_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i1@@1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i2@@1)) (not (= i1@@1 i2@@1)))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (not (= (|Seq#Index| (|Seq#Singleton| x@@11) i1@@1) (|Seq#Index| (|Seq#Singleton| x@@11) i2@@1)))) (=> (not (= (|Seq#Index| (|Seq#Singleton| x@@11) i1@@1) (|Seq#Index| (|Seq#Singleton| x@@11) i2@@1))) (=> (= (ControlFlow 0 17) 16) anon4_correct))))))
(let ((anon14_Else_correct  (=> (forall ((i1_1_1 Int) (i2_1_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i1_1_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i2_1_1)) (not (= i1_1_1 i2_1_1)))) (not (= (|Seq#Index| (|Seq#Singleton| x@@11) i1_1_1) (|Seq#Index| (|Seq#Singleton| x@@11) i2_1_1))))
 :qid |stdinbpl.1320:24|
 :skolemid |112|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i1_1_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i2_1_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i1_1_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i2_1_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i1_1_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i2_1_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i1_1_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i2_1_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i1_1_1)) (|Seq#Index| (|Seq#Singleton| x@@11) i2_1_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i1_1_1)) (|Seq#Index| (|Seq#Singleton| x@@11) i2_1_1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i2_1_1)) (|Seq#Index| (|Seq#Singleton| x@@11) i1_1_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (int_2_U i2_1_1)) (|Seq#Index| (|Seq#Singleton| x@@11) i1_1_1))
 :pattern ( (|Seq#Index| (|Seq#Singleton| x@@11) i1_1_1) (|Seq#Index| (|Seq#Singleton| x@@11) i2_1_1))
)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((i@@6 Int) (i_6 Int) ) (!  (=> (and (and (and (and (not (= i@@6 i_6)) (and (<= 0 i@@6) (< i@@6 (|Seq#Length| (|Seq#Singleton| x@@11))))) (and (<= 0 i_6) (< i_6 (|Seq#Length| (|Seq#Singleton| x@@11))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (|Seq#Singleton| x@@11) i@@6) (|Seq#Index| (|Seq#Singleton| x@@11) i_6))))
 :qid |stdinbpl.1331:21|
 :skolemid |113|
 :pattern ( (neverTriggered7 i@@6) (neverTriggered7 i_6))
))) (=> (forall ((i@@7 Int) (i_6@@0 Int) ) (!  (=> (and (and (and (and (not (= i@@7 i_6@@0)) (and (<= 0 i@@7) (< i@@7 (|Seq#Length| (|Seq#Singleton| x@@11))))) (and (<= 0 i_6@@0) (< i_6@@0 (|Seq#Length| (|Seq#Singleton| x@@11))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (|Seq#Singleton| x@@11) i@@7) (|Seq#Index| (|Seq#Singleton| x@@11) i_6@@0))))
 :qid |stdinbpl.1331:21|
 :skolemid |113|
 :pattern ( (neverTriggered7 i@@7) (neverTriggered7 i_6@@0))
)) (=> (= (ControlFlow 0 14) (- 0 13)) (forall ((i@@8 Int) ) (!  (=> (and (<= 0 i@@8) (< i@@8 (|Seq#Length| (|Seq#Singleton| x@@11)))) (>= (U_2_real (MapType1Select Mask@1 (|Seq#Index| (|Seq#Singleton| x@@11) i@@8) f_7)) FullPerm))
 :qid |stdinbpl.1338:21|
 :skolemid |114|
 :pattern ( (|Seq#Index| (|Seq#Singleton| x@@11) i@@8))
 :pattern ( (|Seq#Index| (|Seq#Singleton| x@@11) i@@8))
))))))))
(let ((anon13_Then_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (< 0 (|Seq#Length| (|Seq#Singleton| x@@11)))) (=> (< 0 (|Seq#Length| (|Seq#Singleton| x@@11))) (and (and (=> (= (ControlFlow 0 20) 14) anon14_Else_correct) (=> (= (ControlFlow 0 20) 17) anon15_Then_correct)) (=> (= (ControlFlow 0 20) 19) anon15_Else_correct))))))
(let ((anon10_correct true))
(let ((anon18_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| y@@2))) (int_2_U i1_2_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| y@@2))) (int_2_U i2_2_1)) (not (= i1_2_1 i2_2_1))))) (= (ControlFlow 0 9) 6)) anon10_correct)))
(let ((anon18_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| y@@2))) (int_2_U i1_2_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| y@@2))) (int_2_U i2_2_1)) (not (= i1_2_1 i2_2_1)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (not (= (|Seq#Index| (|Seq#Singleton| y@@2) i1_2_1) (|Seq#Index| (|Seq#Singleton| y@@2) i2_2_1)))) (=> (not (= (|Seq#Index| (|Seq#Singleton| y@@2) i1_2_1) (|Seq#Index| (|Seq#Singleton| y@@2) i2_2_1))) (=> (= (ControlFlow 0 7) 6) anon10_correct))))))
(let ((anon17_Else_correct  (=> (forall ((i1_3_1 Int) (i2_3_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| y@@2))) (int_2_U i1_3_1)) (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| y@@2))) (int_2_U i2_3_1)) (not (= i1_3_1 i2_3_1)))) (not (= (|Seq#Index| (|Seq#Singleton| y@@2) i1_3_1) (|Seq#Index| (|Seq#Singleton| y@@2) i2_3_1))))
 :qid |stdinbpl.1393:24|
 :skolemid |119|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| y@@2))) (int_2_U i1_3_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| y@@2))) (int_2_U i2_3_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| y@@2))) (int_2_U i1_3_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| y@@2))) (int_2_U i2_3_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| y@@2))) (int_2_U i1_3_1)) (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| y@@2))) (int_2_U i2_3_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| y@@2))) (int_2_U i1_3_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| y@@2))) (int_2_U i2_3_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| y@@2))) (int_2_U i1_3_1)) (|Seq#Index| (|Seq#Singleton| y@@2) i2_3_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| y@@2))) (int_2_U i1_3_1)) (|Seq#Index| (|Seq#Singleton| y@@2) i2_3_1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| y@@2))) (int_2_U i2_3_1)) (|Seq#Index| (|Seq#Singleton| y@@2) i1_3_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| (|Seq#Singleton| y@@2))) (int_2_U i2_3_1)) (|Seq#Index| (|Seq#Singleton| y@@2) i1_3_1))
 :pattern ( (|Seq#Index| (|Seq#Singleton| y@@2) i1_3_1) (|Seq#Index| (|Seq#Singleton| y@@2) i2_3_1))
)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (|Seq#Length| (|Seq#Singleton| y@@2))))) (and (<= 0 i_1_1) (< i_1_1 (|Seq#Length| (|Seq#Singleton| y@@2))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (|Seq#Singleton| y@@2) i_1) (|Seq#Index| (|Seq#Singleton| y@@2) i_1_1))))
 :qid |stdinbpl.1404:21|
 :skolemid |120|
 :pattern ( (neverTriggered8 i_1) (neverTriggered8 i_1_1))
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= 0 i_1@@0) (< i_1@@0 (|Seq#Length| (|Seq#Singleton| y@@2))))) (and (<= 0 i_1_1@@0) (< i_1_1@@0 (|Seq#Length| (|Seq#Singleton| y@@2))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (|Seq#Singleton| y@@2) i_1@@0) (|Seq#Index| (|Seq#Singleton| y@@2) i_1_1@@0))))
 :qid |stdinbpl.1404:21|
 :skolemid |120|
 :pattern ( (neverTriggered8 i_1@@0) (neverTriggered8 i_1_1@@0))
)) (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((i_1@@1 Int) ) (!  (=> (and (<= 0 i_1@@1) (< i_1@@1 (|Seq#Length| (|Seq#Singleton| y@@2)))) (>= (U_2_real (MapType1Select Mask@1 (|Seq#Index| (|Seq#Singleton| y@@2) i_1@@1) f_7)) FullPerm))
 :qid |stdinbpl.1411:21|
 :skolemid |121|
 :pattern ( (|Seq#Index| (|Seq#Singleton| y@@2) i_1@@1))
 :pattern ( (|Seq#Index| (|Seq#Singleton| y@@2) i_1@@1))
))))))))
(let ((anon16_Then_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (< 0 (|Seq#Length| (|Seq#Singleton| y@@2)))) (=> (< 0 (|Seq#Length| (|Seq#Singleton| y@@2))) (and (and (=> (= (ControlFlow 0 10) 4) anon17_Else_correct) (=> (= (ControlFlow 0 10) 7) anon18_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon18_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (and (= (fun_impl Heap@@17 (|Seq#Singleton| y@@2)) 2) (state Heap@@17 Mask@1)) (and (state Heap@@17 Mask@1) (= (ControlFlow 0 2) (- 0 1)))) false)))
(let ((anon13_Else_correct  (=> (and (and (= (fun_impl Heap@@17 (|Seq#Singleton| x@@11)) 1) (state Heap@@17 Mask@1)) (and (state Heap@@17 Mask@1) (state Heap@@17 Mask@1))) (and (=> (= (ControlFlow 0 12) 10) anon16_Then_correct) (=> (= (ControlFlow 0 12) 2) anon16_Else_correct)))))
(let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@17 x@@11 $allocated)) (U_2_bool (MapType0Select Heap@@17 y@@2 $allocated)))) (=> (and (and (and (not (= x@@11 null)) (= Mask@0 (MapType1Store ZeroMask x@@11 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@11 f_7)) FullPerm))))) (and (state Heap@@17 Mask@0) (not (= y@@2 null)))) (and (and (= Mask@1 (MapType1Store Mask@0 y@@2 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@2 f_7)) FullPerm)))) (state Heap@@17 Mask@1)) (and (state Heap@@17 Mask@1) (state Heap@@17 Mask@1)))) (and (=> (= (ControlFlow 0 22) 20) anon13_Then_correct) (=> (= (ControlFlow 0 22) 12) anon13_Else_correct))))))
