...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated)) (= perm@0 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= x@@8 null))) (=> (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) perm@0)))) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@0 x@@8 f_7)) (=> (HasDirectPerm Mask@0 x@@8 f_7) (=> (and (not (= (MapType0Select Heap@@9 x@@8 f_7) null)) (= perm@1 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (=> (> perm@1 NoPerm) (not (= x@@8 null))) (=> (and (and (= Mask@1 (MapType1Store Mask@0 x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@8 f_7)) perm@1)))) (state Heap@@9 Mask@1)) (and (state Heap@@9 Mask@1) (= (ControlFlow 0 2) (- 0 1)))) false)))))))))))))))
