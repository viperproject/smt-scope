...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type nodes@0) (MapType2Type RefType boolType)) (= (type n_10) RefType)) (= (type Mask@5) (MapType1Type RefType realType))) (= (type n_1) RefType)) (= (type Heap@7) (MapType0Type RefType))) (= (type n$2_3) RefType)) (= (type n$3_3) RefType)) (= (type n_13) RefType)) (= (type QPMask@5) (MapType1Type RefType realType))) (= (type n_10_1) RefType)) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type freshObj@0) RefType)) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type QPMask@3) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv25 arg0@@43)) RefType)
 :qid |funType:invRecv25|
 :pattern ( (invRecv25 arg0@@43))
))) (= (type QPMask@4) (MapType1Type RefType realType))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv26 arg0@@44)) RefType)
 :qid |funType:invRecv26|
 :pattern ( (invRecv26 arg0@@44))
))) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv27 arg0@@45)) RefType)
 :qid |funType:invRecv27|
 :pattern ( (invRecv27 arg0@@45))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@46 T@U) ) (! (= (type (invRecv22 arg0@@46)) RefType)
 :qid |funType:invRecv22|
 :pattern ( (invRecv22 arg0@@46))
))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@47 T@U) ) (! (= (type (invRecv23 arg0@@47)) RefType)
 :qid |funType:invRecv23|
 :pattern ( (invRecv23 arg0@@47))
))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv24 arg0@@48)) RefType)
 :qid |funType:invRecv24|
 :pattern ( (invRecv24 arg0@@48))
))) (= (type Heap@@9) (MapType0Type RefType))) (= (type a_2) RefType)) (= (type b_2) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type freshObj@1) RefType)) (= (type Heap@2) (MapType0Type RefType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Heap@3) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@6) (MapType0Type RefType))))
(set-info :boogie-vc-id client_success)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 48) (let ((anon23_correct true))
(let ((anon36_Else_correct  (=> (and (not (U_2_bool (MapType2Select nodes@0 n_10_1))) (= (ControlFlow 0 25) 22)) anon23_correct)))
(let ((anon36_Then_correct  (=> (U_2_bool (MapType2Select nodes@0 n_10_1)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (U_2_bool (MapType0Select ExhaleHeap@0 n_10_1 is_marked))) (=> (U_2_bool (MapType0Select ExhaleHeap@0 n_10_1 is_marked)) (=> (= (ControlFlow 0 23) 22) anon23_correct))))))
(let ((anon19_correct true))
(let ((anon34_Else_correct  (=> (and (not (U_2_bool (MapType2Select nodes@0 n_13))) (= (ControlFlow 0 21) 18)) anon19_correct)))
(let ((anon34_Then_correct  (=> (U_2_bool (MapType2Select nodes@0 n_13)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (HasDirectPerm QPMask@5 n_13 is_marked)) (=> (HasDirectPerm QPMask@5 n_13 is_marked) (=> (= (ControlFlow 0 19) 18) anon19_correct))))))
(let ((anon35_Else_correct true))
(let ((anon31_Else_correct  (=> (forall ((n$3_1_1 T@U) ) (!  (=> (= (type n$3_1_1) RefType) (=> (and (U_2_bool (MapType2Select nodes@0 n$3_1_1)) (not (= (MapType0Select Heap@7 n$3_1_1 right) null))) (U_2_bool (MapType2Select nodes@0 (MapType0Select Heap@7 n$3_1_1 right)))))
 :qid |stdinbpl.2124:22|
 :skolemid |262|
 :pattern ( (MapType2Select nodes@0 (MapType0Select Heap@7 n$3_1_1 right)))
 :pattern ( (MapType2Select nodes@0 n$3_1_1) (MapType0Select Heap@7 n$3_1_1 right))
)) (and (=> (= (ControlFlow 0 26) (- 0 30)) (not (U_2_bool (MapType0Select Heap@7 freshObj@0 is_marked)))) (=> (not (U_2_bool (MapType0Select Heap@7 freshObj@0 is_marked))) (=> (IdenticalOnKnownLocations Heap@7 ExhaleHeap@0 QPMask@2) (=> (and (U_2_bool (MapType2Select nodes@0 freshObj@0)) (not (U_2_bool (MapType2Select nodes@0 null)))) (and (=> (= (ControlFlow 0 26) (- 0 29)) (forall ((n$4 T@U) (n$4_5 T@U) ) (!  (=> (and (= (type n$4) RefType) (= (type n$4_5) RefType)) (=> (and (and (and (and (not (= n$4 n$4_5)) (U_2_bool (MapType2Select nodes@0 n$4))) (U_2_bool (MapType2Select nodes@0 n$4_5))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$4 n$4_5))))
 :qid |stdinbpl.2140:17|
 :skolemid |263|
 :no-pattern (type n$4)
 :no-pattern (type n$4_5)
 :no-pattern (U_2_int n$4)
 :no-pattern (U_2_bool n$4)
 :no-pattern (U_2_int n$4_5)
 :no-pattern (U_2_bool n$4_5)
))) (=> (forall ((n$4@@0 T@U) (n$4_5@@0 T@U) ) (!  (=> (and (= (type n$4@@0) RefType) (= (type n$4_5@@0) RefType)) (=> (and (and (and (and (not (= n$4@@0 n$4_5@@0)) (U_2_bool (MapType2Select nodes@0 n$4@@0))) (U_2_bool (MapType2Select nodes@0 n$4_5@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$4@@0 n$4_5@@0))))
 :qid |stdinbpl.2140:17|
 :skolemid |263|
 :no-pattern (type n$4@@0)
 :no-pattern (type n$4_5@@0)
 :no-pattern (U_2_int n$4@@0)
 :no-pattern (U_2_bool n$4@@0)
 :no-pattern (U_2_int n$4_5@@0)
 :no-pattern (U_2_bool n$4_5@@0)
)) (=> (and (forall ((n$4@@1 T@U) ) (!  (=> (= (type n$4@@1) RefType) (=> (and (U_2_bool (MapType2Select nodes@0 n$4@@1)) (< NoPerm FullPerm)) (and (qpRange25 n$4@@1) (= (invRecv25 n$4@@1) n$4@@1))))
 :qid |stdinbpl.2146:24|
 :skolemid |264|
 :pattern ( (MapType0Select ExhaleHeap@0 n$4@@1 left))
 :pattern ( (MapType1Select QPMask@3 n$4@@1 left))
 :pattern ( (MapType2Select nodes@0 n$4@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select nodes@0 (invRecv25 o_3))) (< NoPerm FullPerm)) (qpRange25 o_3)) (= (invRecv25 o_3) o_3)))
 :qid |stdinbpl.2150:24|
 :skolemid |265|
 :pattern ( (invRecv25 o_3))
))) (=> (and (and (forall ((n$4@@2 T@U) ) (!  (=> (and (= (type n$4@@2) RefType) (U_2_bool (MapType2Select nodes@0 n$4@@2))) (not (= n$4@@2 null)))
 :qid |stdinbpl.2156:24|
 :skolemid |266|
 :pattern ( (MapType0Select ExhaleHeap@0 n$4@@2 left))
 :pattern ( (MapType1Select QPMask@3 n$4@@2 left))
 :pattern ( (MapType2Select nodes@0 n$4@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select nodes@0 (invRecv25 o_3@@0))) (< NoPerm FullPerm)) (qpRange25 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv25 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@3 o_3@@0 left)) (+ (U_2_real (MapType1Select QPMask@2 o_3@@0 left)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select nodes@0 (invRecv25 o_3@@0))) (< NoPerm FullPerm)) (qpRange25 o_3@@0))) (= (U_2_real (MapType1Select QPMask@3 o_3@@0 left)) (U_2_real (MapType1Select QPMask@2 o_3@@0 left))))))
 :qid |stdinbpl.2162:24|
 :skolemid |267|
 :pattern ( (MapType1Select QPMask@3 o_3@@0 left))
))) (and (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 left))) (= (U_2_real (MapType1Select QPMask@2 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@3 o_3@@1 f_5))))))
 :qid |stdinbpl.2166:31|
 :skolemid |268|
 :pattern ( (MapType1Select QPMask@2 o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@3 o_3@@1 f_5))
)) (state ExhaleHeap@0 QPMask@3))) (and (=> (= (ControlFlow 0 26) (- 0 28)) (forall ((n$5 T@U) (n$5_5 T@U) ) (!  (=> (and (= (type n$5) RefType) (= (type n$5_5) RefType)) (=> (and (and (and (and (not (= n$5 n$5_5)) (U_2_bool (MapType2Select nodes@0 n$5))) (U_2_bool (MapType2Select nodes@0 n$5_5))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$5 n$5_5))))
 :qid |stdinbpl.2174:17|
 :skolemid |269|
 :no-pattern (type n$5)
 :no-pattern (type n$5_5)
 :no-pattern (U_2_int n$5)
 :no-pattern (U_2_bool n$5)
 :no-pattern (U_2_int n$5_5)
 :no-pattern (U_2_bool n$5_5)
))) (=> (forall ((n$5@@0 T@U) (n$5_5@@0 T@U) ) (!  (=> (and (= (type n$5@@0) RefType) (= (type n$5_5@@0) RefType)) (=> (and (and (and (and (not (= n$5@@0 n$5_5@@0)) (U_2_bool (MapType2Select nodes@0 n$5@@0))) (U_2_bool (MapType2Select nodes@0 n$5_5@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$5@@0 n$5_5@@0))))
 :qid |stdinbpl.2174:17|
 :skolemid |269|
 :no-pattern (type n$5@@0)
 :no-pattern (type n$5_5@@0)
 :no-pattern (U_2_int n$5@@0)
 :no-pattern (U_2_bool n$5@@0)
 :no-pattern (U_2_int n$5_5@@0)
 :no-pattern (U_2_bool n$5_5@@0)
)) (=> (and (forall ((n$5@@1 T@U) ) (!  (=> (= (type n$5@@1) RefType) (=> (and (U_2_bool (MapType2Select nodes@0 n$5@@1)) (< NoPerm FullPerm)) (and (qpRange26 n$5@@1) (= (invRecv26 n$5@@1) n$5@@1))))
 :qid |stdinbpl.2180:24|
 :skolemid |270|
 :pattern ( (MapType0Select ExhaleHeap@0 n$5@@1 right))
 :pattern ( (MapType1Select QPMask@4 n$5@@1 right))
 :pattern ( (MapType2Select nodes@0 n$5@@1))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType2Select nodes@0 (invRecv26 o_3@@2))) (< NoPerm FullPerm)) (qpRange26 o_3@@2)) (= (invRecv26 o_3@@2) o_3@@2)))
 :qid |stdinbpl.2184:24|
 :skolemid |271|
 :pattern ( (invRecv26 o_3@@2))
))) (=> (and (and (forall ((n$5@@2 T@U) ) (!  (=> (and (= (type n$5@@2) RefType) (U_2_bool (MapType2Select nodes@0 n$5@@2))) (not (= n$5@@2 null)))
 :qid |stdinbpl.2190:24|
 :skolemid |272|
 :pattern ( (MapType0Select ExhaleHeap@0 n$5@@2 right))
 :pattern ( (MapType1Select QPMask@4 n$5@@2 right))
 :pattern ( (MapType2Select nodes@0 n$5@@2))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType2Select nodes@0 (invRecv26 o_3@@3))) (< NoPerm FullPerm)) (qpRange26 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv26 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@4 o_3@@3 right)) (+ (U_2_real (MapType1Select QPMask@3 o_3@@3 right)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select nodes@0 (invRecv26 o_3@@3))) (< NoPerm FullPerm)) (qpRange26 o_3@@3))) (= (U_2_real (MapType1Select QPMask@4 o_3@@3 right)) (U_2_real (MapType1Select QPMask@3 o_3@@3 right))))))
 :qid |stdinbpl.2196:24|
 :skolemid |273|
 :pattern ( (MapType1Select QPMask@4 o_3@@3 right))
))) (and (forall ((o_3@@4 T@U) (f_5@@0 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_5@@0))))
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 right))) (= (U_2_real (MapType1Select QPMask@3 o_3@@4 f_5@@0)) (U_2_real (MapType1Select QPMask@4 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.2200:31|
 :skolemid |274|
 :pattern ( (MapType1Select QPMask@3 o_3@@4 f_5@@0))
 :pattern ( (MapType1Select QPMask@4 o_3@@4 f_5@@0))
)) (state ExhaleHeap@0 QPMask@4))) (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((n$6 T@U) (n$6_5 T@U) ) (!  (=> (and (= (type n$6) RefType) (= (type n$6_5) RefType)) (=> (and (and (and (and (not (= n$6 n$6_5)) (U_2_bool (MapType2Select nodes@0 n$6))) (U_2_bool (MapType2Select nodes@0 n$6_5))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$6 n$6_5))))
 :qid |stdinbpl.2208:17|
 :skolemid |275|
 :no-pattern (type n$6)
 :no-pattern (type n$6_5)
 :no-pattern (U_2_int n$6)
 :no-pattern (U_2_bool n$6)
 :no-pattern (U_2_int n$6_5)
 :no-pattern (U_2_bool n$6_5)
))) (=> (forall ((n$6@@0 T@U) (n$6_5@@0 T@U) ) (!  (=> (and (= (type n$6@@0) RefType) (= (type n$6_5@@0) RefType)) (=> (and (and (and (and (not (= n$6@@0 n$6_5@@0)) (U_2_bool (MapType2Select nodes@0 n$6@@0))) (U_2_bool (MapType2Select nodes@0 n$6_5@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$6@@0 n$6_5@@0))))
 :qid |stdinbpl.2208:17|
 :skolemid |275|
 :no-pattern (type n$6@@0)
 :no-pattern (type n$6_5@@0)
 :no-pattern (U_2_int n$6@@0)
 :no-pattern (U_2_bool n$6@@0)
 :no-pattern (U_2_int n$6_5@@0)
 :no-pattern (U_2_bool n$6_5@@0)
)) (=> (and (and (and (and (forall ((n$6@@1 T@U) ) (!  (=> (= (type n$6@@1) RefType) (=> (and (U_2_bool (MapType2Select nodes@0 n$6@@1)) (< NoPerm FullPerm)) (and (qpRange27 n$6@@1) (= (invRecv27 n$6@@1) n$6@@1))))
 :qid |stdinbpl.2214:24|
 :skolemid |276|
 :pattern ( (MapType0Select ExhaleHeap@0 n$6@@1 is_marked))
 :pattern ( (MapType1Select QPMask@5 n$6@@1 is_marked))
 :pattern ( (MapType2Select nodes@0 n$6@@1))
)) (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (U_2_bool (MapType2Select nodes@0 (invRecv27 o_3@@5))) (< NoPerm FullPerm)) (qpRange27 o_3@@5)) (= (invRecv27 o_3@@5) o_3@@5)))
 :qid |stdinbpl.2218:24|
 :skolemid |277|
 :pattern ( (invRecv27 o_3@@5))
))) (and (forall ((n$6@@2 T@U) ) (!  (=> (and (= (type n$6@@2) RefType) (U_2_bool (MapType2Select nodes@0 n$6@@2))) (not (= n$6@@2 null)))
 :qid |stdinbpl.2224:24|
 :skolemid |278|
 :pattern ( (MapType0Select ExhaleHeap@0 n$6@@2 is_marked))
 :pattern ( (MapType1Select QPMask@5 n$6@@2 is_marked))
 :pattern ( (MapType2Select nodes@0 n$6@@2))
)) (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (U_2_bool (MapType2Select nodes@0 (invRecv27 o_3@@6))) (< NoPerm FullPerm)) (qpRange27 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv27 o_3@@6) o_3@@6)) (= (U_2_real (MapType1Select QPMask@5 o_3@@6 is_marked)) (+ (U_2_real (MapType1Select QPMask@4 o_3@@6 is_marked)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select nodes@0 (invRecv27 o_3@@6))) (< NoPerm FullPerm)) (qpRange27 o_3@@6))) (= (U_2_real (MapType1Select QPMask@5 o_3@@6 is_marked)) (U_2_real (MapType1Select QPMask@4 o_3@@6 is_marked))))))
 :qid |stdinbpl.2230:24|
 :skolemid |279|
 :pattern ( (MapType1Select QPMask@5 o_3@@6 is_marked))
)))) (and (and (forall ((o_3@@7 T@U) (f_5@@1 T@U) ) (! (let ((B@@13 (FieldTypeInv1 (type f_5@@1))))
(let ((A@@14 (FieldTypeInv0 (type f_5@@1))))
 (=> (and (and (= (type o_3@@7) RefType) (= (type f_5@@1) (FieldType A@@14 B@@13))) (not (= f_5@@1 is_marked))) (= (U_2_real (MapType1Select QPMask@4 o_3@@7 f_5@@1)) (U_2_real (MapType1Select QPMask@5 o_3@@7 f_5@@1))))))
 :qid |stdinbpl.2234:31|
 :skolemid |280|
 :pattern ( (MapType1Select QPMask@4 o_3@@7 f_5@@1))
 :pattern ( (MapType1Select QPMask@5 o_3@@7 f_5@@1))
)) (state ExhaleHeap@0 QPMask@5)) (and (forall ((n$7_3 T@U) ) (!  (=> (= (type n$7_3) RefType) (=> (and (U_2_bool (MapType2Select nodes@0 n$7_3)) (not (= (MapType0Select ExhaleHeap@0 n$7_3 left) null))) (U_2_bool (MapType2Select nodes@0 (MapType0Select ExhaleHeap@0 n$7_3 left)))))
 :qid |stdinbpl.2240:22|
 :skolemid |281|
 :pattern ( (MapType2Select nodes@0 (MapType0Select ExhaleHeap@0 n$7_3 left)))
 :pattern ( (MapType2Select nodes@0 n$7_3) (MapType0Select ExhaleHeap@0 n$7_3 left))
)) (forall ((n$8_3 T@U) ) (!  (=> (= (type n$8_3) RefType) (=> (and (U_2_bool (MapType2Select nodes@0 n$8_3)) (not (= (MapType0Select ExhaleHeap@0 n$8_3 right) null))) (U_2_bool (MapType2Select nodes@0 (MapType0Select ExhaleHeap@0 n$8_3 right)))))
 :qid |stdinbpl.2244:22|
 :skolemid |282|
 :pattern ( (MapType2Select nodes@0 (MapType0Select ExhaleHeap@0 n$8_3 right)))
 :pattern ( (MapType2Select nodes@0 n$8_3) (MapType0Select ExhaleHeap@0 n$8_3 right))
))))) (and (and (and (forall ((n_4_1 T@U) ) (!  (=> (and (and (= (type n_4_1) RefType) (U_2_bool (MapType2Select nodes@0 n_4_1))) (U_2_bool (MapType0Select Heap@7 n_4_1 is_marked))) (U_2_bool (MapType0Select ExhaleHeap@0 n_4_1 is_marked)))
 :qid |stdinbpl.2248:22|
 :skolemid |283|
 :pattern ( (MapType2Select nodes@0 n_4_1) (MapType0Select ExhaleHeap@0 n_4_1 is_marked))
)) (U_2_bool (MapType0Select ExhaleHeap@0 freshObj@0 is_marked))) (and (forall ((n_5 T@U) ) (!  (=> (and (= (type n_5) RefType) (U_2_bool (MapType2Select nodes@0 n_5))) (= (MapType0Select ExhaleHeap@0 n_5 left) (MapType0Select Heap@7 n_5 left)))
 :qid |stdinbpl.2253:22|
 :skolemid |284|
 :pattern ( (MapType2Select nodes@0 n_5) (MapType0Select ExhaleHeap@0 n_5 left))
)) (forall ((n_6_1 T@U) ) (!  (=> (and (= (type n_6_1) RefType) (U_2_bool (MapType2Select nodes@0 n_6_1))) (= (MapType0Select ExhaleHeap@0 n_6_1 right) (MapType0Select Heap@7 n_6_1 right)))
 :qid |stdinbpl.2257:22|
 :skolemid |285|
 :pattern ( (MapType2Select nodes@0 n_6_1) (MapType0Select ExhaleHeap@0 n_6_1 right))
)))) (and (and (forall ((n_7 T@U) ) (!  (=> (and (and (= (type n_7) RefType) (U_2_bool (MapType2Select nodes@0 n_7))) (and (not (U_2_bool (MapType0Select Heap@7 n_7 is_marked))) (U_2_bool (MapType0Select ExhaleHeap@0 n_7 is_marked)))) (or (= (MapType0Select ExhaleHeap@0 n_7 left) null) (U_2_bool (MapType0Select ExhaleHeap@0 (MapType0Select ExhaleHeap@0 n_7 left) is_marked))))
 :qid |stdinbpl.2261:22|
 :skolemid |286|
 :pattern ( (MapType2Select nodes@0 n_7) (MapType0Select ExhaleHeap@0 n_7 is_marked))
 :pattern ( (MapType2Select nodes@0 n_7) (MapType0Select ExhaleHeap@0 (MapType0Select ExhaleHeap@0 n_7 left) is_marked))
)) (forall ((n_8_1 T@U) ) (!  (=> (and (and (= (type n_8_1) RefType) (U_2_bool (MapType2Select nodes@0 n_8_1))) (and (not (U_2_bool (MapType0Select Heap@7 n_8_1 is_marked))) (U_2_bool (MapType0Select ExhaleHeap@0 n_8_1 is_marked)))) (or (= (MapType0Select ExhaleHeap@0 n_8_1 right) null) (U_2_bool (MapType0Select ExhaleHeap@0 (MapType0Select ExhaleHeap@0 n_8_1 right) is_marked))))
 :qid |stdinbpl.2265:22|
 :skolemid |287|
 :pattern ( (MapType2Select nodes@0 n_8_1) (MapType0Select ExhaleHeap@0 n_8_1 is_marked))
 :pattern ( (MapType2Select nodes@0 n_8_1) (MapType0Select ExhaleHeap@0 (MapType0Select ExhaleHeap@0 n_8_1 right) is_marked))
...
(let ((anon32_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select nodes@0 n$3_3)) (not (= (MapType0Select Heap@7 n$3_3 right) null)))) (= (ControlFlow 0 16) 13)) anon15_correct)))
(let ((anon32_Then_correct  (=> (and (U_2_bool (MapType2Select nodes@0 n$3_3)) (not (= (MapType0Select Heap@7 n$3_3 right) null))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (U_2_bool (MapType2Select nodes@0 (MapType0Select Heap@7 n$3_3 right)))) (=> (U_2_bool (MapType2Select nodes@0 (MapType0Select Heap@7 n$3_3 right))) (=> (= (ControlFlow 0 14) 13) anon15_correct))))))
(let ((anon29_Else_correct  (=> (forall ((n$2_1_1 T@U) ) (!  (=> (= (type n$2_1_1) RefType) (=> (and (U_2_bool (MapType2Select nodes@0 n$2_1_1)) (not (= (MapType0Select Heap@7 n$2_1_1 left) null))) (U_2_bool (MapType2Select nodes@0 (MapType0Select Heap@7 n$2_1_1 left)))))
 :qid |stdinbpl.2113:22|
 :skolemid |261|
 :pattern ( (MapType2Select nodes@0 (MapType0Select Heap@7 n$2_1_1 left)))
 :pattern ( (MapType2Select nodes@0 n$2_1_1) (MapType0Select Heap@7 n$2_1_1 left))
...
(let ((anon30_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select nodes@0 n$2_3)) (not (= (MapType0Select Heap@7 n$2_3 left) null)))) (= (ControlFlow 0 12) 9)) anon11_correct)))
(let ((anon30_Then_correct  (=> (and (U_2_bool (MapType2Select nodes@0 n$2_3)) (not (= (MapType0Select Heap@7 n$2_3 left) null))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (U_2_bool (MapType2Select nodes@0 (MapType0Select Heap@7 n$2_3 left)))) (=> (U_2_bool (MapType2Select nodes@0 (MapType0Select Heap@7 n$2_3 left))) (=> (= (ControlFlow 0 10) 9) anon11_correct))))))
(let ((anon27_Else_correct  (=> (and (forall ((n_2_1 T@U) ) (!  (=> (and (= (type n_2_1) RefType) (U_2_bool (MapType2Select nodes@0 n_2_1))) (not (U_2_bool (MapType0Select Heap@7 n_2_1 is_marked))))
 :qid |stdinbpl.1966:20|
 :skolemid |242|
 :pattern ( (MapType2Select nodes@0 n_2_1))
)) (state Heap@7 Mask@5)) (and (=> (= (ControlFlow 0 32) (- 0 40)) (U_2_bool (MapType2Select nodes@0 freshObj@0))) (=> (U_2_bool (MapType2Select nodes@0 freshObj@0)) (and (=> (= (ControlFlow 0 32) (- 0 39)) (not (U_2_bool (MapType2Select nodes@0 null)))) (=> (not (U_2_bool (MapType2Select nodes@0 null))) (and (=> (= (ControlFlow 0 32) (- 0 38)) (forall ((n_3 T@U) (n_3_1 T@U) ) (!  (=> (and (= (type n_3) RefType) (= (type n_3_1) RefType)) (=> (and (and (and (and (not (= n_3 n_3_1)) (U_2_bool (MapType2Select nodes@0 n_3))) (U_2_bool (MapType2Select nodes@0 n_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3 n_3_1))))
 :qid |stdinbpl.1990:19|
 :skolemid |243|
 :pattern ( (neverTriggered22 n_3) (neverTriggered22 n_3_1))
))) (=> (forall ((n_3@@0 T@U) (n_3_1@@0 T@U) ) (!  (=> (and (= (type n_3@@0) RefType) (= (type n_3_1@@0) RefType)) (=> (and (and (and (and (not (= n_3@@0 n_3_1@@0)) (U_2_bool (MapType2Select nodes@0 n_3@@0))) (U_2_bool (MapType2Select nodes@0 n_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3@@0 n_3_1@@0))))
 :qid |stdinbpl.1990:19|
 :skolemid |243|
 :pattern ( (neverTriggered22 n_3@@0) (neverTriggered22 n_3_1@@0))
)) (and (=> (= (ControlFlow 0 32) (- 0 37)) (forall ((n_3@@1 T@U) ) (!  (=> (and (= (type n_3@@1) RefType) (U_2_bool (MapType2Select nodes@0 n_3@@1))) (>= (U_2_real (MapType1Select Mask@5 n_3@@1 left)) FullPerm))
 :qid |stdinbpl.1997:19|
 :skolemid |244|
 :pattern ( (MapType0Select Heap@7 n_3@@1 left))
 :pattern ( (MapType1Select QPMask@0 n_3@@1 left))
 :pattern ( (MapType2Select nodes@0 n_3@@1))
))) (=> (forall ((n_3@@2 T@U) ) (!  (=> (and (= (type n_3@@2) RefType) (U_2_bool (MapType2Select nodes@0 n_3@@2))) (>= (U_2_real (MapType1Select Mask@5 n_3@@2 left)) FullPerm))
 :qid |stdinbpl.1997:19|
 :skolemid |244|
 :pattern ( (MapType0Select Heap@7 n_3@@2 left))
 :pattern ( (MapType1Select QPMask@0 n_3@@2 left))
 :pattern ( (MapType2Select nodes@0 n_3@@2))
)) (=> (and (and (forall ((n_3@@3 T@U) ) (!  (=> (= (type n_3@@3) RefType) (=> (and (U_2_bool (MapType2Select nodes@0 n_3@@3)) (< NoPerm FullPerm)) (and (qpRange22 n_3@@3) (= (invRecv22 n_3@@3) n_3@@3))))
 :qid |stdinbpl.2003:24|
 :skolemid |245|
 :pattern ( (MapType0Select Heap@7 n_3@@3 left))
 :pattern ( (MapType1Select QPMask@0 n_3@@3 left))
 :pattern ( (MapType2Select nodes@0 n_3@@3))
)) (forall ((o_3@@8 T@U) ) (!  (=> (= (type o_3@@8) RefType) (=> (and (U_2_bool (MapType2Select nodes@0 (invRecv22 o_3@@8))) (and (< NoPerm FullPerm) (qpRange22 o_3@@8))) (= (invRecv22 o_3@@8) o_3@@8)))
 :qid |stdinbpl.2007:24|
 :skolemid |246|
 :pattern ( (invRecv22 o_3@@8))
))) (and (forall ((o_3@@9 T@U) ) (!  (=> (= (type o_3@@9) RefType) (and (=> (and (U_2_bool (MapType2Select nodes@0 (invRecv22 o_3@@9))) (and (< NoPerm FullPerm) (qpRange22 o_3@@9))) (and (= (invRecv22 o_3@@9) o_3@@9) (= (U_2_real (MapType1Select QPMask@0 o_3@@9 left)) (- (U_2_real (MapType1Select Mask@5 o_3@@9 left)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select nodes@0 (invRecv22 o_3@@9))) (and (< NoPerm FullPerm) (qpRange22 o_3@@9)))) (= (U_2_real (MapType1Select QPMask@0 o_3@@9 left)) (U_2_real (MapType1Select Mask@5 o_3@@9 left))))))
 :qid |stdinbpl.2013:24|
 :skolemid |247|
 :pattern ( (MapType1Select QPMask@0 o_3@@9 left))
)) (forall ((o_3@@10 T@U) (f_5@@2 T@U) ) (! (let ((B@@14 (FieldTypeInv1 (type f_5@@2))))
(let ((A@@15 (FieldTypeInv0 (type f_5@@2))))
 (=> (and (and (= (type o_3@@10) RefType) (= (type f_5@@2) (FieldType A@@15 B@@14))) (not (= f_5@@2 left))) (= (U_2_real (MapType1Select Mask@5 o_3@@10 f_5@@2)) (U_2_real (MapType1Select QPMask@0 o_3@@10 f_5@@2))))))
 :qid |stdinbpl.2019:31|
 :skolemid |248|
 :pattern ( (MapType1Select QPMask@0 o_3@@10 f_5@@2))
)))) (and (=> (= (ControlFlow 0 32) (- 0 36)) (forall ((n$0 T@U) (n$0_4 T@U) ) (!  (=> (and (= (type n$0) RefType) (= (type n$0_4) RefType)) (=> (and (and (and (and (not (= n$0 n$0_4)) (U_2_bool (MapType2Select nodes@0 n$0))) (U_2_bool (MapType2Select nodes@0 n$0_4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0 n$0_4))))
 :qid |stdinbpl.2031:19|
 :skolemid |249|
 :pattern ( (neverTriggered23 n$0) (neverTriggered23 n$0_4))
))) (=> (forall ((n$0@@0 T@U) (n$0_4@@0 T@U) ) (!  (=> (and (= (type n$0@@0) RefType) (= (type n$0_4@@0) RefType)) (=> (and (and (and (and (not (= n$0@@0 n$0_4@@0)) (U_2_bool (MapType2Select nodes@0 n$0@@0))) (U_2_bool (MapType2Select nodes@0 n$0_4@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0@@0 n$0_4@@0))))
 :qid |stdinbpl.2031:19|
 :skolemid |249|
 :pattern ( (neverTriggered23 n$0@@0) (neverTriggered23 n$0_4@@0))
)) (and (=> (= (ControlFlow 0 32) (- 0 35)) (forall ((n$0@@1 T@U) ) (!  (=> (and (= (type n$0@@1) RefType) (U_2_bool (MapType2Select nodes@0 n$0@@1))) (>= (U_2_real (MapType1Select QPMask@0 n$0@@1 right)) FullPerm))
 :qid |stdinbpl.2038:19|
 :skolemid |250|
 :pattern ( (MapType0Select Heap@7 n$0@@1 right))
 :pattern ( (MapType1Select QPMask@1 n$0@@1 right))
 :pattern ( (MapType2Select nodes@0 n$0@@1))
))) (=> (forall ((n$0@@2 T@U) ) (!  (=> (and (= (type n$0@@2) RefType) (U_2_bool (MapType2Select nodes@0 n$0@@2))) (>= (U_2_real (MapType1Select QPMask@0 n$0@@2 right)) FullPerm))
 :qid |stdinbpl.2038:19|
 :skolemid |250|
 :pattern ( (MapType0Select Heap@7 n$0@@2 right))
 :pattern ( (MapType1Select QPMask@1 n$0@@2 right))
 :pattern ( (MapType2Select nodes@0 n$0@@2))
)) (=> (and (and (forall ((n$0@@3 T@U) ) (!  (=> (= (type n$0@@3) RefType) (=> (and (U_2_bool (MapType2Select nodes@0 n$0@@3)) (< NoPerm FullPerm)) (and (qpRange23 n$0@@3) (= (invRecv23 n$0@@3) n$0@@3))))
 :qid |stdinbpl.2044:24|
 :skolemid |251|
 :pattern ( (MapType0Select Heap@7 n$0@@3 right))
 :pattern ( (MapType1Select QPMask@1 n$0@@3 right))
 :pattern ( (MapType2Select nodes@0 n$0@@3))
)) (forall ((o_3@@11 T@U) ) (!  (=> (= (type o_3@@11) RefType) (=> (and (U_2_bool (MapType2Select nodes@0 (invRecv23 o_3@@11))) (and (< NoPerm FullPerm) (qpRange23 o_3@@11))) (= (invRecv23 o_3@@11) o_3@@11)))
 :qid |stdinbpl.2048:24|
 :skolemid |252|
 :pattern ( (invRecv23 o_3@@11))
))) (and (forall ((o_3@@12 T@U) ) (!  (=> (= (type o_3@@12) RefType) (and (=> (and (U_2_bool (MapType2Select nodes@0 (invRecv23 o_3@@12))) (and (< NoPerm FullPerm) (qpRange23 o_3@@12))) (and (= (invRecv23 o_3@@12) o_3@@12) (= (U_2_real (MapType1Select QPMask@1 o_3@@12 right)) (- (U_2_real (MapType1Select QPMask@0 o_3@@12 right)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select nodes@0 (invRecv23 o_3@@12))) (and (< NoPerm FullPerm) (qpRange23 o_3@@12)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@12 right)) (U_2_real (MapType1Select QPMask@0 o_3@@12 right))))))
 :qid |stdinbpl.2054:24|
 :skolemid |253|
 :pattern ( (MapType1Select QPMask@1 o_3@@12 right))
)) (forall ((o_3@@13 T@U) (f_5@@3 T@U) ) (! (let ((B@@15 (FieldTypeInv1 (type f_5@@3))))
(let ((A@@16 (FieldTypeInv0 (type f_5@@3))))
 (=> (and (and (= (type o_3@@13) RefType) (= (type f_5@@3) (FieldType A@@16 B@@15))) (not (= f_5@@3 right))) (= (U_2_real (MapType1Select QPMask@0 o_3@@13 f_5@@3)) (U_2_real (MapType1Select QPMask@1 o_3@@13 f_5@@3))))))
 :qid |stdinbpl.2060:31|
 :skolemid |254|
 :pattern ( (MapType1Select QPMask@1 o_3@@13 f_5@@3))
)))) (and (=> (= (ControlFlow 0 32) (- 0 34)) (forall ((n$1 T@U) (n$1_4 T@U) ) (!  (=> (and (= (type n$1) RefType) (= (type n$1_4) RefType)) (=> (and (and (and (and (not (= n$1 n$1_4)) (U_2_bool (MapType2Select nodes@0 n$1))) (U_2_bool (MapType2Select nodes@0 n$1_4))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1 n$1_4))))
 :qid |stdinbpl.2072:19|
 :skolemid |255|
 :pattern ( (neverTriggered24 n$1) (neverTriggered24 n$1_4))
))) (=> (forall ((n$1@@0 T@U) (n$1_4@@0 T@U) ) (!  (=> (and (= (type n$1@@0) RefType) (= (type n$1_4@@0) RefType)) (=> (and (and (and (and (not (= n$1@@0 n$1_4@@0)) (U_2_bool (MapType2Select nodes@0 n$1@@0))) (U_2_bool (MapType2Select nodes@0 n$1_4@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1@@0 n$1_4@@0))))
 :qid |stdinbpl.2072:19|
 :skolemid |255|
 :pattern ( (neverTriggered24 n$1@@0) (neverTriggered24 n$1_4@@0))
)) (and (=> (= (ControlFlow 0 32) (- 0 33)) (forall ((n$1@@1 T@U) ) (!  (=> (and (= (type n$1@@1) RefType) (U_2_bool (MapType2Select nodes@0 n$1@@1))) (>= (U_2_real (MapType1Select QPMask@1 n$1@@1 is_marked)) FullPerm))
 :qid |stdinbpl.2079:19|
 :skolemid |256|
 :pattern ( (MapType0Select Heap@7 n$1@@1 is_marked))
 :pattern ( (MapType1Select QPMask@2 n$1@@1 is_marked))
 :pattern ( (MapType2Select nodes@0 n$1@@1))
))) (=> (forall ((n$1@@2 T@U) ) (!  (=> (and (= (type n$1@@2) RefType) (U_2_bool (MapType2Select nodes@0 n$1@@2))) (>= (U_2_real (MapType1Select QPMask@1 n$1@@2 is_marked)) FullPerm))
 :qid |stdinbpl.2079:19|
 :skolemid |256|
 :pattern ( (MapType0Select Heap@7 n$1@@2 is_marked))
 :pattern ( (MapType1Select QPMask@2 n$1@@2 is_marked))
 :pattern ( (MapType2Select nodes@0 n$1@@2))
)) (=> (and (and (forall ((n$1@@3 T@U) ) (!  (=> (= (type n$1@@3) RefType) (=> (and (U_2_bool (MapType2Select nodes@0 n$1@@3)) (< NoPerm FullPerm)) (and (qpRange24 n$1@@3) (= (invRecv24 n$1@@3) n$1@@3))))
 :qid |stdinbpl.2085:24|
 :skolemid |257|
 :pattern ( (MapType0Select Heap@7 n$1@@3 is_marked))
 :pattern ( (MapType1Select QPMask@2 n$1@@3 is_marked))
 :pattern ( (MapType2Select nodes@0 n$1@@3))
)) (forall ((o_3@@14 T@U) ) (!  (=> (= (type o_3@@14) RefType) (=> (and (U_2_bool (MapType2Select nodes@0 (invRecv24 o_3@@14))) (and (< NoPerm FullPerm) (qpRange24 o_3@@14))) (= (invRecv24 o_3@@14) o_3@@14)))
 :qid |stdinbpl.2089:24|
 :skolemid |258|
 :pattern ( (invRecv24 o_3@@14))
))) (and (forall ((o_3@@15 T@U) ) (!  (=> (= (type o_3@@15) RefType) (and (=> (and (U_2_bool (MapType2Select nodes@0 (invRecv24 o_3@@15))) (and (< NoPerm FullPerm) (qpRange24 o_3@@15))) (and (= (invRecv24 o_3@@15) o_3@@15) (= (U_2_real (MapType1Select QPMask@2 o_3@@15 is_marked)) (- (U_2_real (MapType1Select QPMask@1 o_3@@15 is_marked)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select nodes@0 (invRecv24 o_3@@15))) (and (< NoPerm FullPerm) (qpRange24 o_3@@15)))) (= (U_2_real (MapType1Select QPMask@2 o_3@@15 is_marked)) (U_2_real (MapType1Select QPMask@1 o_3@@15 is_marked))))))
 :qid |stdinbpl.2095:24|
 :skolemid |259|
 :pattern ( (MapType1Select QPMask@2 o_3@@15 is_marked))
)) (forall ((o_3@@16 T@U) (f_5@@4 T@U) ) (! (let ((B@@16 (FieldTypeInv1 (type f_5@@4))))
(let ((A@@17 (FieldTypeInv0 (type f_5@@4))))
 (=> (and (and (= (type o_3@@16) RefType) (= (type f_5@@4) (FieldType A@@17 B@@16))) (not (= f_5@@4 is_marked))) (= (U_2_real (MapType1Select QPMask@1 o_3@@16 f_5@@4)) (U_2_real (MapType1Select QPMask@2 o_3@@16 f_5@@4))))))
 :qid |stdinbpl.2101:31|
 :skolemid |260|
 :pattern ( (MapType1Select QPMask@2 o_3@@16 f_5@@4))
...
(let ((anon28_Else_correct  (=> (and (not (U_2_bool (MapType2Select nodes@0 n_1))) (= (ControlFlow 0 8) 5)) anon7_correct)))
(let ((anon28_Then_correct  (=> (U_2_bool (MapType2Select nodes@0 n_1)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (not (U_2_bool (MapType0Select Heap@7 n_1 is_marked)))) (=> (not (U_2_bool (MapType0Select Heap@7 n_1 is_marked))) (=> (= (ControlFlow 0 6) 5) anon7_correct))))))
(let ((anon3_correct true))
(let ((anon26_Else_correct  (=> (and (not (U_2_bool (MapType2Select nodes@0 n_10))) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon26_Then_correct  (=> (U_2_bool (MapType2Select nodes@0 n_10)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@5 n_10 is_marked)) (=> (HasDirectPerm Mask@5 n_10 is_marked) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 a_2 $allocated)) (U_2_bool (MapType0Select Heap@@9 b_2 $allocated))) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@9 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@9 freshObj@0 $allocated (bool_2_U true)))) (and (and (= Mask@0 (MapType1Store ZeroMask freshObj@0 left (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 left)) FullPerm)))) (= Mask@1 (MapType1Store Mask@0 freshObj@0 right (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@0 right)) FullPerm))))) (and (= Mask@2 (MapType1Store Mask@1 freshObj@0 is_marked (real_2_U (+ (U_2_real (MapType1Select Mask@1 freshObj@0 is_marked)) FullPerm)))) (state Heap@0 Mask@2)))) (and (=> (= (ControlFlow 0 41) (- 0 47)) (= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 is_marked)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 is_marked))) (=> (and (= Heap@1 (MapType0Store Heap@0 freshObj@0 is_marked (bool_2_U false))) (state Heap@1 Mask@2)) (=> (and (and (and (not (= freshObj@1 null)) (not (U_2_bool (MapType0Select Heap@1 freshObj@1 $allocated)))) (= Heap@2 (MapType0Store Heap@1 freshObj@1 $allocated (bool_2_U true)))) (and (and (= Mask@3 (MapType1Store Mask@2 freshObj@1 left (real_2_U (+ (U_2_real (MapType1Select Mask@2 freshObj@1 left)) FullPerm)))) (= Mask@4 (MapType1Store Mask@3 freshObj@1 right (real_2_U (+ (U_2_real (MapType1Select Mask@3 freshObj@1 right)) FullPerm))))) (and (= Mask@5 (MapType1Store Mask@4 freshObj@1 is_marked (real_2_U (+ (U_2_real (MapType1Select Mask@4 freshObj@1 is_marked)) FullPerm)))) (state Heap@2 Mask@5)))) (and (=> (= (ControlFlow 0 41) (- 0 46)) (= FullPerm (U_2_real (MapType1Select Mask@5 freshObj@1 is_marked)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@5 freshObj@1 is_marked))) (=> (and (= Heap@3 (MapType0Store Heap@2 freshObj@1 is_marked (bool_2_U false))) (state Heap@3 Mask@5)) (and (=> (= (ControlFlow 0 41) (- 0 45)) (= FullPerm (U_2_real (MapType1Select Mask@5 freshObj@0 left)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@5 freshObj@0 left))) (=> (and (= Heap@4 (MapType0Store Heap@3 freshObj@0 left freshObj@1)) (state Heap@4 Mask@5)) (and (=> (= (ControlFlow 0 41) (- 0 44)) (= FullPerm (U_2_real (MapType1Select Mask@5 freshObj@0 right)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@5 freshObj@0 right))) (=> (and (= Heap@5 (MapType0Store Heap@4 freshObj@0 right null)) (state Heap@5 Mask@5)) (and (=> (= (ControlFlow 0 41) (- 0 43)) (= FullPerm (U_2_real (MapType1Select Mask@5 freshObj@1 left)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@5 freshObj@1 left))) (=> (and (= Heap@6 (MapType0Store Heap@5 freshObj@1 left null)) (state Heap@6 Mask@5)) (and (=> (= (ControlFlow 0 41) (- 0 42)) (= FullPerm (U_2_real (MapType1Select Mask@5 freshObj@1 right)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@5 freshObj@1 right))) (=> (and (and (= Heap@7 (MapType0Store Heap@6 freshObj@1 right freshObj@0)) (state Heap@7 Mask@5)) (and (= nodes@0 (|Set#UnionOne| (|Set#Singleton| freshObj@1) freshObj@0)) (state Heap@7 Mask@5))) (and (and (and (and (=> (= (ControlFlow 0 41) 32) anon27_Else_correct) (=> (= (ControlFlow 0 41) 6) anon28_Then_correct)) (=> (= (ControlFlow 0 41) 8) anon28_Else_correct)) (=> (= (ControlFlow 0 41) 2) anon26_Then_correct)) (=> (= (ControlFlow 0 41) 4) anon26_Else_correct))))))))))))))))))))))))))
