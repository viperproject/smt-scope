...
(declare-fun getRandomNumber (T@U) Int)
(declare-fun |getRandomNumber'| (T@U) Int)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |getRandomNumber#triggerStateless| () Int)
(declare-fun NoPerm () Real)
(declare-fun FullPerm () Real)
(declare-fun |getRandomNumber#frame| (T@U) Int)
...
(assert (forall ((Heap@@5 T@U) ) (!  (=> (= (type Heap@@5) (MapType0Type RefType)) (and (= (getRandomNumber Heap@@5) (|getRandomNumber'| Heap@@5)) (dummyFunction (int_2_U |getRandomNumber#triggerStateless|))))
 :qid |stdinbpl.185:15|
 :skolemid |22|
 :pattern ( (getRandomNumber Heap@@5))
)))
...
(assert (forall ((Heap@@8 T@U) ) (!  (=> (= (type Heap@@8) (MapType0Type RefType)) (dummyFunction (int_2_U |getRandomNumber#triggerStateless|)))
 :qid |stdinbpl.189:15|
 :skolemid |23|
 :pattern ( (|getRandomNumber'| Heap@@8))
)))
...
(assert (forall ((Heap@@10 T@U) (Mask@@9 T@U) ) (!  (=> (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (state Heap@@10 Mask@@9)) (= (|getRandomNumber'| Heap@@10) (|getRandomNumber#frame| EmptyFrame)))
 :qid |stdinbpl.202:15|
 :skolemid |25|
 :pattern ( (state Heap@@10 Mask@@9) (|getRandomNumber'| Heap@@10))
)))
...
(assert (forall ((Heap@@12 T@U) (Mask@@10 T@U) ) (!  (=> (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (and (state Heap@@12 Mask@@10) (< AssumeFunctionsAbove 0))) (= (getRandomNumber Heap@@12) 4))
 :qid |stdinbpl.195:15|
 :skolemid |24|
 :pattern ( (state Heap@@12 Mask@@10) (getRandomNumber Heap@@12))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon6_Else_correct  (=> (= b_2@0 (* a_2 (getRandomNumber Heap@@13))) (=> (and (state Heap@@13 ZeroMask) (= (ControlFlow 0 4) (- 0 3))) (> b_2@0 0)))))
(let ((anon6_Then_correct true))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (> a_2 0) (state Heap@@13 ZeroMask))) (and (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 2) anon6_Then_correct)) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
