...
(assert  (and (= (type x@@20) ArrayDomainTypeType) (= (type Heap@@17) (MapType0Type RefType))))
(set-info :boogie-vc-id |hide1#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct true))
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= 0 i_1@@18)) (=> (<= 0 i_1@@18) (=> (= (ControlFlow 0 2) (- 0 1)) (< i_1@@18 (alen x@@20)))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (> n@@11 0)) (=> (and (and (>= i_1@@18 0) (< i_1@@18 n@@11)) (and (= (alen x@@20) n@@11) (state Heap@@17 ZeroMask))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))))
