...
(declare-const z@4@00 $Ref)
(push) ; 2
; [eval] (z in xs)
(assert (Set_in z@4@00 xs@0@00))
(pop) ; 2
...
(push) ; 2
(assert (not (forall ((z1@4@00 $Ref) (z2@4@00 $Ref)) (!
  (=>
    (and (Set_in z1@4@00 xs@0@00) (Set_in z2@4@00 xs@0@00) (= z1@4@00 z2@4@00))
    (= z1@4@00 z2@4@00))
...
(assert (forall ((z@4@00 $Ref)) (!
  (=> (Set_in z@4@00 xs@0@00) (not (= z@4@00 $Ref.null)))
  :pattern ((Set_in z@4@00 xs@0@00))
  :pattern ((inv@5@00 s@$ xs@0@00 x@1@00 n@2@00 z@4@00))
  :pattern ((img@6@00 s@$ xs@0@00 x@1@00 n@2@00 z@4@00))
...
(check-sat)
; unknown
; [eval] (n == 0 ? x.f : fun(xs, x, n - 1))
; [eval] n == 0
(set-option :timeout 0)
(push) ; 2
(push) ; 3
(set-option :timeout 10)
(assert (not (not (= n@2@00 0))))
(check-sat)
; unknown
(pop) ; 3
; 0,00s
...
; 0,00s
; (get-info :all-statistics)
; [then-branch: 0 | n@2@00 == 0 | live]
; [else-branch: 0 | n@2@00 != 0 | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 0 | n@2@00 == 0]
(assert (= n@2@00 0))
(push) ; 4
(assert (not (and
  (img@6@00 s@$ xs@0@00 x@1@00 n@2@00 x@1@00)
  (Set_in (inv@5@00 s@$ xs@0@00 x@1@00 n@2@00 x@1@00) xs@0@00))))
(check-sat)
; unsat
(pop) ; 4
; 0,00s
...
(pop) ; 3
(push) ; 3
; [else-branch: 0 | n@2@00 != 0]
(assert (not (= n@2@00 0)))
; [eval] fun(xs, x, n - 1)
; [eval] n - 1
(push) ; 4
(declare-const z@7@00 $Ref)
(push) ; 5
; [eval] (z in xs)
(assert (Set_in z@7@00 xs@0@00))
(pop) ; 5
...
; Check receiver injectivity
(push) ; 5
(assert (not (forall ((z1@7@00 $Ref) (z2@7@00 $Ref)) (!
  (=>
    (and (Set_in z1@7@00 xs@0@00) (Set_in z2@7@00 xs@0@00) (= z1@7@00 z2@7@00))
    (= z1@7@00 z2@7@00))
    ...
    (-
      ...
      (ite
        (and
          (Set_in (inv@8@00 s@$ xs@0@00 x@1@00 n@2@00 r) xs@0@00)
          (img@9@00 s@$ xs@0@00 x@1@00 n@2@00 r)
          (= r (inv@8@00 s@$ xs@0@00 x@1@00 n@2@00 r)))
        ($Perm.min
          (ite
            (and
              (img@6@00 s@$ xs@0@00 x@1@00 n@2@00 r)
...
(assert (=>
  ...
  (and
    ...
    (fun%precondition ($Snap.combine
      ($SortWrappers.$FVF<f>To$Snap (sm@10@00 s@$ xs@0@00 x@1@00 n@2@00))
      ($Snap.combine $Snap.unit $Snap.unit)) xs@0@00 x@1@00 (- n@2@00 1)))))
(assert (or (not (= n@2@00 0)) (= n@2@00 0)))
(assert (=
  result@3@00
  (ite
    (= n@2@00 0)
