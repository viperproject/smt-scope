...
(assert  (and (and (and (and (= (type xs) (MapType2Type RefType boolType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv2 arg0@@43)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (U_2_bool (MapType2Select xs z_1))) (U_2_bool (MapType2Select xs z_1_1))) (< NoPerm k)) (< NoPerm k)) (not (= z_1 z_1_1))))
 :qid |stdinbpl.519:15|
 :skolemid |88|
 :no-pattern (type z_1)
...
))) (=> (forall ((z_1@@0 T@U) (z_1_1@@0 T@U) ) (!  (=> (and (= (type z_1@@0) RefType) (= (type z_1_1@@0) RefType)) (=> (and (and (and (and (not (= z_1@@0 z_1_1@@0)) (U_2_bool (MapType2Select xs z_1@@0))) (U_2_bool (MapType2Select xs z_1_1@@0))) (< NoPerm k)) (< NoPerm k)) (not (= z_1@@0 z_1_1@@0))))
 :qid |stdinbpl.519:15|
 :skolemid |88|
...
)) (=> (and (forall ((z_1@@1 T@U) ) (!  (=> (= (type z_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs z_1@@1)) (< NoPerm k)) (and (qpRange2 z_1@@1) (= (invRecv2 z_1@@1) z_1@@1))))
 :qid |stdinbpl.525:22|
 :skolemid |89|
 :pattern ( (MapType0Select Heap@@9 z_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@1 f_7))
 :pattern ( (MapType2Select xs z_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv2 o_3))) (< NoPerm k)) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.529:22|
 :skolemid |90|
 :pattern ( (invRecv2 o_3))
))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((z_1@@2 T@U) ) (!  (=> (and (= (type z_1@@2) RefType) (U_2_bool (MapType2Select xs z_1@@2))) (>= k NoPerm))
 :qid |stdinbpl.535:15|
 :skolemid |91|
 :pattern ( (MapType0Select Heap@@9 z_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@2 f_7))
 :pattern ( (MapType2Select xs z_1@@2))
))) (=> (forall ((z_1@@3 T@U) ) (!  (=> (and (= (type z_1@@3) RefType) (U_2_bool (MapType2Select xs z_1@@3))) (>= k NoPerm))
 :qid |stdinbpl.535:15|
 :skolemid |91|
 :pattern ( (MapType0Select Heap@@9 z_1@@3 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@3 f_7))
 :pattern ( (MapType2Select xs z_1@@3))
)) (=> (and (forall ((z_1@@4 T@U) ) (!  (=> (= (type z_1@@4) RefType) (=> (and (U_2_bool (MapType2Select xs z_1@@4)) (> k NoPerm)) (not (= z_1@@4 null))))
 :qid |stdinbpl.541:22|
 :skolemid |92|
 :pattern ( (MapType0Select Heap@@9 z_1@@4 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@4 f_7))
 :pattern ( (MapType2Select xs z_1@@4))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs (invRecv2 o_3@@0))) (< NoPerm k)) (qpRange2 o_3@@0)) (and (=> (< NoPerm k) (= (invRecv2 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) k)))) (=> (not (and (and (U_2_bool (MapType2Select xs (invRecv2 o_3@@0))) (< NoPerm k)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.547:22|
 :skolemid |93|
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (= (ControlFlow 0 3) (- 0 2)))) (not (= x@@19 null)))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@19 $allocated))) (=> (and (and (U_2_bool (MapType2Select xs x@@19)) (state Heap@@9 ZeroMask)) (and (<= NoPerm k) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 6) 1) anon3_Then_correct) (=> (= (ControlFlow 0 6) 3) anon3_Else_correct))))))
