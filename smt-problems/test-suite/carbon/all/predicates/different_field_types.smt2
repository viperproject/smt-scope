...
(assert  (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type x@@18) RefType)) (= (type Heap@@14) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |fun#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_correct true))
(let ((anon8_Else_correct  (=> (not b_2@@9) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@2 x@@18 g)) (=> (HasDirectPerm Mask@2 x@@18 g) (=> (= (ControlFlow 0 4) 1) anon6_correct))))))
(let ((anon8_Then_correct  (=> b_2@@9 (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@2 x@@18 f_7)) (=> (HasDirectPerm Mask@2 x@@18 f_7) (=> (= (ControlFlow 0 2) 1) anon6_correct))))))
(let ((anon3_correct  (=> (state Heap@@14 Mask@2) (and (=> (= (ControlFlow 0 6) 2) anon8_Then_correct) (=> (= (ControlFlow 0 6) 4) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (not b_2@@9) (not (= x@@18 null))) (=> (and (and (= Mask@1 (MapType1Store ZeroMask x@@18 g (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@18 g)) FullPerm)))) (state Heap@@14 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 8) 6))) anon3_correct))))
(let ((anon7_Then_correct  (=> (and b_2@@9 (not (= x@@18 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask x@@18 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@18 f_7)) FullPerm)))) (state Heap@@14 Mask@0)) (and (= Mask@2 Mask@0) (= (ControlFlow 0 7) 6))) anon3_correct))))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@14 x@@18 $allocated)) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 9) 7) anon7_Then_correct) (=> (= (ControlFlow 0 9) 8) anon7_Else_correct))))))
