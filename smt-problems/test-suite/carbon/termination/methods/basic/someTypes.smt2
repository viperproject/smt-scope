...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 66) (let ((anon47_Then_correct  (=> (= (ControlFlow 0 49) (- 0 48)) (> (U_2_real (MapType1Select Mask@5 null (list (MapType0Select Heap@1 xs@@8 next)))) NoPerm))))
(let ((anon56_Then_correct  (=> (= (ControlFlow 0 26) (- 0 25)) (> (U_2_real (MapType1Select Mask@0 null (list xs@@8))) NoPerm))))
(let ((anon59_Then_correct  (=> (= (ControlFlow 0 22) (- 0 21)) (> (U_2_real (MapType1Select Mask@0 null (list xs@@8))) NoPerm))))
(let ((anon58_Then_correct  (=> (= (ControlFlow 0 20) (- 0 19)) (> (U_2_real (MapType1Select Mask@10 null (list xs@@8))) NoPerm))))
(let ((anon40_correct true))
(let ((anon61_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon40_correct)))
(let ((anon61_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@12 null (list xs@@8))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@12 null (list xs@@8)))) (=> (= (ControlFlow 0 9) 8) anon40_correct))))))
(let ((anon38_correct  (=> (and (= Mask@11 (MapType1Store Mask@10 null (list xs@@8) (real_2_U (- (U_2_real (MapType1Select Mask@10 null (list xs@@8))) FullPerm)))) (IdenticalOnKnownLocations Heap@7 ExhaleHeap@4 Mask@11)) (=> (and (and (= Mask@12 (MapType1Store Mask@11 null (list xs@@8) (real_2_U (+ (U_2_real (MapType1Select Mask@11 null (list xs@@8))) FullPerm)))) (state ExhaleHeap@4 Mask@12)) (and (state ExhaleHeap@4 Mask@12) (state ExhaleHeap@4 Mask@12))) (and (=> (= (ControlFlow 0 12) 9) anon61_Then_correct) (=> (= (ControlFlow 0 12) 11) anon61_Else_correct))))))
(let ((anon60_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 15) 12)) anon38_correct)))
(let ((anon60_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= FullPerm (U_2_real (MapType1Select Mask@10 null (list xs@@8))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@10 null (list xs@@8)))) (=> (= (ControlFlow 0 13) 12) anon38_correct))))))
(let ((anon36_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (and (decreasing (PI_list Heap@7 xs@@8) (PI_list Heap@@13 xs@@8)) (bounded (PI_list Heap@@13 xs@@8)))) (=> (and (decreasing (PI_list Heap@7 xs@@8) (PI_list Heap@@13 xs@@8)) (bounded (PI_list Heap@@13 xs@@8))) (=> (state Heap@7 Mask@10) (and (=> (= (ControlFlow 0 16) 13) anon60_Then_correct) (=> (= (ControlFlow 0 16) 15) anon60_Else_correct)))))))
(let ((anon57_Then_correct  (=> (not (and (decreasing (PI_list Heap@7 xs@@8) (PI_list Heap@@13 xs@@8)) (bounded (PI_list Heap@@13 xs@@8)))) (and (and (=> (= (ControlFlow 0 23) 20) anon58_Then_correct) (=> (= (ControlFlow 0 23) 22) anon59_Then_correct)) (=> (= (ControlFlow 0 23) 16) anon36_correct)))))
(let ((anon57_Else_correct  (=> (and (and (decreasing (PI_list Heap@7 xs@@8) (PI_list Heap@@13 xs@@8)) (bounded (PI_list Heap@@13 xs@@8))) (= (ControlFlow 0 18) 16)) anon36_correct)))
(let ((anon55_Then_correct  (=> (decreasing (PI_list Heap@7 xs@@8) (PI_list Heap@@13 xs@@8)) (and (and (=> (= (ControlFlow 0 27) 26) anon56_Then_correct) (=> (= (ControlFlow 0 27) 23) anon57_Then_correct)) (=> (= (ControlFlow 0 27) 18) anon57_Else_correct)))))
(let ((anon55_Else_correct  (=> (not (decreasing (PI_list Heap@7 xs@@8) (PI_list Heap@@13 xs@@8))) (and (=> (= (ControlFlow 0 24) 23) anon57_Then_correct) (=> (= (ControlFlow 0 24) 18) anon57_Else_correct)))))
(let ((anon54_Then_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (> (U_2_real (MapType1Select Mask@0 null (list xs@@8))) NoPerm))))
(let ((anon53_Then_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (> (U_2_real (MapType1Select Mask@10 null (list xs@@8))) NoPerm))))
(let ((anon24_correct  (=> (and (state Heap@7 Mask@10) (state Heap@7 Mask@10)) (and (and (and (=> (= (ControlFlow 0 28) 5) anon53_Then_correct) (=> (= (ControlFlow 0 28) 7) anon54_Then_correct)) (=> (= (ControlFlow 0 28) 27) anon55_Then_correct)) (=> (= (ControlFlow 0 28) 24) anon55_Else_correct)))))
(let ((anon52_Else_correct  (=> (= (MapType0Select Heap@5 xs@@8 next) null) (=> (and (= Heap@7 Heap@5) (= (ControlFlow 0 30) 28)) anon24_correct))))
(let ((anon52_Then_correct  (=> (not (= (MapType0Select Heap@5 xs@@8 next) null)) (=> (and (and (forall ((o_4 T@U) (f_8 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_8))))
(let ((A@@12 (FieldTypeInv0 (type f_8))))
 (=> (and (and (= (type o_4) RefType) (= (type f_8) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@5 null (|list#sm| xs@@8)) o_4 f_8)) (U_2_bool (MapType1Select (MapType0Select Heap@5 null (|list#sm| (MapType0Select Heap@5 xs@@8 next))) o_4 f_8)))) (U_2_bool (MapType1Select newPMask@0 o_4 f_8)))))
 :qid |stdinbpl.890:29|
 :skolemid |36|
 :pattern ( (MapType1Select newPMask@0 o_4 f_8))
)) (= Heap@6 (MapType0Store Heap@5 null (|list#sm| xs@@8) newPMask@0))) (and (= Heap@7 Heap@6) (= (ControlFlow 0 29) 28))) anon24_correct))))
(let ((anon22_correct  (=> (= Heap@5 (MapType0Store Heap@4 null (|list#sm| xs@@8) (MapType1Store (MapType0Select Heap@4 null (|list#sm| xs@@8)) xs@@8 next (bool_2_U true)))) (and (=> (= (ControlFlow 0 31) 29) anon52_Then_correct) (=> (= (ControlFlow 0 31) 30) anon52_Else_correct)))))
(let ((anon51_Else_correct  (=> (HasDirectPerm Mask@10 null (list xs@@8)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 33) 31)) anon22_correct))))
(let ((anon51_Then_correct  (=> (not (HasDirectPerm Mask@10 null (list xs@@8))) (=> (and (and (= Heap@2 (MapType0Store Heap@1 null (|list#sm| xs@@8) ZeroPMask)) (= Heap@3 (MapType0Store Heap@2 null (list xs@@8) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 32) 31))) anon22_correct))))
(let ((anon20_correct  (=> (= Mask@10 (MapType1Store Mask@9 null (list xs@@8) (real_2_U (+ (U_2_real (MapType1Select Mask@9 null (list xs@@8))) FullPerm)))) (=> (and (and (state Heap@1 Mask@10) (state Heap@1 Mask@10)) (and (|list#trigger| Heap@1 (list xs@@8)) (= (MapType0Select Heap@1 null (list xs@@8)) (CombineFrames (FrameFragment (MapType0Select Heap@1 xs@@8 next)) (FrameFragment (ite (not (= (MapType0Select Heap@1 xs@@8 next) null)) (MapType0Select Heap@1 null (list (MapType0Select Heap@1 xs@@8 next))) EmptyFrame)))))) (and (=> (= (ControlFlow 0 34) 32) anon51_Then_correct) (=> (= (ControlFlow 0 34) 33) anon51_Else_correct))))))
(let ((anon19_correct  (=> (and (and (= Mask@8 (MapType1Store Mask@7 null (list (MapType0Select Heap@1 xs@@8 next)) (real_2_U (- (U_2_real (MapType1Select Mask@7 null (list (MapType0Select Heap@1 xs@@8 next)))) FullPerm)))) (InsidePredicate (list xs@@8) (MapType0Select Heap@1 null (list xs@@8)) (list (MapType0Select Heap@1 xs@@8 next)) (MapType0Select Heap@1 null (list (MapType0Select Heap@1 xs@@8 next))))) (and (= Mask@9 Mask@8) (= (ControlFlow 0 36) 34))) anon20_correct)))
(let ((anon50_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 39) 36)) anon19_correct)))
(let ((anon50_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 37) (- 0 38)) (<= FullPerm (U_2_real (MapType1Select Mask@7 null (list (MapType0Select Heap@1 xs@@8 next)))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@7 null (list (MapType0Select Heap@1 xs@@8 next))))) (=> (= (ControlFlow 0 37) 36) anon19_correct))))))
(let ((anon49_Then_correct  (=> (not (= (MapType0Select Heap@1 xs@@8 next) null)) (and (=> (= (ControlFlow 0 40) 37) anon50_Then_correct) (=> (= (ControlFlow 0 40) 39) anon50_Else_correct)))))
(let ((anon49_Else_correct  (=> (= (MapType0Select Heap@1 xs@@8 next) null) (=> (and (= Mask@9 Mask@7) (= (ControlFlow 0 35) 34)) anon20_correct))))
(let ((anon16_correct  (=> (= Mask@7 (MapType1Store Mask@5 xs@@8 next (real_2_U (- (U_2_real (MapType1Select Mask@5 xs@@8 next)) FullPerm)))) (and (=> (= (ControlFlow 0 41) 40) anon49_Then_correct) (=> (= (ControlFlow 0 41) 35) anon49_Else_correct)))))
(let ((anon48_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 44) 41)) anon16_correct)))
(let ((anon48_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 42) (- 0 43)) (<= FullPerm (U_2_real (MapType1Select Mask@5 xs@@8 next)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@5 xs@@8 next))) (=> (= (ControlFlow 0 42) 41) anon16_correct))))))
(let ((anon14_correct  (=> (state Heap@1 Mask@5) (and (=> (= (ControlFlow 0 45) (- 0 46)) (HasDirectPerm Mask@5 xs@@8 next)) (=> (HasDirectPerm Mask@5 xs@@8 next) (=> (state Heap@1 Mask@5) (and (=> (= (ControlFlow 0 45) 42) anon48_Then_correct) (=> (= (ControlFlow 0 45) 44) anon48_Else_correct))))))))
(let ((anon47_Else_correct  (=> (and (= list_16816818320@0 (PI_list Heap@1 (MapType0Select Heap@1 xs@@8 next))) (state Heap@1 Mask@5)) (=> (and (and (nestedPredicates list_16816818320@0 list__169813300@0) (state Heap@1 Mask@5)) (and (state Heap@1 Mask@5) (= (ControlFlow 0 50) 45))) anon14_correct))))
(let ((anon46_Then_correct  (=> (not (= (MapType0Select Heap@1 xs@@8 next) null)) (and (=> (= (ControlFlow 0 51) (- 0 52)) (HasDirectPerm Mask@5 xs@@8 next)) (=> (HasDirectPerm Mask@5 xs@@8 next) (and (=> (= (ControlFlow 0 51) 49) anon47_Then_correct) (=> (= (ControlFlow 0 51) 50) anon47_Else_correct)))))))
(let ((anon46_Else_correct  (=> (and (= (MapType0Select Heap@1 xs@@8 next) null) (= (ControlFlow 0 47) 45)) anon14_correct)))
(let ((anon10_correct  (=> (and (state Heap@1 Mask@5) (state Heap@1 Mask@5)) (and (=> (= (ControlFlow 0 53) (- 0 54)) (HasDirectPerm Mask@5 xs@@8 next)) (=> (HasDirectPerm Mask@5 xs@@8 next) (and (=> (= (ControlFlow 0 53) 51) anon46_Then_correct) (=> (= (ControlFlow 0 53) 47) anon46_Else_correct)))))))
(let ((anon45_Else_correct  (=> (= (MapType0Select Heap@1 xs@@8 next) null) (=> (and (= Mask@5 Mask@3) (= (ControlFlow 0 56) 53)) anon10_correct))))
(let ((anon45_Then_correct  (=> (and (not (= (MapType0Select Heap@1 xs@@8 next) null)) (= Mask@4 (MapType1Store Mask@3 null (list (MapType0Select Heap@1 xs@@8 next)) (real_2_U (+ (U_2_real (MapType1Select Mask@3 null (list (MapType0Select Heap@1 xs@@8 next)))) FullPerm))))) (=> (and (and (InsidePredicate (list xs@@8) (MapType0Select Heap@1 null (list xs@@8)) (list (MapType0Select Heap@1 xs@@8 next)) (MapType0Select Heap@1 null (list (MapType0Select Heap@1 xs@@8 next)))) (state Heap@1 Mask@4)) (and (= Mask@5 Mask@4) (= (ControlFlow 0 55) 53))) anon10_correct))))
(let ((anon8_correct  (=> (not (= xs@@8 null)) (=> (and (= Mask@3 (MapType1Store Mask@2 xs@@8 next (real_2_U (+ (U_2_real (MapType1Select Mask@2 xs@@8 next)) FullPerm)))) (state Heap@1 Mask@3)) (and (=> (= (ControlFlow 0 57) 55) anon45_Then_correct) (=> (= (ControlFlow 0 57) 56) anon45_Else_correct))))))
(let ((anon44_Else_correct  (=> (HasDirectPerm Mask@2 null (list xs@@8)) (=> (and (= Heap@1 Heap@@13) (= (ControlFlow 0 59) 57)) anon8_correct))))
(let ((anon44_Then_correct  (=> (and (and (not (HasDirectPerm Mask@2 null (list xs@@8))) (= Heap@0 (MapType0Store Heap@@13 null (list xs@@8) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 58) 57))) anon8_correct)))
(let ((anon6_correct  (=> (= Mask@2 (MapType1Store Mask@0 null (list xs@@8) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (list xs@@8))) FullPerm)))) (and (=> (= (ControlFlow 0 60) 58) anon44_Then_correct) (=> (= (ControlFlow 0 60) 59) anon44_Else_correct)))))
(let ((anon43_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 63) 60)) anon6_correct)))
(let ((anon43_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 61) (- 0 62)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@8))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@8)))) (=> (= (ControlFlow 0 61) 60) anon6_correct))))))
(let ((anon42_Else_correct  (=> (and (and (= list__169813300@0 (PI_list Heap@@13 xs@@8)) (state Heap@@13 Mask@0)) (and (|list#trigger| Heap@@13 (list xs@@8)) (= (MapType0Select Heap@@13 null (list xs@@8)) (CombineFrames (FrameFragment (MapType0Select Heap@@13 xs@@8 next)) (FrameFragment (ite (not (= (MapType0Select Heap@@13 xs@@8 next) null)) (MapType0Select Heap@@13 null (list (MapType0Select Heap@@13 xs@@8 next))) EmptyFrame)))))) (and (=> (= (ControlFlow 0 64) 61) anon43_Then_correct) (=> (= (ControlFlow 0 64) 63) anon43_Else_correct)))))
(let ((anon42_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (> (U_2_real (MapType1Select Mask@0 null (list xs@@8))) NoPerm))))
(let ((anon41_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@13 xs@@8 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (list xs@@8) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (list xs@@8))) FullPerm))))) (and (state Heap@@13 Mask@0) (state Heap@@13 Mask@0))) (and (and (=> (= (ControlFlow 0 65) 1) anon41_Then_correct) (=> (= (ControlFlow 0 65) 3) anon42_Then_correct)) (=> (= (ControlFlow 0 65) 64) anon42_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (> wildcard NoPerm) true) (= (ControlFlow 0 66) 65)) anon0_correct)))
