...
(declare-fun c2 () T@U)
(declare-fun c1 () T@U)
(assert  (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type c2) RefType)) (= (type r_6) RefType)) (= (type c1) RefType)))
(set-info :boogie-vc-id test07b)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (not (HasDirectPerm Mask@0 r_6 val)) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (HasDirectPerm Mask@0 r_6 val) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@0 r_6 val)) (=> (HasDirectPerm Mask@0 r_6 val) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((r_1_1 T@U) ) (!  (=> (and (and (= (type r_1_1) RefType) (HasDirectPerm Mask@0 r_1_1 val)) (= r_1_1 c2)) false)
 :qid |stdinbpl.543:15|
 :skolemid |27|
 :pattern ( (MapType1Select Mask@0 r_1_1 val))
 :pattern ( (MapType0Select Heap@@9 r_1_1 val))
)))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 c1 $allocated))) (and (U_2_bool (MapType0Select Heap@@9 c2 $allocated)) (not (= c1 null)))) (and (and (= Mask@0 (MapType1Store ZeroMask c1 val (real_2_U (+ (U_2_real (MapType1Select ZeroMask c1 val)) FullPerm)))) (state Heap@@9 Mask@0)) (and (not (= c1 c2)) (state Heap@@9 Mask@0)))) (and (and (=> (= (ControlFlow 0 7) 2) anon5_Else_correct) (=> (= (ControlFlow 0 7) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))
