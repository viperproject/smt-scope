...
(assert  (and (and (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type c1) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type c2) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test01d)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon2_correct  (=> (= Mask@2 (MapType1Store Mask@1 c1 val (real_2_U (- (U_2_real (MapType1Select Mask@1 c1 val)) perm@2)))) (=> (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)) (=> (and (and (= c1 c2) (state ExhaleHeap@0 Mask@2)) (and (state ExhaleHeap@0 Mask@2) (= (ControlFlow 0 2) (- 0 1)))) false)))))
(let ((anon3_Else_correct  (=> (and (= perm@2 NoPerm) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= perm@2 NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= perm@2 (U_2_real (MapType1Select Mask@1 c1 val)))) (=> (<= perm@2 (U_2_real (MapType1Select Mask@1 c1 val))) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 c1 $allocated))) (and (U_2_bool (MapType0Select Heap@@9 c2 $allocated)) (= perm@0 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 6) (- 0 9)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= c1 null))) (= Mask@0 (MapType1Store ZeroMask c1 val (real_2_U (+ (U_2_real (MapType1Select ZeroMask c1 val)) perm@0))))) (and (state Heap@@9 Mask@0) (= perm@1 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (and (and (=> (> perm@1 NoPerm) (not (= c2 null))) (= Mask@1 (MapType1Store Mask@0 c2 val (real_2_U (+ (U_2_real (MapType1Select Mask@0 c2 val)) perm@1))))) (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1))) (and (and (<= (/ (to_real 1) (to_real 1)) (U_2_real (MapType1Select Mask@1 c1 val))) (state Heap@@9 Mask@1)) (and (state Heap@@9 Mask@1) (= perm@2 (/ (to_real 1) (to_real 2)))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))))))))))
