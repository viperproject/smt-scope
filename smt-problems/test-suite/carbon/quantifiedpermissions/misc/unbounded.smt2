...
(assert (forall ((x_2 T@U) ) (!  (=> (= (type x_2) RefType) (= (NN x_2) (not (= x_2 null))))
 :qid |stdinbpl.204:15|
 :skolemid |22|
 :pattern ( (NN x_2))
)))
...
(declare-fun y@@1 () T@U)
(declare-fun z@@0 () T@U)
(assert  (and (and (and (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type freshObj@0) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type x_4) RefType)) (forall ((arg0@@26 T@U) ) (! (= (type (invRecv2 arg0@@26)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@26))
))) (= (type y@@1) RefType)) (= (type z@@0) RefType)))
...
(let ((anon11_Then_correct  (=> (NN x_4) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm QPMask@0 x_4 f_7)) (=> (HasDirectPerm QPMask@0 x_4 f_7) (=> (= (ControlFlow 0 9) 7) anon6_correct))))))
...
(let ((anon9_Else_correct  (=> (forall ((x_3_1 T@U) ) (!  (=> (and (= (type x_3_1) RefType) (not (= x_3_1 null))) (and (NN x_3_1) (= (U_2_int (MapType0Select Heap@@9 x_3_1 f_7)) 0)))
 :qid |stdinbpl.429:20|
 :skolemid |36|
 :pattern ( (NN x_3_1))
)) (=> (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)) (=> (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@9 freshObj@0 $allocated)))) (and (= Heap@0 (MapType0Store Heap@@9 freshObj@0 $allocated (bool_2_U true))) (state Heap@0 QPMask@0))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (NN freshObj@0)) (=> (NN freshObj@0) (=> (state Heap@0 QPMask@0) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm QPMask@0 freshObj@0 f_7)) (=> (HasDirectPerm QPMask@0 freshObj@0 f_7) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= (U_2_int (MapType0Select Heap@0 freshObj@0 f_7)) 0)) (=> (= (U_2_int (MapType0Select Heap@0 freshObj@0 f_7)) 0) (=> (and (state Heap@0 QPMask@0) (= (ControlFlow 0 3) (- 0 2))) false)))))))))))))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (not (= x_1 null))) (not (= x_1_1 null))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.382:15|
 :skolemid |30|
 :no-pattern (type x_1)
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (not (= x_1@@0 null))) (not (= x_1_1@@0 null))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.382:15|
 :skolemid |30|
...
)) (=> (and (and (and (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (not (= x_1@@1 null)) (< NoPerm FullPerm)) (and (qpRange2 x_1@@1) (= (invRecv2 x_1@@1) x_1@@1))))
 :qid |stdinbpl.388:22|
 :skolemid |31|
 :pattern ( (MapType0Select Heap@@9 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (not (= (invRecv2 o_3) null)) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.392:22|
 :skolemid |32|
 :pattern ( (invRecv2 o_3))
))) (and (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (not (= x_1@@2 null))) (not (= x_1@@2 null)))
 :qid |stdinbpl.398:22|
 :skolemid |33|
 :pattern ( (MapType0Select Heap@@9 x_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@2 f_7))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (not (= (invRecv2 o_3@@0) null)) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (not (= (invRecv2 o_3@@0) null)) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.404:22|
 :skolemid |34|
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (and (=> (= (ControlFlow 0 13) 3) anon9_Else_correct) (=> (= (ControlFlow 0 13) 12) anon10_Then_correct)) (=> (= (ControlFlow 0 13) 8) anon10_Else_correct)))))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 y@@1 $allocated)) (U_2_bool (MapType0Select Heap@@9 z@@0 $allocated))) (and (=> (= (ControlFlow 0 15) 1) anon8_Then_correct) (=> (= (ControlFlow 0 15) 13) anon8_Else_correct))))))
