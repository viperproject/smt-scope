...
(assert  (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type this) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id t1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 this x@@8 (real_2_U (- (U_2_real (MapType1Select Mask@0 this x@@8)) FullPerm)))) (=> (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 this x@@8)) (=> (HasDirectPerm Mask@1 this x@@8) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (MapType0Select ExhaleHeap@0 this x@@8)) 1))))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@0 this x@@8)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 this x@@8))) (=> (= (ControlFlow 0 4) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 this $allocated)) (not (= this null))) (and (= Mask@0 (MapType1Store ZeroMask this x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this x@@8)) FullPerm)))) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 7) (- 0 14)) (HasDirectPerm Mask@0 this x@@8)) (=> (HasDirectPerm Mask@0 this x@@8) (=> (= (U_2_int (MapType0Select Heap@@9 this x@@8)) 1) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 7) (- 0 13)) (HasDirectPerm Mask@0 this x@@8)) (=> (HasDirectPerm Mask@0 this x@@8) (and (=> (= (ControlFlow 0 7) (- 0 12)) (= (U_2_int (MapType0Select Heap@@9 this x@@8)) 1)) (=> (= (U_2_int (MapType0Select Heap@@9 this x@@8)) 1) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 7) (- 0 11)) (HasDirectPerm Mask@0 this x@@8)) (=> (HasDirectPerm Mask@0 this x@@8) (and (=> (= (ControlFlow 0 7) (- 0 10)) (= (U_2_int (MapType0Select Heap@@9 this x@@8)) 1)) (=> (= (U_2_int (MapType0Select Heap@@9 this x@@8)) 1) (=> (state Heap@@9 Mask@0) (and (=> (= (ControlFlow 0 7) (- 0 9)) (HasDirectPerm Mask@0 this x@@8)) (=> (HasDirectPerm Mask@0 this x@@8) (and (=> (= (ControlFlow 0 7) (- 0 8)) (= (U_2_int (MapType0Select Heap@@9 this x@@8)) 1)) (=> (= (U_2_int (MapType0Select Heap@@9 this x@@8)) 1) (=> (state Heap@@9 Mask@0) (and (=> (= (ControlFlow 0 7) 4) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct)))))))))))))))))))))))))
...
(declare-fun Mask@0 () T@U)
(declare-fun Heap@@9 () T@U)
(assert  (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type this) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id exhaleExpression3WithRequires)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon8_Else_correct  (=> (not (= this null)) (=> (and (and (= PostMask@0 (MapType1Store ZeroMask this x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this x@@8)) FullPerm)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (= (ControlFlow 0 8) (- 0 7)))) (HasDirectPerm PostMask@0 this x@@8)))))
...
(let ((anon6_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 this x@@8 (real_2_U (- (U_2_real (MapType1Select Mask@0 this x@@8)) FullPerm)))) (= (ControlFlow 0 2) (- 0 1))) (= (U_2_int (MapType0Select Heap@@9 this x@@8)) 1))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon6_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 this x@@8)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 this x@@8))) (=> (= (ControlFlow 0 3) 2) anon6_correct))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 this $allocated)) (not (= this null))) (and (= Mask@0 (MapType1Store ZeroMask this x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this x@@8)) FullPerm)))) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm Mask@0 this x@@8)) (=> (HasDirectPerm Mask@0 this x@@8) (=> (and (= (U_2_int (MapType0Select Heap@@9 this x@@8)) 1) (state Heap@@9 Mask@0)) (and (and (=> (= (ControlFlow 0 10) 9) anon7_Then_correct) (=> (= (ControlFlow 0 10) 3) anon9_Then_correct)) (=> (= (ControlFlow 0 10) 5) anon9_Else_correct)))))))))
