...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon6_correct  (=> (not (= x@@11 null)) (=> (and (= Mask@1 (MapType1Store Mask@0 x@@11 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@11 f_7)) FullPerm)))) (state Heap@1 Mask@1)) (=> (and (and (= (U_2_int (MapType0Select Heap@1 x@@11 f_7)) 0) (state Heap@1 Mask@1)) (and (state Heap@1 Mask@1) (= (ControlFlow 0 3) (- 0 2)))) (= FullPerm (U_2_real (MapType1Select Mask@1 x@@11 f_7))))))))
(let ((anon9_Else_correct  (=> (HasDirectPerm Mask@0 null (p3 x@@11)) (=> (and (= Heap@1 Heap@@14) (= (ControlFlow 0 5) 3)) anon6_correct))))
(let ((anon9_Then_correct  (=> (and (and (not (HasDirectPerm Mask@0 null (p3 x@@11))) (= Heap@0 (MapType0Store Heap@@14 null (p3 x@@11) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 4) 3))) anon6_correct)))
(let ((anon4_correct  (=> (= Mask@0 (MapType1Store QPMask@0 null (p3 x@@11) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (p3 x@@11))) FullPerm)))) (and (=> (= (ControlFlow 0 6) 4) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon4_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p3 x@@11))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p3 x@@11)))) (=> (= (ControlFlow 0 7) 6) anon4_correct))))))
...
)) (=> (forall ((r_1@@1 T@U) ) (!  (=> (= (type r_1@@1) RefType) (=> (and (|Seq#Contains| xs r_1@@1) (< NoPerm FullPerm)) (and (= (invRecv4 r_1@@1) r_1@@1) (qpRange4 r_1@@1))))
...
)) (=> (and (and (and (forall ((r_2_1 T@U) ) (!  (=> (= (type r_2_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv4 r_2_1)) (< NoPerm FullPerm)) (qpRange4 r_2_1)) (= (invRecv4 r_2_1) r_2_1)))
 :qid |stdinbpl.1242:22|
 :skolemid |103|
 :pattern ( (invRecv4 r_2_1))
)) (forall ((r_2_1@@0 T@U) ) (!  (=> (= (type r_2_1@@0) RefType) (=> (and (and (|Seq#Contains| xs (invRecv4 r_2_1@@0)) (< NoPerm FullPerm)) (qpRange4 r_2_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 r_2_1@@0) r_2_1@@0)) (= (U_2_real (MapType1Select QPMask@0 null (p3 r_2_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (p3 r_2_1@@0))) FullPerm)))))
...
)) (forall ((r_2_1@@1 T@U) ) (!  (=> (and (= (type r_2_1@@1) RefType) (not (and (and (|Seq#Contains| xs (invRecv4 r_2_1@@1)) (< NoPerm FullPerm)) (qpRange4 r_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (p3 r_2_1@@1))) (U_2_real (MapType1Select ZeroMask null (p3 r_2_1@@1)))))
 :qid |stdinbpl.1258:22|
 :skolemid |106|
 :pattern ( (MapType1Select QPMask@0 null (p3 r_2_1@@1)))
)))) (and (and (state Heap@@14 QPMask@0) (state Heap@@14 QPMask@0)) (and (|p3#trigger| Heap@@14 (p3 x@@11)) (= (MapType0Select Heap@@14 null (p3 x@@11)) (FrameFragment (MapType0Select Heap@@14 x@@11 f_7)))))) (and (=> (= (ControlFlow 0 10) 7) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct))))))))
