...
(assert  (and (= (type a_3@@10) ArrayDomainTypeType) (= (type Heap@@16) (MapType0Type RefType))))
(set-info :boogie-vc-id |g#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_3 Int) (x_3_1 Int) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (and (<= 0 x_3) (< x_3 (len a_3@@10)))) (and (<= 0 x_3_1) (< x_3_1 (len a_3@@10)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@10 x_3) (loc a_3@@10 x_3_1))))
 :qid |stdinbpl.470:15|
 :skolemid |47|
)))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@16 ZeroMask) (= AssumeFunctionsAbove 1)) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
