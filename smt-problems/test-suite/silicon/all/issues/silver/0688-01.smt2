...
(check-sat)
; unknown
; ---------- FUNCTION lemmaLEqualR67----------
(declare-fun result@0@00 () Unit)
...
; [eval] L67()
; [eval] R67()
(assert (= (as L67<Int>  Int) (as R67<Int>  Int)))
(pop) ; 1
...
(check-sat)
; unknown
; [eval] (let x == (F67(L67(), R67())) in unit())
; [eval] F67(L67(), R67())
; [eval] L67()
; [eval] R67()
(declare-fun letvar@4@00 ($Snap) Int)
(assert (= (letvar@4@00 s@$) (F67<Int> (as L67<Int>  Int) (as R67<Int>  Int))))
; [eval] unit()
(assert (= result@0@00 (as unit<Unit>  Unit)))
; [eval] L67() == R67()
; [eval] L67()
; [eval] R67()
(set-option :timeout 0)
(push) ; 2
(assert (not (= (as L67<Int>  Int) (as R67<Int>  Int))))
(check-sat)
; unsat
(pop) ; 2
; 0,00s
