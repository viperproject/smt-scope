...
(assert  (and (and (and (and (and (= (type xs) (SeqType RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type y@@2) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@35 T@U) ) (! (= (type (invRecv4 arg0@@35)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon3_Else_correct  (=> (and (forall ((x_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (|Seq#Contains| xs x_1)) (not (= x_1 null)))
 :qid |stdinbpl.1085:20|
 :skolemid |77|
 :pattern ( (|Seq#ContainsTrigger| xs x_1))
 :pattern ( (|Seq#Contains| xs x_1))
)) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 3) (- 0 8)) (|Seq#Contains| xs y@@2)) (=> (|Seq#Contains| xs y@@2) (and (=> (= (ControlFlow 0 3) (- 0 7)) (<= NoPerm p_1)) (=> (<= NoPerm p_1) (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((x_2 T@U) ) (!  (=> (= (type x_2) RefType) (=> (and (|Seq#Contains| xs x_2) (dummyFunction (MapType0Select Heap@@9 x_2 f_7))) (>= p_1 NoPerm)))
 :qid |stdinbpl.1112:19|
 :skolemid |78|
 :pattern ( (MapType0Select Heap@@9 x_2 f_7))
 :pattern ( (MapType1Select QPMask@0 x_2 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs x_2))
 :pattern ( (|Seq#Contains| xs x_2))
))) (=> (forall ((x_2@@0 T@U) ) (!  (=> (= (type x_2@@0) RefType) (=> (and (|Seq#Contains| xs x_2@@0) (dummyFunction (MapType0Select Heap@@9 x_2@@0 f_7))) (>= p_1 NoPerm)))
 :qid |stdinbpl.1112:19|
 :skolemid |78|
 :pattern ( (MapType0Select Heap@@9 x_2@@0 f_7))
 :pattern ( (MapType1Select QPMask@0 x_2@@0 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs x_2@@0))
 :pattern ( (|Seq#Contains| xs x_2@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((x_2@@1 T@U) (x_2_1 T@U) ) (!  (=> (and (= (type x_2@@1) RefType) (= (type x_2_1) RefType)) (=> (and (and (and (and (not (= x_2@@1 x_2_1)) (|Seq#Contains| xs x_2@@1)) (|Seq#Contains| xs x_2_1)) (< NoPerm p_1)) (< NoPerm p_1)) (not (= x_2@@1 x_2_1))))
 :qid |stdinbpl.1119:19|
 :skolemid |79|
 :pattern ( (neverTriggered4 x_2@@1) (neverTriggered4 x_2_1))
))) (=> (forall ((x_2@@2 T@U) (x_2_1@@0 T@U) ) (!  (=> (and (= (type x_2@@2) RefType) (= (type x_2_1@@0) RefType)) (=> (and (and (and (and (not (= x_2@@2 x_2_1@@0)) (|Seq#Contains| xs x_2@@2)) (|Seq#Contains| xs x_2_1@@0)) (< NoPerm p_1)) (< NoPerm p_1)) (not (= x_2@@2 x_2_1@@0))))
 :qid |stdinbpl.1119:19|
 :skolemid |79|
 :pattern ( (neverTriggered4 x_2@@2) (neverTriggered4 x_2_1@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_2@@3 T@U) ) (!  (=> (and (= (type x_2@@3) RefType) (|Seq#Contains| xs x_2@@3)) (>= (U_2_real (MapType1Select ZeroMask x_2@@3 f_7)) p_1))
 :qid |stdinbpl.1126:19|
 :skolemid |80|
 :pattern ( (MapType0Select Heap@@9 x_2@@3 f_7))
 :pattern ( (MapType1Select QPMask@0 x_2@@3 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs x_2@@3))
 :pattern ( (|Seq#Contains| xs x_2@@3))
))) (=> (forall ((x_2@@4 T@U) ) (!  (=> (and (= (type x_2@@4) RefType) (|Seq#Contains| xs x_2@@4)) (>= (U_2_real (MapType1Select ZeroMask x_2@@4 f_7)) p_1))
 :qid |stdinbpl.1126:19|
 :skolemid |80|
 :pattern ( (MapType0Select Heap@@9 x_2@@4 f_7))
 :pattern ( (MapType1Select QPMask@0 x_2@@4 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs x_2@@4))
 :pattern ( (|Seq#Contains| xs x_2@@4))
)) (=> (and (and (and (forall ((x_2@@5 T@U) ) (!  (=> (= (type x_2@@5) RefType) (=> (and (|Seq#Contains| xs x_2@@5) (< NoPerm p_1)) (and (qpRange4 x_2@@5) (= (invRecv4 x_2@@5) x_2@@5))))
 :qid |stdinbpl.1132:24|
 :skolemid |81|
 :pattern ( (MapType0Select Heap@@9 x_2@@5 f_7))
 :pattern ( (MapType1Select QPMask@0 x_2@@5 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs x_2@@5))
 :pattern ( (|Seq#Contains| xs x_2@@5))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (|Seq#Contains| xs (invRecv4 o_3)) (and (< NoPerm p_1) (qpRange4 o_3))) (= (invRecv4 o_3) o_3)))
 :qid |stdinbpl.1136:24|
 :skolemid |82|
 :pattern ( (invRecv4 o_3))
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (|Seq#Contains| xs (invRecv4 o_3@@0)) (and (< NoPerm p_1) (qpRange4 o_3@@0))) (and (= (invRecv4 o_3@@0) o_3@@0) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (- (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) p_1)))) (=> (not (and (|Seq#Contains| xs (invRecv4 o_3@@0)) (and (< NoPerm p_1) (qpRange4 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.1142:24|
 :skolemid |83|
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.1148:31|
 :skolemid |84|
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
)))) (and (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 QPMask@0) (state ExhaleHeap@0 QPMask@0)) (and (state ExhaleHeap@0 QPMask@0) (= (ControlFlow 0 3) (- 0 2))))) false))))))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 y@@2 $allocated))) (=> (and (and (= p_1 NoPerm) (state Heap@@9 ZeroMask)) (and (|Seq#Contains| xs y@@2) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 9) 1) anon3_Then_correct) (=> (= (ControlFlow 0 9) 3) anon3_Else_correct))))))
