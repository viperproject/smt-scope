...
(assert (forall ((x@@8 T@U) ) (!  (=> (= (type x@@8) RefType) (IsPredicateField (token x@@8)))
 :qid |stdinbpl.194:15|
 :skolemid |23|
 :pattern ( (token x@@8))
)))
(assert (forall ((Heap@@2 T@U) (x@@9 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type x@@9) RefType)) (|token#everUsed| (token x@@9)))
 :qid |stdinbpl.213:15|
 :skolemid |27|
 :pattern ( (|token#trigger| Heap@@2 (token x@@9)))
)))
...
(assert (forall ((x@@10 T@U) (x2 T@U) ) (!  (=> (and (and (= (type x@@10) RefType) (= (type x2) RefType)) (= (token x@@10) (token x2))) (= x@@10 x2))
 :qid |stdinbpl.204:15|
 :skolemid |25|
 :pattern ( (token x@@10) (token x2))
)))
...
(assert (forall ((x@@11 T@U) (x2@@0 T@U) ) (!  (=> (and (and (= (type x@@11) RefType) (= (type x2@@0) RefType)) (= (|token#sm| x@@11) (|token#sm| x2@@0))) (= x@@11 x2@@0))
 :qid |stdinbpl.208:15|
 :skolemid |26|
 :pattern ( (|token#sm| x@@11) (|token#sm| x2@@0))
)))
...
(assert (forall ((x@@12 T@U) ) (!  (=> (= (type x@@12) RefType) (= (getPredWandId (token x@@12)) 0))
 :qid |stdinbpl.198:15|
 :skolemid |24|
 :pattern ( (token x@@12))
)))
...
(assert (forall ((x@@13 T@U) ) (!  (=> (= (type x@@13) RefType) (= (PredicateMaskField (token x@@13)) (|token#sm| x@@13)))
 :qid |stdinbpl.190:15|
 :skolemid |22|
 :pattern ( (PredicateMaskField (token x@@13)))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type x@@14) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Heap@2) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (forall ((arg0@@28 T@U) ) (! (= (type (FrameFragment arg0@@28)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@28))
))))
(set-info :boogie-vc-id t_plus)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon4_correct true))
(let ((anon6_Else_correct  (=> (HasDirectPerm Mask@2 null (token x@@14)) (=> (and (= Heap@2 Heap@@10) (= (ControlFlow 0 3) 1)) anon4_correct))))
(let ((anon6_Then_correct  (=> (not (HasDirectPerm Mask@2 null (token x@@14))) (=> (and (and (= Heap@0 (MapType0Store Heap@@10 null (|token#sm| x@@14) ZeroPMask)) (= Heap@1 (MapType0Store Heap@0 null (token x@@14) freshVersion@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 2) 1))) anon4_correct))))
(let ((anon2_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 x@@14 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 x@@14 f_7)) perm@0)))) (= perm@1 (/ (to_real 1) (to_real 10)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (= Mask@2 (MapType1Store Mask@1 null (token x@@14) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (token x@@14))) perm@1)))) (=> (and (and (state Heap@@10 Mask@2) (state Heap@@10 Mask@2)) (and (|token#trigger| Heap@@10 (token x@@14)) (= (MapType0Select Heap@@10 null (token x@@14)) (FrameFragment (MapType0Select Heap@@10 x@@14 f_7))))) (and (=> (= (ControlFlow 0 4) 2) anon6_Then_correct) (=> (= (ControlFlow 0 4) 3) anon6_Else_correct)))))))))
(let ((anon5_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 8) 4)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= perm@0 (U_2_real (MapType1Select Mask@0 x@@14 f_7)))) (=> (<= perm@0 (U_2_real (MapType1Select Mask@0 x@@14 f_7))) (=> (= (ControlFlow 0 6) 4) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 x@@14 $allocated)) (not (= x@@14 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask x@@14 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@14 f_7)) FullPerm)))) (state Heap@@10 Mask@0)) (and (state Heap@@10 Mask@0) (= perm@0 (* FullPerm (/ (to_real 1) (to_real 10)))))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 9) 6) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct)))))))))
