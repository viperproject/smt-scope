...
(assert  (and (= (Ctor PredicateType_PredType) 13) (forall ((arg0@@30 T@U) ) (! (= (type (Pred arg0@@30)) (FieldType PredicateType_PredType FrameTypeType))
 :qid |funType:Pred|
 :pattern ( (Pred arg0@@30))
))))
(assert (forall ((z@@0 T@U) ) (!  (=> (= (type z@@0) RefType) (IsPredicateField (Pred z@@0)))
 :qid |stdinbpl.400:15|
 :skolemid |83|
 :pattern ( (Pred z@@0))
)))
(assert (forall ((Heap@@2 T@U) (z@@1 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type z@@1) RefType)) (|Pred#everUsed| (Pred z@@1)))
 :qid |stdinbpl.419:15|
 :skolemid |87|
 :pattern ( (|Pred#trigger| Heap@@2 (Pred z@@1)))
)))
...
(assert (forall ((z@@2 T@U) (z2 T@U) ) (!  (=> (and (and (= (type z@@2) RefType) (= (type z2) RefType)) (= (Pred z@@2) (Pred z2))) (= z@@2 z2))
 :qid |stdinbpl.410:15|
 :skolemid |85|
 :pattern ( (Pred z@@2) (Pred z2))
)))
(assert (forall ((arg0@@39 T@U) ) (! (= (type (|Pred#sm| arg0@@39)) (FieldType PredicateType_PredType (MapType1Type RefType boolType)))
 :qid |funType:Pred#sm|
 :pattern ( (|Pred#sm| arg0@@39))
)))
(assert (forall ((z@@3 T@U) (z2@@0 T@U) ) (!  (=> (and (and (= (type z@@3) RefType) (= (type z2@@0) RefType)) (= (|Pred#sm| z@@3) (|Pred#sm| z2@@0))) (= z@@3 z2@@0))
 :qid |stdinbpl.414:15|
 :skolemid |86|
 :pattern ( (|Pred#sm| z@@3) (|Pred#sm| z2@@0))
)))
...
(assert (forall ((z@@4 T@U) ) (!  (=> (= (type z@@4) RefType) (= (getPredWandId (Pred z@@4)) 0))
 :qid |stdinbpl.404:15|
 :skolemid |84|
 :pattern ( (Pred z@@4))
)))
...
(assert (forall ((z@@5 T@U) ) (!  (=> (= (type z@@5) RefType) (= (PredicateMaskField (Pred z@@5)) (|Pred#sm| z@@5)))
 :qid |stdinbpl.396:15|
 :skolemid |82|
 :pattern ( (PredicateMaskField (Pred z@@5)))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type x@@19) RefType) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (forall ((arg0@@45 T@U) ) (! (= (type (FrameFragment arg0@@45)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@45))
))) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (= (type UnfoldingMask@3) (MapType1Type RefType realType))) (= (type s@@3) (MapType2Type RefType boolType))) (forall ((arg0@@46 T@U) ) (! (= (type (invRecv1 arg0@@46)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon10_correct  (=> (and (not (= x@@19 null)) (= Mask@3 (MapType1Store Mask@2 x@@19 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@2 x@@19 f_7)) FullPerm))))) (=> (and (and (state Heap@2 Mask@3) (>= (U_2_int (MapType0Select Heap@2 x@@19 f_7)) 3)) (and (state Heap@2 Mask@3) (state Heap@2 Mask@3))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (HasDirectPerm Mask@3 x@@19 f_7)) (=> (HasDirectPerm Mask@3 x@@19 f_7) (and (=> (= (ControlFlow 0 3) (- 0 5)) (>= (U_2_int (MapType0Select Heap@2 x@@19 f_7)) 3)) (=> (>= (U_2_int (MapType0Select Heap@2 x@@19 f_7)) 3) (=> (state Heap@2 Mask@3) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm Mask@3 x@@19 f_7)) (=> (HasDirectPerm Mask@3 x@@19 f_7) (=> (= (ControlFlow 0 3) (- 0 2)) (= (U_2_int (MapType0Select Heap@2 x@@19 f_7)) 3)))))))))))))
(let ((anon15_Else_correct  (=> (HasDirectPerm Mask@2 null (Pred x@@19)) (=> (and (= Heap@2 ExhaleHeap@0) (= (ControlFlow 0 8) 3)) anon10_correct))))
(let ((anon15_Then_correct  (=> (and (and (not (HasDirectPerm Mask@2 null (Pred x@@19))) (= Heap@1 (MapType0Store ExhaleHeap@0 null (Pred x@@19) newVersion@0))) (and (= Heap@2 Heap@1) (= (ControlFlow 0 7) 3))) anon10_correct)))
(let ((anon8_correct  (=> (= Mask@2 (MapType1Store Mask@1 null (Pred x@@19) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (Pred x@@19))) FullPerm)))) (and (=> (= (ControlFlow 0 9) 7) anon15_Then_correct) (=> (= (ControlFlow 0 9) 8) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon8_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@1 null (Pred x@@19))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 null (Pred x@@19)))) (=> (= (ControlFlow 0 10) 9) anon8_correct))))))
(let ((anon6_correct  (=> (= Mask@0 (MapType1Store QPMask@0 null (Pred x@@19) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (Pred x@@19))) perm_temp_quasihavoc_@0)))) (=> (and (IdenticalOnKnownLocations Heap@0 ExhaleHeap@0 Mask@0) (state ExhaleHeap@0 Mask@0)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (>= perm_temp_quasihavoc_@0 NoPerm)) (=> (>= perm_temp_quasihavoc_@0 NoPerm) (=> (and (= Mask@1 (MapType1Store Mask@0 null (Pred x@@19) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (Pred x@@19))) perm_temp_quasihavoc_@0)))) (state ExhaleHeap@0 Mask@1)) (=> (and (and (state ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1)) (and (|Pred#trigger| ExhaleHeap@0 (Pred x@@19)) (= (MapType0Select ExhaleHeap@0 null (Pred x@@19)) (FrameFragment (MapType0Select ExhaleHeap@0 x@@19 f_7))))) (and (=> (= (ControlFlow 0 13) 10) anon14_Then_correct) (=> (= (ControlFlow 0 13) 12) anon14_Else_correct))))))))))
(let ((anon13_Else_correct  (=> (and (= perm_temp_quasihavoc_@0 NoPerm) (= (ControlFlow 0 17) 13)) anon6_correct)))
(let ((anon13_Then_correct  (=> (not (= perm_temp_quasihavoc_@0 NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= perm_temp_quasihavoc_@0 (U_2_real (MapType1Select QPMask@0 null (Pred x@@19))))) (=> (<= perm_temp_quasihavoc_@0 (U_2_real (MapType1Select QPMask@0 null (Pred x@@19)))) (=> (= (ControlFlow 0 15) 13) anon6_correct))))))
(let ((anon4_correct  (=> (and (= UnfoldingMask@0 (MapType1Store QPMask@0 null (Pred x@@19) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (Pred x@@19))) FullPerm)))) (not (= x@@19 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x@@19 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@19 f_7)) FullPerm)))) (state Heap@@10 UnfoldingMask@1)) (and (>= (U_2_int (MapType0Select Heap@@10 x@@19 f_7)) 3) (state Heap@@10 UnfoldingMask@1))) (and (=> (= (ControlFlow 0 18) (- 0 20)) (HasDirectPerm UnfoldingMask@1 x@@19 f_7)) (=> (HasDirectPerm UnfoldingMask@1 x@@19 f_7) (=> (and (= Heap@0 (MapType0Store Heap@@10 null (|Pred#sm| x@@19) (MapType1Store (MapType0Select Heap@@10 null (|Pred#sm| x@@19)) x@@19 f_7 (bool_2_U true)))) (state Heap@0 QPMask@0)) (=> (and (and (|Pred#trigger| Heap@0 (Pred x@@19)) (= (MapType0Select Heap@0 null (Pred x@@19)) (FrameFragment (MapType0Select Heap@0 x@@19 f_7)))) (and (= UnfoldingMask@2 (MapType1Store QPMask@0 null (Pred x@@19) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (Pred x@@19))) FullPerm)))) (not (= x@@19 null)))) (=> (and (and (and (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 x@@19 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 x@@19 f_7)) FullPerm)))) (state Heap@0 UnfoldingMask@3)) (and (>= (U_2_int (MapType0Select Heap@0 x@@19 f_7)) 3) (state Heap@0 UnfoldingMask@3))) (and (and (= (U_2_int (MapType0Select Heap@0 x@@19 f_7)) 3) (state Heap@0 QPMask@0)) (and (= perm_temp_quasihavoc_@0 (U_2_real (MapType1Select QPMask@0 null (Pred x@@19)))) (state Heap@0 QPMask@0)))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (>= perm_temp_quasihavoc_@0 NoPerm)) (=> (>= perm_temp_quasihavoc_@0 NoPerm) (and (=> (= (ControlFlow 0 18) 15) anon13_Then_correct) (=> (= (ControlFlow 0 18) 17) anon13_Else_correct)))))))))))))
(let ((anon12_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 23) 18)) anon4_correct)))
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (Pred x@@19))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (Pred x@@19)))) (=> (= (ControlFlow 0 21) 18) anon4_correct))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 24) (- 0 25)) (forall ((a_1 T@U) (a_1_1 T@U) ) (!  (=> (and (= (type a_1) RefType) (= (type a_1_1) RefType)) (=> (and (and (and (and (not (= a_1 a_1_1)) (U_2_bool (MapType2Select s@@3 a_1))) (U_2_bool (MapType2Select s@@3 a_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1 a_1_1))))
 :qid |stdinbpl.483:17|
 :skolemid |88|
 :pattern ( (neverTriggered1 a_1) (neverTriggered1 a_1_1))
))) (=> (forall ((a_1@@0 T@U) (a_1_1@@0 T@U) ) (!  (=> (and (= (type a_1@@0) RefType) (= (type a_1_1@@0) RefType)) (=> (and (and (and (and (not (= a_1@@0 a_1_1@@0)) (U_2_bool (MapType2Select s@@3 a_1@@0))) (U_2_bool (MapType2Select s@@3 a_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= a_1@@0 a_1_1@@0))))
 :qid |stdinbpl.483:17|
 :skolemid |88|
 :pattern ( (neverTriggered1 a_1@@0) (neverTriggered1 a_1_1@@0))
)) (=> (forall ((a_1@@1 T@U) ) (!  (=> (= (type a_1@@1) RefType) (=> (and (U_2_bool (MapType2Select s@@3 a_1@@1)) (< NoPerm FullPerm)) (and (= (invRecv1 a_1@@1) a_1@@1) (qpRange1 a_1@@1))))
 :qid |stdinbpl.489:22|
 :skolemid |89|
 :pattern ( (MapType0Select Heap@@10 null (Pred a_1@@1)))
 :pattern ( (MapType1Select ZeroMask null (Pred a_1@@1)))
 :pattern ( (MapType2Select s@@3 a_1@@1))
)) (=> (and (forall ((z@@6 T@U) ) (!  (=> (= (type z@@6) RefType) (=> (and (and (U_2_bool (MapType2Select s@@3 (invRecv1 z@@6))) (< NoPerm FullPerm)) (qpRange1 z@@6)) (= (invRecv1 z@@6) z@@6)))
 :qid |stdinbpl.493:22|
 :skolemid |90|
 :pattern ( (invRecv1 z@@6))
)) (forall ((z@@7 T@U) ) (!  (=> (= (type z@@7) RefType) (=> (and (and (U_2_bool (MapType2Select s@@3 (invRecv1 z@@7))) (< NoPerm FullPerm)) (qpRange1 z@@7)) (and (=> (< NoPerm FullPerm) (= (invRecv1 z@@7) z@@7)) (= (U_2_real (MapType1Select QPMask@0 null (Pred z@@7))) (+ (U_2_real (MapType1Select ZeroMask null (Pred z@@7))) FullPerm)))))
 :qid |stdinbpl.499:22|
 :skolemid |91|
 :pattern ( (MapType1Select QPMask@0 null (Pred z@@7)))
...
)) (forall ((z@@8 T@U) ) (!  (=> (and (= (type z@@8) RefType) (not (and (and (U_2_bool (MapType2Select s@@3 (invRecv1 z@@8))) (< NoPerm FullPerm)) (qpRange1 z@@8)))) (= (U_2_real (MapType1Select QPMask@0 null (Pred z@@8))) (U_2_real (MapType1Select ZeroMask null (Pred z@@8)))))
 :qid |stdinbpl.509:22|
 :skolemid |93|
 :pattern ( (MapType1Select QPMask@0 null (Pred z@@8)))
))) (and (state Heap@@10 QPMask@0) (state Heap@@10 QPMask@0))) (and (and (U_2_bool (MapType2Select s@@3 x@@19)) (state Heap@@10 QPMask@0)) (and (|Pred#trigger| Heap@@10 (Pred x@@19)) (= (MapType0Select Heap@@10 null (Pred x@@19)) (FrameFragment (MapType0Select Heap@@10 x@@19 f_7)))))) (and (=> (= (ControlFlow 0 24) 21) anon12_Then_correct) (=> (= (ControlFlow 0 24) 23) anon12_Else_correct)))))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x@@19 $allocated))) (and (=> (= (ControlFlow 0 26) 1) anon11_Then_correct) (=> (= (ControlFlow 0 26) 24) anon11_Else_correct)))))
