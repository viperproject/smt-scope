...
(declare-fun |fac'| (T@U Int T@U) Int)
(declare-fun HuhDomainTypeType () T@T)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |fac#triggerStateless| (Int T@U) Int)
...
(declare-fun |fac#frame| (T@U Int T@U) Int)
...
(assert (= (Ctor HuhDomainTypeType) 10))
(assert (forall ((Heap@@0 T@U) (i Int) (h T@U) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type h) HuhDomainTypeType)) (dummyFunction (int_2_U (|fac#triggerStateless| i h))))
 :qid |stdinbpl.209:15|
 :skolemid |23|
 :pattern ( (|fac'| Heap@@0 i h))
)))
...
(assert (forall ((Heap@@3 T@U) (Mask@@2 T@U) (i@@0 Int) (h@@0 T@U) ) (!  (=> (and (and (and (= (type Heap@@3) (MapType0Type RefType)) (= (type Mask@@2) (MapType1Type RefType realType))) (= (type h@@0) HuhDomainTypeType)) (state Heap@@3 Mask@@2)) (= (|fac'| Heap@@3 i@@0 h@@0) (|fac#frame| EmptyFrame i@@0 h@@0)))
 :qid |stdinbpl.222:15|
 :skolemid |25|
 :pattern ( (state Heap@@3 Mask@@2) (|fac'| Heap@@3 i@@0 h@@0))
)))
...
(assert (forall ((Heap@@7 T@U) (i@@1 Int) (h@@1 T@U) ) (!  (=> (and (= (type Heap@@7) (MapType0Type RefType)) (= (type h@@1) HuhDomainTypeType)) (and (= (fac Heap@@7 i@@1 h@@1) (|fac'| Heap@@7 i@@1 h@@1)) (dummyFunction (int_2_U (|fac#triggerStateless| i@@1 h@@1)))))
 :qid |stdinbpl.205:15|
 :skolemid |22|
 :pattern ( (fac Heap@@7 i@@1 h@@1))
)))
...
(assert (forall ((Heap@@12 T@U) (Mask@@10 T@U) (i@@2 Int) (h@@2 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type h@@2) HuhDomainTypeType)) (and (state Heap@@12 Mask@@10) (< AssumeFunctionsAbove 0))) (>= i@@2 0)) (= (fac Heap@@12 i@@2 h@@2) (ite (= i@@2 0) 1 (* i@@2 (|fac'| Heap@@12 (- i@@2 1) h@@2)))))
 :qid |stdinbpl.215:15|
 :skolemid |24|
 :pattern ( (state Heap@@12 Mask@@10) (fac Heap@@12 i@@2 h@@2))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(declare-fun |fac#trigger| (T@U Int T@U) Bool)
(declare-fun i@@3 () Int)
(declare-fun h@@3 () T@U)
(declare-fun Heap@@13 () T@U)
(assert  (and (= (type h@@3) HuhDomainTypeType) (= (type Heap@@13) (MapType0Type RefType))))
(set-info :boogie-vc-id |fac#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_correct true))
(let ((anon7_Else_correct  (=> (and (|fac#trigger| EmptyFrame (- i@@3 1) h@@3) (= (ControlFlow 0 5) 3)) anon5_correct)))
(let ((anon6_Then_correct  (=> (and (= i@@3 0) (= (ControlFlow 0 4) 3)) anon5_correct)))
(let ((anon7_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (>= (- i@@3 1) 0))))
(let ((anon6_Else_correct  (=> (not (= i@@3 0)) (and (=> (= (ControlFlow 0 6) 2) anon7_Then_correct) (=> (= (ControlFlow 0 6) 5) anon7_Else_correct)))))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove 0)) (and (>= i@@3 0) (state Heap@@13 ZeroMask))) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))
