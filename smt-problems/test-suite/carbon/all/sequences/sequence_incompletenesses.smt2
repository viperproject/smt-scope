...
(assert  (and (and (and (and (= (type Heap@1) (MapType0Type RefType)) (= (type a_2) ArrayDomainTypeType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@13) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id colourings0)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 31) (let ((anon15_correct true))
(let ((anon25_Else_correct  (=> (and (not (and (<= 0 j_1) (< j_1 (|Seq#Length| (MapType0Select Heap@1 (slot a_2 1) val))))) (= (ControlFlow 0 23) 19)) anon15_correct)))
(let ((anon25_Then_correct  (=> (and (<= 0 j_1) (< j_1 (|Seq#Length| (MapType0Select Heap@1 (slot a_2 1) val)))) (and (=> (= (ControlFlow 0 20) (- 0 22)) (|Seq#Equal| (|Seq#Index| (MapType0Select Heap@1 (slot a_2 1) val) j_1) (|Seq#Append| (|Seq#Singleton| (int_2_U 0)) (|Seq#Singleton| (int_2_U 1))))) (=> (|Seq#Equal| (|Seq#Index| (MapType0Select Heap@1 (slot a_2 1) val) j_1) (|Seq#Append| (|Seq#Singleton| (int_2_U 0)) (|Seq#Singleton| (int_2_U 1)))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (valid Heap@1 (|Seq#Index| (MapType0Select Heap@1 (slot a_2 1) val) j_1) 1 true)) (=> (valid Heap@1 (|Seq#Index| (MapType0Select Heap@1 (slot a_2 1) val) j_1) 1 true) (=> (= (ControlFlow 0 20) 19) anon15_correct))))))))
(let ((anon23_Then_correct true))
(let ((anon11_correct true))
(let ((anon22_Then_correct  (=> (|Seq#Equal| (|Seq#Index| (MapType0Select Heap@1 (slot a_2 1) val) j@@5) (|Seq#Append| (|Seq#Singleton| (int_2_U 0)) (|Seq#Singleton| (int_2_U 1)))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (HasDirectPerm QPMask@0 (slot a_2 1) val)) (=> (HasDirectPerm QPMask@0 (slot a_2 1) val) (and (=> (= (ControlFlow 0 8) (- 0 10)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 8) (- 0 9)) (< j@@5 (|Seq#Length| (MapType0Select Heap@1 (slot a_2 1) val)))) (=> (< j@@5 (|Seq#Length| (MapType0Select Heap@1 (slot a_2 1) val))) (and (=> (= (ControlFlow 0 8) 7) anon23_Then_correct) (=> (= (ControlFlow 0 8) 4) anon11_correct)))))))))))
(let ((anon22_Else_correct  (=> (and (not (|Seq#Equal| (|Seq#Index| (MapType0Select Heap@1 (slot a_2 1) val) j@@5) (|Seq#Append| (|Seq#Singleton| (int_2_U 0)) (|Seq#Singleton| (int_2_U 1))))) (= (ControlFlow 0 6) 4)) anon11_correct)))
(let ((anon21_Then_correct  (=> (and (<= 0 j@@5) (< j@@5 (|Seq#Length| (MapType0Select Heap@1 (slot a_2 1) val)))) (and (=> (= (ControlFlow 0 12) (- 0 15)) (HasDirectPerm QPMask@0 (slot a_2 1) val)) (=> (HasDirectPerm QPMask@0 (slot a_2 1) val) (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< j@@5 (|Seq#Length| (MapType0Select Heap@1 (slot a_2 1) val)))) (=> (< j@@5 (|Seq#Length| (MapType0Select Heap@1 (slot a_2 1) val))) (and (=> (= (ControlFlow 0 12) 8) anon22_Then_correct) (=> (= (ControlFlow 0 12) 6) anon22_Else_correct)))))))))))
(let ((anon21_Else_correct  (=> (and (not (and (<= 0 j@@5) (< j@@5 (|Seq#Length| (MapType0Select Heap@1 (slot a_2 1) val))))) (= (ControlFlow 0 5) 4)) anon11_correct)))
(let ((anon20_Else_correct  (=> (< j@@5 0) (and (=> (= (ControlFlow 0 18) 12) anon21_Then_correct) (=> (= (ControlFlow 0 18) 5) anon21_Else_correct)))))
(let ((anon20_Then_correct  (=> (<= 0 j@@5) (and (=> (= (ControlFlow 0 16) (- 0 17)) (HasDirectPerm QPMask@0 (slot a_2 1) val)) (=> (HasDirectPerm QPMask@0 (slot a_2 1) val) (and (=> (= (ControlFlow 0 16) 12) anon21_Then_correct) (=> (= (ControlFlow 0 16) 5) anon21_Else_correct)))))))
(let ((anon24_Else_correct true))
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 24) (- 0 25)) (valid Heap@1 (|Seq#Empty| intType) 0 false)) (=> (valid Heap@1 (|Seq#Empty| intType) 0 false) (=> (state Heap@1 QPMask@0) (and (and (and (and (=> (= (ControlFlow 0 24) 3) anon24_Else_correct) (=> (= (ControlFlow 0 24) 20) anon25_Then_correct)) (=> (= (ControlFlow 0 24) 23) anon25_Else_correct)) (=> (= (ControlFlow 0 24) 16) anon20_Then_correct)) (=> (= (ControlFlow 0 24) 18) anon20_Else_correct)))))))
...
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 29)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 (len a_2)))) (and (<= 0 i_1_1) (< i_1_1 (len a_2)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (slot a_2 i_1) (slot a_2 i_1_1))))
 ...
 :qid |stdinbpl.780:15|
 :skolemid |64|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 (len a_2))) (< NoPerm FullPerm)) (and (qpRange1 (slot a_2 i_1@@1)) (= (invRecv1 (slot a_2 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.786:22|
 :skolemid |65|
 :pattern ( (slot a_2 i_1@@1))
 :pattern ( (slot a_2 i_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv1 o_3)) (< (invRecv1 o_3) (len a_2))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (slot a_2 (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.790:22|
 :skolemid |66|
 ...
 :pattern ( (slot a_2 i_1@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (len a_2))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (slot a_2 (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (len a_2))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.802:22|
 :skolemid |68|
...
))) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0))) (and (=> (= (ControlFlow 0 26) (- 0 28)) (= FullPerm (U_2_real (MapType1Select QPMask@0 (slot a_2 0) val)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 (slot a_2 0) val))) (=> (and (= Heap@0 (MapType0Store Heap@@13 (slot a_2 0) val (|Seq#Singleton| (|Seq#Empty| intType)))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (= FullPerm (U_2_real (MapType1Select QPMask@0 (slot a_2 1) val)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 (slot a_2 1) val))) (=> (and (= Heap@1 (MapType0Store Heap@0 (slot a_2 1) val (|Seq#Singleton| (|Seq#Append| (|Seq#Singleton| (int_2_U 0)) (|Seq#Singleton| (int_2_U 1)))))) (state Heap@1 QPMask@0)) (and (=> (= (ControlFlow 0 26) 2) anon18_Then_correct) (=> (= (ControlFlow 0 26) 24) anon18_Else_correct)))))))))))))))
(let ((anon17_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (= (len a_2) 51) (state Heap@@13 ZeroMask))) (and (=> (= (ControlFlow 0 30) 1) anon17_Then_correct) (=> (= (ControlFlow 0 30) 26) anon17_Else_correct)))))
