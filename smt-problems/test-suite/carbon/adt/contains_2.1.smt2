...
(assert  (and (and (forall ((arg0@@25 T@T) ) (! (= (Ctor (ListDomainTypeType arg0@@25)) 11)
...
))) (forall ((arg0@@27 T@U) (arg1@@9 T@U) ) (! (let ((T (type arg0@@27)))
(= (type (Cons arg0@@27 arg1@@9)) (ListDomainTypeType T)))
 :qid |funType:Cons|
 :pattern ( (Cons arg0@@27 arg1@@9))
))))
(assert (forall ((value_1 T@U) (tail_1 T@U) ) (! (let ((T@@0 (type value_1)))
 (=> (= (type tail_1) (ListDomainTypeType T@@0)) (contains tail_1 (Cons value_1 tail_1))))
 :qid |stdinbpl.238:19|
 :skolemid |27|
 :pattern ( (Cons value_1 tail_1))
)))
(assert  (and (and (forall ((arg0@@28 T@U) ) (! (let ((T@@1 (ListDomainTypeTypeInv0 (type arg0@@28))))
(= (type (get_List_value arg0@@28)) T@@1))
 :qid |funType:get_List_value|
 :pattern ( (get_List_value arg0@@28))
)) (forall ((arg0@@29 T@U) ) (! (let ((T@@2 (ListDomainTypeTypeInv0 (type arg0@@29))))
(= (type (get_List_tail arg0@@29)) (ListDomainTypeType T@@2)))
 :qid |funType:get_List_tail|
 :pattern ( (get_List_tail arg0@@29))
))) (forall ((T@@3 T@T) ) (! (= (type (Nil T@@3)) (ListDomainTypeType T@@3))
 :qid |funType:Nil|
 :pattern ( (Nil T@@3))
))))
(assert (forall ((t_2 T@U) ) (! (let ((T@@4 (ListDomainTypeTypeInv0 (type t_2))))
 (=> (= (type t_2) (ListDomainTypeType T@@4)) (or (= t_2 (Nil T@@4)) (= t_2 (Cons (get_List_value t_2) (get_List_tail t_2))))))
 :qid |stdinbpl.232:19|
 :skolemid |26|
...
(assert (forall ((value_1@@0 T@U) (tail_1@@0 T@U) ) (! (let ((T@@5 (type value_1@@0)))
 (=> (= (type tail_1@@0) (ListDomainTypeType T@@5)) (= value_1@@0 (get_List_value (Cons value_1@@0 tail_1@@0)))))
 :qid |stdinbpl.208:19|
 :skolemid |22|
 :pattern ( (Cons value_1@@0 tail_1@@0))
)))
(assert (forall ((value_1@@1 T@U) (tail_1@@1 T@U) ) (! (let ((T@@6 (type value_1@@1)))
 (=> (= (type tail_1@@1) (ListDomainTypeType T@@6)) (= tail_1@@1 (get_List_tail (Cons value_1@@1 tail_1@@1)))))
 :qid |stdinbpl.214:19|
 :skolemid |23|
...
(assert (forall ((value_1@@2 T@U) (tail_1@@2 T@U) ) (! (let ((T@@7 (type value_1@@2)))
 (=> (= (type tail_1@@2) (ListDomainTypeType T@@7)) (= (List_tag (Cons value_1@@2 tail_1@@2)) 0)))
 :qid |stdinbpl.226:19|
 :skolemid |25|
...
(assert (forall ((T@@8 T@T) ) (! (= (List_tag (Nil T@@8)) 1)
 :skolemid |24|
)))
(assert (forall ((a_3 T@U) (b_3 T@U) (c T@U) ) (!  (=> (and (and (and (= (type a_3) intType) (= (type b_3) (ListDomainTypeType intType))) (= (type c) (ListDomainTypeType intType))) (and (contains a_3 b_3) (contains b_3 c))) (contains a_3 c))
 :qid |stdinbpl.251:15|
 :skolemid |28|
 :pattern ( (contains a_3 b_3) (contains b_3 c))
)))
(assert (forall ((a_3@@0 T@U) (b_3@@0 T@U) (c@@0 T@U) ) (!  (=> (and (and (and (= (type a_3@@0) (ListDomainTypeType intType)) (= (type b_3@@0) (ListDomainTypeType intType))) (= (type c@@0) (ListDomainTypeType intType))) (and (contains a_3@@0 b_3@@0) (contains b_3@@0 c@@0))) (contains a_3@@0 c@@0))
 :qid |stdinbpl.257:15|
 :skolemid |29|
...
(set-info :boogie-vc-id contains_2b)
