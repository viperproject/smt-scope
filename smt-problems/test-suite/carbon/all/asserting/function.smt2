...
(declare-fun |fplusone'| (T@U T@U T@U) Int)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |fplusone#triggerStateless| (T@U T@U) Int)
(declare-fun |fplusone2'| (T@U T@U T@U) Int)
(declare-fun |fplusone2#triggerStateless| (T@U T@U) Int)
...
(declare-fun |fplusone#frame| (T@U T@U T@U) Int)
(declare-fun FrameFragment (T@U) T@U)
(declare-fun |fplusone2#frame| (T@U T@U T@U) Int)
...
(assert (forall ((Heap@@0 T@U) (x@@8 T@U) (y@@1 T@U) ) (!  (=> (and (and (= (type Heap@@0) (MapType0Type RefType)) (= (type x@@8) RefType)) (= (type y@@1) RefType)) (dummyFunction (int_2_U (|fplusone#triggerStateless| x@@8 y@@1))))
 :qid |stdinbpl.198:15|
 :skolemid |23|
 :pattern ( (|fplusone'| Heap@@0 x@@8 y@@1))
)))
(assert (forall ((Heap@@1 T@U) (x@@9 T@U) (y@@2 T@U) ) (!  (=> (and (and (= (type Heap@@1) (MapType0Type RefType)) (= (type x@@9) RefType)) (= (type y@@2) RefType)) (dummyFunction (int_2_U (|fplusone2#triggerStateless| x@@9 y@@2))))
 :qid |stdinbpl.276:15|
 :skolemid |27|
 :pattern ( (|fplusone2'| Heap@@1 x@@9 y@@2))
)))
...
(assert (forall ((Heap@@7 T@U) (x@@10 T@U) (y@@3 T@U) ) (!  (=> (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type x@@10) RefType)) (= (type y@@3) RefType)) (and (= (fplusone Heap@@7 x@@10 y@@3) (|fplusone'| Heap@@7 x@@10 y@@3)) (dummyFunction (int_2_U (|fplusone#triggerStateless| x@@10 y@@3)))))
 :qid |stdinbpl.194:15|
 :skolemid |22|
 :pattern ( (fplusone Heap@@7 x@@10 y@@3))
)))
(assert (forall ((Heap@@8 T@U) (x@@11 T@U) (y@@4 T@U) ) (!  (=> (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type x@@11) RefType)) (= (type y@@4) RefType)) (and (= (fplusone2 Heap@@8 x@@11 y@@4) (|fplusone2'| Heap@@8 x@@11 y@@4)) (dummyFunction (int_2_U (|fplusone2#triggerStateless| x@@11 y@@4)))))
 :qid |stdinbpl.272:15|
 :skolemid |26|
 :pattern ( (fplusone2 Heap@@8 x@@11 y@@4))
)))
...
(assert (forall ((Heap@@13 T@U) (Mask@@9 T@U) (x@@12 T@U) (y@@5 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (= (type x@@12) RefType)) (= (type y@@5) RefType)) (and (state Heap@@13 Mask@@9) (< AssumeFunctionsAbove 0))) (= (fplusone Heap@@13 x@@12 y@@5) (+ (U_2_int (MapType0Select Heap@@13 x@@12 f_7)) 1)))
 :qid |stdinbpl.204:15|
 :skolemid |24|
 :pattern ( (state Heap@@13 Mask@@9) (fplusone Heap@@13 x@@12 y@@5))
)))
(assert (forall ((Heap@@14 T@U) (Mask@@10 T@U) (x@@13 T@U) (y@@6 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type x@@13) RefType)) (= (type y@@6) RefType)) (and (state Heap@@14 Mask@@10) (< AssumeFunctionsAbove 1))) (= (fplusone2 Heap@@14 x@@13 y@@6) (+ (U_2_int (MapType0Select Heap@@14 x@@13 f_7)) 1)))
 :qid |stdinbpl.282:15|
 :skolemid |28|
 :pattern ( (state Heap@@14 Mask@@10) (fplusone2 Heap@@14 x@@13 y@@6))
)))
...
(assert (forall ((Heap@@15 T@U) (Mask@@11 T@U) (x@@14 T@U) (y@@7 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@15) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (= (type x@@14) RefType)) (= (type y@@7) RefType)) (state Heap@@15 Mask@@11)) (= (|fplusone'| Heap@@15 x@@14 y@@7) (|fplusone#frame| (FrameFragment (MapType0Select Heap@@15 x@@14 f_7)) x@@14 y@@7)))
 :qid |stdinbpl.211:15|
 :skolemid |25|
 :pattern ( (state Heap@@15 Mask@@11) (|fplusone'| Heap@@15 x@@14 y@@7))
)))
(assert (forall ((Heap@@16 T@U) (Mask@@12 T@U) (x@@15 T@U) (y@@8 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@16) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (= (type x@@15) RefType)) (= (type y@@8) RefType)) (state Heap@@16 Mask@@12)) (= (|fplusone2'| Heap@@16 x@@15 y@@8) (|fplusone2#frame| (FrameFragment (MapType0Select Heap@@16 x@@15 f_7)) x@@15 y@@8)))
 :qid |stdinbpl.289:15|
 :skolemid |29|
 :pattern ( (state Heap@@16 Mask@@12) (|fplusone2'| Heap@@16 x@@15 y@@8))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
...
(assert  (and (and (and (and (= (type Heap@0) (MapType0Type RefType)) (= (type freshObj@0) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@17) (MapType0Type RefType))) (= (type x@@16) RefType)))
(set-info :boogie-vc-id main2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon3_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 freshObj@0 f_7))) (=> (= (ControlFlow 0 6) 5) anon3_correct))))))
(let ((anon5_Else_correct  (=> (and (= hmm@0 (fplusone Heap@0 freshObj@0 freshObj@0)) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@0 freshObj@0 f_7)) (=> (HasDirectPerm Mask@0 freshObj@0 f_7) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 freshObj@0 f_7)) (=> (HasDirectPerm Mask@0 freshObj@0 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (= hmm@0 (U_2_int (MapType0Select Heap@0 freshObj@0 f_7)))))))))))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@17 x@@16 $allocated))) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@17 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@17 freshObj@0 $allocated (bool_2_U true)))) (and (= Mask@0 (MapType1Store ZeroMask freshObj@0 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 f_7)) FullPerm)))) (state Heap@0 Mask@0))) (and (and (=> (= (ControlFlow 0 9) 2) anon5_Else_correct) (=> (= (ControlFlow 0 9) 6) anon6_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct)))))))
