...
(let ((anon4_Else_correct  (=> (not (= (List_tag l@@5) 1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing (get_List_tail l@@5) l@@5)) (=> (decreasing (get_List_tail l@@5) l@@5) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded l@@5)) (=> (bounded l@@5) (=> (and (state Heap@@14 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
(let ((anon4_Then_correct  (=> (and (= (List_tag l@@5) 1) (= (ControlFlow 0 2) 1)) anon3_correct)))
(let ((anon0_correct  (=> (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 6) 2) anon4_Then_correct) (=> (= (ControlFlow 0 6) 3) anon4_Else_correct)))))
