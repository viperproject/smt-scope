...
(assert  (and (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type diz@@5) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id Fib__forkOperator)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct true))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (and (state Heap@@14 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@14 diz@@5 $allocated)) (not (= diz@@5 null)))) (and (and (state Heap@@14 ZeroMask) (>= current_thread_id 0)) (and (state Heap@@14 ZeroMask) (= perm@0 (/ (to_real 1) (to_real 10)))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (and (=> (> perm@0 NoPerm) (not (= diz@@5 null))) (= Mask@0 (MapType1Store ZeroMask diz@@5 Fib__input (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz@@5 Fib__input)) perm@0))))) (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0))) (and (and (not (= diz@@5 null)) (= Mask@1 (MapType1Store Mask@0 diz@@5 Fib__output (real_2_U (+ (U_2_real (MapType1Select Mask@0 diz@@5 Fib__output)) FullPerm))))) (and (state Heap@@14 Mask@1) (state Heap@@14 Mask@1)))) (and (=> (= (ControlFlow 0 3) 1) anon5_Then_correct) (=> (= (ControlFlow 0 3) 2) anon5_Else_correct))))))))
