...
(assert  (and (and (and (and (and (and (= (type Heap@@35) (MapType0Type RefType)) (= (type this@@55) RefType)) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |Node_reverse#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon4_correct true))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 4)) anon4_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@3 null (Node_reverse (MapType0Select Heap@@35 this@@55 Node_prev)))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 null (Node_reverse (MapType0Select Heap@@35 this@@55 Node_prev))))) (=> (= (ControlFlow 0 5) 4) anon4_correct))))))
(let ((anon6_correct true))
(let ((anon8_Else_correct  (=> (= (Node_rev_next Heap@@35 (MapType0Select Heap@@35 this@@55 Node_prev)) this@@55) (=> (and (= Mask@4 Mask@3) (= (ControlFlow 0 3) 1)) anon6_correct))))
(let ((anon7_Then_correct  (=> (not (= (MapType0Select Heap@@35 this@@55 Node_prev) null)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (HasDirectPerm Mask@2 this@@55 Node_prev)) (=> (HasDirectPerm Mask@2 this@@55 Node_prev) (=> (= Mask@3 (MapType1Store Mask@2 null (Node_reverse (MapType0Select Heap@@35 this@@55 Node_prev)) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (Node_reverse (MapType0Select Heap@@35 this@@55 Node_prev)))) FullPerm)))) (=> (and (state Heap@@35 Mask@3) (state Heap@@35 Mask@3)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm Mask@3 this@@55 Node_prev)) (=> (HasDirectPerm Mask@3 this@@55 Node_prev) (and (and (=> (= (ControlFlow 0 8) 3) anon8_Else_correct) (=> (= (ControlFlow 0 8) 5) anon9_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct)))))))))))
(let ((anon7_Else_correct  (=> (= (MapType0Select Heap@@35 this@@55 Node_prev) null) (=> (and (= Mask@4 Mask@2) (= (ControlFlow 0 2) 1)) anon6_correct))))
(let ((anon0_correct  (=> (and (and (state Heap@@35 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@35 this@@55 $allocated)) (not (= this@@55 null)))) (=> (and (and (and (= Mask@0 (MapType1Store ZeroMask this@@55 Node_val (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@55 Node_val)) FullPerm)))) (state Heap@@35 Mask@0)) (and (not (= this@@55 null)) (= Mask@1 (MapType1Store Mask@0 this@@55 Node_prev (real_2_U (+ (U_2_real (MapType1Select Mask@0 this@@55 Node_prev)) FullPerm)))))) (and (and (state Heap@@35 Mask@1) (not (= this@@55 null))) (and (= Mask@2 (MapType1Store Mask@1 this@@55 Node_next (real_2_U (+ (U_2_real (MapType1Select Mask@1 this@@55 Node_next)) FullPerm)))) (state Heap@@35 Mask@2)))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm Mask@2 this@@55 Node_prev)) (=> (HasDirectPerm Mask@2 this@@55 Node_prev) (and (=> (= (ControlFlow 0 11) 8) anon7_Then_correct) (=> (= (ControlFlow 0 11) 2) anon7_Else_correct))))))))
