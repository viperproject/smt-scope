...
(declare-fun j_8 () Int)
(assert  (and (and (and (and (and (and (and (and (and (and (= (type a_2) (SeqType RefType)) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Heap@@33) (MapType0Type RefType))) (= (type QPMask@3) (MapType1Type RefType realType))) (= (type AssertMask@0) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type diz) RefType)) (= (type QPMask@4) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id Ref__example)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 87) (let ((anon16_correct true))
(let ((anon51_Else_correct  (=> (and (not (and (<= 0 i_12) (< i_12 len))) (= (ControlFlow 0 79) 71)) anon16_correct)))
(let ((anon51_Then_correct  (=> (and (<= 0 i_12) (< i_12 len)) (and (=> (= (ControlFlow 0 72) (- 0 78)) (>= i_12 0)) (=> (>= i_12 0) (and (=> (= (ControlFlow 0 72) (- 0 77)) (< i_12 (|Seq#Length| a_2))) (=> (< i_12 (|Seq#Length| a_2)) (and (=> (= (ControlFlow 0 72) (- 0 76)) (HasDirectPerm QPMask@4 (|Seq#Index| a_2 i_12) Ref__Integer_value)) (=> (HasDirectPerm QPMask@4 (|Seq#Index| a_2 i_12) Ref__Integer_value) (and (=> (= (ControlFlow 0 72) (- 0 75)) (>= i_12 0)) (=> (>= i_12 0) (and (=> (= (ControlFlow 0 72) (- 0 74)) (< i_12 (|Seq#Length| a_2))) (=> (< i_12 (|Seq#Length| a_2)) (and (=> (= (ControlFlow 0 72) (- 0 73)) (HasDirectPerm QPMask@0 (|Seq#Index| a_2 i_12) Ref__Integer_value)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| a_2 i_12) Ref__Integer_value) (=> (= (ControlFlow 0 72) 71) anon16_correct))))))))))))))))
(let ((anon50_Else_correct true))
(let ((anon48_Else_correct  (and (=> (= (ControlFlow 0 80) (- 0 81)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (and (<= 0 i_3) (< i_3 len))) (and (<= 0 i_3_1) (< i_3_1 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| a_2 i_3) (|Seq#Index| a_2 i_3_1))))
 :qid |stdinbpl.2386:15|
 :skolemid |186|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (and (<= 0 i_3@@0) (< i_3@@0 len))) (and (<= 0 i_3_1@@0) (< i_3_1@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| a_2 i_3@@0) (|Seq#Index| a_2 i_3_1@@0))))
 :qid |stdinbpl.2386:15|
 :skolemid |186|
)) (=> (forall ((i_3@@1 Int) ) (!  (=> (and (and (<= 0 i_3@@1) (< i_3@@1 len)) (< NoPerm FullPerm)) (and (qpRange13 (|Seq#Index| a_2 i_3@@1)) (= (invRecv13 (|Seq#Index| a_2 i_3@@1)) i_3@@1)))
 :qid |stdinbpl.2392:22|
 :skolemid |187|
 :pattern ( (|Seq#Index| a_2 i_3@@1))
 :pattern ( (|Seq#Index| a_2 i_3@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv13 o_3)) (< (invRecv13 o_3) len)) (< NoPerm FullPerm)) (qpRange13 o_3)) (= (|Seq#Index| a_2 (invRecv13 o_3)) o_3)))
 :qid |stdinbpl.2396:22|
 :skolemid |188|
 :pattern ( (invRecv13 o_3))
)) (forall ((i_3@@2 Int) ) (!  (=> (and (<= 0 i_3@@2) (< i_3@@2 len)) (not (= (|Seq#Index| a_2 i_3@@2) null)))
 :qid |stdinbpl.2402:22|
 :skolemid |189|
 :pattern ( (|Seq#Index| a_2 i_3@@2))
 :pattern ( (|Seq#Index| a_2 i_3@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv13 o_3@@0)) (< (invRecv13 o_3@@0) len)) (< NoPerm FullPerm)) (qpRange13 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| a_2 (invRecv13 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@4 o_3@@0 Ref__Integer_value)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 Ref__Integer_value)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv13 o_3@@0)) (< (invRecv13 o_3@@0) len)) (< NoPerm FullPerm)) (qpRange13 o_3@@0))) (= (U_2_real (MapType1Select QPMask@4 o_3@@0 Ref__Integer_value)) (U_2_real (MapType1Select ZeroMask o_3@@0 Ref__Integer_value))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.2412:29|
 :skolemid |191|
 :pattern ( (MapType1Select ZeroMask o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@4 o_3@@1 f_5))
))) (and (state PostHeap@0 QPMask@4) (state PostHeap@0 QPMask@4))) (and (and (=> (= (ControlFlow 0 80) 70) anon50_Else_correct) (=> (= (ControlFlow 0 80) 72) anon51_Then_correct)) (=> (= (ControlFlow 0 80) 79) anon51_Else_correct)))))))))
(let ((anon12_correct true))
(let ((anon49_Else_correct  (=> (and (not (and (<= 0 i_11) (< i_11 len))) (= (ControlFlow 0 69) 65)) anon12_correct)))
(let ((anon49_Then_correct  (=> (and (<= 0 i_11) (< i_11 len)) (and (=> (= (ControlFlow 0 66) (- 0 68)) (>= i_11 0)) (=> (>= i_11 0) (and (=> (= (ControlFlow 0 66) (- 0 67)) (< i_11 (|Seq#Length| a_2))) (=> (< i_11 (|Seq#Length| a_2)) (=> (= (ControlFlow 0 66) 65) anon12_correct))))))))
(let ((anon47_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (= (|Seq#Length| a_2) len) (state PostHeap@0 ZeroMask)) (and (and (=> (= (ControlFlow 0 82) 80) anon48_Else_correct) (=> (= (ControlFlow 0 82) 66) anon49_Then_correct)) (=> (= (ControlFlow 0 82) 69) anon49_Else_correct))))))
(let ((anon41_correct true))
(let ((anon63_Else_correct  (=> (and (not (and (<= 0 i_7) (< i_7 len))) (= (ControlFlow 0 34) 31)) anon41_correct)))
(let ((anon63_Then_correct  (=> (and (<= 0 i_7) (< i_7 len)) (and (=> (= (ControlFlow 0 32) (- 0 33)) (= (U_2_int (MapType0Select ExhaleHeap@0 (|Seq#Index| a_2 i_7) Ref__Integer_value)) (U_2_int (MapType0Select Heap@@33 (|Seq#Index| a_2 i_7) Ref__Integer_value)))) (=> (= (U_2_int (MapType0Select ExhaleHeap@0 (|Seq#Index| a_2 i_7) Ref__Integer_value)) (U_2_int (MapType0Select Heap@@33 (|Seq#Index| a_2 i_7) Ref__Integer_value))) (=> (= (ControlFlow 0 32) 31) anon41_correct))))))
(let ((anon62_Else_correct true))
(let ((anon60_Else_correct  (=> (and (forall ((i_14_1 Int) ) (!  (=> (and (<= 0 i_14_1) (< i_14_1 len)) (= (U_2_int (MapType0Select ExhaleHeap@0 (|Seq#Index| a_2 i_14_1) Ref__Integer_value)) (U_2_int (MapType0Select Heap@@33 (|Seq#Index| a_2 i_14_1) Ref__Integer_value))))
 :qid |stdinbpl.2635:20|
 :skolemid |207|
 :pattern ( (|Seq#Index| a_2 i_14_1))
)) (state ExhaleHeap@0 QPMask@2)) (and (=> (= (ControlFlow 0 35) (- 0 38)) (= (|Seq#Length| a_2) len)) (=> (= (|Seq#Length| a_2) len) (and (=> (= (ControlFlow 0 35) (- 0 37)) (forall ((i_6 Int) (i_6_1 Int) ) (!  (=> (and (and (and (and (not (= i_6 i_6_1)) (and (<= 0 i_6) (< i_6 len))) (and (<= 0 i_6_1) (< i_6_1 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| a_2 i_6) (|Seq#Index| a_2 i_6_1))))
 :qid |stdinbpl.2653:17|
 :skolemid |208|
 :pattern ( (neverTriggered14 i_6) (neverTriggered14 i_6_1))
))) (=> (forall ((i_6@@0 Int) (i_6_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_6@@0 i_6_1@@0)) (and (<= 0 i_6@@0) (< i_6@@0 len))) (and (<= 0 i_6_1@@0) (< i_6_1@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| a_2 i_6@@0) (|Seq#Index| a_2 i_6_1@@0))))
 :qid |stdinbpl.2653:17|
 :skolemid |208|
 :pattern ( (neverTriggered14 i_6@@0) (neverTriggered14 i_6_1@@0))
)) (and (=> (= (ControlFlow 0 35) (- 0 36)) (forall ((i_6@@1 Int) ) (!  (=> (and (<= 0 i_6@@1) (< i_6@@1 len)) (>= (U_2_real (MapType1Select QPMask@2 (|Seq#Index| a_2 i_6@@1) Ref__Integer_value)) FullPerm))
 :qid |stdinbpl.2660:17|
 :skolemid |209|
 :pattern ( (|Seq#Index| a_2 i_6@@1))
 :pattern ( (|Seq#Index| a_2 i_6@@1))
))) (=> (forall ((i_6@@2 Int) ) (!  (=> (and (<= 0 i_6@@2) (< i_6@@2 len)) (>= (U_2_real (MapType1Select QPMask@2 (|Seq#Index| a_2 i_6@@2) Ref__Integer_value)) FullPerm))
 :qid |stdinbpl.2660:17|
 :skolemid |209|
 :pattern ( (|Seq#Index| a_2 i_6@@2))
 :pattern ( (|Seq#Index| a_2 i_6@@2))
)) (=> (and (and (forall ((i_6@@3 Int) ) (!  (=> (and (and (<= 0 i_6@@3) (< i_6@@3 len)) (< NoPerm FullPerm)) (and (qpRange14 (|Seq#Index| a_2 i_6@@3)) (= (invRecv14 (|Seq#Index| a_2 i_6@@3)) i_6@@3)))
 :qid |stdinbpl.2666:22|
 :skolemid |210|
 :pattern ( (|Seq#Index| a_2 i_6@@3))
 :pattern ( (|Seq#Index| a_2 i_6@@3))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (<= 0 (invRecv14 o_3@@2)) (< (invRecv14 o_3@@2) len)) (and (< NoPerm FullPerm) (qpRange14 o_3@@2))) (= (|Seq#Index| a_2 (invRecv14 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.2670:22|
 :skolemid |211|
 :pattern ( (invRecv14 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (<= 0 (invRecv14 o_3@@3)) (< (invRecv14 o_3@@3) len)) (and (< NoPerm FullPerm) (qpRange14 o_3@@3))) (and (= (|Seq#Index| a_2 (invRecv14 o_3@@3)) o_3@@3) (= (U_2_real (MapType1Select QPMask@3 o_3@@3 Ref__Integer_value)) (- (U_2_real (MapType1Select QPMask@2 o_3@@3 Ref__Integer_value)) FullPerm)))) (=> (not (and (and (<= 0 (invRecv14 o_3@@3)) (< (invRecv14 o_3@@3) len)) (and (< NoPerm FullPerm) (qpRange14 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@3 o_3@@3 Ref__Integer_value)) (U_2_real (MapType1Select QPMask@2 o_3@@3 Ref__Integer_value))))))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 Ref__Integer_value))) (= (U_2_real (MapType1Select QPMask@2 o_3@@4 f_5@@0)) (U_2_real (MapType1Select QPMask@3 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.2682:29|
 :skolemid |213|
 :pattern ( (MapType1Select QPMask@3 o_3@@4 f_5@@0))
)))) (and (and (=> (= (ControlFlow 0 35) 30) anon62_Else_correct) (=> (= (ControlFlow 0 35) 32) anon63_Then_correct)) (=> (= (ControlFlow 0 35) 34) anon63_Else_correct))))))))))))
(let ((anon37_correct true))
(let ((anon61_Else_correct  (=> (and (not (and (<= 0 i_13_1) (< i_13_1 len))) (= (ControlFlow 0 29) 26)) anon37_correct)))
(let ((anon61_Then_correct  (=> (and (<= 0 i_13_1) (< i_13_1 len)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (= (U_2_int (MapType0Select ExhaleHeap@0 (|Seq#Index| a_2 i_13_1) Ref__Integer_value)) (U_2_int (MapType0Select Heap@@33 (|Seq#Index| a_2 i_13_1) Ref__Integer_value)))) (=> (= (U_2_int (MapType0Select ExhaleHeap@0 (|Seq#Index| a_2 i_13_1) Ref__Integer_value)) (U_2_int (MapType0Select Heap@@33 (|Seq#Index| a_2 i_13_1) Ref__Integer_value))) (=> (= (ControlFlow 0 27) 26) anon37_correct))))))
(let ((anon33_correct true))
(let ((anon59_Else_correct  (=> (and (not (and (<= 0 i_13) (< i_13 len))) (= (ControlFlow 0 25) 17)) anon33_correct)))
(let ((anon59_Then_correct  (=> (and (<= 0 i_13) (< i_13 len)) (and (=> (= (ControlFlow 0 18) (- 0 24)) (>= i_13 0)) (=> (>= i_13 0) (and (=> (= (ControlFlow 0 18) (- 0 23)) (< i_13 (|Seq#Length| a_2))) (=> (< i_13 (|Seq#Length| a_2)) (and (=> (= (ControlFlow 0 18) (- 0 22)) (HasDirectPerm QPMask@2 (|Seq#Index| a_2 i_13) Ref__Integer_value)) (=> (HasDirectPerm QPMask@2 (|Seq#Index| a_2 i_13) Ref__Integer_value) (and (=> (= (ControlFlow 0 18) (- 0 21)) (>= i_13 0)) (=> (>= i_13 0) (and (=> (= (ControlFlow 0 18) (- 0 20)) (< i_13 (|Seq#Length| a_2))) (=> (< i_13 (|Seq#Length| a_2)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm QPMask@0 (|Seq#Index| a_2 i_13) Ref__Integer_value)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| a_2 i_13) Ref__Integer_value) (=> (= (ControlFlow 0 18) 17) anon33_correct))))))))))))))))
(let ((anon30_correct  (=> (state ExhaleHeap@0 QPMask@2) (and (and (and (and (=> (= (ControlFlow 0 39) 35) anon60_Else_correct) (=> (= (ControlFlow 0 39) 27) anon61_Then_correct)) (=> (= (ControlFlow 0 39) 29) anon61_Else_correct)) (=> (= (ControlFlow 0 39) 18) anon59_Then_correct)) (=> (= (ControlFlow 0 39) 25) anon59_Else_correct)))))
(let ((anon29_correct  (=> (and (= AssertMask@0 (MapType1Store QPMask@2 (|Seq#Index| a_2 0) Ref__Integer_value (real_2_U (- (U_2_real (MapType1Select QPMask@2 (|Seq#Index| a_2 0) Ref__Integer_value)) FullPerm)))) (state ExhaleHeap@0 QPMask@2)) (and (=> (= (ControlFlow 0 41) (- 0 46)) (< 0 (|Seq#Length| a_2))) (=> (< 0 (|Seq#Length| a_2)) (and (=> (= (ControlFlow 0 41) (- 0 45)) (HasDirectPerm QPMask@2 (|Seq#Index| a_2 0) Ref__Integer_value)) (=> (HasDirectPerm QPMask@2 (|Seq#Index| a_2 0) Ref__Integer_value) (and (=> (= (ControlFlow 0 41) (- 0 44)) (< 0 (|Seq#Length| a_2))) (=> (< 0 (|Seq#Length| a_2)) (and (=> (= (ControlFlow 0 41) (- 0 43)) (HasDirectPerm QPMask@0 (|Seq#Index| a_2 0) Ref__Integer_value)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| a_2 0) Ref__Integer_value) (and (=> (= (ControlFlow 0 41) (- 0 42)) (= (U_2_int (MapType0Select ExhaleHeap@0 (|Seq#Index| a_2 0) Ref__Integer_value)) (U_2_int (MapType0Select Heap@@33 (|Seq#Index| a_2 0) Ref__Integer_value)))) (=> (= (U_2_int (MapType0Select ExhaleHeap@0 (|Seq#Index| a_2 0) Ref__Integer_value)) (U_2_int (MapType0Select Heap@@33 (|Seq#Index| a_2 0) Ref__Integer_value))) (=> (and (state ExhaleHeap@0 QPMask@2) (= (ControlFlow 0 41) 39)) anon30_correct))))))))))))))
(let ((anon57_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 49) 41)) anon29_correct)))
(let ((anon57_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 47) (- 0 48)) (<= FullPerm (U_2_real (MapType1Select QPMask@2 (|Seq#Index| a_2 0) Ref__Integer_value)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@2 (|Seq#Index| a_2 0) Ref__Integer_value))) (=> (= (ControlFlow 0 47) 41) anon29_correct))))))
(let ((anon56_Then_correct  (=> (> len 0) (and (=> (= (ControlFlow 0 50) (- 0 51)) (< 0 (|Seq#Length| a_2))) (=> (< 0 (|Seq#Length| a_2)) (and (=> (= (ControlFlow 0 50) 47) anon57_Then_correct) (=> (= (ControlFlow 0 50) 49) anon57_Else_correct)))))))
(let ((anon56_Else_correct  (=> (and (>= 0 len) (= (ControlFlow 0 40) 39)) anon30_correct)))
(let ((anon26_correct  (and (=> (= (ControlFlow 0 52) (- 0 53)) (forall ((i_10 Int) (i_10_1 Int) ) (!  (=> (and (and (and (and (not (= i_10 i_10_1)) (and (<= 0 i_10) (< i_10 len))) (and (<= 0 i_10_1) (< i_10_1 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| a_2 i_10) (|Seq#Index| a_2 i_10_1))))
 :qid |stdinbpl.2525:17|
 :skolemid |200|
))) (=> (forall ((i_10@@0 Int) (i_10_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_10@@0 i_10_1@@0)) (and (<= 0 i_10@@0) (< i_10@@0 len))) (and (<= 0 i_10_1@@0) (< i_10_1@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| a_2 i_10@@0) (|Seq#Index| a_2 i_10_1@@0))))
 :qid |stdinbpl.2525:17|
 :skolemid |200|
)) (=> (forall ((i_10@@1 Int) ) (!  (=> (and (and (<= 0 i_10@@1) (< i_10@@1 len)) (< NoPerm FullPerm)) (and (qpRange16 (|Seq#Index| a_2 i_10@@1)) (= (invRecv16 (|Seq#Index| a_2 i_10@@1)) i_10@@1)))
 :qid |stdinbpl.2531:24|
 :skolemid |201|
 :pattern ( (|Seq#Index| a_2 i_10@@1))
 :pattern ( (|Seq#Index| a_2 i_10@@1))
)) (=> (and (and (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (and (<= 0 (invRecv16 o_3@@5)) (< (invRecv16 o_3@@5) len)) (< NoPerm FullPerm)) (qpRange16 o_3@@5)) (= (|Seq#Index| a_2 (invRecv16 o_3@@5)) o_3@@5)))
 :qid |stdinbpl.2535:24|
 :skolemid |202|
 :pattern ( (invRecv16 o_3@@5))
)) (forall ((i_10@@2 Int) ) (!  (=> (and (<= 0 i_10@@2) (< i_10@@2 len)) (not (= (|Seq#Index| a_2 i_10@@2) null)))
 :qid |stdinbpl.2541:24|
 :skolemid |203|
 :pattern ( (|Seq#Index| a_2 i_10@@2))
 :pattern ( (|Seq#Index| a_2 i_10@@2))
))) (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (and (<= 0 (invRecv16 o_3@@6)) (< (invRecv16 o_3@@6) len)) (< NoPerm FullPerm)) (qpRange16 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| a_2 (invRecv16 o_3@@6)) o_3@@6)) (= (U_2_real (MapType1Select QPMask@2 o_3@@6 Ref__Integer_value)) (+ (U_2_real (MapType1Select QPMask@1 o_3@@6 Ref__Integer_value)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv16 o_3@@6)) (< (invRecv16 o_3@@6) len)) (< NoPerm FullPerm)) (qpRange16 o_3@@6))) (= (U_2_real (MapType1Select QPMask@2 o_3@@6 Ref__Integer_value)) (U_2_real (MapType1Select QPMask@1 o_3@@6 Ref__Integer_value))))))
 :qid |stdinbpl.2547:24|
 :skolemid |204|
...
(let ((A@@14 (FieldTypeInv0 (type f_5@@1))))
 ...
 :qid |stdinbpl.2551:31|
 :skolemid |205|
 :pattern ( (MapType1Select QPMask@1 o_3@@7 f_5@@1))
 :pattern ( (MapType1Select QPMask@2 o_3@@7 f_5@@1))
)))) (and (and (state ExhaleHeap@0 QPMask@2) (forall ((i_11_1 Int) ) (!  (=> (and (<= 0 i_11_1) (< i_11_1 len)) (= (U_2_int (MapType0Select ExhaleHeap@0 (|Seq#Index| a_2 i_11_1) Ref__Integer_value)) (U_2_int (MapType0Select Heap@@33 (|Seq#Index| a_2 i_11_1) Ref__Integer_value))))
 :qid |stdinbpl.2557:22|
 :skolemid |206|
 :pattern ( (|Seq#Index| a_2 i_11_1))
))) (and (state ExhaleHeap@0 QPMask@2) (state ExhaleHeap@0 QPMask@2)))) (and (=> (= (ControlFlow 0 52) 50) anon56_Then_correct) (=> (= (ControlFlow 0 52) 40) anon56_Else_correct))))))))
(let ((anon55_Else_correct  (=> (and (<= len 0) (= (ControlFlow 0 55) 52)) anon26_correct)))
(let ((anon55_Then_correct  (=> (< 0 len) (=> (and (= (|Seq#Length| a_2) len) (= (ControlFlow 0 54) 52)) anon26_correct))))
(let ((anon53_Else_correct  (=> (forall ((k_3_1 Int) (j_3_1 Int) ) (!  (=> (and (>= k_3_1 0) (and (< k_3_1 (|Seq#Length| a_2)) (and (>= j_3_1 0) (and (< j_3_1 (|Seq#Length| a_2)) (not (= k_3_1 j_3_1)))))) (not (= (|Seq#Index| a_2 k_3_1) (|Seq#Index| a_2 j_3_1))))
 :qid |stdinbpl.2469:22|
 :skolemid |193|
 :pattern ( (|Seq#Index| a_2 k_3_1) (|Seq#Index| a_2 j_3_1))
)) (and (=> (= (ControlFlow 0 56) (- 0 58)) (forall ((i_9 Int) (i_9_1 Int) ) (!  (=> (and (and (and (and (not (= i_9 i_9_1)) (and (<= 0 i_9) (< i_9 len))) (and (<= 0 i_9_1) (< i_9_1 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| a_2 i_9) (|Seq#Index| a_2 i_9_1))))
 :qid |stdinbpl.2480:19|
 :skolemid |194|
 :pattern ( (neverTriggered15 i_9) (neverTriggered15 i_9_1))
))) (=> (forall ((i_9@@0 Int) (i_9_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_9@@0 i_9_1@@0)) (and (<= 0 i_9@@0) (< i_9@@0 len))) (and (<= 0 i_9_1@@0) (< i_9_1@@0 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| a_2 i_9@@0) (|Seq#Index| a_2 i_9_1@@0))))
 :qid |stdinbpl.2480:19|
 :skolemid |194|
 :pattern ( (neverTriggered15 i_9@@0) (neverTriggered15 i_9_1@@0))
)) (and (=> (= (ControlFlow 0 56) (- 0 57)) (forall ((i_9@@1 Int) ) (!  (=> (and (<= 0 i_9@@1) (< i_9@@1 len)) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| a_2 i_9@@1) Ref__Integer_value)) FullPerm))
 :qid |stdinbpl.2487:19|
 :skolemid |195|
 :pattern ( (|Seq#Index| a_2 i_9@@1))
 :pattern ( (|Seq#Index| a_2 i_9@@1))
))) (=> (forall ((i_9@@2 Int) ) (!  (=> (and (<= 0 i_9@@2) (< i_9@@2 len)) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| a_2 i_9@@2) Ref__Integer_value)) FullPerm))
 :qid |stdinbpl.2487:19|
 :skolemid |195|
 :pattern ( (|Seq#Index| a_2 i_9@@2))
 :pattern ( (|Seq#Index| a_2 i_9@@2))
)) (=> (forall ((i_9@@3 Int) ) (!  (=> (and (and (<= 0 i_9@@3) (< i_9@@3 len)) (< NoPerm FullPerm)) (and (qpRange15 (|Seq#Index| a_2 i_9@@3)) (= (invRecv15 (|Seq#Index| a_2 i_9@@3)) i_9@@3)))
 :qid |stdinbpl.2493:24|
 :skolemid |196|
 :pattern ( (|Seq#Index| a_2 i_9@@3))
 :pattern ( (|Seq#Index| a_2 i_9@@3))
)) (=> (and (and (forall ((o_3@@8 T@U) ) (!  (=> (= (type o_3@@8) RefType) (=> (and (and (<= 0 (invRecv15 o_3@@8)) (< (invRecv15 o_3@@8) len)) (and (< NoPerm FullPerm) (qpRange15 o_3@@8))) (= (|Seq#Index| a_2 (invRecv15 o_3@@8)) o_3@@8)))
 :qid |stdinbpl.2497:24|
 :skolemid |197|
 :pattern ( (invRecv15 o_3@@8))
)) (forall ((o_3@@9 T@U) ) (!  (=> (= (type o_3@@9) RefType) (and (=> (and (and (<= 0 (invRecv15 o_3@@9)) (< (invRecv15 o_3@@9) len)) (and (< NoPerm FullPerm) (qpRange15 o_3@@9))) (and (= (|Seq#Index| a_2 (invRecv15 o_3@@9)) o_3@@9) (= (U_2_real (MapType1Select QPMask@1 o_3@@9 Ref__Integer_value)) (- (U_2_real (MapType1Select QPMask@0 o_3@@9 Ref__Integer_value)) FullPerm)))) (=> (not (and (and (<= 0 (invRecv15 o_3@@9)) (< (invRecv15 o_3@@9) len)) (and (< NoPerm FullPerm) (qpRange15 o_3@@9)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@9 Ref__Integer_value)) (U_2_real (MapType1Select QPMask@0 o_3@@9 Ref__Integer_value))))))
 :qid |stdinbpl.2503:24|
 :skolemid |198|
 :pattern ( (MapType1Select QPMask@1 o_3@@9 Ref__Integer_value))
))) (and (forall ((o_3@@10 T@U) (f_5@@2 T@U) ) (! (let ((B@@14 (FieldTypeInv1 (type f_5@@2))))
(let ((A@@15 (FieldTypeInv0 (type f_5@@2))))
 (=> (and (and (= (type o_3@@10) RefType) (= (type f_5@@2) (FieldType A@@15 B@@14))) (not (= f_5@@2 Ref__Integer_value))) (= (U_2_real (MapType1Select QPMask@0 o_3@@10 f_5@@2)) (U_2_real (MapType1Select QPMask@1 o_3@@10 f_5@@2))))))
 :qid |stdinbpl.2509:31|
 :skolemid |199|
 :pattern ( (MapType1Select QPMask@1 o_3@@10 f_5@@2))
)) (IdenticalOnKnownLocations Heap@@33 ExhaleHeap@0 QPMask@1))) (and (=> (= (ControlFlow 0 56) 54) anon55_Then_correct) (=> (= (ControlFlow 0 56) 55) anon55_Else_correct)))))))))))
(let ((anon23_correct true))
(let ((anon54_Else_correct  (=> (and (not (and (>= k_2_1 0) (and (< k_2_1 (|Seq#Length| a_2)) (and (>= j_2_1 0) (and (< j_2_1 (|Seq#Length| a_2)) (not (= k_2_1 j_2_1))))))) (= (ControlFlow 0 16) 13)) anon23_correct)))
(let ((anon54_Then_correct  (=> (and (>= k_2_1 0) (and (< k_2_1 (|Seq#Length| a_2)) (and (>= j_2_1 0) (and (< j_2_1 (|Seq#Length| a_2)) (not (= k_2_1 j_2_1)))))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (not (= (|Seq#Index| a_2 k_2_1) (|Seq#Index| a_2 j_2_1)))) (=> (not (= (|Seq#Index| a_2 k_2_1) (|Seq#Index| a_2 j_2_1))) (=> (= (ControlFlow 0 14) 13) anon23_correct))))))
(let ((anon52_Else_correct  (=> (<= len 0) (and (and (=> (= (ControlFlow 0 61) 56) anon53_Else_correct) (=> (= (ControlFlow 0 61) 14) anon54_Then_correct)) (=> (= (ControlFlow 0 61) 16) anon54_Else_correct)))))
(let ((anon52_Then_correct  (=> (< 0 len) (and (=> (= (ControlFlow 0 59) (- 0 60)) (= (|Seq#Length| a_2) len)) (=> (= (|Seq#Length| a_2) len) (and (and (=> (= (ControlFlow 0 59) 56) anon53_Else_correct) (=> (= (ControlFlow 0 59) 14) anon54_Then_correct)) (=> (= (ControlFlow 0 59) 16) anon54_Else_correct)))))))
(let ((anon47_Else_correct  (and (=> (= (ControlFlow 0 62) (- 0 64)) (not (= diz null))) (=> (not (= diz null)) (and (=> (= (ControlFlow 0 62) (- 0 63)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (and (=> (= (ControlFlow 0 62) 59) anon52_Then_correct) (=> (= (ControlFlow 0 62) 61) anon52_Else_correct))))))))
(let ((anon45_Else_correct  (and (=> (= (ControlFlow 0 83) (- 0 84)) (forall ((i_1 Int) (i_1_2 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_2)) (and (<= 0 i_1) (< i_1 len))) (and (<= 0 i_1_2) (< i_1_2 len))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| a_2 i_1) (|Seq#Index| a_2 i_1_2))))
 ...
 :qid |stdinbpl.2327:15|
 :skolemid |180|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 len)) (< NoPerm FullPerm)) (and (qpRange12 (|Seq#Index| a_2 i_1@@1)) (= (invRecv12 (|Seq#Index| a_2 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.2333:22|
 :skolemid |181|
 :pattern ( (|Seq#Index| a_2 i_1@@1))
 :pattern ( (|Seq#Index| a_2 i_1@@1))
)) (=> (and (forall ((o_3@@11 T@U) ) (!  (=> (= (type o_3@@11) RefType) (=> (and (and (and (<= 0 (invRecv12 o_3@@11)) (< (invRecv12 o_3@@11) len)) (< NoPerm FullPerm)) (qpRange12 o_3@@11)) (= (|Seq#Index| a_2 (invRecv12 o_3@@11)) o_3@@11)))
 ...
 :pattern ( (|Seq#Index| a_2 i_1@@2))
))) (=> (and (and (forall ((o_3@@12 T@U) ) (!  (=> (= (type o_3@@12) RefType) (and (=> (and (and (and (<= 0 (invRecv12 o_3@@12)) (< (invRecv12 o_3@@12) len)) (< NoPerm FullPerm)) (qpRange12 o_3@@12)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| a_2 (invRecv12 o_3@@12)) o_3@@12)) (= (U_2_real (MapType1Select QPMask@0 o_3@@12 Ref__Integer_value)) (+ (U_2_real (MapType1Select ZeroMask o_3@@12 Ref__Integer_value)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv12 o_3@@12)) (< (invRecv12 o_3@@12) len)) (< NoPerm FullPerm)) (qpRange12 o_3@@12))) (= (U_2_real (MapType1Select QPMask@0 o_3@@12 Ref__Integer_value)) (U_2_real (MapType1Select ZeroMask o_3@@12 Ref__Integer_value))))))
...
))) (and (state Heap@@33 QPMask@0) (state Heap@@33 QPMask@0))) (and (=> (= (ControlFlow 0 83) 82) anon47_Then_correct) (=> (= (ControlFlow 0 83) 62) anon47_Else_correct)))))))))
(let ((anon7_correct true))
(let ((anon46_Else_correct  (=> (and (not (and (<= 0 i_8) (< i_8 len))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon46_Then_correct  (=> (and (<= 0 i_8) (< i_8 len)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_8 0)) (=> (>= i_8 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_8 (|Seq#Length| a_2))) (=> (< i_8 (|Seq#Length| a_2)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon43_Else_correct  (=> (and (forall ((k_1_1 Int) (j_1_1 Int) ) (!  (=> (and (>= k_1_1 0) (and (< k_1_1 (|Seq#Length| a_2)) (and (>= j_1_1 0) (and (< j_1_1 (|Seq#Length| a_2)) (not (= k_1_1 j_1_1)))))) (not (= (|Seq#Index| a_2 k_1_1) (|Seq#Index| a_2 j_1_1))))
 :qid |stdinbpl.2309:20|
 :skolemid |179|
 :pattern ( (|Seq#Index| a_2 k_1_1) (|Seq#Index| a_2 j_1_1))
)) (state Heap@@33 ZeroMask)) (and (and (=> (= (ControlFlow 0 85) 83) anon45_Else_correct) (=> (= (ControlFlow 0 85) 9) anon46_Then_correct)) (=> (= (ControlFlow 0 85) 12) anon46_Else_correct)))))
(let ((anon3_correct true))
(let ((anon44_Else_correct  (=> (and (not (and (>= k_14 0) (and (< k_14 (|Seq#Length| a_2)) (and (>= j_8 0) (and (< j_8 (|Seq#Length| a_2)) (not (= k_14 j_8))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon44_Then_correct  (=> (and (>= k_14 0) (and (< k_14 (|Seq#Length| a_2)) (and (>= j_8 0) (and (< j_8 (|Seq#Length| a_2)) (not (= k_14 j_8)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= k_14 0)) (=> (>= k_14 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< k_14 (|Seq#Length| a_2))) (=> (< k_14 (|Seq#Length| a_2)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_8 0)) (=> (>= j_8 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_8 (|Seq#Length| a_2))) (=> (< j_8 (|Seq#Length| a_2)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@33 diz $allocated))) (and (not (= diz null)) (state Heap@@33 ZeroMask))) (and (and (>= current_thread_id 0) (state Heap@@33 ZeroMask)) (and (= (|Seq#Length| a_2) len) (state Heap@@33 ZeroMask)))) (and (and (=> (= (ControlFlow 0 86) 85) anon43_Else_correct) (=> (= (ControlFlow 0 86) 2) anon44_Then_correct)) (=> (= (ControlFlow 0 86) 7) anon44_Else_correct))))))
