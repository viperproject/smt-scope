...
(declare-fun |ge'| (T@U Int Int) Bool)
(declare-fun MapType0Type (T@T) T@T)
(declare-fun RefType () T@T)
(declare-fun MapType1Type (T@T T@T) T@T)
(declare-fun |ge#frame| (T@U Int Int) Bool)
...
(assert (forall ((Heap T@U) (Mask T@U) (i1 Int) (i2 Int) ) (!  (=> (and (and (= (type Heap) (MapType0Type RefType)) (= (type Mask) (MapType1Type RefType realType))) (state Heap Mask)) (= (|ge'| Heap i1 i2) (|ge#frame| EmptyFrame i1 i2)))
 :qid |stdinbpl.286:15|
 :skolemid |30|
 :pattern ( (state Heap Mask) (|ge'| Heap i1 i2))
)))
...
(assert (forall ((Heap@@1 T@U) (i1@@0 Int) (i2@@0 Int) ) (!  (=> (= (type Heap@@1) (MapType0Type RefType)) (dummyFunction (bool_2_U (|ge#triggerStateless| i1@@0 i2@@0))))
 :qid |stdinbpl.273:15|
 :skolemid |28|
 :pattern ( (|ge'| Heap@@1 i1@@0 i2@@0))
)))
...
(assert (forall ((Heap@@4 T@U) (i Int) ) (!  (=> (= (type Heap@@4) (MapType0Type RefType)) (dummyFunction (int_2_U (|fac#triggerStateless| i))))
 :qid |stdinbpl.190:15|
 :skolemid |23|
 :pattern ( (|fac'| Heap@@4 i))
)))
...
(assert (forall ((Heap@@6 T@U) (i@@0 Int) ) (!  (=> (= (type Heap@@6) (MapType0Type RefType)) (and (= (fac Heap@@6 i@@0) (|fac'| Heap@@6 i@@0)) (dummyFunction (int_2_U (|fac#triggerStateless| i@@0)))))
 :qid |stdinbpl.186:15|
 :skolemid |22|
 :pattern ( (fac Heap@@6 i@@0))
)))
(assert (forall ((Heap@@7 T@U) (Mask@@4 T@U) (i@@1 Int) ) (!  (=> (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type Mask@@4) (MapType1Type RefType realType))) (and (state Heap@@7 Mask@@4) (< AssumeFunctionsAbove 0))) (= (fac Heap@@7 i@@1) (ite (<= i@@1 1) 1 (* i@@1 (|fac'| Heap@@7 (- i@@1 1))))))
 :qid |stdinbpl.196:15|
 :skolemid |24|
 :pattern ( (state Heap@@7 Mask@@4) (fac Heap@@7 i@@1))
)))
...
(assert (forall ((Heap@@10 T@U) (Mask@@8 T@U) (i@@2 Int) ) (!  (=> (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@8) (MapType1Type RefType realType))) (and (state Heap@@10 Mask@@8) (or (< AssumeFunctionsAbove 0) (|fac#trigger| EmptyFrame i@@2)))) (ge Heap@@10 (|fac'| Heap@@10 i@@2) 1))
 :qid |stdinbpl.209:15|
 :skolemid |26|
 :pattern ( (state Heap@@10 Mask@@8) (|fac'| Heap@@10 i@@2))
)))
...
(assert (forall ((Heap@@13 T@U) (Mask@@12 T@U) (i@@3 Int) ) (!  (=> (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (state Heap@@13 Mask@@12)) (= (|fac'| Heap@@13 i@@3) (|fac#frame| EmptyFrame i@@3)))
 :qid |stdinbpl.203:15|
 :skolemid |25|
 :pattern ( (state Heap@@13 Mask@@12) (|fac'| Heap@@13 i@@3))
)))
...
(assert (forall ((Heap@@16 T@U) (Mask@@13 T@U) (i1@@1 Int) (i2@@1 Int) ) (!  (=> (and (and (= (type Heap@@16) (MapType0Type RefType)) (= (type Mask@@13) (MapType1Type RefType realType))) (and (state Heap@@16 Mask@@13) (< AssumeFunctionsAbove 1))) (= (ge Heap@@16 i1@@1 i2@@1) (>= i1@@1 i2@@1)))
 :qid |stdinbpl.279:15|
 :skolemid |29|
 :pattern ( (state Heap@@16 Mask@@13) (ge Heap@@16 i1@@1 i2@@1))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@17 T@U) (i1@@2 Int) (i2@@2 Int) ) (!  (=> (= (type Heap@@17) (MapType0Type RefType)) (and (= (ge Heap@@17 i1@@2 i2@@2) (|ge'| Heap@@17 i1@@2 i2@@2)) (dummyFunction (bool_2_U (|ge#triggerStateless| i1@@2 i2@@2)))))
 :qid |stdinbpl.269:15|
 :skolemid |27|
 :pattern ( (ge Heap@@17 i1@@2 i2@@2))
)))
(push 1)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon10_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (ge Heap@@18 Result@0 1))))
(let ((anon10_Then_correct true))
(let ((anon5_correct  (=> (= Result@0 (ite (<= i@@4 1) 1 (* i@@4 (fac Heap@@18 (- i@@4 1))))) (and (=> (= (ControlFlow 0 5) 2) anon10_Then_correct) (=> (= (ControlFlow 0 5) 4) anon10_Else_correct)))))
...
(let ((anon0_correct  (=> (and (state Heap@@18 ZeroMask) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 9) 6) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct)))))
