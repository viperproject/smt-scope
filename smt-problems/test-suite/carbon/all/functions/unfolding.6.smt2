...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@@37) (MapType0Type RefType)) (= (type y@@9) RefType)) (= (type Unfolding1Mask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@2) (MapType1Type RefType realType))) (= (type Unfolding1Mask@1) (MapType1Type RefType realType))) (= (type Unfolding1Mask@2) (MapType1Type RefType realType))) (= (type UnfoldingHeap@0) (MapType0Type RefType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type UnfoldingHeap@1) (MapType0Type RefType))) (forall ((arg0@@35 T@U) ) (! (= (type (FrameFragment arg0@@35)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@35))
))) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |fun3#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon6_correct true))
(let ((anon5_correct  (=> (and (and (and (= Unfolding1Mask@0 (MapType1Store UnfoldingMask@2 null (R (MapType0Select Heap@@37 y@@9 n)) (real_2_U (- (U_2_real (MapType1Select UnfoldingMask@2 null (R (MapType0Select Heap@@37 y@@9 n)))) FullPerm)))) (not (= (MapType0Select Heap@@37 y@@9 n) null))) (and (= Unfolding1Mask@1 (MapType1Store Unfolding1Mask@0 (MapType0Select Heap@@37 y@@9 n) n (real_2_U (+ (U_2_real (MapType1Select Unfolding1Mask@0 (MapType0Select Heap@@37 y@@9 n) n)) FullPerm)))) (state Heap@@37 Unfolding1Mask@1))) (and (and (= Unfolding1Mask@2 (MapType1Store Unfolding1Mask@1 null (R (MapType0Select Heap@@37 (MapType0Select Heap@@37 y@@9 n) n)) (real_2_U (+ (U_2_real (MapType1Select Unfolding1Mask@1 null (R (MapType0Select Heap@@37 (MapType0Select Heap@@37 y@@9 n) n)))) FullPerm)))) (InsidePredicate (R (MapType0Select Heap@@37 y@@9 n)) (MapType0Select Heap@@37 null (R (MapType0Select Heap@@37 y@@9 n))) (R (MapType0Select Heap@@37 (MapType0Select Heap@@37 y@@9 n) n)) (MapType0Select Heap@@37 null (R (MapType0Select Heap@@37 (MapType0Select Heap@@37 y@@9 n) n))))) (and (state Heap@@37 Unfolding1Mask@2) (state Heap@@37 Unfolding1Mask@2)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm Unfolding1Mask@2 y@@9 n)) (=> (HasDirectPerm Unfolding1Mask@2 y@@9 n) (=> (= UnfoldingHeap@0 (MapType0Store Heap@@37 null (|R#sm| (MapType0Select Heap@@37 y@@9 n)) (MapType1Store (MapType0Select Heap@@37 null (|R#sm| (MapType0Select Heap@@37 y@@9 n))) (MapType0Select Heap@@37 y@@9 n) n (bool_2_U true)))) (=> (and (and (forall ((o_3 T@U) (f_8 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_8))))
(let ((A@@12 (FieldTypeInv0 (type f_8))))
 (=> (and (and (= (type o_3) RefType) (= (type f_8) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select UnfoldingHeap@0 null (|R#sm| (MapType0Select UnfoldingHeap@0 y@@9 n))) o_3 f_8)) (U_2_bool (MapType1Select (MapType0Select UnfoldingHeap@0 null (|R#sm| (MapType0Select UnfoldingHeap@0 (MapType0Select UnfoldingHeap@0 y@@9 n) n))) o_3 f_8)))) (U_2_bool (MapType1Select newPMask@0 o_3 f_8)))))
 :qid |stdinbpl.871:33|
 :skolemid |46|
 :pattern ( (MapType1Select newPMask@0 o_3 f_8))
)) (= UnfoldingHeap@1 (MapType0Store UnfoldingHeap@0 null (|R#sm| (MapType0Select UnfoldingHeap@0 y@@9 n)) newPMask@0))) (and (state UnfoldingHeap@1 UnfoldingMask@2) (= (ControlFlow 0 3) 1))) anon6_correct)))))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@2 null (R (MapType0Select Heap@@37 y@@9 n)))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@2 null (R (MapType0Select Heap@@37 y@@9 n))))) (=> (= (ControlFlow 0 5) 3) anon5_correct))))))
(let ((anon8_Then_correct  (=> (not (= (MapType0Select Heap@@37 y@@9 n) null)) (=> (and (|R#trigger| Heap@@37 (R (MapType0Select Heap@@37 y@@9 n))) (= (MapType0Select Heap@@37 null (R (MapType0Select Heap@@37 y@@9 n))) (CombineFrames (FrameFragment (MapType0Select Heap@@37 (MapType0Select Heap@@37 y@@9 n) n)) (MapType0Select Heap@@37 null (R (MapType0Select Heap@@37 (MapType0Select Heap@@37 y@@9 n) n)))))) (and (=> (= (ControlFlow 0 8) 5) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct))))))
(let ((anon8_Else_correct  (=> (and (= (MapType0Select Heap@@37 y@@9 n) null) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon2_correct  (=> (and (and (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (R y@@9) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (R y@@9))) FullPerm)))) (not (= y@@9 null))) (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 y@@9 n (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 y@@9 n)) FullPerm)))) (state Heap@@37 UnfoldingMask@1))) (and (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 null (R (MapType0Select Heap@@37 y@@9 n)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 null (R (MapType0Select Heap@@37 y@@9 n)))) FullPerm)))) (InsidePredicate (R y@@9) (MapType0Select Heap@@37 null (R y@@9)) (R (MapType0Select Heap@@37 y@@9 n)) (MapType0Select Heap@@37 null (R (MapType0Select Heap@@37 y@@9 n))))) (and (state Heap@@37 UnfoldingMask@2) (state Heap@@37 UnfoldingMask@2)))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm UnfoldingMask@2 y@@9 n)) (=> (HasDirectPerm UnfoldingMask@2 y@@9 n) (and (=> (= (ControlFlow 0 9) 8) anon8_Then_correct) (=> (= (ControlFlow 0 9) 2) anon8_Else_correct)))))))
(let ((anon7_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 9)) anon2_correct)))
(let ((anon7_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (R y@@9))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (R y@@9)))) (=> (= (ControlFlow 0 11) 9) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@37 ZeroMask) (U_2_bool (MapType0Select Heap@@37 y@@9 $allocated))) (and (= AssumeFunctionsAbove 3) (= Mask@0 (MapType1Store ZeroMask null (R y@@9) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (R y@@9))) FullPerm)))))) (and (and (state Heap@@37 Mask@0) (state Heap@@37 Mask@0)) (and (|R#trigger| Heap@@37 (R y@@9)) (= (MapType0Select Heap@@37 null (R y@@9)) (CombineFrames (FrameFragment (MapType0Select Heap@@37 y@@9 n)) (MapType0Select Heap@@37 null (R (MapType0Select Heap@@37 y@@9 n)))))))) (and (=> (= (ControlFlow 0 14) 11) anon7_Then_correct) (=> (= (ControlFlow 0 14) 13) anon7_Else_correct)))))
