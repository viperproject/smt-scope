...
(assert (forall ((arg1@@13 T@U) (arg2@@7 Real) (arg3@@3 Bool) ) (!  (=> (= (type arg1@@13) RefType) (= (getPredWandId (wand arg1@@13 arg2@@7 arg3@@3)) 0))
 :qid |stdinbpl.203:15|
 :skolemid |27|
...
(assert (forall ((arg0@@27 T@U) (arg1@@17 Real) (arg2@@11 Bool) ) (! (= (type (|wand#sm| arg0@@27 arg1@@17 arg2@@11)) (FieldType WandType_wandType (MapType1Type RefType boolType)))
 :qid |funType:wand#sm|
 :pattern ( (|wand#sm| arg0@@27 arg1@@17 arg2@@11))
)))
...
(assert  (and (forall ((arg0@@28 Real) (arg1@@19 T@U) ) (! (= (type (ConditionalFrame arg0@@28 arg1@@19)) FrameTypeType)
 :qid |funType:ConditionalFrame|
 :pattern ( (ConditionalFrame arg0@@28 arg1@@19))
