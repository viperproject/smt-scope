...
(assert  (and (and (and (and (and (and (= (type UnfoldingMask@0) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type x@@23) RefType)) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Heap@@41) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |fun04#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon2_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (P01 x@@23 n@@37) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P01 x@@23 n@@37))) FullPerm)))) (=> (and (not (= x@@23 null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x@@23 ss (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@23 ss)) FullPerm))))) (=> (and (and (state Heap@@41 UnfoldingMask@1) (= (|Seq#Length| (MapType0Select Heap@@41 x@@23 ss)) n@@37)) (and (<= 3 n@@37) (forall ((k@@2 Int) (j@@15 Int) ) (!  (=> (and (>= k@@2 0) (and (< k@@2 (|Seq#Length| (MapType0Select Heap@@41 x@@23 ss))) (and (>= j@@15 0) (and (< j@@15 (|Seq#Length| (MapType0Select Heap@@41 x@@23 ss))) (not (= k@@2 j@@15)))))) (not (= (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) k@@2) (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j@@15))))
 :qid |stdinbpl.1520:22|
 :skolemid |129|
 :pattern ( (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) k@@2) (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j@@15))
)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (forall ((j_1 Int) (j_1_1 Int) ) (!  (=> (and (and (and (and (not (= j_1 j_1_1)) (and (<= 0 j_1) (< j_1 3))) (and (<= 0 j_1_1) (< j_1_1 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j_1) (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j_1_1))))
 :qid |stdinbpl.1526:17|
 :skolemid |130|
))) (=> (forall ((j_1@@0 Int) (j_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_1@@0 j_1_1@@0)) (and (<= 0 j_1@@0) (< j_1@@0 3))) (and (<= 0 j_1_1@@0) (< j_1_1@@0 3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j_1@@0) (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j_1_1@@0))))
 :qid |stdinbpl.1526:17|
 :skolemid |130|
)) (=> (and (forall ((j_1@@1 Int) ) (!  (=> (and (and (<= 0 j_1@@1) (< j_1@@1 3)) (< NoPerm FullPerm)) (and (qpRange7 (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j_1@@1)) (= (invRecv7 (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j_1@@1)) j_1@@1)))
 :qid |stdinbpl.1532:24|
 :skolemid |131|
 :pattern ( (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j_1@@1))
 :pattern ( (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv7 o_3)) (< (invRecv7 o_3) 3)) (< NoPerm FullPerm)) (qpRange7 o_3)) (= (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) (invRecv7 o_3)) o_3)))
 :qid |stdinbpl.1536:24|
 :skolemid |132|
 :pattern ( (invRecv7 o_3))
))) (=> (and (and (forall ((j_1@@2 Int) ) (!  (=> (and (<= 0 j_1@@2) (< j_1@@2 3)) (not (= (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j_1@@2) null)))
 :qid |stdinbpl.1542:24|
 :skolemid |133|
 :pattern ( (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j_1@@2))
 :pattern ( (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j_1@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv7 o_3@@0)) (< (invRecv7 o_3@@0) 3)) (< NoPerm FullPerm)) (qpRange7 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) (invRecv7 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select UnfoldingMask@1 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv7 o_3@@0)) (< (invRecv7 o_3@@0) 3)) (< NoPerm FullPerm)) (qpRange7 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select UnfoldingMask@1 o_3@@0 f_7))))))
 :qid |stdinbpl.1548:24|
 :skolemid |134|
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 f_7))) (= (U_2_real (MapType1Select UnfoldingMask@1 o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.1552:31|
 :skolemid |135|
 :pattern ( (MapType1Select UnfoldingMask@1 o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
)) (state Heap@@41 QPMask@0))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (forall ((j_2 Int) (j_2_1 Int) ) (!  (=> (and (and (and (and (not (= j_2 j_2_1)) (and (<= 3 j_2) (< j_2 n@@37))) (and (<= 3 j_2_1) (< j_2_1 n@@37))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j_2) (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j_2_1))))
 :qid |stdinbpl.1560:17|
 :skolemid |136|
))) (=> (forall ((j_2@@0 Int) (j_2_1@@0 Int) ) (!  (=> (and (and (and (and (not (= j_2@@0 j_2_1@@0)) (and (<= 3 j_2@@0) (< j_2@@0 n@@37))) (and (<= 3 j_2_1@@0) (< j_2_1@@0 n@@37))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j_2@@0) (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j_2_1@@0))))
 :qid |stdinbpl.1560:17|
 :skolemid |136|
)) (=> (forall ((j_2@@1 Int) ) (!  (=> (and (and (<= 3 j_2@@1) (< j_2@@1 n@@37)) (< NoPerm FullPerm)) (and (qpRange8 (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j_2@@1)) (= (invRecv8 (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j_2@@1)) j_2@@1)))
 :qid |stdinbpl.1566:24|
 :skolemid |137|
 :pattern ( (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j_2@@1))
 :pattern ( (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j_2@@1))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (and (<= 3 (invRecv8 o_3@@2)) (< (invRecv8 o_3@@2) n@@37)) (< NoPerm FullPerm)) (qpRange8 o_3@@2)) (= (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) (invRecv8 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.1570:24|
 :skolemid |138|
 :pattern ( (invRecv8 o_3@@2))
)) (forall ((j_2@@2 Int) ) (!  (=> (and (<= 3 j_2@@2) (< j_2@@2 n@@37)) (not (= (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j_2@@2) null)))
 :qid |stdinbpl.1576:24|
 :skolemid |139|
 :pattern ( (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j_2@@2))
 :pattern ( (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) j_2@@2))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (and (<= 3 (invRecv8 o_3@@3)) (< (invRecv8 o_3@@3) n@@37)) (< NoPerm FullPerm)) (qpRange8 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) (invRecv8 o_3@@3)) o_3@@3)) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (and (<= 3 (invRecv8 o_3@@3)) (< (invRecv8 o_3@@3) n@@37)) (< NoPerm FullPerm)) (qpRange8 o_3@@3))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7))))))
 :qid |stdinbpl.1582:24|
 :skolemid |140|
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 ...
 :qid |stdinbpl.1586:31|
 :skolemid |141|
 :pattern ( (MapType1Select QPMask@0 o_3@@4 f_5@@0))
 :pattern ( (MapType1Select QPMask@1 o_3@@4 f_5@@0))
))) (and (state Heap@@41 QPMask@1) (state Heap@@41 QPMask@1))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm QPMask@1 x@@23 ss)) (=> (HasDirectPerm QPMask@1 x@@23 ss) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i@@29 0)) (=> (>= i@@29 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i@@29 (|Seq#Length| (MapType0Select Heap@@41 x@@23 ss)))) (=> (< i@@29 (|Seq#Length| (MapType0Select Heap@@41 x@@23 ss))) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm QPMask@1 (|Seq#Index| (MapType0Select Heap@@41 x@@23 ss) i@@29) f_7))))))))))))))))))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P01 x@@23 n@@37))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P01 x@@23 n@@37)))) (=> (= (ControlFlow 0 8) 2) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@41 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@41 x@@23 $allocated)) (= AssumeFunctionsAbove 5)) (=> (and (and (and (= Mask@0 (MapType1Store ZeroMask null (P01 x@@23 n@@37) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P01 x@@23 n@@37))) FullPerm)))) (state Heap@@41 Mask@0)) (and (state Heap@@41 Mask@0) (< 0 i@@29))) (and (and (< i@@29 n@@37) (state Heap@@41 Mask@0)) (and (|P01#trigger| Heap@@41 (P01 x@@23 n@@37)) (= (MapType0Select Heap@@41 null (P01 x@@23 n@@37)) (CombineFrames (FrameFragment (MapType0Select Heap@@41 x@@23 ss)) (CombineFrames (FrameFragment (int_2_U (|P01#condqp7| Heap@@41 x@@23 n@@37))) (FrameFragment (int_2_U (|P01#condqp8| Heap@@41 x@@23 n@@37))))))))) (and (=> (= (ControlFlow 0 11) 8) anon3_Then_correct) (=> (= (ControlFlow 0 11) 10) anon3_Else_correct)))))))
