...
(assert  (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type this) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id TestBug1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@10 this $allocated)) (not (= this null))) (and (= Mask@0 (MapType1Store ZeroMask this Testtk$ (real_2_U (+ (U_2_real (MapType1Select ZeroMask this Testtk$)) FullPerm)))) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (HasDirectPerm Mask@0 this Testtk$)) (=> (HasDirectPerm Mask@0 this Testtk$) (=> (and (not (= (MapType0Select Heap@@10 this Testtk$) null)) (state Heap@@10 Mask@0)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm Mask@0 this Testtk$)) (=> (HasDirectPerm Mask@0 this Testtk$) (=> (not (= (MapType0Select Heap@@10 this Testtk$) null)) (=> (and (= Mask@1 (MapType1Store Mask@0 (MapType0Select Heap@@10 this Testtk$) joinable$ (real_2_U (+ (U_2_real (MapType1Select Mask@0 (MapType0Select Heap@@10 this Testtk$) joinable$)) FullPerm)))) (state Heap@@10 Mask@1)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@1 this Testtk$)) (=> (HasDirectPerm Mask@1 this Testtk$) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 (MapType0Select Heap@@10 this Testtk$) joinable$)) (=> (HasDirectPerm Mask@1 (MapType0Select Heap@@10 this Testtk$) joinable$) (=> (U_2_bool (MapType0Select Heap@@10 (MapType0Select Heap@@10 this Testtk$) joinable$)) (=> (and (state Heap@@10 Mask@1) (= (ControlFlow 0 2) (- 0 1))) false)))))))))))))))))
