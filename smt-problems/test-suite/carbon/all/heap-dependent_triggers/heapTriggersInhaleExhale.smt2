...
(assert  (and (and (and (and (and (and (and (= (type ys) (MapType2Type RefType boolType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@52 T@U) ) (! (= (type (invRecv4 arg0@@52)) RefType)
 :qid |funType:invRecv4|
 :pattern ( (invRecv4 arg0@@52))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type xs) (MapType2Type RefType boolType))) (= (type a_2) RefType)) (forall ((arg0@@53 T@U) ) (! (= (type (invRecv3 arg0@@53)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((y_1 T@U) (y_1_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (= (type y_1_1) RefType)) (=> (and (and (and (and (not (= y_1 y_1_1)) (U_2_bool (MapType2Select ys y_1))) (U_2_bool (MapType2Select ys y_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_1 y_1_1))))
...
)) (=> (and (forall ((y_1@@1 T@U) ) (!  (=> (= (type y_1@@1) RefType) (=> (and (U_2_bool (MapType2Select ys y_1@@1)) (< NoPerm FullPerm)) (and (qpRange4 y_1@@1) (= (invRecv4 y_1@@1) y_1@@1))))
 :qid |stdinbpl.1074:22|
 :skolemid |139|
 :pattern ( (MapType0Select Heap@@9 y_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 y_1@@1 f_7))
 :pattern ( (MapType0Select Heap@@9 y_1@@1 f_7))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select ys (invRecv4 o_3))) (< NoPerm FullPerm)) (qpRange4 o_3)) (= (invRecv4 o_3) o_3)))
 :qid |stdinbpl.1078:22|
 :skolemid |140|
 :pattern ( (invRecv4 o_3))
))) (=> (and (and (forall ((y_1@@2 T@U) ) (!  (=> (and (= (type y_1@@2) RefType) (U_2_bool (MapType2Select ys y_1@@2))) (not (= y_1@@2 null)))
 :qid |stdinbpl.1084:22|
 :skolemid |141|
 :pattern ( (MapType0Select Heap@@9 y_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@1 y_1@@2 f_7))
 :pattern ( (MapType0Select Heap@@9 y_1@@2 f_7))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select ys (invRecv4 o_3@@0))) (< NoPerm FullPerm)) (qpRange4 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select ys (invRecv4 o_3@@0))) (< NoPerm FullPerm)) (qpRange4 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7))))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.1094:29|
 :skolemid |143|
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@1 o_3@@1 f_5))
)) (state Heap@@9 QPMask@1))) (=> (and (and (and (state Heap@@9 QPMask@1) (state Heap@@9 QPMask@1)) (and (U_2_bool (MapType2Select xs a_2)) (state Heap@@9 QPMask@1))) (and (and (state Heap@@9 QPMask@1) (U_2_bool (MapType2Select ys a_2))) (and (state Heap@@9 QPMask@1) (state Heap@@9 QPMask@1)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (= (U_2_real (MapType1Select QPMask@1 a_2 f_7)) (* (to_real 2) FullPerm))) (=> (= (U_2_real (MapType1Select QPMask@1 a_2 f_7)) (* (to_real 2) FullPerm)) (=> (and (state Heap@@9 QPMask@1) (= (ControlFlow 0 4) (- 0 3))) false))))))))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select xs x_1))) (U_2_bool (MapType2Select xs x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 ...
 :pattern ( (MapType0Select Heap@@9 x_1@@1 f_7))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv3 o_3@@2))) (< NoPerm FullPerm)) (qpRange3 o_3@@2)) (= (invRecv3 o_3@@2) o_3@@2)))
 ...
 :pattern ( (MapType0Select Heap@@9 x_1@@2 f_7))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType2Select xs (invRecv3 o_3@@3))) (< NoPerm FullPerm)) (qpRange3 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select xs (invRecv3 o_3@@3))) (< NoPerm FullPerm)) (qpRange3 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@3 f_7))))))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 ...
 :qid |stdinbpl.1051:29|
 :skolemid |137|
 :pattern ( (MapType1Select ZeroMask o_3@@4 f_5@@0))
 :pattern ( (MapType1Select QPMask@0 o_3@@4 f_5@@0))
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (=> (= (ControlFlow 0 7) 2) anon6_Then_correct) (=> (= (ControlFlow 0 7) 4) anon6_Else_correct)))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 a_2 $allocated))) (and (=> (= (ControlFlow 0 9) 1) anon5_Then_correct) (=> (= (ControlFlow 0 9) 7) anon5_Else_correct)))))
