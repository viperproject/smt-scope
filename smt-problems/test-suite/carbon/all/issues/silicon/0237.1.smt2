...
(assert (forall ((a_3 T@U) ) (!  (=> (= (type a_3) RefType) (>= (len a_3) 0))
 :qid |stdinbpl.237:15|
 :skolemid |23|
 :pattern ( (len a_3))
)))
...
(assert (forall ((p_5 T@U) (v_1 T@U) (w T@U) ) (! (let ((A@@2 (FieldTypeInv0 (type p_5))))
 (=> (and (and (= (type p_5) (FieldType A@@2 FrameTypeType)) (= (type v_1) FrameTypeType)) (= (type w) FrameTypeType)) (not (InsidePredicate p_5 v_1 p_5 w))))
 :qid |stdinbpl.206:19|
 :skolemid |21|
 :pattern ( (InsidePredicate p_5 v_1 p_5 w))
)))
...
(assert (forall ((p_5@@0 Real) (f_6 T@U) ) (!  (=> (= (type f_6) FrameTypeType) (= (ConditionalFrame p_5@@0 f_6) (ite (> p_5@@0 0.0) f_6 EmptyFrame)))
 :qid |stdinbpl.194:15|
 :skolemid |19|
 :pattern ( (ConditionalFrame p_5@@0 f_6))
)))
...
)) (forall ((arg0@@27 T@U) ) (! (= (type (first arg0@@27)) RefType)
 :qid |funType:first|
 :pattern ( (first arg0@@27))
))))
(assert (forall ((a_3@@0 T@U) (i_1 Int) ) (!  (=> (= (type a_3@@0) RefType) (and (= (first (loc a_3@@0 i_1)) a_3@@0) (= (second (loc a_3@@0 i_1)) i_1)))
 :qid |stdinbpl.231:15|
 :skolemid |22|
...
(assert (forall ((p_5@@1 T@U) (v_1@@0 T@U) (q T@U) (w@@0 T@U) (r T@U) (u T@U) ) (! (let ((C@@3 (FieldTypeInv0 (type r))))
(let ((B@@10 (FieldTypeInv0 (type q))))
(let ((A@@11 (FieldTypeInv0 (type p_5@@1))))
 (=> (and (and (and (and (and (and (= (type p_5@@1) (FieldType A@@11 FrameTypeType)) (= (type v_1@@0) FrameTypeType)) (= (type q) (FieldType B@@10 FrameTypeType))) (= (type w@@0) FrameTypeType)) (= (type r) (FieldType C@@3 FrameTypeType))) (= (type u) FrameTypeType)) (and (InsidePredicate p_5@@1 v_1@@0 q w@@0) (InsidePredicate q w@@0 r u))) (InsidePredicate p_5@@1 v_1@@0 r u)))))
 :qid |stdinbpl.201:25|
 :skolemid |20|
 :pattern ( (InsidePredicate p_5@@1 v_1@@0 q w@@0) (InsidePredicate q w@@0 r u))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
...
(assert  (and (and (and (= (type arr) RefType) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (forall ((p_3 Int) (p_3_1 Int) ) (!  (=> (and (and (not (= p_3 p_3_1)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_3) (loc arr p_3_1))))
 :qid |stdinbpl.463:15|
 :skolemid |43|
))) (=> (forall ((p_3@@0 Int) (p_3_1@@0 Int) ) (!  (=> (and (and (not (= p_3@@0 p_3_1@@0)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_3@@0) (loc arr p_3_1@@0))))
 :qid |stdinbpl.463:15|
 :skolemid |43|
)) (=> (forall ((p_3@@1 Int) ) (!  (=> (< NoPerm NoPerm) (and (qpRange4 (loc arr p_3@@1)) (= (invRecv4 (loc arr p_3@@1)) p_3@@1)))
 :qid |stdinbpl.469:22|
 :skolemid |44|
 :pattern ( (loc arr p_3@@1))
 :pattern ( (loc arr p_3@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (< NoPerm NoPerm) (qpRange4 o_3)) (= (loc arr (invRecv4 o_3)) o_3)))
 :qid |stdinbpl.473:22|
 :skolemid |45|
 :pattern ( (invRecv4 o_3))
)) (= (ControlFlow 0 8) (- 0 7))) (forall ((p_3@@2 Int) ) (! (>= NoPerm NoPerm)
 :qid |stdinbpl.479:15|
 :skolemid |46|
 :pattern ( (loc arr p_3@@2))
 :pattern ( (loc arr p_3@@2))
))))))))
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((p_4 Int) ) (!  (=> (dummyFunction (MapType0Select Heap@@9 (loc arr p_4) val)) (>= NoPerm NoPerm))
 :qid |stdinbpl.510:17|
 :skolemid |49|
 :pattern ( (loc arr p_4))
 :pattern ( (loc arr p_4))
))) (=> (forall ((p_4@@0 Int) ) (!  (=> (dummyFunction (MapType0Select Heap@@9 (loc arr p_4@@0) val)) (>= NoPerm NoPerm))
 :qid |stdinbpl.510:17|
 :skolemid |49|
 :pattern ( (loc arr p_4@@0))
 :pattern ( (loc arr p_4@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((p_4@@1 Int) (p_4_1 Int) ) (!  (=> (and (and (not (= p_4@@1 p_4_1)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_4@@1) (loc arr p_4_1))))
 :qid |stdinbpl.517:17|
 :skolemid |50|
 :pattern ( (neverTriggered5 p_4@@1) (neverTriggered5 p_4_1))
))) (=> (forall ((p_4@@2 Int) (p_4_1@@0 Int) ) (!  (=> (and (and (not (= p_4@@2 p_4_1@@0)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_4@@2) (loc arr p_4_1@@0))))
 :qid |stdinbpl.517:17|
 :skolemid |50|
 :pattern ( (neverTriggered5 p_4@@2) (neverTriggered5 p_4_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((p_4@@3 Int) ) (! (>= (U_2_real (MapType1Select QPMask@0 (loc arr p_4@@3) val)) NoPerm)
 :qid |stdinbpl.524:17|
 :skolemid |51|
 :pattern ( (loc arr p_4@@3))
 :pattern ( (loc arr p_4@@3))
)))))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 13)) (forall ((p_1 Int) (p_1_1 Int) ) (!  (=> (and (and (not (= p_1 p_1_1)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_1) (loc arr p_1_1))))
 :qid |stdinbpl.409:15|
 :skolemid |37|
))) (=> (forall ((p_1@@0 Int) (p_1_1@@0 Int) ) (!  (=> (and (and (not (= p_1@@0 p_1_1@@0)) (< NoPerm NoPerm)) (< NoPerm NoPerm)) (not (= (loc arr p_1@@0) (loc arr p_1_1@@0))))
 :qid |stdinbpl.409:15|
 :skolemid |37|
)) (=> (and (forall ((p_1@@1 Int) ) (!  (=> (< NoPerm NoPerm) (and (qpRange3 (loc arr p_1@@1)) (= (invRecv3 (loc arr p_1@@1)) p_1@@1)))
 :qid |stdinbpl.415:22|
 :skolemid |38|
 :pattern ( (loc arr p_1@@1))
 :pattern ( (loc arr p_1@@1))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (=> (and (< NoPerm NoPerm) (qpRange3 o_3@@0)) (= (loc arr (invRecv3 o_3@@0)) o_3@@0)))
 :qid |stdinbpl.419:22|
 :skolemid |39|
 :pattern ( (invRecv3 o_3@@0))
))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((p_1@@2 Int) ) (! (>= NoPerm NoPerm)
 :qid |stdinbpl.425:15|
 :skolemid |40|
 :pattern ( (loc arr p_1@@2))
 :pattern ( (loc arr p_1@@2))
))) (=> (forall ((p_1@@3 Int) ) (! (>= NoPerm NoPerm)
 :qid |stdinbpl.425:15|
 :skolemid |40|
 :pattern ( (loc arr p_1@@3))
 :pattern ( (loc arr p_1@@3))
)) (=> (and (and (forall ((o_3@@1 T@U) ) (!  (=> (= (type o_3@@1) RefType) (and (=> (and (< NoPerm NoPerm) (qpRange3 o_3@@1)) (and (=> (< NoPerm NoPerm) (= (loc arr (invRecv3 o_3@@1)) o_3@@1)) (= (U_2_real (MapType1Select QPMask@0 o_3@@1 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@1 val)) NoPerm)))) (=> (not (and (< NoPerm NoPerm) (qpRange3 o_3@@1))) (= (U_2_real (MapType1Select QPMask@0 o_3@@1 val)) (U_2_real (MapType1Select ZeroMask o_3@@1 val))))))
 :qid |stdinbpl.434:22|
 :skolemid |41|
 :pattern ( (MapType1Select QPMask@0 o_3@@1 val))
)) (forall ((o_3@@2 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@2) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 val))) (= (U_2_real (MapType1Select ZeroMask o_3@@2 f_5)) (U_2_real (MapType1Select QPMask@0 o_3@@2 f_5))))))
 :qid |stdinbpl.438:29|
 :skolemid |42|
...
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 arr $allocated))) (and (=> (= (ControlFlow 0 14) 1) anon7_Then_correct) (=> (= (ControlFlow 0 14) 11) anon7_Else_correct)))))
