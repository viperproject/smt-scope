...
(= (type (MapType2Store arg0@@34 arg1@@16 arg2@@3)) (MapType2Type aVar0@@1 aVar1@@3))))
 ...
 :weight 0
)))) (= (Ctor PredicateType_invType) 14)) (forall ((arg0@@35 T@U) ) (! (= (type (inv arg0@@35)) (FieldType PredicateType_invType FrameTypeType))
 :qid |funType:inv|
 :pattern ( (inv arg0@@35))
))))
(assert (forall ((s T@U) ) (!  (=> (= (type s) (MapType2Type RefType boolType)) (IsPredicateField (inv s)))
 :qid |stdinbpl.406:15|
 :skolemid |83|
 :pattern ( (inv s))
)))
(assert (forall ((Heap@@2 T@U) (s@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type s@@0) (MapType2Type RefType boolType))) (|inv#everUsed| (inv s@@0)))
 :qid |stdinbpl.425:15|
 :skolemid |87|
 :pattern ( (|inv#trigger| Heap@@2 (inv s@@0)))
)))
...
(assert (forall ((Heap2Heap T@U) (Heap1Heap T@U) (s@@1 T@U) ) (!  (=> (and (and (and (= (type Heap2Heap) (MapType0Type RefType)) (= (type Heap1Heap) (MapType0Type RefType))) (= (type s@@1) (MapType2Type RefType boolType))) (and (=  (and (U_2_bool (MapType2Select s@@1 (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap s@@1) (|inv#condqp1| Heap1Heap s@@1)))) (< NoPerm FullPerm))  (and (U_2_bool (MapType2Select s@@1 (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap s@@1) (|inv#condqp1| Heap1Heap s@@1)))) (< NoPerm FullPerm))) (=> (and (U_2_bool (MapType2Select s@@1 (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap s@@1) (|inv#condqp1| Heap1Heap s@@1)))) (< NoPerm FullPerm)) (= (U_2_int (MapType0Select Heap2Heap (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap s@@1) (|inv#condqp1| Heap1Heap s@@1)) f_7)) (U_2_int (MapType0Select Heap1Heap (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap s@@1) (|inv#condqp1| Heap1Heap s@@1)) f_7)))))) (= (|inv#condqp1| Heap2Heap s@@1) (|inv#condqp1| Heap1Heap s@@1)))
 :qid |stdinbpl.436:15|
 :skolemid |88|
 :pattern ( (|inv#condqp1| Heap2Heap s@@1) (|inv#condqp1| Heap1Heap s@@1) (succHeapTrans Heap2Heap Heap1Heap))
)))
...
(assert (forall ((s@@2 T@U) (s2 T@U) ) (!  (=> (and (and (= (type s@@2) (MapType2Type RefType boolType)) (= (type s2) (MapType2Type RefType boolType))) (= (inv s@@2) (inv s2))) (= s@@2 s2))
 :qid |stdinbpl.416:15|
 :skolemid |85|
 :pattern ( (inv s@@2) (inv s2))
)))
(assert (forall ((arg0@@40 T@U) ) (! (= (type (|inv#sm| arg0@@40)) (FieldType PredicateType_invType (MapType1Type RefType boolType)))
 :qid |funType:inv#sm|
 :pattern ( (|inv#sm| arg0@@40))
)))
(assert (forall ((s@@3 T@U) (s2@@0 T@U) ) (!  (=> (and (and (= (type s@@3) (MapType2Type RefType boolType)) (= (type s2@@0) (MapType2Type RefType boolType))) (= (|inv#sm| s@@3) (|inv#sm| s2@@0))) (= s@@3 s2@@0))
 :qid |stdinbpl.420:15|
 :skolemid |86|
 :pattern ( (|inv#sm| s@@3) (|inv#sm| s2@@0))
)))
...
(assert (forall ((arg0@@44 T@U) (arg1@@22 T@U) ) (! (let ((T@@20 (MapType2TypeInv0 (type arg0@@44))))
(= (type (|Set#Difference| arg0@@44 arg1@@22)) (MapType2Type T@@20 boolType)))
...
(= (type (|Set#UnionOne| arg0@@45 arg1@@23)) (MapType2Type T@@24 boolType)))
...
(assert (forall ((s@@4 T@U) ) (! (let ((T@@32 (MapType2TypeInv0 (type s@@4))))
 (=> (= (type s@@4) (MapType2Type T@@32 boolType)) (<= 0 (|Set#Card| s@@4))))
 :qid |stdinbpl.204:18|
 :skolemid |22|
 :pattern ( (|Set#Card| s@@4))
)))
(assert (forall ((s@@5 T@U) ) (! (let ((T@@33 (MultiSetTypeInv0 (type s@@5))))
 (=> (= (type s@@5) (MultiSetType T@@33)) (<= 0 (|MultiSet#Card| s@@5))))
 :qid |stdinbpl.312:18|
 :skolemid |57|
...
(assert (forall ((s@@6 T@U) ) (!  (=> (= (type s@@6) (MapType2Type RefType boolType)) (= (getPredWandId (inv s@@6)) 0))
 :qid |stdinbpl.410:15|
 :skolemid |84|
 :pattern ( (inv s@@6))
)))
...
(assert (forall ((s@@7 T@U) ) (! (let ((T@@42 (MultiSetTypeInv0 (type s@@7))))
 (=> (= (type s@@7) (MultiSetType T@@42)) (and (= (= (|MultiSet#Card| s@@7) 0) (= s@@7 (|MultiSet#Empty| T@@42))) (=> (not (= (|MultiSet#Card| s@@7) 0)) (exists ((x@@15 T@U) ) (!  (and (= (type x@@15) T@@42) (< 0 (|MultiSet#Select| s@@7 x@@15)))
 :qid |stdinbpl.320:38|
 :skolemid |59|
...
(assert (forall ((s@@8 T@U) ) (!  (=> (= (type s@@8) (MapType2Type RefType boolType)) (= (PredicateMaskField (inv s@@8)) (|inv#sm| s@@8)))
 :qid |stdinbpl.402:15|
 :skolemid |82|
 :pattern ( (PredicateMaskField (inv s@@8)))
)))
...
(assert (forall ((s@@9 T@U) ) (! (let ((T@@48 (MapType2TypeInv0 (type s@@9))))
 (=> (= (type s@@9) (MapType2Type T@@48 boolType)) (and (= (= (|Set#Card| s@@9) 0) (= s@@9 (|Set#Empty| T@@48))) (=> (not (= (|Set#Card| s@@9) 0)) (exists ((x@@16 T@U) ) (!  (and (= (type x@@16) T@@48) (U_2_bool (MapType2Select s@@9 x@@16)))
 :qid |stdinbpl.210:33|
 :skolemid |24|
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@2) (MapType1Type RefType realType)) (= (type this) (MapType2Type RefType boolType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@46 T@U) ) (! (= (type (invRecv2 arg0@@46)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@46))
))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type t_1) RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@47 T@U) ) (! (= (type (invRecv3 arg0@@47)) RefType)
...
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null (inv this))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 null (inv this)))) (=> (= (ControlFlow 0 3) 2) anon10_correct))))))
(let ((anon8_correct  (=> (forall ((o_4 T@U) (f_8 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_8))))
(let ((A@@12 (FieldTypeInv0 (type f_8))))
 (=> (and (and (= (type o_4) RefType) (= (type f_8) (FieldType A@@12 B@@11))) (U_2_bool (MapType1Select (MapType0Select Heap@4 null (|inv#sm| this)) o_4 f_8))) (U_2_bool (MapType1Select newPMask@0 o_4 f_8)))))
 :qid |stdinbpl.670:27|
 :skolemid |107|
 :pattern ( (MapType1Select newPMask@0 o_4 f_8))
)) (=> (and (and (forall ((x_2 T@U) ) (!  (=> (and (= (type x_2) RefType) (U_2_bool (MapType2Select this x_2))) (U_2_bool (MapType1Select newPMask@0 x_2 f_7)))
 :qid |stdinbpl.674:20|
 :skolemid |108|
 :no-pattern (type x_2)
 :no-pattern (U_2_int x_2)
 :no-pattern (U_2_bool x_2)
)) (= Heap@5 (MapType0Store Heap@4 null (|inv#sm| this) newPMask@0))) (and (state Heap@5 Mask@2) (state Heap@5 Mask@2))) (and (=> (= (ControlFlow 0 6) 3) anon15_Then_correct) (=> (= (ControlFlow 0 6) 5) anon15_Else_correct))))))
(let ((anon14_Else_correct  (=> (HasDirectPerm Mask@2 null (inv this)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 8) 6)) anon8_correct))))
(let ((anon14_Then_correct  (=> (not (HasDirectPerm Mask@2 null (inv this))) (=> (and (and (= Heap@2 (MapType0Store Heap@1 null (|inv#sm| this) ZeroPMask)) (= Heap@3 (MapType0Store Heap@2 null (inv this) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 7) 6))) anon8_correct))))
(let ((anon6_correct  (and (=> (= (ControlFlow 0 9) (- 0 13)) (forall ((x@@19 T@U) (x_3 T@U) ) (!  (=> (and (= (type x@@19) RefType) (= (type x_3) RefType)) (=> (and (and (and (and (not (= x@@19 x_3)) (U_2_bool (MapType2Select this x@@19))) (U_2_bool (MapType2Select this x_3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@19 x_3))))
 :qid |stdinbpl.565:15|
 :skolemid |95|
...
))) (=> (forall ((x@@20 T@U) (x_3@@0 T@U) ) (!  (=> (and (= (type x@@20) RefType) (= (type x_3@@0) RefType)) (=> (and (and (and (and (not (= x@@20 x_3@@0)) (U_2_bool (MapType2Select this x@@20))) (U_2_bool (MapType2Select this x_3@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@20 x_3@@0))))
 :qid |stdinbpl.565:15|
 :skolemid |95|
...
)) (=> (forall ((x@@21 T@U) ) (!  (=> (= (type x@@21) RefType) (=> (and (U_2_bool (MapType2Select this x@@21)) (< NoPerm FullPerm)) (and (qpRange2 x@@21) (= (invRecv2 x@@21) x@@21))))
 :qid |stdinbpl.571:22|
 :skolemid |96|
 :pattern ( (MapType0Select Heap@1 x@@21 f_7))
 :pattern ( (MapType1Select QPMask@0 x@@21 f_7))
 :pattern ( (MapType2Select this x@@21))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select this (invRecv2 o_3))) (< NoPerm FullPerm)) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.575:22|
 :skolemid |97|
 :pattern ( (invRecv2 o_3))
)) (forall ((x@@22 T@U) ) (!  (=> (and (= (type x@@22) RefType) (U_2_bool (MapType2Select this x@@22))) (not (= x@@22 null)))
 :qid |stdinbpl.581:22|
 :skolemid |98|
 :pattern ( (MapType0Select Heap@1 x@@22 f_7))
 :pattern ( (MapType1Select QPMask@0 x@@22 f_7))
 :pattern ( (MapType2Select this x@@22))
))) (=> (and (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select this (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select Mask@1 o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select this (invRecv2 o_3@@0))) (< NoPerm FullPerm)) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select Mask@1 o_3@@0 f_7))))))
 :qid |stdinbpl.587:22|
 :skolemid |99|
...
))) (and (state Heap@1 QPMask@0) (state Heap@1 QPMask@0))) (and (and (state Heap@1 QPMask@0) (U_2_bool (MapType2Select this t_1))) (and (state Heap@1 QPMask@0) (state Heap@1 QPMask@0)))) (and (=> (= (ControlFlow 0 9) (- 0 12)) (HasDirectPerm QPMask@0 t_1 f_7)) (=> (HasDirectPerm QPMask@0 t_1 f_7) (=> (and (= a_2@0 (U_2_int (MapType0Select Heap@1 t_1 f_7))) (state Heap@1 QPMask@0)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select this x_1))) (U_2_bool (MapType2Select this x_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.623:17|
 :skolemid |101|
 :pattern ( (neverTriggered3 x_1) (neverTriggered3 x_1_1))
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (U_2_bool (MapType2Select this x_1@@0))) (U_2_bool (MapType2Select this x_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.623:17|
 :skolemid |101|
 :pattern ( (neverTriggered3 x_1@@0) (neverTriggered3 x_1_1@@0))
)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((x_1@@1 T@U) ) (!  (=> (and (= (type x_1@@1) RefType) (U_2_bool (MapType2Select this x_1@@1))) (>= (U_2_real (MapType1Select QPMask@0 x_1@@1 f_7)) FullPerm))
 :qid |stdinbpl.630:17|
 :skolemid |102|
 :pattern ( (MapType0Select Heap@1 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 x_1@@1 f_7))
 :pattern ( (MapType2Select this x_1@@1))
))) (=> (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (U_2_bool (MapType2Select this x_1@@2))) (>= (U_2_real (MapType1Select QPMask@0 x_1@@2 f_7)) FullPerm))
 :qid |stdinbpl.630:17|
 :skolemid |102|
 :pattern ( (MapType0Select Heap@1 x_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@1 x_1@@2 f_7))
 :pattern ( (MapType2Select this x_1@@2))
)) (=> (forall ((x_1@@3 T@U) ) (!  (=> (= (type x_1@@3) RefType) (=> (and (U_2_bool (MapType2Select this x_1@@3)) (< NoPerm FullPerm)) (and (qpRange3 x_1@@3) (= (invRecv3 x_1@@3) x_1@@3))))
 :qid |stdinbpl.636:22|
 :skolemid |103|
 :pattern ( (MapType0Select Heap@1 x_1@@3 f_7))
 :pattern ( (MapType1Select QPMask@1 x_1@@3 f_7))
 :pattern ( (MapType2Select this x_1@@3))
)) (=> (and (and (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType2Select this (invRecv3 o_3@@2))) (and (< NoPerm FullPerm) (qpRange3 o_3@@2))) (= (invRecv3 o_3@@2) o_3@@2)))
 :qid |stdinbpl.640:22|
 :skolemid |104|
 :pattern ( (invRecv3 o_3@@2))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType2Select this (invRecv3 o_3@@3))) (and (< NoPerm FullPerm) (qpRange3 o_3@@3))) (and (= (invRecv3 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (- (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select this (invRecv3 o_3@@3))) (and (< NoPerm FullPerm) (qpRange3 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7))))))
 :qid |stdinbpl.646:22|
 :skolemid |105|
...
)) (= Mask@2 (MapType1Store QPMask@1 null (inv this) (real_2_U (+ (U_2_real (MapType1Select QPMask@1 null (inv this))) FullPerm)))))) (and (and (state Heap@1 Mask@2) (state Heap@1 Mask@2)) (and (|inv#trigger| Heap@1 (inv this)) (= (MapType0Select Heap@1 null (inv this)) (FrameFragment (int_2_U (|inv#condqp1| Heap@1 this))))))) (and (=> (= (ControlFlow 0 9) 7) anon14_Then_correct) (=> (= (ControlFlow 0 9) 8) anon14_Else_correct))))))))))))))))))
(let ((anon13_Else_correct  (=> (HasDirectPerm Mask@1 null (inv this)) (=> (and (= Heap@1 Heap@@10) (= (ControlFlow 0 15) 9)) anon6_correct))))
(let ((anon13_Then_correct  (=> (and (and (not (HasDirectPerm Mask@1 null (inv this))) (= Heap@0 (MapType0Store Heap@@10 null (inv this) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 14) 9))) anon6_correct)))
(let ((anon4_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (inv this) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (inv this))) FullPerm)))) (and (=> (= (ControlFlow 0 16) 14) anon13_Then_correct) (=> (= (ControlFlow 0 16) 15) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 19) 16)) anon4_correct)))
(let ((anon12_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (inv this))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (inv this)))) (=> (= (ControlFlow 0 17) 16) anon4_correct))))))
(let ((anon11_Else_correct  (=> (U_2_bool (MapType0Select Heap@@10 t_1 $allocated)) (=> (and (|inv#trigger| Heap@@10 (inv this)) (= (MapType0Select Heap@@10 null (inv this)) (FrameFragment (int_2_U (|inv#condqp1| Heap@@10 this))))) (and (=> (= (ControlFlow 0 20) 17) anon12_Then_correct) (=> (= (ControlFlow 0 20) 19) anon12_Else_correct))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@10 ZeroMask) (= Mask@0 (MapType1Store ZeroMask null (inv this) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (inv this))) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 21) 1) anon11_Then_correct) (=> (= (ControlFlow 0 21) 20) anon11_Else_correct)))))
