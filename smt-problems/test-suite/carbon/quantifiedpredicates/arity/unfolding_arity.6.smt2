...
(let ((anon18_correct  (=> (= UnfoldingMask@0 (MapType1Store QPMask@0 null (p1 r_7) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (p1 r_7))) FullPerm)))) (=> (and (and (not (= r_7 null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 r_7 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 r_7 f_7)) FullPerm))))) (and (state Heap@@12 UnfoldingMask@1) (state Heap@@12 UnfoldingMask@1))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (= (U_2_int (MapType0Select Heap@@12 r_7 f_7)) 4)) (=> (= (U_2_int (MapType0Select Heap@@12 r_7 f_7)) 4) (=> (= (ControlFlow 0 21) 19) anon19_correct)))))))
(let ((anon30_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 25) 21)) anon18_correct)))
(let ((anon30_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p1 r_7))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p1 r_7)))) (=> (= (ControlFlow 0 23) 21) anon18_correct))))))
(let ((anon29_Then_correct  (=> (U_2_bool (MapType2Select xs r_7)) (=> (and (|p1#trigger| Heap@@12 (p1 r_7)) (= (MapType0Select Heap@@12 null (p1 r_7)) (FrameFragment (MapType0Select Heap@@12 r_7 f_7)))) (and (=> (= (ControlFlow 0 26) 23) anon30_Then_correct) (=> (= (ControlFlow 0 26) 25) anon30_Else_correct))))))
(let ((anon29_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs r_7))) (= (ControlFlow 0 20) 19)) anon19_correct)))
(let ((anon13_correct true))
(let ((anon12_correct  (=> (= UnfoldingMask@2 (MapType1Store QPMask@0 null (p1 r_4) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (p1 r_4))) FullPerm)))) (=> (and (and (not (= r_4 null)) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 r_4 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 r_4 f_7)) FullPerm))))) (and (state Heap@@12 UnfoldingMask@3) (state Heap@@12 UnfoldingMask@3))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm UnfoldingMask@3 r_4 f_7)) (=> (HasDirectPerm UnfoldingMask@3 r_4 f_7) (=> (= Heap@0 (MapType0Store Heap@@12 null (|p1#sm| r_4) (MapType1Store (MapType0Select Heap@@12 null (|p1#sm| r_4)) r_4 f_7 (bool_2_U true)))) (=> (and (state Heap@0 QPMask@0) (= (ControlFlow 0 13) 11)) anon13_correct))))))))
(let ((anon27_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 17) 13)) anon12_correct)))
(let ((anon27_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p1 r_4))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p1 r_4)))) (=> (= (ControlFlow 0 15) 13) anon12_correct))))))
(let ((anon26_Then_correct  (=> (U_2_bool (MapType2Select xs r_4)) (=> (and (|p1#trigger| Heap@@12 (p1 r_4)) (= (MapType0Select Heap@@12 null (p1 r_4)) (FrameFragment (MapType0Select Heap@@12 r_4 f_7)))) (and (=> (= (ControlFlow 0 18) 15) anon27_Then_correct) (=> (= (ControlFlow 0 18) 17) anon27_Else_correct))))))
(let ((anon26_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs r_4))) (= (ControlFlow 0 12) 11)) anon13_correct)))
(let ((anon28_Else_correct true))
(let ((anon22_Else_correct  (=> (forall ((r_5 T@U) ) (!  (=> (and (= (type r_5) RefType) (U_2_bool (MapType2Select xs r_5))) (= (U_2_int (MapType0Select Heap@@12 r_5 f_7)) 4))
 :qid |stdinbpl.671:20|
 :skolemid |106|
...
(let ((anon6_correct  (=> (= UnfoldingMask@4 (MapType1Store QPMask@0 null (p1 r_3) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (p1 r_3))) FullPerm)))) (=> (and (and (not (= r_3 null)) (= UnfoldingMask@5 (MapType1Store UnfoldingMask@4 r_3 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@4 r_3 f_7)) FullPerm))))) (and (state Heap@@12 UnfoldingMask@5) (state Heap@@12 UnfoldingMask@5))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm UnfoldingMask@5 r_3 f_7)) (=> (HasDirectPerm UnfoldingMask@5 r_3 f_7) (=> (= Heap@1 (MapType0Store Heap@@12 null (|p1#sm| r_3) (MapType1Store (MapType0Select Heap@@12 null (|p1#sm| r_3)) r_3 f_7 (bool_2_U true)))) (=> (and (state Heap@1 QPMask@0) (= (ControlFlow 0 4) 2)) anon7_correct))))))))
(let ((anon24_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 4)) anon6_correct)))
(let ((anon24_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p1 r_3))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p1 r_3)))) (=> (= (ControlFlow 0 6) 4) anon6_correct))))))
(let ((anon23_Then_correct  (=> (U_2_bool (MapType2Select xs r_3)) (=> (and (|p1#trigger| Heap@@12 (p1 r_3)) (= (MapType0Select Heap@@12 null (p1 r_3)) (FrameFragment (MapType0Select Heap@@12 r_3 f_7)))) (and (=> (= (ControlFlow 0 9) 6) anon24_Then_correct) (=> (= (ControlFlow 0 9) 8) anon24_Else_correct))))))
(let ((anon23_Else_correct  (=> (and (not (U_2_bool (MapType2Select xs r_3))) (= (ControlFlow 0 3) 2)) anon7_correct)))
(let ((anon21_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 29)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (U_2_bool (MapType2Select xs r_1))) (U_2_bool (MapType2Select xs r_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1 r_1_1))))
 :qid |stdinbpl.598:17|
 :skolemid |100|
 :pattern ( (neverTriggered1 r_1) (neverTriggered1 r_1_1))
))) (=> (forall ((r_1@@0 T@U) (r_1_1@@0 T@U) ) (!  (=> (and (= (type r_1@@0) RefType) (= (type r_1_1@@0) RefType)) (=> (and (and (and (and (not (= r_1@@0 r_1_1@@0)) (U_2_bool (MapType2Select xs r_1@@0))) (U_2_bool (MapType2Select xs r_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1@@0 r_1_1@@0))))
 :qid |stdinbpl.598:17|
 :skolemid |100|
 :pattern ( (neverTriggered1 r_1@@0) (neverTriggered1 r_1_1@@0))
)) (=> (forall ((r_1@@1 T@U) ) (!  (=> (= (type r_1@@1) RefType) (=> (and (U_2_bool (MapType2Select xs r_1@@1)) (< NoPerm FullPerm)) (and (= (invRecv1 r_1@@1) r_1@@1) (qpRange1 r_1@@1))))
 :qid |stdinbpl.604:22|
 :skolemid |101|
 :pattern ( (MapType0Select Heap@@12 null (p1 r_1@@1)))
 :pattern ( (MapType1Select ZeroMask null (p1 r_1@@1)))
 :pattern ( (MapType2Select xs r_1@@1))
)) (=> (and (forall ((r_2_1 T@U) ) (!  (=> (= (type r_2_1) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv1 r_2_1))) (< NoPerm FullPerm)) (qpRange1 r_2_1)) (= (invRecv1 r_2_1) r_2_1)))
 :qid |stdinbpl.608:22|
 :skolemid |102|
 :pattern ( (invRecv1 r_2_1))
)) (forall ((r_2_1@@0 T@U) ) (!  (=> (= (type r_2_1@@0) RefType) (=> (and (and (U_2_bool (MapType2Select xs (invRecv1 r_2_1@@0))) (< NoPerm FullPerm)) (qpRange1 r_2_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 r_2_1@@0) r_2_1@@0)) (= (U_2_real (MapType1Select QPMask@0 null (p1 r_2_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (p1 r_2_1@@0))) FullPerm)))))
 :qid |stdinbpl.614:22|
 :skolemid |103|
 :pattern ( (MapType1Select QPMask@0 null (p1 r_2_1@@0)))
...
)) (forall ((r_2_1@@1 T@U) ) (!  (=> (and (= (type r_2_1@@1) RefType) (not (and (and (U_2_bool (MapType2Select xs (invRecv1 r_2_1@@1))) (< NoPerm FullPerm)) (qpRange1 r_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (p1 r_2_1@@1))) (U_2_real (MapType1Select ZeroMask null (p1 r_2_1@@1)))))
 :qid |stdinbpl.624:22|
 :skolemid |105|
 :pattern ( (MapType1Select QPMask@0 null (p1 r_2_1@@1)))
