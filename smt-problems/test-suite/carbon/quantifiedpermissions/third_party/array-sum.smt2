...
(declare-fun |sum#trigger| (T@U T@U Int Int Int T@U) Bool)
...
(assert  (and (and (and (= (type ar@@4) (SeqType RefType)) (= (type Heap@@13) (MapType0Type RefType))) (= (type diz@@4) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |sum#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 39) (let ((anon13_correct true))
(let ((anon24_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k1_4)) (and (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k2_4)) (not (= k1_4 k2_4))))) (= (ControlFlow 0 24) 21)) anon13_correct)))
(let ((anon24_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k1_4)) (and (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k2_4)) (not (= k1_4 k2_4)))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (not (= (|Seq#Index| ar@@4 k1_4) (|Seq#Index| ar@@4 k2_4)))) (=> (not (= (|Seq#Index| ar@@4 k1_4) (|Seq#Index| ar@@4 k2_4))) (=> (= (ControlFlow 0 22) 21) anon13_correct))))))
(let ((anon23_Else_correct  (=> (and (forall ((k1_5_1 Int) (k2_5_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k1_5_1)) (and (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k2_5_1)) (not (= k1_5_1 k2_5_1)))) (not (= (|Seq#Index| ar@@4 k1_5_1) (|Seq#Index| ar@@4 k2_5_1))))
 :qid |stdinbpl.754:26|
 :skolemid |71|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| lo@@4 hi@@4) (int_2_U k1_5_1)) (|Seq#ContainsTrigger| (|Seq#Range| lo@@4 hi@@4) (int_2_U k2_5_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| lo@@4 hi@@4) (int_2_U k1_5_1)) (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k2_5_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k1_5_1)) (|Seq#ContainsTrigger| (|Seq#Range| lo@@4 hi@@4) (int_2_U k2_5_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k1_5_1)) (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k2_5_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| lo@@4 hi@@4) (int_2_U k1_5_1)) (|Seq#Index| ar@@4 k2_5_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k1_5_1)) (|Seq#Index| ar@@4 k2_5_1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| lo@@4 hi@@4) (int_2_U k2_5_1)) (|Seq#Index| ar@@4 k1_5_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k2_5_1)) (|Seq#Index| ar@@4 k1_5_1))
 :pattern ( (|Seq#Index| ar@@4 k1_5_1) (|Seq#Index| ar@@4 k2_5_1))
)) (> wildcard@0 0.0)) (and (=> (= (ControlFlow 0 17) (- 0 20)) (forall ((k_5 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_5)) (> (U_2_real (MapType1Select QPMask@0 (|Seq#Index| ar@@4 k_5) val)) NoPerm))
 :qid |stdinbpl.762:21|
 :skolemid |72|
))) (=> (forall ((k_5@@0 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_5@@0)) (> (U_2_real (MapType1Select QPMask@0 (|Seq#Index| ar@@4 k_5@@0) val)) NoPerm))
 :qid |stdinbpl.762:21|
 :skolemid |72|
)) (=> (forall ((k_5@@1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_5@@1)) (< wildcard@0 (U_2_real (MapType1Select QPMask@0 (|Seq#Index| ar@@4 k_5@@1) val))))
 :qid |stdinbpl.766:26|
 :skolemid |73|
)) (and (=> (= (ControlFlow 0 17) (- 0 19)) (forall ((k_5@@2 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_5@@2)) (dummyFunction (MapType0Select Heap@@13 (|Seq#Index| ar@@4 k_5@@2) val))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.773:23|
 :skolemid |74|
 :pattern ( (|Seq#Index| ar@@4 k_5@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_5@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_5@@2)))
 :pattern ( (|Seq#Index| ar@@4 k_5@@2))
))) (=> (forall ((k_5@@3 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_5@@3)) (dummyFunction (MapType0Select Heap@@13 (|Seq#Index| ar@@4 k_5@@3) val))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.773:23|
 :skolemid |74|
 :pattern ( (|Seq#Index| ar@@4 k_5@@3))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_5@@3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_5@@3)))
 :pattern ( (|Seq#Index| ar@@4 k_5@@3))
)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((k_5@@4 Int) (k_5_1 Int) ) (!  (=> (and (and (and (and (not (= k_5@@4 k_5_1)) (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_5@@4))) (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_5_1))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index| ar@@4 k_5@@4) (|Seq#Index| ar@@4 k_5_1))))
 :qid |stdinbpl.780:23|
 :skolemid |75|
 :pattern ( (neverTriggered2 k_5@@4) (neverTriggered2 k_5_1))
))) (=> (forall ((k_5@@5 Int) (k_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_5@@5 k_5_1@@0)) (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_5@@5))) (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_5_1@@0))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= (|Seq#Index| ar@@4 k_5@@5) (|Seq#Index| ar@@4 k_5_1@@0))))
 :qid |stdinbpl.780:23|
 :skolemid |75|
 :pattern ( (neverTriggered2 k_5@@5) (neverTriggered2 k_5_1@@0))
)) (=> (= (ControlFlow 0 17) (- 0 16)) (forall ((k_5@@6 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_5@@6)) (> (U_2_real (MapType1Select QPMask@0 (|Seq#Index| ar@@4 k_5@@6) val)) NoPerm))
 :qid |stdinbpl.787:23|
 :skolemid |76|
 :pattern ( (|Seq#Index| ar@@4 k_5@@6))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_5@@6)))
 :pattern ( (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_5@@6)))
 :pattern ( (|Seq#Index| ar@@4 k_5@@6))
)))))))))))))
(let ((anon22_Then_correct  (and (=> (= (ControlFlow 0 25) (- 0 30)) (not (= diz@@4 null))) (=> (not (= diz@@4 null)) (and (=> (= (ControlFlow 0 25) (- 0 29)) (<= 0 lo@@4)) (=> (<= 0 lo@@4) (and (=> (= (ControlFlow 0 25) (- 0 28)) (<= lo@@4 (+ i@@11 1))) (=> (<= lo@@4 (+ i@@11 1)) (and (=> (= (ControlFlow 0 25) (- 0 27)) (<= (+ i@@11 1) hi@@4)) (=> (<= (+ i@@11 1) hi@@4) (and (=> (= (ControlFlow 0 25) (- 0 26)) (<= hi@@4 (|Seq#Length| ar@@4))) (=> (<= hi@@4 (|Seq#Length| ar@@4)) (and (and (=> (= (ControlFlow 0 25) 17) anon23_Else_correct) (=> (= (ControlFlow 0 25) 22) anon24_Then_correct)) (=> (= (ControlFlow 0 25) 24) anon24_Else_correct))))))))))))))
(let ((anon16_correct true))
(let ((anon22_Else_correct  (=> (and (|sum#trigger| (FrameFragment (int_2_U (|sum#condqp1| Heap@@13 diz@@4 lo@@4 hi@@4 (+ i@@11 1) ar@@4))) diz@@4 lo@@4 hi@@4 (+ i@@11 1) ar@@4) (= (ControlFlow 0 15) 13)) anon16_correct)))
(let ((anon21_Then_correct  (=> (< i@@11 hi@@4) (and (=> (= (ControlFlow 0 31) (- 0 34)) (>= i@@11 0)) (=> (>= i@@11 0) (and (=> (= (ControlFlow 0 31) (- 0 33)) (< i@@11 (|Seq#Length| ar@@4))) (=> (< i@@11 (|Seq#Length| ar@@4)) (and (=> (= (ControlFlow 0 31) (- 0 32)) (HasDirectPerm QPMask@0 (|Seq#Index| ar@@4 i@@11) val)) (=> (HasDirectPerm QPMask@0 (|Seq#Index| ar@@4 i@@11) val) (and (=> (= (ControlFlow 0 31) 25) anon22_Then_correct) (=> (= (ControlFlow 0 31) 15) anon22_Else_correct)))))))))))
(let ((anon21_Else_correct  (=> (and (<= hi@@4 i@@11) (= (ControlFlow 0 14) 13)) anon16_correct)))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 35) (- 0 36)) (forall ((k_4 Int) (k_4_1 Int) ) (!  (=> (and (and (and (and (not (= k_4 k_4_1)) (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_4))) (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_4_1))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index| ar@@4 k_4) (|Seq#Index| ar@@4 k_4_1))))
 :qid |stdinbpl.689:15|
 :skolemid |65|
))) (=> (forall ((k_4@@0 Int) (k_4_1@@0 Int) ) (!  (=> (and (and (and (and (not (= k_4@@0 k_4_1@@0)) (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_4@@0))) (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_4_1@@0))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (|Seq#Index| ar@@4 k_4@@0) (|Seq#Index| ar@@4 k_4_1@@0))))
 :qid |stdinbpl.689:15|
 :skolemid |65|
)) (=> (forall ((k_4@@1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_4@@1)) (and (qpRange1 (|Seq#Index| ar@@4 k_4@@1)) (= (invRecv1 (|Seq#Index| ar@@4 k_4@@1)) k_4@@1)))
 :qid |stdinbpl.695:22|
 :skolemid |66|
 :pattern ( (|Seq#Index| ar@@4 k_4@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_4@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_4@@1)))
 :pattern ( (|Seq#Index| ar@@4 k_4@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U (invRecv1 o_3))) (qpRange1 o_3)) (= (|Seq#Index| ar@@4 (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.699:22|
 :skolemid |67|
 :pattern ( (invRecv1 o_3))
)) (forall ((k_4@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_4@@2)) (not (= (|Seq#Index| ar@@4 k_4@@2) null)))
 :qid |stdinbpl.705:22|
 :skolemid |68|
 :pattern ( (|Seq#Index| ar@@4 k_4@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_4@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k_4@@2)))
 :pattern ( (|Seq#Index| ar@@4 k_4@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U (invRecv1 o_3@@0))) (qpRange1 o_3@@0)) (and (= (|Seq#Index| ar@@4 (invRecv1 o_3@@0)) o_3@@0) (< (U_2_real (MapType1Select ZeroMask o_3@@0 val)) (U_2_real (MapType1Select QPMask@0 o_3@@0 val))))) (=> (not (and (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U (invRecv1 o_3@@0))) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.711:22|
 :skolemid |69|
...
))) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0))) (and (=> (= (ControlFlow 0 35) 31) anon21_Then_correct) (=> (= (ControlFlow 0 35) 14) anon21_Else_correct)))))))))
(let ((anon7_correct true))
(let ((anon20_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon20_Then_correct  (=> (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= k 0)) (=> (>= k 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< k (|Seq#Length| ar@@4))) (=> (< k (|Seq#Length| ar@@4)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon17_Else_correct  (=> (and (forall ((k1_3 Int) (k2_3 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k1_3)) (and (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k2_3)) (not (= k1_3 k2_3)))) (not (= (|Seq#Index| ar@@4 k1_3) (|Seq#Index| ar@@4 k2_3))))
 :qid |stdinbpl.671:20|
 :skolemid |64|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| lo@@4 hi@@4) (int_2_U k1_3)) (|Seq#ContainsTrigger| (|Seq#Range| lo@@4 hi@@4) (int_2_U k2_3)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| lo@@4 hi@@4) (int_2_U k1_3)) (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k2_3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k1_3)) (|Seq#ContainsTrigger| (|Seq#Range| lo@@4 hi@@4) (int_2_U k2_3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k1_3)) (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k2_3)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| lo@@4 hi@@4) (int_2_U k1_3)) (|Seq#Index| ar@@4 k2_3))
 :pattern ( (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k1_3)) (|Seq#Index| ar@@4 k2_3))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| lo@@4 hi@@4) (int_2_U k2_3)) (|Seq#Index| ar@@4 k1_3))
 :pattern ( (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k2_3)) (|Seq#Index| ar@@4 k1_3))
 :pattern ( (|Seq#Index| ar@@4 k1_3) (|Seq#Index| ar@@4 k2_3))
)) (state Heap@@13 ZeroMask)) (and (and (=> (= (ControlFlow 0 37) 35) anon19_Else_correct) (=> (= (ControlFlow 0 37) 9) anon20_Then_correct)) (=> (= (ControlFlow 0 37) 12) anon20_Else_correct)))))
(let ((anon3_correct true))
(let ((anon18_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k1_1)) (and (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k2_1)) (not (= k1_1 k2_1))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon18_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k1_1)) (and (|Seq#Contains| (|Seq#Range| lo@@4 hi@@4) (int_2_U k2_1)) (not (= k1_1 k2_1)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= k1_1 0)) (=> (>= k1_1 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< k1_1 (|Seq#Length| ar@@4))) (=> (< k1_1 (|Seq#Length| ar@@4)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= k2_1 0)) (=> (>= k2_1 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< k2_1 (|Seq#Length| ar@@4))) (=> (< k2_1 (|Seq#Length| ar@@4)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@13 diz@@4 $allocated)) (= AssumeFunctionsAbove 0)) (=> (and (and (and (not (= diz@@4 null)) (state Heap@@13 ZeroMask)) (and (<= 0 lo@@4) (<= lo@@4 i@@11))) (and (and (<= i@@11 hi@@4) (state Heap@@13 ZeroMask)) (and (<= hi@@4 (|Seq#Length| ar@@4)) (state Heap@@13 ZeroMask)))) (and (and (=> (= (ControlFlow 0 38) 37) anon17_Else_correct) (=> (= (ControlFlow 0 38) 2) anon18_Then_correct)) (=> (= (ControlFlow 0 38) 7) anon18_Else_correct)))))))
