...
(declare-fun |bar#frame| (T@U Int) Int)
...
(assert (forall ((Heap@@2 T@U) (x@@8 Int) ) (!  (=> (= (type Heap@@2) (MapType0Type RefType)) (dummyFunction (int_2_U (|foo#triggerStateless| x@@8))))
 :qid |stdinbpl.190:15|
 :skolemid |23|
 :pattern ( (|foo'| Heap@@2 x@@8))
)))
(assert (forall ((Heap@@3 T@U) (y@@1 Int) ) (!  (=> (= (type Heap@@3) (MapType0Type RefType)) (dummyFunction (int_2_U (|bar#triggerStateless| y@@1))))
 :qid |stdinbpl.239:15|
 :skolemid |27|
 :pattern ( (|bar'| Heap@@3 y@@1))
)))
...
(assert (forall ((Heap@@5 T@U) (x@@9 Int) ) (!  (=> (= (type Heap@@5) (MapType0Type RefType)) (and (= (foo Heap@@5 x@@9) (|foo'| Heap@@5 x@@9)) (dummyFunction (int_2_U (|foo#triggerStateless| x@@9)))))
 :qid |stdinbpl.186:15|
 :skolemid |22|
 :pattern ( (foo Heap@@5 x@@9))
)))
(assert (forall ((Heap@@6 T@U) (y@@2 Int) ) (!  (=> (= (type Heap@@6) (MapType0Type RefType)) (and (= (bar Heap@@6 y@@2) (|bar'| Heap@@6 y@@2)) (dummyFunction (int_2_U (|bar#triggerStateless| y@@2)))))
 :qid |stdinbpl.235:15|
 :skolemid |26|
 :pattern ( (bar Heap@@6 y@@2))
)))
...
(assert (forall ((Heap@@9 T@U) (Mask@@6 T@U) (y@@3 Int) ) (!  (=> (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (and (state Heap@@9 Mask@@6) (< AssumeFunctionsAbove 0))) (= (bar Heap@@9 y@@3) (- y@@3 2)))
 :qid |stdinbpl.245:15|
 :skolemid |28|
 :pattern ( (state Heap@@9 Mask@@6) (bar Heap@@9 y@@3))
)))
(assert (forall ((Heap@@10 T@U) (Mask@@7 T@U) (x@@10 Int) ) (!  (=> (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (and (state Heap@@10 Mask@@7) (< AssumeFunctionsAbove 1))) (= (foo Heap@@10 x@@10) (+ x@@10 1)))
 :qid |stdinbpl.196:15|
 :skolemid |24|
 :pattern ( (state Heap@@10 Mask@@7) (foo Heap@@10 x@@10))
)))
...
(assert (forall ((Heap@@13 T@U) (Mask@@11 T@U) (x@@11 Int) ) (!  (=> (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (state Heap@@13 Mask@@11)) (= (|foo'| Heap@@13 x@@11) (|foo#frame| EmptyFrame x@@11)))
 :qid |stdinbpl.203:15|
 :skolemid |25|
 :pattern ( (state Heap@@13 Mask@@11) (|foo'| Heap@@13 x@@11))
)))
(assert (forall ((Heap@@14 T@U) (Mask@@12 T@U) (y@@4 Int) ) (!  (=> (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (state Heap@@14 Mask@@12)) (= (|bar'| Heap@@14 y@@4) (|bar#frame| EmptyFrame y@@4)))
 :qid |stdinbpl.252:15|
 :skolemid |29|
 :pattern ( (state Heap@@14 Mask@@12) (|bar'| Heap@@14 y@@4))
)))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (> (foo Heap@@17 5) (bar Heap@@17 (- 5 1))))))
(let ((anon6_Then_correct true))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@17 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (state Heap@@17 ZeroMask)) (and (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 2) anon6_Then_correct)) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))))
