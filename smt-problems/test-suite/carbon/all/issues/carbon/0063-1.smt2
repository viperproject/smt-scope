...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon2_correct  (=> (and (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (P this@@11) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P this@@11))) FullPerm)))) (state Heap@@11 UnfoldingMask@0)) (and (state Heap@@11 Mask@0) (= (ControlFlow 0 2) (- 0 4)))) false)))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P this@@11))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P this@@11)))) (=> (= (ControlFlow 0 5) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 this@@11 $allocated))) (and (= Mask@0 (MapType1Store ZeroMask null (P this@@11) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P this@@11))) FullPerm)))) (state Heap@@11 Mask@0))) (and (and (state Heap@@11 Mask@0) (state Heap@@11 Mask@0)) (and (|P#trigger| Heap@@11 (P this@@11)) (= (MapType0Select Heap@@11 null (P this@@11)) EmptyFrame)))) (and (=> (= (ControlFlow 0 8) 5) anon3_Then_correct) (=> (= (ControlFlow 0 8) 7) anon3_Else_correct)))))
