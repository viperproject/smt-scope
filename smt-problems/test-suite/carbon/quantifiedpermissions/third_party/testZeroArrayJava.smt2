...
(assert  (and (and (and (= (type Heap@@33) (MapType0Type RefType)) (= (type diz) RefType)) (= (type freshObj@0) RefType)) (= (type Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id ZeroArray__ZeroArray)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (U_2_bool (MapType0Select Heap@@33 diz $allocated)) (=> (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@33 freshObj@0 $allocated)))) (=> (and (and (= Heap@0 (MapType0Store Heap@@33 freshObj@0 $allocated (bool_2_U true))) (state Heap@0 ZeroMask)) (and (state Heap@0 ZeroMask) (= (ControlFlow 0 3) (- 0 4)))) (not (= freshObj@0 null)))))))
