...
(assert  (and (and (= (type Heap@@25) (MapType1Type RefType)) (= (type x@@67) RefType)) (= (type Mask@0) (MapType2Type RefType realType))))
(set-info :boogie-vc-id |lft_List#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@25 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType1Select Heap@@25 x@@67 $allocated))) (=> (and (and (not (= x@@67 null)) (= Mask@0 (MapType2Store ZeroMask x@@67 ref (real_2_U (+ (U_2_real (MapType2Select ZeroMask x@@67 ref)) FullPerm))))) (and (state Heap@@25 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@0 x@@67 ref))))))
