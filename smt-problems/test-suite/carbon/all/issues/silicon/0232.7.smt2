...
(assert  (and (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type Heap@@10) (MapType0Type RefType))) (= (type this) RefType)) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test4)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon4_correct true))
(let ((anon3_correct  (=> (= Mask@2 (MapType1Store Mask@1 null (P (MapType0Select Heap@@10 this f_7)) (real_2_U (- (U_2_real (MapType1Select Mask@1 null (P (MapType0Select Heap@@10 this f_7)))) perm@0)))) (=> (and (= Mask@3 Mask@2) (= (ControlFlow 0 3) 1)) anon4_correct))))
(let ((anon6_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= perm@0 (U_2_real (MapType1Select Mask@1 null (P (MapType0Select Heap@@10 this f_7)))))) (=> (<= perm@0 (U_2_real (MapType1Select Mask@1 null (P (MapType0Select Heap@@10 this f_7))))) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
(let ((anon5_Then_correct  (=> (< NoPerm (U_2_real (MapType1Select Mask@1 null (P (MapType0Select Heap@@10 this f_7))))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (HasDirectPerm Mask@1 this f_7)) (=> (HasDirectPerm Mask@1 this f_7) (and (=> (= (ControlFlow 0 7) (- 0 9)) (HasDirectPerm Mask@1 this f_7)) (=> (HasDirectPerm Mask@1 this f_7) (=> (= perm@0 (U_2_real (MapType1Select Mask@1 null (P (MapType0Select Heap@@10 this f_7))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))))))))))
...
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 this $allocated))) (=> (and (and (not (= this null)) (= Mask@0 (MapType1Store ZeroMask this f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this f_7)) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (HasDirectPerm Mask@0 this f_7)) (=> (HasDirectPerm Mask@0 this f_7) (=> (= Mask@1 (MapType1Store Mask@0 null (P (MapType0Select Heap@@10 this f_7)) (real_2_U (+ (U_2_real (MapType1Select Mask@0 null (P (MapType0Select Heap@@10 this f_7)))) FullPerm)))) (=> (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm Mask@1 this f_7)) (=> (HasDirectPerm Mask@1 this f_7) (and (=> (= (ControlFlow 0 11) 7) anon5_Then_correct) (=> (= (ControlFlow 0 11) 2) anon5_Else_correct))))))))))))
