...
(declare-fun |f'| (T@U T@U T@U) Bool)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |f#triggerStateless| (T@U T@U) Bool)
...
(declare-fun |$'| (T@U T@U) Bool)
(declare-fun |$#triggerStateless| (T@U) Bool)
...
(declare-fun |f#trigger| (T@U T@U T@U) Bool)
...
(declare-fun |$#frame| (T@U T@U) Bool)
(declare-fun $ (T@U T@U) Bool)
(declare-fun |MultiSet#Empty| (T@T) T@U)
(declare-fun FullPerm () Real)
(declare-fun |Set#Empty| (T@T) T@U)
(declare-fun |f#frame| (T@U T@U T@U) Bool)
(declare-fun |Set#Subset| (T@U T@U) Bool)
(declare-fun ZeroPMask () T@U)
(declare-fun |MultiSet#Subset| (T@U T@U) Bool)
(declare-fun f_6@@0 (T@U T@U T@U) Bool)
...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (Ctor RefType) 8)) (= (type car) (FieldType NormalFieldType RefType))))
(assert (distinct $allocated car)
)
...
(assert (forall ((Heap@@0 T@U) (uref T@U) (vref T@U) ) (!  (=> (and (and (= (type Heap@@0) (MapType0Type RefType)) (= (type uref) RefType)) (= (type vref) RefType)) (dummyFunction (bool_2_U (|f#triggerStateless| uref vref))))
 :qid |stdinbpl.407:15|
 :skolemid |83|
 :pattern ( (|f'| Heap@@0 uref vref))
)))
...
(assert (forall ((Heap@@3 T@U) (ref T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type ref) RefType)) (dummyFunction (bool_2_U (|$#triggerStateless| ref))))
 :qid |stdinbpl.474:15|
 :skolemid |87|
 :pattern ( (|$'| Heap@@3 ref))
)))
...
(assert (forall ((Heap@@6 T@U) (Mask@@4 T@U) (ref@@0 T@U) ) (!  (=> (and (and (and (= (type Heap@@6) (MapType0Type RefType)) (= (type Mask@@4) (MapType1Type RefType realType))) (= (type ref@@0) RefType)) (and (state Heap@@6 Mask@@4) (or (< AssumeFunctionsAbove 0) (|$#trigger| (FrameFragment (MapType0Select Heap@@6 ref@@0 car)) ref@@0)))) (|$'| Heap@@6 ref@@0))
 :qid |stdinbpl.487:15|
 :skolemid |89|
 :pattern ( (state Heap@@6 Mask@@4) (|$'| Heap@@6 ref@@0))
)))
...
(assert  (and (forall ((arg0@@41 T@U) (arg1@@20 T@U) ) (! (= (type (CombineFrames arg0@@41 arg1@@20)) FrameTypeType)
 :qid |funType:CombineFrames|
 :pattern ( (CombineFrames arg0@@41 arg1@@20))
)) (= (type EmptyFrame) FrameTypeType)))
(assert (forall ((Heap@@8 T@U) (Mask@@6 T@U) (uref@@0 T@U) (vref@@0 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@6) (MapType1Type RefType realType))) (= (type uref@@0) RefType)) (= (type vref@@0) RefType)) (and (state Heap@@8 Mask@@6) (or (< AssumeFunctionsAbove 1) (|f#trigger| (CombineFrames (FrameFragment (MapType0Select Heap@@8 uref@@0 car)) (FrameFragment (ite (not (= uref@@0 vref@@0)) (FrameFragment (MapType0Select Heap@@8 vref@@0 car)) EmptyFrame))) uref@@0 vref@@0)))) (|f'| Heap@@8 uref@@0 vref@@0))
 :qid |stdinbpl.420:15|
 :skolemid |85|
 :pattern ( (state Heap@@8 Mask@@6) (|f'| Heap@@8 uref@@0 vref@@0))
)))
...
(assert (forall ((arg0@@42 Real) (arg1@@21 T@U) ) (! (= (type (ConditionalFrame arg0@@42 arg1@@21)) FrameTypeType)
 :qid |funType:ConditionalFrame|
 :pattern ( (ConditionalFrame arg0@@42 arg1@@21))
)))
...
(assert (forall ((Heap@@9 T@U) (Mask@@8 T@U) (ref@@1 T@U) ) (!  (=> (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@8) (MapType1Type RefType realType))) (= (type ref@@1) RefType)) (state Heap@@9 Mask@@8)) (= (|$'| Heap@@9 ref@@1) (|$#frame| (FrameFragment (MapType0Select Heap@@9 ref@@1 car)) ref@@1)))
 :qid |stdinbpl.481:15|
 :skolemid |88|
 :pattern ( (state Heap@@9 Mask@@8) (|$'| Heap@@9 ref@@1))
)))
...
(assert (forall ((Heap@@10 T@U) (ref@@2 T@U) ) (!  (=> (and (= (type Heap@@10) (MapType0Type RefType)) (= (type ref@@2) RefType)) (and (= ($ Heap@@10 ref@@2) (|$'| Heap@@10 ref@@2)) (dummyFunction (bool_2_U (|$#triggerStateless| ref@@2)))))
 :qid |stdinbpl.470:15|
 :skolemid |86|
 :pattern ( ($ Heap@@10 ref@@2))
)))
...
(assert (forall ((Heap@@14 T@U) (Mask@@12 T@U) (uref@@1 T@U) (vref@@1 T@U) ) (!  (=> (and (and (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (= (type uref@@1) RefType)) (= (type vref@@1) RefType)) (state Heap@@14 Mask@@12)) (= (|f'| Heap@@14 uref@@1 vref@@1) (|f#frame| (CombineFrames (FrameFragment (MapType0Select Heap@@14 uref@@1 car)) (FrameFragment (ite (not (= uref@@1 vref@@1)) (FrameFragment (MapType0Select Heap@@14 vref@@1 car)) EmptyFrame))) uref@@1 vref@@1)))
 :qid |stdinbpl.414:15|
 :skolemid |84|
 :pattern ( (state Heap@@14 Mask@@12) (|f'| Heap@@14 uref@@1 vref@@1))
)))
...
(assert (forall ((Heap@@16 T@U) (uref@@2 T@U) (vref@@2 T@U) ) (!  (=> (and (and (= (type Heap@@16) (MapType0Type RefType)) (= (type uref@@2) RefType)) (= (type vref@@2) RefType)) (and (= (f_6@@0 Heap@@16 uref@@2 vref@@2) (|f'| Heap@@16 uref@@2 vref@@2)) (dummyFunction (bool_2_U (|f#triggerStateless| uref@@2 vref@@2)))))
 :qid |stdinbpl.403:15|
 :skolemid |82|
 :pattern ( (f_6@@0 Heap@@16 uref@@2 vref@@2))
)))
(push 1)
...
(assert  (and (and (and (and (and (and (and (and (and (and (= (type g) (MapType2Type RefType boolType)) (= (type n1) RefType)) (= (type n2) RefType)) (= (type ExhaleWellDef0Mask@2) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@0) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type n1_1) RefType)) (= (type n2_1) RefType)) (= (type Heap@@17) (MapType0Type RefType))) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv1 arg0@@45)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon16_correct true))
(let ((anon26_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g n1_1)) (U_2_bool (MapType2Select g n2_1)))) (= (ControlFlow 0 20) 17)) anon16_correct)))
(let ((anon26_Then_correct  (=> (and (U_2_bool (MapType2Select g n1_1)) (U_2_bool (MapType2Select g n2_1))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (f_6@@0 Heap@@17 n1_1 n2_1)) (=> (f_6@@0 Heap@@17 n1_1 n2_1) (=> (= (ControlFlow 0 18) 17) anon16_correct))))))
(let ((anon11_correct true))
(let ((anon10_correct  (=> (= ExhaleWellDef0Mask@1 (MapType1Store ExhaleWellDef0Mask@0 n2 car (real_2_U (- (U_2_real (MapType1Select ExhaleWellDef0Mask@0 n2 car)) FullPerm)))) (=> (and (= ExhaleWellDef0Mask@2 ExhaleWellDef0Mask@1) (= (ControlFlow 0 7) 5)) anon11_correct))))
(let ((anon24_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 7)) anon10_correct)))
(let ((anon24_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@0 n2 car)))) (=> (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@0 n2 car))) (=> (= (ControlFlow 0 8) 7) anon10_correct))))))
(let ((anon23_Then_correct  (=> (not (= n1 n2)) (and (=> (= (ControlFlow 0 11) 8) anon24_Then_correct) (=> (= (ControlFlow 0 11) 10) anon24_Else_correct)))))
(let ((anon23_Else_correct  (=> (= n1 n2) (=> (and (= ExhaleWellDef0Mask@2 ExhaleWellDef0Mask@0) (= (ControlFlow 0 6) 5)) anon11_correct))))
(let ((anon7_correct  (=> (= ExhaleWellDef0Mask@0 (MapType1Store QPMask@0 n1 car (real_2_U (- (U_2_real (MapType1Select QPMask@0 n1 car)) FullPerm)))) (and (=> (= (ControlFlow 0 12) 11) anon23_Then_correct) (=> (= (ControlFlow 0 12) 6) anon23_Else_correct)))))
(let ((anon22_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 15) 12)) anon7_correct)))
(let ((anon22_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 n1 car)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 n1 car))) (=> (= (ControlFlow 0 13) 12) anon7_correct))))))
(let ((anon12_correct true))
(let ((anon20_Then_correct  (=> (and (U_2_bool (MapType2Select g n1)) (U_2_bool (MapType2Select g n2))) (and (and (=> (= (ControlFlow 0 16) 3) anon12_correct) (=> (= (ControlFlow 0 16) 13) anon22_Then_correct)) (=> (= (ControlFlow 0 16) 15) anon22_Else_correct)))))
(let ((anon20_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g n1)) (U_2_bool (MapType2Select g n2)))) (= (ControlFlow 0 4) 3)) anon12_correct)))
(let ((anon25_Else_correct true))
(let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((n_1 T@U) (n_1_1 T@U) ) (!  (=> (and (= (type n_1) RefType) (= (type n_1_1) RefType)) (=> (and (and (and (and (not (= n_1 n_1_1)) (U_2_bool (MapType2Select g n_1))) (U_2_bool (MapType2Select g n_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_1 n_1_1))))
 :qid |stdinbpl.556:15|
 :skolemid |90|
 :no-pattern (type n_1)
...
)) (=> (forall ((n_1@@1 T@U) ) (!  (=> (= (type n_1@@1) RefType) (=> (and (U_2_bool (MapType2Select g n_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 n_1@@1) (= (invRecv1 n_1@@1) n_1@@1))))
 :qid |stdinbpl.562:22|
 :skolemid |91|
 :pattern ( (MapType0Select Heap@@17 n_1@@1 car))
 :pattern ( (MapType1Select QPMask@0 n_1@@1 car))
 :pattern ( (MapType2Select g n_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select g (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.566:22|
 :skolemid |92|
 :pattern ( (invRecv1 o_3))
)) (forall ((n_1@@2 T@U) ) (!  (=> (and (= (type n_1@@2) RefType) (U_2_bool (MapType2Select g n_1@@2))) (not (= n_1@@2 null)))
 :qid |stdinbpl.572:22|
 :skolemid |93|
 :pattern ( (MapType0Select Heap@@17 n_1@@2 car))
 :pattern ( (MapType1Select QPMask@0 n_1@@2 car))
 :pattern ( (MapType2Select g n_1@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select g (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 car)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 car)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select g (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 car)) (U_2_real (MapType1Select ZeroMask o_3@@0 car))))))
 :qid |stdinbpl.578:22|
 :skolemid |94|
 :pattern ( (MapType1Select QPMask@0 o_3@@0 car))
)) (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 car))) (= (U_2_real (MapType1Select ZeroMask o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.582:29|
 :skolemid |95|
 :pattern ( (MapType1Select ZeroMask o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3@@1 f_5))
))) (and (state Heap@@17 QPMask@0) (state Heap@@17 QPMask@0))) (and (and (and (and (=> (= (ControlFlow 0 21) 2) anon25_Else_correct) (=> (= (ControlFlow 0 21) 18) anon26_Then_correct)) (=> (= (ControlFlow 0 21) 20) anon26_Else_correct)) (=> (= (ControlFlow 0 21) 16) anon20_Then_correct)) (=> (= (ControlFlow 0 21) 4) anon20_Else_correct)))))))))
(let ((anon18_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@17 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 23) 1) anon18_Then_correct) (=> (= (ControlFlow 0 23) 21) anon18_Else_correct)))))
