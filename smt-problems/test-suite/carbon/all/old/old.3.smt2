...
(assert  (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type r_1) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id t4)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon2_correct  (=> (= Mask@1 (MapType1Store Mask@0 r_1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 r_1 f_7)) FullPerm)))) (=> (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@1) (state ExhaleHeap@0 Mask@1)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm Mask@0 r_1 f_7)) (=> (HasDirectPerm Mask@0 r_1 f_7) (and (=> (= (ControlFlow 0 2) (- 0 4)) (> (U_2_int (MapType0Select Heap@@9 r_1 f_7)) 0)) (=> (> (U_2_int (MapType0Select Heap@@9 r_1 f_7)) 0) (=> (state ExhaleHeap@0 Mask@1) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 r_1 f_7)) (=> (HasDirectPerm Mask@1 r_1 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (> (U_2_int (MapType0Select ExhaleHeap@0 r_1 f_7)) 0)))))))))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@0 r_1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 r_1 f_7))) (=> (= (ControlFlow 0 6) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 r_1 $allocated))) (=> (and (and (not (= r_1 null)) (= Mask@0 (MapType1Store ZeroMask r_1 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1 f_7)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm Mask@0 r_1 f_7)) (=> (HasDirectPerm Mask@0 r_1 f_7) (=> (and (> (U_2_int (MapType0Select Heap@@9 r_1 f_7)) 0) (state Heap@@9 Mask@0)) (and (=> (= (ControlFlow 0 9) 6) anon3_Then_correct) (=> (= (ControlFlow 0 9) 8) anon3_Else_correct)))))))))
