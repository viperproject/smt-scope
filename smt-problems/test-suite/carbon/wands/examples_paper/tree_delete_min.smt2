...
(let ((anon11_Else_correct  (=> (and (not (= x@@25 null)) (= Heap@0 (MapType0Store Heap@@18 null (|Tree#sm| x@@25) (MapType1Store (MapType0Select Heap@@18 null (|Tree#sm| x@@25)) x@@25 v_2 (bool_2_U true))))) (=> (and (and (and (= Heap@1 (MapType0Store Heap@0 null (|Tree#sm| x@@25) (MapType1Store (MapType0Select Heap@0 null (|Tree#sm| x@@25)) x@@25 l (bool_2_U true)))) (forall ((o_3 T@U) (f_7 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_7))))
(let ((A@@12 (FieldTypeInv0 (type f_7))))
 (=> (and (and (= (type o_3) RefType) (= (type f_7) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|Tree#sm| x@@25)) o_3 f_7)) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|Tree#sm| (MapType0Select Heap@1 x@@25 l))) o_3 f_7)))) (U_2_bool (MapType1Select newPMask@0 o_3 f_7)))))
 :qid |stdinbpl.703:33|
 :skolemid |69|
 :pattern ( (MapType1Select newPMask@0 o_3 f_7))
))) (and (= Heap@2 (MapType0Store Heap@1 null (|Tree#sm| x@@25) newPMask@0)) (= Heap@3 (MapType0Store Heap@2 null (|Tree#sm| x@@25) (MapType1Store (MapType0Select Heap@2 null (|Tree#sm| x@@25)) x@@25 r_1 (bool_2_U true)))))) (and (and (forall ((o_4 T@U) (f_8 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_8))))
(let ((A@@13 (FieldTypeInv0 (type f_8))))
 (=> (and (and (= (type o_4) RefType) (= (type f_8) (FieldType A@@13 B@@12))) (or (U_2_bool (MapType1Select (MapType0Select Heap@3 null (|Tree#sm| x@@25)) o_4 f_8)) (U_2_bool (MapType1Select (MapType0Select Heap@3 null (|Tree#sm| (MapType0Select Heap@3 x@@25 r_1))) o_4 f_8)))) (U_2_bool (MapType1Select newPMask@1 o_4 f_8)))))
 :qid |stdinbpl.710:33|
 :skolemid |70|
 :pattern ( (MapType1Select newPMask@1 o_4 f_8))
)) (= Heap@4 (MapType0Store Heap@3 null (|Tree#sm| x@@25) newPMask@1))) (and (= Heap@5 Heap@4) (= (ControlFlow 0 3) 1)))) anon8_correct))))
(let ((anon11_Then_correct  (=> (= x@@25 null) (=> (and (= Heap@5 Heap@@18) (= (ControlFlow 0 2) 1)) anon8_correct))))
(let ((anon5_correct  (=> (state Heap@@18 UnfoldingMask@6) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm UnfoldingMask@6 x@@25 v_2)) (=> (HasDirectPerm UnfoldingMask@6 x@@25 v_2) (and (=> (= (ControlFlow 0 4) 2) anon11_Then_correct) (=> (= (ControlFlow 0 4) 3) anon11_Else_correct)))))))
(let ((anon10_Else_correct  (=> (and (not (= x@@25 null)) (not (= x@@25 null))) (=> (and (and (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x@@25 v_2 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@25 v_2)) FullPerm)))) (state Heap@@18 UnfoldingMask@1)) (and (not (= x@@25 null)) (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 x@@25 l (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 x@@25 l)) FullPerm)))))) (and (and (state Heap@@18 UnfoldingMask@2) (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 null (Tree (MapType0Select Heap@@18 x@@25 l)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 null (Tree (MapType0Select Heap@@18 x@@25 l)))) FullPerm))))) (and (InsidePredicate (Tree x@@25) (MapType0Select Heap@@18 null (Tree x@@25)) (Tree (MapType0Select Heap@@18 x@@25 l)) (MapType0Select Heap@@18 null (Tree (MapType0Select Heap@@18 x@@25 l)))) (state Heap@@18 UnfoldingMask@3)))) (and (and (and (not (= x@@25 null)) (= UnfoldingMask@4 (MapType1Store UnfoldingMask@3 x@@25 r_1 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@3 x@@25 r_1)) FullPerm))))) (and (state Heap@@18 UnfoldingMask@4) (= UnfoldingMask@5 (MapType1Store UnfoldingMask@4 null (Tree (MapType0Select Heap@@18 x@@25 r_1)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@4 null (Tree (MapType0Select Heap@@18 x@@25 r_1)))) FullPerm)))))) (and (and (InsidePredicate (Tree x@@25) (MapType0Select Heap@@18 null (Tree x@@25)) (Tree (MapType0Select Heap@@18 x@@25 r_1)) (MapType0Select Heap@@18 null (Tree (MapType0Select Heap@@18 x@@25 r_1)))) (state Heap@@18 UnfoldingMask@5)) (and (= UnfoldingMask@6 UnfoldingMask@5) (= (ControlFlow 0 7) 4))))) anon5_correct))))
(let ((anon10_Then_correct  (=> (= x@@25 null) (=> (and (= UnfoldingMask@6 UnfoldingMask@0) (= (ControlFlow 0 6) 4)) anon5_correct))))
(let ((anon2_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (Tree x@@25) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (Tree x@@25))) FullPerm)))) (and (=> (= (ControlFlow 0 8) 6) anon10_Then_correct) (=> (= (ControlFlow 0 8) 7) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 8)) anon2_correct)))
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Tree x@@25))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Tree x@@25)))) (=> (= (ControlFlow 0 9) 8) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@18 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@18 x@@25 $allocated)) (= AssumeFunctionsAbove 1)) (and (not (= x@@25 null)) (= Mask@0 (MapType1Store ZeroMask null (Tree x@@25) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Tree x@@25))) FullPerm)))))) (and (and (state Heap@@18 Mask@0) (state Heap@@18 Mask@0)) (and (|Tree#trigger| Heap@@18 (Tree x@@25)) (= (MapType0Select Heap@@18 null (Tree x@@25)) (FrameFragment (ite (= x@@25 null) EmptyFrame (CombineFrames (FrameFragment (MapType0Select Heap@@18 x@@25 v_2)) (CombineFrames (FrameFragment (MapType0Select Heap@@18 x@@25 l)) (CombineFrames (MapType0Select Heap@@18 null (Tree (MapType0Select Heap@@18 x@@25 l))) (CombineFrames (FrameFragment (MapType0Select Heap@@18 x@@25 r_1)) (MapType0Select Heap@@18 null (Tree (MapType0Select Heap@@18 x@@25 r_1))))))))))))) (and (=> (= (ControlFlow 0 12) 9) anon9_Then_correct) (=> (= (ControlFlow 0 12) 11) anon9_Else_correct))))))
