...
(declare-fun y@@1 () T@U)
(declare-fun z@@0 () T@U)
(assert  (and (and (and (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type freshObj@0) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type x_3) RefType)) (forall ((arg0@@26 T@U) ) (! (= (type (invRecv1 arg0@@26)) RefType)
 :qid |funType:invRecv1|
 :pattern ( (invRecv1 arg0@@26))
...
(let ((anon9_Else_correct  (=> (and (not (NN x_3)) (= (ControlFlow 0 10) 7)) anon5_correct)))
(let ((anon9_Then_correct  (=> (NN x_3) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm QPMask@0 x_3 f_7)) (=> (HasDirectPerm QPMask@0 x_3 f_7) (=> (= (ControlFlow 0 8) 7) anon5_correct))))))
(let ((anon8_Else_correct  (=> (forall ((x_3_1 T@U) ) (!  (=> (= (type x_3_1) RefType) (and (NN x_3_1) (= (U_2_int (MapType0Select Heap@@9 x_3_1 f_7)) 0)))
 :qid |stdinbpl.302:20|
 :skolemid |29|
 :pattern ( (NN x_3_1))
...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (not (= x_1 x_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.257:15|
 :skolemid |23|
 :no-pattern (type x_1)
...
)) (=> (and (and (and (forall ((x_1@@1 T@U) ) (!  (=> (and (= (type x_1@@1) RefType) (< NoPerm FullPerm)) (and (qpRange1 x_1@@1) (= (invRecv1 x_1@@1) x_1@@1)))
 :qid |stdinbpl.263:22|
 :skolemid |24|
 :pattern ( (MapType0Select Heap@@9 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (< NoPerm FullPerm) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.267:22|
 :skolemid |25|
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (and (=> (= (ControlFlow 0 11) 3) anon8_Else_correct) (=> (= (ControlFlow 0 11) 8) anon9_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon9_Else_correct)))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 y@@1 $allocated)) (U_2_bool (MapType0Select Heap@@9 z@@0 $allocated))) (and (=> (= (ControlFlow 0 13) 1) anon7_Then_correct) (=> (= (ControlFlow 0 13) 11) anon7_Else_correct))))))
