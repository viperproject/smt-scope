...
(declare-fun |fun01'| (T@U T@U Bool) Int)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |fun01#triggerStateless| (T@U Bool) Int)
...
(declare-fun |fun01#frame| (T@U T@U Bool) Int)
...
(assert (forall ((Heap@@0 T@U) (x@@8 T@U) (b_2 Bool) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type x@@8) RefType)) (dummyFunction (int_2_U (|fun01#triggerStateless| x@@8 b_2))))
 :qid |stdinbpl.200:15|
 :skolemid |23|
 :pattern ( (|fun01'| Heap@@0 x@@8 b_2))
)))
...
(assert (forall ((Heap@@3 T@U) (Mask@@2 T@U) (x@@9 T@U) (b_2@@0 Bool) ) (!  (=> (and (and (and (= (type Heap@@3) (MapType0Type RefType)) (= (type Mask@@2) (MapType1Type RefType realType))) (= (type x@@9) RefType)) (state Heap@@3 Mask@@2)) (= (|fun01'| Heap@@3 x@@9 b_2@@0) (|fun01#frame| (FrameFragment (ite b_2@@0 (FrameFragment (MapType0Select Heap@@3 x@@9 f_7)) (FrameFragment (MapType0Select Heap@@3 x@@9 g)))) x@@9 b_2@@0)))
 :qid |stdinbpl.207:15|
 :skolemid |24|
 :pattern ( (state Heap@@3 Mask@@2) (|fun01'| Heap@@3 x@@9 b_2@@0))
)))
...
(assert (forall ((Heap@@7 T@U) (x@@10 T@U) (b_2@@1 Bool) ) (!  (=> (and (= (type Heap@@7) (MapType0Type RefType)) (= (type x@@10) RefType)) (and (= (fun01 Heap@@7 x@@10 b_2@@1) (|fun01'| Heap@@7 x@@10 b_2@@1)) (dummyFunction (int_2_U (|fun01#triggerStateless| x@@10 b_2@@1)))))
 :qid |stdinbpl.196:15|
 :skolemid |22|
 :pattern ( (fun01 Heap@@7 x@@10 b_2@@1))
)))
...
(assert  (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type x@@11) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@12) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
...
(let ((anon24_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@11 g)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@11 g))) (=> (= (ControlFlow 0 16) 15) anon15_correct))))))
(let ((anon23_Else_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (= (fun01 Heap@0 x@@11 false) (- 0 1)))))
(let ((anon21_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (= (fun01 Heap@0 x@@11 true) 1)) (=> (= (fun01 Heap@0 x@@11 true) 1) (=> (state Heap@0 Mask@1) (and (and (=> (= (ControlFlow 0 19) 14) anon23_Else_correct) (=> (= (ControlFlow 0 19) 16) anon24_Then_correct)) (=> (= (ControlFlow 0 19) 18) anon24_Else_correct)))))))
(let ((anon11_correct true))
(let ((anon22_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon11_correct)))
(let ((anon22_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@11 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@11 f_7))) (=> (= (ControlFlow 0 10) 9) anon11_correct))))))
(let ((anon19_Else_correct  (=> (= (fun01 Heap@@12 x@@11 false) (- 0 1)) (=> (and (state Heap@@12 Mask@1) (state Heap@@12 Mask@1)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (= FullPerm (U_2_real (MapType1Select Mask@1 x@@11 g)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 x@@11 g))) (=> (and (= Heap@0 (MapType0Store Heap@@12 x@@11 g (int_2_U 10))) (state Heap@0 Mask@1)) (and (and (=> (= (ControlFlow 0 21) 19) anon21_Else_correct) (=> (= (ControlFlow 0 21) 10) anon22_Then_correct)) (=> (= (ControlFlow 0 21) 12) anon22_Else_correct)))))))))
(let ((anon7_correct true))
(let ((anon20_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon7_correct)))
(let ((anon20_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@11 g)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@11 g))) (=> (= (ControlFlow 0 6) 5) anon7_correct))))))
(let ((anon17_Else_correct  (=> (and (and (= (fun01 Heap@@12 x@@11 true) 1) (state Heap@@12 Mask@1)) (and (state Heap@@12 Mask@1) (state Heap@@12 Mask@1))) (and (and (=> (= (ControlFlow 0 23) 21) anon19_Else_correct) (=> (= (ControlFlow 0 23) 6) anon20_Then_correct)) (=> (= (ControlFlow 0 23) 8) anon20_Else_correct)))))
(let ((anon3_correct true))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@11 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@11 f_7))) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (and (and (state Heap@@12 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@12 x@@11 $allocated)) (not (= x@@11 null)))) (=> (and (and (and (= Mask@0 (MapType1Store ZeroMask x@@11 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@11 f_7)) FullPerm)))) (state Heap@@12 Mask@0)) (and (state Heap@@12 Mask@0) (not (= x@@11 null)))) (and (and (= Mask@1 (MapType1Store Mask@0 x@@11 g (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@11 g)) FullPerm)))) (state Heap@@12 Mask@1)) (and (state Heap@@12 Mask@1) (state Heap@@12 Mask@1)))) (and (and (=> (= (ControlFlow 0 24) 23) anon17_Else_correct) (=> (= (ControlFlow 0 24) 2) anon18_Then_correct)) (=> (= (ControlFlow 0 24) 4) anon18_Else_correct))))))
