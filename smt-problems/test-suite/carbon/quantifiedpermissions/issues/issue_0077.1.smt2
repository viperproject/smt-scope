...
(assert  (and (and (and (and (and (and (= (type S) (SeqType RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 47) (let ((anon12_correct true))
(let ((anon29_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_6))) (= (ControlFlow 0 40) 36)) anon12_correct)))
(let ((anon29_Then_correct  (=> (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_6)) (and (=> (= (ControlFlow 0 37) (- 0 39)) (>= i1_6 0)) (=> (>= i1_6 0) (and (=> (= (ControlFlow 0 37) (- 0 38)) (< i1_6 (|Seq#Length| S))) (=> (< i1_6 (|Seq#Length| S)) (=> (= (ControlFlow 0 37) 36) anon12_correct))))))))
(let ((anon28_Else_correct  (and (=> (= (ControlFlow 0 34) (- 0 35)) (forall ((i1_3 Int) (i1_3_1 Int) ) (!  (=> (and (and (and (and (not (= i1_3 i1_3_1)) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_3))) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_3_1))) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index| S i1_3) (|Seq#Index| S i1_3_1))))
 :qid |stdinbpl.937:15|
 :skolemid |88|
))) (=> (forall ((i1_3@@0 Int) (i1_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i1_3@@0 i1_3_1@@0)) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_3@@0))) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_3_1@@0))) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index| S i1_3@@0) (|Seq#Index| S i1_3_1@@0))))
 :qid |stdinbpl.937:15|
 :skolemid |88|
)) (=> (forall ((i1_3@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_3@@1)) (< NoPerm p_1)) (and (qpRange5 (|Seq#Index| S i1_3@@1)) (= (invRecv5 (|Seq#Index| S i1_3@@1)) i1_3@@1)))
 :qid |stdinbpl.943:22|
 :skolemid |89|
 :pattern ( (|Seq#Index| S i1_3@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| start end) (int_2_U i1_3@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_3@@1)))
 :pattern ( (|Seq#Index| S i1_3@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U (invRecv5 o_3))) (< NoPerm p_1)) (qpRange5 o_3)) (= (|Seq#Index| S (invRecv5 o_3)) o_3)))
 :qid |stdinbpl.947:22|
 :skolemid |90|
 :pattern ( (invRecv5 o_3))
)) (= (ControlFlow 0 34) (- 0 33))) (forall ((i1_3@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_3@@2)) (>= p_1 NoPerm))
 :qid |stdinbpl.953:15|
 :skolemid |91|
 :pattern ( (|Seq#Index| S i1_3@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| start end) (int_2_U i1_3@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_3@@2)))
 :pattern ( (|Seq#Index| S i1_3@@2))
))))))))
(let ((anon27_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (and (=> (= (ControlFlow 0 41) 34) anon28_Else_correct) (=> (= (ControlFlow 0 41) 37) anon29_Then_correct)) (=> (= (ControlFlow 0 41) 40) anon29_Else_correct)))))
(let ((anon21_correct true))
(let ((anon33_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_6))) (= (ControlFlow 0 29) 25)) anon21_correct)))
(let ((anon33_Then_correct  (=> (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_6)) (and (=> (= (ControlFlow 0 26) (- 0 28)) (>= i_6 0)) (=> (>= i_6 0) (and (=> (= (ControlFlow 0 26) (- 0 27)) (< i_6 (|Seq#Length| S))) (=> (< i_6 (|Seq#Length| S)) (=> (= (ControlFlow 0 26) 25) anon21_correct))))))))
(let ((anon32_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 24)) (forall ((i_5 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_5)) (dummyFunction (MapType0Select Heap@@9 (|Seq#Index| S i_5) f_7))) (>= p_1 NoPerm))
 :qid |stdinbpl.1059:17|
 :skolemid |102|
 :pattern ( (|Seq#Index| S i_5))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| start end) (int_2_U i_5)))
 :pattern ( (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_5)))
 :pattern ( (|Seq#Index| S i_5))
))) (=> (forall ((i_5@@0 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_5@@0)) (dummyFunction (MapType0Select Heap@@9 (|Seq#Index| S i_5@@0) f_7))) (>= p_1 NoPerm))
 :qid |stdinbpl.1059:17|
 :skolemid |102|
 :pattern ( (|Seq#Index| S i_5@@0))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| start end) (int_2_U i_5@@0)))
 :pattern ( (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_5@@0)))
 :pattern ( (|Seq#Index| S i_5@@0))
)) (and (=> (= (ControlFlow 0 19) (- 0 23)) (forall ((i_5@@1 Int) (i_5_1 Int) ) (!  (=> (and (and (and (and (not (= i_5@@1 i_5_1)) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_5@@1))) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_5_1))) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index| S i_5@@1) (|Seq#Index| S i_5_1))))
 :qid |stdinbpl.1066:17|
 :skolemid |103|
 :pattern ( (neverTriggered8 i_5@@1) (neverTriggered8 i_5_1))
))) (=> (forall ((i_5@@2 Int) (i_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_5@@2 i_5_1@@0)) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_5@@2))) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_5_1@@0))) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index| S i_5@@2) (|Seq#Index| S i_5_1@@0))))
 :qid |stdinbpl.1066:17|
 :skolemid |103|
 :pattern ( (neverTriggered8 i_5@@2) (neverTriggered8 i_5_1@@0))
)) (and (=> (= (ControlFlow 0 19) (- 0 22)) (forall ((i_5@@3 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_5@@3)) (>= (U_2_real (MapType1Select QPMask@1 (|Seq#Index| S i_5@@3) f_7)) p_1))
 :qid |stdinbpl.1073:17|
 :skolemid |104|
 :pattern ( (|Seq#Index| S i_5@@3))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| start end) (int_2_U i_5@@3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_5@@3)))
 :pattern ( (|Seq#Index| S i_5@@3))
))) (=> (forall ((i_5@@4 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_5@@4)) (>= (U_2_real (MapType1Select QPMask@1 (|Seq#Index| S i_5@@4) f_7)) p_1))
 :qid |stdinbpl.1073:17|
 :skolemid |104|
 :pattern ( (|Seq#Index| S i_5@@4))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| start end) (int_2_U i_5@@4)))
 :pattern ( (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_5@@4)))
 :pattern ( (|Seq#Index| S i_5@@4))
)) (=> (and (forall ((i_5@@5 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_5@@5)) (< NoPerm p_1)) (and (qpRange8 (|Seq#Index| S i_5@@5)) (= (invRecv8 (|Seq#Index| S i_5@@5)) i_5@@5)))
 :qid |stdinbpl.1079:22|
 :skolemid |105|
 :pattern ( (|Seq#Index| S i_5@@5))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| start end) (int_2_U i_5@@5)))
 :pattern ( (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_5@@5)))
 :pattern ( (|Seq#Index| S i_5@@5))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (=> (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U (invRecv8 o_3@@0))) (and (< NoPerm p_1) (qpRange8 o_3@@0))) (= (|Seq#Index| S (invRecv8 o_3@@0)) o_3@@0)))
 :qid |stdinbpl.1083:22|
 :skolemid |106|
 :pattern ( (invRecv8 o_3@@0))
))) (=> (and (and (forall ((o_3@@1 T@U) ) (!  (=> (= (type o_3@@1) RefType) (and (=> (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U (invRecv8 o_3@@1))) (and (< NoPerm p_1) (qpRange8 o_3@@1))) (and (= (|Seq#Index| S (invRecv8 o_3@@1)) o_3@@1) (= (U_2_real (MapType1Select QPMask@2 o_3@@1 f_7)) (- (U_2_real (MapType1Select QPMask@1 o_3@@1 f_7)) p_1)))) (=> (not (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U (invRecv8 o_3@@1))) (and (< NoPerm p_1) (qpRange8 o_3@@1)))) (= (U_2_real (MapType1Select QPMask@2 o_3@@1 f_7)) (U_2_real (MapType1Select QPMask@1 o_3@@1 f_7))))))
 :qid |stdinbpl.1089:22|
 :skolemid |107|
 :pattern ( (MapType1Select QPMask@2 o_3@@1 f_7))
)) (forall ((o_3@@2 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@2) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 f_7))) (= (U_2_real (MapType1Select QPMask@1 o_3@@2 f_5)) (U_2_real (MapType1Select QPMask@2 o_3@@2 f_5))))))
 :qid |stdinbpl.1095:29|
 :skolemid |108|
 :pattern ( (MapType1Select QPMask@2 o_3@@2 f_5))
))) (and (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 QPMask@2) (state ExhaleHeap@0 QPMask@2))) (and (=> (= (ControlFlow 0 19) (- 0 21)) (forall ((i1_4 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_4)) (dummyFunction (MapType0Select ExhaleHeap@0 (|Seq#Index| S i1_4) f_7))) (>= p_1 NoPerm))
 :qid |stdinbpl.1113:17|
 :skolemid |109|
 :pattern ( (|Seq#Index| S i1_4))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| start end) (int_2_U i1_4)))
 :pattern ( (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_4)))
 :pattern ( (|Seq#Index| S i1_4))
))) (=> (forall ((i1_4@@0 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_4@@0)) (dummyFunction (MapType0Select ExhaleHeap@0 (|Seq#Index| S i1_4@@0) f_7))) (>= p_1 NoPerm))
 :qid |stdinbpl.1113:17|
 :skolemid |109|
 :pattern ( (|Seq#Index| S i1_4@@0))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| start end) (int_2_U i1_4@@0)))
 :pattern ( (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_4@@0)))
 :pattern ( (|Seq#Index| S i1_4@@0))
)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((i1_4@@1 Int) (i1_4_1 Int) ) (!  (=> (and (and (and (and (not (= i1_4@@1 i1_4_1)) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_4@@1))) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_4_1))) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index| S i1_4@@1) (|Seq#Index| S i1_4_1))))
 :qid |stdinbpl.1120:17|
 :skolemid |110|
 :pattern ( (neverTriggered6 i1_4@@1) (neverTriggered6 i1_4_1))
))) (=> (forall ((i1_4@@2 Int) (i1_4_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i1_4@@2 i1_4_1@@0)) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_4@@2))) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_4_1@@0))) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index| S i1_4@@2) (|Seq#Index| S i1_4_1@@0))))
 :qid |stdinbpl.1120:17|
 :skolemid |110|
 :pattern ( (neverTriggered6 i1_4@@2) (neverTriggered6 i1_4_1@@0))
)) (=> (= (ControlFlow 0 19) (- 0 18)) (forall ((i1_4@@3 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_4@@3)) (>= (U_2_real (MapType1Select QPMask@2 (|Seq#Index| S i1_4@@3) f_7)) p_1))
 :qid |stdinbpl.1127:17|
 :skolemid |111|
 :pattern ( (|Seq#Index| S i1_4@@3))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| start end) (int_2_U i1_4@@3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_4@@3)))
 :pattern ( (|Seq#Index| S i1_4@@3))
)))))))))))))))))
(let ((anon30_Else_correct  (and (=> (= (ControlFlow 0 30) (- 0 32)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_3))) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_3_1))) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index| S i_3) (|Seq#Index| S i_3_1))))
 :qid |stdinbpl.997:15|
 :skolemid |95|
))) (=> (forall ((i_3@@0 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@0 i_3_1@@0)) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_3@@0))) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_3_1@@0))) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index| S i_3@@0) (|Seq#Index| S i_3_1@@0))))
 :qid |stdinbpl.997:15|
 :skolemid |95|
)) (=> (and (forall ((i_3@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_3@@1)) (< NoPerm p_1)) (and (qpRange7 (|Seq#Index| S i_3@@1)) (= (invRecv7 (|Seq#Index| S i_3@@1)) i_3@@1)))
 ...
 :pattern ( (|Seq#Index| S i_3@@1))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U (invRecv7 o_3@@3))) (< NoPerm p_1)) (qpRange7 o_3@@3)) (= (|Seq#Index| S (invRecv7 o_3@@3)) o_3@@3)))
 :qid |stdinbpl.1007:22|
 :skolemid |97|
 :pattern ( (invRecv7 o_3@@3))
))) (and (=> (= (ControlFlow 0 30) (- 0 31)) (forall ((i_3@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_3@@2)) (>= p_1 NoPerm))
 ...
 :pattern ( (|Seq#Index| S i_3@@2))
))) (=> (forall ((i_3@@3 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_3@@3)) (>= p_1 NoPerm))
 :qid |stdinbpl.1013:15|
 :skolemid |98|
 ...
 :pattern ( (|Seq#Index| S i_3@@3))
)) (=> (and (forall ((i_3@@4 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_3@@4)) (> p_1 NoPerm)) (not (= (|Seq#Index| S i_3@@4) null)))
 ...
 :pattern ( (|Seq#Index| S i_3@@4))
)) (forall ((o_3@@4 T@U) ) (!  (=> (= (type o_3@@4) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U (invRecv7 o_3@@4))) (< NoPerm p_1)) (qpRange7 o_3@@4)) (and (=> (< NoPerm p_1) (= (|Seq#Index| S (invRecv7 o_3@@4)) o_3@@4)) (= (U_2_real (MapType1Select QPMask@1 o_3@@4 f_7)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@4 f_7)) p_1)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U (invRecv7 o_3@@4))) (< NoPerm p_1)) (qpRange7 o_3@@4))) (= (U_2_real (MapType1Select QPMask@1 o_3@@4 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@4 f_7))))))
...
)) (state Heap@@9 QPMask@1)) (and (state Heap@@9 QPMask@1) (state Heap@@9 QPMask@1))) (and (and (=> (= (ControlFlow 0 30) 19) anon32_Else_correct) (=> (= (ControlFlow 0 30) 26) anon33_Then_correct)) (=> (= (ControlFlow 0 30) 29) anon33_Else_correct)))))))))))
(let ((anon17_correct true))
(let ((anon31_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_4))) (= (ControlFlow 0 17) 13)) anon17_correct)))
(let ((anon31_Then_correct  (=> (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_4)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< i_4 (|Seq#Length| S))) (=> (< i_4 (|Seq#Length| S)) (=> (= (ControlFlow 0 14) 13) anon17_correct))))))))
(let ((anon25_Else_correct  (and (=> (= (ControlFlow 0 42) (- 0 44)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_1_1))) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index| S i_1) (|Seq#Index| S i_1_1))))
 :qid |stdinbpl.874:15|
 :skolemid |81|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_1@@0))) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_1_1@@0))) (< NoPerm p_1)) (< NoPerm p_1)) (not (= (|Seq#Index| S i_1@@0) (|Seq#Index| S i_1_1@@0))))
 :qid |stdinbpl.874:15|
 :skolemid |81|
)) (=> (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_1@@1)) (< NoPerm p_1)) (and (qpRange4 (|Seq#Index| S i_1@@1)) (= (invRecv4 (|Seq#Index| S i_1@@1)) i_1@@1)))
 :qid |stdinbpl.880:22|
 :skolemid |82|
 :pattern ( (|Seq#Index| S i_1@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| start end) (int_2_U i_1@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_1@@1)))
 :pattern ( (|Seq#Index| S i_1@@1))
)) (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U (invRecv4 o_3@@6))) (< NoPerm p_1)) (qpRange4 o_3@@6)) (= (|Seq#Index| S (invRecv4 o_3@@6)) o_3@@6)))
 :qid |stdinbpl.884:22|
 :skolemid |83|
 :pattern ( (invRecv4 o_3@@6))
))) (and (=> (= (ControlFlow 0 42) (- 0 43)) (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_1@@2)) (>= p_1 NoPerm))
 :qid |stdinbpl.890:15|
 :skolemid |84|
 :pattern ( (|Seq#Index| S i_1@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| start end) (int_2_U i_1@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_1@@2)))
 :pattern ( (|Seq#Index| S i_1@@2))
))) (=> (forall ((i_1@@3 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_1@@3)) (>= p_1 NoPerm))
 :qid |stdinbpl.890:15|
 :skolemid |84|
 :pattern ( (|Seq#Index| S i_1@@3))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| start end) (int_2_U i_1@@3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_1@@3)))
 :pattern ( (|Seq#Index| S i_1@@3))
)) (=> (forall ((i_1@@4 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_1@@4)) (> p_1 NoPerm)) (not (= (|Seq#Index| S i_1@@4) null)))
 :qid |stdinbpl.896:22|
 :skolemid |85|
 :pattern ( (|Seq#Index| S i_1@@4))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| start end) (int_2_U i_1@@4)))
 :pattern ( (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_1@@4)))
 :pattern ( (|Seq#Index| S i_1@@4))
)) (=> (and (and (forall ((o_3@@7 T@U) ) (!  (=> (= (type o_3@@7) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U (invRecv4 o_3@@7))) (< NoPerm p_1)) (qpRange4 o_3@@7)) (and (=> (< NoPerm p_1) (= (|Seq#Index| S (invRecv4 o_3@@7)) o_3@@7)) (= (U_2_real (MapType1Select QPMask@0 o_3@@7 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@7 f_7)) p_1)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U (invRecv4 o_3@@7))) (< NoPerm p_1)) (qpRange4 o_3@@7))) (= (U_2_real (MapType1Select QPMask@0 o_3@@7 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@7 f_7))))))
 :qid |stdinbpl.902:22|
 :skolemid |86|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (and (and (=> (= (ControlFlow 0 42) 41) anon27_Then_correct) (=> (= (ControlFlow 0 42) 30) anon30_Else_correct)) (=> (= (ControlFlow 0 42) 14) anon31_Then_correct)) (=> (= (ControlFlow 0 42) 17) anon31_Else_correct)))))))))))
(let ((anon7_correct true))
(let ((anon26_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_2))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon26_Then_correct  (=> (|Seq#Contains| (|Seq#Range| start end) (int_2_U i_2)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_2 (|Seq#Length| S))) (=> (< i_2 (|Seq#Length| S)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon23_Else_correct  (=> (and (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_1)) (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U i2_1)) (not (= i1_1 i2_1)))) (not (= (|Seq#Index| S i1_1) (|Seq#Index| S i2_1))))
 :qid |stdinbpl.856:20|
 :skolemid |80|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| start end) (int_2_U i1_1)) (|Seq#ContainsTrigger| (|Seq#Range| start end) (int_2_U i2_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| start end) (int_2_U i1_1)) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i2_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_1)) (|Seq#ContainsTrigger| (|Seq#Range| start end) (int_2_U i2_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_1)) (|Seq#Contains| (|Seq#Range| start end) (int_2_U i2_1)))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| start end) (int_2_U i1_1)) (|Seq#Index| S i2_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_1)) (|Seq#Index| S i2_1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| start end) (int_2_U i2_1)) (|Seq#Index| S i1_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| start end) (int_2_U i2_1)) (|Seq#Index| S i1_1))
 :pattern ( (|Seq#Index| S i1_1) (|Seq#Index| S i2_1))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 45) 42) anon25_Else_correct) (=> (= (ControlFlow 0 45) 9) anon26_Then_correct)) (=> (= (ControlFlow 0 45) 12) anon26_Else_correct)))))
(let ((anon3_correct true))
(let ((anon24_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_5)) (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U i2_2)) (not (= i1_5 i2_2))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon24_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U i1_5)) (and (|Seq#Contains| (|Seq#Range| start end) (int_2_U i2_2)) (not (= i1_5 i2_2)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_5 0)) (=> (>= i1_5 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_5 (|Seq#Length| S))) (=> (< i1_5 (|Seq#Length| S)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_2 0)) (=> (>= i2_2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_2 (|Seq#Length| S))) (=> (< i2_2 (|Seq#Length| S)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (<= 0 start) (<= start end)) (=> (and (and (<= end (|Seq#Length| S)) (state Heap@@9 ZeroMask)) (and (< NoPerm p_1) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 46) 45) anon23_Else_correct) (=> (= (ControlFlow 0 46) 2) anon24_Then_correct)) (=> (= (ControlFlow 0 46) 7) anon24_Else_correct)))))))
