...
(assert  (and (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type diz) RefType)) (= (type __flatten_11) RefType)) (= (type freshObj@0) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id Exercise4__Exercise4)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (and (U_2_bool (MapType0Select Heap@@9 diz $allocated)) (U_2_bool (MapType0Select Heap@@9 __flatten_11 $allocated))) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@9 freshObj@0 $allocated)))) (and (= Heap@0 (MapType0Store Heap@@9 freshObj@0 $allocated (bool_2_U true))) (= Mask@0 (MapType1Store ZeroMask freshObj@0 Exercise4__Integer_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 Exercise4__Integer_value)) FullPerm)))))) (and (and (state Heap@0 Mask@0) (state Heap@0 Mask@0)) (and (state Heap@0 Mask@0) (= (ControlFlow 0 3) (- 0 4))))) (not (= freshObj@0 null))))))
