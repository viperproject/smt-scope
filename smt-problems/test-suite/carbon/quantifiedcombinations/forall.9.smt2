...
(assert  (and (and (and (and (= (type xs) (SeqType RefType)) (= (type Heap@@10) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (forall ((arg0@@37 T@U) ) (! (= (type (invRecv4 arg0@@37)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((x_5 T@U) (x_5_1 T@U) ) (!  (=> (and (= (type x_5) RefType) (= (type x_5_1) RefType)) (=> (and (and (and (and (not (= x_5 x_5_1)) (|Seq#Contains| xs x_5)) (|Seq#Contains| xs x_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_5 x_5_1))))
...
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_8 T@U) (x_8_2 T@U) ) (!  (=> (and (= (type x_8) RefType) (= (type x_8_2) RefType)) (=> (and (and (and (and (not (= x_8 x_8_2)) (|Seq#Contains| xs x_8)) (|Seq#Contains| xs x_8_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_8 x_8_2))))
 :qid |stdinbpl.1059:17|
 :skolemid |94|
 :pattern ( (neverTriggered6 x_8) (neverTriggered6 x_8_2))
 ...
 :qid |stdinbpl.1059:17|
 :skolemid |94|
 :pattern ( (neverTriggered6 x_8@@0) (neverTriggered6 x_8_2@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_8@@1 T@U) ) (!  (=> (and (= (type x_8@@1) RefType) (|Seq#Contains| xs x_8@@1)) (>= (U_2_real (MapType1Select QPMask@0 null (pred x_8@@1))) FullPerm))
 :qid |stdinbpl.1066:17|
 :skolemid |95|
 :pattern ( (MapType0Select Heap@@10 null (pred x_8@@1)))
 :pattern ( (MapType1Select QPMask@0 null (pred x_8@@1)))
...
)) (=> (and (forall ((x_2_1 T@U) ) (!  (=> (= (type x_2_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv4 x_2_1)) (< NoPerm FullPerm)) (qpRange4 x_2_1)) (= (invRecv4 x_2_1) x_2_1)))
 :qid |stdinbpl.969:22|
 :skolemid |84|
 :pattern ( (invRecv4 x_2_1))
)) (forall ((x_2_1@@0 T@U) ) (!  (=> (= (type x_2_1@@0) RefType) (=> (and (and (|Seq#Contains| xs (invRecv4 x_2_1@@0)) (< NoPerm FullPerm)) (qpRange4 x_2_1@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv4 x_2_1@@0) x_2_1@@0)) (= (U_2_real (MapType1Select QPMask@0 null (pred x_2_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (pred x_2_1@@0))) FullPerm)))))
 :qid |stdinbpl.975:22|
 :skolemid |85|
...
)) (forall ((x_2_1@@1 T@U) ) (!  (=> (and (= (type x_2_1@@1) RefType) (not (and (and (|Seq#Contains| xs (invRecv4 x_2_1@@1)) (< NoPerm FullPerm)) (qpRange4 x_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (pred x_2_1@@1))) (U_2_real (MapType1Select ZeroMask null (pred x_2_1@@1)))))
 :qid |stdinbpl.985:22|
 :skolemid |87|
