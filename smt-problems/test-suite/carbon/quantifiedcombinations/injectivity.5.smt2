...
(declare-fun y@@2 () T@U)
(assert  (and (and (and (and (and (and (= (type xs) (SeqType RefType)) (= (type Heap@@11) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@39 T@U) ) (! (= (type (invRecv20 arg0@@39)) RefType)
...
(set-info :boogie-vc-id test03_2)
...
)) (=> (= (ControlFlow 0 5) (- 0 4)) (forall ((x_5@@1 T@U) ) (!  (=> (and (= (type x_5@@1) RefType) (|Seq#Contains| xs x_5@@1)) (>= (U_2_real (MapType1Select QPMask@1 null (pred2 x_5@@1 1))) FullPerm))
 :qid |stdinbpl.1822:17|
 :skolemid |195|
 :pattern ( (MapType0Select Heap@@11 null (pred2 x_5@@1 1)))
 :pattern ( (MapType1Select QPMask@1 null (pred2 x_5@@1 1)))
...
)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((x_3@@1 T@U) ) (!  (=> (and (= (type x_3@@1) RefType) (|Seq#Contains| xs x_3@@1)) (>= (U_2_real (MapType1Select QPMask@0 x_3@@1 f_7)) FullPerm))
 :qid |stdinbpl.1776:17|
 :skolemid |189|
 :pattern ( (MapType0Select Heap@@11 x_3@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 x_3@@1 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs x_3@@1))
 :pattern ( (|Seq#Contains| xs x_3@@1))
))) (=> (forall ((x_3@@2 T@U) ) (!  (=> (and (= (type x_3@@2) RefType) (|Seq#Contains| xs x_3@@2)) (>= (U_2_real (MapType1Select QPMask@0 x_3@@2 f_7)) FullPerm))
 :qid |stdinbpl.1776:17|
 :skolemid |189|
 :pattern ( (MapType0Select Heap@@11 x_3@@2 f_7))
 :pattern ( (MapType1Select QPMask@1 x_3@@2 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs x_3@@2))
 :pattern ( (|Seq#Contains| xs x_3@@2))
)) (=> (and (and (forall ((x_3@@3 T@U) ) (!  (=> (= (type x_3@@3) RefType) (=> (and (|Seq#Contains| xs x_3@@3) (< NoPerm FullPerm)) (and (qpRange20 x_3@@3) (= (invRecv20 x_3@@3) x_3@@3))))
 :qid |stdinbpl.1782:22|
 :skolemid |190|
 :pattern ( (MapType0Select Heap@@11 x_3@@3 f_7))
 :pattern ( (MapType1Select QPMask@1 x_3@@3 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs x_3@@3))
 :pattern ( (|Seq#Contains| xs x_3@@3))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (|Seq#Contains| xs (invRecv20 o_3)) (and (< NoPerm FullPerm) (qpRange20 o_3))) (= (invRecv20 o_3) o_3)))
 :qid |stdinbpl.1786:22|
 :skolemid |191|
 :pattern ( (invRecv20 o_3))
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (|Seq#Contains| xs (invRecv20 o_3@@0)) (and (< NoPerm FullPerm) (qpRange20 o_3@@0))) (and (= (invRecv20 o_3@@0) o_3@@0) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (- (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (|Seq#Contains| xs (invRecv20 o_3@@0)) (and (< NoPerm FullPerm) (qpRange20 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7))))))
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| xs x_1@@1) (< NoPerm FullPerm)) (and (qpRange19 x_1@@1) (= (invRecv19 x_1@@1) x_1@@1))))
...
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (|Seq#Contains| xs (invRecv19 o_3@@2)) (< NoPerm FullPerm)) (qpRange19 o_3@@2)) (= (invRecv19 o_3@@2) o_3@@2)))
 :qid |stdinbpl.1723:22|
 :skolemid |184|
 :pattern ( (invRecv19 o_3@@2))
)) (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (|Seq#Contains| xs x_1@@2)) (not (= x_1@@2 null)))
 :qid |stdinbpl.1729:22|
 :skolemid |185|
...
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (|Seq#Contains| xs (invRecv19 o_3@@3)) (< NoPerm FullPerm)) (qpRange19 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv19 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| xs (invRecv19 o_3@@3)) (< NoPerm FullPerm)) (qpRange19 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@3 f_7))))))
