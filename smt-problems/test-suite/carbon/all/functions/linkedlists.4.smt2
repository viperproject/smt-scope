...
(assert  (and (and (and (and (and (= (type Heap@@47) (MapType0Type RefType)) (= (type xs@@42) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |list#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (= (MapType0Select Heap@@47 xs@@42 next) null) (=> (and (= Mask@3 Mask@1) (= (ControlFlow 0 5) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (not (= (MapType0Select Heap@@47 xs@@42 next) null)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@1 xs@@42 next)) (=> (HasDirectPerm Mask@1 xs@@42 next) (=> (and (= Mask@2 (MapType1Store Mask@1 null (list (MapType0Select Heap@@47 xs@@42 next)) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (list (MapType0Select Heap@@47 xs@@42 next)))) FullPerm)))) (state Heap@@47 Mask@2)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@2 xs@@42 next)) (=> (HasDirectPerm Mask@2 xs@@42 next) (=> (not (= (MapType0Select Heap@@47 xs@@42 next) null)) (=> (and (= Mask@3 Mask@2) (= (ControlFlow 0 2) 1)) anon2_correct))))))))))
(let ((anon0_correct  (=> (state Heap@@47 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@47 xs@@42 $allocated))) (and (not (= xs@@42 null)) (= Mask@0 (MapType1Store ZeroMask xs@@42 next (real_2_U (+ (U_2_real (MapType1Select ZeroMask xs@@42 next)) FullPerm)))))) (and (and (state Heap@@47 Mask@0) (not (= xs@@42 null))) (and (= Mask@1 (MapType1Store Mask@0 xs@@42 val (real_2_U (+ (U_2_real (MapType1Select Mask@0 xs@@42 val)) FullPerm)))) (state Heap@@47 Mask@1)))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm Mask@1 xs@@42 next)) (=> (HasDirectPerm Mask@1 xs@@42 next) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))))
