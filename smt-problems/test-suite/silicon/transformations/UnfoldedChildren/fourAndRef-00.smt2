...
; [eval] fourAnd(false, false, false, false)
(push) ; 3
(assert (fourAnd%precondition $Snap.unit false false false false))
(pop) ; 3
; Joined path conditions
(assert (fourAnd%precondition $Snap.unit false false false false))
(declare-const r@4@01 Bool)
(assert (= r@4@01 (fourAnd $Snap.unit false false false false)))
; [exec]
; assert !r
; [eval] !r
(push) ; 3
...
(assert (= r@5@01 (fourAnd $Snap.unit false false false false)))
; [exec]
; assert !r
; [eval] !r
(push) ; 3
