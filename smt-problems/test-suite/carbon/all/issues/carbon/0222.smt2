...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (and (state Heap@@13 ZeroMask) (U_2_bool (MapType0Select Heap@@13 x@@12 $allocated))) (and (= AssumeFunctionsAbove 0) (not (= x@@12 null)))) (and (and (= Mask@0 (MapType1Store ZeroMask x@@12 val (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@12 val)) FullPerm)))) (state Heap@@13 Mask@0)) (and (state Heap@@13 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm Mask@0 x@@12 val))))
