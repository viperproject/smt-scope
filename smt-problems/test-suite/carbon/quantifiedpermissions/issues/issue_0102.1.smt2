...
(let ((anon18_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_7))) (= (ControlFlow 0 20) 16)) anon11_correct)))
(let ((anon18_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_7)) (and (=> (= (ControlFlow 0 17) (- 0 19)) (>= i_7 0)) (=> (>= i_7 0) (and (=> (= (ControlFlow 0 17) (- 0 18)) (< i_7 (|Seq#Length| xs))) (=> (< i_7 (|Seq#Length| xs)) (=> (= (ControlFlow 0 17) 16) anon11_correct))))))))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_3) (|Seq#Index| xs i_3_1))))
 :qid |stdinbpl.740:17|
 :skolemid |65|
...
)) (=> (= (ControlFlow 0 14) (- 0 13)) (forall ((i_3@@1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@1)) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs i_3@@1) f_7)) FullPerm))
 :qid |stdinbpl.747:17|
 :skolemid |66|
...
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_1) (|Seq#Index| xs i_1_1))))
 :qid |stdinbpl.681:15|
 :skolemid |59|
 ...
 :qid |stdinbpl.681:15|
 :skolemid |59|
)) (=> (and (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index| xs i_1@@1)) (= (invRecv1 (|Seq#Index| xs i_1@@1)) i_1@@1)))
 :qid |stdinbpl.687:22|
 :skolemid |60|
 ...
 :pattern ( (|Seq#Index| xs i_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (|Seq#Index| xs (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.691:22|
 :skolemid |61|
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0)))) (and (and (=> (= (ControlFlow 0 21) 14) anon17_Else_correct) (=> (= (ControlFlow 0 21) 17) anon18_Then_correct)) (=> (= (ControlFlow 0 21) 20) anon18_Else_correct)))))))
(let ((anon7_correct true))
(let ((anon16_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i@@6))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon16_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i@@6)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i@@6 (|Seq#Length| xs))) (=> (< i@@6 (|Seq#Length| xs)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
...
)) (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 23) 21) anon15_Else_correct) (=> (= (ControlFlow 0 23) 9) anon16_Then_correct)) (=> (= (ControlFlow 0 23) 12) anon16_Else_correct))))))
(let ((anon3_correct true))
(let ((anon14_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i1)) (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i2)) (not (= i1 i2))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
...
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (= (|Seq#Length| xs) n@@13) (state Heap@@9 ZeroMask)) (and (> n@@13 2) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 24) 23) anon13_Else_correct) (=> (= (ControlFlow 0 24) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 24) 7) anon14_Else_correct))))))
