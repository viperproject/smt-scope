...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type held) (FieldType NormalFieldType intType))))
(assert (distinct $allocated held)
)
...
(assert (forall ((Heap@@2 T@U) (this T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type this) RefType)) (dummyFunction (real_2_U (|level#triggerStateless| this))))
 :qid |stdinbpl.197:15|
 :skolemid |23|
 :pattern ( (|level'| Heap@@2 this))
)))
...
(assert (forall ((Heap@@4 T@U) (this@@0 T@U) ) (!  (=> (and (= (type Heap@@4) (MapType0Type RefType)) (= (type this@@0) RefType)) (and (= (level Heap@@4 this@@0) (|level'| Heap@@4 this@@0)) (dummyFunction (real_2_U (|level#triggerStateless| this@@0)))))
 :qid |stdinbpl.193:15|
 :skolemid |22|
 :pattern ( (level Heap@@4 this@@0))
)))
...
(assert (forall ((Heap@@9 T@U) (Mask@@9 T@U) (this@@1 T@U) ) (!  (=> (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (= (type this@@1) RefType)) (state Heap@@9 Mask@@9)) (= (|level'| Heap@@9 this@@1) (|level#frame| EmptyFrame this@@1)))
 :qid |stdinbpl.204:15|
 :skolemid |24|
 :pattern ( (state Heap@@9 Mask@@9) (|level'| Heap@@9 this@@1))
)))
...
(assert  (and (and (and (and (and (and (= (type x@@8) RefType) (= (type x$0) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@12) (MapType0Type RefType))) (= (type to) RefType)) (= (type x$1) RefType)) (= (type this@@2) RefType)))
...
(let ((anon37_Then_correct  (=> (HasDirectPerm Mask@0 x$1 held) (and (=> (= (ControlFlow 0 21) (- 0 22)) (HasDirectPerm Mask@0 x$1 held)) (=> (HasDirectPerm Mask@0 x$1 held) (and (and (=> (= (ControlFlow 0 21) 19) anon38_Then_correct) (=> (= (ControlFlow 0 21) 20) anon39_Then_correct)) (=> (= (ControlFlow 0 21) 17) anon24_correct)))))))
(let ((anon37_Else_correct  (=> (and (not (HasDirectPerm Mask@0 x$1 held)) (= (ControlFlow 0 18) 17)) anon24_correct)))
(let ((anon36_Else_correct  (=> (= (ControlFlow 0 16) (- 0 15)) (forall ((x$1_1 T@U) ) (!  (=> (and (= (type x$1_1) RefType) (HasDirectPerm Mask@0 x$1_1 held)) (< (level Heap@@12 x$1_1) (level Heap@@12 to)))
 :qid |stdinbpl.353:15|
 :skolemid |27|
 :pattern ( (MapType1Select Mask@0 x$1_1 held))
 :pattern ( (MapType0Select Heap@@12 x$1_1 held))
)))))
(let ((anon32_Else_correct  (and (=> (= (ControlFlow 0 23) (- 0 24)) (forall ((x$0_1 T@U) ) (!  (=> (and (= (type x$0_1) RefType) (HasDirectPerm ZeroMask x$0_1 held)) (< (level Heap@@12 x$0_1) (level Heap@@12 this@@2)))
 :qid |stdinbpl.318:15|
 :skolemid |26|
 :pattern ( (MapType1Select ZeroMask x$0_1 held))
 :pattern ( (MapType0Select Heap@@12 x$0_1 held))
))) (=> (forall ((x$0_1@@0 T@U) ) (!  (=> (and (= (type x$0_1@@0) RefType) (HasDirectPerm ZeroMask x$0_1@@0 held)) (< (level Heap@@12 x$0_1@@0) (level Heap@@12 this@@2)))
 :qid |stdinbpl.318:15|
 :skolemid |26|
 :pattern ( (MapType1Select ZeroMask x$0_1@@0 held))
 :pattern ( (MapType0Select Heap@@12 x$0_1@@0 held))
)) (=> (and (state Heap@@12 ZeroMask) (not (= this@@2 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask this@@2 held (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@2 held)) FullPerm)))) (state Heap@@12 Mask@0)) (and (state Heap@@12 Mask@0) (state Heap@@12 Mask@0))) (and (and (=> (= (ControlFlow 0 23) 16) anon36_Else_correct) (=> (= (ControlFlow 0 23) 21) anon37_Then_correct)) (=> (= (ControlFlow 0 23) 18) anon37_Else_correct))))))))
(let ((anon35_Then_correct true))
(let ((anon34_Then_correct true))
(let ((anon17_correct true))
(let ((anon33_Then_correct  (=> (HasDirectPerm ZeroMask x$0 held) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm ZeroMask x$0 held)) (=> (HasDirectPerm ZeroMask x$0 held) (and (and (=> (= (ControlFlow 0 13) 11) anon34_Then_correct) (=> (= (ControlFlow 0 13) 12) anon35_Then_correct)) (=> (= (ControlFlow 0 13) 9) anon17_correct)))))))
(let ((anon33_Else_correct  (=> (and (not (HasDirectPerm ZeroMask x$0 held)) (= (ControlFlow 0 10) 9)) anon17_correct)))
(let ((anon31_Else_correct  (=> (< (level Heap@@12 this@@2) (level Heap@@12 to)) (=> (and (state Heap@@12 ZeroMask) (state Heap@@12 ZeroMask)) (and (and (=> (= (ControlFlow 0 25) 23) anon32_Else_correct) (=> (= (ControlFlow 0 25) 13) anon33_Then_correct)) (=> (= (ControlFlow 0 25) 10) anon33_Else_correct))))))
(let ((anon31_Then_correct true))
(let ((anon30_Then_correct true))
(let ((anon26_Else_correct  (=> (and (forall ((x_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (HasDirectPerm ZeroMask x_1 held)) (< (level Heap@@12 x_1) (level Heap@@12 this@@2)))
 :qid |stdinbpl.278:20|
 :skolemid |25|
 :pattern ( (MapType1Select ZeroMask x_1 held))
 :pattern ( (MapType0Select Heap@@12 x_1 held))
)) (state Heap@@12 ZeroMask)) (and (and (=> (= (ControlFlow 0 26) 7) anon30_Then_correct) (=> (= (ControlFlow 0 26) 8) anon31_Then_correct)) (=> (= (ControlFlow 0 26) 25) anon31_Else_correct)))))
(let ((anon29_Then_correct true))
(let ((anon28_Then_correct true))
(let ((anon6_correct true))
(let ((anon27_Then_correct  (=> (HasDirectPerm ZeroMask x@@8 held) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm ZeroMask x@@8 held)) (=> (HasDirectPerm ZeroMask x@@8 held) (and (and (=> (= (ControlFlow 0 5) 3) anon28_Then_correct) (=> (= (ControlFlow 0 5) 4) anon29_Then_correct)) (=> (= (ControlFlow 0 5) 1) anon6_correct)))))))
(let ((anon27_Else_correct  (=> (and (not (HasDirectPerm ZeroMask x@@8 held)) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (state Heap@@12 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@12 this@@2 $allocated))) (and (U_2_bool (MapType0Select Heap@@12 to $allocated)) (state Heap@@12 ZeroMask))) (and (and (=> (= (ControlFlow 0 27) 26) anon26_Else_correct) (=> (= (ControlFlow 0 27) 5) anon27_Then_correct)) (=> (= (ControlFlow 0 27) 2) anon27_Else_correct))))))
