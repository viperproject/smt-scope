...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type a_2) RefType)) (= (type b_2) RefType)) (= (type c) RefType)) (= (type d) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type _receiver0) RefType)) (= (type _target0) RefType)) (= (type _receiver1) RefType)) (= (type _target1) RefType)) (= (type _target0@0) RefType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type _target1@0) RefType)) (= (type Heap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test5)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 a_2 $allocated))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@10 b_2 $allocated)) (U_2_bool (MapType0Select Heap@@10 c $allocated))) (and (U_2_bool (MapType0Select Heap@@10 d $allocated)) (not (= a_2 null)))) (and (and (= Mask@0 (MapType1Store ZeroMask a_2 n (real_2_U (+ (U_2_real (MapType1Select ZeroMask a_2 n)) FullPerm)))) (state Heap@@10 Mask@0)) (and (not (= b_2 null)) (= Mask@1 (MapType1Store Mask@0 b_2 m (real_2_U (+ (U_2_real (MapType1Select Mask@0 b_2 m)) FullPerm))))))) (=> (and (and (and (and (state Heap@@10 Mask@1) (state Heap@@10 Mask@1)) (and (state Heap@@10 Mask@1) (U_2_bool (MapType0Select Heap@@10 _receiver0 $allocated)))) (and (and (U_2_bool (MapType0Select Heap@@10 _target0 $allocated)) (U_2_bool (MapType0Select Heap@@10 _receiver1 $allocated))) (and (U_2_bool (MapType0Select Heap@@10 _target1 $allocated)) (state Heap@@10 Mask@1)))) (and (and (and (state Heap@@10 Mask@1) (not (= _target0@0 null))) (and (= Mask@2 (MapType1Store Mask@1 _target0@0 n (real_2_U (+ (U_2_real (MapType1Select Mask@1 _target0@0 n)) FullPerm)))) (state Heap@@10 Mask@2))) (and (and (state Heap@@10 Mask@2) (U_2_bool (MapType0Select Heap@@10 _target0@0 $allocated))) (and (U_2_bool (MapType0Select Heap@@10 _target1@0 $allocated)) (state Heap@@10 Mask@2))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= FullPerm (U_2_real (MapType1Select Mask@2 a_2 n)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@2 a_2 n))) (=> (= Heap@0 (MapType0Store Heap@@10 a_2 n _target0@0)) (=> (and (state Heap@0 Mask@2) (= (ControlFlow 0 2) (- 0 1))) (= FullPerm (U_2_real (MapType1Select Mask@2 b_2 m))))))))))))
