...
(assert  (and (and (and (and (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type x_2) RefType)) (= (type y@@2) RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type z_2) RefType)) (forall ((arg0@@35 T@U) ) (! (= (type (invRecv3 arg0@@35)) RefType)
 :qid |funType:invRecv3|
 :pattern ( (invRecv3 arg0@@35))
))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@36 T@U) ) (! (= (type (invRecv2 arg0@@36)) RefType)
...
(let ((anon14_Else_correct  (=> (and (>= 0 (fun02 (U_2_int (MapType0Select Heap@@13 z_2 g)))) (= (ControlFlow 0 10) 6)) anon8_correct)))
(let ((anon14_Then_correct  (=> (> (fun02 (U_2_int (MapType0Select Heap@@13 z_2 g))) 0) (and (=> (= (ControlFlow 0 8) (- 0 9)) (HasDirectPerm QPMask@1 z_2 f_7)) (=> (HasDirectPerm QPMask@1 z_2 f_7) (=> (= (ControlFlow 0 8) 6) anon8_correct))))))
(let ((anon13_Then_correct  (=> (or (= z_2 x_2) (= z_2 y@@2)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm QPMask@1 z_2 g)) (=> (HasDirectPerm QPMask@1 z_2 g) (and (=> (= (ControlFlow 0 11) 8) anon14_Then_correct) (=> (= (ControlFlow 0 11) 10) anon14_Else_correct)))))))
(let ((anon13_Else_correct  (=> (and (not (or (= z_2 x_2) (= z_2 y@@2))) (= (ControlFlow 0 7) 6)) anon8_correct)))
(let ((anon12_Else_correct  (=> (forall ((z_5 T@U) ) (!  (=> (and (= (type z_5) RefType) (or (= z_5 x_2) (= z_5 y@@2))) (and (> (fun02 (U_2_int (MapType0Select Heap@@13 z_5 g))) 0) (> (fun02 (U_2_int (MapType0Select Heap@@13 z_5 f_7))) 0)))
 :qid |stdinbpl.968:20|
 :skolemid |81|
 :pattern ( (MapType0Select Heap@@13 z_5 f_7))
)) (=> (and (state Heap@@13 QPMask@1) (state Heap@@13 QPMask@1)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm QPMask@1 x_2 g)) (=> (HasDirectPerm QPMask@1 x_2 g) (=> (= (ControlFlow 0 4) (- 0 3)) (> (fun02 (U_2_int (MapType0Select Heap@@13 x_2 g))) 0))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((z_3 T@U) (z_3_1 T@U) ) (!  (=> (and (= (type z_3) RefType) (= (type z_3_1) RefType)) (=> (and (and (and (and (not (= z_3 z_3_1)) (or (= z_3 x_2) (= z_3 y@@2))) (or (= z_3_1 x_2) (= z_3_1 y@@2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_3 z_3_1))))
 :qid |stdinbpl.911:15|
 :skolemid |75|
 :no-pattern (type z_3)
...
))) (=> (forall ((z_3@@0 T@U) (z_3_1@@0 T@U) ) (!  (=> (and (= (type z_3@@0) RefType) (= (type z_3_1@@0) RefType)) (=> (and (and (and (and (not (= z_3@@0 z_3_1@@0)) (or (= z_3@@0 x_2) (= z_3@@0 y@@2))) (or (= z_3_1@@0 x_2) (= z_3_1@@0 y@@2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_3@@0 z_3_1@@0))))
 :qid |stdinbpl.911:15|
 :skolemid |75|
...
)) (=> (and (and (forall ((z_3@@1 T@U) ) (!  (=> (= (type z_3@@1) RefType) (=> (and (or (= z_3@@1 x_2) (= z_3@@1 y@@2)) (< NoPerm FullPerm)) (and (qpRange3 z_3@@1) (= (invRecv3 z_3@@1) z_3@@1))))
 :qid |stdinbpl.917:22|
 :skolemid |76|
 :pattern ( (MapType0Select Heap@@13 z_3@@1 g))
 :pattern ( (MapType1Select QPMask@1 z_3@@1 g))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (or (= (invRecv3 o_3) x_2) (= (invRecv3 o_3) y@@2)) (< NoPerm FullPerm)) (qpRange3 o_3)) (= (invRecv3 o_3) o_3)))
 :qid |stdinbpl.921:22|
 :skolemid |77|
 :pattern ( (invRecv3 o_3))
))) (and (forall ((z_3@@2 T@U) ) (!  (=> (and (= (type z_3@@2) RefType) (or (= z_3@@2 x_2) (= z_3@@2 y@@2))) (not (= z_3@@2 null)))
 :qid |stdinbpl.927:22|
 :skolemid |78|
 :pattern ( (MapType0Select Heap@@13 z_3@@2 g))
 :pattern ( (MapType1Select QPMask@1 z_3@@2 g))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (or (= (invRecv3 o_3@@0) x_2) (= (invRecv3 o_3@@0) y@@2)) (< NoPerm FullPerm)) (qpRange3 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv3 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 g)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@0 g)) FullPerm)))) (=> (not (and (and (or (= (invRecv3 o_3@@0) x_2) (= (invRecv3 o_3@@0) y@@2)) (< NoPerm FullPerm)) (qpRange3 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 g)) (U_2_real (MapType1Select QPMask@0 o_3@@0 g))))))
 :qid |stdinbpl.933:22|
 :skolemid |79|
...
)) (state Heap@@13 QPMask@1)) (and (state Heap@@13 QPMask@1) (state Heap@@13 QPMask@1))) (and (and (not (= x_2 null)) (not (= y@@2 null))) (and (state Heap@@13 QPMask@1) (state Heap@@13 QPMask@1)))) (and (and (=> (= (ControlFlow 0 13) 4) anon12_Else_correct) (=> (= (ControlFlow 0 13) 11) anon13_Then_correct)) (=> (= (ControlFlow 0 13) 7) anon13_Else_correct))))))))
(let ((anon11_Then_correct true))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (or (= z_1 x_2) (= z_1 y@@2))) (or (= z_1_1 x_2) (= z_1_1 y@@2))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1))))
 :qid |stdinbpl.868:15|
 :skolemid |69|
 :no-pattern (type z_1)
...
)) (=> (and (and (and (forall ((z_1@@1 T@U) ) (!  (=> (= (type z_1@@1) RefType) (=> (and (or (= z_1@@1 x_2) (= z_1@@1 y@@2)) (< NoPerm FullPerm)) (and (qpRange2 z_1@@1) (= (invRecv2 z_1@@1) z_1@@1))))
 :qid |stdinbpl.874:22|
 :skolemid |70|
 :pattern ( (MapType0Select Heap@@13 z_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 z_1@@1 f_7))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (or (= (invRecv2 o_3@@2) x_2) (= (invRecv2 o_3@@2) y@@2)) (< NoPerm FullPerm)) (qpRange2 o_3@@2)) (= (invRecv2 o_3@@2) o_3@@2)))
 :qid |stdinbpl.878:22|
 :skolemid |71|
...
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (or (= (invRecv2 o_3@@3) x_2) (= (invRecv2 o_3@@3) y@@2)) (< NoPerm FullPerm)) (qpRange2 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv2 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (or (= (invRecv2 o_3@@3) x_2) (= (invRecv2 o_3@@3) y@@2)) (< NoPerm FullPerm)) (qpRange2 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@3 f_7))))))
 :qid |stdinbpl.890:22|
 :skolemid |73|
...
)) (state Heap@@13 QPMask@0)) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0)))) (and (=> (= (ControlFlow 0 15) 2) anon11_Then_correct) (=> (= (ControlFlow 0 15) 13) anon11_Else_correct)))))))
(let ((anon10_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@13 x_2 $allocated)) (U_2_bool (MapType0Select Heap@@13 y@@2 $allocated)))) (and (=> (= (ControlFlow 0 17) 1) anon10_Then_correct) (=> (= (ControlFlow 0 17) 15) anon10_Else_correct)))))
