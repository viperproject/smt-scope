...
(declare-fun t_1 () T@U)
(assert  (and (and (and (= (type s@@21) (SeqType intType)) (= (type ss@0) (SeqType intType))) (= (type Heap@@13) (MapType0Type RefType))) (= (type t_1) (SeqType intType))))
(set-info :boogie-vc-id test_append_left)
...
(let ((anon9_Then_correct  (=> (|Seq#Contains| s@@21 (int_2_U i_1)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (|Seq#Contains| (|Seq#Take| ss@0 (|Seq#Length| s@@21)) (int_2_U i_1))) (=> (|Seq#Contains| (|Seq#Take| ss@0 (|Seq#Length| s@@21)) (int_2_U i_1)) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
