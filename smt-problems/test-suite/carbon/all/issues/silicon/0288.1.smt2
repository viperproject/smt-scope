...
(declare-fun |g'| (T@U T@U) Bool)
(declare-fun |g#triggerStateless| (T@U) Bool)
(declare-fun len (T@U) Int)
(declare-fun |f#condqp1| (T@U T@U) Int)
(declare-fun |sk_f#condqp1| (Int Int) Int)
(declare-fun NoPerm () Real)
(declare-fun FullPerm () Real)
(declare-fun loc (T@U Int) T@U)
(declare-fun |g#condqp2| (T@U T@U) Int)
...
(declare-fun |g#frame| (T@U T@U) Bool)
...
(assert (forall ((Heap@@2 T@U) (a_3 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type a_3) ArrayDomainTypeType)) (dummyFunction (bool_2_U (|f#triggerStateless| a_3))))
 :qid |stdinbpl.250:15|
 :skolemid |25|
 :pattern ( (|f'| Heap@@2 a_3))
)))
(assert (forall ((Heap@@3 T@U) (a_3@@0 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type a_3@@0) ArrayDomainTypeType)) (dummyFunction (bool_2_U (|g#triggerStateless| a_3@@0))))
 :qid |stdinbpl.423:15|
 :skolemid |44|
 :pattern ( (|g'| Heap@@3 a_3@@0))
)))
...
(assert (forall ((Heap2Heap T@U) (Heap1Heap T@U) (a_3@@2 T@U) ) (!  (=> (and (and (and (= (type Heap2Heap) (MapType0Type RefType)) (= (type Heap1Heap) (MapType0Type RefType))) (= (type a_3@@2) ArrayDomainTypeType)) (and (=  (and (and (<= 0 (|sk_f#condqp1| (|f#condqp1| Heap2Heap a_3@@2) (|f#condqp1| Heap1Heap a_3@@2))) (< (|sk_f#condqp1| (|f#condqp1| Heap2Heap a_3@@2) (|f#condqp1| Heap1Heap a_3@@2)) (len a_3@@2))) (< NoPerm FullPerm))  (and (and (<= 0 (|sk_f#condqp1| (|f#condqp1| Heap2Heap a_3@@2) (|f#condqp1| Heap1Heap a_3@@2))) (< (|sk_f#condqp1| (|f#condqp1| Heap2Heap a_3@@2) (|f#condqp1| Heap1Heap a_3@@2)) (len a_3@@2))) (< NoPerm FullPerm))) (=> (and (and (<= 0 (|sk_f#condqp1| (|f#condqp1| Heap2Heap a_3@@2) (|f#condqp1| Heap1Heap a_3@@2))) (< (|sk_f#condqp1| (|f#condqp1| Heap2Heap a_3@@2) (|f#condqp1| Heap1Heap a_3@@2)) (len a_3@@2))) (< NoPerm FullPerm)) (= (U_2_int (MapType0Select Heap2Heap (loc a_3@@2 (|sk_f#condqp1| (|f#condqp1| Heap2Heap a_3@@2) (|f#condqp1| Heap1Heap a_3@@2))) val)) (U_2_int (MapType0Select Heap1Heap (loc a_3@@2 (|sk_f#condqp1| (|f#condqp1| Heap2Heap a_3@@2) (|f#condqp1| Heap1Heap a_3@@2))) val)))))) (= (|f#condqp1| Heap2Heap a_3@@2) (|f#condqp1| Heap1Heap a_3@@2)))
 :qid |stdinbpl.276:15|
 :skolemid |29|
 :pattern ( (|f#condqp1| Heap2Heap a_3@@2) (|f#condqp1| Heap1Heap a_3@@2) (succHeapTrans Heap2Heap Heap1Heap))
)))
(assert (forall ((Heap2Heap@@0 T@U) (Heap1Heap@@0 T@U) (a_3@@3 T@U) ) (!  (=> (and (and (and (= (type Heap2Heap@@0) (MapType0Type RefType)) (= (type Heap1Heap@@0) (MapType0Type RefType))) (= (type a_3@@3) ArrayDomainTypeType)) (and (=  (and (and (<= 0 (|sk_g#condqp2| (|g#condqp2| Heap2Heap@@0 a_3@@3) (|g#condqp2| Heap1Heap@@0 a_3@@3))) (< (|sk_g#condqp2| (|g#condqp2| Heap2Heap@@0 a_3@@3) (|g#condqp2| Heap1Heap@@0 a_3@@3)) (len a_3@@3))) (< NoPerm FullPerm))  (and (and (<= 0 (|sk_g#condqp2| (|g#condqp2| Heap2Heap@@0 a_3@@3) (|g#condqp2| Heap1Heap@@0 a_3@@3))) (< (|sk_g#condqp2| (|g#condqp2| Heap2Heap@@0 a_3@@3) (|g#condqp2| Heap1Heap@@0 a_3@@3)) (len a_3@@3))) (< NoPerm FullPerm))) (=> (and (and (<= 0 (|sk_g#condqp2| (|g#condqp2| Heap2Heap@@0 a_3@@3) (|g#condqp2| Heap1Heap@@0 a_3@@3))) (< (|sk_g#condqp2| (|g#condqp2| Heap2Heap@@0 a_3@@3) (|g#condqp2| Heap1Heap@@0 a_3@@3)) (len a_3@@3))) (< NoPerm FullPerm)) (= (U_2_int (MapType0Select Heap2Heap@@0 (loc a_3@@3 (|sk_g#condqp2| (|g#condqp2| Heap2Heap@@0 a_3@@3) (|g#condqp2| Heap1Heap@@0 a_3@@3))) val)) (U_2_int (MapType0Select Heap1Heap@@0 (loc a_3@@3 (|sk_g#condqp2| (|g#condqp2| Heap2Heap@@0 a_3@@3) (|g#condqp2| Heap1Heap@@0 a_3@@3))) val)))))) (= (|g#condqp2| Heap2Heap@@0 a_3@@3) (|g#condqp2| Heap1Heap@@0 a_3@@3)))
 :qid |stdinbpl.440:15|
 :skolemid |46|
 :pattern ( (|g#condqp2| Heap2Heap@@0 a_3@@3) (|g#condqp2| Heap1Heap@@0 a_3@@3) (succHeapTrans Heap2Heap@@0 Heap1Heap@@0))
)))
...
(assert (forall ((a_3@@4 T@U) (i_1 Int) ) (!  (=> (= (type a_3@@4) ArrayDomainTypeType) (and (= (first (loc a_3@@4 i_1)) a_3@@4) (= (second (loc a_3@@4 i_1)) i_1)))
 :qid |stdinbpl.220:15|
 :skolemid |22|
 :pattern ( (loc a_3@@4 i_1))
)))
...
(assert (forall ((Heap@@7 T@U) (a_3@@5 T@U) ) (!  (=> (and (= (type Heap@@7) (MapType0Type RefType)) (= (type a_3@@5) ArrayDomainTypeType)) (and (= (f_6@@0 Heap@@7 a_3@@5) (|f'| Heap@@7 a_3@@5)) (dummyFunction (bool_2_U (|f#triggerStateless| a_3@@5)))))
 :qid |stdinbpl.246:15|
 :skolemid |24|
 :pattern ( (f_6@@0 Heap@@7 a_3@@5))
)))
(assert (forall ((Heap@@8 T@U) (a_3@@6 T@U) ) (!  (=> (and (= (type Heap@@8) (MapType0Type RefType)) (= (type a_3@@6) ArrayDomainTypeType)) (and (= (g Heap@@8 a_3@@6) (|g'| Heap@@8 a_3@@6)) (dummyFunction (bool_2_U (|g#triggerStateless| a_3@@6)))))
 :qid |stdinbpl.419:15|
 :skolemid |43|
 :pattern ( (g Heap@@8 a_3@@6))
)))
...
(assert (forall ((Heap@@11 T@U) (Mask@@9 T@U) (a_3@@7 T@U) ) (!  (=> (and (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (= (type a_3@@7) ArrayDomainTypeType)) (and (state Heap@@11 Mask@@9) (< AssumeFunctionsAbove 0))) (= (f_6@@0 Heap@@11 a_3@@7) (forall ((k Int) ) (!  (=> (and (<= 0 k) (< k (len a_3@@7))) (g Heap@@11 a_3@@7))
 :qid |stdinbpl.258:79|
 :skolemid |26|
))))
 :qid |stdinbpl.256:15|
 :skolemid |27|
 :pattern ( (state Heap@@11 Mask@@9) (f_6@@0 Heap@@11 a_3@@7))
)))
(assert (forall ((arg0@@28 T@U) ) (! (= (type (FrameFragment arg0@@28)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@28))
)))
(assert (forall ((Heap@@12 T@U) (Mask@@10 T@U) (a_3@@8 T@U) ) (!  (=> (and (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type a_3@@8) ArrayDomainTypeType)) (state Heap@@12 Mask@@10)) (= (|f'| Heap@@12 a_3@@8) (|f#frame| (FrameFragment (int_2_U (|f#condqp1| Heap@@12 a_3@@8))) a_3@@8)))
 :qid |stdinbpl.266:15|
 :skolemid |28|
 :pattern ( (state Heap@@12 Mask@@10) (|f'| Heap@@12 a_3@@8))
)))
(assert (forall ((Heap@@13 T@U) (Mask@@11 T@U) (a_3@@9 T@U) ) (!  (=> (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (= (type a_3@@9) ArrayDomainTypeType)) (state Heap@@13 Mask@@11)) (= (|g'| Heap@@13 a_3@@9) (|g#frame| (FrameFragment (int_2_U (|g#condqp2| Heap@@13 a_3@@9))) a_3@@9)))
 :qid |stdinbpl.430:15|
 :skolemid |45|
 :pattern ( (state Heap@@13 Mask@@11) (|g'| Heap@@13 a_3@@9))
)))
...
(declare-fun a_3@@10 () T@U)
(declare-fun QPMask@0 () T@U)
(declare-fun k_1 () Int)
(declare-fun qpRange1 (T@U) Bool)
(declare-fun invRecv1 (T@U) Int)
(declare-fun Heap@@16 () T@U)
(assert  (and (and (= (type a_3@@10) ArrayDomainTypeType) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@@16) (MapType0Type RefType))))
(set-info :boogie-vc-id |f#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon11_Then_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((x_5 Int) (x_5_1 Int) ) (!  (=> (and (and (and (and (not (= x_5 x_5_1)) (and (<= 0 x_5) (< x_5 (len a_3@@10)))) (and (<= 0 x_5_1) (< x_5_1 (len a_3@@10)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@10 x_5) (loc a_3@@10 x_5_1))))
 :qid |stdinbpl.360:25|
 :skolemid |36|
 :pattern ( (neverTriggered2 x_5) (neverTriggered2 x_5_1))
))) (=> (forall ((x_5@@0 Int) (x_5_1@@0 Int) ) (!  (=> (and (and (and (and (not (= x_5@@0 x_5_1@@0)) (and (<= 0 x_5@@0) (< x_5@@0 (len a_3@@10)))) (and (<= 0 x_5_1@@0) (< x_5_1@@0 (len a_3@@10)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@10 x_5@@0) (loc a_3@@10 x_5_1@@0))))
 :qid |stdinbpl.360:25|
 :skolemid |36|
 :pattern ( (neverTriggered2 x_5@@0) (neverTriggered2 x_5_1@@0))
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((x_5@@1 Int) ) (!  (=> (and (<= 0 x_5@@1) (< x_5@@1 (len a_3@@10))) (>= (U_2_real (MapType1Select QPMask@0 (loc a_3@@10 x_5@@1) val)) FullPerm))
 :qid |stdinbpl.367:25|
 :skolemid |37|
 :pattern ( (loc a_3@@10 x_5@@1))
 :pattern ( (loc a_3@@10 x_5@@1))
)))))))
(let ((anon6_correct true))
(let ((anon10_Then_correct  (=> (and (<= 0 k_1) (< k_1 (len a_3@@10))) (and (=> (= (ControlFlow 0 8) 6) anon11_Then_correct) (=> (= (ControlFlow 0 8) 3) anon6_correct)))))
(let ((anon10_Else_correct  (=> (and (not (and (<= 0 k_1) (< k_1 (len a_3@@10)))) (= (ControlFlow 0 4) 3)) anon6_correct)))
(let ((anon9_Else_correct true))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((x_4 Int) (x_4_1 Int) ) (!  (=> (and (and (and (and (not (= x_4 x_4_1)) (and (<= 0 x_4) (< x_4 (len a_3@@10)))) (and (<= 0 x_4_1) (< x_4_1 (len a_3@@10)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@10 x_4) (loc a_3@@10 x_4_1))))
 :qid |stdinbpl.310:15|
 :skolemid |30|
))) (=> (forall ((x_4@@0 Int) (x_4_1@@0 Int) ) (!  (=> (and (and (and (and (not (= x_4@@0 x_4_1@@0)) (and (<= 0 x_4@@0) (< x_4@@0 (len a_3@@10)))) (and (<= 0 x_4_1@@0) (< x_4_1@@0 (len a_3@@10)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc a_3@@10 x_4@@0) (loc a_3@@10 x_4_1@@0))))
 :qid |stdinbpl.310:15|
 :skolemid |30|
)) (=> (forall ((x_4@@1 Int) ) (!  (=> (and (and (<= 0 x_4@@1) (< x_4@@1 (len a_3@@10))) (< NoPerm FullPerm)) (and (qpRange1 (loc a_3@@10 x_4@@1)) (= (invRecv1 (loc a_3@@10 x_4@@1)) x_4@@1)))
 :qid |stdinbpl.316:22|
 :skolemid |31|
 :pattern ( (loc a_3@@10 x_4@@1))
 :pattern ( (loc a_3@@10 x_4@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (and (<= 0 (invRecv1 o_3)) (< (invRecv1 o_3) (len a_3@@10))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (loc a_3@@10 (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.320:22|
 :skolemid |32|
 :pattern ( (invRecv1 o_3))
)) (forall ((x_4@@2 Int) ) (!  (=> (and (<= 0 x_4@@2) (< x_4@@2 (len a_3@@10))) (not (= (loc a_3@@10 x_4@@2) null)))
 :qid |stdinbpl.326:22|
 :skolemid |33|
 :pattern ( (loc a_3@@10 x_4@@2))
 :pattern ( (loc a_3@@10 x_4@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (len a_3@@10))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (loc a_3@@10 (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 val)) FullPerm)))) (=> (not (and (and (and (<= 0 (invRecv1 o_3@@0)) (< (invRecv1 o_3@@0) (len a_3@@10))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select ZeroMask o_3@@0 val))))))
 :qid |stdinbpl.332:22|
 :skolemid |34|
...
))) (and (state Heap@@16 QPMask@0) (state Heap@@16 QPMask@0))) (and (and (=> (= (ControlFlow 0 9) 2) anon9_Else_correct) (=> (= (ControlFlow 0 9) 8) anon10_Then_correct)) (=> (= (ControlFlow 0 9) 4) anon10_Else_correct)))))))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@16 ZeroMask) (= AssumeFunctionsAbove 0)) (and (=> (= (ControlFlow 0 11) 1) anon8_Then_correct) (=> (= (ControlFlow 0 11) 9) anon8_Else_correct)))))
