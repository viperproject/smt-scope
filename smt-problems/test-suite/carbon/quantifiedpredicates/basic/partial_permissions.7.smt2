...
(assert  (and (and (and (and (and (and (and (and (and (= (type QPMask@0) (MapType1Type RefType realType)) (= (type Heap@@10) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@37 T@U) ) (! (= (type (invRecv15 arg0@@37)) RefType)
 :qid |funType:invRecv15|
 :pattern ( (invRecv15 arg0@@37))
))) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type QPMask@3) (MapType1Type RefType realType))) (forall ((arg0@@38 T@U) ) (! (= (type (invRecv13 arg0@@38)) RefType)
 :qid |funType:invRecv13|
 :pattern ( (invRecv13 arg0@@38))
))) (forall ((arg0@@39 T@U) ) (! (= (type (invRecv12 arg0@@39)) RefType)
 :qid |funType:invRecv12|
 :pattern ( (invRecv12 arg0@@39))
))) (= (type r_1@@5) RefType)))
(set-info :boogie-vc-id t4)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon12_Else_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (forall ((x_5 T@U) (x_5_1 T@U) ) (!  (=> (and (= (type x_5) RefType) (= (type x_5_1) RefType)) (=> (and (and (not (= x_5 x_5_1)) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_5 x_5_1))))
...
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (not (= x_3 x_3_1)) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_3 x_3_1))))
...
))) (=> (forall ((x_3@@0 T@U) (x_3_1@@0 T@U) ) (!  (=> (and (= (type x_3@@0) RefType) (= (type x_3_1@@0) RefType)) (=> (and (and (not (= x_3@@0 x_3_1@@0)) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_3@@0 x_3_1@@0))))
 :qid |stdinbpl.1508:15|
 :skolemid |158|
...
)) (=> (forall ((x_3@@1 T@U) ) (!  (=> (= (type x_3@@1) RefType) (and (qpRange13 x_3@@1) (= (invRecv13 x_3@@1) x_3@@1)))
 :qid |stdinbpl.1514:22|
 :skolemid |159|
 :pattern ( (MapType0Select PostHeap@0 x_3@@1 f_7))
 :pattern ( (MapType1Select QPMask@3 x_3@@1 f_7))
 :pattern ( (MapType0Select PostHeap@0 x_3@@1 f_7))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (and (= (type o_3) RefType) (qpRange13 o_3)) (= (invRecv13 o_3) o_3))
 :qid |stdinbpl.1518:22|
 :skolemid |160|
 :pattern ( (invRecv13 o_3))
)) (forall ((x_3@@2 T@U) ) (!  (=> (= (type x_3@@2) RefType) (not (= x_3@@2 null)))
 :qid |stdinbpl.1524:22|
 :skolemid |161|
 :pattern ( (MapType0Select PostHeap@0 x_3@@2 f_7))
 :pattern ( (MapType1Select QPMask@3 x_3@@2 f_7))
 :pattern ( (MapType0Select PostHeap@0 x_3@@2 f_7))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (qpRange13 o_3@@0) (and (= (invRecv13 o_3@@0) o_3@@0) (< (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@3 o_3@@0 f_7))))) (=> (not (qpRange13 o_3@@0)) (= (U_2_real (MapType1Select QPMask@3 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
(let ((anon10_Else_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 3) (- 0 10)) (forall ((x_6 T@U) ) (!  (=> (= (type x_6) RefType) (> (U_2_real (MapType1Select QPMask@0 x_6 f_7)) NoPerm))
 :qid |stdinbpl.1592:15|
 :skolemid |170|
 :no-pattern (type x_6)
 :no-pattern (U_2_int x_6)
 :no-pattern (U_2_bool x_6)
))) (=> (forall ((x_6@@0 T@U) ) (!  (=> (= (type x_6@@0) RefType) (> (U_2_real (MapType1Select QPMask@0 x_6@@0 f_7)) NoPerm))
 :qid |stdinbpl.1592:15|
 :skolemid |170|
 :no-pattern (type x_6@@0)
 :no-pattern (U_2_int x_6@@0)
 :no-pattern (U_2_bool x_6@@0)
)) (=> (forall ((x_6@@1 T@U) ) (!  (=> (= (type x_6@@1) RefType) (< wildcard@0 (U_2_real (MapType1Select QPMask@0 x_6@@1 f_7))))
 :qid |stdinbpl.1596:20|
 :skolemid |171|
 :no-pattern (type x_6@@1)
 :no-pattern (U_2_int x_6@@1)
 :no-pattern (U_2_bool x_6@@1)
)) (and (=> (= (ControlFlow 0 3) (- 0 9)) (forall ((x_6@@2 T@U) ) (!  (=> (and (= (type x_6@@2) RefType) (dummyFunction (MapType0Select Heap@@10 x_6@@2 f_7))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1603:17|
 :skolemid |172|
 :pattern ( (MapType0Select Heap@@10 x_6@@2 f_7))
 :pattern ( (MapType1Select QPMask@1 x_6@@2 f_7))
 :pattern ( (MapType0Select Heap@@10 x_6@@2 f_7))
))) (=> (forall ((x_6@@3 T@U) ) (!  (=> (and (= (type x_6@@3) RefType) (dummyFunction (MapType0Select Heap@@10 x_6@@3 f_7))) (>= wildcard@0 NoPerm))
 :qid |stdinbpl.1603:17|
 :skolemid |172|
 :pattern ( (MapType0Select Heap@@10 x_6@@3 f_7))
 :pattern ( (MapType1Select QPMask@1 x_6@@3 f_7))
 :pattern ( (MapType0Select Heap@@10 x_6@@3 f_7))
)) (and (=> (= (ControlFlow 0 3) (- 0 8)) (forall ((x_6@@4 T@U) (x_6_1 T@U) ) (!  (=> (and (= (type x_6@@4) RefType) (= (type x_6_1) RefType)) (=> (and (and (not (= x_6@@4 x_6_1)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_6@@4 x_6_1))))
 :qid |stdinbpl.1610:17|
 :skolemid |173|
 :pattern ( (neverTriggered15 x_6@@4) (neverTriggered15 x_6_1))
))) (=> (forall ((x_6@@5 T@U) (x_6_1@@0 T@U) ) (!  (=> (and (= (type x_6@@5) RefType) (= (type x_6_1@@0) RefType)) (=> (and (and (not (= x_6@@5 x_6_1@@0)) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_6@@5 x_6_1@@0))))
 :qid |stdinbpl.1610:17|
 :skolemid |173|
 :pattern ( (neverTriggered15 x_6@@5) (neverTriggered15 x_6_1@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (forall ((x_6@@6 T@U) ) (!  (=> (= (type x_6@@6) RefType) (> (U_2_real (MapType1Select QPMask@0 x_6@@6 f_7)) NoPerm))
 :qid |stdinbpl.1617:17|
 :skolemid |174|
 :pattern ( (MapType0Select Heap@@10 x_6@@6 f_7))
 :pattern ( (MapType1Select QPMask@1 x_6@@6 f_7))
 :pattern ( (MapType0Select Heap@@10 x_6@@6 f_7))
))) (=> (forall ((x_6@@7 T@U) ) (!  (=> (= (type x_6@@7) RefType) (> (U_2_real (MapType1Select QPMask@0 x_6@@7 f_7)) NoPerm))
 :qid |stdinbpl.1617:17|
 :skolemid |174|
 :pattern ( (MapType0Select Heap@@10 x_6@@7 f_7))
 :pattern ( (MapType1Select QPMask@1 x_6@@7 f_7))
 :pattern ( (MapType0Select Heap@@10 x_6@@7 f_7))
)) (=> (forall ((x_6@@8 T@U) ) (!  (=> (and (= (type x_6@@8) RefType) (< NoPerm wildcard@0)) (and (qpRange15 x_6@@8) (= (invRecv15 x_6@@8) x_6@@8)))
 :qid |stdinbpl.1623:22|
 :skolemid |175|
 :pattern ( (MapType0Select Heap@@10 x_6@@8 f_7))
 :pattern ( (MapType1Select QPMask@1 x_6@@8 f_7))
 :pattern ( (MapType0Select Heap@@10 x_6@@8 f_7))
)) (=> (and (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (< NoPerm wildcard@0) (qpRange15 o_3@@2)) (= (invRecv15 o_3@@2) o_3@@2)))
 :qid |stdinbpl.1627:22|
 :skolemid |176|
 :pattern ( (invRecv15 o_3@@2))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (< NoPerm wildcard@0) (qpRange15 o_3@@3)) (and (= (invRecv15 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (- (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) wildcard@0)))) (=> (not (and (< NoPerm wildcard@0) (qpRange15 o_3@@3))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7))))))
...
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 ...
 :qid |stdinbpl.1639:29|
 :skolemid |178|
 :pattern ( (MapType1Select QPMask@1 o_3@@4 f_5@@0))
)) (> wildcard@1 0.0))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((x_7 T@U) ) (!  (=> (= (type x_7) RefType) (> (U_2_real (MapType1Select QPMask@1 x_7 f_7)) NoPerm))
 :qid |stdinbpl.1648:15|
 :skolemid |179|
 :no-pattern (type x_7)
 :no-pattern (U_2_int x_7)
 :no-pattern (U_2_bool x_7)
))) (=> (forall ((x_7@@0 T@U) ) (!  (=> (= (type x_7@@0) RefType) (> (U_2_real (MapType1Select QPMask@1 x_7@@0 f_7)) NoPerm))
 :qid |stdinbpl.1648:15|
 :skolemid |179|
 :no-pattern (type x_7@@0)
 :no-pattern (U_2_int x_7@@0)
 :no-pattern (U_2_bool x_7@@0)
)) (=> (forall ((x_7@@1 T@U) ) (!  (=> (= (type x_7@@1) RefType) (< wildcard@1 (U_2_real (MapType1Select QPMask@1 x_7@@1 f_7))))
 :qid |stdinbpl.1652:20|
 :skolemid |180|
 :no-pattern (type x_7@@1)
 :no-pattern (U_2_int x_7@@1)
 :no-pattern (U_2_bool x_7@@1)
)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((x_7@@2 T@U) ) (!  (=> (and (= (type x_7@@2) RefType) (dummyFunction (MapType0Select Heap@@10 x_7@@2 f_7))) (>= wildcard@1 NoPerm))
 :qid |stdinbpl.1659:17|
 :skolemid |181|
 :pattern ( (MapType0Select Heap@@10 x_7@@2 f_7))
 :pattern ( (MapType1Select QPMask@2 x_7@@2 f_7))
 :pattern ( (MapType0Select Heap@@10 x_7@@2 f_7))
))) (=> (forall ((x_7@@3 T@U) ) (!  (=> (and (= (type x_7@@3) RefType) (dummyFunction (MapType0Select Heap@@10 x_7@@3 f_7))) (>= wildcard@1 NoPerm))
 :qid |stdinbpl.1659:17|
 :skolemid |181|
 :pattern ( (MapType0Select Heap@@10 x_7@@3 f_7))
 :pattern ( (MapType1Select QPMask@2 x_7@@3 f_7))
 :pattern ( (MapType0Select Heap@@10 x_7@@3 f_7))
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_7@@4 T@U) (x_7_1 T@U) ) (!  (=> (and (= (type x_7@@4) RefType) (= (type x_7_1) RefType)) (=> (and (and (not (= x_7@@4 x_7_1)) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= x_7@@4 x_7_1))))
 :qid |stdinbpl.1666:17|
 :skolemid |182|
 :pattern ( (neverTriggered16 x_7@@4) (neverTriggered16 x_7_1))
))) (=> (forall ((x_7@@5 T@U) (x_7_1@@0 T@U) ) (!  (=> (and (= (type x_7@@5) RefType) (= (type x_7_1@@0) RefType)) (=> (and (and (not (= x_7@@5 x_7_1@@0)) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= x_7@@5 x_7_1@@0))))
 :qid |stdinbpl.1666:17|
 :skolemid |182|
 :pattern ( (neverTriggered16 x_7@@5) (neverTriggered16 x_7_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_7@@6 T@U) ) (!  (=> (= (type x_7@@6) RefType) (> (U_2_real (MapType1Select QPMask@1 x_7@@6 f_7)) NoPerm))
 :qid |stdinbpl.1673:17|
 :skolemid |183|
 :pattern ( (MapType0Select Heap@@10 x_7@@6 f_7))
 :pattern ( (MapType1Select QPMask@2 x_7@@6 f_7))
 :pattern ( (MapType0Select Heap@@10 x_7@@6 f_7))
))))))))))))))))))))))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (not (= x_1 x_1_1)) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_1 x_1_1))))
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (not (= x_1@@0 x_1_1@@0)) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.1457:15|
 :skolemid |152|
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (and (qpRange12 x_1@@1) (= (invRecv12 x_1@@1) x_1@@1)))
 :qid |stdinbpl.1463:22|
 :skolemid |153|
 :pattern ( (MapType0Select Heap@@10 x_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@1 f_7))
 :pattern ( (MapType0Select Heap@@10 x_1@@1 f_7))
)) (=> (and (forall ((o_3@@5 T@U) ) (!  (=> (and (= (type o_3@@5) RefType) (qpRange12 o_3@@5)) (= (invRecv12 o_3@@5) o_3@@5))
 :qid |stdinbpl.1467:22|
 :skolemid |154|
 :pattern ( (invRecv12 o_3@@5))
)) (forall ((x_1@@2 T@U) ) (!  (=> (= (type x_1@@2) RefType) (not (= x_1@@2 null)))
 :qid |stdinbpl.1473:22|
 :skolemid |155|
 :pattern ( (MapType0Select Heap@@10 x_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 x_1@@2 f_7))
 :pattern ( (MapType0Select Heap@@10 x_1@@2 f_7))
))) (=> (and (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (qpRange12 o_3@@6) (and (= (invRecv12 o_3@@6) o_3@@6) (< (U_2_real (MapType1Select ZeroMask o_3@@6 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7))))) (=> (not (qpRange12 o_3@@6)) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@6 f_7))))))
