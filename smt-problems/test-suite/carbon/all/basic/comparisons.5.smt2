...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (< i1 i2)) (and (> i3 i4) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (< i1 i2)) (=> (< i1 i2) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> i3 i4)) (=> (> i3 i4) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (<= i2 i3))))))))))
