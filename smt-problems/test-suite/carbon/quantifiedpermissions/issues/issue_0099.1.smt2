...
(assert  (and (and (and (and (= (type xs) (SeqType RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type Heap@@13) (MapType0Type RefType))))
(set-info :boogie-vc-id test03)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 29) (let ((anon12_correct true))
(let ((anon21_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_8))) (= (ControlFlow 0 23) 19)) anon12_correct)))
(let ((anon21_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_8)) (and (=> (= (ControlFlow 0 20) (- 0 22)) (>= i_8 0)) (=> (>= i_8 0) (and (=> (= (ControlFlow 0 20) (- 0 21)) (< i_8 (|Seq#Length| xs))) (=> (< i_8 (|Seq#Length| xs)) (=> (= (ControlFlow 0 20) 19) anon12_correct))))))))
(let ((anon20_Else_correct  (=> (= (ControlFlow 0 18) (- 0 17)) (forall ((i_3 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3 i_3_1)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_3) (|Seq#Index| xs i_3_1))))
...
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 16)) (forall ((i_4 Int) (i_4_1 Int) ) (!  (=> (and (and (and (and (not (= i_4 i_4_1)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_4) (|Seq#Index| xs i_4_1))))
 :qid |stdinbpl.1110:17|
 :skolemid |95|
 :pattern ( (neverTriggered6 i_4) (neverTriggered6 i_4_1))
))) (=> (forall ((i_4@@0 Int) (i_4_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_4@@0 i_4_1@@0)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4@@0))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_4@@0) (|Seq#Index| xs i_4_1@@0))))
 :qid |stdinbpl.1110:17|
 :skolemid |95|
 :pattern ( (neverTriggered6 i_4@@0) (neverTriggered6 i_4_1@@0))
)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((i_4@@1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4@@1)) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs i_4@@1) f_7)) FullPerm))
 :qid |stdinbpl.1117:17|
 :skolemid |96|
 :pattern ( (|Seq#Index| xs i_4@@1))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_4@@1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4@@1)))
 :pattern ( (|Seq#Index| xs i_4@@1))
))) (=> (forall ((i_4@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4@@2)) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs i_4@@2) f_7)) FullPerm))
 :qid |stdinbpl.1117:17|
 :skolemid |96|
 :pattern ( (|Seq#Index| xs i_4@@2))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_4@@2)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4@@2)))
 :pattern ( (|Seq#Index| xs i_4@@2))
)) (=> (forall ((i_4@@3 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4@@3)) (< NoPerm FullPerm)) (and (qpRange6 (|Seq#Index| xs i_4@@3)) (= (invRecv6 (|Seq#Index| xs i_4@@3)) i_4@@3)))
 :qid |stdinbpl.1123:22|
 :skolemid |97|
 :pattern ( (|Seq#Index| xs i_4@@3))
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_4@@3)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_4@@3)))
 :pattern ( (|Seq#Index| xs i_4@@3))
)) (=> (and (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv6 o_3))) (and (< NoPerm FullPerm) (qpRange6 o_3))) (= (|Seq#Index| xs (invRecv6 o_3)) o_3)))
 :qid |stdinbpl.1127:22|
 :skolemid |98|
 :pattern ( (invRecv6 o_3))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv6 o_3@@0))) (and (< NoPerm FullPerm) (qpRange6 o_3@@0))) (and (= (|Seq#Index| xs (invRecv6 o_3@@0)) o_3@@0) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (- (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv6 o_3@@0))) (and (< NoPerm FullPerm) (qpRange6 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7))))))
...
)) (= (ControlFlow 0 14) (- 0 13)))) (> n@@13 0)))))))))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 25) (- 0 26)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs i_1) (|Seq#Index| xs i_1_1))))
 ...
 :qid |stdinbpl.1004:15|
 :skolemid |83|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@1)) (< NoPerm FullPerm)) (and (qpRange4 (|Seq#Index| xs i_1@@1)) (= (invRecv4 (|Seq#Index| xs i_1@@1)) i_1@@1)))
 ...
 :pattern ( (|Seq#Index| xs i_1@@1))
)) (=> (and (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv4 o_3@@2))) (< NoPerm FullPerm)) (qpRange4 o_3@@2)) (= (|Seq#Index| xs (invRecv4 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.1014:22|
 :skolemid |85|
 :pattern ( (invRecv4 o_3@@2))
)) (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@2)) (not (= (|Seq#Index| xs i_1@@2) null)))
 ...
 :pattern ( (|Seq#Index| xs i_1@@2))
))) (=> (and (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv4 o_3@@3))) (< NoPerm FullPerm)) (qpRange4 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| xs (invRecv4 o_3@@3)) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv4 o_3@@3))) (< NoPerm FullPerm)) (qpRange4 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@3 f_7))))))
...
))) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0))) (and (=> (= (ControlFlow 0 25) 24) anon19_Then_correct) (=> (= (ControlFlow 0 25) 14) anon19_Else_correct)))))))))
(let ((anon7_correct true))
(let ((anon18_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_7))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon18_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_7)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_7 0)) (=> (>= i_7 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_7 (|Seq#Length| xs))) (=> (< i_7 (|Seq#Length| xs)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon15_Else_correct  (=> (and (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (<= 0 i1_1) (and (< i1_1 (|Seq#Length| xs)) (and (<= 0 i2_1) (and (< i2_1 (|Seq#Length| xs)) (not (= i1_1 i2_1)))))) (not (= (|Seq#Index| xs i1_1) (|Seq#Index| xs i2_1))))
 :qid |stdinbpl.986:20|
 :skolemid |82|
 :pattern ( (|Seq#Index| xs i1_1) (|Seq#Index| xs i2_1))
)) (state Heap@@13 ZeroMask)) (and (and (=> (= (ControlFlow 0 27) 25) anon17_Else_correct) (=> (= (ControlFlow 0 27) 9) anon18_Then_correct)) (=> (= (ControlFlow 0 27) 12) anon18_Else_correct)))))
(let ((anon3_correct true))
(let ((anon16_Else_correct  (=> (and (not (and (<= 0 i1_3) (and (< i1_3 (|Seq#Length| xs)) (and (<= 0 i2_3) (and (< i2_3 (|Seq#Length| xs)) (not (= i1_3 i2_3))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon16_Then_correct  (=> (and (<= 0 i1_3) (and (< i1_3 (|Seq#Length| xs)) (and (<= 0 i2_3) (and (< i2_3 (|Seq#Length| xs)) (not (= i1_3 i2_3)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_3 0)) (=> (>= i1_3 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_3 (|Seq#Length| xs))) (=> (< i1_3 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_3 0)) (=> (>= i2_3 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_3 (|Seq#Length| xs))) (=> (< i2_3 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (= (|Seq#Length| xs) n@@13) (state Heap@@13 ZeroMask))) (and (and (=> (= (ControlFlow 0 28) 27) anon15_Else_correct) (=> (= (ControlFlow 0 28) 2) anon16_Then_correct)) (=> (= (ControlFlow 0 28) 7) anon16_Else_correct)))))
