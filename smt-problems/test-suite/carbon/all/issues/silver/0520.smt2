...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon9_Else_correct  (=> (and (not (>= r_1@0 0)) (state Heap@@9 ZeroMask)) (=> (and (and (and (>= r_1@0 (- 0 d)) (= n (+ (* q_1@0 d) r_1@0))) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (and (= r_1@2 (+ r_1@0 d)) (state Heap@@9 ZeroMask)) (and (= q_1@2 (- q_1@0 1)) (state Heap@@9 ZeroMask)))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (= n (+ (* q_1@2 d) r_1@2))) (=> (= n (+ (* q_1@2 d) r_1@2)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (>= r_1@2 0)) (=> (>= r_1@2 0) (=> (= (ControlFlow 0 7) (- 0 6)) (< r_1@2 d))))))))))
(let ((anon9_Then_correct  (=> (and (state Heap@@9 ZeroMask) (>= r_1@0 (- 0 d))) (=> (and (and (and (= n (+ (* q_1@0 d) r_1@0)) (state Heap@@9 ZeroMask)) (and (>= r_1@0 0) (state Heap@@9 ZeroMask))) (and (and (= r_1@1 (- r_1@0 d)) (state Heap@@9 ZeroMask)) (and (= q_1@1 (+ q_1@0 1)) (state Heap@@9 ZeroMask)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (>= r_1@1 (- 0 d))) (=> (>= r_1@1 (- 0 d)) (=> (= (ControlFlow 0 4) (- 0 3)) (= n (+ (* q_1@1 d) r_1@1)))))))))
(let ((anon8_Then_correct true))
(let ((anon7_Else_correct  (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 10) (- 0 12)) (>= n (- 0 d))) (=> (>= n (- 0 d)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (= n (+ (* 0 d) n))) (=> (= n (+ (* 0 d) n)) (and (and (=> (= (ControlFlow 0 10) 2) anon8_Then_correct) (=> (= (ControlFlow 0 10) 4) anon9_Then_correct)) (=> (= (ControlFlow 0 10) 7) anon9_Else_correct)))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (>= n 0)) (and (> d 0) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 13) 1) anon7_Then_correct) (=> (= (ControlFlow 0 13) 10) anon7_Else_correct)))))
