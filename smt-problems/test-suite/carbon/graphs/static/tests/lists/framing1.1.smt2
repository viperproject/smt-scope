...
(assert  (and (and (and (and (and (and (and (= (type g@@15) (MapType2Type RefType boolType)) (= (type n$1_4) RefType)) (= (type Heap@@35) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type n_18) RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type roots@@4) (MapType2Type RefType boolType))) (forall ((arg0@@59 T@U) ) (! (= (type (invRecv14 arg0@@59)) RefType)
...
(let ((anon19_Then_correct  (=> (U_2_bool (MapType2Select g@@15 n_18)) (and (=> (= (ControlFlow 0 15) 13) anon20_Then_correct) (=> (= (ControlFlow 0 15) 10) anon12_correct)))))
(let ((anon19_Else_correct  (=> (and (not (U_2_bool (MapType2Select g@@15 n_18))) (= (ControlFlow 0 11) 10)) anon12_correct)))
...
)) (state Heap@@35 QPMask@0)) (and (|Set#Subset| roots@@4 g@@15) (state Heap@@35 QPMask@0))) (and (and (=> (= (ControlFlow 0 16) 9) anon18_Else_correct) (=> (= (ControlFlow 0 16) 15) anon19_Then_correct)) (=> (= (ControlFlow 0 16) 11) anon19_Else_correct)))))
(let ((anon7_correct true))
(let ((anon17_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g@@15 n$1_4)) (not (= (MapType0Select Heap@@35 n$1_4 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon17_Then_correct  (=> (and (U_2_bool (MapType2Select g@@15 n$1_4)) (not (= (MapType0Select Heap@@35 n$1_4 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 n$1_4 next)) (=> (HasDirectPerm QPMask@0 n$1_4 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon16_Else_correct  (=> (not (U_2_bool (MapType2Select g@@15 n$1_4))) (and (=> (= (ControlFlow 0 8) 3) anon17_Then_correct) (=> (= (ControlFlow 0 8) 5) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (U_2_bool (MapType2Select g@@15 n$1_4)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm QPMask@0 n$1_4 next)) (=> (HasDirectPerm QPMask@0 n$1_4 next) (and (=> (= (ControlFlow 0 6) 3) anon17_Then_correct) (=> (= (ControlFlow 0 6) 5) anon17_Else_correct)))))))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((n$0_4 T@U) (n$0_4_1 T@U) ) (!  (=> (and (= (type n$0_4) RefType) (= (type n$0_4_1) RefType)) (=> (and (and (and (and (not (= n$0_4 n$0_4_1)) (U_2_bool (MapType2Select g@@15 n$0_4))) (U_2_bool (MapType2Select g@@15 n$0_4_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$0_4 n$0_4_1))))
...
)) (=> (and (forall ((n$0_4@@1 T@U) ) (!  (=> (= (type n$0_4@@1) RefType) (=> (and (U_2_bool (MapType2Select g@@15 n$0_4@@1)) (< NoPerm FullPerm)) (and (qpRange14 n$0_4@@1) (= (invRecv14 n$0_4@@1) n$0_4@@1))))
 :qid |stdinbpl.1945:22|
 :skolemid |230|
 :pattern ( (MapType0Select Heap@@35 n$0_4@@1 next))
 :pattern ( (MapType1Select QPMask@0 n$0_4@@1 next))
 :pattern ( (MapType0Select Heap@@35 n$0_4@@1 next))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select g@@15 (invRecv14 o_3))) (< NoPerm FullPerm)) (qpRange14 o_3)) (= (invRecv14 o_3) o_3)))
 ...
 :pattern ( (MapType0Select Heap@@35 n$0_4@@2 next))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select g@@15 (invRecv14 o_3@@0))) (< NoPerm FullPerm)) (qpRange14 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv14 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 next)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select g@@15 (invRecv14 o_3@@0))) (< NoPerm FullPerm)) (qpRange14 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (U_2_real (MapType1Select ZeroMask o_3@@0 next))))))
...
(let ((anon0_correct  (=> (state Heap@@35 ZeroMask) (=> (and (= AssumeFunctionsAbove 1) (not (U_2_bool (MapType2Select g@@15 null)))) (and (=> (= (ControlFlow 0 19) 1) anon14_Then_correct) (=> (= (ControlFlow 0 19) 17) anon14_Else_correct))))))
