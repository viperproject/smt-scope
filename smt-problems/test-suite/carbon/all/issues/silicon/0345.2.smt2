...
(assert  (and (and (and (and (and (and (= (type Heap@0) (MapType0Type RefType)) (= (type freshObj@0) RefType)) (= (type d) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type c) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id t1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon2_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= (MapType0Select Heap@0 freshObj@0 f_7) freshObj@0)) (not (= (MapType0Select Heap@0 freshObj@0 f_7) d))))))
(let ((anon3_Else_correct  (=> (and (not (= (MapType0Select Heap@0 freshObj@0 f_7) freshObj@0)) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (not (= (MapType0Select Heap@0 freshObj@0 f_7) freshObj@0))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm Mask@1 freshObj@0 f_7)) (=> (HasDirectPerm Mask@1 freshObj@0 f_7) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 c $allocated))) (and (U_2_bool (MapType0Select Heap@@9 d $allocated)) (not (= d null)))) (and (and (= Mask@0 (MapType1Store ZeroMask d f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask d f_7)) FullPerm)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)))) (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@9 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@9 freshObj@0 $allocated (bool_2_U true)))) (and (= Mask@1 (MapType1Store Mask@0 freshObj@0 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@0 f_7)) FullPerm)))) (state Heap@0 Mask@1)))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (not (= freshObj@0 d))) (=> (not (= freshObj@0 d)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm Mask@1 freshObj@0 f_7)) (=> (HasDirectPerm Mask@1 freshObj@0 f_7) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))))))
