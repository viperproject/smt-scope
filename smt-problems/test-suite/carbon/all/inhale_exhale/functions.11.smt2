...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (=> (not (= this@@54 null)) (=> (and (= Mask@0 (MapType1Store ZeroMask this@@54 x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@54 x@@8)) FullPerm)))) (state Heap@@64 Mask@0)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (HasDirectPerm Mask@0 this@@54 x@@8)) (=> (HasDirectPerm Mask@0 this@@54 x@@8) (=> (and (= (U_2_int (MapType0Select Heap@@64 this@@54 x@@8)) 1) (state Heap@@64 Mask@0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm Mask@0 this@@54 x@@8)) (=> (HasDirectPerm Mask@0 this@@54 x@@8) (=> (and (= Result@0 (U_2_int (MapType0Select Heap@@64 this@@54 x@@8))) (= (ControlFlow 0 3) (- 0 2))) (= Result@0 1)))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@64 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@64 this@@54 $allocated)) (= AssumeFunctionsAbove 3)) (and (=> (= (ControlFlow 0 6) 1) anon3_Then_correct) (=> (= (ControlFlow 0 6) 3) anon3_Else_correct))))))
...
(assert  (and (and (and (and (and (and (= (type ExhaleWellDef0Mask@1) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type this@@54) RefType)) (= (type Heap@@64) (MapType0Type RefType))) (= (type ExhaleWellDef0Mask@0) (MapType1Type RefType realType))) (= (type AssertMask@1) (MapType1Type RefType realType))) (= (type AssertMask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id inhaleTrue1Method2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 29) (let ((anon12_correct  (=> (= AssertMask@1 (MapType1Store Mask@0 this@@54 x@@8 (real_2_U (- (U_2_real (MapType1Select Mask@0 this@@54 x@@8)) FullPerm)))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm Mask@0 this@@54 x@@8)) (=> (HasDirectPerm Mask@0 this@@54 x@@8) (=> (= (ControlFlow 0 12) (- 0 11)) (= (U_2_int (MapType0Select Heap@@64 this@@54 x@@8)) 1)))))))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 12)) anon12_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (U_2_real (MapType1Select Mask@0 this@@54 x@@8)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 this@@54 x@@8))) (=> (= (ControlFlow 0 14) 12) anon12_correct))))))
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (= (inhaleTrue1 Heap@@64 this@@54) 0)) (=> (= (inhaleTrue1 Heap@@64 this@@54) 0) (=> (state Heap@@64 Mask@0) (and (=> (= (ControlFlow 0 17) 14) anon18_Then_correct) (=> (= (ControlFlow 0 17) 16) anon18_Else_correct)))))))
(let ((anon9_correct  (=> (and (= ExhaleWellDef0Mask@0 (MapType1Store Mask@0 this@@54 x@@8 (real_2_U (- (U_2_real (MapType1Select Mask@0 this@@54 x@@8)) FullPerm)))) (= (ControlFlow 0 7) (- 0 6))) (= (U_2_int (MapType0Select Heap@@64 this@@54 x@@8)) 1))))
(let ((anon17_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 7)) anon9_correct)))
(let ((anon17_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select Mask@0 this@@54 x@@8)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 this@@54 x@@8))) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
(let ((anon6_correct  (=> (= AssertMask@0 (MapType1Store Mask@0 this@@54 x@@8 (real_2_U (- (U_2_real (MapType1Select Mask@0 this@@54 x@@8)) FullPerm)))) (and (=> (= (ControlFlow 0 19) (- 0 21)) (HasDirectPerm Mask@0 this@@54 x@@8)) (=> (HasDirectPerm Mask@0 this@@54 x@@8) (and (=> (= (ControlFlow 0 19) (- 0 20)) (= (U_2_int (MapType0Select Heap@@64 this@@54 x@@8)) 1)) (=> (= (U_2_int (MapType0Select Heap@@64 this@@54 x@@8)) 1) (=> (state Heap@@64 Mask@0) (and (and (=> (= (ControlFlow 0 19) 17) anon16_Else_correct) (=> (= (ControlFlow 0 19) 8) anon17_Then_correct)) (=> (= (ControlFlow 0 19) 10) anon17_Else_correct))))))))))
(let ((anon15_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 24) 19)) anon6_correct)))
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (<= FullPerm (U_2_real (MapType1Select Mask@0 this@@54 x@@8)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 this@@54 x@@8))) (=> (= (ControlFlow 0 22) 19) anon6_correct))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 25) (- 0 26)) (= (inhaleTrue1 Heap@@64 this@@54) 0)) (=> (= (inhaleTrue1 Heap@@64 this@@54) 0) (=> (state Heap@@64 Mask@0) (and (=> (= (ControlFlow 0 25) 22) anon15_Then_correct) (=> (= (ControlFlow 0 25) 24) anon15_Else_correct)))))))
(let ((anon3_correct  (=> (and (= ExhaleWellDef0Mask@1 (MapType1Store Mask@0 this@@54 x@@8 (real_2_U (- (U_2_real (MapType1Select Mask@0 this@@54 x@@8)) FullPerm)))) (= (ControlFlow 0 2) (- 0 1))) (= (U_2_int (MapType0Select Heap@@64 this@@54 x@@8)) 1))))
(let ((anon14_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon3_correct)))
(let ((anon14_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 this@@54 x@@8)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 this@@54 x@@8))) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@64 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@64 this@@54 $allocated)) (not (= this@@54 null))) (and (= Mask@0 (MapType1Store ZeroMask this@@54 x@@8 (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@54 x@@8)) FullPerm)))) (state Heap@@64 Mask@0))) (and (=> (= (ControlFlow 0 27) (- 0 28)) (HasDirectPerm Mask@0 this@@54 x@@8)) (=> (HasDirectPerm Mask@0 this@@54 x@@8) (=> (and (= (U_2_int (MapType0Select Heap@@64 this@@54 x@@8)) 1) (state Heap@@64 Mask@0)) (and (and (=> (= (ControlFlow 0 27) 25) anon13_Else_correct) (=> (= (ControlFlow 0 27) 3) anon14_Then_correct)) (=> (= (ControlFlow 0 27) 5) anon14_Else_correct)))))))))
