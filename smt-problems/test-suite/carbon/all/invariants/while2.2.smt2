...
(assert  (and (and (and (= (type Heap@0) (MapType0Type RefType)) (= (type x@@8) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Else_correct true))
(let ((anon6_Then_correct  (=> (state Heap@0 ZeroMask) (=> (and (state Heap@0 ZeroMask) (= (ControlFlow 0 3) (- 0 2))) (HasDirectPerm ZeroMask x@@8 f_7)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (=> (and (and (not (= x@@8 null)) (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) FullPerm))))) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (= FullPerm (U_2_real (MapType1Select Mask@0 x@@8 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 x@@8 f_7))) (=> (and (= Heap@0 (MapType0Store Heap@@9 x@@8 f_7 (int_2_U 1))) (state Heap@0 Mask@0)) (and (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))))))
