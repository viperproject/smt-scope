...
(assert  (and (and (and (and (and (and (and (= (type UnfoldingMask@0) (MapType0Type RefType realType)) (= (type Mask@0) (MapType0Type RefType realType))) (= (type x@@28) RefType)) (= (type UnfoldingMask@1) (MapType0Type RefType realType))) (= (type Heap@@19) (MapType1Type RefType))) (= (type UnfoldingMask@2) (MapType0Type RefType realType))) (forall ((arg0@@51 T@U) (arg1@@80 T@U) ) (! (= (type (CombineFrames arg0@@51 arg1@@80)) FrameTypeType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon2_correct  (=> (and (and (and (= UnfoldingMask@0 (MapType0Store Mask@0 null (pair x@@28) (real_2_U (- (U_2_real (MapType0Select Mask@0 null (pair x@@28))) FullPerm)))) (not (= x@@28 null))) (and (= UnfoldingMask@1 (MapType0Store UnfoldingMask@0 x@@28 f_7 (real_2_U (+ (U_2_real (MapType0Select UnfoldingMask@0 x@@28 f_7)) FullPerm)))) (state Heap@@19 UnfoldingMask@1))) (and (and (not (= x@@28 null)) (= UnfoldingMask@2 (MapType0Store UnfoldingMask@1 x@@28 g (real_2_U (+ (U_2_real (MapType0Select UnfoldingMask@1 x@@28 g)) FullPerm))))) (and (state Heap@@19 UnfoldingMask@2) (state Heap@@19 UnfoldingMask@2)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm UnfoldingMask@2 x@@28 f_7)) (=> (HasDirectPerm UnfoldingMask@2 x@@28 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm UnfoldingMask@2 x@@28 g)))))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 6) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType0Select Mask@0 null (pair x@@28))))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@0 null (pair x@@28)))) (=> (= (ControlFlow 0 4) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@19 ZeroMask) (U_2_bool (MapType1Select Heap@@19 x@@28 $allocated))) (and (= AssumeFunctionsAbove 1) (= Mask@0 (MapType0Store ZeroMask null (pair x@@28) (real_2_U (+ (U_2_real (MapType0Select ZeroMask null (pair x@@28))) FullPerm)))))) (and (and (state Heap@@19 Mask@0) (state Heap@@19 Mask@0)) (and (|pair#trigger| Heap@@19 (pair x@@28)) (= (MapType1Select Heap@@19 null (pair x@@28)) (CombineFrames (FrameFragment (MapType1Select Heap@@19 x@@28 f_7)) (FrameFragment (MapType1Select Heap@@19 x@@28 g))))))) (and (=> (= (ControlFlow 0 7) 4) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct)))))
