...
(assert  (and (and (and (= (type x@@34) RefType) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@14) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))))
...
(let ((anon3_Then_correct  (=> (<= NoPerm p_1@@5) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= p_1@@5 NoPerm)) (=> (>= p_1@@5 NoPerm) (=> (=> (> p_1@@5 NoPerm) (not (= x@@34 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask x@@34 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@34 f_7)) p_1@@5)))) (state Heap@@14 Mask@0)) (and (= Mask@1 Mask@0) (= (ControlFlow 0 2) 1))) anon2_correct)))))))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@14 x@@34 $allocated))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
...
(declare-fun y@@6 () T@U)
(declare-fun AssumeFunctionsAbove () Int)
(assert  (and (and (and (and (and (= (type xs@0) (MapType2Type RefType boolType)) (= (type Heap@@14) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv8 arg0@@48)) RefType)
 :qid |funType:invRecv8|
 :pattern ( (invRecv8 arg0@@48))
))) (= (type xs) (MapType2Type RefType boolType))) (= (type y@@6) RefType)))
(set-info :boogie-vc-id test23)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon6_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (U_2_bool (MapType2Select xs@0 x_3))) (U_2_bool (MapType2Select xs@0 x_3_1))) (< NoPerm (permfun x_3))) (< NoPerm (permfun x_3_1))) (not (= x_3 x_3_1))))
...
))) (=> (forall ((x_3@@0 T@U) (x_3_1@@0 T@U) ) (!  (=> (and (= (type x_3@@0) RefType) (= (type x_3_1@@0) RefType)) (=> (and (and (and (and (not (= x_3@@0 x_3_1@@0)) (U_2_bool (MapType2Select xs@0 x_3@@0))) (U_2_bool (MapType2Select xs@0 x_3_1@@0))) (< NoPerm (permfun x_3@@0))) (< NoPerm (permfun x_3_1@@0))) (not (= x_3@@0 x_3_1@@0))))
 :qid |stdinbpl.1400:15|
 :skolemid |149|
...
)) (=> (forall ((x_3@@1 T@U) ) (!  (=> (= (type x_3@@1) RefType) (=> (and (U_2_bool (MapType2Select xs@0 x_3@@1)) (< NoPerm (permfun x_3@@1))) (and (qpRange8 x_3@@1) (= (invRecv8 x_3@@1) x_3@@1))))
 :qid |stdinbpl.1406:22|
 :skolemid |150|
 :pattern ( (MapType0Select Heap@@14 x_3@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 x_3@@1 f_7))
 :pattern ( (MapType2Select xs@0 x_3@@1))
 :pattern ( (permfun x_3@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select xs@0 (invRecv8 o_3))) (< NoPerm (permfun (invRecv8 o_3)))) (qpRange8 o_3)) (= (invRecv8 o_3) o_3)))
 :qid |stdinbpl.1410:22|
 :skolemid |151|
 :pattern ( (invRecv8 o_3))
)) (= (ControlFlow 0 4) (- 0 3))) (forall ((x_3@@2 T@U) ) (!  (=> (and (= (type x_3@@2) RefType) (U_2_bool (MapType2Select xs@0 x_3@@2))) (>= (permfun x_3@@2) NoPerm))
 :qid |stdinbpl.1416:15|
 :skolemid |152|
 :pattern ( (MapType0Select Heap@@14 x_3@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 x_3@@2 f_7))
 :pattern ( (MapType2Select xs@0 x_3@@2))
 :pattern ( (permfun x_3@@2))
))))))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (forall ((x_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (U_2_bool (MapType2Select xs x_1))) (<= NoPerm (permfun x_1)))
 :qid |stdinbpl.1378:20|
 :skolemid |148|
 :pattern ( (MapType2Select xs x_1))
 :pattern ( (permfun x_1))
)) (=> (and (and (state Heap@@14 ZeroMask) (state Heap@@14 ZeroMask)) (and (= xs@0 (|Set#Union| xs (|Set#Singleton| y@@6))) (state Heap@@14 ZeroMask))) (and (=> (= (ControlFlow 0 6) 2) anon6_Then_correct) (=> (= (ControlFlow 0 6) 4) anon6_Else_correct))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@14 y@@6 $allocated))) (and (=> (= (ControlFlow 0 7) 1) anon5_Then_correct) (=> (= (ControlFlow 0 7) 6) anon5_Else_correct))))))
