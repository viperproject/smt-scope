...
(declare-fun monitor () T@U)
(declare-fun Heap@0 () T@U)
(declare-fun Heap@@9 () T@U)
(declare-fun value () T@U)
(assert  (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type monitor) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type value) RefType)))
...
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 monitor f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 monitor f_7))) (=> (= (ControlFlow 0 3) 2) anon4_correct))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (= FullPerm (U_2_real (MapType1Select Mask@0 monitor f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 monitor f_7))) (=> (and (= Heap@0 (MapType0Store Heap@@9 monitor f_7 value)) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 6) 3) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 monitor $allocated))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@9 value $allocated)) (not (= monitor null))) (and (= Mask@0 (MapType1Store ZeroMask monitor f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask monitor f_7)) FullPerm)))) (state Heap@@9 Mask@0))) (and (and (state Heap@@9 Mask@0) (not (= monitor null))) (and (not (= value null)) (state Heap@@9 Mask@0)))) (and (=> (= (ControlFlow 0 8) 1) anon5_Then_correct) (=> (= (ControlFlow 0 8) 6) anon5_Else_correct))))))
