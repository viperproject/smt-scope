...
(declare-fun lseg (T@U T@U T@U) T@U)
...
(declare-fun |lseg#sm| (T@U T@U T@U) T@U)
...
(assert  (and (and (= (Ctor PredicateType_lsegType) 12) (= (Ctor FrameTypeType) 13)) (forall ((arg0@@26 T@U) (arg1@@10 T@U) (arg2@@3 T@U) ) (! (= (type (lseg arg0@@26 arg1@@10 arg2@@3)) (FieldType PredicateType_lsegType FrameTypeType))
 :qid |funType:lseg|
 :pattern ( (lseg arg0@@26 arg1@@10 arg2@@3))
))))
(assert (forall ((first T@U) (last T@U) (values T@U) ) (!  (=> (and (and (= (type first) RefType) (= (type last) RefType)) (= (type values) (SeqType intType))) (IsPredicateField (lseg first last values)))
 :qid |stdinbpl.559:15|
 :skolemid |59|
 :pattern ( (lseg first last values))
)))
(assert (forall ((Heap@@0 T@U) (first@@0 T@U) (last@@0 T@U) (values@@0 T@U) ) (!  (=> (and (and (and (= (type Heap@@0) (MapType0Type RefType)) (= (type first@@0) RefType)) (= (type last@@0) RefType)) (= (type values@@0) (SeqType intType))) (|lseg#everUsed| (lseg first@@0 last@@0 values@@0)))
 :qid |stdinbpl.578:15|
 :skolemid |63|
 :pattern ( (|lseg#trigger| Heap@@0 (lseg first@@0 last@@0 values@@0)))
)))
(assert (forall ((first@@1 T@U) (last@@1 T@U) (values@@1 T@U) ) (!  (=> (and (and (= (type first@@1) RefType) (= (type last@@1) RefType)) (= (type values@@1) (SeqType intType))) (= (getPredWandId (lseg first@@1 last@@1 values@@1)) 0))
 :qid |stdinbpl.563:15|
 :skolemid |60|
...
(assert (forall ((arg0@@31 T@U) (arg1@@13 T@U) (arg2@@5 T@U) ) (! (= (type (|lseg#sm| arg0@@31 arg1@@13 arg2@@5)) (FieldType PredicateType_lsegType (MapType1Type RefType boolType)))
 :qid |funType:lseg#sm|
 :pattern ( (|lseg#sm| arg0@@31 arg1@@13 arg2@@5))
)))
(assert (forall ((first@@2 T@U) (last@@2 T@U) (values@@2 T@U) ) (!  (=> (and (and (= (type first@@2) RefType) (= (type last@@2) RefType)) (= (type values@@2) (SeqType intType))) (= (PredicateMaskField (lseg first@@2 last@@2 values@@2)) (|lseg#sm| first@@2 last@@2 values@@2)))
 :qid |stdinbpl.555:15|
 :skolemid |58|
 :pattern ( (PredicateMaskField (lseg first@@2 last@@2 values@@2)))
)))
...
(assert (forall ((first@@3 T@U) (last@@3 T@U) (values@@3 T@U) (first2 T@U) (last2 T@U) (values2 T@U) ) (!  (=> (and (and (and (and (and (and (= (type first@@3) RefType) (= (type last@@3) RefType)) (= (type values@@3) (SeqType intType))) (= (type first2) RefType)) (= (type last2) RefType)) (= (type values2) (SeqType intType))) (= (lseg first@@3 last@@3 values@@3) (lseg first2 last2 values2))) (and (= first@@3 first2) (and (= last@@3 last2) (= values@@3 values2))))
 :qid |stdinbpl.569:15|
 :skolemid |61|
 :pattern ( (lseg first@@3 last@@3 values@@3) (lseg first2 last2 values2))
)))
(assert (forall ((first@@4 T@U) (last@@4 T@U) (values@@4 T@U) (first2@@0 T@U) (last2@@0 T@U) (values2@@0 T@U) ) (!  (=> (and (and (and (and (and (and (= (type first@@4) RefType) (= (type last@@4) RefType)) (= (type values@@4) (SeqType intType))) (= (type first2@@0) RefType)) (= (type last2@@0) RefType)) (= (type values2@@0) (SeqType intType))) (= (|lseg#sm| first@@4 last@@4 values@@4) (|lseg#sm| first2@@0 last2@@0 values2@@0))) (and (= first@@4 first2@@0) (and (= last@@4 last2@@0) (= values@@4 values2@@0))))
 :qid |stdinbpl.573:15|
 :skolemid |62|
...
(declare-fun last@@5 () T@U)
(declare-fun toAdd () Int)
(declare-fun values@@5 () T@U)
...
(declare-fun first@@5 () T@U)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@7) (MapType1Type RefType realType)) (= (type freshObj@0) RefType)) (= (type last@@5) RefType)) (= (type values@@5) (SeqType intType))) (= (type Heap@9) (MapType0Type RefType))) (= (type Heap@6) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@7) (MapType0Type RefType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@8) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@6) (MapType1Type RefType realType))) (forall ((arg0@@37 T@U) ) (! (= (type (FrameFragment arg0@@37)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@37))
))) (forall ((arg0@@38 T@U) (arg1@@18 T@U) ) (! (= (type (CombineFrames arg0@@38 arg1@@18)) FrameTypeType)
 :qid |funType:CombineFrames|
 :pattern ( (CombineFrames arg0@@38 arg1@@18))
))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type first@@5) RefType)))
(set-info :boogie-vc-id prepend)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 33) (let ((anon16_correct true))
(let ((anon24_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon16_correct)))
(let ((anon24_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@7 null (lseg freshObj@0 last@@5 (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5)))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@7 null (lseg freshObj@0 last@@5 (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5))))) (=> (= (ControlFlow 0 3) 2) anon16_correct))))))
...
(let ((anon23_Then_correct  (=> (not (= freshObj@0 last@@5)) (=> (and (= Heap@6 (MapType0Store Heap@5 null (|lseg#sm| freshObj@0 last@@5 (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5)) (MapType1Store (MapType0Select Heap@5 null (|lseg#sm| freshObj@0 last@@5 (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5))) freshObj@0 elem (bool_2_U true)))) (= Heap@7 (MapType0Store Heap@6 null (|lseg#sm| freshObj@0 last@@5 (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5)) (MapType1Store (MapType0Select Heap@6 null (|lseg#sm| freshObj@0 last@@5 (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5))) freshObj@0 next (bool_2_U true))))) (=> (and (and (forall ((o_4 T@U) (f_8 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_8))))
(let ((A@@12 (FieldTypeInv0 (type f_8))))
 (=> (and (and (= (type o_4) RefType) (= (type f_8) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@7 null (|lseg#sm| freshObj@0 last@@5 (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5))) o_4 f_8)) (U_2_bool (MapType1Select (MapType0Select Heap@7 null (|lseg#sm| (MapType0Select Heap@7 freshObj@0 next) last@@5 (|Seq#Drop| (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5) 1))) o_4 f_8)))) (U_2_bool (MapType1Select newPMask@0 o_4 f_8)))))
 :qid |stdinbpl.1008:29|
 :skolemid |65|
 :pattern ( (MapType1Select newPMask@0 o_4 f_8))
)) (= Heap@8 (MapType0Store Heap@7 null (|lseg#sm| freshObj@0 last@@5 (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5)) newPMask@0))) (and (= Heap@9 Heap@8) (= (ControlFlow 0 7) 6))) anon14_correct)))))
(let ((anon22_Else_correct  (=> (and (HasDirectPerm Mask@7 null (lseg freshObj@0 last@@5 (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5))) (= Heap@5 Heap@2)) (and (=> (= (ControlFlow 0 10) 7) anon23_Then_correct) (=> (= (ControlFlow 0 10) 8) anon23_Else_correct)))))
(let ((anon22_Then_correct  (=> (and (and (not (HasDirectPerm Mask@7 null (lseg freshObj@0 last@@5 (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5)))) (= Heap@3 (MapType0Store Heap@2 null (|lseg#sm| freshObj@0 last@@5 (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5)) ZeroPMask))) (and (= Heap@4 (MapType0Store Heap@3 null (lseg freshObj@0 last@@5 (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5)) freshVersion@0)) (= Heap@5 Heap@4))) (and (=> (= (ControlFlow 0 9) 7) anon23_Then_correct) (=> (= (ControlFlow 0 9) 8) anon23_Else_correct)))))
(let ((anon10_correct  (=> (= Mask@7 (MapType1Store Mask@6 null (lseg freshObj@0 last@@5 (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5)) (real_2_U (+ (U_2_real (MapType1Select Mask@6 null (lseg freshObj@0 last@@5 (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5)))) FullPerm)))) (=> (and (and (state Heap@2 Mask@7) (state Heap@2 Mask@7)) (and (|lseg#trigger| Heap@2 (lseg freshObj@0 last@@5 (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5))) (= (MapType0Select Heap@2 null (lseg freshObj@0 last@@5 (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5))) (FrameFragment (ite (not (= freshObj@0 last@@5)) (CombineFrames (FrameFragment (MapType0Select Heap@2 freshObj@0 elem)) (CombineFrames (FrameFragment (MapType0Select Heap@2 freshObj@0 next)) (MapType0Select Heap@2 null (lseg (MapType0Select Heap@2 freshObj@0 next) last@@5 (|Seq#Drop| (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5) 1))))) EmptyFrame))))) (and (=> (= (ControlFlow 0 11) 9) anon22_Then_correct) (=> (= (ControlFlow 0 11) 10) anon22_Else_correct))))))
(let ((anon9_correct  (=> (and (and (= Mask@5 (MapType1Store Mask@4 null (lseg (MapType0Select Heap@2 freshObj@0 next) last@@5 (|Seq#Drop| (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5) 1)) (real_2_U (- (U_2_real (MapType1Select Mask@4 null (lseg (MapType0Select Heap@2 freshObj@0 next) last@@5 (|Seq#Drop| (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5) 1)))) FullPerm)))) (InsidePredicate (lseg freshObj@0 last@@5 (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5)) (MapType0Select Heap@2 null (lseg freshObj@0 last@@5 (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5))) (lseg (MapType0Select Heap@2 freshObj@0 next) last@@5 (|Seq#Drop| (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5) 1)) (MapType0Select Heap@2 null (lseg (MapType0Select Heap@2 freshObj@0 next) last@@5 (|Seq#Drop| (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5) 1))))) (and (= Mask@6 Mask@5) (= (ControlFlow 0 13) 11))) anon10_correct)))
(let ((anon21_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 16) 13)) anon9_correct)))
(let ((anon21_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (U_2_real (MapType1Select Mask@4 null (lseg (MapType0Select Heap@2 freshObj@0 next) last@@5 (|Seq#Drop| (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5) 1)))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 null (lseg (MapType0Select Heap@2 freshObj@0 next) last@@5 (|Seq#Drop| (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5) 1))))) (=> (= (ControlFlow 0 14) 13) anon9_correct))))))
(let ((anon7_correct  (=> (= Mask@4 (MapType1Store Mask@3 freshObj@0 next (real_2_U (- (U_2_real (MapType1Select Mask@3 freshObj@0 next)) FullPerm)))) (and (=> (= (ControlFlow 0 17) (- 0 19)) (< 0 (|Seq#Length| (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5)))) (=> (< 0 (|Seq#Length| (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (= (U_2_int (MapType0Select Heap@2 freshObj@0 elem)) (U_2_int (|Seq#Index| (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5) 0)))) (=> (= (U_2_int (MapType0Select Heap@2 freshObj@0 elem)) (U_2_int (|Seq#Index| (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5) 0))) (and (=> (= (ControlFlow 0 17) 14) anon21_Then_correct) (=> (= (ControlFlow 0 17) 16) anon21_Else_correct)))))))))
(let ((anon20_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 22) 17)) anon7_correct)))
(let ((anon20_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (<= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 next)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 next))) (=> (= (ControlFlow 0 20) 17) anon7_correct))))))
(let ((anon5_correct  (=> (= Mask@3 (MapType1Store Mask@2 freshObj@0 elem (real_2_U (- (U_2_real (MapType1Select Mask@2 freshObj@0 elem)) FullPerm)))) (and (=> (= (ControlFlow 0 23) 20) anon20_Then_correct) (=> (= (ControlFlow 0 23) 22) anon20_Else_correct)))))
(let ((anon19_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 26) 23)) anon5_correct)))
(let ((anon19_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (<= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 elem)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 elem))) (=> (= (ControlFlow 0 24) 23) anon5_correct))))))
...
(let ((anon17_Else_correct  (=> (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@10 freshObj@0 $allocated)))) (=> (and (and (= Heap@0 (MapType0Store Heap@@10 freshObj@0 $allocated (bool_2_U true))) (= Mask@1 (MapType1Store Mask@0 freshObj@0 elem (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@0 elem)) FullPerm))))) (and (= Mask@2 (MapType1Store Mask@1 freshObj@0 next (real_2_U (+ (U_2_real (MapType1Select Mask@1 freshObj@0 next)) FullPerm)))) (state Heap@0 Mask@2))) (and (=> (= (ControlFlow 0 28) (- 0 31)) (= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 elem)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 elem))) (=> (and (= Heap@1 (MapType0Store Heap@0 freshObj@0 elem (int_2_U toAdd))) (state Heap@1 Mask@2)) (and (=> (= (ControlFlow 0 28) (- 0 30)) (= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 next)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@2 freshObj@0 next))) (=> (and (= Heap@2 (MapType0Store Heap@1 freshObj@0 next first@@5)) (state Heap@2 Mask@2)) (and (=> (= (ControlFlow 0 28) (- 0 29)) (|Seq#Equal| (|Seq#Drop| (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5) 1) values@@5)) (=> (|Seq#Equal| (|Seq#Drop| (|Seq#Append| (|Seq#Singleton| (int_2_U toAdd)) values@@5) 1) values@@5) (=> (state Heap@2 Mask@2) (and (=> (= (ControlFlow 0 28) 27) anon18_Then_correct) (=> (= (ControlFlow 0 28) 12) anon18_Else_correct)))))))))))))))
(let ((anon17_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 first@@5 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@10 last@@5 $allocated)) (= Mask@0 (MapType1Store ZeroMask null (lseg first@@5 last@@5 values@@5) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (lseg first@@5 last@@5 values@@5))) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 32) 1) anon17_Then_correct) (=> (= (ControlFlow 0 32) 28) anon17_Else_correct))))))
