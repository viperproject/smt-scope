(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:17:43
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0124.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(assert (forall ((i@7@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0124.vpr@8@10@8@65-aux|)))
(assert (forall ((i@7@01 Int)) (!
  (=>
    (Seq_contains (Seq_range 0 (- (Seq_length xs@2@01) 1)) i@7@01)
    (< (Seq_index xs@2@01 i@7@01) (Seq_index xs@2@01 (+ i@7@01 1))))
  :pattern ((Seq_index xs@2@01 i@7@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0124.vpr@8@10@8@65|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((i@9@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0124.vpr@13@10@13@65-aux|)))
(push) ; 3
(assert (not (forall ((i@9@01 Int)) (!
  ...
  :pattern ((Seq_index ys@8@01 i@9@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0124.vpr@13@10@13@65|))))
(check-sat)
; unsat
(pop) ; 3
; 0,00s
...
(assert (forall ((i1@17@01 Int) (i2@18@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length xs@12@01)) i1@17@01) (Seq_contains_trigger
    (Seq_range 0 (Seq_length xs@12@01))
    i2@18@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0124.vpr@19@10@19@104-aux|)))
(assert (forall ((i1@17@01 Int) (i2@18@01 Int)) (!
  (and
    (=>
      (Seq_contains (Seq_range 0 (Seq_length xs@12@01)) i1@17@01)
...
(assert (forall ((i1@17@01 Int) (i2@18@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length xs@12@01)) i2@18@01) (Seq_index
    ...
    i1@17@01))
  :pattern ((Seq_index xs@12@01 i1@17@01) (Seq_index xs@12@01 i2@18@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0124.vpr@19@10@19@104|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((i@24@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0124.vpr@21@10@21@60-aux|)))
(assert (forall ((i@24@01 Int)) (!
  (=>
    (Seq_contains (Seq_range 0 (- (Seq_length xs@12@01) 1)) i@24@01)
    (not (= ($FVF.lookup_f $t@20@01 (Seq_index xs@12@01 i@24@01)) 0)))
  :pattern ((Seq_index xs@12@01 i@24@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0124.vpr@21@10@21@60|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((i@26@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0124.vpr@25@10@25@60-aux|)))
(push) ; 3
(assert (not (forall ((i@26@01 Int)) (!
  ...
  :pattern ((Seq_index ys@25@01 i@26@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0124.vpr@25@10@25@60|))))
(check-sat)
; unsat
(pop) ; 3
; 0,00s
...
(assert (forall ((i1@34@01 Int) (i2@35@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length xs@29@01)) i1@34@01) (Seq_contains_trigger
    (Seq_range 0 (Seq_length xs@29@01))
    i2@35@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0124.vpr@30@10@30@104-aux|)))
(assert (forall ((i1@34@01 Int) (i2@35@01 Int)) (!
  (and
    (=>
      (Seq_contains (Seq_range 0 (Seq_length xs@29@01)) i1@34@01)
...
(assert (forall ((i1@34@01 Int) (i2@35@01 Int)) (!
  ...
  :pattern ((Seq_contains_trigger (Seq_range 0 (Seq_length xs@29@01)) i2@35@01) (Seq_index
    ...
    i1@34@01))
  :pattern ((Seq_index xs@29@01 i1@34@01) (Seq_index xs@29@01 i2@35@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0124.vpr@30@10@30@104|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((i@41@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0124.vpr@32@10@32@69-aux|)))
(assert (forall ((i@41@01 Int)) (!
  (=>
    (Seq_contains (Seq_range 0 (- (Seq_length xs@29@01) 1)) i@41@01)
    (<
  ...
  :pattern ((Seq_index xs@29@01 i@41@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0124.vpr@32@10@32@69|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(assert (forall ((i@43@01 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0124.vpr@37@10@37@69-aux|)))
(push) ; 3
(assert (not (forall ((i@43@01 Int)) (!
  ...
  :pattern ((Seq_index ys@42@01 i@43@01))
  :qid |prog./silicon/silver/src/test/resources/quantifiedpermissions/issues/issue_0124.vpr@37@10@37@69|))))
(check-sat)
; unsat
(pop) ; 3
; 0,00s
