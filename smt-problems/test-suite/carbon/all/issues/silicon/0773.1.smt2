...
(let ((anon9_Else_correct  (=> (not __plugin_refute_nondet1) (=> (and (state Heap@@23 ZeroMask) (state Heap@@23 ZeroMask)) (and (=> (= (ControlFlow 0 6) 4) anon10_Then_correct) (=> (= (ControlFlow 0 6) 5) anon10_Else_correct))))))
(let ((anon9_Then_correct  (=> (and __plugin_refute_nondet1 (= (ControlFlow 0 3) (- 0 2))) false)))
(let ((anon8_Else_correct  (=> (state Heap@@23 ZeroMask) (=> (and (and (state Heap@@23 ZeroMask) (state Heap@@23 ZeroMask)) (and (state Heap@@23 ZeroMask) (state Heap@@23 ZeroMask))) (and (=> (= (ControlFlow 0 7) 3) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct))))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@23 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 8) 1) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct)))))
