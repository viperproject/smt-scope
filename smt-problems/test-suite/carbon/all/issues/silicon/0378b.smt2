...
(declare-fun |inv'| (T@U Int Int) Bool)
...
(declare-fun foo (Int) T@U)
(declare-fun |inv#condqp1| (T@U Int Int) Int)
(declare-fun NoPerm () Real)
(declare-fun |sk_inv#condqp1| (Int Int) Int)
(declare-fun dummyHeap () T@U)
(declare-fun ZeroMask () T@U)
(declare-fun |inv#frame| (T@U Int Int) Bool)
...
(assert (forall ((Heap@@0 T@U) (x@@8 Int) (k Int) ) (!  (=> (= (type Heap@@0) (MapType0Type RefType)) (dummyFunction (bool_2_U (|inv#triggerStateless| x@@8 k))))
 :qid |stdinbpl.231:15|
 :skolemid |24|
 :pattern ( (|inv'| Heap@@0 x@@8 k))
)))
...
(assert (forall ((arg0@@25 Int) ) (! (= (type (foo arg0@@25)) RefType)
 :qid |funType:foo|
 :pattern ( (foo arg0@@25))
)))
(assert (forall ((i_1 Int) (j Int) ) (!  (=> (= (foo i_1) (foo j)) (= i_1 j))
 :qid |stdinbpl.207:15|
 :skolemid |22|
 :pattern ( (foo i_1) (foo j))
)))
...
(assert (forall ((Heap2Heap T@U) (Heap1Heap T@U) (x@@9 Int) (k@@0 Int) ) (!  (=> (and (and (= (type Heap2Heap) (MapType0Type RefType)) (= (type Heap1Heap) (MapType0Type RefType))) (and (= (< NoPerm (/ (to_real 1) (to_real 2))) (< NoPerm (/ (to_real 1) (to_real 2)))) (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (U_2_int (MapType0Select Heap2Heap (foo (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap x@@9 k@@0) (|inv#condqp1| Heap1Heap x@@9 k@@0))) val)) (U_2_int (MapType0Select Heap1Heap (foo (|sk_inv#condqp1| (|inv#condqp1| Heap2Heap x@@9 k@@0) (|inv#condqp1| Heap1Heap x@@9 k@@0))) val)))))) (= (|inv#condqp1| Heap2Heap x@@9 k@@0) (|inv#condqp1| Heap1Heap x@@9 k@@0)))
 :qid |stdinbpl.254:15|
 :skolemid |27|
 :pattern ( (|inv#condqp1| Heap2Heap x@@9 k@@0) (|inv#condqp1| Heap1Heap x@@9 k@@0) (succHeapTrans Heap2Heap Heap1Heap))
)))
...
(assert  (and (forall ((arg0@@26 T@U) (arg1@@9 T@U) ) (! (= (type (CombineFrames arg0@@26 arg1@@9)) FrameTypeType)
 :qid |funType:CombineFrames|
 :pattern ( (CombineFrames arg0@@26 arg1@@9))
)) (forall ((arg0@@27 T@U) ) (! (= (type (FrameFragment arg0@@27)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@27))
))))
(assert (forall ((Heap@@5 T@U) (Mask@@4 T@U) (x@@10 Int) (k@@1 Int) ) (!  (=> (and (and (= (type Heap@@5) (MapType0Type RefType)) (= (type Mask@@4) (MapType1Type RefType realType))) (state Heap@@5 Mask@@4)) (= (|inv'| Heap@@5 x@@10 k@@1) (|inv#frame| (CombineFrames (FrameFragment (MapType0Select Heap@@5 (foo k@@1) val)) (FrameFragment (int_2_U (|inv#condqp1| Heap@@5 x@@10 k@@1)))) x@@10 k@@1)))
 :qid |stdinbpl.244:15|
 :skolemid |26|
 :pattern ( (state Heap@@5 Mask@@4) (|inv'| Heap@@5 x@@10 k@@1))
)))
...
(assert (forall ((Heap@@9 T@U) (Mask@@9 T@U) (x@@11 Int) (k@@2 Int) ) (!  (=> (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (and (state Heap@@9 Mask@@9) (< AssumeFunctionsAbove 0))) (>= x@@11 0)) (= (inv Heap@@9 x@@11 k@@2)  (=> (not (= x@@11 0)) (|inv'| Heap@@9 (- x@@11 1) k@@2))))
 :qid |stdinbpl.237:15|
 :skolemid |25|
 :pattern ( (state Heap@@9 Mask@@9) (inv Heap@@9 x@@11 k@@2))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@12 T@U) (x@@12 Int) (k@@3 Int) ) (!  (=> (= (type Heap@@12) (MapType0Type RefType)) (and (= (inv Heap@@12 x@@12 k@@3) (|inv'| Heap@@12 x@@12 k@@3)) (dummyFunction (bool_2_U (|inv#triggerStateless| x@@12 k@@3)))))
 :qid |stdinbpl.227:15|
 :skolemid |23|
 :pattern ( (inv Heap@@12 x@@12 k@@3))
)))
(push 1)
...
(declare-fun |inv#trigger| (T@U Int Int) Bool)
(declare-fun qpRange1 (T@U) Bool)
(declare-fun invRecv1 (T@U) Int)
(declare-fun Mask@0 () T@U)
(declare-fun perm@0 () Real)
(assert  (and (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |inv#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon6_correct  (=> (= Mask@1 (MapType1Store QPMask@0 (foo k@@4) val (real_2_U (- (U_2_real (MapType1Select QPMask@0 (foo k@@4) val)) perm@1)))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (forall ((i_5 Int) ) (!  (=> (dummyFunction (MapType0Select Heap@@13 (foo i_5) val)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.359:23|
 :skolemid |35|
 :pattern ( (foo i_5))
 :pattern ( (foo i_5))
))) (=> (forall ((i_5@@0 Int) ) (!  (=> (dummyFunction (MapType0Select Heap@@13 (foo i_5@@0) val)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.359:23|
 :skolemid |35|
 :pattern ( (foo i_5@@0))
 :pattern ( (foo i_5@@0))
)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((i_5@@1 Int) (i_5_1 Int) ) (!  (=> (and (and (not (= i_5@@1 i_5_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (foo i_5@@1) (foo i_5_1))))
 :qid |stdinbpl.366:23|
 :skolemid |36|
...
)) (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((i_5@@3 Int) ) (! (>= (U_2_real (MapType1Select Mask@1 (foo i_5@@3) val)) (/ (to_real 1) (to_real 2)))
 :qid |stdinbpl.373:23|
 :skolemid |37|
 :pattern ( (foo i_5@@3))
 :pattern ( (foo i_5@@3))
))))))))))
(let ((anon12_Else_correct  (=> (and (= perm@1 NoPerm) (= (ControlFlow 0 11) 6)) anon6_correct)))
(let ((anon12_Then_correct  (=> (not (= perm@1 NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= perm@1 (U_2_real (MapType1Select QPMask@0 (foo k@@4) val)))) (=> (<= perm@1 (U_2_real (MapType1Select QPMask@0 (foo k@@4) val))) (=> (= (ControlFlow 0 9) 6) anon6_correct))))))
(let ((anon11_Then_correct  (and (=> (= (ControlFlow 0 12) (- 0 14)) (>= (- x@@13 1) 0)) (=> (>= (- x@@13 1) 0) (=> (= perm@1 (/ (to_real 1) (to_real 2))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (and (=> (= (ControlFlow 0 12) 9) anon12_Then_correct) (=> (= (ControlFlow 0 12) 11) anon12_Else_correct)))))))))
(let ((anon8_correct true))
(let ((anon11_Else_correct  (=> (and (|inv#trigger| (CombineFrames (FrameFragment (MapType0Select Heap@@13 (foo k@@4) val)) (FrameFragment (int_2_U (|inv#condqp1| Heap@@13 (- x@@13 1) k@@4)))) (- x@@13 1) k@@4) (= (ControlFlow 0 4) 2)) anon8_correct)))
(let ((anon10_Then_correct  (=> (not (= x@@13 0)) (and (=> (= (ControlFlow 0 15) 12) anon11_Then_correct) (=> (= (ControlFlow 0 15) 4) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (= x@@13 0) (= (ControlFlow 0 3) 2)) anon8_correct)))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 18)) (forall ((i_4 Int) (i_4_1 Int) ) (!  (=> (and (and (not (= i_4 i_4_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (foo i_4) (foo i_4_1))))
 :qid |stdinbpl.297:15|
 :skolemid |28|
))) (=> (forall ((i_4@@0 Int) (i_4_1@@0 Int) ) (!  (=> (and (and (not (= i_4@@0 i_4_1@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (foo i_4@@0) (foo i_4_1@@0))))
 :qid |stdinbpl.297:15|
 :skolemid |28|
)) (=> (and (forall ((i_4@@1 Int) ) (!  (=> (< NoPerm (/ (to_real 1) (to_real 2))) (and (qpRange1 (foo i_4@@1)) (= (invRecv1 (foo i_4@@1)) i_4@@1)))
 :qid |stdinbpl.303:22|
 :skolemid |29|
 :pattern ( (foo i_4@@1))
 :pattern ( (foo i_4@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange1 o_3)) (= (foo (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.307:22|
 :skolemid |30|
 :pattern ( (invRecv1 o_3))
))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((i_4@@2 Int) ) (! (>= (/ (to_real 1) (to_real 2)) NoPerm)
 :qid |stdinbpl.313:15|
 :skolemid |31|
 :pattern ( (foo i_4@@2))
 :pattern ( (foo i_4@@2))
))) (=> (forall ((i_4@@3 Int) ) (! (>= (/ (to_real 1) (to_real 2)) NoPerm)
 :qid |stdinbpl.313:15|
 :skolemid |31|
 :pattern ( (foo i_4@@3))
 :pattern ( (foo i_4@@3))
)) (=> (forall ((i_4@@4 Int) ) (!  (=> (> (/ (to_real 1) (to_real 2)) NoPerm) (not (= (foo i_4@@4) null)))
 :qid |stdinbpl.319:22|
 :skolemid |32|
 :pattern ( (foo i_4@@4))
 :pattern ( (foo i_4@@4))
)) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange1 o_3@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (foo (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (+ (U_2_real (MapType1Select Mask@0 o_3@@0 val)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (< NoPerm (/ (to_real 1) (to_real 2))) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 val)) (U_2_real (MapType1Select Mask@0 o_3@@0 val))))))
 :qid |stdinbpl.325:22|
 :skolemid |33|
...
))) (and (state Heap@@13 QPMask@0) (state Heap@@13 QPMask@0))) (and (=> (= (ControlFlow 0 16) 15) anon10_Then_correct) (=> (= (ControlFlow 0 16) 3) anon10_Else_correct)))))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (and (= AssumeFunctionsAbove 0) (>= x@@13 0)) (and (state Heap@@13 ZeroMask) (= perm@0 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (and (=> (> perm@0 NoPerm) (not (= (foo k@@4) null))) (= Mask@0 (MapType1Store ZeroMask (foo k@@4) val (real_2_U (+ (U_2_real (MapType1Select ZeroMask (foo k@@4) val)) perm@0))))) (and (state Heap@@13 Mask@0) (state Heap@@13 Mask@0))) (and (=> (= (ControlFlow 0 19) 1) anon9_Then_correct) (=> (= (ControlFlow 0 19) 16) anon9_Else_correct)))))))))
