...
(assert  (and (and (and (and (and (and (= (type S1) (SeqType RefType)) (= (type S2) (MapType2Type RefType boolType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type x@@22) RefType)))
(set-info :boogie-vc-id m01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon12_Else_correct  (=> (= (ControlFlow 0 11) (- 0 10)) (forall ((y_1 T@U) (y_1_1 T@U) ) (!  (=> (and (= (type y_1) RefType) (= (type y_1_1) RefType)) (=> (and (and (and (and (not (= y_1 y_1_1)) (U_2_bool (MapType2Select S2 y_1))) (U_2_bool (MapType2Select S2 y_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_1 y_1_1))))
 :qid |stdinbpl.873:15|
 :skolemid |124|
 :no-pattern (type y_1)
...
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((y_2 T@U) (y_2_1 T@U) ) (!  (=> (and (= (type y_2) RefType) (= (type y_2_1) RefType)) (=> (and (and (and (and (not (= y_2 y_2_1)) (U_2_bool (MapType2Select S2 y_2))) (U_2_bool (MapType2Select S2 y_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_2 y_2_1))))
 :qid |stdinbpl.920:17|
 :skolemid |130|
 :pattern ( (neverTriggered3 y_2) (neverTriggered3 y_2_1))
))) (=> (forall ((y_2@@0 T@U) (y_2_1@@0 T@U) ) (!  (=> (and (= (type y_2@@0) RefType) (= (type y_2_1@@0) RefType)) (=> (and (and (and (and (not (= y_2@@0 y_2_1@@0)) (U_2_bool (MapType2Select S2 y_2@@0))) (U_2_bool (MapType2Select S2 y_2_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y_2@@0 y_2_1@@0))))
 :qid |stdinbpl.920:17|
 :skolemid |130|
 :pattern ( (neverTriggered3 y_2@@0) (neverTriggered3 y_2_1@@0))
)) (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((y_2@@1 T@U) ) (!  (=> (and (= (type y_2@@1) RefType) (U_2_bool (MapType2Select S2 y_2@@1))) (>= (U_2_real (MapType1Select QPMask@0 y_2@@1 f_7)) FullPerm))
 :qid |stdinbpl.927:17|
 :skolemid |131|
 :pattern ( (MapType0Select Heap@@9 y_2@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 y_2@@1 f_7))
 :pattern ( (MapType2Select S2 y_2@@1))
)))))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U i_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| S1 i_1) (|Seq#Index| S1 i_1_1))))
 ...
 :qid |stdinbpl.822:15|
 :skolemid |118|
)) (=> (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U i_1@@1)) (< NoPerm FullPerm)) (and (qpRange1 (|Seq#Index| S1 i_1@@1)) (= (invRecv1 (|Seq#Index| S1 i_1@@1)) i_1@@1)))
 :qid |stdinbpl.828:22|
 :skolemid |119|
 ...
 :pattern ( (|Seq#Index| S1 i_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (|Seq#Index| S1 (invRecv1 o_3)) o_3)))
 :qid |stdinbpl.832:22|
 :skolemid |120|
 ...
 :pattern ( (|Seq#Index| S1 i_1@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (|Seq#Index| S1 (invRecv1 o_3@@0)) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.844:22|
 :skolemid |122|
...
(let ((anon10_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U i@@6))) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| S1)) (int_2_U i@@6)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i@@6 (|Seq#Length| S1))) (=> (< i@@6 (|Seq#Length| S1)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
