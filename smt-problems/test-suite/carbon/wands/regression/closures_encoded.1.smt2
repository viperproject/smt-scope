...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@14) (MapType0Type RefType realType)) (= (type x@@44) RefType)) (= (type Mask@13) (MapType0Type RefType realType))) (= (type Mask@12) (MapType0Type RefType realType))) (= (type ExhaleHeap@3) (MapType1Type RefType))) (= (type ExhaleHeap@4) (MapType1Type RefType))) (= (type Mask@11) (MapType0Type RefType realType))) (= (type Mask@10) (MapType0Type RefType realType))) (= (type ExhaleHeap@2) (MapType1Type RefType))) (= (type Mask@8) (MapType0Type RefType realType))) (= (type Mask@7) (MapType0Type RefType realType))) (= (type ExhaleHeap@1) (MapType1Type RefType))) (= (type Mask@9) (MapType0Type RefType realType))) (= (type Mask@5) (MapType0Type RefType realType))) (= (type Mask@4) (MapType0Type RefType realType))) (= (type ExhaleHeap@0) (MapType1Type RefType))) (= (type Mask@6) (MapType0Type RefType realType))) (= (type Mask@2) (MapType0Type RefType realType))) (= (type Mask@1) (MapType0Type RefType realType))) (= (type Heap@@15) (MapType1Type RefType))) (= (type Mask@3) (MapType0Type RefType realType))) (= (type Mask@0) (MapType0Type RefType realType))) (= (type WandDefLHSMask@0) (MapType0Type RefType realType))) (= (type WandDefLHSHeap@0) (MapType1Type RefType))) (= (type WandDefRHSMask@0) (MapType0Type RefType realType))) (= (type WandDefRHSHeap@0) (MapType1Type RefType))))
(set-info :boogie-vc-id triple_nested)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 33) (let ((anon20_Else_correct true))
(let ((anon20_Then_correct true))
(let ((anon19_Then_correct  (=> (and (= WandDefLHSMask@0 (MapType0Store ZeroMask null (c1_post x@@44) (real_2_U (+ (U_2_real (MapType0Select ZeroMask null (c1_post x@@44))) FullPerm)))) (state WandDefLHSHeap@0 WandDefLHSMask@0)) (=> (and (and (state WandDefLHSHeap@0 WandDefLHSMask@0) (state WandDefLHSHeap@0 WandDefLHSMask@0)) (and (= WandDefRHSMask@0 (MapType0Store ZeroMask null (c2_pre x@@44) (real_2_U (+ (U_2_real (MapType0Select ZeroMask null (c2_pre x@@44))) FullPerm)))) (state WandDefRHSHeap@0 WandDefRHSMask@0))) (and (=> (= (ControlFlow 0 31) 29) anon20_Then_correct) (=> (= (ControlFlow 0 31) 30) anon20_Else_correct))))))
(let ((anon18_correct true))
(let ((anon27_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon18_correct)))
(let ((anon27_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType0Select Mask@14 null (c3_post x@@44))))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@14 null (c3_post x@@44)))) (=> (= (ControlFlow 0 3) 2) anon18_correct))))))
(let ((anon16_correct  (=> (= Mask@13 (MapType0Store Mask@12 null (c3_pre x@@44) (real_2_U (- (U_2_real (MapType0Select Mask@12 null (c3_pre x@@44))) FullPerm)))) (=> (and (IdenticalOnKnownLocations ExhaleHeap@3 ExhaleHeap@4 Mask@13) (state ExhaleHeap@4 Mask@13)) (=> (and (and (= Mask@14 (MapType0Store Mask@13 null (c3_post x@@44) (real_2_U (+ (U_2_real (MapType0Select Mask@13 null (c3_post x@@44))) FullPerm)))) (state ExhaleHeap@4 Mask@14)) (and (state ExhaleHeap@4 Mask@14) (state ExhaleHeap@4 Mask@14))) (and (=> (= (ControlFlow 0 6) 3) anon27_Then_correct) (=> (= (ControlFlow 0 6) 5) anon27_Else_correct)))))))
(let ((anon26_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon16_correct)))
(let ((anon26_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType0Select Mask@12 null (c3_pre x@@44))))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@12 null (c3_pre x@@44)))) (=> (= (ControlFlow 0 7) 6) anon16_correct))))))
(let ((anon14_correct  (=> (and (and (and (= Mask@11 (MapType0Store Mask@10 null (c2_post x@@44) (real_2_U (- (U_2_real (MapType0Select Mask@10 null (c2_post x@@44))) FullPerm)))) (state ExhaleHeap@2 Mask@11)) (and (= Mask@12 (MapType0Store Mask@11 null (c3_pre x@@44) (real_2_U (+ (U_2_real (MapType0Select Mask@11 null (c3_pre x@@44))) FullPerm)))) (state ExhaleHeap@2 Mask@12))) (and (and (state ExhaleHeap@2 Mask@12) (IdenticalOnKnownLocations ExhaleHeap@2 ExhaleHeap@3 Mask@12)) (and (state ExhaleHeap@3 Mask@12) (state ExhaleHeap@3 Mask@12)))) (and (=> (= (ControlFlow 0 10) 7) anon26_Then_correct) (=> (= (ControlFlow 0 10) 9) anon26_Else_correct)))))
(let ((anon25_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 10)) anon14_correct)))
(let ((anon25_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType0Select Mask@10 null (c2_post x@@44))))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@10 null (c2_post x@@44)))) (=> (= (ControlFlow 0 11) 10) anon14_correct))))))
(let ((anon12_correct  (=> (= Mask@8 (MapType0Store Mask@7 null (c2_pre x@@44) (real_2_U (- (U_2_real (MapType0Select Mask@7 null (c2_pre x@@44))) FullPerm)))) (=> (and (IdenticalOnKnownLocations ExhaleHeap@1 ExhaleHeap@2 Mask@8) (state ExhaleHeap@2 Mask@8)) (=> (and (and (= Mask@9 (MapType0Store Mask@8 null (c2_post x@@44) (real_2_U (+ (U_2_real (MapType0Select Mask@8 null (c2_post x@@44))) FullPerm)))) (state ExhaleHeap@2 Mask@9)) (and (state ExhaleHeap@2 Mask@9) (state ExhaleHeap@2 Mask@9))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= FullPerm (U_2_real (MapType0Select Mask@9 null (wand_1 x@@44 FullPerm x@@44 FullPerm))))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@9 null (wand_1 x@@44 FullPerm x@@44 FullPerm)))) (=> (and (= Mask@10 (MapType0Store Mask@9 null (wand_1 x@@44 FullPerm x@@44 FullPerm) (real_2_U (- (U_2_real (MapType0Select Mask@9 null (wand_1 x@@44 FullPerm x@@44 FullPerm))) FullPerm)))) (state ExhaleHeap@2 Mask@10)) (and (=> (= (ControlFlow 0 14) 11) anon25_Then_correct) (=> (= (ControlFlow 0 14) 13) anon25_Else_correct))))))))))
(let ((anon24_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 18) 14)) anon12_correct)))
(let ((anon24_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= FullPerm (U_2_real (MapType0Select Mask@7 null (c2_pre x@@44))))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@7 null (c2_pre x@@44)))) (=> (= (ControlFlow 0 16) 14) anon12_correct))))))
(let ((anon10_correct  (=> (and (= Mask@5 (MapType0Store Mask@4 null (c1_post x@@44) (real_2_U (- (U_2_real (MapType0Select Mask@4 null (c1_post x@@44))) FullPerm)))) (state ExhaleHeap@0 Mask@5)) (=> (and (and (and (= Mask@6 (MapType0Store Mask@5 null (c2_pre x@@44) (real_2_U (+ (U_2_real (MapType0Select Mask@5 null (c2_pre x@@44))) FullPerm)))) (state ExhaleHeap@0 Mask@6)) (and (= Mask@7 (MapType0Store Mask@6 null (wand_1 x@@44 FullPerm x@@44 FullPerm) (real_2_U (+ (U_2_real (MapType0Select Mask@6 null (wand_1 x@@44 FullPerm x@@44 FullPerm))) FullPerm)))) (state ExhaleHeap@0 Mask@7))) (and (and (state ExhaleHeap@0 Mask@7) (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@1 Mask@7)) (and (state ExhaleHeap@1 Mask@7) (state ExhaleHeap@1 Mask@7)))) (and (=> (= (ControlFlow 0 19) 16) anon24_Then_correct) (=> (= (ControlFlow 0 19) 18) anon24_Else_correct))))))
(let ((anon23_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 22) 19)) anon10_correct)))
(let ((anon23_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (<= FullPerm (U_2_real (MapType0Select Mask@4 null (c1_post x@@44))))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@4 null (c1_post x@@44)))) (=> (= (ControlFlow 0 20) 19) anon10_correct))))))
(let ((anon8_correct  (=> (= Mask@2 (MapType0Store Mask@1 null (c1_pre x@@44) (real_2_U (- (U_2_real (MapType0Select Mask@1 null (c1_pre x@@44))) FullPerm)))) (=> (and (IdenticalOnKnownLocations Heap@@15 ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)) (=> (and (and (= Mask@3 (MapType0Store Mask@2 null (c1_post x@@44) (real_2_U (+ (U_2_real (MapType0Select Mask@2 null (c1_post x@@44))) FullPerm)))) (state ExhaleHeap@0 Mask@3)) (and (state ExhaleHeap@0 Mask@3) (state ExhaleHeap@0 Mask@3))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (<= FullPerm (U_2_real (MapType0Select Mask@3 null (wand_4 x@@44 FullPerm x@@44 FullPerm x@@44 FullPerm x@@44 FullPerm))))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@3 null (wand_4 x@@44 FullPerm x@@44 FullPerm x@@44 FullPerm x@@44 FullPerm)))) (=> (and (= Mask@4 (MapType0Store Mask@3 null (wand_4 x@@44 FullPerm x@@44 FullPerm x@@44 FullPerm x@@44 FullPerm) (real_2_U (- (U_2_real (MapType0Select Mask@3 null (wand_4 x@@44 FullPerm x@@44 FullPerm x@@44 FullPerm x@@44 FullPerm))) FullPerm)))) (state ExhaleHeap@0 Mask@4)) (and (=> (= (ControlFlow 0 23) 20) anon23_Then_correct) (=> (= (ControlFlow 0 23) 22) anon23_Else_correct))))))))))
(let ((anon22_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 27) 23)) anon8_correct)))
(let ((anon22_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 25) (- 0 26)) (<= FullPerm (U_2_real (MapType0Select Mask@1 null (c1_pre x@@44))))) (=> (<= FullPerm (U_2_real (MapType0Select Mask@1 null (c1_pre x@@44)))) (=> (= (ControlFlow 0 25) 23) anon8_correct))))))
(let ((anon21_Then_correct true))
(let ((anon19_Else_correct  (=> (= Mask@1 (MapType0Store Mask@0 null (wand_4 x@@44 FullPerm x@@44 FullPerm x@@44 FullPerm x@@44 FullPerm) (real_2_U (+ (U_2_real (MapType0Select Mask@0 null (wand_4 x@@44 FullPerm x@@44 FullPerm x@@44 FullPerm x@@44 FullPerm))) FullPerm)))) (=> (and (state Heap@@15 Mask@1) (state Heap@@15 Mask@1)) (and (and (=> (= (ControlFlow 0 28) 1) anon21_Then_correct) (=> (= (ControlFlow 0 28) 25) anon22_Then_correct)) (=> (= (ControlFlow 0 28) 27) anon22_Else_correct))))))
(let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and (U_2_bool (MapType1Select Heap@@15 x@@44 $allocated)) (= Mask@0 (MapType0Store ZeroMask null (c1_pre x@@44) (real_2_U (+ (U_2_real (MapType0Select ZeroMask null (c1_pre x@@44))) FullPerm))))) (and (state Heap@@15 Mask@0) (state Heap@@15 Mask@0))) (and (=> (= (ControlFlow 0 32) 31) anon19_Then_correct) (=> (= (ControlFlow 0 32) 28) anon19_Else_correct))))))
