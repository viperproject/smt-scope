...
(set-info :boogie-vc-id |Node_rev_prev#definedness|)
...
(let ((anon9_Then_correct  (=> (not (= (MapType0Select Heap@2 this@@55 Node_prev) null)) (=> (and (and (forall ((o_6 T@U) (f_10 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_10))))
(let ((A@@12 (FieldTypeInv0 (type f_10))))
 (=> (and (and (= (type o_6) RefType) (= (type f_10) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@2 null (|Node_reverse#sm| this@@55)) o_6 f_10)) (U_2_bool (MapType1Select (MapType0Select Heap@2 null (|Node_reverse#sm| (MapType0Select Heap@2 this@@55 Node_prev))) o_6 f_10)))) (U_2_bool (MapType1Select newPMask@0 o_6 f_10)))))
 :qid |stdinbpl.729:33|
 :skolemid |55|
...
(declare-fun sent@0 () T@U)
(declare-fun Mask@1 () T@U)
(declare-fun Mask@0 () T@U)
(declare-fun Heap@@35 () T@U)
(declare-fun sent () T@U)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Mask@6) (MapType1Type RefType realType)) (= (type freshObj@0) RefType)) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type newPMask@0) (MapType1Type RefType boolType))) (= (type Heap@6) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (forall ((arg0@@64 T@U) (arg1@@45 T@U) ) (! (= (type (CombineFrames arg0@@64 arg1@@45)) FrameTypeType)
 :qid |funType:CombineFrames|
 :pattern ( (CombineFrames arg0@@64 arg1@@45))
))) (forall ((arg0@@65 T@U) ) (! (= (type (FrameFragment arg0@@65)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@65))
))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type sent@0) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@35) (MapType0Type RefType))) (= (type sent) RefType)))
(set-info :boogie-vc-id List_new)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((anon14_correct true))
(let ((anon21_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon14_correct)))
(let ((anon21_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@6 null (List_state freshObj@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@6 null (List_state freshObj@0)))) (=> (= (ControlFlow 0 3) 2) anon14_correct))))))
(let ((anon12_correct  (=> (= Heap@5 (MapType0Store Heap@4 null (|List_state#sm| freshObj@0) (MapType1Store (MapType0Select Heap@4 null (|List_state#sm| freshObj@0)) freshObj@0 List_sentinel (bool_2_U true)))) (=> (and (and (forall ((o_34 T@U) (f_38 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_38))))
(let ((A@@12 (FieldTypeInv0 (type f_38))))
 (=> (and (and (= (type o_34) RefType) (= (type f_38) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@5 null (|List_state#sm| freshObj@0)) o_34 f_38)) (U_2_bool (MapType1Select (MapType0Select Heap@5 null (|Node_state#sm| (MapType0Select Heap@5 freshObj@0 List_sentinel))) o_34 f_38)))) (U_2_bool (MapType1Select newPMask@0 o_34 f_38)))))
 :qid |stdinbpl.6788:27|
 :skolemid |123|
 :pattern ( (MapType1Select newPMask@0 o_34 f_38))
)) (= Heap@6 (MapType0Store Heap@5 null (|List_state#sm| freshObj@0) newPMask@0))) (and (state Heap@6 Mask@6) (state Heap@6 Mask@6))) (and (=> (= (ControlFlow 0 6) 3) anon21_Then_correct) (=> (= (ControlFlow 0 6) 5) anon21_Else_correct))))))
(let ((anon20_Else_correct  (=> (HasDirectPerm Mask@6 null (List_state freshObj@0)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 8) 6)) anon12_correct))))
(let ((anon20_Then_correct  (=> (not (HasDirectPerm Mask@6 null (List_state freshObj@0))) (=> (and (and (= Heap@2 (MapType0Store Heap@1 null (|List_state#sm| freshObj@0) ZeroPMask)) (= Heap@3 (MapType0Store Heap@2 null (List_state freshObj@0) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 7) 6))) anon12_correct))))
(let ((anon10_correct  (=> (= Mask@5 (MapType1Store Mask@4 null (Node_state (MapType0Select Heap@1 freshObj@0 List_sentinel)) (real_2_U (- (U_2_real (MapType1Select Mask@4 null (Node_state (MapType0Select Heap@1 freshObj@0 List_sentinel)))) FullPerm)))) (=> (and (InsidePredicate (List_state freshObj@0) (MapType0Select Heap@1 null (List_state freshObj@0)) (Node_state (MapType0Select Heap@1 freshObj@0 List_sentinel)) (MapType0Select Heap@1 null (Node_state (MapType0Select Heap@1 freshObj@0 List_sentinel)))) (= Mask@6 (MapType1Store Mask@5 null (List_state freshObj@0) (real_2_U (+ (U_2_real (MapType1Select Mask@5 null (List_state freshObj@0))) FullPerm))))) (=> (and (and (state Heap@1 Mask@6) (state Heap@1 Mask@6)) (and (|List_state#trigger| Heap@1 (List_state freshObj@0)) (= (MapType0Select Heap@1 null (List_state freshObj@0)) (CombineFrames (FrameFragment (MapType0Select Heap@1 freshObj@0 List_sentinel)) (MapType0Select Heap@1 null (Node_state (MapType0Select Heap@1 freshObj@0 List_sentinel))))))) (and (=> (= (ControlFlow 0 9) 7) anon20_Then_correct) (=> (= (ControlFlow 0 9) 8) anon20_Else_correct)))))))
(let ((anon19_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon10_correct)))
(let ((anon19_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select Mask@4 null (Node_state (MapType0Select Heap@1 freshObj@0 List_sentinel)))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 null (Node_state (MapType0Select Heap@1 freshObj@0 List_sentinel))))) (=> (= (ControlFlow 0 10) 9) anon10_correct))))))
(let ((anon8_correct  (=> (= Mask@4 (MapType1Store Mask@3 freshObj@0 List_sentinel (real_2_U (- (U_2_real (MapType1Select Mask@3 freshObj@0 List_sentinel)) FullPerm)))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (not (= (MapType0Select Heap@1 freshObj@0 List_sentinel) null))) (=> (not (= (MapType0Select Heap@1 freshObj@0 List_sentinel) null)) (and (=> (= (ControlFlow 0 13) 10) anon19_Then_correct) (=> (= (ControlFlow 0 13) 12) anon19_Else_correct)))))))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 17) 13)) anon8_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 List_sentinel)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 List_sentinel))) (=> (= (ControlFlow 0 15) 13) anon8_correct))))))
(let ((anon6_correct  (=> (IdenticalOnKnownLocations Heap@0 ExhaleHeap@0 Mask@2) (=> (and (and (and (= Mask@3 (MapType1Store Mask@2 null (Node_state sent@0) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (Node_state sent@0))) FullPerm)))) (state ExhaleHeap@0 Mask@3)) (and (state ExhaleHeap@0 Mask@3) (= (Node_get_next ExhaleHeap@0 sent@0) null))) (and (and (not (= sent@0 null)) (state ExhaleHeap@0 Mask@3)) (and (U_2_bool (MapType0Select ExhaleHeap@0 sent@0 $allocated)) (state ExhaleHeap@0 Mask@3)))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 List_sentinel)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 List_sentinel))) (=> (and (= Heap@1 (MapType0Store ExhaleHeap@0 freshObj@0 List_sentinel sent@0)) (state Heap@1 Mask@3)) (and (=> (= (ControlFlow 0 18) 15) anon18_Then_correct) (=> (= (ControlFlow 0 18) 17) anon18_Else_correct)))))))))
(let ((anon5_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (Node_state null) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (Node_state null))) FullPerm)))) (=> (and (= Mask@2 Mask@1) (= (ControlFlow 0 21) 18)) anon6_correct))))
(let ((anon17_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 24) 21)) anon5_correct)))
(let ((anon17_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Node_state null))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Node_state null)))) (=> (= (ControlFlow 0 22) 21) anon5_correct))))))
(let ((anon16_Then_correct  (=> (not (= null null)) (and (=> (= (ControlFlow 0 25) 22) anon17_Then_correct) (=> (= (ControlFlow 0 25) 24) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (= null null) (=> (and (= Mask@2 Mask@0) (= (ControlFlow 0 20) 18)) anon6_correct))))
(let ((anon15_Else_correct  (=> (U_2_bool (MapType0Select Heap@@35 sent $allocated)) (=> (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@35 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@35 freshObj@0 $allocated (bool_2_U true)))) (and (= Mask@0 (MapType1Store ZeroMask freshObj@0 List_sentinel (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 List_sentinel)) FullPerm)))) (state Heap@0 Mask@0))) (and (=> (= (ControlFlow 0 26) 25) anon16_Then_correct) (=> (= (ControlFlow 0 26) 20) anon16_Else_correct))))))
(let ((anon15_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@35 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 27) 1) anon15_Then_correct) (=> (= (ControlFlow 0 27) 26) anon15_Else_correct)))))
