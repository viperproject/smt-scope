...
))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@47 T@U) ) (! (= (type (invRecv3 arg0@@47)) RefType)
...
)) (=> (and (forall ((n@@1 T@U) ) (!  (=> (= (type n@@1) RefType) (=> (and (U_2_bool (MapType2Select nodes@@6 n@@1)) (< NoPerm (* FullPerm rd))) (and (qpRange2 n@@1) (= (invRecv2 n@@1) n@@1))))
 :qid |stdinbpl.565:22|
 :skolemid |96|
 :pattern ( (MapType0Select Heap@1 n@@1 next))
 :pattern ( (MapType1Select QPMask@0 n@@1 next))
 :pattern ( (MapType2Select nodes@@6 n@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select nodes@@6 (invRecv2 o_3))) (< NoPerm (* FullPerm rd))) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.569:22|
 :skolemid |97|
...
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select nodes@@6 (invRecv2 o_3@@0))) (< NoPerm (* FullPerm rd))) (qpRange2 o_3@@0)) (and (=> (< NoPerm (* FullPerm rd)) (= (invRecv2 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (+ (U_2_real (MapType1Select Mask@1 o_3@@0 next)) (* FullPerm rd))))) (=> (not (and (and (U_2_bool (MapType2Select nodes@@6 (invRecv2 o_3@@0))) (< NoPerm (* FullPerm rd))) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) (U_2_real (MapType1Select Mask@1 o_3@@0 next))))))
 :qid |stdinbpl.587:22|
 :skolemid |100|
...
)) (=> (and (and (forall ((n_1@@5 T@U) ) (!  (=> (= (type n_1@@5) RefType) (=> (and (U_2_bool (MapType2Select nodes@@6 n_1@@5)) (< NoPerm (* FullPerm rd))) (and (qpRange3 n_1@@5) (= (invRecv3 n_1@@5) n_1@@5))))
 :qid |stdinbpl.629:22|
 :skolemid |105|
 :pattern ( (MapType0Select Heap@1 n_1@@5 next))
 :pattern ( (MapType1Select QPMask@1 n_1@@5 next))
 :pattern ( (MapType2Select nodes@@6 n_1@@5))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType2Select nodes@@6 (invRecv3 o_3@@2))) (and (< NoPerm (* FullPerm rd)) (qpRange3 o_3@@2))) (= (invRecv3 o_3@@2) o_3@@2)))
 :qid |stdinbpl.633:22|
 :skolemid |106|
 :pattern ( (invRecv3 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType2Select nodes@@6 (invRecv3 o_3@@3))) (and (< NoPerm (* FullPerm rd)) (qpRange3 o_3@@3))) (and (= (invRecv3 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 next)) (- (U_2_real (MapType1Select QPMask@0 o_3@@3 next)) (* FullPerm rd))))) (=> (not (and (U_2_bool (MapType2Select nodes@@6 (invRecv3 o_3@@3))) (and (< NoPerm (* FullPerm rd)) (qpRange3 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 next)) (U_2_real (MapType1Select QPMask@0 o_3@@3 next))))))
 :qid |stdinbpl.639:22|
 :skolemid |107|
