...
(let ((anon21_Else_correct  (=> (HasDirectPerm Mask@5 null (p5 x@@11 4)) (=> (and (= Heap@9 Heap@6) (= (ControlFlow 0 4) 2)) anon14_correct))))
(let ((anon21_Then_correct  (=> (not (HasDirectPerm Mask@5 null (p5 x@@11 4))) (=> (and (and (= Heap@7 (MapType0Store Heap@6 null (|p5#sm| x@@11 4) ZeroPMask)) (= Heap@8 (MapType0Store Heap@7 null (p5 x@@11 4) freshVersion@1))) (and (= Heap@9 Heap@8) (= (ControlFlow 0 3) 2))) anon14_correct))))
(let ((anon12_correct  (=> (= Mask@4 (MapType1Store Mask@3 x@@11 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@3 x@@11 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (= (U_2_int (MapType0Select Heap@6 x@@11 f_7)) 4)) (=> (= (U_2_int (MapType0Select Heap@6 x@@11 f_7)) 4) (=> (= Mask@5 (MapType1Store Mask@4 null (p5 x@@11 4) (real_2_U (+ (U_2_real (MapType1Select Mask@4 null (p5 x@@11 4))) FullPerm)))) (=> (and (and (state Heap@6 Mask@5) (state Heap@6 Mask@5)) (and (|p5#trigger| Heap@6 (p5 x@@11 4)) (= (MapType0Select Heap@6 null (p5 x@@11 4)) (FrameFragment (MapType0Select Heap@6 x@@11 f_7))))) (and (=> (= (ControlFlow 0 5) 3) anon21_Then_correct) (=> (= (ControlFlow 0 5) 4) anon21_Else_correct)))))))))
(let ((anon20_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 5)) anon12_correct)))
(let ((anon20_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select Mask@3 x@@11 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 x@@11 f_7))) (=> (= (ControlFlow 0 7) 5) anon12_correct))))))
(let ((anon10_correct  (=> (= Heap@6 (MapType0Store Heap@5 null (|p5#sm| x@@11 4) (MapType1Store (MapType0Select Heap@5 null (|p5#sm| x@@11 4)) x@@11 f_7 (bool_2_U true)))) (=> (and (state Heap@6 Mask@3) (state Heap@6 Mask@3)) (and (=> (= (ControlFlow 0 10) 7) anon20_Then_correct) (=> (= (ControlFlow 0 10) 9) anon20_Else_correct))))))
(let ((anon19_Else_correct  (=> (HasDirectPerm Mask@3 null (p5 x@@11 4)) (=> (and (= Heap@5 Heap@2) (= (ControlFlow 0 12) 10)) anon10_correct))))
(let ((anon19_Then_correct  (=> (not (HasDirectPerm Mask@3 null (p5 x@@11 4))) (=> (and (and (= Heap@3 (MapType0Store Heap@2 null (|p5#sm| x@@11 4) ZeroPMask)) (= Heap@4 (MapType0Store Heap@3 null (p5 x@@11 4) freshVersion@0))) (and (= Heap@5 Heap@4) (= (ControlFlow 0 11) 10))) anon10_correct))))
(let ((anon8_correct  (=> (= Mask@2 (MapType1Store Mask@1 x@@11 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 x@@11 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (= (U_2_int (MapType0Select Heap@2 x@@11 f_7)) 4)) (=> (= (U_2_int (MapType0Select Heap@2 x@@11 f_7)) 4) (=> (= Mask@3 (MapType1Store Mask@2 null (p5 x@@11 4) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (p5 x@@11 4))) FullPerm)))) (=> (and (and (state Heap@2 Mask@3) (state Heap@2 Mask@3)) (and (|p5#trigger| Heap@2 (p5 x@@11 4)) (= (MapType0Select Heap@2 null (p5 x@@11 4)) (FrameFragment (MapType0Select Heap@2 x@@11 f_7))))) (and (=> (= (ControlFlow 0 13) 11) anon19_Then_correct) (=> (= (ControlFlow 0 13) 12) anon19_Else_correct)))))))))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 17) 13)) anon8_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@11 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 x@@11 f_7))) (=> (= (ControlFlow 0 15) 13) anon8_correct))))))
(let ((anon6_correct  (=> (and (not (= x@@11 null)) (= Mask@1 (MapType1Store Mask@0 x@@11 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@11 f_7)) FullPerm))))) (=> (and (and (state Heap@1 Mask@1) (= (U_2_int (MapType0Select Heap@1 x@@11 f_7)) i@@18)) (and (state Heap@1 Mask@1) (state Heap@1 Mask@1))) (and (=> (= (ControlFlow 0 18) (- 0 21)) (HasDirectPerm Mask@1 x@@11 f_7)) (=> (HasDirectPerm Mask@1 x@@11 f_7) (and (=> (= (ControlFlow 0 18) (- 0 20)) (= (U_2_int (MapType0Select Heap@1 x@@11 f_7)) i@@18)) (=> (= (U_2_int (MapType0Select Heap@1 x@@11 f_7)) i@@18) (=> (state Heap@1 Mask@1) (and (=> (= (ControlFlow 0 18) (- 0 19)) (= FullPerm (U_2_real (MapType1Select Mask@1 x@@11 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 x@@11 f_7))) (=> (and (= Heap@2 (MapType0Store Heap@1 x@@11 f_7 (int_2_U 4))) (state Heap@2 Mask@1)) (and (=> (= (ControlFlow 0 18) 15) anon18_Then_correct) (=> (= (ControlFlow 0 18) 17) anon18_Else_correct))))))))))))))
(let ((anon17_Else_correct  (=> (HasDirectPerm Mask@0 null (p5 x@@11 i@@18)) (=> (and (= Heap@1 Heap@@14) (= (ControlFlow 0 23) 18)) anon6_correct))))
(let ((anon17_Then_correct  (=> (and (and (not (HasDirectPerm Mask@0 null (p5 x@@11 i@@18))) (= Heap@0 (MapType0Store Heap@@14 null (p5 x@@11 i@@18) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 22) 18))) anon6_correct)))
(let ((anon4_correct  (=> (= Mask@0 (MapType1Store QPMask@0 null (p5 x@@11 i@@18) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (p5 x@@11 i@@18))) FullPerm)))) (and (=> (= (ControlFlow 0 24) 22) anon17_Then_correct) (=> (= (ControlFlow 0 24) 23) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 27) 24)) anon4_correct)))
(let ((anon16_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 25) (- 0 26)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p5 x@@11 i@@18))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (p5 x@@11 i@@18)))) (=> (= (ControlFlow 0 25) 24) anon4_correct))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 29)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (|Seq#Contains| xs r_1)) (|Seq#Contains| xs r_1_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (not (= r_1 r_1_1)) (not (= i@@18 i@@18)))))
 :qid |stdinbpl.1721:17|
 :skolemid |120|
 :pattern ( (neverTriggered7 r_1) (neverTriggered7 r_1_1))
 ...
 :qid |stdinbpl.1721:17|
 :skolemid |120|
 :pattern ( (neverTriggered7 r_1@@0) (neverTriggered7 r_1_1@@0))
)) (=> (forall ((r_1@@1 T@U) ) (!  (=> (= (type r_1@@1) RefType) (=> (and (|Seq#Contains| xs r_1@@1) (< NoPerm FullPerm)) (and (= (invRecv7 r_1@@1 i@@18) r_1@@1) (qpRange7 r_1@@1 i@@18))))
 :qid |stdinbpl.1727:22|
 :skolemid |121|
...
)) (=> (and (and (and (forall ((r_2_1 T@U) (i_1_1 Int) ) (!  (=> (= (type r_2_1) RefType) (=> (and (and (|Seq#Contains| xs (invRecv7 r_2_1 i_1_1)) (< NoPerm FullPerm)) (qpRange7 r_2_1 i_1_1)) (and (= (invRecv7 r_2_1 i_1_1) r_2_1) (= i@@18 i_1_1))))
 :qid |stdinbpl.1731:22|
 :skolemid |122|
 :pattern ( (invRecv7 r_2_1 i_1_1))
)) (forall ((r_2_1@@0 T@U) (i_1_1@@0 Int) ) (!  (=> (= (type r_2_1@@0) RefType) (=> (and (and (|Seq#Contains| xs (invRecv7 r_2_1@@0 i_1_1@@0)) (< NoPerm FullPerm)) (qpRange7 r_2_1@@0 i_1_1@@0)) (and (=> (< NoPerm FullPerm) (and (= (invRecv7 r_2_1@@0 i_1_1@@0) r_2_1@@0) (= i@@18 i_1_1@@0))) (= (U_2_real (MapType1Select QPMask@0 null (p5 r_2_1@@0 i_1_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (p5 r_2_1@@0 i_1_1@@0))) FullPerm)))))
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 ...
 :qid |stdinbpl.1743:29|
 :skolemid |124|
 :pattern ( (MapType1Select ZeroMask o_3 f_5))
 :pattern ( (MapType1Select QPMask@0 o_3 f_5))
)) (forall ((r_2_1@@1 T@U) (i_1_1@@1 Int) ) (!  (=> (and (= (type r_2_1@@1) RefType) (not (and (and (|Seq#Contains| xs (invRecv7 r_2_1@@1 i_1_1@@1)) (< NoPerm FullPerm)) (qpRange7 r_2_1@@1 i_1_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (p5 r_2_1@@1 i_1_1@@1))) (U_2_real (MapType1Select ZeroMask null (p5 r_2_1@@1 i_1_1@@1)))))
 :qid |stdinbpl.1747:22|
 :skolemid |125|
 :pattern ( (MapType1Select QPMask@0 null (p5 r_2_1@@1 i_1_1@@1)))
)))) (and (and (state Heap@@14 QPMask@0) (state Heap@@14 QPMask@0)) (and (|p5#trigger| Heap@@14 (p5 x@@11 i@@18)) (= (MapType0Select Heap@@14 null (p5 x@@11 i@@18)) (FrameFragment (MapType0Select Heap@@14 x@@11 f_7)))))) (and (=> (= (ControlFlow 0 28) 25) anon16_Then_correct) (=> (= (ControlFlow 0 28) 27) anon16_Else_correct))))))))
(let ((anon15_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@14 ZeroMask) (U_2_bool (MapType0Select Heap@@14 x@@11 $allocated))) (and (|Seq#Contains| xs x@@11) (state Heap@@14 ZeroMask))) (and (=> (= (ControlFlow 0 30) 1) anon15_Then_correct) (=> (= (ControlFlow 0 30) 28) anon15_Else_correct)))))
