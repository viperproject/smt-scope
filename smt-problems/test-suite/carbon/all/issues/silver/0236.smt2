...
(declare-fun Option2_discr (T@U) Int)
(declare-fun Option2DomainTypeTypeInv0 (T@T) T@T)
(declare-fun Option2DomainTypeType (T@T) T@T)
(declare-fun Option2_None (T@T) T@U)
(declare-fun ZeroPMask () T@U)
(declare-fun Option_discr (T@U) Int)
(declare-fun Option_None (T@T) T@U)
...
(assert  (and (and (forall ((arg0@@26 T@T) ) (! (= (Ctor (Option2DomainTypeType arg0@@26)) 12)
 :qid |ctor:Option2DomainTypeType|
)) (forall ((arg0@@27 T@T) ) (! (= (Option2DomainTypeTypeInv0 (Option2DomainTypeType arg0@@27)) arg0@@27)
 :qid |typeInv:Option2DomainTypeTypeInv0|
 :pattern ( (Option2DomainTypeType arg0@@27))
))) (forall ((T T@T) ) (! (= (type (Option2_None T)) (Option2DomainTypeType T))
 :qid |funType:Option2_None|
 :pattern ( (Option2_None T))
))))
(assert (forall ((o_3 T@U) ) (! (let ((T@@0 (Option2DomainTypeTypeInv0 (type o_3))))
 (=> (= (type o_3) (Option2DomainTypeType T@@0)) (and (>= (Option2_discr o_3) 0) (= (Option2_discr (Option2_None T@@0)) 0))))
 :qid |stdinbpl.214:19|
 :skolemid |23|
 :pattern ( (Option2_discr o_3))
)))
...
(assert  (and (and (forall ((arg0@@28 T@T) ) (! (= (Ctor (OptionDomainTypeType arg0@@28)) 13)
 :qid |ctor:OptionDomainTypeType|
)) (forall ((arg0@@29 T@T) ) (! (= (OptionDomainTypeTypeInv0 (OptionDomainTypeType arg0@@29)) arg0@@29)
 :qid |typeInv:OptionDomainTypeTypeInv0|
 :pattern ( (OptionDomainTypeType arg0@@29))
))) (forall ((T@@1 T@T) ) (! (= (type (Option_None T@@1)) (OptionDomainTypeType T@@1))
 :qid |funType:Option_None|
 :pattern ( (Option_None T@@1))
))))
(assert (forall ((T@@2 T@T) ) (! (= (Option_discr (Option_None T@@2)) 0)
 :skolemid |22|
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (Option_discr (Option_None boolType)) 0)) (=> (= (Option_discr (Option_None boolType)) 0) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (Option_discr (Option_None RefType)) 0)) (=> (= (Option_discr (Option_None RefType)) 0) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))) (= (Option_discr (Option_None realType)) 1))))))))))
