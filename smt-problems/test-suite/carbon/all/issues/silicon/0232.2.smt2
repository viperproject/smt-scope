...
(assert  (and (and (and (and (= (type Mask@1) (MapType1Type RefType realType)) (= (type this) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type ExhaleHeap@0) (MapType0Type RefType))))
...
(let ((anon6_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= perm@0 (U_2_real (MapType1Select Mask@1 null (P this))))) (=> (<= perm@0 (U_2_real (MapType1Select Mask@1 null (P this)))) (=> (= (ControlFlow 0 2) 1) anon4_correct))))))
(let ((anon2_correct  (=> (and (and (= Mask@1 (MapType1Store Mask@0 null (P this) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P this))) NoPerm)))) (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@0 Mask@1)) (and (state ExhaleHeap@0 Mask@1) (= perm@0 (U_2_real (MapType1Select Mask@1 null (P this)))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))))
(let ((anon5_Else_correct  (=> (and (= NoPerm NoPerm) (= (ControlFlow 0 9) 5)) anon2_correct)))
(let ((anon5_Then_correct  (=> (not (= NoPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= NoPerm (U_2_real (MapType1Select Mask@0 null (P this))))) (=> (<= NoPerm (U_2_real (MapType1Select Mask@0 null (P this)))) (=> (= (ControlFlow 0 7) 5) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@10 this $allocated)) (= Mask@0 (MapType1Store ZeroMask null (P this) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P this))) FullPerm))))) (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 10) 7) anon5_Then_correct) (=> (= (ControlFlow 0 10) 9) anon5_Else_correct))))))
