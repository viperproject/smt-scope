...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon12_Else_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (= (f_get Heap@@19 10) 0))))
(let ((anon12_Then_correct true))
(let ((anon9_Else_correct  (=> (forall ((qvar_1 Int) ) (! (= (f_get Heap@@19 qvar_1) (f_clamp Heap@@19))
 :qid |stdinbpl.359:20|
 :skolemid |32|
 :pattern ( (|f_get#frame| EmptyFrame qvar_1))
)) (=> (and (state Heap@@19 ZeroMask) (state Heap@@19 ZeroMask)) (and (=> (= (ControlFlow 0 7) 4) anon12_Then_correct) (=> (= (ControlFlow 0 7) 6) anon12_Else_correct))))))
(let ((anon11_Else_correct true))
(let ((anon11_Then_correct true))
(let ((anon10_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (state Heap@@19 ZeroMask)) (and (and (and (=> (= (ControlFlow 0 8) 7) anon9_Else_correct) (=> (= (ControlFlow 0 8) 1) anon10_Then_correct)) (=> (= (ControlFlow 0 8) 2) anon11_Then_correct)) (=> (= (ControlFlow 0 8) 3) anon11_Else_correct))))))
