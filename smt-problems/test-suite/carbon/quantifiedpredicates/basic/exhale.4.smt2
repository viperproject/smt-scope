...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type QPMask@1) (MapType1Type RefType realType)) (= (type y@@2) RefType)) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type xs) (SeqType RefType))) (forall ((arg0@@39 T@U) ) (! (= (type (invRecv6 arg0@@39)) RefType)
 :qid |funType:invRecv6|
 :pattern ( (invRecv6 arg0@@39))
))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (forall ((arg0@@40 T@U) ) (! (= (type (FrameFragment arg0@@40)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@40))
))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@11) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (forall ((arg0@@41 T@U) ) (! (= (type (invRecv4 arg0@@41)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 31) (let ((anon19_Else_correct  (=> (= (ControlFlow 0 26) (- 0 25)) (forall ((x_4 T@U) (x_4_1 T@U) ) (!  (=> (and (= (type x_4) RefType) (= (type x_4_1) RefType)) (=> (and (and (and (and (not (= x_4 x_4_1)) (and (|Seq#Contains| xs x_4) (not (= x_4 y@@2)))) (and (|Seq#Contains| xs x_4_1) (not (= x_4_1 y@@2)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_4 x_4_1))))
...
(let ((anon24_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select QPMask@1 null (pred1 y@@2))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@1 null (pred1 y@@2)))) (=> (= (ControlFlow 0 3) 2) anon16_correct))))))
(let ((anon14_correct  (=> (= Heap@5 (MapType0Store Heap@4 null (|pred1#sm| y@@2) (MapType1Store (MapType0Select Heap@4 null (|pred1#sm| y@@2)) y@@2 f_7 (bool_2_U true)))) (=> (and (state Heap@5 Mask@3) (state Heap@5 Mask@3)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (forall ((x_6 T@U) (x_6_1 T@U) ) (!  (=> (and (= (type x_6) RefType) (= (type x_6_1) RefType)) (=> (and (and (and (and (not (= x_6 x_6_1)) (and (|Seq#Contains| xs x_6) (not (= x_6 y@@2)))) (and (|Seq#Contains| xs x_6_1) (not (= x_6_1 y@@2)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_6 x_6_1))))
 :qid |stdinbpl.1255:17|
 :skolemid |101|
 :pattern ( (neverTriggered6 x_6) (neverTriggered6 x_6_1))
))) (=> (forall ((x_6@@0 T@U) (x_6_1@@0 T@U) ) (!  (=> (and (= (type x_6@@0) RefType) (= (type x_6_1@@0) RefType)) (=> (and (and (and (and (not (= x_6@@0 x_6_1@@0)) (and (|Seq#Contains| xs x_6@@0) (not (= x_6@@0 y@@2)))) (and (|Seq#Contains| xs x_6_1@@0) (not (= x_6_1@@0 y@@2)))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_6@@0 x_6_1@@0))))
 :qid |stdinbpl.1255:17|
 :skolemid |101|
 :pattern ( (neverTriggered6 x_6@@0) (neverTriggered6 x_6_1@@0))
)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((x_6@@1 T@U) ) (!  (=> (= (type x_6@@1) RefType) (=> (and (|Seq#Contains| xs x_6@@1) (not (= x_6@@1 y@@2))) (>= (U_2_real (MapType1Select Mask@3 null (pred1 x_6@@1))) FullPerm)))
 :qid |stdinbpl.1262:17|
 :skolemid |102|
 :pattern ( (MapType0Select Heap@5 null (pred1 x_6@@1)))
 :pattern ( (MapType1Select Mask@3 null (pred1 x_6@@1)))
 :pattern ( (|Seq#ContainsTrigger| xs x_6@@1))
 :pattern ( (|Seq#Contains| xs x_6@@1))
))) (=> (forall ((x_6@@2 T@U) ) (!  (=> (= (type x_6@@2) RefType) (=> (and (|Seq#Contains| xs x_6@@2) (not (= x_6@@2 y@@2))) (>= (U_2_real (MapType1Select Mask@3 null (pred1 x_6@@2))) FullPerm)))
 :qid |stdinbpl.1262:17|
 :skolemid |102|
 :pattern ( (MapType0Select Heap@5 null (pred1 x_6@@2)))
 :pattern ( (MapType1Select Mask@3 null (pred1 x_6@@2)))
 :pattern ( (|Seq#ContainsTrigger| xs x_6@@2))
 :pattern ( (|Seq#Contains| xs x_6@@2))
)) (=> (forall ((x_6@@3 T@U) ) (!  (=> (= (type x_6@@3) RefType) (=> (and (and (|Seq#Contains| xs x_6@@3) (not (= x_6@@3 y@@2))) (< NoPerm FullPerm)) (and (= (invRecv6 x_6@@3) x_6@@3) (qpRange6 x_6@@3))))
 :qid |stdinbpl.1268:22|
 :skolemid |103|
 :pattern ( (MapType0Select Heap@5 null (pred1 x_6@@3)))
 :pattern ( (MapType1Select Mask@3 null (pred1 x_6@@3)))
 :pattern ( (|Seq#ContainsTrigger| xs x_6@@3))
 :pattern ( (|Seq#Contains| xs x_6@@3))
)) (=> (and (and (forall ((a_2 T@U) ) (!  (=> (= (type a_2) RefType) (=> (and (and (and (|Seq#Contains| xs (invRecv6 a_2)) (not (= (invRecv6 a_2) y@@2))) (< NoPerm FullPerm)) (qpRange6 a_2)) (= (invRecv6 a_2) a_2)))
 :qid |stdinbpl.1272:22|
 :skolemid |104|
 :pattern ( (invRecv6 a_2))
)) (forall ((a_2@@0 T@U) ) (!  (=> (= (type a_2@@0) RefType) (=> (and (and (and (|Seq#Contains| xs (invRecv6 a_2@@0)) (not (= (invRecv6 a_2@@0) y@@2))) (< NoPerm FullPerm)) (qpRange6 a_2@@0)) (and (= (invRecv6 a_2@@0) a_2@@0) (= (U_2_real (MapType1Select QPMask@1 null (pred1 a_2@@0))) (- (U_2_real (MapType1Select Mask@3 null (pred1 a_2@@0))) FullPerm)))))
 :qid |stdinbpl.1278:22|
 :skolemid |105|
 :pattern ( (MapType1Select QPMask@1 null (pred1 a_2@@0)))
))) (and (forall ((a_2@@1 T@U) ) (!  (=> (and (= (type a_2@@1) RefType) (not (and (and (and (|Seq#Contains| xs (invRecv6 a_2@@1)) (not (= (invRecv6 a_2@@1) y@@2))) (< NoPerm FullPerm)) (qpRange6 a_2@@1)))) (= (U_2_real (MapType1Select QPMask@1 null (pred1 a_2@@1))) (U_2_real (MapType1Select Mask@3 null (pred1 a_2@@1)))))
 :qid |stdinbpl.1282:22|
 :skolemid |106|
 :pattern ( (MapType1Select QPMask@1 null (pred1 a_2@@1)))
)) (forall ((o_3 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (or (or (not (= o_3 null)) (not (IsPredicateField f_5))) (not (= (getPredWandId f_5) 0)))) (= (U_2_real (MapType1Select Mask@3 o_3 f_5)) (U_2_real (MapType1Select QPMask@1 o_3 f_5))))))
 :qid |stdinbpl.1288:29|
 :skolemid |107|
...
(let ((anon23_Else_correct  (=> (HasDirectPerm Mask@3 null (pred1 y@@2)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 10) 6)) anon14_correct))))
(let ((anon23_Then_correct  (=> (not (HasDirectPerm Mask@3 null (pred1 y@@2))) (=> (and (and (= Heap@2 (MapType0Store Heap@1 null (|pred1#sm| y@@2) ZeroPMask)) (= Heap@3 (MapType0Store Heap@2 null (pred1 y@@2) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 9) 6))) anon14_correct))))
(let ((anon12_correct  (=> (and (= Mask@2 (MapType1Store Mask@1 y@@2 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 y@@2 f_7)) FullPerm)))) (= Mask@3 (MapType1Store Mask@2 null (pred1 y@@2) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (pred1 y@@2))) FullPerm))))) (=> (and (and (state Heap@1 Mask@3) (state Heap@1 Mask@3)) (and (|pred1#trigger| Heap@1 (pred1 y@@2)) (= (MapType0Select Heap@1 null (pred1 y@@2)) (FrameFragment (MapType0Select Heap@1 y@@2 f_7))))) (and (=> (= (ControlFlow 0 11) 9) anon23_Then_correct) (=> (= (ControlFlow 0 11) 10) anon23_Else_correct))))))
(let ((anon22_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 14) 11)) anon12_correct)))
(let ((anon22_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= FullPerm (U_2_real (MapType1Select Mask@1 y@@2 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 y@@2 f_7))) (=> (= (ControlFlow 0 12) 11) anon12_correct))))))
(let ((anon10_correct  (=> (not (= y@@2 null)) (=> (and (and (= Mask@1 (MapType1Store Mask@0 y@@2 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@2 f_7)) FullPerm)))) (state Heap@1 Mask@1)) (and (state Heap@1 Mask@1) (state Heap@1 Mask@1))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (not (= y@@2 null))) (=> (not (= y@@2 null)) (=> (state Heap@1 Mask@1) (and (=> (= (ControlFlow 0 15) 12) anon22_Then_correct) (=> (= (ControlFlow 0 15) 14) anon22_Else_correct)))))))))
(let ((anon21_Else_correct  (=> (HasDirectPerm Mask@0 null (pred1 y@@2)) (=> (and (= Heap@1 Heap@@11) (= (ControlFlow 0 18) 15)) anon10_correct))))
(let ((anon21_Then_correct  (=> (and (and (not (HasDirectPerm Mask@0 null (pred1 y@@2))) (= Heap@0 (MapType0Store Heap@@11 null (pred1 y@@2) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 17) 15))) anon10_correct)))
(let ((anon8_correct  (=> (= Mask@0 (MapType1Store QPMask@0 null (pred1 y@@2) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (pred1 y@@2))) FullPerm)))) (and (=> (= (ControlFlow 0 19) 17) anon21_Then_correct) (=> (= (ControlFlow 0 19) 18) anon21_Else_correct)))))
(let ((anon20_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 22) 19)) anon8_correct)))
(let ((anon20_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (pred1 y@@2))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (pred1 y@@2)))) (=> (= (ControlFlow 0 20) 19) anon8_correct))))))
(let ((anon18_Else_correct  (=> (and (|pred1#trigger| Heap@@11 (pred1 y@@2)) (= (MapType0Select Heap@@11 null (pred1 y@@2)) (FrameFragment (MapType0Select Heap@@11 y@@2 f_7)))) (and (=> (= (ControlFlow 0 23) 20) anon20_Then_correct) (=> (= (ControlFlow 0 23) 22) anon20_Else_correct)))))
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| xs x_1@@1) (< NoPerm FullPerm)) (and (= (invRecv4 x_1@@1) x_1@@1) (qpRange4 x_1@@1))))
...
)) (=> (and (forall ((a_1@@11 T@U) ) (!  (=> (= (type a_1@@11) RefType) (=> (and (and (|Seq#Contains| xs (invRecv4 a_1@@11)) (< NoPerm FullPerm)) (qpRange4 a_1@@11)) (= (invRecv4 a_1@@11) a_1@@11)))
 :qid |stdinbpl.1106:22|
 :skolemid |91|
 :pattern ( (invRecv4 a_1@@11))
)) (forall ((a_1@@12 T@U) ) (!  (=> (= (type a_1@@12) RefType) (=> (and (and (|Seq#Contains| xs (invRecv4 a_1@@12)) (< NoPerm FullPerm)) (qpRange4 a_1@@12)) (and (=> (< NoPerm FullPerm) (= (invRecv4 a_1@@12) a_1@@12)) (= (U_2_real (MapType1Select QPMask@0 null (pred1 a_1@@12))) (+ (U_2_real (MapType1Select ZeroMask null (pred1 a_1@@12))) FullPerm)))))
...
)) (forall ((a_1@@13 T@U) ) (!  (=> (and (= (type a_1@@13) RefType) (not (and (and (|Seq#Contains| xs (invRecv4 a_1@@13)) (< NoPerm FullPerm)) (qpRange4 a_1@@13)))) (= (U_2_real (MapType1Select QPMask@0 null (pred1 a_1@@13))) (U_2_real (MapType1Select ZeroMask null (pred1 a_1@@13)))))
 :qid |stdinbpl.1122:22|
 :skolemid |94|
 :pattern ( (MapType1Select QPMask@0 null (pred1 a_1@@13)))
))) (and (state Heap@@11 QPMask@0) (state Heap@@11 QPMask@0))) (and (=> (= (ControlFlow 0 28) 27) anon18_Then_correct) (=> (= (ControlFlow 0 28) 23) anon18_Else_correct)))))))))
(let ((anon17_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 y@@2 $allocated))) (and (|Seq#Contains| xs y@@2) (state Heap@@11 ZeroMask))) (and (=> (= (ControlFlow 0 30) 1) anon17_Then_correct) (=> (= (ControlFlow 0 30) 28) anon17_Else_correct)))))
