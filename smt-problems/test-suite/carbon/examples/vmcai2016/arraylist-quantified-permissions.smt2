...
(assert  (and (and (and (= (type Heap@@19) (MapType0Type RefType)) (= (type this@@15) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |AList#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon5_correct true))
(let ((anon9_Else_correct  (=> (and (not (and (<= 0 i_11) (< i_11 (len (MapType0Select Heap@@19 this@@15 elems))))) (= (ControlFlow 0 6) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (and (<= 0 i_11) (< i_11 (len (MapType0Select Heap@@19 this@@15 elems)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@1 this@@15 elems)) (=> (HasDirectPerm Mask@1 this@@15 elems) (=> (= (ControlFlow 0 4) 3) anon5_correct))))))
(let ((anon8_Else_correct  (=> (< i_11 0) (and (=> (= (ControlFlow 0 9) 4) anon9_Then_correct) (=> (= (ControlFlow 0 9) 6) anon9_Else_correct)))))
(let ((anon8_Then_correct  (=> (<= 0 i_11) (and (=> (= (ControlFlow 0 7) (- 0 8)) (HasDirectPerm Mask@1 this@@15 elems)) (=> (HasDirectPerm Mask@1 this@@15 elems) (and (=> (= (ControlFlow 0 7) 4) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))))
(let ((anon7_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((i_2 Int) (i_2_1 Int) ) (!  (=> (and (and (and (and (not (= i_2 i_2_1)) (and (<= 0 i_2) (< i_2 (len (MapType0Select Heap@@19 this@@15 elems))))) (and (<= 0 i_2_1) (< i_2_1 (len (MapType0Select Heap@@19 this@@15 elems))))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (loc (MapType0Select Heap@@19 this@@15 elems) i_2) (loc (MapType0Select Heap@@19 this@@15 elems) i_2_1))))
 :qid |stdinbpl.724:15|
 :skolemid |56|
)))))
(let ((anon0_correct  (=> (state Heap@@19 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@19 this@@15 $allocated))) (and (not (= this@@15 null)) (= Mask@0 (MapType1Store ZeroMask this@@15 elems (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@15 elems)) FullPerm)))))) (and (and (state Heap@@19 Mask@0) (not (= this@@15 null))) (and (= Mask@1 (MapType1Store Mask@0 this@@15 size (real_2_U (+ (U_2_real (MapType1Select Mask@0 this@@15 size)) FullPerm)))) (state Heap@@19 Mask@1)))) (and (=> (= (ControlFlow 0 10) (- 0 14)) (HasDirectPerm Mask@1 this@@15 size)) (=> (HasDirectPerm Mask@1 this@@15 size) (=> (<= 0 (U_2_int (MapType0Select Heap@@19 this@@15 size))) (and (=> (= (ControlFlow 0 10) (- 0 13)) (HasDirectPerm Mask@1 this@@15 size)) (=> (HasDirectPerm Mask@1 this@@15 size) (and (=> (= (ControlFlow 0 10) (- 0 12)) (HasDirectPerm Mask@1 this@@15 elems)) (=> (HasDirectPerm Mask@1 this@@15 elems) (=> (<= (U_2_int (MapType0Select Heap@@19 this@@15 size)) (len (MapType0Select Heap@@19 this@@15 elems))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm Mask@1 this@@15 elems)) (=> (HasDirectPerm Mask@1 this@@15 elems) (=> (< 0 (len (MapType0Select Heap@@19 this@@15 elems))) (and (and (=> (= (ControlFlow 0 10) 2) anon7_Else_correct) (=> (= (ControlFlow 0 10) 7) anon8_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 15) 10) anon0_correct)))
