...
(declare-fun tmp () T@U)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type tmp@0) RefType) (= (type Mask@14) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))) (= (type Mask@15) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type tmp@1) RefType)) (= (type Mask@13) (MapType1Type RefType realType))) (= (type Mask@11) (MapType1Type RefType realType))) (= (type Mask@12) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Mask@10) (MapType1Type RefType realType))) (= (type Mask@9) (MapType1Type RefType realType))) (= (type Mask@8) (MapType1Type RefType realType))) (= (type Mask@7) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type newVersion@0) FrameTypeType)) (= (type Mask@6) (MapType1Type RefType realType))) (forall ((arg0@@28 T@U) (arg1@@10 T@U) ) (! (= (type (CombineFrames arg0@@28 arg1@@10)) FrameTypeType)
...
))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type list) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type tmp) RefType)))
(set-info :boogie-vc-id traverse)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 38) (let ((anon21_correct true))
(let ((anon20_correct  (=> (= Mask@12 (MapType1Store Mask@11 null (valid tmp@1) (real_2_U (- (U_2_real (MapType1Select Mask@11 null (valid tmp@1))) FullPerm)))) (=> (and (= Mask@13 Mask@12) (= (ControlFlow 0 10) 8)) anon21_correct))))
(let ((anon35_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 10)) anon20_correct)))
(let ((anon35_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType1Select Mask@11 null (valid tmp@1))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@11 null (valid tmp@1)))) (=> (= (ControlFlow 0 11) 10) anon20_correct))))))
...
(let ((anon17_correct  (=> (and (state Heap@1 Mask@11) (state Heap@1 Mask@11)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm Mask@11 tmp@0 next)) (=> (HasDirectPerm Mask@11 tmp@0 next) (=> (and (= tmp@1 (MapType0Select Heap@1 tmp@0 next)) (state Heap@1 Mask@11)) (and (=> (= (ControlFlow 0 15) 14) anon34_Then_correct) (=> (= (ControlFlow 0 15) 9) anon34_Else_correct))))))))
(let ((anon33_Else_correct  (=> (= (MapType0Select Heap@1 tmp@0 next) null) (=> (and (= Mask@11 Mask@9) (= (ControlFlow 0 18) 15)) anon17_correct))))
(let ((anon33_Then_correct  (=> (and (not (= (MapType0Select Heap@1 tmp@0 next) null)) (= Mask@10 (MapType1Store Mask@9 null (valid (MapType0Select Heap@1 tmp@0 next)) (real_2_U (+ (U_2_real (MapType1Select Mask@9 null (valid (MapType0Select Heap@1 tmp@0 next)))) FullPerm))))) (=> (and (and (InsidePredicate (valid tmp@0) (MapType0Select Heap@1 null (valid tmp@0)) (valid (MapType0Select Heap@1 tmp@0 next)) (MapType0Select Heap@1 null (valid (MapType0Select Heap@1 tmp@0 next)))) (state Heap@1 Mask@10)) (and (= Mask@11 Mask@10) (= (ControlFlow 0 17) 15))) anon17_correct))))
(let ((anon15_correct  (=> (and (not (= tmp@0 null)) (= Mask@8 (MapType1Store Mask@7 tmp@0 next (real_2_U (+ (U_2_real (MapType1Select Mask@7 tmp@0 next)) FullPerm))))) (=> (and (and (state Heap@1 Mask@8) (not (= tmp@0 null))) (and (= Mask@9 (MapType1Store Mask@8 tmp@0 val (real_2_U (+ (U_2_real (MapType1Select Mask@8 tmp@0 val)) FullPerm)))) (state Heap@1 Mask@9))) (and (=> (= (ControlFlow 0 19) 17) anon33_Then_correct) (=> (= (ControlFlow 0 19) 18) anon33_Else_correct))))))
(let ((anon32_Else_correct  (=> (HasDirectPerm Mask@7 null (valid tmp@0)) (=> (and (= Heap@1 ExhaleHeap@0) (= (ControlFlow 0 21) 19)) anon15_correct))))
(let ((anon32_Then_correct  (=> (and (and (not (HasDirectPerm Mask@7 null (valid tmp@0))) (= Heap@0 (MapType0Store ExhaleHeap@0 null (valid tmp@0) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 20) 19))) anon15_correct)))
(let ((anon13_correct  (=> (= Mask@7 (MapType1Store Mask@6 null (valid tmp@0) (real_2_U (- (U_2_real (MapType1Select Mask@6 null (valid tmp@0))) FullPerm)))) (and (=> (= (ControlFlow 0 22) 20) anon32_Then_correct) (=> (= (ControlFlow 0 22) 21) anon32_Else_correct)))))
(let ((anon31_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 25) 22)) anon13_correct)))
(let ((anon31_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (<= FullPerm (U_2_real (MapType1Select Mask@6 null (valid tmp@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@6 null (valid tmp@0)))) (=> (= (ControlFlow 0 23) 22) anon13_correct))))))
(let ((anon11_correct  (=> (state ExhaleHeap@0 Mask@6) (=> (and (and (not (= tmp@0 null)) (state ExhaleHeap@0 Mask@6)) (and (|valid#trigger| ExhaleHeap@0 (valid tmp@0)) (= (MapType0Select ExhaleHeap@0 null (valid tmp@0)) (CombineFrames (FrameFragment (MapType0Select ExhaleHeap@0 tmp@0 next)) (CombineFrames (FrameFragment (MapType0Select ExhaleHeap@0 tmp@0 val)) (FrameFragment (ite (not (= (MapType0Select ExhaleHeap@0 tmp@0 next) null)) (MapType0Select ExhaleHeap@0 null (valid (MapType0Select ExhaleHeap@0 tmp@0 next))) EmptyFrame))))))) (and (=> (= (ControlFlow 0 26) 23) anon31_Then_correct) (=> (= (ControlFlow 0 26) 25) anon31_Else_correct))))))
(let ((anon30_Else_correct  (=> (= tmp@0 null) (=> (and (= Mask@6 ZeroMask) (= (ControlFlow 0 28) 26)) anon11_correct))))
(let ((anon30_Then_correct  (=> (not (= tmp@0 null)) (=> (and (and (= Mask@5 (MapType1Store ZeroMask null (valid tmp@0) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid tmp@0))) FullPerm)))) (state ExhaleHeap@0 Mask@5)) (and (= Mask@6 Mask@5) (= (ControlFlow 0 27) 26))) anon11_correct))))
...
(let ((anon36_Then_correct  (=> (not (= tmp@0 null)) (=> (and (and (= Mask@3 (MapType1Store Mask@2 null (valid tmp@0) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (valid tmp@0))) FullPerm)))) (state ExhaleHeap@0 Mask@3)) (and (= Mask@4 Mask@3) (= (ControlFlow 0 5) 4))) anon24_correct))))
...
(let ((anon28_Then_correct  (=> (not (= tmp@0 null)) (=> (and (and (= Mask@14 (MapType1Store Mask@2 null (valid tmp@0) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (valid tmp@0))) FullPerm)))) (state ExhaleHeap@0 Mask@14)) (and (= Mask@15 Mask@14) (= (ControlFlow 0 2) 1))) anon7_correct))))
(let ((anon4_correct  (=> (and (IdenticalOnKnownLocations Heap@@10 ExhaleHeap@0 Mask@2) (U_2_bool (MapType0Select ExhaleHeap@0 tmp@0 $allocated))) (and (and (and (=> (= (ControlFlow 0 30) 29) anon29_Then_correct) (=> (= (ControlFlow 0 30) 7) anon29_Else_correct)) (=> (= (ControlFlow 0 30) 2) anon28_Then_correct)) (=> (= (ControlFlow 0 30) 3) anon28_Else_correct)))))
(let ((anon3_correct  (=> (= Mask@1 (MapType1Store Mask@0 null (valid list) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid list))) FullPerm)))) (=> (and (= Mask@2 Mask@1) (= (ControlFlow 0 32) 30)) anon4_correct))))
(let ((anon26_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 35) 32)) anon3_correct)))
(let ((anon26_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 33) (- 0 34)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid list))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (valid list)))) (=> (= (ControlFlow 0 33) 32) anon3_correct))))))
(let ((anon25_Then_correct  (=> (not (= list null)) (and (=> (= (ControlFlow 0 36) 33) anon26_Then_correct) (=> (= (ControlFlow 0 36) 35) anon26_Else_correct)))))
(let ((anon25_Else_correct  (=> (= list null) (=> (and (= Mask@2 Mask@0) (= (ControlFlow 0 31) 30)) anon4_correct))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@10 list $allocated)) (= Mask@0 (MapType1Store ZeroMask null (valid list) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid list))) FullPerm))))) (=> (and (and (state Heap@@10 Mask@0) (state Heap@@10 Mask@0)) (and (U_2_bool (MapType0Select Heap@@10 tmp $allocated)) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 37) 36) anon25_Then_correct) (=> (= (ControlFlow 0 37) 31) anon25_Else_correct)))))))
