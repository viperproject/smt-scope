...
(declare-fun |bar'| (T@U T@U) Bool)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |bar#triggerStateless| (T@U) Bool)
(declare-fun bar (T@U T@U) Bool)
...
(declare-fun |bar#frame| (T@U T@U) Bool)
...
(assert (forall ((Heap@@2 T@U) (x@@8 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type x@@8) RefType)) (dummyFunction (bool_2_U (|bar#triggerStateless| x@@8))))
 :qid |stdinbpl.197:15|
 :skolemid |23|
 :pattern ( (|bar'| Heap@@2 x@@8))
)))
...
(assert (forall ((Heap@@4 T@U) (Mask@@3 T@U) (x@@9 T@U) ) (!  (=> (and (and (and (= (type Heap@@4) (MapType0Type RefType)) (= (type Mask@@3) (MapType1Type RefType realType))) (= (type x@@9) RefType)) (and (state Heap@@4 Mask@@3) (< AssumeFunctionsAbove 0))) (bar Heap@@4 x@@9))
 :qid |stdinbpl.203:15|
 :skolemid |24|
 :pattern ( (state Heap@@4 Mask@@3) (bar Heap@@4 x@@9))
)))
...
(assert (forall ((Heap@@7 T@U) (Mask@@7 T@U) (x@@10 T@U) ) (!  (=> (and (and (and (= (type Heap@@7) (MapType0Type RefType)) (= (type Mask@@7) (MapType1Type RefType realType))) (= (type x@@10) RefType)) (state Heap@@7 Mask@@7)) (= (|bar'| Heap@@7 x@@10) (|bar#frame| (FrameFragment (MapType0Select Heap@@7 x@@10 f_7)) x@@10)))
 :qid |stdinbpl.210:15|
 :skolemid |25|
 :pattern ( (state Heap@@7 Mask@@7) (|bar'| Heap@@7 x@@10))
)))
(assert (forall ((Heap@@8 T@U) (x@@11 T@U) ) (!  (=> (and (= (type Heap@@8) (MapType0Type RefType)) (= (type x@@11) RefType)) (and (= (bar Heap@@8 x@@11) (|bar'| Heap@@8 x@@11)) (dummyFunction (bool_2_U (|bar#triggerStateless| x@@11)))))
 :qid |stdinbpl.193:15|
 :skolemid |22|
 :pattern ( (bar Heap@@8 x@@11))
)))
...
(assert  (and (and (= (type Heap@@13) (MapType0Type RefType)) (= (type x@@12) RefType)) (= (type PostHeap@0) (MapType0Type RefType))))
...
(let ((anon9_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select ZeroMask x@@12 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select ZeroMask x@@12 f_7))) (=> (= (ControlFlow 0 5) 4) anon4_correct))))))
(let ((anon8_Else_correct true))
(let ((anon7_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (state PostHeap@0 ZeroMask)) (and (and (=> (= (ControlFlow 0 8) 3) anon8_Else_correct) (=> (= (ControlFlow 0 8) 5) anon9_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct)))))
(let ((anon7_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (bar Heap@@13 x@@12))))
(let ((anon0_correct  (=> (state Heap@@13 ZeroMask) (=> (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@13 x@@12 $allocated))) (and (not (= x@@12 null)) (state Heap@@13 ZeroMask))) (and (=> (= (ControlFlow 0 9) 8) anon7_Then_correct) (=> (= (ControlFlow 0 9) 2) anon7_Else_correct))))))
