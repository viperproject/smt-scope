...
(assert  (and (= (type xs) (SeqType intType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id test2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 (|Seq#Length| xs)))) (= (ControlFlow 0 6) 2)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (<= 0 i_2) (< i_2 (|Seq#Length| xs))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< i_2 (|Seq#Length| xs))) (=> (< i_2 (|Seq#Length| xs)) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (and (=> (= (ControlFlow 0 7) 1) anon5_Else_correct) (=> (= (ControlFlow 0 7) 3) anon6_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))
