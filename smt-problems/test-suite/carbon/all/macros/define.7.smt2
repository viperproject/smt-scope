...
(assert  (and (and (and (= (type Heap@0) (MapType0Type RefType)) (= (type x@@8) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@12) (MapType0Type RefType))))
(set-info :boogie-vc-id test07)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (=> (< 5 (U_2_int (MapType0Select Heap@0 x@@8 g))) (=> (and (state Heap@0 Mask@0) (= (ControlFlow 0 3) (- 0 2))) false))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@12 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@12 x@@8 $allocated))) (=> (and (and (not (= x@@8 null)) (= Mask@0 (MapType1Store ZeroMask x@@8 g (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 g)) FullPerm))))) (and (state Heap@@12 Mask@0) (state Heap@@12 Mask@0))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (= FullPerm (U_2_real (MapType1Select Mask@0 x@@8 g)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@0 x@@8 g))) (=> (and (= Heap@0 (MapType0Store Heap@@12 x@@8 g (int_2_U 1))) (state Heap@0 Mask@0)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm Mask@0 x@@8 g)) (=> (HasDirectPerm Mask@0 x@@8 g) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))))))))
