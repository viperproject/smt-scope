...
(assert  (and (= (type Heap@@9) (MapType0Type RefType)) (= (type this) RefType)))
(set-info :boogie-vc-id s2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 this $allocated))) (and (not (= this null)) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm ZeroMask this x@@8))))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_Else_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (not (= this null)) (= (ControlFlow 0 7) (- 0 6))) (HasDirectPerm ZeroMask this x@@8)))))
