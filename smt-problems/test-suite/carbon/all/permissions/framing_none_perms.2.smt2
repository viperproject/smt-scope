...
(assert  (and (and (and (= (type Heap@@15) (MapType0Type RefType)) (= (type x@@14) RefType)) (= (type y@@7) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |fun02#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@15 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@15 x@@14 $allocated)) (U_2_bool (MapType0Select Heap@@15 y@@7 $allocated))) (and (= AssumeFunctionsAbove 0) (= perm@0 (ite b_2@@5 FullPerm NoPerm)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (and (=> (> perm@0 NoPerm) (not (= x@@14 null))) (= Mask@0 (MapType1Store ZeroMask x@@14 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@14 f_7)) perm@0))))) (=> (and (and (state Heap@@15 Mask@0) (state Heap@@15 Mask@0)) (and (= perm@1 (ite  (not b_2@@5) FullPerm NoPerm)) (= (ControlFlow 0 2) (- 0 1)))) (>= perm@1 NoPerm)))))))))
