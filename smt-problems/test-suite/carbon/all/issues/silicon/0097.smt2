...
(declare-fun PseudoListvalue$ () T@U)
(declare-fun PseudoListnext$ () T@U)
(declare-fun par$PseudoListstatic_range_workaround$this$_1 () T@U)
(declare-fun par$PseudoListstatic_range_workaround$k$ () T@U)
...
(declare-fun |PseudoListget$'| (T@U T@U Int) Bool)
(declare-fun dummyFunction (T@U) Bool)
(declare-fun |PseudoListget$#triggerStateless| (T@U Int) Bool)
...
(declare-fun PseudoList$MonitorInvariant (T@U) T@U)
(declare-fun PredicateType_PseudoList$MonitorInvariantType () T@T)
(declare-fun PseudoListinv$ (T@U) T@U)
(declare-fun PredicateType_PseudoListinv$Type () T@T)
(declare-fun |PseudoList$MonitorInvariant#trigger| (T@U T@U) Bool)
(declare-fun |PseudoList$MonitorInvariant#everUsed| (T@U) Bool)
(declare-fun |PseudoListinv$#trigger| (T@U T@U) Bool)
(declare-fun |PseudoListinv$#everUsed| (T@U) Bool)
...
(declare-fun |PseudoList$MonitorInvariant#sm| (T@U) T@U)
(declare-fun |PseudoListinv$#sm| (T@U) T@U)
...
(declare-fun |PseudoListget$#frame| (T@U T@U Int) Bool)
...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type old$methodPermission) (FieldType NormalFieldType realType))) (= (type joinable$) (FieldType NormalFieldType boolType))) (= (type PseudoListvalue$) (FieldType NormalFieldType intType))) (= (Ctor RefType) 8)) (= (type PseudoListnext$) (FieldType NormalFieldType RefType))) (= (type par$PseudoListstatic_range_workaround$this$_1) (FieldType NormalFieldType RefType))) (= (type par$PseudoListstatic_range_workaround$k$) (FieldType NormalFieldType realType))))
(assert (distinct $allocated (real_2_U globalK$) old$methodPermission joinable$ PseudoListvalue$ PseudoListnext$ par$PseudoListstatic_range_workaround$this$_1 par$PseudoListstatic_range_workaround$k$)
)
...
(assert (forall ((Heap@@0 T@U) (this$_2 T@U) (index Int) ) (!  (=> (and (= (type Heap@@0) (MapType0Type RefType)) (= (type this$_2) RefType)) (dummyFunction (bool_2_U (|PseudoListget$#triggerStateless| this$_2 index))))
 :qid |stdinbpl.587:15|
 :skolemid |59|
 :pattern ( (|PseudoListget$'| Heap@@0 this$_2 index))
)))
...
(assert  (and (= (Ctor PredicateType_PseudoList$MonitorInvariantType) 13) (forall ((arg0@@29 T@U) ) (! (= (type (PseudoList$MonitorInvariant arg0@@29)) (FieldType PredicateType_PseudoList$MonitorInvariantType FrameTypeType))
 :qid |funType:PseudoList$MonitorInvariant|
 :pattern ( (PseudoList$MonitorInvariant arg0@@29))
))))
(assert (forall ((this$ T@U) ) (!  (=> (= (type this$) RefType) (IsPredicateField (PseudoList$MonitorInvariant this$)))
 :qid |stdinbpl.725:15|
 :skolemid |64|
 :pattern ( (PseudoList$MonitorInvariant this$))
)))
(assert  (and (= (Ctor PredicateType_PseudoListinv$Type) 14) (forall ((arg0@@30 T@U) ) (! (= (type (PseudoListinv$ arg0@@30)) (FieldType PredicateType_PseudoListinv$Type FrameTypeType))
 :qid |funType:PseudoListinv$|
 :pattern ( (PseudoListinv$ arg0@@30))
))))
(assert (forall ((this$_3 T@U) ) (!  (=> (= (type this$_3) RefType) (IsPredicateField (PseudoListinv$ this$_3)))
 :qid |stdinbpl.774:15|
 :skolemid |70|
 :pattern ( (PseudoListinv$ this$_3))
)))
(assert (forall ((Heap@@3 T@U) (this$@@0 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type this$@@0) RefType)) (|PseudoList$MonitorInvariant#everUsed| (PseudoList$MonitorInvariant this$@@0)))
 :qid |stdinbpl.744:15|
 :skolemid |68|
 :pattern ( (|PseudoList$MonitorInvariant#trigger| Heap@@3 (PseudoList$MonitorInvariant this$@@0)))
)))
(assert (forall ((Heap@@4 T@U) (this$_3@@0 T@U) ) (!  (=> (and (= (type Heap@@4) (MapType0Type RefType)) (= (type this$_3@@0) RefType)) (|PseudoListinv$#everUsed| (PseudoListinv$ this$_3@@0)))
 :qid |stdinbpl.793:15|
 :skolemid |74|
 :pattern ( (|PseudoListinv$#trigger| Heap@@4 (PseudoListinv$ this$_3@@0)))
)))
...
(assert (forall ((this$@@1 T@U) (this$2 T@U) ) (!  (=> (and (and (= (type this$@@1) RefType) (= (type this$2) RefType)) (= (PseudoList$MonitorInvariant this$@@1) (PseudoList$MonitorInvariant this$2))) (= this$@@1 this$2))
 :qid |stdinbpl.735:15|
 :skolemid |66|
 :pattern ( (PseudoList$MonitorInvariant this$@@1) (PseudoList$MonitorInvariant this$2))
)))
(assert (forall ((arg0@@35 T@U) ) (! (= (type (|PseudoList$MonitorInvariant#sm| arg0@@35)) (FieldType PredicateType_PseudoList$MonitorInvariantType (MapType1Type RefType boolType)))
 :qid |funType:PseudoList$MonitorInvariant#sm|
 :pattern ( (|PseudoList$MonitorInvariant#sm| arg0@@35))
)))
(assert (forall ((this$@@2 T@U) (this$2@@0 T@U) ) (!  (=> (and (and (= (type this$@@2) RefType) (= (type this$2@@0) RefType)) (= (|PseudoList$MonitorInvariant#sm| this$@@2) (|PseudoList$MonitorInvariant#sm| this$2@@0))) (= this$@@2 this$2@@0))
 :qid |stdinbpl.739:15|
 :skolemid |67|
 :pattern ( (|PseudoList$MonitorInvariant#sm| this$@@2) (|PseudoList$MonitorInvariant#sm| this$2@@0))
)))
(assert (forall ((this$_3@@1 T@U) (this$_32 T@U) ) (!  (=> (and (and (= (type this$_3@@1) RefType) (= (type this$_32) RefType)) (= (PseudoListinv$ this$_3@@1) (PseudoListinv$ this$_32))) (= this$_3@@1 this$_32))
 :qid |stdinbpl.784:15|
 :skolemid |72|
 :pattern ( (PseudoListinv$ this$_3@@1) (PseudoListinv$ this$_32))
)))
(assert (forall ((arg0@@36 T@U) ) (! (= (type (|PseudoListinv$#sm| arg0@@36)) (FieldType PredicateType_PseudoListinv$Type (MapType1Type RefType boolType)))
 :qid |funType:PseudoListinv$#sm|
 :pattern ( (|PseudoListinv$#sm| arg0@@36))
)))
(assert (forall ((this$_3@@2 T@U) (this$_32@@0 T@U) ) (!  (=> (and (and (= (type this$_3@@2) RefType) (= (type this$_32@@0) RefType)) (= (|PseudoListinv$#sm| this$_3@@2) (|PseudoListinv$#sm| this$_32@@0))) (= this$_3@@2 this$_32@@0))
 :qid |stdinbpl.788:15|
 :skolemid |73|
...
(assert  (not (IsPredicateField PseudoListvalue$)))
(assert  (not (IsWandField PseudoListvalue$)))
(assert  (not (IsPredicateField PseudoListnext$)))
(assert  (not (IsWandField PseudoListnext$)))
(assert  (not (IsPredicateField par$PseudoListstatic_range_workaround$this$_1)))
(assert  (not (IsWandField par$PseudoListstatic_range_workaround$this$_1)))
(assert  (not (IsPredicateField par$PseudoListstatic_range_workaround$k$)))
(assert  (not (IsWandField par$PseudoListstatic_range_workaround$k$)))
...
(assert (forall ((Heap@@8 T@U) (Mask@@5 T@U) (this$_2@@0 T@U) (index@@0 Int) ) (!  (=> (and (and (and (and (= (type Heap@@8) (MapType0Type RefType)) (= (type Mask@@5) (MapType1Type RefType realType))) (= (type this$_2@@0) RefType)) (and (state Heap@@8 Mask@@5) (< AssumeFunctionsAbove 0))) (not (= this$_2@@0 null))) (= (PseudoListget$ Heap@@8 this$_2@@0 index@@0)  (or (= index@@0 0) (|PseudoListget$'| Heap@@8 (MapType0Select Heap@@8 this$_2@@0 PseudoListnext$) (- index@@0 1)))))
 :qid |stdinbpl.593:15|
 :skolemid |60|
 :pattern ( (state Heap@@8 Mask@@5) (PseudoListget$ Heap@@8 this$_2@@0 index@@0))
 :pattern ( (state Heap@@8 Mask@@5) (|PseudoListget$#triggerStateless| this$_2@@0 index@@0) (|PseudoListinv$#trigger| Heap@@8 (PseudoListinv$ this$_2@@0)))
)))
...
(assert  (and (forall ((arg0@@38 Real) (arg1@@15 T@U) ) (! (= (type (ConditionalFrame arg0@@38 arg1@@15)) FrameTypeType)
...
(assert (forall ((this$@@3 T@U) ) (!  (=> (= (type this$@@3) RefType) (= (getPredWandId (PseudoList$MonitorInvariant this$@@3)) 0))
 :qid |stdinbpl.729:15|
 :skolemid |65|
 :pattern ( (PseudoList$MonitorInvariant this$@@3))
)))
(assert (forall ((this$_3@@3 T@U) ) (!  (=> (= (type this$_3@@3) RefType) (= (getPredWandId (PseudoListinv$ this$_3@@3)) 1))
 :qid |stdinbpl.778:15|
 :skolemid |71|
...
(assert (forall ((this$@@4 T@U) ) (!  (=> (= (type this$@@4) RefType) (= (PredicateMaskField (PseudoList$MonitorInvariant this$@@4)) (|PseudoList$MonitorInvariant#sm| this$@@4)))
 :qid |stdinbpl.721:15|
 :skolemid |63|
 :pattern ( (PredicateMaskField (PseudoList$MonitorInvariant this$@@4)))
)))
(assert (forall ((this$_3@@4 T@U) ) (!  (=> (= (type this$_3@@4) RefType) (= (PredicateMaskField (PseudoListinv$ this$_3@@4)) (|PseudoListinv$#sm| this$_3@@4)))
 :qid |stdinbpl.770:15|
 :skolemid |69|
 :pattern ( (PredicateMaskField (PseudoListinv$ this$_3@@4)))
)))
...
(assert (forall ((Heap@@12 T@U) (Mask@@10 T@U) (this$_2@@1 T@U) (index@@1 Int) ) (!  (=> (and (and (and (= (type Heap@@12) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type this$_2@@1) RefType)) (state Heap@@12 Mask@@10)) (= (|PseudoListget$'| Heap@@12 this$_2@@1 index@@1) (|PseudoListget$#frame| (MapType0Select Heap@@12 null (PseudoListinv$ this$_2@@1)) this$_2@@1 index@@1)))
 :qid |stdinbpl.600:15|
 :skolemid |61|
 :pattern ( (state Heap@@12 Mask@@10) (|PseudoListget$'| Heap@@12 this$_2@@1 index@@1))
 :pattern ( (state Heap@@12 Mask@@10) (|PseudoListget$#triggerStateless| this$_2@@1 index@@1) (|PseudoListinv$#trigger| Heap@@12 (PseudoListinv$ this$_2@@1)))
)))
...
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(assert (forall ((Heap@@14 T@U) (this$_2@@2 T@U) (index@@2 Int) ) (!  (=> (and (= (type Heap@@14) (MapType0Type RefType)) (= (type this$_2@@2) RefType)) (and (= (PseudoListget$ Heap@@14 this$_2@@2 index@@2) (|PseudoListget$'| Heap@@14 this$_2@@2 index@@2)) (dummyFunction (bool_2_U (|PseudoListget$#triggerStateless| this$_2@@2 index@@2)))))
 :qid |stdinbpl.583:15|
 :skolemid |58|
 :pattern ( (PseudoListget$ Heap@@14 this$_2@@2 index@@2))
)))
(push 1)
...
(assert  (and (and (and (and (and (and (= (type this$_1) RefType) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@15) (MapType0Type RefType))) (= (type n$) RefType)) (= (type a$) RefType)) (= (type b$) RefType)) (= (type c$) RefType)))
...
(let ((anon31_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (PseudoListinv$ this$_1))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (PseudoListinv$ this$_1)))) (=> (= (ControlFlow 0 22) 21) anon20_correct))))))
(let ((anon29_Else_correct  (=> (and (forall ((i_4_1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i_4_1)) (PseudoListget$ Heap@@15 this$_1 i_4_1))
 :qid |stdinbpl.1004:20|
 :skolemid |76|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 4) (int_2_U i_4_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i_4_1)))
 :pattern ( (|PseudoListget$#frame| (MapType0Select Heap@@15 null (PseudoListinv$ this$_1)) this$_1 i_4_1))
)) (state Heap@@15 Mask@0)) (and (=> (= (ControlFlow 0 25) 22) anon31_Then_correct) (=> (= (ControlFlow 0 25) 24) anon31_Else_correct)))))
(let ((anon17_correct true))
(let ((anon30_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i_3))) (= (ControlFlow 0 20) 17)) anon17_correct)))
(let ((anon30_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i_3)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (PseudoListget$ Heap@@15 this$_1 i_3)) (=> (PseudoListget$ Heap@@15 this$_1 i_3) (=> (= (ControlFlow 0 18) 17) anon17_correct))))))
(let ((anon28_Then_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (not (= this$_1 null))) (=> (not (= this$_1 null)) (=> (= (ControlFlow 0 14) (- 0 13)) (> (U_2_real (MapType1Select Mask@0 null (PseudoListinv$ this$_1))) NoPerm))))))
(let ((anon13_correct true))
(let ((anon27_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i_2)) (and (=> (= (ControlFlow 0 16) 14) anon28_Then_correct) (=> (= (ControlFlow 0 16) 11) anon13_correct)))))
(let ((anon27_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 4) (int_2_U i_2))) (= (ControlFlow 0 12) 11)) anon13_correct)))
(let ((anon23_Else_correct  (=> (forall ((i_1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 1 4) (int_2_U i_1)) (PseudoListget$ Heap@@15 this$_1 i_1))
 :qid |stdinbpl.959:20|
 :skolemid |75|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 1 4) (int_2_U i_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 1 4) (int_2_U i_1)))
 :pattern ( (|PseudoListget$#frame| (MapType0Select Heap@@15 null (PseudoListinv$ this$_1)) this$_1 i_1))
)) (=> (and (state Heap@@15 Mask@0) (state Heap@@15 Mask@0)) (and (and (and (and (=> (= (ControlFlow 0 26) 25) anon29_Else_correct) (=> (= (ControlFlow 0 26) 18) anon30_Then_correct)) (=> (= (ControlFlow 0 26) 20) anon30_Else_correct)) (=> (= (ControlFlow 0 26) 16) anon27_Then_correct)) (=> (= (ControlFlow 0 26) 12) anon27_Else_correct))))))
(let ((anon25_Then_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (not (= this$_1 null))) (=> (not (= this$_1 null)) (=> (= (ControlFlow 0 8) (- 0 7)) (> (U_2_real (MapType1Select Mask@0 null (PseudoListinv$ this$_1))) NoPerm))))))
(let ((anon8_correct true))
(let ((anon24_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 1 4) (int_2_U i@@6)) (and (=> (= (ControlFlow 0 10) 8) anon25_Then_correct) (=> (= (ControlFlow 0 10) 5) anon8_correct)))))
(let ((anon24_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 1 4) (int_2_U i@@6))) (= (ControlFlow 0 6) 5)) anon8_correct)))
(let ((anon22_Else_correct  (=> (and (and (PseudoListget$ Heap@@15 this$_1 0) (state Heap@@15 Mask@0)) (and (state Heap@@15 Mask@0) (state Heap@@15 Mask@0))) (and (and (=> (= (ControlFlow 0 27) 26) anon23_Else_correct) (=> (= (ControlFlow 0 27) 10) anon24_Then_correct)) (=> (= (ControlFlow 0 27) 6) anon24_Else_correct)))))
(let ((anon22_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (not (= this$_1 null))) (=> (not (= this$_1 null)) (=> (= (ControlFlow 0 3) (- 0 2)) (> (U_2_real (MapType1Select Mask@0 null (PseudoListinv$ this$_1))) NoPerm))))))
(let ((anon21_Else_correct  (=> (U_2_bool (MapType0Select Heap@@15 n$ $allocated)) (=> (and (and (U_2_bool (MapType0Select Heap@@15 a$ $allocated)) (U_2_bool (MapType0Select Heap@@15 b$ $allocated))) (and (U_2_bool (MapType0Select Heap@@15 c$ $allocated)) (state Heap@@15 Mask@0))) (and (=> (= (ControlFlow 0 28) 3) anon22_Then_correct) (=> (= (ControlFlow 0 28) 27) anon22_Else_correct))))))
(let ((anon21_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@15 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@15 this$_1 $allocated)) (not (= this$_1 null)))) (=> (and (and (and (state Heap@@15 ZeroMask) (< NoPerm k$)) (and (state Heap@@15 ZeroMask) (< k$ FullPerm))) (and (and (state Heap@@15 ZeroMask) (= Mask@0 (MapType1Store ZeroMask null (PseudoListinv$ this$_1) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (PseudoListinv$ this$_1))) FullPerm))))) (and (state Heap@@15 Mask@0) (state Heap@@15 Mask@0)))) (and (=> (= (ControlFlow 0 29) 1) anon21_Then_correct) (=> (= (ControlFlow 0 29) 28) anon21_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (> wildcard NoPerm) true) (= (ControlFlow 0 30) 29)) anon0_correct)))
