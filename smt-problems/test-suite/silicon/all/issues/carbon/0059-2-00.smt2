(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 19:46:38
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/issues/carbon/0059-2.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(push) ; 4
(assert (P%trigger ($Snap.second $t@2@01) this@1@01))
(pop) ; 4
...
; Joined path conditions
(assert (and
  (P%trigger ($Snap.first $t@3@01) this@1@01)
  (P%trigger ($Snap.second $t@2@01) this@1@01)))
(assert (=
