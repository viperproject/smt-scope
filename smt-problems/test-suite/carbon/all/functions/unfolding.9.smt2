...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@10) (MapType0Type RefType)) (= (type freshObj@0) RefType)) (= (type ExhaleWellDef0Mask@0) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Heap@9) (MapType0Type RefType))) (= (type Heap@7) (MapType0Type RefType))) (= (type Heap@6) (MapType0Type RefType))) (= (type Heap@8) (MapType0Type RefType))) (= (type freshVersion@1) FrameTypeType)) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (forall ((arg0@@35 T@U) ) (! (= (type (FrameFragment arg0@@35)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@35))
))) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@37) (MapType0Type RefType))) (= (type x@@48) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))))
...
(let ((anon21_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@0 null (G freshObj@0))))) (=> (<= FullPerm (U_2_real (MapType1Select ExhaleWellDef0Mask@0 null (G freshObj@0)))) (=> (= (ControlFlow 0 4) 3) anon13_correct))))))
(let ((anon11_correct  (=> (= ExhaleWellDef0Mask@0 (MapType1Store Mask@5 null (F freshObj@0) (real_2_U (- (U_2_real (MapType1Select Mask@5 null (F freshObj@0))) FullPerm)))) (and (=> (= (ControlFlow 0 7) 4) anon21_Then_correct) (=> (= (ControlFlow 0 7) 6) anon21_Else_correct)))))
(let ((anon20_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 7)) anon11_correct)))
(let ((anon20_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select Mask@5 null (F freshObj@0))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@5 null (F freshObj@0)))) (=> (= (ControlFlow 0 8) 7) anon11_correct))))))
(let ((anon19_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= (fun1 Heap@10 freshObj@0) 10))))
(let ((anon8_correct  (=> (= Heap@10 (MapType0Store Heap@9 null (|G#sm| freshObj@0) (MapType1Store (MapType0Select Heap@9 null (|G#sm| freshObj@0)) freshObj@0 g (bool_2_U true)))) (=> (and (state Heap@10 Mask@5) (state Heap@10 Mask@5)) (and (and (=> (= (ControlFlow 0 11) 2) anon19_Else_correct) (=> (= (ControlFlow 0 11) 8) anon20_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon20_Else_correct))))))
(let ((anon18_Else_correct  (=> (HasDirectPerm Mask@5 null (G freshObj@0)) (=> (and (= Heap@9 Heap@6) (= (ControlFlow 0 13) 11)) anon8_correct))))
(let ((anon18_Then_correct  (=> (not (HasDirectPerm Mask@5 null (G freshObj@0))) (=> (and (and (= Heap@7 (MapType0Store Heap@6 null (|G#sm| freshObj@0) ZeroPMask)) (= Heap@8 (MapType0Store Heap@7 null (G freshObj@0) freshVersion@1))) (and (= Heap@9 Heap@8) (= (ControlFlow 0 12) 11))) anon8_correct))))
(let ((anon6_correct  (=> (and (= Mask@4 (MapType1Store Mask@3 freshObj@0 g (real_2_U (- (U_2_real (MapType1Select Mask@3 freshObj@0 g)) FullPerm)))) (= Mask@5 (MapType1Store Mask@4 null (G freshObj@0) (real_2_U (+ (U_2_real (MapType1Select Mask@4 null (G freshObj@0))) FullPerm))))) (=> (and (and (state Heap@6 Mask@5) (state Heap@6 Mask@5)) (and (|G#trigger| Heap@6 (G freshObj@0)) (= (MapType0Select Heap@6 null (G freshObj@0)) (FrameFragment (MapType0Select Heap@6 freshObj@0 g))))) (and (=> (= (ControlFlow 0 14) 12) anon18_Then_correct) (=> (= (ControlFlow 0 14) 13) anon18_Else_correct))))))
(let ((anon17_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 17) 14)) anon6_correct)))
(let ((anon17_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 g)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 g))) (=> (= (ControlFlow 0 15) 14) anon6_correct))))))
(let ((anon4_correct  (=> (= Heap@6 (MapType0Store Heap@5 null (|F#sm| freshObj@0) (MapType1Store (MapType0Select Heap@5 null (|F#sm| freshObj@0)) freshObj@0 f_7 (bool_2_U true)))) (=> (and (state Heap@6 Mask@3) (state Heap@6 Mask@3)) (and (=> (= (ControlFlow 0 18) 15) anon17_Then_correct) (=> (= (ControlFlow 0 18) 17) anon17_Else_correct))))))
(let ((anon16_Else_correct  (=> (HasDirectPerm Mask@3 null (F freshObj@0)) (=> (and (= Heap@5 Heap@2) (= (ControlFlow 0 20) 18)) anon4_correct))))
(let ((anon16_Then_correct  (=> (not (HasDirectPerm Mask@3 null (F freshObj@0))) (=> (and (and (= Heap@3 (MapType0Store Heap@2 null (|F#sm| freshObj@0) ZeroPMask)) (= Heap@4 (MapType0Store Heap@3 null (F freshObj@0) freshVersion@0))) (and (= Heap@5 Heap@4) (= (ControlFlow 0 19) 18))) anon4_correct))))
(let ((anon2_correct  (=> (and (= Mask@2 (MapType1Store Mask@1 freshObj@0 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@1 freshObj@0 f_7)) FullPerm)))) (= Mask@3 (MapType1Store Mask@2 null (F freshObj@0) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (F freshObj@0))) FullPerm))))) (=> (and (and (state Heap@2 Mask@3) (state Heap@2 Mask@3)) (and (|F#trigger| Heap@2 (F freshObj@0)) (= (MapType0Select Heap@2 null (F freshObj@0)) (FrameFragment (MapType0Select Heap@2 freshObj@0 f_7))))) (and (=> (= (ControlFlow 0 21) 19) anon16_Then_correct) (=> (= (ControlFlow 0 21) 20) anon16_Else_correct))))))
(let ((anon15_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 24) 21)) anon2_correct)))
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (<= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 f_7))) (=> (= (ControlFlow 0 22) 21) anon2_correct))))))
(let ((anon0_correct  (=> (state Heap@@37 ZeroMask) (=> (and (and (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@37 x@@48 $allocated))) (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@37 freshObj@0 $allocated))))) (and (and (= Heap@0 (MapType0Store Heap@@37 freshObj@0 $allocated (bool_2_U true))) (= Mask@0 (MapType1Store ZeroMask freshObj@0 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 f_7)) FullPerm))))) (and (= Mask@1 (MapType1Store Mask@0 freshObj@0 g (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@0 g)) FullPerm)))) (state Heap@0 Mask@1)))) (and (=> (= (ControlFlow 0 25) (- 0 27)) (= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 f_7))) (=> (and (= Heap@1 (MapType0Store Heap@0 freshObj@0 f_7 (int_2_U 3))) (state Heap@1 Mask@1)) (and (=> (= (ControlFlow 0 25) (- 0 26)) (= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 g)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 freshObj@0 g))) (=> (and (= Heap@2 (MapType0Store Heap@1 freshObj@0 g (int_2_U 7))) (state Heap@2 Mask@1)) (and (=> (= (ControlFlow 0 25) 22) anon15_Then_correct) (=> (= (ControlFlow 0 25) 24) anon15_Else_correct))))))))))))
...
(declare-fun Heap@3 () T@U)
(declare-fun Heap@4 () T@U)
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type Heap@15) (MapType0Type RefType)) (= (type freshObj@0) RefType)) (= (type freshObj@1) RefType)) (= (type ExhaleWellDef0Mask@0) (MapType1Type RefType realType))) (= (type Mask@9) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@2) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@4) (MapType1Type RefType realType))) (= (type ExhaleWellDef0Mask@6) (MapType1Type RefType realType))) (= (type Heap@14) (MapType0Type RefType))) (= (type Heap@13) (MapType0Type RefType))) (= (type Heap@11) (MapType0Type RefType))) (= (type Heap@10) (MapType0Type RefType))) (= (type Heap@12) (MapType0Type RefType))) (= (type freshVersion@1) FrameTypeType)) (= (type Mask@8) (MapType1Type RefType realType))) (= (type Mask@7) (MapType1Type RefType realType))) (forall ((arg0@@35 T@U) ) (! (= (type (FrameFragment arg0@@35)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@35))
))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type Heap@9) (MapType0Type RefType))) (= (type Heap@8) (MapType0Type RefType))) (= (type Heap@6) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@7) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@5) (MapType1Type RefType realType))) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Heap@@37) (MapType0Type RefType))) (= (type x@@48) RefType)) (= (type y@@9) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type Heap@4) (MapType0Type RefType))))
(set-info :boogie-vc-id test2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 80) (let ((anon17_correct true))
(let ((anon45_Else_correct  (=> (and (= perm@7 NoPerm) (= (ControlFlow 0 45) 42)) anon17_correct)))
(let ((anon45_Then_correct  (=> (not (= perm@7 NoPerm)) (and (=> (= (ControlFlow 0 43) (- 0 44)) (<= perm@7 (U_2_real (MapType1Select ExhaleWellDef0Mask@6 null (pair freshObj@0))))) (=> (<= perm@7 (U_2_real (MapType1Select ExhaleWellDef0Mask@6 null (pair freshObj@0)))) (=> (= (ControlFlow 0 43) 42) anon17_correct))))))
(let ((anon15_correct  (=> (and (= ExhaleWellDef0Mask@6 (MapType1Store Mask@9 null (pair freshObj@0) (real_2_U (- (U_2_real (MapType1Select Mask@9 null (pair freshObj@0))) perm@0)))) (= perm@7 (/ (to_real 1) (to_real 3)))) (and (=> (= (ControlFlow 0 46) (- 0 47)) (>= perm@7 NoPerm)) (=> (>= perm@7 NoPerm) (and (=> (= (ControlFlow 0 46) 43) anon45_Then_correct) (=> (= (ControlFlow 0 46) 45) anon45_Else_correct)))))))
(let ((anon44_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 50) 46)) anon15_correct)))
(let ((anon44_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 48) (- 0 49)) (<= perm@0 (U_2_real (MapType1Select Mask@9 null (pair freshObj@0))))) (=> (<= perm@0 (U_2_real (MapType1Select Mask@9 null (pair freshObj@0)))) (=> (= (ControlFlow 0 48) 46) anon15_correct))))))
(let ((anon43_Then_correct  (=> (= perm@0 (/ (to_real 1) (to_real 3))) (and (=> (= (ControlFlow 0 51) (- 0 52)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 51) 48) anon44_Then_correct) (=> (= (ControlFlow 0 51) 50) anon44_Else_correct)))))))
(let ((anon23_correct true))
(let ((anon48_Else_correct  (=> (and (= perm@6 NoPerm) (= (ControlFlow 0 32) 29)) anon23_correct)))
(let ((anon48_Then_correct  (=> (not (= perm@6 NoPerm)) (and (=> (= (ControlFlow 0 30) (- 0 31)) (<= perm@6 (U_2_real (MapType1Select ExhaleWellDef0Mask@4 null (pair freshObj@1))))) (=> (<= perm@6 (U_2_real (MapType1Select ExhaleWellDef0Mask@4 null (pair freshObj@1)))) (=> (= (ControlFlow 0 30) 29) anon23_correct))))))
(let ((anon21_correct  (=> (and (= ExhaleWellDef0Mask@4 (MapType1Store Mask@9 null (pair freshObj@0) (real_2_U (- (U_2_real (MapType1Select Mask@9 null (pair freshObj@0))) perm@1)))) (= perm@6 (/ (to_real 1) (to_real 3)))) (and (=> (= (ControlFlow 0 33) (- 0 34)) (>= perm@6 NoPerm)) (=> (>= perm@6 NoPerm) (and (=> (= (ControlFlow 0 33) 30) anon48_Then_correct) (=> (= (ControlFlow 0 33) 32) anon48_Else_correct)))))))
(let ((anon47_Else_correct  (=> (and (= perm@1 NoPerm) (= (ControlFlow 0 37) 33)) anon21_correct)))
(let ((anon47_Then_correct  (=> (not (= perm@1 NoPerm)) (and (=> (= (ControlFlow 0 35) (- 0 36)) (<= perm@1 (U_2_real (MapType1Select Mask@9 null (pair freshObj@0))))) (=> (<= perm@1 (U_2_real (MapType1Select Mask@9 null (pair freshObj@0)))) (=> (= (ControlFlow 0 35) 33) anon21_correct))))))
(let ((anon46_Then_correct  (=> (= perm@1 (/ (to_real 1) (to_real 3))) (and (=> (= (ControlFlow 0 38) (- 0 39)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (and (=> (= (ControlFlow 0 38) 35) anon47_Then_correct) (=> (= (ControlFlow 0 38) 37) anon47_Else_correct)))))))
(let ((anon29_correct true))
(let ((anon51_Else_correct  (=> (and (= perm@5 NoPerm) (= (ControlFlow 0 19) 16)) anon29_correct)))
(let ((anon51_Then_correct  (=> (not (= perm@5 NoPerm)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (<= perm@5 (U_2_real (MapType1Select ExhaleWellDef0Mask@2 null (pair freshObj@0))))) (=> (<= perm@5 (U_2_real (MapType1Select ExhaleWellDef0Mask@2 null (pair freshObj@0)))) (=> (= (ControlFlow 0 17) 16) anon29_correct))))))
(let ((anon27_correct  (=> (and (= ExhaleWellDef0Mask@2 (MapType1Store Mask@9 null (pair freshObj@1) (real_2_U (- (U_2_real (MapType1Select Mask@9 null (pair freshObj@1))) perm@2)))) (= perm@5 (/ (to_real 1) (to_real 3)))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (>= perm@5 NoPerm)) (=> (>= perm@5 NoPerm) (and (=> (= (ControlFlow 0 20) 17) anon51_Then_correct) (=> (= (ControlFlow 0 20) 19) anon51_Else_correct)))))))
(let ((anon50_Else_correct  (=> (and (= perm@2 NoPerm) (= (ControlFlow 0 24) 20)) anon27_correct)))
(let ((anon50_Then_correct  (=> (not (= perm@2 NoPerm)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (<= perm@2 (U_2_real (MapType1Select Mask@9 null (pair freshObj@1))))) (=> (<= perm@2 (U_2_real (MapType1Select Mask@9 null (pair freshObj@1)))) (=> (= (ControlFlow 0 22) 20) anon27_correct))))))
(let ((anon49_Then_correct  (=> (= perm@2 (/ (to_real 1) (to_real 3))) (and (=> (= (ControlFlow 0 25) (- 0 26)) (>= perm@2 NoPerm)) (=> (>= perm@2 NoPerm) (and (=> (= (ControlFlow 0 25) 22) anon50_Then_correct) (=> (= (ControlFlow 0 25) 24) anon50_Else_correct)))))))
(let ((anon35_correct true))
(let ((anon54_Else_correct  (=> (and (= perm@4 NoPerm) (= (ControlFlow 0 6) 3)) anon35_correct)))
(let ((anon54_Then_correct  (=> (not (= perm@4 NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= perm@4 (U_2_real (MapType1Select ExhaleWellDef0Mask@0 null (pair freshObj@1))))) (=> (<= perm@4 (U_2_real (MapType1Select ExhaleWellDef0Mask@0 null (pair freshObj@1)))) (=> (= (ControlFlow 0 4) 3) anon35_correct))))))
(let ((anon33_correct  (=> (and (= ExhaleWellDef0Mask@0 (MapType1Store Mask@9 null (pair freshObj@0) (real_2_U (- (U_2_real (MapType1Select Mask@9 null (pair freshObj@0))) perm@3)))) (= perm@4 (/ (to_real 1) (to_real 3)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (>= perm@4 NoPerm)) (=> (>= perm@4 NoPerm) (and (=> (= (ControlFlow 0 7) 4) anon54_Then_correct) (=> (= (ControlFlow 0 7) 6) anon54_Else_correct)))))))
(let ((anon53_Else_correct  (=> (and (= perm@3 NoPerm) (= (ControlFlow 0 11) 7)) anon33_correct)))
(let ((anon53_Then_correct  (=> (not (= perm@3 NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= perm@3 (U_2_real (MapType1Select Mask@9 null (pair freshObj@0))))) (=> (<= perm@3 (U_2_real (MapType1Select Mask@9 null (pair freshObj@0)))) (=> (= (ControlFlow 0 9) 7) anon33_correct))))))
(let ((anon52_Then_correct  (=> (= perm@3 (/ (to_real 1) (to_real 3))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (>= perm@3 NoPerm)) (=> (>= perm@3 NoPerm) (and (=> (= (ControlFlow 0 12) 9) anon53_Then_correct) (=> (= (ControlFlow 0 12) 11) anon53_Else_correct)))))))
(let ((anon52_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (< (add Heap@15 freshObj@0 freshObj@1) 0))))
(let ((anon49_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (< (add Heap@15 freshObj@1 freshObj@0) 0)) (=> (< (add Heap@15 freshObj@1 freshObj@0) 0) (=> (state Heap@15 Mask@9) (and (=> (= (ControlFlow 0 14) 12) anon52_Then_correct) (=> (= (ControlFlow 0 14) 2) anon52_Else_correct)))))))
(let ((anon46_Else_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) (= (add Heap@15 freshObj@0 freshObj@1) (+ a_2 3))) (=> (= (add Heap@15 freshObj@0 freshObj@1) (+ a_2 3)) (=> (state Heap@15 Mask@9) (and (=> (= (ControlFlow 0 27) 25) anon49_Then_correct) (=> (= (ControlFlow 0 27) 14) anon49_Else_correct)))))))
(let ((anon43_Else_correct  (and (=> (= (ControlFlow 0 40) (- 0 41)) (= (add Heap@15 freshObj@0 freshObj@0) (+ 2 a_2))) (=> (= (add Heap@15 freshObj@0 freshObj@0) (+ 2 a_2)) (=> (state Heap@15 Mask@9) (and (=> (= (ControlFlow 0 40) 38) anon46_Then_correct) (=> (= (ControlFlow 0 40) 27) anon46_Else_correct)))))))
(let ((anon12_correct  (=> (and (and (= Heap@14 (MapType0Store Heap@13 null (|pair#sm| freshObj@1) (MapType1Store (MapType0Select Heap@13 null (|pair#sm| freshObj@1)) freshObj@1 f_7 (bool_2_U true)))) (= Heap@15 (MapType0Store Heap@14 null (|pair#sm| freshObj@1) (MapType1Store (MapType0Select Heap@14 null (|pair#sm| freshObj@1)) freshObj@1 g (bool_2_U true))))) (and (state Heap@15 Mask@9) (state Heap@15 Mask@9))) (and (=> (= (ControlFlow 0 53) 51) anon43_Then_correct) (=> (= (ControlFlow 0 53) 40) anon43_Else_correct)))))
(let ((anon42_Else_correct  (=> (HasDirectPerm Mask@9 null (pair freshObj@1)) (=> (and (= Heap@13 Heap@10) (= (ControlFlow 0 55) 53)) anon12_correct))))
(let ((anon42_Then_correct  (=> (not (HasDirectPerm Mask@9 null (pair freshObj@1))) (=> (and (and (= Heap@11 (MapType0Store Heap@10 null (|pair#sm| freshObj@1) ZeroPMask)) (= Heap@12 (MapType0Store Heap@11 null (pair freshObj@1) freshVersion@1))) (and (= Heap@13 Heap@12) (= (ControlFlow 0 54) 53))) anon12_correct))))
(let ((anon10_correct  (=> (and (= Mask@8 (MapType1Store Mask@7 freshObj@1 g (real_2_U (- (U_2_real (MapType1Select Mask@7 freshObj@1 g)) FullPerm)))) (= Mask@9 (MapType1Store Mask@8 null (pair freshObj@1) (real_2_U (+ (U_2_real (MapType1Select Mask@8 null (pair freshObj@1))) FullPerm))))) (=> (and (and (state Heap@10 Mask@9) (state Heap@10 Mask@9)) (and (|pair#trigger| Heap@10 (pair freshObj@1)) (= (MapType0Select Heap@10 null (pair freshObj@1)) (CombineFrames (FrameFragment (MapType0Select Heap@10 freshObj@1 f_7)) (FrameFragment (MapType0Select Heap@10 freshObj@1 g)))))) (and (=> (= (ControlFlow 0 56) 54) anon42_Then_correct) (=> (= (ControlFlow 0 56) 55) anon42_Else_correct))))))
(let ((anon41_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 59) 56)) anon10_correct)))
(let ((anon41_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 57) (- 0 58)) (<= FullPerm (U_2_real (MapType1Select Mask@7 freshObj@1 g)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@7 freshObj@1 g))) (=> (= (ControlFlow 0 57) 56) anon10_correct))))))
(let ((anon8_correct  (=> (= Mask@7 (MapType1Store Mask@6 freshObj@1 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@6 freshObj@1 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 60) 57) anon41_Then_correct) (=> (= (ControlFlow 0 60) 59) anon41_Else_correct)))))
(let ((anon40_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 63) 60)) anon8_correct)))
(let ((anon40_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 61) (- 0 62)) (<= FullPerm (U_2_real (MapType1Select Mask@6 freshObj@1 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@6 freshObj@1 f_7))) (=> (= (ControlFlow 0 61) 60) anon8_correct))))))
(let ((anon6_correct  (=> (and (and (= Heap@9 (MapType0Store Heap@8 null (|pair#sm| freshObj@0) (MapType1Store (MapType0Select Heap@8 null (|pair#sm| freshObj@0)) freshObj@0 f_7 (bool_2_U true)))) (= Heap@10 (MapType0Store Heap@9 null (|pair#sm| freshObj@0) (MapType1Store (MapType0Select Heap@9 null (|pair#sm| freshObj@0)) freshObj@0 g (bool_2_U true))))) (and (state Heap@10 Mask@6) (state Heap@10 Mask@6))) (and (=> (= (ControlFlow 0 64) 61) anon40_Then_correct) (=> (= (ControlFlow 0 64) 63) anon40_Else_correct)))))
(let ((anon39_Else_correct  (=> (HasDirectPerm Mask@6 null (pair freshObj@0)) (=> (and (= Heap@8 Heap@5) (= (ControlFlow 0 66) 64)) anon6_correct))))
(let ((anon39_Then_correct  (=> (not (HasDirectPerm Mask@6 null (pair freshObj@0))) (=> (and (and (= Heap@6 (MapType0Store Heap@5 null (|pair#sm| freshObj@0) ZeroPMask)) (= Heap@7 (MapType0Store Heap@6 null (pair freshObj@0) freshVersion@0))) (and (= Heap@8 Heap@7) (= (ControlFlow 0 65) 64))) anon6_correct))))
(let ((anon4_correct  (=> (and (= Mask@5 (MapType1Store Mask@4 freshObj@0 g (real_2_U (- (U_2_real (MapType1Select Mask@4 freshObj@0 g)) FullPerm)))) (= Mask@6 (MapType1Store Mask@5 null (pair freshObj@0) (real_2_U (+ (U_2_real (MapType1Select Mask@5 null (pair freshObj@0))) FullPerm))))) (=> (and (and (state Heap@5 Mask@6) (state Heap@5 Mask@6)) (and (|pair#trigger| Heap@5 (pair freshObj@0)) (= (MapType0Select Heap@5 null (pair freshObj@0)) (CombineFrames (FrameFragment (MapType0Select Heap@5 freshObj@0 f_7)) (FrameFragment (MapType0Select Heap@5 freshObj@0 g)))))) (and (=> (= (ControlFlow 0 67) 65) anon39_Then_correct) (=> (= (ControlFlow 0 67) 66) anon39_Else_correct))))))
(let ((anon38_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 70) 67)) anon4_correct)))
(let ((anon38_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 68) (- 0 69)) (<= FullPerm (U_2_real (MapType1Select Mask@4 freshObj@0 g)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 freshObj@0 g))) (=> (= (ControlFlow 0 68) 67) anon4_correct))))))
(let ((anon2_correct  (=> (= Mask@4 (MapType1Store Mask@3 freshObj@0 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@3 freshObj@0 f_7)) FullPerm)))) (and (=> (= (ControlFlow 0 71) 68) anon38_Then_correct) (=> (= (ControlFlow 0 71) 70) anon38_Else_correct)))))
(let ((anon37_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 74) 71)) anon2_correct)))
(let ((anon37_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 72) (- 0 73)) (<= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 f_7))) (=> (= (ControlFlow 0 72) 71) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@37 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and (and (> a_2 10) (state Heap@@37 ZeroMask)) (and (U_2_bool (MapType0Select Heap@@37 x@@48 $allocated)) (U_2_bool (MapType0Select Heap@@37 y@@9 $allocated)))) (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@37 freshObj@0 $allocated)))) (and (= Heap@0 (MapType0Store Heap@@37 freshObj@0 $allocated (bool_2_U true))) (= Mask@0 (MapType1Store ZeroMask freshObj@0 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 f_7)) FullPerm))))))) (and (and (and (= Mask@1 (MapType1Store Mask@0 freshObj@0 g (real_2_U (+ (U_2_real (MapType1Select Mask@0 freshObj@0 g)) FullPerm)))) (state Heap@0 Mask@1)) (and (not (= freshObj@1 null)) (not (U_2_bool (MapType0Select Heap@0 freshObj@1 $allocated))))) (and (and (= Heap@1 (MapType0Store Heap@0 freshObj@1 $allocated (bool_2_U true))) (= Mask@2 (MapType1Store Mask@1 freshObj@1 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@1 freshObj@1 f_7)) FullPerm))))) (and (= Mask@3 (MapType1Store Mask@2 freshObj@1 g (real_2_U (+ (U_2_real (MapType1Select Mask@2 freshObj@1 g)) FullPerm)))) (state Heap@1 Mask@3))))) (and (=> (= (ControlFlow 0 75) (- 0 79)) (= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 f_7))) (=> (and (= Heap@2 (MapType0Store Heap@1 freshObj@0 f_7 (int_2_U 1))) (state Heap@2 Mask@3)) (and (=> (= (ControlFlow 0 75) (- 0 78)) (= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 g)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@0 g))) (=> (and (= Heap@3 (MapType0Store Heap@2 freshObj@0 g (int_2_U a_2))) (state Heap@3 Mask@3)) (and (=> (= (ControlFlow 0 75) (- 0 77)) (= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@1 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@1 f_7))) (=> (and (= Heap@4 (MapType0Store Heap@3 freshObj@1 f_7 (int_2_U 2))) (state Heap@4 Mask@3)) (and (=> (= (ControlFlow 0 75) (- 0 76)) (= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@1 g)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@3 freshObj@1 g))) (=> (and (= Heap@5 (MapType0Store Heap@4 freshObj@1 g (int_2_U (- 0 a_2)))) (state Heap@5 Mask@3)) (and (=> (= (ControlFlow 0 75) 72) anon37_Then_correct) (=> (= (ControlFlow 0 75) 74) anon37_Else_correct))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 80) 75) anon0_correct)))
PreconditionGeneratedEntry_correct)))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
