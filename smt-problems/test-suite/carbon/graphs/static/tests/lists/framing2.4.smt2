...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type g0@@8) (MapType2Type RefType boolType)) (= (type n$0_2) RefType)) (= (type Heap@@27) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type g1@@8) (MapType2Type RefType boolType))) (= (type n$2_1) RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type u_2) RefType)) (= (type v_3) RefType)) (= (type QPMask@4) (MapType1Type RefType realType))) (= (type QPMask@5) (MapType1Type RefType realType))) (= (type u_4) RefType)) (= (type v_4) RefType)) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type QPMask@3) (MapType1Type RefType realType))) (forall ((arg0@@58 T@U) ) (! (= (type (invRecv9 arg0@@58)) RefType)
 :qid |funType:invRecv9|
 :pattern ( (invRecv9 arg0@@58))
))) (forall ((arg0@@59 T@U) ) (! (= (type (invRecv8 arg0@@59)) RefType)
 :qid |funType:invRecv8|
 :pattern ( (invRecv8 arg0@@59))
))))
(set-info :boogie-vc-id |apply_TCFraming#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 48) (let ((anon46_Then_correct  (and (=> (= (ControlFlow 0 36) (- 0 38)) (forall ((n_7 T@U) ) (!  (=> (= (type n_7) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Union| g1@@8 g0@@8) n_7)) (dummyFunction (MapType0Select Heap@@27 n_7 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.1798:25|
 :skolemid |226|
 :pattern ( (MapType0Select Heap@@27 n_7 next))
 :pattern ( (MapType1Select QPMask@3 n_7 next))
 :pattern ( (MapType0Select Heap@@27 n_7 next))
))) (=> (forall ((n_7@@0 T@U) ) (!  (=> (= (type n_7@@0) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Union| g1@@8 g0@@8) n_7@@0)) (dummyFunction (MapType0Select Heap@@27 n_7@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.1798:25|
 :skolemid |226|
 :pattern ( (MapType0Select Heap@@27 n_7@@0 next))
 :pattern ( (MapType1Select QPMask@3 n_7@@0 next))
 :pattern ( (MapType0Select Heap@@27 n_7@@0 next))
)) (and (=> (= (ControlFlow 0 36) (- 0 37)) (forall ((n_7@@1 T@U) (n_7_1 T@U) ) (!  (=> (and (= (type n_7@@1) RefType) (= (type n_7_1) RefType)) (=> (and (and (and (and (not (= n_7@@1 n_7_1)) (U_2_bool (MapType2Select (|Set#Union| g1@@8 g0@@8) n_7@@1))) (U_2_bool (MapType2Select (|Set#Union| g1@@8 g0@@8) n_7_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_7@@1 n_7_1))))
 :qid |stdinbpl.1805:25|
 :skolemid |227|
 :pattern ( (neverTriggered13 n_7@@1) (neverTriggered13 n_7_1))
))) (=> (forall ((n_7@@2 T@U) (n_7_1@@0 T@U) ) (!  (=> (and (= (type n_7@@2) RefType) (= (type n_7_1@@0) RefType)) (=> (and (and (and (and (not (= n_7@@2 n_7_1@@0)) (U_2_bool (MapType2Select (|Set#Union| g1@@8 g0@@8) n_7@@2))) (U_2_bool (MapType2Select (|Set#Union| g1@@8 g0@@8) n_7_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_7@@2 n_7_1@@0))))
 :qid |stdinbpl.1805:25|
 :skolemid |227|
 :pattern ( (neverTriggered13 n_7@@2) (neverTriggered13 n_7_1@@0))
)) (=> (= (ControlFlow 0 36) (- 0 35)) (forall ((n_7@@3 T@U) ) (!  (=> (and (= (type n_7@@3) RefType) (U_2_bool (MapType2Select (|Set#Union| g1@@8 g0@@8) n_7@@3))) (>= (U_2_real (MapType1Select QPMask@1 n_7@@3 next)) (/ (to_real 1) (to_real 2))))
...
(let ((anon45_Then_correct  (and (=> (= (ControlFlow 0 32) (- 0 34)) (forall ((n_6 T@U) ) (!  (=> (= (type n_6) RefType) (=> (and (U_2_bool (MapType2Select g1@@8 n_6)) (dummyFunction (MapType0Select Heap@@27 n_6 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.1742:25|
 :skolemid |219|
 :pattern ( (MapType0Select Heap@@27 n_6 next))
 :pattern ( (MapType1Select QPMask@2 n_6 next))
 :pattern ( (MapType0Select Heap@@27 n_6 next))
))) (=> (forall ((n_6@@0 T@U) ) (!  (=> (= (type n_6@@0) RefType) (=> (and (U_2_bool (MapType2Select g1@@8 n_6@@0)) (dummyFunction (MapType0Select Heap@@27 n_6@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.1742:25|
 :skolemid |219|
 :pattern ( (MapType0Select Heap@@27 n_6@@0 next))
 :pattern ( (MapType1Select QPMask@2 n_6@@0 next))
 :pattern ( (MapType0Select Heap@@27 n_6@@0 next))
)) (and (=> (= (ControlFlow 0 32) (- 0 33)) (forall ((n_6@@1 T@U) (n_6_1 T@U) ) (!  (=> (and (= (type n_6@@1) RefType) (= (type n_6_1) RefType)) (=> (and (and (and (and (not (= n_6@@1 n_6_1)) (U_2_bool (MapType2Select g1@@8 n_6@@1))) (U_2_bool (MapType2Select g1@@8 n_6_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_6@@1 n_6_1))))
 :qid |stdinbpl.1749:25|
 :skolemid |220|
 :pattern ( (neverTriggered12 n_6@@1) (neverTriggered12 n_6_1))
))) (=> (forall ((n_6@@2 T@U) (n_6_1@@0 T@U) ) (!  (=> (and (= (type n_6@@2) RefType) (= (type n_6_1@@0) RefType)) (=> (and (and (and (and (not (= n_6@@2 n_6_1@@0)) (U_2_bool (MapType2Select g1@@8 n_6@@2))) (U_2_bool (MapType2Select g1@@8 n_6_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_6@@2 n_6_1@@0))))
 :qid |stdinbpl.1749:25|
 :skolemid |220|
 :pattern ( (neverTriggered12 n_6@@2) (neverTriggered12 n_6_1@@0))
)) (=> (= (ControlFlow 0 32) (- 0 31)) (forall ((n_6@@3 T@U) ) (!  (=> (and (= (type n_6@@3) RefType) (U_2_bool (MapType2Select g1@@8 n_6@@3))) (>= (U_2_real (MapType1Select QPMask@1 n_6@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.1756:25|
 :skolemid |221|
 :pattern ( (MapType0Select Heap@@27 n_6@@3 next))
 :pattern ( (MapType1Select QPMask@2 n_6@@3 next))
 :pattern ( (MapType0Select Heap@@27 n_6@@3 next))
)))))))))
(let ((anon29_correct true))
(let ((anon44_Then_correct  (=> (and (U_2_bool (MapType2Select g1@@8 u_4)) (U_2_bool (MapType2Select g1@@8 v_4))) (and (and (=> (= (ControlFlow 0 39) 32) anon45_Then_correct) (=> (= (ControlFlow 0 39) 36) anon46_Then_correct)) (=> (= (ControlFlow 0 39) 29) anon29_correct)))))
(let ((anon44_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g1@@8 u_4)) (U_2_bool (MapType2Select g1@@8 v_4)))) (= (ControlFlow 0 30) 29)) anon29_correct)))
(let ((anon43_Else_correct true))
(let ((anon39_Else_correct  (=> (forall ((u_3 T@U) (v_3_1 T@U) ) (!  (=> (and (and (= (type u_3) RefType) (= (type v_3_1) RefType)) (and (U_2_bool (MapType2Select g0@@8 u_3)) (U_2_bool (MapType2Select g0@@8 v_3_1)))) (= (exists_path ($$ Heap@@27 g0@@8) u_3 v_3_1) (exists_path ($$ Heap@@27 (|Set#Union| g0@@8 g1@@8)) u_3 v_3_1)))
 :qid |stdinbpl.1724:20|
 :skolemid |218|
 :pattern ( (MapType2Select g0@@8 u_3) (MapType2Select g0@@8 v_3_1))
 :pattern ( (MapType2Select g0@@8 u_3) (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@27 g0@@8))) g0@@8) u_3 v_3_1))
 :pattern ( (MapType2Select g0@@8 u_3) (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@27 (|Set#Union| g0@@8 g1@@8)))) (|Set#Union| g0@@8 g1@@8)) u_3 v_3_1))
 :pattern ( (MapType2Select g0@@8 v_3_1) (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@27 g0@@8))) g0@@8) u_3 v_3_1))
 :pattern ( (MapType2Select g0@@8 v_3_1) (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@27 (|Set#Union| g0@@8 g1@@8)))) (|Set#Union| g0@@8 g1@@8)) u_3 v_3_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@27 g0@@8))) g0@@8) u_3 v_3_1))
 :pattern ( (exists_path (|$$#frame| (FrameFragment (int_2_U (|$$#condqp1| Heap@@27 (|Set#Union| g0@@8 g1@@8)))) (|Set#Union| g0@@8 g1@@8)) u_3 v_3_1))
)) (=> (and (state Heap@@27 QPMask@1) (state Heap@@27 QPMask@1)) (and (and (=> (= (ControlFlow 0 40) 28) anon43_Else_correct) (=> (= (ControlFlow 0 40) 39) anon44_Then_correct)) (=> (= (ControlFlow 0 40) 30) anon44_Else_correct))))))
(let ((anon42_Then_correct  (and (=> (= (ControlFlow 0 24) (- 0 26)) (forall ((n_5 T@U) ) (!  (=> (= (type n_5) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Union| g0@@8 g1@@8) n_5)) (dummyFunction (MapType0Select Heap@@27 n_5 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.1673:25|
 :skolemid |211|
 :pattern ( (MapType0Select Heap@@27 n_5 next))
 :pattern ( (MapType1Select QPMask@5 n_5 next))
 :pattern ( (MapType0Select Heap@@27 n_5 next))
))) (=> (forall ((n_5@@0 T@U) ) (!  (=> (= (type n_5@@0) RefType) (=> (and (U_2_bool (MapType2Select (|Set#Union| g0@@8 g1@@8) n_5@@0)) (dummyFunction (MapType0Select Heap@@27 n_5@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.1673:25|
 :skolemid |211|
 :pattern ( (MapType0Select Heap@@27 n_5@@0 next))
 :pattern ( (MapType1Select QPMask@5 n_5@@0 next))
 :pattern ( (MapType0Select Heap@@27 n_5@@0 next))
)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (forall ((n_5@@1 T@U) (n_5_1 T@U) ) (!  (=> (and (= (type n_5@@1) RefType) (= (type n_5_1) RefType)) (=> (and (and (and (and (not (= n_5@@1 n_5_1)) (U_2_bool (MapType2Select (|Set#Union| g0@@8 g1@@8) n_5@@1))) (U_2_bool (MapType2Select (|Set#Union| g0@@8 g1@@8) n_5_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_5@@1 n_5_1))))
 :qid |stdinbpl.1680:25|
 :skolemid |212|
 :pattern ( (neverTriggered11 n_5@@1) (neverTriggered11 n_5_1))
 ...
 :qid |stdinbpl.1680:25|
 :skolemid |212|
 :pattern ( (neverTriggered11 n_5@@2) (neverTriggered11 n_5_1@@0))
)) (=> (= (ControlFlow 0 24) (- 0 23)) (forall ((n_5@@3 T@U) ) (!  (=> (and (= (type n_5@@3) RefType) (U_2_bool (MapType2Select (|Set#Union| g0@@8 g1@@8) n_5@@3))) (>= (U_2_real (MapType1Select QPMask@1 n_5@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.1687:25|
 :skolemid |213|
 :pattern ( (MapType0Select Heap@@27 n_5@@3 next))
 :pattern ( (MapType1Select QPMask@5 n_5@@3 next))
 :pattern ( (MapType0Select Heap@@27 n_5@@3 next))
)))))))))
(let ((anon41_Then_correct  (and (=> (= (ControlFlow 0 20) (- 0 22)) (forall ((n_4 T@U) ) (!  (=> (= (type n_4) RefType) (=> (and (U_2_bool (MapType2Select g0@@8 n_4)) (dummyFunction (MapType0Select Heap@@27 n_4 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.1617:25|
 :skolemid |204|
 :pattern ( (MapType0Select Heap@@27 n_4 next))
 :pattern ( (MapType1Select QPMask@4 n_4 next))
 :pattern ( (MapType0Select Heap@@27 n_4 next))
))) (=> (forall ((n_4@@0 T@U) ) (!  (=> (= (type n_4@@0) RefType) (=> (and (U_2_bool (MapType2Select g0@@8 n_4@@0)) (dummyFunction (MapType0Select Heap@@27 n_4@@0 next))) (>= (/ (to_real 1) (to_real 2)) NoPerm)))
 :qid |stdinbpl.1617:25|
 :skolemid |204|
 :pattern ( (MapType0Select Heap@@27 n_4@@0 next))
 :pattern ( (MapType1Select QPMask@4 n_4@@0 next))
 :pattern ( (MapType0Select Heap@@27 n_4@@0 next))
)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall ((n_4@@1 T@U) (n_4_1 T@U) ) (!  (=> (and (= (type n_4@@1) RefType) (= (type n_4_1) RefType)) (=> (and (and (and (and (not (= n_4@@1 n_4_1)) (U_2_bool (MapType2Select g0@@8 n_4@@1))) (U_2_bool (MapType2Select g0@@8 n_4_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_4@@1 n_4_1))))
 :qid |stdinbpl.1624:25|
 :skolemid |205|
 :pattern ( (neverTriggered10 n_4@@1) (neverTriggered10 n_4_1))
))) (=> (forall ((n_4@@2 T@U) (n_4_1@@0 T@U) ) (!  (=> (and (= (type n_4@@2) RefType) (= (type n_4_1@@0) RefType)) (=> (and (and (and (and (not (= n_4@@2 n_4_1@@0)) (U_2_bool (MapType2Select g0@@8 n_4@@2))) (U_2_bool (MapType2Select g0@@8 n_4_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= n_4@@2 n_4_1@@0))))
 :qid |stdinbpl.1624:25|
 :skolemid |205|
 :pattern ( (neverTriggered10 n_4@@2) (neverTriggered10 n_4_1@@0))
)) (=> (= (ControlFlow 0 20) (- 0 19)) (forall ((n_4@@3 T@U) ) (!  (=> (and (= (type n_4@@3) RefType) (U_2_bool (MapType2Select g0@@8 n_4@@3))) (>= (U_2_real (MapType1Select QPMask@1 n_4@@3 next)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.1631:25|
 :skolemid |206|
...
(let ((anon40_Then_correct  (=> (and (U_2_bool (MapType2Select g0@@8 u_2)) (U_2_bool (MapType2Select g0@@8 v_3))) (and (and (=> (= (ControlFlow 0 27) 20) anon41_Then_correct) (=> (= (ControlFlow 0 27) 24) anon42_Then_correct)) (=> (= (ControlFlow 0 27) 17) anon22_correct)))))
(let ((anon40_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g0@@8 u_2)) (U_2_bool (MapType2Select g0@@8 v_3)))) (= (ControlFlow 0 18) 17)) anon22_correct)))
(let ((anon36_Else_correct  (=> (forall ((n$2_2 T@U) ) (!  (=> (= (type n$2_2) RefType) (=> (and (U_2_bool (MapType2Select g1@@8 n$2_2)) (not (= (MapType0Select Heap@@27 n$2_2 next) null))) (U_2_bool (MapType2Select g1@@8 (MapType0Select Heap@@27 n$2_2 next)))))
 :qid |stdinbpl.1593:20|
 :skolemid |203|
 :pattern ( (MapType2Select g1@@8 (MapType0Select Heap@@27 n$2_2 next)))
 :pattern ( (MapType2Select g1@@8 n$2_2) (MapType0Select Heap@@27 n$2_2 next))
)) (=> (and (state Heap@@27 QPMask@1) (|Set#Equal| (|Set#Intersection| g1@@8 g0@@8) (|Set#Empty| RefType))) (=> (and (and (state Heap@@27 QPMask@1) (|Set#Equal| (|Set#Union| g0@@8 g1@@8) (|Set#Union| g1@@8 g0@@8))) (and (state Heap@@27 QPMask@1) (state Heap@@27 QPMask@1))) (and (and (=> (= (ControlFlow 0 41) 40) anon39_Else_correct) (=> (= (ControlFlow 0 41) 27) anon40_Then_correct)) (=> (= (ControlFlow 0 41) 18) anon40_Else_correct)))))))
(let ((anon15_correct true))
(let ((anon38_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g1@@8 n$2_1)) (not (= (MapType0Select Heap@@27 n$2_1 next) null)))) (= (ControlFlow 0 13) 10)) anon15_correct)))
(let ((anon38_Then_correct  (=> (and (U_2_bool (MapType2Select g1@@8 n$2_1)) (not (= (MapType0Select Heap@@27 n$2_1 next) null))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (HasDirectPerm QPMask@1 n$2_1 next)) (=> (HasDirectPerm QPMask@1 n$2_1 next) (=> (= (ControlFlow 0 11) 10) anon15_correct))))))
(let ((anon37_Else_correct  (=> (not (U_2_bool (MapType2Select g1@@8 n$2_1))) (and (=> (= (ControlFlow 0 16) 11) anon38_Then_correct) (=> (= (ControlFlow 0 16) 13) anon38_Else_correct)))))
(let ((anon37_Then_correct  (=> (U_2_bool (MapType2Select g1@@8 n$2_1)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm QPMask@1 n$2_1 next)) (=> (HasDirectPerm QPMask@1 n$2_1 next) (and (=> (= (ControlFlow 0 14) 11) anon38_Then_correct) (=> (= (ControlFlow 0 14) 13) anon38_Else_correct)))))))
(let ((anon35_Else_correct  (and (=> (= (ControlFlow 0 42) (- 0 43)) (forall ((n$1_3 T@U) (n$1_3_1 T@U) ) (!  (=> (and (= (type n$1_3) RefType) (= (type n$1_3_1) RefType)) (=> (and (and (and (and (not (= n$1_3 n$1_3_1)) (U_2_bool (MapType2Select g1@@8 n$1_3))) (U_2_bool (MapType2Select g1@@8 n$1_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_3 n$1_3_1))))
...
))) (=> (forall ((n$1_3@@0 T@U) (n$1_3_1@@0 T@U) ) (!  (=> (and (= (type n$1_3@@0) RefType) (= (type n$1_3_1@@0) RefType)) (=> (and (and (and (and (not (= n$1_3@@0 n$1_3_1@@0)) (U_2_bool (MapType2Select g1@@8 n$1_3@@0))) (U_2_bool (MapType2Select g1@@8 n$1_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n$1_3@@0 n$1_3_1@@0))))
 :qid |stdinbpl.1548:15|
 :skolemid |197|
...
)) (=> (and (forall ((n$1_3@@1 T@U) ) (!  (=> (= (type n$1_3@@1) RefType) (=> (and (U_2_bool (MapType2Select g1@@8 n$1_3@@1)) (< NoPerm FullPerm)) (and (qpRange9 n$1_3@@1) (= (invRecv9 n$1_3@@1) n$1_3@@1))))
 :qid |stdinbpl.1554:22|
 :skolemid |198|
 :pattern ( (MapType0Select Heap@@27 n$1_3@@1 next))
 :pattern ( (MapType1Select QPMask@1 n$1_3@@1 next))
 :pattern ( (MapType0Select Heap@@27 n$1_3@@1 next))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select g1@@8 (invRecv9 o_3))) (< NoPerm FullPerm)) (qpRange9 o_3)) (= (invRecv9 o_3) o_3)))
 :qid |stdinbpl.1558:22|
 :skolemid |199|
 :pattern ( (invRecv9 o_3))
))) (=> (and (and (forall ((n$1_3@@2 T@U) ) (!  (=> (and (= (type n$1_3@@2) RefType) (U_2_bool (MapType2Select g1@@8 n$1_3@@2))) (not (= n$1_3@@2 null)))
 :qid |stdinbpl.1564:22|
 :skolemid |200|
 :pattern ( (MapType0Select Heap@@27 n$1_3@@2 next))
 :pattern ( (MapType1Select QPMask@1 n$1_3@@2 next))
 :pattern ( (MapType0Select Heap@@27 n$1_3@@2 next))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select g1@@8 (invRecv9 o_3@@0))) (< NoPerm FullPerm)) (qpRange9 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv9 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 next)) (+ (U_2_real (MapType1Select QPMask@0 o_3@@0 next)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select g1@@8 (invRecv9 o_3@@0))) (< NoPerm FullPerm)) (qpRange9 o_3@@0))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 next)) (U_2_real (MapType1Select QPMask@0 o_3@@0 next))))))
...
)) (state Heap@@27 QPMask@1))) (and (and (=> (= (ControlFlow 0 42) 41) anon36_Else_correct) (=> (= (ControlFlow 0 42) 14) anon37_Then_correct)) (=> (= (ControlFlow 0 42) 16) anon37_Else_correct))))))))
(let ((anon35_Then_correct true))
(let ((anon32_Else_correct  (=> (and (forall ((n$0_2_1 T@U) ) (!  (=> (= (type n$0_2_1) RefType) (=> (and (U_2_bool (MapType2Select g0@@8 n$0_2_1)) (not (= (MapType0Select Heap@@27 n$0_2_1 next) null))) (U_2_bool (MapType2Select g0@@8 (MapType0Select Heap@@27 n$0_2_1 next)))))
 :qid |stdinbpl.1536:20|
 :skolemid |196|
 :pattern ( (MapType2Select g0@@8 (MapType0Select Heap@@27 n$0_2_1 next)))
 :pattern ( (MapType2Select g0@@8 n$0_2_1) (MapType0Select Heap@@27 n$0_2_1 next))
)) (not (U_2_bool (MapType2Select g1@@8 null)))) (and (=> (= (ControlFlow 0 44) 9) anon35_Then_correct) (=> (= (ControlFlow 0 44) 42) anon35_Else_correct)))))
(let ((anon7_correct true))
(let ((anon34_Else_correct  (=> (and (not (and (U_2_bool (MapType2Select g0@@8 n$0_2)) (not (= (MapType0Select Heap@@27 n$0_2 next) null)))) (= (ControlFlow 0 5) 2)) anon7_correct)))
(let ((anon34_Then_correct  (=> (and (U_2_bool (MapType2Select g0@@8 n$0_2)) (not (= (MapType0Select Heap@@27 n$0_2 next) null))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 n$0_2 next)) (=> (HasDirectPerm QPMask@0 n$0_2 next) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))
(let ((anon33_Else_correct  (=> (not (U_2_bool (MapType2Select g0@@8 n$0_2))) (and (=> (= (ControlFlow 0 8) 3) anon34_Then_correct) (=> (= (ControlFlow 0 8) 5) anon34_Else_correct)))))
(let ((anon33_Then_correct  (=> (U_2_bool (MapType2Select g0@@8 n$0_2)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (HasDirectPerm QPMask@0 n$0_2 next)) (=> (HasDirectPerm QPMask@0 n$0_2 next) (and (=> (= (ControlFlow 0 6) 3) anon34_Then_correct) (=> (= (ControlFlow 0 6) 5) anon34_Else_correct)))))))
(let ((anon31_Else_correct  (and (=> (= (ControlFlow 0 45) (- 0 46)) (forall ((n_3 T@U) (n_3_1 T@U) ) (!  (=> (and (= (type n_3) RefType) (= (type n_3_1) RefType)) (=> (and (and (and (and (not (= n_3 n_3_1)) (U_2_bool (MapType2Select g0@@8 n_3))) (U_2_bool (MapType2Select g0@@8 n_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3 n_3_1))))
...
))) (=> (forall ((n_3@@0 T@U) (n_3_1@@0 T@U) ) (!  (=> (and (= (type n_3@@0) RefType) (= (type n_3_1@@0) RefType)) (=> (and (and (and (and (not (= n_3@@0 n_3_1@@0)) (U_2_bool (MapType2Select g0@@8 n_3@@0))) (U_2_bool (MapType2Select g0@@8 n_3_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= n_3@@0 n_3_1@@0))))
 :qid |stdinbpl.1491:15|
 :skolemid |190|
...
)) (=> (and (forall ((n_3@@1 T@U) ) (!  (=> (= (type n_3@@1) RefType) (=> (and (U_2_bool (MapType2Select g0@@8 n_3@@1)) (< NoPerm FullPerm)) (and (qpRange8 n_3@@1) (= (invRecv8 n_3@@1) n_3@@1))))
 :qid |stdinbpl.1497:22|
 :skolemid |191|
 :pattern ( (MapType0Select Heap@@27 n_3@@1 next))
 :pattern ( (MapType1Select QPMask@0 n_3@@1 next))
 :pattern ( (MapType0Select Heap@@27 n_3@@1 next))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (U_2_bool (MapType2Select g0@@8 (invRecv8 o_3@@2))) (< NoPerm FullPerm)) (qpRange8 o_3@@2)) (= (invRecv8 o_3@@2) o_3@@2)))
 :qid |stdinbpl.1501:22|
 :skolemid |192|
 :pattern ( (invRecv8 o_3@@2))
))) (=> (and (and (forall ((n_3@@2 T@U) ) (!  (=> (and (= (type n_3@@2) RefType) (U_2_bool (MapType2Select g0@@8 n_3@@2))) (not (= n_3@@2 null)))
 :qid |stdinbpl.1507:22|
 :skolemid |193|
 :pattern ( (MapType0Select Heap@@27 n_3@@2 next))
 :pattern ( (MapType1Select QPMask@0 n_3@@2 next))
 :pattern ( (MapType0Select Heap@@27 n_3@@2 next))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (U_2_bool (MapType2Select g0@@8 (invRecv8 o_3@@3))) (< NoPerm FullPerm)) (qpRange8 o_3@@3)) (and (=> (< NoPerm FullPerm) (= (invRecv8 o_3@@3) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 next)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 next)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select g0@@8 (invRecv8 o_3@@3))) (< NoPerm FullPerm)) (qpRange8 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 next)) (U_2_real (MapType1Select ZeroMask o_3@@3 next))))))
...
)) (state Heap@@27 QPMask@0))) (and (and (=> (= (ControlFlow 0 45) 44) anon32_Else_correct) (=> (= (ControlFlow 0 45) 6) anon33_Then_correct)) (=> (= (ControlFlow 0 45) 8) anon33_Else_correct))))))))
(let ((anon31_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@27 ZeroMask) (=> (and (= AssumeFunctionsAbove 0) (not (U_2_bool (MapType2Select g0@@8 null)))) (and (=> (= (ControlFlow 0 47) 1) anon31_Then_correct) (=> (= (ControlFlow 0 47) 45) anon31_Else_correct))))))
