...
(declare-fun read_fields (T@U) T@U)
(declare-fun PredicateType_read_fieldsType () T@T)
(declare-fun acc_graph (T@U) T@U)
...
(declare-fun PredicateType_acc_graphType () T@T)
(declare-fun |read_fields#trigger| (T@U T@U) Bool)
(declare-fun |read_fields#everUsed| (T@U) Bool)
(declare-fun |acc_graph#trigger| (T@U T@U) Bool)
(declare-fun |acc_graph#everUsed| (T@U) Bool)
...
(declare-fun |read_fields#sm| (T@U) T@U)
(declare-fun |acc_graph#sm| (T@U) T@U)
...
(declare-fun |acc_graph#condqp1| (T@U T@U) Int)
(declare-fun |sk_acc_graph#condqp1| (Int Int) T@U)
...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (type visited) (FieldType NormalFieldType boolType))))
...
(assert  (and (= (Ctor PredicateType_read_fieldsType) 13) (forall ((arg0@@30 T@U) ) (! (= (type (read_fields arg0@@30)) (FieldType PredicateType_read_fieldsType FrameTypeType))
 :qid |funType:read_fields|
 :pattern ( (read_fields arg0@@30))
))))
(assert (forall ((node T@U) ) (!  (=> (= (type node) RefType) (IsPredicateField (read_fields node)))
 :qid |stdinbpl.403:15|
 :skolemid |83|
 :pattern ( (read_fields node))
)))
(assert  (and (and (and (and (and (and (and (and (forall ((arg0@@31 T@T) (arg1@@12 T@T) ) (! (= (Ctor (MapType2Type arg0@@31 arg1@@12)) 14)
 :qid |ctor:MapType2Type|
)) (forall ((arg0@@32 T@T) (arg1@@13 T@T) ) (! (= (MapType2TypeInv0 (MapType2Type arg0@@32 arg1@@13)) arg0@@32)
 :qid |typeInv:MapType2TypeInv0|
 :pattern ( (MapType2Type arg0@@32 arg1@@13))
))) (forall ((arg0@@33 T@T) (arg1@@14 T@T) ) (! (= (MapType2TypeInv1 (MapType2Type arg0@@33 arg1@@14)) arg1@@14)
 :qid |typeInv:MapType2TypeInv1|
 :pattern ( (MapType2Type arg0@@33 arg1@@14))
))) (forall ((arg0@@34 T@U) (arg1@@15 T@U) ) (! (let ((aVar1@@2 (MapType2TypeInv1 (type arg0@@34))))
(= (type (MapType2Select arg0@@34 arg1@@15)) aVar1@@2))
 :qid |funType:MapType2Select|
 :pattern ( (MapType2Select arg0@@34 arg1@@15))
))) (forall ((arg0@@35 T@U) (arg1@@16 T@U) (arg2@@3 T@U) ) (! (let ((aVar1@@3 (type arg2@@3)))
(let ((aVar0@@1 (type arg1@@16)))
(= (type (MapType2Store arg0@@35 arg1@@16 arg2@@3)) (MapType2Type aVar0@@1 aVar1@@3))))
 :qid |funType:MapType2Store|
 :pattern ( (MapType2Store arg0@@35 arg1@@16 arg2@@3))
 ...
 :weight 0
)))) (= (Ctor PredicateType_acc_graphType) 15)) (forall ((arg0@@36 T@U) ) (! (= (type (acc_graph arg0@@36)) (FieldType PredicateType_acc_graphType FrameTypeType))
 :qid |funType:acc_graph|
 :pattern ( (acc_graph arg0@@36))
))))
(assert (forall ((all_nodes T@U) ) (!  (=> (= (type all_nodes) (MapType2Type RefType boolType)) (IsPredicateField (acc_graph all_nodes)))
 :qid |stdinbpl.456:15|
 :skolemid |89|
 :pattern ( (acc_graph all_nodes))
)))
(assert (forall ((Heap@@2 T@U) (node@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type node@@0) RefType)) (|read_fields#everUsed| (read_fields node@@0)))
 :qid |stdinbpl.422:15|
 :skolemid |87|
 :pattern ( (|read_fields#trigger| Heap@@2 (read_fields node@@0)))
)))
(assert (forall ((Heap@@3 T@U) (all_nodes@@0 T@U) ) (!  (=> (and (= (type Heap@@3) (MapType0Type RefType)) (= (type all_nodes@@0) (MapType2Type RefType boolType))) (|acc_graph#everUsed| (acc_graph all_nodes@@0)))
 :qid |stdinbpl.475:15|
 :skolemid |93|
 :pattern ( (|acc_graph#trigger| Heap@@3 (acc_graph all_nodes@@0)))
)))
...
(assert (forall ((arg0@@37 T@U) (arg1@@17 T@U) ) (! (let ((T@@4 (MapType2TypeInv0 (type arg0@@37))))
(= (type (|Set#Union| arg0@@37 arg1@@17)) (MapType2Type T@@4 boolType)))
 :qid |funType:Set#Union|
 :pattern ( (|Set#Union| arg0@@37 arg1@@17))
)))
...
(assert (forall ((arg0@@38 T@U) (arg1@@18 T@U) ) (! (let ((T@@6 (MapType2TypeInv0 (type arg0@@38))))
(= (type (|Set#Intersection| arg0@@38 arg1@@18)) (MapType2Type T@@6 boolType)))
 :qid |funType:Set#Intersection|
 :pattern ( (|Set#Intersection| arg0@@38 arg1@@18))
)))
...
(assert (forall ((node@@1 T@U) (node2 T@U) ) (!  (=> (and (and (= (type node@@1) RefType) (= (type node2) RefType)) (= (read_fields node@@1) (read_fields node2))) (= node@@1 node2))
 :qid |stdinbpl.413:15|
 :skolemid |85|
 :pattern ( (read_fields node@@1) (read_fields node2))
)))
(assert (forall ((arg0@@40 T@U) ) (! (= (type (|read_fields#sm| arg0@@40)) (FieldType PredicateType_read_fieldsType (MapType1Type RefType boolType)))
 :qid |funType:read_fields#sm|
 :pattern ( (|read_fields#sm| arg0@@40))
)))
(assert (forall ((node@@2 T@U) (node2@@0 T@U) ) (!  (=> (and (and (= (type node@@2) RefType) (= (type node2@@0) RefType)) (= (|read_fields#sm| node@@2) (|read_fields#sm| node2@@0))) (= node@@2 node2@@0))
 :qid |stdinbpl.417:15|
 :skolemid |86|
 :pattern ( (|read_fields#sm| node@@2) (|read_fields#sm| node2@@0))
)))
(assert (forall ((all_nodes@@1 T@U) (all_nodes2 T@U) ) (!  (=> (and (and (= (type all_nodes@@1) (MapType2Type RefType boolType)) (= (type all_nodes2) (MapType2Type RefType boolType))) (= (acc_graph all_nodes@@1) (acc_graph all_nodes2))) (= all_nodes@@1 all_nodes2))
 :qid |stdinbpl.466:15|
 :skolemid |91|
 :pattern ( (acc_graph all_nodes@@1) (acc_graph all_nodes2))
)))
(assert (forall ((arg0@@41 T@U) ) (! (= (type (|acc_graph#sm| arg0@@41)) (FieldType PredicateType_acc_graphType (MapType1Type RefType boolType)))
 :qid |funType:acc_graph#sm|
 :pattern ( (|acc_graph#sm| arg0@@41))
)))
(assert (forall ((all_nodes@@2 T@U) (all_nodes2@@0 T@U) ) (!  (=> (and (and (= (type all_nodes@@2) (MapType2Type RefType boolType)) (= (type all_nodes2@@0) (MapType2Type RefType boolType))) (= (|acc_graph#sm| all_nodes@@2) (|acc_graph#sm| all_nodes2@@0))) (= all_nodes@@2 all_nodes2@@0))
 :qid |stdinbpl.470:15|
 :skolemid |92|
 :pattern ( (|acc_graph#sm| all_nodes@@2) (|acc_graph#sm| all_nodes2@@0))
)))
...
(assert (forall ((arg0@@42 T@U) (arg1@@19 T@U) ) (! (let ((T@@13 (type arg1@@19)))
(= (type (|MultiSet#UnionOne| arg0@@42 arg1@@19)) (MultiSetType T@@13)))
 :qid |funType:MultiSet#UnionOne|
 :pattern ( (|MultiSet#UnionOne| arg0@@42 arg1@@19))
)))
...
(assert  (not (IsPredicateField visited)))
(assert  (not (IsWandField visited)))
...
(assert (forall ((arg0@@44 Int) (arg1@@20 Int) ) (! (= (type (|sk_acc_graph#condqp1| arg0@@44 arg1@@20)) RefType)
 :qid |funType:sk_acc_graph#condqp1|
 :pattern ( (|sk_acc_graph#condqp1| arg0@@44 arg1@@20))
)))
(assert (forall ((Heap2Heap T@U) (Heap1Heap T@U) (all_nodes@@3 T@U) ) (!  (=> (and (and (and (= (type Heap2Heap) (MapType0Type RefType)) (= (type Heap1Heap) (MapType0Type RefType))) (= (type all_nodes@@3) (MapType2Type RefType boolType))) (and (=  (and (U_2_bool (MapType2Select all_nodes@@3 (|sk_acc_graph#condqp1| (|acc_graph#condqp1| Heap2Heap all_nodes@@3) (|acc_graph#condqp1| Heap1Heap all_nodes@@3)))) (< NoPerm FullPerm))  (and (U_2_bool (MapType2Select all_nodes@@3 (|sk_acc_graph#condqp1| (|acc_graph#condqp1| Heap2Heap all_nodes@@3) (|acc_graph#condqp1| Heap1Heap all_nodes@@3)))) (< NoPerm FullPerm))) (=> (and (U_2_bool (MapType2Select all_nodes@@3 (|sk_acc_graph#condqp1| (|acc_graph#condqp1| Heap2Heap all_nodes@@3) (|acc_graph#condqp1| Heap1Heap all_nodes@@3)))) (< NoPerm FullPerm)) (= (MapType0Select Heap2Heap null (read_fields (|sk_acc_graph#condqp1| (|acc_graph#condqp1| Heap2Heap all_nodes@@3) (|acc_graph#condqp1| Heap1Heap all_nodes@@3)))) (MapType0Select Heap1Heap null (read_fields (|sk_acc_graph#condqp1| (|acc_graph#condqp1| Heap2Heap all_nodes@@3) (|acc_graph#condqp1| Heap1Heap all_nodes@@3)))))))) (= (|acc_graph#condqp1| Heap2Heap all_nodes@@3) (|acc_graph#condqp1| Heap1Heap all_nodes@@3)))
 :qid |stdinbpl.486:15|
 :skolemid |94|
 :pattern ( (|acc_graph#condqp1| Heap2Heap all_nodes@@3) (|acc_graph#condqp1| Heap1Heap all_nodes@@3) (succHeapTrans Heap2Heap Heap1Heap))
)))
...
(assert  (and (forall ((arg0@@45 Real) (arg1@@21 T@U) ) (! (= (type (ConditionalFrame arg0@@45 arg1@@21)) FrameTypeType)
 :qid |funType:ConditionalFrame|
 :pattern ( (ConditionalFrame arg0@@45 arg1@@21))
...
(assert (forall ((arg0@@46 T@U) (arg1@@22 T@U) ) (! (let ((T@@20 (MapType2TypeInv0 (type arg0@@46))))
(= (type (|Set#Difference| arg0@@46 arg1@@22)) (MapType2Type T@@20 boolType)))
 :qid |funType:Set#Difference|
 :pattern ( (|Set#Difference| arg0@@46 arg1@@22))
)))
...
(assert (forall ((arg0@@47 T@U) (arg1@@23 T@U) ) (! (let ((T@@24 (type arg1@@23)))
(= (type (|Set#UnionOne| arg0@@47 arg1@@23)) (MapType2Type T@@24 boolType)))
 :qid |funType:Set#UnionOne|
 :pattern ( (|Set#UnionOne| arg0@@47 arg1@@23))
)))
...
(assert (forall ((node@@3 T@U) ) (!  (=> (= (type node@@3) RefType) (= (getPredWandId (read_fields node@@3)) 0))
 :qid |stdinbpl.407:15|
 :skolemid |84|
 :pattern ( (read_fields node@@3))
)))
(assert (forall ((all_nodes@@4 T@U) ) (!  (=> (= (type all_nodes@@4) (MapType2Type RefType boolType)) (= (getPredWandId (acc_graph all_nodes@@4)) 1))
 :qid |stdinbpl.460:15|
 :skolemid |90|
...
(assert (forall ((node@@4 T@U) ) (!  (=> (= (type node@@4) RefType) (= (PredicateMaskField (read_fields node@@4)) (|read_fields#sm| node@@4)))
 :qid |stdinbpl.399:15|
 :skolemid |82|
 :pattern ( (PredicateMaskField (read_fields node@@4)))
)))
(assert (forall ((all_nodes@@5 T@U) ) (!  (=> (= (type all_nodes@@5) (MapType2Type RefType boolType)) (= (PredicateMaskField (acc_graph all_nodes@@5)) (|acc_graph#sm| all_nodes@@5)))
 :qid |stdinbpl.452:15|
 :skolemid |88|
 :pattern ( (PredicateMaskField (acc_graph all_nodes@@5)))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type graph) (MapType2Type RefType boolType)) (= (type node_2) RefType)) (= (type UnfoldingMask@0) (MapType1Type RefType realType))) (= (type Mask@5) (MapType1Type RefType realType))) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Heap@9) (MapType0Type RefType))) (forall ((arg0@@48 T@U) ) (! (= (type (FrameFragment arg0@@48)) FrameTypeType)
 :qid |funType:FrameFragment|
 :pattern ( (FrameFragment arg0@@48))
))) (= (type Heap@12) (MapType0Type RefType))) (= (type Mask@6) (MapType1Type RefType realType))) (= (type Heap@10) (MapType0Type RefType))) (= (type Heap@11) (MapType0Type RefType))) (= (type freshVersion@2) FrameTypeType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type Heap@8) (MapType0Type RefType))) (= (type n) RefType)) (forall ((arg0@@49 T@U) ) (! (= (type (invRecv2 arg0@@49)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@49))
))) (= (type Heap@6) (MapType0Type RefType))) (= (type Heap@5) (MapType0Type RefType))) (= (type Heap@7) (MapType0Type RefType))) (= (type freshVersion@1) FrameTypeType)) (= (type Mask@4) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Heap@4) (MapType0Type RefType))) (= (type diff) RefType)) (= (type Heap@2) (MapType0Type RefType))) (= (type Heap@1) (MapType0Type RefType))) (= (type Heap@3) (MapType0Type RefType))) (= (type freshVersion@0) FrameTypeType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@11) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
...
(let ((anon27_Else_correct  (=> (HasDirectPerm Mask@6 null (acc_graph graph)) (=> (and (= Heap@12 Heap@9) (= (ControlFlow 0 12) 10)) anon18_correct))))
(let ((anon27_Then_correct  (=> (not (HasDirectPerm Mask@6 null (acc_graph graph))) (=> (and (and (= Heap@10 (MapType0Store Heap@9 null (|acc_graph#sm| graph) ZeroPMask)) (= Heap@11 (MapType0Store Heap@10 null (acc_graph graph) freshVersion@2))) (and (= Heap@12 Heap@11) (= (ControlFlow 0 11) 10))) anon18_correct))))
(let ((anon24_Else_correct  (=> (= Mask@6 (MapType1Store QPMask@0 null (acc_graph graph) (real_2_U (+ (U_2_real (MapType1Select QPMask@0 null (acc_graph graph))) FullPerm)))) (=> (and (and (state Heap@9 Mask@6) (state Heap@9 Mask@6)) (and (|acc_graph#trigger| Heap@9 (acc_graph graph)) (= (MapType0Select Heap@9 null (acc_graph graph)) (FrameFragment (int_2_U (|acc_graph#condqp1| Heap@9 graph)))))) (and (=> (= (ControlFlow 0 13) 11) anon27_Then_correct) (=> (= (ControlFlow 0 13) 12) anon27_Else_correct))))))
(let ((anon15_correct true))
(let ((anon14_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@5 null (read_fields node_2) (real_2_U (- (U_2_real (MapType1Select Mask@5 null (read_fields node_2))) FullPerm)))) (not (= node_2 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 node_2 visited (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 node_2 visited)) FullPerm)))) (state Heap@9 UnfoldingMask@1)) (and (state Heap@9 UnfoldingMask@1) (= (ControlFlow 0 4) 2))) anon15_correct))))
(let ((anon26_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 4)) anon14_correct)))
(let ((anon26_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select Mask@5 null (read_fields node_2))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@5 null (read_fields node_2)))) (=> (= (ControlFlow 0 5) 4) anon14_correct))))))
(let ((anon25_Then_correct  (=> (U_2_bool (MapType2Select graph node_2)) (=> (and (|read_fields#trigger| Heap@9 (read_fields node_2)) (= (MapType0Select Heap@9 null (read_fields node_2)) (FrameFragment (MapType0Select Heap@9 node_2 visited)))) (and (=> (= (ControlFlow 0 8) 5) anon26_Then_correct) (=> (= (ControlFlow 0 8) 7) anon26_Else_correct))))))
(let ((anon25_Else_correct  (=> (and (not (U_2_bool (MapType2Select graph node_2))) (= (ControlFlow 0 3) 2)) anon15_correct)))
(let ((anon10_correct  (=> (= Heap@9 (MapType0Store Heap@8 null (|read_fields#sm| n) (MapType1Store (MapType0Select Heap@8 null (|read_fields#sm| n)) n visited (bool_2_U true)))) (=> (and (state Heap@9 Mask@5) (state Heap@9 Mask@5)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (forall ((node@@5 T@U) (node_3 T@U) ) (!  (=> (and (= (type node@@5) RefType) (= (type node_3) RefType)) (=> (and (and (and (and (not (= node@@5 node_3)) (U_2_bool (MapType2Select graph node@@5))) (U_2_bool (MapType2Select graph node_3))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= node@@5 node_3))))
 :qid |stdinbpl.709:17|
 :skolemid |101|
 :pattern ( (neverTriggered2 node@@5) (neverTriggered2 node_3))
))) (=> (forall ((node@@6 T@U) (node_3@@0 T@U) ) (!  (=> (and (= (type node@@6) RefType) (= (type node_3@@0) RefType)) (=> (and (and (and (and (not (= node@@6 node_3@@0)) (U_2_bool (MapType2Select graph node@@6))) (U_2_bool (MapType2Select graph node_3@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= node@@6 node_3@@0))))
 :qid |stdinbpl.709:17|
 :skolemid |101|
 :pattern ( (neverTriggered2 node@@6) (neverTriggered2 node_3@@0))
)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((node@@7 T@U) ) (!  (=> (and (= (type node@@7) RefType) (U_2_bool (MapType2Select graph node@@7))) (>= (U_2_real (MapType1Select Mask@5 null (read_fields node@@7))) FullPerm))
 :qid |stdinbpl.716:17|
 :skolemid |102|
 :pattern ( (MapType0Select Heap@9 null (read_fields node@@7)))
 :pattern ( (MapType1Select Mask@5 null (read_fields node@@7)))
 :pattern ( (MapType2Select graph node@@7))
))) (=> (forall ((node@@8 T@U) ) (!  (=> (and (= (type node@@8) RefType) (U_2_bool (MapType2Select graph node@@8))) (>= (U_2_real (MapType1Select Mask@5 null (read_fields node@@8))) FullPerm))
 :qid |stdinbpl.716:17|
 :skolemid |102|
 :pattern ( (MapType0Select Heap@9 null (read_fields node@@8)))
 :pattern ( (MapType1Select Mask@5 null (read_fields node@@8)))
 :pattern ( (MapType2Select graph node@@8))
)) (=> (forall ((node@@9 T@U) ) (!  (=> (= (type node@@9) RefType) (=> (and (U_2_bool (MapType2Select graph node@@9)) (< NoPerm FullPerm)) (and (= (invRecv2 node@@9) node@@9) (qpRange2 node@@9))))
 :qid |stdinbpl.722:22|
 :skolemid |103|
 :pattern ( (MapType0Select Heap@9 null (read_fields node@@9)))
 :pattern ( (MapType1Select Mask@5 null (read_fields node@@9)))
 :pattern ( (MapType2Select graph node@@9))
)) (=> (and (and (forall ((node_1_1 T@U) ) (!  (=> (= (type node_1_1) RefType) (=> (and (and (U_2_bool (MapType2Select graph (invRecv2 node_1_1))) (< NoPerm FullPerm)) (qpRange2 node_1_1)) (= (invRecv2 node_1_1) node_1_1)))
 :qid |stdinbpl.726:22|
 :skolemid |104|
 :pattern ( (invRecv2 node_1_1))
)) (forall ((node_1_1@@0 T@U) ) (!  (=> (= (type node_1_1@@0) RefType) (=> (and (and (U_2_bool (MapType2Select graph (invRecv2 node_1_1@@0))) (< NoPerm FullPerm)) (qpRange2 node_1_1@@0)) (and (= (invRecv2 node_1_1@@0) node_1_1@@0) (= (U_2_real (MapType1Select QPMask@0 null (read_fields node_1_1@@0))) (- (U_2_real (MapType1Select Mask@5 null (read_fields node_1_1@@0))) FullPerm)))))
 :qid |stdinbpl.732:22|
 :skolemid |105|
 :pattern ( (MapType1Select QPMask@0 null (read_fields node_1_1@@0)))
))) (and (forall ((node_1_1@@1 T@U) ) (!  (=> (and (= (type node_1_1@@1) RefType) (not (and (and (U_2_bool (MapType2Select graph (invRecv2 node_1_1@@1))) (< NoPerm FullPerm)) (qpRange2 node_1_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (read_fields node_1_1@@1))) (U_2_real (MapType1Select Mask@5 null (read_fields node_1_1@@1)))))
 :qid |stdinbpl.736:22|
 :skolemid |106|
 :pattern ( (MapType1Select QPMask@0 null (read_fields node_1_1@@1)))
)) (forall ((o_3 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (or (or (not (= o_3 null)) (not (IsPredicateField f_5))) (not (= (getPredWandId f_5) 0)))) (= (U_2_real (MapType1Select Mask@5 o_3 f_5)) (U_2_real (MapType1Select QPMask@0 o_3 f_5))))))
 :qid |stdinbpl.742:29|
 :skolemid |107|
...
(let ((anon23_Else_correct  (=> (HasDirectPerm Mask@5 null (read_fields n)) (=> (and (= Heap@8 Heap@5) (= (ControlFlow 0 18) 14)) anon10_correct))))
(let ((anon23_Then_correct  (=> (not (HasDirectPerm Mask@5 null (read_fields n))) (=> (and (and (= Heap@6 (MapType0Store Heap@5 null (|read_fields#sm| n) ZeroPMask)) (= Heap@7 (MapType0Store Heap@6 null (read_fields n) freshVersion@1))) (and (= Heap@8 Heap@7) (= (ControlFlow 0 17) 14))) anon10_correct))))
(let ((anon8_correct  (=> (and (= Mask@4 (MapType1Store Mask@3 n visited (real_2_U (- (U_2_real (MapType1Select Mask@3 n visited)) FullPerm)))) (= Mask@5 (MapType1Store Mask@4 null (read_fields n) (real_2_U (+ (U_2_real (MapType1Select Mask@4 null (read_fields n))) FullPerm))))) (=> (and (and (state Heap@5 Mask@5) (state Heap@5 Mask@5)) (and (|read_fields#trigger| Heap@5 (read_fields n)) (= (MapType0Select Heap@5 null (read_fields n)) (FrameFragment (MapType0Select Heap@5 n visited))))) (and (=> (= (ControlFlow 0 19) 17) anon23_Then_correct) (=> (= (ControlFlow 0 19) 18) anon23_Else_correct))))))
(let ((anon22_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 22) 19)) anon8_correct)))
(let ((anon22_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (<= FullPerm (U_2_real (MapType1Select Mask@3 n visited)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 n visited))) (=> (= (ControlFlow 0 20) 19) anon8_correct))))))
(let ((anon6_correct  (=> (= Heap@5 (MapType0Store Heap@4 null (|read_fields#sm| diff) (MapType1Store (MapType0Select Heap@4 null (|read_fields#sm| diff)) diff visited (bool_2_U true)))) (=> (and (state Heap@5 Mask@3) (state Heap@5 Mask@3)) (and (=> (= (ControlFlow 0 23) 20) anon22_Then_correct) (=> (= (ControlFlow 0 23) 22) anon22_Else_correct))))))
(let ((anon21_Else_correct  (=> (HasDirectPerm Mask@3 null (read_fields diff)) (=> (and (= Heap@4 Heap@1) (= (ControlFlow 0 25) 23)) anon6_correct))))
(let ((anon21_Then_correct  (=> (not (HasDirectPerm Mask@3 null (read_fields diff))) (=> (and (and (= Heap@2 (MapType0Store Heap@1 null (|read_fields#sm| diff) ZeroPMask)) (= Heap@3 (MapType0Store Heap@2 null (read_fields diff) freshVersion@0))) (and (= Heap@4 Heap@3) (= (ControlFlow 0 24) 23))) anon6_correct))))
(let ((anon4_correct  (=> (and (= Mask@2 (MapType1Store Mask@1 diff visited (real_2_U (- (U_2_real (MapType1Select Mask@1 diff visited)) FullPerm)))) (= Mask@3 (MapType1Store Mask@2 null (read_fields diff) (real_2_U (+ (U_2_real (MapType1Select Mask@2 null (read_fields diff))) FullPerm))))) (=> (and (and (state Heap@1 Mask@3) (state Heap@1 Mask@3)) (and (|read_fields#trigger| Heap@1 (read_fields diff)) (= (MapType0Select Heap@1 null (read_fields diff)) (FrameFragment (MapType0Select Heap@1 diff visited))))) (and (=> (= (ControlFlow 0 26) 24) anon21_Then_correct) (=> (= (ControlFlow 0 26) 25) anon21_Else_correct))))))
(let ((anon20_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 29) 26)) anon4_correct)))
(let ((anon20_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (<= FullPerm (U_2_real (MapType1Select Mask@1 diff visited)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@1 diff visited))) (=> (= (ControlFlow 0 27) 26) anon4_correct))))))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 30) (- 0 32)) (= FullPerm (U_2_real (MapType1Select Mask@1 diff visited)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 diff visited))) (=> (and (= Heap@0 (MapType0Store Heap@@11 diff visited (bool_2_U true))) (state Heap@0 Mask@1)) (and (=> (= (ControlFlow 0 30) (- 0 31)) (= FullPerm (U_2_real (MapType1Select Mask@1 n visited)))) (=> (= FullPerm (U_2_real (MapType1Select Mask@1 n visited))) (=> (and (= Heap@1 (MapType0Store Heap@0 n visited (bool_2_U false))) (state Heap@1 Mask@1)) (and (=> (= (ControlFlow 0 30) 27) anon20_Then_correct) (=> (= (ControlFlow 0 30) 29) anon20_Else_correct))))))))))
(let ((anon19_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@11 n $allocated)) (U_2_bool (MapType0Select Heap@@11 diff $allocated))) (and (|Set#Equal| graph (|Set#UnionOne| (|Set#Singleton| diff) n)) (state Heap@@11 ZeroMask))) (=> (and (and (and (not (= n null)) (= Mask@0 (MapType1Store ZeroMask n visited (real_2_U (+ (U_2_real (MapType1Select ZeroMask n visited)) FullPerm))))) (and (state Heap@@11 Mask@0) (state Heap@@11 Mask@0))) (and (and (not (= diff null)) (= Mask@1 (MapType1Store Mask@0 diff visited (real_2_U (+ (U_2_real (MapType1Select Mask@0 diff visited)) FullPerm))))) (and (state Heap@@11 Mask@1) (state Heap@@11 Mask@1)))) (and (=> (= (ControlFlow 0 33) 1) anon19_Then_correct) (=> (= (ControlFlow 0 33) 30) anon19_Else_correct)))))))
