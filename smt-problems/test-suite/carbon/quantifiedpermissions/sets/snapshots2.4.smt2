...
(assert  (and (and (and (and (and (and (and (and (and (and (= (type xs@@4) (MapType1Type RefType boolType)) (= (type Heap@@13) (MapType0Type RefType))) (= (type QPMask@1) (MapType2Type RefType realType))) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv7 arg0@@45)) RefType)
 :qid |funType:invRecv7|
 :pattern ( (invRecv7 arg0@@45))
))) (= (type x@@24) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type QPMask@2) (MapType2Type RefType realType))) (forall ((arg0@@46 T@U) ) (! (= (type (invRecv8 arg0@@46)) RefType)
 :qid |funType:invRecv8|
 :pattern ( (invRecv8 arg0@@46))
))) (= (type y@@6) RefType)) (forall ((arg0@@47 T@U) ) (! (= (type (invRecv6 arg0@@47)) RefType)
 :qid |funType:invRecv6|
 :pattern ( (invRecv6 arg0@@47))
))))
(set-info :boogie-vc-id test02)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon9_Else_correct  (=> (= (ControlFlow 0 13) (- 0 12)) (= v_2@0 (fun Heap@0 xs@@4 x@@24 n@@4)))))
...
)) (=> (and (and (forall ((z_3@@3 T@U) ) (!  (=> (= (type z_3@@3) RefType) (=> (and (U_2_bool (MapType1Select xs@@4 z_3@@3)) (< NoPerm FullPerm)) (and (qpRange8 z_3@@3) (= (invRecv8 z_3@@3) z_3@@3))))
...
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType1Select xs@@4 (invRecv8 o_3))) (and (< NoPerm FullPerm) (qpRange8 o_3))) (= (invRecv8 o_3) o_3)))
 :qid |stdinbpl.1018:26|
 :skolemid |132|
 :pattern ( (invRecv8 o_3))
))) (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType1Select xs@@4 (invRecv8 o_3@@0))) (and (< NoPerm FullPerm) (qpRange8 o_3@@0))) (and (= (invRecv8 o_3@@0) o_3@@0) (= (U_2_real (MapType2Select QPMask@2 o_3@@0 f_7)) (- (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType1Select xs@@4 (invRecv8 o_3@@0))) (and (< NoPerm FullPerm) (qpRange8 o_3@@0)))) (= (U_2_real (MapType2Select QPMask@2 o_3@@0 f_7)) (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7))))))
 :qid |stdinbpl.1024:26|
 :skolemid |133|
...
)) (=> (and (and (forall ((z_2@@3 T@U) ) (!  (=> (= (type z_2@@3) RefType) (=> (and (U_2_bool (MapType1Select xs@@4 z_2@@3)) (< NoPerm FullPerm)) (and (qpRange7 z_2@@3) (= (invRecv7 z_2@@3) z_2@@3))))
 :qid |stdinbpl.944:26|
 :skolemid |125|
 :pattern ( (MapType0Select Heap@@13 z_2@@3 f_7))
 :pattern ( (MapType2Select QPMask@1 z_2@@3 f_7))
 :pattern ( (MapType1Select xs@@4 z_2@@3))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType1Select xs@@4 (invRecv7 o_3@@2))) (and (< NoPerm FullPerm) (qpRange7 o_3@@2))) (= (invRecv7 o_3@@2) o_3@@2)))
 :qid |stdinbpl.948:26|
 :skolemid |126|
 :pattern ( (invRecv7 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType1Select xs@@4 (invRecv7 o_3@@3))) (and (< NoPerm FullPerm) (qpRange7 o_3@@3))) (and (= (invRecv7 o_3@@3) o_3@@3) (= (U_2_real (MapType2Select QPMask@1 o_3@@3 f_7)) (- (U_2_real (MapType2Select QPMask@0 o_3@@3 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType1Select xs@@4 (invRecv7 o_3@@3))) (and (< NoPerm FullPerm) (qpRange7 o_3@@3)))) (= (U_2_real (MapType2Select QPMask@1 o_3@@3 f_7)) (U_2_real (MapType2Select QPMask@0 o_3@@3 f_7))))))
 :qid |stdinbpl.954:26|
 :skolemid |127|
...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((z_1 T@U) (z_1_1 T@U) ) (!  (=> (and (= (type z_1) RefType) (= (type z_1_1) RefType)) (=> (and (and (and (and (not (= z_1 z_1_1)) (U_2_bool (MapType1Select xs@@4 z_1))) (U_2_bool (MapType1Select xs@@4 z_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= z_1 z_1_1))))
 :qid |stdinbpl.872:15|
 :skolemid |117|
 :no-pattern (type z_1)
...
)) (=> (and (and (forall ((z_1@@1 T@U) ) (!  (=> (= (type z_1@@1) RefType) (=> (and (U_2_bool (MapType1Select xs@@4 z_1@@1)) (< NoPerm FullPerm)) (and (qpRange6 z_1@@1) (= (invRecv6 z_1@@1) z_1@@1))))
 :qid |stdinbpl.878:22|
 :skolemid |118|
 :pattern ( (MapType0Select Heap@@13 z_1@@1 f_7))
 :pattern ( (MapType2Select QPMask@0 z_1@@1 f_7))
 :pattern ( (MapType1Select xs@@4 z_1@@1))
)) (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (U_2_bool (MapType1Select xs@@4 (invRecv6 o_3@@5))) (< NoPerm FullPerm)) (qpRange6 o_3@@5)) (= (invRecv6 o_3@@5) o_3@@5)))
 :qid |stdinbpl.882:22|
 :skolemid |119|
 :pattern ( (invRecv6 o_3@@5))
))) (and (forall ((z_1@@2 T@U) ) (!  (=> (and (= (type z_1@@2) RefType) (U_2_bool (MapType1Select xs@@4 z_1@@2))) (not (= z_1@@2 null)))
 :qid |stdinbpl.888:22|
 :skolemid |120|
 :pattern ( (MapType0Select Heap@@13 z_1@@2 f_7))
 :pattern ( (MapType2Select QPMask@0 z_1@@2 f_7))
 :pattern ( (MapType1Select xs@@4 z_1@@2))
)) (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (U_2_bool (MapType1Select xs@@4 (invRecv6 o_3@@6))) (< NoPerm FullPerm)) (qpRange6 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv6 o_3@@6) o_3@@6)) (= (U_2_real (MapType2Select QPMask@0 o_3@@6 f_7)) (+ (U_2_real (MapType2Select ZeroMask o_3@@6 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType1Select xs@@4 (invRecv6 o_3@@6))) (< NoPerm FullPerm)) (qpRange6 o_3@@6))) (= (U_2_real (MapType2Select QPMask@0 o_3@@6 f_7)) (U_2_real (MapType2Select ZeroMask o_3@@6 f_7))))))
 :qid |stdinbpl.894:22|
 :skolemid |121|
...
)) (state Heap@@13 QPMask@0)) (and (state Heap@@13 QPMask@0) (U_2_bool (MapType1Select xs@@4 x@@24)))) (and (and (U_2_bool (MapType1Select xs@@4 y@@6)) (state Heap@@13 QPMask@0)) (and (>= n@@4 0) (state Heap@@13 QPMask@0)))) (and (=> (= (ControlFlow 0 16) 3) anon8_Then_correct) (=> (= (ControlFlow 0 16) 14) anon8_Else_correct))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@13 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@13 x@@24 $allocated)) (U_2_bool (MapType0Select Heap@@13 y@@6 $allocated)))) (and (=> (= (ControlFlow 0 18) 1) anon7_Then_correct) (=> (= (ControlFlow 0 18) 16) anon7_Else_correct)))))
