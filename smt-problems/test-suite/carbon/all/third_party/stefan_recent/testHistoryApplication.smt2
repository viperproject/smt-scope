...
(let ((anon39_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= FullPerm (U_2_real (MapType1Select Mask@22 null (History__hist_idle h q_1 (p_seq p_1@@2 p_incr)))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@22 null (History__hist_idle h q_1 (p_seq p_1@@2 p_incr))))) (=> (= (ControlFlow 0 4) 3) anon26_correct))))))
(let ((anon24_correct  (=> (= Mask@22 (MapType1Store Mask@21 h History__x_hist_mode (real_2_U (- (U_2_real (MapType1Select Mask@21 h History__x_hist_mode)) FullPerm)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (= (U_2_int (MapType0Select ExhaleHeap@2 h History__x_hist_mode)) 1)) (=> (= (U_2_int (MapType0Select ExhaleHeap@2 h History__x_hist_mode)) 1) (and (=> (= (ControlFlow 0 7) 4) anon39_Then_correct) (=> (= (ControlFlow 0 7) 6) anon39_Else_correct)))))))
(let ((anon38_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 11) 7)) anon24_correct)))
(let ((anon38_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= FullPerm (U_2_real (MapType1Select Mask@21 h History__x_hist_mode)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@21 h History__x_hist_mode))) (=> (= (ControlFlow 0 9) 7) anon24_correct))))))
(let ((anon22_correct  (=> (= Mask@21 (MapType1Store Mask@20 h History__x_hist_value (real_2_U (- (U_2_real (MapType1Select Mask@20 h History__x_hist_value)) FullPerm)))) (and (=> (= (ControlFlow 0 12) 9) anon38_Then_correct) (=> (= (ControlFlow 0 12) 11) anon38_Else_correct)))))
(let ((anon37_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 15) 12)) anon22_correct)))
(let ((anon37_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= FullPerm (U_2_real (MapType1Select Mask@20 h History__x_hist_value)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@20 h History__x_hist_value))) (=> (= (ControlFlow 0 13) 12) anon22_correct))))))
(let ((anon20_correct  (=> (= Mask@17 (MapType1Store Mask@16 h History__x_hist_mode (real_2_U (- (U_2_real (MapType1Select Mask@16 h History__x_hist_mode)) FullPerm)))) (and (=> (= (ControlFlow 0 16) (- 0 18)) (= (U_2_int (MapType0Select ExhaleHeap@1 h History__x_hist_mode)) 2)) (=> (= (U_2_int (MapType0Select ExhaleHeap@1 h History__x_hist_mode)) 2) (and (=> (= (ControlFlow 0 16) (- 0 17)) (= (U_2_int (MapType0Select ExhaleHeap@1 h History__x_hist_value)) (+ (U_2_int (MapType0Select ExhaleHeap@1 h History__x_hist_act)) 1))) (=> (= (U_2_int (MapType0Select ExhaleHeap@1 h History__x_hist_value)) (+ (U_2_int (MapType0Select ExhaleHeap@1 h History__x_hist_act)) 1)) (=> (and (IdenticalOnKnownLocations ExhaleHeap@1 ExhaleHeap@2 Mask@17) (not (= q_1 NoPerm))) (=> (and (and (= Mask@18 (MapType1Store Mask@17 null (History__hist_idle h q_1 (p_seq p_1@@2 p_incr)) (real_2_U (+ (U_2_real (MapType1Select Mask@17 null (History__hist_idle h q_1 (p_seq p_1@@2 p_incr)))) FullPerm)))) (state ExhaleHeap@2 Mask@18)) (and (not (= h null)) (= Mask@19 (MapType1Store Mask@18 h History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select Mask@18 h History__x_hist_value)) FullPerm)))))) (=> (and (and (and (state ExhaleHeap@2 Mask@19) (not (= h null))) (and (= Mask@20 (MapType1Store Mask@19 h History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select Mask@19 h History__x_hist_mode)) FullPerm)))) (state ExhaleHeap@2 Mask@20))) (and (and (= (U_2_int (MapType0Select ExhaleHeap@2 h History__x_hist_mode)) 1) (= (U_2_int (MapType0Select ExhaleHeap@2 h History__x_hist_value)) (U_2_int (MapType0Select ExhaleHeap@1 h History__x_hist_value)))) (and (state ExhaleHeap@2 Mask@20) (state ExhaleHeap@2 Mask@20)))) (and (=> (= (ControlFlow 0 16) 13) anon37_Then_correct) (=> (= (ControlFlow 0 16) 15) anon37_Else_correct))))))))))))
(let ((anon36_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 21) 16)) anon20_correct)))
(let ((anon36_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (<= FullPerm (U_2_real (MapType1Select Mask@16 h History__x_hist_mode)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@16 h History__x_hist_mode))) (=> (= (ControlFlow 0 19) 16) anon20_correct))))))
(let ((anon18_correct  (=> (= Mask@16 (MapType1Store Mask@15 h History__x_hist_value (real_2_U (- (U_2_real (MapType1Select Mask@15 h History__x_hist_value)) FullPerm)))) (and (=> (= (ControlFlow 0 22) 19) anon36_Then_correct) (=> (= (ControlFlow 0 22) 21) anon36_Else_correct)))))
(let ((anon35_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 25) 22)) anon18_correct)))
(let ((anon35_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (<= FullPerm (U_2_real (MapType1Select Mask@15 h History__x_hist_value)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@15 h History__x_hist_value))) (=> (= (ControlFlow 0 23) 22) anon18_correct))))))
(let ((anon16_correct  (=> (= Mask@15 (MapType1Store Mask@14 h History__x_hist_act (real_2_U (- (U_2_real (MapType1Select Mask@14 h History__x_hist_act)) FullPerm)))) (and (=> (= (ControlFlow 0 26) 23) anon35_Then_correct) (=> (= (ControlFlow 0 26) 25) anon35_Else_correct)))))
(let ((anon34_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 29) 26)) anon16_correct)))
(let ((anon34_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (<= FullPerm (U_2_real (MapType1Select Mask@14 h History__x_hist_act)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@14 h History__x_hist_act))) (=> (= (ControlFlow 0 27) 26) anon16_correct))))))
(let ((anon14_correct  (=> (= Mask@14 (MapType1Store Mask@13 null (History__hist_do_incr h q_1 p_1@@2) (real_2_U (- (U_2_real (MapType1Select Mask@13 null (History__hist_do_incr h q_1 p_1@@2))) FullPerm)))) (and (=> (= (ControlFlow 0 30) 27) anon34_Then_correct) (=> (= (ControlFlow 0 30) 29) anon34_Else_correct)))))
(let ((anon33_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 33) 30)) anon14_correct)))
(let ((anon33_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 31) (- 0 32)) (<= FullPerm (U_2_real (MapType1Select Mask@13 null (History__hist_do_incr h q_1 p_1@@2))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@13 null (History__hist_do_incr h q_1 p_1@@2)))) (=> (= (ControlFlow 0 31) 30) anon14_correct))))))
(let ((anon12_correct  (=> (= Mask@11 (MapType1Store Mask@10 h History__x_hist_mode (real_2_U (- (U_2_real (MapType1Select Mask@10 h History__x_hist_mode)) perm@0)))) (and (=> (= (ControlFlow 0 34) (- 0 39)) (= (U_2_int (MapType0Select ExhaleHeap@0 h History__x_hist_mode)) 2)) (=> (= (U_2_int (MapType0Select ExhaleHeap@0 h History__x_hist_mode)) 2) (=> (and (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@1 Mask@11) (not (= h null))) (=> (and (and (= Mask@12 (MapType1Store Mask@11 h History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select Mask@11 h History__x_hist_value)) FullPerm)))) (state ExhaleHeap@1 Mask@12)) (and (= (U_2_int (MapType0Select ExhaleHeap@1 h History__x_hist_value)) arg_value@0) (= perm@1 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 34) (- 0 38)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (=> (> perm@1 NoPerm) (not (= h null))) (= Mask@13 (MapType1Store Mask@12 h History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select Mask@12 h History__x_hist_mode)) perm@1))))) (=> (and (and (state ExhaleHeap@1 Mask@13) (= (U_2_int (MapType0Select ExhaleHeap@1 h History__x_hist_mode)) 2)) (and (state ExhaleHeap@1 Mask@13) (state ExhaleHeap@1 Mask@13))) (and (=> (= (ControlFlow 0 34) (- 0 37)) (not (= h null))) (=> (not (= h null)) (and (=> (= (ControlFlow 0 34) (- 0 36)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (and (=> (= (ControlFlow 0 34) (- 0 35)) (not (= q_1 NoPerm))) (=> (not (= q_1 NoPerm)) (and (=> (= (ControlFlow 0 34) 31) anon33_Then_correct) (=> (= (ControlFlow 0 34) 33) anon33_Else_correct)))))))))))))))))))
(let ((anon32_Else_correct  (=> (and (= perm@0 NoPerm) (= (ControlFlow 0 42) 34)) anon12_correct)))
(let ((anon32_Then_correct  (=> (not (= perm@0 NoPerm)) (and (=> (= (ControlFlow 0 40) (- 0 41)) (<= perm@0 (U_2_real (MapType1Select Mask@10 h History__x_hist_mode)))) (=> (<= perm@0 (U_2_real (MapType1Select Mask@10 h History__x_hist_mode))) (=> (= (ControlFlow 0 40) 34) anon12_correct))))))
(let ((anon10_correct  (=> (and (= Mask@10 (MapType1Store Mask@9 h History__x_hist_value (real_2_U (- (U_2_real (MapType1Select Mask@9 h History__x_hist_value)) FullPerm)))) (= perm@0 (/ (to_real 1) (to_real 2)))) (and (=> (= (ControlFlow 0 43) (- 0 44)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (and (=> (= (ControlFlow 0 43) 40) anon32_Then_correct) (=> (= (ControlFlow 0 43) 42) anon32_Else_correct)))))))
(let ((anon31_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 47) 43)) anon10_correct)))
(let ((anon31_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 45) (- 0 46)) (<= FullPerm (U_2_real (MapType1Select Mask@9 h History__x_hist_value)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@9 h History__x_hist_value))) (=> (= (ControlFlow 0 45) 43) anon10_correct))))))
(let ((anon8_correct  (=> (= Mask@5 (MapType1Store Mask@4 h History__x_hist_mode (real_2_U (- (U_2_real (MapType1Select Mask@4 h History__x_hist_mode)) FullPerm)))) (and (=> (= (ControlFlow 0 48) (- 0 52)) (= (U_2_int (MapType0Select Heap@@19 h History__x_hist_mode)) 1)) (=> (= (U_2_int (MapType0Select Heap@@19 h History__x_hist_mode)) 1) (=> (and (IdenticalOnKnownLocations Heap@@19 ExhaleHeap@0 Mask@5) (not (= q_1 NoPerm))) (=> (and (and (and (and (= Mask@6 (MapType1Store Mask@5 null (History__hist_do_incr h q_1 p_1@@2) (real_2_U (+ (U_2_real (MapType1Select Mask@5 null (History__hist_do_incr h q_1 p_1@@2))) FullPerm)))) (state ExhaleHeap@0 Mask@6)) (and (not (= h null)) (= Mask@7 (MapType1Store Mask@6 h History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select Mask@6 h History__x_hist_value)) FullPerm)))))) (and (and (state ExhaleHeap@0 Mask@7) (not (= h null))) (and (= Mask@8 (MapType1Store Mask@7 h History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select Mask@7 h History__x_hist_mode)) FullPerm)))) (state ExhaleHeap@0 Mask@8)))) (and (and (and (= (U_2_int (MapType0Select ExhaleHeap@0 h History__x_hist_mode)) 2) (= (U_2_int (MapType0Select ExhaleHeap@0 h History__x_hist_value)) (U_2_int (MapType0Select Heap@@19 h History__x_hist_value)))) (and (not (= h null)) (= Mask@9 (MapType1Store Mask@8 h History__x_hist_act (real_2_U (+ (U_2_real (MapType1Select Mask@8 h History__x_hist_act)) FullPerm)))))) (and (and (state ExhaleHeap@0 Mask@9) (= (U_2_int (MapType0Select ExhaleHeap@0 h History__x_hist_value)) (U_2_int (MapType0Select ExhaleHeap@0 h History__x_hist_act)))) (and (state ExhaleHeap@0 Mask@9) (state ExhaleHeap@0 Mask@9))))) (and (=> (= (ControlFlow 0 48) (- 0 51)) (HasDirectPerm Mask@9 h History__x_hist_value)) (=> (HasDirectPerm Mask@9 h History__x_hist_value) (=> (= arg_value@0 (+ (U_2_int (MapType0Select ExhaleHeap@0 h History__x_hist_value)) 1)) (and (=> (= (ControlFlow 0 48) (- 0 50)) (not (= h null))) (=> (not (= h null)) (and (=> (= (ControlFlow 0 48) (- 0 49)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (and (=> (= (ControlFlow 0 48) 45) anon31_Then_correct) (=> (= (ControlFlow 0 48) 47) anon31_Else_correct))))))))))))))))
(let ((anon30_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 55) 48)) anon8_correct)))
(let ((anon30_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 53) (- 0 54)) (<= FullPerm (U_2_real (MapType1Select Mask@4 h History__x_hist_mode)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 h History__x_hist_mode))) (=> (= (ControlFlow 0 53) 48) anon8_correct))))))
(let ((anon6_correct  (=> (= Mask@4 (MapType1Store Mask@3 h History__x_hist_value (real_2_U (- (U_2_real (MapType1Select Mask@3 h History__x_hist_value)) FullPerm)))) (and (=> (= (ControlFlow 0 56) 53) anon30_Then_correct) (=> (= (ControlFlow 0 56) 55) anon30_Else_correct)))))
(let ((anon29_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 59) 56)) anon6_correct)))
(let ((anon29_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 57) (- 0 58)) (<= FullPerm (U_2_real (MapType1Select Mask@3 h History__x_hist_value)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@3 h History__x_hist_value))) (=> (= (ControlFlow 0 57) 56) anon6_correct))))))
(let ((anon4_correct  (=> (= Mask@3 (MapType1Store Mask@2 null (History__hist_idle h q_1 p_1@@2) (real_2_U (- (U_2_real (MapType1Select Mask@2 null (History__hist_idle h q_1 p_1@@2))) FullPerm)))) (and (=> (= (ControlFlow 0 60) 57) anon29_Then_correct) (=> (= (ControlFlow 0 60) 59) anon29_Else_correct)))))
(let ((anon28_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 63) 60)) anon4_correct)))
(let ((anon28_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 61) (- 0 62)) (<= FullPerm (U_2_real (MapType1Select Mask@2 null (History__hist_idle h q_1 p_1@@2))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 null (History__hist_idle h q_1 p_1@@2)))) (=> (= (ControlFlow 0 61) 60) anon4_correct))))))
(let ((anon27_Else_correct  (and (=> (= (ControlFlow 0 64) (- 0 67)) (not (= h null))) (=> (not (= h null)) (and (=> (= (ControlFlow 0 64) (- 0 66)) (>= current_thread_id 0)) (=> (>= current_thread_id 0) (and (=> (= (ControlFlow 0 64) (- 0 65)) (not (= q_1 NoPerm))) (=> (not (= q_1 NoPerm)) (and (=> (= (ControlFlow 0 64) 61) anon28_Then_correct) (=> (= (ControlFlow 0 64) 63) anon28_Else_correct))))))))))
(let ((anon27_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (and (not (= h null)) (= PostMask@0 (MapType1Store ZeroMask h History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select ZeroMask h History__x_hist_value)) FullPerm))))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (and (not (= h null)) (= PostMask@1 (MapType1Store PostMask@0 h History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select PostMask@0 h History__x_hist_mode)) FullPerm))))) (and (state PostHeap@0 PostMask@1) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm PostMask@1 h History__x_hist_mode)))))
(let ((anon0_correct  (=> (and (and (state Heap@@19 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@19 diz@@19 $allocated)) (U_2_bool (MapType0Select Heap@@19 h $allocated)))) (=> (and (and (and (and (not (= diz@@19 null)) (state Heap@@19 ZeroMask)) (and (>= current_thread_id 0) (state Heap@@19 ZeroMask))) (and (and (not (= q_1 NoPerm)) (state Heap@@19 ZeroMask)) (and (= Mask@0 (MapType1Store ZeroMask null (History__hist_idle h q_1 p_1@@2) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (History__hist_idle h q_1 p_1@@2))) FullPerm)))) (state Heap@@19 Mask@0)))) (and (and (and (state Heap@@19 Mask@0) (not (= h null))) (and (= Mask@1 (MapType1Store Mask@0 h History__x_hist_value (real_2_U (+ (U_2_real (MapType1Select Mask@0 h History__x_hist_value)) FullPerm)))) (state Heap@@19 Mask@1))) (and (and (state Heap@@19 Mask@1) (not (= h null))) (and (= Mask@2 (MapType1Store Mask@1 h History__x_hist_mode (real_2_U (+ (U_2_real (MapType1Select Mask@1 h History__x_hist_mode)) FullPerm)))) (state Heap@@19 Mask@2))))) (and (=> (= (ControlFlow 0 68) (- 0 69)) (HasDirectPerm Mask@2 h History__x_hist_mode)) (=> (HasDirectPerm Mask@2 h History__x_hist_mode) (=> (and (= (U_2_int (MapType0Select Heap@@19 h History__x_hist_mode)) 1) (state Heap@@19 Mask@2)) (and (=> (= (ControlFlow 0 68) 2) anon27_Then_correct) (=> (= (ControlFlow 0 68) 64) anon27_Else_correct)))))))))
