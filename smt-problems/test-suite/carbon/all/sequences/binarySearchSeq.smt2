...
(declare-fun i@@6 () Int)
(declare-fun j@@5 () Int)
(assert  (and (and (= (type array) (SeqType intType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type PostHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id binary_search)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 73) (let ((anon11_correct true))
(let ((anon50_Else_correct  (=> (and (not (and (<= 0 i_2) (< i_2 (|Seq#Length| array)))) (= (ControlFlow 0 63) 59)) anon11_correct)))
(let ((anon50_Then_correct  (=> (and (<= 0 i_2) (< i_2 (|Seq#Length| array))) (and (=> (= (ControlFlow 0 60) (- 0 62)) (>= i_2 0)) (=> (>= i_2 0) (and (=> (= (ControlFlow 0 60) (- 0 61)) (< i_2 (|Seq#Length| array))) (=> (< i_2 (|Seq#Length| array)) (=> (= (ControlFlow 0 60) 59) anon11_correct))))))))
(let ((anon13_correct true))
(let ((anon49_Else_correct  (=> (and (forall ((i_3 Int) ) (!  (=> (and (<= 0 i_3) (< i_3 (|Seq#Length| array))) (not (= (U_2_int (|Seq#Index| array i_3)) key)))
 :qid |stdinbpl.624:22|
 :skolemid |59|
 :pattern ( (|Seq#Index| array i_3))
...
(let ((anon47_Then_correct  (=> (<= 0 index) (and (=> (= (ControlFlow 0 66) (- 0 68)) (>= index 0)) (=> (>= index 0) (and (=> (= (ControlFlow 0 66) (- 0 67)) (< index (|Seq#Length| array))) (=> (< index (|Seq#Length| array)) (=> (and (= (U_2_int (|Seq#Index| array index)) key) (= (ControlFlow 0 66) 65)) anon7_correct))))))))
(let ((anon46_Then_correct  (=> (and (and (state PostHeap@0 ZeroMask) (<= (- 0 1) index)) (and (< index (|Seq#Length| array)) (state PostHeap@0 ZeroMask))) (and (=> (= (ControlFlow 0 70) 66) anon47_Then_correct) (=> (= (ControlFlow 0 70) 69) anon47_Else_correct)))))
(let ((anon22_correct true))
(let ((anon55_Else_correct  (=> (and (not (and (<= 0 i_4) (and (< i_4 (|Seq#Length| array)) (not (and (<= low@0 i_4) (< i_4 high@1)))))) (= (ControlFlow 0 49) 45)) anon22_correct)))
(let ((anon55_Then_correct  (=> (and (<= 0 i_4) (and (< i_4 (|Seq#Length| array)) (not (and (<= low@0 i_4) (< i_4 high@1))))) (and (=> (= (ControlFlow 0 46) (- 0 48)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 46) (- 0 47)) (< i_4 (|Seq#Length| array))) (=> (< i_4 (|Seq#Length| array)) (=> (= (ControlFlow 0 46) 45) anon22_correct))))))))
(let ((anon54_Else_correct true))
(let ((anon53_Then_correct  (=> (and (and (<= 0 low@0) (<= low@0 high@1)) (and (<= high@1 (|Seq#Length| array)) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 50) 44) anon54_Else_correct) (=> (= (ControlFlow 0 50) 46) anon55_Then_correct)) (=> (= (ControlFlow 0 50) 49) anon55_Else_correct)))))
(let ((anon34_correct true))
(let ((anon60_Else_correct  (=> (and (not (and (<= 0 i_11) (and (< i_11 (|Seq#Length| array)) (not (and (<= low@2 i_11) (< i_11 high@3)))))) (= (ControlFlow 0 29) 26)) anon34_correct)))
(let ((anon60_Then_correct  (=> (and (<= 0 i_11) (and (< i_11 (|Seq#Length| array)) (not (and (<= low@2 i_11) (< i_11 high@3))))) (and (=> (= (ControlFlow 0 27) (- 0 28)) (not (= (U_2_int (|Seq#Index| array i_11)) key))) (=> (not (= (U_2_int (|Seq#Index| array i_11)) key)) (=> (= (ControlFlow 0 27) 26) anon34_correct))))))
(let ((anon59_Else_correct true))
(let ((anon31_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 30) (- 0 33)) (<= 0 low@2)) (=> (<= 0 low@2) (and (=> (= (ControlFlow 0 30) (- 0 32)) (<= low@2 high@3)) (=> (<= low@2 high@3) (and (=> (= (ControlFlow 0 30) (- 0 31)) (<= high@3 (|Seq#Length| array))) (=> (<= high@3 (|Seq#Length| array)) (and (and (=> (= (ControlFlow 0 30) 25) anon59_Else_correct) (=> (= (ControlFlow 0 30) 27) anon60_Then_correct)) (=> (= (ControlFlow 0 30) 29) anon60_Else_correct)))))))))))
(let ((anon30_correct  (=> (and (and (state Heap@@9 ZeroMask) (= low@2 low@0)) (and (= high@3 high@2) (= (ControlFlow 0 35) 30))) anon31_correct)))
(let ((anon58_Else_correct  (=> (and (and (<= (U_2_int (|Seq#Index| array mid@1)) key) (state Heap@@9 ZeroMask)) (and (= high@2 high@1) (= (ControlFlow 0 37) 35))) anon30_correct)))
(let ((anon58_Then_correct  (=> (and (and (< key (U_2_int (|Seq#Index| array mid@1))) (state Heap@@9 ZeroMask)) (and (= high@2 mid@1) (= (ControlFlow 0 36) 35))) anon30_correct)))
(let ((anon57_Else_correct  (=> (<= key (U_2_int (|Seq#Index| array mid@1))) (and (=> (= (ControlFlow 0 38) (- 0 40)) (>= mid@1 0)) (=> (>= mid@1 0) (and (=> (= (ControlFlow 0 38) (- 0 39)) (< mid@1 (|Seq#Length| array))) (=> (< mid@1 (|Seq#Length| array)) (and (=> (= (ControlFlow 0 38) 36) anon58_Then_correct) (=> (= (ControlFlow 0 38) 37) anon58_Else_correct)))))))))
(let ((anon57_Then_correct  (=> (and (< (U_2_int (|Seq#Index| array mid@1)) key) (= low@1 (+ mid@1 1))) (=> (and (and (state Heap@@9 ZeroMask) (= low@2 low@1)) (and (= high@3 high@1) (= (ControlFlow 0 34) 30))) anon31_correct))))
(let ((anon56_Then_correct  (=> (and (state Heap@@9 ZeroMask) (<= 0 low@0)) (=> (and (and (and (<= low@0 high@1) (<= high@1 (|Seq#Length| array))) (and (forall ((i_10 Int) ) (!  (=> (and (<= 0 i_10) (and (< i_10 (|Seq#Length| array)) (not (and (<= low@0 i_10) (< i_10 high@1))))) (not (= (U_2_int (|Seq#Index| array i_10)) key)))
 :qid |stdinbpl.710:24|
 :skolemid |62|
 :pattern ( (|Seq#Index| array i_10))
)) (state Heap@@9 ZeroMask))) (and (and (< low@0 high@1) (state Heap@@9 ZeroMask)) (and (= mid@1 (div (+ low@0 high@1) 2)) (state Heap@@9 ZeroMask)))) (and (=> (= (ControlFlow 0 41) (- 0 43)) (>= mid@1 0)) (=> (>= mid@1 0) (and (=> (= (ControlFlow 0 41) (- 0 42)) (< mid@1 (|Seq#Length| array))) (=> (< mid@1 (|Seq#Length| array)) (and (=> (= (ControlFlow 0 41) 34) anon57_Then_correct) (=> (= (ControlFlow 0 41) 38) anon57_Else_correct))))))))))
(let ((anon42_correct true))
(let ((anon64_Else_correct  (=> (and (not (and (<= 0 i_4_1) (< i_4_1 (|Seq#Length| array)))) (= (ControlFlow 0 17) 14)) anon42_correct)))
(let ((anon64_Then_correct  (=> (and (<= 0 i_4_1) (< i_4_1 (|Seq#Length| array))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (not (= (U_2_int (|Seq#Index| array i_4_1)) key))) (=> (not (= (U_2_int (|Seq#Index| array i_4_1)) key)) (=> (= (ControlFlow 0 15) 14) anon42_correct))))))
...
(let ((anon61_Then_correct  (=> (<= 0 index@2) (and (=> (= (ControlFlow 0 19) (- 0 20)) (= (U_2_int (|Seq#Index| array index@2)) key)) (=> (= (U_2_int (|Seq#Index| array index@2)) key) (and (=> (= (ControlFlow 0 19) 18) anon62_Then_correct) (=> (= (ControlFlow 0 19) 12) anon62_Else_correct)))))))
(let ((anon56_Else_correct  (=> (and (not (< low@0 high@1)) (state Heap@@9 ZeroMask)) (=> (and (and (and (<= 0 low@0) (<= low@0 high@1)) (and (<= high@1 (|Seq#Length| array)) (forall ((i_13 Int) ) (!  (=> (and (<= 0 i_13) (and (< i_13 (|Seq#Length| array)) (not (and (<= low@0 i_13) (< i_13 high@1))))) (not (= (U_2_int (|Seq#Index| array i_13)) key)))
 :qid |stdinbpl.790:22|
 :skolemid |64|
 :pattern ( (|Seq#Index| array i_13))
)))) (and (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (= index@2 (- 0 1)) (state Heap@@9 ZeroMask)))) (and (=> (= (ControlFlow 0 22) (- 0 24)) (<= (- 0 1) index@2)) (=> (<= (- 0 1) index@2) (and (=> (= (ControlFlow 0 22) (- 0 23)) (< index@2 (|Seq#Length| array))) (=> (< index@2 (|Seq#Length| array)) (and (=> (= (ControlFlow 0 22) 19) anon61_Then_correct) (=> (= (ControlFlow 0 22) 21) anon61_Else_correct))))))))))
(let ((anon51_Else_correct  (=> (forall ((i_7_1 Int) ) (!  (=> (and (<= 0 i_7_1) (and (< i_7_1 (|Seq#Length| array)) (not (and (<= 0 i_7_1) (< i_7_1 high@0))))) (not (= (U_2_int (|Seq#Index| array i_7_1)) key)))
 :qid |stdinbpl.666:24|
 :skolemid |60|
 :pattern ( (|Seq#Index| array i_7_1))
...
(let ((anon52_Else_correct  (=> (and (not (and (<= 0 i_6) (and (< i_6 (|Seq#Length| array)) (not (and (<= 0 i_6) (< i_6 high@0)))))) (= (ControlFlow 0 11) 8)) anon17_correct)))
(let ((anon52_Then_correct  (=> (and (<= 0 i_6) (and (< i_6 (|Seq#Length| array)) (not (and (<= 0 i_6) (< i_6 high@0))))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (not (= (U_2_int (|Seq#Index| array i_6)) key))) (=> (not (= (U_2_int (|Seq#Index| array i_6)) key)) (=> (= (ControlFlow 0 9) 8) anon17_correct))))))
(let ((anon46_Else_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (= high@0 (|Seq#Length| array)) (state Heap@@9 ZeroMask)) (and (= index@0 (- 0 1)) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 52) (- 0 55)) (<= 0 0)) (=> (<= 0 0) (and (=> (= (ControlFlow 0 52) (- 0 54)) (<= 0 high@0)) (=> (<= 0 high@0) (and (=> (= (ControlFlow 0 52) (- 0 53)) (<= high@0 (|Seq#Length| array))) (=> (<= high@0 (|Seq#Length| array)) (and (and (=> (= (ControlFlow 0 52) 51) anon51_Else_correct) (=> (= (ControlFlow 0 52) 9) anon52_Then_correct)) (=> (= (ControlFlow 0 52) 11) anon52_Else_correct))))))))))))
(let ((anon44_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (<= 0 i_1) (and (< j_1 (|Seq#Length| array)) (< i_1 j_1))) (< (U_2_int (|Seq#Index| array i_1)) (U_2_int (|Seq#Index| array j_1))))
 :qid |stdinbpl.583:20|
 :skolemid |58|
 :pattern ( (|Seq#Index| array i_1) (|Seq#Index| array j_1))
)) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 71) 70) anon46_Then_correct) (=> (= (ControlFlow 0 71) 52) anon46_Else_correct)))))
(let ((anon3_correct true))
(let ((anon45_Else_correct  (=> (and (not (and (<= 0 i@@6) (and (< j@@5 (|Seq#Length| array)) (< i@@6 j@@5)))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon45_Then_correct  (=> (and (<= 0 i@@6) (and (< j@@5 (|Seq#Length| array)) (< i@@6 j@@5))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i@@6 0)) (=> (>= i@@6 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i@@6 (|Seq#Length| array))) (=> (< i@@6 (|Seq#Length| array)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j@@5 (|Seq#Length| array))) (=> (< j@@5 (|Seq#Length| array)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (and (=> (= (ControlFlow 0 72) 71) anon44_Else_correct) (=> (= (ControlFlow 0 72) 2) anon45_Then_correct)) (=> (= (ControlFlow 0 72) 7) anon45_Else_correct)))))
