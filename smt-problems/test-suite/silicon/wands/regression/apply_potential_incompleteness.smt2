(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:34:49
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/wands/regression/apply_potential_incompleteness.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(set-option :timeout 0)
(push) ; 4
(assert (not (= ($SortWrappers.$SnapToInt (MWSF_apply mwsf@3@01 ($Snap.first $t@4@01))) 2)))
(check-sat)
; unsat
(pop) ; 4
; 0,00s
; (get-info :all-statistics)
(assert (= ($SortWrappers.$SnapToInt (MWSF_apply mwsf@3@01 ($Snap.first $t@4@01))) 2))
; [exec]
; assert false
(check-sat)
; unknown
