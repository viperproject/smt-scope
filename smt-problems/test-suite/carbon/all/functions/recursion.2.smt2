...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon5_correct  (=> (and (= Result@0 (ite (< n@@9 2) n@@9 (* n@@9 (fac Heap@@19 (- n@@9 1))))) (= (ControlFlow 0 4) (- 0 3))) (>= Result@0 0))))
(let ((anon7_Else_correct  (=> (and (|fac#trigger| EmptyFrame (- n@@9 1)) (= (ControlFlow 0 6) 4)) anon5_correct)))
(let ((anon6_Then_correct  (=> (and (< n@@9 2) (= (ControlFlow 0 5) 4)) anon5_correct)))
(let ((anon7_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (>= (- n@@9 1) 0))))
(let ((anon6_Else_correct  (=> (<= 2 n@@9) (and (=> (= (ControlFlow 0 7) 2) anon7_Then_correct) (=> (= (ControlFlow 0 7) 6) anon7_Else_correct)))))
(let ((anon0_correct  (=> (and (and (state Heap@@19 ZeroMask) (= AssumeFunctionsAbove 1)) (and (>= n@@9 0) (state Heap@@19 ZeroMask))) (and (=> (= (ControlFlow 0 8) 5) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))
