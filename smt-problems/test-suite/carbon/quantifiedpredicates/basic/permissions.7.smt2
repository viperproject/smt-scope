...
(assert  (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type y@@2) RefType)) (= (type xs) (SeqType RefType))))
(set-info :boogie-vc-id test01_qp_client)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 y@@2 $allocated))) (and (|Seq#Contains| xs y@@2) (state Heap@@11 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Seq#Contains| xs y@@2)) (=> (|Seq#Contains| xs y@@2) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((x@@11 T@U) (x_2 T@U) ) (!  (=> (and (= (type x@@11) RefType) (= (type x_2) RefType)) (=> (and (and (and (and (not (= x@@11 x_2)) (|Seq#Contains| xs x@@11)) (|Seq#Contains| xs x_2)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@11 x_2))))
 :qid |stdinbpl.953:19|
 :skolemid |76|
 :pattern ( (neverTriggered2 x@@11) (neverTriggered2 x_2))
))) (=> (forall ((x@@12 T@U) (x_2@@0 T@U) ) (!  (=> (and (= (type x@@12) RefType) (= (type x_2@@0) RefType)) (=> (and (and (and (and (not (= x@@12 x_2@@0)) (|Seq#Contains| xs x@@12)) (|Seq#Contains| xs x_2@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x@@12 x_2@@0))))
 :qid |stdinbpl.953:19|
 :skolemid |76|
 :pattern ( (neverTriggered2 x@@12) (neverTriggered2 x_2@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((x@@13 T@U) ) (!  (=> (and (= (type x@@13) RefType) (|Seq#Contains| xs x@@13)) (>= (U_2_real (MapType1Select ZeroMask null (pred1 x@@13))) FullPerm))
 :qid |stdinbpl.960:19|
 :skolemid |77|
 :pattern ( (MapType0Select Heap@@11 null (pred1 x@@13)))
 :pattern ( (MapType1Select ZeroMask null (pred1 x@@13)))
 :pattern ( (|Seq#ContainsTrigger| xs x@@13))
 :pattern ( (|Seq#Contains| xs x@@13))
))))))))))
