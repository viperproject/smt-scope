...
(let ((anon25_Else_correct  (=> (= (MapType0Select Heap@1 xs@@42 next) null) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 15) 13)) anon17_correct))))
(let ((anon25_Then_correct  (=> (not (= (MapType0Select Heap@1 xs@@42 next) null)) (=> (and (and (forall ((o_10 T@U) (f_14 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_14))))
(let ((A@@12 (FieldTypeInv0 (type f_14))))
 (=> (and (and (= (type o_10) RefType) (= (type f_14) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|list#sm| xs@@42)) o_10 f_14)) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|list#sm| (MapType0Select Heap@1 xs@@42 next))) o_10 f_14)))) (U_2_bool (MapType1Select newPMask@0 o_10 f_14)))))
 :qid |stdinbpl.1661:33|
 :skolemid |98|
 :pattern ( (MapType1Select newPMask@0 o_10 f_14))
)) (= Heap@2 (MapType0Store Heap@1 null (|list#sm| xs@@42) newPMask@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 14) 13))) anon17_correct))))
(let ((anon15_correct  (=> (and (= Heap@0 (MapType0Store Heap@@47 null (|list#sm| xs@@42) (MapType1Store (MapType0Select Heap@@47 null (|list#sm| xs@@42)) xs@@42 next (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|list#sm| xs@@42) (MapType1Store (MapType0Select Heap@0 null (|list#sm| xs@@42)) xs@@42 val (bool_2_U true))))) (and (=> (= (ControlFlow 0 16) 14) anon25_Then_correct) (=> (= (ControlFlow 0 16) 15) anon25_Else_correct)))))
(let ((anon23_Else_correct  (=> (and (|get#trigger| (MapType0Select Heap@@47 null (list (MapType0Select Heap@@47 xs@@42 next))) (MapType0Select Heap@@47 xs@@42 next) (- index@@3 1)) (= (ControlFlow 0 19) 16)) anon15_correct)))
(let ((anon22_Then_correct  (=> (= index@@3 0) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm UnfoldingMask@4 xs@@42 val)) (=> (HasDirectPerm UnfoldingMask@4 xs@@42 val) (=> (= (ControlFlow 0 17) 16) anon15_correct))))))
(let ((anon13_correct  (=> (= UnfoldingMask@5 (MapType1Store UnfoldingMask@4 null (list (MapType0Select Heap@@47 xs@@42 next)) (real_2_U (- (U_2_real (MapType1Select UnfoldingMask@4 null (list (MapType0Select Heap@@47 xs@@42 next)))) FullPerm)))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (not (= (MapType0Select Heap@@47 xs@@42 next) null))) (=> (not (= (MapType0Select Heap@@47 xs@@42 next) null)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= 0 (- index@@3 1))) (=> (<= 0 (- index@@3 1)) (=> (= (ControlFlow 0 7) (- 0 6)) (< (- index@@3 1) (length Heap@@47 (MapType0Select Heap@@47 xs@@42 next)))))))))))
(let ((anon24_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 7)) anon13_correct)))
(let ((anon24_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (list (MapType0Select Heap@@47 xs@@42 next)))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (list (MapType0Select Heap@@47 xs@@42 next))))) (=> (= (ControlFlow 0 10) 7) anon13_correct))))))
(let ((anon22_Else_correct  (=> (not (= index@@3 0)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (HasDirectPerm UnfoldingMask@4 xs@@42 next)) (=> (HasDirectPerm UnfoldingMask@4 xs@@42 next) (and (and (=> (= (ControlFlow 0 20) 19) anon23_Else_correct) (=> (= (ControlFlow 0 20) 10) anon24_Then_correct)) (=> (= (ControlFlow 0 20) 12) anon24_Else_correct)))))))
(let ((anon8_correct  (=> (state Heap@@47 UnfoldingMask@4) (and (=> (= (ControlFlow 0 22) 17) anon22_Then_correct) (=> (= (ControlFlow 0 22) 20) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (= (MapType0Select Heap@@47 xs@@42 next) null) (=> (and (= UnfoldingMask@4 UnfoldingMask@2) (= (ControlFlow 0 24) 22)) anon8_correct))))
(let ((anon21_Then_correct  (=> (not (= (MapType0Select Heap@@47 xs@@42 next) null)) (=> (and (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 null (list (MapType0Select Heap@@47 xs@@42 next)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@2 null (list (MapType0Select Heap@@47 xs@@42 next)))) FullPerm)))) (InsidePredicate (list xs@@42) (MapType0Select Heap@@47 null (list xs@@42)) (list (MapType0Select Heap@@47 xs@@42 next)) (MapType0Select Heap@@47 null (list (MapType0Select Heap@@47 xs@@42 next))))) (=> (and (and (state Heap@@47 UnfoldingMask@3) (not (= (MapType0Select Heap@@47 xs@@42 next) null))) (and (= UnfoldingMask@4 UnfoldingMask@3) (= (ControlFlow 0 23) 22))) anon8_correct)))))
(let ((anon6_correct  (=> (= UnfoldingMask@0 (MapType1Store Mask@0 null (list xs@@42) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (list xs@@42))) FullPerm)))) (=> (and (not (= xs@@42 null)) (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 xs@@42 next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 xs@@42 next)) FullPerm))))) (=> (and (and (state Heap@@47 UnfoldingMask@1) (not (= xs@@42 null))) (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 xs@@42 val (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 xs@@42 val)) FullPerm)))) (state Heap@@47 UnfoldingMask@2))) (and (=> (= (ControlFlow 0 25) 23) anon21_Then_correct) (=> (= (ControlFlow 0 25) 24) anon21_Else_correct)))))))
(let ((anon20_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 28) 25)) anon6_correct)))
(let ((anon20_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@42))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@42)))) (=> (= (ControlFlow 0 26) 25) anon6_correct))))))
(let ((anon18_Else_correct  (=> (and (and (< index@@3 (length Heap@@47 xs@@42)) (state Heap@@47 Mask@0)) (and (|list#trigger| Heap@@47 (list xs@@42)) (= (MapType0Select Heap@@47 null (list xs@@42)) (CombineFrames (FrameFragment (MapType0Select Heap@@47 xs@@42 next)) (CombineFrames (FrameFragment (MapType0Select Heap@@47 xs@@42 val)) (FrameFragment (ite (not (= (MapType0Select Heap@@47 xs@@42 next) null)) (MapType0Select Heap@@47 null (list (MapType0Select Heap@@47 xs@@42 next))) EmptyFrame))))))) (and (=> (= (ControlFlow 0 29) 26) anon20_Then_correct) (=> (= (ControlFlow 0 29) 28) anon20_Else_correct)))))
(let ((anon3_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 null (list xs@@42) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (list xs@@42))) FullPerm)))) (= (ControlFlow 0 2) (- 0 1))) (not (= xs@@42 null)))))
(let ((anon19_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon3_correct)))
(let ((anon19_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@42))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (list xs@@42)))) (=> (= (ControlFlow 0 3) 2) anon3_correct))))))
(let ((anon0_correct  (=> (state Heap@@47 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@47 xs@@42 $allocated)) (= AssumeFunctionsAbove 5)) (and (= Mask@0 (MapType1Store ZeroMask null (list xs@@42) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (list xs@@42))) FullPerm)))) (state Heap@@47 Mask@0))) (and (and (not (= xs@@42 null)) (state Heap@@47 Mask@0)) (and (<= 0 index@@3) (state Heap@@47 Mask@0)))) (and (and (=> (= (ControlFlow 0 30) 29) anon18_Else_correct) (=> (= (ControlFlow 0 30) 3) anon19_Then_correct)) (=> (= (ControlFlow 0 30) 5) anon19_Else_correct))))))
