...
(declare-fun m@@23 () T@U)
(declare-fun k () Int)
(declare-fun Heap@@9 () T@U)
(assert  (and (= (type m@@23) (MapType intType boolType)) (= (type Heap@@9) (MapType1Type RefType))))
(set-info :boogie-vc-id test4)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (and (not (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U k)))) (= (ControlFlow 0 5) 1)) anon2_correct)))
(let ((anon3_Then_correct  (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U k))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U k)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U k))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (MapType0Select (|Map#Elements| m@@23) (int_2_U k)))) (=> (U_2_bool (MapType0Select (|Map#Elements| m@@23) (int_2_U k))) (=> (= (ControlFlow 0 2) 1) anon2_correct))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (|Map#Equal| (|Map#Build| m@@23 (int_2_U 4) (bool_2_U true)) (|Map#Build| (|Map#Build| (|Map#Empty| intType boolType) (int_2_U 4) (bool_2_U false)) (int_2_U 5) (bool_2_U true)))) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))
