...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (= m@0 (|Map#Build| (|Map#Empty| intType intType) (int_2_U 3) (int_2_U 9)))) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (|Map#Equal| (|Map#Build| m@0 (int_2_U 3) (int_2_U 5)) (|Map#Build| (|Map#Empty| intType intType) (int_2_U 3) (int_2_U 9))))))
