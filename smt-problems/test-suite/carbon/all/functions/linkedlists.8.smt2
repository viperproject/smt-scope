...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon13_correct  (=> (state Heap@3 Mask@0) (=> (and (= Result@0 (+ 1 (ite (= (MapType0Select Heap@3 xs@@42 next) null) 0 (length Heap@3 (MapType0Select Heap@3 xs@@42 next))))) (= (ControlFlow 0 7) (- 0 6))) (> Result@0 0)))))
(let ((anon19_Else_correct  (=> (= (MapType0Select Heap@1 xs@@42 next) null) (=> (and (= Heap@3 Heap@1) (= (ControlFlow 0 9) 7)) anon13_correct))))
(let ((anon19_Then_correct  (=> (not (= (MapType0Select Heap@1 xs@@42 next) null)) (=> (and (and (forall ((o_3 T@U) (f_7 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_7))))
(let ((A@@12 (FieldTypeInv0 (type f_7))))
 (=> (and (and (= (type o_3) RefType) (= (type f_7) (FieldType A@@12 B@@11))) (or (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|list#sm| xs@@42)) o_3 f_7)) (U_2_bool (MapType1Select (MapType0Select Heap@1 null (|list#sm| (MapType0Select Heap@1 xs@@42 next))) o_3 f_7)))) (U_2_bool (MapType1Select newPMask@0 o_3 f_7)))))
 :qid |stdinbpl.693:33|
 :skolemid |63|
 :pattern ( (MapType1Select newPMask@0 o_3 f_7))
)) (= Heap@2 (MapType0Store Heap@1 null (|list#sm| xs@@42) newPMask@0))) (and (= Heap@3 Heap@2) (= (ControlFlow 0 8) 7))) anon13_correct))))
(let ((anon11_correct  (=> (and (= Heap@0 (MapType0Store Heap@@47 null (|list#sm| xs@@42) (MapType1Store (MapType0Select Heap@@47 null (|list#sm| xs@@42)) xs@@42 next (bool_2_U true)))) (= Heap@1 (MapType0Store Heap@0 null (|list#sm| xs@@42) (MapType1Store (MapType0Select Heap@0 null (|list#sm| xs@@42)) xs@@42 val (bool_2_U true))))) (and (=> (= (ControlFlow 0 10) 8) anon19_Then_correct) (=> (= (ControlFlow 0 10) 9) anon19_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (|length#trigger| (MapType0Select Heap@@47 null (list (MapType0Select Heap@@47 xs@@42 next))) (MapType0Select Heap@@47 xs@@42 next)) (= (ControlFlow 0 12) 10)) anon11_correct)))
(let ((anon16_Then_correct  (=> (and (= (MapType0Select Heap@@47 xs@@42 next) null) (= (ControlFlow 0 11) 10)) anon11_correct)))
(let ((anon9_correct  (=> (and (= UnfoldingMask@5 (MapType1Store UnfoldingMask@4 null (list (MapType0Select Heap@@47 xs@@42 next)) (real_2_U (- (U_2_real (MapType1Select UnfoldingMask@4 null (list (MapType0Select Heap@@47 xs@@42 next)))) FullPerm)))) (= (ControlFlow 0 2) (- 0 1))) (not (= (MapType0Select Heap@@47 xs@@42 next) null)))))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon9_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (list (MapType0Select Heap@@47 xs@@42 next)))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@4 null (list (MapType0Select Heap@@47 xs@@42 next))))) (=> (= (ControlFlow 0 3) 2) anon9_correct))))))
(let ((anon16_Else_correct  (=> (not (= (MapType0Select Heap@@47 xs@@42 next) null)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (HasDirectPerm UnfoldingMask@4 xs@@42 next)) (=> (HasDirectPerm UnfoldingMask@4 xs@@42 next) (and (and (=> (= (ControlFlow 0 13) 12) anon17_Else_correct) (=> (= (ControlFlow 0 13) 3) anon18_Then_correct)) (=> (= (ControlFlow 0 13) 5) anon18_Else_correct)))))))
(let ((anon4_correct  (=> (state Heap@@47 UnfoldingMask@4) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm UnfoldingMask@4 xs@@42 next)) (=> (HasDirectPerm UnfoldingMask@4 xs@@42 next) (and (=> (= (ControlFlow 0 15) 11) anon16_Then_correct) (=> (= (ControlFlow 0 15) 13) anon16_Else_correct)))))))
(let ((anon15_Else_correct  (=> (= (MapType0Select Heap@@47 xs@@42 next) null) (=> (and (= UnfoldingMask@4 UnfoldingMask@2) (= (ControlFlow 0 18) 15)) anon4_correct))))
