...
(let ((anon7_correct  (=> (and (state Heap@@29 ZeroMask) (= (ControlFlow 0 5) 3)) anon8_correct)))
(let ((anon12_Else_correct  (=> (and (>= 0 $result) (= (ControlFlow 0 9) 5)) anon7_correct)))
(let ((anon12_Then_correct  (=> (> $result 0) (and (=> (= (ControlFlow 0 6) (- 0 8)) (decreasing (int_2_U (- $result 1)) (int_2_U x@@28))) (=> (decreasing (int_2_U (- $result 1)) (int_2_U x@@28)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (bounded (int_2_U x@@28))) (=> (bounded (int_2_U x@@28)) (=> (and (state Heap@@29 ZeroMask) (= (ControlFlow 0 6) 5)) anon7_correct))))))))
(let ((anon11_Then_correct  (=> (= $result x@@28) (and (=> (= (ControlFlow 0 10) 6) anon12_Then_correct) (=> (= (ControlFlow 0 10) 9) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (not (= $result x@@28)) (= (ControlFlow 0 4) 3)) anon8_correct)))
(let ((anon10_Else_correct  (=> (and (= (f1 Heap@@29 x@@28) 0) (state Heap@@29 ZeroMask)) (and (=> (= (ControlFlow 0 11) 10) anon11_Then_correct) (=> (= (ControlFlow 0 11) 4) anon11_Else_correct)))))
(let ((anon10_Then_correct true))
(let ((anon9_Else_correct  (=> (= (f_6 Heap@@29 x@@28) 0) (=> (and (state Heap@@29 ZeroMask) (state Heap@@29 ZeroMask)) (and (=> (= (ControlFlow 0 12) 2) anon10_Then_correct) (=> (= (ControlFlow 0 12) 11) anon10_Else_correct))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@29 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (state Heap@@29 ZeroMask)) (and (=> (= (ControlFlow 0 13) 1) anon9_Then_correct) (=> (= (ControlFlow 0 13) 12) anon9_Else_correct))))))
