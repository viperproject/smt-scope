...
(declare-fun b_2@2 () Int)
(declare-fun b_2@1 () Int)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon14_correct  (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 3) (- 0 2))) (or (= b_2@3 2) (or (= b_2@3 3) (or (= b_2@3 4) (= b_2@3 5)))))))
(let ((anon13_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= b_2@3 b_2@2) (= (ControlFlow 0 5) 3)) anon14_correct))))
(let ((anon12_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= b_2@2 b_2@1) (= (ControlFlow 0 7) 5)) anon13_correct))))
(let ((anon11_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= b_2@1 b_2@0) (= (ControlFlow 0 9) 7)) anon12_correct))))
(let ((anon19_Else_correct  (=> (and (and (not (= a_2 4)) (state Heap@@9 ZeroMask)) (and (= b_2@0 5) (= (ControlFlow 0 11) 9))) anon11_correct)))
(let ((anon19_Then_correct  (=> (and (and (= a_2 4) (state Heap@@9 ZeroMask)) (and (= b_2@0 2) (= (ControlFlow 0 10) 9))) anon11_correct)))
(let ((anon18_Else_correct  (=> (not (= a_2 3)) (and (=> (= (ControlFlow 0 12) 10) anon19_Then_correct) (=> (= (ControlFlow 0 12) 11) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (and (and (= a_2 3) (state Heap@@9 ZeroMask)) (and (= b_2@1 4) (= (ControlFlow 0 8) 7))) anon12_correct)))
(let ((anon17_Else_correct  (=> (not (= a_2 2)) (and (=> (= (ControlFlow 0 13) 8) anon18_Then_correct) (=> (= (ControlFlow 0 13) 12) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (and (and (= a_2 2) (state Heap@@9 ZeroMask)) (and (= b_2@2 3) (= (ControlFlow 0 6) 5))) anon13_correct)))
(let ((anon16_Else_correct  (=> (not (= a_2 1)) (and (=> (= (ControlFlow 0 14) 6) anon17_Then_correct) (=> (= (ControlFlow 0 14) 13) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (and (and (= a_2 1) (state Heap@@9 ZeroMask)) (and (= b_2@3 2) (= (ControlFlow 0 4) 3))) anon14_correct)))
(let ((anon15_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (> a_2 0) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 15) 1) anon15_Then_correct) (=> (= (ControlFlow 0 15) 4) anon16_Then_correct)) (=> (= (ControlFlow 0 15) 14) anon16_Else_correct))))))
