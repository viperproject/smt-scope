...
(assert  (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type c1) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type r_8) RefType)))
(set-info :boogie-vc-id test06)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (not (HasDirectPerm ZeroMask r_8 val)) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (HasDirectPerm ZeroMask r_8 val) (and (=> (= (ControlFlow 0 4) (- 0 5)) (HasDirectPerm ZeroMask r_8 val)) (=> (HasDirectPerm ZeroMask r_8 val) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
(let ((anon5_Else_correct  (=> (forall ((r_1_1 T@U) ) (!  (=> (and (= (type r_1_1) RefType) (HasDirectPerm ZeroMask r_1_1 val)) false)
 :qid |stdinbpl.652:20|
 :skolemid |29|
 :pattern ( (MapType1Select ZeroMask r_1_1 val))
 :pattern ( (MapType0Select Heap@@9 r_1_1 val))
)) (=> (and (and (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (not (= c1 null)) (= Mask@0 (MapType1Store ZeroMask c1 val (real_2_U (+ (U_2_real (MapType1Select ZeroMask c1 val)) FullPerm)))))) (and (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (= (ControlFlow 0 2) (- 0 1))))) false))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 c1 $allocated))) (and (and (=> (= (ControlFlow 0 7) 2) anon5_Else_correct) (=> (= (ControlFlow 0 7) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))
