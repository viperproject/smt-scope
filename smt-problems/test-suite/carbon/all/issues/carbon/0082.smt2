...
(assert  (and (and (and (and (and (= (type Heap@@14) (MapType0Type RefType)) (= (type self@@9) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (forall ((arg0@@28 T@U) ) (! (= (type (FrameFragment arg0@@28)) FrameTypeType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@14 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@14 self@@9 $allocated)) (= AssumeFunctionsAbove 0)) (and (> wildcard@0 NoPerm) (= Mask@0 (MapType1Store ZeroMask null (valid self@@9) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (valid self@@9))) wildcard@0)))))) (and (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0)) (and (|valid#trigger| Heap@@14 (valid self@@9)) (= (MapType0Select Heap@@14 null (valid self@@9)) (FrameFragment (MapType0Select Heap@@14 self@@9 f_7)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> (U_2_real (MapType1Select Mask@0 null (valid self@@9))) NoPerm)) (=> (> (U_2_real (MapType1Select Mask@0 null (valid self@@9))) NoPerm) (=> (> wildcard@1 NoPerm) (=> (and (and (and (< wildcard@1 (U_2_real (MapType1Select Mask@0 null (valid self@@9)))) (= UnfoldingMask@0 (MapType1Store Mask@0 null (valid self@@9) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (valid self@@9))) wildcard@1))))) (and (> wildcard@2 NoPerm) (not (= self@@9 null)))) (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 self@@9 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 self@@9 f_7)) wildcard@2)))) (state Heap@@14 UnfoldingMask@1)) (and (state Heap@@14 UnfoldingMask@1) (= (ControlFlow 0 2) (- 0 1))))) (HasDirectPerm UnfoldingMask@1 self@@9 f_7)))))))))
