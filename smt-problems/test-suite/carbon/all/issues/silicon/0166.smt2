...
(assert  (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id Quantifiersforall10)
...
(let ((anon15_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 10) (int_2_U i_4))) (= (ControlFlow 0 6) 3)) anon9_correct)))
(let ((anon15_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 10) (int_2_U i_4)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (> x@@11 i_4)) (=> (> x@@11 i_4) (=> (= (ControlFlow 0 4) 3) anon9_correct))))))
(let ((anon14_Else_correct true))
(let ((anon11_Else_correct  (=> (and (forall ((i_1 T@U) ) (!  (=> (and (= (type i_1) intType) (|Seq#Contains| (|Seq#Range| 0 10) i_1)) (> x@@11 (U_2_int i_1)))
 :qid |stdinbpl.562:20|
 :skolemid |58|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 10) i_1))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 10) i_1))
...
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 11) 1) anon11_Then_correct) (=> (= (ControlFlow 0 11) 10) anon11_Else_correct)))))
