...
(= (type (MapType0Store arg0@@18 arg1@@6 arg2)) (MapType0Type aVar0 aVar1@@0))))
 ...
 :weight 0
)))) (= (Ctor RefType) 9)) (= (type S) (FieldType NormalFieldType (MapType0Type RefType boolType)))) (= (type f_7) (FieldType NormalFieldType RefType))))
(assert (distinct $allocated S f_7)
)
...
(assert  (and (= (Ctor PredicateType_pType) 14) (forall ((arg0@@35 T@U) ) (! (= (type (p_1 arg0@@35)) (FieldType PredicateType_pType FrameTypeType))
 :qid |funType:p_1|
 :pattern ( (p_1 arg0@@35))
))))
...
(assert (forall ((Heap@@2 T@U) (this@@0 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType1Type RefType)) (= (type this@@0) RefType)) (|p#everUsed| (p_1 this@@0)))
 :qid |stdinbpl.425:15|
 :skolemid |87|
 :pattern ( (|p#trigger| Heap@@2 (p_1 this@@0)))
)))
...
(assert (forall ((this@@1 T@U) (this2 T@U) ) (!  (=> (and (and (= (type this@@1) RefType) (= (type this2) RefType)) (= (p_1 this@@1) (p_1 this2))) (= this@@1 this2))
 :qid |stdinbpl.416:15|
 :skolemid |85|
 :pattern ( (p_1 this@@1) (p_1 this2))
)))
(assert (forall ((arg0@@39 T@U) ) (! (= (type (|p#sm| arg0@@39)) (FieldType PredicateType_pType (MapType2Type RefType boolType)))
 :qid |funType:p#sm|
 :pattern ( (|p#sm| arg0@@39))
)))
(assert (forall ((this@@2 T@U) (this2@@0 T@U) ) (!  (=> (and (and (= (type this@@2) RefType) (= (type this2@@0) RefType)) (= (|p#sm| this@@2) (|p#sm| this2@@0))) (= this@@2 this2@@0))
 :qid |stdinbpl.420:15|
 :skolemid |86|
...
(assert (forall ((this@@3 T@U) ) (!  (=> (= (type this@@3) RefType) (= (getPredWandId (p_1 this@@3)) 0))
 :qid |stdinbpl.410:15|
 :skolemid |84|
 :pattern ( (p_1 this@@3))
)))
...
(assert (forall ((this@@4 T@U) ) (!  (=> (= (type this@@4) RefType) (= (PredicateMaskField (p_1 this@@4)) (|p#sm| this@@4)))
 :qid |stdinbpl.402:15|
 :skolemid |82|
 :pattern ( (PredicateMaskField (p_1 this@@4)))
)))
...
(assert (forall ((arg0@@45 Int) (arg1@@23 Int) ) (! (= (type (|sk_p#condqp1| arg0@@45 arg1@@23)) RefType)
 :qid |funType:sk_p#condqp1|
 :pattern ( (|sk_p#condqp1| arg0@@45 arg1@@23))
)))
(assert (forall ((Heap2Heap T@U) (Heap1Heap T@U) (this@@5 T@U) ) (!  (=> (and (and (and (= (type Heap2Heap) (MapType1Type RefType)) (= (type Heap1Heap) (MapType1Type RefType))) (= (type this@@5) RefType)) (and (=  (and (U_2_bool (MapType0Select (MapType1Select Heap2Heap this@@5 S) (|sk_p#condqp1| (|p#condqp1| Heap2Heap this@@5) (|p#condqp1| Heap1Heap this@@5)))) (< NoPerm (/ (to_real 1) (to_real 2))))  (and (U_2_bool (MapType0Select (MapType1Select Heap1Heap this@@5 S) (|sk_p#condqp1| (|p#condqp1| Heap2Heap this@@5) (|p#condqp1| Heap1Heap this@@5)))) (< NoPerm (/ (to_real 1) (to_real 2))))) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap2Heap this@@5 S) (|sk_p#condqp1| (|p#condqp1| Heap2Heap this@@5) (|p#condqp1| Heap1Heap this@@5)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (= (MapType1Select Heap2Heap (|sk_p#condqp1| (|p#condqp1| Heap2Heap this@@5) (|p#condqp1| Heap1Heap this@@5)) f_7) (MapType1Select Heap1Heap (|sk_p#condqp1| (|p#condqp1| Heap2Heap this@@5) (|p#condqp1| Heap1Heap this@@5)) f_7))))) (= (|p#condqp1| Heap2Heap this@@5) (|p#condqp1| Heap1Heap this@@5)))
 :qid |stdinbpl.436:15|
 :skolemid |88|
 :pattern ( (|p#condqp1| Heap2Heap this@@5) (|p#condqp1| Heap1Heap this@@5) (succHeapTrans Heap2Heap Heap1Heap))
)))
...
(assert  (and (and (and (and (and (= (type Mask@0) (MapType2Type RefType realType)) (= (type this@@6) RefType)) (= (type Heap@@10) (MapType1Type RefType))) (= (type y@@6) RefType)) (= (type QPMask@0) (MapType2Type RefType realType))) (forall ((arg0@@46 T@U) ) (! (= (type (invRecv1 arg0@@46)) RefType)
...
(let ((anon12_Else_correct  (=> (and (not (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@6 S) y@@6)) (not (= (MapType1Select Heap@@10 y@@6 f_7) null)))) (= (ControlFlow 0 8) 4)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@6 S) y@@6)) (not (= (MapType1Select Heap@@10 y@@6 f_7) null))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (HasDirectPerm QPMask@0 y@@6 f_7)) (=> (HasDirectPerm QPMask@0 y@@6 f_7) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm QPMask@0 this@@6 S)) (=> (HasDirectPerm QPMask@0 this@@6 S) (=> (= (ControlFlow 0 5) 4) anon7_correct))))))))
(let ((anon11_Else_correct  (=> (not (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@6 S) y@@6))) (and (=> (= (ControlFlow 0 11) 5) anon12_Then_correct) (=> (= (ControlFlow 0 11) 8) anon12_Else_correct)))))
(let ((anon11_Then_correct  (=> (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@6 S) y@@6)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm QPMask@0 y@@6 f_7)) (=> (HasDirectPerm QPMask@0 y@@6 f_7) (and (=> (= (ControlFlow 0 9) 5) anon12_Then_correct) (=> (= (ControlFlow 0 9) 8) anon12_Else_correct)))))))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (HasDirectPerm QPMask@0 this@@6 S)) (=> (HasDirectPerm QPMask@0 this@@6 S) (and (=> (= (ControlFlow 0 12) 9) anon11_Then_correct) (=> (= (ControlFlow 0 12) 11) anon11_Else_correct))))))
(let ((anon10_Else_correct true))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 16)) (forall ((x_2 T@U) (x_2_1 T@U) ) (!  (=> (and (= (type x_2) RefType) (= (type x_2_1) RefType)) (=> (and (and (and (and (not (= x_2 x_2_1)) (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@6 S) x_2))) (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@6 S) x_2_1))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= x_2 x_2_1))))
 :qid |stdinbpl.472:15|
 :skolemid |89|
 :no-pattern (type x_2)
...
))) (=> (forall ((x_2@@0 T@U) (x_2_1@@0 T@U) ) (!  (=> (and (= (type x_2@@0) RefType) (= (type x_2_1@@0) RefType)) (=> (and (and (and (and (not (= x_2@@0 x_2_1@@0)) (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@6 S) x_2@@0))) (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@6 S) x_2_1@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= x_2@@0 x_2_1@@0))))
 :qid |stdinbpl.472:15|
 :skolemid |89|
...
)) (=> (and (forall ((x_2@@1 T@U) ) (!  (=> (= (type x_2@@1) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@6 S) x_2@@1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange1 x_2@@1) (= (invRecv1 x_2@@1) x_2@@1))))
 :qid |stdinbpl.478:22|
 :skolemid |90|
 :pattern ( (MapType1Select Heap@@10 x_2@@1 f_7))
 :pattern ( (MapType2Select QPMask@0 x_2@@1 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 this@@6 S) x_2@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@6 S) (invRecv1 o_3))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.482:22|
 :skolemid |91|
 :pattern ( (invRecv1 o_3))
))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((x_2@@2 T@U) ) (!  (=> (and (= (type x_2@@2) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@6 S) x_2@@2))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.488:15|
 :skolemid |92|
 :pattern ( (MapType1Select Heap@@10 x_2@@2 f_7))
 :pattern ( (MapType2Select QPMask@0 x_2@@2 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 this@@6 S) x_2@@2))
))) (=> (forall ((x_2@@3 T@U) ) (!  (=> (and (= (type x_2@@3) RefType) (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@6 S) x_2@@3))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.488:15|
 :skolemid |92|
 :pattern ( (MapType1Select Heap@@10 x_2@@3 f_7))
 :pattern ( (MapType2Select QPMask@0 x_2@@3 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 this@@6 S) x_2@@3))
)) (=> (and (and (forall ((x_2@@4 T@U) ) (!  (=> (= (type x_2@@4) RefType) (=> (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@6 S) x_2@@4)) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= x_2@@4 null))))
 :qid |stdinbpl.494:22|
 :skolemid |93|
 :pattern ( (MapType1Select Heap@@10 x_2@@4 f_7))
 :pattern ( (MapType2Select QPMask@0 x_2@@4 f_7))
 :pattern ( (MapType0Select (MapType1Select Heap@@10 this@@6 S) x_2@@4))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@6 S) (invRecv1 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_3@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv1 o_3@@0) o_3@@0)) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType2Select Mask@0 o_3@@0 f_7)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@6 S) (invRecv1 o_3@@0))) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange1 o_3@@0))) (= (U_2_real (MapType2Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType2Select Mask@0 o_3@@0 f_7))))))
 :qid |stdinbpl.500:22|
 :skolemid |94|
...
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 f_7))) (= (U_2_real (MapType2Select Mask@0 o_3@@1 f_5)) (U_2_real (MapType2Select QPMask@0 o_3@@1 f_5))))))
 :qid |stdinbpl.504:29|
 :skolemid |95|
 :pattern ( (MapType2Select Mask@0 o_3@@1 f_5))
 :pattern ( (MapType2Select QPMask@0 o_3@@1 f_5))
)) (state Heap@@10 QPMask@0))) (and (=> (= (ControlFlow 0 14) 12) anon10_Then_correct) (=> (= (ControlFlow 0 14) 3) anon10_Else_correct))))))))))
(let ((anon9_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (HasDirectPerm Mask@0 this@@6 S))))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (=> (and (and (U_2_bool (MapType1Select Heap@@10 this@@6 $allocated)) (not (= this@@6 null))) (and (= Mask@0 (MapType2Store ZeroMask this@@6 S (real_2_U (+ (U_2_real (MapType2Select ZeroMask this@@6 S)) FullPerm)))) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm Mask@0 this@@6 S)) (=> (HasDirectPerm Mask@0 this@@6 S) (=> (U_2_bool (MapType0Select (MapType1Select Heap@@10 this@@6 S) this@@6)) (and (=> (= (ControlFlow 0 17) 2) anon9_Then_correct) (=> (= (ControlFlow 0 17) 14) anon9_Else_correct)))))))))
