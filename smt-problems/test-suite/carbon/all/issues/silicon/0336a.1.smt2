...
(assert  (and (and (and (and (and (and (= (type b_2@@7) (MapType2Type RefType boolType)) (= (type l) RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (forall ((arg0@@47 T@U) ) (! (= (type (invRecv2 arg0@@47)) RefType)
...
(let ((anon12_Else_correct  (=> (and (not (U_2_bool (MapType2Select b_2@@7 l))) (= (ControlFlow 0 7) 4)) anon7_correct)))
(let ((anon12_Then_correct  (=> (U_2_bool (MapType2Select b_2@@7 l)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm QPMask@1 l rank)) (=> (HasDirectPerm QPMask@1 l rank) (=> (= (ControlFlow 0 5) 4) anon7_correct))))))
(let ((anon11_Else_correct true))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (forall ((l_5 T@U) (l_5_1 T@U) ) (!  (=> (and (= (type l_5) RefType) (= (type l_5_1) RefType)) (=> (and (and (and (and (not (= l_5 l_5_1)) (U_2_bool (MapType2Select b_2@@7 l_5))) (U_2_bool (MapType2Select b_2@@7 l_5_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= l_5 l_5_1))))
 :qid |stdinbpl.527:15|
 :skolemid |96|
 :no-pattern (type l_5)
...
)) (state Heap@@10 QPMask@1))) (and (and (=> (= (ControlFlow 0 8) 3) anon11_Else_correct) (=> (= (ControlFlow 0 8) 5) anon12_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon12_Else_correct))))))))
(let ((anon10_Then_correct true))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((l_3 T@U) (l_3_1 T@U) ) (!  (=> (and (= (type l_3) RefType) (= (type l_3_1) RefType)) (=> (and (and (and (and (not (= l_3 l_3_1)) (U_2_bool (MapType2Select b_2@@7 l_3))) (U_2_bool (MapType2Select b_2@@7 l_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= l_3 l_3_1))))
 :qid |stdinbpl.488:15|
 :skolemid |90|
 :no-pattern (type l_3)
...
)) (state Heap@@10 QPMask@0))) (and (=> (= (ControlFlow 0 10) 2) anon10_Then_correct) (=> (= (ControlFlow 0 10) 8) anon10_Else_correct))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@10 ZeroMask) (and (=> (= (ControlFlow 0 12) 1) anon9_Then_correct) (=> (= (ControlFlow 0 12) 10) anon9_Else_correct)))))
