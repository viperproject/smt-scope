...
(declare-fun |list_len#frame| (T@U) Int)
...
(assert (forall ((Heap@@5 T@U) (Mask@@2 T@U) (this@@3 T@U) (i@@0 Int) ) (!  (=> (and (and (and (and (= (type Heap@@5) (MapType0Type RefType)) (= (type Mask@@2) (MapType1Type RefType realType))) (= (type this@@3) RefType)) (and (state Heap@@5 Mask@@2) (< AssumeFunctionsAbove 1))) (and (<= 0 i@@0) (< i@@0 (length Heap@@5 this@@3)))) (= (get Heap@@5 this@@3 i@@0) (ite (= i@@0 0) (- 0 1) (|get'| Heap@@5 (MapType0Select Heap@@5 this@@3 next) (- i@@0 1)))))
 :qid |stdinbpl.262:15|
 :skolemid |28|
 :pattern ( (state Heap@@5 Mask@@2) (get Heap@@5 this@@3 i@@0))
 :pattern ( (state Heap@@5 Mask@@2) (|get#triggerStateless| this@@3 i@@0) (|Node#trigger| Heap@@5 (Node this@@3)))
)))
...
(assert (forall ((Heap@@10 T@U) ) (!  (=> (= (type Heap@@10) (MapType0Type RefType)) (and (= (list_len Heap@@10) (|list_len'| Heap@@10)) (dummyFunction (int_2_U |list_len#triggerStateless|))))
 :qid |stdinbpl.405:15|
 :skolemid |31|
 :pattern ( (list_len Heap@@10))
)))
...
(assert (forall ((Heap@@11 T@U) (this@@7 T@U) (i@@1 Int) ) (!  (=> (and (= (type Heap@@11) (MapType0Type RefType)) (= (type this@@7) RefType)) (and (= (get Heap@@11 this@@7 i@@1) (|get'| Heap@@11 this@@7 i@@1)) (dummyFunction (int_2_U (|get#triggerStateless| this@@7 i@@1)))))
 :qid |stdinbpl.252:15|
 :skolemid |26|
 :pattern ( (get Heap@@11 this@@7 i@@1))
)))
...
(assert (forall ((this@@8 T@U) ) (!  (=> (= (type this@@8) RefType) (= (getPredWandId (Node this@@8)) 0))
 :qid |stdinbpl.462:15|
 :skolemid |37|
 :pattern ( (Node this@@8))
)))
...
(assert (forall ((Heap@@14 T@U) ) (!  (=> (= (type Heap@@14) (MapType0Type RefType)) (dummyFunction (int_2_U |list_len#triggerStateless|)))
 :qid |stdinbpl.409:15|
 :skolemid |32|
 :pattern ( (|list_len'| Heap@@14))
)))
(assert (forall ((Heap@@15 T@U) (Mask@@10 T@U) (this@@9 T@U) ) (!  (=> (and (and (and (= (type Heap@@15) (MapType0Type RefType)) (= (type Mask@@10) (MapType1Type RefType realType))) (= (type this@@9) RefType)) (state Heap@@15 Mask@@10)) (= (|length'| Heap@@15 this@@9) (|length#frame| (MapType0Select Heap@@15 null (Node this@@9)) this@@9)))
 :qid |stdinbpl.212:15|
 :skolemid |25|
 :pattern ( (state Heap@@15 Mask@@10) (|length'| Heap@@15 this@@9))
)))
...
(assert (forall ((Heap@@17 T@U) (Mask@@11 T@U) ) (!  (=> (and (and (= (type Heap@@17) (MapType0Type RefType)) (= (type Mask@@11) (MapType1Type RefType realType))) (state Heap@@17 Mask@@11)) (= (|list_len'| Heap@@17) (|list_len#frame| EmptyFrame)))
 :qid |stdinbpl.422:15|
 :skolemid |34|
 :pattern ( (state Heap@@17 Mask@@11) (|list_len'| Heap@@17))
)))
(assert (forall ((this@@10 T@U) ) (!  (=> (= (type this@@10) RefType) (= (PredicateMaskField (Node this@@10)) (|Node#sm| this@@10)))
 :qid |stdinbpl.454:15|
 :skolemid |35|
 :pattern ( (PredicateMaskField (Node this@@10)))
)))
...
(assert (forall ((Heap@@19 T@U) (Mask@@12 T@U) (this@@11 T@U) (i@@2 Int) ) (!  (=> (and (and (and (= (type Heap@@19) (MapType0Type RefType)) (= (type Mask@@12) (MapType1Type RefType realType))) (= (type this@@11) RefType)) (state Heap@@19 Mask@@12)) (= (|get'| Heap@@19 this@@11 i@@2) (|get#frame| (MapType0Select Heap@@19 null (Node this@@11)) this@@11 i@@2)))
 :qid |stdinbpl.269:15|
 :skolemid |29|
 :pattern ( (state Heap@@19 Mask@@12) (|get'| Heap@@19 this@@11 i@@2))
 :pattern ( (state Heap@@19 Mask@@12) (|get#triggerStateless| this@@11 i@@2) (|Node#trigger| Heap@@19 (Node this@@11)))
)))
(assert (forall ((Heap@@20 T@U) (Mask@@13 T@U) (this@@12 T@U) ) (!  (=> (and (and (and (= (type Heap@@20) (MapType0Type RefType)) (= (type Mask@@13) (MapType1Type RefType realType))) (= (type this@@12) RefType)) (and (state Heap@@20 Mask@@13) (< AssumeFunctionsAbove 2))) (= (length Heap@@20 this@@12) 10))
 :qid |stdinbpl.205:15|
 :skolemid |24|
 :pattern ( (state Heap@@20 Mask@@13) (length Heap@@20 this@@12))
 :pattern ( (state Heap@@20 Mask@@13) (|length#triggerStateless| this@@12) (|Node#trigger| Heap@@20 (Node this@@12)))
)))
(assert (forall ((Heap@@21 T@U) (Mask@@14 T@U) ) (!  (=> (and (and (= (type Heap@@21) (MapType0Type RefType)) (= (type Mask@@14) (MapType1Type RefType realType))) (and (state Heap@@21 Mask@@14) (< AssumeFunctionsAbove 0))) (= (list_len Heap@@21) 0))
 :qid |stdinbpl.415:15|
 :skolemid |33|
 :pattern ( (state Heap@@21 Mask@@14) (list_len Heap@@21))
)))
(assert (= NoPerm 0.0))
(assert (= FullPerm 1.0))
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(declare-fun |get#trigger| (T@U T@U Int) Bool)
...
(let ((anon18_Else_correct  (=> (and (|get#trigger| (MapType0Select Heap@@22 null (Node (MapType0Select Heap@@22 this@@13 next))) (MapType0Select Heap@@22 this@@13 next) (- i@@3 1)) (= (ControlFlow 0 13) 11)) anon13_correct)))
(let ((anon17_Then_correct  (=> (and (= i@@3 0) (= (ControlFlow 0 12) 11)) anon13_correct)))
(let ((anon11_correct  (=> (= UnfoldingMask@3 (MapType1Store UnfoldingMask@2 null (Node (MapType0Select Heap@@22 this@@13 next)) (real_2_U (- (U_2_real (MapType1Select UnfoldingMask@2 null (Node (MapType0Select Heap@@22 this@@13 next)))) FullPerm)))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= 0 (- i@@3 1))) (=> (<= 0 (- i@@3 1)) (=> (= (ControlFlow 0 6) (- 0 5)) (< (- i@@3 1) (length Heap@@22 (MapType0Select Heap@@22 this@@13 next)))))))))
(let ((anon19_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 10) 6)) anon11_correct)))
(let ((anon19_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@2 null (Node (MapType0Select Heap@@22 this@@13 next)))))) (=> (<= FullPerm (U_2_real (MapType1Select UnfoldingMask@2 null (Node (MapType0Select Heap@@22 this@@13 next))))) (=> (= (ControlFlow 0 8) 6) anon11_correct))))))
(let ((anon17_Else_correct  (=> (not (= i@@3 0)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (HasDirectPerm UnfoldingMask@2 this@@13 next)) (=> (HasDirectPerm UnfoldingMask@2 this@@13 next) (and (and (=> (= (ControlFlow 0 14) 13) anon18_Else_correct) (=> (= (ControlFlow 0 14) 8) anon19_Then_correct)) (=> (= (ControlFlow 0 14) 10) anon19_Else_correct)))))))
(let ((anon6_correct  (=> (and (and (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (Node this@@13) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (Node this@@13))) FullPerm)))) (not (= this@@13 null))) (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 this@@13 next (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 this@@13 next)) FullPerm)))) (state Heap@@22 UnfoldingMask@1))) (and (and (= UnfoldingMask@2 (MapType1Store UnfoldingMask@1 null (Node (MapType0Select Heap@@22 this@@13 next)) (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@1 null (Node (MapType0Select Heap@@22 this@@13 next)))) FullPerm)))) (InsidePredicate (Node this@@13) (MapType0Select Heap@@22 null (Node this@@13)) (Node (MapType0Select Heap@@22 this@@13 next)) (MapType0Select Heap@@22 null (Node (MapType0Select Heap@@22 this@@13 next))))) (and (state Heap@@22 UnfoldingMask@2) (state Heap@@22 UnfoldingMask@2)))) (and (=> (= (ControlFlow 0 16) 12) anon17_Then_correct) (=> (= (ControlFlow 0 16) 14) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 19) 16)) anon6_correct)))
(let ((anon16_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Node this@@13))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Node this@@13)))) (=> (= (ControlFlow 0 17) 16) anon6_correct))))))
(let ((anon14_Else_correct  (=> (and (and (< i@@3 (length Heap@@22 this@@13)) (state Heap@@22 Mask@0)) (and (|Node#trigger| Heap@@22 (Node this@@13)) (= (MapType0Select Heap@@22 null (Node this@@13)) (CombineFrames (FrameFragment (MapType0Select Heap@@22 this@@13 next)) (MapType0Select Heap@@22 null (Node (MapType0Select Heap@@22 this@@13 next))))))) (and (=> (= (ControlFlow 0 20) 17) anon16_Then_correct) (=> (= (ControlFlow 0 20) 19) anon16_Else_correct)))))
(let ((anon3_correct true))
(let ((anon15_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Node this@@13))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (Node this@@13)))) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (state Heap@@22 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@22 this@@13 $allocated)) (= AssumeFunctionsAbove 1)) (and (= Mask@0 (MapType1Store ZeroMask null (Node this@@13) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (Node this@@13))) FullPerm)))) (state Heap@@22 Mask@0))) (and (and (state Heap@@22 Mask@0) (<= 0 i@@3)) (and (state Heap@@22 Mask@0) (state Heap@@22 Mask@0)))) (and (and (=> (= (ControlFlow 0 21) 20) anon14_Else_correct) (=> (= (ControlFlow 0 21) 2) anon15_Then_correct)) (=> (= (ControlFlow 0 21) 4) anon15_Else_correct))))))
