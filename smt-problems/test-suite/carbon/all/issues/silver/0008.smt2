...
(assert  (and (and (= (type Heap@@18) (MapType0Type RefType)) (= (type x@@21) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |P#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@18 ZeroMask) (=> (and (= AssumeFunctionsAbove (- 0 1)) (U_2_bool (MapType0Select Heap@@18 x@@21 $allocated))) (=> (and (and (not (= x@@21 null)) (= Mask@0 (MapType1Store ZeroMask x@@21 g (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@21 g)) FullPerm))))) (and (state Heap@@18 Mask@0) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm Mask@0 x@@21 g))))))
