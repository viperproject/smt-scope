...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 r_1 $allocated)) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm ZeroMask r_1 f_7)))))
