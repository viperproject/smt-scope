...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (state Heap@@75 ZeroMask) (= AssumeFunctionsAbove 3)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (not (= 1 0))) (=> (not (= 1 0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (= 1 0))) (=> (not (= 1 0)) (=> (= (ControlFlow 0 2) (- 0 1)) (not (= (div 1 1) 2))))))))))
