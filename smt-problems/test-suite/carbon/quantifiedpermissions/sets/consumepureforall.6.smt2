...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type S) (MapType2Type RefType boolType)) (= (type q_4) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type t_2_1) RefType)) (= (type Heap@1) (MapType0Type RefType))) (= (type b_2) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Heap@@9) (MapType0Type RefType))) (= (type c) RefType)) (= (type QPMask@1) (MapType1Type RefType realType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv27 arg0@@43)) RefType)
 :qid |funType:invRecv27|
 :pattern ( (invRecv27 arg0@@43))
))) (= (type t_7) RefType)) (= (type QPMask@2) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (forall ((arg0@@44 T@U) ) (! (= (type (invRecv26 arg0@@44)) RefType)
 :qid |funType:invRecv26|
 :pattern ( (invRecv26 arg0@@44))
))) (forall ((arg0@@45 T@U) ) (! (= (type (invRecv25 arg0@@45)) RefType)
...
(let ((anon25_Else_correct  (=> (and (not (U_2_bool (MapType2Select S t_7))) (= (ControlFlow 0 21) 18)) anon12_correct)))
(let ((anon25_Then_correct  (=> (U_2_bool (MapType2Select S t_7)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (HasDirectPerm QPMask@2 t_7 f_7)) (=> (HasDirectPerm QPMask@2 t_7 f_7) (=> (= (ControlFlow 0 19) 18) anon12_correct))))))
(let ((anon24_Else_correct true))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 22) (- 0 23)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (U_2_bool (MapType2Select S r_1))) (U_2_bool (MapType2Select S r_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1 r_1_1))))
 :qid |stdinbpl.2343:15|
 :skolemid |252|
 :no-pattern (type r_1)
...
))) (=> (forall ((r_1@@0 T@U) (r_1_1@@0 T@U) ) (!  (=> (and (= (type r_1@@0) RefType) (= (type r_1_1@@0) RefType)) (=> (and (and (and (and (not (= r_1@@0 r_1_1@@0)) (U_2_bool (MapType2Select S r_1@@0))) (U_2_bool (MapType2Select S r_1_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_1@@0 r_1_1@@0))))
 :qid |stdinbpl.2343:15|
 :skolemid |252|
...
)) (=> (forall ((r_1@@1 T@U) ) (!  (=> (= (type r_1@@1) RefType) (=> (and (U_2_bool (MapType2Select S r_1@@1)) (< NoPerm FullPerm)) (and (qpRange26 r_1@@1) (= (invRecv26 r_1@@1) r_1@@1))))
 :qid |stdinbpl.2349:22|
 :skolemid |253|
 :pattern ( (MapType0Select PostHeap@0 r_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@2 r_1@@1 f_7))
 :pattern ( (MapType2Select S r_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select S (invRecv26 o_3))) (< NoPerm FullPerm)) (qpRange26 o_3)) (= (invRecv26 o_3) o_3)))
 :qid |stdinbpl.2353:22|
 :skolemid |254|
 :pattern ( (invRecv26 o_3))
)) (forall ((r_1@@2 T@U) ) (!  (=> (and (= (type r_1@@2) RefType) (U_2_bool (MapType2Select S r_1@@2))) (not (= r_1@@2 null)))
 :qid |stdinbpl.2359:22|
 :skolemid |255|
 :pattern ( (MapType0Select PostHeap@0 r_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@2 r_1@@2 f_7))
 :pattern ( (MapType2Select S r_1@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select S (invRecv26 o_3@@0))) (< NoPerm FullPerm)) (qpRange26 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv26 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select S (invRecv26 o_3@@0))) (< NoPerm FullPerm)) (qpRange26 o_3@@0))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
))) (and (state PostHeap@0 QPMask@2) (state PostHeap@0 QPMask@2))) (and (and (=> (= (ControlFlow 0 22) 17) anon24_Else_correct) (=> (= (ControlFlow 0 22) 19) anon25_Then_correct)) (=> (= (ControlFlow 0 22) 21) anon25_Else_correct)))))))))
(let ((anon23_Then_correct true))
(let ((anon22_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 24) 16) anon23_Then_correct) (=> (= (ControlFlow 0 24) 22) anon23_Else_correct)))))
(let ((anon17_correct true))
(let ((anon27_Else_correct  (=> (and (not (U_2_bool (MapType2Select S t_2_1))) (= (ControlFlow 0 10) 7)) anon17_correct)))
(let ((anon27_Then_correct  (=> (U_2_bool (MapType2Select S t_2_1)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (> (U_2_int (MapType0Select Heap@1 t_2_1 f_7)) a_2)) (=> (> (U_2_int (MapType0Select Heap@1 t_2_1 f_7)) a_2) (=> (= (ControlFlow 0 8) 7) anon17_correct))))))
(let ((anon26_Else_correct true))
(let ((anon22_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 15)) (= FullPerm (U_2_real (MapType1Select QPMask@0 b_2 f_7)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 b_2 f_7))) (=> (and (= Heap@0 (MapType0Store Heap@@9 b_2 f_7 (int_2_U (+ (* 2 a_2) 1)))) (state Heap@0 QPMask@0)) (and (=> (= (ControlFlow 0 11) (- 0 14)) (= FullPerm (U_2_real (MapType1Select QPMask@0 c f_7)))) (=> (= FullPerm (U_2_real (MapType1Select QPMask@0 c f_7))) (=> (and (= Heap@1 (MapType0Store Heap@0 c f_7 (int_2_U (+ a_2 1)))) (state Heap@1 QPMask@0)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (forall ((r_2 T@U) (r_2_1 T@U) ) (!  (=> (and (= (type r_2) RefType) (= (type r_2_1) RefType)) (=> (and (and (and (and (not (= r_2 r_2_1)) (U_2_bool (MapType2Select S r_2))) (U_2_bool (MapType2Select S r_2_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_2 r_2_1))))
 :qid |stdinbpl.2416:17|
 :skolemid |259|
 :pattern ( (neverTriggered27 r_2) (neverTriggered27 r_2_1))
))) (=> (forall ((r_2@@0 T@U) (r_2_1@@0 T@U) ) (!  (=> (and (= (type r_2@@0) RefType) (= (type r_2_1@@0) RefType)) (=> (and (and (and (and (not (= r_2@@0 r_2_1@@0)) (U_2_bool (MapType2Select S r_2@@0))) (U_2_bool (MapType2Select S r_2_1@@0))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= r_2@@0 r_2_1@@0))))
 :qid |stdinbpl.2416:17|
 :skolemid |259|
 :pattern ( (neverTriggered27 r_2@@0) (neverTriggered27 r_2_1@@0))
)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((r_2@@1 T@U) ) (!  (=> (and (= (type r_2@@1) RefType) (U_2_bool (MapType2Select S r_2@@1))) (>= (U_2_real (MapType1Select QPMask@0 r_2@@1 f_7)) FullPerm))
 :qid |stdinbpl.2423:17|
 :skolemid |260|
 :pattern ( (MapType0Select Heap@1 r_2@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 r_2@@1 f_7))
 :pattern ( (MapType2Select S r_2@@1))
))) (=> (forall ((r_2@@2 T@U) ) (!  (=> (and (= (type r_2@@2) RefType) (U_2_bool (MapType2Select S r_2@@2))) (>= (U_2_real (MapType1Select QPMask@0 r_2@@2 f_7)) FullPerm))
 :qid |stdinbpl.2423:17|
 :skolemid |260|
 :pattern ( (MapType0Select Heap@1 r_2@@2 f_7))
 :pattern ( (MapType1Select QPMask@1 r_2@@2 f_7))
 :pattern ( (MapType2Select S r_2@@2))
)) (=> (and (and (forall ((r_2@@3 T@U) ) (!  (=> (= (type r_2@@3) RefType) (=> (and (U_2_bool (MapType2Select S r_2@@3)) (< NoPerm FullPerm)) (and (qpRange27 r_2@@3) (= (invRecv27 r_2@@3) r_2@@3))))
 :qid |stdinbpl.2429:22|
 :skolemid |261|
 :pattern ( (MapType0Select Heap@1 r_2@@3 f_7))
 :pattern ( (MapType1Select QPMask@1 r_2@@3 f_7))
 :pattern ( (MapType2Select S r_2@@3))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType2Select S (invRecv27 o_3@@2))) (and (< NoPerm FullPerm) (qpRange27 o_3@@2))) (= (invRecv27 o_3@@2) o_3@@2)))
 :qid |stdinbpl.2433:22|
 :skolemid |262|
 :pattern ( (invRecv27 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType2Select S (invRecv27 o_3@@3))) (and (< NoPerm FullPerm) (qpRange27 o_3@@3))) (and (= (invRecv27 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (- (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) FullPerm)))) (=> (not (and (U_2_bool (MapType2Select S (invRecv27 o_3@@3))) (and (< NoPerm FullPerm) (qpRange27 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7))))))
...
(let ((anon20_Else_correct  (=> (and (and (and (forall ((q_1_1 T@U) ) (!  (=> (and (= (type q_1_1) RefType) (U_2_bool (MapType2Select S q_1_1))) (> (U_2_int (MapType0Select Heap@@9 q_1_1 f_7)) a_2))
 :qid |stdinbpl.2314:20|
 :skolemid |251|
 :pattern ( (MapType2Select S q_1_1))
)) (state Heap@@9 QPMask@0)) (and (U_2_bool (MapType2Select S b_2)) (state Heap@@9 QPMask@0))) (and (and (U_2_bool (MapType2Select S c)) (state Heap@@9 QPMask@0)) (and (> a_2 0) (state Heap@@9 QPMask@0)))) (and (=> (= (ControlFlow 0 25) 24) anon22_Then_correct) (=> (= (ControlFlow 0 25) 11) anon22_Else_correct)))))
(let ((anon5_correct true))
(let ((anon21_Else_correct  (=> (and (not (U_2_bool (MapType2Select S q_4))) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon21_Then_correct  (=> (U_2_bool (MapType2Select S q_4)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 q_4 f_7)) (=> (HasDirectPerm QPMask@0 q_4 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (forall ((s_1 T@U) (s_1_1 T@U) ) (!  (=> (and (= (type s_1) RefType) (= (type s_1_1) RefType)) (=> (and (and (and (and (not (= s_1 s_1_1)) (U_2_bool (MapType2Select S s_1))) (U_2_bool (MapType2Select S s_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1 s_1_1))))
 :qid |stdinbpl.2272:15|
 :skolemid |245|
 :no-pattern (type s_1)
...
)) (=> (forall ((s_1@@1 T@U) ) (!  (=> (= (type s_1@@1) RefType) (=> (and (U_2_bool (MapType2Select S s_1@@1)) (< NoPerm FullPerm)) (and (qpRange25 s_1@@1) (= (invRecv25 s_1@@1) s_1@@1))))
...
)) (=> (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (U_2_bool (MapType2Select S (invRecv25 o_3@@5))) (< NoPerm FullPerm)) (qpRange25 o_3@@5)) (= (invRecv25 o_3@@5) o_3@@5)))
...
))) (=> (and (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (U_2_bool (MapType2Select S (invRecv25 o_3@@6))) (< NoPerm FullPerm)) (qpRange25 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv25 o_3@@6) o_3@@6)) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@6 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select S (invRecv25 o_3@@6))) (< NoPerm FullPerm)) (qpRange25 o_3@@6))) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@6 f_7))))))
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 26) 25) anon20_Else_correct) (=> (= (ControlFlow 0 26) 3) anon21_Then_correct)) (=> (= (ControlFlow 0 26) 5) anon21_Else_correct)))))))))
(let ((anon19_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@9 b_2 $allocated)) (U_2_bool (MapType0Select Heap@@9 c $allocated))) (and (=> (= (ControlFlow 0 28) 1) anon19_Then_correct) (=> (= (ControlFlow 0 28) 26) anon19_Else_correct))))))
