...
(set-info :boogie-vc-id |len1#definedness|)
...
(let ((anon4_Else_correct  (=> (not (= (Triple3_tag t_2@@30) 0)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing t_2@@30 t_2@@30)) (=> (decreasing t_2@@30 t_2@@30) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded t_2@@30)) (=> (bounded t_2@@30) (=> (and (state Heap@@53 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
