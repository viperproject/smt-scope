...
(assert  (and (and (= (type Heap@@17) (MapType0Type RefType)) (= (type x@@18) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |pred#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (state Heap@@17 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (U_2_bool (MapType0Select Heap@@17 x@@18 $allocated)) (= perm@0 (/ (to_real 1) (to_real 2))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= x@@18 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask x@@18 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@18 f_7)) perm@0)))) (state Heap@@17 Mask@0)) (and (= perm@1 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1)))) (>= perm@1 NoPerm))))))))
