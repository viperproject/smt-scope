...
(declare-fun L@0 () T@U)
(assert  (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type diz) RefType)) (= (type L@0) (SeqType RefType))))
(set-info :boogie-vc-id Test__seq_of_object)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (and (U_2_bool (MapType0Select Heap@@9 diz $allocated)) (not (= diz null))) (and (state Heap@@9 ZeroMask) (>= current_thread_id 0))) (and (and (state Heap@@9 ZeroMask) (= L@0 (|Seq#Empty| RefType))) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1))))) (= (|Seq#Length| L@0) 0)))))
