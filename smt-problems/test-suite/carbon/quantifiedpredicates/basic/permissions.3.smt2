...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon6_correct  (=> (and (not (= y@@2 null)) (= Mask@1 (MapType1Store Mask@0 y@@2 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 y@@2 f_7)) FullPerm))))) (=> (and (and (state Heap@1 Mask@1) (state Heap@1 Mask@1)) (and (state Heap@1 Mask@1) (= (ControlFlow 0 3) (- 0 2)))) (not (= y@@2 null))))))
(let ((anon9_Else_correct  (=> (HasDirectPerm Mask@0 null (pred1 y@@2)) (=> (and (= Heap@1 Heap@@11) (= (ControlFlow 0 5) 3)) anon6_correct))))
(let ((anon9_Then_correct  (=> (and (and (not (HasDirectPerm Mask@0 null (pred1 y@@2))) (= Heap@0 (MapType0Store Heap@@11 null (pred1 y@@2) newVersion@0))) (and (= Heap@1 Heap@0) (= (ControlFlow 0 4) 3))) anon6_correct)))
(let ((anon4_correct  (=> (= Mask@0 (MapType1Store QPMask@0 null (pred1 y@@2) (real_2_U (- (U_2_real (MapType1Select QPMask@0 null (pred1 y@@2))) FullPerm)))) (and (=> (= (ControlFlow 0 6) 4) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 9) 6)) anon4_correct)))
(let ((anon8_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (pred1 y@@2))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (pred1 y@@2)))) (=> (= (ControlFlow 0 7) 6) anon4_correct))))))
...
)) (=> (and (and (and (forall ((a_1@@11 T@U) ) (!  (=> (= (type a_1@@11) RefType) (=> (and (and (|Seq#Contains| xs (invRecv1 a_1@@11)) (< NoPerm FullPerm)) (qpRange1 a_1@@11)) (= (invRecv1 a_1@@11) a_1@@11)))
 :qid |stdinbpl.842:22|
 :skolemid |72|
...
)))) (and (and (state Heap@@11 QPMask@0) (state Heap@@11 QPMask@0)) (and (|pred1#trigger| Heap@@11 (pred1 y@@2)) (= (MapType0Select Heap@@11 null (pred1 y@@2)) (FrameFragment (MapType0Select Heap@@11 y@@2 f_7)))))) (and (=> (= (ControlFlow 0 10) 7) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (and (state Heap@@11 ZeroMask) (U_2_bool (MapType0Select Heap@@11 y@@2 $allocated))) (and (|Seq#Contains| xs y@@2) (state Heap@@11 ZeroMask))) (and (=> (= (ControlFlow 0 12) 1) anon7_Then_correct) (=> (= (ControlFlow 0 12) 10) anon7_Else_correct)))))
