...
(let ((anon0_correct  (=> (state Heap@@121 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@121 this@@111 $allocated)) (= AssumeFunctionsAbove 2)) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
...
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct true))
(let ((anon3_Then_correct  (=> (state Heap@@121 ZeroMask) (=> (and (not (= this@@111 null)) (= (ControlFlow 0 2) (- 0 1))) (HasDirectPerm ZeroMask this@@111 x@@8)))))
(let ((anon0_correct  (=> (state Heap@@121 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@121 this@@111 $allocated)) (= AssumeFunctionsAbove 1)) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 5) 4) anon0_correct)))
PreconditionGeneratedEntry_correct)))))
))
(check-sat)
...
(declare-fun Heap@@121 () T@U)
(assert  (and (= (type this@@111) RefType) (= (type Heap@@121) (MapType0Type RefType))))
(set-info :boogie-vc-id |t5#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon6_Then_correct  (=> (and (not (= this@@111 null)) (= (ControlFlow 0 3) (- 0 2))) (HasDirectPerm ZeroMask this@@111 x@@8))))
(let ((anon5_Else_correct  (=> (and (state Heap@@121 ZeroMask) (= (ControlFlow 0 4) 3)) anon6_Then_correct)))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@121 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@121 this@@111 $allocated)) (= AssumeFunctionsAbove 10)) (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 4) anon5_Else_correct))))))
