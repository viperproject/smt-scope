...
(set-info :boogie-vc-id |tripleLen3Bad#definedness|)
...
(assert  (and (= (type t_2@@30) Triple3DomainTypeType) (= (type Heap@@53) (MapType0Type RefType))))
(set-info :boogie-vc-id tripleLen3_termination_proof)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_correct true))
(let ((anon4_Else_correct  (=> (not (= (Triple3_tag t_2@@30) 0)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (decreasing (get_Triple2_x (get_Triple1_x (get_Triple3_x t_2@@30))) t_2@@30)) (=> (decreasing (get_Triple2_x (get_Triple1_x (get_Triple3_x t_2@@30))) t_2@@30) (and (=> (= (ControlFlow 0 3) (- 0 4)) (bounded t_2@@30)) (=> (bounded t_2@@30) (=> (and (state Heap@@53 ZeroMask) (= (ControlFlow 0 3) 1)) anon3_correct))))))))
