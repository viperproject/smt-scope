...
))) (= (Ctor NormalFieldType) 7)) (= (type $allocated) (FieldType NormalFieldType boolType))) (= (Ctor RefType) 8)) (= (type root) (FieldType NormalFieldType RefType))))
(assert (distinct $allocated root)
)
...
(assert (forall ((Heap@@2 T@U) (this@@1 T@U) ) (!  (=> (and (= (type Heap@@2) (MapType0Type RefType)) (= (type this@@1) RefType)) (|valid1#everUsed| (valid1 this@@1)))
 :qid |stdinbpl.213:15|
 :skolemid |27|
 :pattern ( (|valid1#trigger| Heap@@2 (valid1 this@@1)))
)))
...
(assert (forall ((this@@3 T@U) (this2 T@U) ) (!  (=> (and (and (= (type this@@3) RefType) (= (type this2) RefType)) (= (valid1 this@@3) (valid1 this2))) (= this@@3 this2))
 :qid |stdinbpl.204:15|
 :skolemid |25|
 :pattern ( (valid1 this@@3) (valid1 this2))
)))
(assert (forall ((arg0@@27 T@U) ) (! (= (type (|valid1#sm| arg0@@27)) (FieldType PredicateType_valid1Type (MapType1Type RefType boolType)))
 :qid |funType:valid1#sm|
 :pattern ( (|valid1#sm| arg0@@27))
)))
(assert (forall ((this@@4 T@U) (this2@@0 T@U) ) (!  (=> (and (and (= (type this@@4) RefType) (= (type this2@@0) RefType)) (= (|valid1#sm| this@@4) (|valid1#sm| this2@@0))) (= this@@4 this2@@0))
 :qid |stdinbpl.208:15|
 :skolemid |26|
...
(assert (forall ((this@@7 T@U) ) (!  (=> (= (type this@@7) RefType) (= (getPredWandId (valid1 this@@7)) 0))
 :qid |stdinbpl.198:15|
 :skolemid |24|
...
(assert (forall ((this@@9 T@U) ) (!  (=> (= (type this@@9) RefType) (= (PredicateMaskField (valid1 this@@9)) (|valid1#sm| this@@9)))
 :qid |stdinbpl.190:15|
 :skolemid |22|
 :pattern ( (PredicateMaskField (valid1 this@@9)))
)))
...
(assert  (and (and (= (type Heap@@11) (MapType0Type RefType)) (= (type this@@11) RefType)) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |valid1#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@11 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@11 this@@11 $allocated)) (not (= this@@11 null))) (and (= Mask@0 (MapType1Store ZeroMask this@@11 root (real_2_U (+ (U_2_real (MapType1Select ZeroMask this@@11 root)) FullPerm)))) (state Heap@@11 Mask@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 this@@11 root)) (=> (HasDirectPerm Mask@0 this@@11 root) (=> (and (= perm@0 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@0 NoPerm))))))))
