...
(assert  (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type c) RefType)) (= (type freshObj@0) RefType)) (= (type Heap@0) (MapType0Type RefType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id separately)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 c $allocated))) (=> (and (and (and (and (not (= freshObj@0 null)) (not (U_2_bool (MapType0Select Heap@@9 freshObj@0 $allocated)))) (= Heap@0 (MapType0Store Heap@@9 freshObj@0 $allocated (bool_2_U true)))) (and (state Heap@0 ZeroMask) (not (= freshObj@0 null)))) (and (and (= Mask@0 (MapType1Store ZeroMask freshObj@0 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask freshObj@0 f_7)) FullPerm)))) (state Heap@0 Mask@0)) (and (state Heap@0 Mask@0) (state Heap@0 Mask@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 freshObj@0 f_7)) (=> (HasDirectPerm Mask@0 freshObj@0 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (not (= (MapType0Select Heap@0 freshObj@0 f_7) freshObj@0)))))))))
