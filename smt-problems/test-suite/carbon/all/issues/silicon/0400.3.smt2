...
(set-info :boogie-vc-id test_take_index_01)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= a_2@0 (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 1)) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 5))) (|Seq#Singleton| (int_2_U 7))) (|Seq#Singleton| (int_2_U 8)))) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< 3 (|Seq#Length| (|Seq#Take| a_2@0 10)))) (=> (< 3 (|Seq#Length| (|Seq#Take| a_2@0 10))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int (|Seq#Index| (|Seq#Take| a_2@0 10) 3)) 7))))))))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= a_2@0 (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Append| (|Seq#Singleton| (int_2_U 1)) (|Seq#Singleton| (int_2_U 4))) (|Seq#Singleton| (int_2_U 5))) (|Seq#Singleton| (int_2_U 7))) (|Seq#Singleton| (int_2_U 8)))) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (|Seq#Length| (|Seq#Drop| (|Seq#Take| a_2@0 2) 2)) 0)) (=> (= (|Seq#Length| (|Seq#Drop| (|Seq#Take| a_2@0 2) 2)) 0) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (|Seq#Length| (|Seq#Drop| (|Seq#Take| a_2@0 2) 3)) 0)) (=> (= (|Seq#Length| (|Seq#Drop| (|Seq#Take| a_2@0 2) 3)) 0) (=> (and (state Heap@@9 ZeroMask) (<= 0 e2)) (=> (and (and (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (<= e2 e1) (state Heap@@9 ZeroMask))) (and (and (state Heap@@9 ZeroMask) (<= e1 5)) (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (|Seq#Length| (|Seq#Drop| (|Seq#Take| a_2@0 e2) e1)) 0)) (=> (= (|Seq#Length| (|Seq#Drop| (|Seq#Take| a_2@0 e2) e1)) 0) (=> (state Heap@@9 ZeroMask) (=> (and (and (<= e4 e3) (state Heap@@9 ZeroMask)) (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 2) (- 0 1)))) (= (|Seq#Length| (|Seq#Drop| (|Seq#Take| a_2@0 e4) e3)) 0))))))))))))))))
