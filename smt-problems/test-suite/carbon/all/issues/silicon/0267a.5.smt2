...
(assert  (and (= (type Result@0) RefType) (= (type Heap@@39) (MapType0Type RefType))))
...
(let ((anon18_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (= Result@0 (ite (bool___unbox__ Heap@@39 (ANOTHER_GLOBAL_VAR Heap@@39)) (OTHER_GLOBAL_VAR Heap@@39) (__prim__int___box__ Heap@@39 44))))))
(let ((anon26_Then_correct  (=> (bool___unbox__ Heap@@39 (ANOTHER_GLOBAL_VAR Heap@@39)) (and (=> (= (ControlFlow 0 11) 10) anon27_Then_correct) (=> (= (ControlFlow 0 11) 8) anon18_correct)))))
(let ((anon28_Then_correct true))
(let ((anon26_Else_correct  (=> (not (bool___unbox__ Heap@@39 (ANOTHER_GLOBAL_VAR Heap@@39))) (and (=> (= (ControlFlow 0 9) 6) anon28_Then_correct) (=> (= (ControlFlow 0 9) 8) anon18_correct)))))
(let ((anon25_Then_correct true))
(let ((anon24_Then_correct true))
(let ((anon9_correct  (=> (= Result@0 (ite (bool___unbox__ Heap@@39 (ANOTHER_GLOBAL_VAR Heap@@39)) (OTHER_GLOBAL_VAR Heap@@39) (__prim__int___box__ Heap@@39 44))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (issubtype (typeof Result@0) vint)) (=> (issubtype (typeof Result@0) vint) (and (and (and (=> (= (ControlFlow 0 12) 4) anon24_Then_correct) (=> (= (ControlFlow 0 12) 5) anon25_Then_correct)) (=> (= (ControlFlow 0 12) 11) anon26_Then_correct)) (=> (= (ControlFlow 0 12) 9) anon26_Else_correct)))))))
(let ((anon21_Then_correct  (=> (bool___unbox__ Heap@@39 (ANOTHER_GLOBAL_VAR Heap@@39)) (and (=> (= (ControlFlow 0 16) 15) anon22_Then_correct) (=> (= (ControlFlow 0 16) 12) anon9_correct)))))
(let ((anon23_Then_correct true))
(let ((anon21_Else_correct  (=> (not (bool___unbox__ Heap@@39 (ANOTHER_GLOBAL_VAR Heap@@39))) (and (=> (= (ControlFlow 0 14) 3) anon23_Then_correct) (=> (= (ControlFlow 0 14) 12) anon9_correct)))))
(let ((anon20_Then_correct true))
(let ((anon19_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@39 ZeroMask) (= AssumeFunctionsAbove 0)) (and (and (and (=> (= (ControlFlow 0 17) 1) anon19_Then_correct) (=> (= (ControlFlow 0 17) 2) anon20_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon21_Then_correct)) (=> (= (ControlFlow 0 17) 14) anon21_Else_correct)))))
