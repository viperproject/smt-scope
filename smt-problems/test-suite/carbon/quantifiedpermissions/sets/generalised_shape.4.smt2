...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (= (type x2_2) RefType) (= (type x1_2) RefType)) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Heap@@10) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@48 T@U) ) (! (= (type (invRecv21 arg0@@48)) RefType)
 :qid |funType:invRecv21|
 :pattern ( (invRecv21 arg0@@48))
))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type x_14) RefType)) (= (type QPMask@2) (MapType1Type RefType realType))) (forall ((arg0@@49 T@U) ) (! (= (type (invRecv19 arg0@@49)) RefType)
 :qid |funType:invRecv19|
 :pattern ( (invRecv19 arg0@@49))
))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test15)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((anon6_correct true))
(let ((anon12_Else_correct  (=> (and (not (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_14))) (= (ControlFlow 0 17) 14)) anon6_correct)))
(let ((anon12_Then_correct  (=> (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_14)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (HasDirectPerm QPMask@2 x_14 g)) (=> (HasDirectPerm QPMask@2 x_14 g) (=> (= (ControlFlow 0 15) 14) anon6_correct))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 13) (- 0 12)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_3))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_3_1))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= (MapType0Select PostHeap@0 x_3 g) (MapType0Select PostHeap@0 x_3_1 g)))))
...
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 21)) (forall ((x_1 T@U) (x_1_1 T@U) ) (!  (=> (and (= (type x_1) RefType) (= (type x_1_1) RefType)) (=> (and (and (and (and (not (= x_1 x_1_1)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_1))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_1_1))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_1 x_1_1))))
 :qid |stdinbpl.1894:15|
 :skolemid |206|
 :no-pattern (type x_1)
...
))) (=> (forall ((x_1@@0 T@U) (x_1_1@@0 T@U) ) (!  (=> (and (= (type x_1@@0) RefType) (= (type x_1_1@@0) RefType)) (=> (and (and (and (and (not (= x_1@@0 x_1_1@@0)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_1@@0))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_1_1@@0))) (< NoPerm wildcard)) (< NoPerm wildcard)) (not (= x_1@@0 x_1_1@@0))))
 :qid |stdinbpl.1894:15|
 :skolemid |206|
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (and (= (type x_1@@1) RefType) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_1@@1))) (and (qpRange19 x_1@@1) (= (invRecv19 x_1@@1) x_1@@1)))
 :qid |stdinbpl.1900:22|
 :skolemid |207|
 :pattern ( (MapType0Select PostHeap@0 x_1@@1 g))
 :pattern ( (MapType1Select QPMask@2 x_1@@1 g))
 :pattern ( (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_1@@1))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) (invRecv19 o_3))) (qpRange19 o_3)) (= (invRecv19 o_3) o_3)))
 :qid |stdinbpl.1904:22|
 :skolemid |208|
 :pattern ( (invRecv19 o_3))
)) (forall ((x_1@@2 T@U) ) (!  (=> (and (= (type x_1@@2) RefType) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_1@@2))) (not (= x_1@@2 null)))
 :qid |stdinbpl.1910:22|
 :skolemid |209|
 :pattern ( (MapType0Select PostHeap@0 x_1@@2 g))
 :pattern ( (MapType1Select QPMask@2 x_1@@2 g))
 :pattern ( (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_1@@2))
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) (invRecv19 o_3@@0))) (qpRange19 o_3@@0)) (and (= (invRecv19 o_3@@0) o_3@@0) (< (U_2_real (MapType1Select ZeroMask o_3@@0 g)) (U_2_real (MapType1Select QPMask@2 o_3@@0 g))))) (=> (not (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) (invRecv19 o_3@@0))) (qpRange19 o_3@@0))) (= (U_2_real (MapType1Select QPMask@2 o_3@@0 g)) (U_2_real (MapType1Select ZeroMask o_3@@0 g))))))
 :qid |stdinbpl.1916:22|
 :skolemid |210|
 :pattern ( (MapType1Select QPMask@2 o_3@@0 g))
)) (forall ((o_3@@1 T@U) (f_5 T@U) ) (! (let ((B@@11 (FieldTypeInv1 (type f_5))))
(let ((A@@12 (FieldTypeInv0 (type f_5))))
 (=> (and (and (= (type o_3@@1) RefType) (= (type f_5) (FieldType A@@12 B@@11))) (not (= f_5 g))) (= (U_2_real (MapType1Select ZeroMask o_3@@1 f_5)) (U_2_real (MapType1Select QPMask@2 o_3@@1 f_5))))))
 :qid |stdinbpl.1920:29|
 :skolemid |211|
 :pattern ( (MapType1Select ZeroMask o_3@@1 f_5))
 :pattern ( (MapType1Select QPMask@2 o_3@@1 f_5))
))) (and (state PostHeap@0 QPMask@2) (state PostHeap@0 QPMask@2))) (and (=> (= (ControlFlow 0 18) (- 0 20)) (HasDirectPerm QPMask@2 x1_2 g)) (=> (HasDirectPerm QPMask@2 x1_2 g) (and (=> (= (ControlFlow 0 18) (- 0 19)) (HasDirectPerm QPMask@2 x2_2 g)) (=> (HasDirectPerm QPMask@2 x2_2 g) (=> (and (not (= (MapType0Select PostHeap@0 x1_2 g) (MapType0Select PostHeap@0 x2_2 g))) (state PostHeap@0 QPMask@2)) (and (and (=> (= (ControlFlow 0 18) 13) anon11_Else_correct) (=> (= (ControlFlow 0 18) 15) anon12_Then_correct)) (=> (= (ControlFlow 0 18) 17) anon12_Else_correct))))))))))))))
(let ((anon10_Then_correct true))
(let ((anon9_Then_correct  (=> (state PostHeap@0 ZeroMask) (and (=> (= (ControlFlow 0 22) 11) anon10_Then_correct) (=> (= (ControlFlow 0 22) 18) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (> wildcard@0 0.0) (and (=> (= (ControlFlow 0 2) (- 0 10)) (forall ((x_4 T@U) ) (!  (=> (and (= (type x_4) RefType) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_4))) (> (U_2_real (MapType1Select Mask@3 x_4 g)) NoPerm))
 :qid |stdinbpl.1990:15|
 :skolemid |218|
 :no-pattern (type x_4)
 :no-pattern (U_2_int x_4)
 :no-pattern (U_2_bool x_4)
))) (=> (forall ((x_4@@0 T@U) ) (!  (=> (and (= (type x_4@@0) RefType) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_4@@0))) (> (U_2_real (MapType1Select Mask@3 x_4@@0 g)) NoPerm))
 :qid |stdinbpl.1990:15|
 :skolemid |218|
 :no-pattern (type x_4@@0)
 :no-pattern (U_2_int x_4@@0)
 :no-pattern (U_2_bool x_4@@0)
)) (=> (forall ((x_4@@1 T@U) ) (!  (=> (and (= (type x_4@@1) RefType) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_4@@1))) (< wildcard@0 (U_2_real (MapType1Select Mask@3 x_4@@1 g))))
 :qid |stdinbpl.1994:20|
 :skolemid |219|
 :no-pattern (type x_4@@1)
 :no-pattern (U_2_int x_4@@1)
 :no-pattern (U_2_bool x_4@@1)
)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (forall ((x_4@@2 T@U) ) (!  (=> (= (type x_4@@2) RefType) (=> (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_4@@2)) (dummyFunction (MapType0Select Heap@@10 x_4@@2 g))) (>= wildcard@0 NoPerm)))
 :qid |stdinbpl.2001:17|
 :skolemid |220|
 :pattern ( (MapType0Select Heap@@10 x_4@@2 g))
 :pattern ( (MapType1Select QPMask@0 x_4@@2 g))
 :pattern ( (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_4@@2))
))) (=> (forall ((x_4@@3 T@U) ) (!  (=> (= (type x_4@@3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_4@@3)) (dummyFunction (MapType0Select Heap@@10 x_4@@3 g))) (>= wildcard@0 NoPerm)))
 :qid |stdinbpl.2001:17|
 :skolemid |220|
 :pattern ( (MapType0Select Heap@@10 x_4@@3 g))
 :pattern ( (MapType1Select QPMask@0 x_4@@3 g))
 :pattern ( (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_4@@3))
)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (forall ((x_4@@4 T@U) (x_4_1 T@U) ) (!  (=> (and (= (type x_4@@4) RefType) (= (type x_4_1) RefType)) (=> (and (and (and (and (not (= x_4@@4 x_4_1)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_4@@4))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_4_1))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_4@@4 x_4_1))))
 :qid |stdinbpl.2008:17|
 :skolemid |221|
 :pattern ( (neverTriggered21 x_4@@4) (neverTriggered21 x_4_1))
))) (=> (forall ((x_4@@5 T@U) (x_4_1@@0 T@U) ) (!  (=> (and (= (type x_4@@5) RefType) (= (type x_4_1@@0) RefType)) (=> (and (and (and (and (not (= x_4@@5 x_4_1@@0)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_4@@5))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_4_1@@0))) (< NoPerm wildcard@0)) (< NoPerm wildcard@0)) (not (= x_4@@5 x_4_1@@0))))
 :qid |stdinbpl.2008:17|
 :skolemid |221|
 :pattern ( (neverTriggered21 x_4@@5) (neverTriggered21 x_4_1@@0))
)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (forall ((x_4@@6 T@U) ) (!  (=> (and (= (type x_4@@6) RefType) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_4@@6))) (> (U_2_real (MapType1Select Mask@3 x_4@@6 g)) NoPerm))
 :qid |stdinbpl.2015:17|
 :skolemid |222|
 :pattern ( (MapType0Select Heap@@10 x_4@@6 g))
 :pattern ( (MapType1Select QPMask@0 x_4@@6 g))
 :pattern ( (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_4@@6))
))) (=> (forall ((x_4@@7 T@U) ) (!  (=> (and (= (type x_4@@7) RefType) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_4@@7))) (> (U_2_real (MapType1Select Mask@3 x_4@@7 g)) NoPerm))
 :qid |stdinbpl.2015:17|
 :skolemid |222|
 :pattern ( (MapType0Select Heap@@10 x_4@@7 g))
 :pattern ( (MapType1Select QPMask@0 x_4@@7 g))
 :pattern ( (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_4@@7))
)) (=> (and (and (forall ((x_4@@8 T@U) ) (!  (=> (= (type x_4@@8) RefType) (=> (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_4@@8)) (< NoPerm wildcard@0)) (and (qpRange21 x_4@@8) (= (invRecv21 x_4@@8) x_4@@8))))
 :qid |stdinbpl.2021:22|
 :skolemid |223|
 :pattern ( (MapType0Select Heap@@10 x_4@@8 g))
 :pattern ( (MapType1Select QPMask@0 x_4@@8 g))
 :pattern ( (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_4@@8))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) (invRecv21 o_3@@2))) (and (< NoPerm wildcard@0) (qpRange21 o_3@@2))) (= (invRecv21 o_3@@2) o_3@@2)))
 :qid |stdinbpl.2025:22|
 :skolemid |224|
 :pattern ( (invRecv21 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) (invRecv21 o_3@@3))) (and (< NoPerm wildcard@0) (qpRange21 o_3@@3))) (and (= (invRecv21 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 g)) (- (U_2_real (MapType1Select Mask@3 o_3@@3 g)) wildcard@0)))) (=> (not (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) (invRecv21 o_3@@3))) (and (< NoPerm wildcard@0) (qpRange21 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 g)) (U_2_real (MapType1Select Mask@3 o_3@@3 g))))))
 :qid |stdinbpl.2031:22|
 :skolemid |225|
 :pattern ( (MapType1Select QPMask@0 o_3@@3 g))
)) (forall ((o_3@@4 T@U) (f_5@@0 T@U) ) (! (let ((B@@12 (FieldTypeInv1 (type f_5@@0))))
(let ((A@@13 (FieldTypeInv0 (type f_5@@0))))
 (=> (and (and (= (type o_3@@4) RefType) (= (type f_5@@0) (FieldType A@@13 B@@12))) (not (= f_5@@0 g))) (= (U_2_real (MapType1Select Mask@3 o_3@@4 f_5@@0)) (U_2_real (MapType1Select QPMask@0 o_3@@4 f_5@@0))))))
 :qid |stdinbpl.2037:29|
 :skolemid |226|
 :pattern ( (MapType1Select QPMask@0 o_3@@4 f_5@@0))
)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (not (= (MapType0Select Heap@@10 x1_2 g) (MapType0Select Heap@@10 x2_2 g)))) (=> (not (= (MapType0Select Heap@@10 x1_2 g) (MapType0Select Heap@@10 x2_2 g))) (=> (> wildcard@1 0.0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall ((x_5 T@U) ) (!  (=> (and (= (type x_5) RefType) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_5))) (> (U_2_real (MapType1Select QPMask@0 (MapType0Select Heap@@10 x_5 g) f_7)) NoPerm))
 :qid |stdinbpl.2048:15|
 :skolemid |227|
 :no-pattern (type x_5)
 :no-pattern (U_2_int x_5)
 :no-pattern (U_2_bool x_5)
))) (=> (forall ((x_5@@0 T@U) ) (!  (=> (and (= (type x_5@@0) RefType) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_5@@0))) (> (U_2_real (MapType1Select QPMask@0 (MapType0Select Heap@@10 x_5@@0 g) f_7)) NoPerm))
 :qid |stdinbpl.2048:15|
 :skolemid |227|
 :no-pattern (type x_5@@0)
 :no-pattern (U_2_int x_5@@0)
 :no-pattern (U_2_bool x_5@@0)
)) (=> (forall ((x_5@@1 T@U) ) (!  (=> (and (= (type x_5@@1) RefType) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_5@@1))) (< wildcard@1 (U_2_real (MapType1Select QPMask@0 (MapType0Select Heap@@10 x_5@@1 g) f_7))))
 :qid |stdinbpl.2052:20|
 :skolemid |228|
 :no-pattern (type x_5@@1)
 :no-pattern (U_2_int x_5@@1)
 :no-pattern (U_2_bool x_5@@1)
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((x_5@@2 T@U) ) (!  (=> (= (type x_5@@2) RefType) (=> (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_5@@2)) (dummyFunction (MapType0Select Heap@@10 (MapType0Select Heap@@10 x_5@@2 g) f_7))) (>= wildcard@1 NoPerm)))
 :qid |stdinbpl.2059:17|
 :skolemid |229|
 :pattern ( (MapType0Select Heap@@10 x_5@@2 g))
 :pattern ( (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_5@@2))
))) (=> (forall ((x_5@@3 T@U) ) (!  (=> (= (type x_5@@3) RefType) (=> (and (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_5@@3)) (dummyFunction (MapType0Select Heap@@10 (MapType0Select Heap@@10 x_5@@3 g) f_7))) (>= wildcard@1 NoPerm)))
 :qid |stdinbpl.2059:17|
 :skolemid |229|
 :pattern ( (MapType0Select Heap@@10 x_5@@3 g))
 :pattern ( (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_5@@3))
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((x_5@@4 T@U) (x_5_1 T@U) ) (!  (=> (and (= (type x_5@@4) RefType) (= (type x_5_1) RefType)) (=> (and (and (and (and (not (= x_5@@4 x_5_1)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_5@@4))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_5_1))) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= (MapType0Select Heap@@10 x_5@@4 g) (MapType0Select Heap@@10 x_5_1 g)))))
 :qid |stdinbpl.2066:17|
 :skolemid |230|
 :pattern ( (neverTriggered22 x_5@@4) (neverTriggered22 x_5_1))
))) (=> (forall ((x_5@@5 T@U) (x_5_1@@0 T@U) ) (!  (=> (and (= (type x_5@@5) RefType) (= (type x_5_1@@0) RefType)) (=> (and (and (and (and (not (= x_5@@5 x_5_1@@0)) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_5@@5))) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_5_1@@0))) (< NoPerm wildcard@1)) (< NoPerm wildcard@1)) (not (= (MapType0Select Heap@@10 x_5@@5 g) (MapType0Select Heap@@10 x_5_1@@0 g)))))
 :qid |stdinbpl.2066:17|
 :skolemid |230|
 :pattern ( (neverTriggered22 x_5@@5) (neverTriggered22 x_5_1@@0))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((x_5@@6 T@U) ) (!  (=> (and (= (type x_5@@6) RefType) (U_2_bool (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_5@@6))) (> (U_2_real (MapType1Select QPMask@0 (MapType0Select Heap@@10 x_5@@6 g) f_7)) NoPerm))
 :qid |stdinbpl.2073:17|
 :skolemid |231|
 :pattern ( (MapType0Select Heap@@10 x_5@@6 g))
 :pattern ( (MapType2Select (|Set#UnionOne| (|Set#Singleton| x2_2) x1_2) x_5@@6))
))))))))))))))))))))))))))
(let ((anon0_correct  (=> (and (state Heap@@10 ZeroMask) (U_2_bool (MapType0Select Heap@@10 x1_2 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@10 x2_2 $allocated)) (not (= x1_2 null))) (and (= Mask@0 (MapType1Store ZeroMask x1_2 g (real_2_U (+ (U_2_real (MapType1Select ZeroMask x1_2 g)) FullPerm)))) (state Heap@@10 Mask@0))) (and (=> (= (ControlFlow 0 23) (- 0 27)) (HasDirectPerm Mask@0 x1_2 g)) (=> (HasDirectPerm Mask@0 x1_2 g) (=> (= perm@0 (/ (to_real 2) (to_real 3))) (and (=> (= (ControlFlow 0 23) (- 0 26)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= (MapType0Select Heap@@10 x1_2 g) null))) (=> (and (= Mask@1 (MapType1Store Mask@0 (MapType0Select Heap@@10 x1_2 g) f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 (MapType0Select Heap@@10 x1_2 g) f_7)) perm@0)))) (state Heap@@10 Mask@1)) (=> (and (and (state Heap@@10 Mask@1) (not (= x2_2 null))) (and (= Mask@2 (MapType1Store Mask@1 x2_2 g (real_2_U (+ (U_2_real (MapType1Select Mask@1 x2_2 g)) FullPerm)))) (state Heap@@10 Mask@2))) (and (=> (= (ControlFlow 0 23) (- 0 25)) (HasDirectPerm Mask@2 x2_2 g)) (=> (HasDirectPerm Mask@2 x2_2 g) (=> (= perm@1 (/ (to_real 2) (to_real 3))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (and (and (=> (> perm@1 NoPerm) (not (= (MapType0Select Heap@@10 x2_2 g) null))) (= Mask@3 (MapType1Store Mask@2 (MapType0Select Heap@@10 x2_2 g) f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@2 (MapType0Select Heap@@10 x2_2 g) f_7)) perm@1))))) (and (state Heap@@10 Mask@3) (state Heap@@10 Mask@3))) (and (=> (= (ControlFlow 0 23) 22) anon9_Then_correct) (=> (= (ControlFlow 0 23) 2) anon9_Else_correct))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (> wildcard 0.0) true) (= (ControlFlow 0 28) 23)) anon0_correct)))
