...
(declare-fun j_2 () Int)
(declare-fun j@@5 () Int)
(assert  (and (= (type a_2) (SeqType intType)) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id m)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 34) (let ((anon25_correct true))
(let ((anon40_Else_correct  (=> (and (not (|Seq#Contains| a_2 (int_2_U j_11))) (= (ControlFlow 0 25) 22)) anon25_correct)))
(let ((anon40_Then_correct  (=> (|Seq#Contains| a_2 (int_2_U j_11)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (exists ((k_3 T@U) ) (!  (and (= (type k_3) intType) (and (|Seq#Contains| a_2 k_3) (> (U_2_int k_3) 0)))
 :qid |stdinbpl.664:19|
 :skolemid |64|
 :pattern ( (|Seq#ContainsTrigger| a_2 k_3))
 :pattern ( (|Seq#Contains| a_2 k_3))
))) (=> (exists ((k_3@@0 Int) ) (!  (and (|Seq#Contains| a_2 (int_2_U k_3@@0)) (> k_3@@0 0))
 :qid |stdinbpl.664:19|
 :skolemid |64|
 :pattern ( (|Seq#ContainsTrigger| a_2 (int_2_U k_3@@0)))
 :pattern ( (|Seq#Contains| a_2 (int_2_U k_3@@0)))
)) (=> (= (ControlFlow 0 23) 22) anon25_correct))))))
(let ((anon38_Then_correct true))
(let ((anon21_correct true))
(let ((anon37_Then_correct  (=> (|Seq#Contains| a_2 (int_2_U j_6)) (and (=> (= (ControlFlow 0 21) 20) anon38_Then_correct) (=> (= (ControlFlow 0 21) 18) anon21_correct)))))
(let ((anon37_Else_correct  (=> (and (not (|Seq#Contains| a_2 (int_2_U j_6))) (= (ControlFlow 0 19) 18)) anon21_correct)))
(let ((anon39_Else_correct true))
(let ((anon34_Else_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (exists ((j_9 Int) ) (!  (and (and (<= 0 j_9) (< j_9 (|Seq#Length| a_2))) (> (U_2_int (|Seq#Index| a_2 j_9)) 0))
 :qid |stdinbpl.640:15|
 :skolemid |63|
 :pattern ( (|Seq#Index| a_2 j_9))
))) (=> (exists ((j_9@@0 Int) ) (!  (and (and (<= 0 j_9@@0) (< j_9@@0 (|Seq#Length| a_2))) (> (U_2_int (|Seq#Index| a_2 j_9@@0)) 0))
 :qid |stdinbpl.640:15|
 :skolemid |63|
 :pattern ( (|Seq#Index| a_2 j_9@@0))
)) (=> (state Heap@@9 ZeroMask) (and (and (and (and (=> (= (ControlFlow 0 26) 17) anon39_Else_correct) (=> (= (ControlFlow 0 26) 23) anon40_Then_correct)) (=> (= (ControlFlow 0 26) 25) anon40_Else_correct)) (=> (= (ControlFlow 0 26) 21) anon37_Then_correct)) (=> (= (ControlFlow 0 26) 19) anon37_Else_correct)))))))
(let ((anon16_correct true))
(let ((anon35_Else_correct  (=> (and (not (and (<= 0 j_4) (< j_4 (|Seq#Length| a_2)))) (= (ControlFlow 0 16) 12)) anon16_correct)))
(let ((anon35_Then_correct  (=> (and (<= 0 j_4) (< j_4 (|Seq#Length| a_2))) (and (=> (= (ControlFlow 0 13) (- 0 15)) (>= j_4 0)) (=> (>= j_4 0) (and (=> (= (ControlFlow 0 13) (- 0 14)) (< j_4 (|Seq#Length| a_2))) (=> (< j_4 (|Seq#Length| a_2)) (=> (= (ControlFlow 0 13) 12) anon16_correct))))))))
(let ((anon33_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 29)) (exists ((j_7 T@U) ) (!  (and (= (type j_7) intType) (and (|Seq#Contains| a_2 j_7) (> (U_2_int j_7) 0)))
 :qid |stdinbpl.619:15|
 :skolemid |62|
 :pattern ( (|Seq#ContainsTrigger| a_2 j_7))
 :pattern ( (|Seq#Contains| a_2 j_7))
))) (=> (exists ((j_7@@0 Int) ) (!  (and (|Seq#Contains| a_2 (int_2_U j_7@@0)) (> j_7@@0 0))
 :qid |stdinbpl.619:15|
 :skolemid |62|
 :pattern ( (|Seq#ContainsTrigger| a_2 (int_2_U j_7@@0)))
 :pattern ( (|Seq#Contains| a_2 (int_2_U j_7@@0)))
)) (=> (state Heap@@9 ZeroMask) (and (and (=> (= (ControlFlow 0 28) 26) anon34_Else_correct) (=> (= (ControlFlow 0 28) 13) anon35_Then_correct)) (=> (= (ControlFlow 0 28) 16) anon35_Else_correct)))))))
(let ((anon33_Then_correct true))
(let ((anon30_Else_correct  (=> (and (forall ((j_5 T@U) ) (!  (=> (and (= (type j_5) intType) (|Seq#Contains| a_2 j_5)) (exists ((k_1 Int) ) (!  (and (|Seq#Contains| a_2 (int_2_U k_1)) (> k_1 0))
 :qid |stdinbpl.597:42|
 :skolemid |60|
 :pattern ( (|Seq#ContainsTrigger| a_2 (int_2_U k_1)))
 :pattern ( (|Seq#Contains| a_2 (int_2_U k_1)))
)))
 :qid |stdinbpl.595:20|
 :skolemid |61|
 :pattern ( (|Seq#ContainsTrigger| a_2 j_5))
 :pattern ( (|Seq#Contains| a_2 j_5))
)) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 30) 11) anon33_Then_correct) (=> (= (ControlFlow 0 30) 28) anon33_Else_correct)))))
(let ((anon32_Then_correct true))
(let ((anon10_correct true))
(let ((anon31_Then_correct  (=> (|Seq#Contains| a_2 (int_2_U j_2)) (and (=> (= (ControlFlow 0 10) 9) anon32_Then_correct) (=> (= (ControlFlow 0 10) 7) anon10_correct)))))
(let ((anon31_Else_correct  (=> (and (not (|Seq#Contains| a_2 (int_2_U j_2))) (= (ControlFlow 0 8) 7)) anon10_correct)))
(let ((anon28_Else_correct  (=> (and (exists ((j_3 Int) ) (!  (and (and (<= 0 j_3) (< j_3 (|Seq#Length| a_2))) (> (U_2_int (|Seq#Index| a_2 j_3)) 0))
 :qid |stdinbpl.580:20|
 :skolemid |59|
 :pattern ( (|Seq#Index| a_2 j_3))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 31) 30) anon30_Else_correct) (=> (= (ControlFlow 0 31) 10) anon31_Then_correct)) (=> (= (ControlFlow 0 31) 8) anon31_Else_correct)))))
(let ((anon5_correct true))
(let ((anon29_Else_correct  (=> (and (not (and (<= 0 j@@5) (< j@@5 (|Seq#Length| a_2)))) (= (ControlFlow 0 6) 2)) anon5_correct)))
(let ((anon29_Then_correct  (=> (and (<= 0 j@@5) (< j@@5 (|Seq#Length| a_2))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (>= j@@5 0)) (=> (>= j@@5 0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< j@@5 (|Seq#Length| a_2))) (=> (< j@@5 (|Seq#Length| a_2)) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))))
(let ((anon27_Else_correct  (=> (and (exists ((j_1 Int) ) (!  (and (|Seq#Contains| a_2 (int_2_U j_1)) (> j_1 0))
 :qid |stdinbpl.564:20|
 :skolemid |58|
 :pattern ( (|Seq#ContainsTrigger| a_2 (int_2_U j_1)))
 :pattern ( (|Seq#Contains| a_2 (int_2_U j_1)))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 32) 31) anon28_Else_correct) (=> (= (ControlFlow 0 32) 3) anon29_Then_correct)) (=> (= (ControlFlow 0 32) 6) anon29_Else_correct)))))
(let ((anon27_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 33) 1) anon27_Then_correct) (=> (= (ControlFlow 0 33) 32) anon27_Else_correct)))))
