...
(let ((anon6_Else_correct  (=> (and (= right 0) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (not (= right 0)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (= right 0))) (=> (not (= right 0)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
...
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (= right 0) (>= (mod left right) 0)))))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (>= left 0)) (and (>= right 0) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 8) 7) anon5_Then_correct) (=> (= (ControlFlow 0 8) 2) anon5_Else_correct)))))
