...
(assert  (and (and (and (and (= (type xs) (SeqType RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type ExhaleHeap@0) (MapType0Type RefType))))
(set-info :boogie-vc-id test3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((anon11_correct true))
(let ((anon18_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_12))) (= (ControlFlow 0 22) 18)) anon11_correct)))
(let ((anon18_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_12)) (and (=> (= (ControlFlow 0 19) (- 0 21)) (>= i_12 0)) (=> (>= i_12 0) (and (=> (= (ControlFlow 0 19) (- 0 20)) (< i_12 (|Seq#Length| xs))) (=> (< i_12 (|Seq#Length| xs)) (=> (= (ControlFlow 0 19) 18) anon11_correct))))))))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 17)) (forall ((i_3 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3)) (dummyFunction (MapType0Select Heap@@9 (|Seq#Index| xs i_3) f_7))) (>= (ite (< i_3 2) FullPerm (/ (to_real 1) (to_real 10))) NoPerm))
 ...
 :pattern ( (|Seq#Index| xs i_3))
))) (=> (forall ((i_3@@0 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@0)) (dummyFunction (MapType0Select Heap@@9 (|Seq#Index| xs i_3@@0) f_7))) (>= (ite (< i_3@@0 2) FullPerm (/ (to_real 1) (to_real 10))) NoPerm))
 :qid |stdinbpl.1174:17|
 :skolemid |100|
 ...
 :pattern ( (|Seq#Index| xs i_3@@0))
)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (forall ((i_3@@1 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3@@1 i_3_1)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@1))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3_1))) (< NoPerm (ite (< i_3@@1 2) FullPerm (/ (to_real 1) (to_real 10))))) (< NoPerm (ite (< i_3_1 2) FullPerm (/ (to_real 1) (to_real 10))))) (not (= (|Seq#Index| xs i_3@@1) (|Seq#Index| xs i_3_1))))
 :qid |stdinbpl.1181:17|
 :skolemid |101|
 :pattern ( (neverTriggered7 i_3@@1) (neverTriggered7 i_3_1))
))) (=> (forall ((i_3@@2 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@2 i_3_1@@0)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@2))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3_1@@0))) (< NoPerm (ite (< i_3@@2 2) FullPerm (/ (to_real 1) (to_real 10))))) (< NoPerm (ite (< i_3_1@@0 2) FullPerm (/ (to_real 1) (to_real 10))))) (not (= (|Seq#Index| xs i_3@@2) (|Seq#Index| xs i_3_1@@0))))
 :qid |stdinbpl.1181:17|
 :skolemid |101|
 :pattern ( (neverTriggered7 i_3@@2) (neverTriggered7 i_3_1@@0))
)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((i_3@@3 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@3)) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs i_3@@3) f_7)) (ite (< i_3@@3 2) FullPerm (/ (to_real 1) (to_real 10)))))
 ...
 :pattern ( (|Seq#Index| xs i_3@@3))
))) (=> (forall ((i_3@@4 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@4)) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| xs i_3@@4) f_7)) (ite (< i_3@@4 2) FullPerm (/ (to_real 1) (to_real 10)))))
 :qid |stdinbpl.1188:17|
 :skolemid |102|
 ...
 :pattern ( (|Seq#Index| xs i_3@@4))
)) (=> (forall ((i_3@@5 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_3@@5)) (< NoPerm (ite (< i_3@@5 2) FullPerm (/ (to_real 1) (to_real 10))))) (and (qpRange7 (|Seq#Index| xs i_3@@5)) (= (invRecv7 (|Seq#Index| xs i_3@@5)) i_3@@5)))
 ...
 :pattern ( (|Seq#Index| xs i_3@@5))
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv7 o_3))) (and (< NoPerm (ite (< (invRecv7 o_3) 2) FullPerm (/ (to_real 1) (to_real 10)))) (qpRange7 o_3))) (= (|Seq#Index| xs (invRecv7 o_3)) o_3)))
 :qid |stdinbpl.1198:22|
 :skolemid |104|
 :pattern ( (invRecv7 o_3))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv7 o_3@@0))) (and (< NoPerm (ite (< (invRecv7 o_3@@0) 2) FullPerm (/ (to_real 1) (to_real 10)))) (qpRange7 o_3@@0))) (and (= (|Seq#Index| xs (invRecv7 o_3@@0)) o_3@@0) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (- (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (ite (< (invRecv7 o_3@@0) 2) FullPerm (/ (to_real 1) (to_real 10))))))) (=> (not (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv7 o_3@@0))) (and (< NoPerm (ite (< (invRecv7 o_3@@0) 2) FullPerm (/ (to_real 1) (to_real 10)))) (qpRange7 o_3@@0)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@0 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7))))))
...
)) (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 QPMask@1)) (and (state ExhaleHeap@0 QPMask@1) (= (ControlFlow 0 14) (- 0 13)))) false)))))))))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 23) (- 0 25)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1_1))) (< NoPerm (ite (< i_1 2) FullPerm (/ (to_real 1) (to_real 10))))) (< NoPerm (ite (< i_1_1 2) FullPerm (/ (to_real 1) (to_real 10))))) (not (= (|Seq#Index| xs i_1) (|Seq#Index| xs i_1_1))))
 :qid |stdinbpl.1112:15|
 :skolemid |93|
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@0))) (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1_1@@0))) (< NoPerm (ite (< i_1@@0 2) FullPerm (/ (to_real 1) (to_real 10))))) (< NoPerm (ite (< i_1_1@@0 2) FullPerm (/ (to_real 1) (to_real 10))))) (not (= (|Seq#Index| xs i_1@@0) (|Seq#Index| xs i_1_1@@0))))
 :qid |stdinbpl.1112:15|
 :skolemid |93|
)) (=> (and (forall ((i_1@@1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@1)) (< NoPerm (ite (< i_1@@1 2) FullPerm (/ (to_real 1) (to_real 10))))) (and (qpRange6 (|Seq#Index| xs i_1@@1)) (= (invRecv6 (|Seq#Index| xs i_1@@1)) i_1@@1)))
 ...
 :pattern ( (|Seq#Index| xs i_1@@1))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv6 o_3@@2))) (< NoPerm (ite (< (invRecv6 o_3@@2) 2) FullPerm (/ (to_real 1) (to_real 10))))) (qpRange6 o_3@@2)) (= (|Seq#Index| xs (invRecv6 o_3@@2)) o_3@@2)))
 :qid |stdinbpl.1122:22|
 :skolemid |95|
 :pattern ( (invRecv6 o_3@@2))
))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (forall ((i_1@@2 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@2)) (>= (ite (< i_1@@2 2) FullPerm (/ (to_real 1) (to_real 10))) NoPerm))
 ...
 :pattern ( (|Seq#Index| xs i_1@@2))
))) (=> (forall ((i_1@@3 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@3)) (>= (ite (< i_1@@3 2) FullPerm (/ (to_real 1) (to_real 10))) NoPerm))
 :qid |stdinbpl.1128:15|
 :skolemid |96|
 ...
 :pattern ( (|Seq#Index| xs i_1@@3))
)) (=> (and (forall ((i_1@@4 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1@@4)) (> (ite (< i_1@@4 2) FullPerm (/ (to_real 1) (to_real 10))) NoPerm)) (not (= (|Seq#Index| xs i_1@@4) null)))
 ...
 :pattern ( (|Seq#Index| xs i_1@@4))
)) (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv6 o_3@@3))) (< NoPerm (ite (< (invRecv6 o_3@@3) 2) FullPerm (/ (to_real 1) (to_real 10))))) (qpRange6 o_3@@3)) (and (=> (< NoPerm (ite (< (invRecv6 o_3@@3) 2) FullPerm (/ (to_real 1) (to_real 10)))) (= (|Seq#Index| xs (invRecv6 o_3@@3)) o_3@@3)) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@3 f_7)) (ite (< (invRecv6 o_3@@3) 2) FullPerm (/ (to_real 1) (to_real 10))))))) (=> (not (and (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U (invRecv6 o_3@@3))) (< NoPerm (ite (< (invRecv6 o_3@@3) 2) FullPerm (/ (to_real 1) (to_real 10))))) (qpRange6 o_3@@3))) (= (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@3 f_7))))))
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 23) 14) anon17_Else_correct) (=> (= (ControlFlow 0 23) 19) anon18_Then_correct)) (=> (= (ControlFlow 0 23) 22) anon18_Else_correct)))))))))))
(let ((anon7_correct true))
(let ((anon16_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_11))) (= (ControlFlow 0 12) 8)) anon7_correct)))
(let ((anon16_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_11)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (>= i_11 0)) (=> (>= i_11 0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< i_11 (|Seq#Length| xs))) (=> (< i_11 (|Seq#Length| xs)) (=> (= (ControlFlow 0 9) 8) anon7_correct))))))))
(let ((anon13_Else_correct  (=> (forall ((i1_1 Int) (i2_1 Int) ) (!  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i1_1)) (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i2_1)) (not (= i1_1 i2_1)))) (not (= (|Seq#Index| xs i1_1) (|Seq#Index| xs i2_1))))
 :qid |stdinbpl.1088:20|
 :skolemid |92|
...
)) (=> (and (state Heap@@9 ZeroMask) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 26) 23) anon15_Else_correct) (=> (= (ControlFlow 0 26) 9) anon16_Then_correct)) (=> (= (ControlFlow 0 26) 12) anon16_Else_correct))))))
(let ((anon3_correct true))
(let ((anon14_Else_correct  (=> (and (not (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i1_3)) (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i2_3)) (not (= i1_3 i2_3))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon14_Then_correct  (=> (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i1_3)) (and (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i2_3)) (not (= i1_3 i2_3)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i1_3 0)) (=> (>= i1_3 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i1_3 (|Seq#Length| xs))) (=> (< i1_3 (|Seq#Length| xs)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i2_3 0)) (=> (>= i2_3 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i2_3 (|Seq#Length| xs))) (=> (< i2_3 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (= (|Seq#Length| xs) n@@13) (state Heap@@9 ZeroMask)) (and (> n@@13 2) (state Heap@@9 ZeroMask))) (and (and (=> (= (ControlFlow 0 27) 26) anon13_Else_correct) (=> (= (ControlFlow 0 27) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 27) 7) anon14_Else_correct))))))
