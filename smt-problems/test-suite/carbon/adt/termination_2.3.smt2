...
(assert  (and (= (type Heap@@29) (MapType0Type RefType)) (= (type l@@19) (ListDomainTypeType ValDomainTypeType))))
(set-info :boogie-vc-id lenBad2_termination_proof)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (state Heap@@29 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (decreasing l@@19 l@@19)) (=> (decreasing l@@19 l@@19) (=> (= (ControlFlow 0 2) (- 0 1)) (bounded l@@19)))))))
