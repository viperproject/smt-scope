...
(let ((anon9_Else_correct  (=> (and (not (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i_8)))) (= (ControlFlow 0 11) 8)) anon5_correct)))
(let ((anon9_Then_correct  (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i_8))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i_8)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U i_8))) (=> (= (ControlFlow 0 9) 8) anon5_correct))))))
(let ((anon8_Else_correct  (=> (and (forall ((i_3 T@U) ) (!  (=> (and (= (type i_3) intType) (U_2_bool (MapType0Select (|Map#Domain| m@@23) i_3))) (= (U_2_int (MapType0Select (|Map#Elements| m@@23) i_3)) (+ (U_2_int i_3) 1)))
 :qid |stdinbpl.1315:20|
 :skolemid |123|
 :pattern ( (MapType0Select (|Map#Elements| m@@23) i_3))
)) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 5)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 5))) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 3) (- 0 6)) (not (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 6))))) (=> (not (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 6)))) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 3) (- 0 5)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 5)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@@23) (int_2_U 5))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= (U_2_int (MapType0Select (|Map#Elements| m@@23) (int_2_U 5))) 6)) (=> (= (U_2_int (MapType0Select (|Map#Elements| m@@23) (int_2_U 5))) 6) (=> (and (state Heap@@9 ZeroMask) (= (ControlFlow 0 3) (- 0 2))) (U_2_bool (MapType0Select (|Map#Values| m@@23) (int_2_U 6)))))))))))))))))
(let ((anon7_Else_correct  (=> (and (forall ((i_1 T@U) ) (!  (=> (= (type i_1) intType) (=  (and (<= 2 (U_2_int i_1)) (< (U_2_int i_1) 6)) (U_2_bool (MapType0Select (|Map#Domain| m@@23) i_1))))
 :qid |stdinbpl.1301:20|
 :skolemid |122|
 :pattern ( (MapType0Select (|Map#Domain| m@@23) i_1))
)) (state Heap@@9 ZeroMask)) (and (and (=> (= (ControlFlow 0 12) 3) anon8_Else_correct) (=> (= (ControlFlow 0 12) 9) anon9_Then_correct)) (=> (= (ControlFlow 0 12) 11) anon9_Else_correct)))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 13) 1) anon7_Then_correct) (=> (= (ControlFlow 0 13) 12) anon7_Else_correct)))))
