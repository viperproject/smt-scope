...
(set-info :boogie-vc-id send_body_100)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (and (U_2_bool (MapType0Select Heap@@9 this $allocated)) (<= 0 i_25)) (and (< i_25 (|Seq#Length| ar)) (state Heap@@9 ZeroMask))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= i_25 0)) (=> (>= i_25 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< i_25 (|Seq#Length| ar))) (=> (< i_25 (|Seq#Length| ar)) (=> (and (= perm@0 (/ (to_real 1) (to_real 2))) (= (ControlFlow 0 2) (- 0 1))) (>= perm@0 NoPerm))))))))))
