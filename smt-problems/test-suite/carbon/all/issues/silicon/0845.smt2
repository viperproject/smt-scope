...
(assert  (and (and (= (type QPMask@0) (MapType1Type RefType realType)) (= (type x0@@7) ArrayDomainTypeType)) (= (type Heap@@27) (MapType0Type RefType))))
(set-info :boogie-vc-id main1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon12_correct true))
(let ((anon20_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 17) 14)) anon12_correct)))
(let ((anon20_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (hide0 x0@@7 n@@21 0))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (hide0 x0@@7 n@@21 0)))) (=> (= (ControlFlow 0 15) 14) anon12_correct))))))
(let ((anon19_Then_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (< 0 n@@21)) (=> (< 0 n@@21) (and (=> (= (ControlFlow 0 18) 15) anon20_Then_correct) (=> (= (ControlFlow 0 18) 17) anon20_Else_correct))))))
(let ((anon19_Else_correct  (=> (= (ControlFlow 0 13) (- 0 12)) (= (get0 Heap@@27 x0@@7 n@@21 0) 0))))
(let ((anon15_Else_correct  (=> (and (forall ((j_1 Int) ) (!  (=> (and (<= 0 j_1) (< j_1 n@@21)) (= (get0 Heap@@27 x0@@7 n@@21 j_1) 0))
 :qid |stdinbpl.894:20|
 :skolemid |58|
 :pattern ( (|get0#frame| (MapType0Select Heap@@27 null (hide0 x0@@7 n@@21 j_1)) x0@@7 n@@21 j_1))
)) (state Heap@@27 QPMask@0)) (and (=> (= (ControlFlow 0 20) 18) anon19_Then_correct) (=> (= (ControlFlow 0 20) 13) anon19_Else_correct)))))
(let ((anon7_correct true))
(let ((anon18_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 7) 4)) anon7_correct)))
(let ((anon18_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (hide0 x0@@7 n@@21 j))))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 null (hide0 x0@@7 n@@21 j)))) (=> (= (ControlFlow 0 5) 4) anon7_correct))))))
(let ((anon17_Then_correct  (and (=> (= (ControlFlow 0 8) (- 0 10)) (<= 0 j)) (=> (<= 0 j) (and (=> (= (ControlFlow 0 8) (- 0 9)) (< j n@@21)) (=> (< j n@@21) (and (=> (= (ControlFlow 0 8) 5) anon18_Then_correct) (=> (= (ControlFlow 0 8) 7) anon18_Else_correct))))))))
(let ((anon8_correct true))
(let ((anon16_Then_correct  (=> (and (<= 0 j) (< j n@@21)) (and (=> (= (ControlFlow 0 11) 8) anon17_Then_correct) (=> (= (ControlFlow 0 11) 2) anon8_correct)))))
(let ((anon16_Else_correct  (=> (and (not (and (<= 0 j) (< j n@@21))) (= (ControlFlow 0 3) 2)) anon8_correct)))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((i_1 Int) (i_1_1 Int) ) (!  (=> (and (and (and (and (not (= i_1 i_1_1)) (and (<= 0 i_1) (< i_1 n@@21))) (and (<= 0 i_1_1) (< i_1_1 n@@21))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (or (not (= x0@@7 x0@@7)) (not (= n@@21 n@@21))) (not (= i_1 i_1_1))))
 :qid |stdinbpl.832:17|
 :skolemid |52|
 :pattern ( (neverTriggered1 i_1) (neverTriggered1 i_1_1))
))) (=> (forall ((i_1@@0 Int) (i_1_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_1@@0 i_1_1@@0)) (and (<= 0 i_1@@0) (< i_1@@0 n@@21))) (and (<= 0 i_1_1@@0) (< i_1_1@@0 n@@21))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (or (or (not (= x0@@7 x0@@7)) (not (= n@@21 n@@21))) (not (= i_1@@0 i_1_1@@0))))
 :qid |stdinbpl.832:17|
 :skolemid |52|
 :pattern ( (neverTriggered1 i_1@@0) (neverTriggered1 i_1_1@@0))
)) (=> (and (and (and (forall ((i_1@@1 Int) ) (!  (=> (and (and (<= 0 i_1@@1) (< i_1@@1 n@@21)) (< NoPerm FullPerm)) (and (= (invRecv1 x0@@7 n@@21 i_1@@1) i_1@@1) (qpRange1 x0@@7 n@@21 i_1@@1)))
 :qid |stdinbpl.838:22|
 :skolemid |53|
 :pattern ( (MapType0Select Heap@@27 null (hide0 x0@@7 n@@21 i_1@@1)))
 :pattern ( (MapType1Select ZeroMask null (hide0 x0@@7 n@@21 i_1@@1)))
 :pattern ( (MapType0Select Heap@@27 null (hide0 x0@@7 n@@21 i_1@@1)))
)) (forall ((x@@30 T@U) (n_1_1 Int) (i_2_1 Int) ) (!  (=> (= (type x@@30) ArrayDomainTypeType) (=> (and (and (and (<= 0 (invRecv1 x@@30 n_1_1 i_2_1)) (< (invRecv1 x@@30 n_1_1 i_2_1) n@@21)) (< NoPerm FullPerm)) (qpRange1 x@@30 n_1_1 i_2_1)) (and (and (= x0@@7 x@@30) (= n@@21 n_1_1)) (= (invRecv1 x@@30 n_1_1 i_2_1) i_2_1))))
 :qid |stdinbpl.842:22|
 :skolemid |54|
 :pattern ( (invRecv1 x@@30 n_1_1 i_2_1))
))) (and (forall ((x@@31 T@U) (n_1_1@@0 Int) (i_2_1@@0 Int) ) (!  (=> (= (type x@@31) ArrayDomainTypeType) (=> (and (and (and (<= 0 (invRecv1 x@@31 n_1_1@@0 i_2_1@@0)) (< (invRecv1 x@@31 n_1_1@@0 i_2_1@@0) n@@21)) (< NoPerm FullPerm)) (qpRange1 x@@31 n_1_1@@0 i_2_1@@0)) (and (=> (< NoPerm FullPerm) (and (and (= x0@@7 x@@31) (= n@@21 n_1_1@@0)) (= (invRecv1 x@@31 n_1_1@@0 i_2_1@@0) i_2_1@@0))) (= (U_2_real (MapType1Select QPMask@0 null (hide0 x@@31 n_1_1@@0 i_2_1@@0))) (+ (U_2_real (MapType1Select ZeroMask null (hide0 x@@31 n_1_1@@0 i_2_1@@0))) FullPerm)))))
 :qid |stdinbpl.848:22|
 :skolemid |55|
 :pattern ( (MapType1Select QPMask@0 null (hide0 x@@31 n_1_1@@0 i_2_1@@0)))
...
)))) (and (and (forall ((x@@32 T@U) (n_1_1@@1 Int) (i_2_1@@1 Int) ) (!  (=> (and (= (type x@@32) ArrayDomainTypeType) (not (and (and (and (<= 0 (invRecv1 x@@32 n_1_1@@1 i_2_1@@1)) (< (invRecv1 x@@32 n_1_1@@1 i_2_1@@1) n@@21)) (< NoPerm FullPerm)) (qpRange1 x@@32 n_1_1@@1 i_2_1@@1)))) (= (U_2_real (MapType1Select QPMask@0 null (hide0 x@@32 n_1_1@@1 i_2_1@@1))) (U_2_real (MapType1Select ZeroMask null (hide0 x@@32 n_1_1@@1 i_2_1@@1)))))
 :qid |stdinbpl.858:22|
 :skolemid |57|
 :pattern ( (MapType1Select QPMask@0 null (hide0 x@@32 n_1_1@@1 i_2_1@@1)))
)) (state Heap@@27 QPMask@0)) (and (state Heap@@27 QPMask@0) (state Heap@@27 QPMask@0)))) (and (and (=> (= (ControlFlow 0 21) 20) anon15_Else_correct) (=> (= (ControlFlow 0 21) 11) anon16_Then_correct)) (=> (= (ControlFlow 0 21) 3) anon16_Else_correct)))))))
(let ((anon14_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@27 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (< 10 n@@21) (state Heap@@27 ZeroMask)) (and (= (alen x0@@7) n@@21) (state Heap@@27 ZeroMask))) (and (=> (= (ControlFlow 0 23) 1) anon14_Then_correct) (=> (= (ControlFlow 0 23) 21) anon14_Else_correct))))))
