...
(assert  (and (and (and (and (and (= (type PostHeap@0) (MapType0Type RefType)) (= (type this) RefType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))))
(set-info :boogie-vc-id t1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon4_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 this f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 this f_7)) FullPerm)))) (= (ControlFlow 0 5) (- 0 4))) (= (U_2_int (MapType0Select Heap@@9 this f_7)) (U_2_int (MapType0Select Heap@@9 this f_7))))))
