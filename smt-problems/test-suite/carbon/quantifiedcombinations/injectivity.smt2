...
(assert  (and (and (and (and (and (and (and (and (and (and (= (type xs) (SeqType RefType)) (= (type Heap@@11) (MapType0Type RefType))) (= (type QPMask@1) (MapType1Type RefType realType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@39 T@U) ) (! (= (type (invRecv9 arg0@@39)) RefType)
 :qid |funType:invRecv9|
 :pattern ( (invRecv9 arg0@@39))
))) (= (type y@@2) RefType)) (= (type PostHeap@0) (MapType0Type RefType))) (= (type QPMask@3) (MapType1Type RefType realType))) (forall ((arg0@@40 T@U) ) (! (= (type (invRecv7 arg0@@40)) RefType)
 :qid |funType:invRecv7|
 :pattern ( (invRecv7 arg0@@40))
))) (forall ((arg0@@41 T@U) ) (! (= (type (invRecv6 arg0@@41)) RefType)
 :qid |funType:invRecv6|
 :pattern ( (invRecv6 arg0@@41))
))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test01_2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon12_Else_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((x_5 T@U) (x_5_1 T@U) ) (!  (=> (and (= (type x_5) RefType) (= (type x_5_1) RefType)) (=> (and (and (and (and (not (= x_5 x_5_1)) (|Seq#Contains| xs x_5)) (|Seq#Contains| xs x_5_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y@@2 y@@2))))
 :qid |stdinbpl.1114:17|
 :skolemid |113|
 :pattern ( (neverTriggered8 x_5) (neverTriggered8 x_5_1))
)))))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((x_3 T@U) (x_3_1 T@U) ) (!  (=> (and (= (type x_3) RefType) (= (type x_3_1) RefType)) (=> (and (and (and (and (not (= x_3 x_3_1)) (|Seq#Contains| xs x_3)) (|Seq#Contains| xs x_3_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_3 x_3_1))))
...
)) (=> (and (forall ((x_3@@1 T@U) ) (!  (=> (= (type x_3@@1) RefType) (=> (and (|Seq#Contains| xs x_3@@1) (< NoPerm FullPerm)) (and (qpRange7 x_3@@1) (= (invRecv7 x_3@@1) x_3@@1))))
 :qid |stdinbpl.1079:22|
 :skolemid |108|
 :pattern ( (MapType0Select PostHeap@0 x_3@@1 f_7))
 :pattern ( (MapType1Select QPMask@3 x_3@@1 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs x_3@@1))
 :pattern ( (|Seq#Contains| xs x_3@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| xs (invRecv7 o_3)) (< NoPerm FullPerm)) (qpRange7 o_3)) (= (invRecv7 o_3) o_3)))
 ...
 :skolemid |110|
 :pattern ( (MapType0Select PostHeap@0 x_3@@2 f_7))
 :pattern ( (MapType1Select QPMask@3 x_3@@2 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs x_3@@2))
 :pattern ( (|Seq#Contains| xs x_3@@2))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| xs (invRecv7 o_3@@0)) (< NoPerm FullPerm)) (qpRange7 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv7 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@3 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| xs (invRecv7 o_3@@0)) (< NoPerm FullPerm)) (qpRange7 o_3@@0))) (= (U_2_real (MapType1Select QPMask@3 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
...
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((x_7 T@U) (x_7_1 T@U) ) (!  (=> (and (= (type x_7) RefType) (= (type x_7_1) RefType)) (=> (and (and (and (and (not (= x_7 x_7_1)) (|Seq#Contains| xs x_7)) (|Seq#Contains| xs x_7_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= x_7 x_7_1))))
 :qid |stdinbpl.1161:17|
 :skolemid |119|
 ...
 :qid |stdinbpl.1161:17|
 :skolemid |119|
 :pattern ( (neverTriggered9 x_7@@0) (neverTriggered9 x_7_1@@0))
)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((x_7@@1 T@U) ) (!  (=> (and (= (type x_7@@1) RefType) (|Seq#Contains| xs x_7@@1)) (>= (U_2_real (MapType1Select QPMask@0 x_7@@1 f_7)) FullPerm))
 :qid |stdinbpl.1168:17|
 :skolemid |120|
 :pattern ( (MapType0Select Heap@@11 x_7@@1 f_7))
 :pattern ( (MapType1Select QPMask@1 x_7@@1 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs x_7@@1))
 :pattern ( (|Seq#Contains| xs x_7@@1))
))) (=> (forall ((x_7@@2 T@U) ) (!  (=> (and (= (type x_7@@2) RefType) (|Seq#Contains| xs x_7@@2)) (>= (U_2_real (MapType1Select QPMask@0 x_7@@2 f_7)) FullPerm))
 :qid |stdinbpl.1168:17|
 :skolemid |120|
 :pattern ( (MapType0Select Heap@@11 x_7@@2 f_7))
 :pattern ( (MapType1Select QPMask@1 x_7@@2 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs x_7@@2))
 :pattern ( (|Seq#Contains| xs x_7@@2))
)) (=> (and (and (forall ((x_7@@3 T@U) ) (!  (=> (= (type x_7@@3) RefType) (=> (and (|Seq#Contains| xs x_7@@3) (< NoPerm FullPerm)) (and (qpRange9 x_7@@3) (= (invRecv9 x_7@@3) x_7@@3))))
 :qid |stdinbpl.1174:22|
 :skolemid |121|
 :pattern ( (MapType0Select Heap@@11 x_7@@3 f_7))
 :pattern ( (MapType1Select QPMask@1 x_7@@3 f_7))
 :pattern ( (|Seq#ContainsTrigger| xs x_7@@3))
 :pattern ( (|Seq#Contains| xs x_7@@3))
)) (forall ((o_3@@2 T@U) ) (!  (=> (= (type o_3@@2) RefType) (=> (and (|Seq#Contains| xs (invRecv9 o_3@@2)) (and (< NoPerm FullPerm) (qpRange9 o_3@@2))) (= (invRecv9 o_3@@2) o_3@@2)))
 :qid |stdinbpl.1178:22|
 :skolemid |122|
 :pattern ( (invRecv9 o_3@@2))
))) (and (forall ((o_3@@3 T@U) ) (!  (=> (= (type o_3@@3) RefType) (and (=> (and (|Seq#Contains| xs (invRecv9 o_3@@3)) (and (< NoPerm FullPerm) (qpRange9 o_3@@3))) (and (= (invRecv9 o_3@@3) o_3@@3) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (- (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7)) FullPerm)))) (=> (not (and (|Seq#Contains| xs (invRecv9 o_3@@3)) (and (< NoPerm FullPerm) (qpRange9 o_3@@3)))) (= (U_2_real (MapType1Select QPMask@1 o_3@@3 f_7)) (U_2_real (MapType1Select QPMask@0 o_3@@3 f_7))))))
...
)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((x_8 T@U) (x_8_1 T@U) ) (!  (=> (and (= (type x_8) RefType) (= (type x_8_1) RefType)) (=> (and (and (and (and (not (= x_8 x_8_1)) (|Seq#Contains| xs x_8)) (|Seq#Contains| xs x_8_1)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y@@2 y@@2))))
 :qid |stdinbpl.1202:17|
 :skolemid |125|
 :pattern ( (neverTriggered10 x_8) (neverTriggered10 x_8_1))
))) (=> (forall ((x_8@@0 T@U) (x_8_1@@0 T@U) ) (!  (=> (and (= (type x_8@@0) RefType) (= (type x_8_1@@0) RefType)) (=> (and (and (and (and (not (= x_8@@0 x_8_1@@0)) (|Seq#Contains| xs x_8@@0)) (|Seq#Contains| xs x_8_1@@0)) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= y@@2 y@@2))))
 :qid |stdinbpl.1202:17|
 :skolemid |125|
 :pattern ( (neverTriggered10 x_8@@0) (neverTriggered10 x_8_1@@0))
)) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_8@@1 T@U) ) (!  (=> (and (= (type x_8@@1) RefType) (|Seq#Contains| xs x_8@@1)) (>= (U_2_real (MapType1Select QPMask@1 null (pred1 y@@2))) FullPerm))
 :qid |stdinbpl.1209:17|
 :skolemid |126|
...
)) (=> (forall ((x_1@@1 T@U) ) (!  (=> (= (type x_1@@1) RefType) (=> (and (|Seq#Contains| xs x_1@@1) (< NoPerm FullPerm)) (and (qpRange6 x_1@@1) (= (invRecv6 x_1@@1) x_1@@1))))
...
)) (=> (and (forall ((o_3@@5 T@U) ) (!  (=> (= (type o_3@@5) RefType) (=> (and (and (|Seq#Contains| xs (invRecv6 o_3@@5)) (< NoPerm FullPerm)) (qpRange6 o_3@@5)) (= (invRecv6 o_3@@5) o_3@@5)))
...
))) (=> (and (and (forall ((o_3@@6 T@U) ) (!  (=> (= (type o_3@@6) RefType) (and (=> (and (and (|Seq#Contains| xs (invRecv6 o_3@@6)) (< NoPerm FullPerm)) (qpRange6 o_3@@6)) (and (=> (< NoPerm FullPerm) (= (invRecv6 o_3@@6) o_3@@6)) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (+ (U_2_real (MapType1Select Mask@0 o_3@@6 f_7)) FullPerm)))) (=> (not (and (and (|Seq#Contains| xs (invRecv6 o_3@@6)) (< NoPerm FullPerm)) (qpRange6 o_3@@6))) (= (U_2_real (MapType1Select QPMask@0 o_3@@6 f_7)) (U_2_real (MapType1Select Mask@0 o_3@@6 f_7))))))
...
(let ((A@@14 (FieldTypeInv0 (type f_5@@1))))
 (=> (and (and (= (type o_3@@7) RefType) (= (type f_5@@1) (FieldType A@@14 B@@13))) (not (= f_5@@1 f_7))) (= (U_2_real (MapType1Select Mask@0 o_3@@7 f_5@@1)) (U_2_real (MapType1Select QPMask@0 o_3@@7 f_5@@1))))))
 :qid |stdinbpl.1048:29|
 :skolemid |106|
 :pattern ( (MapType1Select Mask@0 o_3@@7 f_5@@1))
