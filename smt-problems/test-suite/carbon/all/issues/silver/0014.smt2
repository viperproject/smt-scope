...
(assert  (and (= (Ctor PredicateType_vType) 11) (= (type v_2) (FieldType PredicateType_vType FrameTypeType))))
(assert (IsPredicateField v_2))
(assert (= (getPredWandId v_2) 0))
...
(assert (forall ((Heap@@7 T@U) ) (!  (=> (= (type Heap@@7) (MapType0Type RefType)) (|v#everUsed| v_2))
 :qid |stdinbpl.188:15|
 :skolemid |22|
 :pattern ( (|v#trigger| Heap@@7 v_2))
)))
...
(assert (= (type |v#sm|) (FieldType PredicateType_vType (MapType1Type RefType boolType))))
(assert (= (PredicateMaskField v_2) |v#sm|))
