...
(set-info :boogie-vc-id Ref__destroy_check)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((anon3_correct true))
(let ((anon14_Else_correct  (=> (and (not (= (U_2_int (MapType0Select Heap@@9 diz Ref__x)) 0)) (= (ControlFlow 0 24) 21)) anon3_correct)))
(let ((anon14_Then_correct  (=> (= (U_2_int (MapType0Select Heap@@9 diz Ref__x)) 0) (and (=> (= (ControlFlow 0 22) (- 0 23)) (HasDirectPerm PostMask@0 diz Ref__x)) (=> (HasDirectPerm PostMask@0 diz Ref__x) (=> (and (= (U_2_int (MapType0Select PostHeap@0 diz Ref__x)) 1) (= (ControlFlow 0 22) 21)) anon3_correct))))))
(let ((anon13_Then_correct  (=> (state PostHeap@0 ZeroMask) (=> (and (and (not (= diz null)) (= PostMask@0 (MapType1Store ZeroMask diz Ref__x (real_2_U (+ (U_2_real (MapType1Select ZeroMask diz Ref__x)) FullPerm))))) (and (state PostHeap@0 PostMask@0) (state PostHeap@0 PostMask@0))) (and (=> (= (ControlFlow 0 25) (- 0 26)) (HasDirectPerm Mask@0 diz Ref__x)) (=> (HasDirectPerm Mask@0 diz Ref__x) (and (=> (= (ControlFlow 0 25) 22) anon14_Then_correct) (=> (= (ControlFlow 0 25) 24) anon14_Else_correct))))))))
(let ((anon12_correct true))
(let ((anon18_Else_correct  (=> (and (not (= (U_2_int (MapType0Select Heap@@9 diz Ref__x)) 0)) (= (ControlFlow 0 4) 1)) anon12_correct)))
(let ((anon18_Then_correct  (=> (= (U_2_int (MapType0Select Heap@@9 diz Ref__x)) 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (U_2_int (MapType0Select ExhaleHeap@1 diz Ref__x)) 1)) (=> (= (U_2_int (MapType0Select ExhaleHeap@1 diz Ref__x)) 1) (=> (= (ControlFlow 0 2) 1) anon12_correct))))))
(let ((anon10_correct  (=> (= Mask@5 (MapType1Store Mask@4 diz Ref__x (real_2_U (- (U_2_real (MapType1Select Mask@4 diz Ref__x)) FullPerm)))) (and (=> (= (ControlFlow 0 5) 2) anon18_Then_correct) (=> (= (ControlFlow 0 5) 4) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon10_correct)))
(let ((anon17_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@4 diz Ref__x)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@4 diz Ref__x))) (=> (= (ControlFlow 0 6) 5) anon10_correct))))))
(let ((anon8_correct  (=> (= Mask@3 (MapType1Store Mask@2 diz Ref__x (real_2_U (- (U_2_real (MapType1Select Mask@2 diz Ref__x)) FullPerm)))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (>= 0 0)) (=> (>= 0 0) (=> (and (and (and (IdenticalOnKnownLocations ExhaleHeap@0 ExhaleHeap@1 Mask@3) (not (= diz null))) (and (= Mask@4 (MapType1Store Mask@3 diz Ref__x (real_2_U (+ (U_2_real (MapType1Select Mask@3 diz Ref__x)) FullPerm)))) (state ExhaleHeap@1 Mask@4))) (and (and (= (U_2_int (MapType0Select ExhaleHeap@1 diz Ref__x)) (+ (U_2_int (MapType0Select ExhaleHeap@0 diz Ref__x)) 0)) (state ExhaleHeap@1 Mask@4)) (and (state ExhaleHeap@1 Mask@4) (state ExhaleHeap@1 Mask@4)))) (and (=> (= (ControlFlow 0 9) 6) anon17_Then_correct) (=> (= (ControlFlow 0 9) 8) anon17_Else_correct))))))))
(let ((anon16_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 13) 9)) anon8_correct)))
(let ((anon16_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= FullPerm (U_2_real (MapType1Select Mask@2 diz Ref__x)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@2 diz Ref__x))) (=> (= (ControlFlow 0 11) 9) anon8_correct))))))
(let ((anon6_correct  (=> (and (and (and (= Mask@1 (MapType1Store Mask@0 diz Ref__x (real_2_U (- (U_2_real (MapType1Select Mask@0 diz Ref__x)) FullPerm)))) (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 Mask@1)) (and (not (= diz null)) (= Mask@2 (MapType1Store Mask@1 diz Ref__x (real_2_U (+ (U_2_real (MapType1Select Mask@1 diz Ref__x)) FullPerm)))))) (and (and (state ExhaleHeap@0 Mask@2) (= (U_2_int (MapType0Select ExhaleHeap@0 diz Ref__x)) (+ (U_2_int (MapType0Select Heap@@9 diz Ref__x)) 1))) (and (state ExhaleHeap@0 Mask@2) (state ExhaleHeap@0 Mask@2)))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (not (= diz null))) (=> (not (= diz null)) (and (=> (= (ControlFlow 0 14) 11) anon16_Then_correct) (=> (= (ControlFlow 0 14) 13) anon16_Else_correct)))))))
(let ((anon15_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 18) 14)) anon6_correct)))
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= FullPerm (U_2_real (MapType1Select Mask@0 diz Ref__x)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 diz Ref__x))) (=> (= (ControlFlow 0 16) 14) anon6_correct))))))
