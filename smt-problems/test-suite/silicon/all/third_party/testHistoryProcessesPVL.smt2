(get-info :version)
; (:version "4.8.7")
; Started: 2024-11-17 20:09:33
; Silicon.version: 1.1-SNAPSHOT (4d756c79+)
; Input file: /silicon/silver/src/test/resources/all/third_party/testHistoryProcessesPVL.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
; [eval] diz.Ref__x == old(diz.Ref__x)
; [eval] old(diz.Ref__x)
(assert (=
...
; [eval] diz.Ref__x == old(diz.Ref__x) + 1
; [eval] old(diz.Ref__x) + 1
; [eval] old(diz.Ref__x)
(assert (=
...
; [eval] diz.Ref__x == old(diz.Ref__x) + n
; [eval] old(diz.Ref__x) + n
; [eval] old(diz.Ref__x)
(assert (=
...
; [eval] diz.Ref__x == old(diz.Ref__x) + n + m
; [eval] old(diz.Ref__x) + n + m
; [eval] old(diz.Ref__x) + n
; [eval] old(diz.Ref__x)
(assert (=
...
; [eval] diz.Ref__x == old(diz.Ref__x) + n + m + k
; [eval] old(diz.Ref__x) + n + m + k
; [eval] old(diz.Ref__x) + n + m
; [eval] old(diz.Ref__x) + n
; [eval] old(diz.Ref__x)
(assert (=
...
; [eval] old(diz.Ref__x) == 0 ==> diz.Ref__x == 1
; [eval] old(diz.Ref__x) == 0
; [eval] old(diz.Ref__x)
(push) ; 3
(push) ; 4
(set-option :timeout 10)
...
(declare-const Ref__x@109@01 Int)
(declare-const Ref__x_old@110@01 Int)
(declare-const Ref__Integer_value@111@01 Int)
