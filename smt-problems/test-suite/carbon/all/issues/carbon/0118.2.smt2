...
(declare-fun i_4 () Int)
(declare-fun j_2 () Int)
(assert  (and (and (and (= (type S) (SeqType RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type QPMask@0) (MapType1Type RefType realType))) (forall ((arg0@@35 T@U) ) (! (= (type (invRecv2 arg0@@35)) RefType)
 :qid |funType:invRecv2|
 :pattern ( (invRecv2 arg0@@35))
))))
...
(let ((anon15_Else_correct  (=> (and (not (and (<= 0 i_5) (< i_5 (|Seq#Length| S)))) (= (ControlFlow 0 17) 13)) anon9_correct)))
(let ((anon15_Then_correct  (=> (and (<= 0 i_5) (< i_5 (|Seq#Length| S))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (>= i_5 0)) (=> (>= i_5 0) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< i_5 (|Seq#Length| S))) (=> (< i_5 (|Seq#Length| S)) (=> (= (ControlFlow 0 14) 13) anon9_correct))))))))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 12)) (forall ((i_3 Int) ) (!  (=> (and (and (<= 0 i_3) (< i_3 (|Seq#Length| S))) (dummyFunction (MapType0Select Heap@@9 (|Seq#Index| S i_3) f_7))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.799:17|
 :skolemid |73|
 :pattern ( (|Seq#Index| S i_3))
 :pattern ( (|Seq#Index| S i_3))
))) (=> (forall ((i_3@@0 Int) ) (!  (=> (and (and (<= 0 i_3@@0) (< i_3@@0 (|Seq#Length| S))) (dummyFunction (MapType0Select Heap@@9 (|Seq#Index| S i_3@@0) f_7))) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.799:17|
 :skolemid |73|
 :pattern ( (|Seq#Index| S i_3@@0))
 :pattern ( (|Seq#Index| S i_3@@0))
)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((i_3@@1 Int) (i_3_1 Int) ) (!  (=> (and (and (and (and (not (= i_3@@1 i_3_1)) (and (<= 0 i_3@@1) (< i_3@@1 (|Seq#Length| S)))) (and (<= 0 i_3_1) (< i_3_1 (|Seq#Length| S)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index| S i_3@@1) (|Seq#Index| S i_3_1))))
 :qid |stdinbpl.806:17|
 :skolemid |74|
 :pattern ( (neverTriggered3 i_3@@1) (neverTriggered3 i_3_1))
))) (=> (forall ((i_3@@2 Int) (i_3_1@@0 Int) ) (!  (=> (and (and (and (and (not (= i_3@@2 i_3_1@@0)) (and (<= 0 i_3@@2) (< i_3@@2 (|Seq#Length| S)))) (and (<= 0 i_3_1@@0) (< i_3_1@@0 (|Seq#Length| S)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= (|Seq#Index| S i_3@@2) (|Seq#Index| S i_3_1@@0))))
 :qid |stdinbpl.806:17|
 :skolemid |74|
 :pattern ( (neverTriggered3 i_3@@2) (neverTriggered3 i_3_1@@0))
)) (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((i_3@@3 Int) ) (!  (=> (and (<= 0 i_3@@3) (< i_3@@3 (|Seq#Length| S))) (>= (U_2_real (MapType1Select QPMask@0 (|Seq#Index| S i_3@@3) f_7)) (/ (to_real 1) (to_real 2))))
 :qid |stdinbpl.813:17|
 :skolemid |75|
 :pattern ( (|Seq#Index| S i_3@@3))
 :pattern ( (|Seq#Index| S i_3@@3))
)))))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 18) (- 0 20)) (forall ((r_1 T@U) (r_1_1 T@U) ) (!  (=> (and (= (type r_1) RefType) (= (type r_1_1) RefType)) (=> (and (and (and (and (not (= r_1 r_1_1)) (|Seq#Contains| S r_1)) (|Seq#Contains| S r_1_1)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= r_1 r_1_1))))
 :qid |stdinbpl.740:15|
 :skolemid |66|
 :no-pattern (type r_1)
...
))) (=> (forall ((r_1@@0 T@U) (r_1_1@@0 T@U) ) (!  (=> (and (= (type r_1@@0) RefType) (= (type r_1_1@@0) RefType)) (=> (and (and (and (and (not (= r_1@@0 r_1_1@@0)) (|Seq#Contains| S r_1@@0)) (|Seq#Contains| S r_1_1@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (< NoPerm (/ (to_real 1) (to_real 2)))) (not (= r_1@@0 r_1_1@@0))))
 :qid |stdinbpl.740:15|
 :skolemid |66|
...
)) (=> (and (forall ((r_1@@1 T@U) ) (!  (=> (= (type r_1@@1) RefType) (=> (and (|Seq#Contains| S r_1@@1) (< NoPerm (/ (to_real 1) (to_real 2)))) (and (qpRange2 r_1@@1) (= (invRecv2 r_1@@1) r_1@@1))))
 :qid |stdinbpl.746:22|
 :skolemid |67|
 :pattern ( (MapType0Select Heap@@9 r_1@@1 f_7))
 :pattern ( (MapType1Select QPMask@0 r_1@@1 f_7))
 :pattern ( (|Seq#ContainsTrigger| S r_1@@1))
 :pattern ( (|Seq#Contains| S r_1@@1))
)) (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (|Seq#Contains| S (invRecv2 o_3)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_3)) (= (invRecv2 o_3) o_3)))
 :qid |stdinbpl.750:22|
 :skolemid |68|
 :pattern ( (invRecv2 o_3))
))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((r_1@@2 T@U) ) (!  (=> (and (= (type r_1@@2) RefType) (|Seq#Contains| S r_1@@2)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.756:15|
 :skolemid |69|
 :pattern ( (MapType0Select Heap@@9 r_1@@2 f_7))
 :pattern ( (MapType1Select QPMask@0 r_1@@2 f_7))
 :pattern ( (|Seq#ContainsTrigger| S r_1@@2))
 :pattern ( (|Seq#Contains| S r_1@@2))
))) (=> (forall ((r_1@@3 T@U) ) (!  (=> (and (= (type r_1@@3) RefType) (|Seq#Contains| S r_1@@3)) (>= (/ (to_real 1) (to_real 2)) NoPerm))
 :qid |stdinbpl.756:15|
 :skolemid |69|
 :pattern ( (MapType0Select Heap@@9 r_1@@3 f_7))
 :pattern ( (MapType1Select QPMask@0 r_1@@3 f_7))
 :pattern ( (|Seq#ContainsTrigger| S r_1@@3))
 :pattern ( (|Seq#Contains| S r_1@@3))
)) (=> (and (forall ((r_1@@4 T@U) ) (!  (=> (= (type r_1@@4) RefType) (=> (and (|Seq#Contains| S r_1@@4) (> (/ (to_real 1) (to_real 2)) NoPerm)) (not (= r_1@@4 null))))
 :qid |stdinbpl.762:22|
 :skolemid |70|
 :pattern ( (MapType0Select Heap@@9 r_1@@4 f_7))
 :pattern ( (MapType1Select QPMask@0 r_1@@4 f_7))
 :pattern ( (|Seq#ContainsTrigger| S r_1@@4))
 :pattern ( (|Seq#Contains| S r_1@@4))
)) (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (|Seq#Contains| S (invRecv2 o_3@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_3@@0)) (and (=> (< NoPerm (/ (to_real 1) (to_real 2))) (= (invRecv2 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) (/ (to_real 1) (to_real 2)))))) (=> (not (and (and (|Seq#Contains| S (invRecv2 o_3@@0)) (< NoPerm (/ (to_real 1) (to_real 2)))) (qpRange2 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.768:22|
 :skolemid |71|
...
)) (state Heap@@9 QPMask@0)) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 18) 10) anon14_Else_correct) (=> (= (ControlFlow 0 18) 14) anon15_Then_correct)) (=> (= (ControlFlow 0 18) 17) anon15_Else_correct)))))))))))
(let ((anon13_Then_correct true))
(let ((anon11_Else_correct  (=> (and (forall ((i_1 Int) (j_1 Int) ) (!  (=> (and (>= i_1 0) (and (< i_1 (|Seq#Length| S)) (and (>= j_1 0) (and (< j_1 (|Seq#Length| S)) (not (= i_1 j_1)))))) (not (= (|Seq#Index| S i_1) (|Seq#Index| S j_1))))
 :qid |stdinbpl.720:20|
 :skolemid |65|
 :pattern ( (|Seq#Index| S i_1) (|Seq#Index| S j_1))
)) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 21) 8) anon13_Then_correct) (=> (= (ControlFlow 0 21) 18) anon13_Else_correct)))))
(let ((anon3_correct true))
(let ((anon12_Else_correct  (=> (and (not (and (>= i_4 0) (and (< i_4 (|Seq#Length| S)) (and (>= j_2 0) (and (< j_2 (|Seq#Length| S)) (not (= i_4 j_2))))))) (= (ControlFlow 0 7) 1)) anon3_correct)))
(let ((anon12_Then_correct  (=> (and (>= i_4 0) (and (< i_4 (|Seq#Length| S)) (and (>= j_2 0) (and (< j_2 (|Seq#Length| S)) (not (= i_4 j_2)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (>= i_4 0)) (=> (>= i_4 0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< i_4 (|Seq#Length| S))) (=> (< i_4 (|Seq#Length| S)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= j_2 0)) (=> (>= j_2 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< j_2 (|Seq#Length| S))) (=> (< j_2 (|Seq#Length| S)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (and (=> (= (ControlFlow 0 22) 21) anon11_Else_correct) (=> (= (ControlFlow 0 22) 2) anon12_Then_correct)) (=> (= (ControlFlow 0 22) 7) anon12_Else_correct)))))
