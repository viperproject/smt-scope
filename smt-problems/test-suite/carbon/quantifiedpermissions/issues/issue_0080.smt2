...
(let ((anon9_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U x@@11))) (= (ControlFlow 0 8) 4)) anon5_correct)))
(let ((anon9_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U x@@11)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (>= (+ (* a_2 x@@11) b_2) 0)) (=> (>= (+ (* a_2 x@@11) b_2) 0) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< (+ (* a_2 x@@11) b_2) (|Seq#Length| xs))) (=> (< (+ (* a_2 x@@11) b_2) (|Seq#Length| xs)) (=> (= (ControlFlow 0 5) 4) anon5_correct))))))))
(let ((anon8_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((x_3 Int) (x_3_1 Int) ) (!  (=> (and (and (and (and (not (= x_3 x_3_1)) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U x_3))) (|Seq#Contains| (|Seq#Range| 0 (|Seq#Length| xs)) (int_2_U x_3_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= (|Seq#Index| xs (+ (* a_2 x_3) b_2)) (|Seq#Index| xs (+ (* a_2 x_3_1) b_2)))))
 :qid |stdinbpl.595:15|
 :skolemid |58|
)))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (and (and (and (=> (= (ControlFlow 0 9) 1) anon7_Then_correct) (=> (= (ControlFlow 0 9) 3) anon8_Else_correct)) (=> (= (ControlFlow 0 9) 5) anon9_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon9_Else_correct)))))
