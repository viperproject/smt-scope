...
(assert  (and (and (and (and (= (type UnfoldingMask@0) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type x@@22) RefType)) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Heap@@72) (MapType0Type RefType))))
(set-info :boogie-vc-id |funP#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (P x@@22) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P x@@22))) FullPerm)))) (not (= x@@22 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x@@22 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@22 f_7)) FullPerm)))) (state Heap@@72 UnfoldingMask@1)) (and (state Heap@@72 UnfoldingMask@1) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm UnfoldingMask@1 x@@22 f_7)))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P x@@22))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P x@@22)))) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@72 ZeroMask) (U_2_bool (MapType0Select Heap@@72 x@@22 $allocated))) (and (= AssumeFunctionsAbove 6) (= Mask@0 (MapType1Store ZeroMask null (P x@@22) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@22))) FullPerm)))))) (and (and (state Heap@@72 Mask@0) (state Heap@@72 Mask@0)) (and (|P#trigger| Heap@@72 (P x@@22)) (= (MapType0Select Heap@@72 null (P x@@22)) (FrameFragment (MapType0Select Heap@@72 x@@22 f_7)))))) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))
...
(declare-fun Heap@@72 () T@U)
(assert  (and (and (and (and (= (type UnfoldingMask@0) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type x@@22) RefType)) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Heap@@72) (MapType0Type RefType))))
(set-info :boogie-vc-id |funP2#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (P x@@22) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P x@@22))) FullPerm)))) (not (= x@@22 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x@@22 f_7 (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@22 f_7)) FullPerm)))) (state Heap@@72 UnfoldingMask@1)) (and (state Heap@@72 UnfoldingMask@1) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm UnfoldingMask@1 x@@22 f_7)))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P x@@22))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P x@@22)))) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@72 ZeroMask) (U_2_bool (MapType0Select Heap@@72 x@@22 $allocated))) (and (= AssumeFunctionsAbove 0) (= Mask@0 (MapType1Store ZeroMask null (P x@@22) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@22))) FullPerm)))))) (and (and (state Heap@@72 Mask@0) (state Heap@@72 Mask@0)) (and (|P#trigger| Heap@@72 (P x@@22)) (= (MapType0Select Heap@@72 null (P x@@22)) (FrameFragment (MapType0Select Heap@@72 x@@22 f_7)))))) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 7) 6) anon0_correct)))
PreconditionGeneratedEntry_correct))))))
))
(check-sat)
...
(declare-fun Heap@@72 () T@U)
(assert  (and (and (and (= (type Heap@@72) (MapType0Type RefType)) (= (type r_1@@36) RefType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Mask@1) (MapType1Type RefType realType))))
(set-info :boogie-vc-id mNestedFunc3)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon3_correct  (=> (and (= Mask@1 (MapType1Store Mask@0 r_1@@36 f_7 (real_2_U (- (U_2_real (MapType1Select Mask@0 r_1@@36 f_7)) FullPerm)))) (= (ControlFlow 0 5) (- 0 4))) (> (U_2_int (MapType0Select Heap@@72 r_1@@36 f_7)) (- 0 38)))))
(let ((anon6_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 8) 5)) anon3_correct)))
(let ((anon6_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= FullPerm (U_2_real (MapType1Select Mask@0 r_1@@36 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 r_1@@36 f_7))) (=> (= (ControlFlow 0 6) 5) anon3_correct))))))
(let ((anon5_Else_correct  (=> (|isGreaterOne3'| Heap@@72 r_1@@36) (=> (and (state Heap@@72 Mask@0) (state Heap@@72 Mask@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 r_1@@36 f_7)) (=> (HasDirectPerm Mask@0 r_1@@36 f_7) (=> (= (ControlFlow 0 2) (- 0 1)) (> (U_2_int (MapType0Select Heap@@72 r_1@@36 f_7)) 1))))))))
(let ((anon0_correct  (=> (and (state Heap@@72 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (U_2_bool (MapType0Select Heap@@72 r_1@@36 $allocated)) (not (= r_1@@36 null))) (and (= Mask@0 (MapType1Store ZeroMask r_1@@36 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r_1@@36 f_7)) FullPerm)))) (state Heap@@72 Mask@0))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (HasDirectPerm Mask@0 r_1@@36 f_7)) (=> (HasDirectPerm Mask@0 r_1@@36 f_7) (=> (> (U_2_int (MapType0Select Heap@@72 r_1@@36 f_7)) (- 0 20)) (=> (and (state Heap@@72 Mask@0) (state Heap@@72 Mask@0)) (and (and (=> (= (ControlFlow 0 9) 2) anon5_Else_correct) (=> (= (ControlFlow 0 9) 6) anon6_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct))))))))))
...
(set-info :boogie-vc-id mFac3_5)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (= tmp@0 (fac3 Heap@@72 3)) (=> (and (state Heap@@72 ZeroMask) (= (ControlFlow 0 3) (- 0 2))) (= tmp@0 6)))))
