...
(declare-fun i_4_2 () Int)
(declare-fun m@0 () T@U)
(declare-fun Heap@@9 () T@U)
(declare-fun i_1 () Int)
(declare-fun i_5 () Int)
(assert  (and (= (type m@0) (MapType intType intType)) (= (type Heap@@9) (MapType1Type RefType))))
(set-info :boogie-vc-id test8)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon13_correct true))
(let ((anon21_Else_correct  (=> (and (not (or (< i_4_2 1) (> i_4_2 3))) (= (ControlFlow 0 14) 11)) anon13_correct)))
(let ((anon21_Then_correct  (=> (or (< i_4_2 1) (> i_4_2 3)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (not (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U i_4_2))))) (=> (not (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U i_4_2)))) (=> (= (ControlFlow 0 12) 11) anon13_correct))))))
(let ((anon20_Else_correct true))
(let ((anon19_Then_correct true))
(let ((anon17_Else_correct  (=> (and (forall ((i_2_1 T@U) ) (!  (=> (and (= (type i_2_1) intType) (U_2_bool (MapType0Select (|Map#Domain| m@0) i_2_1))) (= (U_2_int (MapType0Select (|Map#Elements| m@0) i_2_1)) (* (U_2_int i_2_1) (U_2_int i_2_1))))
 :qid |stdinbpl.888:20|
 :skolemid |106|
 :pattern ( (MapType0Select (|Map#Elements| m@0) i_2_1))
)) (state Heap@@9 ZeroMask)) (and (=> (= (ControlFlow 0 15) (- 0 19)) (not (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U 0))))) (=> (not (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U 0)))) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 15) (- 0 18)) (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U 1)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U 1))) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 15) (- 0 17)) (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U 2)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U 2))) (=> (state Heap@@9 ZeroMask) (and (=> (= (ControlFlow 0 15) (- 0 16)) (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U 3)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U 3))) (=> (state Heap@@9 ZeroMask) (and (and (and (=> (= (ControlFlow 0 15) 9) anon19_Then_correct) (=> (= (ControlFlow 0 15) 10) anon20_Else_correct)) (=> (= (ControlFlow 0 15) 12) anon21_Then_correct)) (=> (= (ControlFlow 0 15) 14) anon21_Else_correct)))))))))))))))))
(let ((anon7_correct true))
(let ((anon18_Else_correct  (=> (and (not (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U i_1)))) (= (ControlFlow 0 8) 5)) anon7_correct)))
(let ((anon18_Then_correct  (=> (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U i_1))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (= (U_2_int (MapType0Select (|Map#Elements| m@0) (int_2_U i_1))) (* i_1 i_1))) (=> (= (U_2_int (MapType0Select (|Map#Elements| m@0) (int_2_U i_1))) (* i_1 i_1)) (=> (= (ControlFlow 0 6) 5) anon7_correct))))))
(let ((anon3_correct true))
(let ((anon16_Else_correct  (=> (and (not (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U i_5)))) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon16_Then_correct  (=> (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U i_5))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U i_5)))) (=> (U_2_bool (MapType0Select (|Map#Domain| m@0) (int_2_U i_5))) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (state Heap@@9 ZeroMask) (=> (and (= m@0 (|Map#Build| (|Map#Build| (|Map#Build| (|Map#Empty| intType intType) (int_2_U 1) (int_2_U 1)) (int_2_U 2) (int_2_U 4)) (int_2_U 3) (int_2_U 9))) (state Heap@@9 ZeroMask)) (and (and (and (and (=> (= (ControlFlow 0 20) 15) anon17_Else_correct) (=> (= (ControlFlow 0 20) 6) anon18_Then_correct)) (=> (= (ControlFlow 0 20) 8) anon18_Else_correct)) (=> (= (ControlFlow 0 20) 2) anon16_Then_correct)) (=> (= (ControlFlow 0 20) 4) anon16_Else_correct))))))
