...
(assert  (and (and (and (and (and (and (and (and (= (type S) (MapType2Type RefType boolType)) (= (type p_1) RefType)) (= (type QPMask@0) (MapType1Type RefType realType))) (= (type PostHeap@0) (MapType0Type RefType))) (= (type b_2) RefType)) (= (type PostMask@0) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))) (= (type Heap@@9) (MapType0Type RefType))) (forall ((arg0@@43 T@U) ) (! (= (type (invRecv1 arg0@@43)) RefType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon10_correct  (=> (and (= Mask@0 (MapType1Store QPMask@0 b_2 f_7 (real_2_U (- (U_2_real (MapType1Select QPMask@0 b_2 f_7)) FullPerm)))) (= (ControlFlow 0 9) (- 0 8))) (> (U_2_int (MapType0Select Heap@@9 b_2 f_7)) 0))))
(let ((anon15_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 12) 9)) anon10_correct)))
(let ((anon15_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= FullPerm (U_2_real (MapType1Select QPMask@0 b_2 f_7)))) (=> (<= FullPerm (U_2_real (MapType1Select QPMask@0 b_2 f_7))) (=> (= (ControlFlow 0 10) 9) anon10_correct))))))
(let ((anon14_Then_correct  (=> (and (state PostHeap@0 ZeroMask) (not (= b_2 null))) (=> (and (and (= PostMask@0 (MapType1Store ZeroMask b_2 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask b_2 f_7)) FullPerm)))) (state PostHeap@0 PostMask@0)) (and (state PostHeap@0 PostMask@0) (= (ControlFlow 0 7) (- 0 6)))) (HasDirectPerm PostMask@0 b_2 f_7)))))
(let ((anon12_Else_correct  (=> (and (and (forall ((p_1_1 T@U) ) (!  (=> (and (= (type p_1_1) RefType) (U_2_bool (MapType2Select S p_1_1))) (> (U_2_int (MapType0Select Heap@@9 p_1_1 f_7)) 0))
 :qid |stdinbpl.542:20|
 :skolemid |88|
 :pattern ( (MapType2Select S p_1_1))
)) (state Heap@@9 QPMask@0)) (and (U_2_bool (MapType2Select S b_2)) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 13) 7) anon14_Then_correct) (=> (= (ControlFlow 0 13) 10) anon15_Then_correct)) (=> (= (ControlFlow 0 13) 12) anon15_Else_correct)))))
(let ((anon5_correct true))
(let ((anon13_Else_correct  (=> (and (not (U_2_bool (MapType2Select S p_1))) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon13_Then_correct  (=> (U_2_bool (MapType2Select S p_1)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (HasDirectPerm QPMask@0 p_1 f_7)) (=> (HasDirectPerm QPMask@0 p_1 f_7) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (forall ((s_1 T@U) (s_1_1 T@U) ) (!  (=> (and (= (type s_1) RefType) (= (type s_1_1) RefType)) (=> (and (and (and (and (not (= s_1 s_1_1)) (U_2_bool (MapType2Select S s_1))) (U_2_bool (MapType2Select S s_1_1))) (< NoPerm FullPerm)) (< NoPerm FullPerm)) (not (= s_1 s_1_1))))
 :qid |stdinbpl.500:15|
 :skolemid |82|
 :no-pattern (type s_1)
...
)) (=> (and (forall ((o_3 T@U) ) (!  (=> (= (type o_3) RefType) (=> (and (and (U_2_bool (MapType2Select S (invRecv1 o_3))) (< NoPerm FullPerm)) (qpRange1 o_3)) (= (invRecv1 o_3) o_3)))
 :qid |stdinbpl.510:22|
 :skolemid |84|
...
))) (=> (and (and (forall ((o_3@@0 T@U) ) (!  (=> (= (type o_3@@0) RefType) (and (=> (and (and (U_2_bool (MapType2Select S (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0)) (and (=> (< NoPerm FullPerm) (= (invRecv1 o_3@@0) o_3@@0)) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (+ (U_2_real (MapType1Select ZeroMask o_3@@0 f_7)) FullPerm)))) (=> (not (and (and (U_2_bool (MapType2Select S (invRecv1 o_3@@0))) (< NoPerm FullPerm)) (qpRange1 o_3@@0))) (= (U_2_real (MapType1Select QPMask@0 o_3@@0 f_7)) (U_2_real (MapType1Select ZeroMask o_3@@0 f_7))))))
 :qid |stdinbpl.522:22|
 :skolemid |86|
...
))) (and (state Heap@@9 QPMask@0) (state Heap@@9 QPMask@0))) (and (and (=> (= (ControlFlow 0 14) 13) anon12_Else_correct) (=> (= (ControlFlow 0 14) 3) anon13_Then_correct)) (=> (= (ControlFlow 0 14) 5) anon13_Else_correct)))))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 b_2 $allocated))) (and (=> (= (ControlFlow 0 16) 1) anon11_Then_correct) (=> (= (ControlFlow 0 16) 14) anon11_Else_correct)))))
