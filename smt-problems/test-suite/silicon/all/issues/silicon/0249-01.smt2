...
(assert (forall ((other@3@00 Int)) (!
  ...
  :qid |prog./silicon/silver/src/test/resources/all/issues/silicon/0249.vpr@6@12@6@82-aux|)))
(assert (forall ((other@3@00 Int)) (!
  (= (= (int___box__ $Snap.unit other@3@00) result@1@00) (= other@3@00 int@0@00))
  :pattern ((int___box__%limited $Snap.unit other@3@00))
  :qid |prog./silicon/silver/src/test/resources/all/issues/silicon/0249.vpr@6@12@6@82|)))
(pop) ; 1
