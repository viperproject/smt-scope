...
(assert  (and (and (and (and (and (= (type Heap@@9) (MapType0Type RefType)) (= (type Mask@2) (MapType1Type RefType realType))) (= (type x@@8) RefType)) (= (type y@@1) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id test01_p2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon8_correct  (=> (and (and (and (state Heap@@9 Mask@2) b_2) (and (state Heap@@9 Mask@2) (state Heap@@9 Mask@2))) (and (and (= x@@8 y@@1) (state Heap@@9 Mask@2)) (and (state Heap@@9 Mask@2) (= (ControlFlow 0 2) (- 0 1))))) false)))
(let ((anon12_Else_correct  (=> (and (= x@@8 y@@1) (= (ControlFlow 0 6) 2)) anon8_correct)))
(let ((anon12_Then_correct  (=> (not (= x@@8 y@@1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (not b_2)) (=> (not b_2) (=> (state Heap@@9 Mask@2) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= (U_2_real (MapType1Select Mask@2 y@@1 f_7)) NoPerm)) (=> (= (U_2_real (MapType1Select Mask@2 y@@1 f_7)) NoPerm) (=> (and (state Heap@@9 Mask@2) (= (ControlFlow 0 3) 2)) anon8_correct)))))))))
(let ((anon6_correct  (=> (state Heap@@9 Mask@2) (and (=> (= (ControlFlow 0 7) 3) anon12_Then_correct) (=> (= (ControlFlow 0 7) 6) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (not b_2) (= (ControlFlow 0 10) 7)) anon6_correct)))
(let ((anon11_Then_correct  (=> b_2 (and (=> (= (ControlFlow 0 8) (- 0 9)) (= y@@1 x@@8)) (=> (= y@@1 x@@8) (=> (= (ControlFlow 0 8) 7) anon6_correct))))))
(let ((anon4_correct  (=> (state Heap@@9 Mask@2) (=> (and (and (state Heap@@9 Mask@2) (<= (__iar__assume_helper_2 (= x@@8 y@@1)  (and b_2 (= y@@1 y@@1)) (/ (to_real 1) (to_real 3)) (/ (to_real 3) (to_real 16)) (/ (to_real 0) (to_real 16))) (U_2_real (MapType1Select Mask@2 y@@1 f_7)))) (and (state Heap@@9 Mask@2) (state Heap@@9 Mask@2))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (= (U_2_real (MapType1Select Mask@2 x@@8 f_7)) (+ (/ (to_real 1) (to_real 3)) (ite b_2 (/ (to_real 1) (to_real 4)) NoPerm)))) (=> (= (U_2_real (MapType1Select Mask@2 x@@8 f_7)) (+ (/ (to_real 1) (to_real 3)) (ite b_2 (/ (to_real 1) (to_real 4)) NoPerm))) (=> (state Heap@@9 Mask@2) (and (=> (= (ControlFlow 0 11) 8) anon11_Then_correct) (=> (= (ControlFlow 0 11) 10) anon11_Else_correct)))))))))
(let ((anon10_Else_correct  (=> (and (not b_2) (= (ControlFlow 0 14) 11)) anon4_correct)))
(let ((anon10_Then_correct  (=> b_2 (=> (and (<= (__iar__assume_helper_1 (= x@@8 y@@1) (/ (to_real 1) (to_real 3)) (/ (to_real 3) (to_real 16))) (U_2_real (MapType1Select Mask@2 y@@1 f_7))) (= (ControlFlow 0 13) 11)) anon4_correct))))
(let ((anon2_correct  (=> (and (and (state Heap@@9 Mask@2) (<= (/ (to_real 1) (to_real 3)) (U_2_real (MapType1Select Mask@2 x@@8 f_7)))) (and (state Heap@@9 Mask@2) (state Heap@@9 Mask@2))) (and (=> (= (ControlFlow 0 15) 13) anon10_Then_correct) (=> (= (ControlFlow 0 15) 14) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (not b_2) (=> (and (= Mask@2 Mask@0) (= (ControlFlow 0 18) 15)) anon2_correct))))
(let ((anon9_Then_correct  (=> (and b_2 (= perm@1 (/ (to_real 1) (to_real 4)))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (>= perm@1 NoPerm)) (=> (>= perm@1 NoPerm) (=> (=> (> perm@1 NoPerm) (not (= x@@8 null))) (=> (and (= Mask@1 (MapType1Store Mask@0 x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select Mask@0 x@@8 f_7)) perm@1)))) (state Heap@@9 Mask@1)) (=> (and (and (state Heap@@9 Mask@1) (state Heap@@9 Mask@1)) (and (= Mask@2 Mask@1) (= (ControlFlow 0 16) 15))) anon2_correct))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 x@@8 $allocated))) (and (U_2_bool (MapType0Select Heap@@9 y@@1 $allocated)) (= perm@0 (/ (to_real 1) (to_real 3))))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (>= perm@0 NoPerm)) (=> (>= perm@0 NoPerm) (=> (=> (> perm@0 NoPerm) (not (= x@@8 null))) (=> (and (and (= Mask@0 (MapType1Store ZeroMask x@@8 f_7 (real_2_U (+ (U_2_real (MapType1Select ZeroMask x@@8 f_7)) perm@0)))) (state Heap@@9 Mask@0)) (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 19) 16) anon9_Then_correct) (=> (= (ControlFlow 0 19) 18) anon9_Else_correct)))))))))
