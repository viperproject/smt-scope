...
(declare-fun r_21 () T@U)
(declare-fun r1 () T@U)
(declare-fun r2 () T@U)
(assert  (and (and (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type r_21) RefType)) (= (type Heap@@9) (MapType0Type RefType))) (= (type r_22) RefType)) (= (type r1) RefType)) (= (type r2) RefType)))
(set-info :boogie-vc-id permOnlyOneField1)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (HasDirectPerm Mask@0 r_22 f2)) (= (ControlFlow 0 14) 9)) anon7_correct)))
(let ((anon12_Then_correct  (=> (HasDirectPerm Mask@0 r_22 f2) (and (=> (= (ControlFlow 0 10) (- 0 13)) (HasDirectPerm Mask@0 r_22 f2)) (=> (HasDirectPerm Mask@0 r_22 f2) (and (=> (= (ControlFlow 0 10) (- 0 12)) (HasDirectPerm Mask@0 r_22 f2)) (=> (HasDirectPerm Mask@0 r_22 f2) (and (=> (= (ControlFlow 0 10) (- 0 11)) (HasDirectPerm Mask@0 r_22 f2)) (=> (HasDirectPerm Mask@0 r_22 f2) (=> (= (ControlFlow 0 10) 9) anon7_correct))))))))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (forall ((r_3 T@U) ) (!  (=> (and (= (type r_3) RefType) (HasDirectPerm Mask@0 r_3 f2)) (>= (U_2_int (MapType0Select Heap@@9 r_3 f2)) (U_2_int (MapType0Select Heap@@9 r_3 f2))))
 :qid |stdinbpl.729:15|
 :skolemid |38|
 :pattern ( (MapType1Select Mask@0 r_3 f2))
 :pattern ( (MapType0Select Heap@@9 r_3 f2))
)))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (forall ((r_1_1 T@U) ) (!  (=> (and (= (type r_1_1) RefType) (HasDirectPerm Mask@0 r_1_1 f1)) (>= (U_2_int (MapType0Select Heap@@9 r_1_1 f2)) (U_2_int (MapType0Select Heap@@9 r_1_1 f2))))
 :qid |stdinbpl.706:15|
 :skolemid |37|
 :pattern ( (MapType1Select Mask@0 r_1_1 f1))
 :pattern ( (MapType0Select Heap@@9 r_1_1 f1))
))) (=> (forall ((r_1_1@@0 T@U) ) (!  (=> (and (= (type r_1_1@@0) RefType) (HasDirectPerm Mask@0 r_1_1@@0 f1)) (>= (U_2_int (MapType0Select Heap@@9 r_1_1@@0 f2)) (U_2_int (MapType0Select Heap@@9 r_1_1@@0 f2))))
 :qid |stdinbpl.706:15|
 :skolemid |37|
 :pattern ( (MapType1Select Mask@0 r_1_1@@0 f1))
 :pattern ( (MapType0Select Heap@@9 r_1_1@@0 f1))
)) (=> (state Heap@@9 Mask@0) (and (and (=> (= (ControlFlow 0 15) 8) anon11_Else_correct) (=> (= (ControlFlow 0 15) 10) anon12_Then_correct)) (=> (= (ControlFlow 0 15) 14) anon12_Else_correct)))))))
(let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (HasDirectPerm Mask@0 r_21 f1)) (= (ControlFlow 0 6) 1)) anon3_correct)))
(let ((anon10_Then_correct  (=> (HasDirectPerm Mask@0 r_21 f1) (and (=> (= (ControlFlow 0 2) (- 0 5)) (HasDirectPerm Mask@0 r_21 f1)) (=> (HasDirectPerm Mask@0 r_21 f1) (and (=> (= (ControlFlow 0 2) (- 0 4)) (HasDirectPerm Mask@0 r_21 f2)) (=> (HasDirectPerm Mask@0 r_21 f2) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@0 r_21 f2)) (=> (HasDirectPerm Mask@0 r_21 f2) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))))
(let ((anon0_correct  (=> (and (state Heap@@9 ZeroMask) (U_2_bool (MapType0Select Heap@@9 r1 $allocated))) (=> (and (and (U_2_bool (MapType0Select Heap@@9 r2 $allocated)) (not (= r1 null))) (and (= Mask@0 (MapType1Store ZeroMask r1 f1 (real_2_U (+ (U_2_real (MapType1Select ZeroMask r1 f1)) FullPerm)))) (state Heap@@9 Mask@0))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (HasDirectPerm Mask@0 r1 f1)) (=> (HasDirectPerm Mask@0 r1 f1) (=> (> (U_2_int (MapType0Select Heap@@9 r1 f1)) 0) (=> (and (state Heap@@9 Mask@0) (state Heap@@9 Mask@0)) (and (and (=> (= (ControlFlow 0 17) 15) anon9_Else_correct) (=> (= (ControlFlow 0 17) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 17) 6) anon10_Else_correct))))))))))
