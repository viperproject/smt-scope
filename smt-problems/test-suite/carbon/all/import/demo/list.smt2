...
(assert (forall ((Heap@@10 T@U) (Mask@@9 T@U) (this@@6 T@U) ) (!  (=> (and (and (and (= (type Heap@@10) (MapType0Type RefType)) (= (type Mask@@9) (MapType1Type RefType realType))) (= (type this@@6) RefType)) (state Heap@@10 Mask@@9)) (= (|length'| Heap@@10 this@@6) (|length#frame| (MapType0Select Heap@@10 null (list this@@6)) this@@6)))
 :qid |stdinbpl.207:15|
 :skolemid |24|
 :pattern ( (state Heap@@10 Mask@@9) (|length'| Heap@@10 this@@6))
)))
...
(assert (forall ((this@@7 T@U) ) (!  (=> (= (type this@@7) RefType) (= (PredicateMaskField (list this@@7)) (|list#sm| this@@7)))
 :qid |stdinbpl.244:15|
 :skolemid |25|
 :pattern ( (PredicateMaskField (list this@@7)))
)))
