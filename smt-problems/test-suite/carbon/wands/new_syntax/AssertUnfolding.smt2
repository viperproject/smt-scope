...
(assert  (and (and (and (and (and (= (type UnfoldingMask@0) (MapType1Type RefType realType)) (= (type Mask@0) (MapType1Type RefType realType))) (= (type x@@18) RefType)) (= (type UnfoldingMask@1) (MapType1Type RefType realType))) (= (type Heap@@14) (MapType0Type RefType))) (forall ((arg0@@31 T@U) ) (! (= (type (FrameFragment arg0@@31)) FrameTypeType)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (and (= UnfoldingMask@0 (MapType1Store Mask@0 null (P x@@18) (real_2_U (- (U_2_real (MapType1Select Mask@0 null (P x@@18))) FullPerm)))) (not (= x@@18 null))) (=> (and (and (= UnfoldingMask@1 (MapType1Store UnfoldingMask@0 x@@18 i (real_2_U (+ (U_2_real (MapType1Select UnfoldingMask@0 x@@18 i)) FullPerm)))) (state Heap@@14 UnfoldingMask@1)) (and (state Heap@@14 UnfoldingMask@1) (= (ControlFlow 0 2) (- 0 1)))) (HasDirectPerm UnfoldingMask@1 x@@18 i)))))
(let ((anon3_Else_correct  (=> (and (= FullPerm NoPerm) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (not (= FullPerm NoPerm)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P x@@18))))) (=> (<= FullPerm (U_2_real (MapType1Select Mask@0 null (P x@@18)))) (=> (= (ControlFlow 0 3) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (and (state Heap@@14 ZeroMask) (U_2_bool (MapType0Select Heap@@14 x@@18 $allocated))) (and (= AssumeFunctionsAbove 0) (= Mask@0 (MapType1Store ZeroMask null (P x@@18) (real_2_U (+ (U_2_real (MapType1Select ZeroMask null (P x@@18))) FullPerm)))))) (and (and (state Heap@@14 Mask@0) (state Heap@@14 Mask@0)) (and (|P#trigger| Heap@@14 (P x@@18)) (= (MapType0Select Heap@@14 null (P x@@18)) (FrameFragment (MapType0Select Heap@@14 x@@18 i)))))) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))
