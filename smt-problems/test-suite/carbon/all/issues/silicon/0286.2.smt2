...
(assert  (and (and (and (and (and (and (= (type Heap@@19) (MapType0Type RefType)) (= (type start@@19) RefType)) (= (type end@@9) RefType)) (= (type Mask@1) (MapType1Type RefType realType))) (= (type Mask@2) (MapType1Type RefType realType))) (= (type Mask@3) (MapType1Type RefType realType))) (= (type Mask@0) (MapType1Type RefType realType))))
(set-info :boogie-vc-id |lseg#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct true))
(let ((anon3_Else_correct  (=> (= (MapType0Select Heap@@19 start@@19 next) end@@9) (=> (and (= Mask@3 Mask@1) (= (ControlFlow 0 4) 1)) anon2_correct))))
(let ((anon3_Then_correct  (=> (not (= (MapType0Select Heap@@19 start@@19 next) end@@9)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (HasDirectPerm Mask@1 start@@19 next)) (=> (HasDirectPerm Mask@1 start@@19 next) (=> (and (and (= Mask@2 (MapType1Store Mask@1 null (lseg (MapType0Select Heap@@19 start@@19 next) end@@9) (real_2_U (+ (U_2_real (MapType1Select Mask@1 null (lseg (MapType0Select Heap@@19 start@@19 next) end@@9))) FullPerm)))) (state Heap@@19 Mask@2)) (and (= Mask@3 Mask@2) (= (ControlFlow 0 2) 1))) anon2_correct))))))
(let ((anon0_correct  (=> (and (state Heap@@19 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (=> (and (and (and (U_2_bool (MapType0Select Heap@@19 start@@19 $allocated)) (U_2_bool (MapType0Select Heap@@19 end@@9 $allocated))) (and (not (= start@@19 null)) (= Mask@0 (MapType1Store ZeroMask start@@19 val (real_2_U (+ (U_2_real (MapType1Select ZeroMask start@@19 val)) FullPerm)))))) (and (and (state Heap@@19 Mask@0) (not (= start@@19 null))) (and (= Mask@1 (MapType1Store Mask@0 start@@19 next (real_2_U (+ (U_2_real (MapType1Select Mask@0 start@@19 next)) FullPerm)))) (state Heap@@19 Mask@1)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (HasDirectPerm Mask@1 start@@19 next)) (=> (HasDirectPerm Mask@1 start@@19 next) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))))
