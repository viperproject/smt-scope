...
(declare-fun key@@2 () T@U)
(declare-fun Heap@@33 () T@U)
(declare-fun ln_1@0 () Int)
(declare-fun Mask@0 () T@U)
(declare-fun self@@14 () T@U)
(declare-fun wildcard@0 () Real)
(declare-fun wildcard () Real)
(assert  (and (and (and (= (type Mask@0) (MapType1Type RefType realType)) (= (type self@@14) RefType)) (= (type key@@2) RefType)) (= (type Heap@@33) (MapType0Type RefType))))
(set-info :boogie-vc-id |list___getitem__#definedness|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon18_Then_correct  (=> (= (ControlFlow 0 15) (- 0 14)) (issubtype (typeof key@@2) vint))))
(let ((anon21_Then_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (issubtype (typeof key@@2) vint))))
(let ((anon14_correct true))
(let ((anon21_Else_correct  (=> (and (< (int___unbox__ Heap@@33 key@@2) ln_1@0) (= (ControlFlow 0 11) 7)) anon14_correct)))
(let ((anon20_Then_correct  (=> (and (>= (int___unbox__ Heap@@33 key@@2) 0) (state Heap@@33 Mask@0)) (and (=> (= (ControlFlow 0 12) 10) anon21_Then_correct) (=> (= (ControlFlow 0 12) 11) anon21_Else_correct)))))
(let ((anon20_Else_correct  (=> (and (> 0 (int___unbox__ Heap@@33 key@@2)) (= (ControlFlow 0 8) 7)) anon14_correct)))
(let ((anon19_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (issubtype (typeof key@@2) vint))))
(let ((anon18_Else_correct  (=> (>= (int___unbox__ Heap@@33 key@@2) (- 0 ln_1@0)) (and (and (=> (= (ControlFlow 0 16) 6) anon19_Then_correct) (=> (= (ControlFlow 0 16) 12) anon20_Then_correct)) (=> (= (ControlFlow 0 16) 8) anon20_Else_correct)))))
(let ((anon17_Then_correct  (=> (and (< (int___unbox__ Heap@@33 key@@2) 0) (state Heap@@33 Mask@0)) (and (=> (= (ControlFlow 0 17) 15) anon18_Then_correct) (=> (= (ControlFlow 0 17) 16) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (<= 0 (int___unbox__ Heap@@33 key@@2)) (and (and (=> (= (ControlFlow 0 13) 6) anon19_Then_correct) (=> (= (ControlFlow 0 13) 12) anon20_Then_correct)) (=> (= (ControlFlow 0 13) 8) anon20_Else_correct)))))
(let ((anon16_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (issubtype (typeof key@@2) vint))))
(let ((anon15_Else_correct  (=> (= ln_1@0 (list___len__ Heap@@33 self@@14)) (and (and (=> (= (ControlFlow 0 18) 4) anon16_Then_correct) (=> (= (ControlFlow 0 18) 17) anon17_Then_correct)) (=> (= (ControlFlow 0 18) 13) anon17_Else_correct)))))
(let ((anon15_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (> (U_2_real (MapType1Select Mask@0 self@@14 list_acc)) NoPerm))))
(let ((anon0_correct  (=> (state Heap@@33 ZeroMask) (=> (and (U_2_bool (MapType0Select Heap@@33 self@@14 $allocated)) (U_2_bool (MapType0Select Heap@@33 key@@2 $allocated))) (=> (and (and (and (= AssumeFunctionsAbove 1) (issubtype (typeof key@@2) vint)) (and (state Heap@@33 ZeroMask) (> wildcard@0 NoPerm))) (and (and (not (= self@@14 null)) (= Mask@0 (MapType1Store ZeroMask self@@14 list_acc (real_2_U (+ (U_2_real (MapType1Select ZeroMask self@@14 list_acc)) wildcard@0))))) (and (state Heap@@33 Mask@0) (state Heap@@33 Mask@0)))) (and (=> (= (ControlFlow 0 19) 2) anon15_Then_correct) (=> (= (ControlFlow 0 19) 18) anon15_Else_correct)))))))
