...
(assert  (and (= (type xs) (SeqType intType)) (= (type Heap@@12) (MapType0Type RefType))))
(set-info :boogie-vc-id test2)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon3_correct true))
(let ((anon6_Else_correct  (=> (and (not (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1))) (= (ControlFlow 0 8) 4)) anon3_correct)))
(let ((anon6_Then_correct  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (>= i_1 0)) (=> (>= i_1 0) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< i_1 (|Seq#Length| xs))) (=> (< i_1 (|Seq#Length| xs)) (=> (= (ControlFlow 0 5) 4) anon3_correct))))))))
(let ((anon5_Else_correct  (=> (and (forall ((i_1_1 Int) ) (!  (=> (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1_1)) (not (= (U_2_int (|Seq#Index| xs i_1_1)) 0)))
 :qid |stdinbpl.723:20|
 :skolemid |61|
 :pattern ( (|Seq#ContainsTrigger| (|Seq#Range| 0 n@@13) (int_2_U i_1_1)))
 :pattern ( (|Seq#Contains| (|Seq#Range| 0 n@@13) (int_2_U i_1_1)))
 :pattern ( (|Seq#Index| xs i_1_1))
)) (state Heap@@12 ZeroMask)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< 3 (|Seq#Length| xs))) (=> (< 3 (|Seq#Length| xs)) (=> (= (ControlFlow 0 2) (- 0 1)) (not (= (U_2_int (|Seq#Index| xs 3)) 0))))))))
(let ((anon0_correct  (=> (and (and (state Heap@@12 ZeroMask) (= AssumeFunctionsAbove (- 0 1))) (and (< 5 n@@13) (state Heap@@12 ZeroMask))) (and (and (=> (= (ControlFlow 0 9) 2) anon5_Else_correct) (=> (= (ControlFlow 0 9) 5) anon6_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct)))))
